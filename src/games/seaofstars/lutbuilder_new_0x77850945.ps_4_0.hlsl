...
void main(float4 v0: SV_POSITION0, float2 v1: TEXCOORD0, out float4 o0: SV_Target0) {
  ...
  r0.xyz = r0.xyz * cb0[135].zzz + float3(0.0275523961, 0.0275523961, 0.0275523961);
  ...
  r0.w = saturate(cb0[143].w + r0.w);
  r1.x = 1 + -r0.w;
  r1.yzw = float3(-0.5, -0.5, -0.5) + cb0[143].xyz;
  r1.xyz = r1.xxx * r1.yzw + float3(0.5, 0.5, 0.5);
  r2.xyz = float3(-0.5, -0.5, -0.5) + cb0[144].xyz;
  ...
  r1.x = dot(r0.xyz, cb0[132].xyz);
  r1.y = dot(r0.xyz, cb0[133].xyz);
  r1.z = dot(r0.xyz, cb0[134].xyz);

  // Shadows, midtones, highlights
  r0.x = dot(r1.xyz, float3(0.212672904, 0.715152204, 0.0721750036));
  r0.yz = cb0[142].yw + -cb0[142].xz;
  r0.xw = -cb0[142].xz + r0.xx;
  ...
  r0.z = 1 + -r0.x;
  r0.y = -r0.w * r0.y + r0.z;
  r2.xyz = cb0[139].xyz * r1.xyz;
  r3.xyz = cb0[140].xyz * r1.xyz;
  r0.yzw = r3.xyz * r0.yyy;
  r0.xyz = r2.xyz * r0.xxx + r0.yzw;
  r1.xyz = cb0[141].xyz * r1.xyz;
  r0.xyz = r1.xyz * r1.www + r0.xyz;

  // Lift, gamma, gain
  // TODO: Reduce Lift in HDR
  r0.xyz = r0.xyz * cb0[138].xyz + cb0[136].xyz;
  ...
  bool useSDRLut = (cb0[146].x >= 0) && (cb0[145].w >= 0);

  renodx::lut::Config lut_config = renodx::lut::config::Create(
      s0_s,
      useSDRLut ? cb0[145].w * injectedData.colorGradeLUTStrength : 0,
      injectedData.colorGradeLUTScaling,
      renodx::lut::config::type::SRGB,
      renodx::lut::config::type::SRGB,
      cb0[145].xyz  // precompute
  );
  ...
  r0.w = cmp(0 < cb0[146].x);
  if (r0.w != 0) {
    r0.w = cmp(0 < cb0[145].w);
    if (r0.w != 0) {
      ...
      r2.xyz = cb0[145].zzz * r1.zxy;
      r0.w = floor(r2.x);
      r2.xw = float2(0.5, 0.5) * cb0[145].xy;
      r2.yz = r2.yz * cb0[145].xy + r2.xw;
      r2.x = r0.w * cb0[145].y + r2.y;
      r3.xyzw = t8.SampleLevel(s0_s, r2.xz, 0).xyzw;
      r4.x = cb0[145].y;
      r4.y = 0;
      r2.xy = r4.xy + r2.xz;
      r2.xyzw = t8.SampleLevel(s0_s, r2.xy, 0).xyzw;
      r0.w = r1.z * cb0[145].z + -r0.w;
      r2.xyz = r2.xyz + -r3.xyz;
      r2.xyz = r0.www * r2.xyz + r3.xyz;
      r2.xyz = r2.xyz + -r1.xyz;
      r1.xyz = cb0[145].www * r2.xyz + r1.xyz;
