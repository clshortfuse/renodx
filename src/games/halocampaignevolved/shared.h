#ifndef SRC_GAMES_HALOCAMPAIGNEVOLVED_SHARED_H_
#define SRC_GAMES_HALOCAMPAIGNEVOLVED_SHARED_H_
...
struct ShaderInjectData {
  ...
  float tone_map_override_black_clip;
  ...
  float custom_color_grade_strength;
  float custom_color_grade_scaling;
...
#define RENODX_COLOR_GRADE_STRENGTH          shader_injection.custom_color_grade_strength
...
#endif  // SRC_GAMES_HALOCAMPAIGNEVOLVED_SHARED_H_
