...
// ---- Created with 3Dmigoto v1.4.1 on Thu Oct 16 02:30:58 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r4.xyzw = t2.Sample(s4_s, v1.xy).wxyz;
  r2.x = cmp(cb0[22].z < cb0[2].z);
  if (r2.x != 0) {
    r5.xyzw = t1.SampleLevel(s1_s, v2.xy, v2.w).xyzw;
    r2.x = cb1[7].z * r5.x + cb1[7].w;
    r2.x = 1 / r2.x;
    r2.z = -cb0[18].x + r2.x;
    r2.w = cmp(r2.x < cb0[18].x);
  ...
  r4.zw = cb0[4].xy * r1.yz;
  r1.y = floor(r2.x);
  r4.y = r1.y * cb0[4].y + r4.z;
  r4.x = cb0[4].y + r4.y;
  r5.xyzw = t4.Sample(s3_s, r4.yw).xyzw;
  r4.xyzw = t4.Sample(s3_s, r4.xw).xyzw;
  r1.x = r1.w * r1.x + -r1.y;
  ...
  r1.w = 1 + -r1.w;
  r1.w = cb0[6].z * r1.w;
  r3.y = dot(r2.xzw, float3(0.298999995,0.587000012,0.114));
  r0.xyz = r0.xyz * r1.xyz + -r3.yyy;
