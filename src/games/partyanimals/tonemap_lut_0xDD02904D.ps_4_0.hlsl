...
// ---- Created with 3Dmigoto v1.4.1 on Thu Oct 16 23:24:06 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.zw = cb0[4].xy * r1.xy;
  r3.y = r2.x * cb0[4].y + r3.z;
  r3.x = cb0[4].y + r3.y;
  ...
  r1.xyz = r0.xyw * float3(0.305306017,0.305306017,0.305306017) + float3(0.682171106,0.682171106,0.682171106);
  r1.xyz = r0.xyw * r1.xyz + float3(0.0125228781,0.0125228781,0.0125228781);
  r2.xyz = r1.xyz * r0.xyw;
  //r2.xyz = renodx::color::srgb::DecodeSafe(r0.xyw);
