...
// ---- Created with 3Dmigoto v1.4.1 on Thu Oct 16 22:58:16 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.y = max(r1.x, r0.y);
  r0.x = r0.x * r0.y + 1;
  r1.xyz = saturate(r2.xyz);
  r1.xyz = float3(1,1,1) + -r1.xyz;
  r3.xyz = r2.xyz * r1.yxx;
  r1.xyz = r3.xyz * r1.zzy;
  r1.xyz = r1.xyz * cb0[6].www + float3(1,1,1);
