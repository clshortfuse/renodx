...
float4 main(
  ...
  SV_Target.x = (saturate((((exp2(((log2((((((_199.x) - (_194.x)) * _189) + (_194.x)) + ((((frac((_213 * 29156.4765625f))) + -0.5f) + (frac((_223 * 29156.4765625f)))) * 0.0019607844296842813f)))) * (userModifications.x)))) * (userModifications.y)) + (userModifications.z))));
  SV_Target.y = (saturate((((exp2(((log2((((((_199.y) - (_194.y)) * _189) + (_194.y)) + ((((frac((_213 * 38273.5625f))) + -0.5f) + (frac((_223 * 38273.5625f)))) * 0.0019607844296842813f)))) * (userModifications.x)))) * (userModifications.y)) + (userModifications.z))));
  SV_Target.z = (saturate((((exp2(((log2((((((_199.z) - (_194.z)) * _189) + (_194.z)) + ((((frac((_213 * 47843.75390625f))) + -0.5f) + (frac((_223 * 47843.75390625f)))) * 0.0019607844296842813f)))) * (userModifications.x)))) * (userModifications.y)) + (userModifications.z))));
