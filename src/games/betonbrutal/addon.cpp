...
renodx::mods::shader::CustomShaders custom_shaders = {
    ...
    CustomShaderEntryCallback(0x440F1911, [](reshade::api::command_list* cmd_list) {  // uberpost (CA + bloom)
    is_bloom_enabled = true;
    is_CA_enabled = true;
    return true;
    }),
    CustomShaderEntryCallback(0x9CC447BF, [](reshade::api::command_list* cmd_list) {  // uberpost 2 (CA)
    is_bloom_enabled = false;
    is_CA_enabled = true;
    return true;
    }),
    CustomShaderEntryCallback(0xC63B24BB, [](reshade::api::command_list* cmd_list) {  // uberpost 3
    is_bloom_enabled = false;
    is_CA_enabled = false;
    return true;
    }),
    CustomShaderEntryCallback(0xCF7B19D4, [](reshade::api::command_list* cmd_list) {  // uberpost 4 (bloom)
    is_bloom_enabled = true;
    is_CA_enabled = false;
    return true;
    }),
    CustomShaderEntry(0xCC8B6ACF),  // post final
...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        .key = "fxLumaSharpen",
        .binding = &shader_injection.fxLumaSharpen,
        .default_value = 50.f,
...
void OnPresetOff() {
  ...
  renodx::utils::settings::UpdateSetting("fxLumaSharpen", 50.f);
}
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for BETON BRUTAL";
