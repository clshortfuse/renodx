...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Assassin's Creed Brotherhood";
  ...
  switch (fdw_reason) {
    case DLL_PROCESS_ATTACH:
      ...
      if (!initialized) {
        ...
        renodx::utils::device_proxy::SetSameHwndNonFlipBootstrap(true);
