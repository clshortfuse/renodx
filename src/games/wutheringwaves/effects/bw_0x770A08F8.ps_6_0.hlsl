...
float4 main(
  ...
  float _93 = floor(frac(View_2376 * 0.10000000149011612f) * (MaterialCollection0_000[7].w)) * 0.25f;
  float _94 = cos(_93);
  float _95 = sin(_93);
  float _96 = -0.0f - _95;
  float _99 = _69 * 2.0f;
  ...
  while(true) {
    ...
    while(true) {
      ...
      float _600 = ((1.0f - (_596 * 2.0f)) * (MaterialCollection0_000[2].z)) + _596;
