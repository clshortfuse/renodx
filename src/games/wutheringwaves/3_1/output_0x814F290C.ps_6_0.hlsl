...
float4 main(
    ...
    do {
      if (_46 > 0.0f) {
        ...
        if (_46 < 0.0f) {
          ...
          float _90 = (((_85 * _85) * (cb0_101x * 0.699999988079071f)) + 1.0f) * _85;
  ...
  float4 _137 = t4.SampleLevel(s4, float2(_135, _136), 0.0f);
  float _149 = ((1.0f / ((View_1040.z * _137.x) - View_1040.w)) + View_1040.y) + (View_1040.x * _137.x);
  float4 _150 = t3.Sample(s3, float2(_135, _136));
  float _158 = 1.0f / ((_149 + View_1040.w) * View_1040.z);
  if (((bool)(!(cb0_096y == 0.0f))) || ((bool)(((bool)(((bool)(((bool)(((bool)(!(cb0_097y == 0.0f))) || ((bool)(!(cb0_101y == 0.0f))))) || ((bool)(!(cb0_102y == 0.0f))))) || ((bool)(!(cb0_103y == 0.0f))))) || ((bool)(!(cb0_104y == 0.0f)))))) {
    float _203 = 1.5f - (saturate(cb0_097z) * 1.4900000095367432f);
    float _208 = saturate(((sqrt((_122 * _122) + (_121 * _121)) - cb0_097y) - _203) / (-0.0f - _203));
    float _212 = (_208 * _208) * (3.0f - (_208 * 2.0f));
    _220 = (1.0f - (_212 * max(cb0_096y, cb0_101y)));
    _221 = (1.0f - (_212 * max(cb0_096y, cb0_102y)));
    _222 = (1.0f - (_212 * max(cb0_096y, cb0_103y)));
  } else {
    _220 = 1.0f;
    _221 = 1.0f;
    _222 = 1.0f;
  }
  bool _228 = !(cb0_096z == 0.0f);
  bool _229 = !(cb0_101z == 0.0f);
  bool _231 = !(cb0_102z == 0.0f);
  bool _233 = !(cb0_103z == 0.0f);
  if (((bool)(((bool)(((bool)(_228 || _229)) || _231)) || _233)) || ((bool)(!(cb0_104z == 0.0f)))) {
    do {
      if (_228) {
        _244 = exp2(log2(saturate(cb0_096z)) * 3.0f);
      } else {
        _244 = cb0_096z;
      }
      do {
        if (_229) {
          _251 = exp2(log2(saturate(cb0_101z)) * 3.0f);
        } else {
          _251 = cb0_101z;
        }
        do {
          if (_231) {
            _258 = exp2(log2(saturate(cb0_102z)) * 3.0f);
          } else {
            _258 = cb0_102z;
          }
          do {
            if (_233) {
              _265 = exp2(log2(saturate(cb0_103z)) * 3.0f);
            } else {
              _265 = cb0_103z;
            }
  ...
  if (((bool)(((bool)(((bool)(((bool)(!(cb0_097x == 0.0f))) || ((bool)(!(cb0_102x == 0.0f))))) || ((bool)(!(cb0_103x == 0.0f))))) || ((bool)(!(cb0_104x == 0.0f))))) || ((bool)(!(cb0_105x == 0.0f)))) {
    ...
    _337 = max(_323, (1.0f - saturate(max(cb0_097x, cb0_102x))));
    _338 = max(_323, (1.0f - saturate(max(cb0_097x, cb0_103x))));
    _339 = max(_323, (1.0f - saturate(max(cb0_097x, cb0_104x))));
  } else {
    _337 = 1.0f;
    _338 = 1.0f;
    _339 = 1.0f;
  }
  float _341 = (TEXCOORD_2.w * 543.3099975585938f) + TEXCOORD_2.z;
  float _344 = frac(sin(_341) * 493013.0f);
  if (cb0_096x > 0.0f) {
    _365 = (((frac((sin(_341 + 33.9900016784668f) * 493013.0f) + 7.177000045776367f) - _344) * cb0_096x) + _344);
    _366 = (((frac((sin(_341 + 66.98999786376953f) * 493013.0f) + 14.298999786376953f) - _344) * cb0_096x) + _344);
  } else {
    _365 = _344;
    _366 = _344;
  }
  if (cb0_099z > 0.0f) {
    _388 = (((((_302 * _222) * _339) * cb0_099z) * ((sin((((TEXCOORD_3.y * 10.0f) + 10.0f) + (_344 * 0.0020000000949949026f)) + (View_2376 * 4.0f)) * 0.5f) + 0.5f)) + 1.0f);
  } else {
    _388 = 1.0f;
  }
  float _391 = (_301 * _221) * _338;
  if (cb0_099y > 0.0f) {
    float _396 = View_2376 * 0.00016666666488163173f;
    float _400 = frac(abs(_396));
    float _405 = select((_396 >= (-0.0f - _396)), _400, (-0.0f - _400)) * ((TEXCOORD_3.y * 111000.0f) + 111000.0f);
    float _413 = ((_391 * 0.014999999664723873f) * cb0_099y) * (0.5f - frac(sin(dot(float2(_405, _405), float2(12.989800453186035f, 78.23300170898438f))) * 43758.546875f));
    _418 = ((_413 * 0.5f) + _135);
    _419 = (_413 + _136);
  } else {
    _418 = _135;
  ...
  float _424 = cb0_095z * (1.0f - (_344 * _344));
  float _429 = (_424 * (TEXCOORD_2.x - _418)) + _418;
  float _430 = (_424 * (TEXCOORD_2.y - _419)) + _419;
  float _445 = _429 - (((cb0_048z * _121) + cb0_049x) * cb0_048x);
  float _446 = _430 - (((cb0_048w * _122) + cb0_049y) * cb0_048y);
  float _456 = cb0_118z * cb0_117x;
  float _457 = cb0_118z * cb0_117y;
  bool _458 = (cb0_118x == 0.0f);
  float _468 = (cb0_114z * _121) + cb0_114x;
  float _469 = (cb0_114w * _122) + cb0_114y;
  float _488 = float((int)(((int)(uint)((bool)(_468 > 0.0f))) - ((int)(uint)((bool)(_468 < 0.0f))))) * saturate(abs(_468) - cb0_117z);
  float _490 = float((int)(((int)(uint)((bool)(_469 > 0.0f))) - ((int)(uint)((bool)(_469 < 0.0f))))) * saturate(abs(_469) - cb0_117z);
  float _495 = _469 - (_490 * _456);
  float _497 = _469 - (_490 * _457);
  ...
  float4 _542 = t0.Sample(s0, float2(min(max(_429, cb0_053z), cb0_054x), min(max(_430, cb0_053w), cb0_054y)));
  float4 _558 = t0.Sample(s0, float2(min(max(((((((cb0_115z * (_468 - (_488 * select(_458, _456, cb0_117x)))) + cb0_115x) * cb0_048z) + cb0_049x) * cb0_048x) + _445), cb0_053z), cb0_054x), min(max(((((((cb0_115w * _505) + cb0_115y) * cb0_048w) + cb0_049y) * cb0_048y) + _446), cb0_053w), cb0_054y)));
  float4 _572 = t0.Sample(s0, float2(min(max(((((((cb0_115z * (_468 - (_488 * select(_458, _457, cb0_117y)))) + cb0_115x) * cb0_048z) + cb0_049x) * cb0_048x) + _445), cb0_053z), cb0_054x), min(max(((((((cb0_115w * _506) + cb0_115y) * cb0_048w) + cb0_049y) * cb0_048y) + _446), cb0_053w), cb0_054y)));
  if (_498) {
  ...
  float _604 = saturate(cb0_098x);
  float _606 = saturate(cb0_098y);
  if (_604 > 0.0f) {
    float _617 = saturate(((_600 * 0.29899999499320984f) + (_542.z * 0.11400000005960464f)) + (_601 * 0.5870000123977661f));
    float _618 = _617 * 2.0f;
    float _622 = ((_617 * saturate(1.0f - cb0_098z)) * _618) * (3.0f - _618);
    float _629 = max(sqrt(((_600 * _600) + (_542.z * _542.z)) + (_601 * _601)), 0.014999999664723873f);
    float _630 = _600 / _629;
    float _631 = _601 / _629;
    float _632 = _542.z / _629;
    float _642 = log2(_622);
    float _661 = ((_300 * _220) * _337) * _604;
    _672 = (((((lerp(_630, 1.0f, 0.25f)) * (((_606 * 0.17000000178813934f) + 0.029999999329447746f) + _622)) - _600) * _661) + _600);
    _673 = (((((((_606 * 0.18000000715255737f) + 0.05000000074505806f) + exp2(_642 * 0.8999999761581421f)) * (lerp(_631, 1.0f, 0.25f))) - _601) * _661) + _601);
    _674 = (((((((_606 * 0.17999999225139618f) + 0.07999999821186066f) + exp2(_642 * 0.949999988079071f)) * (lerp(_632, 1.0f, 0.25f))) - _542.z) * _661) + _542.z);
  } else {
    _672 = _600;
    _673 = _601;
    _674 = _542.z;
  }
  float _677 = saturate(cb0_099x);
  float _678 = _677 * _391;
  if (_677 > 0.0f) {
    float _689 = (sin(((_122 * 640.0f) + 640.0f) - (View_2376 * 10.0f)) * 0.5f) + 1.0f;
    _703 = ((((_689 * _672) - _672) * _678) + _672);
    _704 = ((((_689 * _673) - _673) * _678) + _673);
    _705 = ((((_689 * _674) - _674) * _678) + _674);
  } else {
    _703 = _672;
    _704 = _673;
    _705 = _674;
  }
  float _714 = log2(max(dot(float3(_703, _704, _705), float3(cb0_043x, cb0_043y, cb0_043z)), cb0_042x));
  float4 _732 = t6.Sample(s6, float3((cb0_046z * TEXCOORD_4.x), (cb0_046w * TEXCOORD_4.y), ((((cb0_041z * _714) + cb0_041w) * 0.96875f) + 0.015625f)));
  float4 _736 = t7.Sample(s7, float2(TEXCOORD_4.x, TEXCOORD_4.y));
  float _739 = select((_732.y < 0.0010000000474974513f), _736.x, (_732.x / _732.y));
  float _742 = log2(TEXCOORD_1.x);
  float _744 = (_739 + _742) + ((_736.x - _739) * cb0_046x);
  float _749 = _742 + _714;
  float _751 = _744 - log2((TEXCOORD_1.y * 0.18000000715255737f) * cb0_046y);
  bool _752 = (_751 > 0.0f);
  if (_752) {
    _764 = max(0.0f, (_751 - cb0_047x));
  } else {
    _764 = min(0.0f, (_751 + cb0_047y));
  }
  float4 _796 = t1.Sample(s1, float2(min(max(((cb0_068z * _429) + cb0_069x), cb0_060z), cb0_061x), min(max(((cb0_068w * _430) + cb0_069y), cb0_060w), cb0_061y)));
  APPLY_BLOOM(_796);
  [branch]
  if (!(cb0_085z == 0)) {
    bool _824 = (cb0_085w != 0);
    float4 _827 = t2.Sample(s2, float2(select(_824, _429, min(max(((cb0_076z * _429) + cb0_077x), cb0_075z), cb0_076x)), select(_824, _430, min(max(((cb0_076w * _430) + cb0_077y), cb0_075w), cb0_076y))));
    _835 = (_827.x + _796.x);
    _836 = (_827.y + _796.y);
    _837 = (_827.z + _796.z);
  } else {
  ...
  float _838 = exp2((((_744 - _749) + ((_749 - _744) * cb0_045w)) - _764) + (_764 * select(_752, cb0_045y, cb0_045z))) * TEXCOORD_1.x;
  float _863 = TEXCOORD_1.z + -1.0f;
  float _865 = TEXCOORD_1.w + -1.0f;
  float _868 = (((cb0_090x * 2.0f) + _863) * cb0_088z) * cb0_088x;
  float _870 = (((cb0_090y * 2.0f) + _865) * cb0_088w) * cb0_088x;
  float _877 = 1.0f / ((((saturate(cb0_089w) * 9.0f) + 1.0f) * dot(float2(_868, _870), float2(_868, _870))) + 1.0f);
  float _878 = _877 * _877;
  float _879 = cb0_090z + 1.0f;
  float _907 = (((cb0_093x * 2.0f) + _863) * cb0_091z) * cb0_091x;
  float _909 = (((cb0_093y * 2.0f) + _865) * cb0_091w) * cb0_091x;
  float _916 = 1.0f / ((((saturate(cb0_092w) * 9.0f) + 1.0f) * dot(float2(_907, _909), float2(_907, _909))) + 1.0f);
  float _917 = _916 * _916;
  float _918 = cb0_093z + 1.0f;
  float _930 = (((_835 + ((_838 * _703) * cb0_086x)) * _388) * ((_878 * (_879 - cb0_089x)) + cb0_089x)) * ((_917 * (_918 - cb0_092x)) + cb0_092x);
  float _933 = (((_836 + ((_838 * _704) * cb0_086y)) * _388) * ((_878 * (_879 - cb0_089y)) + cb0_089y)) * ((_917 * (_918 - cb0_092y)) + cb0_092y);
  float _936 = (((_837 + ((_838 * _705) * cb0_086z)) * _388) * ((_878 * (_879 - cb0_089z)) + cb0_089z)) * ((_917 * (_918 - cb0_092z)) + cb0_092z);
  [branch]
  if (!(cb0_111w == 0)) {
    float _950 = ((((cb0_111z + 1.0f) * 0.009900989942252636f) * (cb0_111x - cb0_111y)) + cb0_111y) * -1.4426950216293335f;
    _961 = (1.0f - exp2(_950 * _930));
    _962 = (1.0f - exp2(_950 * _933));
    _963 = (1.0f - exp2(_950 * _936));
  } else {
    _961 = _930;
    _962 = _933;
    _963 = _936;
  ...
  CAPTURE_UNTONEMAPPED(float3(_961, _962, _963));
  [branch]
  if (WUWA_TM_IS(1)) {
    _996 = ((((_961 * 1.3600000143051147f) + 0.04699999839067459f) * _961) / ((((_961 * 0.9599999785423279f) + 0.5600000023841858f) * _961) + 0.14000000059604645f));
    _997 = ((((_962 * 1.3600000143051147f) + 0.04699999839067459f) * _962) / ((((_962 * 0.9599999785423279f) + 0.5600000023841858f) * _962) + 0.14000000059604645f));
    _998 = ((((_963 * 1.3600000143051147f) + 0.04699999839067459f) * _963) / ((((_963 * 0.9599999785423279f) + 0.5600000023841858f) * _963) + 0.14000000059604645f));
  } else {
    _996 = _961;
    _997 = _962;
    _998 = _963;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _1008 = 1.0049500465393066f - (0.16398000717163086f / (_996 + -0.19505000114440918f));
    float _1009 = 1.0049500465393066f - (0.16398000717163086f / (_997 + -0.19505000114440918f));
    float _1010 = 1.0049500465393066f - (0.16398000717163086f / (_998 + -0.19505000114440918f));
    _1030 = (((_996 - _1008) * select((_996 > 0.6000000238418579f), 0.0f, 1.0f)) + _1008);
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _1038 = cb0_037y * _1030;
    float _1039 = cb0_037y * _1031;
    float _1040 = cb0_037y * _1032;
    float _1043 = cb0_037z * cb0_037w;
    float _1053 = cb0_038y * cb0_038x;
    float _1064 = cb0_038z * cb0_038x;
    float _1071 = cb0_038y / cb0_038z;
    _1079 = (((((_1043 + _1038) * _1030) + _1053) / (((_1038 + cb0_037z) * _1030) + _1064)) - _1071);
    _1080 = (((((_1043 + _1039) * _1031) + _1053) / (((_1039 + cb0_037z) * _1031) + _1064)) - _1071);
    _1081 = (((((_1043 + _1040) * _1032) + _1053) / (((_1040 + cb0_037z) * _1032) + _1064)) - _1071);
  } else {
    _1079 = _1030;
    _1080 = _1031;
    _1081 = _1032;
  ...
  if (!(cb0_105w == 0)) {
    if (!(cb0_106x == 1.0f)) {
      float _1091 = (cb0_106x * 0.699999988079071f) + 0.30000001192092896f;
      _1096 = (_1091 * _1079);
      _1097 = (_1091 * _1080);
      _1098 = (_1091 * _1081);
    } else {
  ...
  CLAMP_IF_SDR3(_1096, _1097, _1098);
  CAPTURE_TONEMAPPED(float3(_1096, _1097, _1098));
  float _1113 = (saturate((log2(_1098 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _1117 = (saturate((log2(_1097 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _1121 = (saturate((log2(_1096 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  [branch]
  if (!(cb0_107w == 0)) {
    float4 _1142 = t5.Sample(s5, float2(min(max(((cb0_084z * _429) + cb0_085x), cb0_083z), cb0_084x), min(max(((cb0_084w * _430) + cb0_085y), cb0_083w), cb0_084y)));
    float _1152 = select((((uint)(uint(float((uint)((int)((uint)(uint(round(_1142.w * 255.0f))) & 15))))) & -4) == 12), 1.0f, 0.0f);
    float4 _1153 = t9.Sample(s9, float3(_1121, _1117, _1113));
    float4 _1160 = t8.Sample(s8, float3(_1121, _1117, _1113));
    _1185 = ((((_1160.x - _1153.x) * 1.0499999523162842f) * _1152) + (_1153.x * 1.0499999523162842f));
    _1186 = ((((_1160.y - _1153.y) * 1.0499999523162842f) * _1152) + (_1153.y * 1.0499999523162842f));
    _1187 = ((((_1160.z - _1153.z) * 1.0499999523162842f) * _1152) + (_1153.z * 1.0499999523162842f));
  } else {
    float4 _1177 = t8.Sample(s8, float3(_1121, _1117, _1113));
    _1185 = (_1177.x * 1.0499999523162842f);
    _1186 = (_1177.y * 1.0499999523162842f);
    _1187 = (_1177.z * 1.0499999523162842f);
  }
  HANDLE_LUT_OUTPUT3_FADE(_1185, _1186, _1187, t8, s8);
  float _1195 = ((_344 * 0.00390625f) + -0.001953125f) + _1185;
  float _1196 = ((_365 * 0.00390625f) + -0.001953125f) + _1186;
  float _1197 = ((_366 * 0.00390625f) + -0.001953125f) + _1187;
  [branch]
  if (!(cb0_106w == 0)) {
    float _1209 = (pow(_1195, 0.012683313339948654f));
    float _1210 = (pow(_1196, 0.012683313339948654f));
    float _1211 = (pow(_1197, 0.012683313339948654f));
    float _1244 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1209 + -0.8359375f)) / (18.8515625f - (_1209 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    float _1245 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1210 + -0.8359375f)) / (18.8515625f - (_1210 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    float _1246 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1211 + -0.8359375f)) / (18.8515625f - (_1211 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    _1272 = min((_1244 * 12.920000076293945f), ((exp2(log2(max(_1244, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1273 = min((_1245 * 12.920000076293945f), ((exp2(log2(max(_1245, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1274 = min((_1246 * 12.920000076293945f), ((exp2(log2(max(_1246, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _1272 = _1195;
    _1273 = _1196;
    _1274 = _1197;
  ...
  SV_Target.y = _1273;
  SV_Target.z = _1274;
  SV_Target.w = dot(float3(_1185, _1186, _1187), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f));
