...
float4 main(
  ...
  float _699 = (((_605 + ((_539 * TEXCOORD_1.x) * cb0_086x)) * _381) * ((_647 * (_648 - cb0_089x)) + cb0_089x)) * ((_686 * (_687 - cb0_092x)) + cb0_092x);
  float _702 = (((_606 + ((_540 * TEXCOORD_1.x) * cb0_086y)) * _381) * ((_647 * (_648 - cb0_089y)) + cb0_089y)) * ((_686 * (_687 - cb0_092y)) + cb0_092y);
  float _705 = (((_607 + ((_541 * TEXCOORD_1.x) * cb0_086z)) * _381) * ((_647 * (_648 - cb0_089z)) + cb0_089z)) * ((_686 * (_687 - cb0_092z)) + cb0_092z);

  CAPTURE_UNTONEMAPPED(float3(_699, _702, _705));

  [branch]
  if (false) {
    float _719 = ((((cb0_111z + 1.0f) * 0.009900989942252636f) * (cb0_111x - cb0_111y)) + cb0_111y) * -1.4426950216293335f;
    _730 = (1.0f - exp2(_719 * _699));
    _731 = (1.0f - exp2(_719 * _702));
    _732 = (1.0f - exp2(_719 * _705));
  } else {
    _730 = _699;
    _731 = _702;
    _732 = _705;
  ...
  [branch]
  if (WUWA_TM_IS(1)) {
    _765 = ((((_730 * 1.3600000143051147f) + 0.04699999839067459f) * _730) / ((((_730 * 0.9599999785423279f) + 0.5600000023841858f) * _730) + 0.14000000059604645f));
    _766 = ((((_731 * 1.3600000143051147f) + 0.04699999839067459f) * _731) / ((((_731 * 0.9599999785423279f) + 0.5600000023841858f) * _731) + 0.14000000059604645f));
    _767 = ((((_732 * 1.3600000143051147f) + 0.04699999839067459f) * _732) / ((((_732 * 0.9599999785423279f) + 0.5600000023841858f) * _732) + 0.14000000059604645f));
  } else {
    _765 = _730;
    _766 = _731;
    _767 = _732;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _777 = 1.0049500465393066f - (0.16398000717163086f / (_765 + -0.19505000114440918f));
    float _778 = 1.0049500465393066f - (0.16398000717163086f / (_766 + -0.19505000114440918f));
    float _779 = 1.0049500465393066f - (0.16398000717163086f / (_767 + -0.19505000114440918f));
    _799 = (((_765 - _777) * select((_765 > 0.6000000238418579f), 0.0f, 1.0f)) + _777);
    _800 = (((_766 - _778) * select((_766 > 0.6000000238418579f), 0.0f, 1.0f)) + _778);
    _801 = (((_767 - _779) * select((_767 > 0.6000000238418579f), 0.0f, 1.0f)) + _779);
  } else {
    _799 = _765;
    _800 = _766;
    _801 = _767;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _807 = cb0_037y * _799;
    float _808 = cb0_037y * _800;
    float _809 = cb0_037y * _801;
    float _812 = cb0_037z * cb0_037w;
    float _822 = cb0_038y * cb0_038x;
    float _833 = cb0_038z * cb0_038x;
    float _840 = cb0_038y / cb0_038z;
    _848 = (((((_812 + _807) * _799) + _822) / (((_807 + cb0_037z) * _799) + _833)) - _840);
    _849 = (((((_812 + _808) * _800) + _822) / (((_808 + cb0_037z) * _800) + _833)) - _840);
    _850 = (((((_812 + _809) * _801) + _822) / (((_809 + cb0_037z) * _801) + _833)) - _840);
  } else {
    _848 = _799;
    _849 = _800;
    _850 = _801;
  ...
  if (!((uint)(cb0_105w) == 0)) {
    if (!(cb0_106x == 1.0f)) {
      float _860 = (cb0_106x * 0.699999988079071f) + 0.30000001192092896f;
      _865 = (_860 * _848);
      _866 = (_860 * _849);
      _867 = (_860 * _850);
    } else {
  ...
  CLAMP_IF_SDR3(_865, _866, _867);
  CAPTURE_TONEMAPPED(float3(_865, _866, _867));

  float _882 = (saturate((log2(_867 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _886 = (saturate((log2(_866 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _890 = (saturate((log2(_865 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  [branch]
  if (!((uint)(cb0_107w) == 0)) {
    float4 _911 = t5.Sample(s5, float2(min(max(((cb0_084z * _422) + cb0_085x), cb0_083z), cb0_084x), min(max(((cb0_084w * _423) + cb0_085y), cb0_083w), cb0_084y)));
    float _921 = select((((uint)(uint(float((uint)((int)((uint)(uint(round(_911.w * 255.0f))) & 15))))) & -4) == 12), 1.0f, 0.0f);
    float4 _922 = t7.Sample(s7, float3(_890, _886, _882));
    float4 _929 = t6.Sample(s6, float3(_890, _886, _882));
    _954 = ((((_929.x - _922.x) * 1.0499999523162842f) * _921) + (_922.x * 1.0499999523162842f));
    _955 = ((((_929.y - _922.y) * 1.0499999523162842f) * _921) + (_922.y * 1.0499999523162842f));
    _956 = ((((_929.z - _922.z) * 1.0499999523162842f) * _921) + (_922.z * 1.0499999523162842f));
  } else {
    float4 _946 = t6.Sample(s6, float3(_890, _886, _882));
    _954 = (_946.x * 1.0499999523162842f);
    _955 = (_946.y * 1.0499999523162842f);
    _956 = (_946.z * 1.0499999523162842f);
  }
  HANDLE_LUT_OUTPUT3_FADE(_954, _955, _956, t6, s6);

  float _964 = ((_337 * 0.00390625f) + -0.001953125f) + _954;
  float _965 = ((_358 * 0.00390625f) + -0.001953125f) + _955;
  float _966 = ((_359 * 0.00390625f) + -0.001953125f) + _956;
  [branch]
  if (!((uint)(cb0_106w) == 0)) {
    ...
    float _1013 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_978 + -0.8359375f)) / (18.8515625f - (_978 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    float _1014 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_979 + -0.8359375f)) / (18.8515625f - (_979 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    float _1015 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_980 + -0.8359375f)) / (18.8515625f - (_980 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
