...
float4 main(
  ...
  HANDLE_LUT_OUTPUT3_FADE(_476, _477, _478, t4, s4);
  ...
  GENERATE_INVERSION(_563, _564, _565);

  float _574 = ((((_564 * 587.0f) + (_563 * 299.0f)) + (_565 * 114.0f)) * 0.0010000000474974513f) - cb0_108w;
  float _581 = saturate(float(((int)(uint)((bool)(_574 > 0.0f))) - ((int)(uint)((bool)(_574 < 0.0f)))));
  float _588 = cb0_109x - _563;
  float _589 = cb0_109y - _564;
  float _590 = cb0_109z - _565;

  float _595 = WUWA_PEAK_SCALING * cb0_110x - _563;
  float _596 = WUWA_PEAK_SCALING * cb0_110y - _564;
  float _597 = WUWA_PEAK_SCALING * cb0_110z - _565;
  ...
  SV_Target.x = (((lerp(_614, _617, _581)) * cb0_108y) + _563);
  SV_Target.y = (((lerp(_615, _618, _581)) * cb0_108y) + _564);
  SV_Target.z = (((lerp(_616, _619, _581)) * cb0_108y) + _565);
