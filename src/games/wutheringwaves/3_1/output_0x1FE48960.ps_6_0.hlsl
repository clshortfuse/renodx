...
float4 main(
  ...
  float _866 = ((((_762 + ((_696 * TEXCOORD_1.x) * cb0_086x)) * _381) * ((_804 * (_805 - cb0_089x)) + cb0_089x)) * ((_843 * (_844 - cb0_092x)) + cb0_092x)) * ((cb0_095x * _337) + cb0_095y);
  float _870 = ((((_763 + ((_697 * TEXCOORD_1.x) * cb0_086y)) * _381) * ((_804 * (_805 - cb0_089y)) + cb0_089y)) * ((_843 * (_844 - cb0_092y)) + cb0_092y)) * ((cb0_095x * _358) + cb0_095y);
  float _874 = ((((_764 + ((_698 * TEXCOORD_1.x) * cb0_086z)) * _381) * ((_804 * (_805 - cb0_089z)) + cb0_089z)) * ((_843 * (_844 - cb0_092z)) + cb0_092z)) * ((cb0_095x * _359) + cb0_095y);

  CAPTURE_UNTONEMAPPED(float3(_866, _870, _874));

  [branch]
  if (false) {
    float _888 = ((((cb0_111z + 1.0f) * 0.009900989942252636f) * (cb0_111x - cb0_111y)) + cb0_111y) * -1.4426950216293335f;
    _899 = (1.0f - exp2(_888 * _866));
    _900 = (1.0f - exp2(_888 * _870));
    _901 = (1.0f - exp2(_888 * _874));
  } else {
    _899 = _866;
    _900 = _870;
    _901 = _874;
  ...
  [branch]
  if (WUWA_TM_IS(1)) {
    _934 = ((((_899 * 1.3600000143051147f) + 0.04699999839067459f) * _899) / ((((_899 * 0.9599999785423279f) + 0.5600000023841858f) * _899) + 0.14000000059604645f));
    ...
    _936 = ((((_901 * 1.3600000143051147f) + 0.04699999839067459f) * _901) / ((((_901 * 0.9599999785423279f) + 0.5600000023841858f) * _901) + 0.14000000059604645f));
  } else {
    _934 = _899;
    _935 = _900;
    _936 = _901;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _946 = 1.0049500465393066f - (0.16398000717163086f / (_934 + -0.19505000114440918f));
    float _947 = 1.0049500465393066f - (0.16398000717163086f / (_935 + -0.19505000114440918f));
    float _948 = 1.0049500465393066f - (0.16398000717163086f / (_936 + -0.19505000114440918f));
    ...
    _970 = (((_936 - _948) * select((_936 > 0.6000000238418579f), 0.0f, 1.0f)) + _948);
  } else {
    _968 = _934;
    _969 = _935;
    _970 = _936;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _976 = cb0_037y * _968;
    float _977 = cb0_037y * _969;
    float _978 = cb0_037y * _970;
    float _981 = cb0_037z * cb0_037w;
    float _991 = cb0_038y * cb0_038x;
    float _1002 = cb0_038z * cb0_038x;
    float _1009 = cb0_038y / cb0_038z;
    _1017 = (((((_981 + _976) * _968) + _991) / (((_976 + cb0_037z) * _968) + _1002)) - _1009);
    _1018 = (((((_981 + _977) * _969) + _991) / (((_977 + cb0_037z) * _969) + _1002)) - _1009);
    _1019 = (((((_981 + _978) * _970) + _991) / (((_978 + cb0_037z) * _970) + _1002)) - _1009);
  } else {
    _1017 = _968;
    _1018 = _969;
    _1019 = _970;
  ...
  if (!((uint)(cb0_105w) == 0)) {
    if (!(cb0_106x == 1.0f)) {
      float _1029 = (cb0_106x * 0.699999988079071f) + 0.30000001192092896f;
      _1034 = (_1029 * _1017);
      _1035 = (_1029 * _1018);
      _1036 = (_1029 * _1019);
    } else {
  ...
  CLAMP_IF_SDR3(_1034, _1035, _1036);
  CAPTURE_TONEMAPPED(float3(_1034, _1035, _1036));

  float _1051 = (saturate((log2(_1036 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _1055 = (saturate((log2(_1035 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _1059 = (saturate((log2(_1034 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  [branch]
  if (!((uint)(cb0_107w) == 0)) {
    float4 _1080 = t5.Sample(s5, float2(min(max(((cb0_084z * _422) + cb0_085x), cb0_083z), cb0_084x), min(max(((cb0_084w * _423) + cb0_085y), cb0_083w), cb0_084y)));
    float _1090 = select((((uint)(uint(float((uint)((int)((uint)(uint(round(_1080.w * 255.0f))) & 15))))) & -4) == 12), 1.0f, 0.0f);
    float4 _1091 = t7.Sample(s7, float3(_1059, _1055, _1051));
    float4 _1098 = t6.Sample(s6, float3(_1059, _1055, _1051));
    _1123 = ((((_1098.x - _1091.x) * 1.0499999523162842f) * _1090) + (_1091.x * 1.0499999523162842f));
    _1124 = ((((_1098.y - _1091.y) * 1.0499999523162842f) * _1090) + (_1091.y * 1.0499999523162842f));
    _1125 = ((((_1098.z - _1091.z) * 1.0499999523162842f) * _1090) + (_1091.z * 1.0499999523162842f));
  } else {
    float4 _1115 = t6.Sample(s6, float3(_1059, _1055, _1051));
    _1123 = (_1115.x * 1.0499999523162842f);
    _1124 = (_1115.y * 1.0499999523162842f);
    _1125 = (_1115.z * 1.0499999523162842f);
  }
  HANDLE_LUT_OUTPUT3_FADE(_1123, _1124, _1125, t6, s6);

  float _1133 = ((_337 * 0.00390625f) + -0.001953125f) + _1123;
  float _1134 = ((_358 * 0.00390625f) + -0.001953125f) + _1124;
  float _1135 = ((_359 * 0.00390625f) + -0.001953125f) + _1125;
  [branch]
  if (!((uint)(cb0_106w) == 0)) {
    ...
    float _1182 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1147 + -0.8359375f)) / (18.8515625f - (_1147 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    float _1183 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1148 + -0.8359375f)) / (18.8515625f - (_1148 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    float _1184 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1149 + -0.8359375f)) / (18.8515625f - (_1149 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
  ...
  SV_Target.w = (dot(float3(_1123, _1124, _1125), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
