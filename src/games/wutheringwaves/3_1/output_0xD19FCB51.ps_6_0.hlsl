...
float4 main(
  ...
  HANDLE_LUT_OUTPUT3(_601, _602, _603);
  ...
  GENERATE_INVERSION(_688, _689, _690);

  float _699 = ((((_689 * 587.0f) + (_688 * 299.0f)) + (_690 * 114.0f)) * 0.0010000000474974513f) - cb0_108w;
  float _706 = saturate(float(((int)(uint)((bool)(_699 > 0.0f))) - ((int)(uint)((bool)(_699 < 0.0f)))));
  float _713 = cb0_109x - _688;
  float _714 = cb0_109y - _689;
  float _715 = cb0_109z - _690;

  float _720 = WUWA_PEAK_SCALING * cb0_110x - _688;
  float _721 = WUWA_PEAK_SCALING * cb0_110y - _689;
  float _722 = WUWA_PEAK_SCALING * cb0_110z - _690;
  ...
  SV_Target.x = (((lerp(_739, _742, _706)) * cb0_108y) + _688);
  SV_Target.y = (((lerp(_740, _743, _706)) * cb0_108y) + _689);
  SV_Target.z = (((lerp(_741, _744, _706)) * cb0_108y) + _690);
