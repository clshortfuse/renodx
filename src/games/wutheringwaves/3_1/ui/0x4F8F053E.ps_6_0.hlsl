...
float4 main(
  ...
  float _116 = _113 * _77;
  float _117 = _114 * _78;
  float _147 = ((SV_Position.x - View_2144.x) * View_2160.z) - (Material_000[3].x);
  float _148 = (1.0f - ((SV_Position.y - View_2144.y) * View_2160.w)) - (Material_000[3].y);
  float _149 = _81.w * COLOR.w;
  float _178 = mad(_67, (Primitive_096[2].x), mad(_66, (Primitive_096[1].x), ((Primitive_096[0].x) * _65))) + (Primitive_096[3].x);
  float _182 = mad(_67, (Primitive_096[2].y), mad(_66, (Primitive_096[1].y), ((Primitive_096[0].y) * _65))) + (Primitive_096[3].y);
  float _210 = saturate(((1.0f - saturate((((-0.0f - (Material_000[3].y)) - (Material_000[4].y)) + _182) / (Material_000[8].y))) - saturate((((Material_000[3].y) - (Material_000[4].y)) - _182) / (Material_000[8].w))) * ((1.0f - saturate((((Material_000[3].x) - (Material_000[4].x)) - _178) / (Material_000[8].x))) - saturate((((-0.0f - (Material_000[3].x)) - (Material_000[4].x)) + _178) / (Material_000[8].z))));
  float _214 = (_210 * _210) * (3.0f - (_210 * 2.0f));
  float _231 = saturate(select(((bool)((Material_144[2].w) >= 0.5f) && (bool)(abs((Material_144[2].w) + -0.5f) > 9.999999747378752e-06f)), select(((bool)(_148 > (Material_000[4].y)) || ((bool)((bool)(_147 > (Material_000[4].x)) || ((bool)((bool)(_147 < (-0.0f - (Material_000[4].x))) || (bool)(_148 < (-0.0f - (Material_000[4].y)))))))), 0.0f, _149), (select(((bool)(abs(Material_144[2].z) > 9.999999747378752e-06f) && (bool)((Material_144[2].z) >= 0.0f)), (1.0f - _214), _214) * _149)));
  ...
  [branch]
  if ((bool)(_269 > 0.029999999329447746f) && (bool)(TranslucentBasePass_4352 != 0)) {
    do {
      [branch]
      if (TranslucentBasePass_4368 == 0.0f) {
        float _313 = ((((TranslucentBasePass_4424 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4416 - TranslucentBasePass_4420)) + TranslucentBasePass_4420) * ((((TranslucentBasePass_4356 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4360 - TranslucentBasePass_4364)) + TranslucentBasePass_4364);
        float _314 = _313 * _270;
        float _315 = _313 * _271;
        float _316 = _313 * _272;
        float _321 = max((_314 - TranslucentBasePass_4412), 0.0f);
        float _322 = max((_315 - TranslucentBasePass_4412), 0.0f);
        float _323 = max((_316 - TranslucentBasePass_4412), 0.0f);
        float _336 = TranslucentBasePass_4396 * -1.4426950216293335f;
        float _343 = 1.0f - exp2((((_321 / (_321 + 1.0f)) - _321) + _314) * _336);
        float _344 = 1.0f - exp2((((_322 / (_322 + 1.0f)) - _322) + _315) * _336);
        float _345 = 1.0f - exp2((((_323 / (_323 + 1.0f)) - _323) + _316) * _336);
        float _346 = _343 * TranslucentBasePass_4372;
        float _347 = _344 * TranslucentBasePass_4372;
        float _348 = _345 * TranslucentBasePass_4372;
        float _349 = TranslucentBasePass_4380 * TranslucentBasePass_4376;
        float _356 = TranslucentBasePass_4388 * TranslucentBasePass_4384;
        float _366 = TranslucentBasePass_4392 * TranslucentBasePass_4384;
        float _373 = TranslucentBasePass_4388 / TranslucentBasePass_4392;
        float _389 = saturate(((saturate(((((_346 + _349) * _343) + _356) / (((_346 + TranslucentBasePass_4376) * _343) + _366)) - _373) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _390 = saturate(((saturate(((((_347 + _349) * _344) + _356) / (((_347 + TranslucentBasePass_4376) * _344) + _366)) - _373) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _391 = saturate(((saturate(((((_348 + _349) * _345) + _356) / (((_348 + TranslucentBasePass_4376) * _345) + _366)) - _373) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _392 = dot(float3(_389, _390, _391), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
        float _405 = 1.0f / TranslucentBasePass_4404;
        _416 = exp2(log2(saturate(lerp(_392, _389, TranslucentBasePass_4408))) * _405);
        _417 = exp2(log2(saturate(lerp(_392, _390, TranslucentBasePass_4408))) * _405);
        _418 = exp2(log2(saturate(lerp(_392, _391, TranslucentBasePass_4408))) * _405);
      } else {
        _416 = _270;
        _417 = _271;
        _418 = _272;
      ...
      if (TranslucentBasePass_4368 == 1.0f) {
        float _423 = TranslucentBasePass_4396 * -1.4426950216293335f;
        float _435 = 1.0f / TranslucentBasePass_4404;
        _446 = exp2(log2(1.0f - exp2(_423 * _416)) * _435);
        _447 = exp2(log2(1.0f - exp2(_423 * _417)) * _435);
        _448 = exp2(log2(1.0f - exp2(_423 * _418)) * _435);
      } else {
        _446 = _416;
        _447 = _417;
        _448 = _418;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _446), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _447), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _448), 0.0f));
  SV_Target.w = _269;
