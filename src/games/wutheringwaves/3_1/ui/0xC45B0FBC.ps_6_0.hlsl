...
float4 main(
  ...
  float _197 = View_2376 * (Material_576[4].w);
  float _200 = (Material_576[5].x) + _197;
  float4 _205 = t2.SampleBias(s2, float2(((((_185 * (Material_576[4].y)) + _181) * (Material_576[4].z)) + _200), ((((_186 * (Material_576[4].y)) + _182) * (Material_576[4].z)) + _200)), View_2388, int2(0, 0));
  ...
  float _228 = (Material_576[5].y) * _224.x;
  float _229 = _228 * _205.x;
  float _230 = _228 * _205.y;
  float _231 = _228 * _205.z;
  float _263 = (Material_576[6].x) * View_2376;
  float4 _268 = t4.SampleBias(s4, float2((_263 + ((((Material_576[5].z) * _109) + _95) * (Material_576[5].w))), (_263 + ((((Material_576[5].z) * _110) + _96) * (Material_576[5].w)))), View_2388, int2(0, 0));
  float _280 = (frac(((View_2376 * 0.009999999776482582f) * (Material_576[6].y)) + _268.x) * 100.0f) / (Material_576[6].z);
  float _284 = frac(abs(_280));
  float _287 = select((_280 >= (-0.0f - _280)), _284, (-0.0f - _284)) * (Material_576[6].z);
  float _296 = 1.0f - (abs(_287 - (Material_576[7].x)) / (Material_576[7].x));
  float _303 = select((_296 <= 2.980232949312267e-08f), 0.0f, exp2(log2(_296) * (Material_576[7].y))) * select(((Material_576[6].w) < _287), 0.0f, 1.0f);
  float _316 = abs(_105 - (MaterialCollection0_000[0].x));
  float _321 = abs(_106 - (MaterialCollection0_000[0].y));
  float _326 = (View_2160.x / View_2160.y) * (Material_576[7].z);
  float _335 = (((((Material_576[7].z) - _316) / (Material_576[7].z)) * select(((Material_576[7].z) < _316), 0.0f, 1.0f)) * ((_326 - _321) / _326)) * select((_326 < _321), 0.0f, 1.0f);
  float _341 = select((_335 <= 2.980232949312267e-08f), 0.0f, exp2(log2(_335) * (Material_576[7].w)));
  float _357 = select(((Material_576[8].x) < _105), 0.0f, 1.0f) * ((Material_576[8].x) - _105);
  float _373 = select((_105 < (Material_576[8].z)), 0.0f, 1.0f) * ((_105 + -1.0f) + (Material_576[8].x));
  float _380 = (MaterialCollection0_000[0].z) * (select((_357 <= 2.980232949312267e-08f), 0.0f, exp2(log2(_357) * (Material_576[8].y))) - select((_373 <= 2.980232949312267e-08f), 0.0f, exp2(log2(_373) * (Material_576[8].y))));
  float _381 = _380 * (Material_000[19].x);
  float _382 = _380 * (Material_000[19].y);
  float _383 = _380 * (Material_000[19].z);
  float _399 = ((((select((_229 <= 2.980232949312267e-08f), 0.0f, (_229 * _229)) * (Material_000[13].x)) + (select(((_158.x * select((_131.x <= 2.980232949312267e-08f), 0.0f, (exp2(log2(_131.x)) * 2.0f))) < (Material_576[2].w)), 0.0f, 1.0f) * (Material_000[7].x))) + min(max((((_341 * (Material_000[17].x)) + ((Material_000[15].x) * _303)) + _381), 0.0f), 1.0f)) + _381) + (Material_000[21].x);
  float _402 = ((((select((_230 <= 2.980232949312267e-08f), 0.0f, (_230 * _230)) * (Material_000[13].y)) + (select(((_158.x * select((_131.y <= 2.980232949312267e-08f), 0.0f, (exp2(log2(_131.y)) * 2.0f))) < (Material_576[2].w)), 0.0f, 1.0f) * (Material_000[7].y))) + _382) + min(max((((_341 * (Material_000[17].y)) + ((Material_000[15].y) * _303)) + _382), 0.0f), 1.0f)) + (Material_000[21].y);
  float _405 = ((((select((_231 <= 2.980232949312267e-08f), 0.0f, (_231 * _231)) * (Material_000[13].z)) + (select(((_158.x * select((_131.z <= 2.980232949312267e-08f), 0.0f, (exp2(log2(_131.z)) * 2.0f))) < (Material_576[2].w)), 0.0f, 1.0f) * (Material_000[7].z))) + _383) + min(max((((_341 * (Material_000[17].z)) + ((Material_000[15].z) * _303)) + _383), 0.0f), 1.0f)) + (Material_000[21].z);
  float4 _406 = t5.SampleBias(s5, float2(_95, _96), View_2388, int2(0, 0));
  float4 _410 = t6.SampleBias(s6, float2(_95, _96), View_2388, int2(0, 0));
  float _416 = _410.w * (Material_576[8].w);
  float4 _423 = t7.SampleBias(s7, float2(_95, _96), View_2388, int2(0, 0));
  float _430 = (Material_576[9].x) * _423.x;
  float _433 = select((_430 < 0.10000000149011612f), 0.0f, 1.0f) * _430;
  float _444 = (View_2376 * 0.10000000149011612f) * (Material_576[9].w);
  float4 _449 = t8.SampleBias(s8, float2((_444 + ((Material_576[9].z) * TEXCOORD.x)), (_444 + ((Material_576[9].z) * TEXCOORD.y))), View_2388, int2(0, 0));
  float _455 = ((_449.x + 0.10000002384185791f) * 0.5f) * (Material_576[10].x);
  float _460 = (Material_576[9].x) * _423.y;
  float _463 = select((_460 < 0.10000000149011612f), 0.0f, 1.0f) * _460;
  float _471 = (Material_576[9].x) * _423.z;
  float _474 = select((_471 < 0.10000000149011612f), 0.0f, 1.0f) * _471;
  float _481 = (Material_576[9].x) * _423.w;
  float _484 = select((_481 < 0.10000000149011612f), 0.0f, 1.0f) * _481;
  float _498 = (Material_576[11].z) - _105;
  float _500 = ((Material_576[11].y) - _106) * (View_2160.z / View_2160.w);
  float4 _503 = t3.SampleBias(s3, float2(_105, _106), View_2388, int2(0, 0));
  float _506 = (_503.x * -0.20000000298023224f) - sqrt(dot(float2(_498, _500), float2(_498, _500)));
  float4 _518 = t9.SampleBias(s9, float2(_95, _96), View_2388, int2(0, 0));
  float _523 = _518.x * (Material_576[9].x);
  float _526 = select((_523 < 0.10000000149011612f), 0.0f, 1.0f) * _523;
  float _533 = _518.y * (Material_576[9].x);
  float _536 = select((_533 < 0.10000000149011612f), 0.0f, 1.0f) * _533;
  float _543 = _518.z * (Material_576[9].x);
  float _546 = select((_543 < 0.10000000149011612f), 0.0f, 1.0f) * _543;
  float _553 = _518.w * (Material_576[9].x);
  float _556 = select((_553 < 0.10000000149011612f), 0.0f, 1.0f) * _553;
  float _575 = saturate(saturate(dot(float4(((((select(((Material_576[9].y) < _526), -0.0f, -2.0f) * _526) + _518.x) * _455) + _526), ((((select(((Material_576[9].y) < _536), -0.0f, -2.0f) * _536) + _518.y) * _455) + _536), ((((select(((Material_576[9].y) < _546), -0.0f, -2.0f) * _546) + _518.z) * _455) + _546), ((((select(((Material_576[9].y) < _556), -0.0f, -2.0f) * _556) + _518.w) * _455) + _556)), float4(((Material_000[31].x) + _506), ((Material_000[31].y) + _506), ((Material_000[31].z) + _506), ((Material_000[31].w) + _506)))) + saturate(dot(float4(((_455 * ((select(((Material_576[9].y) < _433), -0.0f, -2.0f) * _433) + _423.x)) + _433), ((((select(((Material_576[9].y) < _463), -0.0f, -2.0f) * _463) + _423.y) * _455) + _463), ((((select(((Material_576[9].y) < _474), -0.0f, -2.0f) * _474) + _423.z) * _455) + _474), ((((select(((Material_576[9].y) < _484), -0.0f, -2.0f) * _484) + _423.w) * _455) + _484)), float4((_506 + (Material_000[26].x)), (_506 + (Material_000[26].y)), (_506 + (Material_000[26].z)), (_506 + (Material_000[26].w))))));
  float _585 = (_575 * ((_406.x - _399) + (_416 * (_410.x - _406.x)))) + _399;
  float _586 = (_575 * ((_406.y - _402) + (_416 * (_410.y - _406.y)))) + _402;
  float _587 = (_575 * ((_406.z - _405) + (_416 * (_410.z - _406.z)))) + _405;
  float4 _604 = t10.SampleBias(s10, float2(((Material_576[13].x) * (((Material_576[12].w) * View_2376) + abs(((_96 + _95) * 2.0f) + -2.0f))), saturate((Material_576[13].y) + _575)), View_2388, int2(0, 0));
  float _620 = ((((Material_576[13].z) * _604.x) - _585) * _604.w) + _585;
  float _621 = ((((Material_576[13].z) * _604.y) - _586) * _604.w) + _586;
  float _622 = ((((Material_576[13].z) * _604.z) - _587) * _604.w) + _587;
  float _648;
  float _649;
  float _650;
  float _743;
  ...
  if ((Material_576[13].w) > 0.5f) {
    _648 = max(((exp2(log2(max(_620, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _649 = max(((exp2(log2(max(_621, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _650 = max(((exp2(log2(max(_622, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
  } else {
    _648 = _620;
    _649 = _621;
    _650 = _622;
  }
  float4 _699 = t11.SampleBias(s11, float2((((mad(_86, (Primitive_096[2].x), mad(_85, (Primitive_096[1].x), ((Primitive_096[0].x) * _84))) + (Primitive_096[3].x)) - (Material_000[34].x)) / (Material_000[35].x)), (1.0f - (((mad(_86, (Primitive_096[2].y), mad(_85, (Primitive_096[1].y), ((Primitive_096[0].y) * _84))) + (Primitive_096[3].y)) - (Material_000[34].y)) / (Material_000[35].y)))), View_2388, int2(0, 0));
  float _705 = saturate(saturate((Material_576[15].y) * _699.x));
  float _706 = max(((((Material_000[32].x) - _648) * (Material_576[14].x)) + _648), 0.0f);
  float _707 = max(((((Material_000[32].y) - _649) * (Material_576[14].x)) + _649), 0.0f);
  float _708 = max(((((Material_000[32].z) - _650) * (Material_576[14].x)) + _650), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_83 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_81 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_82 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      float _740 = float((bool)(bool)(frac(dot(float3(_81, _82, _83), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _743 = 1.0f;
      _744 = (1.0f - _740);
      _745 = 1.0f;
      _746 = _740;
  ...
  [branch]
  if ((bool)(_743 > 0.029999999329447746f) && (bool)(TranslucentBasePass_4352 != 0)) {
    do {
      [branch]
      if (TranslucentBasePass_4368 == 0.0f) {
        float _787 = ((((TranslucentBasePass_4424 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4416 - TranslucentBasePass_4420)) + TranslucentBasePass_4420) * ((((TranslucentBasePass_4356 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4360 - TranslucentBasePass_4364)) + TranslucentBasePass_4364);
        float _788 = _787 * _744;
        float _789 = _787 * _745;
        float _790 = _787 * _746;
        float _795 = max((_788 - TranslucentBasePass_4412), 0.0f);
        float _796 = max((_789 - TranslucentBasePass_4412), 0.0f);
        float _797 = max((_790 - TranslucentBasePass_4412), 0.0f);
        float _810 = TranslucentBasePass_4396 * -1.4426950216293335f;
        float _817 = 1.0f - exp2((((_795 / (_795 + 1.0f)) - _795) + _788) * _810);
        float _818 = 1.0f - exp2((((_796 / (_796 + 1.0f)) - _796) + _789) * _810);
        float _819 = 1.0f - exp2((((_797 / (_797 + 1.0f)) - _797) + _790) * _810);
        float _820 = _817 * TranslucentBasePass_4372;
        float _821 = _818 * TranslucentBasePass_4372;
        float _822 = _819 * TranslucentBasePass_4372;
        float _823 = TranslucentBasePass_4380 * TranslucentBasePass_4376;
        float _830 = TranslucentBasePass_4388 * TranslucentBasePass_4384;
        float _840 = TranslucentBasePass_4392 * TranslucentBasePass_4384;
        float _847 = TranslucentBasePass_4388 / TranslucentBasePass_4392;
        float _863 = saturate(((saturate(((((_820 + _823) * _817) + _830) / (((_820 + TranslucentBasePass_4376) * _817) + _840)) - _847) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _864 = saturate(((saturate(((((_821 + _823) * _818) + _830) / (((_821 + TranslucentBasePass_4376) * _818) + _840)) - _847) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _865 = saturate(((saturate(((((_822 + _823) * _819) + _830) / (((_822 + TranslucentBasePass_4376) * _819) + _840)) - _847) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _866 = dot(float3(_863, _864, _865), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
        float _879 = 1.0f / TranslucentBasePass_4404;
        _890 = exp2(log2(saturate(lerp(_866, _863, TranslucentBasePass_4408))) * _879);
        _891 = exp2(log2(saturate(lerp(_866, _864, TranslucentBasePass_4408))) * _879);
        _892 = exp2(log2(saturate(lerp(_866, _865, TranslucentBasePass_4408))) * _879);
      } else {
        _890 = _744;
        _891 = _745;
        _892 = _746;
      ...
      if (TranslucentBasePass_4368 == 1.0f) {
        float _897 = TranslucentBasePass_4396 * -1.4426950216293335f;
        float _909 = 1.0f / TranslucentBasePass_4404;
        _920 = exp2(log2(1.0f - exp2(_897 * _890)) * _909);
        _921 = exp2(log2(1.0f - exp2(_897 * _891)) * _909);
        _922 = exp2(log2(1.0f - exp2(_897 * _892)) * _909);
      } else {
        _920 = _890;
        _921 = _891;
        _922 = _892;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _920), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _921), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _922), 0.0f));
  SV_Target.w = _743;
