...
float4 main(
  ...
  float4 _116 = t0.SampleBias(s0, float2(((min(max(frac(((Material_000[5].x) * ((TEXCOORD.x - (Material_000[3].x)) / (Material_000[4].x))) + (Material_000[6].x)), (Material_256[0].y)), (Material_256[2].z)) * (Material_000[4].x)) + (Material_000[3].x)), ((min(max(frac(((Material_000[5].y) * ((TEXCOORD.y - (Material_000[3].y)) / (Material_000[4].y))) + (Material_000[6].y)), (Material_256[0].y)), (Material_256[2].z)) * (Material_000[4].y)) + (Material_000[3].y))), View_2388, int2(0, 0));
  if ((Material_256[0].x) > 0.5f) {
  ...
  [branch]
  if ((bool)(_286 > 0.029999999329447746f) && (bool)(TranslucentBasePass_4352 != 0)) {
    do {
      [branch]
      if (TranslucentBasePass_4368 == 0.0f) {
        float _330 = ((((TranslucentBasePass_4424 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4416 - TranslucentBasePass_4420)) + TranslucentBasePass_4420) * ((((TranslucentBasePass_4356 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4360 - TranslucentBasePass_4364)) + TranslucentBasePass_4364);
        float _331 = _330 * _287;
        float _332 = _330 * _288;
        float _333 = _330 * _289;
        float _338 = max((_331 - TranslucentBasePass_4412), 0.0f);
        float _339 = max((_332 - TranslucentBasePass_4412), 0.0f);
        float _340 = max((_333 - TranslucentBasePass_4412), 0.0f);
        float _353 = TranslucentBasePass_4396 * -1.4426950216293335f;
        float _360 = 1.0f - exp2((((_338 / (_338 + 1.0f)) - _338) + _331) * _353);
        float _361 = 1.0f - exp2((((_339 / (_339 + 1.0f)) - _339) + _332) * _353);
        float _362 = 1.0f - exp2((((_340 / (_340 + 1.0f)) - _340) + _333) * _353);
        float _363 = _360 * TranslucentBasePass_4372;
        float _364 = _361 * TranslucentBasePass_4372;
        float _365 = _362 * TranslucentBasePass_4372;
        float _366 = TranslucentBasePass_4380 * TranslucentBasePass_4376;
        float _373 = TranslucentBasePass_4388 * TranslucentBasePass_4384;
        float _383 = TranslucentBasePass_4392 * TranslucentBasePass_4384;
        float _390 = TranslucentBasePass_4388 / TranslucentBasePass_4392;
        float _406 = saturate(((saturate(((((_363 + _366) * _360) + _373) / (((_363 + TranslucentBasePass_4376) * _360) + _383)) - _390) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _407 = saturate(((saturate(((((_364 + _366) * _361) + _373) / (((_364 + TranslucentBasePass_4376) * _361) + _383)) - _390) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _408 = saturate(((saturate(((((_365 + _366) * _362) + _373) / (((_365 + TranslucentBasePass_4376) * _362) + _383)) - _390) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _409 = dot(float3(_406, _407, _408), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
        float _422 = 1.0f / TranslucentBasePass_4404;
        _433 = exp2(log2(saturate(lerp(_409, _406, TranslucentBasePass_4408))) * _422);
        _434 = exp2(log2(saturate(lerp(_409, _407, TranslucentBasePass_4408))) * _422);
        _435 = exp2(log2(saturate(lerp(_409, _408, TranslucentBasePass_4408))) * _422);
      } else {
        _433 = _287;
        _434 = _288;
        _435 = _289;
      ...
      if (TranslucentBasePass_4368 == 1.0f) {
        float _440 = TranslucentBasePass_4396 * -1.4426950216293335f;
        float _452 = 1.0f / TranslucentBasePass_4404;
        _463 = exp2(log2(1.0f - exp2(_440 * _433)) * _452);
        _464 = exp2(log2(1.0f - exp2(_440 * _434)) * _452);
        _465 = exp2(log2(1.0f - exp2(_440 * _435)) * _452);
      } else {
        _463 = _433;
        _464 = _434;
        _465 = _435;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _463), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _464), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _465), 0.0f));
  SV_Target.w = _286;
