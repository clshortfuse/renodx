...
float4 main(
  ...
  float4 SV_Target;
  float4 _47 = t0.SampleLevel(s0, float2((View_2208.z * SV_Position.x), (View_2208.w * SV_Position.y)), 0.0f);
  float _50 = select((SV_Position.z < _47.x), 0.0f, 1.0f);
  float _51 = _50 * COLOR.x;
  float _52 = _50 * COLOR.y;
  float _53 = _50 * COLOR.z;
  float _70 = mad(SV_Position.z, (View_704[2].w), mad(SV_Position.y, (View_704[1].w), ((View_704[0].w) * SV_Position.x))) + (View_704[3].w);
  float _74 = ((mad(SV_Position.z, (View_704[2].x), mad(SV_Position.y, (View_704[1].x), ((View_704[0].x) * SV_Position.x))) + (View_704[3].x)) / _70) - View_1120.x;
  float _75 = ((mad(SV_Position.z, (View_704[2].y), mad(SV_Position.y, (View_704[1].y), ((View_704[0].y) * SV_Position.x))) + (View_704[3].y)) / _70) - View_1120.y;
  float _76 = ((mad(SV_Position.z, (View_704[2].z), mad(SV_Position.y, (View_704[1].z), ((View_704[0].z) * SV_Position.x))) + (View_704[3].z)) / _70) - View_1120.z;
  float _85;
  float _86;
  float _87;
  float _121;
  ...
  float4 _90 = t1.SampleBias(s1, float2(TEXCOORD.x, TEXCOORD.y), View_2388, int2(0, 0));
  if ((Material_032[0].x) > 0.5f) {
    _121 = max(((exp2(log2(max(_90.x, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _122 = max(((exp2(log2(max(_90.y, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _123 = max(((exp2(log2(max(_90.z, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
  } else {
    _121 = _90.x;
    _122 = _90.y;
    _123 = _90.z;
  ...
  float _125 = _122 * _86;
  float _126 = _123 * _87;
  float _142 = saturate((_50 * COLOR.w) * _90.w);
  float _143 = max(((((Material_000[1].x) - _124) * (Material_032[0].y)) + _124), 0.0f);
  float _144 = max(((((Material_000[1].y) - _125) * (Material_032[0].y)) + _125), 0.0f);
  float _145 = max(((((Material_000[1].z) - _126) * (Material_032[0].y)) + _126), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_76 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_74 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_75 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      float _177 = float((bool)(bool)(frac(dot(float3(_74, _75, _76), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _180 = 1.0f;
      _181 = (1.0f - _177);
      _182 = 1.0f;
      _183 = _177;
  ...
  [branch]
  if ((bool)(_180 > 0.029999999329447746f) && (bool)(TranslucentBasePass_4352 != 0)) {
    do {
      [branch]
      if (TranslucentBasePass_4368 == 0.0f) {
        float _224 = ((((TranslucentBasePass_4424 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4416 - TranslucentBasePass_4420)) + TranslucentBasePass_4420) * ((((TranslucentBasePass_4356 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4360 - TranslucentBasePass_4364)) + TranslucentBasePass_4364);
        float _225 = _224 * _181;
        float _226 = _224 * _182;
        float _227 = _224 * _183;
        float _232 = max((_225 - TranslucentBasePass_4412), 0.0f);
        float _233 = max((_226 - TranslucentBasePass_4412), 0.0f);
        float _234 = max((_227 - TranslucentBasePass_4412), 0.0f);
        float _247 = TranslucentBasePass_4396 * -1.4426950216293335f;
        float _254 = 1.0f - exp2((((_232 / (_232 + 1.0f)) - _232) + _225) * _247);
        float _255 = 1.0f - exp2((((_233 / (_233 + 1.0f)) - _233) + _226) * _247);
        float _256 = 1.0f - exp2((((_234 / (_234 + 1.0f)) - _234) + _227) * _247);
        float _257 = _254 * TranslucentBasePass_4372;
        float _258 = _255 * TranslucentBasePass_4372;
        float _259 = _256 * TranslucentBasePass_4372;
        float _260 = TranslucentBasePass_4380 * TranslucentBasePass_4376;
        float _267 = TranslucentBasePass_4388 * TranslucentBasePass_4384;
        float _277 = TranslucentBasePass_4392 * TranslucentBasePass_4384;
        float _284 = TranslucentBasePass_4388 / TranslucentBasePass_4392;
        float _300 = saturate(((saturate(((((_257 + _260) * _254) + _267) / (((_257 + TranslucentBasePass_4376) * _254) + _277)) - _284) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _301 = saturate(((saturate(((((_258 + _260) * _255) + _267) / (((_258 + TranslucentBasePass_4376) * _255) + _277)) - _284) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _302 = saturate(((saturate(((((_259 + _260) * _256) + _267) / (((_259 + TranslucentBasePass_4376) * _256) + _277)) - _284) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _303 = dot(float3(_300, _301, _302), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
        float _316 = 1.0f / TranslucentBasePass_4404;
        _327 = exp2(log2(saturate(lerp(_303, _300, TranslucentBasePass_4408))) * _316);
        _328 = exp2(log2(saturate(lerp(_303, _301, TranslucentBasePass_4408))) * _316);
        _329 = exp2(log2(saturate(lerp(_303, _302, TranslucentBasePass_4408))) * _316);
      } else {
        _327 = _181;
        _328 = _182;
        _329 = _183;
      ...
      if (TranslucentBasePass_4368 == 1.0f) {
        float _334 = TranslucentBasePass_4396 * -1.4426950216293335f;
        float _346 = 1.0f / TranslucentBasePass_4404;
        _357 = exp2(log2(1.0f - exp2(_334 * _327)) * _346);
        _358 = exp2(log2(1.0f - exp2(_334 * _328)) * _346);
        _359 = exp2(log2(1.0f - exp2(_334 * _329)) * _346);
      } else {
        _357 = _327;
        _358 = _328;
        _359 = _329;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _357), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _358), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _359), 0.0f));
  SV_Target.w = _180;
