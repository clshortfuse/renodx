...
float4 main(
  ...
  [branch]
  if ((bool)(_165 > 0.029999999329447746f) && (bool)(TranslucentBasePass_4352 != 0)) {
    do {
      [branch]
      if (TranslucentBasePass_4368 == 0.0f) {
        float _209 = ((((TranslucentBasePass_4424 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4416 - TranslucentBasePass_4420)) + TranslucentBasePass_4420) * ((((TranslucentBasePass_4356 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4360 - TranslucentBasePass_4364)) + TranslucentBasePass_4364);
        float _210 = _209 * _166;
        float _211 = _209 * _167;
        float _212 = _209 * _168;
        float _217 = max((_210 - TranslucentBasePass_4412), 0.0f);
        float _218 = max((_211 - TranslucentBasePass_4412), 0.0f);
        float _219 = max((_212 - TranslucentBasePass_4412), 0.0f);
        float _232 = TranslucentBasePass_4396 * -1.4426950216293335f;
        float _239 = 1.0f - exp2((((_217 / (_217 + 1.0f)) - _217) + _210) * _232);
        float _240 = 1.0f - exp2((((_218 / (_218 + 1.0f)) - _218) + _211) * _232);
        float _241 = 1.0f - exp2((((_219 / (_219 + 1.0f)) - _219) + _212) * _232);
        float _242 = _239 * TranslucentBasePass_4372;
        float _243 = _240 * TranslucentBasePass_4372;
        float _244 = _241 * TranslucentBasePass_4372;
        float _245 = TranslucentBasePass_4380 * TranslucentBasePass_4376;
        float _252 = TranslucentBasePass_4388 * TranslucentBasePass_4384;
        float _262 = TranslucentBasePass_4392 * TranslucentBasePass_4384;
        float _269 = TranslucentBasePass_4388 / TranslucentBasePass_4392;
        float _285 = saturate(((saturate(((((_242 + _245) * _239) + _252) / (((_242 + TranslucentBasePass_4376) * _239) + _262)) - _269) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _286 = saturate(((saturate(((((_243 + _245) * _240) + _252) / (((_243 + TranslucentBasePass_4376) * _240) + _262)) - _269) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _287 = saturate(((saturate(((((_244 + _245) * _241) + _252) / (((_244 + TranslucentBasePass_4376) * _241) + _262)) - _269) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _288 = dot(float3(_285, _286, _287), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
        float _301 = 1.0f / TranslucentBasePass_4404;
        _312 = exp2(log2(saturate(lerp(_288, _285, TranslucentBasePass_4408))) * _301);
        _313 = exp2(log2(saturate(lerp(_288, _286, TranslucentBasePass_4408))) * _301);
        _314 = exp2(log2(saturate(lerp(_288, _287, TranslucentBasePass_4408))) * _301);
      } else {
        _312 = _166;
        _313 = _167;
        _314 = _168;
      ...
      if (TranslucentBasePass_4368 == 1.0f) {
        float _319 = TranslucentBasePass_4396 * -1.4426950216293335f;
        float _331 = 1.0f / TranslucentBasePass_4404;
        _342 = exp2(log2(1.0f - exp2(_319 * _312)) * _331);
        _343 = exp2(log2(1.0f - exp2(_319 * _313)) * _331);
        _344 = exp2(log2(1.0f - exp2(_319 * _314)) * _331);
      } else {
        _342 = _312;
        _343 = _313;
        _344 = _314;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _342), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _343), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _344), 0.0f));
  SV_Target.w = _165;
