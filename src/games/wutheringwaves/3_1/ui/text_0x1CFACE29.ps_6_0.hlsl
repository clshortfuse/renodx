...
float4 main(
  ...
  float _168 = ((SV_Position.x - View_2144.x) * View_2160.z) - (Material_000[3].x);
  float _169 = (1.0f - ((SV_Position.y - View_2144.y) * View_2160.w)) - (Material_000[3].y);
  float _171 = ((_98.w * _93) + _88) * COLOR.w;
  float _200 = mad(_71, (Primitive_096[2].x), mad(_70, (Primitive_096[1].x), ((Primitive_096[0].x) * _69))) + (Primitive_096[3].x);
  float _204 = mad(_71, (Primitive_096[2].y), mad(_70, (Primitive_096[1].y), ((Primitive_096[0].y) * _69))) + (Primitive_096[3].y);
  float _232 = saturate(((1.0f - saturate((((-0.0f - (Material_000[3].y)) - (Material_000[4].y)) + _204) / (Material_000[8].y))) - saturate((((Material_000[3].y) - (Material_000[4].y)) - _204) / (Material_000[8].w))) * ((1.0f - saturate((((Material_000[3].x) - (Material_000[4].x)) - _200) / (Material_000[8].x))) - saturate((((-0.0f - (Material_000[3].x)) - (Material_000[4].x)) + _200) / (Material_000[8].z))));
  float _236 = (_232 * _232) * (3.0f - (_232 * 2.0f));
  float _253 = saturate(select(((bool)((Material_144[2].w) >= 0.5f) && (bool)(abs((Material_144[2].w) + -0.5f) > 9.999999747378752e-06f)), select(((bool)(_169 > (Material_000[4].y)) || ((bool)((bool)(_168 > (Material_000[4].x)) || ((bool)((bool)(_168 < (-0.0f - (Material_000[4].x))) || (bool)(_169 < (-0.0f - (Material_000[4].y)))))))), 0.0f, _171), (select(((bool)(abs(Material_144[2].z) > 9.999999747378752e-06f) && (bool)((Material_144[2].z) >= 0.0f)), (1.0f - _236), _236) * _171)));
  ...
  [branch]
  if ((bool)(_291 > 0.029999999329447746f) && (bool)(TranslucentBasePass_4352 != 0)) {
    do {
      [branch]
      if (TranslucentBasePass_4368 == 0.0f) {
        float _335 = ((((TranslucentBasePass_4424 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4416 - TranslucentBasePass_4420)) + TranslucentBasePass_4420) * ((((TranslucentBasePass_4356 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4360 - TranslucentBasePass_4364)) + TranslucentBasePass_4364);
        float _336 = _335 * _292;
        float _337 = _335 * _293;
        float _338 = _335 * _294;
        float _343 = max((_336 - TranslucentBasePass_4412), 0.0f);
        float _344 = max((_337 - TranslucentBasePass_4412), 0.0f);
        float _345 = max((_338 - TranslucentBasePass_4412), 0.0f);
        float _358 = TranslucentBasePass_4396 * -1.4426950216293335f;
        float _365 = 1.0f - exp2((((_343 / (_343 + 1.0f)) - _343) + _336) * _358);
        float _366 = 1.0f - exp2((((_344 / (_344 + 1.0f)) - _344) + _337) * _358);
        float _367 = 1.0f - exp2((((_345 / (_345 + 1.0f)) - _345) + _338) * _358);
        float _368 = _365 * TranslucentBasePass_4372;
        float _369 = _366 * TranslucentBasePass_4372;
        float _370 = _367 * TranslucentBasePass_4372;
        float _371 = TranslucentBasePass_4380 * TranslucentBasePass_4376;
        float _378 = TranslucentBasePass_4388 * TranslucentBasePass_4384;
        float _388 = TranslucentBasePass_4392 * TranslucentBasePass_4384;
        float _395 = TranslucentBasePass_4388 / TranslucentBasePass_4392;
        float _411 = saturate(((saturate(((((_368 + _371) * _365) + _378) / (((_368 + TranslucentBasePass_4376) * _365) + _388)) - _395) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _412 = saturate(((saturate(((((_369 + _371) * _366) + _378) / (((_369 + TranslucentBasePass_4376) * _366) + _388)) - _395) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _413 = saturate(((saturate(((((_370 + _371) * _367) + _378) / (((_370 + TranslucentBasePass_4376) * _367) + _388)) - _395) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _414 = dot(float3(_411, _412, _413), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
        float _427 = 1.0f / TranslucentBasePass_4404;
        _438 = exp2(log2(saturate(lerp(_414, _411, TranslucentBasePass_4408))) * _427);
        _439 = exp2(log2(saturate(lerp(_414, _412, TranslucentBasePass_4408))) * _427);
        _440 = exp2(log2(saturate(lerp(_414, _413, TranslucentBasePass_4408))) * _427);
      } else {
        _438 = _292;
        _439 = _293;
        _440 = _294;
      ...
      if (TranslucentBasePass_4368 == 1.0f) {
        float _445 = TranslucentBasePass_4396 * -1.4426950216293335f;
        float _457 = 1.0f / TranslucentBasePass_4404;
        _468 = exp2(log2(1.0f - exp2(_445 * _438)) * _457);
        _469 = exp2(log2(1.0f - exp2(_445 * _439)) * _457);
        _470 = exp2(log2(1.0f - exp2(_445 * _440)) * _457);
      } else {
        _468 = _438;
        _469 = _439;
        _470 = _440;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _468), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _469), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _470), 0.0f));
  SV_Target.w = _291;
