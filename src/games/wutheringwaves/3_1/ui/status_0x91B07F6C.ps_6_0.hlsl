...
float4 main(
  ...
  [branch]
  if ((bool)(_187 > 0.029999999329447746f) && (bool)(TranslucentBasePass_4352 != 0)) {
    do {
      [branch]
      if (TranslucentBasePass_4368 == 0.0f) {
        float _231 = ((((TranslucentBasePass_4424 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4416 - TranslucentBasePass_4420)) + TranslucentBasePass_4420) * ((((TranslucentBasePass_4356 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4360 - TranslucentBasePass_4364)) + TranslucentBasePass_4364);
        float _232 = _231 * _188;
        float _233 = _231 * _189;
        float _234 = _231 * _190;
        float _239 = max((_232 - TranslucentBasePass_4412), 0.0f);
        float _240 = max((_233 - TranslucentBasePass_4412), 0.0f);
        float _241 = max((_234 - TranslucentBasePass_4412), 0.0f);
        float _254 = TranslucentBasePass_4396 * -1.4426950216293335f;
        float _261 = 1.0f - exp2((((_239 / (_239 + 1.0f)) - _239) + _232) * _254);
        float _262 = 1.0f - exp2((((_240 / (_240 + 1.0f)) - _240) + _233) * _254);
        float _263 = 1.0f - exp2((((_241 / (_241 + 1.0f)) - _241) + _234) * _254);
        float _264 = _261 * TranslucentBasePass_4372;
        float _265 = _262 * TranslucentBasePass_4372;
        float _266 = _263 * TranslucentBasePass_4372;
        float _267 = TranslucentBasePass_4380 * TranslucentBasePass_4376;
        float _274 = TranslucentBasePass_4388 * TranslucentBasePass_4384;
        float _284 = TranslucentBasePass_4392 * TranslucentBasePass_4384;
        float _291 = TranslucentBasePass_4388 / TranslucentBasePass_4392;
        float _307 = saturate(((saturate(((((_264 + _267) * _261) + _274) / (((_264 + TranslucentBasePass_4376) * _261) + _284)) - _291) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _308 = saturate(((saturate(((((_265 + _267) * _262) + _274) / (((_265 + TranslucentBasePass_4376) * _262) + _284)) - _291) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _309 = saturate(((saturate(((((_266 + _267) * _263) + _274) / (((_266 + TranslucentBasePass_4376) * _263) + _284)) - _291) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _310 = dot(float3(_307, _308, _309), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
        float _323 = 1.0f / TranslucentBasePass_4404;
        _334 = exp2(log2(saturate(lerp(_310, _307, TranslucentBasePass_4408))) * _323);
        _335 = exp2(log2(saturate(lerp(_310, _308, TranslucentBasePass_4408))) * _323);
        _336 = exp2(log2(saturate(lerp(_310, _309, TranslucentBasePass_4408))) * _323);
      } else {
        _334 = _188;
        _335 = _189;
        _336 = _190;
      ...
      if (TranslucentBasePass_4368 == 1.0f) {
        float _341 = TranslucentBasePass_4396 * -1.4426950216293335f;
        float _353 = 1.0f / TranslucentBasePass_4404;
        _364 = exp2(log2(1.0f - exp2(_341 * _334)) * _353);
        _365 = exp2(log2(1.0f - exp2(_341 * _335)) * _353);
        _366 = exp2(log2(1.0f - exp2(_341 * _336)) * _353);
      } else {
        _364 = _334;
        _365 = _335;
        _366 = _336;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _364), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _365), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _366), 0.0f));
  SV_Target.w = _187;
