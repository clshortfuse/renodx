...
float4 main(
  ...
  [branch]
  if ((bool)(_175 > 0.029999999329447746f) && (bool)(TranslucentBasePass_4352 != 0)) {
    do {
      [branch]
      if (TranslucentBasePass_4368 == 0.0f) {
        float _219 = ((((TranslucentBasePass_4424 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4416 - TranslucentBasePass_4420)) + TranslucentBasePass_4420) * ((((TranslucentBasePass_4356 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4360 - TranslucentBasePass_4364)) + TranslucentBasePass_4364);
        float _220 = _219 * _176;
        float _221 = _219 * _177;
        float _222 = _219 * _178;
        float _227 = max((_220 - TranslucentBasePass_4412), 0.0f);
        float _228 = max((_221 - TranslucentBasePass_4412), 0.0f);
        float _229 = max((_222 - TranslucentBasePass_4412), 0.0f);
        float _242 = TranslucentBasePass_4396 * -1.4426950216293335f;
        float _249 = 1.0f - exp2((((_227 / (_227 + 1.0f)) - _227) + _220) * _242);
        float _250 = 1.0f - exp2((((_228 / (_228 + 1.0f)) - _228) + _221) * _242);
        float _251 = 1.0f - exp2((((_229 / (_229 + 1.0f)) - _229) + _222) * _242);
        float _252 = _249 * TranslucentBasePass_4372;
        float _253 = _250 * TranslucentBasePass_4372;
        float _254 = _251 * TranslucentBasePass_4372;
        float _255 = TranslucentBasePass_4380 * TranslucentBasePass_4376;
        float _262 = TranslucentBasePass_4388 * TranslucentBasePass_4384;
        float _272 = TranslucentBasePass_4392 * TranslucentBasePass_4384;
        float _279 = TranslucentBasePass_4388 / TranslucentBasePass_4392;
        float _295 = saturate(((saturate(((((_252 + _255) * _249) + _262) / (((_252 + TranslucentBasePass_4376) * _249) + _272)) - _279) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _296 = saturate(((saturate(((((_253 + _255) * _250) + _262) / (((_253 + TranslucentBasePass_4376) * _250) + _272)) - _279) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _297 = saturate(((saturate(((((_254 + _255) * _251) + _262) / (((_254 + TranslucentBasePass_4376) * _251) + _272)) - _279) + -0.5f) * TranslucentBasePass_4400) + 0.5f);
        float _298 = dot(float3(_295, _296, _297), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
        float _311 = 1.0f / TranslucentBasePass_4404;
        _322 = exp2(log2(saturate(lerp(_298, _295, TranslucentBasePass_4408))) * _311);
        _323 = exp2(log2(saturate(lerp(_298, _296, TranslucentBasePass_4408))) * _311);
        _324 = exp2(log2(saturate(lerp(_298, _297, TranslucentBasePass_4408))) * _311);
      } else {
        _322 = _176;
        _323 = _177;
        _324 = _178;
      ...
      if (TranslucentBasePass_4368 == 1.0f) {
        float _329 = TranslucentBasePass_4396 * -1.4426950216293335f;
        float _341 = 1.0f / TranslucentBasePass_4404;
        _352 = exp2(log2(1.0f - exp2(_329 * _322)) * _341);
        _353 = exp2(log2(1.0f - exp2(_329 * _323)) * _341);
        _354 = exp2(log2(1.0f - exp2(_329 * _324)) * _341);
      } else {
        _352 = _322;
        _353 = _323;
        _354 = _324;
  ...
  float3 _video_hdr = AutoHDRVideo(float3(_352, _353, _354), SV_Position.xy);
