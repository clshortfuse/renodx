...
float4 main(
  ...
  float _118 = _115 * _79;
  float _119 = _116 * _80;
  float _149 = ((SV_Position.x - View_2144.x) * View_2160.z) - (Material_000[3].x);
  float _150 = (1.0f - ((SV_Position.y - View_2144.y) * View_2160.w)) - (Material_000[3].y);
  float _151 = _83.w * COLOR.w;
  float _180 = mad(_69, (Primitive_096[2].x), mad(_68, (Primitive_096[1].x), ((Primitive_096[0].x) * _67))) + (Primitive_096[3].x);
  float _184 = mad(_69, (Primitive_096[2].y), mad(_68, (Primitive_096[1].y), ((Primitive_096[0].y) * _67))) + (Primitive_096[3].y);
  float _212 = saturate(((1.0f - saturate((((-0.0f - (Material_000[3].y)) - (Material_000[4].y)) + _184) / (Material_000[8].y))) - saturate((((Material_000[3].y) - (Material_000[4].y)) - _184) / (Material_000[8].w))) * ((1.0f - saturate((((Material_000[3].x) - (Material_000[4].x)) - _180) / (Material_000[8].x))) - saturate((((-0.0f - (Material_000[3].x)) - (Material_000[4].x)) + _180) / (Material_000[8].z))));
  float _216 = (_212 * _212) * (3.0f - (_212 * 2.0f));
  float4 _246 = t1.SampleBias(s1, float2(((_180 - (Material_000[10].x)) / (Material_000[11].x)), (1.0f - ((_184 - (Material_000[10].y)) / (Material_000[11].y)))), View_2388, int2(0, 0));
  float _253 = saturate(saturate((Material_192[4].x) * _246.x) * select(((bool)((Material_192[2].w) >= 0.5f) && (bool)(abs((Material_192[2].w) + -0.5f) > 9.999999747378752e-06f)), select(((bool)(_150 > (Material_000[4].y)) || ((bool)((bool)(_149 > (Material_000[4].x)) || ((bool)((bool)(_149 < (-0.0f - (Material_000[4].x))) || (bool)(_150 < (-0.0f - (Material_000[4].y)))))))), 0.0f, _151), (select(((bool)(abs(Material_192[2].z) > 9.999999747378752e-06f) && (bool)((Material_192[2].z) >= 0.0f)), (1.0f - _216), _216) * _151)));
