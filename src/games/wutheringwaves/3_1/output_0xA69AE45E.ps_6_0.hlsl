...
float4 main(
  ...
  GENERATE_INVERSION(_637, _638, _639);

  float _648 = ((((_638 * 587.0f) + (_637 * 299.0f)) + (_639 * 114.0f)) * 0.0010000000474974513f) - cb0_108w;
  float _655 = saturate(float((int)(((int)(uint)((bool)(_648 > 0.0f))) - ((int)(uint)((bool)(_648 < 0.0f))))));
  float _662 = cb0_109x - _637;
  float _663 = cb0_109y - _638;
  float _664 = cb0_109z - _639;
  float _669 = (WUWA_PEAK_SCALING * cb0_110x) - _637;
  float _670 = (WUWA_PEAK_SCALING * cb0_110y) - _638;
  float _671 = (WUWA_PEAK_SCALING * cb0_110z) - _639;
  [branch]
  if (cb0_108z > 0.0f) {
    _688 = (_662 * cb0_108z);
    _689 = (_663 * cb0_108z);
  ...
  SV_Target.x = (((lerp(_688, _691, _655)) * cb0_108y) + _637);
  SV_Target.y = (((lerp(_689, _692, _655)) * cb0_108y) + _638);
  SV_Target.z = (((lerp(_690, _693, _655)) * cb0_108y) + _639);
