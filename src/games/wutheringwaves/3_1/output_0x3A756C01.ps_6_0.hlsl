...
float4 main(
  ...
  float4 _103 = t0.Sample(s0, float2(_40, _41));
  float4 _131 = t1.Sample(s1, float2(min(max(((cb0_068z * _40) + cb0_069x), cb0_060z), cb0_061x), min(max(((cb0_068w * _41) + cb0_069y), cb0_060w), cb0_061y)));
  APPLY_BLOOM(_131);
  [branch]
  if (!(cb0_085z == 0)) {
    bool _159 = (cb0_085w != 0);
    float4 _162 = t2.Sample(s2, float2(select(_159, _40, min(max(((cb0_076z * _40) + cb0_077x), cb0_075z), cb0_076x)), select(_159, _41, min(max(((cb0_076w * _41) + cb0_077y), cb0_075w), cb0_076y))));
    _170 = (_162.x + _131.x);
    _171 = (_162.y + _131.y);
    _172 = (_162.z + _131.z);
  } else {
  ...
  float _197 = TEXCOORD_1.z + -1.0f;
  float _199 = TEXCOORD_1.w + -1.0f;
  float _202 = (((cb0_090x * 2.0f) + _197) * cb0_088z) * cb0_088x;
  float _204 = (((cb0_090y * 2.0f) + _199) * cb0_088w) * cb0_088x;
  float _211 = 1.0f / ((((saturate(cb0_089w) * 9.0f) + 1.0f) * dot(float2(_202, _204), float2(_202, _204))) + 1.0f);
  float _212 = _211 * _211;
  float _213 = cb0_090z + 1.0f;
  float _241 = (((cb0_093x * 2.0f) + _197) * cb0_091z) * cb0_091x;
  float _243 = (((cb0_093y * 2.0f) + _199) * cb0_091w) * cb0_091x;
  float _250 = 1.0f / ((((saturate(cb0_092w) * 9.0f) + 1.0f) * dot(float2(_241, _243), float2(_241, _243))) + 1.0f);
  float _251 = _250 * _250;
  float _252 = cb0_093z + 1.0f;
  float _263 = (((_212 * (_213 - cb0_089x)) + cb0_089x) * (_170 + ((_103.x * TEXCOORD_1.x) * cb0_086x))) * ((_251 * (_252 - cb0_092x)) + cb0_092x);
  float _265 = (((_212 * (_213 - cb0_089y)) + cb0_089y) * (_171 + ((_103.y * TEXCOORD_1.x) * cb0_086y))) * ((_251 * (_252 - cb0_092y)) + cb0_092y);
  float _267 = (((_212 * (_213 - cb0_089z)) + cb0_089z) * (_172 + ((_103.z * TEXCOORD_1.x) * cb0_086z))) * ((_251 * (_252 - cb0_092z)) + cb0_092z);

  CAPTURE_UNTONEMAPPED(float3(_263, _265, _267));
  [branch]
  if (!(cb0_111w == 0)) {
    float _281 = ((((cb0_111z + 1.0f) * 0.009900989942252636f) * (cb0_111x - cb0_111y)) + cb0_111y) * -1.4426950216293335f;
    _292 = (1.0f - exp2(_281 * _263));
    _293 = (1.0f - exp2(_281 * _265));
    _294 = (1.0f - exp2(_281 * _267));
  } else {
    _292 = _263;
    _293 = _265;
    _294 = _267;
  ...
  [branch]
  if (WUWA_TM_IS(1)) {
    _327 = ((((_292 * 1.3600000143051147f) + 0.04699999839067459f) * _292) / ((((_292 * 0.9599999785423279f) + 0.5600000023841858f) * _292) + 0.14000000059604645f));
    ...
    _329 = ((((_294 * 1.3600000143051147f) + 0.04699999839067459f) * _294) / ((((_294 * 0.9599999785423279f) + 0.5600000023841858f) * _294) + 0.14000000059604645f));
  } else {
    _327 = _292;
    _328 = _293;
    _329 = _294;
  ...
  if (WUWA_TM_IS(2)) {
    ...
    float _341 = 1.0049500465393066f - (0.16398000717163086f / (_329 + -0.19505000114440918f));
    ...
    _363 = (((_329 - _341) * select((_329 > 0.6000000238418579f), 0.0f, 1.0f)) + _341);
  } else {
    _361 = _327;
    _362 = _328;
    _363 = _329;
  ...
  if (WUWA_TM_IS(3)) {
    ...
    float _371 = cb0_037y * _363;
    float _374 = cb0_037z * cb0_037w;
    float _384 = cb0_038y * cb0_038x;
    float _395 = cb0_038z * cb0_038x;
    float _402 = cb0_038y / cb0_038z;
    _410 = (((((_374 + _369) * _361) + _384) / (((_369 + cb0_037z) * _361) + _395)) - _402);
    _411 = (((((_374 + _370) * _362) + _384) / (((_370 + cb0_037z) * _362) + _395)) - _402);
    _412 = (((((_374 + _371) * _363) + _384) / (((_371 + cb0_037z) * _363) + _395)) - _402);
  } else {
    _410 = _361;
    _411 = _362;
    _412 = _363;
  ...
  if (!(cb0_105w == 0)) {
    if (!(cb0_106x == 1.0f)) {
      float _422 = (cb0_106x * 0.699999988079071f) + 0.30000001192092896f;
      _427 = (_422 * _410);
      _428 = (_422 * _411);
      _429 = (_422 * _412);
    } else {
  ...
  CLAMP_IF_SDR3(_427, _428, _429);
  CAPTURE_TONEMAPPED(float3(_427, _428, _429));
  float _444 = (saturate((log2(_429 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _448 = (saturate((log2(_428 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _452 = (saturate((log2(_427 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  [branch]
  if (!(cb0_107w == 0)) {
    float4 _473 = t6.Sample(s6, float2(min(max(((cb0_084z * _40) + cb0_085x), cb0_083z), cb0_084x), min(max(((cb0_084w * _41) + cb0_085y), cb0_083w), cb0_084y)));
    float _483 = select((((uint)(uint(float((uint)((int)((uint)(uint(round(_473.w * 255.0f))) & 15))))) & -4) == 12), 1.0f, 0.0f);
    float4 _484 = t8.Sample(s8, float3(_452, _448, _444));
    float4 _491 = t7.Sample(s7, float3(_452, _448, _444));
    _532 = ((((_491.x - _484.x) * 1.0499999523162842f) * _483) + (_484.x * 1.0499999523162842f));
    _533 = ((((_491.y - _484.y) * 1.0499999523162842f) * _483) + (_484.y * 1.0499999523162842f));
    _534 = ((((_491.z - _484.z) * 1.0499999523162842f) * _483) + (_484.z * 1.0499999523162842f));
  } else {
    float _510 = select(((select((((_63 - _55.x) + ((((View_448[3].z) - _63) + ((View_448[2].z) * _54)) * select(((View_448[3].w) < 1.0f), 0.0f, 1.0f))) > 0.0005000000237487257f), 0.0f, 1.0f) * _55.x) > 0.0f), 0.0f, 1.0f);
    float4 _511 = t7.Sample(s7, float3(_452, _448, _444));
    float4 _515 = t3.Sample(s3, float3(_452, _448, _444));
    _532 = ((lerp(_515.x, _511.x, _510)) * 1.0499999523162842f);
    _533 = ((lerp(_515.y, _511.y, _510)) * 1.0499999523162842f);
    _534 = ((lerp(_515.z, _511.z, _510)) * 1.0499999523162842f);
  }

  HANDLE_LUT_OUTPUT3_FADE(_532, _533, _534, t7, s7);
  float _542 = ((_79 * 0.00390625f) + -0.001953125f) + _532;
  float _543 = ((_101 * 0.00390625f) + -0.001953125f) + _533;
  float _544 = ((_102 * 0.00390625f) + -0.001953125f) + _534;
  [branch]
  if (!(cb0_106w == 0)) {
    ...
    float _591 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_556 + -0.8359375f)) / (18.8515625f - (_556 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    float _592 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_557 + -0.8359375f)) / (18.8515625f - (_557 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    float _593 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_558 + -0.8359375f)) / (18.8515625f - (_558 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
