...
float4 main(
  ...
  HANDLE_LUT_OUTPUT3_FADE(_675, _676, _677, t4, s4);
  ...
  GENERATE_INVERSION(_762, _763, _764);

  float _773 = ((((_763 * 587.0f) + (_762 * 299.0f)) + (_764 * 114.0f)) * 0.0010000000474974513f) - cb0_108w;
  float _780 = saturate(float((int)(((int)(uint)((bool)(_773 > 0.0f))) - ((int)(uint)((bool)(_773 < 0.0f))))));
  float _787 = cb0_109x - _762;
  float _788 = cb0_109y - _763;
  float _789 = cb0_109z - _764;
  float _794 = (WUWA_PEAK_SCALING * cb0_110x) - _762;
  float _795 = (WUWA_PEAK_SCALING * cb0_110y) - _763;
  float _796 = (WUWA_PEAK_SCALING * cb0_110z) - _764;
  [branch]
  if (cb0_108z > 0.0f) {
    _813 = (_787 * cb0_108z);
    _814 = (_788 * cb0_108z);
  ...
  SV_Target.x = (((lerp(_813, _816, _780)) * cb0_108y) + _762);
  SV_Target.y = (((lerp(_814, _817, _780)) * cb0_108y) + _763);
  SV_Target.z = (((lerp(_815, _818, _780)) * cb0_108y) + _764);
