...
float4 main(
  ...
  float4 _411 = t0.Sample(s0, float2(_409, _410));
  float _417 = saturate(cb0_098x);
  float _419 = saturate(cb0_098y);
  if (_417 > 0.0f) {
    float _430 = saturate(((_411.x * 0.29899999499320984f) + (_411.y * 0.5870000123977661f)) + (_411.z * 0.11400000005960464f));
    float _431 = _430 * 2.0f;
    float _435 = ((_430 * saturate(1.0f - cb0_098z)) * _431) * (3.0f - _431);
    float _442 = max(sqrt(((_411.x * _411.x) + (_411.y * _411.y)) + (_411.z * _411.z)), 0.014999999664723873f);
    float _443 = _411.x / _442;
    float _444 = _411.y / _442;
    float _445 = _411.z / _442;
    float _455 = log2(_435);
    float _474 = ((_291 * _211) * _328) * _417;
    _485 = (((((lerp(_443, 1.0f, 0.25f)) * (((_419 * 0.17000000178813934f) + 0.029999999329447746f) + _435)) - _411.x) * _474) + _411.x);
    _486 = (((((((_419 * 0.18000000715255737f) + 0.05000000074505806f) + exp2(_455 * 0.8999999761581421f)) * (lerp(_444, 1.0f, 0.25f))) - _411.y) * _474) + _411.y);
    _487 = (((((((_419 * 0.17999999225139618f) + 0.07999999821186066f) + exp2(_455 * 0.949999988079071f)) * (lerp(_445, 1.0f, 0.25f))) - _411.z) * _474) + _411.z);
  } else {
    _485 = _411.x;
    _486 = _411.y;
    _487 = _411.z;
  }
  float _489 = saturate(cb0_099x);
  float _490 = _489 * _382;
  if (_489 > 0.0f) {
    float _501 = (sin(((_113 * 640.0f) + 640.0f) - (View_2376 * 10.0f)) * 0.5f) + 1.0f;
    _515 = ((((_501 * _485) - _485) * _490) + _485);
    _516 = ((((_501 * _486) - _486) * _490) + _486);
    _517 = ((((_501 * _487) - _487) * _490) + _487);
  } else {
    _515 = _485;
    _516 = _486;
    _517 = _487;
  ...
  float4 _542 = t1.Sample(s1, float2(min(max(((cb0_068z * _409) + cb0_069x), cb0_060z), cb0_061x), min(max(((cb0_068w * _410) + cb0_069y), cb0_060w), cb0_061y)));
  APPLY_BLOOM(_542);

  [branch]
  if (!((uint)(cb0_085z) == 0)) {
    bool _570 = ((uint)(cb0_085w) != 0);
    float4 _573 = t2.Sample(s2, float2(select(_570, _409, min(max(((cb0_076z * _409) + cb0_077x), cb0_075z), cb0_076x)), select(_570, _410, min(max(((cb0_076w * _410) + cb0_077y), cb0_075w), cb0_076y))));
    _581 = (_573.x + _542.x);
    _582 = (_573.y + _542.y);
    _583 = (_573.z + _542.z);
  } else {
  ...
  float _608 = TEXCOORD_1.z + -1.0f;
  float _610 = TEXCOORD_1.w + -1.0f;
  float _613 = (((cb0_090x * 2.0f) + _608) * cb0_088z) * cb0_088x;
  float _615 = (((cb0_090y * 2.0f) + _610) * cb0_088w) * cb0_088x;
  float _622 = 1.0f / ((((saturate(cb0_089w) * 9.0f) + 1.0f) * dot(float2(_613, _615), float2(_613, _615))) + 1.0f);
  float _623 = _622 * _622;
  float _624 = cb0_090z + 1.0f;
  float _652 = (((cb0_093x * 2.0f) + _608) * cb0_091z) * cb0_091x;
  float _654 = (((cb0_093y * 2.0f) + _610) * cb0_091w) * cb0_091x;
  float _661 = 1.0f / ((((saturate(cb0_092w) * 9.0f) + 1.0f) * dot(float2(_652, _654), float2(_652, _654))) + 1.0f);
  float _662 = _661 * _661;
  float _663 = cb0_093z + 1.0f;
  float _675 = (((_581 + ((_515 * TEXCOORD_1.x) * cb0_086x)) * _379) * ((_623 * (_624 - cb0_089x)) + cb0_089x)) * ((_662 * (_663 - cb0_092x)) + cb0_092x);
  float _678 = (((_582 + ((_516 * TEXCOORD_1.x) * cb0_086y)) * _379) * ((_623 * (_624 - cb0_089y)) + cb0_089y)) * ((_662 * (_663 - cb0_092y)) + cb0_092y);
  float _681 = (((_583 + ((_517 * TEXCOORD_1.x) * cb0_086z)) * _379) * ((_623 * (_624 - cb0_089z)) + cb0_089z)) * ((_662 * (_663 - cb0_092z)) + cb0_092z);

  CAPTURE_UNTONEMAPPED(float3(_675, _678, _681));

  [branch]
  if (false) {
    float _695 = ((((cb0_111z + 1.0f) * 0.009900989942252636f) * (cb0_111x - cb0_111y)) + cb0_111y) * -1.4426950216293335f;
    _706 = (1.0f - exp2(_695 * _675));
    _707 = (1.0f - exp2(_695 * _678));
    _708 = (1.0f - exp2(_695 * _681));
  } else {
    _706 = _675;
    _707 = _678;
    _708 = _681;
  ...
  [branch]
  if (WUWA_TM_IS(1)) {
    _741 = ((((_706 * 1.3600000143051147f) + 0.04699999839067459f) * _706) / ((((_706 * 0.9599999785423279f) + 0.5600000023841858f) * _706) + 0.14000000059604645f));
    _742 = ((((_707 * 1.3600000143051147f) + 0.04699999839067459f) * _707) / ((((_707 * 0.9599999785423279f) + 0.5600000023841858f) * _707) + 0.14000000059604645f));
    _743 = ((((_708 * 1.3600000143051147f) + 0.04699999839067459f) * _708) / ((((_708 * 0.9599999785423279f) + 0.5600000023841858f) * _708) + 0.14000000059604645f));
  } else {
    _741 = _706;
    _742 = _707;
    _743 = _708;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _753 = 1.0049500465393066f - (0.16398000717163086f / (_741 + -0.19505000114440918f));
    float _754 = 1.0049500465393066f - (0.16398000717163086f / (_742 + -0.19505000114440918f));
    float _755 = 1.0049500465393066f - (0.16398000717163086f / (_743 + -0.19505000114440918f));
    _775 = (((_741 - _753) * select((_741 > 0.6000000238418579f), 0.0f, 1.0f)) + _753);
    _776 = (((_742 - _754) * select((_742 > 0.6000000238418579f), 0.0f, 1.0f)) + _754);
    _777 = (((_743 - _755) * select((_743 > 0.6000000238418579f), 0.0f, 1.0f)) + _755);
  } else {
    _775 = _741;
    _776 = _742;
    _777 = _743;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _783 = cb0_037y * _775;
    float _784 = cb0_037y * _776;
    float _785 = cb0_037y * _777;
    float _788 = cb0_037z * cb0_037w;
    float _798 = cb0_038y * cb0_038x;
    float _809 = cb0_038z * cb0_038x;
    float _816 = cb0_038y / cb0_038z;
    _824 = (((((_788 + _783) * _775) + _798) / (((_783 + cb0_037z) * _775) + _809)) - _816);
    _825 = (((((_788 + _784) * _776) + _798) / (((_784 + cb0_037z) * _776) + _809)) - _816);
    _826 = (((((_788 + _785) * _777) + _798) / (((_785 + cb0_037z) * _777) + _809)) - _816);
  } else {
    _824 = _775;
    _825 = _776;
    _826 = _777;
  ...
  if (!((uint)(cb0_105w) == 0)) {
    if (!(cb0_106x == 1.0f)) {
      float _836 = (cb0_106x * 0.699999988079071f) + 0.30000001192092896f;
      _841 = (_836 * _824);
      _842 = (_836 * _825);
      _843 = (_836 * _826);
    } else {
  ...
  CLAMP_IF_SDR3(_841, _842, _843);
  CAPTURE_TONEMAPPED(float3(_841, _842, _843));

  float _858 = (saturate((log2(_843 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _862 = (saturate((log2(_842 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _866 = (saturate((log2(_841 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  [branch]
  if (!((uint)(cb0_107w) == 0)) {
    float4 _887 = t5.Sample(s5, float2(min(max(((cb0_084z * _409) + cb0_085x), cb0_083z), cb0_084x), min(max(((cb0_084w * _410) + cb0_085y), cb0_083w), cb0_084y)));
    float _897 = select((((uint)(uint(float((uint)((int)((uint)(uint(round(_887.w * 255.0f))) & 15))))) & -4) == 12), 1.0f, 0.0f);
    float4 _898 = t7.Sample(s7, float3(_866, _862, _858));
    float4 _905 = t6.Sample(s6, float3(_866, _862, _858));
    _930 = ((((_905.x - _898.x) * 1.0499999523162842f) * _897) + (_898.x * 1.0499999523162842f));
    _931 = ((((_905.y - _898.y) * 1.0499999523162842f) * _897) + (_898.y * 1.0499999523162842f));
    _932 = ((((_905.z - _898.z) * 1.0499999523162842f) * _897) + (_898.z * 1.0499999523162842f));
  } else {
    float4 _922 = t6.Sample(s6, float3(_866, _862, _858));
    _930 = (_922.x * 1.0499999523162842f);
    _931 = (_922.y * 1.0499999523162842f);
    _932 = (_922.z * 1.0499999523162842f);
  }
  
  HANDLE_LUT_OUTPUT3_FADE(_930, _931, _932, t6, s6);

  float _940 = ((_335 * 0.00390625f) + -0.001953125f) + _930;
  float _941 = ((_356 * 0.00390625f) + -0.001953125f) + _931;
  float _942 = ((_357 * 0.00390625f) + -0.001953125f) + _932;
  [branch]
  if (!((uint)(cb0_106w) == 0)) {
    ...
    float _989 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_954 + -0.8359375f)) / (18.8515625f - (_954 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    float _990 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_955 + -0.8359375f)) / (18.8515625f - (_955 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    float _991 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_956 + -0.8359375f)) / (18.8515625f - (_956 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
  ...
  GENERATE_INVERSION(_1017, _1018, _1019);

  float _1028 = ((((_1018 * 587.0f) + (_1017 * 299.0f)) + (_1019 * 114.0f)) * 0.0010000000474974513f) - cb0_108w;
  float _1035 = saturate(float(((int)(uint)((bool)(_1028 > 0.0f))) - ((int)(uint)((bool)(_1028 < 0.0f)))));
  float _1042 = cb0_109x - _1017;
  float _1043 = cb0_109y - _1018;
  float _1044 = cb0_109z - _1019;

  float _1049 = WUWA_PEAK_SCALING * cb0_110x - _1017;
  float _1050 = WUWA_PEAK_SCALING * cb0_110y - _1018;
  float _1051 = WUWA_PEAK_SCALING * cb0_110z - _1019;

  [branch]
  if (cb0_108z > 0.0f) {
    _1068 = (_1042 * cb0_108z);
    _1069 = (_1043 * cb0_108z);
    _1070 = (_1044 * cb0_108z);
    _1071 = (_1049 * cb0_108z);
    _1072 = (_1050 * cb0_108z);
    _1073 = (_1051 * cb0_108z);
  } else {
    float _1060 = abs(cb0_108z);
    _1068 = (_1060 * _1049);
    _1069 = (_1060 * _1050);
    _1070 = (_1060 * _1051);
    _1071 = (_1060 * _1042);
  ...
  SV_Target.x = (((lerp(_1068, _1071, _1035)) * cb0_108y) + _1017);
  SV_Target.y = (((lerp(_1069, _1072, _1035)) * cb0_108y) + _1018);
  SV_Target.z = (((lerp(_1070, _1073, _1035)) * cb0_108y) + _1019);
