...
float4 main(
  ...
  HANDLE_LUT_OUTPUT3_FADE(_1056, _1057, _1058, t6, s6);
  ...
  GENERATE_INVERSION(_1143, _1144, _1145);

  float _1154 = ((((_1144 * 587.0f) + (_1143 * 299.0f)) + (_1145 * 114.0f)) * 0.0010000000474974513f) - cb0_108w;
  float _1161 = saturate(float(((int)(uint)((bool)(_1154 > 0.0f))) - ((int)(uint)((bool)(_1154 < 0.0f)))));
  float _1168 = cb0_109x - _1143;
  float _1169 = cb0_109y - _1144;
  float _1170 = cb0_109z - _1145;

  float _1175 = WUWA_PEAK_SCALING * cb0_110x - _1143;
  float _1176 = WUWA_PEAK_SCALING * cb0_110y - _1144;
  float _1177 = WUWA_PEAK_SCALING * cb0_110z - _1145;

  [branch]
  if (cb0_108z > 0.0f) {
    _1194 = (_1168 * cb0_108z);
    _1195 = (_1169 * cb0_108z);
    _1196 = (_1170 * cb0_108z);
    _1197 = (_1175 * cb0_108z);
    _1198 = (_1176 * cb0_108z);
    _1199 = (_1177 * cb0_108z);
  } else {
    float _1186 = abs(cb0_108z);
    _1194 = (_1186 * _1175);
    _1195 = (_1186 * _1176);
    _1196 = (_1186 * _1177);
    _1197 = (_1186 * _1168);
  ...
  SV_Target.x = (((lerp(_1194, _1197, _1161)) * cb0_108y) + _1143);
  SV_Target.y = (((lerp(_1195, _1198, _1161)) * cb0_108y) + _1144);
  SV_Target.z = (((lerp(_1196, _1199, _1161)) * cb0_108y) + _1145);
