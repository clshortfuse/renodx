...
float4 main(
  ...
  CAPTURE_UNTONEMAPPED(float3(_349, _350, _351));
  [branch]
  if (WUWA_TM_IS(1)) {
  ...
  GENERATE_INVERSION(_660, _661, _662);

  float _671 = ((((_661 * 587.0f) + (_660 * 299.0f)) + (_662 * 114.0f)) * 0.0010000000474974513f) - cb0_108w;
  float _678 = saturate(float((int)(((int)(uint)((bool)(_671 > 0.0f))) - ((int)(uint)((bool)(_671 < 0.0f))))));
  float _685 = cb0_109x - _660;
  float _686 = cb0_109y - _661;
  float _687 = cb0_109z - _662;
  float _692 = (WUWA_PEAK_SCALING * cb0_110x) - _660;
  float _693 = (WUWA_PEAK_SCALING * cb0_110y) - _661;
  float _694 = (WUWA_PEAK_SCALING * cb0_110z) - _662;
  [branch]
  if (cb0_108z > 0.0f) {
    _711 = (_685 * cb0_108z);
    _712 = (_686 * cb0_108z);
  ...
  SV_Target.x = (((lerp(_711, _714, _678)) * cb0_108y) + _660);
  SV_Target.y = (((lerp(_712, _715, _678)) * cb0_108y) + _661);
  SV_Target.z = (((lerp(_713, _716, _678)) * cb0_108y) + _662);
