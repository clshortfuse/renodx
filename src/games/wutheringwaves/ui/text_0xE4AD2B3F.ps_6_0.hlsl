...
cbuffer cb2 : register(b2) {
  ...
  float4 Material_144[3] : packoffset(c009.x);
};
...
float4 main(
  ...
  float4 SV_Target;
  float _61 = mad(SV_Position.z, (dx_alignment_legacy_View_704[2].w), mad(SV_Position.y, (dx_alignment_legacy_View_704[1].w), ((dx_alignment_legacy_View_704[0].w) * SV_Position.x))) + (dx_alignment_legacy_View_704[3].w);
  float _65 = ((mad(SV_Position.z, (dx_alignment_legacy_View_704[2].x), mad(SV_Position.y, (dx_alignment_legacy_View_704[1].x), ((dx_alignment_legacy_View_704[0].x) * SV_Position.x))) + (dx_alignment_legacy_View_704[3].x)) / _61) - dx_alignment_legacy_View_1120.x;
  float _66 = ((mad(SV_Position.z, (dx_alignment_legacy_View_704[2].y), mad(SV_Position.y, (dx_alignment_legacy_View_704[1].y), ((dx_alignment_legacy_View_704[0].y) * SV_Position.x))) + (dx_alignment_legacy_View_704[3].y)) / _61) - dx_alignment_legacy_View_1120.y;
  float _67 = ((mad(SV_Position.z, (dx_alignment_legacy_View_704[2].z), mad(SV_Position.y, (dx_alignment_legacy_View_704[1].z), ((dx_alignment_legacy_View_704[0].z) * SV_Position.x))) + (dx_alignment_legacy_View_704[3].z)) / _61) - dx_alignment_legacy_View_1120.z;
  float _68 = TEXCOORD_9.x - dx_alignment_legacy_View_1120.x;
  float _69 = TEXCOORD_9.y - dx_alignment_legacy_View_1120.y;
  float _70 = TEXCOORD_9.z - dx_alignment_legacy_View_1120.z;
  float _79;
  float _80;
  float _81;
  float _132;
  ...
  float4 _84 = t0.SampleBias(s0, float2(TEXCOORD.x, TEXCOORD.y), dx_alignment_legacy_View_2388, int2(0, 0));
  float _87 = max(_84.x, _84.y);
  float _88 = ceil(_87);
  float _92 = ceil(TEXCOORD.z);
  float4 _97 = t1.SampleBias(s1, float2((TEXCOORD.z + -1.0f), (TEXCOORD.w + -1.0f)), dx_alignment_legacy_View_2388, int2(0, 0));
  float _102 = _97.x * _92;
  float _103 = _97.y * _92;
  float _104 = _97.z * _92;
  if ((Material_144[0].x) > 0.5f) {
    _132 = max(((exp2(log2(max(_102, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
  ...
  float _135 = _132 + (_88 * _79);
  float _136 = _133 + (_88 * _80);
  float _137 = _134 + (_88 * _81);
  float _169 = mad(_70, (dx_alignment_legacy_Primitive_096[2].x), mad(_69, (dx_alignment_legacy_Primitive_096[1].x), ((dx_alignment_legacy_Primitive_096[0].x) * _68))) + (dx_alignment_legacy_Primitive_096[3].x);
  float _173 = mad(_70, (dx_alignment_legacy_Primitive_096[2].y), mad(_69, (dx_alignment_legacy_Primitive_096[1].y), ((dx_alignment_legacy_Primitive_096[0].y) * _68))) + (dx_alignment_legacy_Primitive_096[3].y);
  float _208 = saturate(((1.0f - saturate(((_173 - (Material_000[7].y)) - (Material_000[6].y)) / (Material_000[8].y))) - saturate((((-0.0f - _173) - (Material_000[7].y)) + (Material_000[6].y)) / (Material_000[8].w))) * ((1.0f - saturate((((-0.0f - _169) - (Material_000[7].x)) + (Material_000[6].x)) / (Material_000[8].x))) - saturate(((_169 - (Material_000[7].x)) - (Material_000[6].x)) / (Material_000[8].z))));
  float _212 = (_208 * _208) * (3.0f - (_208 * 2.0f));
  float _222 = saturate((((_97.w * _92) + _87) * COLOR.w) * select(((bool)(abs(Material_144[2].z) > 9.999999747378752e-06f) && (bool)((Material_144[2].z) >= 0.0f)), (1.0f - _212), _212));
  float _223 = max(((((Material_000[1].x) - _135) * (Material_144[0].y)) + _135), 0.0f);
  float _224 = max(((((Material_000[1].y) - _136) * (Material_144[0].y)) + _136), 0.0f);
  float _225 = max(((((Material_000[1].z) - _137) * (Material_144[0].y)) + _137), 0.0f);
  [branch]
  if (dx_alignment_legacy_View_2336 > 0.0f) {
    if ((bool)(abs(_67 - dx_alignment_legacy_Primitive_080.z) > (dx_alignment_legacy_Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_65 - dx_alignment_legacy_Primitive_080.x) > (dx_alignment_legacy_Primitive_304.x + 1.0f)) || (bool)(abs(_66 - dx_alignment_legacy_Primitive_080.y) > (dx_alignment_legacy_Primitive_304.y + 1.0f))))) {
      float _257 = float((bool)(bool)(frac(dot(float3(_65, _66, _67), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _260 = 1.0f;
      _261 = (1.0f - _257);
      _262 = 1.0f;
      _263 = _257;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _261), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _262), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _263), 0.0f));
  SV_Target.w = _260 * TEXT_OPACITY;
  return SV_Target;
}
