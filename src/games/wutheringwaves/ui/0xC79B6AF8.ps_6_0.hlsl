...
float4 main(
  ...
  float4 SV_Target;
  float _57 = mad(SV_Position.z, (View_704[2].w), mad(SV_Position.y, (View_704[1].w), ((View_704[0].w) * SV_Position.x))) + (View_704[3].w);
  float _61 = ((mad(SV_Position.z, (View_704[2].x), mad(SV_Position.y, (View_704[1].x), ((View_704[0].x) * SV_Position.x))) + (View_704[3].x)) / _57) - View_1120.x;
  float _62 = ((mad(SV_Position.z, (View_704[2].y), mad(SV_Position.y, (View_704[1].y), ((View_704[0].y) * SV_Position.x))) + (View_704[3].y)) / _57) - View_1120.y;
  float _63 = ((mad(SV_Position.z, (View_704[2].z), mad(SV_Position.y, (View_704[1].z), ((View_704[0].z) * SV_Position.x))) + (View_704[3].z)) / _57) - View_1120.z;
  float _64 = TEXCOORD_9.x - View_1120.x;
  float _65 = TEXCOORD_9.y - View_1120.y;
  float _66 = TEXCOORD_9.z - View_1120.z;
  float _75;
  float _76;
  float _77;
  float _111;
  ...
  float4 _80 = t0.SampleBias(s0, float2(TEXCOORD.x, TEXCOORD.y), View_2388, int2(0, 0));
  if ((Material_144[0].x) > 0.5f) {
    _111 = max(((exp2(log2(max(_80.x, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _112 = max(((exp2(log2(max(_80.y, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _113 = max(((exp2(log2(max(_80.z, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
  } else {
    _111 = _80.x;
    _112 = _80.y;
    _113 = _80.z;
  ...
  float _148 = _80.w * COLOR.w;
  float _177 = mad(_66, (Primitive_096[2].x), mad(_65, (Primitive_096[1].x), ((Primitive_096[0].x) * _64))) + (Primitive_096[3].x);
  float _181 = mad(_66, (Primitive_096[2].y), mad(_65, (Primitive_096[1].y), ((Primitive_096[0].y) * _64))) + (Primitive_096[3].y);
  float _209 = saturate(((1.0f - saturate((((-0.0f - (Material_000[3].y)) - (Material_000[4].y)) + _181) / (Material_000[8].y))) - saturate((((Material_000[3].y) - (Material_000[4].y)) - _181) / (Material_000[8].w))) * ((1.0f - saturate((((Material_000[3].x) - (Material_000[4].x)) - _177) / (Material_000[8].x))) - saturate((((-0.0f - (Material_000[3].x)) - (Material_000[4].x)) + _177) / (Material_000[8].z))));
  float _213 = (_209 * _209) * (3.0f - (_209 * 2.0f));
  float _230 = saturate(select(((bool)((Material_144[2].w) >= 0.5f) && (bool)(abs((Material_144[2].w) + -0.5f) > 9.999999747378752e-06f)), select(((bool)(_147 > (Material_000[4].y)) || ((bool)((bool)(_146 > (Material_000[4].x)) || ((bool)((bool)(_146 < (-0.0f - (Material_000[4].x))) || (bool)(_147 < (-0.0f - (Material_000[4].y)))))))), 0.0f, _148), (select(((bool)(abs(Material_144[2].z) > 9.999999747378752e-06f) && (bool)((Material_144[2].z) >= 0.0f)), (1.0f - _213), _213) * _148)));
  float _231 = max(((((Material_000[1].x) - _114) * (Material_144[0].y)) + _114), 0.0f);
  float _232 = max(((((Material_000[1].y) - _115) * (Material_144[0].y)) + _115), 0.0f);
  float _233 = max(((((Material_000[1].z) - _116) * (Material_144[0].y)) + _116), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_63 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_61 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_62 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      float _265 = float((bool)(bool)(frac(dot(float3(_61, _62, _63), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _268 = 1.0f;
      _269 = (1.0f - _265);
      _270 = 1.0f;
      _271 = _265;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _269), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _270), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _271), 0.0f));

  SV_Target.w = _268 * HUD_OPACITY;
