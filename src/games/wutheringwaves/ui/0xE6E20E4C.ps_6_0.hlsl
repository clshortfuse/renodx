...
float4 main(
  ...
  float4 SV_Target;
  float4 _46 = t0.SampleLevel(s0, float2((View_2208.z * SV_Position.x), (View_2208.w * SV_Position.y)), 0.0f);
  float _49 = select((SV_Position.z < _46.x), 0.0f, 1.0f);
  float _50 = _49 * COLOR.x;
  float _51 = _49 * COLOR.y;
  float _52 = _49 * COLOR.z;
  float _69 = mad(SV_Position.z, (View_704[2].w), mad(SV_Position.y, (View_704[1].w), ((View_704[0].w) * SV_Position.x))) + (View_704[3].w);
  float _73 = ((mad(SV_Position.z, (View_704[2].x), mad(SV_Position.y, (View_704[1].x), ((View_704[0].x) * SV_Position.x))) + (View_704[3].x)) / _69) - View_1120.x;
  float _74 = ((mad(SV_Position.z, (View_704[2].y), mad(SV_Position.y, (View_704[1].y), ((View_704[0].y) * SV_Position.x))) + (View_704[3].y)) / _69) - View_1120.y;
  float _75 = ((mad(SV_Position.z, (View_704[2].z), mad(SV_Position.y, (View_704[1].z), ((View_704[0].z) * SV_Position.x))) + (View_704[3].z)) / _69) - View_1120.z;
  float _84;
  float _85;
  float _86;
  float _120;
  ...
  float4 _89 = t1.SampleBias(s1, float2(TEXCOORD.x, TEXCOORD.y), View_2388, int2(0, 0));
  if ((Material_032[0].x) > 0.5f) {
    _120 = max(((exp2(log2(max(_89.x, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _121 = max(((exp2(log2(max(_89.y, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _122 = max(((exp2(log2(max(_89.z, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
  } else {
    _120 = _89.x;
    _121 = _89.y;
    _122 = _89.z;
  ...
  float _124 = _121 * _85;
  float _125 = _122 * _86;
  float _141 = saturate((_49 * COLOR.w) * _89.w);
  float _142 = max(((((Material_000[1].x) - _123) * (Material_032[0].y)) + _123), 0.0f);
  float _143 = max(((((Material_000[1].y) - _124) * (Material_032[0].y)) + _124), 0.0f);
  float _144 = max(((((Material_000[1].z) - _125) * (Material_032[0].y)) + _125), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_75 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_73 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_74 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      float _176 = float((bool)(bool)(frac(dot(float3(_73, _74, _75), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _179 = 1.0f;
      _180 = (1.0f - _176);
      _181 = 1.0f;
      _182 = _176;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _180), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _181), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _182), 0.0f));

  SV_Target.w = _179 * HUD_OPACITY;
