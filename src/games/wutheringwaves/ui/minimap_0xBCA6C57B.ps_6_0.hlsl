...
OutputSignature main(
  ...
  float _117 = _114 * _78;
  float _118 = _115 * _79;
  float _149 = mad(_68, (Primitive_096[2].x), mad(_67, (Primitive_096[1].x), ((Primitive_096[0].x) * _66))) + (Primitive_096[3].x);
  float _153 = mad(_68, (Primitive_096[2].y), mad(_67, (Primitive_096[1].y), ((Primitive_096[0].y) * _66))) + (Primitive_096[3].y);
  float _188 = saturate(((1.0f - saturate(((_153 - (Material_000[7].y)) - (Material_000[6].y)) / (Material_000[8].y))) - saturate((((-0.0f - _153) - (Material_000[7].y)) + (Material_000[6].y)) / (Material_000[8].w))) * ((1.0f - saturate((((-0.0f - _149) - (Material_000[7].x)) + (Material_000[6].x)) / (Material_000[8].x))) - saturate(((_149 - (Material_000[7].x)) - (Material_000[6].x)) / (Material_000[8].z))));
  float _192 = (_188 * _188) * (3.0f - (_188 * 2.0f));
  float4 _215 = t1.SampleBias(s1, float2(((_149 - (Material_000[10].x)) / (Material_000[11].x)), (1.0f - ((_153 - (Material_000[10].y)) / (Material_000[11].y)))), View_2388, int2(0, 0));
  float _222 = saturate(((_82.w * COLOR.w) * select(((bool)(abs(Material_192[2].z) > 9.999999747378752e-06f) && (bool)((Material_192[2].z) >= 0.0f)), (1.0f - _192), _192)) * saturate((Material_192[3].w) * _215.x));
  float _223 = max(((((Material_000[1].x) - _116) * (Material_192[0].y)) + _116), 0.0f);
  float _224 = max(((((Material_000[1].y) - _117) * (Material_192[0].y)) + _117), 0.0f);
  float _225 = max(((((Material_000[1].z) - _118) * (Material_192[0].y)) + _118), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_65 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_63 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_64 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      float _257 = float((bool)(bool)(frac(dot(float3(_63, _64, _65), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _260 = 1.0f;
      _261 = (1.0f - _257);
      _262 = 1.0f;
      _263 = _257;
