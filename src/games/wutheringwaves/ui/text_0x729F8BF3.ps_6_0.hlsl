...
float4 main(
  ...
  float4 SV_Target;
  float _61 = mad(SV_Position.z, (View_704[2].w), mad(SV_Position.y, (View_704[1].w), ((View_704[0].w) * SV_Position.x))) + (View_704[3].w);
  float _65 = ((mad(SV_Position.z, (View_704[2].x), mad(SV_Position.y, (View_704[1].x), ((View_704[0].x) * SV_Position.x))) + (View_704[3].x)) / _61) - View_1120.x;
  float _66 = ((mad(SV_Position.z, (View_704[2].y), mad(SV_Position.y, (View_704[1].y), ((View_704[0].y) * SV_Position.x))) + (View_704[3].y)) / _61) - View_1120.y;
  float _67 = ((mad(SV_Position.z, (View_704[2].z), mad(SV_Position.y, (View_704[1].z), ((View_704[0].z) * SV_Position.x))) + (View_704[3].z)) / _61) - View_1120.z;
  float _68 = TEXCOORD_9.x - View_1120.x;
  float _69 = TEXCOORD_9.y - View_1120.y;
  float _70 = TEXCOORD_9.z - View_1120.z;
  float _79;
  float _80;
  float _81;
  float _132;
  ...
  float4 _84 = t0.SampleBias(s0, float2(TEXCOORD.x, TEXCOORD.y), View_2388, int2(0, 0));
  float _87 = max(_84.x, _84.y);
  float _88 = ceil(_87);
  float _92 = ceil(TEXCOORD.z);
  float4 _97 = t1.SampleBias(s1, float2((TEXCOORD.z + -1.0f), (TEXCOORD.w + -1.0f)), View_2388, int2(0, 0));
  ...
  float _170 = ((_97.w * _92) + _87) * COLOR.w;
  float _199 = mad(_70, (Primitive_096[2].x), mad(_69, (Primitive_096[1].x), ((Primitive_096[0].x) * _68))) + (Primitive_096[3].x);
  float _203 = mad(_70, (Primitive_096[2].y), mad(_69, (Primitive_096[1].y), ((Primitive_096[0].y) * _68))) + (Primitive_096[3].y);
  float _231 = saturate(((1.0f - saturate((((-0.0f - (Material_000[3].y)) - (Material_000[4].y)) + _203) / (Material_000[8].y))) - saturate((((Material_000[3].y) - (Material_000[4].y)) - _203) / (Material_000[8].w))) * ((1.0f - saturate((((Material_000[3].x) - (Material_000[4].x)) - _199) / (Material_000[8].x))) - saturate((((-0.0f - (Material_000[3].x)) - (Material_000[4].x)) + _199) / (Material_000[8].z))));
  float _235 = (_231 * _231) * (3.0f - (_231 * 2.0f));
  float _252 = saturate(select(((bool)((Material_144[2].w) >= 0.5f) && (bool)(abs((Material_144[2].w) + -0.5f) > 9.999999747378752e-06f)), select(((bool)(_168 > (Material_000[4].y)) || ((bool)((bool)(_167 > (Material_000[4].x)) || ((bool)((bool)(_167 < (-0.0f - (Material_000[4].x))) || (bool)(_168 < (-0.0f - (Material_000[4].y)))))))), 0.0f, _170), (select(((bool)(abs(Material_144[2].z) > 9.999999747378752e-06f) && (bool)((Material_144[2].z) >= 0.0f)), (1.0f - _235), _235) * _170)));
  float _253 = max(((((Material_000[1].x) - _135) * (Material_144[0].y)) + _135), 0.0f);
  float _254 = max(((((Material_000[1].y) - _136) * (Material_144[0].y)) + _136), 0.0f);
  float _255 = max(((((Material_000[1].z) - _137) * (Material_144[0].y)) + _137), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_67 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_65 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_66 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      float _287 = float((bool)(bool)(frac(dot(float3(_65, _66, _67), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _290 = 1.0f;
      _291 = (1.0f - _287);
      _292 = 1.0f;
      _293 = _287;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _291), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _292), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _293), 0.0f));

  SV_Target.w = _290 * TEXT_OPACITY;
