...
float4 main(
  ...
  float4 _517 = t9.SampleBias(s9, float2(_94, _95), View_2388, int2(0, 0));
  float _522 = _517.x * (Material_576[9].x);
  float _525 = select((_522 < 0.10000000149011612f), 0.0f, 1.0f) * _522;
  float _532 = _517.y * (Material_576[9].x);
  float _535 = select((_532 < 0.10000000149011612f), 0.0f, 1.0f) * _532;
  float _542 = _517.z * (Material_576[9].x);
  float _545 = select((_542 < 0.10000000149011612f), 0.0f, 1.0f) * _542;
  float _552 = _517.w * (Material_576[9].x);
  float _555 = select((_552 < 0.10000000149011612f), 0.0f, 1.0f) * _552;
  float _574 = saturate(saturate(dot(float4(((((select(((Material_576[9].y) < _525), -0.0f, -2.0f) * _525) + _517.x) * _454) + _525), ((((select(((Material_576[9].y) < _535), -0.0f, -2.0f) * _535) + _517.y) * _454) + _535), ((((select(((Material_576[9].y) < _545), -0.0f, -2.0f) * _545) + _517.z) * _454) + _545), ((((select(((Material_576[9].y) < _555), -0.0f, -2.0f) * _555) + _517.w) * _454) + _555)), float4(((Material_000[31].x) + _505), ((Material_000[31].y) + _505), ((Material_000[31].z) + _505), ((Material_000[31].w) + _505)))) + saturate(dot(float4(((_454 * ((select(((Material_576[9].y) < _432), -0.0f, -2.0f) * _432) + _422.x)) + _432), ((((select(((Material_576[9].y) < _462), -0.0f, -2.0f) * _462) + _422.y) * _454) + _462), ((((select(((Material_576[9].y) < _473), -0.0f, -2.0f) * _473) + _422.z) * _454) + _473), ((((select(((Material_576[9].y) < _483), -0.0f, -2.0f) * _483) + _422.w) * _454) + _483)), float4((_505 + (Material_000[26].x)), (_505 + (Material_000[26].y)), (_505 + (Material_000[26].z)), (_505 + (Material_000[26].w))))));
  float _584 = (_574 * ((_405.x - _398) + (_415 * (_409.x - _405.x)))) + _398;
  float _585 = (_574 * ((_405.y - _401) + (_415 * (_409.y - _405.y)))) + _401;
  float _586 = (_574 * ((_405.z - _404) + (_415 * (_409.z - _405.z)))) + _404;
  float4 _603 = t10.SampleBias(s10, float2(((Material_576[13].x) * (((Material_576[12].w) * View_2376) + abs(((_95 + _94) * 2.0f) + -2.0f))), saturate((Material_576[13].y) + _574)), View_2388, int2(0, 0));
  float _619 = ((((Material_576[13].z) * _603.x) - _584) * _603.w) + _584;
  float _620 = ((((Material_576[13].z) * _603.y) - _585) * _603.w) + _585;
  float _621 = ((((Material_576[13].z) * _603.z) - _586) * _603.w) + _586;
  float _647;
  float _648;
  float _649;
  float _742;
  ...
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_82 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_80 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_81 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      float _739 = float((bool)(bool)(frac(dot(float3(_80, _81, _82), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _742 = 1.0f;
      _743 = (1.0f - _739);
      _744 = 1.0f;
      _745 = _739;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _743), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _744), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _745), 0.0f));

  SV_Target.w = _742 * HUD_OPACITY;
