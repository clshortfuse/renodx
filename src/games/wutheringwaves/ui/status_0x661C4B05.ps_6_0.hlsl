...
float4 main(
  ...
  float4 _78 = t0.SampleBias(s0, float2(TEXCOORD.x, TEXCOORD.y), View_2388, int2(0, 0));
  float _81 = max(_78.x, _78.y);
  float _82 = ceil(_81);
  float _86 = ceil(TEXCOORD.z);
  float4 _91 = t1.SampleBias(s1, float2((TEXCOORD.z + -1.0f), (TEXCOORD.w + -1.0f)), View_2388, int2(0, 0));
  float _96 = _91.x * _86;
  float _97 = _91.y * _86;
  float _98 = _91.z * _86;
  if ((Material_032[0].x) > 0.5f) {
