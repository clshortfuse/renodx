...
float4 main(
  ...
  float4 SV_Target;
  float _58 = mad(SV_Position.z, (dx_alignment_legacy_View_704[2].w), mad(SV_Position.y, (dx_alignment_legacy_View_704[1].w), ((dx_alignment_legacy_View_704[0].w) * SV_Position.x))) + (dx_alignment_legacy_View_704[3].w);
  float _62 = ((mad(SV_Position.z, (dx_alignment_legacy_View_704[2].x), mad(SV_Position.y, (dx_alignment_legacy_View_704[1].x), ((dx_alignment_legacy_View_704[0].x) * SV_Position.x))) + (dx_alignment_legacy_View_704[3].x)) / _58) - dx_alignment_legacy_View_1120.x;
  float _63 = ((mad(SV_Position.z, (dx_alignment_legacy_View_704[2].y), mad(SV_Position.y, (dx_alignment_legacy_View_704[1].y), ((dx_alignment_legacy_View_704[0].y) * SV_Position.x))) + (dx_alignment_legacy_View_704[3].y)) / _58) - dx_alignment_legacy_View_1120.y;
  float _64 = ((mad(SV_Position.z, (dx_alignment_legacy_View_704[2].z), mad(SV_Position.y, (dx_alignment_legacy_View_704[1].z), ((dx_alignment_legacy_View_704[0].z) * SV_Position.x))) + (dx_alignment_legacy_View_704[3].z)) / _58) - dx_alignment_legacy_View_1120.z;
  float _73;
  float _74;
  float _75;
  float _126;
  ...
  float4 _78 = t0.SampleBias(s0, float2(TEXCOORD.x, TEXCOORD.y), dx_alignment_legacy_View_2388, int2(0, 0));
  float _81 = max(_78.x, _78.y);
  float _82 = ceil(_81);
  float _86 = ceil(TEXCOORD.z);
  float4 _91 = t1.SampleBias(s1, float2((TEXCOORD.z + -1.0f), (TEXCOORD.w + -1.0f)), dx_alignment_legacy_View_2388, int2(0, 0));
  float _96 = _91.x * _86;
  float _97 = _91.y * _86;
  float _98 = _91.z * _86;
  if ((Material_032[0].x) > 0.5f) {
    _126 = max(((exp2(log2(max(_96, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
  ...
  float _129 = _126 + (_82 * _73);
  float _130 = _127 + (_82 * _74);
  float _131 = _128 + (_82 * _75);
  float _148 = saturate(((_91.w * _86) + _81) * COLOR.w);
  float _149 = max(((((Material_000[1].x) - _129) * (Material_032[0].y)) + _129), 0.0f);
  float _150 = max(((((Material_000[1].y) - _130) * (Material_032[0].y)) + _130), 0.0f);
  float _151 = max(((((Material_000[1].z) - _131) * (Material_032[0].y)) + _131), 0.0f);
  [branch]
  if (dx_alignment_legacy_View_2336 > 0.0f) {
    if ((bool)(abs(_64 - dx_alignment_legacy_Primitive_080.z) > (dx_alignment_legacy_Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_62 - dx_alignment_legacy_Primitive_080.x) > (dx_alignment_legacy_Primitive_304.x + 1.0f)) || (bool)(abs(_63 - dx_alignment_legacy_Primitive_080.y) > (dx_alignment_legacy_Primitive_304.y + 1.0f))))) {
      float _183 = float((bool)(bool)(frac(dot(float3(_62, _63, _64), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _186 = 1.0f;
      _187 = (1.0f - _183);
      _188 = 1.0f;
      _189 = _183;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _187), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _188), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _189), 0.0f));
  SV_Target.w = _186 * TEXT_OPACITY;
  return SV_Target;
}
