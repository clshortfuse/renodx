...
float4 main(
  ...
  float _183 = mad(_68, (Primitive_096[2].x), mad(_67, (Primitive_096[1].x), ((Primitive_096[0].x) * _66))) + (Primitive_096[3].x);
  float _187 = mad(_68, (Primitive_096[2].y), mad(_67, (Primitive_096[1].y), ((Primitive_096[0].y) * _66))) + (Primitive_096[3].y);
  ...
  float4 _240 = t1.SampleBias(s1, float2(((_183 - (Material_000[14].x)) / (Material_000[15].x)), (1.0f - ((_187 - (Material_000[14].y)) / (Material_000[15].y)))), View_2388, int2(0, 0));
