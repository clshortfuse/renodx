...
float4 main(
  ...
  float4 SV_Target;
  float _59 = mad(SV_Position.z, (dx_alignment_legacy_View_704[2].w), mad(SV_Position.y, (dx_alignment_legacy_View_704[1].w), ((dx_alignment_legacy_View_704[0].w) * SV_Position.x))) + (dx_alignment_legacy_View_704[3].w);
  float _63 = ((mad(SV_Position.z, (dx_alignment_legacy_View_704[2].x), mad(SV_Position.y, (dx_alignment_legacy_View_704[1].x), ((dx_alignment_legacy_View_704[0].x) * SV_Position.x))) + (dx_alignment_legacy_View_704[3].x)) / _59) - dx_alignment_legacy_View_1120.x;
  float _64 = ((mad(SV_Position.z, (dx_alignment_legacy_View_704[2].y), mad(SV_Position.y, (dx_alignment_legacy_View_704[1].y), ((dx_alignment_legacy_View_704[0].y) * SV_Position.x))) + (dx_alignment_legacy_View_704[3].y)) / _59) - dx_alignment_legacy_View_1120.y;
  float _65 = ((mad(SV_Position.z, (dx_alignment_legacy_View_704[2].z), mad(SV_Position.y, (dx_alignment_legacy_View_704[1].z), ((dx_alignment_legacy_View_704[0].z) * SV_Position.x))) + (dx_alignment_legacy_View_704[3].z)) / _59) - dx_alignment_legacy_View_1120.z;
  float _66 = TEXCOORD_9.x - dx_alignment_legacy_View_1120.x;
  float _67 = TEXCOORD_9.y - dx_alignment_legacy_View_1120.y;
  float _68 = TEXCOORD_9.z - dx_alignment_legacy_View_1120.z;
  float _77;
  float _78;
  float _79;
  float _146;
  ...
  float4 _115 = t0.SampleBias(s0, float2((((Material_000[4].x) * min(max(frac(((Material_000[5].x) * ((TEXCOORD.x - (Material_000[3].x)) / (Material_000[4].x))) + (Material_000[6].x)), (Material_256[0].y)), (Material_256[2].z))) + (Material_000[3].x)), (((Material_000[4].y) * min(max(frac(((Material_000[5].y) * ((TEXCOORD.y - (Material_000[3].y)) / (Material_000[4].y))) + (Material_000[6].y)), (Material_256[0].y)), (Material_256[2].z))) + (Material_000[3].y))), dx_alignment_legacy_View_2388, int2(0, 0));
  if ((Material_256[0].x) > 0.5f) {
    _146 = max(((exp2(log2(max(_115.x, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _147 = max(((exp2(log2(max(_115.y, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _148 = max(((exp2(log2(max(_115.z, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
  } else {
    _146 = _115.x;
    _147 = _115.y;
    _148 = _115.z;
  ...
  float _150 = _147 * _78;
  float _151 = _148 * _79;
  float _167 = _115.w * COLOR.w;
  float _183 = mad(_68, (dx_alignment_legacy_Primitive_096[2].x), mad(_67, (dx_alignment_legacy_Primitive_096[1].x), ((dx_alignment_legacy_Primitive_096[0].x) * _66))) + (dx_alignment_legacy_Primitive_096[3].x);
  float _187 = mad(_68, (dx_alignment_legacy_Primitive_096[2].y), mad(_67, (dx_alignment_legacy_Primitive_096[1].y), ((dx_alignment_legacy_Primitive_096[0].y) * _66))) + (dx_alignment_legacy_Primitive_096[3].y);
  float _210 = saturate((1.0f - saturate((abs(_187 - (Material_000[10].y)) - (Material_000[11].y)) / (Material_000[12].y))) * (1.0f - saturate((abs(_183 - (Material_000[10].x)) - (Material_000[11].x)) / (Material_000[12].x))));
  float _214 = (_210 * _210) * (3.0f - (_210 * 2.0f));
  float _226 = select(((Material_256[4].w) > 0.5f), (select(((bool)(abs(Material_256[4].z) > 9.999999747378752e-06f) && (bool)((Material_256[4].z) >= 0.0f)), (1.0f - _214), _214) * _167), _167);
  float4 _240 = t1.SampleBias(s1, float2(((_183 - (Material_000[14].x)) / (Material_000[15].x)), (1.0f - ((_187 - (Material_000[14].y)) / (Material_000[15].y)))), dx_alignment_legacy_View_2388, int2(0, 0));
  float _247 = saturate(select(((Material_256[6].x) > 0.5f), (_240.x * _226), _226));
  float _248 = max(((((Material_000[7].x) - _149) * (Material_256[2].w)) + _149), 0.0f);
  float _249 = max(((((Material_000[7].y) - _150) * (Material_256[2].w)) + _150), 0.0f);
  float _250 = max(((((Material_000[7].z) - _151) * (Material_256[2].w)) + _151), 0.0f);
  [branch]
  if (dx_alignment_legacy_View_2336 > 0.0f) {
    if ((bool)(abs(_65 - dx_alignment_legacy_Primitive_080.z) > (dx_alignment_legacy_Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_63 - dx_alignment_legacy_Primitive_080.x) > (dx_alignment_legacy_Primitive_304.x + 1.0f)) || (bool)(abs(_64 - dx_alignment_legacy_Primitive_080.y) > (dx_alignment_legacy_Primitive_304.y + 1.0f))))) {
      float _282 = float((bool)(bool)(frac(dot(float3(_63, _64, _65), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _285 = 1.0f;
      _286 = (1.0f - _282);
      _287 = 1.0f;
      _288 = _282;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _286), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _287), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _288), 0.0f));
  SV_Target.w = _285 * HUD_OPACITY;
  return SV_Target;
}
