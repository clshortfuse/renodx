...
float4 main(
  ...
  float _66 = TEXCOORD_9.x - View_1120.x;
  float _67 = TEXCOORD_9.y - View_1120.y;
  float _68 = TEXCOORD_9.z - View_1120.z;
  float _77;
  float _78;
  float _79;
  float _113;
  ...
  float4 _82 = t0.SampleBias(s0, float2(TEXCOORD.x, TEXCOORD.y), View_2388, int2(0, 0));
  if ((Material_192[0].x) > 0.5f) {
    _113 = max(((exp2(log2(max(_82.x, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _114 = max(((exp2(log2(max(_82.y, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _115 = max(((exp2(log2(max(_82.z, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
  } else {
    _113 = _82.x;
    _114 = _82.y;
    _115 = _82.z;
  ...
  float _150 = _82.w * COLOR.w;
  float _179 = mad(_68, (Primitive_096[2].x), mad(_67, (Primitive_096[1].x), ((Primitive_096[0].x) * _66))) + (Primitive_096[3].x);
  float _183 = mad(_68, (Primitive_096[2].y), mad(_67, (Primitive_096[1].y), ((Primitive_096[0].y) * _66))) + (Primitive_096[3].y);
  float _211 = saturate(((1.0f - saturate((((-0.0f - (Material_000[3].y)) - (Material_000[4].y)) + _183) / (Material_000[8].y))) - saturate((((Material_000[3].y) - (Material_000[4].y)) - _183) / (Material_000[8].w))) * ((1.0f - saturate((((Material_000[3].x) - (Material_000[4].x)) - _179) / (Material_000[8].x))) - saturate((((-0.0f - (Material_000[3].x)) - (Material_000[4].x)) + _179) / (Material_000[8].z))));
  float _215 = (_211 * _211) * (3.0f - (_211 * 2.0f));
  float4 _245 = t1.SampleBias(s1, float2(((_179 - (Material_000[10].x)) / (Material_000[11].x)), (1.0f - ((_183 - (Material_000[10].y)) / (Material_000[11].y)))), View_2388, int2(0, 0));
  float _252 = saturate(saturate((Material_192[4].x) * _245.x) * select(((bool)((Material_192[2].w) >= 0.5f) && (bool)(abs((Material_192[2].w) + -0.5f) > 9.999999747378752e-06f)), select(((bool)(_149 > (Material_000[4].y)) || ((bool)((bool)(_148 > (Material_000[4].x)) || ((bool)((bool)(_148 < (-0.0f - (Material_000[4].x))) || (bool)(_149 < (-0.0f - (Material_000[4].y)))))))), 0.0f, _150), (select(((bool)(abs(Material_192[2].z) > 9.999999747378752e-06f) && (bool)((Material_192[2].z) >= 0.0f)), (1.0f - _215), _215) * _150)));
  float _253 = max(((((Material_000[1].x) - _116) * (Material_192[0].y)) + _116), 0.0f);
  float _254 = max(((((Material_000[1].y) - _117) * (Material_192[0].y)) + _117), 0.0f);
  float _255 = max(((((Material_000[1].z) - _118) * (Material_192[0].y)) + _118), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_65 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_63 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_64 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      float _287 = float((bool)(bool)(frac(dot(float3(_63, _64, _65), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _290 = 1.0f;
      _291 = (1.0f - _287);
      _292 = 1.0f;
      _293 = _287;
