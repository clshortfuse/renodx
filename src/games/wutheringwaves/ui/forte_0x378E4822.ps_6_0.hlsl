...
OutputSignature main(
  ...
  float _115 = _112 * _76;
  float _116 = _113 * _77;
  float _147 = mad(_66, (Primitive_096[2].x), mad(_65, (Primitive_096[1].x), ((Primitive_096[0].x) * _64))) + (Primitive_096[3].x);
  float _151 = mad(_66, (Primitive_096[2].y), mad(_65, (Primitive_096[1].y), ((Primitive_096[0].y) * _64))) + (Primitive_096[3].y);
  float _186 = saturate(((1.0f - saturate(((_151 - (Material_000[7].y)) - (Material_000[6].y)) / (Material_000[8].y))) - saturate((((-0.0f - _151) - (Material_000[7].y)) + (Material_000[6].y)) / (Material_000[8].w))) * ((1.0f - saturate((((-0.0f - _147) - (Material_000[7].x)) + (Material_000[6].x)) / (Material_000[8].x))) - saturate(((_147 - (Material_000[7].x)) - (Material_000[6].x)) / (Material_000[8].z))));
  float _190 = (_186 * _186) * (3.0f - (_186 * 2.0f));
  float _200 = saturate((_80.w * COLOR.w) * select(((bool)(abs(Material_144[2].z) > 9.999999747378752e-06f) && (bool)((Material_144[2].z) >= 0.0f)), (1.0f - _190), _190));
  float _201 = max(((((Material_000[1].x) - _114) * (Material_144[0].y)) + _114), 0.0f);
  float _202 = max(((((Material_000[1].y) - _115) * (Material_144[0].y)) + _115), 0.0f);
  float _203 = max(((((Material_000[1].z) - _116) * (Material_144[0].y)) + _116), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_63 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_61 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_62 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      float _235 = float((bool)(bool)(frac(dot(float3(_61, _62, _63), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _238 = 1.0f;
      _239 = (1.0f - _235);
      _240 = 1.0f;
      _241 = _235;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _239), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _240), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _241), 0.0f));

  SV_Target.w = _238 * HUD_OPACITY;
