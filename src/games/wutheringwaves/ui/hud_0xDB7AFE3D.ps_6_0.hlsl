...
float4 main(
  ...
  float4 SV_Target;
  float _54 = mad(SV_Position.z, (dx_alignment_legacy_View_704[2].w), mad(SV_Position.y, (dx_alignment_legacy_View_704[1].w), ((dx_alignment_legacy_View_704[0].w) * SV_Position.x))) + (dx_alignment_legacy_View_704[3].w);
  float _58 = ((mad(SV_Position.z, (dx_alignment_legacy_View_704[2].x), mad(SV_Position.y, (dx_alignment_legacy_View_704[1].x), ((dx_alignment_legacy_View_704[0].x) * SV_Position.x))) + (dx_alignment_legacy_View_704[3].x)) / _54) - dx_alignment_legacy_View_1120.x;
  float _59 = ((mad(SV_Position.z, (dx_alignment_legacy_View_704[2].y), mad(SV_Position.y, (dx_alignment_legacy_View_704[1].y), ((dx_alignment_legacy_View_704[0].y) * SV_Position.x))) + (dx_alignment_legacy_View_704[3].y)) / _54) - dx_alignment_legacy_View_1120.y;
  float _60 = ((mad(SV_Position.z, (dx_alignment_legacy_View_704[2].z), mad(SV_Position.y, (dx_alignment_legacy_View_704[1].z), ((dx_alignment_legacy_View_704[0].z) * SV_Position.x))) + (dx_alignment_legacy_View_704[3].z)) / _54) - dx_alignment_legacy_View_1120.z;
  float _69;
  float _70;
  float _71;
  float _105;
  ...
  float4 _74 = t0.SampleBias(s0, float2(TEXCOORD.x, TEXCOORD.y), dx_alignment_legacy_View_2388, int2(0, 0));
  if ((Material_032[0].x) > 0.5f) {
  ...
  if (dx_alignment_legacy_View_2336 > 0.0f) {
    if ((bool)(abs(_60 - dx_alignment_legacy_Primitive_080.z) > (dx_alignment_legacy_Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_58 - dx_alignment_legacy_Primitive_080.x) > (dx_alignment_legacy_Primitive_304.x + 1.0f)) || (bool)(abs(_59 - dx_alignment_legacy_Primitive_080.y) > (dx_alignment_legacy_Primitive_304.y + 1.0f))))) {
