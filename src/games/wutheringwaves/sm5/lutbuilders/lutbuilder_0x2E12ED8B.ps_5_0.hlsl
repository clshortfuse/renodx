...
// ---- Created with 3Dmigoto v1.4.1 on Fri Aug 29 17:23:27 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  // r0.xyz = cb0[46].xxx ? r0.xyz : r1.xyz;
  r0.xyz = tm_flags.xxx ? r0.xyz : r1.xyz;
  r0.w = dot(r0.xyz, float3(0.272228718,0.674081743,0.0536895171));
  ...
  r0.xyz = cb0[75].xxx * r0.xyz + r1.yzw;
  ...
  if (r0.w != 0) {
    ...
    r1.xyz = max(float3(0,0,0), r1.xyz);
    r1.xyz = r1.xyz + -r0.xyz;
    r0.xyz = cb0[75].zzz * r1.xyz + r0.xyz;
  }
  // if (cb0[46].x != 0) {
  if (tm_flags.x != 0) {
    ...
    r0.xyz = cb0[75].xxx * r3.xyz + r0.xyz;
  ...
  if (cb0[74].z == 0) {
    ...
    r4.xyzw = cmp(asint(cb0[74].wwww) == int4(1,2,3,4));
    ...
    if (r0.w != 0) {
      ...
      r7.xy = cmp(asint(cb0[74].zz) == int2(3,5));
      ...
      if (r0.w != 0) {
        ...
        r7.xy = cmp(asint(cb0[74].zz) == int2(4,6));
        r0.w = (int)r7.y | (int)r7.x;
        if (r0.w != 0) {
          r7.xyz = float3(3,3,3) * r2.xyz;
          r8.y = dot(float3(0.439700812,0.382978052,0.1773348), r7.xyz);
          ...
          if (r0.w != 0) {
            ...
            r7.xy = cmp(asint(cb0[74].zz) == int2(8,9));
