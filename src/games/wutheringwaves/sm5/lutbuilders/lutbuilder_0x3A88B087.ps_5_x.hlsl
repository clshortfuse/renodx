...
void main(
  ...
  r1.w = r1.w * r1.w;
  r1.w = -r2.x * r1.w + 1;
  r2.xyzw = cb0[63].xyzw * cb0[48].xyzw;
  r3.xyzw = cb0[64].xyzw * cb0[49].xyzw;
  r4.xyzw = cb0[65].xyzw * cb0[50].xyzw;
  r5.xyzw = cb0[66].xyzw * cb0[51].xyzw;
  r6.xyzw = cb0[67].xyzw + cb0[52].xyzw;
  r2.xyz = r2.xyz * r2.www;
  ...
  r0.xyz = cb0[74].zzz * r2.xyz + r0.xyz;
  // r2.xyz = cmp(asint(cb0[46].yzw) == int3(0, 0, 0));
  r2.xyz = cmp(asint(tm_flags.yzw) == int3(0, 0, 0));
  r0.w = r2.y ? r2.x : 0;
  r0.w = r2.z ? r0.w : 0;
  if (r0.w != 0) {
    ...
    r2.xyz = max(float3(0, 0, 0), r2.xyz);
    r2.xyz = r2.xyz + -r0.xyz;
    r0.xyz = cb0[75].xxx * r2.xyz + r0.xyz;
  }
  [branch]
  ...
  r2.xyz = cb0[41].xxx * r2.xyz;
  r0.xyz = cb0[40].xxx * r0.xyz + r2.xyz;
  ...
  r2.xyz = cb0[44].yzw * r0.xyz;
  r0.xyz = -r0.xyz * cb0[44].yzw + cb0[45].xyz;
  r0.xyz = cb0[45].www * r0.xyz + r2.xyz;
  ...
  if (asuint(cb0[74].x) == 0) {
    ...
    if (r0.w != 0) {
      ...
      r7.xyz = cb0[44].yzw * r1.xyz;
      r1.xyz = -r1.xyz * cb0[44].yzw + cb0[45].xyz;
      r1.xyz = cb0[45].www * r1.xyz + r7.xyz;
