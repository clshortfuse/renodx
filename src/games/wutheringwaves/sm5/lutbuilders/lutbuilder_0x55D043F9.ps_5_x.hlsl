...
// Found in Wuthering Waves

// ---- Created with 3Dmigoto v1.3.16 on Thu Jun 12 12:57:58 2025
...
void main(
  ...
  const float4 tm_flags = float4(
    cb0[46].x,
    cmp(RENODX_WUWA_TM == 1),
    cmp(RENODX_WUWA_TM == 2),
    cmp(RENODX_WUWA_TM == 3)
  );
  ...
  r0.w = 1.00055635 * cb0[47].x;
  r1.x = cmp(6996.10791 >= cb0[47].x);
  ...
  r2.xyz = cb0[47].xxx * float3(0.000154118257, 0.00084242021, 4.22806261e-05) + float3(0.860117733, 1, 0.317398727);
  r0.w = cb0[47].x * cb0[47].x;
  r2.xyz = r0.www * float3(1.28641219e-07, 7.08145137e-07, 4.20481676e-08) + r2.xyz;
  r2.x = r2.x / r2.y;
  r1.z = -cb0[47].x * 2.8974182e-05 + 1;
  ...
  r0.xyz = (asuint(cb0[46].x) != 0u) ? r0.xyz : r1.xyz;
  r0.w = dot(r0.xyz, float3(0.272228718, 0.674081743, 0.0536895171));
  r1.xyzw = cb0[53].xyzw * cb0[48].xyzw;
  r2.xyzw = cb0[54].xyzw * cb0[49].xyzw;
  r3.xyzw = cb0[55].xyzw * cb0[50].xyzw;
  r4.xyzw = cb0[56].xyzw * cb0[51].xyzw;
  r5.xyzw = cb0[57].xyzw + cb0[52].xyzw;
  ...
  r2.y = max(r2.y, r1.x);
  r2.x = r2.y + -r2.x;
  r2.z = cmp(r2.x != 0.000000);
  r3.y = r2.x / r2.y;
  r4.xyz = r1.yzx + -r1.zxy;
  r4.xyz = r4.xyz / r2.xxx;
  r1.xyz = cmp(r1.xyz == r2.yyy);
  r2.xw = float2(2, 4) + r4.yz;
  r1.z = r1.z ? r2.w : 0;
  r1.y = r1.y ? r2.x : r1.z;
  r3.x = r1.x ? r4.x : r1.y;
  r1.xy = r2.zz ? r3.xy : 0;
  ...
  r1.x = cmp(r1.z == 4.000000);
  r2.z = 1;
  r3.z = 1;
  r1.xz = r1.xx ? r2.xz : r3.zy;
  r1.y = r3.x;
  r1.xyz = r4.www ? r3.xyz : r1.xyz;
  r3.w = r2.x;
  r1.xyz = r4.zzz ? r3.xzw : r1.xyz;
  r1.xyz = r4.yyy ? r3.yzx : r1.xyz;
  r1.xyz = r4.xxx ? r3.zwx : r1.xyz;
  ...
  r7.xyzw = cb0[67].xyzw + cb0[52].xyzw;
  r2.yzw = r3.xyz * r3.www;
  r2.yzw = r2.yzw * r0.xyz + r0.www;
  r2.yzw = max(float3(0, 0, 0), r2.yzw);
  r2.yzw = float3(5.55555534, 5.55555534, 5.55555534) * r2.yzw;
  r3.xyz = r4.xyz * r4.www;
  r2.yzw = log2(r2.yzw);
  r2.yzw = r3.xyz * r2.yzw;
  r2.yzw = exp2(r2.yzw);
  r2.yzw = float3(0.180000007, 0.180000007, 0.180000007) * r2.yzw;
  r3.xyz = r5.xyz * r5.www;
  ...
  r2.yzw = r2.yzw * r3.xyz + r4.xyz;
  r2.yzw = saturate(r2.yzw * r1.www);
  r3.x = min(r2.z, r2.w);
  r3.x = min(r3.x, r2.y);
  r3.y = max(r2.z, r2.w);
  r3.y = max(r3.y, r2.y);
  ...
  r4.y = r3.x / r3.y;
  r5.xyz = r2.zwy + -r2.wyz;
  r5.xyz = r5.xyz / r3.xxx;
  r2.yzw = cmp(r2.yzw == r3.yyy);
  r3.xw = float2(2, 4) + r5.yz;
  r2.w = r2.w ? r3.w : 0;
  r2.z = r2.z ? r3.x : r2.w;
  r4.x = r2.y ? r5.x : r2.z;
  r2.yz = r3.zz ? r4.xy : 0;
  ...
  r2.y = 1 + -r2.y;
  r3.x = -r2.z * r2.y + 1;
  r5.xyzw = cmp(r2.wwww == float4(0, 1, 2, 3));
  r2.y = cmp(r2.w == 4.000000);
  r3.z = 1;
  r4.z = 1;
  r6.xz = r2.yy ? r3.xz : r4.zy;
  r6.y = r4.x;
  r2.yzw = r5.www ? r4.xyz : r6.xyz;
  r4.w = r3.x;
  r2.yzw = r5.zzz ? r4.xzw : r2.yzw;
  r2.yzw = r5.yyy ? r4.yzx : r2.yzw;
  r2.yzw = r5.xxx ? r4.zwx : r2.yzw;
  ...
  r3.x = r3.x * r3.x;
  r3.z = r3.y * r3.x;
  r4.xyzw = cb0[58].xyzw * cb0[48].xyzw;
  r5.xyzw = cb0[59].xyzw * cb0[49].xyzw;
  r6.xyzw = cb0[60].xyzw * cb0[50].xyzw;
  r7.xyzw = cb0[61].xyzw * cb0[51].xyzw;
  r8.xyzw = cb0[62].xyzw + cb0[52].xyzw;
  ...
  r0.xyz = saturate(r0.xyz * r1.www);
  r0.w = min(r0.y, r0.z);
  r0.w = min(r0.x, r0.w);
  r3.w = max(r0.y, r0.z);
  r3.w = max(r3.w, r0.x);
  r0.w = r3.w + -r0.w;
  r4.x = cmp(r0.w != 0.000000);
  r5.y = r0.w / r3.w;
  r4.yzw = r0.yzx + -r0.zxy;
  r4.yzw = r4.yzw / r0.www;
  r0.xyz = cmp(r0.xyz == r3.www);
  r4.zw = float2(2, 4) + r4.zw;
  r0.z = r0.z ? r4.w : 0;
  r0.y = r0.y ? r4.z : r0.z;
  r5.x = r0.x ? r4.y : r0.y;
  r0.xy = r4.xx ? r5.xy : 0;
  ...
  r0.x = 1 + -r0.x;
  r5.x = -r0.y * r0.x + 1;
  r6.xyzw = cmp(r0.zzzz == float4(0, 1, 2, 3));
  r0.x = cmp(r0.z == 4.000000);
  r5.z = 1;
  r4.z = 1;
  r0.xz = r0.xx ? r5.xz : r4.zy;
  r0.y = r4.x;
  r0.xyz = r6.www ? r4.xyz : r0.xyz;
  r4.w = r5.x;
  r0.xyz = r6.zzz ? r4.xzw : r0.xyz;
  r0.xyz = r6.yyy ? r4.yzx : r0.xyz;
  r0.xyz = r6.xxx ? r4.zwx : r0.xyz;
  r0.xyz = r0.xyz * r3.www;
  r0.w = 1 + -r2.x;
  r0.w = -r3.y * r3.x + r0.w;
  r0.xyz = r0.xyz * r0.www;
  r0.xyz = r1.xyz * r2.xxx + r0.xyz;
  r0.xyz = r2.yzw * r3.zzz + r0.xyz;
  r0.w = dot(r0.xyz, float3(0.272228718, 0.674081743, 0.0536895171));
  ...
  r0.xyz = r1.xyz * r0.xyz;
  r0.xyz = exp2(r0.xyz);
  r1.xyz = cb0[71].xyz * cb0[71].www;
  r2.xyz = cb0[72].xyz + cb0[72].www;
  ...
  r2.y = r0.w / r1.x;
  r3.xyz = r0.yzx + -r0.zxy;
  r3.xyz = r3.xyz / r0.www;
  r0.xyz = cmp(r0.xyz == r1.xxx);
  r1.zw = float2(2, 4) + r3.yz;
  r0.z = r0.z ? r1.w : 0;
  r0.y = r0.y ? r1.z : r0.z;
  r2.x = r0.x ? r3.x : r0.y;
  r0.xy = r1.yy ? r2.xy : 0;
  ...
  r3.x = dot(float3(0.938639402, 1.02359565e-10, 0.0613606237), r1.yzw);
  r3.y = dot(float3(8.36008554e-11, 0.830794156, 0.169205874), r1.yzw);
  r3.z = dot(float3(2.13187367e-12, -5.63307213e-12, 1), r1.yzw);
  r0.xyz = -r0.xyz * r1.xxx + r3.xyz;
  r0.xyz = cb0[74].zzz * r0.xyz + r1.yzw;
  // r1.xyz = cmp(asint(cb0[46].yzw) == int3(0, 0, 0));
  r1.xyz = cmp(asint(tm_flags.yzw) == int3(0, 0, 0));
  r0.w = r1.y ? r1.x : 0;
  r0.w = r1.z ? r0.w : 0;
  if (r0.w != 0) {
    ...
    r1.x = max(r1.y, r1.z);
    r1.x = max(r1.x, r1.w);
    r3.xy = max(float2(1.00000001e-10, 0.00999999978), r1.xx);
    r0.w = max(1.00000001e-10, r0.w);
    r0.w = r3.x + -r0.w;
    r0.w = r0.w / r3.y;
    r3.xyz = r1.wzy + -r1.zyw;
    r3.xy = r3.xy * r1.wz;
    r1.x = r3.x + r3.y;
    r1.x = r1.y * r3.z + r1.x;
    r1.x = sqrt(r1.x);
    ...
    r4.x = r3.y * 2 + -r3.z;
    r1.w = -r1.w * r1.x + r4.x;
    r4.x = min(abs(r1.z), abs(r1.w));
    r4.y = max(abs(r1.z), abs(r1.w));
    r4.y = 1 / r4.y;
    r4.x = r4.x * r4.y;
    r4.y = r4.x * r4.x;
    ...
    r5.xyz = r1.xyz * float3(0.30103001, 0.30103001, 0.30103001) + r3.yyy;
    r5.xyz = cb0[36].xxx * r5.xyz;
    r3.y = r0.w + r0.w;
    r3.w = -2 * cb0[36].x;
    r0.w = r3.w / r0.w;
    r6.xyz = r1.xyz * float3(0.30103001, 0.30103001, 0.30103001) + -r3.xxx;
    ...
    r2.w = r3.y / r2.w;
    r1.xyz = r1.xyz * float3(0.30103001, 0.30103001, 0.30103001) + -r3.zzz;
    ...
    r1.xyz = r3.xyz * r1.xyz + r7.xyz;
    r0.w = dot(r1.xyz, float3(0.272228718, 0.674081743, 0.0536895171));
    r1.xyz = r1.xyz + -r0.www;
    r1.xyz = r1.xyz * float3(0.930000007, 0.930000007, 0.930000007) + r0.www;
    r1.xyz = max(float3(0, 0, 0), r1.xyz);
    r1.xyz = r1.xyz + -r0.xyz;
    r0.xyz = cb0[75].xxx * r1.xyz + r0.xyz;
  }
  [branch]
  if (asuint(cb0[46].x) != 0) {
    r1.x = dot(r2.xyz, cb0[28].xyz);
    r1.y = dot(r2.xyz, cb0[29].xyz);
    r1.z = dot(r2.xyz, cb0[30].xyz);
    ...
    r1.xyz = max(float3(0, 0, 0), r1.xyz);
    r3.xyz = cb0[31].xxx + -r1.xyz;
    r3.xyz = max(float3(0, 0, 0), r3.xyz);
    r4.xyz = max(cb0[31].zzz, r1.xyz);
    r1.xyz = max(cb0[31].xxx, r1.xyz);
    r1.xyz = min(cb0[31].zzz, r1.xyz);
    ...
    r1.xyz = r1.xyz * cb0[30].www + r3.xyz;
    ...
    r0.xyz = cb0[74].zzz * r3.xyz + r0.xyz;
  ...
  r1.y = r1.y + r1.w;
  r1.x = 0.0625 * r1.y;
  r3.xyz = t1.Sample(s1_s, r1.xz).xyz;
  r1.yw = float2(0.0625, 0) + r1.xz;
  r4.xyz = t1.Sample(s1_s, r1.yw).xyz;
  r4.xyz = r4.xyz + -r3.xyz;
  r3.xyz = r0.www * r4.xyz + r3.xyz;
  r3.xyz = cb0[41].xxx * r3.xyz;
  r0.xyz = cb0[40].xxx * r0.xyz + r3.xyz;
  r3.xyz = t2.Sample(s2_s, r1.xz).xyz;
  r4.xyz = t2.Sample(s2_s, r1.yw).xyz;
  r4.xyz = r4.xyz + -r3.xyz;
  r3.xyz = r0.www * r4.xyz + r3.xyz;
  r0.xyz = cb0[42].xxx * r3.xyz + r0.xyz;
  r3.xyz = t0.Sample(s0_s, r1.xz).xyz;
  r1.xyz = t0.Sample(s0_s, r1.yw).xyz;
  r1.xyz = r1.xyz + -r3.xyz;
  r1.xyz = r0.www * r1.xyz + r3.xyz;
  r1.xyz = r1.xyz + -r0.xyz;
  r1.xyz = cb0[39].zzz * r1.xyz;
  r0.xyz = cb0[38].www * r1.xyz + r0.xyz;
  ...
  r0.xyz = cb0[26].xxx * r1.xyz + r0.xyz;
  r0.xyz = cb0[26].zzz + r0.xyz;
  r1.xyz = cb0[44].yzw * r0.xyz;
  r0.xyz = -r0.xyz * cb0[44].yzw + cb0[45].xyz;
  r0.xyz = cb0[45].www * r0.xyz + r1.xyz;
  r1.xyz = max(float3(0, 0, 0), r0.xyz);
  r1.xyz = log2(r1.xyz);
  r1.xyz = cb0[27].yyy * r1.xyz;
  r3.xyz = exp2(r1.xyz);

  o0 = GenerateLUTOutput(r3);
  return;

  [branch]
  if (asuint(cb0[74].x) == 0) {
    r4.xyz = float3(12.9200001, 12.9200001, 12.9200001) * r3.xyz;
    r5.xyz = cmp(r3.xyz >= float3(0.00313066994, 0.00313066994, 0.00313066994));
    r1.xyz = float3(0.416666657, 0.416666657, 0.416666657) * r1.xyz;
    r1.xyz = exp2(r1.xyz);
    r1.xyz = r1.xyz * float3(1.05499995, 1.05499995, 1.05499995) + float3(-0.0549999997, -0.0549999997, -0.0549999997);
    r1.xyz = r5.xyz ? r1.xyz : r4.xyz;
  } else {
    r4.xyzw = cmp(asint(cb0[74].yyyy) == int4(1, 2, 3, 4));
    ...
    if (r0.w != 0) {
      ...
      r7.xyz = cb0[44].yzw * r2.xyz;
      r2.xyz = -r2.xyz * cb0[44].yzw + cb0[45].xyz;
      r2.xyz = cb0[45].www * r2.xyz + r7.xyz;
      r7.xy = cmp(asint(cb0[74].xx) == int2(3, 5));
      r0.w = (int)r7.y | (int)r7.x;
      if (r0.w != 0) {
        r7.xyz = float3(3, 3, 3) * r2.xyz;
        ...
        r7.xy = cmp(asint(cb0[74].xx) == int2(4, 6));
        r0.w = (int)r7.y | (int)r7.x;
        if (r0.w != 0) {
          r7.xyz = float3(3, 3, 3) * r2.xyz;
          r8.y = dot(float3(0.439700812, 0.382978052, 0.1773348), r7.xyz);
          ...
          if (r0.w != 0) {
            ...
            r7.xy = cmp(asint(cb0[74].xx) == int2(8, 9));
            ...
            r3.x = 0.454545468 + -cb0[27].z;
            r3.x = cb0[38].w * r3.x + cb0[27].z;
            r4.x = log2(r0.w);
            r4.y = log2(r1.w);
            r4.z = log2(r2.w);
