  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (cb0[89].w != 0) {
    ...
    if (r0.w != 0) {
      ...
      if (r1.w != 0) {
        ...
        if (r0.w != 0) {
          r0.w = 1 + -cb0[90].x;
          r3.xyz = cmp(float3(0.440281361,0.440281361,0.440281361) < r2.xyz);
          r4.xyz = float3(-0.440281361,-0.440281361,-0.440281361) + r2.xyz;
          r5.xyz = r4.xyz * r0.www + float3(1,1,1);
          r4.xyz = r4.xyz / r5.xyz;
          r4.xyz = float3(0.440281361,0.440281361,0.440281361) + r4.xyz;
  ...
  r0.w = r0.w * 0.00100000005 + -cb0[92].y;
  r1.x = cmp(0 < r0.w);
  r0.w = cmp(r0.w < 0);
  ...
  r1.x = cmp(0 < cb0[92].x);
  if (r1.x != 0) {
    r1.xyz = (RENODX_PEAK_NITS / RENODX_GAME_NITS) * cb0[94].xyz + -r0.xyz;

    r1.xyz = cb0[92].xxx * r1.xyz + r0.xyz;
    r2.xyz = cb0[93].xyz + -r0.xyz;
    r2.xyz = cb0[92].xxx * r2.xyz + r0.xyz;
  } else {
    r3.xyz = cb0[93].xyz + -r0.xyz;
    r1.xyz = abs(cb0[92].xxx) * r3.xyz + r0.xyz;

    r3.xyz = (RENODX_PEAK_NITS / RENODX_GAME_NITS) * cb0[94].xyz + -r0.xyz;

    r2.xyz = abs(cb0[92].xxx) * r3.xyz + r0.xyz;
  }
  r1.xyz = -r2.xyz + r1.xyz;
  r1.xyz = r0.www * r1.xyz + r2.xyz;
  r1.xyz = r1.xyz + -r0.xyz;
  o0.xyz = cb0[91].www * r1.xyz + r0.xyz;
