...
// ---- Created with 3Dmigoto v1.4.1 on Wed Apr 16 12:18:52 2025
...
void main(linear noperspective float2 v0: TEXCOORD0,
          ...
          linear noperspective float2 v3: TEXCOORD4, float4 v4: SV_POSITION0,
  ...
  r0.z = dot(r2.xyz, cb0[42].yzw);
  r0.z = max(cb0[41].z, r0.z);
  r0.z = log2(r0.z);
  r0.w = cb0[45].z * v1.y;
  r0.w = 0.180000007 * r0.w;
  r0.w = log2(r0.w);
  r3.xy = cb0[46].xy * v3.xy;
  r1.w = r0.z * cb0[41].x + cb0[41].y;
  r1.w = r1.w * 31 + 0.5;
  r3.z = 0.03125 * r1.w;
  r3.xy = t2.Sample(s2_s, r3.xyz).xy;
  r1.w = r3.x / r3.y;
  r2.w = t3.Sample(s3_s, v3.xy).x;
  r3.x = cmp(r3.y < 0.00100000005);
  r1.w = r3.x ? r2.w : r1.w;
  r2.w = r2.w + -r1.w;
  r1.w = cb0[45].y * r2.w + r1.w;
  r2.w = log2(v1.x);
  r1.w = r2.w + r1.w;
  r0.z = r2.w + r0.z;
  r2.w = r0.z + -r1.w;
  ...
  if (RENODX_WUWA_BLOOM > 0.f) {
    ...
    r0.xyz = r2.xyz * r0.zzz + r0.xyw * RENODX_WUWA_BLOOM;
  } else {
