...
// ---- Created with 3Dmigoto v1.4.1 on Sun Sep  7 10:37:52 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = r0.w * 0.00100000005 + -cb0[92].w;
  r1.x = cmp(0 < r0.w);
  r0.w = cmp(r0.w < 0);
  ...
  r1.x = cmp(0 < cb0[92].z);
  if (r1.x != 0) {
    // r1.xyz = cb0[94].xyz + -r0.xyz;
    r1.xyz = (RENODX_PEAK_NITS / RENODX_GAME_NITS) * cb0[94].xyz + -r0.xyz;
    r1.xyz = cb0[92].zzz * r1.xyz + r0.xyz;
    r2.xyz = cb0[93].xyz + -r0.xyz;
    r2.xyz = cb0[92].zzz * r2.xyz + r0.xyz;
  } else {
    r3.xyz = cb0[93].xyz + -r0.xyz;
    r1.xyz = abs(cb0[92].zzz) * r3.xyz + r0.xyz;
    // r3.xyz = cb0[94].xyz + -r0.xyz;
    r3.xyz = (RENODX_PEAK_NITS / RENODX_GAME_NITS) * cb0[94].xyz + -r0.xyz;
    r2.xyz = abs(cb0[92].zzz) * r3.xyz + r0.xyz;
  }
  r1.xyz = -r2.xyz + r1.xyz;
  r1.xyz = r0.www * r1.xyz + r2.xyz;
  r1.xyz = r1.xyz + -r0.xyz;
  o0.xyz = cb0[92].yyy * r1.xyz + r0.xyz;
