  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.z = -r1.x * r1.x + 1;
  r0.z = cb0[78].z * r0.z;
  r2.xy = -r0.xy * cb0[47].zw + v2.xy;
  r0.zw = r2.xy * r0.zz;
  r0.xy = r0.xy * cb0[47].zw + r0.zw;
  r2.yw = cb0[99].zz * cb0[98].xy;
  r1.w = cmp(cb0[99].x == 0.000000);
  r2.xz = r1.ww ? r2.yw : cb0[98].xy;
  // r3.xyzw = w0.xyzw * cb0[95].zwzw + cb0[95].xyxy;
  r3.xyzw = w0.xyxy * cb0[95].zwzw + cb0[95].xyxy;
  ...
  r5.xyzw = saturate(-cb0[98].zzzz + abs(r3.zwzw));
  r4.xyzw = r5.xyzw * r4.xyzw;
  r2.xyzw = -r4.ywxz * r2.ywxz + r3.ywxz;
  r1.w = cmp(0 < cb0[99].x);
  r3.xy = -cb0[99].ww * float2(0.400000006,0.200000003) + r2.xy;
  r2.xy = r1.ww ? r3.xy : r2.xy;
  r2.xyzw = r2.zxwy * cb0[96].zwzw + cb0[96].xyxy;
  r2.xyzw = r2.xyzw * cb0[48].xyxy + cb0[48].zwzw;
  r3.xy = max(cb0[53].xy, r0.xy);
  r3.xy = min(cb0[53].zw, r3.xy);
  r3.xyz = t0.Sample(s0_s, r3.xy).xyz;
  r2.xyzw = r2.xyzw * cb0[47].zwzw + r0.zwzw;
  r2.xyzw = max(cb0[53].xyxy, r2.xyzw);
  r2.xyzw = min(cb0[53].zwzw, r2.xyzw);
  ...
  r2.xyz = cb0[99].xxx * r2.xyz + r4.xyz;
