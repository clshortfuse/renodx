...
// ---- Created with 3Dmigoto v1.4.1 on Thu Jul 24 17:07:48 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.yz = cmp(float2(0,0) != cb0[80].yx);
  r3.xy = cmp(float2(0,0) != cb0[84].yz);
  r2.y = (int)r2.y | (int)r3.x;
  r3.xzw = cmp(float3(0,0,0) != cb0[85].yzx);
  r2.y = (int)r2.y | (int)r3.x;
  r4.xyz = cmp(float3(0,0,0) != cb0[86].yzx);
  r2.y = (int)r2.y | (int)r4.x;
  r5.xyz = cmp(float3(0,0,0) != cb0[87].yzx);
  r2.y = (int)r2.y | (int)r5.x;
  r4.xw = cmp(float2(0,0) != cb0[79].yz);
  r2.y = (int)r2.y | (int)r4.x;
  r6.x = max(cb0[84].y, cb0[79].y);
  r6.y = max(cb0[85].y, cb0[79].y);
  r6.z = max(cb0[86].y, cb0[79].y);
  r2.w = saturate(cb0[80].z);
  r2.w = r2.w * -1.49000001 + cb0[80].y;
  r2.w = 1.5 + r2.w;
  ...
  if (r2.y != 0) {
    r2.y = saturate(cb0[79].z);
    r2.w = r2.y * r2.y;
    r2.y = r2.y * r2.w;
    r2.y = r4.w ? r2.y : 0;
    r2.w = saturate(cb0[84].z);
    r3.x = r2.w * r2.w;
    r2.w = r3.x * r2.w;
    r2.w = r3.y ? r2.w : 0;
    r3.x = saturate(cb0[85].z);
    r3.y = r3.x * r3.x;
    r3.x = r3.x * r3.y;
    r3.x = r3.z ? r3.x : 0;
    r3.y = saturate(cb0[86].z);
    r3.z = r3.y * r3.y;
    r3.y = r3.y * r3.z;
    r3.y = r4.y ? r3.y : 0;
    r7.x = max(r2.y, r2.w);
  ...
  r1.w = 1 + r1.w;
  r1.w = min(1, r1.w);
  r2.x = saturate(max(cb0[85].x, cb0[80].x));
  r2.y = saturate(max(cb0[86].x, cb0[80].x));
  r2.z = saturate(max(cb0[87].x, cb0[80].x));
  ...
  r5.xyzw = cb0[79].xxxx * r5.xyzw + r4.yyyy;
  r4.xyzw = r1.wwww ? r5.xyzw : r4.yyyy;
  r1.zw = cmp(float2(0,0) < cb0[82].zy);
  ...
  r7.yw = cb0[99].zz * cb0[98].xy;
  r0.y = cmp(cb0[99].x == 0.000000);
  r7.xz = r0.yy ? r7.yw : cb0[98].xy;
  r8.xyzw = r0.xzxz * cb0[95].zwzw + cb0[95].xyxy;
  ...
  r10.xyzw = saturate(-cb0[98].zzzz + abs(r8.zwzw));
  r9.xyzw = r10.xyzw * r9.xyzw;
  r7.xyzw = -r9.ywxz * r7.ywxz + r8.ywxz;
  r0.x = cmp(0 < cb0[99].x);
  r0.yz = -cb0[99].ww * float2(0.400000006,0.200000003) + r7.xy;
  r7.xy = r0.xx ? r0.yz : r7.xy;
  r7.xyzw = r7.zxwy * cb0[96].zwzw + cb0[96].xyxy;
  r7.xyzw = r7.xyzw * cb0[48].xyxy + cb0[48].zwzw;
  r7.xyzw = cb0[47].zwzw * r7.xyzw;
  ...
  r5.xyw = cb0[99].xxx * r5.xyw + r8.xyz;
  r0.xyz = r0.xxx ? r5.xyw : r8.xyz;
  r2.zw = saturate(cb0[81].xy);
  r1.w = saturate(1 + -cb0[81].z);
  r3.z = cmp(0 < r2.z);
  ...
  r0.w = rcp(r0.w);
  r0.w = r0.w * r0.w;
  r1.xyw = float3(1,1,1) + -cb0[72].xyz;
  r1.xyw = r0.www * r1.xyw + cb0[72].xyz;
  r2.xy = cb0[76].xy * float2(2,2) + v1.zw;
  r2.xy = float2(-1,-1) + r2.xy;
  r2.xy = cb0[74].xx * r2.xy;
  r2.xy = cb0[74].zw * r2.xy;
  r0.w = dot(r2.xy, r2.xy);
  r2.x = saturate(cb0[75].w);
  r2.x = r2.x * 9 + 1;
  r0.w = r0.w * r2.x + 1;
  r0.w = rcp(r0.w);
  r0.w = r0.w * r0.w;
  r2.xyz = float3(1,1,1) + -cb0[75].xyz;
  r2.xyz = r0.www * r2.xyz + cb0[75].xyz;
  r1.xyw = min(r2.xyz, r1.xyw);
  ...
  r0.xyz = RENODX_WUWA_GRAIN * r4.yzw * float3(0.00390625,0.00390625,0.00390625) + r0.xyz;
