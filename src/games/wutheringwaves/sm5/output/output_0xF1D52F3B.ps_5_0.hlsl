  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xzw = cb0[80].xxx * r1.xzw + r2.xxx;
  r1.xyz = r1.yyy ? r1.xzw : r2.xxx;
  r1.w = -r1.x * r1.x + 1;
  r1.w = cb0[79].z * r1.w;
  r0.xy = -r0.xy * cb0[48].xy + v2.xy;
  r0.xy = r1.ww * r0.xy + r0.zw;
  r0.zw = max(cb0[53].zw, r0.xy);
  r0.zw = min(cb0[54].xy, r0.zw);
  ...
  r2.xyz = r1.xyz * cb0[79].xxx + cb0[79].yyy;
  r0.xyz = r2.xyz * r0.xyz;
