  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (r0.x != 0) {
    r0.x = saturate(cb0[76].z);
    r0.z = r0.x * r0.x;
    r0.x = r0.x * r0.z;
    r0.x = r4.w ? r0.x : 0;
    r0.z = saturate(cb0[81].z);
    r2.y = r0.z * r0.z;
    r0.z = r2.y * r0.z;
    r0.z = r3.y ? r0.z : 0;
    r2.y = saturate(cb0[82].z);
    r2.w = r2.y * r2.y;
    r2.y = r2.y * r2.w;
    r2.y = r3.z ? r2.y : 0;
    r2.w = saturate(cb0[83].z);
    r3.x = r2.w * r2.w;
    r2.w = r3.x * r2.w;
    r2.w = r4.y ? r2.w : 0;
    r3.x = max(r0.x, r0.z);
  ...
  r0.xz = cmp(float2(0,0) < cb0[79].zy);
  ...
  r1.xy = max(cb0[53].xy, r0.yz);
  r1.xy = min(cb0[53].zw, r1.xy);
  ...
  r1.xyz = cb0[69].xyz * r1.xyz;

  [branch]
  if (RENODX_WUWA_BLOOM > 0.f) {
    r0.yz = cb0[68].xy * r0.yz + cb0[68].zw;
    r0.yz = max(cb0[60].xy, r0.yz);
    r0.yz = min(cb0[60].zw, r0.yz);
    r0.yzw = t1.Sample(s1_s, r0.yz).xyz;
    // r0.yzw = r1.xyz * v1.xxx + r0.yzw;
    r0.yzw = r1.xyz * v1.xxx + r0.yzw * RENODX_WUWA_BLOOM;
  } else {
    r0.yzw = r1.xyz * v1.xxx;
  }
  ...
  r1.y = saturate(cb0[72].w);
  r1.y = r1.y * 9 + 1;
  r1.x = r1.x * r1.y + 1;
  r1.x = rcp(r1.x);
  r1.x = r1.x * r1.x;
  r1.yzw = float3(1,1,1) + -cb0[72].xyz;
  r1.xyz = r1.xxx * r1.yzw + cb0[72].xyz;
