...
// ---- Created with 3Dmigoto v1.4.1 on Tue Apr 29 15:30:25 2025
...
void main(
  ...
  r2.yz = cmp(float2(0, 0) != cb0[77].yx);
  r3.xy = cmp(float2(0, 0) != cb0[81].yz);
  r2.y = (int)r2.y | (int)r3.x;
  r3.xzw = cmp(float3(0, 0, 0) != cb0[82].yzx);
  r2.y = (int)r2.y | (int)r3.x;
  r4.xyz = cmp(float3(0, 0, 0) != cb0[83].yzx);
  r2.y = (int)r2.y | (int)r4.x;
  r5.xyz = cmp(float3(0, 0, 0) != cb0[84].yzx);
  r2.y = (int)r2.y | (int)r5.x;
  r4.xw = cmp(float2(0, 0) != cb0[76].yz);
  r2.y = (int)r2.y | (int)r4.x;
  r6.x = max(cb0[81].y, cb0[76].y);
  r6.y = max(cb0[82].y, cb0[76].y);
  r6.z = max(cb0[83].y, cb0[76].y);
  r2.w = saturate(cb0[77].z);
  r2.w = r2.w * -1.49000001 + cb0[77].y;
  r2.w = 1.5 + r2.w;
  ...
  if (r2.y != 0) {
    ...
    r2.w = r3.x * r2.w;
    r2.w = r3.y ? r2.w : 0;
    r3.x = saturate(cb0[82].z);
    r3.y = r3.x * r3.x;
    r3.x = r3.x * r3.y;
    r3.x = r3.z ? r3.x : 0;
    r3.y = saturate(cb0[83].z);
    r3.z = r3.y * r3.y;
    r3.y = r3.y * r3.z;
    r3.y = r4.y ? r3.y : 0;
    r7.x = max(r2.y, r2.w);
  ...
  r1.w = 1 + r1.w;
  r1.w = min(1, r1.w);
  r2.x = saturate(max(cb0[82].x, cb0[77].x));
  r2.y = saturate(max(cb0[83].x, cb0[77].x));
  r2.z = saturate(max(cb0[84].x, cb0[77].x));
  ...
  r1.zw = cmp(float2(0, 0) < cb0[79].zy);
  ...
  r7.yw = cb0[96].zz * cb0[95].xy;
  r0.y = cmp(cb0[96].x == 0.000000);
  r7.xz = r0.yy ? r7.yw : cb0[95].xy;
  ...
  r0.x = cmp(0 < cb0[96].x);
  r0.yz = -cb0[96].ww * float2(0.400000006, 0.200000003) + r7.xy;
  r7.xy = r0.xx ? r0.yz : r7.xy;
  r7.xyzw = r7.zxwy * cb0[93].zwzw + cb0[93].xyxy;
  ...
  r5.xyw = cb0[96].xxx * r5.xyw + r8.xyz;
  r0.xyz = r0.xxx ? r5.xyw : r8.xyz;
  r2.zw = saturate(cb0[78].xy);
  r1.w = saturate(1 + -cb0[78].z);
  r3.z = cmp(0 < r2.z);
