  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (r1.x != 0) {
    ...
    if (r0.z != 0) {
      r0.z = cb0[81].x + cb0[81].x;
      r2.x = cb0[64].y * cb0[64].z;
      r0.z = 0.5 * abs(r0.z);
  ...
  r0.w = r0.z * 0.5 + 0.5;
  r1.xy = r0.xz * cb0[48].xy + cb0[48].zw;
  r1.zw = cb0[47].zw * r1.xy;
  r2.x = t3.SampleLevel(s3_s, r1.zw, 0).x;
  r2.y = r2.x * cb1[65].x + cb1[65].y;
  r2.x = r2.x * cb1[65].z + -cb1[65].w;
  r2.x = 1 / r2.x;
  r2.x = r2.y + r2.x;
  r2.y = t2.Sample(s2_s, r1.zw).x;
  r2.z = cmp(cb1[31].w >= 1);
  r2.z = r2.z ? 1.000000 : 0;
  r2.w = cb1[65].w + r2.x;
  r2.w = cb1[65].z * r2.w;
  r2.w = 1 / r2.w;
  r3.x = r2.x * cb1[30].z + cb1[31].z;
  r3.x = r3.x + -r2.w;
  r2.z = r2.z * r3.x + r2.w;
  r2.z = r2.z + -r2.y;
  r3.xy = cmp(float2(0,0) != cb0[77].yx);
  r3.zw = cmp(float2(0,0) != cb0[81].yz);
  r2.w = (int)r3.z | (int)r3.x;
  r4.xyz = cmp(float3(0,0,0) != cb0[82].yzx);
  r2.w = (int)r2.w | (int)r4.x;
  r5.xyz = cmp(float3(0,0,0) != cb0[83].yzx);
  r2.w = (int)r2.w | (int)r5.x;
  r6.xyz = cmp(float3(0,0,0) != cb0[84].yzx);
  r2.w = (int)r2.w | (int)r6.x;
  r3.xz = cmp(float2(0,0) != cb0[76].yz);
  r2.w = (int)r2.w | (int)r3.x;
  r7.x = max(cb0[81].y, cb0[76].y);
  r7.y = max(cb0[82].y, cb0[76].y);
  r7.z = max(cb0[83].y, cb0[76].y);
  r3.x = saturate(cb0[77].z);
  r3.x = r3.x * -1.49000001 + cb0[77].y;
  r3.x = 1.5 + r3.x;
  ...
  r3.x = r4.x + -r3.x;
  r4.x = 1 / r4.w;
  r3.x = saturate(r4.x * r3.x);
  r4.x = r3.x * -2 + 3;
  r3.x = r3.x * r3.x;
  r3.x = r4.x * r3.x;
  r7.xyz = -r7.xyz * r3.xxx + float3(1,1,1);
  r7.xyz = r2.www ? r7.xyz : float3(1,1,1);
  r2.w = (int)r3.w | (int)r3.z;
  r2.w = (int)r4.y | (int)r2.w;
  r2.w = (int)r5.y | (int)r2.w;
  r2.w = (int)r6.y | (int)r2.w;
  if (r2.w != 0) {
    r2.w = saturate(cb0[76].z);
    r3.x = r2.w * r2.w;
    r2.w = r3.x * r2.w;
    r2.w = r3.z ? r2.w : 0;
    r3.x = saturate(cb0[81].z);
    r3.z = r3.x * r3.x;
    r3.x = r3.x * r3.z;
    r3.x = r3.w ? r3.x : 0;
    r3.z = saturate(cb0[82].z);
    r3.w = r3.z * r3.z;
    r3.z = r3.z * r3.w;
    r3.z = r4.y ? r3.z : 0;
    r3.w = saturate(cb0[83].z);
    r4.x = r3.w * r3.w;
    r3.w = r4.x * r3.w;
    r3.w = r5.y ? r3.w : 0;
    r8.xyz = max(r3.xzw, r2.www);
    r3.xzw = r8.xyz * float3(9999.99023,9999.99023,9999.99023) + float3(0.00999999978,0.00999999978,0.00999999978);
    r4.xyw = -r8.xyz * float3(1000,1000,1000) + r2.xxx;
    r3.xzw = float3(1,1,1) / r3.xzw;
    r3.xzw = saturate(r4.xyw * r3.xzw);
    r4.xyw = r3.xzw * float3(-2,-2,-2) + float3(3,3,3);
    r3.xzw = r3.xzw * r3.xzw;
    r3.xzw = r4.xyw * r3.xzw;
  } else {
    r3.xzw = float3(1,1,1);
  }
  r2.x = (int)r3.y | (int)r4.z;
  r2.x = (int)r5.z | (int)r2.x;
  r2.x = (int)r6.z | (int)r2.x;
  r2.w = cmp(0 != cb0[85].x);
  r2.x = (int)r2.w | (int)r2.x;
  r2.yz = cmp(float2(0.000500000024,0.000500000024) >= r2.yz);
  r2.y = r2.y ? 1.000000 : 0;
  r2.z = r2.z ? -1 : -0;
  r2.y = r2.y + r2.z;
  r2.y = 1 + r2.y;
  r2.y = min(1, r2.y);
  r4.x = saturate(max(cb0[82].x, cb0[77].x));
  r4.y = saturate(max(cb0[83].x, cb0[77].x));
  r4.z = saturate(max(cb0[84].x, cb0[77].x));
  r4.xyz = float3(1,1,1) + -r4.xyz;
  r2.yzw = max(r4.xyz, r2.yyy);
  r2.xyz = r2.xxx ? r2.yzw : float3(1,1,1);
  r2.w = v2.w * 543.309998 + v2.z;
  r3.y = sin(r2.w);
  r3.y = 493013 * r3.y;
  r4.xy = frac(r3.yy);

  // r3.y = cmp(0 < cb0[76].x);
  // r4.xyzw = r3.yyyy ? r5.xyzw : r4.yyyy;
  const bool grain_enabled = 0 < cb0[76].x && RENODX_WUWA_GRAIN > 0.f;

  [branch]
  if (grain_enabled) {
    r5.xy = float2(33.9900017,66.9899979) + r2.ww;
    r5.xy = sin(r5.xy);
    r5.xy = r5.xy * float2(493013,493013) + float2(7.17700005,14.2989998);
    r4.zw = frac(r5.xy);
    r5.xyzw = r4.xyzw + -r4.yyyy;
    r5.xyzw = cb0[76].xxxx * r5.xyzw + r4.yyyy;
    r4.xyzw = r5.xyzw;
  } else {
    r4.xyzw = r4.yyyy;
  }

  r5.xy = cmp(float2(0,0) < cb0[79].zy);
  r6.xyz = float3(4,0.000166666665,10) * cb1[148].zzz;
  r2.w = r0.y * 20 + r6.x;
  ...
  r0.y = 0.5 + -r0.y;
  r0.y = r2.w * r0.y;
  r3.yw = r0.yy * float2(0.00749999983,0.0149999997) + r1.zw;
  r1.zw = r5.yy ? r3.yw : r1.zw;
  r0.y = -r4.y * r4.y + 1;
  r0.y = cb0[75].z * r0.y;
  r3.yw = v2.xy + -r1.zw;
  r1.zw = r0.yy * r3.yw + r1.zw;
  r1.xy = -r1.xy * cb0[47].zw + r1.zw;
  r5.yw = cb0[96].zz * cb0[95].xy;
  r0.y = cmp(cb0[96].x == 0.000000);
  r5.xz = r0.yy ? r5.yw : cb0[95].xy;
  r8.xyzw = r0.xzxz * cb0[92].zwzw + cb0[92].xyxy;
  ...
  r10.xyzw = saturate(-cb0[95].zzzz + abs(r8.zwzw));
  r9.xyzw = r10.xyzw * r9.xyzw;
  r5.xyzw = -r9.ywxz * r5.ywxz + r8.ywxz;
  r0.x = cmp(0 < cb0[96].x);
  r0.yz = -cb0[96].ww * float2(0.400000006,0.200000003) + r5.xy;
  r5.xy = r0.xx ? r0.yz : r5.xy;
  r5.xyzw = r5.zxwy * cb0[93].zwzw + cb0[93].xyxy;
  r5.xyzw = r5.xyzw * cb0[48].xyxy + cb0[48].zwzw;
  r0.yz = max(cb0[53].xy, r1.zw);
  r0.yz = min(cb0[53].zw, r0.yz);
  r6.xyw = t0.Sample(s0_s, r0.yz).xyz;
  r5.xyzw = r5.xyzw * cb0[47].zwzw + r1.xyxy;
  r5.xyzw = max(cb0[53].xyxy, r5.xyzw);
  r5.xyzw = min(cb0[53].zwzw, r5.xyzw);
  r8.x = t0.Sample(s0_s, r5.xy).x;
  r8.y = t0.Sample(s0_s, r5.zw).y;
  r0.y = dot(r6.xyw, float3(0.298999995,0.587000012,0.114));
  r0.y = -cb0[96].y + r0.y;
  ...
  r0.y = r0.z * r0.y;
  r8.z = r6.w;
  r5.xyz = r8.xyz + -r6.xyw;
  r5.xyz = r0.yyy * r5.xyz + r6.xyw;
  r5.xyz = r5.xyz + -r8.xyz;
  r5.xyz = cb0[96].xxx * r5.xyz + r8.xyz;
  r0.xyz = r0.xxx ? r5.xyz : r8.xyz;
  r1.xy = saturate(cb0[78].xy);
  r2.w = saturate(1 + -cb0[78].z);
  r3.y = cmp(0 < r1.x);
  r3.w = saturate(dot(r0.xyz, float3(0.298999995,0.587000012,0.114)));
  r4.x = r3.w * -2 + 3;
  r3.w = r3.w * r3.w;
  r3.w = r4.x * r3.w;
  r5.x = dot(r3.ww, r2.ww);
  r2.w = dot(r0.xyz, r0.xyz);
  r2.w = sqrt(r2.w);
  r2.w = max(0.0149999997, r2.w);
  r6.xyw = r0.xyz / r2.www;
  r8.xyz = float3(1,1,1) + -r6.xyw;
  r6.xyw = r8.xyz * float3(0.25,0.25,0.25) + r6.xyw;
  r2.w = log2(r5.x);
  r7.zw = float2(0.899999976,0.949999988) * r2.ww;
  r5.yz = exp2(r7.zw);
  r5.xyz = r1.yyy * float3(0.170000002,0.180000007,0.179999992) + r5.xyz;
  r5.xyz = float3(0.0299999993,0.0500000007,0.0799999982) + r5.xyz;
  r1.x = r1.x * r7.x;
  r1.x = r1.x * r3.x;
  r1.x = r1.x * r2.x;
  r5.xyz = r6.xyw * r5.xyz + -r0.xyz;
  r5.xyz = r1.xxx * r5.xyz + r0.xyz;
  r0.xyz = r3.yyy ? r5.xyz : r0.xyz;
  r1.x = saturate(cb0[79].x);
  r1.y = r1.x * r7.y;
  r1.y = r1.y * r3.z;
  r1.y = r1.y * r2.y;
  r1.x = cmp(0 < r1.x);
  ...
  r0.w = sin(r0.w);
  r0.w = r0.w * 0.5 + 1;
  r2.xyw = r0.www * r0.xyz + -r0.xyz;
  r2.xyw = r1.yyy * r2.xyw + r0.xyz;
  r0.xyz = r1.xxx ? r2.xyw : r0.xyz;
  r0.xyz = cb0[69].xyz * r0.xyz;

  [branch]
  if (RENODX_WUWA_BLOOM > 0.f) {
    r1.xy = cb0[68].xy * r1.zw + cb0[68].zw;
    r1.xy = max(cb0[60].xy, r1.xy);
    r1.xy = min(cb0[60].zw, r1.xy);
    r1.xyz = t1.Sample(s1_s, r1.xy).xyz;
    // r0.xyz = r0.xyz * v1.xxx + r1.xyz;
    r0.xyz = r0.xyz * v1.xxx + r1.xyz * RENODX_WUWA_BLOOM;
  } else {
    r0.xyz = r0.xyz * v1.xxx;
  }

  r1.xy = cb0[73].xy * float2(2,2) + v1.zw;
  r1.xy = float2(-1,-1) + r1.xy;
  r1.xy = cb0[71].xx * r1.xy;
  r1.xy = cb0[71].zw * r1.xy;
  r0.w = dot(r1.xy, r1.xy);
  r1.x = saturate(cb0[72].w);
  r1.x = r1.x * 9 + 1;
  r0.w = r0.w * r1.x + 1;
  r0.w = rcp(r0.w);
  r0.w = r0.w * r0.w;
  r1.xyz = float3(1,1,1) + -cb0[72].xyz;
  r1.xyz = r0.www * r1.xyz + cb0[72].xyz;
  ...
  [branch]
  if (grain_enabled) {
    r0.xyz = r4.yzw * RENODX_WUWA_GRAIN * float3(0.00390625, 0.00390625, 0.00390625) + r0.xyz;
