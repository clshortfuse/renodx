...
// ---- Created with 3Dmigoto v1.4.1 on Sat Jul 19 12:14:59 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = r0.w * 0.00100000005 + -cb0[87].z;
  r1.x = cmp(0 < r0.w);
  r0.w = cmp(r0.w < 0);
  ...
  r1.x = cmp(0 < cb0[87].y);
  if (r1.x != 0) {
    // r1.xyz = cb0[89].xyz + -r0.xyz;
    r1.xyz = (cb0[89].xyz * (RENODX_PEAK_NITS / RENODX_GAME_NITS)) + -r0.xyz;
    r1.xyz = cb0[87].yyy * r1.xyz + r0.xyz;
    r2.xyz = cb0[88].xyz + -r0.xyz;
    r2.xyz = cb0[87].yyy * r2.xyz + r0.xyz;
  } else {
    r3.xyz = cb0[88].xyz + -r0.xyz;
    r1.xyz = abs(cb0[87].yyy) * r3.xyz + r0.xyz;
    // r3.xyz = cb0[89].xyz + -r0.xyz;
    r3.xyz = (cb0[89].xyz * (RENODX_PEAK_NITS / RENODX_GAME_NITS)) + -r0.xyz;
    r2.xyz = abs(cb0[87].yyy) * r3.xyz + r0.xyz;
  }
  r1.xyz = -r2.xyz + r1.xyz;
  r1.xyz = r0.www * r1.xyz + r2.xyz;
  r1.xyz = r1.xyz + -r0.xyz;
  o0.xyz = cb0[87].xxx * r1.xyz + r0.xyz;
