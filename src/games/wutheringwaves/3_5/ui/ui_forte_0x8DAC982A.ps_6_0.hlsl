...
float4 main(
  ...
  _211 = saturate((1.0f - saturate((abs(_188 - (Material_000[10].y)) - (Material_000[11].y)) / (Material_000[12].y))) * (1.0f - saturate((abs(_184 - (Material_000[10].x)) - (Material_000[11].x)) / (Material_000[12].x))));
  _215 = (_211 * _211) * (3.0f - (_211 * 2.0f));
  _227 = select(((Material_256[4].w) > 0.5f), (select(((bool)(abs(Material_256[4].z) > 9.999999747378752e-06f) && (bool)((Material_256[4].z) >= 0.0f)), (1.0f - _215), _215) * _168), _168);
  _248 = saturate(select(((Material_256[6].x) > 0.5f), ((((float4)(t1.SampleBias(s1, float2(((_184 - (Material_000[14].x)) / (Material_000[15].x)), (1.0f - ((_188 - (Material_000[14].y)) / (Material_000[15].y)))), View_2388, int2(0, 0)))).x) * _227), _227));
  _249 = max(((((Material_000[7].x) - _150) * (Material_256[2].w)) + _150), 0.0f);
  _250 = max(((((Material_000[7].y) - _151) * (Material_256[2].w)) + _151), 0.0f);
  _251 = max(((((Material_000[7].z) - _152) * (Material_256[2].w)) + _152), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_66 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_64 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_65 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      _283 = float((bool)(bool)(frac(dot(float3(_64, _65, _66), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _286 = 1.0f;
      _287 = (1.0f - _283);
      _288 = 1.0f;
      _289 = _283;
  ...
  if (!(TranslucentBasePass_4768 == 0)) {
    ...
    if (TranslucentBasePass_4784 == 0.0f) {
      _322 = (((TranslucentBasePass_4772 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4776 - TranslucentBasePass_4780)) + TranslucentBasePass_4780;
      _330 = (((TranslucentBasePass_4840 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4832 - TranslucentBasePass_4836)) + TranslucentBasePass_4836;
      _331 = (_322 * _287) * _330;
      _332 = (_322 * _288) * _330;
      _333 = (_322 * _289) * _330;
      _338 = max((_331 - TranslucentBasePass_4828), 0.0f);
      _339 = max((_332 - TranslucentBasePass_4828), 0.0f);
      _340 = max((_333 - TranslucentBasePass_4828), 0.0f);
      _353 = TranslucentBasePass_4812 * -1.4426950216293335f;
      _360 = 1.0f - exp2(_353 * ((_331 - _338) + (_338 / (_338 + 1.0f))));
      _361 = 1.0f - exp2(_353 * ((_332 - _339) + (_339 / (_339 + 1.0f))));
      _362 = 1.0f - exp2(_353 * ((_333 - _340) + (_340 / (_340 + 1.0f))));
      _363 = _360 * TranslucentBasePass_4788;
      _364 = _361 * TranslucentBasePass_4788;
      _365 = _362 * TranslucentBasePass_4788;
      _366 = TranslucentBasePass_4796 * TranslucentBasePass_4792;
      _373 = TranslucentBasePass_4804 * TranslucentBasePass_4800;
      _383 = TranslucentBasePass_4808 * TranslucentBasePass_4800;
      _390 = TranslucentBasePass_4804 / TranslucentBasePass_4808;
      _406 = saturate(((saturate(((((_363 + _366) * _360) + _373) / (((_363 + TranslucentBasePass_4792) * _360) + _383)) - _390) + -0.5f) * TranslucentBasePass_4816) + 0.5f);
      _407 = saturate(((saturate(((((_364 + _366) * _361) + _373) / (((_364 + TranslucentBasePass_4792) * _361) + _383)) - _390) + -0.5f) * TranslucentBasePass_4816) + 0.5f);
      _408 = saturate(((saturate(((((_365 + _366) * _362) + _373) / (((_365 + TranslucentBasePass_4792) * _362) + _383)) - _390) + -0.5f) * TranslucentBasePass_4816) + 0.5f);
      _409 = dot(float3(_406, _407, _408), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      _422 = 1.0f / TranslucentBasePass_4820;
      _433 = exp2(log2(saturate(lerp(_409, _406, TranslucentBasePass_4824))) * _422);
      _434 = exp2(log2(saturate(lerp(_409, _407, TranslucentBasePass_4824))) * _422);
      _435 = exp2(log2(saturate(lerp(_409, _408, TranslucentBasePass_4824))) * _422);
    } else {
      _433 = _287;
      _434 = _288;
      _435 = _289;
    ...
    if (TranslucentBasePass_4784 == 1.0f) {
      _457 = ((((TranslucentBasePass_4776 - TranslucentBasePass_4780) * saturate(TranslucentBasePass_4772 * 0.009999999776482582f)) + TranslucentBasePass_4780) * 0.012500000186264515f) * (((TranslucentBasePass_4832 - TranslucentBasePass_4836) * saturate(TranslucentBasePass_4840 * 0.009999999776482582f)) + TranslucentBasePass_4836);
      _462 = (_457 * _433);
      _463 = (_457 * _434);
      _464 = (_457 * _435);
    } else {
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _462), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _463), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _464), 0.0f));
  SV_Target.w = _286;
