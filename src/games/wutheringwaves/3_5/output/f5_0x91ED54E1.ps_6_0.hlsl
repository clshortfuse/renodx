...
float4 main(
  ...
  _437 = t0.Sample(s0, float2(min(max(_426, cb0_053x), cb0_053z), min(max(_427, cb0_053y), cb0_053w)));
  _443 = saturate(cb0_098x);
  _445 = saturate(cb0_098y);
  if (_443 > 0.0f) {
    _456 = saturate(((_437.x * 0.29899999499320984f) + (_437.y * 0.5870000123977661f)) + (_437.z * 0.11400000005960464f));
    _462 = ((_456 * _456) * (saturate(1.0f - cb0_098z) * 2.0f)) * (3.0f - (_456 * 2.0f));
    _469 = max(sqrt(((_437.x * _437.x) + (_437.y * _437.y)) + (_437.z * _437.z)), 0.014999999664723873f);
    _470 = _437.x / _469;
    _471 = _437.y / _469;
    _472 = _437.z / _469;
    _482 = log2(_462);
    _501 = ((_294 * _214) * _331) * _443;
    _512 = (((((lerp(_470, 1.0f, 0.25f)) * (((_445 * 0.17000000178813934f) + 0.029999999329447746f) + _462)) - _437.x) * _501) + _437.x);
    _513 = (((((((_445 * 0.18000000715255737f) + 0.05000000074505806f) + exp2(_482 * 0.8999999761581421f)) * (lerp(_471, 1.0f, 0.25f))) - _437.y) * _501) + _437.y);
    _514 = (((((((_445 * 0.17999999225139618f) + 0.07999999821186066f) + exp2(_482 * 0.949999988079071f)) * (lerp(_472, 1.0f, 0.25f))) - _437.z) * _501) + _437.z);
  } else {
    _512 = _437.x;
    _513 = _437.y;
    _514 = _437.z;
  }
  _517 = saturate(cb0_099x);
  _518 = _387 * _517;
  if (_517 > 0.0f) {
    _529 = (sin(((_116 * 640.0f) + 640.0f) - (View_2376 * 10.0f)) * 0.5f) + 1.0f;
    _543 = ((((_529 * _512) - _512) * _518) + _512);
    _544 = ((((_529 * _513) - _513) * _518) + _513);
    _545 = ((((_529 * _514) - _514) * _518) + _514);
  } else {
    _543 = _512;
    _544 = _513;
    _545 = _514;
  }
  _568 = t1.Sample(s1, float2(min(max(((cb0_068x * _426) + cb0_068z), cb0_060x), cb0_060z), min(max(((cb0_068y * _427) + cb0_068w), cb0_060y), cb0_060w)));
  APPLY_BLOOM(_568);
  [branch]
  if (!(cb0_085x == 0)) {
    _595 = (cb0_085z != 0);
    _598 = t2.Sample(s2, float2(select(_595, _426, min(max(((cb0_076x * _426) + cb0_076z), cb0_075x), cb0_075z)), select(_595, _427, min(max(((cb0_076y * _427) + cb0_076w), cb0_075y), cb0_075w))));
    _606 = (_598.x + _568.x);
    _607 = (_598.y + _568.y);
    _608 = (_598.z + _568.z);
  } else {
  ...
  [branch]
  if (!(cb0_085y == 0)) {
    _612 = t3.Sample(s3, float2(_426, _427));
    _620 = (_612.x + _606);
    _621 = (_612.y + _607);
    _622 = (_612.z + _608);
  } else {
  ...
  _647 = TEXCOORD_1.z + -1.0f;
  _649 = TEXCOORD_1.w + -1.0f;
  _652 = ((_647 + (cb0_090x * 2.0f)) * cb0_088z) * cb0_088x;
  _654 = ((_649 + (cb0_090y * 2.0f)) * cb0_088w) * cb0_088x;
  _661 = 1.0f / ((((saturate(cb0_089w) * 9.0f) + 1.0f) * dot(float2(_652, _654), float2(_652, _654))) + 1.0f);
  _662 = _661 * _661;
  _663 = cb0_090z + 1.0f;
  _691 = ((_647 + (cb0_093x * 2.0f)) * cb0_091z) * cb0_091x;
  _693 = ((_649 + (cb0_093y * 2.0f)) * cb0_091w) * cb0_091x;
  _700 = 1.0f / ((((saturate(cb0_092w) * 9.0f) + 1.0f) * dot(float2(_691, _693), float2(_691, _693))) + 1.0f);
  _701 = _700 * _700;
  _702 = cb0_093z + 1.0f;
  _724 = ((((_620 + ((_543 * TEXCOORD_1.x) * cb0_086x)) * _384) * ((_662 * (_663 - cb0_089x)) + cb0_089x)) * ((_701 * (_702 - cb0_092x)) + cb0_092x)) * ((cb0_095x * _338) + cb0_095y);
  _728 = ((((_621 + ((_544 * TEXCOORD_1.x) * cb0_086y)) * _384) * ((_662 * (_663 - cb0_089y)) + cb0_089y)) * ((_701 * (_702 - cb0_092y)) + cb0_092y)) * ((cb0_095x * _361) + cb0_095y);
  _732 = ((((_622 + ((_545 * TEXCOORD_1.x) * cb0_086z)) * _384) * ((_662 * (_663 - cb0_089z)) + cb0_089z)) * ((_701 * (_702 - cb0_092z)) + cb0_092z)) * ((cb0_095x * _362) + cb0_095y);
  CAPTURE_UNTONEMAPPED(float3(_724, _728, _732));
  [branch]
  if (WUWA_TM_IS(1)) {
    _765 = ((((_724 * 1.3600000143051147f) + 0.04699999839067459f) * _724) / ((((_724 * 0.9599999785423279f) + 0.5600000023841858f) * _724) + 0.14000000059604645f));
    _766 = ((((_728 * 1.3600000143051147f) + 0.04699999839067459f) * _728) / ((((_728 * 0.9599999785423279f) + 0.5600000023841858f) * _728) + 0.14000000059604645f));
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    _777 = 1.0049500465393066f - (0.16398000717163086f / (_765 + -0.19505000114440918f));
    _778 = 1.0049500465393066f - (0.16398000717163086f / (_766 + -0.19505000114440918f));
    _779 = 1.0049500465393066f - (0.16398000717163086f / (_767 + -0.19505000114440918f));
  ...
  if (WUWA_TM_IS(3)) {
    ...
    _808 = cb0_037y * _800;
    _809 = cb0_037y * _801;
    _812 = cb0_037z * cb0_037w;
    _822 = cb0_038y * cb0_038x;
    _833 = cb0_038z * cb0_038x;
    _840 = cb0_038y / cb0_038z;
    _848 = ((((_812 + _807) * _799) + _822) / (_833 + ((_807 + cb0_037z) * _799))) - _840;
    _849 = ((((_812 + _808) * _800) + _822) / (_833 + ((_808 + cb0_037z) * _800))) - _840;
    _850 = ((((_812 + _809) * _801) + _822) / (_833 + ((_809 + cb0_037z) * _801))) - _840;
  } else {
    _848 = _799;
    _849 = _800;
    _850 = _801;
  ...
  if (!(cb0_105w == 0)) {
    if (!(cb0_106x == 1.0f)) {
      _860 = (cb0_106x * 0.699999988079071f) + 0.30000001192092896f;
      _865 = (_860 * _848);
      _866 = (_860 * _849);
      _867 = (_860 * _850);
    } else {
  ...
  APPLY_EXTENDED_TONEMAP(_865, _866, _867);
  _888 = (saturate((log2(_865 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  _889 = (saturate((log2(_866 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  _890 = (saturate((log2(_867 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  _891 = t7.Sample(s7, float3(_888, _889, _890));
  [branch]
  if (!(cb0_107w == 0)) {
    _924 = select((((uint)(uint(float((uint)((int)((uint)(uint(round((((float4)(t6.Sample(s6, float2(min(max(((cb0_084x * _426) + cb0_084z), cb0_083x), cb0_083z), min(max(((cb0_084y * _427) + cb0_084w), cb0_083y), cb0_083w))))).w) * 255.0f))) & 15))))) & -4) == 12), 1.0f, 0.0f);
    _925 = t8.Sample(s8, float3(_888, _889, _890));
    _939 = (lerp(_925.x, _891.x, _924));
    _940 = (lerp(_925.y, _891.y, _924));
    _941 = (lerp(_925.z, _891.z, _924));
  } else {
    _939 = _891.x;
    _940 = _891.y;
    _941 = _891.z;
  }
  _942 = _941 * 1.0499999523162842f;
  _943 = _940 * 1.0499999523162842f;
  _944 = _939 * 1.0499999523162842f;
  _952 = ((_338 * 0.00390625f) + -0.001953125f) + _944;
  _953 = ((_361 * 0.00390625f) + -0.001953125f) + _943;
  _954 = ((_362 * 0.00390625f) + -0.001953125f) + _942;
  [branch]
  if (!(cb0_106w == 0)) {
    _966 = (pow(_952, 0.012683313339948654f));
    _967 = (pow(_953, 0.012683313339948654f));
    _968 = (pow(_954, 0.012683313339948654f));
    _1001 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_966 + -0.8359375f)) / (18.8515625f - (_966 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    _1002 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_967 + -0.8359375f)) / (18.8515625f - (_967 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    _1003 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_968 + -0.8359375f)) / (18.8515625f - (_968 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    ...
    _1031 = min((_1003 * 12.920000076293945f), ((exp2(log2(max(_1003, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _1029 = _952;
    _1030 = _953;
    _1031 = _954;
  ...
  SV_Target.w = (dot(float3(_944, _943, _942), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
