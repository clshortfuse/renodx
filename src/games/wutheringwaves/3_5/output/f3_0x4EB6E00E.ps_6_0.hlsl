...
float4 main(
  ...
  GENERATE_INVERSION(_994, _995, _996);
  _1005 = ((((_995 * 587.0f) + (_994 * 299.0f)) + (_996 * 114.0f)) * 0.0010000000474974513f) - cb0_108z;
  _1012 = saturate(float((int)(((int)(uint)((bool)(_1005 > 0.0f))) - ((int)(uint)((bool)(_1005 < 0.0f))))));
  _1019 = cb0_109x - _994;
  _1020 = cb0_109y - _995;
  _1021 = cb0_109z - _996;
  _1026 = WUWA_PEAK_SCALING * cb0_110x - _994;
  _1027 = WUWA_PEAK_SCALING * cb0_110y - _995;
  _1028 = WUWA_PEAK_SCALING * cb0_110z - _996;
  [branch]
  if (cb0_108y > 0.0f) {
    _1045 = (_1019 * cb0_108y);
    _1046 = (_1020 * cb0_108y);
    _1047 = (_1021 * cb0_108y);
    _1048 = (_1026 * cb0_108y);
    _1049 = (_1027 * cb0_108y);
    _1050 = (_1028 * cb0_108y);
  } else {
    _1037 = abs(cb0_108y);
    _1045 = (_1026 * _1037);
    _1046 = (_1027 * _1037);
  ...
  SV_Target.x = ((cb0_108x * (lerp(_1045, _1048, _1012))) + _994);
  SV_Target.y = ((cb0_108x * (lerp(_1046, _1049, _1012))) + _995);
  SV_Target.z = (((lerp(_1047, _1050, _1012)) * cb0_108x) + _996);
