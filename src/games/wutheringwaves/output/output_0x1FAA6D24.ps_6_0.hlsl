...
float4 main(
  ...
  CAPTURE_UNTONEMAPPED(untonemapped, float3(_763, _766, _769));
    ...
    if (!((bool)(cb0_090x <= 0.0f) && (bool)(cb0_090y <= 0.0f))) {
      ...
      if (!(_900 <= 9.999999747378752e-05f)) {
        ...
        if ((bool)(cb0_090y > 0.0f) && (bool)((_900 / cb0_090y) > 1.0f)) {
          ...
          if (_934 > _952) {
            float _1162 = _934 - _952;
            _1168 = ((_1162 / ((_1162 * cb0_090z) + 1.0f)) + _952);
            if (_935 > _952) {
              float _1171 = _935 - _952;
              _964 = ((_1171 / ((_1171 * cb0_090z) + 1.0f)) + _952);
              _965 = _1168;
              _966 = _961;
            } else {
              _964 = _935;
          ...
          while(true) {
            if (cb0_090x > 0.0f) {
              if (_900 < cb0_090x) {
                ...
                if (_965 < _982) {
                  _1154 = (((cb0_090z * 0.30000001192092896f) * (_982 - _965)) + _965);
                  if (_964 < _982) {
  ...
  CAPTURE_TONEMAPPED(tonemapped, float3(_1030, _1031, _1032));
