...
float4 main(
  ...
  CAPTURE_UNTONEMAPPED(float3(_181, _183, _185));
    ...
    if (!((bool)(cb0_090x <= 0.0f) && (bool)(cb0_090y <= 0.0f))) {
      ...
      if (!(_316 <= 9.999999747378752e-05f)) {
        ...
        if ((bool)(cb0_090y > 0.0f) && (bool)((_316 / cb0_090y) > 1.0f)) {
          ...
          if (_350 > _368) {
            float _648 = _350 - _368;
            _654 = ((_648 / ((_648 * cb0_090z) + 1.0f)) + _368);
            if (_351 > _368) {
              float _657 = _351 - _368;
              _380 = ((_657 / ((_657 * cb0_090z) + 1.0f)) + _368);
              _381 = _654;
              _382 = _377;
            } else {
              _380 = _351;
          ...
          while(true) {
            if (cb0_090x > 0.0f) {
              if (_316 < cb0_090x) {
                ...
                if (_381 < _398) {
                  _640 = (((cb0_090z * 0.30000001192092896f) * (_398 - _381)) + _381);
                  if (_380 < _398) {
  ...
  CAPTURE_TONEMAPPED(float3(_446, _447, _448));
  ...
  const float3 inverted = renodx::draw::InvertIntermediatePass(float3(_561, _562, _563));
  _561 = inverted.r; _562 = inverted.g; _563 = inverted.b;

  float _572 = ((((_562 * 587.0f) + (_561 * 299.0f)) + (_563 * 114.0f)) * 0.0010000000474974513f) - cb0_092w;
  float _579 = saturate(float(((int)(uint)((bool)(_572 > 0.0f))) - ((int)(uint)((bool)(_572 < 0.0f)))));
  float _586 = cb0_093x - _561;
  float _587 = cb0_093y - _562;
  float _588 = cb0_093z - _563;

  const float peak_scaling = RENODX_PEAK_NITS / RENODX_GAME_NITS;
  // float _593 = cb0_094x - _561;
  // float _594 = cb0_094y - _562;
  // float _595 = cb0_094z - _563;
  float _593 = peak_scaling * cb0_094x - _561;
  float _594 = peak_scaling * cb0_094y - _562;
  float _595 = peak_scaling * cb0_094z - _563;
  ...
  SV_Target.x = ((cb0_092y * (lerp(_612, _615, _579))) + _561);
  SV_Target.y = ((cb0_092y * (lerp(_613, _616, _579))) + _562);
  SV_Target.z = (((lerp(_614, _617, _579)) * cb0_092y) + _563);
