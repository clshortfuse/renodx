...
float4 main(
  ...
  float4 SV_Target;
  float _28 = cb0_065x * cb0_064w;
  float _29 = TEXCOORD_3.x * 0.5f;
  float _30 = TEXCOORD_3.y * 0.5f;
  float _101;
  float _102;
  float _110;
  float _111;
  ...
  float _1234;
  if (!(!(cb0_093x != 0.0f))) {
    float _35 = cb0_093x * 2.0f;
    do {
      if (_35 > 0.0f) {
        float _39 = abs(_35) * 0.5f;
        float _40 = tan(_39);
        float _41 = _28 * TEXCOORD_3.x;
        float _51 = rsqrt(dot(float2(_41, TEXCOORD_3.y), float2(_41, TEXCOORD_3.y)));
        float _55 = rsqrt(dot(float2(_28, 1.0f), float2(_28, 1.0f)));
        float _60 = tan((sqrt((_41 * _41) + (TEXCOORD_3.y * TEXCOORD_3.y)) / sqrt((_28 * _28) + 1.0f)) * _39);
        _101 = (((_60 * ((_51 * _41) / (_55 * _28))) / _40) * 0.5f);
        _102 = (((_60 * ((_51 * TEXCOORD_3.y) / _55)) / _40) * 0.5f);
      } else {
        if (_35 < 0.0f) {
          float _74 = sqrt(((TEXCOORD_3.y * TEXCOORD_3.y) + (TEXCOORD_3.x * TEXCOORD_3.x)) * 0.25f);
          float _79 = (((_74 * _74) * (cb0_093x * 0.699999988079071f)) + 1.0f) * _74;
          float _81 = atan(_29 / _30);
          bool _84 = (_30 < 0.0f);
          bool _85 = (_30 == 0.0f);
          bool _86 = (_29 >= 0.0f);
          bool _87 = (_29 < 0.0f);
          float _95 = select((_86 && _85), 1.5707963705062866f, select((_87 && _85), -1.5707963705062866f, select((_87 && _84), (_81 + -3.1415927410125732f), select((_86 && _84), (_81 + 3.1415927410125732f), _81))));
          _101 = (sin(_95) * _79);
          _102 = (cos(_95) * _79);
        } else {
          _101 = _29;
      ...
      _110 = (((_101 + 0.5f) * 2.0f) + -1.0f);
      _111 = (((_102 + 0.5f) * 2.0f) + -1.0f);
    } while (false);
  } else {
    _110 = TEXCOORD_3.x;
    _111 = TEXCOORD_3.y;
  }
  float _124 = ((cb0_048z * _110) + cb0_049x) * cb0_048x;
  float _125 = ((cb0_048w * _111) + cb0_049y) * cb0_048y;
  float4 _126 = t4.SampleLevel(s4, float2(_124, _125), 0.0f);
  float _138 = ((1.0f / ((View_1040.z * _126.x) - View_1040.w)) + View_1040.y) + (View_1040.x * _126.x);
  float4 _139 = t3.Sample(s3, float2(_124, _125));
  float _147 = 1.0f / ((_138 + View_1040.w) * View_1040.z);
  float _158 = select((((_147 - _139.x) + ((((View_448[3].z) - _147) + ((View_448[2].z) * _138)) * select(((View_448[3].w) < 1.0f), 0.0f, 1.0f))) > 0.0005000000237487257f), 0.0f, 1.0f);
  if (((bool)(!(cb0_088y == 0.0f))) || ((bool)(((bool)(((bool)(((bool)(((bool)(!(cb0_089y == 0.0f))) || ((bool)(!(cb0_093y == 0.0f))))) || ((bool)(!(cb0_094y == 0.0f))))) || ((bool)(!(cb0_095y == 0.0f))))) || ((bool)(!(cb0_096y == 0.0f)))))) {
    float _193 = 1.5f - (saturate(cb0_089z) * 1.4900000095367432f);
    float _198 = saturate(((sqrt((_111 * _111) + (_110 * _110)) - cb0_089y) - _193) / (-0.0f - _193));
    float _202 = (_198 * _198) * (3.0f - (_198 * 2.0f));
    _210 = (1.0f - (_202 * max(cb0_088y, cb0_093y)));
    _211 = (1.0f - (_202 * max(cb0_088y, cb0_094y)));
    _212 = (1.0f - (_202 * max(cb0_088y, cb0_095y)));
  } else {
    _210 = 1.0f;
    _211 = 1.0f;
    _212 = 1.0f;
  }
  bool _218 = !(cb0_088z == 0.0f);
  bool _219 = !(cb0_093z == 0.0f);
  bool _221 = !(cb0_094z == 0.0f);
  bool _223 = !(cb0_095z == 0.0f);
  if (((bool)(((bool)(((bool)(_218 || _219)) || _221)) || _223)) || ((bool)(!(cb0_096z == 0.0f)))) {
    do {
      if (_218) {
        _234 = exp2(log2(saturate(cb0_088z)) * 3.0f);
      } else {
        _234 = cb0_088z;
      }
      do {
        if (_219) {
          _241 = exp2(log2(saturate(cb0_093z)) * 3.0f);
        } else {
          _241 = cb0_093z;
        }
        do {
          if (_221) {
            _248 = exp2(log2(saturate(cb0_094z)) * 3.0f);
          } else {
            _248 = cb0_094z;
          }
          do {
            if (_223) {
              _255 = exp2(log2(saturate(cb0_095z)) * 3.0f);
            } else {
              _255 = cb0_095z;
            }
            float _256 = max(_234, _241);
            float _257 = max(_234, _248);
            float _258 = max(_234, _255);
            float _274 = saturate((_138 - (_256 * 1000.0f)) / ((_256 * 9999.990234375f) + 0.009999999776482582f));
            float _275 = saturate((_138 - (_257 * 1000.0f)) / ((_257 * 9999.990234375f) + 0.009999999776482582f));
            float _276 = saturate((_138 - (_258 * 1000.0f)) / ((_258 * 9999.990234375f) + 0.009999999776482582f));
            _290 = ((_274 * _274) * (3.0f - (_274 * 2.0f)));
  ...
  if (((bool)(((bool)(((bool)(((bool)(!(cb0_089x == 0.0f))) || ((bool)(!(cb0_094x == 0.0f))))) || ((bool)(!(cb0_095x == 0.0f))))) || ((bool)(!(cb0_096x == 0.0f))))) || ((bool)(!(cb0_097x == 0.0f)))) {
    float _312 = saturate(select((_139.x > 0.0005000000237487257f), 1.0f, 2.0f) - _158);
    _326 = max(_312, (1.0f - saturate(max(cb0_089x, cb0_094x))));
    _327 = max(_312, (1.0f - saturate(max(cb0_089x, cb0_095x))));
    _328 = max(_312, (1.0f - saturate(max(cb0_089x, cb0_096x))));
  } else {
    _326 = 1.0f;
    _327 = 1.0f;
    _328 = 1.0f;
  }
  float _330 = (TEXCOORD_2.w * 543.3099975585938f) + TEXCOORD_2.z;
  float _333 = frac(sin(_330) * 493013.0f);
  if (cb0_088x > 0.0f) {
    _354 = (((frac((sin(_330 + 33.9900016784668f) * 493013.0f) + 7.177000045776367f) - _333) * cb0_088x) + _333);
    _355 = (((frac((sin(_330 + 66.98999786376953f) * 493013.0f) + 14.298999786376953f) - _333) * cb0_088x) + _333);
  } else {
    _354 = _333;
    _355 = _333;
  }
  if (cb0_091z > 0.0f) {
    _377 = (((((_292 * _212) * _328) * cb0_091z) * ((sin((((TEXCOORD_3.y * 10.0f) + 10.0f) + (_333 * 0.0020000000949949026f)) + (View_2376 * 4.0f)) * 0.5f) + 0.5f)) + 1.0f);
  } else {
    _377 = 1.0f;
  }
  float _380 = (_291 * _211) * _327;
  if (cb0_091y > 0.0f) {
    float _385 = View_2376 * 0.00016666666488163173f;
    float _389 = frac(abs(_385));
    float _394 = select((_385 >= (-0.0f - _385)), _389, (-0.0f - _389)) * ((TEXCOORD_3.y * 111000.0f) + 111000.0f);
    float _402 = ((_380 * 0.014999999664723873f) * cb0_091y) * (0.5f - frac(sin(dot(float2(_394, _394), float2(12.989800453186035f, 78.23300170898438f))) * 43758.546875f));
    _407 = ((_402 * 0.5f) + _124);
    _408 = (_402 + _125);
  } else {
    _407 = _124;
  ...
  float _418 = cb0_109z * cb0_108x;
  float _419 = cb0_109z * cb0_108y;
  bool _420 = (cb0_109x == 0.0f);
  float _430 = (cb0_105z * _110) + cb0_105x;
  float _431 = (cb0_105w * _111) + cb0_105y;
  float _450 = float(((int)(uint)((bool)(_430 > 0.0f))) - ((int)(uint)((bool)(_430 < 0.0f)))) * saturate(abs(_430) - cb0_108z);
  float _452 = float(((int)(uint)((bool)(_431 > 0.0f))) - ((int)(uint)((bool)(_431 < 0.0f)))) * saturate(abs(_431) - cb0_108z);
  float _457 = _431 - (_452 * _418);
  float _459 = _431 - (_452 * _419);
  bool _460 = (cb0_109x > 0.0f);
  if (_460) {
    _467 = (_457 - (cb0_109w * 0.4000000059604645f));
    _468 = (_459 - (cb0_109w * 0.20000000298023224f));
  } else {
    _467 = _457;
    _468 = _459;
  }
  float4 _502 = t0.Sample(s0, float2(_407, _408));
  float4 _506 = t0.Sample(s0, float2((((((cb0_106z * (_430 - (_450 * select(_420, _418, cb0_108x)))) + cb0_106x) * cb0_048z) + cb0_049x) * cb0_048x), (((((cb0_106w * _467) + cb0_106y) * cb0_048w) + cb0_049y) * cb0_048y)));
  float4 _508 = t0.Sample(s0, float2((((((cb0_106z * (_430 - (_450 * select(_420, _419, cb0_108y)))) + cb0_106x) * cb0_048z) + cb0_049x) * cb0_048x), (((((cb0_106w * _468) + cb0_106y) * cb0_048w) + cb0_049y) * cb0_048y)));
  if (_460) {
    float _518 = saturate(((((_502.y * 0.5870000123977661f) - cb0_109y) + (_502.x * 0.29899999499320984f)) + (_502.z * 0.11400000005960464f)) * 10.0f);
    float _522 = (_518 * _518) * (3.0f - (_518 * 2.0f));
    _536 = ((((_502.x - _506.x) + (_522 * (_506.x - _502.x))) * cb0_109x) + _506.x);
    _537 = ((((_502.y - _508.y) + (_522 * (_508.y - _502.y))) * cb0_109x) + _508.y);
  } else {
    _536 = _506.x;
    _537 = _508.y;
  }
  float _540 = saturate(cb0_090x);
  float _542 = saturate(cb0_090y);
  if (_540 > 0.0f) {
    float _553 = saturate(((_536 * 0.29899999499320984f) + (_502.z * 0.11400000005960464f)) + (_537 * 0.5870000123977661f));
    float _554 = _553 * 2.0f;
    float _558 = ((_553 * saturate(1.0f - cb0_090z)) * _554) * (3.0f - _554);
    float _565 = max(sqrt(((_536 * _536) + (_502.z * _502.z)) + (_537 * _537)), 0.014999999664723873f);
    float _566 = _536 / _565;
    float _567 = _537 / _565;
    float _568 = _502.z / _565;
    float _578 = log2(_558);
    float _597 = ((_290 * _210) * _326) * _540;
    _608 = (((((lerp(_566, 1.0f, 0.25f)) * (((_542 * 0.17000000178813934f) + 0.029999999329447746f) + _558)) - _536) * _597) + _536);
    _609 = (((((((_542 * 0.18000000715255737f) + 0.05000000074505806f) + exp2(_578 * 0.8999999761581421f)) * (lerp(_567, 1.0f, 0.25f))) - _537) * _597) + _537);
    _610 = (((((((_542 * 0.17999999225139618f) + 0.07999999821186066f) + exp2(_578 * 0.949999988079071f)) * (lerp(_568, 1.0f, 0.25f))) - _502.z) * _597) + _502.z);
  } else {
    _608 = _536;
    _609 = _537;
    _610 = _502.z;
  }
  float _613 = saturate(cb0_091x);
  float _614 = _613 * _380;
  if (_613 > 0.0f) {
    float _625 = (sin(((_111 * 640.0f) + 640.0f) - (View_2376 * 10.0f)) * 0.5f) + 1.0f;
    _639 = ((((_625 * _608) - _608) * _614) + _608);
    _640 = ((((_625 * _609) - _609) * _614) + _609);
    _641 = ((((_625 * _610) - _610) * _614) + _610);
  } else {
    _639 = _608;
    _640 = _609;
    _641 = _610;
  ...
  float4 _666 = t1.Sample(s1, float2(min(max(((cb0_068z * _407) + cb0_069x), cb0_060z), cb0_061x), min(max(((cb0_068w * _408) + cb0_069y), cb0_060w), cb0_061y)));
  APPLY_BLOOM(_666);

  [branch]
  if (!((uint)(cb0_077z) == 0)) {
    float4 _693 = t2.Sample(s2, float2(min(max(((cb0_076z * _407) + cb0_077x), cb0_075z), cb0_076x), min(max(((cb0_076w * _408) + cb0_077y), cb0_075w), cb0_076y)));
    _701 = (_693.x + _666.x);
    _702 = (_693.y + _666.y);
    _703 = (_693.z + _666.z);
  } else {
  ...
  float _728 = TEXCOORD_1.z + -1.0f;
  float _730 = TEXCOORD_1.w + -1.0f;
  float _733 = (((cb0_082x * 2.0f) + _728) * cb0_080z) * cb0_080x;
  float _735 = (((cb0_082y * 2.0f) + _730) * cb0_080w) * cb0_080x;
  float _742 = 1.0f / ((((saturate(cb0_081w) * 9.0f) + 1.0f) * dot(float2(_733, _735), float2(_733, _735))) + 1.0f);
  float _743 = _742 * _742;
  float _744 = cb0_082z + 1.0f;
  float _772 = (((cb0_085x * 2.0f) + _728) * cb0_083z) * cb0_083x;
  float _774 = (((cb0_085y * 2.0f) + _730) * cb0_083w) * cb0_083x;
  float _781 = 1.0f / ((((saturate(cb0_084w) * 9.0f) + 1.0f) * dot(float2(_772, _774), float2(_772, _774))) + 1.0f);
  float _782 = _781 * _781;
  float _783 = cb0_085z + 1.0f;
  float _795 = (((_701 + ((_639 * TEXCOORD_1.x) * cb0_078x)) * _377) * ((_743 * (_744 - cb0_081x)) + cb0_081x)) * ((_782 * (_783 - cb0_084x)) + cb0_084x);
  float _798 = (((_702 + ((_640 * TEXCOORD_1.x) * cb0_078y)) * _377) * ((_743 * (_744 - cb0_081y)) + cb0_081y)) * ((_782 * (_783 - cb0_084y)) + cb0_084y);
  float _801 = (((_703 + ((_641 * TEXCOORD_1.x) * cb0_078z)) * _377) * ((_743 * (_744 - cb0_081z)) + cb0_081z)) * ((_782 * (_783 - cb0_084z)) + cb0_084z);

  CAPTURE_UNTONEMAPPED(float3(_795, _798, _801));

  [branch]
  if (WUWA_TM_IS(1)) {
    _834 = ((((_795 * 1.3600000143051147f) + 0.04699999839067459f) * _795) / ((((_795 * 0.9599999785423279f) + 0.5600000023841858f) * _795) + 0.14000000059604645f));
    _835 = ((((_798 * 1.3600000143051147f) + 0.04699999839067459f) * _798) / ((((_798 * 0.9599999785423279f) + 0.5600000023841858f) * _798) + 0.14000000059604645f));
    _836 = ((((_801 * 1.3600000143051147f) + 0.04699999839067459f) * _801) / ((((_801 * 0.9599999785423279f) + 0.5600000023841858f) * _801) + 0.14000000059604645f));
  } else {
    _834 = _795;
    _835 = _798;
    _836 = _801;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _846 = 1.0049500465393066f - (0.16398000717163086f / (_834 + -0.19505000114440918f));
    float _847 = 1.0049500465393066f - (0.16398000717163086f / (_835 + -0.19505000114440918f));
    float _848 = 1.0049500465393066f - (0.16398000717163086f / (_836 + -0.19505000114440918f));
    _868 = (((_834 - _846) * select((_834 > 0.6000000238418579f), 0.0f, 1.0f)) + _846);
    _869 = (((_835 - _847) * select((_835 > 0.6000000238418579f), 0.0f, 1.0f)) + _847);
    _870 = (((_836 - _848) * select((_836 > 0.6000000238418579f), 0.0f, 1.0f)) + _848);
  } else {
    _868 = _834;
    _869 = _835;
    _870 = _836;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _876 = cb0_037y * _868;
    float _877 = cb0_037y * _869;
    float _878 = cb0_037y * _870;
    float _881 = cb0_037z * cb0_037w;
    float _891 = cb0_038y * cb0_038x;
    float _902 = cb0_038z * cb0_038x;
    float _909 = cb0_038y / cb0_038z;
    _917 = (((((_881 + _876) * _868) + _891) / (((_876 + cb0_037z) * _868) + _902)) - _909);
    _918 = (((((_881 + _877) * _869) + _891) / (((_877 + cb0_037z) * _869) + _902)) - _909);
    _919 = (((((_881 + _878) * _870) + _891) / (((_878 + cb0_037z) * _870) + _902)) - _909);
  } else {
    _917 = _868;
    _918 = _869;
    _919 = _870;
  ...
  if (!((uint)(cb0_097w) == 0)) {
    if (!(cb0_098x == 1.0f)) {
      float _928 = dot(float3(_917, _918, _919), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_928 <= 9.999999747378752e-05f)) {
        float _937 = (pow(_917, 0.1593017578125f));
        float _938 = (pow(_918, 0.1593017578125f));
        float _939 = (pow(_919, 0.1593017578125f));
        float _961 = exp2(log2(((_937 * 18.8515625f) + 0.8359375f) / ((_937 * 18.6875f) + 1.0f)) * 78.84375f);
        float _962 = exp2(log2(((_938 * 18.8515625f) + 0.8359375f) / ((_938 * 18.6875f) + 1.0f)) * 78.84375f);
        float _963 = exp2(log2(((_939 * 18.8515625f) + 0.8359375f) / ((_939 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_928 * 200.0f) > 1.0f) {
          float _967 = 1.0f - cb0_098x;
          do {
            if (_961 > 0.44028136134147644f) {
              float _970 = _961 + -0.44028136134147644f;
              _976 = ((_970 / ((_970 * _967) + 1.0f)) + 0.44028136134147644f);
            } else {
              _976 = _961;
            }
            do {
              if (_962 > 0.44028136134147644f) {
                float _1228 = _962 + -0.44028136134147644f;
                _1234 = ((_1228 / ((_1228 * _967) + 1.0f)) + 0.44028136134147644f);
                if (_963 > 0.44028136134147644f) {
                  float _1237 = _963 + -0.44028136134147644f;
                  _979 = ((_1237 / ((_1237 * _967) + 1.0f)) + 0.44028136134147644f);
                  _980 = _1234;
                  _981 = _976;
                } else {
                  _979 = _963;
              ...
              while(true) {
                float _988 = (pow(_981, 0.012683313339948654f));
                float _989 = (pow(_980, 0.012683313339948654f));
                float _990 = (pow(_979, 0.012683313339948654f));
                _1016 = exp2(log2(max((_988 + -0.8359375f), 0.0f) / (18.8515625f - (_988 * 18.6875f))) * 6.277394771575928f);
                _1017 = exp2(log2(max((_989 + -0.8359375f), 0.0f) / (18.8515625f - (_989 * 18.6875f))) * 6.277394771575928f);
                _1018 = exp2(log2(max((_990 + -0.8359375f), 0.0f) / (18.8515625f - (_990 * 18.6875f))) * 6.277394771575928f);
                break;
              }
            } while (false);
          } while (false);
  ...
  CLAMP_IF_SDR3(_1016, _1017, _1018);
  CAPTURE_TONEMAPPED(float3(_1016, _1017, _1018));

  float _1039 = (saturate((log2(_1016 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _1040 = (saturate((log2(_1017 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _1041 = (saturate((log2(_1018 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float4 _1042 = t5.Sample(s5, float3(_1039, _1040, _1041));

  HANDLE_LUT_OUTPUT(_1042);

  [branch]
  if (false) {
    float _1049 = select(((_158 * _139.x) > 0.0f), 0.0f, 1.0f);
    float4 _1050 = t6.Sample(s6, float3(_1039, _1040, _1041));
    _1064 = (lerp(_1042.x, _1050.x, _1049));
    _1065 = (lerp(_1042.y, _1050.y, _1049));
    _1066 = (lerp(_1042.z, _1050.z, _1049));
  } else {
    _1064 = _1042.x;
    _1065 = _1042.y;
    _1066 = _1042.z;
  }
  float _1067 = _1064 * 1.0499999523162842f;
  float _1068 = _1065 * 1.0499999523162842f;
  float _1069 = _1066 * 1.0499999523162842f;
  float _1077 = ((_333 * 0.00390625f) + -0.001953125f) + _1067;
  float _1078 = ((_354 * 0.00390625f) + -0.001953125f) + _1068;
  float _1079 = ((_355 * 0.00390625f) + -0.001953125f) + _1069;
  [branch]
  if (!((uint)(cb0_098w) == 0)) {
    float _1091 = (pow(_1077, 0.012683313339948654f));
    float _1092 = (pow(_1078, 0.012683313339948654f));
    float _1093 = (pow(_1079, 0.012683313339948654f));
    float _1126 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1091 + -0.8359375f)) / (18.8515625f - (_1091 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1127 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1092 + -0.8359375f)) / (18.8515625f - (_1092 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1128 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1093 + -0.8359375f)) / (18.8515625f - (_1093 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    _1154 = min((_1126 * 12.920000076293945f), ((exp2(log2(max(_1126, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1155 = min((_1127 * 12.920000076293945f), ((exp2(log2(max(_1127, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1156 = min((_1128 * 12.920000076293945f), ((exp2(log2(max(_1128, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _1154 = _1077;
    _1155 = _1078;
    _1156 = _1079;
  ...
  const float3 inverted = renodx::draw::InvertIntermediatePass(float3(_1154, _1155, _1156));
  _1154 = inverted.r; _1155 = inverted.g; _1156 = inverted.b;

  float _1165 = ((((_1155 * 587.0f) + (_1154 * 299.0f)) + (_1156 * 114.0f)) * 0.0010000000474974513f) - cb0_100z;
  float _1172 = saturate(float(((int)(uint)((bool)(_1165 > 0.0f))) - ((int)(uint)((bool)(_1165 < 0.0f)))));
  float _1179 = cb0_101x - _1154;
  float _1180 = cb0_101y - _1155;
  float _1181 = cb0_101z - _1156;

  const float peak_scaling = RENODX_PEAK_NITS / RENODX_GAME_NITS;
  float _1186 = peak_scaling * cb0_102x - _1154;
  float _1187 = peak_scaling * cb0_102y - _1155;
  float _1188 = peak_scaling * cb0_102z - _1156;

  [branch]
  if (cb0_100y > 0.0f) {
    _1205 = (_1179 * cb0_100y);
    _1206 = (_1180 * cb0_100y);
    _1207 = (_1181 * cb0_100y);
    _1208 = (_1186 * cb0_100y);
    _1209 = (_1187 * cb0_100y);
    _1210 = (_1188 * cb0_100y);
  } else {
    float _1197 = abs(cb0_100y);
    _1205 = (_1197 * _1186);
    _1206 = (_1197 * _1187);
    _1207 = (_1197 * _1188);
    _1208 = (_1197 * _1179);
  ...
  SV_Target.x = (((lerp(_1205, _1208, _1172)) * cb0_100x) + _1154);
  SV_Target.y = (((lerp(_1206, _1209, _1172)) * cb0_100x) + _1155);
  SV_Target.z = (((lerp(_1207, _1210, _1172)) * cb0_100x) + _1156);

  SV_Target.rgb = renodx::draw::RenderIntermediatePass(SV_Target.rgb);

  SV_Target.w = (dot(float3(_1067, _1068, _1069), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
