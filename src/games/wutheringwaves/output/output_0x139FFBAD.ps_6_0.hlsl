...
float4 main(
  ...
  float _456 = ((((_395 * (_396 - cb0_081x)) + cb0_081x) * (_353 + ((_288 * TEXCOORD_1.x) * cb0_078x))) * ((_434 * (_435 - cb0_084x)) + cb0_084x)) * ((cb0_087x * _84) + cb0_087y);
  float _459 = ((((_395 * (_396 - cb0_081y)) + cb0_081y) * (_354 + ((_289 * TEXCOORD_1.x) * cb0_078y))) * ((_434 * (_435 - cb0_084y)) + cb0_084y)) * ((cb0_087x * _106) + cb0_087y);
  float _462 = ((((_395 * (_396 - cb0_081z)) + cb0_081z) * (_355 + ((_230.z * TEXCOORD_1.x) * cb0_078z))) * ((_434 * (_435 - cb0_084z)) + cb0_084z)) * ((cb0_087x * _107) + cb0_087y);

  CAPTURE_UNTONEMAPPED(float3(_456, _459, _462));

  [branch]
  if (WUWA_TM_IS(1)) {
    _495 = ((((_456 * 1.3600000143051147f) + 0.04699999839067459f) * _456) / ((((_456 * 0.9599999785423279f) + 0.5600000023841858f) * _456) + 0.14000000059604645f));
    _496 = ((((_459 * 1.3600000143051147f) + 0.04699999839067459f) * _459) / ((((_459 * 0.9599999785423279f) + 0.5600000023841858f) * _459) + 0.14000000059604645f));
    _497 = ((((_462 * 1.3600000143051147f) + 0.04699999839067459f) * _462) / ((((_462 * 0.9599999785423279f) + 0.5600000023841858f) * _462) + 0.14000000059604645f));
  } else {
    _495 = _456;
    _496 = _459;
    _497 = _462;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _507 = 1.0049500465393066f - (0.16398000717163086f / (_495 + -0.19505000114440918f));
    float _508 = 1.0049500465393066f - (0.16398000717163086f / (_496 + -0.19505000114440918f));
    float _509 = 1.0049500465393066f - (0.16398000717163086f / (_497 + -0.19505000114440918f));
    _529 = (((_495 - _507) * select((_495 > 0.6000000238418579f), 0.0f, 1.0f)) + _507);
    _530 = (((_496 - _508) * select((_496 > 0.6000000238418579f), 0.0f, 1.0f)) + _508);
    _531 = (((_497 - _509) * select((_497 > 0.6000000238418579f), 0.0f, 1.0f)) + _509);
  } else {
    _529 = _495;
    _530 = _496;
    _531 = _497;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _537 = cb0_037y * _529;
    float _538 = cb0_037y * _530;
    float _539 = cb0_037y * _531;
    float _542 = cb0_037z * cb0_037w;
    float _552 = cb0_038y * cb0_038x;
    float _563 = cb0_038z * cb0_038x;
    float _570 = cb0_038y / cb0_038z;
    _578 = (((((_542 + _537) * _529) + _552) / (((_537 + cb0_037z) * _529) + _563)) - _570);
    _579 = (((((_542 + _538) * _530) + _552) / (((_538 + cb0_037z) * _530) + _563)) - _570);
    _580 = (((((_542 + _539) * _531) + _552) / (((_539 + cb0_037z) * _531) + _563)) - _570);
  } else {
    _578 = _529;
    _579 = _530;
    _580 = _531;
  ...
  if (!((uint)(cb0_097w) == 0)) {
    if (!(cb0_098x == 1.0f)) {
      float _589 = dot(float3(_578, _579, _580), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_589 <= 9.999999747378752e-05f)) {
        float _598 = (pow(_578, 0.1593017578125f));
        float _599 = (pow(_579, 0.1593017578125f));
        float _600 = (pow(_580, 0.1593017578125f));
        float _622 = exp2(log2(((_598 * 18.8515625f) + 0.8359375f) / ((_598 * 18.6875f) + 1.0f)) * 78.84375f);
        float _623 = exp2(log2(((_599 * 18.8515625f) + 0.8359375f) / ((_599 * 18.6875f) + 1.0f)) * 78.84375f);
        float _624 = exp2(log2(((_600 * 18.8515625f) + 0.8359375f) / ((_600 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_589 * 200.0f) > 1.0f) {
          float _628 = 1.0f - cb0_098x;
          do {
            if (_622 > 0.44028136134147644f) {
              float _631 = _622 + -0.44028136134147644f;
              _637 = ((_631 / ((_631 * _628) + 1.0f)) + 0.44028136134147644f);
            } else {
              _637 = _622;
            }
            do {
              if (_623 > 0.44028136134147644f) {
                float _819 = _623 + -0.44028136134147644f;
                _825 = ((_819 / ((_819 * _628) + 1.0f)) + 0.44028136134147644f);
                if (_624 > 0.44028136134147644f) {
                  float _828 = _624 + -0.44028136134147644f;
                  _640 = ((_828 / ((_828 * _628) + 1.0f)) + 0.44028136134147644f);
                  _641 = _825;
                  _642 = _637;
                } else {
                  _640 = _624;
              ...
              while(true) {
                float _649 = (pow(_642, 0.012683313339948654f));
                float _650 = (pow(_641, 0.012683313339948654f));
                float _651 = (pow(_640, 0.012683313339948654f));
                _677 = exp2(log2(max((_649 + -0.8359375f), 0.0f) / (18.8515625f - (_649 * 18.6875f))) * 6.277394771575928f);
                _678 = exp2(log2(max((_650 + -0.8359375f), 0.0f) / (18.8515625f - (_650 * 18.6875f))) * 6.277394771575928f);
                _679 = exp2(log2(max((_651 + -0.8359375f), 0.0f) / (18.8515625f - (_651 * 18.6875f))) * 6.277394771575928f);
                break;
              }
            } while (false);
          } while (false);
  ...
  CLAMP_IF_SDR3(_677, _678, _679);
  CAPTURE_TONEMAPPED(float3(_677, _678, _679));

  float _700 = (saturate((log2(_677 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _701 = (saturate((log2(_678 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _702 = (saturate((log2(_679 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float4 _703 = t5.Sample(s5, float3(_700, _701, _702));

  HANDLE_LUT_OUTPUT(_703);

  [branch]
  if (false) {
    float _710 = select(((_79 * _78) > 0.0f), 0.0f, 1.0f);
    float4 _711 = t6.Sample(s6, float3(_700, _701, _702));
    _725 = (lerp(_703.x, _711.x, _710));
    _726 = (lerp(_703.y, _711.y, _710));
    _727 = (lerp(_703.z, _711.z, _710));
  } else {
    _725 = _703.x;
    _726 = _703.y;
    _727 = _703.z;
  }
  float _728 = _725 * 1.0499999523162842f;
  float _729 = _726 * 1.0499999523162842f;
  float _730 = _727 * 1.0499999523162842f;
  float _738 = ((_84 * 0.00390625f) + -0.001953125f) + _728;
  float _739 = ((_106 * 0.00390625f) + -0.001953125f) + _729;
  float _740 = ((_107 * 0.00390625f) + -0.001953125f) + _730;
  [branch]
  if (!((uint)(cb0_098w) == 0)) {
    float _752 = (pow(_738, 0.012683313339948654f));
    float _753 = (pow(_739, 0.012683313339948654f));
    float _754 = (pow(_740, 0.012683313339948654f));
    float _787 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_752 + -0.8359375f)) / (18.8515625f - (_752 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _788 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_753 + -0.8359375f)) / (18.8515625f - (_753 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _789 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_754 + -0.8359375f)) / (18.8515625f - (_754 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    _815 = min((_787 * 12.920000076293945f), ((exp2(log2(max(_787, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _816 = min((_788 * 12.920000076293945f), ((exp2(log2(max(_788, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  ...
  SV_Target.w = (dot(float3(_728, _729, _730), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
