...
float4 main(
  ...
  float _854 = (((_760 + ((_694 * TEXCOORD_1.x) * cb0_078x)) * _379) * ((_802 * (_803 - cb0_081x)) + cb0_081x)) * ((_841 * (_842 - cb0_084x)) + cb0_084x);
  float _857 = (((_761 + ((_695 * TEXCOORD_1.x) * cb0_078y)) * _379) * ((_802 * (_803 - cb0_081y)) + cb0_081y)) * ((_841 * (_842 - cb0_084y)) + cb0_084y);
  float _860 = (((_762 + ((_696 * TEXCOORD_1.x) * cb0_078z)) * _379) * ((_802 * (_803 - cb0_081z)) + cb0_081z)) * ((_841 * (_842 - cb0_084z)) + cb0_084z);

  CAPTURE_UNTONEMAPPED(float3(_854, _857, _860));

  [branch]
  if (WUWA_TM_IS(1)) {
    _893 = ((((_854 * 1.3600000143051147f) + 0.04699999839067459f) * _854) / ((((_854 * 0.9599999785423279f) + 0.5600000023841858f) * _854) + 0.14000000059604645f));
    _894 = ((((_857 * 1.3600000143051147f) + 0.04699999839067459f) * _857) / ((((_857 * 0.9599999785423279f) + 0.5600000023841858f) * _857) + 0.14000000059604645f));
    _895 = ((((_860 * 1.3600000143051147f) + 0.04699999839067459f) * _860) / ((((_860 * 0.9599999785423279f) + 0.5600000023841858f) * _860) + 0.14000000059604645f));
  } else {
    _893 = _854;
    _894 = _857;
    _895 = _860;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _905 = 1.0049500465393066f - (0.16398000717163086f / (_893 + -0.19505000114440918f));
    float _906 = 1.0049500465393066f - (0.16398000717163086f / (_894 + -0.19505000114440918f));
    float _907 = 1.0049500465393066f - (0.16398000717163086f / (_895 + -0.19505000114440918f));
    _927 = (((_893 - _905) * select((_893 > 0.6000000238418579f), 0.0f, 1.0f)) + _905);
    _928 = (((_894 - _906) * select((_894 > 0.6000000238418579f), 0.0f, 1.0f)) + _906);
    _929 = (((_895 - _907) * select((_895 > 0.6000000238418579f), 0.0f, 1.0f)) + _907);
  } else {
    _927 = _893;
    _928 = _894;
    _929 = _895;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _935 = cb0_037y * _927;
    float _936 = cb0_037y * _928;
    float _937 = cb0_037y * _929;
    float _940 = cb0_037z * cb0_037w;
    float _950 = cb0_038y * cb0_038x;
    float _961 = cb0_038z * cb0_038x;
    float _968 = cb0_038y / cb0_038z;
    _976 = (((((_940 + _935) * _927) + _950) / (((_935 + cb0_037z) * _927) + _961)) - _968);
    _977 = (((((_940 + _936) * _928) + _950) / (((_936 + cb0_037z) * _928) + _961)) - _968);
    _978 = (((((_940 + _937) * _929) + _950) / (((_937 + cb0_037z) * _929) + _961)) - _968);
  } else {
    _976 = _927;
    _977 = _928;
    _978 = _929;
  ...
  if (!((uint)(cb0_097w) == 0)) {
    if (!(cb0_098x == 1.0f)) {
      float _987 = dot(float3(_976, _977, _978), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_987 <= 9.999999747378752e-05f)) {
        float _996 = (pow(_976, 0.1593017578125f));
        float _997 = (pow(_977, 0.1593017578125f));
        float _998 = (pow(_978, 0.1593017578125f));
        float _1020 = exp2(log2(((_996 * 18.8515625f) + 0.8359375f) / ((_996 * 18.6875f) + 1.0f)) * 78.84375f);
        float _1021 = exp2(log2(((_997 * 18.8515625f) + 0.8359375f) / ((_997 * 18.6875f) + 1.0f)) * 78.84375f);
        float _1022 = exp2(log2(((_998 * 18.8515625f) + 0.8359375f) / ((_998 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_987 * 200.0f) > 1.0f) {
          float _1026 = 1.0f - cb0_098x;
          do {
            if (_1020 > 0.44028136134147644f) {
              float _1029 = _1020 + -0.44028136134147644f;
              _1035 = ((_1029 / ((_1029 * _1026) + 1.0f)) + 0.44028136134147644f);
            } else {
              _1035 = _1020;
            }
            do {
              if (_1021 > 0.44028136134147644f) {
                float _1217 = _1021 + -0.44028136134147644f;
                _1223 = ((_1217 / ((_1217 * _1026) + 1.0f)) + 0.44028136134147644f);
                if (_1022 > 0.44028136134147644f) {
                  float _1226 = _1022 + -0.44028136134147644f;
                  _1038 = ((_1226 / ((_1226 * _1026) + 1.0f)) + 0.44028136134147644f);
                  _1039 = _1223;
                  _1040 = _1035;
                } else {
                  _1038 = _1022;
              ...
              while(true) {
                float _1047 = (pow(_1040, 0.012683313339948654f));
                float _1048 = (pow(_1039, 0.012683313339948654f));
                float _1049 = (pow(_1038, 0.012683313339948654f));
                _1075 = exp2(log2(max((_1047 + -0.8359375f), 0.0f) / (18.8515625f - (_1047 * 18.6875f))) * 6.277394771575928f);
                _1076 = exp2(log2(max((_1048 + -0.8359375f), 0.0f) / (18.8515625f - (_1048 * 18.6875f))) * 6.277394771575928f);
                _1077 = exp2(log2(max((_1049 + -0.8359375f), 0.0f) / (18.8515625f - (_1049 * 18.6875f))) * 6.277394771575928f);
                break;
              }
            } while (false);
          } while (false);
  ...
  CLAMP_IF_SDR3(_1075, _1076, _1077);
  CAPTURE_TONEMAPPED(float3(_1075, _1076, _1077));

  float _1098 = (saturate((log2(_1075 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _1099 = (saturate((log2(_1076 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _1100 = (saturate((log2(_1077 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float4 _1101 = t5.Sample(s5, float3(_1098, _1099, _1100));

  HANDLE_LUT_OUTPUT(_1101);

  [branch]
  if (false) {
    float _1108 = select(((_160 * _141.x) > 0.0f), 0.0f, 1.0f);
    float4 _1109 = t6.Sample(s6, float3(_1098, _1099, _1100));
    _1123 = (lerp(_1101.x, _1109.x, _1108));
    _1124 = (lerp(_1101.y, _1109.y, _1108));
    _1125 = (lerp(_1101.z, _1109.z, _1108));
  } else {
    _1123 = _1101.x;
    _1124 = _1101.y;
    _1125 = _1101.z;
  }
  float _1126 = _1123 * 1.0499999523162842f;
  float _1127 = _1124 * 1.0499999523162842f;
  float _1128 = _1125 * 1.0499999523162842f;
  float _1136 = ((_335 * 0.00390625f) + -0.001953125f) + _1126;
  float _1137 = ((_356 * 0.00390625f) + -0.001953125f) + _1127;
  float _1138 = ((_357 * 0.00390625f) + -0.001953125f) + _1128;
  [branch]
  if (!((uint)(cb0_098w) == 0)) {
    float _1150 = (pow(_1136, 0.012683313339948654f));
    float _1151 = (pow(_1137, 0.012683313339948654f));
    float _1152 = (pow(_1138, 0.012683313339948654f));
    float _1185 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1150 + -0.8359375f)) / (18.8515625f - (_1150 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1186 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1151 + -0.8359375f)) / (18.8515625f - (_1151 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1187 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1152 + -0.8359375f)) / (18.8515625f - (_1152 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    ...
    _1215 = min((_1187 * 12.920000076293945f), ((exp2(log2(max(_1187, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _1213 = _1136;
    _1214 = _1137;
    _1215 = _1138;
  ...
  SV_Target.w = (dot(float3(_1126, _1127, _1128), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
