...
float4 main(
  ...
  float _442 = (((_391 * (_392 - cb0_081x)) + cb0_081x) * (_349 + ((_288 * TEXCOORD_1.x) * cb0_078x))) * ((_430 * (_431 - cb0_084x)) + cb0_084x);
  float _444 = (((_391 * (_392 - cb0_081y)) + cb0_081y) * (_350 + ((_289 * TEXCOORD_1.x) * cb0_078y))) * ((_430 * (_431 - cb0_084y)) + cb0_084y);
  float _446 = (((_391 * (_392 - cb0_081z)) + cb0_081z) * (_351 + ((_230.z * TEXCOORD_1.x) * cb0_078z))) * ((_430 * (_431 - cb0_084z)) + cb0_084z);

  CAPTURE_UNTONEMAPPED(float3(_442, _444, _446));

  [branch]
  if (WUWA_TM_IS(1)) {
    _479 = ((((_442 * 1.3600000143051147f) + 0.04699999839067459f) * _442) / ((((_442 * 0.9599999785423279f) + 0.5600000023841858f) * _442) + 0.14000000059604645f));
    _480 = ((((_444 * 1.3600000143051147f) + 0.04699999839067459f) * _444) / ((((_444 * 0.9599999785423279f) + 0.5600000023841858f) * _444) + 0.14000000059604645f));
  ...
  if (!((uint)(cb0_097w) == 0)) {
    if (!(cb0_098x == 1.0f)) {
      float _573 = dot(float3(_562, _563, _564), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_573 <= 9.999999747378752e-05f)) {
        float _582 = (pow(_562, 0.1593017578125f));
        float _583 = (pow(_563, 0.1593017578125f));
        float _584 = (pow(_564, 0.1593017578125f));
        float _606 = exp2(log2(((_582 * 18.8515625f) + 0.8359375f) / ((_582 * 18.6875f) + 1.0f)) * 78.84375f);
        float _607 = exp2(log2(((_583 * 18.8515625f) + 0.8359375f) / ((_583 * 18.6875f) + 1.0f)) * 78.84375f);
        float _608 = exp2(log2(((_584 * 18.8515625f) + 0.8359375f) / ((_584 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_573 * 200.0f) > 1.0f) {
          float _612 = 1.0f - cb0_098x;
          do {
            if (_606 > 0.44028136134147644f) {
              float _615 = _606 + -0.44028136134147644f;
              _621 = ((_615 / ((_615 * _612) + 1.0f)) + 0.44028136134147644f);
            } else {
              _621 = _606;
            }
            do {
              if (_607 > 0.44028136134147644f) {
                float _803 = _607 + -0.44028136134147644f;
                _809 = ((_803 / ((_803 * _612) + 1.0f)) + 0.44028136134147644f);
                if (_608 > 0.44028136134147644f) {
                  float _812 = _608 + -0.44028136134147644f;
                  _624 = ((_812 / ((_812 * _612) + 1.0f)) + 0.44028136134147644f);
                  _625 = _809;
                  _626 = _621;
                } else {
                  _624 = _608;
              ...
              while(true) {
                float _633 = (pow(_626, 0.012683313339948654f));
                float _634 = (pow(_625, 0.012683313339948654f));
                float _635 = (pow(_624, 0.012683313339948654f));
                _661 = exp2(log2(max((_633 + -0.8359375f), 0.0f) / (18.8515625f - (_633 * 18.6875f))) * 6.277394771575928f);
                _662 = exp2(log2(max((_634 + -0.8359375f), 0.0f) / (18.8515625f - (_634 * 18.6875f))) * 6.277394771575928f);
                _663 = exp2(log2(max((_635 + -0.8359375f), 0.0f) / (18.8515625f - (_635 * 18.6875f))) * 6.277394771575928f);
                break;
              }
            } while (false);
          } while (false);
  ...
  CLAMP_IF_SDR3(_661, _662, _663);
  CAPTURE_TONEMAPPED(float3(_661, _662, _663));

  float _684 = (saturate((log2(_661 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _685 = (saturate((log2(_662 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _686 = (saturate((log2(_663 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float4 _687 = t5.Sample(s5, float3(_684, _685, _686));

  HANDLE_LUT_OUTPUT(_687);

  [branch]
  if (false) {
    float _694 = select(((_79 * _78) > 0.0f), 0.0f, 1.0f);
    float4 _695 = t6.Sample(s6, float3(_684, _685, _686));
    _709 = (lerp(_687.x, _695.x, _694));
    _710 = (lerp(_687.y, _695.y, _694));
    _711 = (lerp(_687.z, _695.z, _694));
  } else {
    _709 = _687.x;
    _710 = _687.y;
    _711 = _687.z;
  }
  float _712 = _709 * 1.0499999523162842f;
  float _713 = _710 * 1.0499999523162842f;
  float _714 = _711 * 1.0499999523162842f;
  float _722 = ((_84 * 0.00390625f) + -0.001953125f) + _712;
  float _723 = ((_106 * 0.00390625f) + -0.001953125f) + _713;
  float _724 = ((_107 * 0.00390625f) + -0.001953125f) + _714;
  [branch]
  if (!((uint)(cb0_098w) == 0)) {
    float _736 = (pow(_722, 0.012683313339948654f));
    float _737 = (pow(_723, 0.012683313339948654f));
    float _738 = (pow(_724, 0.012683313339948654f));
    float _771 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_736 + -0.8359375f)) / (18.8515625f - (_736 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _772 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_737 + -0.8359375f)) / (18.8515625f - (_737 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _773 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_738 + -0.8359375f)) / (18.8515625f - (_738 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    _799 = min((_771 * 12.920000076293945f), ((exp2(log2(max(_771, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  ...
  SV_Target.w = (dot(float3(_712, _713, _714), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
