...
float4 main(
  ...
  float _822 = ((((_717.x + ((_690 * TEXCOORD_1.x) * cb0_070x)) * _375) * ((_760 * (_761 - cb0_073x)) + cb0_073x)) * ((_799 * (_800 - cb0_076x)) + cb0_076x)) * ((cb0_079x * _331) + cb0_079y);
  float _826 = ((((_717.y + ((_691 * TEXCOORD_1.x) * cb0_070y)) * _375) * ((_760 * (_761 - cb0_073y)) + cb0_073y)) * ((_799 * (_800 - cb0_076y)) + cb0_076y)) * ((cb0_079x * _352) + cb0_079y);
  float _830 = ((((_717.z + ((_692 * TEXCOORD_1.x) * cb0_070z)) * _375) * ((_760 * (_761 - cb0_073z)) + cb0_073z)) * ((_799 * (_800 - cb0_076z)) + cb0_076z)) * ((cb0_079x * _353) + cb0_079y);

  CAPTURE_UNTONEMAPPED(float3(_822, _826, _830));

  [branch]
  if (((uint)(RENODX_WUWA_TM) == 1)) {
    _863 = ((((_822 * 1.3600000143051147f) + 0.04699999839067459f) * _822) / ((((_822 * 0.9599999785423279f) + 0.5600000023841858f) * _822) + 0.14000000059604645f));
    _864 = ((((_826 * 1.3600000143051147f) + 0.04699999839067459f) * _826) / ((((_826 * 0.9599999785423279f) + 0.5600000023841858f) * _826) + 0.14000000059604645f));
  ...
  if (((uint)(RENODX_WUWA_TM) == 3)) {
    ...
    _946 = (((((_910 + _905) * _897) + _920) / (((_905 + cb0_037z) * _897) + _931)) - _938);
    _947 = (((((_910 + _906) * _898) + _920) / (((_906 + cb0_037z) * _898) + _931)) - _938);
    _948 = (((((_910 + _907) * _899) + _920) / (((_907 + cb0_037z) * _899) + _931)) - _938);
  } else {
    _946 = _897;
    _947 = _898;
    _948 = _899;
  ...
  if (!((uint)(cb0_089w) == 0)) {
    if (!(cb0_090x == 1.0f)) {
      float _957 = dot(float3(_946, _947, _948), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_957 <= 9.999999747378752e-05f)) {
        float _966 = (pow(_946, 0.1593017578125f));
        float _967 = (pow(_947, 0.1593017578125f));
        float _968 = (pow(_948, 0.1593017578125f));
        float _990 = exp2(log2(((_966 * 18.8515625f) + 0.8359375f) / ((_966 * 18.6875f) + 1.0f)) * 78.84375f);
        float _991 = exp2(log2(((_967 * 18.8515625f) + 0.8359375f) / ((_967 * 18.6875f) + 1.0f)) * 78.84375f);
        float _992 = exp2(log2(((_968 * 18.8515625f) + 0.8359375f) / ((_968 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_957 * 200.0f) > 1.0f) {
          float _996 = 1.0f - cb0_090x;
          do {
            if (_990 > 0.44028136134147644f) {
              float _999 = _990 + -0.44028136134147644f;
              _1005 = ((_999 / ((_999 * _996) + 1.0f)) + 0.44028136134147644f);
            } else {
              _1005 = _990;
            }
            do {
              if (_991 > 0.44028136134147644f) {
                float _1164 = _991 + -0.44028136134147644f;
                _1170 = ((_1164 / ((_1164 * _996) + 1.0f)) + 0.44028136134147644f);
                if (_992 > 0.44028136134147644f) {
                  float _1173 = _992 + -0.44028136134147644f;
                  _1008 = ((_1173 / ((_1173 * _996) + 1.0f)) + 0.44028136134147644f);
                  _1009 = _1170;
                  _1010 = _1005;
                } else {
                  _1008 = _992;
              ...
              while(true) {
                float _1017 = (pow(_1010, 0.012683313339948654f));
                float _1018 = (pow(_1009, 0.012683313339948654f));
                float _1019 = (pow(_1008, 0.012683313339948654f));
                _1045 = exp2(log2(max((_1017 + -0.8359375f), 0.0f) / (18.8515625f - (_1017 * 18.6875f))) * 6.277394771575928f);
                _1046 = exp2(log2(max((_1018 + -0.8359375f), 0.0f) / (18.8515625f - (_1018 * 18.6875f))) * 6.277394771575928f);
                _1047 = exp2(log2(max((_1019 + -0.8359375f), 0.0f) / (18.8515625f - (_1019 * 18.6875f))) * 6.277394771575928f);
                break;
              }
            } while (false);
          } while (false);
  ...
  CLAMP_IF_SDR(_1045); CLAMP_IF_SDR(_1046); CLAMP_IF_SDR(_1047);
  CAPTURE_TONEMAPPED(float3(_1045, _1046, _1047));

  float4 _1069 = t4.Sample(s4, float3(((saturate((log2(_1045 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f), ((saturate((log2(_1046 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f), ((saturate((log2(_1047 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f)));
  _1069.rgb = HandleLUTOutput(_1069.rgb, untonemapped, tonemapped);

  float _1073 = _1069.x * 1.0499999523162842f;
  float _1074 = _1069.y * 1.0499999523162842f;
  float _1075 = _1069.z * 1.0499999523162842f;
  float _1083 = ((_331 * 0.00390625f) + -0.001953125f) + _1073;
  float _1084 = ((_352 * 0.00390625f) + -0.001953125f) + _1074;
  float _1085 = ((_353 * 0.00390625f) + -0.001953125f) + _1075;
  [branch]
  if (!((uint)(cb0_090w) == 0)) {
    float _1097 = (pow(_1083, 0.012683313339948654f));
    float _1098 = (pow(_1084, 0.012683313339948654f));
    float _1099 = (pow(_1085, 0.012683313339948654f));
    float _1132 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1097 + -0.8359375f)) / (18.8515625f - (_1097 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_090z));
    float _1133 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1098 + -0.8359375f)) / (18.8515625f - (_1098 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_090z));
    float _1134 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1099 + -0.8359375f)) / (18.8515625f - (_1099 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_090z));
    ...
    _1161 = min((_1133 * 12.920000076293945f), ((exp2(log2(max(_1133, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1162 = min((_1134 * 12.920000076293945f), ((exp2(log2(max(_1134, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _1160 = _1083;
    _1161 = _1084;
    _1162 = _1085;
  ...
  SV_Target.w = (dot(float3(_1073, _1074, _1075), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
