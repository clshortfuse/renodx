...
float4 main(
  ...
  if (_489) {
    ...
    // _588 = ((((_532.x - _547.x) + (_574 * (_547.x - _532.x))) * cb0_099x) + _547.x);
    // _589 = ((((_532.y - _560.y) + (_574 * (_560.y - _532.y))) * cb0_099x) + _560.y);
  ...
  float _810 = ((_717.x + ((_692 * TEXCOORD_1.x) * cb0_069x)) * _376) * min(((_759 * (1.0f - cb0_072x)) + cb0_072x), ((_796 * (1.0f - cb0_075x)) + cb0_075x));
  float _812 = ((_717.y + ((_693 * TEXCOORD_1.x) * cb0_069y)) * _376) * min(((_759 * (1.0f - cb0_072y)) + cb0_072y), ((_796 * (1.0f - cb0_075y)) + cb0_075y));
  float _814 = ((_717.z + ((_694 * TEXCOORD_1.x) * cb0_069z)) * _376) * min(((_759 * (1.0f - cb0_072z)) + cb0_072z), ((_796 * (1.0f - cb0_075z)) + cb0_075z));

  CAPTURE_UNTONEMAPPED(untonemapped, float3(_810, _812, _814));

  [branch]
  if (((uint)(RENODX_WUWA_TM) == 1)) {
    // _847 = saturate((((_810 * 1.3600000143051147f) + 0.04699999839067459f) * _810) / ((((_810 * 0.9599999785423279f) + 0.5600000023841858f) * _810) + 0.14000000059604645f));
    // _848 = saturate((((_812 * 1.3600000143051147f) + 0.04699999839067459f) * _812) / ((((_812 * 0.9599999785423279f) + 0.5600000023841858f) * _812) + 0.14000000059604645f));
    // _849 = saturate((((_814 * 1.3600000143051147f) + 0.04699999839067459f) * _814) / ((((_814 * 0.9599999785423279f) + 0.5600000023841858f) * _814) + 0.14000000059604645f));
    _847 = ((((_810 * 1.3600000143051147f) + 0.04699999839067459f) * _810) / ((((_810 * 0.9599999785423279f) + 0.5600000023841858f) * _810) + 0.14000000059604645f));
    _848 = ((((_812 * 1.3600000143051147f) + 0.04699999839067459f) * _812) / ((((_812 * 0.9599999785423279f) + 0.5600000023841858f) * _812) + 0.14000000059604645f));
    _849 = ((((_814 * 1.3600000143051147f) + 0.04699999839067459f) * _814) / ((((_814 * 0.9599999785423279f) + 0.5600000023841858f) * _814) + 0.14000000059604645f));
  } else {
    _847 = _810;
    _848 = _812;
    _849 = _814;
  ...
  if (((uint)(RENODX_WUWA_TM) == 2)) {
    float _859 = 1.0049500465393066f - (0.16398000717163086f / (_847 + -0.19505000114440918f));
    float _860 = 1.0049500465393066f - (0.16398000717163086f / (_848 + -0.19505000114440918f));
    float _861 = 1.0049500465393066f - (0.16398000717163086f / (_849 + -0.19505000114440918f));
    // _881 = saturate(((_847 - _859) * select((_847 > 0.6000000238418579f), 0.0f, 1.0f)) + _859);
    // _882 = saturate(((_848 - _860) * select((_848 > 0.6000000238418579f), 0.0f, 1.0f)) + _860);
    // _883 = saturate(((_849 - _861) * select((_849 > 0.6000000238418579f), 0.0f, 1.0f)) + _861);
    _881 = (((_847 - _859) * select((_847 > 0.6000000238418579f), 0.0f, 1.0f)) + _859);
    _882 = (((_848 - _860) * select((_848 > 0.6000000238418579f), 0.0f, 1.0f)) + _860);
    _883 = (((_849 - _861) * select((_849 > 0.6000000238418579f), 0.0f, 1.0f)) + _861);
  } else {
    _881 = _847;
    _882 = _848;
    _883 = _849;
  ...
  if (((uint)(RENODX_WUWA_TM) == 3)) {
    float _889 = cb0_037y * _881;
    float _890 = cb0_037y * _882;
    float _891 = cb0_037y * _883;
    float _894 = cb0_037z * cb0_037w;
    float _904 = cb0_038y * cb0_038x;
    float _915 = cb0_038z * cb0_038x;
    float _922 = cb0_038y / cb0_038z;
    // _930 = saturate(((((_894 + _889) * _881) + _904) / (_915 + ((_889 + cb0_037z) * _881))) - _922);
    // _931 = saturate(((((_894 + _890) * _882) + _904) / (_915 + ((_890 + cb0_037z) * _882))) - _922);
    // _932 = saturate(((((_894 + _891) * _883) + _904) / (_915 + ((_891 + cb0_037z) * _883))) - _922);
    _930 = (((((_894 + _889) * _881) + _904) / (_915 + ((_889 + cb0_037z) * _881))) - _922);
    _931 = (((((_894 + _890) * _882) + _904) / (_915 + ((_890 + cb0_037z) * _882))) - _922);
    _932 = (((((_894 + _891) * _883) + _904) / (_915 + ((_891 + cb0_037z) * _883))) - _922);
  } else {
    _930 = _881;
    _931 = _882;
    _932 = _883;
  ...
  CLAMP_IF_SDR(_930); CLAMP_IF_SDR(_931); CLAMP_IF_SDR(_932);
  CAPTURE_TONEMAPPED(tonemapped, float3(_930, _931, _932));

  float4 _954 = t4.Sample(s4, float3(((saturate((log2(_930 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f), ((saturate((log2(_931 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f), ((saturate((log2(_932 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f)));
  _954.rgb = HandleLUTOutput(_954.rgb, untonemapped, tonemapped);

  float _958 = _954.x * 1.0499999523162842f;
  float _959 = _954.y * 1.0499999523162842f;
  float _960 = _954.z * 1.0499999523162842f;

  // float _968 = ((_330 * 0.00390625f) + -0.001953125f) + _958;
  // float _969 = ((_353 * 0.00390625f) + -0.001953125f) + _959;
  // float _970 = ((_354 * 0.00390625f) + -0.001953125f) + _960;
  float _968 = RENODX_WUWA_GRAIN * ((_330 * 0.00390625f) + -0.001953125f) + _958;
  float _969 = RENODX_WUWA_GRAIN * ((_353 * 0.00390625f) + -0.001953125f) + _959;
  float _970 = RENODX_WUWA_GRAIN * ((_354 * 0.00390625f) + -0.001953125f) + _960;

  [branch]
  if (!((uint)(cb0_089x) == 0)) {
    float _982 = (pow(_968, 0.012683313339948654f));
    float _983 = (pow(_969, 0.012683313339948654f));
    float _984 = (pow(_970, 0.012683313339948654f));
    float _1017 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_982 + -0.8359375f)) / (18.8515625f - (_982 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_088w));
    float _1018 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_983 + -0.8359375f)) / (18.8515625f - (_983 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_088w));
    float _1019 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_984 + -0.8359375f)) / (18.8515625f - (_984 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_088w));
    _1045 = min((_1017 * 12.920000076293945f), ((exp2(log2(max(_1017, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1046 = min((_1018 * 12.920000076293945f), ((exp2(log2(max(_1018, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1047 = min((_1019 * 12.920000076293945f), ((exp2(log2(max(_1019, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _1045 = _968;
    _1046 = _969;
    _1047 = _970;
  ...
  // SV_Target.w = saturate(dot(float3(_958, _959, _960), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
  SV_Target.w = (dot(float3(_958, _959, _960), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
