...
float4 main(
    ...
    do {
      if (_37 > 0.0f) {
        ...
        if (_37 < 0.0f) {
          ...
          float _81 = (((_76 * _76) * (cb0_093x * 0.699999988079071f)) + 1.0f) * _76;
  ...
  float _160 = select((((_149 - _141.x) + ((((View_448[3].z) - _149) + ((View_448[2].z) * _140)) * select(((View_448[3].w) < 1.0f), 0.0f, 1.0f))) > 0.0005000000237487257f), 0.0f, 1.0f);
  if (((bool)(!(cb0_088y == 0.0f))) || ((bool)(((bool)(((bool)(((bool)(((bool)(!(cb0_089y == 0.0f))) || ((bool)(!(cb0_093y == 0.0f))))) || ((bool)(!(cb0_094y == 0.0f))))) || ((bool)(!(cb0_095y == 0.0f))))) || ((bool)(!(cb0_096y == 0.0f)))))) {
    float _195 = 1.5f - (saturate(cb0_089z) * 1.4900000095367432f);
    float _200 = saturate(((sqrt((_113 * _113) + (_112 * _112)) - cb0_089y) - _195) / (-0.0f - _195));
    float _204 = (_200 * _200) * (3.0f - (_200 * 2.0f));
    _212 = (1.0f - (_204 * max(cb0_088y, cb0_093y)));
    _213 = (1.0f - (_204 * max(cb0_088y, cb0_094y)));
    _214 = (1.0f - (_204 * max(cb0_088y, cb0_095y)));
  } else {
    _212 = 1.0f;
    _213 = 1.0f;
    _214 = 1.0f;
  }
  bool _220 = !(cb0_088z == 0.0f);
  bool _221 = !(cb0_093z == 0.0f);
  bool _223 = !(cb0_094z == 0.0f);
  bool _225 = !(cb0_095z == 0.0f);
  if (((bool)(((bool)(((bool)(_220 || _221)) || _223)) || _225)) || ((bool)(!(cb0_096z == 0.0f)))) {
    do {
      if (_220) {
        _236 = exp2(log2(saturate(cb0_088z)) * 3.0f);
      } else {
        _236 = cb0_088z;
      }
      do {
        if (_221) {
          _243 = exp2(log2(saturate(cb0_093z)) * 3.0f);
        } else {
          _243 = cb0_093z;
        }
        do {
          if (_223) {
            _250 = exp2(log2(saturate(cb0_094z)) * 3.0f);
          } else {
            _250 = cb0_094z;
          }
          do {
            if (_225) {
              _257 = exp2(log2(saturate(cb0_095z)) * 3.0f);
            } else {
              _257 = cb0_095z;
            }
            float _258 = max(_236, _243);
            float _259 = max(_236, _250);
            float _260 = max(_236, _257);
            ...
            float _278 = saturate((_140 - (_260 * 1000.0f)) / ((_260 * 9999.990234375f) + 0.009999999776482582f));
  ...
  if (((bool)(((bool)(((bool)(((bool)(!(cb0_089x == 0.0f))) || ((bool)(!(cb0_094x == 0.0f))))) || ((bool)(!(cb0_095x == 0.0f))))) || ((bool)(!(cb0_096x == 0.0f))))) || ((bool)(!(cb0_097x == 0.0f)))) {
    float _314 = saturate(select((_141.x > 0.0005000000237487257f), 1.0f, 2.0f) - _160);
    _328 = max(_314, (1.0f - saturate(max(cb0_089x, cb0_094x))));
    _329 = max(_314, (1.0f - saturate(max(cb0_089x, cb0_095x))));
    _330 = max(_314, (1.0f - saturate(max(cb0_089x, cb0_096x))));
  } else {
    _328 = 1.0f;
    _329 = 1.0f;
    _330 = 1.0f;
  ...
  if (cb0_088x > 0.0f) {
    _356 = (((frac((sin(_332 + 33.9900016784668f) * 493013.0f) + 7.177000045776367f) - _335) * cb0_088x) + _335);
    _357 = (((frac((sin(_332 + 66.98999786376953f) * 493013.0f) + 14.298999786376953f) - _335) * cb0_088x) + _335);
  } else {
    _356 = _335;
    _357 = _335;
  }
  if (cb0_091z > 0.0f) {
    _379 = (((((_294 * _214) * _330) * cb0_091z) * ((sin((((TEXCOORD_3.y * 10.0f) + 10.0f) + (_335 * 0.0020000000949949026f)) + (View_2376 * 4.0f)) * 0.5f) + 0.5f)) + 1.0f);
  } else {
    _379 = 1.0f;
  }
  float _382 = (_293 * _213) * _329;
  if (cb0_091y > 0.0f) {
    ...
    float _404 = ((_382 * 0.014999999664723873f) * cb0_091y) * (0.5f - frac(sin(dot(float2(_396, _396), float2(12.989800453186035f, 78.23300170898438f))) * 43758.546875f));
    _409 = ((_404 * 0.5f) + _126);
    _410 = (_404 + _127);
  } else {
    _409 = _126;
  ...
  float _415 = cb0_087z * (1.0f - (_335 * _335));
  float _420 = (_415 * (TEXCOORD_2.x - _409)) + _409;
  float _421 = (_415 * (TEXCOORD_2.y - _410)) + _410;
  float _436 = _420 - (((cb0_048z * _112) + cb0_049x) * cb0_048x);
  float _437 = _421 - (((cb0_048w * _113) + cb0_049y) * cb0_048y);
  float _447 = cb0_109z * cb0_108x;
  float _448 = cb0_109z * cb0_108y;
  bool _449 = (cb0_109x == 0.0f);
  float _459 = (cb0_105z * _112) + cb0_105x;
  float _460 = (cb0_105w * _113) + cb0_105y;
  float _479 = float(((int)(uint)((bool)(_459 > 0.0f))) - ((int)(uint)((bool)(_459 < 0.0f)))) * saturate(abs(_459) - cb0_108z);
  float _481 = float(((int)(uint)((bool)(_460 > 0.0f))) - ((int)(uint)((bool)(_460 < 0.0f)))) * saturate(abs(_460) - cb0_108z);
  float _486 = _460 - (_481 * _447);
  float _488 = _460 - (_481 * _448);
  bool _489 = (cb0_109x > 0.0f);
  if (_489) {
    _496 = (_486 - (cb0_109w * 0.4000000059604645f));
    _497 = (_488 - (cb0_109w * 0.20000000298023224f));
  } else {
    _496 = _486;
    _497 = _488;
  }
  float4 _533 = t0.Sample(s0, float2(min(max(_420, cb0_053z), cb0_054x), min(max(_421, cb0_053w), cb0_054y)));
  float4 _549 = t0.Sample(s0, float2(min(max(((((((cb0_106z * (_459 - (_479 * select(_449, _447, cb0_108x)))) + cb0_106x) * cb0_048z) + cb0_049x) * cb0_048x) + _436), cb0_053z), cb0_054x), min(max(((((((cb0_106w * _496) + cb0_106y) * cb0_048w) + cb0_049y) * cb0_048y) + _437), cb0_053w), cb0_054y)));
  float4 _563 = t0.Sample(s0, float2(min(max(((((((cb0_106z * (_459 - (_479 * select(_449, _448, cb0_108y)))) + cb0_106x) * cb0_048z) + cb0_049x) * cb0_048x) + _436), cb0_053z), cb0_054x), min(max(((((((cb0_106w * _497) + cb0_106y) * cb0_048w) + cb0_049y) * cb0_048y) + _437), cb0_053w), cb0_054y)));
  if (_489) {
    float _573 = saturate(((((_533.y * 0.5870000123977661f) - cb0_109y) + (_533.x * 0.29899999499320984f)) + (_533.z * 0.11400000005960464f)) * 10.0f);
    float _577 = (_573 * _573) * (3.0f - (_573 * 2.0f));
    _591 = ((((_533.x - _549.x) + (_577 * (_549.x - _533.x))) * cb0_109x) + _549.x);
    _592 = ((((_533.y - _563.y) + (_577 * (_563.y - _533.y))) * cb0_109x) + _563.y);
  } else {
    _591 = _549.x;
    _592 = _563.y;
  }
  float _595 = saturate(cb0_090x);
  float _597 = saturate(cb0_090y);
  if (_595 > 0.0f) {
    float _608 = saturate(((_591 * 0.29899999499320984f) + (_533.z * 0.11400000005960464f)) + (_592 * 0.5870000123977661f));
    float _609 = _608 * 2.0f;
    float _613 = ((_608 * saturate(1.0f - cb0_090z)) * _609) * (3.0f - _609);
    float _620 = max(sqrt(((_591 * _591) + (_533.z * _533.z)) + (_592 * _592)), 0.014999999664723873f);
    float _621 = _591 / _620;
    float _622 = _592 / _620;
    float _623 = _533.z / _620;
    float _633 = log2(_613);
    float _652 = ((_292 * _212) * _328) * _595;
    _663 = (((((lerp(_621, 1.0f, 0.25f)) * (((_597 * 0.17000000178813934f) + 0.029999999329447746f) + _613)) - _591) * _652) + _591);
    _664 = (((((((_597 * 0.18000000715255737f) + 0.05000000074505806f) + exp2(_633 * 0.8999999761581421f)) * (lerp(_622, 1.0f, 0.25f))) - _592) * _652) + _592);
    _665 = (((((((_597 * 0.17999999225139618f) + 0.07999999821186066f) + exp2(_633 * 0.949999988079071f)) * (lerp(_623, 1.0f, 0.25f))) - _533.z) * _652) + _533.z);
  } else {
    _663 = _591;
    _664 = _592;
    _665 = _533.z;
  }
  float _668 = saturate(cb0_091x);
  float _669 = _668 * _382;
  if (_668 > 0.0f) {
    float _680 = (sin(((_113 * 640.0f) + 640.0f) - (View_2376 * 10.0f)) * 0.5f) + 1.0f;
    _694 = ((((_680 * _663) - _663) * _669) + _663);
    _695 = ((((_680 * _664) - _664) * _669) + _664);
    _696 = ((((_680 * _665) - _665) * _669) + _665);
  } else {
    _694 = _663;
    _695 = _664;
    _696 = _665;
  ...
  float4 _721 = t1.Sample(s1, float2(min(max(((cb0_068z * _420) + cb0_069x), cb0_060z), cb0_061x), min(max(((cb0_068w * _421) + cb0_069y), cb0_060w), cb0_061y)));
  APPLY_BLOOM(_721);

  [branch]
  if (!((uint)(cb0_077z) == 0)) {
    bool _749 = ((uint)(cb0_077w) != 0);
    float4 _752 = t2.Sample(s2, float2(select(_749, _420, min(max(((cb0_076z * _420) + cb0_077x), cb0_075z), cb0_076x)), select(_749, _421, min(max(((cb0_076w * _421) + cb0_077y), cb0_075w), cb0_076y))));
    _760 = (_752.x + _721.x);
    _761 = (_752.y + _721.y);
    _762 = (_752.z + _721.z);
  } else {
  ...
  float _787 = TEXCOORD_1.z + -1.0f;
  float _789 = TEXCOORD_1.w + -1.0f;
  float _792 = (((cb0_082x * 2.0f) + _787) * cb0_080z) * cb0_080x;
  float _794 = (((cb0_082y * 2.0f) + _789) * cb0_080w) * cb0_080x;
  float _801 = 1.0f / ((((saturate(cb0_081w) * 9.0f) + 1.0f) * dot(float2(_792, _794), float2(_792, _794))) + 1.0f);
  float _802 = _801 * _801;
  float _803 = cb0_082z + 1.0f;
  float _831 = (((cb0_085x * 2.0f) + _787) * cb0_083z) * cb0_083x;
  float _833 = (((cb0_085y * 2.0f) + _789) * cb0_083w) * cb0_083x;
  float _840 = 1.0f / ((((saturate(cb0_084w) * 9.0f) + 1.0f) * dot(float2(_831, _833), float2(_831, _833))) + 1.0f);
  float _841 = _840 * _840;
  float _842 = cb0_085z + 1.0f;
  float _864 = ((((_760 + ((_694 * TEXCOORD_1.x) * cb0_078x)) * _379) * ((_802 * (_803 - cb0_081x)) + cb0_081x)) * ((_841 * (_842 - cb0_084x)) + cb0_084x)) * ((cb0_087x * _335) + cb0_087y);
  float _868 = ((((_761 + ((_695 * TEXCOORD_1.x) * cb0_078y)) * _379) * ((_802 * (_803 - cb0_081y)) + cb0_081y)) * ((_841 * (_842 - cb0_084y)) + cb0_084y)) * ((cb0_087x * _356) + cb0_087y);
  float _872 = ((((_762 + ((_696 * TEXCOORD_1.x) * cb0_078z)) * _379) * ((_802 * (_803 - cb0_081z)) + cb0_081z)) * ((_841 * (_842 - cb0_084z)) + cb0_084z)) * ((cb0_087x * _357) + cb0_087y);

  CAPTURE_UNTONEMAPPED(float3(_864, _868, _872));

  [branch]
  if (WUWA_TM_IS(1)) {
    _905 = ((((_864 * 1.3600000143051147f) + 0.04699999839067459f) * _864) / ((((_864 * 0.9599999785423279f) + 0.5600000023841858f) * _864) + 0.14000000059604645f));
    _906 = ((((_868 * 1.3600000143051147f) + 0.04699999839067459f) * _868) / ((((_868 * 0.9599999785423279f) + 0.5600000023841858f) * _868) + 0.14000000059604645f));
    _907 = ((((_872 * 1.3600000143051147f) + 0.04699999839067459f) * _872) / ((((_872 * 0.9599999785423279f) + 0.5600000023841858f) * _872) + 0.14000000059604645f));
  } else {
    _905 = _864;
    _906 = _868;
    _907 = _872;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _917 = 1.0049500465393066f - (0.16398000717163086f / (_905 + -0.19505000114440918f));
    float _918 = 1.0049500465393066f - (0.16398000717163086f / (_906 + -0.19505000114440918f));
    float _919 = 1.0049500465393066f - (0.16398000717163086f / (_907 + -0.19505000114440918f));
    _939 = (((_905 - _917) * select((_905 > 0.6000000238418579f), 0.0f, 1.0f)) + _917);
    _940 = (((_906 - _918) * select((_906 > 0.6000000238418579f), 0.0f, 1.0f)) + _918);
    _941 = (((_907 - _919) * select((_907 > 0.6000000238418579f), 0.0f, 1.0f)) + _919);
  } else {
    _939 = _905;
    _940 = _906;
    _941 = _907;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _947 = cb0_037y * _939;
    float _948 = cb0_037y * _940;
    float _949 = cb0_037y * _941;
    float _952 = cb0_037z * cb0_037w;
    float _962 = cb0_038y * cb0_038x;
    float _973 = cb0_038z * cb0_038x;
    float _980 = cb0_038y / cb0_038z;
    _988 = (((((_952 + _947) * _939) + _962) / (((_947 + cb0_037z) * _939) + _973)) - _980);
    _989 = (((((_952 + _948) * _940) + _962) / (((_948 + cb0_037z) * _940) + _973)) - _980);
    _990 = (((((_952 + _949) * _941) + _962) / (((_949 + cb0_037z) * _941) + _973)) - _980);
  } else {
    _988 = _939;
    _989 = _940;
    _990 = _941;
  ...
  if (!((uint)(cb0_097w) == 0)) {
    if (!(cb0_098x == 1.0f)) {
      float _999 = dot(float3(_988, _989, _990), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_999 <= 9.999999747378752e-05f)) {
        float _1008 = (pow(_988, 0.1593017578125f));
        float _1009 = (pow(_989, 0.1593017578125f));
        float _1010 = (pow(_990, 0.1593017578125f));
        float _1032 = exp2(log2(((_1008 * 18.8515625f) + 0.8359375f) / ((_1008 * 18.6875f) + 1.0f)) * 78.84375f);
        float _1033 = exp2(log2(((_1009 * 18.8515625f) + 0.8359375f) / ((_1009 * 18.6875f) + 1.0f)) * 78.84375f);
        float _1034 = exp2(log2(((_1010 * 18.8515625f) + 0.8359375f) / ((_1010 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_999 * 200.0f) > 1.0f) {
          float _1038 = 1.0f - cb0_098x;
          do {
            if (_1032 > 0.44028136134147644f) {
              float _1041 = _1032 + -0.44028136134147644f;
              _1047 = ((_1041 / ((_1041 * _1038) + 1.0f)) + 0.44028136134147644f);
            } else {
              _1047 = _1032;
            }
            do {
              if (_1033 > 0.44028136134147644f) {
                float _1229 = _1033 + -0.44028136134147644f;
                _1235 = ((_1229 / ((_1229 * _1038) + 1.0f)) + 0.44028136134147644f);
                if (_1034 > 0.44028136134147644f) {
                  float _1238 = _1034 + -0.44028136134147644f;
                  _1050 = ((_1238 / ((_1238 * _1038) + 1.0f)) + 0.44028136134147644f);
                  _1051 = _1235;
                  _1052 = _1047;
                } else {
                  _1050 = _1034;
              ...
              while(true) {
                float _1059 = (pow(_1052, 0.012683313339948654f));
                float _1060 = (pow(_1051, 0.012683313339948654f));
                float _1061 = (pow(_1050, 0.012683313339948654f));
                _1087 = exp2(log2(max((_1059 + -0.8359375f), 0.0f) / (18.8515625f - (_1059 * 18.6875f))) * 6.277394771575928f);
                _1088 = exp2(log2(max((_1060 + -0.8359375f), 0.0f) / (18.8515625f - (_1060 * 18.6875f))) * 6.277394771575928f);
                _1089 = exp2(log2(max((_1061 + -0.8359375f), 0.0f) / (18.8515625f - (_1061 * 18.6875f))) * 6.277394771575928f);
                break;
              }
            } while (false);
          } while (false);
  ...
  CLAMP_IF_SDR3(_1087, _1088, _1089);
  CAPTURE_TONEMAPPED(float3(_1087, _1088, _1089));

  float _1110 = (saturate((log2(_1087 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _1111 = (saturate((log2(_1088 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _1112 = (saturate((log2(_1089 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float4 _1113 = t5.Sample(s5, float3(_1110, _1111, _1112));

  HANDLE_LUT_OUTPUT(_1113);

  [branch]
  if (false) {
    float _1120 = select(((_160 * _141.x) > 0.0f), 0.0f, 1.0f);
    float4 _1121 = t6.Sample(s6, float3(_1110, _1111, _1112));
    _1135 = (lerp(_1113.x, _1121.x, _1120));
    _1136 = (lerp(_1113.y, _1121.y, _1120));
    _1137 = (lerp(_1113.z, _1121.z, _1120));
  } else {
    _1135 = _1113.x;
    _1136 = _1113.y;
    _1137 = _1113.z;
  }
  float _1138 = _1135 * 1.0499999523162842f;
  float _1139 = _1136 * 1.0499999523162842f;
  float _1140 = _1137 * 1.0499999523162842f;
  float _1148 = ((_335 * 0.00390625f) + -0.001953125f) + _1138;
  float _1149 = ((_356 * 0.00390625f) + -0.001953125f) + _1139;
  float _1150 = ((_357 * 0.00390625f) + -0.001953125f) + _1140;
  [branch]
  if (!((uint)(cb0_098w) == 0)) {
    float _1162 = (pow(_1148, 0.012683313339948654f));
    float _1163 = (pow(_1149, 0.012683313339948654f));
    float _1164 = (pow(_1150, 0.012683313339948654f));
    float _1197 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1162 + -0.8359375f)) / (18.8515625f - (_1162 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1198 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1163 + -0.8359375f)) / (18.8515625f - (_1163 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1199 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1164 + -0.8359375f)) / (18.8515625f - (_1164 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    _1225 = min((_1197 * 12.920000076293945f), ((exp2(log2(max(_1197, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1226 = min((_1198 * 12.920000076293945f), ((exp2(log2(max(_1198, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1227 = min((_1199 * 12.920000076293945f), ((exp2(log2(max(_1199, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _1225 = _1148;
    _1226 = _1149;
    _1227 = _1150;
  ...
  SV_Target.w = (dot(float3(_1138, _1139, _1140), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
