...
float4 main(
          ...
          do {
            ...
            do {
              if (_344 > 0.44028136134147644f) {
                float _588 = _344 + -0.44028136134147644f;
                _594 = ((_588 / ((_588 * _349) + 1.0f)) + 0.44028136134147644f);
                if (_345 > 0.44028136134147644f) {
                  float _597 = _345 + -0.44028136134147644f;
                  _361 = ((_597 / ((_597 * _349) + 1.0f)) + 0.44028136134147644f);
                  _362 = _594;
                  _363 = _358;
                } else {
                  _361 = _345;
  ...
  const float3 inverted = renodx::draw::InvertIntermediatePass(float3(_513, _514, _515));
  _513 = inverted.r; _514 = inverted.g; _515 = inverted.b;

  float _524 = ((((_514 * 587.0f) + (_513 * 299.0f)) + (_515 * 114.0f)) * 0.0010000000474974513f) - cb0_092y;
  float _531 = saturate(float(((int)(uint)((bool)(_524 > 0.0f))) - ((int)(uint)((bool)(_524 < 0.0f)))));
  float _538 = cb0_093x - _513;
  float _539 = cb0_093y - _514;
  float _540 = cb0_093z - _515;

  const float peak_scaling = RENODX_PEAK_NITS / RENODX_GAME_NITS;
  float _545 = peak_scaling * cb0_094x - _513;
  float _546 = peak_scaling * cb0_094y - _514;
  float _547 = peak_scaling * cb0_094z - _515;
  ...
  SV_Target.x = ((cb0_091w * (lerp(_564, _567, _531))) + _513);
  SV_Target.y = ((cb0_091w * (lerp(_565, _568, _531))) + _514);
  SV_Target.z = (((lerp(_566, _569, _531)) * cb0_091w) + _515);
