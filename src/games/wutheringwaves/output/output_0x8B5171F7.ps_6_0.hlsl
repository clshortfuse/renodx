          ...
          do {
            ...
            do {
              if (_966 > 0.44028136134147644f) {
                float _1162 = _966 + -0.44028136134147644f;
                _1168 = ((_1162 / ((_1162 * _971) + 1.0f)) + 0.44028136134147644f);
                if (_967 > 0.44028136134147644f) {
                  float _1171 = _967 + -0.44028136134147644f;
                  _983 = ((_1171 / ((_1171 * _971) + 1.0f)) + 0.44028136134147644f);
                  _984 = _1168;
                  _985 = _980;
                } else {
                  _983 = _967;
