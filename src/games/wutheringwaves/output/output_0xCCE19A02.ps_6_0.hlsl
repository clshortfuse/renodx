          ...
          do {
            ...
            do {
              if (_840 > 0.44028136134147644f) {
                float _1036 = _840 + -0.44028136134147644f;
                _1042 = ((_1036 / ((_1036 * _845) + 1.0f)) + 0.44028136134147644f);
                if (_841 > 0.44028136134147644f) {
                  float _1045 = _841 + -0.44028136134147644f;
                  _857 = ((_1045 / ((_1045 * _845) + 1.0f)) + 0.44028136134147644f);
                  _858 = _1042;
                  _859 = _854;
                } else {
                  _857 = _841;
