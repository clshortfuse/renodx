          ...
          do {
            ...
            do {
              if (_427 > 0.44028136134147644f) {
                float _623 = _427 + -0.44028136134147644f;
                _629 = ((_623 / ((_623 * _432) + 1.0f)) + 0.44028136134147644f);
                if (_428 > 0.44028136134147644f) {
                  float _632 = _428 + -0.44028136134147644f;
                  _444 = ((_632 / ((_632 * _432) + 1.0f)) + 0.44028136134147644f);
                  _445 = _629;
                  _446 = _441;
                } else {
                  _444 = _428;
