...
float4 main(
          ...
          do {
            ...
            do {
              if (_798 > 0.44028136134147644f) {
                float _1042 = _798 + -0.44028136134147644f;
                _1048 = ((_1042 / ((_1042 * _803) + 1.0f)) + 0.44028136134147644f);
                if (_799 > 0.44028136134147644f) {
                  float _1051 = _799 + -0.44028136134147644f;
                  _815 = ((_1051 / ((_1051 * _803) + 1.0f)) + 0.44028136134147644f);
                  _816 = _1048;
                  _817 = _812;
                } else {
                  _815 = _799;
  ...
  const float3 inverted = renodx::draw::InvertIntermediatePass(float3(_967, _968, _969));
  _967 = inverted.r; _968 = inverted.g; _969 = inverted.b;

  float _978 = ((((_968 * 587.0f) + (_967 * 299.0f)) + (_969 * 114.0f)) * 0.0010000000474974513f) - cb0_092y;
  float _985 = saturate(float(((int)(uint)((bool)(_978 > 0.0f))) - ((int)(uint)((bool)(_978 < 0.0f)))));
  float _992 = cb0_093x - _967;
  float _993 = cb0_093y - _968;
  float _994 = cb0_093z - _969;

  const float peak_scaling = RENODX_PEAK_NITS / RENODX_GAME_NITS;
  float _999 = peak_scaling * cb0_094x - _967;
  float _1000 = peak_scaling * cb0_094y - _968;
  float _1001 = peak_scaling * cb0_094z - _969;
  ...
  if (cb0_092x > 0.0f) {
    ...
    _1020 = (_994 * cb0_092x);
    _1021 = (_999 * cb0_092x);
    _1022 = (_1000 * cb0_092x);
    _1023 = (_1001 * cb0_092x);
  } else {
    float _1010 = abs(cb0_092x);
    _1018 = (_1010 * _999);
    _1019 = (_1010 * _1000);
    _1020 = (_1010 * _1001);
    _1021 = (_1010 * _992);
  ...
  SV_Target.x = ((cb0_091w * (lerp(_1018, _1021, _985))) + _967);
  SV_Target.y = ((cb0_091w * (lerp(_1019, _1022, _985))) + _968);
  SV_Target.z = (((lerp(_1020, _1023, _985)) * cb0_091w) + _969);
