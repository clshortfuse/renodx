...
float4 main(
  ...
  float4 _409 = t0.Sample(s0, float2(_407, _408));
  float _415 = saturate(cb0_090x);
  float _417 = saturate(cb0_090y);
  if (_415 > 0.0f) {
    float _428 = saturate(((_409.x * 0.29899999499320984f) + (_409.y * 0.5870000123977661f)) + (_409.z * 0.11400000005960464f));
    float _429 = _428 * 2.0f;
    float _433 = ((_428 * saturate(1.0f - cb0_090z)) * _429) * (3.0f - _429);
    float _440 = max(sqrt(((_409.x * _409.x) + (_409.y * _409.y)) + (_409.z * _409.z)), 0.014999999664723873f);
    float _441 = _409.x / _440;
    float _442 = _409.y / _440;
    float _443 = _409.z / _440;
    float _453 = log2(_433);
    float _472 = ((_290 * _210) * _326) * _415;
    _483 = (((((lerp(_441, 1.0f, 0.25f)) * (((_417 * 0.17000000178813934f) + 0.029999999329447746f) + _433)) - _409.x) * _472) + _409.x);
    _484 = (((((((_417 * 0.18000000715255737f) + 0.05000000074505806f) + exp2(_453 * 0.8999999761581421f)) * (lerp(_442, 1.0f, 0.25f))) - _409.y) * _472) + _409.y);
    _485 = (((((((_417 * 0.17999999225139618f) + 0.07999999821186066f) + exp2(_453 * 0.949999988079071f)) * (lerp(_443, 1.0f, 0.25f))) - _409.z) * _472) + _409.z);
  } else {
    _483 = _409.x;
    _484 = _409.y;
    _485 = _409.z;
  }
  float _487 = saturate(cb0_091x);
  float _488 = _487 * _380;
  if (_487 > 0.0f) {
    float _499 = (sin(((_111 * 640.0f) + 640.0f) - (View_2376 * 10.0f)) * 0.5f) + 1.0f;
  ...
  float4 _540 = t1.Sample(s1, float2(min(max(((cb0_068z * _407) + cb0_069x), cb0_060z), cb0_061x), min(max(((cb0_068w * _408) + cb0_069y), cb0_060w), cb0_061y)));
  APPLY_BLOOM(_540);

  [branch]
  if (!((uint)(cb0_077z) == 0)) {
    bool _568 = ((uint)(cb0_077w) != 0);
    float4 _571 = t2.Sample(s2, float2(select(_568, _407, min(max(((cb0_076z * _407) + cb0_077x), cb0_075z), cb0_076x)), select(_568, _408, min(max(((cb0_076w * _408) + cb0_077y), cb0_075w), cb0_076y))));
    _579 = (_571.x + _540.x);
    _580 = (_571.y + _540.y);
    _581 = (_571.z + _540.z);
  } else {
  ...
  float _606 = TEXCOORD_1.z + -1.0f;
  float _608 = TEXCOORD_1.w + -1.0f;
  float _611 = (((cb0_082x * 2.0f) + _606) * cb0_080z) * cb0_080x;
  float _613 = (((cb0_082y * 2.0f) + _608) * cb0_080w) * cb0_080x;
  float _620 = 1.0f / ((((saturate(cb0_081w) * 9.0f) + 1.0f) * dot(float2(_611, _613), float2(_611, _613))) + 1.0f);
  float _621 = _620 * _620;
  float _622 = cb0_082z + 1.0f;
  float _650 = (((cb0_085x * 2.0f) + _606) * cb0_083z) * cb0_083x;
  float _652 = (((cb0_085y * 2.0f) + _608) * cb0_083w) * cb0_083x;
  float _659 = 1.0f / ((((saturate(cb0_084w) * 9.0f) + 1.0f) * dot(float2(_650, _652), float2(_650, _652))) + 1.0f);
  float _660 = _659 * _659;
  float _661 = cb0_085z + 1.0f;
  float _673 = (((_579 + ((_513 * TEXCOORD_1.x) * cb0_078x)) * _377) * ((_621 * (_622 - cb0_081x)) + cb0_081x)) * ((_660 * (_661 - cb0_084x)) + cb0_084x);
  float _676 = (((_580 + ((_514 * TEXCOORD_1.x) * cb0_078y)) * _377) * ((_621 * (_622 - cb0_081y)) + cb0_081y)) * ((_660 * (_661 - cb0_084y)) + cb0_084y);
  float _679 = (((_581 + ((_515 * TEXCOORD_1.x) * cb0_078z)) * _377) * ((_621 * (_622 - cb0_081z)) + cb0_081z)) * ((_660 * (_661 - cb0_084z)) + cb0_084z);

  CAPTURE_UNTONEMAPPED(float3(_673, _676, _679));

  [branch]
  if (WUWA_TM_IS(1)) {
    _712 = ((((_673 * 1.3600000143051147f) + 0.04699999839067459f) * _673) / ((((_673 * 0.9599999785423279f) + 0.5600000023841858f) * _673) + 0.14000000059604645f));
    _713 = ((((_676 * 1.3600000143051147f) + 0.04699999839067459f) * _676) / ((((_676 * 0.9599999785423279f) + 0.5600000023841858f) * _676) + 0.14000000059604645f));
    _714 = ((((_679 * 1.3600000143051147f) + 0.04699999839067459f) * _679) / ((((_679 * 0.9599999785423279f) + 0.5600000023841858f) * _679) + 0.14000000059604645f));
  } else {
    _712 = _673;
    _713 = _676;
    _714 = _679;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _724 = 1.0049500465393066f - (0.16398000717163086f / (_712 + -0.19505000114440918f));
    float _725 = 1.0049500465393066f - (0.16398000717163086f / (_713 + -0.19505000114440918f));
    float _726 = 1.0049500465393066f - (0.16398000717163086f / (_714 + -0.19505000114440918f));
    _746 = (((_712 - _724) * select((_712 > 0.6000000238418579f), 0.0f, 1.0f)) + _724);
    _747 = (((_713 - _725) * select((_713 > 0.6000000238418579f), 0.0f, 1.0f)) + _725);
    _748 = (((_714 - _726) * select((_714 > 0.6000000238418579f), 0.0f, 1.0f)) + _726);
  } else {
    _746 = _712;
    _747 = _713;
    _748 = _714;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _754 = cb0_037y * _746;
    float _755 = cb0_037y * _747;
    float _756 = cb0_037y * _748;
    float _759 = cb0_037z * cb0_037w;
    float _769 = cb0_038y * cb0_038x;
    float _780 = cb0_038z * cb0_038x;
    float _787 = cb0_038y / cb0_038z;
    _795 = (((((_759 + _754) * _746) + _769) / (((_754 + cb0_037z) * _746) + _780)) - _787);
    _796 = (((((_759 + _755) * _747) + _769) / (((_755 + cb0_037z) * _747) + _780)) - _787);
    _797 = (((((_759 + _756) * _748) + _769) / (((_756 + cb0_037z) * _748) + _780)) - _787);
  } else {
    _795 = _746;
    _796 = _747;
    _797 = _748;
  ...
  if (!((uint)(cb0_097w) == 0)) {
    if (!(cb0_098x == 1.0f)) {
      float _806 = dot(float3(_795, _796, _797), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_806 <= 9.999999747378752e-05f)) {
        float _815 = (pow(_795, 0.1593017578125f));
        float _816 = (pow(_796, 0.1593017578125f));
        float _817 = (pow(_797, 0.1593017578125f));
        float _839 = exp2(log2(((_815 * 18.8515625f) + 0.8359375f) / ((_815 * 18.6875f) + 1.0f)) * 78.84375f);
        float _840 = exp2(log2(((_816 * 18.8515625f) + 0.8359375f) / ((_816 * 18.6875f) + 1.0f)) * 78.84375f);
        float _841 = exp2(log2(((_817 * 18.8515625f) + 0.8359375f) / ((_817 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_806 * 200.0f) > 1.0f) {
          float _845 = 1.0f - cb0_098x;
          do {
            if (_839 > 0.44028136134147644f) {
              float _848 = _839 + -0.44028136134147644f;
              _854 = ((_848 / ((_848 * _845) + 1.0f)) + 0.44028136134147644f);
            } else {
              _854 = _839;
            }
            do {
              if (_840 > 0.44028136134147644f) {
                float _1106 = _840 + -0.44028136134147644f;
                _1112 = ((_1106 / ((_1106 * _845) + 1.0f)) + 0.44028136134147644f);
                if (_841 > 0.44028136134147644f) {
                  float _1115 = _841 + -0.44028136134147644f;
                  _857 = ((_1115 / ((_1115 * _845) + 1.0f)) + 0.44028136134147644f);
                  _858 = _1112;
                  _859 = _854;
                } else {
                  _857 = _841;
              ...
              while(true) {
                float _866 = (pow(_859, 0.012683313339948654f));
                float _867 = (pow(_858, 0.012683313339948654f));
                float _868 = (pow(_857, 0.012683313339948654f));
                _894 = exp2(log2(max((_866 + -0.8359375f), 0.0f) / (18.8515625f - (_866 * 18.6875f))) * 6.277394771575928f);
                _895 = exp2(log2(max((_867 + -0.8359375f), 0.0f) / (18.8515625f - (_867 * 18.6875f))) * 6.277394771575928f);
                _896 = exp2(log2(max((_868 + -0.8359375f), 0.0f) / (18.8515625f - (_868 * 18.6875f))) * 6.277394771575928f);
                break;
              }
            } while (false);
          } while (false);
  ...
  CLAMP_IF_SDR3(_894, _895, _896);
  CAPTURE_TONEMAPPED(float3(_894, _895, _896));

  float _917 = (saturate((log2(_894 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _918 = (saturate((log2(_895 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _919 = (saturate((log2(_896 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float4 _920 = t5.Sample(s5, float3(_917, _918, _919));

  HANDLE_LUT_OUTPUT(_920);

  [branch]
  if (false) {
    float _927 = select(((_158 * _139.x) > 0.0f), 0.0f, 1.0f);
    float4 _928 = t6.Sample(s6, float3(_917, _918, _919));
    _942 = (lerp(_920.x, _928.x, _927));
    _943 = (lerp(_920.y, _928.y, _927));
    _944 = (lerp(_920.z, _928.z, _927));
  } else {
    _942 = _920.x;
    _943 = _920.y;
    _944 = _920.z;
  }
  float _945 = _942 * 1.0499999523162842f;
  float _946 = _943 * 1.0499999523162842f;
  float _947 = _944 * 1.0499999523162842f;
  float _955 = ((_333 * 0.00390625f) + -0.001953125f) + _945;
  float _956 = ((_354 * 0.00390625f) + -0.001953125f) + _946;
  float _957 = ((_355 * 0.00390625f) + -0.001953125f) + _947;
  [branch]
  if (!((uint)(cb0_098w) == 0)) {
    float _969 = (pow(_955, 0.012683313339948654f));
    float _970 = (pow(_956, 0.012683313339948654f));
    float _971 = (pow(_957, 0.012683313339948654f));
    float _1004 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_969 + -0.8359375f)) / (18.8515625f - (_969 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1005 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_970 + -0.8359375f)) / (18.8515625f - (_970 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1006 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_971 + -0.8359375f)) / (18.8515625f - (_971 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    _1032 = min((_1004 * 12.920000076293945f), ((exp2(log2(max(_1004, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1033 = min((_1005 * 12.920000076293945f), ((exp2(log2(max(_1005, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1034 = min((_1006 * 12.920000076293945f), ((exp2(log2(max(_1006, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _1032 = _955;
    _1033 = _956;
    _1034 = _957;
  ...
  const float3 inverted = renodx::draw::InvertIntermediatePass(float3(_1032, _1033, _1034));
  _1032 = inverted.r; _1033 = inverted.g; _1034 = inverted.b;

  float _1043 = ((((_1033 * 587.0f) + (_1032 * 299.0f)) + (_1034 * 114.0f)) * 0.0010000000474974513f) - cb0_100z;
  float _1050 = saturate(float(((int)(uint)((bool)(_1043 > 0.0f))) - ((int)(uint)((bool)(_1043 < 0.0f)))));
  float _1057 = cb0_101x - _1032;
  float _1058 = cb0_101y - _1033;
  float _1059 = cb0_101z - _1034;

  const float peak_scaling = RENODX_PEAK_NITS / RENODX_GAME_NITS;
  float _1064 = peak_scaling * cb0_102x - _1032;
  float _1065 = peak_scaling * cb0_102y - _1033;
  float _1066 = peak_scaling * cb0_102z - _1034;

  [branch]
  if (cb0_100y > 0.0f) {
    _1083 = (_1057 * cb0_100y);
    _1084 = (_1058 * cb0_100y);
    _1085 = (_1059 * cb0_100y);
    _1086 = (_1064 * cb0_100y);
    _1087 = (_1065 * cb0_100y);
    _1088 = (_1066 * cb0_100y);
  } else {
    float _1075 = abs(cb0_100y);
    _1083 = (_1075 * _1064);
    _1084 = (_1075 * _1065);
    _1085 = (_1075 * _1066);
    _1086 = (_1075 * _1057);
  ...
  SV_Target.x = (((lerp(_1083, _1086, _1050)) * cb0_100x) + _1032);
  SV_Target.y = (((lerp(_1084, _1087, _1050)) * cb0_100x) + _1033);
  SV_Target.z = (((lerp(_1085, _1088, _1050)) * cb0_100x) + _1034);

  SV_Target.rgb = renodx::draw::RenderIntermediatePass(SV_Target.rgb);

  SV_Target.w = (dot(float3(_945, _946, _947), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
