...
float4 main(
  ...
  [branch]
  if (!((uint)(cb0_077z) == 0)) {
    float4 _748 = t2.Sample(s2, float2(min(max(((cb0_076z * _420) + cb0_077x), cb0_075z), cb0_076x), min(max(((cb0_076w * _421) + cb0_077y), cb0_075w), cb0_076y)));
    _756 = (_748.x + _721.x);
    _757 = (_748.y + _721.y);
    _758 = (_748.z + _721.z);
  } else {
  ...
  float _783 = TEXCOORD_1.z + -1.0f;
  float _785 = TEXCOORD_1.w + -1.0f;
  float _788 = (((cb0_082x * 2.0f) + _783) * cb0_080z) * cb0_080x;
  float _790 = (((cb0_082y * 2.0f) + _785) * cb0_080w) * cb0_080x;
  float _797 = 1.0f / ((((saturate(cb0_081w) * 9.0f) + 1.0f) * dot(float2(_788, _790), float2(_788, _790))) + 1.0f);
  float _798 = _797 * _797;
  float _799 = cb0_082z + 1.0f;
  float _827 = (((cb0_085x * 2.0f) + _783) * cb0_083z) * cb0_083x;
  float _829 = (((cb0_085y * 2.0f) + _785) * cb0_083w) * cb0_083x;
  float _836 = 1.0f / ((((saturate(cb0_084w) * 9.0f) + 1.0f) * dot(float2(_827, _829), float2(_827, _829))) + 1.0f);
  float _837 = _836 * _836;
  float _838 = cb0_085z + 1.0f;
  float _860 = ((((_756 + ((_694 * TEXCOORD_1.x) * cb0_078x)) * _379) * ((_798 * (_799 - cb0_081x)) + cb0_081x)) * ((_837 * (_838 - cb0_084x)) + cb0_084x)) * ((cb0_087x * _335) + cb0_087y);
  float _864 = ((((_757 + ((_695 * TEXCOORD_1.x) * cb0_078y)) * _379) * ((_798 * (_799 - cb0_081y)) + cb0_081y)) * ((_837 * (_838 - cb0_084y)) + cb0_084y)) * ((cb0_087x * _356) + cb0_087y);
  float _868 = ((((_758 + ((_696 * TEXCOORD_1.x) * cb0_078z)) * _379) * ((_798 * (_799 - cb0_081z)) + cb0_081z)) * ((_837 * (_838 - cb0_084z)) + cb0_084z)) * ((cb0_087x * _357) + cb0_087y);

  CAPTURE_UNTONEMAPPED(float3(_860, _864, _868));

  [branch]
  if (WUWA_TM_IS(1)) {
    _901 = ((((_860 * 1.3600000143051147f) + 0.04699999839067459f) * _860) / ((((_860 * 0.9599999785423279f) + 0.5600000023841858f) * _860) + 0.14000000059604645f));
    _902 = ((((_864 * 1.3600000143051147f) + 0.04699999839067459f) * _864) / ((((_864 * 0.9599999785423279f) + 0.5600000023841858f) * _864) + 0.14000000059604645f));
    _903 = ((((_868 * 1.3600000143051147f) + 0.04699999839067459f) * _868) / ((((_868 * 0.9599999785423279f) + 0.5600000023841858f) * _868) + 0.14000000059604645f));
  } else {
    _901 = _860;
    _902 = _864;
    _903 = _868;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _913 = 1.0049500465393066f - (0.16398000717163086f / (_901 + -0.19505000114440918f));
    float _914 = 1.0049500465393066f - (0.16398000717163086f / (_902 + -0.19505000114440918f));
    float _915 = 1.0049500465393066f - (0.16398000717163086f / (_903 + -0.19505000114440918f));
    _935 = (((_901 - _913) * select((_901 > 0.6000000238418579f), 0.0f, 1.0f)) + _913);
    _936 = (((_902 - _914) * select((_902 > 0.6000000238418579f), 0.0f, 1.0f)) + _914);
    _937 = (((_903 - _915) * select((_903 > 0.6000000238418579f), 0.0f, 1.0f)) + _915);
  } else {
    _935 = _901;
    _936 = _902;
    _937 = _903;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _943 = cb0_037y * _935;
    float _944 = cb0_037y * _936;
    float _945 = cb0_037y * _937;
    float _948 = cb0_037z * cb0_037w;
    float _958 = cb0_038y * cb0_038x;
    float _969 = cb0_038z * cb0_038x;
    float _976 = cb0_038y / cb0_038z;
    _984 = (((((_948 + _943) * _935) + _958) / (((_943 + cb0_037z) * _935) + _969)) - _976);
    _985 = (((((_948 + _944) * _936) + _958) / (((_944 + cb0_037z) * _936) + _969)) - _976);
    _986 = (((((_948 + _945) * _937) + _958) / (((_945 + cb0_037z) * _937) + _969)) - _976);
  } else {
    _984 = _935;
    _985 = _936;
    _986 = _937;
  ...
  if (!((uint)(cb0_097w) == 0)) {
    if (!(cb0_098x == 1.0f)) {
      float _995 = dot(float3(_984, _985, _986), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_995 <= 9.999999747378752e-05f)) {
        float _1004 = (pow(_984, 0.1593017578125f));
        float _1005 = (pow(_985, 0.1593017578125f));
        float _1006 = (pow(_986, 0.1593017578125f));
        float _1028 = exp2(log2(((_1004 * 18.8515625f) + 0.8359375f) / ((_1004 * 18.6875f) + 1.0f)) * 78.84375f);
        float _1029 = exp2(log2(((_1005 * 18.8515625f) + 0.8359375f) / ((_1005 * 18.6875f) + 1.0f)) * 78.84375f);
        float _1030 = exp2(log2(((_1006 * 18.8515625f) + 0.8359375f) / ((_1006 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_995 * 200.0f) > 1.0f) {
          float _1034 = 1.0f - cb0_098x;
          do {
            if (_1028 > 0.44028136134147644f) {
              float _1037 = _1028 + -0.44028136134147644f;
              _1043 = ((_1037 / ((_1037 * _1034) + 1.0f)) + 0.44028136134147644f);
            } else {
              _1043 = _1028;
            }
            do {
              if (_1029 > 0.44028136134147644f) {
                float _1225 = _1029 + -0.44028136134147644f;
                _1231 = ((_1225 / ((_1225 * _1034) + 1.0f)) + 0.44028136134147644f);
                if (_1030 > 0.44028136134147644f) {
                  float _1234 = _1030 + -0.44028136134147644f;
                  _1046 = ((_1234 / ((_1234 * _1034) + 1.0f)) + 0.44028136134147644f);
                  _1047 = _1231;
                  _1048 = _1043;
                } else {
                  _1046 = _1030;
              ...
              while(true) {
                float _1055 = (pow(_1048, 0.012683313339948654f));
                float _1056 = (pow(_1047, 0.012683313339948654f));
                float _1057 = (pow(_1046, 0.012683313339948654f));
                _1083 = exp2(log2(max((_1055 + -0.8359375f), 0.0f) / (18.8515625f - (_1055 * 18.6875f))) * 6.277394771575928f);
                _1084 = exp2(log2(max((_1056 + -0.8359375f), 0.0f) / (18.8515625f - (_1056 * 18.6875f))) * 6.277394771575928f);
                _1085 = exp2(log2(max((_1057 + -0.8359375f), 0.0f) / (18.8515625f - (_1057 * 18.6875f))) * 6.277394771575928f);
                break;
              }
            } while (false);
          } while (false);
  ...
  CLAMP_IF_SDR3(_1083, _1084, _1085);
  CAPTURE_TONEMAPPED(float3(_1083, _1084, _1085));

  float _1106 = (saturate((log2(_1083 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _1107 = (saturate((log2(_1084 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _1108 = (saturate((log2(_1085 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float4 _1109 = t5.Sample(s5, float3(_1106, _1107, _1108));

  HANDLE_LUT_OUTPUT(_1109);

  [branch]
  if (false) {
    float _1116 = select(((_160 * _141.x) > 0.0f), 0.0f, 1.0f);
    float4 _1117 = t6.Sample(s6, float3(_1106, _1107, _1108));
    _1131 = (lerp(_1109.x, _1117.x, _1116));
    _1132 = (lerp(_1109.y, _1117.y, _1116));
    _1133 = (lerp(_1109.z, _1117.z, _1116));
  } else {
    _1131 = _1109.x;
    _1132 = _1109.y;
    _1133 = _1109.z;
  }
  float _1134 = _1131 * 1.0499999523162842f;
  float _1135 = _1132 * 1.0499999523162842f;
  float _1136 = _1133 * 1.0499999523162842f;
  float _1144 = ((_335 * 0.00390625f) + -0.001953125f) + _1134;
  float _1145 = ((_356 * 0.00390625f) + -0.001953125f) + _1135;
  float _1146 = ((_357 * 0.00390625f) + -0.001953125f) + _1136;
  [branch]
  if (!((uint)(cb0_098w) == 0)) {
    float _1158 = (pow(_1144, 0.012683313339948654f));
    float _1159 = (pow(_1145, 0.012683313339948654f));
    float _1160 = (pow(_1146, 0.012683313339948654f));
    float _1193 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1158 + -0.8359375f)) / (18.8515625f - (_1158 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1194 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1159 + -0.8359375f)) / (18.8515625f - (_1159 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1195 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1160 + -0.8359375f)) / (18.8515625f - (_1160 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    _1221 = min((_1193 * 12.920000076293945f), ((exp2(log2(max(_1193, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1222 = min((_1194 * 12.920000076293945f), ((exp2(log2(max(_1194, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1223 = min((_1195 * 12.920000076293945f), ((exp2(log2(max(_1195, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _1221 = _1144;
    _1222 = _1145;
    _1223 = _1146;
  ...
  SV_Target.w = (dot(float3(_1134, _1135, _1136), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
