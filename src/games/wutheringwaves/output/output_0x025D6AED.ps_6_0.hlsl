...
float4 main(
  ...
  float _693 = (((_599 + ((_537 * TEXCOORD_1.x) * cb0_078x)) * _379) * ((_641 * (_642 - cb0_081x)) + cb0_081x)) * ((_680 * (_681 - cb0_084x)) + cb0_084x);
  float _696 = (((_600 + ((_538 * TEXCOORD_1.x) * cb0_078y)) * _379) * ((_641 * (_642 - cb0_081y)) + cb0_081y)) * ((_680 * (_681 - cb0_084y)) + cb0_084y);
  float _699 = (((_601 + ((_539 * TEXCOORD_1.x) * cb0_078z)) * _379) * ((_641 * (_642 - cb0_081z)) + cb0_081z)) * ((_680 * (_681 - cb0_084z)) + cb0_084z);

  CAPTURE_UNTONEMAPPED(float3(_693, _696, _699));

  [branch]
  if (WUWA_TM_IS(1)) {
    _732 = ((((_693 * 1.3600000143051147f) + 0.04699999839067459f) * _693) / ((((_693 * 0.9599999785423279f) + 0.5600000023841858f) * _693) + 0.14000000059604645f));
    _733 = ((((_696 * 1.3600000143051147f) + 0.04699999839067459f) * _696) / ((((_696 * 0.9599999785423279f) + 0.5600000023841858f) * _696) + 0.14000000059604645f));
    _734 = ((((_699 * 1.3600000143051147f) + 0.04699999839067459f) * _699) / ((((_699 * 0.9599999785423279f) + 0.5600000023841858f) * _699) + 0.14000000059604645f));
  } else {
    _732 = _693;
    _733 = _696;
    _734 = _699;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _744 = 1.0049500465393066f - (0.16398000717163086f / (_732 + -0.19505000114440918f));
    float _745 = 1.0049500465393066f - (0.16398000717163086f / (_733 + -0.19505000114440918f));
    float _746 = 1.0049500465393066f - (0.16398000717163086f / (_734 + -0.19505000114440918f));
    _766 = (((_732 - _744) * select((_732 > 0.6000000238418579f), 0.0f, 1.0f)) + _744);
    _767 = (((_733 - _745) * select((_733 > 0.6000000238418579f), 0.0f, 1.0f)) + _745);
    _768 = (((_734 - _746) * select((_734 > 0.6000000238418579f), 0.0f, 1.0f)) + _746);
  } else {
    _766 = _732;
    _767 = _733;
    _768 = _734;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _774 = cb0_037y * _766;
    float _775 = cb0_037y * _767;
    float _776 = cb0_037y * _768;
    float _779 = cb0_037z * cb0_037w;
    float _789 = cb0_038y * cb0_038x;
    float _800 = cb0_038z * cb0_038x;
    float _807 = cb0_038y / cb0_038z;
    _815 = (((((_779 + _774) * _766) + _789) / (((_774 + cb0_037z) * _766) + _800)) - _807);
    _816 = (((((_779 + _775) * _767) + _789) / (((_775 + cb0_037z) * _767) + _800)) - _807);
    _817 = (((((_779 + _776) * _768) + _789) / (((_776 + cb0_037z) * _768) + _800)) - _807);
  } else {
    _815 = _766;
    _816 = _767;
    _817 = _768;
  ...
  if (!((uint)(cb0_097w) == 0)) {
    if (!(cb0_098x == 1.0f)) {
      float _826 = dot(float3(_815, _816, _817), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_826 <= 9.999999747378752e-05f)) {
        float _835 = (pow(_815, 0.1593017578125f));
        float _836 = (pow(_816, 0.1593017578125f));
        float _837 = (pow(_817, 0.1593017578125f));
        float _859 = exp2(log2(((_835 * 18.8515625f) + 0.8359375f) / ((_835 * 18.6875f) + 1.0f)) * 78.84375f);
        float _860 = exp2(log2(((_836 * 18.8515625f) + 0.8359375f) / ((_836 * 18.6875f) + 1.0f)) * 78.84375f);
        float _861 = exp2(log2(((_837 * 18.8515625f) + 0.8359375f) / ((_837 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_826 * 200.0f) > 1.0f) {
          float _865 = 1.0f - cb0_098x;
          do {
            if (_859 > 0.44028136134147644f) {
              float _868 = _859 + -0.44028136134147644f;
              _874 = ((_868 / ((_868 * _865) + 1.0f)) + 0.44028136134147644f);
            } else {
              _874 = _859;
            }
            do {
              if (_860 > 0.44028136134147644f) {
                float _1056 = _860 + -0.44028136134147644f;
                _1062 = ((_1056 / ((_1056 * _865) + 1.0f)) + 0.44028136134147644f);
                if (_861 > 0.44028136134147644f) {
                  float _1065 = _861 + -0.44028136134147644f;
                  _877 = ((_1065 / ((_1065 * _865) + 1.0f)) + 0.44028136134147644f);
                  _878 = _1062;
                  _879 = _874;
                } else {
                  _877 = _861;
              ...
              while(true) {
                float _886 = (pow(_879, 0.012683313339948654f));
                float _887 = (pow(_878, 0.012683313339948654f));
                float _888 = (pow(_877, 0.012683313339948654f));
                _914 = exp2(log2(max((_886 + -0.8359375f), 0.0f) / (18.8515625f - (_886 * 18.6875f))) * 6.277394771575928f);
                _915 = exp2(log2(max((_887 + -0.8359375f), 0.0f) / (18.8515625f - (_887 * 18.6875f))) * 6.277394771575928f);
                _916 = exp2(log2(max((_888 + -0.8359375f), 0.0f) / (18.8515625f - (_888 * 18.6875f))) * 6.277394771575928f);
                break;
              }
            } while (false);
          } while (false);
  ...
  CLAMP_IF_SDR3(_914, _915, _916);
  CAPTURE_TONEMAPPED(float3(_914, _915, _916));

  float _937 = (saturate((log2(_914 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _938 = (saturate((log2(_915 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _939 = (saturate((log2(_916 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float4 _940 = t5.Sample(s5, float3(_937, _938, _939));

  HANDLE_LUT_OUTPUT(_940);

  [branch]
  if (false) {
    float _947 = select(((_160 * _141.x) > 0.0f), 0.0f, 1.0f);
    float4 _948 = t6.Sample(s6, float3(_937, _938, _939));
    _962 = (lerp(_940.x, _948.x, _947));
    _963 = (lerp(_940.y, _948.y, _947));
    _964 = (lerp(_940.z, _948.z, _947));
  } else {
    _962 = _940.x;
    _963 = _940.y;
    _964 = _940.z;
  }
  float _965 = _962 * 1.0499999523162842f;
  float _966 = _963 * 1.0499999523162842f;
  float _967 = _964 * 1.0499999523162842f;
  float _975 = ((_335 * 0.00390625f) + -0.001953125f) + _965;
  float _976 = ((_356 * 0.00390625f) + -0.001953125f) + _966;
  float _977 = ((_357 * 0.00390625f) + -0.001953125f) + _967;
  [branch]
  if (!((uint)(cb0_098w) == 0)) {
    float _989 = (pow(_975, 0.012683313339948654f));
    float _990 = (pow(_976, 0.012683313339948654f));
    float _991 = (pow(_977, 0.012683313339948654f));
    float _1024 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_989 + -0.8359375f)) / (18.8515625f - (_989 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1025 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_990 + -0.8359375f)) / (18.8515625f - (_990 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1026 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_991 + -0.8359375f)) / (18.8515625f - (_991 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    _1052 = min((_1024 * 12.920000076293945f), ((exp2(log2(max(_1024, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  ...
  SV_Target.w = (dot(float3(_965, _966, _967), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
