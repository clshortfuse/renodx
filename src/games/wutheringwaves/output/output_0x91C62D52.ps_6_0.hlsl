...
float4 main(
  ...
  [branch]
  if (!((uint)(cb0_077z) == 0)) {
    float4 _567 = t2.Sample(s2, float2(min(max(((cb0_076z * _407) + cb0_077x), cb0_075z), cb0_076x), min(max(((cb0_076w * _408) + cb0_077y), cb0_075w), cb0_076y)));
    _575 = (_567.x + _540.x);
    _576 = (_567.y + _540.y);
    _577 = (_567.z + _540.z);
  } else {
  ...
  float _602 = TEXCOORD_1.z + -1.0f;
  float _604 = TEXCOORD_1.w + -1.0f;
  float _607 = (((cb0_082x * 2.0f) + _602) * cb0_080z) * cb0_080x;
  float _609 = (((cb0_082y * 2.0f) + _604) * cb0_080w) * cb0_080x;
  float _616 = 1.0f / ((((saturate(cb0_081w) * 9.0f) + 1.0f) * dot(float2(_607, _609), float2(_607, _609))) + 1.0f);
  float _617 = _616 * _616;
  float _618 = cb0_082z + 1.0f;
  float _646 = (((cb0_085x * 2.0f) + _602) * cb0_083z) * cb0_083x;
  float _648 = (((cb0_085y * 2.0f) + _604) * cb0_083w) * cb0_083x;
  float _655 = 1.0f / ((((saturate(cb0_084w) * 9.0f) + 1.0f) * dot(float2(_646, _648), float2(_646, _648))) + 1.0f);
  float _656 = _655 * _655;
  float _657 = cb0_085z + 1.0f;
  float _669 = (((_575 + ((_513 * TEXCOORD_1.x) * cb0_078x)) * _377) * ((_617 * (_618 - cb0_081x)) + cb0_081x)) * ((_656 * (_657 - cb0_084x)) + cb0_084x);
  float _672 = (((_576 + ((_514 * TEXCOORD_1.x) * cb0_078y)) * _377) * ((_617 * (_618 - cb0_081y)) + cb0_081y)) * ((_656 * (_657 - cb0_084y)) + cb0_084y);
  float _675 = (((_577 + ((_515 * TEXCOORD_1.x) * cb0_078z)) * _377) * ((_617 * (_618 - cb0_081z)) + cb0_081z)) * ((_656 * (_657 - cb0_084z)) + cb0_084z);

  CAPTURE_UNTONEMAPPED(float3(_669, _672, _675));

  [branch]
  if (WUWA_TM_IS(1)) {
    _708 = ((((_669 * 1.3600000143051147f) + 0.04699999839067459f) * _669) / ((((_669 * 0.9599999785423279f) + 0.5600000023841858f) * _669) + 0.14000000059604645f));
    _709 = ((((_672 * 1.3600000143051147f) + 0.04699999839067459f) * _672) / ((((_672 * 0.9599999785423279f) + 0.5600000023841858f) * _672) + 0.14000000059604645f));
    _710 = ((((_675 * 1.3600000143051147f) + 0.04699999839067459f) * _675) / ((((_675 * 0.9599999785423279f) + 0.5600000023841858f) * _675) + 0.14000000059604645f));
  } else {
    _708 = _669;
    _709 = _672;
    _710 = _675;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _720 = 1.0049500465393066f - (0.16398000717163086f / (_708 + -0.19505000114440918f));
    float _721 = 1.0049500465393066f - (0.16398000717163086f / (_709 + -0.19505000114440918f));
    float _722 = 1.0049500465393066f - (0.16398000717163086f / (_710 + -0.19505000114440918f));
    _742 = (((_708 - _720) * select((_708 > 0.6000000238418579f), 0.0f, 1.0f)) + _720);
    _743 = (((_709 - _721) * select((_709 > 0.6000000238418579f), 0.0f, 1.0f)) + _721);
    _744 = (((_710 - _722) * select((_710 > 0.6000000238418579f), 0.0f, 1.0f)) + _722);
  } else {
    _742 = _708;
    _743 = _709;
    _744 = _710;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _750 = cb0_037y * _742;
    float _751 = cb0_037y * _743;
    float _752 = cb0_037y * _744;
    float _755 = cb0_037z * cb0_037w;
    float _765 = cb0_038y * cb0_038x;
    float _776 = cb0_038z * cb0_038x;
    float _783 = cb0_038y / cb0_038z;
    _791 = (((((_755 + _750) * _742) + _765) / (((_750 + cb0_037z) * _742) + _776)) - _783);
    _792 = (((((_755 + _751) * _743) + _765) / (((_751 + cb0_037z) * _743) + _776)) - _783);
    _793 = (((((_755 + _752) * _744) + _765) / (((_752 + cb0_037z) * _744) + _776)) - _783);
  } else {
    _791 = _742;
    _792 = _743;
    _793 = _744;
  ...
  if (!((uint)(cb0_097w) == 0)) {
    if (!(cb0_098x == 1.0f)) {
      float _802 = dot(float3(_791, _792, _793), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_802 <= 9.999999747378752e-05f)) {
        float _811 = (pow(_791, 0.1593017578125f));
        float _812 = (pow(_792, 0.1593017578125f));
        float _813 = (pow(_793, 0.1593017578125f));
        float _835 = exp2(log2(((_811 * 18.8515625f) + 0.8359375f) / ((_811 * 18.6875f) + 1.0f)) * 78.84375f);
        float _836 = exp2(log2(((_812 * 18.8515625f) + 0.8359375f) / ((_812 * 18.6875f) + 1.0f)) * 78.84375f);
        float _837 = exp2(log2(((_813 * 18.8515625f) + 0.8359375f) / ((_813 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_802 * 200.0f) > 1.0f) {
          float _841 = 1.0f - cb0_098x;
          do {
            if (_835 > 0.44028136134147644f) {
              float _844 = _835 + -0.44028136134147644f;
              _850 = ((_844 / ((_844 * _841) + 1.0f)) + 0.44028136134147644f);
            } else {
              _850 = _835;
            }
            do {
              if (_836 > 0.44028136134147644f) {
                float _1102 = _836 + -0.44028136134147644f;
                _1108 = ((_1102 / ((_1102 * _841) + 1.0f)) + 0.44028136134147644f);
                if (_837 > 0.44028136134147644f) {
                  float _1111 = _837 + -0.44028136134147644f;
                  _853 = ((_1111 / ((_1111 * _841) + 1.0f)) + 0.44028136134147644f);
                  _854 = _1108;
                  _855 = _850;
                } else {
                  _853 = _837;
              ...
              while(true) {
                float _862 = (pow(_855, 0.012683313339948654f));
                float _863 = (pow(_854, 0.012683313339948654f));
                float _864 = (pow(_853, 0.012683313339948654f));
                _890 = exp2(log2(max((_862 + -0.8359375f), 0.0f) / (18.8515625f - (_862 * 18.6875f))) * 6.277394771575928f);
                _891 = exp2(log2(max((_863 + -0.8359375f), 0.0f) / (18.8515625f - (_863 * 18.6875f))) * 6.277394771575928f);
                _892 = exp2(log2(max((_864 + -0.8359375f), 0.0f) / (18.8515625f - (_864 * 18.6875f))) * 6.277394771575928f);
                break;
              }
            } while (false);
          } while (false);
  ...
  CLAMP_IF_SDR3(_890, _891, _892);
  CAPTURE_TONEMAPPED(float3(_890, _891, _892));

  float _913 = (saturate((log2(_890 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _914 = (saturate((log2(_891 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _915 = (saturate((log2(_892 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float4 _916 = t5.Sample(s5, float3(_913, _914, _915));

  HANDLE_LUT_OUTPUT(_916);

  [branch]
  if (false) {
    float _923 = select(((_158 * _139.x) > 0.0f), 0.0f, 1.0f);
    float4 _924 = t6.Sample(s6, float3(_913, _914, _915));
    _938 = (lerp(_916.x, _924.x, _923));
    _939 = (lerp(_916.y, _924.y, _923));
    _940 = (lerp(_916.z, _924.z, _923));
  } else {
    _938 = _916.x;
    _939 = _916.y;
    _940 = _916.z;
  }
  float _941 = _938 * 1.0499999523162842f;
  float _942 = _939 * 1.0499999523162842f;
  float _943 = _940 * 1.0499999523162842f;
  float _951 = ((_333 * 0.00390625f) + -0.001953125f) + _941;
  float _952 = ((_354 * 0.00390625f) + -0.001953125f) + _942;
  float _953 = ((_355 * 0.00390625f) + -0.001953125f) + _943;
  [branch]
  if (!((uint)(cb0_098w) == 0)) {
    float _965 = (pow(_951, 0.012683313339948654f));
    float _966 = (pow(_952, 0.012683313339948654f));
    float _967 = (pow(_953, 0.012683313339948654f));
    float _1000 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_965 + -0.8359375f)) / (18.8515625f - (_965 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1001 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_966 + -0.8359375f)) / (18.8515625f - (_966 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1002 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_967 + -0.8359375f)) / (18.8515625f - (_967 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    _1028 = min((_1000 * 12.920000076293945f), ((exp2(log2(max(_1000, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1029 = min((_1001 * 12.920000076293945f), ((exp2(log2(max(_1001, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1030 = min((_1002 * 12.920000076293945f), ((exp2(log2(max(_1002, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _1028 = _951;
    _1029 = _952;
    _1030 = _953;
  ...
  const float3 inverted = renodx::draw::InvertIntermediatePass(float3(_1028, _1029, _1030));
  _1028 = inverted.r; _1029 = inverted.g; _1030 = inverted.b;

  float _1039 = ((((_1029 * 587.0f) + (_1028 * 299.0f)) + (_1030 * 114.0f)) * 0.0010000000474974513f) - cb0_100z;
  float _1046 = saturate(float(((int)(uint)((bool)(_1039 > 0.0f))) - ((int)(uint)((bool)(_1039 < 0.0f)))));
  float _1053 = cb0_101x - _1028;
  float _1054 = cb0_101y - _1029;
  float _1055 = cb0_101z - _1030;

  const float peak_scaling = RENODX_PEAK_NITS / RENODX_GAME_NITS;
  float _1060 = peak_scaling * cb0_102x - _1028;
  float _1061 = peak_scaling * cb0_102y - _1029;
  float _1062 = peak_scaling * cb0_102z - _1030;

  [branch]
  if (cb0_100y > 0.0f) {
    _1079 = (_1053 * cb0_100y);
    _1080 = (_1054 * cb0_100y);
    _1081 = (_1055 * cb0_100y);
    _1082 = (_1060 * cb0_100y);
    _1083 = (_1061 * cb0_100y);
    _1084 = (_1062 * cb0_100y);
  } else {
    float _1071 = abs(cb0_100y);
    _1079 = (_1071 * _1060);
    _1080 = (_1071 * _1061);
    _1081 = (_1071 * _1062);
    _1082 = (_1071 * _1053);
  ...
  SV_Target.x = (((lerp(_1079, _1082, _1046)) * cb0_100x) + _1028);
  SV_Target.y = (((lerp(_1080, _1083, _1046)) * cb0_100x) + _1029);
  SV_Target.z = (((lerp(_1081, _1084, _1046)) * cb0_100x) + _1030);

  SV_Target.rgb = renodx::draw::RenderIntermediatePass(SV_Target.rgb);

  SV_Target.w = (dot(float3(_941, _942, _943), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
