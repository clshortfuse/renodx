...
float4 main(
  ...
  float _697 = (((_603 + ((_537 * TEXCOORD_1.x) * cb0_078x)) * _379) * ((_645 * (_646 - cb0_081x)) + cb0_081x)) * ((_684 * (_685 - cb0_084x)) + cb0_084x);
  float _700 = (((_604 + ((_538 * TEXCOORD_1.x) * cb0_078y)) * _379) * ((_645 * (_646 - cb0_081y)) + cb0_081y)) * ((_684 * (_685 - cb0_084y)) + cb0_084y);
  float _703 = (((_605 + ((_539 * TEXCOORD_1.x) * cb0_078z)) * _379) * ((_645 * (_646 - cb0_081z)) + cb0_081z)) * ((_684 * (_685 - cb0_084z)) + cb0_084z);

  CAPTURE_UNTONEMAPPED(float3(_697, _700, _703));

  [branch]
  if (WUWA_TM_IS(1)) {
    _736 = ((((_697 * 1.3600000143051147f) + 0.04699999839067459f) * _697) / ((((_697 * 0.9599999785423279f) + 0.5600000023841858f) * _697) + 0.14000000059604645f));
    _737 = ((((_700 * 1.3600000143051147f) + 0.04699999839067459f) * _700) / ((((_700 * 0.9599999785423279f) + 0.5600000023841858f) * _700) + 0.14000000059604645f));
    _738 = ((((_703 * 1.3600000143051147f) + 0.04699999839067459f) * _703) / ((((_703 * 0.9599999785423279f) + 0.5600000023841858f) * _703) + 0.14000000059604645f));
  } else {
    _736 = _697;
    _737 = _700;
    _738 = _703;
  ...
  if (WUWA_TM_IS(2)) {
    ...
    float _750 = 1.0049500465393066f - (0.16398000717163086f / (_738 + -0.19505000114440918f));
    _770 = (((_736 - _748) * select((_736 > 0.6000000238418579f), 0.0f, 1.0f)) + _748);
    _771 = (((_737 - _749) * select((_737 > 0.6000000238418579f), 0.0f, 1.0f)) + _749);
    _772 = (((_738 - _750) * select((_738 > 0.6000000238418579f), 0.0f, 1.0f)) + _750);
  } else {
    _770 = _736;
    _771 = _737;
    _772 = _738;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _778 = cb0_037y * _770;
    float _779 = cb0_037y * _771;
    float _780 = cb0_037y * _772;
    float _783 = cb0_037z * cb0_037w;
    float _793 = cb0_038y * cb0_038x;
    float _804 = cb0_038z * cb0_038x;
    float _811 = cb0_038y / cb0_038z;
    _819 = (((((_783 + _778) * _770) + _793) / (((_778 + cb0_037z) * _770) + _804)) - _811);
    _820 = (((((_783 + _779) * _771) + _793) / (((_779 + cb0_037z) * _771) + _804)) - _811);
    _821 = (((((_783 + _780) * _772) + _793) / (((_780 + cb0_037z) * _772) + _804)) - _811);
  } else {
    _819 = _770;
    _820 = _771;
    _821 = _772;
  ...
  if (!((uint)(cb0_097w) == 0)) {
    if (!(cb0_098x == 1.0f)) {
      float _830 = dot(float3(_819, _820, _821), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_830 <= 9.999999747378752e-05f)) {
        float _839 = (pow(_819, 0.1593017578125f));
        float _840 = (pow(_820, 0.1593017578125f));
        float _841 = (pow(_821, 0.1593017578125f));
        float _863 = exp2(log2(((_839 * 18.8515625f) + 0.8359375f) / ((_839 * 18.6875f) + 1.0f)) * 78.84375f);
        float _864 = exp2(log2(((_840 * 18.8515625f) + 0.8359375f) / ((_840 * 18.6875f) + 1.0f)) * 78.84375f);
        float _865 = exp2(log2(((_841 * 18.8515625f) + 0.8359375f) / ((_841 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_830 * 200.0f) > 1.0f) {
          float _869 = 1.0f - cb0_098x;
          do {
            if (_863 > 0.44028136134147644f) {
              float _872 = _863 + -0.44028136134147644f;
              _878 = ((_872 / ((_872 * _869) + 1.0f)) + 0.44028136134147644f);
            } else {
              _878 = _863;
            }
            do {
              if (_864 > 0.44028136134147644f) {
                float _1060 = _864 + -0.44028136134147644f;
                _1066 = ((_1060 / ((_1060 * _869) + 1.0f)) + 0.44028136134147644f);
                if (_865 > 0.44028136134147644f) {
                  float _1069 = _865 + -0.44028136134147644f;
                  _881 = ((_1069 / ((_1069 * _869) + 1.0f)) + 0.44028136134147644f);
                  _882 = _1066;
                  _883 = _878;
                } else {
                  _881 = _865;
              ...
              while(true) {
                float _890 = (pow(_883, 0.012683313339948654f));
                float _891 = (pow(_882, 0.012683313339948654f));
                float _892 = (pow(_881, 0.012683313339948654f));
                _918 = exp2(log2(max((_890 + -0.8359375f), 0.0f) / (18.8515625f - (_890 * 18.6875f))) * 6.277394771575928f);
                _919 = exp2(log2(max((_891 + -0.8359375f), 0.0f) / (18.8515625f - (_891 * 18.6875f))) * 6.277394771575928f);
                _920 = exp2(log2(max((_892 + -0.8359375f), 0.0f) / (18.8515625f - (_892 * 18.6875f))) * 6.277394771575928f);
                break;
              }
            } while (false);
          } while (false);
  ...
  CLAMP_IF_SDR3(_918, _919, _920);
  CAPTURE_TONEMAPPED(float3(_918, _919, _920));

  float _941 = (saturate((log2(_918 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _942 = (saturate((log2(_919 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _943 = (saturate((log2(_920 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float4 _944 = t5.Sample(s5, float3(_941, _942, _943));

  HANDLE_LUT_OUTPUT(_944);

  [branch]
  if (false) {
    float _951 = select(((_160 * _141.x) > 0.0f), 0.0f, 1.0f);
    float4 _952 = t6.Sample(s6, float3(_941, _942, _943));
    _966 = (lerp(_944.x, _952.x, _951));
    _967 = (lerp(_944.y, _952.y, _951));
    _968 = (lerp(_944.z, _952.z, _951));
  } else {
    _966 = _944.x;
    _967 = _944.y;
    _968 = _944.z;
  }
  float _969 = _966 * 1.0499999523162842f;
  float _970 = _967 * 1.0499999523162842f;
  float _971 = _968 * 1.0499999523162842f;
  float _979 = ((_335 * 0.00390625f) + -0.001953125f) + _969;
  float _980 = ((_356 * 0.00390625f) + -0.001953125f) + _970;
  float _981 = ((_357 * 0.00390625f) + -0.001953125f) + _971;
  [branch]
  if (!((uint)(cb0_098w) == 0)) {
    float _993 = (pow(_979, 0.012683313339948654f));
    float _994 = (pow(_980, 0.012683313339948654f));
    float _995 = (pow(_981, 0.012683313339948654f));
    float _1028 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_993 + -0.8359375f)) / (18.8515625f - (_993 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1029 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_994 + -0.8359375f)) / (18.8515625f - (_994 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1030 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_995 + -0.8359375f)) / (18.8515625f - (_995 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    _1056 = min((_1028 * 12.920000076293945f), ((exp2(log2(max(_1028, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  ...
  SV_Target.w = (dot(float3(_969, _970, _971), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
