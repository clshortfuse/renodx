          ...
          do {
            ...
            do {
              if (_836 > 0.44028136134147644f) {
                float _1032 = _836 + -0.44028136134147644f;
                _1038 = ((_1032 / ((_1032 * _841) + 1.0f)) + 0.44028136134147644f);
                if (_837 > 0.44028136134147644f) {
                  float _1041 = _837 + -0.44028136134147644f;
                  _853 = ((_1041 / ((_1041 * _841) + 1.0f)) + 0.44028136134147644f);
                  _854 = _1038;
                  _855 = _850;
                } else {
                  _853 = _837;
