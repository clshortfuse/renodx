...
float4 main(
  ...
  [branch]
  if (!((uint)(cb0_077z) == 0)) {
    float4 _161 = t2.Sample(s2, float2(min(max(((cb0_076z * _36) + cb0_077x), cb0_075z), cb0_076x), min(max(((cb0_076w * _37) + cb0_077y), cb0_075w), cb0_076y)));
    _169 = (_161.x + _134.x);
    _170 = (_161.y + _134.y);
    _171 = (_161.z + _134.z);
  } else {
  ...
  float _196 = TEXCOORD_1.z + -1.0f;
  float _198 = TEXCOORD_1.w + -1.0f;
  float _201 = (((cb0_082x * 2.0f) + _196) * cb0_080z) * cb0_080x;
  float _203 = (((cb0_082y * 2.0f) + _198) * cb0_080w) * cb0_080x;
  float _210 = 1.0f / ((((saturate(cb0_081w) * 9.0f) + 1.0f) * dot(float2(_201, _203), float2(_201, _203))) + 1.0f);
  float _211 = _210 * _210;
  float _212 = cb0_082z + 1.0f;
  float _240 = (((cb0_085x * 2.0f) + _196) * cb0_083z) * cb0_083x;
  float _242 = (((cb0_085y * 2.0f) + _198) * cb0_083w) * cb0_083x;
  float _249 = 1.0f / ((((saturate(cb0_084w) * 9.0f) + 1.0f) * dot(float2(_240, _242), float2(_240, _242))) + 1.0f);
  float _250 = _249 * _249;
  float _251 = cb0_085z + 1.0f;
  float _262 = (((_211 * (_212 - cb0_081x)) + cb0_081x) * (_169 + ((_106.x * TEXCOORD_1.x) * cb0_078x))) * ((_250 * (_251 - cb0_084x)) + cb0_084x);
  float _264 = (((_211 * (_212 - cb0_081y)) + cb0_081y) * (_170 + ((_106.y * TEXCOORD_1.x) * cb0_078y))) * ((_250 * (_251 - cb0_084y)) + cb0_084y);
  float _266 = (((_211 * (_212 - cb0_081z)) + cb0_081z) * (_171 + ((_106.z * TEXCOORD_1.x) * cb0_078z))) * ((_250 * (_251 - cb0_084z)) + cb0_084z);

  CAPTURE_UNTONEMAPPED(float3(_262, _264, _266));

  [branch]
  if (WUWA_TM_IS(1)) {
    _299 = ((((_262 * 1.3600000143051147f) + 0.04699999839067459f) * _262) / ((((_262 * 0.9599999785423279f) + 0.5600000023841858f) * _262) + 0.14000000059604645f));
    _300 = ((((_264 * 1.3600000143051147f) + 0.04699999839067459f) * _264) / ((((_264 * 0.9599999785423279f) + 0.5600000023841858f) * _264) + 0.14000000059604645f));
    _301 = ((((_266 * 1.3600000143051147f) + 0.04699999839067459f) * _266) / ((((_266 * 0.9599999785423279f) + 0.5600000023841858f) * _266) + 0.14000000059604645f));
  } else {
    _299 = _262;
    _300 = _264;
    _301 = _266;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _311 = 1.0049500465393066f - (0.16398000717163086f / (_299 + -0.19505000114440918f));
    float _312 = 1.0049500465393066f - (0.16398000717163086f / (_300 + -0.19505000114440918f));
    float _313 = 1.0049500465393066f - (0.16398000717163086f / (_301 + -0.19505000114440918f));
    _333 = (((_299 - _311) * select((_299 > 0.6000000238418579f), 0.0f, 1.0f)) + _311);
    _334 = (((_300 - _312) * select((_300 > 0.6000000238418579f), 0.0f, 1.0f)) + _312);
    _335 = (((_301 - _313) * select((_301 > 0.6000000238418579f), 0.0f, 1.0f)) + _313);
  } else {
    _333 = _299;
    _334 = _300;
    _335 = _301;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _341 = cb0_037y * _333;
    float _342 = cb0_037y * _334;
    float _343 = cb0_037y * _335;
    float _346 = cb0_037z * cb0_037w;
    float _356 = cb0_038y * cb0_038x;
    float _367 = cb0_038z * cb0_038x;
    float _374 = cb0_038y / cb0_038z;
    _382 = (((((_346 + _341) * _333) + _356) / (((_341 + cb0_037z) * _333) + _367)) - _374);
    _383 = (((((_346 + _342) * _334) + _356) / (((_342 + cb0_037z) * _334) + _367)) - _374);
    _384 = (((((_346 + _343) * _335) + _356) / (((_343 + cb0_037z) * _335) + _367)) - _374);
  } else {
    _382 = _333;
    _383 = _334;
    _384 = _335;
  ...
  if (!((uint)(cb0_097w) == 0)) {
    if (!(cb0_098x == 1.0f)) {
      float _393 = dot(float3(_382, _383, _384), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_393 <= 9.999999747378752e-05f)) {
        float _402 = (pow(_382, 0.1593017578125f));
        float _403 = (pow(_383, 0.1593017578125f));
        float _404 = (pow(_384, 0.1593017578125f));
        float _426 = exp2(log2(((_402 * 18.8515625f) + 0.8359375f) / ((_402 * 18.6875f) + 1.0f)) * 78.84375f);
        float _427 = exp2(log2(((_403 * 18.8515625f) + 0.8359375f) / ((_403 * 18.6875f) + 1.0f)) * 78.84375f);
        float _428 = exp2(log2(((_404 * 18.8515625f) + 0.8359375f) / ((_404 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_393 * 200.0f) > 1.0f) {
          float _432 = 1.0f - cb0_098x;
          do {
            if (_426 > 0.44028136134147644f) {
              float _435 = _426 + -0.44028136134147644f;
              _441 = ((_435 / ((_435 * _432) + 1.0f)) + 0.44028136134147644f);
            } else {
              _441 = _426;
            }
            do {
              if (_427 > 0.44028136134147644f) {
                float _693 = _427 + -0.44028136134147644f;
                _699 = ((_693 / ((_693 * _432) + 1.0f)) + 0.44028136134147644f);
                if (_428 > 0.44028136134147644f) {
                  float _702 = _428 + -0.44028136134147644f;
                  _444 = ((_702 / ((_702 * _432) + 1.0f)) + 0.44028136134147644f);
                  _445 = _699;
                  _446 = _441;
                } else {
                  _444 = _428;
  ...
  CLAMP_IF_SDR3(_481, _482, _483);
  CAPTURE_TONEMAPPED(float3(_481, _482, _483));

  float _504 = (saturate((log2(_481 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _505 = (saturate((log2(_482 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _506 = (saturate((log2(_483 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float4 _507 = t5.Sample(s5, float3(_504, _505, _506));

  HANDLE_LUT_OUTPUT(_507);

  [branch]
  if (false) {
    float _514 = select(((_77 * _76) > 0.0f), 0.0f, 1.0f);
    float4 _515 = t6.Sample(s6, float3(_504, _505, _506));
    _529 = (lerp(_507.x, _515.x, _514));
    _530 = (lerp(_507.y, _515.y, _514));
    _531 = (lerp(_507.z, _515.z, _514));
  } else {
    _529 = _507.x;
    _530 = _507.y;
    _531 = _507.z;
  ...
  float _533 = _530 * 1.0499999523162842f;
  float _534 = _531 * 1.0499999523162842f;
  float _542 = ((_82 * 0.00390625f) + -0.001953125f) + _532;
  float _543 = ((_104 * 0.00390625f) + -0.001953125f) + _533;
  float _544 = ((_105 * 0.00390625f) + -0.001953125f) + _534;
  [branch]
  if (!((uint)(cb0_098w) == 0)) {
    ...
    float _591 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_556 + -0.8359375f)) / (18.8515625f - (_556 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _592 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_557 + -0.8359375f)) / (18.8515625f - (_557 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _593 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_558 + -0.8359375f)) / (18.8515625f - (_558 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
  ...
  const float3 inverted = renodx::draw::InvertIntermediatePass(float3(_619, _620, _621));
  _619 = inverted.r; _620 = inverted.g; _621 = inverted.b;

  float _630 = ((((_620 * 587.0f) + (_619 * 299.0f)) + (_621 * 114.0f)) * 0.0010000000474974513f) - cb0_100z;
  float _637 = saturate(float(((int)(uint)((bool)(_630 > 0.0f))) - ((int)(uint)((bool)(_630 < 0.0f)))));
  float _644 = cb0_101x - _619;
  float _645 = cb0_101y - _620;
  float _646 = cb0_101z - _621;

  const float peak_scaling = RENODX_PEAK_NITS / RENODX_GAME_NITS;
  float _651 = peak_scaling * cb0_102x - _619;
  float _652 = peak_scaling * cb0_102y - _620;
  float _653 = peak_scaling * cb0_102z - _621;
  ...
  SV_Target.x = (((lerp(_670, _673, _637)) * cb0_100x) + _619);
  SV_Target.y = (((lerp(_671, _674, _637)) * cb0_100x) + _620);
  SV_Target.z = (((lerp(_672, _675, _637)) * cb0_100x) + _621);

  SV_Target.rgb = renodx::draw::RenderIntermediatePass(SV_Target.rgb);

  SV_Target.w = (dot(float3(_532, _533, _534), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
