...
float4 main(
  ...
  [branch]
  if (!((uint)(cb0_077z) == 0)) {
    float4 _591 = t2.Sample(s2, float2(min(max(((cb0_076z * _420) + cb0_077x), cb0_075z), cb0_076x), min(max(((cb0_076w * _421) + cb0_077y), cb0_075w), cb0_076y)));
    _599 = (_591.x + _564.x);
    _600 = (_591.y + _564.y);
    _601 = (_591.z + _564.z);
  } else {
  ...
  float _626 = TEXCOORD_1.z + -1.0f;
  float _628 = TEXCOORD_1.w + -1.0f;
  float _631 = (((cb0_082x * 2.0f) + _626) * cb0_080z) * cb0_080x;
  float _633 = (((cb0_082y * 2.0f) + _628) * cb0_080w) * cb0_080x;
  float _640 = 1.0f / ((((saturate(cb0_081w) * 9.0f) + 1.0f) * dot(float2(_631, _633), float2(_631, _633))) + 1.0f);
  float _641 = _640 * _640;
  float _642 = cb0_082z + 1.0f;
  float _670 = (((cb0_085x * 2.0f) + _626) * cb0_083z) * cb0_083x;
  float _672 = (((cb0_085y * 2.0f) + _628) * cb0_083w) * cb0_083x;
  float _679 = 1.0f / ((((saturate(cb0_084w) * 9.0f) + 1.0f) * dot(float2(_670, _672), float2(_670, _672))) + 1.0f);
  float _680 = _679 * _679;
  float _681 = cb0_085z + 1.0f;
  float _703 = ((((_599 + ((_537 * TEXCOORD_1.x) * cb0_078x)) * _379) * ((_641 * (_642 - cb0_081x)) + cb0_081x)) * ((_680 * (_681 - cb0_084x)) + cb0_084x)) * ((cb0_087x * _335) + cb0_087y);
  float _707 = ((((_600 + ((_538 * TEXCOORD_1.x) * cb0_078y)) * _379) * ((_641 * (_642 - cb0_081y)) + cb0_081y)) * ((_680 * (_681 - cb0_084y)) + cb0_084y)) * ((cb0_087x * _356) + cb0_087y);
  float _711 = ((((_601 + ((_539 * TEXCOORD_1.x) * cb0_078z)) * _379) * ((_641 * (_642 - cb0_081z)) + cb0_081z)) * ((_680 * (_681 - cb0_084z)) + cb0_084z)) * ((cb0_087x * _357) + cb0_087y);

  CAPTURE_UNTONEMAPPED(float3(_703, _707, _711));

  [branch]
  if (WUWA_TM_IS(1)) {
    _744 = ((((_703 * 1.3600000143051147f) + 0.04699999839067459f) * _703) / ((((_703 * 0.9599999785423279f) + 0.5600000023841858f) * _703) + 0.14000000059604645f));
    _745 = ((((_707 * 1.3600000143051147f) + 0.04699999839067459f) * _707) / ((((_707 * 0.9599999785423279f) + 0.5600000023841858f) * _707) + 0.14000000059604645f));
    _746 = ((((_711 * 1.3600000143051147f) + 0.04699999839067459f) * _711) / ((((_711 * 0.9599999785423279f) + 0.5600000023841858f) * _711) + 0.14000000059604645f));
  } else {
    _744 = _703;
    _745 = _707;
    _746 = _711;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _756 = 1.0049500465393066f - (0.16398000717163086f / (_744 + -0.19505000114440918f));
    float _757 = 1.0049500465393066f - (0.16398000717163086f / (_745 + -0.19505000114440918f));
    float _758 = 1.0049500465393066f - (0.16398000717163086f / (_746 + -0.19505000114440918f));
    _778 = (((_744 - _756) * select((_744 > 0.6000000238418579f), 0.0f, 1.0f)) + _756);
    _779 = (((_745 - _757) * select((_745 > 0.6000000238418579f), 0.0f, 1.0f)) + _757);
    _780 = (((_746 - _758) * select((_746 > 0.6000000238418579f), 0.0f, 1.0f)) + _758);
  } else {
    _778 = _744;
    _779 = _745;
    _780 = _746;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _786 = cb0_037y * _778;
    float _787 = cb0_037y * _779;
    float _788 = cb0_037y * _780;
    float _791 = cb0_037z * cb0_037w;
    float _801 = cb0_038y * cb0_038x;
    float _812 = cb0_038z * cb0_038x;
    float _819 = cb0_038y / cb0_038z;
    _827 = (((((_791 + _786) * _778) + _801) / (((_786 + cb0_037z) * _778) + _812)) - _819);
    _828 = (((((_791 + _787) * _779) + _801) / (((_787 + cb0_037z) * _779) + _812)) - _819);
    _829 = (((((_791 + _788) * _780) + _801) / (((_788 + cb0_037z) * _780) + _812)) - _819);
  } else {
    _827 = _778;
    _828 = _779;
    _829 = _780;
  ...
  if (!((uint)(cb0_097w) == 0)) {
    if (!(cb0_098x == 1.0f)) {
      float _838 = dot(float3(_827, _828, _829), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_838 <= 9.999999747378752e-05f)) {
        float _847 = (pow(_827, 0.1593017578125f));
        float _848 = (pow(_828, 0.1593017578125f));
        float _849 = (pow(_829, 0.1593017578125f));
        float _871 = exp2(log2(((_847 * 18.8515625f) + 0.8359375f) / ((_847 * 18.6875f) + 1.0f)) * 78.84375f);
        float _872 = exp2(log2(((_848 * 18.8515625f) + 0.8359375f) / ((_848 * 18.6875f) + 1.0f)) * 78.84375f);
        float _873 = exp2(log2(((_849 * 18.8515625f) + 0.8359375f) / ((_849 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_838 * 200.0f) > 1.0f) {
          float _877 = 1.0f - cb0_098x;
          do {
            if (_871 > 0.44028136134147644f) {
              float _880 = _871 + -0.44028136134147644f;
              _886 = ((_880 / ((_880 * _877) + 1.0f)) + 0.44028136134147644f);
            } else {
              _886 = _871;
            }
            do {
              if (_872 > 0.44028136134147644f) {
                float _1068 = _872 + -0.44028136134147644f;
                _1074 = ((_1068 / ((_1068 * _877) + 1.0f)) + 0.44028136134147644f);
                if (_873 > 0.44028136134147644f) {
                  float _1077 = _873 + -0.44028136134147644f;
                  _889 = ((_1077 / ((_1077 * _877) + 1.0f)) + 0.44028136134147644f);
                  _890 = _1074;
                  _891 = _886;
                } else {
                  _889 = _873;
  ...
  CLAMP_IF_SDR3(_926, _927, _928);
  CAPTURE_TONEMAPPED(float3(_926, _927, _928));

  float _949 = (saturate((log2(_926 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _950 = (saturate((log2(_927 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _951 = (saturate((log2(_928 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float4 _952 = t5.Sample(s5, float3(_949, _950, _951));

  HANDLE_LUT_OUTPUT(_952);

  [branch]
  if (false) {
    float _959 = select(((_160 * _141.x) > 0.0f), 0.0f, 1.0f);
    float4 _960 = t6.Sample(s6, float3(_949, _950, _951));
    _974 = (lerp(_952.x, _960.x, _959));
    _975 = (lerp(_952.y, _960.y, _959));
    _976 = (lerp(_952.z, _960.z, _959));
  } else {
    _974 = _952.x;
    _975 = _952.y;
    _976 = _952.z;
  }
  float _977 = _974 * 1.0499999523162842f;
  float _978 = _975 * 1.0499999523162842f;
  float _979 = _976 * 1.0499999523162842f;
  float _987 = ((_335 * 0.00390625f) + -0.001953125f) + _977;
  float _988 = ((_356 * 0.00390625f) + -0.001953125f) + _978;
  float _989 = ((_357 * 0.00390625f) + -0.001953125f) + _979;
  [branch]
  if (!((uint)(cb0_098w) == 0)) {
    float _1001 = (pow(_987, 0.012683313339948654f));
    float _1002 = (pow(_988, 0.012683313339948654f));
    float _1003 = (pow(_989, 0.012683313339948654f));
    float _1036 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1001 + -0.8359375f)) / (18.8515625f - (_1001 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1037 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1002 + -0.8359375f)) / (18.8515625f - (_1002 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1038 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1003 + -0.8359375f)) / (18.8515625f - (_1003 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    _1064 = min((_1036 * 12.920000076293945f), ((exp2(log2(max(_1036, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1065 = min((_1037 * 12.920000076293945f), ((exp2(log2(max(_1037, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1066 = min((_1038 * 12.920000076293945f), ((exp2(log2(max(_1038, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _1064 = _987;
    _1065 = _988;
    _1066 = _989;
  ...
  SV_Target.w = (dot(float3(_977, _978, _979), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
