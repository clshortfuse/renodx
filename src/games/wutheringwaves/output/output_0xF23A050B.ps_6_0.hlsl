...
float4 main(
  ...
  float _818 = (((_723.x + ((_696 * TEXCOORD_1.x) * cb0_070x)) * _377) * ((_766 * (_767 - cb0_073x)) + cb0_073x)) * ((_805 * (_806 - cb0_076x)) + cb0_076x);
  float _821 = (((_723.y + ((_697 * TEXCOORD_1.x) * cb0_070y)) * _377) * ((_766 * (_767 - cb0_073y)) + cb0_073y)) * ((_805 * (_806 - cb0_076y)) + cb0_076y);
  float _824 = (((_723.z + ((_698 * TEXCOORD_1.x) * cb0_070z)) * _377) * ((_766 * (_767 - cb0_073z)) + cb0_073z)) * ((_805 * (_806 - cb0_076z)) + cb0_076z);

  CAPTURE_UNTONEMAPPED(untonemapped, float3(_818, _821, _824));

  [branch]
  // if (!((uint)(cb0_091z) == 0)) {
  if (!((uint)(RENODX_WUWA_TM) == 1)) {
    // _857 = saturate((((_818 * 1.3600000143051147f) + 0.04699999839067459f) * _818) / ((((_818 * 0.9599999785423279f) + 0.5600000023841858f) * _818) + 0.14000000059604645f));
    // _858 = saturate((((_821 * 1.3600000143051147f) + 0.04699999839067459f) * _821) / ((((_821 * 0.9599999785423279f) + 0.5600000023841858f) * _821) + 0.14000000059604645f));
    // _859 = saturate((((_824 * 1.3600000143051147f) + 0.04699999839067459f) * _824) / ((((_824 * 0.9599999785423279f) + 0.5600000023841858f) * _824) + 0.14000000059604645f));
    _857 = ((((_818 * 1.3600000143051147f) + 0.04699999839067459f) * _818) / ((((_818 * 0.9599999785423279f) + 0.5600000023841858f) * _818) + 0.14000000059604645f));
    _858 = ((((_821 * 1.3600000143051147f) + 0.04699999839067459f) * _821) / ((((_821 * 0.9599999785423279f) + 0.5600000023841858f) * _821) + 0.14000000059604645f));
    _859 = ((((_824 * 1.3600000143051147f) + 0.04699999839067459f) * _824) / ((((_824 * 0.9599999785423279f) + 0.5600000023841858f) * _824) + 0.14000000059604645f));
  } else {
    _857 = _818;
    _858 = _821;
    _859 = _824;
  ...
  if (!((uint)(RENODX_WUWA_TM) == 2)) {
    float _869 = 1.0049500465393066f - (0.16398000717163086f / (_857 + -0.19505000114440918f));
    float _870 = 1.0049500465393066f - (0.16398000717163086f / (_858 + -0.19505000114440918f));
    float _871 = 1.0049500465393066f - (0.16398000717163086f / (_859 + -0.19505000114440918f));
    // _891 = saturate(((_857 - _869) * select((_857 > 0.6000000238418579f), 0.0f, 1.0f)) + _869);
    // _892 = saturate(((_858 - _870) * select((_858 > 0.6000000238418579f), 0.0f, 1.0f)) + _870);
    // _893 = saturate(((_859 - _871) * select((_859 > 0.6000000238418579f), 0.0f, 1.0f)) + _871);
    _891 = (((_857 - _869) * select((_857 > 0.6000000238418579f), 0.0f, 1.0f)) + _869);
  ...
  if (!((uint)(RENODX_WUWA_TM) == 3)) {
    float _900 = cb0_037y * _891;
    float _901 = cb0_037y * _892;
    float _902 = cb0_037y * _893;
    float _905 = cb0_037z * cb0_037w;
    float _915 = cb0_038y * cb0_038x;
    float _926 = cb0_038z * cb0_038x;
    float _933 = cb0_038y / cb0_038z;
    // _941 = saturate(((((_905 + _900) * _891) + _915) / (_926 + ((_900 + cb0_037z) * _891))) - _933);
    // _942 = saturate(((((_905 + _901) * _892) + _915) / (_926 + ((_901 + cb0_037z) * _892))) - _933);
    // _943 = saturate(((((_905 + _902) * _893) + _915) / (_926 + ((_902 + cb0_037z) * _893))) - _933);
    _941 = (((((_905 + _900) * _891) + _915) / (_926 + ((_900 + cb0_037z) * _891))) - _933);
    _942 = (((((_905 + _901) * _892) + _915) / (_926 + ((_901 + cb0_037z) * _892))) - _933);
    _943 = (((((_905 + _902) * _893) + _915) / (_926 + ((_902 + cb0_037z) * _893))) - _933);
  } else {
    _941 = _891;
    _942 = _892;
    _943 = _893;
  ...
  if (!((uint)(cb0_089w) == 0)) {
    if (!((bool)(cb0_090x <= 0.0f) && (bool)(cb0_090y <= 0.0f))) {
      float _955 = dot(float3(_941, _942, _943), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_955 <= 9.999999747378752e-05f)) {
        float _964 = (pow(_941, 0.1593017578125f));
        float _965 = (pow(_942, 0.1593017578125f));
        float _966 = (pow(_943, 0.1593017578125f));
        float _988 = exp2(log2(((_964 * 18.8515625f) + 0.8359375f) / ((_964 * 18.6875f) + 1.0f)) * 78.84375f);
        float _989 = exp2(log2(((_965 * 18.8515625f) + 0.8359375f) / ((_965 * 18.6875f) + 1.0f)) * 78.84375f);
        float _990 = exp2(log2(((_966 * 18.8515625f) + 0.8359375f) / ((_966 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((bool)(cb0_090y > 0.0f) && (bool)((_955 / cb0_090y) > 1.0f)) {
          float _999 = (pow(cb0_090y, 0.1593017578125f));
          float _1007 = exp2(log2(((_999 * 18.8515625f) + 0.8359375f) / ((_999 * 18.6875f) + 1.0f)) * 78.84375f);
          if (_988 > _1007) {
            float _1010 = _988 - _1007;
            _1016 = ((_1010 / ((_1010 * cb0_090z) + 1.0f)) + _1007);
          } else {
            _1016 = _988;
          }
          if (_989 > _1007) {
            float _1217 = _989 - _1007;
            _1223 = ((_1217 / ((_1217 * cb0_090z) + 1.0f)) + _1007);
            if (_990 > _1007) {
              float _1226 = _990 - _1007;
              _1019 = ((_1226 / ((_1226 * cb0_090z) + 1.0f)) + _1007);
              _1020 = _1223;
              _1021 = _1016;
            } else {
              _1019 = _990;
          ...
          while(true) {
            if (cb0_090x > 0.0f) {
              if (_955 < cb0_090x) {
                float _1029 = (pow(cb0_090x, 0.1593017578125f));
                float _1037 = exp2(log2(((_1029 * 18.8515625f) + 0.8359375f) / ((_1029 * 18.6875f) + 1.0f)) * 78.84375f);
                if (_1021 < _1037) {
                  _1045 = (((cb0_090z * 0.30000001192092896f) * (_1037 - _1021)) + _1021);
                } else {
                  _1045 = _1021;
                }
                if (_1020 < _1037) {
                  _1209 = (((cb0_090z * 0.30000001192092896f) * (_1037 - _1020)) + _1020);
                  if (_1019 < _1037) {
                    _1048 = (((cb0_090z * 0.30000001192092896f) * (_1037 - _1019)) + _1019);
                    _1049 = _1209;
                    _1050 = _1045;
                  } else {
                    _1048 = _1019;
            ...
            while(true) {
              float _1057 = (pow(_1050, 0.012683313339948654f));
              float _1058 = (pow(_1049, 0.012683313339948654f));
              float _1059 = (pow(_1048, 0.012683313339948654f));
              _1085 = exp2(log2(max((_1057 + -0.8359375f), 0.0f) / (18.8515625f - (_1057 * 18.6875f))) * 6.277394771575928f);
              _1086 = exp2(log2(max((_1058 + -0.8359375f), 0.0f) / (18.8515625f - (_1058 * 18.6875f))) * 6.277394771575928f);
  ...
  CLAMP_IF_SDR(_1085); CLAMP_IF_SDR(_1086); CLAMP_IF_SDR(_1087);
  CAPTURE_TONEMAPPED(tonemapped, float3(_1085, _1086, _1087));

  float4 _1109 = t4.Sample(s4, float3(((saturate((log2(_1085 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f), ((saturate((log2(_1086 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f), ((saturate((log2(_1087 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f)));
  _1109.rgb = HandleLUTOutput(_1109.rgb, untonemapped, tonemapped);

  float _1113 = _1109.x * 1.0499999523162842f;
  float _1114 = _1109.y * 1.0499999523162842f;
  float _1115 = _1109.z * 1.0499999523162842f;
  float _1123 = ((_331 * 0.00390625f) + -0.001953125f) + _1113;
  float _1124 = ((_354 * 0.00390625f) + -0.001953125f) + _1114;
  float _1125 = ((_355 * 0.00390625f) + -0.001953125f) + _1115;
  [branch]
  if (!((uint)(cb0_091y) == 0)) {
    float _1137 = (pow(_1123, 0.012683313339948654f));
    float _1138 = (pow(_1124, 0.012683313339948654f));
    float _1139 = (pow(_1125, 0.012683313339948654f));
    float _1172 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1137 + -0.8359375f)) / (18.8515625f - (_1137 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_091x));
    float _1173 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1138 + -0.8359375f)) / (18.8515625f - (_1138 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_091x));
    float _1174 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1139 + -0.8359375f)) / (18.8515625f - (_1139 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_091x));
    ...
    _1201 = min((_1173 * 12.920000076293945f), ((exp2(log2(max(_1173, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  ...
  // SV_Target.w = saturate(dot(float3(_1113, _1114, _1115), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
  SV_Target.w = (dot(float3(_1113, _1114, _1115), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
