...
float4 main(
  ...
  float _285 = (((_234 * (_235 - cb0_081x)) + cb0_081x) * (_192 + ((_129.x * TEXCOORD_1.x) * cb0_078x))) * ((_273 * (_274 - cb0_084x)) + cb0_084x);
  float _287 = (((_234 * (_235 - cb0_081y)) + cb0_081y) * (_193 + ((_129.y * TEXCOORD_1.x) * cb0_078y))) * ((_273 * (_274 - cb0_084y)) + cb0_084y);
  float _289 = (((_234 * (_235 - cb0_081z)) + cb0_081z) * (_194 + ((_129.z * TEXCOORD_1.x) * cb0_078z))) * ((_273 * (_274 - cb0_084z)) + cb0_084z);

  CAPTURE_UNTONEMAPPED(float3(_285, _287, _289));

  [branch]
  if (WUWA_TM_IS(1)) {
    _322 = ((((_285 * 1.3600000143051147f) + 0.04699999839067459f) * _285) / ((((_285 * 0.9599999785423279f) + 0.5600000023841858f) * _285) + 0.14000000059604645f));
    _323 = ((((_287 * 1.3600000143051147f) + 0.04699999839067459f) * _287) / ((((_287 * 0.9599999785423279f) + 0.5600000023841858f) * _287) + 0.14000000059604645f));
  ...
  if (!((uint)(cb0_097w) == 0)) {
    if (!(cb0_098x == 1.0f)) {
      float _416 = dot(float3(_405, _406, _407), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_416 <= 9.999999747378752e-05f)) {
        float _425 = (pow(_405, 0.1593017578125f));
        float _426 = (pow(_406, 0.1593017578125f));
        float _427 = (pow(_407, 0.1593017578125f));
        float _449 = exp2(log2(((_425 * 18.8515625f) + 0.8359375f) / ((_425 * 18.6875f) + 1.0f)) * 78.84375f);
        float _450 = exp2(log2(((_426 * 18.8515625f) + 0.8359375f) / ((_426 * 18.6875f) + 1.0f)) * 78.84375f);
        float _451 = exp2(log2(((_427 * 18.8515625f) + 0.8359375f) / ((_427 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_416 * 200.0f) > 1.0f) {
          float _455 = 1.0f - cb0_098x;
          do {
            if (_449 > 0.44028136134147644f) {
              float _458 = _449 + -0.44028136134147644f;
              _464 = ((_458 / ((_458 * _455) + 1.0f)) + 0.44028136134147644f);
            } else {
              _464 = _449;
            }
            do {
              if (_450 > 0.44028136134147644f) {
                float _646 = _450 + -0.44028136134147644f;
                _652 = ((_646 / ((_646 * _455) + 1.0f)) + 0.44028136134147644f);
                if (_451 > 0.44028136134147644f) {
                  float _655 = _451 + -0.44028136134147644f;
                  _467 = ((_655 / ((_655 * _455) + 1.0f)) + 0.44028136134147644f);
                  _468 = _652;
                  _469 = _464;
                } else {
                  _467 = _451;
              ...
              while(true) {
                float _476 = (pow(_469, 0.012683313339948654f));
                float _477 = (pow(_468, 0.012683313339948654f));
                float _478 = (pow(_467, 0.012683313339948654f));
                _504 = exp2(log2(max((_476 + -0.8359375f), 0.0f) / (18.8515625f - (_476 * 18.6875f))) * 6.277394771575928f);
                _505 = exp2(log2(max((_477 + -0.8359375f), 0.0f) / (18.8515625f - (_477 * 18.6875f))) * 6.277394771575928f);
                _506 = exp2(log2(max((_478 + -0.8359375f), 0.0f) / (18.8515625f - (_478 * 18.6875f))) * 6.277394771575928f);
                break;
              }
            } while (false);
          } while (false);
  ...
  CLAMP_IF_SDR3(_504, _505, _506);
  CAPTURE_TONEMAPPED(float3(_504, _505, _506));

  float _527 = (saturate((log2(_504 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _528 = (saturate((log2(_505 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _529 = (saturate((log2(_506 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float4 _530 = t5.Sample(s5, float3(_527, _528, _529));

  HANDLE_LUT_OUTPUT(_530);

  [branch]
  if (false) {
    float _537 = select(((_79 * _78) > 0.0f), 0.0f, 1.0f);
    float4 _538 = t6.Sample(s6, float3(_527, _528, _529));
    _552 = (lerp(_530.x, _538.x, _537));
    _553 = (lerp(_530.y, _538.y, _537));
    _554 = (lerp(_530.z, _538.z, _537));
  } else {
    _552 = _530.x;
    _553 = _530.y;
    _554 = _530.z;
  ...
  float _556 = _553 * 1.0499999523162842f;
  float _557 = _554 * 1.0499999523162842f;
  float _565 = ((_84 * 0.00390625f) + -0.001953125f) + _555;
  float _566 = ((_106 * 0.00390625f) + -0.001953125f) + _556;
  float _567 = ((_107 * 0.00390625f) + -0.001953125f) + _557;
  [branch]
  if (!((uint)(cb0_098w) == 0)) {
    float _579 = (pow(_565, 0.012683313339948654f));
    float _580 = (pow(_566, 0.012683313339948654f));
    float _581 = (pow(_567, 0.012683313339948654f));
    float _614 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_579 + -0.8359375f)) / (18.8515625f - (_579 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _615 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_580 + -0.8359375f)) / (18.8515625f - (_580 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _616 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_581 + -0.8359375f)) / (18.8515625f - (_581 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    ...
    _644 = min((_616 * 12.920000076293945f), ((exp2(log2(max(_616, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _642 = _565;
    _643 = _566;
    _644 = _567;
  ...
  SV_Target.w = (dot(float3(_555, _556, _557), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
