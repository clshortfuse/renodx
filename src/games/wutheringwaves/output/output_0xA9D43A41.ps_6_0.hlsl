...
float4 main(
  ...
  float _669 = ((((_564.x + ((_537 * TEXCOORD_1.x) * cb0_070x)) * _377) * ((_607 * (_608 - cb0_073x)) + cb0_073x)) * ((_646 * (_647 - cb0_076x)) + cb0_076x)) * ((cb0_079x * _331) + cb0_079y);
  float _673 = ((((_564.y + ((_538 * TEXCOORD_1.x) * cb0_070y)) * _377) * ((_607 * (_608 - cb0_073y)) + cb0_073y)) * ((_646 * (_647 - cb0_076y)) + cb0_076y)) * ((cb0_079x * _354) + cb0_079y);
  float _677 = ((((_564.z + ((_539 * TEXCOORD_1.x) * cb0_070z)) * _377) * ((_607 * (_608 - cb0_073z)) + cb0_073z)) * ((_646 * (_647 - cb0_076z)) + cb0_076z)) * ((cb0_079x * _355) + cb0_079y);

  CAPTURE_UNTONEMAPPED(untonemapped, float3(_669, _673, _677));

  [branch]
  // if (!((uint)(cb0_091z) == 0)) {
  if (RENODX_WUWA_TM == 1) {
    // _710 = saturate((((_669 * 1.3600000143051147f) + 0.04699999839067459f) * _669) / ((((_669 * 0.9599999785423279f) + 0.5600000023841858f) * _669) + 0.14000000059604645f));
    // _711 = saturate((((_673 * 1.3600000143051147f) + 0.04699999839067459f) * _673) / ((((_673 * 0.9599999785423279f) + 0.5600000023841858f) * _673) + 0.14000000059604645f));
    // _712 = saturate((((_677 * 1.3600000143051147f) + 0.04699999839067459f) * _677) / ((((_677 * 0.9599999785423279f) + 0.5600000023841858f) * _677) + 0.14000000059604645f));
    _710 = ((((_669 * 1.3600000143051147f) + 0.04699999839067459f) * _669) / ((((_669 * 0.9599999785423279f) + 0.5600000023841858f) * _669) + 0.14000000059604645f));
    _711 = ((((_673 * 1.3600000143051147f) + 0.04699999839067459f) * _673) / ((((_673 * 0.9599999785423279f) + 0.5600000023841858f) * _673) + 0.14000000059604645f));
    _712 = ((((_677 * 1.3600000143051147f) + 0.04699999839067459f) * _677) / ((((_677 * 0.9599999785423279f) + 0.5600000023841858f) * _677) + 0.14000000059604645f));
  } else {
    _710 = _669;
    _711 = _673;
    _712 = _677;
  ...
  if (RENODX_WUWA_TM == 2) {
    ...
    float _723 = 1.0049500465393066f - (0.16398000717163086f / (_711 + -0.19505000114440918f));
    float _724 = 1.0049500465393066f - (0.16398000717163086f / (_712 + -0.19505000114440918f));
    // _744 = saturate(((_710 - _722) * select((_710 > 0.6000000238418579f), 0.0f, 1.0f)) + _722);
    // _745 = saturate(((_711 - _723) * select((_711 > 0.6000000238418579f), 0.0f, 1.0f)) + _723);
    // _746 = saturate(((_712 - _724) * select((_712 > 0.6000000238418579f), 0.0f, 1.0f)) + _724);
    _744 = (((_710 - _722) * select((_710 > 0.6000000238418579f), 0.0f, 1.0f)) + _722);
    _745 = (((_711 - _723) * select((_711 > 0.6000000238418579f), 0.0f, 1.0f)) + _723);
  ...
  // if (!((uint)(cb0_092x) == 0)) {
  if (RENODX_WUWA_TM == 3) {
    float _753 = cb0_037y * _744;
    float _754 = cb0_037y * _745;
    float _755 = cb0_037y * _746;
    float _758 = cb0_037z * cb0_037w;
    float _768 = cb0_038y * cb0_038x;
    float _779 = cb0_038z * cb0_038x;
    float _786 = cb0_038y / cb0_038z;
    // _794 = saturate(((((_758 + _753) * _744) + _768) / (_779 + ((_753 + cb0_037z) * _744))) - _786);
    // _795 = saturate(((((_758 + _754) * _745) + _768) / (_779 + ((_754 + cb0_037z) * _745))) - _786);
    // _796 = saturate(((((_758 + _755) * _746) + _768) / (_779 + ((_755 + cb0_037z) * _746))) - _786);
    _794 = (((((_758 + _753) * _744) + _768) / (_779 + ((_753 + cb0_037z) * _744))) - _786);
    _795 = (((((_758 + _754) * _745) + _768) / (_779 + ((_754 + cb0_037z) * _745))) - _786);
    _796 = (((((_758 + _755) * _746) + _768) / (_779 + ((_755 + cb0_037z) * _746))) - _786);
  } else {
    _794 = _744;
    _795 = _745;
    _796 = _746;
  ...
  if (!((uint)(cb0_089w) == 0)) {
    if (!((bool)(cb0_090x <= 0.0f) && (bool)(cb0_090y <= 0.0f))) {
      float _808 = dot(float3(_794, _795, _796), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_808 <= 9.999999747378752e-05f)) {
        float _817 = (pow(_794, 0.1593017578125f));
        float _818 = (pow(_795, 0.1593017578125f));
        float _819 = (pow(_796, 0.1593017578125f));
        float _841 = exp2(log2(((_817 * 18.8515625f) + 0.8359375f) / ((_817 * 18.6875f) + 1.0f)) * 78.84375f);
        float _842 = exp2(log2(((_818 * 18.8515625f) + 0.8359375f) / ((_818 * 18.6875f) + 1.0f)) * 78.84375f);
        float _843 = exp2(log2(((_819 * 18.8515625f) + 0.8359375f) / ((_819 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((bool)(cb0_090y > 0.0f) && (bool)((_808 / cb0_090y) > 1.0f)) {
          float _852 = (pow(cb0_090y, 0.1593017578125f));
          float _860 = exp2(log2(((_852 * 18.8515625f) + 0.8359375f) / ((_852 * 18.6875f) + 1.0f)) * 78.84375f);
          if (_841 > _860) {
            float _863 = _841 - _860;
            _869 = ((_863 / ((_863 * cb0_090z) + 1.0f)) + _860);
          } else {
            _869 = _841;
          }
          if (_842 > _860) {
            float _1070 = _842 - _860;
            _1076 = ((_1070 / ((_1070 * cb0_090z) + 1.0f)) + _860);
            if (_843 > _860) {
              float _1079 = _843 - _860;
              _872 = ((_1079 / ((_1079 * cb0_090z) + 1.0f)) + _860);
              _873 = _1076;
              _874 = _869;
            } else {
              _872 = _843;
          ...
          while(true) {
            if (cb0_090x > 0.0f) {
              if (_808 < cb0_090x) {
                float _882 = (pow(cb0_090x, 0.1593017578125f));
                float _890 = exp2(log2(((_882 * 18.8515625f) + 0.8359375f) / ((_882 * 18.6875f) + 1.0f)) * 78.84375f);
                if (_874 < _890) {
                  _898 = (((cb0_090z * 0.30000001192092896f) * (_890 - _874)) + _874);
                } else {
                  _898 = _874;
                }
                if (_873 < _890) {
                  _1062 = (((cb0_090z * 0.30000001192092896f) * (_890 - _873)) + _873);
                  if (_872 < _890) {
                    _901 = (((cb0_090z * 0.30000001192092896f) * (_890 - _872)) + _872);
                    _902 = _1062;
                    _903 = _898;
                  } else {
                    _901 = _872;
            ...
            while(true) {
              float _910 = (pow(_903, 0.012683313339948654f));
              float _911 = (pow(_902, 0.012683313339948654f));
              float _912 = (pow(_901, 0.012683313339948654f));
              _938 = exp2(log2(max((_910 + -0.8359375f), 0.0f) / (18.8515625f - (_910 * 18.6875f))) * 6.277394771575928f);
              _939 = exp2(log2(max((_911 + -0.8359375f), 0.0f) / (18.8515625f - (_911 * 18.6875f))) * 6.277394771575928f);
              _940 = exp2(log2(max((_912 + -0.8359375f), 0.0f) / (18.8515625f - (_912 * 18.6875f))) * 6.277394771575928f);
              break;
            }
            break;
          }
  ...
  CLAMP_IF_SDR(_938); CLAMP_IF_SDR(_939); CLAMP_IF_SDR(_940);
  CAPTURE_TONEMAPPED(tonemapped, float3(_938, _939, _940));

  float4 _962 = t4.Sample(s4, float3(((saturate((log2(_938 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f), ((saturate((log2(_939 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f), ((saturate((log2(_940 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f)));
  _962.rgb = HandleLUTOutput(_962.rgb, untonemapped, tonemapped);

  float _966 = _962.x * 1.0499999523162842f;
  float _967 = _962.y * 1.0499999523162842f;
  float _968 = _962.z * 1.0499999523162842f;
  float _976 = ((_331 * 0.00390625f) + -0.001953125f) + _966;
  float _977 = ((_354 * 0.00390625f) + -0.001953125f) + _967;
  float _978 = ((_355 * 0.00390625f) + -0.001953125f) + _968;
  [branch]
  if (!((uint)(cb0_091y) == 0)) {
    ...
    float _1025 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_990 + -0.8359375f)) / (18.8515625f - (_990 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_091x));
    float _1026 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_991 + -0.8359375f)) / (18.8515625f - (_991 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_091x));
    float _1027 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_992 + -0.8359375f)) / (18.8515625f - (_992 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_091x));
  ...
  // SV_Target.w = saturate(dot(float3(_966, _967, _968), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
