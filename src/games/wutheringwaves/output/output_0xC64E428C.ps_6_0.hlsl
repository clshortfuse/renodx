...
float4 main(
  ...
  if (((uint)(RENODX_WUWA_TM) == 1)) {
    _341 = saturate((((_304 * 1.3600000143051147f) + 0.04699999839067459f) * _304) / ((((_304 * 0.9599999785423279f) + 0.5600000023841858f) * _304) + 0.14000000059604645f));
    _342 = saturate((((_306 * 1.3600000143051147f) + 0.04699999839067459f) * _306) / ((((_306 * 0.9599999785423279f) + 0.5600000023841858f) * _306) + 0.14000000059604645f));
    _343 = saturate((((_308 * 1.3600000143051147f) + 0.04699999839067459f) * _308) / ((((_308 * 0.9599999785423279f) + 0.5600000023841858f) * _308) + 0.14000000059604645f));
  } else {
    _341 = _304;
    _342 = _306;
    _343 = _308;
  ...
  if (((uint)(RENODX_WUWA_TM) == 2)) {
    ...
    _376 = saturate(((_342 - _354) * select((_342 > 0.6000000238418579f), 0.0f, 1.0f)) + _354);
    _377 = saturate(((_343 - _355) * select((_343 > 0.6000000238418579f), 0.0f, 1.0f)) + _355);
  } else {
    _375 = _341;
    _376 = _342;
    _377 = _343;
  ...
  if (((uint)(RENODX_WUWA_TM) == 3)) {
    ...
    _424 = saturate(((((_388 + _383) * _375) + _398) / (((_383 + cb0_037z) * _375) + _409)) - _416);
    _425 = saturate(((((_388 + _384) * _376) + _398) / (((_384 + cb0_037z) * _376) + _409)) - _416);
    _426 = saturate(((((_388 + _385) * _377) + _398) / (((_385 + cb0_037z) * _377) + _409)) - _416);
  } else {
    _424 = _375;
    _425 = _376;
    _426 = _377;
          ...
          do {
            ...
            do {
              if (_469 > 0.44028136134147644f) {
                float _713 = _469 + -0.44028136134147644f;
                _719 = ((_713 / ((_713 * _474) + 1.0f)) + 0.44028136134147644f);
                if (_470 > 0.44028136134147644f) {
                  float _722 = _470 + -0.44028136134147644f;
                  _486 = ((_722 / ((_722 * _474) + 1.0f)) + 0.44028136134147644f);
                  _487 = _719;
                  _488 = _483;
                } else {
                  _486 = _470;
  ...
  const float3 inverted = renodx::draw::InvertIntermediatePass(float3(_638, _639, _640));
  _638 = inverted.r; _639 = inverted.g; _640 = inverted.b;

  float _649 = ((((_639 * 587.0f) + (_638 * 299.0f)) + (_640 * 114.0f)) * 0.0010000000474974513f) - cb0_092y;
  float _656 = saturate(float(((int)(uint)((bool)(_649 > 0.0f))) - ((int)(uint)((bool)(_649 < 0.0f)))));
  float _663 = cb0_093x - _638;
  float _664 = cb0_093y - _639;
  float _665 = cb0_093z - _640;

  const float peak_scaling = RENODX_PEAK_NITS / RENODX_GAME_NITS;
  float _670 = peak_scaling * cb0_094x - _638;
  float _671 = peak_scaling * cb0_094y - _639;
  float _672 = peak_scaling * cb0_094z - _640;
  ...
  SV_Target.x = ((cb0_091w * (lerp(_689, _692, _656))) + _638);
  SV_Target.y = ((cb0_091w * (lerp(_690, _693, _656))) + _639);
  SV_Target.z = (((lerp(_691, _694, _656)) * cb0_091w) + _640);
