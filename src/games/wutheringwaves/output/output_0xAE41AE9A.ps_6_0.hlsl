          ...
          do {
            ...
            do {
              if (_924 > 0.44028136134147644f) {
                float _1097 = _924 + -0.44028136134147644f;
                _1103 = ((_1097 / ((_1097 * _929) + 1.0f)) + 0.44028136134147644f);
                if (_925 > 0.44028136134147644f) {
                  float _1106 = _925 + -0.44028136134147644f;
                  _941 = ((_1106 / ((_1106 * _929) + 1.0f)) + 0.44028136134147644f);
                  _942 = _1103;
                  _943 = _938;
                } else {
                  _941 = _925;
