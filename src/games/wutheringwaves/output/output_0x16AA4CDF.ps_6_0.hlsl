          ...
          do {
            ...
            do {
              if (_431 > 0.44028136134147644f) {
                float _627 = _431 + -0.44028136134147644f;
                _633 = ((_627 / ((_627 * _436) + 1.0f)) + 0.44028136134147644f);
                if (_432 > 0.44028136134147644f) {
                  float _636 = _432 + -0.44028136134147644f;
                  _448 = ((_636 / ((_636 * _436) + 1.0f)) + 0.44028136134147644f);
                  _449 = _633;
                  _450 = _445;
                } else {
                  _448 = _432;
