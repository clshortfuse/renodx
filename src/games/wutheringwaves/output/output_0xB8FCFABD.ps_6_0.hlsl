          ...
          do {
            ...
            do {
              if (_556 > 0.44028136134147644f) {
                float _752 = _556 + -0.44028136134147644f;
                _758 = ((_752 / ((_752 * _561) + 1.0f)) + 0.44028136134147644f);
                if (_557 > 0.44028136134147644f) {
                  float _761 = _557 + -0.44028136134147644f;
                  _573 = ((_761 / ((_761 * _561) + 1.0f)) + 0.44028136134147644f);
                  _574 = _758;
                  _575 = _570;
                } else {
                  _573 = _557;
