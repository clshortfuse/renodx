...
float4 main(
  ...
  float _299 = ((((_238 * (_239 - cb0_081x)) + cb0_081x) * (_196 + ((_129.x * TEXCOORD_1.x) * cb0_078x))) * ((_277 * (_278 - cb0_084x)) + cb0_084x)) * ((cb0_087x * _84) + cb0_087y);
  float _302 = ((((_238 * (_239 - cb0_081y)) + cb0_081y) * (_197 + ((_129.y * TEXCOORD_1.x) * cb0_078y))) * ((_277 * (_278 - cb0_084y)) + cb0_084y)) * ((cb0_087x * _106) + cb0_087y);
  float _305 = ((((_238 * (_239 - cb0_081z)) + cb0_081z) * (_198 + ((_129.z * TEXCOORD_1.x) * cb0_078z))) * ((_277 * (_278 - cb0_084z)) + cb0_084z)) * ((cb0_087x * _107) + cb0_087y);

  CAPTURE_UNTONEMAPPED(float3(_299, _302, _305));

  [branch]
  if (WUWA_TM_IS(1)) {
    _338 = ((((_299 * 1.3600000143051147f) + 0.04699999839067459f) * _299) / ((((_299 * 0.9599999785423279f) + 0.5600000023841858f) * _299) + 0.14000000059604645f));
    _339 = ((((_302 * 1.3600000143051147f) + 0.04699999839067459f) * _302) / ((((_302 * 0.9599999785423279f) + 0.5600000023841858f) * _302) + 0.14000000059604645f));
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _350 = 1.0049500465393066f - (0.16398000717163086f / (_338 + -0.19505000114440918f));
    ...
    _372 = (((_338 - _350) * select((_338 > 0.6000000238418579f), 0.0f, 1.0f)) + _350);
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _380 = cb0_037y * _372;
    float _381 = cb0_037y * _373;
    float _382 = cb0_037y * _374;
    float _385 = cb0_037z * cb0_037w;
    float _395 = cb0_038y * cb0_038x;
    float _406 = cb0_038z * cb0_038x;
    float _413 = cb0_038y / cb0_038z;
    _421 = (((((_385 + _380) * _372) + _395) / (((_380 + cb0_037z) * _372) + _406)) - _413);
    _422 = (((((_385 + _381) * _373) + _395) / (((_381 + cb0_037z) * _373) + _406)) - _413);
    _423 = (((((_385 + _382) * _374) + _395) / (((_382 + cb0_037z) * _374) + _406)) - _413);
  } else {
    _421 = _372;
    _422 = _373;
    _423 = _374;
  ...
  if (!((uint)(cb0_097w) == 0)) {
    if (!(cb0_098x == 1.0f)) {
      float _432 = dot(float3(_421, _422, _423), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_432 <= 9.999999747378752e-05f)) {
        float _441 = (pow(_421, 0.1593017578125f));
        float _442 = (pow(_422, 0.1593017578125f));
        float _443 = (pow(_423, 0.1593017578125f));
        float _465 = exp2(log2(((_441 * 18.8515625f) + 0.8359375f) / ((_441 * 18.6875f) + 1.0f)) * 78.84375f);
        float _466 = exp2(log2(((_442 * 18.8515625f) + 0.8359375f) / ((_442 * 18.6875f) + 1.0f)) * 78.84375f);
        float _467 = exp2(log2(((_443 * 18.8515625f) + 0.8359375f) / ((_443 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_432 * 200.0f) > 1.0f) {
          float _471 = 1.0f - cb0_098x;
          do {
            if (_465 > 0.44028136134147644f) {
              float _474 = _465 + -0.44028136134147644f;
              _480 = ((_474 / ((_474 * _471) + 1.0f)) + 0.44028136134147644f);
            } else {
              _480 = _465;
            }
            do {
              if (_466 > 0.44028136134147644f) {
                float _662 = _466 + -0.44028136134147644f;
                _668 = ((_662 / ((_662 * _471) + 1.0f)) + 0.44028136134147644f);
                if (_467 > 0.44028136134147644f) {
                  float _671 = _467 + -0.44028136134147644f;
                  _483 = ((_671 / ((_671 * _471) + 1.0f)) + 0.44028136134147644f);
                  _484 = _668;
                  _485 = _480;
                } else {
                  _483 = _467;
              ...
              while(true) {
                float _492 = (pow(_485, 0.012683313339948654f));
                float _493 = (pow(_484, 0.012683313339948654f));
                float _494 = (pow(_483, 0.012683313339948654f));
                _520 = exp2(log2(max((_492 + -0.8359375f), 0.0f) / (18.8515625f - (_492 * 18.6875f))) * 6.277394771575928f);
                _521 = exp2(log2(max((_493 + -0.8359375f), 0.0f) / (18.8515625f - (_493 * 18.6875f))) * 6.277394771575928f);
                _522 = exp2(log2(max((_494 + -0.8359375f), 0.0f) / (18.8515625f - (_494 * 18.6875f))) * 6.277394771575928f);
                break;
              }
            } while (false);
          } while (false);
  ...
  CLAMP_IF_SDR3(_520, _521, _522);
  CAPTURE_TONEMAPPED(float3(_520, _521, _522));

  float _543 = (saturate((log2(_520 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _544 = (saturate((log2(_521 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _545 = (saturate((log2(_522 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float4 _546 = t5.Sample(s5, float3(_543, _544, _545));

  HANDLE_LUT_OUTPUT(_546);

  [branch]
  if (false) {
    float _553 = select(((_79 * _78) > 0.0f), 0.0f, 1.0f);
    float4 _554 = t6.Sample(s6, float3(_543, _544, _545));
    _568 = (lerp(_546.x, _554.x, _553));
    _569 = (lerp(_546.y, _554.y, _553));
    _570 = (lerp(_546.z, _554.z, _553));
  } else {
    _568 = _546.x;
    _569 = _546.y;
    _570 = _546.z;
  }
  float _571 = _568 * 1.0499999523162842f;
  float _572 = _569 * 1.0499999523162842f;
  float _573 = _570 * 1.0499999523162842f;
  float _581 = ((_84 * 0.00390625f) + -0.001953125f) + _571;
  float _582 = ((_106 * 0.00390625f) + -0.001953125f) + _572;
  float _583 = ((_107 * 0.00390625f) + -0.001953125f) + _573;
  [branch]
  if (!((uint)(cb0_098w) == 0)) {
    float _595 = (pow(_581, 0.012683313339948654f));
    float _596 = (pow(_582, 0.012683313339948654f));
    float _597 = (pow(_583, 0.012683313339948654f));
    float _630 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_595 + -0.8359375f)) / (18.8515625f - (_595 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _631 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_596 + -0.8359375f)) / (18.8515625f - (_596 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _632 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_597 + -0.8359375f)) / (18.8515625f - (_597 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    _658 = min((_630 * 12.920000076293945f), ((exp2(log2(max(_630, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _659 = min((_631 * 12.920000076293945f), ((exp2(log2(max(_631, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  ...
  SV_Target.w = (dot(float3(_571, _572, _573), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
