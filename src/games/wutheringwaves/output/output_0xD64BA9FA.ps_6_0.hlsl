...
float4 main(
          ...
          do {
            ...
            do {
              if (_552 > 0.44028136134147644f) {
                float _818 = _552 + -0.44028136134147644f;
                _824 = ((_818 / ((_818 * _557) + 1.0f)) + 0.44028136134147644f);
                if (_553 > 0.44028136134147644f) {
                  float _827 = _553 + -0.44028136134147644f;
                  _569 = ((_827 / ((_827 * _557) + 1.0f)) + 0.44028136134147644f);
                  _570 = _824;
                  _571 = _566;
                } else {
                  _569 = _553;
  ...
  float _755 = ((((_745 * 587.0f) + (_744 * 299.0f)) + (_746 * 114.0f)) * 0.0010000000474974513f) - cb0_100z;
  float _762 = saturate(float(((int)(uint)((bool)(_755 > 0.0f))) - ((int)(uint)((bool)(_755 < 0.0f)))));
  float _769 = cb0_101x - _744;
  float _770 = cb0_101y - _745;
  float _771 = cb0_101z - _746;
  float _776 = cb0_102x - _744;
  float _777 = cb0_102y - _745;
  float _778 = cb0_102z - _746;
  [branch]
  if (cb0_100y > 0.0f) {
    _795 = (_769 * cb0_100y);
    _796 = (_770 * cb0_100y);
  ...
  SV_Target.x = (((lerp(_795, _798, _762)) * cb0_100x) + _744);
  SV_Target.y = (((lerp(_796, _799, _762)) * cb0_100x) + _745);
  SV_Target.z = (((lerp(_797, _800, _762)) * cb0_100x) + _746);
