...
float4 main(
  ...
  float4 _429 = t0.Sample(s0, float2(min(max(_418, cb0_053x), cb0_053z), min(max(_419, cb0_053y), cb0_053w)));
  float _435 = saturate(cb0_081x);
  float _437 = saturate(cb0_081y);
  if (_435 > 0.0f) {
    float _448 = saturate(((_429.x * 0.29899999499320984f) + (_429.y * 0.5870000123977661f)) + (_429.z * 0.11400000005960464f));
    float _454 = ((_448 * _448) * (saturate(1.0f - cb0_081z) * 2.0f)) * (3.0f - (_448 * 2.0f));
    float _461 = max(sqrt(((_429.x * _429.x) + (_429.y * _429.y)) + (_429.z * _429.z)), 0.014999999664723873f);
    float _462 = _429.x / _461;
    float _463 = _429.y / _461;
    float _464 = _429.z / _461;
    float _474 = log2(_454);
    float _493 = ((_286 * _206) * _323) * _435;
    _504 = (((((lerp(_462, 1.0f, 0.25f)) * (((_437 * 0.17000000178813934f) + 0.029999999329447746f) + _454)) - _429.x) * _493) + _429.x);
    _505 = (((((((_437 * 0.18000000715255737f) + 0.05000000074505806f) + exp2(_474 * 0.8999999761581421f)) * (lerp(_463, 1.0f, 0.25f))) - _429.y) * _493) + _429.y);
    _506 = (((((((_437 * 0.17999999225139618f) + 0.07999999821186066f) + exp2(_474 * 0.949999988079071f)) * (lerp(_464, 1.0f, 0.25f))) - _429.z) * _493) + _429.z);
  } else {
    _504 = _429.x;
    _505 = _429.y;
    _506 = _429.z;
  }
  float _509 = saturate(cb0_082x);
  float _510 = _379 * _509;
  if (_509 > 0.0f) {
    float _521 = (sin(((_108 * 640.0f) + 640.0f) - (dx_alignment_legacy_View_2376 * 10.0f)) * 0.5f) + 1.0f;
    _535 = ((((_521 * _504) - _504) * _510) + _504);
    _536 = ((((_521 * _505) - _505) * _510) + _505);
    _537 = ((((_521 * _506) - _506) * _510) + _506);
  } else {
    _535 = _504;
    _536 = _505;
    _537 = _506;
  ...
  float4 _560 = t1.Sample(s1, float2(min(max(((cb0_068x * _418) + cb0_068z), cb0_060x), cb0_060z), min(max(((cb0_068y * _419) + cb0_068w), cb0_060y), cb0_060w)));
  _560.rgb *= RENODX_WUWA_BLOOM;

  float _587 = TEXCOORD_1.z + -1.0f;
  float _589 = TEXCOORD_1.w + -1.0f;
  float _592 = ((_587 + (cb0_073x * 2.0f)) * cb0_071z) * cb0_071x;
  float _594 = ((_589 + (cb0_073y * 2.0f)) * cb0_071w) * cb0_071x;
  float _601 = 1.0f / ((((saturate(cb0_072w) * 9.0f) + 1.0f) * dot(float2(_592, _594), float2(_592, _594))) + 1.0f);
  float _602 = _601 * _601;
  float _629 = ((_587 + (cb0_076x * 2.0f)) * cb0_074z) * cb0_074x;
  float _631 = ((_589 + (cb0_076y * 2.0f)) * cb0_074w) * cb0_074x;
  float _638 = 1.0f / ((((saturate(cb0_075w) * 9.0f) + 1.0f) * dot(float2(_629, _631), float2(_629, _631))) + 1.0f);
  float _639 = _638 * _638;
  float _653 = ((_560.x + ((_535 * TEXCOORD_1.x) * cb0_069x)) * _376) * min(((_602 * (1.0f - cb0_072x)) + cb0_072x), ((_639 * (1.0f - cb0_075x)) + cb0_075x));
  float _655 = ((_560.y + ((_536 * TEXCOORD_1.x) * cb0_069y)) * _376) * min(((_602 * (1.0f - cb0_072y)) + cb0_072y), ((_639 * (1.0f - cb0_075y)) + cb0_075y));
  float _657 = ((_560.z + ((_537 * TEXCOORD_1.x) * cb0_069z)) * _376) * min(((_602 * (1.0f - cb0_072z)) + cb0_072z), ((_639 * (1.0f - cb0_075z)) + cb0_075z));

  CAPTURE_UNTONEMAPPED(untonemapped, float3(_653, _655, _657));

  [branch]
  // if (!((uint)(cb0_089y) == 0)) {
  if (((uint)(RENODX_WUWA_TM) == 1)) {
    // _690 = saturate((((_653 * 1.3600000143051147f) + 0.04699999839067459f) * _653) / ((((_653 * 0.9599999785423279f) + 0.5600000023841858f) * _653) + 0.14000000059604645f));
    // _691 = saturate((((_655 * 1.3600000143051147f) + 0.04699999839067459f) * _655) / ((((_655 * 0.9599999785423279f) + 0.5600000023841858f) * _655) + 0.14000000059604645f));
    // _692 = saturate((((_657 * 1.3600000143051147f) + 0.04699999839067459f) * _657) / ((((_657 * 0.9599999785423279f) + 0.5600000023841858f) * _657) + 0.14000000059604645f));
    _690 = ((((_653 * 1.3600000143051147f) + 0.04699999839067459f) * _653) / ((((_653 * 0.9599999785423279f) + 0.5600000023841858f) * _653) + 0.14000000059604645f));
    _691 = ((((_655 * 1.3600000143051147f) + 0.04699999839067459f) * _655) / ((((_655 * 0.9599999785423279f) + 0.5600000023841858f) * _655) + 0.14000000059604645f));
    _692 = ((((_657 * 1.3600000143051147f) + 0.04699999839067459f) * _657) / ((((_657 * 0.9599999785423279f) + 0.5600000023841858f) * _657) + 0.14000000059604645f));
  } else {
    _690 = _653;
    _691 = _655;
    _692 = _657;
  ...
  if (((uint)(RENODX_WUWA_TM) == 2)) {
    float _702 = 1.0049500465393066f - (0.16398000717163086f / (_690 + -0.19505000114440918f));
    float _703 = 1.0049500465393066f - (0.16398000717163086f / (_691 + -0.19505000114440918f));
    float _704 = 1.0049500465393066f - (0.16398000717163086f / (_692 + -0.19505000114440918f));
    // _724 = saturate(((_690 - _702) * select((_690 > 0.6000000238418579f), 0.0f, 1.0f)) + _702);
    // _725 = saturate(((_691 - _703) * select((_691 > 0.6000000238418579f), 0.0f, 1.0f)) + _703);
    // _726 = saturate(((_692 - _704) * select((_692 > 0.6000000238418579f), 0.0f, 1.0f)) + _704);
    _724 = (((_690 - _702) * select((_690 > 0.6000000238418579f), 0.0f, 1.0f)) + _702);
    _725 = (((_691 - _703) * select((_691 > 0.6000000238418579f), 0.0f, 1.0f)) + _703);
    _726 = (((_692 - _704) * select((_692 > 0.6000000238418579f), 0.0f, 1.0f)) + _704);
  } else {
    _724 = _690;
    _725 = _691;
    _726 = _692;
  ...
  if (((uint)(RENODX_WUWA_TM) == 3)) {
    float _732 = cb0_037y * _724;
    float _733 = cb0_037y * _725;
    float _734 = cb0_037y * _726;
    float _737 = cb0_037z * cb0_037w;
    float _747 = cb0_038y * cb0_038x;
    float _758 = cb0_038z * cb0_038x;
    float _765 = cb0_038y / cb0_038z;
    // _773 = saturate(((((_737 + _732) * _724) + _747) / (_758 + ((_732 + cb0_037z) * _724))) - _765);
    // _774 = saturate(((((_737 + _733) * _725) + _747) / (_758 + ((_733 + cb0_037z) * _725))) - _765);
    // _775 = saturate(((((_737 + _734) * _726) + _747) / (_758 + ((_734 + cb0_037z) * _726))) - _765);
    _773 = (((((_737 + _732) * _724) + _747) / (_758 + ((_732 + cb0_037z) * _724))) - _765);
    _774 = (((((_737 + _733) * _725) + _747) / (_758 + ((_733 + cb0_037z) * _725))) - _765);
    _775 = (((((_737 + _734) * _726) + _747) / (_758 + ((_734 + cb0_037z) * _726))) - _765);
  } else {
    _773 = _724;
    _774 = _725;
    _775 = _726;
  ...
  CLAMP_IF_SDR(_773); CLAMP_IF_SDR(_774); CLAMP_IF_SDR(_775);
  CAPTURE_TONEMAPPED(tonemapped, float3(_773, _774, _775));

  float4 _797 = t4.Sample(s4, float3(((saturate((log2(_773 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f), ((saturate((log2(_774 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f), ((saturate((log2(_775 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f)));
  _797.rgb = HandleLUTOutput(_797.rgb, untonemapped, tonemapped);

  float _801 = _797.x * 1.0499999523162842f;
  float _802 = _797.y * 1.0499999523162842f;
  float _803 = _797.z * 1.0499999523162842f;

  // float _811 = ((_330 * 0.00390625f) + -0.001953125f) + _801;
  // float _812 = ((_353 * 0.00390625f) + -0.001953125f) + _802;
  // float _813 = ((_354 * 0.00390625f) + -0.001953125f) + _803;
  float _811 = RENODX_WUWA_GRAIN * ((_330 * 0.00390625f) + -0.001953125f) + _801;
  float _812 = RENODX_WUWA_GRAIN * ((_353 * 0.00390625f) + -0.001953125f) + _802;
  float _813 = RENODX_WUWA_GRAIN * ((_354 * 0.00390625f) + -0.001953125f) + _803;

  [branch]
  if (!((uint)(cb0_089x) == 0)) {
    float _825 = (pow(_811, 0.012683313339948654f));
    float _826 = (pow(_812, 0.012683313339948654f));
    float _827 = (pow(_813, 0.012683313339948654f));
    float _860 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_825 + -0.8359375f)) / (18.8515625f - (_825 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_088w));
    float _861 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_826 + -0.8359375f)) / (18.8515625f - (_826 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_088w));
    float _862 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_827 + -0.8359375f)) / (18.8515625f - (_827 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_088w));
    _888 = min((_860 * 12.920000076293945f), ((exp2(log2(max(_860, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _889 = min((_861 * 12.920000076293945f), ((exp2(log2(max(_861, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _890 = min((_862 * 12.920000076293945f), ((exp2(log2(max(_862, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _888 = _811;
    _889 = _812;
    _890 = _813;
  ...
  // SV_Target.w = saturate(dot(float3(_801, _802, _803), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
  SV_Target.w = (dot(float3(_801, _802, _803), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
