          ...
          do {
            ...
            do {
              if (_962 > 0.44028136134147644f) {
                float _1158 = _962 + -0.44028136134147644f;
                _1164 = ((_1158 / ((_1158 * _967) + 1.0f)) + 0.44028136134147644f);
                if (_963 > 0.44028136134147644f) {
                  float _1167 = _963 + -0.44028136134147644f;
                  _979 = ((_1167 / ((_1167 * _967) + 1.0f)) + 0.44028136134147644f);
                  _980 = _1164;
                  _981 = _976;
                } else {
                  _979 = _963;
