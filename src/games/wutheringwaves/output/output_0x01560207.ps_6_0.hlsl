...
float4 main(
  ...
  float _850 = (((_756 + ((_694 * TEXCOORD_1.x) * cb0_078x)) * _379) * ((_798 * (_799 - cb0_081x)) + cb0_081x)) * ((_837 * (_838 - cb0_084x)) + cb0_084x);
  float _853 = (((_757 + ((_695 * TEXCOORD_1.x) * cb0_078y)) * _379) * ((_798 * (_799 - cb0_081y)) + cb0_081y)) * ((_837 * (_838 - cb0_084y)) + cb0_084y);
  float _856 = (((_758 + ((_696 * TEXCOORD_1.x) * cb0_078z)) * _379) * ((_798 * (_799 - cb0_081z)) + cb0_081z)) * ((_837 * (_838 - cb0_084z)) + cb0_084z);

  CAPTURE_UNTONEMAPPED(float3(_850, _853, _856));

  [branch]
  if (WUWA_TM_IS(1)) {
    _889 = ((((_850 * 1.3600000143051147f) + 0.04699999839067459f) * _850) / ((((_850 * 0.9599999785423279f) + 0.5600000023841858f) * _850) + 0.14000000059604645f));
    _890 = ((((_853 * 1.3600000143051147f) + 0.04699999839067459f) * _853) / ((((_853 * 0.9599999785423279f) + 0.5600000023841858f) * _853) + 0.14000000059604645f));
    _891 = ((((_856 * 1.3600000143051147f) + 0.04699999839067459f) * _856) / ((((_856 * 0.9599999785423279f) + 0.5600000023841858f) * _856) + 0.14000000059604645f));
  } else {
    _889 = _850;
    _890 = _853;
    _891 = _856;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _901 = 1.0049500465393066f - (0.16398000717163086f / (_889 + -0.19505000114440918f));
    float _902 = 1.0049500465393066f - (0.16398000717163086f / (_890 + -0.19505000114440918f));
    float _903 = 1.0049500465393066f - (0.16398000717163086f / (_891 + -0.19505000114440918f));
    _923 = (((_889 - _901) * select((_889 > 0.6000000238418579f), 0.0f, 1.0f)) + _901);
    _924 = (((_890 - _902) * select((_890 > 0.6000000238418579f), 0.0f, 1.0f)) + _902);
    _925 = (((_891 - _903) * select((_891 > 0.6000000238418579f), 0.0f, 1.0f)) + _903);
  } else {
    _923 = _889;
    _924 = _890;
    _925 = _891;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _931 = cb0_037y * _923;
    float _932 = cb0_037y * _924;
    float _933 = cb0_037y * _925;
    float _936 = cb0_037z * cb0_037w;
    float _946 = cb0_038y * cb0_038x;
    float _957 = cb0_038z * cb0_038x;
    float _964 = cb0_038y / cb0_038z;
    _972 = (((((_936 + _931) * _923) + _946) / (((_931 + cb0_037z) * _923) + _957)) - _964);
    _973 = (((((_936 + _932) * _924) + _946) / (((_932 + cb0_037z) * _924) + _957)) - _964);
    _974 = (((((_936 + _933) * _925) + _946) / (((_933 + cb0_037z) * _925) + _957)) - _964);
  } else {
    _972 = _923;
    _973 = _924;
    _974 = _925;
  ...
  if (!((uint)(cb0_097w) == 0)) {
    if (!(cb0_098x == 1.0f)) {
      float _983 = dot(float3(_972, _973, _974), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_983 <= 9.999999747378752e-05f)) {
        float _992 = (pow(_972, 0.1593017578125f));
        float _993 = (pow(_973, 0.1593017578125f));
        float _994 = (pow(_974, 0.1593017578125f));
        float _1016 = exp2(log2(((_992 * 18.8515625f) + 0.8359375f) / ((_992 * 18.6875f) + 1.0f)) * 78.84375f);
        float _1017 = exp2(log2(((_993 * 18.8515625f) + 0.8359375f) / ((_993 * 18.6875f) + 1.0f)) * 78.84375f);
        float _1018 = exp2(log2(((_994 * 18.8515625f) + 0.8359375f) / ((_994 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_983 * 200.0f) > 1.0f) {
          float _1022 = 1.0f - cb0_098x;
          do {
            if (_1016 > 0.44028136134147644f) {
              float _1025 = _1016 + -0.44028136134147644f;
              _1031 = ((_1025 / ((_1025 * _1022) + 1.0f)) + 0.44028136134147644f);
            } else {
              _1031 = _1016;
            }
            do {
              if (_1017 > 0.44028136134147644f) {
                float _1213 = _1017 + -0.44028136134147644f;
                _1219 = ((_1213 / ((_1213 * _1022) + 1.0f)) + 0.44028136134147644f);
                if (_1018 > 0.44028136134147644f) {
                  float _1222 = _1018 + -0.44028136134147644f;
                  _1034 = ((_1222 / ((_1222 * _1022) + 1.0f)) + 0.44028136134147644f);
                  _1035 = _1219;
                  _1036 = _1031;
                } else {
                  _1034 = _1018;
              ...
              while(true) {
                float _1043 = (pow(_1036, 0.012683313339948654f));
                float _1044 = (pow(_1035, 0.012683313339948654f));
                float _1045 = (pow(_1034, 0.012683313339948654f));
                _1071 = exp2(log2(max((_1043 + -0.8359375f), 0.0f) / (18.8515625f - (_1043 * 18.6875f))) * 6.277394771575928f);
                _1072 = exp2(log2(max((_1044 + -0.8359375f), 0.0f) / (18.8515625f - (_1044 * 18.6875f))) * 6.277394771575928f);
                _1073 = exp2(log2(max((_1045 + -0.8359375f), 0.0f) / (18.8515625f - (_1045 * 18.6875f))) * 6.277394771575928f);
                break;
              }
            } while (false);
          } while (false);
  ...
  CLAMP_IF_SDR3(_1071, _1072, _1073);
  CAPTURE_TONEMAPPED(float3(_1071, _1072, _1073));

  float _1094 = (saturate((log2(_1071 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _1095 = (saturate((log2(_1072 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _1096 = (saturate((log2(_1073 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float4 _1097 = t5.Sample(s5, float3(_1094, _1095, _1096));

  HANDLE_LUT_OUTPUT(_1097);

  [branch]
  if (false) {
    float _1104 = select(((_160 * _141.x) > 0.0f), 0.0f, 1.0f);
    float4 _1105 = t6.Sample(s6, float3(_1094, _1095, _1096));
    _1119 = (lerp(_1097.x, _1105.x, _1104));
    _1120 = (lerp(_1097.y, _1105.y, _1104));
    _1121 = (lerp(_1097.z, _1105.z, _1104));
  } else {
    _1119 = _1097.x;
    _1120 = _1097.y;
    _1121 = _1097.z;
  }
  float _1122 = _1119 * 1.0499999523162842f;
  float _1123 = _1120 * 1.0499999523162842f;
  float _1124 = _1121 * 1.0499999523162842f;
  float _1132 = ((_335 * 0.00390625f) + -0.001953125f) + _1122;
  float _1133 = ((_356 * 0.00390625f) + -0.001953125f) + _1123;
  float _1134 = ((_357 * 0.00390625f) + -0.001953125f) + _1124;
  [branch]
  if (!((uint)(cb0_098w) == 0)) {
    float _1146 = (pow(_1132, 0.012683313339948654f));
    float _1147 = (pow(_1133, 0.012683313339948654f));
    float _1148 = (pow(_1134, 0.012683313339948654f));
    float _1181 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1146 + -0.8359375f)) / (18.8515625f - (_1146 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1182 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1147 + -0.8359375f)) / (18.8515625f - (_1147 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1183 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1148 + -0.8359375f)) / (18.8515625f - (_1148 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    _1209 = min((_1181 * 12.920000076293945f), ((exp2(log2(max(_1181, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1210 = min((_1182 * 12.920000076293945f), ((exp2(log2(max(_1182, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1211 = min((_1183 * 12.920000076293945f), ((exp2(log2(max(_1183, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _1209 = _1132;
    _1210 = _1133;
    _1211 = _1134;
  ...
  SV_Target.w = (dot(float3(_1122, _1123, _1124), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
