...
float4 main(
  ...
  float4 _106 = t0.Sample(s0, float2(_36, _37));

  float4 _134 = t1.Sample(s1, float2(min(max(((cb0_068z * _36) + cb0_069x), cb0_060z), cb0_061x), min(max(((cb0_068w * _37) + cb0_069y), cb0_060w), cb0_061y)));
  APPLY_BLOOM(_134);

  [branch]
  if (!((uint)(cb0_077z) == 0)) {
    bool _162 = ((uint)(cb0_077w) != 0);
    float4 _165 = t2.Sample(s2, float2(select(_162, _36, min(max(((cb0_076z * _36) + cb0_077x), cb0_075z), cb0_076x)), select(_162, _37, min(max(((cb0_076w * _37) + cb0_077y), cb0_075w), cb0_076y))));
    _173 = (_165.x + _134.x);
    _174 = (_165.y + _134.y);
    _175 = (_165.z + _134.z);
  } else {
  ...
  float _200 = TEXCOORD_1.z + -1.0f;
  float _202 = TEXCOORD_1.w + -1.0f;
  float _205 = (((cb0_082x * 2.0f) + _200) * cb0_080z) * cb0_080x;
  float _207 = (((cb0_082y * 2.0f) + _202) * cb0_080w) * cb0_080x;
  float _214 = 1.0f / ((((saturate(cb0_081w) * 9.0f) + 1.0f) * dot(float2(_205, _207), float2(_205, _207))) + 1.0f);
  float _215 = _214 * _214;
  float _216 = cb0_082z + 1.0f;
  float _244 = (((cb0_085x * 2.0f) + _200) * cb0_083z) * cb0_083x;
  float _246 = (((cb0_085y * 2.0f) + _202) * cb0_083w) * cb0_083x;
  float _253 = 1.0f / ((((saturate(cb0_084w) * 9.0f) + 1.0f) * dot(float2(_244, _246), float2(_244, _246))) + 1.0f);
  float _254 = _253 * _253;
  float _255 = cb0_085z + 1.0f;
  float _266 = (((_215 * (_216 - cb0_081x)) + cb0_081x) * (_173 + ((_106.x * TEXCOORD_1.x) * cb0_078x))) * ((_254 * (_255 - cb0_084x)) + cb0_084x);
  float _268 = (((_215 * (_216 - cb0_081y)) + cb0_081y) * (_174 + ((_106.y * TEXCOORD_1.x) * cb0_078y))) * ((_254 * (_255 - cb0_084y)) + cb0_084y);
  float _270 = (((_215 * (_216 - cb0_081z)) + cb0_081z) * (_175 + ((_106.z * TEXCOORD_1.x) * cb0_078z))) * ((_254 * (_255 - cb0_084z)) + cb0_084z);

  CAPTURE_UNTONEMAPPED(float3(_266, _268, _270));

  [branch]
  if (WUWA_TM_IS(1)) {
    _303 = ((((_266 * 1.3600000143051147f) + 0.04699999839067459f) * _266) / ((((_266 * 0.9599999785423279f) + 0.5600000023841858f) * _266) + 0.14000000059604645f));
    _304 = ((((_268 * 1.3600000143051147f) + 0.04699999839067459f) * _268) / ((((_268 * 0.9599999785423279f) + 0.5600000023841858f) * _268) + 0.14000000059604645f));
    _305 = ((((_270 * 1.3600000143051147f) + 0.04699999839067459f) * _270) / ((((_270 * 0.9599999785423279f) + 0.5600000023841858f) * _270) + 0.14000000059604645f));
  } else {
    _303 = _266;
    _304 = _268;
    _305 = _270;
  ...
  if (WUWA_TM_IS(2)) {
    ...
    float _317 = 1.0049500465393066f - (0.16398000717163086f / (_305 + -0.19505000114440918f));
    ...
    _339 = (((_305 - _317) * select((_305 > 0.6000000238418579f), 0.0f, 1.0f)) + _317);
  } else {
    _337 = _303;
    _338 = _304;
    _339 = _305;
  ...
  if (WUWA_TM_IS(3)) {
    ...
    float _347 = cb0_037y * _339;
    float _350 = cb0_037z * cb0_037w;
    float _360 = cb0_038y * cb0_038x;
    float _371 = cb0_038z * cb0_038x;
    float _378 = cb0_038y / cb0_038z;
    _386 = (((((_350 + _345) * _337) + _360) / (((_345 + cb0_037z) * _337) + _371)) - _378);
    _387 = (((((_350 + _346) * _338) + _360) / (((_346 + cb0_037z) * _338) + _371)) - _378);
    _388 = (((((_350 + _347) * _339) + _360) / (((_347 + cb0_037z) * _339) + _371)) - _378);
  } else {
    _386 = _337;
    _387 = _338;
    _388 = _339;
  ...
  if (!((uint)(cb0_097w) == 0)) {
    if (!(cb0_098x == 1.0f)) {
      float _397 = dot(float3(_386, _387, _388), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_397 <= 9.999999747378752e-05f)) {
        float _406 = (pow(_386, 0.1593017578125f));
        float _407 = (pow(_387, 0.1593017578125f));
        float _408 = (pow(_388, 0.1593017578125f));
        float _430 = exp2(log2(((_406 * 18.8515625f) + 0.8359375f) / ((_406 * 18.6875f) + 1.0f)) * 78.84375f);
        float _431 = exp2(log2(((_407 * 18.8515625f) + 0.8359375f) / ((_407 * 18.6875f) + 1.0f)) * 78.84375f);
        float _432 = exp2(log2(((_408 * 18.8515625f) + 0.8359375f) / ((_408 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_397 * 200.0f) > 1.0f) {
          float _436 = 1.0f - cb0_098x;
          do {
            if (_430 > 0.44028136134147644f) {
              float _439 = _430 + -0.44028136134147644f;
              _445 = ((_439 / ((_439 * _436) + 1.0f)) + 0.44028136134147644f);
            } else {
              _445 = _430;
            }
            do {
              if (_431 > 0.44028136134147644f) {
                float _697 = _431 + -0.44028136134147644f;
                _703 = ((_697 / ((_697 * _436) + 1.0f)) + 0.44028136134147644f);
                if (_432 > 0.44028136134147644f) {
                  float _706 = _432 + -0.44028136134147644f;
                  _448 = ((_706 / ((_706 * _436) + 1.0f)) + 0.44028136134147644f);
                  _449 = _703;
                  _450 = _445;
                } else {
                  _448 = _432;
              ...
              while(true) {
                float _457 = (pow(_450, 0.012683313339948654f));
                float _458 = (pow(_449, 0.012683313339948654f));
                float _459 = (pow(_448, 0.012683313339948654f));
                _485 = exp2(log2(max((_457 + -0.8359375f), 0.0f) / (18.8515625f - (_457 * 18.6875f))) * 6.277394771575928f);
                _486 = exp2(log2(max((_458 + -0.8359375f), 0.0f) / (18.8515625f - (_458 * 18.6875f))) * 6.277394771575928f);
                _487 = exp2(log2(max((_459 + -0.8359375f), 0.0f) / (18.8515625f - (_459 * 18.6875f))) * 6.277394771575928f);
                break;
              }
            } while (false);
          } while (false);
  ...
  CLAMP_IF_SDR3(_485, _486, _487);
  CAPTURE_TONEMAPPED(float3(_485, _486, _487));

  float _508 = (saturate((log2(_485 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _509 = (saturate((log2(_486 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _510 = (saturate((log2(_487 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float4 _511 = t5.Sample(s5, float3(_508, _509, _510));

  HANDLE_LUT_OUTPUT(_511);

  [branch]
  if (false) {
    float _518 = select(((_77 * _76) > 0.0f), 0.0f, 1.0f);
    float4 _519 = t6.Sample(s6, float3(_508, _509, _510));
    _533 = (lerp(_511.x, _519.x, _518));
    _534 = (lerp(_511.y, _519.y, _518));
    _535 = (lerp(_511.z, _519.z, _518));
  } else {
    _533 = _511.x;
    _534 = _511.y;
    _535 = _511.z;
  }
  float _536 = _533 * 1.0499999523162842f;
  float _537 = _534 * 1.0499999523162842f;
  float _538 = _535 * 1.0499999523162842f;
  float _546 = ((_82 * 0.00390625f) + -0.001953125f) + _536;
  float _547 = ((_104 * 0.00390625f) + -0.001953125f) + _537;
  float _548 = ((_105 * 0.00390625f) + -0.001953125f) + _538;
  [branch]
  if (!((uint)(cb0_098w) == 0)) {
    float _560 = (pow(_546, 0.012683313339948654f));
    float _561 = (pow(_547, 0.012683313339948654f));
    float _562 = (pow(_548, 0.012683313339948654f));
    float _595 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_560 + -0.8359375f)) / (18.8515625f - (_560 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _596 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_561 + -0.8359375f)) / (18.8515625f - (_561 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _597 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_562 + -0.8359375f)) / (18.8515625f - (_562 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    _623 = min((_595 * 12.920000076293945f), ((exp2(log2(max(_595, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _624 = min((_596 * 12.920000076293945f), ((exp2(log2(max(_596, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _625 = min((_597 * 12.920000076293945f), ((exp2(log2(max(_597, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _623 = _546;
    _624 = _547;
    _625 = _548;
  ...
  const float3 inverted = renodx::draw::InvertIntermediatePass(float3(_623, _624, _625));
  _623 = inverted.r; _624 = inverted.g; _625 = inverted.b;

  float _634 = ((((_624 * 587.0f) + (_623 * 299.0f)) + (_625 * 114.0f)) * 0.0010000000474974513f) - cb0_100z;
  float _641 = saturate(float(((int)(uint)((bool)(_634 > 0.0f))) - ((int)(uint)((bool)(_634 < 0.0f)))));
  float _648 = cb0_101x - _623;
  float _649 = cb0_101y - _624;
  float _650 = cb0_101z - _625;

  const float peak_scaling = RENODX_PEAK_NITS / RENODX_GAME_NITS;
  float _655 = peak_scaling * cb0_102x - _623;
  float _656 = peak_scaling * cb0_102y - _624;
  float _657 = peak_scaling * cb0_102z - _625;
  ...
  SV_Target.x = (((lerp(_674, _677, _641)) * cb0_100x) + _623);
  SV_Target.y = (((lerp(_675, _678, _641)) * cb0_100x) + _624);
  SV_Target.z = (((lerp(_676, _679, _641)) * cb0_100x) + _625);

  SV_Target.rgb = renodx::draw::RenderIntermediatePass(SV_Target.rgb);

  SV_Target.w = (dot(float3(_536, _537, _538), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
