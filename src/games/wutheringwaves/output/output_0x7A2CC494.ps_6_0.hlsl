...
float4 main(
  ...
  [branch]
  if (!((uint)(cb0_077z) == 0)) {
    bool _694 = ((uint)(cb0_077w) != 0);
    float4 _697 = t2.Sample(s2, float2(select(_694, _407, min(max(((cb0_076z * _407) + cb0_077x), cb0_075z), cb0_076x)), select(_694, _408, min(max(((cb0_076w * _408) + cb0_077y), cb0_075w), cb0_076y))));
    _705 = (_697.x + _666.x);
    _706 = (_697.y + _666.y);
    _707 = (_697.z + _666.z);
  } else {
  ...
  float _732 = TEXCOORD_1.z + -1.0f;
  float _734 = TEXCOORD_1.w + -1.0f;
  float _737 = (((cb0_082x * 2.0f) + _732) * cb0_080z) * cb0_080x;
  float _739 = (((cb0_082y * 2.0f) + _734) * cb0_080w) * cb0_080x;
  float _746 = 1.0f / ((((saturate(cb0_081w) * 9.0f) + 1.0f) * dot(float2(_737, _739), float2(_737, _739))) + 1.0f);
  float _747 = _746 * _746;
  float _748 = cb0_082z + 1.0f;
  float _776 = (((cb0_085x * 2.0f) + _732) * cb0_083z) * cb0_083x;
  float _778 = (((cb0_085y * 2.0f) + _734) * cb0_083w) * cb0_083x;
  float _785 = 1.0f / ((((saturate(cb0_084w) * 9.0f) + 1.0f) * dot(float2(_776, _778), float2(_776, _778))) + 1.0f);
  float _786 = _785 * _785;
  float _787 = cb0_085z + 1.0f;
  float _799 = (((_705 + ((_639 * TEXCOORD_1.x) * cb0_078x)) * _377) * ((_747 * (_748 - cb0_081x)) + cb0_081x)) * ((_786 * (_787 - cb0_084x)) + cb0_084x);
  float _802 = (((_706 + ((_640 * TEXCOORD_1.x) * cb0_078y)) * _377) * ((_747 * (_748 - cb0_081y)) + cb0_081y)) * ((_786 * (_787 - cb0_084y)) + cb0_084y);
  float _805 = (((_707 + ((_641 * TEXCOORD_1.x) * cb0_078z)) * _377) * ((_747 * (_748 - cb0_081z)) + cb0_081z)) * ((_786 * (_787 - cb0_084z)) + cb0_084z);

  CAPTURE_UNTONEMAPPED(float3(_799, _802, _805));

  [branch]
  if (WUWA_TM_IS(1)) {
    _838 = ((((_799 * 1.3600000143051147f) + 0.04699999839067459f) * _799) / ((((_799 * 0.9599999785423279f) + 0.5600000023841858f) * _799) + 0.14000000059604645f));
    _839 = ((((_802 * 1.3600000143051147f) + 0.04699999839067459f) * _802) / ((((_802 * 0.9599999785423279f) + 0.5600000023841858f) * _802) + 0.14000000059604645f));
    _840 = ((((_805 * 1.3600000143051147f) + 0.04699999839067459f) * _805) / ((((_805 * 0.9599999785423279f) + 0.5600000023841858f) * _805) + 0.14000000059604645f));
  } else {
    _838 = _799;
    _839 = _802;
    _840 = _805;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _850 = 1.0049500465393066f - (0.16398000717163086f / (_838 + -0.19505000114440918f));
    float _851 = 1.0049500465393066f - (0.16398000717163086f / (_839 + -0.19505000114440918f));
    float _852 = 1.0049500465393066f - (0.16398000717163086f / (_840 + -0.19505000114440918f));
    _872 = (((_838 - _850) * select((_838 > 0.6000000238418579f), 0.0f, 1.0f)) + _850);
    _873 = (((_839 - _851) * select((_839 > 0.6000000238418579f), 0.0f, 1.0f)) + _851);
    _874 = (((_840 - _852) * select((_840 > 0.6000000238418579f), 0.0f, 1.0f)) + _852);
  } else {
    _872 = _838;
    _873 = _839;
    _874 = _840;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _880 = cb0_037y * _872;
    float _881 = cb0_037y * _873;
    float _882 = cb0_037y * _874;
    float _885 = cb0_037z * cb0_037w;
    float _895 = cb0_038y * cb0_038x;
    float _906 = cb0_038z * cb0_038x;
    float _913 = cb0_038y / cb0_038z;
    _921 = (((((_885 + _880) * _872) + _895) / (((_880 + cb0_037z) * _872) + _906)) - _913);
    _922 = (((((_885 + _881) * _873) + _895) / (((_881 + cb0_037z) * _873) + _906)) - _913);
    _923 = (((((_885 + _882) * _874) + _895) / (((_882 + cb0_037z) * _874) + _906)) - _913);
  } else {
    _921 = _872;
    _922 = _873;
    _923 = _874;
  ...
  if (!((uint)(cb0_097w) == 0)) {
    if (!(cb0_098x == 1.0f)) {
      float _932 = dot(float3(_921, _922, _923), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_932 <= 9.999999747378752e-05f)) {
        float _941 = (pow(_921, 0.1593017578125f));
        float _942 = (pow(_922, 0.1593017578125f));
        float _943 = (pow(_923, 0.1593017578125f));
        float _965 = exp2(log2(((_941 * 18.8515625f) + 0.8359375f) / ((_941 * 18.6875f) + 1.0f)) * 78.84375f);
        float _966 = exp2(log2(((_942 * 18.8515625f) + 0.8359375f) / ((_942 * 18.6875f) + 1.0f)) * 78.84375f);
        float _967 = exp2(log2(((_943 * 18.8515625f) + 0.8359375f) / ((_943 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_932 * 200.0f) > 1.0f) {
          float _971 = 1.0f - cb0_098x;
          do {
            if (_965 > 0.44028136134147644f) {
              float _974 = _965 + -0.44028136134147644f;
              _980 = ((_974 / ((_974 * _971) + 1.0f)) + 0.44028136134147644f);
            } else {
              _980 = _965;
            }
            do {
              if (_966 > 0.44028136134147644f) {
                float _1232 = _966 + -0.44028136134147644f;
                _1238 = ((_1232 / ((_1232 * _971) + 1.0f)) + 0.44028136134147644f);
                if (_967 > 0.44028136134147644f) {
                  float _1241 = _967 + -0.44028136134147644f;
                  _983 = ((_1241 / ((_1241 * _971) + 1.0f)) + 0.44028136134147644f);
                  _984 = _1238;
                  _985 = _980;
                } else {
                  _983 = _967;
              ...
              while(true) {
                float _992 = (pow(_985, 0.012683313339948654f));
                float _993 = (pow(_984, 0.012683313339948654f));
                float _994 = (pow(_983, 0.012683313339948654f));
                _1020 = exp2(log2(max((_992 + -0.8359375f), 0.0f) / (18.8515625f - (_992 * 18.6875f))) * 6.277394771575928f);
                _1021 = exp2(log2(max((_993 + -0.8359375f), 0.0f) / (18.8515625f - (_993 * 18.6875f))) * 6.277394771575928f);
                _1022 = exp2(log2(max((_994 + -0.8359375f), 0.0f) / (18.8515625f - (_994 * 18.6875f))) * 6.277394771575928f);
                break;
              }
            } while (false);
          } while (false);
  ...
  CLAMP_IF_SDR3(_1020, _1021, _1022);
  CAPTURE_TONEMAPPED(float3(_1020, _1021, _1022));

  float _1043 = (saturate((log2(_1020 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _1044 = (saturate((log2(_1021 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _1045 = (saturate((log2(_1022 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float4 _1046 = t5.Sample(s5, float3(_1043, _1044, _1045));

  HANDLE_LUT_OUTPUT(_1046);

  [branch]
  if (false) {
    float _1053 = select(((_158 * _139.x) > 0.0f), 0.0f, 1.0f);
    float4 _1054 = t6.Sample(s6, float3(_1043, _1044, _1045));
    _1068 = (lerp(_1046.x, _1054.x, _1053));
    _1069 = (lerp(_1046.y, _1054.y, _1053));
    _1070 = (lerp(_1046.z, _1054.z, _1053));
  } else {
    _1068 = _1046.x;
    _1069 = _1046.y;
    _1070 = _1046.z;
  }
  float _1071 = _1068 * 1.0499999523162842f;
  float _1072 = _1069 * 1.0499999523162842f;
  float _1073 = _1070 * 1.0499999523162842f;
  float _1081 = ((_333 * 0.00390625f) + -0.001953125f) + _1071;
  float _1082 = ((_354 * 0.00390625f) + -0.001953125f) + _1072;
  float _1083 = ((_355 * 0.00390625f) + -0.001953125f) + _1073;
  [branch]
  if (!((uint)(cb0_098w) == 0)) {
    float _1095 = (pow(_1081, 0.012683313339948654f));
    float _1096 = (pow(_1082, 0.012683313339948654f));
    float _1097 = (pow(_1083, 0.012683313339948654f));
    float _1130 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1095 + -0.8359375f)) / (18.8515625f - (_1095 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1131 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1096 + -0.8359375f)) / (18.8515625f - (_1096 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _1132 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1097 + -0.8359375f)) / (18.8515625f - (_1097 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    _1158 = min((_1130 * 12.920000076293945f), ((exp2(log2(max(_1130, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1159 = min((_1131 * 12.920000076293945f), ((exp2(log2(max(_1131, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1160 = min((_1132 * 12.920000076293945f), ((exp2(log2(max(_1132, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _1158 = _1081;
    _1159 = _1082;
    _1160 = _1083;
  ...
  const float3 inverted = renodx::draw::InvertIntermediatePass(float3(_1158, _1159, _1160));
  _1158 = inverted.r; _1159 = inverted.g; _1160 = inverted.b;

  float _1169 = ((((_1159 * 587.0f) + (_1158 * 299.0f)) + (_1160 * 114.0f)) * 0.0010000000474974513f) - cb0_100z;
  float _1176 = saturate(float(((int)(uint)((bool)(_1169 > 0.0f))) - ((int)(uint)((bool)(_1169 < 0.0f)))));
  float _1183 = cb0_101x - _1158;
  float _1184 = cb0_101y - _1159;
  float _1185 = cb0_101z - _1160;

  const float peak_scaling = RENODX_PEAK_NITS / RENODX_GAME_NITS;
  float _1190 = peak_scaling * cb0_102x - _1158;
  float _1191 = peak_scaling * cb0_102y - _1159;
  float _1192 = peak_scaling * cb0_102z - _1160;

  [branch]
  if (cb0_100y > 0.0f) {
    _1209 = (_1183 * cb0_100y);
    _1210 = (_1184 * cb0_100y);
    _1211 = (_1185 * cb0_100y);
    _1212 = (_1190 * cb0_100y);
    _1213 = (_1191 * cb0_100y);
    _1214 = (_1192 * cb0_100y);
  } else {
    float _1201 = abs(cb0_100y);
    _1209 = (_1201 * _1190);
    _1210 = (_1201 * _1191);
    _1211 = (_1201 * _1192);
    _1212 = (_1201 * _1183);
  ...
  SV_Target.x = (((lerp(_1209, _1212, _1176)) * cb0_100x) + _1158);
  SV_Target.y = (((lerp(_1210, _1213, _1176)) * cb0_100x) + _1159);
  SV_Target.z = (((lerp(_1211, _1214, _1176)) * cb0_100x) + _1160);

  SV_Target.rgb = renodx::draw::RenderIntermediatePass(SV_Target.rgb);

  SV_Target.w = (dot(float3(_1071, _1072, _1073), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
