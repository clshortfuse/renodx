...
float4 main(
  ...
  CAPTURE_UNTONEMAPPED(float3(_758, _760, _762));
  ...
  CAPTURE_TONEMAPPED(float3(_878, _879, _880));
  ...
  const float3 inverted = renodx::draw::InvertIntermediatePass(float3(_993, _994, _995));
  _993 = inverted.r; _994 = inverted.g; _995 = inverted.b;

  float _1004 = ((((_994 * 587.0f) + (_993 * 299.0f)) + (_995 * 114.0f)) * 0.0010000000474974513f) - cb0_090z;
  float _1011 = saturate(float(((int)(uint)((bool)(_1004 > 0.0f))) - ((int)(uint)((bool)(_1004 < 0.0f)))));

  const float peak_scaling = RENODX_PEAK_NITS / RENODX_GAME_NITS;
  // float _1018 = cb0_091x - _993;
  // float _1019 = cb0_091y - _994;
  // float _1020 = cb0_091z - _995;
  float _1018 = peak_scaling * cb0_091x - _993;
  float _1019 = peak_scaling * cb0_091y - _994;
  float _1020 = peak_scaling * cb0_091z - _995;

  float _1025 = cb0_092x - _993;
  float _1026 = cb0_092y - _994;
  float _1027 = cb0_092z - _995;
  [branch]
  if (cb0_090y > 0.0f) {
    _1044 = (_1018 * cb0_090y);
    _1045 = (_1019 * cb0_090y);
    _1046 = (_1020 * cb0_090y);
    _1047 = (_1025 * cb0_090y);
    _1048 = (_1026 * cb0_090y);
    _1049 = (_1027 * cb0_090y);
  } else {
    float _1036 = abs(cb0_090y);
    _1044 = (_1025 * _1036);
    _1045 = (_1026 * _1036);
    _1046 = (_1027 * _1036);
    _1047 = (_1018 * _1036);
  ...
  SV_Target.x = ((cb0_090x * (lerp(_1044, _1047, _1011))) + _993);
  SV_Target.y = ((cb0_090x * (lerp(_1045, _1048, _1011))) + _994);
  SV_Target.z = (((lerp(_1046, _1049, _1011)) * cb0_090x) + _995);
