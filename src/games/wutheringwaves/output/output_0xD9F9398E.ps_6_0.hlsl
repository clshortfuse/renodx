...
float4 main(
  ...
  [branch]
  if (!((uint)(cb0_077z) == 0)) {
    bool _342 = ((uint)(cb0_077w) != 0);
    float4 _345 = t2.Sample(s2, float2(select(_342, _117, min(max(((cb0_076z * _117) + cb0_077x), cb0_075z), cb0_076x)), select(_342, _118, min(max(((cb0_076w * _118) + cb0_077y), cb0_075w), cb0_076y))));
    _353 = (_345.x + _314.x);
    _354 = (_345.y + _314.y);
    _355 = (_345.z + _314.z);
  } else {
  ...
  float _380 = TEXCOORD_1.z + -1.0f;
  float _382 = TEXCOORD_1.w + -1.0f;
  float _385 = (((cb0_082x * 2.0f) + _380) * cb0_080z) * cb0_080x;
  float _387 = (((cb0_082y * 2.0f) + _382) * cb0_080w) * cb0_080x;
  float _394 = 1.0f / ((((saturate(cb0_081w) * 9.0f) + 1.0f) * dot(float2(_385, _387), float2(_385, _387))) + 1.0f);
  float _395 = _394 * _394;
  float _396 = cb0_082z + 1.0f;
  float _424 = (((cb0_085x * 2.0f) + _380) * cb0_083z) * cb0_083x;
  float _426 = (((cb0_085y * 2.0f) + _382) * cb0_083w) * cb0_083x;
  float _433 = 1.0f / ((((saturate(cb0_084w) * 9.0f) + 1.0f) * dot(float2(_424, _426), float2(_424, _426))) + 1.0f);
  float _434 = _433 * _433;
  float _435 = cb0_085z + 1.0f;
  float _446 = (((_395 * (_396 - cb0_081x)) + cb0_081x) * (_353 + ((_288 * TEXCOORD_1.x) * cb0_078x))) * ((_434 * (_435 - cb0_084x)) + cb0_084x);
  float _448 = (((_395 * (_396 - cb0_081y)) + cb0_081y) * (_354 + ((_289 * TEXCOORD_1.x) * cb0_078y))) * ((_434 * (_435 - cb0_084y)) + cb0_084y);
  float _450 = (((_395 * (_396 - cb0_081z)) + cb0_081z) * (_355 + ((_230.z * TEXCOORD_1.x) * cb0_078z))) * ((_434 * (_435 - cb0_084z)) + cb0_084z);

  CAPTURE_UNTONEMAPPED(float3(_446, _448, _450));

  [branch]
  if (WUWA_TM_IS(1)) {
    _483 = ((((_446 * 1.3600000143051147f) + 0.04699999839067459f) * _446) / ((((_446 * 0.9599999785423279f) + 0.5600000023841858f) * _446) + 0.14000000059604645f));
    _484 = ((((_448 * 1.3600000143051147f) + 0.04699999839067459f) * _448) / ((((_448 * 0.9599999785423279f) + 0.5600000023841858f) * _448) + 0.14000000059604645f));
    _485 = ((((_450 * 1.3600000143051147f) + 0.04699999839067459f) * _450) / ((((_450 * 0.9599999785423279f) + 0.5600000023841858f) * _450) + 0.14000000059604645f));
  } else {
    _483 = _446;
    _484 = _448;
    _485 = _450;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _495 = 1.0049500465393066f - (0.16398000717163086f / (_483 + -0.19505000114440918f));
    float _496 = 1.0049500465393066f - (0.16398000717163086f / (_484 + -0.19505000114440918f));
    float _497 = 1.0049500465393066f - (0.16398000717163086f / (_485 + -0.19505000114440918f));
    _517 = (((_483 - _495) * select((_483 > 0.6000000238418579f), 0.0f, 1.0f)) + _495);
    _518 = (((_484 - _496) * select((_484 > 0.6000000238418579f), 0.0f, 1.0f)) + _496);
    _519 = (((_485 - _497) * select((_485 > 0.6000000238418579f), 0.0f, 1.0f)) + _497);
  } else {
    _517 = _483;
    _518 = _484;
    _519 = _485;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _525 = cb0_037y * _517;
    float _526 = cb0_037y * _518;
    float _527 = cb0_037y * _519;
    float _530 = cb0_037z * cb0_037w;
    float _540 = cb0_038y * cb0_038x;
    float _551 = cb0_038z * cb0_038x;
    float _558 = cb0_038y / cb0_038z;
    _566 = (((((_530 + _525) * _517) + _540) / (((_525 + cb0_037z) * _517) + _551)) - _558);
    _567 = (((((_530 + _526) * _518) + _540) / (((_526 + cb0_037z) * _518) + _551)) - _558);
    _568 = (((((_530 + _527) * _519) + _540) / (((_527 + cb0_037z) * _519) + _551)) - _558);
  } else {
    _566 = _517;
    _567 = _518;
    _568 = _519;
  ...
  if (!((uint)(cb0_097w) == 0)) {
    if (!(cb0_098x == 1.0f)) {
      float _577 = dot(float3(_566, _567, _568), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_577 <= 9.999999747378752e-05f)) {
        float _586 = (pow(_566, 0.1593017578125f));
        float _587 = (pow(_567, 0.1593017578125f));
        float _588 = (pow(_568, 0.1593017578125f));
        float _610 = exp2(log2(((_586 * 18.8515625f) + 0.8359375f) / ((_586 * 18.6875f) + 1.0f)) * 78.84375f);
        float _611 = exp2(log2(((_587 * 18.8515625f) + 0.8359375f) / ((_587 * 18.6875f) + 1.0f)) * 78.84375f);
        float _612 = exp2(log2(((_588 * 18.8515625f) + 0.8359375f) / ((_588 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_577 * 200.0f) > 1.0f) {
          float _616 = 1.0f - cb0_098x;
          do {
            if (_610 > 0.44028136134147644f) {
              float _619 = _610 + -0.44028136134147644f;
              _625 = ((_619 / ((_619 * _616) + 1.0f)) + 0.44028136134147644f);
            } else {
              _625 = _610;
            }
            do {
              if (_611 > 0.44028136134147644f) {
                float _807 = _611 + -0.44028136134147644f;
                _813 = ((_807 / ((_807 * _616) + 1.0f)) + 0.44028136134147644f);
                if (_612 > 0.44028136134147644f) {
                  float _816 = _612 + -0.44028136134147644f;
                  _628 = ((_816 / ((_816 * _616) + 1.0f)) + 0.44028136134147644f);
                  _629 = _813;
                  _630 = _625;
                } else {
                  _628 = _612;
              ...
              while(true) {
                float _637 = (pow(_630, 0.012683313339948654f));
                float _638 = (pow(_629, 0.012683313339948654f));
                float _639 = (pow(_628, 0.012683313339948654f));
                _665 = exp2(log2(max((_637 + -0.8359375f), 0.0f) / (18.8515625f - (_637 * 18.6875f))) * 6.277394771575928f);
                _666 = exp2(log2(max((_638 + -0.8359375f), 0.0f) / (18.8515625f - (_638 * 18.6875f))) * 6.277394771575928f);
                _667 = exp2(log2(max((_639 + -0.8359375f), 0.0f) / (18.8515625f - (_639 * 18.6875f))) * 6.277394771575928f);
                break;
              }
            } while (false);
          } while (false);
  ...
  CLAMP_IF_SDR3(_665, _666, _667);
  CAPTURE_TONEMAPPED(float3(_665, _666, _667));

  float _688 = (saturate((log2(_665 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _689 = (saturate((log2(_666 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _690 = (saturate((log2(_667 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float4 _691 = t5.Sample(s5, float3(_688, _689, _690));

  HANDLE_LUT_OUTPUT(_691);

  [branch]
  if (false) {
    float _698 = select(((_79 * _78) > 0.0f), 0.0f, 1.0f);
    float4 _699 = t6.Sample(s6, float3(_688, _689, _690));
    _713 = (lerp(_691.x, _699.x, _698));
    _714 = (lerp(_691.y, _699.y, _698));
    _715 = (lerp(_691.z, _699.z, _698));
  } else {
    _713 = _691.x;
    _714 = _691.y;
    _715 = _691.z;
  }
  float _716 = _713 * 1.0499999523162842f;
  float _717 = _714 * 1.0499999523162842f;
  float _718 = _715 * 1.0499999523162842f;
  float _726 = ((_84 * 0.00390625f) + -0.001953125f) + _716;
  float _727 = ((_106 * 0.00390625f) + -0.001953125f) + _717;
  float _728 = ((_107 * 0.00390625f) + -0.001953125f) + _718;
  [branch]
  if (!((uint)(cb0_098w) == 0)) {
    float _740 = (pow(_726, 0.012683313339948654f));
    float _741 = (pow(_727, 0.012683313339948654f));
    float _742 = (pow(_728, 0.012683313339948654f));
    float _775 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_740 + -0.8359375f)) / (18.8515625f - (_740 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _776 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_741 + -0.8359375f)) / (18.8515625f - (_741 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _777 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_742 + -0.8359375f)) / (18.8515625f - (_742 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    _803 = min((_775 * 12.920000076293945f), ((exp2(log2(max(_775, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _804 = min((_776 * 12.920000076293945f), ((exp2(log2(max(_776, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _805 = min((_777 * 12.920000076293945f), ((exp2(log2(max(_777, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _803 = _726;
    _804 = _727;
    _805 = _728;
  ...
  SV_Target.w = (dot(float3(_716, _717, _718), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
