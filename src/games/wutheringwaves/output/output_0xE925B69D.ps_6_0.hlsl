...
float4 main(
  ...
  [branch]
  if (!((uint)(cb0_077z) == 0)) {
    float4 _184 = t2.Sample(s2, float2(min(max(((cb0_076z * _117) + cb0_077x), cb0_075z), cb0_076x), min(max(((cb0_076w * _118) + cb0_077y), cb0_075w), cb0_076y)));
    _192 = (_184.x + _157.x);
    _193 = (_184.y + _157.y);
    _194 = (_184.z + _157.z);
  } else {
  ...
  float _219 = TEXCOORD_1.z + -1.0f;
  float _221 = TEXCOORD_1.w + -1.0f;
  float _224 = (((cb0_082x * 2.0f) + _219) * cb0_080z) * cb0_080x;
  float _226 = (((cb0_082y * 2.0f) + _221) * cb0_080w) * cb0_080x;
  float _233 = 1.0f / ((((saturate(cb0_081w) * 9.0f) + 1.0f) * dot(float2(_224, _226), float2(_224, _226))) + 1.0f);
  float _234 = _233 * _233;
  float _235 = cb0_082z + 1.0f;
  float _263 = (((cb0_085x * 2.0f) + _219) * cb0_083z) * cb0_083x;
  float _265 = (((cb0_085y * 2.0f) + _221) * cb0_083w) * cb0_083x;
  float _272 = 1.0f / ((((saturate(cb0_084w) * 9.0f) + 1.0f) * dot(float2(_263, _265), float2(_263, _265))) + 1.0f);
  float _273 = _272 * _272;
  float _274 = cb0_085z + 1.0f;
  float _295 = ((((_234 * (_235 - cb0_081x)) + cb0_081x) * (_192 + ((_129.x * TEXCOORD_1.x) * cb0_078x))) * ((_273 * (_274 - cb0_084x)) + cb0_084x)) * ((cb0_087x * _84) + cb0_087y);
  float _298 = ((((_234 * (_235 - cb0_081y)) + cb0_081y) * (_193 + ((_129.y * TEXCOORD_1.x) * cb0_078y))) * ((_273 * (_274 - cb0_084y)) + cb0_084y)) * ((cb0_087x * _106) + cb0_087y);
  float _301 = ((((_234 * (_235 - cb0_081z)) + cb0_081z) * (_194 + ((_129.z * TEXCOORD_1.x) * cb0_078z))) * ((_273 * (_274 - cb0_084z)) + cb0_084z)) * ((cb0_087x * _107) + cb0_087y);

  CAPTURE_UNTONEMAPPED(float3(_295, _298, _301));

  [branch]
  if (WUWA_TM_IS(1)) {
    _334 = ((((_295 * 1.3600000143051147f) + 0.04699999839067459f) * _295) / ((((_295 * 0.9599999785423279f) + 0.5600000023841858f) * _295) + 0.14000000059604645f));
    _335 = ((((_298 * 1.3600000143051147f) + 0.04699999839067459f) * _298) / ((((_298 * 0.9599999785423279f) + 0.5600000023841858f) * _298) + 0.14000000059604645f));
    _336 = ((((_301 * 1.3600000143051147f) + 0.04699999839067459f) * _301) / ((((_301 * 0.9599999785423279f) + 0.5600000023841858f) * _301) + 0.14000000059604645f));
  } else {
    _334 = _295;
    _335 = _298;
    _336 = _301;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _346 = 1.0049500465393066f - (0.16398000717163086f / (_334 + -0.19505000114440918f));
    float _347 = 1.0049500465393066f - (0.16398000717163086f / (_335 + -0.19505000114440918f));
    float _348 = 1.0049500465393066f - (0.16398000717163086f / (_336 + -0.19505000114440918f));
    _368 = (((_334 - _346) * select((_334 > 0.6000000238418579f), 0.0f, 1.0f)) + _346);
    _369 = (((_335 - _347) * select((_335 > 0.6000000238418579f), 0.0f, 1.0f)) + _347);
    _370 = (((_336 - _348) * select((_336 > 0.6000000238418579f), 0.0f, 1.0f)) + _348);
  } else {
    _368 = _334;
    _369 = _335;
    _370 = _336;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _376 = cb0_037y * _368;
    float _377 = cb0_037y * _369;
    float _378 = cb0_037y * _370;
    float _381 = cb0_037z * cb0_037w;
    float _391 = cb0_038y * cb0_038x;
    float _402 = cb0_038z * cb0_038x;
    float _409 = cb0_038y / cb0_038z;
    _417 = (((((_381 + _376) * _368) + _391) / (((_376 + cb0_037z) * _368) + _402)) - _409);
    _418 = (((((_381 + _377) * _369) + _391) / (((_377 + cb0_037z) * _369) + _402)) - _409);
    _419 = (((((_381 + _378) * _370) + _391) / (((_378 + cb0_037z) * _370) + _402)) - _409);
  } else {
    _417 = _368;
    _418 = _369;
    _419 = _370;
  ...
  if (!((uint)(cb0_097w) == 0)) {
    if (!(cb0_098x == 1.0f)) {
      float _428 = dot(float3(_417, _418, _419), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      if (!(_428 <= 9.999999747378752e-05f)) {
        float _437 = (pow(_417, 0.1593017578125f));
        float _438 = (pow(_418, 0.1593017578125f));
        float _439 = (pow(_419, 0.1593017578125f));
        float _461 = exp2(log2(((_437 * 18.8515625f) + 0.8359375f) / ((_437 * 18.6875f) + 1.0f)) * 78.84375f);
        float _462 = exp2(log2(((_438 * 18.8515625f) + 0.8359375f) / ((_438 * 18.6875f) + 1.0f)) * 78.84375f);
        float _463 = exp2(log2(((_439 * 18.8515625f) + 0.8359375f) / ((_439 * 18.6875f) + 1.0f)) * 78.84375f);
        if ((_428 * 200.0f) > 1.0f) {
          float _467 = 1.0f - cb0_098x;
          do {
            if (_461 > 0.44028136134147644f) {
              float _470 = _461 + -0.44028136134147644f;
              _476 = ((_470 / ((_470 * _467) + 1.0f)) + 0.44028136134147644f);
            } else {
              _476 = _461;
            }
            do {
              if (_462 > 0.44028136134147644f) {
                float _658 = _462 + -0.44028136134147644f;
                _664 = ((_658 / ((_658 * _467) + 1.0f)) + 0.44028136134147644f);
                if (_463 > 0.44028136134147644f) {
                  float _667 = _463 + -0.44028136134147644f;
                  _479 = ((_667 / ((_667 * _467) + 1.0f)) + 0.44028136134147644f);
                  _480 = _664;
                  _481 = _476;
                } else {
                  _479 = _463;
              ...
              while(true) {
                float _488 = (pow(_481, 0.012683313339948654f));
                float _489 = (pow(_480, 0.012683313339948654f));
                float _490 = (pow(_479, 0.012683313339948654f));
                _516 = exp2(log2(max((_488 + -0.8359375f), 0.0f) / (18.8515625f - (_488 * 18.6875f))) * 6.277394771575928f);
                _517 = exp2(log2(max((_489 + -0.8359375f), 0.0f) / (18.8515625f - (_489 * 18.6875f))) * 6.277394771575928f);
                _518 = exp2(log2(max((_490 + -0.8359375f), 0.0f) / (18.8515625f - (_490 * 18.6875f))) * 6.277394771575928f);
                break;
              }
            } while (false);
          } while (false);
  ...
  CLAMP_IF_SDR3(_516, _517, _518);
  CAPTURE_TONEMAPPED(float3(_516, _517, _518));

  float _539 = (saturate((log2(_516 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _540 = (saturate((log2(_517 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float _541 = (saturate((log2(_518 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  float4 _542 = t5.Sample(s5, float3(_539, _540, _541));

  HANDLE_LUT_OUTPUT(_542);

  [branch]
  if (false) {
    float _549 = select(((_79 * _78) > 0.0f), 0.0f, 1.0f);
    float4 _550 = t6.Sample(s6, float3(_539, _540, _541));
    _564 = (lerp(_542.x, _550.x, _549));
    _565 = (lerp(_542.y, _550.y, _549));
    _566 = (lerp(_542.z, _550.z, _549));
  } else {
    _564 = _542.x;
    _565 = _542.y;
    _566 = _542.z;
  }
  float _567 = _564 * 1.0499999523162842f;
  float _568 = _565 * 1.0499999523162842f;
  float _569 = _566 * 1.0499999523162842f;
  float _577 = ((_84 * 0.00390625f) + -0.001953125f) + _567;
  float _578 = ((_106 * 0.00390625f) + -0.001953125f) + _568;
  float _579 = ((_107 * 0.00390625f) + -0.001953125f) + _569;
  [branch]
  if (!((uint)(cb0_098w) == 0)) {
    float _591 = (pow(_577, 0.012683313339948654f));
    float _592 = (pow(_578, 0.012683313339948654f));
    float _593 = (pow(_579, 0.012683313339948654f));
    float _626 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_591 + -0.8359375f)) / (18.8515625f - (_591 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _627 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_592 + -0.8359375f)) / (18.8515625f - (_592 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    float _628 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_593 + -0.8359375f)) / (18.8515625f - (_593 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_098z));
    _654 = min((_626 * 12.920000076293945f), ((exp2(log2(max(_626, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _655 = min((_627 * 12.920000076293945f), ((exp2(log2(max(_627, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _656 = min((_628 * 12.920000076293945f), ((exp2(log2(max(_628, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _654 = _577;
    _655 = _578;
    _656 = _579;
  ...
  SV_Target.w = (dot(float3(_567, _568, _569), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
