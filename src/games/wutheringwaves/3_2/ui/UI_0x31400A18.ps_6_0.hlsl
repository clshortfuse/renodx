...
float4 main(
  ...
  float4 SV_Target;
  float _60 = mad(SV_Position.z, (View_704[2].w), mad(SV_Position.y, (View_704[1].w), ((View_704[0].w) * SV_Position.x))) + (View_704[3].w);
  float _64 = ((mad(SV_Position.z, (View_704[2].x), mad(SV_Position.y, (View_704[1].x), ((View_704[0].x) * SV_Position.x))) + (View_704[3].x)) / _60) - View_1120.x;
  float _65 = ((mad(SV_Position.z, (View_704[2].y), mad(SV_Position.y, (View_704[1].y), ((View_704[0].y) * SV_Position.x))) + (View_704[3].y)) / _60) - View_1120.y;
  float _66 = ((mad(SV_Position.z, (View_704[2].z), mad(SV_Position.y, (View_704[1].z), ((View_704[0].z) * SV_Position.x))) + (View_704[3].z)) / _60) - View_1120.z;
  float _67 = TEXCOORD_9.x - View_1120.x;
  float _68 = TEXCOORD_9.y - View_1120.y;
  float _69 = TEXCOORD_9.z - View_1120.z;
  float _78;
  float _79;
  float _80;
  float _114;
  ...
  float4 _83 = t0.SampleBias(s0, float2(TEXCOORD.x, TEXCOORD.y), View_2388, int2(0, 0));
  if ((Material_192[0].x) > 0.5f) {
    _114 = max(((exp2(log2(max(_83.x, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _115 = max(((exp2(log2(max(_83.y, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _116 = max(((exp2(log2(max(_83.z, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
  } else {
    _114 = _83.x;
    _115 = _83.y;
    _116 = _83.z;
  ...
  float _118 = _115 * _79;
  float _119 = _116 * _80;
  float _148 = ((SV_Position.x - View_2144.x) * View_2160.z) - (Material_000[3].x);
  float _149 = (1.0f - ((SV_Position.y - View_2144.y) * View_2160.w)) - (Material_000[3].y);
  float _150 = _83.w * COLOR.w;
  float _179 = mad(_69, (Primitive_096[2].x), mad(_68, (Primitive_096[1].x), ((Primitive_096[0].x) * _67))) + (Primitive_096[3].x);
  float _183 = mad(_69, (Primitive_096[2].y), mad(_68, (Primitive_096[1].y), ((Primitive_096[0].y) * _67))) + (Primitive_096[3].y);
  float _212 = saturate(((1.0f - saturate(((_183 - (Material_000[4].y)) - (Material_000[3].y)) / (Material_000[8].y))) - saturate((((-0.0f - _183) - (Material_000[4].y)) + (Material_000[3].y)) / (Material_000[8].w))) * ((1.0f - saturate((((-0.0f - _179) - (Material_000[4].x)) + (Material_000[3].x)) / (Material_000[8].x))) - saturate(((_179 - (Material_000[4].x)) - (Material_000[3].x)) / (Material_000[8].z))));
  float _216 = (_212 * _212) * (3.0f - (_212 * 2.0f));
  float4 _246 = t1.SampleBias(s1, float2(((_179 - (Material_000[10].x)) / (Material_000[11].x)), (1.0f - ((_183 - (Material_000[10].y)) / (Material_000[11].y)))), View_2388, int2(0, 0));
  float _253 = saturate(saturate((Material_192[4].x) * _246.x) * select(((bool)(abs((Material_192[2].w) + -0.5f) > 9.999999747378752e-06f) && (bool)((Material_192[2].w) >= 0.5f)), select(((bool)(_149 > (Material_000[4].y)) || ((bool)((bool)(_148 > (Material_000[4].x)) || ((bool)((bool)(_148 < (-0.0f - (Material_000[4].x))) || (bool)(_149 < (-0.0f - (Material_000[4].y)))))))), 0.0f, _150), (select(((bool)(abs(Material_192[2].z) > 9.999999747378752e-06f) && (bool)((Material_192[2].z) >= 0.0f)), (1.0f - _216), _216) * _150)));
  float _254 = max(((((Material_000[1].x) - _117) * (Material_192[0].y)) + _117), 0.0f);
  float _255 = max(((((Material_000[1].y) - _118) * (Material_192[0].y)) + _118), 0.0f);
  float _256 = max(((((Material_000[1].z) - _119) * (Material_192[0].y)) + _119), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_66 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_64 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_65 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      float _288 = float((bool)(bool)(frac(dot(float3(_64, _65, _66), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _291 = 1.0f;
      _292 = (1.0f - _288);
      _293 = 1.0f;
      _294 = _288;
