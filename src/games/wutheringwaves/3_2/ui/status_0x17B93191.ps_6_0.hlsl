...
float4 main(
  ...
  float4 SV_Target;
  float _59 = mad(SV_Position.z, (View_704[2].w), mad(SV_Position.y, (View_704[1].w), ((View_704[0].w) * SV_Position.x))) + (View_704[3].w);
  float _63 = ((mad(SV_Position.z, (View_704[2].x), mad(SV_Position.y, (View_704[1].x), ((View_704[0].x) * SV_Position.x))) + (View_704[3].x)) / _59) - View_1120.x;
  float _64 = ((mad(SV_Position.z, (View_704[2].y), mad(SV_Position.y, (View_704[1].y), ((View_704[0].y) * SV_Position.x))) + (View_704[3].y)) / _59) - View_1120.y;
  float _65 = ((mad(SV_Position.z, (View_704[2].z), mad(SV_Position.y, (View_704[1].z), ((View_704[0].z) * SV_Position.x))) + (View_704[3].z)) / _59) - View_1120.z;
  float _74;
  float _75;
  float _76;
  float _127;
  ...
  float4 _79 = t0.SampleBias(s0, float2(TEXCOORD.x, TEXCOORD.y), View_2388, int2(0, 0));
  float _82 = max(_79.x, _79.y);
  float _83 = ceil(_82);
  float _87 = ceil(TEXCOORD.z);
  float4 _92 = t1.SampleBias(s1, float2((TEXCOORD.z + -1.0f), (TEXCOORD.w + -1.0f)), View_2388, int2(0, 0));
  float _97 = _92.x * _87;
  float _98 = _92.y * _87;
  float _99 = _92.z * _87;
  if ((Material_032[0].x) > 0.5f) {
  ...
  float _130 = _127 + (_83 * _74);
  float _131 = _128 + (_83 * _75);
  float _132 = _129 + (_83 * _76);
  float _149 = saturate(((_92.w * _87) + _82) * COLOR.w);
  float _150 = max(((((Material_000[1].x) - _130) * (Material_032[0].y)) + _130), 0.0f);
  float _151 = max(((((Material_000[1].y) - _131) * (Material_032[0].y)) + _131), 0.0f);
  float _152 = max(((((Material_000[1].z) - _132) * (Material_032[0].y)) + _132), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_65 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_63 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_64 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      float _184 = float((bool)(bool)(frac(dot(float3(_63, _64, _65), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _187 = 1.0f;
      _188 = (1.0f - _184);
      _189 = 1.0f;
      _190 = _184;
  ...
  if (!(TranslucentBasePass_4352 == 0)) {
    do {
      ...
      if (TranslucentBasePass_4368 == 0.0f) {
        float _214 = 1.0f / TranslucentBasePass_4356;
        _225 = exp2(log2(1.0f - exp2((_188 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _214);
        _226 = exp2(log2(1.0f - exp2((_189 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _214);
        _227 = exp2(log2(1.0f - exp2((_190 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _214);
      } else {
        _225 = _188;
        _226 = _189;
        _227 = _190;
      ...
      do {
        ...
        if (TranslucentBasePass_4368 == 1.0f) {
          float _231 = TranslucentBasePass_4372 * _225;
          float _232 = TranslucentBasePass_4372 * _226;
          float _233 = TranslucentBasePass_4372 * _227;
          float _235 = TranslucentBasePass_4376 * 1.3600000143051147f;
          float _236 = TranslucentBasePass_4376 * 0.9599999785423279f;
          float _273 = 1.0f / TranslucentBasePass_4356;
          _284 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_235 * _231) + 0.04699999839067459f) * _231) / ((((_236 * _231) + 0.5600000023841858f) * _231) + 0.14000000059604645f)))) * _273);
          _285 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_235 * _232) + 0.04699999839067459f) * _232) / ((((_236 * _232) + 0.5600000023841858f) * _232) + 0.14000000059604645f)))) * _273);
          _286 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_235 * _233) + 0.04699999839067459f) * _233) / ((((_236 * _233) + 0.5600000023841858f) * _233) + 0.14000000059604645f)))) * _273);
        } else {
          _284 = _225;
          _285 = _226;
          _286 = _227;
        ...
        do {
          ...
          if (TranslucentBasePass_4368 == 2.0f) {
            float _291 = TranslucentBasePass_4384 * _284;
            float _292 = TranslucentBasePass_4384 * _285;
            float _293 = TranslucentBasePass_4384 * _286;
            float _299 = TranslucentBasePass_4392 * -0.16398000717163086f;
            float _303 = (_299 / (_291 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _304 = (_299 / (_292 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _305 = (_299 / (_293 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _326 = 1.0f / TranslucentBasePass_4356;
            _337 = exp2(log2(saturate(((_291 - _303) * select((TranslucentBasePass_4388 < _291), 0.0f, 1.0f)) + _303)) * _326);
            _338 = exp2(log2(saturate(((_292 - _304) * select((TranslucentBasePass_4388 < _292), 0.0f, 1.0f)) + _304)) * _326);
            _339 = exp2(log2(saturate(((_293 - _305) * select((TranslucentBasePass_4388 < _293), 0.0f, 1.0f)) + _305)) * _326);
          } else {
            _337 = _284;
            _338 = _285;
            _339 = _286;
          ...
          if (TranslucentBasePass_4368 == 3.0f) {
            float _344 = TranslucentBasePass_4396 * _337;
            float _345 = TranslucentBasePass_4396 * _338;
            float _346 = TranslucentBasePass_4396 * _339;
            float _381 = exp2(log2(abs(_344)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_344 > 0.0f))) - ((int)(uint)((bool)(_344 < 0.0f)))));
            float _382 = exp2(log2(abs(_345)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_345 > 0.0f))) - ((int)(uint)((bool)(_345 < 0.0f)))));
            float _383 = exp2(log2(abs(_346)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_346 > 0.0f))) - ((int)(uint)((bool)(_346 < 0.0f)))));
            float _384 = TranslucentBasePass_4400 * 5.340000152587891f;
            float _385 = _381 * _384;
            float _386 = _382 * _384;
            float _387 = _383 * _384;
            float _409 = TranslucentBasePass_4404 + -0.0004396551812533289f;
            float _418 = 1.0f / TranslucentBasePass_4356;
            _429 = exp2(log2(saturate(_409 + ((((_385 + 2.609099864959717f) * _381) + 0.0013464000076055527f) / (((_385 + 1.1699999570846558f) * _381) + 3.0624001026153564f)))) * _418);
            _430 = exp2(log2(saturate(_409 + ((((_386 + 2.609099864959717f) * _382) + 0.0013464000076055527f) / (((_386 + 1.1699999570846558f) * _382) + 3.0624001026153564f)))) * _418);
            _431 = exp2(log2(saturate(_409 + ((((_387 + 2.609099864959717f) * _383) + 0.0013464000076055527f) / (((_387 + 1.1699999570846558f) * _383) + 3.0624001026153564f)))) * _418);
          } else {
            _429 = _337;
            _430 = _338;
            _431 = _339;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _429), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _430), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _431), 0.0f));
  SV_Target.w = _187;
