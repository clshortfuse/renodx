...
float4 main(
  ...
  float4 SV_Target;
  float _55 = mad(SV_Position.z, (View_704[2].w), mad(SV_Position.y, (View_704[1].w), ((View_704[0].w) * SV_Position.x))) + (View_704[3].w);
  float _59 = ((mad(SV_Position.z, (View_704[2].x), mad(SV_Position.y, (View_704[1].x), ((View_704[0].x) * SV_Position.x))) + (View_704[3].x)) / _55) - View_1120.x;
  float _60 = ((mad(SV_Position.z, (View_704[2].y), mad(SV_Position.y, (View_704[1].y), ((View_704[0].y) * SV_Position.x))) + (View_704[3].y)) / _55) - View_1120.y;
  float _61 = ((mad(SV_Position.z, (View_704[2].z), mad(SV_Position.y, (View_704[1].z), ((View_704[0].z) * SV_Position.x))) + (View_704[3].z)) / _55) - View_1120.z;
  float _70;
  float _71;
  float _72;
  float _106;
  ...
  float4 _75 = t0.SampleBias(s0, float2(TEXCOORD.x, TEXCOORD.y), View_2388, int2(0, 0));
  if ((Material_032[0].x) > 0.5f) {
  ...
  float _110 = _107 * _71;
  float _111 = _108 * _72;
  float _127 = saturate(_75.w * COLOR.w);
  float _128 = max(((((Material_000[1].x) - _109) * (Material_032[0].y)) + _109), 0.0f);
  float _129 = max(((((Material_000[1].y) - _110) * (Material_032[0].y)) + _110), 0.0f);
  float _130 = max(((((Material_000[1].z) - _111) * (Material_032[0].y)) + _111), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_61 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_59 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_60 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      float _162 = float((bool)(bool)(frac(dot(float3(_59, _60, _61), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _165 = 1.0f;
      _166 = (1.0f - _162);
      _167 = 1.0f;
      _168 = _162;
  ...
  if (!(TranslucentBasePass_4352 == 0)) {
    do {
      ...
      if (TranslucentBasePass_4368 == 0.0f) {
        float _192 = 1.0f / TranslucentBasePass_4356;
        _203 = exp2(log2(1.0f - exp2((_166 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _192);
        _204 = exp2(log2(1.0f - exp2((_167 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _192);
        _205 = exp2(log2(1.0f - exp2((_168 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _192);
      } else {
        _203 = _166;
        _204 = _167;
        _205 = _168;
      ...
      do {
        ...
        if (TranslucentBasePass_4368 == 1.0f) {
          float _209 = TranslucentBasePass_4372 * _203;
          float _210 = TranslucentBasePass_4372 * _204;
          float _211 = TranslucentBasePass_4372 * _205;
          float _213 = TranslucentBasePass_4376 * 1.3600000143051147f;
          float _214 = TranslucentBasePass_4376 * 0.9599999785423279f;
          float _251 = 1.0f / TranslucentBasePass_4356;
          _262 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_213 * _209) + 0.04699999839067459f) * _209) / ((((_214 * _209) + 0.5600000023841858f) * _209) + 0.14000000059604645f)))) * _251);
          _263 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_213 * _210) + 0.04699999839067459f) * _210) / ((((_214 * _210) + 0.5600000023841858f) * _210) + 0.14000000059604645f)))) * _251);
          _264 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_213 * _211) + 0.04699999839067459f) * _211) / ((((_214 * _211) + 0.5600000023841858f) * _211) + 0.14000000059604645f)))) * _251);
        } else {
          _262 = _203;
          _263 = _204;
          _264 = _205;
        ...
        do {
          ...
          if (TranslucentBasePass_4368 == 2.0f) {
            float _269 = TranslucentBasePass_4384 * _262;
            float _270 = TranslucentBasePass_4384 * _263;
            float _271 = TranslucentBasePass_4384 * _264;
            float _277 = TranslucentBasePass_4392 * -0.16398000717163086f;
            float _281 = (_277 / (_269 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _282 = (_277 / (_270 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _283 = (_277 / (_271 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _304 = 1.0f / TranslucentBasePass_4356;
            _315 = exp2(log2(saturate(((_269 - _281) * select((TranslucentBasePass_4388 < _269), 0.0f, 1.0f)) + _281)) * _304);
            _316 = exp2(log2(saturate(((_270 - _282) * select((TranslucentBasePass_4388 < _270), 0.0f, 1.0f)) + _282)) * _304);
            _317 = exp2(log2(saturate(((_271 - _283) * select((TranslucentBasePass_4388 < _271), 0.0f, 1.0f)) + _283)) * _304);
          } else {
            _315 = _262;
            _316 = _263;
            _317 = _264;
          ...
          if (TranslucentBasePass_4368 == 3.0f) {
            float _322 = TranslucentBasePass_4396 * _315;
            float _323 = TranslucentBasePass_4396 * _316;
            float _324 = TranslucentBasePass_4396 * _317;
            float _359 = exp2(log2(abs(_322)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_322 > 0.0f))) - ((int)(uint)((bool)(_322 < 0.0f)))));
            float _360 = exp2(log2(abs(_323)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_323 > 0.0f))) - ((int)(uint)((bool)(_323 < 0.0f)))));
            float _361 = exp2(log2(abs(_324)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_324 > 0.0f))) - ((int)(uint)((bool)(_324 < 0.0f)))));
            float _362 = TranslucentBasePass_4400 * 5.340000152587891f;
            float _363 = _359 * _362;
            float _364 = _360 * _362;
            float _365 = _361 * _362;
            float _387 = TranslucentBasePass_4404 + -0.0004396551812533289f;
            float _396 = 1.0f / TranslucentBasePass_4356;
            _407 = exp2(log2(saturate(_387 + ((((_363 + 2.609099864959717f) * _359) + 0.0013464000076055527f) / (((_363 + 1.1699999570846558f) * _359) + 3.0624001026153564f)))) * _396);
            _408 = exp2(log2(saturate(_387 + ((((_364 + 2.609099864959717f) * _360) + 0.0013464000076055527f) / (((_364 + 1.1699999570846558f) * _360) + 3.0624001026153564f)))) * _396);
            _409 = exp2(log2(saturate(_387 + ((((_365 + 2.609099864959717f) * _361) + 0.0013464000076055527f) / (((_365 + 1.1699999570846558f) * _361) + 3.0624001026153564f)))) * _396);
          } else {
            _407 = _315;
            _408 = _316;
            _409 = _317;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _407), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _408), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _409), 0.0f));
  SV_Target.w = _165;
