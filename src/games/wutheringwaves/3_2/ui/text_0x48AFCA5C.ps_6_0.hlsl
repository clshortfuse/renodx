...
float4 main(
  ...
  float4 SV_Target;
  float _62 = mad(SV_Position.z, (View_704[2].w), mad(SV_Position.y, (View_704[1].w), ((View_704[0].w) * SV_Position.x))) + (View_704[3].w);
  float _66 = ((mad(SV_Position.z, (View_704[2].x), mad(SV_Position.y, (View_704[1].x), ((View_704[0].x) * SV_Position.x))) + (View_704[3].x)) / _62) - View_1120.x;
  float _67 = ((mad(SV_Position.z, (View_704[2].y), mad(SV_Position.y, (View_704[1].y), ((View_704[0].y) * SV_Position.x))) + (View_704[3].y)) / _62) - View_1120.y;
  float _68 = ((mad(SV_Position.z, (View_704[2].z), mad(SV_Position.y, (View_704[1].z), ((View_704[0].z) * SV_Position.x))) + (View_704[3].z)) / _62) - View_1120.z;
  float _69 = TEXCOORD_9.x - View_1120.x;
  float _70 = TEXCOORD_9.y - View_1120.y;
  float _71 = TEXCOORD_9.z - View_1120.z;
  float _80;
  float _81;
  float _82;
  float _133;
  ...
  float4 _85 = t0.SampleBias(s0, float2(TEXCOORD.x, TEXCOORD.y), View_2388, int2(0, 0));
  float _88 = max(_85.x, _85.y);
  float _89 = ceil(_88);
  float _93 = ceil(TEXCOORD.z);
  float4 _98 = t1.SampleBias(s1, float2((TEXCOORD.z + -1.0f), (TEXCOORD.w + -1.0f)), View_2388, int2(0, 0));
  float _103 = _98.x * _93;
  float _104 = _98.y * _93;
  float _105 = _98.z * _93;
  if ((Material_144[0].x) > 0.5f) {
    _133 = max(((exp2(log2(max(_103, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _134 = max(((exp2(log2(max(_104, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _135 = max(((exp2(log2(max(_105, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
  } else {
    _133 = _103;
    _134 = _104;
    _135 = _105;
  }
  float _136 = _133 + (_89 * _80);
  float _137 = _134 + (_89 * _81);
  float _138 = _135 + (_89 * _82);
  float _167 = ((SV_Position.x - View_2144.x) * View_2160.z) - (Material_000[3].x);
  float _168 = (1.0f - ((SV_Position.y - View_2144.y) * View_2160.w)) - (Material_000[3].y);
  float _170 = ((_98.w * _93) + _88) * COLOR.w;
  float _199 = mad(_71, (Primitive_096[2].x), mad(_70, (Primitive_096[1].x), ((Primitive_096[0].x) * _69))) + (Primitive_096[3].x);
  float _203 = mad(_71, (Primitive_096[2].y), mad(_70, (Primitive_096[1].y), ((Primitive_096[0].y) * _69))) + (Primitive_096[3].y);
  float _232 = saturate(((1.0f - saturate(((_203 - (Material_000[4].y)) - (Material_000[3].y)) / (Material_000[8].y))) - saturate((((-0.0f - _203) - (Material_000[4].y)) + (Material_000[3].y)) / (Material_000[8].w))) * ((1.0f - saturate((((-0.0f - _199) - (Material_000[4].x)) + (Material_000[3].x)) / (Material_000[8].x))) - saturate(((_199 - (Material_000[4].x)) - (Material_000[3].x)) / (Material_000[8].z))));
  float _236 = (_232 * _232) * (3.0f - (_232 * 2.0f));
  float _253 = saturate(select(((bool)(abs((Material_144[2].w) + -0.5f) > 9.999999747378752e-06f) && (bool)((Material_144[2].w) >= 0.5f)), select(((bool)(_168 > (Material_000[4].y)) || ((bool)((bool)(_167 > (Material_000[4].x)) || ((bool)((bool)(_167 < (-0.0f - (Material_000[4].x))) || (bool)(_168 < (-0.0f - (Material_000[4].y)))))))), 0.0f, _170), (select(((bool)(abs(Material_144[2].z) > 9.999999747378752e-06f) && (bool)((Material_144[2].z) >= 0.0f)), (1.0f - _236), _236) * _170)));
  float _254 = max(((((Material_000[1].x) - _136) * (Material_144[0].y)) + _136), 0.0f);
  float _255 = max(((((Material_000[1].y) - _137) * (Material_144[0].y)) + _137), 0.0f);
  float _256 = max(((((Material_000[1].z) - _138) * (Material_144[0].y)) + _138), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_68 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_66 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_67 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      float _288 = float((bool)(bool)(frac(dot(float3(_66, _67, _68), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _291 = 1.0f;
      _292 = (1.0f - _288);
      _293 = 1.0f;
      _294 = _288;
  ...
  if (!(TranslucentBasePass_4352 == 0)) {
    do {
      ...
      if (TranslucentBasePass_4368 == 0.0f) {
        float _318 = 1.0f / TranslucentBasePass_4356;
        _329 = exp2(log2(1.0f - exp2((_292 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _318);
        _330 = exp2(log2(1.0f - exp2((_293 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _318);
        _331 = exp2(log2(1.0f - exp2((_294 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _318);
      } else {
        _329 = _292;
        _330 = _293;
        _331 = _294;
      ...
      do {
        ...
        if (TranslucentBasePass_4368 == 1.0f) {
          float _335 = TranslucentBasePass_4372 * _329;
          float _336 = TranslucentBasePass_4372 * _330;
          float _337 = TranslucentBasePass_4372 * _331;
          float _339 = TranslucentBasePass_4376 * 1.3600000143051147f;
          float _340 = TranslucentBasePass_4376 * 0.9599999785423279f;
          float _377 = 1.0f / TranslucentBasePass_4356;
          _388 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_339 * _335) + 0.04699999839067459f) * _335) / ((((_340 * _335) + 0.5600000023841858f) * _335) + 0.14000000059604645f)))) * _377);
          _389 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_339 * _336) + 0.04699999839067459f) * _336) / ((((_340 * _336) + 0.5600000023841858f) * _336) + 0.14000000059604645f)))) * _377);
          _390 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_339 * _337) + 0.04699999839067459f) * _337) / ((((_340 * _337) + 0.5600000023841858f) * _337) + 0.14000000059604645f)))) * _377);
        } else {
          _388 = _329;
          _389 = _330;
          _390 = _331;
        ...
        do {
          ...
          if (TranslucentBasePass_4368 == 2.0f) {
            float _395 = TranslucentBasePass_4384 * _388;
            float _396 = TranslucentBasePass_4384 * _389;
            float _397 = TranslucentBasePass_4384 * _390;
            float _403 = TranslucentBasePass_4392 * -0.16398000717163086f;
            float _407 = (_403 / (_395 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _408 = (_403 / (_396 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _409 = (_403 / (_397 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _430 = 1.0f / TranslucentBasePass_4356;
            _441 = exp2(log2(saturate(((_395 - _407) * select((TranslucentBasePass_4388 < _395), 0.0f, 1.0f)) + _407)) * _430);
            _442 = exp2(log2(saturate(((_396 - _408) * select((TranslucentBasePass_4388 < _396), 0.0f, 1.0f)) + _408)) * _430);
            _443 = exp2(log2(saturate(((_397 - _409) * select((TranslucentBasePass_4388 < _397), 0.0f, 1.0f)) + _409)) * _430);
          } else {
            _441 = _388;
            _442 = _389;
            _443 = _390;
          ...
          if (TranslucentBasePass_4368 == 3.0f) {
            float _448 = TranslucentBasePass_4396 * _441;
            float _449 = TranslucentBasePass_4396 * _442;
            float _450 = TranslucentBasePass_4396 * _443;
            float _485 = exp2(log2(abs(_448)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_448 > 0.0f))) - ((int)(uint)((bool)(_448 < 0.0f)))));
            float _486 = exp2(log2(abs(_449)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_449 > 0.0f))) - ((int)(uint)((bool)(_449 < 0.0f)))));
            float _487 = exp2(log2(abs(_450)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_450 > 0.0f))) - ((int)(uint)((bool)(_450 < 0.0f)))));
            float _488 = TranslucentBasePass_4400 * 5.340000152587891f;
            float _489 = _485 * _488;
            float _490 = _486 * _488;
            float _491 = _487 * _488;
            float _513 = TranslucentBasePass_4404 + -0.0004396551812533289f;
            float _522 = 1.0f / TranslucentBasePass_4356;
            _533 = exp2(log2(saturate(_513 + ((((_489 + 2.609099864959717f) * _485) + 0.0013464000076055527f) / (((_489 + 1.1699999570846558f) * _485) + 3.0624001026153564f)))) * _522);
            _534 = exp2(log2(saturate(_513 + ((((_490 + 2.609099864959717f) * _486) + 0.0013464000076055527f) / (((_490 + 1.1699999570846558f) * _486) + 3.0624001026153564f)))) * _522);
            _535 = exp2(log2(saturate(_513 + ((((_491 + 2.609099864959717f) * _487) + 0.0013464000076055527f) / (((_491 + 1.1699999570846558f) * _487) + 3.0624001026153564f)))) * _522);
          } else {
            _533 = _441;
            _534 = _442;
            _535 = _443;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _533), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _534), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _535), 0.0f));
  SV_Target.w = _291;
