...
float4 main(
  ...
  float4 _116 = t0.SampleBias(s0, float2((((Material_000[4].x) * min(max(frac(((Material_000[5].x) * ((TEXCOORD.x - (Material_000[3].x)) / (Material_000[4].x))) + (Material_000[6].x)), (Material_256[0].y)), (Material_256[2].z))) + (Material_000[3].x)), (((Material_000[4].y) * min(max(frac(((Material_000[5].y) * ((TEXCOORD.y - (Material_000[3].y)) / (Material_000[4].y))) + (Material_000[6].y)), (Material_256[0].y)), (Material_256[2].z))) + (Material_000[3].y))), View_2388, int2(0, 0));
  if ((Material_256[0].x) > 0.5f) {
    _147 = max(((exp2(log2(max(_116.x, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _148 = max(((exp2(log2(max(_116.y, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _149 = max(((exp2(log2(max(_116.z, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
  } else {
    _147 = _116.x;
    _148 = _116.y;
    _149 = _116.z;
  ...
  float _151 = _148 * _79;
  float _152 = _149 * _80;
  float _168 = _116.w * COLOR.w;
  float _184 = mad(_69, (Primitive_096[2].x), mad(_68, (Primitive_096[1].x), ((Primitive_096[0].x) * _67))) + (Primitive_096[3].x);
  float _188 = mad(_69, (Primitive_096[2].y), mad(_68, (Primitive_096[1].y), ((Primitive_096[0].y) * _67))) + (Primitive_096[3].y);
  float _211 = saturate((1.0f - saturate((abs(_188 - (Material_000[10].y)) - (Material_000[11].y)) / (Material_000[12].y))) * (1.0f - saturate((abs(_184 - (Material_000[10].x)) - (Material_000[11].x)) / (Material_000[12].x))));
  float _215 = (_211 * _211) * (3.0f - (_211 * 2.0f));
  float _227 = select(((Material_256[4].w) > 0.5f), (select(((bool)(abs(Material_256[4].z) > 9.999999747378752e-06f) && (bool)((Material_256[4].z) >= 0.0f)), (1.0f - _215), _215) * _168), _168);
  float4 _241 = t1.SampleBias(s1, float2(((_184 - (Material_000[14].x)) / (Material_000[15].x)), (1.0f - ((_188 - (Material_000[14].y)) / (Material_000[15].y)))), View_2388, int2(0, 0));
  float _248 = saturate(select(((Material_256[6].x) > 0.5f), (_241.x * _227), _227));
  float _249 = max(((((Material_000[7].x) - _150) * (Material_256[2].w)) + _150), 0.0f);
  float _250 = max(((((Material_000[7].y) - _151) * (Material_256[2].w)) + _151), 0.0f);
  float _251 = max(((((Material_000[7].z) - _152) * (Material_256[2].w)) + _152), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_66 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_64 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_65 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      float _283 = float((bool)(bool)(frac(dot(float3(_64, _65, _66), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _286 = 1.0f;
      _287 = (1.0f - _283);
      _288 = 1.0f;
      _289 = _283;
  ...
  if (!(TranslucentBasePass_4352 == 0)) {
    do {
      ...
      if (TranslucentBasePass_4368 == 0.0f) {
        float _313 = 1.0f / TranslucentBasePass_4356;
        _324 = exp2(log2(1.0f - exp2((_287 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _313);
        _325 = exp2(log2(1.0f - exp2((_288 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _313);
        _326 = exp2(log2(1.0f - exp2((_289 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _313);
      } else {
        _324 = _287;
        _325 = _288;
        _326 = _289;
      ...
      do {
        ...
        if (TranslucentBasePass_4368 == 1.0f) {
          float _330 = TranslucentBasePass_4372 * _324;
          float _331 = TranslucentBasePass_4372 * _325;
          float _332 = TranslucentBasePass_4372 * _326;
          float _334 = TranslucentBasePass_4376 * 1.3600000143051147f;
          float _335 = TranslucentBasePass_4376 * 0.9599999785423279f;
          float _372 = 1.0f / TranslucentBasePass_4356;
          _383 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_334 * _330) + 0.04699999839067459f) * _330) / ((((_335 * _330) + 0.5600000023841858f) * _330) + 0.14000000059604645f)))) * _372);
          _384 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_334 * _331) + 0.04699999839067459f) * _331) / ((((_335 * _331) + 0.5600000023841858f) * _331) + 0.14000000059604645f)))) * _372);
          _385 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_334 * _332) + 0.04699999839067459f) * _332) / ((((_335 * _332) + 0.5600000023841858f) * _332) + 0.14000000059604645f)))) * _372);
        } else {
          _383 = _324;
          _384 = _325;
          _385 = _326;
        ...
        do {
          ...
          if (TranslucentBasePass_4368 == 2.0f) {
            float _390 = TranslucentBasePass_4384 * _383;
            float _391 = TranslucentBasePass_4384 * _384;
            float _392 = TranslucentBasePass_4384 * _385;
            float _398 = TranslucentBasePass_4392 * -0.16398000717163086f;
            float _402 = (_398 / (_390 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _403 = (_398 / (_391 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _404 = (_398 / (_392 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _425 = 1.0f / TranslucentBasePass_4356;
            _436 = exp2(log2(saturate(((_390 - _402) * select((TranslucentBasePass_4388 < _390), 0.0f, 1.0f)) + _402)) * _425);
            _437 = exp2(log2(saturate(((_391 - _403) * select((TranslucentBasePass_4388 < _391), 0.0f, 1.0f)) + _403)) * _425);
            _438 = exp2(log2(saturate(((_392 - _404) * select((TranslucentBasePass_4388 < _392), 0.0f, 1.0f)) + _404)) * _425);
          } else {
            _436 = _383;
            _437 = _384;
            _438 = _385;
          ...
          if (TranslucentBasePass_4368 == 3.0f) {
            float _443 = TranslucentBasePass_4396 * _436;
            float _444 = TranslucentBasePass_4396 * _437;
            float _445 = TranslucentBasePass_4396 * _438;
            float _480 = exp2(log2(abs(_443)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_443 > 0.0f))) - ((int)(uint)((bool)(_443 < 0.0f)))));
            float _481 = exp2(log2(abs(_444)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_444 > 0.0f))) - ((int)(uint)((bool)(_444 < 0.0f)))));
            float _482 = exp2(log2(abs(_445)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_445 > 0.0f))) - ((int)(uint)((bool)(_445 < 0.0f)))));
            float _483 = TranslucentBasePass_4400 * 5.340000152587891f;
            float _484 = _480 * _483;
            float _485 = _481 * _483;
            float _486 = _482 * _483;
            float _508 = TranslucentBasePass_4404 + -0.0004396551812533289f;
            float _517 = 1.0f / TranslucentBasePass_4356;
            _528 = exp2(log2(saturate(_508 + ((((_484 + 2.609099864959717f) * _480) + 0.0013464000076055527f) / (((_484 + 1.1699999570846558f) * _480) + 3.0624001026153564f)))) * _517);
            _529 = exp2(log2(saturate(_508 + ((((_485 + 2.609099864959717f) * _481) + 0.0013464000076055527f) / (((_485 + 1.1699999570846558f) * _481) + 3.0624001026153564f)))) * _517);
            _530 = exp2(log2(saturate(_508 + ((((_486 + 2.609099864959717f) * _482) + 0.0013464000076055527f) / (((_486 + 1.1699999570846558f) * _482) + 3.0624001026153564f)))) * _517);
          } else {
            _528 = _436;
            _529 = _437;
            _530 = _438;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _528), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _529), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _530), 0.0f));
  SV_Target.w = _286;
