...
cbuffer cb4 : register(b4) {
  float4 Material_000[22] : packoffset(c000.x);
  float4 Material_352[8] : packoffset(c022.x);
};
...
float4 main(
  ...
  float4 SV_Target;
  float _65 = mad(SV_Position.z, (View_704[2].w), mad(SV_Position.y, (View_704[1].w), ((View_704[0].w) * SV_Position.x))) + (View_704[3].w);
  float _69 = ((mad(SV_Position.z, (View_704[2].x), mad(SV_Position.y, (View_704[1].x), ((View_704[0].x) * SV_Position.x))) + (View_704[3].x)) / _65) - View_1120.x;
  float _70 = ((mad(SV_Position.z, (View_704[2].y), mad(SV_Position.y, (View_704[1].y), ((View_704[0].y) * SV_Position.x))) + (View_704[3].y)) / _65) - View_1120.y;
  float _71 = ((mad(SV_Position.z, (View_704[2].z), mad(SV_Position.y, (View_704[1].z), ((View_704[0].z) * SV_Position.x))) + (View_704[3].z)) / _65) - View_1120.z;
  float _72 = TEXCOORD_9.x - View_1120.x;
  float _73 = TEXCOORD_9.y - View_1120.y;
  float _74 = TEXCOORD_9.z - View_1120.z;
  float _77 = (Material_352[0].x) + 1.0f;
  float _83 = (_77 * COLOR_1.x) * (Material_000[3].x);
  float _85 = (_77 * COLOR_1.y) * (Material_000[3].y);
  float _87 = (_77 * COLOR_1.z) * (Material_000[3].z);
  float _98 = (SV_Position.x - View_2144.x) * View_2160.z;
  float _99 = (SV_Position.y - View_2144.y) * View_2160.w;
  float _107 = _98 - (Primitive_432[0].w);
  float _108 = (1.0f - _99) - (Primitive_432[1].x);
  float _115 = ((Material_352[1].x) * (TEXCOORD.w - TEXCOORD.x)) + TEXCOORD.x;
  float _116 = ((Material_352[1].x) * (TEXCOORD.z - TEXCOORD.y)) + TEXCOORD.y;
  float _123 = (_115 + -0.5f) + ((_98 - _115) * (Material_352[1].y));
  float _125 = (_116 + -0.5f) + ((_99 - _116) * (Material_352[1].y));
  float _145 = NIAGARA_LOCAL_TIME * 0.00027777778450399637f;
  float _149 = frac(abs(_145));
  float _152 = select((_145 >= (-0.0f - _145)), _149, (-0.0f - _149)) * 3600.0f;
  float _157 = ((((Material_352[5].x) - _152) * (Material_352[4].w)) + _152) * (Material_352[5].y);
  float _164 = (_157 + select(((NiagaraMeshVF_068 & 1) != 0), COLOR_2.y, 0.0f)) - (_157 * (Material_352[5].z));
  float _178 = (((Material_000[15].x) + ((Material_000[13].x) * (dot(float2(_123, _125), float2((Material_000[7].x), (Material_000[7].y))) + 0.5f))) + (Material_000[17].x)) + (_164 * (Material_000[14].x));
  float _181 = (((Material_000[15].y) + ((Material_000[13].y) * (dot(float2(_123, _125), float2((Material_000[8].x), (Material_000[8].y))) + 0.5f))) + (Material_000[17].y)) + (_164 * (Material_000[14].y));
  float4 _198 = t0.SampleLevel(s0, float2(((_178 + (Material_000[18].x)) + ((saturate(_178) - _178) * (Material_352[5].z))), ((_181 + (Material_000[18].y)) + ((saturate(_181) - _181) * (Material_352[5].z)))), (View_2388 + -1.0f));
  float _208 = dot(float4(_198.x, _198.y, _198.z, _198.w), float4((Material_000[20].x), (Material_000[20].y), (Material_000[20].z), (Material_000[20].w)));
  float _219 = (((Material_352[6].y) * COLOR_1.w) * (((Material_352[6].x) * ((_208 * -2.0f) + 1.0f)) + _208)) * (Material_352[6].z);
  float _305;
  float _306;
  float _307;
  float _382;
  ...
  if ((Primitive_432[0].x) > 0.5f) {
    _305 = max(((exp2(log2(max(_83, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _306 = max(((exp2(log2(max(_85, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _307 = max(((exp2(log2(max(_87, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
  } else {
    _305 = _83;
    _306 = _85;
    _307 = _87;
  }
  float _326 = (((Primitive_432[7].w) * ((Primitive_432[6].w) + -1.0f)) + 1.0f) * _305;
  float _327 = (((Primitive_432[7].w) * ((Primitive_432[7].x) + -1.0f)) + 1.0f) * _306;
  float _328 = (((Primitive_432[7].w) * ((Primitive_432[7].y) + -1.0f)) + 1.0f) * _307;
  float _344 = saturate((((Primitive_432[7].w) * ((Primitive_432[7].z) + -1.0f)) + 1.0f) * select(((bool)((Primitive_432[8].y) >= 0.5f) && (bool)(abs((Primitive_432[8].y) + -0.5f) > 9.999999747378752e-06f)), select(((bool)(_108 > (Primitive_432[1].z)) || ((bool)((bool)(_107 > (Primitive_432[1].y)) || ((bool)((bool)(_107 < (-0.0f - (Primitive_432[1].y))) || (bool)(_108 < (-0.0f - (Primitive_432[1].z)))))))), 0.0f, _219), select(((Primitive_432[0].y) > 0.5f), (((1.0f - saturate((abs((((((Primitive_432[3].w) * _72) - (Primitive_432[0].w)) + (Primitive_432[4].z)) + ((Primitive_432[4].w) * _73)) + ((Primitive_432[5].w) * _74)) - (Primitive_432[1].y)) / (Primitive_432[1].w))) * _219) * (1.0f - saturate((abs((((((Primitive_432[4].x) * _72) - (Primitive_432[1].x)) + ((Primitive_432[5].x) * _73)) + (Primitive_432[5].z)) + ((Primitive_432[6].x) * _74)) - (Primitive_432[1].z)) / (Primitive_432[2].x)))), _219)));
  float _345 = max(((((Material_000[21].x) - _326) * (Material_352[6].w)) + _326), 0.0f);
  float _346 = max(((((Material_000[21].y) - _327) * (Material_352[6].w)) + _327), 0.0f);
  float _347 = max(((((Material_000[21].z) - _328) * (Material_352[6].w)) + _328), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_71 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_69 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_70 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      float _379 = float((bool)(bool)(frac(dot(float3(_69, _70, _71), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _382 = 1.0f;
      _383 = (1.0f - _379);
      _384 = 1.0f;
      _385 = _379;
  ...
  if (!(TranslucentBasePass_4352 == 0)) {
    do {
      ...
      if (TranslucentBasePass_4368 == 0.0f) {
        float _409 = 1.0f / TranslucentBasePass_4356;
        _420 = exp2(log2(1.0f - exp2((_383 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _409);
      ...
      do {
        ...
        if (TranslucentBasePass_4368 == 1.0f) {
          float _426 = TranslucentBasePass_4372 * _420;
          float _427 = TranslucentBasePass_4372 * _421;
          float _428 = TranslucentBasePass_4372 * _422;
          float _430 = TranslucentBasePass_4376 * 1.3600000143051147f;
          float _431 = TranslucentBasePass_4376 * 0.9599999785423279f;
          float _468 = 1.0f / TranslucentBasePass_4356;
          _479 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_430 * _426) + 0.04699999839067459f) * _426) / ((((_431 * _426) + 0.5600000023841858f) * _426) + 0.14000000059604645f)))) * _468);
          _480 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_430 * _427) + 0.04699999839067459f) * _427) / ((((_431 * _427) + 0.5600000023841858f) * _427) + 0.14000000059604645f)))) * _468);
          _481 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_430 * _428) + 0.04699999839067459f) * _428) / ((((_431 * _428) + 0.5600000023841858f) * _428) + 0.14000000059604645f)))) * _468);
        } else {
          _479 = _420;
          _480 = _421;
          _481 = _422;
        ...
        do {
          ...
          if (TranslucentBasePass_4368 == 2.0f) {
            float _486 = TranslucentBasePass_4384 * _479;
            float _487 = TranslucentBasePass_4384 * _480;
            float _488 = TranslucentBasePass_4384 * _481;
            float _494 = TranslucentBasePass_4392 * -0.16398000717163086f;
            float _498 = (_494 / (_486 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _499 = (_494 / (_487 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _500 = (_494 / (_488 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _521 = 1.0f / TranslucentBasePass_4356;
            _532 = exp2(log2(saturate(((_486 - _498) * select((TranslucentBasePass_4388 < _486), 0.0f, 1.0f)) + _498)) * _521);
            _533 = exp2(log2(saturate(((_487 - _499) * select((TranslucentBasePass_4388 < _487), 0.0f, 1.0f)) + _499)) * _521);
            _534 = exp2(log2(saturate(((_488 - _500) * select((TranslucentBasePass_4388 < _488), 0.0f, 1.0f)) + _500)) * _521);
          } else {
            _532 = _479;
            _533 = _480;
            _534 = _481;
          ...
          if (TranslucentBasePass_4368 == 3.0f) {
            float _539 = TranslucentBasePass_4396 * _532;
            float _540 = TranslucentBasePass_4396 * _533;
            float _541 = TranslucentBasePass_4396 * _534;
            float _576 = exp2(log2(abs(_539)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_539 > 0.0f))) - ((int)(uint)((bool)(_539 < 0.0f)))));
            float _577 = exp2(log2(abs(_540)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_540 > 0.0f))) - ((int)(uint)((bool)(_540 < 0.0f)))));
            float _578 = exp2(log2(abs(_541)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_541 > 0.0f))) - ((int)(uint)((bool)(_541 < 0.0f)))));
            float _579 = TranslucentBasePass_4400 * 5.340000152587891f;
            float _580 = _576 * _579;
            float _581 = _577 * _579;
            float _582 = _578 * _579;
            float _604 = TranslucentBasePass_4404 + -0.0004396551812533289f;
            float _613 = 1.0f / TranslucentBasePass_4356;
            _624 = exp2(log2(saturate(_604 + ((((_580 + 2.609099864959717f) * _576) + 0.0013464000076055527f) / (((_580 + 1.1699999570846558f) * _576) + 3.0624001026153564f)))) * _613);
            _625 = exp2(log2(saturate(_604 + ((((_581 + 2.609099864959717f) * _577) + 0.0013464000076055527f) / (((_581 + 1.1699999570846558f) * _577) + 3.0624001026153564f)))) * _613);
            _626 = exp2(log2(saturate(_604 + ((((_582 + 2.609099864959717f) * _578) + 0.0013464000076055527f) / (((_582 + 1.1699999570846558f) * _578) + 3.0624001026153564f)))) * _613);
          } else {
            _624 = _532;
            _625 = _533;
            _626 = _534;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _624), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _625), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _626), 0.0f));
  SV_Target.w = _382;
