...
float4 main(
  ...
  float4 _85 = t0.Sample(s0, float2((dot(float2(TEXCOORD.x, TEXCOORD.y), float2((Material_000[2].x), (Material_000[2].y))) + (Material_000[1].x)), (dot(float2(TEXCOORD.x, TEXCOORD.y), float2((Material_000[2].z), (Material_000[2].w))) + (Material_000[1].y))));
  if ((Material_064[0].x) > 0.5f) {
  ...
  float _120 = _117 * _71;
  float _121 = _118 * _72;
  float _137 = saturate(_85.w * COLOR.w);
  float _138 = max(((((Material_000[3].x) - _119) * (Material_064[0].y)) + _119), 0.0f);
  float _139 = max(((((Material_000[3].y) - _120) * (Material_064[0].y)) + _120), 0.0f);
  float _140 = max(((((Material_000[3].z) - _121) * (Material_064[0].y)) + _121), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_61 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_59 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_60 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      float _172 = float((bool)(bool)(frac(dot(float3(_59, _60, _61), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _175 = 1.0f;
      _176 = (1.0f - _172);
      _177 = 1.0f;
      _178 = _172;
  ...
  if (!(TranslucentBasePass_4352 == 0)) {
    do {
      ...
      if (TranslucentBasePass_4368 == 0.0f) {
        float _202 = 1.0f / TranslucentBasePass_4356;
        _213 = exp2(log2(1.0f - exp2((_176 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _202);
        _214 = exp2(log2(1.0f - exp2((_177 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _202);
        _215 = exp2(log2(1.0f - exp2((_178 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _202);
      } else {
        _213 = _176;
        _214 = _177;
        _215 = _178;
      ...
      do {
        ...
        if (TranslucentBasePass_4368 == 1.0f) {
          float _219 = TranslucentBasePass_4372 * _213;
          float _220 = TranslucentBasePass_4372 * _214;
          float _221 = TranslucentBasePass_4372 * _215;
          float _223 = TranslucentBasePass_4376 * 1.3600000143051147f;
          float _224 = TranslucentBasePass_4376 * 0.9599999785423279f;
          float _261 = 1.0f / TranslucentBasePass_4356;
          _272 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_223 * _219) + 0.04699999839067459f) * _219) / ((((_224 * _219) + 0.5600000023841858f) * _219) + 0.14000000059604645f)))) * _261);
          _273 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_223 * _220) + 0.04699999839067459f) * _220) / ((((_224 * _220) + 0.5600000023841858f) * _220) + 0.14000000059604645f)))) * _261);
          _274 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_223 * _221) + 0.04699999839067459f) * _221) / ((((_224 * _221) + 0.5600000023841858f) * _221) + 0.14000000059604645f)))) * _261);
        } else {
          _272 = _213;
          _273 = _214;
          _274 = _215;
        ...
        do {
          ...
          if (TranslucentBasePass_4368 == 2.0f) {
            float _279 = TranslucentBasePass_4384 * _272;
            float _280 = TranslucentBasePass_4384 * _273;
            float _281 = TranslucentBasePass_4384 * _274;
            float _287 = TranslucentBasePass_4392 * -0.16398000717163086f;
            float _291 = (_287 / (_279 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _292 = (_287 / (_280 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _293 = (_287 / (_281 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _314 = 1.0f / TranslucentBasePass_4356;
            _325 = exp2(log2(saturate(((_279 - _291) * select((TranslucentBasePass_4388 < _279), 0.0f, 1.0f)) + _291)) * _314);
            _326 = exp2(log2(saturate(((_280 - _292) * select((TranslucentBasePass_4388 < _280), 0.0f, 1.0f)) + _292)) * _314);
            _327 = exp2(log2(saturate(((_281 - _293) * select((TranslucentBasePass_4388 < _281), 0.0f, 1.0f)) + _293)) * _314);
          } else {
            _325 = _272;
            _326 = _273;
            _327 = _274;
          ...
          if (TranslucentBasePass_4368 == 3.0f) {
            float _332 = TranslucentBasePass_4396 * _325;
            float _333 = TranslucentBasePass_4396 * _326;
            float _334 = TranslucentBasePass_4396 * _327;
            float _369 = exp2(log2(abs(_332)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_332 > 0.0f))) - ((int)(uint)((bool)(_332 < 0.0f)))));
            float _370 = exp2(log2(abs(_333)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_333 > 0.0f))) - ((int)(uint)((bool)(_333 < 0.0f)))));
            float _371 = exp2(log2(abs(_334)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_334 > 0.0f))) - ((int)(uint)((bool)(_334 < 0.0f)))));
            float _372 = TranslucentBasePass_4400 * 5.340000152587891f;
            float _373 = _369 * _372;
            float _374 = _370 * _372;
            float _375 = _371 * _372;
            float _397 = TranslucentBasePass_4404 + -0.0004396551812533289f;
            float _406 = 1.0f / TranslucentBasePass_4356;
            _417 = exp2(log2(saturate(_397 + ((((_373 + 2.609099864959717f) * _369) + 0.0013464000076055527f) / (((_373 + 1.1699999570846558f) * _369) + 3.0624001026153564f)))) * _406);
            _418 = exp2(log2(saturate(_397 + ((((_374 + 2.609099864959717f) * _370) + 0.0013464000076055527f) / (((_374 + 1.1699999570846558f) * _370) + 3.0624001026153564f)))) * _406);
            _419 = exp2(log2(saturate(_397 + ((((_375 + 2.609099864959717f) * _371) + 0.0013464000076055527f) / (((_375 + 1.1699999570846558f) * _371) + 3.0624001026153564f)))) * _406);
          } else {
            _417 = _325;
            _418 = _326;
            _419 = _327;
  ...
  float3 _video_hdr = AutoHDRVideo(float3(_417, _418, _419), SV_Position.xy);
