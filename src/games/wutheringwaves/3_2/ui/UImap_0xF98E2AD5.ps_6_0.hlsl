...
float4 main(
  ...
  float4 SV_Target;
  float _84 = mad(SV_Position.z, (View_704[2].w), mad(SV_Position.y, (View_704[1].w), ((View_704[0].w) * SV_Position.x))) + (View_704[3].w);
  float _88 = ((mad(SV_Position.z, (View_704[2].x), mad(SV_Position.y, (View_704[1].x), ((View_704[0].x) * SV_Position.x))) + (View_704[3].x)) / _84) - View_1120.x;
  float _89 = ((mad(SV_Position.z, (View_704[2].y), mad(SV_Position.y, (View_704[1].y), ((View_704[0].y) * SV_Position.x))) + (View_704[3].y)) / _84) - View_1120.y;
  float _90 = ((mad(SV_Position.z, (View_704[2].z), mad(SV_Position.y, (View_704[1].z), ((View_704[0].z) * SV_Position.x))) + (View_704[3].z)) / _84) - View_1120.z;
  float _91 = TEXCOORD_9.x - View_1120.x;
  float _92 = TEXCOORD_9.y - View_1120.y;
  float _93 = TEXCOORD_9.z - View_1120.z;
  float _102 = ((Material_000[2].x) * TEXCOORD.x) + (Material_000[3].x);
  float _103 = ((Material_000[2].y) * TEXCOORD.y) + (Material_000[3].y);
  float4 _106 = t1.SampleBias(s1, float2(_102, _103), View_2388, int2(0, 0));
  float4 _111 = t2.SampleBias(s2, float2(_102, _103), View_2388, int2(0, 0));
  float _118 = (Material_128[1].x) * _111.w;
  float _128 = ((_118 * (_111.x - _106.x)) + _106.x) * COLOR.x;
  float _129 = ((_118 * (_111.y - _106.y)) + _106.y) * COLOR.y;
  float _130 = ((_118 * (_111.z - _106.z)) + _106.z) * COLOR.z;
  float _160;
  float _161;
  float _162;
  float _274;
  ...
  float4 _210 = t3.SampleBias(s3, float2((((mad(_93, (Primitive_096[2].x), mad(_92, (Primitive_096[1].x), ((Primitive_096[0].x) * _91))) + (Primitive_096[3].x)) - (Material_000[6].x)) / (Material_000[7].x)), (1.0f - (((mad(_93, (Primitive_096[2].y), mad(_92, (Primitive_096[1].y), ((Primitive_096[0].y) * _91))) + (Primitive_096[3].y)) - (Material_000[6].y)) / (Material_000[7].y)))), View_2388, int2(0, 0));
  float _217 = saturate((((_118 * (_111.w - _106.w)) + _106.w) * COLOR.w) * saturate((Material_128[2].w) * _210.x));
  if (TranslucentBasePass_3196 > 0.0f) {
    float _225 = mad(_90, (View_064[2].w), mad(_89, (View_064[1].w), (_88 * (View_064[0].w)))) + (View_064[3].w);
    float4 _261 = t0.SampleLevel(s0, float3(min((((((mad(_90, (View_064[2].x), mad(_89, (View_064[1].x), (_88 * (View_064[0].x)))) + (View_064[3].x)) / _225) * 0.5f) + 0.5f) * View_3968.x), View_3976.x), min(((0.5f - (((mad(_90, (View_064[2].y), mad(_89, (View_064[1].y), (_88 * (View_064[0].y)))) + (View_064[3].y)) / _225) * 0.5f)) * View_3968.y), View_3976.y), min(((log2((View_3888.x * _225) + View_3888.y) * View_3888.z) * View_3872.z), 1.0f)), 0.0f);
    _274 = ((_261.w * TEXCOORD_7.x) + _261.x);
    _275 = ((_261.w * TEXCOORD_7.y) + _261.y);
    _276 = ((_261.w * TEXCOORD_7.z) + _261.z);
    _277 = (_261.w * TEXCOORD_7.w);
  } else {
    _274 = TEXCOORD_7.x;
    _275 = TEXCOORD_7.y;
    _276 = TEXCOORD_7.z;
  ...
  float _278 = max(((((Material_000[4].x) - _160) * (Material_128[1].z)) + _160), 0.0f);
  float _279 = max(((((Material_000[4].y) - _161) * (Material_128[1].z)) + _161), 0.0f);
  float _280 = max(((((Material_000[4].z) - _162) * (Material_128[1].z)) + _162), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_90 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_88 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_89 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      float _312 = float((bool)(bool)(frac(dot(float3(_88, _89, _90), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _315 = 1.0f;
      _316 = (1.0f - _312);
      _317 = 1.0f;
      _318 = _312;
  ...
  float _322 = (_316 * _277) + _274;
  float _323 = (_317 * _277) + _275;
  float _324 = (_318 * _277) + _276;
  float _327 = dot(float3(_322, _323, _324), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f));
  float _341 = (lerp(_322, _327, View_4460)) * View_4432.x;
  float _342 = (lerp(_323, _327, View_4460)) * View_4432.y;
  float _343 = (lerp(_324, _327, View_4460)) * View_4432.z;
  if (Primitive_684 == 0) {
    float _350 = dot(float3(_341, _342, _343), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f));
    _368 = ((lerp(_341, _350, View_4496)) * View_4480.x);
    _369 = ((lerp(_342, _350, View_4496)) * View_4480.y);
    _370 = ((lerp(_343, _350, View_4496)) * View_4480.z);
  } else {
    _368 = _341;
    _369 = _342;
    _370 = _343;
  }
  SV_Target.x = (-0.0f - min((-0.0f - _368), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _369), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _370), 0.0f));
  SV_Target.w = _315;
