...
float4 main(
  ...
  float lut_sampling_scale = wuwa::lut::PrepareLinearInput(_1285, _1286, _1287);
  ...
  float lut_sample_max_channel = wuwa::lut::NormalizeEncodedInput(_1298, _1309, _1320);
  ...
  wuwa::lut::ApplySampleMaxChannel(_1386, _1387, _1388, lut_sample_max_channel);
  ...
  wuwa::lut::ApplyLutStrength(_1447, _1448, _1449, ungraded);
  ...
  if (cb0_074z == 0) {
    ...
    if (cb0_074z == 1) {
      ...
      bool _1561 = (cb0_074z == 5);
      if ((bool)(cb0_074z == 3) || _1561) {
        ...
        float _1614 = ((float((int)(((int)(uint)((bool)(_1599 > 0.0f))) - ((int)(uint)((bool)(_1599 < 0.0f))))) * (1.0f - (_1603 * _1603))) + 1.0f) * 0.02500000037252903f;
        do {
            ...
            do {
              ...
              do {
                if ((bool)(_1670 > -67.5f) && (bool)(_1670 < 67.5f)) {
                  ...
                  int _1677 = int(_1676);
                  float _1679 = _1676 - float((int)(_1677));
                      ...
                      do {
                        if (!(!(_1944 <= -3.848327875137329f))) {
                          ...
                          if ((bool)(_1944 > -3.848327875137329f) && (bool)(_1944 < 0.6812411546707153f)) {
                            ...
                            int _1956 = int(_1955);
                            float _1958 = _1955 - float((int)(_1956));
                        ...
                        do {
                          if (!(!(_2009 <= -3.848327875137329f))) {
                            ...
                            if ((bool)(_2009 > -3.848327875137329f) && (bool)(_2009 < 0.6812411546707153f)) {
                              ...
                              int _2021 = int(_2020);
                              float _2023 = _2020 - float((int)(_2021));
                          ...
                          do {
                            if (!(!(_2074 <= -3.848327875137329f))) {
                              ...
                              if ((bool)(_2074 > -3.848327875137329f) && (bool)(_2074 < 0.6812411546707153f)) {
                                ...
                                int _2086 = int(_2085);
                                float _2088 = _2085 - float((int)(_2086));
                                ...
                                if ((bool)(_2074 >= 0.6812411546707153f) && (bool)(_2074 < 3.653702974319458f)) {
                                  ...
                                  int _2111 = int(_2110);
                                  float _2113 = _2110 - float((int)(_2111));
        ...
        if ((cb0_074z & -3) == 4) {
          ...
          float _2247 = ((float((int)(((int)(uint)((bool)(_2232 > 0.0f))) - ((int)(uint)((bool)(_2232 < 0.0f))))) * (1.0f - (_2236 * _2236))) + 1.0f) * 0.02500000037252903f;
          do {
                    ...
                    if (!(_2382 <= -5.2601776123046875f)) {
                      if ((bool)(_2382 > -5.2601776123046875f) && (bool)(_2382 < -0.7447274923324585f)) {
                        ...
                        if ((bool)(_2382 >= -0.7447274923324585f) && (bool)(_2382 < 4.673812389373779f)) {
                          ...
                          int _2416 = int(_2415);
                          float _2418 = _2415 - float((int)(_2416));
                        ...
                        do {
                          if (!(_2577 <= -3.848327875137329f)) {
                            if ((bool)(_2577 > -3.848327875137329f) && (bool)(_2577 < 0.6812411546707153f)) {
                              ...
                              int _2586 = int(_2585);
                              float _2588 = _2585 - float((int)(_2586));
                              ...
                              if ((bool)(_2577 >= 0.6812411546707153f) && (bool)(_2577 < 3.7613162994384766f)) {
                                ...
                                int _2611 = int(_2610);
                                float _2613 = _2610 - float((int)(_2611));
                          ...
                          do {
                            if (!(_2639 <= -3.848327875137329f)) {
                              if ((bool)(_2639 > -3.848327875137329f) && (bool)(_2639 < 0.6812411546707153f)) {
                                ...
                                int _2648 = int(_2647);
                                float _2650 = _2647 - float((int)(_2648));
                            ...
                            do {
                              if (!(_2701 <= -3.848327875137329f)) {
                                if ((bool)(_2701 > -3.848327875137329f) && (bool)(_2701 < 0.6812411546707153f)) {
                                  ...
                                  int _2710 = int(_2709);
                                  float _2712 = _2709 - float((int)(_2710));
