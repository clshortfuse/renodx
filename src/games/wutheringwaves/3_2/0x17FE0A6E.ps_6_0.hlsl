...
float4 main(
  ...
  float _720 = (((_626 + ((_545 * TEXCOORD_1.x) * cb0_087x)) * _385) * ((_668 * (_669 - cb0_090x)) + cb0_090x)) * ((_707 * (_708 - cb0_093x)) + cb0_093x);
  float _723 = (((_627 + ((_546 * TEXCOORD_1.x) * cb0_087y)) * _385) * ((_668 * (_669 - cb0_090y)) + cb0_090y)) * ((_707 * (_708 - cb0_093y)) + cb0_093y);
  float _726 = (((_628 + ((_547 * TEXCOORD_1.x) * cb0_087z)) * _385) * ((_668 * (_669 - cb0_090z)) + cb0_090z)) * ((_707 * (_708 - cb0_093z)) + cb0_093z);

  CAPTURE_UNTONEMAPPED(float3(_720, _723, _726));
  [branch]
  if (WUWA_TM_IS(1)) {
    _759 = ((((_720 * 1.3600000143051147f) + 0.04699999839067459f) * _720) / ((((_720 * 0.9599999785423279f) + 0.5600000023841858f) * _720) + 0.14000000059604645f));
    _760 = ((((_723 * 1.3600000143051147f) + 0.04699999839067459f) * _723) / ((((_723 * 0.9599999785423279f) + 0.5600000023841858f) * _723) + 0.14000000059604645f));
    _761 = ((((_726 * 1.3600000143051147f) + 0.04699999839067459f) * _726) / ((((_726 * 0.9599999785423279f) + 0.5600000023841858f) * _726) + 0.14000000059604645f));
  } else {
    _759 = _720;
    _760 = _723;
    _761 = _726;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _771 = 1.0049500465393066f - (0.16398000717163086f / (_759 + -0.19505000114440918f));
    ...
    _793 = (((_759 - _771) * select((_759 > 0.6000000238418579f), 0.0f, 1.0f)) + _771);
    _794 = (((_760 - _772) * select((_760 > 0.6000000238418579f), 0.0f, 1.0f)) + _772);
    _795 = (((_761 - _773) * select((_761 > 0.6000000238418579f), 0.0f, 1.0f)) + _773);
  } else {
    _793 = _759;
    _794 = _760;
    _795 = _761;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _801 = cb0_037y * _793;
    float _802 = cb0_037y * _794;
    float _803 = cb0_037y * _795;
    float _806 = cb0_037z * cb0_037w;
    float _816 = cb0_038y * cb0_038x;
    float _827 = cb0_038z * cb0_038x;
    float _834 = cb0_038y / cb0_038z;
    _842 = (((((_806 + _801) * _793) + _816) / (_827 + ((_801 + cb0_037z) * _793))) - _834);
    _843 = (((((_806 + _802) * _794) + _816) / (_827 + ((_802 + cb0_037z) * _794))) - _834);
    _844 = (((((_806 + _803) * _795) + _816) / (_827 + ((_803 + cb0_037z) * _795))) - _834);
  } else {
    _842 = _793;
    _843 = _794;
    _844 = _795;
  ...
  if (!(cb0_106w == 0)) {
    if (!(cb0_107x == 1.0f)) {
      float _854 = (cb0_107x * 0.699999988079071f) + 0.30000001192092896f;
      _859 = (_854 * _842);
      _860 = (_854 * _843);
      _861 = (_854 * _844);
    } else {
  ...
  CLAMP_IF_SDR3(_859, _860, _861);
  CAPTURE_TONEMAPPED(float3(_859, _860, _861));
  float _882 = (saturate((log2(_859 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  ...
  float4 _885 = t7.Sample(s7, float3(_882, _883, _884));
  [branch]
  if (!(cb0_108w == 0)) {
    float4 _909 = t6.Sample(s6, float2(min(max(((cb0_084z * _427) + cb0_085x), cb0_083z), cb0_084x), min(max(((cb0_084w * _428) + cb0_085y), cb0_083w), cb0_084y)));
    float _919 = select((((uint)(uint(float((uint)((int)((uint)(uint(round(_909.w * 255.0f))) & 15))))) & -4) == 12), 1.0f, 0.0f);
    float4 _920 = t8.Sample(s8, float3(_882, _883, _884));
    _934 = (lerp(_920.x, _885.x, _919));
    _935 = (lerp(_920.y, _885.y, _919));
    _936 = (lerp(_920.z, _885.z, _919));
  } else {
    _934 = _885.x;
    _935 = _885.y;
    _936 = _885.z;
  }
  HANDLE_LUT_OUTPUT3_FADE(_934, _935, _936, t7, s7);
  float _937 = _936 * 1.0499999523162842f;
  float _938 = _935 * 1.0499999523162842f;
  float _939 = _934 * 1.0499999523162842f;
  float _947 = ((_339 * 0.00390625f) + -0.001953125f) + _939;
  float _948 = ((_362 * 0.00390625f) + -0.001953125f) + _938;
  float _949 = ((_363 * 0.00390625f) + -0.001953125f) + _937;
  [branch]
  if (!(cb0_107w == 0)) {
    float _961 = (pow(_947, 0.012683313339948654f));
    float _962 = (pow(_948, 0.012683313339948654f));
    float _963 = (pow(_949, 0.012683313339948654f));
    float _996 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_961 + -0.8359375f)) / (18.8515625f - (_961 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_107z));
    float _997 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_962 + -0.8359375f)) / (18.8515625f - (_962 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_107z));
    float _998 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_963 + -0.8359375f)) / (18.8515625f - (_963 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_107z));
    _1024 = min((_996 * 12.920000076293945f), ((exp2(log2(max(_996, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1025 = min((_997 * 12.920000076293945f), ((exp2(log2(max(_997, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1026 = min((_998 * 12.920000076293945f), ((exp2(log2(max(_998, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _1024 = _947;
    _1025 = _948;
    _1026 = _949;
  ...
  SV_Target.y = _1025;
  SV_Target.z = _1026;
  SV_Target.w = dot(float3(_939, _938, _937), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f));
