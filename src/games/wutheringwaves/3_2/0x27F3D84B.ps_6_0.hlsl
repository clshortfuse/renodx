...
float4 main(
  ...
  GENERATE_INVERSION(_671, _672, _673);

  float _682 = ((((_672 * 587.0f) + (_671 * 299.0f)) + (_673 * 114.0f)) * 0.0010000000474974513f) - cb0_109z;
  float _689 = saturate(float((int)(((int)(uint)((bool)(_682 > 0.0f))) - ((int)(uint)((bool)(_682 < 0.0f))))));
  float _696 = cb0_110x - _671;
  float _697 = cb0_110y - _672;
  float _698 = cb0_110z - _673;
  float _703 = (WUWA_PEAK_SCALING * cb0_111x) - _671;
  float _704 = (WUWA_PEAK_SCALING * cb0_111y) - _672;
  float _705 = (WUWA_PEAK_SCALING * cb0_111z) - _673;
  [branch]
  if (cb0_109y > 0.0f) {
    _722 = (_696 * cb0_109y);
    _723 = (_697 * cb0_109y);
