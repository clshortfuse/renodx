...
float4 main(
  ...
  float4 SV_Target;
  float _34 = cb0_065x * cb0_064w;
  float _35 = TEXCOORD_3.x * 0.5f;
  float _36 = TEXCOORD_3.y * 0.5f;
  float _107;
  float _108;
  float _116;
  float _117;
  ...
  float _1185;
  if (!(!(cb0_102x != 0.0f))) {
    float _41 = cb0_102x * 2.0f;
    do {
      if (_41 > 0.0f) {
        float _45 = abs(_41) * 0.5f;
        float _46 = tan(_45);
        float _47 = _34 * TEXCOORD_3.x;
        float _57 = rsqrt(dot(float2(_47, TEXCOORD_3.y), float2(_47, TEXCOORD_3.y)));
        float _61 = rsqrt(dot(float2(_34, 1.0f), float2(_34, 1.0f)));
        float _66 = tan((sqrt((_47 * _47) + (TEXCOORD_3.y * TEXCOORD_3.y)) / sqrt((_34 * _34) + 1.0f)) * _45);
        _107 = (((_66 * ((_57 * _47) / (_61 * _34))) / _46) * 0.5f);
        _108 = (((_66 * ((_57 * TEXCOORD_3.y) / _61)) / _46) * 0.5f);
      } else {
        if (_41 < 0.0f) {
          float _80 = sqrt(((TEXCOORD_3.y * TEXCOORD_3.y) + (TEXCOORD_3.x * TEXCOORD_3.x)) * 0.25f);
          float _85 = (((_80 * _80) * (cb0_102x * 0.699999988079071f)) + 1.0f) * _80;
          float _87 = atan(_35 / _36);
          bool _90 = (_36 < 0.0f);
          bool _91 = (_36 == 0.0f);
          bool _92 = (_35 >= 0.0f);
          bool _93 = (_35 < 0.0f);
          float _101 = select((_92 && _91), 1.5707963705062866f, select((_93 && _91), -1.5707963705062866f, select((_93 && _90), (_87 + -3.1415927410125732f), select((_92 && _90), (_87 + 3.1415927410125732f), _87))));
          _107 = (sin(_101) * _85);
          _108 = (cos(_101) * _85);
        } else {
          _107 = _35;
      ...
      _117 = (((_108 + 0.5f) * 2.0f) + -1.0f);
    } while (false);
  } else {
    _116 = TEXCOORD_3.x;
    _117 = TEXCOORD_3.y;
  }
  float _130 = ((cb0_048z * _116) + cb0_049x) * cb0_048x;
  float _131 = ((cb0_048w * _117) + cb0_049y) * cb0_048y;
  float4 _132 = t5.SampleLevel(s5, float2(_130, _131), 0.0f);
  float _144 = ((View_1040.x * _132.x) + View_1040.y) + (1.0f / ((View_1040.z * _132.x) - View_1040.w));
  float4 _145 = t4.Sample(s4, float2(_130, _131));
  float _153 = 1.0f / ((View_1040.w + _144) * View_1040.z);
  if (((bool)(!(cb0_097y == 0.0f))) || ((bool)(((bool)(((bool)(((bool)(((bool)(!(cb0_098y == 0.0f))) || ((bool)(!(cb0_102y == 0.0f))))) || ((bool)(!(cb0_103y == 0.0f))))) || ((bool)(!(cb0_104y == 0.0f))))) || ((bool)(!(cb0_105y == 0.0f)))))) {
    float _198 = 1.5f - (saturate(cb0_098z) * 1.4900000095367432f);
    float _203 = saturate(((sqrt((_117 * _117) + (_116 * _116)) - cb0_098y) - _198) / (-0.0f - _198));
    float _207 = (_203 * _203) * (3.0f - (_203 * 2.0f));
    _215 = (1.0f - (_207 * max(cb0_097y, cb0_102y)));
    _216 = (1.0f - (_207 * max(cb0_097y, cb0_103y)));
    _217 = (1.0f - (_207 * max(cb0_097y, cb0_104y)));
  } else {
    _215 = 1.0f;
    _216 = 1.0f;
    _217 = 1.0f;
  }
  bool _223 = !(cb0_097z == 0.0f);
  bool _224 = !(cb0_102z == 0.0f);
  bool _226 = !(cb0_103z == 0.0f);
  bool _228 = !(cb0_104z == 0.0f);
  if (((bool)(((bool)(((bool)(_223 || _224)) || _226)) || _228)) || ((bool)(!(cb0_105z == 0.0f)))) {
    do {
      if (_223) {
        _239 = exp2(log2(saturate(cb0_097z)) * 3.0f);
      } else {
        _239 = cb0_097z;
      }
      do {
        if (_224) {
          _246 = exp2(log2(saturate(cb0_102z)) * 3.0f);
        } else {
          _246 = cb0_102z;
        }
        do {
          if (_226) {
            _253 = exp2(log2(saturate(cb0_103z)) * 3.0f);
          } else {
            _253 = cb0_103z;
          }
          do {
            if (_228) {
              _260 = exp2(log2(saturate(cb0_104z)) * 3.0f);
            } else {
              _260 = cb0_104z;
            }
            float _261 = max(_239, _246);
            float _262 = max(_239, _253);
            float _263 = max(_239, _260);
            float _279 = saturate((_144 - (_261 * 1000.0f)) / ((_261 * 9999.990234375f) + 0.009999999776482582f));
            float _280 = saturate((_144 - (_262 * 1000.0f)) / ((_262 * 9999.990234375f) + 0.009999999776482582f));
            float _281 = saturate((_144 - (_263 * 1000.0f)) / ((_263 * 9999.990234375f) + 0.009999999776482582f));
            _295 = ((_279 * _279) * (3.0f - (_279 * 2.0f)));
            _296 = ((_280 * _280) * (3.0f - (_280 * 2.0f)));
            _297 = ((_281 * _281) * (3.0f - (_281 * 2.0f)));
          } while (false);
        } while (false);
      } while (false);
    } while (false);
  ...
  if (((bool)(((bool)(((bool)(((bool)(!(cb0_098x == 0.0f))) || ((bool)(!(cb0_103x == 0.0f))))) || ((bool)(!(cb0_104x == 0.0f))))) || ((bool)(!(cb0_105x == 0.0f))))) || ((bool)(!(cb0_106x == 0.0f)))) {
    float _318 = saturate(select((((_153 - _145.x) + ((((View_448[3].z) - _153) + ((View_448[2].z) * _144)) * select(((View_448[3].w) < 1.0f), 0.0f, 1.0f))) > 0.0005000000237487257f), 1.0f, 0.0f) + select((_145.x > 0.0005000000237487257f), 0.0f, 1.0f));
    _332 = max(_318, (1.0f - saturate(max(cb0_098x, cb0_103x))));
    _333 = max(_318, (1.0f - saturate(max(cb0_098x, cb0_104x))));
    _334 = max(_318, (1.0f - saturate(max(cb0_098x, cb0_105x))));
  } else {
    _332 = 1.0f;
    _333 = 1.0f;
    _334 = 1.0f;
  }
  float _335 = TEXCOORD_2.w * 543.3099975585938f;
  float _339 = frac(sin(_335 + TEXCOORD_2.z) * 493013.0f);
  if (cb0_097x > 0.0f) {
    _362 = ((cb0_097x * (frac((sin((TEXCOORD_2.z + 33.9900016784668f) + _335) * 493013.0f) + 7.177000045776367f) - _339)) + _339);
    _363 = ((cb0_097x * (frac((sin((TEXCOORD_2.z + 66.98999786376953f) + _335) * 493013.0f) + 14.298999786376953f) - _339)) + _339);
  } else {
    _362 = _339;
    _363 = _339;
  }
  if (cb0_100z > 0.0f) {
    _385 = (((((_297 * _217) * _334) * cb0_100z) * ((sin((((TEXCOORD_3.y * 10.0f) + 10.0f) + (_339 * 0.0020000000949949026f)) + (View_2376 * 4.0f)) * 0.5f) + 0.5f)) + 1.0f);
  } else {
    _385 = 1.0f;
  }
  float _388 = (_296 * _216) * _333;
  float _389 = _388 * cb0_100y;
  if (cb0_100y > 0.0f) {
    float _394 = View_2376 * 0.00016666666488163173f;
    float _398 = frac(abs(_394));
    float _403 = ((TEXCOORD_3.y * 111000.0f) + 111000.0f) * select((_394 >= (-0.0f - _394)), _398, (-0.0f - _398));
    float _409 = (0.5f - frac(sin(dot(float2(_403, _403), float2(12.989800453186035f, 78.23300170898438f))) * 43758.546875f)) * 0.014999999664723873f;
    _416 = (((_389 * 0.5f) * _409) + _130);
    _417 = ((_409 * _389) + _131);
  } else {
    _416 = _130;
    _417 = _131;
  }
  float _422 = cb0_096z * (1.0f - (_339 * _339));
  float _427 = (_422 * (TEXCOORD_2.x - _416)) + _416;
  float _428 = (_422 * (TEXCOORD_2.y - _417)) + _417;
  float _443 = _427 - (((cb0_048z * _116) + cb0_049x) * cb0_048x);
  float _444 = _428 - (((cb0_048w * _117) + cb0_049y) * cb0_048y);
  float _454 = cb0_118z * cb0_117x;
  float _455 = cb0_118z * cb0_117y;
  bool _456 = (cb0_118x == 0.0f);
  float _466 = (cb0_114z * _116) + cb0_114x;
  float _467 = (cb0_114w * _117) + cb0_114y;
  float _478 = float((int)(((int)(uint)((bool)(_466 > 0.0f))) - ((int)(uint)((bool)(_466 < 0.0f)))));
  float _479 = float((int)(((int)(uint)((bool)(_467 > 0.0f))) - ((int)(uint)((bool)(_467 < 0.0f)))));
  float _484 = saturate(abs(_466) - cb0_117z);
  float _485 = saturate(abs(_467) - cb0_117z);
  float _495 = _467 - ((_485 * _454) * _479);
  float _497 = _467 - ((_485 * _455) * _479);
  bool _498 = (cb0_118x > 0.0f);
  if (_498) {
    _505 = (_495 - (cb0_118w * 0.4000000059604645f));
    _506 = (_497 - (cb0_118w * 0.20000000298023224f));
  } else {
    _505 = _495;
    _506 = _497;
  }
  float4 _542 = t0.Sample(s0, float2(min(max(_427, cb0_053z), cb0_054x), min(max(_428, cb0_053w), cb0_054y)));
  float4 _558 = t0.Sample(s0, float2(min(max(((((cb0_048z * ((cb0_115z * (_466 - ((_484 * select(_456, _454, cb0_117x)) * _478))) + cb0_115x)) + cb0_049x) * cb0_048x) + _443), cb0_053z), cb0_054x), min(max(((((cb0_048w * ((cb0_115w * _505) + cb0_115y)) + cb0_049y) * cb0_048y) + _444), cb0_053w), cb0_054y)));
  float4 _572 = t0.Sample(s0, float2(min(max(((((cb0_048z * ((cb0_115z * (_466 - ((_484 * select(_456, _455, cb0_117y)) * _478))) + cb0_115x)) + cb0_049x) * cb0_048x) + _443), cb0_053z), cb0_054x), min(max(((((cb0_048w * ((cb0_115w * _506) + cb0_115y)) + cb0_049y) * cb0_048y) + _444), cb0_053w), cb0_054y)));
  if (_498) {
    float _582 = saturate(((((_542.y * 0.5870000123977661f) - cb0_118y) + (_542.x * 0.29899999499320984f)) + (_542.z * 0.11400000005960464f)) * 10.0f);
    float _586 = (_582 * _582) * (3.0f - (_582 * 2.0f));
    _600 = ((((_542.x - _558.x) + (_586 * (_558.x - _542.x))) * cb0_118x) + _558.x);
    _601 = ((((_542.y - _572.y) + (_586 * (_572.y - _542.y))) * cb0_118x) + _572.y);
  } else {
    _600 = _558.x;
    _601 = _572.y;
  }
  float _604 = saturate(cb0_099x);
  float _606 = saturate(cb0_099y);
  if (_604 > 0.0f) {
    float _617 = saturate(((_600 * 0.29899999499320984f) + (_542.z * 0.11400000005960464f)) + (_601 * 0.5870000123977661f));
    float _623 = ((_617 * _617) * (saturate(1.0f - cb0_099z) * 2.0f)) * (3.0f - (_617 * 2.0f));
    float _630 = max(sqrt(((_600 * _600) + (_542.z * _542.z)) + (_601 * _601)), 0.014999999664723873f);
    float _631 = _600 / _630;
    float _632 = _601 / _630;
    float _633 = _542.z / _630;
    float _643 = log2(_623);
    float _662 = ((_295 * _215) * _332) * _604;
    _673 = (((((lerp(_631, 1.0f, 0.25f)) * (((_606 * 0.17000000178813934f) + 0.029999999329447746f) + _623)) - _600) * _662) + _600);
    _674 = (((((((_606 * 0.18000000715255737f) + 0.05000000074505806f) + exp2(_643 * 0.8999999761581421f)) * (lerp(_632, 1.0f, 0.25f))) - _601) * _662) + _601);
    _675 = (((((((_606 * 0.17999999225139618f) + 0.07999999821186066f) + exp2(_643 * 0.949999988079071f)) * (lerp(_633, 1.0f, 0.25f))) - _542.z) * _662) + _542.z);
  } else {
    _673 = _600;
    _674 = _601;
    _675 = _542.z;
  }
  float _678 = saturate(cb0_100x);
  float _679 = _388 * _678;
  if (_678 > 0.0f) {
    float _690 = (sin(((_117 * 640.0f) + 640.0f) - (View_2376 * 10.0f)) * 0.5f) + 1.0f;
    _704 = ((((_690 * _673) - _673) * _679) + _673);
    _705 = ((((_690 * _674) - _674) * _679) + _674);
    _706 = ((((_690 * _675) - _675) * _679) + _675);
  } else {
    _704 = _673;
    _705 = _674;
    _706 = _675;
  }
  float4 _731 = t1.Sample(s1, float2(min(max(((cb0_068z * _427) + cb0_069x), cb0_060z), cb0_061x), min(max(((cb0_068w * _428) + cb0_069y), cb0_060w), cb0_061y)));
  APPLY_BLOOM(_731);
  [branch]
  if (!(cb0_085z == 0)) {
    bool _760 = (cb0_086x != 0);
    float4 _763 = t2.Sample(s2, float2(select(_760, _427, min(max(((cb0_076z * _427) + cb0_077x), cb0_075z), cb0_076x)), select(_760, _428, min(max(((cb0_076w * _428) + cb0_077y), cb0_075w), cb0_076y))));
    _771 = (_763.x + _731.x);
    _772 = (_763.y + _731.y);
    _773 = (_763.z + _731.z);
  } else {
  ...
  [branch]
  if (!(cb0_085w == 0)) {
    float4 _777 = t3.Sample(s3, float2(_427, _428));
    _785 = (_777.x + _771);
    _786 = (_777.y + _772);
    _787 = (_777.z + _773);
  } else {
  ...
  float _812 = TEXCOORD_1.z + -1.0f;
  float _814 = TEXCOORD_1.w + -1.0f;
  float _817 = ((_812 + (cb0_091x * 2.0f)) * cb0_089z) * cb0_089x;
  float _819 = ((_814 + (cb0_091y * 2.0f)) * cb0_089w) * cb0_089x;
  float _826 = 1.0f / ((((saturate(cb0_090w) * 9.0f) + 1.0f) * dot(float2(_817, _819), float2(_817, _819))) + 1.0f);
  float _827 = _826 * _826;
  float _828 = cb0_091z + 1.0f;
  float _856 = ((_812 + (cb0_094x * 2.0f)) * cb0_092z) * cb0_092x;
  float _858 = ((_814 + (cb0_094y * 2.0f)) * cb0_092w) * cb0_092x;
  float _865 = 1.0f / ((((saturate(cb0_093w) * 9.0f) + 1.0f) * dot(float2(_856, _858), float2(_856, _858))) + 1.0f);
  float _866 = _865 * _865;
  float _867 = cb0_094z + 1.0f;
  float _879 = (((_785 + ((_704 * TEXCOORD_1.x) * cb0_087x)) * _385) * ((_827 * (_828 - cb0_090x)) + cb0_090x)) * ((_866 * (_867 - cb0_093x)) + cb0_093x);
  float _882 = (((_786 + ((_705 * TEXCOORD_1.x) * cb0_087y)) * _385) * ((_827 * (_828 - cb0_090y)) + cb0_090y)) * ((_866 * (_867 - cb0_093y)) + cb0_093y);
  float _885 = (((_787 + ((_706 * TEXCOORD_1.x) * cb0_087z)) * _385) * ((_827 * (_828 - cb0_090z)) + cb0_090z)) * ((_866 * (_867 - cb0_093z)) + cb0_093z);

  CAPTURE_UNTONEMAPPED(float3(_879, _882, _885));
  [branch]
  if (WUWA_TM_IS(1)) {
    _918 = ((((_879 * 1.3600000143051147f) + 0.04699999839067459f) * _879) / ((((_879 * 0.9599999785423279f) + 0.5600000023841858f) * _879) + 0.14000000059604645f));
    _919 = ((((_882 * 1.3600000143051147f) + 0.04699999839067459f) * _882) / ((((_882 * 0.9599999785423279f) + 0.5600000023841858f) * _882) + 0.14000000059604645f));
    _920 = ((((_885 * 1.3600000143051147f) + 0.04699999839067459f) * _885) / ((((_885 * 0.9599999785423279f) + 0.5600000023841858f) * _885) + 0.14000000059604645f));
  } else {
    _918 = _879;
    _919 = _882;
    _920 = _885;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _930 = 1.0049500465393066f - (0.16398000717163086f / (_918 + -0.19505000114440918f));
    ...
    _952 = (((_918 - _930) * select((_918 > 0.6000000238418579f), 0.0f, 1.0f)) + _930);
    _953 = (((_919 - _931) * select((_919 > 0.6000000238418579f), 0.0f, 1.0f)) + _931);
    _954 = (((_920 - _932) * select((_920 > 0.6000000238418579f), 0.0f, 1.0f)) + _932);
  } else {
    _952 = _918;
    _953 = _919;
    _954 = _920;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _960 = cb0_037y * _952;
    float _961 = cb0_037y * _953;
    float _962 = cb0_037y * _954;
    float _965 = cb0_037z * cb0_037w;
    float _975 = cb0_038y * cb0_038x;
    float _986 = cb0_038z * cb0_038x;
    float _993 = cb0_038y / cb0_038z;
    _1001 = (((((_965 + _960) * _952) + _975) / (_986 + ((_960 + cb0_037z) * _952))) - _993);
    _1002 = (((((_965 + _961) * _953) + _975) / (_986 + ((_961 + cb0_037z) * _953))) - _993);
    _1003 = (((((_965 + _962) * _954) + _975) / (_986 + ((_962 + cb0_037z) * _954))) - _993);
  } else {
    _1001 = _952;
    _1002 = _953;
    _1003 = _954;
  ...
  if (!(cb0_106w == 0)) {
    if (!(cb0_107x == 1.0f)) {
      float _1013 = (cb0_107x * 0.699999988079071f) + 0.30000001192092896f;
      _1018 = (_1013 * _1001);
      _1019 = (_1013 * _1002);
      _1020 = (_1013 * _1003);
    } else {
  ...
  CLAMP_IF_SDR3(_1018, _1019, _1020);
  CAPTURE_TONEMAPPED(float3(_1018, _1019, _1020));
  ...
  float4 _1044 = t7.Sample(s7, float3(_1041, _1042, _1043));
  [branch]
  if (!(cb0_108w == 0)) {
    float4 _1068 = t6.Sample(s6, float2(min(max(((cb0_084z * _427) + cb0_085x), cb0_083z), cb0_084x), min(max(((cb0_084w * _428) + cb0_085y), cb0_083w), cb0_084y)));
    float _1078 = select((((uint)(uint(float((uint)((int)((uint)(uint(round(_1068.w * 255.0f))) & 15))))) & -4) == 12), 1.0f, 0.0f);
    float4 _1079 = t8.Sample(s8, float3(_1041, _1042, _1043));
    _1093 = (lerp(_1079.x, _1044.x, _1078));
    _1094 = (lerp(_1079.y, _1044.y, _1078));
    _1095 = (lerp(_1079.z, _1044.z, _1078));
  } else {
    _1093 = _1044.x;
    _1094 = _1044.y;
    _1095 = _1044.z;
  }
  HANDLE_LUT_OUTPUT3_FADE(_1093, _1094, _1095, t7, s7);
  float _1096 = _1095 * 1.0499999523162842f;
  float _1097 = _1094 * 1.0499999523162842f;
  float _1098 = _1093 * 1.0499999523162842f;
  float _1106 = ((_339 * 0.00390625f) + -0.001953125f) + _1098;
  float _1107 = ((_362 * 0.00390625f) + -0.001953125f) + _1097;
  float _1108 = ((_363 * 0.00390625f) + -0.001953125f) + _1096;
  [branch]
  if (!(cb0_107w == 0)) {
    float _1120 = (pow(_1106, 0.012683313339948654f));
    float _1121 = (pow(_1107, 0.012683313339948654f));
    float _1122 = (pow(_1108, 0.012683313339948654f));
    float _1155 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1120 + -0.8359375f)) / (18.8515625f - (_1120 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_107z));
    float _1156 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1121 + -0.8359375f)) / (18.8515625f - (_1121 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_107z));
    float _1157 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1122 + -0.8359375f)) / (18.8515625f - (_1122 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_107z));
    _1183 = min((_1155 * 12.920000076293945f), ((exp2(log2(max(_1155, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1184 = min((_1156 * 12.920000076293945f), ((exp2(log2(max(_1156, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1185 = min((_1157 * 12.920000076293945f), ((exp2(log2(max(_1157, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _1183 = _1106;
    _1184 = _1107;
    _1185 = _1108;
  ...
  SV_Target.y = _1184;
  SV_Target.z = _1185;
  SV_Target.w = dot(float3(_1098, _1097, _1096), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f));
