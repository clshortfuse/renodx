...
float4 main(
  ...
  APPLY_EXTENDED_TONEMAP(_963, _964, _965);
  ...
  if (cb0_109y > 0.0f) {
    ...
    _1180 = (_1154 * cb0_109y);
    _1181 = (_1155 * cb0_109y);
    _1182 = (_1160 * cb0_109y);
    _1183 = (_1161 * cb0_109y);
    _1184 = (_1162 * cb0_109y);
  } else {
    float _1171 = abs(cb0_109y);
    _1179 = (_1160 * _1171);
    _1180 = (_1161 * _1171);
    _1181 = (_1162 * _1171);
    _1182 = (_1153 * _1171);
  ...
  SV_Target.x = ((cb0_109x * (lerp(_1179, _1182, _1146))) + _1128);
  SV_Target.y = ((cb0_109x * (lerp(_1180, _1183, _1146))) + _1129);
  SV_Target.z = (((lerp(_1181, _1184, _1146)) * cb0_109x) + _1130);
