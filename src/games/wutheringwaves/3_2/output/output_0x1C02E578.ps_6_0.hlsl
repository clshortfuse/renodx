...
float4 main(
  ...
  float _889 = ((((_785 + ((_704 * TEXCOORD_1.x) * cb0_087x)) * _385) * ((_827 * (_828 - cb0_090x)) + cb0_090x)) * ((_866 * (_867 - cb0_093x)) + cb0_093x)) * ((cb0_096x * _339) + cb0_096y);
  float _893 = ((((_786 + ((_705 * TEXCOORD_1.x) * cb0_087y)) * _385) * ((_827 * (_828 - cb0_090y)) + cb0_090y)) * ((_866 * (_867 - cb0_093y)) + cb0_093y)) * ((cb0_096x * _362) + cb0_096y);
  float _897 = ((((_787 + ((_706 * TEXCOORD_1.x) * cb0_087z)) * _385) * ((_827 * (_828 - cb0_090z)) + cb0_090z)) * ((_866 * (_867 - cb0_093z)) + cb0_093z)) * ((cb0_096x * _363) + cb0_096y);

  CAPTURE_UNTONEMAPPED(float3(_889, _893, _897));
  [branch]
  if (WUWA_TM_IS(1)) {
    _930 = ((((_889 * 1.3600000143051147f) + 0.04699999839067459f) * _889) / ((((_889 * 0.9599999785423279f) + 0.5600000023841858f) * _889) + 0.14000000059604645f));
    _931 = ((((_893 * 1.3600000143051147f) + 0.04699999839067459f) * _893) / ((((_893 * 0.9599999785423279f) + 0.5600000023841858f) * _893) + 0.14000000059604645f));
    _932 = ((((_897 * 1.3600000143051147f) + 0.04699999839067459f) * _897) / ((((_897 * 0.9599999785423279f) + 0.5600000023841858f) * _897) + 0.14000000059604645f));
  } else {
    _930 = _889;
    _931 = _893;
    _932 = _897;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _942 = 1.0049500465393066f - (0.16398000717163086f / (_930 + -0.19505000114440918f));
    ...
    _964 = (((_930 - _942) * select((_930 > 0.6000000238418579f), 0.0f, 1.0f)) + _942);
    _965 = (((_931 - _943) * select((_931 > 0.6000000238418579f), 0.0f, 1.0f)) + _943);
    _966 = (((_932 - _944) * select((_932 > 0.6000000238418579f), 0.0f, 1.0f)) + _944);
  } else {
    _964 = _930;
    _965 = _931;
    _966 = _932;
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _972 = cb0_037y * _964;
    float _973 = cb0_037y * _965;
    float _974 = cb0_037y * _966;
    float _977 = cb0_037z * cb0_037w;
    float _987 = cb0_038y * cb0_038x;
    float _998 = cb0_038z * cb0_038x;
    float _1005 = cb0_038y / cb0_038z;
    _1013 = (((((_977 + _972) * _964) + _987) / (_998 + ((_972 + cb0_037z) * _964))) - _1005);
    _1014 = (((((_977 + _973) * _965) + _987) / (_998 + ((_973 + cb0_037z) * _965))) - _1005);
    _1015 = (((((_977 + _974) * _966) + _987) / (_998 + ((_974 + cb0_037z) * _966))) - _1005);
  } else {
    _1013 = _964;
    _1014 = _965;
    _1015 = _966;
  ...
  if (!(cb0_106w == 0)) {
    if (!(cb0_107x == 1.0f)) {
      float _1025 = (cb0_107x * 0.699999988079071f) + 0.30000001192092896f;
      _1030 = (_1025 * _1013);
      _1031 = (_1025 * _1014);
      _1032 = (_1025 * _1015);
    } else {
  ...
  CLAMP_IF_SDR3(_1030, _1031, _1032);
  CAPTURE_TONEMAPPED(float3(_1030, _1031, _1032));
  float _1053 = (saturate((log2(_1030 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  ...
  float4 _1056 = t7.Sample(s7, float3(_1053, _1054, _1055));
  [branch]
  if (!(cb0_108w == 0)) {
    float4 _1080 = t6.Sample(s6, float2(min(max(((cb0_084z * _427) + cb0_085x), cb0_083z), cb0_084x), min(max(((cb0_084w * _428) + cb0_085y), cb0_083w), cb0_084y)));
    float _1090 = select((((uint)(uint(float((uint)((int)((uint)(uint(round(_1080.w * 255.0f))) & 15))))) & -4) == 12), 1.0f, 0.0f);
    float4 _1091 = t8.Sample(s8, float3(_1053, _1054, _1055));
    _1105 = (lerp(_1091.x, _1056.x, _1090));
    _1106 = (lerp(_1091.y, _1056.y, _1090));
    _1107 = (lerp(_1091.z, _1056.z, _1090));
  } else {
    _1105 = _1056.x;
    _1106 = _1056.y;
    _1107 = _1056.z;
  }
  HANDLE_LUT_OUTPUT3_FADE(_1105, _1106, _1107, t7, s7);
  float _1108 = _1107 * 1.0499999523162842f;
  float _1109 = _1106 * 1.0499999523162842f;
  float _1110 = _1105 * 1.0499999523162842f;
  float _1118 = ((_339 * 0.00390625f) + -0.001953125f) + _1110;
  float _1119 = ((_362 * 0.00390625f) + -0.001953125f) + _1109;
  float _1120 = ((_363 * 0.00390625f) + -0.001953125f) + _1108;
  [branch]
  if (!(cb0_107w == 0)) {
    float _1132 = (pow(_1118, 0.012683313339948654f));
    float _1133 = (pow(_1119, 0.012683313339948654f));
    float _1134 = (pow(_1120, 0.012683313339948654f));
    float _1167 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1132 + -0.8359375f)) / (18.8515625f - (_1132 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_107z));
    float _1168 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1133 + -0.8359375f)) / (18.8515625f - (_1133 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_107z));
    float _1169 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1134 + -0.8359375f)) / (18.8515625f - (_1134 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_107z));
    _1195 = min((_1167 * 12.920000076293945f), ((exp2(log2(max(_1167, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1196 = min((_1168 * 12.920000076293945f), ((exp2(log2(max(_1168, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  ...
  SV_Target.y = _1196;
  SV_Target.z = _1197;
  SV_Target.w = dot(float3(_1110, _1109, _1108), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f));
