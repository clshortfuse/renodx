...
float4 main(
  ...
  float4 _416 = t0.Sample(s0, float2(_414, _415));
  float _422 = saturate(cb0_099x);
  float _424 = saturate(cb0_099y);
  if (_422 > 0.0f) {
    float _435 = saturate(((_416.x * 0.29899999499320984f) + (_416.y * 0.5870000123977661f)) + (_416.z * 0.11400000005960464f));
    float _441 = ((_435 * _435) * (saturate(1.0f - cb0_099z) * 2.0f)) * (3.0f - (_435 * 2.0f));
    float _448 = max(sqrt(((_416.x * _416.x) + (_416.y * _416.y)) + (_416.z * _416.z)), 0.014999999664723873f);
    float _449 = _416.x / _448;
    float _450 = _416.y / _448;
    float _451 = _416.z / _448;
    float _461 = log2(_441);
    float _480 = ((_293 * _213) * _330) * _422;
    _491 = (((((lerp(_449, 1.0f, 0.25f)) * (((_424 * 0.17000000178813934f) + 0.029999999329447746f) + _441)) - _416.x) * _480) + _416.x);
    _492 = (((((((_424 * 0.18000000715255737f) + 0.05000000074505806f) + exp2(_461 * 0.8999999761581421f)) * (lerp(_450, 1.0f, 0.25f))) - _416.y) * _480) + _416.y);
    _493 = (((((((_424 * 0.17999999225139618f) + 0.07999999821186066f) + exp2(_461 * 0.949999988079071f)) * (lerp(_451, 1.0f, 0.25f))) - _416.z) * _480) + _416.z);
  } else {
    _491 = _416.x;
    _492 = _416.y;
    _493 = _416.z;
  }
  float _495 = saturate(cb0_100x);
  float _496 = _386 * _495;
  if (_495 > 0.0f) {
    float _507 = (sin(((_115 * 640.0f) + 640.0f) - (View_2376 * 10.0f)) * 0.5f) + 1.0f;
    _521 = ((((_507 * _491) - _491) * _496) + _491);
    _522 = ((((_507 * _492) - _492) * _496) + _492);
    _523 = ((((_507 * _493) - _493) * _496) + _493);
  } else {
    _521 = _491;
    _522 = _492;
    _523 = _493;
  }
  float4 _548 = t1.Sample(s1, float2(min(max(((cb0_068z * _414) + cb0_069x), cb0_060z), cb0_061x), min(max(((cb0_068w * _415) + cb0_069y), cb0_060w), cb0_061y)));
  APPLY_BLOOM(_548);
  [branch]
  if (!(cb0_085z == 0)) {
    bool _577 = (cb0_086x != 0);
    float4 _580 = t2.Sample(s2, float2(select(_577, _414, min(max(((cb0_076z * _414) + cb0_077x), cb0_075z), cb0_076x)), select(_577, _415, min(max(((cb0_076w * _415) + cb0_077y), cb0_075w), cb0_076y))));
    _588 = (_580.x + _548.x);
    _589 = (_580.y + _548.y);
    _590 = (_580.z + _548.z);
  } else {
  ...
  [branch]
  if (!(cb0_085w == 0)) {
    float4 _594 = t3.Sample(s3, float2(_414, _415));
    _602 = (_594.x + _588);
    _603 = (_594.y + _589);
    _604 = (_594.z + _590);
  } else {
  ...
  float _629 = TEXCOORD_1.z + -1.0f;
  float _631 = TEXCOORD_1.w + -1.0f;
  float _634 = ((_629 + (cb0_091x * 2.0f)) * cb0_089z) * cb0_089x;
  float _636 = ((_631 + (cb0_091y * 2.0f)) * cb0_089w) * cb0_089x;
  float _643 = 1.0f / ((((saturate(cb0_090w) * 9.0f) + 1.0f) * dot(float2(_634, _636), float2(_634, _636))) + 1.0f);
  float _644 = _643 * _643;
  float _645 = cb0_091z + 1.0f;
  float _673 = ((_629 + (cb0_094x * 2.0f)) * cb0_092z) * cb0_092x;
  float _675 = ((_631 + (cb0_094y * 2.0f)) * cb0_092w) * cb0_092x;
  float _682 = 1.0f / ((((saturate(cb0_093w) * 9.0f) + 1.0f) * dot(float2(_673, _675), float2(_673, _675))) + 1.0f);
  float _683 = _682 * _682;
  float _684 = cb0_094z + 1.0f;
  float _696 = (((_602 + ((_521 * TEXCOORD_1.x) * cb0_087x)) * _383) * ((_644 * (_645 - cb0_090x)) + cb0_090x)) * ((_683 * (_684 - cb0_093x)) + cb0_093x);
  float _699 = (((_603 + ((_522 * TEXCOORD_1.x) * cb0_087y)) * _383) * ((_644 * (_645 - cb0_090y)) + cb0_090y)) * ((_683 * (_684 - cb0_093y)) + cb0_093y);
  float _702 = (((_604 + ((_523 * TEXCOORD_1.x) * cb0_087z)) * _383) * ((_644 * (_645 - cb0_090z)) + cb0_090z)) * ((_683 * (_684 - cb0_093z)) + cb0_093z);

  CAPTURE_UNTONEMAPPED(float3(_696, _699, _702));
  [branch]
  if (WUWA_TM_IS(1)) {
    _735 = ((((_696 * 1.3600000143051147f) + 0.04699999839067459f) * _696) / ((((_696 * 0.9599999785423279f) + 0.5600000023841858f) * _696) + 0.14000000059604645f));
    _736 = ((((_699 * 1.3600000143051147f) + 0.04699999839067459f) * _699) / ((((_699 * 0.9599999785423279f) + 0.5600000023841858f) * _699) + 0.14000000059604645f));
    _737 = ((((_702 * 1.3600000143051147f) + 0.04699999839067459f) * _702) / ((((_702 * 0.9599999785423279f) + 0.5600000023841858f) * _702) + 0.14000000059604645f));
  } else {
    _735 = _696;
    _736 = _699;
    _737 = _702;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    float _747 = 1.0049500465393066f - (0.16398000717163086f / (_735 + -0.19505000114440918f));
    ...
    _769 = (((_735 - _747) * select((_735 > 0.6000000238418579f), 0.0f, 1.0f)) + _747);
  ...
  [branch]
  if (WUWA_TM_IS(3)) {
    float _777 = cb0_037y * _769;
    float _778 = cb0_037y * _770;
    float _779 = cb0_037y * _771;
    float _782 = cb0_037z * cb0_037w;
    float _792 = cb0_038y * cb0_038x;
    float _803 = cb0_038z * cb0_038x;
    float _810 = cb0_038y / cb0_038z;
    _818 = (((((_782 + _777) * _769) + _792) / (_803 + ((_777 + cb0_037z) * _769))) - _810);
    _819 = (((((_782 + _778) * _770) + _792) / (_803 + ((_778 + cb0_037z) * _770))) - _810);
    _820 = (((((_782 + _779) * _771) + _792) / (_803 + ((_779 + cb0_037z) * _771))) - _810);
  } else {
    _818 = _769;
    _819 = _770;
    _820 = _771;
  ...
  if (!(cb0_106w == 0)) {
    if (!(cb0_107x == 1.0f)) {
      float _830 = (cb0_107x * 0.699999988079071f) + 0.30000001192092896f;
      _835 = (_830 * _818);
      _836 = (_830 * _819);
      _837 = (_830 * _820);
    } else {
  ...
  CLAMP_IF_SDR3(_835, _836, _837);
  CAPTURE_TONEMAPPED(float3(_835, _836, _837));
  float _858 = (saturate((log2(_835 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  ...
  float4 _861 = t7.Sample(s7, float3(_858, _859, _860));
  [branch]
  if (!(cb0_108w == 0)) {
    float4 _885 = t6.Sample(s6, float2(min(max(((cb0_084z * _414) + cb0_085x), cb0_083z), cb0_084x), min(max(((cb0_084w * _415) + cb0_085y), cb0_083w), cb0_084y)));
    float _895 = select((((uint)(uint(float((uint)((int)((uint)(uint(round(_885.w * 255.0f))) & 15))))) & -4) == 12), 1.0f, 0.0f);
    float4 _896 = t8.Sample(s8, float3(_858, _859, _860));
    _910 = (lerp(_896.x, _861.x, _895));
    _911 = (lerp(_896.y, _861.y, _895));
    _912 = (lerp(_896.z, _861.z, _895));
  } else {
    _910 = _861.x;
    _911 = _861.y;
    _912 = _861.z;
  }
  HANDLE_LUT_OUTPUT3_FADE(_910, _911, _912, t7, s7);
  float _913 = _912 * 1.0499999523162842f;
  float _914 = _911 * 1.0499999523162842f;
  float _915 = _910 * 1.0499999523162842f;
  float _923 = ((_337 * 0.00390625f) + -0.001953125f) + _915;
  float _924 = ((_360 * 0.00390625f) + -0.001953125f) + _914;
  float _925 = ((_361 * 0.00390625f) + -0.001953125f) + _913;
  [branch]
  if (!(cb0_107w == 0)) {
    float _937 = (pow(_923, 0.012683313339948654f));
    float _938 = (pow(_924, 0.012683313339948654f));
    float _939 = (pow(_925, 0.012683313339948654f));
    float _972 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_937 + -0.8359375f)) / (18.8515625f - (_937 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_107z));
    float _973 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_938 + -0.8359375f)) / (18.8515625f - (_938 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_107z));
    float _974 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_939 + -0.8359375f)) / (18.8515625f - (_939 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_107z));
    _1000 = min((_972 * 12.920000076293945f), ((exp2(log2(max(_972, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1001 = min((_973 * 12.920000076293945f), ((exp2(log2(max(_973, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1002 = min((_974 * 12.920000076293945f), ((exp2(log2(max(_974, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _1000 = _923;
    _1001 = _924;
    _1002 = _925;
  }
  GENERATE_INVERSION(_1000, _1001, _1002);

  float _1011 = ((((_1001 * 587.0f) + (_1000 * 299.0f)) + (_1002 * 114.0f)) * 0.0010000000474974513f) - cb0_109z;
  float _1018 = saturate(float((int)(((int)(uint)((bool)(_1011 > 0.0f))) - ((int)(uint)((bool)(_1011 < 0.0f))))));
  float _1025 = cb0_110x - _1000;
  float _1026 = cb0_110y - _1001;
  float _1027 = cb0_110z - _1002;
  float _1032 = (WUWA_PEAK_SCALING * cb0_111x) - _1000;
  float _1033 = (WUWA_PEAK_SCALING * cb0_111y) - _1001;
  float _1034 = (WUWA_PEAK_SCALING * cb0_111z) - _1002;
  [branch]
  if (cb0_109y > 0.0f) {
    _1051 = (_1025 * cb0_109y);
    _1052 = (_1026 * cb0_109y);
    _1053 = (_1027 * cb0_109y);
    _1054 = (_1032 * cb0_109y);
    _1055 = (_1033 * cb0_109y);
    _1056 = (_1034 * cb0_109y);
  } else {
    float _1043 = abs(cb0_109y);
    _1051 = (_1032 * _1043);
    _1052 = (_1033 * _1043);
    _1053 = (_1034 * _1043);
    _1054 = (_1025 * _1043);
  ...
  SV_Target.x = ((cb0_109x * (lerp(_1051, _1054, _1018))) + _1000);
  SV_Target.y = ((cb0_109x * (lerp(_1052, _1055, _1018))) + _1001);
  SV_Target.z = (((lerp(_1053, _1056, _1018)) * cb0_109x) + _1002);
  SV_Target.rgb = renodx::draw::RenderIntermediatePass(SV_Target.rgb);
  SV_Target.w = dot(float3(_915, _914, _913), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f));
