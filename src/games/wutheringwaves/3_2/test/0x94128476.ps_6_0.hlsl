...
float4 main(
  ...
  float4 SV_Target;
  float _58 = mad(SV_Position.z, (View_704[2].w), mad(SV_Position.y, (View_704[1].w), ((View_704[0].w) * SV_Position.x))) + (View_704[3].w);
  float _62 = ((mad(SV_Position.z, (View_704[2].x), mad(SV_Position.y, (View_704[1].x), ((View_704[0].x) * SV_Position.x))) + (View_704[3].x)) / _58) - View_1120.x;
  float _63 = ((mad(SV_Position.z, (View_704[2].y), mad(SV_Position.y, (View_704[1].y), ((View_704[0].y) * SV_Position.x))) + (View_704[3].y)) / _58) - View_1120.y;
  float _64 = ((mad(SV_Position.z, (View_704[2].z), mad(SV_Position.y, (View_704[1].z), ((View_704[0].z) * SV_Position.x))) + (View_704[3].z)) / _58) - View_1120.z;
  float _65 = TEXCOORD_9.x - View_1120.x;
  float _66 = TEXCOORD_9.y - View_1120.y;
  float _67 = TEXCOORD_9.z - View_1120.z;
  float _76;
  float _77;
  float _78;
  float _112;
  ...
  float4 _81 = t0.SampleBias(s0, float2(TEXCOORD.x, TEXCOORD.y), View_2388, int2(0, 0));
  if ((Material_144[0].x) > 0.5f) {
    _112 = max(((exp2(log2(max(_81.x, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _113 = max(((exp2(log2(max(_81.y, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _114 = max(((exp2(log2(max(_81.z, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
  } else {
    _112 = _81.x;
    _113 = _81.y;
    _114 = _81.z;
  ...
  float _116 = _113 * _77;
  float _117 = _114 * _78;
  float _146 = ((SV_Position.x - View_2144.x) * View_2160.z) - (Material_000[3].x);
  float _147 = (1.0f - ((SV_Position.y - View_2144.y) * View_2160.w)) - (Material_000[3].y);
  float _148 = _81.w * COLOR.w;
  float _177 = mad(_67, (Primitive_096[2].x), mad(_66, (Primitive_096[1].x), ((Primitive_096[0].x) * _65))) + (Primitive_096[3].x);
  float _181 = mad(_67, (Primitive_096[2].y), mad(_66, (Primitive_096[1].y), ((Primitive_096[0].y) * _65))) + (Primitive_096[3].y);
  float _210 = saturate(((1.0f - saturate(((_181 - (Material_000[4].y)) - (Material_000[3].y)) / (Material_000[8].y))) - saturate((((-0.0f - _181) - (Material_000[4].y)) + (Material_000[3].y)) / (Material_000[8].w))) * ((1.0f - saturate((((-0.0f - _177) - (Material_000[4].x)) + (Material_000[3].x)) / (Material_000[8].x))) - saturate(((_177 - (Material_000[4].x)) - (Material_000[3].x)) / (Material_000[8].z))));
  float _214 = (_210 * _210) * (3.0f - (_210 * 2.0f));
  float _231 = saturate(select(((bool)(abs((Material_144[2].w) + -0.5f) > 9.999999747378752e-06f) && (bool)((Material_144[2].w) >= 0.5f)), select(((bool)(_147 > (Material_000[4].y)) || ((bool)((bool)(_146 > (Material_000[4].x)) || ((bool)((bool)(_146 < (-0.0f - (Material_000[4].x))) || (bool)(_147 < (-0.0f - (Material_000[4].y)))))))), 0.0f, _148), (select(((bool)(abs(Material_144[2].z) > 9.999999747378752e-06f) && (bool)((Material_144[2].z) >= 0.0f)), (1.0f - _214), _214) * _148)));
  float _232 = max(((((Material_000[1].x) - _115) * (Material_144[0].y)) + _115), 0.0f);
  float _233 = max(((((Material_000[1].y) - _116) * (Material_144[0].y)) + _116), 0.0f);
  float _234 = max(((((Material_000[1].z) - _117) * (Material_144[0].y)) + _117), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_64 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_62 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_63 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      float _266 = float((bool)(bool)(frac(dot(float3(_62, _63, _64), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _269 = 1.0f;
      _270 = (1.0f - _266);
      _271 = 1.0f;
      _272 = _266;
  ...
  if (!(TranslucentBasePass_4352 == 0)) {
    do {
      ...
      if (TranslucentBasePass_4368 == 0.0f) {
        float _296 = 1.0f / TranslucentBasePass_4356;
        _307 = exp2(log2(1.0f - exp2((_270 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _296);
        _308 = exp2(log2(1.0f - exp2((_271 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _296);
        _309 = exp2(log2(1.0f - exp2((_272 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _296);
      } else {
        _307 = _270;
        _308 = _271;
        _309 = _272;
      ...
      do {
        ...
        if (TranslucentBasePass_4368 == 1.0f) {
          float _313 = TranslucentBasePass_4372 * _307;
          float _314 = TranslucentBasePass_4372 * _308;
          float _315 = TranslucentBasePass_4372 * _309;
          float _317 = TranslucentBasePass_4376 * 1.3600000143051147f;
          float _318 = TranslucentBasePass_4376 * 0.9599999785423279f;
          float _355 = 1.0f / TranslucentBasePass_4356;
          _366 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_317 * _313) + 0.04699999839067459f) * _313) / ((((_318 * _313) + 0.5600000023841858f) * _313) + 0.14000000059604645f)))) * _355);
          _367 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_317 * _314) + 0.04699999839067459f) * _314) / ((((_318 * _314) + 0.5600000023841858f) * _314) + 0.14000000059604645f)))) * _355);
          _368 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_317 * _315) + 0.04699999839067459f) * _315) / ((((_318 * _315) + 0.5600000023841858f) * _315) + 0.14000000059604645f)))) * _355);
        } else {
          _366 = _307;
          _367 = _308;
          _368 = _309;
        ...
        do {
          ...
          if (TranslucentBasePass_4368 == 2.0f) {
            float _373 = TranslucentBasePass_4384 * _366;
            float _374 = TranslucentBasePass_4384 * _367;
            float _375 = TranslucentBasePass_4384 * _368;
            float _381 = TranslucentBasePass_4392 * -0.16398000717163086f;
            float _385 = (_381 / (_373 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _386 = (_381 / (_374 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _387 = (_381 / (_375 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _408 = 1.0f / TranslucentBasePass_4356;
            _419 = exp2(log2(saturate(((_373 - _385) * select((TranslucentBasePass_4388 < _373), 0.0f, 1.0f)) + _385)) * _408);
            _420 = exp2(log2(saturate(((_374 - _386) * select((TranslucentBasePass_4388 < _374), 0.0f, 1.0f)) + _386)) * _408);
            _421 = exp2(log2(saturate(((_375 - _387) * select((TranslucentBasePass_4388 < _375), 0.0f, 1.0f)) + _387)) * _408);
          } else {
            _419 = _366;
            _420 = _367;
            _421 = _368;
          ...
          if (TranslucentBasePass_4368 == 3.0f) {
            float _426 = TranslucentBasePass_4396 * _419;
            float _427 = TranslucentBasePass_4396 * _420;
            float _428 = TranslucentBasePass_4396 * _421;
            float _463 = exp2(log2(abs(_426)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_426 > 0.0f))) - ((int)(uint)((bool)(_426 < 0.0f)))));
            float _464 = exp2(log2(abs(_427)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_427 > 0.0f))) - ((int)(uint)((bool)(_427 < 0.0f)))));
            float _465 = exp2(log2(abs(_428)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_428 > 0.0f))) - ((int)(uint)((bool)(_428 < 0.0f)))));
            float _466 = TranslucentBasePass_4400 * 5.340000152587891f;
            float _467 = _463 * _466;
            float _468 = _464 * _466;
            float _469 = _465 * _466;
            float _491 = TranslucentBasePass_4404 + -0.0004396551812533289f;
            float _500 = 1.0f / TranslucentBasePass_4356;
            _511 = exp2(log2(saturate(_491 + ((((_467 + 2.609099864959717f) * _463) + 0.0013464000076055527f) / (((_467 + 1.1699999570846558f) * _463) + 3.0624001026153564f)))) * _500);
            _512 = exp2(log2(saturate(_491 + ((((_468 + 2.609099864959717f) * _464) + 0.0013464000076055527f) / (((_468 + 1.1699999570846558f) * _464) + 3.0624001026153564f)))) * _500);
            _513 = exp2(log2(saturate(_491 + ((((_469 + 2.609099864959717f) * _465) + 0.0013464000076055527f) / (((_469 + 1.1699999570846558f) * _465) + 3.0624001026153564f)))) * _500);
          } else {
            _511 = _419;
            _512 = _420;
            _513 = _421;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _511), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _512), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _513), 0.0f));
  SV_Target.w = _269;
