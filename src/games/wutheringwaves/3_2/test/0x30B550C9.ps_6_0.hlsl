...
cbuffer cb3 : register(b3) {
  int NiagaraMeshVF_000 : packoffset(c000.x);
  float NiagaraMeshVF_004 : packoffset(c000.y);
  float NiagaraMeshVF_008 : packoffset(c000.z);
  float NiagaraMeshVF_012 : packoffset(c000.w);
  float3 NiagaraMeshVF_016 : packoffset(c001.x);
  float NiagaraMeshVF_028 : packoffset(c001.w);
  float4 NiagaraMeshVF_032 : packoffset(c002.x);
  int NiagaraMeshVF_048 : packoffset(c003.x);
  int NiagaraMeshVF_052 : packoffset(c003.y);
  int NiagaraMeshVF_056 : packoffset(c003.z);
  int NiagaraMeshVF_060 : packoffset(c003.w);
  float NiagaraMeshVF_064 : packoffset(c004.x);
  int NiagaraMeshVF_068 : packoffset(c004.y);
  int NiagaraMeshVF_072 : packoffset(c004.z);
  int NiagaraMeshVF_076 : packoffset(c004.w);
  int NiagaraMeshVF_080 : packoffset(c005.x);
  int NiagaraMeshVF_084 : packoffset(c005.y);
  int NiagaraMeshVF_088 : packoffset(c005.z);
  int NiagaraMeshVF_092 : packoffset(c005.w);
  int NiagaraMeshVF_096 : packoffset(c006.x);
  int NiagaraMeshVF_100 : packoffset(c006.y);
  int NiagaraMeshVF_104 : packoffset(c006.z);
  int NiagaraMeshVF_108 : packoffset(c006.w);
  int NiagaraMeshVF_112 : packoffset(c007.x);
  int NiagaraMeshVF_116 : packoffset(c007.y);
  int NiagaraMeshVF_120 : packoffset(c007.z);
  int NiagaraMeshVF_124 : packoffset(c007.w);
  int NiagaraMeshVF_128 : packoffset(c008.x);
  int NiagaraMeshVF_132 : packoffset(c008.y);
  int NiagaraMeshVF_136 : packoffset(c008.z);
  float NiagaraMeshVF_140 : packoffset(c008.w);
  float4 NiagaraMeshVF_144 : packoffset(c009.x);
  float3 NiagaraMeshVF_160 : packoffset(c010.x);
  float NiagaraMeshVF_172 : packoffset(c010.w);
  float4 NiagaraMeshVF_176 : packoffset(c011.x);
  float4 NiagaraMeshVF_192 : packoffset(c012.x);
  float3 NiagaraMeshVF_208 : packoffset(c013.x);
  float NiagaraMeshVF_220 : packoffset(c013.w);
  float4 NiagaraMeshVF_224 : packoffset(c014.x);
  float4 NiagaraMeshVF_240 : packoffset(c015.x);
  float4 NiagaraMeshVF_256 : packoffset(c016.x);
  float4 NiagaraMeshVF_272 : packoffset(c017.x);
  float NiagaraMeshVF_288 : packoffset(c018.x);
  float NiagaraMeshVF_292 : packoffset(c018.y);
  float NiagaraMeshVF_296 : packoffset(c018.z);
  float NiagaraMeshVF_300 : packoffset(c018.w);
  float NiagaraMeshVF_304 : packoffset(c019.x);
  float NiagaraMeshVF_308 : packoffset(c019.y);
  float NiagaraMeshVF_312 : packoffset(c019.z);
  float NiagaraMeshVF_316 : packoffset(c019.w);
  float3 NiagaraMeshVF_320 : packoffset(c020.x);
  float NiagaraMeshVF_332 : packoffset(c020.w);
  int NiagaraMeshVF_336 : packoffset(c021.x);
  float NiagaraMeshVF_340 : packoffset(c021.y);
  float NiagaraMeshVF_344 : packoffset(c021.z);
  float NiagaraMeshVF_348 : packoffset(c021.w);
  float3 NiagaraMeshVF_352 : packoffset(c022.x);
  int NiagaraMeshVF_364 : packoffset(c022.w);
  int NiagaraMeshVF_368 : packoffset(c023.x);
  float NiagaraMeshVF_372 : packoffset(c023.y);
  int NiagaraMeshVF_376 : packoffset(c023.z);
};

cbuffer cb4 : register(b4) {
  float4 Material_000[43] : packoffset(c000.x);
  float4 Material_688[14] : packoffset(c043.x);
};
...
float4 main(
  ...
  nointerpolation float4 COLOR_1 : COLOR1,
  nointerpolation float4 COLOR_2 : COLOR2,
  ...
  float4 SV_Target;
  float _68 = mad(SV_Position.z, (View_704[2].w), mad(SV_Position.y, (View_704[1].w), ((View_704[0].w) * SV_Position.x))) + (View_704[3].w);
  float _72 = ((mad(SV_Position.z, (View_704[2].x), mad(SV_Position.y, (View_704[1].x), ((View_704[0].x) * SV_Position.x))) + (View_704[3].x)) / _68) - View_1120.x;
  float _73 = ((mad(SV_Position.z, (View_704[2].y), mad(SV_Position.y, (View_704[1].y), ((View_704[0].y) * SV_Position.x))) + (View_704[3].y)) / _68) - View_1120.y;
  float _74 = ((mad(SV_Position.z, (View_704[2].z), mad(SV_Position.y, (View_704[1].z), ((View_704[0].z) * SV_Position.x))) + (View_704[3].z)) / _68) - View_1120.z;
  float _75 = TEXCOORD_9.x - View_1120.x;
  float _76 = TEXCOORD_9.y - View_1120.y;
  float _77 = TEXCOORD_9.z - View_1120.z;
  float _80 = TEXCOORD.w - TEXCOORD.x;
  float _81 = TEXCOORD.z - TEXCOORD.y;
  float _84 = ((Material_688[0].z) * _80) + TEXCOORD.x;
  float _85 = ((Material_688[0].z) * _81) + TEXCOORD.y;
  float _94 = (SV_Position.x - View_2144.x) * View_2160.z;
  float _95 = (SV_Position.y - View_2144.y) * View_2160.w;
  float _102 = (_84 + -0.5f) + ((_94 - _84) * (Material_688[0].w));
  float _104 = (_85 + -0.5f) + ((_95 - _85) * (Material_688[0].w));
  float _123 = NIAGARA_LOCAL_TIME * 0.00027777778450399637f;
  float _127 = frac(abs(_123));
  float _130 = select((_123 >= (-0.0f - _123)), _127, (-0.0f - _127)) * 3600.0f;
  float _135 = ((((Material_688[4].z) - _130) * (Material_688[4].y)) + _130) * (Material_688[4].w);
  bool _137 = ((NiagaraMeshVF_068 & 1) != 0);
  float _143 = (_135 + select(_137, COLOR_2.x, 0.0f)) - (_135 * (Material_688[5].x));
  float _157 = (((Material_000[14].x) + ((Material_000[12].x) * (dot(float2(_102, _104), float2((Material_000[6].x), (Material_000[6].y))) + 0.5f))) + (Material_000[16].x)) + (_143 * (Material_000[13].x));
  float _160 = (((Material_000[14].y) + ((Material_000[12].y) * (dot(float2(_102, _104), float2((Material_000[7].x), (Material_000[7].y))) + 0.5f))) + (Material_000[16].y)) + (_143 * (Material_000[13].y));
  float4 _176 = t0.SampleBias(s0, float2(((_157 + (Material_000[17].x)) + ((saturate(_157) - _157) * (Material_688[5].x))), ((_160 + (Material_000[17].y)) + ((saturate(_160) - _160) * (Material_688[5].x)))), View_2388, int2(0, 0));
  float _186 = dot(float4(_176.x, _176.y, _176.z, _176.w), float4((Material_000[19].x), (Material_000[19].y), (Material_000[19].z), (Material_000[19].w)));
  float _195 = ((Material_688[6].x) * (_186 - _176.x)) + _176.x;
  float _196 = ((Material_688[6].x) * (_186 - _176.y)) + _176.y;
  float _197 = ((Material_688[6].x) * (_186 - _176.z)) + _176.z;
  float _215 = (Material_688[6].z) * select((_195 <= 2.980232949312267e-08f), 0.0f, exp2(log2(_195) * (Material_688[6].y)));
  float _216 = (Material_688[6].z) * select((_196 <= 2.980232949312267e-08f), 0.0f, exp2(log2(_196) * (Material_688[6].y)));
  float _217 = (Material_688[6].z) * select((_197 <= 2.980232949312267e-08f), 0.0f, exp2(log2(_197) * (Material_688[6].y)));
  float _246 = ((Material_000[22].x) * COLOR_1.x) * ((((Material_688[7].y) + _215) + ((((Material_688[6].w) * _195) - _215) * (Material_688[7].x))) + (Material_688[7].z));
  float _248 = ((Material_000[22].y) * COLOR_1.y) * ((((Material_688[7].y) + _216) + ((((Material_688[6].w) * _196) - _216) * (Material_688[7].x))) + (Material_688[7].z));
  float _250 = ((Material_000[22].z) * COLOR_1.z) * ((((Material_688[7].y) + _217) + ((((Material_688[6].w) * _197) - _217) * (Material_688[7].x))) + (Material_688[7].z));
  float _260 = _94 - (Primitive_432[0].w);
  float _261 = (1.0f - _95) - (Primitive_432[1].x);
  float _273 = ((Material_688[8].z) * _80) + TEXCOORD.x;
  float _274 = ((Material_688[8].z) * _81) + TEXCOORD.y;
  float _281 = (_273 + -0.5f) + ((_94 - _273) * (Material_688[8].w));
  float _283 = (_274 + -0.5f) + ((_95 - _274) * (Material_688[8].w));
  float _304 = (_135 + select(_137, COLOR_2.y, 0.0f)) - (_135 * (Material_688[12].y));
  float _318 = (((Material_000[36].x) + ((Material_000[34].x) * (dot(float2(_281, _283), float2((Material_000[28].x), (Material_000[28].y))) + 0.5f))) + (_304 * (Material_000[35].x))) + (Material_000[38].x);
  float _321 = (((Material_000[36].y) + ((Material_000[34].y) * (dot(float2(_281, _283), float2((Material_000[29].x), (Material_000[29].y))) + 0.5f))) + (_304 * (Material_000[35].y))) + (Material_000[38].y);
  float4 _336 = t1.SampleLevel(s1, float2((((Material_000[39].x) + _318) + ((saturate(_318) - _318) * (Material_688[12].y))), (((Material_000[39].y) + _321) + ((saturate(_321) - _321) * (Material_688[12].y)))), (View_2388 + -1.0f));
  float _346 = dot(float4(_336.x, _336.y, _336.z, _336.w), float4((Material_000[41].x), (Material_000[41].y), (Material_000[41].z), (Material_000[41].w)));
  float _357 = (((dot(float4(_176.x, _176.y, _176.z, _176.w), float4((Material_000[24].x), (Material_000[24].y), (Material_000[24].z), (Material_000[24].w))) * COLOR_1.w) * (Material_688[7].w)) * (Material_688[13].x)) * (((Material_688[12].w) * ((_346 * -2.0f) + 1.0f)) + _346);
  float _443;
  float _444;
  float _445;
  float _520;
  ...
  if ((Primitive_432[0].x) > 0.5f) {
    _443 = max(((exp2(log2(max(_246, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _444 = max(((exp2(log2(max(_248, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _445 = max(((exp2(log2(max(_250, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
  } else {
    _443 = _246;
    _444 = _248;
    _445 = _250;
  }
  float _464 = (((Primitive_432[7].w) * ((Primitive_432[6].w) + -1.0f)) + 1.0f) * _443;
  float _465 = (((Primitive_432[7].w) * ((Primitive_432[7].x) + -1.0f)) + 1.0f) * _444;
  float _466 = (((Primitive_432[7].w) * ((Primitive_432[7].y) + -1.0f)) + 1.0f) * _445;
  float _482 = saturate((((Primitive_432[7].w) * ((Primitive_432[7].z) + -1.0f)) + 1.0f) * select(((bool)((Primitive_432[8].y) >= 0.5f) && (bool)(abs((Primitive_432[8].y) + -0.5f) > 9.999999747378752e-06f)), select(((bool)(_261 > (Primitive_432[1].z)) || ((bool)((bool)(_260 > (Primitive_432[1].y)) || ((bool)((bool)(_260 < (-0.0f - (Primitive_432[1].y))) || (bool)(_261 < (-0.0f - (Primitive_432[1].z)))))))), 0.0f, _357), select(((Primitive_432[0].y) > 0.5f), (((1.0f - saturate((abs((((((Primitive_432[3].w) * _75) - (Primitive_432[0].w)) + (Primitive_432[4].z)) + ((Primitive_432[4].w) * _76)) + ((Primitive_432[5].w) * _77)) - (Primitive_432[1].y)) / (Primitive_432[1].w))) * _357) * (1.0f - saturate((abs((((((Primitive_432[4].x) * _75) - (Primitive_432[1].x)) + ((Primitive_432[5].x) * _76)) + (Primitive_432[5].z)) + ((Primitive_432[6].x) * _77)) - (Primitive_432[1].z)) / (Primitive_432[2].x)))), _357)));
  float _483 = max(((((Material_000[42].x) - _464) * (Material_688[13].y)) + _464), 0.0f);
  float _484 = max(((((Material_000[42].y) - _465) * (Material_688[13].y)) + _465), 0.0f);
  float _485 = max(((((Material_000[42].z) - _466) * (Material_688[13].y)) + _466), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_74 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_72 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_73 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      float _517 = float((bool)(bool)(frac(dot(float3(_72, _73, _74), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _520 = 1.0f;
      _521 = (1.0f - _517);
      _522 = 1.0f;
      _523 = _517;
  ...
  if (!(TranslucentBasePass_4352 == 0)) {
    do {
      ...
      if (TranslucentBasePass_4368 == 0.0f) {
        float _547 = 1.0f / TranslucentBasePass_4356;
        _558 = exp2(log2(1.0f - exp2((_521 * -1.4426950216293335f) * TranslucentBasePass_4364)) * _547);
      ...
      do {
        ...
        if (TranslucentBasePass_4368 == 1.0f) {
          float _564 = TranslucentBasePass_4372 * _558;
          float _565 = TranslucentBasePass_4372 * _559;
          float _566 = TranslucentBasePass_4372 * _560;
          float _568 = TranslucentBasePass_4376 * 1.3600000143051147f;
          float _569 = TranslucentBasePass_4376 * 0.9599999785423279f;
          float _606 = 1.0f / TranslucentBasePass_4356;
          _617 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_568 * _564) + 0.04699999839067459f) * _564) / ((((_569 * _564) + 0.5600000023841858f) * _564) + 0.14000000059604645f)))) * _606);
          _618 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_568 * _565) + 0.04699999839067459f) * _565) / ((((_569 * _565) + 0.5600000023841858f) * _565) + 0.14000000059604645f)))) * _606);
          _619 = exp2(log2(saturate(TranslucentBasePass_4380 + saturate((((_568 * _566) + 0.04699999839067459f) * _566) / ((((_569 * _566) + 0.5600000023841858f) * _566) + 0.14000000059604645f)))) * _606);
        } else {
          _617 = _558;
          _618 = _559;
          _619 = _560;
        ...
        do {
          ...
          if (TranslucentBasePass_4368 == 2.0f) {
            float _624 = TranslucentBasePass_4384 * _617;
            float _625 = TranslucentBasePass_4384 * _618;
            float _626 = TranslucentBasePass_4384 * _619;
            float _632 = TranslucentBasePass_4392 * -0.16398000717163086f;
            float _636 = (_632 / (_624 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _637 = (_632 / (_625 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _638 = (_632 / (_626 + -0.19505000114440918f)) + 1.0049500465393066f;
            float _659 = 1.0f / TranslucentBasePass_4356;
            _670 = exp2(log2(saturate(((_624 - _636) * select((TranslucentBasePass_4388 < _624), 0.0f, 1.0f)) + _636)) * _659);
            _671 = exp2(log2(saturate(((_625 - _637) * select((TranslucentBasePass_4388 < _625), 0.0f, 1.0f)) + _637)) * _659);
            _672 = exp2(log2(saturate(((_626 - _638) * select((TranslucentBasePass_4388 < _626), 0.0f, 1.0f)) + _638)) * _659);
          } else {
            _670 = _617;
            _671 = _618;
            _672 = _619;
          ...
          if (TranslucentBasePass_4368 == 3.0f) {
            float _677 = TranslucentBasePass_4396 * _670;
            float _678 = TranslucentBasePass_4396 * _671;
            float _679 = TranslucentBasePass_4396 * _672;
            float _714 = exp2(log2(abs(_677)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_677 > 0.0f))) - ((int)(uint)((bool)(_677 < 0.0f)))));
            float _715 = exp2(log2(abs(_678)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_678 > 0.0f))) - ((int)(uint)((bool)(_678 < 0.0f)))));
            float _716 = exp2(log2(abs(_679)) * TranslucentBasePass_4408) * float((int)(((int)(uint)((bool)(_679 > 0.0f))) - ((int)(uint)((bool)(_679 < 0.0f)))));
            float _717 = TranslucentBasePass_4400 * 5.340000152587891f;
            float _718 = _714 * _717;
            float _719 = _715 * _717;
            float _720 = _716 * _717;
            float _742 = TranslucentBasePass_4404 + -0.0004396551812533289f;
            float _751 = 1.0f / TranslucentBasePass_4356;
            _762 = exp2(log2(saturate(_742 + ((((_718 + 2.609099864959717f) * _714) + 0.0013464000076055527f) / (((_718 + 1.1699999570846558f) * _714) + 3.0624001026153564f)))) * _751);
            _763 = exp2(log2(saturate(_742 + ((((_719 + 2.609099864959717f) * _715) + 0.0013464000076055527f) / (((_719 + 1.1699999570846558f) * _715) + 3.0624001026153564f)))) * _751);
            _764 = exp2(log2(saturate(_742 + ((((_720 + 2.609099864959717f) * _716) + 0.0013464000076055527f) / (((_720 + 1.1699999570846558f) * _716) + 3.0624001026153564f)))) * _751);
          } else {
            _762 = _670;
            _763 = _671;
            _764 = _672;
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _762), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _763), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _764), 0.0f));
  SV_Target.w = _520;
