...
float4 main(
  ...
  _65 = ((mad(SV_Position.z, (View_704[2].z), mad(SV_Position.y, (View_704[1].z), ((View_704[0].z) * SV_Position.x))) + (View_704[3].z)) / _59) - View_1120.z;
  ...
  _79 = t0.SampleBias(s0, float2(TEXCOORD.x, TEXCOORD.y), View_2388, int2(0, 0));
  _82 = max(_79.x, _79.y);
  _83 = ceil(_82);
  _87 = ceil(TEXCOORD.z);
  _92 = t1.SampleBias(s1, float2((TEXCOORD.z + -1.0f), (TEXCOORD.w + -1.0f)), View_2388, int2(0, 0));
  _97 = _92.x * _87;
  _98 = _92.y * _87;
  _99 = _92.z * _87;
  if ((Material_032[0].x) > 0.5f) {
    _127 = max(((exp2(log2(max(_97, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _128 = max(((exp2(log2(max(_98, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
    _129 = max(((exp2(log2(max(_99, 0.0f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f), 0.0f);
  } else {
    _127 = _97;
    _128 = _98;
    _129 = _99;
  ...
  if (!(TranslucentBasePass_4416 == 0)) {
    ...
    if (TranslucentBasePass_4432 == 0.0f) {
      _223 = (((TranslucentBasePass_4420 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4424 - TranslucentBasePass_4428)) + TranslucentBasePass_4428;
      _231 = (((TranslucentBasePass_4488 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4480 - TranslucentBasePass_4484)) + TranslucentBasePass_4484;
      _232 = (_223 * _188) * _231;
      _233 = (_223 * _189) * _231;
      _234 = (_223 * _190) * _231;
      _239 = max((_232 - TranslucentBasePass_4476), 0.0f);
      _240 = max((_233 - TranslucentBasePass_4476), 0.0f);
      _241 = max((_234 - TranslucentBasePass_4476), 0.0f);
      _254 = TranslucentBasePass_4460 * -1.4426950216293335f;
      ...
      _264 = _261 * TranslucentBasePass_4436;
      _265 = _262 * TranslucentBasePass_4436;
      _266 = _263 * TranslucentBasePass_4436;
      _267 = TranslucentBasePass_4444 * TranslucentBasePass_4440;
      _274 = TranslucentBasePass_4452 * TranslucentBasePass_4448;
      _284 = TranslucentBasePass_4456 * TranslucentBasePass_4448;
      _291 = TranslucentBasePass_4452 / TranslucentBasePass_4456;
      _307 = saturate(((saturate(((((_264 + _267) * _261) + _274) / (((_264 + TranslucentBasePass_4440) * _261) + _284)) - _291) + -0.5f) * TranslucentBasePass_4464) + 0.5f);
      _308 = saturate(((saturate(((((_265 + _267) * _262) + _274) / (((_265 + TranslucentBasePass_4440) * _262) + _284)) - _291) + -0.5f) * TranslucentBasePass_4464) + 0.5f);
      _309 = saturate(((saturate(((((_266 + _267) * _263) + _274) / (((_266 + TranslucentBasePass_4440) * _263) + _284)) - _291) + -0.5f) * TranslucentBasePass_4464) + 0.5f);
      _310 = dot(float3(_307, _308, _309), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      _323 = 1.0f / TranslucentBasePass_4468;
      _334 = exp2(log2(saturate(lerp(_310, _307, TranslucentBasePass_4472))) * _323);
      _335 = exp2(log2(saturate(lerp(_310, _308, TranslucentBasePass_4472))) * _323);
      _336 = exp2(log2(saturate(lerp(_310, _309, TranslucentBasePass_4472))) * _323);
    } else {
      _334 = _188;
      _335 = _189;
      _336 = _190;
    ...
    if (TranslucentBasePass_4432 == 1.0f) {
      _358 = ((((TranslucentBasePass_4424 - TranslucentBasePass_4428) * saturate(TranslucentBasePass_4420 * 0.009999999776482582f)) + TranslucentBasePass_4428) * 0.012500000186264515f) * (((TranslucentBasePass_4480 - TranslucentBasePass_4484) * saturate(TranslucentBasePass_4488 * 0.009999999776482582f)) + TranslucentBasePass_4484);
      _363 = (_358 * _334);
      _364 = (_358 * _335);
      _365 = (_358 * _336);
    } else {
  ...
  bool isUuid = (local.x >= 0.85f) && (local.y >= 0.95f);
