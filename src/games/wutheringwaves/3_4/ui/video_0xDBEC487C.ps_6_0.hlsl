...
float4 main(
  ...
  if (!(TranslucentBasePass_4416 == 0)) {
    ...
    if (TranslucentBasePass_4432 == 0.0f) {
      _211 = (((TranslucentBasePass_4420 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4424 - TranslucentBasePass_4428)) + TranslucentBasePass_4428;
      _219 = (((TranslucentBasePass_4488 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4480 - TranslucentBasePass_4484)) + TranslucentBasePass_4484;
      _220 = (_211 * _176) * _219;
      _221 = (_211 * _177) * _219;
      _222 = (_211 * _178) * _219;
      _227 = max((_220 - TranslucentBasePass_4476), 0.0f);
      _228 = max((_221 - TranslucentBasePass_4476), 0.0f);
      _229 = max((_222 - TranslucentBasePass_4476), 0.0f);
      _242 = TranslucentBasePass_4460 * -1.4426950216293335f;
      ...
      _252 = _249 * TranslucentBasePass_4436;
      _253 = _250 * TranslucentBasePass_4436;
      _254 = _251 * TranslucentBasePass_4436;
      _255 = TranslucentBasePass_4444 * TranslucentBasePass_4440;
      _262 = TranslucentBasePass_4452 * TranslucentBasePass_4448;
      _272 = TranslucentBasePass_4456 * TranslucentBasePass_4448;
      _279 = TranslucentBasePass_4452 / TranslucentBasePass_4456;
      _295 = saturate(((saturate(((((_252 + _255) * _249) + _262) / (((_252 + TranslucentBasePass_4440) * _249) + _272)) - _279) + -0.5f) * TranslucentBasePass_4464) + 0.5f);
      _296 = saturate(((saturate(((((_253 + _255) * _250) + _262) / (((_253 + TranslucentBasePass_4440) * _250) + _272)) - _279) + -0.5f) * TranslucentBasePass_4464) + 0.5f);
      _297 = saturate(((saturate(((((_254 + _255) * _251) + _262) / (((_254 + TranslucentBasePass_4440) * _251) + _272)) - _279) + -0.5f) * TranslucentBasePass_4464) + 0.5f);
      _298 = dot(float3(_295, _296, _297), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      _311 = 1.0f / TranslucentBasePass_4468;
      _322 = exp2(log2(saturate(lerp(_298, _295, TranslucentBasePass_4472))) * _311);
      _323 = exp2(log2(saturate(lerp(_298, _296, TranslucentBasePass_4472))) * _311);
      _324 = exp2(log2(saturate(lerp(_298, _297, TranslucentBasePass_4472))) * _311);
    } else {
      _322 = _176;
      _323 = _177;
      _324 = _178;
    ...
    if (TranslucentBasePass_4432 == 1.0f) {
      _346 = ((((TranslucentBasePass_4424 - TranslucentBasePass_4428) * saturate(TranslucentBasePass_4420 * 0.009999999776482582f)) + TranslucentBasePass_4428) * 0.012500000186264515f) * (((TranslucentBasePass_4480 - TranslucentBasePass_4484) * saturate(TranslucentBasePass_4488 * 0.009999999776482582f)) + TranslucentBasePass_4484);
      _351 = (_346 * _322);
      _352 = (_346 * _323);
      _353 = (_346 * _324);
    } else {
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _video_hdr.x), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _video_hdr.y), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _video_hdr.z), 0.0f));
  SV_Target.w = _175;
  return SV_Target;
}