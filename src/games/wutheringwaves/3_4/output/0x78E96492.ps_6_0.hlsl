...
float4 main(
  ...
  _415 = t0.Sample(s0, float2(_413, _414));
  _421 = saturate(cb0_098x);
  _423 = saturate(cb0_098y);
  if (_421 > 0.0f) {
    _434 = saturate(((_415.x * 0.29899999499320984f) + (_415.y * 0.5870000123977661f)) + (_415.z * 0.11400000005960464f));
    _440 = ((_434 * _434) * (saturate(1.0f - cb0_098z) * 2.0f)) * (3.0f - (_434 * 2.0f));
    _447 = max(sqrt(((_415.x * _415.x) + (_415.y * _415.y)) + (_415.z * _415.z)), 0.014999999664723873f);
    _448 = _415.x / _447;
    _449 = _415.y / _447;
    _450 = _415.z / _447;
    _460 = log2(_440);
    _479 = ((_292 * _212) * _329) * _421;
    _490 = (((((lerp(_448, 1.0f, 0.25f)) * (((_423 * 0.17000000178813934f) + 0.029999999329447746f) + _440)) - _415.x) * _479) + _415.x);
    _491 = (((((((_423 * 0.18000000715255737f) + 0.05000000074505806f) + exp2(_460 * 0.8999999761581421f)) * (lerp(_449, 1.0f, 0.25f))) - _415.y) * _479) + _415.y);
    _492 = (((((((_423 * 0.17999999225139618f) + 0.07999999821186066f) + exp2(_460 * 0.949999988079071f)) * (lerp(_450, 1.0f, 0.25f))) - _415.z) * _479) + _415.z);
  } else {
    _490 = _415.x;
    _491 = _415.y;
    _492 = _415.z;
  }
  _494 = saturate(cb0_099x);
  _495 = _385 * _494;
  if (_494 > 0.0f) {
    _506 = (sin(((_114 * 640.0f) + 640.0f) - (View_2376 * 10.0f)) * 0.5f) + 1.0f;
    _520 = ((((_506 * _490) - _490) * _495) + _490);
    _521 = ((((_506 * _491) - _491) * _495) + _491);
    _522 = ((((_506 * _492) - _492) * _495) + _492);
  } else {
    _520 = _490;
    _521 = _491;
    _522 = _492;
  }
  _545 = t1.Sample(s1, float2(min(max(((cb0_068x * _413) + cb0_068z), cb0_060x), cb0_060z), min(max(((cb0_068y * _414) + cb0_068w), cb0_060y), cb0_060w)));
  APPLY_BLOOM(_545);
  [branch]
  if (!(cb0_085x == 0)) {
    _572 = (cb0_085z != 0);
    _575 = t2.Sample(s2, float2(select(_572, _413, min(max(((cb0_076x * _413) + cb0_076z), cb0_075x), cb0_075z)), select(_572, _414, min(max(((cb0_076y * _414) + cb0_076w), cb0_075y), cb0_075w))));
    _583 = (_575.x + _545.x);
    _584 = (_575.y + _545.y);
    _585 = (_575.z + _545.z);
  } else {
  ...
  [branch]
  if (!(cb0_085y == 0)) {
    _589 = t3.Sample(s3, float2(_413, _414));
    _597 = (_589.x + _583);
    _598 = (_589.y + _584);
    _599 = (_589.z + _585);
  } else {
  ...
  _624 = TEXCOORD_1.z + -1.0f;
  _626 = TEXCOORD_1.w + -1.0f;
  _629 = ((_624 + (cb0_090x * 2.0f)) * cb0_088z) * cb0_088x;
  _631 = ((_626 + (cb0_090y * 2.0f)) * cb0_088w) * cb0_088x;
  _638 = 1.0f / ((((saturate(cb0_089w) * 9.0f) + 1.0f) * dot(float2(_629, _631), float2(_629, _631))) + 1.0f);
  _639 = _638 * _638;
  _640 = cb0_090z + 1.0f;
  _668 = ((_624 + (cb0_093x * 2.0f)) * cb0_091z) * cb0_091x;
  _670 = ((_626 + (cb0_093y * 2.0f)) * cb0_091w) * cb0_091x;
  _677 = 1.0f / ((((saturate(cb0_092w) * 9.0f) + 1.0f) * dot(float2(_668, _670), float2(_668, _670))) + 1.0f);
  _678 = _677 * _677;
  _679 = cb0_093z + 1.0f;
  _691 = (((_597 + ((_520 * TEXCOORD_1.x) * cb0_086x)) * _382) * ((_639 * (_640 - cb0_089x)) + cb0_089x)) * ((_678 * (_679 - cb0_092x)) + cb0_092x);
  _694 = (((_598 + ((_521 * TEXCOORD_1.x) * cb0_086y)) * _382) * ((_639 * (_640 - cb0_089y)) + cb0_089y)) * ((_678 * (_679 - cb0_092y)) + cb0_092y);
  _697 = (((_599 + ((_522 * TEXCOORD_1.x) * cb0_086z)) * _382) * ((_639 * (_640 - cb0_089z)) + cb0_089z)) * ((_678 * (_679 - cb0_092z)) + cb0_092z);
  CAPTURE_UNTONEMAPPED(float3(_691, _694, _697));
  [branch]
  if (WUWA_TM_IS(1)) {
    _730 = ((((_691 * 1.3600000143051147f) + 0.04699999839067459f) * _691) / ((((_691 * 0.9599999785423279f) + 0.5600000023841858f) * _691) + 0.14000000059604645f));
    _731 = ((((_694 * 1.3600000143051147f) + 0.04699999839067459f) * _694) / ((((_694 * 0.9599999785423279f) + 0.5600000023841858f) * _694) + 0.14000000059604645f));
    _732 = ((((_697 * 1.3600000143051147f) + 0.04699999839067459f) * _697) / ((((_697 * 0.9599999785423279f) + 0.5600000023841858f) * _697) + 0.14000000059604645f));
  } else {
    _730 = _691;
    _731 = _694;
    _732 = _697;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    _742 = 1.0049500465393066f - (0.16398000717163086f / (_730 + -0.19505000114440918f));
    _743 = 1.0049500465393066f - (0.16398000717163086f / (_731 + -0.19505000114440918f));
    _744 = 1.0049500465393066f - (0.16398000717163086f / (_732 + -0.19505000114440918f));
    _764 = ((_730 - _742) * select((_730 > 0.6000000238418579f), 0.0f, 1.0f)) + _742;
    _765 = ((_731 - _743) * select((_731 > 0.6000000238418579f), 0.0f, 1.0f)) + _743;
  ...
  if (WUWA_TM_IS(3)) {
    ...
    _773 = cb0_037y * _765;
    _774 = cb0_037y * _766;
    _777 = cb0_037z * cb0_037w;
    _787 = cb0_038y * cb0_038x;
    _798 = cb0_038z * cb0_038x;
    _805 = cb0_038y / cb0_038z;
    _813 = ((((_777 + _772) * _764) + _787) / (_798 + ((_772 + cb0_037z) * _764))) - _805;
    _814 = ((((_777 + _773) * _765) + _787) / (_798 + ((_773 + cb0_037z) * _765))) - _805;
    _815 = ((((_777 + _774) * _766) + _787) / (_798 + ((_774 + cb0_037z) * _766))) - _805;
  } else {
    _813 = _764;
    _814 = _765;
    _815 = _766;
  ...
  if (!(cb0_105w == 0)) {
    if (!(cb0_106x == 1.0f)) {
      _825 = (cb0_106x * 0.699999988079071f) + 0.30000001192092896f;
      _830 = (_825 * _813);
      _831 = (_825 * _814);
      _832 = (_825 * _815);
    } else {
  ...
  APPLY_EXTENDED_TONEMAP(_830, _831, _832);
  _853 = (saturate((log2(_830 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  _854 = (saturate((log2(_831 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  _855 = (saturate((log2(_832 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  _856 = t7.Sample(s7, float3(_853, _854, _855));
  [branch]
  if (!(cb0_107w == 0)) {
    _889 = select((((uint)(uint(float((uint)((int)((uint)(uint(round((((float4)(t6.Sample(s6, float2(min(max(((cb0_084x * _413) + cb0_084z), cb0_083x), cb0_083z), min(max(((cb0_084y * _414) + cb0_084w), cb0_083y), cb0_083w))))).w) * 255.0f))) & 15))))) & -4) == 12), 1.0f, 0.0f);
    _890 = t8.Sample(s8, float3(_853, _854, _855));
    _904 = (lerp(_890.x, _856.x, _889));
    _905 = (lerp(_890.y, _856.y, _889));
    _906 = (lerp(_890.z, _856.z, _889));
  } else {
    _904 = _856.x;
    _905 = _856.y;
    _906 = _856.z;
  }
  _907 = _906 * 1.0499999523162842f;
  _908 = _905 * 1.0499999523162842f;
  _909 = _904 * 1.0499999523162842f;
  _917 = ((_336 * 0.00390625f) + -0.001953125f) + _909;
  _918 = ((_359 * 0.00390625f) + -0.001953125f) + _908;
  _919 = ((_360 * 0.00390625f) + -0.001953125f) + _907;
  [branch]
  if (!(cb0_106w == 0)) {
    _931 = (pow(_917, 0.012683313339948654f));
    _932 = (pow(_918, 0.012683313339948654f));
    _933 = (pow(_919, 0.012683313339948654f));
    _966 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_931 + -0.8359375f)) / (18.8515625f - (_931 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    _967 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_932 + -0.8359375f)) / (18.8515625f - (_932 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    _968 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_933 + -0.8359375f)) / (18.8515625f - (_933 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    ...
    _996 = min((_968 * 12.920000076293945f), ((exp2(log2(max(_968, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _994 = _917;
    _995 = _918;
    _996 = _919;
  ...
  SV_Target.w = (dot(float3(_909, _908, _907), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
