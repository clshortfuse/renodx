...
float4 main(
  ...
  _701 = _700 * _700;
  _702 = cb0_093z + 1.0f;
  _714 = (((_620 + ((_543 * TEXCOORD_1.x) * cb0_086x)) * _384) * ((_662 * (_663 - cb0_089x)) + cb0_089x)) * ((_701 * (_702 - cb0_092x)) + cb0_092x);
  _717 = (((_621 + ((_544 * TEXCOORD_1.x) * cb0_086y)) * _384) * ((_662 * (_663 - cb0_089y)) + cb0_089y)) * ((_701 * (_702 - cb0_092y)) + cb0_092y);
  _720 = (((_622 + ((_545 * TEXCOORD_1.x) * cb0_086z)) * _384) * ((_662 * (_663 - cb0_089z)) + cb0_089z)) * ((_701 * (_702 - cb0_092z)) + cb0_092z);
  CAPTURE_UNTONEMAPPED(float3(_714, _717, _720));
  [branch]
  if (WUWA_TM_IS(1)) {
    _753 = ((((_714 * 1.3600000143051147f) + 0.04699999839067459f) * _714) / ((((_714 * 0.9599999785423279f) + 0.5600000023841858f) * _714) + 0.14000000059604645f));
    _754 = ((((_717 * 1.3600000143051147f) + 0.04699999839067459f) * _717) / ((((_717 * 0.9599999785423279f) + 0.5600000023841858f) * _717) + 0.14000000059604645f));
    _755 = ((((_720 * 1.3600000143051147f) + 0.04699999839067459f) * _720) / ((((_720 * 0.9599999785423279f) + 0.5600000023841858f) * _720) + 0.14000000059604645f));
  } else {
    _753 = _714;
    _754 = _717;
    _755 = _720;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    _765 = 1.0049500465393066f - (0.16398000717163086f / (_753 + -0.19505000114440918f));
    _766 = 1.0049500465393066f - (0.16398000717163086f / (_754 + -0.19505000114440918f));
    _767 = 1.0049500465393066f - (0.16398000717163086f / (_755 + -0.19505000114440918f));
    _787 = ((_753 - _765) * select((_753 > 0.6000000238418579f), 0.0f, 1.0f)) + _765;
    _788 = ((_754 - _766) * select((_754 > 0.6000000238418579f), 0.0f, 1.0f)) + _766;
    _789 = ((_755 - _767) * select((_755 > 0.6000000238418579f), 0.0f, 1.0f)) + _767;
  } else {
    _787 = _753;
    _788 = _754;
    _789 = _755;
  ...
  if (WUWA_TM_IS(3)) {
    ...
    _796 = cb0_037y * _788;
    _797 = cb0_037y * _789;
    _800 = cb0_037z * cb0_037w;
    _810 = cb0_038y * cb0_038x;
    _821 = cb0_038z * cb0_038x;
    _828 = cb0_038y / cb0_038z;
    _836 = ((((_800 + _795) * _787) + _810) / (_821 + ((_795 + cb0_037z) * _787))) - _828;
    _837 = ((((_800 + _796) * _788) + _810) / (_821 + ((_796 + cb0_037z) * _788))) - _828;
    _838 = ((((_800 + _797) * _789) + _810) / (_821 + ((_797 + cb0_037z) * _789))) - _828;
  } else {
    _836 = _787;
    _837 = _788;
    _838 = _789;
  ...
  if (!(cb0_105w == 0)) {
    if (!(cb0_106x == 1.0f)) {
      _848 = (cb0_106x * 0.699999988079071f) + 0.30000001192092896f;
      _853 = (_848 * _836);
      _854 = (_848 * _837);
      _855 = (_848 * _838);
    } else {
  ...
  APPLY_EXTENDED_TONEMAP(_853, _854, _855);
  _876 = (saturate((log2(_853 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  _877 = (saturate((log2(_854 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  _878 = (saturate((log2(_855 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  _879 = t7.Sample(s7, float3(_876, _877, _878));
  [branch]
  if (!(cb0_107w == 0)) {
    _912 = select((((uint)(uint(float((uint)((int)((uint)(uint(round((((float4)(t6.Sample(s6, float2(min(max(((cb0_084x * _426) + cb0_084z), cb0_083x), cb0_083z), min(max(((cb0_084y * _427) + cb0_084w), cb0_083y), cb0_083w))))).w) * 255.0f))) & 15))))) & -4) == 12), 1.0f, 0.0f);
    _913 = t8.Sample(s8, float3(_876, _877, _878));
    _927 = (lerp(_913.x, _879.x, _912));
    _928 = (lerp(_913.y, _879.y, _912));
    _929 = (lerp(_913.z, _879.z, _912));
  } else {
    _927 = _879.x;
    _928 = _879.y;
    _929 = _879.z;
  }
  _930 = _929 * 1.0499999523162842f;
  _931 = _928 * 1.0499999523162842f;
  _932 = _927 * 1.0499999523162842f;
  _940 = ((_338 * 0.00390625f) + -0.001953125f) + _932;
  _941 = ((_361 * 0.00390625f) + -0.001953125f) + _931;
  _942 = ((_362 * 0.00390625f) + -0.001953125f) + _930;
  [branch]
  if (!(cb0_106w == 0)) {
    _954 = (pow(_940, 0.012683313339948654f));
    _955 = (pow(_941, 0.012683313339948654f));
    _956 = (pow(_942, 0.012683313339948654f));
    _989 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_954 + -0.8359375f)) / (18.8515625f - (_954 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    _990 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_955 + -0.8359375f)) / (18.8515625f - (_955 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    _991 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_956 + -0.8359375f)) / (18.8515625f - (_956 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
  ...
  SV_Target.w = (dot(float3(_932, _931, _930), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
