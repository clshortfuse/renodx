...
float4 main(
  ...
  _56 = ((View_1040.x * (((float4)(t6.SampleLevel(s6, float2(_42, _43), 0.0f))).x)) + View_1040.y) + (1.0f / ((View_1040.z * (((float4)(t6.SampleLevel(s6, float2(_42, _43), 0.0f))).x)) - View_1040.w));
  _65 = 1.0f / ((View_1040.w + _56) * View_1040.z);
  _77 = TEXCOORD_2.w * 543.3099975585938f;
  _81 = frac(sin(_77 + TEXCOORD_2.z) * 493013.0f);
  if (cb0_096x > 0.0f) {
    _105 = ((cb0_096x * (frac((sin((TEXCOORD_2.z + 33.9900016784668f) + _77) * 493013.0f) + 7.177000045776367f) - _81)) + _81);
    _106 = ((cb0_096x * (frac((sin((TEXCOORD_2.z + 66.98999786376953f) + _77) * 493013.0f) + 14.298999786376953f) - _81)) + _81);
  } else {
    _105 = _81;
    _106 = _81;
  }
  _116 = cb0_117z * cb0_116x;
  _117 = cb0_117z * cb0_116y;
  _118 = (cb0_117x == 0.0f);
  _128 = (cb0_113z * TEXCOORD_3.x) + cb0_113x;
  _129 = (cb0_113w * TEXCOORD_3.y) + cb0_113y;
  _140 = float((int)(((int)(uint)((bool)(_128 > 0.0f))) - ((int)(uint)((bool)(_128 < 0.0f)))));
  _141 = float((int)(((int)(uint)((bool)(_129 > 0.0f))) - ((int)(uint)((bool)(_129 < 0.0f)))));
  _146 = saturate(abs(_128) - cb0_116z);
  _147 = saturate(abs(_129) - cb0_116z);
  _157 = _129 - ((_147 * _116) * _141);
  _159 = _129 - ((_147 * _117) * _141);
  _160 = (cb0_117x > 0.0f);
  if (_160) {
    _167 = (_157 - (cb0_117w * 0.4000000059604645f));
    _168 = (_159 - (cb0_117w * 0.20000000298023224f));
  } else {
    _167 = _157;
    _168 = _159;
  }
  _202 = t0.Sample(s0, float2(_42, _43));
  if (_160) {
    _218 = saturate(((((_202.y * 0.5870000123977661f) - cb0_117y) + (_202.x * 0.29899999499320984f)) + (_202.z * 0.11400000005960464f)) * 10.0f);
    _222 = (_218 * _218) * (3.0f - (_218 * 2.0f));
    _236 = ((((_202.x - (((float4)(t0.Sample(s0, float2((((cb0_048x * ((cb0_114z * (_128 - ((_146 * select(_118, _116, cb0_116x)) * _140))) + cb0_114x)) + cb0_048z) * cb0_047z), (((cb0_048y * ((cb0_114w * _167) + cb0_114y)) + cb0_048w) * cb0_047w))))).x)) + (_222 * ((((float4)(t0.Sample(s0, float2((((cb0_048x * ((cb0_114z * (_128 - ((_146 * select(_118, _116, cb0_116x)) * _140))) + cb0_114x)) + cb0_048z) * cb0_047z), (((cb0_048y * ((cb0_114w * _167) + cb0_114y)) + cb0_048w) * cb0_047w))))).x) - _202.x))) * cb0_117x) + (((float4)(t0.Sample(s0, float2((((cb0_048x * ((cb0_114z * (_128 - ((_146 * select(_118, _116, cb0_116x)) * _140))) + cb0_114x)) + cb0_048z) * cb0_047z), (((cb0_048y * ((cb0_114w * _167) + cb0_114y)) + cb0_048w) * cb0_047w))))).x));
    _237 = ((((_202.y - (((float4)(t0.Sample(s0, float2((((cb0_048x * ((cb0_114z * (_128 - ((_146 * select(_118, _117, cb0_116y)) * _140))) + cb0_114x)) + cb0_048z) * cb0_047z), (((cb0_048y * ((cb0_114w * _168) + cb0_114y)) + cb0_048w) * cb0_047w))))).y)) + (_222 * ((((float4)(t0.Sample(s0, float2((((cb0_048x * ((cb0_114z * (_128 - ((_146 * select(_118, _117, cb0_116y)) * _140))) + cb0_114x)) + cb0_048z) * cb0_047z), (((cb0_048y * ((cb0_114w * _168) + cb0_114y)) + cb0_048w) * cb0_047w))))).y) - _202.y))) * cb0_117x) + (((float4)(t0.Sample(s0, float2((((cb0_048x * ((cb0_114z * (_128 - ((_146 * select(_118, _117, cb0_116y)) * _140))) + cb0_114x)) + cb0_048z) * cb0_047z), (((cb0_048y * ((cb0_114w * _168) + cb0_114y)) + cb0_048w) * cb0_047w))))).y));
  } else {
    _236 = (((float4)(t0.Sample(s0, float2((((cb0_048x * ((cb0_114z * (_128 - ((_146 * select(_118, _116, cb0_116x)) * _140))) + cb0_114x)) + cb0_048z) * cb0_047z), (((cb0_048y * ((cb0_114w * _167) + cb0_114y)) + cb0_048w) * cb0_047w))))).x);
    _237 = (((float4)(t0.Sample(s0, float2((((cb0_048x * ((cb0_114z * (_128 - ((_146 * select(_118, _117, cb0_116y)) * _140))) + cb0_114x)) + cb0_048z) * cb0_047z), (((cb0_048y * ((cb0_114w * _168) + cb0_114y)) + cb0_048w) * cb0_047w))))).y);
  }
  _260 = t1.Sample(s1, float2(min(max(((cb0_068x * _42) + cb0_068z), cb0_060x), cb0_060z), min(max(((cb0_068y * _43) + cb0_068w), cb0_060y), cb0_060w)));
  APPLY_BLOOM(_260);
  [branch]
  if (!(cb0_085x == 0)) {
    _287 = (cb0_085z != 0);
    _290 = t2.Sample(s2, float2(select(_287, _42, min(max(((cb0_076x * _42) + cb0_076z), cb0_075x), cb0_075z)), select(_287, _43, min(max(((cb0_076y * _43) + cb0_076w), cb0_075y), cb0_075w))));
    _298 = (_290.x + _260.x);
    _299 = (_290.y + _260.y);
    _300 = (_290.z + _260.z);
  } else {
  ...
  [branch]
  if (!(cb0_085y == 0)) {
    _304 = t3.Sample(s3, float2(_42, _43));
    _312 = (_304.x + _298);
    _313 = (_304.y + _299);
    _314 = (_304.z + _300);
  } else {
  ...
  _339 = TEXCOORD_1.z + -1.0f;
  _341 = TEXCOORD_1.w + -1.0f;
  _344 = ((_339 + (cb0_090x * 2.0f)) * cb0_088z) * cb0_088x;
  _346 = ((_341 + (cb0_090y * 2.0f)) * cb0_088w) * cb0_088x;
  _353 = 1.0f / ((((saturate(cb0_089w) * 9.0f) + 1.0f) * dot(float2(_344, _346), float2(_344, _346))) + 1.0f);
  _354 = _353 * _353;
  _355 = cb0_090z + 1.0f;
  _383 = ((_339 + (cb0_093x * 2.0f)) * cb0_091z) * cb0_091x;
  _385 = ((_341 + (cb0_093y * 2.0f)) * cb0_091w) * cb0_091x;
  _392 = 1.0f / ((((saturate(cb0_092w) * 9.0f) + 1.0f) * dot(float2(_383, _385), float2(_383, _385))) + 1.0f);
  _393 = _392 * _392;
  _394 = cb0_093z + 1.0f;
  _405 = (((_354 * (_355 - cb0_089x)) + cb0_089x) * (_312 + ((_236 * TEXCOORD_1.x) * cb0_086x))) * ((_393 * (_394 - cb0_092x)) + cb0_092x);
  _407 = (((_354 * (_355 - cb0_089y)) + cb0_089y) * (_313 + ((_237 * TEXCOORD_1.x) * cb0_086y))) * ((_393 * (_394 - cb0_092y)) + cb0_092y);
  _409 = (((_354 * (_355 - cb0_089z)) + cb0_089z) * (_314 + ((_202.z * TEXCOORD_1.x) * cb0_086z))) * ((_393 * (_394 - cb0_092z)) + cb0_092z);
  CAPTURE_UNTONEMAPPED(float3(_405, _407, _409));
  [branch]
  if (WUWA_TM_IS(1)) {
    _442 = ((((_405 * 1.3600000143051147f) + 0.04699999839067459f) * _405) / ((((_405 * 0.9599999785423279f) + 0.5600000023841858f) * _405) + 0.14000000059604645f));
    _443 = ((((_407 * 1.3600000143051147f) + 0.04699999839067459f) * _407) / ((((_407 * 0.9599999785423279f) + 0.5600000023841858f) * _407) + 0.14000000059604645f));
    _444 = ((((_409 * 1.3600000143051147f) + 0.04699999839067459f) * _409) / ((((_409 * 0.9599999785423279f) + 0.5600000023841858f) * _409) + 0.14000000059604645f));
  } else {
    _442 = _405;
    _443 = _407;
    _444 = _409;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    _454 = 1.0049500465393066f - (0.16398000717163086f / (_442 + -0.19505000114440918f));
    _455 = 1.0049500465393066f - (0.16398000717163086f / (_443 + -0.19505000114440918f));
    _456 = 1.0049500465393066f - (0.16398000717163086f / (_444 + -0.19505000114440918f));
    _476 = ((_442 - _454) * select((_442 > 0.6000000238418579f), 0.0f, 1.0f)) + _454;
    _477 = ((_443 - _455) * select((_443 > 0.6000000238418579f), 0.0f, 1.0f)) + _455;
    _478 = ((_444 - _456) * select((_444 > 0.6000000238418579f), 0.0f, 1.0f)) + _456;
  } else {
    _476 = _442;
    _477 = _443;
    _478 = _444;
  ...
  if (WUWA_TM_IS(3)) {
    ...
    _485 = cb0_037y * _477;
    _486 = cb0_037y * _478;
    _489 = cb0_037z * cb0_037w;
    _499 = cb0_038y * cb0_038x;
    _510 = cb0_038z * cb0_038x;
    _517 = cb0_038y / cb0_038z;
    _525 = ((((_489 + _484) * _476) + _499) / (_510 + ((_484 + cb0_037z) * _476))) - _517;
    _526 = ((((_489 + _485) * _477) + _499) / (_510 + ((_485 + cb0_037z) * _477))) - _517;
    _527 = ((((_489 + _486) * _478) + _499) / (_510 + ((_486 + cb0_037z) * _478))) - _517;
  } else {
    _525 = _476;
    _526 = _477;
    _527 = _478;
  ...
  if (!(cb0_105w == 0)) {
    if (!(cb0_106x == 1.0f)) {
      _537 = (cb0_106x * 0.699999988079071f) + 0.30000001192092896f;
      _542 = (_537 * _525);
      _543 = (_537 * _526);
      _544 = (_537 * _527);
    } else {
  ...
  APPLY_EXTENDED_TONEMAP(_542, _543, _544);
  _565 = (saturate((log2(_542 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  _566 = (saturate((log2(_543 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  _567 = (saturate((log2(_544 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  _568 = t8.Sample(s8, float3(_565, _566, _567));
  [branch]
  if (cb0_107w == 0) {
    _618 = select(((select((((_65 - (((float4)(t5.Sample(s5, float2(_42, _43)))).x)) + ((((View_448[3].z) - _65) + ((View_448[2].z) * _56)) * select(((View_448[3].w) < 1.0f), 0.0f, 1.0f))) > 0.0005000000237487257f), 0.0f, 1.0f) * (((float4)(t5.Sample(s5, float2(_42, _43)))).x)) > 0.0f), 0.0f, 1.0f);
    _619 = t4.Sample(s4, float3(_565, _566, _567));
    _633 = (lerp(_619.x, _568.x, _618));
    _634 = (lerp(_619.y, _568.y, _618));
    _635 = (lerp(_619.z, _568.z, _618));
  } else {
    _601 = select((((uint)(uint(float((uint)((int)((uint)(uint(round((((float4)(t7.Sample(s7, float2(min(max(((cb0_084x * _42) + cb0_084z), cb0_083x), cb0_083z), min(max(((cb0_084y * _43) + cb0_084w), cb0_083y), cb0_083w))))).w) * 255.0f))) & 15))))) & -4) == 12), 1.0f, 0.0f);
    _602 = t9.Sample(s9, float3(_565, _566, _567));
    _633 = (lerp(_602.x, _568.x, _601));
    _634 = (lerp(_602.y, _568.y, _601));
    _635 = (lerp(_602.z, _568.z, _601));
  }
  _636 = _635 * 1.0499999523162842f;
  _637 = _634 * 1.0499999523162842f;
  _638 = _633 * 1.0499999523162842f;
  _646 = ((_81 * 0.00390625f) + -0.001953125f) + _638;
  _647 = ((_105 * 0.00390625f) + -0.001953125f) + _637;
  _648 = ((_106 * 0.00390625f) + -0.001953125f) + _636;
  [branch]
  if (!(cb0_106w == 0)) {
    _660 = (pow(_646, 0.012683313339948654f));
    _661 = (pow(_647, 0.012683313339948654f));
    _662 = (pow(_648, 0.012683313339948654f));
    _695 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_660 + -0.8359375f)) / (18.8515625f - (_660 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    _696 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_661 + -0.8359375f)) / (18.8515625f - (_661 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    _697 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_662 + -0.8359375f)) / (18.8515625f - (_662 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    _723 = min((_695 * 12.920000076293945f), ((exp2(log2(max(_695, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _724 = min((_696 * 12.920000076293945f), ((exp2(log2(max(_696, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _725 = min((_697 * 12.920000076293945f), ((exp2(log2(max(_697, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _723 = _646;
    _724 = _647;
    _725 = _648;
  ...
  SV_Target.w = (dot(float3(_638, _637, _636), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
