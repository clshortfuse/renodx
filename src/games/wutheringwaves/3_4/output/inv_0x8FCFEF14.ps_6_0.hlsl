...
float4 main(
  ...
  GENERATE_INVERSION(_718, _719, _720);
  _729 = ((((_719 * 587.0f) + (_718 * 299.0f)) + (_720 * 114.0f)) * 0.0010000000474974513f) - cb0_108z;
  _736 = saturate(float((int)(((int)(uint)((bool)(_729 > 0.0f))) - ((int)(uint)((bool)(_729 < 0.0f))))));
  _743 = cb0_109x - _718;
  _744 = cb0_109y - _719;
  _745 = cb0_109z - _720;
  _750 = WUWA_PEAK_SCALING * cb0_110x - _718;
  _751 = WUWA_PEAK_SCALING * cb0_110y - _719;
  _752 = WUWA_PEAK_SCALING * cb0_110z - _720;
  [branch]
  if (cb0_108y > 0.0f) {
    _769 = (_743 * cb0_108y);
    _770 = (_744 * cb0_108y);
