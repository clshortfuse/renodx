...
float4 main(
  ...
  GENERATE_INVERSION(_741, _742, _743);
  _752 = ((((_742 * 587.0f) + (_741 * 299.0f)) + (_743 * 114.0f)) * 0.0010000000474974513f) - cb0_108z;
  _759 = saturate(float((int)(((int)(uint)((bool)(_752 > 0.0f))) - ((int)(uint)((bool)(_752 < 0.0f))))));
  _766 = cb0_109x - _741;
  _767 = cb0_109y - _742;
  _768 = cb0_109z - _743;
  _773 = WUWA_PEAK_SCALING * cb0_110x - _741;
  _774 = WUWA_PEAK_SCALING * cb0_110y - _742;
  _775 = WUWA_PEAK_SCALING * cb0_110z - _743;
  [branch]
  if (cb0_108y > 0.0f) {
    _792 = (_766 * cb0_108y);
    _793 = (_767 * cb0_108y);
