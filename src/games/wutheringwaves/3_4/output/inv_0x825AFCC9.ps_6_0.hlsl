...
float4 main(
  ...
  GENERATE_INVERSION(_1122, _1123, _1124);
  _1133 = ((((_1123 * 587.0f) + (_1122 * 299.0f)) + (_1124 * 114.0f)) * 0.0010000000474974513f) - cb0_108z;
  _1140 = saturate(float((int)(((int)(uint)((bool)(_1133 > 0.0f))) - ((int)(uint)((bool)(_1133 < 0.0f))))));
  _1147 = cb0_109x - _1122;
  _1148 = cb0_109y - _1123;
  _1149 = cb0_109z - _1124;
  _1154 = WUWA_PEAK_SCALING * cb0_110x - _1122;
  _1155 = WUWA_PEAK_SCALING * cb0_110y - _1123;
  _1156 = WUWA_PEAK_SCALING * cb0_110z - _1124;
  [branch]
  if (cb0_108y > 0.0f) {
    _1173 = (_1147 * cb0_108y);
    _1174 = (_1148 * cb0_108y);
    _1175 = (_1149 * cb0_108y);
    _1176 = (_1154 * cb0_108y);
    _1177 = (_1155 * cb0_108y);
    _1178 = (_1156 * cb0_108y);
  } else {
    _1165 = abs(cb0_108y);
    _1173 = (_1154 * _1165);
    _1174 = (_1155 * _1165);
  ...
  SV_Target.x = ((cb0_108x * (lerp(_1173, _1176, _1140))) + _1122);
  SV_Target.y = ((cb0_108x * (lerp(_1174, _1177, _1140))) + _1123);
  SV_Target.z = (((lerp(_1175, _1178, _1140)) * cb0_108x) + _1124);
