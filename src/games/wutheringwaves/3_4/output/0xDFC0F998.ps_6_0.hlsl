...
float4 main(
  ...
  _858 = _857 * _857;
  _859 = cb0_093z + 1.0f;
  _871 = (((_777 + ((_700 * TEXCOORD_1.x) * cb0_086x)) * _384) * ((_819 * (_820 - cb0_089x)) + cb0_089x)) * ((_858 * (_859 - cb0_092x)) + cb0_092x);
  _874 = (((_778 + ((_701 * TEXCOORD_1.x) * cb0_086y)) * _384) * ((_819 * (_820 - cb0_089y)) + cb0_089y)) * ((_858 * (_859 - cb0_092y)) + cb0_092y);
  _877 = (((_779 + ((_702 * TEXCOORD_1.x) * cb0_086z)) * _384) * ((_819 * (_820 - cb0_089z)) + cb0_089z)) * ((_858 * (_859 - cb0_092z)) + cb0_092z);
  CAPTURE_UNTONEMAPPED(float3(_871, _874, _877));
  [branch]
  if (WUWA_TM_IS(1)) {
    _910 = ((((_871 * 1.3600000143051147f) + 0.04699999839067459f) * _871) / ((((_871 * 0.9599999785423279f) + 0.5600000023841858f) * _871) + 0.14000000059604645f));
    _911 = ((((_874 * 1.3600000143051147f) + 0.04699999839067459f) * _874) / ((((_874 * 0.9599999785423279f) + 0.5600000023841858f) * _874) + 0.14000000059604645f));
    _912 = ((((_877 * 1.3600000143051147f) + 0.04699999839067459f) * _877) / ((((_877 * 0.9599999785423279f) + 0.5600000023841858f) * _877) + 0.14000000059604645f));
  } else {
    _910 = _871;
    _911 = _874;
    _912 = _877;
  ...
  [branch]
  if (WUWA_TM_IS(2)) {
    _922 = 1.0049500465393066f - (0.16398000717163086f / (_910 + -0.19505000114440918f));
    _923 = 1.0049500465393066f - (0.16398000717163086f / (_911 + -0.19505000114440918f));
    _924 = 1.0049500465393066f - (0.16398000717163086f / (_912 + -0.19505000114440918f));
    _944 = ((_910 - _922) * select((_910 > 0.6000000238418579f), 0.0f, 1.0f)) + _922;
    _945 = ((_911 - _923) * select((_911 > 0.6000000238418579f), 0.0f, 1.0f)) + _923;
    _946 = ((_912 - _924) * select((_912 > 0.6000000238418579f), 0.0f, 1.0f)) + _924;
  } else {
    _944 = _910;
    _945 = _911;
    _946 = _912;
  ...
  if (WUWA_TM_IS(3)) {
    ...
    _953 = cb0_037y * _945;
    _954 = cb0_037y * _946;
    _957 = cb0_037z * cb0_037w;
    _967 = cb0_038y * cb0_038x;
    _978 = cb0_038z * cb0_038x;
    _985 = cb0_038y / cb0_038z;
    _993 = ((((_957 + _952) * _944) + _967) / (_978 + ((_952 + cb0_037z) * _944))) - _985;
    _994 = ((((_957 + _953) * _945) + _967) / (_978 + ((_953 + cb0_037z) * _945))) - _985;
    _995 = ((((_957 + _954) * _946) + _967) / (_978 + ((_954 + cb0_037z) * _946))) - _985;
  } else {
    _993 = _944;
    _994 = _945;
    _995 = _946;
  ...
  if (!(cb0_105w == 0)) {
    if (!(cb0_106x == 1.0f)) {
      _1005 = (cb0_106x * 0.699999988079071f) + 0.30000001192092896f;
      _1010 = (_1005 * _993);
      _1011 = (_1005 * _994);
      _1012 = (_1005 * _995);
    } else {
  ...
  APPLY_EXTENDED_TONEMAP(_1010, _1011, _1012);
  _1033 = (saturate((log2(_1010 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  _1034 = (saturate((log2(_1011 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  _1035 = (saturate((log2(_1012 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f) * 0.96875f) + 0.015625f;
  _1036 = t7.Sample(s7, float3(_1033, _1034, _1035));
  [branch]
  if (!(cb0_107w == 0)) {
    _1069 = select((((uint)(uint(float((uint)((int)((uint)(uint(round((((float4)(t6.Sample(s6, float2(min(max(((cb0_084x * _426) + cb0_084z), cb0_083x), cb0_083z), min(max(((cb0_084y * _427) + cb0_084w), cb0_083y), cb0_083w))))).w) * 255.0f))) & 15))))) & -4) == 12), 1.0f, 0.0f);
    _1070 = t8.Sample(s8, float3(_1033, _1034, _1035));
    _1084 = (lerp(_1070.x, _1036.x, _1069));
    _1085 = (lerp(_1070.y, _1036.y, _1069));
    _1086 = (lerp(_1070.z, _1036.z, _1069));
  } else {
    _1084 = _1036.x;
    _1085 = _1036.y;
    _1086 = _1036.z;
  }
  _1087 = _1086 * 1.0499999523162842f;
  _1088 = _1085 * 1.0499999523162842f;
  _1089 = _1084 * 1.0499999523162842f;
  _1097 = ((_338 * 0.00390625f) + -0.001953125f) + _1089;
  _1098 = ((_361 * 0.00390625f) + -0.001953125f) + _1088;
  _1099 = ((_362 * 0.00390625f) + -0.001953125f) + _1087;
  [branch]
  if (!(cb0_106w == 0)) {
    _1111 = (pow(_1097, 0.012683313339948654f));
    _1112 = (pow(_1098, 0.012683313339948654f));
    _1113 = (pow(_1099, 0.012683313339948654f));
    _1146 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1111 + -0.8359375f)) / (18.8515625f - (_1111 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    _1147 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1112 + -0.8359375f)) / (18.8515625f - (_1112 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    _1148 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_1113 + -0.8359375f)) / (18.8515625f - (_1113 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / cb0_106z));
    _1174 = min((_1146 * 12.920000076293945f), ((exp2(log2(max(_1146, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1175 = min((_1147 * 12.920000076293945f), ((exp2(log2(max(_1147, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _1176 = min((_1148 * 12.920000076293945f), ((exp2(log2(max(_1148, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _1174 = _1097;
    _1175 = _1098;
    _1176 = _1099;
  ...
  SV_Target.w = (dot(float3(_1089, _1088, _1087), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f)));
