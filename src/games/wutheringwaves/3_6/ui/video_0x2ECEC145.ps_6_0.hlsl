...
float4 main(
  ...
  const float2 _video_uv = float2((dot(float2(TEXCOORD.x, TEXCOORD.y), float2((Material_000[2].x), (Material_000[2].y))) + (Material_000[1].x)), (dot(float2(TEXCOORD.x, TEXCOORD.y), float2((Material_000[2].z), (Material_000[2].w))) + (Material_000[1].y)));
  _85 = t0.Sample(s0, _video_uv);
  uint _video_width;
  uint _video_height;
  t0.GetDimensions(_video_width, _video_height);
  const float2 _video_texel = 1.f / float2(_video_width, _video_height);
  if ((Material_064[0].x) > 0.5f) {
  ...
  _120 = _117 * _71;
  _121 = _118 * _72;
  _144 = select((Primitive_688.x > 0.0f), saturate(Primitive_688.y), 1.0f) * saturate(_85.w * COLOR.w);
  _145 = max(((((Material_000[3].x) - _119) * (Material_064[0].y)) + _119), 0.0f);
  _146 = max(((((Material_000[3].y) - _120) * (Material_064[0].y)) + _120), 0.0f);
  _147 = max(((((Material_000[3].z) - _121) * (Material_064[0].y)) + _121), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_61 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_59 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_60 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      _179 = float((bool)(bool)(frac(dot(float3(_59, _60, _61), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _182 = 1.0f;
      _183 = (1.0f - _179);
      _184 = 1.0f;
      _185 = _179;
  ...
  if (!(TranslucentBasePass_4768 == 0)) {
    ...
    if (TranslucentBasePass_4784 == 0.0f) {
      _218 = (((TranslucentBasePass_4772 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4776 - TranslucentBasePass_4780)) + TranslucentBasePass_4780;
      _226 = (((TranslucentBasePass_4840 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4832 - TranslucentBasePass_4836)) + TranslucentBasePass_4836;
      _227 = (_218 * _183) * _226;
      _228 = (_218 * _184) * _226;
      _229 = (_218 * _185) * _226;
      _234 = max((_227 - TranslucentBasePass_4828), 0.0f);
      _235 = max((_228 - TranslucentBasePass_4828), 0.0f);
      _236 = max((_229 - TranslucentBasePass_4828), 0.0f);
      _249 = TranslucentBasePass_4812 * -1.4426950216293335f;
      _256 = 1.0f - exp2(_249 * ((_227 - _234) + (_234 / (_234 + 1.0f))));
      _257 = 1.0f - exp2(_249 * ((_228 - _235) + (_235 / (_235 + 1.0f))));
      _258 = 1.0f - exp2(_249 * ((_229 - _236) + (_236 / (_236 + 1.0f))));
      _259 = _256 * TranslucentBasePass_4788;
      _260 = _257 * TranslucentBasePass_4788;
      _261 = _258 * TranslucentBasePass_4788;
      _262 = TranslucentBasePass_4796 * TranslucentBasePass_4792;
      _269 = TranslucentBasePass_4804 * TranslucentBasePass_4800;
      _279 = TranslucentBasePass_4808 * TranslucentBasePass_4800;
      _286 = TranslucentBasePass_4804 / TranslucentBasePass_4808;
      _302 = saturate(((saturate(((((_259 + _262) * _256) + _269) / (((_259 + TranslucentBasePass_4792) * _256) + _279)) - _286) + -0.5f) * TranslucentBasePass_4816) + 0.5f);
      _303 = saturate(((saturate(((((_260 + _262) * _257) + _269) / (((_260 + TranslucentBasePass_4792) * _257) + _279)) - _286) + -0.5f) * TranslucentBasePass_4816) + 0.5f);
      _304 = saturate(((saturate(((((_261 + _262) * _258) + _269) / (((_261 + TranslucentBasePass_4792) * _258) + _279)) - _286) + -0.5f) * TranslucentBasePass_4816) + 0.5f);
      _305 = dot(float3(_302, _303, _304), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      _318 = 1.0f / TranslucentBasePass_4820;
      _329 = exp2(log2(saturate(lerp(_305, _302, TranslucentBasePass_4824))) * _318);
      _330 = exp2(log2(saturate(lerp(_305, _303, TranslucentBasePass_4824))) * _318);
      _331 = exp2(log2(saturate(lerp(_305, _304, TranslucentBasePass_4824))) * _318);
    } else {
      _329 = _183;
      _330 = _184;
      _331 = _185;
    ...
    if (TranslucentBasePass_4784 == 1.0f) {
      _353 = ((((TranslucentBasePass_4776 - TranslucentBasePass_4780) * saturate(TranslucentBasePass_4772 * 0.009999999776482582f)) + TranslucentBasePass_4780) * 0.012500000186264515f) * (((TranslucentBasePass_4832 - TranslucentBasePass_4836) * saturate(TranslucentBasePass_4840 * 0.009999999776482582f)) + TranslucentBasePass_4836);
      _358 = (_353 * _329);
      _359 = (_353 * _330);
      _360 = (_353 * _331);
    } else {
    ...
    SV_Target.x = (-0.0f - min((-0.0f - _358), 0.0f));
    SV_Target.y = (-0.0f - min((-0.0f - _359), 0.0f));
    SV_Target.z = (-0.0f - min((-0.0f - _360), 0.0f));
  SV_Target.w = _182;
  return SV_Target;
}