...
cbuffer cb3 : register(b3) {
  float4 Material_000[18] : packoffset(c000.x);
  float4 Material_288[7] : packoffset(c018.x);
};
...
float4 main(
  ...
  float _441;
  float _476;
  _60 = mad(SV_Position.z, (View_704[2].w), mad(SV_Position.y, (View_704[1].w), ((View_704[0].w) * SV_Position.x))) + (View_704[3].w);
  _64 = ((mad(SV_Position.z, (View_704[2].x), mad(SV_Position.y, (View_704[1].x), ((View_704[0].x) * SV_Position.x))) + (View_704[3].x)) / _60) - View_1120.x;
  _65 = ((mad(SV_Position.z, (View_704[2].y), mad(SV_Position.y, (View_704[1].y), ((View_704[0].y) * SV_Position.x))) + (View_704[3].y)) / _60) - View_1120.y;
  _66 = ((mad(SV_Position.z, (View_704[2].z), mad(SV_Position.y, (View_704[1].z), ((View_704[0].z) * SV_Position.x))) + (View_704[3].z)) / _60) - View_1120.z;
  _67 = TEXCOORD_9.x - View_1120.x;
  _68 = TEXCOORD_9.y - View_1120.y;
  _69 = TEXCOORD_9.z - View_1120.z;
  if ((Material_288[0].x) < 0.5f) {
    _78 = (COLOR.x * COLOR.x);
    _79 = (COLOR.y * COLOR.y);
    _80 = (COLOR.z * COLOR.z);
  } else {
  ...
  _116 = t0.SampleBias(s0, float2((((Material_000[4].x) * min(max(frac(((Material_000[5].x) * ((TEXCOORD.x - (Material_000[3].x)) / (Material_000[4].x))) + (Material_000[6].x)), (Material_288[0].y)), (Material_288[2].z))) + (Material_000[3].x)), (((Material_000[4].y) * min(max(frac(((Material_000[5].y) * ((TEXCOORD.y - (Material_000[3].y)) / (Material_000[4].y))) + (Material_000[6].y)), (Material_288[0].y)), (Material_288[2].z))) + (Material_000[3].y))), View_2388, int2(0, 0));
  if ((Material_288[0].x) > 0.5f) {
  ...
  _152 = _149 * _80;
  _168 = _116.w * COLOR.w;
  _184 = mad(_69, (Primitive_096[2].x), mad(_68, (Primitive_096[1].x), ((Primitive_096[0].x) * _67))) + (Primitive_096[3].x);
  _188 = mad(_69, (Primitive_096[2].y), mad(_68, (Primitive_096[1].y), ((Primitive_096[0].y) * _67))) + (Primitive_096[3].y);
  _223 = saturate(((1.0f - saturate(((_188 - (Material_000[13].y)) - (Material_000[12].y)) / (Material_000[14].y))) - saturate((((-0.0f - _188) - (Material_000[13].y)) + (Material_000[12].y)) / (Material_000[14].w))) * ((1.0f - saturate((((-0.0f - _184) - (Material_000[13].x)) + (Material_000[12].x)) / (Material_000[14].x))) - saturate(((_184 - (Material_000[13].x)) - (Material_000[12].x)) / (Material_000[14].z))));
  _227 = (_223 * _223) * (3.0f - (_223 * 2.0f));
  _239 = select(((Material_288[5].y) > 0.5f), (select(((bool)(abs(Material_288[5].x) > 9.999999747378752e-06f) && (bool)((Material_288[5].x) >= 0.0f)), (1.0f - _227), _227) * _168), _168);
  _267 = select((Primitive_688.x > 0.0f), saturate(Primitive_688.y), 1.0f) * saturate(select(((Material_288[6].z) > 0.5f), ((((float4)(t1.SampleBias(s1, float2(((_184 - (Material_000[16].x)) / (Material_000[17].x)), (1.0f - ((_188 - (Material_000[16].y)) / (Material_000[17].y)))), View_2388, int2(0, 0)))).x) * _239), _239));
  _268 = max(((((Material_000[7].x) - _150) * (Material_288[2].w)) + _150), 0.0f);
  _269 = max(((((Material_000[7].y) - _151) * (Material_288[2].w)) + _151), 0.0f);
  _270 = max(((((Material_000[7].z) - _152) * (Material_288[2].w)) + _152), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_66 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_64 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_65 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      _302 = float((bool)(bool)(frac(dot(float3(_64, _65, _66), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _305 = 1.0f;
      _306 = (1.0f - _302);
      _307 = 1.0f;
      _308 = _302;
  ...
  if (!(TranslucentBasePass_4768 == 0)) {
    ...
    if (TranslucentBasePass_4784 == 0.0f) {
      _341 = (((TranslucentBasePass_4772 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4776 - TranslucentBasePass_4780)) + TranslucentBasePass_4780;
      _349 = (((TranslucentBasePass_4840 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4832 - TranslucentBasePass_4836)) + TranslucentBasePass_4836;
      _350 = (_341 * _306) * _349;
      _351 = (_341 * _307) * _349;
      _352 = (_341 * _308) * _349;
      _357 = max((_350 - TranslucentBasePass_4828), 0.0f);
      _358 = max((_351 - TranslucentBasePass_4828), 0.0f);
      _359 = max((_352 - TranslucentBasePass_4828), 0.0f);
      _372 = TranslucentBasePass_4812 * -1.4426950216293335f;
      _379 = 1.0f - exp2(_372 * ((_350 - _357) + (_357 / (_357 + 1.0f))));
      _380 = 1.0f - exp2(_372 * ((_351 - _358) + (_358 / (_358 + 1.0f))));
      _381 = 1.0f - exp2(_372 * ((_352 - _359) + (_359 / (_359 + 1.0f))));
      _382 = _379 * TranslucentBasePass_4788;
      _383 = _380 * TranslucentBasePass_4788;
      _384 = _381 * TranslucentBasePass_4788;
      _385 = TranslucentBasePass_4796 * TranslucentBasePass_4792;
      _392 = TranslucentBasePass_4804 * TranslucentBasePass_4800;
      _402 = TranslucentBasePass_4808 * TranslucentBasePass_4800;
      _409 = TranslucentBasePass_4804 / TranslucentBasePass_4808;
      _425 = saturate(((saturate(((((_382 + _385) * _379) + _392) / (((_382 + TranslucentBasePass_4792) * _379) + _402)) - _409) + -0.5f) * TranslucentBasePass_4816) + 0.5f);
      _426 = saturate(((saturate(((((_383 + _385) * _380) + _392) / (((_383 + TranslucentBasePass_4792) * _380) + _402)) - _409) + -0.5f) * TranslucentBasePass_4816) + 0.5f);
      _427 = saturate(((saturate(((((_384 + _385) * _381) + _392) / (((_384 + TranslucentBasePass_4792) * _381) + _402)) - _409) + -0.5f) * TranslucentBasePass_4816) + 0.5f);
      _428 = dot(float3(_425, _426, _427), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      _441 = 1.0f / TranslucentBasePass_4820;
      _452 = exp2(log2(saturate(lerp(_428, _425, TranslucentBasePass_4824))) * _441);
      _453 = exp2(log2(saturate(lerp(_428, _426, TranslucentBasePass_4824))) * _441);
      _454 = exp2(log2(saturate(lerp(_428, _427, TranslucentBasePass_4824))) * _441);
    } else {
      _452 = _306;
      _453 = _307;
      _454 = _308;
    ...
    if (TranslucentBasePass_4784 == 1.0f) {
      _476 = ((((TranslucentBasePass_4776 - TranslucentBasePass_4780) * saturate(TranslucentBasePass_4772 * 0.009999999776482582f)) + TranslucentBasePass_4780) * 0.012500000186264515f) * (((TranslucentBasePass_4832 - TranslucentBasePass_4836) * saturate(TranslucentBasePass_4840 * 0.009999999776482582f)) + TranslucentBasePass_4836);
      _481 = (_476 * _452);
      _482 = (_476 * _453);
      _483 = (_476 * _454);
    } else {
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _481), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _482), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _483), 0.0f));
  SV_Target.w = _305;
