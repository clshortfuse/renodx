...
float4 main(
  ...
  float _899;
  float _934;
  _77 = mad(SV_Position.z, (View_704[2].w), mad(SV_Position.y, (View_704[1].w), ((View_704[0].w) * SV_Position.x))) + (View_704[3].w);
  _81 = ((mad(SV_Position.z, (View_704[2].x), mad(SV_Position.y, (View_704[1].x), ((View_704[0].x) * SV_Position.x))) + (View_704[3].x)) / _77) - View_1120.x;
  _82 = ((mad(SV_Position.z, (View_704[2].y), mad(SV_Position.y, (View_704[1].y), ((View_704[0].y) * SV_Position.x))) + (View_704[3].y)) / _77) - View_1120.y;
  _83 = ((mad(SV_Position.z, (View_704[2].z), mad(SV_Position.y, (View_704[1].z), ((View_704[0].z) * SV_Position.x))) + (View_704[3].z)) / _77) - View_1120.z;
  _84 = TEXCOORD_9.x - View_1120.x;
  _85 = TEXCOORD_9.y - View_1120.y;
  _86 = TEXCOORD_9.z - View_1120.z;
  _95 = ((Material_000[3].x) * TEXCOORD.x) + (Material_000[4].x);
  _96 = ((Material_000[3].y) * TEXCOORD.y) + (Material_000[4].y);
  _105 = (SV_Position.x - View_2144.x) * View_2160.z;
  _106 = (SV_Position.y - View_2144.y) * View_2160.w;
  _109 = _105 - _95;
  _110 = _106 - _96;
  _113 = ((Material_576[1].z) * _109) + _95;
  _114 = ((Material_576[1].z) * _110) + _96;
  _122 = (Material_576[2].x) * View_2376;
  _126 = (Material_576[2].y) * sin(_122 * 6.2831854820251465f);
  _131 = t0.SampleBias(s0, float2((_126 + (_113 * (Material_576[1].w))), (_126 + (_114 * (Material_576[1].w)))), View_2388, int2(0, 0));
  ...
  _205 = t2.SampleBias(s2, float2((_200 + (((_185 * (Material_576[4].y)) + _181) * (Material_576[4].z))), (_200 + (((_186 * (Material_576[4].y)) + _182) * (Material_576[4].z)))), View_2388, int2(0, 0));
  _219 = sin(_197 * 6.2831854820251465f) * 5.0f;
  _231 = ((((float4)(t3.SampleBias(s3, float2((((((Material_576[4].y) * _185) + _181) * 2.0f) + _219), (((((Material_576[4].y) * _186) + _182) * 2.0f) + _219)), View_2388, int2(0, 0)))).x) * _205.x) * (Material_576[5].y);
  _232 = ((((float4)(t3.SampleBias(s3, float2((((((Material_576[4].y) * _185) + _181) * 2.0f) + _219), (((((Material_576[4].y) * _186) + _182) * 2.0f) + _219)), View_2388, int2(0, 0)))).x) * _205.y) * (Material_576[5].y);
  _233 = ((((float4)(t3.SampleBias(s3, float2((((((Material_576[4].y) * _185) + _181) * 2.0f) + _219), (((((Material_576[4].y) * _186) + _182) * 2.0f) + _219)), View_2388, int2(0, 0)))).x) * _205.z) * (Material_576[5].y);
  _265 = (Material_576[6].x) * View_2376;
  _282 = (frac(((View_2376 * 0.009999999776482582f) * (Material_576[6].y)) + (((float4)(t4.SampleBias(s4, float2((_265 + ((((Material_576[5].z) * _109) + _95) * (Material_576[5].w))), (_265 + ((((Material_576[5].z) * _110) + _96) * (Material_576[5].w)))), View_2388, int2(0, 0)))).x)) * 100.0f) / (Material_576[6].z);
  _286 = frac(abs(_282));
  _289 = select((_282 >= (-0.0f - _282)), _286, (-0.0f - _286)) * (Material_576[6].z);
  _298 = 1.0f - (abs(_289 - (Material_576[7].x)) / (Material_576[7].x));
  _305 = select((_298 <= 2.980232949312267e-08f), 0.0f, exp2(log2(_298) * (Material_576[7].y))) * select(((Material_576[6].w) < _289), 0.0f, 1.0f);
  _318 = abs(_105 - (MaterialCollection0_000[0].x));
  _323 = abs(_106 - (MaterialCollection0_000[0].y));
  _328 = (Material_576[7].z) * (View_2160.x / View_2160.y);
  _337 = (((((Material_576[7].z) - _318) / (Material_576[7].z)) * select(((Material_576[7].z) < _318), 0.0f, 1.0f)) * select((_328 < _323), 0.0f, 1.0f)) * ((_328 - _323) / _328);
  _343 = select((_337 <= 2.980232949312267e-08f), 0.0f, exp2(log2(_337) * (Material_576[7].w)));
  _359 = select(((Material_576[8].x) < _105), 0.0f, 1.0f) * ((Material_576[8].x) - _105);
  _365 = select((_359 <= 2.980232949312267e-08f), 0.0f, exp2(log2(_359) * (Material_576[8].y)));
  _381 = select((_105 < (Material_576[8].z)), 0.0f, 1.0f) * ((_105 + -1.0f) + (Material_576[8].x));
  _386 = select((_381 <= 2.980232949312267e-08f), 0.0f, exp2(log2(_381) * (Material_576[8].y)));
  _387 = -0.0f - (MaterialCollection0_000[0].z);
  _394 = (((Material_000[19].x) * _387) * _386) + (((Material_000[19].x) * (MaterialCollection0_000[0].z)) * _365);
  _395 = (((Material_000[19].y) * _387) * _386) + (((Material_000[19].y) * (MaterialCollection0_000[0].z)) * _365);
  _396 = (((Material_000[19].z) * _387) * _386) + (((Material_000[19].z) * (MaterialCollection0_000[0].z)) * _365);
  _412 = ((((select((_231 <= 2.980232949312267e-08f), 0.0f, (_231 * _231)) * (Material_000[13].x)) + ((Material_000[7].x) * select((((((float4)(t1.SampleBias(s1, float2((((Material_576[2].z) * _113) + _122), (((Material_576[2].z) * _114) + _122)), View_2388, int2(0, 0)))).x) * select((_131.x <= 2.980232949312267e-08f), 0.0f, (exp2(log2(_131.x)) * 2.0f))) < (Material_576[2].w)), 0.0f, 1.0f))) + min(max((((_343 * (Material_000[17].x)) + ((Material_000[15].x) * _305)) + _394), 0.0f), 1.0f)) + _394) + (Material_000[21].x);
  _415 = ((((select((_232 <= 2.980232949312267e-08f), 0.0f, (_232 * _232)) * (Material_000[13].y)) + (select((((((float4)(t1.SampleBias(s1, float2((((Material_576[2].z) * _113) + _122), (((Material_576[2].z) * _114) + _122)), View_2388, int2(0, 0)))).x) * select((_131.y <= 2.980232949312267e-08f), 0.0f, (exp2(log2(_131.y)) * 2.0f))) < (Material_576[2].w)), 0.0f, 1.0f) * (Material_000[7].y))) + _395) + min(max((((_343 * (Material_000[17].y)) + ((Material_000[15].y) * _305)) + _395), 0.0f), 1.0f)) + (Material_000[21].y);
  _418 = ((((select((_233 <= 2.980232949312267e-08f), 0.0f, (_233 * _233)) * (Material_000[13].z)) + (select((((((float4)(t1.SampleBias(s1, float2((((Material_576[2].z) * _113) + _122), (((Material_576[2].z) * _114) + _122)), View_2388, int2(0, 0)))).x) * select((_131.z <= 2.980232949312267e-08f), 0.0f, (exp2(log2(_131.z)) * 2.0f))) < (Material_576[2].w)), 0.0f, 1.0f) * (Material_000[7].z))) + _396) + min(max((((_343 * (Material_000[17].z)) + ((Material_000[15].z) * _305)) + _396), 0.0f), 1.0f)) + (Material_000[21].z);
  ...
  _446 = select((_443 < 0.10000000149011612f), 0.0f, 1.0f) * _443;
  _457 = (View_2376 * 0.10000000149011612f) * (Material_576[9].w);
  _468 = (((((float4)(t8.SampleBias(s8, float2((_457 + ((Material_576[9].z) * TEXCOORD.x)), (_457 + ((Material_576[9].z) * TEXCOORD.y))), View_2388, int2(0, 0)))).x) + 0.10000002384185791f) * 0.5f) * (Material_576[10].x);
  _473 = (Material_576[9].x) * _436.y;
  _476 = select((_473 < 0.10000000149011612f), 0.0f, 1.0f) * _473;
  _484 = (Material_576[9].x) * _436.z;
  _487 = select((_484 < 0.10000000149011612f), 0.0f, 1.0f) * _484;
  _494 = (Material_576[9].x) * _436.w;
  _497 = select((_494 < 0.10000000149011612f), 0.0f, 1.0f) * _494;
  _511 = (Material_576[11].z) - _105;
  _513 = ((Material_576[11].y) - _106) * (View_2160.z / View_2160.w);
  _519 = ((((float4)(t3.SampleBias(s3, float2(_105, _106), View_2388, int2(0, 0)))).x) * -0.20000000298023224f) - sqrt(dot(float2(_511, _513), float2(_511, _513)));
  _531 = t9.SampleBias(s9, float2(_95, _96), View_2388, int2(0, 0));
  _536 = (Material_576[9].x) * _531.x;
  _539 = select((_536 < 0.10000000149011612f), 0.0f, 1.0f) * _536;
  _546 = (Material_576[9].x) * _531.y;
  _549 = select((_546 < 0.10000000149011612f), 0.0f, 1.0f) * _546;
  _556 = (Material_576[9].x) * _531.z;
  _559 = select((_556 < 0.10000000149011612f), 0.0f, 1.0f) * _556;
  _566 = (Material_576[9].x) * _531.w;
  _569 = select((_566 < 0.10000000149011612f), 0.0f, 1.0f) * _566;
  _588 = saturate(saturate(dot(float4(((((select(((Material_576[9].y) < _539), -0.0f, -2.0f) * _539) + _531.x) * _468) + _539), ((((select(((Material_576[9].y) < _549), -0.0f, -2.0f) * _549) + _531.y) * _468) + _549), ((((select(((Material_576[9].y) < _559), -0.0f, -2.0f) * _559) + _531.z) * _468) + _559), ((((select(((Material_576[9].y) < _569), -0.0f, -2.0f) * _569) + _531.w) * _468) + _569)), float4(((Material_000[31].x) + _519), ((Material_000[31].y) + _519), ((Material_000[31].z) + _519), ((Material_000[31].w) + _519)))) + saturate(dot(float4(((_468 * ((select(((Material_576[9].y) < _446), -0.0f, -2.0f) * _446) + _436.x)) + _446), ((((select(((Material_576[9].y) < _476), -0.0f, -2.0f) * _476) + _436.y) * _468) + _476), ((((select(((Material_576[9].y) < _487), -0.0f, -2.0f) * _487) + _436.z) * _468) + _487), ((((select(((Material_576[9].y) < _497), -0.0f, -2.0f) * _497) + _436.w) * _468) + _497)), float4((_519 + (Material_000[26].x)), (_519 + (Material_000[26].y)), (_519 + (Material_000[26].z)), (_519 + (Material_000[26].w))))));
  _598 = (_588 * ((_419.x - _412) + (_429 * (_423.x - _419.x)))) + _412;
  _599 = (_588 * ((_419.y - _415) + (_429 * (_423.y - _419.y)))) + _415;
  _600 = (_588 * ((_419.z - _418) + (_429 * (_423.z - _419.z)))) + _418;
  _617 = t10.SampleBias(s10, float2(((Material_576[13].x) * (((Material_576[12].w) * View_2376) + abs(((_96 + _95) * 2.0f) + -2.0f))), saturate((Material_576[13].y) + _588)), View_2388, int2(0, 0));
  _633 = ((((Material_576[13].z) * _617.x) - _598) * _617.w) + _598;
  _634 = ((((Material_576[13].z) * _617.y) - _599) * _617.w) + _599;
  _635 = ((((Material_576[13].z) * _617.z) - _600) * _617.w) + _600;
  ...
  _725 = select((Primitive_688.x > 0.0f), saturate(Primitive_688.y), 1.0f) * saturate(saturate((Material_576[15].y) * (((float4)(t11.SampleBias(s11, float2((((mad(_86, (Primitive_096[2].x), mad(_85, (Primitive_096[1].x), ((Primitive_096[0].x) * _84))) + (Primitive_096[3].x)) - (Material_000[34].x)) / (Material_000[35].x)), (1.0f - (((mad(_86, (Primitive_096[2].y), mad(_85, (Primitive_096[1].y), ((Primitive_096[0].y) * _84))) + (Primitive_096[3].y)) - (Material_000[34].y)) / (Material_000[35].y)))), View_2388, int2(0, 0)))).x)));
  _726 = max(((((Material_000[32].x) - _661) * (Material_576[14].x)) + _661), 0.0f);
  _727 = max(((((Material_000[32].y) - _662) * (Material_576[14].x)) + _662), 0.0f);
  _728 = max(((((Material_000[32].z) - _663) * (Material_576[14].x)) + _663), 0.0f);
  [branch]
  if (View_2336 > 0.0f) {
    if ((bool)(abs(_83 - Primitive_080.z) > (Primitive_304.z + 1.0f)) || ((bool)((bool)(abs(_81 - Primitive_080.x) > (Primitive_304.x + 1.0f)) || (bool)(abs(_82 - Primitive_080.y) > (Primitive_304.y + 1.0f))))) {
      _760 = float((bool)(bool)(frac(dot(float3(_81, _82, _83), float3(0.5770000219345093f, 0.5770000219345093f, 0.5770000219345093f)) * 0.0020000000949949026f) > 0.5f));
      _763 = 1.0f;
      _764 = (1.0f - _760);
      _765 = 1.0f;
      _766 = _760;
  ...
  if (!(TranslucentBasePass_4768 == 0)) {
    ...
    if (TranslucentBasePass_4784 == 0.0f) {
      _799 = (((TranslucentBasePass_4772 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4776 - TranslucentBasePass_4780)) + TranslucentBasePass_4780;
      _807 = (((TranslucentBasePass_4840 + 1.0f) * 0.009900989942252636f) * (TranslucentBasePass_4832 - TranslucentBasePass_4836)) + TranslucentBasePass_4836;
      _808 = (_799 * _764) * _807;
      _809 = (_799 * _765) * _807;
      _810 = (_799 * _766) * _807;
      _815 = max((_808 - TranslucentBasePass_4828), 0.0f);
      _816 = max((_809 - TranslucentBasePass_4828), 0.0f);
      _817 = max((_810 - TranslucentBasePass_4828), 0.0f);
      _830 = TranslucentBasePass_4812 * -1.4426950216293335f;
      _837 = 1.0f - exp2(_830 * ((_808 - _815) + (_815 / (_815 + 1.0f))));
      _838 = 1.0f - exp2(_830 * ((_809 - _816) + (_816 / (_816 + 1.0f))));
      _839 = 1.0f - exp2(_830 * ((_810 - _817) + (_817 / (_817 + 1.0f))));
      _840 = _837 * TranslucentBasePass_4788;
      _841 = _838 * TranslucentBasePass_4788;
      _842 = _839 * TranslucentBasePass_4788;
      _843 = TranslucentBasePass_4796 * TranslucentBasePass_4792;
      _850 = TranslucentBasePass_4804 * TranslucentBasePass_4800;
      _860 = TranslucentBasePass_4808 * TranslucentBasePass_4800;
      _867 = TranslucentBasePass_4804 / TranslucentBasePass_4808;
      _883 = saturate(((saturate(((((_840 + _843) * _837) + _850) / (((_840 + TranslucentBasePass_4792) * _837) + _860)) - _867) + -0.5f) * TranslucentBasePass_4816) + 0.5f);
      _884 = saturate(((saturate(((((_841 + _843) * _838) + _850) / (((_841 + TranslucentBasePass_4792) * _838) + _860)) - _867) + -0.5f) * TranslucentBasePass_4816) + 0.5f);
      _885 = saturate(((saturate(((((_842 + _843) * _839) + _850) / (((_842 + TranslucentBasePass_4792) * _839) + _860)) - _867) + -0.5f) * TranslucentBasePass_4816) + 0.5f);
      _886 = dot(float3(_883, _884, _885), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      _899 = 1.0f / TranslucentBasePass_4820;
      _910 = exp2(log2(saturate(lerp(_886, _883, TranslucentBasePass_4824))) * _899);
      _911 = exp2(log2(saturate(lerp(_886, _884, TranslucentBasePass_4824))) * _899);
      _912 = exp2(log2(saturate(lerp(_886, _885, TranslucentBasePass_4824))) * _899);
    } else {
      _910 = _764;
      _911 = _765;
      _912 = _766;
    ...
    if (TranslucentBasePass_4784 == 1.0f) {
      _934 = ((((TranslucentBasePass_4776 - TranslucentBasePass_4780) * saturate(TranslucentBasePass_4772 * 0.009999999776482582f)) + TranslucentBasePass_4780) * 0.012500000186264515f) * (((TranslucentBasePass_4832 - TranslucentBasePass_4836) * saturate(TranslucentBasePass_4840 * 0.009999999776482582f)) + TranslucentBasePass_4836);
      _939 = (_934 * _910);
      _940 = (_934 * _911);
      _941 = (_934 * _912);
    } else {
  ...
  SV_Target.x = (-0.0f - min((-0.0f - _939), 0.0f));
  SV_Target.y = (-0.0f - min((-0.0f - _940), 0.0f));
  SV_Target.z = (-0.0f - min((-0.0f - _941), 0.0f));
  SV_Target.w = _763;
