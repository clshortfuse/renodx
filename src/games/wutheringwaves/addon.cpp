...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
      ...
      .tooltip = "Blend amount between pre-display-map color and PsychoV-mapped color.",
        .max = 100.f,
        .is_enabled = []() { return shader_injection.tone_map_type >= 1; },
        .parse = [](float value) { return value * 0.01f; },
        .is_visible = []() { return current_settings_mode >= 2; },
    ...
    new renodx::utils::settings::Setting{
        ...
        .default_value = 100.f,
      .label = "PsychoV Hue Restore",
        .section = "Scene Grading",
      .tooltip = "Maps to PsychoV hue_restore.",
        .min = 0.f,
        .max = 100.f,
        .is_enabled = []() { return shader_injection.tone_map_type >= 1
                      && shader_injection.color_grade_strength > 0
    ...
    new renodx::utils::settings::Setting{
        ...
        .default_value = 100.f,
      .label = "PsychoV Purity Scale",
        .section = "Scene Grading",
      .tooltip = "Scales PsychoV purity/saturation strength.",
        .min = 0.f,
        .max = 100.f,
        .is_enabled = []() { return shader_injection.tone_map_type >= 1
                                    && shader_injection.color_grade_strength > 0; },
    ...
    new renodx::utils::settings::Setting{
        ...
        .default_value = 50.f,
      .label = "PsychoV Highlight Purity Bias",
        .section = "Scene Grading",
      .tooltip = "Biases PsychoV highlight purity around the neutral midpoint.",
        .min = 0.f,
        .max = 100.f,
        .is_enabled = []() { return shader_injection.tone_map_type >= 1
                                    && shader_injection.color_grade_strength > 0
