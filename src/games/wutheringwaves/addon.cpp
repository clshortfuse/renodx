...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
      ...
      new renodx::utils::settings::Setting{
        ...
        .section = "Scene Grading",
        .tooltip = "Change strength of the extended game tonemapping.",
        .tint = tint_scene_grading,
        .min = 0.f,
        .max = 100.f,
        .parse = [](float value) { return value * 0.01f; },
        ...
        .is_visible = []() { return current_settings_mode >= 1; },
          ...
          new renodx::utils::settings::Setting{
        .key = "WuWaLUTLightness",
        .binding = &shader_injection.wuwa_lut_lightness,
        .default_value = 100.f,
        .label = "LUT Lightness",
        .section = "Scene Grading",
        .tooltip = "How much of the game LUT's own lightness/contrast to keep. Has no effect in SDR.",
        .tint = tint_scene_grading,
        .min = 0.f,
        .max = 100.f,
        .parse = [](float value) { return value * 0.01f; },
      ...
      new renodx::utils::settings::Setting{
        ...
        .label = "LUT Strength",
        .section = "Scene Grading",
        .tooltip = "Strength of the game LUT's color tint.",
        .tint = tint_scene_grading,
        .min = 0.f,
        .max = 100.f,
        .parse = [](float value) { return value * 0.01f; },
