...
float4 main(
  ...
  // _5 = _3;
  // _6 = _4;
  int _7 = SV_RenderTargetArrayIndex;
  float _8 = TEXCOORD.x;
  float _9 = TEXCOORD.y;
  float _10[6];
  float _11[6];
  ...
  float4 _1030 = cb0[13u];
  float _1031 = _1030.w;
  float _1032 = _1030.x;
  float _1033 = _1030.y;
  float _1034 = _1030.z;
  float4 _1035 = cb0[14u];
  float _1036 = _1035.x;
  float _1037 = _1035.y;
  float _1038 = _1035.z;
  ...
  if (_1079) {
    ...
    if (_1151) {
      ...
      if (_1213) {
        ...
        float4 _1217 = cb0[12u];
        float _1218 = _1217.z;
        float _1219 = _1217.y;
        float _1220 = _1217.x;
        float4 _1221 = cb0[11u];
        float _1222 = _1221.x;
        float _1223 = _1221.y;
        float _1224 = _1221.z;
        float _1225 = _1221.w;
        float4 _1226 = cb0[10u];
        float _1227 = _1226.x;
        float _1228 = _1226.y;
        float _1229 = _1226.z;
        float _1230 = _1226.w;
        ...
        _13[4] = _1219;
        _13[5] = _1219;
        float4 _1250 = cb1[16u];
        float _1251 = _1250.x;
        float _1252 = _1250.y;
        float _1253 = _1250.z;
        float4 _1254 = cb1[17u];
        float _1255 = _1254.x;
        float _1256 = _1254.y;
        float _1257 = _1254.z;
        float4 _1258 = cb1[18u];
        float _1259 = _1258.x;
        float _1260 = _1258.y;
        float _1261 = _1258.z;
        ...
        if (!_1450) {
          ...
          if (_1459) {
            ...
            float _1483 =
                dot(float3(_1477, _1468, 1.0f), float3(_1480, _1481, _1482));
            _1518 = _1483;
          } else {
                          ...
                          if (_1607) {
                            ...
                            if (!_1633) {
                              ...
                              if (_1637) {
                                ...
                                float _1677 =
                                    mad(0.13400420546531677f, _1673, _1676);
                                float _1678 =
                                    mad(0.15618768334388733f, _1675, _1677);
                                float _1679 = _1671 * 0.2722287178039551f;
                                float _1680 =
                                    mad(0.6740817427635193f, _1673, _1679);
                                float _1681 =
                                    mad(0.053689517080783844f, _1675, _1680);
                                float _1682 = _1671 * -0.005574649665504694f;
                                float _1683 =
                                    mad(0.00406073359772563f, _1673, _1682);
                                float _1684 =
                                    mad(1.0103391408920288f, _1675, _1683);
                                float _1685 = _1678 * 1.6410233974456787f;
                                float _1686 =
                                    mad(-0.32480329275131226f, _1681, _1685);
                                float _1687 =
                                    mad(-0.23642469942569733f, _1684, _1686);
                                float _1688 = _1678 * -0.663662850856781f;
                                float _1689 =
                                    mad(1.6153316497802734f, _1681, _1688);
                                float _1690 =
                                    mad(0.016756348311901093f, _1684, _1689);
                                float _1691 = _1678 * 0.011721894145011902f;
                                float _1692 =
                                    mad(-0.008284442126750946f, _1681, _1691);
                                float _1693 =
                                    mad(0.9883948564529419f, _1684, _1692);
                                ...
                                float _1701 =
                                    mad(0.13400420546531677f, _1698, _1700);
                                float _1702 =
                                    mad(0.15618768334388733f, _1699, _1701);
                                float _1703 = _1697 * 0.2722287178039551f;
                                float _1704 =
                                    mad(0.6740817427635193f, _1698, _1703);
                                float _1705 =
                                    mad(0.053689517080783844f, _1699, _1704);
                                float _1706 = _1697 * -0.005574649665504694f;
                                float _1707 =
                                    mad(0.00406073359772563f, _1698, _1706);
                                float _1708 =
                                    mad(1.0103391408920288f, _1699, _1707);
                                float _1709 = _1702 * 1.6410233974456787f;
                                float _1710 =
                                    mad(-0.32480329275131226f, _1705, _1709);
                                float _1711 =
                                    mad(-0.23642469942569733f, _1708, _1710);
                                float _1712 = _1702 * -0.663662850856781f;
                                float _1713 =
                                    mad(1.6153316497802734f, _1705, _1712);
                                float _1714 =
                                    mad(0.016756348311901093f, _1708, _1713);
                                float _1715 = _1702 * 0.011721894145011902f;
                                float _1716 =
                                    mad(-0.008284442126750946f, _1705, _1715);
                                float _1717 =
                                    mad(0.9883948564529419f, _1708, _1716);
        ...
        if (!_1524) {
          ...
          if (_1533) {
            ...
            float _1556 = mad(_1547, 0.5f, _1552);
            float _1557 =
                dot(float3(_1551, _1542, 1.0f), float3(_1554, _1555, _1556));
            _1592 = _1557;
          } else {
            bool _1559 = (_1523 < _1531);
            if (!_1559) {
        ...
        if (!_1598) {
          ...
          if (_1607) {
            ...
            float _1630 = mad(_1621, 0.5f, _1626);
            float _1631 =
                dot(float3(_1625, _1616, 1.0f), float3(_1628, _1629, _1630));
            _1666 = _1631;
          } else {
            bool _1633 = (_1597 < _1605);
            if (!_1633) {
        ...
        if (_1789) {
          ...
          float4 _1793 = cb0[12u];
          float _1794 = _1793.z;
          float _1795 = _1793.y;
          float _1796 = _1793.x;
          float4 _1797 = cb0[11u];
          float _1798 = _1797.x;
          float _1799 = _1797.y;
          float _1800 = _1797.z;
          float _1801 = _1797.w;
          float4 _1802 = cb0[10u];
          float _1803 = _1802.x;
          float _1804 = _1802.y;
          float _1805 = _1802.z;
          float _1806 = _1802.w;
          ...
          _11[4] = _1795;
          _11[5] = _1795;
          float4 _1826 = cb1[16u];
          float _1827 = _1826.x;
          float _1828 = _1826.y;
          float _1829 = _1826.z;
          float4 _1830 = cb1[17u];
          float _1831 = _1830.x;
          float _1832 = _1830.y;
          float _1833 = _1830.z;
          float4 _1834 = cb1[18u];
          float _1835 = _1834.x;
          float _1836 = _1834.y;
          float _1837 = _1834.z;
          ...
          if (!_2026) {
            ...
            if (_2035) {
              ...
              float _2059 =
                  dot(float3(_2053, _2044, 1.0f), float3(_2056, _2057, _2058));
              _2094 = _2059;
            } else {
                            ...
                            if (_2183) {
                              ...
                              if (!_2209) {
                                ...
                                if (_2213) {
                                  ...
                                  float _2253 =
                                      mad(0.13400420546531677f, _2249, _2252);
                                  float _2254 =
                                      mad(0.15618768334388733f, _2251, _2253);
                                  float _2255 = _2247 * 0.2722287178039551f;
                                  float _2256 =
                                      mad(0.6740817427635193f, _2249, _2255);
                                  float _2257 =
                                      mad(0.053689517080783844f, _2251, _2256);
                                  float _2258 = _2247 * -0.005574649665504694f;
                                  float _2259 =
                                      mad(0.00406073359772563f, _2249, _2258);
                                  float _2260 =
                                      mad(1.0103391408920288f, _2251, _2259);
                                  float _2261 = _2254 * 1.6410233974456787f;
                                  float _2262 =
                                      mad(-0.32480329275131226f, _2257, _2261);
                                  float _2263 =
                                      mad(-0.23642469942569733f, _2260, _2262);
                                  float _2264 = _2254 * -0.663662850856781f;
                                  float _2265 =
                                      mad(1.6153316497802734f, _2257, _2264);
                                  float _2266 =
                                      mad(0.016756348311901093f, _2260, _2265);
                                  float _2267 = _2254 * 0.011721894145011902f;
                                  float _2268 =
                                      mad(-0.008284442126750946f, _2257, _2267);
                                  float _2269 =
                                      mad(0.9883948564529419f, _2260, _2268);
                                  ...
                                  float _2277 =
                                      mad(0.13400420546531677f, _2274, _2276);
                                  float _2278 =
                                      mad(0.15618768334388733f, _2275, _2277);
                                  float _2279 = _2273 * 0.2722287178039551f;
                                  float _2280 =
                                      mad(0.6740817427635193f, _2274, _2279);
                                  float _2281 =
                                      mad(0.053689517080783844f, _2275, _2280);
                                  float _2282 = _2273 * -0.005574649665504694f;
                                  float _2283 =
                                      mad(0.00406073359772563f, _2274, _2282);
                                  float _2284 =
                                      mad(1.0103391408920288f, _2275, _2283);
                                  float _2285 = _2278 * 1.6410233974456787f;
                                  float _2286 =
                                      mad(-0.32480329275131226f, _2281, _2285);
                                  float _2287 =
                                      mad(-0.23642469942569733f, _2284, _2286);
                                  float _2288 = _2278 * -0.663662850856781f;
                                  float _2289 =
                                      mad(1.6153316497802734f, _2281, _2288);
                                  float _2290 =
                                      mad(0.016756348311901093f, _2284, _2289);
                                  float _2291 = _2278 * 0.011721894145011902f;
                                  float _2292 =
                                      mad(-0.008284442126750946f, _2281, _2291);
                                  float _2293 =
                                      mad(0.9883948564529419f, _2284, _2292);
                    ...
                    if (_2183) {
                      ...
                      if (!_2209) {
                        ...
                        if (_2213) {
                          ...
                          float _2235 = _2227 - _2224;
                          float _2236 = mad(_2227, 0.5f, _2232);
                          float _2237 = dot(float3(_2231, _2222, 1.0f),
                                            float3(_2234, _2235, _2236));
                          _2242 = _2237;
                          float _2243 = _2242 * 3.321928024291992f;
                          float _2244 = exp2(_2243);
          ...
          if (!_2100) {
            ...
            if (_2109) {
              ...
              float _2132 = mad(_2123, 0.5f, _2128);
              float _2133 =
                  dot(float3(_2127, _2118, 1.0f), float3(_2130, _2131, _2132));
              _2168 = _2133;
            } else {
              bool _2135 = (_2099 < _2107);
              if (!_2135) {
          ...
          if (!_2174) {
            ...
            if (_2183) {
              ...
              float _2206 = mad(_2197, 0.5f, _2202);
              float _2207 =
                  dot(float3(_2201, _2192, 1.0f), float3(_2204, _2205, _2206));
              _2242 = _2207;
            } else {
              bool _2209 = (_2173 < _2181);
              if (!_2209) {
  ...
  SV_Target.rgb = renodx::color::pq::from::BT2020(output_color, 100.f);
  return SV_Target;
}
