...
void comp_main() {
  ...
  float3 lut_input_preoffset = float3(
      (((((((_28_m0[5u].x - 0.5f) * _83) + 0.5f) * 2.0f) * _174) * ((_209 * (_202.x - _153)) + _153)) * (((_28_m0[2u].x - 1.0f) * _221) + 1.0f)) + (_28_m0[4u].x * _84),
      (((((((_28_m0[5u].y - 0.5f) * _83) + 0.5f) * 2.0f) * _174) * ((_209 * (_202.y - _154)) + _154)) * (((_28_m0[2u].y - 1.0f) * _221) + 1.0f)) + (_28_m0[4u].y * _84),
      (((((((_28_m0[5u].z - 0.5f) * _83) + 0.5f) * 2.0f) * _174) * ((_209 * (_202.z - _155)) + _155)) * (((_28_m0[2u].z - 1.0f) * _221) + 1.0f)) + (_28_m0[4u].z * _84));
