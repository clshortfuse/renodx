...
#else
  float4 _350 = _14.SampleLevel(_38, float3((clamp((((((((_35_m0[5u].x + (-0.5f)) * _135) + 0.5f) * 2.0f) * _260) * ((_291 * (_284.x - _239)) + _239)) * (((_35_m0[2u].x + (-1.0f)) * _303) + 1.0f)) + (_35_m0[4u].x * _143), 0.0f, 1.0f) * 0.9375f) + 0.03125f, (clamp((((((((_35_m0[5u].y + (-0.5f)) * _135) + 0.5f) * 2.0f) * _260) * ((_291 * (_284.y - _240)) + _240)) * (((_35_m0[2u].y + (-1.0f)) * _303) + 1.0f)) + (_35_m0[4u].y * _143), 0.0f, 1.0f) * 0.9375f) + 0.03125f, (clamp((((((((_35_m0[5u].z + (-0.5f)) * _135) + 0.5f) * 2.0f) * _260) * ((_291 * (_284.z - _241)) + _241)) * (((_35_m0[2u].z + (-1.0f)) * _303) + 1.0f)) + (_35_m0[4u].z * _143), 0.0f, 1.0f) * 0.9375f) + 0.03125f), 0.0f);
  float _365 = (frac(sin(dot(float2(_89, _90), float2(12.98980045318603515625f, 78.233001708984375f))) * 43758.546875f) * 0.0039215688593685626983642578125f) + (-0.00196078442968428134918212890625f);
  _24[uint3(_77, _78, _68)] = float4((_365 + _350.x) * _35_m0[11u].x, (_365 + _350.y) * _35_m0[11u].x, (_365 + _350.z) * _35_m0[11u].x, 0.0f);
#endif
}
