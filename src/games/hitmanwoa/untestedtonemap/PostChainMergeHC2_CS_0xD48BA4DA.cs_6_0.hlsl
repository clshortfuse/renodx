...
void comp_main() {
  ...
  tonemapped = float3(
      (_33_m0[4u].x * _137) + (((((_33_m0[5u].x - 0.5f) * _129 + 0.5f) * 2.0f) * (tonemapped.r * _33_m0[10u].y)) * _254),
      (_33_m0[4u].y * _137) + (((((_33_m0[5u].y - 0.5f) * _129 + 0.5f) * 2.0f) * (tonemapped.g * _33_m0[10u].y)) * _254),
      (_33_m0[4u].z * _137) + (((((_33_m0[5u].z - 0.5f) * _129 + 0.5f) * 2.0f) * (tonemapped.b * _33_m0[10u].y)) * _254));

  // float4 _286 = _14.SampleLevel(_36, saturate(tonemapped) * 0.9375f + 0.03125f, 0.0f);
  ...
  float4 _286 = _14.SampleLevel(_36, float3((clamp((_33_m0[4u].x * _137) + ((((((_33_m0[5u].x + (-0.5f)) * _129) + 0.5f) * 2.0f) * clamp((((((_198 + 0.100000001490116119384765625f) * _195) + 0.0040000001899898052215576171875f) / (((_198 + 1.0f) * _195) + 0.060000002384185791015625f)) + (-0.066666662693023681640625f)) * _33_m0[10u].y, 0.0f, 1.0f)) * _254), 0.0f, 1.0f) * 0.9375f) + 0.03125f, (clamp((_33_m0[4u].y * _137) + ((((((_33_m0[5u].y + (-0.5f)) * _129) + 0.5f) * 2.0f) * clamp((((((_212 + 0.100000001490116119384765625f) * _196) + 0.0040000001899898052215576171875f) / (((_212 + 1.0f) * _196) + 0.060000002384185791015625f)) + (-0.066666662693023681640625f)) * _33_m0[10u].y, 0.0f, 1.0f)) * _254), 0.0f, 1.0f) * 0.9375f) + 0.03125f, (clamp((_33_m0[4u].z * _137) + ((((((_33_m0[5u].z + (-0.5f)) * _129) + 0.5f) * 2.0f) * clamp((((((_221 + 0.100000001490116119384765625f) * _197) + 0.0040000001899898052215576171875f) / (((_221 + 1.0f) * _197) + 0.060000002384185791015625f)) + (-0.066666662693023681640625f)) * _33_m0[10u].y, 0.0f, 1.0f)) * _254), 0.0f, 1.0f) * 0.9375f) + 0.03125f), 0.0f);
  float _301 = (frac(sin(dot(float2(_83, _84), float2(12.98980045318603515625f, 78.233001708984375f))) * 43758.546875f) * 0.0039215688593685626983642578125f) + (-0.00196078442968428134918212890625f);
  _22[uint3(_71, _72, _62)] = float4((_301 + _286.x) * _33_m0[11u].x, (_301 + _286.y) * _33_m0[11u].x, (_301 + _286.z) * _33_m0[11u].x, 0.0f);
#endif
}
