...
void comp_main() {
  ...
  float3 tonemapped = float3(
      ((_259 * (_252.x - _207)) + _207) * (((_35_m0[2u].x - 1.0f) * _271) + 1.0f),
      ((_259 * (_252.y - _208)) + _208) * (((_35_m0[2u].y - 1.0f) * _271) + 1.0f),
      ((_259 * (_252.z - _209)) + _209) * (((_35_m0[2u].z - 1.0f) * _271) + 1.0f));

  tonemapped = float3(
      ((((_35_m0[5u].x - 0.5f) * _135 + 0.5f) * 2.0f) * _228 * tonemapped.r) + (_35_m0[4u].x * _143),
      ((((_35_m0[5u].y - 0.5f) * _135 + 0.5f) * 2.0f) * _228 * tonemapped.g) + (_35_m0[4u].y * _143),
      ((((_35_m0[5u].z - 0.5f) * _135 + 0.5f) * 2.0f) * _228 * tonemapped.b) + (_35_m0[4u].z * _143));

  float3 final_color = ToneMapMaxCLLAndSampleLinearLUT16AndFinalizeOutput(tonemapped, _14, _38, _35_m0[8u].y, _89, _90, _35_m0[11u].x);

  _24[uint3(_77, _78, _68)] = float4(final_color, 0.0f);
#else
  float4 _318 = _14.SampleLevel(_38, float3((clamp((((((((_35_m0[5u].x + (-0.5f)) * _135) + 0.5f) * 2.0f) * _228) * ((_259 * (_252.x - _207)) + _207)) * (((_35_m0[2u].x + (-1.0f)) * _271) + 1.0f)) + (_35_m0[4u].x * _143), 0.0f, 1.0f) * 0.9375f) + 0.03125f, (clamp((((((((_35_m0[5u].y + (-0.5f)) * _135) + 0.5f) * 2.0f) * _228) * ((_259 * (_252.y - _208)) + _208)) * (((_35_m0[2u].y + (-1.0f)) * _271) + 1.0f)) + (_35_m0[4u].y * _143), 0.0f, 1.0f) * 0.9375f) + 0.03125f, (clamp((((((((_35_m0[5u].z + (-0.5f)) * _135) + 0.5f) * 2.0f) * _228) * ((_259 * (_252.z - _209)) + _209)) * (((_35_m0[2u].z + (-1.0f)) * _271) + 1.0f)) + (_35_m0[4u].z * _143), 0.0f, 1.0f) * 0.9375f) + 0.03125f), 0.0f);
  float _333 = (frac(sin(dot(float2(_89, _90), float2(12.98980045318603515625f, 78.233001708984375f))) * 43758.546875f) * 0.0039215688593685626983642578125f) + (-0.00196078442968428134918212890625f);
  _24[uint3(_77, _78, _68)] = float4((_333 + _318.x) * _35_m0[11u].x, (_333 + _318.y) * _35_m0[11u].x, (_333 + _318.z) * _35_m0[11u].x, 0.0f);
#endif
}
