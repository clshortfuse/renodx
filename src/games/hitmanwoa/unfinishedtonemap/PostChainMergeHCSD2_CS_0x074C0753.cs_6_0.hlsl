...
void comp_main()
{
    ...
    float4 _303 = _12.SampleLevel(_31, float3((clamp((((((((_28_m0[5u].x + (-0.5f)) * _83) + 0.5f) * 2.0f) * _206) * ((_241 * (_234.x - _185)) + _185)) * (((_28_m0[2u].x + (-1.0f)) * _253) + 1.0f)) + (_28_m0[4u].x * _84), 0.0f, 1.0f) * 0.9375f) + 0.03125f, (clamp((((((((_28_m0[5u].y + (-0.5f)) * _83) + 0.5f) * 2.0f) * _206) * ((_241 * (_234.y - _186)) + _186)) * (((_28_m0[2u].y + (-1.0f)) * _253) + 1.0f)) + (_28_m0[4u].y * _84), 0.0f, 1.0f) * 0.9375f) + 0.03125f, (clamp((((((((_28_m0[5u].z + (-0.5f)) * _83) + 0.5f) * 2.0f) * _206) * ((_241 * (_234.z - _187)) + _187)) * (((_28_m0[2u].z + (-1.0f)) * _253) + 1.0f)) + (_28_m0[4u].z * _84), 0.0f, 1.0f) * 0.9375f) + 0.03125f), 0.0f);
    float _319 = (frac(sin(dot(float2(_63, _64), float2(12.98980045318603515625f, 78.233001708984375f))) * 43758.546875f) * 0.0039215688593685626983642578125f) + (-0.00196078442968428134918212890625f);
    _22[uint2(gl_GlobalInvocationID.x, gl_GlobalInvocationID.y)] = float4((_319 + _303.x) * _28_m0[11u].x, (_319 + _303.y) * _28_m0[11u].x, (_319 + _303.z) * _28_m0[11u].x, 0.0f);
