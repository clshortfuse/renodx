...
void comp_main()
{
    ...
    float _153 = clamp(((((_28_m0[9u].x * _116.x) + _110.x) * _28_m0[7u].x) * _28_m0[10u].y) * _144, 0.0f, 1.0f);
    float _154 = clamp(((((_28_m0[9u].x * _116.y) + _110.y) * _28_m0[7u].y) * _28_m0[10u].y) * _144, 0.0f, 1.0f);
    float _155 = clamp(((((_28_m0[9u].x * _116.z) + _110.z) * _28_m0[7u].z) * _28_m0[10u].y) * _144, 0.0f, 1.0f);
    ...
    float4 _274 = _12.SampleLevel(_31, float3((sqrt(clamp((((((((_28_m0[5u].x + (-0.5f)) * _83) + 0.5f) * 2.0f) * _174) * ((_209 * (_202.x - _153)) + _153)) * (((_28_m0[2u].x + (-1.0f)) * _221) + 1.0f)) + (_28_m0[4u].x * _84), 0.0f, 1.0f)) * 0.9375f) + 0.03125f, (sqrt(clamp((((((((_28_m0[5u].y + (-0.5f)) * _83) + 0.5f) * 2.0f) * _174) * ((_209 * (_202.y - _154)) + _154)) * (((_28_m0[2u].y + (-1.0f)) * _221) + 1.0f)) + (_28_m0[4u].y * _84), 0.0f, 1.0f)) * 0.9375f) + 0.03125f, (sqrt(clamp((((((((_28_m0[5u].z + (-0.5f)) * _83) + 0.5f) * 2.0f) * _174) * ((_209 * (_202.z - _155)) + _155)) * (((_28_m0[2u].z + (-1.0f)) * _221) + 1.0f)) + (_28_m0[4u].z * _84), 0.0f, 1.0f)) * 0.9375f) + 0.03125f), 0.0f);
    float _290 = (frac(sin(dot(float2(_63, _64), float2(12.98980045318603515625f, 78.233001708984375f))) * 43758.546875f) * 0.0039215688593685626983642578125f) + (-0.00196078442968428134918212890625f);
    _22[uint2(gl_GlobalInvocationID.x, gl_GlobalInvocationID.y)] = float4((_290 + _274.x) * _28_m0[11u].x, (_290 + _274.y) * _28_m0[11u].x, (_290 + _274.z) * _28_m0[11u].x, 0.0f);
    _22[uint2(gl_GlobalInvocationID.x, gl_GlobalInvocationID.y)] = float4(2.5, 2.5, 0.f, 0.f);
}
