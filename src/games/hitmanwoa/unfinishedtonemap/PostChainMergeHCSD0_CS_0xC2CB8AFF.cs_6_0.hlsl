...
void comp_main() {
  ...
  float _207 = clamp(((((_35_m0[9u].x * _170.x) + _162.x) * _35_m0[7u].x) * _35_m0[10u].y) * _200, 0.0f, 1.0f);
  float _208 = clamp(((((_35_m0[9u].x * _170.y) + _162.y) * _35_m0[7u].y) * _35_m0[10u].y) * _200, 0.0f, 1.0f);
  float _209 = clamp(((((_35_m0[9u].x * _170.z) + _162.z) * _35_m0[7u].z) * _35_m0[10u].y) * _200, 0.0f, 1.0f);
