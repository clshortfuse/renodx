...
void comp_main() {
  ...
  float4 _239 = _12.SampleLevel(_29, float3((sqrt(clamp((_26_m0[4u].x * _78) + ((((((_26_m0[5u].x + (-0.5f)) * _77) + 0.5f) * 2.0f) * clamp((((((_142 + 0.100000001490116119384765625f) * _139) + 0.0040000001899898052215576171875f) / (((_142 + 1.0f) * _139) + 0.060000002384185791015625f)) + (-0.066666662693023681640625f)) * _26_m0[10u].y, 0.0f, 1.0f)) * _200), 0.0f, 1.0f)) * 0.9375f) + 0.03125f, (sqrt(clamp((_26_m0[4u].y * _78) + ((((((_26_m0[5u].y + (-0.5f)) * _77) + 0.5f) * 2.0f) * clamp((((((_157 + 0.100000001490116119384765625f) * _140) + 0.0040000001899898052215576171875f) / (((_157 + 1.0f) * _140) + 0.060000002384185791015625f)) + (-0.066666662693023681640625f)) * _26_m0[10u].y, 0.0f, 1.0f)) * _200), 0.0f, 1.0f)) * 0.9375f) + 0.03125f, (sqrt(clamp((_26_m0[4u].z * _78) + ((((((_26_m0[5u].z + (-0.5f)) * _77) + 0.5f) * 2.0f) * clamp((((((_166 + 0.100000001490116119384765625f) * _141) + 0.0040000001899898052215576171875f) / (((_166 + 1.0f) * _141) + 0.060000002384185791015625f)) + (-0.066666662693023681640625f)) * _26_m0[10u].y, 0.0f, 1.0f)) * _200), 0.0f, 1.0f)) * 0.9375f) + 0.03125f), 0.0f);
