...
float4 main(
  ...
  //_59.rgb = renodx::draw::InvertIntermediatePass(_59.rgb);
  ...
  if ((bool)(_11.w > 0.0f) && (bool)(_11.w < 1.0f)) {
    ...
    float _114 = ((((1.0f / ((dot(float3(_104, _105, _106), float3(0.26269999146461487f, 0.6779999732971191f, 0.059300001710653305f)) / cb0_007z) + 1.0f)) * cb0_007z) + -1.0f) * _11.w) + 1.0f;
    _119 = (_114 * _104);
    _120 = (_114 * _105);
    _121 = (_114 * _106);
  } else {
  ...
  float _141 = exp2(log2(((_119 * _122) + ((cb0_007w * mad(0.04330150783061981f, _42, mad(0.32926714420318604f, _41, (_40 * 0.6274880170822144f)))) * cb0_007z)) * 9.999999747378752e-05f) * 0.1593017578125f);
  float _142 = exp2(log2(((_120 * _122) + ((cb0_007w * mad(0.011359544470906258f, _42, mad(0.9195171594619751f, _41, (_40 * 0.06910824030637741f)))) * cb0_007z)) * 9.999999747378752e-05f) * 0.1593017578125f);
  float _143 = exp2(log2(((_121 * _122) + ((cb0_007w * mad(0.8954997062683105f, _42, mad(0.08802297711372375f, _41, (_40 * 0.016396233811974525f)))) * cb0_007z)) * 9.999999747378752e-05f) * 0.1593017578125f);
