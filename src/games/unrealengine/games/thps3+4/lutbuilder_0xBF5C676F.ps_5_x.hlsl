...
// ---- Created with 3Dmigoto v1.4.1 on Wed Jul 16 23:51:19 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = 1.00055635 * cb0[46].z;
  r0.w = 1 / r0.w;
  r1.x = cmp(6996.10791 >= cb0[46].z);
  ...
  r2.xyz = cb0[46].zzz * float3(0.000154118257,0.00084242021,4.22806261e-05) + float3(0.860117733,1,0.317398727);
  r0.w = cb0[46].z * cb0[46].z;
  r2.xyz = r0.www * float3(1.28641219e-07,7.08145137e-07,4.20481676e-08) + r2.xyz;
  r2.x = r2.x / r2.y;
  r1.z = -cb0[46].z * 2.8974182e-05 + 1;
  ...
  r1.xyzw = (asuint(cb0[46].x) != 0u) ? r1.xyzw : r1.zwxy;
  ...
  r0.xyz = (asuint(cb0[46].y) != 0u) ? r0.xyz : r1.xyz;
  r0.w = dot(r0.xyz, float3(0.272228718,0.674081743,0.0536895171));
  ...
  if (asuint(cb0[67].z) == 0) {
    ...
    if (RENODX_TONE_MAP_TYPE != 0.f) {
      o0 = GenerateOutput(renodx::color::srgb::DecodeSafe(r1.xyz), asuint(cb0[67].z));
      return;
    }
    ...
    if (r0.w != 0) {
      ...
      if (r0.w != 0) {
        ...
        r8.xyz = float3(0.00492610829,0.00492610829,0.00492610829) * r7.xyz;
        r0.w = cmp(cb0[28].z >= 1);
        r9.xyz = log2(abs(r8.xyz));
        r9.xyz = cb0[28].zzz * r9.xyz;
        r9.xyz = exp2(r9.xyz);
        r7.xyz = -r7.xyz * float3(0.00492610829,0.00492610829,0.00492610829) + float3(2,2,2);
        ...
        r7.xyz = exp2(r7.xyz);
        r8.xyz = float3(2.30044842,8.99999941e-05,9.99999975e-05) * cb0[28].zyy;
        r1.w = exp2(r8.x);
        r0.w = r0.w ? r1.w : 4.92610836;
