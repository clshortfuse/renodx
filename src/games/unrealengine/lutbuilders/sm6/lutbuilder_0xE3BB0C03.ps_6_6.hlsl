...
float4 main(
  ...
  float _77 = mad((UniformBufferConstants_WorkingColorSpace_008z), _62, (mad((UniformBufferConstants_WorkingColorSpace_008y), _61, ((UniformBufferConstants_WorkingColorSpace_008x)*_60))));
  float _80 = mad((UniformBufferConstants_WorkingColorSpace_009z), _62, (mad((UniformBufferConstants_WorkingColorSpace_009y), _61, ((UniformBufferConstants_WorkingColorSpace_009x)*_60))));
  float _83 = mad((UniformBufferConstants_WorkingColorSpace_010z), _62, (mad((UniformBufferConstants_WorkingColorSpace_010y), _61, ((UniformBufferConstants_WorkingColorSpace_010x)*_60))));
  ...
  float3 untonemapped_ap1 = float3(_485, _487, _489);
  ...
  float _744 = (((bool)((_684 < _675))) ? ((_693 / ((exp2(((_696 * 1.4426950216293335f) * _695))) + 1.0f)) - (cb0_038x)) : _690);
  float _745 = (((bool)((_685 < _675))) ? ((_693 / ((exp2(((_697 * 1.4426950216293335f) * _695))) + 1.0f)) - (cb0_038x)) : _691);
  float _746 = (((bool)((_686 < _675))) ? ((_693 / ((exp2(((_698 * 1.4426950216293335f) * _695))) + 1.0f)) - (cb0_038x)) : _692);
  ...
  float _808 = ((cb0_037x) * ((max(0.0f, (((_785 - _788) * 0.9300000071525574f) + _788))) - _504)) + _504;
  float _809 = ((cb0_037x) * ((max(0.0f, (((_786 - _788) * 0.9300000071525574f) + _788))) - _505)) + _505;
  float _810 = ((cb0_037x) * ((max(0.0f, (((_787 - _788) * 0.9300000071525574f) + _788))) - _506)) + _506;
  ...
  float _850 = max(0.0f, (mad((UniformBufferConstants_WorkingColorSpace_012z), _828, (mad((UniformBufferConstants_WorkingColorSpace_012y), _827, ((UniformBufferConstants_WorkingColorSpace_012x)*_826))))));
  float _851 = max(0.0f, (mad((UniformBufferConstants_WorkingColorSpace_013z), _828, (mad((UniformBufferConstants_WorkingColorSpace_013y), _827, ((UniformBufferConstants_WorkingColorSpace_013x)*_826))))));
  float _852 = max(0.0f, (mad((UniformBufferConstants_WorkingColorSpace_014z), _828, (mad((UniformBufferConstants_WorkingColorSpace_014y), _827, ((UniformBufferConstants_WorkingColorSpace_014x)*_826))))));
  ...
  float _901 = exp2(((log2((max(0.0f, ((((cb0_013x)-_878) * (cb0_013w)) + _878))))) * (cb0_040y)));
  float _902 = exp2(((log2((max(0.0f, ((((cb0_013y)-_879) * (cb0_013w)) + _879))))) * (cb0_040y)));
  float _903 = exp2(((log2((max(0.0f, ((((cb0_013z)-_880) * (cb0_013w)) + _880))))) * (cb0_040y)));

  if (RENODX_TONE_MAP_TYPE != 0) {
    return LutBuilderToneMap(untonemapped_ap1, float3(_901, _902, _903));
  }
  ...
  if (((((uint)(UniformBufferConstants_WorkingColorSpace_020x)) == 0))) {
    float _910 = mad((UniformBufferConstants_WorkingColorSpace_008z), _903, (mad((UniformBufferConstants_WorkingColorSpace_008y), _902, ((UniformBufferConstants_WorkingColorSpace_008x)*_901))));
    float _913 = mad((UniformBufferConstants_WorkingColorSpace_009z), _903, (mad((UniformBufferConstants_WorkingColorSpace_009y), _902, ((UniformBufferConstants_WorkingColorSpace_009x)*_901))));
    float _916 = mad((UniformBufferConstants_WorkingColorSpace_010z), _903, (mad((UniformBufferConstants_WorkingColorSpace_010y), _902, ((UniformBufferConstants_WorkingColorSpace_010x)*_901))));
