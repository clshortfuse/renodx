...
float4 main(
  ...
  bool _91 = ((uint)(bIsTemperatureWhiteBalance) != 0);
  ...
  float _357 = (1.0f - exp2(((_339 * _339) * -4.0f) * ExpandGamut)) * (1.0f - exp2(dot(float3(_343, _344, _345), float3(_343, _344, _345)) * -4.0f));
  ...
  SetUntonemappedAP1(float3(_740, _742, _744));
  ...
  float _1108 = saturate(max(0.0f, mad((WorkingColorSpace_FromAP1[0].z), _1083, mad((WorkingColorSpace_FromAP1[0].y), _1082, ((WorkingColorSpace_FromAP1[0].x) * _1081)))));
  float _1109 = saturate(max(0.0f, mad((WorkingColorSpace_FromAP1[1].z), _1083, mad((WorkingColorSpace_FromAP1[1].y), _1082, ((WorkingColorSpace_FromAP1[1].x) * _1081)))));
  float _1110 = saturate(max(0.0f, mad((WorkingColorSpace_FromAP1[2].z), _1083, mad((WorkingColorSpace_FromAP1[2].y), _1082, ((WorkingColorSpace_FromAP1[2].x) * _1081)))));
  ...
  if ((uint)(WorkingColorSpace_bIsSRGB) == 0) {
    float _1283 = mad((WorkingColorSpace_ToAP1[0].z), _1264, mad((WorkingColorSpace_ToAP1[0].y), _1263, ((WorkingColorSpace_ToAP1[0].x) * _1262)));
    float _1286 = mad((WorkingColorSpace_ToAP1[1].z), _1264, mad((WorkingColorSpace_ToAP1[1].y), _1263, ((WorkingColorSpace_ToAP1[1].x) * _1262)));
    float _1289 = mad((WorkingColorSpace_ToAP1[2].z), _1264, mad((WorkingColorSpace_ToAP1[2].y), _1263, ((WorkingColorSpace_ToAP1[2].x) * _1262)));
