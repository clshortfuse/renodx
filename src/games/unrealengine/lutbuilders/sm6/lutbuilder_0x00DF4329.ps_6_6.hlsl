...
float4 main(
  ...
  SetUngradedAP1(float3(_134, _137, _140));
  ...
  SetUntonemappedAP1(float3(_542, _544, _546));
  ...
  SetTonemappedAP1(_904, _905, _906);
  ...
  if (RENODX_TONE_MAP_TYPE != 0) {
    return GenerateOutput(float3(_979, _980, _981), OutputDevice);
  }
