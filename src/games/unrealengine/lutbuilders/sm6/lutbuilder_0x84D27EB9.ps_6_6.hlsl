...
float4 main(
        ...
        do {
          ...
          do {
            ...
            do {
              ...
              float _1208 = cb0_016x * (((cb0_043y + (cb0_043x * _1180)) * _1180) + cb0_043z);
              float _1209 = cb0_016y * (((cb0_043y + (cb0_043x * _1181)) * _1181) + cb0_043z);
              float _1210 = cb0_016z * (((cb0_043y + (cb0_043x * _1182)) * _1182) + cb0_043z);
              ...
              float _1243 = exp2(log2(max(0.0f, _1217)) * cb0_044y);
              float _1244 = exp2(log2(max(0.0f, _1218)) * cb0_044y);
              float _1245 = exp2(log2(max(0.0f, _1219)) * cb0_044y);
              if (RENODX_TONE_MAP_TYPE != 0.f) {
                return GenerateOutput(float3(_1243, _1244, _1245), cb0_044w);
              }
              do {
                [branch]
                if (cb0_044w == 0) {
                        ...
                        if (cb0_044w == 7) {
                          ...
                          if (!(cb0_044w == 8)) {
                            if (cb0_044w == 9) {
                              ...
                              _2860 = exp2(log2(mad(_53, _2839, mad(_52, _2836, (_2833 * _51)))) * cb0_044z);
                              _2861 = exp2(log2(mad(_56, _2839, mad(_55, _2836, (_2833 * _54)))) * cb0_044z);
                              _2862 = exp2(log2(mad(_59, _2839, mad(_58, _2836, (_2833 * _57)))) * cb0_044z);
                            }
                          } else {
                            _2860 = _1229;
                            _2861 = _1230;
  ...
  float _1244 = exp2(log2(max(0.0f, _1218)) * cb0_044y);
  float _1245 = exp2(log2(max(0.0f, _1219)) * cb0_044y);
  if (RENODX_TONE_MAP_TYPE != 0.f) return GenerateOutput(float3(_1243, _1244, _1245), cb0_044w);
  [branch]
  if (cb0_044w == 0) {
    do {
      if (WorkingColorSpace_384 == 0) {
