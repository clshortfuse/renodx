...
void main(
  ...
  if (asuint(cb0[65].z) == 0) {
    ...
    if (r0.w != 0) {
      ...
      r7.xyzw = cmp(asint(cb0[65].zzzz) == int4(3, 5, 10, 11));
  ...
  r1.xyz = cb0[69].xyz * r0.yyy;
  r0.xyw = r0.xxx * cb0[68].xyz + r1.xyz;
  r0.xyz = r0.zzz * cb0[70].xyz + r0.xyw;
  r0.xyz = cb0[71].xyz + r0.xyz;
  r0.xyz = max(float3(0, 0, 0), r0.xyz);
  r1.xyz = cb0[67].xxx * r0.xyz;
  r1.xyz = log2(r1.xyz);
  r1.xyz = cb0[67].yyy * r1.xyz;
  r1.xyz = exp2(r1.xyz);
  r1.xyz = r1.xyz + -r0.xyz;
