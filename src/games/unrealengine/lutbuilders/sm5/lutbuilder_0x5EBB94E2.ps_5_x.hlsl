...
// ---- Created with 3Dmigoto v1.3.16 on Sun Jul  6 03:06:31 2025
...
void main(
  ...
  if (RENODX_TONE_MAP_TYPE != 0) {
    o0 = GenerateOutput(r3.xyz, asuint(cb0[56].z));
    return;
  }
  ...
  if (asuint(cb0[56].z) == 0) {
    ...
    r4.xyzw = cmp(asint(cb0[56].wwww) == int4(1, 2, 3, 4));
