// ---- Created with 3Dmigoto v1.3.2 on Mon Dec 30 23:35:20 2024
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xzw = cb0[68].xxx * r1.xzw + r2.xxx;
  r1.xyz = r1.yyy ? r1.xzw : r2.xxx;
  r1.w = -r1.x * r1.x + 1;
  r1.w = cb0[67].z * r1.w;
  r0.xy = -r0.xy * cb0[39].zw + v2.xy;
  r0.xy = r1.ww * r0.xy + r0.zw;
  r0.zw = max(cb0[45].xy, r0.xy);
  r0.zw = min(cb0[45].zw, r0.zw);
  ...
  r0.w = r0.w * 0.00100000005 + -cb0[79].z;
  r1.x = cmp(0 < r0.w);
  r0.w = cmp(r0.w < 0);
  ...
  r1.x = cmp(0 < cb0[79].y);
  if (r1.x != 0) {
    r1.xyz = cb0[81].xyz + -r0.xyz;
    r1.xyz = cb0[79].yyy * r1.xyz + r0.xyz;
    r2.xyz = cb0[80].xyz + -r0.xyz;
    r2.xyz = cb0[79].yyy * r2.xyz + r0.xyz;
  } else {
    r3.xyz = cb0[80].xyz + -r0.xyz;
    r1.xyz = abs(cb0[79].yyy) * r3.xyz + r0.xyz;
    r3.xyz = cb0[81].xyz + -r0.xyz;
    r2.xyz = abs(cb0[79].yyy) * r3.xyz + r0.xyz;
  }
  r1.xyz = -r2.xyz + r1.xyz;
  r1.xyz = r0.www * r1.xyz + r2.xyz;
  r1.xyz = r1.xyz + -r0.xyz;
  o0.xyz = cb0[79].xxx * r1.xyz + r0.xyz;
  return;
}