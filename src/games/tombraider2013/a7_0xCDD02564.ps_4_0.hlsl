// ---- Created with 3Dmigoto v1.4.1 on Mon Jan 20 22:44:53 2025
...
void main(
  ...
  r0.z = (int)v0.x * 24;
  r1.xy = -InstanceParameters[r0.z].InstanceParams[0].xy * float2(3, 3) + r0.xy;
  r1.xyzw = p_default_Material_024EF73C9855356_Param_texture.Sample(p_default_Material_024EF73C9855356_Param_sampler_s, r1.xy).xyzw;

  r1 = max(0, r1);

  r1.xyzw = InstanceParameters[r0.z].InstanceParams[1].zzzz * r1.xyzw;
  ...
  r1.xyzw = r2.xyzw * InstanceParameters[r0.z].InstanceParams[1].wwww + r1.xyzw;
  r2.xy = -InstanceParameters[r0.z].InstanceParams[0].xy * float2(2, 2) + r0.xy;
  r2.xyzw = p_default_Material_024EF73C9855356_Param_texture.Sample(p_default_Material_024EF73C9855356_Param_sampler_s, r2.xy).xyzw;

  r2 = max(0, r2);

  r1.xyzw = r2.xyzw * InstanceParameters[r0.z].InstanceParams[1].yyyy + r1.xyzw;
  r2.xy = -InstanceParameters[r0.z].InstanceParams[0].xy + r0.xy;
  r2.xyzw = p_default_Material_024EF73C9855356_Param_texture.Sample(p_default_Material_024EF73C9855356_Param_sampler_s, r2.xy).xyzw;

  r2 = max(0, r2);

  r1.xyzw = r2.xyzw * InstanceParameters[r0.z].InstanceParams[1].xxxx + r1.xyzw;
  r2.xyzw = p_default_Material_024EF73C9855356_Param_texture.Sample(p_default_Material_024EF73C9855356_Param_sampler_s, r0.xy).xyzw;

  r2 = max(0, r2);

  r1.xyzw = r2.xyzw * InstanceParameters[r0.z].InstanceParams[2].xxxx + r1.xyzw;
  r2.xy = InstanceParameters[r0.z].InstanceParams[0].xy + r0.xy;
  r2.xyzw = p_default_Material_024EF73C9855356_Param_texture.Sample(p_default_Material_024EF73C9855356_Param_sampler_s, r2.xy).xyzw;
  ...
  r1.xyzw = r2.xyzw * InstanceParameters[r0.z].InstanceParams[1].zzzz + r1.xyzw;
  r0.xyzw = r3.xyzw * InstanceParameters[r0.z].InstanceParams[1].wwww + r1.xyzw;
  r1.x = v0.x;
