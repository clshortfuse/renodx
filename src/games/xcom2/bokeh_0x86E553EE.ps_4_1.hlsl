...
// ---- Created with 3Dmigoto v1.4.1 on Thu Oct  2 18:04:50 2025
...
SamplerState DirtyLensTexture_s : register(s4);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyz = DirtyLensValues.xxx * r1.xyz + BloomTintAndScreenBlendThreshold.xyz;
