...
struct ShaderInjectData {
  ...
  float custom_random;
  float worldmap_fog_saturate;
  float use_alternative_lut_sampling;
};
...
#define RENODX_USE_ALTERNATIVE_LUT             shader_injection.use_alternative_lut_sampling
#define RENODX_WORLD_MAP_FOG_SATURATE          shader_injection.worldmap_fog_saturate
