...
SamplerState lense_flare_2_sampler_s : register(s0);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xy = half_texel_offset.xy + v2.xy;
  r1.xyzw = lense_flare_2_texture.Sample(lense_flare_2_sampler_s, r1.xy).xyzw;
  r0.w = v1.w;

  o0.xyzw = r1.xyzw * r0.xyzw;
  // Disable bloom/lens flare by outputting transparent
