...
static float PaperWhiteNits = ITU_WhiteLevelNits;
  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (HDR && TonemapHDR)
  {
    const float paperWhite = PaperWhiteNits / sRGB_WhiteLevelNits;
    ...
    linearColor = DICETonemap(linearColor, peakWhite, highlightsShoulderStart);
