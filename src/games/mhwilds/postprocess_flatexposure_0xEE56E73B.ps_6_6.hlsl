...
float4 main(
  ...
  float _2772;
  if (!_37) {
    _43 = ((uint)(distortionType) == 0);
  } else {
    _43 = false;
  }
  if (!_37) {
    _49 = (((uint)(distortionType) == 1) && (CUSTOM_LENS_DISTORTION == 1));
  } else {
    _49 = false;
  }
  bool _51 = (((uint)(cPassEnabled) & 64) != 0);
  [branch]
  if (film_aspect == 0.0f) {
    ...
    if ((uint)(aberrationEnable) == 0) {
      if (_51) {
        if (!((uint)(fHazeFilterReductionResolution) == 0)) {
          ...
          bool _149 = (((uint)(fHazeFilterAttribute) & 2) != 0);
          ...
          if (_149) {
            ...
            _243 = select((((uint)(fHazeFilterAttribute) & 1) != 0), (1.0f - _153.x), _153.x);
            _244 = 0.0f;
          }
    ...
    if (_49) {
      ...
      if (_51) {
        if (!((uint)(fHazeFilterReductionResolution) == 0)) {
          ...
          bool _633 = (((uint)(fHazeFilterAttribute) & 2) != 0);
          ...
          if (_633) {
            ...
            _727 = select((((uint)(fHazeFilterAttribute) & 1) != 0), (1.0f - (_637.x)), (_637.x));
            _728 = 0.0f;
          }
          if (!(((uint)(fHazeFilterAttribute) & 4) == 0)) {
      ...
      if (!_51) {
        ...
        if (!((uint)(fHazeFilterReductionResolution) == 0)) {
          ...
          bool _917 = (((uint)(fHazeFilterAttribute) & 2) != 0);
          ...
          if (_917) {
            ...
            _1011 = select((((uint)(fHazeFilterAttribute) & 1) != 0), (1.0f - _921.x), _921.x);
            _1012 = 0.0f;
          }
          if (!(((uint)(fHazeFilterAttribute) & 4) == 0)) {
  ...
  if (!(((uint)(cPassEnabled) & 32) == 0)) {
    ...
    float _1213 = float((bool)(bool)(((uint)(cbRadialBlurFlags) & 2) != 0));
  ...
  if (!(((uint)(cPassEnabled) & 2) == 0) && CUSTOM_FILM_GRAIN_STRENGTH == 0) {
  ...
  float _2543 = select(_2542, _2537, 1.0f);
  float _2544 = select(_2542, _2538, 1.0f);
  float _2545 = select(_2542, _2539, 1.0f);
  if (!(((uint)(cPassEnabled) & 8) == 0)) {
    _2580 = saturate(((cvdR.x * _2543) + (cvdR.y * _2544)) + (cvdR.z * _2545));
    _2581 = saturate(((cvdG.x * _2543) + (cvdG.y * _2544)) + (cvdG.z * _2545));
    _2582 = saturate(((cvdB.x * _2543) + (cvdB.y * _2544)) + (cvdB.z * _2545));
  } else {
    _2580 = _2543;
    _2581 = _2544;
    _2582 = _2545;
  ...
  if (!(((uint)(cPassEnabled) & 16) == 0)) {
    float _2597 = screenInverseSize.x * SV_Position.x;
    float _2598 = screenInverseSize.y * SV_Position.y;
    float4 _2601 = ImagePlameBase.SampleLevel(BilinearClamp, float2(_2597, _2598), 0.0f);
    float _2606 = (_2601.x) * ColorParam.x;
    float _2607 = (_2601.y) * ColorParam.y;
    float _2608 = (_2601.z) * ColorParam.z;
    float _2611 = ImagePlameAlpha.SampleLevel(BilinearClamp, float2(_2597, _2598), 0.0f);
    float _2616 = ((_2601.w) * ColorParam.w) * saturate(((_2611.x) * Levels_Rate) + Levels_Range);
    if (_2606 < 0.5f) {
    ...
    _2663 = (lerp(_2580, _2628, _2616));
    _2664 = (lerp(_2581, _2640, _2616));
    _2665 = (lerp(_2582, _2652, _2616));
  } else {
    _2663 = _2580;
    _2664 = _2581;
    _2665 = _2582;
  ...
  //   float _2673 = invLinearBegin * _2663;
  //   if (!(_2663 >= linearBegin)) {
  //     _2681 = ((_2673 * _2673) * (3.0f - (_2673 * 2.0f)));
  //   } else {
  //     _2681 = 1.0f;
  //   }
  //   float _2682 = invLinearBegin * _2664;
  //   if (!(_2664 >= linearBegin)) {
  //     _2690 = ((_2682 * _2682) * (3.0f - (_2682 * 2.0f)));
  //   } else {
  //     _2690 = 1.0f;
  //   }
  //   float _2691 = invLinearBegin * _2665;
  //   if (!(_2665 >= linearBegin)) {
  //     _2699 = ((_2691 * _2691) * (3.0f - (_2691 * 2.0f)));
  //   } else {
  //     _2699 = 1.0f;
  //   }
  //   float _2708 = select((_2663 < linearStart), 0.0f, 1.0f);
  //   float _2709 = select((_2664 < linearStart), 0.0f, 1.0f);
  //   float _2710 = select((_2665 < linearStart), 0.0f, 1.0f);
  //   _2770 = (((((contrast * _2663) + madLinearStartContrastFactor) * (_2681 - _2708)) + (((pow(_2673, toe)) * (1.0f - _2681)) * linearBegin)) + ((maxNit - (exp2((contrastFactor * _2663) + mulLinearStartContrastFactor) * displayMaxNitSubContrastFactor)) * _2708));
  //   _2771 = (((((contrast * _2664) + madLinearStartContrastFactor) * (_2690 - _2709)) + (((pow(_2682, toe)) * (1.0f - _2690)) * linearBegin)) + ((maxNit - (exp2((contrastFactor * _2664) + mulLinearStartContrastFactor) * displayMaxNitSubContrastFactor)) * _2709));
  //   _2772 = (((((contrast * _2665) + madLinearStartContrastFactor) * (_2699 - _2710)) + (((pow(_2691, toe)) * (1.0f - _2699)) * linearBegin)) + ((maxNit - (exp2((contrastFactor * _2665) + mulLinearStartContrastFactor) * displayMaxNitSubContrastFactor)) * _2710));
  // } else {
  //   _2770 = _2663;
  //   _2771 = _2664;
  //   _2772 = _2665;
  ...
  SV_Target.xyz = CustomTonemap(float3(_2663, _2664, _2665));
