...
void main(
  ...
  if ((bool)(_14 < screenSize.x) && (bool)(_15 < screenSize.y)) {
    ...
    // float _104 = (_99 * _31) * rangeCompress;
    // OutputTex[int2((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y))] = float4(_104, ((_99 * _32) * rangeCompress), ((_99 * _33) * rangeCompress), _104);
