...
void comp_main()
{
    ...
    {
        float _200 = exp2(log2((HDRMapping_m0[14u].z * 0.009998348541557788848876953125f) * (((HDRMapping_m0[14u].z + (-1.0f)) * 0.999834835529327392578125f) + 1.0f)) * 0.1593017578125f);
        float _209 = clamp(exp2(log2(((_200 * 18.8515625f) + 0.8359375f) / ((_200 * 18.6875f) + 1.0f)) * 78.84375f), 0.0f, 1.0f);
        float _214 = min(0.50806462764739990234375f / _209, _209 * 1.96825349330902099609375f);
        float _215 = (HDRMapping_m0[14u].w * (-4.2855739593505859375e-05f)) * _214;
        float _216 = (HDRMapping_m0[14u].w * (-0.000116012990474700927734375f)) * _214;
