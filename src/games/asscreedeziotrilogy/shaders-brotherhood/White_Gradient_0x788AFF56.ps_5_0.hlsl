...
// ---- Created with 3Dmigoto v1.3.16 on Wed May 06 10:18:43 2026
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.xyzw = asfloat(asuint(r3.xyzw) & asuint(cb3[44].xyzw));
  r3.xyzw = asfloat(asuint(r3.xyzw) | asuint(cb3[45].xyzw));
  r2.xyzw = r0.xyzw * r2.xyzw + r3.xyzw;
  r0.xyzw = abs(r0.xyzw);
  r0.xyzw = r1.xyzw * r0.xyzw;
  r0.xyzw = r0.xyzw * cb4[10].xyzw + r2.xyzw;
  o0.xyzw = lerp(r3.xyzw, r0.xyzw, CUSTOM_WHITE_GRADIENT_STRENGTH);
  return;
}
