...
void main(
  ...
  r2.y = rsqrt(abs(r0.x));
  r0.x = (r2.y == asfloat(0x7f800000u)) ? kHuge : r2.y;
  ...
  r3.x = dot(v11.xyz, v11.xyz);
  r3.x = rsqrt(r3.x);
  r3.x = (r3.x != asfloat(0x7f800000u)) ? r3.x : 0.f;
  r2.xyz = r3.x * v11.xyz;

  r4.x = dot(v10.xyz, v10.xyz);
  r4.x = rsqrt(r4.x);
  ...
  r4.y = log(abs(r0.y));
  r0.y = (r4.y == asfloat(0xff800000u)) ? kHugeNeg : r4.y;
  ...
  r2 = BitNorm(t0.Sample(s0_s, v6.xy), cb3[44], cb3[45]);
  r0.y = max(r2.w * v2.w, 0.f);
  r0.z = r2.w - 0.1f;
  ...
  r2 = r0.xxxx * r0.yyyy - cb4[39].xxxx;
  r0.x *= max(r0.y, 0.f);
  r1.w = r0.x;

  if (r2.x < 0.f || r2.y < 0.f || r2.z < 0.f) discard;

  r0.w = r1.w * 255.f + 0.0001f;
