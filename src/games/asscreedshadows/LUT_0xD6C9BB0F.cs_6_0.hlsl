...
void comp_main()
{
    ...
    // blue tint
    // BT.709 -> AP1
    float _118 = (_21_m0[2u].x * mad(_89, 0.047379501163959503173828125f, mad(_87, 0.3395229876041412353515625f, _85 * 0.613097012042999267578125f))) * _21_m0[2u].w;
    float _119 = (_21_m0[2u].y * mad(_89, 0.013452400453388690948486328125f, mad(_87, 0.916354000568389892578125f, _85 * 0.070193700492382049560546875f))) * _21_m0[2u].w;
    float _120 = (_21_m0[2u].z * mad(_89, 0.86981499195098876953125f, mad(_87, 0.1095699965953826904296875f, _85 * 0.020615600049495697021484375f))) * _21_m0[2u].w;
    ...
    //   float3 untonemapped_ap1 = float3(_342, _343, _345);
    //   float diffuse_white = 203.f;
    //   float peak_nits = 1000.f;
    //   float3 tonemapped = ApplyToneMapEncodePQ(untonemapped_ap1, peak_nits, diffuse_white);
    //   _15[uint3(gl_GlobalInvocationID.xyz)] = float4(tonemapped, 1.0f);
    //   return;
    // }

    _15[uint3(gl_GlobalInvocationID.x, gl_GlobalInvocationID.y, gl_GlobalInvocationID.z)] = float4(_12.SampleLevel(_24, float3((clamp((log2((_436 + _342) + (_453 * ((_423 * (((_375 * _301) * _384) - _342)) - _436))) * 0.0500000007450580596923828125f) + 0.6236965656280517578125f, 0.0f, 1.0f) * 0.96875f) + 0.015625f, (clamp((log2((_437 + _343) + (_453 * ((_423 * (((_376 * _301) * _384) - _343)) - _437))) * 0.0500000007450580596923828125f) + 0.6236965656280517578125f, 0.0f, 1.0f) * 0.96875f) + 0.015625f, (clamp((log2((_438 + _345) + (_453 * ((_423 * (((_377 * _301) * _384) - _345)) - _438))) * 0.0500000007450580596923828125f) + 0.6236965656280517578125f, 0.0f, 1.0f) * 0.96875f) + 0.015625f), 0.0f).xyz, 1.0f);
}
