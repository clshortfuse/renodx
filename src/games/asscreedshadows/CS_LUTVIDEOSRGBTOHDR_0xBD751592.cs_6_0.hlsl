...
#if RENODX_GAME_GAMMA_CORRECTION  // linearize with 2.2 gamma
    float _84 = _15_m0[8u].w * pow(_49, 2.2f);
    float _85 = _15_m0[8u].w * pow(_50, 2.2f);
    float _86 = _15_m0[8u].w * pow(_51, 2.2f);
#else  // linearize with sRGB gamma
  ...
  switch (_42.y) {
    case 2u: {
      ...
      if (_179 < _15_m0[5u].y) {
        ...
        _703 = (_179 > _198) ? ((_197 + _15_m0[5u].y) + (((_179 - _198) * _183) / (max(_183 - _179, 9.9999997473787516355514526367188e-06f) * ((_15_m0[5u].x * _183) / (_183 - _198))))) : (((_179 - _15_m0[5u].y) / _15_m0[5u].x) + _15_m0[5u].y);
      }
      ...
      if (_705 < _15_m0[5u].y) {
        ...
        _956 = (_705 > _198) ? ((_197 + _15_m0[5u].y) + (((_705 - _198) * _183) / (max(_183 - _705, 9.9999997473787516355514526367188e-06f) * ((_15_m0[5u].x * _183) / (_183 - _198))))) : (((_705 - _15_m0[5u].y) / _15_m0[5u].x) + _15_m0[5u].y);
      }
      ...
      if (_958 < _15_m0[5u].y) {
        ...
        _1089 = (_958 > _198) ? ((_197 + _15_m0[5u].y) + (((_958 - _198) * _183) / (max(_183 - _958, 9.9999997473787516355514526367188e-06f) * ((_15_m0[5u].x * _183) / (_183 - _198))))) : (((_958 - _15_m0[5u].y) / _15_m0[5u].x) + _15_m0[5u].y);
      }
      _250 = _703 * 100.0f;
      _254 = _956 * 100.0f;
      _258 = _1089 * 100.0f;
    ...
    case 1u: {
      ...
      if (_280 < _15_m0[5u].y) {
        ...
        _836 = (_280 > _297) ? ((_296 + _15_m0[5u].y) - ((((_15_m0[8u].w * 0.006931471638381481170654296875f) * _681) * log2(max((_284 - _280) / _681, 9.9999997473787516355514526367188e-06f))) / (_15_m0[5u].x * _284))) : (((_280 - _15_m0[5u].y) / _15_m0[5u].x) + _15_m0[5u].y);
      }
      ...
      if (_838 < _15_m0[5u].y) {
        ...
        _974 = (_838 > _297) ? ((_296 + _15_m0[5u].y) - ((((_15_m0[8u].w * 0.006931471638381481170654296875f) * _935) * log2(max((_284 - _838) / _935, 9.9999997473787516355514526367188e-06f))) / (_15_m0[5u].x * _284))) : (((_838 - _15_m0[5u].y) / _15_m0[5u].x) + _15_m0[5u].y);
      }
      ...
      if (_976 < _15_m0[5u].y) {
        ...
        _1102 = (_976 > _297) ? ((_296 + _15_m0[5u].y) - ((((_15_m0[8u].w * 0.006931471638381481170654296875f) * _1068) * log2(max((_284 - _976) / _1068, 9.9999997473787516355514526367188e-06f))) / (_15_m0[5u].x * _284))) : (((_976 - _15_m0[5u].y) / _15_m0[5u].x) + _15_m0[5u].y);
      }
      _250 = _836 * 100.0f;
      _254 = _974 * 100.0f;
      _258 = _1102 * 100.0f;
