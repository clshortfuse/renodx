...
cbuffer ColorGradingGenerateRRTODTLUT_cbuffer : register(b0, space5) {
...
void main(
  ...
  switch ((int)(cb0_space5_003y)) {
    case 2: {
      ...
      float _39 = ((_29 - cb0_space5_000y) * cb0_space5_000z) / cb0_space5_000x;
      float _40 = _27 - cb0_space5_000y;
      bool _43 = (cb0_space5_000y > 9.999999747378752e-06f);
      float _44 = _27 / cb0_space5_000y;
      float _55 = _29 - ((_39 * cb0_space5_000x) + cb0_space5_000y);
      float _56 = (cb0_space5_000x * _29) / _55;
    ...
    case 3: {
      ...
      float _158 = log2(abs(cb0_space5_002x));
      float _161 = cb0_space5_002w * cb0_space5_002z;
      float _163 = exp2(_161 * _158);
      float _164 = log2(_149);
      float _166 = exp2(_164 * cb0_space5_002z);
      float _168 = exp2(_161 * _164);
      float _170 = (_168 - _163) * cb0_space5_002y;
      float _173 = ((_166 * cb0_space5_002y) - exp2(_158 * cb0_space5_002z)) / _170;
      float _178 = ((_168 * _163) - ((_163 * cb0_space5_002y) * _166)) / _170;
      float _181 = exp2(log2(abs(_20 / _149)) * cb0_space5_002z);
      float _193 = exp2(log2(abs(_21 / _149)) * cb0_space5_002z);
      float _205 = exp2(log2(abs(_22 / _149)) * cb0_space5_002z);
    ...
    case 1: {
      ...
      float _243 = ((_233 - cb0_space5_000y) * cb0_space5_000z) / cb0_space5_000x;
      float _244 = _231 - cb0_space5_000y;
      bool _247 = (cb0_space5_000y > 9.999999747378752e-06f);
      float _248 = _231 / cb0_space5_000y;
      float _259 = _233 - ((_243 * cb0_space5_000x) + cb0_space5_000y);
      float _260 = (cb0_space5_000x * _233) / _259;
  ...
  if (!(cb0_space5_003x == 0)) {
    ...
    float _427 = saturate(mad(_361, -0.08325883746147156f, mad(_360, -0.6217920184135437f, (_359 * 1.7050509452819824f))) / cb0_space5_003w);
    float _428 = saturate(mad(_361, -0.010548345744609833f, mad(_360, 1.1408041715621948f, (_359 * -0.13025641441345215f))) / cb0_space5_003w);
    float _429 = saturate(mad(_361, 1.1529725790023804f, mad(_360, -0.12896890938282013f, (_359 * -0.024003375321626663f))) / cb0_space5_003w);
  ...
  ColorGradingGenerateRRTODTLUT_Output[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))] = float4(_455, _456, _457, 1.0f);
}
