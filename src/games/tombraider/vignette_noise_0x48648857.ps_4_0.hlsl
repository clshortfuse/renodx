...
SamplerState p_default_Material_18F3494417343873_177C260427234832_199E787C1910656_Texture_sampler_s : register(s0);
SamplerState p_default_Material_17272C1C7708652_BackBufferTexture_sampler_s : register(s1);
Texture2D<float4> p_default_Material_18F3494417343873_177C260427234832_199E787C1910656_Texture_texture : register(t0);
Texture2D<float4> p_default_Material_17272C1C7708652_BackBufferTexture_texture : register(t1);
...
void main(
  ...
  float3 original_texture = r1.rgb;
  r0.z = max(r1.x, r1.y);
  r0.z = max(r0.z, r1.z);
  r0.z = 1 + -r0.z;
  r0.z = r0.z * r0.z;
  r0.w = (int)v0.x * 24;
  r0.z = InstanceParameters[r0.w].InstanceParams[5].w * r0.z;
  r2.xy = r0.xy * InstanceParameters[r0.w].InstanceParams[7].xy + InstanceParameters[r0.w].InstanceParams[7].zw;
  r0.xy = -InstanceParameters[r0.w].InstanceParams[6].zw + r0.xy;
  r0.x = dot(r0.xy, r0.xy);
  r0.x = sqrt(r0.x);
  r0.x = -InstanceParameters[r0.w].InstanceParams[6].x + r0.x;
  r0.x = saturate(InstanceParameters[r0.w].InstanceParams[6].y * r0.x);
  ...
  float3 noise_pattern = r2.xyz;
  r2.xyz = float3(1, 1, 1) + r2.xyz * CUSTOM_FILM_GRAIN_STRENGTH;
  ...
  r2.xyzw = InstanceParameters[r0.w].InstanceParams[1].xyzw + -InstanceParameters[r0.w].InstanceParams[0].xyzw;
  r0.xyzw = r0.xxxx * r2.xyzw + InstanceParameters[r0.w].InstanceParams[0].xyzw;
  r0.xyz = r0.xyz + -r1.xyz;
  o0.xyz = r0.www * r0.xyz * CUSTOM_VIGNETTE + r1.xyz;
  r0.x = v0.x;
