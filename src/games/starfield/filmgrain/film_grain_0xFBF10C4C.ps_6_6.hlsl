...
float4 main(
  ...
  if (CUSTOM_FILM_GRAIN_USE_PERCEPTUAL) {
    ...
    outputColor = renodx::effects::ApplyFilmGrain(
        ...
        TEXCOORD.xy,
        CUSTOM_RANDOM,
        stub_PushConstantWrapper_FilmGrain_000.PushConstantWrapper_FilmGrain_000 != 0 ? CUSTOM_FILM_GRAIN * 0.03f : 0,
        1.f);
