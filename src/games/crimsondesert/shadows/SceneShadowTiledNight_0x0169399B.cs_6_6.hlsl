...
#define SHADOW_DBG_CONTACT_INV  _2593
#define SHADOW_DBG_OUT_R        _2608
#define SHADOW_DBG_OUT_G        _2609
#define SHADOW_DBG_OUT_B        _2610
#define SHADOW_DBG_OUT_A        _2611
...
void main(
  ...
  if (((_73 < 1.0000000116860974e-07f)) || (_101)) {
    ...
    if (_1616 > 0.0f) {
      ...
      if (_109 < 8.0f) {
        ...
        while(true) {
          ...
          if (!(_2069 == 0)) {
            ...
            _2107 = _2014;
            _2108 = saturate((saturate(1.0f - ((_2097 * _2097) * _2092)) * (1.0f - _1999)) + _1999);
            ...
            if (CONTACT_SHADOW_QUALITY > 0.5f && _2014 == 17) {
              ...
              _2108 = lerp(_1999, _2108, _grassContrib);
            }
          } else {
            _2107 = _1991;
            _2108 = _1999;
          ...
          [branch]
          if (_2108 > 0.949999988079071f) {
            if (!_2015) {
              _2138 = (saturate(_1998 / (_1998 - _2021)) - min(_1995, _2016));
            } else {
              _2138 = 0.0f;
            }
            _2422 = _2014;
            _2423 = _2108;
            _2424 = ((_2138 * _1972) + _1992);
            _2425 = ((_2138 * _1974) + _1993);
            _2426 = ((_2138 * _1975) + _1994);
            _2427 = _2013;
          } else {
            if ((uint)_1997 < (uint)7) {
              _2130 = ((_2016 * _1972) + _1992);
              _2131 = ((_2016 * _1974) + _1993);
              _2132 = ((_2016 * _1975) + _1994);
              _2133 = (_2016 + _1995);
              _2134 = min(abs(_1975), _2021);
            } else {
              _2130 = _1992;
              _2131 = _1993;
              _2132 = _1994;
        ...
        float _2148 = select(_1870, ((_nearFarProj.x - _1864) / _1867), _1756);
        float _2180 = mad((_viewProjRelative[2].z), _1851, mad((_viewProjRelative[2].y), _1850, ((_viewProjRelative[2].x) * _1849))) + (_viewProjRelative[2].w);
        float _2184 = mad((_viewProjRelative[3].z), _1851, mad((_viewProjRelative[3].y), _1850, ((_viewProjRelative[3].x) * _1849))) + (_viewProjRelative[3].w);
        float _2188 = (_2148 * _1731) + _1849;
        float _2189 = (_2148 * _1735) + _1850;
        float _2190 = (_2148 * _1739) + _1851;
        float _2206 = mad((_viewProjRelative[3].z), _2190, mad((_viewProjRelative[3].y), _2189, ((_viewProjRelative[3].x) * _2188))) + (_viewProjRelative[3].w);
        float _2207 = (mad((_viewProjRelative[0].z), _1851, mad((_viewProjRelative[0].y), _1850, ((_viewProjRelative[0].x) * _1849))) + (_viewProjRelative[0].w)) / _2184;
        float _2208 = (mad((_viewProjRelative[1].z), _1851, mad((_viewProjRelative[1].y), _1850, ((_viewProjRelative[1].x) * _1849))) + (_viewProjRelative[1].w)) / _2184;
        float _2209 = _2180 / _2184;
        float _2213 = ((mad((_viewProjRelative[0].z), _2190, mad((_viewProjRelative[0].y), _2189, ((_viewProjRelative[0].x) * _2188))) + (_viewProjRelative[0].w)) / _2206) - _2207;
        float _2214 = ((mad((_viewProjRelative[1].z), _2190, mad((_viewProjRelative[1].y), _2189, ((_viewProjRelative[1].x) * _2188))) + (_viewProjRelative[1].w)) / _2206) - _2208;
        float _2226 = max(0.125f, (1.0f / min(1.0f, (max(((_bufferSizeAndInvSize.x * 0.5f) * abs(_2213)), ((_bufferSizeAndInvSize.y * 0.5f) * abs(_2214))) * 0.125f))));
        float _2227 = _2226 * (((mad((_viewProjRelative[2].z), _2190, mad((_viewProjRelative[2].y), _2189, ((_viewProjRelative[2].x) * _2188))) + (_viewProjRelative[2].w)) / _2206) - _2209);
        float _2244 = (_1742 * 0.0625f) * max(abs(_2227), (_2209 - ((mad((_proj[2].z), _109, 0.0f) + _2180) / (mad((_proj[3].z), _109, 0.0f) + _2184))));
        float _2246 = (_2213 * 0.0625f) * _2226;
        float _2248 = (_2214 * -0.0625f) * _2226;
        float _2249 = _2227 * 0.125f;
        float _2256 = max(_1812, (1.0f / max((abs(_2246) * _bufferSizeAndInvSize.x), (abs(_2248) * _bufferSizeAndInvSize.y))));
        float _2263 = 0.5f / _bufferSizeAndInvSize.x;
        _2265 = 0;
        _2266 = _1762;
        _2267 = _1812;
        _2268 = (((_2207 * 0.5f) + 0.5f) + (_2256 * _2246));
        _2269 = ((0.5f - (_2208 * 0.5f)) + (_2256 * _2248));
        _2270 = ((_2256 * _2249) + _2209);
        _2271 = 0;
        _2272 = 1.0f;
        _2273 = 0.0f;
        while(true) {
          uint _2282 = __3__36__0__0__g_depthStencil.Load(int3(int(min(max(_2268, _2263), (1.0f - _2263)) * _bufferSizeAndInvSize.x), int(_2269 * _bufferSizeAndInvSize.y), 0));
          int _2284 = (uint)((uint)(_2282.x)) >> 24;
          float _2287 = float((uint)((uint)(_2282.x & 16777215))) * 5.960465188081798e-08f;
          int _2288 = _2284 & 127;
          bool _2289 = (_2265 == 0);
          float _2290 = select(_2289, 1.0f, _2266);
          float _2291 = _2270 - _2287;
          float _2295 = _nearFarProj.x / max(1.0000000116860974e-07f, _2287);
          float _2298 = _2295 - (_nearFarProj.x / max(1.0000000116860974e-07f, _2270));
          bool _2301 = (abs(_2291 + _2244) < _2244);
          int _2302 = (int)(uint)((int)(_2301));
          if (_2301) {
            if (((_2288 == 7)) || ((((_2288 == 54)) || (((((_2284 & 126) == 66)) || (((((uint)(_2288 + -5) < (uint)2)) || ((((_2288 == 107)) || ((((_2288 == 26)) || (((((uint)(_2288 + -27) < (uint)2)) || ((((_2288 == 106)) || (((((_2284 & 125) == 105)) || ((((_2288 == 18)) || (((uint)(_2288 + -19) < (uint)2))))))))))))))))))))) {
              _2336 = true;
              _2343 = ((int)(uint)((int)(((_2298 < 0.0f)) && ((_2298 > select(_2336, -0.07999999821186066f, -1.0f))))));
            } else {
              if ((uint)(_2288 + -53) < (uint)14) {
                _2336 = (_2295 < 32.0f);
                _2343 = ((int)(uint)((int)(((_2298 < 0.0f)) && ((_2298 > select(_2336, -0.07999999821186066f, -1.0f))))));
              } else {
                _2343 = _2302;
          ...
          if (!(_2343 == 0)) {
            if ((uint)_2288 > (uint)11) {
              if (!((((uint)_2288 < (uint)16)) || ((_2288 == 17)))) {
                if (!(_2288 == 16)) {
                  if (!(((_2288 == 18)) || ((((_2288 == 107)) || (((uint)(_2288 + -19) < (uint)2)))))) {
                    if (!(_2288 == 66)) {
                      _2366 = 0.0f;
                    } else {
                    ...
                    _2366 = 0.4000000059604645f;
                  }
                } else {
                  _2366 = 0.10000000149011612f;
                }
              } else {
                _2366 = 0.30000001192092896f;
              }
              // RenoDX: Weather-adaptive grass occluder thickness
              if (_2288 == 17) {
                float _grassWeather2 = saturate(abs(_sunDirection.y) * FOLIAGE_SHADOW_SENSITIVITY);
                _2366 = select(CONTACT_SHADOW_QUALITY > 0.5f, lerp(0.018f, 0.05f, _grassWeather2), 0.09f);
              }
            } else {
              if (!(_2288 == 11)) {
                _2366 = 0.0f;
            ...
            float _2368 = saturate(_2295 * 0.015625f);
            float _2371 = (1.0f - _2368) + (_2368 * _2366);
            _2381 = _2288;
            _2382 = saturate((saturate(1.0f - ((_2371 * _2371) * _2366)) * (1.0f - _2273)) + _2273);
            // RenoDX: Weather-adaptive grass shadow contribution
            if (CONTACT_SHADOW_QUALITY > 0.5f && _2288 == 17) {
              float _grassContrib2 = lerp(0.3f, 0.65f, saturate(abs(_sunDirection.y) * FOLIAGE_SHADOW_SENSITIVITY));
              _2382 = lerp(_2273, _2382, _grassContrib2);
            }
          } else {
            _2381 = _2271;
            _2382 = _2273;
          ...
          [branch]
          if (_2382 > 0.949999988079071f) {
            if (!_2289) {
              _2412 = (saturate(_2272 / (_2272 - _2291)) - min(_2267, _2290));
            } else {
              _2412 = 0.0f;
            }
            _2422 = _2288;
            _2423 = _2382;
            _2424 = ((_2412 * _2246) + _2268);
            _2425 = ((_2412 * _2248) + _2269);
            _2426 = ((_2412 * _2249) + _2270);
            _2427 = _2287;
          } else {
            if ((uint)_2265 < (uint)7) {
              _2404 = (_2267 + _2290);
              _2405 = (_2268 + (_2290 * _2246));
              _2406 = (_2269 + (_2290 * _2248));
              _2407 = (_2270 + (_2290 * _2249));
              _2408 = min(abs(_2249), _2291);
            } else {
              _2404 = _2267;
              _2405 = _2268;
              _2406 = _2269;
      ...
      bool _2431 = (_2423 > 0.0f);
      if (_2426 > 0.0f) {
        if ((_2431) || ((((((_2424 >= 0.0f)) && ((_2424 <= 1.0f)))) && ((((_2425 >= 0.0f)) && ((_2425 <= 1.0f))))))) {
          float _2445 = (_2424 * 2.0f) + -1.0f;
          float _2446 = 1.0f - (_2425 * 2.0f);
          float _2462 = mad((_invViewProjRelative[3].z), _2426, mad((_invViewProjRelative[3].y), _2446, (_2445 * (_invViewProjRelative[3].x)))) + (_invViewProjRelative[3].w);
          if (!(_2422 == 2)) {
            if (_2422 == 3) {
              _2488 = 0.0f;
              _2490 = _2488;
          ...
          if (_2423 == 1.0f) {
            _2513 = saturate(((((_1756 * 0.9375f) - max(0.0f, dot(float3(_1731, _1735, _1739), float3((((mad((_invViewProjRelative[0].z), _2426, mad((_invViewProjRelative[0].y), _2446, (_2445 * (_invViewProjRelative[0].x)))) + (_invViewProjRelative[0].w)) / _2462) - _1849), (((mad((_invViewProjRelative[1].z), _2426, mad((_invViewProjRelative[1].y), _2446, (_2445 * (_invViewProjRelative[1].x)))) + (_invViewProjRelative[1].w)) / _2462) - _1850), (((mad((_invViewProjRelative[2].z), _2426, mad((_invViewProjRelative[2].y), _2446, (_2445 * (_invViewProjRelative[2].x)))) + (_invViewProjRelative[2].w)) / _2462) - _1851))))) * ((_109 * 0.015625f) + 1.5f)) / _1756) * 0.9375f);
          } else {
            _2513 = _2423;
          }
          float _2514 = _2513 * saturate(exp2(min(0.0f, (((_109 * 0.01899999938905239f) + 0.10000000149011612f) + (_2490 * ((_nearFarProj.x / max(1.0000000116860974e-07f, _2427)) - (_nearFarProj.x / max(1.0000000116860974e-07f, _2426)))))) * 1.4426950216293335f));
          int _2515 = _2422 & -2;
          if (!(_2515 == 6)) {
            bool __defer_2517_2527 = false;
            if ((((_74 == 33) && (_2422 == 33)) || (!(_74 == 33) && (((_74 == 55)) && ((_2422 == 55)))))) {
              _2589 = (_2514 * 0.009999999776482582f);
            } else {
              __defer_2517_2527 = true;
            }
            if (__defer_2517_2527) {
              if (!(((_2422 == 54)) || ((_2515 == 66))) || ((((_2422 == 54)) || ((_2515 == 66))) && (!(((_1626 == 66)) || ((_74 == 54)))))) {
                if (!_166) {
                  if ((uint)((int)((uint)(_2422) + (uint)(-53))) < (uint)15) {
                    _2586 = saturate(_109 * 0.03125f);
                  } else {
                    _2586 = 1.0f;
                  }
                  _2589 = (_2586 * _2514);
                ...
                uint4 _2541 = __3__36__0__0__g_baseColor.Load(int3(int(_2424 * _bufferSizeAndInvSize.x), int(_2425 * _bufferSizeAndInvSize.y), 0));
                float _2547 = float((uint)((uint)(((uint)((uint)(_2541.x)) >> 8) & 255))) * 0.003921568859368563f;
                float _2550 = float((uint)((uint)(_2541.x & 255))) * 0.003921568859368563f;
                float _2554 = float((uint)((uint)(((uint)((uint)(_2541.y)) >> 8) & 255))) * 0.003921568859368563f;
                float _2555 = _2547 * _2547;
                float _2556 = _2550 * _2550;
                float _2557 = _2554 * _2554;
                _2589 = (saturate(1.0f - (dot(float3((((_2555 * 0.6131200194358826f) + (_2556 * 0.3395099937915802f)) + (_2557 * 0.047370001673698425f)), (((_2555 * 0.07020000368356705f) + (_2556 * 0.9163600206375122f)) + (_2557 * 0.013450000435113907f)), (((_2555 * 0.02061999961733818f) + (_2556 * 0.10958000272512436f)) + (_2557 * 0.8697999715805054f))), float3(0.21267099678516388f, 0.7151600122451782f, 0.0721689984202385f)) * 0.875f)) * _2514);
              }
            }
          } else {
            _2589 = (_2514 * 0.009999999776482582f);
      ...
      _2593 = saturate(1.0f - _2589);
    } else {
      _2593 = 1.0f;
    }
    float _2594 = min(_1616, _2593);
    ...
    #define MICRO_CONTACT_SHADOW  _2593
    ...
    if (CONTACT_SHADOW_QUALITY > 0.5f && _2593 < 1.0f) {
      ...
      _2593 = lerp(lerp(1.0f, _2593, 0.5f), _2593, _edgeFade);
    }

    _2594 = min(_1616, _2593);
    _2608 = float(half(_2594 * float(_1592)));
    _2609 = float(half(_2594 * float(_1593)));
    _2610 = float(half(_2594 * float(_1594)));
    _2611 = saturate((1.0f - _550) + (exp2(log2(saturate(select(_166, (_1601 + 0.9800000190734863f), _1601))) * 0.45454543828964233f) * _550));
    // ── RenoDX Shadow Debug ──────────────────────────────────────────────
    #include "shadow_debug_night.hlsli"
    // ────────────────────────────────────────────────────────────────────
  }
  __3__38__0__1__g_shadowColorResultUAV[int2(((int)(((uint)(((((int)((uint)(_40) << 2)) & 262140) | ((int)(SV_GroupID.x) & 3)) << 3)) + SV_GroupThreadID.x)), ((int)(((uint)(((((uint)((uint)(_40)) >> 16) << 2) | (((uint)(SV_GroupID.x) >> 2) & 3)) << 3)) + SV_GroupThreadID.y)))] = half4(half(_2608), half(_2609), half(_2610), half(_2611));
}