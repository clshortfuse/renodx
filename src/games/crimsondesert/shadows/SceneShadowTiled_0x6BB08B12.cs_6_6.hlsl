...
void main(
  ...
  if (((int)(_76 < 1.0000000116860974e-07f)) | (_104)) {
          ...
          if (!(_2513 == 0)) {
            if ((uint)_2458 > (uint)11) {
              if (!(((int)((uint)_2458 < (uint)16)) | ((int)(_2458 == 17)))) {
                ...
                // _shadowAOParams.x is the game's ToD shadow floor
                if (_2458 == 17) {
            ...
            if (CONTACT_SHADOW_QUALITY > 0.5f && _2458 == 17) {
              ...
              _2560 = lerp(_2443, _2560, _grassContrib);
            }
          } else {
            _2559 = _2435;
            _2560 = _2443;
              ...
              if (!(((int)((uint)_2740 < (uint)16)) | ((int)(_2740 == 17)))) {
                if (!(_2740 == 16)) {
                  if (!(((int)(_2740 == 18)) | (((int)(((int)(_2740 == 107)) | ((int)((uint)(_2740 + -19) < (uint)2))))))) {
                    ...
                    _2818 = select(CONTACT_SHADOW_QUALITY > 0.5f, 0.18f, 0.4000000059604645f);
                  }
                } else {
                  _2818 = 0.10000000149011612f;
                }
                ...
                if (_2740 == 17) {
                  ...
                  _2818 = select(CONTACT_SHADOW_QUALITY > 0.5f, lerp(0.018f, 0.05f, _grassWeather2), 0.09f);
                } else {
                  _2818 = select(CONTACT_SHADOW_QUALITY > 0.5f, 0.12f, 0.30000001192092896f);
                }
              }
            } else {
              if (!(_2740 == 11)) {
    ...
    #define MICRO_CONTACT_SHADOW  _3076
    ...
    if (CONTACT_SHADOW_QUALITY > 0.5f && _3076 < 1.0f) {
      float2 _screenUV = float2((_57 + 0.5f) * _bufferSizeAndInvSize.z,
                                 (_58 + 0.5f) * _bufferSizeAndInvSize.w);
      // Distance from nearest screen edge [0 = at edge, 0.5 = center]
      float2 _edgeDist = min(_screenUV, 1.0f - _screenUV);
      float _edgeFade = saturate(min(_edgeDist.x, _edgeDist.y) * 10.0f);  // 10% border fade
      _3076 = lerp(lerp(1.0f, _3076, 0.5f), _3076, _edgeFade);
    }
    // ─────────────────────────────────────────────────────────────────────
