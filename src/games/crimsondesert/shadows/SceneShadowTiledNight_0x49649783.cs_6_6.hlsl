...
#define SHADOW_DBG_CONTACT_INV  _2609
#define SHADOW_DBG_OUT_R        _2624
#define SHADOW_DBG_OUT_G        _2625
#define SHADOW_DBG_OUT_B        _2626
#define SHADOW_DBG_OUT_A        _2627
  ...
  if (((_73 < 1.0000000116860974e-07f)) || (_101)) {
    ...
    if (_1616 > 0.0f) {
      ...
      if (_109 < 8.0f) {
        ...
        while(true) {
          ...
          if (!(_2069 == 0)) {
            if ((uint)_2014 > (uint)11) {
              if (!((((uint)_2014 < (uint)16)) || ((_2014 == 17)))) {
                if (!(_2014 == 16)) {
                  if (!(((_2014 == 18)) || ((((_2014 == 107)) || (((uint)(_2014 + -19) < (uint)2)))))) {
                    if (!(_2014 == 66)) {
                      _2092 = 0.0f;
                    } else {
                      _2092 = 0.10000000149011612f;
                    }
                  } else {
                    _2092 = 0.4000000059604645f;
                  }
                } else {
                  _2092 = 0.10000000149011612f;
                }
              } else {
                _2092 = 0.30000001192092896f;
              }
              ...
              if (_2014 == 17) {
                ...
                _2092 = select(CONTACT_SHADOW_QUALITY > 0.5f, lerp(0.018f, 0.05f, _grassWeather), 0.09f);
              }
            } else {
              if (!(_2014 == 11)) {
                _2092 = 0.0f;
            ...
            float _2094 = saturate(_2020 * 0.015625f);
            float _2097 = (1.0f - _2094) + (_2094 * _2092);
            if (_166) {
              _2108 = saturate((-0.0f - _2024) / (_1995 * 0.004654859658330679f));
            } else {
              _2108 = 1.0f;
            }
            _2115 = _2014;
            _2116 = saturate(((saturate(1.0f - ((_2097 * _2097) * _2092)) * (1.0f - _1999)) * _2108) + _1999);
            // RenoDX: Weather-adaptive grass shadow contribution
            if (CONTACT_SHADOW_QUALITY > 0.5f && _2014 == 17) {
              float _grassContrib = lerp(0.3f, 0.65f, saturate(abs(_sunDirection.y) * FOLIAGE_SHADOW_SENSITIVITY));
              _2116 = lerp(_1999, _2116, _grassContrib);
            }
          } else {
            _2115 = _1991;
            _2116 = _1999;
          ...
          if (_2116 > 0.949999988079071f) {
            if (!_2015) {
              _2146 = (saturate(_1998 / (_1998 - _2021)) - min(_1995, _2016));
            } else {
              _2146 = 0.0f;
            }
            _2438 = _2014;
            _2439 = _2116;
            _2440 = ((_2146 * _1972) + _1992);
            _2441 = ((_2146 * _1974) + _1993);
            _2442 = ((_2146 * _1975) + _1994);
            _2443 = _2013;
          } else {
            if ((uint)_1997 < (uint)7) {
              _2138 = ((_2016 * _1972) + _1992);
              _2139 = ((_2016 * _1974) + _1993);
              _2140 = ((_2016 * _1975) + _1994);
              _2141 = (_2016 + _1995);
              _2142 = min(abs(_1975), _2021);
            } else {
              _2138 = _1992;
              _2139 = _1993;
              _2140 = _1994;
        ...
        float _2156 = select(_1870, ((_nearFarProj.x - _1864) / _1867), _1756);
        float _2188 = mad((_viewProjRelative[2].z), _1851, mad((_viewProjRelative[2].y), _1850, ((_viewProjRelative[2].x) * _1849))) + (_viewProjRelative[2].w);
        float _2192 = mad((_viewProjRelative[3].z), _1851, mad((_viewProjRelative[3].y), _1850, ((_viewProjRelative[3].x) * _1849))) + (_viewProjRelative[3].w);
        float _2196 = (_2156 * _1731) + _1849;
        float _2197 = (_2156 * _1735) + _1850;
        float _2198 = (_2156 * _1739) + _1851;
        float _2214 = mad((_viewProjRelative[3].z), _2198, mad((_viewProjRelative[3].y), _2197, ((_viewProjRelative[3].x) * _2196))) + (_viewProjRelative[3].w);
        float _2215 = (mad((_viewProjRelative[0].z), _1851, mad((_viewProjRelative[0].y), _1850, ((_viewProjRelative[0].x) * _1849))) + (_viewProjRelative[0].w)) / _2192;
        float _2216 = (mad((_viewProjRelative[1].z), _1851, mad((_viewProjRelative[1].y), _1850, ((_viewProjRelative[1].x) * _1849))) + (_viewProjRelative[1].w)) / _2192;
        float _2217 = _2188 / _2192;
        float _2221 = ((mad((_viewProjRelative[0].z), _2198, mad((_viewProjRelative[0].y), _2197, ((_viewProjRelative[0].x) * _2196))) + (_viewProjRelative[0].w)) / _2214) - _2215;
        float _2222 = ((mad((_viewProjRelative[1].z), _2198, mad((_viewProjRelative[1].y), _2197, ((_viewProjRelative[1].x) * _2196))) + (_viewProjRelative[1].w)) / _2214) - _2216;
        float _2234 = max(0.125f, (1.0f / min(1.0f, (max(((_bufferSizeAndInvSize.x * 0.5f) * abs(_2221)), ((_bufferSizeAndInvSize.y * 0.5f) * abs(_2222))) * 0.125f))));
        float _2235 = _2234 * (((mad((_viewProjRelative[2].z), _2198, mad((_viewProjRelative[2].y), _2197, ((_viewProjRelative[2].x) * _2196))) + (_viewProjRelative[2].w)) / _2214) - _2217);
        float _2252 = (_1742 * 0.0625f) * max(abs(_2235), (_2217 - ((mad((_proj[2].z), _109, 0.0f) + _2188) / (mad((_proj[3].z), _109, 0.0f) + _2192))));
        float _2254 = (_2221 * 0.0625f) * _2234;
        float _2256 = (_2222 * -0.0625f) * _2234;
        float _2257 = _2235 * 0.125f;
        float _2264 = max(_1812, (1.0f / max((abs(_2254) * _bufferSizeAndInvSize.x), (abs(_2256) * _bufferSizeAndInvSize.y))));
        float _2271 = 0.5f / _bufferSizeAndInvSize.x;
        _2273 = 0;
        _2274 = _1762;
        _2275 = _1812;
        _2276 = (((_2215 * 0.5f) + 0.5f) + (_2264 * _2254));
        _2277 = ((0.5f - (_2216 * 0.5f)) + (_2264 * _2256));
        _2278 = ((_2264 * _2257) + _2217);
        _2279 = 0;
        _2280 = 1.0f;
        _2281 = 0.0f;
        while(true) {
          uint _2290 = __3__36__0__0__g_depthStencil.Load(int3(int(min(max(_2276, _2271), (1.0f - _2271)) * _bufferSizeAndInvSize.x), int(_2277 * _bufferSizeAndInvSize.y), 0));
          int _2292 = (uint)((uint)(_2290.x)) >> 24;
          float _2295 = float((uint)((uint)(_2290.x & 16777215))) * 5.960465188081798e-08f;
          int _2296 = _2292 & 127;
          bool _2297 = (_2273 == 0);
          float _2298 = select(_2297, 1.0f, _2274);
          float _2299 = _2278 - _2295;
          float _2303 = _nearFarProj.x / max(1.0000000116860974e-07f, _2295);
          float _2306 = _2303 - (_nearFarProj.x / max(1.0000000116860974e-07f, _2278));
          bool _2309 = (abs(_2299 + _2252) < _2252);
          int _2310 = (int)(uint)((int)(_2309));
          if (_2309) {
            if (((_2296 == 7)) || ((((_2296 == 54)) || (((((_2292 & 126) == 66)) || (((((uint)(_2296 + -5) < (uint)2)) || ((((_2296 == 107)) || ((((_2296 == 26)) || (((((uint)(_2296 + -27) < (uint)2)) || ((((_2296 == 106)) || (((((_2292 & 125) == 105)) || ((((_2296 == 18)) || (((uint)(_2296 + -19) < (uint)2))))))))))))))))))))) {
              _2344 = true;
              _2351 = ((int)(uint)((int)(((_2306 < 0.0f)) && ((_2306 > select(_2344, -0.07999999821186066f, -1.0f))))));
            } else {
              if ((uint)(_2296 + -53) < (uint)14) {
                _2344 = (_2303 < 32.0f);
                _2351 = ((int)(uint)((int)(((_2306 < 0.0f)) && ((_2306 > select(_2344, -0.07999999821186066f, -1.0f))))));
              } else {
                _2351 = _2310;
          ...
          if (!(_2351 == 0)) {
            if ((uint)_2296 > (uint)11) {
              if (!((((uint)_2296 < (uint)16)) || ((_2296 == 17)))) {
                if (!(_2296 == 16)) {
                  if (!(((_2296 == 18)) || ((((_2296 == 107)) || (((uint)(_2296 + -19) < (uint)2)))))) {
                    if (!(_2296 == 66)) {
                      _2374 = 0.0f;
                    } else {
                      _2374 = 0.10000000149011612f;
                    }
                  } else {
                    _2374 = 0.4000000059604645f;
                  }
                } else {
                  _2374 = 0.10000000149011612f;
                }
              } else {
                _2374 = 0.30000001192092896f;
              }
              // RenoDX: Weather-adaptive grass occluder thickness
              if (_2296 == 17) {
                float _grassWeather2 = saturate(abs(_sunDirection.y) * FOLIAGE_SHADOW_SENSITIVITY);
                _2374 = select(CONTACT_SHADOW_QUALITY > 0.5f, lerp(0.018f, 0.05f, _grassWeather2), 0.09f);
              }
            } else {
              if (!(_2296 == 11)) {
                _2374 = 0.0f;
            ...
            float _2376 = saturate(_2303 * 0.015625f);
            float _2379 = (1.0f - _2376) + (_2376 * _2374);
            if (_166) {
              _2390 = saturate((-0.0f - _2306) / (_2275 * 0.004654859658330679f));
            } else {
              _2390 = 1.0f;
            }
            _2397 = _2296;
            _2398 = saturate(((saturate(1.0f - ((_2379 * _2379) * _2374)) * (1.0f - _2281)) * _2390) + _2281);
            // RenoDX: Weather-adaptive grass shadow contribution
            if (CONTACT_SHADOW_QUALITY > 0.5f && _2296 == 17) {
              float _grassContrib2 = lerp(0.3f, 0.65f, saturate(abs(_sunDirection.y) * FOLIAGE_SHADOW_SENSITIVITY));
              _2398 = lerp(_2281, _2398, _grassContrib2);
            }
          } else {
            _2397 = _2279;
            _2398 = _2281;
          ...
          [branch]
          if (_2398 > 0.949999988079071f) {
            if (!_2297) {
              _2428 = (saturate(_2280 / (_2280 - _2299)) - min(_2275, _2298));
            } else {
              _2428 = 0.0f;
            }
            _2438 = _2296;
            _2439 = _2398;
            _2440 = ((_2428 * _2254) + _2276);
            _2441 = ((_2428 * _2256) + _2277);
            _2442 = ((_2428 * _2257) + _2278);
            _2443 = _2295;
          } else {
            if ((uint)_2273 < (uint)7) {
              _2420 = (_2275 + _2298);
              _2421 = (_2276 + (_2298 * _2254));
              _2422 = (_2277 + (_2298 * _2256));
              _2423 = (_2278 + (_2298 * _2257));
              _2424 = min(abs(_2257), _2299);
            } else {
              _2420 = _2275;
              _2421 = _2276;
              _2422 = _2277;
      ...
      bool _2447 = (_2439 > 0.0f);
      if (_2442 > 0.0f) {
        if ((_2447) || ((((((_2440 >= 0.0f)) && ((_2440 <= 1.0f)))) && ((((_2441 >= 0.0f)) && ((_2441 <= 1.0f))))))) {
          float _2461 = (_2440 * 2.0f) + -1.0f;
          float _2462 = 1.0f - (_2441 * 2.0f);
          float _2478 = mad((_invViewProjRelative[3].z), _2442, mad((_invViewProjRelative[3].y), _2462, (_2461 * (_invViewProjRelative[3].x)))) + (_invViewProjRelative[3].w);
          if (!(_2438 == 2)) {
            if (_2438 == 3) {
              _2504 = 0.0f;
              _2506 = _2504;
          ...
          if (_2439 == 1.0f) {
            _2529 = saturate(((((_1756 * 0.9375f) - max(0.0f, dot(float3(_1731, _1735, _1739), float3((((mad((_invViewProjRelative[0].z), _2442, mad((_invViewProjRelative[0].y), _2462, (_2461 * (_invViewProjRelative[0].x)))) + (_invViewProjRelative[0].w)) / _2478) - _1849), (((mad((_invViewProjRelative[1].z), _2442, mad((_invViewProjRelative[1].y), _2462, (_2461 * (_invViewProjRelative[1].x)))) + (_invViewProjRelative[1].w)) / _2478) - _1850), (((mad((_invViewProjRelative[2].z), _2442, mad((_invViewProjRelative[2].y), _2462, (_2461 * (_invViewProjRelative[2].x)))) + (_invViewProjRelative[2].w)) / _2478) - _1851))))) * ((_109 * 0.015625f) + 1.5f)) / _1756) * 0.9375f);
          } else {
            _2529 = _2439;
          }
          float _2530 = _2529 * saturate(exp2(min(0.0f, (((_109 * 0.01899999938905239f) + 0.10000000149011612f) + (_2506 * ((_nearFarProj.x / max(1.0000000116860974e-07f, _2443)) - (_nearFarProj.x / max(1.0000000116860974e-07f, _2442)))))) * 1.4426950216293335f));
          int _2531 = _2438 & -2;
          if (!(_2531 == 6)) {
            bool __defer_2533_2543 = false;
            if ((((_74 == 33) && (_2438 == 33)) || (!(_74 == 33) && (((_74 == 55)) && ((_2438 == 55)))))) {
              _2605 = (_2530 * 0.009999999776482582f);
            } else {
              __defer_2533_2543 = true;
            }
            if (__defer_2533_2543) {
              if (!(((_2438 == 54)) || ((_2531 == 66))) || ((((_2438 == 54)) || ((_2531 == 66))) && (!(((_1626 == 66)) || ((_74 == 54)))))) {
                if (!_166) {
                  if ((uint)((int)((uint)(_2438) + (uint)(-53))) < (uint)15) {
                    _2602 = saturate(_109 * 0.03125f);
                  } else {
                    _2602 = 1.0f;
                  }
                  _2605 = (_2602 * _2530);
                ...
                uint4 _2557 = __3__36__0__0__g_baseColor.Load(int3(int(_2440 * _bufferSizeAndInvSize.x), int(_2441 * _bufferSizeAndInvSize.y), 0));
                float _2563 = float((uint)((uint)(((uint)((uint)(_2557.x)) >> 8) & 255))) * 0.003921568859368563f;
                float _2566 = float((uint)((uint)(_2557.x & 255))) * 0.003921568859368563f;
                float _2570 = float((uint)((uint)(((uint)((uint)(_2557.y)) >> 8) & 255))) * 0.003921568859368563f;
                float _2571 = _2563 * _2563;
                float _2572 = _2566 * _2566;
                float _2573 = _2570 * _2570;
                _2605 = (saturate(1.0f - (dot(float3((((_2571 * 0.6131200194358826f) + (_2572 * 0.3395099937915802f)) + (_2573 * 0.047370001673698425f)), (((_2571 * 0.07020000368356705f) + (_2572 * 0.9163600206375122f)) + (_2573 * 0.013450000435113907f)), (((_2571 * 0.02061999961733818f) + (_2572 * 0.10958000272512436f)) + (_2573 * 0.8697999715805054f))), float3(0.21267099678516388f, 0.7151600122451782f, 0.0721689984202385f)) * 0.875f)) * _2530);
              }
            }
          } else {
            _2605 = (_2530 * 0.009999999776482582f);
      ...
      _2609 = saturate(1.0f - _2605);
    } else {
      _2609 = 1.0f;
    }
    float _2610 = min(_1616, _2609);
    ...
    #define MICRO_CONTACT_SHADOW  _2609
    ...
    if (CONTACT_SHADOW_QUALITY > 0.5f && _2609 < 1.0f) {
      ...
      _2609 = lerp(lerp(1.0f, _2609, 0.5f), _2609, _edgeFade);
    }

    _2610 = min(_1616, _2609);
    _2624 = float(half(_2610 * float(_1592)));
    _2625 = float(half(_2610 * float(_1593)));
    _2626 = float(half(_2610 * float(_1594)));
    _2627 = saturate((1.0f - _550) + (exp2(log2(saturate(select(_166, (_1601 + 0.9800000190734863f), _1601))) * 0.45454543828964233f) * _550));
    // ── RenoDX Shadow Debug ──────────────────────────────────────────────
    #include "shadow_debug_night.hlsli"
    // ────────────────────────────────────────────────────────────────────
  }
  __3__38__0__1__g_shadowColorResultUAV[int2(((int)(((uint)(((((int)((uint)(_40) << 2)) & 262140) | ((int)(SV_GroupID.x) & 3)) << 3)) + SV_GroupThreadID.x)), ((int)(((uint)(((((uint)((uint)(_40)) >> 16) << 2) | (((uint)(SV_GroupID.x) >> 2) & 3)) << 3)) + SV_GroupThreadID.y)))] = half4(half(_2624), half(_2625), half(_2626), half(_2627));
}