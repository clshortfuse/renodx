// ---- Created with 3Dmigoto v1.3.16 on Wed Jul 31 20:56:39 2024
#include "./shared.h"
  ...
  out float4 o0 : SV_Target0)
{
  ...
  //r0.x = IsInside ? r0.y : r0.x; //OG code, creates artifacts
  ...
  r1.x = r2.x + -r1.x;
  o0.x = (r0.x * abs(r1.x) + r0.y); //removed saturate
  r0.y = dot(abs(r3.yy), abs(r1.yy));
  r1.x = dot(abs(r3.zz), abs(r1.zz));
  r1.x = r2.z + -r1.x;
  r0.y = r2.y + -r0.y;
  o0.y = (r0.x * abs(r0.y) + r0.z); //removed saturate
  o0.z = (r0.x * abs(r1.x) + r0.w); //removed saturate
  o0.w = 1;
  return;
}