#ifndef SRC_HONKAI_STARRAIL_SHARED_H_
#define SRC_HONKAI_STARRAIL_SHARED_H_

// Honkai: Star Rail: see README.md for the render path this mod hooks.
...
struct ShaderInjectData {
  ...
  float custom_effects_before_ui;
};
...
#endif  // SRC_HONKAI_STARRAIL_SHARED_H_
