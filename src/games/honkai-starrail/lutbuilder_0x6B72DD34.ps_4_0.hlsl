...
void main(
  ...
  r0.w = cmp(0.5 >= cb0[31].x);
  if (r0.w != 0) {
    r0.w = cmp(0.5 < cb0[30].z);
    if (r0.w != 0) {
      ...
      r0.w = cmp(0.5 < cb0[30].w);
      if (r0.w == 0) {
        r1.xyz = cb0[23].xxx * r0.xyz;
        r2.xyzw = cmp(r1.xxyy < cb0[23].yzyz);
        r3.xyzw = r2.yyyy ? cb0[26].xyzw : cb0[28].xyzw;
        r4.xyzw = r2.yyww ? cb0[27].xyxy : cb0[29].xyxy;
        r3.xyzw = r2.xxxx ? cb0[24].xyzw : r3.xyzw;
        r4.xyzw = r2.xxzz ? cb0[25].xyxy : r4.xyzw;
        r0.w = r0.x * cb0[23].x + -r3.x;
        r0.w = r0.w * r3.z;
        r1.x = cmp(0 < r0.w);
        r0.w = log2(r0.w);
        r0.w = r4.y * r0.w;
        ...
        r0.w = r1.x ? r0.w : 0;
        r3.x = r0.w * r3.w + r3.y;
        r5.xyzw = r2.wwww ? cb0[26].xyzw : cb0[28].xyzw;
        r5.xyzw = r2.zzzz ? cb0[24].xyzw : r5.xyzw;
        r0.w = r0.y * cb0[23].x + -r5.x;
        r0.w = r0.w * r5.z;
        r1.x = cmp(0 < r0.w);
        r0.w = log2(r0.w);
        r0.w = r4.w * r0.w;
        ...
        r0.w = r1.x ? r0.w : 0;
        r3.y = r0.w * r5.w + r5.y;
        r1.xy = cmp(r1.zz < cb0[23].yz);
        r4.xyzw = r1.yyyy ? cb0[26].xyzw : cb0[28].xyzw;
        r1.yz = r1.yy ? cb0[27].xy : cb0[29].xy;
        r4.xyzw = r1.xxxx ? cb0[24].xyzw : r4.xyzw;
        r1.yz = r1.xx ? cb0[25].xy : r1.yz;
        r0.w = r0.z * cb0[23].x + -r4.x;
        r0.w = r0.w * r4.z;
        r1.w = cmp(0 < r0.w);
        r0.w = log2(r0.w);
        r0.w = r1.z * r0.w;
        ...
        r0.w = r1.w ? r0.w : 0;
        r3.z = r0.w * r4.w + r4.y;
        r4.xyzw = r2.xxxx ? cb0[24].xyzw : cb0[26].xyzw;
        r5.xyzw = r2.xxzz ? cb0[25].xyxy : cb0[27].xyxy;
        r0.w = r0.x * cb0[23].x + -r4.x;
        r0.w = r0.w * r4.z;
        r1.y = cmp(0 < r0.w);
        r0.w = log2(r0.w);
        r0.w = r5.y * r0.w;
        ...
        r0.w = r1.w ? r1.z : r0.w;
        r4.x = cb0[30].y * r0.w;
        r2.xyzw = r2.zzzz ? cb0[24].xyzw : cb0[26].xyzw;
        r0.w = r0.y * cb0[23].x + -r2.x;
        r0.w = r0.w * r2.z;
        r1.y = cmp(0 < r0.w);
        r0.w = log2(r0.w);
        r0.w = r5.w * r0.w;
        ...
        r0.w = r1.w ? r1.z : r0.w;
        r4.y = cb0[30].y * r0.w;
        r2.xyzw = r1.xxxx ? cb0[24].xyzw : cb0[26].xyzw;
        r1.xy = r1.xx ? cb0[25].xy : cb0[27].xy;
        r0.w = r0.z * cb0[23].x + -r2.x;
        r0.w = r0.w * r2.z;
        r1.z = cmp(0 < r0.w);
        r0.w = log2(r0.w);
        r0.w = r1.y * r0.w;
      ...
      r0.w = r1.x ? r0.w : 0;
      r0.x = r0.w * r3.w + r3.y;
      r3.xyzw = r2.wwww ? cb0[26].xyzw : cb0[28].xyzw;
      r2.xyzw = r2.zzzz ? cb0[24].xyzw : r3.xyzw;
      r0.w = r0.y * cb0[23].x + -r2.x;
      r0.w = r0.w * r2.z;
      r1.x = cmp(0 < r0.w);
      r0.w = log2(r0.w);
      ...
      r0.y = r0.w * r2.w + r2.y;
      r1.xy = cmp(r1.zz < cb0[23].yz);
      r2.xyzw = r1.yyyy ? cb0[26].xyzw : cb0[28].xyzw;
      r1.yz = r1.yy ? cb0[27].xy : cb0[29].xy;
      r2.xyzw = r1.xxxx ? cb0[24].xyzw : r2.xyzw;
      r1.xy = r1.xx ? cb0[25].xy : r1.yz;
      r0.w = r0.z * cb0[23].x + -r2.x;
      r0.w = r0.w * r2.z;
      r1.z = cmp(0 < r0.w);
      r0.w = log2(r0.w);
