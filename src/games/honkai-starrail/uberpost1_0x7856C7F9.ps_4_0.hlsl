#include "./common.hlsl"
// ---- Created with 3Dmigoto v1.4.1 on Sat Dec 28 18:33:43 2024
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xy = cb0[388].zw + -v1.xy;
  r1.xy = cb0[388].xx * r1.xy;
  r1.xy = r1.xy * cb0[388].yy + v1.xy;
  r2.xyzw = t5.Sample(s0_s, v1.xy).xyzw;
  r1.yz = -cb0[388].zw + r1.xy;
  r1.x = cb0[389].z * r1.y;
