...
bool HandleUICompositing(float4 ui_color_gamma, float4 scene_color_pq, inout float4 output_color, uint output_mode = 0u, bool skip_swapchain = false) {
  ...
  output_mode = 1u;  // We're using scRGB
