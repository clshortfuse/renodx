...
// ---- Created with 3Dmigoto v1.4.1 on Tue Aug 12 17:00:22 2025
...
void main(
  ...
  r5.w = r5.w + -r4.w;
#if 1
  ApplyFilmicToneMap(r5.rgb, preRRT);
  r1.rgb = r5.rgb;
#else
  r5.xyz = log2(r5.xyz);
  ...
  SampleLUTUpgradeToneMap(untonemapped, s0_s, s1_s, t0, t1, r1.rgb);
