...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .labels = {"Vanilla HDR", "Vanilla SDR in HDR", "RenoDX"},
    ...
    new renodx::utils::settings::Setting{
        ...
        .section = "Tone Mapping",
        .tooltip = "Emulates SDR gamma options.",
        .labels = {"Off", "2.2"},
        .is_enabled = []() { return RENODX_TONE_MAP_TYPE > 1; },
    ...
    // },
        ...
        .min = 0.f,
        .max = 100.f,
        .is_enabled = []() { return RENODX_TONE_MAP_TYPE > 1 && SCENE_GRADE_PER_CHANNEL_BLOWOUT > 0.f; },
        .parse = [](float value) { return value * 0.01f; },
        .is_visible = []() { return settings[0]->GetValue() >= 1.f; },
    },
            new renodx::utils::settings::Setting{
        .key = "SceneGradeColorGradeStrength",
        .binding = &shader_injection.scene_grade_color_grade_strength,
        .default_value = 100.f,
        .label = "Color Grade Strength",
        .section = "Scene Grading",
        .tooltip = "Controls the strength of the color grading effect.",
        .min = 0.f,
        .max = 100.f,
        //.is_enabled = []() { return RENODX_TONE_MAP_TYPE > 1; },
        .parse = [](float value) { return value * 0.01f; },
    ...
    new renodx::utils::settings::Setting{
        .key = "SceneGradeSkipAces",
        .binding = &shader_injection.scene_grade_skip_aces,
        .value_type = renodx::utils::settings::SettingValueType::INTEGER,
        .default_value = 0.f,
        .label = "Skip ACES",
        .section = "Scene Grading",
        .tooltip = "Skips the ACES componenet of color grading.",
        .labels = {"Off", "On"},
        //.is_enabled = []() { return RENODX_TONE_MAP_TYPE > 1; },
        .is_visible = []() { return settings[0]->GetValue() >= 1; },
    },
    ...
    //     .label = "LUT Shaper",
    //     .section = "Advanced",
    //     .tooltip = "Changes LUT encoding, no reason to mess with this really",
    //     .labels = {"Square Root", "PQ"},
    //     //.is_enabled = []() { return RENODX_TONE_MAP_TYPE > 1; },
    //     .is_visible = []() { return settings[0]->GetValue() >= 1; },
    // },
    // new renodx::utils::settings::Setting{
...
void OnPresetOff() {
  ...
  renodx::utils::settings::UpdateSetting("LUTShaper", 0.f);
  renodx::utils::settings::UpdateSetting("SceneGradeColorGradeStrength", 100.f);
    renodx::utils::settings::UpdateSetting("SceneGradeSkipAces", 0.f);
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Days Gone";
