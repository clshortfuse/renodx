...
// ---- Created with 3Dmigoto v1.4.1 on Mon Mar  9 16:44:49 2026
  ...
  out float4 o0 : SV_Target0)
{
  ...
  // r0.xyz = sqrt(r0.xyz);
  r0.xyz = LutEncode(r0.xyz);

  r0.xyz = r0.xyz * float3(0.96875,0.96875,0.96875) + float3(0.015625,0.015625,0.015625);
  r0.xyz = t5.SampleLevel(s0_s, r0.xyz, 0).xyz;

  // r2.xyz = r0.xyz * r0.xyz;
  r2.xyz = LutDecode(r0.xyz);
  // end lut sampling

  float3 graded = r2.xyz;
  r2.xyz = lerp(ungraded, graded, SCENE_GRADE_COLOR_GRADE_STRENGTH);
  ...
  float vanilla_scale = cb0[7].y;
  r0.xyz = RENODX_TONE_MAP_TYPE == 0.f ? r0.xyz * vanilla_scale : r0.xyz;
  //r0.xyz = cb0[7].yyy * r0.xyz; // brightness scaling
  ...
  o0.xyz = sqrt(r0.xyz); // output encoding
