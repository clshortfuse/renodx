...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX (Hearts of Iron IV)";
  ...
  switch (fdw_reason) {
    case DLL_PROCESS_ATTACH:
      ...
      if (!initialized) {
        ...
        renodx::utils::settings::useRenoDXHelper = true;
