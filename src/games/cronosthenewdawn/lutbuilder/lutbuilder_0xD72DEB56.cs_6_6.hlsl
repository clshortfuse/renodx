...
void main(
  ...
  float CCWeightShadows = 1.0f - _578;
  float _687 = saturate((_441 - ColorCorrectionHighlightsMin) / (ColorCorrectionHighlightsMax - ColorCorrectionHighlightsMin));
  float CCWeightHighlights = (_687 * _687) * (3.0f - (_687 * 2.0f));
  float CCWeightMidtones = _578 - CCWeightHighlights;
  ...
  if (bIsHDR) {
    float4 output;
    if (GenerateOutput(_1216, _1217, _1218, output, OutputDevice)) {
