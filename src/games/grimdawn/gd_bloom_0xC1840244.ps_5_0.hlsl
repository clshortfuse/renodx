...
Texture2D<float4> textureSampler0 : register(t0);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyz = textureSampler0.Sample(textureSampler0_s, w1.xy).xyz;
  r0.xyz = float3(0.25,0.25,0.25) * r0.xyz;
  r1.xyz = textureSampler0.Sample(textureSampler0_s, v1.xy).xyz;
  r0.xyz = r1.xyz * float3(0.25,0.25,0.25) + r0.xyz;
  r1.xyz = textureSampler0.Sample(textureSampler0_s, v2.xy).xyz;
  r0.xyz = r1.xyz * float3(0.25,0.25,0.25) + r0.xyz;
  r1.xyz = textureSampler0.Sample(textureSampler0_s, w2.xy).xyz;
  r0.xyz = r1.xyz * float3(0.25,0.25,0.25) + r0.xyz;
