...
renodx::mods::shader::CustomShaders custom_shaders = {
    ...
    CustomShaderEntry(0x6EA48EC8),  // LUT3DBaker (ACES)
    CustomShaderEntryCallback(0x6BE60185, [](reshade::api::command_list* cmd_list) {  // uberpost (bloom + grain)
    is_bloom_enabled = true;
    is_grain_enabled = true;
    return true;
    }),
    CustomShaderEntryCallback(0x728A5929, [](reshade::api::command_list* cmd_list) {  // uberpost (title menu)
    is_bloom_enabled = true;
    is_grain_enabled = false;
    return true;
    }),
    CustomShaderEntryCallback(0x6D14F22A, [](reshade::api::command_list* cmd_list) {  // uberpost 2 (bloom + grain + dither)
    is_bloom_enabled = true;
    is_grain_enabled = true;
    return true;
    }),
    CustomShaderEntryCallback(0x18DC6A24, [](reshade::api::command_list* cmd_list) {  // uberpost 3 (grain + dither)
    is_bloom_enabled = false;
    is_grain_enabled = true;
    return true;
    }),
    CustomShaderEntryCallback(0xC63B24BB, [](reshade::api::command_list* cmd_list) {  // uberpost 4 (grain)
    is_bloom_enabled = false;
    is_grain_enabled = true;
    return true;
    }),
    CustomShaderEntryCallback(0x7E2A04D8, [](reshade::api::command_list* cmd_list) {  // uberpost 5 (bloom + dither)
    is_bloom_enabled = true;
    is_grain_enabled = false;
    return true;
    }),
    CustomShaderEntryCallback(0x957EC72A, [](reshade::api::command_list* cmd_list) {  // uberpost 6 (bloom FXAA/SMAA)
    is_bloom_enabled = true;
    is_grain_enabled = false;
    return true;
    }),
    CustomShaderEntryCallback(0x272EB112, [](reshade::api::command_list* cmd_list) {  // uberpost 7 (dither)
    is_bloom_enabled = false;
    is_grain_enabled = false;
    return true;
    }),
    CustomShaderEntryCallback(0xDB814E6C, [](reshade::api::command_list* cmd_list) {  // uberpost 8
    is_bloom_enabled = false;
    is_grain_enabled = false;
    return true;
    }),
...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .on_change = []() {
            ...
            renodx::utils::settings::UpdateSetting("colorGradeExposure", 1.f);
            renodx::utils::settings::UpdateSetting("colorGradeHighlights", 50.f);
            renodx::utils::settings::UpdateSetting("colorGradeShadows", 38.f);
