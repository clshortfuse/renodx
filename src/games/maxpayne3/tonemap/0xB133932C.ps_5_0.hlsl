// ---- Created with 3Dmigoto v1.4.1 on Fri Mar 14 15:41:36 2025
#include "../common.hlsl"
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r4.xy = (int2)r0.xz;
  r4.zw = float2(0,0);
  r0.xzw = PostFxTexture0a.Load(r4.xy, 0).xyz;
  r5.xyz = PostFxTexture0a.Load(r4.xy, 1).xyz;
  r0.xzw = r5.xyz + r0.xzw;
  r5.xyz = PostFxTexture0a.Load(r4.xy, 2).xyz;
  r0.xzw = r5.xyz + r0.xzw;
  r4.xyz = PostFxTexture0a.Load(r4.xy, 3).xyz;
  r0.xzw = r4.xyz + r0.xzw;
  r0.xzw = ColorFringeParams2.xyz * r0.xzw;
  r1.xyz = ColorFringeParams2.xyz * r1.xyz;
  r0.xzw = r0.xzw * float3(0.25,0.25,0.25) + -r1.xyz;
  ...
  r0.xzw = r1.yzw * float3(0.25,0.25,0.25) + r0.xzw;
  r1.y = dot(r0.xzw, float3(1,1,1));
  r1.y = -1.5 + r1.y;
  r1.y = max(0, r1.y);
  r1.z = DruggedEffectParams.z + 0.100000001;
  r3.y = DruggedEffectParams.w * r1.z;
  r1.z = -0.5 + v1.x;
  r1.z = -r1.z * r3.y;
  r1.w = 2 + r1.y;
  r3.x = r1.z * r1.w;
  r1.zw = v1.xy + r3.xy;
  r4.xyz = BlurSampler.Sample(BlurSampler_s, r1.zw).xyz;
  r1.zw = r1.zw + r3.xy;
  r3.xyz = BlurSampler.Sample(BlurSampler_s, r1.zw).xyz;
  r1.z = dot(r4.xyz, float3(1,1,1));
  r1.z = -1.5 + r1.z;
  r1.w = dot(r3.xyz, float3(1,1,1));
  r1.w = -1.5 + r1.w;
  r1.zw = max(float2(0,0), r1.zw);
  r2.w = r1.z + r1.w;
  r2.w = DruggedEffectParams.z * r2.w;
  r2.w = 0.5 * r2.w;
  r3.xyz = max(r4.xyz, r3.xyz);
  r3.xyz = DruggedEffectColorShift.xyz * r3.xyz;
  r3.xyz = DruggedEffectParams.zzz * r3.xyz;
  r3.xyz = r3.xyz + r3.xyz;
  r0.xzw = max(r3.xyz, r0.xzw);
  r3.x = r1.y + -r1.z;
  r1.yz = r1.yz + -r1.ww;
  r1.y = abs(r3.x) + abs(r1.y);
  r1.y = r1.y + abs(r1.z);
  r1.y = DruggedEffectParams.x * r1.y;
  r1.y = min(r2.w, r1.y);
  r1.y = r2.z * r2.w + -r1.y;
  r1.y = min(1, r1.y);
  r0.xzw = r1.yyy + r0.xzw;
  r0.xzw = max(float3(0,0,0), r0.xzw);
  r1.yzw = r0.yyy * ColorCorrectBottomOffset.xyz + ColorCorrectTopAndPedReflectScale.xyz;
