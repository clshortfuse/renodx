  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.w = cmp(r0.w < 1);
  r2.x = -motionBlurMatrix._m32 * dofProj.z;
  r2.z = motionBlurMatrix._m32 * dofProj.w;
  r2.xy = motionBlurMatrix._m30_m31 / r2.xz;
  ...
  r4.xyz = HDRPointSampler.Sample(HDRPointSampler_s, r2.xy).xyz;
  r4.xyz = r4.xyz + -r0.xyz;
  r3.xyz = r4.xyz * r3.xyz + r0.xyz;
  r1.zw = -ColorFringeParams2.ww * globalScreenSize.zz + v1.xy;
  r4.xyz = ColorFringeParams2.xyz * r0.www;
  r5.xyz = HDRPointSampler.Sample(HDRPointSampler_s, r1.zw).xyz;
