// ---- Created with 3Dmigoto v1.4.1 on Fri Mar 14 15:41:12 2025
#include "../common.hlsl"
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xzw = r5.xyz + r0.xzw;
  r5.xyz = PostFxTexture0a.Load(r4.xy, 3).xyz;
  r0.xzw = r5.xyz + r0.xzw;
  r5.xyz = PostFxTexture0a.Load(r4.xy, 4).xyz;
  r0.xzw = r5.xyz + r0.xzw;
  r5.xyz = PostFxTexture0a.Load(r4.xy, 5).xyz;
  r0.xzw = r5.xyz + r0.xzw;
  r5.xyz = PostFxTexture0a.Load(r4.xy, 6).xyz;
  r0.xzw = r5.xyz + r0.xzw;
  r4.xyz = PostFxTexture0a.Load(r4.xy, 7).xyz;
  r0.xzw = r4.xyz + r0.xzw;
  r0.xzw = ColorFringeParams2.xyz * r0.xzw;
  r1.xyz = ColorFringeParams2.xyz * r1.xyz;
  r0.xzw = r0.xzw * float3(0.125,0.125,0.125) + -r1.xyz;
