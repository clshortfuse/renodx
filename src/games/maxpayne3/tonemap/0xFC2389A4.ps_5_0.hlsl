// ---- Created with 3Dmigoto v1.4.1 on Fri Mar 14 15:41:53 2025
#include "../common.hlsl"
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xy = cmp(v1.xy >= NoiseFilterArea.xz);
  r1.zw = cmp(NoiseFilterArea.yw >= v1.xy);
  r2.xyzw = r1.xyzw ? float4(1,1,1,1) : 0;
  r1.xy = r2.xz * r2.yw;
  r0.w = r1.x * r1.y;
  r0.w = cmp(r0.w != 0.000000);
  r1.xy = v1.xy * float2(3.20000005,1.79999995) + NoiseParams.xy;
  r1.xy = frac(r1.xy);
  r1.x = BlurSampler.Sample(BlurSampler_s, r1.xy).z;
  if (r0.w != 0) {
    r0.w = -0.5 + r1.x;
    r1.xyz = r0.www * NoiseParams.zzz + r0.xyz;
