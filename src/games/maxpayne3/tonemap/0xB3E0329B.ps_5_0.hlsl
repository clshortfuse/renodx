// ---- Created with 3Dmigoto v1.4.1 on Fri Mar 14 15:41:37 2025
#include "../common.hlsl"
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyz = r2.xyz + r1.xyz;
  r2.xyz = PostFxTexture0a.Load(r0.xy, 3).xyz;
  r1.xyz = r2.xyz + r1.xyz;
  r2.xyz = PostFxTexture0a.Load(r0.xy, 4).xyz;
  r1.xyz = r2.xyz + r1.xyz;
  r2.xyz = PostFxTexture0a.Load(r0.xy, 5).xyz;
  r1.xyz = r2.xyz + r1.xyz;
  r2.xyz = PostFxTexture0a.Load(r0.xy, 6).xyz;
  r1.xyz = r2.xyz + r1.xyz;
  ...
  r1.z = cmp(r0.w < 1);
  if (r1.z != 0) {
    r1.z = -motionBlurMatrix._m32 * dofProj.z;
    r2.x = motionBlurMatrix._m30 / r1.z;
    r1.z = motionBlurMatrix._m32 * dofProj.w;
    r2.y = motionBlurMatrix._m31 / r1.z;
    r1.zw = v1.xy * float2(2,2) + float2(-1,-1);
    r1.zw = r2.xy + -r1.zw;
    r1.zw = ImageFXParams.yy * r1.zw;
    r1.zw = float2(0.125,0.125) * r1.zw;
    r1.zw = r0.ww * -r1.zw + r1.zw;
    ...
    r2.zw = r1.zw * float2(2,2) + v1.xy;
    r2.zw = r2.zw * r2.xy;
    r4.xy = (int2)r2.zw;
    r4.zw = float2(0,0);
    r4.xyz = PostFxDOFTexture.Load(r4.xy, 0).xyz;
    r3.xyz = r4.xyz + r3.xyz;
    r4.xyzw = r1.zwzw * float4(3,3,4,4) + v1.xyxy;
    r4.xyzw = r4.xyzw * r2.xyxy;
    ...
    r4.xyz = PostFxDOFTexture.Load(r4.xy, 0).xyz;
    r3.xyz = r4.xyz + r3.xyz;
    r4.xyzw = r1.zwzw * float4(5,5,6,6) + v1.xyxy;
    r4.xyzw = r4.xyzw * r2.xyxy;
    r4.xyzw = (int4)r4.zwxy;
    r5.xy = r4.zw;
    r5.zw = float2(0,0);
    ...
    r4.xyz = PostFxDOFTexture.Load(r4.xy, 0).xyz;
    r3.xyz = r4.xyz + r3.xyz;
    r1.zw = r1.zw * float2(7,7) + v1.xy;
    r1.zw = r1.zw * r2.xy;
    r2.xy = (int2)r1.zw;
    r2.zw = float2(0,0);
    r2.xyz = PostFxDOFTexture.Load(r2.xy, 0).xyz;
    r2.xyz = r3.xyz + r2.xyz;
    r0.xyz = float3(0.125,0.125,0.125) * r2.xyz;
  }
