// ---- Created with 3Dmigoto v1.4.1 on Fri Mar 14 15:41:00 2025
#include "../common.hlsl"
...
Texture2DMS<uint4> StencilCopyTexture : register(t8);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.yzw = float3(0.125,0.125,0.125) * r0.yzw;
  ...
  r1.xyz = v1.yxy * float3(2,2,2) + float3(-1,-1,-1);
  r1.w = dofProj.z * r1.y;
  r1.x = dofProj.w * -r1.x;
  r1.xw = r1.xw * r0.xx;
  r2.xyz = motionBlurMatrix._m10_m11_m12 * r1.xxx;
  r2.xyz = r1.www * motionBlurMatrix._m00_m01_m02 + r2.xyz;
  r2.xyz = -r0.xxx * motionBlurMatrix._m20_m21_m22 + r2.xyz;
  r2.xyz = motionBlurMatrix._m30_m31_m32 + r2.xyz;
  r0.x = dofProj.z * -r2.z;
  r3.x = r2.x / r0.x;
  r0.x = dofProj.w * r2.z;
  r3.y = r2.y / r0.x;
  r1.xy = r3.xy + -r1.yz;
  r1.xy = DirectionalMotionBlurLength * r1.xy;
  r1.zw = float2(0.166666672,0.166666672) * r1.xy;
  PostFxDOFTexture.GetDimensions(fDest.x, fDest.y, fDest.z);
  r2.xy = fDest.xy;
  r2.zw = v1.xy * r2.xy;
  r3.xy = (int2)r2.zw;
  r3.zw = float2(0,0);
  r0.x = StencilCopyTexture.Load(r3.xy, 0).y;
  r0.x = cmp(128 >= (uint)r0.x);
  ...
  while (true) {
    ...
    if (r2.w != 0) break;
    r2.w = (int)r2.z;
    r5.xy = r1.zw * r2.ww + v1.xy;
    r5.xy = r5.xy * r2.xy;
    r3.xy = (int2)r5.xy;
    r5.xyz = PostFxDOFTexture.Load(r3.xy, 0).xyz;
    r4.xyz = r5.xyz + r4.xyz;
    r2.z = (int)r2.z + 1;
  }
  r1.xy = globalScreenSize.xy * r1.xy;
  r1.x = dot(r1.xy, r1.xy);
  r1.x = sqrt(r1.x);
  r1.x = 0.5 * r1.x;
  r1.x = min(1, r1.x);
  r0.x = r1.x * r0.x;
  r1.xyz = r4.xyz * float3(0.142857149,0.142857149,0.142857149) + -r0.yzw;
  ...
  r1.xyz = ToneMapParams.zzz * r1.xyz;
  ...
  r1.x = -0.999989986 + deSatContrastGamma.z;
  r0.w = log2(r0.w);
  r0.w = r1.x * r0.w;
  r0.w = exp2(r0.w);
  r0.w = min(65000, r0.w);
