  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xy = (int2)r0.xz;
  r1.zw = float2(0,0);
  r0.xzw = PostFxTexture0a.Load(r1.xy, 0).xyz;
  r2.xyz = PostFxTexture0a.Load(r1.xy, 1).xyz;
  r0.xzw = r2.xyz + r0.xzw;
  r2.xyz = PostFxTexture0a.Load(r1.xy, 2).xyz;
  r0.xzw = r2.xyz + r0.xzw;
  r2.xyz = PostFxTexture0a.Load(r1.xy, 3).xyz;
  r0.xzw = r2.xyz + r0.xzw;
  r2.xyz = PostFxTexture0a.Load(r1.xy, 4).xyz;
  r0.xzw = r2.xyz + r0.xzw;
  r2.xyz = PostFxTexture0a.Load(r1.xy, 5).xyz;
  r0.xzw = r2.xyz + r0.xzw;
  r2.xyz = PostFxTexture0a.Load(r1.xy, 6).xyz;
  r0.xzw = r2.xyz + r0.xzw;
  r1.xyz = PostFxTexture0a.Load(r1.xy, 7).xyz;
  r0.xzw = r1.xyz + r0.xzw;
  r0.xzw = float3(0.125,0.125,0.125) * r0.xzw;
