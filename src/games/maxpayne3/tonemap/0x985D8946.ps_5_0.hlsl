  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.yzw = r0.yzw * float3(0.125,0.125,0.125) + -r1.xyz;
  ...
  r1.x = -1.5 + r1.x;
  r1.x = max(0, r1.x);
  r1.y = DruggedEffectParams.z + 0.100000001;
  r3.y = DruggedEffectParams.w * r1.y;
  r1.y = -0.5 + v1.x;
  r1.y = -r1.y * r3.y;
  r1.z = 2 + r1.x;
  r3.x = r1.y * r1.z;
  r1.yz = v1.xy + r3.xy;
  r4.xyz = BlurSampler.Sample(BlurSampler_s, r1.yz).xyz;
  r1.yz = r1.yz + r3.xy;
  r3.xyz = BlurSampler.Sample(BlurSampler_s, r1.yz).xyz;
  ...
  r2.z = r1.y + r1.z;
  r2.z = DruggedEffectParams.z * r2.z;
  r2.z = 0.5 * r2.z;
  ...
  r2.w = r1.x + -r1.y;
  r1.xy = r1.xy + -r1.zz;
  r1.x = abs(r2.w) + abs(r1.x);
  r1.x = r1.x + abs(r1.y);
  r1.x = DruggedEffectParams.x * r1.x;
  r1.x = min(r2.z, r1.x);
  r1.x = r1.w * r2.z + -r1.x;
  r1.x = min(1, r1.x);
