// ---- Created with 3Dmigoto v1.4.1 on Tue Mar 11 03:27:10 2025
#include "../common.hlsl"
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.x = r0.x + -r0.y;
  r0.x = r0.z / r0.x;
  r0.y = -HeatHazeParams.x + r0.x;
  r0.y = max(0, r0.y);
  r0.y = saturate(r0.y / HeatHazeParams.y);
  ...
  r0.x = 1 + -r0.x;
  r0.x = r0.y * r0.x;
  r0.yz = v1.xy * HeatHazeTex1Params.xy + HeatHazeTex1Params.zw;
  r1.xy = v1.xy * HeatHazeTex2Params.xy + HeatHazeTex2Params.zw;
  r0.yz = HeatHazeSampler.Sample(HeatHazeSampler_s, r0.yz).xy;
  r1.xy = HeatHazeSampler.Sample(HeatHazeSampler_s, r1.xy).xy;
  r0.yz = r1.xy + r0.yz;
  r0.yz = float2(-1,-1) + r0.yz;
  r0.yz = HeatHazeOffsetParams.xy * r0.yz;
  r0.xy = r0.yz * r0.xx + v1.xy;
  r0.xzw = HDRPointSampler.Sample(HDRPointSampler_s, r0.xy).xyz;
  ...
  if (r1.x != 0) {
    ...
    r0.xzw = r0.xzw * radialBlurScale + r1.xyz;
  }
  r1.x = cmp(0 != blurIntensity);
  if (r1.x != 0) {
    r1.xyz = BlurSampler.Sample(BlurSampler_s, v1.xy).xyz;
    r1.xyz = r1.xyz + -r0.xzw;
    r0.xzw = blurIntensity * r1.xyz + r0.xzw;
  }
  r1.xyz = DeathSampler.Sample(DeathSampler_s, w1.xy).xzw;
  r1.w = ColorFringeParams1.w / globalScreenSize.x;
  r2.xy = v1.xy + -r1.ww;
  r1.z = 1 + -r1.z;
  r3.xyz = ColorFringeParams1.xyz * r1.zzz;
  r2.xyz = HDRPointSampler.Sample(HDRPointSampler_s, r2.xy).xyz;
  r2.xyz = r2.xyz + -r0.xzw;
  r2.xyz = r2.xyz * r3.xyz + r0.xzw;
  r3.xy = -ColorFringeParams2.ww * globalScreenSize.zz + v1.xy;
  r4.xyz = ColorFringeParams2.xyz * r1.zzz;
  r3.xyz = HDRPointSampler.Sample(HDRPointSampler_s, r3.xy).xyz;
  r0.xzw = r3.xyz + -r0.xzw;
  r0.xzw = r0.xzw * r4.xyz + r2.xyz;
  r1.z = AdapLumSampler.Sample(AdapLumSampler_s, float2(0,0)).x;
  r1.z = 9.99999997e-07 + r1.z;
  r1.z = ToneMapParams.y / r1.z;
  r2.xyz = BloomSampler.Sample(BloomSampler_s, v1.xy).xyz;
  r1.w = ToneMapParams.w + -ToneMapParams.z;
  r1.w = r1.x * r1.w + ToneMapParams.z;
  r2.xyz = r2.xyz * r1.www;
  r0.xzw = r2.xyz * float3(0.25,0.25,0.25) + r0.xzw;
  r2.x = dot(r0.xzw, float3(1,1,1));
  r2.x = -1.5 + r2.x;
  r2.x = max(0, r2.x);
  r2.y = DruggedEffectParams.z + 0.100000001;
  r3.y = DruggedEffectParams.w * r2.y;
  r2.y = -0.5 + v1.x;
  r2.y = -r2.y * r3.y;
  r2.z = 2 + r2.x;
  r3.x = r2.y * r2.z;
  r2.yz = v1.xy + r3.xy;
  r4.xyz = BlurSampler.Sample(BlurSampler_s, r2.yz).xyz;
  r2.yz = r2.yz + r3.xy;
  r2.yzw = BlurSampler.Sample(BlurSampler_s, r2.yz).xyz;
  r3.x = dot(r4.xyz, float3(1,1,1));
  r3.x = -1.5 + r3.x;
  r3.y = dot(r2.yzw, float3(1,1,1));
  r3.y = -1.5 + r3.y;
  r3.xy = max(float2(0,0), r3.xy);
  r3.z = r3.x + r3.y;
  r3.z = DruggedEffectParams.z * r3.z;
  r3.z = 0.5 * r3.z;
  r2.yzw = max(r4.xyz, r2.yzw);
  r2.yzw = DruggedEffectColorShift.xyz * r2.yzw;
  r2.yzw = DruggedEffectParams.zzz * r2.yzw;
  r2.yzw = r2.yzw + r2.yzw;
  r0.xzw = max(r2.yzw, r0.xzw);
  r2.y = -r3.x + r2.x;
  r2.x = -r3.y + r2.x;
  r2.x = abs(r2.y) + abs(r2.x);
  r2.y = r3.x + -r3.y;
  r2.x = r2.x + abs(r2.y);
  r2.x = DruggedEffectParams.x * r2.x;
  r2.x = min(r3.z, r2.x);
  r1.w = r1.w * r3.z + -r2.x;
  r1.w = min(1, r1.w);
  r0.xzw = r1.www + r0.xzw;
  r0.xzw = max(float3(0,0,0), r0.xzw);
  r2.xyz = r0.yyy * ColorCorrectBottomOffset.xyz + ColorCorrectTopAndPedReflectScale.xyz;
  r0.xyz = r2.xyz * r0.xzw;
  r0.w = Exposures.y + -Exposures.x;
  r0.w = r1.x * r0.w + Exposures.x;
