// ---- Created with 3Dmigoto v1.4.1 on Fri Mar 14 15:41:04 2025
#include "../common.hlsl"
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r4.xyz = r5.xyz + r4.xyz;
  r3.xyz = PostFxTexture0a.Load(r3.xy, 3).xyz;
  r3.xyz = r4.xyz + r3.xyz;
  r3.xyz = ColorFringeParams1.xyz * r3.xyz;
  r4.xyz = ColorFringeParams1.xyz * r2.xyz;
  r3.xyz = r3.xyz * float3(0.25,0.25,0.25) + -r4.xyz;
  r3.xyz = r3.xyz + r2.xyz;
  r1.zw = -ColorFringeParams2.ww * globalScreenSize.zz + v1.xy;
  r1.xy = r1.xy * r1.zw;
  r1.xy = (int2)r1.xy;
  r1.zw = float2(0,0);
  r4.xyz = PostFxTexture0a.Load(r1.xy, 0).xyz;
  r5.xyz = PostFxTexture0a.Load(r1.xy, 1).xyz;
  r4.xyz = r5.xyz + r4.xyz;
  r5.xyz = PostFxTexture0a.Load(r1.xy, 2).xyz;
  r4.xyz = r5.xyz + r4.xyz;
  r1.xyz = PostFxTexture0a.Load(r1.xy, 3).xyz;
  r1.xyz = r4.xyz + r1.xyz;
  r1.xyz = ColorFringeParams2.xyz * r1.xyz;
  r2.xyz = ColorFringeParams2.xyz * r2.xyz;
