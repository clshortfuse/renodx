// ---- Created with 3Dmigoto v1.4.1 on Fri Mar 14 15:41:09 2025
#include "../common.hlsl"
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.zw = DeathSampler.Sample(DeathSampler_s, w1.xy).xz;
  r1.w = ColorFringeParams1.w / globalScreenSize.x;
  r2.xy = v1.xy + -r1.ww;
  r2.xy = r2.xy * r0.xy;
  r2.xy = (int2)r2.xy;
  r2.zw = float2(0,0);
  r3.xyz = PostFxTexture0a.Load(r2.xy, 0).xyz;
  r4.xyz = PostFxTexture0a.Load(r2.xy, 1).xyz;
  r3.xyz = r4.xyz + r3.xyz;
  r4.xyz = PostFxTexture0a.Load(r2.xy, 2).xyz;
  r3.xyz = r4.xyz + r3.xyz;
  r4.xyz = PostFxTexture0a.Load(r2.xy, 3).xyz;
  r3.xyz = r4.xyz + r3.xyz;
  r4.xyz = PostFxTexture0a.Load(r2.xy, 4).xyz;
  r3.xyz = r4.xyz + r3.xyz;
  r4.xyz = PostFxTexture0a.Load(r2.xy, 5).xyz;
  r3.xyz = r4.xyz + r3.xyz;
  r4.xyz = PostFxTexture0a.Load(r2.xy, 6).xyz;
  r3.xyz = r4.xyz + r3.xyz;
  r2.xyz = PostFxTexture0a.Load(r2.xy, 7).xyz;
  r2.xyz = r3.xyz + r2.xyz;
  r2.xyz = ColorFringeParams1.xyz * r2.xyz;
  r3.xyz = ColorFringeParams1.xyz * r1.xyz;
  r2.xyz = r2.xyz * float3(0.125,0.125,0.125) + -r3.xyz;
  r2.xyz = r2.xyz + r1.xyz;
  ...
  r3.xyz = r4.xyz + r3.xyz;
  r3.xyz = ColorFringeParams2.xyz * r3.xyz;
  r1.xyz = ColorFringeParams2.xyz * r1.xyz;
  r1.xyz = r3.xyz * float3(0.125,0.125,0.125) + -r1.xyz;
  r1.xyz = r2.xyz + r1.xyz;
  r0.x = AdapLumSampler.Sample(AdapLumSampler_s, float2(0,0)).x;
  r0.x = 9.99999997e-07 + r0.x;
  r0.x = ToneMapParams.y / r0.x;
  r2.xyz = BloomSampler.Sample(BloomSampler_s, v1.xy).xyz;
  r0.y = ToneMapParams.w + -ToneMapParams.z;
  r0.y = r0.z * r0.y + ToneMapParams.z;
  r2.xyz = r2.xyz * r0.yyy;
  r1.xyz = r2.xyz * float3(0.25,0.25,0.25) + r1.xyz;
  r1.w = dot(r1.xyz, float3(1,1,1));
  r1.w = -1.5 + r1.w;
  r1.w = max(0, r1.w);
  r2.x = DruggedEffectParams.z + 0.100000001;
  r2.y = DruggedEffectParams.w * r2.x;
  r2.z = -0.5 + v1.x;
  r2.z = -r2.z * r2.y;
  r2.w = 2 + r1.w;
  r2.x = r2.z * r2.w;
  r2.zw = v1.xy + r2.xy;
  r3.xyz = BlurSampler.Sample(BlurSampler_s, r2.zw).xyz;
  r2.xy = r2.zw + r2.xy;
  r2.xyz = BlurSampler.Sample(BlurSampler_s, r2.xy).xyz;
  r2.w = dot(r3.xyz, float3(1,1,1));
  r2.w = -1.5 + r2.w;
  r2.w = max(0, r2.w);
  r3.w = dot(r2.xyz, float3(1,1,1));
  r3.w = -1.5 + r3.w;
  r3.w = max(0, r3.w);
  r4.x = r3.w + r2.w;
  r4.x = DruggedEffectParams.z * r4.x;
  r4.x = 0.5 * r4.x;
  r2.xyz = max(r3.xyz, r2.xyz);
  r2.xyz = DruggedEffectColorShift.xyz * r2.xyz;
  r2.xyz = DruggedEffectParams.zzz * r2.xyz;
  ...
  r2.x = -r3.w + r2.w;
  r1.w = abs(r2.x) + r1.w;
  r1.w = DruggedEffectParams.x * r1.w;
  r1.w = min(r4.x, r1.w);
  r0.y = r0.y * r4.x + -r1.w;
  r0.y = min(1, r0.y);
  ...
  r1.xyz = r2.xyz * r1.xyz;
  r0.y = Exposures.y + -Exposures.x;
  r0.y = r0.z * r0.y + Exposures.x;
  r1.xyz = r1.xyz * r0.yyy;
