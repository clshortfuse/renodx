// ---- Created with 3Dmigoto v1.4.1 on Fri Mar 14 15:41:49 2025
#include "../common.hlsl"
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r4.xyz = r5.xyz + r4.xyz;
  r5.xyz = PostFxTexture0a.Load(r1.xy, 3).xyz;
  r4.xyz = r5.xyz + r4.xyz;
  r5.xyz = PostFxTexture0a.Load(r1.xy, 4).xyz;
  r4.xyz = r5.xyz + r4.xyz;
  r5.xyz = PostFxTexture0a.Load(r1.xy, 5).xyz;
  r4.xyz = r5.xyz + r4.xyz;
  r5.xyz = PostFxTexture0a.Load(r1.xy, 6).xyz;
  r4.xyz = r5.xyz + r4.xyz;
  r1.xyz = PostFxTexture0a.Load(r1.xy, 7).xyz;
  r1.xyz = r4.xyz + r1.xyz;
  r1.xyz = ColorFringeParams2.xyz * r1.xyz;
  r2.xyz = ColorFringeParams2.xyz * r2.xyz;
  r1.xyz = r1.xyz * float3(0.125,0.125,0.125) + -r2.xyz;
