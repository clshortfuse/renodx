// ---- Created with 3Dmigoto v1.4.1 on Fri Mar 14 15:41:29 2025
#include "../common.hlsl"
...
Texture2D<uint4> StencilCopyTexture : register(t8);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  StencilCopyTexture.GetDimensions(0, fDest.x, fDest.y, fDest.z);
  r2.xy = fDest.xy;
  r2.xy = v1.xy * r2.xy;
  r2.xy = (int2)r2.xy;
  r2.zw = float2(0,0);
  r0.x = StencilCopyTexture.Load(r2.xyz).y;
  ...
  r1.x = min(1, r1.x);
  r0.x = r1.x * r0.x;
  r1.xyz = r2.xyz * float3(0.142857149,0.142857149,0.142857149) + -r0.yzw;
