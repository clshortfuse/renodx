  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xyz = RenderPointMapMSAA.Load(r0.xy, 3).xyz;
  r1.xyzw = r2.xyzx + r1.xyzw;
  r2.xyz = RenderPointMapMSAA.Load(r0.xy, 4).xyz;
  r1.xyzw = r2.xyzx + r1.xyzw;
  r2.xyz = RenderPointMapMSAA.Load(r0.xy, 5).xyz;
  r1.xyzw = r2.xyzx + r1.xyzw;
  r2.xyz = RenderPointMapMSAA.Load(r0.xy, 6).xyz;
  r0.xyz = RenderPointMapMSAA.Load(r0.xy, 7).xyz;
  r1.xyzw = r2.xyzx + r1.xyzw;
  r0.xyzw = r1.xyzw + r0.xyzx;
  r1.xyz = -r0.xyz * float3(0.125,0.125,0.125) + float3(1,1,1);
  r0.xyzw = float4(0.125,0.125,0.125,0.0009765625) * r0.xyzw;
