...
void main(uint3 vThreadID : SV_DispatchThreadID)
{
  ...
  r2.z = cb1[3].x * r2.z;
  r2.z = ceil(r2.z);
  r2.z = max((shader_injection.improved_ssr >= 0.5f) ? 256 : 32, r2.z);
  r4.w = cmp(r2.w >= 0.300000012);
  r5.w = 0.125 * r2.z;
  r2.z = r4.w ? r5.w : r2.z;
  r3.w = -r3.y;
  ...
  r2.xz = t2.SampleLevel(s0_s, r0.zw, 0).xy;
  r3.xy = abs(r2.xz) * float2(2,2) + float2(-1,-1);
  r3.xy = r3.xy * r3.xy;
  r0.y = 2 / r2.y;
  r0.y = -1 + r0.y;
  r0.y = 1 / r0.y;
  ...
  r2.w = sqrt(r2.w);
  r3.w = cmp(abs(r4.z) < 0.999000013);
  r9.z = r3.w ? 0 : 1;
  r9.y = r3.w ? 1.000000 : 0;
  r9.x = 0;
  r10.xyz = r9.xyz * r4.xyz;
  r9.xyz = r9.zxy * r4.yzx + -r10.xyz;
  ...
  r10.yzw = r9.xyz * r4.xyz;
  r4.xyz = r4.zxy * r9.yzx + -r10.yzw;
  ...
  r3.xy = cmp(float2(0,0) < r2.xz);
  r2.xz = cmp(r2.xz < float2(0,0));
  r2.xz = (int2)-r3.xy + (int2)r2.xz;
  r2.xz = (int2)r2.xz;
  r0.yz = r0.yz * r2.xz + r5.xy;
