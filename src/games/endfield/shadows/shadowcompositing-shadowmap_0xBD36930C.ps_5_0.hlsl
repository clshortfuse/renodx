  ...
  out float3 o0 : SV_Target0)
{
  ...
  if (r0.x != 0) {
    ...
    if (FAKE_CLOUD_SHADOWS >= 1.f) {
      ...
      if (r0.y != 0) {
        r0.yzw = -cb0[175].xyz + r2.xyz;
        r1.xy = cb0[178].xz * r0.zz + r0.yw;
        r1.zw = cb0[176].zz * r1.xy;
        r2.xy = cb0[185].ww * cb0[177].xy;
        r1.xy = r1.xy * cb0[176].zz + r2.xy;
        r0.z = t2.SampleLevel(s2_s, r1.xy, 0).x;
        r1.xy = r1.zw * cb0[177].ww + r2.xy;
        r1.x = t2.SampleLevel(s2_s, r1.xy, 0).x;
        r0.y = dot(r0.yw, r0.yw);
        r0.y = sqrt(r0.y);
        r0.w = cb0[176].y + -cb0[176].x;
        r0.y = -cb0[176].x + r0.y;
        r0.w = 1 / r0.w;
