  ...
  out float3 o0 : SV_Target0)
{
  ...
  if (r0.z != 0) {
    ...
    if (FAKE_CLOUD_SHADOWS >= 1.f) {
      ...
      if (r0.w != 0) {
        r4.xyz = -cb0[175].xyz + r2.xyz;
        r4.yw = cb0[178].xz * r4.yy + r4.xz;
        r5.xy = cb0[176].zz * r4.yw;
        r5.zw = cb0[185].ww * cb0[177].xy;
        r4.yw = r4.yw * cb0[176].zz + r5.zw;
        r0.w = t3.SampleLevel(s2_s, r4.yw, 0).x;
        r4.yw = r5.xy * cb0[177].ww + r5.zw;
        r2.w = t3.SampleLevel(s2_s, r4.yw, 0).x;
        r3.w = dot(r4.xz, r4.xz);
        r3.w = sqrt(r3.w);
        r4.x = cb0[176].y + -cb0[176].x;
        r3.w = -cb0[176].x + r3.w;
        r4.x = 1 / r4.x;
