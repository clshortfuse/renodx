...
if_nz r0.z
  ...
  mad_sat r23.w, r6.w, l(0.050000), l(-1.500000)
...
movc r11.xyw, cb13[14].zzzz, r11.xyzw, l(1.0, 1.0, 0, 1.0)
...
mov r22.w, r2.w  // Store ambient luminance for cubemap modulation
mov r5.w, l(1.000000)
