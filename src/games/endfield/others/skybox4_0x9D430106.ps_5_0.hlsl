  ...
  out float4 o1 : SV_Target1)
{
  ...
  r3.x = 1.57079637 * r1.z;
  r3.y = saturate(r1.z * 10 + 1);
  // ==========================================================================
  ...
  r3.z = saturate(dot(-cb2[44].xyz, -r1.yzw));  // Sun-view alignment (1 = looking at sun)
  r3.z = log2(r3.z);
  // Sun size adjustment: multiply exponent to shrink disk (5.0 = ~80% smaller)
  float sunSizeMultiplier = (SUN_INTENSITY > 0.5f) ? 5.0f : 1.0f;
  r3.z = cb2[43].x * sunSizeMultiplier * r3.z;   // Apply sun size exponent
  r3.z = exp2(r3.z);
  r3.w = r3.z * r3.z + 1;    // Soft falloff numerator
  r3.w = 0.0100164423 * r3.w;
  r3.z = -r3.z * 1.98000002 + 1.98010004;  // Soft falloff denominator
  r4.x = log2(cb2[42].w);     // Sun intensity
  r4.x = 0.649999976 * r4.x;
  r4.x = exp2(r4.x);
  r4.x = 8 * r4.x;
  r3.z = log2(r3.z);
  r3.z = r4.x * r3.z;
  r3.z = exp2(r3.z);
  r3.z = max(9.99999975e-005, r3.z);
  r3.z = r3.w / r3.z;        // Final sun disk intensity
  // ==========================================================================
  // EQUIRECTANGULAR SKYBOX UV CALCULATION (for t2: 4096x2048)
  // ==========================================================================
  r3.w = cb2[41].z * cb1[20].x;
  r4.xy = r3.ww * float2(20,20) + float2(0,0.5);
  r4.xy = frac(r4.xy);
  r4.xy = float2(-0.5,-0.5) + r4.xy;
  r3.x = sin(r3.x);
  r5.xz = cb2[41].xy * r3.xx;
  r5.y = 0;
  r3.x = cb2[41].w * 0.0174532942;
  sincos(r3.x, r3.x, r6.x);
  r7.x = -r3.x;
  r7.y = r6.x;
  r6.x = dot(r7.yx, r1.yw);
  r7.z = r3.x;
  r6.z = dot(r7.zy, r1.yw);
  r6.y = r1.z;
  r7.xyz = r5.xyz * r4.xxx + r6.xyz;
  ...
  r3.w = cmp(abs(r3.x) < 1);
  r4.z = 1 / abs(r3.x);
  r4.z = r3.w ? abs(r3.x) : r4.z;
  r4.w = r4.z * r4.z;
  r5.w = r4.w * 0.0872929022 + -0.301894993;
  r4.w = r5.w * r4.w + 1;
  r5.w = r4.w * r4.z;
  r4.z = -r4.w * r4.z + 1.57079637;
  r3.w = r3.w ? r5.w : r4.z;
  r4.z = abs(r7.y) * 0.0468878001 + -0.203471005;
  r4.z = r4.z * abs(r7.y) + 1.57079601;
  r4.w = 1 + -abs(r7.y);
  r4.w = sqrt(r4.w);
  r5.w = r4.z * r4.w;
  r3.x = cmp(r3.x < 0);
  ...
  r3.w = r7.x ? 3.1415925 : -3.1415925;
  r6.w = cmp(r7.z < 0);
  r6.w = r6.w ? 1.000000 : 0;
  r8.x = r3.w * r6.w + r3.x;
  r3.x = -r4.z * r4.w + 3.14159274;
  r3.x = r7.y ? r5.w : r3.x;
  r8.y = 1.57079637 + -r3.x;
  r7.xy = r8.xy * float2(0.159099996,0.318300009) + float2(0.5,0.5);
  r7.z = r7.y * 2 + -1;
  // ==========================================================================
  // SKYBOX TEXTURE SAMPLE (t2: 4096x2048 equirectangular)
  // ==========================================================================
  r7.xyzw = t2.SampleBias(s1_s, r7.xz, cb1[26].x).xyzw;
  r4.yzw = r5.xyz * r4.yyy + r6.xyz;
  ...
  r3.w = cmp(abs(r3.x) < 1);
  r5.x = 1 / abs(r3.x);
  r5.x = r3.w ? abs(r3.x) : r5.x;
  r5.y = r5.x * r5.x;
  r5.z = r5.y * 0.0872929022 + -0.301894993;
  r5.y = r5.z * r5.y + 1;
  r5.z = r5.y * r5.x;
  r5.x = -r5.y * r5.x + 1.57079637;
  r3.w = r3.w ? r5.z : r5.x;
  r5.x = abs(r4.z) * 0.0468878001 + -0.203471005;
  r5.x = r5.x * abs(r4.z) + 1.57079601;
  r5.y = 1 + -abs(r4.z);
  r5.y = sqrt(r5.y);
  r5.z = r5.x * r5.y;
  r3.x = cmp(r3.x < 0);
  r3.x = r3.x ? -r3.w : r3.w;
  r4.yz = cmp(r4.yz >= float2(0,0));
  r3.w = r4.y ? 3.1415925 : -3.1415925;
  r4.y = cmp(r4.w < 0);
  r4.y = r4.y ? 1.000000 : 0;
  r8.x = r3.w * r4.y + r3.x;
  r3.x = -r5.x * r5.y + 3.14159274;
  r3.x = r4.z ? r5.z : r3.x;
  r8.y = 1.57079637 + -r3.x;
  r5.xy = r8.xy * float2(0.159099996,0.318300009) + float2(0.5,0.5);
  r5.z = r5.y * 2 + -1;
  r5.xyzw = t2.SampleBias(s1_s, r5.xz, cb1[26].x).xyzw;
  r3.x = r4.x + r4.x;
  r4.xyzw = r5.xyzw + -r7.xyzw;
  r4.xyzw = abs(r3.xxxx) * r4.xyzw + r7.xyzw;
  r5.xyz = float3(-0.5,-0.5,-0.5) + r4.xyz;
  r4.xyz = r5.xyz * cb2[40].yyy + float3(0.5,0.5,0.5);
  r5.xyzw = cb2[38].xyzw * r4.xyzw;
  r3.x = max(r5.x, r5.y);
  r4.xyzw = -r4.xyzw * cb2[38].xyzw + r3.xxxx;
  r4.xyzw = cb2[40].xxxx * r4.xyzw + r5.xyzw;
  ...
  r4.w = r3.w * r3.z;
  r3.z = -r3.w * r3.z + r3.z;
  r3.z = cb2[43].y * r3.z + r4.w;  // Sun brightness
  r5.yzw = cb2[42].xyz * r3.zzz;    // Apply sun color
  ...
  r2.yzw = r2.yzw * r3.yyy + r5.yzw;
  r3.yzw = r4.xyz * r3.xxx + -r2.yzw;
  r2.yzw = r5.xxx * r3.yzw + r2.yzw;
  // ==========================================================================
  // REFLECTION PROBE 1 (cb2[0].x enables this)
  // ==========================================================================
  r3.yz = cmp(float2(0.75,0.75) < cb2[0].xy);
  if (r3.y != 0) {
    r3.y = rsqrt(r0.w);
    r5.yzw = r3.yyy * r0.yxz;
    r3.y = dot(r5.zyw, cb2[15].xyz);
    r3.w = cb2[19].x * cb2[19].x + -1;
    r3.w = r3.y * r3.y + r3.w;
    r4.w = max(0, r3.w);
    r4.w = sqrt(r4.w);
    r3.y = -r4.w + r3.y;
    r6.xyz = r5.zyw * r3.yyy + -cb2[15].xyz;
    r6.xyz = r6.xyz / cb2[19].xxx;
    r3.y = dot(r6.xyz, cb2[21].xyz);
    r7.xyz = -cb2[21].xyz * r3.yyy + r6.xyz;
    r4.w = dot(r7.xyz, r7.xyz);
    r4.w = rsqrt(r4.w);
    r7.xyz = r7.xyz * r4.www;
    r4.w = dot(r7.xyz, cb2[25].xyz);
    r6.w = cmp(0 < r4.w);
    r4.w = cmp(r4.w < 0);
    r4.w = (int)-r6.w + (int)r4.w;
    r4.w = (int)r4.w;
    r6.w = saturate(-r4.w);
    r7.x = dot(r7.xyz, cb2[23].xyz);
    r7.y = 1 + -abs(r7.x);
    r7.y = sqrt(r7.y);
    r7.z = abs(r7.x) * -0.0187292993 + 0.0742610022;
    r7.z = r7.z * abs(r7.x) + -0.212114394;
    r7.z = r7.z * abs(r7.x) + 1.57072878;
    r7.w = r7.z * r7.y;
    ...
    r7.x = r7.z * r7.y + r7.x;
    r4.w = r7.x * r4.w;
    r7.x = r4.w * 0.159154937 + r6.w;
    r4.w = r3.y * r3.y;
    r4.w = r4.w * -0.222222224 + -0.277777791;
    r7.y = r4.w * -r3.y + 0.50000006;
    r8.xyzw = t3.SampleBias(s2_s, r7.xy, cb1[26].x).xyzw;
    r3.y = saturate(dot(cb2[17].xyz, r6.xyz));
    r3.y = saturate(r3.y * cb2[1].x + cb2[1].z);
    r6.xyz = t5.SampleBias(s4_s, r7.xy, cb1[26].x).xyz;
    r6.xyz = cb2[9].xyz * r6.xyz;
    r8.xyz = r8.xyz * r3.yyy + r6.xyz;
    r3.y = dot(cb2[15].xyz, cb2[15].xyz);
    r3.y = rsqrt(r3.y);
    r6.xyz = cb2[15].xyz * r3.yyy;
    r3.y = saturate(dot(r5.zyw, r6.xyz));
    r3.y = r3.w * r3.y;
    r3.y = max(0, r3.y);
    r3.y = cmp(0 < r3.y);
    ...
    r6.xyzw = cb2[5].xyzw * r6.xyzw;
    r5.y = saturate(r5.y);
    r3.y = -1 + r5.y;
    r3.y = cb2[29].w * r3.y + 1;
    r7.xyzw = r6.xyzw * r3.yyyy;
  ...
  if (r3.z != 0) {
    r3.y = rsqrt(r0.w);
    r3.yzw = r3.yyy * r0.yxz;
    r0.x = dot(r3.zyw, cb2[16].xyz);
    r0.z = cb2[20].x * cb2[20].x + -1;
    r0.z = r0.x * r0.x + r0.z;
    r4.w = max(0, r0.z);
    r4.w = sqrt(r4.w);
    r0.x = -r4.w + r0.x;
    r5.yzw = r3.zyw * r0.xxx + -cb2[16].xyz;
    ...
    r0.x = saturate(dot(r3.zyw, r5.yzw));
    r0.x = r0.z * r0.x;
    r0.x = max(0, r0.x);
    r0.x = cmp(0 < r0.x);
    ...
    r3.yz = cmp(float2(1.5,0.5) >= cb2[2].yy);
    r3.yz = r3.yz ? float2(1,1) : 0;
    r0.z = -r0.z * r3.y + 1;
    r0.z = -r7.w * r0.z + 1;
    r0.x = -r6.w * r0.x + 1;
    r0.x = -r0.x * r3.z + 1;
    r3.yzw = r7.xyz * r0.xxx;
    r2.yzw = r2.yzw * r0.zzz + r3.yzw;
  }
  // Final skybox blend
  r3.xyz = r4.xyz * r3.xxx + -r2.yzw;
