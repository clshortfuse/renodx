  ...
  out float4 o1 : SV_Target1)
{
  ...
  if (r3.x != 0) {
    ...
    r3.x = dot(r6.xyz, cb2[21].xyz);
    r7.xyz = -cb2[21].xyz * r3.xxx + r6.xyz;
    ...
    r7.y = r4.w * -r3.x + 0.50000006;
    r8.xyzw = t3.SampleBias(s2_s, r7.xy, cb1[26].x).xyzw;
    r3.x = saturate(dot(cb2[17].xyz, r6.xyz));
    r3.x = saturate(r3.x * cb2[1].x + cb2[1].z);
    r6.xyz = t5.SampleBias(s4_s, r7.xy, cb1[26].x).xyz;
    r6.xyz = cb2[9].xyz * r6.xyz;
    r8.xyz = r8.xyz * r3.xxx + r6.xyz;
    r3.x = dot(cb2[15].xyz, cb2[15].xyz);
    r3.x = rsqrt(r3.x);
    r6.xyz = cb2[15].xyz * r3.xxx;
    r3.x = saturate(dot(r5.zyw, r6.xyz));
    r3.x = r3.w * r3.x;
    r3.x = max(0, r3.x);
    r3.x = cmp(0 < r3.x);
    r3.x = r3.x ? 1.000000 : 0;
    r6.xyzw = r8.xyzw * r3.xxxx;
