// ---- Created with 3Dmigoto v1.3.16 on Tue Jan 20 19:04:10 2026
#include "../common.hlsl"
  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (shader_injection.tone_map_type == 0.f) {
    ...
    r1.xyz = cb1[8].zzz * r0.zxy;
    r0.w = floor(r1.x);
    r2.xy = cb1[8].xy * float2(0.5, 0.5);
    r1.yz = r1.yz * cb1[8].xy + r2.xy;
    r1.x = r0.w * cb1[8].y + r1.y;
    r2.xyz = t3.SampleLevel(s0_s, r1.xz, 0).xyz;
    r3.z = cb1[8].y;
    r1.xy = r1.xz + r3.zw;
    r1.xyz = t3.SampleLevel(s0_s, r1.xy, 0).xyz;
    r0.w = r0.z * cb1[8].z + -r0.w;
    r1.xyz = r1.xyz + -r2.xyz;
    r1.xyz = r0.www * r1.xyz + r2.xyz;
    r1.xyz = r1.xyz + -r0.xyz;
    r0.xyz = cb1[8].www * r1.xyz + r0.xyz;
