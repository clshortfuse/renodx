  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = r2.x * 0.5 + r2.y;
  r0.w = r2.z * 0.5 + r0.w;
  r3.xyz = t0.SampleLevel(s0_s, r1.zw, 0).xyz;
  ...
  r6.yw = float2(0,0);
  r5.zw = v1.xy + r6.xy;
  r7.xyz = t0.SampleLevel(s0_s, r5.zw, 0).xyz;
  r5.z = r7.x * 0.5 + r7.y;
  r5.z = r7.z * 0.5 + r5.z;
  r5.y = max(r5.z, r5.y);
  r2.w = max(r5.y, r2.w);
  ...
  r4.xyz = t1.SampleLevel(s0_s, v1.xy, 0).xyz;
  r5.xyz = log2(r4.zxy);
  ...
  r0.w = -cb1[9].z + 1;
  r7.xyz = r4.zxy * r0.www;
  r7.xyz = cmp(float3(0.300000012,0.300000012,0.300000012) < r7.xyz);
  r4.xyz = r7.xyz ? r5.xyz : r4.zxy;
  r3.xyz = r4.xyz * cb1[11].zxy + r3.xyz;
  r1.xyz = -r1.xyz * cb0[93].xxx + r3.xyz;
