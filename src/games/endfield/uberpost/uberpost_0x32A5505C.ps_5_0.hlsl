  ...
  out float4 o0 : SV_Target0)
{
  ...
  /* Original Code
  r0.xyz = r0.xyz * float3(0.92592597,0.92592597,0.92592597) + float3(0.0479959995,0.0479959995,0.0479959995);
  ...
  return;
  */
  LUTSampleResult lut_sample = LUTSAMPLE(s0_s, cb1[7].xyz, t1, r0.yzx * (1.f / 6.f));
  [branch]
