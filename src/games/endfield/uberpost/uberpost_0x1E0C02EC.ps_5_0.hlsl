  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.xyz = cb1[7].zzz * r0.xyz;
  r0.y = floor(r3.x);
  r2.zw = cb1[7].xy * float2(0.5,0.5);
  r3.yz = r3.yz * cb1[7].xy + r2.zw;
  r3.x = r0.y * cb1[7].y + r3.y;
  r4.xyz = t2.SampleLevel(s2_s, r3.xz, 0).xyz;
  r5.x = cb1[7].y;
  r5.y = 0;
  r2.zw = r5.xy + r3.xz;
  r3.xyz = t2.SampleLevel(s2_s, r2.zw, 0).xyz;
  r0.x = r0.x * cb1[7].z + -r0.y;
  r3.xyz = r3.xyz + -r4.xyz;
  r0.xyz = r0.xxx * r3.xyz + r4.xyz;
  r3.xyz = float3(12.9200001,12.9200001,12.9200001) * r0.xyz;
  r4.xyz = log2(abs(r0.xyz));
