// ---- Created with 3Dmigoto v1.3.16 on Tue Jan 20 19:03:58 2026
#include "../common.hlsl"
  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (shader_injection.tone_map_type == 0.f) {
    ...
    r2.xyz = t1.SampleLevel(s1_s, r1.xz, 0).xyz;
    r3.x = cb1[7].y;
    r3.y = 0;
    r0.zw = r3.xy + r1.xz;
    ...
    o0.xyz = renodx::draw::RenderIntermediatePass(renodx::draw::ToneMapPass(r0.yzx, graded));
  }
  */
  renodx::lut::Config lut_config = renodx::lut::config::Create(
      s1_s,
  ...
  if (shader_injection.tone_map_type == 0.f) {
    ...
    o0.xyz = renodx::color::bt2020::from::BT709(o0.xyz);
    o0.xyz = renodx::tonemap::neutwo::MaxChannel(o0.xyz, shader_injection.peak_white_nits / shader_injection.diffuse_white_nits, 65.f);
    o0.xyz = renodx::color::bt709::from::BT2020(o0.xyz);
  }
