  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.xyz = float3(32,32,32) * r1.xyz;
  r1.xyz = r0.xyz * float3(32,32,32) + -r3.xyz;
  ...
  r0.xyz = r3.xyz * cb4[8].xxx + r0.xyz * CUSTOM_BLOOM;
  r1.w = 1 + -r1.w;
  ...
  r4.y = cmp(0 < abs(r0.x));
  r4.x = rcp(r0.x);
  o0.x = r4.y ? r4.x : 99999999;
  r4.y = cmp(0 < abs(r0.y));
  r4.x = rcp(r0.y);
  o0.y = r4.y ? r4.x : 99999999;
  r4.y = cmp(0 < abs(r0.z));
  r4.x = rcp(r0.z);
  o0.z = r4.y ? r4.x : 99999999;*/
  o0.w = r0.w;
