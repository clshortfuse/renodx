  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = r4.x ? 9999999933815812510711506376257961984 : r4.y;
  r4.y = rsqrt(abs(r0.y));
  r4.x = cmp((int)r4.y == 0x7f800000);
  r0.y = r4.x ? 9999999933815812510711506376257961984 : r4.y;
  r4.y = rsqrt(abs(r0.z));
  r4.x = cmp((int)r4.y == 0x7f800000);
  r0.z = r4.x ? 9999999933815812510711506376257961984 : r4.y;
  r4.y = cmp(0 < abs(r0.x));
  r4.x = rcp(r0.x);
  r0.x = r4.y ? r4.x : 9999999933815812510711506376257961984;
  r4.y = cmp(0 < abs(r0.y));
  r4.x = rcp(r0.y);
  r0.y = r4.y ? r4.x : 9999999933815812510711506376257961984;
  r4.y = cmp(0 < abs(r0.z));
  r4.x = rcp(r0.z);
  r0.z = r4.y ? r4.x : 9999999933815812510711506376257961984;
  o0.xyzw = saturate(-cb4[9].zzzz + r0.xyzw);*/
  o0.w = saturate(r0.w - cb4[9].z);
  if (RENODX_TONE_MAP_TYPE == 0.f) {
    r0.rgb = sqrt(vanilla) - cb4[9].zzz;
