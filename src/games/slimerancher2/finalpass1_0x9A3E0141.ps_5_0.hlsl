...
// ---- Created with 3Dmigoto v1.3.16 on Fri Jul 25 14:20:50 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.z = dot(r4.xyz, float3(0.212672904,0.715152204,0.0721750036));
  r1.w = min(r1.x, r3.y);
  r1.x = max(r1.x, r3.y);
  r1.x = max(r1.x, r1.y);
  r1.y = min(r1.w, r1.y);
  ...
  float3 sceneColor = r1.www * r0.yzw + r1.xyz;
