...
OutputSignature main(
  ...
  float _655 = _650 * 0.9708889722824097f;
  float _656 = mad(0.026962999254465103f, _651, _655);
  float _657 = mad(0.002148000057786703f, _652, _656);
  float _658 = _650 * 0.01088900025933981f;
  float _659 = mad(0.9869629740715027f, _651, _658);
  float _660 = mad(0.002148000057786703f, _652, _659);
  float _661 = mad(0.026962999254465103f, _651, _658);
  float _662 = mad(0.9621480107307434f, _652, _661);
  float _663 = max(_657, 0.0f);
  float _664 = max(_660, 0.0f);
  float _665 = max(_662, 0.0f);
  float _666 = min(_663, cb2_095y);
  float _667 = min(_664, cb2_095y);
  float _668 = min(_665, cb2_095y);
  bool _671 = ((uint)(cb2_095x) == 0);
  bool _674 = ((uint)(cb2_094w) == 0);
  bool _676 = ((uint)(cb2_094z) == 0);
  bool _678 = ((uint)(cb2_094y) != 0);
  bool _680 = ((uint)(cb2_094x) == 0);
  bool _682 = ((uint)(cb2_069z) != 0);
  float _729 = asfloat((uint)(cb2_075y));
  float _730 = asfloat((uint)(cb2_075z));
  float _731 = asfloat((uint)(cb2_075w));
  float _732 = asfloat((uint)(cb2_074z));
  float _733 = asfloat((uint)(cb2_074w));
  float _734 = asfloat((uint)(cb2_075x));
  float _735 = asfloat((uint)(cb2_073w));
  float _736 = asfloat((uint)(cb2_074x));
  float _737 = asfloat((uint)(cb2_074y));
  float _738 = asfloat((uint)(cb2_077x));
  float _739 = asfloat((uint)(cb2_077y));
  float _740 = asfloat((uint)(cb2_079x));
  float _741 = asfloat((uint)(cb2_079y));
  float _742 = asfloat((uint)(cb2_079z));
  float _743 = asfloat((uint)(cb2_078y));
  float _744 = asfloat((uint)(cb2_078z));
  float _745 = asfloat((uint)(cb2_078w));
  float _746 = asfloat((uint)(cb2_077z));
  float _747 = asfloat((uint)(cb2_077w));
  float _748 = asfloat((uint)(cb2_078x));
  float _749 = asfloat((uint)(cb2_072y));
  float _750 = asfloat((uint)(cb2_072z));
  float _751 = asfloat((uint)(cb2_072w));
  float _752 = asfloat((uint)(cb2_071x));
  float _753 = asfloat((uint)(cb2_071y));
  float _754 = asfloat((uint)(cb2_076x));
  float _755 = asfloat((uint)(cb2_070w));
  float _756 = asfloat((uint)(cb2_070x));
  float _757 = asfloat((uint)(cb2_070y));
  float _758 = asfloat((uint)(cb2_070z));
  float _759 = asfloat((uint)(cb2_073x));
  float _760 = asfloat((uint)(cb2_073y));
  float _761 = asfloat((uint)(cb2_073z));
  float _762 = asfloat((uint)(cb2_071z));
  float _763 = asfloat((uint)(cb2_071w));
  float _764 = asfloat((uint)(cb2_072x));
  float _765 = max(_667, _668);
  float _766 = max(_666, _765);
  float _767 = 1.0f / _766;
  float _768 = _767 * _666;
  float _769 = _767 * _667;
  float _770 = _767 * _668;
  float _771 = abs(_768);
  float _772 = log2(_771);
  float _773 = _772 * _756;
  float _774 = exp2(_773);
  float _775 = abs(_769);
  float _776 = log2(_775);
  float _777 = _776 * _757;
  float _778 = exp2(_777);
  float _779 = abs(_770);
  float _780 = log2(_779);
  float _781 = _780 * _758;
  float _782 = exp2(_781);
  if (_678) {
    float _785 = asfloat((uint)(cb2_076w));
    float _787 = asfloat((uint)(cb2_076z));
    float _789 = asfloat((uint)(cb2_076y));
    float _790 = _787 * _667;
    float _791 = _789 * _666;
    float _792 = _785 * _668;
    float _793 = _791 + _792;
    float _794 = _793 + _790;
    _802 = _794;
  } else {
    float _796 = _763 * _667;
    float _797 = _762 * _666;
    float _798 = _764 * _668;
  ...
  float _805 = _804 * _755;
  float _806 = exp2(_805);
  float _807 = log2(_806);
  float _808 = _807 * _754;
  float _809 = exp2(_808);
  float _810 = select(_682, _809, _806);
  float _811 = _810 * _752;
  float _812 = _811 + _753;
  float _813 = 1.0f / _812;
  float _814 = _813 * _806;
  if (_678) {
    if (!_680) {
      float _817 = _774 * _746;
      float _818 = _778 * _747;
      float _819 = _782 * _748;
      float _820 = _818 + _817;
      float _821 = _820 + _819;
      float _822 = _778 * _744;
      float _823 = _774 * _743;
      float _824 = _782 * _745;
      float _825 = _822 + _823;
      float _826 = _825 + _824;
      float _827 = _782 * _742;
      float _828 = _778 * _741;
      float _829 = _774 * _740;
      float _830 = _828 + _829;
      float _831 = _830 + _827;
      float _832 = max(_826, _831);
      float _833 = max(_821, _832);
      float _834 = 1.0f / _833;
      float _835 = _834 * _821;
      float _836 = _834 * _826;
      float _837 = _834 * _831;
      _839 = _835;
      _840 = _836;
      _841 = _837;
    } else {
    ...
    float _842 = _839 * _739;
    float _843 = exp2(_842);
    float _844 = _843 * _738;
    float _845 = saturate(_844);
    float _846 = _839 * _738;
    float _847 = _839 - _846;
    float _848 = saturate(_847);
    float _849 = max(_738, _848);
    float _850 = min(_849, _845);
    float _851 = _840 * _739;
    float _852 = exp2(_851);
    float _853 = _852 * _738;
    float _854 = saturate(_853);
    float _855 = _840 * _738;
    float _856 = _840 - _855;
    float _857 = saturate(_856);
    float _858 = max(_738, _857);
    float _859 = min(_858, _854);
    float _860 = _841 * _739;
    float _861 = exp2(_860);
    float _862 = _861 * _738;
    float _863 = saturate(_862);
    float _864 = _841 * _738;
    float _865 = _841 - _864;
    float _866 = saturate(_865);
    float _867 = max(_738, _866);
  ...
  float _873 = _870 * _762;
  float _874 = _871 * _763;
  float _875 = _874 + _873;
  float _876 = _872 * _764;
  float _877 = _875 + _876;
  float _878 = 1.0f / _877;
  float _879 = _878 * _814;
  float _880 = saturate(_879);
  float _881 = _880 * _870;
  float _882 = saturate(_881);
  float _883 = _880 * _871;
  float _884 = saturate(_883);
  float _885 = _880 * _872;
  float _886 = saturate(_885);
  float _887 = _882 * _749;
  float _888 = _749 - _887;
  float _889 = _884 * _750;
  float _890 = _750 - _889;
  float _891 = _886 * _751;
  float _892 = _751 - _891;
  float _893 = _886 * _764;
  float _894 = _882 * _762;
  float _895 = _884 * _763;
  float _896 = _814 - _894;
  float _897 = _896 - _895;
  float _898 = _897 - _893;
  float _899 = saturate(_898);
  float _900 = _890 * _763;
  float _901 = _888 * _762;
  float _902 = _892 * _764;
  float _903 = _900 + _901;
  float _904 = _903 + _902;
  float _905 = 1.0f / _904;
  float _906 = _905 * _899;
  float _907 = _906 * _888;
  float _908 = _907 + _882;
  float _909 = saturate(_908);
  float _910 = _906 * _890;
  float _911 = _910 + _884;
  float _912 = saturate(_911);
  float _913 = _906 * _892;
  float _914 = _913 + _886;
  float _915 = saturate(_914);
  float _916 = _915 * _764;
  float _917 = _909 * _762;
  float _918 = _912 * _763;
  float _919 = _814 - _917;
  float _920 = _919 - _918;
  float _921 = _920 - _916;
  float _922 = saturate(_921);
  float _923 = _922 * _759;
  float _924 = _923 + _909;
  float _925 = saturate(_924);
  float _926 = _922 * _760;
  float _927 = _926 + _912;
  float _928 = saturate(_927);
  float _929 = _922 * _761;
  float _930 = _929 + _915;
  float _931 = saturate(_930);
  if (!_676) {
    float _933 = _925 * _735;
    float _934 = _928 * _736;
    float _935 = _931 * _737;
    float _936 = _934 + _933;
    float _937 = _936 + _935;
    float _938 = _928 * _733;
    float _939 = _925 * _732;
    float _940 = _931 * _734;
    float _941 = _938 + _939;
    float _942 = _941 + _940;
    float _943 = _931 * _731;
    float _944 = _928 * _730;
    float _945 = _925 * _729;
    float _946 = _944 + _945;
    float _947 = _946 + _943;
    if (!_674) {
      float _949 = saturate(_937);
      float _950 = saturate(_942);
      float _951 = saturate(_947);
      _953 = _951;
      _954 = _950;
      _955 = _949;
    } else {
  ...
  if (!_671) {
    float _957 = _955 * _735;
    float _958 = _954 * _735;
    float _959 = _953 * _735;
    _961 = _959;
    _962 = _958;
    _963 = _957;
  } else {
  ...
  if (_642) {
    float _967 = cb1_018z * 9.999999747378752e-05f;
    float _968 = _967 * _963;
    float _969 = _967 * _962;
    float _970 = _967 * _961;
    float _972 = 5000.0f / cb1_018y;
    float _973 = _968 * _972;
    float _974 = _969 * _972;
    float _975 = _970 * _972;
    _977 = _973;
    _978 = _974;
    _979 = _975;
  } else {
  ...
  float _980 = _977 * 1.6047500371932983f;
  float _981 = mad(-0.5310800075531006f, _978, _980);
  float _982 = mad(-0.07366999983787537f, _979, _981);
  float _983 = _977 * -0.10208000242710114f;
  float _984 = mad(1.1081299781799316f, _978, _983);
  float _985 = mad(-0.006049999967217445f, _979, _984);
  float _986 = _977 * -0.0032599999103695154f;
  float _987 = mad(-0.07275000214576721f, _978, _986);
  float _988 = mad(1.0760200023651123f, _979, _987);
  if (_642) {
    // float _990 = max(_982, 0.0f);
    // float _991 = max(_985, 0.0f);
    // float _992 = max(_988, 0.0f);
    // bool _993 = !(_990 >= 0.0030399328097701073f);
    // if (!_993) {
    //   float _995 = abs(_990);
    ...
    //   _1004 = _1000;
    // } else {
    //   float _1002 = _990 * 12.923210144042969f;
    //   _1004 = _1002;
    // }
    // bool _1005 = !(_991 >= 0.0030399328097701073f);
    // if (!_1005) {
    //   float _1007 = abs(_991);
    ...
    //   _1016 = _1012;
    // } else {
    //   float _1014 = _991 * 12.923210144042969f;
    //   _1016 = _1014;
    // }
    // bool _1017 = !(_992 >= 0.0030399328097701073f);
    // if (!_1017) {
    //   float _1019 = abs(_992);
    //   float _1020 = log2(_1019);
    //   float _1021 = _1020 * 0.4166666567325592f;
    //   float _1022 = exp2(_1021);
    //   float _1023 = _1022 * 1.0549999475479126f;
    //   float _1024 = _1023 + -0.054999999701976776f;
    //   _1097 = _1004;
    //   _1098 = _1016;
    //   _1099 = _1024;
    // } else {
    //   float _1026 = _992 * 12.923210144042969f;
    //   _1097 = _1004;
    //   _1098 = _1016;
    //   _1099 = _1026;
    // }
    _1097 = renodx::color::srgb::EncodeSafe(_982);
    _1098 = renodx::color::srgb::EncodeSafe(_985);
    _1099 = renodx::color::srgb::EncodeSafe(_988);

  } else {
    float _1028 = saturate(_982);
    float _1029 = saturate(_985);
    float _1030 = saturate(_988);
    bool _1031 = ((uint)(cb1_018w) == -2);
    if (!_1031) {
      bool _1033 = !(_1028 >= 0.0030399328097701073f);
      if (!_1033) {
        ...
        float _1042 = _1028 * 12.923210144042969f;
        _1044 = _1042;
      }
      bool _1045 = !(_1029 >= 0.0030399328097701073f);
      if (!_1045) {
        float _1047 = abs(_1029);
        ...
        float _1054 = _1029 * 12.923210144042969f;
        _1056 = _1054;
      }
      bool _1057 = !(_1030 >= 0.0030399328097701073f);
      if (!_1057) {
        float _1059 = abs(_1030);
        ...
        float _1066 = _1030 * 12.923210144042969f;
        _1068 = _1044;
        _1069 = _1056;
        _1070 = _1066;
      }
  ...
  float _1100 = dot(float3(_1097, _1098, _1099), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
  SV_Target.x = _1097;
  SV_Target.y = _1098;
  SV_Target.z = _1099;
  SV_Target.w = _1100;
