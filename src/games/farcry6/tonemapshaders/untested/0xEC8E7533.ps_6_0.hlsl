...
OutputSignature main(
  ...
  float _468 = _465 * 0.9708889722824097f;
  float _469 = mad(0.026962999254465103f, _466, _468);
  float _470 = mad(0.002148000057786703f, _467, _469);
  float _471 = _465 * 0.01088900025933981f;
  float _472 = mad(0.9869629740715027f, _466, _471);
  float _473 = mad(0.002148000057786703f, _467, _472);
  float _474 = mad(0.026962999254465103f, _466, _471);
  float _475 = mad(0.9621480107307434f, _467, _474);
  if (_404) {
    if (RENODX_TONE_MAP_TYPE == 0.f) {
        float _480 = cb1_018y * 0.10000000149011612f;
        float _481 = log2(cb1_018z);
        float _482 = _481 + -13.287712097167969f;
        float _483 = _482 * 1.4929734468460083f;
        float _484 = _483 + 18.0f;
        float _485 = exp2(_484);
        float _486 = _485 * 0.18000000715255737f;
        float _487 = abs(_486);
        float _488 = log2(_487);
        float _489 = _488 * 1.5f;
        float _490 = exp2(_489);
        float _491 = _490 * _480;
        float _492 = _491 / cb1_018z;
        float _493 = _492 + -0.07636754959821701f;
        float _494 = _488 * 1.2750000953674316f;
        float _495 = exp2(_494);
        float _496 = _495 * 0.07636754959821701f;
        float _497 = cb1_018y * 0.011232397519052029f;
        float _498 = _497 * _490;
        float _499 = _498 / cb1_018z;
        float _500 = _496 - _499;
        float _501 = _495 + -0.11232396960258484f;
        float _502 = _501 * _480;
        ...
        float _513 = _510 * 1.5f;
        float _514 = exp2(_511);
        float _515 = exp2(_512);
        float _516 = exp2(_513);
        float _517 = _514 * _504;
        float _518 = _515 * _504;
        float _519 = _516 * _504;
        float _520 = _508 * 1.2750000953674316f;
        float _521 = _509 * 1.2750000953674316f;
        float _522 = _510 * 1.2750000953674316f;
        float _523 = exp2(_520);
        float _524 = exp2(_521);
        float _525 = exp2(_522);
        float _526 = _523 * _493;
        float _527 = _524 * _493;
        float _528 = _525 * _493;
        float _529 = _526 + _500;
        float _530 = _527 + _500;
        float _531 = _528 + _500;
        ...
        float _537 = _534 * 9.999999747378752e-05f;
        float _538 = 5000.0f / cb1_018y;
      ...
      float3 tonemapped = ApplyCustomToneMap(float3(_470, _473, _475));
      _568 = tonemapped.x, _569 = tonemapped.y, _570 = tonemapped.z;
    }
      } else {
        float _543 = _470 + 0.020616600289940834f;
        float _544 = _473 + 0.020616600289940834f;
        float _545 = _475 + 0.020616600289940834f;
        float _546 = _543 * _470;
        float _547 = _544 * _473;
        float _548 = _545 * _475;
        float _549 = _546 + -7.456949970219284e-05f;
        float _550 = _547 + -7.456949970219284e-05f;
        float _551 = _548 + -7.456949970219284e-05f;
        float _552 = _470 * 0.9837960004806519f;
        float _553 = _473 * 0.9837960004806519f;
        float _554 = _475 * 0.9837960004806519f;
        float _555 = _552 + 0.4336790144443512f;
        float _556 = _553 + 0.4336790144443512f;
        float _557 = _554 + 0.4336790144443512f;
        float _558 = _555 * _470;
        float _559 = _556 * _473;
        float _560 = _557 * _475;
        float _561 = _558 + 0.24617899954319f;
        float _562 = _559 + 0.24617899954319f;
        float _563 = _560 + 0.24617899954319f;
      ...
      float _571 = _568 * 1.6047500371932983f;
      float _572 = mad(-0.5310800075531006f, _569, _571);
      float _573 = mad(-0.07366999983787537f, _570, _572);
      float _574 = _568 * -0.10208000242710114f;
      float _575 = mad(1.1081299781799316f, _569, _574);
      float _576 = mad(-0.006049999967217445f, _570, _575);
      float _577 = _568 * -0.0032599999103695154f;
      float _578 = mad(-0.07275000214576721f, _569, _577);
      float _579 = mad(1.0760200023651123f, _570, _578);
      if (_404) {
        // float _581 = max(_573, 0.0f);
        // float _582 = max(_576, 0.0f);
        // float _583 = max(_579, 0.0f);
        // bool _584 = !(_581 >= 0.0030399328097701073f);
        // if (!_584) {
        //   float _586 = abs(_581);
        ...
        //   _595 = _591;
        // } else {
        //   float _593 = _581 * 12.923210144042969f;
        //   _595 = _593;
        // }
        // bool _596 = !(_582 >= 0.0030399328097701073f);
        // if (!_596) {
        //   float _598 = abs(_582);
        ...
        //   _607 = _603;
        // } else {
        //   float _605 = _582 * 12.923210144042969f;
        //   _607 = _605;
        // }
        // bool _608 = !(_583 >= 0.0030399328097701073f);
        // if (!_608) {
        //   float _610 = abs(_583);
        ...
        //   _690 = _615;
        // } else {
        //   float _617 = _583 * 12.923210144042969f;
        //   _688 = _595;
        //   _689 = _607;
        //   _690 = _617;
        // }
        _688 = renodx::color::srgb::EncodeSafe(_573);
        _689 = renodx::color::srgb::EncodeSafe(_576);
        _690 = renodx::color::srgb::EncodeSafe(_579);

      } else {
        float _619 = saturate(_573);
        float _620 = saturate(_576);
        float _621 = saturate(_579);
        bool _622 = ((uint)(cb1_018w) == -2);
        if (!_622) {
          bool _624 = !(_619 >= 0.0030399328097701073f);
          if (!_624) {
            float _626 = abs(_619);
            ...
            float _633 = _619 * 12.923210144042969f;
            _635 = _633;
          }
          bool _636 = !(_620 >= 0.0030399328097701073f);
          if (!_636) {
            float _638 = abs(_620);
            ...
            float _645 = _620 * 12.923210144042969f;
            _647 = _645;
          }
          bool _648 = !(_621 >= 0.0030399328097701073f);
          if (!_648) {
            float _650 = abs(_621);
            ...
            float _657 = _621 * 12.923210144042969f;
            _659 = _635;
            _660 = _647;
            _661 = _657;
          }
      ...
      float _691 = dot(float3(_688, _689, _690), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      SV_Target.x = _688;
      SV_Target.y = _689;
      SV_Target.z = _690;
      SV_Target.w = _691;
