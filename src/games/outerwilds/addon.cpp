...
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntry(0x2AA95E6B),
    CustomShaderEntry(0x7F1AF2FE),
    CustomShaderEntry(0x60C9F3A1),
    CustomShaderEntry(0x51459A11),
    CustomShaderEntry(0x2B868B21),
};
...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .label = "RenoDX by ShortFuse, game mod by Ritsu. Shout-out to HDR Den & Not Voosh for (lending) their code!",
        .section = "About",
    },
    new renodx::utils::settings::Setting{
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Outer Wilds";
