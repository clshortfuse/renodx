...
const float _1627[2][2] = float[][](float[](-15.0, 0.18), float[](-6.5, 0.35));
const float _1770[2][2] = float[][](float[](6.5, 0.89), float[](18.0, 0.90));
...
vec3 _204(vec3 _203) {
  return max(vec3(0.0), exp(_203 * log(10000.0) - log(100.0)) - 0.01);
}
...
vec3 _207(vec3 _206) {
  return _30(_206,
             // BT709_TO_XYZ_MAT
             mat3(vec3(0.412390887737274169921875, 0.357584297657012939453125, 0.18048083782196044921875),
                  vec3(0.2126390635967254638671875, 0.71516859531402587890625, 0.072192333638668060302734375),
                  vec3(0.01933082006871700286865234375, 0.119194723665714263916015625, 0.95053231716156005859375)),
             // D65_TO_D60_CAT
             mat3(vec3(1.01303005218505859375, 0.0061053098179399967193603515625, -0.014971000142395496368408203125),
                  vec3(0.0076982299797236919403076171875, 0.99816501140594482421875, -0.005032029934227466583251953125),
                  vec3(-0.0028413101099431514739990234375, 0.0046851597726345062255859375, 0.92450702190399169921875)),
             // XYZ_TO_AP0_MAT
             mat3(vec3(1.04981100559234619140625, 0.0, -9.74845024757087230682373046875e-05),
                  vec3(-0.49590301513671875, 1.37331306934356689453125, 0.09824003279209136962890625),
                  vec3(3.9999999756901161163114011287689e-08, 0.0, 0.991252005100250244140625)));
}
...
float _64(vec3 _63) {
  ...
  return (max(_357, 1.0e-10) - max(_370, 1.0e-10)) / max(_357, 1.0e-2);
}
...
float _67(vec3 _66) {
  ...
  if (_405) {
    ...
    float _428 = sqrt(3.0) * (_66.y - _66.z);
    float _429 = ((2.0 * _66.x) - _66.y) - _66.z;
    _408 = (180.0 / M_PI) * _54(_428, _429);
  }
  if (_408 < 0.0) {
    _408 += 360.0;
  }
...
float _131(float _129, float _130) {
  ...
  if (_1222) {
    ...
    if (_1233 == 3) {
      _1211 = (((_1244[0] * (1.0 / 6.0)) + (_1244[1] * 0.5)) + (_1244[2] * (-0.5))) + (_1244[3] * (1.0 / 6.0));
    } else {
      if (_1233 == 2) {
        _1211 = (((_1244[0] * 0.5) + (_1244[1] * (-1.0))) + (_1244[2] * 0.0)) + (_1244[3] * (2.0 / 3.0));
      } else {
        if (_1233 == 1) {
          _1211 = (((_1244[0] * (-0.5)) + (_1244[1] * 0.5)) + (_1244[2] * 0.5)) + (_1244[3] * (1.0 / 6.0));
        } else {
          if (_1233 == 0) {
            _1211 = (((_1244[0] * (1.0 / 6.0)) + (_1244[1] * 0.0)) + (_1244[2] * 0.0)) + (_1244[3] * 0.0);
          } else {
            _1211 = 0.0;
          }
        }
...
vec3 _198(vec3 _197) {
  ...
  float _2501 = (_2487 - 0.4) / 0.2;
  float _2495 = _134(_2501);
  float _2508 = _2491;
  float _2510 = 0.05 * _2495;
  float _2511 = 0.08;
  ...
  _2514.x += (((_2527 * _2487) * (0.03 - _2514.x)) * 0.18);
  _2514 = max(_2514, vec3(0.0));
  vec3 _2563 = _2514;
  mat3 _2565 = mat3(
      // AP0 -> AP1
      vec3(1.45143926143646240234375, -0.236510753631591796875, -0.214928567409515380859375),
...
float _108(float _107) {
  _740 _742 = _740(
      float[](-4.0, -4.0, -3.1573765277862548828125, -0.485249996185302734375, 1.84773242473602294921875, 1.84773242473602294921875),
      float[](-0.718548238277435302734375, 2.0810306072235107421875, 3.66812419891357421875, 4.0, 4.0, 4.0),
      _113(5.4931642807787284255027770996094e-06, 9.9999997473787516355514526367188e-05),
      _113(0.180000007152557373046875, 4.80000019073486328125),
      _113(47185.921875, 10000.0), 0.0, 0.0);
  ...
  if (_763 <= _57(_770)) {
    ...
    if (_798) {
      ...
      if (_875) {
        ...
        mat3 _924 = mat3(vec3(0.5, -1.0, 0.5),
                         vec3(-1.0, 1.0, 0.5),
                         vec3(0.5, 0.0, 0.0));
        vec3 _925 = _904;
...
vec3 _201(vec3 _200) {
  ...
  mat3 _2620 = mat3(
      // AP1 -> AP0
      vec3(0.695452213287353515625, 0.140678703784942626953125, 0.16386906802654266357421875),
...
_114 _116() {
  float _960 = 0.18 * pow(2, -6.5);
  float _964 = 0.18;
  float _968 = 0.18 * pow(2, 6.5);
  _114 _939 = _114(
      // coeffs_low[10]
      float[](-1.69896996021270751953125, -1.69896996021270751953125, -1.477900028228759765625, -1.2290999889373779296875, -0.864799976348876953125, -0.448000013828277587890625, 0.0051799998618662357330322265625, 0.451108038425445556640625, 0.91137444972991943359375, 0.91137444972991943359375),
      // coeffs_high[10]
      float[](0.51543867588043212890625, 0.8470437526702880859375, 1.13580000400543212890625, 1.38020002841949462890625, 1.51970005035400390625, 1.5985000133514404296875, 1.64670002460479736328125, 1.67460918426513671875, 1.687873363494873046875, 1.687873363494873046875),
      _113(_108(_960), 0.02),
      _113(_108(_964), 4.8),
      _113(_108(_968), 48.0),
      0.0,  // slope_low
...
float _122(float _120, _114 _121) {
  ...
  if (_977 <= _57(_983)) {
    ...
    if (_1024) {
      ...
      mat3 _1074 = mat3(vec3(0.5, -1.0, 0.5),
                        vec3(-1.0, 1.0, 0.5),
                        vec3(0.5, 0.0, 0.0));
      vec3 _1075 = _1054;
      ...
      if (_1094) {
        ...
        mat3 _1143 = mat3(vec3(0.5, -1.0, 0.5),
                          vec3(-1.0, 1.0, 0.5),
                          vec3(0.5, 0.0, 0.0));
        vec3 _1144 = _1123;
...
vec3 _76(vec3 _75) {
  vec3 _515;
  _515.x = (_75.x * _75.z) / max(_75.y, 1.0e-10);
  _515.y = _75.z;
  _515.z = (((1.0 - _75.x) - _75.y) * _75.z) / max(_75.y, 1.0e-10);
  return _515;
}
...
vec3 _100(vec3 _99) {
  ...
  mat3 _634 = mat3(
      // AP1_TO_XYZ_MAT
      vec3(0.662454187870025634765625, 0.1340042054653167724609375, 0.1561876833438873291015625),
      vec3(0.272228717803955078125, 0.674081742763519287109375, 0.053689517080783843994140625),
      vec3(-0.0055746496655046939849853515625, 0.0040607335977256298065185546875, 1.01033914089202880859375));
  vec3 _618 = _23(_632, _634);
  vec3 _637 = _618;
  vec3 _636 = _73(_637);
  _636.z = clamp(_636.z, 0.0, 65504.0);
  _636.z = pow(_636.z, 0.9811);
  vec3 _650 = _636;
  _618 = _76(_650);
  vec3 _666 = _618;
  mat3 _668 = mat3(
      // XYZ_TO_AP1_MAT
      vec3(1.6410233974456787109375, -0.324803292751312255859375, -0.23642469942569732666015625),
      vec3(-0.663662850856781005859375, 1.6153316497802734375, 0.016756348311901092529296875),
      vec3(0.01172189414501190185546875, -0.008284442126750946044921875, 0.98839485645294189453125));
...
float _150(float _149) {
  ...
  return 0.18 * pow(2.0, _147(_1485, _1487));
}
...
float _153(float _152) {
  ...
  return 0.18 * pow(2.0, _147(_1506, _1508));
}
...
_159 _163(_155 _161, _155 _162) {
  ...
  float _1635 = log2(_161._m0 / 0.18);
...
_159 _167(_155 _165, _155 _166) {
  ...
  float _1778 = log2(_166._m0 / 0.18);
...
vec3 _217(vec3 _214, bool _215, _211 _216, float diffuse_white) {
  ...
  if (_215 == false) {
    ...
    vec3 _2699 = _2694;
    mat3 _2701 = mat3(vec3(1.45143926143646240234375, -0.236510753631591796875, -0.214928567409515380859375),
                      vec3(-0.07655377686023712158203125, 1.1762297153472900390625, -0.0996759235858917236328125),
                      vec3(0.0083161480724811553955078125, -0.0060324496589601039886474609375, 0.99771630764007568359375));
    ...
    vec3 _2745 = _2688;
    // AP1 -> XYZ
    mat3 _2747 = mat3(vec3(0.662454187870025634765625, 0.1340042054653167724609375, 0.1561876833438873291015625),
                      vec3(0.272228717803955078125, 0.674081742763519287109375, 0.053689517080783843994140625),
                      vec3(-0.0055746496655046939849853515625, 0.0040607335977256298065185546875, 1.01033914089202880859375));
    vec3 _2744 = _23(_2745, _2747);
    vec3 _2762 = _2744;
    // D60 -> D65
    mat3 _2764 = mat3(vec3(0.987228810787200927734375, -0.00611330009996891021728515625, 0.0159534104168415069580078125),
    ...
    vec3 _2779 = _2688;
    // XYZ -> BT.709
    mat3 _2781 = mat3(vec3(3.2409694194793701171875, -1.53738296031951904296875, -0.4986107647418975830078125),
    ...
    _2686 = max(10e-05, _216._m0) / mid_gray_ratio;  // min nits
    ...
    vec3 _2836 = _2688;
    // AP1 -> XYZ
    mat3 _2838 = mat3(vec3(0.662454187870025634765625, 0.1340042054653167724609375, 0.1561876833438873291015625),
                      vec3(0.272228717803955078125, 0.674081742763519287109375, 0.053689517080783843994140625),
                      vec3(-0.0055746496655046939849853515625, 0.0040607335977256298065185546875, 1.01033914089202880859375));
    vec3 _2835 = _23(_2836, _2838);
    vec3 _2840 = _2835;
    // D60 -> D65
    mat3 _2842 = mat3(vec3(0.987228810787200927734375, -0.00611330009996891021728515625, 0.0159534104168415069580078125),
                      vec3(-0.007598400115966796875, 1.00185978412628173828125, 0.0053300000727176666259765625),
                      vec3(0.00307258008979260921478271484375, -0.0050959200598299503326416015625, 1.0816795825958251953125));
    _2688 = _23(_2840, _2842);
    vec3 _2857 = _2688;
    // XYZ -> BT.2020
    mat3 _2859 = mat3(vec3(1.71665096282958984375, -0.35567080974578857421875, -0.2533662319183349609375),
                      vec3(-0.666684329509735107421875, 1.616481304168701171875, 0.0157685391604900360107421875),
                      vec3(0.0176398493349552154541015625, -0.04277060925960540771484375, 0.94210326671600341796875));
