...
layout(set = 0, binding = 1, std140) uniform _2984_2986 {
  vec4 _m0[1024];
}
_2986;

layout(set = 0, binding = 2, std430) restrict readonly buffer _2988_2990 {
  uvec4 _m0[];
}
_2990;

layout(set = 0, binding = 3, std430) restrict readonly buffer _2992_2994 {
  uvec4 _m0[];
}
_2994;
...
layout(set = 1, binding = 1, rgba16f) uniform writeonly image3D _2970;
...
vec3 _217(vec3 _214, bool _215, _211 _216) {
  vec3 _2682 = _214;
  ...
  if (_215 == false) {
    ...
    _2686 = max(9.9999997473787516355514526367188e-05, _216._m0);
    _2687 = _216._m1;
    float _2796 = _2686;
    float _2798 = _2687;
    float _2800 = 0.0;
...
void main() {
  ...
  vec3 _2924 = _2916;
  _2916 = _204(_2924);
  uint _2927 = _2932._m0._m5;
  _211 _2939;
  _2939._m0 = _2932._m0._m6;  // min nits
  _2939._m1 = _2887._m45;     // max nits
  _2939._m2 = _2932._m0._m7;  // mid point slider
  bool _2956 = (_2927 & 1u) != 0u;

  bool useHDR = _2956;  // true = HDR, false = SDR
