...
vec3 _132(vec3 _131) {
  vec3 _614 = _131;
  mat3 _616 = mat3(vec3(1.45143926143646240234375, -0.236510753631591796875, -0.214928567409515380859375),
  ...
  vec3 _698 = _676;
  mat3 _700 = mat3(vec3(0.695452213287353515625, 0.140678703784942626953125, 0.16386906802654266357421875),
...
#if 1
    _1178 = mix(color_grade_input, _1178, CUSTOM_LUT_STRENGTH);
#endif
  }
  float _2094 = 0.0;
  SPIRV_CROSS_BRANCH
