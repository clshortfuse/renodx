...
OutputSignature main(
  ...
  float _340 = exp2(log2(((((_120 * ColorScale0.x) * _318) * ((((((((_233.x - (_46.x * 4.0f)) + _252.x) + _46.x) - (ddx_fine(_46.x) * _214)) + _46.x) - (ddy_fine(_46.x) * _218)) * _289) + _46.x)) + ((((BloomDirtMaskTint.x * _89.x) + 1.0f) * _70.x) * _317)) * 0.009999999776482582f) * 0.1593017578125f);
  float _341 = exp2(log2(((((_121 * ColorScale0.y) * _318) * ((((((((_233.y - (_46.y * 4.0f)) + _252.y) + _46.y) - (ddx_fine(_46.y) * _214)) + _46.y) - (ddy_fine(_46.y) * _218)) * _289) + _46.y)) + ((((BloomDirtMaskTint.y * _89.y) + 1.0f) * _70.y) * _317)) * 0.009999999776482582f) * 0.1593017578125f);
  float _342 = exp2(log2(((((_122 * ColorScale0.z) * _318) * ((((((((_233.z - (_46.z * 4.0f)) + _252.z) + _46.z) - (ddx_fine(_46.z) * _214)) + _46.z) - (ddy_fine(_46.z) * _218)) * _289) + _46.z)) + ((((BloomDirtMaskTint.z * _89.z) + 1.0f) * _70.z) * _317)) * 0.009999999776482582f) * 0.1593017578125f);
  float4 _381 = ColorGradingLUT.Sample(ColorGradingLUTSampler, float3(((LUTScale * exp2(log2((1.0f / ((_340 * 18.6875f) + 1.0f)) * ((_340 * 18.8515625f) + 0.8359375f)) * 78.84375f)) + LUTOffset), ((LUTScale * exp2(log2((1.0f / ((_341 * 18.6875f) + 1.0f)) * ((_341 * 18.8515625f) + 0.8359375f)) * 78.84375f)) + LUTOffset), ((LUTScale * exp2(log2((1.0f / ((_342 * 18.6875f) + 1.0f)) * ((_342 * 18.8515625f) + 0.8359375f)) * 78.84375f)) + LUTOffset)));
  ...
  return LutToneMap(untonemapped, _381.rgb, TEXCOORD, midgray_lum);
  
  float _385 = _381.x * 1.0499999523162842f;
  float _386 = _381.y * 1.0499999523162842f;
  float _387 = _381.z * 1.0499999523162842f;
  [branch]
  if (!((uint)(bOutputInHDR) == 0)) {
    float _399 = (pow(_385, 0.012683313339948654f));
    float _400 = (pow(_386, 0.012683313339948654f));
    float _401 = (pow(_387, 0.012683313339948654f));
    float _434 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_399 + -0.8359375f)) / (18.8515625f - (_399 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / EditorNITLevel));
    float _435 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_400 + -0.8359375f)) / (18.8515625f - (_400 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / EditorNITLevel));
    float _436 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_401 + -0.8359375f)) / (18.8515625f - (_401 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / EditorNITLevel));
    _462 = min((_434 * 12.920000076293945f), ((exp2(log2(max(_434, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _463 = min((_435 * 12.920000076293945f), ((exp2(log2(max(_435, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _464 = min((_436 * 12.920000076293945f), ((exp2(log2(max(_436, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _462 = _385;
    _463 = _386;
    _464 = _387;
  }
  float _471 = (frac(sin((TEXCOORD_2.w * 543.3099975585938f) + TEXCOORD_2.z) * 493013.0f) * 2.0f) + -1.0f;
  float _474 = min(max((_471 * 0x7FF0000000000000), -1.0f), 1.0f);
  float _483 = (_474 - (sqrt(saturate(1.0f - abs(_471))) * _474)) * BackbufferQuantizationDithering;
  SV_Target.x = (_483 + _462);
  SV_Target.y = (_483 + _463);
  SV_Target.z = (_483 + _464);
  SV_Target.w = 0.0f;
  SV_Target_1 = dot(float3(_385, _386, _387), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f));
