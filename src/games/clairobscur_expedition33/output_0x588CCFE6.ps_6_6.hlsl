...
OutputSignature main(
  ...
  float4 _240 = ColorGradingLUT.Sample(ColorGradingLUTSampler, float3(((LUTScale * saturate((log2((((((BloomDirtMaskTint.x * _89.x) + 1.0f) * _70.x) * _197) + 0.002667719265446067f) + (((ColorScale0.x * _46.x) * _120) * _198)) * 0.0714285746216774f) + 0.6107269525527954f)) + LUTOffset), ((LUTScale * saturate((log2((((((BloomDirtMaskTint.y * _89.y) + 1.0f) * _70.y) * _197) + 0.002667719265446067f) + (((ColorScale0.y * _46.y) * _121) * _198)) * 0.0714285746216774f) + 0.6107269525527954f)) + LUTOffset), ((LUTScale * saturate((log2((((((BloomDirtMaskTint.z * _89.z) + 1.0f) * _70.z) * _197) + 0.002667719265446067f) + (((ColorScale0.z * _46.z) * _122) * _198)) * 0.0714285746216774f) + 0.6107269525527954f)) + LUTOffset)));
  ...
  float _246 = _240.z * 1.0499999523162842f;
  [branch]
  if (!((uint)(bOutputInHDR) == 0)) {
    float _258 = (pow(_244, 0.012683313339948654f));
    float _259 = (pow(_245, 0.012683313339948654f));
    float _260 = (pow(_246, 0.012683313339948654f));
    float _293 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_258 + -0.8359375f)) / (18.8515625f - (_258 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / EditorNITLevel));
    float _294 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_259 + -0.8359375f)) / (18.8515625f - (_259 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / EditorNITLevel));
    float _295 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_260 + -0.8359375f)) / (18.8515625f - (_260 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / EditorNITLevel));
    _321 = min((_293 * 12.920000076293945f), ((exp2(log2(max(_293, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _322 = min((_294 * 12.920000076293945f), ((exp2(log2(max(_294, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  ...
  float _330 = (frac(sin((TEXCOORD_2.w * 543.3099975585938f) + TEXCOORD_2.z) * 493013.0f) * 2.0f) + -1.0f;
  float _333 = min(max((_330 * 0x7FF0000000000000), -1.0f), 1.0f);
  float _342 = (_333 - (sqrt(saturate(1.0f - abs(_330))) * _333)) * BackbufferQuantizationDithering;
  SV_Target.x = (_342 + _321);
  SV_Target.y = (_342 + _322);
  SV_Target.z = (_342 + _323);
  SV_Target.w = 0.0f;
  SV_Target_1 = dot(float3(_244, _245, _246), float3(0.29899999499320984f, 0.5870000123977661f, 0.11400000005960464f));
