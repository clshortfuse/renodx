...
float4 main(
  ...
  if ((((bool)(((_11.w) > 0.0f))) && ((bool)(((_11.w) < 1.0f))))) {
    ...
    float _114 = ((((1.0f / (((dot(float3(_104, _105, _106), float3(0.26269999146461487f, 0.6779999732971191f, 0.059300001710653305f))) / ($Globals_000x)) + 1.0f)) * ($Globals_000x)) + -1.0f) * (_11.w)) + 1.0f;
    _119 = (_114 * _104);
    _120 = (_114 * _105);
    _121 = (_114 * _106);
  }
  float _122 = 1.0f - (_11.w);
  float _141 = exp2(((log2((((_119 * _122) + ((($Globals_000y) * (mad(0.043313056230545044f, _42, (mad(0.3292830288410187f, _41, (_40 * 0.6274039149284363f)))))) * ($Globals_000x))) * 9.999999747378752e-05f))) * 0.1593017578125f));
  float _142 = exp2(((log2((((_120 * _122) + ((($Globals_000y) * (mad(0.011362319812178612f, _42, (mad(0.919540286064148f, _41, (_40 * 0.06909731030464172f)))))) * ($Globals_000x))) * 9.999999747378752e-05f))) * 0.1593017578125f));
  float _143 = exp2(((log2((((_121 * _122) + ((($Globals_000y) * (mad(0.8955953121185303f, _42, (mad(0.08801331371068954f, _41, (_40 * 0.016391439363360405f)))))) * ($Globals_000x))) * 9.999999747378752e-05f))) * 0.1593017578125f));
