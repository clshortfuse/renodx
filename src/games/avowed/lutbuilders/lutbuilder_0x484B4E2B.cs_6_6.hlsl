...
void main(
  ...
  float _1071 = (tonemapCurveAmount * (max(0.0f, (lerp(_1051, _1048, 0.9300000071525574f))) - _767)) + _767;
  float _1072 = (tonemapCurveAmount * (max(0.0f, (lerp(_1051, _1049, 0.9300000071525574f))) - _768)) + _768;
  float _1073 = (tonemapCurveAmount * (max(0.0f, (lerp(_1051, _1050, 0.9300000071525574f))) - _769)) + _769;
