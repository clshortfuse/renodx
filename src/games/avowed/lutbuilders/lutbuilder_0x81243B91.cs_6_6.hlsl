...
void main(
 ...
 uint SV_GroupIndex : SV_GroupIndex
  ...
  float _53 = 1.3792141675949097f;
  float _54 = -0.30886411666870117f;
  float _55 = -0.0703500509262085f;
  float _56 = -0.06933490186929703f;
  float _57 = 1.08229660987854f;
  float _58 = -0.012961871922016144f;
  float _59 = -0.0021590073592960835f;
  float _60 = -0.0454593189060688f;
  float _61 = 1.0476183891296387f;
  float _119;
  float _120;
  float _121;
  float _644;
  ...
  if (!((((uint)(cb0_041x)) == 1))) {
    ...
    if (!((((uint)(cb0_041x)) == 2))) {
      ...
      if (!((((uint)(cb0_041x)) == 3))) {
        ...
        _53 = ((_42 ? 1.0f : 1.705051064491272f));
        _54 = ((_42 ? 0.0f : -0.6217921376228333f));
        _55 = ((_42 ? 0.0f : -0.0832589864730835f));
        _56 = ((_42 ? 0.0f : -0.13025647401809692f));
        _57 = ((_42 ? 1.0f : 1.140804648399353f));
        _58 = ((_42 ? 0.0f : -0.010548308491706848f));
        _59 = ((_42 ? 0.0f : -0.024003351107239723f));
        _60 = ((_42 ? 0.0f : -0.1289689838886261f));
        _61 = ((_42 ? 1.0f : 1.1529725790023804f));
      }
    }
  }
  if (((((uint)(cb0_040w)) > 2))) {
  ...
  float _548 = ((_430 * ((((cb0_019z) + (cb0_034z)) + _327) + ((((cb0_018z) * (cb0_033z)) * _336) * (exp2(((log2(((exp2(((((cb0_016z) * (cb0_031z)) * _354) * (log2(((max(0.0f, (((((cb0_015z) * (cb0_030z)) * _363) * _256) + _180))) * 5.55555534362793f)))))) * 0.18000000715255737f))) * (1.0f / (((cb0_017z) * (cb0_032z)) * _345)))))))) + (_318 * ((((cb0_019z) + (cb0_024z)) + _194) + ((((cb0_018z) * (cb0_023z)) * _208) * (exp2(((log2(((exp2(((((cb0_016z) * (cb0_021z)) * _236) * (log2(((max(0.0f, (((((cb0_015z) * (cb0_020z)) * _250) * _256) + _180))) * 5.55555534362793f)))))) * 0.18000000715255737f))) * (1.0f / (((cb0_017z) * (cb0_022z)) * _222))))))))) + (((((cb0_019z) + (cb0_029z)) + _439) + ((((cb0_018z) * (cb0_028z)) * _448) * (exp2(((log2(((exp2(((((cb0_016z) * (cb0_026z)) * _466) * (log2(((max(0.0f, (((((cb0_015z) * (cb0_025z)) * _475) * _256) + _180))) * 5.55555534362793f)))))) * 0.18000000715255737f))) * (1.0f / (((cb0_017z) * (cb0_027z)) * _457))))))) * _533);
      ...
      float3 untonemapped_ap1 = float3(_544, _546, _548);  // CustomEdit
