...
void main(
  ...
  float _888 = (tonemapCurveAmount * (max(0.0f, (lerp(_868, _865, 0.9300000071525574f))) - _584)) + _584;
  float _889 = (tonemapCurveAmount * (max(0.0f, (lerp(_868, _866, 0.9300000071525574f))) - _585)) + _585;
  float _890 = (tonemapCurveAmount * (max(0.0f, (lerp(_868, _867, 0.9300000071525574f))) - _586)) + _586;
