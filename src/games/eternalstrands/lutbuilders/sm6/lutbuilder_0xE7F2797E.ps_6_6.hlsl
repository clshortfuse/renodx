...
float4 main(
  ...
  float _855 = saturate(max(0.0f, mad((WorkingColorSpace_FromAP1[0].z), _830, mad((WorkingColorSpace_FromAP1[0].y), _829, ((WorkingColorSpace_FromAP1[0].x) * _828)))));
  float _856 = saturate(max(0.0f, mad((WorkingColorSpace_FromAP1[1].z), _830, mad((WorkingColorSpace_FromAP1[1].y), _829, ((WorkingColorSpace_FromAP1[1].x) * _828)))));
  float _857 = saturate(max(0.0f, mad((WorkingColorSpace_FromAP1[2].z), _830, mad((WorkingColorSpace_FromAP1[2].y), _829, ((WorkingColorSpace_FromAP1[2].x) * _828)))));
  ...
  if (RENODX_TONE_MAP_TYPE != 0) {
    return GenerateOutput(float3(_1009, _1010, _1011), OutputDevice);
  }

  if ((uint)(WorkingColorSpace_bIsSRGB) == 0) {
    float _1030 = mad((WorkingColorSpace_ToAP1[0].z), _1011, mad((WorkingColorSpace_ToAP1[0].y), _1010, ((WorkingColorSpace_ToAP1[0].x) * _1009)));
    float _1033 = mad((WorkingColorSpace_ToAP1[1].z), _1011, mad((WorkingColorSpace_ToAP1[1].y), _1010, ((WorkingColorSpace_ToAP1[1].x) * _1009)));
    float _1036 = mad((WorkingColorSpace_ToAP1[2].z), _1011, mad((WorkingColorSpace_ToAP1[2].y), _1010, ((WorkingColorSpace_ToAP1[2].x) * _1009)));
