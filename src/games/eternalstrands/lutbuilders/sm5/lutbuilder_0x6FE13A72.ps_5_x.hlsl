...
// ---- Created with 3Dmigoto v1.4.1 on Thu Jul 17 23:39:13 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = cmp(asuint(cb0[65].z) >= 3);
  if (r0.w != 0) {
    r1.xy = float2(-0.015625,-0.015625) + v0.xy;
    r1.xy = float2(1.03225803,1.03225803) * r1.xy;
    r1.xy = log2(r1.xy);
    r1.z = log2(r0.z);
    ...
    r1.xyz = exp2(r1.xyz);
    r1.xyz = float3(100,100,100) * r1.xyz;
  } else {
    ...
    r0.xyz = exp2(r0.xyz);
    r1.xyz = r0.xyz * float3(0.180000007,0.180000007,0.180000007) + float3(-0.00266771927,-0.00266771927,-0.00266771927);
  }
