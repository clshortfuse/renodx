...
renodx::utils::settings::Settings info_settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .label = std::string("Requires scene change for most settings to apply. Changing ingame brightness slider will force this."),
        .section = "About",
    },
        new renodx::utils::settings::Setting{
        .value_type = renodx::utils::settings::SettingValueType::TEXT,
        .label = std::string("Downgrade to CNN based framegen (dll 3.8.1) to avoid flickering highlights with framegen enabled."),
        .section = "About",
    },
    new renodx::utils::settings::Setting{
        .value_type = renodx::utils::settings::SettingValueType::TEXT,
        .label = std::string("Custom Build of Universal Unreal Addon by Scrungus and Dadveeb."),
        .section = "About",
    },
    new renodx::utils::settings::Setting{
        .value_type = renodx::utils::settings::SettingValueType::TEXT,
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Eternal Strands";
