  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.yw = Global.c[15].xy * r0.yz;
  r1.y = PostProcess.Settings[13].w * r0.z * injectedData.fxVignette;
  r0.z = dot(r0.yw, r0.yw);
  r0.z = sqrt(r0.z);
  r0.z = PostProcess.Settings[2].w * r0.z;
  r0.x = r0.z * r0.x;
  r2.xw = User.c[2].xy;
  r2.yz = float2(0,0);
  r1.zw = -User.c[2].zw + v1.zw;
  r2.xyzw = r1.zwzw + r2.xyzw;
  r3.xyz = s0.SampleLevel(s0Sampler_s, r2.xy, r0.x).xyz;
  r2.xyz = s0.SampleLevel(s0Sampler_s, r2.zw, r0.x).xyz;
  r4.xyz = s0.SampleLevel(s0Sampler_s, r1.zw, r0.x).xyz;
  r1.zw = User.c[2].xy + r1.zw;
  r5.xyz = s0.SampleLevel(s0Sampler_s, r1.zw, r0.x).xyz;
  r3.xyz = r4.xyz + r3.xyz;
  r2.xyz = r3.xyz + r2.xyz;
  r2.xyz = r2.xyz + r5.xyz;
  r3.xyzw = s0.SampleLevel(s0Sampler_s, v1.zw, r0.x).xyzw;
  r2.xyz = r3.xyz * float3(4,4,4) + -r2.xyz;
  r1.zw = r0.yw * PostProcess.Settings[2].zz * injectedData.fxChroma + v1.zw;
  r0.yz = -r0.yw * PostProcess.Settings[2].zz * injectedData.fxChroma + v1.zw;
  r0.z = s0.SampleLevel(s0Sampler_s, r0.yz, r0.x).y;
  r0.y = s0.SampleLevel(s0Sampler_s, r1.zw, r0.x).x;
  r0.w = r3.z;
  if (Global.c[0].x == 0.f) {
    r0.xyz = r2.xyz * PostProcess.Settings[0].www + r0.yzw;
  } else {
    r0.xyz = r2.xyz * PostProcess.Settings[0].www * injectedData.fxSharpen + r0.yzw;
  }
  ...
  r0.w = dot(r2.xyzw, Global.c[56].xyzw);
  ...
  r1.zw = r1.zz * PostProcess.Settings[7].xy + v1.xy;
  r1.zw = s5.Sample(s5Sampler_s, r1.zw).zw;
  r1.z = r1.z + -r2.z;
  r2.z = abs(r1.w) * r1.z + r2.z;
  r2.xyz = r2.xyz + -r0.xyz;
  r1.z = -1 + PostProcess.Settings[7].w;
  r0.w = saturate(r0.w / r1.z);
  if (Global.c[0].x == 0.f) {
    r0.xyz = r0.www * r2.xyz + r0.xyz;
  } else {
    r0.xyz = r0.www * r2.xyz * injectedData.fxDoF + r0.xyz;
  }
