  ...
  out float4 o0 : SV_Target0)
{
  ...
  r5.xyz = s0.SampleLevel(s0Sampler_s, r4.xy, r0.y).xyz;
  r4.xyz = s0.SampleLevel(s0Sampler_s, r4.zw, r0.y).xyz;
  r6.xyz = s0.SampleLevel(s0Sampler_s, r0.zw, r0.y).xyz;
  r0.zw = User.c[2].xy + r0.zw;
  r7.xyz = s0.SampleLevel(s0Sampler_s, r0.zw, r0.y).xyz;
  r5.xyz = r6.xyz + r5.xyz;
  r4.xyz = r5.xyz + r4.xyz;
  r4.xyz = r4.xyz + r7.xyz;
  r5.xyzw = s0.SampleLevel(s0Sampler_s, v1.zw, r0.y).xyzw;
  ...
  r2.z = r5.z;
  if (Global.c[0].x == 0.f) {
    r0.yzw = r4.xyz * PostProcess.Settings[0].www + r2.xyz;
  } else {
    r0.yzw = r4.xyz * PostProcess.Settings[0].www * injectedData.fxSharpen + r2.xyz;
  }
  r2.xyz = float3(0.5,0.5,0.5) * r5.xyz;
