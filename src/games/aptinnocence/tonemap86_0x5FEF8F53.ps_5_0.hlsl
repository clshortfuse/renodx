  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.zw = -User.c[2].zw * r2.zw + r0.zw;
  r2.xy = User.c[2].xy * r2.xy + r1.zw;
  r2.xyz = s0.SampleLevel(s0Sampler_s, r2.xy, r0.x).xyz;
  r3.yz = float2(0,0);
  r3.xyzw = r1.zwzw + r3.xyzw;
  r4.xyz = s0.SampleLevel(s0Sampler_s, r1.zw, r0.x).xyz;
  r5.xyz = s0.SampleLevel(s0Sampler_s, r3.xy, r0.x).xyz;
  r3.xyz = s0.SampleLevel(s0Sampler_s, r3.zw, r0.x).xyz;
  r4.xyz = r5.xyz + r4.xyz;
  r3.xyz = r4.xyz + r3.xyz;
  r2.xyz = r3.xyz + r2.xyz;
  r3.xyzw = s0.SampleLevel(s0Sampler_s, r0.zw, r0.x).xyzw;
  r2.xyz = r3.xyz * float3(4,4,4) + -r2.xyz;
  r1.zw = r1.xy * PostProcess.Settings[2].zz * injectedData.fxChroma + r0.zw;
  r0.yz = -r1.xy * PostProcess.Settings[2].zz * injectedData.fxChroma + r0.zw;
