  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyz = s8.Sample(s8Sampler_s, r0.xy).xyz;
  r1.xyz = r1.xyz * PostProcess.Settings[4].www * injectedData.fxLens + PostProcess.Settings[4].zzz * injectedData.fxBloom;
  r2.xyz = s2.Sample(s2Sampler_s, r0.zw).xyz;
  r0.xyzw = s0.SampleLevel(s0Sampler_s, r0.zw, 0).xyzw;
  o0.w = r0.w;
