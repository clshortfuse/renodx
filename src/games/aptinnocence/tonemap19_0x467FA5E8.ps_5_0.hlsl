  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.x = r2.w * r2.x;
  r3.xy = r2.yz * PostProcess.Settings[2].zz * injectedData.fxChroma + r0.zw;
  r2.yz = -r2.yz * PostProcess.Settings[2].zz * injectedData.fxChroma + r0.zw;
  r4.y = s0.SampleLevel(s0Sampler_s, r2.yz, r2.x).y;
  r4.x = s0.SampleLevel(s0Sampler_s, r3.xy, r2.x).x;
  r4.zw = s0.SampleLevel(s0Sampler_s, r0.zw, r2.x).zw;
