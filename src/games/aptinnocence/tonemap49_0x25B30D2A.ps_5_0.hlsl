  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.yzw = s8.Sample(s8Sampler_s, v1.xy).xyz;
  r0.yzw = r0.yzw * PostProcess.Settings[4].www * injectedData.fxLens + PostProcess.Settings[4].zzz * injectedData.fxBloom;
  r2.xyz = s2.Sample(s2Sampler_s, v1.zw).xyz;
  r3.xyzw = s0.SampleLevel(s0Sampler_s, v1.zw, 0).xyzw;
  o0.w = r3.w;
  ...
  r0.w = v1.w * 2 + -1;
  r2.y = PostProcess.Settings[13].w * r0.w * injectedData.fxVignette;
  r2.x = v1.z * 2 + -1;
