  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.zw = s0.SampleLevel(s0Sampler_s, v1.zw, r0.z).zw;
  r0.xyz = r1.xyz;
  ...
  r1.x = min(r1.x, r1.y);
  r1.y = -r1.x + r0.w;
  r1.y = PostProcess.Settings[5].w * r1.y;
  r1.x = -PostProcess.Settings[5].y + r1.x;
  r0.w = r1.x * r0.w;
  r0.w = r1.y / r0.w;
  r1.x = min(0, r0.w);
  r1.x = PostProcess.Settings[7].z * r1.x;
  r1.y = PostProcess.Settings[6].w * PostProcess.Settings[5].x + 1;
  r1.y = rcp(r1.y);
  r0.w = max(0, r0.w);
  r0.w = r1.x * r1.y + r0.w;
  r1.x = min(r2.w, r0.w);
  r0.w = max(abs(r1.x), abs(r0.w));
  r0.w = min(1, r0.w);
  r1.x = PostProcess.Settings[6].x * r0.w;
  r1.xy = r1.xx * PostProcess.Settings[7].xy + v1.xy;
