  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.z = dot(r2.xyzw, Global.c[56].xyzw);
  ...
  r3.x = PostProcess.Settings[6].w * PostProcess.Settings[5].x + PostProcess.Settings[5].x;
  r0.w = max(r0.z, r0.w);
  r0.w = min(r0.w, r3.x);
  r3.x = r0.z + -r0.w;
  r3.x = PostProcess.Settings[5].w * r3.x;
  r0.w = -PostProcess.Settings[5].y + r0.w;
  r0.z = r0.z * r0.w;
  r0.z = r3.x / r0.z;
  r0.w = min(0, r0.z);
  r0.w = PostProcess.Settings[7].z * r0.w;
  r3.x = PostProcess.Settings[6].w * PostProcess.Settings[5].x + 1;
  r3.x = rcp(r3.x);
  r0.z = max(0, r0.z);
  r0.z = r0.w * r3.x + r0.z;
  r0.w = min(r2.w, r0.z);
