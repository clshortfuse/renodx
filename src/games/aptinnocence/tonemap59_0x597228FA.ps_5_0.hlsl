  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.zw = -User.c[2].zw * r3.zw + r0.zw;
  r3.xy = User.c[2].xy * r3.xy + r2.zw;
  r3.xyz = s0.SampleLevel(s0Sampler_s, r3.xy, r0.x).xyz;
  r4.yz = float2(0,0);
  r4.xyzw = r2.zwzw + r4.xyzw;
  r5.xyz = s0.SampleLevel(s0Sampler_s, r2.zw, r0.x).xyz;
  r6.xyz = s0.SampleLevel(s0Sampler_s, r4.xy, r0.x).xyz;
  r4.xyz = s0.SampleLevel(s0Sampler_s, r4.zw, r0.x).xyz;
  r5.xyz = r6.xyz + r5.xyz;
  r4.xyz = r5.xyz + r4.xyz;
  r3.xyz = r4.xyz + r3.xyz;
  r4.xyzw = s0.SampleLevel(s0Sampler_s, r0.zw, r0.x).xyzw;
  r3.xyz = r4.xyz * float3(4,4,4) + -r3.xyz;
  r2.zw = r2.xy * PostProcess.Settings[2].zz * injectedData.fxChroma + r0.zw;
  r0.yz = -r2.xy * PostProcess.Settings[2].zz * injectedData.fxChroma + r0.zw;
  r0.z = s0.SampleLevel(s0Sampler_s, r0.yz, r0.x).y;
  r0.y = s0.SampleLevel(s0Sampler_s, r2.zw, r0.x).x;
  r0.w = r4.z;
  if (Global.c[0].x == 0.f) {
    r0.xyz = r3.xyz * PostProcess.Settings[0].www + r0.yzw;
  } else {
    r0.xyz = r3.xyz * PostProcess.Settings[0].www * injectedData.fxSharpen + r0.yzw;
  }
