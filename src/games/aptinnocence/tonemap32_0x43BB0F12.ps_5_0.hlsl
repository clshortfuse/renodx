  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyzw = s0.SampleLevel(s0Sampler_s, r0.zw, r0.x).xyzw;
  ...
  r0.yz = -User.c[2].zw * r3.zw + r0.zw;
  r5.xyz = s0.SampleLevel(s0Sampler_s, r0.yz, r0.x).xyz;
  r4.yz = float2(0,0);
  r4.xyzw = r4.xyzw + r0.yzyz;
  r6.xyz = s0.SampleLevel(s0Sampler_s, r4.xy, r0.x).xyz;
  r4.xyz = s0.SampleLevel(s0Sampler_s, r4.zw, r0.x).xyz;
  r0.yz = User.c[2].xy * r3.xy + r0.yz;
  ...
  r2.z = r1.z;
  if (Global.c[0].x == 0.f) {
    r0.xyz = r0.xyz * PostProcess.Settings[0].www + r2.xyz;
  } else {
    r0.xyz = r0.xyz * PostProcess.Settings[0].www * injectedData.fxSharpen + r2.xyz;
  }
  r2.xyz = float3(0.5,0.5,0.5) * r1.xyz;
  r1.xyz = r1.xyz + r1.xyz;
  r0.xyz = max(r2.xyz, r0.xyz);
  r0.xyz = min(r0.xyz, r1.xyz);
