  ...
  out float4 o0 : SV_Target0)
{
  ...
  r5.xyzw = s0.SampleLevel(s0Sampler_s, r0.zw, 0).xyzw;
  r0.zw = User.c[2].xy * r3.xy + r0.xy;
  r1.yzw = s0.SampleLevel(s0Sampler_s, r0.zw, 0).xyz;
  r4.yz = float2(0,0);
  r3.xyzw = r0.xyxy + r4.xyzw;
  r0.xyz = s0.SampleLevel(s0Sampler_s, r0.xy, 0).xyz;
  r4.xyz = s0.SampleLevel(s0Sampler_s, r3.xy, 0).xyz;
  r3.xyz = s0.SampleLevel(s0Sampler_s, r3.zw, 0).xyz;
  r0.xyz = r4.xyz + r0.xyz;
  r0.xyz = r0.xyz + r3.xyz;
  r0.xyz = r0.xyz + r1.yzw;
  r0.xyz = r5.xyz * float3(4,4,4) + -r0.xyz;
  if (Global.c[0].x == 0.f) {
    r0.xyz = r0.xyz * PostProcess.Settings[0].www + r5.xyz;
  } else {
    r0.xyz = r0.xyz * PostProcess.Settings[0].www * injectedData.fxSharpen + r5.xyz;
  }
  r1.yzw = float3(0.5,0.5,0.5) * r5.xyz;
  r0.xyz = max(r1.yzw, r0.xyz);
  r1.yzw = r5.xyz + r5.xyz;
  o0.w = r5.w;
  r0.xyz = min(r1.yzw, r0.xyz);
  ...
  if (Global.c[0].x == 0.f) {
    ...
    r0.xyz = r0.www * r1.yzw * injectedData.fxDoF + r0.xyz;
  }
