  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyw = s0.SampleLevel(s0Sampler_s, r0.zw, r1.z).xyz;
  r6.yz = float2(0,0);
  r6.xyzw = r6.xyzw + r0.zwzw;
  r7.xyz = s0.SampleLevel(s0Sampler_s, r6.xy, r1.z).xyz;
  r6.xyz = s0.SampleLevel(s0Sampler_s, r6.zw, r1.z).xyz;
  r0.zw = User.c[2].xy * r5.xy + r0.zw;
  r5.xyz = s0.SampleLevel(s0Sampler_s, r0.zw, r1.z).xyz;
  r1.xyz = r7.xyz + r1.xyw;
