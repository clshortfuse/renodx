  ...
  out float4 o0 : SV_Target0)
{
  ...
  r5.zw = -User.c[2].zw * r5.zw + r0.zw;
  r7.xyz = s0.SampleLevel(s0Sampler_s, r5.zw, r1.w).xyz;
  r6.yz = float2(0,0);
  r6.xyzw = r6.xyzw + r5.zwzw;
  r8.xyz = s0.SampleLevel(s0Sampler_s, r6.xy, r1.w).xyz;
  r6.xyz = s0.SampleLevel(s0Sampler_s, r6.zw, r1.w).xyz;
  r5.xy = User.c[2].xy * r5.xy + r5.zw;
  r5.xyz = s0.SampleLevel(s0Sampler_s, r5.xy, r1.w).xyz;
  r7.xyz = r8.xyz + r7.xyz;
  r6.xyz = r7.xyz + r6.xyz;
  r5.xyz = r6.xyz + r5.xyz;
  r5.xyz = r2.xyz * float3(4,4,4) + -r5.xyz;
  r4.z = r2.z;
  if (Global.c[0].x == 0.f) {
    r4.xyz = r5.xyz * PostProcess.Settings[0].www + r4.xyz;
  } else {
    r4.xyz = r5.xyz * PostProcess.Settings[0].www * injectedData.fxSharpen + r4.xyz;
  }
  ...
  r1.w = dot(r3.xyzw, Global.c[56].xyzw);
