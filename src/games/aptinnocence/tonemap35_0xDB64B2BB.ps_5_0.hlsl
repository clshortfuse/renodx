  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.x = s0.SampleLevel(s0Sampler_s, r2.zw, r1.w).x;
  r3.y = s0.SampleLevel(s0Sampler_s, r2.xy, r1.w).y;
  r2.xyzw = s0.SampleLevel(s0Sampler_s, r0.zw, r1.w).xyzw;
  ...
  r6.xyz = s0.SampleLevel(s0Sampler_s, r4.zw, r1.w).xyz;
  r5.yz = float2(0,0);
  r5.xyzw = r5.xyzw + r4.zwzw;
  r7.xyz = s0.SampleLevel(s0Sampler_s, r5.xy, r1.w).xyz;
  r5.xyz = s0.SampleLevel(s0Sampler_s, r5.zw, r1.w).xyz;
  r4.xy = User.c[2].xy * r4.xy + r4.zw;
  r4.xyz = s0.SampleLevel(s0Sampler_s, r4.xy, r1.w).xyz;
  r6.xyz = r7.xyz + r6.xyz;
  r5.xyz = r6.xyz + r5.xyz;
  r4.xyz = r5.xyz + r4.xyz;
  r4.xyz = r2.xyz * float3(4,4,4) + -r4.xyz;
  r3.z = r2.z;
  if (Global.c[0].x == 0.f) {
    r3.xyz = r4.xyz * PostProcess.Settings[0].www + r3.xyz;
  } else {
    r3.xyz = r4.xyz * PostProcess.Settings[0].www * injectedData.fxSharpen + r3.xyz;
  }
  r4.xyz = float3(0.5,0.5,0.5) * r2.xyz;
  r2.xyz = r2.xyz + r2.xyz;
  r3.xyz = max(r4.xyz, r3.xyz);
  r2.xyz = min(r3.xyz, r2.xyz);
  r3.xyz = s2.Sample(s2Sampler_s, r0.zw).xyz;
