  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.x = s7.Sample(s7Sampler_s, float2(0.5,0.5)).x;
  r2.y = 1;
  r2.z = dot(r2.xy, Global.c[55].zw);
  r2.x = dot(r2.xy, Global.c[56].zw);
  r2.x = r2.z / r2.x;
  r2.y = -PostProcess.Settings[6].w * r2.x + r2.x;
  r2.z = PostProcess.Settings[6].w * r2.x + r2.x;
  r2.y = max(r2.y, r0.w);
  r2.y = min(r2.y, r2.z);
  r2.z = -r2.y + r0.w;
  ...
  r2.x = PostProcess.Settings[6].w * r2.x + 1;
  r2.x = rcp(r2.x);
  r0.w = max(0, r0.w);
  r0.w = r2.y * r2.x + r0.w;
  r1.w = min(r1.w, r0.w);
