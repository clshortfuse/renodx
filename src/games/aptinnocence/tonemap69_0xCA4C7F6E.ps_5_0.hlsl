  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.zw = -User.c[2].zw * r5.zw + r0.zw;
  r7.xyz = s0.SampleLevel(s0Sampler_s, r0.zw, r1.w).xyz;
  r6.yz = float2(0,0);
  r6.xyzw = r6.xyzw + r0.zwzw;
  r8.xyz = s0.SampleLevel(s0Sampler_s, r6.xy, r1.w).xyz;
  r6.xyz = s0.SampleLevel(s0Sampler_s, r6.zw, r1.w).xyz;
  r0.zw = User.c[2].xy * r5.xy + r0.zw;
  r5.xyz = s0.SampleLevel(s0Sampler_s, r0.zw, r1.w).xyz;
