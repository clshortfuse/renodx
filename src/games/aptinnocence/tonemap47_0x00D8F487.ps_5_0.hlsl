  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.xy = r2.ww * PostProcess.Settings[7].xy + r0.xy;
  ...
  r0.xy = s5.Sample(s5Sampler_s, r3.xy).zw;
  r0.x = r0.x + -r2.z;
  ...
  r5.y = s0.SampleLevel(s0Sampler_s, r3.xy, r0.x).y;
  r5.x = s0.SampleLevel(s0Sampler_s, r3.zw, r0.x).x;
  r5.zw = s0.SampleLevel(s0Sampler_s, r0.zw, r0.x).zw;
