  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.yzw = s8.Sample(s8Sampler_s, v1.xy).xyz;
  r2.yzw = r2.yzw * PostProcess.Settings[4].www * injectedData.fxLens + PostProcess.Settings[4].zzz * injectedData.fxBloom;
  r1.yzw = r1.yzw + -r0.xyz;
  r0.xyz = r2.yzw * r1.yzw + r0.xyz;
  ...
  if (Global.c[0].x == 0.f) {
    ...
    r0.xyz = r1.xxx * r1.yzw * injectedData.fxDoF + r0.xyz;
  }
  r1.x = s1.Load(int3(0,0,0)).x;
  r0.xyz = lerp(1.f, r1.xxx, injectedData.fxAutoExposure) * r0.xyz;
  r1.y = PostProcess.Settings[13].w * r2.x * injectedData.fxVignette;
  r1.x = v1.z * 2 + -1;
