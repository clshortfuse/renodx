  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.w = r2.x * r1.w;
  r1.z = r1.z * r1.w;
  r2.xy = r1.xy * PostProcess.Settings[2].zz * injectedData.fxChroma + r0.zw;
  r1.xy = -r1.xy * PostProcess.Settings[2].zz * injectedData.fxChroma + r0.zw;
  r2.x = s0.SampleLevel(s0Sampler_s, r2.xy, r1.z).x;
  r2.y = s0.SampleLevel(s0Sampler_s, r1.xy, r1.z).y;
  r3.xyzw = s0.SampleLevel(s0Sampler_s, r0.zw, r1.z).xyzw;
  ...
  r1.xy = -User.c[2].zw * r4.zw + r0.zw;
  r6.xyz = s0.SampleLevel(s0Sampler_s, r1.xy, r1.z).xyz;
  r5.yz = float2(0,0);
  r5.xyzw = r5.xyzw + r1.xyxy;
  r7.xyz = s0.SampleLevel(s0Sampler_s, r5.xy, r1.z).xyz;
  r5.xyz = s0.SampleLevel(s0Sampler_s, r5.zw, r1.z).xyz;
  r1.xy = User.c[2].xy * r4.xy + r1.xy;
  ...
  r2.z = r3.z;
  if (Global.c[0].x == 0.f) {
    r1.xyz = r1.xyz * PostProcess.Settings[0].www + r2.xyz;
  } else {
    r1.xyz = r1.xyz * PostProcess.Settings[0].www * injectedData.fxSharpen + r2.xyz;
  }
