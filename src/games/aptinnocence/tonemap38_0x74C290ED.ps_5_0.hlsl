  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.x = sqrt(r0.x);
  r0.y = s7.Sample(s7Sampler_s, float2(0.5,0.5)).x;
  r0.z = 1;
  r0.w = dot(r0.yz, Global.c[55].zw);
  r0.y = dot(r0.yz, Global.c[56].zw);
  r0.y = r0.w / r0.y;
  r0.z = -PostProcess.Settings[6].w * r0.y + r0.y;
  r0.z = max(r0.x, r0.z);
  r0.w = PostProcess.Settings[6].w * r0.y + r0.y;
  r0.y = PostProcess.Settings[6].w * r0.y + 1;
  r0.y = rcp(r0.y);
  r0.z = min(r0.z, r0.w);
  r0.w = r0.x + -r0.z;
  r0.z = -PostProcess.Settings[5].y + r0.z;
  r0.x = r0.x * r0.z;
  r0.z = PostProcess.Settings[5].w * r0.w;
  r0.x = r0.z / r0.x;
  r0.z = min(0, r0.x);
  r0.x = max(0, r0.x);
