  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyzw = s0.SampleLevel(s0Sampler_s, r0.xy, 0).xyzw;
  r2.xyzw = r0.xyxy / User.c[2].xyxy;
  ...
  r0.zw = -User.c[2].zw * r2.zw + r0.xy;
  r4.xyz = s0.SampleLevel(s0Sampler_s, r0.zw, 0).xyz;
  r3.yz = float2(0,0);
  r3.xyzw = r3.xyzw + r0.zwzw;
  r5.xyz = s0.SampleLevel(s0Sampler_s, r3.xy, 0).xyz;
  r3.xyz = s0.SampleLevel(s0Sampler_s, r3.zw, 0).xyz;
  r0.zw = User.c[2].xy * r2.xy + r0.zw;
  r2.xyz = s0.SampleLevel(s0Sampler_s, r0.zw, 0).xyz;
  ...
  r0.z = s1.Load(int3(0,0,0)).x;
  r1.xyz = r1.xyz * lerp(1.f, r0.zzz, injectedData.fxAutoExposure);
