  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.z = PostProcess.Settings[6].w * PostProcess.Settings[5].x + PostProcess.Settings[5].x;
  r2.y = max(r2.x, r2.y);
  r2.y = min(r2.y, r2.z);
  r2.z = r2.x + -r2.y;
  r2.z = PostProcess.Settings[5].w * r2.z;
  r2.y = -PostProcess.Settings[5].y + r2.y;
  r2.x = r2.x * r2.y;
  r2.x = r2.z / r2.x;
  r2.y = min(0, r2.x);
  r2.y = PostProcess.Settings[7].z * r2.y;
  r2.z = PostProcess.Settings[6].w * PostProcess.Settings[5].x + 1;
  r2.z = rcp(r2.z);
  r2.x = max(0, r2.x);
  r2.x = r2.y * r2.z + r2.x;
  r2.y = min(r3.w, r2.x);
  r2.x = max(abs(r2.y), abs(r2.x));
  r2.x = min(1, r2.x);
  r2.y = PostProcess.Settings[6].x * r2.x;
  r0.xy = r2.yy * PostProcess.Settings[7].xy + r0.xy;
  r0.xy = s5.Sample(s5Sampler_s, r0.xy).zw;
  r0.x = r0.x + -r3.z;
  r3.z = abs(r0.y) * r0.x + r3.z;
  r0.x = r2.x * PostProcess.Settings[6].x + -1;
  ...
  if (Global.c[0].x == 0.f) {
    ...
    r1.xyz = r0.xxx * r2.xyz * injectedData.fxDoF + r1.xyz;
  }
  r0.x = s1.Load(int3(0,0,0)).x;
  r1.xyz = r1.xyz * lerp(1.f, r0.xxx, injectedData.fxAutoExposure);
  ...
  r0.x = exp2(r0.x);
  r0.yzw = r1.xyz * PostProcess.Settings[12].xyz + -r1.xyz;
