  ...
  out float4 o0 : SV_Target0)
{
  ...
  r5.y = s0.SampleLevel(s0Sampler_s, r1.xy, r0.x).y;
  r5.x = s0.SampleLevel(s0Sampler_s, r1.zw, r0.x).x;
  r5.z = r4.z;
  if (Global.c[0].x == 0.f) {
    r1.xyz = r3.xyz * PostProcess.Settings[0].www + r5.xyz;
  } else {
    r1.xyz = r3.xyz * PostProcess.Settings[0].www * injectedData.fxSharpen + r5.xyz;
  }
