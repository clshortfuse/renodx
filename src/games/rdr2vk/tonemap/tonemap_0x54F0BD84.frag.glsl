...
void main() {
  ...
  vec3 _529 = min(_525 * texelFetch(_64, ivec2(0), 0).x, vec3(GetTonemapClampMax()));
  bool _530 = !_524;
  float _643;
  vec3 _644;
  if (_530) {
    ...
    if (floatBitsToInt(_69._m51.w) != 0) {
      ...
      float _622 = CUSTOM_VIGNETTE * max((dot(_618, _618) - _69._m53.x) * _69._m53.w, 0.0);
      bool _623 = _622 < 1.0;
...
#if 1
  vec3 _747 = ApplyToneMap(_681, _684, _643, _67._m6, _67._m4, _67._m10, _493.rgb, _494);
#else
  vec3 _747;
  if (_684) {
  ...
  if (_530) {
#if 1
    vec3 _902 = CompressLUTInput(_876, _816, _67._m5, _67._m7, _67._m8, _67._m9, _901);
#else
    float _895 = max(max(_876.x, max(_876.y, _876.z)), 9.9999997473787516355514526367188e-05);
    _901 = (_816 && (!(_67._m5 != 0u))) ? 1.0 : (((_895 > _67._m7) ? ((_895 * _67._m8) + _67._m9) : _895) / _895);
    vec3 _902 = _876 * _901;
#endif
    float _905 = _902.z;
...
#if 1
  _1034 = DecodeLUTInput(_1034, _876, _901);
#endif
  ...
  vec3 _1103 = _1040 + CUSTOM_DITHERING * (_1101 * mix(_69._m39.xyz, _69._m40.xyz, pow(clamp((mix(vec3(max(_1034.x, max(_1034.y, _1034.z))), _1040, bvec3(floatBitsToInt(_69._m41.w) != 0)) - _69._m42.xyz) * _69._m41.xyz, vec3(0.0), vec3(1.0)), vec3(_69._m42.w))));
