...
OutputSignature main(
  ...
  float _65;
  float4 _74;
  _11 = SrcTexture.SampleLevel(PointBorder, float2(TEXCOORD.x, TEXCOORD.y), 0.0f);

  if (TONE_MAP_TYPE != 0.f) {
    float3 untonemapped_ap1 = _11.rgb;

    SV_Target = float4(GenerateOutput(untonemapped_ap1, TEXCOORD, 1u), 1.f);
    SV_Target_1 = SV_Target;
    OutputSignature output_signature = { SV_Target, SV_Target_1 };
    return output_signature;
  }

  _17 = whitePaperNits * 0.009999999776482582f;
  _18 = _17 * _11.x;
  _19 = _17 * _11.y;
  _20 = _17 * _11.z;
  if (!(_18 <= 0.0f)) {
  ...
  _74 = SrcLUT.SampleLevel(TrilinearClamp, float3(((_35 * 0.984375f) + 0.0078125f), ((_50 * 0.984375f) + 0.0078125f), ((_65 * 0.984375f) + 0.0078125f)), 0.0f);
  SV_Target.x = _74.x;
  SV_Target.y = _74.y;
  SV_Target.z = _74.z;
  SV_Target.w = 1.0f;
