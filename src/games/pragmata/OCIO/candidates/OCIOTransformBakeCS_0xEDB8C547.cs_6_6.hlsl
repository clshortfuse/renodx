...
void main(
  ...
  float _334 = exp2(log2(saturate(((_312 * _166.x) + _307) + (_311 * _173.x))) * 0.012683313339948654f);
  float _335 = exp2(log2(saturate(((_312 * _166.y) + _308) + (_311 * _173.y))) * 0.012683313339948654f);
  float _336 = exp2(log2(saturate(((_312 * _166.z) + _309) + (_311 * _173.z))) * 0.012683313339948654f);
  float _358 = exp2(log2(max(0.0f, (_334 + -0.8359375f)) / (18.8515625f - (_334 * 18.6875f))) * 6.277394771575928f);
  float _361 = exp2(log2(max(0.0f, (_335 + -0.8359375f)) / (18.8515625f - (_335 * 18.6875f))) * 6.277394771575928f) * 100.0f;
  float _362 = exp2(log2(max(0.0f, (_336 + -0.8359375f)) / (18.8515625f - (_336 * 18.6875f))) * 6.277394771575928f) * 100.0f;

  // _362 = 99999.f;

  OutLUT[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))] = float4(mad(-0.07285170257091522f, _362, mad(-0.5876399874687195f, _361, (_358 * 166.04910278320312f))),
                                                                                                                     mad(-0.00834800023585558f, _362, mad(1.1328999996185303f, _361, (_358 * -12.454999923706055f))),
                                                                                                                     mad(1.1187299489974976f, _362, mad(-0.10057900100946426f, _361, (_358 * -1.8150999546051025f))), 1.0f);
}
