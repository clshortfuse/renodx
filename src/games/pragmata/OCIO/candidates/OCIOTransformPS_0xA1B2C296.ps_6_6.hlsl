...
float4 main(
  ...
  float _292 = exp2(log2(saturate(((_270 * _124.x) + _265) + (_269 * _131.x))) * 0.012683313339948654f);
  float _293 = exp2(log2(saturate(((_270 * _124.y) + _266) + (_269 * _131.y))) * 0.012683313339948654f);
  float _294 = exp2(log2(saturate(((_270 * _124.z) + _267) + (_269 * _131.z))) * 0.012683313339948654f);
  float _316 = exp2(log2(max(0.0f, (_292 + -0.8359375f)) / (18.8515625f - (_292 * 18.6875f))) * 6.277394771575928f);
  float _319 = exp2(log2(max(0.0f, (_293 + -0.8359375f)) / (18.8515625f - (_293 * 18.6875f))) * 6.277394771575928f) * 100.0f;
  float _320 = exp2(log2(max(0.0f, (_294 + -0.8359375f)) / (18.8515625f - (_294 * 18.6875f))) * 6.277394771575928f) * 100.0f;
  SV_Target.x = mad(-0.07285170257091522f, _320, mad(-0.5876399874687195f, _319, (_316 * 166.04910278320312f)));
  SV_Target.y = mad(-0.00834800023585558f, _320, mad(1.1328999996185303f, _319, (_316 * -12.454999923706055f)));
  SV_Target.z = mad(1.1187299489974976f, _320, mad(-0.10057900100946426f, _319, (_316 * -1.8150999546051025f)));
  SV_Target.w = 1.0f;
