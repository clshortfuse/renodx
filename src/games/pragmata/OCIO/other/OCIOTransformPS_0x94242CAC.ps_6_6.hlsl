...
float4 main(
  ...
  float _280 = ((_270 * _124.x) + _265) + (_269 * _131.x);
  float _281 = ((_270 * _124.y) + _266) + (_269 * _131.y);
  float _282 = ((_270 * _124.z) + _267) + (_269 * _131.z);
  if (!(!(_280 >= 0.03928571194410324f))) {
    _293 = exp2(log2((_280 + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f);
  } else {
    _293 = (_280 * 0.07738011330366135f);
  }
  if (!(!(_281 >= 0.03928571194410324f))) {
    _304 = exp2(log2((_281 + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f);
  } else {
    _304 = (_281 * 0.07738011330366135f);
  }
  if (!(!(_282 >= 0.03928571194410324f))) {
    _315 = exp2(log2((_282 + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f);
  } else {
    _315 = (_282 * 0.07738011330366135f);
  }
  SV_Target.x = _293;
  SV_Target.y = _304;
  SV_Target.z = _315;
