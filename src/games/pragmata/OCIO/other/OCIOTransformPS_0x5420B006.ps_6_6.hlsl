...
float4 main(
  ...
  SV_Target.x = ((exp2(log2(((_272 * _126.x) + _267) + (_271 * _133.x)) * fGamma) * fConvertToLimit) + fLowerLimit);
  SV_Target.y = ((exp2(log2(((_272 * _126.y) + _268) + (_271 * _133.y)) * fGamma) * fConvertToLimit) + fLowerLimit);
  SV_Target.z = ((exp2(log2(((_272 * _126.z) + _269) + (_271 * _133.z)) * fGamma) * fConvertToLimit) + fLowerLimit);
  SV_Target.w = 1.0f;
