...
void main(
  ...
  float _55 = mad(_52, 0.047374799847602844f, mad(_38, 0.33951008319854736f, (_24 * 0.6131157279014587f)));
  float _58 = mad(_52, 0.013449129648506641f, mad(_38, 0.9163550138473511f, (_24 * 0.07019715756177902f)));
  float _61 = mad(_52, 0.8698007464408875f, mad(_38, 0.10957999527454376f, (_24 * 0.020619075745344162f)));
  if (!(!(_55 >= 0.03928571194410324f))) {
    _72 = exp2(log2((_55 + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f);
  } else {
    _72 = (_55 * 0.07738011330366135f);
  }
  if (!(!(_58 >= 0.03928571194410324f))) {
    _83 = exp2(log2((_58 + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f);
  } else {
    _83 = (_58 * 0.07738011330366135f);
  }
  if (!(!(_61 >= 0.03928571194410324f))) {
    _94 = exp2(log2((_61 + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f);
  } else {
    _94 = (_61 * 0.07738011330366135f);
  }

  // _94 = 9999.f;
  OutLUT[SV_DispatchThreadID] = float4(_72, _83, _94, 1.0f);
}
