...
void main(
  ...
  float _113;
  float _114;
  _14 = int16_t((int)(SV_GroupThreadID.x));
  _16 = (uint16_t)(_14) >> 1;
  _19 = (uint16_t)(_14) >> 2;
  _22 = (uint16_t)(_14) >> 3;
  _31 = ((int)(((int)(((int)(((int)(_14 & 1)) | ((int)((int)(int16_t((int)(SV_GroupID.x))) << 4)))) | ((int)(_16 & 2)))) | ((int)(_19 & 4)))) | ((int)(_22 & 8));
  _36 = ((int)(((int)(((int)(((int)(_16 & 1)) | ((int)((int)(int16_t((int)(SV_GroupID.y))) << 4)))) | ((int)(_19 & 2)))) | ((int)(_22 & 4)))) | ((int)(((int)((uint16_t)(_14) >> 4)) & 8));
  _48 = GUIImage.SampleLevel(PointClamp, float2(((((float)((uint16_t)_31)) + 0.5f) * screenInverseSize.x), ((((float)((uint16_t)_36)) + 0.5f) * screenInverseSize.y)), 0.0f);
  if (_48.w > 0.0f) {
    _64 = 1.0f / ((((float)((uint)((uint)(((uint)((uint)(guiShaderCommonFlag)) >> 8) & 1)))) * (1.0f - _48.w)) + _48.w);
    _69 = (_64 * _48.x);
    _70 = (_64 * _48.y);
    _71 = (_64 * _48.z);
  } else {
    ...
    do {
      ...
      if (!(_48.w == 1.0f)) {
        do {
          ...
          _88 = RWResult[int2(((int)(min16uint)(_31)), ((int)(min16uint)(_36)))].x;
          _89 = RWResult[int2(((int)(min16uint)(_31)), ((int)(min16uint)(_36)))].y;
          _90 = RWResult[int2(((int)(min16uint)(_31)), ((int)(min16uint)(_36)))].z;
          _101 = 1.0f / fConvertToLimitForOverlay;
          _105 = 1.0f / fGammaForOverlay;
          _112 = exp2(log2(_101 * max((_88 - fLowerLimitForOverlay), 0.0f)) * _105);
          _113 = exp2(log2(_101 * max((_89 - fLowerLimitForOverlay), 0.0f)) * _105);
          _114 = exp2(log2(_101 * max((_90 - fLowerLimitForOverlay), 0.0f)) * _105);
          do {
            [branch]
