...
// ---- Created with 3Dmigoto v1.2.45 on Fri Jan 30 22:52:13 2026
...
void main( 
  ...
  linear centroid float3 v3 : TEXCOORD6,
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyz = CAMERA_POS_WS.xyz + -v1.xyz;
  r0.w = dot(r0.xyz, r0.xyz);
  r0.w = rsqrt(r0.w);
  r0.xyz = r0.www * r0.yxz;
  r0.y = saturate(dot(-r0.yxz, vSunDir.xyz));
  r0.x = saturate(-r0.x);
  ...
  r0.yzw = FakeHDRGain::Apply(r0.yzw, pow(CUSTOM_SKY_SKYBOX_GLOW, 4.5), CUSTOM_SKY_LUMINARIES_GLOW_CONTRAST, CUSTOM_SKY_SKYBOX_GLOW_SATURATION); // Sky intensity, * 20
  r1.xyz = float3(1,1,1) + -v3.xyz;
  r0.yzw = r1.xyz * r0.yzw;
  r1.xyz = max(0.0, vSunColor.xyz * fHDRSkyIntensity + -r0.yzw);
  r2.xyzw = sColor1.Sample(samColor1_s, v2.xy).xyzw;
