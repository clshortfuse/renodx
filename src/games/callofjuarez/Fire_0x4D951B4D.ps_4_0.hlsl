...
// ---- Created with 3Dmigoto v1.2.45 on Sun Jan 25 22:10:12 2026
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = BACKBUFFER_PARAMS.xy * r0.xy;
  r0.xyzw = sBackbuffer.Sample(samBackbuffer_s, r0.xy).xyzw;
  r0.x = saturate(-v3.x + r0.w);
