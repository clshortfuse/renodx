...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
      ...
      new renodx::utils::settings::Setting{
        ...
        .default_value = 100.f,
        .label = "Eye Adaptation Strength",
        .section = "Game FX",
        .tooltip = "Eye adaptation is incredibly aggressive in HDR, to the point where simple act of reloading the guns makes the screen brightness flicker. 0 - disabled completely, 100 - Vanilla",
        .max = 100.f,
        .parse = [](float value) { return value * 0.01f; },
    },
    new renodx::utils::settings::Setting{
    ...
    new renodx::utils::settings::Setting{
        .key = "AOEnable",
        .binding = &shader_injection.Custom_AO_Enable,
        .value_type = renodx::utils::settings::SettingValueType::INTEGER,
        .default_value = 0.f,
        .label = "Enable AO",
        .section = "Game FX - AO",
        .tooltip = "Enables additional ambient occlusion pass.",
        .labels = {"Off", "On"},
    }, 
    new renodx::utils::settings::Setting{
        .key = "AODebug",
        ...
        .value_type = renodx::utils::settings::SettingValueType::INTEGER,
        .default_value = 0.f,
        .label = "Enable AO Debug View",
        .section = "Game FX - AO",
        .tooltip = "Ambient Occlusion debug views.",
        .labels = {"None", "AO", "Depth"},
    }, 
    new renodx::utils::settings::Setting{
        .key = "AOIntensity",
        .binding = &shader_injection.Custom_AO_Intensity,
        .default_value = 50.f,
        .label = "AO Intensity",
        .section = "Game FX - AO",
        ...
        .min = 0.f,
        .max = 100.f,
        .parse = [](float value) { return value * 0.045f; },
    },
    new renodx::utils::settings::Setting{
        .key = "AORadiusNear",
        .binding = &shader_injection.Custom_AO_Radius_Near,
        .default_value = 50.f,
        .label = "AO Radius Near",
        .section = "Game FX - AO",
        .tooltip = "Ambient Occlusion near radius.",
        .min = 0.f,
        .max = 100.f,
        .parse = [](float value) { return value * 0.04f; },
    },
    new renodx::utils::settings::Setting{
        .key = "AORadiusFar",
        .binding = &shader_injection.Custom_AO_Radius_Far,
        .default_value = 50.f,
        .label = "AO Radius Far",
        .section = "Game FX - AO",
        ...
        .min = 0.f,
        .max = 100.f,
        .parse = [](float value) { return value * 0.03f; },
    },
    new renodx::utils::settings::Setting{
        .key = "AOBiasNear",
        .binding = &shader_injection.Custom_AO_Bias_Near,
        .default_value = 50.f,
        .label = "AO Bias Near",
        .section = "Game FX - AO",
        ...
        .min = 0.f,
        .max = 100.f,
        .parse = [](float value) { return value * 0.00040f; },
    },
    new renodx::utils::settings::Setting{
        .key = "AOBiasFar",
        .binding = &shader_injection.Custom_AO_Bias_Far,
        .default_value = 50.f,
        .label = "AO Bias Far",
        .section = "Game FX - AO",
        .tooltip = "Ambient Occlusion far bias.",
        .min = 0.f,
        .max = 100.f,
        .parse = [](float value) { return value * 0.000002f; },
    },
    new renodx::utils::settings::Setting{
        .key = "AOThicknessFar",
        .binding = &shader_injection.Custom_AO_Thickness_Far,
        .default_value = 50.f,
        .label = "AO Thickness Far",
        .section = "Game FX - AO",
        .tooltip = "Ambient Occlusion far thickness. Used to reduce halos on thin objects.",
        .min = 0.f,
        .max = 100.f,
        .parse = [](float value) { return value * 0.00001f; },
    },
    new renodx::utils::settings::Setting{
        .key = "AOThicknessNear",
        .binding = &shader_injection.Custom_AO_Thickness_Near,
        .default_value = 50.f,
        .label = "AO Thickness Near",
        .section = "Game FX - AO",
        .tooltip = "Ambient Occlusion near thickness. Used to reduce halos on thin objects.",
        .min = 0.f,
        .max = 100.f,
    ...
    new renodx::utils::settings::Setting{
        .key = "AOFadeDistanceStart",
        .binding = &shader_injection.Custom_AO_Fade_Start,
        .default_value = 50.f,
        .label = "AO Fade Distance Start",
        .section = "Game FX - AO",
        .tooltip = "Ambient Occlusion fade distance start.",
        .min = 0.f,
        .max = 100.f,
        .parse = [](float value) { return value; },
    },
    new renodx::utils::settings::Setting{
        .key = "AOFadeDistanceEnd",
        .binding = &shader_injection.Custom_AO_Fade_End,
        .default_value = 50.f,
        .label = "AO Fade Distance End",
        .section = "Game FX - AO",
        .tooltip = "Ambient Occlusion fade distance end.",
        .min = 0.f,
        .max = 100.f,
        .parse = [](float value) { return value * 0.5f; },
    },
    new renodx::utils::settings::Setting{
        .key = "AOFadeBrightness",
        .binding = &shader_injection.Custom_AO_Brightness_Fade_Threshold,
        .default_value = 50.f,
        .label = "AO Brightness Fade Threshold",
        .section = "Game FX - AO",
        .tooltip = "Ambient Occlusion fade behind very bright pixels.",
        .min = 0.f,
        .max = 100.f,
        .parse = [](float value) { return value * 0.02f; },
    },
