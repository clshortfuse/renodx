...
{renodx::templates::settings::CreateDefaultSettings({
  {"ToneMapType", {.binding = &shader_injection.tone_map_type, .default_value = 1.f, .labels = {"Vanilla SDR (AgX)", "Vanilla+ HDR (AgX + PsychoV Blend)"}}},
  ...
  {"ToneMapHueCorrection", {.binding =  &shader_injection.tone_map_hue_correction, .default_value = 50.f, .tooltip = "Emulates vanilla SDR hue shifts."}},
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX - Revenge of the Savage Planet";
