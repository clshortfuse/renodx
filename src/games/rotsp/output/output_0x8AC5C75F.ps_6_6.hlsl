...
float4 main(
  ...
  float _117 = (_27 * View_OneOverPreExposure) * (_105 * _105);
  float _130 = (((ColorScale0.x * _39.x) * _117) * _113) + ((((BloomDirtMaskTint.x * _82.x) + 1.0f) * _63.x) * _117);
  float _131 = (((ColorScale0.y * _39.y) * _117) * _114) + ((((BloomDirtMaskTint.y * _82.y) + 1.0f) * _63.y) * _117);
  float _132 = (((ColorScale0.z * _39.z) * _117) * _115) + ((((BloomDirtMaskTint.z * _82.z) + 1.0f) * _63.z) * _117);
  float _183;
  float _194;
  float _205;
  float _407;
  ...
  float _485;
  if (ToneMapImpl == 0) {
    float4 _163 = ColorGradingLUT.Sample(ColorGradingLUTSampler, float3(((LUTScale * saturate((log2(_130 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f)) + LUTOffset), ((LUTScale * saturate((log2(_131 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f)) + LUTOffset), ((LUTScale * saturate((log2(_132 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f)) + LUTOffset)));
    _407 = (_163.x * 1.0499999523162842f);
    _408 = (_163.y * 1.0499999523162842f);
    _409 = (_163.z * 1.0499999523162842f);
  } else {
    if (ToneMapImpl == 1) {
      if (_130 < 0.0031306699384003878f) {
        _183 = (_130 * 12.920000076293945f);
      } else {
        _183 = (((pow(_130, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
      }
      if (_131 < 0.0031306699384003878f) {
        _194 = (_131 * 12.920000076293945f);
      } else {
        _194 = (((pow(_131, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
      }
      if (_132 < 0.0031306699384003878f) {
        _205 = (_132 * 12.920000076293945f);
      } else {
        _205 = (((pow(_132, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
      }
      _407 = saturate(_183);
      _408 = saturate(_194);
      _409 = saturate(_205);
      ...
      if ((ToneMapImpl & -2) == 2) {
        ...
        float _237 = max(0.0f, _130);
        float _238 = max(0.0f, _131);
        float _239 = max(0.0f, _132);
        float _242 = mad(0.18048079311847687f, _239, mad(0.3575843274593353f, _238, (_237 * 0.412390798330307f)));
        float _245 = mad(0.07219231873750687f, _239, mad(0.7151686549186707f, _238, (_237 * 0.2126390039920807f)));
        float _248 = mad(0.9505321383476257f, _239, mad(0.11919478327035904f, _238, (_237 * 0.019330818206071854f)));
        float _270 = min(max(log2(mad((AgX_CompressionMatrixInv[0].z), _248, mad((AgX_CompressionMatrixInv[0].y), _245, (_242 * (AgX_CompressionMatrixInv[0].x)))) * 5.55555534362793f), -10.0f), 6.5f) + 10.0f;
        float _271 = min(max(log2(mad((AgX_CompressionMatrixInv[1].z), _248, mad((AgX_CompressionMatrixInv[1].y), _245, (_242 * (AgX_CompressionMatrixInv[1].x)))) * 5.55555534362793f), -10.0f), 6.5f) + 10.0f;
        float _272 = min(max(log2(mad((AgX_CompressionMatrixInv[2].z), _248, mad((AgX_CompressionMatrixInv[2].y), _245, (_242 * (AgX_CompressionMatrixInv[2].x)))) * 5.55555534362793f), -10.0f), 6.5f) + 10.0f;
        float _273 = _270 * 0.06060606241226196f;
        float _274 = _271 * 0.06060606241226196f;
        float _275 = _272 * 0.06060606241226196f;
        ...
        float _342 = exp2(log2(saturate((((((0.0028570001013576984f - (_270 * 0.010412122122943401f)) + (_276 * 4.361000061035156f)) + (_279 * 92.05999755859375f)) - ((_270 * 1.7406060695648193f) * _276)) - ((_270 * 7.678787708282471f) * _279)) + ((_279 * _276) * (78.01000213623047f - (_270 * 1.082424283027649f))))) * 2.200000047683716f);
        float _343 = exp2(log2(saturate((((((0.0028570001013576984f - (_271 * 0.010412122122943401f)) + (_277 * 4.361000061035156f)) + (_280 * 92.05999755859375f)) - ((_271 * 1.7406060695648193f) * _277)) - ((_271 * 7.678787708282471f) * _280)) + ((_280 * _277) * (78.01000213623047f - (_271 * 1.082424283027649f))))) * 2.200000047683716f);
        float _344 = exp2(log2(saturate((((((0.0028570001013576984f - (_272 * 0.010412122122943401f)) + (_278 * 4.361000061035156f)) + (_281 * 92.05999755859375f)) - ((_272 * 1.7406060695648193f) * _278)) - ((_272 * 7.678787708282471f) * _281)) + ((_281 * _278) * (78.01000213623047f - (_272 * 1.082424283027649f))))) * 2.200000047683716f);
        float _347 = mad((AgX_CompressionMatrix[0].z), _344, mad((AgX_CompressionMatrix[0].y), _343, (_342 * (AgX_CompressionMatrix[0].x))));
        float _350 = mad((AgX_CompressionMatrix[1].z), _344, mad((AgX_CompressionMatrix[1].y), _343, (_342 * (AgX_CompressionMatrix[1].x))));
        float _353 = mad((AgX_CompressionMatrix[2].z), _344, mad((AgX_CompressionMatrix[2].y), _343, (_342 * (AgX_CompressionMatrix[2].x))));
        float _369 = exp2(log2(mad(-0.4986107647418976f, _353, mad(-1.5373831987380981f, _350, (_347 * 3.2409698963165283f)))) * 0.45454543828964233f);
        float _370 = exp2(log2(mad(0.04155505821108818f, _353, mad(1.8759675025939941f, _350, (_347 * -0.9692436456680298f)))) * 0.45454543828964233f);
        float _371 = exp2(log2(mad(1.056971549987793f, _353, mad(-0.20397695899009705f, _350, (_347 * 0.05563008040189743f)))) * 0.45454543828964233f);
        if (ToneMapImpl == 3) {
          float _385 = saturate(pow(_369, AgX_PostContrast));
          float _386 = saturate(pow(_370, AgX_PostContrast));
          float _387 = saturate(pow(_371, AgX_PostContrast));
          float _389 = dot(float3(_385, _386, _387), float3(0.2126729041337967f, 0.7151522040367126f, 0.07217500358819962f));
          _407 = saturate(lerp(_389, _385, AgX_PostSaturation));
          _408 = saturate(lerp(_389, _386, AgX_PostSaturation));
          _409 = saturate(lerp(_389, _387, AgX_PostSaturation));
        } else {
          _407 = saturate(_369);
          _408 = saturate(_370);
          _409 = saturate(_371);
        ...
        float3 sdr_final = renodx::color::srgb::DecodeSafe(float3(_407, _408, _409));
  ...
  [branch]
  if (!(bOutputInHDR == 0)) {
    float _420 = (pow(_407, 0.012683313339948654f));
    float _421 = (pow(_408, 0.012683313339948654f));
    float _422 = (pow(_409, 0.012683313339948654f));
    float _455 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_420 + -0.8359375f)) / (18.8515625f - (_420 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / EditorNITLevel));
    float _456 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_421 + -0.8359375f)) / (18.8515625f - (_421 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / EditorNITLevel));
    float _457 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_422 + -0.8359375f)) / (18.8515625f - (_422 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / EditorNITLevel));
    _483 = min((_455 * 12.920000076293945f), ((exp2(log2(max(_455, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _484 = min((_456 * 12.920000076293945f), ((exp2(log2(max(_456, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
    _485 = min((_457 * 12.920000076293945f), ((exp2(log2(max(_457, 0.0031306699384003878f)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _483 = _407;
    _484 = _408;
    _485 = _409;
  }
  float _492 = (frac(sin((TEXCOORD_2.w * 543.3099975585938f) + TEXCOORD_2.z) * 493013.0f) * 2.0f) + -1.0f;
  float _495 = min(max((_492 * +1.#INF), -1.0f), 1.0f);
  float _504 = (_495 - (sqrt(saturate(1.0f - abs(_492))) * _495)) * BackbufferQuantizationDithering;
  SV_Target.x = (_504 + _483);
  SV_Target.y = (_504 + _484);
  SV_Target.z = (_504 + _485);
  SV_Target.w = 0.0f;
  return SV_Target;
}
