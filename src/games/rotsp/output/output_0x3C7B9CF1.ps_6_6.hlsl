...
float4 main(
  ...
  float _190 = _27 * View_OneOverPreExposure;
  ...
  float _245 = (((_232 * ColorScale0.x) * _113) * ((((((((_149.x - (_39.x * 4.0f)) + _168.x) + _39.x) - (ddx_fine(_39.x) * _130)) + _39.x) - (ddy_fine(_39.x) * _134)) * _204) + _39.x)) + ((((BloomDirtMaskTint.x * _82.x) + 1.0f) * _63.x) * _232);
  float _246 = (((_232 * ColorScale0.y) * _114) * ((((((((_149.y - (_39.y * 4.0f)) + _168.y) + _39.y) - (ddx_fine(_39.y) * _130)) + _39.y) - (ddy_fine(_39.y) * _134)) * _204) + _39.y)) + ((((BloomDirtMaskTint.y * _82.y) + 1.0f) * _63.y) * _232);
  float _247 = (((_232 * ColorScale0.z) * _115) * ((((((((_149.z - (_39.z * 4.0f)) + _168.z) + _39.z) - (ddx_fine(_39.z) * _130)) + _39.z) - (ddy_fine(_39.z) * _134)) * _204) + _39.z)) + ((((BloomDirtMaskTint.z * _82.z) + 1.0f) * _63.z) * _232);
  float _298;
  float _309;
  float _320;
  float _522;
  ...
  float _600;
  if (ToneMapImpl == 0) {
    float4 _278 = ColorGradingLUT.Sample(ColorGradingLUTSampler, float3(((LUTScale * saturate((log2(_245 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f)) + LUTOffset), ((LUTScale * saturate((log2(_246 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f)) + LUTOffset), ((LUTScale * saturate((log2(_247 + 0.002667719265446067f) * 0.0714285746216774f) + 0.6107269525527954f)) + LUTOffset)));
    _522 = (_278.x * 1.0499999523162842f);
    _523 = (_278.y * 1.0499999523162842f);
    _524 = (_278.z * 1.0499999523162842f);
  } else {
    if (ToneMapImpl == 1) {
      if (_245 < 0.0031306699384003878f) {
        _298 = (_245 * 12.920000076293945f);
      } else {
        _298 = (((pow(_245, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
      }
      if (_246 < 0.0031306699384003878f) {
        _309 = (_246 * 12.920000076293945f);
      } else {
        _309 = (((pow(_246, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
      }
      if (_247 < 0.0031306699384003878f) {
        _320 = (_247 * 12.920000076293945f);
      } else {
        _320 = (((pow(_247, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
      }
      _522 = saturate(_298);
      _523 = saturate(_309);
      _524 = saturate(_320);
      ...
      if ((ToneMapImpl & -2) == 2) {
        ...
        float _352 = max(0.0f, _245);
        float _353 = max(0.0f, _246);
        float _354 = max(0.0f, _247);
        float _357 = mad(0.18048079311847687f, _354, mad(0.3575843274593353f, _353, (_352 * 0.412390798330307f)));
        float _360 = mad(0.07219231873750687f, _354, mad(0.7151686549186707f, _353, (_352 * 0.2126390039920807f)));
        float _363 = mad(0.9505321383476257f, _354, mad(0.11919478327035904f, _353, (_352 * 0.019330818206071854f)));
        float _385 = min(max(log2(mad((AgX_CompressionMatrixInv[0].z), _363, mad((AgX_CompressionMatrixInv[0].y), _360, (_357 * (AgX_CompressionMatrixInv[0].x)))) * 5.55555534362793f), -10.0f), 6.5f) + 10.0f;
        float _386 = min(max(log2(mad((AgX_CompressionMatrixInv[1].z), _363, mad((AgX_CompressionMatrixInv[1].y), _360, (_357 * (AgX_CompressionMatrixInv[1].x)))) * 5.55555534362793f), -10.0f), 6.5f) + 10.0f;
        float _387 = min(max(log2(mad((AgX_CompressionMatrixInv[2].z), _363, mad((AgX_CompressionMatrixInv[2].y), _360, (_357 * (AgX_CompressionMatrixInv[2].x)))) * 5.55555534362793f), -10.0f), 6.5f) + 10.0f;
        float _388 = _385 * 0.06060606241226196f;
        float _389 = _386 * 0.06060606241226196f;
        float _390 = _387 * 0.06060606241226196f;
        float _391 = _388 * _388;
        float _392 = _389 * _389;
        float _393 = _390 * _390;
        float _394 = _391 * _391;
        float _395 = _392 * _392;
        float _396 = _393 * _393;
        float _457 = exp2(log2(saturate((((((0.0028570001013576984f - (_385 * 0.010412122122943401f)) + (_391 * 4.361000061035156f)) + (_394 * 92.05999755859375f)) - ((_385 * 1.7406060695648193f) * _391)) - ((_385 * 7.678787708282471f) * _394)) + ((_394 * _391) * (78.01000213623047f - (_385 * 1.082424283027649f))))) * 2.200000047683716f);
        float _458 = exp2(log2(saturate((((((0.0028570001013576984f - (_386 * 0.010412122122943401f)) + (_392 * 4.361000061035156f)) + (_395 * 92.05999755859375f)) - ((_386 * 1.7406060695648193f) * _392)) - ((_386 * 7.678787708282471f) * _395)) + ((_395 * _392) * (78.01000213623047f - (_386 * 1.082424283027649f))))) * 2.200000047683716f);
        float _459 = exp2(log2(saturate((((((0.0028570001013576984f - (_387 * 0.010412122122943401f)) + (_393 * 4.361000061035156f)) + (_396 * 92.05999755859375f)) - ((_387 * 1.7406060695648193f) * _393)) - ((_387 * 7.678787708282471f) * _396)) + ((_396 * _393) * (78.01000213623047f - (_387 * 1.082424283027649f))))) * 2.200000047683716f);
        float _462 = mad((AgX_CompressionMatrix[0].z), _459, mad((AgX_CompressionMatrix[0].y), _458, (_457 * (AgX_CompressionMatrix[0].x))));
        float _465 = mad((AgX_CompressionMatrix[1].z), _459, mad((AgX_CompressionMatrix[1].y), _458, (_457 * (AgX_CompressionMatrix[1].x))));
        float _468 = mad((AgX_CompressionMatrix[2].z), _459, mad((AgX_CompressionMatrix[2].y), _458, (_457 * (AgX_CompressionMatrix[2].x))));
        float _484 = exp2(log2(mad(-0.4986107647418976f, _468, mad(-1.5373831987380981f, _465, (_462 * 3.2409698963165283f)))) * 0.45454543828964233f);
        float _485 = exp2(log2(mad(0.04155505821108818f, _468, mad(1.8759675025939941f, _465, (_462 * -0.9692436456680298f)))) * 0.45454543828964233f);
        float _486 = exp2(log2(mad(1.056971549987793f, _468, mad(-0.20397695899009705f, _465, (_462 * 0.05563008040189743f)))) * 0.45454543828964233f);
        if (ToneMapImpl == 3) {
          float _500 = saturate(pow(_484, AgX_PostContrast));
          float _501 = saturate(pow(_485, AgX_PostContrast));
          float _502 = saturate(pow(_486, AgX_PostContrast));
          float _504 = dot(float3(_500, _501, _502), float3(0.2126729041337967f, 0.7151522040367126f, 0.07217500358819962f));
          _522 = saturate(lerp(_504, _500, AgX_PostSaturation));
          _523 = saturate(lerp(_504, _501, AgX_PostSaturation));
          _524 = saturate(lerp(_504, _502, AgX_PostSaturation));
        } else {
          _522 = saturate(_484);
          _523 = saturate(_485);
          _524 = saturate(_486);
        ...
        float3 sdr_final = renodx::color::srgb::DecodeSafe(float3(_522, _523, _524));
  ...
  [branch]
  if (!(bOutputInHDR == 0)) {
    float _535 = (pow(_522, 0.012683313339948654f));
    float _536 = (pow(_523, 0.012683313339948654f));
    float _537 = (pow(_524, 0.012683313339948654f));
    float _570 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_535 + -0.8359375f)) / (18.8515625f - (_535 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / EditorNITLevel));
    float _571 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_536 + -0.8359375f)) / (18.8515625f - (_536 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / EditorNITLevel));
    float _572 = max(6.103519990574569e-05f, ((exp2(log2(max(0.0f, (_537 + -0.8359375f)) / (18.8515625f - (_537 * 18.6875f))) * 6.277394771575928f) * 10000.0f) / EditorNITLevel));
  ...
  float _607 = (frac(sin((TEXCOORD_2.w * 543.3099975585938f) + TEXCOORD_2.z) * 493013.0f) * 2.0f) + -1.0f;
  float _610 = min(max((_607 * +1.#INF), -1.0f), 1.0f);
  float _619 = (_610 - (sqrt(saturate(1.0f - abs(_607))) * _610)) * BackbufferQuantizationDithering;
  SV_Target.x = (_619 + _598);
  SV_Target.y = (_619 + _599);
  SV_Target.z = (_619 + _600);
  SV_Target.w = 0.0f;
  return SV_Target;
}
