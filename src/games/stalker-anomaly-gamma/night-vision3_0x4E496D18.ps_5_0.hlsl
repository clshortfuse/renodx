// ---- Created with 3Dmigoto v1.4.1 on Sun Oct 19 02:52:32 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  const float3 NV_TINT = float3(0.699999988, 1.0, 0.600000024);
  ...
  if (r2.w != 0) {
    ...
    r3.z = r3.z ? 0 : r3.w;
    r3.z = r3.z + -r2.w;
    r2.w = r3.z * 0.0500000007 + r2.w;
    r3.zw = floor(shader_param_8.yz);
    r4.xy = float2(0.100000001,0.00999999978) * r3.zw;
    r3.w = rsqrt(r4.x);
    r3.w = 1 / r3.w;
    r3.x = r3.x * r3.w;
  r2.w = max(r3.x * 0.150000006 + r2.w, 0);
  nvIntensity = r2.w;
    r3.x = r3.z * 0.100000001 + -1;
    r3.x = -r3.x * 0.00100000005 + 0.999000013;
    r3.x = cmp(r3.x < r3.y);
    r2.w = r3.x ? 1 : r2.w;
    r3.xyz = float3(0.699999988,1,0.600000024) * r2.www;
