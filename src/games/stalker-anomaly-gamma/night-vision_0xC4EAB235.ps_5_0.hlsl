// ---- Created with 3Dmigoto v1.4.1 on Sun Oct 19 02:35:16 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  const float3 NV_TINT = float3(0.200000003, 1.0, 0.899999976);
  ...
  if (r2.w != 0) {
    ...
    r2.w = r5.x / r5.y;
    r3.zw = log2(r1.xy);
    r3.zw = float2(0.850000024,0.850000024) * r3.zw;
    r3.zw = exp2(r3.zw);
    r4.x = saturate(0.0666666701 * r2.w);
    r4.y = r4.x * -2 + 3;
    r4.x = r4.x * r4.x;
    r4.x = -r4.y * r4.x + 1;
    r4.x = max(0.200000003, r4.x);
    r4.yz = -r3.zw + r2.xy;
    r3.zw = r4.xx * r4.yz + r3.zw;
    r4.x = cmp(r2.w < 1000);
    r2.w = -5 + r2.w;
    ...
    r3.z = r3.z ? 0 : r3.w;
    r3.z = r3.z + -r2.w;
    r2.w = r3.z * 0.100000001 + r2.w;
    r3.zw = floor(shader_param_8.yz);
    r4.xy = float2(0.100000001,0.00999999978) * r3.zw;
    r3.w = rsqrt(r4.x);
    r3.w = 1 / r3.w;
    r3.x = r3.x * r3.w;
  r2.w = max(r3.x * 0.0799999982 + r2.w, 0);
  nvIntensity = r2.w;
    r3.x = r3.z * 0.100000001 + -1;
    r3.x = -r3.x * 0.00079999998 + 0.999199986;
    r3.x = cmp(r3.x < r3.y);
    r2.w = r3.x ? 1 : r2.w;
    r3.xyz = float3(0.200000003,1,0.899999976) * r2.www;
