// ---- Created with 3Dmigoto v1.4.1 on Mon Jan 20 16:57:36 2025
...
SamplerState p_default_Material_0250B9644272472_Param_sampler_s : register(s0);
SamplerState p_default_Material_0250BA2C4258597_Param_sampler_s : register(s1);
Texture2D<float4> p_default_Material_0250B9644272472_Param_texture : register(t0);
Texture2D<float4> p_default_Material_0250BA2C4258597_Param_texture : register(t1);
...
void main(
  ...
  r1.xyzw = p_default_Material_0250BA2C4258597_Param_texture.Sample(p_default_Material_0250BA2C4258597_Param_sampler_s, r0.yz).xyzw;

  r1 = max(0, r1);

  r2.xyzw = p_default_Material_0250B9644272472_Param_texture.Sample(p_default_Material_0250B9644272472_Param_sampler_s, r0.yz).xyzw;

  r2 = max(0, r2);

  r0.x = InstanceParameters[r0.x].InstanceParams[0].x * r1.w;
  r0.x = cmp(r0.x < r2.w);
