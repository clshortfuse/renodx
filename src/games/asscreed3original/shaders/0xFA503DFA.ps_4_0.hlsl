// ---- Created with 3Dmigoto v1.3.16 on Thu May 14 01:06:07 2026
  ...
  out float4 o1 : SV_Target1)
{
  ...
  r0.x = cmp(v3.w < 0);
  if (r0.x != 0) discard;
  r0.xy = v0.xy * g_VPosToUV.xy + float2(-1,-0.569999993);
  r0.zw = float2(1.25,1.25) * v2.xy;
  r0.xy = r0.xy * float2(0.600000024,0.600000024) + r0.zw;
  r0.zw = trunc(abs(r0.xy));
  ...
  r1.xyz = -g_NormalScale.xxx * r0.yzw;
  r0.yzw = v8.xxx ? r1.xyz : r0.yzw;
  r1.xyz = v3.xyz;
  r1.w = 0;
