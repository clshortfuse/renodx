...
SamplerState PostFxBloom__CurrentAutoExposureScaleTexture__SampObj___s : register(s2);
...
Texture2D<float4> PostFxBloom__CurrentAutoExposureScaleTexture__TexObj__ : register(t2);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyz = applyCA(PostFxBloom__SourceTextureSampler__TexObj__, PostFxBloom__SourceTextureSampler__SampObj___s, v0.xy, injectedData.fxChroma * injectedData.is_not_camera);
  ...
  r0.xyz = applyUserTonemap(r0.xyz, _ToneMapParams0, _ToneMapParams1);
  r0.xyz = renodx::color::srgb::EncodeSafe(r0.xyz);
  r0.w = dot(v2.xy, float2(0.754877687,0.569840312));
  r0.w = frac(r0.w);
  r0.w = -0.5 + r0.w;
