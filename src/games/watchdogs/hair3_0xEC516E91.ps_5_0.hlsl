  ...
  out float4 o2 : SV_Target2)
{
  ...
  r0.xyz = MaterialDriverHair__SpecularTexture1__TexObj__.Sample(MaterialDriverHair__SpecularTexture1__SampObj___s, v5.xy).xyz;
  r0.z = -_AlphaTestValue + r0.z;
  r0.z = cmp(r0.z < 0);
  if (r0.z != 0) discard;
  r1.xyz = _DiffuseColor2.xyz + -_DiffuseColor1.xyz;
  r1.xyz = v0.xxx * r1.xyz + _DiffuseColor1.xyz;
  r2.xyz = MaterialDriverHair__DiffuseTexture1__TexObj__.Sample(MaterialDriverHair__DiffuseTexture1__SampObj___s, v4.xy).xyz;
  ...
  r3.xy = MaterialDriverHair__NormalTexture1__TexObj__.Sample(MaterialDriverHair__NormalTexture1__SampObj___s, v4.zw).yw;
