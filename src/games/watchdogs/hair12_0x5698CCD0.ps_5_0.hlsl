  ...
  out float4 o2 : SV_Target2)
{
  ...
  r0.x = MaterialDriverHair__AlphaTexture1__TexObj__.Sample(MaterialDriverHair__AlphaTexture1__SampObj___s, v4.xy).y;
  r0.x = -_AlphaTestValue + r0.x;
  r0.x = cmp(r0.x < 0);
  if (r0.x != 0) discard;
  r0.x = -1 + v0.w;
  o0.w = _WindGlobalNoiseTextureCoverage_VertexAOIntensity.w * r0.x + 1;
  r0.xyz = MaterialDriverHair__DiffuseTexture1__TexObj__.Sample(MaterialDriverHair__DiffuseTexture1__SampObj___s, v4.zw).xyz;
  r0.xyz = _DiffuseColor1.xyz * r0.xyz;
  ...
  r2.xy = MaterialDriverHair__NormalTexture1__TexObj__.Sample(MaterialDriverHair__NormalTexture1__SampObj___s, v5.xy).yw;
  ...
  r0.yz = MaterialDriverHair__SpecularTexture1__TexObj__.Sample(MaterialDriverHair__SpecularTexture1__SampObj___s, v5.zw).xy;
  o2.y = r0.x * r0.z;
