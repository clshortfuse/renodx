...
SamplerState MaterialDriverHair__SpecularTexture1__SampObj___s : register(s1);
Texture2D<float4> MaterialDriverHair__DiffuseTexture1__TexObj__ : register(t0);
Texture2D<float4> MaterialDriverHair__SpecularTexture1__TexObj__ : register(t1);
  ...
  out float2 o3 : SV_Target3)
{
  ...
  r0.xyz = MaterialDriverHair__DiffuseTexture1__TexObj__.Sample(MaterialDriverHair__DiffuseTexture1__SampObj___s, v4.xy).xyz;
  ...
  r0.yz = MaterialDriverHair__SpecularTexture1__TexObj__.Sample(MaterialDriverHair__SpecularTexture1__SampObj___s, v4.zw).xy;
  o2.y = r0.x * r0.z;
