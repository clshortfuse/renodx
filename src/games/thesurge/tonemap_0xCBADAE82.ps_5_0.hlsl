  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xyzw = float4(0.219999999,0.300000012,0.0300000012,0.00200000009) * hdr_filmcurve_parameters.xyyz;
  r1.w = hdr_filmcurve_parameters.w;
  r3.xyzw = r2.xxxx * r1.xyzw + r2.zzzz;
  r3.xyzw = r1.xyzw * r3.xyzw + r2.wwww;
  r2.xyzw = r2.xxxx * r1.xyzw + r2.yyyy;
  r1.xyzw = r1.xyzw * r2.xyzw + float4(0.0599999987,0.0599999987,0.0599999987,0.0599999987);
  r1.xyzw = r3.xyzw / r1.xyzw;
  r1.xyzw = -hdr_filmcurve_parameters.zzzz * float4(0.0333333313,0.0333333313,0.0333333313,0.0333333313) + r1.xyzw;
  r0.x = 1 / r1.w;
  r0.xyz = saturate(r1.xyz * r0.xxx);
  r0.xyz = sqrt(r0.xyz);
  r0.xyz = r0.xyz * float3(0.9375,0.9375,0.9375) + float3(0.03125,0.03125,0.03125);
  r0.xyz = colorGradingLUTSampler.SampleLevel(sampler_trilinear_wrap_s, r0.xyz, 0).xyz;
  r0.xyz = r0.xyz * r0.xyz;
  r0.rgb = applyUserTonemap(untonemapped, colorGradingLUTSampler, sampler_trilinear_wrap_s, hdr_filmcurve_parameters.a);
  r1.x = 1 / hdr_color_parameters1.w;
  o0.rgb = r0.rgb;
  o0.w = r0.w;
  return;
}