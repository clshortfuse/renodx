...
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntry(0xCBADAE82),  // tonemap
    CustomShaderEntry(0x67259E12),  // filmgrain
    CustomShaderEntry(0xDD4A2D9A),  // videos
    CustomShaderEntryCallback(0x9E859B1F, video),  // UI
    CustomShaderEntry(0x75061D6A),  // UI
    CustomShaderEntry(0xB24F9988),  // UI
    CustomShaderEntry(0xEC416938),  // UI
};
...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .label = "Clipping",
        .section = "Color Grading",
        .tooltip = "0: automatic based on vanilla tonemapper"
    ...
    new renodx::utils::settings::Setting{
        ...
        .on_change = []() {
          ...
          renodx::utils::settings::UpdateSetting("colorGradeHighlights", 50.f);
          renodx::utils::settings::UpdateSetting("colorGradeShadows", 50.f);
          renodx::utils::settings::UpdateSetting("colorGradeContrast", 67.f);
          renodx::utils::settings::UpdateSetting("colorGradeSaturation", 50.f);
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for The Surge";
