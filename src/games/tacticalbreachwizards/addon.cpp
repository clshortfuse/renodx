...
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntry(0xC8C2F1A0),
    CustomShaderEntry(0x995B320A),
    CustomShaderEntry(0xD863ED6A),
};
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Tactical Breach Wizards";
