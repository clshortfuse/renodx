// ---- Created with 3Dmigoto v1.3.16 on Tue Jun 16 22:56:13 2026
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.z = dot(r1.xyzw, g_ViewToWorld._m01_m11_m21_m31);
  r2.y = dot(r1.xyzw, g_ViewToWorld._m02_m12_m22_m32);
  r1.xyz = g_EyePosition.xzy + -r2.xyz;
  r0.z = dot(r1.xyz, r1.xyz);
  r0.z = rsqrt(max(r0.z, 0.000001));
  r1.xyz = r1.xyz * r0.zzz;
  r2.xyz = g_Normals_NG.Sample(g_PointClampSampler_NG_s, r0.xy).xyz;
  ...
  r3.xyzw = g_LightingAccumulation_NG.Sample(g_PointClampSampler_NG_s, r0.xy).xyzw;
  r0.xyz = g_AmbientTexture.Sample(g_AmbientTexture_s, r0.xy).xyz;
  r0.w = 1 + -r3.w;
  r0.w = r2.w * r0.w;
  r1.w = r0.w * r3.w;
  r0.w = -r0.w * 0.5 + 1;
  ...
  r0.w = saturate(r1.w * 1.5 + r3.w);
  r1.w = 1 + -r0.w;
  o0.w = r0.w;
  r0.w = 6 * r1.w;
  r1.xyz = g_WeatherReflectionCubeMap.SampleLevel(g_WeatherReflectionCubeMap_s, r1.xyz, r0.w).xyz;
