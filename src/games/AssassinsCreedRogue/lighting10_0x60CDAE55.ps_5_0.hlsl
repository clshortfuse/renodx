// ---- Created with 3Dmigoto v1.3.16 on Sat Jul 04 20:00:23 2026
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = rsqrt(r0.z);
  r0.z = sqrt(r0.z);
  r0.z = g_DeferredOmniLight.m_PositionFar.w * r0.z + 1;
  ...
  r1.y = 0.300000012 + -r1.x;
  r1.x = saturate(r1.x);
  r0.w = r1.y * r0.w;
  r0.w = max(0, r0.w);
  r0.w = r1.x + r0.w;
  r1.xyz = g_Albedo_NG.Sample(g_PointClampSampler_NG_s, r0.xy).xyz;
  r0.x = g_LightingAccumulation_NG.Sample(g_PointClampSampler_NG_s, r0.xy).w;
  o0.w = r0.x;
  r1.xyz = g_DeferredOmniLight.m_ColorFade.xyz * r1.xyz;
