...
float3 ApplyRenoDXUIWhitePoint(float3 color)
{
  ...
  // UI white is scaled relative to diffuse white, not peak white.
  // This lets the RenoDX UI white slider control HUD/text brightness.
  ...
  out float4 o0 : SV_Target0)
{
  ...
  // r0.y = texture alpha
  // r0.x = 1
  // r0.xyzw = vertex color * float4(1, 1, 1, alpha)
  float textureAlpha = t0.Sample(s0_s, v1.xy).w;

  r0.x = v2.x;
  r0.y = v2.y;
  r0.z = v2.z;
  r0.w = v2.w * textureAlpha;
  ...
  // Only enable this if this pass is premultiplied-alpha and transparent edges glow.
