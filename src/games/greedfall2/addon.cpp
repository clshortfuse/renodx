...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .max = 100.f,
        .is_enabled = []() { return shader_injection.tone_map_type > 0; },
        .parse = [](float value) { return (value - 50.f) * 0.001f; },
    },
    new renodx::utils::settings::Setting{
        .key = "FilmGrain",
        ...
        .label = "Film Grain",
        .section = "Effects",
        .tooltip = "Adds perceptual film grain to mask banding",
        .max = 100.f,
        .is_enabled = []() { return shader_injection.tone_map_type > 0; },
    ...
    new renodx::utils::settings::Setting{
        ...
        .label = "Cone Response",
        .section = "Effects",
        .tooltip = "Controls highlight contrast rolloff (Psycho only)",
        .max = 100.f,
        .is_enabled = []() { return shader_injection.tone_map_type == 4; },
    ...
    new renodx::utils::settings::Setting{
        ...
        .label = "Sharpening",
        .section = "Effects",
        .tooltip = "Contrast adaptive sharpening strength",
        .max = 100.f,
        .is_enabled = []() { return shader_injection.tone_map_type > 0; },
        .parse = [](float value) { return value * 0.01f; },
    },
    ...
    new renodx::utils::settings::Setting{
        ...
        .label = "RenoDX by ShortFuse, game mod by RankFTW.",
        .section = "About",
    },
    new renodx::utils::settings::Setting{
        .value_type = renodx::utils::settings::SettingValueType::TEXT,
    ...
    new renodx::utils::settings::Setting{
        ...
        .tint = 0x5865F2,
        .on_change = []() {
          renodx::utils::platform::LaunchURL("https://discord.gg/", "RWDRB3wxB");
        },
    },
    new renodx::utils::settings::Setting{
        .value_type = renodx::utils::settings::SettingValueType::BUTTON,
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for GreedFall 2";
