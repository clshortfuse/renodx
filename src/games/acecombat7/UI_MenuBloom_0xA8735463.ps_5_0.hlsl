// ---- Created with 3Dmigoto v1.4.1 on Fri Oct 11 21:13:08 2024
#include "./shared.h"
...
void main(
  ...
  linear noperspective float4 v8 : TEXCOORD8,
  linear noperspective float4 v9 : TEXCOORD9,
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = r1.xyzw * cb0[38].xyzw + r0.xyzw;
  r1.xyzw = t0.SampleLevel(s0_s, v7.xy, 0).xyzw;
  r0.xyzw = r1.xyzw * cb0[39].xyzw + r0.xyzw;
  r1.xyzw = t0.SampleLevel(s0_s, v7.zw, 0).xyzw;
  r0.xyzw = r1.xyzw * cb0[40].xyzw + r0.xyzw;
  r1.xyzw = t0.SampleLevel(s0_s, v8.xy, 0).xyzw;
  r0.xyzw = r1.xyzw * cb0[41].xyzw + r0.xyzw;
  r1.xyzw = t0.SampleLevel(s0_s, v8.zw, 0).xyzw;
  r0.xyzw = r1.xyzw * cb0[42].xyzw + r0.xyzw;
  r1.xyzw = t0.SampleLevel(s0_s, v9.xy, 0).xyzw;
  o0.xyzw = r1.xyzw * cb0[43].xyzw + r0.xyzw;
