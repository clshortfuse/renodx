// ---- Created with 3Dmigoto v1.4.1 on Thu Oct 10 02:03:17 2024
...
void main(
  ...
  r0.zw = r0.yy * r1.zw + v0.xy;
  r1.xyzw = r0.yyyy * r1.xyzw + v3.zwxy;
  r2.x = t1.Sample(s1_s, r1.xy).x;
  r2.y = t1.Sample(s1_s, r1.zw).y;
  r2.z = t1.Sample(s1_s, r0.zw).z;
  r0.yzw = t2.Sample(s2_s, v0.xy).xyz;
  r1.xy = -cb1[126].xy + v4.xy;
  r1.xy = cb1[127].zw * r1.xy;
  r1.xyz = t0.Sample(s0_s, r1.xy).xyz;
  r1.xyz = r1.xyz * cb2[0].xyz + cb0[30].xyz;
  r0.yzw = r1.xyz * r0.yzw;
  r0.yzw = r2.xyz * cb0[29].xyz + r0.yzw;
