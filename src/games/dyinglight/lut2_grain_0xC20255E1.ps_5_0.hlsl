...
void main(
  ...
  r0.w = cb0[2].x * r0.w;
  r0.w = cb0[0].w * r0.w;
  r1.x = t0.SampleLevel(s0_s, v2.xy, 0).x;        // red chromatic aberration
  r1.y = t0.SampleLevel(s0_s, v2.zw, 0).z;        // blue chromatic aberration
  r2.xyzw = t0.SampleLevel(s0_s, v3.zw, 0).xyzw;  // render

  r1.xy = -r2.xz + r1.xy;

  if (CUSTOM_CLAMP_CHROMATIC_ABERRATION) {
  ...
  r0.xyz = r0.xyz * CUSTOM_GRAIN_STRENGTH + r2.xyz;  // film grain
