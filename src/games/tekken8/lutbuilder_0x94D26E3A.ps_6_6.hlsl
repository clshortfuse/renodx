...
float4 main(
  ...
  float3 untonemapped_ap1 = float3(_576, _577, _578);  // CustomEdit
  ...
  float _1080 = exp2(((log2((max(0.0f, _1054)))) * (gamma)));
  float _1081 = exp2(((log2((max(0.0f, _1055)))) * (gamma)));
  // CustomEdit
  float3 film_graded_color = float3(_1079, _1080, _1081);
  if (shouldTonemap) {
