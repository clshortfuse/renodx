...
float4 main(
  ...
  if (!(rangeAdj == 0)) {
    ...
    float _43 = _42 - uiMaxLumScale;
    do {
      if (_43 > 0.0f) {
        float _46 = uiMaxLumScale * 0.10000002384185791f;
        _54 = (_46 * (1.0f - exp2(((-0.0f - _43) / _46) * 1.4426950216293335f)));
      } else {
        _54 = _43;
      }
      float _58 = (((uiMaxLumScale - _42) + _54) * (1.0f - (_14.w * _14.w))) + _42;
      bool _59 = (_42 > 0.0f);
  ...
  if (noUIBlend == 0) {
    _83 = ((_70 * _14.w) + (uiMaxLumScale * _14.x));
    _84 = ((_71 * _14.w) + (uiMaxLumScale * _14.y));
    _85 = ((_72 * _14.w) + (uiMaxLumScale * _14.z));
  } else {
    _83 = _70;
    _84 = _71;
    _85 = _72;
