...
float4 main(
  ...
  float _138 = PQEncodeLUT.Sample(SS_ClampLinear, float2(((exp2(log2(mad(_94, (mtxColorConvert[2].z), mad(_93, (mtxColorConvert[2].y), ((mtxColorConvert[2].x) * _92))) * 0.019999999552965164f) * 0.25f) * 0.99609375f) + 0.001953125f), 0.0f));
