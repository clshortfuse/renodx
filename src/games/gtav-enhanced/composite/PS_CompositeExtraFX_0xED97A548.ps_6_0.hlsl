...
float4 main(
  ...
  {
    float _262 = mid_gray_gamma;  // needs testing
    float _263 = mid_gray_gamma;  // needs testing
    float _264 = mid_gray_gamma;  // needs testing

    float _314 = mid_gray_gamma;
    float _315 = mid_gray_gamma;
    float _316 = mid_gray_gamma;
