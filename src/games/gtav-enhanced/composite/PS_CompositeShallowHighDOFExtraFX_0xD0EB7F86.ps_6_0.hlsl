...
float4 main(
  ...
  float mid_gray = 0.18f;
  {
    ...
    mid_gray = renodx::color::y::from::BT709(float3(_531, _532, _533));
  }
  ...
  float3 untonemapped = float3(_498, _499, _500) * mid_gray / 0.18f;
  ...
  ApplyPerChannelCorrection(untonemapped, _531, _532, _533);
