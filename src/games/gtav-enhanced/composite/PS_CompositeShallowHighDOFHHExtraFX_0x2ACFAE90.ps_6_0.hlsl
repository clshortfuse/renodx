...
float4 main(
  ...
  float mid_gray = 0.18f;
  {
    ...
    mid_gray = renodx::color::y::from::BT709(float3(_556, _557, _558));
  }
  ...
  float3 untonemapped = float3(_526, _527, _528) * mid_gray / 0.18f;
  ...
  ApplyPerChannelCorrection(untonemapped, _556, _557, _558);
