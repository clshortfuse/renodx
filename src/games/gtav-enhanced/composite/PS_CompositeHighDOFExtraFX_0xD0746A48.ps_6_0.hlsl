...
float4 main(
  ...
  {
    float _388 = mid_gray_gamma;  // needs testing
    float _389 = mid_gray_gamma;  // needs testing
    float _390 = mid_gray_gamma;  // needs testing

    float _440 = mid_gray_gamma;
    float _441 = mid_gray_gamma;
    float _442 = mid_gray_gamma;
