...
float4 main(
  ...
  float4 SV_Target;
  float4 _10 = t15_space1.Sample(s0_space2[(g_rage_dynamicsamplerindices_012 + 0u)], float2(TEXCOORD.x, TEXCOORD.y));
  SV_Target.x = (cb5_014w * _10.x);
  SV_Target.y = (cb5_014w * _10.y);
  SV_Target.z = (cb5_014w * _10.z);
  SV_Target.w = 1.0f;
  return SV_Target;
}
