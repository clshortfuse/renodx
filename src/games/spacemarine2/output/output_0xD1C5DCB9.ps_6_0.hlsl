...
float4 main(noperspective float4 SV_Position : SV_Position,
  ...
  float4 SV_Target;
  float4 _12 =
      HDR_TEX1.Sample(PS_SAMPLERS[4], float2((TEXCOORD.x), (TEXCOORD.y)));
  float4 _20 =
      HDR_TEX2.Sample(PS_SAMPLERS[4], float2((TEXCOORD.x), (TEXCOORD.y)));
  float _32 = (CB_PASS_HDR_004z) *
              ((min((_20.x), 64512.0f)) + (min((_12.x), 64512.0f)));
  float _33 = (CB_PASS_HDR_004z) *
              ((min((_20.y), 64512.0f)) + (min((_12.y), 64512.0f)));
  float _34 = (CB_PASS_HDR_004z) *
              ((min((_20.z), 64512.0f)) + (min((_12.z), 64512.0f)));
  float _62 = _32;
  float _63 = _33;
  float _64 = _34;
  float _147;
  if (!(((CB_PASS_HDR_000y) < 9.999999974752427e-07f))) {
    ...
    float _46 =
        sqrt((((TEXCOORD.w) * (TEXCOORD.w)) + ((TEXCOORD.z) * (TEXCOORD.z))));
    _62 = _32;
    _63 = _33;
    _64 = _34;
    if (((_46 > _42))) {
  ...
  float _72 =
      max(0.0f, ((exp2((-0.0f - ((CB_PASS_HDR_008w) * (CB_PASS_HDR_008z))))) *
                 0.18000000715255737f));
  float4 _98 = HDR_TEX_TONEMAP_LUT.Sample(
      PS_SAMPLERS[4],
      float3((((saturate(((CB_PASS_HDR_008w) +
                          (((log2((_72 + _62))) + 2.473931074142456f) /
                           (CB_PASS_HDR_008z))))) *
               0.96875f) +
              0.015625f),
             (((saturate(((CB_PASS_HDR_008w) +
                          (((log2((_72 + _63))) + 2.473931074142456f) /
                           (CB_PASS_HDR_008z))))) *
               0.96875f) +
              0.015625f),
             (((saturate(((CB_PASS_HDR_008w) +
                          (((log2((_72 + _64))) + 2.473931074142456f) /
                           (CB_PASS_HDR_008z))))) *
               0.96875f) +
              0.015625f)));
  float _108 =
      ((frac(((sin((((TEXCOORD.y) * 543.3099975585938f) + (TEXCOORD.x)))) *
              493013.0f))) *
       2.0f) +
      -1.0f;
  float _111 = min((max((_108 * +1.#INF), -1.0f)), 1.0f);
  float _118 = (_111 - ((sqrt((saturate((1.0f - (abs(_108))))))) * _111)) *
               0.003921568859368563f;
  float _128 = (CB_COMMON_DYN_029x) - (CB_COMMON_DYN_029y);
  float _134 =
      (-0.0f - ((CB_COMMON_DYN_029y) * (CB_COMMON_DYN_029x))) /
      (_128 * ((((float4)(HDR_TEX3.Sample(PS_SAMPLERS[4],
                                          float2((TEXCOORD.x), (TEXCOORD.y)))))
                    .x) -
               ((CB_COMMON_DYN_029x) / _128)));
  _147 = 0.0f;
  if (((_134 < (CB_PASS_HDR_007z)))) {
    _147 =
        (1.0f - (saturate(((_134 - (CB_PASS_HDR_007w)) * (CB_PASS_HDR_008x)))));
  }
