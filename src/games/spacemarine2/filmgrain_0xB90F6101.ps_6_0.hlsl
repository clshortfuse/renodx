...
// This shader is only loaded for some cutscenes
float4 main(
  ...
  float3 output_color = _33.rgb;
  output_color = renodx::draw::InvertIntermediatePass(output_color.rgb);
  if (CUSTOM_FILM_GRAIN_STRENGTH != 0) {
    output_color.rgb = renodx::effects::ApplyFilmGrain(
        output_color.rgb,
        TEXCOORD.xy,
        CUSTOM_RANDOM,
  ...
  output_color = renodx::draw::RenderIntermediatePass(output_color.rgb);
  return float4(output_color.rgb, 1.f);
  ...
  _74.rgb = renodx::draw::InvertIntermediatePass(_74.rgb);
  ...
  float _87 = dot(float3(_74.x, _74.y, _74.z), float3(0.21267099678516388f, 0.7151600122451782f, 0.0721689984202385f));
  ...
  SV_Target.x = ((_116 * (max((FILL_PARAMS[3].x), (((((FILL_PARAMS[0].x) * _43) + (FILL_PARAMS[2].x)) * (((_20 - _17) * (FILL_PARAMS[1].w)) + _17)) + _43)) - _43)) + _43);
  SV_Target.y = ((_116 * (max((FILL_PARAMS[3].y), (((((FILL_PARAMS[0].y) * _44) + (FILL_PARAMS[2].y)) * (((_20 - _18) * (FILL_PARAMS[1].w)) + _18)) + _44)) - _44)) + _44);
  SV_Target.z = ((_116 * (max((FILL_PARAMS[3].z), (((((FILL_PARAMS[0].z) * _45) + (FILL_PARAMS[2].z)) * (((_20 - _19) * (FILL_PARAMS[1].w)) + _19)) + _45)) - _45)) + _45);
