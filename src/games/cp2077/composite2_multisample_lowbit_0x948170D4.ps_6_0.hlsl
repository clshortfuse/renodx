...
void frag_main() {
  ...
  SV_Target.x = asfloat(asuint(((_34_m0[1u].w * (((_532 * _450) / _544) - _529)) + _529) * _34_m0[1u].z) + 65536u);
  SV_Target.y = asfloat(asuint(((_34_m0[1u].w * (((_532 * _451) / _544) - _530)) + _530) * _34_m0[1u].z) + 65536u);
  SV_Target.z = asfloat(asuint(((_34_m0[1u].w * (((_532 * _452) / _544) - _531)) + _531) * _34_m0[1u].z) + 131072u);
  SV_Target.w = 1.0f;
}
