...
void frag_main() {
  ...
  float3 _156 = _13.Sample(_37, float2(_72 - (_109 * 2.5f), _73 - (_110 * 2.5f)));
  float3 _162 = _12.Sample(_37, float2(_149, _142));
  float _168 = _142 - _110;
  float _172 = _34_m0[8u].w + (_149 - _109);
  float3 _173 = _12.Sample(_37, float2(_172, _168));
  float _186 = _168 - _110;
  float _187 = _34_m0[8u].w + (_172 - _109);
  float3 _188 = _12.Sample(_37, float2(_187, _186));
  float _200 = _186 - _110;
  float _201 = _34_m0[8u].w + (_187 - _109);
  float3 _202 = _12.Sample(_37, float2(_201, _200));
  ...
  float _251 = ((((_34_m0[0u].w * 0.625f) * ((((_188.x * 0.300000011920928955078125f) + (_173.x * 0.100000001490116119384765625f)) + (_202.x * 0.4000000059604644775390625f)) + (_12.Sample(_37, float2((_201 - _109) + _34_m0[8u].w, _200 - _110)).x * 0.800000011920928955078125f))) + (_34_m0[0u].x * injectedData.fxBloom * _156.x)));
  float _252 = (((_34_m0[0u].y * injectedData.fxBloom * _156.y) + (((((_188.y * 0.5f) + (_173.y * 0.4000000059604644775390625f)) + (_202.y * 0.20000000298023223876953125f)) * 0.90909087657928466796875f) * _34_m0[0u].w)));
  float _253 = (((_34_m0[0u].z * injectedData.fxBloom * _156.z) + (((((_173.z * 0.300000011920928955078125f) + (_162.z * 0.89999997615814208984375f)) + (_188.z * 0.100000001490116119384765625f)) * 0.76923072338104248046875f) * _34_m0[0u].w)));

  // Custom: global_gain and global_lift
  composite2_global(_34_m0[11u], _251, _252, _253);
  ...
  composite2_vignette(_251, _252, _253, _304, _305, _306);
  ...
  for (;;) {
    ...
    float3 _473 = _18[4u].SampleLevel(_37, float3(_465, _466, _467), 0.0f);
    _475 = _473.x;
    _476 = _473.y;
    _477 = _473.z;
    ...
    float _507;
    if (_485) {
      float3 _489 = _18[5u].SampleLevel(_37, float3(_465, _466, _467), 0.0f);
      ...
      if (_499 == 0u) {
        float3 _522 = _18[6u].SampleLevel(_37, float3(_465, _466, _467), 0.0f);
  ...
  for (;;) {
    ...
    float3 _709 = _18[4u].SampleLevel(_37, float3(_705, _706, _707), 0.0f);
    _711 = _709.x;
    _712 = _709.y;
    _713 = _709.z;
    ...
    float _742;
    if (_720) {
      float3 _724 = _18[5u].SampleLevel(_37, float3(_705, _706, _707), 0.0f);
      ...
      if (_734 == 0u) {
        float3 _757 = _18[6u].SampleLevel(_37, float3(_705, _706, _707), 0.0f);
  ...
  SV_Target.z = _796;
  SV_Target.w = 1.0f;
  SV_Target_1.x = _794 - _563;
  SV_Target_1.y = _795 - _564;
  SV_Target_1.z = _796 - _565;
  SV_Target_1.w = 1.0f;
}
