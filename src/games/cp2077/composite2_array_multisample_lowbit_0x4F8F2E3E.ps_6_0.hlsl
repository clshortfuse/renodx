...
void frag_main() {
  ...
  float4 _145 = _16.Sample(_40, float2(_75 - (_112 * 2.5f), _76 - (_113 * 2.5f)));
  float _157 = _131 - _113;
  float _161 = _37_m0[8u].w + (_138 - _112);
  float4 _162 = _15.Sample(_40, float2(_161, _157));
  float _175 = _157 - _113;
  float _176 = _37_m0[8u].w + (_161 - _112);
  float4 _177 = _15.Sample(_40, float2(_176, _175));
  float _189 = _175 - _113;
  float _190 = _37_m0[8u].w + (_176 - _112);
  float4 _191 = _15.Sample(_40, float2(_190, _189));
  ...
  for (;;) {
    ...
    float4 _468 = _21[4u].SampleLevel(_40, float3(_460, _461, _462), 0.0f);
    _470 = _468.x;
    _471 = _468.y;
    _472 = _468.z;
    ...
    float _502;
    if (_480) {
      float4 _484 = _21[5u].SampleLevel(_40, float3(_460, _461, _462), 0.0f);
      ...
      if (_494 == 0u) {
        float4 _517 = _21[6u].SampleLevel(_40, float3(_460, _461, _462), 0.0f);
  ...
  SV_Target.x = asfloat(asuint(((_37_m0[1u].w * (((_528 * _446) / _540) - _525)) + _525) * _37_m0[1u].z) + 65536u);
  SV_Target.y = asfloat(asuint(((_37_m0[1u].w * (((_528 * _447) / _540) - _526)) + _526) * _37_m0[1u].z) + 65536u);
  SV_Target.z = asfloat(asuint(((_37_m0[1u].w * (((_528 * _448) / _540) - _527)) + _527) * _37_m0[1u].z) + 131072u);
  SV_Target.w = 1.0f;
}
