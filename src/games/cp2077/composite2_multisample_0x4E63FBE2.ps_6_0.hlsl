...
void frag_main() {
  ...
  float3 _155 = _13.Sample(_37, float2(_71 - (_108 * 2.5f), _72 - (_109 * 2.5f)));
  float3 _161 = _12.Sample(_37, float2(_148, _141));
  float _167 = _141 - _109;
  float _171 = _34_m0[8u].w + (_148 - _108);
  float3 _172 = _12.Sample(_37, float2(_171, _167));
  float _185 = _167 - _109;
  float _186 = _34_m0[8u].w + (_171 - _108);
  float3 _187 = _12.Sample(_37, float2(_186, _185));
  float _199 = _185 - _109;
  float _200 = _34_m0[8u].w + (_186 - _108);
  float3 _201 = _12.Sample(_37, float2(_200, _199));
  ...
  float _250 = ((((_34_m0[0u].w * 0.625f) * ((((_187.x * 0.300000011920928955078125f) + (_172.x * 0.100000001490116119384765625f)) + (_201.x * 0.4000000059604644775390625f)) + (_12.Sample(_37, float2((_200 - _108) + _34_m0[8u].w, _199 - _109)).x * 0.800000011920928955078125f))) + (_34_m0[0u].x * injectedData.fxBloom * _155.x)));
  float _251 = (((_34_m0[0u].y * injectedData.fxBloom * _155.y) + (((((_187.y * 0.5f) + (_172.y * 0.4000000059604644775390625f)) + (_201.y * 0.20000000298023223876953125f)) * 0.90909087657928466796875f) * _34_m0[0u].w)));
  float _252 = (((_34_m0[0u].z * injectedData.fxBloom * _155.z) + (((((_172.z * 0.300000011920928955078125f) + (_161.z * 0.89999997615814208984375f)) + (_187.z * 0.100000001490116119384765625f)) * 0.76923072338104248046875f) * _34_m0[0u].w)));

  // Custom: global_gain and global_lift
  composite2_global(_34_m0[11u], _250, _251, _252);
  ...
  composite2_vignette(_250, _251, _252, _303, _304, _305);
  ...
  for (;;) {
    ...
    float3 _472 = _18[4u].SampleLevel(_37, float3(_464, _465, _466), 0.0f);
    _474 = _472.x;
    _475 = _472.y;
    _476 = _472.z;
    ...
    float _506;
    if (_484) {
      float3 _488 = _18[5u].SampleLevel(_37, float3(_464, _465, _466), 0.0f);
      ...
      if (_498 == 0u) {
        float3 _521 = _18[6u].SampleLevel(_37, float3(_464, _465, _466), 0.0f);
