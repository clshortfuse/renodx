  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (cb1[10].y > 0) {
    ...
    outputColor = linearColor;
      ...
      if(injectedData.colorGradeLUTStrength == 0.f || config.type == 1.f || (cb1[2].x <= 0 && cb1[0].x <= 0) ){
  ...
  r0.w = dot(r2.ywz, float3(0.7071,0.7071,0.7017));
  r3.xyz = float3(0.7071,0.7017,0.7071) * r0.www;
  r4.xyz = cb1[1].xyz * r3.zyz + -r2.yzw;
  r4.xyz = cb1[1].www * r4.xyz + r2.yzw;
  r4.xyz = -r0.www * float3(0.7071,0.7017,0.7071) + r4.xyz;
  r3.xyz = cb1[0].zzz * r3.xyz;
  r3.xyz = cb1[0].yyy * r4.xyz + r3.xyz;
  r3.xyz = float3(-0.73,-0.73,-0.73) + r3.xyz;
  r3.xyz = saturate(r3.xyz * cb1[0].www + float3(0.73, 0.73, 0.73));
  r2.xyz = (cb1[0].x > 0) ? r3.xyz : r2.yzw;
  lutOutput = renodx::color::gamma::DecodeSafe(r2.rgb);
  if (config.type == 0.f) {
    r2.rgb = lerp(lutInput, lutOutput, previous_lut_config_strength);
  } else {
    r2.rgb = renodx::tonemap::UpgradeToneMap(hdrColor, sdrColor, lutOutput, previous_lut_config_strength);
  }
    }
    linearColor = r2.rgb;
  ...
  r0.xy = frac(r0.xy);
  r1.z = 0.01 * cb0[84].x;
  r1.xy = cb0[84].xx * float2(0.01,0.01) + r1.xy;
  ...
  r1.w = dot(r4.xy, float2(12.9898,78.233));
  r1.w = sin(r1.w);
  ...
  r3.xy = r5.xy + r3.zw;
  r1.w = dot(r3.xy, float2(12.9898,78.233));
  r1.w = sin(r1.w);
  ...
  r1.w = dot(r4.zw, float2(12.9898,78.233));
  r1.w = sin(r1.w);
  r1.w = 59717.2891 * r1.w;
  r1.w = frac(r1.w);
  r5.z = r1.w * 2 + r1.z;
  ...
  r0.z = dot(r0.zw, float2(12.9898,78.233));
  r0.z = sin(r0.z);
  ...
  r0.z = dot(r0.zw, float2(12.9898,78.233));
  r0.z = sin(r0.z);
  r0.zw = float2(43758.546875,53184.136719) * r0.zz;
  r0.zw = frac(r0.zw);
  ...
  r0.z = r0.z + -r0.x;
  r0.x = r0.y * r0.z + r0.x;
  r0.b = renodx::color::y::from::NTSC1953(r2.rgb);
  r0.z = cb1[5].z * r0.y;
  r0.y = cb1[5].z * r0.y + -0.2;
