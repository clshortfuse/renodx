  ...
  out float4 o1 : SV_Target1)
{
  ...
  r0.xy = t7.SampleLevel(s2_s, r0.xy, 0).xz;
  r0.xy = saturate(r0.xy);
  r0.y = cb0[13].y * r0.y;
  r0.x = 6.28319979 * r0.x;
  sincos(r0.x, r0.x, r1.x);
  r1.y = r0.x;
  r0.xy = r1.xy * r0.yy + v1.xy;
  r1.xyz = t6.SampleLevel(s1_s, v1.xy, 0).xyz;
  r0.z = 6.28319979 * r1.x;
  sincos(r0.z, r1.x, r2.x);
  r2.y = r1.x;
  r3.xyzw = r2.xxyy * r1.zzzz + v1.xxyy;
  r0.zw = r2.xy * r1.zz;
  r1.xz = float2(10,10) * r3.xz;
  r2.xy = r3.yw * float2(-10,-10) + float2(10,10);
  r1.xz = saturate(min(r2.xy, r1.xz));
  r2.xy = r0.zw * r1.xz + v1.xy;
  r0.zw = r1.xz * r0.zw;
  r1.x = t6.SampleLevel(s1_s, r2.xy, 0).w;
  r0.xy = r0.zw * r1.xx + r0.xy;
  r1.xzw = t0.SampleLevel(s0_s, r0.xy, 0).xyz;
  r2.xyz = t4.SampleLevel(s1_s, r0.xy, 0).xyz;
  ...
  r1.w = t3.SampleLevel(s0_s, v1.xy, 0).x;
  r2.xy = r1.ww * cb0[14].xz + cb0[14].yw;
  r1.w = cmp(r1.w < cb0[20].z);
  r1.w = r1.w ? r2.x : r2.y;
  r1.w = min(1, abs(r1.w));
  r1.w = r1.w * r1.w;
  r1.w = saturate(r1.w * cb0[1].z + -0.5);
  r0.w = max(r1.w, r0.w);
  r0.w = min(1, r0.w);
