  ...
  out float4 o1 : SV_Target1)
{
  ...
  r2.xy = v1.xy * cb0[10].xy + cb0[10].zw;
  r1.y = t0.SampleLevel(s1_s, r2.xy, 0).y;
  r0.y = t1.SampleLevel(s1_s, r2.xy, 0).y;
  r2.xy = v1.xy * cb0[11].xy + cb0[11].zw;
  r1.z = t0.SampleLevel(s1_s, r2.xy, 0).z;
  r0.z = t1.SampleLevel(s1_s, r2.xy, 0).z;
  r2.xyz = t0.SampleLevel(s0_s, v1.xy, 0).xyz;
  r1.xyz = -r2.xyz + r1.xyz;
  r3.xyz = t5.SampleLevel(s1_s, v1.xy, 0).xyz;
  ...
  r1.xyz = cb0[6].xyz * r1.xyz + float3(-0.5,-0.5,-0.5);
  r1.xyz = r0.www * r1.xyz + float3(0.5,0.5,0.5);
