...
bool videoScale(reshade::api::command_list* cmd_list) {
...
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntry(0x6A8BFC0E),  // lutbuilder (custom uc2)
    ...
    CustomShaderEntryCallback(0xFE41EA26, &videoScale),  // uberpost (title menu)
    ...
    CustomShaderEntry(0x85463CFA),  // UI default
    CustomShaderEntry(0x31102333),  // UI default 2
    CustomShaderEntry(0x4E43372C),  // UI minimap
    CustomShaderEntry(0xC47E2D5B),  // UI camera
};
...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .label = "Camera Light",
        .section = "Effects",
        .tooltip = "Toggles camera's fake light.",
        .labels = {"Off", "On"},
        .tint = 0x3D5D84,
        .is_visible = []() { return current_settings_mode >= 1; },
    },
    ...
    new renodx::utils::settings::Setting{
        ...
        .on_change = []() {
          ...
          renodx::utils::settings::UpdateSetting("colorGradeHighlights", 50.f);
          renodx::utils::settings::UpdateSetting("colorGradeShadows", 50.f);
          renodx::utils::settings::UpdateSetting("colorGradeContrast", 85.f);
          renodx::utils::settings::UpdateSetting("colorGradeSaturation", 85.f);
          renodx::utils::settings::UpdateSetting("colorGradeBlowout", 65.f);
          renodx::utils::settings::UpdateSetting("colorGradeDechroma", 65.f);
          renodx::utils::settings::UpdateSetting("colorGradeLUTStrength", 100.f);
          renodx::utils::settings::UpdateSetting("colorGradeLUTScaling", 100.f); },
