...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .tooltip = "Sets the tone mapper type.\nVanilla+ uses the vanilla tone mapping and in-game calibration with gamma correction, improved brightness scaling, and improved display mapping.\nRenoDX ACES replaces the game's tone mapper with our ACES implementation. Uses renodx sliders for calibration.\nPsychoV is Shortfuse's advanced new tone mapper. Applied on top of ACES curves by luminosity for grading.",
        .labels = {"Vanilla+","RenoDX ACES", "PsychoV (Beta)"},
    ...
    new renodx::utils::settings::Setting{
        ...
        .section = "Tone Mapping",
        .tooltip = "Emulates SDR gamma options. Always used with Vanilla+, probably not needed with other tone mappers.",
        .labels = {"Off", "2.2"},
        .is_enabled = []() { return RENODX_TONE_MAP_TYPE != 0; },
    ...
    new renodx::utils::settings::Setting{
        ...
        .is_visible = []() { return current_settings_mode >= 1.f; },
            ...
            new renodx::utils::settings::Setting{
        .key = "ColorGradeAdaptiveContrast",
        .binding = &shader_injection.tone_map_adaptive_contrast,
        .default_value = 50.f,
