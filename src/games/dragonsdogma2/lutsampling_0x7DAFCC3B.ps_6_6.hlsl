...
float4 main(
  ...
  if (RENODX_TONE_MAP_TYPE != 0) {
    //_9.xyz *= 0.5f; // Cut brightness in half
  ...
  // if (RENODX_TONE_MAP_TYPE != 0) {
  //   // _66.xyz = renodx::color::pq::DecodeSafe(_66.xyz, 100.f);
  //   // SV_Target.xyz = CustomTonemap(_66.xyz, TEXCOORD);
  //   SV_Target.xyz = SampleSDRLUT(float3(_27, _42, _57), TrilinearClamp, SrcLUT);
  //   SV_Target.w = 1.0f;
  //   return SV_Target;
  // }
