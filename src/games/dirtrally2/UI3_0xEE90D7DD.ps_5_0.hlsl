#include "./shared.h"
// ---- Created with 3Dmigoto v1.3.2 on Thu Apr 24 12:56:35 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  while (true) {
    r2.z = cmp((int)r1.x >= 9);
    if (r2.z != 0) break;
    r2.zw = TGaussBlurKernel.Load(r1.xyz).xy;
    r3.x = r2.w * r0.x;
    r3.zw = r3.xy + r2.xy;
    r4.xyz = TGaussBlurSource.Sample(TGaussBlurSourceSampler_s, r3.zw).xyz;
    r3.xz = -r3.xy + r2.xy;
    r3.xzw = TGaussBlurSource.Sample(TGaussBlurSourceSampler_s, r3.xz).xyz;
    r3.xzw = r4.xyz + r3.xzw;
    r0.yzw = r2.zzz * r3.xzw + r0.yzw;
    r1.x = (int)r1.x + 1;
  }
  ...
  // o0.xyz = exp2(r0.xyz);
  // o0.rgb = renodx::color::gamma::DecodeSafe(r0.yzw, 1.f);
  o0.rgb = r0.yzw;
  o0.w = v3.w;
  return;
}