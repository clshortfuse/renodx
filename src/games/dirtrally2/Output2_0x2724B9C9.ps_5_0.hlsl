...
SamplerState warpMapSampler_s : register(s7);
SamplerState overlayMapSampler_s : register(s8);
SamplerState bokehMapSampler_s : register(s9);
SamplerState dustMapSampler_s : register(s10);
SamplerState lensRainSampler_s : register(s11);
SamplerState lensMudMapSampler_s : register(s12);
SamplerState decodeLUTSampler_s : register(s13);
...
Texture2D<float4> warpMap : register(t4);
Texture2D<float4> overlayMap : register(t5);
Texture2D<float4> motionBlur : register(t6);
Texture2D<float4> bokehMap : register(t7);
Texture2D<float4> dustMap : register(t8);
Texture2D<float4> lensRain : register(t9);
Texture2D<float4> lensMudMap : register(t10);
Texture3D<float4> decodeLUT : register(t11);
