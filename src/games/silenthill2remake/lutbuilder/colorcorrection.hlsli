...
void ApplyColorCorrection(float in_r, float in_g, float in_b,
  ...
  float3 WorkingColor = float3(in_r, in_g, in_b);
  ...
  out_r = WorkingColor.r;
  out_g = WorkingColor.g;
  out_b = WorkingColor.b;
}
