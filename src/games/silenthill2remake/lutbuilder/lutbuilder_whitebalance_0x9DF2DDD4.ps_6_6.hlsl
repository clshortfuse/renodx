...
float4 main(
  ...
  float _399 = (1.0f - exp2(((_381 * _381) * -4.0f) * expand_gamut)) * (1.0f - exp2(dot(float3(_385, _386, _387), float3(_385, _386, _387)) * -4.0f));
  ...
  float _1145, _1146, _1147;
  ApplyFilmToneMapWithBlueCorrect(_783, _785, _787,
                                  _1145, _1146, _1147);
#else
  ...
  float _874 = ((float((int)(((int)(uint)((bool)(_859 > 0.0f))) - ((int)(uint)((bool)(_859 < 0.0f))))) * (1.0f - (_863 * _863))) + 1.0f) * 0.02500000037252903f;
  ...
  float _1003 = (lerp(_957, _954, 0.9599999785423279f));
  float _1004 = (lerp(_957, _955, 0.9599999785423279f));
  float _1005 = (lerp(_957, _956, 0.9599999785423279f));

#if 1
  float _1145, _1146, _1147;
  ApplyFilmicToneMap(_1003, _1004, _1005,
                     _823, _824, _825,
                     _1145, _1146, _1147);
#else
  _1003 = log2(_1003) * 0.3010300099849701f;
  _1004 = log2(_1004) * 0.3010300099849701f;
  _1005 = log2(_1005) * 0.3010300099849701f;
  ...
  float _1127 = (cb0_036w * (max(0.0f, (lerp(_1107, _1104, 0.9300000071525574f))) - _823)) + _823;
  float _1128 = (cb0_036w * (max(0.0f, (lerp(_1107, _1105, 0.9300000071525574f))) - _824)) + _824;
  float _1129 = (cb0_036w * (max(0.0f, (lerp(_1107, _1106, 0.9300000071525574f))) - _825)) + _825;
  ...
  float _1157 = (mad((UniformBufferConstants_WorkingColorSpace_192[0].z), _1147, mad((UniformBufferConstants_WorkingColorSpace_192[0].y), _1146, ((UniformBufferConstants_WorkingColorSpace_192[0].x) * _1145))));
  float _1158 = (mad((UniformBufferConstants_WorkingColorSpace_192[1].z), _1147, mad((UniformBufferConstants_WorkingColorSpace_192[1].y), _1146, ((UniformBufferConstants_WorkingColorSpace_192[1].x) * _1145))));
  float _1159 = (mad((UniformBufferConstants_WorkingColorSpace_192[2].z), _1147, mad((UniformBufferConstants_WorkingColorSpace_192[2].y), _1146, ((UniformBufferConstants_WorkingColorSpace_192[2].x) * _1145))));
  ...
  if (GenerateOutput(_1194, _1195, _1196, SV_Target)) {
    return SV_Target;
  }
                ...
                do {
                  if (!(!(_1593 <= _1595))) {
                    ...
                    if ((bool)(_1593 > _1595) && (bool)(_1593 < _1603)) {
                      ...
                      int _1612 = int(_1611);
                      float _1614 = _1611 - float((int)(_1612));
                  ...
                  do {
                    if (!(!(_1669 <= _1595))) {
                      ...
                      if ((bool)(_1669 > _1595) && (bool)(_1669 < _1677)) {
                        ...
                        int _1686 = int(_1685);
                        float _1688 = _1685 - float((int)(_1686));
                        ...
                        do {
                          if (!(!(_1669 >= _1677))) {
                            ...
                            if (_1669 < (_1707 * 0.3010300099849701f)) {
                              ...
                              int _1716 = int(_1715);
                              float _1718 = _1715 - float((int)(_1716));
                    ...
                    do {
                      if (!(!(_1743 <= _1595))) {
                        ...
                        if ((bool)(_1743 > _1595) && (bool)(_1743 < _1751)) {
                          ...
                          int _1760 = int(_1759);
                          float _1762 = _1759 - float((int)(_1760));
                          ...
                          do {
                            if (!(!(_1743 >= _1751))) {
                              ...
                              if (_1743 < (_1781 * 0.3010300099849701f)) {
                                ...
                                int _1790 = int(_1789);
                                float _1792 = _1789 - float((int)(_1790));
