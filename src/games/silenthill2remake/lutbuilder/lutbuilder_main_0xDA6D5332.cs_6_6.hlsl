...
void main(
  ...
  float _901, _902, _903;
  ApplyFilmToneMapWithBlueCorrect(_539, _541, _543,
                                  _901, _902, _903);
#else
  ...
  float _759 = (lerp(_713, _710, 0.9599999785423279f));
  float _760 = (lerp(_713, _711, 0.9599999785423279f));
  float _761 = (lerp(_713, _712, 0.9599999785423279f));

#if 1
  float _901, _902, _903;
  ApplyFilmicToneMap(_759, _760, _761,
                     _579, _580, _581,
                     _901, _902, _903);
#else
  // split the previous line so we can get the color before log2()
  _759 = log2(_759) * 0.3010300099849701f;
  _760 = log2(_760) * 0.3010300099849701f;
  _761 = log2(_761) * 0.3010300099849701f;
  ...
  // these lines are removed from here and moved up to just after _713
  ...
  float _913 = (mad((UniformBufferConstants_WorkingColorSpace_192[0].z), _903, mad((UniformBufferConstants_WorkingColorSpace_192[0].y), _902, ((UniformBufferConstants_WorkingColorSpace_192[0].x) * _901))));
  float _914 = (mad((UniformBufferConstants_WorkingColorSpace_192[1].z), _903, mad((UniformBufferConstants_WorkingColorSpace_192[1].y), _902, ((UniformBufferConstants_WorkingColorSpace_192[1].x) * _901))));
  float _915 = (mad((UniformBufferConstants_WorkingColorSpace_192[2].z), _903, mad((UniformBufferConstants_WorkingColorSpace_192[2].y), _902, ((UniformBufferConstants_WorkingColorSpace_192[2].x) * _901))));

  // remove BT.709 clamps
  // _913 = max(0, _913);
  // _914 = max(0, _914);
  // _915 = max(0, _915);
  ...
  if (GenerateOutput(_950, _951, _952, u0[SV_DispatchThreadID])) {
    return;
  }
  ...
  u0[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))] = float4((_2402 / 1.05f), (_2403 / 1.05f), (_2404 / 1.05f), 0.0f);
}
