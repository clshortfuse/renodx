...
OutputSignature main(
  ...
  float4 _229 = ColorGradingLUT.Sample(ColorGradingLUTSampler, float3(
    ((LUTScale * saturate((log2((((_68.x * _183) * ((BloomDirtMaskTint.x * _87.x) + 1.0f)) + 0.002667719265446067f) + (((ColorScale0.x * _44.x) * _107) * _184)) * 0.0714285746216774f) + 0.6107269525527954f)) + LUTOffset),
   ((LUTScale * saturate((log2((((_68.y * _183) * ((BloomDirtMaskTint.y * _87.y) + 1.0f)) + 0.002667719265446067f) + (((ColorScale0.y * _44.y) * _108) * _184)) * 0.0714285746216774f) + 0.6107269525527954f)) + LUTOffset), 
   ((LUTScale * saturate((log2((((_68.z * _183) * ((BloomDirtMaskTint.z * _87.z) + 1.0f)) + 0.002667719265446067f) + (((ColorScale0.z * _44.z) * _109) * _184)) * 0.0714285746216774f) + 0.6107269525527954f)) + LUTOffset)));

  float3 midgray = (((ColorScale0.rgb * 0.18f) * SceneColorApplyParamaters[0].rgb) * _184);
  float3 untonemapped = _44.rgb;
  return LutToneMap(untonemapped, _229.rgb, TEXCOORD, midgray);
