...
cbuffer HardCodedConstants : register(b12) {
  ...
  float4 AlphaTexture_ULLRegister : packoffset(c2);
}
...
void main(float4 v0 : SV_Position0, float4 v1 : CLIP_SPACE_POSITION0, float4 v2 : SV_ClipDistance0, float4 v3 : SV_ClipDistance1, float4 v4 : TEXCOORD0, out float4 o0 : SV_TARGET0) {
  ...
  r0.xyzw = GenericTint1.xxxx * r0.xyzw + r1.xxxy;
  r1.xyzw = AlphaTexture_T.Sample(AlphaTexture_S_s, v4.zw).xyzw;
  r1.x = AlphaTexture_ULLRegister.x + r1.x;
  r0.w = r1.x * r0.w;
  r0.w = AlphaFade * r0.w;
