// ---- Created with 3Dmigoto v1.4.1 on Sun Apr 20 14:49:35 2025
  ...
  out float4 o1 : SV_Target1)
{
  ...
  r0.z = cmp(r0.x < FocusPlane);
  r0.z = r0.z ? r3.x : r3.y;
  r0.z = min(1, abs(r0.z));
  r0.z = r0.z * r0.z;
  r0.z = saturate(r0.z * BokehParams.z + -0.5);
  r0.z = max(r0.z, r2.w);
  r0.z = min(1, r0.z);
  ...
  r0.yw = r0.yw * ColorSeparationUVScaleBias2.xy + ColorSeparationUVScaleBias2.zw;
  ...
  r1.w = max(0, r1.w);
  r4.y = min(65000, r1.w);
  r1.w = ColorSampler.SampleLevel(Clamp_s, r0.yw, 0, int2(0, 0)).z;
  r1.w = max(0, r1.w);
  r4.z = min(65000, r1.w);
  ...
  r1.w = max(0, r1.w);
  r5.y = min(5000, r1.w);
  r0.y = ColorAndMaskTexture.SampleLevel(Clamp_s, r0.yw, 0).z;
  r0.y = max(0, r0.y);
  r5.z = min(5000, r0.y);
