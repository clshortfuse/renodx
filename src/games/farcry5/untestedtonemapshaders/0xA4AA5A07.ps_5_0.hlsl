// ---- Created with 3Dmigoto v1.4.1 on Sun Apr 20 14:49:50 2025
...
Texture2D<float4> DistortionTexture : register(t7);
Texture2D<float4> SourceDistortionTexture : register(t8);
Texture2D<float> LocalExposureTexture : register(t9);
Texture2D<float4> NoiseTexture : register(t10);
