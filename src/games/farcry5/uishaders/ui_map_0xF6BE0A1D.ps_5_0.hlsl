#include "../shared.h"
// ---- Created with 3Dmigoto v1.4.1 on Mon Apr 21 20:57:15 2025
...
void main(
  ...
  if (RENODX_TONE_MAP_TYPE != 0 && RENODX_GAMMA_CORRECTION) r1.rgb = renodx::color::correct::GammaSafe(r1.rgb);
  ...
  if (SCRGB != 0) {
    ...
    if (RENODX_TONE_MAP_TYPE == 0.f) {
      ...
      r1.rgb *= RENODX_GRAPHICS_WHITE_NITS;
    }
