...
void main(
  ...
  bool _101 = ((uint)(bIsTemperatureWhiteBalance) != 0);
  ...
  float _267 = mad(_246, (WorkingColorSpace_ToXYZ[2].x), mad(_243, (WorkingColorSpace_ToXYZ[1].x), (_240 * (WorkingColorSpace_ToXYZ[0].x))));
  float _270 = mad(_246, (WorkingColorSpace_ToXYZ[2].y), mad(_243, (WorkingColorSpace_ToXYZ[1].y), (_240 * (WorkingColorSpace_ToXYZ[0].y))));
  float _273 = mad(_246, (WorkingColorSpace_ToXYZ[2].z), mad(_243, (WorkingColorSpace_ToXYZ[1].z), (_240 * (WorkingColorSpace_ToXYZ[0].z))));
  float _276 = mad(_255, (WorkingColorSpace_ToXYZ[2].x), mad(_252, (WorkingColorSpace_ToXYZ[1].x), (_249 * (WorkingColorSpace_ToXYZ[0].x))));
  float _279 = mad(_255, (WorkingColorSpace_ToXYZ[2].y), mad(_252, (WorkingColorSpace_ToXYZ[1].y), (_249 * (WorkingColorSpace_ToXYZ[0].y))));
  float _282 = mad(_255, (WorkingColorSpace_ToXYZ[2].z), mad(_252, (WorkingColorSpace_ToXYZ[1].z), (_249 * (WorkingColorSpace_ToXYZ[0].z))));
  float _285 = mad(_264, (WorkingColorSpace_ToXYZ[2].x), mad(_261, (WorkingColorSpace_ToXYZ[1].x), (_258 * (WorkingColorSpace_ToXYZ[0].x))));
  float _288 = mad(_264, (WorkingColorSpace_ToXYZ[2].y), mad(_261, (WorkingColorSpace_ToXYZ[1].y), (_258 * (WorkingColorSpace_ToXYZ[0].y))));
  float _291 = mad(_264, (WorkingColorSpace_ToXYZ[2].z), mad(_261, (WorkingColorSpace_ToXYZ[1].z), (_258 * (WorkingColorSpace_ToXYZ[0].z))));
  float _321 = mad(mad((WorkingColorSpace_FromXYZ[0].z), _291, mad((WorkingColorSpace_FromXYZ[0].y), _282, (_273 * (WorkingColorSpace_FromXYZ[0].x)))), _74, mad(mad((WorkingColorSpace_FromXYZ[0].z), _288, mad((WorkingColorSpace_FromXYZ[0].y), _279, (_270 * (WorkingColorSpace_FromXYZ[0].x)))), _73, (mad((WorkingColorSpace_FromXYZ[0].z), _285, mad((WorkingColorSpace_FromXYZ[0].y), _276, (_267 * (WorkingColorSpace_FromXYZ[0].x)))) * _72)));
  float _324 = mad(mad((WorkingColorSpace_FromXYZ[1].z), _291, mad((WorkingColorSpace_FromXYZ[1].y), _282, (_273 * (WorkingColorSpace_FromXYZ[1].x)))), _74, mad(mad((WorkingColorSpace_FromXYZ[1].z), _288, mad((WorkingColorSpace_FromXYZ[1].y), _279, (_270 * (WorkingColorSpace_FromXYZ[1].x)))), _73, (mad((WorkingColorSpace_FromXYZ[1].z), _285, mad((WorkingColorSpace_FromXYZ[1].y), _276, (_267 * (WorkingColorSpace_FromXYZ[1].x)))) * _72)));
  float _327 = mad(mad((WorkingColorSpace_FromXYZ[2].z), _291, mad((WorkingColorSpace_FromXYZ[2].y), _282, (_273 * (WorkingColorSpace_FromXYZ[2].x)))), _74, mad(mad((WorkingColorSpace_FromXYZ[2].z), _288, mad((WorkingColorSpace_FromXYZ[2].y), _279, (_270 * (WorkingColorSpace_FromXYZ[2].x)))), _73, (mad((WorkingColorSpace_FromXYZ[2].z), _285, mad((WorkingColorSpace_FromXYZ[2].y), _276, (_267 * (WorkingColorSpace_FromXYZ[2].x)))) * _72)));
  ...
  float _820 = ((float(((int)(uint)((bool)(_805 > 0.0f))) - ((int)(uint)((bool)(_805 < 0.0f)))) * (1.0f - (_809 * _809))) + 1.0f) * 0.02500000037252903f;
  ...
  if (CUSTOM_PROCESSING_MODE == 0.f && RENODX_TONE_MAP_TYPE != 0.f) {
    RWOutputTexture[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))] =
        GenerateOutput(float3(_1270, _1271, _1272), OutputDevice);
    return;
  }
  ...
  if ((uint)(WorkingColorSpace_bIsSRGB) == 0) {
    ...
    float _1285 = mad((WorkingColorSpace_ToAP1[2].z), _1272, mad((WorkingColorSpace_ToAP1[2].y), _1271, ((WorkingColorSpace_ToAP1[2].x) * _1270)));
