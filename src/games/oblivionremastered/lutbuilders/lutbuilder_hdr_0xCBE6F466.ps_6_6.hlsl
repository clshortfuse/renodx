...
float4 main(
  ...
  if ((bool)((uint)(OutputDevice) == 3) || (bool)((uint)(OutputDevice) == 5)) {
    ...
    float _163 = ((float(((int)(uint)((bool)(_148 > 0.0f))) - ((int)(uint)((bool)(_148 < 0.0f)))) * (1.0f - (_152 * _152))) + 1.0f) * 0.02500000037252903f;
    do {
    ...
    if (((uint)(OutputDevice) & -3) == 4) {
      ...
      float _691 = ((float(((int)(uint)((bool)(_676 > 0.0f))) - ((int)(uint)((bool)(_676 < 0.0f)))) * (1.0f - (_680 * _680))) + 1.0f) * 0.02500000037252903f;
      do {
