...
void frag_main() {
  ...
  float _751 = exp2(log2(max((_652 >= 0.5f) ? mad(-(1.0f - _652), _725, 1.0f) : (_652 * _732), 0.0f)) * 0.0126833133399486541748046875f);
  float _752 = exp2(log2(max((_653 >= 0.5f) ? mad(-(1.0f - _653), _725, 1.0f) : (_653 * _732), 0.0f)) * 0.0126833133399486541748046875f);
  float _753 = exp2(log2(max((_654 >= 0.5f) ? mad(-(1.0f - _654), _725, 1.0f) : (_654 * _732), 0.0f)) * 0.0126833133399486541748046875f);
