...
void frag_main() {
  ...
  float _617 = exp2(log2(_599 + _604) * 0.0126833133399486541748046875f);
  float _618 = exp2(log2(_604 + _600) * 0.0126833133399486541748046875f);
  float _619 = exp2(log2(_604 + _601) * 0.0126833133399486541748046875f);
  ...
  float _698 = exp2(log2(dp3_f32(float3(1.025799274444580078125f, -0.02005250938236713409423828125f, -0.005771367810666561126708984375f), _685) * 0.024999998509883880615234375f) * 0.1593017578125f);
  float _699 = exp2(log2(dp3_f32(float3(-0.00223502493463456630706787109375f, 1.0045826435089111328125f, -0.00235231337137520313262939453125f), _685) * 0.024999998509883880615234375f) * 0.1593017578125f);
  float _700 = exp2(log2(dp3_f32(float3(-0.005014003254473209381103515625f, -0.025293387472629547119140625f, 1.03044021129608154296875f), _685) * 0.024999998509883880615234375f) * 0.1593017578125f);
  ...
  float _840 = exp2(log2(max((_741 >= 0.5f) ? mad(-(1.0f - _741), _814, 1.0f) : (_741 * _821), 0.0f)) * 0.0126833133399486541748046875f);
  float _841 = exp2(log2(max((_742 >= 0.5f) ? mad(-(1.0f - _742), _814, 1.0f) : (_742 * _821), 0.0f)) * 0.0126833133399486541748046875f);
  float _842 = exp2(log2(max((_743 >= 0.5f) ? mad(-(1.0f - _743), _814, 1.0f) : (_743 * _821), 0.0f)) * 0.0126833133399486541748046875f);
