...
void frag_main() {
  ...
  float _756 = exp2(log2(_738 + _743) * 0.0126833133399486541748046875f);
  float _757 = exp2(log2(_743 + _739) * 0.0126833133399486541748046875f);
  float _758 = exp2(log2(_743 + _740) * 0.0126833133399486541748046875f);
  ...
  float _837 = exp2(log2(dp3_f32(float3(1.025799274444580078125f, -0.02005250938236713409423828125f, -0.005771367810666561126708984375f), _824) * 0.024999998509883880615234375f) * 0.1593017578125f);
  float _838 = exp2(log2(dp3_f32(float3(-0.00223502493463456630706787109375f, 1.0045826435089111328125f, -0.00235231337137520313262939453125f), _824) * 0.024999998509883880615234375f) * 0.1593017578125f);
  float _839 = exp2(log2(dp3_f32(float3(-0.005014003254473209381103515625f, -0.025293387472629547119140625f, 1.03044021129608154296875f), _824) * 0.024999998509883880615234375f) * 0.1593017578125f);
  ...
  float _979 = exp2(log2(max((_880 >= 0.5f) ? mad(-(1.0f - _880), _953, 1.0f) : (_880 * _960), 0.0f)) * 0.0126833133399486541748046875f);
  float _980 = exp2(log2(max((_881 >= 0.5f) ? mad(-(1.0f - _881), _953, 1.0f) : (_881 * _960), 0.0f)) * 0.0126833133399486541748046875f);
  float _981 = exp2(log2(max((_882 >= 0.5f) ? mad(-(1.0f - _882), _953, 1.0f) : (_882 * _960), 0.0f)) * 0.0126833133399486541748046875f);
