...
void frag_main() {
  ...
  float _785 = exp2(log2(_767 + _772) * 0.0126833133399486541748046875f);
  float _786 = exp2(log2(_772 + _768) * 0.0126833133399486541748046875f);
  float _787 = exp2(log2(_772 + _769) * 0.0126833133399486541748046875f);
  ...
  float _866 = exp2(log2(dp3_f32(float3(1.025799274444580078125f, -0.02005250938236713409423828125f, -0.005771367810666561126708984375f), _853) * 0.024999998509883880615234375f) * 0.1593017578125f);
  float _867 = exp2(log2(dp3_f32(float3(-0.00223502493463456630706787109375f, 1.0045826435089111328125f, -0.00235231337137520313262939453125f), _853) * 0.024999998509883880615234375f) * 0.1593017578125f);
  float _868 = exp2(log2(dp3_f32(float3(-0.005014003254473209381103515625f, -0.025293387472629547119140625f, 1.03044021129608154296875f), _853) * 0.024999998509883880615234375f) * 0.1593017578125f);
  ...
  float _1008 = exp2(log2(max((_909 >= 0.5f) ? mad(-(1.0f - _909), _982, 1.0f) : (_909 * _989), 0.0f)) * 0.0126833133399486541748046875f);
  float _1009 = exp2(log2(max((_910 >= 0.5f) ? mad(-(1.0f - _910), _982, 1.0f) : (_910 * _989), 0.0f)) * 0.0126833133399486541748046875f);
  float _1010 = exp2(log2(max((_911 >= 0.5f) ? mad(-(1.0f - _911), _982, 1.0f) : (_911 * _989), 0.0f)) * 0.0126833133399486541748046875f);
