...
Texture2D<float4> g_MiscMap1 : register(t6);
  ...
  out float3 o0 : SV_TARGET0)
{
  ...
  r0.xyz = g_MiscMap1.Sample(g_LinearClampSampler_s, v1.xy).xyz;
  r1.xyz = g_MiscMap0.Sample(g_LinearClampSampler_s, v1.xy).xyz;
  r0.xyz = min(r1.xyz, r0.xyz);
  r0.xyz = r1.xyz + -r0.xyz;
  r0.xyz = max(float3(1.52587891e-05,1.52587891e-05,1.52587891e-05), r0.xyz);
