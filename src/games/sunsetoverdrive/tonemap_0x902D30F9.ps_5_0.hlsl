  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.xyz = cmp(r2.xyz < float3(0.00313080009,0.00313080009,0.00313080009));
  ...
  r1.rgb = applyUserTonemap(untonemapped, g_ColorLut3d, g_LinearClampSampler_s, vanilla, midGray);
  ...
  r0.xyz = -r1.xyz + r0.xyz;
  r0.xyz = g_TM_GrainStrength * r0.xyz * injectedData.fxFilmGrain + r1.xyz;
  }
