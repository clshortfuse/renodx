...
// ---- Created with 3Dmigoto v1.4.1 on Thu Mar 27 18:44:27 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  while (true) {
    ...
    r11.xyzw = t4.SampleLevel(s5_s, r8.zw, 0).xyzw;
    r4.x = -0.5 + r11.x;
    r4.x = r4.x + r4.x;
    r5.xyz = r10.xyz;
  ...
  r5.xyzw = t5.Sample(s6_s, r3.xy).xyzw;
  r2.xyz = r5.zxy * float3(2,2,2) + r2.xyz;
  r5.xyzw = t5.Sample(s6_s, w2.xy).xyzw;
  ...
  r1.xyzw = t6.Sample(s7_s, v2.xy).xyzw;
  ...
  r2.xyzw = t7.Sample(s8_s, r1.xz).xyzw;
  r4.z = cb0[12].y;
  r0.zw = r1.xz + r4.zw;
  r1.xyzw = t7.Sample(s8_s, r0.zw).xyzw;
  r0.x = r0.x * cb0[12].z + -r0.y;
  r0.yzw = r1.xyz + -r2.xyz;
  r0.xyz = saturate(r0.xxx * r0.yzw + r2.xyz);
