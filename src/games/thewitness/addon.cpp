...
#include <embed/0x5F92E474.h>
#include <embed/0x415DFB3A.h>
...
extern "C" __declspec(dllexport) const char* NAME = "RenoDX - The Witness";
extern "C" __declspec(dllexport) const char* DESCRIPTION = "RenoDX for The Witness";

ShaderReplaceMod::CustomShaders customShaders = {
  CustomShaderEntry(0x5F92E474),
  CustomShaderEntry(0x415DFB3A)
};
  ...
  switch (fdwReason) {
    case DLL_PROCESS_ATTACH:
      ...
      SwapChainUpgradeMod::swapChainUpgradeTargets.push_back(
        {reshade::api::format::b8g8r8a8_typeless, reshade::api::format::r16g16b16a16_typeless, 0}
      );
