...
void main(
...
#if 1
  ApplyFilmicToneMap(lerpColor.r, lerpColor.g, lerpColor.b, _514, _515, _516);
  float _836 = lerpColor.r, _837 = lerpColor.g, _838 = lerpColor.b;
#else
  ...
  // Remove max
  float _860 = mad((WorkingColorSpace.FromAP1[0].z), _838, mad((WorkingColorSpace.FromAP1[0].y), _837, ((WorkingColorSpace.FromAP1[0].x) * _836)));
  float _861 = mad((WorkingColorSpace.FromAP1[1].z), _838, mad((WorkingColorSpace.FromAP1[1].y), _837, ((WorkingColorSpace.FromAP1[1].x) * _836)));
  float _862 = mad((WorkingColorSpace.FromAP1[2].z), _838, mad((WorkingColorSpace.FromAP1[2].y), _837, ((WorkingColorSpace.FromAP1[2].x) * _836)));
  ...
  if (GenerateOutput(_911, _912, _913, SV_Target, is_hdr)) {
