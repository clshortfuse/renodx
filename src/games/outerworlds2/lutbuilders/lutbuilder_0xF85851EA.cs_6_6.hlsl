...
void main(
  ...
  float3 lerpColor = lerp(_903, float3(_900, _901, _902), 0.9599999785423279f);

#if 1
  ApplyFilmicToneMap(lerpColor.r, lerpColor.g, lerpColor.b, _769, _770, _771);
  float _1091 = lerpColor.r, _1092 = lerpColor.g, _1093 = lerpColor.b;
#else
  ...
  float _1118 = mad((WorkingColorSpace.FromAP1[0].z), _1093, mad((WorkingColorSpace.FromAP1[0].y), _1092, ((WorkingColorSpace.FromAP1[0].x) * _1091)));
  float _1119 = mad((WorkingColorSpace.FromAP1[1].z), _1093, mad((WorkingColorSpace.FromAP1[1].y), _1092, ((WorkingColorSpace.FromAP1[1].x) * _1091)));
  float _1120 = mad((WorkingColorSpace.FromAP1[2].z), _1093, mad((WorkingColorSpace.FromAP1[2].y), _1092, ((WorkingColorSpace.FromAP1[2].x) * _1091)));
#if 1
  float _1219, _1220, _1221;
  SampleLUTUpgradeToneMap(float3(_1118, _1119, _1120), Samplers_1, Textures_1, _1219, _1220, _1221);
#else
  ...
  if (GenerateOutput(_1270, _1271, _1272, SV_Target, is_hdr)) {
