...
void main(
...
#if 1
  ApplyFilmicToneMap(lerpColor.r, lerpColor.g, lerpColor.b, _767, _768, _769);
  float _1089 = lerpColor.r, _1090 = lerpColor.g, _1091 = lerpColor.b;
#else
  ...
  // Remove max
  float _1113 = mad((WorkingColorSpace.FromAP1[0].z), _1091, mad((WorkingColorSpace.FromAP1[0].y), _1090, ((WorkingColorSpace.FromAP1[0].x) * _1089)));
  float _1114 = mad((WorkingColorSpace.FromAP1[1].z), _1091, mad((WorkingColorSpace.FromAP1[1].y), _1090, ((WorkingColorSpace.FromAP1[1].x) * _1089)));
  float _1115 = mad((WorkingColorSpace.FromAP1[2].z), _1091, mad((WorkingColorSpace.FromAP1[2].y), _1090, ((WorkingColorSpace.FromAP1[2].x) * _1089)));
  ...
  if (GenerateOutput(_1164, _1165, _1166, SV_Target, is_hdr)) {
