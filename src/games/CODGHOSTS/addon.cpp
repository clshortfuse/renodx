...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .label = "Scene Grading",
        .section = "Color Grading",
        .tooltip = "Controls the original game 3D LUT strength in HDR. 0% = no authored LUT, 100% = full authored LUT.",
        .max = 100.f,
        .is_enabled = []() { return IsCustomToneMapperEnabled(); },
        .parse = [](float value) { return value * 0.01f; },
    },
    new renodx::utils::settings::Setting{
        .key = "BlurStrength",
        .binding = &shader_injection.blur_strength,
        .default_value = 100.f,
        .label = "Blur Strength",
        .section = "Effects",
        .tooltip = "Controls the custom HDR-safe blur pass. 0% = unblurred source, 100% = original game blur.",
        .min = 0.f,
        .max = 100.f,
        .format = "%.0f%%",
        .parse = [](float value) { return value * 0.01f; },
