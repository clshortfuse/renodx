  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.z = r1.x * cb0[1].w + -cb0[2].w;
  r2.xyzw = t9.SampleLevel(s9_s, float2(0,0), 0).xyzw;
  r3.xyzw = t9.SampleLevel(s9_s, float2(0.125,0), 0).xyzw;
  r0.z = r3.x * r0.z + r2.x;
  r0.x = r0.z * 0.5 + r0.x;
