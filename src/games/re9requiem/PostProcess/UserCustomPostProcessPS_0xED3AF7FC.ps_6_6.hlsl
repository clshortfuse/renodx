...
float4 main(
  ...
  if (!(_115 && _114)) {
    float4 _125 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2((screenInverseSize.x * SV_Position.x), (screenInverseSize.y * SV_Position.y)));
    ...
    if (_109 == 0) {
      ...
      if ((uint)(uint(float((uint)(int)(aberrationEnable)))) == 0) {
        float4 _158 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(_152, _153));
        _375 = (_158.x * _108);
        _376 = (_158.y * _108);
        _377 = (_158.z * _108);
      } else {
        ...
        if (!((uint)(uint(float((uint)(int)(aberrationBlurEnable)))) == 0)) {
          ...
          float4 _197 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_192 * _148) + 0.5f), ((_192 * _150) + 0.5f)));
          float _203 = ((((_187 + 0.125f) * _188) + _145) * fDistortionCoef) + 1.0f;
          float4 _208 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_203 * _148) + 0.5f), ((_203 * _150) + 0.5f)));
          float _215 = ((((_187 + 0.25f) * _188) + _145) * fDistortionCoef) + 1.0f;
          float4 _220 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_215 * _148) + 0.5f), ((_215 * _150) + 0.5f)));
          float _229 = ((((_187 + 0.375f) * _188) + _145) * fDistortionCoef) + 1.0f;
          float4 _234 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_229 * _148) + 0.5f), ((_229 * _150) + 0.5f)));
          float _243 = ((((_187 + 0.5f) * _188) + _145) * fDistortionCoef) + 1.0f;
          float4 _248 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_243 * _148) + 0.5f), ((_243 * _150) + 0.5f)));
          float _254 = ((((_187 + 0.625f) * _188) + _145) * fDistortionCoef) + 1.0f;
          float4 _259 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_254 * _148) + 0.5f), ((_254 * _150) + 0.5f)));
          float _267 = ((((_187 + 0.75f) * _188) + _145) * fDistortionCoef) + 1.0f;
          float4 _272 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_267 * _148) + 0.5f), ((_267 * _150) + 0.5f)));
          float _287 = ((((_187 + 0.875f) * _188) + _145) * fDistortionCoef) + 1.0f;
          float4 _292 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_287 * _148) + 0.5f), ((_287 * _150) + 0.5f)));
          float _299 = ((((_187 + 1.0f) * _188) + _145) * fDistortionCoef) + 1.0f;
          float4 _304 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_299 * _148) + 0.5f), ((_299 * _150) + 0.5f)));
          ...
          float4 _327 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(_152, _153));
          float4 _330 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_315 * _148) + 0.5f), ((_315 * _150) + 0.5f)));
          float4 _333 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_322 * _148) + 0.5f), ((_322 * _150) + 0.5f)));
          _375 = (_327.x * _108);
          _376 = (_330.y * _108);
          _377 = (_333.z * _108);
        }
      ...
      if (_109 == 1) {
        ...
        float4 _367 = RE_POSTPROCESS_Color.Sample(BilinearBorder, float2(((_359 * _346) + 0.5f), (((_359 * (((SV_Position.y * 2.0f) * screenInverseSize.y) + -1.0f)) * (((_351 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)));
        _375 = (_367.x * _108);
        _376 = (_367.y * _108);
        _377 = (_367.z * _108);
      } else {
      ...
      do {
        ...
        do {
          if (_115 && (bool)(_109 == 0)) {
            ...
            float4 _605 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(((_599 * _594) + 0.5f), ((_599 * _595) + 0.5f)), 0.0f);
            ...
            float4 _619 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(((_614 * _609) + 0.5f), ((_614 * _610) + 0.5f)), 0.0f);
            ...
            float4 _636 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(((_631 * _626) + 0.5f), ((_631 * _627) + 0.5f)), 0.0f);
            ...
            float4 _653 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(((_648 * _643) + 0.5f), ((_648 * _644) + 0.5f)), 0.0f);
            ...
            float4 _670 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(((_665 * _660) + 0.5f), ((_665 * _661) + 0.5f)), 0.0f);
            ...
            float4 _687 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(((_682 * _677) + 0.5f), ((_682 * _678) + 0.5f)), 0.0f);
            ...
            float4 _704 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(((_699 * _694) + 0.5f), ((_699 * _695) + 0.5f)), 0.0f);
            ...
            float4 _721 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(((_716 * _711) + 0.5f), ((_716 * _712) + 0.5f)), 0.0f);
            ...
            float4 _738 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(((_733 * _728) + 0.5f), ((_733 * _729) + 0.5f)), 0.0f);
            ...
            if (_115 && (bool)(_109 == 1)) {
              ...
              float4 _789 = RE_POSTPROCESS_Color.SampleLevel(BilinearBorder, float2(((_782 * _769) + 0.5f), (((_782 * ((_749 * 2.0f) + -1.0f)) * (((_774 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)), 0.0f);
              ...
              float4 _813 = RE_POSTPROCESS_Color.SampleLevel(BilinearBorder, float2(((_807 * _795) + 0.5f), (((_807 * ((_751 * 2.0f) + -1.0f)) * (((_800 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)), 0.0f);
              ...
              float4 _840 = RE_POSTPROCESS_Color.SampleLevel(BilinearBorder, float2(((_834 * _822) + 0.5f), (((_834 * ((_753 * 2.0f) + -1.0f)) * (((_827 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)), 0.0f);
              ...
              float4 _867 = RE_POSTPROCESS_Color.SampleLevel(BilinearBorder, float2(((_861 * _849) + 0.5f), (((_861 * ((_755 * 2.0f) + -1.0f)) * (((_854 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)), 0.0f);
              ...
              float4 _894 = RE_POSTPROCESS_Color.SampleLevel(BilinearBorder, float2(((_888 * _876) + 0.5f), (((_888 * ((_757 * 2.0f) + -1.0f)) * (((_881 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)), 0.0f);
              ...
              float4 _921 = RE_POSTPROCESS_Color.SampleLevel(BilinearBorder, float2(((_915 * _903) + 0.5f), (((_915 * ((_759 * 2.0f) + -1.0f)) * (((_908 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)), 0.0f);
              ...
              float4 _948 = RE_POSTPROCESS_Color.SampleLevel(BilinearBorder, float2(((_942 * _930) + 0.5f), (((_942 * ((_761 * 2.0f) + -1.0f)) * (((_935 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)), 0.0f);
              ...
              float4 _975 = RE_POSTPROCESS_Color.SampleLevel(BilinearBorder, float2(((_969 * _957) + 0.5f), (((_969 * ((_763 * 2.0f) + -1.0f)) * (((_962 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)), 0.0f);
              ...
              float4 _1002 = RE_POSTPROCESS_Color.SampleLevel(BilinearBorder, float2(((_996 * _984) + 0.5f), (((_996 * ((_765 * 2.0f) + -1.0f)) * (((_989 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)), 0.0f);
              ...
              float4 _1011 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(_747, _749), 0.0f);
              float4 _1015 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(_750, _751), 0.0f);
              float4 _1022 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(_752, _753), 0.0f);
              float4 _1029 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(_754, _755), 0.0f);
              float4 _1036 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(_756, _757), 0.0f);
              float4 _1043 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(_758, _759), 0.0f);
              float4 _1050 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(_760, _761), 0.0f);
              float4 _1057 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(_762, _763), 0.0f);
              float4 _1064 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(_764, _765), 0.0f);
