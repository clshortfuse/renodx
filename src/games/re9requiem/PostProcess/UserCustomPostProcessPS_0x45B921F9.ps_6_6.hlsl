  ...
  if (!(_117 && _116)) {
    ...
    if (_111 == 0) {
      ...
      if ((uint)(uint(float((uint)(int)(aberrationEnable)))) == 0) {
        float4 _160 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(_154, _155));
        _377 = (_160.x * _110);
        _378 = (_160.y * _110);
        _379 = (_160.z * _110);
      } else {
        ...
        if (!((uint)(uint(float((uint)(int)(aberrationBlurEnable)))) == 0)) {
          ...
          float4 _199 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_194 * _150) + 0.5f), ((_194 * _152) + 0.5f)));
          float _205 = ((((_189 + 0.125f) * _190) + _147) * fDistortionCoef) + 1.0f;
          float4 _210 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_205 * _150) + 0.5f), ((_205 * _152) + 0.5f)));
          float _217 = ((((_189 + 0.25f) * _190) + _147) * fDistortionCoef) + 1.0f;
          float4 _222 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_217 * _150) + 0.5f), ((_217 * _152) + 0.5f)));
          float _231 = ((((_189 + 0.375f) * _190) + _147) * fDistortionCoef) + 1.0f;
          float4 _236 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_231 * _150) + 0.5f), ((_231 * _152) + 0.5f)));
          float _245 = ((((_189 + 0.5f) * _190) + _147) * fDistortionCoef) + 1.0f;
          float4 _250 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_245 * _150) + 0.5f), ((_245 * _152) + 0.5f)));
          float _256 = ((((_189 + 0.625f) * _190) + _147) * fDistortionCoef) + 1.0f;
          float4 _261 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_256 * _150) + 0.5f), ((_256 * _152) + 0.5f)));
          float _269 = ((((_189 + 0.75f) * _190) + _147) * fDistortionCoef) + 1.0f;
          float4 _274 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_269 * _150) + 0.5f), ((_269 * _152) + 0.5f)));
          float _289 = ((((_189 + 0.875f) * _190) + _147) * fDistortionCoef) + 1.0f;
          float4 _294 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_289 * _150) + 0.5f), ((_289 * _152) + 0.5f)));
          float _301 = ((((_189 + 1.0f) * _190) + _147) * fDistortionCoef) + 1.0f;
          float4 _306 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_301 * _150) + 0.5f), ((_301 * _152) + 0.5f)));
          ...
          float4 _329 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(_154, _155));
          float4 _332 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_317 * _150) + 0.5f), ((_317 * _152) + 0.5f)));
          float4 _335 = RE_POSTPROCESS_Color.Sample(BilinearClamp, float2(((_324 * _150) + 0.5f), ((_324 * _152) + 0.5f)));
          _377 = (_329.x * _110);
          _378 = (_332.y * _110);
          _379 = (_335.z * _110);
        }
      ...
      if (_111 == 1) {
        ...
        float4 _369 = RE_POSTPROCESS_Color.Sample(BilinearBorder, float2(((_361 * _348) + 0.5f), (((_361 * (((SV_Position.y * 2.0f) * screenInverseSize.y) + -1.0f)) * (((_353 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)));
        _377 = (_369.x * _110);
        _378 = (_369.y * _110);
        _379 = (_369.z * _110);
      } else {
      ...
      do {
        ...
        do {
          if (_117 && (bool)(_111 == 0)) {
            ...
            float4 _607 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(((_601 * _596) + 0.5f), ((_601 * _597) + 0.5f)), 0.0f);
            ...
            float4 _621 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(((_616 * _611) + 0.5f), ((_616 * _612) + 0.5f)), 0.0f);
            ...
            float4 _638 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(((_633 * _628) + 0.5f), ((_633 * _629) + 0.5f)), 0.0f);
            ...
            float4 _655 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(((_650 * _645) + 0.5f), ((_650 * _646) + 0.5f)), 0.0f);
            ...
            float4 _672 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(((_667 * _662) + 0.5f), ((_667 * _663) + 0.5f)), 0.0f);
            ...
            float4 _689 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(((_684 * _679) + 0.5f), ((_684 * _680) + 0.5f)), 0.0f);
            ...
            float4 _706 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(((_701 * _696) + 0.5f), ((_701 * _697) + 0.5f)), 0.0f);
            ...
            float4 _723 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(((_718 * _713) + 0.5f), ((_718 * _714) + 0.5f)), 0.0f);
            ...
            float4 _740 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(((_735 * _730) + 0.5f), ((_735 * _731) + 0.5f)), 0.0f);
            ...
            if (_117 && (bool)(_111 == 1)) {
              ...
              float4 _791 = RE_POSTPROCESS_Color.SampleLevel(BilinearBorder, float2(((_784 * _771) + 0.5f), (((_784 * ((_751 * 2.0f) + -1.0f)) * (((_776 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)), 0.0f);
              ...
              float4 _815 = RE_POSTPROCESS_Color.SampleLevel(BilinearBorder, float2(((_809 * _797) + 0.5f), (((_809 * ((_753 * 2.0f) + -1.0f)) * (((_802 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)), 0.0f);
              ...
              float4 _842 = RE_POSTPROCESS_Color.SampleLevel(BilinearBorder, float2(((_836 * _824) + 0.5f), (((_836 * ((_755 * 2.0f) + -1.0f)) * (((_829 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)), 0.0f);
              ...
              float4 _869 = RE_POSTPROCESS_Color.SampleLevel(BilinearBorder, float2(((_863 * _851) + 0.5f), (((_863 * ((_757 * 2.0f) + -1.0f)) * (((_856 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)), 0.0f);
              ...
              float4 _896 = RE_POSTPROCESS_Color.SampleLevel(BilinearBorder, float2(((_890 * _878) + 0.5f), (((_890 * ((_759 * 2.0f) + -1.0f)) * (((_883 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)), 0.0f);
              ...
              float4 _923 = RE_POSTPROCESS_Color.SampleLevel(BilinearBorder, float2(((_917 * _905) + 0.5f), (((_917 * ((_761 * 2.0f) + -1.0f)) * (((_910 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)), 0.0f);
              ...
              float4 _950 = RE_POSTPROCESS_Color.SampleLevel(BilinearBorder, float2(((_944 * _932) + 0.5f), (((_944 * ((_763 * 2.0f) + -1.0f)) * (((_937 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)), 0.0f);
              ...
              float4 _977 = RE_POSTPROCESS_Color.SampleLevel(BilinearBorder, float2(((_971 * _959) + 0.5f), (((_971 * ((_765 * 2.0f) + -1.0f)) * (((_964 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)), 0.0f);
              ...
              float4 _1004 = RE_POSTPROCESS_Color.SampleLevel(BilinearBorder, float2(((_998 * _986) + 0.5f), (((_998 * ((_767 * 2.0f) + -1.0f)) * (((_991 + -1.0f) * fOptimizedParam.y) + 1.0f)) + 0.5f)), 0.0f);
              ...
              float4 _1013 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(_749, _751), 0.0f);
              float4 _1017 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(_752, _753), 0.0f);
              float4 _1024 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(_754, _755), 0.0f);
              float4 _1031 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(_756, _757), 0.0f);
              float4 _1038 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(_758, _759), 0.0f);
              float4 _1045 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(_760, _761), 0.0f);
              float4 _1052 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(_762, _763), 0.0f);
              float4 _1059 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(_764, _765), 0.0f);
              float4 _1066 = RE_POSTPROCESS_Color.SampleLevel(BilinearClamp, float2(_766, _767), 0.0f);
