...
bool is_grain_used = false;
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntry(0x041FA975),  // videos
    CustomShaderEntry(0xBADD2507),  // videos 3
    CustomShaderEntryCallback(0xD11C7B85, [](reshade::api::command_list* cmd_list) {  // tonemapper
    is_grain_used = true;
    return true;
    }),
    CustomShaderEntryCallback(0x54D9B89F, [](reshade::api::command_list* cmd_list) {  // tonemapper 2
    is_grain_used = true;
    return true;
    }),
    CustomShaderEntryCallback(0x9FEAFC96, [](reshade::api::command_list* cmd_list) {  // tonemapper 3 (photomode no grain)
    is_grain_used = false;
    return true;
    }),
    CustomShaderEntryCallback(0x31A59248, [](reshade::api::command_list* cmd_list) {  // tonemapper 4 (prerendered + hejldawson)
    is_grain_used = false;
    return true;
    }),
    CustomShaderEntryCallback(0x54B0FAE2, [](reshade::api::command_list* cmd_list) {  // tonemapper 5 (transition no grain no distortion)
    is_grain_used = false;
    return true;
    }),
    CustomShaderEntryCallback(0x314165B5, &video),  // UI
};
...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .on_change = []() {
          ...
          renodx::utils::settings::UpdateSetting("toneMapShoulderStart", 0.11f);
    ...
    new renodx::utils::settings::Setting{
        ...
        .on_change = []() {
          ...
          renodx::utils::settings::UpdateSetting("colorGradeSaturation", 50.f);
          renodx::utils::settings::UpdateSetting("colorGradeBlowout", 100.f);
          renodx::utils::settings::UpdateSetting("colorGradeDechroma", 0.f);
