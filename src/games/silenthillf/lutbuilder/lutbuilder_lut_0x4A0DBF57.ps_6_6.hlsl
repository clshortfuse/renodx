#define LUTBUILDER_HASH 0x4A0DBF57
...
float4 main(
  ...
  ApplyFilmicToneMap(_756, _757, _758,
                     _576, _577, _578,
                     _898, _899, _900);
#else
...
#if 1
  float _1016, _1017, _1018;
  SampleLUTUpgradeToneMap(float3(_913, _914, _915), Samplers_1, Textures_1, _1016, _1017, _1018);
#else
...
#if 1
  if (GenerateOutput(_1053, _1054, _1055, SV_Target, OutputDevice)) {
    return SV_Target;
  }
#endif
