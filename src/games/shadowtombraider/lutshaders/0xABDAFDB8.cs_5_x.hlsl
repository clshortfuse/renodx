...
// ---- Created with 3Dmigoto v1.4.1 on Tue Feb  4 18:09:55 2025
...
void main(uint2 vThreadID: SV_DispatchThreadID) {
  ...
  r0.x = r0.y ? r0.x : 0;
  if (r0.x != 0) {
    r0.xyzw = (uint4)vThreadID.xyxy;
    r0.xyzw = float4(0.5, 0.5, 0.5, 0.5) + r0.xyzw;
    r0.xyzw = r0.xyzw / ScreenResolution.xyxy;
    // r0.xyzw = r0.xyzw * g_dvScale1 + g_dvOffset1.xyzw;
    r0.xyzw = r0.xyzw * g_dvScale1 + g_dvOffset1.xyxy;
    r1.xyz = colorBuffer_in.SampleLevel(SamplerGenericBilinearClamp_s, r0.xy, 0).xyz;
    r0.xyz = colorBuffer_in.SampleLevel(SamplerGenericBilinearClamp_s, r0.zw, 0).xyz;
    r0.xyz = r0.xyz + -r1.xyz;
    r0.xyz = g_dvBlend * r0.xyz + r1.xyz;
