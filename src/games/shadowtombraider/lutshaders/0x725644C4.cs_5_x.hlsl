...
void main(uint2 vThreadID: SV_DispatchThreadID) {
  ...
  if (r0.x != 0) {
    ...
    r0.xy = r0.xy / ScreenResolution.xy;
    // r1.xyzw = r0.xyxy * g_dvScale1 + g_dvOffset1.xyzw;
    r1.xyzw = r0.xyxy * g_dvScale1 + g_dvOffset1.xyxy;
    r2.xyz = colorBuffer_in.SampleLevel(SamplerGenericBilinearClamp_s, r1.xy, 0).xyz;
    r1.xyz = colorBuffer_in.SampleLevel(SamplerGenericBilinearClamp_s, r1.zw, 0).xyz;
    r1.xyz = r1.xyz + -r2.xyz;
    r1.xyz = g_dvBlend * r1.xyz + r2.xyz;

    float3 input_color = r1.xyz;

    r2.x = dot(float3(0.412390888, 0.357584298, 0.180480838), r1.xyz);
    r2.y = dot(float3(0.212639064, 0.715168595, 0.0721923336), r1.xyz);
    r2.z = dot(float3(0.0193308201, 0.119194724, 0.950532317), r1.xyz);
    r1.x = dot(float3(1.01303494, 0.00610530004, -0.0149709601), r2.xyz);
    r1.y = dot(float3(0.00769822998, 0.998164833, -0.0050321999), r2.xyz);
    r1.z = dot(float3(-0.00284131011, 0.00468514999, 0.924506664), r2.xyz);
    r2.x = dot(float3(1.6410234, -0.324803293, -0.236424699), r1.xyz);
    r2.y = dot(float3(-0.663662851, 1.61533165, 0.0167563483), r1.xyz);
    r2.z = dot(float3(0.0117218941, -0.00828444213, 0.988394856), r1.xyz);
    r1.xyz = cmp(r2.xyz < float3(1.52587891e-05, 1.52587891e-05, 1.52587891e-05));
    r3.xyz = r2.xyz * float3(0.5, 0.5, 0.5) + float3(1.52587891e-05, 1.52587891e-05, 1.52587891e-05);
    ...
    r0.z = r0.z / g_lutSize;
    r0.w = 0.5 / g_lutSize;
    r1.xyz = r1.xyz * r0.zzz + r0.www;
    r1.xyz = lut.SampleLevel(SamplerGenericBilinearClamp_s, r1.xyz, 0).xyz;
    r1.xyz = max(float3(-0.301369876, -0.301369876, -0.301369876), r1.xyz);
    r1.xyz = r1.xyz * float3(17.5200005, 17.5200005, 17.5200005) + float3(-9.72000027, -9.72000027, -9.72000027);
    r1.xyz = exp2(r1.xyz);
    ...
    r2.x = dot(float3(3.2409699, -1.5373832, -0.498610765), r1.xyz);
    r2.y = dot(float3(-0.969243646, 1.8759675, 0.0415550582), r1.xyz);
    r2.z = dot(float3(0.0556300804, -0.203976959, 1.05697155), r1.xyz);

    r2.xyz = lerp(input_color, r2.xyz, CUSTOM_LUT_STRENGTH);

    r0.z = dot(r2.xyz, float3(0.212599993, 0.715300024, 0.0722000003));
    r1.xyzw = r2.xyzx + -r0.zzzz;
    r1.xyzw = g_saturation * r1.xyzw + r0.zzzz;
    r2.xyzw = g_pmBrightness * r1.xyzw;
    r0.xy = -g_vigCenterPoint.xy + r0.xy;
    r0.x = dot(r0.xy, r0.xy);
    r0.x = sqrt(r0.x);
    r0.x = -g_vigParams.x + r0.x;
    r0.x = saturate(g_vigParams.y * r0.x);
    r3.xyzw = g_vigColOuter.xyzw + -g_vigColInner.xyzw;
    r0.xyzw = r0.xxxx * r3.xyzw + g_vigColInner.xyzw;
    r1.xyzw = -r1.wyzw * g_pmBrightness + r0.xyzx;
