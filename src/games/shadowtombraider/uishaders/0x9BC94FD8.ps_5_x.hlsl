...
// ---- Created with 3Dmigoto v1.4.1 on Tue Feb  4 18:09:52 2025
...
// unknown dcl_: dcl_uav_typed_texture2d (uint,uint,uint,uint) u1
  ...
  r0.xyz = mad((int3)v3.xxx, int3(9,9,9), int3(2,3,4));
  r1.xyzw = p_default_Material_00DD4274319654666_Param_texture.Sample(SamplerGenericAutoWrap_s, v2.xy).xyzw;
  r2.xyzw = InstanceParametersBuffer[r0.x].xyzw * r1.xyzw;
  r0.xyzw = r2.xyzw * InstanceParametersBuffer[r0.y].xyzw + InstanceParametersBuffer[r0.z].xyzw;
  r0.xyz = r0.xyz * r0.www;
  r0.xyz = UiAlphaMultiplier * r0.xyz * RENODX_GRAPHICS_WHITE_NITS / RENODX_DIFFUSE_WHITE_NITS;
  r0.w = FrameExposureBuffer[0].cameraExposure;
  o0.xyz = r0.xyz * r0.www;
  r0.x = GlobalRenderFlags & 2048;
  r0.x = cmp((int)r0.x == 0);
  r0.y = cmp(TranslucentVelocityAlphaThreshold < 0);
  r0.x = r0.y ? r0.x : 0;
  if (r0.x != 0) {
    ...
    r0.xy = float2(0.5,-0.5) * r0.xy;
    r0.z = -v1.w + v0.w;
    r1.xy = DrawableFlags & int2(1,2);
    r0.w = GlobalRenderFlags & 4096;
    r1.xy = r1.xy ? float2(1,1) : float2(0,0);
    r1.x = mad((int)r1.y, 2, (int)r1.x);
    r0.w = r0.w ? 1 : 0;
    r1.w = mad((int)r0.w, 4, (int)r1.x);
