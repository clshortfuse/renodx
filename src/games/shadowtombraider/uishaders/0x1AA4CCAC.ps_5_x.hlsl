...
// ---- Created with 3Dmigoto v1.4.1 on Tue Feb  4 18:09:36 2025
...
void main(
  ...
  r0.xyzw = mad((int4)v3.xxxx, int4(9, 9, 9, 9), int4(2, 4, 3, 5));
  r1.xyzw = InstanceParametersBuffer[r0.x].xyzw * v2.xyzw;
  r1.xyzw = InstanceParametersBuffer[r0.z].xyzw * r1.xyzw + InstanceParametersBuffer[r0.y].xyzw;
  ...
  if (r0.x != 0) {
    ...
    VelocityBuffer_uav[r0.xy] = r2.xyzw;
  }
  o0.w = r1.x;
  return;
}
