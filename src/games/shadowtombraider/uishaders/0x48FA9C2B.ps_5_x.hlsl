...
// ---- Created with 3Dmigoto v1.4.1 on Tue Feb  4 18:09:42 2025
...
// unknown dcl_: dcl_uav_typed_texture2d (uint,uint,uint,uint) u1
  ...
  r0.xyzw = mad((int4)v3.xxxx, int4(9,9,9,9), int4(2,3,4,5));
  ...
  r1.xyzw = r2.xyzw * InstanceParametersBuffer[r0.y].xyzw + InstanceParametersBuffer[r0.z].xyzw;
  r0.xyz = r1.xyz * r1.www;
  r0.xyz = UiAlphaMultiplier * r0.xyz * RENODX_GRAPHICS_WHITE_NITS / RENODX_DIFFUSE_WHITE_NITS;
  r0.w = cmp(0.000000 == InstanceParametersBuffer[r0.w].x);
  r1.x = v3.x;
