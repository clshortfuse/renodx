...
// ---- Created with 3Dmigoto v1.4.1 on Tue Feb  4 18:09:53 2025
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = mad((int2)v2.xx, int2(9,9), int2(3,4));
  r0.zw = p_default_Material_00DD4274319654666_Param_texture.Sample(SamplerGenericAutoWrap_s, v1.xy).xw;
  r0.xy = InstanceParametersBuffer[r0.x].xw * r0.zw + InstanceParametersBuffer[r0.y].xw;
  r0.x = -1 + r0.x;
  r0.x = r0.y * r0.x + 1;
  r0.x = 1 + -r0.x;
