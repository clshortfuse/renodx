...
renodx::mods::shader::CustomShaders custom_shaders = {
    ...
    CustomDirectXShaders(0x2F759B36),  // Build ACES LUT - generated on changing HDR settings
    CustomDirectXShaders(0x0FBDBDA4),  // Tonemap With LUT
    CustomDirectXShaders(0xDB8538C1),  // Tonemap Per-Pixel
    CustomDirectXShaders(0x5D10D1A2),  // HDR Gamma
    CustomDirectXShaders(0x02F23B46),  // Bloom

    // Lens Flare
    CustomDirectXShaders(0x8697E4DE),
    CustomDirectXShaders(0x828F116D),

    // lut shaders
    CustomDirectXShaders(0x36A04CB8),
    CustomDirectXShaders(0x725644C4),
    CustomDirectXShaders(0x72D58C75),
    CustomDirectXShaders(0x90C37605),
    CustomDirectXShaders(0xABDAFDB8),
    CustomDirectXShaders(0xFF27B467),

    // UIShaders
    CustomDirectXShaders(0x1AA4CCAC),
    CustomDirectXShaders(0x332A318B),
    CustomDirectXShaders(0x3AA14258),
    CustomDirectXShaders(0x48FA9C2B),
    CustomDirectXShaders(0x6F8605E5),
    CustomDirectXShaders(0x81B46BE8),
    CustomDirectXShaders(0x9BC94FD8),
    CustomDirectXShaders(0xA302A797),
    CustomDirectXShaders(0xA5AAFE7A),
    CustomDirectXShaders(0xD7AEE3C3),
    CustomDirectXShaders(0xD7BE7204),
    CustomDirectXShaders(0xF374711E),
...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        .key = "ColorGradeACESLookStrength",
        .binding = &CUSTOM_ACES_LOOK_STRENGTH,
        .default_value = 100.f,
        .label = "ACES Look Strength",
        .section = "Color Grading",
        .max = 100.f,
        .parse = [](float value) { return value * 0.01f; },
    },
...
void OnPresetOff() {
  ...
  renodx::utils::settings::UpdateSetting("ToneMapPeakNits", 1500.f);
  ...
  renodx::utils::settings::UpdateSetting("ColorGradeClip", 1500.f);
  renodx::utils::settings::UpdateSetting("ColorGradeLUTStrength", 100.f);
  renodx::utils::settings::UpdateSetting("ColorGradeACESLookStrength", 100.f);
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Shadow of the Tomb Raider";
