// ---- Created with 3Dmigoto v1.4.1 on Mon Dec  1 14:39:30 2025
...
cbuffer _Globals : register(b0)
{
  ...
  float4 g_ZConstantsSprites : packoffset(c128);
  float4 g_ZParams : packoffset(c129);
  float4 g_LerpStart : packoffset(c130);
  float4 g_LerpMask : packoffset(c131);
  float g_FadeFactor : packoffset(c132);
}
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = DiffuseMapTextureObject_0.Sample(DiffuseMapTextureObject_0_s, v1.xy).xyzw;
  r0.z = -v1.z + r0.y;
  r1.xyzw = r0.xxxy * v2.xyzw + -g_LerpStart.xyzw;
  r0.x = cmp(r0.z < 0);
  if (r0.x != 0) discard;
  r0.xy = v0.xy * g_VPosToUV.xy + g_VPosToUV.zw;
  r0.xyzw = DepthSurface.SampleLevel(DepthSurface_s, r0.xy, 0).xyzw;
  r0.x = g_ReverseProjectionParams.z + r0.x;
  r0.x = g_ReverseProjectionParams.w / r0.x;
  r0.x = -v1.w + -r0.x;
  r0.x = saturate(g_ZParams.z * r0.x);
  r0.xyzw = saturate(r0.xxxx * g_FadeFactor + g_LerpMask.xyzw);
  o0.xyzw = r0.xyzw * r1.xyzw + g_LerpStart.xyzw;
