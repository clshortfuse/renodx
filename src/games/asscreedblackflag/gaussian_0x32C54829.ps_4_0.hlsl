// ---- Created with 3Dmigoto v1.4.1 on Thu Nov 20 00:06:56 2025
...
cbuffer _Globals : register(b0)
{
  ...
  float4 g_GaussianBloom7SampleOffsets[7] : packoffset(c128);
  float4 g_GaussianBloom7SampleWeights[7] : packoffset(c135);
}
  ...
  out float4 o0 : SV_Target0)
{
  ...
  while (true) {
    r1.y = cmp((int)r1.x >= 7);
    if (r1.y != 0) break;
    r1.yz = g_GaussianBloom7SampleOffsets[r1.x].xy + v1.xy;
    r2.xyzw = s0.Sample(s0_s, r1.yz).xyzw;
    r0.xyzw = g_GaussianBloom7SampleWeights[r1.x].xyzw * r2.xyzw + r0.xyzw;
    r1.x = (int)r1.x + 1;
  }
  o0.xyzw = r0.xyzw;
