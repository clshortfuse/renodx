...
cbuffer _Globals : register(b0)
{
  ...
  float4 g_MergeTextureSampleWeights[8] : packoffset(c128);
}
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = s1.Sample(s1_s, v1.xy).xyzw;
  r0.xyzw = g_MergeTextureSampleWeights[1].xyzw * r0.xyzw;
  r1.xyzw = s0.Sample(s0_s, v1.xy).xyzw;
  r0.xyzw = g_MergeTextureSampleWeights[0].xyzw * r1.xyzw + r0.xyzw;
  r1.xyzw = s2.Sample(s2_s, v1.xy).xyzw;
  o0.xyzw = g_MergeTextureSampleWeights[2].xyzw * r1.xyzw + r0.xyzw;
