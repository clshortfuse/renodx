...
// ---- Created with 3Dmigoto v1.4.1 on Thu Nov 20 00:11:47 2025
...
cbuffer _Globals : register(b0)
{
  ...
  float4 g_BloomParams : packoffset(c128);
  float4 g_BloomTint : packoffset(c129);
}
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = Source.Sample(Source_s, v1.xy).xyzw;
  r0.x = dot(float3(0.298999995,0.587000012,0.114), r0.xyz);
  r0.x = -g_BloomParams.y + r0.x;
  r0.y = -g_BloomParams.y + 1;
  r0.y = 1 / r0.y;
  r0.x = saturate(r0.x * r0.y);
  r0.y = r0.x * -2 + 3;
  r0.x = r0.x * r0.x;
  r0.x = r0.y * r0.x;
  r0.x = g_BloomParams.x * r0.x;

  r0.x *= CUSTOM_BLOOM;

  o0.xyzw = g_BloomTint.xyzw * r0.xxxx;
