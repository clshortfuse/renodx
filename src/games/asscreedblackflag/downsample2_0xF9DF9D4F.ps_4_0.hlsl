// ---- Created with 3Dmigoto v1.4.1 on Thu Nov 20 00:07:49 2025
...
cbuffer _Globals : register(b0)
{
  ...
  float4 g_Downscale2x2SampleOffsets[4] : packoffset(c128);
}
  ...
  out float4 o0 : SV_Target0)
{
  ...
  while (true) {
    r1.y = cmp((int)r1.x >= 4);
    if (r1.y != 0) break;
    r1.yz = g_Downscale2x2SampleOffsets[r1.x].xy + v1.xy;
