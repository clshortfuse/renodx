// ---- Created with 3Dmigoto v1.4.1 on Mon Dec  1 16:13:27 2025
...
cbuffer _Globals : register(b0)
{
  ...
  float4 g_NVGodRaysBlendParams : packoffset(c128);
}
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.x = 4.0999999 * r0.x;
  r0.x = min(1, r0.x);
  r0.x = -0.209999993 + r0.x;
  r0.yz = float2(1.26582277,-4.76190472) * r0.xx;
  r0.x = cmp(0 < r0.x);
  r0.yz = max(float2(0,0), r0.yz);
  r0.yz = -r0.yz * float2(0.129999995,0.129999995) + float2(0.129999995,0.129999995);
  r0.x = r0.x ? r0.y : r0.z;
  r0.y = -g_NVGodRaysBlendParams.w * 0.0078125 + 1;
  r0.yzw = saturate(g_NVGodRaysBlendParams.xyz * r0.yyy);
