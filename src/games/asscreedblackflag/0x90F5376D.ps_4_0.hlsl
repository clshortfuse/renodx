// ---- Created with 3Dmigoto v1.4.1 on Thu Nov 27 02:42:00 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = 1;
  r1.xy = v0.xy * g_VPosToUV.xy + g_VPosToUV.zw;
  r1.zw = r1.xy * g_VPOSReverseParams.xy + g_VPOSReverseParams.zw;
  r2.xyzw = DepthSampler.SampleLevel(DepthSampler_s, r1.xy, 0).xyzw;
  r1.x = g_ReverseProjectionParams.z + r2.x;
  r0.z = g_ReverseProjectionParams.w / r1.x;
  r0.xy = r1.zw * r0.zz;
  r0.w = dot(r0.xyzw, g_ViewToWorld._m02_m12_m22_m32);
  r0.x = dot(r0.xyz, r0.xyz);
  r0.x = sqrt(r0.x);
  r1.y = saturate(-r0.w / FogMaxDepth);
  r1.x = r1.y * r1.y;
  r1.z = 1;
  r0.y = saturate(dot(FogDepthGradient.xyz, r1.xyz));
  r1.xyzw = FogRampSampler.SampleLevel(FogRampSampler_s, r0.yy, 0).xyzw;
  r1.y = 1 + -r0.y;
  r0.y = FogMaxDistance * r1.w;
  r0.y = max(1, r0.y);
  r0.x = r0.x / r0.y;
  r0.y = min(1, r0.x);
  r0.x = r0.y * r0.y;
  r0.z = 1;
  r1.x = saturate(dot(FogDistanceGradient.xyz, r0.xyz));
  r0.xyzw = FogExtinctionRampSampler.SampleLevel(FogExtinctionRampSampler_s, r1.xy, 0).xyzw;
  o0.xyz = r0.xyz;
  o0.w = 1;
