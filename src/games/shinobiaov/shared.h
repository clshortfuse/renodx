#ifndef SRC_SHINOBIAOV_SHARED_H_
#define SRC_SHINOBIAOV_SHARED_H_
...
#define RENODX_TONE_MAP_BLOWOUT              max(0.000001f, shader_injection.tone_map_blowout)
...
struct ShaderInjectData {
  ...
  float custom_sprite_itm;
  float custom_sprite_itm_method;
};
...
#endif  // SRC_SHINOBIAOV_SHARED_H_