...
#define FILMTONECURVE_GENERATOR(T)                                                                                                                                        \
  T ApplyToneCurve(T untonemapped, const Config p) {                                                                                                                      \
    ...
    T toe_curve =                                                                                                                                                         \
        (untonemapped_log < p.log_toe_threshold)                                                                                                                          \
    ...
    T shoulder_curve =                                                                                                                                                    \
        (untonemapped_log > p.log_shoulder_threshold)                                                                                                                     \
    ...
    T t_blend = (p.log_shoulder_threshold < p.log_toe_threshold) ? (1.f - t_linear) : t_linear;                                                                           \
...
#define FILMTONECURVE_EXTENDED_GENERATOR(T)                                  \
  T ApplyToneCurveExtended(T untonemapped, T vanilla, const Config p) {      \
    ...
    return untonemapped < (T)pivot_input ? vanilla : extended_tail;          \
  }
