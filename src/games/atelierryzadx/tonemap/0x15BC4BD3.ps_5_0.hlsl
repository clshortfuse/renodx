...
// ---- Created with 3Dmigoto v1.3.16 on Thu Nov 13 18:40:10 2025
...
cbuffer _Globals : register(b0)
{
  ...
  float fStarWeight : packoffset(c2.z) = {0.800000012};
  float fLensFlareWeight : packoffset(c2.w) = {0.300000012};
