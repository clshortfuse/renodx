...
// ---- Created with 3Dmigoto v1.3.16 on Thu Nov 27 12:47:36 2025
...
cbuffer _Globals : register(b0)
{
  ...
  float fBloomWeight : packoffset(c3.y) = {0.5};
  float fStarWeight : packoffset(c3.z) = {0.800000012};
  float fLensFlareWeight : packoffset(c3.w) = {0.300000012};
  float2 SimulateHDRParams : packoffset(c4);
  float fSaturationScaleEx : packoffset(c4.z) = {1};
...
SamplerState smplLightShaftLinWork2_s : register(s6);
...
Texture2D<float4> smplLightShaftLinWork2_Tex : register(t6);
