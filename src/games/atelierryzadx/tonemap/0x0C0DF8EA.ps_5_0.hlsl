...
// ---- Created with 3Dmigoto v1.3.16 on Thu Nov 27 11:58:18 2025
...
cbuffer _Globals : register(b0)
{
  ...
  float fSaturationScaleEx : packoffset(c3) = {1};
  float3 vColorScale : packoffset(c3.y) = {1,1,1};
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.yzw = smplStar_Tex.Sample(smplStar_s, v1.xy).xyz;
  r1.yzw = fStarWeight * r1.yzw;
