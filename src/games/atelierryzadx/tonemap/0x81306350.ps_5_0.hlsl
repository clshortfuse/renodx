...
// ---- Created with 3Dmigoto v1.3.16 on Thu Nov 27 12:47:44 2025
...
cbuffer _Globals : register(b0)
{
  ...
  float fLensFlareWeight : packoffset(c4) = {0.300000012};
  float2 SimulateHDRParams : packoffset(c4.y);
  float fSaturationScaleEx : packoffset(c4.w) = {1};
  float4 vLightShaftPower : packoffset(c5);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyz = r0.xyz * fLensFlareWeight + r2.yzw;
