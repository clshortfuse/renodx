...
cbuffer _Globals : register(b0)
{
  ...
  float fStarWeight : packoffset(c6.y) = {0.800000012};
  float fLensFlareWeight : packoffset(c6.z) = {0.300000012};
  float2 SimulateHDRParams : packoffset(c7);
  float fSaturationScaleEx : packoffset(c7.z) = {1};
