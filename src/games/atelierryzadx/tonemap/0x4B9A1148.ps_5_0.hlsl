...
// ---- Created with 3Dmigoto v1.3.16 on Thu Nov 27 12:47:40 2025
...
cbuffer _Globals : register(b0)
{
  ...
  float2 SimulateHDRParams : packoffset(c3.z);
  float fSaturationScaleEx : packoffset(c4) = {1};
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.yzw = smplFlare_Tex.Sample(smplFlare_s, v1.xy).xyz;
  r0.yzw = fLensFlareWeight * r0.yzw;
