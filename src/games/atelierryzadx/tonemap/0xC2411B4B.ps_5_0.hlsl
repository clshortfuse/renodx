...
// ---- Created with 3Dmigoto v1.3.16 on Thu Nov 27 12:47:49 2025
...
cbuffer _Globals : register(b0)
{
  ...
  float fStarWeight : packoffset(c3.y) = {0.800000012};
  float fLensFlareWeight : packoffset(c3.z) = {0.300000012};
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.yzw = smplStar_Tex.Sample(smplStar_s, v1.xy).xyz;
  r0.yzw = fStarWeight * r0.yzw;
