...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    // Decode it back to scene-linear RGB before RenoDRT or PsychoV24.
    linearOutput =
        GammaDecode2(
            gradedOutput
        );
    ...
    // ========================================================================
    // RenoDX or PsychoV24 tonemapping
    // ========================================================================
    ...
    // applies the configured encoding for later passes and swapchain decoding.
    //
