...
void main(float4 v0 : SV_POSITION0, float4 v1 : TEXCOORD0, float4 v2 : TEXCOORD4, float4 v3 : TEXCOORD7, float4 v4 : TEXCOORD8, float3 v5 : TEXCOORD9, float4 v6 : COLOR1, out float4 o0 : SV_Target0) {
  float4 r0, r1, r2;
