...
void main(float4 v0 : SV_POSITION0, float4 v1 : TEXCOORD0, float4 v2 : TEXCOORD4, float4 v3 : COLOR0, float4 v4 : COLOR1, float3 v5 : TEXCOORD1, out float4 o0 : SV_Target0) {
  float4 r0, r1, r2, r3;
