// Mechanically reconstructed from 0x53BC8110.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = (r7.w) * (r11.w) + (r12.w);
    r0.z = (r0.z) * (r10.w) + (c3.x);
    r0.y = 1.0f / (r0.z);
    r0.z = (r8.w) * (r9.w);
    r0.y = (r7.w) * (r0.y);
    r1.z = (r0.z) * (r0.y);
    r0.xyz = (r12.xyz) * (r6.www) + (r13.xyz);
