// Mechanically reconstructed from 0x9C81464B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = r4.y;
    r3.x = dot(r5.xy, r0.xy) + (c13.w);
    r1 = tex2D(s1, v1.xy);
    r0.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r1 = tex2D(s2, v6.xy);
    r9.w = (r1.w) * (v0.y);
    r3.y = dot(r5.xy, r0.zw) + (c13.w);
    r6.xy = (r9.ww) * (-(r0.xy)) + (r0.xy);
    r0 = tex2D(s3, v6.zw);
    r8.w = (r0.w) * (v0.z);
    r7.xy = (r2.yw) * (c12.xx) + (c12.yy);
    r5.xy = lerp(r6.xy, r3.xy, r8.ww);
    r1.w = dot(r7.xy, r7.xy) + (c13.w);
