// Mechanically reconstructed from 0xE6CE142A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.x = dot(r2.xy, r0.xy) + (c11.z);
    r4.y = dot(r2.xy, r0.zw) + (c11.z);
    r0 = tex2D(s2, v6.xy);
    r6.w = (r0.w) * (v0.y);
    r2.xy = (r1.yw) * (c4.xx) + (c4.yy);
    r5.xy = lerp(r6.xy, r4.xy, r6.ww);
    r1.w = dot(r2.xy, r2.xy) + (c11.z);
    r0.w = dot(r5.xy, r5.xy) + (c11.z);
    r1.w = exp2(-(r1.w));
    r0.w = exp2(-(r0.w));
    r1.w = (r1.w) * (c3.x) + (c3.y);
    r0.w = (r0.w) * (c3.x) + (c3.y);
    r1.y = (r1.w) * (r0.w);
    r1.w = dot(r2.xy, r5.xy) + (c11.z);
    r2 = tex2D(s14, v1.zw);
    r6.xy = (r2.xy) * (c3.ww);
    ...
    r1.w = (r1.w) * (r3.w);
    r3 = tex2D(s3, v6.zw);
    r3.xyz = (r3.xyz) + (c11.yyy);
    r2.w = (r2.w) * (c2.x) + (c2.y);
    r4.xyz = (v0.zzz) * (r3.xyz) + (-(c11.yyy));
    r3 = tex2D(s4, v7.xy);
    r7.xyz = (r3.xyz) + (c11.yyy);
    r3.xyz = (r2.xyz) * (r4.xyz);
    r2.xyz = (v0.www) * (r7.xyz) + (-(c11.yyy));
    r2.w = 1.0f / (r2.w);
