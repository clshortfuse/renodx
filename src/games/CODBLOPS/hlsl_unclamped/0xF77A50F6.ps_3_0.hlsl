// Mechanically reconstructed from 0xF77A50F6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r0.w) * (c3.x) + (c3.y);
    r10.xyz = lerp(r0.yyy, c[36].xyw, r9.www);
    r1.xy = (v0.zw) * (c4.xy);
    r5 = tex2D(s13, r1.xy);
    ...
    r3.xyz = lerp(r2.xyz, c1.zzz, r0.xxx);
    r0 = tex2D(s8, v7.zw);
    r2 = lerp(r3, r0, r9.wwww);
    r0 = v1;
