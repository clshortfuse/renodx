// Mechanically reconstructed from 0x497F31BC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c9 = float4(1.0f, 0.5f, 0.0f, 4.0f);
    ...
    r3.y = dot(r6.xy, r1.zw) + (c4.x);
    r12.xyz = (v0.yyy) * (r0.xyz) + (c3.zzz);
    r0 = tex2D(s0, v1.xy);
    r2 = tex2D(s4, v7.zw);
    r12.w = (r2.w) * (v0.z);
    r2.xyz = (r0.xyz) * (-(r12.xyz)) + (r2.xyz);
    r3.x = dot(r6.xy, r1.xy) + (c4.x);
    r1.xyz = (r12.www) * (r2.xyz);
    r1.xyz = (r0.xyz) * (r12.xyz) + (r1.xyz);
    r6.xy = lerp(r4.xy, r3.xy, r12.ww);
    r2 = tex2D(s6, v1.xy);
    r0 = tex2D(s7, v7.zw);
    r7.w = lerp(r2.y, r0.y, r12.w);
    r0.z = dot(r6.xy, r6.xy) + (c4.x);
    r8.xyz = (r1.xyz) * (r1.xyz);
    r0.z = exp2(-(r0.z));
    r2.z = (r0.z) * (c10.x) + (c10.y);
    r0.xy = (v1.zw) * (c9.xy) + (c9.zy);
    r1 = tex2D(s13, r0.xy);
    r0.xy = (v1.zw) * (c9.xy);
    r4 = tex2D(s13, r0.xy);
    r3 = tex2D(s14, v1.zw);
    ...
    r1.w = (r3.x) * (c10.w) + (-(r2.x));
    r0.z = dot(r4.xy, r6.xy) + (c4.x);
    r3.w = (r4.z) * (-(r0.x)) + (r1.w);
    r1.xy = (r1.xz) * (r0.yy);
    r0.x = dot(r4.xy, r4.xy) + (c4.x);
    r1.w = (r3.y) * (c10.w) + (-(r1.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r1.z) * (-(r0.y)) + (r1.w);
    r0.x = (r0.x) * (c10.x) + (c10.y);
    r0.y = (r0.y) + (r0.y);
    r0.x = (r2.z) * (r0.x);
