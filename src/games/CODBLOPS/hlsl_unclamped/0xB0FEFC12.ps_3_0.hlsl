// Mechanically reconstructed from 0xB0FEFC12.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s6, v0.xy);
    r0 = tex2D(s7, v7.zw);
    r3.xyz = float3(((r4.w) >= 0.0f ? (r2.x) : (r3.x)), ((r4.w) >= 0.0f ? (r2.y) : (r3.y)), ((r4.w) >= 0.0f ? (r2.z) : (r3.z)));
    ...
    r0 = tex2D(s13, r0.xy);
    r3.w = r0.y;
    r4.xy = float2(((r4.w) >= 0.0f ? (r1.x) : (c1.y)), ((r4.w) >= 0.0f ? (r1.y) : (c1.y)));
    ...
    r0.w = rsqrt(r0.w);
    r15.xyz = (r10.www) * (v6.xyz);
    r0.xyz = (r0.xyz) * (r3.www);
    r3.xyz = (r1.xyz) * (r0.www) + (-(r15.xyz));
    r14.xyz = normalize(r3.xyz);
    r16.xyz = (r1.xyz) * (r0.www);
    r8.xz = (r5.xy) * (c12.xx);
    r0.w = saturate(dot(r14.xyz, r16.xyz));
    r0.xyz = (r8.xyz) * (r1.www) + (r0.xyz);
    r0.w = (-(r0.w)) + (c3.y);
    r1.xyw = c[37].xyw;
    r10.xyz = float3(((r4.w) >= 0.0f ? (r1.x) : (c[36].x)), ((r4.w) >= 0.0f ? (r1.y) : (c[36].y)), ((r4.w) >= 0.0f ? (r1.w) : (c[36].w)));
    r1.w = (r0.w) * (r0.w);
    r17.xyz = (r0.xyz) * (r10.yyy);
    r0.z = (r1.w) * (r1.w);
    r0.w = (r0.w) * (r0.z);
    r13.xyz = (r2.xyz) * (r2.xyz);
    r11.xyz = (r12.xyz) * (r0.www) + (r13.xyz);
    ...
    r2.xyz = (r4.www) * (r2.xyz) + (r17.xyz);
    r5.z = (r2.w) * (c3.z);
    r3.w = saturate(dot(r16.xyz, r9.xyz));
    r1.w = (r3.w) * (r9.w) + (r5.z);
    r3.z = saturate(dot(r9.xyz, -(r15.xyz)));
    r1.xyz = (v6.xyz) * (-(r10.www)) + (c[17].xyz);
    r5.w = (r3.z) * (r9.w) + (r5.z);
    r0.xyz = normalize(r1.xyz);
    r1.z = (r1.w) * (r5.w) + (c12.z);
    r1.w = saturate(dot(r0.xyz, c[17].xyz));
    r1.z = 1.0f / (r1.z);
    r4.z = (r3.w) * (r1.z);
    r5.y = (-(r1.w)) + (c3.y);
    r1.z = (r5.y) * (r5.y);
    r1.w = dot(r15.xyz, r9.xyz);
    r5.x = (r1.z) * (r1.z);
    r1.z = (r1.w) + (r1.w);
    r1.w = (r2.w) * (c3.x);
    r1.xyz = (r9.xyz) * (-(r1.zzz)) + (r15.xyz);
    ...
    r3.xyz = (r12.xyz) * (r1.www) + (r13.xyz);
    r2.w = (r5.y) * (r5.x);
    r1.xyz = (r1.xyz) * (r3.xyz);
    r3.x = exp2(r4.y);
    r3.y = saturate(dot(r9.xyz, r14.xyz));
    r1.w = (r3.x) * (c14.x) + (c14.y);
    r3.z = (r8.w) * (r9.w) + (r5.z);
    r4.y = (r3.z) * (r5.w) + (c12.z);
    r3.z = saturate(dot(r9.xyz, r0.xyz));
    r0.y = 1.0f / (r4.y);
    r0.z = pow(abs(r3.z), r3.x);
    r0.y = (r8.w) * (r0.y);
    r0.z = (r1.w) * (r0.z);
    r3.z = (r0.y) * (r0.z);
    r0.xyz = (r12.xyz) * (r2.www) + (r13.xyz);
    r2.w = pow(abs(r3.y), r3.x);
