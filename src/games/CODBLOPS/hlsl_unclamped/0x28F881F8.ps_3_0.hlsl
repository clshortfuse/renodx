// Mechanically reconstructed from 0x28F881F8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = (r4.xz) * (r0.xx);
    r1.xy = (r3.xz) * (r0.yy);
    r2.z = (r5.x) * (c12.w) + (-(r4.x));
    r0.z = (r5.y) * (c12.w) + (-(r1.x));
    r2.z = (r4.z) * (-(r0.x)) + (r2.z);
    r0.z = (r3.z) * (-(r0.y)) + (r0.z);
    r0.y = (r0.z) + (r0.z);
    r0.xz = (r1.xy) * (c13.xx);
