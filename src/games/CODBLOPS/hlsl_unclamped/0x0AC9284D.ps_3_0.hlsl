// Mechanically reconstructed from 0x0AC9284D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s3, v7.xy);
    r4.z = (r1.w) * (v0.y) + (c3.z);
    r6.xy = lerp(r4.xy, r3.xy, r3.ww);
    r2.xyz = float3(((r4.z) >= 0.0f ? (r1.x) : (r2.x)), ((r4.z) >= 0.0f ? (r1.y) : (r2.y)), ((r4.z) >= 0.0f ? (r1.z) : (r2.z)));
    r1.xyz = lerp(r2.xyz, r0.xyz, r3.www);
    ...
    r7.xz = (r2.xy) * (c12.yy);
    r3.xyz = (r7.xyz) * (r0.www) + (r0.xyz);
    r0.x = c3.w;
    r4.xyz = float3(((r4.z) >= 0.0f ? (r0.x) : (c[8].x)), ((r4.z) >= 0.0f ? (r0.x) : (c[8].y)), ((r4.z) >= 0.0f ? (r0.x) : (c[8].w)));
    r2 = tex2D(s6, v1.xy);
    r1 = tex2D(s7, v7.zw);
    r0.xyz = (v6.xyz) * (-(r4.www)) + (c[17].xyz);
    r5.xyz = normalize(r0.xyz);
    r5.w = saturate(dot(r5.xyz, c[17].xyz));
    r0 = lerp(r2, r1, r3.wwww);
    r1.w = (-(r5.w)) + (c3.w);
    r9.xyz = (r0.xyz) * (-(r0.xyz)) + (c3.www);
    r1.z = (r1.w) * (r1.w);
    r2.w = (r1.z) * (r1.z);
    r1.xyz = v2.xyz;
    ...
    r0.z = (r0.w) * (-(c13.x)) + (c13.y);
    r1.z = saturate(dot(r12.xyz, r5.xyz));
    r0.x = (r0.w) * (c13.x);
    ...
    r0.z = (r0.z) * (r0.y) + (c12.w);
    r0.y = (r1.w) * (c15.x) + (c15.y);
    r0.z = 1.0f / (r0.z);
    r1.w = (r0.x) * (r0.y);
    r1.z = (r2.w) * (r0.z);
    r0.xyz = (r9.xyz) * (r2.zzz) + (r10.xyz);
    r1.w = (r1.w) * (r1.z);
    r11.xyz = lerp(r4.xyz, c[9].xyw, r3.www);
    r0.xyz = (r0.xyz) * (r1.www);
    r15.xyz = (r3.xyz) * (r11.yyy);
    r13.xyz = (r11.zzz) * (r0.xyz);
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c13.y) : (c13.w));
    ...
    else
    {
        ...
        else
        {
            ...
            if ((r0.z) != (-(r0.z)))
            {
                ...
                r2.z = r4.x;
                r2.w = r3.x;
                r0.x = dot(r2, c15.yyyy);
                r0.z = saturate((v5.w) + (c20.y));
                r0.y = (r1.y) + (-(r0.x));
                r0.z = (r0.z) * (r0.y) + (r0.x);
            }
            else
