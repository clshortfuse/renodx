// Mechanically reconstructed from 0x9EA266FB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.y = dot(r1.xy, r0.zw) + (c20.z);
    r7.x = dot(r1.xy, r0.xy) + (c20.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r5.w = (r0.w) * (v0.y);
    r2 = tex2D(s1, v1.xy);
    ...
    r1.y = dot(r12.xy, r12.xy) + (c20.z);
    r1.w = dot(r2.xy, r2.xy) + (c20.z);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r3.w = (r1.y) * (c3.x) + (c3.y);
    r1.y = (r1.w) * (c3.x) + (c3.y);
    r1.w = dot(r2.xy, r12.xy) + (c20.z);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r6.xy = (r2.xy) * (c4.ww);
