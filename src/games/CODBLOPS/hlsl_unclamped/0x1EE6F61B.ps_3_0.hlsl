// Mechanically reconstructed from 0x1EE6F61B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.w = (r1.w) * (v0.y) + (c3.w);
    r6.w = (r2.w) * (r2.z);
    r11.xy = float2(((r4.w) >= 0.0f ? (r2.x) : (r3.x)), ((r4.w) >= 0.0f ? (r2.y) : (r3.y)));
    r3 = tex2D(s0, v1.xy);
    ...
    r2 = tex2D(s13, r2.xy);
    r0.w = r2.y;
    r8.xyz = float3(((r4.w) >= 0.0f ? (r1.x) : (r3.x)), ((r4.w) >= 0.0f ? (r1.y) : (r3.y)), ((r4.w) >= 0.0f ? (r1.z) : (r3.z)));
    r1.xy = (r0.wy) * (c12.xx) + (c12.yy);
    r0.y = dot(r11.xy, r11.xy) + (c3.z);
    r0.w = dot(r1.xy, r1.xy) + (c3.z);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r7.w = (r0.y) * (c11.x) + (c11.y);
    r0.y = (r0.w) * (c11.x) + (c11.y);
    r0.w = dot(r1.xy, r11.xy) + (c3.z);
    r0.y = (r7.w) * (r0.y);
    r1 = tex2D(s14, v1.zw);
    r5.xy = (r1.xy) * (c11.ww);
    ...
    r1.w = (r1.w) * (r1.z);
    r11.xyz = float3(((r4.w) >= 0.0f ? (r1.y) : (c[8].x)), ((r4.w) >= 0.0f ? (r1.y) : (c[8].y)), ((r4.w) >= 0.0f ? (r1.y) : (c[8].w)));
