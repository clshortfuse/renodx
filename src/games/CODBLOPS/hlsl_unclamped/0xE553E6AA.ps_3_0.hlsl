// Mechanically reconstructed from 0xE553E6AA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xy = lerp(r7.xy, r2.xy, r4.ww);
    r0.w = dot(r6.xy, r6.xy) + (c15.z);
    r0.y = dot(r8.xy, r8.xy) + (c15.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c2.x) + (c2.y);
    r3.w = (r0.y) * (c2.x) + (c2.y);
    ...
    r0.xyz = (r12.xyz) * (r3.www) + (r3.xyz);
    r11.xyz = (r4.www) * (r2.xyz) + (c[34].xyw);
    ...
    r14.xyz = (v0.www) * (r3.xyz) + (c15.www);
    r13.xyz = normalize(r1.xyz);
    r1.xyz = (r2.xyz) * (r14.xyz);
