// Mechanically reconstructed from 0xC35C89CF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c6 = float4(0.600000024f, 0.400000006f, 0.797884583f, 31.875f);
    ...
    r0.y = dot(r11.xy, r11.xy) + (c3.x);
    r0.w = dot(r1.xy, r1.xy) + (c3.x);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r4.w = (r0.y) * (c6.x) + (c6.y);
    r0.y = (r0.w) * (c6.x) + (c6.y);
    r0.w = dot(r1.xy, r11.xy) + (c3.x);
    r0.y = (r4.w) * (r0.y);
    r2.w = (r1.w) * (-(c7.z)) + (c7.w);
