// Mechanically reconstructed from 0x66C316FF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s2, v7.xy);
    r8.w = (r1.w) * (v0.y);
    r13.xyz = (v0.zzz) * (r6.xyz) + (c1.zzz);
    r2 = (r8.wwww) * (r0) + (r2);
    r6.xyz = (v0.www) * (r5.xyz) + (c1.zzz);
    ...
    r1.w = pow(abs(r3.w), r0.z);
    r0.z = (r0.z) * (c4.y) + (c4.z);
    r0.y = (r0.x) * (r0.y);
    r0.z = (r1.w) * (r0.z);
    r14.xyz = (r0.xxx) * (c[18].xyz);
    r0.z = (r0.y) * (r0.z);
    r0.xyz = (r2.xyz) * (r0.zzz);
    r7.xyz = lerp(r3.yyy, c[20].xyw, r8.www);
    r1.w = (r2.w) * (c2.z);
    ...
    r4.xyz = (r15.xyz) * (r2.yyy);
    r5.xyz = (r7.yyy) * (r0.xyz);
    r3 = tex2D(s0, v1.xy);
    r0.xyz = lerp(r3.xyz, r1.xyz, r8.www);
    r1.xyz = (r2.yyy) * (r14.xyz) + (r5.xyz);
