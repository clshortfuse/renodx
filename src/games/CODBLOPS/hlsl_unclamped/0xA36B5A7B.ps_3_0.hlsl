// Mechanically reconstructed from 0xA36B5A7B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.y = dot(r1.xy, r0.zw) + (c12.z);
    r3.x = dot(r1.xy, r0.xy) + (c12.z);
    r0 = tex2D(s1, v0.xy);
