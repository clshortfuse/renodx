// Mechanically reconstructed from 0x3E21319C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.w = (r1.w) * (r0.y);
    r0.xyz = (r6.www) * (c[36].xyz);
    r6.xyz = (r3.www) * (r6.xyz);
    r7.xyz = (r9.www) * (r0.xyz) + (r1.xyz);
    r1 = tex2D(s0, v0.xy);
    r0 = tex2D(s3, v4.zw);
    r9.xyz = normalize(v3.xyz);
    r11.xyz = (r2.xyz) * (r2.www) + (-(r9.xyz));
