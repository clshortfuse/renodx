// Mechanically reconstructed from 0x9A1EBA0F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s0, v0.xy);
    r7.w = (r1.w) * (v6.x) + (c1.z);
    r7.xy = (r4.yw) * (c4.yy) + (c4.zz);
    r5 = float4(((r7.w) >= 0.0f ? (r0.x) : (c1.w)), ((r7.w) >= 0.0f ? (r0.y) : (c1.w)), ((r7.w) >= 0.0f ? (r0.z) : (c1.w)), ((r7.w) >= 0.0f ? (r0.w) : (c1.w)));
    r0 = tex2D(s3, v6.zw);
    r2.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r0 = (c1.xxxx) * (v7) + (c1.yyyy);
    r3.x = dot(r2.xy, r0.xy) + (c1.w);
    r3.y = dot(r2.xy, r0.zw) + (c1.w);
    r2 = tex2D(s5, v6.zw);
    r3.zw = r2.yy;
    r0 = tex2D(s2, v6.zw);
    r6.w = (r0.w) * (v6.y) + (c1.z);
    ...
    r0.w = (r0.w) * (c3.x) + (c3.y);
    r2.y = (r2.z) * (r0.w);
    r2.z = dot(r7.xy, r3.xy) + (c1.w);
    r5 = tex2D(s14, v0.zw);
    r7.xy = (r5.xy) * (c4.xx);
    r5.w = saturate((r2.z) * (r2.y) + (r2.y));
    r2.xy = (r6.xz) * (r7.yy);
    r4.w = (r5.y) * (c4.x) + (-(r2.x));
    r2.xz = (r2.xy) * (c4.yy);
    r2.y = (r6.z) * (-(r7.y)) + (r4.w);
    ...
    r4.xyz = (r6.xyz) * (r0.www) + (r5.xyz);
    r0 = (r0.xyzx) * (-(c1.yyyw)) + (-(c1.wwwy));
    r7.xyz = (r3.www) * (r4.xyz);
    r4 = tex2D(s4, v0.xy);
    r5 = float4(((r7.w) >= 0.0f ? (r4.x) : (-(c1.w))), ((r7.w) >= 0.0f ? (r4.y) : (-(c1.w))), ((r7.w) >= 0.0f ? (r4.z) : (-(c1.w))), ((r7.w) >= 0.0f ? (r4.w) : (-(c1.y))));
    r4 = float4(((r7.w) >= 0.0f ? (r1.x) : (c1.w)), ((r7.w) >= 0.0f ? (r1.y) : (c1.w)), ((r7.w) >= 0.0f ? (r1.z) : (c1.w)), ((r7.w) >= 0.0f ? (r1.w) : (c1.w)));
    r1 = v1;
