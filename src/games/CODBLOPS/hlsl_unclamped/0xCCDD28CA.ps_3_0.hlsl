// Mechanically reconstructed from 0xCCDD28CA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = c0.z;
    r8.xyz = float3(((r2.w) >= 0.0f ? (c[21].x) : (r2.y)), ((r2.w) >= 0.0f ? (c[21].y) : (r2.y)), ((r2.w) >= 0.0f ? (c[21].w) : (r2.y)));
