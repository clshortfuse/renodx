// Mechanically reconstructed from 0x28E4AB75.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = exp2(-(r0.w));
    r4.w = (r11.x) * (-(c14.z)) + (c14.w);
    r3.w = (r0.w) * (c12.x) + (c12.y);
    ...
    r1 = tex2D(s14, v1.zw);
    r8.xy = (r1.xy) * (c12.ww);
    r0.w = dot(r7.xy, r3.xy) + (c3.z);
    r4.xy = (r2.xz) * (r8.xx);
    r0.y = (r1.x) * (c12.w) + (-(r4.x));
    r6.xy = (r0.xz) * (r8.yy);
    r0.x = (r2.z) * (-(r8.x)) + (r0.y);
    r0.y = (r1.y) * (c12.w) + (-(r6.x));
    r0.y = (r0.z) * (-(r8.y)) + (r0.y);
