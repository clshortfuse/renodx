// Mechanically reconstructed from 0x9103A4CE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = (r1.yw) * (c8.xx) + (c8.yy);
    r5.xy = float2(((r5.w) >= 0.0f ? (r0.x) : (c1.z)), ((r5.w) >= 0.0f ? (r0.y) : (c1.z)));
    ...
    r1.xyz = (r4.xyz) * (r3.www) + (r0.xyz);
    r0.xyz = normalize(r2.xyz);
    r2.y = c1.z;
    r8.xyz = float3(((r5.w) >= 0.0f ? (c[5].x) : (r2.y)), ((r5.w) >= 0.0f ? (c[5].y) : (r2.y)), ((r5.w) >= 0.0f ? (c[5].w) : (r2.y)));
    ...
    r1.x = (r3.w) * (-(c8.z)) + (c8.w);
    r1.y = saturate(dot(r0.xyz, -(r9.xyz)));
    r1.z = (r4.w) * (r1.x) + (r2.z);
    r1.x = (r1.y) * (r1.x) + (r2.z);
    r7.xyz = (v6.xyz) * (-(r2.www)) + (c[17].xyz);
    r1.z = (r1.z) * (r1.x) + (c3.x);
    r5.w = (-(r1.y)) + (c1.y);
    r1.z = 1.0f / (r1.z);
    r2.x = (r4.w) * (r1.z);
    r1.xyz = normalize(r7.xyz);
    r6.w = saturate(dot(r0.xyz, r1.xyz));
    r7.xy = (r3.ww) * (c9.xy) + (c9.zw);
