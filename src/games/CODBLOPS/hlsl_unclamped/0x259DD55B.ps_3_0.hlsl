// Mechanically reconstructed from 0x259DD55B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c23 = float4(2.0f, -1.0f, 0.0f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = (c23.xxxx) * (v8) + (c23.yyyy);
    r2.y = dot(r1.xy, r0.zw) + (c23.z);
    r2.x = dot(r1.xy, r0.xy) + (c23.z);
    r0 = tex2D(s1, v0.xy);
    r0.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r1 = tex2D(s3, v7.zw);
    r4.w = (r1.w) * (v7.y);
    r5.xy = lerp(r0.xy, r2.xy, r4.ww);
    r5.z = (r1.w) * (-(v7.y)) + (c23.w);
    r0 = tex2D(s0, v0.xy);
    r3.xyz = lerp(r0.xyz, r1.xyz, r4.www);
    r1.w = (r0.w) * (-(v7.x)) + (c23.w);
    r0.xy = (v0.zw) * (c4.xy);
    r2 = tex2D(s13, r0.xy);
    r0.xy = (v0.zw) * (c4.xy) + (c4.zy);
    r0 = tex2D(s13, r0.xy);
    r2.w = r0.y;
    r6.w = (r1.w) * (-(r5.z)) + (c23.w);
    r1.xy = (r2.yw) * (c12.xx) + (c12.yy);
    r0.w = dot(r5.xy, r5.xy) + (c23.z);
    r0.y = dot(r1.xy, r1.xy) + (c23.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c3.x) + (c3.y);
    r1.w = (r0.y) * (c3.x) + (c3.y);
    r0.y = dot(r1.xy, r5.xy) + (c23.z);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v0.zw);
    r7.xy = (r1.xy) * (c4.ww);
