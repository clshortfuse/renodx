// Mechanically reconstructed from 0x4983BBBF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = saturate(dot(r4.xyz, -(r11.xyz)));
    r4.w = (r0.w) * (c1.y);
    r3.w = (r0.w) * (-(c1.y)) + (c1.x);
    ...
    r9.w = max(abs(r4.y), abs(r4.z));
    r6.xyz = (r0.yyy) * (r1.xyz);
    r1.w = max(abs(r4.x), r9.w);
    r1.w = 1.0f / (r1.w);
