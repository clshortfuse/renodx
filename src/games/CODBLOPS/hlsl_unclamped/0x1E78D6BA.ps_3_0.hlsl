// Mechanically reconstructed from 0x1E78D6BA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r3.w = (r0.w) * (v0.w) + (c1.y);
    r3.xy = float2(((r3.w) >= 0.0f ? (r2.x) : (c1.w)), ((r3.w) >= 0.0f ? (r2.y) : (c1.w)));
    r2.xyz = v4.xyz;
    ...
    r1 = float4(((r3.w) >= 0.0f ? (r1.x) : (c1.w)), ((r3.w) >= 0.0f ? (r1.y) : (c1.w)), ((r3.w) >= 0.0f ? (r1.z) : (c1.w)), ((r3.w) >= 0.0f ? (r1.w) : (c1.z)));
    r2.z = rsqrt(r0.w);
    r4.w = (r1.w) * (c2.x);
    ...
    r0 = float4(((r3.w) >= 0.0f ? (r0.x) : (c1.w)), ((r3.w) >= 0.0f ? (r0.y) : (c1.w)), ((r3.w) >= 0.0f ? (r0.z) : (c1.w)), ((r3.w) >= 0.0f ? (r0.w) : (c1.w)));
