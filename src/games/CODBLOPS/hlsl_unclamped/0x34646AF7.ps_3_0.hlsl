// Mechanically reconstructed from 0x34646AF7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.y = dot(r2.xy, r0.zw) + (c4.z);
    r1.x = dot(r2.xy, r0.xy) + (c4.z);
    r0 = tex2D(s1, v1.xy);
    r2.xy = (r0.wy) * (c3.xy) + (c3.zw);
    r0 = tex2D(s3, v7.xy);
    r6.z = (r0.w) * (v0.y) + (c4.w);
    r6.w = saturate(dot(r5.xyz, c[17].xyz));
    r6.xy = float2(((r6.z) >= 0.0f ? (r1.x) : (r2.x)), ((r6.z) >= 0.0f ? (r1.y) : (r2.y)));
    r1 = tex2D(s0, v1.xy);
    r0.w = dot(r6.xy, r6.xy) + (c4.z);
    r0.w = exp2(-(r0.w));
    ...
    r3 = tex2D(s14, v1.zw);
    r8.xy = (r3.xy) * (c12.ww);
    r9.xy = (r4.yw) * (c13.xx) + (c13.yy);
    r4.xy = (r4.xz) * (r8.xx);
    r1.w = dot(r9.xy, r6.xy) + (c4.z);
    r2.w = (r3.x) * (c12.w) + (-(r4.x));
    r2.y = (r4.z) * (-(r8.x)) + (r2.w);
    r7.xy = (r2.xz) * (r8.yy);
    r2.x = (r3.y) * (c12.w) + (-(r7.x));
    r2.w = dot(r9.xy, r9.xy) + (c4.z);
    r2.z = (r2.z) * (-(r8.y)) + (r2.x);
    r2.w = exp2(-(r2.w));
    r10.y = (r2.y) + (r2.y);
    ...
    r10.xz = (r4.xy) * (c13.xx);
    r2.xyz = float3(((r6.z) >= 0.0f ? (r0.x) : (r1.x)), ((r6.z) >= 0.0f ? (r0.y) : (r1.y)), ((r6.z) >= 0.0f ? (r0.z) : (r1.z)));
    r1.xyz = (r10.xyz) * (r0.www) + (r3.xyz);
    r0 = tex2D(s6, v1.xy);
    r13.xyz = float3(((r6.z) >= 0.0f ? (c[23].x) : (r0.y)), ((r6.z) >= 0.0f ? (c[23].y) : (r0.y)), ((r6.z) >= 0.0f ? (c[23].w) : (r0.y)));
    r14.xyz = (r1.xyz) * (r13.yyy);
    r1 = (r0.wwww) * (c1.xxxy) + (c1.zzzx);
    r0 = tex2D(s7, v7.xy);
