// Mechanically reconstructed from 0x7E081710.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xy = (r1.ww) * (-(r4.xy)) + (r4.xy);
    r0.w = dot(r2.xy, r2.xy) + (c4.y);
    r0.y = dot(r6.xy, r6.xy) + (c4.y);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c4.z) + (c4.w);
    r4.w = (r0.y) * (c4.z) + (c4.w);
    r0.y = (r0.w) * (r4.w);
    r0.w = dot(r2.xy, r6.xy) + (c4.y);
    r2 = tex2D(s14, v0.zw);
    r7.xy = (r2.xy) * (c2.zz);
