// Mechanically reconstructed from 0x0634D2CA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r2.xyz = saturate((r1.xyz) * (r0.www) + (r0.xyz));
    r0 = tex2D(s1, v1.xy);
    ...
    r0.x = saturate(dot(r2.xyz, -(r9.xyz)));
    r1.z = (r0.w) * (c1.y);
    r0.z = (r0.w) * (-(c1.y)) + (c1.x);
    ...
    r1.z = (r2.w) + (r2.w);
    r2.xyz = (r2.xyz) * (-(r1.zzz)) + (r9.xyz);
    r2.w = (r0.w) * (c0.z);
    r2 = texCUBElod(s15, r2);
    r1.xyz = (r2.xyz) * (r2.xyz);
    r2.xyz = (r1.www) * (r7.xyz) + (r8.xyz);
