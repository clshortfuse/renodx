// Mechanically reconstructed from 0x264E1C0E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.z = (r0.w) * (v0.w) + (c1.x);
    r1.w = r2.x;
    r2.xy = float2(((r6.z) >= 0.0f ? (r3.x) : (c1.z)), ((r6.z) >= 0.0f ? (r3.y) : (c1.z)));
    r4.y = dot(r1, c3.wwww);
    r1 = v2;
    r1.xyz = (r2.xxx) * (v5.xyz) + (r1.xyz);
    r3.xyz = (r5.xyz) * (r3.www);
    r1.xyz = (r2.yyy) * (v4.xyz) + (r1.xyz);
    r0.w = dot(r3.xyz, c[10].xyz);
