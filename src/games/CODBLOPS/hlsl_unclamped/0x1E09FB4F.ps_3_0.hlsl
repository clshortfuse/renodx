// Mechanically reconstructed from 0x1E09FB4F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = (r4.w) * (c15.z) + (c15.w);
    r1.y = (r11.x) * (c2.z);
    r0.z = (r11.x) * (-(c15.x)) + (c15.y);
    r0.x = (r3.w) * (r0.z) + (r1.y);
    r0.z = (r1.w) * (r0.z) + (r1.y);
    r0.y = (r1.z) * (r0.y);
    r0.z = (r0.z) * (r0.x) + (c4.w);
