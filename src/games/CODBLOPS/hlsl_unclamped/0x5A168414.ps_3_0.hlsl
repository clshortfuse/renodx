// Mechanically reconstructed from 0x5A168414.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyw = c[21].xyw;
    r3.xyz = (-(r0.xyw)) + (c[22].xyw);
    r0.xyz = v1.xyz;
    r0.xyz = (r5.xxx) * (v4.xyz) + (r0.xyz);
    r8.xyz = (r6.www) * (r3.xyz) + (c[21].xyw);
    r0.xyz = (r5.yyy) * (v3.xyz) + (r0.xyz);
    r11.xyz = (r2.xyz) * (r8.yyy);
