// Mechanically reconstructed from 0x027813A6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(-1.0f, 1.0f, 0.200000003f, 0.797884583f);
    ...
    r1.w = (r1.w) * (r1.w);
    r7.xyz = (r6.xyz) * (c1.zzz);
    r1.w = (r4.w) * (r1.w);
    r1.xyz = (r7.xyz) * (-(r7.xyz)) + (c1.yyy);
    r0.w = (r3.w) * (r0.w);
