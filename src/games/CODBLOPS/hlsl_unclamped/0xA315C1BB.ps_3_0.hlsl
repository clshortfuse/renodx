// Mechanically reconstructed from 0xA315C1BB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(1.0f, 3.5f, 0.959999979f, 0.0399999991f);
    ...
    r0.z = (r0.z) + (r0.z);
    r1.xyz = (r8.xyz) * (-(r0.zzz)) + (r4.xyz);
    r0.z = saturate(dot(r8.xyz, -(r4.xyz)));
    r1.w = (r0.w) * (c2.w);
