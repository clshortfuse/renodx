// Mechanically reconstructed from 0x2F150135.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = (v6.zzzz) * (c[33]) + (r0);
    r0 = (r0) + (c[34]);
    r3.xy = (r0.ww) * (c[39].xy) + (r0.xy);
    r3.zw = r0.zw;
    r1 = tex2Dproj(s2, r3);
    r2.zw = r3.zw;
    r0.zw = r2.zw;
    r4.xy = (r3.ww) * (-(c[39].zw)) + (r0.xy);
    r4.zw = r0.zw;
    r4 = tex2Dproj(s2, r4);
    r1.w = r4.x;
    r2.xy = (r3.ww) * (-(c[39].xy)) + (r0.xy);
    r0.xy = (r3.ww) * (c[39].zw) + (r0.xy);
    r2 = tex2Dproj(s2, r2);
    r1.y = r2.x;
    r2 = tex2Dproj(s2, r0);
    ...
    r1.w = dot(c[37].yz, r4.xy) + (c[37].x);
    r2.xy = saturate((r4.xx) * (c[38].xy) + (c[38].zw));
    r1.xy = (r2.xy) * (r2.xy);
    ...
    r1 = (r3) * (r3) + (r1);
    r2 = (-(v6.zzzz)) + (c[8]);
    r8.xyz = (r7.xyz) * (c1.zzz);
    r1 = (r2) * (r2) + (r1);
    r7.w = saturate(dot(r5.xyz, r9.xyz));
    r5.x = rsqrt(r1.x);
    r5.y = rsqrt(r1.y);
    r5.z = rsqrt(r1.z);
    r5.w = rsqrt(r1.w);
    r7.xyz = (r7.www) * (c[36].xyz);
    r4 = (r4) * (r5);
    r4 = (r9.yyyy) * (r4);
    r3 = (r3) * (r5);
    r2 = (r2) * (r5);
