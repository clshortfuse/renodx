// Mechanically reconstructed from 0x85E8307E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.w = c1.x;
    r1.xyz = (r8.www) + (-(c[31].xyw));
    r9.xyz = (r12.xyz) * (r0.www) + (r13.xyz);
    r2.xyz = (r5.www) * (r1.xyz) + (c[31].xyw);
