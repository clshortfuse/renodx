// Mechanically reconstructed from 0x12E627EF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.y = (r1.z) + (r1.z);
    r1.z = c1.x;
    r2.xyz = (r1.zzz) + (-(c[29].xyw));
    r1.xyz = (r4.xyz) * (r1.www) + (r3.xyz);
    r6.xyz = (r0.www) * (r2.xyz) + (c[29].xyw);
