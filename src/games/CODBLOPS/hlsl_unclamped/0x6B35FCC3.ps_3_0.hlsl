// Mechanically reconstructed from 0x6B35FCC3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xyz = (v0.yyy) * (r1.xyz) + (c42.zzz);
    r0 = tex2D(s0, v1.xy);
    r1 = tex2D(s6, v7.zw);
    r3.w = (r1.w) * (v0.z);
    r1.xyz = (r0.xyz) * (-(r8.xyz)) + (r1.xyz);
    r10.xy = lerp(r3.xy, r2.xy, r3.ww);
    r1.xyz = (r3.www) * (r1.xyz);
    r0.w = dot(r10.xy, r10.xy) + (c3.x);
    ...
    r1 = tex2D(s14, v1.zw);
    r4.xy = (r1.xy) * (c12.ww);
    r6.xy = (r0.wy) * (c41.xx) + (c41.yy);
    r2.xy = (r2.xz) * (r4.xx);
    r0.w = dot(r6.xy, r10.xy) + (c3.x);
    ...
    r9.xz = (r2.xy) * (c4.ww);
    r3.z = rsqrt(r3.z);
    r1.xyz = (r9.xyz) * (r4.www) + (r0.xyz);
    r2 = tex2D(s8, v1.xy);
    r0 = tex2D(s9, v7.zw);
    r7.w = lerp(r2.y, r0.y, r3.w);
    r12.xyz = (r1.xyz) * (r7.www);
    r0.xyz = (-(v6.xyz)) + (c[20].xyz);
    r1.xyz = (v6.xyz) * (-(r3.zzz)) + (c[17].xyz);
    r1.w = dot(r0.xyz, r0.xyz);
    r1.w = rsqrt(r1.w);
    r6.xyz = (r3.zzz) * (v6.xyz);
    r3.xyz = normalize(r1.xyz);
    r1.xyz = (r0.xyz) * (r1.www) + (-(r6.xyz));
    r7.xyz = normalize(r1.xyz);
    r4.xyz = (r0.xyz) * (r1.www);
    r0.y = saturate(dot(r3.xyz, c[17].xyz));
    r0.z = saturate(dot(r7.xyz, r4.xyz));
    r4.w = (-(r0.y)) + (c42.z);
    r0.z = (-(r0.z)) + (c42.z);
    r0.x = (r4.w) * (r4.w);
    r0.y = (r0.z) * (r0.z);
    ...
    r0.z = (r1.z) * (r2.w) + (c13.x);
    r0.y = 1.0f / (r0.z);
    r1.xy = (r0.ww) * (c40.xy) + (c40.zw);
    r2.x = exp2(r1.y);
    r1.z = saturate(dot(r10.xyz, r7.xyz));
    r0.z = pow(abs(r1.z), r2.x);
    r2.z = (r2.x) * (c13.y) + (c13.z);
    r1.y = (r6.w) * (r0.y);
    r1.z = (r0.z) * (r2.z);
    ...
    r2.w = (r0.w) * (r2.w) + (c13.x);
    r0.w = pow(abs(r2.y), r2.x);
    r2.w = 1.0f / (r2.w);
    r0.w = (r2.z) * (r0.w);
    r2.w = (r1.w) * (r2.w);
