// Mechanically reconstructed from 0x65D15F85.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(0.200000003f, 1.0f, 0.797884583f, 0.0009765625f);
    ...
    r2 = lerp(r5, r4, r3.wwww);
    r1.z = rsqrt(r0.w);
    r4.w = (r2.w) * (c1.z);
    r8.xyz = (r7.xyz) * (r1.zzz);
    r1.w = (r2.w) * (-(c1.z)) + (c1.y);
