// Mechanically reconstructed from 0x0DD25C1F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyz = (r6.www) * (r0.xyz) + (c[29].xyw);
    r4.xyz = (-(v7.xyz)) + (c[5].xyz);
    r0 = v2;
    r0.xyz = (r7.xxx) * (v5.xyz) + (r0.xyz);
    r1.w = dot(r4.xyz, r4.xyz);
    r7.xyz = (r7.yyy) * (v4.xyz) + (r0.xyz);
    r2.w = rsqrt(r1.w);
