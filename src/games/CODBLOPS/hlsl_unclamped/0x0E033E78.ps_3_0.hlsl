// Mechanically reconstructed from 0x0E033E78.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = (v0.yyy) * (r1.xyz) + (c14.yyy);
    r5.xyz = (r6.xyz) * (c14.zzz);
    r2 = tex2D(s4, v1.xy);
    r5.w = r2.w;
    r1 = tex2D(s3, v7.zw);
    r8.w = (r1.w) * (v0.z);
    ...
    r2 = tex2D(s0, v1.xy);
    r0.xyz = (r2.xyz) * (-(r6.xyz)) + (r1.xyz);
    r1.xyz = (r7.www) * (r12.xyz) + (r4.xyz);
