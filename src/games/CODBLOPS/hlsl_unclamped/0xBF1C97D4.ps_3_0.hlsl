// Mechanically reconstructed from 0xBF1C97D4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyz = (r4.xyz) * (r7.yyy) + (r2.xyz);
    r5.w = (r2.w) * (-(c38.z)) + (c38.w);
    r9.w = (r2.w) * (c3.z);
