// Mechanically reconstructed from 0xD4B0859A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = (r0.z) + (r0.z);
    r5 = tex2D(s6, v1.xy);
    r2.xyz = lerp(r5.yyy, c[36].xyw, r11.www);
    r0.xyz = (r8.xyz) * (r0.www) + (r4.xyz);
    r11.xyz = lerp(r2.xyz, c[37].xyw, r12.www);
    ...
    r15.xyz = (r2.yyy) * (r0.xyz) + (r5.xyz);
    r0.xyz = normalize(r4.xyz);
    r14.xyz = (r2.www) * (v6.xyz);
    ...
    r0.xyz = lerp(r6.xyz, r1.xyz, r12.www);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r1.z = dot(r14.xyz, r10.xyz);
    r3.xyz = (r0.xyz) * (r15.xyz) + (r2.xyz);
    r1.z = (r1.z) + (r1.z);
    r1.xyz = (r10.xyz) * (-(r1.zzz)) + (r14.xyz);
    r2.xyz = (r13.xyz) * (r10.www) + (-(r14.xyz));
    ...
    r1.w = (r8.w) * (r1.w);
    r4.xyz = (r5.xyz) * (r1.www) + (r9.xyz);
    r1.w = saturate(dot(r12.xyz, r10.xyz));
