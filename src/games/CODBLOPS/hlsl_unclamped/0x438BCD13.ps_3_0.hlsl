// Mechanically reconstructed from 0x438BCD13.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = (r2.z) * (r1.z);
    r1.z = (r1.x) * (r1.z);
    r1.xy = float2(((r3.z) >= 0.0f ? (c1.y) : (r1.y)), ((r3.z) >= 0.0f ? (c1.z) : (r1.y)));
    r1.z = (r3.w) * (r1.z);
