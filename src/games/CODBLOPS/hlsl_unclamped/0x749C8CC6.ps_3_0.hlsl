// Mechanically reconstructed from 0x749C8CC6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s8, v1.xy);
    r14.xyz = lerp(r1.yyy, c[32].xyw, r5.www);
    r2.w = -(r1.w);
    r2.xyz = c3.www;
    r0 = tex2D(s9, v7.xy);
    r0 = (r2) + (r0);
    r1 = (r1.wwww) * (-(c3.zzzy)) + (-(c3.wwwz));
