// Mechanically reconstructed from 0xC9D2086A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s3, v7.zw);
    r5.z = (r0.w) * (v7.y);
    r3.xyz = lerp(r2.xyz, r0.xyz, r5.zzz);
    r0.w = (r0.w) * (-(v7.y)) + (c1.x);
    r6.w = (r2.w) * (-(r0.w)) + (c1.x);
    ...
    r3.w = (r0.y) * (c3.x) + (c3.y);
    r0.w = exp2(-(r0.w));
    r7.xyz = lerp(r1.yyy, c[20].xyw, r5.zzz);
    r0.y = (r0.w) * (c3.x) + (c3.y);
    ...
    r1.w = (r1.z) * (r1.w);
    r1.xyz = (r8.xyz) * (r3.www) + (r3.xyz);
    r0.xyz = (r0.xyz) * (r1.www);
    r14.xyz = (r7.yyy) * (r1.xyz);
