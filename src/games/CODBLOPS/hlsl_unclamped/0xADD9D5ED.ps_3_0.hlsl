// Mechanically reconstructed from 0xADD9D5ED.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.xyz = float3(((r4.w) >= 0.0f ? (c[24].x) : (r2.y)), ((r4.w) >= 0.0f ? (c[24].y) : (r2.y)), ((r4.w) >= 0.0f ? (c[24].w) : (r2.y)));
