// Mechanically reconstructed from 0x2BBF3507.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xyz = (r14.xyz) * (r4.zzz) + (r15.xyz);
    r0.z = max(abs(r9.x), r1.w);
    r1.w = 1.0f / (r0.z);
    r0.xyz = (r9.xyz) * (c[5].xyz);
    r10.xyz = (r4.www) * (r2.xyz);
    ...
    r13.xyz = (r2.xyz) * (c0.www);
    r12.xyz = (r1.xxx) * (r0.xyz);
    if ((c3.x) >= (v6.w))
    {
        r3 = (v6.xyzx) * (c3.xxxw);
        r2 = (r3) + (-(c13.xyzz));
