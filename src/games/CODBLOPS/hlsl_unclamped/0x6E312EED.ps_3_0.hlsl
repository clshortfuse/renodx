// Mechanically reconstructed from 0x6E312EED.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = saturate(dot(r7.xyz, r0.xyz));
    ...
    r1.w = (r0.z) * (r1.w) + (r1.y);
    r1.w = (r1.w) * (r1.z) + (c1.z);
    r2.y = max(abs(r7.y), abs(r7.z));
    r2.z = 1.0f / (r1.w);
    r1.w = max(abs(r7.x), r2.y);
    r1.w = 1.0f / (r1.w);
    ...
    r4.xyz = (r0.zzz) * (r9.xyz) + (r10.xyz);
    r5.xyz = (r3.xyz) * (r8.www) + (r6.xyz);
