// Mechanically reconstructed from 0x216114E2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xy = (c[11].zz) * (r1.xy) + (r0.xy);
    r1.w = dot(r6.xy, r6.xy) + (c1.x);
    r0.xy = (v1.zw) * (c4.xz);
    r0 = tex2D(s13, r0.xy);
