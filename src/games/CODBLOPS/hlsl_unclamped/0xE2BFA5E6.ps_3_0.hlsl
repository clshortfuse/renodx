// Mechanically reconstructed from 0xE2BFA5E6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4 = tex3D(s11, r1.xyz);
    r1.z = lerp(r4.w, r3.z, r2.y);
    r6.xyz = (r4.xyz) * (r4.xyz);
    r3.z = (r6.w) * (r1.z);
    r4.z = (r2.w) * (c2.z);
    r3.x = (r2.w) * (-(c2.z)) + (c2.w);
    r1.xyz = normalize(v7.xyz);
    r2.y = saturate(dot(r8.xyz, r7.xyz));
