// Mechanically reconstructed from 0x3A8CC8BC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = (c9.xxxx) * (v7) + (c9.yyyy);
    r4.x = dot(r2.xy, r1.xy) + (c9.z);
    r4.y = dot(r2.xy, r1.zw) + (c9.z);
    r1 = tex2D(s2, v6.zw);
    r5.w = (r1.w) * (v6.y);
    r2.xy = (r0.yw) * (c4.xx) + (c4.yy);
    r6.xy = lerp(r5.xy, r4.xy, r5.ww);
    r0.y = dot(r2.xy, r2.xy) + (c9.z);
    r0.w = dot(r6.xy, r6.xy) + (c9.z);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r0.y = (r0.y) * (c2.x) + (c2.y);
    r0.w = (r0.w) * (c2.x) + (c2.y);
    r3.w = (r0.y) * (r0.w);
    r0.y = dot(r2.xy, r6.xy) + (c9.z);
    r2 = tex2D(s14, v0.zw);
    r5.xy = (r2.xy) * (c2.ww);
