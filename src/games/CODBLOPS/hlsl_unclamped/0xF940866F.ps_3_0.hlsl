// Mechanically reconstructed from 0xF940866F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xz = (r2.xy) * (c4.yy);
    r8.w = rsqrt(r3.z);
    r4.xyz = (r7.xyz) * (r3.www) + (r0.xyz);
    r1 = tex2D(s7, v1.xy);
    r11.w = (r1.w) * (-(c15.x)) + (c15.y);
    r3 = tex2D(s0, v1.xy);
    r2 = tex2D(s5, v8.xy);
    r1.z = (r2.w) * (v0.y) + (c1.x);
    r0 = v2;
    r0.xyz = (r5.xxx) * (v5.xyz) + (r0.xyz);
    r8.xyz = float3(((r1.z) >= 0.0f ? (r2.x) : (r3.x)), ((r1.z) >= 0.0f ? (r2.y) : (r3.y)), ((r1.z) >= 0.0f ? (r2.z) : (r3.z)));
    r0.xyz = (r5.yyy) * (v4.xyz) + (r0.xyz);
    r7.w = ((r1.z) >= 0.0f ? (c1.y) : (r1.y));
    r9.xyz = normalize(r0.xyz);
    r11.xyz = (r4.xyz) * (r7.www);
    r10.w = saturate(dot(r9.xyz, c[17].xyz));
    r2 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r2.y)) >= 0.0f ? (c15.y) : (c15.w));
