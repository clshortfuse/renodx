// Mechanically reconstructed from 0x5F13DB79.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xy = (r1.yw) * (c2.yy) + (c2.zz);
    r0.z = exp2(-(r0.w));
    r0.w = dot(r0.xy, r0.xy) + (c1.x);
    r2.w = (r0.z) * (c1.y) + (c1.z);
    r0.w = exp2(-(r0.w));
    r1.w = dot(r0.xy, r4.xy) + (c1.x);
    r1.y = (r0.w) * (c1.y) + (c1.z);
    r0 = tex2D(s14, v1.zw);
    r5.xy = (r0.xy) * (c2.xx);
    r0.w = (r2.w) * (r1.y);
    ...
    r2.y = (r1.z) * (-(r5.x)) + (r2.y);
    r3.w = (r1.w) * (r1.y);
    r1.xyz = (r0.xyz) * (-(r0.xyz)) + (c3.xxx);
    r1.w = dot(r4.xyz, r8.xyz);
    r5.xyz = (r3.www) * (r1.xyz);
    r1.z = (r1.w) + (r1.w);
    r1.w = (r0.w) * (c1.w);
    r1.xyz = (r8.xyz) * (-(r1.zzz)) + (r4.xyz);
    r1 = texCUBElod(s15, r1);
    r4.xyz = (r1.xyz) * (r1.xyz);
    r1.xyz = (r0.xyz) * (r0.xyz) + (r5.xyz);
    r0.xyz = (r4.xyz) * (c[20].xxx);
    r2.y = (r2.y) + (r2.y);
