// Mechanically reconstructed from 0x326984E7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s2, v7.zw);
    r3.w = (r0.w) * (v7.y) + (c0.x);
    r4.xy = (r1.yw) * (c14.xx) + (c14.yy);
    r8.xy = float2(((r3.w) >= 0.0f ? (r2.x) : (c0.z)), ((r3.w) >= 0.0f ? (r2.y) : (c0.z)));
    r1.w = dot(r4.xy, r4.xy) + (c0.z);
    r0.w = dot(r8.xy, r8.xy) + (c0.z);
    r1.w = exp2(-(r1.w));
    r0.w = exp2(-(r0.w));
    r1.w = (r1.w) * (c2.x) + (c2.y);
    r5.w = (r0.w) * (c2.x) + (c2.y);
    ...
    r7.xyz = float3(((r3.w) >= 0.0f ? (c[21].x) : (r1.w)), ((r3.w) >= 0.0f ? (c[21].y) : (r1.w)), ((r3.w) >= 0.0f ? (c[21].w) : (r1.w)));
