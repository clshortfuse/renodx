// Mechanically reconstructed from 0x0F95CC2A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = dot(r3.xy, r0.zw) + (c1.z);
    r2.x = dot(r3.xy, r0.xy) + (c1.z);
    r0.xy = (v0.zw) * (-(c1.yw));
    r3 = tex2D(s13, r0.xy);
    r0 = tex2D(s5, v7.zw);
    r10.w = (r0.w) * (v7.y) + (c1.w);
    r1.xy = (v0.zw) * (-(c1.yw)) + (-(c1.zw));
    r1 = tex2D(s13, r1.xy);
    r3.w = r1.y;
    r5.xy = float2(((r10.w) >= 0.0f ? (r2.x) : (r4.x)), ((r10.w) >= 0.0f ? (r2.y) : (r4.y)));
    ...
    r0.w = rsqrt(r0.w);
    r12.xyz = (r4.www) * (v6.xyz);
    r2.xyz = (r8.xyz) * (r1.www) + (r1.xyz);
    r3.xyz = (r4.xyz) * (r0.www) + (-(r12.xyz));
    r1 = tex2D(s0, v0.xy);
    r13.xyz = (r4.xyz) * (r0.www);
    r0.xyz = float3(((r10.w) >= 0.0f ? (r0.x) : (r1.x)), ((r10.w) >= 0.0f ? (r0.y) : (r1.y)), ((r10.w) >= 0.0f ? (r0.z) : (r1.z)));
    ...
    r3.xyw = c[37].xyw;
    r7.xyz = float3(((r10.w) >= 0.0f ? (r3.x) : (c[36].x)), ((r10.w) >= 0.0f ? (r3.y) : (c[36].y)), ((r10.w) >= 0.0f ? (r3.w) : (c[36].w)));
    r6.w = saturate(dot(r9.xyz, c[17].xyz));
    r15.xyz = (r2.xyz) * (r7.yyy);
    ...
    r5.w = saturate(dot(r13.xyz, r9.xyz));
    r1 = tex2D(s8, v7.zw);
    r2 = tex2D(s7, v0.xy);
    r2 = float4(((r10.w) >= 0.0f ? (r1.x) : (r2.x)), ((r10.w) >= 0.0f ? (r1.y) : (r2.y)), ((r10.w) >= 0.0f ? (r1.z) : (r2.z)), ((r10.w) >= 0.0f ? (r1.w) : (r2.w)));
    r4.xyz = (r2.xyz) * (-(r2.xyz)) + (-(c1.yyy));
    r5.xyz = (r2.xyz) * (r2.xyz);
    r0.xyz = (r4.xyz) * (r9.www) + (r5.xyz);
    r9.w = (r2.w) * (-(c14.x)) + (c14.y);
    r10.w = (r2.w) * (c3.w);
    r2.z = saturate(dot(r9.xyz, -(r12.xyz)));
    r1.w = (r5.w) * (r9.w) + (r10.w);
    r4.w = (r2.z) * (r9.w) + (r10.w);
    r1.z = (r1.w) * (r4.w) + (c4.w);
    ...
    r1.w = (r7.x) * (c14.z) + (c14.w);
    r1.z = (r6.w) * (r9.w) + (r10.w);
    r1.z = (r1.z) * (r4.w) + (c4.w);
    r4.w = saturate(dot(r9.xyz, r10.xyz));
    r1.y = 1.0f / (r1.z);
    r1.z = pow(abs(r4.w), r7.x);
    r1.y = (r6.w) * (r1.y);
    r1.z = (r1.w) * (r1.z);
    r6.w = (r1.y) * (r1.z);
    r1.xyz = (r4.xyz) * (r8.www) + (r5.xyz);
    r4.w = pow(abs(r7.y), r7.x);
