// Mechanically reconstructed from 0xFD9CA142.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.z = dot(r6.xyz, r10.xyz);
    r2.xyz = (r8.xyz) * (r2.xyz);
    r8.z = (r9.z) + (r9.z);
    r5.xyz = (r0.xyz) * (r5.xyz) + (r2.xyz);
    r2.xyz = (r10.xyz) * (-(r8.zzz)) + (r6.xyz);
