// Mechanically reconstructed from 0x5DC84AF8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(0.200000003f, 0.797884583f, 1.0f, 0.0009765625f);
    ...
    r1.x = dot(r4.xy, r0.xy) + (c1.z);
    r1.y = dot(r4.xy, r0.zw) + (c1.z);
    r0 = tex2D(s3, v6.xy);
    r2.w = (r0.w) * (v0.y) + (c1.w);
    r3.xyz = (r3.xyz) * (r3.xyz);
    r7.xyz = float3(((r2.w) >= 0.0f ? (r1.x) : (r2.x)), ((r2.w) >= 0.0f ? (r1.y) : (r2.y)), ((r2.w) >= 0.0f ? (r1.z) : (r2.z)));
    r3.xyz = (r4.www) * (r3.xyz);
    r1.xyz = v4.xyz;
    r1.xyz = (r7.xxx) * (r1.xyz) + (v2.xyz);
    ...
    r1.w = (r4.w) * (r4.w);
    r5.xyz = (v0.zzz) * (r1.xyz) + (-(c1.yyy));
    r1.w = (r1.w) * (r1.w);
    r6.xyz = (r5.xyz) * (c2.xxx);
    r1.w = (r4.w) * (r1.w);
    r1.xyz = (r6.xyz) * (-(r6.xyz)) + (-(c1.yyy));
    r0.w = (r3.w) * (r0.w);
    r7.xyz = (r1.www) * (r1.xyz);
    r1 = tex2D(s0, v1.xy);
    r0.xyz = float3(((r2.w) >= 0.0f ? (r0.x) : (r1.x)), ((r2.w) >= 0.0f ? (r0.y) : (r1.y)), ((r2.w) >= 0.0f ? (r0.z) : (r1.z)));
