// Mechanically reconstructed from 0x48194091.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = r2.y;
    r3.w = (r1.w) * (c3.x) + (c3.y);
    r4.xy = (r0.wy) * (c12.xx) + (c12.yy);
    r1 = tex2D(s14, v0.zw);
    r5.xy = (r1.xy) * (c4.ww);
    r0.w = dot(r4.xy, r9.xy) + (c1.w);
    r2.xy = (r2.xz) * (r5.xx);
    r0.y = (r1.x) * (c4.w) + (-(r2.x));
    r3.xy = (r0.xz) * (r5.yy);
    r0.y = (r2.z) * (-(r5.x)) + (r0.y);
    ...
    r8.xz = (r2.xy) * (c12.xx);
    r0.w = (r1.w) * (r1.w);
    r2.xyz = (r8.xyz) * (r3.www) + (r0.xyz);
    r1.z = (r0.w) * (r0.w);
    r0 = tex2D(s3, v7.zw);
    r0.xyz = (r0.xyz) + (c1.yyy);
    r0.w = (r1.w) * (r1.z);
    r4.xyz = (v7.yyy) * (r0.xyz) + (c1.zzz);
    r5 = tex2D(s4, v0.xy);
    r1 = tex2D(s0, v0.xy);
    r0.xyz = lerp(r1.xyz, c1.xxx, r5.xxx);
    r1.w = (r5.w) * (-(c12.z)) + (c12.w);
    r0.xyz = (r4.xyz) * (r0.xyz);
    r10.xyz = (r0.xyz) * (-(r0.xyz)) + (c1.zzz);
    r11.xyz = (r0.xyz) * (r0.xyz);
    r3.xyz = (r10.xyz) * (r0.www) + (r11.xyz);
    r0 = v1;
    r7.xyz = (r9.xxx) * (v4.xyz) + (r0.xyz);
    r0.xyz = (r5.xxx) * (r1.xyz);
    r1.xyz = (r9.yyy) * (v3.xyz) + (r7.xyz);
    r9.xyz = normalize(r1.xyz);
    r12.xyz = (r2.www) * (v6.xyz);
    r5.z = saturate(dot(r9.xyz, -(r12.xyz)));
    r1.y = (r5.w) * (c3.w);
    r1.z = (r5.z) * (r1.w) + (r1.y);
    r16.xy = (r5.ww) * (c14.xy) + (c14.zw);
    r3.w = exp2(r16.y);
