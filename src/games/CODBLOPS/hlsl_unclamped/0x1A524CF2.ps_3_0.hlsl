// Mechanically reconstructed from 0x1A524CF2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c14 = float4(1.0f, 0.5f, 0.0f, 0.25f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r1.y = r2.x;
    r2 = tex2Dproj(s2, r0);
    r0 = (v5.xyzx) * (c14.xxxz) + (c14.zzzx);
    r2.w = dot(r0, c[21]);
    r1.z = r2.x;
    r2.w = 1.0f / (r2.w);
    r2.x = dot(r0, c[10]);
    r2.y = dot(r0, c[11]);
    r4.w = dot(r1, c14.wwww);
    r1.xy = (r2.ww) * (r2.xy);
    r2.x = dot(r0, c[20]);
    ...
    r2.z = saturate(dot(r6.xyz, -(r9.xyz)));
