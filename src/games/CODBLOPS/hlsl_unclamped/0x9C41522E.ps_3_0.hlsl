// Mechanically reconstructed from 0x9C41522E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = saturate(dot(r1.xyz, -(r5.xyz)));
    r1 = tex2D(s6, v6.xy);
    r4.xyz = c3.www;
    r3 = tex2D(s5, v1.xy);
    r4.w = -(r3.w);
    r1 = (r1) + (r4);
    r4 = (r3.wwww) * (-(c3.zzzy)) + (-(c3.wwwz));
    r0.w = dot(c[5].xyz, r5.xyz);
    r1 = (r5.wwww) * (r1) + (r4);
    r7.xy = lerp(r3.yy, c[8].xy, r5.ww);
    r2.w = (r1.w) * (c4.z);
    ...
    r1.w = (r1.w) * (c2.x) + (c2.y);
    r4.xyz = (v0.zzz) * (r2.xyz) + (-(c3.yyy));
    r1.w = 1.0f / (r1.w);
    r1.xyz = (r1.xyz) * (r4.xyz);
    r1.w = (r3.w) * (r1.w);
    r2.xyz = (r1.xyz) * (-(r1.xyz)) + (-(c3.yyy));
    r3.xyz = (r7.xxx) * (r3.xyz);
    r2.xyz = (r1.www) * (r2.xyz);
    r5.xyz = (r1.xyz) * (r1.xyz) + (r2.xyz);
    r1.xy = (v1.zw) * (c2.yz);
    r2 = tex2D(s13, r1.xy);
    r1 = tex2D(s14, v1.zw);
    r6.xy = (r1.xy) * (c4.ww);
    ...
    r1.y = r2.y;
    r2.z = (r2.z) * (-(r6.y)) + (r1.w);
    r1.xy = (r1.xy) * (c10.xx) + (c10.yy);
    r1.z = dot(r1.xy, r1.xy) + (c3.z);
    r1.w = dot(r8.xy, r8.xy) + (c3.z);
    r1.z = exp2(-(r1.z));
    r1.w = exp2(-(r1.w));
    r1.z = (r1.z) * (c4.x) + (c4.y);
    r2.w = (r1.w) * (c4.x) + (c4.y);
    r1.w = dot(r1.xy, r8.xy) + (c3.z);
    r1.z = (r1.z) * (r2.w);
    r6.y = (r2.z) + (r2.z);
    r1.w = saturate((r1.w) * (r1.z) + (r1.z));
    r3.xyz = (r3.xyz) * (c4.zzz);
    r6.xyz = (r6.xyz) * (r1.www);
    r1 = tex2D(s0, v1.xy);
    r2.xyz = lerp(r1.xyz, r0.xyz, r5.www);
    r1.xyz = (r5.xyz) * (r2.www) + (r6.xyz);
