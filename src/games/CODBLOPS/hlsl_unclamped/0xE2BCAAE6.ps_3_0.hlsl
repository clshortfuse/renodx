// Mechanically reconstructed from 0xE2BCAAE6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = c1.y;
    r11.xyz = float3(((r0.w) >= 0.0f ? (r6.w) : (c[36].x)), ((r0.w) >= 0.0f ? (r6.w) : (c[36].y)), ((r0.w) >= 0.0f ? (r6.w) : (c[36].w)));
    ...
    r1 = tex2D(s5, v7.zw);
    r0 = v2;
    r7.xyz = (r9.xxx) * (v5.xyz) + (r0.xyz);
    r0.xyz = (r1.xyz) + (c1.zzz);
    r1.xyz = (r9.yyy) * (v4.xyz) + (r7.xyz);
