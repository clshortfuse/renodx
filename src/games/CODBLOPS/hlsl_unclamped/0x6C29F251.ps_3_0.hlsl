// Mechanically reconstructed from 0x6C29F251.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s2, v1.xy);
    r0.xyz = (r2.wwy) * (c1.zyy) + (c1.wzz);
    r2.w = (-(r1.z)) + (c1.y);
    r1.xyz = float3(((r3.w) >= 0.0f ? (r0.x) : (c1.z)), ((r3.w) >= 0.0f ? (r0.y) : (c1.y)), ((r3.w) >= 0.0f ? (r0.z) : (c1.z)));
    r0.z = (r2.w) * (r2.w);
    r0.y = (r1.y) * (c4.x) + (c4.y);
    r0.z = (r2.w) * (r0.z);
    r0.y = 1.0f / (r0.y);
