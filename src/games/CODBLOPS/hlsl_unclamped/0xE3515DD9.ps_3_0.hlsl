// Mechanically reconstructed from 0xE3515DD9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = c1.w;
    r2.xyz = float3(((r5.w) >= 0.0f ? (c[5].x) : (r0.x)), ((r5.w) >= 0.0f ? (c[5].y) : (r0.x)), ((r5.w) >= 0.0f ? (c[5].w) : (r0.x)));
    r0.xyz = normalize(r3.xyz);
    r9.xyz = lerp(r2.xyz, c[6].xyw, r10.www);
    r7.w = saturate(dot(r0.xyz, c[17].xyz));
    r2.xyz = (r1.xyz) * (r9.yyy);
    r1.xyz = (r7.www) * (c[18].xyz);
    r3 = tex2D(s12, v0.zw);
    r2.xyz = (r3.yyy) * (r1.xyz) + (r2.xyz);
    r4 = tex2D(s4, v0.xy);
