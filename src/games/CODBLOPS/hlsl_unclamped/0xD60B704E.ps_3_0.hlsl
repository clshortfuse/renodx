// Mechanically reconstructed from 0xD60B704E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c11 = float4(4.0f, -2.0f, 0.0009765625f, 0.25f);
    ...
    r6.y = dot(r1.xy, r0.zw) + (c3.x);
    r6.x = dot(r1.xy, r0.xy) + (c3.x);
    r1 = tex2D(s6, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r0.xyz = (r0.xyz) + (c16.yyy);
    r2.xyz = (v0.yyy) * (r0.xyz) + (c16.zzz);
    r3.w = r1.w;
    r3.xyz = (r2.xyz) * (c16.www);
    r0 = tex2D(s0, v1.xy);
    r4.xyz = (r2.xyz) * (r0.xyz);
    r2 = tex2D(s4, v7.zw);
    r1.z = (r2.w) * (v0.z) + (c3.y);
    r0 = tex2D(s7, v7.zw);
    r0 = float4(((r1.z) >= 0.0f ? (r0.x) : (r3.x)), ((r1.z) >= 0.0f ? (r0.y) : (r3.y)), ((r1.z) >= 0.0f ? (r0.z) : (r3.z)), ((r1.z) >= 0.0f ? (r0.w) : (r3.w)));
    r2.xyz = float3(((r1.z) >= 0.0f ? (r2.x) : (r4.x)), ((r1.z) >= 0.0f ? (r2.y) : (r4.y)), ((r1.z) >= 0.0f ? (r2.z) : (r4.z)));
    r9.xyz = (r0.xyz) * (-(r0.xyz)) + (c16.zzz);
    r10.xyz = (r0.xyz) * (r0.xyz);
    r6.xy = float2(((r1.z) >= 0.0f ? (r6.x) : (r7.x)), ((r1.z) >= 0.0f ? (r6.y) : (r7.y)));
    ...
    r2.w = r4.y;
    r1.x = (r0.w) * (-(c4.y)) + (c4.z);
    r3.xy = (r2.wy) * (c11.xx) + (c11.yy);
    r2.w = dot(r6.xy, r6.xy) + (c3.x);
    r1.w = dot(r3.xy, r3.xy) + (c3.x);
    r2.w = exp2(-(r2.w));
    r1.w = exp2(-(r1.w));
    r4.w = (r2.w) * (c3.z) + (c3.w);
    r2.w = (r1.w) * (c3.z) + (c3.w);
    r1.w = dot(r3.xy, r6.xy) + (c3.x);
    r2.w = (r4.w) * (r2.w);
    r3 = tex2D(s14, v1.zw);
    r7.xy = (r3.xy) * (c10.ww);
    r1.w = saturate((r1.w) * (r2.w) + (r2.w));
    r4.xy = (r4.xz) * (r7.xx);
    r2.w = (r3.x) * (c10.w) + (-(r4.x));
    r11.xy = (r2.xz) * (r7.yy);
    r2.y = (r4.z) * (-(r7.x)) + (r2.w);
    r2.w = (r3.y) * (c10.w) + (-(r11.x));
    r2.w = (r2.z) * (-(r7.y)) + (r2.w);
    r7.y = (r2.y) + (r2.y);
    r2.y = (r2.w) + (r2.w);
    r3.xyz = v2.xyz;
    ...
    r7.xz = (r4.xy) * (c11.xx);
    r4.z = saturate(dot(r12.xyz, r5.xyz));
    r3.y = (r0.w) * (c4.y);
    ...
    r3.z = (r6.w) * (r1.x) + (r3.y);
    r1.x = (r2.w) * (r1.x) + (r3.y);
    r3.w = pow(abs(r4.z), r1.w);
    r1.x = (r1.x) * (r3.z) + (c11.z);
    ...
    r1.w = (r1.w) * (r1.x);
    r11.xyz = float3(((r1.z) >= 0.0f ? (c[8].x) : (r1.y)), ((r1.z) >= 0.0f ? (c[8].y) : (r1.y)), ((r1.z) >= 0.0f ? (c[8].w) : (r1.y)));
    r0.xyz = (r0.xyz) * (r1.www);
    r15.xyz = (r2.xyz) * (r11.yyy);
    r13.xyz = (r11.zzz) * (r0.xyz);
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c10.x) : (c10.z));
