// Mechanically reconstructed from 0xE28848F3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.z = rsqrt(r0.w);
    r1.z = c1.y;
    r2.xy = (r1.xy) * (c[40].xx) + (r1.zz);
    r0 = tex2D(s0, v1.xy);
    r3.xyz = (r0.xyz) * (v0.xyz);
    r0 = tex2D(s7, r2.xy);
    r0.xyz = (r3.xyz) * (-(r3.xyz)) + (r0.xyz);
    r0.w = (r0.w) + (c3.z);
    r1.xy = (r1.xy) * (c[39].xx) + (r1.zz);
    r1 = tex2D(s6, r1.xy);
    ...
    r1.z = (r5.w) * (r11.y) + (r11.x);
    r11.z = (r3.w) * (r11.y) + (r11.x);
    r5.xyz = (r2.xyz) * (-(r2.xyz)) + (c3.xxx);
    r1.z = (r1.z) * (r11.z) + (c4.w);
    r6.xyz = (r2.xyz) * (r2.xyz);
    r2.z = 1.0f / (r1.z);
    r1.xyz = (r5.xyz) * (r9.www) + (r6.xyz);
    r9.w = (r5.w) * (r2.z);
    r12.w = (-(r3.w)) + (c3.x);
    ...
    r8.y = saturate(dot(r9.xyz, r8.xyz));
    r2.w = 1.0f / (r3.x);
    r2.w = (r3.w) * (r2.w);
    r8.z = exp2(r3.y);
    r3.w = pow(abs(r8.y), r8.z);
    r3.z = (r8.z) * (c13.x) + (c13.y);
    r3.w = (r3.w) * (r3.z);
    r3.y = (r11.w) * (r11.y) + (r11.x);
    r3.y = (r3.y) * (r11.z) + (c4.w);
    r7.z = saturate(dot(r9.xyz, r7.xyz));
    r3.y = 1.0f / (r3.y);
    r3.x = pow(abs(r7.z), r8.z);
    r3.y = (r11.w) * (r3.y);
    r3.z = (r3.z) * (r3.x);
    r7.z = (r3.y) * (r3.z);
    r3.xyz = (r5.xyz) * (r10.www) + (r6.xyz);
    r3.w = (r9.w) * (r3.w);
