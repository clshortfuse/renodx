// Mechanically reconstructed from 0x8248D103.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.w = (r0.w) * (v0.y);
    r7.w = (r1.w) * (r1.z);
    r6.xy = lerp(r2.xy, r1.xy, r4.ww);
    r1 = tex2D(s0, v1.xy);
    r5.xyz = lerp(r1.xyz, r0.xyz, r4.www);
    r3 = tex2D(s7, v1.xy);
    r0 = tex2D(s8, v7.xy);
    r5.w = lerp(r3.y, r0.y, r4.w);
    r1 = tex2D(s6, v7.zw);
    r1.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r2 = (c3.xxxx) * (v9) + (c3.yyyy);
    r1.w = lerp(r3.w, r0.w, r4.w);
    r3.y = dot(r1.xy, r2.zw) + (c3.z);
    r0 = tex2D(s4, v7.zw);
    r4.w = (r0.w) * (v0.z);
    r3.x = dot(r1.xy, r2.xy) + (c3.z);
    r1.xyz = lerp(r5.xyz, r0.xyz, r4.www);
    ...
    r1.xy = (r3.xz) * (r6.xx);
    r0.y = (r2.x) * (c10.w) + (-(r1.x));
    r3.xy = (r0.xz) * (r6.yy);
    r0.y = (r3.z) * (-(r6.x)) + (r0.y);
    r0.x = (r2.y) * (c10.w) + (-(r3.x));
    r0.z = (r0.z) * (-(r6.y)) + (r0.x);
    r7.y = (r0.y) + (r0.y);
    r0.y = (r0.z) + (r0.z);
    r0.xz = (r3.xy) * (c11.xx);
