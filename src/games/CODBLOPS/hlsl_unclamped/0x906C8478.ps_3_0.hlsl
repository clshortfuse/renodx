// Mechanically reconstructed from 0x906C8478.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(-0.5f, 1.0f, 0.0f, 0.25f);
    const float4 c2 = float4(-2.0f, 3.0f, 31.875f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r3.xy = (c[29].zz) * (r3.xy) + (r0.xy);
    r3.z = c1.y;
    r0 = tex2D(s0, v1.xy);
    r2.w = (r0.w) * (v0.w) + (c1.x);
    r0.w = (r1.w) * (r4.w);
    r4.xyz = float3(((r2.w) >= 0.0f ? (r3.x) : (c1.z)), ((r2.w) >= 0.0f ? (r3.y) : (c1.z)), ((r2.w) >= 0.0f ? (r3.z) : (c1.z)));
    r5.xyz = (r1.xyz) * (r0.www);
    r1 = v2;
    r3.xyz = (r4.xxx) * (v5.xyz) + (r1.xyz);
    r1.xyz = (r3.www) * (r5.xyz);
    r5.xyz = (r4.yyy) * (v4.xyz) + (r3.xyz);
