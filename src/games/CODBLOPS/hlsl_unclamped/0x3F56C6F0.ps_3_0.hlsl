// Mechanically reconstructed from 0x3F56C6F0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = dot(r1.xy, r0.xy) + (c4.z);
    r0.y = dot(r1.xy, r0.zw) + (c4.z);
    r1 = tex2D(s3, v6.xy);
    r5.w = (r1.w) * (v0.y);
    ...
    r3.x = dot(r5.xy, r0.xy) + (c4.z);
    r3.y = dot(r5.xy, r0.zw) + (c4.z);
    r0 = tex2D(s4, v6.zw);
    r4.w = (r0.w) * (v0.z);
    r5.xy = lerp(r4.xy, r3.xy, r4.ww);
    r3.xyz = (r2.xyz) * (r2.xyz);
    r2.xyz = v4.xyz;
    r2.xyz = (r5.xxx) * (r2.xyz) + (v2.xyz);
    ...
    r1.w = (r1.w) * (c1.x) + (c1.y);
    r1.xyz = lerp(r6.xyz, r0.xyz, r4.www);
    r0.w = (r0.w) * (r1.w);
