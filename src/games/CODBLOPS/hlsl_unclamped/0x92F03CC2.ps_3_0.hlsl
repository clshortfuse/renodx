// Mechanically reconstructed from 0x92F03CC2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c36 = float4(0.00048828125f, -0.000122070312f, 0.0f, 0.0f);
    ...
    r1.xy = lerp(r3.xy, r2.xy, r6.ww);
    r3 = tex2D(s8, v1.xy);
    r2 = tex2D(s9, v7.xy);
    r0 = tex2D(s5, v7.zw);
    r5.w = (r0.w) * (v0.z);
    r4.w = lerp(r3.y, r2.y, r6.w);
