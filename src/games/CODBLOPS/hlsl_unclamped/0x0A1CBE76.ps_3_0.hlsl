// Mechanically reconstructed from 0x0A1CBE76.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c13 = float4(0.00048828125f, -0.000122070312f, 0.0f, 0.999511719f);
    ...
    r3.w = dot(r4.xzy, c3.yyz);
    r0.xyz = c[22].xyz;
    r0.xyz = (-(r0.xyz)) + (c[23].xyz);
    r1.xyz = (r4.www) * (c[18].xyz);
    r0.xyz = (r8.www) * (r0.xyz) + (c[22].xyz);
    r2.xyz = (r1.xyz) * (r6.www) + (r4.xyz);
    r0.xyz = (r0.xyz) * (r2.xyz);
    r0.w = saturate(c[17].z);
    r0.xyz = (r7.zzz) * (r0.xyz);
    r1.xyz = (r1.xyz) * (r0.www) + (r3.www);
