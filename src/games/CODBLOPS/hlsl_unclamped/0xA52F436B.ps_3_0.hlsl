// Mechanically reconstructed from 0xA52F436B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.y = (r0.z) * (-(r7.x)) + (r0.w);
    r3 = tex2D(s4, v1.xy);
    r7.xy = lerp(r3.yy, c[20].xy, r5.ww);
    r2 = tex2D(s5, v7.zw);
    r0 = tex2D(s2, v7.xy);
    r0.xyz = (r0.xyz) + (c2.xxx);
    r10.xyz = (v0.yyy) * (r0.xyz) + (c2.yyy);
    r0 = v2;
    r0.xyz = (r8.xxx) * (v5.xyz) + (r0.xyz);
    r3.xyz = (r10.xyz) * (c2.zzz);
