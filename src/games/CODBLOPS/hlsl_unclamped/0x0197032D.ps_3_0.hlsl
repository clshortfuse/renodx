// Mechanically reconstructed from 0x0197032D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xy = lerp(r2.yy, c[23].xy, r4.ww);
    ...
    r9.xyz = (v0.yyy) * (r0.xyz) + (c2.zzz);
    r2.xyz = (r9.xyz) * (c2.www);
    r5.w = (r5.w) + (r5.w);
