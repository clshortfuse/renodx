// Mechanically reconstructed from 0x19CAA419.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xy = lerp(r6.xy, r5.xy, r5.ww);
    r3.xyz = lerp(r4.xyz, r1.xyz, r5.www);
    r0.w = dot(r7.xy, r7.xy) + (c3.z);
    r5.xyz = (r3.xyz) * (r3.xyz);
    r0.w = exp2(-(r0.w));
    r4.w = (r0.w) * (c12.x) + (c12.y);
    r3.xyz = float3(((r6.w) >= 0.0f ? (r0.y) : (c[39].x)), ((r6.w) >= 0.0f ? (r0.y) : (c[39].y)), ((r6.w) >= 0.0f ? (r0.y) : (c[39].w)));
    r1 = tex2D(s11, v7.zw);
    r0 = lerp(r2, r1, r5.wwww);
    r13.xyz = lerp(r3.xyz, c[40].xyw, r5.www);
    r1.xy = (v1.zw) * (-(c3.yw));
    r3 = tex2D(s13, r1.xy);
