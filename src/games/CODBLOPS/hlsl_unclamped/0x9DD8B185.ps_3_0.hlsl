// Mechanically reconstructed from 0x9DD8B185.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s1, v6.zw);
    r1.w = (r1.w) * (v6.y) + (c1.x);
    r7.xy = float2(((r1.w) >= 0.0f ? (r0.x) : (c1.y)), ((r1.w) >= 0.0f ? (r0.y) : (c1.y)));
    r0 = v1;
    ...
    r2 = tex2D(s3, v6.zw);
    r2.xyz = (r2.wwy) * (c1.yzz) + (c1.wyy);
    r2.w = (-(r3.w)) + (c1.z);
    r5.xyz = float3(((r1.w) >= 0.0f ? (r2.x) : (c1.y)), ((r1.w) >= 0.0f ? (r2.y) : (c1.z)), ((r1.w) >= 0.0f ? (r2.z) : (c1.z)));
    r2.y = (r2.w) * (r2.w);
    r2.z = (r5.y) * (c4.x) + (c4.y);
    r2.w = (r2.w) * (r2.y);
    r2.z = 1.0f / (r2.z);
