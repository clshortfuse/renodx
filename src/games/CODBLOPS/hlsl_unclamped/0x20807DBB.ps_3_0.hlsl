// Mechanically reconstructed from 0x20807DBB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c10 = float4(0.600000024f, 0.400000006f, 3.5f, 1.0f);
    const float4 c11 = float4(2.0f, -1.0f, 1.0f, 0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r1 = (c11.xxxx) * (v7) + (c11.yyyy);
    r4.x = dot(r2.xy, r1.xy) + (c2.x);
    r4.y = dot(r2.xy, r1.zw) + (c2.x);
    r1 = tex2D(s3, v6.zw);
    r6.w = (r1.w) * (v0.z);
    r2.xy = (r0.yw) * (c4.xx) + (c4.yy);
    r5.xy = lerp(r6.xy, r4.xy, r6.ww);
    r0.y = dot(r2.xy, r2.xy) + (c2.x);
    ...
    r0 = tex2D(s2, v6.xy);
    r0.xyz = (r0.xyz) + (c11.yyy);
    r0.w = (r1.w) + (r1.w);
    r6.xyz = (v0.yyy) * (r0.xyz) + (c11.zzz);
    r2.xyz = (r9.xyz) * (-(r0.www)) + (r8.xyz);
    r4.xyz = (r6.xyz) * (c11.www);
    r7.w = saturate(dot(r9.xyz, -(r8.xyz)));
    r0 = lerp(r4, r3, r6.wwww);
    r1.w = dot(c[5].xyz, r8.xyz);
    r2.w = (r0.w) * (c2.w);
