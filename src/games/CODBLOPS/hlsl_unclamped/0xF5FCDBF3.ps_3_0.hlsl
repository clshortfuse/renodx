// Mechanically reconstructed from 0xF5FCDBF3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyw = c[32].xyw;
    r1.xyz = (-(r0.xyw)) + (c[33].xyw);
    r0 = tex2D(s6, v7.zw);
    r4.w = (r0.w) * (v0.z);
    r4.xyz = (r3.www) * (r1.xyz) + (c[32].xyw);
    r3.xyz = lerp(r5.xyz, r0.xyz, r4.www);
    r1 = tex2D(s10, v7.zw);
    r0 = lerp(r2, r1, r4.wwww);
    r5.xy = (r4.ww) * (-(r6.xy)) + (r6.xy);
    r14.xyz = lerp(r4.xyz, c[34].xyw, r4.www);
    r1.w = dot(r5.xy, r5.xy) + (c4.z);
