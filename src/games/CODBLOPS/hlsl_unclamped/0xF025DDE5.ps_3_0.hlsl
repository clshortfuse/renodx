// Mechanically reconstructed from 0xF025DDE5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.y = dot(r2.xy, r0.zw) + (c1.z);
    r3.x = dot(r2.xy, r0.xy) + (c1.z);
    r0.xy = (v0.zw) * (-(c1.yw));
    r2 = tex2D(s13, r0.xy);
    r0 = tex2D(s5, v7.zw);
    r4.w = (r0.w) * (v7.y) + (c1.w);
    ...
    r1 = tex2D(s13, r1.xy);
    r2.w = r1.y;
    r6.xy = float2(((r4.w) >= 0.0f ? (r3.x) : (r4.x)), ((r4.w) >= 0.0f ? (r3.y) : (r4.y)));
    r5.xy = (r2.yw) * (c4.yy) + (c4.zz);
    r13.w = rsqrt(r3.w);
    r0.w = dot(r5.xy, r6.xy) + (c1.z);
    r3 = tex2D(s14, v0.zw);
    r7.xy = (r3.xy) * (c4.xx);
    r2.xy = (r2.xz) * (r7.xx);
    r4.xy = (r1.xz) * (r7.yy);
    ...
    r0.z = (r1.w) * (r1.z);
    r5.w = saturate(dot(r14.xyz, r2.xyz));
    r1 = tex2D(s8, v7.zw);
    r2 = tex2D(s7, v0.xy);
    ...
    r0.x = 1.0f / (r0.y);
    r9.w = exp2(r17.y);
    r0.y = pow(abs(r5.w), r9.w);
    r7.w = (r9.w) * (c12.z) + (c12.w);
    r1.x = (r1.z) * (r0.x);
    r1.y = (r0.y) * (r7.w);
    ...
    r2.xyw = c[30].xyw;
    r13.xyz = float3(((r4.w) >= 0.0f ? (r2.x) : (c[29].x)), ((r4.w) >= 0.0f ? (r2.y) : (c[29].y)), ((r4.w) >= 0.0f ? (r2.w) : (c[29].w)));
    r2.xyz = (r0.xyz) * (r13.zzz);
    r1.xyz = (r1.zzz) * (c[6].xyz);
    r0.xyz = (r10.xyz) * (r3.www) + (r3.xyz);
