// Mechanically reconstructed from 0xA7739A3D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.x = dot(r2.xy, r0.xy) + (c15.w);
    r4.y = dot(r2.xy, r0.zw) + (c15.w);
    r0 = tex2D(s3, v6.zw);
    r4.w = (r0.w) * (v0.z) + (c2.x);
    ...
    r7.xyz = float3(((r4.w) >= 0.0f ? (r1.y) : (c[23].x)), ((r4.w) >= 0.0f ? (r1.y) : (c[23].y)), ((r4.w) >= 0.0f ? (r1.y) : (c[23].w)));
