// Mechanically reconstructed from 0x7531B9F6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = exp2(-(r0.w));
    r3.z = (r11.x) * (-(c12.z)) + (c12.w);
    r3.w = (r0.w) * (c10.x) + (c10.y);
    ...
    r4.xy = (r2.xz) * (r8.xx);
    r0.y = (r1.x) * (c10.w) + (-(r4.x));
    r5.xy = (r0.xz) * (r8.yy);
    r0.x = (r2.z) * (-(r8.x)) + (r0.y);
    r0.y = (r1.y) * (c10.w) + (-(r5.x));
    r0.y = (r0.z) * (-(r8.y)) + (r0.y);
