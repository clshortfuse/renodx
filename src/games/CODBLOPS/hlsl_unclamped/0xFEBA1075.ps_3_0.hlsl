// Mechanically reconstructed from 0xFEBA1075.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.w = (r3.w) * (v0.y);
    r0.w = r4.y;
    r2.xy = (r7.ww) * (-(r1.xy)) + (r1.xy);
    r1 = tex2D(s3, v7.zw);
    r3.w = (r1.w) * (v0.z);
    r7.xy = (r0.yw) * (c12.xx) + (c12.yy);
    r5.xy = (r3.ww) * (-(r2.xy)) + (r2.xy);
    ...
    r2.w = (r0.z) * (-(r6.x)) + (r0.w);
    r0.xyw = c[20].xyw;
    r0.xyz = (-(r0.xyw)) + (c[21].xyw);
    r8.y = (r2.w) + (r2.w);
    r2.xyz = (r7.www) * (r0.xyz) + (c[20].xyw);
    r0.xyz = (r8.xyz) * (r1.www) + (r4.xyz);
    r7.xyz = lerp(r2.xyz, c1.xxx, r3.www);
    ...
    r0.xyz = lerp(r13.xyz, r1.xyz, r3.www);
