// Mechanically reconstructed from 0xC359E955.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = (r0.z) + (r0.z);
    r12.yz = c1.yz;
    r6.xyz = float3(((r4.w) >= 0.0f ? (r12.y) : (c[36].x)), ((r4.w) >= 0.0f ? (r12.z) : (c[36].y)), ((r4.w) >= 0.0f ? (r12.y) : (c[36].w)));
    r1 = tex2D(s5, v7.zw);
    r2.w = (r1.w) * (v0.z) + (c1.x);
    r0.xyz = (r8.xyz) * (r0.www) + (r7.xyz);
    r11.xyz = float3(((r2.w) >= 0.0f ? (c1.y) : (r6.x)), ((r2.w) >= 0.0f ? (c1.z) : (r6.y)), ((r2.w) >= 0.0f ? (c1.y) : (r6.z)));
