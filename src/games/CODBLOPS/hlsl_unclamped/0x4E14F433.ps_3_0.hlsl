// Mechanically reconstructed from 0x4E14F433.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyz = (v0.yyy) * (r1.xyz) + (c4.yyy);
    r1.xyz = (r0.xyz) * (r3.xyz);
    r0 = tex2D(s3, v7.zw);
    r2.xyz = (r0.xyz) + (c4.xxx);
    r0.xyz = (r3.xyz) * (c4.zzz);
    r2.xyz = (v0.zzz) * (r2.xyz) + (c4.yyy);
    ...
    r1.w = dot(r12.xy, r12.xy) + (c4.w);
    r1.z = dot(r4.xy, r4.xy) + (c4.w);
    r1.w = exp2(-(r1.w));
    r1.z = exp2(-(r1.z));
    r1.w = (r1.w) * (c1.x) + (c1.y);
    r1.x = (r1.z) * (c1.x) + (c1.y);
    r1.z = dot(r4.xy, r12.xy) + (c4.w);
    r1.x = (r1.w) * (r1.x);
    r4 = tex2D(s14, v1.zw);
    r13.xy = (r4.xy) * (c2.ww);
