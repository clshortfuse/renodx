// Mechanically reconstructed from 0x932F30D4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = rsqrt(r0.z);
    r3.xyz = (r3.www) * (v7.xyz);
    r2.xyz = (r1.xyz) * (r0.zzz) + (-(r3.xyz));
    r4.xyz = normalize(r2.xyz);
    r2.xyz = (r1.xyz) * (r0.zzz);
    r0.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r0.w = saturate(dot(r4.xyz, r2.xyz));
    r1.xy = (c[38].zz) * (r5.xy) + (r0.xy);
    r1.w = (-(r0.w)) + (c1.y);
    r7.w = dot(r2.xyz, c[30].xyz);
    r1.z = (r1.w) * (r1.w);
    r0 = tex2D(s0, v1.xy);
    r4.w = (r0.w) * (v0.w) + (c1.x);
    r0.w = (r1.z) * (r1.z);
    r5.xy = float2(((r4.w) >= 0.0f ? (r1.x) : (c1.z)), ((r4.w) >= 0.0f ? (r1.y) : (c1.z)));
    r5.w = (r1.w) * (r0.w);
    r1 = v2;
    ...
    r6.w = exp2(r2.y);
    r2.y = pow(abs(r4.z), r6.w);
    r5.z = (r6.w) * (c12.x) + (c12.y);
    r2.z = (r2.z) + (r2.z);
    r2.y = (r2.y) * (r5.z);
    r2.x = 1.0f / (r2.x);
    r2.y = (r6.y) * (r2.y);
    ...
    r11.xyz = (r14.xyz) * (r6.zzz) + (r15.xyz);
    r2 = tex3D(s11, v8.xyz);
    r0.xyz = (r2.xyz) * (r2.xyz);
    r3.xyz = (v7.xyz) * (-(r3.www)) + (c[17].xyz);
    ...
    r2.y = (r2.y) * (r2.y);
    r10.w = (r2.z) * (r2.y);
    r3.w = dot(r9.xyz, c[17].xyz);
    r2.y = saturate(dot(r9.xyz, r0.xyz));
    r2.z = saturate(r3.w);
    r0.y = pow(abs(r2.y), r6.w);
    r0.z = (r2.z) * (r5.y) + (r5.x);
    r3.z = (r5.z) * (r0.y);
    r0.z = (r0.z) * (r5.w) + (c3.w);
    r2.y = 1.0f / (r0.z);
    ...
    r0.xyz = (r2.xyz) * (r2.xyz);
    r16.yz = c1.yz;
    r7.xyz = float3(((r4.w) >= 0.0f ? (c[37].x) : (r16.z)), ((r4.w) >= 0.0f ? (c[37].y) : (r16.z)), ((r4.w) >= 0.0f ? (c[37].w) : (r16.z)));
    r9.w = (r3.z) * (r3.y);
    r0.xyz = (r0.xyz) * (r7.yyy);
    r12.xyz = (abs(r3.www)) * (c[18].xyz);
