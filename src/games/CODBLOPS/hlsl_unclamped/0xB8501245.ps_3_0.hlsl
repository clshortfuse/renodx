// Mechanically reconstructed from 0xB8501245.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = (r0.z) * (r3.w) + (r3.z);
    r3.w = (r0.x) * (r3.w) + (r3.z);
    r7.xyz = lerp(c[36].xyw, r3.yyy, r8.www);
    r0.y = (r0.y) * (r3.w) + (c4.x);
    r5.w = (-(r0.x)) + (-(c13.y));
    r0.y = 1.0f / (r0.y);
    r4.w = (r0.z) * (r0.y);
