// Mechanically reconstructed from 0x2D9A2FB1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xy = (r2.xy) * (r3.xy);
    r2.xyw = c[26].xyw;
    r4.xyz = float3(((r4.w) >= 0.0f ? (r2.x) : (c[25].x)), ((r4.w) >= 0.0f ? (r2.y) : (c[25].y)), ((r4.w) >= 0.0f ? (r2.w) : (c[25].w)));
    r0.w = (r0.w) * (r3.x);
