// Mechanically reconstructed from 0x3C15DF3E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xyz = (r3.xyz) * (r6.xxx);
    r10.xy = (c[38].zz) * (r10.xy) + (r0.xy);
    r3.xyz = (r2.xyz) * (r2.xyz);
    r0 = v2;
    r0.xyz = (r10.xxx) * (v5.xyz) + (r0.xyz);
    r2.xyz = (r2.xyz) * (-(r2.xyz)) + (c2.xxx);
    r12.xyz = (r10.yyy) * (v4.xyz) + (r0.xyz);
