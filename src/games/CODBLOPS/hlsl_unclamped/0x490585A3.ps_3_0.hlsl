// Mechanically reconstructed from 0x490585A3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyz = (r5.www) * (v7.xyz);
    r7.xyz = normalize(r2.xyz);
    r2.xyz = (r0.xyz) * (r2.www) + (-(r3.xyz));
    ...
    r0.y = (r0.z) * (r0.z);
    r4.w = (r0.z) * (r0.y);
    r0.z = dot(r3.xyz, r10.xyz);
    r0.z = (r0.z) + (r0.z);
    r0.xy = (r0.ww) * (c15.xy) + (c15.zw);
    r9.w = exp2(r0.y);
    r7.w = saturate(dot(r10.xyz, r8.xyz));
    r0.y = pow(abs(r7.w), r9.w);
    ...
    r4.xyz = (r6.xyz) * (r1.xyz) + (r4.xyz);
    r1 = (v7.yyyy) * (c[32]);
    r8.xyz = (r3.xyz) * (c1.www) + (r4.xyz);
    r1 = (v7.xxxx) * (c[31]) + (r1);
