// Mechanically reconstructed from 0x19CA6666.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.w = (r1.w) * (-(c12.x)) + (c12.y);
    r13.w = (r1.w) * (c3.w);
    r6.w = saturate(dot(r2.xyz, r13.xyz));
    r15.w = saturate(dot(r13.xyz, -(r14.xyz)));
    r0.z = (r6.w) * (r12.w) + (r13.w);
