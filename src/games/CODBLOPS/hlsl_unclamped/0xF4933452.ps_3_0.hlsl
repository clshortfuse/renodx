// Mechanically reconstructed from 0xF4933452.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.z = (r2.z) * (-(r6.y)) + (r2.w);
    r6.y = (r0.w) + (r0.w);
    r0.w = dot(r9.xy, r9.xy) + (c35.z);
    r2.w = dot(r7.xy, r7.xy) + (c35.z);
    r0.w = exp2(-(r0.w));
    r2.w = exp2(-(r2.w));
    r0.w = (r0.w) * (c3.x) + (c3.y);
    r2.w = (r2.w) * (c3.x) + (c3.y);
    ...
    r0 = tex2D(s9, v7.xy);
    r14.xyz = lerp(c[32].xyw, r0.yyy, r5.www);
    r13.xyz = (r1.xyz) * (r14.yyy);
    r1 = (r0.wwww) * (-(c35.zzzy)) + (-(c35.wwwz));
    r2 = tex2D(s8, v1.xy);
