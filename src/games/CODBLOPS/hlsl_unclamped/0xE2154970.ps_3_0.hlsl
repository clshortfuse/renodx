// Mechanically reconstructed from 0xE2154970.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.x = dot(r2.xy, r1.xy) + (c13.z);
    r4.y = dot(r2.xy, r1.zw) + (c13.z);
    r1 = tex2D(s2, v6.zw);
    r8.w = (r1.w) * (v6.y);
    ...
    r7.xyz = lerp(c[20].xyw, r2.yyy, r8.www);
