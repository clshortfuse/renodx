// Mechanically reconstructed from 0x2A84C8F3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = (v0.zw) * (c4.xz);
    r2 = tex2D(s13, r2.xy);
    r3.xy = (v0.zw) * (c4.xz) + (c4.wz);
    r4 = tex2D(s13, r3.xy);
    r2.w = r4.y;
    r5.xyz = (r0.xyz) * (v6.yyy);
    r0.xy = (r2.yw) * (c2.yy) + (c2.zz);
    r3 = tex2D(s1, v0.xy);
    r6.xy = (r3.wy) * (c0.xy) + (c0.zw);
    r0.z = dot(r0.xy, r0.xy) + (c1.x);
