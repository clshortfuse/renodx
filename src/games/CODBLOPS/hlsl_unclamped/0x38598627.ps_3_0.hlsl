// Mechanically reconstructed from 0x38598627.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (r2.w) * (r2.w);
    r12.xyz = (v0.yyy) * (r0.xyz) + (c13.yyy);
    r4.w = (r1.w) * (r0.w);
    r4.xyz = (r12.xyz) * (c13.zzz);
    r0 = tex2D(s4, v8.zw);
    r3.xyz = (r0.xyz) + (c13.xxx);
    r0 = tex2D(s1, v1.xy);
    r8.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r6.xyz = (v0.zzz) * (r3.xyz) + (c13.yyy);
    r0 = v2;
