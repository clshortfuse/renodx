// Mechanically reconstructed from 0xB367E9FE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = (r4.w) * (c14.z) + (c14.w);
    r1.y = (r11.x) * (c3.w);
    r0.z = (r11.x) * (-(c14.x)) + (c14.y);
    r0.x = (r3.w) * (r0.z) + (r1.y);
    r0.z = (r1.w) * (r0.z) + (r1.y);
    r0.y = (r1.z) * (r0.y);
