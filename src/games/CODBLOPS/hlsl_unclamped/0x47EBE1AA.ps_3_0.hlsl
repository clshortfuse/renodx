// Mechanically reconstructed from 0x47EBE1AA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xyz = (r3.www) * (c[32].xyz);
    r2.w = saturate(dot(r0.xyz, r4.xyz));
    r8.xyz = (r11.xyz) * (r2.xyz) + (r3.xyz);
    r4.z = (-(r2.w)) + (c1.y);
    ...
    r2.y = 1.0f / (r2.z);
    r5.w = exp2(r3.y);
    r2.z = pow(abs(r4.w), r5.w);
    r4.w = (r5.w) * (c4.y) + (c4.z);
    r3.y = (r3.w) * (r2.y);
    r3.w = (r2.z) * (r4.w);
    r2.xyz = (r4.xyz) * (r9.www) + (r5.xyz);
    r3.w = (r3.y) * (r3.w);
    r10.w = (-(r3.z)) + (c1.y);
