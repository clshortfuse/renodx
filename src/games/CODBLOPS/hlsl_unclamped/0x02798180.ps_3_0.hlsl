// Mechanically reconstructed from 0x02798180.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.w = lerp(r2.z, r0.w, r2.w);
    r9.xyz = (r1.xyz) * (r1.xyz);
    r10.w = (r7.w) * (-(c13.z)) + (c13.w);
