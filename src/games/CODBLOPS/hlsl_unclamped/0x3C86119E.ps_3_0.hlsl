// Mechanically reconstructed from 0x3C86119E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    float4 v6 = input.v6;
    float4 v7 = input.v7;
    const float4 c0 = float4(2.0f, -1.0f, 31.875f, 0.178571001f);
    ...
    const float4 c14 = float4(2.22222233f, 3.125f, 3.4482758f, 4.33290005f);
    const float4 c15 = float4(4.54519987f, 5.88230991f, 0.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r1 = tex2D(s8, r1.xy);
    r4 = tex2D(s6, v4.xy);
    r1.xzw = (r4.xyz) * (c1.www) + (-(r3.xyz));
    r1.xyz = (r1.yyy) * (r1.xzw) + (r3.xyz);
    r0.xyz = (r0.xyz) * (r1.xyz);
    r1.xyz = max(r0.xyz, c1.xxx);
    r0.xyz = (r1.xyz) * (c0.www);
    r0.w = (-(r0.w)) + (c1.z);
    r3.xyz = saturate((r0.www) * (c14.xyz));
    r0.w = pow(abs(r3.x), c14.w);
    r2.xyz = (r1.xyz) * (-(c0.www)) + (r2.xyz);
    r0.xyz = (r0.www) * (r2.xyz) + (r0.xyz);
    r2 = tex2D(s10, v4.xy);
    r0.w = saturate((r2.x) * (c12.y));
    r1.w = c[30].w;
    r2.xy = (r1.ww) * (c[40].xy);
    r2.xy = (r2.xy) * (c[39].xx);
    ...
    r0.w = pow(abs(r3.y), c15.x);
    r3.xyw = lerp(r2.xyz, r0.xyz, r0.www);
    r0.x = pow(abs(r3.z), c15.y);
    r2.xyz = lerp(r1.xyz, r3.xyw, r0.xxx);
    r2.w = c1.z;
    r0.x = dot(r2, c[32]);
    r0.y = dot(r2, c[33]);
    r0.z = dot(r2, c[34]);
