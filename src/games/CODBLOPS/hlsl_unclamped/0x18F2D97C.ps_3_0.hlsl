// Mechanically reconstructed from 0x18F2D97C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c35 = float4(1.16412354f, 1.59579468f, -0.87065506f, 0.600000024f);
    const float4 c36 = float4(1.16412354f, -0.813476562f, -0.391448975f, 0.529705048f);
    const float4 c37 = float4(81.2394867f, 17.3480244f, 37.3498383f, 59.3948402f);
    const float4 c38 = float4(9.99999994e-09f, 0.0f, 0.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r2.y = c14.w;
    r3 = tex2D(s7, r2.yz);
    r2.y = (r3.x) * (-(c18.x)) + (v3.x);
    r2.y = (r2.y) * (c18.y) + (-(v3.x));
    r2.y = (c[27].x) * (r2.y) + (v3.x);
    r2.w = frac(abs(v3.y));
    ...
    r3.z = (r3.y) + (-(r3.w));
    r3.xy = (r3.xz) * (c16.yx);
    r3.xy = (r2.yz) * (c16.xx) + (r3.xy);
    r4 = tex2D(s3, r3.xy);
    r5 = tex2D(s4, r3.xy);
    r3 = tex2D(s5, r3.xy);
    r4.xw = (r4.xx) * (c3.xy) + (c3.zx);
    r4.y = r5.x;
    r3.y = dot(c35.xyz, r4.xyw);
    r4.z = r3.x;
    r3.z = dot(c36, r4);
    r3.w = dot(c15.xyz, r4.xzw);
    r3.xyz = (r3.yzw) * (c[33].xxx);
    r4.xy = lerp(c[9].xy, c[9].zw, r2.yz);
    r4 = tex2D(s2, r4.xy);
    ...
    r3.x = c15.w;
    r3 = tex2D(s7, r3.xy);
    r2.w = saturate((r3.x) * (c[25].x));
    r3.x = 1.0f / (c[26].x);
    r3.y = 1.0f / (c[26].y);
    r3.z = dot(r0.wwww, c37);
    r4.x = frac(r3.z);
    r4.w = c[7].w;
    r3.z = dot(r4.xwww, c37);
    r4.y = frac(r3.z);
    r3.z = dot(r4.xyww, c37);
    r4.z = frac(r3.z);
    r3.z = dot(r4, c37);
    r4.w = frac(r3.z);
    r3.z = dot(r4, c37);
    ...
    r2.x = pow(abs(r0.w), c[31].x);
    r3.x = c3.x;
    r0.w = (r2.x) * (-(c[30].x)) + (r3.x);
    r2.xyz = lerp(c[29].xyz, r4.xyz, r0.www);
