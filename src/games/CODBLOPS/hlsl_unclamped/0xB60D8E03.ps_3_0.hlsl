// Mechanically reconstructed from 0xB60D8E03.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s3, v7.xy);
    r5.w = (r0.w) * (v0.y) + (c3.w);
    r8.xy = (r1.yw) * (c12.yy) + (c12.zz);
    r6.xy = float2(((r5.w) >= 0.0f ? (r2.x) : (r6.x)), ((r5.w) >= 0.0f ? (r2.y) : (r6.y)));
    ...
    r8.y = (r1.w) + (r1.w);
    r2.xyz = (r6.yyy) * (v3.xyz) + (r1.xyz);
    r1.xyz = (r8.xyz) * (r0.www) + (r3.xyz);
    r9.xyz = normalize(r2.xyz);
    r2.xyw = c[32].xyw;
    r3.xyz = float3(((r5.w) >= 0.0f ? (r2.x) : (c[31].x)), ((r5.w) >= 0.0f ? (r2.y) : (c[31].y)), ((r5.w) >= 0.0f ? (r2.w) : (c[31].w)));
