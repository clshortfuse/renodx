// Mechanically reconstructed from 0xBCF6458C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r0.w) * (r0.w);
    r9.xyz = (r1.xyz) * (-(r1.xyz)) + (-(c3.yyy));
    r1.w = (r1.w) * (r1.w);
    r11.w = (r12.z) * (-(c13.x)) + (c13.y);
    r2.w = (r0.w) * (r1.w);
