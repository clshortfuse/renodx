// Mechanically reconstructed from 0x33FF098B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c47 = float4(0.144999996f, 0.240400001f, 1.24039996f, 0.0133333337f);
    const float4 c48 = float4(1.16412354f, -0.813476562f, -0.391448975f, 0.529705048f);
    const float4 c49 = float4(1.16412354f, 2.01782227f, -1.08166885f, 0.600000024f);
    const float4 c50 = float4(81.2394867f, 17.3480244f, 37.3498383f, 59.3948402f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r2.y = c47.x;
    r3 = tex2D(s8, r2.yz);
    r2.y = (r3.x) * (-(c47.y)) + (v3.x);
    r2.y = (r2.y) * (c47.z) + (-(v3.x));
    r2.y = (c[40].x) * (r2.y) + (v3.x);
    r2.w = frac(abs(v3.y));
    ...
    r2.w = (r2.w) + (r3.x);
    r2.y = saturate(r2.y);
    r3.xy = lerp(c[31].xy, c[31].zw, r2.yz);
    r4 = tex2D(s4, r3.xy);
    r5 = tex2D(s5, r3.xy);
    r3 = tex2D(s6, r3.xy);
    ...
    r4.z = r3.x;
    r3.z = dot(c48, r4);
    r3.w = dot(c49.xyz, r4.xzw);
    r3.xyz = (r3.yzw) * (c[46].xxx);
    ...
    r3.x = c16.x;
    r3 = tex2D(s8, r3.xy);
    r2.w = saturate((r3.x) * (c[38].x));
    r3.x = 1.0f / (c[39].x);
    r3.y = 1.0f / (c[39].y);
    r3.z = dot(r0.wwww, c50);
    r4.x = frac(r3.z);
    r4.w = c[30].w;
    r3.z = dot(r4.xwww, c50);
    r4.y = frac(r3.z);
    r3.z = dot(r4.xyww, c50);
    r4.z = frac(r3.z);
    r3.z = dot(r4, c50);
    r4.w = frac(r3.z);
    r3.z = dot(r4, c50);
    ...
    r2.x = pow(abs(r0.w), c[44].x);
    r2.z = c0.z;
    r0.w = (r2.x) * (-(c[43].x)) + (r2.z);
    r2.xyz = lerp(c[42].xyz, r4.xyz, r0.www);
