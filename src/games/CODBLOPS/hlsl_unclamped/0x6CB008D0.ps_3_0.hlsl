// Mechanically reconstructed from 0x6CB008D0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = rsqrt(r0.w);
    r5.w = (r2.w) * (c0.z);
    r3.xyz = (r1.xxx) * (v3.xyz);
    r4.w = (r2.w) * (-(c0.z)) + (c0.y);
    r0.w = saturate(dot(r11.xyz, -(r3.xyz)));
    r3.w = (r0.w) * (r4.w) + (r5.w);
    r1.z = (r1.w) * (r4.w) + (r5.w);
    r8.xyz = (v3.xyz) * (-(r1.xxx)) + (c[17].xyz);
    r1.z = (r1.z) * (r3.w) + (c3.x);
    r1.z = 1.0f / (r1.z);
    r4.xyz = normalize(r8.xyz);
    r1.x = (r1.w) * (r1.z);
    r6.w = saturate(dot(r11.xyz, r4.xyz));
    ...
    r1 = tex2D(s0, v0.xy);
    r2.xyz = lerp(r1.xyz, r0.xyz, r10.www);
    r2.xyz = (r2.xyz) * (r2.xyz);
    r0.z = dot(r3.xyz, r11.xyz);
    r4.xyz = (r2.xyz) * (r4.xyz) + (r13.xyz);
    r0.z = (r0.z) + (r0.z);
    r0.xyz = (r11.xyz) * (-(r0.zzz)) + (r3.xyz);
