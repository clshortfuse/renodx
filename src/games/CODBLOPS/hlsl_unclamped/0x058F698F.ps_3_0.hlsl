// Mechanically reconstructed from 0x058F698F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xyz = float3(((r5.w) >= 0.0f ? (c[20].x) : (r0.y)), ((r5.w) >= 0.0f ? (c[20].y) : (r0.y)), ((r5.w) >= 0.0f ? (c[20].w) : (r0.y)));
    ...
    r0.y = (r0.z) * (r0.y) + (r2.z);
    r0.y = (r0.y) * (r2.w) + (c4.x);
    r12.xyz = (r0.zzz) * (c[18].xyz);
    r0.y = 1.0f / (r0.y);
    r4.xyz = (v6.xyz) * (-(r0.xxx)) + (c[17].xyz);
    r2.x = (r0.z) * (r0.y);
