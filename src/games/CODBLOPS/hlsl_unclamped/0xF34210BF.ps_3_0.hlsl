// Mechanically reconstructed from 0xF34210BF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(0.600000024f, 0.400000006f, 3.5f, 1.0f);
    ...
    r5.xy = lerp(r6.xy, r0.xy, r1.ww);
    r0.w = dot(r4.xy, r4.xy) + (c2.z);
    r0.z = dot(r5.xy, r5.xy) + (c2.z);
    r0.w = exp2(-(r0.w));
    r0.z = exp2(-(r0.z));
    r0.w = (r0.w) * (c1.x) + (c1.y);
    r6.w = (r0.z) * (c1.x) + (c1.y);
