// Mechanically reconstructed from 0xF77B543A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (-(r1.w)) + (c1.y);
    r14.xyz = (v0.yyy) * (r0.xyz) + (c1.yyy);
    r0 = tex2D(s4, v8.zw);
    r0.xyz = (r0.xyz) + (c1.xxx);
    r4.xyz = (r14.xyz) * (c1.zzz);
    r13.xyz = (v0.zzz) * (r0.xyz) + (c1.yyy);
    r0 = tex2D(s5, v9.xy);
    r1.xyz = (r0.xyz) + (c1.xxx);
    r0.xyz = (r4.xyz) * (r13.xyz);
    ...
    r15.xyz = (r1.yyy) * (r2.xyz);
    r17.xyz = (r1.yyy) * (r0.xyz);
    r2 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r2.y)) >= 0.0f ? (c1.y) : (c1.w));
    r16.xyz = (r1.xxx) * (c[18].xyz);
    if ((r0.z) != (-(r0.z)))
    {
        r0.z = r2.y;
        r1.x = r0.z;
    ...
    r3.xyz = (r1.xxx) * (r16.xyz) + (r17.xyz);
    r4.xyz = (r15.xyz) * (c[19].xyz);
    r2 = tex2D(s0, v1.xy);
    r0.xyz = (r14.xyz) * (r2.xyz);
