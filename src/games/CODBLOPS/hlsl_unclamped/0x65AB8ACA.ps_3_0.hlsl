// Mechanically reconstructed from 0x65AB8ACA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = float4(((r5.w) >= 0.0f ? (r1.x) : (c1.z)), ((r5.w) >= 0.0f ? (r1.y) : (c1.z)), ((r5.w) >= 0.0f ? (r1.z) : (c1.z)), ((r5.w) >= 0.0f ? (r1.w) : (c1.z)));
