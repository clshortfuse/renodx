// Mechanically reconstructed from 0xC44E6392.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s5, v7.zw);
    r3.w = (r1.w) * (v7.y);
    r5.xy = lerp(r0.xy, r2.xy, r3.ww);
    r1.w = (r1.w) * (-(v7.y)) + (c32.w);
    r0 = tex2D(s0, v0.xy);
    r2.xyz = lerp(r0.xyz, r1.xyz, r3.www);
    r0.w = (r0.w) * (-(v7.x)) + (c32.w);
    r6.w = (r0.w) * (-(r1.w)) + (c32.w);
    r0.w = dot(r5.xy, r5.xy) + (c32.z);
    ...
    r9.xz = (r3.xy) * (c12.xx);
    r1.w = (r1.w) * (r1.w);
    r3.xyz = (r9.xyz) * (r3.zzz) + (r0.xyz);
    r7.w = (r0.w) * (r1.w);
    r1 = tex2D(s7, v0.xy);
    r0.xyz = (-(v6.xyz)) + (c[5].xyz);
    r0.w = dot(r0.xyz, r0.xyz);
    r0.w = rsqrt(r0.w);
    r15.xyz = (r4.www) * (v6.xyz);
    r2.xyz = (r0.xyz) * (r0.www) + (-(r15.xyz));
    ...
    r0 = tex2D(s8, v7.zw);
    r0 = (r2) + (r0);
    r2 = (r1.wwww) * (c1.yyyz) + (c1.wwwy);
    r4.w = (r1.z) * (r1.x);
    r0 = (r3.wwww) * (r0) + (r2);
    r10.xyz = (r0.xyz) * (-(r0.xyz)) + (c32.www);
    r2.xyz = v1.xyz;
    r2.xyz = (r5.xxx) * (v4.xyz) + (r2.xyz);
    r11.xyz = (r0.xyz) * (r0.xyz);
    r0.xyz = (r5.yyy) * (v3.xyz) + (r2.xyz);
    r12.w = (r0.w) * (-(c12.z)) + (c12.w);
    r13.xyz = normalize(r0.xyz);
    r1.z = saturate(dot(r13.xyz, r4.xyz));
    r13.w = (r0.w) * (c3.w);
    r1.w = saturate(dot(r8.xyz, r13.xyz));
    r14.w = saturate(dot(r13.xyz, -(r15.xyz)));
    r0.z = (r1.w) * (r12.w) + (r13.w);
    r11.w = (r14.w) * (r12.w) + (r13.w);
    r0.z = (r0.z) * (r11.w) + (c13.x);
    r18.xy = (r0.ww) * (c31.xy) + (c31.zw);
    r0.y = 1.0f / (r0.z);
    r10.w = exp2(r18.y);
    ...
    r1.z = (r1.x) * (r1.z);
    r12.xyz = lerp(r1.yyy, c[29].xyw, r3.www);
    r0.xyz = (r0.xyz) * (r1.zzz);
    r17.xyz = (r3.xyz) * (r12.yyy);
    ...
    r1 = tex2D(s12, v0.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c32.w) : (c32.z));
    ...
    r2.xyz = (r1.www) * (r16.xyz) + (r17.xyz);
    r0.z = (-(r14.w)) + (c32.w);
    r0.x = 1.0f / (r18.x);
    r0.y = (r0.z) * (r0.z);
    r0.y = (r0.z) * (r0.y);
    r0.z = dot(r15.xyz, r13.xyz);
    r2.w = (r0.x) * (r0.y);
    r0.z = (r0.z) + (r0.z);
    r0.w = (r0.w) * (c3.z);
    r0.xyz = (r13.xyz) * (-(r0.zzz)) + (r15.xyz);
    r0 = texCUBElod(s15, r0);
    r0.w = (r9.w) * (r12.w) + (r13.w);
    r0.w = (r0.w) * (r11.w) + (c13.x);
    r1.y = saturate(dot(r13.xyz, r14.xyz));
    r1.z = 1.0f / (r0.w);
    r0.w = pow(abs(r1.y), r10.w);
    r1.z = (r9.w) * (r1.z);
    r0.w = (r8.w) * (r0.w);
    r0.w = (r1.z) * (r0.w);
    r3.xyz = (r10.xyz) * (r7.www) + (r11.xyz);
    ...
    r1.xy = (r1.xy) * (r1.xy);
    r1.w = ((-abs(r1.w)) >= 0.0f ? (c32.z) : (r1.z));
    r1.z = (r3.x) * (r1.x);
    r1.w = (r1.w) * (r1.z);
    r1.z = (r1.y) * (-(r3.y)) + (c32.w);
    r1.xy = (r2.ww) * (r2.xy);
    r1.w = (r1.w) * (r1.z);
    r2.w = (r3.z) * (r1.w);
