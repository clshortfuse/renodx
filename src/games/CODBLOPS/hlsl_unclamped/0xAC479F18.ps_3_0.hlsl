// Mechanically reconstructed from 0xAC479F18.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xy = (v4.ww) * (c[34].xy) + (v4.xy);
    r0.zw = v4.zw;
    r0 = tex2Dproj(s1, r0);
    r1.xy = (v4.ww) * (-(c[34].xy)) + (v4.xy);
    r1.zw = v4.zw;
    r1 = tex2Dproj(s1, r1);
    r0.y = r1.x;
    r1.xy = (v4.ww) * (c[34].zw) + (v4.xy);
    r1.zw = v4.zw;
    r1 = tex2Dproj(s1, r1);
    r0.z = r1.x;
    r1.xy = (v4.ww) * (-(c[34].zw)) + (v4.xy);
    ...
    r1.w = dot(r0.xyz, c[30].xyz);
    r2.x = 1.0f / (r1.z);
    r1.z = saturate((r1.w) * (c[31].x) + (c[31].y));
    r1.w = saturate(dot(r0.xyz, r6.xyz));
    r0.z = (r1.z) * (c[31].w);
    r1.z = lerp(r0.w, r2.w, r0.z);
    r1.xy = saturate((r2.xx) * (c[33].xy) + (c[33].zw));
    r0.xy = (r1.xy) * (r1.xy);
