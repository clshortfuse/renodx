// Mechanically reconstructed from 0xEDDAFA6D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.xy = float2(((r8.w) >= 0.0f ? (r0.x) : (c1.y)), ((r8.w) >= 0.0f ? (r0.y) : (c1.y)));
    ...
    r3.z = (r3.w) * (r4.w) + (r4.z);
    r4.w = (r3.x) * (r4.w) + (r4.z);
    r9.xyz = float3(((r8.w) >= 0.0f ? (r3.y) : (c[10].x)), ((r8.w) >= 0.0f ? (r3.y) : (c[10].y)), ((r8.w) >= 0.0f ? (r3.y) : (c[10].w)));
    r3.z = (r3.z) * (r4.w) + (c4.x);
    r7.w = (-(r3.x)) + (c1.z);
    r3.z = 1.0f / (r3.z);
    r4.w = (r3.w) * (r3.z);
