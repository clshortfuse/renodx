// Mechanically reconstructed from 0x92F93865.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r13.xyz = (r2.www) * (v6.xyz);
    r3.xyz = (v6.xyz) * (-(r2.www)) + (c[17].xyz);
    r0.y = saturate(dot(r10.xyz, -(r13.xyz)));
    r8.w = (r1.w) * (c2.w);
    ...
    r2.w = (r2.x) * (r2.w);
    r15.xyz = (r8.xyz) * (r2.zzz) + (r9.xyz);
    r0.xyz = (r1.xxx) * (r3.xyz);
    r3.xyz = (r2.www) * (r15.xyz);
    r0.xyz = (r14.xyz) * (r0.xyz);
    r3.xyz = (r1.yyy) * (r3.xyz);
    r0.xyz = (r4.xyz) * (r0.xyz);
    r3.xyz = (r3.xyz) * (c[19].xyz);
    r2.xyz = (r2.yyy) * (r3.xyz);
    r1.x = dot(r13.xyz, r10.xyz);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r1.x = (r1.x) + (r1.x);
    r6.xyz = (r0.xyz) * (r6.xyz) + (r2.xyz);
    r2.xyz = (r10.xyz) * (-(r1.xxx)) + (r13.xyz);
    r12.xyz = (r12.xyz) * (r11.www) + (-(r13.xyz));
    r2.w = (r1.w) * (c2.z);
