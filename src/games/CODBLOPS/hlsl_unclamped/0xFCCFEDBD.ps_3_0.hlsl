// Mechanically reconstructed from 0xFCCFEDBD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.y = (r2.w) * (-(c3.x)) + (c3.y);
    r4.x = saturate(dot(r10.xyz, -(r1.xyz)));
    r4.z = (r7.w) * (r4.y) + (r6.w);
    r4.y = (r4.x) * (r4.y) + (r6.w);
    r6.w = (-(r4.x)) + (c1.y);
    r4.z = (r4.z) * (r4.y) + (c3.z);
    r4.z = 1.0f / (r4.z);
    r3.xyz = (r3.xyz) * (r5.www) + (-(r1.xyz));
    r5.w = (r7.w) * (r4.z);
    r4.xyz = normalize(r3.xyz);
    r3.xyz = (r7.www) * (c[22].xyz);
