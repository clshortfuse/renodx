// Mechanically reconstructed from 0xFFA22179.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c20 = float4(2.0f, -1.0f, 0.0f, -0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = (c20.xxxx) * (v9) + (c20.yyyy);
    r8.y = dot(r1.xy, r0.zw) + (c20.z);
    r8.x = dot(r1.xy, r0.xy) + (c20.z);
    r0 = tex2D(s1, v1.xy);
    ...
    r7.w = (r1.w) * (v0.y);
    r2 = tex2D(s8, v7.xy);
    r4 = (r2.wwww) * (-(c20.zzzy)) + (-(c20.wwwz));
    r5 = tex2D(s7, v1.xy);
    r0 = tex2D(s4, v7.zw);
    r7.xyz = (r0.xyz) + (c20.yyy);
    r0 = lerp(r5, r4, r7.wwww);
    r5.xyz = (v0.zzz) * (r7.xyz) + (-(c20.yyy));
    r4 = tex2D(s5, v8.xy);
    r4.xyz = (r4.xyz) + (c20.yyy);
    r7.xyz = (r0.xyz) * (r5.xyz);
    r4.xyz = (v0.www) * (r4.xyz) + (-(c20.yyy));
    r0.xyz = lerp(r3.xyz, r1.xyz, r7.www);
    r1.xyz = (r7.xyz) * (r4.xyz);
    r12.xy = lerp(r9.xy, r8.xy, r7.ww);
    r9.xyz = (r1.xyz) * (-(r1.xyz)) + (-(c20.yyy));
    ...
    r3 = tex2D(s13, r3.xy);
    r1.w = r3.y;
    r2.w = dot(r12.xy, r12.xy) + (c20.z);
    r4.xy = (r1.wy) * (c11.xx) + (c11.yy);
    r1.y = exp2(-(r2.w));
    r1.w = dot(r4.xy, r4.xy) + (c20.z);
    r3.w = (r1.y) * (c3.x) + (c3.y);
    r1.w = exp2(-(r1.w));
    r11.xyz = lerp(c[8].xyw, r2.yyy, r7.www);
    r1.y = (r1.w) * (c3.x) + (c3.y);
    r1.w = dot(r4.xy, r12.xy) + (c20.z);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r5.xy = (r2.xy) * (c4.ww);
    ...
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (-(c20.y)) : (-(c20.z)));
