// Mechanically reconstructed from 0xE75CEDF5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = c2.w;
    r3.xyz = float3(((r6.w) >= 0.0f ? (r0.w) : (c[32].x)), ((r6.w) >= 0.0f ? (r0.w) : (c[32].y)), ((r6.w) >= 0.0f ? (r0.w) : (c[32].w)));
    r2 = tex2D(s8, v7.zw);
