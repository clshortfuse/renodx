// Mechanically reconstructed from 0x0568F0F9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s5, v7.zw);
    r4.z = (r0.w) * (v7.y);
    r3.xyz = lerp(r2.xyz, r0.xyz, r4.zzz);
    r0.w = (r0.w) * (-(v7.y)) + (c1.x);
    r6.w = (r2.w) * (-(r0.w)) + (c1.x);
    ...
    r1.z = (r0.z) * (c3.x) + (c3.y);
    r4.w = rsqrt(r0.w);
    r12.xyz = lerp(r1.yyy, c[29].xyw, r4.zzz);
    r0.xy = (v0.zw) * (c4.xy);
    r3 = tex2D(s13, r0.xy);
    ...
    r0.xyz = (r4.yyy) * (v3.xyz) + (r1.xyz);
    r12.w = (r0.w) * (-(c12.z)) + (c12.w);
    r13.xyz = normalize(r0.xyz);
    r1.z = saturate(dot(r13.xyz, r3.xyz));
    r12.y = (r0.w) * (c3.w);
    r1.w = saturate(dot(r8.xyz, r13.xyz));
    r13.w = saturate(dot(r13.xyz, -(r15.xyz)));
    r0.z = (r1.w) * (r12.w) + (r12.y);
    r11.w = (r13.w) * (r12.w) + (r12.y);
