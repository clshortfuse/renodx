// Mechanically reconstructed from 0x34582CD3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.x = 1.0f / (r3.w);
    r7.y = (r0.w) + (r0.w);
    r1.xy = saturate((r3.xx) * (c[28].xy) + (c[28].zw));
    r0.xy = (r1.xy) * (r1.xy);
