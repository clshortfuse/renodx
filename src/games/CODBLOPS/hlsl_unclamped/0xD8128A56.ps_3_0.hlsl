// Mechanically reconstructed from 0xD8128A56.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xy = (c[29].zz) * (r1.xy) + (r0.xy);
    r1.z = c0.y;
    r0 = tex2D(s0, v1.xy);
    r3.z = (r0.w) * (v0.w) + (c0.x);
    r6.xyz = float3(((r3.z) >= 0.0f ? (r1.x) : (c0.z)), ((r3.z) >= 0.0f ? (r1.y) : (c0.z)), ((r3.z) >= 0.0f ? (r1.z) : (c0.z)));
    r1 = v2;
