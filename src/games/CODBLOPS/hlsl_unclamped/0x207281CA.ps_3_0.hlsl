// Mechanically reconstructed from 0x207281CA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.y = dot(r1.xy, r0.zw) + (c20.w);
    r6.x = dot(r1.xy, r0.xy) + (c20.w);
    r1 = tex2D(s1, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r0.xyz = (r0.xyz) + (c20.yyy);
    r4.xyz = (v0.yyy) * (r0.xyz) + (c20.zzz);
    r0 = tex2D(s0, v1.xy);
    r2 = tex2D(s4, v7.zw);
    r3.w = (r2.w) * (v0.z);
    ...
    r6.xy = (r0.wy) * (c11.xx) + (c11.yy);
    r0.w = dot(r5.xy, r5.xy) + (c20.w);
    r0.y = dot(r6.xy, r6.xy) + (c20.w);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c3.x) + (c3.y);
    r1.w = (r0.y) * (c3.x) + (c3.y);
    r0.y = dot(r6.xy, r5.xy) + (c20.w);
    r1.w = (r0.w) * (r1.w);
