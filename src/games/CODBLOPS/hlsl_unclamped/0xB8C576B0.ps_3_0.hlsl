// Mechanically reconstructed from 0xB8C576B0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.z = saturate(dot(r8.xyz, -(r12.xyz)));
    r0.z = (r0.w) * (r4.w) + (r6.w);
    r3.w = (r3.z) * (r4.w) + (r6.w);
    r8.w = (-(r3.z)) + (c1.x);
    r0.z = (r0.z) * (r3.w) + (c4.x);
    r0.z = 1.0f / (r0.z);
    r6.xyz = (r6.xyz) * (r0.xxx) + (-(r12.xyz));
    r3.w = (r0.w) * (r0.z);
    r3.xyz = normalize(r6.xyz);
    r7.xyz = (r0.www) * (c[21].xyz);
    r0.x = saturate(dot(r8.xyz, r3.xyz));
    r0.w = saturate(dot(r3.xyz, r4.xyz));
    r3.xy = (r2.ww) * (c13.xy) + (c13.zw);
    r0.z = exp2(r3.y);
    r7.w = 1.0f / (r3.x);
    r3.z = pow(abs(r0.x), r0.z);
    r0.w = (-(r0.w)) + (c1.x);
    r0.z = (r0.z) * (c4.y) + (c4.z);
    r0.x = (r0.w) * (r0.w);
    r0.z = (r3.z) * (r0.z);
