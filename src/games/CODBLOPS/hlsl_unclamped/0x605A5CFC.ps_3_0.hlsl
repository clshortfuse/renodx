// Mechanically reconstructed from 0x605A5CFC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r0.z) * (r0.y);
    r4 = tex2D(s3, v7.zw);
    r0.xyz = (r4.xyz) + (c2.yyy);
    r3.w = (r3.w) * (c1.z) + (c1.w);
    r4.xyz = (v0.zzz) * (r0.xyz) + (c2.xxx);
    r0.z = 1.0f / (r3.w);
    r3.xyz = (r3.xyz) * (r4.xyz);
    r2.w = (r2.w) * (r0.z);
    r7.xyz = (r3.xyz) * (-(r3.xyz)) + (c2.xxx);
    r0.xyz = (r2.xyz) * (r2.xyz);
    r2.xyz = (r2.www) * (r7.xyz);
    r0.xyz = (r8.xxx) * (r0.xyz);
    r2.xyz = (r3.xyz) * (r3.xyz) + (r2.xyz);
    r3.xyz = (r5.xyz) * (r8.yyy);
