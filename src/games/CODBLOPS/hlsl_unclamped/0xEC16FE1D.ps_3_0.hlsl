// Mechanically reconstructed from 0xEC16FE1D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    float4 v6 = input.v6;
    float4 v7 = input.v7;
    const float4 c0 = float4(0.200000003f, -0.5f, 1.0f, 0.0f);
    ...
    r5.xyz = float3(((r6.w) >= 0.0f ? (r2.x) : (c0.w)), ((r6.w) >= 0.0f ? (r2.y) : (c0.w)), ((r6.w) >= 0.0f ? (r2.z) : (c0.w)));
