// Mechanically reconstructed from 0x92F5025A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c39 = float4(3.5f, -13.0f, 1.0f, 13.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r3.xyz = (r8.xyz) * (r4.www) + (r3.xyz);
    r1.xyz = lerp(r2.xyz, r0.xyz, r3.www);
    r7.xyz = (r1.xyz) * (r1.xyz);
    r18.yz = c1.yz;
    r4.xyz = float3(((r0.w) >= 0.0f ? (r18.y) : (c[36].x)), ((r0.w) >= 0.0f ? (r18.z) : (c[36].y)), ((r0.w) >= 0.0f ? (r18.y) : (c[36].w)));
    r1 = tex2D(s7, v1.xy);
    r0 = tex2D(s8, v8.zw);
    ...
    r0.xyz = (r5.xyz) * (r4.www) + (-(r15.xyz));
    r14.xyz = normalize(r0.xyz);
    r16.xyz = (r5.xyz) * (r4.www);
    r10.xyz = lerp(r4.xyz, c[37].xyw, r3.www);
