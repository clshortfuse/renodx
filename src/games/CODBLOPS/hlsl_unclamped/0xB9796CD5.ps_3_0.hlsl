// Mechanically reconstructed from 0xB9796CD5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = (c20.xxxx) * (v8) + (c20.yyyy);
    r0 = tex2D(s3, v7.xy);
    r0.xyz = (r0.xyz) + (c20.yyy);
    r3.y = dot(r6.xy, r1.zw) + (c20.w);
    r5.xyz = (v0.yyy) * (r0.xyz) + (c20.zzz);
    r0 = tex2D(s0, v1.xy);
    r2 = tex2D(s4, v7.zw);
    r5.w = (r2.w) * (v0.z);
    r2.xyz = (r0.xyz) * (-(r5.xyz)) + (r2.xyz);
    r3.x = dot(r6.xy, r1.xy) + (c20.w);
    r1.xyz = (r5.www) * (r2.xyz);
    r0.xyz = (r0.xyz) * (r5.xyz) + (r1.xyz);
    r6.xy = lerp(r7.xy, r3.xy, r5.ww);
    r3 = tex2D(s6, v1.xy);
    r3.xyz = (r5.xyz) * (r3.xyz);
    r2 = tex2D(s7, v7.zw);
    r1 = (r2.wwww) * (c3.xxxy) + (c3.zzzx);
    r8.xyz = (r0.xyz) * (r0.xyz);
    r0 = lerp(r3, r1, r5.wwww);
    ...
    r3 = tex2D(s13, r3.xy);
    r1.w = r3.y;
    r2.w = dot(r6.xy, r6.xy) + (c20.w);
    r5.xy = (r1.wy) * (c11.xx) + (c11.yy);
    r1.y = exp2(-(r2.w));
    r1.w = dot(r5.xy, r5.xy) + (c20.w);
    r3.w = (r1.y) * (c4.x) + (c4.y);
    r1.w = exp2(-(r1.w));
    r11.xyz = lerp(c[8].xyw, r2.yyy, r5.www);
    r1.y = (r1.w) * (c4.x) + (c4.y);
    r1.w = dot(r5.xy, r6.xy) + (c20.w);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c4.ww);
