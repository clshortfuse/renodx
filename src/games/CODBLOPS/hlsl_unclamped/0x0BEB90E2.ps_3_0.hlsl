// Mechanically reconstructed from 0x0BEB90E2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = r4.y;
    r6.x = dot(r3.xy, r1.xy) + (c1.w);
    r2 = tex2D(s1, v1.xy);
    r1.xy = (r2.wy) * (c2.xy) + (c2.zw);
    r2 = tex2D(s4, v6.xy);
    r5.w = (r2.w) * (v0.y);
    r6.y = dot(r3.xy, r1.zw) + (c1.w);
    ...
    r0.y = dot(r9.xy, r9.xy) + (c1.w);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c3.x) + (c3.y);
    r7.w = (r0.y) * (c3.x) + (c3.y);
    r0.y = (r0.w) * (r7.w);
    r0.w = dot(r3.xy, r9.xy) + (c1.w);
    r3 = tex2D(s14, v1.zw);
    r7.xy = (r3.xy) * (c4.ww);
