// Mechanically reconstructed from 0x2CFC5F6C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s4, v8.xy);
    r7.w = (r1.w) * (v0.y);
    r1.w = lerp(r4.y, r5.w, c[8].w);
    r2 = (r7.wwww) * (r0) + (r2);
    r11.xyz = (r5.xyz) * (r1.www);
    r5.w = (r2.w) * (c2.w);
    ...
    r14.xyz = (r3.www) * (r2.xyz);
    r2.xy = (v1.zw) * (c3.xy);
    r2 = tex2D(s13, r2.xy);
    r4.xy = (v1.zw) * (c3.xy) + (c3.zy);
    r4 = tex2D(s13, r4.xy);
    r2.w = r4.y;
    r9.xyz = lerp(r3.yyy, c[29].xyw, r7.www);
    r3.xy = (r2.yw) * (c12.xx) + (c12.yy);
    r2.w = dot(r15.xy, r15.xy) + (c1.y);
    r2.y = dot(r3.xy, r3.xy) + (c1.y);
    r2.w = exp2(-(r2.w));
    r2.y = exp2(-(r2.y));
    r2.w = (r2.w) * (c2.x) + (c2.y);
    r3.w = (r2.y) * (c2.x) + (c2.y);
    r2.y = dot(r3.xy, r15.xy) + (c1.y);
    r4.w = (r2.w) * (r3.w);
    r3 = tex2D(s14, v1.zw);
    r15.xy = (r3.xy) * (c3.ww);
