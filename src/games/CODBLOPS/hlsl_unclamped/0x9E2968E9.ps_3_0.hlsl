// Mechanically reconstructed from 0x9E2968E9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(-0.5f, 0.25f, -1.0f, 1.0f);
    const float4 c2 = float4(0.125f, 0.25f, 1.0f, 0.0f);
    const float4 c3 = float4(0.959999979f, 0.0399999991f, 0.797884583f, 1.0f);
    const float4 c4 = float4(0.0009765625f, -13.0f, 13.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r1.xyz = v3.xyz;
    r1.xyz = (r2.xxx) * (r1.xyz) + (v1.xyz);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r1.xyz = (r2.yyy) * (v2.xyz) + (r1.xyz);
    ...
    r4.w = (r0.w) * (c4.y) + (c4.z);
    r0.w = (r3.w) * (r5.w) + (c4.x);
    r5.xyz = (r0.xyz) * (r2.www) + (-(r5.xyz));
    r0.w = 1.0f / (r0.w);
    r2.w = (r1.w) * (r0.w);
    r0.xyz = normalize(r5.xyz);
    r3.w = saturate(dot(r4.xyz, r0.xyz));
