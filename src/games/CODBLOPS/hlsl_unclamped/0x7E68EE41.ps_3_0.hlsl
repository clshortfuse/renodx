// Mechanically reconstructed from 0x7E68EE41.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = tex2D(s5, v7.zw);
    r0.zw = (r3.ww) * (c1.zy) + (c1.wz);
    r1 = tex2D(s3, v7.zw);
    r10.z = (r1.w) * (v7.y) + (c1.x);
    r4.xyz = (-(v6.xyz)) + (c[20].xyz);
    r2 = float4(((r10.z) >= 0.0f ? (r0.x) : (c1.z)), ((r10.z) >= 0.0f ? (r0.y) : (c1.z)), ((r10.z) >= 0.0f ? (r0.z) : (c1.z)), ((r10.z) >= 0.0f ? (r0.w) : (c1.y)));
    ...
    r2 = tex2D(s0, v0.xy);
    r0.xyz = float3(((r10.z) >= 0.0f ? (r1.x) : (r2.x)), ((r10.z) >= 0.0f ? (r1.y) : (r2.y)), ((r10.z) >= 0.0f ? (r1.z) : (r2.z)));
