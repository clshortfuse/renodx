// Mechanically reconstructed from 0x52DE68C0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s4, v7.xy);
    r0.w = (r1.w) * (v0.y) + (c1.z);
    r4.xyz = (r8.xyz) * (r3.www) + (r3.xyz);
    r1.xyz = float3(((r0.w) >= 0.0f ? (r1.x) : (r2.x)), ((r0.w) >= 0.0f ? (r1.y) : (r2.y)), ((r0.w) >= 0.0f ? (r1.z) : (r2.z)));
    r3.xyz = lerp(r1.xyz, r0.xyz, r4.www);
    r0.x = c1.w;
    r5.xyz = float3(((r0.w) >= 0.0f ? (r0.x) : (c[27].x)), ((r0.w) >= 0.0f ? (r0.x) : (c[27].y)), ((r0.w) >= 0.0f ? (r0.x) : (c[27].w)));
    r1 = tex2D(s9, v7.zw);
    r2 = tex2D(s8, v1.xy);
    r0 = lerp(r2, r1, r4.wwww);
    r13.xyz = lerp(r5.xyz, c[28].xyw, r4.www);
    r1 = tex2D(s6, v8.xy);
    ...
    r2.xy = (r0.ww) * (c30.xy) + (c30.zw);
    r0.y = 1.0f / (r0.z);
    r7.w = exp2(r2.y);
    r0.z = pow(abs(r3.w), r7.w);
    r5.w = (r7.w) * (c14.x) + (c14.y);
    r3.w = (r2.z) * (r0.y);
    r2.y = (r0.z) * (r5.w);
