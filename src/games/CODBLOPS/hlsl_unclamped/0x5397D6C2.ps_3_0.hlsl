// Mechanically reconstructed from 0x5397D6C2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c14 = float4(1.0f, 0.797884583f, 0.5f, 0.0f);
    ...
    r0.w = (r1.z) * (-(r4.x)) + (r0.w);
    r10.y = (r0.w) + (r0.w);
    r1.xy = (v0.zw) * (c14.xz) + (c14.wz);
    r1 = tex2D(s13, r1.xy);
    r3.xy = (r4.yy) * (r1.xz);
    r0.w = (r0.y) * (c3.x) + (-(r3.x));
    r0.y = r1.y;
    r1.w = (r1.z) * (-(r4.y)) + (r0.w);
    r4.xy = (r0.xy) * (c3.yy) + (c3.zz);
    r0 = tex2D(s1, v0.xy);
    ...
    r0.xyz = (r5.xyz) * (r0.www) + (-(r15.xyz));
    r4.xyz = normalize(r0.xyz);
    r9.xyz = (r5.xyz) * (r0.www);
    r11.w = (r1.w) * (-(c14.y)) + (c14.x);
    r0.w = saturate(dot(r4.xyz, r9.xyz));
    r11.xyz = (r1.xyz) * (-(r1.xyz)) + (c14.xxx);
    r2.w = (-(r0.w)) + (c14.x);
    r0.xyw = c[29].xyw;
    ...
    r1.z = (r1.y) * (r1.z);
    r13.xyz = (r3.www) * (r2.xyz) + (c[29].xyw);
    r0.xyz = (r0.xyz) * (r1.zzz);
    r16.xyz = (r3.xyz) * (r13.yyy);
    ...
    r2 = tex2D(s12, v0.zw);
    r0.z = ((-abs(r2.y)) >= 0.0f ? (c14.x) : (c14.w));
