// Mechanically reconstructed from 0x1BC1C5A0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s5, v8.xy);
    r3.w = (r1.w) * (v0.y);
    r7.xy = (r3.ww) * (-(r0.xy)) + (r0.xy);
    r0 = tex2D(s7, v1.xy);
    r2 = tex2D(s0, v1.xy);
    r5.xyz = lerp(r2.xyz, r1.xyz, r3.www);
    r4.xyz = lerp(r0.yyy, c[29].xyw, r3.www);
    r2.w = -(r0.w);
    r2.xyz = c1.xxx;
    r1 = tex2D(s8, v8.xy);
    r1 = (r2) + (r1);
    ...
    r1.y = (r1.x) * (r1.y);
    r13.xyz = lerp(r4.xyz, c[30].xyw, r4.www);
