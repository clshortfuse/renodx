// Mechanically reconstructed from 0x9DD04535.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.z = (r0.w) * (v0.w) + (c1.x);
    r0.w = (r2.w) * (r2.w);
    r4.xy = float2(((r4.z) >= 0.0f ? (r5.x) : (c1.z)), ((r4.z) >= 0.0f ? (r5.y) : (c1.z)));
    r0.w = (r0.w) * (r0.w);
    r1 = v2;
    ...
    r2 = tex2D(s5, v1.xy);
    r2 = float4(((r4.z) >= 0.0f ? (r2.x) : (c1.z)), ((r4.z) >= 0.0f ? (r2.y) : (c1.z)), ((r4.z) >= 0.0f ? (r2.z) : (c1.z)), ((r4.z) >= 0.0f ? (r2.w) : (c1.y)));
    ...
    r1.y = c1.z;
    r8.xyz = float3(((r4.z) >= 0.0f ? (c[30].x) : (r1.y)), ((r4.z) >= 0.0f ? (c[30].y) : (r1.y)), ((r4.z) >= 0.0f ? (c[30].w) : (r1.y)));
