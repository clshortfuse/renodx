// Mechanically reconstructed from 0x8CCA2806.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c11 = float4(0.797884583f, 0.959999979f, 0.0399999991f, 31.875f);
    ...
    r4.xy = (r2.xz) * (r8.xx);
    r0.y = (r1.x) * (c11.w) + (-(r4.x));
    r5.xy = (r0.xz) * (r8.yy);
    r0.x = (r2.z) * (-(r8.x)) + (r0.y);
    r0.y = (r1.y) * (c11.w) + (-(r5.x));
    r0.y = (r0.z) * (-(r8.y)) + (r0.y);
    ...
    r8.w = (r5.w) * (r0.w);
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c10.x) : (c10.z));
