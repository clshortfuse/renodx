// Mechanically reconstructed from 0x85CEBF6B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xy = lerp(r2.xy, r3.xy, r6.ww);
    r0 = tex2D(s8, v7.xy);
    r3 = (r0.wwww) * (-(c20.zzzy)) + (-(c20.wwwz));
    r4 = tex2D(s7, v1.xy);
    r1 = tex2D(s4, v7.zw);
    r5.w = (r1.w) * (v0.z);
    r2 = lerp(r4, r3, r6.wwww);
    r3.xyz = lerp(r5.xyz, r1.xyz, r5.www);
    r6.xy = lerp(r8.xy, r7.xy, r5.ww);
    r5.xyz = lerp(c[8].xyw, r0.yyy, r6.www);
    r1 = tex2D(s9, v7.zw);
    ...
    r1.w = (-(r3.w)) + (-(c20.y));
    r11.xyz = lerp(r5.xyz, c[9].xyw, r5.www);
    r1.z = (r1.w) * (r1.w);
