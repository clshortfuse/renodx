// Mechanically reconstructed from 0x1C9C8280.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.x = dot(r4.xy, r1.xy) + (c2.x);
    r3.y = dot(r4.xy, r1.zw) + (c2.x);
    r4 = tex2D(s3, v6.zw);
    r4.w = (r4.w) * (v0.z);
