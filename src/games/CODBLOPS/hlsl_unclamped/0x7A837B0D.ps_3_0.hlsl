// Mechanically reconstructed from 0x7A837B0D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.zw = c15.zw;
    r3.xyz = (r9.zwz) + (-(c[39].xyw));
    r0.xyz = v2.xyz;
    r0.xyz = (r9.xxx) * (v4.xyz) + (r0.xyz);
    r3.xyz = (r2.www) * (r3.xyz) + (c[39].xyw);
    ...
    r0.w = (r0.y) + (c15.w);
    r0.y = (r1.w) + (r1.w);
    r11.xyz = (r6.www) * (r0.xwz) + (r3.xyz);
    r3.xyz = (r10.xyz) * (-(r0.yyy)) + (r9.xyz);
    r0 = tex2D(s8, v1.xy);
    r3.w = (r0.w) * (c2.z);
