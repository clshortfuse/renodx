// Mechanically reconstructed from 0xF0B01810.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s0, v0.xy);
    r1.w = (r1.w) * (-(v7.x)) + (c12.x);
    r0 = tex2D(s4, v7.zw);
    r4.w = (r0.w) * (v7.y);
    r2.xyz = lerp(r1.xyz, r0.xyz, r4.www);
    r0.w = (r0.w) * (-(v7.y)) + (c12.x);
    r6.w = (r1.w) * (-(r0.w)) + (c12.x);
    ...
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c12.x) : (c12.y));
