// Mechanically reconstructed from 0x132D8AD3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s12, v6.zw);
    r3.xy = c1.xy;
    r0.xy = (v6.xy) * (c[33].xx) + (r3.xx);
    r0.xy = (r0.xy) * (c[34].xx) + (r3.yy);
    r0 = tex2D(s2, r0.xy);
    r9.xy = (v6.xy) * (c[33].xx);
    r0.w = (r0.y) * (c1.z) + (c1.w);
    r2.xy = (r9.xy) * (c2.xx) + (c2.yy);
    r0.y = (r0.w) * (c1.z) + (c1.w);
    r2.xy = (r2.xy) * (c[35].xx) + (r3.yy);
    r2 = tex2D(s3, r2.xy);
    r0.w = (r2.y) * (c1.z) + (c1.w);
    r0.w = (r0.w) * (c1.z) + (c1.w);
    r0.xz = c2.zz;
    ...
    r0.xyz = (r4.xyz) * (c[32].xxx) + (-(r2.xyz));
    r7.xyz = (-(v4.xyz)) * (r2.www) + (r1.xyz);
