// Mechanically reconstructed from 0xDE2F6D5B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s7, v1.xy);
    r0 = tex2D(s8, v8.xy);
    r1 = lerp(r2, r0, r3.wwww);
    r6.xy = (r3.ww) * (-(r3.xy)) + (r3.xy);
    r0.xyw = c[31].xyw;
    r2.xyz = (-(r0.xyw)) + (c[32].xyw);
    r0 = tex2D(s5, v8.zw);
    r4.w = (r0.w) * (v0.z);
    r4.xyz = (r3.www) * (r2.xyz) + (c[31].xyw);
    r3.xyz = lerp(r5.xyz, r0.xyz, r4.www);
    r0 = tex2D(s9, v8.zw);
    r2 = lerp(r1, r0, r4.wwww);
    r0 = tex2D(s6, v9.xy);
    r0.xyz = (r0.xyz) + (c1.xxx);
    r8.xyz = lerp(r4.xyz, c[33].xyw, r4.www);
    r1.xyz = (v0.www) * (r0.xyz) + (c1.yyy);
    r4.xy = (r4.ww) * (-(r6.xy)) + (r6.xy);
    r0.xyz = (r3.xyz) * (r1.xyz);
    r2.xyz = (r2.xyz) * (r1.xyz);
    r7.xyz = (r0.xyz) * (r0.xyz);
    r9.w = (r2.w) * (-(c35.z)) + (c35.w);
    ...
    r3.w = r0.y;
    r5.xy = (r3.xz) * (r6.xx);
    r9.xy = (r3.yw) * (c35.xx) + (c35.yy);
    r0.y = (r1.x) * (c4.w) + (-(r5.x));
    r0.w = dot(r9.xy, r4.xy) + (c1.z);
    r1.w = (r3.z) * (-(r6.x)) + (r0.y);
    r3.xy = (r0.xz) * (r6.yy);
