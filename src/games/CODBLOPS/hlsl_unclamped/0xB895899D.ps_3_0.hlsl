// Mechanically reconstructed from 0xB895899D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    float4 v2 = input.v2;
    float4 v3 = input.v3;
    const float4 c0 = float4(1.0f, 0.797884583f, 0.0009765625f, 0.0f);
