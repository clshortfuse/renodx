// Mechanically reconstructed from 0xCB4352F9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyw = c[31].xyw;
    r0.xyz = (-(r4.xyw)) + (c[32].xyw);
    r1.xyz = (r10.yyy) * (v4.xyz) + (r1.xyz);
    r10.xyz = normalize(r1.xyz);
    r14.xyz = normalize(v6.xyz);
    r0.xyz = (r6.www) * (r0.xyz) + (c[31].xyw);
    r1.w = dot(r14.xyz, r10.xyz);
    r11.xyz = lerp(r0.xyz, c2.xxx, r2.www);
    r0.z = (r1.w) + (r1.w);
    r5 = tex2D(s6, v1.xy);
    r4 = tex2D(s7, v7.xy);
    r1 = lerp(r5, r4, r6.wwww);
    r4.xyz = (r10.xyz) * (-(r0.zzz)) + (r14.xyz);
    r4.w = (r1.w) * (c2.w);
    ...
    r4.w = 1.0f / (r15.x);
    r13.xyz = (v0.www) * (r4.xyz) + (c2.xxx);
    r4.w = (r5.w) * (r4.w);
    r1.xyz = (r1.xyz) * (r13.xyz);
    r5.xyz = (r1.xyz) * (r1.xyz);
    r1.xyz = (r1.xyz) * (-(r1.xyz)) + (c2.xxx);
    r0.xyz = (r11.xxx) * (r0.xyz);
    r4.xyz = (r1.xyz) * (r4.www) + (r5.xyz);
    ...
    r4 = tex2D(s0, v1.xy);
    r14.xyz = lerp(r4.xyz, r3.xyz, r6.www);
    r0.xyz = lerp(r14.xyz, r2.xyz, r2.www);
    r2.y = (r1.w) * (c1.z);
    ...
    r1.w = (-(r1.w)) + (c2.x);
    r2.z = pow(abs(r3.y), r5.w);
    r2.w = (r1.w) * (r1.w);
    r2.z = (r3.z) * (r2.z);
    r2.w = (r2.w) * (r2.w);
    r5.w = (r3.w) * (r2.z);
    r1.w = (r1.w) * (r2.w);
    r5.xyz = (r1.xyz) * (r1.www) + (r5.xyz);
    r4 = (-(v6.yyyy)) + (c[6]);
    r1 = (r4) * (r4);
    r3 = (-(v6.xxxx)) + (c[5]);
    r1 = (r3) * (r3) + (r1);
