// Mechanically reconstructed from 0xDB4F99CF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = float4(((r6.w) >= 0.0f ? (r2.x) : (c1.z)), ((r6.w) >= 0.0f ? (r2.y) : (c1.z)), ((r6.w) >= 0.0f ? (r2.z) : (c1.z)), ((r6.w) >= 0.0f ? (r2.w) : (c1.z)));
    r1.w = dot(r5.xy, r5.xy) + (c1.z);
    r1.y = dot(r2.xy, r2.xy) + (c1.z);
    r1.w = exp2(-(r1.w));
    r1.y = exp2(-(r1.y));
    r1.w = (r1.w) * (c4.x) + (c4.y);
    r5.w = (r1.y) * (c4.x) + (c4.y);
    ...
    r2.y = (r2.y) + (r2.y);
    r5.y = (r2.x) + (r2.x);
    r4.xyz = (r1.xyz) * (-(r2.yyy)) + (r7.xyz);
    r3 = tex2D(s2, v1.xy);
    r3 = float4(((r6.w) >= 0.0f ? (r3.x) : (c1.z)), ((r6.w) >= 0.0f ? (r3.y) : (c1.z)), ((r6.w) >= 0.0f ? (r3.z) : (c1.z)), ((r6.w) >= 0.0f ? (r3.w) : (c1.y)));
    ...
    r3.xyz = (r3.xyz) * (r3.xyz) + (r1.xyz);
    r1.xyz = (r5.xyz) * (r5.www) + (r6.xyz);
