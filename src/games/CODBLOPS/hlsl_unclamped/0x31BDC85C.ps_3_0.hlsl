// Mechanically reconstructed from 0x31BDC85C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = (r2.yw) * (c4.zz) + (c4.ww);
    r2.w = exp2(-(r0.w));
    r0.w = dot(r4.xy, r4.xy) + (c2.z);
    r2.w = (r2.w) * (c3.x) + (c3.y);
    r2.y = exp2(-(r0.w));
    r0.w = dot(r4.xy, r3.xy) + (c2.z);
    r2.y = (r2.y) * (c3.x) + (c3.y);
    r4 = tex2D(s14, v1.zw);
    r8.xy = (r4.xy) * (c3.ww);
    r2.y = (r2.w) * (r2.y);
    ...
    r2.xyz = (r7.xyz) * (r2.www) + (r5.xyz);
    r0.w = (r0.w) + (r0.w);
    r6.xyz = (r3.www) * (r2.xyz);
    r4.xyz = (r9.xyz) * (-(r0.www)) + (r8.xyz);
    r5 = tex2D(s6, v1.xy);
    r2 = tex2D(s7, v6.xy);
    r5 = float4(((r6.w) >= 0.0f ? (r2.x) : (r5.x)), ((r6.w) >= 0.0f ? (r2.y) : (r5.y)), ((r6.w) >= 0.0f ? (r2.z) : (r5.z)), ((r6.w) >= 0.0f ? (r2.w) : (r5.w)));
    r2 = tex2D(s8, v6.zw);
