// Mechanically reconstructed from 0x8ED25695.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4 = (r4) * (r0.xxxx) + (r5);
    r1.z = c1.y;
    r2 = saturate((r2) * (c[8]) + (r1.zzzz));
    r3 = saturate((r3) * (r0.zzzz) + (r4));
    r0.z = saturate(dot(c[17].xyz, r0.xyz));
    r2 = (r2) * (r3);
