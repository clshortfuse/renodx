// Mechanically reconstructed from 0xC2F4CF22.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = saturate(dot(r1.xyz, -(r11.xyz)));
    r0.y = (r0.w) * (c0.w);
    r0.z = (r0.w) * (-(c0.w)) + (c0.y);
    r2.w = saturate(dot(r1.xyz, c[17].xyz));
    r3.z = (r3.w) * (r0.z) + (r0.y);
    r1.w = (r2.w) * (r0.z) + (r0.y);
    r0.xyz = (r9.xyz) * (r3.yyy) + (r10.xyz);
    r1.w = (r1.w) * (r3.z) + (c2.x);
    r3.z = 1.0f / (r1.w);
    ...
    r0.w = (r3.y) * (c1.w) + (-(r4.x));
    r8.xz = (r4.xy) * (c3.xx);
    r0.w = (r4.z) * (-(r12.y)) + (r0.w);
    r2.xy = (r2.xz) * (r12.xx);
    r8.y = (r0.w) + (r0.w);
    r0.w = (r3.x) * (c1.w) + (-(r2.x));
    r3.xz = (r2.xy) * (c3.xx);
    r0.w = (r2.z) * (-(r12.x)) + (r0.w);
    r3.y = (r0.w) + (r0.w);
    r0.w = dot(r11.xyz, r1.xyz);
    r2.xyz = (r8.xyz) * (r0.zzz) + (r3.xyz);
    r0.w = (r0.w) + (r0.w);
    r8.xyz = (r2.xyz) * (c[5].yyy);
