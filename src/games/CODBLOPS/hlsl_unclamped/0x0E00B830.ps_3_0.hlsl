// Mechanically reconstructed from 0x0E00B830.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s1, v4.zw);
    r7.w = (r0.w) * (v4.y);
    r1 = lerp(r3, r2, r7.wwww);
    r3.z = (r1.w) * (c0.z);
    r0.w = dot(v3.xyz, v3.xyz);
    r2.w = (r1.w) * (-(c0.z)) + (c0.y);
    r2.y = rsqrt(r0.w);
    r12.xyz = (r2.yyy) * (v3.xyz);
