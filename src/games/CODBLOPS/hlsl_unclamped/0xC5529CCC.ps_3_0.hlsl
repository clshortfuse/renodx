// Mechanically reconstructed from 0xC5529CCC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = saturate(dot(r12.xyz, -(r13.xyz)));
    r0 = tex2D(s2, v0.xy);
    r3.z = (r0.w) * (c0.w);
    r1.y = (r0.w) * (-(c0.w)) + (c0.y);
    r1.z = saturate(dot(r12.xyz, c[17].xyz));
    r3.w = (r1.x) * (r1.y) + (r3.z);
    r1.y = (r1.z) * (r1.y) + (r3.z);
    ...
    r1.xy = c0.xy;
    r1.xyz = (r1.xyx) + (-(c[5].xyw));
    r0.xyz = (r2.www) * (r0.xyz);
    r11.xyz = (r1.www) * (r1.xyz) + (c[5].xyw);
    r5.w = 1.0f / (r2.x);
    ...
    r0.w = dot(r3.xy, r3.xy) + (c0.x);
    r6.xyz = (r1.xyz) * (r0.yyy);
    r0.w = exp2(-(r0.w));
    r3 = tex2D(s14, v0.zw);
    r8.xy = (r3.xy) * (c2.ww);
    r0.z = saturate((r0.w) * (c3.z) + (c3.w));
    r1.xy = (r4.xz) * (r8.yy);
    r0.w = (r3.y) * (c2.w) + (-(r1.x));
    r1.xz = (r1.xy) * (c3.xx);
    r0.w = (r4.z) * (-(r8.y)) + (r0.w);
