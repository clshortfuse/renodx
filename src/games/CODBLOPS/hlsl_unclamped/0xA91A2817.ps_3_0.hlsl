// Mechanically reconstructed from 0xA91A2817.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = (-(r1.x)) + (c1.z);
    r0.y = (r0.x) * (r0.y);
    r10.xyz = (r0.xxx) * (c[18].xyz);
    r0.z = (r0.z) * (r0.y);
    r0.z = (r2.w) * (r0.z);
    r2.w = max(abs(r5.y), abs(r5.z));
    r0.z = (r1.y) * (r0.z);
    r0.y = max(abs(r5.x), r2.w);
    r2.w = 1.0f / (r0.y);
    ...
    r3.w = dot(r9.xyz, r5.xyz);
    r3.xyz = (r2.www) * (r10.xyz) + (r2.xyz);
    r2.w = (r3.w) + (r3.w);
    ...
    r3.w = (r1.w) * (r3.w);
    r2.w = (-(r2.w)) + (c1.z);
    r4.w = saturate(dot(r5.xyz, r3.xyz));
    r3.z = (r2.w) * (r2.w);
