// Mechanically reconstructed from 0xE5664F3E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.z = 1.0f / (r15.x);
    r13.xyz = (v0.zzz) * (r3.xyz) + (c1.yyy);
    r3 = tex2D(s5, v8.xy);
    r3.xyz = (r3.xyz) + (c1.xxx);
    r1.xyz = (r1.xyz) * (r13.xyz);
    r12.xyz = (v0.www) * (r3.xyz) + (c1.yyy);
    r3.w = (r4.w) * (r4.z);
