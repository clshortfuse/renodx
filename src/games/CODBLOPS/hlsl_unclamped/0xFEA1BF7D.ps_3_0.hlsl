// Mechanically reconstructed from 0xFEA1BF7D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s4, v7.zw);
    r1.yzw = (r1.wyy) + (c1.xzx);
    r9.xyz = normalize(r0.xyz);
    r12.xy = (r9.ww) * (r1.yw) + (c1.yy);
    r1.y = saturate(dot(r9.xyz, -(r7.xyz)));
    r0.x = (r12.x) * (c2.w);
    r0.z = (r12.x) * (-(c4.z)) + (c4.w);
    ...
    r0.x = pow(abs(r2.z), r1.x);
    r0.z = (r1.x) * (c12.y) + (c12.z);
    r0.y = (-(r0.y)) + (c1.y);
    r0.z = (r0.x) * (r0.z);
    r0.x = (r0.y) * (r0.y);
    r0.x = (r0.x) * (r0.x);
    ...
    r1.w = (r1.w) * (c2.x) + (c2.y);
    r1.z = (r0.z) * (c2.x) + (c2.y);
    r0.z = dot(r0.xy, r4.xy) + (c1.z);
    r0.y = (r1.w) * (r1.z);
    r4 = tex2D(s14, v1.zw);
    r8.xy = (r4.xy) * (c3.ww);
    r1.x = saturate((r0.z) * (r0.y) + (r0.y));
    r0.xy = (r5.xz) * (r8.yy);
    r1.z = (r4.y) * (c3.w) + (-(r0.x));
    r0.xz = (r0.xy) * (c4.xx);
    r0.y = (r5.z) * (-(r8.y)) + (r1.z);
    ...
    r4.xyz = (r10.xyz) * (r1.yyy);
    r5.xyz = (r12.yyy) * (r0.xyz);
    r2 = tex2D(s1, v7.xy);
