// Mechanically reconstructed from 0x58DA4960.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.w = (r11.z) * (-(c30.z)) + (c30.w);
    r2.w = dot(r11.xy, r11.xy) + (c1.z);
    ...
    r5.z = (r8.w) * (r9.w) + (r10.w);
    r2.y = (r1.w) * (r9.w) + (r10.w);
    r2.z = saturate(dot(r9.xyz, r1.xyz));
    r2.y = (r2.y) * (r5.z) + (c12.x);
    r1.z = saturate(dot(r1.xyz, r0.xyz));
    r1.y = 1.0f / (r2.y);
    r1.x = (r1.w) * (r1.y);
    r14.xy = (r11.zz) * (c16.xy) + (c16.zw);
    r5.w = exp2(r14.y);
    r1.y = (-(r1.z)) + (-(c1.y));
    r1.z = pow(abs(r2.z), r5.w);
    r2.z = (r1.y) * (r1.y);
    r4.z = (r5.w) * (c12.y) + (c12.z);
    r2.z = (r2.z) * (r2.z);
    r1.z = (r1.z) * (r4.z);
    r1.y = (r1.y) * (r2.z);
    r1.z = (r1.x) * (r1.z);
    ...
    r2.z = (r1.w) * (r2.z);
    r1.w = (r2.w) * (r9.w) + (r10.w);
    r2.y = saturate(dot(r9.xyz, r1.xyz));
    r1.z = (r1.w) * (r5.z) + (c12.x);
