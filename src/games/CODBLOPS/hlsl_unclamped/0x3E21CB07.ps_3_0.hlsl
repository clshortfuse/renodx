// Mechanically reconstructed from 0x3E21CB07.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r1.z) * (-(r6.x)) + (r1.w);
    r1 = tex2D(s4, v6.xy);
    r13.w = (r1.w) * (v0.y) + (c2.z);
    r12.y = (r2.w) + (r2.w);
    r6.w = c2.w;
    r3.xyz = float3(((r13.w) >= 0.0f ? (r6.w) : (c[39].x)), ((r13.w) >= 0.0f ? (r6.w) : (c[39].y)), ((r13.w) >= 0.0f ? (r6.w) : (c[39].w)));
    r2.xyz = (r12.xyz) * (r0.www) + (r5.xyz);
