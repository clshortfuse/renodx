// Mechanically reconstructed from 0xE1F7D6AB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.w = (r4.w) * (v0.y);
    r1.w = r0.x;
    r6.xy = lerp(r5.xy, r2.xy, r8.ww);
    r0 = tex2D(s7, v7.zw);
    r2.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r0 = (c1.xxxx) * (v9) + (c1.yyyy);
    r5.x = dot(r2.xy, r0.xy) + (c1.w);
    r5.y = dot(r2.xy, r0.zw) + (c1.w);
    r0 = tex2D(s5, v7.zw);
    r4.w = (r0.w) * (v0.z);
    r0.w = dot(r1, c2.xxxx);
    r2.xy = lerp(r6.xy, r5.xy, r4.ww);
    r0.w = (r0.w) + (c1.y);
    r1.xyz = v4.xyz;
    ...
    r6 = lerp(r7, r1, r8.wwww);
    r0.w = dot(r11.xyz, r11.xyz);
    r1 = lerp(r6, r5, r4.wwww);
    r3.w = rsqrt(r0.w);
    r3.y = (r1.w) * (c2.y);
