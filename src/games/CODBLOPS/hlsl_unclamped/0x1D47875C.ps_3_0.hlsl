// Mechanically reconstructed from 0x1D47875C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r4.w) * (r1.w);
    r1.xyz = (r5.xyz) * (r1.zzz) + (r8.xyz);
    r10.x = 1.0f / (r3.w);
    r1.xyz = (r1.www) * (r1.xyz);
    r4.w = 1.0f / (r3.x);
    r2.xyz = (r1.xyz) * (c[11].www);
    r1 = tex2D(s4, v1.xy);
    r2.xyz = (r2.xyz) * (r1.www);
    r2.w = (r2.w) * (c0.y);
    r7.xyz = (r2.xyz) * (c[8].xyz);
    r2.z = dot(c[9].yz, r10.xy) + (c[9].x);
    r3.xy = saturate((r10.xx) * (c[10].xy) + (c[10].zw));
    r2.xy = (r3.xy) * (r3.xy);
    r3.xy = (r3.xy) * (c2.yy) + (c2.zz);
    r3.xy = (r2.xy) * (r3.xy);
    r3.w = max(abs(r0.y), abs(r0.z));
    r3.z = (r2.z) * (r3.x);
    r2.z = max(abs(r0.x), r3.w);
    r3.w = 1.0f / (r2.z);
    ...
    r2.xyz = (r2.xyz) * (c[11].yyy);
    r6.w = (r6.w) + (r6.w);
    r7.xyz = (r1.www) * (r2.xyz);
    r2.xyz = (r0.xyz) * (-(r6.www)) + (r9.xyz);
    ...
    r2.xyz = (r3.www) * (r6.xyz) + (r7.xyz);
    r0.xyz = (r0.xyz) * (r5.xyz);
    r2.xyz = (r4.xyz) * (r2.xyz) + (r3.xyz);
    r0.xyz = (r0.xyz) * (c[11].xxx);
