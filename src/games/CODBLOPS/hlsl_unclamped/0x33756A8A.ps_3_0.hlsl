// Mechanically reconstructed from 0x33756A8A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.y = dot(r8.xy, r8.xy) + (c1.w);
    r1.w = exp2(-(r1.w));
    r1.y = exp2(-(r1.y));
    r1.w = (r1.w) * (c2.x) + (c2.y);
    r3.w = (r1.y) * (c2.x) + (c2.y);
    r1.y = (r1.w) * (r3.w);
    r1.w = dot(r2.xy, r8.xy) + (c1.w);
    r2 = tex2D(s14, v0.zw);
    r9.xy = (r2.xy) * (c3.ww);
