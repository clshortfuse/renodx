// Mechanically reconstructed from 0x62141123.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c3 = float4(0.25f, 0.0f, 0.0f, 0.0f);
    const float4 c4 = float4(4.0f, -2.0f, 2.0f, 3.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0.xy = (r5.xy) * (r5.xy);
    r5.xy = (r5.xy) * (c4.yy) + (c4.ww);
    r0.w = dot(c[29].yz, r6.xy) + (c[29].x);
    r0.xy = (r0.xy) * (r5.xy);
    r7.xyz = (r1.xyz) * (c4.xzx) + (r3.xyz);
    r0.w = (r0.w) * (r0.x);
    ...
    r3.xy = (r0.xy) * (r0.xy);
    r4.xy = (r0.xy) * (c4.yy) + (c4.ww);
    r0.xyz = (-(v6.xyz)) + (c[5].xyz);
    r3.z = (r3.x) * (r4.x);
    r2.xyz = normalize(r0.xyz);
    r1.w = (r3.y) * (-(r4.y)) + (c2.x);
    r0.z = dot(r2.xyz, c[21].xyz);
    r0.x = (r3.w) * (r3.z);
