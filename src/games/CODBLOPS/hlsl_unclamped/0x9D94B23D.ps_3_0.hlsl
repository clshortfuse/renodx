// Mechanically reconstructed from 0x9D94B23D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = (r1.x) * (-(c4.z)) + (v3.x);
    r1.x = (r1.x) * (c4.w) + (-(v3.x));
    r1.x = (c[34].x) * (r1.x) + (v3.x);
    r1.z = (-(r1.x)) + (c0.w);
    r1.zw = float2(((r1.z) >= 0.0f ? (c2.x) : (c2.y)), ((r1.x) >= 0.0f ? (c2.x) : (c2.y)));
    r1.x = saturate(r1.x);
    r1.z = (r1.z) + (r1.w);
    r1.w = frac(abs(v3.y));
    ...
    r1.xyz = float3(((-(r1.z)) >= 0.0f ? (r1.x) : (c2.x)), ((-(r1.z)) >= 0.0f ? (r1.y) : (c2.x)), ((-(r1.z)) >= 0.0f ? (r1.w) : (c2.x)));
    r1.w = abs(c[26].w);
    r1.w = frac(r1.w);
