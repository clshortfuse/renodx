// Mechanically reconstructed from 0xD404CB33.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = (v0.zzz) * (r3.xyz) + (c2.www);
    r3 = tex2D(s4, v7.xy);
    r7.xyz = (r3.xyz) + (c2.yyy);
    r3.xyz = (r2.xyz) * (r4.xyz);
    r2.xyz = (v0.www) * (r7.xyz) + (c2.www);
    r2.w = 1.0f / (r2.w);
    r3.xyz = (r3.xyz) * (r2.xyz);
    r1.w = (r1.w) * (r2.w);
    r8.xyz = (r3.xyz) * (-(r3.xyz)) + (c2.www);
