// Mechanically reconstructed from 0x2D918242.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = dot(r1.xy, r0.zw) + (c27.z);
    r2.x = dot(r1.xy, r0.xy) + (c27.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r7.w = (r0.w) * (v0.y);
    ...
    r1.xyz = lerp(r5.xyz, r0.xyz, r6.www);
    r7.xy = lerp(r8.xy, r6.xy, r6.ww);
    r6.xyz = (r1.xyz) * (r1.xyz);
    r1 = tex2D(s9, v7.zw);
    r2 = (r1.wwww) * (-(c27.zzzy)) + (-(c27.wwwz));
    r0.xyw = c[23].xyw;
    r5.xyz = (-(r0.xyw)) + (c[24].xyw);
    r0 = lerp(r3, r2, r6.wwww);
    r2.xyz = (r7.www) * (r5.xyz) + (c[23].xyw);
    r13.xyz = lerp(r2.xyz, r1.yyy, r6.www);
