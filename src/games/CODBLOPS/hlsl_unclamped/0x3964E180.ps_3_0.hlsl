// Mechanically reconstructed from 0x3964E180.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xy = (r3.xz) * (r4.xx);
    r0.w = dot(r6.xy, r5.xy) + (c12.y);
    r0.y = (r2.x) * (c3.w) + (-(r3.x));
    r1.z = (r3.z) * (-(r4.x)) + (r0.y);
    r1.xy = (r0.xz) * (r4.yy);
    r0.y = (r2.y) * (c3.w) + (-(r1.x));
    r0.x = dot(r6.xy, r6.xy) + (c12.y);
    r0.y = (r0.z) * (-(r4.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r8.y = (r1.z) + (r1.z);
