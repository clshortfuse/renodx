// Mechanically reconstructed from 0xEB15073C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r13.y = (r2.z) * (-(r2.z)) + (c1.y);
    r14.w = (r2.z) * (r2.z);
    r4.w = (r13.y) * (r4.w) + (r14.w);
    r7.w = ((r3.w) >= 0.0f ? (r1.y) : (c1.z));
    ...
    r13.z = (r2.w) * (c3.z);
    r2.z = saturate(dot(r7.xyz, r9.xyz));
    r3.z = saturate(dot(r9.xyz, -(r6.xyz)));
    r2.y = (r2.z) * (r13.w) + (r13.z);
    r12.w = (r3.z) * (r13.w) + (r13.z);
    r0.xyz = (r0.xyz) * (c3.xxx);
    r2.y = (r2.y) * (r12.w) + (c4.x);
    ...
    r2.w = pow(abs(r3.y), r11.w);
    r9.w = (r11.w) * (c4.y) + (c4.z);
    r2.w = (r2.w) * (r9.w);
    r2.y = (-(r3.z)) + (c1.y);
    r2.w = (r3.w) * (r2.w);
    r3.w = (r2.y) * (r2.y);
    ...
    r3.y = (r13.y) * (r13.x) + (r14.w);
    r2.w = (r10.w) * (r13.w) + (r13.z);
    r2.w = (r2.w) * (r12.w) + (c4.x);
