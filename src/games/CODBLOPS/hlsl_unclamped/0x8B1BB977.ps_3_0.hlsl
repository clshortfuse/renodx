// Mechanically reconstructed from 0x8B1BB977.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s7, v6.xy);
    r4.xyz = float3(((r6.w) >= 0.0f ? (r2.y) : (c[8].x)), ((r6.w) >= 0.0f ? (r2.y) : (c[8].y)), ((r6.w) >= 0.0f ? (r2.y) : (c[8].w)));
    r3 = (r2.wwww) * (c3.xxxy) + (c3.zzzx);
    r2.xyz = v2.xyz;
    r7.xyz = (r8.xxx) * (v4.xyz) + (r2.xyz);
    r2.xyz = -(r4.xyz);
    r7.xyz = (r8.yyy) * (v3.xyz) + (r7.xyz);
    r2.w = (r2.y) + (-(c2.y));
    r10.xyz = normalize(r7.xyz);
    r9.xyz = (r5.www) * (r2.xwz) + (r4.xyz);
