// Mechanically reconstructed from 0x4280CAA9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = saturate(dot(r15.xyz, c[17].xyz));
    ...
    r1 = tex2D(s4, v1.xy);
    r13.xyz = (r1.xyz) * (-(r1.xyz)) + (c0.www);
    r14.xyz = (r1.xyz) * (r1.xyz);
    r13.w = (r1.w) * (-(c12.x)) + (c12.y);
    r14.w = (r1.w) * (c12.x);
    r9.xyz = normalize(v2.xyz);
    r6.w = saturate(dot(r8.xyz, r9.xyz));
    r0.z = saturate(dot(r9.xyz, -(r2.xyz)));
    r0.w = (r6.w) * (r13.w) + (r14.w);
    r12.w = (r0.z) * (r13.w) + (r14.w);
    r7.xyz = (r13.xyz) * (r2.www) + (r14.xyz);
    r0.y = (r0.w) * (r12.w) + (c12.z);
    r0.w = (r1.w) * (c0.y);
    r0.y = 1.0f / (r0.y);
    r1.z = (r6.w) * (r0.y);
    r0.z = (-(r0.z)) + (c0.w);
    ...
    r0.x = 1.0f / (r0.x);
    r11.w = exp2(r0.y);
    r1.y = saturate(dot(r9.xyz, r3.xyz));
    r1.w = (r0.z) * (r0.x);
    r0.y = pow(abs(r1.y), r11.w);
    ...
    r1.z = (r10.w) * (r13.w) + (r14.w);
    r1.z = (r1.z) * (r12.w) + (c12.z);
    r2.w = saturate(dot(r9.xyz, r15.xyz));
    r1.y = 1.0f / (r1.z);
    r1.z = pow(abs(r2.w), r11.w);
    r1.y = (r10.w) * (r1.y);
    r1.z = (r9.w) * (r1.z);
    r2.w = (r1.y) * (r1.z);
    r1.xyz = (r13.xyz) * (r8.www) + (r14.xyz);
    r1.xyz = (r2.www) * (r1.xyz);
    r1.xyz = (r1.xyz) * (c[37].www);
    r1.xyz = (r0.www) * (r1.xyz);
    r2.xyz = (r1.xyz) * (c[19].xyz);
    r1.xyz = (r1.www) * (r11.xyz) + (r12.xyz);
    r3.xyz = (r1.www) * (r2.xyz);
    r2.xyz = (r10.xyz) * (c[37].xxx);
    r3.xyz = (r6.xyz) * (r1.xyz) + (r3.xyz);
    r1.xyz = (r7.xyz) * (r7.www);
    r7.xyz = (r2.xyz) * (r0.xyz) + (r3.xyz);
    r1.w = dot(r8.xyz, c[30].xyz);
    ...
    r2.xy = (r0.xy) * (-(c4.ww)) + (-(c4.yy));
    r0.xy = (r0.xy) * (r0.xy);
    r0.w = ((-abs(r0.w)) >= 0.0f ? (c12.w) : (r0.z));
    r0.z = (r2.x) * (r0.x);
    r0.w = (r0.w) * (r0.z);
    r0.z = (r0.y) * (-(r2.y)) + (c0.w);
    r0.xy = (r1.ww) * (r1.xy);
