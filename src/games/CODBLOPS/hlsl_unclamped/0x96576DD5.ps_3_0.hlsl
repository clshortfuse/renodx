// Mechanically reconstructed from 0x96576DD5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = (r2.xyz) * (c0.www);
    r1.z = (-(r4.w)) + (c2.x);
    r10.xyz = (r5.xyz) * (r5.www) + (-(r0.xyz));
    r0.z = (r1.z) * (r1.z);
    r0.z = (r1.z) * (r0.z);
