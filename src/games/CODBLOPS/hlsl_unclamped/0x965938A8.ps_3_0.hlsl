// Mechanically reconstructed from 0x965938A8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyw = c[34].xyw;
    r1.xyz = (-(r0.xyw)) + (c[35].xyw);
    r0 = tex2D(s5, v7.zw);
    r4.w = (r0.w) * (v0.z);
    r4.xyz = (r3.www) * (r1.xyz) + (c[34].xyw);
    r3.xyz = lerp(r5.xyz, r0.xyz, r4.www);
    r0 = tex2D(s10, v7.zw);
    r1 = lerp(r2, r0, r4.wwww);
    r0 = tex2D(s6, v8.xy);
    r0.xyz = (r0.xyz) + (c39.yyy);
    r8.xyz = lerp(r4.xyz, c[36].xyw, r4.www);
    r0.xyz = (v0.www) * (r0.xyz) + (c39.www);
    r7.xy = (r4.ww) * (-(r6.xy)) + (r6.xy);
    r4.xyz = (r1.xyz) * (r0.xyz);
    r0.xyz = (r3.xyz) * (r0.xyz);
    r0.w = dot(r7.xy, r7.xy) + (c39.z);
    ...
    r0.y = (r2.x) * (c4.w) + (-(r1.x));
    r0.w = dot(r9.xy, r7.xy) + (c39.z);
    r1.z = (r3.z) * (-(r6.x)) + (r0.y);
    r3.xy = (r0.xz) * (r6.yy);
    r0.x = dot(r9.xy, r9.xy) + (c39.z);
    r0.y = (r2.y) * (c4.w) + (-(r3.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r0.z) * (-(r6.y)) + (r0.y);
    r0.z = (r0.x) * (c3.x) + (c3.y);
