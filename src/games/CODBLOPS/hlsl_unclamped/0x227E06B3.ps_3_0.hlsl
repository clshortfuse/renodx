// Mechanically reconstructed from 0x227E06B3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = tex2D(s5, v7.zw);
    r1.xyz = (r3.xyz) + (c14.yyy);
    r3.w = 1.0f / (r13.x);
    r11.xyz = (v0.zzz) * (r1.xyz) + (c14.xxx);
    r3.w = (r4.z) * (r3.w);
    r1.xyz = (r11.xyz) * (c14.zzz);
    r4.xyz = (r1.xyz) * (r1.xyz);
    r1.xyz = (r1.xyz) * (-(r1.xyz)) + (c14.xxx);
