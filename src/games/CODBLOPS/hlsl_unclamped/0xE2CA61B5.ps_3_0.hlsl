// Mechanically reconstructed from 0xE2CA61B5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xy = (r3.xz) * (r6.yy);
    r0.y = (r2.y) * (c10.x) + (-(r3.x));
    r4.xz = (r3.xy) * (c10.yy);
    r1.w = (r3.z) * (-(r6.y)) + (r0.y);
    r0.xy = (r0.xz) * (r6.xx);
    r4.y = (r1.w) + (r1.w);
    r1.w = (r2.x) * (c10.x) + (-(r0.x));
