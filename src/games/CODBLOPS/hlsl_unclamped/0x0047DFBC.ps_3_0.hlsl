// Mechanically reconstructed from 0x0047DFBC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = (r1.w) * (r1.w);
    r1.w = (r1.w) * (r1.z);
    r1.xy = (r0.ww) * (c13.xy) + (c13.zw);
    r1.z = 1.0f / (r1.x);
    r3.w = exp2(r1.y);
    r1.z = (r1.w) * (r1.z);
    r1.w = dot(r5.xyz, r9.xyz);
    r10.xyz = (r0.xyz) * (r1.zzz) + (r7.xyz);
    r1.w = (r1.w) + (r1.w);
