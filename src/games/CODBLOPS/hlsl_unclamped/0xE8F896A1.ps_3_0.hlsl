// Mechanically reconstructed from 0xE8F896A1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s3, v1.xy);
    r2.xyz = (r1.xyz) * (-(r1.xyz)) + (c0.www);
    r3.xyz = (r1.xyz) * (r1.xyz);
    r0.xyz = (r2.xyz) * (r4.www) + (r3.xyz);
    r1.z = (r1.w) * (-(c3.x)) + (c3.y);
    r6.z = (r1.w) * (c3.x);
