// Mechanically reconstructed from 0x2E11CB8C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = c2.w;
    r4.xyz = float3(((r9.w) >= 0.0f ? (r6.w) : (c[28].x)), ((r9.w) >= 0.0f ? (r6.w) : (c[28].y)), ((r9.w) >= 0.0f ? (r6.w) : (c[28].w)));
    r2 = tex2D(s6, v6.zw);
    r10.xyz = (-(v5.xyz)) + (c[20].xyz);
    r9.y = dot(r10.xyz, r10.xyz);
    r7.w = rsqrt(r9.y);
    r9.x = 1.0f / (r7.w);
    r7.xy = saturate((r9.xx) * (c[24].xy) + (c[24].zw));
    r6.xy = (r7.xy) * (r7.xy);
    r7.xy = (r7.xy) * (c16.xx) + (c16.yy);
    r0.w = dot(c[23].yz, r9.xy) + (c[23].x);
    r6.xy = (r6.xy) * (r7.xy);
