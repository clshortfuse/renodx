// Mechanically reconstructed from 0x2E3B61C8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xy = (c[24].zz) * (r1.xy) + (r0.xy);
    r0 = tex2D(s0, v1.xy);
    r6.z = (r0.w) * (v0.w) + (c0.x);
    r4.xy = float2(((r6.z) >= 0.0f ? (r1.x) : (c0.z)), ((r6.z) >= 0.0f ? (r1.y) : (c0.z)));
    r1 = v2;
    ...
    r0.w = dot(r1.xyz, c[10].xyz);
    r0.w = saturate((r0.w) * (c[11].x) + (c[11].y));
    r4.z = (r0.w) * (c[11].w);
    r0 = (r0.xyzx) * (c0.yyyz) + (c0.zzzy);
    r3.w = lerp(r2.w, r4.y, r4.z);
    r4.xyz = (r2.xyz) * (r2.xyz);
    r5.x = 1.0f / (r4.w);
    r2.w = dot(c[20].yz, r5.xy) + (c[20].x);
    r5.xy = saturate((r5.xx) * (c[21].xy) + (c[21].zw));
    r2.xy = (r5.xy) * (r5.xy);
    r5.xy = (r5.xy) * (c2.zz) + (c2.ww);
    r5.xy = (r2.xy) * (r5.xy);
    r9.xyz = normalize(v7.xyz);
    r2.w = (r2.w) * (r5.x);
    r2.xyz = (r3.xyz) * (r4.www) + (-(r9.xyz));
    r2.w = (r5.y) * (r2.w);
    r3.xyz = normalize(r2.xyz);
    r5.w = (r3.w) * (r2.w);
    r4.w = saturate(dot(r8.xyz, r3.xyz));
    r2 = tex2D(s3, v1.xy);
    r2 = float4(((r6.z) >= 0.0f ? (r2.x) : (c0.z)), ((r6.z) >= 0.0f ? (r2.y) : (c0.z)), ((r6.z) >= 0.0f ? (r2.z) : (c0.z)), ((r6.z) >= 0.0f ? (r2.w) : (c0.y)));
    ...
    r1.y = (r2.w) * (-(c3.x)) + (c3.y);
    r1.z = (r6.w) * (r1.y) + (r3.x);
    r3.y = saturate(dot(r8.xyz, -(r9.xyz)));
    r1.y = (r3.y) * (r1.y) + (r3.x);
    r4.w = (-(r3.y)) + (c0.y);
    r1.y = (r1.z) * (r1.y) + (c3.z);
    r1.z = (-(r3.z)) + (c0.y);
    ...
    r1.y = c0.z;
    r1.xyz = float3(((r6.z) >= 0.0f ? (c[23].x) : (r1.y)), ((r6.z) >= 0.0f ? (c[23].y) : (r1.y)), ((r6.z) >= 0.0f ? (c[23].w) : (r1.y)));
    r2.xyz = (r2.xyz) * (r1.zzz);
    r10.xy = c[9].xy;
    r5.xyz = (r10.yyy) * (c[8].xyz);
    r0 = float4(((r6.z) >= 0.0f ? (r0.x) : (c0.z)), ((r6.z) >= 0.0f ? (r0.y) : (c0.z)), ((r6.z) >= 0.0f ? (r0.z) : (c0.z)), ((r6.z) >= 0.0f ? (r0.w) : (c0.z)));
