// Mechanically reconstructed from 0x565883B5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = tex2D(s13, r3.xy);
    r1.w = r3.y;
    r11.xyz = lerp(r2.yyy, c[8].xyw, r6.www);
    r2.xy = (r1.wy) * (c4.yy) + (c4.zz);
    r1.y = dot(r5.xy, r5.xy) + (c3.x);
