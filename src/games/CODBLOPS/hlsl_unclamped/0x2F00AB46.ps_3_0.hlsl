// Mechanically reconstructed from 0x2F00AB46.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r7.z = (r0.w) * (v0.w) + (c0.x);
    r2.xy = float2(((r7.z) >= 0.0f ? (r1.x) : (c0.z)), ((r7.z) >= 0.0f ? (r1.y) : (c0.z)));
    ...
    r2 = tex2D(s2, v1.xy);
    r2 = float4(((r7.z) >= 0.0f ? (r2.x) : (c0.z)), ((r7.z) >= 0.0f ? (r2.y) : (c0.z)), ((r7.z) >= 0.0f ? (r2.z) : (c0.z)), ((r7.z) >= 0.0f ? (r2.w) : (c0.y)));
    r1.y = saturate(dot(r4.xyz, -(r10.xyz)));
    r3.z = (r2.w) * (c2.y);
    r1.z = (r2.w) * (-(c2.y)) + (c2.z);
    r8.w = saturate(dot(r4.xyz, c[17].xyz));
    r1.x = (r1.y) * (r1.z) + (r3.z);
    r1.z = (r8.w) * (r1.z) + (r3.z);
    ...
    r8.xyz = (r2.xyz) * (-(r2.xyz)) + (c0.yyy);
    r2.z = (r3.w) * (r1.y);
    r1.xyz = (r8.xyz) * (r1.zzz) + (r9.xyz);
    r1.xyz = (r2.zzz) * (r1.xyz);
    r2.y = c0.z;
    r6.xyz = float3(((r7.z) >= 0.0f ? (c[7].x) : (r2.y)), ((r7.z) >= 0.0f ? (c[7].y) : (r2.y)), ((r7.z) >= 0.0f ? (c[7].w) : (r2.y)));
    r4.w = (r2.w) * (c0.w);
