// Mechanically reconstructed from 0x7E5A26C3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = (r6.xyz) * (r5.www) + (-(r8.xyz));
    r3.xyz = (r2.xyz) * (r3.www) + (r4.xyz);
    r5.w = exp2(r9.y);
    r3.xyz = (r1.xyz) * (r3.xyz);
    r12.yz = c1.yz;
    r11.xyz = float3(((r6.w) >= 0.0f ? (c[37].x) : (r12.z)), ((r6.w) >= 0.0f ? (c[37].y) : (r12.z)), ((r6.w) >= 0.0f ? (c[37].w) : (r12.z)));
