// Mechanically reconstructed from 0x03503466.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r1.x) * (r1.w);
    r15.xyz = (r3.xyz) * (r1.zzz) + (r4.xyz);
    r0.xyz = (r6.xxx) * (r2.xyz);
    r2.xyz = (r1.www) * (r15.xyz);
    r0.xyz = (r14.xyz) * (r0.xyz);
    ...
    r2.xyz = (r11.xyz) * (r11.www) + (-(r12.xyz));
    r1.w = (r6.w) * (c2.z);
