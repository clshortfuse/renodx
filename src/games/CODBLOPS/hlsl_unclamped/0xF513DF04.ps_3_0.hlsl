// Mechanically reconstructed from 0xF513DF04.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.z = (r2.z) * (-(r8.y)) + (r2.w);
    r9.y = (r0.w) + (r0.w);
    r0.w = dot(r7.xy, r7.xy) + (c42.z);
    r2.w = dot(r6.xy, r6.xy) + (c42.z);
    r0.w = exp2(-(r0.w));
    r2.w = exp2(-(r2.w));
    r0.w = (r0.w) * (c3.x) + (c3.y);
    r2.w = (r2.w) * (c3.x) + (c3.y);
    ...
    r0 = tex2D(s9, v7.xy);
    r13.xyz = lerp(c[39].xyw, r0.yyy, r5.www);
