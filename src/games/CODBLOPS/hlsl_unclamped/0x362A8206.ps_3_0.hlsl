// Mechanically reconstructed from 0x362A8206.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = lerp(r0.xy, r6.xy, r8.ww);
    r0 = tex2D(s4, v7.zw);
    r4.w = (r0.w) * (v0.z);
    r8.xy = lerp(r4.xy, r3.xy, r4.ww);
    r4.xyz = lerp(r2.xyz, r1.xyz, r8.www);
    r0.w = dot(r8.xy, r8.xy) + (c27.z);
    ...
    r2.xy = (r2.xz) * (r6.xx);
    r0.w = dot(r7.xy, r8.xy) + (c27.z);
    r0.y = (r1.x) * (c4.w) + (-(r2.x));
    r1.w = (r2.z) * (-(r6.x)) + (r0.y);
    r4.xy = (r0.xz) * (r6.yy);
    r0.y = (r1.y) * (c4.w) + (-(r4.x));
    r0.x = dot(r7.xy, r7.xy) + (c27.z);
    r0.y = (r0.z) * (-(r6.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r10.y = (r1.w) + (r1.w);
    r0.z = (r0.z) * (c4.x) + (c4.y);
    ...
    r4.xyz = (r10.xyz) * (r3.www) + (r0.xyz);
    r1 = tex2D(s8, v7.zw);
    r7.zw = c27.zw;
    r7.xyz = (r7.zwz) + (-(c[23].xyw));
    r2 = (r1.wwww) * (c3.xxxy) + (c3.zzzx);
    r3 = tex2D(s7, v1.xy);
    r0 = lerp(r3, r2, r4.wwww);
    r2.xyz = (r8.www) * (r7.xyz) + (c[23].xyw);
