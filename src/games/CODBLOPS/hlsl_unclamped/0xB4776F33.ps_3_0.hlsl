// Mechanically reconstructed from 0xB4776F33.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xy = (-(r0.xy)) + (c[21].xy);
    r4.xz = (r2.xy) * (c3.xx);
    r0.xy = (r6.ww) * (r0.xy) + (c[20].xy);
    r4.y = (r0.z) * (-(r3.x)) + (r0.w);
    r8.xy = lerp(r0.xy, c[22].xy, r5.ww);
    r1 = tex2D(s5, v1.xy);
    r0 = tex2D(s6, v7.xy);
    r3 = lerp(r1, r0, r6.wwww);
    r1 = tex2D(s7, v7.zw);
    r0 = v2;
