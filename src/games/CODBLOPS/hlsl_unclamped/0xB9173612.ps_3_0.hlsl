// Mechanically reconstructed from 0xB9173612.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = exp2(-(r0.z));
    r1 = tex2D(s6, v0.xy);
    r8.z = (r1.w) * (-(c31.z)) + (c31.w);
    r8.y = (r1.w) * (c3.z);
    r4.w = saturate(dot(r2.xyz, r10.xyz));
    r9.w = saturate(dot(r10.xyz, -(r11.xyz)));
    r0.z = (r4.w) * (r8.z) + (r8.y);
    r6.z = (r9.w) * (r8.z) + (r8.y);
    r0.z = (r0.z) * (r6.z) + (c14.x);
    r13.xy = (r1.ww) * (c30.xy) + (c30.zw);
    r0.y = 1.0f / (r0.z);
    r6.w = exp2(r13.y);
    r0.z = pow(abs(r2.w), r6.w);
    r5.z = (r6.w) * (c14.y) + (c14.z);
    r0.y = (r4.w) * (r0.y);
    r0.z = (r0.z) * (r5.z);
    r5.w = (r0.x) * (c3.x) + (c3.y);
    r0.z = (r0.y) * (r0.z);
    ...
    r0.y = (r2.w) * (v7.y) + (c1.x);
    r0.z = (r4.z) * (r0.z);
    r2.xyz = float3(((r0.y) >= 0.0f ? (r2.x) : (r3.x)), ((r0.y) >= 0.0f ? (r2.y) : (r3.y)), ((r0.y) >= 0.0f ? (r2.z) : (r3.z)));
    r8.w = ((r0.y) >= 0.0f ? (c1.y) : (r1.y));
    r0.xyz = (r0.zzz) * (c[7].xyz);
    r1.xyz = (r2.xyz) * (r2.xyz);
    r3.xyz = (r8.www) * (r0.xyz);
    ...
    r0.xy = (r4.yw) * (c31.xx) + (c31.yy);
    r3 = tex2D(s14, v0.zw);
    r6.xy = (r3.xy) * (c3.ww);
    r0.z = dot(r0.xy, r5.xy) + (c1.z);
    r4.xy = (r4.xz) * (r6.xx);
    r2.w = (r3.x) * (c3.w) + (-(r4.x));
    r5.xy = (r2.xz) * (r6.yy);
    r2.y = (r4.z) * (-(r6.x)) + (r2.w);
    r2.w = (r3.y) * (c3.w) + (-(r5.x));
    r2.w = (r2.z) * (-(r6.y)) + (r2.w);
    r0.y = dot(r0.xy, r0.xy) + (c1.z);
    r9.y = (r2.y) + (r2.y);
    r0.x = exp2(-(r0.y));
    r0.y = (r2.w) + (r2.w);
    r0.x = (r0.x) * (c3.x) + (c3.y);
    r0.x = (r5.w) * (r0.x);
    r3.xyz = (v6.xyz) * (-(r8.xxx)) + (c[17].xyz);
