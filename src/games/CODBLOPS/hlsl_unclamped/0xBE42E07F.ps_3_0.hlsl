// Mechanically reconstructed from 0xBE42E07F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xz = (r1.xy) * (c2.yy);
    r3.y = (r1.w) + (r1.w);
    r1.xyz = (r0.xyz) * (r0.xyz) + (-(r4.xyz));
    r0.xyz = (r3.xyz) * (r0.www) + (r2.xyz);
    r4.xyz = (v4.www) * (r1.xyz) + (r4.xyz);
