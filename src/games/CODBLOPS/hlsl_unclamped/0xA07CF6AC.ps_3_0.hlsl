// Mechanically reconstructed from 0xA07CF6AC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s2, v6.xy);
    r4.w = (r1.w) * (v0.y) + (c2.w);
    r2.xy = (r0.yw) * (c9.xx) + (c9.yy);
    r6.xy = float2(((r4.w) >= 0.0f ? (r4.x) : (r5.x)), ((r4.w) >= 0.0f ? (r4.y) : (r5.y)));
    ...
    r5.xz = (r0.xy) * (c4.ww);
    r5.y = (r0.z) + (r0.z);
    r4.xyz = (r5.xyz) * (r0.www) + (r2.xyz);
    r2 = tex2D(s6, v1.xy);
    r0 = tex2D(s7, v6.xy);
    r7.xy = float2(((r4.w) >= 0.0f ? (r0.w) : (r2.w)), ((r4.w) >= 0.0f ? (r0.y) : (r2.y)));
    r0 = tex2D(s3, v6.zw);
    r2.xyz = v2.xyz;
