// Mechanically reconstructed from 0x2A615D84.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyz = (r0.xyz) + (c13.yyy);
    r0 = v2;
    r0.xyz = (r14.xxx) * (v5.xyz) + (r0.xyz);
    r6.xyz = (v0.zzz) * (r3.xyz) + (c13.xxx);
    ...
    r2.w = dot(r14.xy, r14.xy) + (c13.w);
    r0.z = dot(r0.xy, r0.xy) + (c13.w);
    r2.w = exp2(-(r2.w));
    r0.z = exp2(-(r0.z));
    r2.w = (r2.w) * (c1.x) + (c1.y);
    r2.y = (r0.z) * (c1.x) + (c1.y);
    r0.z = dot(r0.xy, r14.xy) + (c13.w);
    r0.y = (r2.w) * (r2.y);
    r3 = tex2D(s14, v1.zw);
    r14.xy = (r3.xy) * (c2.ww);
