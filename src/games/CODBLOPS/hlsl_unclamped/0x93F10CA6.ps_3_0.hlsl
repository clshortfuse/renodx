// Mechanically reconstructed from 0x93F10CA6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = dot(r4.xy, r4.xy) + (c12.x);
    r0.w = dot(r6.xy, r6.xy) + (c12.x);
    r1.w = exp2(-(r1.w));
    r0.w = exp2(-(r0.w));
    r1.z = (r1.w) * (c12.z) + (c12.w);
    r0.w = (r0.w) * (c12.z) + (c12.w);
    r1.w = dot(r4.xy, r6.xy) + (c12.x);
    r1.z = (r1.z) * (r0.w);
    ...
    r0.xy = c12.xy;
    r3.xyz = (r0.xyx) + (-(c[29].xyw));
    r4.z = saturate(dot(r14.xyz, r4.xyz));
    r1 = tex2D(s6, v0.xy);
    r11.xyz = (r1.xyz) * (-(r1.xyz)) + (c12.yyy);
    ...
    r0.z = (r0.z) * (r10.w) + (c4.z);
    r17.xy = (r1.ww) * (c16.xy) + (c16.zw);
    r0.y = 1.0f / (r0.z);
    r9.w = exp2(r17.y);
    r0.z = pow(abs(r4.z), r9.w);
    ...
    r2 = tex2D(s12, v0.zw);
    r0.z = ((-abs(r2.y)) >= 0.0f ? (c12.y) : (c12.x));
    ...
    r2.xy = (r2.xy) * (r2.xy);
    r0.z = ((-abs(r0.z)) >= 0.0f ? (c12.x) : (r2.w));
    r2.w = (r3.x) * (r2.x);
    r0.z = (r0.z) * (r2.w);
    r2.w = (r2.y) * (-(r3.y)) + (c12.y);
    r0.xy = (r3.ww) * (r0.xy);
    r0.z = (r0.z) * (r2.w);
    r3.w = (r4.z) * (r0.z);
