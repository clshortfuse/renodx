// Mechanically reconstructed from 0x27E2AD71.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.z = dot(r16.xy, r16.xy) + (c1.y);
    r0.z = dot(r0.xy, r0.xy) + (c1.y);
    r2.z = exp2(-(r2.z));
    r0.z = exp2(-(r0.z));
    r2.z = (r2.z) * (c1.z) + (c1.w);
    r2.y = (r0.z) * (c1.z) + (c1.w);
    r0.z = dot(r0.xy, r16.xy) + (c1.y);
    r0.y = (r2.z) * (r2.y);
    r5 = tex2D(s14, v0.zw);
    r8.xy = (r5.xy) * (c3.ww);
