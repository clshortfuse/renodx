// Mechanically reconstructed from 0x875D67E5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xz = (r3.xy) * (c8.xx);
    r6.w = (r2.w) * (r3.w);
    r5.xyz = (r7.xyz) * (r0.www) + (r0.xyz);
    r2 = tex2D(s6, v1.xy);
    r3 = tex2D(s0, v1.xy);
    r0 = v2;
    r0.xyz = (r4.xxx) * (v5.xyz) + (r0.xyz);
    r13.xyz = lerp(r3.xyz, r1.xyz, r5.www);
    r8.xyz = (r4.yyy) * (v4.xyz) + (r0.xyz);
    r3.w = -(r2.w);
    r3.xyz = c1.xxx;
    r1 = tex2D(s7, v8.xy);
    r1 = (r3) + (r1);
    ...
    r2.xyz = (r2.www) * (r16.xyz) + (r17.xyz);
    r0.xyz = (r15.xyz) * (c[19].xyz);
    r3.xyz = (r2.www) * (r0.xyz);
    r0.xyz = (r13.xyz) * (r14.xyz);
    r5.xyz = (r12.xyz) * (r0.xyz);
    r0.z = (-(r7.w)) + (c1.z);
    r0.x = 1.0f / (r18.x);
    r0.y = (r0.z) * (r0.z);
    r0.y = (r0.z) * (r0.y);
