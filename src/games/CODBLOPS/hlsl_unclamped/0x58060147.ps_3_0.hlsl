// Mechanically reconstructed from 0x58060147.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = dot(c[25].yz, r1.xy) + (c[25].x);
    r3.xy = saturate((r1.xx) * (c[26].xy) + (c[26].zw));
    r1.xy = (r3.xy) * (r3.xy);
    r3.xy = (r3.xy) * (c1.xx) + (c1.yy);
    r1.xy = (r1.xy) * (r3.xy);
    r1.w = dot(r9.xyz, c[23].xyz);
    r1.x = (r3.w) * (r1.x);
    ...
    r7.z = rsqrt(r3.z);
    r7.w = rsqrt(r3.w);
    r8.xyz = (r8.xyz) * (c1.zzz);
    r6 = (r6) * (r7);
    r6 = (r10.yyyy) * (r6);
    r5 = (r5) * (r7);
    r4 = (r4) * (r7);
    r5 = (r5) * (r10.xxxx) + (r6);
    r3 = saturate((r3) * (c[9]) + (r11.zzzz));
    r4 = saturate((r4) * (r10.zzzz) + (r5));
    r1.y = saturate(dot(r9.xyz, r10.xyz));
    r3 = (r3) * (r4);
    r5.xyz = (r1.yyy) * (c[22].xyz);
    r4.x = dot(c[10], r3);
    r4.y = dot(c[11], r3);
    r4.z = dot(c[20], r3);
    r3.xyz = (r1.www) * (r5.xyz) + (r8.xyz);
