// Mechanically reconstructed from 0x469C400C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.xyz = (v0.yyy) * (r3.xyz) + (c2.yyy);
    r3 = tex2D(s4, v7.zw);
    r7.xyz = (r3.xyz) + (c2.xxx);
    r3.xyz = (r2.xyz) * (r9.xyz);
    r2.xyz = (v0.zzz) * (r7.xyz) + (c2.yyy);
