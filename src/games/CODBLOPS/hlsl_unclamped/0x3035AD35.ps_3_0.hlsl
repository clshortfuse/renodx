// Mechanically reconstructed from 0x3035AD35.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = (r0.w) * (c1.w);
    r2.w = (r0.w) * (-(c1.w)) + (c1.z);
    r2.z = dot(r10.xyz, c[17].xyz);
    r3.w = (r2.x) * (r2.w) + (r2.y);
    r1.w = saturate(r2.z);
    r5.z = (-(r2.x)) + (c1.z);
    r2.w = (r1.w) * (r2.w) + (r2.y);
    r2.xyz = (abs(r2.zzz)) * (c[18].xyz);
    r2.w = (r2.w) * (r3.w) + (c2.x);
    r2.w = 1.0f / (r2.w);
