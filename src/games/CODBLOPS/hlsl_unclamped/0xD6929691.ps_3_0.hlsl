// Mechanically reconstructed from 0xD6929691.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = (r0.w) * (c4.z) + (c4.w);
    r0.w = dot(r1.xy, r4.xy) + (c3.w);
    r0.y = (r3.w) * (r0.y);
    r1 = tex2D(s14, v1.zw);
    r5.xy = (r1.xy) * (c10.zz);
    r0.w = saturate((r0.w) * (r0.y) + (r0.y));
    r3.xy = (r2.xz) * (r5.xx);
    r0.y = (r1.x) * (c10.z) + (-(r3.x));
    r2.xy = (r0.xz) * (r5.yy);
    r0.y = (r2.z) * (-(r5.x)) + (r0.y);
    r0.x = (r1.y) * (c10.z) + (-(r2.x));
    r0.z = (r0.z) * (-(r5.y)) + (r0.x);
    r6.y = (r0.y) + (r0.y);
    r0.y = (r0.z) + (r0.z);
    r0.xz = (r2.xy) * (c10.ww);
    ...
    r8.xyz = lerp(r1.yyy, c[8].xyw, r9.www);
    r1.w = rsqrt(r2.w);
