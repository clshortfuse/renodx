// Mechanically reconstructed from 0x4B3FC4B9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = dot(r1.xyz, c[38].xyz);
    r0.z = saturate((r0.z) * (c[39].x) + (c[39].y));
    r7.x = 1.0f / (r0.w);
    r0.x = (r0.z) * (c[39].w);
    r5.xy = saturate((r7.xx) * (c[41].xy) + (c[41].zw));
    r3.xy = (r5.xy) * (r5.xy);
    r5.xy = (r5.xy) * (c12.xx) + (c12.yy);
    r0.z = dot(c[40].yz, r7.xy) + (c[40].x);
    r3.xy = (r3.xy) * (r5.xy);
