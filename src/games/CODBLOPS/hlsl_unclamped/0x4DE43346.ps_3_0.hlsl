// Mechanically reconstructed from 0x4DE43346.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.x = dot(r3, c[29]);
    r5.y = (r5.x) * (r5.x);
    r3.y = dot(c[24].yz, r5.xy) + (c[24].x);
    r3.z = saturate(1.0f / (r3.y));
    r3.y = ((-abs(r3.y)) >= 0.0f ? (c0.x) : (r3.z));
    r3.zw = saturate((r5.xx) * (c[25].xy) + (c[25].zw));
    r5.xy = (r3.zw) * (r3.zw);
    ...
    r3.z = (r5.y) * (-(r3.w)) + (c0.z);
    r3.y = (r3.y) * (r3.z);
    r3.z = dot(r4.xyz, c[30].xyz);
    r3.z = saturate((r3.z) * (c[31].x) + (c[31].y));
    r3.w = (r3.z) * (r3.z);
    r3.z = (r3.z) * (c3.x) + (c3.y);
    r3.z = (r3.w) * (r3.z);
    r3.y = (r3.y) * (r3.z);
