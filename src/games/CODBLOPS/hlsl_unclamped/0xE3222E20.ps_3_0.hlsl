// Mechanically reconstructed from 0xE3222E20.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s7, v0.xy);
    r0 = tex2D(s8, v7.zw);
    r13.xy = lerp(r1.wy, r0.wy, r3.ww);
    r8.xyz = (r2.xyz) * (r2.xyz);
    r8.w = (r13.x) * (-(c31.z)) + (c31.w);
    ...
    r0.xy = (r3.yw) * (c31.xx) + (c31.yy);
    r2 = tex2D(s14, v0.zw);
    r5.xy = (r2.xy) * (c1.ww);
    r0.z = dot(r0.xy, r4.xy) + (c3.z);
    r3.xy = (r3.xz) * (r5.xx);
    r1.w = (r2.x) * (c1.w) + (-(r3.x));
    r4.xy = (r1.xz) * (r5.yy);
    r1.y = (r3.z) * (-(r5.x)) + (r1.w);
