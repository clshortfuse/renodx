// Mechanically reconstructed from 0x77F04052.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyz = (r1.yyy) * (r0.xyz) + (r5.xyz);
    r1.w = (-(r1.w)) + (c1.y);
    r5.xyz = (r1.xxx) * (v6.xyz);
    r1.x = (r1.w) * (r1.w);
    ...
    r8.z = dot(r5.xyz, r10.xyz);
    r1.xyz = (r1.yyy) * (r4.xyz);
    r8.z = (r8.z) + (r8.z);
    r4.xyz = (r6.xyz) * (r0.xyz) + (r1.xyz);
    r1.xyz = (r10.xyz) * (-(r8.zzz)) + (r5.xyz);
