// Mechanically reconstructed from 0xB49A8115.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = dot(r4.xy, r4.xy) + (c13.w);
    r1.x = exp2(-(r1.x));
    r2.w = exp2(-(r2.w));
    r1.x = (r1.x) * (c1.x) + (c1.y);
    r2.z = (r2.w) * (c1.x) + (c1.y);
    r2.w = dot(r4.xy, r8.xy) + (c13.w);
    r2.z = (r1.x) * (r2.z);
    r4 = tex2D(s14, v1.zw);
    r13.xy = (r4.xy) * (c2.ww);
