// Mechanically reconstructed from 0x1C486764.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.y = (r2.w) + (r2.w);
    r2.xyz = (r11.www) * (r0.xyz) + (c[31].xyw);
    r0.xyz = (r7.xyz) * (r1.www) + (r4.xyz);
    r11.xyz = lerp(r2.xyz, c[33].xyw, r10.www);
    ...
    r3.w = (r3.w) * (r7.w) + (c4.x);
    r8.xyz = (r2.yyy) * (r0.xyz) + (r8.xyz);
    r0.z = 1.0f / (r3.w);
    r5.xyz = (v6.xyz) * (-(r2.xxx)) + (c[17].xyz);
    r9.w = (r1.w) * (r0.z);
    ...
    r0.xyz = lerp(r13.xyz, r1.xyz, r10.www);
