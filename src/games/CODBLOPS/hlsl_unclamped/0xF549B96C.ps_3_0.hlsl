// Mechanically reconstructed from 0xF549B96C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = v2;
    r4.xyz = (r8.xxx) * (v5.xyz) + (r0.xyz);
    r0.xyz = (r3.xyz) * (c1.www);
    r4.xyz = (r8.yyy) * (v4.xyz) + (r4.xyz);
    ...
    r7.w = ((r3.w) >= 0.0f ? (c1.y) : (r2.y));
    r11.xyz = (r4.www) * (c[21].xyz);
    r0.xyz = (r0.xyz) * (r7.www);
    r6.w = 1.0f / (r4.x);
    r0.xyz = (r0.xyz) * (c[22].xyz);
    r1.w = (r2.w) * (c2.w);
    r6.xyz = (r8.www) * (r0.xyz);
    r2 = tex2D(s0, v1.xy);
    r0.xyz = float3(((r3.w) >= 0.0f ? (r1.x) : (r2.x)), ((r3.w) >= 0.0f ? (r1.y) : (r2.y)), ((r3.w) >= 0.0f ? (r1.z) : (r2.z)));
    r1.xy = (v1.zw) * (-(c1.zx));
    r2 = tex2D(s13, r1.xy);
