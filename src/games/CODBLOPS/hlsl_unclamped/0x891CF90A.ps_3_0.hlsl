// Mechanically reconstructed from 0x891CF90A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.y = (r0.w) + (r0.w);
    r0.w = (r6.w) * (r6.z);
    r0.xyz = (r11.xyz) * (r3.www) + (r1.xyz);
    r1 = tex2D(s7, v1.xy);
    r13.xy = float2(((r2.w) >= 0.0f ? (-(c2.z)) : (r1.y)), ((r2.w) >= 0.0f ? (-(c2.y)) : (r1.y)));
    r3.w = (r4.w) * (r0.w);
    r3.xyz = (r0.xyz) * (r13.yyy);
    r0 = tex2D(s12, v1.zw);
    r1.xyz = v2.xyz;
