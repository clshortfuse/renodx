// Mechanically reconstructed from 0x2DED704A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c4 = float4(0.00048828125f, -0.000122070312f, 0.0f, 0.0450000018f);
    ...
    r7.z = saturate(dot(c[17].xyz, r1.xyz));
    ...
    r1.w = dot(r4.xzy, c3.yyz);
    r1.xyz = (r4.www) * (c[18].xyz);
    r0.xyz = c[22].xyz;
    r0.xyz = (-(r0.xyz)) + (c[23].xyz);
    r0.xyz = (r3.www) * (r0.xyz) + (c[22].xyz);
    r2.xyz = (r1.xyz) * (r7.www) + (r4.xyz);
    r1.xyz = (r1.xyz) * (r7.zzz) + (r1.www);
    r0.xyz = (r0.xyz) * (r2.xyz);
    r7.xyz = (r1.xyz) * (c[24].xyz);
