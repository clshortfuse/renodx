// Mechanically reconstructed from 0xE95A81FE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c8 = float4(0.0f, 1.0f, 0.600000024f, 0.400000006f);
    ...
    r0.y = dot(r5.xy, r5.xy) + (c8.x);
    r0.w = dot(r1.xy, r1.xy) + (c8.x);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r2.w = (r0.y) * (c8.z) + (c8.w);
    r0.y = (r0.w) * (c8.z) + (c8.w);
    r0.w = dot(r1.xy, r5.xy) + (c8.x);
    r0.y = (r2.w) * (r0.y);
    r1 = tex2D(s14, v0.zw);
    r6.xy = (r1.xy) * (c3.ww);
    ...
    r0.xy = c8.xy;
    r3.xyz = (r0.xyx) + (-(c[5].xyw));
    r7.w = saturate(dot(r12.xyz, -(r13.xyz)));
    r1 = tex2D(s4, v0.xy);
    r9.xyz = (r1.xyz) * (-(r1.xyz)) + (c8.yyy);
    r0.z = (r1.w) * (-(c1.y)) + (c1.z);
    r0.x = (r1.w) * (c1.y);
