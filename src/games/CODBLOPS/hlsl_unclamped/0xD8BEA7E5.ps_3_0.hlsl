// Mechanically reconstructed from 0xD8BEA7E5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c43 = float4(2.0f, -1.0f, 0.0f, -0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r2.y = dot(r1.xy, r0.zw) + (c43.z);
    r2.x = dot(r1.xy, r0.xy) + (c43.z);
    r0 = tex2D(s1, v1.xy);
    ...
    r5.y = dot(r1.xy, r0.zw) + (c43.z);
    r5.x = dot(r1.xy, r0.xy) + (c43.z);
    r1 = tex2D(s10, v7.xy);
    r2 = tex2D(s9, v1.xy);
    r0 = tex2D(s6, v7.zw);
    r5.w = (r0.w) * (v0.z);
    r3 = lerp(r2, r1, r7.wwww);
    r11.xy = lerp(r6.xy, r5.xy, r5.ww);
    r1.xyz = lerp(r4.xyz, r0.xyz, r5.www);
    r0.w = dot(r11.xy, r11.xy) + (c43.z);
    ...
    r0.y = (r1.x) * (c4.w) + (-(r4.x));
    r0.w = dot(r7.xy, r11.xy) + (c43.z);
    r1.w = (r2.z) * (-(r6.x)) + (r0.y);
    r2.xy = (r0.xz) * (r6.yy);
    r0.x = dot(r7.xy, r7.xy) + (c43.z);
    r0.y = (r1.y) * (c4.w) + (-(r2.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r0.z) * (-(r6.y)) + (r0.y);
    r0.z = (r0.x) * (c3.x) + (c3.y);
    ...
    r8.xyz = (r9.xyz) * (r4.zzz) + (r1.xyz);
    r10.xyz = (r7.www) * (r0.xyz) + (c[39].xyw);
    r1 = tex2D(s11, v7.zw);
    r0.xyz = (-(v6.xyz)) + (c[20].xyz);
    r0.w = dot(r0.xyz, r0.xyz);
    r0.w = rsqrt(r0.w);
    r6.xyz = (r4.www) * (v6.xyz);
    r2 = (r1.wwww) * (-(c43.zzzy)) + (-(c43.wwwz));
    ...
    r1.z = (r1.w) * (r1.w);
    r11.w = (r0.w) * (-(c12.z)) + (c12.w);
    r1.z = (r1.z) * (r1.z);
    r14.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c43.yyy));
    r1.w = (r1.w) * (r1.z);
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (-(c43.y)) : (-(c43.z)));
