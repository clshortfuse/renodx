// Mechanically reconstructed from 0xDC22CDA2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = (r6.w) * (r2.x) + (r3.z);
    r14.xy = (r0.ww) * (c8.xy) + (c8.zw);
    r2.w = saturate(dot(r9.xyz, c[17].xyz));
    r1.w = exp2(r14.y);
    r0.z = (r2.w) * (r2.x) + (r3.z);
    r0.x = pow(abs(r2.y), r1.w);
    r0.z = (r0.z) * (r0.y) + (c4.x);
    r0.y = (r1.w) * (c4.y) + (c4.z);
    r0.z = 1.0f / (r0.z);
    r1.w = (r0.x) * (r0.y);
    r2.y = (r2.w) * (r0.z);
    r0.xyz = (r7.xyz) * (r3.www) + (r8.xyz);
    r1.w = (r1.w) * (r2.y);
