// Mechanically reconstructed from 0xABCB8422.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xyz = (r2.xyz) * (-(r2.xyz)) + (c1.xxx);
    r3.y = (r3.y) + (r3.y);
    r5.xyz = (r5.www) * (r1.xyz);
    r1.xyz = (r6.xyz) * (-(r3.yyy)) + (r7.xyz);
