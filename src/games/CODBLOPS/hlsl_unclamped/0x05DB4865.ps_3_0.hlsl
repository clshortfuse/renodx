// Mechanically reconstructed from 0x05DB4865.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c44 = float4(4.0f, -3.0f, -2.0f, 3.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0.xyw = c[39].xyw;
    r1.xyz = (-(r0.xyw)) + (c[40].xyw);
    r0 = tex2D(s6, v7.zw);
    r4.w = (r0.w) * (v0.z);
    r4.xyz = (r3.www) * (r1.xyz) + (c[39].xyw);
    r3.xyz = lerp(r5.xyz, r0.xyz, r4.www);
    r1 = tex2D(s10, v7.zw);
    r0 = lerp(r2, r1, r4.wwww);
    r7.xy = (r4.ww) * (-(r6.xy)) + (r6.xy);
    r13.xyz = lerp(r4.xyz, c[41].xyw, r4.www);
