// Mechanically reconstructed from 0x1353BF0B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = saturate((r6.xx) * (c[25].xy) + (c[25].zw));
    r2.w = dot(c[24].yz, r6.xy) + (c[24].x);
    r0.xy = (r4.xy) * (r4.xy);
