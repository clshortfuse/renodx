// Mechanically reconstructed from 0x0AA9E6EF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.z = saturate(dot(r12.xyz, r6.xyz));
    r0.x = (r0.w) * (c4.w);
