// Mechanically reconstructed from 0x63752DDD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.z = (r1.w) * (-(v7.y)) + (c14.w);
    r0 = tex2D(s0, v0.xy);
    r2.xyz = lerp(r0.xyz, r1.xyz, r3.www);
    r2.w = (r0.w) * (-(v7.x)) + (c14.w);
    r0.xy = (v0.zw) * (c3.xy) + (c3.zy);
    r0 = tex2D(s13, r0.xy);
    r1.xy = (v0.zw) * (c3.xy);
    r1 = tex2D(s13, r1.xy);
    r0.w = r1.y;
    r6.w = (r2.w) * (-(r3.z)) + (c14.w);
    r3.xy = (r0.wy) * (c4.xx) + (c4.yy);
    r0.w = dot(r5.xy, r5.xy) + (c14.z);
    r0.y = dot(r3.xy, r3.xy) + (c14.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c1.x) + (c1.y);
    r1.w = (r0.y) * (c1.x) + (c1.y);
    r0.y = dot(r3.xy, r5.xy) + (c14.z);
    r1.w = (r0.w) * (r1.w);
    ...
    r0.xyw = c[5].xyw;
    r4.xyz = (-(r0.xyw)) + (c[6].xyw);
    r12.xyz = (r5.zzz) * (v6.xyz);
    r2 = tex2D(s5, v0.xy);
    r1 = tex2D(s6, v7.zw);
