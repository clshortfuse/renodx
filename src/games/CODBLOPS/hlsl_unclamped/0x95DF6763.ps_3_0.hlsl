// Mechanically reconstructed from 0x95DF6763.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xy = (c[32].zz) * (r1.xy) + (r0.xy);
    r0.xyz = (r4.xyz) * (r1.www) + (-(r2.xyz));
    ...
    r2.w = dot(r0.xyz, c[23].xyz);
    r5.y = saturate(dot(r12.xyz, r1.xyz));
    r1.y = saturate((r2.w) * (c[24].x) + (c[24].y));
    r1.w = (-(r1.w)) + (c0.w);
    r4.z = (r1.y) * (-(c14.w)) + (-(c14.y));
    r1.z = (r1.w) * (r1.w);
    r4.w = (r1.y) * (r1.y);
    r1.z = (r1.z) * (r1.z);
    r5.z = (r1.w) * (r1.z);
    ...
    r1 = tex2D(s5, v1.xy);
    r10.xyz = (r1.xyz) * (-(r1.xyz)) + (c0.www);
    r11.xyz = (r1.xyz) * (r1.xyz);
    r13.w = (r1.w) * (-(c3.x)) + (c3.y);
    r14.w = (r1.w) * (c3.x);
    r5.w = saturate(dot(r0.xyz, r12.xyz));
    r2.w = saturate(dot(r12.xyz, -(r2.xyz)));
    r0.z = (r5.w) * (r13.w) + (r14.w);
    r12.w = (r2.w) * (r13.w) + (r14.w);
    r0.z = (r0.z) * (r12.w) + (c3.z);
    r4.xy = (r1.ww) * (c4.xy) + (c4.zw);
    r0.y = 1.0f / (r0.z);
    r11.w = exp2(r4.y);
    r0.z = pow(abs(r5.y), r11.w);
    r9.w = (r11.w) * (c12.x) + (c12.y);
    r1.y = (r5.w) * (r0.y);
    r1.z = (r0.z) * (r9.w);
    ...
    r1.w = saturate(dot(r13.xyz, c[17].xyz));
    r1.xyz = (r0.xyz) * (r1.xyz);
    r2.w = (-(r1.w)) + (c0.w);
    r0.z = (r2.w) * (r2.w);
    r1.w = max(abs(r12.y), abs(r12.z));
    r2.z = (r0.z) * (r0.z);
    r0.z = max(abs(r12.x), r1.w);
    r1.w = 1.0f / (r0.z);
    ...
    r8.xyz = (r1.xyz) * (c[31].xxx);
    r0.xyz = (r0.xyz) * (c[31].yyy);
    r10.w = saturate(dot(r12.xyz, c[17].xyz));
    r16.xy = c[29].xy;
    r2.xyz = (r16.xxx) * (c[18].xyz);
    r1 = tex2D(s8, v1.xy);
    r0.xyz = (r0.xyz) * (r1.www);
    r14.xyz = (r10.www) * (r2.xyz);
    r15.xyz = (r0.xyz) * (c0.zzz);
    if ((c0.w) >= (v6.w))
    {
        r3 = (v6.xyzx) * (c3.yyyw);
        r2 = (r3) + (-(c13.xyzz));
    ...
    r0.xyz = (r3.www) * (r14.xyz) + (r15.xyz);
    r2.w = (r10.w) * (r13.w) + (r14.w);
    r2.w = (r2.w) * (r12.w) + (c3.z);
    r3.z = saturate(dot(r12.xyz, r13.xyz));
    r2.z = 1.0f / (r2.w);
    r2.w = pow(abs(r3.z), r11.w);
    r2.z = (r10.w) * (r2.z);
    r2.w = (r9.w) * (r2.w);
    r2.w = (r2.z) * (r2.w);
    r2.xyz = (r10.xyz) * (r8.www) + (r11.xyz);
