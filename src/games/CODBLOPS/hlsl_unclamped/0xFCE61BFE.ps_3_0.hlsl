// Mechanically reconstructed from 0xFCE61BFE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xy = (c[39].zz) * (r1.xy) + (r0.xy);
    r1 = tex2D(s8, v1.xy);
    r4.xy = (v1.xy) + (c1.xx);
    r3.z = c1.y;
    r0.xy = (r4.xy) * (c[44].xx) + (r3.zz);
    r0 = tex2D(s6, r0.xy);
    r7.w = (v8.w) * (c1.z) + (-(r0.x));
