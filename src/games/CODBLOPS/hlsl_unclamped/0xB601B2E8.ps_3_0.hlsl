// Mechanically reconstructed from 0xB601B2E8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r14.xy = c[29].xy;
    r13.xyz = (r14.yyy) * (c[19].xyz);
    r2.w = dot(v6.xyz, v6.xyz);
    r1 = tex2D(s1, v1.xy);
    r1.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r2.w = rsqrt(r2.w);
    r2.xy = float2(((r4.w) >= 0.0f ? (r1.x) : (c0.z)), ((r4.w) >= 0.0f ? (r1.y) : (c0.z)));
    ...
    r1.y = c0.z;
    r7.xyz = float3(((r4.w) >= 0.0f ? (c[31].x) : (r1.y)), ((r4.w) >= 0.0f ? (c[31].y) : (r1.y)), ((r4.w) >= 0.0f ? (c[31].w) : (r1.y)));
    r1.xy = (r2.ww) * (c3.xy) + (c3.zw);
    r9.w = exp2(r1.y);
    r10.w = 1.0f / (r1.x);
    r1.y = pow(abs(r3.w), r9.w);
    r8.w = (r9.w) * (c4.x) + (c4.y);
    r3.w = (r1.y) * (r8.w);
    ...
    r1.xyz = (r2.xyz) * (-(r2.xyz)) + (c0.yyy);
    r3.w = (r3.w) * (r3.x);
    r2.xyz = (r1.xyz) * (r3.yyy) + (r8.xyz);
    r11.w = (-(r3.z)) + (c0.y);
    ...
    r6.xyz = (r3.xyz) * (c2.xxx);
    r3.xyz = (r14.xxx) * (c[18].xyz);
    ...
    r4.xyz = (r11.xyz) * (r12.www) + (-(r12.xyz));
    r11.xyz = (r3.xyz) * (c0.www);
    r3 = tex3D(s11, v7.xyz);
    r3.xyz = (r3.xyz) * (r3.xyz);
