// Mechanically reconstructed from 0x848C2754.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r5.w = (r0.w) * (v0.w) + (c1.x);
    r3.xy = float2(((r5.w) >= 0.0f ? (r1.x) : (c1.z)), ((r5.w) >= 0.0f ? (r1.y) : (c1.z)));
    ...
    r3 = tex3D(s11, r0.xyz);
    r15.yz = c1.yz;
    r8.xyz = float3(((r5.w) >= 0.0f ? (c[22].x) : (r15.z)), ((r5.w) >= 0.0f ? (c[22].y) : (r15.z)), ((r5.w) >= 0.0f ? (c[22].w) : (r15.z)));
    r0.xyz = (r3.xyz) * (r3.xyz);
    r14.xyz = (r4.xyz) * (r8.zzz);
    r3.xyz = (r8.yyy) * (r0.xyz);
    r16.xy = c[21].xy;
    r0.xyz = (r16.xxx) * (c[18].xyz);
    r13.xyz = (r3.xyz) * (c3.xxx);
    r12.xyz = (r4.www) * (r0.xyz);
    if ((c1.y) >= (v6.w))
    {
        r4 = (v6.xyzx) * (c1.yyyz);
        r3 = (r4) + (-(c13.xyzz));
    ...
    r2 = saturate((r2) * (c[9]) + (r15.yyyy));
    r0.xyz = (r0.xyz) * (r9.xyz);
    r2 = (r3) * (r2);
    r3.xyz = (r0.xyz) * (r8.xxx) + (r7.xyz);
    r0.z = dot(c[20], r2);
    r0.x = dot(c[10], r2);
    r0.y = dot(c[11], r2);
