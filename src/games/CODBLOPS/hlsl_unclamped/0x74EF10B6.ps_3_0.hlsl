// Mechanically reconstructed from 0x74EF10B6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s4, v7.zw);
    r0.zw = (r1.ww) * (c1.zy) + (c1.wz);
    r7.w = ((r2.w) >= 0.0f ? (r1.y) : (c1.y));
    ...
    r10.w = saturate(dot(r1.xyz, -(r9.xyz)));
    r0.z = (r1.w) * (c3.w);
    r3.y = saturate(dot(r1.xyz, r3.xyz));
    r0.y = (r10.w) * (r4.z) + (r0.z);
