// Mechanically reconstructed from 0x5362D83E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.xy = (r0.ww) * (-(r5.xy)) + (r5.xy);
    r1.y = dot(r2.xy, r2.xy) + (c4.y);
    ...
    r2 = tex2D(s5, v7.zw);
    r0 = v2;
    r8.xyz = (r9.xxx) * (v5.xyz) + (r0.xyz);
    r0.xyz = (r2.xyz) * (v0.zzz);
    r2.xyz = (r9.yyy) * (v4.xyz) + (r8.xyz);
