// Mechanically reconstructed from 0x26237B4C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.x = dot(r4.xy, r1.xy) + (c2.w);
    r3.y = dot(r4.xy, r1.zw) + (c2.w);
    r4 = tex2D(s3, v6.zw);
    r4.w = (r4.w) * (v0.z);
    r1.xy = (r0.yw) * (c13.xx) + (c13.yy);
    r7.xy = lerp(r5.xy, r3.xy, r4.ww);
    r0.w = dot(r1.xy, r1.xy) + (c2.w);
    r0.y = dot(r7.xy, r7.xy) + (c2.w);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c4.x) + (c4.y);
    r3.w = (r0.y) * (c4.x) + (c4.y);
    r0.y = (r0.w) * (r3.w);
    r0.w = dot(r1.xy, r7.xy) + (c2.w);
    r1 = tex2D(s14, v1.zw);
    r5.xy = (r1.xy) * (c12.ww);
    r1.w = saturate((r0.w) * (r0.y) + (r0.y));
    r2.xy = (r2.xz) * (r5.yy);
    r0.w = (r1.y) * (c12.w) + (-(r2.x));
    r3.xz = (r2.xy) * (c13.xx);
    r0.w = (r2.z) * (-(r5.y)) + (r0.w);
    r0.xy = (r0.xz) * (r5.xx);
    r3.y = (r0.w) + (r0.w);
    ...
    r5.y = (r0.w) + (r0.w);
    r0 = tex2D(s6, v6.zw);
    r10.xy = lerp(c[23].xy, r0.yy, r4.ww);
    r0.xyz = v2.xyz;
