// Mechanically reconstructed from 0xF54AAA26.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s3, v7.zw);
    r3.w = (r1.w) * (v7.y);
    r4.xy = lerp(r0.xy, r2.xy, r3.ww);
    r3.z = (r1.w) * (-(v7.y)) + (c23.w);
    r0 = tex2D(s0, v0.xy);
    r2.xyz = lerp(r0.xyz, r1.xyz, r3.www);
    r2.w = (r0.w) * (-(v7.x)) + (c23.w);
    r0.xy = (v0.zw) * (c3.xy);
    r1 = tex2D(s13, r0.xy);
    r0.xy = (v0.zw) * (c3.xy) + (c3.zy);
    r0 = tex2D(s13, r0.xy);
    r1.w = r0.y;
    r6.w = (r2.w) * (-(r3.z)) + (c23.w);
    r3.xy = (r1.yw) * (c4.xx) + (c4.yy);
    r0.w = dot(r4.xy, r4.xy) + (c23.z);
    r0.y = dot(r3.xy, r3.xy) + (c23.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c1.x) + (c1.y);
    r1.w = (r0.y) * (c1.x) + (c1.y);
    r0.y = dot(r3.xy, r4.xy) + (c23.z);
    r1.w = (r0.w) * (r1.w);
    ...
    r12.xyz = (r4.zzz) * (v6.xyz);
    r0.xyw = c[20].xyw;
    r4.xyz = (-(r0.xyw)) + (c[21].xyw);
