// Mechanically reconstructed from 0xF5801CB4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = dot(r5.xy, r5.xy) + (c12.x);
    r0.y = dot(r1.xy, r1.xy) + (c12.x);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c12.z) + (c12.w);
    r1.w = (r0.y) * (c12.z) + (c12.w);
    r0.y = dot(r1.xy, r5.xy) + (c12.x);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v0.zw);
    r7.xy = (r1.xy) * (c3.ww);
