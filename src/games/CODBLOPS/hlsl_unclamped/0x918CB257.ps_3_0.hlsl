// Mechanically reconstructed from 0x918CB257.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = exp2(-(r0.w));
    r0.xy = (v0.zw) * (c12.xy) + (c12.zy);
    r0 = tex2D(s13, r0.xy);
    r1.xy = (v0.zw) * (c4.zw);
    r2 = tex2D(s13, r1.xy);
    r0.w = r2.y;
    r2.w = (r1.w) * (c3.x) + (c3.y);
    r5.xy = (r0.wy) * (c38.xx) + (c38.yy);
    r1 = tex2D(s14, v0.zw);
    r7.xy = (r1.xy) * (c3.ww);
    ...
    r8.xz = (r3.xy) * (c12.ww);
    r0.w = (r0.w) * (r1.w);
    r4.xyz = (r8.xyz) * (r2.www) + (r0.xyz);
    r4.w = (r0.w) * (c4.x) + (c4.y);
    r1 = tex2D(s6, v0.xy);
    r3.xyz = (-(v6.xyz)) + (c[20].xyz);
    r2.w = (r1.w) * (-(c38.z)) + (c38.w);
    r0.w = dot(r3.xyz, r3.xyz);
    r0.w = rsqrt(r0.w);
    r10.xyz = (r3.www) * (v6.xyz);
    r0.xyz = (r3.xyz) * (r0.www) + (-(r10.xyz));
    r5.xyz = (r3.xyz) * (r0.www);
    r3.xyz = normalize(r0.xyz);
    r0.w = dot(r5.xyz, c[29].xyz);
    r11.w = saturate(dot(r3.xyz, r5.xyz));
    r1.z = saturate((r0.w) * (c[30].x) + (c[30].y));
    r3.w = (r1.z) * (c16.z) + (c16.w);
    r0 = v1;
    ...
    r0.y = (r0.y) * (r1.x) + (c14.x);
    r1.x = pow(abs(r2.w), r3.w);
    r0.y = 1.0f / (r0.y);
    r0.z = (r0.z) * (r1.x);
    r0.y = (r1.z) * (r0.y);
    r12.w = (r0.x) * (c4.x) + (c4.y);
    r0.z = (r0.z) * (r0.y);
    r3 = tex2D(s0, v0.xy);
    r2 = tex2D(s5, v7.zw);
    r2.w = (r2.w) * (v7.y) + (c1.x);
    ...
    r9.w = ((r2.w) >= 0.0f ? (c1.y) : (r1.y));
    r7.xyz = (r0.xyz) * (r0.xyz);
    r11.xyz = (r4.xyz) * (r9.www);
    r12.y = (r1.x) * (r9.w);
    r2 = tex2D(s12, v0.zw);
