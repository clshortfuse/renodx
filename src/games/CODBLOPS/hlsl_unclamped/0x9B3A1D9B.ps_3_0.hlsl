// Mechanically reconstructed from 0x9B3A1D9B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.w = (r5.w) * (v0.y);
    r0.w = r2.y;
    r1.xy = lerp(r4.xy, r3.xy, r7.ww);
    r4 = tex2D(s3, v6.zw);
    r4.w = (r4.w) * (v0.z);
    r3.xy = (r0.yw) * (c4.xx) + (c4.yy);
    r9.xy = (r4.ww) * (-(r1.xy)) + (r1.xy);
    ...
    r0.xy = (-(r0.xy)) + (c[24].xy);
    r0.w = (r0.z) * (-(r8.x)) + (r0.w);
    r0.xy = (r7.ww) * (r0.xy) + (c[23].xy);
    r6.y = (r0.w) + (r0.w);
    r8.xy = lerp(r0.xy, c[25].xy, r4.ww);
    r1 = tex2D(s6, v1.xy);
    r0 = tex2D(s7, v6.xy);
