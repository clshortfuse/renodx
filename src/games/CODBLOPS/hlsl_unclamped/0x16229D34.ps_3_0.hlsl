// Mechanically reconstructed from 0x16229D34.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c3 = float4(8.0f, 0.797884583f, 0.959999979f, 0.0399999991f);
    ...
    r3.w = lerp(r1.y, c1.x, r0.w);
    r2 = tex2D(s1, v1.xy);
    r1.xy = (r2.wy) * (c0.xy) + (c0.zw);
    r2 = tex2D(s0, v1.xy);
    r3.xyz = lerp(r2.xyz, r0.xyz, r0.www);
    r2.xy = (r0.ww) * (-(r1.xy)) + (r1.xy);
    r0 = tex2D(s6, v8.zw);
    r0.w = (r0.w) * (v0.z);
    r1.xyz = lerp(r3.xyz, r0.xyz, r0.www);
    r5.xy = (r0.ww) * (-(r2.xy)) + (r2.xy);
    r9.w = lerp(r3.w, c1.x, r0.w);
