// Mechanically reconstructed from 0x2844CAD7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.z = (r11.w) * (r3.z);
    r0.xyz = (r5.xyz) * (r1.www) + (r7.xyz);
    r1.w = (r0.w) * (c1.x);
    r0.xyz = (r3.zzz) * (r0.xyz);
    r3.xyz = (r0.xyz) * (c[35].www);
    r0.xyz = (r4.xyz) * (c[35].yyy);
    r3.xyz = (r3.xyz) * (c[31].xyz);
    r0.xyz = (r0.xyz) * (c1.yyy);
    r6.xyz = (r10.www) * (r3.xyz);
    r3.xyz = (r10.www) * (r1.xyz) + (r0.xyz);
    r0 = tex2D(s0, v1.xy);
