// Mechanically reconstructed from 0x3DC187CA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(8.0f, 31.875f, 0.0f, 0.178571001f);
    const float4 c2 = float4(2.22222233f, 3.125f, 3.4482758f, 4.33290005f);
    const float4 c3 = float4(-2.0f, 3.0f, 0.5f, 1.0f);
    ...
    r3.xy = (r3.xy) * (-(c3.xx)) + (-(c3.ww));
    r4 = tex2D(s1, v4.xy);
    r3.zw = (r4.wy) * (c0.xy) + (c0.zw);
    r3.zw = (r3.zw) * (c3.zz) + (c3.zz);
    r3.zw = (r3.zw) * (-(c3.xx)) + (-(c3.ww));
    r0.w = saturate((c[25].x) * (v6.z));
    r2.w = (r0.w) * (c[27].x);
    r0.w = saturate(r0.w);
    r3.zw = (r3.zw) * (r2.ww);
    r3.xy = (c[26].xx) * (r3.xy) + (r3.zw);
    ...
    r0.xyz = (r1.xyz) * (-(c1.www)) + (r3.xyz);
    r2.xyz = (r1.xyz) * (c1.www);
    r3.xy = (c[30].xx) * (v4.xy);
    r3 = tex2D(s5, r3.xy);
    r1.w = (r3.x) + (-(c3.w));
    r0.w = (r0.w) * (-(c3.x)) + (r1.w);
    ...
    r2.xy = (r0.ww) * (c[29].xy);
    r2.xy = (r2.xy) * (c[28].xx);
    r2.xy = (v4.xy) * (c[28].xx) + (r2.xy);
    r2 = tex2D(s6, r2.xy);
    r2.xyz = (r2.xyz) * (r2.xyz);
    r2.xyz = (r2.xyz) * (c[32].xxx) + (-(r1.xyz));
    r4 = tex2D(s7, v4.xy);
    r0.w = saturate((r4.x) * (c3.y));
