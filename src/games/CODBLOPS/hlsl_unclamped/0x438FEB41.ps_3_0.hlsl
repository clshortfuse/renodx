// Mechanically reconstructed from 0x438FEB41.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.x = dot(r2.xy, r1.xy) + (c15.w);
    r6.y = dot(r2.xy, r1.zw) + (c15.w);
    r2 = tex2D(s5, v6.zw);
    r2.w = (r2.w) * (v0.z);
    r1.xy = (r0.yw) * (c4.xx) + (c4.yy);
    r7.xy = lerp(r8.xy, r6.xy, r2.ww);
    r0.y = dot(r1.xy, r1.xy) + (c15.w);
    ...
    r1.xyw = c[39].xyw;
    r3.xyz = (-(r1.xyw)) + (c[40].xyw);
    r1.xyz = v2.xyz;
    r1.xyz = (r7.xxx) * (v4.xyz) + (r1.xyz);
    r11.xyz = (r2.www) * (r3.xyz) + (c[39].xyw);
