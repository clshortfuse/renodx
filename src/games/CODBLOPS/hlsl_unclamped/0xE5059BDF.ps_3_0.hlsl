// Mechanically reconstructed from 0xE5059BDF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.w = c0.y;
    r7.xyz = float3(((r5.z) >= 0.0f ? (r5.w) : (c[20].x)), ((r5.z) >= 0.0f ? (r5.w) : (c[20].y)), ((r5.z) >= 0.0f ? (r5.w) : (c[20].w)));
    r6.w = 1.0f / (r2.x);
    ...
    r5.xyz = float3(((r5.z) >= 0.0f ? (r0.x) : (r3.x)), ((r5.z) >= 0.0f ? (r0.y) : (r3.y)), ((r5.z) >= 0.0f ? (r0.z) : (r3.z)));
    r0.z = dot(r8.xy, r8.xy) + (c2.z);
    r3 = tex2D(s14, v0.zw);
    r8.xy = (r3.xy) * (c2.ww);
    r0.z = exp2(-(r0.z));
    r0.xy = (r4.xz) * (r8.yy);
    r1.w = saturate((r0.z) * (c3.z) + (c3.w));
    r1.z = (r3.y) * (c2.w) + (-(r0.x));
    r0.xz = (r0.xy) * (c3.xx);
    r2.xy = (r2.xz) * (r8.xx);
    r0.y = (r4.z) * (-(r8.y)) + (r1.z);
