// Mechanically reconstructed from 0xF97134F7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r2.w) * (r3.z);
    r16.yz = c0.yz;
    r12.xyz = float3(((r4.w) >= 0.0f ? (c[20].x) : (r16.z)), ((r4.w) >= 0.0f ? (c[20].y) : (r16.z)), ((r4.w) >= 0.0f ? (c[20].w) : (r16.z)));
