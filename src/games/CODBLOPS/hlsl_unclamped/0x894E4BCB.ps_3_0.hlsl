// Mechanically reconstructed from 0x894E4BCB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xyz = (r1.yyy) * (r2.xyz);
    r1.z = (-(r4.w)) + (c2.y);
    r2.w = (r1.z) * (r1.z);
    r12.xy = (r1.ww) * (c12.xy) + (c12.zw);
    r1.z = (r1.z) * (r2.w);
    r2.w = 1.0f / (r12.x);
    r10.xyz = (r4.xyz) * (r3.www) + (-(r0.xyz));
    r3.w = (r1.z) * (r2.w);
    r2 = tex2D(s0, v1.xy);
    ...
    r1.z = exp2(r12.y);
    r12.xyz = (r4.xyz) * (r3.www) + (r7.xyz);
    r0.xyz = (r1.xxx) * (r2.xyz);
    r2.xyz = (r11.xyz) * (r12.xyz);
    ...
    r2.w = (r1.w) * (r1.x);
    r1.x = saturate(dot(r2.xyz, r9.xyz));
