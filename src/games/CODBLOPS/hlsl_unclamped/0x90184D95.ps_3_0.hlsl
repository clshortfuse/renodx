// Mechanically reconstructed from 0x90184D95.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s6, v7.zw);
    r0.yz = (r0.wy) + (c1.xx);
    r12.xy = (r5.ww) * (r0.yz) + (c1.zz);
    r0 = v1;
    r0.xyz = (r5.xxx) * (v4.xyz) + (r0.xyz);
    r5.w = (r12.x) * (-(c12.z)) + (c12.w);
    r0.xyz = (r5.yyy) * (v3.xyz) + (r0.xyz);
    r9.xyz = normalize(r0.xyz);
    r5.z = (r12.x) * (c3.w);
    r6.w = saturate(dot(r4.xyz, r9.xyz));
    r12.w = saturate(dot(r9.xyz, -(r8.xyz)));
    r0.z = (r6.w) * (r5.w) + (r5.z);
    r4.z = (r12.w) * (r5.w) + (r5.z);
    r7.w = (r4.w) * (r3.w);
    r0.z = (r0.z) * (r4.z) + (c14.x);
    r0.x = (r9.w) * (r1.w) + (r10.w);
    r0.z = 1.0f / (r0.z);
    r3.w = (r6.w) * (r0.z);
    r13.xy = (r12.xx) * (c37.xy) + (c37.zw);
    r4.w = exp2(r13.y);
    r0.z = saturate(dot(r9.xyz, r3.xyz));
    r11.w = dot(r8.xyz, r9.xyz);
    r1.w = pow(abs(r0.z), r4.w);
    r0.z = (r4.w) * (c14.y) + (c14.z);
    r0.y = saturate(dot(r9.xyz, c[17].xyz));
    r1.w = (r1.w) * (r0.z);
    r3.y = (r0.y) * (r5.w) + (r5.z);
    r3.z = saturate(dot(r9.xyz, r2.xyz));
    r2.z = (r3.y) * (r4.z) + (c14.x);
