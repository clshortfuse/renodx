// Mechanically reconstructed from 0x6D8DD27A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xz = (r4.xy) * (c12.xx);
    r0.w = (r1.w) * (r1.w);
    r1.xyz = (r10.xyz) * (r3.www) + (r0.xyz);
    r2.w = (r0.w) * (r0.w);
    r0 = tex2D(s4, v7.zw);
    r0.xyz = (r0.xyz) + (c26.yyy);
    r1.w = (r1.w) * (r2.w);
    r4.xyz = (v0.zzz) * (r0.xyz) + (c26.www);
    r0 = tex2D(s6, v1.xy);
