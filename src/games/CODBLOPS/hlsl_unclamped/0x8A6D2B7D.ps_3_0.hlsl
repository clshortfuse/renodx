// Mechanically reconstructed from 0x8A6D2B7D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.x = dot(r2.xy, r0.xy) + (c13.z);
    r3.y = dot(r2.xy, r0.zw) + (c13.z);
    r0 = tex2D(s3, v6.zw);
    r6.w = (r0.w) * (v0.z);
    r2.xy = (v1.zw) * (c11.xy);
    r2 = tex2D(s13, r2.xy);
