// Mechanically reconstructed from 0xF78A0E12.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r6.w = (r0.w) * (v0.w) + (c0.x);
    r3.xy = float2(((r6.w) >= 0.0f ? (r1.x) : (c0.z)), ((r6.w) >= 0.0f ? (r1.y) : (c0.z)));
    r1 = v2;
    ...
    r13.yz = c0.yz;
    r9.xyz = float3(((r6.w) >= 0.0f ? (c[37].x) : (r13.z)), ((r6.w) >= 0.0f ? (c[37].y) : (r13.z)), ((r6.w) >= 0.0f ? (c[37].w) : (r13.z)));
    r2.w = (r2.w) * (c0.w);
