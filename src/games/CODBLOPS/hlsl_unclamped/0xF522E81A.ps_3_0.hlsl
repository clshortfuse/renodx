// Mechanically reconstructed from 0xF522E81A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = dot(r5.xy, r5.xy) + (c6.y);
    r0.y = dot(r1.xy, r1.xy) + (c6.y);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c6.z) + (c6.w);
    r1.w = (r0.y) * (c6.z) + (c6.w);
    r0.y = dot(r1.xy, r5.xy) + (c6.y);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v0.zw);
    r6.xy = (r1.xy) * (c3.ww);
