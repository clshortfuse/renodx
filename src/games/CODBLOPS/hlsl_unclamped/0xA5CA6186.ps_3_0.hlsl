// Mechanically reconstructed from 0xA5CA6186.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c12 = float4(0.0f, 1.0f, 0.600000024f, 0.400000006f);
    ...
    r2.w = (r0.w) * (v7.y);
    r1.y = (r1.w) + (r1.w);
    r4.xy = (r2.ww) * (-(r4.xy)) + (r4.xy);
    r1.w = dot(r5.xy, r5.xy) + (c12.x);
    r0.w = dot(r4.xy, r4.xy) + (c12.x);
    r1.w = exp2(-(r1.w));
    r0.w = exp2(-(r0.w));
    r1.z = (r1.w) * (c12.z) + (c12.w);
    r0.w = (r0.w) * (c12.z) + (c12.w);
    r1.w = dot(r5.xy, r4.xy) + (c12.x);
    r1.z = (r1.z) * (r0.w);
    ...
    r1.w = ((-abs(r1.y)) >= 0.0f ? (c12.y) : (c12.x));
    r1.z = (-(r0.w)) + (c12.y);
    ...
    r16.xy = c12.xy;
    r0.xyz = (r16.xyx) + (-(c[36].xyw));
    r9.xyz = normalize(r3.xyz);
    r7.xyz = (r2.www) * (r0.xyz) + (c[36].xyw);
    ...
    r2 = tex2D(s6, v0.xy);
    r4.xyz = (r2.xyz) * (-(r2.xyz)) + (c12.yyy);
    r2.xyz = (r2.xyz) * (r2.xyz);
    r0.xyz = (r4.xyz) * (r9.www) + (r2.xyz);
    r5.w = (r2.w) * (-(c1.y)) + (c1.z);
    r9.w = (r2.w) * (c1.y);
    ...
    r1.xy = (r1.xy) * (r1.xy);
    r0.z = ((-abs(r0.z)) >= 0.0f ? (c12.x) : (r1.w));
    r1.w = (r2.x) * (r1.x);
    r0.z = (r0.z) * (r1.w);
    r1.w = (r1.y) * (-(r2.y)) + (c12.y);
    r0.xy = (r2.ww) * (r0.xy);
    r0.z = (r0.z) * (r1.w);
    r7.w = (r4.z) * (r0.z);
