// Mechanically reconstructed from 0xD12CE1E7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c21 = float4(2.0f, -1.0f, 0.0f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r3.y = dot(r1.xy, r0.zw) + (c21.z);
    r3.x = dot(r1.xy, r0.xy) + (c21.z);
    r0 = tex2D(s6, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c21.xxxx) * (v9) + (c21.yyyy);
    r6.y = dot(r1.xy, r0.zw) + (c21.z);
    r6.x = dot(r1.xy, r0.xy) + (c21.z);
    r0 = tex2D(s1, v1.xy);
    ...
    r0.w = dot(r5.xy, r5.xy) + (c21.z);
    r0.y = dot(r1.xy, r1.xy) + (c21.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c4.x) + (c4.y);
    r1.w = (r0.y) * (c4.x) + (c4.y);
    r0.y = dot(r1.xy, r5.xy) + (c21.z);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v1.zw);
    r7.xy = (r1.xy) * (c11.ww);
    ...
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c21.w) : (c21.z));
