// Mechanically reconstructed from 0x2D1AEA4D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r5.w = (r0.w) * (v0.w) + (c1.y);
    r5.xyz = float3(((r5.w) >= 0.0f ? (r1.x) : (c1.w)), ((r5.w) >= 0.0f ? (r1.y) : (c1.w)), ((r5.w) >= 0.0f ? (r1.z) : (c1.w)));
    r1 = v2;
    ...
    r2.w = r3.w;
    r0.w = (r0.w) + (r0.w);
    r2 = float4(((r5.w) >= 0.0f ? (r2.x) : (c1.w)), ((r5.w) >= 0.0f ? (r2.y) : (c1.w)), ((r5.w) >= 0.0f ? (r2.z) : (c1.w)), ((r5.w) >= 0.0f ? (r2.w) : (c1.z)));
    ...
    r2 = tex3D(s11, r2.xyz);
    r0.w = c1.z;
    r0 = float4(((r5.w) >= 0.0f ? (r0.x) : (c1.w)), ((r5.w) >= 0.0f ? (r0.y) : (c1.w)), ((r5.w) >= 0.0f ? (r0.z) : (c1.w)), ((r5.w) >= 0.0f ? (r0.w) : (c1.w)));
