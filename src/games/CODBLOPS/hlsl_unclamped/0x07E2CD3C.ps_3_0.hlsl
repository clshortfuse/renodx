// Mechanically reconstructed from 0x07E2CD3C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c20 = float4(2.0f, -1.0f, 1.0f, 0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r1 = tex2D(s6, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r0.xyz = (r0.xyz) + (c20.yyy);
    r2.xyz = (v0.yyy) * (r0.xyz) + (c20.zzz);
    r3.w = r1.w;
    r3.xyz = (r2.xyz) * (c20.www);
    r0 = tex2D(s0, v1.xy);
    ...
    r2.xy = (v1.zw) * (c11.xy) + (c11.zy);
    r2 = tex2D(s13, r2.xy);
    r3.xy = (v1.zw) * (c4.zw);
    r4 = tex2D(s13, r3.xy);
    r2.w = r4.y;
    r1.x = (r0.w) * (-(c4.y)) + (c4.z);
    r3.xy = (r2.wy) * (c12.xx) + (c12.yy);
    ...
    r4.xy = (r4.xz) * (r7.xx);
    r2.w = (r3.x) * (c11.w) + (-(r4.x));
    r11.xy = (r2.xz) * (r7.yy);
    r2.y = (r4.z) * (-(r7.x)) + (r2.w);
    r2.w = (r3.y) * (c11.w) + (-(r11.x));
    r2.w = (r2.z) * (-(r7.y)) + (r2.w);
    r7.y = (r2.y) + (r2.y);
    r2.y = (r2.w) + (r2.w);
    r3.xyz = v2.xyz;
    ...
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c11.x) : (c11.z));
