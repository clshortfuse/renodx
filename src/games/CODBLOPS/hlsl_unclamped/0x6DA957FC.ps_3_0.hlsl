// Mechanically reconstructed from 0x6DA957FC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xyz = (r4.xyz) * (c0.www);
    r4.xyz = lerp(r2.xyz, c0.yyy, r0.xxx);
    r2.xyz = (r0.xxx) * (r2.xyz);
    r6.xyz = (r4.xyz) * (r4.xyz);
    r4.xyz = (r4.xyz) * (-(r4.xyz)) + (c1.xxx);
