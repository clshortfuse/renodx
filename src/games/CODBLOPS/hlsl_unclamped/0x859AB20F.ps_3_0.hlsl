// Mechanically reconstructed from 0x859AB20F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = (r1.z) * (r1.y) + (c2.x);
    r3.w = 1.0f / (r1.z);
    r1.xy = (r1.ww) * (c3.xy) + (c3.zw);
    r4.z = exp2(r1.y);
    r1.y = saturate(dot(r9.xyz, r3.xyz));
    r1.z = (r4.z) * (c2.y) + (c2.z);
    r2.w = pow(abs(r1.y), r4.z);
    r1.y = (r4.w) * (r3.w);
    r1.z = (r1.z) * (r2.w);
    r2.w = (r1.w) * (c1.x);
    r1.w = (r1.y) * (r1.z);
