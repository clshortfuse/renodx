// Mechanically reconstructed from 0xC7C53B08.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.z = (r2.w) * (r3.w);
    r6.xy = float2(((r6.z) >= 0.0f ? (r1.x) : (c1.z)), ((r6.z) >= 0.0f ? (r1.y) : (c1.z)));
    r0 = (r0.xyzx) * (c1.yyyz) + (c1.zzzy);
    r1 = v2;
    r1.xyz = (r6.xxx) * (v5.xyz) + (r1.xyz);
    r0 = float4(((r6.z) >= 0.0f ? (r0.x) : (c1.z)), ((r6.z) >= 0.0f ? (r0.y) : (c1.z)), ((r6.z) >= 0.0f ? (r0.z) : (c1.z)), ((r6.z) >= 0.0f ? (r0.w) : (c1.z)));
    r1.xyz = (r6.yyy) * (v4.xyz) + (r1.xyz);
    r0.xyz = (r0.xyz) * (v0.xyz);
    r12.xyz = normalize(r1.xyz);
    r1.xyz = (r0.xyz) * (r0.xyz);
    r4.z = saturate(dot(r12.xyz, r2.xyz));
    r2 = tex2D(s3, v1.xy);
    r2 = float4(((r6.z) >= 0.0f ? (r2.x) : (c1.z)), ((r6.z) >= 0.0f ? (r2.y) : (c1.z)), ((r6.z) >= 0.0f ? (r2.z) : (c1.z)), ((r6.z) >= 0.0f ? (r2.w) : (c1.y)));
    r9.xyz = (r2.xyz) * (-(r2.xyz)) + (c1.yyy);
    r10.xyz = (r2.xyz) * (r2.xyz);
    r3.w = (r2.w) * (-(c8.z)) + (c8.w);
    r2.xyz = (r3.yyy) * (v7.xyz);
    r8.w = saturate(dot(r12.xyz, -(r2.xyz)));
    r3.y = (r2.w) * (c3.z);
    r0.xyz = (r9.xyz) * (r3.zzz) + (r10.xyz);
    r3.z = (r8.w) * (r3.w) + (r3.y);
    r16.xy = (r2.ww) * (c10.xy) + (c10.zw);
    r6.w = saturate(dot(r12.xyz, c[17].xyz));
    r4.w = exp2(r16.y);
    r3.w = (r6.w) * (r3.w) + (r3.y);
    r3.y = pow(abs(r4.z), r4.w);
    r3.z = (r3.w) * (r3.z) + (c9.x);
    r3.w = (r4.w) * (c9.y) + (c9.z);
    r3.z = 1.0f / (r3.z);
    r3.w = (r3.y) * (r3.w);
    ...
    r4.xy = (r5.yw) * (c8.xx) + (c8.yy);
    r3.w = dot(r6.xy, r6.xy) + (c1.z);
    r3.y = dot(r4.xy, r4.xy) + (c1.z);
    r3.w = exp2(-(r3.w));
    r3.y = exp2(-(r3.y));
    r3.w = (r3.w) * (c3.x) + (c3.y);
    r4.w = (r3.y) * (c3.x) + (c3.y);
    r3.y = dot(r4.xy, r6.xy) + (c1.z);
    r5.w = (r3.w) * (r4.w);
    r4 = tex2D(s14, v1.zw);
    r7.xy = (r4.xy) * (c3.ww);
    r4.w = saturate((r3.y) * (r5.w) + (r5.w));
    r5.xy = (r5.xz) * (r7.xx);
    r3.y = (r4.x) * (c3.w) + (-(r5.x));
    r6.xy = (r3.xz) * (r7.yy);
    r3.y = (r5.z) * (-(r7.x)) + (r3.y);
    ...
    r3.w = c1.z;
    r11.xyz = float3(((r6.z) >= 0.0f ? (c[5].x) : (r3.w)), ((r6.z) >= 0.0f ? (c[5].y) : (r3.w)), ((r6.z) >= 0.0f ? (c[5].w) : (r3.w)));
