// Mechanically reconstructed from 0xB0E6D743.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xy = float2(((r3.w) >= 0.0f ? (r4.x) : (c1.z)), ((r3.w) >= 0.0f ? (r4.y) : (c1.z)));
    ...
    r3.xyz = float3(((r3.w) >= 0.0f ? (c[36].x) : (r2.w)), ((r3.w) >= 0.0f ? (c[36].y) : (r2.w)), ((r3.w) >= 0.0f ? (c[36].w) : (r2.w)));
