// Mechanically reconstructed from 0x479B8093.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s5, v8.zw);
    r7.w = (r1.w) * (v0.z);
    r6.w = lerp(r4.y, r8.z, c[8].w);
    r4 = lerp(r5, r0, r7.wwww);
    r5.w = (r4.w) * (c2.w);
    ...
    r14.xy = (r7.ww) * (-(r0.xy)) + (r0.xy);
    r2.w = rsqrt(r0.w);
    r0 = v2;
    r0.xyz = (r14.xxx) * (v5.xyz) + (r0.xyz);
    r6.xyz = (r5.xyz) * (r2.www);
    r8.xyz = (r14.yyy) * (v4.xyz) + (r0.xyz);
    ...
    r4.xyz = lerp(r3.yyy, c[29].xyw, r8.www);
    r3.xy = (v1.zw) * (c3.xy);
    r3 = tex2D(s13, r3.xy);
    r5.xy = (v1.zw) * (c3.xy) + (c3.zy);
    r5 = tex2D(s13, r5.xy);
    r3.w = r5.y;
    r9.xyz = lerp(r4.xyz, c[30].xyw, r7.www);
