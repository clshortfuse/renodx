// Mechanically reconstructed from 0x49E342F3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xyz = lerp(r2.yyy, c[36].xyw, r5.www);
    r1.xyz = (r0.xyz) * (r1.www) + (-(r15.xyz));
    r17.xyz = (r3.xyz) * (r8.yyy);
