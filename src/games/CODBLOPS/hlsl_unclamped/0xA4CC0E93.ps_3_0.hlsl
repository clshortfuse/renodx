// Mechanically reconstructed from 0xA4CC0E93.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = c1.y;
    r3.xyz = float3(((r4.w) >= 0.0f ? (r6.w) : (c[35].x)), ((r4.w) >= 0.0f ? (r6.w) : (c[35].y)), ((r4.w) >= 0.0f ? (r6.w) : (c[35].w)));
