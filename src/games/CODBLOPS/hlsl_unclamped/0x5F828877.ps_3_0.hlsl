// Mechanically reconstructed from 0x5F828877.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = float2(((r5.z) >= 0.0f ? (r1.x) : (c0.w)), ((r5.z) >= 0.0f ? (r1.y) : (c0.w)));
    r1 = v2;
    r1.xyz = (r4.xxx) * (v5.xyz) + (r1.xyz);
    r4.xyz = (r4.yyy) * (v4.xyz) + (r1.xyz);
    r1.xyz = (r2.xyz) + (c0.xxx);
    r10.xyz = normalize(r4.xyz);
    r1.xyz = saturate((r1.xyz) * (r0.www) + (r0.xyz));
    r4.z = saturate(dot(r10.xyz, r3.xyz));
    r3 = tex2D(s3, v1.xy);
    r0.xyz = (r1.xyz) * (r3.xxx);
    r8.w = ((r5.z) >= 0.0f ? (r3.y) : (c0.w));
    r2.w = r3.w;
    r0.w = c0.z;
    r2.xyz = lerp(r1.xyz, c0.yyy, r3.xxx);
    r0 = float4(((r5.z) >= 0.0f ? (r0.x) : (c0.w)), ((r5.z) >= 0.0f ? (r0.y) : (c0.w)), ((r5.z) >= 0.0f ? (r0.z) : (c0.w)), ((r5.z) >= 0.0f ? (r0.w) : (c0.w)));
    r2 = float4(((r5.z) >= 0.0f ? (r2.x) : (c0.w)), ((r5.z) >= 0.0f ? (r2.y) : (c0.w)), ((r5.z) >= 0.0f ? (r2.z) : (c0.w)), ((r5.z) >= 0.0f ? (r2.w) : (c0.z)));
