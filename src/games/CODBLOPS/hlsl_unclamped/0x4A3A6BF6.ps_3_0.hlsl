// Mechanically reconstructed from 0x4A3A6BF6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s8, v8.xy);
    r0 = (r1) + (r0);
    r1 = (r2.wwww) * (c1.yyyz) + (c1.wwwy);
    r5.xyz = lerp(r4.xyz, r3.xyz, r3.www);
    r1 = (r3.wwww) * (r0) + (r1);
    r0 = tex2D(s6, v8.zw);
    r4.w = (r0.w) * (v0.z);
    r4.xyz = lerp(r2.yyy, c[36].xyw, r3.www);
    r3.xyz = lerp(r5.xyz, r0.xyz, r4.www);
    r0 = tex2D(s9, v8.zw);
    r2 = lerp(r1, r0, r4.wwww);
    r10.xyz = lerp(r4.xyz, c[37].xyw, r4.www);
    ...
    r3.w = r0.y;
    r5.xy = (r3.xz) * (r6.xx);
    r8.xy = (r3.yw) * (c12.xx) + (c12.yy);
    r0.y = (r1.x) * (c4.w) + (-(r5.x));
    r0.w = dot(r8.xy, r4.xy) + (c1.y);
    r1.w = (r3.z) * (-(r6.x)) + (r0.y);
    r3.xy = (r0.xz) * (r6.yy);
    r0.x = dot(r8.xy, r8.xy) + (c1.y);
    r0.y = (r1.y) * (c4.w) + (-(r3.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r0.z) * (-(r6.y)) + (r0.y);
    r0.z = (r0.x) * (c3.x) + (c3.y);
    ...
    r1.w = (r3.x) * (c14.y) + (c14.z);
    r3.z = (r8.w) * (r9.w) + (r5.z);
    r4.y = (r3.z) * (r5.w) + (c14.x);
