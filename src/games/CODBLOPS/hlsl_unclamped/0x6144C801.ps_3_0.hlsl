// Mechanically reconstructed from 0x6144C801.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = dot(c[9].yz, r6.xy) + (c[9].x);
    r1.xy = saturate((r6.xx) * (c[10].xy) + (c[10].zw));
    r0.xy = (r1.xy) * (r1.xy);
