// Mechanically reconstructed from 0x2F1FCA0E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xy = (r3.xz) * (r4.xx);
    r1.w = dot(r6.xy, r5.xy) + (c4.z);
    r1.y = (r2.x) * (c3.w) + (-(r10.x));
    r2.w = (r3.z) * (-(r4.x)) + (r1.y);
    r3.xy = (r1.xz) * (r4.yy);
    r1.y = (r2.y) * (c3.w) + (-(r3.x));
    r1.x = dot(r6.xy, r6.xy) + (c4.z);
    r1.y = (r1.z) * (-(r4.y)) + (r1.y);
    r1.z = exp2(-(r1.x));
    r6.y = (r2.w) + (r2.w);
    r1.z = (r1.z) * (c3.x) + (c3.y);
