// Mechanically reconstructed from 0xAA298939.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.x = c[7].w;
    r1.xy = (c[9].xy) * (-(r2.xx)) + (v1.xy);
    r1 = tex2D(s5, r1.xy);
    r2.xy = (c[10].xy) * (-(r2.xx)) + (v1.xy);
    r2 = tex2D(s4, r2.xy);
