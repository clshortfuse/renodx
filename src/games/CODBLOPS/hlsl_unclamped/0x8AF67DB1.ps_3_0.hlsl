// Mechanically reconstructed from 0x8AF67DB1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s5, v7.zw);
    r3.w = (r0.w) * (v7.y) + (c3.w);
    r5.xy = float2(((r3.w) >= 0.0f ? (r2.x) : (r3.x)), ((r3.w) >= 0.0f ? (r2.y) : (r3.y)));
    ...
    r1.z = (r1.y) * (r1.z);
    r13.xyz = float3(((r3.w) >= 0.0f ? (c[29].x) : (r2.y)), ((r3.w) >= 0.0f ? (c[29].y) : (r2.y)), ((r3.w) >= 0.0f ? (c[29].w) : (r2.y)));
