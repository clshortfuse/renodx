// Mechanically reconstructed from 0x9C5D0DC5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = c1.y;
    r6.xyz = float3(((r2.w) >= 0.0f ? (r0.w) : (c[29].x)), ((r2.w) >= 0.0f ? (r0.w) : (c[29].y)), ((r2.w) >= 0.0f ? (r0.w) : (c[29].w)));
