// Mechanically reconstructed from 0x8AE2E20A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.x = dot(r5.xy, r1.xy) + (c1.z);
    r3.y = dot(r5.xy, r1.zw) + (c1.z);
    r1 = tex2D(s3, v6.xy);
    r7.w = (r1.w) * (v0.y) + (c1.w);
    r12.xyz = (r2.xyz) * (r0.yyy);
    r5.xy = float2(((r7.w) >= 0.0f ? (r3.x) : (r4.x)), ((r7.w) >= 0.0f ? (r3.y) : (r4.y)));
    r0 = tex2D(s6, v6.zw);
    ...
    r8.y = (r1.w) + (r1.w);
    r2 = tex2D(s8, v6.xy);
    r4.xyz = float3(((r7.w) >= 0.0f ? (r2.y) : (c[38].x)), ((r7.w) >= 0.0f ? (r2.y) : (c[38].y)), ((r7.w) >= 0.0f ? (r2.y) : (c[38].w)));
