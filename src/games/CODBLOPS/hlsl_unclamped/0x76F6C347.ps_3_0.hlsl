// Mechanically reconstructed from 0x76F6C347.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = tex2D(s14, v1.zw);
    r7.xy = (r3.xy) * (c4.ww);
    r9.xy = (r4.yw) * (c43.xx) + (c43.yy);
    r4.xy = (r4.xz) * (r7.xx);
    r0.w = dot(r9.xy, r8.xy) + (c3.z);
    r0.y = (r3.x) * (c4.w) + (-(r4.x));
    r3.w = (r4.z) * (-(r7.x)) + (r0.y);
    r6.xy = (r0.xz) * (r7.yy);
    r0.y = (r3.y) * (c4.w) + (-(r6.x));
    ...
    r4.xyz = (r9.xyz) * (r5.www) + (r3.xyz);
    r11.w = (r0.w) * (-(c43.z)) + (c43.w);
    r1.xyw = c[39].xyw;
    r1.xyz = (-(r1.xyw)) + (c[40].xyw);
    r14.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c3.yyy));
    r13.xyz = (r6.www) * (r1.xyz) + (c[39].xyw);
    r1 = tex2D(s6, v7.zw);
