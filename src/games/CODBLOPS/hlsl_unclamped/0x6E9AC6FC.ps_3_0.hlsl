// Mechanically reconstructed from 0x6E9AC6FC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r1.w) * (r1.y);
    r3.xyz = (r2.xyz) * (r1.zzz) + (r8.xyz);
    r0.xyz = (r0.xyz) * (r1.www);
    r2 = tex2D(s0, v0.xy);
    r1 = tex2D(s2, v5.zw);
    r1.w = (r1.w) * (v5.y) + (c0.x);
    r6.xyz = float3(((r1.w) >= 0.0f ? (r1.x) : (r2.x)), ((r1.w) >= 0.0f ? (r1.y) : (r2.y)), ((r1.w) >= 0.0f ? (r1.z) : (r2.z)));
    r6.w = c0.y;
    r7.xyz = float3(((r1.w) >= 0.0f ? (r6.w) : (c[20].x)), ((r1.w) >= 0.0f ? (r6.w) : (c[20].y)), ((r1.w) >= 0.0f ? (r6.w) : (c[20].w)));
    r15.xyz = (r3.xyz) * (r7.yyy);
    r13.xyz = (r0.xyz) * (r7.zzz);
    r1 = tex2D(s12, v0.zw);
