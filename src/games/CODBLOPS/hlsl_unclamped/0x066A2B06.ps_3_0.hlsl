// Mechanically reconstructed from 0x066A2B06.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = dot(r5.xy, r5.xy) + (c4.y);
    r2.w = dot(r3.xy, r3.xy) + (c4.y);
    r2.y = exp2(-(r2.y));
    r2.w = exp2(-(r2.w));
    r4.w = (r2.y) * (c4.z) + (c4.w);
    r2.y = (r2.w) * (c4.z) + (c4.w);
    r2.w = dot(r3.xy, r5.xy) + (c4.y);
    r2.y = (r4.w) * (r2.y);
    r3 = tex2D(s14, v1.zw);
    r8.xy = (r3.xy) * (c2.ww);
