// Mechanically reconstructed from 0x537057A1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = float3(((r5.w) >= 0.0f ? (r2.x) : (c0.w)), ((r5.w) >= 0.0f ? (r2.y) : (c0.w)), ((r5.w) >= 0.0f ? (r2.z) : (c0.w)));
    r8.xyz = saturate((r3.xyz) * (r1.www) + (r1.xyz));
    r1 = v2;
    r1.xyz = (r4.xxx) * (v5.xyz) + (r1.xyz);
    r2.xyz = lerp(r8.xyz, c0.yyy, r0.xxx);
    ...
    r0.xyz = (r4.zzz) * (r3.xyz);
    r2.xyz = (r2.xyz) * (r2.xyz);
    r1.xyz = (r4.zzz) * (r1.xyz);
    r0.xyz = (r0.xyz) * (r2.xyz);
    r2.xyz = (r0.xyz) * (c2.yyy) + (r1.xyz);
    r2.w = c0.z;
    r0.x = dot(r2, c[8]);
    r0.y = dot(r2, c[9]);
    r0.z = dot(r2, c[10]);
