// Mechanically reconstructed from 0x271F05CA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5 = tex2D(s13, r0.xy);
    r3.w = r5.y;
    r0.z = dot(r13.xy, r13.xy) + (c0.z);
    r0.xy = (r3.yw) * (c14.xx) + (c14.yy);
    r2.z = exp2(-(r0.z));
    r0.z = dot(r0.xy, r0.xy) + (c0.z);
    r3.w = (r2.z) * (c2.x) + (c2.y);
    r2.z = exp2(-(r0.z));
    r0.z = dot(r0.xy, r13.xy) + (c0.z);
    r0.y = (r2.z) * (c2.x) + (c2.y);
    r4 = tex2D(s14, v0.zw);
    r2.xy = (r4.xy) * (c2.ww);
    r2.z = (r3.w) * (r0.y);
