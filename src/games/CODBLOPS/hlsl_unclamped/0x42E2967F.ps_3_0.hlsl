// Mechanically reconstructed from 0x42E2967F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyz = (r3.xyz) * (r3.www) + (-(r9.xyz));
    r3.xyz = (r11.yyy) * (v4.xyz) + (r2.xyz);
    ...
    r1.x = dot(r11.xy, r11.xy) + (c1.w);
    r2.w = dot(r3.xy, r3.xy) + (c1.w);
    r1.x = exp2(-(r1.x));
    r2.w = exp2(-(r2.w));
    r1.x = (r1.x) * (c2.x) + (c2.y);
    r2.y = (r2.w) * (c2.x) + (c2.y);
    r2.w = dot(r3.xy, r11.xy) + (c1.w);
    r2.y = (r1.x) * (r2.y);
    r3 = tex2D(s14, v1.zw);
    r12.xy = (r3.xy) * (c3.ww);
