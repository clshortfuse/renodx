// Mechanically reconstructed from 0xF973C852.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = dot(r4.xy, r2.xy) + (c3.z);
    r1.y = dot(r4.xy, r2.zw) + (c3.z);
    r2 = tex2D(s6, v1.xy);
    r3.zw = r2.yy;
    r4 = tex2D(s2, v6.xy);
    r4.w = (r4.w) * (v0.y) + (c3.w);
    r7.xy = (r0.yw) * (c12.yy) + (c12.zz);
    ...
    r6.xy = (r6.xz) * (r1.yy);
    r0.w = (r3.y) * (c12.x) + (-(r6.x));
    r7.xz = (r6.xy) * (c12.yy);
    r0.w = (r6.z) * (-(r1.y)) + (r0.w);
    r0.xy = (r0.xz) * (r1.xx);
    r7.y = (r0.w) + (r0.w);
    r0.w = (r3.x) * (c12.x) + (-(r0.x));
    r7.xyz = (r3.www) * (r7.xyz);
    r0.w = (r0.z) * (-(r1.x)) + (r0.w);
    r6.xz = (r0.xy) * (c12.yy);
    r6.y = (r0.w) + (r0.w);
    r0 = tex2D(s8, v6.zw);
    r10.xy = lerp(r1.zw, r0.yy, r7.ww);
