// Mechanically reconstructed from 0x6AAA3237.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r4.xyz = saturate((r2.xyz) * (r0.www) + (r0.xyz));
    r2 = tex2D(s2, v1.xy);
    r3.xyz = lerp(r4.xyz, c0.yyy, r2.xxx);
    r0 = tex2D(s1, v1.xy);
