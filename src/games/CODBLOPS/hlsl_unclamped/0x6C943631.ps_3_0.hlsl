// Mechanically reconstructed from 0x6C943631.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.y = dot(r1.xy, r0.zw) + (c4.z);
    r7.x = dot(r1.xy, r0.xy) + (c4.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r7.w = (r0.w) * (v0.y) + (c4.w);
    r2 = tex2D(s1, v1.xy);
    r2.xy = (r2.wy) * (c3.xy) + (c3.zw);
    r6.xyz = float3(((r7.w) >= 0.0f ? (r0.x) : (r1.x)), ((r7.w) >= 0.0f ? (r0.y) : (r1.y)), ((r7.w) >= 0.0f ? (r0.z) : (r1.z)));
    r8.xy = float2(((r7.w) >= 0.0f ? (r3.x) : (r2.x)), ((r7.w) >= 0.0f ? (r3.y) : (r2.y)));
    r2 = tex2D(s7, v1.xy);
    r3 = (r2.wwww) * (c1.xxxy) + (c1.zzzx);
    r1 = tex2D(s8, v7.xy);
    r0 = tex2D(s4, v7.zw);
    r2.w = (r0.w) * (v0.z);
    r4 = float4(((r7.w) >= 0.0f ? (r1.x) : (r3.x)), ((r7.w) >= 0.0f ? (r1.y) : (r3.y)), ((r7.w) >= 0.0f ? (r1.z) : (r3.z)), ((r7.w) >= 0.0f ? (r1.w) : (r3.w)));
    r1.xyz = lerp(r6.xyz, r0.xyz, r2.www);
    r6.xy = lerp(r8.xy, r7.xy, r2.ww);
    r8.xyz = (r1.xyz) * (r1.xyz);
    r1 = tex2D(s9, v7.zw);
    r3 = (r1.wwww) * (c1.xxxy) + (c1.zzzx);
    r0 = lerp(r4, r3, r2.wwww);
    r2.xyz = float3(((r7.w) >= 0.0f ? (c[8].x) : (r2.y)), ((r7.w) >= 0.0f ? (c[8].y) : (r2.y)), ((r7.w) >= 0.0f ? (c[8].w) : (r2.y)));
    r11.xyz = lerp(r2.xyz, r1.yyy, r2.www);
    r9.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c4.yyy));
    r10.xyz = (r0.xyz) * (r0.xyz);
    r0.xy = (v1.zw) * (-(c4.yw)) + (-(c4.zw));
    r1 = tex2D(s13, r0.xy);
    r0.xy = (v1.zw) * (-(c4.yw));
    r3 = tex2D(s13, r0.xy);
    r1.w = r3.y;
    ...
    r1.y = dot(r6.xy, r6.xy) + (c4.z);
    r1.w = dot(r2.xy, r2.xy) + (c4.z);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r3.w = (r1.y) * (c11.x) + (c11.y);
    r1.y = (r1.w) * (c11.x) + (c11.y);
    r1.w = dot(r2.xy, r6.xy) + (c4.z);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c11.ww);
    r1.w = saturate((r1.w) * (r1.y) + (r1.y));
    r3.xy = (r3.xz) * (r7.xx);
    r1.y = (r2.x) * (c11.w) + (-(r3.x));
    r4.xy = (r1.xz) * (r7.yy);
    r1.y = (r3.z) * (-(r7.x)) + (r1.y);
    r1.x = (r2.y) * (c11.w) + (-(r4.x));
    r1.z = (r1.z) * (-(r7.y)) + (r1.x);
    r7.y = (r1.y) + (r1.y);
    r1.y = (r1.z) + (r1.z);
    r2.xyz = v2.xyz;
