// Mechanically reconstructed from 0xEEAA4EDA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s6, v8.zw);
    r2.w = (r0.w) * (v0.z);
    r3.xy = float2(((r3.w) >= 0.0f ? (c1.y) : (r1.y)), ((r3.w) >= 0.0f ? (c1.z) : (r1.y)));
    r4.xy = (r2.ww) * (-(r4.xy)) + (r4.xy);
    r1.xyz = lerp(r2.xyz, r0.xyz, r2.www);
    r0.w = dot(r4.xy, r4.xy) + (c1.y);
    r12.xy = lerp(r3.xy, c1.zz, r2.ww);
    r0.w = exp2(-(r0.w));
    r4.w = (r0.w) * (c3.x) + (c3.y);
    r0.xy = (v1.zw) * (c16.zw);
    r3 = tex2D(s13, r0.xy);
    ...
    r0.y = (r3.y) * (r4.w) + (c13.x);
    r0.z = pow(abs(r2.x), r3.z);
    r0.y = 1.0f / (r0.y);
    r0.z = (r2.w) * (r0.z);
    r0.y = (r3.w) * (r0.y);
    r0.x = (r2.y) * (c16.x) + (c16.y);
    r0.z = (r0.z) * (r0.y);
