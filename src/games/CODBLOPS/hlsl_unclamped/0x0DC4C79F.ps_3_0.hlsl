// Mechanically reconstructed from 0x0DC4C79F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xyz = (v0.yyy) * (r0.xyz) + (c0.yyy);
    r0 = tex2D(s0, v1.xy);
    r1 = tex2D(s3, v8.zw);
    r4.w = (r1.w) * (v0.z);
    r3.xyz = (r0.xyz) * (-(r2.xyz)) + (r1.xyz);
    r1 = tex2D(s4, v8.zw);
    r4.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r1.xyz = (r4.www) * (r3.xyz);
    r4.xy = (r4.ww) * (r4.xy);
    ...
    r2.xy = (r2.xz) * (r5.xx);
    r0.w = dot(r7.xy, r4.xy) + (c0.z);
    r0.y = (r1.x) * (c4.w) + (-(r2.x));
    r1.w = (r2.z) * (-(r5.x)) + (r0.y);
    r3.xy = (r0.xz) * (r5.yy);
    r0.y = (r1.y) * (c4.w) + (-(r3.x));
    r0.x = dot(r7.xy, r7.xy) + (c0.z);
    r0.y = (r0.z) * (-(r5.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r8.y = (r1.w) + (r1.w);
    r0.z = (r0.z) * (c3.x) + (c3.y);
    ...
    r0.yzw = (r0.wyy) + (c0.xzx);
    r0.x = saturate(dot(r2.xyz, c[17].xyz));
    r13.xy = (r4.ww) * (r0.yw) + (c0.yy);
    r0.w = (-(r0.x)) + (c0.y);
    r0.y = (r0.w) * (r0.w);
    r0.x = c0.w;
    r0.y = (r0.y) * (r0.y);
