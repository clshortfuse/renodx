// Mechanically reconstructed from 0xBE5B893E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = tex2D(s2, v7.xy);
    r9.w = (r3.w) * (v0.y);
    r4 = lerp(r2, r1, r9.wwww);
    r1 = tex2D(s3, v7.zw);
    r8.w = (r1.w) * (v0.z);
    r2 = lerp(r4, r0, r8.wwww);
    r0 = tex2D(s1, v1.xy);
    ...
    r4.xyw = c[20].xyw;
    r4.xyz = (-(r4.xyw)) + (c[21].xyw);
    r2.xyz = (r10.xyz) * (r5.www) + (r11.xyz);
    r4.xyz = (r9.www) * (r4.xyz) + (c[20].xyw);
    r2.xyz = (r1.www) * (r2.xyz);
    r7.xyz = lerp(r4.xyz, c[22].xyw, r8.www);
    r7.w = 1.0f / (r5.x);
    r2.xyz = (r2.xyz) * (r7.zzz);
    r1.w = (r2.w) * (c1.w);
    r14.xyz = (r2.xyz) * (c[19].xyz);
    r2 = tex2D(s12, v1.zw);
    r4.xy = (v1.zw) * (c2.xy);
    r4 = tex2D(s13, r4.xy);
    ...
    r2.z = dot(r5.xy, r5.xy) + (c1.z);
    r2.w = exp2(-(r2.w));
    r2.z = exp2(-(r2.z));
    r2.w = (r2.w) * (c3.x) + (c3.y);
    r2.x = (r2.z) * (c3.x) + (c3.y);
    r2.z = dot(r5.xy, r8.xy) + (c1.z);
    r2.x = (r2.w) * (r2.x);
    r5 = tex2D(s14, v1.zw);
    r15.xy = (r5.xy) * (c3.ww);
    ...
    r5.xyz = (r14.xyz) * (r2.yyy);
    r14.xyz = (r7.yyy) * (r4.xyz);
    r4 = tex2D(s0, v1.xy);
    r6.xyz = lerp(r4.xyz, r3.xyz, r9.www);
    r2.xyz = (r2.yyy) * (r0.xyz) + (r14.xyz);
