// Mechanically reconstructed from 0xBFF12790.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xz = (r0.xy) * (c2.xx);
    r7.y = (r0.z) + (r0.z);
    r1.xyz = (r3.xyz) * (r0.www) + (r7.xyz);
    r0.xyw = c[34].xyw;
    r3.xyz = (-(r0.xyw)) + (c[35].xyw);
    r0 = tex2D(s3, v4.zw);
    ...
    r13.xyz = normalize(v3.xyz);
    r5.xyz = (r6.yyy) * (c[29].xyz);
    r9.xyz = (r2.xyz) * (r2.www) + (-(r13.xyz));
    r3 = tex2D(s4, v0.xy);
    r2 = tex2D(s5, v4.zw);
