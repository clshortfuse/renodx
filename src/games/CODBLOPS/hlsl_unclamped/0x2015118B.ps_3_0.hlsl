// Mechanically reconstructed from 0x2015118B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex3D(s11, r1.xyz);
    r2.xyz = (-(v2.xyz)) + (c[28].xyz);
    r9.y = dot(r2.xyz, r2.xyz);
    r2.w = rsqrt(r9.y);
    r9.x = 1.0f / (r2.w);
    r8.xy = saturate((r9.xx) * (c[31].xy) + (c[31].zw));
    r6.xy = (r8.xy) * (r8.xy);
    r8.xy = (r8.xy) * (c3.xx) + (c3.yy);
    r0.w = dot(c[30].yz, r9.xy) + (c[30].x);
    r6.xy = (r6.xy) * (r8.xy);
    r0.w = (r0.w) * (r6.x);
    r0.w = (r6.y) * (r0.w);
