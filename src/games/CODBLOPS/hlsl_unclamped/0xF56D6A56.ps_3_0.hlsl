// Mechanically reconstructed from 0xF56D6A56.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xy = float2(((r5.w) >= 0.0f ? (r4.x) : (c1.y)), ((r5.w) >= 0.0f ? (r4.y) : (c1.y)));
    ...
    r3.xyw = c[30].xyw;
    r9.xyz = float3(((r5.w) >= 0.0f ? (r3.x) : (c[29].x)), ((r5.w) >= 0.0f ? (r3.y) : (c[29].y)), ((r5.w) >= 0.0f ? (r3.w) : (c[29].w)));
