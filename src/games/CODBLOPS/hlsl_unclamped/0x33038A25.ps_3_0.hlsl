// Mechanically reconstructed from 0x33038A25.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = (r0.y) * (r0.z);
    r0.z = c[23].x;
    r1.z = (c[22].x) * (-(r0.z)) + (r0.z);
    r0.xy = (v2.xy) * (r0.yy) + (r2.xy);
    r0.w = (r0.w) * (r1.z);
    r2.xy = (r0.xy) * (c[11].xy);
    r2.w = (c[22].x) * (r0.z) + (r0.w);
    r0.xy = (r2.xy) * (c0.zz) + (c0.ww);
    r3.xy = (r2.xy) * (c0.zz);
    r0.zw = (r1.wy) * (c[24].xx);
    r0 = tex2Dbias(s2, r0);
    r1.xy = c1.xy;
    r1.w = (c[20].x) * (r1.x) + (r1.y);
    r1.w = frac(r1.w);
    r2.z = (r1.w) * (c1.z) + (c1.w);
    ...
    r3.w = (r4.x) * (c12.w) + (-(r5.x));
    r7.xz = (r5.xy) * (c13.xx);
    r3.w = (r5.z) * (-(r9.x)) + (r3.w);
    r7.y = (r3.w) + (r3.w);
    r3.xy = (r3.xz) * (r9.yy);
    r3.w = (r4.y) * (c12.w) + (-(r3.x));
    r4.xz = (r3.xy) * (c13.xx);
    r3.w = (r3.z) * (-(r9.y)) + (r3.w);
    ...
    r7.xy = saturate((r10.xx) * (c[8].xy) + (c[8].zw));
    r5.xy = (r7.xy) * (r7.xy);
    r7.xy = (r7.xy) * (c4.zz) + (c4.yy);
    r3.w = dot(c[7].yz, r10.xy) + (c[7].x);
    r10.xy = (r5.xy) * (r7.xy);
