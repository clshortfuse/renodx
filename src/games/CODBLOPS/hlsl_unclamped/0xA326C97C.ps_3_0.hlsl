// Mechanically reconstructed from 0xA326C97C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s13, r1.xy);
    r5.xy = (v4.zw) * (c4.xy) + (c4.zy);
    r5 = tex2D(s13, r5.xy);
    r1.w = r5.y;
    r1.yw = (r1.yw) * (c12.xx) + (c12.yy);
    r4.xyz = (r4.xyz) * (r1.www);
    r6.xyz = normalize(v3.xyz);
    r4.xyz = (r1.yyy) * (r6.xyz) + (r4.xyz);
    ...
    r1.x = (r1.z) * (-(r1.y)) + (r2.x);
    r2.z = (r1.x) + (r1.x);
    r1.xyz = (r0.xxx) * (r4.xyz) + (r2.yzw);
    r0.xyz = (r0.yzw) * (c4.www) + (r1.xyz);
