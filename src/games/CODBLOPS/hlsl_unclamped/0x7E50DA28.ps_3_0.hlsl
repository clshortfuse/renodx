// Mechanically reconstructed from 0x7E50DA28.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.z = dot(r2.xy, r2.xy) + (c1.x);
    r1.x = exp2(-(r1.x));
    r2.z = exp2(-(r2.z));
    r1.x = (r1.x) * (c1.y) + (c1.z);
    r3.w = (r2.z) * (c1.y) + (c1.z);
    r2.z = dot(r2.xy, r8.xy) + (c1.x);
    r2.y = (r1.x) * (r3.w);
    r4 = tex2D(s14, v1.zw);
    r8.xy = (r4.xy) * (c3.ww);
