// Mechanically reconstructed from 0x84DDFE19.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = dot(r1.xy, r0.zw) + (c26.w);
    r2.x = dot(r1.xy, r0.xy) + (c26.w);
    r0 = tex2D(s1, v1.xy);
    r1 = tex2D(s3, v7.xy);
    r1.xyz = (r1.xyz) + (c26.yyy);
    r5.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r4.xyz = (v0.yyy) * (r1.xyz) + (c26.zzz);
    r0 = tex2D(s0, v1.xy);
    r1 = tex2D(s4, v7.zw);
    r3.w = (r1.w) * (v0.z);
    r1.xyz = (r0.xyz) * (-(r4.xyz)) + (r1.xyz);
    r7.xy = lerp(r5.xy, r2.xy, r3.ww);
    r1.xyz = (r3.www) * (r1.xyz);
    r0.w = dot(r7.xy, r7.xy) + (c26.w);
    ...
    r1 = tex2D(s14, v1.zw);
    r8.xy = (r1.xy) * (c4.ww);
    r9.xy = (r2.yw) * (c12.xx) + (c12.yy);
    r2.xy = (r2.xz) * (r8.xx);
    r0.w = dot(r9.xy, r7.xy) + (c26.w);
    r0.y = (r1.x) * (c4.w) + (-(r2.x));
    r1.w = (r2.z) * (-(r8.x)) + (r0.y);
    r6.xy = (r0.xz) * (r8.yy);
    r0.y = (r1.y) * (c4.w) + (-(r6.x));
    r0.x = dot(r9.xy, r9.xy) + (c26.w);
    r0.y = (r0.z) * (-(r8.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r10.y = (r1.w) + (r1.w);
    r0.z = (r0.z) * (c3.x) + (c3.y);
    ...
    r1.w = (r1.w) * (r3.z);
    r13.xyz = (r3.www) * (r2.xyz) + (c[23].xyw);
