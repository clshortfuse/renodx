// Mechanically reconstructed from 0x5357D3B1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s4, v0.xy);
    r5.xyz = (-(v3.xyz)) + (c[28].xyz);
    r10.y = dot(r5.xyz, r5.xyz);
    r0.z = rsqrt(r10.y);
    r10.x = 1.0f / (r0.z);
    r9.xy = saturate((r10.xx) * (c[32].xy) + (c[32].zw));
    r8.xy = (r9.xy) * (r9.xy);
    r9.xy = (r9.xy) * (c3.xx) + (c3.yy);
    r0.x = dot(c[31].yz, r10.xy) + (c[31].x);
    r9.xy = (r8.xy) * (r9.xy);
    r0.x = (r0.x) * (r9.x);
