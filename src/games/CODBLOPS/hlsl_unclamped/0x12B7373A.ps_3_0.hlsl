// Mechanically reconstructed from 0x12B7373A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c11 = float4(8.0f, 0.797884583f, 31.875f, 4.0f);
    ...
    r1.xy = (r3.xz) * (r5.xx);
    r0.y = (r2.x) * (c11.z) + (-(r1.x));
    r3.xy = (r0.xz) * (r5.yy);
    r0.y = (r3.z) * (-(r5.x)) + (r0.y);
    r0.x = (r2.y) * (c11.z) + (-(r3.x));
    r0.z = (r0.z) * (-(r5.y)) + (r0.x);
    r6.y = (r0.y) + (r0.y);
    r0.y = (r0.z) + (r0.z);
    r0.xz = (r3.xy) * (c11.ww);
