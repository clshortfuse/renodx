// Mechanically reconstructed from 0xFB44638E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.x = dot(r4.xy, r1.xy) + (c3.x);
    r3.y = dot(r4.xy, r1.zw) + (c3.x);
    r4 = tex2D(s3, v6.zw);
    r4.w = (r4.w) * (v0.z);
    ...
    r7.w = c2.w;
    r0.xy = float2(((r8.w) >= 0.0f ? (r7.w) : (c[23].x)), ((r8.w) >= 0.0f ? (r7.w) : (c[23].y)));
    r0.w = dot(r3.xyz, r9.xyz);
    r8.xy = lerp(r0.xy, c[24].xy, r4.ww);
    r5.w = (r0.w) + (r0.w);
    r2 = tex2D(s6, v1.xy);
    r0 = tex2D(s7, v6.zw);
    r1 = lerp(r2, r0, r4.wwww);
    r0.xyz = (r9.xyz) * (-(r5.www)) + (r3.xyz);
    r0.w = (r1.w) * (c3.w);
    ...
    r0 = (r2) * (r2) + (r0);
    r1 = (-(v5.zzzz)) + (c[7]);
    r6.xyz = float3(((r8.w) >= 0.0f ? (r5.x) : (r6.x)), ((r8.w) >= 0.0f ? (r5.y) : (r6.y)), ((r8.w) >= 0.0f ? (r5.z) : (r6.z)));
    r0 = (r1) * (r1) + (r0);
