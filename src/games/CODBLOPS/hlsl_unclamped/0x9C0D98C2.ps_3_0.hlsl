// Mechanically reconstructed from 0x9C0D98C2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c11 = float4(31.875f, 4.0f, -2.0f, 0.0009765625f);
    ...
    r1 = tex2D(s7, v1.xy);
    r0 = tex2D(s8, v7.xy);
    r5.w = lerp(r1.y, r0.y, r4.w);
    r2 = tex2D(s4, v7.zw);
    r0.xyz = (r2.xyz) + (c16.yyy);
    r2.w = lerp(r1.w, r0.w, r4.w);
    r2.xyz = (v0.zzz) * (r0.xyz) + (c16.www);
    r0 = tex2D(s5, v8.xy);
    ...
    r3.w = r0.y;
    r5.z = (r1.w) * (r1.z);
    r1.xy = (r3.yw) * (c11.yy) + (c11.zz);
    r0.w = dot(r5.xy, r5.xy) + (c16.z);
    r0.y = dot(r1.xy, r1.xy) + (c16.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c3.y) + (c3.z);
    r1.w = (r0.y) * (c3.y) + (c3.z);
    r0.y = dot(r1.xy, r5.xy) + (c16.z);
    r3.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v1.zw);
    r7.xy = (r1.xy) * (c11.xx);
    r1.w = saturate((r0.y) * (r3.w) + (r3.w));
    r3.xy = (r3.xz) * (r7.xx);
    r0.y = (r1.x) * (c11.x) + (-(r3.x));
    r6.xy = (r0.xz) * (r7.yy);
    r0.y = (r3.z) * (-(r7.x)) + (r0.y);
    r0.x = (r1.y) * (c11.x) + (-(r6.x));
    r0.z = (r0.z) * (-(r7.y)) + (r0.x);
    r7.y = (r0.y) + (r0.y);
    r0.y = (r0.z) + (r0.z);
    r0.xz = (r6.xy) * (c11.yy);
    ...
    r0.z = (r0.z) * (r0.y) + (c11.w);
    r0.y = (r1.w) * (c13.x) + (c13.y);
    r0.z = 1.0f / (r0.z);
    r1.w = (r0.x) * (r0.y);
    r1.z = (r2.w) * (r0.z);
    r0.xyz = (r9.xyz) * (r5.zzz) + (r10.xyz);
    r1.w = (r1.w) * (r1.z);
    r11.xyz = lerp(r5.www, c[8].xyw, r4.www);
