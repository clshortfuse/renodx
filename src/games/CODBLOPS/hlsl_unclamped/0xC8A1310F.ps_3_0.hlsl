// Mechanically reconstructed from 0xC8A1310F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xyz = (v0.yyy) * (r0.xyz) + (c16.yyy);
    r1.xyz = (r8.xyz) * (c16.zzz);
    r0 = tex2D(s6, v8.zw);
    r2.xyz = (r0.xyz) + (c16.xxx);
    r0 = tex2D(s1, v1.xy);
    r3.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r7.xyz = (v0.zzz) * (r2.xyz) + (c16.yyy);
    r0.w = dot(r3.xy, r3.xy) + (c16.w);
    r12.xyz = (r1.xyz) * (r7.xyz);
    r0.w = exp2(-(r0.w));
    r3.w = (r0.w) * (c1.x) + (c1.y);
    ...
    r10.xz = (r2.xy) * (c4.xx);
    r2.xyz = (r10.xyz) * (r3.www) + (r0.xyz);
    r0.w = dot(v7.xyz, v7.xyz);
    r11.xyz = (r12.xyz) * (-(r12.xyz)) + (c16.yyy);
    r12.w = rsqrt(r0.w);
    r1 = tex2D(s7, v1.xy);
    r0 = v2;
    ...
    r6.xyz = (r0.xyz) * (r1.zzz);
    r0.z = saturate(dot(r3.xyz, r6.xyz));
    r0.z = (-(r0.z)) + (c16.y);
    r0.y = (r0.z) * (r0.z);
    r4.xyz = (r1.xxx) * (r13.xyz) + (r14.xyz);
    r0.y = (r0.y) * (r0.y);
    r1.z = (r0.z) * (r0.y);
    r0.xyz = (r12.xyz) * (r12.xyz);
    r5.xyz = (r11.xyz) * (r1.zzz) + (r0.xyz);
    r10.w = (r1.w) * (c1.w);
    r4.w = saturate(dot(r6.xyz, r9.xyz));
    r1.z = saturate(dot(r9.xyz, -(r2.xyz)));
    r2.w = (r4.w) * (r9.w) + (r10.w);
    r5.w = (r1.z) * (r9.w) + (r10.w);
    r3.w = dot(r6.xyz, c[29].xyz);
    r2.w = (r2.w) * (r5.w) + (c14.x);
    r2.w = 1.0f / (r2.w);
    r1.z = (-(r1.z)) + (c16.y);
    r2.w = (r4.w) * (r2.w);
    r6.w = (r1.z) * (r1.z);
    ...
    r6.z = (r1.z) + (r1.z);
    r6.xy = (r1.ww) * (c37.xy) + (c37.zw);
    r8.w = exp2(r6.y);
    r3.z = saturate(dot(r9.xyz, r3.xyz));
    r1.z = pow(abs(r3.z), r8.w);
    ...
    r2.w = (r1.w) * (r1.w);
    r3.xyz = (r11.xyz) * (r11.www) + (r0.xyz);
    r2.w = (r2.w) * (r2.w);
    r2.w = (r1.w) * (r2.w);
    r1.w = (r7.w) * (r9.w) + (r10.w);
    r1.w = (r1.w) * (r5.w) + (c14.x);
    r6.z = saturate(dot(r9.xyz, r6.xyz));
    r5.w = 1.0f / (r1.w);
    r1.w = pow(abs(r6.z), r8.w);
    r5.w = (r7.w) * (r5.w);
    r1.w = (r6.w) * (r1.w);
    r1.w = (r5.w) * (r1.w);
