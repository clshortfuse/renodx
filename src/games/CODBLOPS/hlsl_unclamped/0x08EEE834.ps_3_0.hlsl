// Mechanically reconstructed from 0x08EEE834.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyz = (r2.xyz) * (-(r2.xyz)) + (c3.xxx);
    r1.w = (r3.w) * (r1.w);
    r2.xyz = (r0.xyz) * (r1.xxx) + (r7.xyz);
    r9.w = (-(r1.z)) + (c3.x);
    ...
    r2.xyz = (r10.xyz) * (r10.www) + (-(r11.xyz));
