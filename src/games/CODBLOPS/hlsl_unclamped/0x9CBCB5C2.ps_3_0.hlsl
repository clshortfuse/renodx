// Mechanically reconstructed from 0x9CBCB5C2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s7, v0.xy);
    r2 = float4(((r5.w) >= 0.0f ? (r1.x) : (-(c1.w))), ((r5.w) >= 0.0f ? (r1.y) : (-(c1.w))), ((r5.w) >= 0.0f ? (r1.z) : (-(c1.w))), ((r5.w) >= 0.0f ? (r1.w) : (-(c1.y))));
    r3 = tex2D(s8, v7.zw);
    ...
    r0.z = (r3.w) * (r12.w) + (r13.w);
    r11.w = (r15.w) * (r12.w) + (r13.w);
    r0.z = (r0.z) * (r11.w) + (c13.x);
    r17.xy = (r2.ww) * (c31.xy) + (c31.zw);
    r0.y = 1.0f / (r0.z);
    r10.w = exp2(r17.y);
    ...
    r1.y = (r3.w) * (r0.y);
    r1.z = (r0.z) * (r8.w);
    r0.xyz = (r11.xyz) * (r3.zzz) + (r12.xyz);
    r2.z = (r1.y) * (r1.z);
    r1.x = c1.w;
    r1.xyz = float3(((r5.w) >= 0.0f ? (c[29].x) : (r1.x)), ((r5.w) >= 0.0f ? (c[29].y) : (r1.x)), ((r5.w) >= 0.0f ? (c[29].w) : (r1.x)));
    r0.xyz = (r0.xyz) * (r2.zzz);
    r13.xyz = float3(((r4.w) >= 0.0f ? (r3.y) : (r1.x)), ((r4.w) >= 0.0f ? (r3.y) : (r1.y)), ((r4.w) >= 0.0f ? (r3.y) : (r1.z)));
