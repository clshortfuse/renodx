// Mechanically reconstructed from 0x0FC2F9B2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyz = (r8.xyz) * (r4.zzz) + (r3.xyz);
    r1.xyz = lerp(r2.xyz, r0.xyz, r4.www);
    r7.xyz = (r1.xyz) * (r1.xyz);
    r16.yz = c1.yz;
    r4.xyz = float3(((r0.w) >= 0.0f ? (r16.y) : (c[20].x)), ((r0.w) >= 0.0f ? (r16.z) : (c[20].y)), ((r0.w) >= 0.0f ? (r16.y) : (c[20].w)));
    r2 = tex2D(s5, v1.xy);
    r0 = tex2D(s6, v8.zw);
    ...
    r1.z = (r1.y) * (r1.z);
    r12.xyz = lerp(r4.xyz, c[21].xyw, r4.www);
