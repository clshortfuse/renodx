// Mechanically reconstructed from 0x1C958145.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.x = dot(r5.xy, r0.xy) + (c1.z);
    r2.y = dot(r5.xy, r0.zw) + (c1.z);
    r0 = tex2D(s4, v7.xy);
    r3.w = (r0.w) * (v0.y) + (c1.w);
    r0.w = dot(r1, c2.yyyy);
    r2.xy = float2(((r3.w) >= 0.0f ? (r2.x) : (r4.x)), ((r3.w) >= 0.0f ? (r2.y) : (r4.y)));
    r0.w = (r0.w) + (c1.y);
    r1.xyz = v4.xyz;
