// Mechanically reconstructed from 0xECD8A427.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c11 = float4(2.0f, -1.0f, 0.0f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r4 = tex2D(s13, r3.xy);
    r2.w = r4.y;
    r0.w = dot(r8.xy, r8.xy) + (c11.z);
    r3.xy = (r2.yw) * (c3.xx) + (c3.yy);
    r0.w = exp2(-(r0.w));
    r2.w = dot(r3.xy, r3.xy) + (c11.z);
    r0.w = (r0.w) * (c2.x) + (c2.y);
    r2.y = exp2(-(r2.w));
    r2.w = dot(r3.xy, r8.xy) + (c11.z);
    r2.y = (r2.y) * (c2.x) + (c2.y);
    r3 = tex2D(s14, v1.zw);
    r7.xy = (r3.xy) * (c2.ww);
    r2.y = (r0.w) * (r2.y);
