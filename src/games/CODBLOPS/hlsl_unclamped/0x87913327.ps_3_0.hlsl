// Mechanically reconstructed from 0x87913327.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c42 = float4(4.0f, -2.0f, 0.797884583f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r7.xy = lerp(r1.xy, r6.xy, r4.ww);
    r0.w = ((r3.w) >= 0.0f ? (r2.y) : (r3.y));
    r1.w = dot(r7.xy, r7.xy) + (c3.z);
    r2.xyz = lerp(r4.xyz, r0.xyz, r4.www);
    r0.z = exp2(-(r1.w));
    r5.xyz = (r2.xyz) * (r2.xyz);
    r1.w = (r0.z) * (c4.z) + (c4.w);
    r13.xyz = lerp(r0.www, c[39].xyw, r4.www);
    r0.xy = (v1.zw) * (-(c3.yw));
    r3 = tex2D(s13, r0.xy);
    ...
    r9.xz = (r1.xy) * (c12.ww);
    r4.xyz = (r2.xyz) * (r0.www) + (-(r6.xyz));
    r3.xyz = normalize(r4.xyz);
    r4.xyz = (r2.xyz) * (r0.www);
    r0.xyz = (r9.xyz) * (r1.www) + (r0.xyz);
