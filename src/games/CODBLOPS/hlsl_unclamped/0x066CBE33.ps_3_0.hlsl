// Mechanically reconstructed from 0x066CBE33.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.y = (r0.w) + (r0.w);
    r0 = tex2D(s8, v6.zw);
    r6.xyz = lerp(c[32].xyw, r0.yyy, r4.www);
    r0.xyz = v2.xyz;
