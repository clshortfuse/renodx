// Mechanically reconstructed from 0x76A6F80A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.x = 1.0f / (r5.w);
    r3.y = (r0.w) + (r0.w);
    r1.xy = saturate((r5.xx) * (c[9].xy) + (c[9].zw));
    r0.xy = (r1.xy) * (r1.xy);
    ...
    r0.w = (r0.w) * (r1.x);
    r5.xyz = (r0.xyz) * (c[10].yyy);
    r1.w = (r1.y) * (r0.w);
    r0 = tex2D(s12, v1.zw);
    r1.xyz = v2.xyz;
    r1.xyz = (r6.xxx) * (v5.xyz) + (r1.xyz);
    r4.xyz = (r6.yyy) * (v4.xyz) + (r1.xyz);
    ...
    r1.xyz = max(((r1.xyz) * (c[11].xxx)), 0.0f); // HDR: removed only the 1.0 ceiling
    r0.w = rsqrt(r0.x);
    r0.x = rsqrt(r1.x);
    r0.y = rsqrt(r1.y);
    r0.z = rsqrt(r1.z);
