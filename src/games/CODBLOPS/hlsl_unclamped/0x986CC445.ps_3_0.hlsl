// Mechanically reconstructed from 0x986CC445.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s3, v6.xy);
    r2.w = (r2.w) * (v0.y);
    r3.xy = lerp(r4.xy, r0.xy, r2.ww);
    r0 = tex2D(s4, v6.zw);
    r5.w = (r0.w) * (v0.z);
    r4.xy = (r5.ww) * (-(r3.xy)) + (r3.xy);
    r3.xyz = v4.xyz;
    ...
    r1 = tex2D(s7, v6.xy);
    r3 = (r1.wwww) * (-(c3.zzzy)) + (-(c3.wwwz));
    r4 = tex2D(s6, v1.xy);
    r9.xyz = (-(v5.xyz)) + (c[5].xyz);
    r0.w = dot(r9.xyz, r9.xyz);
    r1 = lerp(r4, r3, r2.wwww);
    r3.z = rsqrt(r0.w);
    r3.x = (r1.w) * (c1.x);
