// Mechanically reconstructed from 0x6EA7187F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s5, v7.zw);
    r2.w = (r2.w) * (v0.z) + (c1.x);
    r0.xyz = (r8.xyz) * (r5.www) + (r6.xyz);
    r11.xyz = float3(((r2.w) >= 0.0f ? (c1.y) : (r1.x)), ((r2.w) >= 0.0f ? (c1.z) : (r1.y)), ((r2.w) >= 0.0f ? (c1.y) : (r1.z)));
    ...
    r0.xyz = float3(((r3.w) >= 0.0f ? (r3.x) : (r4.x)), ((r3.w) >= 0.0f ? (r3.y) : (r4.y)), ((r3.w) >= 0.0f ? (r3.z) : (r4.z)));
    r3.w = rsqrt(r1.z);
