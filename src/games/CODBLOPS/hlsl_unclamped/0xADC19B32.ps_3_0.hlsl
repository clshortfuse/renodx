// Mechanically reconstructed from 0xADC19B32.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.w = (r3.w) * (v0.y);
    r0.w = r4.y;
    r7.xy = (r8.ww) * (-(r1.xy)) + (r1.xy);
    r1 = tex2D(s5, v7.zw);
    r5.w = (r1.w) * (v0.z);
    r2.xy = (r0.yw) * (c3.xx) + (c3.yy);
    r10.xy = (r5.ww) * (-(r7.xy)) + (r7.xy);
    ...
    r0.y = lerp(r2.y, c4.x, r8.w);
    r0.z = dot(r11.xyz, r10.xyz);
    r6.w = lerp(r0.y, c4.x, r5.w);
    r0.z = (r0.z) + (r0.z);
