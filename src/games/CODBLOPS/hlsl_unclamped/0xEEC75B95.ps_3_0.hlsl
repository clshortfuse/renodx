// Mechanically reconstructed from 0xEEC75B95.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(0.0f, 1.0f, 0.200000003f, 0.25f);
    ...
    r2 = tex2D(s4, v7.xy);
    r5.w = (r2.w) * (v0.y) + (c2.w);
    r6.xy = float2(((r5.w) >= 0.0f ? (r0.x) : (r4.x)), ((r5.w) >= 0.0f ? (r0.y) : (r4.y)));
    r0 = tex2D(s7, v7.zw);
    ...
    r2.w = (r0.w) * (v0.z) + (c2.w);
    r1.w = r3.x;
    r3.xy = float2(((r2.w) >= 0.0f ? (r4.x) : (r6.x)), ((r2.w) >= 0.0f ? (r4.y) : (r6.y)));
    r0.w = dot(r1, c1.wwww);
    r1.xyz = v4.xyz;
    ...
    r3 = tex2D(s8, v1.xy);
    r3 = float4(((r5.w) >= 0.0f ? (r1.x) : (r3.x)), ((r5.w) >= 0.0f ? (r1.y) : (r3.y)), ((r5.w) >= 0.0f ? (r1.z) : (r3.z)), ((r5.w) >= 0.0f ? (r1.w) : (r3.w)));
    r1 = tex2D(s10, v7.zw);
