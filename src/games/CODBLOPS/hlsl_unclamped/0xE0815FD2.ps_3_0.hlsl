// Mechanically reconstructed from 0xE0815FD2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = dot(r1.xy, r0.zw) + (c15.z);
    r2.x = dot(r1.xy, r0.xy) + (c15.z);
    r0 = tex2D(s1, v1.xy);
    ...
    r1 = tex2D(s14, v1.zw);
    r6.xy = (r1.xy) * (c10.xx);
    r8.xy = (r0.wy) * (c10.yy) + (c10.zz);
    r2.xy = (r2.xz) * (r6.xx);
    r0.w = dot(r8.xy, r7.xy) + (c15.z);
    r0.y = (r1.x) * (c10.x) + (-(r2.x));
    r1.w = (r2.z) * (-(r6.x)) + (r0.y);
    r5.xy = (r0.xz) * (r6.yy);
    r0.y = (r1.y) * (c10.x) + (-(r5.x));
    r0.x = dot(r8.xy, r8.xy) + (c15.z);
    r0.y = (r0.z) * (-(r6.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r6.y = (r1.w) + (r1.w);
    r0.z = (r0.z) * (c3.y) + (c3.z);
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c15.w) : (c15.z));
