// Mechanically reconstructed from 0xCA2B9BB7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.w = (r3.x) * (r1.z);
    r3.xz = c[8].xz;
    r3.x = dot(r1.xw, c[27].xy) + (r3.x);
    r3.y = dot(r1.xw, c[27].zw) + (r3.z);
    r1 = tex2D(s3, r3.xy);
    ...
    r1.x = dot(r4.xy, r1.xy) + (c1.w);
    r1.y = dot(r4.xy, r1.zw) + (c1.w);
    r8.w = (r0.w) * (v7.y);
    r14.xy = lerp(r3.xy, r1.xy, r8.ww);
    ...
    r10.xyz = lerp(r0.zzz, c[29].xyw, r8.www);
    r4.z = (r3.w) * (c3.z);
    r0.xyz = normalize(v6.xyz);
    r2.y = (r3.w) * (-(c4.z)) + (c4.w);
    r2.x = saturate(dot(r11.xyz, -(r0.xyz)));
    r2.z = (r6.w) * (r2.y) + (r4.z);
    r2.y = (r2.x) * (r2.y) + (r4.z);
    r8.w = (-(r2.x)) + (-(c1.y));
    r2.z = (r2.z) * (r2.y) + (c12.x);
    r2.z = 1.0f / (r2.z);
    r4.xyz = (r7.xyz) * (r7.www) + (-(r0.xyz));
    r4.w = (r6.w) * (r2.z);
