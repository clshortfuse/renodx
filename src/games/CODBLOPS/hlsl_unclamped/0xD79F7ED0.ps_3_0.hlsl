// Mechanically reconstructed from 0xD79F7ED0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = c0.z;
    r7.xyz = float3(((r5.w) >= 0.0f ? (c[30].x) : (r2.y)), ((r5.w) >= 0.0f ? (c[30].y) : (r2.y)), ((r5.w) >= 0.0f ? (c[30].w) : (r2.y)));
