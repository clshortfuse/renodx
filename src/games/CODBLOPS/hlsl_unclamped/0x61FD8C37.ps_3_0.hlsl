// Mechanically reconstructed from 0x61FD8C37.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.w = (r8.w) * (c4.x) + (c4.y);
    r2.w = (r0.y) * (r7.w);
    r2.z = saturate(dot(r9.xyz, -(r11.xyz)));
    r6.w = (r1.w) * (c2.x);
    r4.w = (r1.w) * (-(c2.x)) + (c2.y);
    r5.w = (r2.z) * (r4.w) + (r6.w);
