// Mechanically reconstructed from 0x57D4FADE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xyz = (r13.xyz) * (r0.www) + (r1.xyz);
    r2 = tex2D(s6, v0.xy);
    r0 = v1;
    r0.xyz = (r6.xxx) * (v4.xyz) + (r0.xyz);
    r11.xyz = lerp(r2.yyy, c[36].xyw, r7.www);
    ...
    r6.xyz = (r3.xyz) * (r1.www) + (r5.xyz);
    r12.xyz = (r12.xyz) * (r8.www) + (-(r14.xyz));
