// Mechanically reconstructed from 0x6346F574.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.y = c0.z;
    r5.xyz = float3(((r2.w) >= 0.0f ? (c[30].x) : (r5.y)), ((r2.w) >= 0.0f ? (c[30].y) : (r5.y)), ((r2.w) >= 0.0f ? (c[30].w) : (r5.y)));
    r0 = float4(((r2.w) >= 0.0f ? (r0.x) : (c0.z)), ((r2.w) >= 0.0f ? (r0.y) : (c0.z)), ((r2.w) >= 0.0f ? (r0.z) : (c0.z)), ((r2.w) >= 0.0f ? (r0.w) : (c0.z)));
    r11.w = max(abs(r9.y), abs(r9.z));
    r6.xyz = (r2.xyz) * (r5.zzz);
    r2.w = max(abs(r9.x), r11.w);
    r2.w = 1.0f / (r2.w);
