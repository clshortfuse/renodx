// Mechanically reconstructed from 0x916BE4F8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s4, v7.zw);
    r7.w = (r1.w) * (v7.y);
    r0.w = lerp(r4.y, r5.w, c[8].w);
    r2 = (r7.wwww) * (r2) + (r3);
    r11.xyz = (r5.xyz) * (r0.www);
    r5.w = (r2.w) * (c2.w);
    ...
    r4 = tex2D(s13, r3.xy);
    r2.w = r4.y;
    r8.xyz = lerp(r0.yyy, c[29].xyw, r7.www);
    r0.xy = (r2.yw) * (c12.xx) + (c12.yy);
    r2.w = dot(r0.xy, r0.xy) + (c1.z);
    r0.z = dot(r13.xy, r13.xy) + (c1.z);
    r2.w = exp2(-(r2.w));
    r0.z = exp2(-(r0.z));
    r2.y = (r2.w) * (c2.x) + (c2.y);
    r2.w = (r0.z) * (c2.x) + (c2.y);
    r0.z = dot(r0.xy, r13.xy) + (c1.z);
    r0.y = (r2.y) * (r2.w);
    r3 = tex2D(s14, v0.zw);
    r13.xy = (r3.xy) * (c3.ww);
