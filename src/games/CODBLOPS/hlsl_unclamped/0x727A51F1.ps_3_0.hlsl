// Mechanically reconstructed from 0x727A51F1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4 = tex2D(s7, v1.xy);
    r2 = tex2D(s8, v6.xy);
    r5 = float4(((r7.w) >= 0.0f ? (r2.x) : (r4.x)), ((r7.w) >= 0.0f ? (r2.y) : (r4.y)), ((r7.w) >= 0.0f ? (r2.z) : (r4.z)), ((r7.w) >= 0.0f ? (r2.w) : (r4.w)));
    r4 = tex2D(s9, v6.zw);
