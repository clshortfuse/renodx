// Mechanically reconstructed from 0xCA03965F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyz = lerp(r4.xyz, r2.xyz, r5.www);
    ...
    r4.xy = (r4.xz) * (r7.xx);
    r1.z = dot(r9.xy, r8.xy) + (c3.z);
    r1.x = (r3.x) * (c12.w) + (-(r4.x));
    r2.y = (r4.z) * (-(r7.x)) + (r1.x);
    r6.xy = (r2.xz) * (r7.yy);
    r2.w = (r3.y) * (c12.w) + (-(r6.x));
    ...
    r2.xyz = float3(((r6.w) >= 0.0f ? (r1.y) : (c[39].x)), ((r6.w) >= 0.0f ? (r1.y) : (c[39].y)), ((r6.w) >= 0.0f ? (r1.y) : (c[39].w)));
    r1.w = saturate(dot(r3.xyz, r4.xyz));
    r1.xyz = -(r2.xyz);
    r3.w = (-(r1.w)) + (-(c3.y));
    r1.w = (r1.y) + (-(c3.y));
    r1.y = (r3.w) * (r3.w);
    r13.xyz = (r5.www) * (r1.xwz) + (r2.xyz);
    r1.w = (r1.y) * (r1.y);
