// Mechanically reconstructed from 0x3BD6F6AD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xyz = (v0.zzz) * (r1.xyz) + (c21.www);
    r2.w = saturate(dot(r4.xyz, c[17].xyz));
    r0.xyz = (r0.xyz) * (r5.xyz);
    r1 = tex2D(s5, v8.xy);
    r1.xyz = (r1.xyz) + (c21.yyy);
    r2.xyz = (v0.www) * (r1.xyz) + (c21.www);
    r1.w = (-(r2.w)) + (c21.w);
    ...
    r1.w = dot(r6.xy, r6.xy) + (c21.z);
    r1.y = dot(r2.xy, r2.xy) + (c21.z);
    r1.w = exp2(-(r1.w));
    r1.y = exp2(-(r1.y));
    r1.w = (r1.w) * (c3.x) + (c3.y);
    r2.w = (r1.y) * (c3.x) + (c3.y);
    r1.y = dot(r2.xy, r6.xy) + (c21.z);
    r3.w = (r1.w) * (r2.w);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c4.ww);
