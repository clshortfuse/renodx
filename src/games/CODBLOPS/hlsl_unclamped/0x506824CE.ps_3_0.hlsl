// Mechanically reconstructed from 0x506824CE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s3, v6.zw);
    r6.w = (r2.w) * (v6.y) + (c2.x);
    r13.xy = float2(((r6.w) >= 0.0f ? (r0.x) : (r4.x)), ((r6.w) >= 0.0f ? (r0.y) : (r4.y)));
    r8.xyz = (-(v5.xyz)) + (c[5].xyz);
    r0 = v1;
    r0.xyz = (r13.xxx) * (v4.xyz) + (r0.xyz);
    r1.w = dot(r8.xyz, r8.xyz);
    r4.xyz = (r13.yyy) * (v3.xyz) + (r0.xyz);
    r7.w = rsqrt(r1.w);
    ...
    r3.w = r4.w;
    r9.xyz = float3(((r6.w) >= 0.0f ? (c[28].x) : (r4.y)), ((r6.w) >= 0.0f ? (c[28].y) : (r4.y)), ((r6.w) >= 0.0f ? (c[28].w) : (r4.y)));
