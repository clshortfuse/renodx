// Mechanically reconstructed from 0x8300B9CA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = r2.y;
    r6.x = dot(r5.xy, r1.xy) + (c3.w);
    r3 = tex2D(s1, v1.xy);
    r1.xy = (r3.wy) * (c1.xy) + (c1.zw);
    r4 = tex2D(s2, v6.xy);
    r4.w = (r4.w) * (v0.y);
    r6.y = dot(r5.xy, r1.zw) + (c3.w);
    r3.xy = (r4.ww) * (-(r1.xy)) + (r1.xy);
    r5 = tex2D(s3, v6.zw);
    r7.w = (r5.w) * (v0.z);
    r1.xy = (r0.yw) * (c12.xx) + (c12.yy);
    r8.xy = lerp(r3.xy, r6.xy, r7.ww);
    ...
    r6.y = (r0.w) + (r0.w);
    r1 = tex2D(s5, v1.xy);
    r3.xy = lerp(r1.yy, c[23].xy, r4.ww);
    r2.w = -(r1.w);
    r0 = tex2D(s6, v6.xy);
    r2.xyz = c3.zzz;
    r1 = (r1.wwww) * (-(c3.wwwy)) + (-(c3.zzzw));
    r0 = (r2) + (r0);
    r10.xy = lerp(r3.xy, c[24].xy, r7.ww);
    r2 = (r4.wwww) * (r0) + (r1);
    r1 = tex2D(s7, v6.zw);
    r0.xyz = v2.xyz;
