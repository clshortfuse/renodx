// Mechanically reconstructed from 0x5FFF94E5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = (r0.w) + (r0.w);
    r0.xyw = c[31].xyw;
    r1.xyz = (-(r0.xyw)) + (c[32].xyw);
    r0.xyz = (r8.xyz) * (r3.www) + (r3.xyz);
    r11.xyz = (r5.www) * (r1.xyz) + (c[31].xyw);
