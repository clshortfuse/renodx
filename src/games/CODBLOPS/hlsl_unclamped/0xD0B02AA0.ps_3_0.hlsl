// Mechanically reconstructed from 0xD0B02AA0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.y = dot(r1.xy, r0.zw) + (c20.z);
    r5.x = dot(r1.xy, r0.xy) + (c20.z);
    r0 = tex2D(s6, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    ...
    r0.y = dot(r5.xy, r5.xy) + (c20.z);
    r0.w = dot(r1.xy, r1.xy) + (c20.z);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r3.w = (r0.y) * (c3.x) + (c3.y);
    r0.y = (r0.w) * (c3.x) + (c3.y);
    r0.w = dot(r1.xy, r5.xy) + (c20.z);
    r0.y = (r3.w) * (r0.y);
    r1 = tex2D(s14, v1.zw);
    r6.xy = (r1.xy) * (c4.ww);
