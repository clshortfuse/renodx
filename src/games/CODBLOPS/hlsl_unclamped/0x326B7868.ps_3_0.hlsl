// Mechanically reconstructed from 0x326B7868.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c13 = float4(0.600000024f, 0.400000006f, 0.797884583f, 31.875f);
    ...
    r1 = tex2D(s13, r1.xy);
    r2.xy = (r3.yy) * (r1.xz);
    r0.w = (r0.y) * (c13.w) + (-(r2.x));
    r0.y = r1.y;
    r1.w = (r1.z) * (-(r3.y)) + (r0.w);
    r1.xy = (r0.xy) * (c15.xx) + (c15.yy);
    r0 = tex2D(s5, v7.zw);
    r3.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c3.xxxx) * (v8) + (c3.yyyy);
    r6.y = dot(r3.xy, r0.zw) + (c4.x);
    r6.x = dot(r3.xy, r0.xy) + (c4.x);
    r0 = tex2D(s1, v1.xy);
    r8.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = tex2D(s4, v7.zw);
    r4.w = (r0.w) * (v0.z);
    r3.y = (r1.w) + (r1.w);
    r7.xy = lerp(r8.xy, r6.xy, r4.ww);
    r0.w = dot(r7.xy, r7.xy) + (c4.x);
    r1.w = dot(r1.xy, r1.xy) + (c4.x);
    r0.w = exp2(-(r0.w));
    r1.w = exp2(-(r1.w));
    r0.w = (r0.w) * (c13.x) + (c13.y);
    r1.z = (r1.w) * (c13.x) + (c13.y);
    r1.w = dot(r1.xy, r7.xy) + (c4.x);
    r1.z = (r0.w) * (r1.z);
    ...
    r2.xyz = float3(((r7.z) >= 0.0f ? (r1.x) : (r2.x)), ((r7.z) >= 0.0f ? (r1.y) : (r2.y)), ((r7.z) >= 0.0f ? (r1.z) : (r2.z)));
    r10.xz = (r4.xy) * (c12.ww);
    ...
    r6.w = c3.w;
    r2.xyz = float3(((r7.z) >= 0.0f ? (r6.w) : (c[23].x)), ((r7.z) >= 0.0f ? (r6.w) : (c[23].y)), ((r7.z) >= 0.0f ? (r6.w) : (c[23].w)));
    r11.xyz = (r0.xyz) * (-(r0.xyz)) + (c3.www);
    r12.xyz = (r0.xyz) * (r0.xyz);
    r0.xyz = v2.xyz;
    r0.xyz = (r7.xxx) * (v4.xyz) + (r0.xyz);
    r1.x = (r0.w) * (-(c15.z)) + (c15.w);
