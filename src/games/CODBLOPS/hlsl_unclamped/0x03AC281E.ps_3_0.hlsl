// Mechanically reconstructed from 0x03AC281E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.y = dot(r1.xy, r0.zw) + (c36.w);
    r4.x = dot(r1.xy, r0.xy) + (c36.w);
    r2 = tex2D(s0, v1.xy);
    r1 = tex2D(s5, v7.xy);
    r4.z = (r1.w) * (v0.y);
    r0 = tex2D(s1, v1.xy);
    ...
    r6.xz = (r3.xy) * (c12.xx);
    r0.y = c36.z;
    r0.xyz = (r0.yyy) + (-(c[32].xyw));
    r3.xyz = (r6.xyz) * (r3.www) + (r1.xyz);
    r4.xyz = (r4.zzz) * (r0.xyz) + (c[32].xyw);
    r2 = tex2D(s8, v1.xy);
    r1 = tex2D(s9, v7.zw);
