// Mechanically reconstructed from 0xE82ADD4A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xy = (r0.ww) * (-(r4.xy)) + (r4.xy);
    r1.y = dot(r2.xy, r2.xy) + (c4.w);
    r1.w = dot(r8.xy, r8.xy) + (c4.w);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r1.y = (r1.y) * (c1.x) + (c1.y);
    r1.w = (r1.w) * (c1.x) + (c1.y);
    r3.w = (r1.y) * (r1.w);
    r1.y = dot(r2.xy, r8.xy) + (c4.w);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c2.ww);
    ...
    r4.xz = (r1.xy) * (c3.xx);
    r4.y = (r1.z) + (r1.z);
    r3.xyz = (r5.xyz) * (r6.www);
    r2.xyz = (r4.xyz) * (r1.www) + (r2.xyz);
    r1 = tex2D(s6, v1.xy);
    r3.w = lerp(r1.y, c4.x, r0.w);
    r1.xyz = (r5.www) * (r3.xyz);
    r5.xyz = (r2.xyz) * (r3.www);
    r2 = tex2D(s0, v1.xy);
    r7.xyz = lerp(r2.xyz, r0.xyz, r0.www);
    r0 = tex2D(s5, v7.zw);
    r0.xyz = (r0.xyz) + (c4.yyy);
    r2.xyz = (v0.zzz) * (r0.xyz) + (c4.xxx);
    r0 = v2;
