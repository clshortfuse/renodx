// Mechanically reconstructed from 0x954AFBF6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = dot(r4.xyz, c[10].xyz);
    r2.w = saturate((r2.w) * (c[11].x) + (c[11].y));
    r7.x = 1.0f / (r5.w);
    r3.w = (r2.w) * (c[11].w);
    r6.xy = saturate((r7.xx) * (c[21].xy) + (c[21].zw));
    r2.xy = (r6.xy) * (r6.xy);
    r6.xy = (r6.xy) * (c2.yy) + (c2.zz);
    r2.z = dot(c[20].yz, r7.xy) + (c[20].x);
    r2.xy = (r2.xy) * (r6.xy);
