// Mechanically reconstructed from 0xA468A957.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.z = (r2.y) * (r2.y);
    r5.z = (r6.w) * (c12.y) + (c12.z);
    r3.z = (r3.z) * (r3.z);
    r2.z = (r2.z) * (r5.z);
    r2.y = (r2.y) * (r3.z);
    r2.z = (r2.x) * (r2.z);
    r2.x = (r2.y) * (c16.x) + (c16.y);
    r2.y = exp2(-(r3.w));
    r2.z = (r2.z) * (r2.x);
    r5.w = (r2.y) * (c3.x) + (c3.y);
    ...
    r2.z = (r2.w) * (r6.z) + (c12.x);
    r2.w = pow(abs(r3.y), r6.w);
    r2.z = 1.0f / (r2.z);
    r2.w = (r5.z) * (r2.w);
    r2.y = (r3.w) * (r2.z);
    r2.z = (r3.z) * (c16.x) + (c16.y);
    r2.w = (r2.w) * (r2.y);
