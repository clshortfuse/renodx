// Mechanically reconstructed from 0x8B81369A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xyz = float3(((r4.w) >= 0.0f ? (r0.x) : (r2.x)), ((r4.w) >= 0.0f ? (r0.y) : (r2.y)), ((r4.w) >= 0.0f ? (r0.z) : (r2.z)));
    ...
    r0 = tex2D(s13, r0.xy);
    r2.w = r0.y;
    r9.xy = float2(((r4.w) >= 0.0f ? (r3.x) : (c1.y)), ((r4.w) >= 0.0f ? (r3.y) : (c1.y)));
    r3.xy = (r2.yw) * (c12.xx) + (c12.yy);
    r0.y = dot(r9.xy, r9.xy) + (c1.y);
    r0.w = dot(r3.xy, r3.xy) + (c1.y);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r5.w = (r0.y) * (c1.z) + (c1.w);
    r0.y = (r0.w) * (c1.z) + (c1.w);
    r0.w = dot(r3.xy, r9.xy) + (c1.y);
    r0.y = (r5.w) * (r0.y);
