// Mechanically reconstructed from 0x87F903FB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = r2.w;
    r3.xyz = (v0.yyy) * (r0.xyz) + (c1.yyy);
    r0 = tex2D(s0, v1.xy);
    r1.xyz = (r3.xyz) * (r0.xyz);
    r0 = tex2D(s6, v8.zw);
    r2.w = (r0.w) * (v0.z) + (c1.w);
    r3.xyz = (r3.xyz) * (c1.zzz);
    r4.xyz = float3(((r2.w) >= 0.0f ? (r0.x) : (r1.x)), ((r2.w) >= 0.0f ? (r0.y) : (r1.y)), ((r2.w) >= 0.0f ? (r0.z) : (r1.z)));
    r0 = tex2D(s8, v8.zw);
    ...
    r2.w = rsqrt(r0.z);
    r13.xyz = (r11.www) * (v7.xyz);
    r0.xz = (r3.xy) * (c12.ww);
    r3.xyz = (r2.xyz) * (r2.www) + (-(r13.xyz));
    ...
    r0.z = saturate(dot(r9.xyz, -(r13.xyz)));
    r0.y = (r2.w) * (r10.w) + (r5.z);
    r5.w = (r0.z) * (r10.w) + (r5.z);
    r2.xyz = (r4.www) * (r1.xyz) + (r15.xyz);
    ...
    r4.x = exp2(r0.y);
    r1.x = saturate(dot(r9.xyz, r14.xyz));
    r0.z = pow(abs(r1.x), r4.x);
    r4.y = (r4.x) * (c13.y) + (c13.z);
    r0.y = 1.0f / (r0.x);
    r0.z = (r0.z) * (r4.y);
    r4.z = (r1.y) * (r0.y);
    r3.w = (r1.z) * (r0.z);
    r1.w = (r1.w) * (c3.w);
    r1.xyz = (r9.xyz) * (-(r12.www)) + (r13.xyz);
    ...
    r3.y = (r1.w) * (r5.w) + (c13.x);
    r1.w = saturate(dot(r9.xyz, r0.xyz));
    r0.y = 1.0f / (r3.y);
    r0.z = pow(abs(r1.w), r4.x);
    r0.y = (r9.w) * (r0.y);
    r0.z = (r4.y) * (r0.z);
    r1.w = (r0.y) * (r0.z);
