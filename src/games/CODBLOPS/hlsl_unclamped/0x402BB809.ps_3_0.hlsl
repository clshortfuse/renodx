// Mechanically reconstructed from 0x402BB809.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c3 = float4(-2.0f, 3.0f, 31.875f, 0.0f);
    const float4 c4 = float4(8.0f, 1.0f, 0.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r2.xy = c1.xy;
    r0.xy = (v7.xy) * (c[24].xx) + (r2.xx);
    r0.xy = (r0.xy) * (c[25].xx) + (r2.yy);
    r0 = tex2D(s1, r0.xy);
    r6.xy = (v7.xy) * (c[24].xx);
    r0.w = (r0.y) * (c1.z) + (c1.w);
    r1.xy = (r6.xy) * (c2.xx) + (c2.yy);
    r0.y = (r0.w) * (c1.z) + (c1.w);
    r1.xy = (r1.xy) * (c[26].xx) + (r2.yy);
    r1 = tex2D(s2, r1.xy);
    r0.w = (r1.y) * (c1.z) + (c1.w);
    r0.w = (r0.w) * (c1.z) + (c1.w);
    r0.xz = c2.zz;
    ...
    r0.w = 1.0f / (c[21].x);
    r1.xyz = (r0.xyz) * (c[22].xxx);
    r0.xyz = (r2.xyz) * (r0.www);
    r2.xyz = (r1.xyz) * (c4.xxx);
    r0.w = max(abs(r4.x), abs(r4.y));
    r1.xyz = (r0.xyz) * (c[23].xxx) + (-(r2.xyz));
    r0.w = saturate((r0.w) * (-(r0.w)) + (c4.y));
    r4.w = max(abs(r3.y), abs(r3.z));
    r1.w = ((-(r4.z)) >= 0.0f ? (c3.w) : (r0.w));
    ...
    r1.xyz = (r4.xyz) * (c3.zzz);
    r1.xyz = (r2.www) * (r2.xyz) + (r1.xyz);
    r4.xyz = normalize(v5.xyz);
    r2.xyz = (r0.xyz) * (r0.xyz);
    r0.z = dot(c[10].xyz, r4.xyz);
    r1.w = saturate((c[20].y) * (r0.z) + (c[20].x));
    r0.xyz = c[0].xyz;
