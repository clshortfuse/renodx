// Mechanically reconstructed from 0xEDFBFAF2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r0.z) * (-(r6.x)) + (r1.w);
    r6.w = c4.x;
    r0.xyz = (r6.www) + (-(c[36].xyw));
    r9.y = (r1.w) + (r1.w);
    r3.xyz = (r13.www) * (r0.xyz) + (c[36].xyw);
    r0.xyz = (r9.xyz) * (r0.www) + (r4.xyz);
    r11.xyz = lerp(r3.xyz, c4.xxx, r12.www);
    ...
    r5.w = exp2(r15.y);
    r0.z = (-(r0.z)) + (c4.x);
    r0.y = pow(abs(r2.w), r5.w);
    r0.x = (r0.z) * (r0.z);
    r2.w = (r5.w) * (c13.x) + (c13.y);
    r0.x = (r0.x) * (r0.x);
    r0.y = (r0.y) * (r2.w);
    r0.z = (r0.z) * (r0.x);
    r5.xyz = (r4.xyz) * (r4.xyz);
    r4.xyz = (r4.xyz) * (-(r4.xyz)) + (c4.xxx);
    r3.w = (r3.w) * (r0.y);
    r0.xyz = (r4.xyz) * (r0.zzz) + (r5.xyz);
    r13.xyz = (r3.yyy) * (r13.xyz) + (r14.xyz);
