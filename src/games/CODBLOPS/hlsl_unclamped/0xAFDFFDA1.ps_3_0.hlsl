// Mechanically reconstructed from 0xAFDFFDA1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c41 = float4(2.0f, -1.0f, 1.0f, 0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = tex2D(s1, v1.xy);
    r1 = tex2D(s5, v7.xy);
    r1.xyz = (r1.xyz) + (c41.yyy);
    r3.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r7.xyz = (v0.yyy) * (r1.xyz) + (c41.zzz);
    r0 = tex2D(s0, v1.xy);
    r1 = tex2D(s6, v7.zw);
    r7.w = (r1.w) * (v0.z);
    ...
    r13.xyz = lerp(r2.yyy, c[39].xyw, r7.www);
    ...
    r0.w = (r4.w) * (r4.w);
    r6.w = (r0.w) * (r0.w);
    r2.xyz = (r7.xyz) * (c41.www);
    r1 = tex2D(s9, v7.zw);
    r0 = lerp(r2, r1, r7.wwww);
    r1.y = (r4.w) * (r6.w);
    r14.xyz = (r0.xyz) * (-(r0.xyz)) + (c41.zzz);
