// Mechanically reconstructed from 0x1821D0EB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = (c13.xxxx) * (v7) + (c13.yyyy);
    r0.x = dot(r5.xy, r3.xy) + (c2.x);
    r0.y = dot(r5.xy, r3.zw) + (c2.x);
    r3 = tex2D(s5, v1.xy);
    r4.zw = r3.yy;
    r5 = tex2D(s3, v6.zw);
    r6.w = (r5.w) * (v0.z) + (c2.y);
    ...
    r4.xz = (r1.xy) * (c12.xx);
    r3 = tex2D(s2, v6.xy);
    r2.xyz = (r3.xyz) + (c13.yyy);
    r1.w = (r1.z) * (-(r7.x)) + (r1.w);
    r9.xyz = (v0.yyy) * (r2.xyz) + (c13.zzz);
    r4.y = (r1.w) + (r1.w);
    r2.xyz = (r9.xyz) * (c13.www);
    r1 = tex2D(s6, v6.zw);
    r3.xyz = v2.xyz;
