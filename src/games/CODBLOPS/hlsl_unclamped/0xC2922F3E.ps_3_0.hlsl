// Mechanically reconstructed from 0xC2922F3E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = dot(r4.xy, r0.xy) + (c8.z);
    r1.y = dot(r4.xy, r0.zw) + (c8.z);
    r0 = tex2D(s2, v6.zw);
    r8.w = (r0.w) * (v6.y);
    ...
    r1.w = dot(r9.xy, r9.xy) + (c8.z);
    r1.z = dot(r3.xy, r3.xy) + (c8.z);
    r1.w = exp2(-(r1.w));
    r1.z = exp2(-(r1.z));
    r1.w = (r1.w) * (c1.x) + (c1.y);
    r1.x = (r1.z) * (c1.x) + (c1.y);
    r1.z = dot(r3.xy, r9.xy) + (c8.z);
    r1.x = (r1.w) * (r1.x);
    r3 = tex2D(s14, v0.zw);
    r11.xy = (r3.xy) * (c3.ww);
