// Mechanically reconstructed from 0x47B30B65.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = dot(r1.xy, r1.xy) + (c6.y);
    r1.w = dot(r5.xy, r5.xy) + (c6.y);
    r1.z = exp2(-(r1.z));
    r1.w = exp2(-(r1.w));
    r2.w = (r1.z) * (c6.z) + (c6.w);
    r1.w = (r1.w) * (c6.z) + (c6.w);
    r1.z = dot(r1.xy, r5.xy) + (c6.y);
    r1.y = (r2.w) * (r1.w);
