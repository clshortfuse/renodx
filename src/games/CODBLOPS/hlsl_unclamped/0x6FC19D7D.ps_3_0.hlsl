// Mechanically reconstructed from 0x6FC19D7D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xy = (r4.yw) * (c38.xx) + (c38.yy);
    r3 = tex2D(s14, v0.zw);
    r6.xy = (r3.xy) * (c3.ww);
    r1.z = dot(r1.xy, r5.xy) + (c1.z);
    r4.xy = (r4.xz) * (r6.xx);
    r2.w = (r3.x) * (c3.w) + (-(r4.x));
    r2.xy = (r2.xz) * (r6.yy);
    r2.w = (r4.z) * (-(r6.x)) + (r2.w);
    ...
    r10.xyz = float3(((r7.w) >= 0.0f ? (c[36].x) : (r1.w)), ((r7.w) >= 0.0f ? (c[36].y) : (r1.w)), ((r7.w) >= 0.0f ? (c[36].w) : (r1.w)));
    r7.xyz = (r0.xyz) * (r0.xyz);
    r11.xyz = (r1.xyz) * (r10.yyy);
    r2 = tex2D(s12, v0.zw);
    r1 = v1;
    ...
    r2.z = rsqrt(r1.y);
    r2.w = rsqrt(r1.z);
    r1.xyz = (r2.zzz) * (v6.xyz);
    r3.xyz = (v6.xyz) * (-(r2.zzz)) + (c[17].xyz);
