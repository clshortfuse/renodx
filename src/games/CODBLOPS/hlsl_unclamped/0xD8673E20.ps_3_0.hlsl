// Mechanically reconstructed from 0xD8673E20.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.x = dot(r2.xy, r0.xy) + (c3.z);
    r4.y = dot(r2.xy, r0.zw) + (c3.z);
    r0 = tex2D(s3, v7.xy);
    r4.w = (r0.w) * (v0.y) + (c3.w);
    ...
    r1 = tex2D(s6, v1.xy);
    r9.xyz = float3(((r4.w) >= 0.0f ? (c[24].x) : (r1.y)), ((r4.w) >= 0.0f ? (c[24].y) : (r1.y)), ((r4.w) >= 0.0f ? (c[24].w) : (r1.y)));
    r1.xyz = v2.xyz;
