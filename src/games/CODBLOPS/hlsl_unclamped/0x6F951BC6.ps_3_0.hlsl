// Mechanically reconstructed from 0x6F951BC6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.z = (r1.w) * (c1.w);
    r4.w = (r1.w) * (-(c4.z)) + (c4.w);
    r1.x = saturate(dot(r0.xyz, -(r9.xyz)));
    r1.z = (r2.w) * (r4.w) + (r4.z);
    r4.w = (r1.x) * (r4.w) + (r4.z);
    ...
    r2.w = dot(r5.xy, r5.xy) + (c13.w);
    r2.y = dot(r3.xy, r3.xy) + (c13.w);
    r2.w = exp2(-(r2.w));
    r2.y = exp2(-(r2.y));
    r2.w = (r2.w) * (c1.x) + (c1.y);
    r3.w = (r2.y) * (c1.x) + (c1.y);
    r2.y = dot(r3.xy, r5.xy) + (c13.w);
    r4.w = (r2.w) * (r3.w);
    r3 = tex2D(s14, v1.zw);
    r14.xy = (r3.xy) * (c2.ww);
