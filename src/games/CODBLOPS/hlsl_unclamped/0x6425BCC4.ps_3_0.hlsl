// Mechanically reconstructed from 0x6425BCC4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(0.25f, -1.0f, 1.0f, 0.797884583f);
    const float4 c2 = float4(0.959999979f, 0.0399999991f, 0.0009765625f, 0.0f);
