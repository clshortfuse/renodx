// Mechanically reconstructed from 0xE698604D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyz = (r0.xyz) * (c[36].yyy);
    r1 = tex2D(s5, v1.xy);
    r2 = tex2D(s0, v1.xy);
    r0 = v2;
    r7.xyz = (r9.xxx) * (v5.xyz) + (r0.xyz);
    r0.xyz = (r2.xyz) * (v0.xyz);
    r2.xyz = (r9.yyy) * (v4.xyz) + (r7.xyz);
