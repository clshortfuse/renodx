// Mechanically reconstructed from 0xCF60EEE9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s0, v1.xy);
    r2.xyz = saturate((r0.xyz) * (r1.www) + (r1.xyz));
    r0 = tex2D(s1, v1.xy);
