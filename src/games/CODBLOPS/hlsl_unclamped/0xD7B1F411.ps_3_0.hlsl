// Mechanically reconstructed from 0xD7B1F411.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = float3(((r2.w) >= 0.0f ? (r0.x) : (r3.x)), ((r2.w) >= 0.0f ? (r0.y) : (r3.y)), ((r2.w) >= 0.0f ? (r0.z) : (r3.z)));
    r0 = tex2D(s5, v7.zw);
    r0.w = (r0.w) * (v0.z) + (c3.w);
    r1.w = ((r2.w) >= 0.0f ? (r1.y) : (r2.y));
    r2.xyz = float3(((r0.w) >= 0.0f ? (r0.x) : (r5.x)), ((r0.w) >= 0.0f ? (r0.y) : (r5.y)), ((r0.w) >= 0.0f ? (r0.z) : (r5.z)));
    r7.w = ((r0.w) >= 0.0f ? (-(c3.y)) : (r1.w));
    ...
    r0.w = (r2.w) * (r2.w);
    r5.xyz = (v0.www) * (r0.xyz) + (-(c3.yyy));
    r0.w = (r1.w) * (r0.w);
    r0.xyz = (r5.xyz) * (c4.xxx);
    r2.xyz = (r2.xyz) * (r5.xyz);
    r13.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c3.yyy));
    r14.xyz = (r0.xyz) * (r0.xyz);
    r0.xyz = v2.xyz;
    r5.xyz = (r4.xxx) * (v4.xyz) + (r0.xyz);
    r0.xyz = (r13.xyz) * (r0.www) + (r14.xyz);
    r5.xyz = (r4.yyy) * (v3.xyz) + (r5.xyz);
    r11.z = (r4.z) * (c12.x);
    ...
    r1.w = r3.y;
    r3.xy = (r3.xz) * (r0.xx);
    r8.xy = (r1.wy) * (c12.zz) + (c12.ww);
    r1.w = (r2.x) * (c12.y) + (-(r3.x));
    r0.z = dot(r8.xy, r4.xy) + (c3.z);
    r2.w = (r3.z) * (-(r0.x)) + (r1.w);
    r1.xy = (r1.xz) * (r0.yy);
    r0.x = dot(r8.xy, r8.xy) + (c3.z);
    r1.w = (r2.y) * (c12.y) + (-(r1.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r1.z) * (-(r0.y)) + (r1.w);
    r0.x = (r0.x) * (c4.y) + (c4.z);
    r0.y = (r0.y) + (r0.y);
