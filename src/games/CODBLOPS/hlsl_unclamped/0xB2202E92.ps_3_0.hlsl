// Mechanically reconstructed from 0xB2202E92.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = c1.w;
    r0.xyz = float3(((r8.z) >= 0.0f ? (c[29].x) : (r0.x)), ((r8.z) >= 0.0f ? (c[29].y) : (r0.x)), ((r8.z) >= 0.0f ? (c[29].w) : (r0.x)));
    r4 = tex2D(s7, v7.zw);
    r3 = lerp(r5, r4, r8.wwww);
    r10.xyz = lerp(r0.xyz, c[30].xyw, r8.www);
    r4.z = (r3.w) * (c2.w);
