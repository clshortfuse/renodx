// Mechanically reconstructed from 0xDB3BEEB6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = dot(r3.xy, r1.xy) + (c1.z);
    r1.y = dot(r3.xy, r1.zw) + (c1.z);
    r4 = tex2D(s2, v6.zw);
    r6.w = (r4.w) * (v6.y);
    ...
    r5.w = (r0.y) * (c12.x) + (c12.y);
    r0.y = (r0.w) * (r5.w);
    r1 = tex2D(s14, v0.zw);
    r8.xy = (r1.xy) * (c3.ww);
    r0.w = dot(r3.xy, r7.xy) + (c1.z);
    r2.xy = (r2.xz) * (r8.yy);
    ...
    r9.xy = lerp(c[20].xy, r0.yy, r6.ww);
    r0.z = (r0.z) + (r0.z);
    r2 = (r0.wwww) * (c2.xxxy) + (c2.zzzx);
    r1.xyz = (r8.xyz) * (-(r0.zzz)) + (r7.xyz);
    r3 = tex2D(s4, v0.xy);
    ...
    r6.xyz = (r9.yyy) * (r1.xyz);
    r7.xyz = (r0.xyz) * (c2.www);
    r5 = tex2D(s0, v0.xy);
    r9.xyz = lerp(r5.xyz, r4.xyz, r6.www);
    r3 = (-(v5.yyyy)) + (c[6]);
    r0 = (r3) * (r3);
    r2 = (-(v5.xxxx)) + (c[5]);
    r0 = (r2) * (r2) + (r0);
