// Mechanically reconstructed from 0xD8DF98BC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.x = dot(r3.xy, r0.xy) + (c3.w);
    r1 = tex2D(s1, v1.xy);
    r0.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r1 = tex2D(s2, v6.xy);
    r7.w = (r1.w) * (v0.y);
    r2.y = dot(r3.xy, r0.zw) + (c3.w);
    r3.xy = (r7.ww) * (-(r0.xy)) + (r0.xy);
    r0 = tex2D(s3, v6.zw);
    r9.w = (r0.w) * (v0.z);
    ...
    r5.w = -(r4.w);
    r2 = (r2) + (r5);
    r5 = (r4.wwww) * (-(c3.wwwy)) + (-(c3.zzzw));
    r0.w = dot(c[5].xyz, r6.xyz);
    r6 = (r7.wwww) * (r2) + (r5);
    r5 = tex2D(s7, v6.zw);
    r2 = lerp(r6, r5, r9.wwww);
    r5.xy = lerp(r4.yy, c[8].xy, r7.ww);
    r3.w = (r2.w) * (c4.z);
    r3 = texCUBElod(s15, r3);
    r4.xyz = (r3.xyz) * (r3.xyz);
    r7.xy = lerp(r5.xy, c[9].xy, r9.ww);
    r1.w = (-(r1.w)) + (-(c3.y));
    r3.w = (r1.w) * (r1.w);
    r2.w = (r2.w) * (c2.x) + (c2.y);
    r1.w = (r1.w) * (r3.w);
