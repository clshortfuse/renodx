// Mechanically reconstructed from 0x248B2F06.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xy = float2(((r1.w) >= 0.0f ? (r4.x) : (r5.x)), ((r1.w) >= 0.0f ? (r4.y) : (r5.y)));
    ...
    r6.xyz = (r6.yyy) * (v3.xyz) + (r0.xyz);
    r0.xyz = normalize(r6.xyz);
    r6.xyz = normalize(v5.xyz);
    r2.z = dot(r6.xyz, r0.xyz);
    r2.z = (r2.z) + (r2.z);
    r3.xy = float2(((r1.w) >= 0.0f ? (r2.w) : (r3.w)), ((r1.w) >= 0.0f ? (r2.y) : (r3.y)));
