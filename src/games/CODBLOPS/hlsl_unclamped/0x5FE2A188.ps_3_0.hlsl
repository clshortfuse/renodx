// Mechanically reconstructed from 0x5FE2A188.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = (r0.x) * (r2.z) + (c12.z);
    r0.z = (r0.z) * (c11.x) + (c11.y);
    r0.x = 1.0f / (r0.x);
    r0.z = (r1.w) * (r0.z);
    r0.x = (r2.w) * (r0.x);
    r1.xyz = (r7.xyz) * (r4.www) + (r1.xyz);
    r0.z = (r0.z) * (r0.x);
    r15.xy = float2(((r3.w) >= 0.0f ? (-(c3.z)) : (r0.y)), ((r3.w) >= 0.0f ? (-(c3.y)) : (r0.y)));
    r0.xyz = (r3.xyz) * (r0.zzz);
    r14.xyz = (r1.xyz) * (r15.yyy);
