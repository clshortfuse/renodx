// Mechanically reconstructed from 0xCA130589.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = r4.y;
    r5.x = dot(r3.xy, r0.xy) + (c3.z);
    r1 = tex2D(s1, v1.xy);
    r0.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r1 = tex2D(s2, v6.xy);
    r1.w = (r1.w) * (v0.y);
    r5.y = dot(r3.xy, r0.zw) + (c3.z);
    ...
    r10.xy = lerp(r3.xy, c[10].xy, r7.ww);
    r0.w = (r0.w) + (r0.w);
