// Mechanically reconstructed from 0x3C2221CF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7 = tex2D(s8, v1.xy);
    r0 = tex2D(s9, v6.xy);
    r5.zw = lerp(r7.wy, r0.wy, r1.ww);
    r0 = tex2D(s5, v6.zw);
    r0.w = (r0.w) * (v0.z) + (c2.w);
    r10.xy = (r2.yw) * (c12.xx) + (c12.yy);
    r7.xyz = float3(((r0.w) >= 0.0f ? (r6.x) : (r5.x)), ((r0.w) >= 0.0f ? (r6.y) : (r5.y)), ((r0.w) >= 0.0f ? (r6.z) : (r5.z)));
    r2.w = dot(r10.xy, r10.xy) + (c2.z);
    r2.y = dot(r7.xy, r7.xy) + (c2.z);
    r2.w = exp2(-(r2.w));
    r2.y = exp2(-(r2.y));
    r2.w = (r2.w) * (c3.x) + (c3.y);
    r4.w = (r2.y) * (c3.x) + (c3.y);
    r6.w = ((r0.w) >= 0.0f ? (r3.y) : (r5.w));
    r2.y = (r2.w) * (r4.w);
    r3 = tex2D(s14, v1.zw);
    r6.xy = (r3.xy) * (c4.zz);
    r2.w = dot(r10.xy, r7.xy) + (c2.z);
    r4.xy = (r4.xz) * (r6.yy);
    ...
    r2.xyz = (r12.xyz) * (r6.xyz);
    r1.xyz = float3(((r0.w) >= 0.0f ? (r0.x) : (r5.x)), ((r0.w) >= 0.0f ? (r0.y) : (r5.y)), ((r0.w) >= 0.0f ? (r0.z) : (r5.z)));
    r0.xyz = (r2.xyz) * (c3.zzz);
    r5.xyz = (r1.xyz) * (r1.xyz);
    r2.z = exp2(r7.y);
    r6.xyz = (r5.xyz) * (r4.xyz) + (r0.xyz);
    r2.w = (r2.z) * (c14.z) + (c14.w);
    r1.xyz = (r11.xyz) * (r8.www) + (-(r3.xyz));
    ...
    r0.y = pow(abs(r1.z), r2.z);
    r1.z = (r7.z) * (c3.w);
    r0.z = (r7.z) * (-(c14.x)) + (c14.y);
    r0.x = (r3.w) * (r0.z) + (r1.z);
    r0.z = (r1.w) * (r0.z) + (r1.z);
    r0.y = (r2.w) * (r0.y);
