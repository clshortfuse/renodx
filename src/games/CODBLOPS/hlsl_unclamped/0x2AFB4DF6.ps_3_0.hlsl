// Mechanically reconstructed from 0x2AFB4DF6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xyz = lerp(r3.xyz, r0.xyz, r2.www);
    r0 = tex2D(s1, v1.xy);
    r4.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r0 = tex2D(s6, v7.xy);
    r3.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r0 = (c1.xxxx) * (v8) + (c1.yyyy);
    r0.x = dot(r3.xy, r0.xy) + (c1.z);
    r0.y = dot(r3.xy, r0.zw) + (c1.z);
    r1.xyz = (r1.xyz) * (r1.xyz);
    r3.xy = lerp(r4.xy, r0.xy, r1.ww);
    r0 = tex2D(s7, v7.zw);
    r4.xy = (r0.wy) * (c0.xy) + (c0.zw);
