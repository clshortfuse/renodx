// Mechanically reconstructed from 0x0B277526.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.w = (r1.w) * (v5.y);
    r2.w = (r2.w) * (-(v5.x)) + (c0.x);
    r6.xyz = lerp(r2.xyz, r1.xyz, r4.www);
    r1.w = (r1.w) * (-(v5.y)) + (c0.x);
    r7.w = c0.x;
    r1.xyz = (r7.www) + (-(c[20].xyw));
    r6.w = (r2.w) * (-(r1.w)) + (c0.x);
    r7.xyz = (r4.www) * (r1.xyz) + (c[20].xyw);
