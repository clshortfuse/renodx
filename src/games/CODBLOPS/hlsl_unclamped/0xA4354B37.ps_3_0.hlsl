// Mechanically reconstructed from 0xA4354B37.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = exp2(-(r3.z));
    r2.w = dot(r9.xy, r9.xy) + (c1.z);
    r4.w = (r2.y) * (c2.x) + (c2.y);
    r2.w = exp2(-(r2.w));
    r2.y = dot(r9.xy, r3.xy) + (c1.z);
    r3.z = (r2.w) * (c2.x) + (c2.y);
    r2.w = (r3.w) * (c2.z);
    r4.y = (r4.w) * (r3.z);
    r3 = tex2D(s14, v1.zw);
