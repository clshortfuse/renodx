// Mechanically reconstructed from 0xC7DAA791.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c9 = float4(1.0f, 0.0f, 0.600000024f, 0.400000006f);
    ...
    r0.w = dot(r4.xy, r4.xy) + (c9.y);
    r0.y = dot(r3.xy, r3.xy) + (c9.y);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c9.z) + (c9.w);
    r1.w = (r0.y) * (c9.z) + (c9.w);
    r0.y = dot(r3.xy, r4.xy) + (c9.y);
    r1.w = (r0.w) * (r1.w);
