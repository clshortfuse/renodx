// Mechanically reconstructed from 0x21CB88D1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s0, v0.xy);
    r1 = tex2D(s5, v7.zw);
    r0.xyz = (r1.xyz) * (v7.yyy);
    r0.xyz = (r0.xyz) * (r1.www) + (r2.xyz);
    r3.xyz = (r4.www) * (r7.xyz) + (r13.xyz);
    ...
    r1.y = (r2.w) * (r4.x) + (r10.w);
    r4.z = (r1.z) * (r4.x) + (r10.w);
    r2.xyz = (r5.xyz) * (r9.www) + (r7.xyz);
    r1.y = (r1.y) * (r4.z) + (c3.w);
    r1.y = 1.0f / (r1.y);
    r1.z = (-(r1.z)) + (c4.x);
    r3.w = (r2.w) * (r1.y);
    ...
    r1.y = pow(abs(r4.y), r9.w);
    r4.y = (r9.w) * (c13.x) + (c13.y);
    r1.x = 1.0f / (r1.x);
    r1.y = (r1.y) * (r4.y);
    r5.w = (r5.w) * (r1.x);
    r3.w = (r3.w) * (r1.y);
    ...
    r1.w = (r8.w) * (r4.x) + (r10.w);
    r1.w = (r1.w) * (r4.z) + (c3.w);
    r4.x = saturate(dot(r9.xyz, r8.xyz));
    r4.z = 1.0f / (r1.w);
    r1.w = pow(abs(r4.x), r9.w);
    r4.z = (r8.w) * (r4.z);
    r1.w = (r4.y) * (r1.w);
    r1.w = (r4.z) * (r1.w);
