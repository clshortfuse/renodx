// Mechanically reconstructed from 0x08D05F60.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = (r1.z) * (r1.x) + (c3.w);
    r1.x = 1.0f / (r1.z);
    r5.xy = (r1.ww) * (c7.xy) + (c7.zw);
    r5.w = saturate(dot(r0.xyz, r4.xyz));
    r1.z = exp2(r5.y);
    r4.w = pow(abs(r5.w), r1.z);
    r1.z = (r1.z) * (c4.x) + (c4.y);
    r1.x = (r3.w) * (r1.x);
    r1.z = (r4.w) * (r1.z);
    ...
    r6.w = ((r2.w) >= 0.0f ? (c1.y) : (r1.y));
    r7.w = 1.0f / (r5.x);
    r1.xyz = (r3.xyz) * (r6.www);
    r2.w = (r1.w) * (c2.w);
