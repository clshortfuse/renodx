// Mechanically reconstructed from 0x8495B2EC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xyz = lerp(c[27].xyw, r0.yyy, r6.www);
    ...
    r3 = tex2D(s0, v1.xy);
    r4 = tex2D(s4, v6.zw);
    r6.xyz = (r4.xyz) + (c15.yyy);
    r4.xyz = lerp(r3.xyz, r1.xyz, r6.www);
    r8.xyz = (v0.zzz) * (r6.xyz) + (-(c15.yyy));
    r1 = tex2D(s5, v7.xy);
    r3.xyz = (r1.xyz) + (c15.yyy);
    r1.xyz = (r4.xyz) * (r8.xyz);
    r6.xyz = (v0.www) * (r3.xyz) + (-(c15.yyy));
