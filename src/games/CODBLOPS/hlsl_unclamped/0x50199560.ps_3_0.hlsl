// Mechanically reconstructed from 0x50199560.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xyz = (r8.xyz) * (-(r1.zzz)) + (r4.xyz);
    r1.z = saturate(dot(r8.xyz, -(r4.xyz)));
    r2.w = (r1.w) * (c1.w);
