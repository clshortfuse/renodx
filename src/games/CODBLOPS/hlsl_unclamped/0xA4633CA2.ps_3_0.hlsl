// Mechanically reconstructed from 0xA4633CA2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.x = 1.0f / (r0.w);
    r0.x = saturate((r0.z) * (c[39].x) + (c[39].y));
    r7.xy = saturate((r10.xx) * (c[41].xy) + (c[41].zw));
    r5.xy = (r7.xy) * (r7.xy);
    r7.xy = (r7.xy) * (c12.xx) + (c12.yy);
    r0.z = dot(c[40].yz, r10.xy) + (c[40].x);
    r5.xy = (r5.xy) * (r7.xy);
    r0.x = (r0.x) * (c[39].w);
    r0.z = (r0.z) * (r5.x);
