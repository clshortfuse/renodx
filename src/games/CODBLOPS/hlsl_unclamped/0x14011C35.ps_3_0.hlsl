// Mechanically reconstructed from 0x14011C35.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyz = (r3.xyz) * (-(r3.xyz)) + (c4.www);
    r3.xyz = (r1.yyy) * (r3.xyz) + (r1.xzw);
    r0.yzw = (r2.xyz) * (c0.zzz) + (r0.yzw);
    ...
    r1.x = (r6.x) * (c15.x) + (c15.y);
    r0.x = (r0.x) * (c15.z) + (r1.x);
    r1.x = (-(r0.x)) + (c1.z);
    r1.y = (r1.x) * (c15.w);
    r2.w = min(r1.y, c1.z);
    r1.y = (r2.w) * (r2.w) + (-(c1.z));
    ...
    r7.xyz = (r0.yzw) * (r7.xyz) + (r1.yzw);
    r2 = max(r7, c1.xxxx);
    r0.y = saturate((r0.x) * (c16.y));
    r0.y = rsqrt(r0.y);
    r0.y = 1.0f / (r0.y);
    r1.yzw = lerp(r2.xyz, r3.xyz, r0.yyy);
    r0.xy = (r0.xx) + (c16.zw);
    r0.xy = saturate((r0.xy) * (c14.xx));
    r0.x = rsqrt(r0.x);
    r0.x = 1.0f / (r0.x);
    r2.xyz = (r6.yzw) * (r4.xyz) + (-(r1.yzw));
    r0.xzw = (r0.xxx) * (r2.xyz) + (r1.yzw);
    r0.y = rsqrt(r0.y);
    r0.y = 1.0f / (r0.y);
    r1.yzw = (r5.xyz) * (c14.yyy) + (-(r0.xzw));
    r0.xyz = (r0.yyy) * (r1.yzw) + (r0.xzw);
    r1.x = ((r1.x) >= 0.0f ? (c1.z) : (c1.x));
    oC0.w = (r2.w) * (r1.x);
    r0.w = c1.z;
    r1.x = dot(r0, c[32]);
    r1.y = dot(r0, c[33]);
