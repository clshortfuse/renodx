// Mechanically reconstructed from 0x3642F450.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.z = saturate(dot(r4.xyz, r2.xyz));
    ...
    r1.x = dot(r11.xyz, r4.xyz);
    r3.xyz = (r2.xyz) * (r2.xyz);
    r1.x = (r1.x) + (r1.x);
    r2.xyz = (r4.xyz) * (-(r1.xxx)) + (r11.xyz);
    r2.w = (r1.w) * (c1.y);
