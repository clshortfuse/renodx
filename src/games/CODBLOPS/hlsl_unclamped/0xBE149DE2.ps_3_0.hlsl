// Mechanically reconstructed from 0xBE149DE2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s5, v7.zw);
    r3.z = (r0.w) * (v7.y) + (c3.w);
    r3.xy = float2(((r3.z) >= 0.0f ? (r2.x) : (r3.x)), ((r3.z) >= 0.0f ? (r2.y) : (r3.y)));
    r0.xyz = float3(((r3.z) >= 0.0f ? (r0.x) : (r1.x)), ((r3.z) >= 0.0f ? (r0.y) : (r1.y)), ((r3.z) >= 0.0f ? (r0.z) : (r1.z)));
    ...
    r2.w = (r0.w) * (r0.w);
    r0 = tex2D(s7, v0.xy);
    r10.xyz = float3(((r3.z) >= 0.0f ? (c[36].x) : (r0.y)), ((r3.z) >= 0.0f ? (c[36].y) : (r0.y)), ((r3.z) >= 0.0f ? (c[36].w) : (r0.y)));
    r8.w = (r1.w) * (r2.w);
    r18.xyz = (r1.xyz) * (r10.yyy);
    r1 = tex2D(s12, v0.zw);
    r1.w = ((-abs(r1.y)) >= 0.0f ? (-(c3.y)) : (-(c3.z)));
    r2 = (r0.wwww) * (c1.xxxy) + (c1.zzzx);
    r0 = tex2D(s8, v7.zw);
    r2 = float4(((r3.z) >= 0.0f ? (r0.x) : (r2.x)), ((r3.z) >= 0.0f ? (r0.y) : (r2.y)), ((r3.z) >= 0.0f ? (r0.z) : (r2.z)), ((r3.z) >= 0.0f ? (r0.w) : (r2.w)));
    r0 = v1;
