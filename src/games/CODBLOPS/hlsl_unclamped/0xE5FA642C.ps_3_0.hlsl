// Mechanically reconstructed from 0xE5FA642C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.x = 1.0f / (r7.w);
    r2.xy = c12.xy;
    r2.xyz = (r2.xyx) + (-(c[10].xyw));
    r5.xy = saturate((r8.xx) * (c[9].xy) + (c[9].zw));
    r4.xy = (r5.xy) * (r5.xy);
