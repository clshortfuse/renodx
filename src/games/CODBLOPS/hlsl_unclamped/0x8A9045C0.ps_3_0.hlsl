// Mechanically reconstructed from 0x8A9045C0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.w = (r0.w) * (v6.y);
    r10.xy = lerp(r3.xy, r1.xy, r8.ww);
    r1 = v1;
    r1.xyz = (r10.xxx) * (v4.xyz) + (r1.xyz);
    r2 = (r2.xyzx) * (-(c2.yyyw)) + (-(c2.wwwy));
    r4.xyz = (r10.yyy) * (v3.xyz) + (r1.xyz);
    r1.xyz = normalize(r4.xyz);
    r8.xyz = normalize(v5.xyz);
    r2 = float4(((r5.w) >= 0.0f ? (r2.x) : (c2.w)), ((r5.w) >= 0.0f ? (r2.y) : (c2.w)), ((r5.w) >= 0.0f ? (r2.z) : (c2.w)), ((r5.w) >= 0.0f ? (r2.w) : (c2.w)));
    r3.y = dot(r8.xyz, r1.xyz);
