// Mechanically reconstructed from 0x555DE8EC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xyz = float3(((r11.w) >= 0.0f ? (r2.y) : (c[39].x)), ((r11.w) >= 0.0f ? (r2.y) : (c[39].y)), ((r11.w) >= 0.0f ? (r2.y) : (c[39].w)));
    r5.xyz = (r9.yyy) * (v3.xyz) + (r3.xyz);
    r3 = (r2.wwww) * (c2.xxxy) + (c2.zzzx);
    r10.xyz = normalize(r5.xyz);
    r11.xyz = lerp(r2.xyz, c[40].xyw, r12.www);
