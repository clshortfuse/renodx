// Mechanically reconstructed from 0x5444CE88.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyw = c[24].xyw;
    r4.xyz = (-(r4.xyw)) + (c[25].xyw);
    r0.xyz = (r5.www) * (r0.xyz);
    r5.xyz = (r5.www) * (r4.xyz) + (c[24].xyw);
    r0.xyz = (r3.xyz) * (r1.xyz) + (r0.xyz);
    ...
    r2.z = saturate(dot(r7.xyz, r2.xyz));
    r2.y = (-(r5.y)) + (c1.y);
    r5.y = pow(abs(r2.z), r6.w);
    r2.x = (r2.y) * (r2.y);
    r2.z = (r6.w) * (c3.y) + (c3.z);
    r2.x = (r2.x) * (r2.x);
    r2.z = (r5.y) * (r2.z);
