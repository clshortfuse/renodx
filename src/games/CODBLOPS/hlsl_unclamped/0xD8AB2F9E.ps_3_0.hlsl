// Mechanically reconstructed from 0xD8AB2F9E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r10.w) * (r6.w) + (r7.w);
    r5.w = (r1.w) * (r6.w) + (r7.w);
    r2.w = (r2.w) * (r5.w) + (c3.x);
    r10.xy = (r3.ww) * (c13.xy) + (c13.zw);
    r2.x = 1.0f / (r2.w);
    r9.w = exp2(r10.y);
