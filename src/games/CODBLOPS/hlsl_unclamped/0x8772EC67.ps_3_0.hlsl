// Mechanically reconstructed from 0x8772EC67.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xy = float2(((r5.w) >= 0.0f ? (r6.x) : (c1.y)), ((r5.w) >= 0.0f ? (r6.y) : (c1.y)));
    ...
    r0 = tex2D(s6, v6.zw);
    r11.xyz = float3(((r5.w) >= 0.0f ? (r0.y) : (c[36].x)), ((r5.w) >= 0.0f ? (r0.y) : (c[36].y)), ((r5.w) >= 0.0f ? (r0.y) : (c[36].w)));
