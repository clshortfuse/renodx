// Mechanically reconstructed from 0x3272B410.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.w = (r0.w) * (v0.y) + (c3.w);
    r6.w = (r1.w) * (r1.z);
    r8.xy = float2(((r7.w) >= 0.0f ? (r1.x) : (r2.x)), ((r7.w) >= 0.0f ? (r1.y) : (r2.y)));
    r1 = tex2D(s6, v7.zw);
    r2.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r1 = (c3.xxxx) * (v9) + (c3.yyyy);
    r7.y = dot(r2.xy, r1.zw) + (c3.z);
    r7.x = dot(r2.xy, r1.xy) + (c3.z);
    r1 = tex2D(s0, v1.xy);
    ...
    r1 = tex2D(s9, v7.zw);
    r3 = (r1.wwww) * (c4.xxxy) + (c4.zzzx);
    r0 = lerp(r4, r3, r2.wwww);
    r2.xyz = float3(((r7.w) >= 0.0f ? (r2.y) : (c[8].x)), ((r7.w) >= 0.0f ? (r2.y) : (c[8].y)), ((r7.w) >= 0.0f ? (r2.y) : (c[8].w)));
