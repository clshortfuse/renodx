// Mechanically reconstructed from 0x0C72FA25.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(0.0f, 0.25f, 0.797884583f, 1.0f);
    ...
    r4.x = dot(r2.xy, r1.xy) + (c1.x);
    r4.y = dot(r2.xy, r1.zw) + (c1.x);
    r2 = tex2D(s5, v7.zw);
    r2.w = (r2.w) * (v0.z);
    r0.w = dot(r0, c1.yyyy);
    r1.xy = lerp(r5.xy, r4.xy, r2.ww);
    r0.w = (r0.w) + (c4.y);
    r0.xyz = v4.xyz;
    ...
    r6.xyz = (v0.yyy) * (r1.xyz) + (c4.zzz);
    r9.xyz = (-(v6.xyz)) + (c[5].xyz);
    r3.xyz = (r6.xyz) * (c4.www);
