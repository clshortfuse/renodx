// Mechanically reconstructed from 0x6FD7D90C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c3 = float4(2.0f, -1.0f, 0.0f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r6.z = saturate(dot(r8.xyz, -(r10.xyz)));
    r4 = tex2D(s6, v1.xy);
    r3 = tex2D(s7, v6.zw);
    ...
    r3.z = (r3.z) * (r3.z);
    r1.w = (r1.w) * (r3.z);
    r3.xyz = (r1.xyz) * (-(r1.xyz)) + (c3.www);
    r0.w = (r3.w) * (r0.w);
    r8.xyz = (r1.www) * (r3.xyz);
    r3 = tex2D(s0, v1.xy);
    r7.xyz = lerp(r3.xyz, r2.xyz, r2.www);
    r1.xyz = (r1.xyz) * (r1.xyz) + (r8.xyz);
    r2.xyz = lerp(r7.xyz, r0.xyz, r5.www);
