// Mechanically reconstructed from 0xD8B0F646.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (r1.w) * (r1.w);
    r5.xyz = (v0.zzz) * (r0.xyz) + (c24.www);
    r0.w = (r0.w) * (r0.w);
    r1.xyz = (r5.xyz) * (c3.xxx);
    r1.w = (r1.w) * (r0.w);
    r11.xyz = (r1.xyz) * (-(r1.xyz)) + (c24.www);
    r0 = tex2D(s5, v7.xy);
    r3.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c24.xxxx) * (v8) + (c24.yyyy);
    r2.y = dot(r3.xy, r0.zw) + (c24.z);
    r12.xyz = (r1.xyz) * (r1.xyz);
    r2.x = dot(r3.xy, r0.xy) + (c24.z);
    ...
    r0 = tex2D(s3, v7.xy);
    r3.w = (r0.w) * (v0.y);
    r7.xy = lerp(r6.xy, r2.xy, r3.ww);
    r2.xyz = lerp(r1.xyz, r0.xyz, r3.www);
    r0.w = dot(r7.xy, r7.xy) + (c24.z);
    ...
    r1 = tex2D(s14, v1.zw);
    r8.xy = (r1.xy) * (c12.xx);
    r9.xy = (r2.yw) * (c12.yy) + (c12.zz);
    r2.xy = (r2.xz) * (r8.xx);
    r0.w = dot(r9.xy, r7.xy) + (c24.z);
    r0.y = (r1.x) * (c12.x) + (-(r2.x));
    r1.w = (r2.z) * (-(r8.x)) + (r0.y);
    r6.xy = (r0.xz) * (r8.yy);
    r0.y = (r1.y) * (c12.x) + (-(r6.x));
    r0.x = dot(r9.xy, r9.xy) + (c24.z);
    r0.y = (r0.z) * (-(r8.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r10.y = (r1.w) + (r1.w);
    r0.z = (r0.z) * (c3.y) + (c3.z);
    ...
    r13.xyz = (r2.xyz) * (r15.yyy);
    r14.xyz = (r15.xxx) * (r0.xyz);
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c24.w) : (c24.z));
