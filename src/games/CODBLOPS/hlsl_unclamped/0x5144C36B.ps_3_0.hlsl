// Mechanically reconstructed from 0x5144C36B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (r0.w) * (r0.z);
    r7.xyz = (r5.xyz) * (-(r5.xyz)) + (c0.yyy);
    r2.xyz = (r1.xyz) * (r1.xyz);
    r1.xyz = (r0.www) * (r7.xyz);
    r2.xyz = (r0.yyy) * (r2.xyz);
    r5.xyz = (r5.xyz) * (r5.xyz) + (r1.xyz);
    r1.xyz = (r6.xyz) * (r3.www) + (r4.xyz);
