// Mechanically reconstructed from 0xAC363E03.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c25 = float4(2.0f, -1.0f, 0.0f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r2.y = dot(r1.xy, r0.zw) + (c25.z);
    r2.x = dot(r1.xy, r0.xy) + (c25.z);
    r0 = tex2D(s1, v1.xy);
    ...
    r2 = tex2D(s4, v7.zw);
    r0.xyz = (r2.xyz) + (c25.yyy);
    r2.w = lerp(r1.w, r0.w, r4.w);
    r2.xyz = (v0.zzz) * (r0.xyz) + (c25.www);
    r0 = tex2D(s5, v8.xy);
    ...
    r0.w = r3.y;
    r7.xy = (r3.xz) * (r8.xx);
    r9.xy = (r0.wy) * (c4.yy) + (c4.zz);
    r0.y = (r1.x) * (c4.x) + (-(r7.x));
    r0.w = dot(r9.xy, r5.xy) + (c25.z);
    r1.w = (r3.z) * (-(r8.x)) + (r0.y);
    r3.xy = (r0.xz) * (r8.yy);
    r0.x = dot(r9.xy, r9.xy) + (c25.z);
    r0.y = (r1.y) * (c4.x) + (-(r3.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r0.z) * (-(r8.y)) + (r0.y);
    r0.z = (r0.x) * (c3.y) + (c3.z);
    ...
    r1.xyz = (r10.xyz) * (r7.www) + (r3.xyz);
    r11.xyz = (r0.xyz) * (-(r0.xyz)) + (c25.www);
    ...
    r1.w = (r0.x) * (r0.y);
    r2.z = (r2.w) * (r0.z);
    r0.xyz = (r11.xyz) * (r5.zzz) + (r12.xyz);
    r1.w = (r1.w) * (r2.z);
    r13.xyz = lerp(r5.www, c[23].xyw, r4.www);
    r0.xyz = (r0.xyz) * (r1.www);
    r14.xyz = (r1.xyz) * (r13.yyy);
    r15.xyz = (r13.zzz) * (r0.xyz);
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c25.w) : (c25.z));
