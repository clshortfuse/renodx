// Mechanically reconstructed from 0x8296C9E9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = saturate(dot(r0.xyz, r5.xyz));
    ...
    r11.w = max(abs(r0.y), abs(r0.z));
    r5.xyz = (r2.xyz) * (c[30].www);
    r2.w = max(abs(r0.x), r11.w);
    r2.w = 1.0f / (r2.w);
    ...
    r11.w = dot(r10.xyz, r0.xyz);
    r2.xyz = (r2.xyz) * (c1.yyy);
    r11.w = (r11.w) + (r11.w);
    r2.xyz = (r2.www) * (r1.xyz) + (r2.xyz);
    r1.xyz = (r0.xyz) * (-(r11.www)) + (r10.xyz);
