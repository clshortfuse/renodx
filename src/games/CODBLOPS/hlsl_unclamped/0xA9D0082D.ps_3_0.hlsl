// Mechanically reconstructed from 0xA9D0082D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = dot(r9.xy, r9.xy) + (c0.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c2.x) + (c2.y);
    r5.w = (r0.y) * (c2.x) + (c2.y);
    r0.y = (r0.w) * (r5.w);
    r0.w = dot(r1.xy, r9.xy) + (c0.z);
    r1 = tex2D(s14, v1.zw);
    r7.xy = (r1.xy) * (c3.ww);
    ...
    r7.y = (r0.w) + (r0.w);
    r0 = tex2D(s6, v7.zw);
    r2.yzw = (r0.wyy) + (c0.xzx);
    r0.xyz = (r7.xyz) * (r5.www) + (r1.xyz);
    r12.xy = (r4.ww) * (r2.yw) + (c0.yy);
    r6.xyz = (r3.www) * (r3.xyz);
    r11.xyz = (r0.xyz) * (r12.yyy);
    r1 = tex2D(s12, v1.zw);
    r0 = v2;
    ...
    r1.z = (r1.w) * (r1.z);
    r3.w = (r11.x) * (r11.x);
    r2.w = (r11.x) * (-(r11.x)) + (c0.y);
    r8.w = (r12.x) * (c2.w);
    r7.w = (r12.x) * (-(c4.z)) + (c4.w);
