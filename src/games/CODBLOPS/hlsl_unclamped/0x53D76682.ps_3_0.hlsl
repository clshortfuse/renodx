// Mechanically reconstructed from 0x53D76682.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.y = dot(r6.xy, r0.zw) + (c3.z);
    r1.x = dot(r6.xy, r0.xy) + (c3.z);
    r0 = tex2D(s6, v7.zw);
    r5.w = (r0.w) * (v0.z);
    r0.w = lerp(r3.y, r2.y, r6.w);
    r10.xy = lerp(r5.xy, r1.xy, r5.ww);
    r1.w = lerp(r3.w, r2.w, r6.w);
