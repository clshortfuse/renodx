// Mechanically reconstructed from 0xFA29E81D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c4 = float4(2.0f, -1.0f, 0.0f, -0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r1.x = dot(r3.xy, r1.xy) + (c4.z);
    r1.y = dot(r3.xy, r1.zw) + (c4.z);
    r6 = tex2D(s2, v6.zw);
    r6.w = (r6.w) * (v6.y);
    r3.xy = (r0.yw) * (c3.xx) + (c3.yy);
    r4.xy = lerp(r5.xy, r1.xy, r6.ww);
    ...
    r8.xy = lerp(c[20].xy, r1.yy, r6.ww);
    r1.z = (r1.z) + (r1.z);
    r3 = (r1.wwww) * (-(c4.zzzy)) + (-(c4.wwwz));
    r2.xyz = (r10.xyz) * (-(r1.zzz)) + (r0.xyz);
    r4 = tex2D(s4, v0.xy);
