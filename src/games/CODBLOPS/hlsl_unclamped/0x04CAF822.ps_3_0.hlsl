// Mechanically reconstructed from 0x04CAF822.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = dot(c[40].yz, r12.xy) + (c[40].x);
    r1.xy = saturate((r12.xx) * (c[41].xy) + (c[41].zw));
    r0.xy = (r1.xy) * (r1.xy);
