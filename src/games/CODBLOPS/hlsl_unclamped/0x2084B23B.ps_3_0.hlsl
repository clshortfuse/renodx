// Mechanically reconstructed from 0x2084B23B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = c0.z;
    r6.xyz = float3(((r4.w) >= 0.0f ? (c[37].x) : (r1.w)), ((r4.w) >= 0.0f ? (c[37].y) : (r1.w)), ((r4.w) >= 0.0f ? (c[37].w) : (r1.w)));
