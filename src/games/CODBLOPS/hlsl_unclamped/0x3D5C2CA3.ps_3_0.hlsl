// Mechanically reconstructed from 0x3D5C2CA3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = lerp(r1.xyz, r0.xyz, r1.www);
    r5.xy = (r1.ww) * (-(r2.xy)) + (r2.xy);
    r7.w = c12.x;
    r1.xyz = (r7.www) + (-(c[20].xyw));
    r0 = tex2D(s4, v8.zw);
    r4.w = (r0.w) * (v0.z);
    r1.xyz = (r1.www) * (r1.xyz) + (c[20].xyw);
    r2.xyz = lerp(r4.xyz, r0.xyz, r4.www);
    r12.xyz = lerp(r1.xyz, c12.xxx, r4.www);
    r0.xy = (v1.zw) * (c1.zw);
    r1 = tex2D(s13, r0.xy);
    ...
    r8.xz = (r4.xy) * (c4.xx);
    r8.w = saturate(dot(r9.xyz, -(r13.xyz)));
    r1 = tex2D(s5, v1.xy);
