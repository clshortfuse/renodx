// Mechanically reconstructed from 0xFDB05487.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyz = (r7.www) * (r0.xyz) + (c[36].xyw);
    r7.xyz = lerp(r0.xyz, c1.xxx, r8.www);
    r12.xyz = (-(v7.xyz)) + (c[20].xyz);
    r1.w = dot(r12.xyz, r12.xyz);
    r0 = v2;
    r0.xyz = (r6.xxx) * (v5.xyz) + (r0.xyz);
    r1.w = rsqrt(r1.w);
    r0.xyz = (r6.yyy) * (v4.xyz) + (r0.xyz);
    r10.xyz = (r12.xyz) * (r1.www);
    ...
    r1.w = exp2(r12.y);
    r0.x = saturate(dot(r0.xyz, r10.xyz));
