// Mechanically reconstructed from 0x7EEED3C4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s5, v7.xy);
    r5.w = (r0.w) * (v0.y) + (c4.w);
    r9.xy = float2(((r5.w) >= 0.0f ? (r2.x) : (r3.x)), ((r5.w) >= 0.0f ? (r2.y) : (r3.y)));
    ...
    r4.xy = (r4.xz) * (r6.xx);
    r1.w = dot(r7.xy, r9.xy) + (c4.z);
    r2.w = (r3.x) * (c12.w) + (-(r4.x));
    r2.y = (r4.z) * (-(r6.x)) + (r2.w);
    r5.xy = (r2.xz) * (r6.yy);
    r2.x = (r3.y) * (c12.w) + (-(r5.x));
    r2.w = dot(r7.xy, r7.xy) + (c4.z);
    r2.z = (r2.z) * (-(r6.y)) + (r2.x);
    r2.w = exp2(-(r2.w));
    r6.y = (r2.y) + (r2.y);
    ...
    r14.xyz = float3(((r5.w) >= 0.0f ? (c[32].x) : (r1.y)), ((r5.w) >= 0.0f ? (c[32].y) : (r1.y)), ((r5.w) >= 0.0f ? (c[32].w) : (r1.y)));
    r1 = tex2D(s6, v7.zw);
    ...
    r1.xyz = (v0.zzz) * (r1.xyz) + (-(c4.yyy));
    r8.xyz = (r4.xyz) * (r1.www) + (-(r7.xyz));
    r2.xyz = normalize(r8.xyz);
    r8.xyz = (r4.xyz) * (r1.www);
    r4.xyz = (r0.xyz) * (r1.xyz);
    r0.z = saturate(dot(r2.xyz, r8.xyz));
    r13.xyz = (r5.xyz) * (r14.yyy);
    r1.w = (-(r0.z)) + (-(c4.y));
    r15.xyz = (r4.xyz) * (-(r4.xyz)) + (-(c4.yyy));
    r0.z = (r1.w) * (r1.w);
    r3.w = (r0.z) * (r0.z);
    r0.xyz = v2.xyz;
