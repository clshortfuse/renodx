// Mechanically reconstructed from 0x8E965575.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.yz = c1.yz;
    r0.xyz = float3(((r4.w) >= 0.0f ? (r12.y) : (c[28].x)), ((r4.w) >= 0.0f ? (r12.z) : (c[28].y)), ((r4.w) >= 0.0f ? (r12.y) : (c[28].w)));
    r9.xyz = normalize(r4.xyz);
    r4.xyz = lerp(r0.xyz, c1.zzz, r5.www);
