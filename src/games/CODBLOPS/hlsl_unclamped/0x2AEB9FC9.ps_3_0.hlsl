// Mechanically reconstructed from 0x2AEB9FC9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xyz = float3(((r4.w) >= 0.0f ? (c[38].x) : (r0.w)), ((r4.w) >= 0.0f ? (c[38].y) : (r0.w)), ((r4.w) >= 0.0f ? (c[38].w) : (r0.w)));
