// Mechanically reconstructed from 0xD85D6DBD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c10 = float4(0.959999979f, 0.0399999991f, 31.875f, 4.0f);
    ...
    r2.w = r0.y;
    r4.w = rsqrt(r1.w);
    r6.xy = (r2.yw) * (c11.xx) + (c11.yy);
    r1 = tex2D(s14, v1.zw);
    r8.xy = (r1.xy) * (c10.zz);
    r0.w = dot(r6.xy, r3.xy) + (c3.z);
    r4.xy = (r2.xz) * (r8.xx);
    r0.y = (r1.x) * (c10.z) + (-(r4.x));
    r5.xy = (r0.xz) * (r8.yy);
    r0.x = (r2.z) * (-(r8.x)) + (r0.y);
    r0.y = (r1.y) * (c10.z) + (-(r5.x));
    r0.y = (r0.z) * (-(r8.y)) + (r0.y);
