// Mechanically reconstructed from 0x81872268.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s4, v0.xy);
    r1.zw = (r2.ww) * (c2.xy) + (c2.zx);
    r0.z = ((r3.w) >= 0.0f ? (r2.y) : (c1.w));
    r2 = float4(((r3.w) >= 0.0f ? (r1.x) : (-(c1.w))), ((r3.w) >= 0.0f ? (r1.y) : (-(c1.w))), ((r3.w) >= 0.0f ? (r1.z) : (-(c1.w))), ((r3.w) >= 0.0f ? (r1.w) : (-(c1.y))));
    r1 = tex2D(s3, v6.zw);
    r0.xy = (r1.wy) * (c0.xy) + (c0.zw);
    r1 = (c1.xxxx) * (v7) + (c1.yyyy);
    r1.x = dot(r0.xy, r1.xy) + (c1.w);
    r1.y = dot(r0.xy, r1.zw) + (c1.w);
    r3 = tex2D(s5, v6.zw);
    r1.zw = (r3.ww) * (c2.xy) + (c2.zx);
    r8.w = ((r4.w) >= 0.0f ? (r3.y) : (r0.z));
    r4 = float4(((r4.w) >= 0.0f ? (r1.x) : (r2.x)), ((r4.w) >= 0.0f ? (r1.y) : (r2.y)), ((r4.w) >= 0.0f ? (r1.z) : (r2.z)), ((r4.w) >= 0.0f ? (r1.w) : (r2.w)));
    r2.x = (r4.w) * (c3.z);
    r2.y = (r4.w) * (-(c4.z)) + (c4.w);
    r1 = v1;
    r0.xyz = (r4.xxx) * (v4.xyz) + (r1.xyz);
    ...
    r2.z = (r2.w) * (c3.x) + (c3.y);
    r2.x = dot(r9.xy, r9.xy) + (c1.w);
    r2.w = dot(r9.xy, r4.xy) + (c1.w);
    r2.x = exp2(-(r2.x));
    r3.w = (r4.w) * (c2.w);
    r2.x = (r2.x) * (c3.x) + (c3.y);
    r4 = tex2D(s14, v0.zw);
