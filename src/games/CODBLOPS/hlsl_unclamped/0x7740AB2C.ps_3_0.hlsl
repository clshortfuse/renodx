// Mechanically reconstructed from 0x7740AB2C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = r4.y;
    r1.w = (r1.w) * (v5.y) + (c0.x);
    r0.xy = (r2.yw) * (c2.xx) + (c2.yy);
    r5.w = c0.y;
    r7.xyz = float3(((r1.w) >= 0.0f ? (r5.w) : (c[28].x)), ((r1.w) >= 0.0f ? (r5.w) : (c[28].y)), ((r1.w) >= 0.0f ? (r5.w) : (c[28].w)));
