// Mechanically reconstructed from 0x8800ABE7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = (r2.xz) * (r5.xx);
    r0.w = dot(r6.xy, r4.xy) + (c22.z);
    r0.y = (r1.x) * (c4.w) + (-(r2.x));
    r1.w = (r2.z) * (-(r5.x)) + (r0.y);
    r3.xy = (r0.xz) * (r5.yy);
    r0.y = (r1.y) * (c4.w) + (-(r3.x));
    r0.x = dot(r6.xy, r6.xy) + (c22.z);
    r0.y = (r0.z) * (-(r5.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r8.y = (r1.w) + (r1.w);
    r0.z = (r0.z) * (c1.x) + (c1.y);
    ...
    r13.xy = (r1.ww) * (c14.xy) + (c14.zw);
    r4.w = exp2(r13.y);
    r4.z = saturate(dot(r9.xyz, r0.xyz));
    r0.y = pow(abs(r4.z), r4.w);
    ...
    r8.w = (r12.x) * (r0.z);
    r2 = tex2D(s12, v0.zw);
    r0.z = ((-abs(r2.y)) >= 0.0f ? (c22.w) : (c22.z));
