// Mechanically reconstructed from 0x2B1C889D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s9, v7.xy);
    r0 = tex2D(s5, v7.zw);
    r4.xyz = (r0.xyz) + (c31.yyy);
    r0 = lerp(r2, r1, r4.wwww);
    r4.xyz = (v0.zzz) * (r4.xyz) + (c31.www);
    r9.w = (r0.w) * (-(c12.z)) + (c12.w);
    r2.xyz = (r0.xyz) * (r4.xyz);
    r1 = tex2D(s6, v8.xy);
    r0.xyz = (r1.xyz) + (c31.yyy);
    r1.xyz = (v0.www) * (r0.xyz) + (c31.www);
    r0.xyz = (r3.xyz) * (r4.xyz);
    r4.xyz = (r2.xyz) * (r1.xyz);
    r0.xyz = (r1.xyz) * (r0.xyz);
    r10.xyz = (r0.xyz) * (r0.xyz);
    r0.z = dot(r5.xy, r5.xy) + (c31.z);
    r14.xyz = (r4.xyz) * (-(r4.xyz)) + (c31.www);
    r0.z = exp2(-(r0.z));
    r5.w = (r0.z) * (c3.x) + (c3.y);
    ...
    r1.w = r3.y;
    r7.xy = (r3.xz) * (r6.xx);
    r3.xy = (r1.wy) * (c12.xx) + (c12.yy);
    r0.y = (r2.x) * (c4.w) + (-(r7.x));
    r0.z = dot(r3.xy, r5.xy) + (c31.z);
    r1.y = (r3.z) * (-(r6.x)) + (r0.y);
    r0.xy = (r1.xz) * (r6.yy);
    r1.w = dot(r3.xy, r3.xy) + (c31.z);
    r1.x = (r2.y) * (c4.w) + (-(r0.x));
    r1.w = exp2(-(r1.w));
    r1.z = (r1.z) * (-(r6.y)) + (r1.x);
    r1.w = (r1.w) * (c3.x) + (c3.y);
    ...
    r2.z = (r3.z) * (r0.y);
    r2.w = (r0.z) * (r5.w);
    r0.xyz = (r14.xyz) * (r5.zzz) + (r15.xyz);
    r3.y = (r2.z) * (r2.w);
    r2.xyw = c[27].xyw;
    r2.xyz = (-(r2.xyw)) + (c[28].xyw);
    r0.xyz = (r0.xyz) * (r3.yyy);
    r13.xyz = (r4.www) * (r2.xyz) + (c[27].xyw);
    r0.xyz = (r0.xyz) * (c[7].xyz);
    r12.xyz = (r1.xyz) * (r13.yyy);
    r1.xyz = (r13.zzz) * (r0.xyz);
    r0.xyz = (r3.zzz) * (c[6].xyz);
    r1.w = (-(r1.w)) + (c31.w);
    ...
    r0.xy = (r0.xy) * (r0.xy);
    r0.w = ((-abs(r0.w)) >= 0.0f ? (c31.z) : (r0.z));
    r0.z = (r3.x) * (r0.x);
    r0.w = (r0.w) * (r0.z);
    r0.z = (r0.y) * (-(r3.y)) + (c31.w);
    r0.xy = (r1.zz) * (r1.xy);
    r0.w = (r0.w) * (r0.z);
    r1.w = (r1.w) * (r0.w);
