// Mechanically reconstructed from 0x1C81CDB6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = rsqrt(r0.w);
    r14.xyz = (r1.zzz) * (v6.xyz);
    r2.xyz = (r1.xxx) * (r0.xyz);
    r6.xyz = (r5.xyz) * (r0.www) + (-(r14.xyz));
    r4.xyz = normalize(r6.xyz);
    r9.xyz = (r5.xyz) * (r0.www);
    r5.xyz = lerp(r0.xyz, c1.xxx, r1.xxx);
    r0.w = saturate(dot(r4.xyz, r9.xyz));
    r5.xyz = (r3.xyz) * (r5.xyz);
    r1.x = (-(r0.w)) + (c1.z);
    r11.xyz = (r5.xyz) * (-(r5.xyz)) + (c1.zzz);
    r0.w = (r1.x) * (r1.x);
    r2.w = (r0.w) * (r0.w);
    r0 = v1;
    ...
    r1.x = saturate(dot(r13.xyz, r4.xyz));
    r11.w = (r1.w) * (c3.w);
