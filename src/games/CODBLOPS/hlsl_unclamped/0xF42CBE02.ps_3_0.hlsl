// Mechanically reconstructed from 0xF42CBE02.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xyz = (r6.xyz) * (r6.www) + (-(r8.xyz));
    r2.xyz = (r4.xyz) * (r2.xyz);
    r6.w = exp2(r10.y);
    r6.xyz = (r2.xyz) * (c2.zzz);
    r2 = tex2D(s0, v0.xy);
    r4.y = (r9.x) * (c2.w);
    r2.w = (r9.x) * (-(c13.x)) + (c13.y);
