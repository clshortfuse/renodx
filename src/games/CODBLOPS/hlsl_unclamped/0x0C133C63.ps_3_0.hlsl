// Mechanically reconstructed from 0x0C133C63.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.y = (r0.w) + (r0.w);
    r0 = tex2D(s7, v6.xy);
    r1.xy = lerp(c[23].xy, r0.yy, r4.ww);
    r0 = (r0.wwww) * (-(c12.zzzy)) + (-(c12.wwwz));
    r10.xy = lerp(r1.xy, c[24].xy, r7.ww);
    r1 = tex2D(s6, v1.xy);
