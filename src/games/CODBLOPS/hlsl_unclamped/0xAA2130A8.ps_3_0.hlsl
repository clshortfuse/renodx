// Mechanically reconstructed from 0xAA2130A8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = dot(r1.xy, r0.xy) + (c8.z);
    r0.y = dot(r1.xy, r0.zw) + (c8.z);
    r1 = tex2D(s2, v6.zw);
    r10.w = (r1.w) * (v6.y);
    r1.w = (-(r2.w)) + (c8.w);
    ...
    r2.w = dot(r9.xy, r9.xy) + (c8.z);
    r2.z = dot(r4.xy, r4.xy) + (c8.z);
    r2.w = exp2(-(r2.w));
    r2.z = exp2(-(r2.z));
    r2.w = (r2.w) * (c1.x) + (c1.y);
    r2.x = (r2.z) * (c1.x) + (c1.y);
    r2.z = dot(r4.xy, r9.xy) + (c8.z);
    r2.x = (r2.w) * (r2.x);
    r4 = tex2D(s14, v0.zw);
    r10.xy = (r4.xy) * (c3.ww);
