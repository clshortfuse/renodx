// Mechanically reconstructed from 0xAB9B5D4F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.x = 1.0f / (r9.w);
    r3.yz = c1.yz;
    r3.xyz = float3(((r7.w) >= 0.0f ? (r3.y) : (c[10].x)), ((r7.w) >= 0.0f ? (r3.z) : (c[10].y)), ((r7.w) >= 0.0f ? (r3.y) : (c[10].w)));
    r7.xy = saturate((r9.xx) * (c[9].xy) + (c[9].zw));
    r4.xy = (r7.xy) * (r7.xy);
    r7.xy = (r7.xy) * (c13.xx) + (c13.yy);
    r0.w = dot(c[8].yz, r9.xy) + (c[8].x);
    r4.xy = (r4.xy) * (r7.xy);
    r9.xyz = lerp(r3.xyz, c[11].xyw, r6.www);
    r0.w = (r0.w) * (r4.x);
