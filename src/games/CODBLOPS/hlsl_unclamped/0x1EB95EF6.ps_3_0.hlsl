// Mechanically reconstructed from 0x1EB95EF6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = dot(c[33].yz, r4.xy) + (c[33].x);
    r1.xy = (r1.xy) * (r3.xy);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r1.z = (r1.z) * (r1.x);
    r0.xyz = (r0.xyz) * (c[36].yyy);
    r1.z = (r1.y) * (r1.z);
