// Mechanically reconstructed from 0x8FBAAC40.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (r1.y) * (r1.y);
    r3.xyz = (v0.zzz) * (r0.xyz) + (c1.xxx);
    r4.z = (r1.z) * (r0.w);
    r1.xyz = (r3.xyz) * (c1.zzz);
    r9.xyz = (r1.xyz) * (-(r1.xyz)) + (c1.xxx);
    r0 = v2;
