// Mechanically reconstructed from 0xE1A12C36.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c15 = float4(2.22222233f, 3.125f, 3.4482758f, 4.54519987f);
    const float4 c16 = float4(5.88230991f, 0.0f, 0.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r2 = tex2D(s8, r2.xy);
    r5 = tex2D(s6, v4.xy);
    r2.xzw = (r5.xyz) * (c3.zzz) + (-(r4.xyz));
    r2.xyz = (r2.yyy) * (r2.xzw) + (r4.xyz);
    r1.xyz = (r1.xyz) * (r2.xyz);
    r2.xyz = max(r1.xyz, c1.xxx);
    r1.xyz = (r2.xyz) * (c0.zzz);
    r0.x = (-(r0.x)) + (c1.z);
    r4.xyz = saturate((r0.xxx) * (c15.xyz));
    r0.x = pow(abs(r4.x), c0.w);
    r3.xyz = (r2.xyz) * (-(c0.zzz)) + (r3.xyz);
    r1.xyz = (r0.xxx) * (r3.xyz) + (r1.xyz);
    r3 = tex2D(s10, v4.xy);
    r0.x = saturate((r3.x) * (c3.y));
    r1.w = c[37].w;
    r3.xy = (r1.ww) * (c[47].xy);
    r3.xy = (r3.xy) * (c[46].xx);
    ...
    r0.x = pow(abs(r4.y), c15.w);
    r4.xyw = lerp(r3.xyz, r1.xyz, r0.xxx);
    r0.x = pow(abs(r4.z), c16.x);
