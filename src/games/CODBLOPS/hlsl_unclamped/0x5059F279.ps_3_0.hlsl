// Mechanically reconstructed from 0x5059F279.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.zw = c[8].xy;
    r2 = float4(((r8.w) >= 0.0f ? (r1.x) : (c2.w)), ((r8.w) >= 0.0f ? (r1.y) : (c2.w)), ((r8.w) >= 0.0f ? (r1.z) : (c2.w)), ((r8.w) >= 0.0f ? (r1.w) : (c2.w)));
    r1.zw = c[9].xy;
    r5 = tex2D(s4, v6.xy);
    ...
    r6.w = (r0.w) * (v0.z) + (c2.z);
    r5 = float4(((r7.w) >= 0.0f ? (r1.x) : (r2.x)), ((r7.w) >= 0.0f ? (r1.y) : (r2.y)), ((r7.w) >= 0.0f ? (r1.z) : (r2.z)), ((r7.w) >= 0.0f ? (r1.w) : (r2.w)));
    r1 = tex2D(s5, v6.zw);
    r2.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r1 = (c2.xxxx) * (v8) + (c2.yyyy);
    r1.x = dot(r2.xy, r1.xy) + (c2.w);
    r1.y = dot(r2.xy, r1.zw) + (c2.w);
    r2 = tex2D(s8, v6.zw);
    r1.zw = r2.yy;
    r3 = (r3.xyzx) * (-(c2.yyyw)) + (-(c2.wwwy));
    r1 = float4(((r6.w) >= 0.0f ? (r1.x) : (r5.x)), ((r6.w) >= 0.0f ? (r1.y) : (r5.y)), ((r6.w) >= 0.0f ? (r1.z) : (r5.z)), ((r6.w) >= 0.0f ? (r1.w) : (r5.w)));
    r3 = float4(((r7.w) >= 0.0f ? (r3.x) : (r4.x)), ((r7.w) >= 0.0f ? (r3.y) : (r4.y)), ((r7.w) >= 0.0f ? (r3.z) : (r4.z)), ((r7.w) >= 0.0f ? (r3.w) : (r4.w)));
    r2.xyz = v2.xyz;
    ...
    r3.xyz = (r8.xyz) * (-(r0.zzz)) + (r7.xyz);
    r4 = tex2D(s6, v1.xy);
    r5 = float4(((r8.w) >= 0.0f ? (r4.x) : (-(c2.w))), ((r8.w) >= 0.0f ? (r4.y) : (-(c2.w))), ((r8.w) >= 0.0f ? (r4.z) : (-(c2.w))), ((r8.w) >= 0.0f ? (r4.w) : (-(c2.y))));
    r4 = tex2D(s7, v6.xy);
    r4 = float4(((r7.w) >= 0.0f ? (r4.x) : (r5.x)), ((r7.w) >= 0.0f ? (r4.y) : (r5.y)), ((r7.w) >= 0.0f ? (r4.z) : (r5.z)), ((r7.w) >= 0.0f ? (r4.w) : (r5.w)));
    r5.z = saturate(dot(r8.xyz, -(r7.xyz)));
