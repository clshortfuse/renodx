// Mechanically reconstructed from 0x7647E3F9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyz = (r0.xyz) * (r0.www) + (-(r4.xyz));
    r1.xyz = normalize(r3.xyz);
    r9.xyz = (r0.xyz) * (r0.www);
    r0.z = saturate(dot(r2.xyz, c[17].xyz));
    ...
    r0.y = 1.0f / (r0.z);
    r3.w = exp2(r1.y);
    r0.z = pow(abs(r5.z), r3.w);
    r7.w = (r3.w) * (c4.y) + (c4.z);
    r1.y = (r5.w) * (r0.y);
    r1.z = (r0.z) * (r7.w);
    r0.xyz = (r12.xyz) * (r4.www) + (r13.xyz);
    r1.z = (r1.y) * (r1.z);
