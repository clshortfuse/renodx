// Mechanically reconstructed from 0xD1D7566F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.z = (r0.y) * (r0.z);
    r5.w = saturate((r0.w) * (c[24].x) + (c[24].y));
    r0 = tex2D(s1, v1.xy);
    r4.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r0 = tex2D(s7, v1.xy);
    r3.xy = (v1.xy) + (c1.xx);
    r2.w = c1.y;
    r1.xy = (r3.xy) * (c[35].xx) + (r2.ww);
    r1 = tex2D(s5, r1.xy);
    r4.w = (v7.w) * (c1.z) + (-(r1.x));
    r0.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r3.w = saturate((r4.w) * (c1.w));
    r0.w = (r5.w) * (r5.w);
    r1.xy = lerp(r4.xy, r0.xy, r3.ww);
    ...
    r7.xyz = (r2.xyz) * (c2.www);
    r2.w = (-(r6.w)) + (c2.x);
    r2.z = (r2.w) * (r2.w);
    r11.xy = (r1.ww) * (c4.xy) + (c4.zw);
    r2.w = (r2.w) * (r2.z);
    r2.z = 1.0f / (r11.x);
    r9.xyz = (r9.xyz) * (r7.www) + (-(r10.xyz));
    r3.w = (r2.w) * (r2.z);
