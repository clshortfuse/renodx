// Mechanically reconstructed from 0xC9717B30.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r16.yz = c1.yz;
    r7.xyz = float3(((r2.w) >= 0.0f ? (r16.y) : (c[20].x)), ((r2.w) >= 0.0f ? (r16.z) : (c[20].y)), ((r2.w) >= 0.0f ? (r16.y) : (c[20].w)));
