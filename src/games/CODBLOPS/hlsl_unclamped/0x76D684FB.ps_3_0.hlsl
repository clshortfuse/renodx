// Mechanically reconstructed from 0x76D684FB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c8 = float4(-1.0f, 1.0f, 0.200000003f, 0.0f);
    ...
    r0.w = dot(r4.xy, r4.xy) + (c8.w);
    r0.y = dot(r1.xy, r1.xy) + (c8.w);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c1.x) + (c1.y);
    r1.w = (r0.y) * (c1.x) + (c1.y);
    r0.y = dot(r1.xy, r4.xy) + (c8.w);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v0.zw);
    r6.xy = (r1.xy) * (c3.ww);
    ...
    r2 = tex2D(s3, v7.zw);
    r0.xyz = (r2.xyz) + (c8.xxx);
    r0.xyz = (v7.yyy) * (r0.xyz) + (c8.yyy);
    r2.xyz = (r0.xyz) * (c8.zzz);
    r6.xyz = (r2.xyz) * (-(r2.xyz)) + (c8.yyy);
