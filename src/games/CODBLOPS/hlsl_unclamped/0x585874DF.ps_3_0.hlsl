// Mechanically reconstructed from 0x585874DF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = (r1.z) + (r1.z);
    r2.xyz = (r7.xyz) * (-(r1.zzz)) + (r0.xyz);
    r2.w = (r1.w) * (c2.z);
    r2 = texCUBElod(s15, r2);
    r2.xyz = (r2.xyz) * (r2.xyz);
    r4.xyz = (r1.yyy) * (r2.xyz);
    r4.w = saturate(dot(r7.xyz, -(r0.xyz)));
    r10.xyz = (r6.xyz) * (r3.www) + (-(r0.xyz));
    r0.z = (-(r4.w)) + (c1.z);
    r1.z = (r0.z) * (r0.z);
    ...
    r11.xyz = (v0.zzz) * (r6.xyz) + (c1.zzz);
    r6.xyz = (v0.yyy) * (r0.xyz) + (c1.zzz);
    r2 = tex2D(s0, v1.xy);
    r12.xyz = lerp(r2.xyz, c1.xxx, r1.xxx);
    r0.xyz = (r1.xxx) * (r2.xyz);
    r2.xyz = (r6.xyz) * (r12.xyz);
    r0.xyz = (r6.xyz) * (r0.xyz);
    r2.xyz = (r11.xyz) * (r2.xyz);
    r6.xyz = (r2.xyz) * (r2.xyz);
    r2.xyz = (r2.xyz) * (-(r2.xyz)) + (c1.zzz);
    r0.xyz = (r11.xyz) * (r0.xyz);
    r11.xyz = (r2.xyz) * (r3.www) + (r6.xyz);
