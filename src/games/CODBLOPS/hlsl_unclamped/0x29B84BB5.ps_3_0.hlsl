// Mechanically reconstructed from 0x29B84BB5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.z = 1.0f / (r2.z);
    r10.xyz = (r10.xyz) * (r2.yyy) + (-(r11.xyz));
    r3.w = (r2.w) * (r2.z);
