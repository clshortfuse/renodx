// Mechanically reconstructed from 0x157F70B6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(0.959999979f, 0.0399999991f, 0.797884583f, 1.0f);
    ...
    r6.w = saturate(dot(r3.xyz, -(r5.xyz)));
    r2 = tex2D(s5, v0.xy);
    r1 = tex2D(s6, v5.zw);
    r1.xyz = (-(v4.xyz)) + (c[5].xyz);
    r2.z = dot(r1.xyz, r1.xyz);
    r5.w = lerp(r2.w, r1.w, r4.w);
    r3.w = rsqrt(r2.z);
    r6.z = (r5.w) * (c1.z);
    ...
    r5.w = (r5.w) * (c2.y) + (c2.z);
    r1.w = (r1.w) * (r6.w) + (c2.x);
    r5.xyz = (r1.xyz) * (r3.www) + (-(r5.xyz));
    r1.w = 1.0f / (r1.w);
    r3.w = (r2.w) * (r1.w);
    r1.xyz = normalize(r5.xyz);
    r3.z = saturate(dot(r3.xyz, r1.xyz));
    r1.w = saturate(dot(r1.xyz, r2.xyz));
    r2.z = exp2(r5.w);
    r1.z = (-(r1.w)) + (c4.w);
    r1.x = pow(abs(r3.z), r2.z);
    r1.y = (r1.z) * (r1.z);
    r1.w = (r2.z) * (c3.x) + (c3.y);
    r1.y = (r1.y) * (r1.y);
    r1.w = (r1.x) * (r1.w);
