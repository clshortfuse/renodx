// Mechanically reconstructed from 0x657A9031.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = ((r1.z) >= 0.0f ? (r0.y) : (r1.y));
    r0 = tex2D(s4, v7.zw);
    r0.w = (r0.w) * (v0.z) + (c3.w);
    r1.z = dot(v6.xyz, v6.xyz);
    r4.xyz = float3(((r0.w) >= 0.0f ? (r0.x) : (r4.x)), ((r0.w) >= 0.0f ? (r0.y) : (r4.y)), ((r0.w) >= 0.0f ? (r0.z) : (r4.z)));
    r5.z = rsqrt(r1.z);
    r5.w = ((r0.w) >= 0.0f ? (-(c3.y)) : (r1.w));
    r0.xyz = (v6.xyz) * (-(r5.zzz)) + (c[17].xyz);
    r4.w = (r12.z) * (-(c14.x)) + (c14.y);
    ...
    r2.w = r0.y;
    r5.xy = (r2.xz) * (r6.xx);
    r7.xy = (r2.yw) * (c12.zz) + (c12.ww);
    r0.y = (r1.x) * (c12.y) + (-(r5.x));
    r0.w = dot(r7.xy, r12.xy) + (c3.z);
    r1.w = (r2.z) * (-(r6.x)) + (r0.y);
    r2.xy = (r0.xz) * (r6.yy);
