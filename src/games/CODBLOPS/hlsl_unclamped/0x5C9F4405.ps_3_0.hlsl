// Mechanically reconstructed from 0x5C9F4405.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = (v1.xy) + (c1.xx);
    r2.w = c1.y;
    r1.xy = (r4.xy) * (c[25].xx) + (r2.ww);
    r1 = tex2D(s3, r1.xy);
    r4.w = (v7.w) * (c1.z) + (-(r1.x));
    r0.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r7.w = saturate((r4.w) * (c1.w));
    r1.xy = lerp(r2.xy, r0.xy, r7.ww);
    ...
    r9.xy = (r4.xy) * (c[26].xx) + (r2.ww);
    r2.w = saturate(dot(r1.xyz, r3.xyz));
    r0 = tex2D(s2, v1.xy);
    r4.x = (r0.w) * (c3.x);
    r8.xyz = normalize(v6.xyz);
    r4.z = (r0.w) * (-(c3.x)) + (c3.w);
    r4.y = saturate(dot(r1.xyz, -(r8.xyz)));
    r3.w = (r2.w) * (r4.z) + (r4.x);
    r4.z = (r4.y) * (r4.z) + (r4.x);
    r6.w = (-(r4.y)) + (c2.x);
    r3.w = (r3.w) * (r4.z) + (c4.x);
    ...
    r6.xy = c[9].xy;
    r2.xyz = (r6.yyy) * (c[8].xyz);
    r1.w = (r0.w) * (c2.z);
    r3.xyz = (r0.xyz) * (r2.xyz);
    r0.w = dot(c[10].yz, r7.xy) + (c[10].x);
    r2.xy = saturate((r7.xx) * (c[11].xy) + (c[11].zw));
    r0.xy = (r2.xy) * (r2.xy);
    ...
    r1.w = (r1.w) * (r1.w);
    r0.xyz = (r0.xyz) * (c[20].xxx) + (r2.xyz);
    r1.w = (r1.w) * (c[27].w);
    r0.xyz = (c[27].xyz) * (r1.www) + (r0.xyz);
