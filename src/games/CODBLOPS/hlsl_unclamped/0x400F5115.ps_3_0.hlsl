// Mechanically reconstructed from 0x400F5115.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.w = (r1.w) * (v7.y) + (c2.w);
    r1.w = (r4.y) * (r3.z);
    r8.xy = float2(((r7.w) >= 0.0f ? (r0.x) : (r3.x)), ((r7.w) >= 0.0f ? (r0.y) : (r3.y)));
    ...
    r7.xyz = float3(((r7.w) >= 0.0f ? (c[28].x) : (r3.y)), ((r7.w) >= 0.0f ? (c[28].y) : (r3.y)), ((r7.w) >= 0.0f ? (c[28].w) : (r3.y)));
    r0.y = exp2(r0.y);
    r6.w = 1.0f / (r0.x);
