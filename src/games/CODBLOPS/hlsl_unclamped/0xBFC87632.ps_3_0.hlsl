// Mechanically reconstructed from 0xBFC87632.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = dot(r1.xy, r0.zw) + (c20.z);
    r2.x = dot(r1.xy, r0.xy) + (c20.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r6.w = (r0.w) * (v0.y);
    r5.xyz = lerp(r1.xyz, r0.xyz, r6.www);
    r8.xy = lerp(r3.xy, r2.xy, r6.ww);
    r0 = tex2D(s6, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    ...
    r0 = tex2D(s4, v7.zw);
    r7.w = (r0.w) * (v0.z);
    r3 = lerp(r2, r1, r6.wwww);
    r1.xyz = lerp(r5.xyz, r0.xyz, r7.www);
    r6.xy = lerp(r8.xy, r7.xy, r7.ww);
    r8.xyz = (r1.xyz) * (r1.xyz);
    r1 = tex2D(s9, v7.zw);
    r2 = (r1.wwww) * (-(c20.zzzy)) + (-(c20.wwwz));
    r0.xyw = c[8].xyw;
    r5.xyz = (-(r0.xyw)) + (c[9].xyw);
    r0 = lerp(r3, r2, r7.wwww);
    r2.xyz = (r6.www) * (r5.xyz) + (c[8].xyw);
    r11.xyz = lerp(r2.xyz, r1.yyy, r7.www);
    ...
    r1.y = dot(r6.xy, r6.xy) + (c20.z);
    r1.w = dot(r2.xy, r2.xy) + (c20.z);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r3.w = (r1.y) * (c3.x) + (c3.y);
    r1.y = (r1.w) * (c3.x) + (c3.y);
    r1.w = dot(r2.xy, r6.xy) + (c20.z);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c4.ww);
