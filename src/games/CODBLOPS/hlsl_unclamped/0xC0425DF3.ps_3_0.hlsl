// Mechanically reconstructed from 0xC0425DF3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c36 = float4(2.0f, -1.0f, 0.0f, -0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r2.y = dot(r1.xy, r0.zw) + (c36.z);
    r2.x = dot(r1.xy, r0.xy) + (c36.z);
    r0 = tex2D(s1, v1.xy);
    ...
    r0 = tex2D(s8, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c36.xxxx) * (v9) + (c36.yyyy);
    r5.y = dot(r1.xy, r0.zw) + (c36.z);
    r5.x = dot(r1.xy, r0.xy) + (c36.z);
    r1 = tex2D(s10, v7.xy);
    r2 = tex2D(s9, v1.xy);
    r0 = tex2D(s6, v7.zw);
    r6.w = (r0.w) * (v0.z);
    r3 = lerp(r2, r1, r5.wwww);
    r11.xy = lerp(r6.xy, r5.xy, r6.ww);
    r1.xyz = lerp(r4.xyz, r0.xyz, r6.www);
    r0.w = dot(r11.xy, r11.xy) + (c36.z);
    ...
    r0.y = (r1.x) * (c4.w) + (-(r4.x));
    r0.w = dot(r6.xy, r11.xy) + (c36.z);
    r1.w = (r2.z) * (-(r5.x)) + (r0.y);
    r2.xy = (r0.xz) * (r5.yy);
    r0.x = dot(r6.xy, r6.xy) + (c36.z);
    r0.y = (r1.y) * (c4.w) + (-(r2.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r0.z) * (-(r5.y)) + (r0.y);
    r0.z = (r0.x) * (c3.x) + (c3.y);
    ...
    r6.xz = (r4.xy) * (c12.xx);
    r0.xyw = c[32].xyw;
    r0.xyz = (-(r0.xyw)) + (c[33].xyw);
    r4.xyz = (r6.xyz) * (r4.zzz) + (r1.xyz);
    r5.xyz = (r5.www) * (r0.xyz) + (c[32].xyw);
    r1 = tex2D(s11, v7.zw);
    r0.xyz = (-(v6.xyz)) + (c[5].xyz);
    r0.w = dot(r0.xyz, r0.xyz);
    r0.w = rsqrt(r0.w);
    r7.xyz = (r4.www) * (v6.xyz);
    r2 = (r1.wwww) * (-(c36.zzzy)) + (-(c36.wwwz));
    ...
    r1.z = (r1.x) * (r1.z);
    r14.xyz = lerp(r5.xyz, r1.yyy, r6.www);
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (-(c36.y)) : (-(c36.z)));
    ...
    r1.xy = (r1.xy) * (r1.xy);
    r1.w = ((-abs(r1.w)) >= 0.0f ? (c36.z) : (r1.z));
    r1.z = (r3.x) * (r1.x);
    r1.w = (r1.w) * (r1.z);
    r1.z = (r1.y) * (-(r3.y)) + (-(c36.y));
    r1.xy = (r2.ww) * (r2.xy);
    r1.w = (r1.w) * (r1.z);
    r2.w = (r3.z) * (r1.w);
