// Mechanically reconstructed from 0x358878BD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.y = dot(r1.xy, r0.zw) + (c43.z);
    r6.x = dot(r1.xy, r0.xy) + (c43.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s5, v7.xy);
    r6.w = (r0.w) * (v0.y);
    r2 = tex2D(s1, v1.xy);
    ...
    r4.xyz = lerp(c[39].xyw, r0.yyy, r6.www);
    r1 = tex2D(s11, v7.zw);
