// Mechanically reconstructed from 0x4B6B5498.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.z = (r4.w) * (r10.w) + (r10.z);
    r9.w = (r2.w) * (r10.w) + (r10.z);
    r5.xyz = (r1.xyz) * (-(r1.xyz)) + (c1.zzz);
    r7.w = (r6.z) * (r9.w) + (c12.x);
    r6.xyz = (r1.xyz) * (r1.xyz);
    r7.w = 1.0f / (r7.w);
    r1.xyz = (r5.xyz) * (r10.yyy) + (r6.xyz);
    r7.w = (r4.w) * (r7.w);
    r10.y = (-(r2.w)) + (c1.z);
    ...
    r1.w = (r2.w) * (r1.w);
    r8.z = exp2(r8.y);
    r2.w = pow(abs(r4.z), r8.z);
    r4.z = (r8.z) * (c12.y) + (c12.z);
    r2.w = (r2.w) * (r4.z);
    r4.y = (r6.w) * (r10.w) + (r10.z);
    r4.y = (r4.y) * (r9.w) + (c12.x);
    r7.z = saturate(dot(r9.xyz, r7.xyz));
    r4.y = 1.0f / (r4.y);
    r4.x = pow(abs(r7.z), r8.z);
    r4.y = (r6.w) * (r4.y);
    r4.z = (r4.z) * (r4.x);
    r6.w = (r4.y) * (r4.z);
    r4.xyz = (r5.xyz) * (r8.www) + (r6.xyz);
    r2.w = (r7.w) * (r2.w);
    ...
    r7.xyz = (r2.xyz) * (c[37].xxx) + (r3.xyz);
    r1.xyz = (r1.xyz) * (c[23].xyz);
    r3.xyz = (r1.xyz) * (c[37].www);
    r1 = (v7.yyyy) * (c[33]);
