// Mechanically reconstructed from 0x0CFDC8AD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s3, v7.xy);
    r7.w = (r1.w) * (v0.y);
    r6.xy = (r7.ww) * (-(r5.xy)) + (r0.xy);
    r0 = tex2D(s4, v7.zw);
    r5.w = (r0.w) * (v0.z);
    r2.w = r3.x;
    r3.xy = (r6.xy) * (r5.ww);
    r2.w = dot(r2, c1.wwww);
    r3.xy = (r7.ww) * (r5.xy) + (r3.xy);
    r2.w = (r2.w) + (c4.y);
    r2.xyz = v4.xyz;
    ...
    r2.w = (r2.w) * (-(v0.x)) + (c4.z);
    r2.z = (r1.w) * (-(v0.y)) + (c4.z);
    r1.xyz = lerp(r6.xyz, r0.xyz, r5.www);
    r1.w = (r0.w) * (-(v0.z)) + (c4.z);
