// Mechanically reconstructed from 0x8A44CBA5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xy = float2(((r8.w) >= 0.0f ? (r5.x) : (r6.x)), ((r8.w) >= 0.0f ? (r5.y) : (r6.y)));
    ...
    r8.y = (r0.w) + (r0.w);
    r0.w = (r5.w) * (r6.w);
    r0.xyz = (r8.xyz) * (r2.www) + (r1.xyz);
    r6 = tex2D(s6, v0.xy);
    r11.xyz = float3(((r8.w) >= 0.0f ? (c[36].x) : (r6.y)), ((r8.w) >= 0.0f ? (c[36].y) : (r6.y)), ((r8.w) >= 0.0f ? (c[36].w) : (r6.y)));
