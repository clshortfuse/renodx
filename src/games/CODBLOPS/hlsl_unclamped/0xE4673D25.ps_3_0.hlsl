// Mechanically reconstructed from 0xE4673D25.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xyz = (v0.zzz) * (r1.xyz) + (c1.zzz);
    r5.xyz = (v0.yyy) * (r0.xyz) + (c1.zzz);
    r0 = tex2D(s0, v1.xy);
    r1 = tex2D(s5, v1.xy);
    r3.xyz = lerp(r0.xyz, c1.xxx, r1.xxx);
    ...
    r0 = v2;
    r5.xyz = (r12.xxx) * (v5.xyz) + (r0.xyz);
    r0.xyz = (r8.xyz) * (r6.xyz);
    r5.xyz = (r12.yyy) * (v4.xyz) + (r5.xyz);
