// Mechanically reconstructed from 0x38CA458E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4 = float4(((r2.w) >= 0.0f ? (r0.x) : (r1.x)), ((r2.w) >= 0.0f ? (r0.y) : (r1.y)), ((r2.w) >= 0.0f ? (r0.z) : (r1.z)), ((r2.w) >= 0.0f ? (r0.w) : (r1.w)));
    r0 = tex2D(s5, v5.zw);
    ...
    r3.y = exp2(r3.y);
    r2.z = (r3.x) * (c[46].x);
    r2.y = (r3.y) * (c[46].y) + (-(r2.z));
    r2.z = c[46].y;
    r2.z = (r3.y) * (r2.z) + (-(c[45].z));
    r2.y = 1.0f / (r2.y);
    r5.xy = abs(r2.xw);
    r5.z = dot(r1, c[42]);
