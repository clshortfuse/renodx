// Mechanically reconstructed from 0xBD79EE54.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r5.w = (r0.w) * (v0.w) + (c1.x);
    r5.xy = float2(((r5.w) >= 0.0f ? (r1.x) : (c1.z)), ((r5.w) >= 0.0f ? (r1.y) : (c1.z)));
    r1 = v2;
