// Mechanically reconstructed from 0x83FE89D9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s4, v6.zw);
    r6.w = (r0.w) * (v0.z) + (c2.w);
    r14.xy = float2(((r6.w) >= 0.0f ? (r2.x) : (r4.x)), ((r6.w) >= 0.0f ? (r2.y) : (r4.y)));
    ...
    r2.xyw = c[32].xyw;
    r3.xyz = float3(((r7.w) >= 0.0f ? (r2.x) : (c[31].x)), ((r7.w) >= 0.0f ? (r2.y) : (c[31].y)), ((r7.w) >= 0.0f ? (r2.w) : (c[31].w)));
    r2.xy = (v1.zw) * (-(c2.yw));
    r2 = tex2D(s13, r2.xy);
