// Mechanically reconstructed from 0xDD6FF257.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyw = c[28].xyw;
    r6.xyz = float3(((r1.w) >= 0.0f ? (r0.x) : (c[27].x)), ((r1.w) >= 0.0f ? (r0.y) : (c[27].y)), ((r1.w) >= 0.0f ? (r0.w) : (c[27].w)));
    r3.w = (r0.z) + (r0.z);
    r2 = tex2D(s7, v1.xy);
    r0 = tex2D(s8, v6.xy);
