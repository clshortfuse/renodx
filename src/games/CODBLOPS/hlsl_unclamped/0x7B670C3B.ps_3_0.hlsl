// Mechanically reconstructed from 0x7B670C3B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.w = (r1.w) * (v0.y) + (c3.w);
    r1.w = (r2.z) * (r5.x);
    r4.xy = float2(((r9.w) >= 0.0f ? (r0.x) : (r2.x)), ((r9.w) >= 0.0f ? (r0.y) : (r2.y)));
    r0 = tex2D(s6, v7.zw);
    ...
    r7.w = (r0.w) * (v0.z) + (c3.w);
    r0.w = (r5.y) * (r1.w);
    r8.xy = float2(((r7.w) >= 0.0f ? (r2.x) : (r4.x)), ((r7.w) >= 0.0f ? (r2.y) : (r4.y)));
    ...
    r4.xyz = float3(((r9.w) >= 0.0f ? (c[31].x) : (r3.y)), ((r9.w) >= 0.0f ? (c[31].y) : (r3.y)), ((r9.w) >= 0.0f ? (c[31].w) : (r3.y)));
    r1.w = exp2(r5.y);
    ...
    r7.xyz = float3(((r7.w) >= 0.0f ? (c[32].x) : (r4.x)), ((r7.w) >= 0.0f ? (c[32].y) : (r4.y)), ((r7.w) >= 0.0f ? (c[32].w) : (r4.z)));
    r2.xy = (v1.zw) * (-(c3.yw));
    r2 = tex2D(s13, r2.xy);
