// Mechanically reconstructed from 0x0A41E6A9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s2, v6.xy);
    r2.xyz = (r1.xyz) + (c16.yyy);
    r1.xyz = (r12.yyy) * (v3.xyz) + (r3.xyz);
    r6.xyz = (v0.yyy) * (r2.xyz) + (c16.zzz);
    r9.xyz = normalize(r1.xyz);
    r5.xyz = (r6.xyz) * (c16.www);
    r3 = tex2D(s5, v1.xy);
    r5.w = r3.w;
    r2 = tex2D(s6, v6.zw);
