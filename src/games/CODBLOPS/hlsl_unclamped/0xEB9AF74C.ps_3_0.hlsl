// Mechanically reconstructed from 0xEB9AF74C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(0.0f, 1.0f, 0.600000024f, 0.400000006f);
    ...
    r0.xy = c2.xy;
    r4.xyz = (r0.xyx) + (-(c[21].xyw));
    r0.xyz = normalize(r5.xyz);
    r9.xyz = (r5.www) * (r4.xyz) + (c[21].xyw);
