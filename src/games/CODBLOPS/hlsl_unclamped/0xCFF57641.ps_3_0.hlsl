// Mechanically reconstructed from 0xCFF57641.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xy = float2(((r5.w) >= 0.0f ? (r2.x) : (c1.y)), ((r5.w) >= 0.0f ? (r2.y) : (c1.y)));
    ...
    r3.xyw = c[22].xyw;
    r9.xyz = float3(((r5.w) >= 0.0f ? (r3.x) : (c[21].x)), ((r5.w) >= 0.0f ? (r3.y) : (c[21].y)), ((r5.w) >= 0.0f ? (r3.w) : (c[21].w)));
    ...
    r4.w = (r4.w) * (r3.w);
    r8.w = saturate(dot(r0.xyz, r3.xyz));
    r3.w = saturate(dot(r3.xyz, r7.xyz));
    r11.xy = (r2.ww) * (c12.xy) + (c12.zw);
    r7.w = exp2(r11.y);
    r3.z = (-(r3.w)) + (c2.y);
    r3.x = pow(abs(r8.w), r7.w);
    r3.y = (r3.z) * (r3.z);
    r3.w = (r7.w) * (c13.x) + (c13.y);
    r3.y = (r3.y) * (r3.y);
    r3.w = (r3.x) * (r3.w);
    r3.z = (r3.z) * (r3.y);
