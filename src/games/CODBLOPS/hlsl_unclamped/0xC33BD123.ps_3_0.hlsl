// Mechanically reconstructed from 0xC33BD123.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(0.25f, -1.0f, 1.0f, 0.797884583f);
    ...
    r4.xy = (r0.ww) * (-(r2.xy)) + (r2.xy);
    r2.xyz = lerp(r1.xyz, r0.xyz, r0.www);
    r0.xyz = v3.xyz;
    r1.xyz = (r4.xxx) * (r0.xyz) + (v1.xyz);
    r0.xyz = (r2.xyz) * (r2.xyz);
    r1.xyz = (r4.yyy) * (v2.xyz) + (r1.xyz);
    ...
    r0.w = exp2(r0.w);
    r2.z = (-(r2.z)) + (c2.z);
    r4.w = pow(abs(r3.w), r0.w);
    r2.y = (r2.z) * (r2.z);
    r0.w = (r0.w) * (c1.x) + (c1.y);
    r2.y = (r2.y) * (r2.y);
    r3.w = (r2.z) * (r2.y);
    r2.xyz = (r0.xyz) * (-(r0.xyz)) + (c2.zzz);
    r0.w = (r4.w) * (r0.w);
