// Mechanically reconstructed from 0xACD8F347.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xyz = lerp(c[42].xyw, r1.yyy, r10.www);
    r1.xyz = (r6.yyy) * (v3.xyz) + (r2.xyz);
    ...
    r3.y = (r3.y) * (r3.y);
    r9.xyz = (v0.zzz) * (r2.xyz) + (-(c15.yyy));
    r2 = tex2D(s6, v8.xy);
    r2.xyz = (r2.xyz) + (c15.yyy);
    r1.xyz = (r1.xyz) * (r9.xyz);
    r5.xyz = (v0.www) * (r2.xyz) + (-(c15.yyy));
    r2.w = (r3.z) * (r3.y);
