// Mechanically reconstructed from 0xC0016893.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2Dproj(s2, r1);
    r0.w = r1.x;
    r2.xyz = (r2.xyz) * (c[32].yyy);
    r3.w = dot(r0, c3.zzzz);
    r0 = tex2D(s12, v1.zw);
    r1.xyz = (-(v7.xyz)) + (c[24].xyz);
    r6.y = dot(r1.xyz, r1.xyz);
    r1.w = rsqrt(r6.y);
    r3.xyz = (r1.xyz) * (r1.www);
    r0.w = dot(r3.xyz, c[27].xyz);
    ...
    r0.xyz = (r2.www) * (c[25].xyz);
    r1.xyz = (r1.xyz) * (r1.www) + (-(r8.xyz));
    r0.xyz = (r6.www) * (r0.xyz) + (r2.xyz);
