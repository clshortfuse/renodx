// Mechanically reconstructed from 0x3EC6A682.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xyz = float3(((r2.w) >= 0.0f ? (r2.x) : (r1.x)), ((r2.w) >= 0.0f ? (r2.y) : (r1.y)), ((r2.w) >= 0.0f ? (r2.z) : (r1.z)));
    r6.w = ((r2.w) >= 0.0f ? (r0.y) : (r1.w));
    r6.xyz = (r3.xyz) * (r3.xyz);
    r7.w = (r11.z) * (-(c41.z)) + (c41.w);
    ...
    r2 = tex2D(s14, v1.zw);
    r0.xy = (r2.xy) * (c12.zz);
    r4.xy = (r1.wy) * (c41.xx) + (c41.yy);
    r3.xy = (r3.xz) * (r0.xx);
    r0.z = dot(r4.xy, r11.xy) + (c3.z);
