// Mechanically reconstructed from 0xF84EC527.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4 = tex2D(s13, r4.xy);
    r2.w = r4.y;
    r9.xy = float2(((r1.w) >= 0.0f ? (r3.x) : (r5.x)), ((r1.w) >= 0.0f ? (r3.y) : (r5.y)));
    ...
    r8.xy = float2(((r1.w) >= 0.0f ? (r2.w) : (r8.x)), ((r1.w) >= 0.0f ? (r2.y) : (r8.y)));
    r0.w = (r0.w) + (r0.w);
    ...
    r2 = tex2D(s0, v1.xy);
    r4.xyz = lerp(r2.xyz, r1.xyz, r6.www);
    r1.xyz = (r6.xyz) * (r5.xyz);
    r0.xyz = float3(((r1.w) >= 0.0f ? (r0.x) : (r4.x)), ((r1.w) >= 0.0f ? (r0.y) : (r4.y)), ((r1.w) >= 0.0f ? (r0.z) : (r4.z)));
