// Mechanically reconstructed from 0xAAE5D69B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.x = dot(r3.xy, r1.xy) + (c13.z);
    r6.y = dot(r3.xy, r1.zw) + (c13.z);
    r1 = tex2D(s3, v6.zw);
    r6.w = (r1.w) * (v6.y);
    r3.xy = (r2.yw) * (c4.xx) + (c4.yy);
    r7.xy = lerp(r8.xy, r6.xy, r6.ww);
    r0.z = dot(r3.xy, r3.xy) + (c13.z);
    ...
    r5.w = (r2.w) * (-(v6.x)) + (c13.w);
    r6.w = (r1.w) * (-(v6.y)) + (c13.w);
