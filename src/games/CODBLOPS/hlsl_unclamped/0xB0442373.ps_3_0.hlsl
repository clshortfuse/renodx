// Mechanically reconstructed from 0xB0442373.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c28 = float4(3.5f, -13.0f, 1.0f, 13.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r3.xyz = float3(((r4.w) >= 0.0f ? (r0.x) : (r1.x)), ((r4.w) >= 0.0f ? (r0.y) : (r1.y)), ((r4.w) >= 0.0f ? (r0.z) : (r1.z)));
    r0 = tex2D(s5, v7.zw);
    r0.xyz = (r0.xyz) + (c3.yyy);
    r7.xy = float2(((r4.w) >= 0.0f ? (r4.x) : (r2.x)), ((r4.w) >= 0.0f ? (r4.y) : (r2.y)));
    r4.xyz = (v0.zzz) * (r0.xyz) + (-(c3.yyy));
    r0 = tex2D(s6, v8.xy);
    r0.xyz = (r0.xyz) + (c3.yyy);
    r2.xyz = (r4.xyz) * (c4.xxx);
    r1.xyz = (v0.www) * (r0.xyz) + (-(c3.yyy));
    ...
    r2.w = r0.y;
    r3.xy = (r2.xz) * (r5.xx);
    r6.xy = (r2.yw) * (c12.zz) + (c12.ww);
    r0.y = (r1.x) * (c12.y) + (-(r3.x));
    r0.w = dot(r6.xy, r7.xy) + (c3.z);
    r1.w = (r2.z) * (-(r5.x)) + (r0.y);
    r2.xy = (r0.xz) * (r5.yy);
    r0.x = dot(r6.xy, r6.xy) + (c3.z);
    r0.y = (r1.y) * (c12.y) + (-(r2.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r0.z) * (-(r5.y)) + (r0.y);
    r0.z = (r0.x) * (c4.y) + (c4.z);
    r0.y = (r0.y) + (r0.y);
    ...
    r9.xyz = (r3.xyz) * (r0.zzz);
    r0.z = saturate(dot(r1.xyz, r9.xyz));
    r0.z = (-(r0.z)) + (-(c3.y));
    r9.w = (r0.w) * (-(c16.x)) + (c16.y);
    r0.x = (r0.z) * (r0.z);
    r0.x = (r0.x) * (r0.x);
    r3.xyz = v2.xyz;
    ...
    r1.z = saturate(dot(r15.xyz, r1.xyz));
    r10.w = (r0.w) * (c12.x);
    r3.w = saturate(dot(r9.xyz, r15.xyz));
    r2.w = saturate(dot(r15.xyz, -(r6.xyz)));
    r0.z = (r3.w) * (r9.w) + (r10.w);
    r8.w = (r2.w) * (r9.w) + (r10.w);
    r0.z = (r0.z) * (r8.w) + (c16.z);
    r3.xy = (r0.ww) * (c28.xy) + (c28.zw);
    r0.x = 1.0f / (r0.z);
    r7.w = exp2(r3.y);
    ...
    r0.x = (r3.w) * (r0.x);
    r0.z = (r0.z) * (r5.w);
    r1.xyz = (r13.xyz) * (r5.zzz) + (r14.xyz);
    r0.z = (r0.x) * (r0.z);
    r2.xyz = (r8.xyz) * (r6.www) + (r2.xyz);
    r1.xyz = (r1.xyz) * (r0.zzz);
    r17.xy = float2(((r4.w) >= 0.0f ? (-(c3.z)) : (r0.y)), ((r4.w) >= 0.0f ? (-(c3.y)) : (r0.y)));
    r0.xyz = (r1.xyz) * (c[7].xyz);
    r1.xyz = (r17.xxx) * (r0.xyz);
    r0.xyz = (r3.www) * (c[6].xyz);
    r12.xyz = (r2.xyz) * (r17.yyy);
    r5.xyz = (r10.xyz) * (r0.xyz) + (r1.xyz);
    r1.y = 1.0f / (r3.x);
    r0.y = (-(r2.w)) + (-(c3.y));
    r0.x = (r0.y) * (r0.y);
    r0.z = dot(r6.xyz, r15.xyz);
    r1.z = (r0.y) * (r0.x);
    r0.z = (r0.z) + (r0.z);
    r0.w = (r0.w) * (c4.w);
    r0.xyz = (r15.xyz) * (-(r0.zzz)) + (r6.xyz);
    r0 = texCUBElod(s15, r0);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r0.w = (r1.y) * (r1.z);
    r1.xyz = (r17.xxx) * (r0.xyz);
    r2.xyz = (r13.xyz) * (r0.www) + (r14.xyz);
    r0.xyz = (v6.xyz) * (-(r1.www)) + (c[17].xyz);
    r7.xyz = (r1.xyz) * (r2.xyz);
    r16.xyz = normalize(r0.xyz);
    r11.w = saturate(dot(r16.xyz, c[17].xyz));
    r6.w = saturate(dot(r15.xyz, c[17].xyz));
    r0 = tex2D(s12, v1.zw);
    ...
    r0.y = (r0.y) * (r8.w) + (c16.z);
    r1.w = saturate(dot(r15.xyz, r16.xyz));
    r0.x = 1.0f / (r0.y);
