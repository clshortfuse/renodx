// Mechanically reconstructed from 0xF2C9E35F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.y = (r0.w) + (r0.w);
    r0.w = (r3.w) * (r5.w);
    r0.xyz = (r7.xyz) * (r2.www) + (r1.xyz);
    r3 = tex2D(s4, v6.zw);
    r3.w = (r3.w) * (v6.y) + (c1.x);
    r2 = tex2D(s5, v0.xy);
    r12.xy = float2(((r3.w) >= 0.0f ? (c1.y) : (r2.y)), ((r3.w) >= 0.0f ? (c1.z) : (r2.y)));
    ...
    r4.x = (r2.w) * (c2.z);
    r4.y = (r2.w) * (-(c12.z)) + (c12.w);
    r4.z = (r1.x) * (r4.y) + (r4.x);
    r1.w = (r5.w) * (r4.y) + (r4.x);
    r1.w = (r1.w) * (r4.z) + (c13.x);
