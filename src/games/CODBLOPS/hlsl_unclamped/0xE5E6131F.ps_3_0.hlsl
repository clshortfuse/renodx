// Mechanically reconstructed from 0xE5E6131F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.y = saturate(dot(r9.xyz, r11.xyz));
    r1.z = exp2(r12.y);
    r0.y = pow(abs(r1.y), r1.z);
    r0.z = (r1.z) * (c13.x) + (c13.y);
    r1.y = (r7.w) * (r0.x);
    r1.z = (r0.y) * (r0.z);
    r0.xyz = (r5.xyz) * (r6.www) + (r10.xyz);
    r1.z = (r1.y) * (r1.z);
