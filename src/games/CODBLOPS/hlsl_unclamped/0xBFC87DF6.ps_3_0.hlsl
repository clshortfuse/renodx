// Mechanically reconstructed from 0xBFC87DF6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r7.w = (r0.w) * (v0.w) + (c1.x);
    r3.xyz = float3(((r7.w) >= 0.0f ? (r1.x) : (c1.z)), ((r7.w) >= 0.0f ? (r1.y) : (c1.z)), ((r7.w) >= 0.0f ? (r1.z) : (c1.z)));
    r1 = v2;
    r1.xyz = (r3.xxx) * (v5.xyz) + (r1.xyz);
    r1.xyz = (r3.yyy) * (v4.xyz) + (r1.xyz);
    r2.xyz = normalize(r1.xyz);
    r1.z = max(abs(r2.y), abs(r2.z));
    r0.w = max(abs(r2.x), r1.z);
    r2.w = 1.0f / (r0.w);
    r1.xyz = (r2.xyz) * (c[5].xyz);
    r0.w = saturate(dot(c[17].xyz, r2.xyz));
