// Mechanically reconstructed from 0x6A6BBE2F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.y = dot(r1.xy, r0.zw) + (c1.z);
    r3.x = dot(r1.xy, r0.xy) + (c1.z);
    r0 = tex2D(s1, v0.xy);
    ...
    r8.w = saturate(dot(r1.xyz, r3.xyz));
    ...
    r0.y = (r3.z) * (r4.w) + (c14.x);
    r0.z = pow(abs(r1.x), r3.w);
    r0.y = 1.0f / (r0.y);
    r0.z = (r1.w) * (r0.z);
    r0.x = (r2.w) * (r0.y);
    r0.y = (r1.y) * (c3.x) + (c3.y);
