// Mechanically reconstructed from 0x50290098.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = (r3.w) * (v7.y);
    r2.w = (r4.y) * (r2.w);
    r8.xy = lerp(r2.xy, r0.xy, r3.ww);
    r12.xyz = normalize(v6.xyz);
    r0 = v1;
    r0.xyz = (r8.xxx) * (v4.xyz) + (r0.xyz);
    r2.xyz = (r1.xyz) * (r2.zzz) + (-(r12.xyz));
    ...
    r7.xyz = lerp(r2.yyy, c[28].xyw, r3.www);
    ...
    r6 = tex2D(s13, r5.xy);
    r4.w = r6.y;
    r14.xyz = (r0.xyz) * (c[22].xyz);
    r0.xy = (r4.yw) * (c4.xx) + (c4.yy);
    r2.z = dot(r8.xy, r8.xy) + (c1.w);
    ...
    r8.xz = (r4.xy) * (c4.xx);
    r8.y = (r2.y) + (r2.y);
    r4.xyz = (r8.www) * (r14.xyz);
    r0.xyz = (r8.xyz) * (r2.zzz) + (r0.xyz);
    r5.xyz = (r7.yyy) * (r0.xyz);
    r0.xyz = (r1.xyz) * (-(r2.xxx)) + (r3.xyz);
    r3.xyz = (r8.www) * (r13.xyz) + (r5.xyz);
