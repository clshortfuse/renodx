// Mechanically reconstructed from 0xA5693DE0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c16 = float4(1.0f, 0.5f, 0.0f, 4.0f);
    const float4 c20 = float4(4.0f, -3.0f, 0.0f, 0.0f);
    const float4 c21 = float4(2.0f, -1.0f, 1.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r5.w = (r0.w) * (r0.z);
    r1 = tex2D(s0, v1.xy);
    r1.w = (r1.w) * (-(v0.x)) + (c21.z);
    r0 = tex2D(s2, v7.xy);
    r7.z = (r0.w) * (v0.y);
    r2.xyz = lerp(r1.xyz, r0.xyz, r7.zzz);
    r1.z = (r0.w) * (-(v0.y)) + (c21.z);
    r0 = tex2D(s5, v7.zw);
    r3.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c21.xxxx) * (v8) + (c21.yyyy);
    r1.y = dot(r3.xy, r0.zw) + (c21.w);
    r1.x = dot(r3.xy, r0.xy) + (c21.w);
    r0 = tex2D(s4, v7.xy);
    r3.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r1.w = (r1.w) * (-(r1.z)) + (c21.z);
    ...
    r8.w = (r0.w) * (-(v0.z)) + (c21.z);
    r0.xy = (v1.zw) * (c16.xy) + (c16.zy);
    r0 = tex2D(s13, r0.xy);
    r2.xy = (v1.zw) * (c16.xy);
    r2 = tex2D(s13, r2.xy);
    r0.w = r2.y;
    r12.xyz = (r1.xyz) * (r1.xyz);
    r1.xy = (r0.wy) * (c11.xx) + (c11.yy);
    r0.y = dot(r7.xy, r7.xy) + (c21.w);
    r0.w = dot(r1.xy, r1.xy) + (c21.w);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r8.z = (r0.y) * (c4.x) + (c4.y);
    r0.y = (r0.w) * (c4.x) + (c4.y);
    r0.w = dot(r1.xy, r7.xy) + (c21.w);
    r0.y = (r8.z) * (r0.y);
    r1 = tex2D(s14, v1.zw);
    r3.xy = (r1.xy) * (c4.ww);
    ...
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c21.z) : (c21.w));
