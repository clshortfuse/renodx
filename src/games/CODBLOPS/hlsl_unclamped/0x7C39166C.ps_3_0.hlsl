// Mechanically reconstructed from 0x7C39166C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.z = dot(r1, c[24]);
    r0.z = (r3.x) * (c[28].x);
    r0.y = (r3.y) * (c[28].y) + (-(r0.z));
    r0.z = c[28].y;
    r0.z = (r3.y) * (r0.z) + (-(c[27].z));
    r0.y = 1.0f / (r0.y);
    r3.xy = abs(r0.xw);
    r4.w = saturate((r0.z) * (r0.y));
    r1 = c[20];
    r1 = saturate((r3.zyxz) * (r1) + (c[21]));
    r4.x = (r1.w) * (r1.x);
    r4.yz = r1.yz;
    r1 = (r4) * (r4);
