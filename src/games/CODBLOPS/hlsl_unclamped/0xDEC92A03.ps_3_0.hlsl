// Mechanically reconstructed from 0xDEC92A03.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = dot(c[24].yz, r6.xy) + (c[24].x);
    r1.xy = saturate((r6.xx) * (c[25].xy) + (c[25].zw));
    r0.xy = (r1.xy) * (r1.xy);
