// Mechanically reconstructed from 0x7F6F1F1F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c0 = float4(1.0f, 0.5f, 31.875f, -3.0f);
    const float4 c1 = float4(1.0f, -0.0f, 0.000244140625f, -0.000244140625f);
    const float4 c2 = float4(0.00048828125f, -0.000122070312f, -0.0f, 0.25f);
    ...
    r3.w = ((-abs(r1.y)) >= 0.0f ? (c1.y) : (r1.x));
    r1.xy = (r4.xy) * (r4.xy);
    r6.xy = (r4.xy) * (c3.xx) + (c3.yy);
