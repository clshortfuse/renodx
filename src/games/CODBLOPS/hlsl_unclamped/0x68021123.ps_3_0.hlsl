// Mechanically reconstructed from 0x68021123.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = lerp(r3.yyy, c[28].xyw, r8.www);
    r3.xy = (v1.zw) * (c3.xy);
    r3 = tex2D(s13, r3.xy);
    r5.xy = (v1.zw) * (c3.xy) + (c3.zy);
    r5 = tex2D(s13, r5.xy);
    r3.w = r5.y;
    r9.xyz = lerp(r4.xyz, c[29].xyw, r7.www);
