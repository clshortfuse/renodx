// Mechanically reconstructed from 0x0C56B7A6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xy = float2(((r4.w) >= 0.0f ? (r6.x) : (c1.z)), ((r4.w) >= 0.0f ? (r6.y) : (c1.z)));
    ...
    r13.yz = c1.yz;
    r11.xyz = float3(((r4.w) >= 0.0f ? (c[36].x) : (r13.z)), ((r4.w) >= 0.0f ? (c[36].y) : (r13.z)), ((r4.w) >= 0.0f ? (c[36].w) : (r13.z)));
    ...
    r2.x = (r2.w) * (r7.w) + (r8.w);
    r5.w = (r2.z) * (r7.w) + (r8.w);
    r12.xyz = (v6.xyz) * (-(r4.www)) + (c[17].xyz);
    r2.x = (r2.x) * (r5.w) + (c4.x);
    r2.x = 1.0f / (r2.x);
