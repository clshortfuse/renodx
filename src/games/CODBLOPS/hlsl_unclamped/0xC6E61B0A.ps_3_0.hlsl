// Mechanically reconstructed from 0xC6E61B0A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r0.w) * (r0.z);
    r0 = tex2D(s4, v8.zw);
    r2.xyz = (r0.xyz) + (c4.yyy);
    r0 = tex2D(s1, v1.xy);
    r0.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r1 = tex2D(s3, v8.xy);
    r8.w = (r1.w) * (v0.y);
    r6.xyz = (v0.zzz) * (r2.xyz) + (c4.xxx);
    r8.xy = (r8.ww) * (-(r0.xy)) + (r0.xy);
    r2.xyz = (r6.xyz) * (c4.zzz);
    r0 = v2;
    ...
    r2.w = dot(r8.xy, r8.xy) + (c4.w);
    r2.y = dot(r3.xy, r3.xy) + (c4.w);
    r2.w = exp2(-(r2.w));
    r2.y = exp2(-(r2.y));
    r2.w = (r2.w) * (c1.x) + (c1.y);
    r3.w = (r2.y) * (c1.x) + (c1.y);
    r2.y = dot(r3.xy, r8.xy) + (c4.w);
    r4.w = (r2.w) * (r3.w);
    r3 = tex2D(s14, v1.zw);
    r12.xy = (r3.xy) * (c2.ww);
