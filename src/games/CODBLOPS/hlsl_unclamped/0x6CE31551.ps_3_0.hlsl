// Mechanically reconstructed from 0x6CE31551.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = dot(r5.xy, r0.xy) + (c3.z);
    r1.y = dot(r5.xy, r0.zw) + (c3.z);
    r0 = tex2D(s2, v6.xy);
    r5.w = (r0.w) * (v0.y) + (c3.w);
    r6.xy = (r2.yw) * (c2.zz) + (c2.ww);
    r1 = float4(((r5.w) >= 0.0f ? (r1.x) : (r3.x)), ((r5.w) >= 0.0f ? (r1.y) : (r3.y)), ((r5.w) >= 0.0f ? (r1.z) : (r3.z)), ((r5.w) >= 0.0f ? (r1.w) : (r3.w)));
    r2.w = dot(r6.xy, r6.xy) + (c3.z);
    ...
    r1.y = (r3.w) * (c2.x) + (c2.y);
    r7.xyz = (v0.zzz) * (r4.xyz) + (-(c3.yyy));
    r4 = tex2D(s4, v7.xy);
    r8.xyz = (r4.xyz) + (c3.yyy);
    r4.xyz = (r3.xyz) * (r7.xyz);
    r3.xyz = (v0.www) * (r8.xyz) + (-(c3.yyy));
    r1.y = 1.0f / (r1.y);
    r4.xyz = (r4.xyz) * (r3.xyz);
    r1.w = (r1.w) * (r1.y);
    r8.xyz = (r4.xyz) * (-(r4.xyz)) + (-(c3.yyy));
