// Mechanically reconstructed from 0xEF0202FB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = r0.y;
    r10.w = rsqrt(r1.z);
    r1.xy = (r3.yw) * (c38.xx) + (c38.yy);
    r2 = tex2D(s14, v1.zw);
    r8.xy = (r2.xy) * (c3.ww);
    r0.w = dot(r1.xy, r5.xy) + (c1.z);
    r6.xy = (r3.xz) * (r8.xx);
    r0.y = (r2.x) * (c3.w) + (-(r6.x));
    r3.xy = (r0.xz) * (r8.yy);
    r0.x = (r3.z) * (-(r8.x)) + (r0.y);
    ...
    r4.x = exp2(r0.y);
    r3.y = saturate(dot(r9.xyz, r13.xyz));
    r0.z = pow(abs(r3.y), r4.x);
