// Mechanically reconstructed from 0xBE697EA5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s13, r1.xy);
    r4.w = r1.y;
    r7.xy = (r4.yw) * (c3.xx) + (c3.yy);
    r2.xyz = (r7.yyy) * (v1.xyz);
    r7.xyz = (r7.xxx) * (v0.xyz) + (r2.xyz);
    r2 = tex2D(s14, v5.zw);
    r9.xy = (r2.xy) * (c2.ww);
    r7.xyz = (v3.xyz) * (r5.www) + (r7.xyz);
    r4.xy = (r4.xz) * (r9.xx);
    ...
    r10.xy = (r10.xy) * (c[7].xx);
    r3.xyz = (r3.yzx) * (v0.zxy) + (-(r4.xyz));
    r1.xy = (r1.xz) * (r9.yy);
    r3.xyz = (r10.yyy) * (-(r3.xyz));
    r1.w = (r2.y) * (c2.w) + (-(r1.x));
    r2.xyz = (r10.xxx) * (v0.xyz) + (r3.xyz);
    r3.xz = (r1.xy) * (c3.xx);
    ...
    r1.z = (c[8].x) * (c[8].x);
    r1.y = c[8].x;
    r1.xy = (r1.yy) * (r1.yy) + (c1.zw);
    r8.xy = (r1.zz) * (c1.xy);
    r9.x = 1.0f / (r1.x);
    r9.y = 1.0f / (r1.y);
    r2.xyz = (r1.www) * (r3.xyz) + (r7.xyz);
    r1.w = (r8.x) * (-(r9.x)) + (c2.x);
    r1.xyz = (r2.www) * (r3.xyz) + (r7.xyz);
    ...
    r2.z = dot(r2.xyz, r5.xyz);
    r2.z = saturate((r3.w) * (-(r2.w)) + (r2.z));
    r2.y = 1.0f / (r2.w);
    r2.z = (r5.w) * (r2.z);
    r2.y = saturate((r3.w) * (r2.y));
    r1.x = 1.0f / (r1.x);
    r1.y = 1.0f / (r1.y);
    r1.z = 1.0f / (r1.z);
    r4.w = (r2.z) * (r2.y);
