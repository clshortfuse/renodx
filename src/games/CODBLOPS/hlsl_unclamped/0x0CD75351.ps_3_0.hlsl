// Mechanically reconstructed from 0x0CD75351.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = (r6.xyz) * (c1.www);
    r0 = v2;
    r0.xyz = (r5.xxx) * (v5.xyz) + (r0.xyz);
    r8.xyz = (r4.xyz) * (r4.xyz);
    r1.xyz = (r5.yyy) * (v4.xyz) + (r0.xyz);
    ...
    r2.w = dot(r5.xy, r5.xy) + (c2.x);
    r2.y = dot(r3.xy, r3.xy) + (c2.x);
    r2.w = exp2(-(r2.w));
    r2.y = exp2(-(r2.y));
    r2.w = (r2.w) * (c2.y) + (c2.z);
    r3.w = (r2.y) * (c2.y) + (c2.z);
    r2.y = dot(r3.xy, r5.xy) + (c2.x);
    r4.w = (r2.w) * (r3.w);
    r3 = tex2D(s14, v1.zw);
    r13.xy = (r3.xy) * (c3.xx);
