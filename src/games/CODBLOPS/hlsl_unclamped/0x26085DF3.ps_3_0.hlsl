// Mechanically reconstructed from 0x26085DF3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = (r2.xy) * (r5.xy);
    r2.z = c1.y;
    r6.xyz = float3(((r1.w) >= 0.0f ? (r2.z) : (c[34].x)), ((r1.w) >= 0.0f ? (r2.z) : (c[34].y)), ((r1.w) >= 0.0f ? (r2.z) : (c[34].w)));
    r0.w = (r0.w) * (r2.x);
    ...
    r11.w = saturate(dot(r11.xyz, r12.xyz));
    r9.w = (r5.w) * (r2.y);
    r2.xyz = (r11.www) * (c[29].xyz);
