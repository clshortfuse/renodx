// Mechanically reconstructed from 0xBD8DFBB5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r1.w) + (r1.w);
    r1.xyz = (r9.xyz) * (-(r1.www)) + (r6.xyz);
    r1.w = (r2.w) * (c1.x);
    r1 = texCUBElod(s15, r1);
    r1.xyz = (r1.xyz) * (r1.xyz);
    r6.xyz = (r5.xyz) * (c1.yyy);
    r5.xyz = (r1.xyz) * (c1.xxx);
    r1 = tex3D(s11, v7.xyz);
    r1.xyz = (r1.xyz) * (r1.xyz);
    r3.xyz = (r3.www) * (r3.xyz) + (r6.xyz);
