// Mechanically reconstructed from 0x9C3B12A5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c27 = float4(2.0f, -1.0f, 0.0f, -0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r8.xy = lerp(r2.xy, r3.xy, r6.zz);
    r0 = tex2D(s8, v7.xy);
    r3 = (r0.wwww) * (-(c27.zzzy)) + (-(c27.wwwz));
    r4 = tex2D(s7, v1.xy);
    r1 = tex2D(s4, v7.zw);
    r6.w = (r1.w) * (v0.z);
    r2 = lerp(r4, r3, r6.zzzz);
    r3.xyz = lerp(r5.xyz, r1.xyz, r6.www);
    r7.xy = lerp(r8.xy, r6.xy, r6.ww);
    r5.xyz = lerp(c[23].xyw, r0.yyy, r6.zzz);
    r1 = tex2D(s9, v7.zw);
    ...
    r1.w = (-(r3.w)) + (-(c27.y));
    r13.xyz = lerp(r5.xyz, c[24].xyw, r6.www);
    r1.z = (r1.w) * (r1.w);
    r6.xyz = (r3.xyz) * (r3.xyz);
    r1.z = (r1.z) * (r1.z);
    r11.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c27.yyy));
    r1.z = (r1.w) * (r1.z);
    r12.xyz = (r0.xyz) * (r0.xyz);
    r1.w = dot(r7.xy, r7.xy) + (c27.z);
    ...
    r3.xy = (r3.xz) * (r8.xx);
    r1.w = dot(r9.xy, r7.xy) + (c27.z);
    r1.y = (r2.x) * (c4.w) + (-(r3.x));
    r2.w = (r3.z) * (-(r8.x)) + (r1.y);
    r5.xy = (r1.xz) * (r8.yy);
    r1.y = (r2.y) * (c4.w) + (-(r5.x));
    r1.x = dot(r9.xy, r9.xy) + (c27.z);
    r1.y = (r1.z) * (-(r8.y)) + (r1.y);
    r1.z = exp2(-(r1.x));
    r10.y = (r2.w) + (r2.w);
    r1.z = (r1.z) * (c3.x) + (c3.y);
    ...
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (-(c27.y)) : (-(c27.z)));
