// Mechanically reconstructed from 0x82ED96EF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.y = saturate(dot(r7.xyz, -(r5.xyz)));
    r1 = tex2D(s5, v0.xy);
    ...
    r5.w = (r5.w) * (r5.w);
    r1.w = (r1.w) * (r5.w);
    r5.xyz = (r1.xyz) * (-(r1.xyz)) + (c3.www);
    r0.w = (r4.w) * (r0.w);
    r5.xyz = (r1.www) * (r5.xyz);
    r0.w = (r3.w) * (r0.w);
    r6.xyz = (r1.xyz) * (r1.xyz) + (r5.xyz);
    r1 = tex2D(s0, v0.xy);
