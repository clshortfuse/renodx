// Mechanically reconstructed from 0x0C128688.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = (r2.zzz) * (c[8].xyz);
    r2.z = dot(c[9].yz, r2.xy) + (c[9].x);
