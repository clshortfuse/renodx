// Mechanically reconstructed from 0x09BC0ECA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = float4(((r4.w) >= 0.0f ? (r2.x) : (r5.x)), ((r4.w) >= 0.0f ? (r2.y) : (r5.y)), ((r4.w) >= 0.0f ? (r2.z) : (r5.z)), ((r4.w) >= 0.0f ? (r2.w) : (r5.w)));
    r5 = tex2D(s5, v6.zw);
    r6.xy = (r5.wy) * (c1.xy) + (c1.zw);
    r5 = (c2.xxxx) * (v8) + (c2.yyyy);
    r0.x = dot(r6.xy, r5.xy) + (c2.z);
    r0.y = dot(r6.xy, r5.zw) + (c2.z);
    r5 = tex2D(s3, v6.zw);
    r7.w = (r5.w) * (v0.z);
    r0.z = exp2(-(r0.z));
    r6.xy = lerp(r2.xy, r0.xy, r7.ww);
    r1.w = (r0.z) * (c12.x) + (c12.y);
    r1.y = dot(r6.xy, r6.xy) + (c2.z);
    r0 = (r0.wwww) * (c3.xxxy) + (c3.zzzx);
    r1.y = exp2(-(r1.y));
    r10.xy = lerp(r2.zw, c[24].xy, r7.ww);
    r3.w = (r1.y) * (c12.x) + (c12.y);
    r2 = tex2D(s14, v1.zw);
    r8.xy = (r2.xy) * (c4.xx);
    r2.w = (r1.w) * (r3.w);
    r3.xy = (r3.xz) * (r8.yy);
    r1.w = dot(r7.xy, r6.xy) + (c2.z);
    r1.y = (r2.y) * (c4.x) + (-(r3.x));
