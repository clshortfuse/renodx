// Mechanically reconstructed from 0x9C6167D2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s5, v7.xy);
    r5.w = (r2.w) * (v0.y) + (c3.w);
    r7.xy = float2(((r5.w) >= 0.0f ? (r1.x) : (r0.x)), ((r5.w) >= 0.0f ? (r1.y) : (r0.y)));
    r1 = tex2D(s8, v1.xy);
    r0 = tex2D(s9, v7.xy);
    r4 = tex2D(s6, v7.zw);
    r4.xyz = (r4.xyz) + (c3.yyy);
    r3.xyz = float3(((r5.w) >= 0.0f ? (r2.x) : (r3.x)), ((r5.w) >= 0.0f ? (r2.y) : (r3.y)), ((r5.w) >= 0.0f ? (r2.z) : (r3.z)));
