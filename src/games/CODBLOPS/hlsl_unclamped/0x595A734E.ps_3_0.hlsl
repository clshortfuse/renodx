// Mechanically reconstructed from 0x595A734E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xyz = (r7.xyz) * (r5.www) + (-(r11.xyz));
    r2.xyz = (r5.xyz) * (r2.xyz);
    r3.w = exp2(r13.y);
    r11.xyz = (r2.xyz) * (c2.zzz);
    r2 = tex2D(s0, v0.xy);
