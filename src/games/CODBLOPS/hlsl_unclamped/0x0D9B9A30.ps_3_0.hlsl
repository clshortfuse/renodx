// Mechanically reconstructed from 0x0D9B9A30.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.x = dot(r5.xy, r1.xy) + (c13.z);
    r6.y = dot(r5.xy, r1.zw) + (c13.z);
    r1 = tex2D(s4, v7.zw);
    r5.w = (r1.w) * (v7.y);
    r5.xy = (r0.yw) * (c4.xx) + (c4.yy);
    r7.xy = lerp(r8.xy, r6.xy, r5.ww);
    r0.w = dot(r5.xy, r5.xy) + (c13.z);
    r0.y = dot(r7.xy, r7.xy) + (c13.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c1.x) + (c1.y);
    r3.w = (r0.y) * (c1.x) + (c1.y);
    r1.w = lerp(r2.y, r4.w, c[8].w);
    r0.y = (r0.w) * (r3.w);
    r2 = tex2D(s14, v0.zw);
    r6.xy = (r2.xy) * (c2.ww);
    r0.w = dot(r5.xy, r7.xy) + (c13.z);
    r3.xy = (r3.xz) * (r6.yy);
