// Mechanically reconstructed from 0x2F7D8758.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s5, v7.xy);
    r3.w = (r0.w) * (v0.y) + (c3.w);
    r4.xyz = float3(((r3.w) >= 0.0f ? (r0.x) : (r1.x)), ((r3.w) >= 0.0f ? (r0.y) : (r1.y)), ((r3.w) >= 0.0f ? (r0.z) : (r1.z)));
    r0.xy = (v1.zw) * (-(c3.yw));
    r2 = tex2D(s13, r0.xy);
    r0.xy = (v1.zw) * (-(c3.yw)) + (-(c3.zw));
    r0 = tex2D(s13, r0.xy);
    r2.w = r0.y;
    r10.xy = float2(((r3.w) >= 0.0f ? (r3.x) : (r5.x)), ((r3.w) >= 0.0f ? (r3.y) : (r5.y)));
    r1.xy = (r2.yw) * (c12.yy) + (c12.zz);
    r0.y = dot(r10.xy, r10.xy) + (c3.z);
    r0.w = dot(r1.xy, r1.xy) + (c3.z);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r2.w = (r0.y) * (c4.x) + (c4.y);
    r0.y = (r0.w) * (c4.x) + (c4.y);
    r0.w = dot(r1.xy, r10.xy) + (c3.z);
    r0.y = (r2.w) * (r0.y);
    r1 = tex2D(s14, v1.zw);
    r3.xy = (r1.xy) * (c12.xx);
    ...
    r3.z = saturate(dot(r17.xyz, r2.xyz));
    r10.w = (r0.w) * (c4.w);
    ...
    r2.y = (r3.z) * (r2.y);
    r3.z = c3.y;
    r14.xyz = float3(((r3.w) >= 0.0f ? (-(r3.z)) : (c[32].x)), ((r3.w) >= 0.0f ? (-(r3.z)) : (c[32].y)), ((r3.w) >= 0.0f ? (-(r3.z)) : (c[32].w)));
