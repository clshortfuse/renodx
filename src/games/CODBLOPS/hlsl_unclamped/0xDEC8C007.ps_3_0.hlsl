// Mechanically reconstructed from 0xDEC8C007.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xy = (r1.ww) * (r3.xy) + (c[5].xy);
    r0.z = dot(r10.xyz, r9.xyz);
    r6.xyz = (r2.xyz) * (r11.yyy);
    r3.w = (r0.z) + (r0.z);
    r2 = tex2D(s2, v7.xy);
    ...
    r2.xyz = (r0.xyz) * (r5.xyz);
    r7.xyz = (v0.zzz) * (r4.xyz) + (c1.yyy);
    r5.xyz = (r2.xyz) * (r7.xyz);
    r4 = tex2D(s6, v8.xy);
    ...
    r3.xyz = (r2.xyz) * (r2.xyz) + (r5.xyz);
    r2.xyz = (r0.xyz) * (-(r7.xyz)) + (r1.xyz);
