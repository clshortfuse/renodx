// Mechanically reconstructed from 0xF7823575.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s4, v7.zw);
    r4.w = (r0.w) * (v0.z);
    r1.xy = (v1.zw) * (c11.xy) + (c11.zy);
    r1 = tex2D(s13, r1.xy);
    r3.xy = (v1.zw) * (-(c3.yz));
    r3 = tex2D(s13, r3.xy);
    r1.w = r3.y;
    r10.xy = lerp(r4.xy, r2.xy, r4.ww);
    r2.xy = (r1.wy) * (c12.xx) + (c12.yy);
    r1.w = dot(r10.xy, r10.xy) + (c4.x);
    r0.w = dot(r2.xy, r2.xy) + (c4.x);
    r1.w = exp2(-(r1.w));
    r0.w = exp2(-(r0.w));
    r3.w = (r1.w) * (c10.x) + (c10.y);
    r1.w = (r0.w) * (c10.x) + (c10.y);
    r0.w = dot(r2.xy, r10.xy) + (c4.x);
    r1.w = (r3.w) * (r1.w);
    r2 = tex2D(s14, v1.zw);
    r5.xy = (r2.xy) * (c10.ww);
    r4.z = saturate((r0.w) * (r1.w) + (r1.w));
    r4.xy = (r3.xz) * (r5.xx);
    r0.w = (r2.x) * (c10.w) + (-(r4.x));
    r1.xy = (r1.xz) * (r5.yy);
    r1.w = (r3.z) * (-(r5.x)) + (r0.w);
    r0.w = (r2.y) * (c10.w) + (-(r1.x));
    r0.w = (r1.z) * (-(r5.y)) + (r0.w);
    r7.y = (r1.w) + (r1.w);
    r3.y = (r0.w) + (r0.w);
    r3.xz = (r1.xy) * (c11.ww);
    ...
    r4.xyz = (r7.xyz) * (r3.www) + (r3.xyz);
    r8.xyz = (r1.xyz) * (r1.xyz);
    r1 = tex2D(s7, v7.zw);
    r0.x = c3.w;
    r5.xyz = float3(((r0.w) >= 0.0f ? (r0.x) : (c[8].x)), ((r0.w) >= 0.0f ? (r0.x) : (c[8].y)), ((r0.w) >= 0.0f ? (r0.x) : (c[8].w)));
