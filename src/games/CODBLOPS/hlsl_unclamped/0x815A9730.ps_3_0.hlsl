// Mechanically reconstructed from 0x815A9730.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = (v1.xy) * (c[8].xy);
    r2 = tex2D(s4, r2.xy);
    r4.xyz = (r2.xyz) + (c0.xxx);
    r2 = tex2D(s0, v1.xy);
    r2.xyz = saturate((r4.xyz) * (r2.www) + (r2.xyz));
