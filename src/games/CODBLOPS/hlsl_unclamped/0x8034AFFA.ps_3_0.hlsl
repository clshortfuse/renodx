// Mechanically reconstructed from 0x8034AFFA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = (v1.xy) + (c1.xx);
    r0.z = c1.y;
    r0.xy = (r2.xy) * (c[40].xx) + (r0.zz);
    r2.xy = (r2.xy) * (c[39].xx) + (r0.zz);
    r0 = tex2D(s6, r0.xy);
    ...
    r10.w = (r2.w) * (c3.y);
    r9.w = (r2.w) * (-(c3.y)) + (c3.z);
    r3.z = saturate(dot(r10.xyz, c[17].xyz));
    r6.w = (r3.w) * (r9.w) + (r10.w);
    r1.y = (r3.z) * (r9.w) + (r10.w);
    r12.w = (-(r3.w)) + (c2.x);
    r1.y = (r1.y) * (r6.w) + (c3.w);
    r1.y = 1.0f / (r1.y);
    r1.z = (-(r1.z)) + (c2.x);
