// Mechanically reconstructed from 0xFC635AEE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.x = dot(r4.xy, r1.xy) + (c12.z);
    r2.y = dot(r4.xy, r1.zw) + (c12.z);
    r1 = tex2D(s2, v6.zw);
    r4.w = (r1.w) * (v6.y);
