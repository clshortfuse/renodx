// Mechanically reconstructed from 0x161208D5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r0.w) * (c1.x);
    r0.xyz = (r0.xyz) * (c[11].www);
    r5.xyz = (r0.xyz) * (c[8].xyz);
    r7.xy = saturate((r8.xx) * (c[10].xy) + (c[10].zw));
    r4.w = dot(c[9].yz, r8.xy) + (c[9].x);
    r0.xy = (r7.xy) * (r7.xy);
