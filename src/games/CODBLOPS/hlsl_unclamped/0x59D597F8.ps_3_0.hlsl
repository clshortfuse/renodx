// Mechanically reconstructed from 0x59D597F8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.xyz = (r1.yyy) * (r0.xyz) + (r3.xyz);
    r5 = tex2D(s0, v1.xy);
    r6 = tex2D(s4, v7.xy);
    r0.xyz = (r6.xyz) + (c1.xxx);
    r3.xyz = (v0.yyy) * (r0.xyz) + (c1.yyy);
    r1.w = dot(v6.xyz, v6.xyz);
    r0.xyz = (r5.xyz) * (r3.xyz);
    r1.z = rsqrt(r1.w);
    r3.xyz = (r3.xyz) * (c1.zzz);
    r6.xyz = (v6.xyz) * (-(r1.zzz)) + (c[17].xyz);
    r0.xyz = float3(((r4.w) >= 0.0f ? (r4.x) : (r0.x)), ((r4.w) >= 0.0f ? (r4.y) : (r0.y)), ((r4.w) >= 0.0f ? (r4.z) : (r0.z)));
    ...
    r1.w = pow(abs(r5.x), r5.w);
    r1.x = (r1.x) * (r5.y);
    r1.w = (r3.w) * (r1.w);
    r5.xyz = (r2.xyz) * (r5.zzz) + (r3.xyz);
    r1.w = (r1.x) * (r1.w);
    r6.z = (-(r1.z)) + (c1.y);
