// Mechanically reconstructed from 0x4542F41E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r14.xyz = (v0.yyy) * (r1.xyz) + (c13.yyy);
    r1 = tex2D(s4, v7.zw);
    r3.xyz = (r1.xyz) + (c13.xxx);
    r1.xyz = (r14.xyz) * (c13.zzz);
    r13.xyz = (v0.zzz) * (r3.xyz) + (c13.yyy);
    r11.xyz = (r2.xyz) * (r0.yyy);
    r2.xyz = (r1.xyz) * (r13.xyz);
    r0 = tex2D(s5, v8.xy);
    r0.xyz = (r0.xyz) + (c13.xxx);
    r1.xyz = (-(v6.xyz)) + (c[20].xyz);
    r6.xyz = (v0.www) * (r0.xyz) + (c13.yyy);
    ...
    r1.x = dot(r3.xy, r3.xy) + (c13.w);
    r0.z = dot(r0.xy, r0.xy) + (c13.w);
    r1.x = exp2(-(r1.x));
    r0.z = exp2(-(r0.z));
    r1.x = (r1.x) * (c1.x) + (c1.y);
    r2.w = (r0.z) * (c1.x) + (c1.y);
    r0.z = dot(r0.xy, r3.xy) + (c13.w);
    r0.y = (r1.x) * (r2.w);
    r3 = tex2D(s14, v1.zw);
    r8.xy = (r3.xy) * (c2.ww);
