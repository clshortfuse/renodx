// Mechanically reconstructed from 0xA25CFE01.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xz = (r3.xy) * (c4.ww);
    r2.xyz = (r1.xyz) * (r1.www) + (-(r15.xyz));
    r5.xyz = normalize(r2.xyz);
    r9.xyz = (r1.xyz) * (r1.www);
    r2.xyz = (r10.xyz) * (r0.www) + (r0.xyz);
    r0.w = saturate(dot(r5.xyz, r9.xyz));
    r0.z = c1.x;
    r3.xyz = (r0.zzz) + (-(c[29].xyw));
    r1.w = (-(r0.w)) + (c1.x);
    r1.z = (r1.w) * (r1.w);
    r0 = v2;
    ...
    r3.w = saturate(dot(r14.xyz, r5.xyz));
    r0.xyz = (v0.zzz) * (r0.xyz) + (c1.xxx);
    r1 = tex2D(s7, v1.xy);
    ...
    r1.z = (r1.z) * (r10.w) + (c12.x);
    r17.xy = (r1.ww) * (c16.xy) + (c16.zw);
    r1.y = 1.0f / (r1.z);
    r9.w = exp2(r17.y);
    r1.z = pow(abs(r3.w), r9.w);
    r7.w = (r9.w) * (c12.y) + (c12.z);
    r4.w = (r2.w) * (r1.y);
    r3.w = (r1.z) * (r7.w);
    r1.xyz = (r11.xyz) * (r6.www) + (r12.xyz);
    r3.w = (r4.w) * (r3.w);
