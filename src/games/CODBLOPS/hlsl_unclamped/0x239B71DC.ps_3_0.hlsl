// Mechanically reconstructed from 0x239B71DC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    float4 v3 = input.v3;
    float4 v4 = input.v4;
    const float4 c0 = float4(-1.0f, 1.0f, 0.25f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = tex2D(s2, r1.xy);
    r1.xy = (v2.ww) * (c[27].xy) + (v2.xy);
    r1.zw = v2.zw;
    r1 = tex2Dproj(s1, r1);
    r2.xy = (v2.ww) * (-(c[27].xy)) + (v2.xy);
    r2.zw = v2.zw;
    r2 = tex2Dproj(s1, r2);
    r1.y = r2.x;
    r2.xy = (v2.ww) * (c[27].zw) + (v2.xy);
    r2.zw = v2.zw;
    r2 = tex2Dproj(s1, r2);
    r1.z = r2.x;
    r2.xy = (v2.ww) * (-(c[27].zw)) + (v2.xy);
