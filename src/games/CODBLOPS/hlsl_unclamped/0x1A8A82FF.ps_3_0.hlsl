// Mechanically reconstructed from 0x1A8A82FF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = dot(r1.xyz, c[24].xyz);
    r3.x = 1.0f / (r2.z);
    r1.w = saturate((r1.w) * (c[25].x) + (c[25].y));
    r6.w = saturate(dot(r1.xyz, r7.xyz));
    r1.w = (r1.w) * (c[25].w);
    r4.w = lerp(r0.w, r2.w, r1.w);
