// Mechanically reconstructed from 0x2DD8EBF1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s4, v7.zw);
    r0.xyz = (r2.xyz) + (c15.yyy);
    r2.w = lerp(r1.w, r0.w, r4.w);
    r2.xyz = (v0.zzz) * (r0.xyz) + (c15.www);
    r0 = tex2D(s5, v8.xy);
    ...
    r0.w = (r0.w) * (c3.y) + (c3.z);
    r1.w = (r0.y) * (c3.y) + (c3.z);
    r0.y = dot(r1.xy, r5.xy) + (c15.z);
    r3.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v1.zw);
    r7.xy = (r1.xy) * (c10.xx);
    r1.w = saturate((r0.y) * (r3.w) + (r3.w));
    r3.xy = (r3.xz) * (r7.xx);
    r0.y = (r1.x) * (c10.x) + (-(r3.x));
    r6.xy = (r0.xz) * (r7.yy);
    r0.y = (r3.z) * (-(r7.x)) + (r0.y);
