// Mechanically reconstructed from 0x62EE50B4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s7, v7.zw);
    r0 = tex2D(s4, v7.xy);
    r4.xyz = (r0.xyz) + (c14.xxx);
    r0 = v2;
    r2.xyz = (r10.xxx) * (v5.xyz) + (r0.xyz);
    r0.xyz = (v0.yyy) * (r4.xyz) + (c14.yyy);
    r2.xyz = (r10.yyy) * (v4.xyz) + (r2.xyz);
    r10.xyz = normalize(r2.xyz);
    r12.xyz = normalize(v6.xyz);
    r4.xyz = (r0.xyz) * (c14.zzz);
