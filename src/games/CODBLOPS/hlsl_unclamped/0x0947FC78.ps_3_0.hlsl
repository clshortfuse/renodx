// Mechanically reconstructed from 0x0947FC78.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xy = float2(((r6.w) >= 0.0f ? (r4.x) : (r5.x)), ((r6.w) >= 0.0f ? (r4.y) : (r5.y)));
    ...
    r0.xy = (r5.yw) * (c12.xx) + (c12.yy);
    r1.w = dot(r10.xy, r10.xy) + (c1.w);
    r0.z = dot(r0.xy, r0.xy) + (c1.w);
    r1.w = exp2(-(r1.w));
    r0.z = exp2(-(r0.z));
    r3.x = (r1.w) * (c4.x) + (c4.y);
    r1.w = (r0.z) * (c4.x) + (c4.y);
    r0.z = dot(r0.xy, r10.xy) + (c1.w);
    r1.w = (r3.x) * (r1.w);
    r4 = tex2D(s14, v0.zw);
    r0.xy = (r4.xy) * (c4.ww);
    ...
    r3.z = (r8.w) * (r1.z) + (r1.y);
    r3.w = (r4.w) * (r1.z) + (r1.y);
    r1.xyz = (r9.xyz) * (r3.xxx) + (r0.xyz);
    r0.z = (r3.w) * (r3.z) + (c13.x);
    r0.x = 1.0f / (r0.z);
    ...
    r3.w = (r0.y) * (r0.z);
    r16.yw = c1.yw;
    r0.xyz = float3(((r7.w) >= 0.0f ? (c[20].x) : (r16.w)), ((r7.w) >= 0.0f ? (c[20].y) : (r16.w)), ((r7.w) >= 0.0f ? (c[20].w) : (r16.w)));
    r3.w = (r3.z) * (r3.w);
    r13.xyz = float3(((r6.w) >= 0.0f ? (r3.y) : (r0.x)), ((r6.w) >= 0.0f ? (r3.y) : (r0.y)), ((r6.w) >= 0.0f ? (r3.y) : (r0.z)));
