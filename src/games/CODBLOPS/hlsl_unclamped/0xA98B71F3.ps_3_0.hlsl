// Mechanically reconstructed from 0xA98B71F3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.xy = c[21].xy;
    r0.xyz = (r9.xxx) * (c[18].xyz);
    r7.xyz = (r1.xyz) * (c1.yyy);
    r6.xyz = (r7.www) * (r0.xyz);
    if ((c1.z) >= (v6.w))
    {
        r1 = (v6.xyzx) * (c14.xxxy);
        r0 = (r1) + (-(c12.xyzz));
