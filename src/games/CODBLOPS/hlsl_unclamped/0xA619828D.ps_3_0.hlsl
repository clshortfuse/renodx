// Mechanically reconstructed from 0xA619828D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(-1.0f, 1.0f, 0.200000003f, 0.25f);
    ...
    r4.w = pow(abs(r3.w), r2.w);
    r3.w = (r2.w) * (c3.z) + (c3.w);
    r2.w = (-(r0.w)) + (c2.y);
    r0 = tex2D(s4, v6.zw);
    r0.xyz = (r0.xyz) + (c2.xxx);
    r0.w = (r2.w) * (r2.w);
    r5.xyz = (v6.yyy) * (r0.xyz) + (c2.yyy);
    r0.w = (r0.w) * (r0.w);
    r0.xyz = (r5.xyz) * (c2.zzz);
    r2.w = (r2.w) * (r0.w);
