// Mechanically reconstructed from 0x948BE7DC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = float4(((r8.w) >= 0.0f ? (r3.x) : (c1.z)), ((r8.w) >= 0.0f ? (r3.y) : (c1.z)), ((r8.w) >= 0.0f ? (r3.z) : (c1.z)), ((r8.w) >= 0.0f ? (r3.w) : (c1.y)));
    ...
    r2.x = saturate(dot(r1.xyz, r9.xyz));
    r2.y = saturate(dot(r10.xyz, r1.xyz));
    r1.z = (-(r2.x)) + (c1.y);
    r1.x = pow(abs(r2.y), r5.w);
    r1.y = (r1.z) * (r1.z);
    r1.x = (r2.z) * (r1.x);
    r1.y = (r1.y) * (r1.y);
    r5.w = (r2.w) * (r1.x);
