// Mechanically reconstructed from 0x23C487F7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c13 = float4(0.00249999994f, -2.0f, 3.0f, 1.0f);
    ...
    r7.xyz = (r0.xxx) * (r2.xyz) + (c[35].yzx);
    r2.w = log2(abs(r1.w));
    r0.x = (r2.w) * (c13.x) + (r7.y);
    r2.z = (-abs(r1.x)) + (c16.x);
    r1.w = frac(r0.x);
    r1.z = max(c16.y, r2.z);
    r0.x = (r0.x) + (-(r1.w));
    ...
    r5.xy = saturate((r7.xx) * (c[23].xy) + (c[23].zw));
    r3.xy = (r5.xy) * (r5.xy);
    r5.xy = (r5.xy) * (c13.yy) + (c13.zz);
    r1.w = dot(c[22].yz, r7.xy) + (c[22].x);
    r5.xy = (r3.xy) * (r5.xy);
    r1.xyz = (r1.xyz) * (c[32].xxx) + (-(r2.xyz));
    r1.w = (r1.w) * (r5.x);
    ...
    r1.w = (r1.x) * (c14.w) + (-(r2.x));
    r12.xz = (r2.xy) * (c15.xx);
    r1.w = (r2.z) * (-(r7.x)) + (r1.w);
    r12.y = (r1.w) + (r1.w);
    r5.xy = (r5.xz) * (r7.yy);
    r5.w = (r1.y) * (c14.w) + (-(r5.x));
    r4 = (-(v5.yyyy)) + (c[6]);
    r1 = (r4) * (r4);
    r3 = (-(v5.xxxx)) + (c[5]);
    r1 = (r3) * (r3) + (r1);
