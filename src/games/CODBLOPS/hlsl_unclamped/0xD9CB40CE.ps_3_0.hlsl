// Mechanically reconstructed from 0xD9CB40CE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xyz = (r2.xyz) * (-(r2.xyz)) + (c3.xxx);
    r1.w = (r8.w) * (r1.w);
    r2.xyz = (r7.xyz) * (r1.xxx) + (r8.xyz);
    r9.w = (-(r1.z)) + (c3.x);
    r2.xyz = (r1.www) * (r2.xyz);
    r8.w = 1.0f / (r12.x);
    r2.xyz = (r2.xyz) * (c[29].www);
    r1.w = (r2.w) * (c1.w);
