// Mechanically reconstructed from 0xA07E1179.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = dot(r3.xy, r0.zw) + (c3.w);
    r1 = tex2D(s3, v7.xy);
    r5.z = (r1.w) * (v0.y);
    r8.x = dot(r3.xy, r0.xy) + (c3.w);
    r9.xy = (r5.zz) * (-(r2.xy)) + (r2.xy);
    r0 = tex2D(s6, v1.xy);
    r2 = tex2D(s0, v1.xy);
    r7.xyz = lerp(r2.xyz, r1.xyz, r5.zzz);
    r6.xyz = lerp(r0.yyy, c[8].xyw, r5.zzz);
    r3.w = -(r0.w);
    r1 = tex2D(s8, v7.zw);
    r3.xyz = c3.zzz;
    r2 = tex2D(s7, v7.xy);
    r2 = (r3) + (r2);
    r3 = (r0.wwww) * (-(c3.wwwy)) + (-(c3.zzzw));
    r0 = tex2D(s4, v7.zw);
    r1.z = (r0.w) * (v0.z);
    r3 = (r5.zzzz) * (r2) + (r3);
    r5.xyz = lerp(r7.xyz, r0.xyz, r1.zzz);
    r12.xy = lerp(r9.xy, r8.xy, r1.zz);
    r2 = (r1.wwww) * (-(c3.wwwy)) + (-(c3.zzzw));
    r0 = lerp(r3, r2, r1.zzzz);
    r11.xyz = lerp(r6.xyz, r1.yyy, r1.zzz);
    ...
    r1.y = dot(r12.xy, r12.xy) + (c3.w);
    r1.w = dot(r2.xy, r2.xy) + (c3.w);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r3.w = (r1.y) * (c4.x) + (c4.y);
    r1.y = (r1.w) * (c4.x) + (c4.y);
    r1.w = dot(r2.xy, r12.xy) + (c3.w);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r6.xy = (r2.xy) * (c10.ww);
