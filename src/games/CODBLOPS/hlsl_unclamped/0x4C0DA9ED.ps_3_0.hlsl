// Mechanically reconstructed from 0x4C0DA9ED.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = dot(r4.xy, r2.xy) + (c2.z);
    r0.y = dot(r4.xy, r2.zw) + (c2.z);
    r4 = tex2D(s2, v6.xy);
    r4.w = (r4.w) * (v0.y) + (c2.w);
    r2 = tex2D(s6, v1.xy);
    r3.zw = r2.yy;
