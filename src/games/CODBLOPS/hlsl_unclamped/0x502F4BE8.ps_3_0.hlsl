// Mechanically reconstructed from 0x502F4BE8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.y = (r0.w) + (r0.w);
    r0 = tex2D(s7, v6.xy);
    r1.xy = lerp(c[23].xy, r0.yy, r7.ww);
    r0 = (r0.wwww) * (-(c4.zzzy)) + (-(c4.wwwz));
    r8.xy = lerp(r1.xy, c[24].xy, r4.ww);
    r1 = tex2D(s6, v1.xy);
    ...
    r10.xyz = (v0.www) * (r2.xyz) + (-(c4.yyy));
    r1.w = 1.0f / (r1.w);
    r1.xyz = (r1.xyz) * (r10.xyz);
    r0.w = (r0.w) * (r1.w);
    r2.xyz = (r1.xyz) * (-(r1.xyz)) + (-(c4.yyy));
    ...
    r0 = (r2) * (r2) + (r0);
    r1 = (-(v5.zzzz)) + (c[7]);
    r11.xyz = lerp(r6.xyz, r5.xyz, r7.www);
    r0 = (r1) * (r1) + (r0);
    r5.xyz = lerp(r11.xyz, r4.xyz, r4.www);
    r4.x = rsqrt(r0.x);
    r4.y = rsqrt(r0.y);
    r4.z = rsqrt(r0.z);
    r4.w = rsqrt(r0.w);
