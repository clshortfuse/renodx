// Mechanically reconstructed from 0xEC567353.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c26 = float4(2.0f, -1.0f, 1.0f, 0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = (c26.xxxx) * (v8) + (c26.yyyy);
    r6.y = dot(r1.xy, r0.zw) + (c3.x);
    r6.x = dot(r1.xy, r0.xy) + (c3.x);
    r1 = tex2D(s6, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r0.xyz = (r0.xyz) + (c26.yyy);
    r2.xyz = (v0.yyy) * (r0.xyz) + (c26.zzz);
    r3.w = r1.w;
    r3.xyz = (r2.xyz) * (c26.www);
    r0 = tex2D(s0, v1.xy);
    ...
    r11.xyz = (r0.xyz) * (-(r0.xyz)) + (c26.zzz);
    r12.xyz = (r0.xyz) * (r0.xyz);
    r7.xy = float2(((r1.z) >= 0.0f ? (r6.x) : (r7.x)), ((r1.z) >= 0.0f ? (r6.y) : (r7.y)));
    r0.xyz = (r11.xyz) * (r4.www) + (r12.xyz);
    r6.xyz = (r2.xyz) * (r2.xyz);
    r1.w = dot(r7.xy, r7.xy) + (c3.x);
    r1.x = (r0.w) * (-(c4.y)) + (c4.z);
    r1.w = exp2(-(r1.w));
    r5.w = (r1.w) * (c3.z) + (c3.w);
    r2.xy = (v1.zw) * (c4.zw);
    ...
    r4.xy = (r4.xz) * (r9.xx);
    r1.w = dot(r10.xy, r7.xy) + (c3.x);
    r2.w = (r3.x) * (c12.w) + (-(r4.x));
    r2.y = (r4.z) * (-(r9.x)) + (r2.w);
    r8.xy = (r2.xz) * (r9.yy);
    r2.x = (r3.y) * (c12.w) + (-(r8.x));
    r2.w = dot(r10.xy, r10.xy) + (c3.x);
    r2.z = (r2.z) * (-(r9.y)) + (r2.x);
    r2.w = exp2(-(r2.w));
    r10.y = (r2.y) + (r2.y);
    r2.w = (r2.w) * (c3.z) + (c3.w);
    ...
    r1.x = (r1.x) * (r3.z) + (c13.z);
    r1.w = (r1.w) * (c15.x) + (c15.y);
    r1.x = 1.0f / (r1.x);
    r1.w = (r3.w) * (r1.w);
    r1.x = (r2.w) * (r1.x);
    r2.xyz = (r10.xyz) * (r5.www) + (r2.xyz);
    r1.w = (r1.w) * (r1.x);
    r13.xyz = float3(((r1.z) >= 0.0f ? (c[23].x) : (r1.y)), ((r1.z) >= 0.0f ? (c[23].y) : (r1.y)), ((r1.z) >= 0.0f ? (c[23].w) : (r1.y)));
    r0.xyz = (r0.xyz) * (r1.www);
    r14.xyz = (r2.xyz) * (r13.yyy);
    r15.xyz = (r13.zzz) * (r0.xyz);
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c12.x) : (c12.z));
