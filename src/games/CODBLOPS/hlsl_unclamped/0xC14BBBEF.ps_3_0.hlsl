// Mechanically reconstructed from 0xC14BBBEF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.w = (r0.w) * (v0.w) + (c1.x);
    r3 = (-(v6.zzzz)) + (c[8]);
    r7.xyz = float3(((r7.w) >= 0.0f ? (r2.x) : (c1.z)), ((r7.w) >= 0.0f ? (r2.y) : (c1.z)), ((r7.w) >= 0.0f ? (r2.z) : (c1.z)));
    r2 = (r3) * (r3) + (r1);
    r1 = v2;
    ...
    r3.w = saturate(dot(c[17].xyz, r8.xyz));
