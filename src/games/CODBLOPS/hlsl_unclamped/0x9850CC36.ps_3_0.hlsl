// Mechanically reconstructed from 0x9850CC36.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s5, v6.zw);
    r2 = (r2) + (c1.yyyz);
    r0.w = (r10.w) * (r2.w) + (c1.x);
    r0.z = dot(v5.xyz, v5.xyz);
    r2.xyz = (r10.www) * (r2.xyz);
    r5.w = rsqrt(r0.z);
    r5.y = (r0.w) * (c2.z);
    r12.xyz = (r5.www) * (v5.xyz);
    r4.w = (r0.w) * (-(c14.z)) + (c14.w);
    r0.z = saturate(dot(r10.xyz, -(r12.xyz)));
    r2.w = (r0.x) * (r4.w) + (r5.y);
    r3.w = (r0.z) * (r4.w) + (r5.y);
    r8.xyz = (v5.xyz) * (-(r5.www)) + (c[17].xyz);
    r2.w = (r2.w) * (r3.w) + (c4.x);
    r2.w = 1.0f / (r2.w);
    r7.xyz = normalize(r8.xyz);
    r7.w = (r0.x) * (r2.w);
    r5.w = saturate(dot(r10.xyz, r7.xyz));
    r0.x = saturate(dot(r7.xyz, c[17].xyz));
    r14.xy = (r0.ww) * (c12.xy) + (c12.zw);
    r6.w = exp2(r14.y);
    r2.w = (-(r0.x)) + (c1.x);
    r0.x = pow(abs(r5.w), r6.w);
    r7.z = (r2.w) * (r2.w);
    r5.w = (r6.w) * (c4.y) + (c4.z);
    r7.z = (r7.z) * (r7.z);
    r0.x = (r0.x) * (r5.w);
