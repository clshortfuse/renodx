// Mechanically reconstructed from 0x298E6626.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = (r0.w) * (c14.z);
    r1.x = frac(r1.x);
    r1.x = (r0.w) * (c14.z) + (-(r1.x));
    r1.y = (r1.x) * (c14.w) + (v3.y);
    r1.x = c13.w;
    r1 = tex2D(s5, r1.xy);
    r1.x = (r1.x) * (-(c15.x)) + (v3.x);
    r1.x = (r1.x) * (c15.y) + (-(v3.x));
    r1.x = (c[38].x) * (r1.x) + (v3.x);
    r1.z = frac(abs(v3.y));
    r1.y = ((v3.y) >= 0.0f ? (r1.z) : (-(r1.z)));
    r1.z = ((r1.x) >= 0.0f ? (c0.x) : (c0.z));
    r1.w = (-(r1.x)) + (c0.z);
    ...
    r1.xyz = float3(((-(r1.z)) >= 0.0f ? (r1.x) : (c0.x)), ((-(r1.z)) >= 0.0f ? (r1.y) : (c0.x)), ((-(r1.z)) >= 0.0f ? (r1.w) : (c0.x)));
    r1.w = abs(c[30].w);
    r1.w = frac(r1.w);
    r2.y = ((c[30].w) >= 0.0f ? (r1.w) : (-(r1.w)));
    r2.x = c0.x;
    r2 = tex2D(s5, r2.xy);
    ...
    r1.x = pow(abs(r0.w), c[42].x);
    r1.z = c0.z;
    r0.w = (r1.x) * (-(c[41].x)) + (r1.z);
    r1.xyz = lerp(c[40].xyz, r3.xyz, r0.www);
