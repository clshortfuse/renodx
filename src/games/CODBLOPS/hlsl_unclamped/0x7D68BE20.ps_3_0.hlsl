// Mechanically reconstructed from 0x7D68BE20.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xyz = float3(((r4.w) >= 0.0f ? (r0.y) : (c[23].x)), ((r4.w) >= 0.0f ? (r0.y) : (c[23].y)), ((r4.w) >= 0.0f ? (r0.y) : (c[23].w)));
