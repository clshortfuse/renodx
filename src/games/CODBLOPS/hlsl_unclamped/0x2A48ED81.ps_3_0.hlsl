// Mechanically reconstructed from 0x2A48ED81.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = (r0.z) + (r0.z);
    r11.yz = c1.yz;
    r1.xyz = float3(((r3.w) >= 0.0f ? (r11.y) : (c[20].x)), ((r3.w) >= 0.0f ? (r11.z) : (c[20].y)), ((r3.w) >= 0.0f ? (r11.y) : (c[20].w)));
    r2 = tex2D(s3, v7.zw);
    r2.w = (r2.w) * (v0.z) + (c1.x);
    r0.xyz = (r8.xyz) * (r0.www) + (r4.xyz);
    r7.xyz = float3(((r2.w) >= 0.0f ? (c1.y) : (r1.x)), ((r2.w) >= 0.0f ? (c1.z) : (r1.y)), ((r2.w) >= 0.0f ? (c1.y) : (r1.z)));
