// Mechanically reconstructed from 0xD09C0D24.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s6, r1.xy);
    r4 = tex2D(s4, v4.xy);
    r1.xzw = (r4.xyz) * (c4.www) + (-(r3.xyz));
    r1.xyz = (r1.yyy) * (r1.xzw) + (r3.xyz);
    r0.xyz = (r0.xyz) * (r1.xyz);
    r1.xyz = max(r0.xyz, c1.yyy);
    r0.xyz = (r1.xyz) * (c13.xxx);
    r0.w = (-(r0.w)) + (c1.x);
    r3.xyz = saturate((r0.www) * (c13.yzw));
    r0.w = pow(abs(r3.x), c14.x);
    r2.xyz = (r1.xyz) * (-(c13.xxx)) + (r2.xyz);
    r0.xyz = (r0.www) * (r2.xyz) + (r0.xyz);
    r2 = tex2D(s8, v4.xy);
    r0.w = saturate((r2.x) * (-(c4.y)));
    r1.w = c[7].w;
    r2.xy = (r1.ww) * (c[25].xy);
    r2.xy = (r2.xy) * (c[24].xx);
    ...
    r0.w = pow(abs(r3.y), c14.y);
    r3.xyw = lerp(r2.xyz, r0.xyz, r0.www);
    r0.x = pow(abs(r3.z), c14.z);
