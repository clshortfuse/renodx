// Mechanically reconstructed from 0xF9621B65.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    float4 v5 = input.v5;
    float4 v6 = input.v6;
    const float4 c0 = float4(-0.5f, 0.5f, 1e-15f, 1.0f);
    ...
    r1.w = (r1.w) * (c2.x);
    r6.z = max(abs(r2.y), abs(r2.z));
    r6.w = exp2(r1.w);
    r1.w = max(abs(r2.x), r6.z);
    r1.w = 1.0f / (r1.w);
