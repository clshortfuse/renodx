// Mechanically reconstructed from 0x82981DA2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s5, v7.xy);
    r6.w = (r0.w) * (v0.y) + (c3.w);
    r5.xy = float2(((r6.w) >= 0.0f ? (r1.x) : (r3.x)), ((r6.w) >= 0.0f ? (r1.y) : (r3.y)));
    ...
    r3.xyz = float3(((r6.w) >= 0.0f ? (r0.x) : (r1.x)), ((r6.w) >= 0.0f ? (r0.y) : (r1.y)), ((r6.w) >= 0.0f ? (r0.z) : (r1.z)));
    r1 = tex2D(s6, v7.zw);
    r5.w = (r1.w) * (v0.z) + (c3.w);
    r0 = tex2D(s11, v7.zw);
    r0 = float4(((r5.w) >= 0.0f ? (r0.x) : (r2.x)), ((r5.w) >= 0.0f ? (r0.y) : (r2.y)), ((r5.w) >= 0.0f ? (r0.z) : (r2.z)), ((r5.w) >= 0.0f ? (r0.w) : (r2.w)));
    r1.xyz = float3(((r5.w) >= 0.0f ? (r1.x) : (r3.x)), ((r5.w) >= 0.0f ? (r1.y) : (r3.y)), ((r5.w) >= 0.0f ? (r1.z) : (r3.z)));
    r7.xy = float2(((r5.w) >= 0.0f ? (r4.x) : (r5.x)), ((r5.w) >= 0.0f ? (r4.y) : (r5.y)));
    r5.xyz = (r1.xyz) * (r1.xyz);
    r11.w = (r0.w) * (-(c15.x)) + (c15.y);
    ...
    r1.w = (-(r1.w)) + (-(c3.y));
    r4.xyw = c[40].xyw;
    r4.xyz = float3(((r6.w) >= 0.0f ? (r4.x) : (c[39].x)), ((r6.w) >= 0.0f ? (r4.y) : (c[39].y)), ((r6.w) >= 0.0f ? (r4.w) : (c[39].w)));
    r3.w = (r1.w) * (r1.w);
    r13.xyz = float3(((r5.w) >= 0.0f ? (c[41].x) : (r4.x)), ((r5.w) >= 0.0f ? (c[41].y) : (r4.y)), ((r5.w) >= 0.0f ? (c[41].w) : (r4.z)));
    r3.w = (r3.w) * (r3.w);
    r12.xyz = (r3.xyz) * (r13.yyy);
    r1.w = (r1.w) * (r3.w);
