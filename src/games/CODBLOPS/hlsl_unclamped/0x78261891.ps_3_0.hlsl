// Mechanically reconstructed from 0x78261891.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.z = saturate(dot(r5.xyz, r3.xyz));
    r3.w = saturate(dot(r5.xyz, r0.xyz));
    r0.z = pow(abs(r3.z), c3.x);
    ...
    r3.xyz = (r2.xyz) * (c[40].xxx) + (r3.xyz);
    r2.xy = (vPos.xy) * (c[38].zw);
    r2 = tex2D(s2, r2.xy);
    r2.w = (abs(r2.x)) + (-(v1.z));
