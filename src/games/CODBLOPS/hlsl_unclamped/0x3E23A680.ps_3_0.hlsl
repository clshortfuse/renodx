// Mechanically reconstructed from 0x3E23A680.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = rsqrt(r0.w);
    r13.xyz = (r10.www) * (v6.xyz);
    r2.xyz = lerp(r0.xyz, c1.xxx, r1.xxx);
    r0.xyz = (r5.xyz) * (r0.www) + (-(r13.xyz));
    r14.xyz = normalize(r0.xyz);
    r17.xyz = (r5.xyz) * (r0.www);
    ...
    r4.xyz = (v6.xyz) * (-(r10.www)) + (c[17].xyz);
