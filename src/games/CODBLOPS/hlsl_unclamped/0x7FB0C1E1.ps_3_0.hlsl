// Mechanically reconstructed from 0x7FB0C1E1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = float2(((r2.w) >= 0.0f ? (r2.x) : (c1.z)), ((r2.w) >= 0.0f ? (r2.y) : (c1.z)));
    ...
    r5.w = (r5.w) * (r3.w) + (r7.w);
    r3.w = (r2.w) * (r3.w) + (r7.w);
    r8.xyz = (r2.xyz) * (r6.www) + (-(r5.xyz));
    r3.w = (r3.w) * (r5.w) + (c2.x);
    r2.xyz = (abs(r4.www)) * (c[6].xyz);
    r3.w = 1.0f / (r3.w);
    r3.w = (r2.w) * (r3.w);
