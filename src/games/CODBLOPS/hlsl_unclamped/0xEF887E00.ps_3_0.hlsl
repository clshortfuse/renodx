// Mechanically reconstructed from 0xEF887E00.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(-0.200000003f, 0.200000003f, 0.797884583f, 1.0f);
    ...
    r0.x = dot(r4.xy, r1.xy) + (c1.z);
    r0.y = dot(r4.xy, r1.zw) + (c1.z);
    r1 = tex2D(s3, v6.xy);
    r4.w = (r1.w) * (v0.y) + (c1.w);
