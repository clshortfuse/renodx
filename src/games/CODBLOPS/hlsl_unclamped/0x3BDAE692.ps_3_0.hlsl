// Mechanically reconstructed from 0x3BDAE692.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = dot(r7.xy, r7.xy) + (c1.x);
    r2.w = dot(r3.xy, r3.xy) + (c1.x);
    r1.x = exp2(-(r1.x));
    r2.w = exp2(-(r2.w));
    r1.x = (r1.x) * (c1.y) + (c1.z);
    r2.y = (r2.w) * (c1.y) + (c1.z);
    r2.w = dot(r3.xy, r7.xy) + (c1.x);
    r2.y = (r1.x) * (r2.y);
    r3 = tex2D(s14, v1.zw);
    r8.xy = (r3.xy) * (c3.ww);
