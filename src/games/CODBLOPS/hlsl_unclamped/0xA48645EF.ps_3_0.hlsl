// Mechanically reconstructed from 0xA48645EF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s5, v7.zw);
    r4.w = (r0.w) * (v7.y);
    r4.xy = (r4.ww) * (-(r1.xy)) + (r1.xy);
    r1 = tex2D(s6, v0.xy);
    r2 = tex2D(s0, v0.xy);
    r3.xyz = lerp(r2.xyz, r0.xyz, r4.www);
    r0 = tex2D(s7, v7.zw);
    r13.xy = lerp(r1.wy, r0.wy, r4.ww);
    r8.xyz = (r3.xyz) * (r3.xyz);
    r8.w = (r13.x) * (-(c12.y)) + (c12.x);
    r2.w = dot(r4.xy, r4.xy) + (c1.x);
    ...
    r2.z = (r1.y) * (r1.y);
    r4.z = (r5.w) * (c13.x) + (c13.y);
    r2.z = (r2.z) * (r2.z);
    r1.z = (r1.z) * (r4.z);
    r1.y = (r1.y) * (r2.z);
    r1.z = (r1.x) * (r1.z);
    r1.x = (r1.y) * (c12.z) + (c12.w);
    r1.y = exp2(-(r2.w));
    r1.z = (r1.z) * (r1.x);
    r4.w = (r1.y) * (c1.y) + (c1.z);
