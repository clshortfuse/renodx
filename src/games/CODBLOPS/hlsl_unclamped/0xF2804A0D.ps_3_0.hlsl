// Mechanically reconstructed from 0xF2804A0D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xyz = float3(((r4.w) >= 0.0f ? (r1.x) : (r3.x)), ((r4.w) >= 0.0f ? (r1.y) : (r3.y)), ((r4.w) >= 0.0f ? (r1.z) : (r3.z)));
    ...
    r1.xyz = (r10.xyz) * (r7.www) + (r1.xyz);
    r3.w = (r0.w) * (-(c14.x)) + (c14.y);
    r2.xyz = v2.xyz;
    r3.xyz = (r7.xxx) * (v4.xyz) + (r2.xyz);
    r2.xyw = c[23].xyw;
    r2.xyz = (-(r2.xyw)) + (c[24].xyw);
    ...
    r3.w = (r3.w) * (r3.y) + (c12.w);
    r1.w = (r1.w) * (c14.z) + (c14.w);
    r3.w = 1.0f / (r3.w);
    r1.w = (r3.z) * (r1.w);
    r3.w = (r2.w) * (r3.w);
    r2.xyz = (r5.www) * (r2.xyz) + (c[23].xyw);
    r1.w = (r1.w) * (r3.w);
    r13.xyz = float3(((r4.w) >= 0.0f ? (c[25].x) : (r2.x)), ((r4.w) >= 0.0f ? (c[25].y) : (r2.y)), ((r4.w) >= 0.0f ? (c[25].w) : (r2.z)));
