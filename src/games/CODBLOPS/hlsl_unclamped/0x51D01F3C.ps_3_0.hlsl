// Mechanically reconstructed from 0x51D01F3C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xyz = (r11.xyz) * (r5.www) + (-(r12.xyz));
    r2.xyz = (r6.xyz) * (r2.xyz);
    r3.w = exp2(r14.y);
    r3.xyz = (r2.xyz) * (c2.zzz);
    r2 = tex2D(s0, v0.xy);
    r6.xyz = lerp(r2.xyz, r0.xyz, r8.www);
