// Mechanically reconstructed from 0xDD047FFA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r0.w) * (c1.z) + (c1.w);
    r10.xyz = lerp(r0.yyy, c[36].xyw, r6.www);
    r1.xy = (v0.zw) * (c3.yw);
    r5 = tex2D(s13, r1.xy);
    ...
    r4 = tex2D(s14, v0.zw);
    r8.xy = (r4.xy) * (c4.ww);
    r3.xy = (r5.yw) * (c12.xx) + (c12.yy);
    r5.xy = (r5.xz) * (r8.xx);
    r0.w = dot(r3.xy, r6.xy) + (c1.y);
    r0.z = (r4.x) * (c4.w) + (-(r5.x));
    r1.w = (r5.z) * (-(r8.x)) + (r0.z);
    ...
    r4.xyz = (r8.xyz) * (r2.www) + (r3.xyz);
    r3.xyz = (r1.xyz) * (r0.zzz) + (-(r16.xyz));
    r18.xyz = (r10.yyy) * (r4.xyz);
    r15.xyz = normalize(r3.xyz);
    r17.xyz = (r1.xyz) * (r0.zzz);
    r1.xyz = (v6.xyz) * (-(r0.www)) + (c[17].xyz);
    r0.z = saturate(dot(r15.xyz, r17.xyz));
    ...
    r8.w = (r0.w) * (r0.z);
    r1 = tex2D(s12, v0.zw);
    r1.w = ((-abs(r1.y)) >= 0.0f ? (c4.x) : (c4.z));
    r3.xyz = lerp(r2.xyz, c1.xxx, r0.xxx);
    r0 = tex2D(s7, v7.zw);
    r2 = lerp(r3, r0, r6.wwww);
    r0 = v1;
    ...
    r1.w = (r4.y) * (c14.x) + (c14.y);
    r0.z = (r9.w) * (r10.w) + (r4.x);
    r0.z = (r0.z) * (r3.z) + (c12.z);
