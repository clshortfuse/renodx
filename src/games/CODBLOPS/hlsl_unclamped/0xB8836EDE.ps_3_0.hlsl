// Mechanically reconstructed from 0xB8836EDE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r3.w = (r0.w) * (v0.w) + (c1.x);
    r4.xy = float2(((r3.w) >= 0.0f ? (r1.x) : (c1.z)), ((r3.w) >= 0.0f ? (r1.y) : (c1.z)));
    r1 = v2;
    r3.xyz = (r4.xxx) * (v5.xyz) + (r1.xyz);
    r1.xyz = (r2.xyz) * (r2.xyz);
    r2.xyz = (r4.yyy) * (v4.xyz) + (r3.xyz);
    ...
    r2.w = (r3.z) + (r3.z);
    r3.xyz = float3(((r3.w) >= 0.0f ? (r2.x) : (c1.z)), ((r3.w) >= 0.0f ? (r2.y) : (c1.y)), ((r3.w) >= 0.0f ? (r2.z) : (c1.z)));
    ...
    r2.w = (r3.x) * (-(r3.x)) + (c1.y);
    r2.w = (r2.z) * (r2.w);
    r3.y = max(abs(r4.y), abs(r4.z));
    r3.w = (r3.x) * (r3.x) + (r2.w);
    r2.w = max(abs(r4.x), r3.y);
