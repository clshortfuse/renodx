// Mechanically reconstructed from 0x8E983F11.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.z = saturate(dot(r0.xyz, r6.xyz));
    r4.xy = (r2.ww) * (c12.xy) + (c12.zw);
    r9.xyz = lerp(c[21].xyw, r3.yyy, r7.www);
    r3.w = exp2(r4.y);
    r5.w = 1.0f / (r4.x);
    ...
    r2.w = dot(r12.xy, r12.xy) + (c14.z);
    r2.y = dot(r3.xy, r3.xy) + (c14.z);
    r2.w = exp2(-(r2.w));
    r2.y = exp2(-(r2.y));
    r2.w = (r2.w) * (c1.x) + (c1.y);
    r3.w = (r2.y) * (c1.x) + (c1.y);
    r2.y = dot(r3.xy, r12.xy) + (c14.z);
    r4.w = (r2.w) * (r3.w);
    r3 = tex2D(s14, v0.zw);
    r12.xy = (r3.xy) * (c2.ww);
