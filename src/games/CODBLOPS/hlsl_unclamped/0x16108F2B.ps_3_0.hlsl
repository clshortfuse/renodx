// Mechanically reconstructed from 0x16108F2B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = float3(((r3.w) >= 0.0f ? (r2.x) : (c1.z)), ((r3.w) >= 0.0f ? (r2.y) : (c1.z)), ((r3.w) >= 0.0f ? (r2.z) : (c1.z)));
    ...
    r3 = (r3) + (c[26]);
    r6.xy = (r3.ww) * (c[27].xy) + (r3.xy);
    r6.zw = r3.zw;
    r4 = tex2Dproj(s2, r6);
    r5.zw = r6.zw;
    r3.zw = r5.zw;
    r7.xy = (r6.ww) * (-(c[27].zw)) + (r3.xy);
    r7.zw = r3.zw;
    r7 = tex2Dproj(s2, r7);
    r4.w = r7.x;
    r5.xy = (r6.ww) * (-(c[27].xy)) + (r3.xy);
    r3.xy = (r6.ww) * (c[27].zw) + (r3.xy);
    r5 = tex2Dproj(s2, r5);
    r4.y = r5.x;
    r5 = tex2Dproj(s2, r3);
    r3 = (v6.xyzx) * (c1.yyyz) + (c1.zzzy);
    r2.w = dot(r3, c[20]);
    r4.z = r5.x;
    r2.z = 1.0f / (r2.w);
    r5.x = dot(r3, c[9]);
    ...
    r2.x = (r2.x) * (r3.w);
    r3.w = saturate((r2.z) * (c[22].x) + (c[22].y));
    r2.z = (r3.w) * (r3.w);
    r3.w = (r3.w) * (c4.x) + (c4.y);
    r2.x = (r4.w) * (r2.x);
    r3.w = (r2.z) * (r3.w);
    r2.z = saturate(dot(r4.xyz, r9.xyz));
    r2.x = (r2.x) * (r3.w);
    r3.xyz = (r3.xyz) * (r2.xxx);
    r0.xyz = (r0.xyz) * (v0.xyz);
    r4.xyz = (r2.zzz) * (c[6].xyz);
