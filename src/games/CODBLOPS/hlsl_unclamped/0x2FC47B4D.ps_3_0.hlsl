// Mechanically reconstructed from 0x2FC47B4D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xyz = (r2.www) * (r8.xyz);
    r0.xyz = float3(((r3.w) >= 0.0f ? (r0.x) : (r7.x)), ((r3.w) >= 0.0f ? (r0.y) : (r7.y)), ((r3.w) >= 0.0f ? (r0.z) : (r7.z)));
    r1.xyz = (r6.xyz) * (r6.xyz) + (r1.xyz);
