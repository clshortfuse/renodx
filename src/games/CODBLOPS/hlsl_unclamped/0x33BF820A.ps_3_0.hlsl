// Mechanically reconstructed from 0x33BF820A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.x = 1.0f / (r2.w);
    r2.z = dot(r0.xyz, c[31].xyz);
    r2.w = saturate(dot(r0.xyz, r8.xyz));
    r0.z = saturate((r2.z) * (c[32].x) + (c[32].y));
    r3.w = (r0.z) * (c[32].w);
    r2.xy = saturate((r3.xx) * (c[34].xy) + (c[34].zw));
    r0.xy = (r2.xy) * (r2.xy);
    r2.xy = (r2.xy) * (c1.xx) + (c1.yy);
    r0.z = dot(c[33].yz, r3.xy) + (c[33].x);
    r2.xy = (r0.xy) * (r2.xy);
    r2.z = lerp(r1.w, r3.z, r3.w);
    r1.w = (r0.z) * (r2.x);
