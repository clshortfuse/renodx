// Mechanically reconstructed from 0x632E3896.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = c0.z;
    r6.xyz = float3(((r3.w) >= 0.0f ? (c[29].x) : (r0.w)), ((r3.w) >= 0.0f ? (c[29].y) : (r0.w)), ((r3.w) >= 0.0f ? (c[29].w) : (r0.w)));
    ...
    r5.w = (r1.z) * (r4.w) + (r6.y);
    r1.x = (r1.w) * (r4.w) + (r6.y);
    r12.xyz = (v4.xyz) * (-(r3.www)) + (c[17].xyz);
    r1.x = (r1.x) * (r5.w) + (c1.w);
    r1.x = 1.0f / (r1.x);
