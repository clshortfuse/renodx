// Mechanically reconstructed from 0x8F7750CC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    float4 v3 = input.v3;
    float4 v4 = input.v4;
    const float4 c0 = float4(-0.5f, 1.0f, 8.0f, 3.5f);
    ...
    r1.w = (r1.w) * (r4.w);
    r5.w = c0.y;
    r7.xy = float2(((r7.w) >= 0.0f ? (r5.w) : (c[20].x)), ((r7.w) >= 0.0f ? (r5.w) : (c[20].y)));
    r3.w = (r3.w) * (r1.w);
    ...
    r4.z = rsqrt(r0.z);
    r4.w = rsqrt(r0.w);
    r5.xyz = float3(((r7.w) >= 0.0f ? (r5.x) : (r6.x)), ((r7.w) >= 0.0f ? (r5.y) : (r6.y)), ((r7.w) >= 0.0f ? (r5.z) : (r6.z)));
    r3 = (r3) * (r4);
    r3 = (r9.yyyy) * (r3);
    r2 = (r2) * (r4);
    r1 = (r1) * (r4);
