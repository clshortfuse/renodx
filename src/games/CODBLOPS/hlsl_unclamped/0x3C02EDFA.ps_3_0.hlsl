// Mechanically reconstructed from 0x3C02EDFA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s12, v1.zw);
    r4 = tex2D(s2, v6.xy);
    r3.xyz = (r4.xyz) + (c15.yyy);
    r6.xyz = (r1.yyy) * (r5.xyz) + (r6.xyz);
    r7.xyz = (v0.yyy) * (r3.xyz) + (c15.zzz);
    r3.xyz = (r7.xyz) * (c15.www);
