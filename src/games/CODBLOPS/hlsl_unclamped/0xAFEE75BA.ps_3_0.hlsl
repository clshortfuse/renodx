// Mechanically reconstructed from 0xAFEE75BA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xy = float2(((r6.w) >= 0.0f ? (r2.x) : (r5.x)), ((r6.w) >= 0.0f ? (r2.y) : (r5.y)));
    ...
    r3.xyw = c[6].xyw;
    r9.xyz = float3(((r6.w) >= 0.0f ? (r3.x) : (c[5].x)), ((r6.w) >= 0.0f ? (r3.y) : (c[5].y)), ((r6.w) >= 0.0f ? (r3.w) : (c[5].w)));
