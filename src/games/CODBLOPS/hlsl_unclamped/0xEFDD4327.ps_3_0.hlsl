// Mechanically reconstructed from 0xEFDD4327.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.x = dot(r6.xy, r0.xy) + (c14.w);
    r3.y = dot(r6.xy, r0.zw) + (c14.w);
    r0 = tex2D(s4, v6.zw);
    r4.w = (r0.w) * (v0.z);
    r6.xy = (r2.yw) * (c12.xx) + (c12.yy);
    r7.xy = lerp(r8.xy, r3.xy, r4.ww);
    r1.w = dot(r6.xy, r6.xy) + (c14.w);
