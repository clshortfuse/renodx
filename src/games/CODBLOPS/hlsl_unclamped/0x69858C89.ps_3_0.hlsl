// Mechanically reconstructed from 0x69858C89.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = (r7.xyz) * (r1.www) + (r1.xyz);
    r0.xyz = (r3.yyy) * (v3.xyz) + (r0.xyz);
    r1.xyw = c[5].xyw;
    r5.xyz = (-(r1.xyw)) + (c[6].xyw);
