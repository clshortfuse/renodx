// Mechanically reconstructed from 0x91707EA6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = (r1.w) + (r1.w);
    r1.xyz = (r11.www) * (r0.xyz) + (c[31].xyw);
    r0.xyz = (r8.xyz) * (r2.www) + (r4.xyz);
    r11.xyz = lerp(r1.xyz, c1.xxx, r12.www);
    r7.xyz = (r5.xyz) * (r5.www);
    r9.xyz = (r0.xyz) * (r11.yyy);
    r1 = tex2D(s12, v1.zw);
    r0 = v2;
    ...
    r5.w = (r9.z) * (r9.z);
    r15.xyz = (v0.www) * (r0.xyz) + (c1.xxx);
    r1.z = (r1.z) * (r5.w);
    r0.xyz = (r4.xyz) * (r15.xyz);
    r9.xyz = (r0.xyz) * (r0.xyz);
    r5.xyz = (r0.xyz) * (-(r0.xyz)) + (c1.xxx);
    r1.w = (r1.x) * (r1.w);
    r0.xyz = (r5.xyz) * (r1.zzz) + (r9.xyz);
    r5.w = 1.0f / (r16.x);
    r0.xyz = (r1.www) * (r0.xyz);
    r1.w = (r4.w) * (c1.w);
    r0.xyz = (r11.zzz) * (r0.xyz);
    r4 = tex2D(s0, v1.xy);
    r16.xyz = lerp(r4.xyz, r3.xyz, r11.www);
    r3.xyz = (r0.xyz) * (c[19].xyz);
    r0.xyz = lerp(r16.xyz, r2.xyz, r12.www);
