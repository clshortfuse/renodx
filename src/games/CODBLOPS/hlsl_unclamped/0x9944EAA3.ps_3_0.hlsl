// Mechanically reconstructed from 0x9944EAA3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.w = (r0.w) * (v0.w) + (c1.y);
    r2 = float4(((r4.w) >= 0.0f ? (r1.x) : (c1.w)), ((r4.w) >= 0.0f ? (r1.y) : (c1.w)), ((r4.w) >= 0.0f ? (r1.z) : (c1.w)), ((r4.w) >= 0.0f ? (r1.w) : (c1.z)));
    r6.w = (r2.w) * (c2.z);
    r5.z = (r2.w) * (-(c2.z)) + (c2.w);
    ...
    r5.xy = float2(((r4.w) >= 0.0f ? (r1.x) : (c1.w)), ((r4.w) >= 0.0f ? (r1.y) : (c1.w)));
    r0.w = rsqrt(r7.y);
    r1 = v2;
    ...
    r0.w = dot(c[24].yz, r7.xy) + (c[24].x);
    r3.xy = saturate((r7.xx) * (c[25].xy) + (c[25].zw));
    r2.xy = (r3.xy) * (r3.xy);
