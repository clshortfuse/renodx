// Mechanically reconstructed from 0x0BA4A58C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r1.z) * (r1.z);
    r11.xyz = (v0.yyy) * (r0.xyz) + (c13.yyy);
    r0 = tex2D(s4, v8.zw);
    r1.xyz = (r0.xyz) + (c13.xxx);
    r0.xyz = (r11.xyz) * (c13.zzz);
    r10.xyz = (v0.zzz) * (r1.xyz) + (c13.yyy);
    r3.w = (r1.w) * (r2.w);
