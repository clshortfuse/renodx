// Mechanically reconstructed from 0xD7ACAD3A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r1.x) * (r1.w);
    r0.xyz = (v6.yyy) * (r0.xyz) + (c1.yyy);
    r1.z = 1.0f / (r1.z);
    r5.xyz = (r0.xyz) * (c1.zzz);
    r1.w = (r1.w) * (r1.z);
    r7.xyz = (r5.xyz) * (-(r5.xyz)) + (c1.yyy);
    r3.xyz = (r2.xyz) * (r2.xyz);
    r2.xyz = (r1.www) * (r7.xyz);
    r3.xyz = (r1.yyy) * (r3.xyz);
    r5.xyz = (r5.xyz) * (r5.xyz) + (r2.xyz);
    r2.xyz = (r4.xyz) * (r4.www) + (r6.xyz);
