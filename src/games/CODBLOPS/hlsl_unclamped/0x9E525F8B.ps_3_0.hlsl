// Mechanically reconstructed from 0x9E525F8B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.x = dot(r4.xy, r1.xy) + (c13.z);
    r2.y = dot(r4.xy, r1.zw) + (c13.z);
    r1 = tex2D(s2, v6.zw);
    r8.w = (r1.w) * (v6.y);
    r4.xy = (r0.yw) * (c4.xx) + (c4.yy);
    r5.xy = lerp(r6.xy, r2.xy, r8.ww);
    r0.w = dot(r4.xy, r4.xy) + (c13.z);
    r0.y = dot(r5.xy, r5.xy) + (c13.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c1.x) + (c1.y);
    r1.w = (r0.y) * (c1.x) + (c1.y);
    ...
    r6.zw = c13.zw;
    r2.xyz = (r6.zwz) + (-(c[20].xyw));
    r9.xyz = normalize(r3.xyz);
    r4.xyz = (r8.www) * (r2.xyz) + (c[20].xyw);
