// Mechanically reconstructed from 0x27A4BBD4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c6 = float4(4.0f, -2.0f, 0.125f, 0.25f);
