// Mechanically reconstructed from 0xE0EB82E3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = rsqrt(r1.w);
    r10.xyz = (v6.xyz) * (-(r1.zzz)) + (c[17].xyz);
    r5.xyz = normalize(r10.xyz);
    r1.w = saturate(dot(r5.xyz, c[17].xyz));
    r2.xyz = (r1.yyy) * (r0.xyz) + (r2.xyz);
    r1.w = (-(r1.w)) + (c4.x);
    ...
    r1.z = (r1.z) * (r1.z);
    r1.z = (r1.w) * (r1.z);
    r1.x = saturate(dot(r8.xyz, -(r0.xyz)));
    r6.w = (r2.w) * (c1.y);
    r5.w = (r2.w) * (-(c3.z)) + (c3.w);
    r4.w = (r1.x) * (r5.w) + (r6.w);
    r1.w = (r9.w) * (r5.w) + (r6.w);
    ...
    r10.z = dot(r0.xyz, r8.xyz);
    r5.xyz = (r4.xyz) * (r2.xyz) + (r1.xyz);
    r1.z = (r10.z) + (r10.z);
    r1.xyz = (r8.xyz) * (-(r1.zzz)) + (r0.xyz);
    r2.xyz = (r9.xyz) * (r10.www) + (-(r0.xyz));
