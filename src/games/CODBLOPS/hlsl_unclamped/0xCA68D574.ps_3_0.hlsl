// Mechanically reconstructed from 0xCA68D574.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s13, r0.xy);
    r2.w = r0.y;
    r6.w = (r1.w) * (-(r3.w)) + (c23.w);
    r1.xy = (r2.yw) * (c12.xx) + (c12.yy);
    r0.w = dot(r7.xy, r7.xy) + (c23.z);
    r0.y = dot(r1.xy, r1.xy) + (c23.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c4.x) + (c4.y);
    r1.w = (r0.y) * (c4.x) + (c4.y);
    r0.y = dot(r1.xy, r7.xy) + (c23.z);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v0.zw);
    r6.xy = (r1.xy) * (c4.ww);
    ...
    r1.w = (r1.z) * (r1.w);
    r7.xyz = lerp(c[20].xyw, r1.yyy, r4.www);
