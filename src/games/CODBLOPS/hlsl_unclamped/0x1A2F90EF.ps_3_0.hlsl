// Mechanically reconstructed from 0x1A2F90EF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    float4 v3 = input.v3;
    float4 v4 = input.v4;
    const float4 c0 = float4(1.0f, 0.0f, 0.75f, 31.875f);
    const float4 c1 = float4(6.0f, 13.0f, 8.0f, 12.0f);
    const float4 c2 = float4(0.5f, -28.0f, 30.0f, 0.136841998f);
    ...
    r0.xyz = float3(((c[34].x) >= 0.0f ? (r0.x) : (r2.x)), ((c[34].x) >= 0.0f ? (r0.y) : (r2.y)), ((c[34].x) >= 0.0f ? (r0.z) : (r2.z)));
    r0.w = c0.x;
    r1.x = dot(r0, c[31]);
    r1.y = dot(r0, c[32]);
    r1.z = dot(r0, c[33]);
