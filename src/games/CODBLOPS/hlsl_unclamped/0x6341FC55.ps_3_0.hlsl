// Mechanically reconstructed from 0x6341FC55.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xy = lerp(r6.xy, r2.xy, r0.ww);
    r1.y = dot(r4.xy, r4.xy) + (c3.z);
    ...
    r9.xy = (r0.ww) * (r2.xy) + (c[8].xy);
    r1.w = (r1.w) + (r1.w);
    r5.xyz = (r1.xyz) * (r9.yyy);
    r2.xyz = (r8.xyz) * (-(r1.www)) + (r7.xyz);
    r4 = tex2D(s5, v1.xy);
    r3 = tex2D(s6, v6.xy);
    ...
    r0.w = saturate((c[7].y) * (r2.w) + (c[7].x));
    r0.xyz = c[0].xyz;
