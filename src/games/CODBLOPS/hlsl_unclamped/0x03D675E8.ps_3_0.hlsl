// Mechanically reconstructed from 0x03D675E8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.w = saturate(dot(r1.xyz, -(r10.xyz)));
    r0.xyz = (r3.xyz) * (r2.www);
    r11.z = (r1.w) * (c3.y);
    r2.w = saturate(dot(r0.xyz, r1.xyz));
    r6.z = (r9.w) * (r10.w) + (r11.z);
    r3.y = (r2.w) * (r10.w) + (r11.z);
    r3.z = saturate(dot(r1.xyz, r2.xyz));
    r3.y = (r3.y) * (r6.z) + (c14.x);
