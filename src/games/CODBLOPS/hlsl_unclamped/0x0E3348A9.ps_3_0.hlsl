// Mechanically reconstructed from 0x0E3348A9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = tex2D(s13, r1.xy);
    r0.w = r3.y;
    r1.z = dot(r4.xy, r4.xy) + (c6.y);
    r1.xy = (r0.wy) * (c4.xx) + (c4.yy);
    r0.y = exp2(-(r1.z));
    r0.w = dot(r1.xy, r1.xy) + (c6.y);
    r4.w = (r0.y) * (c6.z) + (c6.w);
    r0.w = exp2(-(r0.w));
    r5.z = (r1.w) * (c1.y);
    r0.y = (r0.w) * (c6.z) + (c6.w);
    r0.w = dot(r1.xy, r4.xy) + (c6.y);
    r0.y = (r4.w) * (r0.y);
    r2 = tex2D(s14, v1.zw);
    r5.xy = (r2.xy) * (c3.ww);
