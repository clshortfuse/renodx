// Mechanically reconstructed from 0xF78B3D2A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.x = dot(r3.xy, r0.xy) + (c14.w);
    r6.y = dot(r3.xy, r0.zw) + (c14.w);
    r0 = tex2D(s4, v6.zw);
    r4.w = (r0.w) * (v0.z) + (c2.x);
    ...
    r2.xyw = c[32].xyw;
    r9.xyz = float3(((r4.w) >= 0.0f ? (r2.x) : (c[31].x)), ((r4.w) >= 0.0f ? (r2.y) : (c[31].y)), ((r4.w) >= 0.0f ? (r2.w) : (c[31].w)));
