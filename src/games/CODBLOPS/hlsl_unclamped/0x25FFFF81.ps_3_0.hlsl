// Mechanically reconstructed from 0x25FFFF81.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.z = (r4.w) * (r2.z);
    r0.xyz = (r8.xyz) * (r2.yyy) + (r10.xyz);
    r8.w = 1.0f / (r2.x);
    r0.xyz = (r2.zzz) * (r0.xyz);
    r0.xyz = (r0.xyz) * (c[30].www);
    r3.xy = c[24].xy;
    r2.xyz = (r3.yyy) * (c[23].xyz);
    r0.w = (r0.w) * (c2.z);
