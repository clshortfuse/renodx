// Mechanically reconstructed from 0x5E035A48.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xy = (v1.zw) * (c0.xy);
    r3 = tex2D(s13, r1.xy);
    r1.xy = (v1.zw) * (c0.xy) + (c0.zy);
    r1 = tex2D(s13, r1.xy);
    r3.w = r1.y;
    r2.xy = (r3.yw) * (c1.xx) + (c1.yy);
