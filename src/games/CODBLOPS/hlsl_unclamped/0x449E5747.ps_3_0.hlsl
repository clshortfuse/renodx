// Mechanically reconstructed from 0x449E5747.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.w = (r7.z) * (r7.z);
    r11.xyz = (v0.www) * (r5.xyz) + (c2.xxx);
    r3.w = (r3.w) * (r5.w);
    r4.xyz = (r4.xyz) * (r11.xyz);
    r7.xyz = (r4.xyz) * (r4.xyz);
    r5.xyz = (r4.xyz) * (-(r4.xyz)) + (c2.xxx);
    r5.w = (r6.y) * (r12.w);
