// Mechanically reconstructed from 0xA941C41E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.xyz = lerp(r3.xyz, r1.xyz, r5.www);
    ...
    r1 = (r5.wwww) * (r1) + (r3);
    r13.xyz = (v0.zzz) * (r4.xyz) + (c1.zzz);
    r11.xyz = normalize(r0.xyz);
    r0.xyz = (r1.xyz) * (r13.xyz);
    r2.z = saturate(dot(r11.xyz, r6.xyz));
