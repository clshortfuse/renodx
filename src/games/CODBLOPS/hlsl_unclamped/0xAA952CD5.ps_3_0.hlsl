// Mechanically reconstructed from 0xAA952CD5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r13.xyz = (r1.zzz) * (c[18].xyz);
    r0.w = (-(r0.w)) + (c0.y);
    r12.xyz = (r1.www) * (v3.xyz);
    r1.w = (r0.w) * (r0.w);
