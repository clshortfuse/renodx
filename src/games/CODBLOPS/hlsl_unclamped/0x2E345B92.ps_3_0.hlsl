// Mechanically reconstructed from 0x2E345B92.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = dot(r3.xyz, r0.xyz);
    r2.xyz = (r2.xyz) * (c[6].yyy);
    r6.w = (r6.w) + (r6.w);
    r2.xyz = (r1.www) * (r2.xyz);
    r3.xyz = (r0.xyz) * (-(r6.www)) + (r3.xyz);
