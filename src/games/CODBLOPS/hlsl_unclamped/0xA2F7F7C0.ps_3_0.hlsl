// Mechanically reconstructed from 0xA2F7F7C0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = (r0.z) + (r0.z);
    r15.yz = c1.yz;
    r2.xyz = float3(((r11.w) >= 0.0f ? (r15.y) : (c[36].x)), ((r11.w) >= 0.0f ? (r15.z) : (c[36].y)), ((r11.w) >= 0.0f ? (r15.y) : (c[36].w)));
    ...
    r0.y = rsqrt(r0.z);
    r7.w = (r4.w) * (c2.z);
    r6.xyz = (r0.yyy) * (v6.xyz);
    r2.w = (r4.w) * (-(c14.z)) + (c14.w);
    ...
    r3.xyz = (r0.xyz) * (r14.xyz) + (r2.xyz);
    r1.z = (r1.z) + (r1.z);
    r1.xyz = (r10.xyz) * (-(r1.zzz)) + (r6.xyz);
    r2.xyz = (r13.xyz) * (r10.www) + (-(r6.xyz));
