// Mechanically reconstructed from 0x87681B10.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c14 = float4(0.00048828125f, -0.000122070312f, 0.0f, -4.0f);
    ...
    r2 = tex2D(s3, v1.xy);
    r2.x = (r2.w) * (-(c1.w)) + (c1.z);
    r0.xyz = (r3.zzz) * (v7.xyz);
    r0.w = saturate(dot(r11.xyz, -(r0.xyz)));
    r3.w = (r2.w) * (c1.w);
    r2.z = (r0.w) * (r2.x) + (r3.w);
    r0.w = (-(r0.w)) + (c1.z);
    r1.w = (r0.w) * (r0.w);
    ...
    r0.z = (r0.w) * (r0.w);
    r0.z = (r0.z) * (r0.z);
    r1.x = max(abs(r11.y), abs(r11.z));
    r1.y = (r0.w) * (r0.z);
    r0.w = max(abs(r11.x), r1.x);
    r0.w = 1.0f / (r0.w);
    ...
    r9.xyz = (r0.www) * (r6.xyz) + (r7.xyz);
    r10.xyz = (r0.www) * (r0.xyz);
    r0 = tex2D(s0, v1.xy);
    r5 = (-(v7.yyyy)) + (c[7]);
    r4 = (-(v7.xxxx)) + (c[6]);
    r1 = (r5) * (r5);
    ...
    r4.xyz = (r7.xyz) * (r9.xyz) + (r10.xyz);
    r1 = (r3) * (r1);
    r3.xyz = (r8.xyz) * (r2.yyy) + (r4.xyz);
    r2.z = dot(c[20], r1);
    r2.x = dot(c[10], r1);
    r2.y = dot(c[11], r1);
