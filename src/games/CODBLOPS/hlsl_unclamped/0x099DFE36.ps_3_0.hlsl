// Mechanically reconstructed from 0x099DFE36.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s7, v1.xy);
    r10.xyz = lerp(r0.yyy, c[36].xyw, r4.www);
    r17.xyz = (r2.xyz) * (r10.yyy);
    r2.w = -(r0.w);
    ...
    r2.xyz = (r4.xyz) * (r0.www) + (-(r15.xyz));
    r14.xyz = normalize(r2.xyz);
    r16.xyz = (r4.xyz) * (r0.www);
