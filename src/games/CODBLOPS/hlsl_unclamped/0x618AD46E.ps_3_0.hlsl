// Mechanically reconstructed from 0x618AD46E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.y = dot(r3.xy, r1.zw) + (c1.w);
    r0 = tex2D(s3, v7.xy);
    r5.w = (r0.w) * (v0.y);
    r7.x = dot(r3.xy, r1.xy) + (c1.w);
    r8.xy = (r5.ww) * (-(r2.xy)) + (r2.xy);
    r2 = tex2D(s6, v1.xy);
    r1 = tex2D(s0, v1.xy);
