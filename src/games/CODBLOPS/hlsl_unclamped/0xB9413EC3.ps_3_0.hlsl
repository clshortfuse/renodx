// Mechanically reconstructed from 0xB9413EC3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c35 = float4(4.0f, -3.0f, -2.0f, 3.0f);
    ...
    r2.y = dot(r1.xy, r0.zw) + (c3.w);
    r2.x = dot(r1.xy, r0.xy) + (c3.w);
    r0 = tex2D(s1, v1.xy);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = tex2D(s0, v1.xy);
    r6.z = (r0.w) * (v0.x) + (c3.z);
    r0 = (r0.xyzx) * (-(c3.yyyw)) + (-(c3.wwwy));
    r4.xy = float2(((r6.z) >= 0.0f ? (r1.x) : (c3.w)), ((r6.z) >= 0.0f ? (r1.y) : (c3.w)));
    r1 = float4(((r6.z) >= 0.0f ? (r0.x) : (c3.w)), ((r6.z) >= 0.0f ? (r0.y) : (c3.w)), ((r6.z) >= 0.0f ? (r0.z) : (c3.w)), ((r6.z) >= 0.0f ? (r0.w) : (c3.w)));
    r0 = tex2D(s5, v7.xy);
    r6.w = (r0.w) * (v0.y) + (c3.z);
    r0 = (r0.xyzx) * (-(c3.yyyw)) + (-(c3.wwwy));
    r1 = float4(((r6.w) >= 0.0f ? (r0.x) : (r1.x)), ((r6.w) >= 0.0f ? (r0.y) : (r1.y)), ((r6.w) >= 0.0f ? (r0.z) : (r1.z)), ((r6.w) >= 0.0f ? (r0.w) : (r1.w)));
    r3.xy = float2(((r6.w) >= 0.0f ? (r3.x) : (r4.x)), ((r6.w) >= 0.0f ? (r3.y) : (r4.y)));
    r0 = tex2D(s6, v7.zw);
    r5.w = (r0.w) * (v0.z) + (c3.z);
    r0 = (r0.xyzx) * (-(c3.yyyw)) + (-(c3.wwwy));
    r0 = float4(((r5.w) >= 0.0f ? (r0.x) : (r1.x)), ((r5.w) >= 0.0f ? (r0.y) : (r1.y)), ((r5.w) >= 0.0f ? (r0.z) : (r1.z)), ((r5.w) >= 0.0f ? (r0.w) : (r1.w)));
    r6.xy = float2(((r5.w) >= 0.0f ? (r2.x) : (r3.x)), ((r5.w) >= 0.0f ? (r2.y) : (r3.y)));
    r1 = tex2D(s9, v1.xy);
    r2 = float4(((r6.z) >= 0.0f ? (r1.x) : (-(c3.w))), ((r6.z) >= 0.0f ? (r1.y) : (-(c3.w))), ((r6.z) >= 0.0f ? (r1.z) : (-(c3.w))), ((r6.z) >= 0.0f ? (r1.w) : (-(c3.y))));
    r1 = tex2D(s10, v7.xy);
    r3 = float4(((r6.w) >= 0.0f ? (r1.x) : (r2.x)), ((r6.w) >= 0.0f ? (r1.y) : (r2.y)), ((r6.w) >= 0.0f ? (r1.z) : (r2.z)), ((r6.w) >= 0.0f ? (r1.w) : (r2.w)));
    r1.w = dot(r6.xy, r6.xy) + (c3.w);
    r10.xyz = (r0.xyz) * (r0.xyz);
    r0.z = exp2(-(r1.w));
    r5.z = (r0.z) * (c12.x) + (c12.y);
    r0.xy = (v1.zw) * (-(c3.yz));
    r4 = tex2D(s13, r0.xy);
    ...
    r4.xy = (r4.xz) * (r0.xx);
    r0.z = dot(r5.xy, r6.xy) + (c3.w);
    r1.w = (r2.x) * (c12.w) + (-(r4.x));
    r1.w = (r4.z) * (-(r0.x)) + (r1.w);
    r1.xy = (r1.xz) * (r0.yy);
    ...
    r7.xz = (r4.xy) * (c15.xx);
    r2 = tex2D(s11, v7.zw);
    r1 = (r2.wwww) * (c4.xxxy) + (c4.zzzx);
    r4.xyz = (r7.xyz) * (r5.zzz) + (r0.xyz);
    ...
    r2.w = rsqrt(r0.z);
    r8.xyz = (r2.zzz) * (v6.xyz);
    r16.xyz = (r1.xyz) * (-(r1.xyz)) + (-(c3.yyy));
    r5.xyz = (r3.xyz) * (r2.www) + (-(r8.xyz));
    r0.xyz = normalize(r5.xyz);
    r9.xyz = (r3.xyz) * (r2.www);
    r10.w = (r1.w) * (-(c15.z)) + (c15.w);
    r2.w = saturate(dot(r0.xyz, r9.xyz));
    r2.x = c3.w;
    r3.xyz = float3(((r6.z) >= 0.0f ? (c[32].x) : (r2.x)), ((r6.z) >= 0.0f ? (c[32].y) : (r2.x)), ((r6.z) >= 0.0f ? (c[32].w) : (r2.x)));
    r2.w = (-(r2.w)) + (-(c3.y));
    r3.xyz = float3(((r6.w) >= 0.0f ? (c[33].x) : (r3.x)), ((r6.w) >= 0.0f ? (c[33].y) : (r3.y)), ((r6.w) >= 0.0f ? (c[33].w) : (r3.z)));
    r2.x = (r2.w) * (r2.w);
    r2.x = (r2.x) * (r2.x);
    r5.xyz = v2.xyz;
    ...
    r18.xyz = normalize(r5.xyz);
    r1.z = saturate(dot(r18.xyz, r0.xyz));
    r11.w = (r1.w) * (c12.z);
    r2.x = saturate(dot(r9.xyz, r18.xyz));
    r2.w = saturate(dot(r18.xyz, -(r8.xyz)));
    r0.z = (r2.x) * (r10.w) + (r11.w);
    r9.w = (r2.w) * (r10.w) + (r11.w);
    r0.z = (r0.z) * (r9.w) + (c14.x);
    r5.xy = (r1.ww) * (c36.xy) + (c36.zw);
    r0.y = 1.0f / (r0.z);
    r8.w = exp2(r5.y);
    r0.z = pow(abs(r1.z), r8.w);
    r6.w = (r8.w) * (c14.y) + (c14.z);
    r1.y = (r2.x) * (r0.y);
    r1.z = (r0.z) * (r6.w);
    r0.xyz = (r16.xyz) * (r3.www) + (r17.xyz);
    r1.z = (r1.y) * (r1.z);
    r15.xyz = float3(((r5.w) >= 0.0f ? (r2.y) : (r3.x)), ((r5.w) >= 0.0f ? (r2.y) : (r3.y)), ((r5.w) >= 0.0f ? (r2.y) : (r3.z)));
    r0.xyz = (r0.xyz) * (r1.zzz);
    r14.xyz = (r4.xyz) * (r15.yyy);
    r0.xyz = (r0.xyz) * (c[7].xyz);
    r1.xyz = (r15.zzz) * (r0.xyz);
    r2.w = (-(r2.w)) + (-(c3.y));
    r0.xyz = (r2.xxx) * (c[6].xyz);
    r2.x = (r2.w) * (r2.w);
    r2.y = 1.0f / (r5.x);
    r2.w = (r2.w) * (r2.x);
