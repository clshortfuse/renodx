// Mechanically reconstructed from 0xF20CA4AB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r1.w) * (-(v7.y)) + (c14.w);
    r0 = tex2D(s0, v0.xy);
    r3.xyz = lerp(r0.xyz, r1.xyz, r5.www);
    r0.w = (r0.w) * (-(v7.x)) + (c14.w);
    r6.w = (r0.w) * (-(r1.w)) + (c14.w);
    ...
    r0.w = dot(r4.xy, r4.xy) + (c14.z);
    r0.y = dot(r1.xy, r1.xy) + (c14.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c4.x) + (c4.y);
    r1.w = (r0.y) * (c4.x) + (c4.y);
    r0.y = dot(r1.xy, r4.xy) + (c14.z);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v0.zw);
    r6.xy = (r1.xy) * (c4.ww);
    ...
    r1.z = saturate(dot(r11.xyz, r5.xyz));
    ...
    r1.w = (r1.w) * (r1.z);
    r10.xyz = lerp(c[5].xyw, r1.yyy, r5.www);
