// Mechanically reconstructed from 0x85FF4058.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xy = (r5.ww) * (r1.xy) + (c[20].xy);
    r1.w = (r1.w) + (r1.w);
    r1.xyz = (r9.xyz) * (-(r1.www)) + (r0.xyz);
    ...
    r6.w = (r1.w) * (r1.w);
    r11.xyz = (v0.zzz) * (r0.xyz) + (c1.xxx);
    r3 = tex2D(s4, v8.xy);
    r3.xyz = (r3.xyz) + (c1.yyy);
    r0.xyz = (r2.xyz) * (r11.xyz);
    r10.xyz = (v0.www) * (r3.xyz) + (c1.xxx);
    r1.w = (r1.w) * (r6.w);
