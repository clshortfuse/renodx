// Mechanically reconstructed from 0x137513B7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r3.w) * (r4.w) + (r6.w);
    r5.w = (r1.z) * (r4.w) + (r6.w);
    r11.xyz = (v6.xyz) * (-(r1.xxx)) + (c[17].xyz);
    r1.w = (r1.w) * (r5.w) + (c2.w);
    r1.w = 1.0f / (r1.w);
