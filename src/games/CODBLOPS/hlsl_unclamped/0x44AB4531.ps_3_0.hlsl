// Mechanically reconstructed from 0x44AB4531.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyz = (r4.xyz) * (r2.www) + (-(r3.xyz));
    r5.xy = (c[31].zz) * (r1.xy) + (r2.xy);
    r2.xyz = normalize(r0.xyz);
    r0 = tex2D(s0, v1.xy);
    r5.w = (r0.w) * (v0.w) + (c0.x);
    r1.xyz = (v7.xyz) * (-(r1.www)) + (c[17].xyz);
    r5.xy = float2(((r5.w) >= 0.0f ? (r5.x) : (c0.z)), ((r5.w) >= 0.0f ? (r5.y) : (c0.z)));
    r16.xyz = normalize(r1.xyz);
    r1 = v2;
    r1.xyz = (r5.xxx) * (v5.xyz) + (r1.xyz);
    r3.w = saturate(dot(r16.xyz, c[17].xyz));
    r1.xyz = (r5.yyy) * (v4.xyz) + (r1.xyz);
    r15.xyz = normalize(r1.xyz);
    r10.xyz = (r4.xyz) * (r2.www);
    r4.y = saturate(dot(r15.xyz, r2.xyz));
    ...
    r4.w = dot(r10.xyz, r15.xyz);
    r11.w = (r2.w) * (-(c3.y)) + (c3.z);
    r0.x = saturate(r4.w);
    r12.w = (r2.w) * (c3.y);
    r2.z = saturate(dot(r15.xyz, -(r3.xyz)));
    r0.y = (r0.x) * (r11.w) + (r12.w);
    r10.w = (r2.z) * (r11.w) + (r12.w);
    r0.y = (r0.y) * (r10.w) + (c3.w);
    r2.xy = (r2.ww) * (c4.xy) + (c4.zw);
    r4.z = 1.0f / (r0.y);
    r9.w = exp2(r2.y);
    r0.y = pow(abs(r4.y), r9.w);
    ...
    r1.y = c0.z;
    r8.xyz = float3(((r5.w) >= 0.0f ? (c[30].x) : (r1.y)), ((r5.w) >= 0.0f ? (c[30].y) : (r1.y)), ((r5.w) >= 0.0f ? (c[30].w) : (r1.y)));
    r1.xyz = (r0.xyz) * (r8.zzz);
    r0.xyz = (abs(r4.www)) * (c[7].xyz);
    r1.xyz = (r9.xyz) * (r0.xyz) + (r1.xyz);
    r4.z = 1.0f / (r2.x);
    r4.w = (-(r2.z)) + (c0.y);
    ...
    r8.y = dot(r15.xyz, c[17].xyz);
    r12.xyz = (r0.xyz) * (c3.xxx);
    r11.xyz = (abs(r8.yyy)) * (c[18].xyz);
    if ((c0.y) >= (v6.w))
    {
        r3 = (v6.xyzx) * (c0.yyyz);
        r2 = (r3) + (-(c13.xyzz));
    ...
    r0.y = saturate(r8.y);
    r0.z = (r0.y) * (r11.w) + (r12.w);
    r0.z = (r0.z) * (r10.w) + (c3.w);
    r2.z = saturate(dot(r15.xyz, r16.xyz));
    r0.x = 1.0f / (r0.z);
    r0.z = pow(abs(r2.z), r9.w);
    r0.y = (r0.y) * (r0.x);
    r0.z = (r8.w) * (r0.z);
    r2.z = (r0.y) * (r0.z);
