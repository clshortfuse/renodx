// Mechanically reconstructed from 0xF2F47ADE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = lerp(r2.xy, r3.xy, r2.ww);
    r0 = tex2D(s11, v7.zw);
    r6.w = lerp(r1.w, r0.y, r2.w);
    r10.w = lerp(r2.z, r0.w, r2.w);
    r6.xyz = (r1.xyz) * (r1.xyz);
    r7.w = (r10.w) * (-(c41.z)) + (c41.w);
