// Mechanically reconstructed from 0xAA5654C4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r13.xy = float2(((r5.w) >= 0.0f ? (r1.x) : (r2.x)), ((r5.w) >= 0.0f ? (r1.y) : (r2.y)));
    r6.w = rsqrt(r0.w);
    r1.xyz = v2.xyz;
    r1.xyz = (r13.xxx) * (v4.xyz) + (r1.xyz);
    r8.xyz = (r6.xyz) * (r6.www);
    r2.xyz = (r13.yyy) * (v3.xyz) + (r1.xyz);
    r1 = tex2D(s4, v7.xy);
    ...
    r3 = tex2D(s8, v7.zw);
    r1 = (r3.wwww) * (c2.xxxz) + (c2.wwwx);
    r4 = tex2D(s7, v1.xy);
    r2.w = r4.w;
    r7.w = ((r5.w) >= 0.0f ? (r3.y) : (r4.y));
