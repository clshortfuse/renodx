// Mechanically reconstructed from 0xBA336F49.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s9, v1.xy);
    r0 = tex2D(s10, v7.xy);
    r2 = float4(((r6.w) >= 0.0f ? (r0.x) : (r1.x)), ((r6.w) >= 0.0f ? (r0.y) : (r1.y)), ((r6.w) >= 0.0f ? (r0.z) : (r1.z)), ((r6.w) >= 0.0f ? (r0.w) : (r1.w)));
    ...
    r3.w = (r1.w) * (r1.w);
    r13.xyz = lerp(r4.xyz, c[41].xyw, r5.www);
    r3.w = (r3.w) * (r3.w);
