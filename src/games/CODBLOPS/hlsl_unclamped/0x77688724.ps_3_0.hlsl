// Mechanically reconstructed from 0x77688724.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = dot(r5.xy, r0.xy) + (c2.z);
    r1.y = dot(r5.xy, r0.zw) + (c2.z);
    r0 = tex2D(s2, v6.xy);
    r5.w = (r0.w) * (v0.y) + (c2.w);
    r5.xy = (r2.yw) * (c4.zz) + (c4.ww);
