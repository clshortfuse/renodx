// Mechanically reconstructed from 0x88EADAAE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(4.0f, -2.0f, 0.0f, 0.0f);
    ...
    r4.x = dot(r2.xy, r1.xy) + (c4.z);
    r4.y = dot(r2.xy, r1.zw) + (c4.z);
    r1 = tex2D(s2, v6.zw);
    r1.w = (r1.w) * (v6.y);
