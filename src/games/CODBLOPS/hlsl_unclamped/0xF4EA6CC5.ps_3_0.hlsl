// Mechanically reconstructed from 0xF4EA6CC5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s9, v7.zw);
    r0 = tex2D(s5, v8.xy);
    r6.xyz = (r0.xyz) + (c22.yyy);
    r0 = lerp(r2, r1, r5.wwww);
    r1.xyz = (v0.www) * (r6.xyz) + (c22.www);
    r11.xyz = lerp(r5.xyz, c[10].xyw, r5.www);
    r0.xyz = (r0.xyz) * (r1.xyz);
    r9.xyz = (r0.xyz) * (-(r0.xyz)) + (c22.www);
    ...
    r1.y = dot(r5.xy, r5.xy) + (c22.z);
    r1.w = dot(r2.xy, r2.xy) + (c22.z);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r3.w = (r1.y) * (c3.x) + (c3.y);
    r1.y = (r1.w) * (c3.x) + (c3.y);
    r1.w = dot(r2.xy, r5.xy) + (c22.z);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c4.ww);
    ...
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c22.w) : (c22.z));
