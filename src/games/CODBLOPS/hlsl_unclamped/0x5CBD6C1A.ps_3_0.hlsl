// Mechanically reconstructed from 0x5CBD6C1A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xyz = float3(((r6.w) >= 0.0f ? (c[39].x) : (r0.y)), ((r6.w) >= 0.0f ? (c[39].y) : (r0.y)), ((r6.w) >= 0.0f ? (c[39].w) : (r0.y)));
    r1 = tex2D(s11, v7.zw);
