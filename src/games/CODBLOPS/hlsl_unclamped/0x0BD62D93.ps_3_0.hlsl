// Mechanically reconstructed from 0x0BD62D93.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = (r0.y) * (c1.y) + (c1.z);
    r0.y = (r0.w) * (c1.y) + (c1.z);
    r0.w = dot(r2.xy, r4.xy) + (c1.x);
    r0.y = (r3.w) * (r0.y);
    r3.z = (r12.x) * (-(c12.y)) + (c12.x);
