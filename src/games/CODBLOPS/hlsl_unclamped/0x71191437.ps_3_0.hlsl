// Mechanically reconstructed from 0x71191437.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s3, v7.zw);
    r7.w = (r1.w) * (v7.y) + (c1.x);
    r7.xy = float2(((r7.w) >= 0.0f ? (c1.y) : (r3.y)), ((r7.w) >= 0.0f ? (c1.z) : (r3.y)));
    r2.xy = (v0.zw) * (c3.zw);
    r2 = tex2D(s13, r2.xy);
    ...
    r2.y = dot(r6.xy, r6.xy) + (c1.y);
    r2.w = dot(r3.xy, r3.xy) + (c1.y);
    r2.y = exp2(-(r2.y));
    r2.w = exp2(-(r2.w));
    r4.w = (r2.y) * (c2.x) + (c2.y);
    r2.y = (r2.w) * (c2.x) + (c2.y);
    r2.w = dot(r3.xy, r6.xy) + (c1.y);
    r2.y = (r4.w) * (r2.y);
    r3 = tex2D(s14, v0.zw);
    r8.xy = (r3.xy) * (c2.ww);
