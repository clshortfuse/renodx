// Mechanically reconstructed from 0x4502A23D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.w = lerp(r1.y, r0.y, r5.w);
    r0.xyz = (r7.yyy) * (v3.xyz) + (r2.xyz);
    r3.w = r1.w;
    ...
    r1 = tex2D(s0, v1.xy);
    r3.xyz = (r1.xyz) * (-(r5.xyz)) + (r3.xyz);
    r3.xyz = (r5.www) * (r3.xyz);
    r12.xyz = (r0.yyy) * (r7.xyz) + (r8.xyz);
    ...
    r0.w = rsqrt(r0.w);
    r7.w = exp2(r2.y);
    r3.xyz = (v5.xyz) * (-(r0.www)) + (c[17].xyz);
    r9.w = 1.0f / (r2.x);
    r2.xyz = normalize(r3.xyz);
    r3.xyz = (r0.www) * (v5.xyz);
