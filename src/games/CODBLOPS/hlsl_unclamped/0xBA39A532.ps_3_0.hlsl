// Mechanically reconstructed from 0xBA39A532.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c9 = float4(1.0f, 0.5f, 0.0f, 31.875f);
    ...
    r1 = tex2D(s2, v6.xy);
    r1.w = (r1.w) * (v0.y) + (c1.z);
    r7.xyz = (r6.xyz) * (r0.www) + (r2.xyz);
    r0.w = ((r1.w) >= 0.0f ? (c1.w) : (r3.y));
    r2 = tex2D(s6, v6.zw);
    r3.xyz = v2.xyz;
    r3.xyz = (r5.xxx) * (v4.xyz) + (r3.xyz);
    r5.w = lerp(r0.w, r2.y, r4.w);
    r2.xyz = (r5.yyy) * (v3.xyz) + (r3.xyz);
    r5.xyz = normalize(r2.xyz);
    r4.xyz = normalize(v5.xyz);
    r6.w = lerp(r3.w, r2.w, r4.w);
    ...
    r1.xyz = lerp(r4.xyz, r0.xyz, r4.www);
