// Mechanically reconstructed from 0x880E450F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = dot(r5.xy, r0.xy) + (c1.z);
    r0.y = dot(r5.xy, r0.zw) + (c1.z);
    r2.z = (r3.w) * (-(c12.z)) + (c12.w);
    r8.xy = lerp(r4.xy, r0.xy, r9.ww);
    r0 = v1;
    r4.xyz = (r8.xxx) * (v4.xyz) + (r0.xyz);
    r0.xyz = (-(v5.xyz)) + (c[20].xyz);
    r4.xyz = (r8.yyy) * (v3.xyz) + (r4.xyz);
    r13.y = dot(r0.xyz, r0.xyz);
    ...
    r7.xyz = lerp(r2.yyy, c[25].xyw, r9.www);
