// Mechanically reconstructed from 0x7B290767.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex3D(s11, r1.xyz);
    r2.w = lerp(r1.w, r3.w, c[23].w);
    r1.xyz = (r1.xyz) * (r1.xyz);
    r6.xyz = (r3.xyz) * (r2.www);
    r7.xyz = (r1.xyz) * (c1.zzz);
    r4 = (-(v7.yyyy)) + (c[7]);
    r1 = (r4) * (r4);
    r3 = (-(v7.xxxx)) + (c[6]);
    r1 = (r3) * (r3) + (r1);
