// Mechanically reconstructed from 0xD28ADDFA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xyz = (v0.zzz) * (r9.xyz) + (c1.yyy);
    r0.xyz = (r1.yyy) * (r0.xyz) + (r5.xyz);
    r3.xyz = (r4.xyz) * (r11.xyz);
    r2 = tex2D(s5, v8.xy);
    r1.w = dot(v6.xyz, v6.xyz);
    r2.xyz = (r2.xyz) + (c1.xxx);
    r1.x = rsqrt(r1.w);
    r10.xyz = (v0.www) * (r2.xyz) + (c1.yyy);
