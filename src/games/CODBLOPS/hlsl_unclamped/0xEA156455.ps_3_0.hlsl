// Mechanically reconstructed from 0xEA156455.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.yz = c0.yz;
    r6.xyz = float3(((r4.w) >= 0.0f ? (c[22].x) : (r12.z)), ((r4.w) >= 0.0f ? (c[22].y) : (r12.z)), ((r4.w) >= 0.0f ? (c[22].w) : (r12.z)));
    ...
    r4.w = dot(r2.xyz, r10.xyz);
    r7.xyz = (r1.xyz) * (c1.xxx);
    r1.z = (r4.w) + (r4.w);
    r4.xyz = (r5.xxx) * (c[18].xyz);
