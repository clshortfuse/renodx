// Mechanically reconstructed from 0xE84409D0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = c[38].xy;
    r3.yz = (-(r4.xy)) + (c[30].xy);
    r3.xy = (r3.xx) * (r3.yz) + (c[38].xy);
    r3.zw = (c13.xy) + (v3.xy);
    r3.xy = (r3.zw) * (r3.xy) + (c13.zw);
    r3.xy = (r0.ww) * (c[37].xy) + (r3.xy);
    r3 = tex2D(s4, r3.xy);
    r3.xyz = (r3.xyz) * (r3.xyz);
    r3.xyz = (r3.xyz) * (c14.xyz);
    r4 = tex2D(s5, v3.xy);
    r4.xyz = (r4.xyz) * (r4.xyz);
    r3.xyz = (r4.xyz) * (c[36].xxx) + (r3.xyz);
    r0.w = (r0.w) * (c[34].x);
    r1.w = frac(abs(r0.w));
    ...
    r4.x = v3.x;
    r4 = tex2D(s2, r4.xy);
    r0.w = pow(abs(r4.y), c[31].x);
    r4.xyz = (r0.www) * (c[33].xyz);
    r3.xyz = (r4.xyz) * (c[32].xxx) + (r3.xyz);
    r4.xy = (-(r5.xx)) + (c15.xy);
    ...
    r0.xyz = float3(((c[28].x) >= 0.0f ? (r0.x) : (r1.x)), ((c[28].x) >= 0.0f ? (r0.y) : (r1.y)), ((c[28].x) >= 0.0f ? (r0.z) : (r1.z)));
    r0.w = c2.w;
    r1.x = dot(r0, c[25]);
    r1.y = dot(r0, c[26]);
    r1.z = dot(r0, c[27]);
