// Mechanically reconstructed from 0x902FF4AA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xyz = float3(((r5.w) >= 0.0f ? (r2.y) : (c[20].x)), ((r5.w) >= 0.0f ? (r2.y) : (c[20].y)), ((r5.w) >= 0.0f ? (r2.y) : (c[20].w)));
    r9.xyz = normalize(r0.xyz);
    r3 = (r2.wwww) * (c2.xxxy) + (c2.zzzx);
    r6.w = saturate(dot(r9.xyz, c[17].xyz));
    r11.xyz = (r4.xyz) * (r7.yyy);
