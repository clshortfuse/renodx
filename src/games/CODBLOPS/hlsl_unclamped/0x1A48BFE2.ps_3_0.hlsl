// Mechanically reconstructed from 0x1A48BFE2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.x = 1.0f / (r6.w);
    r8.y = (r0.w) + (r0.w);
    r1.xy = saturate((r7.xx) * (c[24].xy) + (c[24].zw));
    r0.xy = (r1.xy) * (r1.xy);
    ...
    r0.xyz = (v4.www) * (r3.xyz) + (r6.xyz);
    r3.xyz = (r4.www) * (r1.xyz) + (r2.xyz);
    r1 = tex2D(s2, v1.xy);
    r6.y = (r1.w) * (c4.y);
    r6.z = (r1.w) * (-(c4.y)) + (c4.x);
