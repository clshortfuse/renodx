// Mechanically reconstructed from 0x280BE123.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xyw = c[39].xyw;
    r3.xyz = float3(((r3.w) >= 0.0f ? (r2.x) : (c[38].x)), ((r3.w) >= 0.0f ? (r2.y) : (c[38].y)), ((r3.w) >= 0.0f ? (r2.w) : (c[38].w)));
