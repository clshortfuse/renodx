// Mechanically reconstructed from 0x0E4ADFB0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c9 = float4(31.875f, 4.0f, -2.0f, 0.0009765625f);
    const float4 c10 = float4(3.5f, -13.0f, 1.0f, 13.0f);
    const float4 c11 = float4(0.125f, 0.25f, 0.000244140625f, 0.0f);
    ...
    r2.y = dot(r1.xy, r0.zw) + (c14.z);
    r2.x = dot(r1.xy, r0.xy) + (c14.z);
    r0 = tex2D(s1, v1.xy);
    r5.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r2.w = (r0.w) * (v0.y);
    r3.xyz = lerp(r1.xyz, r0.xyz, r2.www);
    r7.xy = lerp(r5.xy, r2.xy, r2.ww);
    r1 = tex2D(s7, v1.xy);
    r0 = tex2D(s8, v7.xy);
    r0.z = dot(r7.xy, r7.xy) + (c14.z);
    r14.xy = lerp(r1.wy, r0.wy, r2.ww);
    r0.w = exp2(-(r0.z));
    r5.w = (r0.w) * (c3.y) + (c3.z);
    ...
    r1 = tex2D(s14, v1.zw);
    r6.xy = (r1.xy) * (c9.xx);
    r8.xy = (r0.wy) * (c9.yy) + (c9.zz);
    r2.xy = (r2.xz) * (r6.xx);
    r0.w = dot(r8.xy, r7.xy) + (c14.z);
    r0.y = (r1.x) * (c9.x) + (-(r2.x));
    r1.w = (r2.z) * (-(r6.x)) + (r0.y);
    r5.xy = (r0.xz) * (r6.yy);
    r0.y = (r1.y) * (c9.x) + (-(r5.x));
    r0.x = dot(r8.xy, r8.xy) + (c14.z);
    r0.y = (r0.z) * (-(r6.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r6.y = (r1.w) + (r1.w);
    r0.z = (r0.z) * (c3.y) + (c3.z);
    ...
    r6.xz = (r2.xy) * (c9.yy);
    r2.w = (r14.x) * (-(c4.x)) + (c4.y);
    r1.xyz = (r6.xyz) * (r5.www) + (r0.xyz);
    r0 = tex2D(s4, v7.zw);
    r0.xyz = (r0.xyz) + (c14.yyy);
    r13.xyz = (r14.yyy) * (r1.xyz);
    r1.xyz = (v0.zzz) * (r0.xyz) + (c14.www);
    r0 = tex2D(s5, v8.xy);
    r2.xyz = (r0.xyz) + (c14.yyy);
    r0.xyz = (r1.xyz) * (c3.xxx);
    r2.xyz = (v0.www) * (r2.xyz) + (c14.www);
    r5.xyz = (r0.xyz) * (r2.xyz);
    r0.xyz = v2.xyz;
    r0.xyz = (r7.xxx) * (v4.xyz) + (r0.xyz);
    r8.xyz = (r5.xyz) * (-(r5.xyz)) + (c14.www);
    ...
    r11.xyz = (r14.yyy) * (r0.xyz);
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c14.w) : (c14.z));
    ...
    else
    {
        ...
        else
        {
            ...
            if ((r0.w) != (-(r0.w)))
            {
                ...
                r1.z = r3.x;
                r1.w = r2.x;
                r0.x = dot(r1, c11.yyyy);
                r0.w = saturate((v5.w) + (c13.y));
                r0.z = (r0.y) + (-(r0.x));
                r0.w = (r0.w) * (r0.z) + (r0.x);
            }
            else
    ...
    r2.xyz = (r0.www) * (r12.xyz) + (r13.xyz);
    r0.xyz = (r11.xyz) * (c[19].xyz);
