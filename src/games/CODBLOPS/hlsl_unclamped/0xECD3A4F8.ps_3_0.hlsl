// Mechanically reconstructed from 0xECD3A4F8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = float3(((r5.w) >= 0.0f ? (r4.x) : (r6.x)), ((r5.w) >= 0.0f ? (r4.y) : (r6.y)), ((r5.w) >= 0.0f ? (r4.z) : (r6.z)));
    ...
    r3.w = (r1.w) * (r2.w);
    r9.w = (r6.z) * (c2.w);
    r8.w = (r6.z) * (-(c14.z)) + (c14.w);
    r2.w = saturate(dot(r8.xyz, -(r9.xyz)));
    r1.w = (r4.w) * (r8.w) + (r9.w);
    r7.w = (r2.w) * (r8.w) + (r9.w);
    r1.w = (r1.w) * (r7.w) + (c4.x);
    r4.xy = (r6.zz) * (c12.xy) + (c12.zw);
    r4.z = 1.0f / (r1.w);
    r10.z = exp2(r4.y);
    r10.w = (r10.z) * (c4.y) + (c4.z);
    r1.w = pow(abs(r5.z), r10.z);
    r4.w = (r4.w) * (r4.z);
    r1.w = (r10.w) * (r1.w);
    r3.w = (r3.w) * (c3.x) + (c3.y);
    r1.w = (r4.w) * (r1.w);
