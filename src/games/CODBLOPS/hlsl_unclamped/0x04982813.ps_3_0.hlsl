// Mechanically reconstructed from 0x04982813.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.w = (r1.w) * (r2.w);
    r5.y = saturate(dot(r10.xyz, r1.xyz));
    r1 = tex2D(s5, v1.xy);
    ...
    r1.x = 1.0f / (r0.z);
    r4.z = exp2(r14.y);
    r0.z = pow(abs(r5.y), r4.z);
    r0.y = (r4.z) * (c13.x) + (c13.y);
    r4.y = (r4.w) * (r1.x);
    r0.z = (r0.z) * (r0.y);
    r1.x = (r5.w) * (c12.z) + (c12.w);
    r0.z = (r4.y) * (r0.z);
    r0.z = (r1.x) * (r0.z);
    r1.x = saturate(dot(r10.xyz, c[17].xyz));
    r13.xyz = (r3.xyz) * (r1.yyy);
    r0.x = (r1.x) * (r0.x) + (r5.z);
