// Mechanically reconstructed from 0x669250DB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.w = (r2.w) * (v0.y) + (c1.x);
    r0.yz = c1.yz;
    r4.xyz = float3(((r7.w) >= 0.0f ? (r0.y) : (c[28].x)), ((r7.w) >= 0.0f ? (r0.z) : (c[28].y)), ((r7.w) >= 0.0f ? (r0.y) : (c[28].w)));
    ...
    r9.xyz = lerp(r4.xyz, c[29].xyw, r6.www);
