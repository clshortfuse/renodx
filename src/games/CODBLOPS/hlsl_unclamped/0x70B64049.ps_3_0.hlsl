// Mechanically reconstructed from 0x70B64049.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = (r4.w) * (r4.w);
    r5.xyz = (r9.yyy) * (v3.xyz) + (r0.xyz);
    r2 = tex2D(s4, v7.zw);
    r2.yz = (r2.wy) + (c1.xx);
    r0.xyz = normalize(r5.xyz);
    r8.xy = (r8.zz) * (r2.yz) + (c1.zz);
    r1.w = saturate(dot(r0.xyz, r4.xyz));
    r2.x = (r8.x) * (c2.w);
    r2.y = (r8.x) * (-(c12.z)) + (c12.w);
    ...
    r6.xyz = lerp(r2.xyz, r1.xyz, r8.zzz);
    r1.w = (r1.w) + (r1.w);
