// Mechanically reconstructed from 0x15EBD122.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.y = dot(r1.xy, r0.zw) + (c42.w);
    r4.x = dot(r1.xy, r0.xy) + (c42.w);
    r1 = tex2D(s1, v1.xy);
    r0 = tex2D(s5, v7.xy);
    r0.xyz = (r0.xyz) + (c42.yyy);
    r8.xyz = (v0.yyy) * (r0.xyz) + (c42.zzz);
    r0 = tex2D(s0, v1.xy);
    r2 = tex2D(s6, v7.zw);
    r4.w = (r2.w) * (v0.z);
    r2.xyz = (r0.xyz) * (-(r8.xyz)) + (r2.xyz);
    r2.xyz = (r4.www) * (r2.xyz);
    r1.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r0.xyz = (r0.xyz) * (r8.xyz) + (r2.xyz);
    r3.xy = lerp(r1.xy, r4.xy, r4.ww);
    r5.xyz = (r0.xyz) * (r0.xyz);
    r2.w = dot(r3.xy, r3.xy) + (c42.w);
    r0.xy = (v1.zw) * (c4.xy);
    r1 = tex2D(s13, r0.xy);
    ...
    r1.w = r0.y;
    r0.w = exp2(-(r2.w));
    r9.xy = (r1.yw) * (c12.xx) + (c12.yy);
    r3.w = (r0.w) * (c3.x) + (c3.y);
    r0.w = dot(r9.xy, r3.xy) + (c42.w);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c4.ww);
    r4.xy = (r1.xz) * (r7.xx);
    r6.xy = (r0.xz) * (r7.yy);
    ...
    r7.y = (r0.y) + (r0.y);
    r0.y = (r0.z) + (r0.z);
    r0.z = dot(r9.xy, r9.xy) + (c42.w);
    r0.x = dot(v6.xyz, v6.xyz);
    r0.z = exp2(-(r0.z));
    r6.z = rsqrt(r0.x);
    r0.z = (r0.z) * (c3.x) + (c3.y);
    r1.xyz = (v6.xyz) * (-(r6.zzz)) + (c[17].xyz);
    r0.z = (r3.w) * (r0.z);
    ...
    r3.xyz = (r3.yyy) * (v3.xyz) + (r2.xyz);
    r14.zw = c42.zw;
    r2.xyz = (r14.wzw) + (-(c[39].xyw));
    r10.xyz = normalize(r3.xyz);
    r9.xyz = (r4.www) * (r2.xyz) + (c[39].xyw);
    ...
    r9.w = (r1.w) * (r2.w);
    r4.xyz = (r0.xyz) * (-(r0.xyz)) + (c42.zzz);
    r8.w = (r0.w) * (-(c12.z)) + (c12.w);
    r9.y = (r0.w) * (c3.w);
    ...
    r0.w = (r6.w) * (r8.w) + (r9.y);
    r0.w = (r0.w) * (r3.z) + (c13.x);
    r3.x = saturate(dot(r10.xyz, r11.xyz));
    r3.z = 1.0f / (r0.w);
    r0.w = pow(abs(r3.x), r7.w);
    r3.z = (r6.w) * (r3.z);
    r0.w = (r3.y) * (r0.w);
    r0.w = (r3.z) * (r0.w);
