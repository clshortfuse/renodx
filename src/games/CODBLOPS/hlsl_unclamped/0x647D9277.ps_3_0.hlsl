// Mechanically reconstructed from 0x647D9277.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s6, v0.xy);
    r11.xyz = float3(((r12.w) >= 0.0f ? (c[36].x) : (r0.y)), ((r12.w) >= 0.0f ? (c[36].y) : (r0.y)), ((r12.w) >= 0.0f ? (c[36].w) : (r0.y)));
