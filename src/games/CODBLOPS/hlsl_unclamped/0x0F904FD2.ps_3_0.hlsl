// Mechanically reconstructed from 0x0F904FD2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c43 = float4(2.0f, -1.0f, -0.0f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r3.y = dot(r1.xy, r0.zw) + (c43.z);
    r3.x = dot(r1.xy, r0.xy) + (c43.z);
    r0 = tex2D(s8, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c43.xxxx) * (v9) + (c43.yyyy);
    r4.y = dot(r1.xy, r0.zw) + (c43.z);
    r4.x = dot(r1.xy, r0.xy) + (c43.z);
    r0 = tex2D(s1, v1.xy);
    ...
    r1.xy = lerp(r5.xy, r3.xy, r4.ww);
    r0 = tex2D(s6, v7.zw);
    r6.w = (r0.w) * (v0.z);
    r3.xyz = lerp(r2.xyz, r0.xyz, r6.www);
    r0.xy = (v1.zw) * (c12.xy);
    r2 = tex2D(s13, r0.xy);
    r0.xy = (v1.zw) * (c12.xy) + (c12.zy);
    r0 = tex2D(s13, r0.xy);
    r2.w = r0.y;
    r7.xy = lerp(r1.xy, r4.xy, r6.ww);
    r1.xy = (r2.yw) * (c13.xx) + (c13.yy);
    r0.w = dot(r7.xy, r7.xy) + (c43.z);
    r0.y = dot(r1.xy, r1.xy) + (c43.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c4.x) + (c4.y);
    r1.w = (r0.y) * (c4.x) + (c4.y);
    r0.y = dot(r1.xy, r7.xy) + (c43.z);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v1.zw);
    r5.xy = (r1.xy) * (c12.ww);
    ...
    r0.w = lerp(r1.y, c43.w, r4.w);
    r1.xyz = (r2.xyz) * (r2.www) + (-(r6.xyz));
    r3.xyz = normalize(r1.xyz);
    r4.xyz = (r2.xyz) * (r2.www);
    r13.xyz = lerp(r0.www, c[39].xyw, r6.www);
    r0.w = saturate(dot(r3.xyz, r4.xyz));
    r12.xyz = (r0.xyz) * (r13.yyy);
    r4.w = (-(r0.w)) + (c43.w);
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c43.w) : (c43.z));
    ...
    r0.xy = (r0.xy) * (r0.xy);
    r0.w = ((-abs(r0.w)) >= 0.0f ? (c43.z) : (r0.z));
    r0.z = (r2.x) * (r0.x);
    r0.w = (r0.w) * (r0.z);
    r0.z = (r0.y) * (-(r2.y)) + (c43.w);
    r0.xy = (r1.ww) * (r1.xy);
    r0.w = (r0.w) * (r0.z);
    r6.w = (r3.z) * (r0.w);
