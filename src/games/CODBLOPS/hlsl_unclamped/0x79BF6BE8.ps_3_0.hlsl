// Mechanically reconstructed from 0x79BF6BE8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = r4.y;
    r5.x = dot(r3.xy, r0.xy) + (c3.w);
    r1 = tex2D(s1, v1.xy);
    r0.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r1 = tex2D(s2, v6.xy);
    r1.w = (r1.w) * (v0.y);
    r5.y = dot(r3.xy, r0.zw) + (c3.w);
    r7.xy = (r1.ww) * (-(r0.xy)) + (r0.xy);
    r0 = tex2D(s3, v6.zw);
    r7.w = (r0.w) * (v0.z);
    r3.xy = (r2.yw) * (c4.xx) + (c4.yy);
    r6.xy = lerp(r7.xy, r5.xy, r7.ww);
    r2.w = dot(r3.xy, r3.xy) + (c3.w);
    ...
    r3.xy = (r1.ww) * (r4.xy) + (c[8].xy);
    r0.w = dot(r8.xyz, r9.xyz);
    r10.xy = lerp(r3.xy, c[9].xy, r7.ww);
    r0.w = (r0.w) + (r0.w);
    r6.xyz = (r2.xyz) * (r10.yyy);
