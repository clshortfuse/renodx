// Mechanically reconstructed from 0xECBD2045.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.z = saturate(dot(r0.xyz, -(r11.xyz)));
    r3.w = (r4.w) * (r4.y) + (r5.w);
    r4.y = (r4.z) * (r4.y) + (r5.w);
    r5.w = c0.z;
    r10.xyz = float3(((r4.x) >= 0.0f ? (c[10].x) : (r5.w)), ((r4.x) >= 0.0f ? (c[10].y) : (r5.w)), ((r4.x) >= 0.0f ? (c[10].w) : (r5.w)));
    r3.w = (r3.w) * (r4.y) + (c1.w);
    r6.w = (-(r4.z)) + (c0.y);
    r3.w = 1.0f / (r3.w);
    r3.w = (r4.w) * (r3.w);
    r4.xyz = (r2.xyz) * (r2.www) + (-(r11.xyz));
    ...
    r6.xyz = (r1.xyz) * (r4.www);
    r1.z = dot(r3.xy, r3.xy) + (c0.z);
    r5.xyz = (r5.xyz) * (r5.xyz);
    r1.z = exp2(-(r1.z));
    r3 = tex2D(s14, v1.zw);
    r12.xy = (r3.xy) * (c1.xx);
    r3.w = saturate((r1.z) * (c2.x) + (c2.y));
    r1.xy = (r4.xz) * (r12.yy);
    r2.w = (r3.y) * (c1.x) + (-(r1.x));
    r1.xz = (r1.xy) * (c1.yy);
    r1.y = (r4.z) * (-(r12.y)) + (r2.w);
    r2.xy = (r2.xz) * (r12.xx);
    r1.y = (r1.y) + (r1.y);
    r2.w = (r3.x) * (c1.x) + (-(r2.x));
    r3.xz = (r2.xy) * (c1.yy);
    ...
    r3.y = (r2.w) + (r2.w);
    r2.w = dot(r11.xyz, r0.xyz);
    r1.xyz = (r1.xyz) * (r3.www) + (r3.xyz);
    r2.w = (r2.w) + (r2.w);
    r4.xyz = (r10.yyy) * (r1.xyz);
