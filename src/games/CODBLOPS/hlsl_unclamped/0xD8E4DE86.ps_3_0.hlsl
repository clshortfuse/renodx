// Mechanically reconstructed from 0xD8E4DE86.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = dot(r8.xy, r8.xy) + (c2.w);
    r2.w = exp2(-(r2.w));
    r1.w = exp2(-(r1.w));
    r2.z = (r2.w) * (c4.x) + (c4.y);
    r1.w = (r1.w) * (c4.x) + (c4.y);
    r2.w = dot(r2.xy, r8.xy) + (c2.w);
    r2.z = (r2.z) * (r1.w);
    r4.y = (r3.w) + (r3.w);
