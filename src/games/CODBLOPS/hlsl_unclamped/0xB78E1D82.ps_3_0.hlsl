// Mechanically reconstructed from 0xB78E1D82.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    float4 v2 = input.v2;
    float4 v3 = input.v3;
    const float4 c0 = float4(-1.0f, 1.0f, 0.200000003f, 0.797884583f);
