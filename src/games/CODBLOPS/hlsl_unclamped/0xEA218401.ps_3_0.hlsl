// Mechanically reconstructed from 0xEA218401.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(2.0f, -1.0f, 1.0f, 0.0f);
    ...
    r2.x = dot(r1.xy, r0.xy) + (c2.w);
    r2.y = dot(r1.xy, r0.zw) + (c2.w);
    r1 = tex2D(s6, v6.zw);
    r2.zw = r1.yy;
    r0 = tex2D(s3, v6.zw);
    r5.w = (r0.w) * (v0.z) + (c3.x);
    r6.xy = (r3.yw) * (c11.xx) + (c11.yy);
    r2 = float4(((r5.w) >= 0.0f ? (r2.x) : (r4.x)), ((r5.w) >= 0.0f ? (r2.y) : (r4.y)), ((r5.w) >= 0.0f ? (r2.z) : (r4.z)), ((r5.w) >= 0.0f ? (r2.w) : (r4.w)));
    r1.z = dot(r6.xy, r6.xy) + (c2.w);
    r0.w = dot(r2.xy, r2.xy) + (c2.w);
    r1.z = exp2(-(r1.z));
    r0.w = exp2(-(r0.w));
    r3.w = (r1.z) * (c4.x) + (c4.y);
    r0.w = (r0.w) * (c4.x) + (c4.y);
