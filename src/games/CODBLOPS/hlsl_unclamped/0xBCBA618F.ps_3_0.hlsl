// Mechanically reconstructed from 0xBCBA618F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c4 = float4(60.0f, 1.0f, 0.0f, 100.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0.w = saturate(r1.y);
    r1.xyz = c[30].xyz;
    r1.xyz = (-(r1.yzx)) + (c[31].yzx);
    r3.xyz = (r0.www) * (r1.xyz) + (c[30].yzx);
    r0.w = frac(r3.y);
    ...
    r0 = tex2D(s3, r2.xy);
    r2.xy = (r6.xy) * (c[32].xx);
    r8.xy = (c[33].xy) * (r1.xx) + (r2.xy);
    r2.xy = (c[34].xx) * (r1.xx) + (r2.xy);
    r1 = tex2D(s4, r8.xy);
    r2 = tex2D(s4, r2.xy);
    r0.z = (r1.x) + (r2.x);
    r0.z = (r0.z) + (r0.z);
