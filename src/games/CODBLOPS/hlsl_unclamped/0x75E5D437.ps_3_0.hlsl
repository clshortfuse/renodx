// Mechanically reconstructed from 0x75E5D437.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xy = float2(((r7.w) >= 0.0f ? (r1.x) : (c1.z)), ((r7.w) >= 0.0f ? (r1.y) : (c1.z)));
    r0 = float4(((r7.w) >= 0.0f ? (r0.x) : (c1.z)), ((r7.w) >= 0.0f ? (r0.y) : (c1.z)), ((r7.w) >= 0.0f ? (r0.z) : (c1.z)), ((r7.w) >= 0.0f ? (r0.w) : (c1.z)));
    ...
    r2 = tex2D(s14, v1.zw);
    r0.xy = (r2.xy) * (c3.ww);
    r6.xy = (r3.yw) * (c38.xx) + (c38.yy);
    r3.xy = (r3.xz) * (r0.xx);
    r0.z = dot(r6.xy, r5.xy) + (c1.z);
    r1.w = (r2.x) * (c3.w) + (-(r3.x));
    r1.w = (r3.z) * (-(r0.x)) + (r1.w);
    r1.xy = (r1.xz) * (r0.yy);
    r2.w = (r2.y) * (c3.w) + (-(r1.x));
    ...
    r13.yz = c1.yz;
    r10.xyz = float3(((r7.w) >= 0.0f ? (c[36].x) : (r13.z)), ((r7.w) >= 0.0f ? (c[36].y) : (r13.z)), ((r7.w) >= 0.0f ? (c[36].w) : (r13.z)));
    r7.xyz = (r4.xyz) * (r4.xyz);
    r11.xyz = (r0.xyz) * (r10.yyy);
    r2 = tex2D(s12, v1.zw);
    r1 = v2;
    r0.xyz = (r5.xxx) * (v5.xyz) + (r1.xyz);
    r0.xyz = (r5.yyy) * (v4.xyz) + (r0.xyz);
    r9.xyz = normalize(r0.xyz);
    r10.w = saturate(dot(r9.xyz, c[17].xyz));
    r0.z = ((-abs(r2.y)) >= 0.0f ? (c1.y) : (c1.z));
    r1.xyz = (r10.www) * (c[18].xyz);
    if ((r0.z) != (-(r0.z)))
    {
        r0.z = r2.y;
        r5.w = r0.z;
    ...
    r4.xyz = (r5.www) * (r1.xyz) + (r11.xyz);
    r0.z = dot(v7.xyz, v7.xyz);
    r1.z = rsqrt(r0.z);
    r0.xyz = (-(v7.xyz)) + (c[20].xyz);
    r2.xyz = (v7.xyz) * (-(r1.zzz)) + (c[17].xyz);
    r1.y = dot(r0.xyz, r0.xyz);
    r2.w = rsqrt(r1.y);
    r1.xyz = (r1.zzz) * (v7.xyz);
    r6.xyz = normalize(r2.xyz);
    r2.xyz = (r0.xyz) * (r2.www) + (-(r1.xyz));
    r11.xyz = normalize(r2.xyz);
    r12.xyz = (r0.xyz) * (r2.www);
    r0.y = saturate(dot(r6.xyz, c[17].xyz));
    ...
    r0.z = (r0.z) * (r0.y);
    r2 = tex2D(s5, v1.xy);
    r3 = float4(((r7.w) >= 0.0f ? (r2.x) : (c1.z)), ((r7.w) >= 0.0f ? (r2.y) : (c1.z)), ((r7.w) >= 0.0f ? (r2.z) : (c1.z)), ((r7.w) >= 0.0f ? (r2.w) : (c1.y)));
    r5.xyz = (r3.xyz) * (-(r3.xyz)) + (c1.yyy);
    r3.xyz = (r3.xyz) * (r3.xyz);
    r4.w = dot(r12.xyz, c[29].xyz);
    r0.xyz = (r5.xyz) * (r0.zzz) + (r3.xyz);
    r11.w = (r3.w) * (-(c38.z)) + (c38.w);
    r12.w = (r3.w) * (c3.z);
    r6.w = saturate(dot(r12.xyz, r9.xyz));
    r8.w = saturate(dot(r9.xyz, -(r1.xyz)));
    r2.w = (r6.w) * (r11.w) + (r12.w);
    r10.y = (r8.w) * (r11.w) + (r12.w);
    r2.z = (r2.w) * (r10.y) + (c14.x);
    ...
    r1.z = (-(r8.w)) + (c1.y);
    r1.y = (r1.z) * (r1.z);
    r12.xy = (r3.ww) * (c16.xy) + (c16.zw);
    r2.w = (r1.z) * (r1.y);
    r3.w = 1.0f / (r12.x);
    r1.xyz = (r2.xyz) * (r2.xyz);
    r2.w = (r2.w) * (r3.w);
    r1.xyz = (r10.xxx) * (r1.xyz);
    r2.xyz = (r5.xyz) * (r2.www) + (r3.xyz);
    r3.w = (r6.w) * (r7.w);
    r1.xyz = (r1.xyz) * (r2.xyz);
    r8.w = exp2(r12.y);
    r7.w = saturate(dot(r9.xyz, r11.xyz));
    r2.w = (r8.w) * (c14.y) + (c14.z);
    r2.z = (r10.w) * (r11.w) + (r12.w);
    r2.z = (r2.z) * (r10.y) + (c14.x);
    r6.z = saturate(dot(r9.xyz, r6.xyz));
    r2.y = 1.0f / (r2.z);
    r2.z = pow(abs(r6.z), r8.w);
    r2.y = (r10.w) * (r2.y);
    r2.z = (r2.w) * (r2.z);
    r6.z = (r2.y) * (r2.z);
    r2.xyz = (r5.xyz) * (r9.www) + (r3.xyz);
    r3.z = pow(abs(r7.w), r8.w);
