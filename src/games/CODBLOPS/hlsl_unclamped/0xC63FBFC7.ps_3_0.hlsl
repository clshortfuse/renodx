// Mechanically reconstructed from 0xC63FBFC7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    float4 v3 = input.v3;
    float4 v4 = input.v4;
    const float4 c0 = float4(0.125f, 0.25f, 1.0f, -0.0f);
    const float4 c1 = float4(1.0f, 0.25f, -1.0f, 0.797884583f);
