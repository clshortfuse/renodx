// Mechanically reconstructed from 0x20A9E41F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.y = dot(r1.xy, r0.zw) + (c3.z);
    r7.x = dot(r1.xy, r0.xy) + (c3.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r5.w = (r0.w) * (v0.y);
    r2 = tex2D(s1, v1.xy);
    ...
    r3.xyz = lerp(r2.yyy, c[8].xyw, r5.www);
    r2 = (r5.wwww) * (r0) + (r1);
    r0 = tex2D(s4, v7.zw);
    r7.w = (r0.w) * (v0.z);
    r5.xyz = lerp(r6.xyz, r0.xyz, r7.www);
    r6.xy = lerp(r8.xy, r7.xy, r7.ww);
    r1 = tex2D(s9, v7.zw);
    r0 = lerp(r2, r1, r7.wwww);
    r11.xyz = lerp(r3.xyz, c[9].xyw, r7.www);
