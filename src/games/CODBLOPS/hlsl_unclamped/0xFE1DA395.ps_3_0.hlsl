// Mechanically reconstructed from 0xFE1DA395.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xy = float2(((r4.w) >= 0.0f ? (r2.w) : (r3.w)), ((r4.w) >= 0.0f ? (r2.y) : (r3.y)));
    r2 = tex2D(s7, v6.zw);
    r3.xyz = v2.xyz;
    r3.xyz = (r6.xxx) * (v4.xyz) + (r3.xyz);
    r3.xyz = (r6.yyy) * (v3.xyz) + (r3.xyz);
    r9.xyz = normalize(r3.xyz);
    r7.xy = lerp(r5.xy, r2.wy, r0.ww);
    ...
    r3.w = (r7.x) * (c3.w);
    r2.w = (r7.x) * (-(c13.z)) + (c13.w);
    r2.x = (r1.w) * (r2.w) + (r3.w);
    r2.w = (r5.w) * (r2.w) + (r3.w);
    r2.w = (r2.w) * (r2.x) + (c12.x);
    r6.xy = (r7.xx) * (c14.xy) + (c14.zw);
    r2.x = 1.0f / (r2.w);
    r2.w = exp2(r6.y);
