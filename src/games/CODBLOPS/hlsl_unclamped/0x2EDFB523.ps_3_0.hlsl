// Mechanically reconstructed from 0x2EDFB523.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r1.z) * (r1.y);
    r1.xyz = (r7.xyz) * (r3.www) + (r2.xyz);
    r0.xyz = (r0.xyz) * (r2.www);
    r3 = tex2D(s0, v0.xy);
    r2 = tex2D(s3, v7.zw);
    r2.w = (r2.w) * (v7.y) + (c1.x);
    r8.xyz = float3(((r2.w) >= 0.0f ? (r2.x) : (r3.x)), ((r2.w) >= 0.0f ? (r2.y) : (r3.y)), ((r2.w) >= 0.0f ? (r2.z) : (r3.z)));
    r2.yz = c1.yz;
    r11.xyz = float3(((r2.w) >= 0.0f ? (r2.y) : (c[5].x)), ((r2.w) >= 0.0f ? (r2.z) : (c[5].y)), ((r2.w) >= 0.0f ? (r2.y) : (c[5].w)));
    r15.xyz = (r1.xyz) * (r11.yyy);
    r1.xyz = (r0.xyz) * (r11.zzz);
    r2 = tex2D(s12, v0.zw);
