// Mechanically reconstructed from 0x3283BEC8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c9 = float4(0.959999979f, 0.0399999991f, 31.875f, 4.0f);
    ...
    r0.w = (r0.w) * (v0.y) + (c3.w);
    r1.z = r3.w;
    r5.xyz = float3(((r0.w) >= 0.0f ? (r0.x) : (r2.x)), ((r0.w) >= 0.0f ? (r0.y) : (r2.y)), ((r0.w) >= 0.0f ? (r0.z) : (r2.z)));
    r2 = tex2D(s8, v7.xy);
    r0.z = r2.w;
    r4 = tex2D(s5, v7.xy);
    r6.xy = (r4.wy) * (c1.xy) + (c1.zw);
    r4 = (c3.xxxx) * (v8) + (c3.yyyy);
    r0.y = dot(r6.xy, r4.zw) + (c3.z);
    r0.x = dot(r6.xy, r4.xy) + (c3.z);
    r1.w = ((r0.w) >= 0.0f ? (r2.y) : (r3.y));
    r2.xyz = float3(((r0.w) >= 0.0f ? (r0.x) : (r1.x)), ((r0.w) >= 0.0f ? (r0.y) : (r1.y)), ((r0.w) >= 0.0f ? (r0.z) : (r1.z)));
    r0 = tex2D(s6, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    ...
    r0 = tex2D(s4, v7.zw);
    r2.w = (r0.w) * (v0.z);
    r1.xyz = lerp(r5.xyz, r0.xyz, r2.www);
    r3.xy = lerp(r2.xy, r4.xy, r2.ww);
    r0 = tex2D(s9, v7.zw);
    r5.w = lerp(r1.w, r0.y, r2.w);
    r6.w = lerp(r2.z, r0.w, r2.w);
    r0.w = dot(r3.xy, r3.xy) + (c3.z);
    r7.xyz = (r1.xyz) * (r1.xyz);
    r0.w = exp2(-(r0.w));
    r3.z = (r6.w) * (-(c10.z)) + (c10.w);
    r3.w = (r0.w) * (c4.x) + (c4.y);
    ...
    r2.w = r0.y;
    r4.w = rsqrt(r1.w);
    r6.xy = (r2.yw) * (c10.xx) + (c10.yy);
    r1 = tex2D(s14, v1.zw);
    r8.xy = (r1.xy) * (c9.zz);
    r0.w = dot(r6.xy, r3.xy) + (c3.z);
    r4.xy = (r2.xz) * (r8.xx);
    r0.y = (r1.x) * (c9.z) + (-(r4.x));
    r5.xy = (r0.xz) * (r8.yy);
    r0.x = (r2.z) * (-(r8.x)) + (r0.y);
    ...
    r11.xy = (r6.ww) * (c12.xy) + (c12.zw);
    r0.w = exp2(r11.y);
    r5.xyz = (r4.www) * (v6.xyz);
    r7.w = saturate(dot(r8.xyz, -(r5.xyz)));
    r1.w = saturate(dot(r8.xyz, c[17].xyz));
    r1.x = (r7.w) * (r3.z) + (r3.y);
    r1.z = (r1.w) * (r3.z) + (r3.y);
    r1.y = pow(abs(r2.z), r0.w);
    r1.z = (r1.z) * (r1.x) + (c11.x);
    r0.w = (r0.w) * (c11.y) + (c11.z);
    r1.z = 1.0f / (r1.z);
    r0.w = (r1.y) * (r0.w);
    r1.y = (r1.w) * (r1.z);
    r1.z = (r2.w) * (c9.x) + (c9.y);
    ...
    r1.xyz = (r0.www) * (r9.xyz) + (r10.xyz);
    r0.xyz = (r8.www) * (c[19].xyz);
    ...
    r0.z = (r0.w) + (r0.w);
    r0.w = (r6.w) * (c4.z);
    r0.xyz = (r8.xyz) * (-(r0.zzz)) + (r5.xyz);
    r0 = texCUBElod(s15, r0);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r0.w = (r1.w) * (c9.x) + (c9.y);
    r0.xyz = (r5.www) * (r0.xyz);
    r2.xyz = (r7.xyz) * (r1.xyz) + (r2.xyz);
