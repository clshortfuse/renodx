// Mechanically reconstructed from 0x49007F15.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xyz = (r6.yyy) * (v4.xyz) + (r0.xyz);
    r6.xyz = (r5.xyz) * (r6.www);
