// Mechanically reconstructed from 0xA44EF69A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c10 = float4(0.797884583f, 31.875f, 4.0f, -2.0f);
    const float4 c11 = float4(0.797884583f, 1.0f, 0.0009765625f, 0.25f);
    ...
    r11.xyz = float3(((r1.w) >= 0.0f ? (r2.x) : (r3.x)), ((r1.w) >= 0.0f ? (r2.y) : (r3.y)), ((r1.w) >= 0.0f ? (r2.z) : (r3.z)));
    r2 = tex2D(s4, v7.zw);
    ...
    r0.w = r2.y;
    r2.w = (r1.w) * (c4.y) + (c4.z);
    r6.xy = (r0.wy) * (c10.zz) + (c10.ww);
    r1 = tex2D(s14, v1.zw);
    r10.xy = (r1.xy) * (c10.yy);
    r0.w = dot(r6.xy, r11.xy) + (c3.z);
    r2.xy = (r2.xz) * (r10.xx);
    r0.y = (r1.x) * (c10.y) + (-(r2.x));
    r5.xy = (r0.xz) * (r10.yy);
    r0.x = (r2.z) * (-(r10.x)) + (r0.y);
    r0.y = (r1.y) * (c10.y) + (-(r5.x));
