// Mechanically reconstructed from 0xC318C1C6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xy = (v6.zw) * (c3.xz);
    r2 = tex2D(s13, r0.xy);
    r0.xy = (v6.zw) * (c3.xz) + (c3.yz);
    r0 = tex2D(s13, r0.xy);
    r2.w = r0.y;
    r9.xy = c1.xy;
    r1.xy = (v6.xy) * (c[40].xx) + (r9.xx);
    r7.xy = (r2.yw) * (c4.xx) + (c4.yy);
    r1.xy = (r1.xy) * (c[41].xx) + (r9.yy);
    r1 = tex2D(s2, r1.xy);
    r8.xy = (v6.xy) * (c[40].xx);
    r6.xy = (r8.xy) * (c2.xx) + (c2.yy);
    r0.w = (r1.y) * (c1.z) + (c1.w);
    r1.xy = (r6.xy) * (c[42].xx) + (r9.yy);
    r1 = tex2D(s3, r1.xy);
    r0.y = (r1.y) * (c1.z) + (c1.w);
    r1.w = (r0.y) * (c1.z) + (c1.w);
    r1.xz = c2.zz;
    ...
    r4.xyz = (r0.zzz) * (v2.xyw) + (r1.xyz);
    r1.xyz = normalize(r3.xyz);
    r0.w = 1.0f / (r4.z);
    r2.w = saturate(dot(r6.xyz, r1.xyz));
    r4.xy = (r4.xy) * (r0.ww);
    r7.xyz = (-(v4.xyz)) * (r3.www) + (r1.xyz);
    ...
    r0.z = dot(c[34].xyz, r4.xyz);
    r1.w = saturate((c[36].y) * (r0.z) + (c[36].x));
    r0.xyz = c[0].xyz;
