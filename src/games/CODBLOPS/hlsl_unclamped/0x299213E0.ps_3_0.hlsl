// Mechanically reconstructed from 0x299213E0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s14, v0.zw);
    r5.xy = (r1.xy) * (c3.ww);
    r7.xy = (r0.wy) * (c4.xx) + (c4.yy);
    r2.xy = (r2.xz) * (r5.xx);
    r0.w = dot(r7.xy, r4.xy) + (c1.x);
    r0.y = (r1.x) * (c3.w) + (-(r2.x));
    r1.w = (r2.z) * (-(r5.x)) + (r0.y);
    r3.xy = (r0.xz) * (r5.yy);
    r0.y = (r1.y) * (c3.w) + (-(r3.x));
