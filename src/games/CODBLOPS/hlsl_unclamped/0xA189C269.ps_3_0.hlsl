// Mechanically reconstructed from 0xA189C269.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s13, r1.xy);
    r2.w = r1.y;
    r5.xy = float2(((r5.w) >= 0.0f ? (r3.x) : (c1.z)), ((r5.w) >= 0.0f ? (r3.y) : (c1.z)));
    ...
    r2.w = (r1.y) * (c3.x) + (c3.y);
    r1.y = (r1.w) * (c3.x) + (c3.y);
    r1.w = dot(r3.xy, r5.xy) + (c1.z);
    r1.y = (r2.w) * (r1.y);
    r8.xyz = (r0.xyz) * (r0.xyz);
    r5.z = saturate((r1.w) * (r1.y) + (r1.y));
    r3 = tex2D(s14, v1.zw);
    r0.xy = (r3.xy) * (c3.ww);
    r2.xy = (r2.xz) * (r0.xx);
    r1.xy = (r1.xz) * (r0.yy);
    ...
    r16.yz = c1.yz;
    r13.xyz = float3(((r5.w) >= 0.0f ? (c[20].x) : (r16.z)), ((r5.w) >= 0.0f ? (c[20].y) : (r16.z)), ((r5.w) >= 0.0f ? (c[20].w) : (r16.z)));
