// Mechanically reconstructed from 0x250396BD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xyz = (r2.xyz) * (-(r2.xyz)) + (c1.www);
    r11.w = max(abs(r4.y), abs(r4.z));
    r8.xyz = (r5.xyz) * (r2.www) + (r7.xyz);
    r2.w = max(abs(r4.x), r11.w);
    r2.w = 1.0f / (r2.w);
