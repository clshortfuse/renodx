// Mechanically reconstructed from 0x69CCD6F5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xyz = lerp(r3.xyz, r0.xyz, r9.www);
    r0.w = dot(r8.xy, r8.xy) + (c43.z);
    ...
    r2.w = r0.y;
    r3.xy = (r2.xz) * (r4.xx);
    r6.xy = (r2.yw) * (c42.xx) + (c42.yy);
    r0.y = (r1.x) * (c4.w) + (-(r3.x));
    r0.w = dot(r6.xy, r8.xy) + (c43.z);
    r1.w = (r2.z) * (-(r4.x)) + (r0.y);
    r2.xy = (r0.xz) * (r4.yy);
    r0.x = dot(r6.xy, r6.xy) + (c43.z);
    r0.y = (r1.y) * (c4.w) + (-(r2.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r0.z) * (-(r4.y)) + (r0.y);
    r0.z = (r0.x) * (c4.x) + (c4.y);
    ...
    r1.xyz = (r9.xyz) * (r3.zzz) + (r1.xyz);
    r2.xyz = (r4.www) * (r0.xyz) + (c[39].xyw);
    r0 = tex2D(s10, v7.zw);
