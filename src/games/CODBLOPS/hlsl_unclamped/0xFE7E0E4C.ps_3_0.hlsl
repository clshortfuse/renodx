// Mechanically reconstructed from 0xFE7E0E4C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c8 = float4(0.000244140625f, 0.0f, -0.000244140625f, -4.0f);
    ...
    r3.xy = float2(((r5.y) >= 0.0f ? (r0.x) : (c1.w)), ((r5.y) >= 0.0f ? (r0.y) : (c1.w)));
    r0.w = (-(r0.w)) + (c1.z);
    r1 = v2;
    ...
    r8.w = ((r5.y) >= 0.0f ? (r3.y) : (c1.w));
    r0.w = c1.z;
    r2.w = r3.w;
    r0 = float4(((r5.y) >= 0.0f ? (r0.x) : (c1.w)), ((r5.y) >= 0.0f ? (r0.y) : (c1.w)), ((r5.y) >= 0.0f ? (r0.z) : (c1.w)), ((r5.y) >= 0.0f ? (r0.w) : (c1.w)));
    r0.xyz = (r0.xyz) * (v0.xyz);
    r2.xyz = lerp(r4.xyz, c1.xxx, r3.xxx);
    r1.xyz = (r0.xyz) * (r0.xyz);
    r2 = float4(((r5.y) >= 0.0f ? (r2.x) : (c1.w)), ((r5.y) >= 0.0f ? (r2.y) : (c1.w)), ((r5.y) >= 0.0f ? (r2.z) : (c1.w)), ((r5.y) >= 0.0f ? (r2.w) : (c1.z)));
    r8.xyz = (r2.xyz) * (-(r2.xyz)) + (c1.zzz);
    r9.xyz = (r2.xyz) * (r2.xyz);
    r4.xyz = (r8.xyz) * (r5.zzz) + (r9.xyz);
    r2.xyz = (r5.www) * (v7.xyz);
    r0.z = (r2.w) * (-(c3.z)) + (c3.w);
    r9.w = saturate(dot(r10.xyz, -(r2.xyz)));
    r3.z = (r2.w) * (c3.z);
    r14.xy = (r2.ww) * (c7.xy) + (c7.zw);
    r0.y = (r9.w) * (r0.z) + (r3.z);
    r0.x = exp2(r14.y);
    r3.w = pow(abs(r4.w), r0.x);
    ...
    r13.xyz = (r4.xyz) * (r5.www);
    r0.xyz = (r8.www) * (r0.xyz);
    r12.xyz = (r0.xyz) * (c3.yyy);
    r11.xyz = (r4.www) * (c[18].xyz);
    if ((c1.z) >= (v6.w))
    {
        r4 = (v6.xyzx) * (c1.zzzw);
        r3 = (r4) + (-(c9.xyzz));
