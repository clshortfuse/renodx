// Mechanically reconstructed from 0x76299F39.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = saturate((r1.w) * (c[24].x) + (c[24].y));
    r1.w = rsqrt(r0.w);
    r0.w = (r2.y) * (r2.y);
    ...
    r7.w = exp2(r0.y);
    r6.w = 1.0f / (r0.x);
    r0.w = pow(abs(r5.w), r7.w);
    r5.w = (r7.w) * (c3.y) + (c3.z);
    r0.w = (r0.w) * (r5.w);
    r6.y = max(abs(r9.y), abs(r9.z));
    r6.z = (r0.z) * (r0.w);
    r0.w = max(abs(r9.x), r6.y);
    r0.w = 1.0f / (r0.w);
