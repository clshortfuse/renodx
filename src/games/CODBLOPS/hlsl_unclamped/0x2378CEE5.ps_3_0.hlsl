// Mechanically reconstructed from 0x2378CEE5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (-(r0.z)) + (c3.x);
    r5.xy = (c[8].zz) * (r3.xy) + (r0.xy);
    r0.z = (r0.w) * (r0.w);
    r0.z = (r0.z) * (r0.z);
    r6.xy = (v1.xy) + (c1.xx);
    r5.w = (r0.w) * (r0.z);
    r3.w = c1.y;
    r1.xy = (r6.xy) * (c[22].xx) + (r3.ww);
    r0 = tex2D(s0, v1.xy);
    r3.xyz = (r0.xyz) * (v0.xyz);
    r1 = tex2D(s6, r1.xy);
    r4.xyz = (r3.xyz) * (-(r3.xyz)) + (r1.xyz);
    r0.xy = (r6.xy) * (c[21].xx) + (r3.ww);
    r0 = tex2D(s5, r0.xy);
    r8.w = (v8.w) * (c1.z) + (-(r0.x));
    r0.w = (r1.w) + (c3.z);
    r9.w = saturate((r8.w) * (c1.w));
    r1 = tex2D(s7, v1.xy);
    r1.xy = (r1.wy) * (c0.xy) + (c0.zw);
    r0.xyz = (r4.xyz) * (r0.yyy);
    r4.xy = lerp(r5.xy, r1.xy, r9.ww);
    r3.w = c3.x;
    r1 = v2;
    ...
    r11.xyz = (r2.www) * (v7.xyz);
    r4.z = saturate(dot(r10.xyz, r2.xyz));
    r10.w = saturate(dot(r10.xyz, -(r11.xyz)));
    r2 = tex2D(s3, v1.xy);
    r8.xyz = (r2.xyz) * (-(r2.xyz)) + (c3.xxx);
    r1.z = (r2.w) * (-(c4.y)) + (c4.z);
    r1.x = (r2.w) * (c4.y);
    r9.xyz = (r2.xyz) * (r2.xyz);
    r1.y = (r10.w) * (r1.z) + (r1.x);
    r14.xy = (r2.ww) * (c12.xy) + (c12.zw);
    r4.w = saturate(dot(r10.xyz, c[17].xyz));
    r2.z = exp2(r14.y);
    r1.z = (r4.w) * (r1.z) + (r1.x);
    r1.x = pow(abs(r4.z), r2.z);
    r1.z = (r1.z) * (r1.y) + (c4.w);
    r1.y = (r2.z) * (c13.x) + (c13.y);
    r1.z = 1.0f / (r1.z);
    r2.z = (r1.x) * (r1.y);
    r2.y = (r4.w) * (r1.z);
    ...
    r3.xyz = (r4.xxx) * (c[18].xyz);
    r1.xyz = (r1.xyz) * (c[7].yyy);
    r12.xyz = (r4.www) * (r3.xyz);
    r13.xyz = (r1.xyz) * (c4.xxx);
    if ((c3.x) >= (v6.w))
    {
        r4 = (v6.xyzx) * (c3.xxxy);
        r3 = (r4) + (-(c14.xyzz));
    ...
    r2.w = ((r8.w) >= 0.0f ? (r2.w) : (c3.y));
    r0.xyz = (r0.xyz) * (r2.xyz);
    r2.w = (r2.w) * (r2.w);
    r0.xyz = (r0.xyz) * (c[7].xxx) + (r1.xyz);
    r1.z = (r2.w) * (c[23].w);
    r2.xyz = (c[23].xyz) * (r1.zzz) + (r0.xyz);
    r2.w = c3.x;
    r0.z = dot(r2, c[20]);
    r0.x = dot(r2, c[10]);
    r0.y = dot(r2, c[11]);
