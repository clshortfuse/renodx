// Mechanically reconstructed from 0x2ED31EE7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = 1.0f / (r2.w);
    r11.w = (r1.w) * (r2.w);
    r11.xyz = (r11.xyz) * (r1.xxx) + (-(r3.xyz));
    r2.xyz = normalize(r11.xyz);
    r11.xy = (r13.xx) * (c13.xy) + (c13.zw);
