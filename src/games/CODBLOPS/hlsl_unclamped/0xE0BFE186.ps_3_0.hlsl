// Mechanically reconstructed from 0xE0BFE186.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s5, v7.xy);
    r5.w = (r0.w) * (v0.y) + (c3.w);
    r5.xy = float2(((r5.w) >= 0.0f ? (r1.x) : (r3.x)), ((r5.w) >= 0.0f ? (r1.y) : (r3.y)));
    r1 = (c3.xxxx) * (v9) + (c3.yyyy);
    r4.y = dot(r2.xy, r1.zw) + (c3.z);
    r4.x = dot(r2.xy, r1.xy) + (c3.z);
    r1 = tex2D(s0, v1.xy);
    r3 = tex2D(s9, v1.xy);
    r2 = tex2D(s10, v7.xy);
    ...
    r1.xyz = float3(((r4.w) >= 0.0f ? (r1.x) : (r3.x)), ((r4.w) >= 0.0f ? (r1.y) : (r3.y)), ((r4.w) >= 0.0f ? (r1.z) : (r3.z)));
    ...
    r1.w = (-(r1.w)) + (-(c3.y));
    r2.xyw = c[33].xyw;
    r2.xyz = float3(((r5.w) >= 0.0f ? (r2.x) : (c[32].x)), ((r5.w) >= 0.0f ? (r2.y) : (c[32].y)), ((r5.w) >= 0.0f ? (r2.w) : (c[32].w)));
    r2.w = (r1.w) * (r1.w);
    r2.w = (r2.w) * (r2.w);
    r4.xyz = v2.xyz;
    ...
    r5.w = (r7.w) * (c15.z) + (c15.w);
    r3.y = (r2.w) * (r0.y);
    r3.z = (r0.z) * (r5.w);
    r0.xyz = (r15.xyz) * (r5.zzz) + (r16.xyz);
    r3.z = (r3.y) * (r3.z);
    r14.xyz = float3(((r4.w) >= 0.0f ? (c[34].x) : (r2.x)), ((r4.w) >= 0.0f ? (c[34].y) : (r2.y)), ((r4.w) >= 0.0f ? (c[34].w) : (r2.z)));
    r0.xyz = (r0.xyz) * (r3.zzz);
    r13.xyz = (r1.xyz) * (r14.yyy);
