// Mechanically reconstructed from 0x059F0E54.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = lerp(r2.yyy, c[27].xyw, r3.www);
    ...
    r5.w = r2.w;
    r1 = tex2D(s0, v1.xy);
    r5.xyz = lerp(r1.xyz, c1.zzz, r2.xxx);
    r1.w = (r0.w) + (r0.w);
    r0 = lerp(r5, r4, r3.wwww);
    r4.xyz = (r7.xyz) * (-(r1.www)) + (r10.xyz);
    r4.w = (r0.w) * (c3.z);
    ...
    r11.xyz = (v0.zzz) * (r5.xyz) + (-(c1.yyy));
    r9.xyz = (v0.www) * (r4.xyz) + (-(c1.yyy));
    ...
    r2.z = (-(r6.w)) + (-(c1.y));
    r6.w = pow(abs(r2.y), r7.w);
    r2.x = (r2.z) * (r2.z);
    r2.y = (r7.w) * (c13.y) + (c13.z);
    r2.x = (r2.x) * (r2.x);
    r2.y = (r6.w) * (r2.y);
    r2.z = (r2.z) * (r2.x);
    r4.w = (r4.w) * (r2.y);
    r2.xyz = (r4.xyz) * (r2.zzz) + (r5.xyz);
    r0.w = (r5.w) * (r0.w);
