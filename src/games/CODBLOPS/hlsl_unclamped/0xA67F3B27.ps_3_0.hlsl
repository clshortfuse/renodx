// Mechanically reconstructed from 0xA67F3B27.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = tex2D(s0, v1.xy);
    r8.xyz = lerp(r3.xyz, r1.xyz, r4.www);
    r4 = tex2D(s3, v7.zw);
    r0.xyz = (r4.xyz) * (v0.zzz);
    r1.xy = (v1.zw) * (c2.xy);
    r3 = tex2D(s13, r1.xy);
    r1.xy = (v1.zw) * (c2.xy) + (c2.zy);
    r5 = tex2D(s13, r1.xy);
    r3.w = r5.y;
    r0.xyz = (r0.xyz) * (r4.www) + (r8.xyz);
    r1.xy = (r3.yw) * (c4.xx) + (c4.yy);
    r2.w = dot(r11.xy, r11.xy) + (c12.y);
    r1.z = dot(r1.xy, r1.xy) + (c12.y);
    r2.w = exp2(-(r2.w));
    r1.z = exp2(-(r1.z));
    r2.w = (r2.w) * (c12.z) + (c12.w);
    r2.z = (r1.z) * (c12.z) + (c12.w);
    r1.z = dot(r1.xy, r11.xy) + (c12.y);
    r1.y = (r2.w) * (r2.z);
    r4 = tex2D(s14, v1.zw);
    r8.xy = (r4.xy) * (c2.ww);
