// Mechanically reconstructed from 0x6F480A52.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = r2.y;
    r1.x = dot(r5.xy, r1.xy) + (c3.w);
    r3 = tex2D(s1, v1.xy);
    r3.xy = (r3.wy) * (c1.xy) + (c1.zw);
    r4 = tex2D(s2, v6.xy);
    r4.w = (r4.w) * (v0.y);
    r1.y = dot(r5.xy, r1.zw) + (c3.w);
    r6.xy = (r4.ww) * (-(r3.xy)) + (r3.xy);
    r5 = tex2D(s3, v6.zw);
    r9.w = (r5.w) * (v0.z);
    r3.xy = (r0.yw) * (c4.xx) + (c4.yy);
    r8.xy = lerp(r6.xy, r1.xy, r9.ww);
    r0.w = dot(r3.xy, r3.xy) + (c3.w);
    r0.y = dot(r8.xy, r8.xy) + (c3.w);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c2.x) + (c2.y);
    r3.w = (r0.y) * (c2.x) + (c2.y);
    ...
    r10.xy = lerp(r0.xy, c[24].xy, r9.ww);
    r5.w = (r0.w) + (r0.w);
    r2 = tex2D(s5, v1.xy);
    r1 = tex2D(s6, v6.zw);
