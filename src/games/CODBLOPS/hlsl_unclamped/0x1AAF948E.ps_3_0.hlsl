// Mechanically reconstructed from 0x1AAF948E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.w = (r0.z) * (r12.w) + (r12.z);
    r0.y = (r1.x) * (r12.w) + (r12.z);
    r1.z = (r0.y) * (r11.w) + (c3.z);
    r0.xy = (r1.ww) * (c15.xy) + (c15.zw);
    r2.w = 1.0f / (r1.z);
    r10.w = exp2(r0.y);
    r0.y = pow(abs(r4.w), r10.w);
    r1.z = (r10.w) * (c4.x) + (c4.y);
    r2.w = (r1.x) * (r2.w);
    r0.y = (r0.y) * (r1.z);
    r4.w = (r2.w) * (r0.y);
    r4.y = 1.0f / (r0.x);
