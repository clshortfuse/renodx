// Mechanically reconstructed from 0xD971FC70.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s7, v1.xy);
    r2 = tex2D(s0, v1.xy);
    r7.xyz = float3(((r3.w) >= 0.0f ? (r0.x) : (r2.x)), ((r3.w) >= 0.0f ? (r0.y) : (r2.y)), ((r3.w) >= 0.0f ? (r0.z) : (r2.z)));
    r0 = tex2D(s8, v8.xy);
    r11.xy = float2(((r3.w) >= 0.0f ? (r0.w) : (r1.w)), ((r3.w) >= 0.0f ? (r0.y) : (r1.y)));
    r0.w = dot(r3.xy, r3.xy) + (c3.x);
    r11.w = (r11.x) * (-(c15.x)) + (c15.y);
    r0.w = exp2(-(r0.w));
    r3.w = (r0.w) * (c3.y) + (c3.z);
    ...
    r1 = tex2D(s14, v1.zw);
    r5.xy = (r1.xy) * (c4.xx);
    r6.xy = (r2.yw) * (c4.yy) + (c4.zz);
    r4.xy = (r2.xz) * (r5.xx);
    r0.w = dot(r6.xy, r3.xy) + (c3.x);
    r0.y = (r1.x) * (c4.x) + (-(r4.x));
    r1.w = (r2.z) * (-(r5.x)) + (r0.y);
    r2.xy = (r0.xz) * (r5.yy);
    r0.y = (r1.y) * (c4.x) + (-(r2.x));
    ...
    r6.xz = (r4.xy) * (c4.yy);
    r1.xyz = (r3.yyy) * (v4.xyz) + (r0.xyz);
    r0.xyz = (r6.xyz) * (r3.www) + (r2.xyz);
    ...
    r4.z = (r1.w) * (r3.w);
    r10.y = (r11.x) * (c15.x);
    r3.w = saturate(dot(r1.xyz, r9.xyz));
    r1.w = saturate(dot(r9.xyz, -(r3.xyz)));
    r1.z = (r3.w) * (r11.w) + (r10.y);
    r10.z = (r1.w) * (r11.w) + (r10.y);
    r1.z = (r1.z) * (r10.z) + (c4.w);
    r1.w = (-(r1.w)) + (c1.z);
    r1.y = 1.0f / (r1.z);
    r1.z = (r1.w) * (r1.w);
    r4.y = (r3.w) * (r1.y);
    ...
    r1.xy = (r11.xx) * (c16.xy) + (c16.zw);
    r8.z = (r1.z) + (r1.z);
    r1.z = 1.0f / (r1.x);
    r10.w = exp2(r1.y);
    r1.y = saturate(dot(r9.xyz, r0.xyz));
    r0.z = pow(abs(r1.y), r10.w);
    r8.w = (r10.w) * (c13.x) + (c13.y);
    r6.w = (r1.w) * (r1.z);
    r4.w = (r0.z) * (r8.w);
    r1 = tex2D(s6, v8.zw);
    r0.xyz = (r1.xyz) + (c1.yyy);
    r4.w = (r4.y) * (r4.w);
    r1.xyz = (v0.zzz) * (r0.xyz) + (c1.zzz);
    r0.xyz = (r7.xyz) * (r1.xyz);
    r1.xyz = (r1.xyz) * (c1.www);
    r5.xyz = (r1.xyz) * (-(r1.xyz)) + (c1.zzz);
    r7.xyz = (r1.xyz) * (r1.xyz);
    r4.xyz = (r5.xyz) * (r4.zzz) + (r7.xyz);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r1.w = (r11.x) * (c3.w);
    r1.xyz = (r9.xyz) * (-(r8.zzz)) + (r3.xyz);
    r1 = texCUBElod(s15, r1);
    r8.xyz = (v7.xyz) * (-(r7.www)) + (c[17].xyz);
    ...
    r7.w = (r7.w) * (r7.w);
    r7.w = (r1.w) * (r7.w);
    r1.w = (r9.w) * (r11.w) + (r10.y);
    r1.w = (r1.w) * (r10.z) + (c4.w);
    r3.y = saturate(dot(r9.xyz, r3.xyz));
    r3.z = 1.0f / (r1.w);
    r1.w = pow(abs(r3.y), r10.w);
    r3.z = (r9.w) * (r3.z);
    r1.w = (r8.w) * (r1.w);
    r1.w = (r3.z) * (r1.w);
    ...
    r7.xyz = (r2.xyz) * (c3.www) + (r3.xyz);
    r1.xyz = (r1.xyz) * (c[22].xyz);
    r3.xyz = (r11.yyy) * (r1.xyz);
    r1 = (v7.yyyy) * (c[32]);
