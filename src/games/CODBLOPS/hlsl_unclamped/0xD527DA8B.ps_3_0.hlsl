// Mechanically reconstructed from 0xD527DA8B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r4.w) * (r2.w);
    r2.w = (r3.w) * (r2.w);
    r4.w = max(abs(r0.y), abs(r0.z));
    r3.w = (r1.y) * (r2.w);
    r2.w = max(abs(r0.x), r4.w);
    r2.w = 1.0f / (r2.w);
    r2.xyz = (r0.xyz) * (c[5].xyz);
    r5.xyz = (r3.www) * (c[19].xyz);
