// Mechanically reconstructed from 0x977D2317.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = dot(r2.xy, r0.xy) + (c11.z);
    r0.y = dot(r2.xy, r0.zw) + (c11.z);
    r2 = tex2D(s2, v6.xy);
    r7.w = (r2.w) * (v0.y);
    ...
    r3.z = dot(r3.xy, r3.xy) + (c11.z);
    r0.z = dot(r0.xy, r0.xy) + (c11.z);
    r3.z = exp2(-(r3.z));
    r0.z = exp2(-(r0.z));
    r3.z = (r3.z) * (c2.y) + (c2.z);
    r4.w = (r0.z) * (c2.y) + (c2.z);
    r0.z = dot(r3.xy, r0.xy) + (c11.z);
    r0.y = (r3.z) * (r4.w);
    r6.y = (r3.w) + (r3.w);
