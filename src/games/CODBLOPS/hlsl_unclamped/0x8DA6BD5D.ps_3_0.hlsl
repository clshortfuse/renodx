// Mechanically reconstructed from 0x8DA6BD5D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.y = (r0.z) + (r0.z);
    r0.yz = c1.yz;
    r3.xyz = float3(((r7.w) >= 0.0f ? (r0.y) : (c[5].x)), ((r7.w) >= 0.0f ? (r0.z) : (c[5].y)), ((r7.w) >= 0.0f ? (r0.y) : (c[5].w)));
    r0.xyz = (r5.xyz) * (r0.www) + (r4.xyz);
    r9.xyz = lerp(r3.xyz, c1.zzz, r6.www);
