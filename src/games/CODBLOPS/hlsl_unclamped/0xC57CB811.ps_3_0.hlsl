// Mechanically reconstructed from 0xC57CB811.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r6.w = (r0.w) * (v0.w) + (c1.x);
    r5.xy = float2(((r6.w) >= 0.0f ? (r1.x) : (c1.z)), ((r6.w) >= 0.0f ? (r1.y) : (c1.z)));
    r1 = v2;
    ...
    r1.y = c1.z;
    r1.xyz = float3(((r6.w) >= 0.0f ? (c[31].x) : (r1.y)), ((r6.w) >= 0.0f ? (c[31].y) : (r1.y)), ((r6.w) >= 0.0f ? (c[31].w) : (r1.y)));
