// Mechanically reconstructed from 0x31700CE2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r2.w) + (r2.w);
    r6.xyz = (r0.xyz) * (r1.xyz) + (r4.xyz);
    r1.xyz = (r9.xyz) * (-(r2.www)) + (r3.xyz);
    r1 = texCUBElod(s15, r1);
    r1.xyz = (r1.xyz) * (r1.xyz);
    r7.xyz = (r1.xyz) * (c[28].xxx);
    r1.w = (r3.w) * (r3.w);
    r5.w = (r3.w) * (r1.w);
    r4 = (-(v7.yyyy)) + (c[6]);
    r1 = (r4) * (r4);
