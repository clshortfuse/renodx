// Mechanically reconstructed from 0x9D9C79F0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s4, v7.xy);
    r7.w = (r0.w) * (v0.y) + (c2.w);
    r12.xyz = float3(((r7.w) >= 0.0f ? (r4.x) : (r5.x)), ((r7.w) >= 0.0f ? (r4.y) : (r5.y)), ((r7.w) >= 0.0f ? (r4.z) : (r5.z)));
    r2.z = (r12.z) * (c4.x);
    r2.w = (r12.z) * (-(c13.x)) + (c13.y);
    r4.xyz = v2.xyz;
    r4.xyz = (r12.xxx) * (v4.xyz) + (r4.xyz);
    ...
    r1.z = (r1.w) * (r2.w) + (r2.z);
    r2.z = (r1.x) * (r2.w) + (r2.z);
    r2.w = lerp(r3.y, r4.w, c[8].w);
    r1.z = (r1.z) * (r2.z) + (c13.z);
