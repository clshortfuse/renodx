// Mechanically reconstructed from 0x48F11D49.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = 1.0f / (r3.w);
    r1.z = dot(c[36].yz, r1.xy) + (c[36].x);
    r1.xy = saturate((r1.xx) * (c[37].xy) + (c[37].zw));
    r0.xy = (r1.xy) * (r1.xy);
    ...
    r1.xyz = (r10.xyz) * (-(r8.zzz)) + (r6.xyz);
    r1 = texCUBElod(s15, r1);
    r1.w = (r8.w) * (r8.w);
    r1.xyz = (r1.xyz) * (r1.xyz);
    r1.w = (r8.w) * (r1.w);
    r4.xyz = (r1.xyz) * (c[39].xxx);
    r1.w = (r4.w) * (r1.w);
