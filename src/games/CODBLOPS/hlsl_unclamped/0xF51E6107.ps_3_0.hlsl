// Mechanically reconstructed from 0xF51E6107.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xy = (r3.xy) * (r4.xy);
    r5.xyz = lerp(r2.yyy, c[29].xyw, r11.www);
    r0.w = (r0.w) * (r3.x);
    r2.xyz = (r0.xyz) * (r5.yyy);
    r4.w = (r3.y) * (r0.w);
    r3 = tex2D(s12, v1.zw);
    r0 = v2;
