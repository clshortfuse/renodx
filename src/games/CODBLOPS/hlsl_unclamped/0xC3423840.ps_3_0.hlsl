// Mechanically reconstructed from 0xC3423840.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c41 = float4(0.00048828125f, -0.000122070312f, 0.0f, 0.0f);
    const float4 c42 = float4(3.5f, -13.0f, 1.0f, 13.0f);
    const float4 c43 = float4(2.0f, -1.0f, 1.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r1 = tex2D(s0, v1.xy);
    r1.w = (r1.w) * (-(v0.x)) + (c43.z);
    r0 = tex2D(s4, v7.xy);
    r6.w = (r0.w) * (v0.y);
    r0.w = (r0.w) * (-(v0.y)) + (c43.z);
    r2.xyz = lerp(r1.xyz, r0.xyz, r6.www);
    r1.w = (r1.w) * (-(r0.w)) + (c43.z);
    r0 = tex2D(s7, v7.zw);
    r3.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c43.xxxx) * (v8) + (c43.yyyy);
    r1.y = dot(r3.xy, r0.zw) + (c43.w);
    r1.x = dot(r3.xy, r0.xy) + (c43.w);
    r0 = tex2D(s6, v7.xy);
    r3.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r1.w = (-(r1.w)) + (c43.z);
    ...
    r0.w = (r0.w) * (-(v0.z)) + (c43.z);
    r5.w = (r1.w) * (-(r0.w)) + (c43.z);
    r0.w = dot(r10.xy, r10.xy) + (c43.w);
    ...
    r0.y = (r1.x) * (c4.w) + (-(r2.x));
    r0.w = dot(r6.xy, r10.xy) + (c43.w);
    r1.w = (r2.z) * (-(r4.x)) + (r0.y);
    r3.xy = (r0.xz) * (r4.yy);
    r0.x = dot(r6.xy, r6.xy) + (c43.w);
    r0.y = (r1.y) * (c4.w) + (-(r3.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r0.z) * (-(r4.y)) + (r0.y);
    r0.z = (r0.x) * (c4.x) + (c4.y);
    ...
    r0 = (r0) + (c43.wwwy);
    r9.xz = (r2.xy) * (c12.ww);
    r3 = (r6.wwww) * (r0) + (c43.wwwz);
    r1 = tex2D(s9, v7.zw);
    r2 = (r1.wwww) * (c3.xxxy) + (c3.zzzx);
    r4.xyz = (r9.xyz) * (r6.zzz) + (r4.xyz);
    ...
    r17.yz = c43.yz;
    r7.xyz = (r17.yyy) + (c[39].xyw);
    r8.xyz = (r3.xyz) * (r1.www) + (-(r6.xyz));
    r2.xyz = normalize(r8.xyz);
    r3.xyz = (r3.xyz) * (r1.www);
    r7.xyz = (r6.www) * (r7.xyz) + (c43.zzz);
    r1.w = saturate(dot(r2.xyz, r3.xyz));
    r13.xyz = lerp(r7.xyz, r1.yyy, r4.www);
    r1.w = (-(r1.w)) + (c43.z);
    r12.xyz = (r4.xyz) * (r13.yyy);
    r1.z = (r1.w) * (r1.w);
    r12.w = (r0.w) * (-(c13.z)) + (c13.w);
    r1.z = (r1.z) * (r1.z);
    r14.xyz = (r0.xyz) * (-(r0.xyz)) + (c43.zzz);
    r1.w = (r1.w) * (r1.z);
    r15.xyz = (r0.xyz) * (r0.xyz);
    r0.xyz = v2.xyz;
    r1.xyz = (r10.xxx) * (v4.xyz) + (r0.xyz);
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c43.z) : (c43.w));
    ...
    r0 = tex2Dproj(s2, r0);
    r1.z = r0.x;
    r0 = (v6.xyzx) * (c43.zzzw) + (c43.wwwz);
    r6.w = dot(r1, c14.zzzz);
    r1.w = dot(r0, c[28]);
    r1.w = 1.0f / (r1.w);
    r2.x = dot(r0, c[27]);
    r1.x = dot(r0, c[25]);
    ...
    r0.xy = (r0.xy) * (r0.xy);
    r0.w = ((-abs(r0.w)) >= 0.0f ? (c43.w) : (r0.z));
    r0.z = (r2.x) * (r0.x);
    r0.w = (r0.w) * (r0.z);
    r0.z = (r0.y) * (-(r2.y)) + (c43.z);
    r0.xy = (r1.ww) * (r1.xy);
    r0.w = (r0.w) * (r0.z);
    r7.w = (r3.z) * (r0.w);
    ...
    r0 = saturate((r0) * (c[8]) + (r17.zzzz));
    r3.xyz = (r7.xyz) * (r8.xyz) + (r9.xyz);
    r0 = (r1) * (r0);
    r2.z = dot(c[11], r0);
    r1.w = dot(c[36].xyz, r6.xyz);
    r1.w = saturate((c[38].y) * (r1.w) + (c[38].x));
    r1.xyz = c[0].xyz;
