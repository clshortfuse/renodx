// Mechanically reconstructed from 0xF82FB505.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = (r0.z) + (r0.z);
    r14.yz = c1.yz;
    r3.xyz = float3(((r7.w) >= 0.0f ? (r14.y) : (c[20].x)), ((r7.w) >= 0.0f ? (r14.z) : (c[20].y)), ((r7.w) >= 0.0f ? (r14.y) : (c[20].w)));
    r0.xyz = (r8.xyz) * (r0.www) + (r4.xyz);
    r7.xyz = lerp(r3.xyz, c[21].xyw, r8.www);
