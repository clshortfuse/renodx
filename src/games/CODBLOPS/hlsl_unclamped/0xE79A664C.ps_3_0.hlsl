// Mechanically reconstructed from 0xE79A664C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c0 = float4(1.0f, 0.5f, 0.25f, 0.0f);
    ...
    r5.xyz = (r0.xyz) * (r8.xyz);
    r3 = (r3) * (r4);
    r5.xyz = (r5.xyz) * (c1.zzz) + (r9.xyz);
    r4.x = dot(c[10], r3);
    r4.y = dot(c[11], r3);
    r4.z = dot(c[20], r3);
    clip(r2.wwxx);
