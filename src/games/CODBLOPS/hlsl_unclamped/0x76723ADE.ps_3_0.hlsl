// Mechanically reconstructed from 0x76723ADE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c6 = float4(1.0f, -1.0f, 0.200000003f, 0.0f);
    ...
    r2.w = dot(r12.xy, r12.xy) + (c6.w);
    r2.z = dot(r4.xy, r4.xy) + (c6.w);
    r2.w = exp2(-(r2.w));
    r2.z = exp2(-(r2.z));
    r2.w = (r2.w) * (c1.x) + (c1.y);
    r2.x = (r2.z) * (c1.x) + (c1.y);
    r2.z = dot(r4.xy, r12.xy) + (c6.w);
    r2.x = (r2.w) * (r2.x);
    r4 = tex2D(s14, v1.zw);
    r13.xy = (r4.xy) * (c2.ww);
