// Mechanically reconstructed from 0x156840EA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.x = 1.0f / (r6.w);
    r2.y = (r0.w) + (r0.w);
    r1.xy = saturate((r7.xx) * (c[9].xy) + (c[9].zw));
    r0.xy = (r1.xy) * (r1.xy);
    r1.xy = (r1.xy) * (c3.zz) + (c3.ww);
    r0.w = dot(c[8].yz, r7.xy) + (c[8].x);
    r1.xy = (r0.xy) * (r1.xy);
    r0.xyz = (r2.xyz) * (r3.www) + (r4.xyz);
    r0.w = (r0.w) * (r1.x);
