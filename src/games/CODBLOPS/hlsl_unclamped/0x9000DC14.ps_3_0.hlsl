// Mechanically reconstructed from 0x9000DC14.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.w = (r1.w) * (r1.w);
    r8.xyz = (r10.yyy) * (v3.xyz) + (r0.xyz);
    r3 = tex2D(s5, v0.xy);
    r2 = tex2D(s6, v7.zw);
    r1 = tex2D(s4, v7.zw);
    r7.w = (r1.w) * (v7.y) + (c1.x);
    r0.xyz = normalize(r8.xyz);
    r9.xy = float2(((r7.w) >= 0.0f ? (r2.w) : (r3.w)), ((r7.w) >= 0.0f ? (r2.y) : (r3.y)));
    ...
    r2.w = dot(r10.xy, r10.xy) + (c1.y);
    r2.y = dot(r3.xy, r3.xy) + (c1.y);
    r2.w = exp2(-(r2.w));
    r2.y = exp2(-(r2.y));
    r2.w = (r2.w) * (c1.z) + (c1.w);
    r3.w = (r2.y) * (c1.z) + (c1.w);
    r2.y = dot(r3.xy, r10.xy) + (c1.y);
    r4.w = (r2.w) * (r3.w);
    r3 = tex2D(s14, v0.zw);
    r10.xy = (r3.xy) * (c3.zz);
