// Mechanically reconstructed from 0x075F64D4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = dot(r1.xy, r0.zw) + (c31.z);
    r2.x = dot(r1.xy, r0.xy) + (c31.z);
    r0 = tex2D(s1, v0.xy);
    ...
    r1.x = (r1.z) * (r6.z) + (c13.x);
    r1.z = saturate(dot(r2.xyz, r0.xyz));
    r1.x = 1.0f / (r1.x);
    r2.z = (r2.w) * (r1.x);
    r13.xy = (r1.ww) * (c30.xy) + (c30.zw);
    r6.w = exp2(r13.y);
    r1.x = (-(r1.z)) + (c31.w);
    r1.z = pow(abs(r3.z), r6.w);
    r2.y = (r1.x) * (r1.x);
    ...
    r1.x = (r1.x) * (r2.y);
    r1.z = (r2.z) * (r1.z);
    r1.x = (r1.x) * (c16.x) + (c16.y);
    r5.w = (r4.w) * (c1.x) + (c1.y);
    r1.z = (r1.z) * (r1.x);
    r8.w = lerp(r1.y, c31.w, r3.w);
    r1.xyz = (r1.zzz) * (c[7].xyz);
    r2.xyz = (r8.www) * (r1.xyz);
    r1.xyz = (r2.www) * (c[6].xyz);
    r7.xyz = (r8.xyz) * (r1.xyz) + (r2.xyz);
    r1.xy = (v0.zw) * (c16.zw);
    r4 = tex2D(s13, r1.xy);
    ...
    r1.z = (r3.y) * (c3.w) + (-(r5.x));
    r1.z = (r2.z) * (-(r1.y)) + (r1.z);
    r0.y = dot(r0.xy, r0.xy) + (c31.z);
    r9.y = (r1.x) + (r1.x);
    r0.x = exp2(-(r0.y));
    r0.y = (r1.z) + (r1.z);
    r0.x = (r0.x) * (c1.x) + (c1.y);
    r0.x = (r5.w) * (r0.x);
    r2.xyz = (v6.xyz) * (-(r9.zzz)) + (c[17].xyz);
    ...
    r1.y = (r2.y) * (r6.z) + (c13.x);
    r1.z = pow(abs(r2.z), r6.w);
    r1.y = 1.0f / (r1.y);
    r1.z = (r5.z) * (r1.z);
    r1.x = (r3.w) * (r1.y);
    r1.y = (r2.w) * (c16.x) + (c16.y);
    r1.z = (r1.z) * (r1.x);
    r0.xyz = (r9.xyz) * (r5.www) + (r0.xyz);
    r1.z = (r1.y) * (r1.z);
    r12.xyz = (r8.www) * (r0.xyz);
    r10.w = (r8.w) * (r1.z);
    r2 = tex2D(s12, v0.zw);
    r0.z = ((-abs(r2.y)) >= 0.0f ? (c31.w) : (c31.z));
    ...
    r2.xy = (r2.xy) * (r2.xy);
    r0.z = ((-abs(r0.z)) >= 0.0f ? (c31.z) : (r2.w));
    r2.w = (r3.x) * (r2.x);
    r0.z = (r0.z) * (r2.w);
    r2.w = (r2.y) * (-(r3.y)) + (c31.w);
    r0.xy = (r3.ww) * (r0.xy);
    r0.z = (r0.z) * (r2.w);
    r3.w = (r4.z) * (r0.z);
    r0.xy = (r0.xy) * (c16.ww) + (c16.ww);
    r2 = tex2D(s4, r0.xy);
