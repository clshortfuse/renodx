// Mechanically reconstructed from 0xE950991E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = r4.y;
    r3.x = dot(r5.xy, r0.xy) + (c1.w);
    r1 = tex2D(s1, v0.xy);
    r0.xy = (r1.wy) * (c0.xy) + (c0.zw);
    r1 = tex2D(s0, v0.xy);
    r6.z = (r1.w) * (v6.x) + (c1.z);
    r3.y = dot(r5.xy, r0.zw) + (c1.w);
    r6.xy = float2(((r6.z) >= 0.0f ? (r0.x) : (c1.w)), ((r6.z) >= 0.0f ? (r0.y) : (c1.w)));
    r0 = tex2D(s2, v6.zw);
    r6.w = (r0.w) * (v6.y) + (c1.z);
    r5.xy = (r2.yw) * (c4.yy) + (c4.zz);
    r6.xy = float2(((r6.w) >= 0.0f ? (r3.x) : (r6.x)), ((r6.w) >= 0.0f ? (r3.y) : (r6.y)));
    ...
    r8.y = (r1.w) + (r1.w);
    r12.yw = c1.yw;
    r3.xyz = float3(((r6.z) >= 0.0f ? (c[20].x) : (r12.w)), ((r6.z) >= 0.0f ? (c[20].y) : (r12.w)), ((r6.z) >= 0.0f ? (c[20].w) : (r12.w)));
    r2.xyz = (r8.xyz) * (r0.www) + (r4.xyz);
    r11.xyz = float3(((r6.w) >= 0.0f ? (c[21].x) : (r3.x)), ((r6.w) >= 0.0f ? (c[21].y) : (r3.y)), ((r6.w) >= 0.0f ? (c[21].w) : (r3.z)));
    ...
    r7.xyz = (r2.yyy) * (r1.xyz) + (r4.xyz);
    r4 = tex2D(s4, v0.xy);
    r5 = float4(((r6.z) >= 0.0f ? (r4.x) : (-(c1.w))), ((r6.z) >= 0.0f ? (r4.y) : (-(c1.w))), ((r6.z) >= 0.0f ? (r4.z) : (-(c1.w))), ((r6.z) >= 0.0f ? (r4.w) : (-(c1.y))));
    r4 = float4(((r6.z) >= 0.0f ? (r3.x) : (c1.w)), ((r6.z) >= 0.0f ? (r3.y) : (c1.w)), ((r6.z) >= 0.0f ? (r3.z) : (c1.w)), ((r6.z) >= 0.0f ? (r3.w) : (c1.w)));
    r3 = tex2D(s5, v6.zw);
