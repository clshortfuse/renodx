// Mechanically reconstructed from 0x0F1DA707.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.y = dot(r1.xy, r0.zw) + (c21.w);
    r0.w = dot(v6.xyz, v6.xyz);
    r3.x = dot(r1.xy, r0.xy) + (c21.w);
    r4.w = rsqrt(r0.w);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r1.w = (r0.w) * (v0.y);
    ...
    r4.xy = (r1.ww) * (-(r4.xy)) + (r4.xy);
    r0 = tex2D(s4, v7.zw);
    r6.w = (r0.w) * (v0.z);
    r1.xyz = lerp(r2.xyz, r0.xyz, r6.www);
    r5.xy = lerp(r4.xy, r3.xy, r6.ww);
    r8.xyz = (r1.xyz) * (r1.xyz);
    r0.y = c21.z;
    r0.xyz = (r0.yyy) + (-(c[8].xyw));
    r1.xyz = (r1.www) * (r0.xyz) + (c[8].xyw);
    r0.xy = (v1.zw) * (c4.xy) + (c4.zy);
    r0 = tex2D(s13, r0.xy);
    r2.xy = (v1.zw) * (c4.xy);
    r2 = tex2D(s13, r2.xy);
    r0.w = r2.y;
    r11.xyz = lerp(r1.xyz, c[9].xyw, r6.www);
    r1.xy = (r0.wy) * (c12.xx) + (c12.yy);
    r0.y = dot(r5.xy, r5.xy) + (c21.w);
    r0.w = dot(r1.xy, r1.xy) + (c21.w);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r3.w = (r0.y) * (c3.x) + (c3.y);
    r0.y = (r0.w) * (c3.x) + (c3.y);
    r0.w = dot(r1.xy, r5.xy) + (c21.w);
    r0.y = (r3.w) * (r0.y);
    r1 = tex2D(s14, v1.zw);
    r4.xy = (r1.xy) * (c4.ww);
    ...
    r5.w = saturate(dot(r4.xyz, c[17].xyz));
