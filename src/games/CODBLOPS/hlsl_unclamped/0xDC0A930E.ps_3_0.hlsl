// Mechanically reconstructed from 0xDC0A930E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyz = (r2.xyz) * (c14.zzz);
    r1.xyz = (r0.xyz) * (r4.xyz);
    r0 = tex2D(s4, v8.xy);
    r2.xyz = (r0.xyz) + (c14.xxx);
    ...
    r1.x = dot(c[23].yz, r5.xy) + (c[23].x);
    r3.xy = (r3.xy) * (r4.xy);
    r2.xyz = (r1.yyy) * (r2.xyz);
    r1.x = (r1.x) * (r3.x);
    r7.xyz = (r2.xyz) * (c[22].xyz);
    r1.x = (r3.y) * (r1.x);
    r2 = tex2D(s12, v1.zw);
    r3.xy = (v1.zw) * (c2.xy);
    r3 = tex2D(s13, r3.xy);
    ...
    r2.z = dot(r4.xy, r4.xy) + (c14.w);
    r2.w = exp2(-(r2.w));
    r2.z = exp2(-(r2.z));
    r2.w = (r2.w) * (c1.x) + (c1.y);
    r2.x = (r2.z) * (c1.x) + (c1.y);
    r2.z = dot(r4.xy, r8.xy) + (c14.w);
    r2.x = (r2.w) * (r2.x);
    r4 = tex2D(s14, v1.zw);
    r13.xy = (r4.xy) * (c2.ww);
