// Mechanically reconstructed from 0x59286598.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s6, v7.zw);
    r0 = (r0) + (c1.yyyz);
    r3.xyz = (r2.www) * (r8.xyz) + (r14.xyz);
    r0.xyz = (r9.www) * (r0.xyz);
    r4.xyz = (r0.xyz) * (-(r0.xyz)) + (c1.xxx);
    r8.xyz = (r0.xyz) * (r0.xyz);
    r1.xyz = (r4.xyz) * (r10.www) + (r8.xyz);
    r2.y = (r9.w) * (r0.w) + (c1.x);
    r9.w = (r2.y) * (-(c38.z)) + (c38.w);
    r10.w = (r2.y) * (c4.z);
    r1.w = saturate(dot(r13.xyz, r9.xyz));
    r2.z = saturate(dot(r9.xyz, -(r12.xyz)));
    r0.w = (r1.w) * (r9.w) + (r10.w);
    r4.w = (r2.z) * (r9.w) + (r10.w);
    r0.z = (r0.w) * (r4.w) + (c12.x);
    r0.w = dot(r12.xyz, r9.xyz);
    r3.w = 1.0f / (r0.z);
    r0.z = (r0.w) + (r0.w);
    r0.w = (r2.y) * (c1.w);
    ...
    r6.x = exp2(r12.y);
    r6.y = saturate(dot(r9.xyz, r11.xyz));
    r0.w = (r6.x) * (c12.y) + (c12.z);
    r0.z = (r6.w) * (r9.w) + (r10.w);
    r0.z = (r0.z) * (r4.w) + (c12.x);
    r4.w = saturate(dot(r9.xyz, r10.xyz));
    r0.y = 1.0f / (r0.z);
    r0.z = pow(abs(r4.w), r6.x);
    r0.y = (r6.w) * (r0.y);
    r0.z = (r0.w) * (r0.z);
    r6.w = (r0.y) * (r0.z);
    r0.xyz = (r4.xyz) * (r8.www) + (r8.xyz);
    r4.w = pow(abs(r6.y), r6.x);
