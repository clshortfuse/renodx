// Mechanically reconstructed from 0xA1F5AB54.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = exp2(r0.y);
    r1.x = pow(abs(r2.z), r0.z);
    r0.z = (r0.z) * (c13.x) + (c13.y);
    r0.y = (r3.w) * (r3.z);
    r0.z = (r1.x) * (r0.z);
    r7.xyz = (r3.www) * (c[21].xyz);
    r0.z = (r0.y) * (r0.z);
    r6.w = 1.0f / (r0.x);
    r0.z = (r2.w) * (r0.z);
    r0.z = (r1.y) * (r0.z);
    ...
    r4 = tex2D(s13, r0.xy);
    r2.w = r4.y;
    r10.xyz = (r0.zzz) * (c[22].xyz);
    r0.xy = (r2.yw) * (c4.xx) + (c4.yy);
    r1.x = dot(r3.xy, r3.xy) + (c1.x);
    r0.z = dot(r0.xy, r0.xy) + (c1.x);
    r1.x = exp2(-(r1.x));
    r0.z = exp2(-(r0.z));
    r1.x = (r1.x) * (c1.y) + (c1.z);
    r2.w = (r0.z) * (c1.y) + (c1.z);
    r0.z = dot(r0.xy, r3.xy) + (c1.x);
    r0.y = (r1.x) * (r2.w);
    r3 = tex2D(s14, v1.zw);
    r8.xy = (r3.xy) * (c3.ww);
    ...
    r8.xz = (r2.xy) * (c4.xx);
    r8.y = (r2.w) + (r2.w);
    r4.xyz = (r6.xyz) * (r10.xyz);
    r10.xyz = (r8.xyz) * (r1.xxx) + (r0.xyz);
    r3 = tex2D(s0, v1.xy);
    r2 = tex2D(s4, v8.xy);
