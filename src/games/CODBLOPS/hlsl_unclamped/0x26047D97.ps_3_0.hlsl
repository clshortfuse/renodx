// Mechanically reconstructed from 0x26047D97.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.w = -(r3.w);
    r1 = (r1) + (r4);
    r4 = (r3.wwww) * (-(c2.zzzy)) + (-(c2.wwwz));
    r0.w = dot(c[5].xyz, r5.xyz);
    r1 = (r5.wwww) * (r1) + (r4);
    r8.xy = lerp(r3.yy, c[8].xy, r5.ww);
    r2.w = (r1.w) * (c3.z);
    r2 = texCUBElod(s15, r2);
    r2.w = (-(r6.w)) + (-(c2.y));
    r2.xyz = (r2.xyz) * (r2.xyz);
    r3.w = (r2.w) * (r2.w);
    r3.xyz = (r8.xxx) * (r2.xyz);
    r3.w = (r2.w) * (r3.w);
    r2 = tex2D(s3, v6.zw);
    r2.xyz = (r2.xyz) + (c2.yyy);
    r1.w = (r1.w) * (c4.x) + (c4.y);
    r6.xyz = (v0.zzz) * (r2.xyz) + (-(c2.yyy));
    r2 = tex2D(s4, v7.xy);
    r2.xyz = (r2.xyz) + (c2.yyy);
    ...
    r7.xz = (r7.xy) * (c11.xx);
    r1.y = r2.y;
    r2.z = (r2.z) * (-(r10.y)) + (r1.w);
    r1.xy = (r1.xy) * (c11.xx) + (c11.yy);
    r1.z = dot(r1.xy, r1.xy) + (c2.z);
    r1.w = dot(r9.xy, r9.xy) + (c2.z);
    r1.z = exp2(-(r1.z));
    r1.w = exp2(-(r1.w));
    r1.z = (r1.z) * (c3.x) + (c3.y);
    r2.w = (r1.w) * (c3.x) + (c3.y);
    r1.w = dot(r1.xy, r9.xy) + (c2.z);
    r1.z = (r1.z) * (r2.w);
    r7.y = (r2.z) + (r2.z);
