// Mechanically reconstructed from 0x69CB4B9D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r16.yz = c1.yz;
    r7.xyz = float3(((r1.z) >= 0.0f ? (r16.y) : (c[36].x)), ((r1.z) >= 0.0f ? (r16.z) : (c[36].y)), ((r1.z) >= 0.0f ? (r16.y) : (c[36].w)));
    ...
    r1.w = (r5.y) * (c15.y) + (c15.z);
    r5.w = (r8.w) * (r5.w) + (r9.w);
    r5.w = (r5.w) * (r7.y) + (c15.x);
