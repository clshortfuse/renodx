// Mechanically reconstructed from 0x8E151A95.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c24 = float4(0.00048828125f, -0.000122070312f, 0.0f, 0.0f);
    ...
    r0 = tex2D(s4, v7.zw);
    r4.z = (r0.w) * (v0.z) + (c3.y);
    r7.xy = float2(((r4.z) >= 0.0f ? (r2.x) : (r3.x)), ((r4.z) >= 0.0f ? (r2.y) : (r3.y)));
    r2 = tex2D(s6, v1.xy);
    r3 = tex2D(s3, v7.xy);
    r3.xyz = (r3.xyz) + (c26.yyy);
    r3.xyz = (v0.yyy) * (r3.xyz) + (c26.zzz);
    r3.w = r2.w;
    r1.xyz = (r1.xyz) * (r3.xyz);
    r6.xyz = float3(((r4.z) >= 0.0f ? (r0.x) : (r1.x)), ((r4.z) >= 0.0f ? (r0.y) : (r1.y)), ((r4.z) >= 0.0f ? (r0.z) : (r1.z)));
    r3.xyz = (r3.xyz) * (c26.www);
    r1 = tex2D(s7, v7.zw);
    r0 = (r1.wwww) * (c3.xxxz) + (c3.wwwx);
    r0 = float4(((r4.z) >= 0.0f ? (r0.x) : (r3.x)), ((r4.z) >= 0.0f ? (r0.y) : (r3.y)), ((r4.z) >= 0.0f ? (r0.z) : (r3.z)), ((r4.z) >= 0.0f ? (r0.w) : (r3.w)));
    r6.w = ((r4.z) >= 0.0f ? (r1.y) : (r2.y));
    ...
    r2 = tex2D(s14, v1.zw);
    r0.xy = (r2.xy) * (c12.ww);
    r8.xy = (r1.wy) * (c13.xx) + (c13.yy);
    r3.xy = (r3.xz) * (r0.xx);
    r0.z = dot(r8.xy, r7.xy) + (c3.x);
    r1.w = (r2.x) * (c12.w) + (-(r3.x));
    r1.w = (r3.z) * (-(r0.x)) + (r1.w);
    r1.xy = (r1.xz) * (r0.yy);
    r2.w = (r2.y) * (c12.w) + (-(r1.x));
    r0.x = dot(r8.xy, r8.xy) + (c3.x);
    r0.y = (r1.z) * (-(r0.y)) + (r2.w);
    r0.x = exp2(-(r0.x));
    r10.y = (r1.w) + (r1.w);
    r0.x = (r0.x) * (c4.x) + (c4.y);
    ...
    r2.z = exp2(r15.y);
    r2.y = saturate(dot(r9.xyz, r5.xyz));
    ...
    r14.xyz = (r6.www) * (r1.xyz);
    r13.xyz = (r6.www) * (r0.xyz);
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c3.z) : (c3.x));
