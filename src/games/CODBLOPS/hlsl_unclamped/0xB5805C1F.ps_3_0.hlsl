// Mechanically reconstructed from 0xB5805C1F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = dot(r3.xy, r0.xy) + (c2.z);
    r0.y = dot(r3.xy, r0.zw) + (c2.z);
    r6 = tex2D(s2, v6.zw);
    r6.w = (r6.w) * (v6.y);
    r3.xy = (r1.yw) * (c3.xx) + (c3.yy);
    r5.xy = lerp(r4.xy, r0.xy, r6.ww);
