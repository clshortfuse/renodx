// Mechanically reconstructed from 0xC8B59981.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xy = float2(((r4.w) >= 0.0f ? (r4.x) : (c1.z)), ((r4.w) >= 0.0f ? (r4.y) : (c1.z)));
    ...
    r11.yz = c1.yz;
    r4.xyz = float3(((r4.w) >= 0.0f ? (c[20].x) : (r11.z)), ((r4.w) >= 0.0f ? (c[20].y) : (r11.z)), ((r4.w) >= 0.0f ? (c[20].w) : (r11.z)));
    r0 = (r0.xyzx) * (c1.yyyz) + (c1.zzzy);
    r5.xyz = (r1.xyz) * (r4.yyy);
    r2 = tex2D(s12, v1.zw);
    r1 = v2;
