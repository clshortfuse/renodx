// Mechanically reconstructed from 0x5A6DA563.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xy = float2(((r1.z) >= 0.0f ? (r4.x) : (c0.z)), ((r1.z) >= 0.0f ? (r4.y) : (c0.y)));
    r4.z = (r7.y) * (c1.y);
    r3.w = (r7.y) * (-(c1.y)) + (c1.z);
