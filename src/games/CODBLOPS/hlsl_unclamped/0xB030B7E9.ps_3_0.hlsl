// Mechanically reconstructed from 0xB030B7E9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.x = dot(r4.xy, r0.xy) + (c11.z);
    r2.y = dot(r4.xy, r0.zw) + (c11.z);
    r0 = tex2D(s3, v6.zw);
    r9.w = (r0.w) * (v0.z);
    ...
    r2.w = dot(r2.xy, r2.xy) + (c11.z);
    r1.w = dot(r8.xy, r8.xy) + (c11.z);
    r2.w = exp2(-(r2.w));
    r1.w = exp2(-(r1.w));
    r2.z = (r2.w) * (c2.x) + (c2.y);
    r1.w = (r1.w) * (c2.x) + (c2.y);
    r2.w = dot(r2.xy, r8.xy) + (c11.z);
    r2.z = (r2.z) * (r1.w);
    r4.y = (r3.w) + (r3.w);
