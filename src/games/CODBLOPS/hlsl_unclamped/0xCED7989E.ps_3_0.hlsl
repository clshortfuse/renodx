// Mechanically reconstructed from 0xCED7989E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = dot(r4.xy, r4.xy) + (c12.z);
    r0.w = dot(r5.xy, r5.xy) + (c12.z);
    r1.w = exp2(-(r1.w));
    r0.w = exp2(-(r0.w));
    r1.w = (r1.w) * (c2.x) + (c2.y);
    r0.w = (r0.w) * (c2.x) + (c2.y);
