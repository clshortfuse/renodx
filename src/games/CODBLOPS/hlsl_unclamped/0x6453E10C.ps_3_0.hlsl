// Mechanically reconstructed from 0x6453E10C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xy = (r8.ww) * (-(r1.xy)) + (r1.xy);
    r1 = tex2D(s5, v8.zw);
    r7.w = (r1.w) * (v0.z);
    r7.xyz = (-(v7.xyz)) + (c[5].xyz);
    r15.xy = (r7.ww) * (-(r0.xy)) + (r0.xy);
    r1.w = dot(r7.xyz, r7.xyz);
    r0 = v2;
    r0.xyz = (r15.xxx) * (v5.xyz) + (r0.xyz);
    r8.z = rsqrt(r1.w);
    r4.xyz = (r15.yyy) * (v4.xyz) + (r0.xyz);
    ...
    r2.w = (r2.w) * (r4.w) + (c4.x);
    r2.w = 1.0f / (r2.w);
    r5.xyz = (r7.xyz) * (r8.zzz) + (-(r10.xyz));
    r5.w = (r1.w) * (r2.w);
    r4.xyz = normalize(r5.xyz);
    r13.xyz = (r1.www) * (c[6].xyz);
    r5.y = saturate(dot(r0.xyz, r4.xyz));
    ...
    r4.xyz = (r8.www) * (r3.xyz) + (c[29].xyw);
    r3.xy = (v1.zw) * (c2.xy);
    r3 = tex2D(s13, r3.xy);
    r5.xy = (v1.zw) * (c2.xy) + (c2.zy);
    r5 = tex2D(s13, r5.xy);
    r3.w = r5.y;
    r9.xyz = lerp(r4.xyz, c[31].xyw, r7.www);
    r4.xy = (r3.yw) * (c12.xx) + (c12.yy);
    r3.w = dot(r15.xy, r15.xy) + (c1.z);
    r3.y = dot(r4.xy, r4.xy) + (c1.z);
    r3.w = exp2(-(r3.w));
    r3.y = exp2(-(r3.y));
    r3.w = (r3.w) * (c3.x) + (c3.y);
    r4.w = (r3.y) * (c3.x) + (c3.y);
    r3.y = dot(r4.xy, r15.xy) + (c1.z);
    r5.w = (r3.w) * (r4.w);
    r4 = tex2D(s14, v1.zw);
    r15.xy = (r4.xy) * (c3.ww);
    ...
    r4.xz = (r3.xy) * (c2.ww);
    r4.y = (r3.z) + (r3.z);
    r5.xyz = (r14.xyz) * (r9.zzz);
    r3.xyz = (r4.xyz) * (r3.www) + (r6.xyz);
    r5.xyz = (r5.xyz) * (c[7].xyz);
    r3.xyz = (r9.yyy) * (r3.xyz);
    r6.xyz = (r12.xyz) * (r5.xyz);
    r5.xyz = (r12.xyz) * (r13.xyz) + (r3.xyz);
    r3 = tex2D(s0, v1.xy);
