// Mechanically reconstructed from 0x04345E8B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.z = (r0.w) * (v0.y);
    r8.w = (r1.w) * (r1.z);
    r6.xy = lerp(r2.xy, r1.xy, r8.zz);
    r1 = tex2D(s0, v1.xy);
    r4.xyz = lerp(r1.xyz, r0.xyz, r8.zzz);
    r3 = tex2D(s7, v1.xy);
    r2 = tex2D(s8, v7.xy);
    r0 = tex2D(s6, v7.zw);
    r7.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c3.xxxx) * (v9) + (c3.yyyy);
    r1.y = dot(r7.xy, r0.zw) + (c3.z);
    r1.x = dot(r7.xy, r0.xy) + (c3.z);
    r0 = tex2D(s4, v7.zw);
    r5.w = (r0.w) * (v0.z);
    r7.w = lerp(r3.y, r2.y, r8.z);
    r7.xy = lerp(r6.xy, r1.xy, r5.ww);
    r1.w = lerp(r3.w, r2.w, r8.z);
    ...
    r0.y = (r3.x) * (c12.w) + (-(r8.x));
    r0.w = dot(r4.xy, r7.xy) + (c3.z);
    r1.z = (r4.z) * (-(r2.x)) + (r0.y);
    r1.xy = (r0.xz) * (r2.yy);
    r0.x = dot(r4.xy, r4.xy) + (c3.z);
    r0.y = (r3.y) * (c12.w) + (-(r1.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r0.z) * (-(r2.y)) + (r0.y);
    r0.z = (r0.x) * (c4.x) + (c4.y);
    r0.y = (r0.y) + (r0.y);
    ...
    r1.w = (r1.w) * (r2.z);
    r13.xyz = lerp(r7.www, c[23].xyw, r5.www);
