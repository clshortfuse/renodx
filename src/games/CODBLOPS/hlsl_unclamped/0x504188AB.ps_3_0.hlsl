// Mechanically reconstructed from 0x504188AB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = r0.y;
    r14.w = rsqrt(r1.z);
    r1.xy = (r3.yw) * (c31.xx) + (c31.yy);
    r2 = tex2D(s14, v1.zw);
    r5.xy = (r2.xy) * (c3.ww);
    r2.w = dot(r1.xy, r7.xy) + (c1.z);
    r6.xy = (r3.xz) * (r5.xx);
    r0.w = (r2.x) * (c3.w) + (-(r6.x));
    r12.xy = (r0.xz) * (r5.yy);
    r0.y = (r3.z) * (-(r5.x)) + (r0.w);
    r0.w = (r2.y) * (c3.w) + (-(r12.x));
    r0.w = (r0.z) * (-(r5.y)) + (r0.w);
    r10.y = (r0.y) + (r0.y);
    r3.y = (r0.w) + (r0.w);
    ...
    r3.y = (r3.w) * (r3.w);
    r3.w = (r3.w) * (r3.y);
    r3.y = dot(r1.xyz, r13.xyz);
    r3.w = (r3.x) * (r3.w);
    r3.y = (r3.y) + (r3.y);
    r1.w = (r1.w) * (c1.w);
    r1.xyz = (r13.xyz) * (-(r3.yyy)) + (r1.xyz);
