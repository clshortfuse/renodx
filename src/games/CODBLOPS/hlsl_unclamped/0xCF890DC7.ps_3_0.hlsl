// Mechanically reconstructed from 0xCF890DC7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c36 = float4(4.0f, -3.0f, -2.0f, 3.0f);
    ...
    r11.w = (r1.w) * (-(c14.z)) + (c14.w);
    r3.xyz = (r1.xyz) * (r5.xyz);
    r2 = tex2D(s6, v8.xy);
    r1.xyz = (r2.xyz) + (c3.yyy);
    r2.xyz = (v0.www) * (r1.xyz) + (-(c3.yyy));
    r1.xyz = (r4.xyz) * (r5.xyz);
    r7.xyz = (r3.xyz) * (r2.xyz);
    r1.xyz = (r2.xyz) * (r1.xyz);
    r5.xyz = (r1.xyz) * (r1.xyz);
    r0.w = dot(r9.xy, r9.xy) + (c3.z);
    r14.xyz = (r7.xyz) * (-(r7.xyz)) + (-(c3.yyy));
    r0.w = exp2(-(r0.w));
    ...
    r3 = tex2D(s14, v1.zw);
    r1.xy = (r3.xy) * (c12.ww);
    r6.xy = (r2.wy) * (c14.xx) + (c14.yy);
    r8.xy = (r4.xz) * (r1.xx);
    r0.w = dot(r6.xy, r9.xy) + (c3.z);
    r0.x = (r3.x) * (c12.w) + (-(r8.x));
    r1.x = (r4.z) * (-(r1.x)) + (r0.x);
    r2.xy = (r2.xz) * (r1.yy);
    r1.z = (r3.y) * (c12.w) + (-(r2.x));
    ...
    r0.w = (-(r0.w)) + (-(c3.y));
    r8.xyz = float3(((r5.w) >= 0.0f ? (r0.y) : (c[34].x)), ((r5.w) >= 0.0f ? (r0.y) : (c[34].y)), ((r5.w) >= 0.0f ? (r0.y) : (c[34].w)));
    r0.z = (r0.w) * (r0.w);
    r13.xyz = (r3.xyz) * (r8.yyy);
    r0.z = (r0.z) * (r0.z);
    r0.w = (r0.w) * (r0.z);
    r15.xyz = (r7.xyz) * (r7.xyz);
