// Mechanically reconstructed from 0x6637CF55.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = (r2.xy) * (r5.xy);
    r5.yz = c1.yz;
    r9.xyz = float3(((r5.w) >= 0.0f ? (r5.y) : (c[10].x)), ((r5.w) >= 0.0f ? (r5.z) : (c[10].y)), ((r5.w) >= 0.0f ? (r5.y) : (c[10].w)));
    r0.w = (r0.w) * (r2.x);
