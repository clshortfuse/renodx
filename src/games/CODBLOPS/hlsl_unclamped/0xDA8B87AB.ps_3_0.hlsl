// Mechanically reconstructed from 0xDA8B87AB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s5, v7.zw);
    r4.w = (r1.w) * (v7.y);
    r6.xy = lerp(r0.xy, r2.xy, r4.ww);
    r1.w = (r1.w) * (-(v7.y)) + (c32.w);
    r0 = tex2D(s0, v0.xy);
    r2.xyz = lerp(r0.xyz, r1.xyz, r4.www);
    r0.w = (r0.w) * (-(v7.x)) + (c32.w);
    r6.w = (r0.w) * (-(r1.w)) + (c32.w);
    r0.w = dot(r6.xy, r6.xy) + (c32.z);
    ...
    r2.w = r0.y;
    r3.xy = (r2.xz) * (r4.xx);
    r5.xy = (r2.yw) * (c31.xx) + (c31.yy);
    r0.y = (r1.x) * (c3.w) + (-(r3.x));
    r0.w = dot(r5.xy, r6.xy) + (c32.z);
    r1.w = (r2.z) * (-(r4.x)) + (r0.y);
    r2.xy = (r0.xz) * (r4.yy);
    r0.x = dot(r5.xy, r5.xy) + (c32.z);
    r0.y = (r1.y) * (c3.w) + (-(r2.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r0.z) * (-(r4.y)) + (r0.y);
    r0.z = (r0.x) * (c3.x) + (c3.y);
    ...
    r4.xyz = (r9.xyz) * (r3.zzz) + (r0.xyz);
    r0.w = dot(r1.xyz, r1.xyz);
    r0.w = rsqrt(r0.w);
    r15.xyz = (r3.www) * (v6.xyz);
    r2.xyz = (r1.xyz) * (r0.www) + (-(r15.xyz));
    ...
    r0.z = saturate(dot(r14.xyz, c[17].xyz));
    r0.w = (-(r0.w)) + (c32.w);
    r5.w = (-(r0.z)) + (c32.w);
    r0.z = (r0.w) * (r0.w);
    r0.y = (r5.w) * (r5.w);
    ...
    r0.z = (r0.z) * (r11.w) + (c12.x);
    r18.xy = (r0.ww) * (c16.xy) + (c16.zw);
    r0.y = 1.0f / (r0.z);
    r10.w = exp2(r18.y);
