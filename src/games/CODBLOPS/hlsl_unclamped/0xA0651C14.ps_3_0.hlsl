// Mechanically reconstructed from 0xA0651C14.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r13.xyz = (v0.yyy) * (r1.xyz) + (c1.yyy);
    r0 = tex2D(s0, v1.xy);
    r1 = tex2D(s6, v8.zw);
    r1.xyz = (r1.xyz) * (v0.zzz);
    r1.xyz = (r1.www) * (r1.xyz);
    r0.xyz = (r0.xyz) * (r13.xyz) + (r1.xyz);
    ...
    r7.xz = (r2.xy) * (c3.ww);
    r1.xyz = (r7.xyz) * (r3.zzz) + (r0.xyz);
    r0.xyz = (-(v7.xyz)) + (c[20].xyz);
    r15.xyz = (r1.xyz) * (c[36].yyy);
    ...
    r2.xyz = (r4.www) * (r14.xyz) + (r15.xyz);
    r1 = tex2D(s7, v1.xy);
    r0.xyz = (r13.xyz) * (r1.xyz);
    r4.xyz = (r0.xyz) * (-(r0.xyz)) + (c1.yyy);
    r5.xyz = (r0.xyz) * (r0.xyz);
    r3.x = (r1.w) * (-(c38.z)) + (c38.w);
    r10.w = (r1.w) * (c4.z);
    r2.w = saturate(dot(r12.xyz, r9.xyz));
    r1.z = saturate(dot(r9.xyz, -(r10.xyz)));
    r1.y = (r2.w) * (r3.x) + (r10.w);
    r3.z = (r1.z) * (r3.x) + (r10.w);
    r0.xyz = (r4.xyz) * (r9.www) + (r5.xyz);
    r1.y = (r1.y) * (r3.z) + (c14.x);
    r1.y = 1.0f / (r1.y);
    r1.z = (-(r1.z)) + (c1.y);
    r3.w = (r2.w) * (r1.y);
    r1.y = (r1.z) * (r1.z);
    ...
    r1.z = (r1.z) + (r1.z);
    r1.xy = (r1.ww) * (c16.xy) + (c16.zw);
    r9.w = exp2(r1.y);
    r3.y = saturate(dot(r9.xyz, r11.xyz));
    r1.y = pow(abs(r3.y), r9.w);
    r3.y = (r9.w) * (c14.y) + (c14.z);
    r1.x = 1.0f / (r1.x);
    r1.y = (r1.y) * (r3.y);
    r5.w = (r5.w) * (r1.x);
    r3.w = (r3.w) * (r1.y);
    ...
    r1.w = (r8.w) * (r3.x) + (r10.w);
    r1.w = (r1.w) * (r3.z) + (c14.x);
    r3.x = saturate(dot(r9.xyz, r8.xyz));
    r3.z = 1.0f / (r1.w);
    r1.w = pow(abs(r3.x), r9.w);
    r3.z = (r8.w) * (r3.z);
    r1.w = (r3.y) * (r1.w);
    r1.w = (r3.z) * (r1.w);
    r3.xyz = (r4.xyz) * (r6.www) + (r5.xyz);
