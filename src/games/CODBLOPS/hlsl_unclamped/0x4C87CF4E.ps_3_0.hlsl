// Mechanically reconstructed from 0x4C87CF4E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.z = saturate(dot(r7.xyz, r5.xyz));
    r6.z = (r2.w) * (c2.w);
    ...
    r3.y = (r4.y) * (c3.w) + (-(r2.x));
    r2.xz = (r2.xy) * (c12.xx);
    r2.y = (r5.z) * (-(r10.y)) + (r3.y);
    r3.xy = (r3.xz) * (r10.xx);
    r2.y = (r2.y) + (r2.y);
    r4.w = (r4.x) * (c3.w) + (-(r3.x));
    r2.xyz = (r4.zzz) * (r2.xyz);
    r4.w = (r3.z) * (-(r10.x)) + (r4.w);
    r3.xz = (r3.xy) * (c12.xx);
    r3.y = (r4.w) + (r4.w);
    r2.w = (r2.w) * (c2.z);
