// Mechanically reconstructed from 0xD759B24A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.y = (r0.z) + (r0.z);
    r6.zw = c15.zw;
    r2.xyz = (r6.zwz) + (-(c[39].xyw));
    r0.xyz = (r9.xyz) * (r0.www) + (r3.xyz);
    r11.xyz = (r1.www) * (r2.xyz) + (c[39].xyw);
    ...
    r2.xyz = (v0.zzz) * (r3.xyz) + (c15.www);
    r3.xyz = (r0.www) * (c[18].xyz);
    r1.xyz = (r7.xyz) * (r2.xyz);
    r7.xyz = (r0.yyy) * (r3.xyz) + (r5.xyz);
