// Mechanically reconstructed from 0xB518F32E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(-1.0f, 1.0f, 0.25f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r3.xyz = (v6.yyy) * (r0.xyz) + (c1.yyy);
    r0 = tex2D(s0, v0.xy);
    r1 = tex2D(s1, v0.xy);
    r4.xy = (r1.wy) * (c0.xy) + (c0.zw);
    r0.xyz = (r3.xyz) * (r0.xyz);
    r1.xyz = v3.xyz;
    r1.xyz = (r4.xxx) * (r1.xyz) + (v1.xyz);
