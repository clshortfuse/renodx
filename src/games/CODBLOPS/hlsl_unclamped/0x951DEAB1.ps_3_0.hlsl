// Mechanically reconstructed from 0x951DEAB1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = c0.z;
    r9.xyz = float3(((r2.w) >= 0.0f ? (c[5].x) : (r2.y)), ((r2.w) >= 0.0f ? (c[5].y) : (r2.y)), ((r2.w) >= 0.0f ? (c[5].w) : (r2.y)));
    r1.w = (r1.w) * (c0.w);
