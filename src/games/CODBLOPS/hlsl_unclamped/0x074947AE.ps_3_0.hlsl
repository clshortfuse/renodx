// Mechanically reconstructed from 0x074947AE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = dot(r10.xy, r10.xy) + (c1.z);
    r2.y = dot(r3.xy, r3.xy) + (c1.z);
    r2.w = exp2(-(r2.w));
    r2.y = exp2(-(r2.y));
    r2.w = (r2.w) * (c3.x) + (c3.y);
    r3.w = (r2.y) * (c3.x) + (c3.y);
    r2.y = dot(r3.xy, r10.xy) + (c1.z);
    r4.w = (r2.w) * (r3.w);
    r3 = tex2D(s14, v0.zw);
    r10.xy = (r3.xy) * (c3.ww);
