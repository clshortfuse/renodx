// Mechanically reconstructed from 0x6BD37CC4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c44 = float4(4.0f, -2.0f, 0.797884583f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r7.xy = lerp(r5.xy, r4.xy, r3.ww);
    r5.xyz = (r1.xyz) * (r1.xyz);
    r0.w = dot(r7.xy, r7.xy) + (c4.z);
    r1.w = exp2(-(r0.w));
    r0.xyw = c[39].xyw;
    r0.xyz = (-(r0.xyw)) + (c[40].xyw);
    r4.w = (r1.w) * (c3.x) + (c3.y);
    r3.xyz = (r4.zzz) * (r0.xyz) + (c[39].xyw);
    r1 = tex2D(s10, v7.zw);
    r0 = lerp(r2, r1, r3.wwww);
    r13.xyz = lerp(r3.xyz, c[41].xyw, r3.www);
    r1.xy = (v1.zw) * (c12.xy);
    r3 = tex2D(s13, r1.xy);
    ...
    r2 = tex2D(s14, v1.zw);
    r4.xy = (r2.xy) * (c3.ww);
    r6.xy = (r3.yw) * (c44.xx) + (c44.yy);
    r8.xy = (r3.xz) * (r4.xx);
    r1.w = dot(r6.xy, r7.xy) + (c4.z);
    r1.y = (r2.x) * (c3.w) + (-(r8.x));
    r2.w = (r3.z) * (-(r4.x)) + (r1.y);
    r3.xy = (r1.xz) * (r4.yy);
    r1.y = (r2.y) * (c3.w) + (-(r3.x));
