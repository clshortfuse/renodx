// Mechanically reconstructed from 0x652605D3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = (r1.w) * (r1.w);
    r0.xyz = (v6.yyy) * (r0.xyz) + (c2.yyy);
    r1.w = (r1.w) * (r1.x);
    r3.xyz = (r0.xyz) * (c2.zzz);
    r1.w = (r1.z) * (r1.w);
    r6.xyz = (r3.xyz) * (-(r3.xyz)) + (c2.yyy);
