// Mechanically reconstructed from 0xA6E8499D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c21 = float4(0.00048828125f, -0.000122070312f, -0.0f, 0.0f);
    ...
    r0.z = (r1.z) * (r4.w) + (r0.z);
    r0.x = pow(abs(r3.z), r1.x);
    r0.y = (r0.z) * (r0.y) + (c14.x);
    r0.z = (r1.x) * (c14.y) + (c14.z);
    r0.y = 1.0f / (r0.y);
    r0.z = (r0.x) * (r0.z);
    r0.x = (r1.z) * (r0.y);
    r0.y = (r3.w) * (c4.x) + (c4.y);
