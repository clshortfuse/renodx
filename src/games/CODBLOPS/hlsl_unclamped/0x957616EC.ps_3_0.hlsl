// Mechanically reconstructed from 0x957616EC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = rsqrt(r1.w);
    r1.xyz = (r1.zzz) * (v5.xyz);
    r0.w = (-(r0.w)) + (c0.z);
    r4.xyz = (r0.xyz) * (r1.www) + (-(r1.xyz));
    ...
    r1.w = (r3.w) * (r9.w) + (r10.z);
    r8.w = (r5.w) * (r9.w) + (r10.z);
    r6.xyz = (r0.xyz) * (r0.xyz);
    r1.w = (r1.w) * (r8.w) + (c3.x);
    r0.xyz = (r4.xyz) * (r10.www) + (r6.xyz);
    r1.w = 1.0f / (r1.w);
    r10.w = (r3.w) * (r1.w);
    ...
    r0.w = 1.0f / (r7.x);
    r7.y = exp2(r7.y);
    r5.w = pow(abs(r1.w), r7.y);
    r1.w = (r7.y) * (c3.y) + (c3.z);
    r0.w = (r10.x) * (r0.w);
    r5.w = (r5.w) * (r1.w);
    r5.w = (r10.w) * (r5.w);
    r7.z = (r7.w) * (r9.w) + (r10.z);
    r7.x = (r7.z) * (r8.w) + (c3.x);
    r7.z = saturate(dot(r9.xyz, r3.xyz));
    r3.z = 1.0f / (r7.x);
    r3.y = pow(abs(r7.z), r7.y);
    r3.z = (r7.w) * (r3.z);
    r1.w = (r1.w) * (r3.y);
    r1.w = (r3.z) * (r1.w);
    r3.xyz = (r4.xyz) * (r6.www) + (r6.xyz);
    ...
    r0 = (v5.zzzz) * (c[34]) + (r0);
    r1.w = saturate((r2.w) * (c[31].x) + (c[31].y));
    r3 = (r0) + (c[35]);
