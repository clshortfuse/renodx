// Mechanically reconstructed from 0xDC59CEC7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = (v0.yyy) * (r0.xyz) + (c1.yyy);
    r0 = tex2D(s0, v1.xy);
    r1 = tex2D(s5, v8.zw);
    r5.w = (r1.w) * (v0.z);
    r2 = tex2D(s6, v8.zw);
    r2.xy = (r2.wy) * (c0.xy) + (c0.zw);
    r1.xyz = (r0.xyz) * (-(r4.xyz)) + (r1.xyz);
    r9.xy = (r5.ww) * (r2.xy);
    ...
    r0.yzw = (r0.wyy) + (c1.xzx);
    r0.x = dot(r2.xyz, r2.xyz);
    r0.x = rsqrt(r0.x);
    r8.xyz = (r3.www) * (v7.xyz);
    r13.xy = (r5.ww) * (r0.yw) + (c1.yy);
    r5.xyz = (r2.xyz) * (r0.xxx) + (-(r8.xyz));
    r1.xyz = normalize(r5.xyz);
    r2.xyz = (r2.xyz) * (r0.xxx);
    r11.xyz = (r4.xyz) * (r13.yyy);
    r0.w = saturate(dot(r1.xyz, r2.xyz));
    r3.w = (r13.x) * (-(c12.z)) + (c12.w);
    r0.w = (-(r0.w)) + (c1.y);
    r8.w = dot(r2.xyz, c[29].xyz);
    r0.y = (r0.w) * (r0.w);
    r0.y = (r0.y) * (r0.y);
    r0.x = c1.w;
    r0.w = (r0.w) * (r0.y);
    r12.xz = (r5.ww) * (r0.xz);
    r9.w = (r12.x) * (-(r12.x)) + (c1.y);
    r10.w = (r12.x) * (r12.x);
    r1.w = (r9.w) * (r0.w) + (r10.w);
    r2.w = (-(r4.w)) + (c1.y);
    r4.w = (r2.w) * (r2.w);
    r0 = v2;
    ...
    r11.w = saturate(dot(r9.xyz, -(r8.xyz)));
    r0.z = (r6.w) * (r3.w) + (r4.z);
    r2.x = (r11.w) * (r3.w) + (r4.z);
    r2.w = (r2.w) * (r4.w);
    r0.z = (r0.z) * (r2.x) + (c15.x);
    r0.z = 1.0f / (r0.z);
    r12.xy = (r13.xx) * (c37.xy) + (c37.zw);
    r2.y = exp2(r12.y);
    r1.z = saturate(dot(r9.xyz, r1.xyz));
    r1.y = (r6.w) * (r0.z);
    r0.x = pow(abs(r1.z), r2.y);
    r0.z = (r2.y) * (c15.y) + (c15.z);
    r0.y = saturate(dot(r9.xyz, c[17].xyz));
    r0.x = (r0.x) * (r0.z);
    r1.z = (r0.y) * (r3.w) + (r4.z);
    r2.z = saturate(dot(r9.xyz, r3.xyz));
    r1.z = (r1.z) * (r2.x) + (c15.x);
    r1.x = pow(abs(r2.z), r2.y);
    r1.z = 1.0f / (r1.z);
    r0.z = (r0.z) * (r1.x);
    r1.x = (r0.y) * (r1.z);
    r1.z = (r9.w) * (r2.w) + (r10.w);
    r0.z = (r0.z) * (r1.x);
    r0.x = (r1.y) * (r0.x);
    r0.z = (r1.z) * (r0.z);
    r7.w = (r1.w) * (r0.x);
    ...
    r2.xyz = (r1.www) * (r10.xyz) + (r11.xyz);
    r0.xyz = (r12.www) * (c[19].xyz);
