// Mechanically reconstructed from 0xC26BDA5E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s5, v7.xy);
    r7.w = (r0.w) * (v0.y);
    r3.xyz = lerp(r1.xyz, r0.xyz, r7.www);
    r5.xy = lerp(r4.xy, r2.xy, r7.ww);
    r0 = tex2D(s8, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    ...
    r0 = tex2D(s10, v7.xy);
    r1 = tex2D(s9, v1.xy);
    r2 = lerp(r1, r0, r7.wwww);
    r1 = tex2D(s6, v7.zw);
    r6.w = (r1.w) * (v0.z) + (c3.w);
    r0 = tex2D(s11, v7.zw);
    r0 = float4(((r6.w) >= 0.0f ? (r0.x) : (r2.x)), ((r6.w) >= 0.0f ? (r0.y) : (r2.y)), ((r6.w) >= 0.0f ? (r0.z) : (r2.z)), ((r6.w) >= 0.0f ? (r0.w) : (r2.w)));
    r8.xy = float2(((r6.w) >= 0.0f ? (r4.x) : (r5.x)), ((r6.w) >= 0.0f ? (r4.y) : (r5.y)));
    r1.xyz = float3(((r6.w) >= 0.0f ? (r1.x) : (r3.x)), ((r6.w) >= 0.0f ? (r1.y) : (r3.y)), ((r6.w) >= 0.0f ? (r1.z) : (r3.z)));
    ...
    r1.y = (r2.x) * (c12.x) + (-(r7.x));
    r1.w = dot(r3.xy, r8.xy) + (c3.z);
    r2.z = (r3.z) * (-(r4.x)) + (r1.y);
    r1.xy = (r1.xz) * (r4.yy);
    r2.x = dot(r3.xy, r3.xy) + (c3.z);
    r2.w = (r2.y) * (c12.x) + (-(r1.x));
    r2.y = exp2(-(r2.x));
    r2.w = (r1.z) * (-(r4.y)) + (r2.w);
    r1.z = (r2.y) * (c4.x) + (c4.y);
    r9.y = (r2.z) + (r2.z);
    ...
    r11.w = (r0.w) * (-(c13.x)) + (c13.y);
    r0.xyz = (r14.xyz) * (r1.www) + (r15.xyz);
    r5.w = dot(r3.xyz, c[29].xyz);
    r4.xyw = c[39].xyw;
    r4.xyz = (-(r4.xyw)) + (c[40].xyw);
    r7.xyz = (r7.www) * (r4.xyz) + (c[39].xyw);
    r4.xyz = v2.xyz;
    r4.xyz = (r8.xxx) * (v4.xyz) + (r4.xyz);
    r13.xyz = float3(((r6.w) >= 0.0f ? (c[41].x) : (r7.x)), ((r6.w) >= 0.0f ? (c[41].y) : (r7.y)), ((r6.w) >= 0.0f ? (c[41].w) : (r7.z)));
