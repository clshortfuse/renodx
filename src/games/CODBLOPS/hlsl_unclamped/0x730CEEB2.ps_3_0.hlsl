// Mechanically reconstructed from 0x730CEEB2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xyz = (v0.zzz) * (r1.xyz) + (c1.zzz);
    r2.xyz = (v0.yyy) * (r0.xyz) + (c1.zzz);
    r0 = tex2D(s0, v1.xy);
    r3.xyz = lerp(r0.xyz, c1.xxx, r6.xxx);
