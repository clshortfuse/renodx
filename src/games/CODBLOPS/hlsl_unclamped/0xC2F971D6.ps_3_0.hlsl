// Mechanically reconstructed from 0xC2F971D6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xy = float2(((r1.w) >= 0.0f ? (r2.w) : (r3.w)), ((r1.w) >= 0.0f ? (r2.y) : (r3.y)));
    ...
    r2.y = dot(r8.xy, r8.xy) + (c1.y);
    r2.w = dot(r3.xy, r3.xy) + (c1.y);
    r2.y = exp2(-(r2.y));
    r2.w = exp2(-(r2.w));
    r4.w = (r2.y) * (c1.z) + (c1.w);
    r2.y = (r2.w) * (c1.z) + (c1.w);
    r2.w = dot(r3.xy, r8.xy) + (c1.y);
    r2.y = (r4.w) * (r2.y);
    r3 = tex2D(s14, v0.zw);
    r8.xy = (r3.xy) * (c3.zz);
