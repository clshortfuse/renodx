// Mechanically reconstructed from 0xCDAC6F68.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xy = lerp(r0.xy, r3.xy, r7.ww);
    r0 = tex2D(s6, v7.zw);
    r6.w = (r0.w) * (v0.z);
    r3.xyz = lerp(r2.xyz, r1.xyz, r7.www);
    r11.xy = lerp(r5.xy, r4.xy, r6.ww);
    r1.xyz = lerp(r3.xyz, r0.xyz, r6.www);
    ...
    r0.y = (r1.x) * (c4.w) + (-(r3.x));
    r0.w = dot(r5.xy, r11.xy) + (c36.z);
    r1.w = (r2.z) * (-(r4.x)) + (r0.y);
    r2.xy = (r0.xz) * (r4.yy);
    r0.x = dot(r5.xy, r5.xy) + (c36.z);
    r0.y = (r1.y) * (c4.w) + (-(r2.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r0.z) * (-(r4.y)) + (r0.y);
    r0.z = (r0.x) * (c4.x) + (c4.y);
    ...
    r4.xyz = (r6.xyz) * (r3.www) + (r1.xyz);
    r5.xyz = (r7.www) * (r0.xyz) + (c[32].xyw);
    r1 = tex2D(s10, v7.zw);
    ...
    r1.x = (r2.w) * (r0.y);
    r1.z = (r0.z) * (r5.w);
    r0.xyz = (r15.xyz) * (r11.www) + (r16.xyz);
    r1.z = (r1.x) * (r1.z);
