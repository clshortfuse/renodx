// Mechanically reconstructed from 0x549AE96F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c34 = float4(2.0f, -1.0f, 1.0f, 0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = tex2D(s1, v1.xy);
    r1 = tex2D(s5, v7.xy);
    r1.xyz = (r1.xyz) + (c34.yyy);
    r4.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r3.xyz = (v0.yyy) * (r1.xyz) + (c34.zzz);
    r0 = tex2D(s0, v1.xy);
    r1 = tex2D(s6, v7.zw);
    r6.w = (r1.w) * (v0.z);
    ...
    r1 = tex2D(s14, v1.zw);
    r6.xy = (r1.xy) * (c4.xx);
    r7.xy = (r2.yw) * (c4.yy) + (c4.zz);
    r2.xy = (r2.xz) * (r6.xx);
    r0.w = dot(r7.xy, r10.xy) + (c3.x);
    r0.y = (r1.x) * (c4.x) + (-(r2.x));
    r1.w = (r2.z) * (-(r6.x)) + (r0.y);
    r5.xy = (r0.xz) * (r6.yy);
    r0.y = (r1.y) * (c4.x) + (-(r5.x));
    r0.x = dot(r7.xy, r7.xy) + (c3.x);
    r0.y = (r0.z) * (-(r6.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r6.y = (r1.w) + (r1.w);
    r0.z = (r0.z) * (c3.y) + (c3.z);
    ...
    r0.z = (r0.z) * (r0.z);
    r10.z = (r0.w) * (r0.z);
    r3.xyz = (r3.xyz) * (c34.www);
    r2 = tex2D(s9, v7.zw);
    r0 = lerp(r3, r2, r6.wwww);
    r15.xyz = (r0.xyz) * (-(r0.xyz)) + (c34.zzz);
    r2.xyz = v2.xyz;
    ...
    r5.w = (r7.w) * (c12.x) + (c12.y);
    r1.x = (r2.w) * (r0.y);
    r1.z = (r0.z) * (r5.w);
    r0.xyz = (r15.xyz) * (r10.zzz) + (r16.xyz);
    r1.z = (r1.x) * (r1.z);
    r14.xyz = lerp(r1.yyy, c[32].xyw, r6.www);
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c15.y) : (c15.w));
