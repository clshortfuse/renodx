// Mechanically reconstructed from 0x09472702.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r1.w) * (c0.y);
    r5.xyz = (r1.xyz) * (c[23].xyz);
    r1.z = dot(c[24].yz, r8.xy) + (c[24].x);
