// Mechanically reconstructed from 0x7D7FDAF0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xz = (r0.xy) * (c2.xx);
    r5.y = (r0.z) + (r0.z);
    r7.xyz = (r3.xyz) * (r0.www) + (r5.xyz);
    r13.xy = c0.xy;
    r1.xyz = (r13.xyx) + (-(c[36].xyw));
    r0 = tex2D(s3, v4.zw);
    ...
    r4.w = (r0.w) * (v4.y);
    r0.w = (r1.w) + (r1.w);
    r11.xyz = (r4.www) * (r1.xyz) + (c[36].xyw);
