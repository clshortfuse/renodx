// Mechanically reconstructed from 0x9C973C3F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xy = float2(((r4.w) >= 0.0f ? (r2.x) : (r3.x)), ((r4.w) >= 0.0f ? (r2.y) : (r3.y)));
    ...
    r0.y = dot(r1.xy, r1.xy) + (c4.z);
    r1.w = dot(v6.xyz, v6.xyz);
    r0.y = exp2(-(r0.y));
    r5.w = rsqrt(r1.w);
    r1.w = (r0.y) * (c11.x) + (c11.y);
    r0.y = dot(r1.xy, r8.xy) + (c4.z);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v1.zw);
    r4.xy = (r1.xy) * (c11.ww);
    ...
    r1.w = (r1.w) * (r1.z);
    r11.xyz = float3(((r4.w) >= 0.0f ? (c[8].x) : (r1.y)), ((r4.w) >= 0.0f ? (c[8].y) : (r1.y)), ((r4.w) >= 0.0f ? (c[8].w) : (r1.y)));
