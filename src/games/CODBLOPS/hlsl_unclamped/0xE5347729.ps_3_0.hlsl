// Mechanically reconstructed from 0xE5347729.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s4, v7.xy);
    r4.w = (r1.w) * (v0.y) + (c3.w);
    r5.xy = float2(((r4.w) >= 0.0f ? (r3.x) : (r0.x)), ((r4.w) >= 0.0f ? (r3.y) : (r0.y)));
    r3 = tex2D(s8, v1.xy);
    r0 = tex2D(s9, v7.xy);
    ...
    r7.xy = (r3.xz) * (r0.xx);
    r0.z = dot(r6.xy, r5.xy) + (c3.z);
    r1.w = (r2.x) * (c12.x) + (-(r7.x));
    r1.w = (r3.z) * (-(r0.x)) + (r1.w);
    r11.xy = (r1.xz) * (r0.yy);
    r0.x = (r2.y) * (c12.x) + (-(r11.x));
    ...
    r2.w = (r2.y) * (r2.w);
    r1.xyz = (r8.xyz) * (r5.zzz) + (r1.xyz);
    r0.xyz = (r0.xyz) * (r2.www);
    r2.xyw = c[28].xyw;
    r13.xyz = float3(((r4.w) >= 0.0f ? (r2.x) : (c[27].x)), ((r4.w) >= 0.0f ? (r2.y) : (c[27].y)), ((r4.w) >= 0.0f ? (r2.w) : (c[27].w)));
