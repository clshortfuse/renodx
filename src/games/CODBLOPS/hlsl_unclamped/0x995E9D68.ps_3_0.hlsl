// Mechanically reconstructed from 0x995E9D68.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (-(r4.w)) + (c1.y);
    r10.xyz = (r10.xyz) * (r3.www) + (-(r11.xyz));
    r2.z = (r2.w) * (r2.w);
    r2.z = (r2.w) * (r2.z);
