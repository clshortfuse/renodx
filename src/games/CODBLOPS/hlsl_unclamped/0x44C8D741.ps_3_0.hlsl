// Mechanically reconstructed from 0x44C8D741.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c8 = float4(1.0f, 0.0f, 0.000244140625f, -0.000244140625f);
    ...
    r7.w = saturate(dot(r7.xyz, r1.xyz));
    ...
    r8.xyz = (r6.zzz) * (v5.xyz);
    r2.w = saturate(dot(r7.xyz, -(r8.xyz)));
    r1 = tex2D(s2, v1.xy);
    r3.xyz = (r1.xyz) * (-(r1.xyz)) + (c0.zzz);
