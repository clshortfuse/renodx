// Mechanically reconstructed from 0x44FDEC95.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = saturate((r1.xx) * (c[33].xy) + (c[33].zw));
    r0 = tex2D(s1, v1.xy);
    r6.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r0.w = dot(c[32].yz, r1.xy) + (c[32].x);
    r0.xyz = v2.xyz;
    ...
    r5.xyz = (r5.xyz) * (c[35].www);
    r3.xyz = (r3.xyz) * (c[35].xxx) + (r6.xyz);
