// Mechanically reconstructed from 0x2DBA956C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c3 = float4(1.0f, -0.0f, 200.0f, 0.5f);
    ...
    r1 = tex2D(s12, v7.zw);
    r3.xy = c1.xy;
    r0.xy = (v7.xy) * (c[34].xx) + (r3.xx);
    r0.xy = (r0.xy) * (c[35].xx) + (r3.yy);
    r0 = tex2D(s3, r0.xy);
    r9.xy = (v7.xy) * (c[34].xx);
    r0.w = (r0.y) * (c1.z) + (c1.w);
    r2.xy = (r9.xy) * (c2.xx) + (c2.yy);
    r0.y = (r0.w) * (c1.z) + (c1.w);
    r2.xy = (r2.xy) * (c[36].xx) + (r3.yy);
    r2 = tex2D(s4, r2.xy);
    r0.w = (r2.y) * (c1.z) + (c1.w);
    r0.w = (r0.w) * (c1.z) + (c1.w);
    r0.xz = c2.zz;
    ...
    r0.xyz = (r4.xyz) * (c[33].xxx) + (-(r2.xyz));
    r7.xyz = (-(v5.xyz)) * (r2.www) + (r1.xyz);
    r0.w = saturate((r3.w) * (-(r3.w)) + (c3.x));
