// Mechanically reconstructed from 0xC6910E55.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.x = dot(r4.xy, r1.xy) + (c15.z);
    r2.y = dot(r4.xy, r1.zw) + (c15.z);
    r1 = tex2D(s3, v6.xy);
    r1.w = (r1.w) * (v0.y);
    r4.xy = (r0.yw) * (c4.xx) + (c4.yy);
    r5.xy = lerp(r6.xy, r2.xy, r1.ww);
    r0.y = dot(r4.xy, r4.xy) + (c15.z);
    ...
    r2.zw = c15.zw;
    r2.xyz = (r2.zwz) + (-(c[27].xyw));
    r7.xyz = normalize(r3.xyz);
    r5.xyz = (r1.www) * (r2.xyz) + (c[27].xyw);
    ...
    r6.xyz = (v0.zzz) * (r3.xyz) + (c15.www);
    r3.xyz = (r0.yyy) * (r8.xyz) + (r10.xyz);
    r2.xyz = (r4.xyz) * (r6.xyz);
    r1 = tex2D(s5, v7.xy);
    r0.w = dot(v5.xyz, v5.xyz);
    r0.z = rsqrt(r0.w);
    r1.xyz = (r1.xyz) + (c15.yyy);
    r8.xyz = (v5.xyz) * (-(r0.zzz)) + (c[17].xyz);
    r4.xyz = (v0.www) * (r1.xyz) + (c15.www);
