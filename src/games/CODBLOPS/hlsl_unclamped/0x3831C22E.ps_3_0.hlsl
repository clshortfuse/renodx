// Mechanically reconstructed from 0x3831C22E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.x = rsqrt(r0.z);
    r9.w = (r13.x) * (c2.w);
    r8.xyz = (r2.xxx) * (v5.xyz);
    r8.w = (r13.x) * (-(c4.z)) + (c4.w);
    r1.w = saturate(dot(r10.xyz, -(r8.xyz)));
    r0.z = (r2.w) * (r8.w) + (r9.w);
    r7.w = (r1.w) * (r8.w) + (r9.w);
    r2.z = (r0.z) * (r7.w) + (c12.x);
