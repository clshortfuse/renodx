// Mechanically reconstructed from 0xAAB6AB4E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c3 = float4(3.5f, 1.0f, 0.959999979f, 0.0399999991f);
    ...
    r0.z = dot(r5.xyz, r8.xyz);
    r0.z = (r0.z) + (r0.z);
    r6.xy = lerp(r1.wy, r0.wy, r2.ww);
