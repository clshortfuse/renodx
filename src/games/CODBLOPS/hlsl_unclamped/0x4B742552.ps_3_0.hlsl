// Mechanically reconstructed from 0x4B742552.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r14.yz = c1.yz;
    r0.xyz = float3(((r1.w) >= 0.0f ? (r14.y) : (c[36].x)), ((r1.w) >= 0.0f ? (r14.z) : (c[36].y)), ((r1.w) >= 0.0f ? (r14.y) : (c[36].w)));
    r2.w = dot(r13.xyz, r10.xyz);
    r11.xyz = lerp(r0.xyz, c[37].xyw, r6.www);
    r0.z = (r2.w) + (r2.w);
    r5 = tex2D(s6, v1.xy);
    r4 = tex2D(s7, v7.zw);
    r2 = lerp(r5, r4, r6.wwww);
    r4.xyz = (r10.xyz) * (-(r0.zzz)) + (r13.xyz);
    r4.w = (r2.w) * (c1.w);
    ...
    r4 = tex2D(s0, v1.xy);
    r3.xyz = float3(((r1.w) >= 0.0f ? (r3.x) : (r4.x)), ((r1.w) >= 0.0f ? (r3.y) : (r4.y)), ((r1.w) >= 0.0f ? (r3.z) : (r4.z)));
    r0.y = (r2.w) * (c2.z);
    r0.z = (r2.w) * (-(c13.x)) + (c13.y);
    r1.w = saturate(dot(r9.xyz, r10.xyz));
    r3.w = (r3.w) * (r0.z) + (r0.y);
    r2.w = (r1.w) * (r0.z) + (r0.y);
    r0.xyz = lerp(r3.xyz, r1.xyz, r6.www);
    r1.z = (r2.w) * (r3.w) + (c4.w);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r1.z = 1.0f / (r1.z);
