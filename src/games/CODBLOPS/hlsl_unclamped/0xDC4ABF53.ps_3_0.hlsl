// Mechanically reconstructed from 0xDC4ABF53.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = (r3.wy) * (c12.xx) + (c12.yy);
    r0.w = dot(r12.xy, r12.xy) + (c3.w);
    r0.z = dot(r2.xy, r2.xy) + (c3.w);
    r0.w = exp2(-(r0.w));
    r0.z = exp2(-(r0.z));
    r0.w = (r0.w) * (c4.x) + (c4.y);
    r1.w = (r0.z) * (c4.x) + (c4.y);
    r0.z = dot(r2.xy, r12.xy) + (c3.w);
    r1.w = (r0.w) * (r1.w);
    r4 = tex2D(s14, v1.zw);
    r2.xy = (r4.xy) * (c11.ww);
    r0.z = saturate((r0.z) * (r1.w) + (r1.w));
    r5.xy = (r5.xz) * (r2.xx);
    r1.w = (r4.x) * (c11.w) + (-(r5.x));
    r3.xy = (r3.xz) * (r2.yy);
    r2.z = (r5.z) * (-(r2.x)) + (r1.w);
    r1.w = (r4.y) * (c11.w) + (-(r3.x));
    r1.w = (r3.z) * (-(r2.y)) + (r1.w);
    r7.y = (r2.z) + (r2.z);
    r2.y = (r1.w) + (r1.w);
    r2.xz = (r3.xy) * (c12.xx);
