// Mechanically reconstructed from 0xCD60AE49.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(1.0f, 0.0f, 0.600000024f, 0.400000006f);
    ...
    r6.xy = (r2.xy) * (r5.ww);
    r0.w = dot(r4.xy, r4.xy) + (c2.y);
    r0.y = dot(r6.xy, r6.xy) + (c2.y);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c2.z) + (c2.w);
    r3.w = (r0.y) * (c2.z) + (c2.w);
