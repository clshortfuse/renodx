// Mechanically reconstructed from 0xD4A1BF93.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r5.w = (r0.w) * (v0.w) + (c0.x);
    r5.xy = float2(((r5.w) >= 0.0f ? (r1.x) : (c0.z)), ((r5.w) >= 0.0f ? (r1.y) : (c0.z)));
    r1 = v2;
    ...
    r1.y = c0.z;
    r1.xyz = float3(((r5.w) >= 0.0f ? (c[30].x) : (r1.y)), ((r5.w) >= 0.0f ? (c[30].y) : (r1.y)), ((r5.w) >= 0.0f ? (c[30].w) : (r1.y)));
    r2.w = (r2.w) * (c0.w);
    ...
    r2.xyz = (r10.xyz) * (r1.yyy);
    r2.xyz = (r2.xyz) * (c2.xxx);
    r1.z = dot(r9.xyz, r8.xyz);
    r5.xyz = (r4.xyz) * (r5.xyz) + (r2.xyz);
    r1.z = (r1.z) + (r1.z);
