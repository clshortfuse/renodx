// Mechanically reconstructed from 0x93F0EA26.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s8, v1.xy);
    r1.z = ((r2.w) >= 0.0f ? (c1.w) : (r1.y));
    r0 = tex2D(s9, v7.zw);
    r6.w = lerp(r1.z, r0.y, r3.w);
    r10.w = lerp(r1.w, r0.w, r3.w);
    r6.xyz = (r2.xyz) * (r2.xyz);
    r7.w = (r10.w) * (-(c42.z)) + (c42.w);
    ...
    r2 = tex2D(s14, v1.zw);
    r0.xy = (r2.xy) * (c12.ww);
    r5.xy = (r1.wy) * (c42.xx) + (c42.yy);
    r3.xy = (r3.xz) * (r0.xx);
    r0.z = dot(r5.xy, r4.xy) + (c4.x);
    ...
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c13.x) : (c13.z));
    ...
    r1.xyz = (r6.www) * (r0.xyz);
    r0 = (v6.xyzx) * (c13.xxxz) + (c13.zzzx);
