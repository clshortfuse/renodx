// Mechanically reconstructed from 0x7A288833.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.y = dot(r1.xy, r0.zw) + (c20.z);
    r4.x = dot(r1.xy, r0.xy) + (c20.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r3.w = (r0.w) * (v0.y);
    r2 = tex2D(s1, v1.xy);
    ...
    r0.w = dot(r10.xy, r10.xy) + (c20.z);
    r0.y = dot(r1.xy, r1.xy) + (c20.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c4.x) + (c4.y);
    r1.w = (r0.y) * (c4.x) + (c4.y);
    r0.y = dot(r1.xy, r10.xy) + (c20.z);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v1.zw);
    r5.xy = (r1.xy) * (c4.ww);
    ...
    r1.z = saturate(dot(r12.xyz, r6.xyz));
    r0.x = (r0.w) * (c4.z);
    ...
    r1.w = (r1.w) * (r1.z);
    r11.xyz = lerp(r5.xyz, r1.yyy, r4.www);
