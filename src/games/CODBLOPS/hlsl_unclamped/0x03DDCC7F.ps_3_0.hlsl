// Mechanically reconstructed from 0x03DDCC7F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = v2;
    r2.xyz = (r9.xxx) * (v5.xyz) + (r0.xyz);
    r0.xyz = (r4.xyz) * (r1.xyz);
    r2.xyz = (r9.yyy) * (v4.xyz) + (r2.xyz);
    ...
    r7.xyz = (r4.xyz) * (c2.www);
    r4.xyz = normalize(r8.xyz);
    r7.xyz = (r0.xyz) * (r5.xyz) + (r7.xyz);
    ...
    r3.z = (r4.z) * (r4.z);
    r3.x = (r12.x) * (c4.x);
    r1.w = (r12.x) * (-(c4.x)) + (c4.y);
    r3.y = (r5.w) * (r1.w) + (r3.x);
    r1.w = (r2.w) * (r1.w) + (r3.x);
    r3.z = (r3.z) * (r3.z);
    r1.w = (r1.w) * (r3.y) + (c12.x);
    r3.z = (r4.z) * (r3.z);
    r1.w = 1.0f / (r1.w);
