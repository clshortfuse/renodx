// Mechanically reconstructed from 0x172D59E8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s2, v1.xy);
    r3.xyz = lerp(r0.xyz, c0.yyy, r2.xxx);
    r5.xyz = (r0.xyz) * (r2.xxx);
    r0 = tex2D(s1, v1.xy);
