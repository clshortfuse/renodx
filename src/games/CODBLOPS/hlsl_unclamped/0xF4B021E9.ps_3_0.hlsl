// Mechanically reconstructed from 0xF4B021E9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r0.w) * (v0.z) + (c1.x);
    r0.w = rsqrt(r1.w);
    r1.xyz = float3(((r2.w) >= 0.0f ? (r0.x) : (r1.x)), ((r2.w) >= 0.0f ? (r0.y) : (r1.y)), ((r2.w) >= 0.0f ? (r0.z) : (r1.z)));
    r0.xyz = (v6.xyz) * (-(r0.www)) + (c[17].xyz);
    r6.xyz = (r1.xyz) * (r1.xyz);
    r3.xyz = normalize(r0.xyz);
    r2.xyz = (r0.www) * (v6.xyz);
    ...
    r4.x = (r1.w) * (c2.z);
    r1.z = (r1.w) * (-(c7.z)) + (c7.w);
    r4.z = saturate(dot(r0.xyz, c[17].xyz));
    r1.x = (r4.y) * (r1.z) + (r4.x);
    r1.z = (r4.z) * (r1.z) + (r4.x);
    r3.w = (r3.w) * (c8.x) + (c8.y);
    r1.z = (r1.z) * (r1.x) + (c3.x);
    ...
    r1.z = 1.0f / (r1.z);
    r1.x = (r4.z) * (r1.z);
    r4.xy = (r1.ww) * (c9.xy) + (c9.zw);
    r5.w = saturate(dot(r0.xyz, r3.xyz));
    r1.z = exp2(r4.y);
    r3.z = pow(abs(r5.w), r1.z);
    r1.z = (r1.z) * (c3.y) + (c3.z);
    r8.xyz = (r4.zzz) * (c[18].xyz);
    r1.z = (r3.z) * (r1.z);
    r1.z = (r1.x) * (r1.z);
    r1.xy = float2(((r4.w) >= 0.0f ? (c1.y) : (r1.y)), ((r4.w) >= 0.0f ? (c1.z) : (r1.y)));
    r1.z = (r3.w) * (r1.z);
    r10.xy = float2(((r2.w) >= 0.0f ? (c1.y) : (r1.x)), ((r2.w) >= 0.0f ? (c1.z) : (r1.y)));
    r6.w = 1.0f / (r4.x);
    r1.z = (r1.z) * (r10.x);
    r2.w = (r1.w) * (c1.w);
    ...
    r5 = tex2D(s13, r4.xy);
    r3.w = r5.y;
    r1.w = dot(r9.xy, r9.xy) + (c1.y);
    r4.xy = (r3.yw) * (c7.xx) + (c7.yy);
    r1.z = exp2(-(r1.w));
    r1.w = dot(r4.xy, r4.xy) + (c1.y);
    r1.z = (r1.z) * (c2.x) + (c2.y);
    r1.x = exp2(-(r1.w));
    r1.w = dot(r4.xy, r9.xy) + (c1.y);
    r1.x = (r1.x) * (c2.x) + (c2.y);
    r4 = tex2D(s14, v1.zw);
    r11.xy = (r4.xy) * (c2.ww);
    r1.x = (r1.z) * (r1.x);
    ...
    r1.x = (r4.y) * (c2.w) + (-(r5.x));
    r9.xz = (r5.xy) * (c4.ww);
    r1.x = (r5.z) * (-(r11.y)) + (r1.x);
    r9.y = (r1.x) + (r1.x);
    r3.xy = (r3.xz) * (r11.xx);
    r5.xyz = (r1.www) * (r9.xyz);
    r1.w = (r4.x) * (c2.w) + (-(r3.x));
    r4.xz = (r3.xy) * (c4.ww);
    r1.w = (r3.z) * (-(r11.x)) + (r1.w);
    r4.y = (r1.w) + (r1.w);
