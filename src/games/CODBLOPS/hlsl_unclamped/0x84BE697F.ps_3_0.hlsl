// Mechanically reconstructed from 0x84BE697F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.w = (r0.w) * (v0.y) + (c3.w);
    r4.w = (r1.w) * (r1.z);
    r3.xy = float2(((r7.w) >= 0.0f ? (r1.x) : (r2.x)), ((r7.w) >= 0.0f ? (r1.y) : (r2.y)));
    r1 = tex2D(s6, v7.zw);
    r4.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r1 = (c3.xxxx) * (v9) + (c3.yyyy);
    r2.y = dot(r4.xy, r1.zw) + (c3.z);
    r2.x = dot(r4.xy, r1.xy) + (c3.z);
    r1 = tex2D(s0, v1.xy);
    r1.xyz = float3(((r7.w) >= 0.0f ? (r0.x) : (r1.x)), ((r7.w) >= 0.0f ? (r0.y) : (r1.y)), ((r7.w) >= 0.0f ? (r0.z) : (r1.z)));
    r0 = tex2D(s4, v7.zw);
    r5.w = (r0.w) * (v0.z);
    ...
    r0.w = dot(r9.xy, r9.xy) + (c3.z);
    r0.y = dot(r1.xy, r1.xy) + (c3.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c11.x) + (c11.y);
    r1.w = (r0.y) * (c11.x) + (c11.y);
    r0.y = dot(r1.xy, r9.xy) + (c3.z);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v1.zw);
    r7.xy = (r1.xy) * (c11.ww);
    ...
    r0.xyz = v2.xyz;
    r6.xyz = (r9.xxx) * (v4.xyz) + (r0.xyz);
    r0 = lerp(r3, r2, r5.wwww);
    r2.xyz = (r9.yyy) * (v3.xyz) + (r6.xyz);
    r9.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c3.yyy));
    r12.xyz = normalize(r2.xyz);
    r1.z = saturate(dot(r12.xyz, r5.xyz));
    r2.xyw = c[9].xyw;
    r2.xyz = float3(((r7.w) >= 0.0f ? (r2.x) : (c[8].x)), ((r7.w) >= 0.0f ? (r2.y) : (c[8].y)), ((r7.w) >= 0.0f ? (r2.w) : (c[8].w)));
    r10.xyz = (r0.xyz) * (r0.xyz);
    r0.z = (r0.w) * (-(c12.z)) + (c12.w);
    r0.x = (r0.w) * (c11.z);
    ...
    r0.y = (r1.w) * (c13.y) + (c13.z);
    r0.z = 1.0f / (r0.z);
    r1.w = (r0.x) * (r0.y);
    r1.z = (r2.w) * (r0.z);
    r0.xyz = (r9.xyz) * (r4.www) + (r10.xyz);
    r1.w = (r1.w) * (r1.z);
    r11.xyz = lerp(r2.xyz, r1.yyy, r5.www);
