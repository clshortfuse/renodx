// Mechanically reconstructed from 0x905F9CE5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c4 = float4(8.0f, 3.5f, 1.0f, 0.5f);
    ...
    r2.x = dot(r3.xy, r0.xy) + (c3.x);
    r2.y = dot(r3.xy, r0.zw) + (c3.x);
    r3 = tex2D(s5, v1.xy);
    r5.zw = r3.yy;
    r0 = tex2D(s3, v6.zw);
    r6.w = (r0.w) * (v0.z) + (c3.y);
    ...
    r3 = tex2D(s14, v1.zw);
    r7.xy = (r3.xy) * (c10.ww);
    r1.w = dot(r6.xy, r2.xy) + (c3.x);
    r4.xy = (r4.xz) * (r7.yy);
    r1.w = saturate((r1.w) * (r1.y) + (r1.y));
    r1.y = (r3.y) * (c10.w) + (-(r4.x));
    r5.xz = (r4.xy) * (c11.xx);
    r1.y = (r4.z) * (-(r7.y)) + (r1.y);
    r5.y = (r1.y) + (r1.y);
    r1.xy = (r1.xz) * (r7.xx);
    r4.xyz = (r1.www) * (r5.xyz);
    r1.w = (r3.x) * (c10.w) + (-(r1.x));
    r6.xz = (r1.xy) * (c11.xx);
    r1.w = (r1.z) * (-(r7.x)) + (r1.w);
    r6.y = (r1.w) + (r1.w);
    r1.xyz = v2.xyz;
