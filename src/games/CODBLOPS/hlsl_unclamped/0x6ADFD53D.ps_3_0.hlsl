// Mechanically reconstructed from 0x6ADFD53D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = c1.w;
    r2.x = lerp(c[31].x, -(r1.w), r1.y);
    r1.y = (r1.y) + (c1.x);
    r3.x = pow(abs(r1.x), r2.x);
    r2.xy = c[7].xy;
    r1.xzw = (r2.yyy) * (c[6].xyz);
    ...
    r0.yzw = (r0.yzw) * (r2.yzw) + (r1.xyz);
    r1.xyz = max(r0.yzw, c1.yyy);
