// Mechanically reconstructed from 0x3211B7EF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = c1.w;
    r0.xyz = float3(((r6.w) >= 0.0f ? (r0.x) : (c[27].x)), ((r6.w) >= 0.0f ? (r0.x) : (c[27].y)), ((r6.w) >= 0.0f ? (r0.x) : (c[27].w)));
    r0.w = dot(r6.xyz, r12.xyz);
    r7.xyz = lerp(r0.xyz, c[28].xyw, r1.www);
    r2.w = (r0.w) + (r0.w);
    r4 = tex2D(s7, v1.xy);
    r3 = tex2D(s8, v6.zw);
    ...
    r3 = tex2D(s0, v1.xy);
    r3.xyz = float3(((r6.w) >= 0.0f ? (r2.x) : (r3.x)), ((r6.w) >= 0.0f ? (r2.y) : (r3.y)), ((r6.w) >= 0.0f ? (r2.z) : (r3.z)));
    r2.xyz = (r14.xyz) * (r5.www) + (-(r6.xyz));
