// Mechanically reconstructed from 0x102D2D1A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c26 = float4(2.0f, -1.0f, 1.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r5.y = dot(r2.xy, r0.zw) + (c26.w);
    r1 = tex2D(s3, v7.xy);
    r1.xyz = (r1.xyz) + (c26.yyy);
    r5.x = dot(r2.xy, r0.xy) + (c26.w);
    r1.xyz = (v0.yyy) * (r1.xyz) + (c26.zzz);
    r2 = tex2D(s6, v1.xy);
    ...
    r1.w = dot(r5.xy, r5.xy) + (c26.w);
    r5.z = (r0.w) * (-(c13.x)) + (c13.y);
    r1.w = exp2(-(r1.w));
    r5.w = (r1.w) * (c3.y) + (c3.z);
    r1.xy = (v1.zw) * (c13.yz);
    r3 = tex2D(s13, r1.xy);
    ...
    r2 = tex2D(s14, v1.zw);
    r8.xy = (r2.xy) * (c4.xx);
    r9.xy = (r3.yw) * (c4.yy) + (c4.zz);
    r3.xy = (r3.xz) * (r8.xx);
    r1.w = dot(r9.xy, r5.xy) + (c26.w);
    r1.y = (r2.x) * (c4.x) + (-(r3.x));
    r2.w = (r3.z) * (-(r8.x)) + (r1.y);
    r7.xy = (r1.xz) * (r8.yy);
    r1.y = (r2.y) * (c4.x) + (-(r7.x));
    r1.x = dot(r9.xy, r9.xy) + (c26.w);
    r1.y = (r1.z) * (-(r8.y)) + (r1.y);
    r1.z = exp2(-(r1.x));
    r10.y = (r2.w) + (r2.w);
    r1.z = (r1.z) * (c3.y) + (c3.z);
    ...
    r1.w = (r2.y) * (r1.w);
    r2.w = (r2.z) * (r2.w);
    r1.xyz = (r10.xyz) * (r5.www) + (r1.xyz);
    r1.w = (r1.w) * (r2.w);
    r2.xyw = c[24].xyw;
    r13.xyz = float3(((r4.w) >= 0.0f ? (r2.x) : (c[23].x)), ((r4.w) >= 0.0f ? (r2.y) : (c[23].y)), ((r4.w) >= 0.0f ? (r2.w) : (c[23].w)));
    r0.xyz = (r0.xyz) * (r1.www);
    r14.xyz = (r1.xyz) * (r13.yyy);
    r15.xyz = (r13.zzz) * (r0.xyz);
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c26.z) : (c26.w));
