// Mechanically reconstructed from 0x49CCC3B9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r13.xyz = (r2.xyz) * (c[5].yyy);
    r14.xyz = (r0.xyz) * (c[5].www);
    r2 = tex2D(s12, v0.zw);
