// Mechanically reconstructed from 0xEF2E2E26.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xyz = (v0.yyy) * (r1.xyz) + (c12.yyy);
    r0 = tex2D(s4, v7.zw);
    r0.xyz = (r0.xyz) + (c12.xxx);
    r2.xyz = (r11.xyz) * (c12.zzz);
    r10.xyz = (v0.zzz) * (r0.xyz) + (c12.yyy);
    r0 = tex2D(s5, v8.xy);
    r1.xyz = (r0.xyz) + (c12.xxx);
    r0.xyz = (r2.xyz) * (r10.xyz);
    r6.xyz = (v0.www) * (r1.xyz) + (c12.yyy);
