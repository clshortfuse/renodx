// Mechanically reconstructed from 0x66B3FA9C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.w = saturate(dot(r0.xyz, r3.xyz));
    r4.w = exp2(r14.y);
    r3.y = saturate(dot(r3.xyz, r6.xyz));
    r3.z = pow(abs(r7.w), r4.w);
    r3.w = (r4.w) * (c3.y) + (c3.z);
    r7.w = (-(r3.y)) + (c1.x);
    r4.w = (r3.z) * (r3.w);
    r6.z = (r7.w) * (r7.w);
