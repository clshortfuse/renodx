// Mechanically reconstructed from 0x12D587DE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c3 = float4(-0.200000003f, 0.0f, 1.0f, 0.200000003f);
    ...
    const float4 c36 = float4(2.0f, -1.0f, 0.0f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r3.y = dot(r1.xy, r0.zw) + (c36.z);
    r3.x = dot(r1.xy, r0.xy) + (c36.z);
    r0 = tex2D(s8, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c36.xxxx) * (v9) + (c36.yyyy);
    r4.y = dot(r1.xy, r0.zw) + (c36.z);
    r4.x = dot(r1.xy, r0.xy) + (c36.z);
    r0 = tex2D(s1, v1.xy);
    ...
    r0 = tex2D(s6, v7.zw);
    r4.w = (r0.w) * (v0.z);
    r3.xyz = lerp(r2.xyz, r0.xyz, r4.www);
    r0.xy = (v1.zw) * (c12.xy);
    r2 = tex2D(s13, r0.xy);
    r0.xy = (v1.zw) * (c12.xy) + (c12.zy);
    r0 = tex2D(s13, r0.xy);
    r2.w = r0.y;
    r10.xy = lerp(r1.xy, r4.xy, r4.ww);
    r1.xy = (r2.yw) * (c13.xx) + (c13.yy);
    r0.w = dot(r10.xy, r10.xy) + (c36.z);
    r0.y = dot(r1.xy, r1.xy) + (c36.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c4.x) + (c4.y);
    r1.w = (r0.y) * (c4.x) + (c4.y);
    r0.y = dot(r1.xy, r10.xy) + (c36.z);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v1.zw);
    r5.xy = (r1.xy) * (c12.ww);
    ...
    r5.xyz = (r1.xyz) * (r5.www) + (-(r7.xyz));
    r4.xyz = normalize(r5.xyz);
    r8.xyz = (r1.xyz) * (r5.www);
    r0 = (r2) + (r0);
    r2.w = saturate(dot(r4.xyz, r8.xyz));
    r1 = (r1.wwww) * (c3.yyyz) + (c3.wwwy);
    r2.w = (-(r2.w)) + (c36.w);
    r0 = (r4.wwww) * (r0) + (r1);
    r1.w = (r2.w) * (r2.w);
    r15.xyz = (r0.xyz) * (-(r0.xyz)) + (c36.www);
    r1.w = (r1.w) * (r1.w);
    r2.z = (r2.w) * (r1.w);
    r1.xyz = v2.xyz;
    ...
    r1.z = (r1.y) * (r1.z);
    r14.xyz = lerp(r6.www, c[32].xyw, r4.www);
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c36.w) : (c36.z));
    ...
    r1.z = (r3.x) * (r1.x);
    r1.w = (r1.w) * (r1.z);
    r1.z = (r1.y) * (-(r3.y)) + (c36.w);
    r1.xy = (r2.ww) * (r2.xy);
    r1.w = (r1.w) * (r1.z);
    r2.w = (r3.z) * (r1.w);
    r1.xy = (r1.xy) * (c12.yy) + (c12.yy);
    r1 = tex2D(s4, r1.xy);
