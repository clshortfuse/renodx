// Mechanically reconstructed from 0x0BAC2B50.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = dot(r4.xy, r1.xy) + (c12.z);
    r1.y = dot(r4.xy, r1.zw) + (c12.z);
    r4 = tex2D(s2, v6.xy);
    r4.w = (r4.w) * (v0.y);
    r0.w = r2.y;
    ...
    r0.y = dot(r6.xy, r6.xy) + (c12.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c2.x) + (c2.y);
    r5.w = (r0.y) * (c2.x) + (c2.y);
    r0.y = (r0.w) * (r5.w);
    r0.w = dot(r1.xy, r6.xy) + (c12.z);
    r1 = tex2D(s14, v1.zw);
    r8.xy = (r1.xy) * (c2.ww);
    ...
    r8.y = (r0.w) + (r0.w);
    r0 = tex2D(s7, v6.xy);
    r2.xy = lerp(c[23].xy, r0.yy, r4.ww);
    ...
    r2 = lerp(r3, r0, r4.wwww);
    r3.w = dot(r6.xyz, r9.xyz);
    r0 = lerp(r2, r1, r7.wwww);
    r1.z = (r3.w) + (r3.w);
    r1.w = (r0.w) * (c2.z);
    r1.xyz = (r9.xyz) * (-(r1.zzz)) + (r6.xyz);
