// Mechanically reconstructed from 0xC208EF90.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = (r2.w) * (r4.w) + (r4.z);
    r4.x = (r1.z) * (r4.w) + (r4.z);
    r4.y = dot(r3.xyz, c[30].xyz);
    r3.z = (r4.x) * (r3.w) + (c14.z);
    r4.x = 1.0f / (r3.z);
    r2.w = (-(r2.w)) + (c1.z);
    r3.z = (r2.w) * (r2.w);
    ...
    r3.x = (r2.w) * (c14.x) + (c14.y);
    r3.z = exp2(r3.y);
    r2.w = saturate(dot(r9.xyz, r2.xyz));
    r7.xyz = (r0.xyz) * (r3.xxx);
    r0.y = pow(abs(r2.w), r3.z);
    r2.w = (r3.z) * (c3.x) + (c3.y);
    r0.z = (-(r1.x)) + (c1.z);
    r0.x = (r0.y) * (r2.w);
    r0.y = (r0.z) * (r0.z);
    ...
    r1.x = (r0.z) * (c14.x) + (c14.y);
    r0.xyz = normalize(r2.xyz);
    r1.w = (r1.w) * (r1.x);
    r1.x = saturate(dot(r0.xyz, c[17].xyz));
    r2.y = saturate((r4.y) * (c[31].x) + (c[31].y));
    r1.x = (-(r1.x)) + (c1.z);
