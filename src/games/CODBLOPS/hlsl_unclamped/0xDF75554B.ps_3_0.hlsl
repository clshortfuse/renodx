// Mechanically reconstructed from 0xDF75554B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    float4 v5 = input.v5;
    float4 v6 = input.v6;
    const float4 c0 = float4(0.5f, 2.0f, -1.0f, 8.0f);
    const float4 c1 = float4(31.875f, 4.0f, 0.200000003f, -2.0f);
    const float4 c2 = float4(1.0f, 0.0f, 0.25f, 7.0f);
    const float4 c3 = float4(4.07999992f, 4.06451607f, -2.07999992f, -2.06451607f);
    const float4 c4 = float4(1.0f, 0.5f, 0.0f, 0.142857f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0.x = (r2.x) * (r0.x);
    r1.xz = c[23].xz;
    r0.y = dot(r1.yw, c[34].xy) + (r1.x);
    r0.z = dot(r1.yw, c[34].zw) + (r1.z);
    r1 = tex2D(s2, r0.yz);
    ...
    r6.xy = (abs(c0.zx)) * (v4.zw);
    r6 = tex2D(s13, r6.xy);
    r7.xy = (v4.zw) * (c4.xy) + (c4.zy);
    r7 = tex2D(s13, r7.xy);
    r6.w = r7.y;
    r6.yw = (r6.yw) * (c1.yy) + (c1.ww);
