// Mechanically reconstructed from 0x2A1B3E03.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r1.w) * (v0.y);
    r2.w = r4.y;
    r5.xy = lerp(r3.xy, r0.xy, r1.ww);
    r0 = tex2D(s3, v6.zw);
    r6.w = (r0.w) * (v0.z);
    r3.xy = (r2.yw) * (c4.xx) + (c4.yy);
    r6.xy = (r6.ww) * (-(r5.xy)) + (r5.xy);
    r2.w = dot(r3.xy, r3.xy) + (c12.z);
