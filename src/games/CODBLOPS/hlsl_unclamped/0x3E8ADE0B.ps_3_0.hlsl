// Mechanically reconstructed from 0x3E8ADE0B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c7 = float4(1.0f, 0.5f, -0.0f, 0.0009765625f);
    ...
    r4.z = (r0.w) * (v6.y) + (c1.x);
    r0.w = rsqrt(r1.w);
    r1.xyz = float3(((r4.z) >= 0.0f ? (r0.x) : (r1.x)), ((r4.z) >= 0.0f ? (r0.y) : (r1.y)), ((r4.z) >= 0.0f ? (r0.z) : (r1.z)));
    ...
    r1.w = (r3.w) * (r3.w);
    r1.xyz = (r9.yyy) * (v3.xyz) + (r0.xyz);
    r4.w = (r1.w) * (r1.w);
    r0.xyz = normalize(r1.xyz);
    r2 = tex2D(s3, v0.xy);
    r1 = tex2D(s4, v6.zw);
    r10.xy = float2(((r4.z) >= 0.0f ? (r1.w) : (r2.w)), ((r4.z) >= 0.0f ? (r1.y) : (r2.y)));
    r2.w = saturate(dot(r0.xyz, -(r8.xyz)));
    r1.x = (r10.x) * (c2.z);
    r1.w = (r10.x) * (-(c2.z)) + (c2.y);
    ...
    r2.xy = (v0.zw) * (c2.yw);
    r2 = tex2D(s13, r2.xy);
    r4.xy = (v0.zw) * (c7.xy) + (c7.zy);
    r4 = tex2D(s13, r4.xy);
    r2.w = r4.y;
    r6.xyz = (r3.xyz) * (r1.yyy);
    r3.xy = (r2.yw) * (c4.xx) + (c4.yy);
    r1.w = dot(r9.xy, r9.xy) + (c1.y);
    r1.z = dot(r3.xy, r3.xy) + (c1.y);
    r1.w = exp2(-(r1.w));
    r1.z = exp2(-(r1.z));
    r1.w = (r1.w) * (c1.z) + (c1.w);
    r1.x = (r1.z) * (c1.z) + (c1.w);
    r1.z = dot(r3.xy, r9.xy) + (c1.y);
    r1.x = (r1.w) * (r1.x);
    r3 = tex2D(s14, v0.zw);
    r11.xy = (r3.xy) * (c3.zz);
