// Mechanically reconstructed from 0x4C79EFF5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = (r2.xyz) * (-(r2.xyz)) + (c4.xxx);
    r1.z = (r1.z) * (r0.y);
    r0.xyz = (r6.xyz) * (r0.zzz) + (r10.xyz);
    r2.xyz = (r1.yyy) * (r3.xyz) + (r5.xyz);
    ...
    r2.w = (r2.w) + (r2.w);
    r7.xyz = (r0.xyz) * (r2.xyz) + (r1.xyz);
    r1.xyz = (r9.xyz) * (-(r2.www)) + (r4.xyz);
    r1 = texCUBElod(s15, r1);
    r1.xyz = (r1.xyz) * (r1.xyz);
    r3.xyz = (r1.xyz) * (c[21].xxx);
    r1.w = (r4.w) * (r4.w);
    r6.w = (r4.w) * (r1.w);
    r5 = (-(v6.yyyy)) + (c[6]);
    r1 = (r5) * (r5);
