// Mechanically reconstructed from 0xB53A169D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = dot(r11.xy, r11.xy) + (c14.z);
    r0.y = dot(r1.xy, r1.xy) + (c14.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c3.y) + (c3.z);
    r1.w = (r0.y) * (c3.y) + (c3.z);
    r0.y = dot(r1.xy, r11.xy) + (c14.z);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v1.zw);
    r7.xy = (r1.xy) * (c4.xx);
    ...
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c14.w) : (c14.z));
