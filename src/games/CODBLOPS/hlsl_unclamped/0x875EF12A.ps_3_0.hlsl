// Mechanically reconstructed from 0x875EF12A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = dot(r2.xyz, c[25].xyz);
    r2.w = saturate((r2.w) * (c[26].x) + (c[26].y));
    r5.x = 1.0f / (r3.z);
    r4.w = (r2.w) * (c[26].w);
    r4.xy = saturate((r5.xx) * (c[28].xy) + (c[28].zw));
    r3.xy = (r4.xy) * (r4.xy);
    r4.xy = (r4.xy) * (c2.yy) + (c2.zz);
    r3.w = dot(c[27].yz, r5.xy) + (c[27].x);
    r3.xy = (r3.xy) * (r4.xy);
