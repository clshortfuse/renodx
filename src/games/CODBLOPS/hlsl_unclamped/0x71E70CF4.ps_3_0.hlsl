// Mechanically reconstructed from 0x71E70CF4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = (r8.w) * (r0.z) + (r0.x);
    r0.z = (r0.z) * (r0.y) + (c3.w);
    r11.xy = (r1.ww) * (c8.xy) + (c8.zw);
    r0.x = 1.0f / (r0.z);
    r1.z = exp2(r11.y);
    r0.y = pow(abs(r9.w), r1.z);
    r0.z = (r1.z) * (c9.x) + (c9.y);
    r1.y = (r8.w) * (r0.x);
    r1.z = (r0.y) * (r0.z);
    r0.xyz = (r7.xyz) * (r7.www) + (r8.xyz);
    r3.w = (r1.y) * (r1.z);
    r1.xyz = (r2.xyz) * (r2.www) + (r3.xyz);
    r0.xyz = (r0.xyz) * (r3.www);
    r2.xyz = (r1.xyz) * (r1.xyz);
    r0.xyz = (r0.xyz) * (c[5].www);
    r5.xyz = (r0.xyz) * (c[19].xyz);
    r0.z = (-(r6.w)) + (c4.x);
    r0.x = 1.0f / (r11.x);
    r0.y = (r0.z) * (r0.z);
    r0.y = (r0.z) * (r0.y);
