// Mechanically reconstructed from 0x594635A3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s0, v0.xy);
    r3.xyz = lerp(r1.xyz, r0.xyz, r12.www);
    r1.w = (r1.w) * (-(v6.x)) + (c1.x);
    r2.w = (r0.w) * (-(v6.y)) + (c1.x);
    r0.w = dot(r8.xyz, r5.xyz);
    r3.xyz = (r3.xyz) * (r3.xyz);
    r0.w = (r0.w) + (r0.w);
    r1.xyz = (r3.xyz) * (r9.xyz) + (r10.xyz);
