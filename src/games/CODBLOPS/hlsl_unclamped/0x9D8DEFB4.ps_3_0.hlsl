// Mechanically reconstructed from 0x9D8DEFB4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = float3(((r1.w) >= 0.0f ? (c[32].x) : (r0.y)), ((r1.w) >= 0.0f ? (c[32].y) : (r0.y)), ((r1.w) >= 0.0f ? (c[32].w) : (r0.y)));
