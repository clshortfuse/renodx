// Mechanically reconstructed from 0x0BA52C23.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xz = (r4.xy) * (c3.xx);
    r0.xz = (r3.xy) * (c3.xx);
    r1.xyz = (r0.xyz) * (r0.www) + (r7.xyz);
    r0 = tex2D(s4, v5.zw);
    r6.w = (r0.w) * (v5.y);
    r13.xy = c0.xy;
    r2.xyz = (r13.xyx) + (-(c[36].xyw));
    r0.w = dot(v4.xyz, v4.xyz);
    r6.xyz = (r6.www) * (r2.xyz) + (c[36].xyw);
    r8.w = rsqrt(r0.w);
    r10.xyz = (r1.xyz) * (r6.yyy);
    r1 = tex2D(s12, v0.zw);
    r9.xyz = normalize(v1.xyz);
    r7.w = saturate(dot(r9.xyz, c[17].xyz));
    r0.w = ((-abs(r1.y)) >= 0.0f ? (c0.y) : (c0.x));
    ...
    r1.w = (r4.w) * (r9.w) + (r10.w);
    r8.w = (r6.w) * (r9.w) + (r10.w);
    ...
    r1.w = (r1.w) * (r8.w) + (c4.x);
    r8.w = saturate(dot(r9.xyz, r11.xyz));
    r6.x = 1.0f / (r1.w);
    r1.w = pow(abs(r8.w), r6.w);
    r6.x = (r7.w) * (r6.x);
    r1.w = (r0.w) * (r1.w);
    r1.w = (r6.x) * (r1.w);
    r3.xyz = (r3.xyz) * (r6.yyy) + (r10.xyz);
    r1.xyz = (r1.xyz) * (r8.xyz);
    r3.xyz = (r1.www) * (r3.xyz);
    r4.z = saturate(dot(r9.xyz, r4.xyz));
    r3.xyz = (r6.zzz) * (r3.xyz);
    r1.w = pow(abs(r4.z), r6.w);
