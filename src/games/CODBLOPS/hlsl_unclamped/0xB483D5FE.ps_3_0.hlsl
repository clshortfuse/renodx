// Mechanically reconstructed from 0xB483D5FE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r2.w) * (v0.y);
    r1.w = r0.x;
    r6.xy = lerp(r4.xy, r3.xy, r2.ww);
    r0 = tex2D(s7, v7.zw);
    r3.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r0 = (c1.xxxx) * (v9) + (c1.yyyy);
    r4.x = dot(r3.xy, r0.xy) + (c1.z);
    r4.y = dot(r3.xy, r0.zw) + (c1.z);
    r0 = tex2D(s5, v7.zw);
    r5.w = (r0.w) * (v0.z);
    r0.w = dot(r1, c2.xxxx);
