// Mechanically reconstructed from 0x4BB6A5AF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = float2(((r7.w) >= 0.0f ? (r1.x) : (c1.w)), ((r7.w) >= 0.0f ? (r1.y) : (c1.w)));
    ...
    r2 = float4(((r7.w) >= 0.0f ? (r2.x) : (c1.w)), ((r7.w) >= 0.0f ? (r2.y) : (c1.w)), ((r7.w) >= 0.0f ? (r2.z) : (c1.w)), ((r7.w) >= 0.0f ? (r2.w) : (c1.z)));
    r3.z = (r2.w) * (c2.z);
    r8.xyz = normalize(v6.xyz);
    r3.w = (r2.w) * (-(c2.z)) + (c2.w);
    r1.x = saturate(dot(r7.xyz, -(r8.xyz)));
    r1.y = (r1.z) * (r3.w) + (r3.z);
    r3.w = (r1.x) * (r3.w) + (r3.z);
    r4.w = ((r7.w) >= 0.0f ? (r3.y) : (c1.w));
    r1.y = (r1.y) * (r3.w) + (c3.z);
    r6.w = (-(r1.x)) + (c1.z);
    r1.y = 1.0f / (r1.y);
    r5.w = (r1.z) * (r1.y);
    ...
    r0 = float4(((r7.w) >= 0.0f ? (r0.x) : (c1.w)), ((r7.w) >= 0.0f ? (r0.y) : (c1.w)), ((r7.w) >= 0.0f ? (r0.z) : (c1.w)), ((r7.w) >= 0.0f ? (r0.w) : (c1.w)));
    r2.z = (r1.z) + (r1.z);
