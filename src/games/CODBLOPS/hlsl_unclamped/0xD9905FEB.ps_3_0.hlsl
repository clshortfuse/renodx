// Mechanically reconstructed from 0xD9905FEB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = dot(r6.xy, r2.xy) + (c1.z);
    r0.y = dot(r6.xy, r2.zw) + (c1.z);
    r2 = tex2D(s4, v7.xy);
    r2.w = (r2.w) * (v0.y) + (c1.w);
    r1.w = r4.x;
    r3.xyz = float3(((r2.w) >= 0.0f ? (r0.x) : (r3.x)), ((r2.w) >= 0.0f ? (r0.y) : (r3.y)), ((r2.w) >= 0.0f ? (r0.z) : (r3.z)));
    r0 = tex2D(s7, v7.zw);
    r4.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r0 = (c1.xxxx) * (v9) + (c1.yyyy);
    r6.x = dot(r4.xy, r0.xy) + (c1.z);
    r6.y = dot(r4.xy, r0.zw) + (c1.z);
    r0 = tex2D(s5, v7.zw);
    r5.w = (r0.w) * (v0.z);
    r0.w = dot(r1, c2.zzzz);
    r4.xy = lerp(r3.xy, r6.xy, r5.ww);
    r0.w = (r0.w) + (c1.y);
    r1.xyz = v4.xyz;
