// Mechanically reconstructed from 0x831F98C8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.w = (r0.w) * (v0.y) + (c3.w);
    r5.w = (r1.w) * (r1.z);
    r4.xy = float2(((r7.w) >= 0.0f ? (r1.x) : (r2.x)), ((r7.w) >= 0.0f ? (r1.y) : (r2.y)));
    r1 = tex2D(s6, v7.zw);
    ...
    r1 = tex2D(s7, v1.xy);
    r0 = tex2D(s8, v7.xy);
    r3 = float4(((r7.w) >= 0.0f ? (r0.x) : (r1.x)), ((r7.w) >= 0.0f ? (r0.y) : (r1.y)), ((r7.w) >= 0.0f ? (r0.z) : (r1.z)), ((r7.w) >= 0.0f ? (r0.w) : (r1.w)));
    ...
    r4.xyz = (r10.xyz) * (r4.zzz) + (r0.xyz);
    r0 = lerp(r3, r2, r4.wwww);
    r11.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c3.yyy));
    r2.xyw = c[24].xyw;
    r2.xyz = float3(((r7.w) >= 0.0f ? (r2.x) : (c[23].x)), ((r7.w) >= 0.0f ? (r2.y) : (c[23].y)), ((r7.w) >= 0.0f ? (r2.w) : (c[23].w)));
