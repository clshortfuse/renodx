// Mechanically reconstructed from 0x650EA165.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = saturate(dot(c[17].xyz, r8.xyz));
    ...
    r0 = (v4.yyyy) * (c[24]);
    r1.z = dot(r1.xyz, c[21].xyz);
    r0 = (v4.xxxx) * (c[23]) + (r0);
    r1.y = saturate((r1.z) * (c[22].x) + (c[22].y));
    r0 = (v4.zzzz) * (c[25]) + (r0);
    r1.z = (r1.y) * (c12.z) + (c12.w);
    r3 = (r0) + (c[26]);
    r0.w = (r1.y) * (r1.y);
    r2.zw = r3.zw;
    r3.z = (r1.z) * (r0.w);
