// Mechanically reconstructed from 0xDD4B7E4E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xyz = lerp(r0.xyz, c[30].xyw, r6.www);
    r0.z = (r1.w) + (r1.w);
    r5 = tex2D(s6, v1.xy);
    r3 = tex2D(s7, v7.zw);
    r4 = lerp(r5, r3, r6.wwww);
    r3.xyz = (r9.xyz) * (-(r0.zzz)) + (r13.xyz);
    r3.w = (r4.w) * (c1.w);
    ...
    r5.xyz = (r0.xyz) * (r1.www) + (r8.xyz);
    r4.xyz = (r14.xyz) * (r7.yyy);
    r3.xyz = (r3.xyz) * (r5.xyz);
    r11.xyz = (r11.xyz) * (r9.www) + (-(r13.xyz));
