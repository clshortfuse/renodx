// Mechanically reconstructed from 0x74C87655.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = dot(c[23].yz, r6.xy) + (c[23].x);
    r2.xy = (r2.xy) * (r3.xy);
    r2.z = (r10.y) * (r2.z);
    r2.w = (r2.w) * (r2.x);
    r6.xyz = (r2.zzz) * (c[22].xyz);
    r8.w = (r2.y) * (r2.w);
    r2 = tex2D(s12, v0.zw);
    r3.xy = (v0.zw) * (c2.zw);
    r3 = tex2D(s13, r3.xy);
    r4.xy = (v0.zw) * (c12.xy) + (c12.zy);
    r5 = tex2D(s13, r4.xy);
    r3.w = r5.y;
