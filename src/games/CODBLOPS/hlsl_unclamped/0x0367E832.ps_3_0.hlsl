// Mechanically reconstructed from 0x0367E832.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.w = (r0.w) * (r7.w) + (r5.z);
    r4.z = (r2.w) * (c3.z) + (c3.w);
    r1.x = (r1.x) * (r5.w) + (c12.z);
    r1.x = 1.0f / (r1.x);
    r0.w = (-(r0.w)) + (c3.x);
    r5.y = (r1.z) * (r1.x);
    r1.x = (r0.w) * (r0.w);
    r0.w = (r0.w) * (r1.x);
    r4.xy = (r1.ww) * (c16.xy) + (c16.zw);
    ...
    r1.x = pow(abs(r0.w), r4.y);
    r0.w = (r4.y) * (c14.x) + (c14.y);
    r1.x = (r1.x) * (r0.w);
    r2.w = saturate(dot(r10.xyz, c[17].xyz));
    r1.x = (r5.y) * (r1.x);
    r3.y = (r2.w) * (r7.w) + (r5.z);
    r3.z = saturate(dot(r10.xyz, r2.xyz));
    r2.z = (r3.y) * (r5.w) + (c12.z);
    r2.y = pow(abs(r3.z), r4.y);
    r2.z = 1.0f / (r2.z);
    r0.w = (r0.w) * (r2.y);
    r2.z = (r2.w) * (r2.z);
    r1.x = (r4.z) * (r1.x);
