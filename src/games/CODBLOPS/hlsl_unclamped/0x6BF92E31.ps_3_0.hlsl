// Mechanically reconstructed from 0x6BF92E31.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.y = (r0.z) + (r0.z);
    r0.y = c1.z;
    r2.xyz = (r0.yyy) + (c[5].xyw);
    r0.xyz = (r3.xyz) * (r0.www) + (r4.xyz);
    r8.xyz = (r5.www) * (r2.xyz) + (c1.xxx);
    ...
    r0.w = rsqrt(r0.w);
    r10.xyz = (r0.www) * (v5.xyz);
    r7.xyz = (v5.xyz) * (-(r0.www)) + (c[17].xyz);
    r2 = tex2D(s3, v6.zw);
    r2 = (r2) + (c1.yyyz);
    ...
    r11.xy = (r0.ww) * (c9.xy) + (c9.zw);
    r0.x = exp2(r11.y);
    r2.w = (-(r2.w)) + (c1.x);
    r6.w = pow(abs(r4.w), r0.x);
    r4.w = (r2.w) * (r2.w);
    r0.x = (r0.x) * (c3.y) + (c3.z);
    r4.w = (r4.w) * (r4.w);
    r0.x = (r6.w) * (r0.x);
