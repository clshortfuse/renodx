// Mechanically reconstructed from 0xB36EB09D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.w = (r1.w) * (v7.y) + (c1.x);
    r10.xyz = normalize(r0.xyz);
    r6.w = c1.y;
    r11.xyz = float3(((r12.w) >= 0.0f ? (r6.w) : (c[44].x)), ((r12.w) >= 0.0f ? (r6.w) : (c[44].y)), ((r12.w) >= 0.0f ? (r6.w) : (c[44].w)));
