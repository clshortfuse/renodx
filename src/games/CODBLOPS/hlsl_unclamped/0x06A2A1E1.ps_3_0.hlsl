// Mechanically reconstructed from 0x06A2A1E1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s13, r1.xy);
    r3.w = r1.y;
    r11.xy = (r4.ww) * (-(r2.xy)) + (r2.xy);
    r2.xy = (r3.yw) * (c4.xx) + (c4.yy);
    r0.w = dot(r11.xy, r11.xy) + (c13.w);
    r1.w = dot(r2.xy, r2.xy) + (c13.w);
    r0.w = exp2(-(r0.w));
    r1.w = exp2(-(r1.w));
    r0.w = (r0.w) * (c1.x) + (c1.y);
    r1.y = (r1.w) * (c1.x) + (c1.y);
    r1.w = dot(r2.xy, r11.xy) + (c13.w);
    r1.y = (r0.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c3.ww);
    ...
    r7.xz = (r3.xy) * (c4.xx);
    r6.xyz = (r0.xyz) * (r8.xyz) + (r4.xyz);
    r4.xyz = (r7.xyz) * (r0.www) + (r1.xyz);
    r2 = tex2D(s5, v1.xy);
    r3.w = r2.w;
    r3.xyz = (r8.xyz) * (c13.zzz);
    r0 = tex2D(s6, v8.zw);
