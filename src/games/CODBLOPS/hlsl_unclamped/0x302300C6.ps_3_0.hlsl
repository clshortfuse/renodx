// Mechanically reconstructed from 0x302300C6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xy = float2(((r3.w) >= 0.0f ? (r4.x) : (c1.z)), ((r3.w) >= 0.0f ? (r4.y) : (c1.z)));
    ...
    r1.xyz = (r2.wwy) * (c1.zyy) + (c1.wzz);
    r2.xyz = (r5.yyy) * (v4.xyz) + (r3.xyz);
    r8.xyz = normalize(r2.xyz);
    r2.xyz = normalize(v6.xyz);
    r3.xyz = float3(((r3.w) >= 0.0f ? (r1.x) : (c1.z)), ((r3.w) >= 0.0f ? (r1.y) : (c1.y)), ((r3.w) >= 0.0f ? (r1.z) : (c1.z)));
