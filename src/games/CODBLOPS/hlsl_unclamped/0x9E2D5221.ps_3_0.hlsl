// Mechanically reconstructed from 0x9E2D5221.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = float3(((r4.w) >= 0.0f ? (r2.x) : (c1.z)), ((r4.w) >= 0.0f ? (r2.y) : (c1.z)), ((r4.w) >= 0.0f ? (r2.z) : (c1.z)));
    ...
    r3.xyz = (r1.xyz) * (c3.xzx) + (r2.xyz);
    r1.xy = (v6.ww) * (c[11].xy) + (v6.xy);
    r1.zw = v6.zw;
    r1 = tex2Dproj(s2, r1);
    r2.xy = (v6.ww) * (-(c[11].xy)) + (v6.xy);
    r2.zw = v6.zw;
    r2 = tex2Dproj(s2, r2);
    r1.y = r2.x;
    r2.xy = (v6.ww) * (c[11].zw) + (v6.xy);
    r2.zw = v6.zw;
    r2 = tex2Dproj(s2, r2);
    r1.z = r2.x;
    r2.xy = (v6.ww) * (-(c[11].zw)) + (v6.xy);
    ...
    r1.w = saturate((r1.w) * (c[8].x) + (c[8].y));
    r5.x = 1.0f / (r1.z);
    r1.w = (r1.w) * (c[8].w);
