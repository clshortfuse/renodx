// Mechanically reconstructed from 0xE20C1618.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    float4 v7 = input.v7;
    float4 v8 = input.v8;
    const float4 c1 = float4(8.0f, 3.5f, 1.0f, 31.875f);
    ...
    r3 = tex2D(s6, v1.xy);
    r2 = tex2D(s7, v6.xy);
    r4.xy = float2(((r1.w) >= 0.0f ? (r2.w) : (r3.w)), ((r1.w) >= 0.0f ? (r2.y) : (r3.y)));
    r2.xyz = v2.xyz;
    r2.xyz = (r7.xxx) * (v4.xyz) + (r2.xyz);
    r9.xy = lerp(r4.yy, c[8].xy, r5.ww);
