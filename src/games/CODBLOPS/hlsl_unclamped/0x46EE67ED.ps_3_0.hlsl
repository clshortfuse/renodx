// Mechanically reconstructed from 0x46EE67ED.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c4 = float4(2.0f, -1.0f, 0.0f, 8.0f);
    ...
    const float4 c41 = float4(0.959999979f, 0.0399999991f, 1.0f, 0.5f);
    ...
    r4.y = dot(r1.xy, r0.zw) + (c4.z);
    r4.x = dot(r1.xy, r0.xy) + (c4.z);
    r0 = tex2D(s8, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c4.xxxx) * (v9) + (c4.yyyy);
    r5.y = dot(r1.xy, r0.zw) + (c4.z);
    r5.x = dot(r1.xy, r0.xy) + (c4.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s5, v7.xy);
    r4.w = (r0.w) * (v0.y);
    r2 = tex2D(s1, v1.xy);
    ...
    r1.xy = lerp(r2.xy, r4.xy, r4.ww);
    r0 = tex2D(s6, v7.zw);
    r3.w = (r0.w) * (v0.z);
    r2.xyz = lerp(r3.xyz, r0.xyz, r3.www);
    r4.xy = lerp(r1.xy, r5.xy, r3.ww);
    r1 = tex2D(s9, v1.xy);
    r0 = tex2D(s10, v7.xy);
    r3.xy = lerp(r1.wy, r0.wy, r4.ww);
    r0 = tex2D(s11, v7.zw);
    r11.xy = lerp(r3.xy, r0.wy, r3.ww);
    r6.xyz = (r2.xyz) * (r2.xyz);
    r6.w = (r11.x) * (-(c13.z)) + (c13.w);
    ...
    r2 = tex2D(s14, v1.zw);
    r0.xy = (r2.xy) * (c3.ww);
    r5.xy = (r1.wy) * (c13.xx) + (c13.yy);
    r3.xy = (r3.xz) * (r0.xx);
    r0.z = dot(r5.xy, r4.xy) + (c4.z);
    r1.w = (r2.x) * (c3.w) + (-(r3.x));
    r1.w = (r3.z) * (-(r0.x)) + (r1.w);
    r1.xy = (r1.xz) * (r0.yy);
    r2.w = (r2.y) * (c3.w) + (-(r1.x));
    r0.x = dot(r5.xy, r5.xy) + (c4.z);
    r0.y = (r1.z) * (-(r0.y)) + (r2.w);
    r0.x = exp2(-(r0.x));
    r7.y = (r1.w) + (r1.w);
    r0.x = (r0.x) * (c3.x) + (c3.y);
    ...
    else
    {
        if ((-(c4.y)) >= (v5.w))
        {
            ...
            if ((c16.w) < (v5.w))
            {
                ...
                r1.z = r3.x;
                r1.w = r2.x;
                r0.y = dot(r1, c16.zzzz);
                r0.x = (-(r0.z)) + (r0.y);
                r0.y = (v5.w) * (c40.x) + (c40.y);
                r2.y = (r0.y) * (r0.x) + (r0.z);
            }
            else
            {
    ...
    r0.y = (r0.y) * (r4.w) + (c16.x);
    r2.w = (r3.w) * (c16.y) + (c16.z);
    r0.y = 1.0f / (r0.y);
    r0.z = (r0.z) * (r2.w);
    r0.x = (r7.w) * (r0.y);
    r0.y = (r1.w) * (c41.x) + (c41.y);
    r0.z = (r0.z) * (r0.x);
    r1.w = (r0.y) * (r0.z);
    ...
    r1.y = (r1.y) * (r0.y);
    r0.w = (r0.w) * (r0.z);
    r1.x = (r0.w) * (c41.x) + (c41.y);
    r0 = (v6.yyyy) * (c[32]);
    r6.w = (r1.y) * (r1.x);
    r0 = (v6.xxxx) * (c[31]) + (r0);
    r1.y = saturate((r1.z) * (c[30].x) + (c[30].y));
    r0 = (v6.zzzz) * (c[33]) + (r0);
    r1.z = (r1.y) * (c40.z) + (c40.w);
    r3 = (r0) + (c[34]);
    r0.w = (r1.y) * (r1.y);
    r2.zw = r3.zw;
    r3.z = (r1.z) * (r0.w);
    ...
    r1 = tex2Dproj(s3, r1);
    r0.z = r1.x;
    r5.w = dot(r0, c16.zzzz);
    r0.xyz = (r6.www) * (c[22].xyz);
    r1.xyz = (r11.yyy) * (r0.xyz);
    r0 = (v6.xyzx) * (-(c4.yyyz)) + (-(c4.zzzy));
