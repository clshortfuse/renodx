// Mechanically reconstructed from 0x2E48DBF7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = rsqrt(r0.w);
    r4.w = (r1.w) * (c4.y);
    r2.xyz = (r0.xxx) * (v6.xyz);
    r3.w = (r1.w) * (-(c4.y)) + (c4.x);
    r0.w = saturate(dot(r11.xyz, -(r2.xyz)));
    r0.z = (r5.w) * (r3.w) + (r4.w);
    r2.w = (r0.w) * (r3.w) + (r4.w);
    r8.xyz = (v6.xyz) * (-(r0.xxx)) + (c[17].xyz);
    r0.z = (r0.z) * (r2.w) + (c2.w);
    r0.z = 1.0f / (r0.z);
