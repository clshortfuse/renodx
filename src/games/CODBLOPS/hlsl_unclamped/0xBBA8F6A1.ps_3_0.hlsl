// Mechanically reconstructed from 0xBBA8F6A1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s8, v1.xy);
    r1 = tex2D(s9, v7.xy);
    r0 = lerp(r2, r1, r3.zzzz);
    r1.xyw = c[27].xyw;
    r2.xyz = (-(r1.xyw)) + (c[28].xyw);
    r1 = tex2D(s5, v7.zw);
    r3.w = (r1.w) * (v0.z);
    r3.xyz = (r3.zzz) * (r2.xyz) + (c[27].xyw);
    r2.xyz = lerp(r4.xyz, r1.xyz, r3.www);
    r1 = tex2D(s6, v8.xy);
    r1.xyz = (r1.xyz) + (c31.yyy);
    r13.xyz = lerp(r3.xyz, c31.www, r3.www);
    r1.xyz = (v0.www) * (r1.xyz) + (c31.www);
    r7.xy = (r3.ww) * (-(r5.xy)) + (r5.xy);
    r4.xyz = (r0.xyz) * (r1.xyz);
    r0.xyz = (r2.xyz) * (r1.xyz);
    r1.w = dot(r7.xy, r7.xy) + (c31.z);
