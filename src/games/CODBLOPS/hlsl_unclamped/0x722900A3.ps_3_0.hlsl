// Mechanically reconstructed from 0x722900A3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.w = (r2.w) * (v0.y) + (c3.w);
    r6.w = (r1.w) * (r1.z);
    r8.xy = float2(((r4.w) >= 0.0f ? (r1.x) : (r3.x)), ((r4.w) >= 0.0f ? (r1.y) : (r3.y)));
    r3 = tex2D(s0, v1.xy);
    ...
    r0.y = dot(r8.xy, r8.xy) + (c3.z);
    r0.w = dot(r5.xy, r5.xy) + (c3.z);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r7.w = (r0.y) * (c11.x) + (c11.y);
    r0.y = (r0.w) * (c11.x) + (c11.y);
    r0.w = dot(r5.xy, r8.xy) + (c3.z);
    r0.y = (r7.w) * (r0.y);
    r6.xyz = float3(((r4.w) >= 0.0f ? (r2.x) : (r3.x)), ((r4.w) >= 0.0f ? (r2.y) : (r3.y)), ((r4.w) >= 0.0f ? (r2.z) : (r3.z)));
    r0.w = saturate((r0.w) * (r0.y) + (r0.y));
    r2 = tex2D(s14, v1.zw);
    r3.xy = (r2.xy) * (c11.ww);
    r9.xy = (r1.xz) * (r3.xx);
    r1.xy = (r0.xz) * (r3.yy);
    r0.x = (r2.x) * (c11.w) + (-(r9.x));
