// Mechanically reconstructed from 0xC0FD9AC4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r2.w) * (c2.x);
    r2.xyz = (r8.xyz) * (r3.www) + (r10.xyz);
    r3.w = max(abs(r9.y), abs(r9.z));
    r3.xyz = (r0.www) * (r2.xyz);
    r0.w = max(abs(r9.x), r3.w);
    r0.w = 1.0f / (r0.w);
