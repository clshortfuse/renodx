// Mechanically reconstructed from 0x70B3588D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = ((-abs(r2.w)) >= 0.0f ? (c3.x) : (r2.z));
    r7.xy = (r2.xy) * (r2.xy);
    r9.xy = (r2.xy) * (c14.xx) + (c14.yy);
    ...
    r4.w = (r2.w) * (r4.w);
    r7.z = saturate(dot(r2.xyz, r7.xyz));
    r2.y = saturate(dot(r6.xyz, r2.xyz));
    r2.z = (-(r7.z)) + (c1.y);
    r6.z = pow(abs(r2.y), r7.w);
    r2.x = (r2.z) * (r2.z);
    r2.y = (r7.w) * (c4.y) + (c4.z);
    r2.x = (r2.x) * (r2.x);
    r2.y = (r6.z) * (r2.y);
