// Mechanically reconstructed from 0x3F0BBCC6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.z = saturate(dot(r2.xyz, r0.xyz));
    r4.w = saturate(dot(r9.xyz, r2.xyz));
    r0 = tex2D(s4, v1.xy);
    r9.w = (r0.w) * (-(c1.x)) + (c1.y);
    r10.w = (r0.w) * (c1.x);
    r5.w = saturate(dot(r2.xyz, -(r3.xyz)));
    r0.z = (r4.w) * (r9.w) + (r10.w);
    r8.w = (r5.w) * (r9.w) + (r10.w);
    r0.z = (r0.z) * (r8.w) + (c1.z);
    r5.xy = (r0.ww) * (c13.xy) + (c13.zw);
    r1.z = 1.0f / (r0.z);
    r2.w = exp2(r5.y);
    r1.w = pow(abs(r4.z), r2.w);
    r0.z = (r2.w) * (c4.x) + (c4.y);
    r1.z = (r4.w) * (r1.z);
    r1.w = (r1.w) * (r0.z);
    r5.y = (r1.y) * (r1.x);
    r5.z = (r1.z) * (r1.w);
    r1 = tex2D(s0, v1.xy);
    r4.xyz = lerp(r1.xyz, c0.xxx, r0.xxx);
    r12.xyz = (r4.xyz) * (-(r4.xyz)) + (c0.www);
    r13.xyz = (r4.xyz) * (r4.xyz);
    r4.xyz = (r0.xxx) * (r1.xyz);
    r1.xyz = (r12.xyz) * (r5.yyy) + (r13.xyz);
