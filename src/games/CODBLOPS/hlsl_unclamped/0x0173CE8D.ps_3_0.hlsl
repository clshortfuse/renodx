// Mechanically reconstructed from 0x0173CE8D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = float4(((r3.w) >= 0.0f ? (r1.x) : (c1.z)), ((r3.w) >= 0.0f ? (r1.y) : (c1.z)), ((r3.w) >= 0.0f ? (r1.z) : (c1.z)), ((r3.w) >= 0.0f ? (r1.w) : (c1.y)));
    r3.xyz = (r3.zzz) * (r2.xyz);
    r2.xyz = v4.xyz;
    r2.xyz = (r1.xxx) * (r2.xyz) + (v2.xyz);
    ...
    r1.x = 1.0f / (r1.x);
    r8.xyz = (r2.xyz) * (r2.www) + (-(r5.xyz));
    r2.w = (r1.y) * (r1.x);
    r2.xyz = (r1.yyy) * (c[6].xyz);
    r5.xyz = normalize(r8.xyz);
    r1.x = saturate(dot(r7.xyz, r5.xyz));
    r1.w = (r1.w) * (c3.x) + (c3.y);
    r1.y = saturate(dot(r5.xyz, r6.xyz));
    r1.w = exp2(r1.w);
    r3.w = pow(abs(r1.x), r1.w);
    r1.y = (-(r1.y)) + (c1.y);
    r1.w = (r1.w) * (c3.z) + (c3.w);
    r1.x = (r1.y) * (r1.y);
    r1.w = (r3.w) * (r1.w);
