// Mechanically reconstructed from 0x44366D26.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.w = (r0.w) * (v0.z);
    r2.yz = c1.yz;
    r5.xyz = float3(((r1.w) >= 0.0f ? (r2.y) : (c[29].x)), ((r1.w) >= 0.0f ? (r2.z) : (c[29].y)), ((r1.w) >= 0.0f ? (r2.y) : (c[29].w)));
    ...
    r7.xy = (r5.ww) * (-(r3.xy)) + (r3.xy);
    r0.xyz = (r2.xyz) * (r1.www) + (-(r15.xyz));
    ...
    r0.z = (-(r1.w)) + (c1.z);
    r4.w = saturate(dot(r14.xyz, r1.xyz));
    r3 = tex2D(s7, v1.xy);
    r2 = tex2D(s8, v8.zw);
    ...
    r0.x = 1.0f / (r0.y);
    r9.w = exp2(r17.y);
    r0.y = pow(abs(r4.w), r9.w);
    r7.w = (r9.w) * (c13.y) + (c13.z);
    r1.x = (r1.z) * (r0.x);
    r1.y = (r0.y) * (r7.w);
    r0.xyz = (r11.xyz) * (r0.zzz) + (r12.xyz);
    r1.y = (r1.x) * (r1.y);
    r13.xyz = lerp(r5.xyz, c[30].xyw, r5.www);
