// Mechanically reconstructed from 0xEC3D177F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.w = rsqrt(r1.x);
    r0.w = (r0.w) * (r1.z);
    r9.xyz = (r7.xyz) * (r10.www);
    r0.w = (r1.w) * (r0.w);
    r1.w = dot(r9.xyz, c[30].xyz);
    ...
    r4.w = exp2(r5.y);
    r5.z = saturate(dot(r10.xyz, r1.xyz));
    r3.w = (r4.w) * (c1.y) + (c1.z);
    ...
    r1.w = (r2.w) + (r2.w);
    r2.xyz = (r5.xyz) * (r0.xyz) + (r11.xyz);
    r0.xyz = (r10.xyz) * (-(r1.www)) + (r8.xyz);
    r0 = texCUBElod(s15, r0);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r1.xyz = (r7.xyz) * (r10.www) + (-(r8.xyz));
