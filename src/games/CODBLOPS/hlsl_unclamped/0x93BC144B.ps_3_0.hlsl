// Mechanically reconstructed from 0x93BC144B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = (r2.xy) * (r4.xy);
    r11.xyz = lerp(r3.yyy, c[36].xyw, r12.www);
    r0.w = (r0.w) * (r2.x);
    ...
    r3.xyz = (r1.www) * (c[32].xyz);
    r0.xyz = normalize(r5.xyz);
    r5.xyz = (r10.www) * (r3.xyz) + (r4.xyz);
