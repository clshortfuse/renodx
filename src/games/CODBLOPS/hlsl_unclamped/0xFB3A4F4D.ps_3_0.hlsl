// Mechanically reconstructed from 0xFB3A4F4D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = dot(r11.xy, r11.xy) + (c14.w);
    r2.y = dot(r3.xy, r3.xy) + (c14.w);
    r2.w = exp2(-(r2.w));
    r2.y = exp2(-(r2.y));
    r2.w = (r2.w) * (c1.x) + (c1.y);
    r3.w = (r2.y) * (c1.x) + (c1.y);
    r2.y = dot(r3.xy, r11.xy) + (c14.w);
    r4.w = (r2.w) * (r3.w);
    r3 = tex2D(s14, v1.zw);
    r12.xy = (r3.xy) * (c2.ww);
