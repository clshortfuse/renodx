// Mechanically reconstructed from 0x9986309D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xy = (r4.yw) * (c12.xx) + (c12.yy);
    r3 = tex2D(s14, v0.zw);
    r1.xy = (r3.xy) * (c4.ww);
    r0.z = dot(r0.xy, r6.xy) + (c31.z);
    r4.xy = (r4.xz) * (r1.xx);
    r1.z = (r3.x) * (c4.w) + (-(r4.x));
    r5.xy = (r2.xz) * (r1.yy);
    r1.x = (r4.z) * (-(r1.x)) + (r1.z);
