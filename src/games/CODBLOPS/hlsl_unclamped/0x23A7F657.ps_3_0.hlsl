// Mechanically reconstructed from 0x23A7F657.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = saturate(dot(r9.xyz, -(r12.xyz)));
    r7.z = (r15.x) * (c4.x);
    r5.w = (r6.w) * (r7.w) + (r7.z);
    ...
    r2 = tex2D(s14, v1.zw);
    r0.xy = (r2.xy) * (c12.xx);
    r7.xy = (r1.wy) * (c12.yy) + (c12.zz);
    r3.xy = (r3.xz) * (r0.xx);
    r0.z = dot(r7.xy, r8.xy) + (c3.x);
    r1.w = (r2.x) * (c12.x) + (-(r3.x));
    r1.w = (r3.z) * (-(r0.x)) + (r1.w);
    r1.xy = (r1.xz) * (r0.yy);
