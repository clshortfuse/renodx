// Mechanically reconstructed from 0x92AF17C1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xy = float2(((r6.w) >= 0.0f ? (r2.x) : (r3.x)), ((r6.w) >= 0.0f ? (r2.y) : (r3.y)));
    r1 = tex2D(s0, v1.xy);
    r4.xyz = float3(((r6.w) >= 0.0f ? (r0.x) : (r1.x)), ((r6.w) >= 0.0f ? (r0.y) : (r1.y)), ((r6.w) >= 0.0f ? (r0.z) : (r1.z)));
    r1 = tex2D(s9, v1.xy);
    r2 = (r1.wwww) * (c3.xxxy) + (c3.zzzx);
    r0 = tex2D(s10, v7.xy);
    r3 = float4(((r6.w) >= 0.0f ? (r0.x) : (r2.x)), ((r6.w) >= 0.0f ? (r0.y) : (r2.y)), ((r6.w) >= 0.0f ? (r0.z) : (r2.z)), ((r6.w) >= 0.0f ? (r0.w) : (r2.w)));
    r2 = tex2D(s6, v7.zw);
    r5.w = (r2.w) * (v0.z) + (c4.w);
    r0 = tex2D(s11, v7.zw);
    ...
    r8.xy = float2(((r5.w) >= 0.0f ? (r5.x) : (r6.x)), ((r5.w) >= 0.0f ? (r5.y) : (r6.y)));
    r5.xyz = (r2.xyz) * (r2.xyz);
    r11.w = (r0.w) * (-(c13.z)) + (c13.w);
    r1.w = dot(r8.xy, r8.xy) + (c4.z);
    r14.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c4.yyy));
    r1.w = exp2(-(r1.w));
    ...
    r10.xy = (r4.xz) * (r6.xx);
    r1.w = dot(r7.xy, r8.xy) + (c4.z);
    r1.x = (r3.x) * (c12.w) + (-(r10.x));
    r2.y = (r4.z) * (-(r6.x)) + (r1.x);
    r4.xy = (r2.xz) * (r6.yy);
    r2.w = (r3.y) * (c12.w) + (-(r4.x));
    r1.x = dot(r7.xy, r7.xy) + (c4.z);
    r2.w = (r2.z) * (-(r6.y)) + (r2.w);
    r1.x = exp2(-(r1.x));
    r9.y = (r2.y) + (r2.y);
    ...
    r1.w = (-(r1.w)) + (-(c4.y));
    r1.xyz = float3(((r6.w) >= 0.0f ? (c[39].x) : (r1.y)), ((r6.w) >= 0.0f ? (c[39].y) : (r1.y)), ((r6.w) >= 0.0f ? (c[39].w) : (r1.y)));
    r3.w = (r1.w) * (r1.w);
    r13.xyz = float3(((r5.w) >= 0.0f ? (c[40].x) : (r1.x)), ((r5.w) >= 0.0f ? (c[40].y) : (r1.y)), ((r5.w) >= 0.0f ? (c[40].w) : (r1.z)));
    r1.z = (r3.w) * (r3.w);
