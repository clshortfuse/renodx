// Mechanically reconstructed from 0xD3E73B72.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.z = (r2.w) * (r3.w) + (r3.z);
    r3.w = (r2.x) * (r3.w) + (r3.z);
    r7.xyz = float3(((r5.w) >= 0.0f ? (c[28].x) : (r2.y)), ((r5.w) >= 0.0f ? (c[28].y) : (r2.y)), ((r5.w) >= 0.0f ? (c[28].w) : (r2.y)));
