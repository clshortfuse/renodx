// Mechanically reconstructed from 0xE3A47CC1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s3, v8.xy);
    r0.w = (r0.w) * (v0.y) + (c1.x);
    r5.xyz = float3(((r0.w) >= 0.0f ? (r0.x) : (r1.x)), ((r0.w) >= 0.0f ? (r0.y) : (r1.y)), ((r0.w) >= 0.0f ? (r0.z) : (r1.z)));
    r0.yz = c1.yz;
    r3.xyz = float3(((r0.w) >= 0.0f ? (r0.y) : (c[5].x)), ((r0.w) >= 0.0f ? (r0.z) : (c[5].y)), ((r0.w) >= 0.0f ? (r0.y) : (c[5].w)));
    r1 = tex2D(s4, v8.zw);
    r2.w = (r1.w) * (v0.z) + (c1.x);
    r0 = v2;
    r0.xyz = (r6.xxx) * (v5.xyz) + (r0.xyz);
    r8.xyz = float3(((r2.w) >= 0.0f ? (r1.x) : (r5.x)), ((r2.w) >= 0.0f ? (r1.y) : (r5.y)), ((r2.w) >= 0.0f ? (r1.z) : (r5.z)));
    ...
    r1.z = (r1.z) * (r1.y);
    r11.xyz = float3(((r2.w) >= 0.0f ? (c1.y) : (r3.x)), ((r2.w) >= 0.0f ? (c1.z) : (r3.y)), ((r2.w) >= 0.0f ? (c1.y) : (r3.z)));
