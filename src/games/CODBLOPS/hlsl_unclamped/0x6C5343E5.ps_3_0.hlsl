// Mechanically reconstructed from 0x6C5343E5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.y = dot(r2.xy, r0.zw) + (c20.w);
    r1 = tex2D(s3, v7.xy);
    r1.xyz = (r1.xyz) + (c20.yyy);
    r5.x = dot(r2.xy, r0.xy) + (c20.w);
    r1.xyz = (v0.yyy) * (r1.xyz) + (c20.zzz);
    r2 = tex2D(s6, v1.xy);
    ...
    r5.xy = float2(((r4.w) >= 0.0f ? (r5.x) : (r6.x)), ((r4.w) >= 0.0f ? (r5.y) : (r6.y)));
    ...
    r3 = tex2D(s13, r2.xy);
    r1.w = r3.y;
    r5.w = (r0.w) * (-(c12.x)) + (c12.y);
    r2.xy = (r1.wy) * (c4.yy) + (c4.zz);
    r1.y = dot(r5.xy, r5.xy) + (c20.w);
    r1.w = dot(r2.xy, r2.xy) + (c20.w);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r3.w = (r1.y) * (c3.y) + (c3.z);
    r1.y = (r1.w) * (c3.y) + (c3.z);
    r1.w = dot(r2.xy, r5.xy) + (c20.w);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c4.xx);
    ...
    r2.z = saturate(dot(r12.xyz, c[17].xyz));
    r2.x = (r6.w) * (r5.w) + (r2.y);
    r2.w = (r2.z) * (r5.w) + (r2.y);
    ...
    r1.w = (r1.w) * (r2.w);
    r2.xyw = c[9].xyw;
    r11.xyz = float3(((r4.w) >= 0.0f ? (r2.x) : (c[8].x)), ((r4.w) >= 0.0f ? (r2.y) : (c[8].y)), ((r4.w) >= 0.0f ? (r2.w) : (c[8].w)));
    r0.xyz = (r0.xyz) * (r1.www);
    r15.xyz = (r1.xyz) * (r11.yyy);
    r13.xyz = (r11.zzz) * (r0.xyz);
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c20.z) : (c20.w));
    r14.xyz = (r2.zzz) * (c[18].xyz);
    if ((r0.z) != (-(r0.z)))
    {
        r0.z = r1.y;
        r1.w = r0.z;
