// Mechanically reconstructed from 0x40A17E9B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.yzw = (r0.wyy) + (c1.xyx);
    r0.x = dot(r2.xyz, r2.xyz);
    r0.x = rsqrt(r0.x);
    r8.xyz = (r3.www) * (v6.xyz);
    r13.xy = (r5.ww) * (r0.yw) + (c1.ww);
