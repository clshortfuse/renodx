// Mechanically reconstructed from 0x4C22F4C3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4 = tex2D(s6, v1.xy);
    r11.xyz = lerp(r4.yyy, c[36].xyw, r5.www);
    ...
    r4.xyz = (r1.xxx) * (c[18].xyz);
    r2 = tex2D(s4, v7.xy);
    r0.xyz = (r2.xyz) + (c1.xxx);
    r7.xyz = (r1.yyy) * (r4.xyz) + (r7.xyz);
    ...
    r1.w = pow(abs(r8.w), r5.w);
    r1.x = (r1.x) * (r4.y);
    r1.w = (r3.w) * (r1.w);
    r4.xyz = (r2.xyz) * (r4.zzz) + (r3.xyz);
    r1.w = (r1.x) * (r1.w);
    r8.w = (-(r1.z)) + (c1.y);
