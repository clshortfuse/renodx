// Mechanically reconstructed from 0x638E91B5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.x = dot(r6.xy, r1.xy) + (c13.z);
    r5.y = dot(r6.xy, r1.zw) + (c13.z);
    r1 = tex2D(s3, v6.zw);
    r5.w = (r1.w) * (v6.y);
    r8.xy = (r0.yw) * (c4.xx) + (c4.yy);
    r6.xy = lerp(r7.xy, r5.xy, r5.ww);
    r0.w = dot(r8.xy, r8.xy) + (c13.z);
    ...
    r4.y = (r0.w) + (r0.w);
    r0.xyw = c[28].xyw;
    r2.xyz = (-(r0.xyw)) + (c[29].xyw);
    r0.xyz = (r4.xyz) * (r3.www) + (r3.xyz);
    r8.xyz = (r5.www) * (r2.xyz) + (c[28].xyw);
    ...
    r2.w = (r2.w) * (-(v6.x)) + (c13.w);
    r1.z = dot(r10.xyz, r9.xyz);
    r1.w = (r1.w) * (-(v6.y)) + (c13.w);
    r2.z = (r1.z) + (r1.z);
