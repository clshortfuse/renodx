// Mechanically reconstructed from 0x77D4BE0E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = v2;
    r3.xyz = (r14.xxx) * (v5.xyz) + (r0.xyz);
    r0.xyz = (r4.xyz) * (r3.www) + (-(r10.xyz));
    r4.xyz = (r14.yyy) * (v4.xyz) + (r3.xyz);
    ...
    r5.y = exp2(r4.y);
    r2.w = 1.0f / (r4.x);
    r4.x = pow(abs(r6.w), r5.y);
    r5.z = (r3.w) * (c2.z);
    r4.w = (r3.w) * (-(c14.z)) + (c14.w);
    r4.y = saturate(dot(r0.xyz, -(r10.xyz)));
    r4.z = (r5.w) * (r4.w) + (r5.z);
    r5.z = (r4.y) * (r4.w) + (r5.z);
    r4.w = (r5.y) * (c3.y) + (c3.z);
    r4.z = (r4.z) * (r5.z) + (c3.x);
    ...
    r4.xyz = (r8.www) * (r3.xyz) + (c[21].xyw);
    r3.xy = (v1.zw) * (c4.xy);
    r3 = tex2D(s13, r3.xy);
    r5.xy = (v1.zw) * (c4.xy) + (c4.zy);
    r5 = tex2D(s13, r5.xy);
    r3.w = r5.y;
    r9.xyz = lerp(r4.xyz, c[23].xyw, r7.www);
