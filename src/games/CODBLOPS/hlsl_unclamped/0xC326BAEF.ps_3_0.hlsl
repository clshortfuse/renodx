// Mechanically reconstructed from 0xC326BAEF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyz = (v0.yyy) * (r1.xyz) + (c13.yyy);
    r1.xyz = (r0.xyz) * (r3.xyz);
    r0 = tex2D(s3, v7.zw);
    r2.xyz = (r0.xyz) + (c13.xxx);
    r0.xyz = (r3.xyz) * (c13.zzz);
    r2.xyz = (v0.zzz) * (r2.xyz) + (c13.yyy);
    ...
    r2.w = dot(r11.xy, r11.xy) + (c13.w);
    r2.y = dot(r3.xy, r3.xy) + (c13.w);
    r2.w = exp2(-(r2.w));
    r2.y = exp2(-(r2.y));
    r2.w = (r2.w) * (c1.x) + (c1.y);
    r3.w = (r2.y) * (c1.x) + (c1.y);
    r2.y = dot(r3.xy, r11.xy) + (c13.w);
    r4.w = (r2.w) * (r3.w);
    r3 = tex2D(s14, v1.zw);
    r12.xy = (r3.xy) * (c2.ww);
