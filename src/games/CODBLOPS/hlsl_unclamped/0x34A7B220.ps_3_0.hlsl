// Mechanically reconstructed from 0x34A7B220.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.xyz = (r0.xyz) * (c[30].yyy);
    r0.w = dot(r1.xyz, r1.xyz);
    r0.w = rsqrt(r0.w);
    r11.xyz = (r9.www) * (v7.xyz);
    ...
    r8.w = saturate(dot(r8.xyz, c[17].xyz));
    r1 = tex2D(s12, v1.zw);
    ...
    r0.xyz = (v7.xyz) * (-(r9.www)) + (c[17].xyz);
    r9.xyz = normalize(r0.xyz);
    r0.z = saturate(dot(r9.xyz, c[17].xyz));
    r0.z = (-(r0.z)) + (c4.x);
    r0.y = (r0.z) * (r0.z);
    r6.xyz = (r2.www) * (r6.xyz) + (r12.xyz);
    r0.y = (r0.y) * (r0.y);
    r5.w = (r0.z) * (r0.y);
    r12.z = saturate(dot(r10.xyz, r8.xyz));
    r1 = tex2D(s5, v1.xy);
    ...
    r0.z = (r12.z) * (r10.w) + (r11.w);
    r4.w = (r1.z) * (r10.w) + (r11.w);
    r0.z = (r0.z) * (r4.w) + (c3.w);
    r1.xy = (r1.ww) * (c15.xy) + (c15.zw);
    r0.y = 1.0f / (r0.z);
    r9.w = exp2(r1.y);
    r0.z = pow(abs(r6.w), r9.w);
    r6.w = (r9.w) * (c12.x) + (c12.y);
    r2.z = (r12.z) * (r0.y);
    r1.y = (r0.z) * (r6.w);
    r0.xyz = (r4.xyz) * (r12.www) + (r5.xyz);
    r1.y = (r2.z) * (r1.y);
    ...
    r4.zw = r5.zw;
    r8.xyz = (r2.xyz) * (r6.xyz) + (r1.xyz);
    r6.zw = r4.zw;
    r7.xyz = (r7.xyz) * (r0.xyz);
    r2.zw = r6.zw;
    r1.xy = (r5.ww) * (-(c[28].zw)) + (r5.xy);
    r1.zw = r2.zw;
    r1 = tex2Dproj(s3, r1);
    r1.w = r1.x;
    ...
    r6 = tex2Dproj(s3, r4);
    r1.x = r6.x;
    r2.xy = (r4.ww) * (c[28].zw) + (r5.xy);
    r4 = tex2Dproj(s3, r2);
    r2 = (v7.xyzx) * (c4.xxxw) + (c4.wwwx);
    r1.z = r4.x;
    r0.z = dot(r2, c[21]);
    r4.w = 1.0f / (r0.z);
    r4.x = dot(r2, c[20]);
