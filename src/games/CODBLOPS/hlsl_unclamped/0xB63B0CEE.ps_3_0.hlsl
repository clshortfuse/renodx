// Mechanically reconstructed from 0xB63B0CEE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = dot(r8.xy, r8.xy) + (c1.w);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c2.x) + (c2.y);
    r3.w = (r0.y) * (c2.x) + (c2.y);
    r0.y = (r0.w) * (r3.w);
    r0.w = dot(r2.xy, r8.xy) + (c1.w);
    r2 = tex2D(s14, v0.zw);
    r9.xy = (r2.xy) * (c3.ww);
    ...
    r8.xyz = (v5.xyz) * (-(r2.www)) + (c[17].xyz);
    r9.z = saturate(dot(r10.xyz, c[17].xyz));
