// Mechanically reconstructed from 0x7727686D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4 = tex2D(s2, v6.xy);
    r4.w = (r4.w) * (v0.y) + (c3.w);
    r2.z = dot(r8.xy, r8.xy) + (c3.z);
    r6 = float4(((r4.w) >= 0.0f ? (r0.x) : (r1.x)), ((r4.w) >= 0.0f ? (r0.y) : (r1.y)), ((r4.w) >= 0.0f ? (r0.z) : (r1.z)), ((r4.w) >= 0.0f ? (r0.w) : (r1.w)));
    r0 = tex2D(s5, v6.zw);
    r1.xy = (r0.wy) * (c2.xy) + (c2.zw);
    ...
    r3.w = (r1.z) * (c4.x) + (c4.y);
    r1.z = dot(r0.xy, r0.xy) + (c3.z);
    r2 = (r2.wwww) * (c1.xxxy) + (c1.zzzx);
    r3.y = exp2(-(r1.z));
    r1 = (r1.wwww) * (c1.xxxy) + (c1.zzzx);
    r5.w = (r3.y) * (c4.x) + (c4.y);
    r3.y = (r3.w) * (r5.w);
    r3.w = dot(r8.xy, r0.xy) + (c3.z);
    r6 = tex2D(s14, v1.zw);
    r9.xy = (r6.xy) * (c12.xx);
    r6.w = saturate((r3.w) * (r3.y) + (r3.y));
    r7.xy = (r7.xz) * (r9.yy);
    r3.w = (r6.y) * (c12.x) + (-(r7.x));
    r8.xz = (r7.xy) * (c12.yy);
    r3.w = (r7.z) * (-(r9.y)) + (r3.w);
    r3.xy = (r3.xz) * (r9.xx);
    r8.y = (r3.w) + (r3.w);
    r3.w = (r6.x) * (c12.x) + (-(r3.x));
    ...
    r0.y = (r0.y) + (r0.y);
    r2.w = (r1.w) * (c1.w);
    r2.xyz = (r9.xyz) * (-(r0.yyy)) + (r6.xyz);
    r2 = texCUBElod(s15, r2);
    r0.y = saturate(dot(r9.xyz, -(r6.xyz)));
    r0.y = (-(r0.y)) + (-(c3.y));
    r2.w = (r0.y) * (r0.y);
    r0.x = (r1.w) * (c4.z) + (c4.w);
    r0.y = (r0.y) * (r2.w);
