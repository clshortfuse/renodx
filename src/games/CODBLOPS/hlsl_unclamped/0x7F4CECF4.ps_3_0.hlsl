// Mechanically reconstructed from 0x7F4CECF4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = (r4.xz) * (r0.xx);
    r0.z = dot(r8.xy, r12.xy) + (c4.x);
    r2.w = (r3.x) * (c3.w) + (-(r4.x));
    r2.w = (r4.z) * (-(r0.x)) + (r2.w);
    r2.xy = (r2.xz) * (r0.yy);
    r3.w = (r3.y) * (c3.w) + (-(r2.x));
    r0.x = dot(r8.xy, r8.xy) + (c4.x);
    r0.y = (r2.z) * (-(r0.y)) + (r3.w);
    r0.x = exp2(-(r0.x));
    r8.y = (r2.w) + (r2.w);
    r0.x = (r0.x) * (c3.x) + (c3.y);
