// Mechanically reconstructed from 0x76424AA2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = float3(((r5.w) >= 0.0f ? (r2.x) : (r4.x)), ((r5.w) >= 0.0f ? (r2.y) : (r4.y)), ((r5.w) >= 0.0f ? (r2.z) : (r4.z)));
    ...
    r1.w = (r1.x) * (r1.w);
    r3.w = (r2.w) * (r1.z);
    r1.xyz = float3(((r7.w) >= 0.0f ? (c[8].x) : (r1.y)), ((r7.w) >= 0.0f ? (c[8].y) : (r1.y)), ((r7.w) >= 0.0f ? (c[8].w) : (r1.y)));
    r1.w = (r1.w) * (r3.w);
    r11.xyz = float3(((r5.w) >= 0.0f ? (c[9].x) : (r1.x)), ((r5.w) >= 0.0f ? (c[9].y) : (r1.y)), ((r5.w) >= 0.0f ? (c[9].w) : (r1.z)));
