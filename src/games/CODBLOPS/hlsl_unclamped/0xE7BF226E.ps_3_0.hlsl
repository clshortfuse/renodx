// Mechanically reconstructed from 0xE7BF226E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyz = (r1.yyy) * (r2.xyz) + (r7.xyz);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r2 = tex2D(s5, v1.xy);
    r1.w = dot(v6.xyz, v6.xyz);
    r3.w = rsqrt(r1.w);
    r2.xyz = (r6.xyz) * (r2.xyz);
    r6.xyz = (v6.xyz) * (-(r3.www)) + (c[17].xyz);
