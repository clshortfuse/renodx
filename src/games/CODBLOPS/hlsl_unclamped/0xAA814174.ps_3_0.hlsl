// Mechanically reconstructed from 0xAA814174.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.w = (r11.x) * (c2.w);
    r7.w = (r11.x) * (-(c12.z)) + (c12.w);
    r6.w = (r2.w) * (r7.w) + (r10.w);
    r0.z = (r3.w) * (r7.w) + (r10.w);
    r0.z = (r0.z) * (r6.w) + (c4.x);
