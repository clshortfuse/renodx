// Mechanically reconstructed from 0xA7BC44ED.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = (v1.xy) + (c1.xx);
    r3.z = c1.y;
    r0.xy = (r4.xy) * (c[39].xx) + (r3.zz);
    r0 = tex2D(s5, r0.xy);
    r7.w = (v8.w) * (c1.z) + (-(r0.x));
    r1.xy = (r1.wy) * (c0.xy) + (c0.zw);
    r5.w = saturate((r7.w) * (c1.w));
    r6.xy = lerp(r7.xy, r1.xy, r5.ww);
    r1 = v2;
    ...
    r0.w = dot(r2, c12.yyyy);
    r0.z = max(abs(r9.x), r1.z);
    r0.z = 1.0f / (r0.z);
    r1.xyz = (r9.xyz) * (c[5].xyz);
    r11.xy = (r4.xy) * (c[40].xx) + (r3.zz);
    r1.xyz = (r1.xyz) * (r0.zzz) + (v8.xyz);
    r2 = tex3D(s11, r1.xyz);
    r4.xyz = (-(v7.xyz)) + (c[21].xyz);
    r0.z = dot(r4.xyz, r4.xyz);
    r0.z = rsqrt(r0.z);
    r3.z = lerp(r2.w, r0.w, c[24].w);
    r7.xyz = (r4.xyz) * (r0.zzz);
    ...
    r0.w = (r0.x) * (r0.w);
    r2.xyz = (r8.xyz) * (r0.zzz) + (r10.xyz);
    r3.w = (r2.w) * (c2.w);
    r2.xyz = (r0.www) * (r2.xyz);
    r5.xyz = (r2.xyz) * (c[37].www);
    r2.xyz = (r6.xyz) * (c[37].yyy);
    r5.xyz = (r5.xyz) * (c[23].xyz);
