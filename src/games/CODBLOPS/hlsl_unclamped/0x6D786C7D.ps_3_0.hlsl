// Mechanically reconstructed from 0x6D786C7D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.z = rsqrt(r0.w);
    r7.xyz = (r2.zzz) * (v4.xyz);
    r1 = tex2D(s1, v1.xy);
    r2.xy = (r1.ww) * (c0.zy) + (c0.wz);
    r0 = tex2D(s0, v1.xy);
    r1.x = (r0.w) * (v0.w) + (c0.x);
    r6.xyz = normalize(v2.xyz);
    r4.xy = float2(((r1.x) >= 0.0f ? (r2.x) : (c0.z)), ((r1.x) >= 0.0f ? (r2.y) : (c0.y)));
    ...
    r1.z = (r6.w) * (r1.z) + (r7.w);
    r1.z = (r1.w) * (r1.z);
    r8.w = ((r1.x) >= 0.0f ? (r1.y) : (c0.z));
    r1.w = (r4.y) * (c1.x);
    r1.z = (r1.z) * (r8.w);
    r0 = float4(((r1.x) >= 0.0f ? (r0.x) : (c0.z)), ((r1.x) >= 0.0f ? (r0.y) : (c0.z)), ((r1.x) >= 0.0f ? (r0.z) : (c0.z)), ((r1.x) >= 0.0f ? (r0.w) : (c0.z)));
    ...
    r1.z = exp2(-(r1.z));
    r1.xy = (r5.xz) * (r10.yy);
    r2.w = saturate((r1.z) * (c3.z) + (c3.w));
    r2.z = (r4.y) * (c2.w) + (-(r1.x));
    r1.xz = (r1.xy) * (c3.xx);
    r3.xy = (r3.xz) * (r10.xx);
    r1.y = (r5.z) * (-(r10.y)) + (r2.z);
    r2.z = (r4.x) * (c2.w) + (-(r3.x));
    r1.y = (r1.y) + (r1.y);
