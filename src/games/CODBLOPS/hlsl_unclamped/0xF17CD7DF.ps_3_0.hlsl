// Mechanically reconstructed from 0xF17CD7DF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s13, r0.xy);
    r2.w = r0.y;
    r5.xy = float2(((r4.w) >= 0.0f ? (r5.x) : (c1.y)), ((r4.w) >= 0.0f ? (r5.y) : (c1.y)));
    ...
    r1.z = (r1.y) * (r1.z);
    r12.xyz = float3(((r4.w) >= 0.0f ? (r2.y) : (c[20].x)), ((r4.w) >= 0.0f ? (r2.y) : (c[20].y)), ((r4.w) >= 0.0f ? (r2.y) : (c[20].w)));
