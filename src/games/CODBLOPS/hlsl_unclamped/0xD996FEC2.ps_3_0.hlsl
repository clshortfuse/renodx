// Mechanically reconstructed from 0xD996FEC2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xyz = float3(((r5.w) >= 0.0f ? (c[36].x) : (r3.y)), ((r5.w) >= 0.0f ? (c[36].y) : (r3.y)), ((r5.w) >= 0.0f ? (c[36].w) : (r3.y)));
    ...
    r7.xyz = (r1.yyy) * (r0.xyz) + (r4.xyz);
    r4 = tex2D(s0, v1.xy);
    r0.xyz = float3(((r5.w) >= 0.0f ? (r2.x) : (r4.x)), ((r5.w) >= 0.0f ? (r2.y) : (r4.y)), ((r5.w) >= 0.0f ? (r2.z) : (r4.z)));
    r2 = tex2D(s5, v7.zw);
    ...
    r1.w = pow(abs(r11.w), r5.w);
    r1.x = (r1.x) * (r10.w);
    r1.w = (r3.w) * (r1.w);
    r12.xyz = (r2.xyz) * (r8.www) + (r3.xyz);
    r1.w = (r1.x) * (r1.w);
    r8.w = (-(r1.z)) + (c1.z);
