// Mechanically reconstructed from 0x30E1897D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xy = c[45].xy;
    r4.yz = (-(r6.xy)) + (c[37].xy);
    r4.xy = (r4.xx) * (r4.yz) + (c[45].xy);
    r4.zw = (c13.xy) + (v3.xy);
    r4.xy = (r4.zw) * (r4.xy) + (c13.zw);
    r4.xy = (r0.ww) * (c[44].xy) + (r4.xy);
    r4 = tex2D(s4, r4.xy);
    r4.xyz = (r4.xyz) * (r4.xyz);
    r4.xyz = (r4.xyz) * (c14.xyz);
    r6 = tex2D(s5, v3.xy);
    r5.yzw = (r6.xyz) * (r6.xyz);
    r4.xyz = (r5.yzw) * (c[43].xxx) + (r4.xyz);
    r0.w = (r0.w) * (c[41].x);
    r1.w = frac(abs(r0.w));
    ...
    r5.y = v3.x;
    r6 = tex2D(s2, r5.yz);
    r0.w = pow(abs(r6.y), c[38].x);
    r5.yzw = (r0.www) * (c[40].xyz);
    r4.xyz = (r5.yzw) * (c[39].xxx) + (r4.xyz);
    r5.xy = (-(r5.xx)) + (c15.xy);
    r3.xyz = float3(((-abs(r5.x)) >= 0.0f ? (r4.x) : (r3.x)), ((-abs(r5.x)) >= 0.0f ? (r4.y) : (r3.y)), ((-abs(r5.x)) >= 0.0f ? (r4.z) : (r3.z)));
    r6 = tex2D(s6, v3.xy);
    r5.xzw = (r6.xyz) * (r6.xyz);
    r4.xyz = (r4.xyz) * (r5.xzw);
    r0.xyz = (r1.xyz) * (r4.xyz) + (r0.xyz);
    r1.xyz = max(r0.xyz, c0.zzz);
    r0.xyz = float3(((-abs(r5.y)) >= 0.0f ? (r1.x) : (r3.x)), ((-abs(r5.y)) >= 0.0f ? (r1.y) : (r3.y)), ((-abs(r5.y)) >= 0.0f ? (r1.z) : (r3.z)));
    r0.w = abs(c[35].x);
