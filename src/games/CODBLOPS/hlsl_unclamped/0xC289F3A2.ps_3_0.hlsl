// Mechanically reconstructed from 0xC289F3A2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c37 = float4(2.0f, -1.0f, 0.0f, -0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r3.y = dot(r1.xy, r0.zw) + (c37.z);
    r3.x = dot(r1.xy, r0.xy) + (c37.z);
    r0 = tex2D(s1, v1.xy);
    ...
    r2 = tex2D(s13, r2.xy);
    r4.w = r2.y;
    r7.xy = lerp(r5.xy, r3.xy, r5.ww);
    r6.xy = (r4.yw) * (c12.xx) + (c12.yy);
    r3 = tex2D(s14, v1.zw);
    r8.xy = (r3.xy) * (c4.ww);
    r1.w = dot(r6.xy, r7.xy) + (c37.z);
    r4.xy = (r4.xz) * (r8.xx);
    r0.w = (r3.x) * (c4.w) + (-(r4.x));
    r5.xy = (r2.xz) * (r8.yy);
    r0.w = (r4.z) * (-(r8.x)) + (r0.w);
    ...
    r6.xyz = (r11.xyz) * (r0.www) + (r2.xyz);
    r0 = tex2D(s9, v7.xy);
    r8.xyz = lerp(c[34].xyw, r0.yyy, r5.www);
    r0 = (r0.wwww) * (-(c37.zzzy)) + (-(c37.wwwz));
    r2 = tex2D(s8, v1.xy);
    r1 = tex2D(s5, v7.zw);
    r4.xyz = (r1.xyz) + (c37.yyy);
    r1 = lerp(r2, r0, r5.wwww);
    r5.xyz = (v0.zzz) * (r4.xyz) + (-(c37.yyy));
    r0 = tex2D(s6, v8.xy);
    r2.xyz = (r0.xyz) + (c37.yyy);
    r0.xyz = (r1.xyz) * (r5.xyz);
    r4.xyz = (v0.www) * (r2.xyz) + (-(c37.yyy));
    r13.xyz = (r6.xyz) * (r8.yyy);
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (-(c37.y)) : (-(c37.z)));
