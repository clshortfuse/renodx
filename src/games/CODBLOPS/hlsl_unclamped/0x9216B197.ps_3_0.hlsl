// Mechanically reconstructed from 0x9216B197.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c4 = float4(-0.200000003f, 0.200000003f, 0.600000024f, 0.400000006f);
    const float4 c12 = float4(8.0f, 0.797884583f, 31.875f, 4.0f);
    ...
    r2.z = dot(r6.xy, r1.zw) + (c3.z);
    r2.x = dot(r6.xy, r1.xy) + (c3.z);
    r1.xyz = float3(((r3.w) >= 0.0f ? (r2.x) : (r0.x)), ((r3.w) >= 0.0f ? (r2.z) : (r0.y)), ((r3.w) >= 0.0f ? (r2.w) : (r0.z)));
    r0 = tex2D(s8, v7.zw);
    r7.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c3.xxxx) * (v9) + (c3.yyyy);
    r6.y = dot(r7.xy, r0.zw) + (c3.z);
    r6.x = dot(r7.xy, r0.xy) + (c3.z);
    r0 = tex2D(s6, v7.zw);
    r5.w = (r0.w) * (v0.z);
    r4.xyz = float3(((r3.w) >= 0.0f ? (r4.x) : (r5.x)), ((r3.w) >= 0.0f ? (r4.y) : (r5.y)), ((r3.w) >= 0.0f ? (r4.z) : (r5.z)));
    r10.xy = lerp(r1.xy, r6.xy, r5.ww);
    r0.w = ((r3.w) >= 0.0f ? (r2.y) : (r3.y));
    r1.w = dot(r10.xy, r10.xy) + (c3.z);
    r2.xyz = lerp(r4.xyz, r0.xyz, r5.www);
    r0.z = exp2(-(r1.w));
    r9.xyz = (r2.xyz) * (r2.xyz);
    r4.w = (r0.z) * (c4.z) + (c4.w);
    r14.xyz = lerp(r0.www, c[32].xyw, r5.www);
    r0.xy = (v1.zw) * (-(c3.yw));
    r3 = tex2D(s13, r0.xy);
    ...
    r2 = tex2D(s14, v1.zw);
    r4.xy = (r2.xy) * (c12.zz);
    r5.xy = (r3.yw) * (c35.xx) + (c35.yy);
    r1.xy = (r3.xz) * (r4.xx);
    r0.w = dot(r5.xy, r10.xy) + (c3.z);
    r0.y = (r2.x) * (c12.z) + (-(r1.x));
    r1.w = (r3.z) * (-(r4.x)) + (r0.y);
    r3.xy = (r0.xz) * (r4.yy);
    r0.y = (r2.y) * (c12.z) + (-(r3.x));
    r0.x = dot(r5.xy, r5.xy) + (c3.z);
    r0.y = (r0.z) * (-(r4.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r6.y = (r1.w) + (r1.w);
    r0.z = (r0.z) * (c4.z) + (c4.w);
    ...
    r0 = (r2) + (r0);
    r1.y = saturate(dot(r4.xyz, r8.xyz));
    r1.w = c4.y;
    r1.y = (-(r1.y)) + (-(c3.y));
    r0 = (r5.wwww) * (r0) + (r1.wwwz);
    r1.w = (r1.y) * (r1.y);
    ...
    r0.xyz = (r10.yyy) * (v3.xyz) + (r1.xyz);
    r9.w = (r0.w) * (-(c35.z)) + (c35.w);
    ...
    r1.y = (r2.w) * (r0.y);
    r1.z = (r0.z) * (r5.w);
    r0.xyz = (r15.xyz) * (r2.zzz) + (r16.xyz);
    r2.z = (r1.y) * (r1.z);
    r1.xyz = (r6.xyz) * (r4.www) + (r3.xyz);
