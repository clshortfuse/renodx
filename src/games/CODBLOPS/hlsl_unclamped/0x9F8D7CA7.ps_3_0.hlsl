// Mechanically reconstructed from 0x9F8D7CA7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = dot(r6.xy, r4.xy) + (c1.z);
    r0.y = dot(r6.xy, r4.zw) + (c1.z);
    r2.xyz = float3(((r1.w) >= 0.0f ? (r2.x) : (r3.x)), ((r1.w) >= 0.0f ? (r2.y) : (r3.y)), ((r1.w) >= 0.0f ? (r2.z) : (r3.z)));
    r6.xyz = float3(((r1.w) >= 0.0f ? (r0.x) : (r1.x)), ((r1.w) >= 0.0f ? (r0.y) : (r1.y)), ((r1.w) >= 0.0f ? (r0.z) : (r1.z)));
    r0.xyz = (r2.xyz) * (r2.xyz);
    r1.xyz = v3.xyz;
    r1.xyz = (r6.xxx) * (r1.xyz) + (v1.xyz);
    r0.xyz = (r5.xyz) * (r0.xyz);
    r1.xyz = (r6.yyy) * (v2.xyz) + (r1.xyz);
