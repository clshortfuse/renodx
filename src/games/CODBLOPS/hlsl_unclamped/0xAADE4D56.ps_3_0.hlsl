// Mechanically reconstructed from 0xAADE4D56.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c20 = float4(2.0f, -1.0f, 0.0f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r3.y = dot(r1.xy, r0.zw) + (c20.z);
    r3.x = dot(r1.xy, r0.xy) + (c20.z);
    r0 = tex2D(s6, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c20.xxxx) * (v9) + (c20.yyyy);
    r6.y = dot(r1.xy, r0.zw) + (c20.z);
    r6.x = dot(r1.xy, r0.xy) + (c20.z);
    r0 = tex2D(s1, v1.xy);
    ...
    r2 = tex2D(s13, r2.xy);
    r0.w = r2.y;
    r5.xy = lerp(r1.xy, r6.xy, r4.ww);
    r1.xy = (r0.wy) * (c11.xx) + (c11.yy);
    r0.w = dot(r5.xy, r5.xy) + (c20.z);
    r0.y = dot(r1.xy, r1.xy) + (c20.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c4.x) + (c4.y);
    r1.w = (r0.y) * (c4.x) + (c4.y);
    r0.y = dot(r1.xy, r5.xy) + (c20.z);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v1.zw);
    r7.xy = (r1.xy) * (c10.ww);
    r1.w = saturate((r0.y) * (r2.w) + (r2.w));
    r2.xy = (r2.xz) * (r7.xx);
    r0.y = (r1.x) * (c10.w) + (-(r2.x));
    r6.xy = (r0.xz) * (r7.yy);
    r0.y = (r2.z) * (-(r7.x)) + (r0.y);
    r0.x = (r1.y) * (c10.w) + (-(r6.x));
    r0.z = (r0.z) * (-(r7.y)) + (r0.x);
    r7.y = (r0.y) + (r0.y);
    r0.y = (r0.z) + (r0.z);
    r0.xz = (r6.xy) * (c11.xx);
    ...
    r0 = tex2D(s7, v1.xy);
    r3.w = lerp(r0.y, c20.w, r6.w);
    r2.w = -(r0.w);
    r1 = (r0.wwww) * (c3.yyyz) + (c3.wwwy);
    r2.xyz = c3.xxx;
    r0 = tex2D(s8, v7.zw);
    r0 = (r2) + (r0);
    r0 = (r4.wwww) * (r0) + (r1);
    ...
    r1.w = (r1.w) * (r1.z);
    r11.xyz = lerp(r3.www, c[8].xyw, r4.www);
    r0.xyz = (r0.xyz) * (r1.www);
    r15.xyz = (r3.xyz) * (r11.yyy);
    r13.xyz = (r11.zzz) * (r0.xyz);
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c20.w) : (c20.z));
