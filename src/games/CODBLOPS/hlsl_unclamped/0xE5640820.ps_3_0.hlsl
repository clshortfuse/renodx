// Mechanically reconstructed from 0xE5640820.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xy = (v1.xy) + (c2.xx);
    r5.z = c2.y;
    r0.xy = (r5.xy) * (c[26].xx) + (r5.zz);
    r0 = tex2D(s3, r0.xy);
    r7.w = (v7.w) * (c2.z) + (-(r0.x));
    r1.xy = (r1.wy) * (c0.xy) + (c0.zw);
    r4.w = saturate((r7.w) * (c2.w));
