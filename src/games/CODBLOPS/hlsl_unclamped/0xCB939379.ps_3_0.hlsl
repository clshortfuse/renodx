// Mechanically reconstructed from 0xCB939379.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.yz = c1.yz;
    r10.xy = float2(((r2.w) >= 0.0f ? (r3.y) : (c[5].x)), ((r2.w) >= 0.0f ? (r3.z) : (c[5].y)));
    r6.w = (-(r3.w)) + (c1.z);
    r5 = tex2D(s4, v1.xy);
    r4 = tex2D(s5, v7.zw);
