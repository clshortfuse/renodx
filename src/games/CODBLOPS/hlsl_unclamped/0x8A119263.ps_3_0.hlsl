// Mechanically reconstructed from 0x8A119263.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = ((-abs(r1.y)) >= 0.0f ? (c12.x) : (c12.y));
    r1.z = (-(r0.w)) + (c12.x);
    ...
    r1.xy = (r1.xy) * (r1.xy);
    r0.z = ((-abs(r0.z)) >= 0.0f ? (c12.y) : (r1.w));
    r1.w = (r2.x) * (r1.x);
    r0.z = (r0.z) * (r1.w);
    r1.w = (r1.y) * (-(r2.y)) + (c12.x);
    r0.xy = (r2.ww) * (r0.xy);
    r0.z = (r0.z) * (r1.w);
    r8.w = (r4.z) * (r0.z);
