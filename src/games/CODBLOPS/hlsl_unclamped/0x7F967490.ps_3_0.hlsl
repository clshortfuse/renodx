// Mechanically reconstructed from 0x7F967490.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = (r13.y) * (r2.w) + (r14.w);
    r0.xyz = (r0.xyz) * (c3.yyy);
    r8.xyz = (r1.zzz) * (r0.xyz);
    r0.xyz = (r3.zzz) * (c[23].xyz);
    r2.xyz = (r7.www) * (r0.xyz);
    r2.w = max(abs(r9.y), abs(r9.z));
    r1.xyz = (r3.www) * (c[22].xyz);
