// Mechanically reconstructed from 0xADD2AC7C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = (r2.yyy) * (r7.xyz);
    r1.xyz = (r2.zzz) * (r1.xyz);
    r2.xyz = (r3.xyz) * (r3.xyz) + (r4.xyz);
    r5.y = (r5.y) + (r5.y);
