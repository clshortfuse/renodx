// Mechanically reconstructed from 0x69245C63.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.xy = float2(((r6.w) >= 0.0f ? (r5.x) : (r6.x)), ((r6.w) >= 0.0f ? (r5.y) : (r6.y)));
    r11.xyz = (r1.xyz) * (-(r1.xyz)) + (-(c3.yyy));
    r12.xyz = (r1.xyz) * (r1.xyz);
    r1.z = dot(r9.xy, r9.xy) + (c3.w);
    r6.xyz = (r11.xyz) * (r5.www) + (r12.xyz);
    r1.z = exp2(-(r1.z));
    r2.w = (r1.z) * (c12.x) + (c12.y);
    r1.xy = (v1.zw) * (-(c3.yz));
    r5 = tex2D(s13, r1.xy);
    ...
    r4 = tex2D(s14, v1.zw);
    r1.xy = (r4.xy) * (c12.ww);
    r7.xy = (r5.yw) * (c13.xx) + (c13.yy);
    r5.xy = (r5.xz) * (r1.xx);
    r1.z = dot(r7.xy, r9.xy) + (c3.w);
    r2.z = (r4.x) * (c12.w) + (-(r5.x));
    r2.z = (r5.z) * (-(r1.x)) + (r2.z);
    r3.xy = (r3.xz) * (r1.yy);
    r2.x = (r4.y) * (c12.w) + (-(r3.x));
    r1.x = dot(r7.xy, r7.xy) + (c3.w);
    r1.y = (r3.z) * (-(r1.y)) + (r2.x);
    r1.x = exp2(-(r1.x));
    r10.y = (r2.z) + (r2.z);
    ...
    r1.y = (r1.y) + (r1.y);
    r1.x = (r2.w) * (r1.x);
    r2.z = saturate((r1.z) * (r1.x) + (r1.x));
    r1.xz = (r3.xy) * (c13.xx);
    r1.xyz = (r1.xyz) * (r2.zzz);
    r10.xz = (r5.xy) * (c13.xx);
    r7.xyz = (r0.xyz) * (r0.xyz);
    r1.xyz = (r10.xyz) * (r2.www) + (r1.xyz);
    r2.w = (r1.w) * (-(c13.z)) + (c13.w);
    r0.xyz = v2.xyz;
    r3.xyz = (r9.xxx) * (v4.xyz) + (r0.xyz);
    r16.yw = c3.yw;
    r0.xyz = float3(((r9.w) >= 0.0f ? (c[23].x) : (r16.w)), ((r9.w) >= 0.0f ? (c[23].y) : (r16.w)), ((r9.w) >= 0.0f ? (c[23].w) : (r16.w)));
    ...
    r2.z = (r2.w) * (r2.z) + (c14.x);
    r2.w = (r3.z) * (c14.y) + (c14.z);
    r2.z = 1.0f / (r2.z);
    r2.w = (r2.x) * (r2.w);
    r2.z = (r3.w) * (r2.z);
    r0.xyz = float3(((r8.w) >= 0.0f ? (c[24].x) : (r0.x)), ((r8.w) >= 0.0f ? (c[24].y) : (r0.y)), ((r8.w) >= 0.0f ? (c[24].w) : (r0.z)));
    r2.w = (r2.w) * (r2.z);
    r13.xyz = float3(((r6.w) >= 0.0f ? (r2.y) : (r0.x)), ((r6.w) >= 0.0f ? (r2.y) : (r0.y)), ((r6.w) >= 0.0f ? (r2.y) : (r0.z)));
