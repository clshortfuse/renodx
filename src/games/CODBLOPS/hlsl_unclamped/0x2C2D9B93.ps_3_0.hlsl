// Mechanically reconstructed from 0x2C2D9B93.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c37 = float4(4.0f, -3.0f, -2.0f, 3.0f);
    ...
    r2.y = dot(r1.xy, r0.zw) + (c16.z);
    r2.x = dot(r1.xy, r0.xy) + (c16.z);
    r0 = tex2D(s1, v1.xy);
    r3.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s4, v7.xy);
    r3.z = (r0.w) * (v0.y);
    r4.xyz = lerp(r1.xyz, r0.xyz, r3.zzz);
    r5.xy = lerp(r3.xy, r2.xy, r3.zz);
    r2 = tex2D(s8, v1.xy);
    r0 = tex2D(s9, v7.xy);
    r1 = lerp(r2, r0, r3.zzzz);
    r0.xyw = c[34].xyw;
    r2.xyz = (-(r0.xyw)) + (c[35].xyw);
    r0 = tex2D(s5, v7.zw);
    r3.w = (r0.w) * (v0.z);
    r3.xyz = (r3.zzz) * (r2.xyz) + (c[34].xyw);
    r2.xyz = lerp(r4.xyz, r0.xyz, r3.www);
    r0 = tex2D(s6, v8.xy);
    r0.xyz = (r0.xyz) + (c16.yyy);
    r8.xyz = lerp(r3.xyz, c16.www, r3.www);
    r0.xyz = (v0.www) * (r0.xyz) + (c16.www);
    ...
    r0.y = (r2.x) * (c4.w) + (-(r1.x));
    r0.w = dot(r9.xy, r7.xy) + (c16.z);
    r1.z = (r3.z) * (-(r6.x)) + (r0.y);
    r3.xy = (r0.xz) * (r6.yy);
    r0.x = dot(r9.xy, r9.xy) + (c16.z);
    r0.y = (r2.y) * (c4.w) + (-(r3.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r0.z) * (-(r6.y)) + (r0.y);
    r0.z = (r0.x) * (c3.x) + (c3.y);
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c16.w) : (c16.z));
    ...
    r1.z = (r0.w) * (c37.z) + (c37.w);
    r1.w = (r0.w) * (r0.w);
    r0 = (v6.xyzx) * (c16.wwwz) + (c16.zzzw);
    r1.w = (r1.z) * (r1.w);
    r1.z = dot(r0, c[28]);
    r1.z = 1.0f / (r1.z);
    r2.x = dot(r0, c[27]);
    ...
    r2.xy = (r0.xy) * (c37.zz) + (c37.ww);
    r0.xy = (r0.xy) * (r0.xy);
    r0.w = ((-abs(r0.w)) >= 0.0f ? (c16.z) : (r0.z));
    r0.z = (r2.x) * (r0.x);
    r0.w = (r0.w) * (r0.z);
    r0.z = (r0.y) * (-(r2.y)) + (c16.w);
    r0.xy = (r1.zz) * (r1.xy);
    r0.w = (r0.w) * (r0.z);
    r5.w = (r1.w) * (r0.w);
