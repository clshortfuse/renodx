// Mechanically reconstructed from 0x8FE88F59.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.xyz = lerp(r4.yyy, c[8].xyw, r5.www);
    ...
    r11.xyz = (v0.yyy) * (r2.xyz) + (c12.zzz);
    r4.xyz = (r11.xyz) * (c12.www);
    ...
    r7.xyz = (r2.xyz) * (-(r2.xyz)) + (c12.zzz);
    r1.w = (r1.x) * (r1.w);
    r2.xyz = (r7.xyz) * (r1.zzz) + (r8.xyz);
    r4.xyz = (r1.yyy) * (r6.xyz) + (r12.xyz);
