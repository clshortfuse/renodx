// Mechanically reconstructed from 0x81B8EB46.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.x = dot(r5.xy, r0.xy) + (c12.z);
    r3.y = dot(r5.xy, r0.zw) + (c12.z);
    r0 = tex2D(s3, v6.zw);
    r7.w = (r0.w) * (v0.z);
    r5.xy = (r2.yw) * (c4.xx) + (c4.yy);
    r6.xy = lerp(r7.xy, r3.xy, r7.ww);
    r2.w = dot(r5.xy, r5.xy) + (c12.z);
