// Mechanically reconstructed from 0x9E613BFD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xyw = c[24].xyw;
    r0.xyz = (-(r1.xyw)) + (c[25].xyw);
    r1.w = dot(r9.xyz, r7.xyz);
    r5.xyz = (r2.www) * (r0.xyz) + (c[24].xyw);
    r0.z = (r1.w) + (r1.w);
    r4 = tex2D(s6, v1.xy);
    r3 = tex2D(s7, v7.xy);
