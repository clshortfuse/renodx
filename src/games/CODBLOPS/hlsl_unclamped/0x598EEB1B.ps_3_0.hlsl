// Mechanically reconstructed from 0x598EEB1B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5 = tex2D(s13, r4.xy);
    r3.w = r5.y;
    r2.w = lerp(r4.w, c12.x, r8.w);
    r4.xy = (r3.yw) * (c4.xx) + (c4.yy);
    r3.y = dot(r6.xy, r6.xy) + (c12.y);
    r3.w = dot(r4.xy, r4.xy) + (c12.y);
    r3.y = exp2(-(r3.y));
    r3.w = exp2(-(r3.w));
    r5.w = (r3.y) * (c12.z) + (c12.w);
    r3.y = (r3.w) * (c12.z) + (c12.w);
    r3.w = dot(r4.xy, r6.xy) + (c12.y);
    r3.y = (r5.w) * (r3.y);
    r4 = tex2D(s14, v1.zw);
    r9.xy = (r4.xy) * (c2.ww);
