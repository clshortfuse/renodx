// Mechanically reconstructed from 0x0829B56D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = c1.y;
    r9.xyz = float3(((r2.w) >= 0.0f ? (r0.w) : (c[5].x)), ((r2.w) >= 0.0f ? (r0.w) : (c[5].y)), ((r2.w) >= 0.0f ? (r0.w) : (c[5].w)));
