// Mechanically reconstructed from 0x4BBE253D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s13, r0.xy);
    r2.w = r0.y;
    r4.xyz = lerp(r3.xyz, r1.xyz, r5.www);
    r1.xy = (r2.yw) * (c4.xx) + (c4.yy);
    r0.w = dot(r5.xy, r5.xy) + (c7.y);
    r0.y = dot(r1.xy, r1.xy) + (c7.y);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c7.z) + (c7.w);
    r1.w = (r0.y) * (c7.z) + (c7.w);
    r0.y = dot(r1.xy, r5.xy) + (c7.y);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v0.zw);
    r6.xy = (r1.xy) * (c3.ww);
