// Mechanically reconstructed from 0x34DB1597.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(-0.5f, 1.0f, -0.0f, 0.797884583f);
    ...
    r0 = tex2D(s2, v5.zw);
    r3.w = (r0.w) * (v5.y) + (c1.x);
    r3.xy = float2(((r3.w) >= 0.0f ? (r2.x) : (c1.z)), ((r3.w) >= 0.0f ? (r2.y) : (c1.z)));
    r2.xyz = (r1.xyz) * (r1.xyz);
    r1.xyz = v3.xyz;
    r1.xyz = (r3.xxx) * (r1.xyz) + (v1.xyz);
    r4.xyz = (r2.www) * (r2.xyz);
    r1.xyz = (r3.yyy) * (v2.xyz) + (r1.xyz);
    ...
    r1 = float4(((r4.w) >= 0.0f ? (r1.x) : (c1.z)), ((r4.w) >= 0.0f ? (r1.y) : (c1.z)), ((r4.w) >= 0.0f ? (r1.z) : (c1.z)), ((r4.w) >= 0.0f ? (r1.w) : (c1.z)));
