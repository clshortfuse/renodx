// Mechanically reconstructed from 0x3CE84354.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xy = float2(((r5.w) >= 0.0f ? (c1.y) : (r3.y)), ((r5.w) >= 0.0f ? (c1.z) : (r3.y)));
    r0.z = (r0.z) + (r0.z);
