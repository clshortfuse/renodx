// Mechanically reconstructed from 0x64FF1AA6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = dot(r9.xy, r9.xy) + (c11.y);
    r2.z = dot(r4.xy, r4.xy) + (c11.y);
    r2.w = exp2(-(r2.w));
    r2.z = exp2(-(r2.z));
    r2.w = (r2.w) * (c11.z) + (c11.w);
    r2.x = (r2.z) * (c11.z) + (c11.w);
    r2.z = dot(r4.xy, r9.xy) + (c11.y);
    r2.x = (r2.w) * (r2.x);
    r4 = tex2D(s14, v0.zw);
    r10.xy = (r4.xy) * (c2.ww);
