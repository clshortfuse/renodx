// Mechanically reconstructed from 0x72AC553E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.y = (r0.w) + (r0.w);
    r0 = tex2D(s6, v1.xy);
    r2.xy = lerp(r0.yy, c[23].xy, r4.ww);
    r1 = tex2D(s8, v6.zw);
    r10.xy = lerp(r2.xy, r1.yy, r7.ww);
