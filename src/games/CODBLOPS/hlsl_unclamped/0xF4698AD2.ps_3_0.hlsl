// Mechanically reconstructed from 0xF4698AD2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xy = (r1.ww) * (r3.xy) + (c[5].xy);
    r2.w = (r2.w) + (r2.w);
    r3.xyz = (r0.xyz) * (-(r2.www)) + (r2.xyz);
