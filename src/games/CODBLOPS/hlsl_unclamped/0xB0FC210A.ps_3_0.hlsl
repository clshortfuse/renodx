// Mechanically reconstructed from 0xB0FC210A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.x = dot(r4.xy, r1.xy) + (c2.w);
    r2.y = dot(r4.xy, r1.zw) + (c2.w);
    r1 = tex2D(s3, v6.zw);
    r5.w = (r1.w) * (v0.z);
    r4.xy = (r0.yw) * (c4.xx) + (c4.yy);
    r6.xy = lerp(r5.xy, r2.xy, r5.ww);
    r0.y = dot(r4.xy, r4.xy) + (c2.w);
    ...
    r3.xyz = (v0.yyy) * (r3.xyz) + (c2.zzz);
    r2.w = 1.0f / (r2.w);
    r2.xyz = (r2.xyz) * (r3.xyz);
    r0.w = (r0.w) * (r2.w);
    r7.xyz = (r2.xyz) * (-(r2.xyz)) + (c2.zzz);
    r6.xyz = (r0.xyz) * (r0.xyz);
    r0.xyz = (r0.www) * (r7.xyz);
    r6.xyz = (r8.xxx) * (r6.xyz);
    r7.xyz = (r2.xyz) * (r2.xyz) + (r0.xyz);
    r0 = tex2D(s0, v1.xy);
