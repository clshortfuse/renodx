// Mechanically reconstructed from 0x1525571F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = tex2D(s7, v1.xy);
    r11.xyz = lerp(r3.yyy, c[39].xyw, r12.www);
    r0 = v2;
    ...
    r2 = (r12.wwww) * (r2) + (r3);
    r9.xyz = (v0.zzz) * (r0.xyz) + (c1.zzz);
    r3 = tex2D(s6, v9.xy);
    r3.xyz = (r3.xyz) + (-(c1.zzz));
    r0.xyz = (r2.xyz) * (r9.xyz);
    r8.xyz = (v0.www) * (r3.xyz) + (c1.zzz);
    r2.z = (r6.w) * (r6.w);
