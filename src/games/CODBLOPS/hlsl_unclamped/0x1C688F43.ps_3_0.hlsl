// Mechanically reconstructed from 0x1C688F43.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = tex2D(s14, v1.zw);
    r0.xy = (r3.xy) * (c3.ww);
    r6.xy = (r4.yw) * (c26.xx) + (c26.yy);
    r4.xy = (r4.xz) * (r0.xx);
    r0.z = dot(r6.xy, r7.xy) + (c4.x);
    r2.w = (r3.x) * (c3.w) + (-(r4.x));
    r2.w = (r4.z) * (-(r0.x)) + (r2.w);
    r2.xy = (r2.xz) * (r0.yy);
    r3.w = (r3.y) * (c3.w) + (-(r2.x));
    ...
    r0.xyz = (v7.xyz) * (-(r15.www)) + (c[17].xyz);
