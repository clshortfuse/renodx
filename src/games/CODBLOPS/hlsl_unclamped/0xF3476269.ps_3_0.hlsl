// Mechanically reconstructed from 0xF3476269.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c42 = float4(2.0f, -1.0f, 0.0f, -0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r6.y = dot(r1.xy, r0.zw) + (c42.z);
    r6.x = dot(r1.xy, r0.xy) + (c42.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s5, v7.xy);
    r4.w = (r0.w) * (v0.y);
    r2 = tex2D(s1, v1.xy);
    ...
    r8.xy = lerp(r2.xy, r3.xy, r4.ww);
    r0 = tex2D(s10, v7.xy);
    r1 = (r0.wwww) * (-(c42.zzzy)) + (-(c42.wwwz));
    r2 = tex2D(s9, v1.xy);
    r3 = lerp(r2, r1, r4.wwww);
    r1 = tex2D(s6, v7.zw);
    r5.w = (r1.w) * (v0.z);
    r4.xyz = lerp(r5.xyz, r1.xyz, r5.www);
    r7.xy = lerp(r8.xy, r6.xy, r5.ww);
    r1 = tex2D(s11, v7.zw);
    r2 = (r1.wwww) * (-(c42.zzzy)) + (-(c42.wwwz));
    r5.xyz = lerp(c[39].xyw, r0.yyy, r4.www);
    r0 = lerp(r3, r2, r5.wwww);
    r13.xyz = lerp(r5.xyz, r1.yyy, r5.www);
    r1.w = dot(r7.xy, r7.xy) + (c42.z);
    ...
    r8.xy = (r3.xz) * (r4.xx);
    r1.w = dot(r6.xy, r7.xy) + (c42.z);
    r1.y = (r2.x) * (c4.w) + (-(r8.x));
    r2.w = (r3.z) * (-(r4.x)) + (r1.y);
    r3.xy = (r1.xz) * (r4.yy);
    r1.y = (r2.y) * (c4.w) + (-(r3.x));
    r1.x = dot(r6.xy, r6.xy) + (c42.z);
    r1.y = (r1.z) * (-(r4.y)) + (r1.y);
    r1.z = exp2(-(r1.x));
    r9.y = (r2.w) + (r2.w);
    r1.z = (r1.z) * (c3.x) + (c3.y);
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (-(c42.y)) : (-(c42.z)));
