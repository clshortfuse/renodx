// Mechanically reconstructed from 0x7CA059C0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.y = c1.z;
    r1.xyz = (r1.yyy) + (c[29].xyw);
    r1.w = dot(r12.xyz, r9.xyz);
    r5.xyz = (r5.www) * (r1.xyz) + (c1.xxx);
    r3.w = (r1.w) + (r1.w);
    r1 = tex2D(s5, v6.zw);
    r2 = (r1) + (c1.yyyz);
