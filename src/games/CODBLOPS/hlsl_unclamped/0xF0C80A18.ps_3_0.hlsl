// Mechanically reconstructed from 0xF0C80A18.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.w = saturate(dot(r2.xyz, -(r3.xyz)));
    r0.z = (r5.w) * (r10.w) + (r11.w);
