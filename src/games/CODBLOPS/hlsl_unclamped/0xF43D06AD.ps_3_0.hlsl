// Mechanically reconstructed from 0xF43D06AD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.y = (r0.z) + (r0.z);
    r0.yz = c1.yz;
    r1.xyz = float3(((r3.w) >= 0.0f ? (r0.y) : (c[29].x)), ((r3.w) >= 0.0f ? (r0.z) : (c[29].y)), ((r3.w) >= 0.0f ? (r0.y) : (c[29].w)));
    r0.xyz = (r7.xyz) * (r0.www) + (r5.xyz);
    r6.xyz = lerp(r1.xyz, c1.zzz, r2.www);
