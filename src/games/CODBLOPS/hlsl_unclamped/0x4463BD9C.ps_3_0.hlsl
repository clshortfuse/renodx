// Mechanically reconstructed from 0x4463BD9C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.y = dot(r2.xy, r0.zw) + (c3.w);
    r1.x = dot(r2.xy, r0.xy) + (c3.w);
    r0 = tex2D(s1, v1.xy);
    r2.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = tex2D(s6, v7.zw);
    r4.w = (r0.w) * (v0.z);
    r10.xy = lerp(r2.xy, r1.xy, r4.ww);
    r2 = tex2D(s0, v1.xy);
    r1 = tex2D(s5, v7.xy);
    r3.w = (r1.w) * (v0.y) + (c3.z);
    r1.xyz = float3(((r3.w) >= 0.0f ? (r1.x) : (r2.x)), ((r3.w) >= 0.0f ? (r1.y) : (r2.y)), ((r3.w) >= 0.0f ? (r1.z) : (r2.z)));
    r0.w = dot(r10.xy, r10.xy) + (c3.w);
    ...
    r2.xy = (r2.xz) * (r5.xx);
    r0.w = dot(r6.xy, r10.xy) + (c3.w);
    r0.y = (r1.x) * (c12.z) + (-(r2.x));
    r1.w = (r2.z) * (-(r5.x)) + (r0.y);
    r4.xy = (r0.xz) * (r5.yy);
    r0.y = (r1.y) * (c12.z) + (-(r4.x));
    r0.x = dot(r6.xy, r6.xy) + (c3.w);
    r0.y = (r0.z) * (-(r5.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r6.y = (r1.w) + (r1.w);
    r0.z = (r0.z) * (c4.z) + (c4.w);
    ...
    r3.xyz = (r6.xyz) * (r4.zzz) + (r0.xyz);
    r1 = tex2D(s8, v1.xy);
    r0 = tex2D(s9, v7.xy);
    r1.xy = float2(((r3.w) >= 0.0f ? (r0.w) : (r1.w)), ((r3.w) >= 0.0f ? (r0.y) : (r1.y)));
    r2.w = -(r1.x);
    r2.xyz = c4.xxx;
    r0 = tex2D(s10, v7.zw);
    ...
    r1.z = (r1.x) * (r1.z);
    r14.xyz = lerp(r1.yyy, c[32].xyw, r4.www);
