// Mechanically reconstructed from 0x298F79B3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    float4 v7 = input.v7;
    float4 v8 = input.v8;
    const float4 c0 = float4(0.0f, 1.0f, 0.200000003f, 0.797884583f);
    ...
    r4.xy = float2(((r8.w) >= 0.0f ? (r1.x) : (c2.w)), ((r8.w) >= 0.0f ? (r1.y) : (c2.w)));
    r1 = tex2D(s3, v6.xy);
    r7.w = (r1.w) * (v0.y) + (c2.z);
    ...
    r3.x = dot(r6.xy, r0.xy) + (c2.w);
    r3.y = dot(r6.xy, r0.zw) + (c2.w);
    r0 = tex2D(s4, v6.zw);
    r5.w = (r0.w) * (v0.z) + (c2.z);
