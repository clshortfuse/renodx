// Mechanically reconstructed from 0x9A52FC96.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xyz = float3(((r4.w) >= 0.0f ? (r0.x) : (r2.x)), ((r4.w) >= 0.0f ? (r0.y) : (r2.y)), ((r4.w) >= 0.0f ? (r0.z) : (r2.z)));
    r2.w = (-(r0.w)) + (c3.y);
    ...
    r0.w = (r3.w) * (r3.w);
    r7.xy = float2(((r4.w) >= 0.0f ? (r0.x) : (c1.y)), ((r4.w) >= 0.0f ? (r0.y) : (c1.y)));
    r2.w = (r2.w) * (r0.w);
    r0 = v1;
