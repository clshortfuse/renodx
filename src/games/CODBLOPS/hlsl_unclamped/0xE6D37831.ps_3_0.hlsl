// Mechanically reconstructed from 0xE6D37831.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xy = (c[11].zz) * (r1.xy) + (r0.xy);
    r1.w = dot(r5.xy, r5.xy) + (c1.x);
    r0.xy = (v1.zw) * (c4.xz);
    r0 = tex2D(s13, r0.xy);
    ...
    r6.x = 1.0f / (r3.w);
    r2.y = (r0.w) + (r0.w);
    r1.xy = saturate((r6.xx) * (c[9].xy) + (c[9].zw));
    r0.xy = (r1.xy) * (r1.xy);
