// Mechanically reconstructed from 0xCE75FD26.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = (r4) * (r4) + (r1);
    r3 = (-(v7.zzzz)) + (c[8]);
    r6.xyz = (r2.yyy) * (r9.xyz);
    r1 = (r3) * (r3) + (r1);
    r9.xyz = (r6.xyz) * (c[19].xyz);
    r6.x = rsqrt(r1.x);
    r6.y = rsqrt(r1.y);
    r6.z = rsqrt(r1.z);
    r6.w = rsqrt(r1.w);
