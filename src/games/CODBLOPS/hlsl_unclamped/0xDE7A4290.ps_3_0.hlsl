// Mechanically reconstructed from 0xDE7A4290.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = rsqrt(r9.y);
    r6.w = c1.x;
    r3.xyz = (r6.www) + (-(c[36].xyw));
    r9.x = 1.0f / (r1.w);
    r3.xyz = (r13.www) * (r3.xyz) + (c[36].xyw);
    r5.xy = saturate((r9.xx) * (c[35].xy) + (c[35].zw));
    r4.xy = (r5.xy) * (r5.xy);
    r5.xy = (r5.xy) * (c12.xx) + (c12.yy);
    r0.w = dot(c[34].yz, r9.xy) + (c[34].x);
    r4.xy = (r4.xy) * (r5.xy);
    r11.xyz = lerp(r3.xyz, c1.xxx, r12.www);
    r0.w = (r0.w) * (r4.x);
