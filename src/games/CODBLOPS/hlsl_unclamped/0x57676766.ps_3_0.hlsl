// Mechanically reconstructed from 0x57676766.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c9 = float4(-1.0f, 1.0f, 0.200000003f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0.y = dot(r2.xy, r2.xy) + (c9.w);
    r0.w = dot(r7.xy, r7.xy) + (c9.w);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r0.y = (r0.y) * (c1.x) + (c1.y);
    r0.w = (r0.w) * (c1.x) + (c1.y);
    r1.w = (r0.y) * (r0.w);
    r0.y = dot(r2.xy, r7.xy) + (c9.w);
    r2 = tex2D(s14, v1.zw);
    r5.xy = (r2.xy) * (c2.ww);
    ...
    r11.xyz = (v0.yyy) * (r3.xyz) + (c9.yyy);
    r5.xyz = (r11.xyz) * (c9.zzz);
