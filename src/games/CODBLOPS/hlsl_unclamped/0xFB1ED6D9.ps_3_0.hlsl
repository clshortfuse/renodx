// Mechanically reconstructed from 0xFB1ED6D9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = (r1.w) * (r1.w);
    r7.w = c1.y;
    r7.xy = float2(((r5.w) >= 0.0f ? (r7.w) : (c[20].x)), ((r5.w) >= 0.0f ? (r7.w) : (c[20].y)));
    r4.w = (r1.w) * (r1.z);
    r1 = tex2D(s4, v1.xy);
    r6.w = (r1.w) * (c3.x) + (c3.y);
    r2 = tex2D(s3, v7.zw);
    ...
    r1.xyz = (r9.xyz) * (-(r2.www)) + (r0.xyz);
    r1 = texCUBElod(s15, r1);
    r0.xyz = (r1.xyz) * (r1.xyz);
    r1.xyz = (r2.xyz) * (r2.xyz) + (r6.xyz);
