// Mechanically reconstructed from 0x09101F8E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xy = float2(((r3.w) >= 0.0f ? (r2.x) : (r4.x)), ((r3.w) >= 0.0f ? (r2.y) : (r4.y)));
    r2.y = (r1.w) + (r1.w);
    r2.z = dot(r3.xy, r5.xy) + (c1.z);
    r1 = tex2D(s0, v0.xy);
    ...
    r1.z = (r1.y) * (r1.z);
    r13.xyz = float3(((r3.w) >= 0.0f ? (r2.y) : (c[29].x)), ((r3.w) >= 0.0f ? (r2.y) : (c[29].y)), ((r3.w) >= 0.0f ? (r2.y) : (c[29].w)));
