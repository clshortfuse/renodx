// Mechanically reconstructed from 0x3F232336.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = (abs(c0.wy)) * (v4.zw);
    r4 = tex2D(s13, r4.xy);
    r5.xy = (v4.zw) * (c1.xy) + (c1.zy);
    r5 = tex2D(s13, r5.xy);
    r4.w = r5.y;
    r4.yw = (r4.yw) * (c4.xx) + (c4.yy);
    ...
    r2.xyz = max(r0.xyz, c1.zzz);
    r0.w = c[21].w;
    r0.xy = (r0.ww) * (c[27].xy);
    r0.xy = (r0.xy) * (c[26].xx);
    r0.xy = (v4.xy) * (c[26].xx) + (r0.xy);
    r3 = tex2D(s6, r0.xy);
