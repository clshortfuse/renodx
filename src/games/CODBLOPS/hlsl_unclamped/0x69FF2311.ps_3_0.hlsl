// Mechanically reconstructed from 0x69FF2311.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyz = (r4.yyy) * (v5.xyz) + (r0.xyz);
    r0.w = rsqrt(r0.w);
    r4.xyz = normalize(r0.xyz);
    r2.xyz = (r0.www) * (v1.xyz);
    r0.z = dot(r3.xzy, c2.yyz);
