// Mechanically reconstructed from 0x276902AE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xy = (r3.yw) * (c14.xx) + (c14.yy);
    r8.xyz = float3(((r12.w) >= 0.0f ? (r4.x) : (r6.x)), ((r12.w) >= 0.0f ? (r4.y) : (r6.y)), ((r12.w) >= 0.0f ? (r4.z) : (r6.z)));
    r0.z = dot(r11.xy, r11.xy) + (c1.z);
    ...
    r1.w = (-(r1.w)) + (-(c1.y));
    r5.xyz = (r2.www) * (v5.xyz);
    r2.w = (r1.w) * (r1.w);
    r10.w = saturate(dot(r10.xyz, r11.xyz));
    r2.w = (r2.w) * (r2.w);
    r2.z = (r1.w) * (r2.w);
    r8.w = (r8.z) * (c2.w);
    r7.w = (r8.z) * (-(c14.z)) + (c14.w);
    r1.w = saturate(dot(r10.xyz, -(r5.xyz)));
    r5.w = (r1.w) * (r7.w) + (r8.w);
    r2.w = (r2.x) * (r7.w) + (r8.w);
    r2.w = (r2.w) * (r5.w) + (c4.x);
    r8.xy = (r8.zz) * (c12.xy) + (c12.zw);
    r9.w = 1.0f / (r2.w);
    r4.w = exp2(r8.y);
    r3.w = (r4.w) * (c4.y) + (c4.z);
    r2.w = pow(abs(r10.w), r4.w);
    r2.x = (r2.x) * (r9.w);
    r2.w = (r3.w) * (r2.w);
    r2.z = (r2.z) * (c3.x) + (c3.y);
    r2.w = (r2.x) * (r2.w);
