// Mechanically reconstructed from 0xC101E20D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c11 = float4(0.00048828125f, -0.000122070312f, 0.0f, -4.0f);
    ...
    r1.x = 1.0f / (r1.z);
    r3.z = exp2(r10.y);
    r1.y = pow(abs(r8.w), r3.z);
    r1.z = (r3.z) * (c3.y) + (c3.z);
    r3.y = (r7.w) * (r1.x);
    r3.z = (r1.y) * (r1.z);
    r1.xyz = (r2.xyz) * (r6.www) + (r6.xyz);
    r3.z = (r3.y) * (r3.z);
    r1.xyz = (r1.xyz) * (r3.zzz);
    r1.xyz = (r1.xyz) * (c[7].www);
    r1.xyz = (r1.xyz) * (c[19].xyz);
    r4.xyz = (r3.www) * (r8.xyz) + (r9.xyz);
    ...
    r2.x = c[6].w;
    r1.xy = (c[8].xy) * (-(r2.xx)) + (v1.xy);
    r1 = tex2D(s5, r1.xy);
    r2.xy = (c[9].xy) * (-(r2.xx)) + (v1.xy);
    r2 = tex2D(s4, r2.xy);
