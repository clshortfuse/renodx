// Mechanically reconstructed from 0x5569234E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.xyz = (v4.xyz) * (-(r0.zzz)) + (c[17].xyz);
    r5.xyz = (r0.xxx) * (c[18].xyz);
    r1.xyz = normalize(r12.xyz);
    r5.xyz = (r0.yyy) * (r5.xyz) + (r11.xyz);
    r0.w = saturate(dot(r1.xyz, c[17].xyz));
    r11.xyz = (r0.zzz) * (v4.xyz);
    r0.w = (-(r0.w)) + (c0.y);
