// Mechanically reconstructed from 0xACF4DDC3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xyz = (r1.xyz) * (r2.xxx) + (v8.xyz);
    r4 = tex3D(s11, r1.xyz);
    r1.z = lerp(r4.w, r2.y, c[9].w);
    ...
    r3.w = 1.0f / (r3.w);
    r3.w = (r2.y) * (r3.w);
    r10.xyz = (r4.xyz) * (r2.xxx) + (-(r5.xyz));
    r7.xyz = (r2.yyy) * (c[7].xyz);
    ...
    r8.w = dot(r5.xyz, r6.xyz);
    r3.xyz = (r1.xyz) * (r7.xyz) + (r2.xyz);
    r2.z = (r8.w) + (r8.w);
    r1.xyz = (r0.xyz) * (v0.xyz);
    r2.xyz = (r6.xyz) * (-(r2.zzz)) + (r5.xyz);
