// Mechanically reconstructed from 0xF4F46502.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.x = dot(r7.xy, r0.xy) + (c3.z);
    r2.y = dot(r7.xy, r0.zw) + (c3.z);
    r0 = tex2D(s3, v6.zw);
    r6.w = (r0.w) * (v0.z);
    ...
    r3.w = (r2.z) * (c4.x) + (c4.y);
    r0.w = exp2(-(r0.w));
    r2 = (r2.wwww) * (c1.xxxy) + (c1.zzzx);
    r0.w = (r0.w) * (c4.x) + (c4.y);
    r3.y = (r3.w) * (r0.w);
    r3.w = dot(r5.xy, r8.xy) + (c3.z);
    r5 = tex2D(s14, v1.zw);
    r4.xy = (r5.xy) * (c10.xx);
    r5.w = saturate((r3.w) * (r3.y) + (r3.y));
    r6.xy = (r6.xz) * (r4.yy);
    r3.w = (r5.y) * (c10.x) + (-(r6.x));
    r7.xz = (r6.xy) * (c10.yy);
    r3.w = (r6.z) * (-(r4.y)) + (r3.w);
    r3.xy = (r3.xz) * (r4.xx);
    r7.y = (r3.w) + (r3.w);
    r3.w = (r5.x) * (c10.x) + (-(r3.x));
    r5.xyz = (r5.www) * (r7.xyz);
    r3.w = (r3.z) * (-(r4.x)) + (r3.w);
    r6.xz = (r3.xy) * (c10.yy);
    r6.y = (r3.w) + (r3.w);
    r5.xyz = (r6.xyz) * (r0.www) + (r5.xyz);
    r3.xyz = v2.xyz;
    r7.xyz = (r8.xxx) * (v4.xyz) + (r3.xyz);
    r3.xy = -(r4.zw);
    r7.xyz = (r8.yyy) * (v3.xyz) + (r7.xyz);
    r8.xyz = normalize(r7.xyz);
    r7.xyz = normalize(v5.xyz);
    r3.z = (r3.y) + (-(c3.y));
    r0.w = dot(r7.xyz, r8.xyz);
    r9.xy = (r6.ww) * (r3.xz) + (r4.zw);
    r0.w = (r0.w) + (r0.w);
