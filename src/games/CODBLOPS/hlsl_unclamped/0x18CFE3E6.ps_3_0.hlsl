// Mechanically reconstructed from 0x18CFE3E6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s0, v1.xy);
    r3.xyz = saturate((r2.xyz) * (r1.www) + (r1.xyz));
    r1.xyz = (r0.xxx) * (r3.xyz);
    r2.xyz = lerp(r3.xyz, c0.yyy, r0.xxx);
    ...
    r1.xyz = (r1.xyz) * (r0.xxx) + (v6.xyz);
    r1 = tex3D(s11, r1.xyz);
    r1.xyz = (r1.xyz) * (r1.xyz);
    r2.xyz = (r4.xxx) * (c[18].xyz);
    r1.xyz = (r0.yyy) * (r1.xyz);
    r12.xyz = (r0.zzz) * (r2.xyz);
    r13.xyz = (r1.xyz) * (c0.www);
    if ((c1.x) >= (v4.w))
    {
        r2 = (v4.xyzx) * (c1.xxxw);
        r1 = (r2) + (-(c12.xyzz));
    ...
    r2.xyz = (r0.zzz) * (r12.xyz) + (r13.xyz);
    r4.xyz = (r11.xyz) * (r0.zzz);
    r0.z = 1.0f / (r14.x);
    r0.x = (-(r6.w)) + (c1.x);
