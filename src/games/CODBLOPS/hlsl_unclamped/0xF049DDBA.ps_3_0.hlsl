// Mechanically reconstructed from 0xF049DDBA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (r0.w) * (v0.y) + (c1.x);
    r1 = tex2D(s6, v1.xy);
    r3.w = ((r0.w) >= 0.0f ? (c1.y) : (r1.y));
    r1.xyz = (r5.www) * (r3.xyz);
    r5.xyz = (r2.xyz) * (r3.www);
    r2 = tex2D(s0, v1.xy);
    r6.xyz = float3(((r0.w) >= 0.0f ? (r0.x) : (r2.x)), ((r0.w) >= 0.0f ? (r0.y) : (r2.y)), ((r0.w) >= 0.0f ? (r0.z) : (r2.z)));
    r0 = tex2D(s5, v7.zw);
    r0.xyz = (r0.xyz) + (c1.zzz);
    r2.xyz = (v0.zzz) * (r0.xyz) + (c1.yyy);
    r0 = v2;
    r3.xyz = (r7.xxx) * (v5.xyz) + (r0.xyz);
    r0.xyz = (r6.xyz) * (r2.xyz);
    r3.xyz = (r7.yyy) * (v4.xyz) + (r3.xyz);
    ...
    r5.w = saturate(dot(r7.xyz, -(r10.xyz)));
    r10.xyz = (r8.xyz) * (r4.www) + (-(r10.xyz));
    r2.w = (-(r5.w)) + (c1.y);
    r4.w = (r2.w) * (r2.w);
