// Mechanically reconstructed from 0x95EE95C7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = dot(r14.xy, r14.xy) + (c12.w);
    r0.z = dot(r0.xy, r0.xy) + (c12.w);
    r2.w = exp2(-(r2.w));
    r0.z = exp2(-(r0.z));
    r2.w = (r2.w) * (c1.x) + (c1.y);
    r2.z = (r0.z) * (c1.x) + (c1.y);
    r0.z = dot(r0.xy, r14.xy) + (c12.w);
    r0.y = (r2.w) * (r2.z);
    r4 = tex2D(s14, v1.zw);
    r14.xy = (r4.xy) * (c2.ww);
