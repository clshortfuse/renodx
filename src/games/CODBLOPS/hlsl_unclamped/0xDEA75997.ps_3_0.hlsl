// Mechanically reconstructed from 0xDEA75997.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s6, v1.xy);
    r0 = v2;
    r3.xyz = (r10.xxx) * (v5.xyz) + (r0.xyz);
    r0.x = -(r1.y);
    r3.xyz = (r10.yyy) * (v4.xyz) + (r3.xyz);
    ...
    r3 = tex2D(s5, v7.zw);
    r1.xyz = (r3.xyz) + (c4.yyy);
    r3.w = 1.0f / (r14.x);
    r11.xyz = (v0.zzz) * (r1.xyz) + (c4.xxx);
    r3.w = (r4.z) * (r3.w);
    r1.xyz = (r11.xyz) * (c4.zzz);
    r4.xyz = (r1.xyz) * (r1.xyz);
    r1.xyz = (r1.xyz) * (-(r1.xyz)) + (c4.xxx);
