// Mechanically reconstructed from 0xB1C4FEBC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c22 = float4(2.0f, -1.0f, 0.0f, -0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r4.y = dot(r1.xy, r0.zw) + (c22.z);
    r4.x = dot(r1.xy, r0.xy) + (c22.z);
    r0 = tex2D(s1, v0.xy);
    ...
    r0.w = dot(r6.xy, r6.xy) + (c22.z);
    r0.y = dot(r1.xy, r1.xy) + (c22.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c1.x) + (c1.y);
    r1.w = (r0.y) * (c1.x) + (c1.y);
    r0.y = dot(r1.xy, r6.xy) + (c22.z);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v0.zw);
    r7.xy = (r1.xy) * (c3.ww);
    ...
    r1.z = (r1.y) * (r1.z);
    r12.xyz = lerp(c[20].xyw, r2.yyy, r4.www);
    r0.xyz = (r0.xyz) * (r1.zzz);
    r15.xyz = (r4.xyz) * (r12.yyy);
    r1.xyz = (r12.zzz) * (r0.xyz);
    r2 = tex2D(s12, v0.zw);
    r0.z = ((-abs(r2.y)) >= 0.0f ? (-(c22.y)) : (-(c22.z)));
