// Mechanically reconstructed from 0x9DFBA58F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s2, v6.xy);
    r3.w = (r0.w) * (v0.y);
    r2.xy = (r1.yw) * (c10.yy) + (c10.zz);
    r6.xy = lerp(r5.xy, r4.xy, r3.ww);
    ...
    r3.xy = (r3.xz) * (r5.yy);
    r1.w = (r2.y) * (c10.x) + (-(r3.x));
    r4.xz = (r3.xy) * (c10.yy);
    r1.w = (r3.z) * (-(r5.y)) + (r1.w);
    r1.xy = (r1.xz) * (r5.xx);
    r4.y = (r1.w) + (r1.w);
    r1.w = (r2.x) * (c10.x) + (-(r1.x));
    ...
    r1.w = (r1.w) * (r5.w);
    r6.xyz = (v0.zzz) * (r2.xyz) + (c2.www);
    r2 = tex2D(s4, v7.xy);
    r2.xyz = (r2.xyz) + (c2.yyy);
    r5.xyz = (r6.xyz) * (c3.xxx);
    r2.xyz = (v0.www) * (r2.xyz) + (c2.www);
    r2.w = 1.0f / (r4.w);
    r5.xyz = (r5.xyz) * (r2.xyz);
    r1.w = (r1.w) * (r2.w);
    r8.xyz = (r5.xyz) * (-(r5.xyz)) + (c2.www);
    r7.xyz = (r1.xyz) * (r1.xyz);
    r1.xyz = (r1.www) * (r8.xyz);
    r7.xyz = (r9.yyy) * (r7.xyz);
    r8.xyz = (r5.xyz) * (r5.xyz) + (r1.xyz);
    r1 = tex2D(s0, v1.xy);
    r5.xyz = lerp(r1.xyz, r0.xyz, r3.www);
    r1.xyz = (r7.xyz) * (r8.xyz);
    r0.xyz = (r6.xyz) * (r5.xyz);
