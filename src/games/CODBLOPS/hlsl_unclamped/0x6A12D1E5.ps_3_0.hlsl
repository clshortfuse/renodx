// Mechanically reconstructed from 0x6A12D1E5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r6.w = (r0.w) * (v0.w) + (c0.x);
    r4.xy = float2(((r6.w) >= 0.0f ? (r1.x) : (c0.z)), ((r6.w) >= 0.0f ? (r1.y) : (c0.z)));
    r1 = v2;
    ...
    r1.z = lerp(r2.w, r3.w, c[25].w);
    r7.w = rsqrt(r1.y);
    r6.xyz = (r2.xyz) * (r2.xyz);
    r4.xyz = (r3.xyz) * (r7.www);
    ...
    r13.yz = c0.yz;
    r9.xyz = float3(((r6.w) >= 0.0f ? (c[38].x) : (r13.z)), ((r6.w) >= 0.0f ? (c[38].y) : (r13.z)), ((r6.w) >= 0.0f ? (c[38].w) : (r13.z)));
    r2.w = (r2.w) * (c0.w);
