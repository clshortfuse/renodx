// Mechanically reconstructed from 0x4D754F94.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xyz = (r1.www) * (v7.xyz);
    r3.y = saturate(dot(r10.xyz, r1.xyz));
    r7.w = saturate(dot(r10.xyz, -(r11.xyz)));
    r1 = tex2D(s3, v1.xy);
    r8.xyz = (r1.xyz) * (-(r1.xyz)) + (c4.xxx);
    r0.z = (r1.w) * (-(c4.y)) + (c4.x);
    r0.x = (r1.w) * (c4.y);
    r9.xyz = (r1.xyz) * (r1.xyz);
    r0.y = (r7.w) * (r0.z) + (r0.x);
    r14.xy = (r1.ww) * (c10.xy) + (c10.zw);
    r3.w = saturate(dot(r10.xyz, c[17].xyz));
    r1.z = exp2(r14.y);
    r0.z = (r3.w) * (r0.z) + (r0.x);
    r0.x = pow(abs(r3.y), r1.z);
    r0.z = (r0.z) * (r0.y) + (c3.w);
    r0.y = (r1.z) * (c11.x) + (c11.y);
    r0.z = 1.0f / (r0.z);
    r1.z = (r0.x) * (r0.y);
    r1.y = (r3.w) * (r0.z);
    r0.xyz = (r8.xyz) * (r2.www) + (r9.xyz);
    r2.w = (r1.z) * (r1.y);
    r1.xyz = (r7.xyz) * (r3.zzz) + (r2.xyz);
    r0.xyz = (r0.xyz) * (r2.www);
    r12.xyz = (r1.xyz) * (c[6].yyy);
    r13.xyz = (r0.xyz) * (c[6].www);
    r2 = tex2D(s12, v1.zw);
    ...
    r2.xyz = (r2.www) * (r1.xyz) + (r12.xyz);
    r4.xyz = (r2.www) * (r0.xyz);
    r3 = tex2D(s0, v1.xy);
    r5.xyz = (r3.xyz) * (v0.xyz);
    r0.z = (-(r7.w)) + (c4.x);
    r0.x = 1.0f / (r14.x);
    r0.y = (r0.z) * (r0.z);
    r0.y = (r0.z) * (r0.y);
