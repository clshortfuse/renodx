// Mechanically reconstructed from 0x57AC2990.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r0.w) * (r0.z);
    r0 = tex2D(s3, v7.zw);
    r2.xyz = (r0.xyz) + (c7.yyy);
    r0 = tex2D(s1, v1.xy);
    r0.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r1 = tex2D(s2, v7.xy);
    r9.w = (r1.w) * (v0.y);
    r10.xyz = (v0.zzz) * (r2.xyz) + (c7.xxx);
    r12.xy = (r9.ww) * (-(r0.xy)) + (r0.xy);
    r3.xyz = (r10.xyz) * (c7.zzz);
    r0 = v2;
    r0.xyz = (r12.xxx) * (v5.xyz) + (r0.xyz);
    r8.xyz = (r3.xyz) * (r3.xyz);
    r2.xyz = (r12.yyy) * (v4.xyz) + (r0.xyz);
    r7.xyz = (r3.xyz) * (-(r3.xyz)) + (c7.xxx);
    ...
    r6.w = lerp(r2.y, c7.x, r9.w);
    r7.w = 1.0f / (r5.x);
    r2.xyz = (r3.xyz) * (r6.www);
    r1.w = (r2.w) * (c1.z);
    r11.xyz = (r2.xyz) * (c[19].xyz);
    r2 = tex2D(s12, v1.zw);
    r3.xy = (v1.zw) * (c2.xy);
    r3 = tex2D(s13, r3.xy);
    ...
    r2.w = dot(r12.xy, r12.xy) + (c7.w);
    r2.z = dot(r4.xy, r4.xy) + (c7.w);
    r2.w = exp2(-(r2.w));
    r2.z = exp2(-(r2.z));
    r2.w = (r2.w) * (c1.x) + (c1.y);
    r2.x = (r2.z) * (c1.x) + (c1.y);
    r2.z = dot(r4.xy, r12.xy) + (c7.w);
    r2.x = (r2.w) * (r2.x);
    r4 = tex2D(s14, v1.zw);
    r13.xy = (r4.xy) * (c2.ww);
