// Mechanically reconstructed from 0xD6303587.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = dot(r5.xy, r0.xy) + (c12.z);
    r1.y = dot(r5.xy, r0.zw) + (c12.z);
    r0 = tex2D(s3, v6.zw);
    r6.w = (r0.w) * (v6.y);
    ...
    r1.y = dot(r10.xy, r10.xy) + (c12.z);
    r1.w = dot(r2.xy, r2.xy) + (c12.z);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r3.w = (r1.y) * (c1.x) + (c1.y);
    r1.y = (r1.w) * (c1.x) + (c1.y);
    r1.w = dot(r2.xy, r10.xy) + (c12.z);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v0.zw);
    r10.xy = (r2.xy) * (c2.ww);
    ...
    r1.w = (r1.w) * (-(v6.x)) + (c12.w);
    r2.w = (r0.w) * (-(v6.y)) + (c12.w);
