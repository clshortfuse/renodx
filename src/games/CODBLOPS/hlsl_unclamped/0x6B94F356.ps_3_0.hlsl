// Mechanically reconstructed from 0x6B94F356.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.y = dot(r2.xy, r0.zw) + (c39.z);
    r1.x = dot(r2.xy, r0.xy) + (c39.z);
    r0 = tex2D(s1, v0.xy);
    r2.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r0 = tex2D(s5, v7.zw);
    r5.w = (r0.w) * (v7.y);
    r4.xy = lerp(r2.xy, r1.xy, r5.ww);
    r2.w = (r0.w) * (-(v7.y)) + (c39.w);
    r1 = tex2D(s0, v0.xy);
    r0.w = (r1.w) * (-(v7.x)) + (c39.w);
    r3.xyz = lerp(r1.xyz, r0.xyz, r5.www);
    r6.w = (r0.w) * (-(r2.w)) + (c39.w);
    r2 = tex2D(s7, v0.xy);
    r0 = tex2D(s8, v7.zw);
    ...
    r3.w = r0.y;
    r11.w = rsqrt(r2.w);
    r9.xy = (r3.yw) * (c4.xx) + (c4.yy);
    r2 = tex2D(s14, v0.zw);
    r7.xy = (r2.xy) * (c3.ww);
    r0.w = dot(r9.xy, r4.xy) + (c39.z);
    r5.xy = (r3.xz) * (r7.xx);
    r0.y = (r2.x) * (c3.w) + (-(r5.x));
    r8.xy = (r0.xz) * (r7.yy);
    r0.y = (r3.z) * (-(r7.x)) + (r0.y);
    ...
    r7.y = (r0.y) + (r0.y);
    r0.y = (r0.z) + (r0.z);
    r0.z = dot(r9.xy, r9.xy) + (c39.z);
    r0.z = exp2(-(r0.z));
    r2.xyz = (-(v6.xyz)) + (c[20].xyz);
    r0.z = (r0.z) * (c1.x) + (c1.y);
    r0.x = dot(r2.xyz, r2.xyz);
    r0.x = rsqrt(r0.x);
    r13.xyz = (r11.www) * (v6.xyz);
    r0.z = (r4.w) * (r0.z);
    r3.xyz = (r2.xyz) * (r0.xxx) + (-(r13.xyz));
    r12.xyz = normalize(r3.xyz);
    r14.xyz = (r2.xyz) * (r0.xxx);
    r2.w = saturate((r0.w) * (r0.z) + (r0.z));
    r0.w = saturate(dot(r12.xyz, r14.xyz));
    r0.xz = (r8.xy) * (c4.xx);
    r0.w = (-(r0.w)) + (c39.w);
    ...
    r2.xyw = c[36].xyw;
    r1.xyz = (-(r2.xyw)) + (c[37].xyw);
    r8.xyz = (r10.xyz) * (r0.www) + (r11.xyz);
    r1.xyz = (r5.www) * (r1.xyz) + (c[36].xyw);
    r7.w = dot(r14.xyz, c[29].xyz);
    r16.xyz = (r0.xyz) * (r1.yyy);
    r0 = tex2D(s12, v0.zw);
    r2.xyz = v1.xyz;
    ...
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c39.w) : (c39.z));
    ...
    r3.xyz = (r2.www) * (r15.xyz) + (r16.xyz);
    r10.w = (r1.w) * (c1.w);
    r1.y = saturate(dot(r14.xyz, r9.xyz));
    r0.w = (r1.y) * (r9.w) + (r10.w);
    r2.z = saturate(dot(r9.xyz, -(r13.xyz)));
    r0.xyz = (v6.xyz) * (-(r11.www)) + (c[17].xyz);
    r5.z = (r2.z) * (r9.w) + (r10.w);
    r4.xyz = normalize(r0.xyz);
    r0.z = (r0.w) * (r5.z) + (c13.x);
    r0.w = saturate(dot(r4.xyz, c[17].xyz));
    r0.z = 1.0f / (r0.z);
    r3.w = (r1.y) * (r0.z);
    r4.w = (-(r0.w)) + (c39.w);
    r0.z = (r4.w) * (r4.w);
    r0.w = dot(r13.xyz, r9.xyz);
    r5.w = (r0.z) * (r0.z);
    r0.z = (r0.w) + (r0.w);
    r0.w = (r1.w) * (c1.z);
    r0.xyz = (r9.xyz) * (-(r0.zzz)) + (r13.xyz);
    r0 = texCUBElod(s15, r0);
    r0.w = (-(r2.z)) + (c39.w);
    r2.z = (r0.w) * (r0.w);
    r5.xy = (r1.ww) * (c16.xy) + (c16.zw);
    r0.w = (r0.w) * (r2.z);
    r1.w = 1.0f / (r5.x);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r0.w = (r0.w) * (r1.w);
    r0.xyz = (r1.xxx) * (r0.xyz);
    r2.xyz = (r10.xyz) * (r0.www) + (r11.xyz);
    r1.w = (r4.w) * (r5.w);
    r2.xyz = (r0.xyz) * (r2.xyz);
    r5.w = exp2(r5.y);
    r4.w = saturate(dot(r9.xyz, r12.xyz));
    r0.w = (r5.w) * (c13.y) + (c13.z);
    r0.z = (r8.w) * (r9.w) + (r10.w);
    r0.z = (r0.z) * (r5.z) + (c13.x);
    r1.x = saturate(dot(r9.xyz, r4.xyz));
    r0.y = 1.0f / (r0.z);
    r0.z = pow(abs(r1.x), r5.w);
    r0.y = (r8.w) * (r0.y);
    r0.z = (r0.w) * (r0.z);
    r1.x = (r0.y) * (r0.z);
    r0.xyz = (r10.xyz) * (r1.www) + (r11.xyz);
    r1.w = pow(abs(r4.w), r5.w);
    r0.xyz = (r1.xxx) * (r0.xyz);
    r0.w = (r0.w) * (r1.w);
    ...
    r0 = (v6.yyyy) * (c[32]);
    r1.xyz = (r1.yyy) * (c[21].xyz);
    r0 = (v6.xxxx) * (c[31]) + (r0);
    r5.xyz = (r6.xyz) * (r1.xyz) + (r2.xyz);
    r0 = (v6.zzzz) * (c[33]) + (r0);
