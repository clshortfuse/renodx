// Mechanically reconstructed from 0xFFB6FC0C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.w = -(r3.w);
    r1 = (r1) + (r4);
    r4 = (r3.wwww) * (c2.yyyz) + (c2.wwwy);
    r3.w = saturate(dot(r5.xyz, -(r6.xyz)));
    r1 = (r5.wwww) * (r1) + (r4);
    r6.xy = lerp(r3.yy, c[5].xy, r5.ww);
    r2.w = (r1.w) * (c3.z);
