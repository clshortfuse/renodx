// Mechanically reconstructed from 0xDCB83D2E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r3.z = (r0.w) * (v0.w) + (c1.x);
    r2 = float4(((r3.z) >= 0.0f ? (r1.x) : (c1.z)), ((r3.z) >= 0.0f ? (r1.y) : (c1.z)), ((r3.z) >= 0.0f ? (r1.z) : (c1.z)), ((r3.z) >= 0.0f ? (r1.w) : (c1.y)));
    r1 = v2;
    ...
    r6.w = exp2(r2.y);
    r2.z = (r2.x) * (r2.z);
    r4.xyz = (r7.xyz) * (r7.www) + (-(r8.xyz));
    r2.z = (r4.w) * (r2.z) + (r5.w);
    r5.xyz = (r5.xyz) * (r2.zzz);
    r3.w = max(abs(r10.y), abs(r10.z));
    r7.w = ((r3.z) >= 0.0f ? (r3.y) : (c1.z));
    ...
    r3.w = 1.0f / (r3.w);
    r7.xyz = (r2.xyz) * (c2.yyy) + (r3.xyz);
    r3.w = (r2.w) * (r3.w);
    r8.xyz = (r2.www) * (c[22].xyz);
    r2.xyz = normalize(r4.xyz);
    r3.z = (r6.w) * (c12.x) + (c12.y);
