// Mechanically reconstructed from 0x41FD18DA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = (r0.z) + (r0.z);
    r12.xy = c12.xy;
    r2.xyz = (r12.xyx) + (-(c[20].xyw));
    r0.xyz = (r8.xyz) * (r0.www) + (r3.xyz);
    r4.xyz = (r5.www) * (r2.xyz) + (c[20].xyw);
