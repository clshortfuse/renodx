// Mechanically reconstructed from 0x0886378C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r14.xy = lerp(r4.xy, r2.xy, r4.ww);
    r1 = tex2D(s8, v1.xy);
    r0 = tex2D(s9, v7.xy);
    r2 = tex2D(s5, v7.zw);
    r2.xyz = (r2.xyz) + (c28.yyy);
    r15.xy = lerp(r1.wy, r0.wy, r4.ww);
    r0.xyz = (v0.zzz) * (r2.xyz) + (c28.www);
    r2.xyz = (r3.xyz) * (r0.xyz);
    r1.xyz = (r0.xyz) * (c3.xxx);
    r0 = tex2D(s6, v8.xy);
    r0.xyz = (r0.xyz) + (c28.yyy);
    r0.w = dot(v6.xyz, v6.xyz);
    r4.xyz = (-(v6.xyz)) + (c[5].xyz);
    r12.w = rsqrt(r0.w);
    r0.w = dot(r4.xyz, r4.xyz);
    r0.w = rsqrt(r0.w);
    r6.xyz = (r12.www) * (v6.xyz);
    r3.xyz = (v0.www) * (r0.xyz) + (c28.www);
    ...
    r1.w = (r0.w) * (r0.w);
    r9.xyz = (r1.xyz) * (-(r1.xyz)) + (c28.www);
    r1.w = (r1.w) * (r1.w);
    r10.w = (r15.x) * (-(c12.x)) + (c12.y);
    r2.w = (r0.w) * (r1.w);
    ...
    r2.xy = (r2.xz) * (r7.xx);
    r0.w = dot(r13.xy, r14.xy) + (c28.z);
    r0.y = (r1.x) * (c4.x) + (-(r2.x));
    r1.w = (r2.z) * (-(r7.x)) + (r0.y);
    r5.xy = (r0.xz) * (r7.yy);
    r0.y = (r1.y) * (c4.x) + (-(r5.x));
    r0.x = dot(r13.xy, r13.xy) + (c28.z);
    r0.y = (r0.z) * (-(r7.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r7.y = (r1.w) + (r1.w);
    r0.z = (r0.z) * (c3.y) + (c3.z);
    ...
    r0.xyz = (r0.www) * (r13.xyz) + (r14.xyz);
    r1.xyz = (r0.www) * (r1.xyz);
    r1.xyz = (r12.xyz) * (r0.xyz) + (r1.xyz);
    r0.w = (-(r5.w)) + (c28.w);
    r0.y = 1.0f / (r16.x);
    r0.z = (r0.w) * (r0.w);
    r0.z = (r0.w) * (r0.z);
    ...
    r0.xy = (r0.xy) * (r0.xy);
    r0.w = ((-abs(r0.w)) >= 0.0f ? (c28.z) : (r0.z));
    r0.z = (r3.x) * (r0.x);
    r0.w = (r0.w) * (r0.z);
    r0.z = (r0.y) * (-(r3.y)) + (c28.w);
    r0.xy = (r1.zz) * (r1.xy);
    r0.w = (r0.w) * (r0.z);
    r1.w = (r1.w) * (r0.w);
