// Mechanically reconstructed from 0xF96758D6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = dot(r1, c2.wwww);
    r1.xyz = (r2.xyz) * (r3.www) + (v8.xyz);
    r1 = tex3D(s11, r1.xyz);
    r2.xyz = (-(v7.xyz)) + (c[6].xyz);
    r3.w = dot(r2.xyz, r2.xyz);
    r3.w = rsqrt(r3.w);
    r4.x = lerp(r1.w, r2.w, c[9].w);
