// Mechanically reconstructed from 0x8E14BA10.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = (c0.xxxx) * (v9) + (c0.yyyy);
    r3.x = dot(r6.xy, r0.xy) + (c0.w);
    r3.y = dot(r6.xy, r0.zw) + (c0.w);
    r0 = tex2D(s5, v7.zw);
    r4.w = (r0.w) * (v0.z);
    r1.w = r2.x;
    ...
    r2.w = (r3.w) * (r3.w);
    r6.xyz = (v0.www) * (r2.xyz) + (-(c0.yyy));
    r3.w = (r1.w) * (r2.w);
    r7.xyz = (r1.xyz) * (r6.xyz);
    r2 = tex2D(s0, v1.xy);
    r1 = tex2D(s4, v7.xy);
    r1.w = (r1.w) * (v0.y) + (c0.z);
    r9.xyz = (r7.xyz) * (-(r7.xyz)) + (-(c0.yyy));
