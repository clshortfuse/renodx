// Mechanically reconstructed from 0x22C9634B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.z = dot(r1, c[22]);
    r0.z = (r4.x) * (c[26].x);
    r0.y = (r4.y) * (c[26].y) + (-(r0.z));
    r0.z = c[26].y;
    r0.z = (r4.y) * (r0.z) + (-(c[25].z));
    r0.y = 1.0f / (r0.y);
    r4.xy = abs(r0.xw);
    r5.w = saturate((r0.z) * (r0.y));
    r1 = c[10];
    r1 = saturate((r4.zyxz) * (r1) + (c[11]));
    r5.x = (r1.w) * (r1.x);
    r5.yz = r1.yz;
    r1 = (r5) * (r5);
