// Mechanically reconstructed from 0x907B5F80.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.z = (r4.w) * (r2.y) + (r2.x);
    r2.y = (r2.w) * (r2.y) + (r2.x);
    r2.z = (r2.z) * (r2.y) + (c12.z);
    r3.xyz = (r7.xyz) * (r7.www) + (-(r10.xyz));
    r3.w = 1.0f / (r2.z);
