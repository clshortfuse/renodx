// Mechanically reconstructed from 0xBE986119.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xyz = float3(((r2.w) >= 0.0f ? (r4.x) : (r6.x)), ((r2.w) >= 0.0f ? (r4.y) : (r6.y)), ((r2.w) >= 0.0f ? (r4.z) : (r6.z)));
