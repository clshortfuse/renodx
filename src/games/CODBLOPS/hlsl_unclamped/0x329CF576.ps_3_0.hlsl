// Mechanically reconstructed from 0x329CF576.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (r0.w) * (r1.x);
    r0.z = saturate(dot(r4.xyz, r8.xyz));
    r0.w = (r1.y) * (r0.w);
    r1.w = (-(r0.z)) + (c1.z);
    r7.w = (r2.w) * (r0.w);
    r1.z = (r1.w) * (r1.w);
