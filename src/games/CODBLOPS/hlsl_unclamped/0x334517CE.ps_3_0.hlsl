// Mechanically reconstructed from 0x334517CE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xy = (r5.ww) * (-(r1.xy)) + (r1.xy);
    r0.w = dot(r3.xy, r3.xy) + (c2.w);
    r0.y = dot(r6.xy, r6.xy) + (c2.w);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c1.x) + (c1.y);
    r4.w = (r0.y) * (c1.x) + (c1.y);
    ...
    r6.w = (-(r0.z)) + (c2.x);
    r2 = tex2D(s3, v7.zw);
    r0.xyz = (r2.xyz) + (c2.yyy);
    r2.w = (r6.w) * (r6.w);
    r10.xyz = (v0.zzz) * (r0.xyz) + (c2.xxx);
    r0.z = (r6.w) * (r2.w);
    r2.xyz = (r10.xyz) * (c2.zzz);
    r1.w = (r1.w) * (r0.z);
