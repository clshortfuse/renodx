// Mechanically reconstructed from 0xF28FECDE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.y = dot(r1.xy, r0.zw) + (c16.z);
    r3.x = dot(r1.xy, r0.xy) + (c16.z);
    r0 = tex2D(s6, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c16.xxxx) * (v9) + (c16.yyyy);
    r7.y = dot(r1.xy, r0.zw) + (c16.z);
    r7.x = dot(r1.xy, r0.xy) + (c16.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r5.w = (r0.w) * (v0.y);
    r2 = tex2D(s1, v1.xy);
    ...
    r8.xy = lerp(r2.xy, r3.xy, r5.ww);
    r0 = tex2D(s8, v7.xy);
    r2 = (r0.wwww) * (-(c16.zzzy)) + (-(c16.wwwz));
    r4 = tex2D(s7, v1.xy);
    r1 = tex2D(s4, v7.zw);
    r6.w = (r1.w) * (v0.z);
    r3 = lerp(r4, r2, r5.wwww);
    r5.xyz = lerp(r6.xyz, r1.xyz, r6.www);
    r12.xy = lerp(r8.xy, r7.xy, r6.ww);
    r6.xyz = lerp(c[8].xyw, r0.yyy, r5.www);
    r1 = tex2D(s9, v7.zw);
    r0.w = dot(v6.xyz, v6.xyz);
    r4.w = rsqrt(r0.w);
    r0.xyz = (v6.xyz) * (-(r4.www)) + (c[17].xyz);
    r4.xyz = normalize(r0.xyz);
    r2 = (r1.wwww) * (-(c16.zzzy)) + (-(c16.wwwz));
    r1.w = saturate(dot(r4.xyz, c[17].xyz));
    r0 = lerp(r3, r2, r6.wwww);
    r1.w = (-(r1.w)) + (-(c16.y));
    r11.xyz = lerp(r6.xyz, r1.yyy, r6.www);
    r1.z = (r1.w) * (r1.w);
    r8.xyz = (r5.xyz) * (r5.xyz);
    r1.z = (r1.z) * (r1.z);
    r9.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c16.yyy));
    r2.w = (r1.w) * (r1.z);
    ...
    r2.xy = (r1.wy) * (c10.xx) + (c10.yy);
    r1.y = dot(r12.xy, r12.xy) + (c16.z);
    r1.w = dot(r2.xy, r2.xy) + (c16.z);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r3.w = (r1.y) * (c3.x) + (c3.y);
    r1.y = (r1.w) * (c3.x) + (c3.y);
    r1.w = dot(r2.xy, r12.xy) + (c16.z);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r6.xy = (r2.xy) * (c4.ww);
