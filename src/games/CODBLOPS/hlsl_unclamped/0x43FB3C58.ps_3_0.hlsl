// Mechanically reconstructed from 0x43FB3C58.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s7, v1.xy);
    r3.xyz = float3(((r3.w) >= 0.0f ? (c[39].x) : (r1.y)), ((r3.w) >= 0.0f ? (c[39].y) : (r1.y)), ((r3.w) >= 0.0f ? (c[39].w) : (r1.y)));
