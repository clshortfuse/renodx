// Mechanically reconstructed from 0x14DDFAA2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s2, v6.xy);
    r2.w = (r2.w) * (v0.y) + (c3.w);
    r5.xy = float2(((r2.w) >= 0.0f ? (r0.x) : (r1.x)), ((r2.w) >= 0.0f ? (r0.y) : (r1.y)));
    r0 = tex2D(s5, v6.zw);
    r1.xy = (r0.wy) * (c2.xy) + (c2.zw);
    ...
    r1 = tex2D(s7, v6.xy);
    r4.xyz = float3(((r2.w) >= 0.0f ? (r1.y) : (c[23].x)), ((r2.w) >= 0.0f ? (r1.y) : (c[23].y)), ((r2.w) >= 0.0f ? (r1.y) : (c[23].w)));
    r3 = (r1.wwww) * (c1.xxxy) + (c1.zzzx);
    r1.xyz = v2.xyz;
    r6.xyz = (r7.xxx) * (v4.xyz) + (r1.xyz);
    r1.xyz = -(r4.xyz);
    r6.xyz = (r7.yyy) * (v3.xyz) + (r6.xyz);
    r1.w = (r1.y) + (-(c3.y));
    r9.xyz = normalize(r6.xyz);
    r7.xyz = (r5.www) * (r1.xwz) + (r4.xyz);
