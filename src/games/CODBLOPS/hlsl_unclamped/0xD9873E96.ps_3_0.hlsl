// Mechanically reconstructed from 0xD9873E96.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = c1.z;
    r3.xyz = (r0.yyy) + (c[37].xyw);
    r0.xyz = v1.xyz;
    r0.xyz = (r10.xxx) * (v4.xyz) + (r0.xyz);
    r5.xyz = (r10.www) * (r3.xyz) + (c1.xxx);
    r0.xyz = (r10.yyy) * (v3.xyz) + (r0.xyz);
    r13.xyz = (r2.xyz) * (r5.yyy);
    r10.xyz = normalize(r0.xyz);
    r11.w = saturate(dot(r10.xyz, r7.xyz));
