// Mechanically reconstructed from 0x3265B10F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xy = float2(((r3.z) >= 0.0f ? (r2.x) : (c1.y)), ((r3.z) >= 0.0f ? (r2.y) : (c1.y)));
    ...
    r2.w = (r0.w) * (r0.w);
    r0 = tex2D(s7, v7.zw);
    r10.xyz = float3(((r3.z) >= 0.0f ? (r0.y) : (c[36].x)), ((r3.z) >= 0.0f ? (r0.y) : (c[36].y)), ((r3.z) >= 0.0f ? (r0.y) : (c[36].w)));
    r8.w = (r1.w) * (r2.w);
