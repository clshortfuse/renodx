// Mechanically reconstructed from 0xC71E05AF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xyz = lerp(r1.xyz, c7.xxx, r1.www);
    ...
    r0.y = dot(r4.xy, r4.xy) + (c7.y);
    r0.w = dot(r1.xy, r1.xy) + (c7.y);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r4.w = (r0.y) * (c7.z) + (c7.w);
    r0.y = (r0.w) * (c7.z) + (c7.w);
    r0.w = dot(r1.xy, r4.xy) + (c7.y);
    r0.y = (r4.w) * (r0.y);
    r1 = tex2D(s14, v1.zw);
    r6.xy = (r1.xy) * (c3.ww);
