// Mechanically reconstructed from 0x95BF6FBA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s3, v6.xy);
    r1.w = (r1.w) * (v0.y) + (c3.w);
    r10.xy = (r3.yw) * (c13.zz) + (c13.ww);
    r12.xyz = float3(((r1.w) >= 0.0f ? (r4.x) : (r6.x)), ((r1.w) >= 0.0f ? (r4.y) : (r6.y)), ((r1.w) >= 0.0f ? (r4.z) : (r6.z)));
    ...
    r8.w = (r12.z) * (c13.x);
    r7.w = (r12.z) * (-(c14.x)) + (c14.y);
    r0.w = (r0.z) * (r7.w) + (r8.w);
    r0.x = saturate(dot(r10.xyz, -(r3.xyz)));
    r4.w = (r0.x) * (r7.w) + (r8.w);
    r5.w = (-(r0.x)) + (-(c3.y));
    r0.w = (r0.w) * (r4.w) + (c14.z);
    r12.xy = (r12.zz) * (c1.xy) + (c1.zw);
    r0.x = 1.0f / (r0.w);
    r3.w = exp2(r12.y);
