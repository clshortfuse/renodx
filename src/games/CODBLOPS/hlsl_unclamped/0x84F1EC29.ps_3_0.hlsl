// Mechanically reconstructed from 0x84F1EC29.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(31.875f, 4.0f, -2.0f, 0.0f);
    const float4 c3 = float4(0.600000024f, 0.400000006f, 0.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r9.yz = c0.yz;
    r5.xy = float2(((r2.w) >= 0.0f ? (c[20].x) : (r9.z)), ((r2.w) >= 0.0f ? (c[20].y) : (r9.z)));
    r0 = (r0.xyzx) * (c0.yyyz) + (c0.zzzy);
    r6.xyz = (r1.xyz) * (r5.yyy);
    r1 = tex2D(s1, v1.xy);
