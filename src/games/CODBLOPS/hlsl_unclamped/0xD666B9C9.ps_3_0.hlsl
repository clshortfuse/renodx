// Mechanically reconstructed from 0xD666B9C9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.x = dot(r6.xy, r1.xy) + (c13.z);
    r3.y = dot(r6.xy, r1.zw) + (c13.z);
    r1 = tex2D(s3, v6.zw);
    r5.w = (r1.w) * (v6.y);
    r6.xy = (r2.yw) * (c4.xx) + (c4.yy);
    r7.xy = lerp(r8.xy, r3.xy, r5.ww);
    r0.w = dot(r6.xy, r6.xy) + (c13.z);
    r0.z = dot(r7.xy, r7.xy) + (c13.z);
    r0.w = exp2(-(r0.w));
    r0.z = exp2(-(r0.z));
    r0.w = (r0.w) * (c1.x) + (c1.y);
    r0.x = (r0.z) * (c1.x) + (c1.y);
    ...
    r3.y = (r0.w) + (r0.w);
    r0.zw = c13.zw;
    r4.xyz = (r0.zwz) + (-(c[28].xyw));
    r2.xyz = (r3.xyz) * (r0.xxx) + (r6.xyz);
    r9.xyz = (r5.www) * (r4.xyz) + (c[28].xyw);
