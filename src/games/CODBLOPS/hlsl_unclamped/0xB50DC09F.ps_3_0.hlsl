// Mechanically reconstructed from 0xB50DC09F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = dot(r4.xy, r4.xy) + (c7.w);
    r0.y = dot(r1.xy, r1.xy) + (c7.w);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c1.x) + (c1.y);
    r1.w = (r0.y) * (c1.x) + (c1.y);
    r0.y = dot(r1.xy, r4.xy) + (c7.w);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v0.zw);
    r6.xy = (r1.xy) * (c3.ww);
    ...
    r2 = tex2D(s3, v7.zw);
    r0.xyz = (r2.xyz) + (c7.xxx);
    r0.xyz = (v7.yyy) * (r0.xyz) + (c7.yyy);
    r2.xyz = (r0.xyz) * (c7.zzz);
    r6.xyz = (r2.xyz) * (-(r2.xyz)) + (c7.yyy);
