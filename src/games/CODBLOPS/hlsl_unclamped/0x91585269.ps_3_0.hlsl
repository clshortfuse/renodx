// Mechanically reconstructed from 0x91585269.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = max(abs(r10.y), abs(r10.z));
    r4.xy = c[6].xy;
    r3.xyz = (r4.yyy) * (c[19].xyz);
    r0.z = max(abs(r10.x), r1.x);
    r1.x = 1.0f / (r0.z);
    r0.xyz = (r10.xyz) * (c[5].xyz);
    r12.xyz = (r2.xyz) * (r3.xyz);
    r0.xyz = (r0.xyz) * (r1.xxx) + (v8.xyz);
    r2 = tex3D(s11, r0.xyz);
    r0.xyz = (r2.xyz) * (r2.xyz);
    r2.xyz = (r4.xxx) * (c[18].xyz);
    r0.xyz = (r1.yyy) * (r0.xyz);
    r13.xyz = (r1.zzz) * (r2.xyz);
    r14.xyz = (r0.xyz) * (c1.zzz);
    if ((c1.w) >= (v6.w))
    {
        r3 = (v6.xyzx) * (c3.yyyw);
        r2 = (r3) + (-(c12.xyzz));
