// Mechanically reconstructed from 0x7D1CB224.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = saturate(dot(r8.xyz, r6.xyz));
    ...
    r7.w = exp2(r2.y);
    r7.xyz = (r4.xyz) * (r3.xxx) + (-(r1.xyz));
    r9.w = 1.0f / (r2.x);
    r4.xyz = normalize(r7.xyz);
    r2.x = (r7.w) * (c12.x) + (c12.y);
    ...
    r2.z = dot(c[24].yz, r9.xy) + (c[24].x);
    r3.xy = saturate((r9.xx) * (c[25].xy) + (c[25].zw));
    r2.xy = (r3.xy) * (r3.xy);
