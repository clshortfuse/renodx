// Mechanically reconstructed from 0xE985316B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = dot(r1.xy, r0.zw) + (c4.z);
    r8.x = dot(r1.xy, r0.xy) + (c4.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r7.w = (r0.w) * (v0.y) + (c4.w);
    r2 = tex2D(s1, v1.xy);
    ...
    r9.xy = float2(((r7.w) >= 0.0f ? (r3.x) : (r2.x)), ((r7.w) >= 0.0f ? (r3.y) : (r2.y)));
    r2 = tex2D(s7, v1.xy);
    r3 = (r2.wwww) * (c3.xxxy) + (c3.zzzx);
    r1 = tex2D(s8, v7.xy);
    r0 = tex2D(s4, v7.zw);
    r2.w = (r0.w) * (v0.z);
    ...
    r2.xyz = float3(((r7.w) >= 0.0f ? (c[23].x) : (r2.y)), ((r7.w) >= 0.0f ? (c[23].y) : (r2.y)), ((r7.w) >= 0.0f ? (c[23].w) : (r2.y)));
    r13.xyz = lerp(r2.xyz, r1.yyy, r2.www);
    r11.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c4.yyy));
    r12.xyz = (r0.xyz) * (r0.xyz);
    r1.w = dot(r7.xy, r7.xy) + (c4.z);
    ...
    r3.xy = (r3.xz) * (r8.xx);
    r1.w = dot(r9.xy, r7.xy) + (c4.z);
    r1.y = (r2.x) * (c12.w) + (-(r3.x));
    r2.w = (r3.z) * (-(r8.x)) + (r1.y);
    r4.xy = (r1.xz) * (r8.yy);
    r1.y = (r2.y) * (c12.w) + (-(r4.x));
    r1.x = dot(r9.xy, r9.xy) + (c4.z);
    r1.y = (r1.z) * (-(r8.y)) + (r1.y);
    r1.z = exp2(-(r1.x));
    r10.y = (r2.w) + (r2.w);
