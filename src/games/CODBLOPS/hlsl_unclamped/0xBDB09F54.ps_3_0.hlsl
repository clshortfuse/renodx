// Mechanically reconstructed from 0xBDB09F54.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.x = dot(r2.xy, r0.xy) + (c13.w);
    r4.y = dot(r2.xy, r0.zw) + (c13.w);
    r0 = tex2D(s3, v6.zw);
    r5.w = (r0.w) * (v0.z) + (c2.x);
