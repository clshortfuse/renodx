// Mechanically reconstructed from 0x46996833.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xy = float2(((r4.w) >= 0.0f ? (r2.x) : (r4.x)), ((r4.w) >= 0.0f ? (r2.y) : (r4.y)));
    ...
    r4.xy = (r3.xy) * (r4.xy);
    r6.w = c2.y;
    r3.xyz = float3(((r4.w) >= 0.0f ? (-(r6.w)) : (c[28].x)), ((r4.w) >= 0.0f ? (-(r6.w)) : (c[28].y)), ((r4.w) >= 0.0f ? (-(r6.w)) : (c[28].w)));
    r1.w = (r1.w) * (r4.x);
