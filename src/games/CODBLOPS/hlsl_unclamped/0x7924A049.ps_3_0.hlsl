// Mechanically reconstructed from 0x7924A049.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    float4 v3 = input.v3;
    float4 v4 = input.v4;
    const float4 c0 = float4(-1.0f, 1.0f, 0.200000003f, 0.25f);
    ...
    r0.w = (r2.w) * (r2.w);
    r5.xyz = (v4.yyy) * (r0.xyz) + (c0.yyy);
    r0.w = (r0.w) * (r0.w);
    r0.xyz = (r5.xyz) * (c0.zzz);
    r2.w = (r2.w) * (r0.w);
