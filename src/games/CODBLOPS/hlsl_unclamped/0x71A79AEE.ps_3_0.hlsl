// Mechanically reconstructed from 0x71A79AEE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = (c26.xxxx) * (v8) + (c26.yyyy);
    r0 = tex2D(s3, v7.xy);
    r0.xyz = (r0.xyz) + (c26.yyy);
    r3.y = dot(r6.xy, r1.zw) + (c3.x);
    r7.xyz = (v0.yyy) * (r0.xyz) + (c26.zzz);
    r0 = tex2D(s0, v1.xy);
    r2 = tex2D(s4, v7.zw);
    r9.w = (r2.w) * (v0.z);
    r2.xyz = (r0.xyz) * (-(r7.xyz)) + (r2.xyz);
    r3.x = dot(r6.xy, r1.xy) + (c3.x);
    r1.xyz = (r9.www) * (r2.xyz);
    r1.xyz = (r0.xyz) * (r7.xyz) + (r1.xyz);
    r8.xy = lerp(r4.xy, r3.xy, r9.ww);
    r2 = tex2D(s6, v1.xy);
    r0 = tex2D(s7, v7.zw);
    r6.w = lerp(r2.y, r0.y, r9.w);
    r0.z = dot(r8.xy, r8.xy) + (c3.x);
    r6.xyz = (r1.xyz) * (r1.xyz);
    r0.z = exp2(-(r0.z));
    r5.w = (r0.z) * (c12.x) + (c12.y);
    ...
    r4.xy = (r4.xz) * (r0.xx);
    r0.z = dot(r2.xy, r8.xy) + (c3.x);
    r1.w = (r3.x) * (c12.w) + (-(r4.x));
    r1.w = (r4.z) * (-(r0.x)) + (r1.w);
    r1.xy = (r1.xz) * (r0.yy);
    r2.z = (r3.y) * (c12.w) + (-(r1.x));
    r0.x = dot(r2.xy, r2.xy) + (c3.x);
    r0.y = (r1.z) * (-(r0.y)) + (r2.z);
    r0.x = exp2(-(r0.x));
    r10.y = (r1.w) + (r1.w);
    ...
    r0.y = (r0.z) * (r0.y) + (c14.x);
    r0.z = (r1.w) * (c14.y) + (c14.z);
    r0.y = 1.0f / (r0.y);
    r0.z = (r0.x) * (r0.z);
    r0.y = (r2.w) * (r0.y);
    r1.xyz = (r11.xyz) * (r8.www) + (r12.xyz);
    r1.w = (r0.z) * (r0.y);
    r0.xyz = (r10.xyz) * (r5.www) + (r3.xyz);
