// Mechanically reconstructed from 0xE28F43E4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = (v1.zw) * (c14.xy);
    r4 = tex2D(s13, r2.xy);
    r2.xy = (v1.zw) * (c14.xy) + (c14.zy);
    r2 = tex2D(s13, r2.xy);
    r4.w = r2.y;
    r3 = tex2D(s14, v1.zw);
    r6.xy = (r3.xy) * (c14.ww);
    r8.xy = (r4.yw) * (c12.xx) + (c12.yy);
    r4.xy = (r4.xz) * (r6.xx);
    r1.w = dot(r8.xy, r7.xy) + (c3.z);
    r2.w = (r3.x) * (c14.w) + (-(r4.x));
    r2.y = (r4.z) * (-(r6.x)) + (r2.w);
    r5.xy = (r2.xz) * (r6.yy);
    r2.x = (r3.y) * (c14.w) + (-(r5.x));
    r2.w = dot(r8.xy, r8.xy) + (c3.z);
    r2.z = (r2.z) * (-(r6.y)) + (r2.x);
    r2.w = exp2(-(r2.w));
    r11.y = (r2.y) + (r2.y);
    r2.w = (r2.w) * (c4.x) + (c4.y);
    ...
    r0 = tex2D(s8, v1.xy);
    r8.xyz = lerp(r0.yyy, c[34].xyw, r5.www);
    r2.w = -(r0.w);
    r1 = (r0.wwww) * (-(c3.zzzy)) + (-(c3.wwwz));
    r2.xyz = c3.www;
    r0 = tex2D(s9, v7.xy);
    r0 = (r2) + (r0);
    r2 = tex2D(s5, v7.zw);
