// Mechanically reconstructed from 0x92B4C576.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xy = saturate((r4.xx) * (c[31].xy) + (c[31].zw));
    r2.xy = (r3.xy) * (r3.xy);
    r3.xy = (r3.xy) * (c2.xx) + (c2.yy);
    r2.w = dot(c[30].yz, r4.xy) + (c[30].x);
    r2.xy = (r2.xy) * (r3.xy);
    ...
    r2 = (v6.zzzz) * (c[26]) + (r2);
    r1.xyz = (r1.zzz) * (c[29].xyz);
    r2 = (r2) + (c[27]);
    r5.xy = (r2.ww) * (c[32].xy) + (r2.xy);
    r5.zw = r2.zw;
    r3 = tex2Dproj(s2, r5);
    r4.zw = r5.zw;
    r2.zw = r4.zw;
    r6.xy = (r5.ww) * (-(c[32].zw)) + (r2.xy);
    r6.zw = r2.zw;
    r6 = tex2Dproj(s2, r6);
    r3.w = r6.x;
    r4.xy = (r5.ww) * (-(c[32].xy)) + (r2.xy);
    r2.xy = (r5.ww) * (c[32].zw) + (r2.xy);
    r4 = tex2Dproj(s2, r4);
    r3.y = r4.x;
    r4 = tex2Dproj(s2, r2);
