// Mechanically reconstructed from 0xE21E44A7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(0.200000003f, 0.797884583f, 1.0f, 0.0009765625f);
    ...
    r0 = tex2D(s3, v6.xy);
    r2.w = (r0.w) * (v0.y);
    r4.xy = lerp(r3.xy, r2.xy, r2.ww);
    r2.xyz = (r1.xyz) * (r1.xyz);
    r1.xyz = v4.xyz;
    r1.xyz = (r4.xxx) * (r1.xyz) + (v2.xyz);
    ...
    r1.w = (r4.w) * (r4.w);
    r6.xyz = (v0.zzz) * (r1.xyz) + (c3.www);
    r1.w = (r1.w) * (r1.w);
    r7.xyz = (r6.xyz) * (c1.xxx);
    r1.w = (r4.w) * (r1.w);
    r1.xyz = (r7.xyz) * (-(r7.xyz)) + (c3.www);
    r0.w = (r3.w) * (r0.w);
    r8.xyz = (r1.www) * (r1.xyz);
    r1 = tex2D(s0, v1.xy);
    r5.xyz = lerp(r1.xyz, r0.xyz, r2.www);
    r1.xyz = (r7.xyz) * (r7.xyz) + (r8.xyz);
