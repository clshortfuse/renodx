// Mechanically reconstructed from 0xC42741D0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = tex2D(s2, v1.xy);
    r1.zw = (r3.ww) * (c0.zy) + (c0.wz);
    r0 = tex2D(s0, v1.xy);
    r3.w = (r0.w) * (v0.w) + (c0.x);
    r2 = float4(((r3.w) >= 0.0f ? (r1.x) : (c0.z)), ((r3.w) >= 0.0f ? (r1.y) : (c0.z)), ((r3.w) >= 0.0f ? (r1.z) : (c0.z)), ((r3.w) >= 0.0f ? (r1.w) : (c0.y)));
    r3.x = (r2.w) * (c2.z);
    r3.z = (r2.w) * (-(c2.z)) + (c2.w);
    r1 = v2;
