// Mechanically reconstructed from 0xA384D37F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(0.0f, 0.797884583f, 1.0f, 0.0009765625f);
    ...
    r1.x = dot(r2.xy, r1.xy) + (c1.x);
    r1.y = dot(r2.xy, r1.zw) + (c1.x);
    r2 = tex2D(s4, v6.zw);
    r2.w = (r2.w) * (v0.z);
