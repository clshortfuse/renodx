// Mechanically reconstructed from 0x79DE2EF6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = float4(((r2.w) >= 0.0f ? (r1.x) : (c1.z)), ((r2.w) >= 0.0f ? (r1.y) : (c1.z)), ((r2.w) >= 0.0f ? (r1.z) : (c1.z)), ((r2.w) >= 0.0f ? (r1.w) : (c1.y)));
    r7.xyz = (r2.xyz) * (r2.xyz);
    r0.w = dot(r1.xy, r1.xy) + (c1.z);
    r7.w = ((r2.w) >= 0.0f ? (r0.y) : (c1.y));
    r0.w = exp2(-(r0.w));
    r8.w = (r1.z) * (-(r1.z)) + (c1.y);
    r4.w = (r0.w) * (c3.x) + (c3.y);
