// Mechanically reconstructed from 0x156CECA8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s0, v1.xy);
    r4.xyz = lerp(r1.xyz, r0.xyz, r6.zzz);
    r3 = tex2D(s9, v1.xy);
    r2 = tex2D(s10, v7.xy);
    r0 = tex2D(s8, v7.zw);
    ...
    r0 = tex2D(s6, v7.zw);
    r6.w = (r0.w) * (v0.z);
    r0.w = lerp(r3.y, r2.y, r6.z);
    r7.xy = lerp(r5.xy, r1.xy, r6.ww);
    r1.w = lerp(r3.w, r2.w, r6.z);
    r2.w = dot(r7.xy, r7.xy) + (c3.z);
    ...
    r3.w = r0.y;
    r4.xy = (r3.xz) * (r6.xx);
    r3.xy = (r3.yw) * (c13.xx) + (c13.yy);
    r0.y = (r2.x) * (c12.w) + (-(r4.x));
    r0.w = dot(r3.xy, r7.xy) + (c3.z);
    r1.z = (r3.z) * (-(r6.x)) + (r0.y);
    r1.xy = (r0.xz) * (r6.yy);
    r0.x = dot(r3.xy, r3.xy) + (c3.z);
    r0.y = (r2.y) * (c12.w) + (-(r1.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r0.z) * (-(r6.y)) + (r0.y);
    r0.z = (r0.x) * (c4.x) + (c4.y);
    r0.y = (r0.y) + (r0.y);
