// Mechanically reconstructed from 0xC6E9D6BA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xyz = float3(((r3.w) >= 0.0f ? (c[29].x) : (r2.y)), ((r3.w) >= 0.0f ? (c[29].y) : (r2.y)), ((r3.w) >= 0.0f ? (c[29].w) : (r2.y)));
