// Mechanically reconstructed from 0xADF4BE96.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = r2.y;
    r6.z = rsqrt(r1.w);
    r7.xy = (r0.wy) * (c13.xx) + (c13.yy);
    r1 = tex2D(s14, v1.zw);
    r8.xy = (r1.xy) * (c12.zz);
    r0.w = dot(r7.xy, r3.xy) + (c3.z);
    r4.xy = (r2.xz) * (r8.xx);
    r0.y = (r1.x) * (c12.z) + (-(r4.x));
    r6.xy = (r0.xz) * (r8.yy);
    r0.x = (r2.z) * (-(r8.x)) + (r0.y);
    r0.y = (r1.y) * (c12.z) + (-(r6.x));
    r0.y = (r0.z) * (-(r8.y)) + (r0.y);
