// Mechanically reconstructed from 0x54CC3AB2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyw = c[24].xyw;
    r0.xyz = (-(r4.xyw)) + (c[25].xyw);
    r1.xyz = (r6.yyy) * (v4.xyz) + (r1.xyz);
    r8.xyz = normalize(r1.xyz);
    r9.xyz = normalize(v6.xyz);
    r0.xyz = (r3.www) * (r0.xyz) + (c[24].xyw);
    r1.w = dot(r9.xyz, r8.xyz);
    r6.xyz = lerp(r0.xyz, c1.xxx, r2.www);
    r0.z = (r1.w) + (r1.w);
    r5 = tex2D(s6, v1.xy);
    r4 = tex2D(s7, v7.xy);
    r1 = lerp(r5, r4, r3.wwww);
    ...
    r4.xyz = (r5.xyz) * (r4.www) + (r7.xyz);
    r0.xyz = (r10.xyz) * (r6.www) + (r12.xyz);
    r1.xyz = (r1.xyz) * (r4.xyz);
    r0.xyz = (r6.yyy) * (r0.xyz);
    r1.xyz = (r10.xyz) * (r1.xyz);
    r6.w = exp2(r13.y);
    r10.xyz = (r1.xyz) * (c1.www);
    r4 = tex2D(s0, v1.xy);
    r12.xyz = lerp(r4.xyz, r3.xyz, r3.www);
    r1.xyz = lerp(r12.xyz, r2.xyz, r2.www);
    r2 = (v6.xyzx) * (c1.xxxz) + (c1.zzzx);
