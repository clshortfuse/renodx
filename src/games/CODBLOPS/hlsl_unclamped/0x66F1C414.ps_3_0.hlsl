// Mechanically reconstructed from 0x66F1C414.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.z = (r1.w) * (-(v7.y)) + (c14.w);
    r0 = tex2D(s0, v0.xy);
    r3.xyz = lerp(r0.xyz, r1.xyz, r4.www);
    r1.w = (r0.w) * (-(v7.x)) + (c14.w);
    r0.xy = (v0.zw) * (c4.xy) + (c4.zy);
    r0 = tex2D(s13, r0.xy);
    r1.xy = (v0.zw) * (c4.xy);
    r2 = tex2D(s13, r1.xy);
    r0.w = r2.y;
    r6.w = (r1.w) * (-(r5.z)) + (c14.w);
    ...
    r1.w = (r1.w) * (r1.z);
    r10.xyz = lerp(r1.yyy, c[5].xyw, r4.www);
