// Mechanically reconstructed from 0x3B658C1C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = dot(c[38].yz, r6.xy) + (c[38].x);
    r2.xy = (r2.xy) * (r3.xy);
    r13.yz = c1.yz;
    r11.xyz = float3(((r5.w) >= 0.0f ? (c[41].x) : (r13.z)), ((r5.w) >= 0.0f ? (c[41].y) : (r13.z)), ((r5.w) >= 0.0f ? (c[41].w) : (r13.z)));
    r1.w = (r1.w) * (r2.x);
