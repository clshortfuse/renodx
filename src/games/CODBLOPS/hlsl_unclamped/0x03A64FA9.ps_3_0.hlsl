// Mechanically reconstructed from 0x03A64FA9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = 1.0f / (r0.z);
    r0.z = pow(abs(r6.z), r7.z);
    r0.y = (r7.w) * (r0.y);
    r0.z = (r1.w) * (r0.z);
    r1.w = (r0.y) * (r0.z);
    r0.xyz = (r4.xyz) * (r6.www) + (r5.xyz);
    r0.w = (r5.w) * (r0.w);
