// Mechanically reconstructed from 0x8A6BED58.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyw = c[37].xyw;
    r4.xyz = float3(((r4.w) >= 0.0f ? (r3.x) : (c[36].x)), ((r4.w) >= 0.0f ? (r3.y) : (c[36].y)), ((r4.w) >= 0.0f ? (r3.w) : (c[36].w)));
    r5.w = saturate(dot(r9.xyz, r5.xyz));
    r11.xyz = (r2.xyz) * (r4.yyy);
