// Mechanically reconstructed from 0xB852292D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.y = dot(r1.xy, r0.zw) + (c1.z);
    r5.x = dot(r1.xy, r0.xy) + (c1.z);
    r2 = tex2D(s1, v0.xy);
    r1 = tex2D(s0, v0.xy);
    r0 = tex2D(s3, v7.zw);
    r5.w = (r0.w) * (v7.y);
    ...
    r1 = tex2D(s5, v0.xy);
    r0 = tex2D(s6, v7.zw);
    r12.xy = lerp(r1.wy, r0.wy, r5.ww);
    r3.z = (r12.x) * (-(c7.z)) + (c7.w);
