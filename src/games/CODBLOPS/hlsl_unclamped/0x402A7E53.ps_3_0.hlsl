// Mechanically reconstructed from 0x402A7E53.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xy = float2(((r5.w) >= 0.0f ? (r2.x) : (r5.x)), ((r5.w) >= 0.0f ? (r2.y) : (r5.y)));
    ...
    r5.xy = (r2.xy) * (r5.xy);
    r2.xyw = c[11].xyw;
    r9.xyz = float3(((r5.w) >= 0.0f ? (r2.x) : (c[10].x)), ((r5.w) >= 0.0f ? (r2.y) : (c[10].y)), ((r5.w) >= 0.0f ? (r2.w) : (c[10].w)));
    r0.w = (r0.w) * (r5.x);
