// Mechanically reconstructed from 0xFCAF13B8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.y = (r1.w) * (-(c14.z)) + (c14.w);
    r4.w = saturate(dot(r0.xyz, -(r9.xyz)));
    r3.z = (r5.w) * (r3.y) + (r6.w);
    r3.y = (r4.w) * (r3.y) + (r6.w);
    r3.w = (r3.w) * (r3.x);
    r6.w = (r3.z) * (r3.y) + (c3.x);
    r3.xyz = (r5.www) * (c[6].xyz);
    r6.w = 1.0f / (r6.w);
    r6.w = (r5.w) * (r6.w);
