// Mechanically reconstructed from 0xCBCEF49A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = dot(r6.xy, r6.xy) + (c12.z);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r1.y = (r1.y) * (c2.y) + (c2.z);
    r1.w = (r1.w) * (c2.y) + (c2.z);
    r3.w = (r1.y) * (r1.w);
    r1.y = dot(r2.xy, r6.xy) + (c12.z);
    r2 = tex2D(s14, v1.zw);
    r5.xy = (r2.xy) * (c3.xx);
    ...
    r2.w = (r4.w) * (r4.w);
    r10.xyz = (v0.zzz) * (r2.xyz) + (c12.www);
    r1.x = (r1.x) * (r2.w);
    r2.xyz = (r10.xyz) * (c2.xxx);
    r8.xyz = (r2.xyz) * (r2.xyz);
    r7.xyz = (r2.xyz) * (-(r2.xyz)) + (c12.www);
    r1.z = (r3.w) * (r1.z);
