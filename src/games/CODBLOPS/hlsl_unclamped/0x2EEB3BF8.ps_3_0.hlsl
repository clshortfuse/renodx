// Mechanically reconstructed from 0x2EEB3BF8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = (v0.zzz) * (r1.xyz) + (c2.www);
    r1.xyz = v2.xyz;
    r1.xyz = (r8.xxx) * (v4.xyz) + (r1.xyz);
    r4.xyz = (r6.xyz) * (c3.xxx);
    ...
    r2.z = (r12.x) * (c13.x);
    r1.x = (r12.x) * (-(c13.x)) + (c13.y);
    r1.y = saturate(dot(r9.xyz, -(r7.xyz)));
    r1.z = (r1.w) * (r1.x) + (r2.z);
    r1.x = (r1.y) * (r1.x) + (r2.z);
    r4.xyz = (r4.xyz) * (-(r4.xyz)) + (c2.www);
    r1.z = (r1.z) * (r1.x) + (c4.w);
