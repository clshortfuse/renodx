// Mechanically reconstructed from 0x3F6B56DA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.w = (r1.w) * (v0.y);
    r3.w = (r2.w) * (r2.z);
    r6.xy = (r5.ww) * (-(r0.xy)) + (r0.xy);
    r0 = tex2D(s5, v1.xy);
    r2 = tex2D(s0, v1.xy);
    r4.xyz = lerp(r2.xyz, r1.xyz, r5.www);
    r3.xyz = lerp(r0.yyy, c[5].xyw, r5.www);
    r2.w = -(r0.w);
    r2.xyz = c1.xxx;
    r1 = tex2D(s6, v8.xy);
    r1 = (r2) + (r1);
    ...
    r4.w = (r0.w) * (v0.z);
    r2 = (r5.wwww) * (r1) + (r2);
    r8.xyz = lerp(r4.xyz, r0.xyz, r4.www);
    r0 = tex2D(s7, v8.zw);
    r1 = lerp(r2, r0, r4.wwww);
    r11.xyz = lerp(r3.xyz, c[6].xyw, r4.www);
