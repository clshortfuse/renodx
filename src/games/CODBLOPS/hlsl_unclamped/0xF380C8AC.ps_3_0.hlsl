// Mechanically reconstructed from 0xF380C8AC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xy = (v0.zw) * (c4.zw);
    r2 = tex2D(s13, r0.xy);
    r0.xy = (v0.zw) * (c6.xy) + (c6.zy);
    r0 = tex2D(s13, r0.xy);
    r2.w = r0.y;
    r3.xy = (r1.wy) * (c0.xy) + (c0.zw);
    r1.xy = (r2.yw) * (c7.xx) + (c7.yy);
