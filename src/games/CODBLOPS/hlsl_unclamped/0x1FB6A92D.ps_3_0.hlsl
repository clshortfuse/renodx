// Mechanically reconstructed from 0x1FB6A92D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xyz = (v0.yyy) * (r0.xyz) + (c35.zzz);
    r3.w = r1.w;
    r3.xyz = (r2.xyz) * (c35.www);
    r0 = tex2D(s0, v1.xy);
    ...
    r10.xy = float2(((r1.x) >= 0.0f ? (r5.x) : (r6.x)), ((r1.x) >= 0.0f ? (r5.y) : (r6.y)));
    r9.xyz = (r2.xyz) * (r2.xyz);
    r15.xyz = (r0.xyz) * (-(r0.xyz)) + (c35.zzz);
    r1.w = dot(r10.xy, r10.xy) + (c3.x);
    r9.w = (r0.w) * (-(c4.y)) + (c4.z);
    r1.w = exp2(-(r1.w));
    r1.z = (r1.w) * (c3.z) + (c3.w);
    r2.xy = (v1.zw) * (c4.zw);
    ...
    r2.w = (r3.x) * (c12.w) + (-(r11.x));
    r1.w = dot(r4.xy, r10.xy) + (c3.x);
    r2.y = (r4.z) * (-(r6.x)) + (r2.w);
    r5.xy = (r2.xz) * (r6.yy);
    ...
    r1.z = (r3.z) * (r1.z);
    r14.xyz = float3(((r1.x) >= 0.0f ? (c[32].x) : (r1.y)), ((r1.x) >= 0.0f ? (c[32].y) : (r1.y)), ((r1.x) >= 0.0f ? (c[32].w) : (r1.y)));
