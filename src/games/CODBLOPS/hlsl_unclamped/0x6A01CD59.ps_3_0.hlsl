// Mechanically reconstructed from 0x6A01CD59.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyz = (r4.www) * (r3.xyz) + (c[36].xyw);
    r3.w = saturate(dot(r9.xyz, r5.xyz));
    r11.xyz = (r2.xyz) * (r3.yyy);
