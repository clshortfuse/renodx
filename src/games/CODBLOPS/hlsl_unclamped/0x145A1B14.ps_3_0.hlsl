// Mechanically reconstructed from 0x145A1B14.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s7, v1.xy);
    r9.xyz = float3(((r4.w) >= 0.0f ? (c[32].x) : (r2.y)), ((r4.w) >= 0.0f ? (c[32].y) : (r2.y)), ((r4.w) >= 0.0f ? (c[32].w) : (r2.y)));
