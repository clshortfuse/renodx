// Mechanically reconstructed from 0xD315FC53.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyz = (r1.xyz) * (r1.xyz) + (-(r3.xyz));
    r2.w = (-(r1.w)) + (c1.x);
    r0.xyz = (v4.www) * (r0.xyz) + (r3.xyz);
    r3.z = (r2.w) * (r2.w);
    r1 = tex2D(s2, v1.xy);
    r3.w = (r1.w) * (c1.y) + (c1.x);
    r2.w = (r2.w) * (r3.z);
