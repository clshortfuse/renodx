// Mechanically reconstructed from 0x099172DB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.w = saturate(dot(r10.xyz, r7.xyz));
    r11.w = (r1.z) * (r3.y);
    r1.xyz = (r12.www) * (c[29].xyz);
    r0.xyz = (r6.www) * (r11.xyz);
    r1.xyz = (r11.www) * (r1.xyz) + (r8.xyz);
    r3 = tex2D(s0, v1.xy);
    r8.xyz = lerp(r3.xyz, r2.xyz, r2.www);
    r2 = tex2D(s5, v7.zw);
    r11.xyz = normalize(v6.xyz);
    r2.xyz = (r2.xyz) + (c14.yyy);
    r3.xyz = (r5.xyz) * (r5.www) + (-(r11.xyz));
    r2.xyz = (v0.zzz) * (r2.xyz) + (c14.xxx);
    ...
    r3.w = (r2.w) * (r2.w);
    r5.z = saturate(dot(r10.xyz, r5.xyz));
    r3.w = (r3.w) * (r3.w);
    r9.w = (r2.w) * (r3.w);
    r8.xyz = (r2.xyz) * (r2.xyz);
    r7.xyz = (r2.xyz) * (-(r2.xyz)) + (c14.xxx);
    r5.w = (r1.w) * (c1.w);
    r3.w = (r1.w) * (-(c3.z)) + (c3.w);
    r7.w = saturate(dot(r10.xyz, -(r11.xyz)));
    r2.z = (r12.w) * (r3.w) + (r5.w);
    r2.w = (r7.w) * (r3.w) + (r5.w);
    r2.z = (r2.z) * (r2.w) + (c4.x);
    r5.xy = (r1.ww) * (c13.xy) + (c13.zw);
    r2.y = 1.0f / (r2.z);
    r8.w = exp2(r5.y);
    r2.z = pow(abs(r5.z), r8.w);
    r6.w = (r8.w) * (c4.y) + (c4.z);
    r5.y = (r12.w) * (r2.y);
    r5.z = (r2.z) * (r6.w);
