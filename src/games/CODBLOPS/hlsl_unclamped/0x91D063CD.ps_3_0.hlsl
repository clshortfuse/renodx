// Mechanically reconstructed from 0x91D063CD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5 = tex2D(s13, r4.xy);
    r3.w = r5.y;
    r1.w = dot(r9.xy, r9.xy) + (c7.y);
    r4.xy = (r3.yw) * (c4.xx) + (c4.yy);
    r1.z = exp2(-(r1.w));
    r1.w = dot(r4.xy, r4.xy) + (c7.y);
    r1.z = (r1.z) * (c7.z) + (c7.w);
    r1.x = exp2(-(r1.w));
    r1.w = dot(r4.xy, r9.xy) + (c7.y);
    r1.x = (r1.x) * (c7.z) + (c7.w);
    r4 = tex2D(s14, v1.zw);
    r10.xy = (r4.xy) * (c2.ww);
    r1.x = (r1.z) * (r1.x);
