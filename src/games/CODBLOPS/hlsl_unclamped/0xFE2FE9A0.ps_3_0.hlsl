// Mechanically reconstructed from 0xFE2FE9A0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = rsqrt(r0.w);
    r1 = v2;
    r4.xyz = (r3.xxx) * (v5.xyz) + (r1.xyz);
    r1.xyz = (r0.www) * (v6.xyz);
    r4.xyz = (r3.yyy) * (v4.xyz) + (r4.xyz);
