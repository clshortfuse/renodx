// Mechanically reconstructed from 0x8D2F041C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c4 = float4(3.5f, 1.0f, 31.875f, 4.0f);
    ...
    r1.x = (r1.w) * (r1.w);
    r6.xyz = (v0.zzz) * (r3.xyz) + (-(c2.yyy));
    r3 = tex2D(s4, v7.xy);
    r3.xyz = (r3.xyz) + (c2.yyy);
    r7.xyz = (r6.xyz) * (c3.xxx);
