// Mechanically reconstructed from 0x663F6361.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r13.xyz = (v0.yyy) * (r0.xyz) + (c1.yyy);
    r4.xyz = (r13.xyz) * (c1.zzz);
    r2 = tex2D(s8, v8.zw);
    ...
    r0 = tex2D(s1, v1.xy);
    r15.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r1.w = rsqrt(r1.w);
    r0 = v2;
    r0.xyz = (r15.xxx) * (v5.xyz) + (r0.xyz);
    r5.xyz = (r6.xyz) * (r1.www);
    r0.xyz = (r15.yyy) * (v4.xyz) + (r0.xyz);
    ...
    r4 = tex2D(s13, r3.xy);
    r2.w = r4.y;
    r14.xyz = (r0.xyz) * (r5.www);
    r0.xy = (r2.yw) * (c13.xx) + (c13.yy);
