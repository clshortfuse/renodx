// Mechanically reconstructed from 0xD9E992F1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s5, v7.xy);
    r2.w = (r0.w) * (v0.y);
    r8.xy = lerp(r3.xy, r2.xy, r2.ww);
    r0.w = dot(r8.xy, r8.xy) + (c40.z);
    r0.w = exp2(-(r0.w));
    r4.xyz = lerp(r1.xyz, r0.xyz, r2.www);
    ...
    r1.z = (r0.w) * (r0.w);
    r0 = tex2D(s6, v7.zw);
    r0.xyz = (r0.xyz) + (c40.yyy);
    r2.w = (r1.w) * (r1.z);
    r0.xyz = (v0.zzz) * (r0.xyz) + (c40.www);
    r1.xyz = (r4.xyz) * (r0.xyz);
    r4.xyz = (r0.xyz) * (c3.xxx);
    r13.xyz = (r4.xyz) * (-(r4.xyz)) + (c40.www);
    r0.xyz = v2.xyz;
    ...
    r1.w = (r2.x) * (c4.x) + (-(r3.x));
    r0.z = dot(r4.xy, r8.xy) + (c40.z);
    r2.w = (r3.z) * (-(r0.x)) + (r1.w);
    r1.xy = (r1.xz) * (r0.yy);
    r0.x = dot(r4.xy, r4.xy) + (c40.z);
    r1.w = (r2.y) * (c4.x) + (-(r1.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r1.z) * (-(r0.y)) + (r1.w);
    r0.x = (r0.x) * (c3.y) + (c3.z);
