// Mechanically reconstructed from 0xFF395716.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.w = (r0.w) * (v0.y) + (c3.w);
    r3.w = (r1.w) * (r1.z);
    r7.xy = float2(((r4.w) >= 0.0f ? (r1.x) : (r2.x)), ((r4.w) >= 0.0f ? (r1.y) : (r2.y)));
    r1 = tex2D(s6, v7.zw);
    ...
    r2.xyz = float3(((r4.w) >= 0.0f ? (r1.y) : (c[23].x)), ((r4.w) >= 0.0f ? (r1.y) : (c[23].y)), ((r4.w) >= 0.0f ? (r1.y) : (c[23].w)));
    r5.xy = lerp(r7.xy, r6.xy, r2.ww);
    r1.xyz = -(r2.xyz);
    r6.xyz = (r3.xyz) * (r3.xyz);
    r1.w = (r1.y) + (-(c3.y));
    r11.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c3.yyy));
    r13.xyz = (r2.www) * (r1.xwz) + (r2.xyz);
