// Mechanically reconstructed from 0xB4AF9CB9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(0.125f, 0.25f, 0.000244140625f, 0.0f);
    const float4 c3 = float4(0.00048828125f, -0.000122070312f, 0.0f, 0.75f);
    const float4 c4 = float4(4.0f, -3.0f, -4.0f, 2.0f);
    const float4 c12 = float4(31.875f, 0.797884583f, 1.0f, 0.0009765625f);
    ...
    r11.w = (r1.w) * (-(c12.y)) + (c12.z);
    r12.w = (r1.w) * (c12.y);
    r9.xyz = normalize(v2.xyz);
    r6.w = saturate(dot(r2.xyz, r9.xyz));
    r0.z = saturate(dot(r9.xyz, -(r3.xyz)));
    r0.y = (r6.w) * (r11.w) + (r12.w);
    r10.w = (r0.z) * (r11.w) + (r12.w);
    r2.xyz = (r13.xyz) * (r3.www) + (r14.xyz);
    ...
    r4.y = (r1.z) * (r0.y);
    r1.w = (r1.w) * (c0.w);
    r1.xyz = (r9.xyz) * (-(r0.zzz)) + (r3.xyz);
    r1 = texCUBElod(s15, r1);
    r0.xyz = (r1.xyz) * (r1.xyz);
    r10.xyz = (r2.xyz) * (r4.yyy);
    r3.xyz = (r0.xyz) * (c0.www);
    r1 = tex3D(s11, v6.xyz);
    r0.xyz = (r1.xyz) * (r1.xyz);
    r2.xyz = (r13.xyz) * (r4.zzz) + (r14.xyz);
    r0.xyz = (r3.xyz) * (r0.xyz);
    r0.xyz = (r0.xyz) * (c12.xxx);
    r1.xyz = (v5.xyz) * (-(r5.www)) + (c[17].xyz);
    r8.xyz = (r2.xyz) * (r0.xyz);
    ...
    r15.yz = c0.yz;
    r7.xyz = float3(((r2.w) >= 0.0f ? (c[37].x) : (r15.z)), ((r2.w) >= 0.0f ? (c[37].y) : (r15.z)), ((r2.w) >= 0.0f ? (c[37].w) : (r15.z)));
    r0.xyz = (r0.xyz) * (r1.www) + (v6.xyz);
    r1 = tex3D(s11, r0.xyz);
    r0.xyz = (r1.xyz) * (r1.xyz);
    r0.xyz = (r7.yyy) * (r0.xyz);
    r7.y = saturate(dot(r9.xyz, c[17].xyz));
    r12.xyz = (r0.xyz) * (c12.xxx);
    r11.xyz = (r7.yyy) * (c[18].xyz);
    if ((c0.y) >= (v4.w))
    {
        r2 = (v4.xyzx) * (c0.yyyz);
        r1 = (r2) + (-(c3.xyzz));
    ...
    r0.z = (r7.y) * (r11.w) + (r12.w);
    r0.z = (r0.z) * (r10.w) + (c12.w);
    r0.z = 1.0f / (r0.z);
    r0.z = (r7.y) * (r0.z);
    r1.z = (r9.w) * (r0.z);
    r0.xyz = (r13.xyz) * (r8.www) + (r14.xyz);
    ...
    r1 = (v5.xxxx) * (c[32]) + (r1);
    r8.xyz = (r8.xyz) * (r7.xxx) + (r0.xyz);
    r1 = (v5.zzzz) * (c[34]) + (r1);
    r0.xyz = (r10.xyz) * (c[23].xyz);
    r4 = (r1) + (c[35]);
    r1.xyz = (r7.zzz) * (r0.xyz);
    r3.zw = r4.zw;
