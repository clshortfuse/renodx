// Mechanically reconstructed from 0x97CF54DF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = tex2D(s4, v1.xy);
    r0 = v2;
    r2.xyz = (r7.xxx) * (v5.xyz) + (r0.xyz);
    r0.x = -(r3.y);
    r2.xyz = (r7.yyy) * (v4.xyz) + (r2.xyz);
    r4.xyz = normalize(r2.xyz);
    r7.xyz = normalize(v6.xyz);
    r0.y = (r0.x) + (c2.x);
    r0.z = dot(r7.xyz, r4.xyz);
    r8.xy = (r1.ww) * (r0.xy) + (r3.yy);
    r0.z = (r0.z) + (r0.z);
    r2.xyz = (r4.xyz) * (-(r0.zzz)) + (r7.xyz);
    ...
    r4.w = (-(r0.z)) + (c2.x);
    r3 = tex2D(s3, v7.zw);
    r0.xyz = (r3.xyz) + (c2.yyy);
    r3.w = (r4.w) * (r4.w);
    r4.xyz = (v0.zzz) * (r0.xyz) + (c2.xxx);
    r0.z = (r4.w) * (r3.w);
    r3.xyz = (r4.xyz) * (c2.zzz);
    r2.w = (r2.w) * (r0.z);
