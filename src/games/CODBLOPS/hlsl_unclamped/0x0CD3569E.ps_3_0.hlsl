// Mechanically reconstructed from 0x0CD3569E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s4, v6.zw);
    r5.w = (r1.w) * (v6.y) + (c1.w);
    r11.xy = (r0.yw) * (c4.xx) + (c4.yy);
    r9.xyz = float3(((r5.w) >= 0.0f ? (r4.x) : (r6.x)), ((r5.w) >= 0.0f ? (r4.y) : (r6.y)), ((r5.w) >= 0.0f ? (r4.z) : (r6.z)));
    ...
    r2.w = (r0.w) * (r1.w);
    r5.xy = (r5.xz) * (r12.yy);
    r0.w = dot(r11.xy, r9.xy) + (c1.z);
    r0.y = (r4.y) * (c3.z) + (-(r5.x));
    r0.w = saturate((r0.w) * (r2.w) + (r2.w));
    r0.y = (r5.z) * (-(r12.y)) + (r0.y);
    r5.xz = (r5.xy) * (c3.ww);
    r5.y = (r0.y) + (r0.y);
    ...
    r6.xyz = (r10.xyz) * (r6.www) + (-(r5.xyz));
    r5.xyz = (r2.xyz) * (c2.zzz);
    r2 = tex2D(s0, v0.xy);
    r3.y = (r9.z) * (c2.w);
    r3.w = (r9.z) * (-(c13.x)) + (c13.y);
    ...
    r0.z = (-(r6.w)) + (-(c1.y));
    r3.z = pow(abs(r0.y), r4.w);
    r0.x = (r0.z) * (r0.z);
    r0.y = (r4.w) * (c13.z) + (c13.w);
    r0.x = (r0.x) * (r0.x);
    r0.y = (r3.z) * (r0.y);
    r0.z = (r0.z) * (r0.x);
    r3.w = (r3.w) * (r0.y);
