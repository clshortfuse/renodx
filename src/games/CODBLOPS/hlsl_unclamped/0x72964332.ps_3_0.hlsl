// Mechanically reconstructed from 0x72964332.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c22 = float4(-1.0f, 1.0f, 0.200000003f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r2 = tex2D(s5, v1.xy);
    r0 = tex2D(s3, v8.xy);
    r0.xyz = (r0.xyz) + (c22.xxx);
    r3.xyz = (v0.yyy) * (r0.xyz) + (c22.yyy);
    r0 = tex2D(s0, v1.xy);
    r1 = tex2D(s4, v8.zw);
    r2.z = (r1.w) * (v0.z);
    ...
    r1 = tex2D(s13, r1.xy);
    r0.w = r1.y;
    r1.w = dot(r6.xy, r6.xy) + (c22.w);
    r4.xy = (r0.wy) * (c4.xx) + (c4.yy);
    r0.y = exp2(-(r1.w));
    r0.w = dot(r4.xy, r4.xy) + (c22.w);
    r2.w = (r0.y) * (c1.x) + (c1.y);
    r0.w = exp2(-(r0.w));
    r1.w = dot(v7.xyz, v7.xyz);
    r0.y = (r0.w) * (c1.x) + (c1.y);
    r0.w = dot(r4.xy, r6.xy) + (c22.w);
    r0.y = (r2.w) * (r0.y);
    r2.x = rsqrt(r1.w);
    ...
    r10.xy = (r0.xz) * (r5.yy);
    r0.y = (r4.x) * (c3.w) + (-(r9.x));
    r0.w = (r4.y) * (c3.w) + (-(r10.x));
    r0.y = (r1.z) * (-(r5.x)) + (r0.y);
    r0.w = (r0.z) * (-(r5.y)) + (r0.w);
    r8.y = (r0.y) + (r0.y);
    r1.xyz = (v7.xyz) * (-(r2.xxx)) + (c[17].xyz);
    r0.y = (r0.w) + (r0.w);
