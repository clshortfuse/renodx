// Mechanically reconstructed from 0xBC912998.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = r4.y;
    r2.xy = (r4.xz) * (r0.xx);
    r4.xy = (r1.wy) * (c12.xx) + (c12.yy);
    r1.w = (r3.x) * (c11.w) + (-(r2.x));
    r0.z = dot(r4.xy, r6.xy) + (c4.x);
    r3.w = (r4.z) * (-(r0.x)) + (r1.w);
    r1.xy = (r1.xz) * (r0.yy);
    r0.x = dot(r4.xy, r4.xy) + (c4.x);
    r1.w = (r3.y) * (c11.w) + (-(r1.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r1.z) * (-(r0.y)) + (r1.w);
