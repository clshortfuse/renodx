// Mechanically reconstructed from 0x5D56A699.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c7 = float4(-1.0f, 1.0f, 0.200000003f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = tex2D(s0, v1.xy);
    r1 = tex2D(s2, v7.xy);
    r1.xyz = (r1.xyz) + (c7.xxx);
    r3.xyz = (v0.yyy) * (r1.xyz) + (c7.yyy);
    r1.xyz = (r0.xyz) * (r3.xyz);
    r0 = tex2D(s3, v7.zw);
    r2.xyz = (r0.xyz) + (c7.xxx);
    r0.xyz = (r3.xyz) * (c7.zzz);
    r2.xyz = (v0.zzz) * (r2.xyz) + (c7.yyy);
    ...
    r1.w = dot(r12.xy, r12.xy) + (c7.w);
    r1.z = dot(r4.xy, r4.xy) + (c7.w);
    r1.w = exp2(-(r1.w));
    r1.z = exp2(-(r1.z));
    r1.w = (r1.w) * (c1.x) + (c1.y);
    r1.x = (r1.z) * (c1.x) + (c1.y);
    r1.z = dot(r4.xy, r12.xy) + (c7.w);
    r1.x = (r1.w) * (r1.x);
    r4 = tex2D(s14, v1.zw);
    r13.xy = (r4.xy) * (c2.ww);
