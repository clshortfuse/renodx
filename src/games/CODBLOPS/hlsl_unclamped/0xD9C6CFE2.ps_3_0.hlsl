// Mechanically reconstructed from 0xD9C6CFE2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = (r1.x) * (r2.w);
    r2.w = saturate((r1.z) * (c[22].x) + (c[22].y));
    r1.z = (r2.w) * (r2.w);
    r2.w = (r2.w) * (c4.x) + (c4.y);
    r1.x = (r2.z) * (r1.x);
    r2.w = (r1.z) * (r2.w);
