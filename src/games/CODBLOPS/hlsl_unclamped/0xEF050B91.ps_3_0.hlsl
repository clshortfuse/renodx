// Mechanically reconstructed from 0xEF050B91.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xz = (r0.xy) * (c3.yy);
    r4.y = (r0.z) + (r0.z);
    r11.xyz = (r7.xyz) * (c1.www);
    r0.xyz = (r4.xyz) * (r0.www) + (r1.xyz);
    r2 = tex2D(s6, v1.xy);
    r3.w = ((r3.w) >= 0.0f ? (c1.y) : (r2.y));
    r2.xyz = (r5.xyz) * (r5.xyz);
    r7.xyz = (r0.xyz) * (r3.www);
    r1 = tex2D(s12, v1.zw);
    r0 = v2;
