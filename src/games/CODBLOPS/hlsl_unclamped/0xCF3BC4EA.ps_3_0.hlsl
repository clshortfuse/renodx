// Mechanically reconstructed from 0xCF3BC4EA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s6, v1.xy);
    r9.xyz = float3(((r4.w) >= 0.0f ? (c[31].x) : (r1.y)), ((r4.w) >= 0.0f ? (c[31].y) : (r1.y)), ((r4.w) >= 0.0f ? (c[31].w) : (r1.y)));
    r2 = (r1.wwww) * (c2.xxxy) + (c2.zzzx);
    r11.xyz = (r4.xyz) * (r9.yyy);
