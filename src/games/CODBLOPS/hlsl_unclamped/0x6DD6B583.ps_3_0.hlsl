// Mechanically reconstructed from 0x6DD6B583.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s2, v6.xy);
    r9.w = (r1.w) * (v0.y);
    r2.xy = lerp(r3.xy, r0.xy, r9.ww);
    r0 = tex2D(s3, v6.zw);
    r8.w = (r0.w) * (v0.z);
    r9.xy = (r8.ww) * (-(r2.xy)) + (r2.xy);
    r2.xyz = v2.xyz;
    ...
    r2 = (r8.wwww) * (r2) + (r6);
    r6.w = lerp(r5.y, r4.y, r9.w);
    r3.w = (r2.w) * (c4.z);
    r3 = texCUBElod(s15, r3);
    r4.xyz = (r3.xyz) * (r3.xyz);
    r7.xy = lerp(r6.ww, c[8].xy, r8.ww);
    r1.w = (-(r1.w)) + (-(c3.y));
    r3.w = (r1.w) * (r1.w);
    r2.w = (r2.w) * (c2.x) + (c2.y);
    r1.w = (r1.w) * (r3.w);
