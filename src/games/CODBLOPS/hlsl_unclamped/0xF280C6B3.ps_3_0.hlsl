// Mechanically reconstructed from 0xF280C6B3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xyz = lerp(r2.yyy, c[29].xyw, r4.www);
    ...
    r0.z = (r0.z) + (r0.z);
    r3 = lerp(r6, r5, r4.wwww);
    r5.xyz = (r10.xyz) * (-(r0.zzz)) + (r14.xyz);
    r5.w = (r3.w) * (c2.z);
    ...
    r6.xyz = (r3.xyz) * (r1.www) + (r9.xyz);
    r5.xyz = (r15.xyz) * (r8.yyy);
