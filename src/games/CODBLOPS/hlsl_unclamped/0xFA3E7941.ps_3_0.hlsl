// Mechanically reconstructed from 0xFA3E7941.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r0.z) * (-(r7.x)) + (r0.w);
    r0.xyw = c[29].xyw;
    r0.xyz = (-(r0.xyw)) + (c[30].xyw);
    r6.y = (r2.w) + (r2.w);
    r3.xyz = (r7.www) * (r0.xyz) + (c[29].xyw);
    r0.xyz = (r6.xyz) * (r1.www) + (r4.xyz);
    r9.xyz = lerp(r3.xyz, c1.xxx, r6.www);
    r14.xyz = (r0.xyz) * (r9.yyy);
