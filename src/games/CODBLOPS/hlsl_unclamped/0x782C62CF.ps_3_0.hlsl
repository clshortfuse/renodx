// Mechanically reconstructed from 0x782C62CF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyz = (r15.xyz) * (r1.www) + (r16.xyz);
    r4.xyz = (r5.yyy) * (v3.xyz) + (r2.xyz);
    r2.xyw = c[32].xyw;
    r2.xyz = (-(r2.xyw)) + (c[33].xyw);
    r17.xyz = normalize(r4.xyz);
    r4.y = saturate(dot(r17.xyz, r3.xyz));
    r10.w = (r0.w) * (c4.w);
    r2.w = saturate(dot(r8.xyz, r17.xyz));
    r1.w = saturate(dot(r17.xyz, -(r7.xyz)));
    r3.z = (r2.w) * (r9.w) + (r10.w);
    r8.w = (r1.w) * (r9.w) + (r10.w);
    r3.z = (r3.z) * (r8.w) + (c12.w);
    r3.xy = (r0.ww) * (c36.xy) + (c36.zw);
    r4.z = 1.0f / (r3.z);
    r7.w = exp2(r3.y);
    r3.z = pow(abs(r4.y), r7.w);
    r5.w = (r7.w) * (c13.z) + (c13.w);
    r3.y = (r2.w) * (r4.z);
    r3.z = (r3.z) * (r5.w);
    r2.xyz = (r6.www) * (r2.xyz) + (c[32].xyw);
    r3.z = (r3.y) * (r3.z);
