// Mechanically reconstructed from 0x257B836F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s14, v1.zw);
    r4.xy = (r2.xy) * (c1.ww);
    r7.xy = (r3.yw) * (c32.xx) + (c32.yy);
    r6.xy = (r3.xz) * (r4.xx);
    r0.w = dot(r7.xy, r5.xy) + (c3.z);
    r0.y = (r2.x) * (c1.w) + (-(r6.x));
    r2.w = (r3.z) * (-(r4.x)) + (r0.y);
    r3.xy = (r0.xz) * (r4.yy);
    r0.y = (r2.y) * (c1.w) + (-(r3.x));
