// Mechanically reconstructed from 0xE50575BC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r14.xyz = (v0.yyy) * (r1.xyz) + (c1.yyy);
    r0 = tex2D(s5, v8.zw);
    r1.xyz = (r0.xyz) + (c1.xxx);
    r0.xyz = (r14.xyz) * (c1.zzz);
    r13.xyz = (v0.zzz) * (r1.xyz) + (c1.yyy);
    r11.xyz = (r2.xyz) * (r1.www);
    r2.xyz = (r0.xyz) * (r13.xyz);
    r0 = tex2D(s6, v9.xy);
    ...
    r1.x = dot(r3.xy, r3.xy) + (c1.w);
    r0.z = dot(r0.xy, r0.xy) + (c1.w);
    r1.x = exp2(-(r1.x));
    r0.z = exp2(-(r0.z));
    r1.x = (r1.x) * (c2.x) + (c2.y);
    r2.w = (r0.z) * (c2.x) + (c2.y);
    r0.z = dot(r0.xy, r3.xy) + (c1.w);
    r0.y = (r1.x) * (r2.w);
    r3 = tex2D(s14, v1.zw);
    r8.xy = (r3.xy) * (c3.ww);
