// Mechanically reconstructed from 0xE74BA845.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(0.200000003f, -1.0f, 1.0f, 0.797884583f);
    ...
    r8.xyz = lerp(r0.xyz, c1.xxx, r1.xxx);
    r7.xyz = (v0.yyy) * (r2.xyz) + (c1.zzz);
    r2 = tex2D(s4, v6.zw);
    r6.xyz = (r2.xyz) + (c1.yyy);
    r2.xyz = (r8.xyz) * (r7.xyz);
    r6.xyz = (v0.zzz) * (r6.xyz) + (c1.zzz);
    r0.w = (r1.z) * (r1.y);
    r2.xyz = (r2.xyz) * (r6.xyz);
    r0.xyz = (r1.xxx) * (r0.xyz);
    r1.xyz = (r2.xyz) * (-(r2.xyz)) + (c1.zzz);
