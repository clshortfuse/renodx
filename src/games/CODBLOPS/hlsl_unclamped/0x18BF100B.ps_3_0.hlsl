// Mechanically reconstructed from 0x18BF100B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = (r1.y) * (r1.z);
    r13.xyz = lerp(r2.yyy, c[29].xyw, r5.www);
    r0.xyz = (r0.xyz) * (r1.zzz);
    r17.xyz = (r5.xyz) * (r13.yyy);
