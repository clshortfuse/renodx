// Mechanically reconstructed from 0x133D919B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c10 = float4(0.00048828125f, -0.000122070312f, -0.0f, -4.0f);
    ...
    r0.y = (r1.x) * (r0.y) + (r1.z);
    r1.z = (r0.y) * (r0.x) + (c3.z);
    r0.xy = (r1.ww) * (c8.xy) + (c8.zw);
    r2.w = 1.0f / (r1.z);
    r0.y = exp2(r0.y);
    r1.z = pow(abs(r2.y), r0.y);
    r0.y = (r0.y) * (c4.x) + (c4.y);
    r2.w = (r1.x) * (r2.w);
    r0.y = (r1.z) * (r0.y);
    r1.z = (r2.z) * (c3.x) + (c3.y);
    ...
    r4.xyz = (r1.xxx) * (r9.xyz) + (r10.xyz);
    r5.xyz = (r1.xxx) * (r0.xyz);
    r2 = tex2D(s0, v1.xy);
    r0.z = dot(r8.xyz, r7.xyz);
    r0.z = (r0.z) + (r0.z);
    r3.w = (r1.w) * (c1.x);
    r3.xyz = (r7.xyz) * (-(r0.zzz)) + (r8.xyz);
