// Mechanically reconstructed from 0x6AD32162.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r1.w) * (r1.w);
    r0 = tex2D(s1, v1.xy);
    r3.xyz = (r0.wwy) * (c0.zyy) + (c0.wzz);
    r0 = tex2D(s0, v1.xy);
    r3.w = (r0.w) * (v0.w) + (c0.x);
    r1.w = (r1.w) * (r2.w);
    r5.xyz = float3(((r3.w) >= 0.0f ? (r3.x) : (c0.z)), ((r3.w) >= 0.0f ? (r3.y) : (c0.y)), ((r3.w) >= 0.0f ? (r3.z) : (c0.z)));
