// Mechanically reconstructed from 0xE4867B13.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4 = tex2D(s5, v7.zw);
    r7.w = (r4.w) * (v0.z) + (c1.w);
    r4.w = ((r7.w) >= 0.0f ? (r0.y) : (r3.y));
    r2 = (r0.wwww) * (c3.xxxy) + (c3.zzzx);
    r12.xyz = (r1.xyz) * (r4.www);
    r1 = tex2D(s12, v1.zw);
    r0 = v2;
    ...
    r5 = tex2D(s0, v1.xy);
    r6 = tex2D(s4, v7.xy);
    r3.xyz = (r6.xyz) + (c1.xxx);
    r3.xyz = (v0.yyy) * (r3.xyz) + (c1.yyy);
    r6.xyz = (r1.yyy) * (r0.xyz) + (r12.xyz);
    r0.xyz = (r5.xyz) * (r3.xyz);
    r3.xyz = (r3.xyz) * (c1.zzz);
    r0.xyz = float3(((r7.w) >= 0.0f ? (r4.x) : (r0.x)), ((r7.w) >= 0.0f ? (r4.y) : (r0.y)), ((r7.w) >= 0.0f ? (r4.z) : (r0.z)));
    ...
    r4.xyz = (r0.xyz) * (r6.xyz) + (r1.xyz);
    r1.z = (r2.w) + (r2.w);
    r1.xyz = (r10.xyz) * (-(r1.zzz)) + (r3.xyz);
    r3.xyz = (r11.xyz) * (r11.www) + (-(r3.xyz));
