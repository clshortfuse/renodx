// Mechanically reconstructed from 0x8BF2FAE6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xyz = (r10.www) * (r2.xyz) + (c[29].xyw);
    ...
    r7.xyz = (r2.xyz) * (-(r2.xyz)) + (c0.xxx);
    r0.z = (r7.w) * (r0.z);
    r2.xyz = (r7.xyz) * (r0.xxx) + (r8.xyz);
