// Mechanically reconstructed from 0xD196C2AC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = (r2.zzz) * (v7.xyz);
    r7.w = (r1.w) * (r2.w);
    r10.w = saturate(dot(r9.xyz, -(r6.xyz)));
    ...
    r0.z = (r1.w) * (-(c1.w)) + (c1.z);
    r0.x = (r1.w) * (c1.w);
    r0.y = (r10.w) * (r0.z) + (r0.x);
    r1.xy = (r1.ww) * (c4.xy) + (c4.zw);
    r1.z = exp2(r1.y);
    r0.z = (r8.w) * (r0.z) + (r0.x);
    r0.x = pow(abs(r9.w), r1.z);
    r0.z = (r0.z) * (r0.y) + (c3.x);
    r0.y = (r1.z) * (c3.y) + (c3.z);
    r0.z = 1.0f / (r0.z);
    r1.z = (r0.x) * (r0.y);
    r1.y = (r8.w) * (r0.z);
    r0.xyz = (r2.xyz) * (r7.www) + (r4.xyz);
    r1.y = (r1.z) * (r1.y);
    r1.z = 1.0f / (r1.x);
    r0.xyz = (r0.xyz) * (r1.yyy);
    r3.w = (r6.w) * (r1.z);
    r0.xyz = (r0.xyz) * (c[22].www);
    r1.w = (r1.w) * (c1.x);
    r1.xyz = (r9.xyz) * (-(r3.zzz)) + (r6.xyz);
