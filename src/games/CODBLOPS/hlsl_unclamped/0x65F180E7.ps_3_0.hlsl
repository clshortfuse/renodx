// Mechanically reconstructed from 0x65F180E7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c27 = float4(4.0f, -2.0f, 0.797884583f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r2 = tex2D(s7, v1.xy);
    r0 = tex2D(s8, v8.xy);
    r7.xy = (r4.ww) * (-(r3.xy)) + (r3.xy);
    r1 = lerp(r2, r0, r4.wwww);
    r0.w = dot(r7.xy, r7.xy) + (c3.z);
    r11.w = (r1.w) * (-(c27.z)) + (c27.w);
    r2.w = exp2(-(r0.w));
    r0 = tex2D(s5, v8.zw);
    r0.xyz = (r0.xyz) + (c3.xxx);
    r4.z = (r2.w) * (c1.x) + (c1.y);
    r6.xyz = (v0.zzz) * (r0.xyz) + (c3.yyy);
    ...
    r2 = tex2D(s14, v1.zw);
    r8.xy = (r2.xy) * (c1.ww);
    r9.xy = (r0.wy) * (c27.xx) + (c27.yy);
    r3.xy = (r3.xz) * (r8.xx);
    r0.w = dot(r9.xy, r7.xy) + (c3.z);
    r0.y = (r2.x) * (c1.w) + (-(r3.x));
    r2.w = (r3.z) * (-(r8.x)) + (r0.y);
    r4.xy = (r0.xz) * (r8.yy);
    r0.y = (r2.y) * (c1.w) + (-(r4.x));
    r0.x = dot(r9.xy, r9.xy) + (c3.z);
    r0.y = (r0.z) * (-(r8.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r8.y = (r2.w) + (r2.w);
    r0.z = (r0.z) * (c1.x) + (c1.y);
    ...
    r0 = tex2D(s6, v9.xy);
    r0.xyz = (r0.xyz) + (c3.xxx);
    r2.xyz = (r8.xyz) * (r4.zzz) + (r2.xyz);
    r4.xyz = (v0.www) * (r0.xyz) + (c3.yyy);
    ...
    r2.xyz = (r2.www) * (r15.xyz) + (r16.xyz);
    r0.z = (-(r14.w)) + (c3.y);
    r0.x = 1.0f / (r17.x);
    r0.y = (r0.z) * (r0.z);
    r0.y = (r0.z) * (r0.y);
    r0.z = dot(r1.xyz, r14.xyz);
    r3.w = (r0.x) * (r0.y);
    r0.z = (r0.z) + (r0.z);
    r1.w = (r1.w) * (c3.w);
    r1.xyz = (r14.xyz) * (-(r0.zzz)) + (r1.xyz);
    r1 = texCUBElod(s15, r1);
    r0.xyz = (v7.xyz) * (-(r13.www)) + (c[17].xyz);
    ...
    r1.w = (r1.w) * (r10.w) + (c14.x);
    r3.z = saturate(dot(r14.xyz, r3.xyz));
    r1.y = 1.0f / (r1.w);
