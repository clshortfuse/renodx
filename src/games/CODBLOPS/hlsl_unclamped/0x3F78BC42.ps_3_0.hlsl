// Mechanically reconstructed from 0x3F78BC42.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r7.w = (r0.w) * (v0.w) + (c0.x);
    r3.xy = float2(((r7.w) >= 0.0f ? (r1.x) : (c0.z)), ((r7.w) >= 0.0f ? (r1.y) : (c0.z)));
    r1 = v2;
    ...
    r2.w = c0.z;
    r5.xyz = float3(((r7.w) >= 0.0f ? (c[30].x) : (r2.w)), ((r7.w) >= 0.0f ? (c[30].y) : (r2.w)), ((r7.w) >= 0.0f ? (c[30].w) : (r2.w)));
    r5.w = 1.0f / (r7.x);
