// Mechanically reconstructed from 0x4C162475.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xyz = (r7.xyz) * (r4.www) + (r5.xyz);
    r0.xyz = (r2.xyz) * (r0.xyz);
    r14.xyz = (r1.xyz) * (c[5].yyy);
    ...
    r0.z = (r1.w) * (c4.z);
    r4.w = saturate(dot(r1.xyz, r4.xyz));
    r0.y = (r7.w) * (r5.z) + (r0.z);
