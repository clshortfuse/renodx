// Mechanically reconstructed from 0x0AFA8C0F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.z = saturate(dot(r10.xyz, r0.xyz));
    r0.xy = (r2.ww) * (c2.xy) + (c2.zw);
    r4.w = exp2(r0.y);
    r2.z = 1.0f / (r0.x);
    r0.z = pow(abs(r4.z), r4.w);
    r0.w = (r4.w) * (c3.x) + (c3.y);
    r0.w = (r0.z) * (r0.w);
    r4.w = max(abs(r10.y), abs(r10.z));
    r1.w = (r1.w) * (r0.w);
    r0.w = max(abs(r10.x), r4.w);
    r0.w = 1.0f / (r0.w);
