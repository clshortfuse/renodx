// Mechanically reconstructed from 0xDA0B1905.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = (r2.w) * (r5.w) + (c12.x);
    r2.xyz = (v5.xyz) * (-(r1.xxx)) + (c[17].xyz);
    r0.z = 1.0f / (r0.z);
    r8.w = (-(r1.z)) + (c1.z);
    r1.x = (r1.w) * (r0.z);
    ...
    r2.w = 1.0f / (r14.x);
    r14.xyz = (r1.www) * (r0.xyz);
    r0.xyz = (r6.xxx) * (r2.xyz);
    r2.xyz = (r6.yyy) * (r14.xyz);
    r0.xyz = (r13.xyz) * (r0.xyz);
