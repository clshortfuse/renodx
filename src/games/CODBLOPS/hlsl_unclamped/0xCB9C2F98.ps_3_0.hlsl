// Mechanically reconstructed from 0xCB9C2F98.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = dot(r12.xy, r12.xy) + (c2.w);
    r1.z = dot(r4.xy, r4.xy) + (c2.w);
    r1.w = exp2(-(r1.w));
    r1.z = exp2(-(r1.z));
    r1.w = (r1.w) * (c1.x) + (c1.y);
    r1.x = (r1.z) * (c1.x) + (c1.y);
    r1.z = dot(r4.xy, r12.xy) + (c2.w);
    r1.x = (r1.w) * (r1.x);
    r4 = tex2D(s14, v0.zw);
    r13.xy = (r4.xy) * (c3.ww);
