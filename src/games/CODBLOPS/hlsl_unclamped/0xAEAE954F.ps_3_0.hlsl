// Mechanically reconstructed from 0xAEAE954F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = (r0.wy) * (c11.xx) + (c11.yy);
    r0.y = dot(r8.xy, r8.xy) + (c20.z);
    r0.w = dot(r4.xy, r4.xy) + (c20.z);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r3.w = (r0.y) * (c3.x) + (c3.y);
    r0.y = (r0.w) * (c3.x) + (c3.y);
    r0.w = dot(r4.xy, r8.xy) + (c20.z);
    r0.y = (r3.w) * (r0.y);
    ...
    r6.w = (r1.w) * (r1.w);
    r3.xyz = (v0.zzz) * (r0.xyz) + (c20.www);
    r0 = tex2D(s7, v1.xy);
    r1 = tex2D(s5, v8.xy);
    r1.xyz = (r1.xyz) + (c20.yyy);
    r0.xyz = (r3.xyz) * (r0.xyz);
    r5.xyz = (v0.www) * (r1.xyz) + (c20.www);
    r1.w = (r2.w) * (r6.w);
