// Mechanically reconstructed from 0x5FBCB054.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s8, v7.zw);
    r11.xy = lerp(r1.xy, r0.wy, r4.ww);
    r0.w = dot(r3.xy, r3.xy) + (c3.w);
    r7.xyz = (r2.xyz) * (r2.xyz);
    r0.w = exp2(-(r0.w));
    r3.z = (r11.x) * (-(c10.z)) + (c10.w);
    r3.w = (r0.w) * (c4.x) + (c4.y);
