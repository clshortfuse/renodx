// Mechanically reconstructed from 0xAF0ED4EC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.y = max(abs(r4.y), abs(r4.z));
    r1.w = saturate((r0.w) * (c[33].x) + (c[33].y));
    r0.w = max(abs(r4.x), r1.y);
    r0.w = 1.0f / (r0.w);
    ...
    r0.z = (r0.z) * (r3.w) + (c1.x);
    r0.z = 1.0f / (r0.z);
    r3.xyz = (r3.xyz) * (r6.www) + (-(r11.xyz));
    r8.y = (r1.w) * (r0.z);
    r1.xyz = normalize(r3.xyz);
    r3.xyz = (r1.www) * (c[30].xyz);
