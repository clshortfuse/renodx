// Mechanically reconstructed from 0xE760D0DC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5 = tex2D(s13, r0.xy);
    r3.w = r5.y;
    r0.xy = (r3.yw) * (c6.xx) + (c6.yy);
    r2.w = dot(r4.xy, r4.xy) + (c8.z);
    r0.z = dot(r0.xy, r0.xy) + (c8.z);
    r2.w = exp2(-(r2.w));
    r0.z = exp2(-(r0.z));
    r2.w = (r2.w) * (c1.x) + (c1.y);
    r2.z = (r0.z) * (c1.x) + (c1.y);
    r0.z = dot(r0.xy, r4.xy) + (c8.z);
    r0.y = (r2.w) * (r2.z);
    r4 = tex2D(s14, v0.zw);
    r11.xy = (r4.xy) * (c3.ww);
