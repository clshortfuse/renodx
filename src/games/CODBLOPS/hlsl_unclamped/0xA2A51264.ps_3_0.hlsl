// Mechanically reconstructed from 0xA2A51264.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c30 = float4(2.0f, -1.0f, 0.0f, -0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r3.y = dot(r1.xy, r0.zw) + (c30.z);
    r3.x = dot(r1.xy, r0.xy) + (c30.z);
    r0 = tex2D(s1, v1.xy);
    ...
    r2 = tex2D(s13, r2.xy);
    r4.w = r2.y;
    r10.xy = lerp(r5.xy, r3.xy, r5.ww);
    r6.xy = (r4.yw) * (c12.xx) + (c12.yy);
    r3 = tex2D(s14, v1.zw);
    r7.xy = (r3.xy) * (c4.ww);
    r1.w = dot(r6.xy, r10.xy) + (c30.z);
    r4.xy = (r4.xz) * (r7.xx);
    r0.w = (r3.x) * (c4.w) + (-(r4.x));
    r5.xy = (r2.xz) * (r7.yy);
    r0.w = (r4.z) * (-(r7.x)) + (r0.w);
    ...
    r2.z = (r2.z) * (-(r7.y)) + (r2.w);
    r8.y = (r0.w) + (r0.w);
    r0.w = dot(r10.xy, r10.xy) + (c30.z);
    r2.w = dot(r6.xy, r6.xy) + (c30.z);
    r0.w = exp2(-(r0.w));
    r2.w = exp2(-(r2.w));
    r0.w = (r0.w) * (c3.x) + (c3.y);
    r2.w = (r2.w) * (c3.x) + (c3.y);
    ...
    r0 = tex2D(s9, v7.xy);
    r13.xyz = lerp(c[27].xyw, r0.yyy, r5.www);
    r1 = (r0.wwww) * (-(c30.zzzy)) + (-(c30.wwwz));
    r2 = tex2D(s8, v1.xy);
    r0 = tex2D(s5, v7.zw);
    r4.xyz = (r0.xyz) + (c30.yyy);
    r0 = lerp(r2, r1, r5.wwww);
    r4.xyz = (v0.zzz) * (r4.xyz) + (-(c30.yyy));
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (-(c30.y)) : (-(c30.z)));
