// Mechanically reconstructed from 0x104B3DAB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.yz = c1.yz;
    r7.xy = float2(((r2.w) >= 0.0f ? (r0.y) : (c[5].x)), ((r2.w) >= 0.0f ? (r0.z) : (c[5].y)));
    r1 = tex2D(s3, v7.zw);
    r0 = v2;
    ...
    r4.w = (r4.w) * (r6.w);
    r5.w = 1.0f / (r5.w);
    r8.xy = float2(((r1.w) >= 0.0f ? (c1.y) : (r7.x)), ((r1.w) >= 0.0f ? (c1.z) : (r7.y)));
    r5.w = (r4.w) * (r5.w);
