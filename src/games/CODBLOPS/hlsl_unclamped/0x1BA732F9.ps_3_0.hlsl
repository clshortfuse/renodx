// Mechanically reconstructed from 0x1BA732F9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r0.z) * (-(r5.x)) + (r1.w);
    r0.z = c1.x;
    r0.xyz = (r0.zzz) + (-(c[24].xyw));
    r8.y = (r1.w) + (r1.w);
    r1.xyz = (r3.www) * (r0.xyz) + (c[24].xyw);
    r0.xyz = (r8.xyz) * (r0.www) + (r4.xyz);
    r5.xyz = lerp(r1.xyz, c1.xxx, r2.www);
    ...
    r4 = tex2D(s0, v1.xy);
    r9.xyz = lerp(r4.xyz, r3.xyz, r3.www);
    r3 = tex2D(s5, v8.xy);
    r0.xyz = (r3.xyz) + (c1.yyy);
    r3.xyz = lerp(r9.xyz, r2.xyz, r2.www);
    r4.xyz = (v0.www) * (r0.xyz) + (c1.xxx);
    r0.xyz = (r1.www) * (c[18].xyz);
    r2.xyz = (r3.xyz) * (r4.xyz);
    r0.xyz = (r1.yyy) * (r0.xyz) + (r6.xyz);
    ...
    r1.z = (r1.w) * (r6.w) + (r7.w);
    r4.w = (r1.x) * (r6.w) + (r7.w);
    r10.xyz = (v6.xyz) * (-(r3.www)) + (c[17].xyz);
    r1.z = (r1.z) * (r4.w) + (c3.x);
    r5.w = (-(r1.x)) + (c1.x);
    r1.z = 1.0f / (r1.z);
    r1.x = (r1.w) * (r1.z);
