// Mechanically reconstructed from 0x6B42FE4E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.x = dot(r2.xy, r1.xy) + (c2.w);
    r4.y = dot(r2.xy, r1.zw) + (c2.w);
    r2 = tex2D(s2, v6.xy);
    r2.w = (r2.w) * (v0.y);
    r1.xy = (r0.yw) * (c4.xx) + (c4.yy);
    r5.xy = lerp(r6.xy, r4.xy, r2.ww);
    ...
    r10.xy = lerp(r1.yy, c[8].xy, r2.ww);
    r0.w = (r0.w) + (r0.w);
    r7.xyz = (r0.xyz) * (r10.yyy);
    r4.xyz = (r3.xyz) * (-(r0.www)) + (r9.xyz);
    r5 = tex2D(s7, v6.xy);
    r6.w = r1.w;
    r0 = tex2D(s0, v1.xy);
    ...
    r6.xyz = (r10.xxx) * (r4.xyz);
    r1.w = (-(r1.w)) + (-(c2.y));
    r1.y = (r1.w) * (r1.w);
    r1.z = (r3.w) * (c10.x) + (c10.y);
    r1.w = (r1.w) * (r1.y);
    r1.z = 1.0f / (r1.z);
    r4 = tex2D(s4, v7.xy);
    r5 = tex2D(s3, v6.zw);
    ...
    r5.xyz = (v0.zzz) * (r5.xyz) + (-(c2.yyy));
    r4.xyz = (v0.www) * (r4.xyz) + (-(c2.yyy));
    r3.xyz = (r3.xyz) * (r5.xyz);
    r1.w = (r1.w) * (r1.z);
    r9.xyz = (r4.xyz) * (r3.xyz);
    r10.xyz = (r9.xyz) * (-(r9.xyz)) + (-(c2.yyy));
    r3.xyz = (r0.xyz) * (-(r1.xxx)) + (r2.xyz);
    r2.xyz = (r1.www) * (r10.xyz);
    r3.xyz = (r2.www) * (r3.xyz);
    r2.xyz = (r9.xyz) * (r9.xyz) + (r2.xyz);
