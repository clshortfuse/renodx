// Mechanically reconstructed from 0x8B2B7E13.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = rsqrt(r1.w);
    r4.xyz = (v0.www) * (r2.xyz) + (c1.yyy);
    r8.xyz = (v6.xyz) * (-(r1.xxx)) + (c[17].xyz);
