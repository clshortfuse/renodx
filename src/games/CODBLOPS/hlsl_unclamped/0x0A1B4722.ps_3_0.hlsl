// Mechanically reconstructed from 0x0A1B4722.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = (r3.yw) * (c13.yy) + (c13.zz);
    r1.w = dot(r5.xy, r5.xy) + (c4.x);
    r1.y = dot(r2.xy, r2.xy) + (c4.x);
    r1.w = exp2(-(r1.w));
    r1.y = exp2(-(r1.y));
    r1.w = (r1.w) * (c4.y) + (c4.z);
    r2.w = (r1.y) * (c4.y) + (c4.z);
    r1.y = dot(r2.xy, r5.xy) + (c4.x);
    r3.w = (r1.w) * (r2.w);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c13.xx);
    r2.w = saturate((r1.y) * (r3.w) + (r3.w));
    r3.xy = (r3.xz) * (r7.xx);
    r1.y = (r2.x) * (c13.x) + (-(r3.x));
    r6.xy = (r1.xz) * (r7.yy);
    r1.y = (r3.z) * (-(r7.x)) + (r1.y);
    r1.x = (r2.y) * (c13.x) + (-(r6.x));
    r1.z = (r1.z) * (-(r7.y)) + (r1.x);
    r10.y = (r1.y) + (r1.y);
    r1.y = (r1.z) + (r1.z);
    r1.xz = (r6.xy) * (c13.yy);
    ...
    r10.xz = (r3.xy) * (c13.yy);
    r3.xyz = lerp(r4.xyz, r0.xyz, r6.zzz);
    r0.xyz = (r10.xyz) * (r1.www) + (r1.xyz);
    r6.w = c3.w;
    r2.xyz = float3(((r0.w) >= 0.0f ? (r6.w) : (c[23].x)), ((r0.w) >= 0.0f ? (r6.w) : (c[23].y)), ((r0.w) >= 0.0f ? (r6.w) : (c[23].w)));
    r1.xyz = (v6.xyz) * (-(r5.www)) + (c[17].xyz);
    r13.xyz = lerp(r2.xyz, c[24].xyw, r6.zzz);
    r4.xyz = normalize(r1.xyz);
    r14.xyz = (r0.xyz) * (r13.yyy);
    r3.w = saturate(dot(r4.xyz, c[17].xyz));
    r2 = tex2D(s7, v1.xy);
    r1 = tex2D(s8, v7.zw);
    r0 = lerp(r2, r1, r6.zzzz);
    r1 = tex2D(s5, v8.xy);
    r1.xyz = (r1.xyz) + (c3.yyy);
    r1.w = (-(r3.w)) + (c3.w);
    r1.xyz = (v0.www) * (r1.xyz) + (c3.www);
    r2.w = (r1.w) * (r1.w);
