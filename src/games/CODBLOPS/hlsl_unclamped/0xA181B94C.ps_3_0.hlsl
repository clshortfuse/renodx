// Mechanically reconstructed from 0xA181B94C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xy = float2(((r3.w) >= 0.0f ? (r4.x) : (c0.z)), ((r3.w) >= 0.0f ? (r4.y) : (c0.z)));
    ...
    r2 = float4(((r3.z) >= 0.0f ? (r2.x) : (c0.z)), ((r3.z) >= 0.0f ? (r2.y) : (c0.z)), ((r3.z) >= 0.0f ? (r2.z) : (c0.z)), ((r3.z) >= 0.0f ? (r2.w) : (c0.z)));
    r9.xyz = normalize(r1.xyz);
    r3.xyz = float3(((r3.w) >= 0.0f ? (c[28].x) : (r2.w)), ((r3.w) >= 0.0f ? (c[28].y) : (r2.w)), ((r3.w) >= 0.0f ? (c[28].w) : (r2.w)));
