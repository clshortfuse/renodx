// Mechanically reconstructed from 0xB4973A77.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s3, v6.xy);
    r8.w = (r2.w) * (v0.y);
    r6.xy = (r8.ww) * (-(r3.xy)) + (r1.xy);
    r1 = tex2D(s4, v6.zw);
    r7.w = (r1.w) * (v0.z);
    r0.w = r4.y;
    r6.xy = (r6.xy) * (r7.ww);
    r8.xy = (r0.yw) * (c12.xx) + (c12.yy);
    r7.xy = (r8.ww) * (r3.xy) + (r6.xy);
    r0.w = dot(r8.xy, r8.xy) + (c16.w);
    r0.y = dot(r7.xy, r7.xy) + (c16.w);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c3.x) + (c3.y);
    r9.w = (r0.y) * (c3.x) + (c3.y);
    ...
    r8.y = (r0.w) + (r0.w);
    r3.xyz = (r8.www) * (r0.xyz) + (c16.zzz);
    r0 = tex2D(s8, v6.zw);
    r6.xyz = lerp(r3.xyz, r0.yyy, r7.www);
    r0.xyz = v2.xyz;
    ...
    r0 = tex2D(s7, v6.xy);
    r0 = (r0) + (c16.wwwy);
    r6.w = dot(r7.xyz, r12.xyz);
    r4 = (r8.wwww) * (r0) + (c16.wwwz);
    r6.w = (r6.w) + (r6.w);
    r0 = lerp(r4, r3, r7.wwww);
    r3.xyz = (r12.xyz) * (-(r6.www)) + (r7.xyz);
    r3.w = (r0.w) * (c2.w);
    ...
    r3 = tex2D(s0, v1.xy);
    r14.xyz = lerp(r3.xyz, r2.xyz, r8.www);
    r3.w = (r3.w) * (-(v0.x)) + (c16.z);
    r4.w = (r2.w) * (-(v0.y)) + (c16.z);
    r0.xyz = lerp(r14.xyz, r1.xyz, r7.www);
    r2.xyz = (r13.xyz) * (r5.www) + (-(r7.xyz));
    ...
    r2.w = pow(abs(r3.z), r6.y);
    r1.x = (r6.y) * (c14.z) + (c14.w);
    r2.z = (r0.w) * (c3.z);
