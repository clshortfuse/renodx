// Mechanically reconstructed from 0x8B9AB710.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = (r0.z) + (r0.z);
    r2.xyz = (r1.xyz) * (r0.www) + (-(r14.xyz));
    r5.xyz = normalize(r2.xyz);
    r10.xyz = (r1.xyz) * (r0.www);
    r0.xz = (r3.xy) * (c4.ww);
    r0.w = saturate(dot(r5.xyz, r10.xyz));
    ...
    r13.w = saturate(dot(r13.xyz, -(r14.xyz)));
    ...
    r2.xyz = (r0.xyz) * (c[24].www);
    r1.xyz = (r3.www) * (c[6].xyz);
    r0.xyz = (r8.xyz) * (r2.www) + (r3.xyz);
    r7.xyz = (r9.xyz) * (r1.xyz) + (r2.xyz);
