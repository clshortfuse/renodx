// Mechanically reconstructed from 0x7E9BA160.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = (r6.w) * (r5.y) + (r5.x);
    r5.z = (r0.z) * (r5.y) + (r5.x);
    r2.xyz = (r13.xyz) * (r4.www) + (r14.xyz);
    r0.y = (r0.y) * (r5.z) + (c12.w);
    r0.y = 1.0f / (r0.y);
    r0.z = (-(r0.z)) + (c0.y);
    r1.z = (r6.w) * (r0.y);
    r0.y = (r0.z) * (r0.z);
    ...
    r0.y = (r1.y) * (r5.z) + (c12.w);
    r0.z = pow(abs(r1.z), r5.w);
    r0.y = 1.0f / (r0.y);
    r0.z = (r4.w) * (r0.z);
    r0.y = (r2.w) * (r0.y);
    r8.w = (r0.z) * (r0.y);
    ...
    r15.yz = c0.yz;
    r7.xyz = float3(((r3.w) >= 0.0f ? (c[38].x) : (r15.z)), ((r3.w) >= 0.0f ? (c[38].y) : (r15.z)), ((r3.w) >= 0.0f ? (c[38].w) : (r15.z)));
    r0.xyz = (r0.xyz) * (r1.www) + (v6.xyz);
    r1 = tex3D(s11, r0.xyz);
    r0.xyz = (r1.xyz) * (r1.xyz);
    r1.xyz = (r7.yyy) * (r0.xyz);
    r16.xy = c[36].xy;
    r0.xyz = (r16.xxx) * (c[18].xyz);
    r12.xyz = (r1.xyz) * (c12.xxx);
    r11.xyz = (r2.www) * (r0.xyz);
    if ((c0.y) >= (v4.w))
    {
        r2 = (v4.xyzx) * (c0.yyyz);
        r1 = (r2) + (-(c3.xyzz));
