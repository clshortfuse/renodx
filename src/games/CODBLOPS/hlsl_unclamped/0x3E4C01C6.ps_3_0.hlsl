// Mechanically reconstructed from 0x3E4C01C6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = (r4.xyz) * (r1.xyz) + (r0.xyz);
    r0 = tex2D(s0, v1.xy);
    r1.z = dot(r7.xyz, r2.xyz);
    r1.z = (r1.z) + (r1.z);
    r0 = (r0.wxyz) * (v0.wxyz);
    r1.xyz = (r2.xyz) * (-(r1.zzz)) + (r7.xyz);
