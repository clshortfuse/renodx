// Mechanically reconstructed from 0x61456B23.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = (c[36].zz) * (r2.xy) + (r0.xy);
    r2.z = c1.y;
    r0 = tex2D(s0, v1.xy);
    r2.w = (r0.w) * (v0.w) + (c1.x);
    r0.w = (r1.w) * (r4.w);
    r9.xyz = float3(((r2.w) >= 0.0f ? (r2.x) : (c1.z)), ((r2.w) >= 0.0f ? (r2.y) : (c1.z)), ((r2.w) >= 0.0f ? (r2.z) : (c1.z)));
    r2.xyz = (r1.xyz) * (r0.www);
    r1 = v2;
    r1.xyz = (r9.xxx) * (v5.xyz) + (r1.xyz);
