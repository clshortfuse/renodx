// Mechanically reconstructed from 0x860412C0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = (r6.wwww) * (r0) + (r2);
    r2.xyz = (v0.zzz) * (r3.xyz) + (-(c3.yyy));
    r7.xz = (r9.xy) * (c12.xx);
    r0.xyz = (r0.xyz) * (r2.xyz);
    r3.xyz = (r7.xyz) * (r7.www) + (r6.xyz);
    r9.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c3.yyy));
    r10.xyz = (r0.xyz) * (r0.xyz);
    r0.xyz = v2.xyz;
    r6.xyz = (r8.xxx) * (v4.xyz) + (r0.xyz);
    r0.xyz = (r9.xyz) * (r4.www) + (r10.xyz);
    r6.xyz = (r8.yyy) * (v3.xyz) + (r6.xyz);
    r11.xyz = lerp(r1.yyy, c[8].xyw, r6.www);
