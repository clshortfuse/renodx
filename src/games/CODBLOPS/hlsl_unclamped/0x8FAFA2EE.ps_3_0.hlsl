// Mechanically reconstructed from 0x8FAFA2EE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s13, r0.xy);
    r2.w = r0.y;
    r1.xy = (r2.yw) * (c0.yy) + (c0.zz);
    r0.w = dot(r1.xy, r1.xy) + (c2.w);
    r1 = tex2D(s14, v0.zw);
    r4.xy = (r1.xy) * (c0.xx);
    r0.w = exp2(-(r0.w));
    r2.xy = (r2.xz) * (r4.xx);
    r2.w = saturate((r0.w) * (c1.x) + (c1.y));
    r0.w = (r1.x) * (c0.x) + (-(r2.x));
    r3.xz = (r2.xy) * (c0.yy);
    r0.xy = (r0.xz) * (r4.yy);
    r1.w = (r2.z) * (-(r4.x)) + (r0.w);
