// Mechanically reconstructed from 0x82668DFB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c15 = float4(1.0f, 0.5f, 0.0f, 0.0009765625f);
    const float4 c16 = float4(3.5f, -13.0f, 1.0f, 13.0f);
    const float4 c30 = float4(4.0f, -2.0f, 0.125f, 0.25f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = tex2D(s7, v7.zw);
    r13.xy = float2(((r3.w) >= 0.0f ? (r0.w) : (r1.w)), ((r3.w) >= 0.0f ? (r0.y) : (r1.y)));
    r8.xyz = (r2.xyz) * (r2.xyz);
    r8.w = (r13.x) * (-(c3.z)) + (c3.y);
    ...
    r7.z = rsqrt(r0.z);
    r1.w = rsqrt(r0.w);
    r10.xyz = (r7.zzz) * (v6.xyz);
    r0 = v1;
    r0.xyz = (r4.xxx) * (v4.xyz) + (r0.xyz);
    r3.xyz = (r2.xyz) * (r1.www) + (-(r10.xyz));
    ...
    r2.y = (r2.y) * (r5.z) + (c15.w);
    r1.z = saturate(dot(r1.xyz, r0.xyz));
    r1.y = 1.0f / (r2.y);
    r1.x = (r1.w) * (r1.y);
    r14.xy = (r13.xx) * (c16.xy) + (c16.zw);
    r5.w = exp2(r14.y);
    r1.y = (-(r1.z)) + (c3.y);
    r1.z = pow(abs(r2.z), r5.w);
    r2.z = (r1.y) * (r1.y);
    r4.z = (r5.w) * (c30.z) + (c30.w);
    r2.z = (r2.z) * (r2.z);
    r1.z = (r1.z) * (r4.z);
    r1.y = (r1.y) * (r2.z);
    r1.z = (r1.x) * (r1.z);
    ...
    r2.xyz = (r13.yyy) * (r1.xyz);
    r1.xyz = (r1.www) * (c[6].xyz);
    r6.xyz = (r8.xyz) * (r1.xyz) + (r2.xyz);
    r1.xy = (v0.zw) * (c3.yw);
    r3 = tex2D(s13, r1.xy);
    r1.xy = (v0.zw) * (c15.xy) + (c15.zy);
    r1 = tex2D(s13, r1.xy);
    r3.w = r1.y;
    r6.w = dot(r0.xyz, c[22].xyz);
    r0.xy = (r3.yw) * (c30.xx) + (c30.yy);
    r2 = tex2D(s14, v0.zw);
    r5.xy = (r2.xy) * (c4.zz);
    r0.z = dot(r0.xy, r4.xy) + (c1.y);
    r3.xy = (r3.xz) * (r5.xx);
    r1.w = (r2.x) * (c4.z) + (-(r3.x));
    r4.xy = (r1.xz) * (r5.yy);
    r1.y = (r3.z) * (-(r5.x)) + (r1.w);
    r1.w = (r2.y) * (c4.z) + (-(r4.x));
    r1.w = (r1.z) * (-(r5.y)) + (r1.w);
    r0.y = dot(r0.xy, r0.xy) + (c1.y);
    r7.y = (r1.y) + (r1.y);
    r0.x = exp2(-(r0.y));
    r0.y = (r1.w) + (r1.w);
    r0.x = (r0.x) * (c1.z) + (c1.w);
    r0.x = (r4.w) * (r0.x);
    r2.xyz = (v6.xyz) * (-(r7.zzz)) + (c[17].xyz);
    ...
    r1.z = (r1.w) * (r5.z) + (c15.w);
    r1.w = pow(abs(r2.y), r5.w);
    r1.z = 1.0f / (r1.z);
    r1.w = (r4.z) * (r1.w);
    r1.y = (r2.w) * (r1.z);
    r1.z = (r2.z) * (c4.x) + (c4.y);
    ...
    r8.w = (r13.y) * (r1.w);
    r1 = tex2D(s12, v0.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c15.x) : (c15.z));
    ...
    r1 = (v6.zzzz) * (c[26]) + (r1);
    r0.z = saturate((r6.w) * (c[23].x) + (c[23].y));
    r4 = (r1) + (c[27]);
    ...
    r1.w = dot(r1, c30.wwww);
    r0.xyz = (r3.www) * (r0.xyz);
    r1.xyz = (r7.xyz) * (c3.xxx) + (r8.xyz);
