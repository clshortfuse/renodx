// Mechanically reconstructed from 0xFC452A25.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.xy = (r3.ww) * (r0.xy) + (r1.yy);
    r11.xyz = (r2.xyz) * (r12.yyy);
    ...
    r0.w = rsqrt(r0.w);
    r1.xyz = (r2.www) * (v6.xyz);
    r0.xyz = (r2.xyz) * (r0.www) + (-(r1.xyz));
    r3.xyz = (r2.xyz) * (r0.www);
    r2.xyz = normalize(r0.xyz);
    r0.w = dot(r3.xyz, c[29].xyz);
    r9.w = saturate(dot(r2.xyz, r3.xyz));
    r3.w = saturate((r0.w) * (c[30].x) + (c[30].y));
    r5.w = (r3.w) * (c16.z) + (c16.w);
    r0 = v1;
    ...
    r4.w = (r0.z) * (r4.z) + (r5.z);
    r7.w = (r5.w) * (r3.w);
    r0.y = (r0.y) * (r4.w) + (c15.x);
    r0.y = 1.0f / (r0.y);
    r0.z = (-(r0.z)) + (c38.w);
    r12.z = (r8.w) * (r0.y);
    r0.y = (r0.z) * (r0.z);
    r0.z = (r0.z) * (r0.y);
    r0.y = dot(r1.xyz, r9.xyz);
    r11.w = (r0.y) + (r0.y);
    r4.xy = (r1.ww) * (c37.xy) + (c37.zw);
    r0.y = 1.0f / (r4.x);
    ...
    r0.y = (r3.y) * (r4.w) + (c15.x);
    r0.z = pow(abs(r2.x), r3.z);
    r0.y = 1.0f / (r0.y);
    r0.z = (r2.w) * (r0.z);
    r0.y = (r3.w) * (r0.y);
    r0.x = (r2.y) * (c3.x) + (c3.y);
    r0.z = (r0.z) * (r0.y);
    r0.y = pow(abs(r2.z), r3.z);
    r0.z = (r0.x) * (r0.z);
    r12.w = (r2.w) * (r0.y);
    r12.y = (r12.x) * (r0.z);
    r2 = tex2D(s12, v0.zw);
