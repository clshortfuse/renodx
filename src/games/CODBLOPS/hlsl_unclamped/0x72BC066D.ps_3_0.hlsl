// Mechanically reconstructed from 0x72BC066D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.w = (r0.w) * (v7.y) + (c1.w);
    r5.w = (r1.w) * (r1.z);
    r5.xy = float2(((r4.w) >= 0.0f ? (r1.x) : (r2.x)), ((r4.w) >= 0.0f ? (r1.y) : (r2.y)));
    r1 = tex2D(s0, v0.xy);
    ...
    r2.w = (r2.w) * (r2.z);
    r11.xyz = float3(((r4.w) >= 0.0f ? (r2.y) : (c[5].x)), ((r4.w) >= 0.0f ? (r2.y) : (c[5].y)), ((r4.w) >= 0.0f ? (r2.y) : (c[5].w)));
