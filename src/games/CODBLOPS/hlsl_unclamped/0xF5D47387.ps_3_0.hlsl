// Mechanically reconstructed from 0xF5D47387.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.x = dot(r5.xy, r0.xy) + (c14.z);
    r6.y = dot(r5.xy, r0.zw) + (c14.z);
    r0 = tex2D(s4, v7.xy);
    r4.w = (r0.w) * (v0.y);
    ...
    r1.w = (r1.w) * (c2.x) + (c2.y);
    r3.w = (r0.w) * (c2.x) + (c2.y);
    r0.w = lerp(r2.y, r5.w, c[8].w);
    r1.y = (r1.w) * (r3.w);
    r2 = tex2D(s14, v1.zw);
    r6.xy = (r2.xy) * (c3.ww);
    r1.w = dot(r5.xy, r7.xy) + (c14.z);
    r3.xy = (r3.xz) * (r6.yy);
    ...
    r3.y = (r1.w) + (r1.w);
    r1.zw = c14.zw;
    r2.xyz = (r1.zwz) + (-(c[32].xyw));
    r1.xyz = (r3.xyz) * (r3.www) + (r5.xyz);
    r9.xyz = (r4.www) * (r2.xyz) + (c[32].xyw);
    ...
    r5.w = pow(abs(r3.w), r0.w);
    r3.w = (r0.w) * (c12.y) + (c12.z);
    r6.w = (r1.w) * (c2.w);
    r2.x = (r1.w) * (-(c4.z)) + (c4.w);
