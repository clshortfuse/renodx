// Mechanically reconstructed from 0x33DFE5FD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s6, v1.xy);
    r11.xyz = lerp(r2.yyy, c[31].xyw, r6.www);
    ...
    r8.z = dot(r6.xyz, r10.xyz);
    r1.xyz = (r1.yyy) * (r4.xyz);
    r4.z = (r8.z) + (r8.z);
    r5.xyz = (r0.xyz) * (r5.xyz) + (r1.xyz);
    r1.xyz = (r10.xyz) * (-(r4.zzz)) + (r6.xyz);
