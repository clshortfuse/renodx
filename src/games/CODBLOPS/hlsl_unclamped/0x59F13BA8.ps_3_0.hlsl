// Mechanically reconstructed from 0x59F13BA8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = dot(r9.xyz, r6.xyz);
    r0 = (r0.xyzx) * (c1.yyyz) + (c1.zzzy);
    r2.y = (r2.y) + (r2.y);
    r4.w = (r2.w) * (c2.x);
    r4.xyz = (r6.xyz) * (-(r2.yyy)) + (r9.xyz);
    ...
    r2.y = (-(r3.z)) + (c1.y);
    r3.z = pow(abs(r2.z), r7.w);
    r2.x = (r2.y) * (r2.y);
    r2.z = (r7.w) * (c12.x) + (c12.y);
    r2.x = (r2.x) * (r2.x);
    r2.z = (r3.z) * (r2.z);
    r2.y = (r2.y) * (r2.x);
    r2.z = (r3.w) * (r2.z);
