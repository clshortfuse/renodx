// Mechanically reconstructed from 0xB2A1F1D1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyz = (v5.xyz) * (-(r1.zzz)) + (c[17].xyz);
    r11.xyz = (v6.yyy) * (r3.xyz) + (c14.yyy);
    r3.xyz = normalize(r0.xyz);
    r0.xyz = (r2.xyz) * (r11.xyz);
    r1.w = saturate(dot(r3.xyz, c[17].xyz));
    r2.xyz = (r11.xyz) * (c14.zzz);
    r1.w = (-(r1.w)) + (c14.y);
    r12.xyz = (r1.zzz) * (v5.xyz);
    r1.z = (r1.w) * (r1.w);
    r2.w = saturate(dot(r10.xyz, r3.xyz));
    r1.z = (r1.z) * (r1.z);
    r3.w = (r1.w) * (r1.z);
    r3.xyz = (r2.xyz) * (r2.xyz);
    r2.xyz = (r2.xyz) * (-(r2.xyz)) + (c14.yyy);
