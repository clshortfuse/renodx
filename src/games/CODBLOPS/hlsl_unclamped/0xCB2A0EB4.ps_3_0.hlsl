// Mechanically reconstructed from 0xCB2A0EB4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = rsqrt(r0.w);
    r0.xyz = (r6.www) * (v4.xyz);
    r2.xyz = (r3.www) * (r8.xyz) + (r10.xyz);
    ...
    r6.w = (r0.w) * (r1.w);
    r1 = tex2D(s5, v0.xy);
    r4.xyz = (r1.xyz) * (-(r1.xyz)) + (c0.xxx);
    r8.xyz = (r1.xyz) * (r1.xyz);
    r11.w = (r1.w) * (-(c0.z)) + (c0.x);
    r12.z = (r1.w) * (c0.z);
    r4.w = saturate(dot(r3.xyz, r9.xyz));
    r12.y = saturate(dot(r9.xyz, -(r0.xyz)));
    r0.w = (r4.w) * (r11.w) + (r12.z);
    r10.w = (r12.y) * (r11.w) + (r12.z);
    r3.xyz = (r4.xyz) * (r6.www) + (r8.xyz);
    r0.w = (r0.w) * (r10.w) + (c4.x);
    r1.z = 1.0f / (r0.w);
