// Mechanically reconstructed from 0xF2209664.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = (r0.xy) * (c12.xx);
    r2.xy = (r1.xz) * (r4.xx);
    r0.w = (r0.x) * (c12.x) + (-(r2.x));
    r0.x = r1.y;
    r0.w = (r1.z) * (-(r4.x)) + (r0.w);
    r11.y = (r0.w) + (r0.w);
    r1.xy = (v1.zw) * (c16.yz) + (c16.wz);
    r1 = tex2D(s13, r1.xy);
    r3.xy = (r4.yy) * (r1.xz);
    r0.w = (r0.y) * (c12.x) + (-(r3.x));
    r0.y = r1.y;
    r1.w = (r1.z) * (-(r4.y)) + (r0.w);
    r4.xy = (r0.xy) * (c12.yy) + (c12.zz);
    r0 = tex2D(s7, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c3.xxxx) * (v9) + (c3.yyyy);
    r5.y = dot(r1.xy, r0.zw) + (c4.x);
    r5.x = dot(r1.xy, r0.xy) + (c4.x);
    r0 = tex2D(s1, v1.xy);
    r6.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = tex2D(s5, v7.zw);
    r4.w = (r0.w) * (v0.z);
    r1.y = (r1.w) + (r1.w);
    r7.xy = lerp(r6.xy, r5.xy, r4.ww);
    r1.w = dot(r7.xy, r7.xy) + (c4.x);
    r0.w = dot(r4.xy, r4.xy) + (c4.x);
    r1.w = exp2(-(r1.w));
    r0.w = exp2(-(r0.w));
    r3.w = (r1.w) * (c4.y) + (c4.z);
    r1.w = (r0.w) * (c4.y) + (c4.z);
    r0.w = dot(r4.xy, r7.xy) + (c4.x);
    r1.w = (r3.w) * (r1.w);
    ...
    r1 = tex2D(s4, v7.xy);
    r0.w = (r1.w) * (v0.y) + (c3.z);
    r5.xyz = (r11.xyz) * (r3.www) + (r3.xyz);
    r1.xyz = float3(((r0.w) >= 0.0f ? (r1.x) : (r2.x)), ((r0.w) >= 0.0f ? (r1.y) : (r2.y)), ((r0.w) >= 0.0f ? (r1.z) : (r2.z)));
    r3.xyz = lerp(r1.xyz, r0.xyz, r4.www);
    r5.w = c3.w;
    r6.xyz = float3(((r0.w) >= 0.0f ? (r5.w) : (c[34].x)), ((r0.w) >= 0.0f ? (r5.w) : (c[34].y)), ((r0.w) >= 0.0f ? (r5.w) : (c[34].w)));
    r0 = tex2D(s9, v7.zw);
    r2 = tex2D(s8, v1.xy);
    r1 = tex2D(s6, v8.xy);
    r4.xyz = (r1.xyz) + (c3.yyy);
    r1 = lerp(r2, r0, r4.wwww);
    r4.xyz = (v0.www) * (r4.xyz) + (c3.www);
    r8.xyz = lerp(r6.xyz, c[35].xyw, r4.www);
    ...
    r13.xyz = (r5.xyz) * (r8.yyy);
    r5.xyz = (r2.xyz) * (r0.www) + (-(r6.xyz));
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c16.y) : (c16.w));
    ...
    r0.w = saturate((r6.w) * (c[30].x) + (c[30].y));
    r8.xyz = (r5.xyz) * (r0.xyz) + (r1.xyz);
    r1.z = (r0.w) * (c15.z) + (c15.w);
    r1.w = (r0.w) * (r0.w);
    r0 = (v6.xyzx) * (c16.yyyw) + (c16.wwwy);
    r1.w = (r1.z) * (r1.w);
    r1.z = dot(r0, c[28]);
    r1.z = 1.0f / (r1.z);
    r2.x = dot(r0, c[27]);
