// Mechanically reconstructed from 0xBF50F38A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s4, v8.zw);
    r0.w = (r0.w) * (v0.z);
    r2.xy = (r1.zz) * (-(r1.xy)) + (r1.xy);
    r1.xyz = lerp(r3.xyz, r0.xyz, r0.www);
    r7.w = lerp(r3.w, c7.x, r0.w);
    ...
    r3.z = saturate(dot(r1.xyz, r0.xyz));
    r12.xy = (r1.ww) * (c9.xy) + (c9.zw);
