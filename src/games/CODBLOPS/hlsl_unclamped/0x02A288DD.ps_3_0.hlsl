// Mechanically reconstructed from 0x02A288DD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c7 = float4(4.0f, -2.0f, 0.0009765625f, 0.25f);
    ...
    r3 = tex2D(s13, r1.xy);
    r0.w = r3.y;
    r1.z = dot(r6.xy, r6.xy) + (c1.y);
    r1.xy = (r0.wy) * (c7.xx) + (c7.yy);
    r0.y = exp2(-(r1.z));
    r0.w = dot(r1.xy, r1.xy) + (c1.y);
    r4.w = (r0.y) * (c1.z) + (c1.w);
    r0.w = exp2(-(r0.w));
    r11.xyz = lerp(r2.yyy, c[5].xyw, r2.zzz);
    r0.y = (r0.w) * (c1.z) + (c1.w);
