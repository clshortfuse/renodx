// Mechanically reconstructed from 0x7D21A3C8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xz = (r2.xy) * (c12.xx);
    r5.y = (r1.x) + (r1.x);
    r2.xyz = (r5.xyz) * (r1.zzz) + (r4.xyz);
    r4.w = ((r1.w) >= 0.0f ? (r1.y) : (c1.z));
