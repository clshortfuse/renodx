// Mechanically reconstructed from 0xA802DEF4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.w = (r1.w) * (v0.y) + (c2.z);
    r7.x = 1.0f / (r6.w);
    r1.w = ((r7.w) >= 0.0f ? (c2.w) : (r2.y));
    r6.xy = saturate((r7.xx) * (c[24].xy) + (c[24].zw));
    r2.xy = (r6.xy) * (r6.xy);
    r6.xy = (r6.xy) * (c15.xx) + (c15.yy);
    r0.w = dot(c[23].yz, r7.xy) + (c[23].x);
    r2.xy = (r2.xy) * (r6.xy);
    r7.xyz = float3(((r4.w) >= 0.0f ? (c[28].x) : (r1.w)), ((r4.w) >= 0.0f ? (c[28].y) : (r1.w)), ((r4.w) >= 0.0f ? (c[28].w) : (r1.w)));
    r0.w = (r0.w) * (r2.x);
