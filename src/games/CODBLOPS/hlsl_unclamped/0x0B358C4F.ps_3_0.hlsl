// Mechanically reconstructed from 0x0B358C4F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.xyz = (r1.xyz) * (c[5].yyy);
    r13.xyz = (r0.xyz) * (c[5].www);
    r2 = tex2D(s12, v1.zw);
