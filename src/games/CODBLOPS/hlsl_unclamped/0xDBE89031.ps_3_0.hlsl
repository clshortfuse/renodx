// Mechanically reconstructed from 0xDBE89031.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xy = float2(((r3.w) >= 0.0f ? (r6.x) : (c1.z)), ((r3.w) >= 0.0f ? (r6.y) : (c1.z)));
    r1.w = exp2(-(r0.w));
    ...
    r9.xyz = (r3.xyz) * (r5.www) + (r2.xyz);
    r2 = float4(((r2.w) >= 0.0f ? (r1.x) : (c1.z)), ((r2.w) >= 0.0f ? (r1.y) : (c1.z)), ((r2.w) >= 0.0f ? (r1.z) : (c1.z)), ((r2.w) >= 0.0f ? (r1.w) : (c1.z)));
    r6.xyz = float3(((r3.w) >= 0.0f ? (c[37].x) : (r2.w)), ((r3.w) >= 0.0f ? (c[37].y) : (r2.w)), ((r3.w) >= 0.0f ? (c[37].w) : (r2.w)));
    r1 = v1;
    ...
    r6.w = (r7.w) * (c4.y) + (c4.z);
    r5.z = saturate(dot(r5.xyz, r8.xyz));
    r5.y = (r3.w) * (r6.w);
    r5.w = (r2.w) * (c2.z);
    r4.w = (r2.w) * (-(c14.z)) + (c14.w);
    r5.x = (r11.w) * (r4.w) + (r5.w);
    ...
    r2.xyz = (r10.www) * (r12.xyz) + (r13.xyz);
