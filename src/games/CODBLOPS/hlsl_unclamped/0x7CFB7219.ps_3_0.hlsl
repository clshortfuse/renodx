// Mechanically reconstructed from 0x7CFB7219.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.x = dot(r5.xy, r0.xy) + (c14.w);
    r6.y = dot(r5.xy, r0.zw) + (c14.w);
    r0 = tex2D(s5, v7.zw);
    r4.w = (r0.w) * (v0.z);
