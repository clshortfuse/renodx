// Mechanically reconstructed from 0xF37F5419.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = dot(r5.xy, r1.zw) + (c3.z);
    r0 = tex2D(s5, v7.xy);
    r6.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c3.xxxx) * (v8) + (c3.yyyy);
    r2.y = dot(r6.xy, r0.zw) + (c3.z);
    r2.x = dot(r6.xy, r0.xy) + (c3.z);
    r0 = tex2D(s3, v7.xy);
    r3.w = (r0.w) * (v0.y);
    r8.x = dot(r5.xy, r1.xy) + (c3.z);
    r9.xy = lerp(r3.xy, r2.xy, r3.ww);
    r1 = tex2D(s0, v1.xy);
    ...
    r6.xyz = lerp(r2.yyy, c[23].xyw, r3.www);
    r3 = (r3.wwww) * (r0) + (r1);
    r0 = tex2D(s4, v7.zw);
    r6.w = (r0.w) * (v0.z);
    r5.xyz = lerp(r7.xyz, r0.xyz, r6.www);
    r7.xy = lerp(r9.xy, r8.xy, r6.ww);
    r1 = tex2D(s9, v7.zw);
    r2 = (r1.wwww) * (-(c3.zzzy)) + (-(c3.wwwz));
    r0 = lerp(r3, r2, r6.wwww);
    r13.xyz = lerp(r6.xyz, r1.yyy, r6.www);
