// Mechanically reconstructed from 0x18408FF9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(0.797884583f, 0.25f, 1.0f, 0.0009765625f);
    ...
    r4.xyz = (r4.xyz) * (-(r4.xyz)) + (c0.www);
    r5.xyz = (r4.xyz) * (r0.zzz) + (r7.xyz);
    ...
    r2.w = (r0.z) * (r0.w);
    r0.x = saturate(dot(r1.xyz, r9.xyz));
    r0.w = saturate(dot(r8.xyz, r1.xyz));
    r0.x = (-(r0.x)) + (c0.w);
    r1.y = pow(abs(r0.w), r3.w);
    r1.z = (r0.x) * (r0.x);
    r0.w = (r3.w) * (c3.x) + (c3.y);
    r1.z = (r1.z) * (r1.z);
    r0.w = (r1.y) * (r0.w);
    r0.x = (r0.x) * (r1.z);
    r0.w = (r2.w) * (r0.w);
    r1.xyz = (r4.xyz) * (r0.xxx) + (r7.xyz);
    r2.xyz = (r2.xyz) * (r2.xyz);
    r4.xyz = (r0.www) * (r1.xyz);
    r1.xyz = (r6.xyz) * (r2.xyz);
    r6.xyz = (r4.xyz) * (c[8].xyz);
