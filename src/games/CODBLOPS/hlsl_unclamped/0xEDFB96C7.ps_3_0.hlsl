// Mechanically reconstructed from 0xEDFB96C7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c4 = float4(1.0f, -1.0f, -2.0f, 3.0f);
    const float4 c12 = float4(40.0f, 1.0f, 0.0f, 8.0f);
    const float4 c13 = float4(0.5f, -0.5f, 0.300000012f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r7.xy = saturate((r8.xx) * (c[8].xy) + (c[8].zw));
    r6.xy = (r7.xy) * (r7.xy);
    r7.xy = (r7.xy) * (c4.zz) + (c4.ww);
    r0.w = dot(c[7].yz, r8.xy) + (c[7].x);
    r6.xy = (r6.xy) * (r7.xy);
    r2.xyz = (r1.xyz) * (c12.www) + (r2.xyz);
    r0.w = (r0.w) * (r6.x);
    r5.xyz = (r4.xyz) * (r0.zzz) + (r5.xyz);
    r0.w = (r6.y) * (r0.w);
    r1 = tex2D(s12, v6.zw);
