// Mechanically reconstructed from 0x43C9EAB2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = (v0.zw) * (c2.xz);
    r2 = tex2D(s13, r2.xy);
    r3.xy = (v0.zw) * (c2.xz) + (c2.wz);
    r4 = tex2D(s13, r3.xy);
    r2.w = r4.y;
    r5.xyz = (r0.xyz) * (v7.yyy);
