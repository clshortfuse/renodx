// Mechanically reconstructed from 0x985D91D0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xy = (r3.zz) * (-(r3.xy)) + (r3.xy);
    r0.xyw = c[20].xyw;
    r1.xyz = (-(r0.xyw)) + (c[21].xyw);
    r0 = tex2D(s4, v8.zw);
    r4.w = (r0.w) * (v0.z);
    r4.xyz = (r3.zzz) * (r1.xyz) + (c[20].xyw);
    r3.xyz = lerp(r6.xyz, r0.xyz, r4.www);
    r0 = tex2D(s8, v8.zw);
    r1 = tex2D(s5, v9.xy);
    r6.xyz = (r1.xyz) + (c1.xxx);
    r1 = lerp(r2, r0, r4.wwww);
    r0.xyz = (v0.www) * (r6.xyz) + (c1.yyy);
    r12.xyz = lerp(r4.xyz, c[22].xyw, r4.www);
