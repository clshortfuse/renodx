// Mechanically reconstructed from 0x41B887D1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = (-(r6.w)) + (c1.w);
    r0.y = (r0.z) * (r0.z);
    r12.xy = (r9.xx) * (c12.xy) + (c12.zw);
    r1.w = (r0.z) * (r0.y);
    r2.w = 1.0f / (r12.x);
    r0.xyz = (r2.xyz) * (r2.xyz);
    r2.w = (r1.w) * (r2.w);
    r3.w = (r11.x) * (r11.x);
    r1.w = (r11.x) * (-(r11.x)) + (c1.w);
    ...
    r5.w = saturate(dot(r4.xyz, r10.xyz));
    r6.w = (r6.w) * (r0.z) + (r0.y);
    r2.w = (r5.w) * (r0.z) + (r0.y);
    ...
    r2.x = saturate(dot(r1.xyz, r4.xyz));
