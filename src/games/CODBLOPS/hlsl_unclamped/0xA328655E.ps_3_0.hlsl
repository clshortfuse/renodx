// Mechanically reconstructed from 0xA328655E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.xy = float2(((r3.w) >= 0.0f ? (c1.y) : (r2.x)), ((r3.w) >= 0.0f ? (c1.z) : (r2.y)));
    r5.xyz = (r5.xyz) * (r6.zzz);
    r2.xyz = (r0.xyz) * (r12.yyy);
    r1 = tex2D(s12, v1.zw);
    r0 = v2;
    ...
    r0.xyz = float3(((r4.w) >= 0.0f ? (r4.x) : (r5.x)), ((r4.w) >= 0.0f ? (r4.y) : (r5.y)), ((r4.w) >= 0.0f ? (r4.z) : (r5.z)));
    ...
    r4.x = (r2.w) * (c3.z);
    r4.y = (r2.w) * (-(c15.z)) + (c15.w);
    r4.z = (r1.x) * (r4.y) + (r4.x);
    r1.w = (r7.w) * (r4.y) + (r4.x);
    r1.w = (r1.w) * (r4.z) + (c12.x);
    ...
    r5.z = dot(r2.xyz, r10.xyz);
    r3.xyz = (r0.xyz) * (r11.xyz) + (r1.xyz);
    r1.z = (r5.z) + (r5.z);
