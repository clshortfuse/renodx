// Mechanically reconstructed from 0xDC1DFC0C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.x = dot(r2.xy, r1.xy) + (c0.w);
    r4.y = dot(r2.xy, r1.zw) + (c0.w);
    r2 = tex2D(s4, v7.xy);
    r2.w = (r2.w) * (v0.y);
    r0.w = dot(r0, c2.xxxx);
    ...
    r5.xyz = lerp(r0.xyz, c0.zzz, r1.xxx);
    ...
    r1.w = (r1.w) * (r1.z);
    r4.xyz = (v0.zzz) * (r4.xyz) + (-(c0.yyy));
    r3.xyz = (r3.xyz) * (r4.xyz);
    r8.xyz = (r0.xyz) * (-(r1.xxx)) + (r2.xyz);
    r2.xyz = (r3.xyz) * (-(r3.xyz)) + (-(c0.yyy));
