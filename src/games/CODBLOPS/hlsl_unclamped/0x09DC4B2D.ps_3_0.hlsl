// Mechanically reconstructed from 0x09DC4B2D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = dot(r11.xy, r11.xy) + (c12.w);
    r1.w = dot(r2.xy, r2.xy) + (c12.w);
    r0.w = exp2(-(r0.w));
    r1.w = exp2(-(r1.w));
    r0.w = (r0.w) * (c1.x) + (c1.y);
    r1.y = (r1.w) * (c1.x) + (c1.y);
    r1.w = dot(r2.xy, r11.xy) + (c12.w);
    r1.y = (r0.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c3.ww);
    ...
    r2 = tex2D(s5, v1.xy);
    r3.w = r2.w;
    r3.xyz = (r8.xyz) * (c12.zzz);
    r0 = tex2D(s6, v8.zw);
    r1 = lerp(r3, r0, r4.wwww);
    r8.xyz = (r6.xyz) * (r6.xyz);
    r9.xyz = (r1.xyz) * (-(r1.xyz)) + (c12.yyy);
