// Mechanically reconstructed from 0xA8F7D0B5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyz = (r0.xyz) * (-(r0.xyz)) + (c0.zzz);
    r3.w = max(abs(r10.y), abs(r10.z));
    r7.xyz = (r0.xyz) * (r1.www) + (r2.xyz);
