// Mechanically reconstructed from 0xB2CF6AFE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = dot(r3.xy, r1.xy) + (c3.z);
    r0.y = dot(r3.xy, r1.zw) + (c3.z);
    r1 = tex2D(s2, v6.xy);
    r1.w = (r1.w) * (v0.y) + (c3.w);
    r2 = float4(((r1.w) >= 0.0f ? (r0.x) : (r2.x)), ((r1.w) >= 0.0f ? (r0.y) : (r2.y)), ((r1.w) >= 0.0f ? (r0.z) : (r2.z)), ((r1.w) >= 0.0f ? (r0.w) : (r2.w)));
    r0 = tex2D(s5, v6.zw);
    r4.xy = (r0.wy) * (c2.xy) + (c2.zw);
    r0 = (c3.xxxx) * (v8) + (c3.yyyy);
    r3.x = dot(r4.xy, r0.xy) + (c3.z);
    r3.y = dot(r4.xy, r0.zw) + (c3.z);
    r0 = tex2D(s3, v6.zw);
    r7.w = (r0.w) * (v0.z);
    r6.xy = lerp(r2.xy, r3.xy, r7.ww);
    r10.xy = lerp(r2.zw, c[10].xy, r7.ww);
    r2.xy = (v1.zw) * (-(c3.yw));
    r2 = tex2D(s13, r2.xy);
    r3.xy = (v1.zw) * (-(c3.yw)) + (-(c3.zw));
    r4 = tex2D(s13, r3.xy);
    r2.w = r4.y;
    r0.w = dot(r6.xy, r6.xy) + (c3.z);
    r3.xy = (r2.yw) * (c1.zz) + (c1.ww);
    r2.w = exp2(-(r0.w));
    r0.w = dot(r3.xy, r3.xy) + (c3.z);
    r2.w = (r2.w) * (c4.x) + (c4.y);
    r2.y = exp2(-(r0.w));
    r0.w = dot(r3.xy, r6.xy) + (c3.z);
    r2.y = (r2.y) * (c4.x) + (c4.y);
    r3 = tex2D(s14, v1.zw);
    r8.xy = (r3.xy) * (c4.ww);
    r2.y = (r2.w) * (r2.y);
    ...
    r0.w = (r2.z) * (-(r8.x)) + (r0.w);
    r2.xyz = (r6.yyy) * (v3.xyz) + (r3.xyz);
    r9.xyz = normalize(r2.xyz);
    r8.xyz = normalize(v5.xyz);
    r7.y = (r0.w) + (r0.w);
    r0.w = dot(r8.xyz, r9.xyz);
    r2.xyz = (r7.xyz) * (r2.www) + (r4.xyz);
    r0.w = (r0.w) + (r0.w);
    r6.xyz = (r10.yyy) * (r2.xyz);
