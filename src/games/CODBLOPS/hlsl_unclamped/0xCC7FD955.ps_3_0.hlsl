// Mechanically reconstructed from 0xCC7FD955.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c10 = float4(0.600000024f, 0.400000006f, 0.797884583f, 31.875f);
    ...
    r6.w = (r0.w) * (v0.y) + (c3.w);
    r5.w = (r1.w) * (r1.z);
    r7.xy = float2(((r6.w) >= 0.0f ? (r1.x) : (r2.x)), ((r6.w) >= 0.0f ? (r1.y) : (r2.y)));
    r1 = tex2D(s6, v7.zw);
    r2.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r1 = (c3.xxxx) * (v9) + (c3.yyyy);
    r6.y = dot(r2.xy, r1.zw) + (c3.z);
    r6.x = dot(r2.xy, r1.xy) + (c3.z);
    r1 = tex2D(s0, v1.xy);
    r5.xyz = float3(((r6.w) >= 0.0f ? (r0.x) : (r1.x)), ((r6.w) >= 0.0f ? (r0.y) : (r1.y)), ((r6.w) >= 0.0f ? (r0.z) : (r1.z)));
    r3 = tex2D(s8, v7.xy);
    r1 = (r3.wwww) * (c4.xxxy) + (c4.zzzx);
    r2 = tex2D(s7, v1.xy);
    r0 = tex2D(s4, v7.zw);
    r3.w = (r0.w) * (v0.z) + (c3.w);
    r2 = float4(((r6.w) >= 0.0f ? (r1.x) : (r2.x)), ((r6.w) >= 0.0f ? (r1.y) : (r2.y)), ((r6.w) >= 0.0f ? (r1.z) : (r2.z)), ((r6.w) >= 0.0f ? (r1.w) : (r2.w)));
    r0.xyz = float3(((r3.w) >= 0.0f ? (r0.x) : (r5.x)), ((r3.w) >= 0.0f ? (r0.y) : (r5.y)), ((r3.w) >= 0.0f ? (r0.z) : (r5.z)));
    r5.xy = float2(((r3.w) >= 0.0f ? (r6.x) : (r7.x)), ((r3.w) >= 0.0f ? (r6.y) : (r7.y)));
    r8.xyz = (r0.xyz) * (r0.xyz);
    r1 = tex2D(s9, v7.zw);
    r0 = (r1.wwww) * (c4.xxxy) + (c4.zzzx);
    r3.xyz = float3(((r6.w) >= 0.0f ? (r3.y) : (c[8].x)), ((r6.w) >= 0.0f ? (r3.y) : (c[8].y)), ((r6.w) >= 0.0f ? (r3.y) : (c[8].w)));
    r0 = float4(((r3.w) >= 0.0f ? (r0.x) : (r2.x)), ((r3.w) >= 0.0f ? (r0.y) : (r2.y)), ((r3.w) >= 0.0f ? (r0.z) : (r2.z)), ((r3.w) >= 0.0f ? (r0.w) : (r2.w)));
    r11.xyz = float3(((r3.w) >= 0.0f ? (r1.y) : (r3.x)), ((r3.w) >= 0.0f ? (r1.y) : (r3.y)), ((r3.w) >= 0.0f ? (r1.y) : (r3.z)));
    ...
    r2.xy = (r1.wy) * (c12.xx) + (c12.yy);
    r1.y = dot(r5.xy, r5.xy) + (c3.z);
    r1.w = dot(r2.xy, r2.xy) + (c3.z);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r3.w = (r1.y) * (c10.x) + (c10.y);
    r1.y = (r1.w) * (c10.x) + (c10.y);
    r1.w = dot(r2.xy, r5.xy) + (c3.z);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c10.ww);
    r1.w = saturate((r1.w) * (r1.y) + (r1.y));
    r3.xy = (r3.xz) * (r7.xx);
    r1.y = (r2.x) * (c10.w) + (-(r3.x));
    r6.xy = (r1.xz) * (r7.yy);
    r1.y = (r3.z) * (-(r7.x)) + (r1.y);
    r1.x = (r2.y) * (c10.w) + (-(r6.x));
    r1.z = (r1.z) * (-(r7.y)) + (r1.x);
    r7.y = (r1.y) + (r1.y);
    r1.y = (r1.z) + (r1.z);
    r2.xyz = v2.xyz;
