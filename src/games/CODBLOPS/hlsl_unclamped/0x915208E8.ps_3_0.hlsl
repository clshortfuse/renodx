// Mechanically reconstructed from 0x915208E8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.xz = (r2.xy) * (c12.xx);
    r2.xyz = (r9.xyz) * (r0.www) + (r1.xyz);
    r1 = tex2D(s0, v1.xy);
    r0.w = dot(v7.xyz, v7.xyz);
    r4.xyz = lerp(r1.xyz, r0.xyz, r5.zzz);
    r10.w = rsqrt(r0.w);
    r1 = tex2D(s7, v1.xy);
    ...
    r8.xyz = lerp(r1.yyy, c[31].xyw, r5.zzz);
    r0.w = saturate(dot(r12.xyz, r15.xyz));
    r17.xyz = (r2.xyz) * (r8.yyy);
    r0.w = (-(r0.w)) + (c1.z);
    r0.y = dot(r15.xyz, c[29].xyz);
    r0.z = (r0.w) * (r0.w);
    r0.z = (r0.z) * (r0.z);
    r5.w = saturate((r0.y) * (c[30].x) + (c[30].y));
    r3.w = (r0.w) * (r0.z);
    r4.w = (r5.w) * (c16.z) + (c16.w);
    r2.w = -(r1.w);
    r2.xyz = c1.xxx;
    r0 = tex2D(s8, v8.xy);
    r0 = (r2) + (r0);
    ...
    r3.xyz = (v0.www) * (r3.xyz) + (c1.zzz);
    r0.w = (r5.w) * (r5.w);
    r0.xyz = (r0.xyz) * (r3.xyz);
    r2.xyz = (r0.xyz) * (-(r0.xyz)) + (c1.zzz);
    r13.xyz = (r0.xyz) * (r0.xyz);
    r7.w = (r4.w) * (r0.w);
    r11.xyz = (r2.xyz) * (r3.www) + (r13.xyz);
    ...
    r5.z = (r1.w) * (r1.z);
    r1.w = (r2.w) * (c3.z);
    r1.xyz = (r10.xyz) * (-(r9.www)) + (r14.xyz);
    r1 = texCUBElod(s15, r1);
    r1.w = (-(r4.z)) + (c1.z);
    r4.z = (r1.w) * (r1.w);
    r5.xy = (r2.ww) * (c33.xy) + (c33.zw);
    r1.w = (r1.w) * (r4.z);
    r2.w = 1.0f / (r5.x);
    r1.xyz = (r1.xyz) * (r1.xyz);
    r1.w = (r1.w) * (r2.w);
    r1.xyz = (r8.xxx) * (r1.xyz);
    r4.xyz = (r2.xyz) * (r1.www) + (r13.xyz);
    r1.xyz = (r1.xyz) * (r4.xyz);
    r4.z = exp2(r5.y);
    r1.w = (r4.z) * (c15.y) + (c15.z);
    r2.w = (r8.w) * (r8.y) + (r6.z);
    r2.w = (r2.w) * (r6.w) + (c15.x);
    r3.y = saturate(dot(r10.xyz, r3.xyz));
    r3.z = 1.0f / (r2.w);
    r2.w = pow(abs(r3.y), r4.z);
    r3.z = (r8.w) * (r3.z);
    r2.w = (r1.w) * (r2.w);
    r2.w = (r3.z) * (r2.w);
    r2.xyz = (r2.xyz) * (r5.zzz) + (r13.xyz);
