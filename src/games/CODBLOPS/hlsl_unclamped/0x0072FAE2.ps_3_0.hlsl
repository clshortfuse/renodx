// Mechanically reconstructed from 0x0072FAE2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = (r3.w) * (r0.z);
    r8.xyz = (r4.xyz) * (-(r4.xyz)) + (c1.xxx);
    r0.xyz = (r3.xyz) * (r3.xyz);
    r3.xyz = (r3.www) * (r8.xyz);
    r0.xyz = (r9.xxx) * (r0.xyz);
    r8.xyz = (r4.xyz) * (r4.xyz) + (r3.xyz);
    r3 = tex2D(s0, v1.xy);
