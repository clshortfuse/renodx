// Mechanically reconstructed from 0xC5EAF9F7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xyz = lerp(r1.xyz, c1.xxx, r2.www);
    r0.xy = (v1.zw) * (c3.xy) + (c3.zy);
    r0 = tex2D(s13, r0.xy);
    r1.xy = (v1.zw) * (c3.xy);
    r3 = tex2D(s13, r1.xy);
    r0.w = r3.y;
    r1.xy = (r2.ww) * (-(r2.xy)) + (r2.xy);
