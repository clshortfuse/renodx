// Mechanically reconstructed from 0x6EC4B649.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = float2(((r8.z) >= 0.0f ? (r1.x) : (c3.w)), ((r8.z) >= 0.0f ? (r1.y) : (c3.w)));
    r1 = float4(((r8.z) >= 0.0f ? (r0.x) : (c3.w)), ((r8.z) >= 0.0f ? (r0.y) : (c3.w)), ((r8.z) >= 0.0f ? (r0.z) : (c3.w)), ((r8.z) >= 0.0f ? (r0.w) : (c3.w)));
    r0 = tex2D(s5, v7.xy);
    r8.w = (r0.w) * (v0.y) + (c3.z);
    r0 = (r0.xyzx) * (-(c3.yyyw)) + (-(c3.wwwy));
    r1 = float4(((r8.w) >= 0.0f ? (r0.x) : (r1.x)), ((r8.w) >= 0.0f ? (r0.y) : (r1.y)), ((r8.w) >= 0.0f ? (r0.z) : (r1.z)), ((r8.w) >= 0.0f ? (r0.w) : (r1.w)));
    r3.xy = float2(((r8.w) >= 0.0f ? (r3.x) : (r4.x)), ((r8.w) >= 0.0f ? (r3.y) : (r4.y)));
    r0 = tex2D(s6, v7.zw);
    r7.w = (r0.w) * (v0.z) + (c3.z);
    r0 = (r0.xyzx) * (-(c3.yyyw)) + (-(c3.wwwy));
    r0 = float4(((r7.w) >= 0.0f ? (r0.x) : (r1.x)), ((r7.w) >= 0.0f ? (r0.y) : (r1.y)), ((r7.w) >= 0.0f ? (r0.z) : (r1.z)), ((r7.w) >= 0.0f ? (r0.w) : (r1.w)));
    r8.xy = float2(((r7.w) >= 0.0f ? (r2.x) : (r3.x)), ((r7.w) >= 0.0f ? (r2.y) : (r3.y)));
    r1 = tex2D(s9, v1.xy);
    r2 = float4(((r8.z) >= 0.0f ? (r1.x) : (-(c3.w))), ((r8.z) >= 0.0f ? (r1.y) : (-(c3.w))), ((r8.z) >= 0.0f ? (r1.z) : (-(c3.w))), ((r8.z) >= 0.0f ? (r1.w) : (-(c3.y))));
    r1 = tex2D(s10, v7.xy);
    r3 = float4(((r8.w) >= 0.0f ? (r1.x) : (r2.x)), ((r8.w) >= 0.0f ? (r1.y) : (r2.y)), ((r8.w) >= 0.0f ? (r1.z) : (r2.z)), ((r8.w) >= 0.0f ? (r1.w) : (r2.w)));
    r7.xyz = (r0.xyz) * (r0.xyz);
    r2 = tex2D(s11, v7.zw);
    r0.z = dot(r8.xy, r8.xy) + (c3.w);
    r1 = (r2.wwww) * (c4.xxxy) + (c4.zzzx);
    r0.z = exp2(-(r0.z));
    r2.w = (r0.z) * (c12.x) + (c12.y);
    r0.xy = (v1.zw) * (-(c3.yz));
    r6 = tex2D(s13, r0.xy);
    ...
    r5 = tex2D(s14, v1.zw);
    r0.xy = (r5.xy) * (c12.ww);
    r9.xy = (r6.yw) * (c16.xx) + (c16.yy);
    r6.xy = (r6.xz) * (r0.xx);
    r0.z = dot(r9.xy, r8.xy) + (c3.w);
    r2.z = (r5.x) * (c12.w) + (-(r6.x));
    r2.z = (r6.z) * (-(r0.x)) + (r2.z);
    r4.xy = (r4.xz) * (r0.yy);
    r2.x = (r5.y) * (c12.w) + (-(r4.x));
    ...
    r0.xyz = (r11.xyz) * (r2.www) + (r0.xyz);
    r2.w = dot(v6.xyz, v6.xyz);
    r4.xyz = (-(v6.xyz)) + (c[20].xyz);
    r2.z = rsqrt(r2.w);
    r2.w = dot(r4.xyz, r4.xyz);
    r2.w = rsqrt(r2.w);
    r6.xyz = (r2.zzz) * (v6.xyz);
    r12.w = (r1.w) * (-(c16.z)) + (c16.w);
    r5.xyz = (r4.xyz) * (r2.www) + (-(r6.xyz));
    r3.xyz = normalize(r5.xyz);
    r4.xyz = (r4.xyz) * (r2.www);
    r15.xyz = (r1.xyz) * (-(r1.xyz)) + (-(c3.yyy));
    r2.w = saturate(dot(r3.xyz, r4.xyz));
    r18.yw = c3.yw;
    r5.xyz = float3(((r8.z) >= 0.0f ? (c[39].x) : (r18.w)), ((r8.z) >= 0.0f ? (c[39].y) : (r18.w)), ((r8.z) >= 0.0f ? (c[39].w) : (r18.w)));
    r2.w = (-(r2.w)) + (-(c3.y));
    r5.xyz = float3(((r8.w) >= 0.0f ? (c[40].x) : (r5.x)), ((r8.w) >= 0.0f ? (c[40].y) : (r5.y)), ((r8.w) >= 0.0f ? (c[40].w) : (r5.z)));
    r2.x = (r2.w) * (r2.w);
    r14.xyz = float3(((r7.w) >= 0.0f ? (r2.y) : (r5.x)), ((r7.w) >= 0.0f ? (r2.y) : (r5.y)), ((r7.w) >= 0.0f ? (r2.y) : (r5.z)));
    r2.y = (r2.x) * (r2.x);
    ...
    r1.y = 1.0f / (r1.z);
    r2.xy = (r1.ww) * (c43.xy) + (c43.zw);
    r10.w = exp2(r2.y);
    r2.y = saturate(dot(r10.xyz, r3.xyz));
    r1.z = pow(abs(r2.y), r10.w);
    ...
    r1 = (v6.xxxx) * (c[31]) + (r1);
    r8.xyz = (r7.xyz) * (r0.xyz) + (r8.xyz);
    r1 = (v6.zzzz) * (c[33]) + (r1);
    r0.z = saturate((r6.w) * (c[30].x) + (c[30].y));
    r4 = (r1) + (c[34]);
    r0.y = (r0.z) * (c42.z) + (c42.w);
    r3.zw = r4.zw;
    r0.z = (r0.z) * (r0.z);
    r5.zw = r3.zw;
    r4.z = (r0.y) * (r0.z);
