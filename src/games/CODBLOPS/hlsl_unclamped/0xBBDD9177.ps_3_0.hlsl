// Mechanically reconstructed from 0xBBDD9177.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = (r1.w) * (-(c1.y)) + (c1.z);
    r3.x = rsqrt(r2.w);
    r9.xyz = (r3.xxx) * (v4.xyz);
    r2.xyz = normalize(v2.xyz);
    r3.z = saturate(dot(r2.xyz, -(r9.xyz)));
    r2.w = saturate(dot(r2.xyz, c[17].xyz));
    r3.y = (r3.z) * (r3.w) + (r4.z);
    r3.w = (r2.w) * (r3.w) + (r4.z);
    r4.xyz = (v4.xyz) * (-(r3.xxx)) + (c[17].xyz);
    r3.w = (r3.w) * (r3.y) + (c1.w);
    r4.w = (-(r3.z)) + (c0.y);
    r3.w = 1.0f / (r3.w);
    r6.w = (r2.w) * (r3.w);
    ...
    r1.w = c0.z;
    r3.xyz = float3(((r5.w) >= 0.0f ? (c[6].x) : (r1.w)), ((r5.w) >= 0.0f ? (c[6].y) : (r1.w)), ((r5.w) >= 0.0f ? (c[6].w) : (r1.w)));
    r0 = float4(((r5.w) >= 0.0f ? (r0.x) : (c0.z)), ((r5.w) >= 0.0f ? (r0.y) : (c0.z)), ((r5.w) >= 0.0f ? (r0.z) : (c0.z)), ((r5.w) >= 0.0f ? (r0.w) : (c0.z)));
    r5.w = max(abs(r2.y), abs(r2.z));
    r4.xyz = (r1.xyz) * (r3.zzz);
    r1.w = max(abs(r2.x), r5.w);
    r1.w = 1.0f / (r1.w);
