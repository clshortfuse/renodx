// Mechanically reconstructed from 0x83FF2E40.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c48 = float4(1.29999995f, 0.0f, 0.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r2.w = 1.0f / (r2.w);
    r1.w = (r1.w) * (r2.w);
    r4.xyz = lerp(r3.xyz, c0.zzz, r1.www);
    r2.xyz = (r2.xyz) * (r4.xyz);
    r0.xzw = (r0.xzw) * (c0.yyy) + (r2.xyz);
    r2.xyz = (-(r0.xzw)) + (c0.zzz);
    ...
    r0.y = (r9.x) * (r9.w);
    r5.z = c0.z;
    r0.y = (r0.y) * (-(c[44].x)) + (r5.z);
    r5.xyw = (r4.xyz) * (c[43].xyz) + (-(r4.xyz));
