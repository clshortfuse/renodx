// Mechanically reconstructed from 0x50CF45B0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = saturate(dot(r3.xyz, r1.xyz));
    ...
    r0.z = (r0.z) * (r9.w) + (c13.z);
    r5.xy = (r1.ww) * (c14.xy) + (c14.zw);
    r0.y = 1.0f / (r0.z);
    r3.w = exp2(r5.y);
    r0.z = pow(abs(r2.y), r3.w);
    r7.w = (r3.w) * (c3.x) + (c3.y);
    r0.y = (r5.w) * (r0.y);
    r0.z = (r0.z) * (r7.w);
    r5.y = (r2.w) * (r2.z);
    ...
    r13.xyz = (r0.xyz) * (-(r0.xyz)) + (c1.www);
    r14.xyz = (r0.xyz) * (r0.xyz);
    r2.xyz = (r1.xxx) * (r2.xyz);
    r0.xyz = (r13.xyz) * (r5.yyy) + (r14.xyz);
