// Mechanically reconstructed from 0x8A0AE5AE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = (r5.w) * (v0.z) + (c2.y);
    r0.z = exp2(-(r1.w));
    r4.xyz = float3(((r6.w) >= 0.0f ? (r4.x) : (r6.x)), ((r6.w) >= 0.0f ? (r4.y) : (r6.y)), ((r6.w) >= 0.0f ? (r4.z) : (r6.z)));
    r1.y = (r0.z) * (c3.x) + (c3.y);
