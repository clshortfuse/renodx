// Mechanically reconstructed from 0x4DA76EA0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.z = (r6.w) * (c4.y);
    r2.w = (r6.w) * (-(c4.y)) + (c4.x);
    r6.x = saturate(dot(r10.xyz, -(r0.xyz)));
    r1.w = (r7.w) * (r2.w) + (r6.z);
    r5.w = (r6.x) * (r2.w) + (r6.z);
    r1.w = (r1.w) * (r5.w) + (c3.z);
