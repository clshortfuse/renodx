// Mechanically reconstructed from 0xB8F9B405.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.y = dot(r6.xy, r6.xy) + (c16.z);
    r1.w = dot(r2.xy, r2.xy) + (c16.z);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r3.w = (r1.y) * (c3.y) + (c3.z);
    r1.y = (r1.w) * (c3.y) + (c3.z);
    r1.w = dot(r2.xy, r6.xy) + (c16.z);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c11.xx);
