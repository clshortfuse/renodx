// Mechanically reconstructed from 0xE8058CFE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = c1.x;
    r4.xyz = (r6.www) + (-(c[28].xyw));
    r0 = v2;
    r0.xyz = (r7.xxx) * (v5.xyz) + (r0.xyz);
    r4.xyz = (r9.www) * (r4.xyz) + (c[28].xyw);
    r0.xyz = (r7.yyy) * (v4.xyz) + (r0.xyz);
    r7.xyz = lerp(r4.xyz, c1.xxx, r5.www);
    ...
    r0.z = (r3.w) * (-(c13.z)) + (c13.w);
    r2.w = saturate(dot(r9.xyz, -(r11.xyz)));
    r4.w = (r1.w) * (r0.z) + (r0.y);
    r6.z = (r2.w) * (r0.z) + (r0.y);
    r0.xyz = (r1.www) * (c[21].xyz);
    r4.w = (r4.w) * (r6.z) + (c3.x);
    r6.xyz = (r8.www) * (r0.xyz) + (r4.xyz);
    r0.z = 1.0f / (r4.w);
    r7.w = (r1.w) * (r0.z);
    r4.xyz = (r10.xyz) * (r10.www) + (-(r11.xyz));
