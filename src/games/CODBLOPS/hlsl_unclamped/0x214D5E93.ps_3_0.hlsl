// Mechanically reconstructed from 0x214D5E93.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = (r0) + (c[27]);
    r4.xy = (r0.ww) * (c[28].xy) + (r0.xy);
    r4.zw = r0.zw;
    r2 = tex2Dproj(s2, r4);
    r3.zw = r4.zw;
    r0.zw = r3.zw;
    r5.xy = (r4.ww) * (-(c[28].zw)) + (r0.xy);
    r5.zw = r0.zw;
    r5 = tex2Dproj(s2, r5);
    r2.w = r5.x;
    r3.xy = (r4.ww) * (-(c[28].xy)) + (r0.xy);
    r0.xy = (r4.ww) * (c[28].zw) + (r0.xy);
    r3 = tex2Dproj(s2, r3);
    r2.y = r3.x;
    r3 = tex2Dproj(s2, r0);
