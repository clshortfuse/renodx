// Mechanically reconstructed from 0x8751DCE7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = (r7.w) * (r0.z);
    r4.xyz = (r8.xyz) * (r0.xxx) + (r9.xyz);
    r1.xyz = (r0.yyy) * (r6.xyz) + (r12.xyz);
