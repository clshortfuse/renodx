// Mechanically reconstructed from 0x2F90339B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.x = dot(r4.xy, r0.xy) + (c0.w);
    r2 = tex2D(s1, v1.xy);
    r0.xy = (r2.wy) * (c1.xy) + (c1.zw);
    r2 = tex2D(s3, v6.xy);
    r2.w = (r2.w) * (v0.y);
    r3.y = dot(r4.xy, r0.zw) + (c0.w);
