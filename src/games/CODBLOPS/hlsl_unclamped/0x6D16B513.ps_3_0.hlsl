// Mechanically reconstructed from 0x6D16B513.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = c1.y;
    r6.xyz = float3(((r0.w) >= 0.0f ? (r1.w) : (c[29].x)), ((r0.w) >= 0.0f ? (r1.w) : (c[29].y)), ((r0.w) >= 0.0f ? (r1.w) : (c[29].w)));
    ...
    r1 = tex2D(s5, v7.zw);
    r0 = v2;
    r7.xyz = (r8.xxx) * (v5.xyz) + (r0.xyz);
    r0.xyz = (r1.xyz) + (c1.zzz);
    r1.xyz = (r8.yyy) * (v4.xyz) + (r7.xyz);
