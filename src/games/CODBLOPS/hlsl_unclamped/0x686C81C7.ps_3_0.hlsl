// Mechanically reconstructed from 0x686C81C7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(-0.5f, 1.0f, 0.959999979f, 0.0399999991f);
