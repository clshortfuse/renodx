// Mechanically reconstructed from 0x1082A34E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = float3(((r5.w) >= 0.0f ? (c[29].x) : (r3.y)), ((r5.w) >= 0.0f ? (c[29].y) : (r3.y)), ((r5.w) >= 0.0f ? (c[29].w) : (r3.y)));
