// Mechanically reconstructed from 0x6A41C1FF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c11 = float4(4.0f, -2.0f, 0.0009765625f, 3.0f);
