// Mechanically reconstructed from 0xADDF532D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = c1.y;
    r4.xyz = float3(((r4.w) >= 0.0f ? (r6.w) : (c[28].x)), ((r4.w) >= 0.0f ? (r6.w) : (c[28].y)), ((r4.w) >= 0.0f ? (r6.w) : (c[28].w)));
