// Mechanically reconstructed from 0x6DA5D376.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r14.xy = float2(((r1.w) >= 0.0f ? (r2.w) : (r3.w)), ((r1.w) >= 0.0f ? (r2.y) : (r3.y)));
    r3.w = saturate(dot(r9.xyz, r8.xyz));
    r0.y = (r14.x) * (c12.x);
    r0.z = (r14.x) * (-(c12.x)) + (c12.y);
    ...
    r2.w = dot(r15.xy, r15.xy) + (c2.x);
    r0.z = dot(r0.xy, r0.xy) + (c2.x);
    r2.w = exp2(-(r2.w));
    r0.z = exp2(-(r0.z));
    r2.w = (r2.w) * (c2.y) + (c2.z);
    r2.y = (r0.z) * (c2.y) + (c2.z);
    r0.z = dot(r0.xy, r15.xy) + (c2.x);
    r0.y = (r2.w) * (r2.y);
    r3 = tex2D(s14, v1.zw);
    r8.xy = (r3.xy) * (c3.xx);
