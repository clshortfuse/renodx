// Mechanically reconstructed from 0xBEE54BED.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c14 = float4(4.0f, -3.0f, -4.0f, 31.875f);
    const float4 c15 = float4(-2.0f, -0.5f, 0.5f, 2.0f);
    const float4 c16 = float4(0.00249999994f, -1.0f, 0.25f, -0.0f);
    const float4 c19 = float4(4.0f, -2.0f, 8.0f, 0.0f);
    const float4 c54 = float4(1.0f, 0.5f, 0.0f, 1000.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r6.xy = (r2.xz) * (r5.xx);
    r0.w = (r1.x) * (c14.w) + (-(r6.x));
    r4.xy = (r0.xz) * (r5.yy);
    r0.y = (r2.z) * (-(r5.x)) + (r0.w);
    r0.w = (r1.y) * (c14.w) + (-(r4.x));
    r0.w = (r0.z) * (-(r5.y)) + (r0.w);
    r10.y = (r0.y) + (r0.y);
    r5.y = (r0.w) + (r0.w);
    r3 = (-(v7.yyyy)) + (c[6]);
    ...
    r1.w = dot(r0, c16.zzzz);
    r1.y = (r1.z) * (c12.x) + (c12.y);
    r1.z = (r1.z) * (r1.z);
    r0 = (v7.xyzx) * (-(c16.yyyw)) + (-(c16.wwwy));
    r1.z = (r1.y) * (r1.z);
    r1.y = dot(r0, c[27]);
    r2.w = 1.0f / (r1.y);
    r2.x = dot(r0, c[26]);
    ...
    r1.xyz = max(((r0.xyz) * (c[40].xxx)), 0.0f); // HDR: removed only the 1.0 ceiling
