// Mechanically reconstructed from 0x3E2FA43E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = lerp(r4.y, c4.x, r8.w);
    r2.w = dot(r9.xyz, r0.xyz);
    r1.w = lerp(r3.w, c4.x, r5.w);
    r2.w = (r2.w) + (r2.w);
    ...
    r4.w = (r7.w) * (r3.w) + (r7.z);
    r3.w = (r2.w) * (r3.w) + (r7.z);
    r7.xyz = lerp(r3.xyz, r2.xyz, r8.www);
    r2.z = (r3.w) * (r4.w) + (c3.w);
    r3.w = 1.0f / (r2.z);
    r2.xyz = normalize(r9.xyz);
    r3.w = (r2.w) * (r3.w);
    r3.z = saturate(dot(r2.xyz, r8.xyz));
    r0.y = saturate(dot(r0.xyz, r2.xyz));
    r0.z = (-(r3.z)) + (c4.x);
    r2.z = pow(abs(r0.y), r6.w);
    r0.x = (r0.z) * (r0.z);
    ...
    r2.z = (r3.w) * (r0.y);
    r2.y = (r0.z) * (c1.z) + (c1.w);
    r0.xyz = lerp(r7.xyz, r1.xyz, r5.www);
    r1.z = (r2.z) * (r2.y);
    r0.xyz = (r0.xyz) * (r0.xyz);
