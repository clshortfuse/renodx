// Mechanically reconstructed from 0xE4731521.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c30 = float4(-1.0f, 1.0f, 0.200000003f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r5.xyz = (v0.yyy) * (r0.xyz) + (c30.yyy);
    r4.xyz = (r5.xyz) * (c30.zzz);
    r0 = tex2D(s6, v8.zw);
    r2.xyz = (r0.xyz) + (c30.xxx);
    r0.w = dot(v7.xyz, v7.xyz);
    r0.xyz = (-(v7.xyz)) + (c[5].xyz);
    r1.z = rsqrt(r0.w);
    r0.w = dot(r0.xyz, r0.xyz);
    r0.w = rsqrt(r0.w);
    r14.xyz = (r1.zzz) * (v7.xyz);
    r3.xyz = (v0.zzz) * (r2.xyz) + (c30.yyy);
    r6.xyz = (r0.xyz) * (r0.www) + (-(r14.xyz));
    r2.xyz = normalize(r6.xyz);
    r9.xyz = (r0.xyz) * (r0.www);
    r4.xyz = (r4.xyz) * (r3.xyz);
    r0.w = saturate(dot(r2.xyz, r9.xyz));
    r11.xyz = (r4.xyz) * (-(r4.xyz)) + (c30.yyy);
    r1.x = (-(r0.w)) + (c30.y);
    r10.w = (r1.w) * (-(c4.z)) + (c4.w);
    r0.w = (r1.x) * (r1.x);
    r2.w = (r0.w) * (r0.w);
    r0 = v2;
    ...
    r1.x = saturate(dot(r13.xyz, r2.xyz));
    r11.w = (r1.w) * (c1.w);
    r3.w = saturate(dot(r9.xyz, r13.xyz));
    r12.w = saturate(dot(r13.xyz, -(r14.xyz)));
    ...
    r0.y = 1.0f / (r0.z);
    r8.w = exp2(r17.y);
    r0.z = pow(abs(r1.x), r8.w);
    r1.x = (r8.w) * (c12.y) + (c12.z);
    r2.z = (r3.w) * (r0.y);
    r2.w = (r0.z) * (r1.x);
    ...
    r6.xyz = (r1.yyy) * (r4.xyz);
    r0.xyz = (r3.xyz) * (r0.xyz);
    r8.xyz = (r0.xyz) * (r0.xyz);
    r0.z = dot(r10.xy, r10.xy) + (c30.w);
    ...
    r4.xy = (r4.xz) * (r0.xx);
    r0.z = dot(r7.xy, r10.xy) + (c30.w);
    r2.w = (r3.x) * (c3.w) + (-(r4.x));
    r2.w = (r4.z) * (-(r0.x)) + (r2.w);
    r2.xy = (r2.xz) * (r0.yy);
    r3.w = (r3.y) * (c3.w) + (-(r2.x));
    r0.x = dot(r7.xy, r7.xy) + (c30.w);
    r0.y = (r2.z) * (-(r0.y)) + (r3.w);
    r0.x = exp2(-(r0.x));
    r10.y = (r2.w) + (r2.w);
    r0.x = (r0.x) * (c1.x) + (c1.y);
    ...
    r0.xyz = (r0.xyz) * (r2.www);
    r10.xz = (r4.xy) * (c4.xx);
    r7.xyz = (r8.xyz) * (r5.xyz) + (r6.xyz);
    r0.xyz = (r10.xyz) * (r5.www) + (r0.xyz);
    r16.xyz = (r1.yyy) * (r0.xyz);
    r7.w = saturate(dot(r13.xyz, c[17].xyz));
    r2 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r2.y)) >= 0.0f ? (c30.y) : (c30.w));
    ...
    r2.xyz = (r11.xyz) * (r4.www) + (r12.xyz);
    r1.xyz = (r1.xyz) * (c[19].xyz);
    r0.xyz = (r0.xyz) * (r2.xyz);
    r1.xyz = (r3.www) * (r1.xyz);
    r8.xyz = (r8.xyz) * (r3.xyz) + (r1.xyz);
    r1 = (v7.yyyy) * (c[25]);
    ...
    r2.xy = (r2.xy) * (r2.xy);
    r0.z = ((-abs(r0.z)) >= 0.0f ? (c30.w) : (r2.w));
    r2.w = (r3.x) * (r2.x);
    r0.z = (r0.z) * (r2.w);
    r2.w = (r2.y) * (-(r3.y)) + (c30.y);
    r0.xy = (r3.ww) * (r0.xy);
    r0.z = (r0.z) * (r2.w);
    r3.w = (r4.z) * (r0.z);
