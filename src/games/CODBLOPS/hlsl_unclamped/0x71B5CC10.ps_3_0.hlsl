// Mechanically reconstructed from 0x71B5CC10.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = float2(((r6.z) >= 0.0f ? (r1.x) : (c1.w)), ((r6.z) >= 0.0f ? (r1.y) : (c1.w)));
    ...
    r7.xy = lerp(r4.xy, r2.xy, r6.ww);
    r4 = tex2D(s7, v0.xy);
    r2 = (r4.wwww) * (c3.xxxy) + (c3.zzzx);
    r10.xyz = (r3.xyz) * (r3.xyz);
    r5 = float4(((r6.z) >= 0.0f ? (r2.x) : (-(c1.w))), ((r6.z) >= 0.0f ? (r2.y) : (-(c1.w))), ((r6.z) >= 0.0f ? (r2.z) : (-(c1.w))), ((r6.z) >= 0.0f ? (r2.w) : (-(c1.y))));
    r2 = tex2D(s8, v7.zw);
    ...
    r1.y = saturate(dot(r14.xyz, r0.xyz));
    r14.w = (r3.w) * (c4.z);
    r1.z = saturate(dot(r9.xyz, r14.xyz));
    r16.w = saturate(dot(r14.xyz, -(r15.xyz)));
    r0.z = (r1.z) * (r13.w) + (r14.w);
    r12.w = (r16.w) * (r13.w) + (r14.w);
    r0.z = (r0.z) * (r12.w) + (c13.x);
    r17.xy = (r3.ww) * (c31.xy) + (c31.zw);
    r0.y = 1.0f / (r0.z);
    r11.w = exp2(r17.y);
    ...
    r1.x = (r1.x) * (r1.y);
    r1.y = ((r6.z) >= 0.0f ? (r4.y) : (c1.w));
    r0.xyz = (r0.xyz) * (r1.xxx);
    r13.xyz = lerp(r1.yyy, c[29].xyw, r6.www);
