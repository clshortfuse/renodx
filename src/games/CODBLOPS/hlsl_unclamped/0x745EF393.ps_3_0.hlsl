// Mechanically reconstructed from 0x745EF393.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.x = saturate(dot(r3.xyz, r0.xyz));
    ...
    r2.z = (r0.z) * (r0.w);
    r0 = tex2D(s0, v1.xy);
    r4.xyz = lerp(r0.xyz, c0.xxx, r2.xxx);
    r13.xyz = (r4.xyz) * (-(r4.xyz)) + (c0.www);
