// Mechanically reconstructed from 0xA4F0B935.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.w = rsqrt(r2.y);
    r2.x = 1.0f / (r5.w);
    r1.xy = saturate((r2.xx) * (c[21].xy) + (c[21].zw));
    r0.xy = (r1.xy) * (r1.xy);
    ...
    r0 = tex2D(s0, v1.xy);
    r7.w = (r0.w) * (v0.w) + (c0.x);
    r3.xy = float2(((r7.w) >= 0.0f ? (r3.x) : (c0.z)), ((r7.w) >= 0.0f ? (r3.y) : (c0.z)));
    r2.w = r1.x;
    r1 = v2;
    ...
    r3.w = saturate((r2.w) * (c[11].x) + (c[11].y));
    ...
    r5.w = (r8.w) * (r2.w);
    r6.z = saturate(dot(r1.xyz, r2.xyz));
    ...
    r2.w = c0.z;
    r5.xyz = float3(((r7.w) >= 0.0f ? (c[23].x) : (r2.w)), ((r7.w) >= 0.0f ? (c[23].y) : (r2.w)), ((r7.w) >= 0.0f ? (c[23].w) : (r2.w)));
    r5.w = 1.0f / (r6.x);
    r3.xyz = (r2.xyz) * (r5.zzz);
    r2 = tex2D(s5, v1.xy);
    r3.xyz = (r3.xyz) * (r2.www);
    r11.xy = c[9].xy;
    r6.xyz = (r11.yyy) * (c[8].xyz);
    r3.w = (r3.w) * (c0.w);
