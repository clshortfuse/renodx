// Mechanically reconstructed from 0x5CD778FB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.y = pow(abs(r7.w), r10.w);
    r7.w = (r10.w) * (c13.x) + (c13.y);
    r1.x = 1.0f / (r1.x);
    r1.y = (r1.y) * (r7.w);
    r3.w = (r3.w) * (r1.x);
    r4.w = (r4.w) * (r1.y);
    ...
    r1.w = (r9.w) * (r10.y) + (r10.x);
    r7.z = (r1.w) * (r10.z) + (c3.w);
    ...
    r3.xyz = (r0.xyz) * (r5.xyz) + (r1.xyz);
    r1 = (v7.yyyy) * (c[32]);
    r8.xyz = (r4.xyz) * (c1.www) + (r3.xyz);
    r1 = (v7.xxxx) * (c[31]) + (r1);
    ...
    r6 = tex2Dproj(s3, r4);
    r2.x = r6.x;
    r1.xy = (r4.ww) * (c[35].zw) + (r5.xy);
    r1 = tex2Dproj(s3, r1);
    r2.z = r1.x;
    r1 = (v7.xyzx) * (c4.xxxw) + (c4.wwwx);
    r7.w = dot(r2, c13.yyyy);
    r2.w = dot(r1, c[28]);
    r2.w = 1.0f / (r2.w);
    r3.x = dot(r1, c[27]);
    r2.x = dot(r1, c[25]);
    ...
    r2.x = c[36].w;
    r1.xy = (c[38].xy) * (-(r2.xx)) + (v1.xy);
    r1 = tex2D(s7, r1.xy);
    r2.xy = (c[39].xy) * (-(r2.xx)) + (v1.xy);
    r2 = tex2D(s6, r2.xy);
