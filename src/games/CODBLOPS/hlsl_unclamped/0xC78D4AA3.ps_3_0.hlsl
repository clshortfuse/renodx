// Mechanically reconstructed from 0xC78D4AA3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = dot(r14.xyz, r11.xyz);
    r0.xyz = (r7.www) * (r0.xyz) + (c[24].xyw);
    r1.w = (r1.w) + (r1.w);
    r8.xyz = lerp(r0.xyz, c1.xxx, r6.www);
    r4.xyz = (r11.xyz) * (-(r1.www)) + (r14.xyz);
    r2 = tex2D(s6, v1.xy);
    r4.w = (r2.w) * (c1.w);
    r4 = texCUBElod(s15, r4);
    r3.w = saturate(dot(r11.xyz, -(r14.xyz)));
    r1.w = (-(r3.w)) + (c1.x);
    ...
    r4.xyz = (r2.xyz) * (r1.www) + (r10.xyz);
    r6.xyz = (r6.xyz) * (r8.yyy);
    r0.xyz = (r0.xyz) * (r4.xyz);
    r13.xyz = (r13.xyz) * (r5.www) + (-(r14.xyz));
    ...
    r1.w = saturate(dot(r12.xyz, r11.xyz));
    r3.w = (r3.w) * (r0.z) + (r0.y);
    r2.w = (r1.w) * (r0.z) + (r0.y);
    r0.xyz = lerp(r14.xyz, r1.xyz, r6.www);
    r1.z = (r2.w) * (r3.w) + (c3.x);
    r2.w = 1.0f / (r1.z);
    r1.xyz = normalize(r13.xyz);
    r2.w = (r1.w) * (r2.w);
    r3.w = saturate(dot(r1.xyz, r12.xyz));
    r1.y = saturate(dot(r11.xyz, r1.xyz));
    r1.z = (-(r3.w)) + (c1.x);
    r3.w = pow(abs(r1.y), r5.w);
    r1.x = (r1.z) * (r1.z);
    r1.y = (r5.w) * (c3.y) + (c3.z);
    r1.x = (r1.x) * (r1.x);
    r1.y = (r3.w) * (r1.y);
