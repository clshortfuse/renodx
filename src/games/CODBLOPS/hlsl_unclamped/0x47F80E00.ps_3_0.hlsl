// Mechanically reconstructed from 0x47F80E00.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = (r0.x) * (r0.y);
    r0.z = (r1.w) * (r0.z);
    r12.xyz = (r0.xxx) * (c[18].xyz);
    r0.z = (r0.y) * (r0.z);
    r0.xyz = (r2.xyz) * (r0.zzz);
    r8.w = ((r4.w) >= 0.0f ? (r3.y) : (r4.y));
    r1.w = (r2.w) * (c3.w);
    ...
    r1.xy = (r3.yw) * (c13.xx) + (c13.yy);
    r2.w = dot(r13.xy, r13.xy) + (c3.x);
    r1.z = dot(r1.xy, r1.xy) + (c3.x);
    r2.w = exp2(-(r2.w));
    r1.z = exp2(-(r1.z));
    r2.w = (r2.w) * (c2.x) + (c2.y);
    r2.z = (r1.z) * (c2.x) + (c2.y);
    r1.z = dot(r1.xy, r13.xy) + (c3.x);
    r1.y = (r2.w) * (r2.z);
    r4 = tex2D(s14, v1.zw);
    r8.xy = (r4.xy) * (c2.ww);
