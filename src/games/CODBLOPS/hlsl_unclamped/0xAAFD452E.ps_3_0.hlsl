// Mechanically reconstructed from 0xAAFD452E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s5, v7.xy);
    r4.w = (r0.w) * (v0.y) + (c3.w);
    r6.xy = float2(((r4.w) >= 0.0f ? (r1.x) : (r3.x)), ((r4.w) >= 0.0f ? (r1.y) : (r3.y)));
    ...
    r3 = tex2D(s10, v7.xy);
    r0 = (r3.wwww) * (c4.xxxy) + (c4.zzzx);
    r1 = tex2D(s9, v1.xy);
    r2 = float4(((r4.w) >= 0.0f ? (r0.x) : (r1.x)), ((r4.w) >= 0.0f ? (r0.y) : (r1.y)), ((r4.w) >= 0.0f ? (r0.z) : (r1.z)), ((r4.w) >= 0.0f ? (r0.w) : (r1.w)));
    r0 = tex2D(s6, v7.zw);
    r3.w = (r0.w) * (v0.z) + (c3.w);
    r4.xyz = float3(((r3.w) >= 0.0f ? (r0.x) : (r4.x)), ((r3.w) >= 0.0f ? (r0.y) : (r4.y)), ((r3.w) >= 0.0f ? (r0.z) : (r4.z)));
    r7.xy = float2(((r3.w) >= 0.0f ? (r5.x) : (r6.x)), ((r3.w) >= 0.0f ? (r5.y) : (r6.y)));
    r1 = tex2D(s11, v7.zw);
    r0 = (r1.wwww) * (c4.xxxy) + (c4.zzzx);
    r3.xyz = float3(((r4.w) >= 0.0f ? (r3.y) : (c[39].x)), ((r4.w) >= 0.0f ? (r3.y) : (c[39].y)), ((r4.w) >= 0.0f ? (r3.y) : (c[39].w)));
