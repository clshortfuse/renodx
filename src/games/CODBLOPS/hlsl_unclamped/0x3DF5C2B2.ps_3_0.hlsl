// Mechanically reconstructed from 0x3DF5C2B2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.w = (r4.w) * (r1.w);
    r6.w = saturate(dot(r2.xyz, r3.xyz));
    ...
    r7.xyz = (r7.xyz) * (c[31].yyy);
    r0.xyz = (r8.xxx) * (c[7].xyz);
    r7.xyz = (r7.xyz) * (c1.yyy);
    r0.xyz = (r4.www) * (r0.xyz);
    r5.xyz = (r4.xyz) * (r5.xyz);
    r4.xyz = (r4.xyz) * (r0.xyz) + (r7.xyz);
    r0 = tex2D(s0, v1.xy);
