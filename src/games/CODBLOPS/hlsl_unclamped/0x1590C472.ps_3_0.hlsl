// Mechanically reconstructed from 0x1590C472.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xy = float2(((r3.w) >= 0.0f ? (r1.w) : (r2.w)), ((r3.w) >= 0.0f ? (r1.y) : (r2.y)));
    r0.w = (r0.w) + (r0.w);
