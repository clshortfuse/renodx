// Mechanically reconstructed from 0xD6D80539.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = (r4.xyz) * (-(r4.xyz)) + (c4.www);
    r4.xyz = (r1.yyy) * (r4.xyz) + (r1.xzw);
    ...
    r9 = tex2D(s8, v4.xy);
    r9.xyz = saturate((r9.xyz) * (c12.yyy));
    ...
    r8.xyz = (r2.xyz) * (r8.xyz) + (r1.yzw);
    r2 = max(r8, c1.xxxx);
    r1.y = saturate((r0.x) * (c16.y));
    r1.y = rsqrt(r1.y);
    r1.y = 1.0f / (r1.y);
    r3.xyz = lerp(r2.xyz, r4.xyz, r1.yyy);
    r1.yz = (r0.xx) + (c16.zw);
    r1.yz = saturate((r1.yz) * (c14.xx));
    r0.x = rsqrt(r1.y);
    r0.x = 1.0f / (r0.x);
    ...
    r0.x = rsqrt(r1.z);
    r0.x = 1.0f / (r0.x);
    r1.yzw = (r6.xyz) * (c14.yyy) + (-(r2.xyz));
    r1.yzw = (r0.xxx) * (r1.yzw) + (r2.xyz);
    r0.x = ((r1.x) >= 0.0f ? (c1.z) : (c1.x));
    oC0.w = (r2.w) * (r0.x);
    r2 = (c[6]) + (-(v1.xxxx));
    r3 = (c[7]) + (-(v1.yyyy));
    r4 = (c[8]) + (-(v1.zzzz));
