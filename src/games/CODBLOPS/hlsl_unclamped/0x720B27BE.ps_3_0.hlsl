// Mechanically reconstructed from 0x720B27BE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = rsqrt(r0.w);
    r13.xyz = (r3.www) * (v6.xyz);
    r0.w = (r1.w) * (r1.w);
    r1.xyz = (r0.xyz) * (r2.www) + (-(r13.xyz));
    r12.xyz = normalize(r1.xyz);
    r14.xyz = (r0.xyz) * (r2.www);
    r0.z = (r0.w) * (r0.w);
    r0.w = saturate(dot(r12.xyz, r14.xyz));
    r8.w = (r1.w) * (r0.z);
    r0.y = (-(r0.w)) + (c1.z);
    r0.w = dot(r14.xyz, c[29].xyz);
    r0.z = (r0.y) * (r0.y);
    r0.x = (r0.z) * (r0.z);
    ...
    r10.xyz = float3(((r11.w) >= 0.0f ? (r1.y) : (c[36].x)), ((r11.w) >= 0.0f ? (r1.y) : (c[36].y)), ((r11.w) >= 0.0f ? (r1.y) : (c[36].w)));
    r9.w = saturate(dot(r9.xyz, c[17].xyz));
    r16.xyz = (r3.xyz) * (r10.yyy);
    r15.xyz = (r9.www) * (c[18].xyz);
    if ((r2.w) != (-(r2.w)))
    {
        r0.z = r2.y;
        r3.w = r0.z;
    ...
    r1 = (r1.wwww) * (c1.yyyz) + (c1.wwwy);
    r2 = tex2D(s6, v0.xy);
    r2 = float4(((r11.w) >= 0.0f ? (r1.x) : (r2.x)), ((r11.w) >= 0.0f ? (r1.y) : (r2.y)), ((r11.w) >= 0.0f ? (r1.z) : (r2.z)), ((r11.w) >= 0.0f ? (r1.w) : (r2.w)));
    ...
    r10.y = (r2.w) * (c3.w);
    r5.w = saturate(dot(r14.xyz, r9.xyz));
    r2.z = saturate(dot(r9.xyz, -(r13.xyz)));
    r1.w = (r5.w) * (r6.w) + (r10.y);
    r4.w = (r2.z) * (r6.w) + (r10.y);
    r1.z = (r1.w) * (r4.w) + (c15.x);
    r1.w = dot(r13.xyz, r9.xyz);
    r6.z = 1.0f / (r1.z);
    r1.z = (r1.w) + (r1.w);
    r1.w = (r2.w) * (c3.z);
    r1.xyz = (r9.xyz) * (-(r1.zzz)) + (r13.xyz);
    r1 = texCUBElod(s15, r1);
    r1.w = (-(r2.z)) + (c1.z);
    r2.z = (r1.w) * (r1.w);
    r6.xy = (r2.ww) * (c38.xy) + (c38.zw);
    r1.w = (r1.w) * (r2.z);
    r2.w = 1.0f / (r6.x);
    ...
    r6.y = exp2(r6.y);
    r6.z = saturate(dot(r9.xyz, r12.xyz));
    r1.w = (r6.y) * (c15.y) + (c15.z);
    r1.z = (r9.w) * (r6.w) + (r10.y);
    r1.z = (r1.z) * (r4.w) + (c15.x);
    r4.w = saturate(dot(r9.xyz, r11.xyz));
    r1.y = 1.0f / (r1.z);
    r1.z = pow(abs(r4.w), r6.y);
    r1.y = (r9.w) * (r1.y);
    r1.z = (r1.w) * (r1.z);
    r6.w = (r1.y) * (r1.z);
    r1.xyz = (r4.xyz) * (r8.www) + (r5.xyz);
    r4.w = pow(abs(r6.z), r6.y);
