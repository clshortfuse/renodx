// Mechanically reconstructed from 0x909642E7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s9, v7.xy);
    r0 = (r1.wwww) * (-(c43.zzzy)) + (-(c43.wwwz));
    r3 = tex2D(s8, v1.xy);
    r2 = lerp(r3, r0, r7.wwww);
    r0 = tex2D(s6, v7.zw);
    r4.w = (r0.w) * (v0.z);
    r4.xyz = lerp(c[39].xyw, r1.yyy, r7.www);
    r3.xyz = lerp(r5.xyz, r0.xyz, r4.www);
    r1 = tex2D(s10, v7.zw);
    r0 = lerp(r2, r1, r4.wwww);
    r7.xy = (r4.ww) * (-(r6.xy)) + (r6.xy);
    r13.xyz = lerp(r4.xyz, c[40].xyw, r4.www);
    r1.w = dot(r7.xy, r7.xy) + (c43.z);
    ...
    r8.xy = (r3.xz) * (r4.xx);
    r1.w = dot(r6.xy, r7.xy) + (c43.z);
    r1.y = (r2.x) * (c4.w) + (-(r8.x));
    r2.w = (r3.z) * (-(r4.x)) + (r1.y);
    r3.xy = (r1.xz) * (r4.yy);
    r1.y = (r2.y) * (c4.w) + (-(r3.x));
    r1.x = dot(r6.xy, r6.xy) + (c43.z);
    r1.y = (r1.z) * (-(r4.y)) + (r1.y);
    r1.z = exp2(-(r1.x));
    r9.y = (r2.w) + (r2.w);
    r1.z = (r1.z) * (c3.x) + (c3.y);
