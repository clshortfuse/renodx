// Mechanically reconstructed from 0x4CD96B61.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.y = dot(r1.xy, r0.zw) + (c3.z);
    r3.x = dot(r1.xy, r0.xy) + (c3.z);
    r2 = tex2D(s1, v1.xy);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r3.w = (r0.w) * (v0.y) + (c3.w);
    ...
    r5.xy = float2(((r3.w) >= 0.0f ? (r3.x) : (r2.x)), ((r3.w) >= 0.0f ? (r3.y) : (r2.y)));
    r0.xyz = (v0.zzz) * (r0.xyz) + (-(c3.yyy));
    ...
    r1 = tex2D(s14, v1.zw);
    r8.xy = (r1.xy) * (c12.yy);
    r9.xy = (r2.yw) * (c12.zz) + (c12.ww);
    r2.xy = (r2.xz) * (r8.xx);
    r0.w = dot(r9.xy, r5.xy) + (c3.z);
    r0.y = (r1.x) * (c12.y) + (-(r2.x));
    r1.w = (r2.z) * (-(r8.x)) + (r0.y);
    r7.xy = (r0.xz) * (r8.yy);
    r0.y = (r1.y) * (c12.y) + (-(r7.x));
    ...
    r0.z = (r0.z) * (r0.x);
    r15.xy = float2(((r3.w) >= 0.0f ? (-(c3.z)) : (r0.y)), ((r3.w) >= 0.0f ? (-(c3.y)) : (r0.y)));
