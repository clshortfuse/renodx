// Mechanically reconstructed from 0x6F4299D2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = c2.w;
    r5.xyz = float3(((r2.w) >= 0.0f ? (r6.w) : (c[23].x)), ((r2.w) >= 0.0f ? (r6.w) : (c[23].y)), ((r2.w) >= 0.0f ? (r6.w) : (c[23].w)));
    r1 = tex2D(s6, v6.zw);
    r4.xyz = v2.xyz;
