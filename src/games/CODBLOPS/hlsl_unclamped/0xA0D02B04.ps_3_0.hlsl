// Mechanically reconstructed from 0xA0D02B04.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = rsqrt(r0.z);
    r3.xyz = (r6.www) * (v7.xyz);
    r2.xyz = (r1.xyz) * (r0.zzz) + (-(r3.xyz));
    ...
    r0.w = (r0.z) * (r0.z);
    r1.xy = (c[38].zz) * (r6.xy) + (r0.xy);
    r0.w = (r0.w) * (r0.w);
    r7.w = dot(r5.xyz, c[30].xyz);
    r4.w = (r0.z) * (r0.w);
    r0 = tex2D(s0, v1.xy);
    r3.w = (r0.w) * (v0.w) + (c1.x);
    r0 = (r0.xyzx) * (c1.yyyz) + (c1.zzzy);
    r6.xy = float2(((r3.w) >= 0.0f ? (r1.x) : (c1.z)), ((r3.w) >= 0.0f ? (r1.y) : (c1.z)));
    ...
    r2.w = (r2.w) * (c1.w);
    r2.xyz = (r9.xyz) * (-(r2.zzz)) + (r3.xyz);
    r2 = texCUBElod(s15, r2);
    r0.xyz = (r2.xyz) * (r2.xyz);
    r4.xyz = (r0.xyz) * (c1.www);
    r11.xyz = (r14.xyz) * (r5.zzz) + (r15.xyz);
    r2 = tex3D(s11, v8.xyz);
    r0.xyz = (r2.xyz) * (r2.xyz);
    r3.xyz = (v7.xyz) * (-(r6.www)) + (c[17].xyz);
    r2.xyz = (r4.xyz) * (r0.xyz);
    r0.xyz = normalize(r3.xyz);
    r10.xyz = (r2.xyz) * (c3.xxx);
    r2.w = saturate(dot(r0.xyz, c[17].xyz));
    r3.z = max(abs(r9.y), abs(r9.z));
    r2.z = (-(r2.w)) + (c1.y);
    r2.w = max(abs(r9.x), r3.z);
    r2.y = (r2.z) * (r2.z);
    r2.w = 1.0f / (r2.w);
    r2.y = (r2.y) * (r2.y);
    r9.w = (r2.z) * (r2.y);
    r0.z = saturate(dot(r9.xyz, r0.xyz));
    r2.z = pow(abs(r0.z), r5.w);
    ...
    r0.xyz = (r2.xyz) * (r2.xyz);
    r16.yz = c1.yz;
    r7.xyz = float3(((r3.w) >= 0.0f ? (c[37].x) : (r16.z)), ((r3.w) >= 0.0f ? (c[37].y) : (r16.z)), ((r3.w) >= 0.0f ? (c[37].w) : (r16.z)));
    r0.xyz = (r0.xyz) * (r7.yyy);
    r7.y = saturate(dot(r9.xyz, c[17].xyz));
    r13.xyz = (r0.xyz) * (c3.xxx);
    r12.xyz = (r7.yyy) * (c[18].xyz);
    if ((c1.y) >= (v6.w))
    {
        r3 = (v6.xyzx) * (c1.yyyz);
        r2 = (r3) + (-(c13.xyzz));
