// Mechanically reconstructed from 0x9ECBCB5A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = rsqrt(r0.w);
    r12.xyz = (r1.xxx) * (v3.xyz);
    r8.xyz = normalize(v1.xyz);
    r1.y = saturate(dot(r8.xyz, -(r12.xyz)));
    r0 = tex2D(s2, v0.xy);
    r2.z = (r0.w) * (c0.z);
    r1.z = (r0.w) * (-(c0.z)) + (c0.x);
    ...
    r0.xyz = (r6.xyz) * (r1.www) + (r10.xyz);
    r7.w = c0.x;
    r2.xyz = (r7.www) + (-(c[20].xyw));
    r1 = tex2D(s1, v4.zw);
    r6.w = (r1.w) * (v4.y);
    r0.xyz = (r2.www) * (r0.xyz);
    r11.xyz = (r6.www) * (r2.xyz) + (c[20].xyw);
    r8.w = 1.0f / (r3.x);
