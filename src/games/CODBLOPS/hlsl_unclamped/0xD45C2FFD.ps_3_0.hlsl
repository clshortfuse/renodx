// Mechanically reconstructed from 0xD45C2FFD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c25 = float4(2.0f, -1.0f, 1.0f, 0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = tex2D(s3, v7.xy);
    r0.xyz = (r0.xyz) + (c25.yyy);
    r1 = (c25.xxxx) * (v8) + (c25.yyyy);
    r3.xyz = (v0.yyy) * (r0.xyz) + (c25.zzz);
    r0 = tex2D(s0, v1.xy);
    r2 = tex2D(s4, v7.zw);
    r6.w = (r2.w) * (v0.z);
    ...
    r1 = tex2D(s6, v1.xy);
    r3.w = r1.w;
    r3.xyz = (r3.xyz) * (c25.www);
    r2 = tex2D(s7, v7.zw);
    r0 = lerp(r3, r2, r6.wwww);
    r11.xyz = (r0.xyz) * (-(r0.xyz)) + (c25.zzz);
    r1.w = dot(r5.xy, r5.xy) + (c3.x);
    r12.xyz = (r0.xyz) * (r0.xyz);
    r1.w = exp2(-(r1.w));
    r0.xyz = (r11.xyz) * (r4.www) + (r12.xyz);
    r4.w = (r1.w) * (c3.y) + (c3.z);
    r13.xyz = lerp(r1.yyy, c[23].xyw, r6.www);
    r1.xy = (v1.zw) * (c4.yz);
    r3 = tex2D(s13, r1.xy);
    ...
    r3.xy = (r3.xz) * (r8.xx);
    r1.w = dot(r9.xy, r5.xy) + (c3.x);
    r1.y = (r2.x) * (c12.x) + (-(r3.x));
    r2.w = (r3.z) * (-(r8.x)) + (r1.y);
    r7.xy = (r1.xz) * (r8.yy);
    r1.y = (r2.y) * (c12.x) + (-(r7.x));
    r1.x = dot(r9.xy, r9.xy) + (c3.x);
    r1.y = (r1.z) * (-(r8.y)) + (r1.y);
    r1.z = exp2(-(r1.x));
    r10.y = (r2.w) + (r2.w);
    r1.z = (r1.z) * (c3.y) + (c3.z);
