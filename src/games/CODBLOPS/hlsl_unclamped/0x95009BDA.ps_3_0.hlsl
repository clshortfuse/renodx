// Mechanically reconstructed from 0x95009BDA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r3.w = (r0.w) * (v0.w) + (c0.x);
    r1.xyz = (r3.xyz) * (r1.www) + (r8.xyz);
    r13.yz = c0.yz;
    r11.xyz = float3(((r3.w) >= 0.0f ? (c[36].x) : (r13.z)), ((r3.w) >= 0.0f ? (c[36].y) : (r13.z)), ((r3.w) >= 0.0f ? (c[36].w) : (r13.z)));
