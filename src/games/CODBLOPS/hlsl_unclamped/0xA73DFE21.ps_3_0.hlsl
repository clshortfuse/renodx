// Mechanically reconstructed from 0xA73DFE21.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s5, v0.xy);
    r1 = tex2D(s6, v7.zw);
    r8.xy = lerp(r2.wy, r1.wy, r6.ww);
    r1.w = saturate(dot(r5.xyz, r4.xyz));
    r2.z = (r8.x) * (c1.w);
    r1.x = (r8.x) * (-(c12.z)) + (c12.w);
    ...
    r1.y = dot(r9.xy, r9.xy) + (c2.z);
    r1.w = dot(r2.xy, r2.xy) + (c2.z);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r3.w = (r1.y) * (c1.x) + (c1.y);
    r1.y = (r1.w) * (c1.x) + (c1.y);
    r1.w = dot(r2.xy, r9.xy) + (c2.z);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v0.zw);
    r9.xy = (r2.xy) * (c3.ww);
