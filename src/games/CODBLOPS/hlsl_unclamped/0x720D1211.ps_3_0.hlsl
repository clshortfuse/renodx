// Mechanically reconstructed from 0x720D1211.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c35 = float4(2.0f, -1.0f, 0.0f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r3.y = dot(r1.xy, r0.zw) + (c35.z);
    r3.x = dot(r1.xy, r0.xy) + (c35.z);
    r0 = tex2D(s8, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c35.xxxx) * (v9) + (c35.yyyy);
    r4.y = dot(r1.xy, r0.zw) + (c35.z);
    r4.x = dot(r1.xy, r0.xy) + (c35.z);
    r2 = tex2D(s0, v1.xy);
    r1 = tex2D(s5, v7.xy);
    r4.w = (r1.w) * (v0.y);
    r0 = tex2D(s1, v1.xy);
    r0.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r5.xy = lerp(r0.xy, r3.xy, r4.ww);
    r0 = tex2D(s6, v7.zw);
    r6.w = (r0.w) * (v0.z);
    r3.xyz = lerp(r2.xyz, r1.xyz, r4.www);
    r10.xy = lerp(r5.xy, r4.xy, r6.ww);
    r1.xyz = lerp(r3.xyz, r0.xyz, r6.www);
    r0.w = dot(r10.xy, r10.xy) + (c35.z);
    ...
    r0.y = (r1.x) * (c4.w) + (-(r3.x));
    r0.w = dot(r5.xy, r10.xy) + (c35.z);
    r1.w = (r2.z) * (-(r4.x)) + (r0.y);
    r2.xy = (r0.xz) * (r4.yy);
    r0.x = dot(r5.xy, r5.xy) + (c35.z);
    r0.y = (r1.y) * (c4.w) + (-(r2.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r0.z) * (-(r4.y)) + (r0.y);
    r0.z = (r0.x) * (c3.x) + (c3.y);
    ...
    r3.xyz = (r6.xyz) * (r3.www) + (r0.xyz);
    r2.w = rsqrt(r0.w);
    r0.zw = c35.zw;
    r0.xyz = (r0.zwz) + (-(c[32].xyw));
    r4.xyz = (-(v6.xyz)) + (c[5].xyz);
    r2.xyz = (r4.www) * (r0.xyz) + (c[32].xyw);
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c35.w) : (c35.z));
