// Mechanically reconstructed from 0x9422D6D4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4 = tex2D(s13, r4.xy);
    r2.w = r4.y;
    r10.xy = (r2.yw) * (c3.xx) + (c3.yy);
    r6.xyz = (r3.xyz) * (r0.yyy);
    r0.w = dot(r10.xy, r10.xy) + (c4.z);
    r3 = tex2D(s14, v1.zw);
    r11.xy = (r3.xy) * (c1.zz);
    r0.w = exp2(-(r0.w));
    r4.xy = (r4.xz) * (r11.yy);
