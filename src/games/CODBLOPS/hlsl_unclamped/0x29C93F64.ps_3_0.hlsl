// Mechanically reconstructed from 0x29C93F64.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    float4 v5 = input.v5;
    float4 v6 = input.v6;
    const float4 c0 = float4(0.0f, 0.600000024f, 0.400000006f, 8.0f);
    ...
    r0.w = dot(r6.xy, r6.xy) + (c0.x);
    r0.y = dot(r1.xy, r1.xy) + (c0.x);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c0.y) + (c0.z);
    r1.w = (r0.y) * (c0.y) + (c0.z);
    r0.y = dot(r1.xy, r6.xy) + (c0.x);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v1.zw);
    r4.xy = (r1.xy) * (c3.ww);
