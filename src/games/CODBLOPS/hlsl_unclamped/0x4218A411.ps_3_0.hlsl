// Mechanically reconstructed from 0x4218A411.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = dot(r8.xy, r8.xy) + (c0.y);
    r2.z = dot(r4.xy, r4.xy) + (c0.y);
    r2.w = exp2(-(r2.w));
    r2.z = exp2(-(r2.z));
    r2.w = (r2.w) * (c2.x) + (c2.y);
    r2.x = (r2.z) * (c2.x) + (c2.y);
    r2.z = dot(r4.xy, r8.xy) + (c0.y);
    r2.x = (r2.w) * (r2.x);
    r4 = tex2D(s14, v0.zw);
    r13.xy = (r4.xy) * (c3.ww);
