// Mechanically reconstructed from 0x0511D2F8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = dot(r5.xyz, c[9].xyz);
    r1.z = max(abs(r7.y), abs(r7.z));
    r2.w = saturate((r0.w) * (c[10].x) + (c[10].y));
