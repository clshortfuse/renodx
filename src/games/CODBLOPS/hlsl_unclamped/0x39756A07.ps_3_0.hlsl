// Mechanically reconstructed from 0x39756A07.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.z = (r0.w) * (v7.y) + (c1.x);
    r2.x = (r2.x) * (r3.w);
    r3.xyz = float3(((r2.z) >= 0.0f ? (r0.x) : (r1.x)), ((r2.z) >= 0.0f ? (r0.y) : (r1.y)), ((r2.z) >= 0.0f ? (r0.z) : (r1.z)));
    r7.xy = float2(((r2.z) >= 0.0f ? (r5.x) : (c1.y)), ((r2.z) >= 0.0f ? (r5.y) : (c1.y)));
    r0 = (r2.wwww) * (c1.yyyz) + (c1.wwwy);
    r1 = tex2D(s6, v0.xy);
    r1 = float4(((r2.z) >= 0.0f ? (r0.x) : (r1.x)), ((r2.z) >= 0.0f ? (r0.y) : (r1.y)), ((r2.z) >= 0.0f ? (r0.z) : (r1.z)), ((r2.z) >= 0.0f ? (r0.w) : (r1.w)));
    ...
    r1.y = saturate(dot(r14.xyz, r4.xyz));
    r12.w = (r1.w) * (c3.w);
    ...
    r1.x = (r1.z) * (r0.y);
    r1.y = (r0.z) * (r7.w);
    r0.xyz = (r11.xyz) * (r2.xxx) + (r12.xyz);
    r1.y = (r1.x) * (r1.y);
    r8.xyz = (r3.xyz) * (r3.xyz);
    r0.xyz = (r0.xyz) * (r1.yyy);
    r13.xyz = float3(((r2.z) >= 0.0f ? (r2.y) : (c[29].x)), ((r2.z) >= 0.0f ? (r2.y) : (c[29].y)), ((r2.z) >= 0.0f ? (r2.y) : (c[29].w)));
