// Mechanically reconstructed from 0xBC5C085E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex3D(s11, r0.xyz);
    r6.xyz = (-(v5.xyz)) + (c[21].xyz);
    r1.z = dot(r6.xyz, r6.xyz);
    r3.w = rsqrt(r1.z);
    r4.w = lerp(r0.w, r1.w, c[25].w);
