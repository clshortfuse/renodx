// Mechanically reconstructed from 0x670164AC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = (c[40].zz) * (r4.xy) + (r0.xy);
    r0 = tex2D(s0, v1.xy);
    r4.w = (r0.w) * (v0.w) + (c1.x);
    r1.w = r2.x;
    r2.xy = float2(((r4.w) >= 0.0f ? (r4.x) : (c1.z)), ((r4.w) >= 0.0f ? (r4.y) : (c1.z)));
    r6.y = dot(r1, c3.wwww);
    r1 = v2;
    ...
    r2.y = c1.z;
    r5.xyz = float3(((r4.w) >= 0.0f ? (c[39].x) : (r2.y)), ((r4.w) >= 0.0f ? (c[39].y) : (r2.y)), ((r4.w) >= 0.0f ? (c[39].w) : (r2.y)));
