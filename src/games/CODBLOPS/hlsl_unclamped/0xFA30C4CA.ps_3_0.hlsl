// Mechanically reconstructed from 0xFA30C4CA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xyz = (r0.xyz) * (-(r2.zzz)) + (r7.xyz);
    r3 = tex2D(s5, v7.xy);
    r3 = float4(((r1.w) >= 0.0f ? (r3.x) : (r4.x)), ((r1.w) >= 0.0f ? (r3.y) : (r4.y)), ((r1.w) >= 0.0f ? (r3.z) : (r4.z)), ((r1.w) >= 0.0f ? (r3.w) : (r4.w)));
