// Mechanically reconstructed from 0x50D0BC64.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = 1.0f / (r0.w);
    r2.z = (r3.w) * (r0.w);
    r2.xy = (r1.ww) * (c11.xy) + (c11.zw);
    r3.z = saturate(dot(r6.xyz, r0.xyz));
    r1.z = exp2(r2.y);
    r0.z = pow(abs(r3.z), r1.z);
    r0.w = (r1.z) * (c2.x) + (c2.y);
    ...
    r1.xyz = max(((r1.xyz) * (c[10].xxx)), 0.0f); // HDR: removed only the 1.0 ceiling
    r0.w = rsqrt(r0.x);
    r0.x = rsqrt(r1.x);
    r0.y = rsqrt(r1.y);
    r0.z = rsqrt(r1.z);
