// Mechanically reconstructed from 0x97448684.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.x = dot(r4.xy, r0.xy) + (c13.w);
    r2.y = dot(r4.xy, r0.zw) + (c13.w);
    r0 = tex2D(s3, v6.zw);
    r5.w = (r0.w) * (v0.z) + (c2.x);
    r4.xy = (r1.yw) * (c4.yy) + (c4.zz);
    r5.xy = float2(((r5.w) >= 0.0f ? (r2.x) : (r5.x)), ((r5.w) >= 0.0f ? (r2.y) : (r5.y)));
    r1.w = dot(r4.xy, r4.xy) + (c13.w);
