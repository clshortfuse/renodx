// Mechanically reconstructed from 0x86B8EE71.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c12 = float4(0.00048828125f, -0.000122070312f, 0.0f, 0.999511719f);
    const float4 c13 = float4(0.000244140625f, 0.0f, -0.000244140625f, -3.0f);
    const float4 c14 = float4(4.0f, -3.0f, 9.99999994e-09f, 0.0450000018f);
    const float4 c15 = float4(10.0f, -1.44269502f, 8.0f, -9.99999975e-05f);
    ...
    r3.xy = (r0.zw) + (r0.xy);
    r6.w = 1.0f / (r8.w);
    r6.xyz = (r8.www) * (v1.xyz);
    r0.xyz = v4.xyz;
    r1.xyz = (r0.zxy) * (v5.yzx);
    r0.w = dot(c[7].xyz, r6.xyz);
    r2.xyz = (r0.yzx) * (v5.zxy) + (-(r1.xyz));
    r5.w = saturate((c[9].y) * (r0.w) + (c[9].x));
    r0.xyz = (r3.xxx) * (v4.xyz) + (r2.xyz);
    r1.xyz = normalize(r2.xyz);
    r0.xyz = (r3.yyy) * (v5.xyz) + (r0.xyz);
    r8.z = saturate(dot(c[17].xyz, r1.xyz));
    ...
    r7.z = saturate(dot(r5.xyz, -(r6.xyz)));
    r1.w = (-(r7.z)) + (c1.x);
    r0.w = (r1.w) * (r1.w);
    ...
    r0.w = dot(r4.xzy, c3.yyz);
    r0.xyz = (r4.www) * (c[18].xyz);
    r7.w = saturate(dot(r5.xyz, c[17].xyz));
    r1.xyz = (r0.xyz) * (r8.zzz) + (r0.www);
    r1.xyz = (r1.xyz) * (c[24].xyz);
    r2.xyz = c[22].xyz;
    r2.xyz = (-(r2.xyz)) + (c[23].xyz);
    r2.xyz = (r7.zzz) * (r2.xyz) + (c[22].xyz);
    ...
    r0.xyz = (r3.www) * (r0.xyz);
    r3.xyz = (v1.xyz) * (-(r8.www)) + (c[17].xyz);
    r1.xyz = (r1.www) * (r0.xyz);
    r0.xyz = normalize(r3.xyz);
    r1.xyz = (r1.xyz) * (c15.zzz) + (r2.xyz);
    ...
    r2.z = (r2.z) * (r2.z);
    r0.w = (r0.w) * (r2.z);
    r0.z = saturate(dot(r5.xyz, r0.xyz));
