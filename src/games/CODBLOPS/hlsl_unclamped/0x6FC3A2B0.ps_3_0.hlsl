// Mechanically reconstructed from 0x6FC3A2B0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.x = 1.0f / (r1.w);
    r1.w = dot(r1.xyz, c[31].xyz);
    r2.w = saturate(dot(r1.xyz, r8.xyz));
    r1.w = saturate((r1.w) * (c[32].x) + (c[32].y));
    r1.z = (r1.w) * (c[32].w);
    r2.xy = saturate((r3.xx) * (c[34].xy) + (c[34].zw));
    r1.xy = (r2.xy) * (r2.xy);
    r2.xy = (r2.xy) * (c1.xx) + (c1.yy);
    r1.w = dot(c[33].yz, r3.xy) + (c[33].x);
    r2.xy = (r1.xy) * (r2.xy);
    r2.z = lerp(r0.w, r3.w, r1.z);
    r0.w = (r1.w) * (r2.x);
