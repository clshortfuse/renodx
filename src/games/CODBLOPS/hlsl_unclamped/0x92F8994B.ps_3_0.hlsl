// Mechanically reconstructed from 0x92F8994B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.y = dot(r3.xy, r0.zw) + (c1.z);
    r1.x = dot(r3.xy, r0.xy) + (c1.z);
    r0 = tex2D(s3, v7.xy);
    r7.w = (r0.w) * (v0.y) + (c1.w);
    r6.w = (r1.w) * (r1.z);
    r9.xy = float2(((r7.w) >= 0.0f ? (r1.x) : (r2.x)), ((r7.w) >= 0.0f ? (r1.y) : (r2.y)));
    r1 = tex2D(s6, v7.zw);
    r2.xy = (r1.wy) * (c4.xy) + (c4.zw);
    r1 = (c1.xxxx) * (v9) + (c1.yyyy);
    r8.y = dot(r2.xy, r1.zw) + (c1.z);
    r8.x = dot(r2.xy, r1.xy) + (c1.z);
    r1 = tex2D(s0, v1.xy);
    ...
    r7.xy = lerp(r9.xy, r8.xy, r2.ww);
    r6.xyz = (r1.xyz) * (r1.xyz);
    r1 = tex2D(s9, v7.zw);
    r3 = (r1.wwww) * (c3.xxxy) + (c3.zzzx);
    r0 = lerp(r4, r3, r2.wwww);
    r2.xyz = float3(((r7.w) >= 0.0f ? (r2.y) : (c[23].x)), ((r7.w) >= 0.0f ? (r2.y) : (c[23].y)), ((r7.w) >= 0.0f ? (r2.y) : (c[23].w)));
    r13.xyz = lerp(r2.xyz, r1.yyy, r2.www);
    ...
    r3.xy = (r3.xz) * (r8.xx);
    r1.w = dot(r9.xy, r7.xy) + (c1.z);
    r1.y = (r2.x) * (c12.w) + (-(r3.x));
    r2.w = (r3.z) * (-(r8.x)) + (r1.y);
    r4.xy = (r1.xz) * (r8.yy);
    r1.y = (r2.y) * (c12.w) + (-(r4.x));
    r1.x = dot(r9.xy, r9.xy) + (c1.z);
    r1.y = (r1.z) * (-(r8.y)) + (r1.y);
    r1.z = exp2(-(r1.x));
    r10.y = (r2.w) + (r2.w);
