// Mechanically reconstructed from 0x34A75647.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.y = dot(r1.xy, r0.zw) + (c35.z);
    r6.x = dot(r1.xy, r0.xy) + (c35.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s5, v7.xy);
    r4.w = (r0.w) * (v0.y);
    r2 = tex2D(s1, v1.xy);
    ...
    r5.xyz = lerp(c[32].xyw, r0.yyy, r4.www);
    r0 = lerp(r3, r2, r5.wwww);
    r14.xyz = lerp(r5.xyz, r1.yyy, r5.www);
    r1.w = dot(r10.xy, r10.xy) + (c35.z);
