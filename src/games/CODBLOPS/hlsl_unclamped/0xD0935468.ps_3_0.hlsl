// Mechanically reconstructed from 0xD0935468.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r13.xy = float2(((r7.w) >= 0.0f ? (r0.x) : (c1.y)), ((r7.w) >= 0.0f ? (r0.y) : (c1.y)));
    ...
    r0.y = (r0.z) * (r3.w) + (r3.z);
    r3.w = (r0.x) * (r3.w) + (r3.z);
    r7.xyz = float3(((r7.w) >= 0.0f ? (r3.y) : (c[36].x)), ((r7.w) >= 0.0f ? (r3.y) : (c[36].y)), ((r7.w) >= 0.0f ? (r3.y) : (c[36].w)));
    r0.y = (r0.y) * (r3.w) + (c4.x);
    r5.w = (-(r0.x)) + (c1.z);
    r0.y = 1.0f / (r0.y);
    r4.w = (r0.z) * (r0.y);
