// Mechanically reconstructed from 0x4892D4A4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    float4 v7 = input.v7;
    float4 v8 = input.v8;
    const float4 c0 = float4(3.5f, -13.0f, 1.0f, 13.0f);
    ...
    r3.y = dot(r4.xy, r1.zw) + (c3.w);
    r0 = tex2D(s0, v0.xy);
    r6.w = (r0.w) * (v7.x) + (c3.z);
    r0 = (r0.xyzx) * (-(c3.yyyw)) + (-(c3.wwwy));
    r3.x = dot(r4.xy, r1.xy) + (c3.w);
    r1 = float4(((r6.w) >= 0.0f ? (r0.x) : (c3.w)), ((r6.w) >= 0.0f ? (r0.y) : (c3.w)), ((r6.w) >= 0.0f ? (r0.z) : (c3.w)), ((r6.w) >= 0.0f ? (r0.w) : (c3.w)));
    r0 = tex2D(s3, v7.zw);
    r5.w = (r0.w) * (v7.y) + (c3.z);
    r0 = (r0.xyzx) * (-(c3.yyyw)) + (-(c3.wwwy));
    r4.xy = float2(((r6.w) >= 0.0f ? (r2.x) : (c3.w)), ((r6.w) >= 0.0f ? (r2.y) : (c3.w)));
    r0 = float4(((r5.w) >= 0.0f ? (r0.x) : (r1.x)), ((r5.w) >= 0.0f ? (r0.y) : (r1.y)), ((r5.w) >= 0.0f ? (r0.z) : (r1.z)), ((r5.w) >= 0.0f ? (r0.w) : (r1.w)));
    r1 = tex2D(s5, v0.xy);
    r2 = float4(((r6.w) >= 0.0f ? (r1.x) : (-(c3.w))), ((r6.w) >= 0.0f ? (r1.y) : (-(c3.w))), ((r6.w) >= 0.0f ? (r1.z) : (-(c3.w))), ((r6.w) >= 0.0f ? (r1.w) : (-(c3.y))));
    r1 = tex2D(s6, v7.zw);
    r2 = float4(((r5.w) >= 0.0f ? (r1.x) : (r2.x)), ((r5.w) >= 0.0f ? (r1.y) : (r2.y)), ((r5.w) >= 0.0f ? (r1.z) : (r2.z)), ((r5.w) >= 0.0f ? (r1.w) : (r2.w)));
    ...
    r3.z = (r8.w) * (r1.z) + (r1.y);
    r3.w = (r4.w) * (r1.z) + (r1.y);
    r1.xyz = (r9.xyz) * (r4.yyy) + (r0.xyz);
    r0.z = (r3.w) * (r3.z) + (c13.w);
    r0.y = 1.0f / (r0.z);
    r16.xy = (r2.ww) * (c0.xy) + (c0.zw);
    r3.z = saturate(dot(r10.xyz, r6.xyz));
    r3.w = exp2(r16.y);
    r0.x = pow(abs(r3.z), r3.w);
    r0.z = (r3.w) * (c12.z) + (c12.w);
    r0.y = (r4.w) * (r0.y);
    r0.z = (r0.x) * (r0.z);
    r0.z = (r0.y) * (r0.z);
    r16.yw = c3.yw;
    r3.xyz = float3(((r6.w) >= 0.0f ? (c[20].x) : (r16.w)), ((r6.w) >= 0.0f ? (c[20].y) : (r16.w)), ((r6.w) >= 0.0f ? (c[20].w) : (r16.w)));
    r0.xyz = (r5.xyz) * (r0.zzz);
    r13.xyz = float3(((r5.w) >= 0.0f ? (c[21].x) : (r3.x)), ((r5.w) >= 0.0f ? (c[21].y) : (r3.y)), ((r5.w) >= 0.0f ? (c[21].w) : (r3.z)));
    r15.xyz = (r1.xyz) * (r13.yyy);
    r1.xyz = (r0.xyz) * (r13.zzz);
    r3 = tex2D(s12, v0.zw);
    r0.z = ((-abs(r3.y)) >= 0.0f ? (-(c3.y)) : (-(c3.w)));
    r14.xyz = (r4.www) * (c[18].xyz);
    if ((r0.z) != (-(r0.z)))
    {
        r0.z = r3.y;
        r3.w = r0.z;
    ...
    r2 = saturate((r2) * (c[8]) + (-(r16.yyyy)));
    r0.xyz = (r9.xyz) * (r0.xyz);
    r2 = (r3) * (r2);
    r1.xyz = (r0.xyz) * (c4.zzz) + (r1.xyz);
    r0.z = dot(c[11], r2);
    r0.x = dot(c[9], r2);
    r0.y = dot(c[10], r2);
