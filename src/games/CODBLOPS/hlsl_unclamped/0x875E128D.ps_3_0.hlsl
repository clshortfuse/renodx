// Mechanically reconstructed from 0x875E128D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.w = (r0.w) * (r0.z);
    r1 = tex2D(s0, v1.xy);
    r1.w = (r1.w) * (-(v0.x)) + (c27.z);
    r0 = tex2D(s2, v7.xy);
    r7.z = (r0.w) * (v0.y);
    r0.w = (r0.w) * (-(v0.y)) + (c27.z);
    r2.xyz = lerp(r1.xyz, r0.xyz, r7.zzz);
    r1.w = (r1.w) * (-(r0.w)) + (c27.z);
    r0 = tex2D(s5, v7.zw);
    r3.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c27.xxxx) * (v8) + (c27.yyyy);
    r1.y = dot(r3.xy, r0.zw) + (c27.w);
    r1.x = dot(r3.xy, r0.xy) + (c27.w);
    r0 = tex2D(s4, v7.xy);
    r3.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r1.w = (-(r1.w)) + (c27.z);
    r4.xy = (r7.zz) * (-(r3.xy)) + (r1.xy);
    r0 = tex2D(s3, v7.zw);
    r4.w = (r0.w) * (v0.z);
    r1.xyz = lerp(r2.xyz, r0.xyz, r4.www);
    r0.xy = (r4.xy) * (r4.ww);
    r7.xy = (r7.zz) * (r3.xy) + (r0.xy);
    r0.w = (r0.w) * (-(v0.z)) + (c27.z);
    r6.w = (r1.w) * (-(r0.w)) + (c27.z);
    r0.w = dot(r7.xy, r7.xy) + (c27.w);
    ...
    r1 = tex2D(s14, v1.zw);
    r4.xy = (r1.xy) * (c4.ww);
    r8.xy = (r2.yw) * (c13.xx) + (c13.yy);
    r2.xy = (r2.xz) * (r4.xx);
    r0.w = dot(r8.xy, r7.xy) + (c27.w);
    r0.y = (r1.x) * (c4.w) + (-(r2.x));
    r1.w = (r2.z) * (-(r4.x)) + (r0.y);
    r3.xy = (r0.xz) * (r4.yy);
    r0.y = (r1.y) * (c4.w) + (-(r3.x));
    r0.x = dot(r8.xy, r8.xy) + (c27.w);
    r0.y = (r0.z) * (-(r4.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r10.y = (r1.w) + (r1.w);
    r0.z = (r0.z) * (c4.x) + (c4.y);
    ...
    r3.xyz = (r5.xyz) * (c3.www) + (r8.xyz);
    r0 = (r1) * (r0);
    r2.z = dot(c[11], r0);
    r1.w = dot(c[20].xyz, r7.xyz);
