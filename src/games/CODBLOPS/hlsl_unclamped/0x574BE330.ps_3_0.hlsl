// Mechanically reconstructed from 0x574BE330.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = 1.0f / (r0.z);
    r10.w = exp2(r16.y);
    r0.z = pow(abs(r3.w), r10.w);
    r8.w = (r10.w) * (c13.y) + (c13.z);
    r0.y = (r2.w) * (r0.y);
    r0.z = (r0.z) * (r8.w);
    r5.xyz = (r11.xyz) * (r1.xxx) + (r12.xyz);
    r1.x = (r0.y) * (r0.z);
    r0.xyz = lerp(r3.xyz, r2.xyz, r1.zzz);
    r2.xyz = (r5.xyz) * (r1.xxx);
    r7.w = lerp(r1.y, c30.x, r1.z);
    r1.xyz = (r2.xyz) * (c[7].xyz);
    r0.xyz = (r4.xyz) * (r0.xyz);
    r5.xyz = (r7.www) * (r1.xyz);
    r8.xyz = (r0.xyz) * (r0.xyz);
    r0.z = dot(r7.xy, r7.xy) + (c30.w);
    ...
    r4.xy = (r4.xz) * (r0.xx);
    r0.z = dot(r6.xy, r7.xy) + (c30.w);
    r2.w = (r3.x) * (c3.w) + (-(r4.x));
    r2.w = (r4.z) * (-(r0.x)) + (r2.w);
    r2.xy = (r2.xz) * (r0.yy);
    r3.w = (r3.y) * (c3.w) + (-(r2.x));
    r0.x = dot(r6.xy, r6.xy) + (c30.w);
    r0.y = (r2.z) * (-(r0.y)) + (r3.w);
    r0.x = exp2(-(r0.x));
    r10.y = (r2.w) + (r2.w);
    r0.x = (r0.x) * (c1.x) + (c1.y);
    ...
    r2 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r2.y)) >= 0.0f ? (c30.x) : (c30.w));
