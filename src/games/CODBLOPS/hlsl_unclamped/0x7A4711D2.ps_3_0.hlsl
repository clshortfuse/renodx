// Mechanically reconstructed from 0x7A4711D2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s4, v1.xy);
    r4.xyz = lerp(r5.xyz, c0.yyy, r1.xxx);
    r0 = tex2D(s1, v1.xy);
    r6.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r12.xyz = (r5.xyz) * (r1.xxx);
    r0 = v2;
    ...
    r1.z = (r5.w) * (c4.x) + (c4.y);
    r2.w = (r2.w) * (r1.z);
    r6.y = max(abs(r8.y), abs(r8.z));
    r6.z = (r6.z) * (r2.w);
    r2.w = max(abs(r8.x), r6.y);
    r2.w = 1.0f / (r2.w);
