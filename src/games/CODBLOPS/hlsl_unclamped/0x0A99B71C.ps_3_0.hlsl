// Mechanically reconstructed from 0x0A99B71C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c20 = float4(0.000244140625f, 0.0f, -0.000244140625f, -3.0f);
