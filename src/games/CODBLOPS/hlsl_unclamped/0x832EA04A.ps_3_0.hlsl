// Mechanically reconstructed from 0x832EA04A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xy = (v1.xy) + (c1.xx);
    r3.xy = (c[32].zz) * (r2.xy) + (r0.xy);
    r1.z = c1.y;
    r4.xy = (r1.xy) * (c[38].xx) + (r1.zz);
    r0 = tex2D(s0, v1.xy);
    r2.xyz = (r0.xyz) * (v0.xyz);
    r0 = tex2D(s8, r4.xy);
    r0.xyz = (r2.xyz) * (-(r2.xyz)) + (r0.xyz);
    r0.w = (r0.w) + (c3.z);
    r1.xy = (r1.xy) * (c[37].xx) + (r1.zz);
    r1 = tex2D(s7, r1.xy);
    r7.w = (v8.w) * (c1.z) + (-(r1.x));
    ...
    r5.y = (r2.w) * (r3.w);
    r2 = tex2D(s5, v1.xy);
    r12.xyz = (r2.xyz) * (-(r2.xyz)) + (c3.xxx);
    r13.xyz = (r2.xyz) * (r2.xyz);
    r14.w = (r2.w) * (-(c14.y)) + (c14.z);
    r14.z = (r2.w) * (c14.y);
    r6.w = saturate(dot(r8.xyz, r1.xyz));
    r3.w = saturate(dot(r1.xyz, -(r4.xyz)));
    r2.z = (r6.w) * (r14.w) + (r14.z);
    r13.w = (r3.w) * (r14.w) + (r14.z);
    r2.z = (r2.z) * (r13.w) + (c14.w);
    r6.xy = (r2.ww) * (c15.xy) + (c15.zw);
    r2.y = 1.0f / (r2.z);
    r4.w = exp2(r6.y);
    r2.z = pow(abs(r5.w), r4.w);
    r11.w = (r4.w) * (c12.x) + (c12.y);
    r5.z = (r6.w) * (r2.y);
    r5.w = (r2.z) * (r11.w);
    r2.xyz = (r12.xyz) * (r5.yyy) + (r13.xyz);
    r5.z = (r5.z) * (r5.w);
    r5.w = saturate(dot(r3.xyz, c[17].xyz));
    r2.xyz = (r2.xyz) * (r5.zzz);
    r5.w = (-(r5.w)) + (c3.x);
    r2.xyz = (r2.xyz) * (c[8].xyz);
    r5.xyz = (r2.xyz) * (c[31].www);
    r2.xyz = (r6.www) * (c[7].xyz);
    r7.xyz = (r0.xyz) * (r2.xyz) + (r5.xyz);
    r5.z = 1.0f / (r6.x);
    r3.w = (-(r3.w)) + (c3.x);
    ...
    r2.z = (r2.z) + (r2.z);
    r2.w = (r2.w) * (c3.w);
    r2.xyz = (r1.xyz) * (-(r2.zzz)) + (r4.xyz);
    r2 = texCUBElod(s15, r2);
    r2.xyz = (r2.xyz) * (r2.xyz);
    r3.w = (r3.w) * (r5.y);
    r4.xyz = (r2.xyz) * (c3.www);
    r2 = tex3D(s11, v8.xyz);
    r2.xyz = (r2.xyz) * (r2.xyz);
    r2.w = (r5.z) * (r3.w);
    r2.xyz = (r4.xyz) * (r2.xyz);
    r2.xyz = (r2.xyz) * (c14.xxx);
    r4.xyz = (r12.xyz) * (r2.www) + (r13.xyz);
    ...
    r2 = tex3D(s11, r2.xyz);
    r2.xyz = (r2.xyz) * (r2.xyz);
    r12.w = pow(abs(r3.w), r4.w);
    r2.xyz = (r2.xyz) * (c[31].yyy);
    r10.w = saturate(dot(r1.xyz, c[17].xyz));
    r14.xy = c[29].xy;
    ...
    if ((c3.x) >= (v6.w))
    {
        ...
        if ((c4.w) < (v6.w))
        {
            ...
            r2.z = r4.x;
            r2.w = r3.x;
            r1.y = dot(r2, c12.yyyy);
            r1.x = (-(r1.z)) + (r1.y);
            r1.y = (v6.w) * (c13.x) + (c13.y);
            r2.w = (r1.y) * (r1.x) + (r1.z);
        }
        else
        {
    ...
    r1.z = (r10.w) * (r14.w) + (r14.z);
    r1.z = (r1.z) * (r13.w) + (c14.w);
    r1.y = 1.0f / (r1.z);
    r1.z = (r11.w) * (r12.w);
    r1.y = (r10.w) * (r1.y);
    r2.z = (r1.z) * (r1.y);
    r1.xyz = (r12.xyz) * (r9.www) + (r13.xyz);
    r1.xyz = (r2.zzz) * (r1.xyz);
    r1.xyz = (r1.xyz) * (c[31].www);
    r2.xyz = (r14.yyy) * (c[19].xyz);
    r2.xyz = (r1.xyz) * (r2.xyz);
    r1.xyz = (r2.www) * (r10.xyz) + (r11.xyz);
    r2.xyz = (r2.www) * (r2.xyz);
    r0.xyz = (r0.xyz) * (r1.xyz) + (r2.xyz);
    r2 = (v7.yyyy) * (c[26]);
    r1.xyz = (r9.xyz) * (c[31].xxx) + (r0.xyz);
    r2 = (v7.xxxx) * (c[25]) + (r2);
    ...
    r6 = tex2Dproj(s3, r4);
    r3.x = r6.x;
    r2.xy = (r4.ww) * (c[30].zw) + (r5.xy);
    r2 = tex2Dproj(s3, r2);
    r3.z = r2.x;
    r2 = (v7.xyzx) * (c3.xxxy) + (c3.yyyx);
    r3.w = dot(r3, c12.yyyy);
    r0.z = dot(r2, c[22]);
    r3.z = 1.0f / (r0.z);
    r3.x = dot(r2, c[21]);
    r0.x = dot(r2, c[11]);
    ...
    r2.w = ((r7.w) >= 0.0f ? (r2.w) : (c3.y));
    r0.xyz = (r3.www) * (r0.xyz);
    r2.w = (r2.w) * (r2.w);
    r0.xyz = (r0.xyz) * (r7.xyz) + (r1.xyz);
    r1.z = (r2.w) * (c[39].w);
    r2.xyz = (c[39].xyz) * (r1.zzz) + (r0.xyz);
    r2.w = c3.x;
    r0.z = dot(r2, c[36]);
    r0.x = dot(r2, c[34]);
    r0.y = dot(r2, c[35]);
