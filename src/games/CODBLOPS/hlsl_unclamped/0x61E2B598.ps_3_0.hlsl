// Mechanically reconstructed from 0x61E2B598.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s4, v7.zw);
    r6.w = (r0.w) * (v0.z);
    r2 = lerp(r3, r1, r6.zzzz);
    r3.xyz = lerp(r5.xyz, r0.xyz, r6.www);
    r1 = tex2D(s9, v7.zw);
    ...
    r1.xyw = c[8].xyw;
    r1.xyz = (-(r1.xyw)) + (c[9].xyw);
    r2.xyz = (r6.zzz) * (r1.xyz) + (c[8].xyw);
    r1.xy = (v1.zw) * (c12.xy) + (c12.zy);
    r1 = tex2D(s13, r1.xy);
    r3.xy = (v1.zw) * (c12.xy);
    r3 = tex2D(s13, r3.xy);
    r1.w = r3.y;
    r11.xyz = lerp(r2.xyz, c[10].xyw, r6.www);
    r2.xy = (r1.wy) * (c13.xx) + (c13.yy);
    r1.y = dot(r5.xy, r5.xy) + (c4.z);
    r1.w = dot(r2.xy, r2.xy) + (c4.z);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r3.w = (r1.y) * (c3.x) + (c3.y);
    r1.y = (r1.w) * (c3.x) + (c3.y);
    r1.w = dot(r2.xy, r5.xy) + (c4.z);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c3.ww);
