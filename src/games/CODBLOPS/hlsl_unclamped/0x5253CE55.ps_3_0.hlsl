// Mechanically reconstructed from 0x5253CE55.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (r0.w) * (v0.y) + (c1.w);
    r1.w = (r1.w) + (c1.y);
    r7.xyz = float3(((r0.w) >= 0.0f ? (r1.x) : (r2.x)), ((r0.w) >= 0.0f ? (r1.y) : (r2.y)), ((r0.w) >= 0.0f ? (r1.z) : (r2.z)));
    r1.w = (r2.w) * (r1.w) + (-(c1.y));
    r1.xyz = v4.xyz;
    ...
    r0 = tex2D(s5, v7.zw);
    r0.w = (r0.w) * (v0.z) + (c1.w);
    r1.xyz = (r3.www) * (r8.xyz);
    r0.xyz = float3(((r0.w) >= 0.0f ? (r0.x) : (r7.x)), ((r0.w) >= 0.0f ? (r0.y) : (r7.y)), ((r0.w) >= 0.0f ? (r0.z) : (r7.z)));
