// Mechanically reconstructed from 0x6109B59E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.x = 1.0f / (r3.w);
    r2.y = (r0.w) + (r0.w);
    r1.xy = saturate((r9.xx) * (c[9].xy) + (c[9].zw));
    r0.xy = (r1.xy) * (r1.xy);
    ...
    r0.w = (r0.w) * (r1.x);
    r10.xyz = (r0.xyz) * (c[10].yyy);
    r2.w = (r1.y) * (r0.w);
    r1 = tex2D(s12, v1.zw);
    r0 = v2;
    r0.xyz = (r8.xxx) * (v5.xyz) + (r0.xyz);
    r4.xyz = (r8.yyy) * (v4.xyz) + (r0.xyz);
    r9.xyz = (r7.xyz) * (r3.www);
    r0.xyz = normalize(r4.xyz);
    r5.w = saturate(dot(r0.xyz, r9.xyz));
    r2.w = (r2.w) * (r1.y);
    r4.xyz = (r5.www) * (c[6].xyz);
    r1 = tex2D(s5, v1.xy);
    r8.w = (r1.w) * (c4.z);
