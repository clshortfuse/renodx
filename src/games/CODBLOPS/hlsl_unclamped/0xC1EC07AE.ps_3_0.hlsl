// Mechanically reconstructed from 0xC1EC07AE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.y = (r1.w) + (r1.w);
    r5.xy = (r5.xy) * (r5.ww);
    r1.w = dot(r4.xy, r4.xy) + (c1.x);
    r0.w = dot(r5.xy, r5.xy) + (c1.x);
    r1.w = exp2(-(r1.w));
    r0.w = exp2(-(r0.w));
    r1.z = (r1.w) * (c3.x) + (c3.y);
    r0.w = (r0.w) * (c3.x) + (c3.y);
    r1.w = dot(r4.xy, r5.xy) + (c1.x);
    r1.z = (r1.z) * (r0.w);
    ...
    r0.y = (r0.z) * (r0.z);
    r0.z = saturate(dot(r12.xyz, r18.xyz));
    r7.w = (r0.x) * (r0.y);
    r0.y = (-(r0.z)) + (c1.y);
    r0.w = (-(r0.w)) + (c1.y);
    r0.x = (r0.y) * (r0.y);
    ...
    r17.xyz = (r3.xyz) * (r10.yyy);
    r0 = (r0.wwww) * (c1.xxxy) + (c1.zzzx);
    r3 = tex2D(s6, v0.xy);
    r1 = lerp(r3, r0, r5.wwww);
    r13.xyz = (r1.xyz) * (-(r1.xyz)) + (c1.yyy);
    r0 = v1;
    r0.xyz = (r5.xxx) * (v4.xyz) + (r0.xyz);
    r14.xyz = (r1.xyz) * (r1.xyz);
    r0.xyz = (r5.yyy) * (v3.xyz) + (r0.xyz);
    r11.xyz = (r13.xyz) * (r4.www) + (r14.xyz);
    r9.xyz = normalize(r0.xyz);
    r10.w = (r1.w) * (-(c12.z)) + (c12.w);
    r9.w = saturate(dot(r9.xyz, c[17].xyz));
    r0.z = ((-abs(r2.y)) >= 0.0f ? (c1.y) : (c1.x));
    ...
    r0.z = (r5.w) * (r10.w) + (r4.x);
    r4.y = (r3.z) * (r10.w) + (r4.x);
    r1.xyz = (r4.www) * (r1.xyz) + (r17.xyz);
    r0.z = (r0.z) * (r4.y) + (c15.x);
    r0.y = 1.0f / (r0.z);
    r0.z = dot(r16.xyz, r9.xyz);
    r3.w = (r5.w) * (r0.y);
    r0.z = (r0.z) + (r0.z);
    r2.w = (r1.w) * (c1.w);
    r2.xyz = (r9.xyz) * (-(r0.zzz)) + (r16.xyz);
    r2 = texCUBElod(s15, r2);
    r0.xyz = (r2.xyz) * (r2.xyz);
    r2.w = (-(r3.z)) + (c1.y);
    r2.z = (r2.w) * (r2.w);
    r2.xy = (r1.ww) * (c38.xy) + (c38.zw);
    r1.w = (r2.w) * (r2.z);
    r2.w = 1.0f / (r2.x);
    r0.xyz = (r10.xxx) * (r0.xyz);
    r1.w = (r1.w) * (r2.w);
    r3.xyz = (r13.xyz) * (r1.www) + (r14.xyz);
    r4.z = exp2(r2.y);
    r1.w = (r4.z) * (c15.y) + (c15.z);
    r2.w = (r9.w) * (r10.w) + (r4.x);
    r2.w = (r2.w) * (r4.y) + (c15.x);
    r4.y = saturate(dot(r9.xyz, r15.xyz));
    r2.z = 1.0f / (r2.w);
    r2.w = pow(abs(r4.y), r4.z);
    r2.z = (r9.w) * (r2.z);
    r2.w = (r1.w) * (r2.w);
    r2.w = (r2.z) * (r2.w);
    r2.xyz = (r13.xyz) * (r8.www) + (r14.xyz);
