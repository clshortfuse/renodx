// Mechanically reconstructed from 0x706C63FB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c4 = float4(4.0f, -3.0f, -2.0f, 3.0f);
    const float4 c12 = float4(-1.0f, 1.0f, 0.5f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c12.y) : (c12.w));
