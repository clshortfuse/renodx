// Mechanically reconstructed from 0x059615E2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyz = (r10.xyz) * (r3.www) + (r2.xyz);
    r4.xyz = (v0.yyy) * (r1.xyz) + (c1.zzz);
    r1 = tex2D(s7, v1.xy);
    ...
    r0.w = rsqrt(r0.w);
    r13.xyz = (r10.www) * (v7.xyz);
    r0.xyz = (v0.zzz) * (r0.xyz) + (c1.zzz);
    r5.xyz = (r4.xyz) * (r0.www) + (-(r13.xyz));
    r14.xyz = normalize(r5.xyz);
    r17.xyz = (r4.xyz) * (r0.www);
    r2.xyz = (r2.xyz) * (r0.xyz);
    r0.w = saturate(dot(r14.xyz, r17.xyz));
    r0.xyz = (r3.xyz) * (r0.xyz);
    r0.w = (-(r0.w)) + (c1.z);
    r7.xyz = (r0.xyz) * (r0.xyz);
    r0.z = (r0.w) * (r0.w);
    r11.xyz = (r2.xyz) * (-(r2.xyz)) + (c1.zzz);
    r0.z = (r0.z) * (r0.z);
    r1.z = (r0.w) * (r0.z);
    r0 = v2;
    ...
    r0.y = (r3.w) * (r9.w) + (r5.x);
    r5.y = (r0.z) * (r9.w) + (r5.x);
    r3.xyz = (r1.xxx) * (r15.xyz) + (r16.xyz);
    r0.y = (r0.y) * (r5.y) + (c14.x);
    r0.y = 1.0f / (r0.y);
    r0.z = (-(r0.z)) + (c1.z);
    r1.z = (r3.w) * (r0.y);
    r0.y = (r0.z) * (r0.z);
    ...
    r0.z = pow(abs(r2.z), r5.z);
    r5.w = (r5.z) * (c14.y) + (c14.z);
    r0.y = 1.0f / (r0.x);
    r0.z = (r0.z) * (r5.w);
    r4.w = (r2.w) * (r0.y);
    r1.z = (r1.z) * (r0.z);
    r2.w = (r1.w) * (c3.z);
    r2.xyz = (r9.xyz) * (-(r11.www)) + (r13.xyz);
    r2 = texCUBElod(s15, r2);
    r4.xyz = (v7.xyz) * (-(r10.www)) + (c[17].xyz);
    ...
    r2.w = (r1.w) * (r2.w);
    r1.w = (r8.w) * (r9.w) + (r5.x);
    r4.z = (r1.w) * (r5.y) + (c14.x);
    r1.w = saturate(dot(r9.xyz, r0.xyz));
    r0.y = 1.0f / (r4.z);
    r0.z = pow(abs(r1.w), r5.z);
    r0.y = (r8.w) * (r0.y);
    r0.z = (r5.w) * (r0.z);
    r1.w = (r0.y) * (r0.z);
