// Mechanically reconstructed from 0xE701F86F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c3 = float4(0.142857f, 2.00000002e-07f, 0.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r1.z = exp2(r1.z);
    r1.x = (r1.x) * (c[25].x);
    r1.x = (r1.z) * (c[25].y) + (-(r1.x));
    r2.y = c[25].y;
    r1.z = (r1.z) * (r2.y) + (-(c[24].z));
    r1.x = 1.0f / (r1.x);
    r2.w = saturate((r1.z) * (r1.x));
    r0.xy = abs(r1.yw);
    r3 = c[9];
    r3 = saturate((r0.zyxz) * (r3) + (c[10]));
    r2.x = (r3.w) * (r3.x);
    r2.yz = r3.yz;
    r3 = (r2) * (r2);
    ...
    r0.w = (r0.z) * (r0.z);
    r0.y = dot(c[8].yz, r0.zw) + (c[8].x);
    r0.x = (r0.x) * (r0.y);
    r0.x = (r2.x) * (r0.x);
    r2.xzw = c[7].xzw;
    r0.y = dot(r1.yw, c[26].xy) + (r2.x);
    r0.z = dot(r1.yw, c[26].zw) + (r2.z);
    r1 = tex2D(s2, r0.yz);
    r0.y = (r1.x) * (r1.x);
    r0.x = (r0.x) * (r0.y);
    r1.xy = (c[27].xy) * (v4.ww);
    ...
    r2 = tex2D(s4, v3.xy);
    r0.zw = (r2.wy) * (c2.xy) + (c2.zw);
    r0.zw = (r0.zw) * (c1.yy) + (c1.yy);
    r0.zw = (r0.zw) * (c1.zz) + (c1.ww);
    r1.xyz = (r1.xyz) * (r0.www);
    r1.xyz = (r0.zzz) * (v2.xyz) + (r1.xyz);
    ...
    r0.yz = (r0.ww) * (c[34].xy);
    r0.yz = (r0.yz) * (c[33].xx);
    r0.yz = (v3.xy) * (c[33].xx) + (r0.yz);
    r2 = tex2D(s8, r0.yz);
    r2.xyz = (r2.xyz) * (r2.xyz);
    r2.xyz = (r2.xyz) * (v5.xxx);
    r2.xyz = (r2.xyz) * (c1.xxx);
    r0.yz = (r0.ww) * (c[35].xy);
    r0.yz = (r0.yz) * (c[36].xx);
    r0.yz = (v3.xy) * (c[36].xx) + (r0.yz);
    r3 = tex2D(s7, r0.yz);
    r0.yzw = (r2.xyz) * (-(r3.xyz)) + (r1.xyz);
