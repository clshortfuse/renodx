// Mechanically reconstructed from 0x4BDA5296.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = dot(r4.xy, r0.zw) + (c1.w);
    r1 = tex2D(s1, v0.xy);
    r3.xy = (r1.wy) * (c0.xy) + (c0.zw);
    r1 = tex2D(s0, v0.xy);
    r5.w = (r1.w) * (v7.x) + (c1.z);
    r2.x = dot(r4.xy, r0.xy) + (c1.w);
    r3.xy = float2(((r5.w) >= 0.0f ? (r3.x) : (c1.w)), ((r5.w) >= 0.0f ? (r3.y) : (c1.w)));
    r0 = tex2D(s5, v7.zw);
    r7.w = (r0.w) * (v7.y);
    r1 = (r1.xyzx) * (-(c1.yyyw)) + (-(c1.wwwy));
    r6.xy = lerp(r3.xy, r2.xy, r7.ww);
    r1 = float4(((r5.w) >= 0.0f ? (r1.x) : (c1.w)), ((r5.w) >= 0.0f ? (r1.y) : (c1.w)), ((r5.w) >= 0.0f ? (r1.z) : (c1.w)), ((r5.w) >= 0.0f ? (r1.w) : (c1.w)));
    ...
    r3 = tex2D(s14, v0.zw);
    r0.xy = (r3.xy) * (c4.ww);
    r7.xy = (r4.yw) * (c12.xx) + (c12.yy);
    r1.xy = (r4.xz) * (r0.xx);
    r1.z = dot(r7.xy, r6.xy) + (c1.w);
    r0.z = (r3.x) * (c4.w) + (-(r1.x));
    r0.x = (r4.z) * (-(r0.x)) + (r0.z);
    ...
    r0.y = (r6.w) * (r2.w);
    r11.y = (r0.x) + (r0.x);
    r1.z = saturate((r1.z) * (r0.y) + (r0.y));
    r0.y = (r0.z) + (r0.z);
    r0.xz = (r2.xy) * (c12.xx);
    r0.xyz = (r1.zzz) * (r0.xyz);
    r11.xz = (r1.xy) * (c12.xx);
    r1.xyz = (r5.xyz) * (r5.xyz);
    r3.xyz = (r11.xyz) * (r6.www) + (r0.xyz);
    r2 = tex2D(s7, v0.xy);
    r2.z = ((r5.w) >= 0.0f ? (r2.y) : (c1.w));
    r2.y = dot(v6.xyz, v6.xyz);
    r0.xyz = (-(v6.xyz)) + (c[20].xyz);
    r3.w = rsqrt(r2.y);
    r2.y = dot(r0.xyz, r0.xyz);
    r4.w = rsqrt(r2.y);
    r17.xyz = (r3.www) * (v6.xyz);
    r10.xyz = lerp(r2.zzz, c[36].xyw, r7.www);
    r2.xyz = (r0.xyz) * (r4.www) + (-(r17.xyz));
    r19.xyz = (r3.xyz) * (r10.yyy);
    r16.xyz = normalize(r2.xyz);
    r18.xyz = (r0.xyz) * (r4.www);
    r0.xyz = (v6.xyz) * (-(r3.www)) + (c[17].xyz);
    r2.z = saturate(dot(r16.xyz, r18.xyz));
    r15.xyz = normalize(r0.xyz);
    r9.w = dot(r18.xyz, c[29].xyz);
    r0.z = saturate(dot(r15.xyz, c[17].xyz));
    r0.x = (-(r2.z)) + (-(c1.y));
    r0.z = (-(r0.z)) + (-(c1.y));
    r2.z = (r0.x) * (r0.x);
    r0.y = (r0.z) * (r0.z);
    ...
    r12.xyz = (r13.xyz) * (r6.www) + (r14.xyz);
    r10.y = saturate(dot(r9.xyz, c[17].xyz));
    r11.w = (r4.w) * (-(c12.z)) + (c12.w);
    r2.xyz = (r10.yyy) * (c[18].xyz);
    if ((r3.w) != (-(r3.w)))
    {
        r0.z = r3.y;
        r5.z = r0.z;
    ...
    r4.xyz = (r5.zzz) * (r2.xyz) + (r19.xyz);
    r6.z = (r4.w) * (c4.z);
    r5.w = saturate(dot(r18.xyz, r9.xyz));
    r0.z = saturate(dot(r9.xyz, -(r17.xyz)));
    r0.y = (r5.w) * (r11.w) + (r6.z);
    r6.w = (r0.z) * (r11.w) + (r6.z);
    r0.x = (r0.y) * (r6.w) + (c13.x);
    r0.y = dot(r17.xyz, r9.xyz);
    r6.y = 1.0f / (r0.x);
    r0.y = (r0.y) + (r0.y);
    r3.w = (r4.w) * (c3.w);
    r3.xyz = (r9.xyz) * (-(r0.yyy)) + (r17.xyz);
    r3 = texCUBElod(s15, r3);
    r0.z = (-(r0.z)) + (-(c1.y));
    r0.y = (r0.z) * (r0.z);
    r5.xy = (r4.ww) * (c38.xy) + (c38.zw);
    r2.z = (r0.z) * (r0.y);
    r2.y = 1.0f / (r5.x);
    r0.xyz = (r3.xyz) * (r3.xyz);
    r2.z = (r2.z) * (r2.y);
    r0.xyz = (r10.xxx) * (r0.xyz);
    r2.xyz = (r13.xyz) * (r2.zzz) + (r14.xyz);
    r3.z = (r5.w) * (r6.y);
    r2.xyz = (r0.xyz) * (r2.xyz);
    r5.y = exp2(r5.y);
    r4.w = saturate(dot(r9.xyz, r16.xyz));
    r3.w = (r5.y) * (c13.y) + (c13.z);
    r0.z = (r10.y) * (r11.w) + (r6.z);
    r0.z = (r0.z) * (r6.w) + (c13.x);
    r3.y = saturate(dot(r9.xyz, r15.xyz));
    r0.y = 1.0f / (r0.z);
    r0.z = pow(abs(r3.y), r5.y);
    r0.y = (r10.y) * (r0.y);
    r0.z = (r3.w) * (r0.z);
    r3.x = (r0.y) * (r0.z);
    r0.xyz = (r13.xyz) * (r10.www) + (r14.xyz);
    r3.y = pow(abs(r4.w), r5.y);
