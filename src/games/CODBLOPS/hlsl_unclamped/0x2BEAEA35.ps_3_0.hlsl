// Mechanically reconstructed from 0x2BEAEA35.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (r0.w) * (v0.y);
    r7.y = (r1.w) + (r1.w);
    r5.xy = (r0.ww) * (-(r5.xy)) + (r5.xy);
    r1.z = dot(r1.xy, r1.xy) + (c7.y);
    r1.w = dot(r5.xy, r5.xy) + (c7.y);
    r1.z = exp2(-(r1.z));
    r1.w = exp2(-(r1.w));
    r2.w = (r1.z) * (c7.z) + (c7.w);
    r1.w = (r1.w) * (c7.z) + (c7.w);
    r1.z = dot(r1.xy, r5.xy) + (c7.y);
    r1.y = (r2.w) * (r1.w);
    r1.z = saturate((r1.z) * (r1.y) + (r1.y));
    r2.xz = (r4.xy) * (c4.xx);
    r1.xyz = (r2.xyz) * (r1.zzz);
    r7.xz = (r3.xy) * (c4.xx);
    r3.xyz = (r7.xyz) * (r1.www) + (r1.xyz);
    r1 = tex2D(s5, v1.xy);
    r2 = tex2D(s0, v1.xy);
    r4.xyz = lerp(r2.xyz, r0.xyz, r0.www);
    r7.w = lerp(r1.y, c7.x, r0.w);
    r2.w = (r1.w) * (-(c4.z)) + (c4.w);
    r0 = tex2D(s4, v8.zw);
