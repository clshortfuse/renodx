// Mechanically reconstructed from 0x6016A38C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (r2.w) * (r2.w);
    r13.xyz = (v0.yyy) * (r0.xyz) + (c12.yyy);
    r4.w = (r1.w) * (r0.w);
    r4.xyz = (r13.xyz) * (c12.zzz);
    r0 = tex2D(s5, v8.zw);
    r3.xyz = (r0.xyz) + (c12.xxx);
    r0 = tex2D(s1, v1.xy);
    r8.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r6.xyz = (v0.zzz) * (r3.xyz) + (c12.yyy);
    r0 = v2;
    ...
    r1.x = dot(r8.xy, r8.xy) + (c12.w);
    r0.z = dot(r0.xy, r0.xy) + (c12.w);
    r1.x = exp2(-(r1.x));
    r0.z = exp2(-(r0.z));
    r1.x = (r1.x) * (c1.x) + (c1.y);
    r2.w = (r0.z) * (c1.x) + (c1.y);
    r0.z = dot(r0.xy, r8.xy) + (c12.w);
    r0.y = (r1.x) * (r2.w);
    r3 = tex2D(s14, v1.zw);
    r8.xy = (r3.xy) * (c2.ww);
