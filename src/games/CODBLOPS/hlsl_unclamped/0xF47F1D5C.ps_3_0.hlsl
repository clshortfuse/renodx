// Mechanically reconstructed from 0xF47F1D5C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r1.w) * (v5.y);
    r16.xy = c0.xy;
    r4.xyz = (r16.xyx) + (-(c[20].xyw));
    r6.xyz = lerp(r2.xyz, r1.xyz, r1.www);
    r7.xyz = (r1.www) * (r4.xyz) + (c[20].xyw);
    r15.xyz = (r3.xyz) * (r7.yyy);
    r13.xyz = (r0.xyz) * (r7.zzz);
    r1 = tex2D(s12, v0.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c0.y) : (c0.x));
