// Mechanically reconstructed from 0x41441DF7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xy = (r1.xy) * (r4.xy);
    r4.xyz = float3(((r5.w) >= 0.0f ? (c[25].x) : (r2.w)), ((r5.w) >= 0.0f ? (c[25].y) : (r2.w)), ((r5.w) >= 0.0f ? (c[25].w) : (r2.w)));
    r1.w = (r1.w) * (r1.x);
    r7.xyz = (r3.xyz) * (r4.yyy);
    r4.w = (r1.y) * (r1.w);
    r3 = tex2D(s12, v0.zw);
    r1 = v1;
    ...
    r4.w = (r4.w) + (r4.w);
    r7.xyz = (r0.xyz) * (r3.xyz) + (r2.xyz);
    r2.xyz = (r9.xyz) * (-(r4.www)) + (r1.xyz);
