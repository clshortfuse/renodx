// Mechanically reconstructed from 0xAE38A3C8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s2, r2.xy);
    r2.xy = (r8.xy) * (c[24].xx);
    r6.xy = (c[25].xy) * (r1.xx) + (r2.xy);
    r2.xy = (c[26].xx) * (r1.xx) + (r2.xy);
    r1 = tex2D(s3, r6.xy);
    r2 = tex2D(s3, r2.xy);
    r0.z = (r1.x) + (r2.x);
    r0.z = (r0.z) + (r0.z);
