// Mechanically reconstructed from 0x86019EC0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r1.z) * (r1.y);
    r1.xyz = (r8.xyz) * (r4.www) + (r2.xyz);
    r0.xyz = (r0.xyz) * (r2.www);
    r14.xyz = (r1.xyz) * (c[20].yyy);
    r13.xyz = (r0.xyz) * (c[20].www);
    r2 = tex2D(s12, v0.zw);
    ...
    r1.xyz = (r3.www) * (r1.xyz) + (r14.xyz);
    r3.xyz = (r13.xyz) * (c[19].xyz);
    r2 = tex2D(s0, v0.xy);
    r0.xyz = (r12.xyz) * (r2.xyz);
