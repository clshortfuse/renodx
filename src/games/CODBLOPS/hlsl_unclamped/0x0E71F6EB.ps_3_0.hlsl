// Mechanically reconstructed from 0x0E71F6EB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = saturate(dot(r4.xyz, r2.xyz));
    r6.y = (r6.x) * (r6.x);
    r2.x = dot(c[37].yz, r6.xy) + (c[37].x);
    r2.yz = saturate((r6.xx) * (c[38].xy) + (c[38].zw));
    r6.xy = (r2.yz) * (r2.yz);
