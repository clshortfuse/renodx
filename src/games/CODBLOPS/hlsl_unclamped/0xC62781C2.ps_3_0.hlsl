// Mechanically reconstructed from 0xC62781C2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyz = (r2.www) * (v3.xyz);
    r4.xyz = (r0.yyy) * (r1.xyz) + (r2.xyz);
    ...
    r3.w = (r0.z) * (r5.w) + (r6.w);
    r0.x = (r0.w) * (r5.w) + (r6.w);
    r11.xyz = (v3.xyz) * (-(r2.www)) + (c[17].xyz);
    r0.x = (r0.x) * (r3.w) + (c3.x);
    r0.x = 1.0f / (r0.x);
