// Mechanically reconstructed from 0x02A99748.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.x = dot(r2.xy, r0.xy) + (c4.z);
    r4.y = dot(r2.xy, r0.zw) + (c4.z);
    r0 = tex2D(s2, v6.xy);
    r6.w = (r0.w) * (v0.y);
    ...
    r1.w = (r2.w) * (c11.x) + (c11.y);
    r3.xyz = (v0.zzz) * (r3.xyz) + (-(c4.yyy));
    r1.w = 1.0f / (r1.w);
