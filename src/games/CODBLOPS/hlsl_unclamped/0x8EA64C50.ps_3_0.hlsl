// Mechanically reconstructed from 0x8EA64C50.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c15 = float4(31.875f, 3.5f, 1.0f, 0.00390625f);
    const float4 c16 = float4(-0.109375f, 30.0f, -0.0700000003f, 1.88679242f);
    const float4 c34 = float4(-2.0f, 3.0f, 1.29999995f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r2.w = pow(abs(v2.w), c[24].y);
    r2.w = (r2.w) + (-(c3.x));
    r2.w = saturate((r2.w) * (c[24].x));
    r2.w = (r2.w) * (c[22].x);
    r6.zw = (r5.zw) * (c12.yy) + (c12.zz);
    ...
    r4.w = 1.0f / (v2.w);
    r6.x = pow(abs(r4.w), c[24].y);
    r4.w = (r6.x) + (-(c3.x));
    r4.w = saturate((r4.w) * (c[24].x));
    r4.w = (r4.w) * (c[23].x);
    r3.w = (r3.w) * (r4.w);
    ...
    r3.x = saturate(lerp(c12.x, r1.w, r2.w));
    r6 = tex2D(s9, v5.xy);
    r6.yz = (c[30].xx) * (v5.xy);
    r7 = tex2D(s5, r6.yz);
    r1.w = (r6.x) * (r7.w);
    ...
    r8.xyz = (r8.xyz) * (c14.www);
    r9 = tex3D(s11, v6.xyz);
    r9.xyz = (r9.xyz) * (r9.xyz);
    r8.xyz = (r8.xyz) * (r9.xyz);
    r8.xyz = (r8.xyz) * (c[26].xxx);
    ...
    r0.yzw = (r8.xyz) * (c15.xxx) + (r0.yzw);
    r1.w = (r5.w) + (c16.z);
    r1.w = saturate((r1.w) * (c16.w));
    r2.w = (r1.w) * (c34.x) + (c34.y);
    r1.w = (r1.w) * (r1.w);
    r1.w = saturate((r2.w) * (r1.w));
    r3.yzw = (r3.yzw) * (v4.xyz);
    r4.xyz = (r3.yzw) * (c[27].xxx);
    r5.xyz = (r3.yzw) * (c[28].xxx);
    r6.x = log2(abs(abs(r5.x)));
    r6.y = log2(abs(abs(r5.y)));
    r6.z = log2(abs(abs(r5.z)));
    r5.xyz = (r6.xyz) * (c34.zzz);
    r6.x = exp2(r5.x);
    r6.y = exp2(r5.y);
    r6.z = exp2(r5.z);
    r3.yzw = (r3.yzw) * (-(c[27].xxx)) + (r6.xyz);
    r3.yzw = (r1.www) * (r3.yzw) + (r4.xyz);
    r1.w = (r7.x) * (r7.w);
    r4.x = c3.x;
    r1.w = (r1.w) * (-(c[32].x)) + (r4.x);
    r4.yzw = (r3.yzw) * (c[31].xyz) + (-(r3.yzw));
