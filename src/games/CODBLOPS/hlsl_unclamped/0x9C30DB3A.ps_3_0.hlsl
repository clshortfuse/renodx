// Mechanically reconstructed from 0x9C30DB3A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xyz = (v0.yyy) * (r0.xyz) + (c2.yyy);
    r2 = tex2D(s0, v1.xy);
    r0.xyz = (r2.xyz) * (-(r8.xyz)) + (r3.xyz);
    r1.w = saturate(dot(r10.xyz, c[17].xyz));
    r0.xyz = (r5.www) * (r0.xyz);
    r3.xyz = (r1.www) * (c[18].xyz);
    r0.xyz = (r2.xyz) * (r8.xyz) + (r0.xyz);
    r12.xyz = (r1.yyy) * (r3.xyz) + (r4.xyz);
