// Mechanically reconstructed from 0xF16F9188.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.z = (r5.w) * (r1.z);
    r1.z = exp2(r6.y);
    r2.w = pow(abs(r5.z), r1.z);
    r7.w = (r1.z) * (c12.x) + (c12.y);
    r6.z = (r2.w) * (r7.w);
    r2.xy = (v1.xy) * (c[31].xy);
    r2 = tex2D(s6, r2.xy);
    ...
    r2.w = (r7.z) * (r6.z);
    r5.xyz = lerp(r2.xyz, c0.yyy, r1.xxx);
    r13.xyz = (r5.xyz) * (-(r5.xyz)) + (c3.xxx);
    r14.xyz = (r5.xyz) * (r5.xyz);
    r5.xyz = (r1.xxx) * (r2.xyz);
    r2.xyz = (r13.xyz) * (r6.www) + (r14.xyz);
