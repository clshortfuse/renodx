// Mechanically reconstructed from 0xDD3DFA76.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r4.w = (r0.w) * (v0.w) + (c0.x);
    r5.xy = float2(((r4.w) >= 0.0f ? (r1.x) : (c0.w)), ((r4.w) >= 0.0f ? (r1.y) : (c0.w)));
    r1 = v2;
