// Mechanically reconstructed from 0xE49859FE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s13, r2.xy);
    r4.w = r2.y;
    r7.xy = lerp(r5.xy, r3.xy, r0.ww);
    r6.xy = (r4.yw) * (c12.xx) + (c12.yy);
    r3 = tex2D(s14, v1.zw);
    r8.xy = (r3.xy) * (c4.ww);
    r2.w = dot(r6.xy, r7.xy) + (c42.z);
    r4.xy = (r4.xz) * (r8.xx);
    r1.w = (r3.x) * (c4.w) + (-(r4.x));
    r5.xy = (r2.xz) * (r8.yy);
    r1.w = (r4.z) * (-(r8.x)) + (r1.w);
    ...
    r0.w = (r3.w) * (r3.w);
    r4.xyz = (v0.zzz) * (r0.xyz) + (c42.www);
    r3.w = (r1.w) * (r0.w);
    r3.xyz = (r3.xyz) * (r4.xyz);
    r0 = tex2D(s8, v1.xy);
    r0.xyz = (r4.xyz) * (r0.xyz);
    r5.xyz = (r3.xyz) * (r3.xyz);
    r14.xyz = (r0.xyz) * (-(r0.xyz)) + (c42.www);
