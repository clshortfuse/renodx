// Mechanically reconstructed from 0xC4AE8F6E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.z = (r5.w) * (r4.z);
    r1.xyz = (r2.xyz) * (r4.yyy) + (r6.xyz);
    r1.w = (r1.w) * (c1.x);
    r1.xyz = (r4.zzz) * (r1.xyz);
    r4.xyz = (r1.xyz) * (c[23].www);
    r1.xyz = (r5.xyz) * (c[23].yyy);
    r4.xyz = (r4.xyz) * (c[8].xyz);
    r1.xyz = (r1.xyz) * (c1.yyy);
    r5.xyz = (r3.www) * (r4.xyz);
    r4.xyz = (r3.www) * (r3.xyz) + (r1.xyz);
    r3 = tex2D(s0, v1.xy);
