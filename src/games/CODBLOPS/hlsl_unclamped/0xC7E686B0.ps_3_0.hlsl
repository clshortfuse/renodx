// Mechanically reconstructed from 0xC7E686B0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = rsqrt(r0.w);
    r16.xyz = (r2.www) * (v7.xyz);
    r2.xyz = (r0.xyz) * (r0.www) + (-(r16.xyz));
    r6.xyz = normalize(r2.xyz);
    r10.xyz = (r0.xyz) * (r0.www);
    r0.w = saturate(dot(r6.xyz, r10.xyz));
    r3.w = (-(r0.w)) + (c1.z);
    r0.w = (r3.w) * (r3.w);
    r11.xyz = lerp(r1.yyy, c[24].xyw, r4.zzz);
    r4.w = (r0.w) * (r0.w);
    r2.w = -(r1.w);
    r2.xyz = c1.xxx;
    r0 = tex2D(s8, v8.xy);
    ...
    r1 = (r4.zzzz) * (r0) + (r1);
    r4.xyz = (v0.zzz) * (r2.xyz) + (c1.zzz);
    r0 = tex2D(s6, v9.xy);
    r2.xyz = (r0.xyz) + (-(c1.zzz));
    r0.xyz = (r1.xyz) * (r4.xyz);
    r2.xyz = (v0.www) * (r2.xyz) + (c1.zzz);
    r3.w = (r3.w) * (r4.w);
    ...
    r1.z = saturate(dot(r14.xyz, r6.xyz));
    r13.w = (r1.w) * (c3.w);
    ...
    r1.y = (r2.w) * (r0.y);
    r1.z = (r0.z) * (r8.w);
    r0.xyz = (r12.xyz) * (r3.www) + (r13.xyz);
    r1.z = (r1.y) * (r1.z);
    r17.xyz = (r5.xyz) * (r11.yyy);
    ...
    r3.z = saturate(dot(r14.xyz, r15.xyz));
    r1.z = 1.0f / (r1.w);
    r1.w = pow(abs(r3.z), r10.w);
    r1.z = (r9.w) * (r1.z);
    r1.w = (r8.w) * (r1.w);
    r1.w = (r1.z) * (r1.w);
    r1.xyz = (r12.xyz) * (r7.www) + (r13.xyz);
