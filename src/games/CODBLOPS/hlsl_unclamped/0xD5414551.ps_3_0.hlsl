// Mechanically reconstructed from 0xD5414551.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.x = dot(r2.xy, r0.xy) + (c1.x);
    r6.y = dot(r2.xy, r0.zw) + (c1.x);
    r0 = tex2D(s4, v7.zw);
    r4.w = (r0.w) * (v0.z) + (c3.z);
    ...
    r0.w = ((r7.w) >= 0.0f ? (c3.w) : (r2.y));
    r9.xyz = normalize(r6.xyz);
    r7.xyz = float3(((r4.w) >= 0.0f ? (c[31].x) : (r0.w)), ((r4.w) >= 0.0f ? (c[31].y) : (r0.w)), ((r4.w) >= 0.0f ? (c[31].w) : (r0.w)));
    r0.w = saturate(dot(r9.xyz, r5.xyz));
    r6.xyz = (r3.xyz) * (r7.yyy);
    ...
    r7.y = (r2.w) * (-(c16.z)) + (c16.w);
    r1.w = saturate(dot(r9.xyz, -(r3.xyz)));
    r3.w = (r0.w) * (r7.y) + (r8.w);
    r7.y = (r1.w) * (r7.y) + (r8.w);
    r3.w = (r3.w) * (r7.y) + (c12.x);
    r10.xyz = (r4.xyz) * (r6.www) + (-(r3.xyz));
    r3.w = 1.0f / (r3.w);
    r4.xyz = normalize(r10.xyz);
    r6.w = (r0.w) * (r3.w);
    r7.y = saturate(dot(r9.xyz, r4.xyz));
    r3.w = saturate(dot(r4.xyz, r5.xyz));
    r5.xy = (r2.ww) * (c14.xy) + (c14.zw);
    r0.w = exp2(r5.y);
    r3.w = (-(r3.w)) + (c3.w);
    r4.y = pow(abs(r7.y), r0.w);
    r4.z = (r3.w) * (r3.w);
