// Mechanically reconstructed from 0xBB5B47E4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xy = float2(((r3.w) >= 0.0f ? (r4.x) : (c0.z)), ((r3.w) >= 0.0f ? (r4.y) : (c0.z)));
    ...
    r4.w = rsqrt(r12.y);
    r1 = float4(((r2.w) >= 0.0f ? (r1.x) : (c0.z)), ((r2.w) >= 0.0f ? (r1.y) : (c0.z)), ((r2.w) >= 0.0f ? (r1.z) : (c0.z)), ((r2.w) >= 0.0f ? (r1.w) : (c0.z)));
    r12.x = 1.0f / (r4.w);
    r11.xyz = float3(((r3.w) >= 0.0f ? (c[41].x) : (r1.w)), ((r3.w) >= 0.0f ? (c[41].y) : (r1.w)), ((r3.w) >= 0.0f ? (c[41].w) : (r1.w)));
    r10.xy = saturate((r12.xx) * (c[39].xy) + (c[39].zw));
    r4.xy = (r10.xy) * (r10.xy);
