// Mechanically reconstructed from 0x732EC992.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (c[28].x) * (c[28].x);
    r2.w = c[28].x;
    r3.xy = (r2.ww) * (r2.ww) + (c2.zw);
    r4.xy = (r0.ww) * (c2.xy);
    r5.x = 1.0f / (r3.x);
    r5.y = 1.0f / (r3.y);
    r2.xyz = (r1.xyz) * (c1.www) + (r2.xyz);
    r2.w = (r4.x) * (-(r5.x)) + (c1.x);
    r1.xyz = (r8.xyz) * (c1.www) + (r9.xyz);
    ...
    r5.x = 1.0f / (r4.z);
    r2.z = saturate((r4.w) * (-(r3.w)) + (r2.z));
    r2.z = (r0.w) * (r2.z);
    r4.xy = saturate((r5.xx) * (c[24].xy) + (c[24].zw));
    r2.xy = (r4.xy) * (r4.xy);
    r4.xy = (r4.xy) * (c1.yy) + (c1.zz);
    r0.w = dot(c[23].yz, r5.xy) + (c[23].x);
    r2.xy = (r2.xy) * (r4.xy);
    r4.z = 1.0f / (r3.w);
    r0.w = (r0.w) * (r2.x);
    r2.x = saturate((r4.w) * (r4.z));
    r0.w = (r2.y) * (r0.w);
    r2.z = (r2.z) * (r2.x);
    r0.w = (r1.w) * (r0.w);
    r2.w = (r2.w) * (r4.w) + (r2.z);
