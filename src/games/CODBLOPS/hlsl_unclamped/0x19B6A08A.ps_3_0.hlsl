// Mechanically reconstructed from 0x19B6A08A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.y = dot(r2.xy, r0.zw) + (c21.w);
    r1 = tex2D(s3, v7.xy);
    r1.xyz = (r1.xyz) + (c21.yyy);
    r3.x = dot(r2.xy, r0.xy) + (c21.w);
    r6.xyz = (v0.yyy) * (r1.xyz) + (c21.zzz);
    r0 = tex2D(s0, v1.xy);
    ...
    r0.w = dot(r5.xy, r5.xy) + (c21.w);
    r0.y = dot(r3.xy, r3.xy) + (c21.w);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c4.x) + (c4.y);
    r1.w = (r0.y) * (c4.x) + (c4.y);
    r0.y = dot(r3.xy, r5.xy) + (c21.w);
    r1.w = (r0.w) * (r1.w);
    ...
    r3.xy = (r1.xz) * (r7.xx);
    r1.xy = (r0.xz) * (r7.yy);
    r0.x = (r2.x) * (c11.w) + (-(r3.x));
    r0.y = (r2.y) * (c11.w) + (-(r1.x));
    r1.z = (r1.z) * (-(r7.x)) + (r0.x);
    r0.z = (r0.z) * (-(r7.y)) + (r0.y);
    r0.y = (r0.z) + (r0.z);
    r0.xz = (r1.xy) * (c12.xx);
