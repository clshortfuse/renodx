// Mechanically reconstructed from 0xFF05D78E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s9, v7.xy);
    r0 = (r1.wwww) * (-(c38.zzzy)) + (-(c38.wwwz));
    r3 = tex2D(s8, v1.xy);
    r2 = lerp(r3, r0, r7.wwww);
    r0 = tex2D(s5, v7.zw);
    r4.w = (r0.w) * (v0.z);
    r4.xyz = lerp(c[34].xyw, r1.yyy, r7.www);
    r3.xyz = lerp(r5.xyz, r0.xyz, r4.www);
    r0 = tex2D(s10, v7.zw);
    r1 = lerp(r2, r0, r4.wwww);
    r0 = tex2D(s6, v8.xy);
    r0.xyz = (r0.xyz) + (c38.yyy);
    r8.xyz = lerp(r4.xyz, c[35].xyw, r4.www);
    r0.xyz = (v0.www) * (r0.xyz) + (-(c38.yyy));
    ...
    r0.y = (r2.x) * (c4.w) + (-(r1.x));
    r0.w = dot(r9.xy, r7.xy) + (c38.z);
    r1.z = (r3.z) * (-(r6.x)) + (r0.y);
    r3.xy = (r0.xz) * (r6.yy);
    r0.x = dot(r9.xy, r9.xy) + (c38.z);
    r0.y = (r2.y) * (c4.w) + (-(r3.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r0.z) * (-(r6.y)) + (r0.y);
    r0.z = (r0.x) * (c3.x) + (c3.y);
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (-(c38.y)) : (-(c38.z)));
