// Mechanically reconstructed from 0xB71591C2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s2, v7.zw);
    r6.z = (r0.w) * (v7.y);
    r2.xyz = lerp(r1.xyz, r0.xyz, r6.zzz);
    r0.w = (r0.w) * (-(v7.y)) + (c1.x);
    r5.w = (r1.w) * (-(r0.w)) + (c1.x);
    r0.w = c1.z;
    ...
    r0.z = (r0.w) * (r0.z) + (c13.x);
    r0.w = (r2.w) * (c13.y) + (c13.z);
    r0.z = 1.0f / (r0.z);
    r0.w = (r0.y) * (r0.w);
    r0.z = (r1.w) * (r0.z);
    r8.xz = (r4.xy) * (c12.xx);
    r0.w = (r0.w) * (r0.z);
    r0.xyz = (r8.xyz) * (r4.www) + (r1.xyz);
    r0.w = (r3.w) * (r0.w);
