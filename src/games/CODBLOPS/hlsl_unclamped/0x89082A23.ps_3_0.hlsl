// Mechanically reconstructed from 0x89082A23.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5 = (c3.xxxx) * (v8) + (c3.yyyy);
    r2.z = dot(r6.xy, r5.zw) + (c3.z);
    r2.x = dot(r6.xy, r5.xy) + (c3.z);
    r4.xyz = float3(((r1.w) >= 0.0f ? (r1.x) : (r4.x)), ((r1.w) >= 0.0f ? (r1.y) : (r4.y)), ((r1.w) >= 0.0f ? (r1.z) : (r4.z)));
    r1.xyz = float3(((r1.w) >= 0.0f ? (r2.x) : (r0.x)), ((r1.w) >= 0.0f ? (r2.z) : (r0.y)), ((r1.w) >= 0.0f ? (r2.w) : (r0.z)));
    r0 = tex2D(s6, v7.zw);
    r5.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c3.xxxx) * (v9) + (c3.yyyy);
    r6.y = dot(r5.xy, r0.zw) + (c3.z);
    r6.x = dot(r5.xy, r0.xy) + (c3.z);
    r0 = tex2D(s4, v7.zw);
    r7.z = (r0.w) * (v0.z);
    r1.w = ((r1.w) >= 0.0f ? (r2.y) : (r3.y));
    r5.xy = lerp(r1.xy, r6.xy, r7.zz);
    r2.xyz = lerp(r4.xyz, r0.xyz, r7.zzz);
    r0.w = dot(r5.xy, r5.xy) + (c3.z);
    ...
    r0 = tex2D(s13, r0.xy);
    r3.w = r0.y;
    r12.xyz = lerp(r1.www, c[23].xyw, r7.zzz);
    r4.xy = (r3.yw) * (c13.xx) + (c13.yy);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c12.zz);
    r0.w = dot(r4.xy, r5.xy) + (c3.z);
    r1.xy = (r3.xz) * (r7.xx);
    r0.y = (r2.x) * (c12.z) + (-(r1.x));
    r3.xy = (r0.xz) * (r7.yy);
    r0.y = (r3.z) * (-(r7.x)) + (r0.y);
    r0.x = (r2.y) * (c12.z) + (-(r3.x));
    r0.z = (r0.z) * (-(r7.y)) + (r0.x);
    r10.y = (r0.y) + (r0.y);
    r0.y = (r0.z) + (r0.z);
    r0.z = dot(r4.xy, r4.xy) + (c3.z);
    r0.z = exp2(-(r0.z));
    r0.x = dot(v6.xyz, v6.xyz);
    r0.z = (r0.z) * (c4.z) + (c4.w);
    r8.w = rsqrt(r0.x);
    r0.z = (r4.w) * (r0.z);
    r2.xyz = (v6.xyz) * (-(r8.www)) + (c[17].xyz);
    ...
    r10.xz = (r1.xy) * (c12.ww);
    r1.w = (r0.w) * (r0.w);
    r0.xyz = (r10.xyz) * (r4.www) + (r0.xyz);
    r1.w = (r1.w) * (r1.w);
    r13.xyz = (r12.yyy) * (r0.xyz);
    r6.w = (r0.w) * (r1.w);
    r0 = tex2D(s12, v1.zw);
    r2.xyz = v2.xyz;
