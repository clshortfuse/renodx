// Mechanically reconstructed from 0x6661625F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = c2.w;
    r4.xyz = float3(((r13.w) >= 0.0f ? (r6.w) : (c[39].x)), ((r13.w) >= 0.0f ? (r6.w) : (c[39].y)), ((r13.w) >= 0.0f ? (r6.w) : (c[39].w)));
    r2 = tex2D(s8, v6.zw);
