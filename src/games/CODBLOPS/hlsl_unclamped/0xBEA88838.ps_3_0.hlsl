// Mechanically reconstructed from 0xBEA88838.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.xyz = float3(((r6.w) >= 0.0f ? (r0.x) : (r3.x)), ((r6.w) >= 0.0f ? (r0.y) : (r3.y)), ((r6.w) >= 0.0f ? (r0.z) : (r3.z)));
    ...
    r0.z = (r1.w) * (c3.w);
    r2.z = saturate(dot(r1.xyz, r10.xyz));
    r0.y = (r7.w) * (r2.x) + (r0.z);
    ...
    r2.w = (r0.x) * (r0.y);
    r2.z = (r3.w) * (r0.z);
    r0.xyz = (r8.xyz) * (r8.www) + (r9.xyz);
    r2.w = (r2.w) * (r2.z);
    r10.xyz = float3(((r6.w) >= 0.0f ? (c[5].x) : (r2.y)), ((r6.w) >= 0.0f ? (c[5].y) : (r2.y)), ((r6.w) >= 0.0f ? (c[5].w) : (r2.y)));
    r0.xyz = (r0.xyz) * (r2.www);
    r15.xyz = (r6.xyz) * (r10.yyy);
