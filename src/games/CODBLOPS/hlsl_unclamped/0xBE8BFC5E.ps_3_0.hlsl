// Mechanically reconstructed from 0xBE8BFC5E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r6.w) * (r1.w);
    r0.xyz = (r5.xyz) * (r3.zzz) + (r7.xyz);
    r6.w = 1.0f / (r3.x);
    r0.xyz = (r1.www) * (r0.xyz);
    r0.xyz = (r0.xyz) * (c[36].www);
    r4.xy = c[32].xy;
    r3.xyz = (r4.yyy) * (c[31].xyz);
    r1.w = (r0.w) * (c1.x);
    r3.xyz = (r0.xyz) * (r3.xyz);
    r1.xyz = (r1.xyz) * (c[36].yyy);
    r0.xyz = (r4.xxx) * (c[30].xyz);
    r1.xyz = (r1.xyz) * (c1.yyy);
    r0.xyz = (r6.zzz) * (r0.xyz);
    r6.xyz = (r10.www) * (r3.xyz);
    r3.xyz = (r10.www) * (r0.xyz) + (r1.xyz);
    r0 = tex2D(s0, v1.xy);
