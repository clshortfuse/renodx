// Mechanically reconstructed from 0xD7AE144E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = tex2D(s14, v1.zw);
    r7.xy = (r3.xy) * (c10.xx);
    r0.w = dot(r6.xy, r1.xy) + (c3.z);
    r5.xy = (r5.xz) * (r7.yy);
    r0.w = saturate((r0.w) * (r2.y) + (r2.y));
    r2.y = (r3.y) * (c10.x) + (-(r5.x));
    r6.xz = (r5.xy) * (c10.yy);
    r2.y = (r5.z) * (-(r7.y)) + (r2.y);
    r6.y = (r2.y) + (r2.y);
    r2.xy = (r2.xz) * (r7.xx);
    r5.xyz = (r0.www) * (r6.xyz);
    r0.w = (r3.x) * (c10.x) + (-(r2.x));
    r6.xz = (r2.xy) * (c10.yy);
    r3.xyz = v2.xyz;
