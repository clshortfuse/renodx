// Mechanically reconstructed from 0x6B6064E2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = dot(r4.xy, r2.xy) + (c1.z);
    r0.y = dot(r4.xy, r2.zw) + (c1.z);
    r2 = tex2D(s3, v6.xy);
    r2.w = (r2.w) * (v0.y) + (c1.w);
    ...
    r4.x = dot(r5.xy, r0.xy) + (c1.z);
    r4.y = dot(r5.xy, r0.zw) + (c1.z);
    r0 = tex2D(s4, v6.zw);
    r5.w = (r0.w) * (v0.z);
    r6.xy = lerp(r3.xy, r4.xy, r5.ww);
    r4.xyz = v4.xyz;
    r4.xyz = (r6.xxx) * (r4.xyz) + (v2.xyz);
