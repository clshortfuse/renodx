// Mechanically reconstructed from 0x0599B5F9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyw = c[21].xyw;
    r0.xyz = (-(r0.xyw)) + (c[22].xyw);
    r3.xyz = (r7.www) * (r0.xyz) + (c[21].xyw);
    r0 = v2;
    ...
    r12.xyz = (r9.www) * (c[6].xyz);
    r8.xyz = (r5.xyz) * (r5.www) + (-(r10.xyz));
    r5 = tex2D(s6, v1.xy);
    r4 = tex2D(s7, v8.xy);
