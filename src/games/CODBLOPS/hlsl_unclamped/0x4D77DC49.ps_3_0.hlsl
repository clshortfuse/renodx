// Mechanically reconstructed from 0x4D77DC49.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c26 = float4(4.0f, -2.0f, 0.797884583f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r3.w = r0.y;
    r14.w = rsqrt(r1.z);
    r1.xy = (r3.yw) * (c26.xx) + (c26.yy);
    r2 = tex2D(s14, v1.zw);
    r5.xy = (r2.xy) * (c1.ww);
    r2.w = dot(r1.xy, r7.xy) + (c3.z);
    r6.xy = (r3.xz) * (r5.xx);
    r0.w = (r2.x) * (c1.w) + (-(r6.x));
    r12.xy = (r0.xz) * (r5.yy);
    r0.y = (r3.z) * (-(r5.x)) + (r0.w);
    r0.w = (r2.y) * (c1.w) + (-(r12.x));
    r0.w = (r0.z) * (-(r5.y)) + (r0.w);
    r8.y = (r0.y) + (r0.y);
    r3.y = (r0.w) + (r0.w);
    ...
    r3.w = rsqrt(r1.z);
    r1.xyz = (r14.www) * (v7.xyz);
    r0.w = exp2(-(r0.w));
    r5.xyz = (r0.xyz) * (r3.www) + (-(r1.xyz));
    r2.xyz = normalize(r5.xyz);
    r10.xyz = (r0.xyz) * (r3.www);
    r0.z = (r0.w) * (c1.x) + (c1.y);
    r0.w = saturate(dot(r2.xyz, r10.xyz));
    r0.z = (r4.w) * (r0.z);
    r0.w = (-(r0.w)) + (c3.y);
    r5.w = saturate((r2.w) * (r0.z) + (r0.z));
    r0.z = (r0.w) * (r0.w);
    r3.xz = (r12.xy) * (c4.ww);
    r0.z = (r0.z) * (r0.z);
    r3.w = (r0.w) * (r0.z);
    ...
    r11.w = (r1.w) * (-(c26.z)) + (c26.w);
    r13.xyz = normalize(r0.xyz);
    r2.z = saturate(dot(r13.xyz, r2.xyz));
    r12.w = (r1.w) * (c1.z);
    r2.w = saturate(dot(r10.xyz, r13.xyz));
    r13.w = saturate(dot(r13.xyz, -(r1.xyz)));
    ...
    r3.xyz = (r2.xyz) * (c[24].www);
    r2.xyz = (r2.www) * (c[6].xyz);
    r0.xyz = (r8.xyz) * (r4.www) + (r0.xyz);
    r7.xyz = (r9.xyz) * (r2.xyz) + (r3.xyz);
    r15.xyz = (r0.xyz) * (c[24].yyy);
    ...
    r0.y = (r0.z) * (r0.z);
    r0.y = (r0.z) * (r0.y);
    r0.z = dot(r1.xyz, r13.xyz);
    r3.w = (r0.x) * (r0.y);
    r0.z = (r0.z) + (r0.z);
    r1.w = (r1.w) * (c3.w);
    r1.xyz = (r13.xyz) * (-(r0.zzz)) + (r1.xyz);
