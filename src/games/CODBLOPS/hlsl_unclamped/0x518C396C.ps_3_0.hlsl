// Mechanically reconstructed from 0x518C396C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s7, v1.xy);
    r11.xyz = float3(((r11.w) >= 0.0f ? (c[39].x) : (r1.y)), ((r11.w) >= 0.0f ? (c[39].y) : (r1.y)), ((r11.w) >= 0.0f ? (c[39].w) : (r1.y)));
