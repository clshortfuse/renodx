// Mechanically reconstructed from 0x305A5DEB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s7, v6.zw);
    r9.xyz = float3(((r4.w) >= 0.0f ? (r1.y) : (c[31].x)), ((r4.w) >= 0.0f ? (r1.y) : (c[31].y)), ((r4.w) >= 0.0f ? (r1.y) : (c[31].w)));
