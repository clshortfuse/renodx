// Mechanically reconstructed from 0xCBBFD703.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c32 = float4(4.0f, -2.0f, 8.0f, 0.999511719f);
    const float4 c33 = float4(9.99999994e-09f, 0.0f, 0.0f, 0.0f);
    const float4 c34 = float4(1.0f, 0.5f, 0.0f, 1000.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0.xy = (v9.zw) * (c34.xy);
    r2 = tex2D(s13, r0.xy);
    r0.xy = (v9.zw) * (c34.xy) + (c34.zy);
    r0 = tex2D(s13, r0.xy);
    r2.w = r0.y;
    r3.xyz = normalize(c[17].xyz);
    r5.xy = (r2.yw) * (c32.xx) + (c32.yy);
    ...
    r3.xy = (r2.xz) * (r4.xx);
    r0.y = (r1.x) * (c19.w) + (-(r3.x));
    r2.xy = (r0.xz) * (r4.yy);
    r0.y = (r2.z) * (-(r4.x)) + (r0.y);
    r0.x = (r1.y) * (c19.w) + (-(r2.x));
    r0.z = (r0.z) * (-(r4.y)) + (r0.x);
    r1.y = (r0.y) + (r0.y);
    r0.y = (r0.z) + (r0.z);
