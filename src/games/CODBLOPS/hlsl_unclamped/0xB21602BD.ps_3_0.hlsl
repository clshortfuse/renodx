// Mechanically reconstructed from 0xB21602BD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.x = dot(r3.xy, r2.xy) + (c1.z);
    r4.y = dot(r3.xy, r2.zw) + (c1.z);
    r2 = tex2D(s4, v7.xy);
    r2.w = (r2.w) * (v0.y);
    r1.w = r0.x;
    r3.xy = lerp(r6.xy, r4.xy, r2.ww);
    r0 = tex2D(s5, v7.zw);
    r5.w = (r0.w) * (v0.z);
    r0.w = dot(r1, c2.xxxx);
    r3.xy = (r5.ww) * (-(r3.xy)) + (r3.xy);
    r0.w = (r0.w) + (c1.y);
    r1.xyz = v4.xyz;
