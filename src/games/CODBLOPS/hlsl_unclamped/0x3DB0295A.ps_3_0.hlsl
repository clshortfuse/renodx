// Mechanically reconstructed from 0x3DB0295A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r1.w) * (r2.w);
    r0.y = saturate(dot(r9.xyz, -(r7.xyz)));
    r2 = tex2D(s2, v1.xy);
    r2.x = (r2.w) * (c1.w);
    r0.z = (r2.w) * (-(c1.w)) + (c1.z);
    ...
    r1.z = (r3.w) + (r3.w);
    r3.xyz = (r9.xyz) * (-(r1.zzz)) + (r7.xyz);
    r3.w = (r2.w) * (c1.x);
    r3 = texCUBElod(s15, r3);
    r1.xyz = (r3.xyz) * (r3.xyz);
    r7.xyz = (r5.xyz) * (c1.yyy);
    r5.xyz = (r1.xyz) * (c1.xxx);
    r3 = tex3D(s11, v7.xyz);
    r1.xyz = (r3.xyz) * (r3.xyz);
    r3.xyz = (r1.www) * (r6.xyz) + (r7.xyz);
