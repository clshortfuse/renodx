// Mechanically reconstructed from 0x6E1AADC7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.z = saturate(dot(r4.xyz, r1.xyz));
    ...
    r1.y = c0.z;
    r1.xyz = float3(((r3.w) >= 0.0f ? (c[11].x) : (r1.y)), ((r3.w) >= 0.0f ? (c[11].y) : (r1.y)), ((r3.w) >= 0.0f ? (c[11].w) : (r1.y)));
    r2.w = (r2.w) * (c0.w);
    r2.xyz = (r2.xyz) * (r1.zzz);
    r0 = float4(((r3.w) >= 0.0f ? (r0.x) : (c0.z)), ((r3.w) >= 0.0f ? (r0.y) : (c0.z)), ((r3.w) >= 0.0f ? (r0.z) : (c0.z)), ((r3.w) >= 0.0f ? (r0.w) : (c0.z)));
    r6.xyz = (r2.xyz) * (c[8].xyz);
