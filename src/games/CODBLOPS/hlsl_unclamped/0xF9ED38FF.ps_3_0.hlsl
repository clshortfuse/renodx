// Mechanically reconstructed from 0xF9ED38FF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = dot(r3.xy, r0.zw) + (c4.z);
    r1 = tex2D(s8, v7.zw);
    r4.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r1 = (c4.xxxx) * (v9) + (c4.yyyy);
    r2.x = dot(r3.xy, r0.xy) + (c4.z);
    r5.y = dot(r4.xy, r1.zw) + (c4.z);
    r0 = tex2D(s1, v1.xy);
    r3.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = tex2D(s5, v7.xy);
    r5.w = (r0.w) * (v0.y) + (c4.w);
    r5.x = dot(r4.xy, r1.xy) + (c4.z);
    ...
    r11.xy = lerp(r6.xy, r5.xy, r12.ww);
    r2.xyz = lerp(r4.xyz, r1.xyz, r12.www);
    r0.w = dot(r11.xy, r11.xy) + (c4.z);
    ...
    r1.xy = (v1.zw) * (-(c4.yw));
    r4 = tex2D(s13, r1.xy);
    r1.xy = (v1.zw) * (-(c4.yw)) + (-(c4.zw));
    r1 = tex2D(s13, r1.xy);
    r4.w = r1.y;
    r2 = tex2D(s14, v1.zw);
    r6.xy = (r2.xy) * (c12.ww);
    r7.xy = (r4.yw) * (c13.xx) + (c13.yy);
    r4.xy = (r4.xz) * (r6.xx);
    r0.z = dot(r7.xy, r11.xy) + (c4.z);
    r0.x = (r2.x) * (c12.w) + (-(r4.x));
    r1.y = (r4.z) * (-(r6.x)) + (r0.x);
    r5.xy = (r1.xz) * (r6.yy);
    r1.w = (r2.y) * (c12.w) + (-(r5.x));
    r0.x = dot(r7.xy, r7.xy) + (c4.z);
    r1.w = (r1.z) * (-(r6.y)) + (r1.w);
    r0.x = exp2(-(r0.x));
    r6.y = (r1.y) + (r1.y);
    ...
    r6.xz = (r4.xy) * (c13.xx);
    r4.xyz = (r6.xyz) * (r0.www) + (r1.xyz);
    r5.xyz = float3(((r5.w) >= 0.0f ? (c[32].x) : (r0.y)), ((r5.w) >= 0.0f ? (c[32].y) : (r0.y)), ((r5.w) >= 0.0f ? (c[32].w) : (r0.y)));
    r1 = tex2D(s11, v7.zw);
    ...
    r0 = lerp(r3, r2, r12.wwww);
    r1.w = saturate(dot(r10.xyz, r8.xyz));
    r15.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c4.yyy));
    r1.w = (-(r1.w)) + (-(c4.y));
    ...
    r1.x = (r2.w) * (r0.y);
    r1.z = (r0.z) * (r5.w);
    r0.xyz = (r15.xyz) * (r3.www) + (r16.xyz);
    r1.z = (r1.x) * (r1.z);
    r14.xyz = lerp(r5.xyz, r1.yyy, r12.www);
