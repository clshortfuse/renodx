// Mechanically reconstructed from 0xA1E63FCD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s10, v7.zw);
    r12.xy = lerp(r1.xy, r0.wy, r3.ww);
    r9.xyz = (r2.xyz) * (r2.xyz);
    r8.w = (r12.x) * (-(c34.z)) + (c34.w);
    ...
    r6.xy = (r2.yw) * (c34.xx) + (c34.yy);
    r1 = tex2D(s14, v1.zw);
    r10.xy = (r1.xy) * (c12.zz);
    r0.w = dot(r6.xy, r4.xy) + (c3.w);
    r3.xy = (r2.xz) * (r10.xx);
