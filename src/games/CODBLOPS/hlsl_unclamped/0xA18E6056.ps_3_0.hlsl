// Mechanically reconstructed from 0xA18E6056.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s3, v5.zw);
    r3.w = (r0.w) * (v5.y) + (c1.w);
    r7.xyz = float3(((r3.w) >= 0.0f ? (r2.x) : (r3.x)), ((r3.w) >= 0.0f ? (r2.y) : (r3.y)), ((r3.w) >= 0.0f ? (r2.z) : (r3.z)));
    r2.xyz = (r1.xyz) * (r1.xyz);
    r1.xyz = v3.xyz;
    r1.xyz = (r7.xxx) * (r1.xyz) + (v1.xyz);
    r3.xyz = (r2.www) * (r2.xyz);
    r1.xyz = (r7.yyy) * (v2.xyz) + (r1.xyz);
