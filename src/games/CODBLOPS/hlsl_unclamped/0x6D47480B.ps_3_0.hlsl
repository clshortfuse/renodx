// Mechanically reconstructed from 0x6D47480B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r1.w) * (r1.w);
    r0.xyz = (r0.xyz) * (c2.www) + (r3.xyz);
    r1.w = (r1.w) * (c[21].w);
    r0.xyz = (c[21].xyz) * (r1.www) + (r0.xyz);
