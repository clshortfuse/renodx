// Mechanically reconstructed from 0x6CD9AEEB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = (v0.zzz) * (r0.xyz) + (c14.xxx);
    r0 = v2;
    r3.xyz = (r14.xxx) * (v5.xyz) + (r0.xyz);
    r0.xyz = (r6.xyz) * (c14.zzz);
    r3.xyz = (r14.yyy) * (v4.xyz) + (r3.xyz);
    ...
    r2.xy = (r0.xy) * (r2.xy);
    r0.xyz = (r3.xyz) * (r13.xxx);
    r2.w = (r2.w) * (r2.x);
    r12.xyz = (r0.xyz) * (c[7].xyz);
    r9.w = (r2.y) * (r2.w);
    r2 = tex2D(s12, v1.zw);
    r0.xy = (v1.zw) * (c2.xy);
    r3 = tex2D(s13, r0.xy);
    ...
    r2.w = dot(r14.xy, r14.xy) + (c14.w);
    r0.z = dot(r0.xy, r0.xy) + (c14.w);
    r2.w = exp2(-(r2.w));
    r0.z = exp2(-(r0.z));
    r2.w = (r2.w) * (c1.x) + (c1.y);
    r2.z = (r0.z) * (c1.x) + (c1.y);
    r0.z = dot(r0.xy, r14.xy) + (c14.w);
    r0.y = (r2.w) * (r2.z);
    r4 = tex2D(s14, v1.zw);
    r14.xy = (r4.xy) * (c2.ww);
