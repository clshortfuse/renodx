// Mechanically reconstructed from 0x55BBD5E1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = (r1.w) * (r1.w);
    r6.xyz = (v0.zzz) * (r3.xyz) + (-(c3.yyy));
    r3 = tex2D(s4, v7.xy);
    r3.xyz = (r3.xyz) + (c3.yyy);
    r7.xyz = (r6.xyz) * (c4.xxx);
    r3.xyz = (v0.www) * (r3.xyz) + (-(c3.yyy));
    r1.w = (r1.w) * (r1.x);
    r7.xyz = (r7.xyz) * (r3.xyz);
    r1.w = (r1.y) * (r1.w);
    r8.xyz = (r7.xyz) * (-(r7.xyz)) + (-(c3.yyy));
