// Mechanically reconstructed from 0x5E884E8B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.w = (r4.w) * (r6.w) + (r6.z);
    r6.w = (r3.w) * (r6.w) + (r6.z);
    r11.xyz = (r0.xyz) * (c[36].yyy);
    r0.z = (r5.w) * (r6.w) + (c12.x);
    ...
    r2.w = (r5.w) * (r4.w);
    r2.xyz = (r5.xyz) * (r2.zzz) + (r10.xyz);
    r1.xyz = (r4.xyz) * (r7.xyz) + (r11.xyz);
