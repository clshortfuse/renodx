// Mechanically reconstructed from 0x5EB06FD4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r0.w) * (v0.y) + (c3.w);
    r3.z = r2.w;
    r4.xyz = float3(((r1.w) >= 0.0f ? (r0.x) : (r4.x)), ((r1.w) >= 0.0f ? (r0.y) : (r4.y)), ((r1.w) >= 0.0f ? (r0.z) : (r4.z)));
    r0 = tex2D(s8, v7.xy);
    r1.z = r0.w;
    r1.xyz = float3(((r1.w) >= 0.0f ? (r1.x) : (r3.x)), ((r1.w) >= 0.0f ? (r1.y) : (r3.y)), ((r1.w) >= 0.0f ? (r1.z) : (r3.z)));
    ...
    r1.xy = (r7.zz) * (-(r1.xy)) + (r1.xy);
    r6.xyz = normalize(r2.xyz);
    r0.w = dot(r1.xy, r1.xy) + (c3.z);
    r1.w = saturate(dot(r6.xyz, c[17].xyz));
    r0.w = exp2(-(r0.w));
    r8.xyz = lerp(r4.xyz, r0.xyz, r7.zzz);
    r4.w = (r0.w) * (c4.z) + (c4.w);
    r12.xyz = lerp(r2.www, c[23].xyw, r7.zzz);
    r0.xy = (v1.zw) * (-(c3.yw));
    r3 = tex2D(s13, r0.xy);
    ...
    r2 = tex2D(s14, v1.zw);
    r5.xy = (r2.xy) * (c12.zz);
    r7.xy = (r3.yw) * (c13.xx) + (c13.yy);
    r3.xy = (r3.xz) * (r5.xx);
    r0.w = dot(r7.xy, r1.xy) + (c3.z);
    r0.y = (r2.x) * (c12.z) + (-(r3.x));
    r2.w = (r3.z) * (-(r5.x)) + (r0.y);
    r4.xy = (r0.xz) * (r5.yy);
    r0.y = (r2.y) * (c12.z) + (-(r4.x));
