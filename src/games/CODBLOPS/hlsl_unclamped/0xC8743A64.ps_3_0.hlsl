// Mechanically reconstructed from 0xC8743A64.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s0, v1.xy);
    r1 = tex2D(s5, v1.xy);
    r4.xyz = (r1.xyz) * (-(r1.xyz)) + (c3.xxx);
    r5.xyz = (r1.xyz) * (r1.xyz);
    r10.w = (r1.w) * (-(c3.y)) + (c3.x);
    r10.z = (r1.w) * (c3.y);
    r11.w = saturate(dot(r6.xyz, r8.xyz));
    r2.w = saturate(dot(r8.xyz, -(r0.xyz)));
    r1.z = (r11.w) * (r10.w) + (r10.z);
    r8.w = (r2.w) * (r10.w) + (r10.z);
    r1.z = (r1.z) * (r8.w) + (c4.w);
    r10.xy = (r1.ww) * (c15.xy) + (c15.zw);
    r1.y = 1.0f / (r1.z);
    r9.w = exp2(r10.y);
    r1.z = pow(abs(r6.w), r9.w);
    r6.w = (r9.w) * (c13.x) + (c13.y);
    r6.y = (r11.w) * (r1.y);
    r6.z = (r1.z) * (r6.w);
    r1.xyz = (r4.xyz) * (r11.zzz) + (r5.xyz);
    r6.z = (r6.y) * (r6.z);
