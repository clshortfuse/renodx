// Mechanically reconstructed from 0xC72F36D2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xyz = (r4.xyz) * (c[23].xyz);
    r0.xyz = (r0.xyz) * (v0.xyz);
    r4.xyz = (r3.xyz) * (r2.xyz);
    r6.xyz = (r0.xyz) * (r0.xyz);
    r0.xyz = (r11.xyz) * (c[36].yyy);
