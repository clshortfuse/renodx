// Mechanically reconstructed from 0xE24F9FB8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = dot(r4.xy, r2.xy) + (c3.z);
    r0.y = dot(r4.xy, r2.zw) + (c3.z);
    r2 = tex2D(s5, v1.xy);
    r3.zw = r2.yy;
    r4 = tex2D(s2, v6.xy);
    r4.w = (r4.w) * (v0.y) + (c3.w);
    ...
    r5.w = (r1.y) * (c4.x) + (c4.y);
    r1.y = (r1.w) * (r5.w);
    r1.w = dot(r6.xy, r0.xy) + (c3.z);
    r3 = tex2D(s14, v1.zw);
    r7.xy = (r3.xy) * (c12.xx);
    r3.w = saturate((r1.w) * (r1.y) + (r1.y));
    r5.xy = (r5.xz) * (r7.yy);
    r1.w = (r3.y) * (c12.x) + (-(r5.x));
    r6.xz = (r5.xy) * (c12.yy);
    r1.w = (r5.z) * (-(r7.y)) + (r1.w);
    r1.xy = (r1.xz) * (r7.xx);
    r6.y = (r1.w) + (r1.w);
