// Mechanically reconstructed from 0xD8118892.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.x = dot(r5.xy, r0.xy) + (c3.x);
    r2.y = dot(r5.xy, r0.zw) + (c3.x);
    r0 = tex2D(s4, v6.zw);
    r12.w = (r0.w) * (v0.z);
    r5.xy = (r1.yw) * (c4.yy) + (c4.zz);
    r9.xy = lerp(r6.xy, r2.xy, r12.ww);
    ...
    r12.y = (r2.w) + (r2.w);
    r6.w = c1.w;
    r3.xyz = float3(((r13.w) >= 0.0f ? (r6.w) : (c[34].x)), ((r13.w) >= 0.0f ? (r6.w) : (c[34].y)), ((r13.w) >= 0.0f ? (r6.w) : (c[34].w)));
    r2.xyz = (r12.xyz) * (r3.www) + (r5.xyz);
    r11.xyz = lerp(r3.xyz, c[35].xyw, r12.www);
