// Mechanically reconstructed from 0x854C2915.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c3 = float4(-0.5f, 0.0f, 1.0f, 0.200000003f);
    ...
    const float4 c34 = float4(0.00048828125f, -0.000122070312f, 0.0f, 0.0f);
    ...
    r5.y = dot(r1.xy, r0.zw) + (c36.w);
    r5.x = dot(r1.xy, r0.xy) + (c36.w);
    r0 = tex2D(s1, v1.xy);
    r1 = tex2D(s5, v7.xy);
    r1.xyz = (r1.xyz) + (c36.yyy);
    r6.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r4.xyz = (v0.yyy) * (r1.xyz) + (c36.zzz);
    r0 = tex2D(s0, v1.xy);
    ...
    r0 = tex2D(s13, r0.xy);
    r2.w = r0.y;
    r10.xy = float2(((r4.w) >= 0.0f ? (r5.x) : (r6.x)), ((r4.w) >= 0.0f ? (r5.y) : (r6.y)));
    r1.xy = (r2.yw) * (c13.xx) + (c13.yy);
    r0.w = dot(r10.xy, r10.xy) + (c36.w);
    r0.y = dot(r1.xy, r1.xy) + (c36.w);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c4.x) + (c4.y);
    r1.w = (r0.y) * (c4.x) + (c4.y);
    r0.y = dot(r1.xy, r10.xy) + (c36.w);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v1.zw);
    r6.xy = (r1.xy) * (c12.ww);
    ...
    r1.z = saturate(dot(r17.xyz, r4.xyz));
    r10.w = (r0.w) * (c4.w);
    ...
    r1.x = (r2.w) * (r0.y);
    r1.z = (r0.z) * (r5.w);
    r0.xyz = (r15.xyz) * (r5.zzz) + (r16.xyz);
    r1.z = (r1.x) * (r1.z);
    r14.xyz = float3(((r4.w) >= 0.0f ? (r1.y) : (c[32].x)), ((r4.w) >= 0.0f ? (r1.y) : (c[32].y)), ((r4.w) >= 0.0f ? (r1.y) : (c[32].w)));
    r0.xyz = (r0.xyz) * (r1.zzz);
    r13.xyz = (r3.xyz) * (r14.yyy);
    ...
    r1.xy = (r1.xy) * (r1.xy);
    r1.w = ((-abs(r1.w)) >= 0.0f ? (c36.w) : (r1.z));
    r1.z = (r3.x) * (r1.x);
    r1.w = (r1.w) * (r1.z);
    r1.z = (r1.y) * (-(r3.y)) + (c36.z);
    r1.xy = (r2.ww) * (r2.xy);
    r1.w = (r1.w) * (r1.z);
    r2.w = (r3.z) * (r1.w);
