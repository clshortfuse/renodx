// Mechanically reconstructed from 0xA2E106CF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.xyz = float3(((r8.w) >= 0.0f ? (r4.y) : (c[10].x)), ((r8.w) >= 0.0f ? (r4.y) : (c[10].y)), ((r8.w) >= 0.0f ? (r4.y) : (c[10].w)));
