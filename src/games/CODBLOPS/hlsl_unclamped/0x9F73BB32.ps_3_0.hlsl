// Mechanically reconstructed from 0x9F73BB32.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s5, v7.zw);
    r4.z = (r0.w) * (v7.y);
    r3.xyz = lerp(r1.xyz, r0.xyz, r4.zzz);
    r4.xy = (r4.zz) * (-(r4.xy)) + (r4.xy);
    r0.z = (r0.w) * (-(v7.y)) + (c1.x);
    ...
    r2.z = (r0.w) * (c3.x) + (c3.y);
    r8.xyz = lerp(r2.yyy, c[36].xyw, r4.zzz);
    r0.xy = (v0.zw) * (c4.xy);
    r3 = tex2D(s13, r0.xy);
    ...
    r1.w = rsqrt(r1.w);
    r15.xyz = (r0.www) * (v6.xyz);
    r2.xyz = (r7.xyz) * (r2.zzz) + (r1.xyz);
    r1.xyz = (r0.xyz) * (r1.www) + (-(r15.xyz));
    r17.xyz = (r8.yyy) * (r2.xyz);
    r14.xyz = normalize(r1.xyz);
    r16.xyz = (r0.xyz) * (r1.www);
    r0.xyz = (v6.xyz) * (-(r0.www)) + (c[17].xyz);
    r1.w = saturate(dot(r14.xyz, r16.xyz));
    r13.xyz = normalize(r0.xyz);
    r7.w = dot(r16.xyz, c[29].xyz);
    r0.w = saturate(dot(r13.xyz, c[17].xyz));
    r0.y = (-(r1.w)) + (c1.x);
    r0.w = (-(r0.w)) + (c1.x);
    r0.x = (r0.y) * (r0.y);
    r0.z = (r0.w) * (r0.w);
    ...
    r2.xyz = (r3.www) * (r1.xyz) + (r17.xyz);
    r4.y = (r1.w) * (c3.w);
    r2.w = saturate(dot(r16.xyz, r9.xyz));
    r1.z = saturate(dot(r9.xyz, -(r15.xyz)));
    r0.w = (r2.w) * (r9.w) + (r4.y);
    r3.z = (r1.z) * (r9.w) + (r4.y);
    r0.z = (r0.w) * (r3.z) + (c15.x);
    r0.w = dot(r15.xyz, r9.xyz);
    r4.w = 1.0f / (r0.z);
    r0.z = (r0.w) + (r0.w);
    r0.w = (r1.w) * (c3.z);
    r0.xyz = (r9.xyz) * (-(r0.zzz)) + (r15.xyz);
    r0 = texCUBElod(s15, r0);
    r0.w = (-(r1.z)) + (c1.x);
    r1.z = (r0.w) * (r0.w);
    r3.xy = (r1.ww) * (c38.xy) + (c38.zw);
    r0.w = (r0.w) * (r1.z);
    r1.w = 1.0f / (r3.x);
    ...
    r4.z = exp2(r3.y);
    r4.w = saturate(dot(r9.xyz, r14.xyz));
    r0.w = (r4.z) * (c15.y) + (c15.z);
    r0.z = (r8.y) * (r9.w) + (r4.y);
    r0.z = (r0.z) * (r3.z) + (c15.x);
    r3.z = saturate(dot(r9.xyz, r13.xyz));
    r0.y = 1.0f / (r0.z);
    r0.z = pow(abs(r3.z), r4.z);
    r0.y = (r8.y) * (r0.y);
    r0.z = (r0.w) * (r0.z);
    r3.y = (r0.y) * (r0.z);
    r0.xyz = (r11.xyz) * (r8.www) + (r12.xyz);
    r3.z = pow(abs(r4.w), r4.z);
