// Mechanically reconstructed from 0xD4855945.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = frac(abs(r0.w));
    r2.z = exp2(r0.z);
    r3.z = ((c[21].w) >= 0.0f ? (r0.w) : (-(r0.w)));
    r1.y = (r3.z) * (c4.x);
    r11.xy = (v5.xy) * (c[24].xx);
    ...
    r0 = tex2D(s2, r2.xy);
    r2.xy = (r11.xy) * (c[27].xx);
    r6.xy = (c[28].xy) * (r1.xx) + (r2.xy);
    r2.xy = (c[29].xx) * (r1.xx) + (r2.xy);
    r1 = tex2D(s3, r6.xy);
    r2 = tex2D(s3, r2.xy);
    r0.z = (r1.x) + (r2.x);
    r0.z = (r0.z) + (r0.z);
    ...
    r0.xyz = (r4.xyz) * (-(r0.zzz)) + (-(r1.xyz));
    r5.w = saturate(dot(r4.xyz, r1.xyz));
    r0.w = c[23].x;
    r0 = texCUBElod(s15, r0);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r7.xyz = (r0.xyz) * (c12.xxx);
