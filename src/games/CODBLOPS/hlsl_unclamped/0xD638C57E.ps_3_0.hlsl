// Mechanically reconstructed from 0xD638C57E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(1.0f, 0.0f, 0.25f, -1.0f);
    ...
    r7.xy = (v1.xy) + (c1.xx);
    r4.w = c1.y;
    r1.xy = (r7.xy) * (c[30].xx) + (r4.ww);
    r1 = tex2D(s5, r1.xy);
    r3.w = (v6.w) * (c1.z) + (-(r1.x));
    r0.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r5.w = saturate((r3.w) * (c1.w));
    r0.w = (r3.z) + (c2.w);
    r1.xy = lerp(r3.xy, r0.xy, r5.ww);
    r0.w = (r2.w) * (r0.w) + (c2.x);
    r0.xyz = v4.xyz;
