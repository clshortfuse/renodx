// Mechanically reconstructed from 0xEF730BF2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = (r1.w) + (r1.w);
    r5.zw = c15.zw;
    r2.xyz = (r5.zwz) + (-(c[38].xyw));
    r4.xyz = (r8.xyz) * (r0.www) + (r4.xyz);
    r3.xyz = (r6.www) * (r2.xyz) + (c[38].xyw);
    r2 = tex2D(s8, v6.zw);
    ...
    r1.y = dot(c[10], r0);
    r1.z = dot(c[11], r0);
    r0.w = saturate((c[37].y) * (r6.w) + (c[37].x));
    r0.xyz = c[0].xyz;
