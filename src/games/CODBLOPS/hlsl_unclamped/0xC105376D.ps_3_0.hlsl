// Mechanically reconstructed from 0xC105376D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r0.w) * (r1.w);
    r2.z = saturate(dot(r3.xyz, r0.xyz));
    r0 = tex2D(s5, v0.xy);
    ...
    r1.z = c0.y;
    r9.xyz = float3(((r1.w) >= 0.0f ? (r1.z) : (c[29].x)), ((r1.w) >= 0.0f ? (r1.z) : (c[29].y)), ((r1.w) >= 0.0f ? (r1.z) : (c[29].w)));
    r2.xyz = (r0.xyz) * (r9.zzz);
    r0.z = dot(r4.xyz, r3.xyz);
    r1.xyz = (r5.zzz) * (c[6].xyz);
    r0.z = (r0.z) + (r0.z);
    r0.w = (r0.w) * (c0.z);
