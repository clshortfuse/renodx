// Mechanically reconstructed from 0xC2E92DFC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    float4 v4 = input.v4;
    float4 v5 = input.v5;
    const float4 c0 = float4(-0.5f, 31.875f, 0.25f, -0.0f);
    ...
    r0 = (r1) * (r1) + (r0);
    r6.w = saturate(dot(c[17].xyz, r9.xyz));
    r5.x = rsqrt(r0.x);
    r5.y = rsqrt(r0.y);
    r5.z = rsqrt(r0.z);
    r5.w = rsqrt(r0.w);
