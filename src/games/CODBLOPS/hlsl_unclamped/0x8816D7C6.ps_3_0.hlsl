// Mechanically reconstructed from 0x8816D7C6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s11, v7.zw);
    r0 = (r1.wwww) * (c3.xxxy) + (c3.zzzx);
    r3.xyz = float3(((r4.w) >= 0.0f ? (r3.y) : (c[32].x)), ((r4.w) >= 0.0f ? (r3.y) : (c[32].y)), ((r4.w) >= 0.0f ? (r3.y) : (c[32].w)));
    ...
    r1.y = (r2.x) * (c12.w) + (-(r10.x));
    r2.w = (r3.z) * (-(r4.x)) + (r1.y);
    r3.xy = (r1.xz) * (r4.yy);
    r1.y = (r2.y) * (c12.w) + (-(r3.x));
    r1.x = dot(r6.xy, r6.xy) + (c1.z);
    r1.y = (r1.z) * (-(r4.y)) + (r1.y);
    r1.z = exp2(-(r1.x));
    r6.y = (r2.w) + (r2.w);
