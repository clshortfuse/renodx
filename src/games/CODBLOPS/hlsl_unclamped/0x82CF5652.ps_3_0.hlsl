// Mechanically reconstructed from 0x82CF5652.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.w = (r0.w) * (r0.z);
    r1.w = (r1.z) * (c16.z) + (c16.w);
    r0 = tex2D(s5, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = tex2D(s4, v7.zw);
    r4.w = (r0.w) * (v7.y) + (c0.x);
    r0.w = (r1.z) * (r1.z);
    r7.xy = float2(((r4.w) >= 0.0f ? (r1.x) : (c0.z)), ((r4.w) >= 0.0f ? (r1.y) : (c0.z)));
    r8.w = (r1.w) * (r0.w);
    r1 = v1;
    ...
    r2 = tex2D(s0, v0.xy);
    r3.w = (r2.w) * (v7.x) + (c0.x);
    r2 = (r2.xyzx) * (c0.yyyz) + (c0.zzzy);
    r13.xyz = normalize(r1.xyz);
    r3 = float4(((r3.w) >= 0.0f ? (r2.x) : (c0.z)), ((r3.w) >= 0.0f ? (r2.y) : (c0.z)), ((r3.w) >= 0.0f ? (r2.z) : (c0.z)), ((r3.w) >= 0.0f ? (r2.w) : (c0.z)));
    r5.z = saturate(dot(r13.xyz, r5.xyz));
    ...
    r13.w = (r2.w) * (-(c12.z)) + (c12.w);
    r14.w = (r2.w) * (c3.z);
    r3.z = saturate(dot(r4.xyz, r13.xyz));
    r16.w = saturate(dot(r13.xyz, -(r14.xyz)));
    r1.z = (r3.z) * (r13.w) + (r14.w);
    r12.w = (r16.w) * (r13.w) + (r14.w);
    r1.z = (r1.z) * (r12.w) + (c13.x);
    r16.xy = (r2.ww) * (c31.xy) + (c31.zw);
    r1.y = 1.0f / (r1.z);
    r11.w = exp2(r16.y);
    r1.z = pow(abs(r5.z), r11.w);
    r9.w = (r11.w) * (c13.y) + (c13.z);
    r2.y = (r3.z) * (r1.y);
    r2.z = (r1.z) * (r9.w);
    r1.xyz = (r11.xyz) * (r5.www) + (r12.xyz);
    r2.z = (r2.y) * (r2.z);
    r8.xyz = (r0.xyz) * (r0.xyz);
    r0.xyz = (r1.xyz) * (r2.zzz);
    r0.xyz = (r0.xyz) * (c[7].xyz);
    r10.xyz = float3(((r4.w) >= 0.0f ? (c[29].x) : (r3.w)), ((r4.w) >= 0.0f ? (c[29].y) : (r3.w)), ((r4.w) >= 0.0f ? (c[29].w) : (r3.w)));
    r2.xyz = (r0.xyz) * (r10.zzz);
    r0.z = dot(r7.xy, r7.xy) + (c0.z);
    r1.xyz = (r3.zzz) * (c[6].xyz);
    r0.z = exp2(-(r0.z));
    r6.w = (r0.z) * (c3.x) + (c3.y);
    r0.xy = (v0.zw) * (c4.xy);
    r5 = tex2D(s13, r0.xy);
    ...
    r5.xy = (r5.xz) * (r0.xx);
    r0.z = dot(r6.xy, r7.xy) + (c0.z);
    r3.w = (r4.x) * (c3.w) + (-(r5.x));
    r3.w = (r5.z) * (-(r0.x)) + (r3.w);
    r3.xy = (r3.xz) * (r0.yy);
    r4.w = (r4.y) * (c3.w) + (-(r3.x));
    r0.x = dot(r6.xy, r6.xy) + (c0.z);
    r0.y = (r3.z) * (-(r0.y)) + (r4.w);
    r0.x = exp2(-(r0.x));
    r9.y = (r3.w) + (r3.w);
    r0.x = (r0.x) * (c3.x) + (c3.y);
    ...
    r4.xyz = (v6.xyz) * (-(r15.www)) + (c[17].xyz);
