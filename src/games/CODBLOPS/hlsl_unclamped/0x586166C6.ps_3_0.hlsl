// Mechanically reconstructed from 0x586166C6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyz = (r0.xyz) * (-(r0.xyz)) + (c2.yyy);
    r1.z = (r8.w) * (r1.z);
    r0.xyz = (r3.xyz) * (r1.xxx) + (r4.xyz);
    r8.xyz = (r1.yyy) * (r8.xyz) + (r13.xyz);
