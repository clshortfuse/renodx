// Mechanically reconstructed from 0x8681CBF8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xyz = (r12.xyz) * (r0.www) + (r1.xyz);
    r3 = tex2D(s7, v1.xy);
    r0 = tex2D(s8, v6.zw);
    r6.w = lerp(r3.y, r0.y, r2.w);
    r1 = (r0.wwww) * (c2.xxxy) + (c2.zzzx);
    r7.xyz = (r5.xyz) * (r6.www);
    r0 = tex2D(s4, v6.xy);
    r3.xyz = (r0.xyz) + (c16.yyy);
    r0.xyz = v2.xyz;
