// Mechanically reconstructed from 0x6DE177D6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.w = (r2.w) * (-(c14.y)) + (c14.x);
    r0.w = exp2(-(r0.w));
    r11.xyz = (r2.xyz) * (-(r2.xyz)) + (c14.xxx);
    r4.z = (r0.w) * (c1.y) + (c1.z);
    r1.w = dot(v6.xyz, v6.xyz);
    r0.xy = (v0.zw) * (c14.xz);
    r3 = tex2D(s13, r0.xy);
    r0.xy = (v0.zw) * (c14.xz) + (c14.wz);
    r0 = tex2D(s13, r0.xy);
    r3.w = r0.y;
    r10.w = rsqrt(r1.w);
    r9.xy = (r3.yw) * (c3.yy) + (c3.zz);
    r1 = tex2D(s14, v0.zw);
    r8.xy = (r1.xy) * (c3.xx);
    r0.w = dot(r9.xy, r4.xy) + (c1.x);
    r5.xy = (r3.xz) * (r8.xx);
    r0.y = (r1.x) * (c3.x) + (-(r5.x));
    r6.xy = (r0.xz) * (r8.yy);
    r0.y = (r3.z) * (-(r8.x)) + (r0.y);
    ...
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c14.x) : (c14.w));
