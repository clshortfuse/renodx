// Mechanically reconstructed from 0xE66DD397.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (-(r0.z)) + (c3.x);
    r5.xy = (c[23].zz) * (r2.xy) + (r0.xy);
    r0.z = (r0.w) * (r0.w);
    r0.z = (r0.z) * (r0.z);
    r1.xy = (v1.xy) + (c1.xx);
    r5.w = (r0.w) * (r0.z);
    r1.z = c1.y;
    r2.xy = (r1.xy) * (c[29].xx) + (r1.zz);
    r0 = tex2D(s0, v1.xy);
    r3.xyz = (r0.xyz) * (v0.xyz);
    r2 = tex2D(s6, r2.xy);
    r0.xy = (r1.xy) * (c[28].xx) + (r1.zz);
    r0 = tex2D(s5, r0.xy);
    r7.w = (v8.w) * (c1.z) + (-(r0.x));
