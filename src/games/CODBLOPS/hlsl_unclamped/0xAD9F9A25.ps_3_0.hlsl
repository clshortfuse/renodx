// Mechanically reconstructed from 0xAD9F9A25.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s14, v1.zw);
    r4.xy = (r1.xy) * (c12.xx);
    r6.xy = (r0.wy) * (c12.yy) + (c12.zz);
    r2.xy = (r2.xz) * (r4.xx);
    r0.w = dot(r6.xy, r10.xy) + (c4.x);
    r0.y = (r1.x) * (c12.x) + (-(r2.x));
    r1.w = (r2.z) * (-(r4.x)) + (r0.y);
    r3.xy = (r0.xz) * (r4.yy);
    r0.y = (r1.y) * (c12.x) + (-(r3.x));
    r0.x = dot(r6.xy, r6.xy) + (c4.x);
    r0.y = (r0.z) * (-(r4.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r9.y = (r1.w) + (r1.w);
    r0.z = (r0.z) * (c4.y) + (c4.z);
    ...
    r9.xz = (r2.xy) * (c12.yy);
    r7.xyz = (r9.xyz) * (r3.zzz) + (r0.xyz);
    r5.w = c3.w;
    r8.xyz = float3(((r3.w) >= 0.0f ? (r5.w) : (c[39].x)), ((r3.w) >= 0.0f ? (r5.w) : (c[39].y)), ((r3.w) >= 0.0f ? (r5.w) : (c[39].w)));
    r2 = tex2D(s8, v1.xy);
    r1 = tex2D(s9, v7.zw);
