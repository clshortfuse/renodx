// Mechanically reconstructed from 0x15D62312.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c42 = float4(2.0f, -1.0f, 1.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r4.y = dot(r2.xy, r0.zw) + (c42.w);
    r1 = tex2D(s5, v7.xy);
    r1.xyz = (r1.xyz) + (c42.yyy);
    r4.x = dot(r2.xy, r0.xy) + (c42.w);
    ...
    r1.w = dot(r7.xy, r7.xy) + (c42.w);
    r14.xyz = (r0.xyz) * (-(r0.xyz)) + (c42.zzz);
    r1.w = exp2(-(r1.w));
    r4.w = (r1.w) * (c3.y) + (c3.z);
    r1.xy = (v1.zw) * (c15.yz);
    r3 = tex2D(s13, r1.xy);
    r1.xy = (v1.zw) * (c15.yz) + (c15.wz);
    r1 = tex2D(s13, r1.xy);
    r2 = tex2D(s14, v1.zw);
    r4.xy = (r2.xy) * (c4.xx);
    r3.w = r1.y;
    ...
    r1.y = (r2.x) * (c4.x) + (-(r8.x));
    r1.w = dot(r3.xy, r7.xy) + (c42.w);
    r2.z = (r3.z) * (-(r4.x)) + (r1.y);
    r1.xy = (r1.xz) * (r4.yy);
    r2.x = dot(r3.xy, r3.xy) + (c42.w);
    r2.w = (r2.y) * (c4.x) + (-(r1.x));
    r2.y = exp2(-(r2.x));
    r2.w = (r1.z) * (-(r4.y)) + (r2.w);
    r1.z = (r2.y) * (c3.y) + (c3.z);
    ...
    r3.w = (r1.w) * (r1.w);
    r4.xyw = c[40].xyw;
    r13.xyz = float3(((r5.w) >= 0.0f ? (r4.x) : (c[39].x)), ((r5.w) >= 0.0f ? (r4.y) : (c[39].y)), ((r5.w) >= 0.0f ? (r4.w) : (c[39].w)));
    r3.w = (r3.w) * (r3.w);
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c42.z) : (c42.w));
