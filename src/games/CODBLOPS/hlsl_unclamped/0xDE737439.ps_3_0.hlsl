// Mechanically reconstructed from 0xDE737439.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xy = (v1.xy) + (c1.xx);
    r1.z = c1.y;
    r2.xy = (r1.xy) * (c[33].xx) + (r1.zz);
    r0 = tex2D(s0, v1.xy);
    r3.xyz = (r0.xyz) * (v0.xyz);
    r0 = tex2D(s7, r2.xy);
    r0.xyz = (r3.xyz) * (-(r3.xyz)) + (r0.xyz);
    r0.w = (r0.w) + (c3.z);
    r1.xy = (r1.xy) * (c[32].xx) + (r1.zz);
    r1 = tex2D(s6, r1.xy);
    ...
    r1.z = (r4.w) * (r4.w);
    r7.z = saturate(dot(r4.xyz, r2.xyz));
    r1.z = (r2.w) * (r1.z);
    r2 = tex2D(s5, v1.xy);
    ...
    r1.y = (r6.z) * (r14.w) + (r14.z);
    r13.w = (r6.w) * (r14.w) + (r14.z);
    r1.y = (r1.y) * (r13.w) + (c4.w);
    r6.xy = (r2.ww) * (c15.xy) + (c15.zw);
    r1.x = 1.0f / (r1.y);
    r4.w = exp2(r6.y);
    r1.y = pow(abs(r7.z), r4.w);
    ...
    r2.xyz = (r1.xyz) * (c4.xxx);
    r1.xyz = normalize(r3.xyz);
    r3.xyz = (r12.xyz) * (r3.www) + (r13.xyz);
    ...
    r2.y = (r2.w) * (r2.w);
    r2.w = max(abs(r4.x), r3.w);
    r9.w = (r2.z) * (r2.y);
    r2.w = 1.0f / (r2.w);
    r2.z = saturate(dot(r4.xyz, r1.xyz));
    r1.xyz = (r4.xyz) * (c[5].xyz);
    r12.w = pow(abs(r2.z), r4.w);
    r1.xyz = (r1.xyz) * (r2.www) + (v8.xyz);
    r2 = tex3D(s11, r1.xyz);
    r1.xyz = (r2.xyz) * (r2.xyz);
    r1.xyz = (r1.xyz) * (c[30].yyy);
    r10.w = saturate(dot(r4.xyz, c[17].xyz));
