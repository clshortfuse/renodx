// Mechanically reconstructed from 0x14C4A0BD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.y = dot(r2.xy, r0.zw) + (c32.z);
    r1.x = dot(r2.xy, r0.xy) + (c32.z);
    r0 = tex2D(s1, v0.xy);
    r2.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r0 = tex2D(s5, v7.zw);
    r4.w = (r0.w) * (v7.y);
    r5.xy = lerp(r2.xy, r1.xy, r4.ww);
    r2.w = (r0.w) * (-(v7.y)) + (c32.w);
    r1 = tex2D(s0, v0.xy);
    r0.w = (r1.w) * (-(v7.x)) + (c32.w);
    r3.xyz = lerp(r1.xyz, r0.xyz, r4.www);
    r6.w = (r0.w) * (-(r2.w)) + (c32.w);
    r2 = tex2D(s7, v0.xy);
    r1 = tex2D(s8, v7.zw);
    r0 = lerp(r2, r1, r4.wwww);
    r7.xyz = (r3.xyz) * (r3.xyz);
    r10.xyz = (r0.xyz) * (-(r0.xyz)) + (c32.www);
    r1.w = dot(r5.xy, r5.xy) + (c32.z);
    r11.w = (r0.w) * (-(c4.z)) + (c4.w);
    r1.w = exp2(-(r1.w));
    r5.w = (r1.w) * (c1.x) + (c1.y);
    ...
    r6.xy = (r3.xz) * (r4.xx);
    r1.w = dot(r8.xy, r5.xy) + (c32.z);
    r1.y = (r2.x) * (c3.w) + (-(r6.x));
    r2.w = (r3.z) * (-(r4.x)) + (r1.y);
    r3.xy = (r1.xz) * (r4.yy);
    r1.y = (r2.y) * (c3.w) + (-(r3.x));
    r1.x = dot(r8.xy, r8.xy) + (c32.z);
    r1.y = (r1.z) * (-(r4.y)) + (r1.y);
    r1.z = exp2(-(r1.x));
    r9.y = (r2.w) + (r2.w);
    r1.z = (r1.z) * (c1.x) + (c1.y);
    ...
    r0.z = (r1.w) * (r11.w) + (r12.w);
    r10.w = (r14.w) * (r11.w) + (r12.w);
    r0.z = (r0.z) * (r10.w) + (c13.x);
    r17.xy = (r0.ww) * (c16.xy) + (c16.zw);
    r0.y = 1.0f / (r0.z);
    r9.w = exp2(r17.y);
    ...
    r2.w = (r3.w) * (r2.w);
    r12.xyz = (r4.www) * (r2.xyz) + (c[29].xyw);
    r0.xyz = (r0.xyz) * (r2.www);
    r16.xyz = (r1.xyz) * (r12.yyy);
    ...
    r3.w = (r3.w) * (r3.w);
    r3.w = (r0.w) * (r3.w);
    r0.w = (r8.w) * (r11.w) + (r12.w);
    r0.w = (r0.w) * (r10.w) + (c13.x);
    r1.y = saturate(dot(r13.xyz, r1.xyz));
    r1.z = 1.0f / (r0.w);
