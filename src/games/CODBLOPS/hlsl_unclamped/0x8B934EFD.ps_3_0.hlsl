// Mechanically reconstructed from 0x8B934EFD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = (r2.w) * (-(c7.z)) + (c7.w);
    r12.xy = (r8.ww) * (-(r0.xy)) + (r0.xy);
    r1.w = dot(v5.xyz, v5.xyz);
    r0 = v1;
    r0.xyz = (r12.xxx) * (v4.xyz) + (r0.xyz);
    r4.w = rsqrt(r1.w);
    r4.xyz = (r12.yyy) * (v3.xyz) + (r0.xyz);
    ...
    r3.x = saturate(dot(r0.xyz, r4.xyz));
    r3.w = saturate(dot(r4.xyz, c[17].xyz));
    r4.xy = (r2.ww) * (c8.xy) + (c8.zw);
    r1.w = exp2(r4.y);
    r3.w = (-(r3.w)) + (c1.z);
