// Mechanically reconstructed from 0x753593EC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c8 = float4(0.959999979f, 0.0399999991f, 1.0f, 0.5f);
    ...
    r1.w = 1.0f / (r1.w);
    r3.x = (r4.w) * (r1.w);
    r4.xy = (r3.ww) * (c9.xy) + (c9.zw);
    r4.z = saturate(dot(r0.xyz, r2.xyz));
    r1.w = exp2(r4.y);
    r2.w = pow(abs(r4.z), r1.w);
    r1.w = (r1.w) * (c3.y) + (c3.z);
    ...
    r9.w = (r2.w) * (v0.y) + (c1.x);
    r1.w = (r3.x) * (r1.w);
    r3.xy = float2(((r9.w) >= 0.0f ? (c1.y) : (r3.y)), ((r9.w) >= 0.0f ? (c1.z) : (r3.y)));
    r1.w = (r3.z) * (r1.w);
    r11.xy = lerp(r3.xy, c1.zz, r8.ww);
    r2.w = 1.0f / (r4.x);
    r3.z = (r1.w) * (r11.x);
    r1.w = (r3.w) * (c1.w);
    r9.xyz = (r3.zzz) * (c[19].xyz);
    r3 = tex2D(s12, v1.zw);
    r4.xy = (v1.zw) * (c8.zw);
    r4 = tex2D(s13, r4.xy);
    ...
    r5.xyz = (r11.yyy) * (r5.xyz);
    r6.xyz = (r9.xyz) * (r3.yyy);
    r5.xyz = (r3.yyy) * (r8.xyz) + (r5.xyz);
    r3 = tex2D(s0, v1.xy);
    r3.w = dot(r7.xyz, r0.xyz);
    r3.xyz = float3(((r9.w) >= 0.0f ? (r2.x) : (r3.x)), ((r9.w) >= 0.0f ? (r2.y) : (r3.y)), ((r9.w) >= 0.0f ? (r2.z) : (r3.z)));
    r3.w = (r3.w) + (r3.w);
    r2.xyz = lerp(r3.xyz, r1.xyz, r8.www);
