// Mechanically reconstructed from 0x413E6739.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c57 = float4(0.144999996f, 0.240400001f, 1.24039996f, 0.015625f);
    const float4 c58 = float4(1.16412354f, -0.813476562f, -0.391448975f, 0.529705048f);
    const float4 c59 = float4(1.16412354f, 2.01782227f, -1.08166885f, 0.600000024f);
    const float4 c60 = float4(64.0f, 0.125f, 1.0f, 0.0133333337f);
    const float4 c61 = float4(81.2394867f, 17.3480244f, 37.3498383f, 59.3948402f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r3.x = c57.x;
    r4 = tex2D(s9, r3.xz);
    r2.w = (r4.x) * (-(c57.y)) + (v3.x);
    r2.w = (r2.w) * (c57.z) + (-(v3.x));
    r3.x = (c[49].x) * (r2.w) + (v3.x);
    r2.w = frac(abs(v3.y));
    ...
    r4.z = (r4.x) + (-(r3.w));
    r4.xy = (r4.yz) * (c60.zy);
    r4.xy = (r3.xz) * (c60.yy) + (r4.xy);
    r5 = tex2D(s5, r4.xy);
    r6 = tex2D(s6, r4.xy);
    r4 = tex2D(s7, r4.xy);
    r5.xw = (r5.xx) * (c0.zx) + (c0.wz);
    r5.y = r6.x;
    r4.y = dot(c18.xyz, r5.xyw);
    r5.z = r4.x;
    r4.z = dot(c58, r5);
    r4.w = dot(c59.xyz, r5.xzw);
    r4.xyz = (r4.yzw) * (c[55].xxx);
    r5.xy = lerp(c[39].xy, c[39].zw, r3.xz);
    r5 = tex2D(s4, r5.xy);
    r3.xzw = (r5.xyz) * (c[56].xxx);
    r5.z = c1.z;
    r4.w = (-(r5.z)) + (c[40].x);
    ...
    r4.x = 1.0f / (c[48].x);
    r4.y = 1.0f / (c[48].y);
    r2.w = dot(r0.wwww, c61);
    r5.x = frac(r2.w);
    r5.w = c[37].w;
    r2.w = dot(r5.xwww, c61);
    r5.y = frac(r2.w);
    r2.w = dot(r5.xyww, c61);
    r5.z = frac(r2.w);
    r2.w = dot(r5, c61);
    r5.w = frac(r2.w);
    r2.w = dot(r5, c61);
    ...
    r3.z = c0.z;
    r0.w = (r1.w) * (-(c[52].x)) + (r3.z);
    r4.xyz = lerp(c[51].xyz, r5.xyz, r0.www);
