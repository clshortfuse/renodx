// Mechanically reconstructed from 0x15DDC78D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xyz = (v0.zzz) * (r1.xyz) + (c36.www);
    r4.xyz = (r0.xyz) * (r1.xyz);
    r0.xyz = (r3.xyz) * (r1.xyz);
    r9.xyz = (r0.xyz) * (r0.xyz);
    r0.z = dot(r5.xy, r5.xy) + (c36.z);
    r15.xyz = (r4.xyz) * (-(r4.xyz)) + (c36.www);
    r0.z = exp2(-(r0.z));
    r5.w = (r0.z) * (c3.x) + (c3.y);
    ...
    r2 = tex2D(s14, v1.zw);
    r0.xy = (r2.xy) * (c4.ww);
    r6.xy = (r1.wy) * (c12.xx) + (c12.yy);
    r10.xy = (r3.xz) * (r0.xx);
    r0.z = dot(r6.xy, r5.xy) + (c36.z);
    r1.w = (r2.x) * (c4.w) + (-(r10.x));
    r1.w = (r3.z) * (-(r0.x)) + (r1.w);
    r1.xy = (r1.xz) * (r0.yy);
    r2.w = (r2.y) * (c4.w) + (-(r1.x));
    ...
    r3.z = saturate(dot(r17.xyz, r0.xyz));
    r10.w = (r0.w) * (c3.w);
    ...
    r3.z = (r3.y) * (r3.z);
    r14.xyz = (r4.www) * (r2.xyz) + (c[32].xyw);
