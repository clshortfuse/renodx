// Mechanically reconstructed from 0x1E9ED4CE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = dot(r3.xyz, c[25].xyz);
    r1.w = max(abs(r10.y), abs(r10.z));
    r1.z = saturate((r0.z) * (c[26].x) + (c[26].y));
