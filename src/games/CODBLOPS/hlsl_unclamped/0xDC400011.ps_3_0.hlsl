// Mechanically reconstructed from 0xDC400011.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s9, v7.xy);
    r0 = (r1.wwww) * (-(c31.zzzy)) + (-(c31.wwwz));
    r3 = tex2D(s8, v1.xy);
    r2 = lerp(r3, r0, r7.wwww);
    r0 = tex2D(s5, v7.zw);
    r4.w = (r0.w) * (v0.z);
    r4.xyz = lerp(c[27].xyw, r1.yyy, r7.www);
    r3.xyz = lerp(r5.xyz, r0.xyz, r4.www);
    r1 = tex2D(s10, v7.zw);
    r0 = lerp(r2, r1, r4.wwww);
    r1 = tex2D(s6, v8.xy);
    r1.xyz = (r1.xyz) + (c31.yyy);
    r13.xyz = lerp(r4.xyz, c[28].xyw, r4.www);
    r1.xyz = (v0.www) * (r1.xyz) + (-(c31.yyy));
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (-(c31.y)) : (-(c31.z)));
