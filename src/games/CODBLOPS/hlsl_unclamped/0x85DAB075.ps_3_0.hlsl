// Mechanically reconstructed from 0x85DAB075.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.w = (r1.w) * (v0.y);
    r4.w = (r2.w) * (r2.z);
    r7.xy = (r5.ww) * (-(r0.xy)) + (r0.xy);
    r0 = tex2D(s5, v1.xy);
    r2 = tex2D(s0, v1.xy);
    r4.xyz = lerp(r2.xyz, r1.xyz, r5.www);
    r3.xyz = lerp(r0.yyy, c[20].xyw, r5.www);
    r2.w = -(r0.w);
    r2.xyz = c1.xxx;
    r1 = tex2D(s6, v8.xy);
    r1 = (r2) + (r1);
    ...
    r3.w = (r0.w) * (v0.z);
    r2 = (r5.wwww) * (r1) + (r2);
    r6.xyz = lerp(r4.xyz, r0.xyz, r3.www);
    r0 = tex2D(s7, v8.zw);
    r1 = lerp(r2, r0, r3.wwww);
    r10.xyz = (r1.xyz) * (-(r1.xyz)) + (c1.zzz);
    r11.xyz = (r1.xyz) * (r1.xyz);
    r12.xyz = lerp(r3.xyz, c[21].xyw, r3.www);
    r4.xyz = (r10.xyz) * (r4.www) + (r11.xyz);
    r1.xy = (r3.ww) * (-(r7.xy)) + (r7.xy);
    r0.xy = (v1.zw) * (c4.xy);
    r3 = tex2D(s13, r0.xy);
