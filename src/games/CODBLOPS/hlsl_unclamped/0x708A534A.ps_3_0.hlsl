// Mechanically reconstructed from 0x708A534A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(-0.5f, 0.0f, 1.0f, 0.797884583f);
    ...
    r0 = tex2D(s2, v5.zw);
    r3.w = (r0.w) * (v5.y) + (c1.x);
    r3.xy = float2(((r3.w) >= 0.0f ? (r2.x) : (c1.y)), ((r3.w) >= 0.0f ? (r2.y) : (c1.y)));
    r2.xyz = v3.xyz;
