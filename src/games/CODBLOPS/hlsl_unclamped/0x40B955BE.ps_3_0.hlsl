// Mechanically reconstructed from 0x40B955BE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c11 = float4(0.600000024f, 0.400000006f, 8.0f, 0.797884583f);
