// Mechanically reconstructed from 0x91931B6D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c9 = float4(0.600000024f, 0.400000006f, 0.797884583f, 31.875f);
    ...
    r5.y = dot(r1.xy, r0.zw) + (c3.z);
    r5.x = dot(r1.xy, r0.xy) + (c3.z);
    r0 = tex2D(s6, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    ...
    r1 = tex2D(s7, v1.xy);
    r0 = tex2D(s8, v7.xy);
    r4.xy = lerp(r1.wy, r0.wy, r5.ww);
    r0 = tex2D(s9, v7.zw);
    r11.xy = lerp(r4.xy, r0.wy, r4.ww);
    r0.w = dot(r3.xy, r3.xy) + (c3.z);
    r7.xyz = (r2.xyz) * (r2.xyz);
    r0.w = exp2(-(r0.w));
    r3.z = (r11.x) * (-(c11.z)) + (c11.w);
    r3.w = (r0.w) * (c9.x) + (c9.y);
