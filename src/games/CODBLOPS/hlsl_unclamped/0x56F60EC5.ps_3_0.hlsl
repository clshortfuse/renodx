// Mechanically reconstructed from 0x56F60EC5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = saturate(r1.y);
    r1.xyz = c[27].xyz;
    r1.xyz = (-(r1.yzx)) + (c[28].yzx);
    r6.xyz = (r0.www) * (r1.xyz) + (c[27].yzx);
    r5.xw = c1.xw;
    r0.z = (r5.x) * (c[8].w);
    r0.w = frac(r6.y);
    r0.y = frac(abs(r0.z));
    r0.z = (r6.y) + (-(r0.w));
    r0.y = ((c[8].w) >= 0.0f ? (r0.y) : (-(r0.y)));
    r0.w = (r0.w) + (c1.z);
    r1 = (r0.yyyy) * (c2);
    r0.z = (r0.z) * (c1.y);
    r2.xy = (c[25].xy) * (r1.xx) + (v7.xy);
    r0.y = exp2(r0.z);
    r3.xy = (r2.xy) * (c[26].xx);
    r2.x = (r3.x) * (r0.y) + (r1.w);
    r2.z = (r0.y) * (r3.y);
    ...
    r5.xy = (c[29].xx) * (r4.xy) + (r5.xy);
    r2.xyz = (r2.yzx) * (v3.zxy) + (-(r3.xyz));
    r4.xyz = (r5.yyy) * (-(r2.xyz));
    r3.xyz = (vPos.yyy) * (c[11].xyz);
    r4.xyz = (r5.xxx) * (v3.xyz) + (r4.xyz);
    r3.xyz = (vPos.xxx) * (c[10].xyz) + (r3.xyz);
    r4.xyz = (r4.xyz) + (v6.xyz);
    r5.xyz = (r3.xyz) + (c[20].xyz);
    ...
    r0.z = saturate((r0.w) * (r0.z) + (c[31].x));
