// Mechanically reconstructed from 0xD6B88E7A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(1.0f, 0.797884583f, 0.0009765625f, 0.25f);
    ...
    r5 = tex2D(s3, v1.xy);
    r0.xyz = lerp(r1.xyz, c0.yyy, r5.xxx);
    r6.xyz = (r1.xyz) * (r5.xxx);
