// Mechanically reconstructed from 0xD283AF10.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.x = 1.0f / (r6.w);
    r13.yz = c1.yz;
    r3.xyz = float3(((r7.w) >= 0.0f ? (r13.y) : (c[25].x)), ((r7.w) >= 0.0f ? (r13.z) : (c[25].y)), ((r7.w) >= 0.0f ? (r13.y) : (c[25].w)));
    r6.xy = saturate((r7.xx) * (c[24].xy) + (c[24].zw));
    r4.xy = (r6.xy) * (r6.xy);
    r6.xy = (r6.xy) * (c13.xx) + (c13.yy);
    r0.w = dot(c[23].yz, r7.xy) + (c[23].x);
    r4.xy = (r4.xy) * (r6.xy);
    r7.xyz = lerp(r3.xyz, c[26].xyw, r8.www);
    r0.w = (r0.w) * (r4.x);
