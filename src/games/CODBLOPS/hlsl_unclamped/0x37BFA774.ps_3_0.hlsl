// Mechanically reconstructed from 0x37BFA774.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(1.0f, 0.0f, -1.0f, 0.797884583f);
