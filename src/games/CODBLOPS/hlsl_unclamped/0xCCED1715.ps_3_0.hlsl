// Mechanically reconstructed from 0xCCED1715.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.y = dot(r1.xy, r0.zw) + (c3.z);
    r6.x = dot(r1.xy, r0.xy) + (c3.z);
    r2 = tex2D(s0, v1.xy);
    r1 = tex2D(s3, v7.xy);
    r5.w = (r1.w) * (v0.y) + (c3.w);
    r3 = tex2D(s7, v1.xy);
    ...
    r4.xyz = (v0.zzz) * (r4.xyz) + (-(c3.yyy));
    r3 = tex2D(s5, v8.xy);
    r3.xyz = (r3.xyz) + (c3.yyy);
    r0.xyz = (r0.xyz) * (r4.xyz);
    r3.xyz = (v0.www) * (r3.xyz) + (-(c3.yyy));
    r11.xy = float2(((r5.w) >= 0.0f ? (r6.x) : (r7.x)), ((r5.w) >= 0.0f ? (r6.y) : (r7.y)));
    r6.xyz = (r0.xyz) * (r3.xyz);
    r0.xyz = float3(((r5.w) >= 0.0f ? (r1.x) : (r2.x)), ((r5.w) >= 0.0f ? (r1.y) : (r2.y)), ((r5.w) >= 0.0f ? (r1.z) : (r2.z)));
    r9.xyz = (r6.xyz) * (-(r6.xyz)) + (-(c3.yyy));
    r10.xyz = (r6.xyz) * (r6.xyz);
    r1.xyz = (r4.xyz) * (r0.xyz);
    r0.xyz = (r9.xyz) * (r7.www) + (r10.xyz);
    ...
    r3 = tex2D(s13, r2.xy);
    r1.w = r3.y;
    r4.w = (r0.w) * (-(c13.x)) + (c13.y);
    r2.xy = (r1.wy) * (c11.yy) + (c11.zz);
    r1.y = dot(r11.xy, r11.xy) + (c3.z);
    r1.w = dot(r2.xy, r2.xy) + (c3.z);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r3.w = (r1.y) * (c4.x) + (c4.y);
    r1.y = (r1.w) * (c4.x) + (c4.y);
    r1.w = dot(r2.xy, r11.xy) + (c3.z);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r6.xy = (r2.xy) * (c11.xx);
    ...
    r1.w = (r1.w) * (r2.w);
    r2.xyw = c[9].xyw;
    r11.xyz = float3(((r5.w) >= 0.0f ? (r2.x) : (c[8].x)), ((r5.w) >= 0.0f ? (r2.y) : (c[8].y)), ((r5.w) >= 0.0f ? (r2.w) : (c[8].w)));
