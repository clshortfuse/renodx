// Mechanically reconstructed from 0xC95D9FEA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c3.ww);
    r0.y = dot(r6.xy, r10.xy) + (c15.z);
    r3.xy = (r3.xz) * (r7.yy);
    r2.w = saturate((r0.y) * (r4.w) + (r4.w));
    r0.y = (r2.y) * (c3.w) + (-(r3.x));
    r6.xz = (r3.xy) * (c4.xx);
    r0.y = (r3.z) * (-(r7.y)) + (r0.y);
    r6.y = (r0.y) + (r0.y);
    ...
    r9.y = (r0.z) + (r0.z);
    r6.zw = c15.zw;
    r2.xyz = (r6.zwz) + (-(c[34].xyw));
    r0.xyz = (r9.xyz) * (r3.www) + (r3.xyz);
    r11.xyz = (r1.www) * (r2.xyz) + (c[34].xyw);
    ...
    r2 = tex2D(s0, v1.xy);
    r3 = tex2D(s4, v6.zw);
    r12.xyz = (r3.xyz) + (c15.yyy);
    r3.xyz = lerp(r2.xyz, r1.xyz, r1.www);
    r13.xyz = (v0.zzz) * (r12.xyz) + (c15.www);
