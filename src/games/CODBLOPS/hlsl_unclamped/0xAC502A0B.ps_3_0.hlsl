// Mechanically reconstructed from 0xAC502A0B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = (r3.w) * (r0.w);
    r0.xyw = c[8].xyw;
    r1.xyz = (-(r0.xyw)) + (c[9].xyw);
    r0 = tex2D(s4, v7.zw);
    r5.w = (r0.w) * (v0.z);
    r5.xyz = (r3.zzz) * (r1.xyz) + (c[8].xyw);
    r3.xyz = lerp(r6.xyz, r0.xyz, r5.www);
    r1 = tex2D(s9, v7.zw);
    r0 = tex2D(s5, v8.xy);
    r6.xyz = (r0.xyz) + (c21.yyy);
    r0 = lerp(r2, r1, r5.wwww);
    r1.xyz = (v0.www) * (r6.xyz) + (c21.www);
    r11.xyz = lerp(r5.xyz, c[10].xyw, r5.www);
