// Mechanically reconstructed from 0xCBB62A8A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = (r0.z) * (r3.w) + (r3.z);
    r3.w = (r0.x) * (r3.w) + (r3.z);
    r7.xyz = lerp(c[25].xyw, r3.yyy, r8.www);
    r0.y = (r0.y) * (r3.w) + (c3.x);
    r7.w = (-(r0.x)) + (-(c14.y));
    r0.y = 1.0f / (r0.y);
    r4.w = (r0.z) * (r0.y);
    r4.xyz = (r8.xyz) * (r1.www) + (-(r12.xyz));
    ...
    r4.xy = saturate((r14.xx) * (c[24].xy) + (c[24].zw));
    r3.xy = (r4.xy) * (r4.xy);
    r4.xy = (r4.xy) * (c13.xx) + (c13.yy);
    r2.w = dot(c[23].yz, r14.xy) + (c[23].x);
    r3.xy = (r3.xy) * (r4.xy);
