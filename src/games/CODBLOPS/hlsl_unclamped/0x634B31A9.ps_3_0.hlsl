// Mechanically reconstructed from 0x634B31A9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r0.w) * (r2.x) + (r3.z);
    r2.x = (r2.z) * (r2.x) + (r3.z);
    r9.xyz = lerp(r2.yyy, c[32].xyw, r6.www);
    ...
    r1.w = dot(r15.xy, r15.xy) + (c2.z);
    r1.y = dot(r2.xy, r2.xy) + (c2.z);
    r1.w = exp2(-(r1.w));
    r1.y = exp2(-(r1.y));
    r1.w = (r1.w) * (c3.x) + (c3.y);
    r2.w = (r1.y) * (c3.x) + (c3.y);
    r1.y = dot(r2.xy, r15.xy) + (c2.z);
    r3.w = (r1.w) * (r2.w);
    r2 = tex2D(s14, v1.zw);
    r15.xy = (r2.xy) * (c13.ww);
