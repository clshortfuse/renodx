// Mechanically reconstructed from 0x0FA584CF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = dot(r1.xyz, c[23].xyz);
    r5.x = 1.0f / (r0.w);
    r0.x = saturate((r0.z) * (c[24].x) + (c[24].y));
    ...
    r2.w = dot(r6.xy, r6.xy) + (c1.x);
    r2.y = dot(r3.xy, r3.xy) + (c1.x);
    r2.w = exp2(-(r2.w));
    r2.y = exp2(-(r2.y));
    r2.w = (r2.w) * (c1.y) + (c1.z);
    r3.w = (r2.y) * (c1.y) + (c1.z);
    r2.y = dot(r3.xy, r6.xy) + (c1.x);
    r4.w = (r2.w) * (r3.w);
    r3 = tex2D(s14, v1.zw);
    r7.xy = (r3.xy) * (c2.ww);
