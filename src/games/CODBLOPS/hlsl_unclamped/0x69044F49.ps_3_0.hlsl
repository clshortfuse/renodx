// Mechanically reconstructed from 0x69044F49.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.x = dot(r3.xy, r0.xy) + (c0.w);
    r2.y = dot(r3.xy, r0.zw) + (c0.w);
    r0 = tex2D(s4, v6.zw);
    r4.w = (r0.w) * (v0.z);
    ...
    r5.w = saturate(dot(r6.xyz, -(r3.xyz)));
    r2 = tex2D(s6, v1.xy);
    r1 = tex2D(s7, v6.zw);
