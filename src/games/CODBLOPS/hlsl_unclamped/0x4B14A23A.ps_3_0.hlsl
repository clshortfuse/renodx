// Mechanically reconstructed from 0x4B14A23A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c36 = float4(4.0f, -2.0f, 0.797884583f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r4.xy = (r2.yw) * (c36.xx) + (c36.yy);
    r1 = tex2D(s14, v1.zw);
    r5.xy = (r1.xy) * (c12.ww);
    r1.w = dot(r4.xy, r11.xy) + (c4.x);
    r2.xy = (r2.xz) * (r5.xx);
    ...
    r6.xz = (r2.xy) * (c13.ww);
    r4.xyz = (r6.xyz) * (r0.www) + (r0.xyz);
    r0.x = c3.w;
    r5.xyz = float3(((r3.w) >= 0.0f ? (r0.x) : (c[32].x)), ((r3.w) >= 0.0f ? (r0.x) : (c[32].y)), ((r3.w) >= 0.0f ? (r0.x) : (c[32].w)));
    r1 = tex2D(s9, v7.zw);
