// Mechanically reconstructed from 0x6EACEF20.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s7, v7.xy);
    r1 = (r2.wwww) * (-(c20.zzzy)) + (-(c20.wwwz));
    r3 = tex2D(s6, v1.xy);
    r0 = tex2D(s4, v7.zw);
    r6.xyz = (r0.xyz) + (c20.yyy);
    r0 = lerp(r3, r1, r7.wwww);
    r1.xyz = (v0.zzz) * (r6.xyz) + (-(c20.yyy));
    ...
    r3 = tex2D(s13, r3.xy);
    r1.w = r3.y;
    r2.w = dot(r6.xy, r6.xy) + (c20.z);
    r5.xy = (r1.wy) * (c11.xx) + (c11.yy);
    r1.y = exp2(-(r2.w));
    r1.w = dot(r5.xy, r5.xy) + (c20.z);
    r3.w = (r1.y) * (c3.x) + (c3.y);
    r1.w = exp2(-(r1.w));
    r11.xyz = lerp(c[8].xyw, r2.yyy, r7.www);
    r1.y = (r1.w) * (c3.x) + (c3.y);
    r1.w = dot(r5.xy, r6.xy) + (c20.z);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c4.ww);
