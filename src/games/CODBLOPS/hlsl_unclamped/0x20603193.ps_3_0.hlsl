// Mechanically reconstructed from 0x20603193.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = tex2D(s5, v6.zw);
    r0.zw = (r3.ww) * (c1.yz) + (c1.wy);
    r1.xyz = float3(((r1.w) >= 0.0f ? (r1.x) : (r2.x)), ((r1.w) >= 0.0f ? (r1.y) : (r2.y)), ((r1.w) >= 0.0f ? (r1.z) : (r2.z)));
    r0 = float4(((r1.w) >= 0.0f ? (r0.x) : (c1.y)), ((r1.w) >= 0.0f ? (r0.y) : (c1.y)), ((r1.w) >= 0.0f ? (r0.z) : (c1.y)), ((r1.w) >= 0.0f ? (r0.w) : (c1.z)));
    r1.xyz = (r1.xyz) * (r1.xyz);
    r2.xyz = v3.xyz;
    r2.xyz = (r0.xxx) * (r2.xyz) + (v1.xyz);
    ...
    r0.x = (r0.w) * (-(c2.y)) + (c2.z);
    r0.y = saturate(dot(r3.xyz, r5.xyz));
    r1.w = (r1.w) * (r0.x) + (r3.w);
    r0.x = (r0.y) * (r0.x) + (r3.w);
    r6.xyz = (r2.xyz) * (r2.www) + (-(r6.xyz));
    r0.x = (r0.x) * (r1.w) + (c2.w);
    r0.x = 1.0f / (r0.x);
    ...
    r0.w = (r1.w) * (r0.w);
    r0.z = (r0.z) * (r0.z) + (r0.x);
    r2.xyz = (r4.xyz) * (c[7].xyz);
    r0.w = (r0.w) * (r0.z);
    r0.xyz = (r0.yyy) * (c[6].xyz);
