// Mechanically reconstructed from 0xBCE31E01.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xyz = float3(((r4.w) >= 0.0f ? (c[29].x) : (r2.y)), ((r4.w) >= 0.0f ? (c[29].y) : (r2.y)), ((r4.w) >= 0.0f ? (c[29].w) : (r2.y)));
