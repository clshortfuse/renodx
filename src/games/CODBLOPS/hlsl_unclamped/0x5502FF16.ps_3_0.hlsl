// Mechanically reconstructed from 0x5502FF16.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.y = dot(r2.xy, r0.zw) + (c20.w);
    r1 = tex2D(s3, v7.xy);
    r1.xyz = (r1.xyz) + (c20.yyy);
    r3.x = dot(r2.xy, r0.xy) + (c20.w);
    r6.xyz = (v0.yyy) * (r1.xyz) + (c20.zzz);
    r0 = tex2D(s0, v1.xy);
    r1.xyz = (r6.xyz) * (r0.xyz);
    r0 = tex2D(s4, v7.zw);
    r3.w = (r0.w) * (v0.z) + (c3.x);
    r2.xyz = float3(((r3.w) >= 0.0f ? (r0.x) : (r1.x)), ((r3.w) >= 0.0f ? (r0.y) : (r1.y)), ((r3.w) >= 0.0f ? (r0.z) : (r1.z)));
    r0.xy = (v1.zw) * (c10.xy) + (c10.zy);
    r0 = tex2D(s13, r0.xy);
    r1.xy = (v1.zw) * (c10.xy);
    r1 = tex2D(s13, r1.xy);
    r0.w = r1.y;
    r5.xy = float2(((r3.w) >= 0.0f ? (r3.x) : (r5.x)), ((r3.w) >= 0.0f ? (r3.y) : (r5.y)));
    r3.xy = (r0.wy) * (c11.xx) + (c11.yy);
    r0.w = dot(r5.xy, r5.xy) + (c20.w);
    r0.y = dot(r3.xy, r3.xy) + (c20.w);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c4.x) + (c4.y);
    r1.w = (r0.y) * (c4.x) + (c4.y);
    r0.y = dot(r3.xy, r5.xy) + (c20.w);
    r1.w = (r0.w) * (r1.w);
    ...
    r3.xy = (r1.xz) * (r7.xx);
    r1.xy = (r0.xz) * (r7.yy);
    r0.x = (r2.x) * (c10.w) + (-(r3.x));
    r0.y = (r2.y) * (c10.w) + (-(r1.x));
    r1.z = (r1.z) * (-(r7.x)) + (r0.x);
    r0.z = (r0.z) * (-(r7.y)) + (r0.y);
    r0.y = (r0.z) + (r0.z);
    r0.xz = (r1.xy) * (c11.xx);
    ...
    r1.z = saturate(dot(r12.xyz, r4.xyz));
    ...
    r1.w = (r1.w) * (r1.z);
    r11.xyz = float3(((r3.w) >= 0.0f ? (r1.y) : (c[8].x)), ((r3.w) >= 0.0f ? (r1.y) : (c[8].y)), ((r3.w) >= 0.0f ? (r1.y) : (c[8].w)));
