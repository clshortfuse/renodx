// Mechanically reconstructed from 0x9B46F24B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = float3(((r4.w) >= 0.0f ? (r4.x) : (c1.w)), ((r4.w) >= 0.0f ? (r4.y) : (c1.w)), ((r4.w) >= 0.0f ? (r4.z) : (c1.w)));
    r2.x = dot(r3.xy, r2.xy) + (c1.w);
    r2.y = dot(r3.xy, r2.zw) + (c1.w);
    r8.w = (r0.w) * (v6.y);
    r1 = (r1.xyzx) * (-(c1.yyyw)) + (-(c1.wwwy));
    r10.xy = lerp(r4.xy, r2.xy, r8.ww);
    r2 = float4(((r4.w) >= 0.0f ? (r1.x) : (c1.w)), ((r4.w) >= 0.0f ? (r1.y) : (c1.w)), ((r4.w) >= 0.0f ? (r1.z) : (c1.w)), ((r4.w) >= 0.0f ? (r1.w) : (c1.w)));
    r1 = v1;
    r1.xyz = (r10.xxx) * (v4.xyz) + (r1.xyz);
    r3 = (r3.wwww) * (c2.xxxy) + (c2.zzzx);
    r5.xyz = (r10.yyy) * (v3.xyz) + (r1.xyz);
    r1.xyz = normalize(r5.xyz);
    r8.xyz = normalize(v5.xyz);
    r6 = float4(((r4.w) >= 0.0f ? (r3.x) : (-(c1.w))), ((r4.w) >= 0.0f ? (r3.y) : (-(c1.w))), ((r4.w) >= 0.0f ? (r3.z) : (-(c1.w))), ((r4.w) >= 0.0f ? (r3.w) : (-(c1.y))));
    r3.w = dot(r8.xyz, r1.xyz);
    r7.xyz = lerp(r2.xyz, r0.xyz, r8.www);
    r0.z = (r3.w) + (r3.w);
    r9.xy = lerp(r4.zz, c[5].xy, r8.ww);
    r3.xyz = (r1.xyz) * (-(r0.zzz)) + (r8.xyz);
    r4 = tex2D(s5, v6.zw);
