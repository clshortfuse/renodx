// Mechanically reconstructed from 0x0D290280.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r13.w = (r1.w) * (-(c1.w)) + (c1.z);
    r6.w = saturate(dot(r2.xyz, r4.xyz));
    r13.z = (r1.w) * (c1.w);
    r1.z = saturate(dot(r4.xyz, -(r7.xyz)));
    r0.z = (r6.w) * (r13.w) + (r13.z);
    r12.w = (r1.z) * (r13.w) + (r13.z);
    ...
    r0.z = (r9.w) * (r13.w) + (r13.z);
    r1.w = (r0.z) * (r12.w) + (c4.x);
    ...
    r4.w = (r1.w) * (r1.z);
    r1 = (v7.yyyy) * (c[26]);
    r2.xyz = (r9.xyz) * (r8.www) + (r10.xyz);
    r1 = (v7.xxxx) * (c[25]) + (r1);
    r2.xyz = (r4.www) * (r2.xyz);
    r1 = (v7.zzzz) * (c[27]) + (r1);
    r2.xyz = (r2.xyz) * (c[31].www);
    r5 = (r1) + (c[28]);
    r1.xyz = (r2.xyz) * (c[19].xyz);
    r4.zw = r5.zw;
    r1.xyz = (r2.www) * (r1.xyz);
    r6.zw = r4.zw;
    r8.xyz = (r8.xyz) * (r0.xyz) + (r1.xyz);
    r2.zw = r6.zw;
    r1.xy = (r5.ww) * (-(c[29].zw)) + (r5.xy);
    r1.zw = r2.zw;
    r1 = tex2Dproj(s3, r1);
    r1.w = r1.x;
