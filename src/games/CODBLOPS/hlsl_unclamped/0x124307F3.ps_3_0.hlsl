// Mechanically reconstructed from 0x124307F3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xy = (c[38].zz) * (r1.xy) + (r0.xy);
    r1 = tex2D(s7, v1.xy);
    r3.xy = (v1.xy) + (c1.xx);
    r2.w = c1.y;
    r0.xy = (r3.xy) * (c[43].xx) + (r2.ww);
    r0 = tex2D(s5, r0.xy);
    r7.w = (v7.w) * (c1.z) + (-(r0.x));
    r1.xy = (r1.wy) * (c0.xy) + (c0.zw);
    r5.w = saturate((r7.w) * (c1.w));
    r4.xy = lerp(r5.xy, r1.xy, r5.ww);
    r1 = v2;
