// Mechanically reconstructed from 0xC0C003B2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s5, v7.xy);
    r5.z = (r2.w) * (v0.y) + (c3.w);
    r5.xy = float2(((r5.z) >= 0.0f ? (r1.x) : (r0.x)), ((r5.z) >= 0.0f ? (r1.y) : (r0.y)));
    r1 = tex2D(s8, v1.xy);
    r0 = tex2D(s9, v7.xy);
    r4 = tex2D(s6, v7.zw);
    r4.xyz = (r4.xyz) + (c3.yyy);
    r3.xyz = float3(((r5.z) >= 0.0f ? (r2.x) : (r3.x)), ((r5.z) >= 0.0f ? (r2.y) : (r3.y)), ((r5.z) >= 0.0f ? (r2.z) : (r3.z)));
    r2.xyz = (v0.zzz) * (r4.xyz) + (-(c3.yyy));
    r0 = float4(((r5.z) >= 0.0f ? (r0.x) : (r1.x)), ((r5.z) >= 0.0f ? (r0.y) : (r1.y)), ((r5.z) >= 0.0f ? (r0.z) : (r1.z)), ((r5.z) >= 0.0f ? (r0.w) : (r1.w)));
    r1.xyz = (r3.xyz) * (r2.xyz);
    r4.xyz = (r2.xyz) * (r0.xyz);
    r9.xyz = (r1.xyz) * (r1.xyz);
    r15.xyz = (r4.xyz) * (-(r4.xyz)) + (-(c3.yyy));
    r0.z = dot(r5.xy, r5.xy) + (c3.z);
    ...
    r3.w = r1.y;
    r10.xy = (r3.xz) * (r6.xx);
    r3.xy = (r3.yw) * (c12.yy) + (c12.zz);
    r0.y = (r2.x) * (c12.x) + (-(r10.x));
    r0.z = dot(r3.xy, r5.xy) + (c3.z);
    r1.y = (r3.z) * (-(r6.x)) + (r0.y);
    r0.xy = (r1.xz) * (r6.yy);
    r1.w = dot(r3.xy, r3.xy) + (c3.z);
    r1.x = (r2.y) * (c12.x) + (-(r0.x));
    r1.w = exp2(-(r1.w));
    r1.z = (r1.z) * (-(r6.y)) + (r1.x);
    r1.w = (r1.w) * (c4.x) + (c4.y);
    r6.y = (r1.y) + (r1.y);
    ...
    r1.xz = (r0.xy) * (c12.yy);
    r3.xyz = (r2.xyz) * (r2.www) + (-(r7.xyz));
    r0.xyz = normalize(r3.xyz);
    r8.xyz = (r2.xyz) * (r2.www);
    r1.xyz = (r1.xyz) * (r1.www);
    r1.w = saturate(dot(r0.xyz, r8.xyz));
    r6.xz = (r10.xy) * (c12.yy);
    r1.w = (-(r1.w)) + (-(c3.y));
    ...
    r2.w = saturate(dot(r17.xyz, r0.xyz));
    r10.w = (r0.w) * (c4.w);
    ...
    r2.y = (r2.z) * (r0.y);
    r2.w = (r0.z) * (r5.w);
    r0.xyz = (r15.xyz) * (r3.zzz) + (r16.xyz);
    r3.z = (r2.y) * (r2.w);
    r2.xyw = c[33].xyw;
    r14.xyz = float3(((r5.z) >= 0.0f ? (r2.x) : (c[32].x)), ((r5.z) >= 0.0f ? (r2.y) : (c[32].y)), ((r5.z) >= 0.0f ? (r2.w) : (c[32].w)));
