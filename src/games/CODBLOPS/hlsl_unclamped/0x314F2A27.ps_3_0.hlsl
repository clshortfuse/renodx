// Mechanically reconstructed from 0x314F2A27.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r3.xyz = saturate((r2.xyz) * (r0.www) + (r0.xyz));
    r0.xyz = (r1.xxx) * (r3.xyz);
    r2.xyz = lerp(r3.xyz, c0.yyy, r1.xxx);
    r8.xyz = (r2.xyz) * (-(r2.xyz)) + (c1.xxx);
