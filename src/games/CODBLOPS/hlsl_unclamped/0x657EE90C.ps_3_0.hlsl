// Mechanically reconstructed from 0x657EE90C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = float4(((r10.w) >= 0.0f ? (r0.x) : (c1.z)), ((r10.w) >= 0.0f ? (r0.y) : (c1.z)), ((r10.w) >= 0.0f ? (r0.z) : (c1.z)), ((r10.w) >= 0.0f ? (r0.w) : (c1.y)));
    r1.w = dot(r4.xyz, r4.xyz);
    r0 = v1;
    r0.xyz = (r2.xxx) * (v4.xyz) + (r0.xyz);
    r3.z = rsqrt(r1.w);
    r7.xyz = (r2.yyy) * (v3.xyz) + (r0.xyz);
