// Mechanically reconstructed from 0x10CA981B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = abs(c[30].w);
    r1.w = frac(r1.w);
    r3.y = ((c[30].w) >= 0.0f ? (r1.w) : (-(r1.w)));
    r3.x = c0.x;
    r3 = tex2D(s4, r3.xy);
    r1.w = saturate((r3.x) * (c[36].x));
