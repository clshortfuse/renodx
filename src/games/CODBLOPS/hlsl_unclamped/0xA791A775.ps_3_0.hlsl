// Mechanically reconstructed from 0xA791A775.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyz = (v7.yyy) * (r3.xyz) + (c13.yyy);
    r1.xyz = (r8.yyy) * (v3.xyz) + (r1.xyz);
    r3.xyz = (r0.xyz) * (c13.zzz);
    ...
    r2.w = dot(r3.xy, r3.xy) + (c13.w);
    r1.x = exp2(-(r1.x));
    r2.w = exp2(-(r2.w));
    r1.x = (r1.x) * (c1.x) + (c1.y);
    r2.y = (r2.w) * (c1.x) + (c1.y);
    r2.w = dot(r3.xy, r8.xy) + (c13.w);
    r2.y = (r1.x) * (r2.y);
    r3 = tex2D(s14, v0.zw);
    r13.xy = (r3.xy) * (c2.ww);
