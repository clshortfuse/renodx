// Mechanically reconstructed from 0xAD7ECBB0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = (r2.w) + (r2.w);
    r2 = tex2D(s2, v1.xy);
    r4.xyz = (r2.wwy) * (c1.zyy) + (c1.wzz);
    r2.xyz = (r8.xyz) * (-(r3.www)) + (r3.xyz);
    r6.xyz = float3(((r4.w) >= 0.0f ? (r4.x) : (c1.z)), ((r4.w) >= 0.0f ? (r4.y) : (c1.y)), ((r4.w) >= 0.0f ? (r4.z) : (c1.z)));
