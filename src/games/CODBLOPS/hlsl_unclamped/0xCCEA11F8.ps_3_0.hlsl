// Mechanically reconstructed from 0xCCEA11F8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (-(r1.w)) + (c0.y);
    r2.xyz = (r1.zzz) * (v4.xyz);
    r1.z = (r1.w) * (r1.w);
    r11.w = saturate(dot(r10.xyz, r8.xyz));
    r1.z = (r1.z) * (r1.z);
    r1.z = (r1.w) * (r1.z);
    r9.xy = float2(((r2.w) >= 0.0f ? (r9.x) : (c0.z)), ((r2.w) >= 0.0f ? (r9.y) : (c0.y)));
    ...
    r1.w = (r9.w) * (r4.w) + (r9.z);
    r1.w = (r1.w) * (r8.w) + (c4.x);
    r8.xy = (r9.yy) * (c12.xy) + (c12.zw);
    r8.z = 1.0f / (r1.w);
    r7.w = exp2(r8.y);
    r5.w = (r7.w) * (c4.y) + (c4.z);
    r1.w = pow(abs(r11.w), r7.w);
    r8.z = (r9.w) * (r8.z);
    r1.w = (r5.w) * (r1.w);
    r1.z = (r2.w) * (r1.z) + (r3.w);
    r1.w = (r8.z) * (r1.w);
