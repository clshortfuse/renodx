// Mechanically reconstructed from 0x333A520E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r14.xyz = (r1.xyz) * (c[20].www);
    r13.xyz = (r0.xyz) * (c[20].yyy);
    r1 = tex2D(s12, v0.zw);
