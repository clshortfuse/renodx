// Mechanically reconstructed from 0xC4895088.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xz = (r2.xy) * (c12.xx);
    r5.xyz = (r8.xyz) * (r3.www) + (r0.xyz);
    r1 = tex2D(s5, v8.xy);
    r4.w = (r1.w) * (v0.y) + (c1.x);
    r0 = tex2D(s7, v1.xy);
    r2 = tex2D(s0, v1.xy);
    r4.xyz = float3(((r4.w) >= 0.0f ? (r1.x) : (r2.x)), ((r4.w) >= 0.0f ? (r1.y) : (r2.y)), ((r4.w) >= 0.0f ? (r1.z) : (r2.z)));
    r2 = (r0.wwww) * (c1.yyyz) + (c1.wwwy);
    r1 = tex2D(s8, v8.xy);
    r3 = tex2D(s6, v8.zw);
    r3.xyz = (r3.xyz) + (-(c1.zzz));
    r2 = float4(((r4.w) >= 0.0f ? (r1.x) : (r2.x)), ((r4.w) >= 0.0f ? (r1.y) : (r2.y)), ((r4.w) >= 0.0f ? (r1.z) : (r2.z)), ((r4.w) >= 0.0f ? (r1.w) : (r2.w)));
    r1.xyz = (v0.zzz) * (r3.xyz) + (c1.zzz);
    r10.xyz = float3(((r4.w) >= 0.0f ? (c[36].x) : (r0.y)), ((r4.w) >= 0.0f ? (c[36].y) : (r0.y)), ((r4.w) >= 0.0f ? (c[36].w) : (r0.y)));
    ...
    r1.w = (r3.x) * (c15.y) + (c15.z);
    r3.z = (r8.w) * (r9.w) + (r5.z);
    r4.y = (r3.z) * (r5.w) + (c15.x);
