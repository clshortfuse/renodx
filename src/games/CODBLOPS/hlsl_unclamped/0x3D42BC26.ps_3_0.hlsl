// Mechanically reconstructed from 0x3D42BC26.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = dot(r5.xyz, c[28].xyz);
    r0.z = saturate((r0.z) * (c[29].x) + (c[29].y));
    r0.y = (r0.z) * (c12.z) + (c12.w);
    r0.z = (r0.z) * (r0.z);
    ...
    r2.y = (r2.x) * (r2.x);
    r0.y = dot(r1, c[25]);
    r0.z = dot(c[22].yz, r2.xy) + (c[22].x);
    r1.w = saturate(1.0f / (r0.z));
    r1.xy = saturate((r2.xx) * (c[23].xy) + (c[23].zw));
    ...
    r0.xyz = (r2.zzz) * (r6.xyz) + (r8.xyz);
    r1.xyz = (r2.www) * (r1.xyz);
    r6.xyz = (r6.www) * (r1.xyz);
    r4 = (-(v4.yyyy)) + (c[6]);
    r3 = (-(v4.xxxx)) + (c[5]);
    r1 = (r4) * (r4);
    r1 = (r3) * (r3) + (r1);
