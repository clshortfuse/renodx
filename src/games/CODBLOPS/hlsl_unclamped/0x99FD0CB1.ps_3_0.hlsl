// Mechanically reconstructed from 0x99FD0CB1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.x = 1.0f / (r4.w);
    r0.w = c2.x;
    r2.xyz = (r0.www) + (-(c[10].xyw));
    r6.xy = saturate((r8.xx) * (c[9].xy) + (c[9].zw));
    r3.xy = (r6.xy) * (r6.xy);
    ...
    r7.y = (r6.z) * (r6.z);
    r12.xyz = (v0.zzz) * (r3.xyz) + (c2.xxx);
    r3 = tex2D(s4, v8.xy);
    r3.xyz = (r3.xyz) + (c2.yyy);
    r2.xyz = (r2.xyz) * (r12.xyz);
    r6.xyz = (v0.www) * (r3.xyz) + (c2.xxx);
    r3.z = (r7.z) * (r7.y);
