// Mechanically reconstructed from 0x9DAA93D4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.y = 1.0f / (r4.y);
    r5.w = (r3.w) * (r4.y);
    r7.xyz = (r2.xyz) * (r4.zzz) + (-(r3.xyz));
    r2.xyz = (r3.www) * (c[7].xyz);
    r4.xyz = normalize(r7.xyz);
    r7.w = saturate(dot(r0.xyz, r4.xyz));
    r7.xy = (r1.ww) * (c3.xy) + (c3.zw);
    r4.y = saturate(dot(r4.xyz, r6.xyz));
    r4.z = exp2(r7.y);
    r3.w = 1.0f / (r7.x);
    r4.y = (-(r4.y)) + (c1.z);
    r6.w = pow(abs(r7.w), r4.z);
    r4.x = (r4.y) * (r4.y);
    r4.z = (r4.z) * (c4.x) + (c4.y);
    r4.x = (r4.x) * (r4.x);
    r4.z = (r6.w) * (r4.z);
    ...
    r4.z = (r5.w) * (r4.z);
    r1.xyz = (r6.xyz) * (r4.yyy) + (r7.xyz);
    r1.w = (r1.w) * (c1.x);
    r1.xyz = (r4.zzz) * (r1.xyz);
    r4.xyz = (r1.xyz) * (c[22].www);
    r1.xyz = (r5.xyz) * (c[22].yyy);
    r4.xyz = (r4.xyz) * (c[8].xyz);
    r1.xyz = (r1.xyz) * (c1.yyy);
    r5.xyz = (r2.www) * (r4.xyz);
    r4.xyz = (r2.www) * (r2.xyz) + (r1.xyz);
    r2 = tex2D(s0, v1.xy);
