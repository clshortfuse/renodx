// Mechanically reconstructed from 0x189FD49A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = (r1.y) * (r1.z);
    r12.xyz = float3(((r4.w) >= 0.0f ? (c[20].x) : (r2.y)), ((r4.w) >= 0.0f ? (c[20].y) : (r2.y)), ((r4.w) >= 0.0f ? (c[20].w) : (r2.y)));
