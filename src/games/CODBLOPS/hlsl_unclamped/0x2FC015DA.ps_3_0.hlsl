// Mechanically reconstructed from 0x2FC015DA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.x = dot(r2.xy, r0.xy) + (c13.z);
    r4.y = dot(r2.xy, r0.zw) + (c13.z);
    r0 = tex2D(s2, v6.xy);
    r5.w = (r0.w) * (v0.y);
    r2.xy = (r1.yw) * (c11.xx) + (c11.yy);
    r6.xy = lerp(r5.xy, r4.xy, r5.ww);
    r1.w = dot(r2.xy, r2.xy) + (c13.z);
    ...
    r2.xyz = (v0.www) * (r6.xyz) + (-(c13.yyy));
    r1.z = (r1.z) * (r4.w);
    r3.xyz = (r3.xyz) * (r2.xyz);
    r8.xyz = (r3.xyz) * (r3.xyz);
    r7.xyz = (r3.xyz) * (-(r3.xyz)) + (-(c13.yyy));
    r1.w = (r1.x) * (r1.w);
