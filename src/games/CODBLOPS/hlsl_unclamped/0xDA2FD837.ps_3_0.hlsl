// Mechanically reconstructed from 0xDA2FD837.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xy = (r6.ww) * (r1.xy) + (c[20].xy);
    r1.w = (r1.w) + (r1.w);
    r9.xy = lerp(r1.xy, c1.xx, r5.ww);
    ...
    r1 = (r3) * (r3) + (r1);
    r2 = (-(v6.zzzz)) + (c[7]);
    r12.xyz = lerp(r7.xyz, r6.xyz, r6.www);
    r1 = (r2) * (r2) + (r1);
