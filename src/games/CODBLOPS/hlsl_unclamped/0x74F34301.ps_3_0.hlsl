// Mechanically reconstructed from 0x74F34301.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.y = saturate(dot(r10.xyz, -(r1.xyz)));
    r3.z = (r2.w) * (c2.y);
    r0.w = (r2.w) * (-(c2.y)) + (c2.z);
    ...
    r3.z = dot(r1.xyz, r10.xyz);
    r2.xyz = (r2.xyz) * (c2.xxx);
    r4.w = (r3.z) + (r3.z);
    r3.xyz = (r3.www) * (r5.xyz) + (r2.xyz);
    r2.xyz = (r10.xyz) * (-(r4.www)) + (r1.xyz);
