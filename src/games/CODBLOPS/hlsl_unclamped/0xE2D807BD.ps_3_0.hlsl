// Mechanically reconstructed from 0xE2D807BD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xy = float2(((r6.w) >= 0.0f ? (r0.x) : (c1.y)), ((r6.w) >= 0.0f ? (r0.y) : (c1.y)));
    ...
    r2.xyz = float3(((r6.w) >= 0.0f ? (r2.x) : (c1.y)), ((r6.w) >= 0.0f ? (r2.y) : (c1.z)), ((r6.w) >= 0.0f ? (r2.z) : (c1.z)));
    r1.w = (-(r1.w)) + (c1.z);
    r1.x = (r1.w) * (r1.w);
    r1.y = (r2.y) * (c4.x) + (c4.y);
    r1.w = (r1.w) * (r1.x);
