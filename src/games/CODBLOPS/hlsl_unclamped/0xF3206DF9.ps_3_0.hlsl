// Mechanically reconstructed from 0xF3206DF9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s4, v1.xy);
    r1.xyz = (r0.xyz) * (r0.xyz) + (-(r2.xyz));
    r0 = tex2D(s1, v1.xy);
    r3.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r6.xyz = (v4.www) * (r1.xyz) + (r2.xyz);
