// Mechanically reconstructed from 0xAD06DA4A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.x = dot(r3.xy, r0.xy) + (c3.z);
    r4.y = dot(r3.xy, r0.zw) + (c3.z);
    r0 = tex2D(s4, v7.xy);
    r4.w = (r0.w) * (v0.y);
    r0.w = dot(r1, c1.xxxx);
    ...
    r3.w = (r1.w) * (r1.w);
    r8.xyz = (v0.zzz) * (r2.xyz) + (c3.www);
    r2 = tex2D(s6, v8.xy);
    r2.xyz = (r2.xyz) + (c3.yyy);
    r1.xyz = (r1.xyz) * (r8.xyz);
    r2.xyz = (v0.www) * (r2.xyz) + (c3.www);
    r2.w = (r3.w) * (r3.w);
    r6.xyz = (r1.xyz) * (r2.xyz);
    r2.w = (r1.w) * (r2.w);
    r9.xyz = (r6.xyz) * (-(r6.xyz)) + (c3.www);
    r1 = tex2D(s0, v1.xy);
