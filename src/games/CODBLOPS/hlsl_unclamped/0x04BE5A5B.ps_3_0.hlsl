// Mechanically reconstructed from 0x04BE5A5B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s5, v8.xy);
    r1.w = (r1.w) * (v0.y);
    r3.xy = (r1.ww) * (-(r0.xy)) + (r0.xy);
    r0 = tex2D(s6, v8.zw);
    r4.w = (r0.w) * (v0.z);
    r5.xy = (r4.ww) * (-(r3.xy)) + (r3.xy);
    r4.xyz = lerp(r2.xyz, r1.xyz, r1.www);
    r0.w = dot(r5.xy, r5.xy) + (c12.y);
    r3.xyz = lerp(r4.xyz, r0.xyz, r4.www);
    r0.w = exp2(-(r0.w));
    r3.w = (r0.w) * (c12.z) + (c12.w);
    r7.w = c12.x;
    r0.xyz = (r7.www) + (-(c[36].xyw));
    r4.xyz = (r1.www) * (r0.xyz) + (c[36].xyw);
    r0.xy = (v1.zw) * (c1.zw);
    r2 = tex2D(s13, r0.xy);
    ...
    r2.xy = (r2.xz) * (r7.xx);
    r0.w = dot(r8.xy, r5.xy) + (c12.y);
    r0.y = (r1.x) * (c3.w) + (-(r2.x));
    r1.w = (r2.z) * (-(r7.x)) + (r0.y);
    r6.xy = (r0.xz) * (r7.yy);
    r0.y = (r1.y) * (c3.w) + (-(r6.x));
    r0.x = dot(r8.xy, r8.xy) + (c12.y);
    r0.y = (r0.z) * (-(r7.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r8.y = (r1.w) + (r1.w);
    ...
    r8.xz = (r2.xy) * (c4.xx);
    r7.xyz = lerp(r4.xyz, c12.xxx, r4.www);
    r0.xyz = (r8.xyz) * (r3.www) + (r0.xyz);
    r6.xyz = (r3.xyz) * (r3.xyz);
    r11.xyz = (r7.yyy) * (r0.xyz);
    r1 = tex2D(s12, v1.zw);
    r0 = v2;
    ...
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c12.x) : (c12.y));
    ...
    r11.w = (r2.w) * (-(c1.y)) + (c1.z);
    r12.z = (r2.w) * (c1.y);
    r5.w = saturate(dot(r11.xyz, r9.xyz));
    r7.y = saturate(dot(r9.xyz, -(r1.xyz)));
    r1.w = (r5.w) * (r11.w) + (r12.z);
    r10.w = (r7.y) * (r11.w) + (r12.z);
    r6.w = (r1.w) * (r10.w) + (c4.z);
    ...
    r1.w = (r7.y) * (c14.x) + (c14.y);
    r7.x = (r9.w) * (r11.w) + (r12.z);
    r10.w = (r7.x) * (r10.w) + (c4.z);
    r7.x = saturate(dot(r9.xyz, r5.xyz));
    r5.y = 1.0f / (r10.w);
    r5.z = pow(abs(r7.x), r7.y);
    r5.y = (r9.w) * (r5.y);
    r5.z = (r1.w) * (r5.z);
    r5.z = (r5.y) * (r5.z);
    r2.xyz = (r4.xyz) * (r8.www) + (r2.xyz);
    r4.z = pow(abs(r6.w), r7.y);
