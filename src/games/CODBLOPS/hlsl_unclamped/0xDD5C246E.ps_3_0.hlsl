// Mechanically reconstructed from 0xDD5C246E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xy = (v1.xy) + (c1.xx);
    r2.z = c1.y;
    r0.xy = (r5.xy) * (c[31].xx) + (r2.zz);
    r0 = tex2D(s4, r0.xy);
    r7.w = (v8.w) * (c1.z) + (-(r0.x));
    r3.xy = (r3.wy) * (c0.xy) + (c0.zw);
    r5.w = saturate((r7.w) * (c1.w));
    r1.w = r2.x;
    r2.xy = lerp(r6.xy, r3.xy, r5.ww);
    r3.z = dot(r1, c4.wwww);
    r1 = v2;
    ...
    r0.x = 1.0f / (r0.x);
    r3.w = (r0.z) * (r0.x);
    r7.xyz = (r4.xyz) * (r4.www) + (-(r1.xyz));
    r3.xyz = (r0.zzz) * (c[22].xyz);
    r4.xyz = normalize(r7.xyz);
    r7.z = saturate(dot(r9.xyz, r4.xyz));
    r7.xy = (r2.ww) * (c12.xy) + (c12.zw);
    r0.x = saturate(dot(r4.xyz, r6.xyz));
    r0.z = exp2(r7.y);
    r9.w = 1.0f / (r7.x);
    r0.x = (-(r0.x)) + (c2.x);
    r4.z = pow(abs(r7.z), r0.z);
    r4.w = (r0.x) * (r0.x);
