// Mechanically reconstructed from 0x43F5907D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = (r1.wy) * (c13.yy) + (c13.zz);
    r1.w = dot(r6.xy, r6.xy) + (c4.x);
    r1.y = dot(r2.xy, r2.xy) + (c4.x);
    r1.w = exp2(-(r1.w));
    r1.y = exp2(-(r1.y));
    r1.w = (r1.w) * (c4.y) + (c4.z);
    r2.w = (r1.y) * (c4.y) + (c4.z);
    r1.y = dot(r2.xy, r6.xy) + (c4.x);
    r3.w = (r1.w) * (r2.w);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c13.xx);
    ...
    r7.xz = (r3.xy) * (c13.yy);
    r3.xyz = lerp(r4.xyz, r0.xyz, r7.www);
    r0.xyz = (r7.xyz) * (r1.www) + (r1.xyz);
    r1.x = c3.w;
    r2.xyz = float3(((r0.w) >= 0.0f ? (r1.x) : (c[8].x)), ((r0.w) >= 0.0f ? (r1.x) : (c[8].y)), ((r0.w) >= 0.0f ? (r1.x) : (c[8].w)));
    r1.xyz = (v6.xyz) * (-(r5.www)) + (c[17].xyz);
    r11.xyz = lerp(r2.xyz, c[9].xyw, r7.www);
    r4.xyz = normalize(r1.xyz);
    r15.xyz = (r0.xyz) * (r11.yyy);
    r3.w = saturate(dot(r4.xyz, c[17].xyz));
    r2 = tex2D(s7, v1.xy);
    r1 = tex2D(s8, v7.zw);
    r0 = tex2D(s5, v8.xy);
    r5.xyz = (r0.xyz) + (c3.yyy);
    r0 = lerp(r2, r1, r7.wwww);
    r1.xyz = (v0.www) * (r5.xyz) + (c3.www);
    r2.xyz = (r0.xyz) * (r1.xyz);
    r1.w = (-(r3.w)) + (c3.w);
    r9.xyz = (r2.xyz) * (-(r2.xyz)) + (c3.www);
    r0.z = (r1.w) * (r1.w);
    r2.w = (r0.z) * (r0.z);
    r0.xyz = v2.xyz;
