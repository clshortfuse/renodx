// Mechanically reconstructed from 0xB3E5E556.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r1.w) * (c4.x) + (c4.y);
    r2.w = (r1.y) * (c4.x) + (c4.y);
    r1.y = dot(r6.xy, r5.xy) + (c3.z);
    r2.w = (r1.w) * (r2.w);
    r8.xyz = (r3.xyz) * (r3.xyz);
    r2.w = saturate((r1.y) * (r2.w) + (r2.w));
    r3 = tex2D(s14, v1.zw);
    r7.xy = (r3.xy) * (c12.xx);
    r2.xy = (r2.xz) * (r7.xx);
    r6.xy = (r1.xz) * (r7.yy);
    r1.x = (r3.x) * (c12.x) + (-(r2.x));
    r1.y = (r3.y) * (c12.x) + (-(r6.x));
    r2.z = (r2.z) * (-(r7.x)) + (r1.x);
    r1.z = (r1.z) * (-(r7.y)) + (r1.y);
    r1.y = (r1.z) + (r1.z);
    r1.xz = (r6.xy) * (c12.yy);
    ...
    r3.w = saturate(dot(r12.xyz, r4.xyz));
    r16.xy = (r0.ww) * (c13.xy) + (c13.zw);
    r2.x = (r0.w) * (c4.w);
    r1.w = exp2(r16.y);
    r2.z = pow(abs(r3.w), r1.w);
