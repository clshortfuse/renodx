// Mechanically reconstructed from 0xA86C2A0B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xy = (c[32].zz) * (r1.xy) + (r0.xy);
    r0 = tex2D(s0, v1.xy);
    r3.w = (r0.w) * (v0.w) + (c1.x);
    r5.xy = float2(((r3.w) >= 0.0f ? (r1.x) : (c1.z)), ((r3.w) >= 0.0f ? (r1.y) : (c1.z)));
    ...
    r1.z = saturate(dot(r16.xyz, c[17].xyz));
    r1.y = c1.z;
    r8.xyz = float3(((r3.w) >= 0.0f ? (c[31].x) : (r1.y)), ((r3.w) >= 0.0f ? (c[31].y) : (r1.y)), ((r3.w) >= 0.0f ? (c[31].w) : (r1.y)));
    r2.y = (-(r1.z)) + (c1.y);
