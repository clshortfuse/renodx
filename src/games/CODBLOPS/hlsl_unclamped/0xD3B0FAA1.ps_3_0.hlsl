// Mechanically reconstructed from 0xD3B0FAA1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(0.200000003f, 0.25f, -1.0f, 1.0f);
    ...
    r3.w = (r1.x) * (r0.z);
    r2.xzw = c[8].xzw;
    r1.x = dot(r0.xw, c[27].xy) + (r2.x);
    r1.y = dot(r0.xw, c[27].zw) + (r2.z);
    r0 = tex2D(s3, r1.xy);
