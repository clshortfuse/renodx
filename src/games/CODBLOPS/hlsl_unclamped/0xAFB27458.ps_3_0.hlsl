// Mechanically reconstructed from 0xAFB27458.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = saturate(dot(r3.xyz, r6.xyz));
    ...
    r12.yz = c0.yz;
    r6.xyz = float3(((r2.w) >= 0.0f ? (c[29].x) : (r12.z)), ((r2.w) >= 0.0f ? (c[29].y) : (r12.z)), ((r2.w) >= 0.0f ? (c[29].w) : (r12.z)));
    r6.w = 1.0f / (r3.x);
