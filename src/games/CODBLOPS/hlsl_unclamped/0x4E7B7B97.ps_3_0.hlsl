// Mechanically reconstructed from 0x4E7B7B97.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r6.xyz = saturate((r2.xyz) * (r0.www) + (r0.xyz));
    r5 = tex2D(s3, v1.xy);
    ...
    r0.w = dot(c[40].yz, r14.xy) + (c[40].x);
    r9.xy = saturate((r14.xx) * (c[41].xy) + (c[41].zw));
    r0.xy = (r9.xy) * (r9.xy);
    r9.xy = (r9.xy) * (c1.zz) + (c1.ww);
    r9.xy = (r0.xy) * (r9.xy);
    r9.w = max(abs(r10.y), abs(r10.z));
    r5.x = (r0.w) * (r9.x);
    r0.w = max(abs(r10.x), r9.w);
    r0.w = 1.0f / (r0.w);
