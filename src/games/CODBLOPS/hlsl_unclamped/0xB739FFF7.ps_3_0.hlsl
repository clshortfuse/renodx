// Mechanically reconstructed from 0xB739FFF7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (c[31].x) * (v4.x);
    r9.x = c4.x;
    r10.w = (r1.w) * (r9.x) + (c[32].x);
    r9.yzw = (c12.xyz) + (v4.xxx);
    r11.xyz = (r9.yzw) * (c[31].xxx);
    r10.z = (r11.x) * (r9.x) + (c[32].z);
    r12.y = c[31].y;
    r10.xy = (v4.yy) * (r12.yy) + (c[32].yw);
    r11.xy = (r11.yz) * (r9.xx) + (c[33].xz);
    r11.zw = (v4.yy) * (r12.yy) + (c[33].yw);
    ...
    r3 = tex2Dgrad(s6, r9.xy, r8.xy, r8.zw);
    r3 = (r3) * (r3);
    r1.xyz = (r2.xyz) * (c15.zzz) + (r1.xyz);
