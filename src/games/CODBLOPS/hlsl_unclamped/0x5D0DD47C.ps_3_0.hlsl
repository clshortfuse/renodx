// Mechanically reconstructed from 0x5D0DD47C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.zw = r2.zw;
    r0.xyz = c[18].xyz;
    r5.xyz = (r0.xyz) * (c[35].xxx);
    r1.zw = r4.zw;
    r0.xy = (r3.ww) * (-(c[36].zw)) + (r3.xy);
    r0.zw = r1.zw;
    r0 = tex2Dproj(s3, r0);
    r0.w = r0.x;
    ...
    r0 = tex2D(s4, r0.xy);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r7.xyz = (r2.www) * (r5.xyz) + (r6.xyz);
    r0.xyz = (r1.www) * (r0.xyz);
    r8.xyz = (r5.www) * (r0.xyz);
    r5.w = saturate(dot(r1.xyz, r10.xyz));
    r0 = tex2D(s0, v1.xy);
    r0 = (r0.wxyz) * (v0.wxyz);
    r4 = (-(v7.yyyy)) + (c[7]);
    r3 = (-(v7.xxxx)) + (c[6]);
