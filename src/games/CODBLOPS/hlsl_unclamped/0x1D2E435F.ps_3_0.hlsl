// Mechanically reconstructed from 0x1D2E435F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c31 = float4(2.0f, -1.0f, 0.0f, -0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r3.y = dot(r1.xy, r0.zw) + (c31.z);
    r3.x = dot(r1.xy, r0.xy) + (c31.z);
    r0 = tex2D(s1, v0.xy);
    ...
    r0 = tex2D(s13, r0.xy);
    r1.w = r0.y;
    r6.xy = lerp(r4.xy, r3.xy, r4.ww);
    r5.xy = (r1.yw) * (c4.xx) + (c4.yy);
    r8.xyz = (r2.xyz) * (r2.xyz);
    r0.w = dot(r5.xy, r6.xy) + (c31.z);
    r2 = tex2D(s14, v0.zw);
    r7.xy = (r2.xy) * (c3.ww);
    r3.xy = (r1.xz) * (r7.xx);
    r4.xy = (r0.xz) * (r7.yy);
    ...
    r10.xz = (r3.xy) * (c4.xx);
    r1.w = (r1.w) * (r1.w);
    r4.xyz = (r10.xyz) * (r2.www) + (r0.xyz);
    r5.w = (r0.w) * (r1.w);
    r2 = tex2D(s8, v7.zw);
    r0 = (r2.wwww) * (-(c31.zzzy)) + (-(c31.wwwz));
    r3 = tex2D(s7, v0.xy);
    r1 = lerp(r3, r0, r4.wwww);
    r11.xyz = (r1.xyz) * (-(r1.xyz)) + (-(c31.yyy));
    r0 = v1;
    ...
    r1.z = saturate(dot(r14.xyz, r5.xyz));
    r12.w = (r1.w) * (c1.w);
    ...
    r1.z = (r1.y) * (r1.z);
    r13.xyz = lerp(c[29].xyw, r2.yyy, r4.www);
    r0.xyz = (r0.xyz) * (r1.zzz);
    r16.xyz = (r4.xyz) * (r13.yyy);
    ...
    r2 = tex2D(s12, v0.zw);
    r0.z = ((-abs(r2.y)) >= 0.0f ? (-(c31.y)) : (-(c31.z)));
