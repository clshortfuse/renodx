// Mechanically reconstructed from 0xD546FF85.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = (r0.z) + (r0.z);
    r6.w = c1.x;
    r1.xyz = (r6.www) + (-(c[20].xyw));
    r0.xyz = (r8.xyz) * (r0.www) + (r3.xyz);
    r7.xyz = (r5.www) * (r1.xyz) + (c[20].xyw);
