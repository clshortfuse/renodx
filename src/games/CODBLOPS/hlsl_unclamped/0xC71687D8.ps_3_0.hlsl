// Mechanically reconstructed from 0xC71687D8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = (v0.yyy) * (r0.xyz) + (c20.zzz);
    r0 = tex2D(s0, v1.xy);
    r2 = tex2D(s4, v7.zw);
    r3.w = (r2.w) * (v0.z);
    r2.xyz = (r0.xyz) * (-(r6.xyz)) + (r2.xyz);
    r7.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r1.xyz = (r3.www) * (r2.xyz);
    r2.xyz = (r0.xyz) * (r6.xyz) + (r1.xyz);
    r0.xy = (v1.zw) * (c4.xy) + (c4.zy);
    r0 = tex2D(s13, r0.xy);
    r1.xy = (v1.zw) * (c4.xy);
    r1 = tex2D(s13, r1.xy);
    r0.w = r1.y;
    r4.xy = lerp(r7.xy, r3.xy, r3.ww);
    r3.xy = (r0.wy) * (c11.xx) + (c11.yy);
    r0.w = dot(r4.xy, r4.xy) + (c20.w);
    r0.y = dot(r3.xy, r3.xy) + (c20.w);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c3.x) + (c3.y);
    r1.w = (r0.y) * (c3.x) + (c3.y);
    r0.y = dot(r3.xy, r4.xy) + (c20.w);
    r1.w = (r0.w) * (r1.w);
