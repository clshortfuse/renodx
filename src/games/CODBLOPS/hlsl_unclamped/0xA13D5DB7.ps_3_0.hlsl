// Mechanically reconstructed from 0xA13D5DB7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.y = dot(r3.xy, r0.zw) + (c3.w);
    r1 = tex2D(s1, v1.xy);
    r2.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r1 = tex2D(s5, v7.xy);
    r3.w = (r1.w) * (v0.y);
    r7.x = dot(r3.xy, r0.xy) + (c3.w);
    r8.xy = (r3.ww) * (-(r2.xy)) + (r2.xy);
    r0 = tex2D(s8, v1.xy);
    r2 = tex2D(s0, v1.xy);
    r6.xyz = lerp(r2.xyz, r1.xyz, r3.www);
    r5.xyz = lerp(r0.yyy, c[32].xyw, r3.www);
    r2.w = -(r0.w);
    r2.xyz = c3.zzz;
    r1 = tex2D(s9, v7.xy);
    r1 = (r2) + (r1);
    r2 = (r0.wwww) * (-(c3.wwwy)) + (-(c3.zzzw));
    r0 = tex2D(s6, v7.zw);
    r5.w = (r0.w) * (v0.z);
    r3 = (r3.wwww) * (r1) + (r2);
    ...
    r10.xy = lerp(r8.xy, r7.xy, r5.ww);
    r0 = lerp(r3, r2, r5.wwww);
    r14.xyz = lerp(r5.xyz, r1.yyy, r5.www);
    r1.w = dot(r10.xy, r10.xy) + (c3.w);
