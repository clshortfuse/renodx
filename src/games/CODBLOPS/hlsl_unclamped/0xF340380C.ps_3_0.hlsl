// Mechanically reconstructed from 0xF340380C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r15.xyz = (v0.yyy) * (r1.xyz) + (c1.yyy);
    r0 = tex2D(s0, v1.xy);
    r1 = tex2D(s5, v8.zw);
    r1.xyz = (r1.xyz) * (v0.zzz);
    r1.xyz = (r1.www) * (r1.xyz);
    r0.w = dot(r3.xy, r3.xy) + (c1.z);
    r13.xyz = (r0.xyz) * (r15.xyz) + (r1.xyz);
    r0.w = exp2(-(r0.w));
    r3.z = (r0.w) * (c3.x) + (c3.y);
    ...
    r1.y = pow(abs(r2.y), r9.w);
    r2.y = (r9.w) * (c13.y) + (c13.z);
    r1.x = 1.0f / (r1.x);
    r1.y = (r1.y) * (r2.y);
    r5.w = (r5.w) * (r1.x);
    r3.w = (r3.w) * (r1.y);
    ...
    r1.w = (r8.w) * (r2.x) + (r10.w);
    r1.w = (r1.w) * (r2.z) + (c13.x);
    r2.x = saturate(dot(r9.xyz, r8.xyz));
    r2.z = 1.0f / (r1.w);
    r1.w = pow(abs(r2.x), r9.w);
    r2.z = (r8.w) * (r2.z);
    r1.w = (r2.y) * (r1.w);
    r1.w = (r2.z) * (r1.w);
    r8.xyz = (r5.xyz) * (r7.www) + (r7.xyz);
    r2.xyz = (r1.xyz) * (r1.xyz);
    r1.xyz = (r1.www) * (r8.xyz);
