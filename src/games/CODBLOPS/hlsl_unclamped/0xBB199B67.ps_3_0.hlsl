// Mechanically reconstructed from 0xBB199B67.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s3, v6.xy);
    r4.w = (r1.w) * (v0.y) + (c1.w);
    r6.xyz = float3(((r4.w) >= 0.0f ? (r0.x) : (r3.x)), ((r4.w) >= 0.0f ? (r0.y) : (r3.y)), ((r4.w) >= 0.0f ? (r0.z) : (r3.z)));
    r0 = tex2D(s6, v6.zw);
