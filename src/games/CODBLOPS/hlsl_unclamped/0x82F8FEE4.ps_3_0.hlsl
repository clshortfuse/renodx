// Mechanically reconstructed from 0x82F8FEE4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s5, v7.xy);
    r5.w = (r0.w) * (v0.y) + (c4.w);
    r8.xy = float2(((r5.w) >= 0.0f ? (r2.x) : (r3.x)), ((r5.w) >= 0.0f ? (r2.y) : (r3.y)));
    r0.w = dot(r8.xy, r8.xy) + (c4.z);
    r0.w = exp2(-(r0.w));
    ...
    r13.xyz = float3(((r5.w) >= 0.0f ? (c[39].x) : (r1.y)), ((r5.w) >= 0.0f ? (c[39].y) : (r1.y)), ((r5.w) >= 0.0f ? (c[39].w) : (r1.y)));
    r1 = tex2D(s6, v7.zw);
    ...
    r4.xyz = (v0.zzz) * (r1.xyz) + (-(c4.yyy));
    r7.xyz = (r2.xyz) * (r1.www) + (-(r6.xyz));
    r1.xyz = normalize(r7.xyz);
    r2.xyz = (r2.xyz) * (r1.www);
    r0.xyz = (r0.xyz) * (r4.xyz);
    r1.w = saturate(dot(r1.xyz, r2.xyz));
    r12.xyz = (r5.xyz) * (r13.yyy);
    r1.w = (-(r1.w)) + (-(c4.y));
