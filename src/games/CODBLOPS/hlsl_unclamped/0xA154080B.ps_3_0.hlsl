// Mechanically reconstructed from 0xA154080B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = saturate((r7.xx) * (c[26].xy) + (c[26].zw));
    r0.xy = (r2.xy) * (r2.xy);
    ...
    r2.xyz = (r0.xyz) * (c[27].yyy);
    r0.xyz = (r6.xxx) * (c[22].xyz);
