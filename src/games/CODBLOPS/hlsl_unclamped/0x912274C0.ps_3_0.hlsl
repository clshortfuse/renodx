// Mechanically reconstructed from 0x912274C0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = (v1.xy) + (c1.xx);
    r0.z = c1.y;
    r0.xy = (r2.xy) * (c[21].xx) + (r0.zz);
    r2.xy = (r2.xy) * (c[20].xx) + (r0.zz);
    r0 = tex2D(s4, r0.xy);
    ...
    r1.x = saturate(dot(r6.xyz, -(r7.xyz)));
    r2 = tex2D(s2, v1.xy);
    r3.w = (r2.w) * (c3.y);
    r1.z = (r2.w) * (-(c3.y)) + (c3.z);
    r9.w = saturate(dot(r6.xyz, c[17].xyz));
    r1.y = (r1.x) * (r1.z) + (r3.w);
    r1.z = (r9.w) * (r1.z) + (r3.w);
    r7.w = (-(r1.x)) + (c2.x);
    r1.z = (r1.z) * (r1.y) + (c3.w);
    ...
    r3.w = (r9.w) * (r3.w);
    r4.z = saturate(dot(r6.xyz, r1.xyz));
    ...
    r1.z = max(abs(r6.x), r3.w);
    r3.w = 1.0f / (r1.z);
    r1.xyz = (r6.xyz) * (c[5].xyz);
    r9.xy = c[6].xy;
    r8.xyz = (r9.yyy) * (c[19].xyz);
