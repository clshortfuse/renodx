// Mechanically reconstructed from 0xDF2EC6FE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xyz = (v0.zzz) * (r1.xyz) + (c27.www);
    r2.w = saturate(dot(r4.xyz, c[17].xyz));
    r0.xyz = (r0.xyz) * (r5.xyz);
    r1 = tex2D(s5, v8.xy);
    r1.xyz = (r1.xyz) + (c27.yyy);
    r2.xyz = (v0.www) * (r1.xyz) + (c27.www);
    r1.w = (-(r2.w)) + (c27.w);
    ...
    r1.w = (r1.w) * (r3.z);
    r13.xyz = (r4.www) * (r2.xyz) + (c[23].xyw);
