// Mechanically reconstructed from 0x8810288D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r1.w) + (r1.w);
    r6.xyz = (r1.xyz) * (r2.yyy);
    r1.xyz = (r8.xyz) * (-(r1.www)) + (r0.xyz);
    r0.z = saturate(dot(r8.xyz, -(r0.xyz)));
    r1.w = (r2.w) * (c1.x);
    ...
    r0.y = 1.0f / (r0.y);
    r1 = tex2D(s0, v1.xy);
    r4.xyz = lerp(r1.xyz, c2.xxx, r2.xxx);
    r1.w = (r0.z) * (r0.y);
