// Mechanically reconstructed from 0x9C1D3175.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.w = (r4.w) * (v0.y);
    r0.w = r2.y;
    r3.xy = lerp(r5.xy, r1.xy, r4.ww);
    r1 = tex2D(s5, v6.zw);
    r5.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r1 = (c12.xxxx) * (v8) + (c12.yyyy);
    r1.x = dot(r5.xy, r1.xy) + (c12.z);
    r1.y = dot(r5.xy, r1.zw) + (c12.z);
    r5 = tex2D(s3, v6.zw);
    r7.w = (r5.w) * (v0.z);
    ...
    r0.xy = (-(r0.xy)) + (c[24].xy);
    r8.y = (r0.w) + (r0.w);
    r1.xy = (r4.ww) * (r0.xy) + (c[23].xy);
    r0 = tex2D(s8, v6.zw);
    r10.xy = lerp(r1.xy, r0.yy, r7.ww);
    r1 = (r0.wwww) * (-(c12.zzzy)) + (-(c12.wwwz));
    r3 = tex2D(s6, v1.xy);
    r0 = tex2D(s7, v6.xy);
    r2.xyz = v2.xyz;
