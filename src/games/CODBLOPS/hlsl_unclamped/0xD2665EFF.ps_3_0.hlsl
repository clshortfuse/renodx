// Mechanically reconstructed from 0xD2665EFF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.z = (r0.w) * (v0.y) + (c3.w);
    r4.w = (r1.w) * (r1.z);
    r7.xy = float2(((r6.z) >= 0.0f ? (r1.x) : (r2.x)), ((r6.z) >= 0.0f ? (r1.y) : (r2.y)));
    r1 = tex2D(s6, v7.zw);
    ...
    r1 = tex2D(s0, v1.xy);
    r5.xyz = float3(((r6.z) >= 0.0f ? (r0.x) : (r1.x)), ((r6.z) >= 0.0f ? (r0.y) : (r1.y)), ((r6.z) >= 0.0f ? (r0.z) : (r1.z)));
    r0 = tex2D(s8, v7.xy);
    r2 = (r0.wwww) * (c4.xxxy) + (c4.zzzx);
    r3 = tex2D(s7, v1.xy);
    r1 = tex2D(s4, v7.zw);
    r6.w = (r1.w) * (v0.z) + (c3.w);
    r2 = float4(((r6.z) >= 0.0f ? (r2.x) : (r3.x)), ((r6.z) >= 0.0f ? (r2.y) : (r3.y)), ((r6.z) >= 0.0f ? (r2.z) : (r3.z)), ((r6.z) >= 0.0f ? (r2.w) : (r3.w)));
    r3.xyz = float3(((r6.w) >= 0.0f ? (r1.x) : (r5.x)), ((r6.w) >= 0.0f ? (r1.y) : (r5.y)), ((r6.w) >= 0.0f ? (r1.z) : (r5.z)));
    r7.xy = float2(((r6.w) >= 0.0f ? (r6.x) : (r7.x)), ((r6.w) >= 0.0f ? (r6.y) : (r7.y)));
    r5.xyz = float3(((r6.z) >= 0.0f ? (r0.y) : (c[23].x)), ((r6.z) >= 0.0f ? (r0.y) : (c[23].y)), ((r6.z) >= 0.0f ? (r0.y) : (c[23].w)));
    r1 = tex2D(s9, v7.zw);
    r0 = (r1.wwww) * (c4.xxxy) + (c4.zzzx);
    r0 = float4(((r6.w) >= 0.0f ? (r0.x) : (r2.x)), ((r6.w) >= 0.0f ? (r0.y) : (r2.y)), ((r6.w) >= 0.0f ? (r0.z) : (r2.z)), ((r6.w) >= 0.0f ? (r0.w) : (r2.w)));
    r13.xyz = float3(((r6.w) >= 0.0f ? (r1.y) : (r5.x)), ((r6.w) >= 0.0f ? (r1.y) : (r5.y)), ((r6.w) >= 0.0f ? (r1.y) : (r5.z)));
    ...
    r2 = tex2D(s14, v1.zw);
    r8.xy = (r2.xy) * (c12.ww);
    r9.xy = (r3.yw) * (c14.xx) + (c14.yy);
    r3.xy = (r3.xz) * (r8.xx);
    r1.w = dot(r9.xy, r7.xy) + (c3.z);
    r1.y = (r2.x) * (c12.w) + (-(r3.x));
    r2.w = (r3.z) * (-(r8.x)) + (r1.y);
    r5.xy = (r1.xz) * (r8.yy);
    r1.y = (r2.y) * (c12.w) + (-(r5.x));
