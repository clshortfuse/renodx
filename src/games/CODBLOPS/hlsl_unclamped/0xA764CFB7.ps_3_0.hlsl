// Mechanically reconstructed from 0xA764CFB7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xy = (r0.ww) * (-(r2.xy)) + (r2.xy);
    r3.xyz = (r0.www) * (r0.xyz) + (c[29].xyw);
    r0 = tex2D(s6, v8.zw);
    r3.w = (r0.w) * (v0.z);
    ...
    r2.xyz = lerp(r5.xyz, r0.xyz, r3.www);
