// Mechanically reconstructed from 0x9203BE86.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xy = float2(((r4.w) >= 0.0f ? (r5.x) : (r6.x)), ((r4.w) >= 0.0f ? (r5.y) : (r6.y)));
    ...
    r1 = tex2D(s9, v7.xy);
    r9.xyz = float3(((r4.w) >= 0.0f ? (r1.y) : (c[32].x)), ((r4.w) >= 0.0f ? (r1.y) : (c[32].y)), ((r4.w) >= 0.0f ? (r1.y) : (c[32].w)));
