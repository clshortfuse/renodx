// Mechanically reconstructed from 0x624BF4D9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r4.w = (r0.w) * (v0.w) + (c1.y);
    r4.xy = float2(((r4.w) >= 0.0f ? (r1.x) : (c1.w)), ((r4.w) >= 0.0f ? (r1.y) : (c1.w)));
    r1 = v2;
