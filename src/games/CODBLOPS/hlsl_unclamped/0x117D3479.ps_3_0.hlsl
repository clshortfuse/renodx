// Mechanically reconstructed from 0x117D3479.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = (r3) * (r3) + (r1);
    r2 = (-(v6.zzzz)) + (c[7]);
    r0.xyz = (r11.xyz) * (r6.xyz);
    r1 = (r2) * (r2) + (r1);
    r0.xyz = float3(((r5.w) >= 0.0f ? (r5.x) : (r0.x)), ((r5.w) >= 0.0f ? (r5.y) : (r0.y)), ((r5.w) >= 0.0f ? (r5.z) : (r0.z)));
    r5.x = rsqrt(r1.x);
    r5.y = rsqrt(r1.y);
    r5.z = rsqrt(r1.z);
    r5.w = rsqrt(r1.w);
