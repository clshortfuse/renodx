// Mechanically reconstructed from 0x5BB10B00.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xy = (r1.xy) * (r5.ww);
    r0.w = dot(r6.xy, r6.xy) + (c0.z);
    r0.y = dot(r10.xy, r10.xy) + (c0.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c2.x) + (c2.y);
    r2.w = (r0.y) * (c2.x) + (c2.y);
    ...
    r8.y = (r0.w) + (r0.w);
    r0.xyw = c[36].xyw;
    r1.xyz = (-(r0.xyw)) + (c[37].xyw);
    r0.xyz = (r8.xyz) * (r2.www) + (r2.xyz);
    r11.xyz = (r5.www) * (r1.xyz) + (c[36].xyw);
    ...
    r13.xyz = (v0.yyy) * (r0.xyz) + (c0.yyy);
    r2 = tex2D(s0, v1.xy);
    r0.z = dot(v6.xyz, v6.xyz);
    r1.z = rsqrt(r0.z);
    r0.xyz = (r2.xyz) * (-(r13.xyz)) + (r3.xyz);
