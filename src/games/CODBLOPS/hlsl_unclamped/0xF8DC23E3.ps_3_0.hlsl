// Mechanically reconstructed from 0xF8DC23E3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = dot(r7.xyz, c[32].xyz);
    r0.z = saturate((r0.z) * (c[33].x) + (c[33].y));
    r0.z = (r0.z) * (c[33].w);
    r10.x = 1.0f / (r2.w);
    r3.w = lerp(r1.w, r4.w, r0.z);
    r6.xy = saturate((r10.xx) * (c[35].xy) + (c[35].zw));
    r0.xy = (r6.xy) * (r6.xy);
    r6.xy = (r6.xy) * (c2.yy) + (c2.zz);
    r1.w = dot(c[34].yz, r10.xy) + (c[34].x);
    r6.xy = (r0.xy) * (r6.xy);
