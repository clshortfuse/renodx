// Mechanically reconstructed from 0x3B34C30B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = dot(r2.xy, r2.xy) + (c2.y);
    r0.w = dot(r9.xy, r9.xy) + (c2.y);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r0.y = (r0.y) * (c2.z) + (c2.w);
    r0.w = (r0.w) * (c2.z) + (c2.w);
    r1.w = (r0.y) * (r0.w);
    r0.y = dot(r2.xy, r9.xy) + (c2.y);
    r2 = tex2D(s14, v0.zw);
    r7.xy = (r2.xy) * (c3.ww);
