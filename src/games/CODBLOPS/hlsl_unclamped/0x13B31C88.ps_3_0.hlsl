// Mechanically reconstructed from 0x13B31C88.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyz = float3(((-abs(r7.y)) >= 0.0f ? (r1.x) : (r3.x)), ((-abs(r7.y)) >= 0.0f ? (r1.y) : (r3.y)), ((-abs(r7.y)) >= 0.0f ? (r1.z) : (r3.z)));
    r1.xyz = (r1.xyz) * (c[26].xxx);
    r3.xyz = float3(((-abs(r7.z)) >= 0.0f ? (r1.x) : (r3.x)), ((-abs(r7.z)) >= 0.0f ? (r1.y) : (r3.y)), ((-abs(r7.z)) >= 0.0f ? (r1.z) : (r3.z)));
    r0.xyz = (r0.xyz) * (c3.yzw) + (r1.xyz);
    r1.xyz = float3(((-abs(r7.w)) >= 0.0f ? (r0.x) : (r3.x)), ((-abs(r7.w)) >= 0.0f ? (r0.y) : (r3.y)), ((-abs(r7.w)) >= 0.0f ? (r0.z) : (r3.z)));
    r0.xyz = (r0.xyz) * (c12.xxx);
    r3.xy = (v3.xy) * (c[25].xy) + (c[25].zw);
    r3 = tex2D(s1, r3.xy);
    ...
    r0.xyz = (r2.xyz) * (c12.zzz) + (r0.xyz);
    r0.xyz = float3(((c[24].x) >= 0.0f ? (r0.x) : (r2.x)), ((c[24].x) >= 0.0f ? (r0.y) : (r2.y)), ((c[24].x) >= 0.0f ? (r0.z) : (r2.z)));
    r0.w = c3.x;
    r1.x = dot(r0, c[21]);
    r1.y = dot(r0, c[22]);
    r1.z = dot(r0, c[23]);
