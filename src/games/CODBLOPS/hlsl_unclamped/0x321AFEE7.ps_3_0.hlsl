// Mechanically reconstructed from 0x321AFEE7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = dot(r1.xy, r0.zw) + (c12.z);
    r2.x = dot(r1.xy, r0.xy) + (c12.z);
    r0 = tex2D(s1, v0.xy);
    r0.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r1 = tex2D(s3, v7.zw);
    r6.w = (r1.w) * (v7.y);
    r4.xy = lerp(r0.xy, r2.xy, r6.ww);
    r1.w = (r1.w) * (-(v7.y)) + (c12.w);
    r0 = tex2D(s0, v0.xy);
    r3.xyz = lerp(r0.xyz, r1.xyz, r6.www);
    r0.w = (r0.w) * (-(v7.x)) + (c12.w);
    r5.w = (r0.w) * (-(r1.w)) + (c12.w);
    ...
    r1.xy = (r0.wy) * (c6.xx) + (c6.yy);
    r0.y = dot(r4.xy, r4.xy) + (c12.z);
    r0.w = dot(r1.xy, r1.xy) + (c12.z);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r2.w = (r0.y) * (c1.x) + (c1.y);
    r0.y = (r0.w) * (c1.x) + (c1.y);
    r0.w = dot(r1.xy, r4.xy) + (c12.z);
    r0.y = (r2.w) * (r0.y);
    r1 = tex2D(s14, v0.zw);
    r5.xy = (r1.xy) * (c4.ww);
    ...
    r1.z = saturate(dot(r7.xyz, r0.xyz));
    ...
    r0.w = (r0.w) * (r0.y);
    r1.z = (r0.z) * (c3.x) + (c3.y);
    r0.xyz = (r5.xyz) * (r2.www) + (r2.xyz);
    r0.w = (r0.w) * (r1.z);
    r7.w = (r11.y) * (r0.w);
    r10.xyz = (r11.yyy) * (r0.xyz);
    r0 = tex2D(s12, v0.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c12.w) : (c12.z));
