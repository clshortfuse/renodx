// Mechanically reconstructed from 0xDCC3F48D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyw = c[29].xyw;
    r9.xyz = float3(((r5.w) >= 0.0f ? (r3.x) : (c[28].x)), ((r5.w) >= 0.0f ? (r3.y) : (c[28].y)), ((r5.w) >= 0.0f ? (r3.w) : (c[28].w)));
