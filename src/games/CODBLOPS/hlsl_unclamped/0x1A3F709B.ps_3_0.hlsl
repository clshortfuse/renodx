// Mechanically reconstructed from 0x1A3F709B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r16.xy = lerp(r1.xy, r0.xy, r3.ww);
    r1.w = dot(r8.xyz, r8.xyz);
    r0 = v1;
    r0.xyz = (r16.xxx) * (v4.xyz) + (r0.xyz);
    r7.w = rsqrt(r1.w);
    r0.xyz = (r16.yyy) * (v3.xyz) + (r0.xyz);
    ...
    r7.xyz = lerp(r2.yyy, c[36].xyw, r3.www);
    ...
    r6 = tex2D(s13, r5.xy);
    r4.w = r6.y;
    r15.xyz = (r0.xyz) * (c[22].xyz);
    r0.xy = (r4.yw) * (c12.xx) + (c12.yy);
    r2.z = dot(r16.xy, r16.xy) + (c1.w);
    r0.z = dot(r0.xy, r0.xy) + (c1.w);
    r2.z = exp2(-(r2.z));
    r0.z = exp2(-(r0.z));
    r2.z = (r2.z) * (c2.x) + (c2.y);
    r2.y = (r0.z) * (c2.x) + (c2.y);
    r0.z = dot(r0.xy, r16.xy) + (c1.w);
    r0.y = (r2.z) * (r2.y);
    r5 = tex2D(s14, v0.zw);
    r8.xy = (r5.xy) * (c3.ww);
