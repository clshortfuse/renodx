// Mechanically reconstructed from 0x77A4C196.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s2, v6.xy);
    r5.w = (r0.w) * (v0.y) + (c2.w);
    r11.xyz = float3(((r5.w) >= 0.0f ? (r3.x) : (r4.x)), ((r5.w) >= 0.0f ? (r3.y) : (r4.y)), ((r5.w) >= 0.0f ? (r3.z) : (r4.z)));
    r2.z = (r11.z) * (c4.x);
    r2.w = (r11.z) * (-(c13.x)) + (c13.y);
    r3.xyz = v2.xyz;
    r4.xyz = (r11.xxx) * (v4.xyz) + (r3.xyz);
