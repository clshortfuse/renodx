// Mechanically reconstructed from 0x2B7276B8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xy = (r3.zz) * (-(r3.xy)) + (r3.xy);
    r0.xyw = c[5].xyw;
    r1.xyz = (-(r0.xyw)) + (c[6].xyw);
    r0 = tex2D(s4, v8.zw);
    r4.w = (r0.w) * (v0.z);
    r3.xyz = (r3.zzz) * (r1.xyz) + (c[5].xyw);
    r12.xyz = lerp(r4.xyz, r0.xyz, r4.www);
    r0 = tex2D(s8, v8.zw);
    r1 = tex2D(s5, v9.xy);
    r4.xyz = (r1.xyz) + (c1.xxx);
    r1 = lerp(r2, r0, r4.wwww);
    r13.xyz = (v0.www) * (r4.xyz) + (c1.yyy);
    r10.xyz = lerp(r3.xyz, c[7].xyw, r4.www);
    r0.xyz = (r1.xyz) * (r13.xyz);
    ...
    r3 = tex2D(s13, r1.xy);
    r0.w = r3.y;
    r1.xy = (r4.ww) * (-(r6.xy)) + (r6.xy);
    r2.xy = (r0.wy) * (c10.xx) + (c10.yy);
    ...
    r0.y = (r0.z) * (r0.y) + (c11.x);
    r0.z = (r2.w) * (c11.y) + (c11.z);
    r0.y = 1.0f / (r0.y);
    r0.z = (r0.x) * (r0.z);
    r0.y = (r3.w) * (r0.y);
    r7.xz = (r3.xy) * (c3.ww);
