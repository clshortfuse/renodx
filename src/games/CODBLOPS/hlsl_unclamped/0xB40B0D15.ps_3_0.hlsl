// Mechanically reconstructed from 0xB40B0D15.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (-(r1.w)) + (c0.y);
    r1.xyz = (r10.www) * (r1.xyz) + (r8.xyz);
    r3.w = (r1.w) * (r1.w);
    r9.y = saturate(dot(r10.xyz, r4.xyz));
    r3.w = (r3.w) * (r3.w);
    r4.z = (r1.w) * (r3.w);
    r8.xy = float2(((r2.w) >= 0.0f ? (r11.x) : (c0.z)), ((r2.w) >= 0.0f ? (r11.y) : (c0.y)));
    r0 = float4(((r2.w) >= 0.0f ? (r0.x) : (c0.z)), ((r2.w) >= 0.0f ? (r0.y) : (c0.z)), ((r2.w) >= 0.0f ? (r0.z) : (c0.z)), ((r2.w) >= 0.0f ? (r0.w) : (c0.z)));
    r3.w = (r8.x) * (r8.x);
    r2.w = (r8.x) * (-(r8.x)) + (c0.y);
    r8.z = (r8.y) * (c1.y);
    r4.w = (r8.y) * (-(c1.y)) + (c1.z);
    r8.x = saturate(dot(r10.xyz, -(r2.xyz)));
    r1.w = (r11.w) * (r4.w) + (r8.z);
    r8.w = (r8.x) * (r4.w) + (r8.z);
    r1.w = (r1.w) * (r8.w) + (c12.x);
    r4.xy = (r8.yy) * (c4.xy) + (c4.zw);
    r9.z = 1.0f / (r1.w);
    r7.w = exp2(r4.y);
