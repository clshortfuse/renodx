// Mechanically reconstructed from 0xE3200096.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.xz = (r2.ww) * (r1.xz);
    r1.w = (r1.w) + (r1.w);
    r1.xyz = (r2.xyz) * (-(r1.www)) + (r8.xyz);
    r1.w = (r10.x) * (c2.z);
    r1 = texCUBElod(s15, r1);
    r1.xyz = (r1.xyz) * (r1.xyz);
    r1.xyz = (r9.zzz) * (r1.xyz);
    r5.w = saturate(dot(r2.xyz, -(r8.xyz)));
    r8.xyz = (r6.xyz) * (r4.www) + (-(r8.xyz));
    r1.w = (-(r5.w)) + (c1.y);
    r2.w = (r1.w) * (r1.w);
    r6.xy = (r10.xx) * (c12.xy) + (c12.zw);
    r1.w = (r1.w) * (r2.w);
    r2.w = 1.0f / (r6.x);
    r6.w = exp2(r6.y);
    r1.w = (r1.w) * (r2.w);
    ...
    r6.z = saturate(dot(r2.xyz, r6.xyz));
    r2.z = (-(r2.w)) + (c1.y);
    r2.x = pow(abs(r6.z), r6.w);
    r2.y = (r2.z) * (r2.z);
