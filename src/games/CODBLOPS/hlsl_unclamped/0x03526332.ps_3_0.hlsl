// Mechanically reconstructed from 0x03526332.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = rsqrt(r0.w);
    r0.xyz = (v3.xyz) * (-(r0.www)) + (c[17].xyz);
    r2.xyz = normalize(r0.xyz);
    r0.z = saturate(dot(r2.xyz, c[17].xyz));
    r1.w = (-(r0.z)) + (c0.y);
    r7.xyz = (r0.www) * (v3.xyz);
    r1.z = (r1.w) * (r1.w);
    r0 = tex2D(s1, v4.zw);
    ...
    r2.xy = (v0.zw) * (c1.xy);
    r2 = tex2D(s13, r2.xy);
    r4.xy = (v0.zw) * (c1.xy) + (c1.zy);
    r4 = tex2D(s13, r4.xy);
    r2.w = r4.y;
    r8.xy = (r2.yw) * (c2.xx) + (c2.yy);
