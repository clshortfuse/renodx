// Mechanically reconstructed from 0x73B4556B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xy = lerp(r3.xy, r2.xy, r3.ww);
    r1 = tex2D(s8, v1.xy);
    r0 = tex2D(s9, v7.xy);
    r2 = tex2D(s5, v7.zw);
    r2.xyz = (r2.xyz) + (c35.yyy);
    r3.xyz = (v0.zzz) * (r2.xyz) + (c35.www);
    r15.xy = lerp(r1.wy, r0.wy, r3.ww);
    r1.xyz = (r4.xyz) * (r3.xyz);
    r0 = tex2D(s6, v8.xy);
    r2.xyz = (r0.xyz) + (c35.yyy);
    r0.xyz = (r3.xyz) * (c3.xxx);
    r2.xyz = (v0.www) * (r2.xyz) + (c35.www);
    ...
    r1.w = (r1.w) * (r7.w) + (c4.w);
    r2.w = 1.0f / (r1.w);
    r2.xy = (r15.xx) * (c16.xy) + (c16.zw);
    r4.z = exp2(r2.y);
    r2.z = saturate(dot(r10.xyz, r1.xyz));
    r1.w = pow(abs(r2.z), r4.z);
    r4.w = (r4.z) * (c12.x) + (c12.y);
    r1.z = (r6.w) * (r2.w);
    r1.w = (r1.w) * (r4.w);
    r1.w = (r1.z) * (r1.w);
    r0.w = (-(r0.w)) + (c35.w);
    ...
    r1.w = r3.y;
    r3.xy = (r3.xz) * (r0.xx);
    r4.xy = (r1.wy) * (c4.yy) + (c4.zz);
    r1.w = (r2.x) * (c4.x) + (-(r3.x));
    r0.z = dot(r4.xy, r8.xy) + (c35.z);
    r2.w = (r3.z) * (-(r0.x)) + (r1.w);
    r1.xy = (r1.xz) * (r0.yy);
    r0.x = dot(r4.xy, r4.xy) + (c35.z);
    r1.w = (r2.y) * (c4.x) + (-(r1.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r1.z) * (-(r0.y)) + (r1.w);
    r0.x = (r0.x) * (c3.y) + (c3.z);
    ...
    r0.xyz = (r9.xyz) * (r11.www) + (r0.xyz);
    r1.w = (r1.w) + (r1.w);
    r12.xyz = (r15.yyy) * (r0.xyz);
    r0.xyz = (r10.xyz) * (-(r1.www)) + (r6.xyz);
    r0 = texCUBElod(s15, r0);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r2.xyz = (v6.xyz) * (-(r10.www)) + (c[17].xyz);
    r1.xyz = (r15.yyy) * (r0.xyz);
    ...
    r0.xy = (r0.xy) * (r0.xy);
    r0.w = ((-abs(r0.w)) >= 0.0f ? (c35.z) : (r0.z));
    r0.z = (r2.x) * (r0.x);
    r0.w = (r0.w) * (r0.z);
    r0.z = (r0.y) * (-(r2.y)) + (c35.w);
    r0.xy = (r1.zz) * (r1.xy);
    r0.w = (r0.w) * (r0.z);
    r5.w = (r1.w) * (r0.w);
    r0.xy = (r0.xy) * (c15.zz) + (c15.zz);
    r4 = tex2D(s3, r0.xy);
    r3 = (-(v6.yyyy)) + (c[6]);
    r2 = (-(v6.xxxx)) + (c[5]);
    r0 = (r3) * (r3);
