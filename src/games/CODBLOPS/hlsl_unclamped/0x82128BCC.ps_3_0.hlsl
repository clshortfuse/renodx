// Mechanically reconstructed from 0x82128BCC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = (r0.z) + (r0.z);
    r13.yz = c1.yz;
    r3.xyz = float3(((r7.w) >= 0.0f ? (r13.y) : (c[20].x)), ((r7.w) >= 0.0f ? (r13.z) : (c[20].y)), ((r7.w) >= 0.0f ? (r13.y) : (c[20].w)));
    r0.xyz = (r8.xyz) * (r0.www) + (r4.xyz);
    r7.xyz = lerp(r3.xyz, c1.zzz, r5.www);
    ...
    r0.y = (r1.w) * (r0.z) + (r3.z);
    r0.z = (r2.w) * (r0.z) + (r3.z);
    r5.xyz = (v6.xyz) * (-(r0.xxx)) + (c[17].xyz);
    r0.z = (r0.z) * (r0.y) + (c3.x);
    r3.w = 1.0f / (r0.z);
    r0.xyz = normalize(r5.xyz);
    r2.w = (r2.w) * (r3.w);
    r5.z = saturate(dot(r9.xyz, r0.xyz));
    r0.z = saturate(dot(r0.xyz, c[17].xyz));
    r13.xy = (r4.ww) * (c13.xy) + (c13.zw);
    r0.y = exp2(r13.y);
    r0.z = (-(r0.z)) + (c1.z);
    r3.w = pow(abs(r5.z), r0.y);
    r0.x = (r0.z) * (r0.z);
    r0.y = (r0.y) * (c3.y) + (c3.z);
    r0.x = (r0.x) * (r0.x);
    r0.y = (r3.w) * (r0.y);
