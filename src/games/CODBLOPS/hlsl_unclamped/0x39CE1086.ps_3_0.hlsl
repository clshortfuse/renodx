// Mechanically reconstructed from 0x39CE1086.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = rsqrt(r0.z);
    r1.xyz = (r5.xxx) * (v5.xyz);
    r4.xyz = (r3.xyz) * (r0.zzz) + (-(r1.xyz));
    ...
    r2.z = (-(r0.x)) + (c0.z);
    r0.x = pow(abs(r2.w), r5.w);
    r2.y = (r2.z) * (r2.z);
    r2.w = (r5.w) * (c12.x) + (c12.y);
    r2.y = (r2.y) * (r2.y);
    r0.x = (r0.x) * (r2.w);
    r2.z = (r2.z) * (r2.y);
    r0.x = (r3.w) * (r0.x);
    ...
    r0.x = (r0.x) * (r2.z);
    r3.w = (r0.w) * (c1.x) + (c1.y);
    r0.w = saturate((r3.z) * (c[31].x) + (c[31].y));
    r2.y = dot(r1.xyz, r9.xyz);
    r2.z = (r0.w) * (c13.z) + (c13.w);
    r2.y = (r2.y) + (r2.y);
    r0.w = (r0.w) * (r0.w);
    r1.xyz = (r9.xyz) * (-(r2.yyy)) + (r1.xyz);
    r1 = texCUBElod(s15, r1);
    r1.xyz = (r1.xyz) * (r1.xyz);
    r6.w = (r2.z) * (r0.w);
    r3.xyz = (r1.xyz) * (c0.xxx);
    r1 = tex3D(s11, v6.xyz);
    r4.xyz = (v5.xyz) * (-(r5.xxx)) + (c[17].xyz);
    r2.xyz = normalize(r4.xyz);
    ...
    r1 = (v5.xxxx) * (c[32]) + (r1);
    r7.xyz = (r6.xyz) * (r0.yyy) + (r2.xyz);
    r1 = (v5.zzzz) * (c[34]) + (r1);
    r2.xyz = (r0.xxx) * (c[23].xyz);
    r3 = (r1) + (c[35]);
