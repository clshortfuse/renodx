// Mechanically reconstructed from 0x0C4B32EF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.xyz = (r1.www) * (v7.xyz);
    r3.y = saturate(dot(r11.xyz, r1.xyz));
    r7.w = saturate(dot(r11.xyz, -(r12.xyz)));
    r1 = tex2D(s3, v1.xy);
    r9.xyz = (r1.xyz) * (-(r1.xyz)) + (c4.xxx);
    r0.z = (r1.w) * (-(c4.y)) + (c4.x);
    r0.x = (r1.w) * (c4.y);
    r10.xyz = (r1.xyz) * (r1.xyz);
    r0.y = (r7.w) * (r0.z) + (r0.x);
    r15.xy = (r1.ww) * (c7.xy) + (c7.zw);
