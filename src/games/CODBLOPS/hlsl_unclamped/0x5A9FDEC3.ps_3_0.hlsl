// Mechanically reconstructed from 0x5A9FDEC3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c25 = float4(2.0f, -1.0f, 0.0f, -0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = (c25.xxxx) * (v8) + (c25.yyyy);
    r3.y = dot(r1.xy, r0.zw) + (c25.z);
    r3.x = dot(r1.xy, r0.xy) + (c25.z);
    r0 = tex2D(s6, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c25.xxxx) * (v9) + (c25.yyyy);
    r7.y = dot(r1.xy, r0.zw) + (c25.z);
    r7.x = dot(r1.xy, r0.xy) + (c25.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r7.z = (r0.w) * (v0.y);
    r2 = tex2D(s1, v1.xy);
    ...
    r0 = tex2D(s8, v7.xy);
    r3 = (r0.wwww) * (-(c25.zzzy)) + (-(c25.wwwz));
    r4 = tex2D(s7, v1.xy);
    r1 = tex2D(s4, v7.zw);
    r7.w = (r1.w) * (v0.z) + (c3.x);
    r2 = lerp(r4, r3, r7.zzzz);
    r3.xyz = float3(((r7.w) >= 0.0f ? (r1.x) : (r6.x)), ((r7.w) >= 0.0f ? (r1.y) : (r6.y)), ((r7.w) >= 0.0f ? (r1.z) : (r6.z)));
    r7.xy = float2(((r7.w) >= 0.0f ? (r7.x) : (r8.x)), ((r7.w) >= 0.0f ? (r7.y) : (r8.y)));
    r4.xyz = lerp(c[23].xyw, r0.yyy, r7.zzz);
    r1 = tex2D(s9, v7.zw);
    r0 = (r1.wwww) * (-(c25.zzzy)) + (-(c25.wwwz));
    r0 = float4(((r7.w) >= 0.0f ? (r0.x) : (r2.x)), ((r7.w) >= 0.0f ? (r0.y) : (r2.y)), ((r7.w) >= 0.0f ? (r0.z) : (r2.z)), ((r7.w) >= 0.0f ? (r0.w) : (r2.w)));
    r13.xyz = float3(((r7.w) >= 0.0f ? (r1.y) : (r4.x)), ((r7.w) >= 0.0f ? (r1.y) : (r4.y)), ((r7.w) >= 0.0f ? (r1.y) : (r4.z)));
    r11.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c25.yyy));
    r12.xyz = (r0.xyz) * (r0.xyz);
    r0.xyz = (r11.xyz) * (r6.www) + (r12.xyz);
    r1.w = dot(r7.xy, r7.xy) + (c25.z);
    ...
    r3.xy = (r3.xz) * (r8.xx);
    r1.w = dot(r9.xy, r7.xy) + (c25.z);
    r1.y = (r2.x) * (c12.x) + (-(r3.x));
    r2.w = (r3.z) * (-(r8.x)) + (r1.y);
    r4.xy = (r1.xz) * (r8.yy);
    r1.y = (r2.y) * (c12.x) + (-(r4.x));
    r1.x = dot(r9.xy, r9.xy) + (c25.z);
    r1.y = (r1.z) * (-(r8.y)) + (r1.y);
    r1.z = exp2(-(r1.x));
    r10.y = (r2.w) + (r2.w);
    r1.z = (r1.z) * (c3.y) + (c3.z);
    ...
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (-(c25.y)) : (-(c25.z)));
