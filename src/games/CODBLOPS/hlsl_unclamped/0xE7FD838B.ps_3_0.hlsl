// Mechanically reconstructed from 0xE7FD838B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s4, v8.xy);
    r8.w = (r1.w) * (v0.y);
    r6.xyz = (v0.zzz) * (r2.xyz) + (c12.xxx);
    r8.xy = (r8.ww) * (-(r0.xy)) + (r0.xy);
    r2.xyz = (r6.xyz) * (c12.zzz);
    r0 = v2;
    ...
    r2.w = dot(r8.xy, r8.xy) + (c12.w);
    r2.y = dot(r3.xy, r3.xy) + (c12.w);
    r2.w = exp2(-(r2.w));
    r2.y = exp2(-(r2.y));
    r2.w = (r2.w) * (c1.x) + (c1.y);
    r3.w = (r2.y) * (c1.x) + (c1.y);
    r2.y = dot(r3.xy, r8.xy) + (c12.w);
    r4.w = (r2.w) * (r3.w);
    r3 = tex2D(s14, v1.zw);
    r13.xy = (r3.xy) * (c2.ww);
