// Mechanically reconstructed from 0x0DE4D5FF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = tex2D(s14, v1.zw);
    r6.xy = (r3.xy) * (c10.xx);
    r9.xy = (r4.yw) * (c10.yy) + (c10.zz);
    r4.xy = (r4.xz) * (r6.xx);
    r1.w = dot(r9.xy, r7.xy) + (c15.z);
    r2.w = (r3.x) * (c10.x) + (-(r4.x));
    r2.y = (r4.z) * (-(r6.x)) + (r2.w);
    r8.xy = (r2.xz) * (r6.yy);
    r2.x = (r3.y) * (c10.x) + (-(r8.x));
    r2.w = dot(r9.xy, r9.xy) + (c15.z);
    r2.z = (r2.z) * (-(r6.y)) + (r2.x);
    r2.w = exp2(-(r2.w));
    r6.y = (r2.y) + (r2.y);
    r2.w = (r2.w) * (c3.y) + (c3.z);
