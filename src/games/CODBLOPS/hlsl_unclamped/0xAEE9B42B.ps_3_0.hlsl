// Mechanically reconstructed from 0xAEE9B42B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.x = dot(r4.xy, r1.xy) + (c14.z);
    r2.y = dot(r4.xy, r1.zw) + (c14.z);
    r1 = tex2D(s4, v6.zw);
    r5.w = (r1.w) * (v6.y);
    r8.xy = (r0.yw) * (c3.xx) + (c3.yy);
    r4.xy = lerp(r7.xy, r2.xy, r5.ww);
    ...
    r11.zw = c14.zw;
    r0.xyz = (r11.zwz) + (-(c[36].xyw));
    r1.w = (r1.w) + (r1.w);
    r11.xyz = (r5.www) * (r0.xyz) + (c[36].xyw);
    r2.xyz = (r10.xyz) * (-(r1.www)) + (r12.xyz);
    r3 = tex2D(s6, v0.xy);
    r2.w = (r3.w) * (c1.z);
