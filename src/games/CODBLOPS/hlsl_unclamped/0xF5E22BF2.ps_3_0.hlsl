// Mechanically reconstructed from 0xF5E22BF2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.z = (r1.w) * (v7.y) + (c1.x);
    r9.y = (r2.w) * (r2.z);
    r2 = float4(((r9.z) >= 0.0f ? (r0.x) : (c1.z)), ((r9.z) >= 0.0f ? (r0.y) : (c1.z)), ((r9.z) >= 0.0f ? (r0.z) : (c1.z)), ((r9.z) >= 0.0f ? (r0.w) : (c1.y)));
    r6.xyz = normalize(v6.xyz);
    r0 = v1;
    r5.xyz = (r2.xxx) * (v4.xyz) + (r0.xyz);
    r0.xyz = (r7.xyz) * (r4.www) + (-(r6.xyz));
    r7.xyz = (r2.yyy) * (v3.xyz) + (r5.xyz);
    r5.xyz = normalize(r0.xyz);
    r0.xyz = normalize(r7.xyz);
    r4.w = saturate(dot(r0.xyz, r5.xyz));
    r3.z = saturate(dot(r5.xyz, r4.xyz));
    ...
    r5.xyz = (r9.yyy) * (r4.xyz);
    r2.xyz = (r8.www) * (r2.xyz);
    r1.w = (r2.w) * (c2.z);
    r4.xyz = (r9.yyy) * (r7.xyz) + (r2.xyz);
    r2 = tex2D(s0, v0.xy);
    r2.w = dot(r6.xyz, r0.xyz);
    r2.w = (r2.w) + (r2.w);
    r2.xyz = float3(((r9.z) >= 0.0f ? (r1.x) : (r2.x)), ((r9.z) >= 0.0f ? (r1.y) : (r2.y)), ((r9.z) >= 0.0f ? (r1.z) : (r2.z)));
