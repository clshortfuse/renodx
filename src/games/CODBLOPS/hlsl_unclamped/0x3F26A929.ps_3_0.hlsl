// Mechanically reconstructed from 0x3F26A929.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xyz = v3.xyz;
    r4.xyz = (r1.zxy) * (v0.yzx);
    r3.xy = (c[34].xx) * (r3.xy) + (r5.xy);
    r1.xyz = (r1.yzx) * (v0.zxy) + (-(r4.xyz));
