// Mechanically reconstructed from 0xADC6FD4C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    float4 v5 = input.v5;
    float4 v6 = input.v6;
    const float4 c0 = float4(-1.0f, 0.0f, 0.200000003f, 1.0f);
    ...
    r2 = tex2D(s3, v6.zw);
    r2.yzw = (r2.wyy) + (c0.xyx);
    r9.xyz = normalize(r0.xyz);
    r11.xy = (r10.ww) * (r2.yw) + (c0.ww);
    ...
    r1.w = dot(r8.xy, r8.xy) + (c0.y);
    r2.w = dot(r4.xy, r4.xy) + (c0.y);
    r1.w = exp2(-(r1.w));
    r2.w = exp2(-(r2.w));
    r1.w = (r1.w) * (c2.x) + (c2.y);
    r2.z = (r2.w) * (c2.x) + (c2.y);
    r2.w = dot(r4.xy, r8.xy) + (c0.y);
    r2.z = (r1.w) * (r2.z);
    r4 = tex2D(s14, v0.zw);
    r10.xy = (r4.xy) * (c3.ww);
