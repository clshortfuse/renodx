// Mechanically reconstructed from 0xE2D5AD56.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = float4(((r5.w) >= 0.0f ? (r1.x) : (c1.z)), ((r5.w) >= 0.0f ? (r1.y) : (c1.z)), ((r5.w) >= 0.0f ? (r1.z) : (c1.z)), ((r5.w) >= 0.0f ? (r1.w) : (c1.y)));
    ...
    r1.y = (r1.y) * (r2.w) + (c4.x);
    r8.w = ((r5.w) >= 0.0f ? (r2.y) : (c1.z));
    r1.y = 1.0f / (r1.y);
    r9.z = (-(r1.x)) + (c1.y);
    r2.w = (r1.z) * (r1.y);
    r6.xyz = (r1.zzz) * (c[6].xyz);
    r2.xyz = (r5.xyz) * (r4.www) + (-(r8.xyz));
    r9.x = 1.0f / (r4.w);
    ...
    r1.y = (r6.w) * (r1.y) + (r7.w);
    r1.z = (r1.z) * (r1.y);
    r2.xy = saturate((r9.xx) * (c[9].xy) + (c[9].zw));
    r1.xy = (r2.xy) * (r2.xy);
