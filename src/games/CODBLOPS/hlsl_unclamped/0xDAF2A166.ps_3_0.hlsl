// Mechanically reconstructed from 0xDAF2A166.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.x = 1.0f / (r1.w);
    r2.w = dot(r1.xyz, c[31].xyz);
    r1.w = saturate(dot(r1.xyz, r7.xyz));
    r1.z = saturate((r2.w) * (c[32].x) + (c[32].y));
    r3.w = (r1.z) * (c[32].w);
    r2.xy = saturate((r3.xx) * (c[34].xy) + (c[34].zw));
    r1.xy = (r2.xy) * (r2.xy);
    r2.xy = (r2.xy) * (c0.xx) + (c0.yy);
    r1.z = dot(c[33].yz, r3.xy) + (c[33].x);
    r2.xy = (r1.xy) * (r2.xy);
    r2.w = lerp(r0.w, r3.z, r3.w);
    r0.w = (r1.z) * (r2.x);
