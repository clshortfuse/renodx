// Mechanically reconstructed from 0xF50FBE14.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s13, r0.xy);
    r2.w = r1.y;
    r0.xy = (r2.yw) * (c0.yy) + (c0.zz);
    r0.w = dot(r0.xy, r0.xy) + (c2.w);
    r1.w = exp2(-(r0.w));
    r0 = tex2D(s14, v0.zw);
    r4.xy = (r0.xy) * (c0.xx);
    ...
    r2.xy = (r1.xy) * (r1.xy);
    r3.xy = (r1.xy) * (c1.zz) + (c1.ww);
    r1.xyz = (-(v3.xyz)) + (c[20].xyz);
    r2.w = (r2.x) * (r3.x);
    r4.xyz = normalize(r1.xyz);
    r1.x = (r2.y) * (-(r3.y)) + (c2.y);
    r1.z = dot(r4.xyz, c[28].xyz);
    r0.w = (r0.w) * (r2.w);
