// Mechanically reconstructed from 0x5C09FEBC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = lerp(r1.xyz, r0.xyz, r4.www);
    r2 = tex2D(s6, v1.xy);
    r0 = tex2D(s7, v8.xy);
    r3.w = dot(v7.xyz, v7.xyz);
    r1 = lerp(r2, r0, r4.wwww);
    r5.w = rsqrt(r3.w);
    r10.xy = (r4.ww) * (-(r3.xy)) + (r3.xy);
    ...
    r0.z = (r0.z) * (r0.y) + (c10.x);
    r0.y = (r2.w) * (c10.y) + (c10.z);
    r0.z = 1.0f / (r0.z);
    r2.w = (r0.x) * (r0.y);
    r5.w = (r3.z) * (r0.z);
    r3.xyw = c[5].xyw;
    ...
    r2.w = (r2.w) * (r5.w);
    r10.xyz = (r4.www) * (r0.xyz) + (c[5].xyw);
    r0.xyz = (r4.xyz) * (r2.www);
    r15.xyz = (r2.xyz) * (r10.yyy);
