// Mechanically reconstructed from 0x4CB1FD60.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xy = (c[25].zz) * (r1.xy) + (r0.xy);
    r1.z = c1.y;
    r0 = tex2D(s0, v1.xy);
    r3.z = (r0.w) * (v0.w) + (c1.x);
    r2.xy = (r3.xy) * (r3.xy);
    r7.xyz = float3(((r3.z) >= 0.0f ? (r1.x) : (c1.z)), ((r3.z) >= 0.0f ? (r1.y) : (c1.z)), ((r3.z) >= 0.0f ? (r1.z) : (c1.z)));
