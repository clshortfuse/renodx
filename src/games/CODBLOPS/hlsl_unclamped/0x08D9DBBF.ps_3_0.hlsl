// Mechanically reconstructed from 0x08D9DBBF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = dot(r5.xy, r5.xy) + (c2.z);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c3.y) + (c3.z);
    r2.w = (r0.y) * (c3.y) + (c3.z);
    r0.y = (r0.w) * (r2.w);
    r0.w = dot(r1.xy, r5.xy) + (c2.z);
    r1 = tex2D(s14, v1.zw);
    r7.xy = (r1.xy) * (c4.xx);
    ...
    r7.xy = (r4.ww) * (r0.xy) + (r1.yy);
    r0.z = dot(r2.xyz, r8.xyz);
    r0.w = (r1.w) * (c3.w);
    r0.z = (r0.z) + (r0.z);
    r1.w = (r1.w) * (c12.x) + (c12.y);
    r0.xyz = (r8.xyz) * (-(r0.zzz)) + (r2.xyz);
    ...
    r1.w = (r0.w) * (r0.w);
    r10.xyz = (v0.zzz) * (r1.xyz) + (c2.www);
    r0.w = (r0.w) * (r1.w);
    r1.xyz = (r10.xyz) * (c3.xxx);
    r0.w = (r3.w) * (r0.w);
    r5.xyz = (r1.xyz) * (-(r1.xyz)) + (c2.www);
