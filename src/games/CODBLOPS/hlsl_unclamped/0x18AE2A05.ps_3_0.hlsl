// Mechanically reconstructed from 0x18AE2A05.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xy = float2(((r5.w) >= 0.0f ? (r2.x) : (r4.x)), ((r5.w) >= 0.0f ? (r2.y) : (r4.y)));
    r1 = tex2D(s9, v7.xy);
    ...
    r1.w = dot(r4.xy, r8.xy) + (c3.z);
    r3.w = (r4.z) * (-(r6.x)) + (r1.x);
    r2.xy = (r2.xz) * (r6.yy);
    r1.x = dot(r4.xy, r4.xy) + (c3.z);
    r2.w = (r3.y) * (c12.w) + (-(r2.x));
    r1.x = exp2(-(r1.x));
    r2.w = (r2.z) * (-(r6.y)) + (r2.w);
    ...
    r1.z = (r1.w) * (r1.w);
    r13.xyz = float3(((r5.w) >= 0.0f ? (r1.y) : (c[39].x)), ((r5.w) >= 0.0f ? (r1.y) : (c[39].y)), ((r5.w) >= 0.0f ? (r1.y) : (c[39].w)));
    r1.z = (r1.z) * (r1.z);
