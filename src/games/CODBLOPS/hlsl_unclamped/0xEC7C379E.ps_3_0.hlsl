// Mechanically reconstructed from 0xEC7C379E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r1.w) * (r2.w);
    r2.xyw = c[24].xyw;
    r13.xyz = float3(((r5.w) >= 0.0f ? (r2.x) : (c[23].x)), ((r5.w) >= 0.0f ? (r2.y) : (c[23].y)), ((r5.w) >= 0.0f ? (r2.w) : (c[23].w)));
