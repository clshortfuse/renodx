// Mechanically reconstructed from 0x384A0FD6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xy = saturate((r1.xx) * (c[33].xy) + (c[33].zw));
    r7.xy = (c[36].zz) * (r7.xy) + (r0.xy);
    r1.z = dot(c[32].yz, r1.xy) + (c[32].x);
    r0 = v2;
    ...
    r2.w = (r1.w) * (c0.y);
    r6.xyz = (r1.xyz) * (c[35].www);
    r1 = tex2D(s7, v1.xy);
    r6.xyz = (r6.xyz) * (r1.www);
    r6.xyz = (r6.xyz) * (c[31].xyz);
    r11.xyz = (r11.xyz) * (c[35].yyy);
