// Mechanically reconstructed from 0x71A46F76.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.z = (r0.w) * (v0.w) + (c1.x);
    r0.w = (r1.z) * (r1.z);
    r4.xy = float2(((r4.z) >= 0.0f ? (r4.x) : (c1.z)), ((r4.z) >= 0.0f ? (r4.y) : (c1.z)));
    r5.w = (r1.w) * (r0.w);
    r1 = v2;
    ...
    r8.y = saturate(dot(r15.xyz, c[17].xyz));
    r12.xyz = (r0.xyz) * (c3.xxx);
    r11.xyz = (r8.yyy) * (c[18].xyz);
    if ((c1.y) >= (v6.w))
    {
        r3 = (v6.xyzx) * (c1.yyyz);
        r2 = (r3) + (-(c13.xyzz));
