// Mechanically reconstructed from 0x885B24E9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = dot(r5.xy, r0.xy) + (c14.z);
    r1.y = dot(r5.xy, r0.zw) + (c14.z);
    r0 = tex2D(s4, v7.zw);
    r6.w = (r0.w) * (v7.y);
    r1.w = saturate(dot(r3.xyz, r4.xyz));
    r10.xy = lerp(r2.xy, r1.xy, r6.ww);
    r3.w = (-(r1.w)) + (c14.w);
    r1.xyz = v1.xyz;
    ...
    r3.xyz = (r7.xyz) * (r8.xyz) + (r1.xyz);
    r1 = tex2D(s0, v0.xy);
    r7.xyz = lerp(r1.xyz, r0.xyz, r6.www);
    r1.w = (r1.w) * (-(v7.x)) + (c14.w);
    r2.w = (r0.w) * (-(v7.y)) + (c14.w);
