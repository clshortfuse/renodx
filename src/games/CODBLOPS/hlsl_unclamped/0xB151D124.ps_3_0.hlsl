// Mechanically reconstructed from 0xB151D124.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s3, v7.xy);
    r8.w = (r0.w) * (v0.y);
    r6.xyz = lerp(r1.xyz, r0.xyz, r8.www);
    r7.xy = lerp(r3.xy, r2.xy, r8.ww);
    r1 = tex2D(s8, v7.xy);
    r0 = (r1.wwww) * (-(c20.zzzy)) + (-(c20.wwwz));
    r3 = tex2D(s7, v1.xy);
    r2 = lerp(r3, r0, r8.wwww);
    r0 = tex2D(s4, v7.zw);
    r5.w = (r0.w) * (v0.z);
    r5.xyz = lerp(c[8].xyw, r1.yyy, r8.www);
    r3.xyz = lerp(r6.xyz, r0.xyz, r5.www);
    r1 = tex2D(s9, v7.zw);
    r0 = tex2D(s5, v8.xy);
    r6.xyz = (r0.xyz) + (c20.yyy);
    r0 = lerp(r2, r1, r5.wwww);
    r1.xyz = (v0.www) * (r6.xyz) + (-(c20.yyy));
    r11.xyz = lerp(r5.xyz, c[9].xyw, r5.www);
    r0.xyz = (r0.xyz) * (r1.xyz);
    r9.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c20.yyy));
    r10.xyz = (r0.xyz) * (r0.xyz);
    r0.xyz = (r9.xyz) * (r6.www) + (r10.xyz);
    r5.xy = (r5.ww) * (-(r7.xy)) + (r7.xy);
    ...
    r1.y = dot(r5.xy, r5.xy) + (c20.z);
    r1.w = dot(r2.xy, r2.xy) + (c20.z);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r3.w = (r1.y) * (c3.x) + (c3.y);
    r1.y = (r1.w) * (c3.x) + (c3.y);
    r1.w = dot(r2.xy, r5.xy) + (c20.z);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c4.ww);
