// Mechanically reconstructed from 0x015A732D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r1.x) * (r1.z);
    r1.x = dot(r5.xy, r3.xy) + (c1.z);
    r2.xy = (r10.xx) * (r2.xz);
    r2.w = saturate((r1.x) * (r2.w) + (r2.w));
    r1.x = (r4.x) * (c3.w) + (-(r2.x));
    r5.xyz = (r9.xyz) * (r2.www);
    r1.x = (r2.z) * (-(r10.x)) + (r1.x);
    r4.xz = (r2.xy) * (c4.xx);
    r4.y = (r1.x) + (r1.x);
