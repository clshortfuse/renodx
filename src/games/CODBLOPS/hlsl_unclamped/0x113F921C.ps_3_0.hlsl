// Mechanically reconstructed from 0x113F921C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s8, v6.xy);
    r11.xyz = lerp(c[34].xyw, r0.yyy, r6.www);
    r2 = (r0.wwww) * (-(c15.zzzy)) + (-(c15.wwwz));
    ...
    r3 = tex2D(s0, v1.xy);
    r4 = tex2D(s4, v6.zw);
    r7.xyz = (r4.xyz) + (c15.yyy);
    r4.xyz = lerp(r3.xyz, r1.xyz, r6.www);
    r14.xyz = (v0.zzz) * (r7.xyz) + (-(c15.yyy));
    r1 = tex2D(s5, v7.xy);
    r3.xyz = (r1.xyz) + (c15.yyy);
    r1.xyz = (r4.xyz) * (r14.xyz);
    r13.xyz = (v0.www) * (r3.xyz) + (-(c15.yyy));
    r3.xyz = (r0.zzz) * (c[18].xyz);
    ...
    r4.w = rsqrt(r0.w);
    r15.xyz = (v5.xyz) * (-(r4.www)) + (c[17].xyz);
