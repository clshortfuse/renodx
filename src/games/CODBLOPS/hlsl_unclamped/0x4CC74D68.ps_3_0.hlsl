// Mechanically reconstructed from 0x4CC74D68.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(0.959999979f, 0.0399999991f, 31.875f, 4.0f);
    const float4 c3 = float4(4.0f, -2.0f, 0.0f, 0.0f);
    const float4 c4 = float4(1.0f, 0.0f, 0.600000024f, 0.400000006f);
    const float4 c7 = float4(1.0f, 0.5f, 0.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r5.xy = (r1.ww) * (-(r4.xy)) + (r4.xy);
    r0.y = dot(r2.xy, r2.xy) + (c4.y);
    r0.w = dot(r5.xy, r5.xy) + (c4.y);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r0.y = (r0.y) * (c4.z) + (c4.w);
    r0.w = (r0.w) * (c4.z) + (c4.w);
    r3.w = (r0.y) * (r0.w);
    r0.y = dot(r2.xy, r5.xy) + (c4.y);
    r2 = tex2D(s14, v1.zw);
    r6.xy = (r2.xy) * (c2.zz);
    ...
    r4.w = lerp(r3.y, c4.x, r1.w);
    r2.w = (r2.w) + (r2.w);
    r2.xyz = (r0.xyz) * (-(r2.www)) + (r5.xyz);
