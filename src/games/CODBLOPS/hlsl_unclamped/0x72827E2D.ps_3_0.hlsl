// Mechanically reconstructed from 0x72827E2D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xyz = (r11.xyz) * (c[36].yyy);
    r3.w = dot(r8.xyz, r9.xyz);
    r1.xyz = (r2.www) * (r1.xyz);
    r2.w = (r3.w) + (r3.w);
    r3.xyz = (r1.xyz) * (c0.zzz);
    r1.xyz = (r9.xyz) * (-(r2.www)) + (r8.xyz);
    r1 = texCUBElod(s15, r1);
    r1.xyz = (r1.xyz) * (r1.xyz);
    r4.xyz = (r4.xyz) * (r7.xyz) + (r3.xyz);
