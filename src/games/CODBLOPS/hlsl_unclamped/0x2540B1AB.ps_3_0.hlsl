// Mechanically reconstructed from 0x2540B1AB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s13, r2.xy);
    r0.w = r2.y;
    r4.xyz = float3(((r10.w) >= 0.0f ? (r1.x) : (r4.x)), ((r10.w) >= 0.0f ? (r1.y) : (r4.y)), ((r10.w) >= 0.0f ? (r1.z) : (r4.z)));
    r1.xy = (r0.wy) * (c12.xx) + (c12.yy);
    r0.w = dot(r5.xy, r5.xy) + (c4.x);
    r0.y = dot(r1.xy, r1.xy) + (c4.x);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c11.x) + (c11.y);
    r1.w = (r0.y) * (c11.x) + (c11.y);
    r0.y = dot(r1.xy, r5.xy) + (c4.x);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v1.zw);
    r6.xy = (r1.xy) * (c11.ww);
    r1.w = saturate((r0.y) * (r2.w) + (r2.w));
    r2.xy = (r2.xz) * (r6.xx);
    r0.y = (r1.x) * (c11.w) + (-(r2.x));
    r7.xy = (r0.xz) * (r6.yy);
    r0.y = (r2.z) * (-(r6.x)) + (r0.y);
    r0.x = (r1.y) * (c11.w) + (-(r7.x));
    r0.z = (r0.z) * (-(r6.y)) + (r0.x);
    r6.y = (r0.y) + (r0.y);
    r0.y = (r0.z) + (r0.z);
    r0.xz = (r7.xy) * (c10.ww);
    ...
    r0 = tex2D(s6, v1.xy);
    r1.w = ((r3.w) >= 0.0f ? (c3.w) : (r0.y));
    r0.xyz = v2.xyz;
    r0.xyz = (r5.xxx) * (v4.xyz) + (r0.xyz);
    r8.xyz = float3(((r10.w) >= 0.0f ? (c[8].x) : (r1.w)), ((r10.w) >= 0.0f ? (c[8].y) : (r1.w)), ((r10.w) >= 0.0f ? (c[8].w) : (r1.w)));
    r0.xyz = (r5.yyy) * (v3.xyz) + (r0.xyz);
    r11.xyz = (r1.xyz) * (r8.yyy);
    r9.xyz = normalize(r0.xyz);
    r8.w = saturate(dot(r9.xyz, r3.xyz));
    r7.w = saturate(dot(r9.xyz, c[17].xyz));
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c4.y) : (c4.x));
    r10.xyz = (r7.www) * (c[18].xyz);
    if ((r0.z) != (-(r0.z)))
    {
        r0.z = r1.y;
        r2.w = r0.z;
    ...
    r0 = tex2D(s7, v7.zw);
    r0 = float4(((r10.w) >= 0.0f ? (r0.x) : (r1.x)), ((r10.w) >= 0.0f ? (r0.y) : (r1.y)), ((r10.w) >= 0.0f ? (r0.z) : (r1.z)), ((r10.w) >= 0.0f ? (r0.w) : (r1.w)));
    r1.xyz = (r0.xyz) * (-(r0.xyz)) + (c3.www);
    r5.xyz = (r0.xyz) * (r0.xyz);
    r0.y = (r0.w) * (-(c12.z)) + (c12.w);
    r12.xy = (r0.ww) * (c14.xy) + (c14.zw);
    r2.z = exp2(r12.y);
    ...
    r0.z = (r7.w) * (r0.y) + (r0.x);
    r0.y = (r1.w) * (r0.y) + (r0.x);
    r0.x = pow(abs(r8.w), r2.z);
    r0.z = (r0.z) * (r0.y) + (c13.x);
    r0.y = (r2.z) * (c13.y) + (c13.z);
    r0.z = 1.0f / (r0.z);
    r2.z = (r0.x) * (r0.y);
    r2.y = (r7.w) * (r0.z);
    r0.xyz = (r1.xyz) * (r6.www) + (r5.xyz);
    r2.z = (r2.z) * (r2.y);
