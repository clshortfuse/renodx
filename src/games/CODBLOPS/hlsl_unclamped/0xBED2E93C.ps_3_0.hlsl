// Mechanically reconstructed from 0xBED2E93C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xy = (c[28].zz) * (r1.xy) + (r0.xy);
    r1 = tex2D(s6, v1.xy);
    r2.xy = (v1.xy) + (c1.xx);
    r2.z = c1.y;
    r0.xy = (r2.xy) * (c[33].xx) + (r2.zz);
    r0 = tex2D(s4, r0.xy);
    r7.w = (v7.w) * (c1.z) + (-(r0.x));
    ...
    r0.w = dot(c[25].yz, r11.xy) + (c[25].x);
    r3.xy = saturate((r11.xx) * (c[26].xy) + (c[26].zw));
    r2.xy = (r3.xy) * (r3.xy);
