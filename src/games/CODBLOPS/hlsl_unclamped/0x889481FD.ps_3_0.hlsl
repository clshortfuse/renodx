// Mechanically reconstructed from 0x889481FD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(1.0f, 0.0f, -1.0f, 0.25f);
    ...
    r3.z = dot(r0, c2.wwww);
    r4.xy = (c[29].zz) * (r3.xy) + (r1.xy);
    r1 = tex2D(s8, v1.xy);
    r8.xy = (v1.xy) + (c1.xx);
    r5.w = c1.y;
    r0.xy = (r8.xy) * (c[31].xx) + (r5.ww);
    r0 = tex2D(s6, r0.xy);
    r3.w = (v6.w) * (c1.z) + (-(r0.x));
    r1.xy = (r1.wy) * (c0.xy) + (c0.zw);
    r4.w = saturate((r3.w) * (c1.w));
    r0.w = (r3.z) + (c2.z);
