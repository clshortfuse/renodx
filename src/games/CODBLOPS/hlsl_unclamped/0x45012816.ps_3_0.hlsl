// Mechanically reconstructed from 0x45012816.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.y = dot(r1.xy, r0.zw) + (c16.z);
    r5.x = dot(r1.xy, r0.xy) + (c16.z);
    r0 = tex2D(s6, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    ...
    r6.xy = lerp(r7.xy, r5.xy, r1.ww);
    r0 = tex2D(s4, v7.zw);
    r3.w = (r0.w) * (v0.z);
    r1.xyz = lerp(r2.xyz, r0.xyz, r3.www);
    r0.zw = c16.zw;
    r0.xyz = (r0.zwz) + (-(c[8].xyw));
    r5.xy = lerp(r6.xy, r3.xy, r3.ww);
    r3.xyz = (r1.www) * (r0.xyz) + (c[8].xyw);
    ...
    r2 = tex2D(s13, r2.xy);
    r0.w = r2.y;
    r11.xyz = (r3.www) * (r1.xwz) + (r3.xyz);
    r1.xy = (r0.wy) * (c10.xx) + (c10.yy);
    r0.y = dot(r5.xy, r5.xy) + (c16.z);
    r0.w = dot(r1.xy, r1.xy) + (c16.z);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r3.w = (r0.y) * (c3.x) + (c3.y);
    r0.y = (r0.w) * (c3.x) + (c3.y);
    r0.w = dot(r1.xy, r5.xy) + (c16.z);
    r0.y = (r3.w) * (r0.y);
    r1 = tex2D(s14, v1.zw);
    r6.xy = (r1.xy) * (c4.ww);
    ...
    r7.xz = (r2.xy) * (c10.xx);
    r2.z = saturate(dot(r12.xyz, r4.xyz));
    r0 = tex2D(s7, v1.xy);
    r9.xyz = (r0.xyz) * (-(r0.xyz)) + (c16.www);
    ...
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c16.w) : (c16.z));
