// Mechanically reconstructed from 0xA695DB9A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.w = (r0.w) * (-(c0.w)) + (c0.y);
    r8.w = (r0.w) * (c0.w);
    r6.y = saturate(dot(r1.xyz, r3.xyz));
    ...
    r1.xy = c0.xy;
    r1.xyz = (r1.xyx) + (-(c[29].xyw));
    r7.xyz = (r5.xyz) * (r5.xyz);
    r9.xyz = (r1.www) * (r1.xyz) + (c[29].xyw);
    r2.xyz = (r0.xyz) * (r9.zzz);
    r0.z = dot(r4.xyz, r3.xyz);
    r1.xyz = (r6.yyy) * (c[6].xyz);
    r0.z = (r0.z) + (r0.z);
    r0.w = (r0.w) * (c0.z);
    r0.xyz = (r3.xyz) * (-(r0.zzz)) + (r4.xyz);
    r0 = texCUBElod(s15, r0);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r5.xyz = (r7.xyz) * (r1.xyz) + (r2.xyz);
    r1.xyz = (r9.xxx) * (r0.xyz);
    r4.xyz = (r10.xyz) * (r6.zzz) + (r11.xyz);
    r0.xy = (v0.zw) * (c3.xy);
    r0 = tex2D(s13, r0.xy);
    r2 = tex2D(s14, v0.zw);
    r8.xy = (r2.xy) * (c3.ww);
    ...
    else
    {
        ...
        {
            r0.w = (v3.w) + (-(c4.x));
            r0.w = ((r0.w) >= 0.0f ? (c0.x) : (c0.y));
            if ((r0.w) != (-(r0.w)))
            {
                r9.xy = (v3.xy) * (c[2].ww) + (c[2].xy);
                r1.xy = (r9.xy) + (c12.xx);
                r1.zw = (v3.zz) * (c0.yx);
                r1 = tex2Dlod(s1, r1);
                r2.xy = (r9.xy) + (c12.zz);
