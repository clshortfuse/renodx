// Mechanically reconstructed from 0x8E40FCA3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = (r0.y) * (r0.x) + (c13.x);
    r1.z = 1.0f / (r0.y);
    r16.xy = (r1.ww) * (c14.xy) + (c14.zw);
    r1.x = saturate(dot(r9.xyz, r3.xyz));
    r1.y = exp2(r16.y);
    r0.x = pow(abs(r1.x), r1.y);
    r0.y = (r1.y) * (c13.y) + (c13.z);
    r1.y = (r4.w) * (r1.z);
    r1.z = (r0.x) * (r0.y);
    r0.xyz = (r10.xyz) * (r0.zzz) + (r11.xyz);
    r2.w = (r1.y) * (r1.z);
    r1.xyz = (r8.xyz) * (r3.www) + (r2.xyz);
    r0.xyz = (r0.xyz) * (r2.www);
    r3 = tex2D(s0, v1.xy);
    r2 = tex2D(s3, v8.xy);
    r2.w = (r2.w) * (v0.y) + (c1.x);
    r4.xyz = float3(((r2.w) >= 0.0f ? (r2.x) : (r3.x)), ((r2.w) >= 0.0f ? (r2.y) : (r3.y)), ((r2.w) >= 0.0f ? (r2.z) : (r3.z)));
    r16.yz = c1.yz;
    r3.xyz = float3(((r2.w) >= 0.0f ? (r16.y) : (c[20].x)), ((r2.w) >= 0.0f ? (r16.z) : (c[20].y)), ((r2.w) >= 0.0f ? (r16.y) : (c[20].w)));
    r2 = tex2D(s4, v8.zw);
    r2.w = (r2.w) * (v0.z) + (c1.x);
    r13.xyz = float3(((r2.w) >= 0.0f ? (r2.x) : (r4.x)), ((r2.w) >= 0.0f ? (r2.y) : (r4.y)), ((r2.w) >= 0.0f ? (r2.z) : (r4.z)));
    r7.xyz = float3(((r2.w) >= 0.0f ? (c1.y) : (r3.x)), ((r2.w) >= 0.0f ? (c1.z) : (r3.y)), ((r2.w) >= 0.0f ? (c1.y) : (r3.z)));
    r15.xyz = (r1.xyz) * (r7.yyy);
    r14.xyz = (r0.xyz) * (r7.zzz);
    r2 = tex2D(s12, v1.zw);
