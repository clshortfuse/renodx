// Mechanically reconstructed from 0x815FF29E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = dot(r0, c2.wwww);
    r0.xyz = (r1.xyz) * (r2.www) + (v8.xyz);
    r0 = tex3D(s11, r0.xyz);
    r3.xyz = (-(v7.xyz)) + (c[21].xyz);
    r1.z = dot(r3.xyz, r3.xyz);
    r2.w = rsqrt(r1.z);
    r2.z = lerp(r0.w, r1.w, c[24].w);
    ...
    r3.xyz = (r0.xyz) * (c[37].www);
    r0.xyz = (r5.xyz) * (c[37].yyy);
