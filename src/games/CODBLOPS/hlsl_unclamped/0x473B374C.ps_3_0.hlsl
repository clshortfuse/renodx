// Mechanically reconstructed from 0x473B374C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xy = (r2.yw) * (c14.xx) + (c14.yy);
    r5.xyz = float3(((r11.w) >= 0.0f ? (r6.x) : (r5.x)), ((r11.w) >= 0.0f ? (r6.y) : (r5.y)), ((r11.w) >= 0.0f ? (r6.z) : (r5.z)));
    ...
    r2.w = (r0.w) * (r1.w);
    r8.w = (r5.z) * (c3.w);
    r7.w = (r5.z) * (-(c14.z)) + (c14.w);
    r1.w = saturate(dot(r10.xyz, -(r3.xyz)));
    r0.w = (r5.w) * (r7.w) + (r8.w);
    r3.w = (r1.w) * (r7.w) + (r8.w);
    r0.w = (r0.w) * (r3.w) + (c12.x);
    r12.xy = (r5.zz) * (c13.xy) + (c13.zw);
    r2.z = 1.0f / (r0.w);
    r9.w = exp2(r12.y);
    r4.w = (r9.w) * (c12.y) + (c12.z);
    r0.w = pow(abs(r2.x), r9.w);
    r2.z = (r5.w) * (r2.z);
    r0.w = (r4.w) * (r0.w);
    r2.w = (r2.w) * (c4.x) + (c4.y);
    r0.w = (r2.z) * (r0.w);
    r6.xyz = (r2.yyy) * (r6.xyz) + (r7.xyz);
    r0.w = (r2.w) * (r0.w);
    r5.w = (-(r1.w)) + (-(c2.y));
    r1.w = (r6.w) * (r0.w);
    r0.w = (r5.z) * (c3.z);
