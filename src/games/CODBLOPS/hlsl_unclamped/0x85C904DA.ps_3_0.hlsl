// Mechanically reconstructed from 0x85C904DA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.y = dot(r3.xy, r1.zw) + (c3.w);
    r0 = tex2D(s1, v1.xy);
    r2.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = tex2D(s5, v7.xy);
    r3.w = (r0.w) * (v0.y);
    r6.x = dot(r3.xy, r1.xy) + (c3.w);
    r7.xy = (r3.ww) * (-(r2.xy)) + (r2.xy);
    r2 = tex2D(s8, v1.xy);
    r1 = tex2D(s0, v1.xy);
    ...
    r0 = tex2D(s9, v7.xy);
    r0 = (r1) + (r0);
    r1 = (r2.wwww) * (-(c3.wwwy)) + (-(c3.zzzw));
    r4.xyz = lerp(r2.yyy, c[32].xyw, r3.www);
    r2 = (r3.wwww) * (r0) + (r1);
    r0 = tex2D(s6, v7.zw);
    r4.w = (r0.w) * (v0.z);
