// Mechanically reconstructed from 0x4439BAEB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.w = rsqrt(r0.z);
    r3.xyz = (v6.xyz) * (-(r9.www)) + (c[17].xyz);
    r1.xyz = normalize(r3.xyz);
    r0.z = saturate(dot(r1.xyz, c[17].xyz));
    r2.z = (-(r0.z)) + (-(c3.y));
    r3.w = lerp(r2.y, r0.y, r6.w);
    r0.z = (r2.z) * (r2.z);
    r1.w = lerp(r2.w, r0.w, r6.w);
    r2.w = (r0.z) * (r0.z);
    r0 = tex2D(s4, v7.zw);
    r10.w = (r0.w) * (v0.z);
    r6.w = (r2.z) * (r2.w);
    r3.xyz = lerp(r4.xyz, r0.xyz, r10.www);
    r4.xy = (r10.ww) * (-(r5.xy)) + (r5.xy);
    ...
    r2.w = (r0.w) * (r2.w);
    r8.xyz = lerp(r3.www, c[8].xyw, r10.www);
    r2.w = saturate((r0.y) * (r2.w) + (r2.w));
    r3 = tex2D(s14, v1.zw);
    r6.xy = (r3.xy) * (c10.ww);
    r5.xy = (r2.xz) * (r6.xx);
    r2.xy = (r0.xz) * (r6.yy);
    r0.x = (r3.x) * (c10.w) + (-(r5.x));
    r0.y = (r3.y) * (c10.w) + (-(r2.x));
    r2.z = (r2.z) * (-(r6.x)) + (r0.x);
    r0.z = (r0.z) * (-(r6.y)) + (r0.y);
    r0.y = (r0.z) + (r0.z);
    r0.xz = (r2.xy) * (c11.xx);
