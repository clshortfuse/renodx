// Mechanically reconstructed from 0x2637D434.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.zw = v0.zw;
    r3 = tex2Dproj(s0, r3);
    r4.xy = (v0.ww) * (-(c[11].xy)) + (v0.xy);
    r4.zw = v0.zw;
    r4 = tex2Dproj(s0, r4);
    r3.y = r4.x;
    r4.xy = (v0.ww) * (c[11].zw) + (v0.xy);
    r4.zw = v0.zw;
    r4 = tex2Dproj(s0, r4);
    r3.z = r4.x;
    r4.xy = (v0.ww) * (-(c[11].zw)) + (v0.xy);
    ...
    r3.w = dot(r4.xyz, c[7].xyz);
    r3.w = saturate((r3.w) * (c[8].x) + (c[8].y));
    r6.x = 1.0f / (r3.z);
    r3.w = (r3.w) * (c[8].w);
    r4.w = lerp(r3.y, r5.w, r3.w);
    r5.xy = saturate((r6.xx) * (c[10].xy) + (c[10].zw));
    r3.xy = (r5.xy) * (r5.xy);
    r5.xy = (r5.xy) * (c4.zz) + (c4.yy);
    r5.w = dot(c[9].yz, r6.xy) + (c[9].x);
    r6.xy = (r3.xy) * (r5.xy);
    r3 = tex2D(s4, v7.xy);
