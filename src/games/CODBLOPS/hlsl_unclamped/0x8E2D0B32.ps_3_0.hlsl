// Mechanically reconstructed from 0x8E2D0B32.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r2.w) * (r6.w);
    r5.w = 1.0f / (r5.w);
    r7.xy = (r3.ww) * (r6.xy) + (c[5].xy);
    r5.w = (r2.w) * (r5.w);
    r6.xyz = (r1.xyz) * (-(r1.xyz)) + (c0.xxx);
