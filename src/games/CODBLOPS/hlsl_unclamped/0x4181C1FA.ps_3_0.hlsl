// Mechanically reconstructed from 0x4181C1FA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = (r2.w) * (r2.w);
    r8.xyz = (v0.yyy) * (r0.xyz) + (c1.yyy);
    r0 = tex2D(s4, v6.zw);
    r0.xyz = (r0.xyz) + (c1.xxx);
    r5.xyz = (r8.xyz) * (c1.zzz);
    r7.xyz = (v0.zzz) * (r0.xyz) + (c1.yyy);
    r0 = tex2D(s5, v7.xy);
    r4.xyz = (r0.xyz) + (c1.xxx);
    r0.xyz = (r5.xyz) * (r7.xyz);
    r5.xyz = (v0.www) * (r4.xyz) + (c1.yyy);
    r0.w = (r3.w) * (r3.w);
    r4.xyz = (r0.xyz) * (r5.xyz);
    r2.w = (r2.w) * (r0.w);
    r6.xyz = (r4.xyz) * (-(r4.xyz)) + (c1.yyy);
    r0 = tex2D(s0, v1.xy);
