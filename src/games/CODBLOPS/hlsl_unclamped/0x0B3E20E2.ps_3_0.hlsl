// Mechanically reconstructed from 0x0B3E20E2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.z = (r0.y) * (r0.w);
    r3.xy = (r3.xz) * (r6.yy);
    r0.y = dot(r7.xy, r5.xy) + (c2.z);
    r2.w = (r2.y) * (c4.x) + (-(r3.x));
    r0.y = saturate((r0.y) * (r2.z) + (r2.z));
    r2.w = (r3.z) * (-(r6.y)) + (r2.w);
    r3.xz = (r3.xy) * (c4.yy);
    r3.y = (r2.w) + (r2.w);
    ...
    r0.w = c2.y;
    r6.xyz = float3(((r1.w) >= 0.0f ? (-(r0.w)) : (c[32].x)), ((r1.w) >= 0.0f ? (-(r0.w)) : (c[32].y)), ((r1.w) >= 0.0f ? (-(r0.w)) : (c[32].w)));
