// Mechanically reconstructed from 0xC6474712.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xy = c1.xy;
    r2.xyz = (r11.xyx) + (-(c[28].xyw));
    r9.xyz = normalize(r3.xyz);
    r3.xyz = (r4.www) * (r2.xyz) + (c[28].xyw);
