// Mechanically reconstructed from 0xE10ED860.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s2, v7.xy);
    r4.w = (r1.w) * (v0.y) + (c1.x);
    r3.xy = float2(((r4.w) >= 0.0f ? (c1.y) : (r2.y)), ((r4.w) >= 0.0f ? (c1.z) : (r2.y)));
    r1.w = (r2.w) * (c1.w);
    r2 = tex2D(s3, v7.zw);
    r2.w = (r2.w) * (v0.z) + (c1.x);
    r9.xy = float2(((r2.w) >= 0.0f ? (c1.y) : (r3.x)), ((r2.w) >= 0.0f ? (c1.z) : (r3.y)));
    r4.xy = saturate((r5.xx) * (c[9].xy) + (c[9].zw));
    r3.xy = (r4.xy) * (r4.xy);
    r4.xy = (r4.xy) * (c14.xx) + (c14.yy);
    r3.w = dot(c[8].yz, r5.xy) + (c[8].x);
    r3.xy = (r3.xy) * (r4.xy);
    r3.z = (r3.z) * (r9.x);
    r3.w = (r3.w) * (r3.x);
    r4.xyz = (r3.zzz) * (c[7].xyz);
    r5.w = (r3.y) * (r3.w);
    r3 = tex2D(s12, v1.zw);
    r5.w = (r5.w) * (r3.y);
    r3 = tex2D(s0, v1.xy);
    ...
    r1.xyz = float3(((r2.w) >= 0.0f ? (r2.x) : (r1.x)), ((r2.w) >= 0.0f ? (r2.y) : (r1.y)), ((r2.w) >= 0.0f ? (r2.z) : (r1.z)));
