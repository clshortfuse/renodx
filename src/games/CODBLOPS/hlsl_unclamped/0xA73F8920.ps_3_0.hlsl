// Mechanically reconstructed from 0xA73F8920.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c9 = float4(-1.0f, 1.0f, 0.0f, 0.5f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = tex2D(s1, v0.xy);
    r1 = tex2D(s3, v6.zw);
    r1.xyz = (r1.xyz) + (c9.xxx);
    r3.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r1.xyz = (v6.yyy) * (r1.xyz) + (c9.yyy);
    r0 = tex2D(s0, v0.xy);
    r0.xyz = (r1.xyz) * (r0.xyz);
    r6.xyz = (r0.xyz) * (r0.xyz);
    r0.w = dot(r3.xy, r3.xy) + (c9.z);
    r1.w = exp2(-(r0.w));
    r0.xy = (v0.zw) * (c9.yw);
    r0 = tex2D(s13, r0.xy);
    r1.xy = (v0.zw) * (c9.yw) + (c9.zw);
    r2 = tex2D(s13, r1.xy);
    r0.w = r2.y;
    r2.w = (r1.w) * (c3.x) + (c3.y);
    ...
    r1 = tex2D(s14, v0.zw);
    r7.xy = (r1.xy) * (c3.zz);
    r0.y = dot(r4.xy, r3.xy) + (c9.z);
    r5.xy = (r2.xz) * (r7.yy);
    r0.w = (r1.y) * (c3.z) + (-(r5.x));
    r1.w = dot(r4.xy, r4.xy) + (c9.z);
    r0.w = (r2.z) * (-(r7.y)) + (r0.w);
    r1.w = exp2(-(r1.w));
    r4.xy = (r0.xz) * (r7.xx);
    r0.x = (r1.w) * (c3.x) + (c3.y);
