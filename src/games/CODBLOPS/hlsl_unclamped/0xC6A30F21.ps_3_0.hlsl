// Mechanically reconstructed from 0xC6A30F21.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s3, v6.xy);
    r4.w = (r2.w) * (v0.y) + (c2.w);
    r4.xy = float2(((r4.w) >= 0.0f ? (r0.x) : (r3.x)), ((r4.w) >= 0.0f ? (r0.y) : (r3.y)));
    r0 = tex2D(s6, v6.zw);
    ...
    r0 = tex2D(s4, v6.zw);
    r2.w = (r0.w) * (v0.z) + (c2.w);
    r4.xy = float2(((r2.w) >= 0.0f ? (r3.x) : (r4.x)), ((r2.w) >= 0.0f ? (r3.y) : (r4.y)));
    r3.xyz = v4.xyz;
