// Mechanically reconstructed from 0x433F2152.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.y = dot(r1.xy, r0.zw) + (c43.w);
    r5.x = dot(r1.xy, r0.xy) + (c43.w);
    r0 = tex2D(s1, v1.xy);
    r1 = tex2D(s5, v7.xy);
    r1.xyz = (r1.xyz) + (c43.yyy);
    r6.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r3.xyz = (v0.yyy) * (r1.xyz) + (c43.zzz);
    r0 = tex2D(s0, v1.xy);
    r1.xyz = (r3.xyz) * (r0.xyz);
    r0 = tex2D(s6, v7.zw);
    r4.w = (r0.w) * (v0.z) + (c3.x);
    r4.xyz = float3(((r4.w) >= 0.0f ? (r0.x) : (r1.x)), ((r4.w) >= 0.0f ? (r0.y) : (r1.y)), ((r4.w) >= 0.0f ? (r0.z) : (r1.z)));
    r0.xy = (v1.zw) * (c12.xy);
    r2 = tex2D(s13, r0.xy);
    ...
    r0.y = dot(r1.xy, r1.xy) + (c43.w);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c4.x) + (c4.y);
    r1.w = (r0.y) * (c4.x) + (c4.y);
    r0.y = dot(r1.xy, r10.xy) + (c43.w);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v1.zw);
    r6.xy = (r1.xy) * (c12.ww);
    ...
    r13.xyz = float3(((r4.w) >= 0.0f ? (r1.y) : (c[39].x)), ((r4.w) >= 0.0f ? (r1.y) : (c[39].y)), ((r4.w) >= 0.0f ? (r1.y) : (c[39].w)));
    r1.xyz = (r10.yyy) * (v3.xyz) + (r2.xyz);
    r12.w = (r0.w) * (c4.w);
