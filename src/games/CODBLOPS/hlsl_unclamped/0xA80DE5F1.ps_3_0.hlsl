// Mechanically reconstructed from 0xA80DE5F1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(-1.0f, 1.0f, 0.797884583f, 0.0009765625f);
    const float4 c2 = float4(-13.0f, 13.0f, 0.125f, 0.25f);
    const float4 c3 = float4(1.0f, -0.0f, 0.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r1 = tex2D(s3, v6.xy);
    r5.w = (r1.w) * (v0.y);
    r3.xy = (r5.ww) * (-(r0.xy)) + (r0.xy);
    r0 = tex2D(s4, v6.zw);
    r1.w = (r0.w) * (v0.z);
    r4.xy = (r1.ww) * (-(r3.xy)) + (r3.xy);
    r3.xyz = v4.xyz;
    r3.xyz = (r4.xxx) * (r3.xyz) + (v2.xyz);
    ...
    r3.w = (r2.w) * (r2.w);
    r3.xyz = (v0.www) * (r3.xyz) + (c1.yyy);
    r3.w = (r3.w) * (r3.w);
    r7.xyz = (r2.xyz) * (r3.xyz);
    r3.w = (r2.w) * (r3.w);
    r9.xyz = (r7.xyz) * (-(r7.xyz)) + (c1.yyy);
    r2 = tex2D(s0, v1.xy);
    r8.xyz = lerp(r2.xyz, r1.xyz, r5.www);
    r1.xyz = (r3.www) * (r9.xyz);
    r2.xyz = lerp(r8.xyz, r0.xyz, r1.www);
    r1.xyz = (r7.xyz) * (r7.xyz) + (r1.xyz);
