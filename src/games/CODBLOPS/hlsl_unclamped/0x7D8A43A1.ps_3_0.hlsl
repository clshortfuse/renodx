// Mechanically reconstructed from 0x7D8A43A1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.y = dot(r6.xy, r2.zw) + (c1.z);
    r1 = tex2D(s0, v0.xy);
    r0 = tex2D(s3, v7.zw);
    r5.z = (r0.w) * (v7.y) + (c1.w);
    r3.x = dot(r6.xy, r2.xy) + (c1.z);
    r2.xyz = float3(((r5.z) >= 0.0f ? (r0.x) : (r1.x)), ((r5.z) >= 0.0f ? (r0.y) : (r1.y)), ((r5.z) >= 0.0f ? (r0.z) : (r1.z)));
    r1 = tex2D(s5, v0.xy);
    r0 = tex2D(s6, v7.zw);
