// Mechanically reconstructed from 0x3418639F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r1.w) * (r1.z);
    r1.xyw = c[8].xyw;
    r2.xyz = (-(r1.xyw)) + (c[9].xyw);
    r1 = tex2D(s4, v7.zw);
    r1.w = (r1.w) * (v0.z);
    r5.xyz = (r3.www) * (r2.xyz) + (c[8].xyw);
    r2.xyz = lerp(r6.xyz, r1.xyz, r1.www);
    r11.xyz = lerp(r5.xyz, c20.www, r1.www);
    r10.xyz = (r0.xyz) * (r0.xyz);
    r0.xyz = (r9.xyz) * (r2.www) + (r10.xyz);
    r5.xy = (r1.ww) * (-(r7.xy)) + (r7.xy);
