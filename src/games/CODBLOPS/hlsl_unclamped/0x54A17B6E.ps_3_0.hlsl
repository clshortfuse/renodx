// Mechanically reconstructed from 0x54A17B6E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r13.yz = c1.yz;
    r0.xyz = float3(((r7.w) >= 0.0f ? (r13.y) : (c[28].x)), ((r7.w) >= 0.0f ? (r13.z) : (c[28].y)), ((r7.w) >= 0.0f ? (r13.y) : (c[28].w)));
    r9.xyz = normalize(r4.xyz);
    r7.xyz = lerp(r0.xyz, c[29].xyw, r8.www);
    r2.w = saturate(dot(r9.xyz, r10.xyz));
    r11.xyz = (r3.xyz) * (r7.yyy);
