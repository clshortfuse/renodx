// Mechanically reconstructed from 0xFBF3589E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.xyz = float3(((r6.w) >= 0.0f ? (c[5].x) : (r0.y)), ((r6.w) >= 0.0f ? (c[5].y) : (r0.y)), ((r6.w) >= 0.0f ? (c[5].w) : (r0.y)));
    r4 = (r0.wwww) * (c1.yyyz) + (c1.wwwy);
    r11.xyz = (r2.xyz) * (r9.yyy);
    r2 = tex2D(s12, v0.zw);
    r0 = v1;
