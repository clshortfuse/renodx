// Mechanically reconstructed from 0xFAE40090.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.yz = c1.yz;
    r5.xyz = float3(((r6.w) >= 0.0f ? (r0.y) : (c[29].x)), ((r6.w) >= 0.0f ? (r0.z) : (c[29].y)), ((r6.w) >= 0.0f ? (r0.y) : (c[29].w)));
    r1 = tex2D(s5, v8.zw);
    r5.w = (r1.w) * (v0.z) + (c1.x);
    ...
    r9.xyz = float3(((r5.w) >= 0.0f ? (c1.y) : (r5.x)), ((r5.w) >= 0.0f ? (c1.z) : (r5.y)), ((r5.w) >= 0.0f ? (c1.y) : (r5.z)));
