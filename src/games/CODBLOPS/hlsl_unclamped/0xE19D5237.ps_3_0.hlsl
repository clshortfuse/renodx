// Mechanically reconstructed from 0xE19D5237.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = (r7.zzz) * (v7.xyz);
    r2.z = saturate(dot(r10.xyz, -(r4.xyz)));
    r0.w = (-(r2.z)) + (c1.z);
    r8.xyz = (r1.www) * (r5.xyz) + (r6.xyz);
    r0.z = (r0.w) * (r0.w);
    r2.w = (r0.w) * (r0.z);
    r2.y = dot(r4.xyz, r10.xyz);
    r0 = tex2D(s3, v1.xy);
    r1.xyz = (r0.xyz) * (-(r0.xyz)) + (c1.zzz);
    r3.xyz = (r0.xyz) * (r0.xyz);
    r3.w = (r2.y) + (r2.y);
    r0.xyz = (r1.xyz) * (r7.www) + (r3.xyz);
    r4.w = (r0.w) * (-(c1.w)) + (c1.z);
    r5.y = (r0.w) * (c1.w);
    r5.z = (r2.z) * (r4.w) + (r5.y);
    ...
    r0.w = (r0.w) * (c1.x);
    r0.xyz = (r10.xyz) * (-(r3.www)) + (r4.xyz);
    r0 = texCUBElod(s15, r0);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r2.xyz = (r2.xyz) * (c[21].www);
