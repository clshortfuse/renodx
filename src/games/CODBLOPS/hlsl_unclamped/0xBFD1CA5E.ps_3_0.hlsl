// Mechanically reconstructed from 0xBFD1CA5E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c9 = float4(0.797884583f, 1.0f, 0.5f, 0.0f);
    ...
    r6.xz = (r4.xy) * (c4.yy);
    r2.xyz = lerp(r1.xyz, r0.xyz, r8.www);
    r3.xyz = (r6.xyz) * (r0.www) + (r3.xyz);
    r1 = tex2D(s6, v1.xy);
    r0 = tex2D(s7, v7.xy);
    r14.xy = lerp(r1.wy, r0.wy, r8.ww);
    r4.w = (r14.x) * (-(c9.x)) + (c9.y);
