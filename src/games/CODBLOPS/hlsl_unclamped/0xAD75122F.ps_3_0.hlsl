// Mechanically reconstructed from 0xAD75122F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s6, v7.zw);
    r4.w = (r1.w) * (v0.z) + (c4.z);
    r5.xy = float2(((r4.w) >= 0.0f ? (r2.x) : (r0.x)), ((r4.w) >= 0.0f ? (r2.y) : (r0.y)));
    r2 = tex2D(s0, v1.xy);
    r0 = tex2D(s5, v7.xy);
    r3.w = (r0.w) * (v0.y) + (c4.z);
    ...
    r1.y = (r3.w) * (r0.y);
    r1.z = (r0.z) * (r5.w);
    r0.xyz = (r15.xyz) * (r4.yyy) + (r16.xyz);
    r1.z = (r1.y) * (r1.z);
    r14.xyz = float3(((r4.w) >= 0.0f ? (c[32].x) : (r4.z)), ((r4.w) >= 0.0f ? (c[32].y) : (r4.z)), ((r4.w) >= 0.0f ? (c[32].w) : (r4.z)));
