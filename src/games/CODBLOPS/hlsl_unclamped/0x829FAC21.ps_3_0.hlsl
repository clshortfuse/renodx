// Mechanically reconstructed from 0x829FAC21.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xyz = float3(((r1.w) >= 0.0f ? (r2.x) : (r3.x)), ((r1.w) >= 0.0f ? (r2.y) : (r3.y)), ((r1.w) >= 0.0f ? (r2.z) : (r3.z)));
    r6.w = ((r1.w) >= 0.0f ? (r0.y) : (r1.y));
    r7.xyz = (r4.xyz) * (r4.xyz);
    r3.z = (r10.z) * (-(c6.z)) + (c6.w);
    r0.xy = (v0.zw) * (-(c1.yw)) + (-(c1.zw));
    r0 = tex2D(s13, r0.xy);
    r1.xy = (v0.zw) * (-(c1.yw));
    r2 = tex2D(s13, r1.xy);
    r0.w = r2.y;
    r1.w = dot(r10.xy, r10.xy) + (c1.z);
    ...
    r2.z = saturate(dot(r8.xyz, r0.xyz));
    r10.xy = (r10.zz) * (c8.xy) + (c8.zw);
