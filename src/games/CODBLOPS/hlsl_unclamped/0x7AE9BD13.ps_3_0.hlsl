// Mechanically reconstructed from 0x7AE9BD13.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c22 = float4(2.0f, -1.0f, 0.0f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = (c22.xxxx) * (v8) + (c22.yyyy);
    r2.y = dot(r1.xy, r0.zw) + (c22.z);
    r2.x = dot(r1.xy, r0.xy) + (c22.z);
    r0 = tex2D(s1, v0.xy);
    r0.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r1 = tex2D(s3, v7.zw);
    r6.w = (r1.w) * (v7.y);
    r4.xy = lerp(r0.xy, r2.xy, r6.ww);
    r1.w = (r1.w) * (-(v7.y)) + (c22.w);
    r0 = tex2D(s0, v0.xy);
    r2.xyz = lerp(r0.xyz, r1.xyz, r6.www);
    r0.w = (r0.w) * (-(v7.x)) + (c22.w);
    r5.w = (r0.w) * (-(r1.w)) + (c22.w);
    r0.w = dot(r4.xy, r4.xy) + (c22.z);
    ...
    r3.xy = (r2.xz) * (r6.xx);
    r0.w = dot(r7.xy, r4.xy) + (c22.z);
    r0.y = (r1.x) * (c4.w) + (-(r3.x));
    r1.w = (r2.z) * (-(r6.x)) + (r0.y);
    r2.xy = (r0.xz) * (r6.yy);
    r0.y = (r1.y) * (c4.w) + (-(r2.x));
    r0.x = dot(r7.xy, r7.xy) + (c22.z);
    r0.y = (r0.z) * (-(r6.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r8.y = (r1.w) + (r1.w);
    r0.z = (r0.z) * (c1.x) + (c1.y);
    ...
    r7.w = (r11.y) * (r0.w);
    r0 = tex2D(s12, v0.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c22.w) : (c22.z));
