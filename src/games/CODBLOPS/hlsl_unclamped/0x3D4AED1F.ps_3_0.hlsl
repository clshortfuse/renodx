// Mechanically reconstructed from 0x3D4AED1F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c30 = float4(0.959999979f, 0.0399999991f, 1.0f, 0.5f);
    ...
    r4.xy = float2(((r0.w) >= 0.0f ? (c1.y) : (r1.y)), ((r0.w) >= 0.0f ? (c1.z) : (r1.y)));
    r0 = tex2D(s6, v8.zw);
    r0.w = (r0.w) * (v0.z);
    r1.xyz = lerp(r2.xyz, r0.xyz, r0.www);
    r13.xy = lerp(r4.xy, c1.zz, r0.ww);
