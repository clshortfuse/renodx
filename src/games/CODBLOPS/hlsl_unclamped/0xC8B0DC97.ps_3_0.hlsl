// Mechanically reconstructed from 0xC8B0DC97.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = (c[8].zz) * (r1.xy) + (r0.xy);
    r1 = tex2D(s6, v1.xy);
    r2.xy = (v1.xy) + (c1.xx);
    r2.z = c1.y;
    r0.xy = (r2.xy) * (c[21].xx) + (r2.zz);
    r0 = tex2D(s4, r0.xy);
    r6.w = (v7.w) * (c1.z) + (-(r0.x));
    r1.xy = (r1.wy) * (c0.xy) + (c0.zw);
    r10.w = saturate((r6.w) * (c1.w));
    ...
    r0.w = (r0.x) * (r0.w);
    r1.xyz = (r6.xyz) * (r0.zzz) + (r7.xyz);
    r2.w = (r2.w) * (c2.w);
    r1.xyz = (r0.www) * (r1.xyz);
    r1.xyz = (r1.xyz) * (c[7].www);
    r2.z = max(abs(r8.y), abs(r8.z));
    r10.xy = c[6].xy;
    r3.xyz = (r10.yyy) * (c[19].xyz);
    r0.w = max(abs(r8.x), r2.z);
    r0.w = 1.0f / (r0.w);
