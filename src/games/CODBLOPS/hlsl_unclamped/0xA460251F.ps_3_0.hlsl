// Mechanically reconstructed from 0xA460251F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyz = (r8.zzz) * (v7.xyz);
    r2.z = saturate(dot(r10.xyz, -(r0.xyz)));
    r1.w = (-(r2.z)) + (c1.z);
    r8.xyz = (r2.www) * (r6.xyz) + (r7.xyz);
    r1.z = (r1.w) * (r1.w);
    r3.w = (r1.w) * (r1.z);
