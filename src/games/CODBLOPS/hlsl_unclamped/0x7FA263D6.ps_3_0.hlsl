// Mechanically reconstructed from 0x7FA263D6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(0.0f, 1.0f, 0.600000024f, 0.400000006f);
