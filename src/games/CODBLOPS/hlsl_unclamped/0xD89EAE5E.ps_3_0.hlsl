// Mechanically reconstructed from 0xD89EAE5E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.z = (r2.z) * (r2.z);
    r2.w = (r2.w) * (r2.z);
    r2.xyz = (r1.xyz) * (-(r1.xyz)) + (c3.www);
    r1.w = (r3.w) * (r1.w);
    r7.xyz = (r2.www) * (r2.xyz);
    r2 = tex2D(s0, v1.xy);
    r6.xyz = lerp(r2.xyz, r0.xyz, r0.www);
    r0 = tex2D(s4, v6.zw);
