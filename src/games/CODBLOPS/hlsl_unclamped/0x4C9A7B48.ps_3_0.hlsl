// Mechanically reconstructed from 0x4C9A7B48.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4 = tex2D(s13, r4.xy);
    r2.w = r4.y;
    r7.xyz = float3(((r7.w) >= 0.0f ? (c[25].x) : (r3.y)), ((r7.w) >= 0.0f ? (c[25].y) : (r3.y)), ((r7.w) >= 0.0f ? (c[25].w) : (r3.y)));
