// Mechanically reconstructed from 0xBEF1A355.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xz = (r2.xy) * (c4.xx);
    r3.zw = c15.zw;
    r3.xyz = (r3.zwz) + (-(c[24].xyw));
    r1.w = (r2.z) * (-(r9.x)) + (r1.w);
    r3.xyz = (r6.www) * (r3.xyz) + (c[24].xyw);
    r4.y = (r1.w) + (r1.w);
    r2.xyz = -(r3.xyz);
    r6.xyz = (r4.xyz) * (r0.www) + (r6.xyz);
    r2.w = (r2.y) + (c15.w);
