// Mechanically reconstructed from 0x5F730101.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xyw = c[25].xyw;
    r2.xyz = (-(r2.xyw)) + (c[26].xyw);
    r0.xyz = (r3.www) * (r0.xyz);
    r7.xyz = (r7.www) * (r2.xyz) + (c[25].xyw);
