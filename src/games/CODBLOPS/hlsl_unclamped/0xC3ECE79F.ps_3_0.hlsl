// Mechanically reconstructed from 0xC3ECE79F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c6 = float4(0.0009765625f, 0.125f, 0.25f, 0.0f);
    ...
    r2.w = (r4.y) * (c3.w) + (-(r5.x));
    r9.xz = (r5.xy) * (c4.xx);
    r2.w = (r5.z) * (-(r10.y)) + (r2.w);
    r3.xy = (r3.xz) * (r10.xx);
    r9.y = (r2.w) + (r2.w);
    r2.w = (r4.x) * (c3.w) + (-(r3.x));
    r4.xyz = (r2.zzz) * (r9.xyz);
