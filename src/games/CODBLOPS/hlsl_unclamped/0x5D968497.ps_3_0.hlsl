// Mechanically reconstructed from 0x5D968497.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s4, v7.xy);
    r2.w = (r2.w) * (v0.y);
    r6.xy = lerp(r4.xy, r0.xy, r2.ww);
    r0 = tex2D(s7, v7.zw);
    r7.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r0 = (c3.xxxx) * (v9) + (c3.yyyy);
    r4.x = dot(r7.xy, r0.xy) + (c3.z);
    r4.y = dot(r7.xy, r0.zw) + (c3.z);
    r0 = tex2D(s5, v7.zw);
    r5.w = (r0.w) * (v0.z);
    r1.w = r3.x;
