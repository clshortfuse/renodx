// Mechanically reconstructed from 0x415F0E3F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = (r0.z) * (r1.w) + (r3.z);
    r1.w = (r0.x) * (r1.w) + (r3.z);
    r7.xyz = float3(((r7.w) >= 0.0f ? (r3.y) : (c[25].x)), ((r7.w) >= 0.0f ? (r3.y) : (c[25].y)), ((r7.w) >= 0.0f ? (r3.y) : (c[25].w)));
    r0.y = (r0.y) * (r1.w) + (c4.x);
    r5.w = (-(r0.x)) + (c1.z);
    r0.y = 1.0f / (r0.y);
    r4.w = (r0.z) * (r0.y);
    r4.xyz = (r6.xyz) * (r6.www) + (-(r11.xyz));
