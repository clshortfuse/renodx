// Mechanically reconstructed from 0x6DA5F54B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.y = dot(r4.xy, r1.zw) + (c3.z);
    r0 = tex2D(s1, v1.xy);
    r3.xy = (r0.wy) * (c4.xy) + (c4.zw);
    r0 = tex2D(s5, v7.xy);
    r5.w = (r0.w) * (v0.y) + (c3.w);
    r5.x = dot(r4.xy, r1.xy) + (c3.z);
    r6.xy = float2(((r5.w) >= 0.0f ? (r2.x) : (r3.x)), ((r5.w) >= 0.0f ? (r2.y) : (r3.y)));
    r1 = tex2D(s0, v1.xy);
    r4.xyz = float3(((r5.w) >= 0.0f ? (r0.x) : (r1.x)), ((r5.w) >= 0.0f ? (r0.y) : (r1.y)), ((r5.w) >= 0.0f ? (r0.z) : (r1.z)));
    r1 = tex2D(s9, v1.xy);
    r2 = (r1.wwww) * (c1.xxxy) + (c1.zzzx);
    r0 = tex2D(s10, v7.xy);
    r3 = float4(((r5.w) >= 0.0f ? (r0.x) : (r2.x)), ((r5.w) >= 0.0f ? (r0.y) : (r2.y)), ((r5.w) >= 0.0f ? (r0.z) : (r2.z)), ((r5.w) >= 0.0f ? (r0.w) : (r2.w)));
    r2 = tex2D(s6, v7.zw);
    r6.w = (r2.w) * (v0.z) + (c3.w);
    r0 = tex2D(s11, v7.zw);
    r0 = float4(((r6.w) >= 0.0f ? (r0.x) : (r3.x)), ((r6.w) >= 0.0f ? (r0.y) : (r3.y)), ((r6.w) >= 0.0f ? (r0.z) : (r3.z)), ((r6.w) >= 0.0f ? (r0.w) : (r3.w)));
    r2.xyz = float3(((r6.w) >= 0.0f ? (r2.x) : (r4.x)), ((r6.w) >= 0.0f ? (r2.y) : (r4.y)), ((r6.w) >= 0.0f ? (r2.z) : (r4.z)));
    r10.xy = float2(((r6.w) >= 0.0f ? (r5.x) : (r6.x)), ((r6.w) >= 0.0f ? (r5.y) : (r6.y)));
    r9.xyz = (r2.xyz) * (r2.xyz);
    r15.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c3.yyy));
    r1.w = dot(r10.xy, r10.xy) + (c3.z);
    r9.w = (r0.w) * (-(c13.z)) + (c13.w);
    r1.w = exp2(-(r1.w));
    r1.z = (r1.w) * (c12.x) + (c12.y);
    r2.xy = (v1.zw) * (-(c3.yw));
    r4 = tex2D(s13, r2.xy);
    r2.xy = (v1.zw) * (-(c3.yw)) + (-(c3.zw));
    r2 = tex2D(s13, r2.xy);
    r4.w = r2.y;
    r3 = tex2D(s14, v1.zw);
    r5.xy = (r3.xy) * (c12.ww);
    ...
    r11.xy = (r4.xz) * (r5.xx);
    r1.w = dot(r6.xy, r10.xy) + (c3.z);
    r1.x = (r3.x) * (c12.w) + (-(r11.x));
    r2.y = (r4.z) * (-(r5.x)) + (r1.x);
    r4.xy = (r2.xz) * (r5.yy);
    r2.w = (r3.y) * (c12.w) + (-(r4.x));
    r1.x = dot(r6.xy, r6.xy) + (c3.z);
    r2.w = (r2.z) * (-(r5.y)) + (r2.w);
    r1.x = exp2(-(r1.x));
    r6.y = (r2.y) + (r2.y);
    ...
    r5.xyz = (r4.xyz) * (r1.www) + (-(r7.xyz));
    r3.xyz = normalize(r5.xyz);
    r8.xyz = (r4.xyz) * (r1.www);
    r6.xz = (r11.xy) * (c13.xx);
    r1.w = saturate(dot(r3.xyz, r8.xyz));
    r2.xyz = (r6.xyz) * (r1.zzz) + (r2.xyz);
    r1.w = (-(r1.w)) + (-(c3.y));
    r1.xyz = float3(((r5.w) >= 0.0f ? (c[32].x) : (r1.y)), ((r5.w) >= 0.0f ? (c[32].y) : (r1.y)), ((r5.w) >= 0.0f ? (c[32].w) : (r1.y)));
    r3.w = (r1.w) * (r1.w);
    r3.w = (r3.w) * (r3.w);
    r4.xyz = v2.xyz;
    r4.xyz = (r10.xxx) * (v4.xyz) + (r4.xyz);
    r4.w = (r1.w) * (r3.w);
    r4.xyz = (r10.yyy) * (v3.xyz) + (r4.xyz);
    r16.xyz = (r0.xyz) * (r0.xyz);
    r17.xyz = normalize(r4.xyz);
    r3.z = saturate(dot(r17.xyz, r3.xyz));
    r10.w = (r0.w) * (c12.z);
    ...
    r3.xy = (r0.ww) * (c36.xy) + (c36.zw);
    r0.y = 1.0f / (r0.z);
    r7.w = exp2(r3.y);
    r0.z = pow(abs(r3.z), r7.w);
    r5.w = (r7.w) * (c14.y) + (c14.z);
    r3.y = (r3.w) * (r0.y);
    r3.z = (r0.z) * (r5.w);
    r0.xyz = (r15.xyz) * (r4.www) + (r16.xyz);
    r3.z = (r3.y) * (r3.z);
    r14.xyz = float3(((r6.w) >= 0.0f ? (c[33].x) : (r1.x)), ((r6.w) >= 0.0f ? (c[33].y) : (r1.y)), ((r6.w) >= 0.0f ? (c[33].w) : (r1.z)));
