// Mechanically reconstructed from 0x98A2962A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c38 = float4(2.0f, -1.0f, 0.0f, -0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = (c38.xxxx) * (v8) + (c38.yyyy);
    r5.y = dot(r1.xy, r0.zw) + (c38.z);
    r5.x = dot(r1.xy, r0.xy) + (c38.z);
    r2 = tex2D(s1, v0.xy);
    r1 = tex2D(s0, v0.xy);
    r0 = tex2D(s5, v7.zw);
    r5.w = (r0.w) * (v7.y);
    ...
    r5.xy = (r2.yw) * (c4.xx) + (c4.yy);
    r1 = tex2D(s14, v0.zw);
    r6.xy = (r1.xy) * (c3.ww);
    r0.w = dot(r5.xy, r4.xy) + (c38.z);
    r2.xy = (r2.xz) * (r6.xx);
    r0.y = (r1.x) * (c3.w) + (-(r2.x));
    r3.xy = (r0.xz) * (r6.yy);
    r0.x = (r2.z) * (-(r6.x)) + (r0.y);
    ...
    r0.y = (r0.z) * (-(r6.y)) + (r0.y);
    r8.y = (r0.x) + (r0.x);
    r0.x = dot(r4.xy, r4.xy) + (c38.z);
    r0.z = dot(r5.xy, r5.xy) + (c38.z);
    r0.x = exp2(-(r0.x));
    r0.z = exp2(-(r0.z));
    r1.w = (r0.x) * (c1.x) + (c1.y);
    r0.z = (r0.z) * (c1.x) + (c1.y);
    ...
    r0.w = rsqrt(r0.w);
    r16.xyz = (r3.www) * (v6.xyz);
    r17.xyz = (r0.xyz) * (r0.www);
    r0.xyz = (r0.xyz) * (r0.www) + (-(r16.xyz));
    r0.w = dot(r17.xyz, c[29].xyz);
    r15.xyz = normalize(r0.xyz);
    r0.z = saturate((r0.w) * (c[30].x) + (c[30].y));
    r0.w = saturate(dot(r15.xyz, r17.xyz));
    r2.w = (r0.z) * (c15.z) + (c15.w);
    r1.w = (r0.z) * (r0.z);
    r0.xyz = (v6.xyz) * (-(r3.www)) + (c[17].xyz);
    r7.w = (r2.w) * (r1.w);
    r14.xyz = normalize(r0.xyz);
    r0.z = (-(r0.w)) + (-(c38.y));
    r0.y = saturate(dot(r14.xyz, c[17].xyz));
    r0.w = (r0.z) * (r0.z);
    r1.w = (-(r0.y)) + (-(c38.y));
    r0.y = (r0.w) * (r0.w);
    r0.w = (r1.w) * (r1.w);
    ...
    r2.w = (r0.w) * (r0.w);
    r0 = tex2D(s8, v7.zw);
    r10.xyz = lerp(c[36].xyw, r0.yyy, r5.www);
    r8.w = (r1.w) * (r2.w);
    r18.xyz = (r1.xyz) * (r10.yyy);
    r1 = tex2D(s12, v0.zw);
    r1.w = ((-abs(r1.y)) >= 0.0f ? (-(c38.y)) : (-(c38.z)));
    r0 = (r0.wwww) * (-(c38.zzzy)) + (-(c38.wwwz));
    r3 = tex2D(s7, v0.xy);
    r2 = lerp(r3, r0, r5.wwww);
    r0 = v1;
    r0.xyz = (r4.xxx) * (v4.xyz) + (r0.xyz);
    r12.xyz = (r2.xyz) * (-(r2.xyz)) + (-(c38.yyy));
    ...
    r3.xyz = (r3.www) * (r2.xyz) + (r18.xyz);
    r5.y = (r2.w) * (c1.w);
    r5.w = saturate(dot(r17.xyz, r9.xyz));
    r0.z = saturate(dot(r9.xyz, -(r16.xyz)));
    r0.y = (r5.w) * (r10.w) + (r5.y);
    r5.z = (r0.z) * (r10.w) + (r5.y);
    r0.x = (r0.y) * (r5.z) + (c14.x);
    ...
    r1.w = (r4.z) * (c14.y) + (c14.z);
    r0.z = (r9.w) * (r10.w) + (r5.y);
    r0.z = (r0.z) * (r5.z) + (c14.x);
    r1.z = saturate(dot(r9.xyz, r14.xyz));
    r0.y = 1.0f / (r0.z);
    r0.z = pow(abs(r1.z), r4.z);
    r0.y = (r9.w) * (r0.y);
    r0.z = (r1.w) * (r0.z);
    r1.y = (r0.y) * (r0.z);
    r0.xyz = (r12.xyz) * (r8.www) + (r13.xyz);
    r1.z = pow(abs(r4.w), r4.z);
    ...
    r3.xyz = (r7.xyz) * (r3.xyz) + (r1.xyz);
    r1 = (v6.yyyy) * (c[32]);
    r2.xyz = (r8.xyz) * (r2.xyz);
    r1 = (v6.xxxx) * (c[31]) + (r1);
    r8.xyz = (r2.xyz) * (c1.zzz) + (r3.xyz);
    r1 = (v6.zzzz) * (c[33]) + (r1);
    ...
    r1.xy = (r1.xy) * (r1.xy);
    r0.z = ((-abs(r0.z)) >= 0.0f ? (c38.z) : (r1.w));
    r1.w = (r2.x) * (r1.x);
    r0.z = (r0.z) * (r1.w);
    r1.w = (r1.y) * (-(r2.y)) + (-(c38.y));
    r0.xy = (r2.ww) * (r0.xy);
    r0.z = (r0.z) * (r1.w);
    r7.w = (r7.w) * (r0.z);
