// Mechanically reconstructed from 0x05D87621.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = float2(((r4.w) >= 0.0f ? (r2.x) : (r4.x)), ((r4.w) >= 0.0f ? (r2.y) : (r4.y)));
    ...
    r6.xy = (r2.xy) * (r3.xy);
    r2.xyw = c[29].xyw;
    r3.xyz = float3(((r4.w) >= 0.0f ? (r2.x) : (c[28].x)), ((r4.w) >= 0.0f ? (r2.y) : (c[28].y)), ((r4.w) >= 0.0f ? (r2.w) : (c[28].w)));
    r1.w = (r1.w) * (r6.x);
