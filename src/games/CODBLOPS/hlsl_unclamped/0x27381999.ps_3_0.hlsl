// Mechanically reconstructed from 0x27381999.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.x = dot(r6.xy, r1.xy) + (c14.z);
    r4.y = dot(r6.xy, r1.zw) + (c14.z);
    r1 = tex2D(s4, v6.zw);
    r12.w = (r1.w) * (v6.y);
    r6.xy = (r0.yw) * (c3.xx) + (c3.yy);
    r7.xy = lerp(r9.xy, r4.xy, r12.ww);
    ...
    r9.y = (r0.z) + (r0.z);
    r6.zw = c14.zw;
    r2.xyz = (r6.zwz) + (-(c[36].xyw));
    r0.xyz = (r9.xyz) * (r0.www) + (r3.xyz);
    r11.xyz = (r12.www) * (r2.xyz) + (c[36].xyw);
