// Mechanically reconstructed from 0x09D0C0EE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = r0.y;
    r3.w = (r1.w) * (c3.x) + (c3.y);
    r4.xy = (r2.yw) * (c38.xx) + (c38.yy);
    r1 = tex2D(s14, v1.zw);
    r5.xy = (r1.xy) * (c3.ww);
    r1.w = dot(r4.xy, r6.xy) + (c1.y);
    r2.xy = (r2.xz) * (r5.xx);
    r0.w = (r1.x) * (c3.w) + (-(r2.x));
    r3.xy = (r0.xz) * (r5.yy);
    r0.y = (r2.z) * (-(r5.x)) + (r0.w);
    ...
    r2.w = saturate((r0.w) * (c[30].x) + (c[30].y));
    r5.z = (r2.w) * (c15.z) + (c15.w);
    r0 = v2;
    ...
    r0.y = saturate(dot(r9.xyz, -(r1.xyz)));
    r0.x = (r8.w) * (r3.w) + (r0.z);
    r2.w = (r0.y) * (r3.w) + (r0.z);
    r7.w = (r5.z) * (r5.w);
    ...
    r3.y = dot(r1.xyz, r9.xyz);
    r0.x = 1.0f / (r0.x);
    r11.w = (r3.y) + (r3.y);
    r10.w = (r3.z) * (r0.x);
    r3.z = exp2(r0.y);
    r0.y = saturate(dot(r9.xyz, c[17].xyz));
    r0.x = (r3.z) * (c13.y) + (c13.z);
    r0.z = (r0.y) * (r3.w) + (r0.z);
    r3.w = saturate(dot(r9.xyz, r4.xyz));
    r2.w = (r0.z) * (r2.w) + (c13.x);
    r0.z = pow(abs(r3.w), r3.z);
    r2.w = 1.0f / (r2.w);
    r0.z = (r0.x) * (r0.z);
    r2.w = (r0.y) * (r2.w);
    r3.w = saturate(dot(r9.xyz, r2.xyz));
    r0.z = (r0.z) * (r2.w);
    r2.w = pow(abs(r3.w), r3.z);
    r0.z = (r4.w) * (r0.z);
    r12.w = (r0.x) * (r2.w);
    r12.y = (r12.x) * (r0.z);
    r2 = tex2D(s12, v1.zw);
