// Mechanically reconstructed from 0xD00752A8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.x = 1.0f / (r3.w);
    r4.y = (r0.w) + (r0.w);
    r1.xy = saturate((r9.xx) * (c[32].xy) + (c[32].zw));
    r0.xy = (r1.xy) * (r1.xy);
