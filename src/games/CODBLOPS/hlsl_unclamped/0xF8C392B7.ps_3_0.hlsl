// Mechanically reconstructed from 0xF8C392B7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c30 = float4(4.0f, -2.0f, 0.797884583f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0.y = dot(r2.xy, r1.zw) + (c3.z);
    r0.x = dot(r2.xy, r1.xy) + (c3.z);
    r1 = tex2D(s1, v1.xy);
    ...
    r0 = tex2D(s5, v7.zw);
    r5.w = (r0.w) * (v0.z);
    r10.xy = (r5.ww) * (-(r1.xy)) + (r1.xy);
    r5.xyz = float3(((r3.w) >= 0.0f ? (r4.x) : (r5.x)), ((r3.w) >= 0.0f ? (r4.y) : (r5.y)), ((r3.w) >= 0.0f ? (r4.z) : (r5.z)));
    r1.w = dot(r10.xy, r10.xy) + (c3.z);
    r0.w = ((r3.w) >= 0.0f ? (r2.y) : (r3.y));
    r1.w = exp2(-(r1.w));
    r4.xyz = lerp(r5.xyz, r0.xyz, r5.www);
    r4.w = (r1.w) * (c4.z) + (c4.w);
    r13.xyz = lerp(r0.www, c[27].xyw, r5.www);
    r0.xy = (v1.zw) * (-(c3.yw));
    r3 = tex2D(s13, r0.xy);
    ...
    r2 = tex2D(s14, v1.zw);
    r5.xy = (r2.xy) * (c12.zz);
    r6.xy = (r3.yw) * (c30.xx) + (c30.yy);
    r1.xy = (r3.xz) * (r5.xx);
    r0.w = dot(r6.xy, r10.xy) + (c3.z);
    ...
    r3.z = saturate(dot(r16.xyz, r3.xyz));
    r10.w = (r0.w) * (c12.y);
