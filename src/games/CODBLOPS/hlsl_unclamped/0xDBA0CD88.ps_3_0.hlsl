// Mechanically reconstructed from 0xDBA0CD88.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.x = dot(r2.xy, r1.xy) + (c3.w);
    r4.y = dot(r2.xy, r1.zw) + (c3.w);
    r2 = tex2D(s3, v7.xy);
    r8.w = (r2.w) * (v0.y);
    ...
    r12.xyz = (r1.zzz) * (r3.xyz);
    r3.xyz = (r0.xyz) * (-(r1.xxx)) + (r2.xyz);
    r2.xyz = (r7.zzz) * (r12.xyz);
