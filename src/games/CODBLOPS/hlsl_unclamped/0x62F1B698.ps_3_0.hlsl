// Mechanically reconstructed from 0x62F1B698.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r3.w) * (r1.w);
    r3.xyz = (r0.xyz) * (r0.xyz);
    r0.xyz = (r0.xyz) * (-(r0.xyz)) + (c0.www);
    r1.xyz = (r1.xyz) * (c0.zzz);
    r7.xyz = (r0.xyz) * (r1.www) + (r3.xyz);
    r3.w = exp2(r8.y);
    r1.xyz = (r1.xyz) * (r7.xyz);
    r9.xyz = (r2.xyz) * (r2.www) + (-(r5.xyz));
    r7.xyz = (r1.xyz) * (c[37].xxx);
    r1 = tex2D(s5, v1.xy);
