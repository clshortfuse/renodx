// Mechanically reconstructed from 0x8B2268C3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s11, v7.zw);
    r12.xy = lerp(r3.xy, r0.wy, r3.ww);
    r9.xyz = (r2.xyz) * (r2.xyz);
    r8.w = (r12.x) * (-(c35.z)) + (c35.w);
    ...
    r2.z = (r2.z) * (r7.w) + (c14.x);
    r0.z = saturate(dot(r0.xyz, r1.xyz));
    r0.y = 1.0f / (r2.z);
    r0.x = (r0.w) * (r0.y);
    r13.xy = (r12.xx) * (c34.xy) + (c34.zw);
    r4.z = exp2(r13.y);
    r0.y = (-(r0.z)) + (-(c3.y));
