// Mechanically reconstructed from 0x4721CC46.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = (r2.xy) * (r3.xy);
    r6.w = c1.y;
    r11.xyz = float3(((r1.w) >= 0.0f ? (r6.w) : (c[41].x)), ((r1.w) >= 0.0f ? (r6.w) : (c[41].y)), ((r1.w) >= 0.0f ? (r6.w) : (c[41].w)));
    r0.w = (r0.w) * (r2.x);
    ...
    r3.w = (r5.w) * (c13.z) + (c13.w);
    r11.y = (r8.w) * (r1.y);
    r8.w = (r1.z) * (r3.w);
    r1.xyz = (r2.xyz) * (r12.www) + (r3.xyz);
    r8.w = (r11.y) * (r8.w);
    r9.w = (-(r9.w)) + (c1.y);
