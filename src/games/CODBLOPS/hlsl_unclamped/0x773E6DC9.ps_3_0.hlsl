// Mechanically reconstructed from 0x773E6DC9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = (r0.z) * (r3.w) + (r3.z);
    r3.w = (r0.x) * (r3.w) + (r3.z);
    r7.xyz = float3(((r7.w) >= 0.0f ? (c[36].x) : (r3.y)), ((r7.w) >= 0.0f ? (c[36].y) : (r3.y)), ((r7.w) >= 0.0f ? (c[36].w) : (r3.y)));
    r0.y = (r0.y) * (r3.w) + (c4.x);
    r5.w = (-(r0.x)) + (-(c2.y));
    r0.y = 1.0f / (r0.y);
    r4.w = (r0.z) * (r0.y);
    r4.xyz = (r8.xyz) * (r1.www) + (-(r11.xyz));
