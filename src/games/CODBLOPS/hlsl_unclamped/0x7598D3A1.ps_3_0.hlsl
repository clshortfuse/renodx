// Mechanically reconstructed from 0x7598D3A1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = dot(r1.xy, r0.zw) + (c3.w);
    r8.x = dot(r1.xy, r0.xy) + (c3.w);
    r2 = tex2D(s1, v1.xy);
    r3 = tex2D(s3, v7.xy);
    r4.w = (r3.w) * (v0.y);
    r1 = tex2D(s7, v1.xy);
    ...
    r3.xy = (r3.xz) * (r8.xx);
    r1.w = dot(r9.xy, r7.xy) + (c3.w);
    r1.y = (r2.x) * (c12.w) + (-(r3.x));
    r2.w = (r3.z) * (-(r8.x)) + (r1.y);
    r5.xy = (r1.xz) * (r8.yy);
    r1.y = (r2.y) * (c12.w) + (-(r5.x));
    r1.x = dot(r9.xy, r9.xy) + (c3.w);
    r1.y = (r1.z) * (-(r8.y)) + (r1.y);
    r1.z = exp2(-(r1.x));
    r10.y = (r2.w) + (r2.w);
    r1.z = (r1.z) * (c4.x) + (c4.y);
