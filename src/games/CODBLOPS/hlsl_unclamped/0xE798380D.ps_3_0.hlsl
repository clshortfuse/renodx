// Mechanically reconstructed from 0xE798380D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s5, v7.zw);
    r3.w = (r0.w) * (v7.y);
    r4.xy = lerp(r3.xy, r2.xy, r3.ww);
    r2.xyz = lerp(r1.xyz, r0.xyz, r3.www);
    r0.w = dot(r4.xy, r4.xy) + (c38.z);
    ...
    r0.y = (r0.z) * (-(r8.y)) + (r0.y);
    r8.y = (r0.x) + (r0.x);
    r0.z = dot(r7.xy, r7.xy) + (c38.z);
    r0.y = (r0.y) + (r0.y);
    r0.z = exp2(-(r0.z));
    r0.z = (r0.z) * (c1.x) + (c1.y);
    r1.xyz = (v6.xyz) * (-(r3.zzz)) + (c[17].xyz);
    r0.z = (r4.w) * (r0.z);
    ...
    r8.xz = (r3.xy) * (c4.xx);
    r1.w = (r1.w) * (r1.w);
    r2.xyz = (r8.xyz) * (r4.www) + (r0.xyz);
    r8.w = (r0.w) * (r1.w);
    r1 = tex2D(s12, v0.zw);
    r0.xyz = (-(v6.xyz)) + (c[20].xyz);
    r0.w = dot(r0.xyz, r0.xyz);
    r0.w = rsqrt(r0.w);
    r12.xyz = (r3.zzz) * (v6.xyz);
    r3.xyz = (r0.xyz) * (r0.www) + (-(r12.xyz));
    r11.xyz = normalize(r3.xyz);
    r13.xyz = (r0.xyz) * (r0.www);
    r0.w = saturate(dot(r11.xyz, r13.xyz));
    r1.w = ((-abs(r1.y)) >= 0.0f ? (c38.w) : (c38.z));
    r1.z = (-(r0.w)) + (c38.w);
    r6.w = dot(r13.xyz, c[29].xyz);
    r0.w = (r1.z) * (r1.z);
    r1.x = (r0.w) * (r0.w);
    r0 = v1;
    ...
    r7.zw = c38.zw;
    r0.xyz = (r7.zwz) + (-(c[36].xyw));
    r9.xyz = normalize(r3.xyz);
    r7.xyz = (r3.www) * (r0.xyz) + (c[36].xyw);
    ...
    r3.xyz = (r4.www) * (r14.xyz) + (r15.xyz);
    r3.w = saturate(dot(r13.xyz, r9.xyz));
    r2 = tex2D(s7, v0.xy);
    r4.xyz = (r2.xyz) * (-(r2.xyz)) + (c38.www);
    r2.xyz = (r2.xyz) * (r2.xyz);
    r0.xyz = (r4.xyz) * (r10.www) + (r2.xyz);
    r5.w = (r2.w) * (-(c4.z)) + (c4.w);
    r10.w = (r2.w) * (c1.w);
    r5.z = saturate(dot(r9.xyz, -(r12.xyz)));
    r1.w = (r3.w) * (r5.w) + (r10.w);
    r7.y = (r5.z) * (r5.w) + (r10.w);
    r1.z = (r1.w) * (r7.y) + (c14.x);
    ...
    r1.w = (r5.y) * (c14.y) + (c14.z);
    r5.w = (r9.w) * (r5.w) + (r10.w);
    r5.w = (r5.w) * (r7.y) + (c14.x);
    r5.x = saturate(dot(r9.xyz, r10.xyz));
    r5.w = 1.0f / (r5.w);
    r7.y = pow(abs(r5.x), r5.y);
    r5.x = (r9.w) * (r5.w);
    r5.w = (r1.w) * (r7.y);
    r5.w = (r5.x) * (r5.w);
    r2.xyz = (r4.xyz) * (r8.www) + (r2.xyz);
    r4.z = pow(abs(r5.z), r5.y);
