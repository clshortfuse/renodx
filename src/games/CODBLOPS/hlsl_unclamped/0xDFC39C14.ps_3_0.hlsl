// Mechanically reconstructed from 0xDFC39C14.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = dot(r5.xy, r4.xy) + (c2.w);
    r0.y = dot(r5.xy, r4.zw) + (c2.w);
    r5 = tex2D(s3, v6.zw);
    r6.w = (r5.w) * (v0.z) + (c3.x);
