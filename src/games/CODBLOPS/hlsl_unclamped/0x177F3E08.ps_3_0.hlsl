// Mechanically reconstructed from 0x177F3E08.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = saturate((r0.w) * (c[24].x) + (c[24].y));
    r0 = v2;
