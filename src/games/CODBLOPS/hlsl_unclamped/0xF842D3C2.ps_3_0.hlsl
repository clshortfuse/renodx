// Mechanically reconstructed from 0xF842D3C2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = (r1) * (r1) + (r0);
    r6.w = saturate(dot(r4.xyz, r7.xyz));
    r4.x = rsqrt(r0.x);
    r4.y = rsqrt(r0.y);
    r4.z = rsqrt(r0.z);
    r4.w = rsqrt(r0.w);
    r6.xyz = c[22].xyz;
    r6.xyz = (r6.xyz) * (c[23].xxx);
    r3 = (r3) * (r4);
    r3 = (r7.yyyy) * (r3);
    r2 = (r2) * (r4);
    r1 = (r1) * (r4);
    ...
    r1 = tex2D(s0, v1.xy);
    r1.xyz = saturate((r4.xyz) * (r1.www) + (r1.xyz));
    r2.y = dot(c[11], r0);
