// Mechanically reconstructed from 0x72CE71EB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s2, v1.xy);
    r2 = float4(((r4.w) >= 0.0f ? (r1.x) : (c0.z)), ((r4.w) >= 0.0f ? (r1.y) : (c0.z)), ((r4.w) >= 0.0f ? (r1.z) : (c0.z)), ((r4.w) >= 0.0f ? (r1.w) : (c0.y)));
