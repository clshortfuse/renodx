// Mechanically reconstructed from 0xB1D4B923.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s2, r1.xy);
    r1.xy = (v2.ww) * (c[28].xy) + (v2.xy);
    r1.zw = v2.zw;
    r1 = tex2Dproj(s1, r1);
    r2.xy = (v2.ww) * (-(c[28].xy)) + (v2.xy);
    r2.zw = v2.zw;
    r2 = tex2Dproj(s1, r2);
    r1.y = r2.x;
    r2.xy = (v2.ww) * (c[28].zw) + (v2.xy);
    r2.zw = v2.zw;
    r2 = tex2Dproj(s1, r2);
    r1.z = r2.x;
    r2.xy = (v2.ww) * (-(c[28].zw)) + (v2.xy);
