// Mechanically reconstructed from 0x80D1FC02.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r0.y) * (c4.x) + (c4.y);
    r0.y = (r0.w) * (c4.x) + (c4.y);
    r0.w = dot(r5.xy, r6.xy) + (c3.z);
    r0.y = (r1.w) * (r0.y);
    r5.xyz = float3(((r4.w) >= 0.0f ? (r2.x) : (r3.x)), ((r4.w) >= 0.0f ? (r2.y) : (r3.y)), ((r4.w) >= 0.0f ? (r2.z) : (r3.z)));
    r0.w = saturate((r0.w) * (r0.y) + (r0.y));
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c11.xx);
    r3.xy = (r1.xz) * (r7.xx);
    r1.xy = (r0.xz) * (r7.yy);
    r0.x = (r2.x) * (c11.x) + (-(r3.x));
    r0.y = (r2.y) * (c11.x) + (-(r1.x));
    r1.z = (r1.z) * (-(r7.x)) + (r0.x);
    r0.z = (r0.z) * (-(r7.y)) + (r0.y);
    r0.y = (r0.z) + (r0.z);
    r0.xz = (r1.xy) * (c11.yy);
    ...
    r1.w = (r1.w) * (r3.w);
    r2.z = c3.y;
    r11.xyz = float3(((r4.w) >= 0.0f ? (-(r2.z)) : (c[8].x)), ((r4.w) >= 0.0f ? (-(r2.z)) : (c[8].y)), ((r4.w) >= 0.0f ? (-(r2.z)) : (c[8].w)));
