// Mechanically reconstructed from 0x87369120.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r2.w) * (c10.x) + (c10.y);
    r3.xyz = (v0.zzz) * (r3.xyz) + (c2.www);
    r1.w = 1.0f / (r1.w);
