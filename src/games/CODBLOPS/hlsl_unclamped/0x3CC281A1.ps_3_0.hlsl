// Mechanically reconstructed from 0x3CC281A1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xy = (v1.xy) + (c1.xx);
    r1.z = c1.y;
    r3.xy = (r1.xy) * (c[37].xx) + (r1.zz);
    r0 = tex2D(s0, v1.xy);
    r2.xyz = (r0.xyz) * (v0.xyz);
    r0 = tex2D(s7, r3.xy);
    r0.xyz = (r2.xyz) * (-(r2.xyz)) + (r0.xyz);
    r0.w = (r0.w) + (c3.z);
    r1.xy = (r1.xy) * (c[36].xx) + (r1.zz);
    r1 = tex2D(s6, r1.xy);
    ...
    if ((c3.x) >= (v6.w))
    {
        ...
        if ((c12.w) < (v6.w))
        {
            ...
            r2.z = r4.x;
            r2.w = r3.x;
            r1.y = dot(r2, c13.yyyy);
            r1.x = (-(r1.z)) + (r1.y);
            r1.y = (v6.w) * (c14.x) + (c14.y);
            r2.w = (r1.y) * (r1.x) + (r1.z);
        }
        else
        {
