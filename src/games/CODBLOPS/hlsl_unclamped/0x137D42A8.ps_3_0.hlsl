// Mechanically reconstructed from 0x137D42A8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = c2.w;
    r4.xyz = float3(((r8.w) >= 0.0f ? (r6.w) : (c[39].x)), ((r8.w) >= 0.0f ? (r6.w) : (c[39].y)), ((r8.w) >= 0.0f ? (r6.w) : (c[39].w)));
    r2 = tex2D(s8, v7.zw);
    ...
    r0.w = exp2(r5.y);
    r3.w = (-(r3.w)) + (c2.w);
    r4.y = pow(abs(r7.w), r0.w);
    r4.z = (r3.w) * (r3.w);
    r0.w = (r0.w) * (c14.y) + (c14.z);
    r4.z = (r4.z) * (r4.z);
    r0.w = (r4.y) * (r0.w);
    r3.w = (r3.w) * (r4.z);
    ...
    r2 = tex2D(s0, v1.xy);
    r5.xyz = float3(((r8.w) >= 0.0f ? (r1.x) : (r2.x)), ((r8.w) >= 0.0f ? (r1.y) : (r2.y)), ((r8.w) >= 0.0f ? (r1.z) : (r2.z)));
