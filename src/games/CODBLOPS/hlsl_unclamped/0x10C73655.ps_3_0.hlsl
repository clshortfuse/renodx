// Mechanically reconstructed from 0x10C73655.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c27 = float4(3.5f, -13.0f, 1.0f, 13.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0.xyw = c[24].xyw;
    r2.xyz = (-(r0.xyw)) + (c[25].xyw);
    r0 = tex2D(s5, v8.zw);
    r0.w = (r0.w) * (v0.z);
    r3.xyz = (r3.www) * (r2.xyz) + (c[24].xyw);
    r2.xyz = lerp(r4.xyz, r0.xyz, r0.www);
    r11.xyz = lerp(r3.xyz, c3.xxx, r0.www);
    r7.xy = (r0.ww) * (-(r5.xy)) + (r5.xy);
    r0 = tex2D(s6, v9.xy);
    ...
    r5.xyz = (r3.xyz) * (r0.www) + (-(r15.xyz));
    r4.xyz = normalize(r5.xyz);
    r10.xyz = (r3.xyz) * (r0.www);
    r3.xyz = (v0.www) * (r0.xyz) + (c3.xxx);
    r0.w = saturate(dot(r4.xyz, r10.xyz));
    r1.xyz = (r1.xyz) * (r3.xyz);
    r2.w = (-(r0.w)) + (c3.x);
    r12.xyz = (r1.xyz) * (-(r1.xyz)) + (c3.xxx);
    r0.w = (r2.w) * (r2.w);
    r3.w = (r0.w) * (r0.w);
    r0 = v2;
