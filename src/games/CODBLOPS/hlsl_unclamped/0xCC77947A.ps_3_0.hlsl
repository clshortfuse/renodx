// Mechanically reconstructed from 0xCC77947A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.z = saturate(dot(r3.xyz, c[17].xyz));
    r0 = tex2D(s3, v7.zw);
    ...
    r0.w = (r6.w) * (-(c12.z)) + (c12.w);
    r7.w = saturate(dot(r9.xyz, -(r12.xyz)));
    r0.z = (r6.w) * (c4.z);
    r1.w = saturate(dot(r9.xyz, c[17].xyz));
    r2.w = (r7.w) * (r0.w) + (r0.z);
    r0.w = (r1.w) * (r0.w) + (r0.z);
    r0.xyz = (r10.xyz) * (r2.zzz) + (r11.xyz);
    r0.w = (r0.w) * (r2.w) + (c13.x);
    r2.w = 1.0f / (r0.w);
    r16.xy = (r6.ww) * (c14.xy) + (c14.zw);
    r3.z = saturate(dot(r9.xyz, r3.xyz));
    r0.w = exp2(r16.y);
    r2.z = pow(abs(r3.z), r0.w);
    r0.w = (r0.w) * (c13.y) + (c13.z);
    r2.w = (r1.w) * (r2.w);
    r0.w = (r2.z) * (r0.w);
    r15.xz = c1.xz;
    r2.xyz = (r15.zzz) + (c[20].xyw);
    r0.w = (r2.w) * (r0.w);
    r7.xyz = (r3.www) * (r2.xyz) + (c1.xxx);
    r0.xyz = (r0.xyz) * (r0.www);
    r13.xyz = (r1.xyz) * (r7.yyy);
    r14.xyz = (r7.zzz) * (r0.xyz);
    r0 = tex2D(s12, v0.zw);
