// Mechanically reconstructed from 0x86C2FB93.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xz = (r2.xy) * (c12.xx);
    r4.w = saturate(dot(r5.xyz, c[17].xyz));
    ...
    r12.xyz = float3(((r4.z) >= 0.0f ? (c[20].x) : (r0.y)), ((r4.z) >= 0.0f ? (c[20].y) : (r0.y)), ((r4.z) >= 0.0f ? (c[20].w) : (r0.y)));
    r1 = (r0.wwww) * (c1.yyyz) + (c1.wwwy);
    r0 = tex2D(s6, v8.xy);
    r1 = float4(((r4.z) >= 0.0f ? (r0.x) : (r1.x)), ((r4.z) >= 0.0f ? (r0.y) : (r1.y)), ((r4.z) >= 0.0f ? (r0.z) : (r1.z)), ((r4.z) >= 0.0f ? (r0.w) : (r1.w)));
    r0 = tex2D(s4, v8.zw);
    r0.xyz = (r0.xyz) + (-(c1.zzz));
    r4.xyz = (v0.zzz) * (r0.xyz) + (c1.zzz);
    r0.w = (-(r4.w)) + (c1.z);
