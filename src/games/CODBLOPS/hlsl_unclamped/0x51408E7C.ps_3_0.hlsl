// Mechanically reconstructed from 0x51408E7C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.y = (r0.z) + (r0.z);
    r0.w = (r1.y) * (r0.w);
    r0.xyz = (r6.xyz) * (r1.xxx) + (r9.xyz);
    r2.xyz = (r0.www) * (c[22].xyz);
    r0.xyz = (r1.yyy) * (r0.xyz);
    r3.xyz = (r4.www) * (r2.xyz);
    r2.xyz = (r4.www) * (r5.xyz) + (r0.xyz);
    r0 = tex2D(s0, v1.xy);
    r0 = (r0.wxyz) * (v0.wxyz);
    ...
    r1.xyz = max(((r1.xyz) * (c[25].xxx)), 0.0f); // HDR: removed only the 1.0 ceiling
    r0.w = rsqrt(r0.x);
    r0.x = rsqrt(r1.x);
    r0.y = rsqrt(r1.y);
    r0.z = rsqrt(r1.z);
