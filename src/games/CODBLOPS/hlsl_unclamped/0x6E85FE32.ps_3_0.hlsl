// Mechanically reconstructed from 0x6E85FE32.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.y = saturate(dot(r4.xyz, -(r9.xyz)));
    r3.y = (r2.w) * (c2.y);
    r1.z = (r2.w) * (-(c2.y)) + (c2.z);
    ...
    r1.y = c1.z;
    r1.xyz = float3(((r3.w) >= 0.0f ? (c[7].x) : (r1.y)), ((r3.w) >= 0.0f ? (c[7].y) : (r1.y)), ((r3.w) >= 0.0f ? (c[7].w) : (r1.y)));
    ...
    r3.xyz = (r3.xyz) * (r1.zzz) + (v7.xyz);
    r3 = tex3D(s11, r3.xyz);
    r6.xyz = (r2.xyz) * (r3.www);
    r2.xyz = (r10.xxx) * (c[18].xyz);
