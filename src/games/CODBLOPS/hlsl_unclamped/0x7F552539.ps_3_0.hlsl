// Mechanically reconstructed from 0x7F552539.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = dot(r6.xy, r6.xy) + (c6.w);
    r0.y = dot(r1.xy, r1.xy) + (c6.w);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c1.x) + (c1.y);
    r1.w = (r0.y) * (c1.x) + (c1.y);
    r0.y = dot(r1.xy, r6.xy) + (c6.w);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v1.zw);
    r7.xy = (r1.xy) * (c3.ww);
    ...
    r2.xyz = (v0.zzz) * (r2.xyz) + (c6.xxx);
    r6.w = (r1.w) * (-(c4.z)) + (c4.w);
    r1.xyz = (r2.xyz) * (c6.zzz);
