// Mechanically reconstructed from 0x653989C7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xy = (r8.ww) * (r1.yz) + (c1.xx);
    r2.w = saturate(dot(r5.xyz, r2.xyz));
    r1.xy = (r8.xx) * (c13.xy) + (c13.zw);
    r1.z = exp2(r1.y);
    r6.w = 1.0f / (r1.x);
