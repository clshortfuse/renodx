// Mechanically reconstructed from 0x91C2E560.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(-0.5f, 0.797884583f, 1.0f, 0.0009765625f);
    const float4 c2 = float4(-13.0f, 13.0f, 0.125f, 0.25f);
    const float4 c3 = float4(2.0f, -1.0f, 1.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r2.x = dot(r4.xy, r0.xy) + (c3.w);
    r2.y = dot(r4.xy, r0.zw) + (c3.w);
    r0 = tex2D(s4, v6.zw);
    r3.w = (r0.w) * (v0.z) + (c1.x);
