// Mechanically reconstructed from 0x179AE9CB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s5, v7.zw);
    r2.w = (r2.w) * (v0.z) + (c1.x);
    r0.xyz = (r7.xyz) * (r5.www) + (r5.xyz);
    r6.xyz = float3(((r2.w) >= 0.0f ? (c1.y) : (r1.x)), ((r2.w) >= 0.0f ? (c1.z) : (r1.y)), ((r2.w) >= 0.0f ? (c1.y) : (r1.z)));
