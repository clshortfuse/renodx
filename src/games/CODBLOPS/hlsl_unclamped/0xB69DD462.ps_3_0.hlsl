// Mechanically reconstructed from 0xB69DD462.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.x = dot(r5.xy, r0.xy) + (c3.x);
    r7.y = dot(r5.xy, r0.zw) + (c3.x);
    r0 = tex2D(s4, v6.zw);
    r5.w = (r0.w) * (v0.z);
    ...
    r5.y = (r2.w) + (r2.w);
    r1.w = c2.w;
    r3.xyz = float3(((r6.w) >= 0.0f ? (r1.w) : (c[31].x)), ((r6.w) >= 0.0f ? (r1.w) : (c[31].y)), ((r6.w) >= 0.0f ? (r1.w) : (c[31].w)));
    r2.xyz = (r5.xyz) * (r0.www) + (r4.xyz);
    r9.xyz = lerp(r3.xyz, c[32].xyw, r5.www);
