// Mechanically reconstructed from 0x665F70B1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = (r7.xyz) * (r0.www) + (r1.xyz);
    r1 = tex2D(s6, v1.xy);
    r0 = tex2D(s7, v7.zw);
    r4.w = ((r6.w) >= 0.0f ? (r0.y) : (r1.y));
    r3.w = r1.w;
