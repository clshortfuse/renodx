// Mechanically reconstructed from 0xA6C25FB9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = (r0.w) + (r0.w);
    r0.zw = c15.zw;
    r3.xyz = (r0.zwz) + (-(c[32].xyw));
    r0.xyz = v2.xyz;
    r0.xyz = (r7.xxx) * (v4.xyz) + (r0.xyz);
    r3.xyz = (r5.www) * (r3.xyz) + (c[32].xyw);
    ...
    r0.w = (r0.y) + (c15.w);
    r0.y = (r2.w) + (r2.w);
    r6.xyz = (r1.www) * (r0.xwz) + (r3.xyz);
    r3.xyz = (r12.xyz) * (-(r0.yyy)) + (r4.xyz);
    r0 = tex2D(s8, v1.xy);
    r3.w = (r0.w) * (c2.z);
