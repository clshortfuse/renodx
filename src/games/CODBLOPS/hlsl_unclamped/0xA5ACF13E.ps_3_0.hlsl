// Mechanically reconstructed from 0xA5ACF13E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = dot(r1.xy, r0.zw) + (c42.z);
    r2.x = dot(r1.xy, r0.xy) + (c42.z);
    r0 = tex2D(s1, v1.xy);
    ...
    r3.xyz = lerp(c[39].xyw, r1.yyy, r6.www);
    r1 = tex2D(s6, v7.zw);
    r1.w = (r1.w) * (v0.z);
    r2.xyz = lerp(r4.xyz, r1.xyz, r1.www);
    r7.xy = (r1.ww) * (-(r5.xy)) + (r5.xy);
    r13.xyz = lerp(r3.xyz, -(c42.yyy), r1.www);
