// Mechanically reconstructed from 0x9F9A111C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.w = (r3.z) * (r2.w) + (r7.z);
    r1.w = (r10.w) * (r2.w) + (r7.z);
    r8.w = (-(r3.z)) + (c2.x);
    r1.w = (r1.w) * (r5.w) + (c2.z);
    r3.z = 1.0f / (r1.w);
    r3.xy = (r7.ww) * (c3.xy) + (c3.zw);
    r4.w = saturate(dot(r10.xyz, r1.xyz));
    r6.w = exp2(r3.y);
    r1.w = pow(abs(r4.w), r6.w);
    r4.w = (r6.w) * (c4.x) + (c4.y);
    r1.z = (r10.w) * (r3.z);
    r1.w = (r1.w) * (r4.w);
    r7.x = 1.0f / (r3.x);
