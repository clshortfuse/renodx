// Mechanically reconstructed from 0x9C82B302.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = (r2.w) * (r0.z);
    r11.y = (r14.x) * (-(c12.z)) + (c12.w);
    r11.x = (r14.x) * (c3.w);
    r2.w = saturate(dot(r1.xyz, r8.xyz));
    r10.w = saturate(dot(r8.xyz, -(r9.xyz)));
    r0.z = (r2.w) * (r11.y) + (r11.x);
    r11.z = (r10.w) * (r11.y) + (r11.x);
    r0.z = (r0.z) * (r11.z) + (c14.x);
    r13.xy = (r14.xx) * (c30.xy) + (c30.zw);
    r0.x = 1.0f / (r0.z);
    r11.w = exp2(r13.y);
