// Mechanically reconstructed from 0x1475E11A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xy = (v1.zw) * (c6.xy) + (c6.zy);
    r0 = tex2D(s13, r0.xy);
    r1.xy = (v1.zw) * (-(c1.xw));
    r2 = tex2D(s13, r1.xy);
    r0.w = r2.y;
    r4.xyz = (r9.xyz) * (r1.zzz) + (r10.xyz);
    r1.xy = (r0.wy) * (c7.xx) + (c7.yy);
    r0.y = dot(r11.xy, r11.xy) + (c4.x);
    r0.w = dot(r1.xy, r1.xy) + (c4.x);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r4.w = (r0.y) * (c3.x) + (c3.y);
    r0.y = (r0.w) * (c3.x) + (c3.y);
    r0.w = dot(r1.xy, r11.xy) + (c4.x);
    r0.y = (r4.w) * (r0.y);
    r2.w = (r1.w) * (-(c7.z)) + (c7.w);
    r6.w = saturate((r0.w) * (r0.y) + (r0.y));
    r3 = tex2D(s14, v1.zw);
    r1.xy = (r3.xy) * (c3.ww);
    r6.xy = (r2.xz) * (r1.xx);
    r0.xy = (r0.xz) * (r1.yy);
    ...
    r2.xz = (r0.xy) * (c6.ww);
    r0 = v2;
    r1.xyz = (r11.xxx) * (v5.xyz) + (r0.xyz);
    r0.xyz = (r6.www) * (r2.xyz);
    r2.xyz = (r11.yyy) * (v4.xyz) + (r1.xyz);
    r1.xyz = normalize(r2.xyz);
    r11.xyz = (r5.www) * (v7.xyz);
    r8.w = saturate(dot(r1.xyz, -(r11.xyz)));
    r2.y = (r1.w) * (c3.z);
    r3.y = saturate(dot(r1.xyz, r5.xyz));
    r2.z = (r8.w) * (r2.w) + (r2.y);
    r15.xy = (r1.ww) * (c9.xy) + (c9.zw);
