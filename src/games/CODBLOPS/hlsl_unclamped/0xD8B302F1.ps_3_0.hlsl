// Mechanically reconstructed from 0xD8B302F1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(1.0f, 3.5f, 0.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r3.xyz = lerp(r2.xyz, c0.yyy, r4.xxx);
    r0.w = (-(r0.w)) + (c1.x);
    r0.y = (r4.w) * (c1.y) + (c1.x);
    r0.z = (r0.w) * (r0.w);
    r1.w = 1.0f / (r0.y);
    r0.w = (r0.w) * (r0.z);
    r0.xyz = (r3.xyz) * (-(r3.xyz)) + (c1.xxx);
    r0.w = (r1.w) * (r0.w);
    r5.xyz = (r2.xyz) * (r4.xxx);
