// Mechanically reconstructed from 0x12245032.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r13.xyz = (r3.zzz) * (v7.xyz);
    r16.yz = c1.yz;
    r3.xyz = float3(((r3.w) >= 0.0f ? (r16.y) : (c[20].x)), ((r3.w) >= 0.0f ? (r16.z) : (c[20].y)), ((r3.w) >= 0.0f ? (r16.y) : (c[20].w)));
    ...
    r1.z = (r1.y) * (r1.z);
    r12.xyz = lerp(r3.xyz, c1.zzz, r4.www);
