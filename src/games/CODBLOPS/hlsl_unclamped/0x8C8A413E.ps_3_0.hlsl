// Mechanically reconstructed from 0x8C8A413E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.w = saturate(dot(r9.xyz, r6.xyz));
    r1 = tex2D(s4, v1.xy);
    r6.w = (r1.w) * (c2.x);
    r4.w = (r1.w) * (-(c2.x)) + (c2.w);
    r10.xyz = normalize(v6.xyz);
    r0.z = (r12.w) * (r4.w) + (r6.w);
    r0.y = saturate(dot(r9.xyz, -(r10.xyz)));
    r5.w = (r0.y) * (r4.w) + (r6.w);
    r9.w = (-(r0.y)) + (c0.w);
    r0.z = (r0.z) * (r5.w) + (c3.x);
    r7.xyz = (r7.xyz) * (r2.www) + (-(r10.xyz));
    r2.w = 1.0f / (r0.z);
