// Mechanically reconstructed from 0x9FD85725.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.w = (r4.w) * (r5.z) + (c3.z);
    r4.w = 1.0f / (r4.w);
    r5.xyz = (r3.xyz) * (r6.zzz) + (-(r1.xyz));
    r4.w = (r5.w) * (r4.w);
    r3.xyz = normalize(r5.xyz);
    r6.x = 1.0f / (r6.z);
    r5.z = saturate(dot(r10.xyz, r3.xyz));
    r4.y = saturate(dot(r3.xyz, r4.xyz));
    r3.xy = (r2.ww) * (c4.xy) + (c4.zw);
    r3.z = exp2(r3.y);
    r6.z = 1.0f / (r3.x);
    r4.z = pow(abs(r5.z), r3.z);
    r3.y = (-(r4.y)) + (c1.y);
    ...
    r2.z = dot(c[25].yz, r6.xy) + (c[25].x);
    r3.xy = saturate((r6.xx) * (c[26].xy) + (c[26].zw));
    r2.xy = (r3.xy) * (r3.xy);
