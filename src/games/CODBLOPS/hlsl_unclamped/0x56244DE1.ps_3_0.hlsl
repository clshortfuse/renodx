// Mechanically reconstructed from 0x56244DE1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xy = (r2.xz) * (r6.xx);
    r0.w = dot(r7.xy, r4.xy) + (c15.z);
    r0.y = (r1.x) * (c3.w) + (-(r5.x));
    r1.w = (r2.z) * (-(r6.x)) + (r0.y);
    r3.xy = (r0.xz) * (r6.yy);
    r0.y = (r1.y) * (c3.w) + (-(r3.x));
    r0.x = dot(r7.xy, r7.xy) + (c15.z);
    r0.y = (r0.z) * (-(r6.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r10.y = (r1.w) + (r1.w);
    r0.z = (r0.z) * (c1.x) + (c1.y);
    ...
    r3.zw = c15.zw;
    r3.xyz = (r3.zwz) + (-(c[29].xyw));
    r3.w = saturate(dot(r14.xyz, r1.xyz));
    r1 = tex2D(s7, v0.xy);
    r11.xyz = (r1.xyz) * (-(r1.xyz)) + (c15.www);
    ...
    r1.z = (r1.y) * (r1.z);
    r13.xyz = (r5.www) * (r3.xyz) + (c[29].xyw);
    ...
    r2 = tex2D(s12, v0.zw);
    r0.z = ((-abs(r2.y)) >= 0.0f ? (c15.w) : (c15.z));
    ...
    r2.xy = (r2.xy) * (r2.xy);
    r0.z = ((-abs(r0.z)) >= 0.0f ? (c15.z) : (r2.w));
    r2.w = (r3.x) * (r2.x);
    r0.z = (r0.z) * (r2.w);
    r2.w = (r2.y) * (-(r3.y)) + (c15.w);
    r0.xy = (r3.ww) * (r0.xy);
    r0.z = (r0.z) * (r2.w);
    r3.w = (r4.z) * (r0.z);
