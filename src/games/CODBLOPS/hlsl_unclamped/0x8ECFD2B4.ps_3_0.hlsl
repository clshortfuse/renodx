// Mechanically reconstructed from 0x8ECFD2B4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s4, v7.zw);
    r5.w = (r0.w) * (v0.z);
    r4.xyz = lerp(r6.xyz, r0.xyz, r5.www);
    r11.xy = lerp(r8.xy, r7.xy, r5.ww);
    r2 = tex2D(s9, v7.zw);
    ...
    r4.xy = (r2.wy) * (c12.xx) + (c12.yy);
    r1.z = dot(r11.xy, r11.xy) + (c3.z);
    r1.w = dot(r4.xy, r4.xy) + (c3.z);
    r1.z = exp2(-(r1.z));
    r1.w = exp2(-(r1.w));
    r1.z = (r1.z) * (c11.x) + (c11.y);
    r1.w = (r1.w) * (c11.x) + (c11.y);
    r1.x = dot(r4.xy, r11.xy) + (c3.z);
    r2.w = (r1.z) * (r1.w);
    r1.w = (r0.w) * (-(c12.z)) + (c12.w);
    r1.x = saturate((r1.x) * (r2.w) + (r2.w));
    r4 = tex2D(s14, v1.zw);
    r7.xy = (r4.xy) * (c11.ww);
    r6.xy = (r3.xz) * (r7.xx);
    r3.xy = (r2.xz) * (r7.yy);
    r2.y = (r4.x) * (c11.w) + (-(r6.x));
    r2.w = (r4.y) * (c11.w) + (-(r3.x));
    r2.y = (r3.z) * (-(r7.x)) + (r2.y);
    r2.w = (r2.z) * (-(r7.y)) + (r2.w);
    r7.y = (r2.y) + (r2.y);
    r2.y = (r2.w) + (r2.w);
    r2.xz = (r3.xy) * (c12.xx);
    r3.xyz = v2.xyz;
    r3.xyz = (r11.xxx) * (v4.xyz) + (r3.xyz);
    r2.xyz = (r1.xxx) * (r2.xyz);
    r3.xyz = (r11.yyy) * (v3.xyz) + (r3.xyz);
    r7.xz = (r6.xy) * (c12.xx);
    r12.xyz = normalize(r3.xyz);
    r2.xyz = (r7.xyz) * (r1.zzz) + (r2.xyz);
    ...
    r1.w = (r1.x) * (r1.w);
    r3.w = (r2.w) * (r1.z);
    r1.xyz = float3(((r7.w) >= 0.0f ? (r1.y) : (c[8].x)), ((r7.w) >= 0.0f ? (r1.y) : (c[8].y)), ((r7.w) >= 0.0f ? (r1.y) : (c[8].w)));
    r1.w = (r1.w) * (r3.w);
    r11.xyz = lerp(r1.xyz, c[9].xyw, r5.www);
