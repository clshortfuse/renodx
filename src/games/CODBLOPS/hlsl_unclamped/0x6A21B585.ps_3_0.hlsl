// Mechanically reconstructed from 0x6A21B585.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = lerp(c[37].xy, c[37].zw, v3.xy);
    r3 = tex2D(s4, r2.xy);
    r3.y = r3.x;
    r4 = tex2D(s5, r2.xy);
    r2 = tex2D(s3, r2.xy);
