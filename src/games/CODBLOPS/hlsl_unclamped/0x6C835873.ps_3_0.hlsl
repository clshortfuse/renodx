// Mechanically reconstructed from 0x6C835873.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.z = r2.w;
    r1 = tex2D(s4, v7.zw);
    r12.w = (r1.w) * (v7.y) + (c1.w);
    r12.xy = (r3.yw) * (c14.xx) + (c14.yy);
    r6.xyz = float3(((r12.w) >= 0.0f ? (r4.x) : (r6.x)), ((r12.w) >= 0.0f ? (r4.y) : (r6.y)), ((r12.w) >= 0.0f ? (r4.z) : (r6.z)));
    ...
    r3.y = (r1.w) * (r2.w);
    r8.w = (r6.z) * (c2.w);
    r7.w = (r6.z) * (-(c14.z)) + (c14.w);
    r1.w = saturate(dot(r10.xyz, -(r5.xyz)));
    r2.w = (r9.w) * (r7.w) + (r8.w);
    r5.w = (r1.w) * (r7.w) + (r8.w);
    r2.w = (r2.w) * (r5.w) + (c4.x);
    r6.xy = (r6.zz) * (c12.xy) + (c12.zw);
    r3.z = 1.0f / (r2.w);
    r4.w = exp2(r6.y);
    r3.w = (r4.w) * (c4.y) + (c4.z);
    r2.w = pow(abs(r3.x), r4.w);
    r3.z = (r9.w) * (r3.z);
    r2.w = (r3.w) * (r2.w);
    r6.y = (r3.y) * (c3.x) + (c3.y);
    r2.w = (r3.z) * (r2.w);
    r3.xyz = (r13.www) * (r0.xyz) + (r2.xyz);
    r0.z = (r6.y) * (r2.w);
    r10.w = (-(r1.w)) + (-(c1.y));
    r0.z = (r6.w) * (r0.z);
    r1.w = (r6.z) * (c2.z);
