// Mechanically reconstructed from 0xE63B5368.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = (r0.w) * (v0.y) + (c3.w);
    r4.w = (r1.w) * (r1.z);
    r5.xy = float2(((r3.w) >= 0.0f ? (r1.x) : (r2.x)), ((r3.w) >= 0.0f ? (r1.y) : (r2.y)));
    r1 = tex2D(s0, v1.xy);
    ...
    r2.w = r0.y;
    r6.xy = (r2.xz) * (r7.xx);
    r8.xy = (r2.yw) * (c12.yy) + (c12.zz);
    r0.y = (r1.x) * (c12.x) + (-(r6.x));
    ...
    r1.w = (r1.w) * (r3.z);
    r6.w = c3.y;
    r13.xyz = float3(((r3.w) >= 0.0f ? (-(r6.w)) : (c[23].x)), ((r3.w) >= 0.0f ? (-(r6.w)) : (c[23].y)), ((r3.w) >= 0.0f ? (-(r6.w)) : (c[23].w)));
