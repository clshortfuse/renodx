// Mechanically reconstructed from 0x1D8F17E8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.x = dot(r2.xy, r1.xy) + (c16.w);
    r6.y = dot(r2.xy, r1.zw) + (c16.w);
    r2 = tex2D(s5, v6.zw);
    r2.w = (r2.w) * (v0.z);
    ...
    r3.xyz = (r13.xyz) * (r0.www) + (r1.xyz);
    r0 = tex2D(s8, v6.zw);
    r11.xyz = lerp(c[39].xyw, r0.yyy, r2.www);
