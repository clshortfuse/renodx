// Mechanically reconstructed from 0x152EFDEB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.y = dot(r1.xy, r0.zw) + (c3.w);
    r7.x = dot(r1.xy, r0.xy) + (c3.w);
    r2 = tex2D(s1, v1.xy);
    r3 = tex2D(s3, v7.xy);
    r5.w = (r3.w) * (v0.y);
    r1 = tex2D(s7, v1.xy);
    ...
    r2.w = r1.w;
    r2.xyz = lerp(r0.xyz, c3.zzz, r1.xxx);
    r0 = tex2D(s8, v7.xy);
    r3 = lerp(r2, r0, r5.wwww);
    r0 = tex2D(s4, v7.zw);
    r1.w = (r0.w) * (v0.z);
    r5.xyz = lerp(r6.xyz, r0.xyz, r1.www);
    r6.xy = lerp(r8.xy, r7.xy, r1.ww);
    r2 = tex2D(s9, v7.zw);
    r0 = lerp(r3, r2, r1.wwww);
    r9.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c3.yyy));
    r10.xyz = (r0.xyz) * (r0.xyz);
    r0.xyz = (r9.xyz) * (r6.www) + (r10.xyz);
    r2.xyz = lerp(r1.yyy, c[8].xyw, r5.www);
    r11.xyz = lerp(r2.xyz, c[9].xyw, r1.www);
