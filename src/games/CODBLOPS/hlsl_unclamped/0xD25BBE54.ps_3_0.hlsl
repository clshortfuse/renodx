// Mechanically reconstructed from 0xD25BBE54.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.w = (r1.w) * (r1.z);
    r1.w = (r0.w) * (c15.z) + (c15.w);
    r0.w = (r0.w) * (r0.w);
    r8.xyz = normalize(v2.xyz);
    r5.w = (r1.w) * (r0.w);
    r12.w = saturate(dot(r8.xyz, r0.xyz));
    r0 = tex2D(s12, v1.zw);
    ...
    r0.xyz = (v5.xyz) * (-(r6.www)) + (c[17].xyz);
    r7.xyz = normalize(r0.xyz);
    r0.w = saturate(dot(r7.xyz, c[17].xyz));
    r1.w = (-(r0.w)) + (c0.y);
    r0.w = (r1.w) * (r1.w);
    r3.xyz = (r2.www) * (r10.xyz) + (r11.xyz);
    r1.z = (r0.w) * (r0.w);
    r0 = tex2D(s0, v1.xy);
    ...
    r10.w = (r0.w) * (-(c0.z)) + (c0.y);
    r10.z = (r0.w) * (c0.z);
    r3.w = saturate(dot(r5.xyz, r8.xyz));
    r1.w = saturate(dot(r8.xyz, -(r9.xyz)));
    r0.z = (r3.w) * (r10.w) + (r10.z);
    r9.w = (r1.w) * (r10.w) + (r10.z);
    r0.z = (r0.z) * (r9.w) + (c4.x);
    r10.xy = (r0.ww) * (c12.xy) + (c12.zw);
    r0.y = 1.0f / (r0.z);
    r8.w = exp2(r10.y);
    r0.z = pow(abs(r12.w), r8.w);
    r4.w = (r8.w) * (c4.y) + (c4.z);
    r5.y = (r3.w) * (r0.y);
    r5.z = (r0.z) * (r4.w);
    r0.xyz = (r2.xyz) * (r11.www) + (r4.xyz);
    r5.z = (r5.y) * (r5.z);
    r5.xyz = (r0.xyz) * (r5.zzz);
    r0.z = (r7.w) * (r10.w) + (r10.z);
    r0.z = (r0.z) * (r9.w) + (c4.x);
    r7.z = saturate(dot(r8.xyz, r7.xyz));
    r0.y = 1.0f / (r0.z);
    r0.z = pow(abs(r7.z), r8.w);
    r0.y = (r7.w) * (r0.y);
    r0.z = (r4.w) * (r0.z);
    r4.w = (r0.y) * (r0.z);
    r0.xyz = (r2.xyz) * (r6.www) + (r4.xyz);
    r5.xyz = (r5.xyz) * (c[7].xyz);
    r0.xyz = (r4.www) * (r0.xyz);
    r7.xyz = (r5.xyz) * (c[29].www);
    r0.xyz = (r0.xyz) * (c[29].www);
    r5.xyz = (r3.www) * (c[6].xyz);
    r0.xyz = (r0.xyz) * (c[19].xyz);
    r5.xyz = (r1.xyz) * (r5.xyz) + (r7.xyz);
    r0.xyz = (r2.www) * (r0.xyz);
    r7.xyz = (r1.xyz) * (r3.xyz) + (r0.xyz);
    r0.z = (-(r1.w)) + (c0.y);
    r0.x = 1.0f / (r10.x);
    r0.y = (r0.z) * (r0.z);
    r0.y = (r0.z) * (r0.y);
