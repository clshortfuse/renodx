// Mechanically reconstructed from 0x9D71690B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = rsqrt(r0.z);
    r0.xyz = (r3.www) * (v7.xyz);
    r1.xyz = (r3.yyy) * (v4.xyz) + (r1.xyz);
    r3.xyz = (r2.xyz) * (r1.www) + (-(r0.xyz));
    ...
    r1 = tex2D(s5, v1.xy);
    r12.w = (r1.w) * (-(c1.w)) + (c1.z);
    r12.z = (r1.w) * (c1.w);
    r1.x = saturate(dot(r2.xyz, r7.xyz));
    r11.w = (r2.w) * (r12.w) + (r12.z);
    r1.z = (r1.x) * (r12.w) + (r12.z);
    r1.z = (r1.z) * (r11.w) + (c3.z);
    ...
    r4.y = 1.0f / (r2.x);
    r3.z = (-(r2.w)) + (c1.z);
    r2.w = dot(r0.xyz, r7.xyz);
    r3.y = (r3.z) * (r3.z);
    r2.z = (r2.w) + (r2.w);
    r2.w = (r1.w) * (c1.x);
    r2.xyz = (r7.xyz) * (-(r2.zzz)) + (r0.xyz);
    ...
    r12.y = saturate(dot(r9.xyz, c[17].xyz));
    r0.xyz = (r0.xyz) * (r1.www) + (v8.xyz);
    r2 = tex3D(s11, r0.xyz);
    r0.xyz = (r2.xyz) * (r2.xyz);
    r0.xyz = (r1.yyy) * (r0.xyz);
    r9.w = saturate(dot(r7.xyz, c[17].xyz));
    ...
    r0.z = (-(r12.y)) + (c1.z);
    r0.y = (r0.z) * (r0.z);
    r3.xyz = (r1.www) * (r10.xyz) + (r11.xyz);
    r0.y = (r0.y) * (r0.y);
    r0.y = (r0.z) * (r0.y);
    r0.z = (r9.w) * (r12.w) + (r12.z);
    r0.z = (r0.z) * (r11.w) + (c3.z);
    ...
    r2 = (v7.xxxx) * (c[25]) + (r2);
    r4.xyz = (r1.xxx) * (c[7].xyz);
    r2 = (v7.zzzz) * (c[27]) + (r2);
    r7.xyz = (r0.xyz) * (r4.xyz) + (r5.xyz);
    r5 = (r2) + (c[28]);
    r2.xyz = (r1.zzz) * (c[19].xyz);
    r4.zw = r5.zw;
    r2.xyz = (r1.www) * (r2.xyz);
    r6.zw = r4.zw;
    r9.xyz = (r0.xyz) * (r3.xyz) + (r2.xyz);
    r3.zw = r6.zw;
