// Mechanically reconstructed from 0xBDF0126A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = ((-abs(r1.w)) >= 0.0f ? (c3.w) : (r2.w));
    r4.xyz = (-(v4.xyz)) + (c[21].xyz);
    r2.xy = (r3.xy) * (r3.xy);
    r1.w = dot(r4.xyz, r4.xyz);
    r5.xy = (r3.xy) * (c4.xx) + (c4.yy);
    r1.w = rsqrt(r1.w);
    r3.w = (r2.x) * (r5.x);
    ...
    r2.w = (r2.w) * (r3.w);
    r2.y = saturate((r2.z) * (c[31].x) + (c[31].y));
    r2.z = (r2.y) * (r2.y);
    r2.y = (r2.y) * (c4.x) + (c4.y);
    r2.w = (r2.x) * (r2.w);
    r2.z = (r2.z) * (r2.y);
