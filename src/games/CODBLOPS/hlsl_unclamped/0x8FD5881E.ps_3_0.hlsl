// Mechanically reconstructed from 0x8FD5881E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xyz = (r2.xyz) * (c[22].xxx);
    r8.xyz = (r0.xyz) * (c[22].yyy);
    r3 = tex2D(s0, v1.xy);
    r5 = (-(v6.yyyy)) + (c[7]);
    r1 = (r5) * (r5);
    r4 = (-(v6.xxxx)) + (c[6]);
