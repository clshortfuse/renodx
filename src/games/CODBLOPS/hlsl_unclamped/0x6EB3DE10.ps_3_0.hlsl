// Mechanically reconstructed from 0x6EB3DE10.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = (r0.w) * (r0.z);
    r0 = tex2D(s0, v1.xy);
    r2.xyz = lerp(r0.xyz, c0.xxx, r1.xxx);
    ...
    r3.xyz = (r2.xyz) * (c[23].xyz);
    r6.xy = saturate((r7.xx) * (c[25].xy) + (c[25].zw));
    r3.w = dot(c[24].yz, r7.xy) + (c[24].x);
    r2.xy = (r6.xy) * (r6.xy);
    r6.xy = (r6.xy) * (c1.yy) + (c1.zz);
