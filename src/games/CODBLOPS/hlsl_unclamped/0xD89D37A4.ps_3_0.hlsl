// Mechanically reconstructed from 0xD89D37A4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xyz = (r12.www) * (r2.xyz) + (c[39].xyw);
    ...
    r8.xyz = (v0.www) * (r3.xyz) + (c1.xxx);
    r9.xyz = (v0.zzz) * (r0.xyz) + (c1.xxx);
    r2 = tex2D(s7, v1.xy);
