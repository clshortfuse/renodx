// Mechanically reconstructed from 0x4678B2DA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.y = (r0.z) * (-(r3.x)) + (r0.w);
    r11.yz = c1.yz;
    r9.xy = float2(((r5.w) >= 0.0f ? (r11.y) : (c[20].x)), ((r5.w) >= 0.0f ? (r11.z) : (c[20].y)));
    r3 = tex2D(s4, v1.xy);
    r2 = tex2D(s5, v7.zw);
    r0 = v2;
    ...
    r7.w = saturate(dot(r10.xyz, -(r0.xyz)));
    ...
    r2.z = 1.0f / (r2.z);
    r2.w = (r2.w) * (r2.y);
    r8.xy = lerp(r9.xy, c[21].xy, r6.ww);
    r3.w = (r2.z) * (r2.w);
