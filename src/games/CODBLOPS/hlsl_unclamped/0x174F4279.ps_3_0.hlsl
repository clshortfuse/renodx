// Mechanically reconstructed from 0x174F4279.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xyz = lerp(r0.xyz, c[33].xyw, r2.www);
    r1 = tex2D(s6, v1.xy);
    r0 = tex2D(s7, v7.xy);
    r5 = lerp(r1, r0, r6.wwww);
    r4 = tex2D(s8, v7.zw);
    r0 = v2;
