// Mechanically reconstructed from 0xCE9E2314.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s1, v6.zw);
    r4.w = (r0.w) * (v6.y) + (c1.x);
    r4.xy = (r1.yw) * (c7.xx) + (c7.yy);
    r6.xy = float2(((r4.w) >= 0.0f ? (r2.x) : (c1.z)), ((r4.w) >= 0.0f ? (r2.y) : (c1.z)));
    ...
    r4.y = (r2.z) + (r2.z);
    r3 = float4(((r2.w) >= 0.0f ? (r1.x) : (c1.z)), ((r2.w) >= 0.0f ? (r1.y) : (c1.z)), ((r2.w) >= 0.0f ? (r1.z) : (c1.z)), ((r2.w) >= 0.0f ? (r1.w) : (c1.z)));
    r1.xyz = (r4.xyz) * (r0.www) + (r5.xyz);
    r7.xyz = float3(((r4.w) >= 0.0f ? (c[5].x) : (r3.w)), ((r4.w) >= 0.0f ? (c[5].y) : (r3.w)), ((r4.w) >= 0.0f ? (c[5].w) : (r3.w)));
    r0 = (r0.xyzx) * (c1.yyyz) + (c1.zzzy);
    r5.xyz = (r1.xyz) * (r7.yyy);
    r2 = tex2D(s12, v0.zw);
    r1 = v1;
    ...
    r1.x = (r3.w) * (-(c7.z)) + (c7.w);
    r1.y = saturate(dot(r8.xyz, -(r9.xyz)));
    r1.z = (r2.w) * (r1.x) + (r2.x);
    r1.x = (r1.y) * (r1.x) + (r2.x);
    ...
    r6.xy = (r3.ww) * (c8.xy) + (c8.zw);
    r1.z = saturate(dot(r1.xyz, c[17].xyz));
    r1.x = exp2(r6.y);
    r4.w = 1.0f / (r6.x);
    r1.z = (-(r1.z)) + (c1.y);
    r2.w = pow(abs(r6.w), r1.x);
    r1.y = (r1.z) * (r1.z);
    r1.x = (r1.x) * (c3.y) + (c3.z);
    r1.y = (r1.y) * (r1.y);
    r2.z = (r2.w) * (r1.x);
