// Mechanically reconstructed from 0x0A717988.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(0.5f, 2.0f, -1.0f, 8.0f);
    const float4 c3 = float4(-101.222f, 103.222f, 0.0f, 0.0f);
    ...
    r0.y = (r2.w) * (r0.y) + (c0.w);
    r0.x = (r0.x) * (r0.y);
    r0.yz = lerp(c[30].xy, c[30].zw, v3.xy);
    r1 = tex2D(s4, r0.yz);
    r1.y = r1.x;
    r2 = tex2D(s5, r0.yz);
    r3 = tex2D(s3, r0.yz);
    r1.xw = (r3.xx) * (c0.wx) + (c0.xw);
    r1.z = r2.x;
    r0.z = dot(c12, r1);
    r0.y = dot(c4.xyz, r1.xyw);
    r0.w = dot(c13.xyz, r1.xzw);
    ...
    r2.x = c2.x;
    r1.w = (-(r2.x)) + (c[29].x);
    r0.yzw = float3(((r1.w) >= 0.0f ? (r0.y) : (r1.x)), ((r1.w) >= 0.0f ? (r0.z) : (r1.y)), ((r1.w) >= 0.0f ? (r0.w) : (r1.z)));
    r1.x = dot(v1.xyz, v1.xyz);
    r1.x = rsqrt(r1.x);
    r1.yzw = (r1.xxx) * (v1.xyz);
    ...
    r1.yzw = (r2.xxx) * (v2.xyz) + (r1.yzw);
    r1.xyz = (v1.xyz) * (r1.xxx) + (r1.yzw);
