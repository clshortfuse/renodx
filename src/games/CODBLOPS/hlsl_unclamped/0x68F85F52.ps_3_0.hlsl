// Mechanically reconstructed from 0x68F85F52.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c15 = float4(1.0f, 0.0f, 0.000244140625f, -0.000244140625f);
    const float4 c16 = float4(1.0f, 0.5f, 0.0f, 31.875f);
    const float4 c19 = float4(4.0f, -2.0f, 1000.0f, 8.0f);
    const float4 c35 = float4(0.5f, -0.5f, 0.999511719f, 9.99999994e-09f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r1.xyz = (r0.xyz) * (c19.www);
    r0.w = pow(abs(r1.w), c[23].x);
    r1.w = 1.0f / (c[21].x);
    r0.w = saturate((-(r0.w)) + (-(c1.w)));
    r2.w = ((-(r2.z)) >= 0.0f ? (c15.y) : (r0.w));
    r0.xy = (r2.xy) * (c35.xy) + (c35.xx);
    r0 = tex2D(s2, r0.xy);
    r0.xyz = (r0.xyz) * (r0.xyz);
    ...
    r5.xy = (r2.xz) * (r6.xx);
    r4.xy = (r1.xz) * (r6.yy);
    r1.y = (r3.x) * (c16.w) + (-(r5.x));
    r1.w = (r3.y) * (c16.w) + (-(r4.x));
    r1.y = (r2.z) * (-(r6.x)) + (r1.y);
    r1.w = (r1.z) * (-(r6.y)) + (r1.w);
    r2.y = (r1.y) + (r1.y);
    r1.y = (r1.w) + (r1.w);
