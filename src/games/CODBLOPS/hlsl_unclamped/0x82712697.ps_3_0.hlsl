// Mechanically reconstructed from 0x82712697.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xy = float2(((r1.w) >= 0.0f ? (c1.y) : (r2.y)), ((r1.w) >= 0.0f ? (c1.z) : (r2.y)));
    r0.z = dot(r11.xyz, r10.xyz);
    r12.xy = lerp(r0.xy, c1.zz, r5.ww);
    r0.z = (r0.z) + (r0.z);
