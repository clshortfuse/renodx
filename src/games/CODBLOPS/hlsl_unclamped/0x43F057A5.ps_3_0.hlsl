// Mechanically reconstructed from 0x43F057A5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = (-(r3.y)) + (c0.z);
    r0.w = (r5.y) * (r0.w);
    r4.xyz = (r3.zzz) * (c[37].xyz);
    r3.xyz = (r0.www) * (c[38].xyz);
    r0.w = dot(c[39].yz, r6.xy) + (c[39].x);
    r6.xy = saturate((r6.xx) * (c[40].xy) + (c[40].zw));
    r0.xy = (r6.xy) * (r6.xy);
    r6.xy = (r6.xy) * (c1.zz) + (c1.ww);
    r6.xy = (r0.xy) * (r6.xy);
    r6.z = max(abs(r10.y), abs(r10.z));
    r5.x = (r0.w) * (r6.x);
    r0.w = max(abs(r10.x), r6.z);
    r0.w = 1.0f / (r0.w);
    ...
    r0.xyz = (r9.xyz) * (c0.yyy);
    r6.xyz = (r6.xyz) * (r6.xyz);
    r0.xyz = (r5.xxx) * (r4.xyz) + (r0.xyz);
    r5.x = 1.0f / (r11.x);
