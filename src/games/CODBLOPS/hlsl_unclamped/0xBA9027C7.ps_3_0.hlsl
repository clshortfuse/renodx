// Mechanically reconstructed from 0xBA9027C7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = 1.0f / (r2.w);
    r1.w = (r1.w) * (r2.w);
    r10.xyz = lerp(r9.xyz, c4.xxx, r1.www);
    ...
    r2.w = saturate((r2.w) * (c14.x) + (c14.x));
    r2.w = (r2.w) + (r2.w);
    r2.w = (r2.w) * (r2.w);
    r2.w = (r2.w) * (r2.w);
    r2.w = (r2.w) * (r2.w);
    r1.w = (r1.w) * (r2.w);
    r2.w = (r2.w) * (c16.x) + (c16.y);
    r1.w = (r1.w) * (c0.w);
    ...
    r4.xyz = (r8.xyz) * (c0.xxx) + (r4.xyz);
    r1.w = (r5.w) + (c16.z);
    r1.w = saturate((r1.w) * (c16.w));
    r2.w = (r1.w) * (c37.x) + (c37.y);
    r1.w = (r1.w) * (r1.w);
    r1.w = saturate((r2.w) * (r1.w));
    r3.yzw = (r3.yzw) * (v4.xyz);
    r5.xyz = (r3.yzw) * (c[30].xxx);
    r6.xyz = (r3.yzw) * (c[31].xxx);
    r8.x = log2(abs(abs(r6.x)));
    r8.y = log2(abs(abs(r6.y)));
    r8.z = log2(abs(abs(r6.z)));
    r6.xyz = (r8.xyz) * (c37.zzz);
    r8.x = exp2(r6.x);
    r8.y = exp2(r6.y);
    r8.z = exp2(r6.z);
    r3.yzw = (r3.yzw) * (-(c[30].xxx)) + (r8.xyz);
    r3.yzw = (r1.www) * (r3.yzw) + (r5.xyz);
    r1.w = (r7.x) * (r7.w);
    r5.x = c4.x;
    r1.w = (r1.w) * (-(c[35].x)) + (r5.x);
    r5.yzw = (r3.yzw) * (c[34].xyz) + (-(r3.yzw));
