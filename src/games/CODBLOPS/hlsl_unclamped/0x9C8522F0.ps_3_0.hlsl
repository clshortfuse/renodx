// Mechanically reconstructed from 0x9C8522F0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xyz = (r1.xyz) * (c[29].yyy);
    r4.xyz = (r0.xyz) * (r0.xyz);
    r1 = tex2D(s6, v1.xy);
    r2.xyz = (r2.xyz) * (r1.xyz);
    r0 = v2;
    r1.xyz = (r8.xxx) * (v5.xyz) + (r0.xyz);
    ...
    r2.z = (r2.z) * (r2.x);
    r2.w = (r2.w) + (r2.w);
    r11.xyz = (r0.xyz) * (r2.zzz) + (r7.xyz);
    r2.xyz = (r8.xyz) * (-(r2.www)) + (r1.xyz);
    r10.xyz = (r10.xyz) * (r5.www) + (-(r1.xyz));
    r2.w = (r1.w) * (c1.w);
