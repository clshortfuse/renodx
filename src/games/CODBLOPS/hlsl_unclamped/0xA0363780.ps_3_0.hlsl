// Mechanically reconstructed from 0xA0363780.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (r1.z) * (r1.z);
    r8.xyz = (v0.yyy) * (r0.xyz) + (c12.yyy);
    r2.x = (r1.w) * (r0.w);
    r5.xyz = (r8.xyz) * (c12.zzz);
    r0 = tex2D(s3, v7.zw);
    r1 = tex2D(s1, v1.xy);
    ...
    r12.xyz = (v0.zzz) * (r1.xyz) + (c12.yyy);
    r1.xyz = (r13.yyy) * (v4.xyz) + (r0.xyz);
    r0.xyz = (r5.xyz) * (r12.xyz);
