// Mechanically reconstructed from 0x6E559C63.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.xyz = (r3.www) * (v3.xyz);
    r5.xyz = (r0.zzz) * (c[18].xyz);
    r0.w = saturate(dot(r9.xyz, -(r12.xyz)));
    r2 = tex2D(s4, v0.xy);
    r10.y = (r2.w) * (c0.z);
    r9.w = (r2.w) * (-(c0.z)) + (c0.x);
    r8.w = (r0.w) * (r9.w) + (r10.y);
    r0.x = (r0.z) * (r9.w) + (r10.y);
    r4.xyz = (v3.xyz) * (-(r3.www)) + (c[17].xyz);
    r0.x = (r0.x) * (r8.w) + (c3.x);
    r0.x = 1.0f / (r0.x);
