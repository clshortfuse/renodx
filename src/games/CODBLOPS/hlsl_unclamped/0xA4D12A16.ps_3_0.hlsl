// Mechanically reconstructed from 0xA4D12A16.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (r0.w) * (c0.y);
    r0.xyz = (r6.xyz) * (r1.zzz) + (r7.xyz);
    r5.xyz = (r1.www) * (r0.xyz);
    r0.z = c0.x;
    r0.xyz = (r0.zzz) + (-(c[10].xyw));
    r1 = tex2D(s1, v4.zw);
    r2.xy = (v0.zw) * (c0.xw);
    r2 = tex2D(s13, r2.xy);
