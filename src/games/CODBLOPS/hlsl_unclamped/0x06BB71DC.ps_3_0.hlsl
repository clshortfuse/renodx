// Mechanically reconstructed from 0x06BB71DC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c21 = float4(2.0f, -1.0f, 0.0f, -0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r2.y = dot(r1.xy, r0.zw) + (c21.z);
    r2.x = dot(r1.xy, r0.xy) + (c21.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r6.w = (r0.w) * (v0.y);
    ...
    r7.y = dot(r1.xy, r0.zw) + (c21.z);
    r7.x = dot(r1.xy, r0.xy) + (c21.z);
    r1 = tex2D(s8, v7.xy);
    r2 = tex2D(s7, v1.xy);
    r0 = tex2D(s4, v7.zw);
    r7.w = (r0.w) * (v0.z);
    ...
    r1.y = dot(r6.xy, r6.xy) + (c21.z);
    r1.w = dot(r2.xy, r2.xy) + (c21.z);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r3.w = (r1.y) * (c3.x) + (c3.y);
    r1.y = (r1.w) * (c3.x) + (c3.y);
    r1.w = dot(r2.xy, r6.xy) + (c21.z);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c4.ww);
    ...
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (-(c21.y)) : (-(c21.z)));
