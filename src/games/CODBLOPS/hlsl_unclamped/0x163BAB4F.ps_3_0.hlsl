// Mechanically reconstructed from 0x163BAB4F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xy = (v1.xy) + (c1.xx);
    r3.z = c1.y;
    r0.xy = (r5.xy) * (c[32].xx) + (r3.zz);
    r0 = tex2D(s5, r0.xy);
    r5.w = (v8.w) * (c1.z) + (-(r0.x));
    r1.xy = (r1.wy) * (c0.xy) + (c0.zw);
    r8.w = saturate((r5.w) * (c1.w));
    r6.xy = lerp(r7.xy, r1.xy, r8.ww);
    r1 = v2;
