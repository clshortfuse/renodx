// Mechanically reconstructed from 0xECA36A6C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = (r6.w) * (r6.y) + (c2.z);
    r6.w = 1.0f / (r6.w);
    r6.xyz = (r2.xyz) * (r6.zzz) + (-(r4.xyz));
    r6.w = (r4.w) * (r6.w);
    r2.xyz = normalize(r6.xyz);
    r6.z = saturate(dot(r10.xyz, r2.xyz));
    r6.xy = (r1.ww) * (c3.xy) + (c3.zw);
    r2.y = saturate(dot(r2.xyz, r5.xyz));
    r2.z = exp2(r6.y);
    r5.z = 1.0f / (r6.x);
    r2.y = (-(r2.y)) + (c0.y);
    r5.y = pow(abs(r6.z), r2.z);
    r2.x = (r2.y) * (r2.y);
    r2.z = (r2.z) * (c4.x) + (c4.y);
    r2.x = (r2.x) * (r2.x);
    r2.z = (r5.y) * (r2.z);
