// Mechanically reconstructed from 0xEE29FDCF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = (r2.w) * (r2.w);
    r3.w = (r3.w) * (r3.w);
    r4.xy = float2(((r5.w) >= 0.0f ? (r9.x) : (c0.z)), ((r5.w) >= 0.0f ? (r9.y) : (c0.y)));
    r4.w = (r2.w) * (r3.w);
    r8.w = (r4.x) * (r4.x);
    r7.w = (r4.x) * (-(r4.x)) + (c0.y);
    r11.y = (r4.y) * (c1.y);
    r11.z = (r4.y) * (-(c1.y)) + (c1.z);
    r3.w = saturate(dot(r10.xyz, -(r3.xyz)));
    r2.w = (r9.z) * (r11.z) + (r11.y);
    r11.w = (r3.w) * (r11.z) + (r11.y);
    r2.w = (r2.w) * (r11.w) + (c4.x);
    r7.xy = (r4.yy) * (c12.xy) + (c12.zw);
    r4.z = 1.0f / (r2.w);
    r10.w = exp2(r7.y);
    ...
    r1.z = r2.x;
    r2.w = (r2.z) * (r11.z) + (r11.y);
    r1.z = dot(r1, c4.zzzz);
    r1.w = (r2.w) * (r11.w) + (c4.x);
