// Mechanically reconstructed from 0xAFCE6642.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s4, v6.zw);
    r2.w = (r2.w) * (v0.z);
    r3.xy = (r2.ww) * (-(r1.xy)) + (r1.xy);
    r1.xyz = v4.xyz;
    r1.xyz = (r3.xxx) * (r1.xyz) + (v2.xyz);
    ...
    r6.xyz = (v0.yyy) * (r1.xyz) + (c1.yyy);
    r9.xyz = (-(v5.xyz)) + (c[5].xyz);
    r3.xyz = (r6.xyz) * (c1.zzz);
    r5.w = dot(r9.xyz, r9.xyz);
    r1 = lerp(r3, r0, r2.wwww);
    r0.y = rsqrt(r5.w);
    r3.w = (r1.w) * (c1.w);
    r7.xyz = (r9.xyz) * (r0.yyy);
    r0.z = (r1.w) * (-(c1.w)) + (c1.y);
