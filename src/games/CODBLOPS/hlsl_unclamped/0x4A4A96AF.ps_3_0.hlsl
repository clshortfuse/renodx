// Mechanically reconstructed from 0x4A4A96AF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.xy = (r1.ww) * (c8.xy) + (c8.zw);
    r0.z = exp2(r9.y);
    r0.x = (-(r0.x)) + (c2.x);
    r2.y = pow(abs(r3.w), r0.z);
    r2.z = (r0.x) * (r0.x);
    r0.z = (r0.z) * (c4.x) + (c4.y);
    r2.z = (r2.z) * (r2.z);
    r0.z = (r2.y) * (r0.z);
