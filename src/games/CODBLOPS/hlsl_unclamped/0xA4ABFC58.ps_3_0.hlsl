// Mechanically reconstructed from 0xA4ABFC58.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(3.5f, 1.0f, 0.959999979f, 0.0399999991f);
    ...
    r1.x = dot(r3.xy, r1.xy) + (c3.w);
    r1.y = dot(r3.xy, r1.zw) + (c3.w);
    r5 = tex2D(s3, v6.zw);
    r7.w = (r5.w) * (v0.z);
