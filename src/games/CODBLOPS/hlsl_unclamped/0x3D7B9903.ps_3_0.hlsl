// Mechanically reconstructed from 0x3D7B9903.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s8, v7.zw);
    r2.z = r0.w;
    r10.xyz = float3(((r1.z) >= 0.0f ? (r2.x) : (r3.x)), ((r1.z) >= 0.0f ? (r2.y) : (r3.y)), ((r1.z) >= 0.0f ? (r2.z) : (r3.z)));
    r8.w = ((r1.z) >= 0.0f ? (r0.y) : (r1.y));
    r6.xyz = (r4.xyz) * (r4.xyz);
    r0.w = dot(r10.xy, r10.xy) + (c1.z);
    r4.z = (r10.z) * (-(c37.z)) + (c37.w);
    r0.w = exp2(-(r0.w));
    r3.z = (r0.w) * (c3.x) + (c3.y);
    ...
    r1 = tex2D(s14, v0.zw);
    r4.xy = (r1.xy) * (c4.zz);
    r5.xy = (r0.wy) * (c37.xx) + (c37.yy);
    r2.xy = (r2.xz) * (r4.xx);
    r0.w = dot(r5.xy, r10.xy) + (c1.z);
    r0.y = (r1.x) * (c4.z) + (-(r2.x));
    r1.w = (r2.z) * (-(r4.x)) + (r0.y);
    r3.xy = (r0.xz) * (r4.yy);
    r0.y = (r1.y) * (c4.z) + (-(r3.x));
    ...
    r1.w = (r10.z) * (c3.z);
    r1.xyz = (r9.xyz) * (-(r10.yyy)) + (r8.xyz);
    r1 = texCUBElod(s15, r1);
    r0.xyz = (r1.xyz) * (r1.xyz);
    r1.w = (r10.w) * (c4.x) + (c4.y);
