// Mechanically reconstructed from 0x176927AB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = r4.y;
    r7.xy = c1.xy;
    r0.xy = (v6.xy) * (c[45].xx) + (r7.xx);
    r6.xy = (r1.yw) * (c4.yy) + (c4.zz);
    r0.xy = (r0.xy) * (c[46].xx) + (r7.yy);
    r0 = tex2D(s3, r0.xy);
    r9.xy = (v6.xy) * (c[45].xx);
    r5.xy = (r9.xy) * (c2.xx) + (c2.yy);
    r1.w = (r0.y) * (c1.z) + (c1.w);
    r0.xy = (r5.xy) * (c[47].xx) + (r7.yy);
    r0 = tex2D(s4, r0.xy);
    r0.w = (r0.y) * (c1.z) + (c1.w);
    r0.w = (r0.w) * (c1.z) + (c1.w);
    r0.xz = c2.zz;
    ...
    r1.xyz = (r0.xyz) * (r0.xyz);
    r0.z = dot(c[39].xyz, r4.xyz);
    r1.w = saturate((c[41].y) * (r0.z) + (c[41].x));
    r0.xyz = c[0].xyz;
