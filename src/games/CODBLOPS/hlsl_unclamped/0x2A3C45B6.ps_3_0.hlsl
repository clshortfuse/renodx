// Mechanically reconstructed from 0x2A3C45B6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xy = (r3.xy) * (r5.xy);
    r3.w = c0.z;
    r6.xyz = float3(((r4.w) >= 0.0f ? (c[34].x) : (r3.w)), ((r4.w) >= 0.0f ? (c[34].y) : (r3.w)), ((r4.w) >= 0.0f ? (c[34].w) : (r3.w)));
    r1.w = (r1.w) * (r3.x);
    r5.xyz = (r1.xyz) * (r6.yyy);
    r3.w = (r3.y) * (r1.w);
    r1 = tex2D(s12, v1.zw);
    r9.w = (r3.w) * (r1.y);
    r8.xyz = (r12.xyz) * (r2.www);
    r10.xyz = normalize(v2.xyz);
    r11.w = saturate(dot(r10.xyz, r8.xyz));
    r11.xyz = normalize(v4.xyz);
    r3.xyz = (r11.www) * (c[29].xyz);
    r1.xyz = (r12.xyz) * (r2.www) + (-(r11.xyz));
