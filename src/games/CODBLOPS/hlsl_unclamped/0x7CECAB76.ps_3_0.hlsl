// Mechanically reconstructed from 0x7CECAB76.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xy = (c[28].zz) * (r3.xy) + (r0.xy);
    r3.z = c1.y;
    r0 = tex2D(s0, v1.xy);
    r4.w = (r0.w) * (v0.w) + (c1.x);
    r1.w = r2.x;
    r7.xyz = float3(((r4.w) >= 0.0f ? (r3.x) : (c1.z)), ((r4.w) >= 0.0f ? (r3.y) : (c1.z)), ((r4.w) >= 0.0f ? (r3.z) : (c1.z)));
    r3.z = dot(r1, c2.zzzz);
    r1 = v2;
