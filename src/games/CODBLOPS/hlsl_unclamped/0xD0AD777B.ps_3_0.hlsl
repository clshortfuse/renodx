// Mechanically reconstructed from 0xD0AD777B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.x = dot(r5.xy, r1.xy) + (c3.x);
    r3.y = dot(r5.xy, r1.zw) + (c3.x);
    r5 = tex2D(s3, v6.zw);
    r9.w = (r5.w) * (v0.z);
    r1.xy = (r0.yw) * (c4.yy) + (c4.zz);
    r8.xy = lerp(r4.xy, r3.xy, r9.ww);
    r0.w = dot(r1.xy, r1.xy) + (c3.x);
    r0.y = dot(r8.xy, r8.xy) + (c3.x);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c3.y) + (c3.z);
    r3.w = (r0.y) * (c3.y) + (c3.z);
    r0.y = (r0.w) * (r3.w);
    r0.w = dot(r1.xy, r8.xy) + (c3.x);
    r1 = tex2D(s14, v1.zw);
    r4.xy = (r1.xy) * (c4.xx);
    ...
    r7.w = c2.w;
    r10.xy = float2(((r4.w) >= 0.0f ? (r7.w) : (c[23].x)), ((r4.w) >= 0.0f ? (r7.w) : (c[23].y)));
    r5.w = (-(r0.w)) + (c2.w);
    r2 = tex2D(s5, v1.xy);
    r1 = tex2D(s6, v6.zw);
    ...
    r1.w = (r5.w) * (r1.w);
    r1.z = 1.0f / (r1.z);
    r8.xy = lerp(r10.xy, c[24].xy, r9.ww);
    r2.w = (r1.w) * (r1.z);
    r1.xyz = (r0.xyz) * (-(r0.xyz)) + (c2.www);
    ...
    r0.xyz = (r8.xxx) * (r1.xyz);
    r1.xyz = (r6.xyz) * (r3.www) + (r7.xyz);
    r0.xyz = (r2.xyz) * (r0.xyz);
    r7.xyz = (r8.yyy) * (r1.xyz);
    ...
    r4.z = rsqrt(r0.z);
    r4.w = rsqrt(r0.w);
    r6.xyz = lerp(r10.xyz, r5.xyz, r9.www);
    r3 = (r3) * (r4);
    r3 = (r9.yyyy) * (r3);
    r2 = (r2) * (r4);
    r1 = (r1) * (r4);
