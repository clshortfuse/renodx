// Mechanically reconstructed from 0x7155E5FC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyz = (r14.xyz) * (r0.www) + (r1.xyz);
    r1 = tex2D(s7, v1.xy);
    r11.xyz = lerp(r1.yyy, c[39].xyw, r9.www);
    ...
    r0.w = (r1.z) * (r6.w) + (r7.w);
    r3.w = (r1.w) * (r6.w) + (r7.w);
    r6.xyz = (r2.yyy) * (r8.xyz) + (r15.xyz);
    r0.w = (r0.w) * (r3.w) + (c13.x);
    r8.xyz = (v5.xyz) * (-(r1.yyy)) + (c[17].xyz);
    r0.w = 1.0f / (r0.w);
    r1.y = (-(r1.w)) + (-(c2.y));
    r2.z = (r1.z) * (r0.w);
    r5.xyz = normalize(r8.xyz);
    r16.xy = (r4.ww) * (c14.xy) + (c14.zw);
    ...
    r0.w = (r2.z) * (r0.w);
    r15.xyz = (r4.xyz) * (r1.zzz) + (r8.xyz);
    r1.z = 1.0f / (r16.x);
    r15.xyz = (r0.www) * (r15.xyz);
    r0.w = (r4.w) * (c3.z);
    r15.xyz = (r11.zzz) * (r15.xyz);
