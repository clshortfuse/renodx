// Mechanically reconstructed from 0xA36EB462.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyz = (r9.www) * (r2.xyz) + (c[31].xyw);
    r2.xyz = v2.xyz;
    r6.xyz = (r7.xxx) * (v4.xyz) + (r2.xyz);
    r2.xyz = -(r3.xyz);
    r6.xyz = (r7.yyy) * (v3.xyz) + (r6.xyz);
    r2.w = (r2.y) + (c15.w);
    r9.xyz = normalize(r6.xyz);
    r3.xyz = (r5.www) * (r2.xwz) + (r3.xyz);
