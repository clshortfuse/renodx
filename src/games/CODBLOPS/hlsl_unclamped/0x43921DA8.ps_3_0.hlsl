// Mechanically reconstructed from 0x43921DA8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = dot(r2.xy, r1.zw) + (c3.z);
    r8.x = dot(r2.xy, r1.xy) + (c3.z);
    r1 = tex2D(s0, v1.xy);
    ...
    r3.xy = (r3.xz) * (r9.xx);
    r8.xy = (r2.xz) * (r9.yy);
    r2.w = (r4.x) * (c12.w) + (-(r3.x));
    r2.y = (r4.y) * (c12.w) + (-(r8.x));
    r2.w = (r3.z) * (-(r9.x)) + (r2.w);
    r2.z = (r2.z) * (-(r9.y)) + (r2.y);
    r2.y = (r2.z) + (r2.z);
    r2.xz = (r8.xy) * (c13.xx);
    ...
    r1.w = (r1.x) * (r1.w);
    r3.w = (r2.w) * (r1.z);
    r1.xyz = float3(((r7.w) >= 0.0f ? (r1.y) : (c[23].x)), ((r7.w) >= 0.0f ? (r1.y) : (c[23].y)), ((r7.w) >= 0.0f ? (r1.y) : (c[23].w)));
    r1.w = (r1.w) * (r3.w);
    r13.xyz = lerp(r1.xyz, c[24].xyw, r5.www);
