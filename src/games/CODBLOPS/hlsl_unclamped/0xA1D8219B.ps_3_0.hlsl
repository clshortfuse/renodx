// Mechanically reconstructed from 0xA1D8219B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.y = dot(r1.xy, r0.zw) + (c36.w);
    r6.x = dot(r1.xy, r0.xy) + (c36.w);
    r1 = tex2D(s1, v1.xy);
    r0 = tex2D(s5, v7.xy);
    r0.xyz = (r0.xyz) + (c36.yyy);
    r4.xyz = (v0.yyy) * (r0.xyz) + (c36.zzz);
    r0 = tex2D(s0, v1.xy);
    r2 = tex2D(s6, v7.zw);
    r4.w = (r2.w) * (v0.z);
    r2.xyz = (r0.xyz) * (-(r4.xyz)) + (r2.xyz);
    r7.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r1.xyz = (r4.www) * (r2.xyz);
    ...
    r10.xy = (r3.xz) * (r4.xx);
    r1.w = dot(r6.xy, r5.xy) + (c36.w);
    r1.y = (r2.x) * (c4.w) + (-(r10.x));
    r2.w = (r3.z) * (-(r4.x)) + (r1.y);
    r3.xy = (r1.xz) * (r4.yy);
    r1.y = (r2.y) * (c4.w) + (-(r3.x));
    r1.x = dot(r6.xy, r6.xy) + (c36.w);
    r1.y = (r1.z) * (-(r4.y)) + (r1.y);
    r1.z = exp2(-(r1.x));
    r6.y = (r2.w) + (r2.w);
    r1.z = (r1.z) * (c3.x) + (c3.y);
    ...
    r4.z = saturate(dot(r17.xyz, r2.xyz));
    r10.w = (r0.w) * (c3.w);
    r3.z = saturate(dot(r8.xyz, r17.xyz));
    r1.w = saturate(dot(r17.xyz, -(r7.xyz)));
    r2.w = (r3.z) * (r9.w) + (r10.w);
