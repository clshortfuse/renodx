// Mechanically reconstructed from 0x80EF39D6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.x = dot(r5.xy, r3.xy) + (c15.z);
    r3.y = dot(r5.xy, r3.zw) + (c15.z);
    r0.z = (r2.w) * (-(c12.z)) + (c12.w);
    r9.xy = lerp(r4.xy, r3.xy, r6.ww);
    r3.xyz = v1.xyz;
    ...
    r6.xyz = (r2.xyz) * (-(r2.xyz)) + (c15.www);
    r0.z = (r0.x) * (r0.z);
    r2.xyz = (r6.xyz) * (r0.www) + (r10.xyz);
    r0.w = (r2.w) * (c2.z);
    r2.xyz = (r0.zzz) * (r2.xyz);
    r11.xyz = lerp(r0.yyy, c[25].xyw, r6.www);
    r3.xy = saturate((r13.xx) * (c[24].xy) + (c[24].zw));
    r0.xy = (r3.xy) * (r3.xy);
    r3.xy = (r3.xy) * (c14.xx) + (c14.yy);
    r2.w = dot(c[23].yz, r13.xy) + (c[23].x);
    r3.xy = (r0.xy) * (r3.xy);
    r0.xyz = (r2.xyz) * (r11.zzz);
    r2.w = (r2.w) * (r3.x);
    r13.xyz = (r0.xyz) * (c[22].xyz);
    r9.w = (r3.y) * (r2.w);
    r2 = tex2D(s12, v0.zw);
    r0.xy = (v0.zw) * (c3.xy);
    r3 = tex2D(s13, r0.xy);
