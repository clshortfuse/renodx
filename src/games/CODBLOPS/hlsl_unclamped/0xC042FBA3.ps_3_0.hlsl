// Mechanically reconstructed from 0xC042FBA3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xyz = (v0.zzz) * (r3.xyz) + (c1.yyy);
    r3 = tex2D(s4, v8.xy);
    r6.xyz = (r3.xyz) + (c1.xxx);
    r3.xyz = (r7.xyz) * (r10.xyz);
    r9.xyz = (v0.www) * (r6.xyz) + (c1.yyy);
    r1.w = (r1.w) * (r1.x);
