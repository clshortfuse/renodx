// Mechanically reconstructed from 0xF235DDC0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.x = 1.0f / (r1.w);
    r0.z = (r0.w) * (c[32].w);
    r8.xy = saturate((r10.xx) * (c[34].xy) + (c[34].zw));
    r7.xy = (r8.xy) * (r8.xy);
