// Mechanically reconstructed from 0xE83C8A9C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xy = (v1.xy) + (c1.xx);
    r1.z = c1.y;
    r3.xy = (r6.xy) * (c[44].xx) + (r1.zz);
    r3 = tex2D(s5, r3.xy);
    r4.w = (v8.w) * (c1.z) + (-(r3.x));
    r2.xy = (r2.wy) * (c0.xy) + (c0.zw);
    r12.z = saturate((r4.w) * (c1.w));
    r0.w = r1.x;
    r1.xy = lerp(r7.xy, r2.xy, r12.zz);
    r2.z = dot(r0, c4.zzzz);
    r0.xyz = v2.xyz;
    ...
    r6.z = saturate(dot(r7.xyz, r3.xyz));
    r10.xyz = normalize(v7.xyz);
    r1.xyz = (r0.xyz) * (r6.zzz);
    r0.xyz = (r5.xyz) * (r5.www) + (-(r10.xyz));
