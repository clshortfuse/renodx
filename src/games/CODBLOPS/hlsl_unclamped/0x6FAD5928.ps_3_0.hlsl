// Mechanically reconstructed from 0x6FAD5928.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = c2.w;
    r5.xy = float2(((r1.w) >= 0.0f ? (r0.w) : (c[8].x)), ((r1.w) >= 0.0f ? (r0.w) : (c[8].y)));
    r4.xyz = (r6.yyy) * (v3.xyz) + (r3.xyz);
    r3.xyz = normalize(r4.xyz);
    r8.xyz = normalize(v5.xyz);
    r9.xy = lerp(r5.xy, c[9].xy, r7.ww);
    r0.w = dot(r8.xyz, r3.xyz);
    r6.xyz = (r2.xyz) * (r9.yyy);
    r0.w = (r0.w) + (r0.w);
    r2.xyz = (r3.xyz) * (-(r0.www)) + (r8.xyz);
    ...
    r2.xyz = lerp(r3.xyz, r0.xyz, r7.www);
