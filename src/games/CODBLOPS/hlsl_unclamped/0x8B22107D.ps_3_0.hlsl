// Mechanically reconstructed from 0x8B22107D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    float4 v3 = input.v3;
    float4 v4 = input.v4;
    const float4 c0 = float4(-0.5f, 0.25f, -1.0f, 1.0f);
    ...
    r1.w = (r0.w) * (v4.y) + (c0.x);
    r0.w = (r3.w) * (r2.w) + (c0.w);
    r0.xyz = float3(((r1.w) >= 0.0f ? (r0.x) : (r1.x)), ((r1.w) >= 0.0f ? (r0.y) : (r1.y)), ((r1.w) >= 0.0f ? (r0.z) : (r1.z)));
