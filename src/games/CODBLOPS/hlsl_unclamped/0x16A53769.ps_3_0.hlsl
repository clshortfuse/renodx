// Mechanically reconstructed from 0x16A53769.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.z = (-(r2.w)) + (c1.y);
    r2.w = pow(abs(r3.y), r8.w);
    r3.y = (r2.z) * (r2.z);
    r5.w = (r8.w) * (c12.y) + (c12.z);
    r3.y = (r3.y) * (r3.y);
    r2.w = (r2.w) * (r5.w);
    r2.z = (r2.z) * (r3.y);
    r7.w = (r3.z) * (r3.z);
