// Mechanically reconstructed from 0xA0048F5E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r5.xyz = saturate((r1.xyz) * (r0.www) + (r0.xyz));
    r7.w = (r0.w) * (v0.w) + (c0.x);
    r3 = tex2D(s2, v1.xy);
    r0.xyz = lerp(r5.xyz, c0.yyy, r3.xxx);
    r0.w = r3.w;
    r2 = float4(((r7.w) >= 0.0f ? (r0.x) : (c0.w)), ((r7.w) >= 0.0f ? (r0.y) : (c0.w)), ((r7.w) >= 0.0f ? (r0.z) : (c0.w)), ((r7.w) >= 0.0f ? (r0.w) : (c0.z)));
    r5.w = (r2.w) * (c2.z);
    r0 = tex2D(s1, v1.xy);
    r0.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r4.w = (r2.w) * (-(c2.z)) + (c2.w);
    r4.xy = float2(((r7.w) >= 0.0f ? (r0.x) : (c0.w)), ((r7.w) >= 0.0f ? (r0.y) : (c0.w)));
    r1 = v2;
    ...
    r0.w = (r8.w) * (r4.w) + (r5.w);
    r4.w = (r3.z) * (r4.w) + (r5.w);
    r0.xyz = (r5.xyz) * (r3.xxx);
    r0.w = (r0.w) * (r4.w) + (c3.z);
    r4.w = ((r7.w) >= 0.0f ? (r3.y) : (c0.w));
    r0.w = 1.0f / (r0.w);
    r6.w = (-(r3.z)) + (c0.z);
    r9.w = (r8.w) * (r0.w);
    r5.xy = (r2.ww) * (c4.xy) + (c4.zw);
    r3.xyz = (r1.xyz) * (r3.www) + (-(r8.xyz));
    r5.z = exp2(r5.y);
    r1.xyz = normalize(r3.xyz);
    r5.w = 1.0f / (r5.x);
    r3.z = saturate(dot(r1.xyz, r4.xyz));
    r0.w = (r5.z) * (c12.x) + (c12.y);
    r3.z = (-(r3.z)) + (c0.z);
    r3.y = saturate(dot(r7.xyz, r1.xyz));
    r1.z = (r3.z) * (r3.z);
    r1.y = pow(abs(r3.y), r5.z);
    r1.z = (r1.z) * (r1.z);
    r0.w = (r0.w) * (r1.y);
    r1.z = (r3.z) * (r1.z);
    r6.xyz = (r2.xyz) * (r2.xyz);
    r5.xyz = (r2.xyz) * (-(r2.xyz)) + (c0.zzz);
    r0.w = (r9.w) * (r0.w);
    ...
    r9.xy = c[9].xy;
    r2.xyz = (r9.yyy) * (c[8].xyz);
    r2.w = (r2.w) * (c2.x);
    r4.xyz = (r1.xyz) * (r2.xyz);
    r0.w = dot(c[10].yz, r10.xy) + (c[10].x);
    r2.xy = saturate((r10.xx) * (c[11].xy) + (c[11].zw));
    r1.xy = (r2.xy) * (r2.xy);
    r2.xy = (r2.xy) * (c3.xx) + (c3.yy);
    r2.xy = (r1.xy) * (r2.xy);
    r2.z = max(abs(r7.y), abs(r7.z));
    r0.w = (r0.w) * (r2.x);
    r1.z = max(abs(r7.x), r2.z);
    r2.z = 1.0f / (r1.z);
    r1.xyz = (r7.xyz) * (c[5].xyz);
    r0.w = (r2.y) * (r0.w);
    r1.xyz = (r1.xyz) * (r2.zzz) + (v7.xyz);
    r3 = tex3D(s11, r1.xyz);
    r0.w = (r0.w) * (r3.w);
    ...
    r0 = float4(((r7.w) >= 0.0f ? (r0.x) : (c0.w)), ((r7.w) >= 0.0f ? (r0.y) : (c0.w)), ((r7.w) >= 0.0f ? (r0.z) : (c0.w)), ((r7.w) >= 0.0f ? (r0.w) : (c0.w)));
    r2.z = (r1.z) + (r1.z);
