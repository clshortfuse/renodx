// Mechanically reconstructed from 0xB57790AC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xy = float2(((r6.w) >= 0.0f ? (r0.x) : (r3.x)), ((r6.w) >= 0.0f ? (r0.y) : (r3.y)));
    r0 = tex2D(s7, v7.zw);
    ...
    r1.w = (r2.z) * (-(r9.x)) + (r1.w);
    r2 = tex2D(s9, v7.xy);
    r4.xyz = float3(((r6.w) >= 0.0f ? (r2.y) : (c[32].x)), ((r6.w) >= 0.0f ? (r2.y) : (c[32].y)), ((r6.w) >= 0.0f ? (r2.y) : (c[32].w)));
    r5.y = (r1.w) + (r1.w);
    r3.xyz = -(r4.xyz);
    r7.xyz = (r5.xyz) * (r0.www) + (r7.xyz);
    r3.w = (r3.y) + (-(c2.y));
    r2 = (r2.wwww) * (c3.xxxy) + (c3.zzzx);
    r9.xyz = (r5.www) * (r3.xwz) + (r4.xyz);
    r12.xyz = (r7.xyz) * (r9.yyy);
