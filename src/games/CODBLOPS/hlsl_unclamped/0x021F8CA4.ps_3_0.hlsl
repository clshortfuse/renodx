// Mechanically reconstructed from 0x021F8CA4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r1.w) * (v5.y);
    r4.xy = c0.xy;
    r4.xyz = (r4.xyx) + (-(c[5].xyw));
    r7.xyz = lerp(r2.xyz, r1.xyz, r1.www);
    r10.xyz = (r1.www) * (r4.xyz) + (c[5].xyw);
