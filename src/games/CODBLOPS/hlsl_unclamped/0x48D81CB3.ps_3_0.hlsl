// Mechanically reconstructed from 0x48D81CB3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c12 = float4(2.0f, -1.0f, -101.222f, 103.222f);
    ...
    r4.xy = lerp(c[8].xy, c[8].zw, v4.xy);
    r5 = tex2D(s2, r4.xy);
    r6 = tex2D(s3, r4.xy);
    r4 = tex2D(s4, r4.xy);
    r5.xw = (r5.xx) * (c1.xy) + (c1.yx);
    r5.y = r6.x;
    r4.y = dot(c13.xyz, r5.xyw);
    r5.z = r4.x;
    r4.z = dot(c14, r5);
    r4.w = dot(c0.xyz, r5.xzw);
