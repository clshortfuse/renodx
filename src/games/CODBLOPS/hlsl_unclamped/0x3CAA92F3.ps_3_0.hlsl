// Mechanically reconstructed from 0x3CAA92F3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.y = dot(r1.xy, r0.zw) + (c36.z);
    r6.x = dot(r1.xy, r0.xy) + (c36.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s5, v7.xy);
    r6.z = (r0.w) * (v0.y);
    r2 = tex2D(s1, v1.xy);
    r2.xy = (r2.wy) * (c1.xy) + (c1.zw);
    r5.xyz = lerp(r1.xyz, r0.xyz, r6.zzz);
    r7.xy = lerp(r2.xy, r3.xy, r6.zz);
    r0 = tex2D(s10, v7.xy);
    r3 = (r0.wwww) * (-(c36.zzzy)) + (-(c36.wwwz));
    r4 = tex2D(s9, v1.xy);
    r1 = tex2D(s6, v7.zw);
    r6.w = (r1.w) * (v0.z);
    r2 = lerp(r4, r3, r6.zzzz);
    r3.xyz = lerp(r5.xyz, r1.xyz, r6.www);
    r5.xy = lerp(r7.xy, r6.xy, r6.ww);
    r4.xyz = lerp(c[32].xyw, r0.yyy, r6.zzz);
    r1 = tex2D(s11, v7.zw);
    r0 = lerp(r2, r1, r6.wwww);
    r14.xyz = lerp(r4.xyz, c[33].xyw, r6.www);
    r1.w = dot(r5.xy, r5.xy) + (c36.z);
    ...
    r10.xy = (r3.xz) * (r4.xx);
    r1.w = dot(r6.xy, r5.xy) + (c36.z);
    r1.y = (r2.x) * (c4.w) + (-(r10.x));
    r2.w = (r3.z) * (-(r4.x)) + (r1.y);
    r3.xy = (r1.xz) * (r4.yy);
    r1.y = (r2.y) * (c4.w) + (-(r3.x));
    r1.x = dot(r6.xy, r6.xy) + (c36.z);
    r1.y = (r1.z) * (-(r4.y)) + (r1.y);
    r1.z = exp2(-(r1.x));
    r6.y = (r2.w) + (r2.w);
    r1.z = (r1.z) * (c3.x) + (c3.y);
