// Mechanically reconstructed from 0x479D05F5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s4, v7.xy);
    r2.w = (r2.w) * (v0.y) + (c1.x);
    r11.xyz = float3(((r2.w) >= 0.0f ? (c[36].x) : (r0.y)), ((r2.w) >= 0.0f ? (c[36].y) : (r0.y)), ((r2.w) >= 0.0f ? (c[36].w) : (r0.y)));
    ...
    r5.w = saturate(dot(r10.xyz, -(r13.xyz)));
    r3.w = (-(r5.w)) + (c1.z);
