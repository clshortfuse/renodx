// Mechanically reconstructed from 0xE7900CB4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.x = dot(r4.xy, r0.xy) + (c1.z);
    r2.y = dot(r4.xy, r0.zw) + (c1.z);
    r0 = tex2D(s3, v6.xy);
    r3.w = (r0.w) * (v0.y) + (c1.w);
