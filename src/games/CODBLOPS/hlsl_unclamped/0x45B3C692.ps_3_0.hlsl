// Mechanically reconstructed from 0x45B3C692.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r14.xy = c0.xy;
    r2.xyz = (r14.xyx) + (-(c[20].xyw));
    r0 = tex2D(s1, v4.zw);
    r7.w = (r0.w) * (v4.y);
    r1.xyz = (r2.www) * (r1.xyz);
    r7.xyz = (r7.www) * (r2.xyz) + (c[20].xyw);
    r5.w = 1.0f / (r3.x);
    ...
    r5.xyz = lerp(r3.xyz, r0.xyz, r7.www);
    r0.z = dot(r8.xy, r8.xy) + (c0.x);
    r3 = tex2D(s14, v0.zw);
    r8.xy = (r3.xy) * (c2.ww);
    r0.z = exp2(-(r0.z));
    r0.xy = (r4.xz) * (r8.yy);
