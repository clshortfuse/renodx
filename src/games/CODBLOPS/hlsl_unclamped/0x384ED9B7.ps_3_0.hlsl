// Mechanically reconstructed from 0x384ED9B7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r1.x) * (r1.x);
    r1.z = saturate(dot(r6.xyz, r10.xyz));
    r2.w = (r2.w) * (r2.w);
    r2.z = (r1.x) * (r2.w);
    ...
    r2.xyz = (r2.yyy) * (r10.xyz);
    r2.w = (r2.w) + (r2.w);
    r5.xyz = (r3.xyz) * (r5.xyz) + (r2.xyz);
    r2.xyz = (r6.xyz) * (-(r2.www)) + (r9.xyz);
