// Mechanically reconstructed from 0x1442BEAF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = (c[28].zz) * (r2.xy) + (r0.xy);
    r0 = tex2D(s0, v1.xy);
    r5.w = (r0.w) * (v0.w) + (c1.x);
    r4.xy = float2(((r5.w) >= 0.0f ? (r2.x) : (c1.z)), ((r5.w) >= 0.0f ? (r2.y) : (c1.z)));
    ...
    r6.w = saturate(dot(r7.xyz, -(r5.xyz)));
    r1 = tex2D(s3, v1.xy);
    r2.xyz = (-(v5.xyz)) + (c[5].xyz);
    r0.w = dot(r2.xyz, r2.xyz);
    r1 = float4(((r5.w) >= 0.0f ? (r1.x) : (c1.z)), ((r5.w) >= 0.0f ? (r1.y) : (c1.z)), ((r5.w) >= 0.0f ? (r1.z) : (c1.z)), ((r5.w) >= 0.0f ? (r1.w) : (c1.y)));
    r4.w = rsqrt(r0.w);
    r3.w = (r1.w) * (c1.w);
