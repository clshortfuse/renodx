// Mechanically reconstructed from 0x967259E4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c37 = float4(4.0f, -2.0f, 0.797884583f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = tex2D(s5, v7.zw);
    r5.w = (r0.w) * (v0.z);
    r5.xyz = float3(((r1.w) >= 0.0f ? (r4.x) : (r5.x)), ((r1.w) >= 0.0f ? (r4.y) : (r5.y)), ((r1.w) >= 0.0f ? (r4.z) : (r5.z)));
    r7.xy = (r5.ww) * (-(r1.xy)) + (r1.xy);
    r4.w = ((r1.w) >= 0.0f ? (r2.y) : (r3.y));
    ...
    r11.xz = (r1.xy) * (c12.ww);
    r8.xyz = lerp(r4.www, c[34].xyw, r5.www);
    r0.xyz = (r11.xyz) * (r1.www) + (r0.xyz);
    ...
    r1 = (r5.wwww) * (r0) + (r1.wwwz);
    r3.xyz = (v0.www) * (r2.xyz) + (-(c3.yyy));
