// Mechanically reconstructed from 0x513BC74E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c6 = float4(4.0f, -2.0f, 0.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r6.w = (r2.w) * (v0.y) + (c1.x);
    r5 = tex2D(s4, v1.xy);
    r5.xy = float2(((r6.w) >= 0.0f ? (c1.y) : (r5.y)), ((r6.w) >= 0.0f ? (c1.z) : (r5.y)));
    r1 = tex2D(s3, v7.zw);
    r1.w = (r1.w) * (v0.z) + (c1.x);
    r0.xyz = (r6.xyz) * (r0.www) + (r3.xyz);
    r8.xy = float2(((r1.w) >= 0.0f ? (c1.y) : (r5.x)), ((r1.w) >= 0.0f ? (c1.z) : (r5.y)));
    ...
    r0.y = saturate(dot(r0.xyz, -(r7.xyz)));
    r4.w = (r5.w) * (c1.w);
    r0.z = (r5.w) * (c2.z) + (c2.w);
