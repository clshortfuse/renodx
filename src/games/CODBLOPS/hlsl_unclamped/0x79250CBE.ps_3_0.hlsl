// Mechanically reconstructed from 0x79250CBE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xy = (r3.xz) * (r6.yy);
    r1.w = (r2.y) * (c10.w) + (-(r3.x));
    r4.xz = (r3.xy) * (c11.xx);
    r1.w = (r3.z) * (-(r6.y)) + (r1.w);
    r1.xy = (r1.xz) * (r6.xx);
    r4.y = (r1.w) + (r1.w);
    r1.w = (r2.x) * (c10.w) + (-(r1.x));
    ...
    r1 = tex2D(s2, v6.xy);
    r1.w = (r1.w) * (v0.y) + (c1.z);
    r8.xyz = (r6.xyz) * (r0.www) + (r2.xyz);
    r0.w = c1.w;
    r4.xy = float2(((r1.w) >= 0.0f ? (r0.w) : (c[8].x)), ((r1.w) >= 0.0f ? (r0.w) : (c[8].y)));
    r2 = tex2D(s6, v6.zw);
    r3.xyz = v2.xyz;
    ...
    r0.w = (r0.w) * (r3.z);
    r3.w = 1.0f / (r3.w);
    r4.xyz = (r8.xyz) * (r9.yyy);
    r3.w = (r0.w) * (r3.w);
    r3.xyz = (r2.xyz) * (-(r2.xyz)) + (c1.www);
    ...
    r3.xyz = (r2.xyz) * (r2.xyz) + (r8.xyz);
    r2.xyz = (r9.xxx) * (r7.xyz);
