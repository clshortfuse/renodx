// Mechanically reconstructed from 0x74C63687.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.z = dot(r0.xyz, c[24].xyz);
    r3.x = 1.0f / (r2.y);
    r2.z = saturate((r2.z) * (c[25].x) + (c[25].y));
    r7.w = saturate(dot(r0.xyz, r7.xyz));
    r0.z = (r2.z) * (c[25].w);
    r5.w = lerp(r1.w, r2.w, r0.z);
    r2.xy = saturate((r3.xx) * (c[27].xy) + (c[27].zw));
    r0.xy = (r2.xy) * (r2.xy);
    r2.xy = (r2.xy) * (c2.xx) + (c2.yy);
    r1.w = dot(c[26].yz, r3.xy) + (c[26].x);
    r2.xy = (r0.xy) * (r2.xy);
