// Mechanically reconstructed from 0x448C1ED6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = (-(r1.w)) + (c1.y);
    r1.xy = (c[7].zz) * (r1.xy) + (r0.xy);
    r0 = tex2D(s0, v1.xy);
    r3.z = (r0.w) * (v0.w) + (c1.x);
    r0.w = (r3.w) * (r3.w);
    r3.xy = float2(((r3.z) >= 0.0f ? (r1.x) : (c1.z)), ((r3.z) >= 0.0f ? (r1.y) : (c1.z)));
    r0.w = (r0.w) * (r0.w);
    r1 = v2;
    ...
    r0 = float4(((r3.z) >= 0.0f ? (r0.x) : (c1.z)), ((r3.z) >= 0.0f ? (r0.y) : (c1.z)), ((r3.z) >= 0.0f ? (r0.z) : (c1.z)), ((r3.z) >= 0.0f ? (r0.w) : (c1.z)));
    r0.xyz = (r0.xyz) * (v0.xyz);
    r12.xyz = (r2.www) * (v7.xyz);
    r8.xyz = (r0.xyz) * (r0.xyz);
    r8.w = saturate(dot(r11.xyz, -(r12.xyz)));
    r2 = tex2D(s3, v1.xy);
    r2 = float4(((r3.z) >= 0.0f ? (r2.x) : (c1.z)), ((r3.z) >= 0.0f ? (r2.y) : (c1.z)), ((r3.z) >= 0.0f ? (r2.z) : (c1.z)), ((r3.z) >= 0.0f ? (r2.w) : (c1.y)));
    r9.xyz = (r2.xyz) * (-(r2.xyz)) + (c1.yyy);
    r10.xyz = (r2.xyz) * (r2.xyz);
    r0.z = (r2.w) * (-(c3.y)) + (c3.z);
    r4.w = dot(r11.xyz, c[17].xyz);
    r0.y = (r2.w) * (c3.y);
    r1.z = saturate(r4.w);
    r1.x = (r8.w) * (r0.z) + (r0.y);
    r1.y = (r1.z) * (r0.z) + (r0.y);
    r0.xyz = (r9.xyz) * (r3.xxx) + (r10.xyz);
    r1.y = (r1.y) * (r1.x) + (c3.w);
    r1.y = 1.0f / (r1.y);
    ...
    r1.y = (r1.y) * (r1.z);
    r1.z = max(abs(r11.x), r2.z);
    r2.xyz = (r0.xyz) * (r1.yyy);
    r3.w = 1.0f / (r1.z);
    r0.y = c1.z;
    r1.xyz = float3(((r3.z) >= 0.0f ? (c[6].x) : (r0.y)), ((r3.z) >= 0.0f ? (c[6].y) : (r0.y)), ((r3.z) >= 0.0f ? (c[6].w) : (r0.y)));
