// Mechanically reconstructed from 0x41CDA6B3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.w = (r3.w) * (v0.z) + (c1.w);
    r8.w = rsqrt(r6.y);
    r6.w = ((r9.w) >= 0.0f ? (r0.y) : (r2.y));
    r6.x = 1.0f / (r8.w);
    r1.xy = saturate((r6.xx) * (c[28].xy) + (c[28].zw));
    r0.xy = (r1.xy) * (r1.xy);
    r1.xy = (r1.xy) * (c13.xx) + (c13.yy);
    r0.z = dot(c[27].yz, r6.xy) + (c[27].x);
    r0.xy = (r0.xy) * (r1.xy);
    r1 = (r0.wwww) * (c3.xxxy) + (c3.zzzx);
    r0.w = (r0.z) * (r0.x);
    r8.xyz = (r4.xyz) * (r6.www);
    r2.z = (r0.y) * (r0.w);
    r4 = tex2D(s12, v1.zw);
    r0 = v2;
    ...
    r11.z = saturate(dot(r6.xyz, r9.xyz));
    r7.w = (r2.z) * (r4.y);
    r0.xyz = (r11.zzz) * (c[25].xyz);
    r4 = tex2D(s0, v1.xy);
    r5 = tex2D(s3, v7.xy);
    r2.xyz = (r5.xyz) + (c1.xxx);
    r2.xyz = (v0.yyy) * (r2.xyz) + (c1.yyy);
    r0.xyz = (r7.www) * (r0.xyz) + (r8.xyz);
    r4.xyz = (r4.xyz) * (r2.xyz);
    r2.xyz = (r2.xyz) * (c1.zzz);
    r4.xyz = float3(((r9.w) >= 0.0f ? (r3.x) : (r4.x)), ((r9.w) >= 0.0f ? (r3.y) : (r4.y)), ((r9.w) >= 0.0f ? (r3.z) : (r4.z)));
    r3 = tex2D(s5, v8.xy);
