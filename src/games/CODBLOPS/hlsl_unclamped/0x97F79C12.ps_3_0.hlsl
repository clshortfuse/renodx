// Mechanically reconstructed from 0x97F79C12.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = dot(r7.xy, r0.xy) + (c12.z);
    r1.y = dot(r7.xy, r0.zw) + (c12.z);
    r0 = tex2D(s3, v6.zw);
    r6.w = (r0.w) * (v6.y);
    ...
    r1.x = (r3.w) * (r4.w);
    r1.z = (r1.z) * (r2.w) + (c3.x);
    r2.z = (r1.x) * (c13.x) + (c13.y);
    r1.z = 1.0f / (r1.z);
    r7.w = (-(r1.y)) + (c12.w);
    r1.z = (r1.w) * (r1.z);
    r6.xyz = (r1.www) * (c[21].xyz);
    r1.xy = (r10.xx) * (c14.xy) + (c14.zw);
    ...
    r1.y = dot(r7.xy, r7.xy) + (c12.z);
    r1.w = dot(r2.xy, r2.xy) + (c12.z);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r3.w = (r1.y) * (c1.x) + (c1.y);
    r1.y = (r1.w) * (c1.x) + (c1.y);
    r1.w = dot(r2.xy, r7.xy) + (c12.z);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v0.zw);
    r9.xy = (r2.xy) * (c2.ww);
    ...
    r5.w = (r1.w) * (-(v6.x)) + (c12.w);
    r6.w = (r0.w) * (-(v6.y)) + (c12.w);
