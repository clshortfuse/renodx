// Mechanically reconstructed from 0xA00D9CE3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.xyz = (v0.yyy) * (r4.xyz) + (c1.yyy);
    r4 = tex2D(s4, v7.zw);
    r7.xyz = (r4.xyz) + (c1.xxx);
    r4.xyz = (r3.xyz) * (r9.xyz);
    r3.xyz = (v0.zzz) * (r7.xyz) + (c1.yyy);
    r7.xyz = normalize(r0.xyz);
    r0.xyz = (r4.xyz) * (-(r3.xyz)) + (r2.xyz);
