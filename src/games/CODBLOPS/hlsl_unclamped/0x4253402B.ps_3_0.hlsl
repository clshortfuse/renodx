// Mechanically reconstructed from 0x4253402B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c12 = float4(2.0f, -1.0f, 1.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r1.x = dot(r2.xy, r1.xy) + (c12.w);
    r1.y = dot(r2.xy, r1.zw) + (c12.w);
    r2 = tex2D(s3, v6.zw);
    r3.w = (r2.w) * (v0.z);
    r4.xy = (r0.yw) * (c10.xx) + (c10.yy);
    r5.xy = lerp(r6.xy, r1.xy, r3.ww);
    r0.y = dot(r4.xy, r4.xy) + (c12.w);
    r0.w = dot(r5.xy, r5.xy) + (c12.w);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r0.y = (r0.y) * (c2.x) + (c2.y);
    r0.w = (r0.w) * (c2.x) + (c2.y);
