// Mechanically reconstructed from 0xA479E7DC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.y = (r1.x) * (r0.z);
    r3.xzw = c[7].xzw;
    r1.x = dot(r0.xw, c[26].xy) + (r3.x);
    r1.y = dot(r0.xw, c[26].zw) + (r3.z);
    r0 = tex2D(s3, r1.xy);
    ...
    r3.xy = float2(((r2.w) >= 0.0f ? (r1.x) : (c1.z)), ((r2.w) >= 0.0f ? (r1.y) : (c1.z)));
