// Mechanically reconstructed from 0xCE18835B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.w = (r2.w) * (v0.y) + (c1.x);
    r0.yz = c1.yz;
    r4.xyz = float3(((r7.w) >= 0.0f ? (r0.y) : (c[29].x)), ((r7.w) >= 0.0f ? (r0.z) : (c[29].y)), ((r7.w) >= 0.0f ? (r0.y) : (c[29].w)));
    r8.xyz = (-(v7.xyz)) + (c[5].xyz);
    r0 = v2;
    r0.xyz = (r7.xxx) * (v5.xyz) + (r0.xyz);
    r1.w = dot(r8.xyz, r8.xyz);
    r5.xyz = (r7.yyy) * (v4.xyz) + (r0.xyz);
    r8.w = rsqrt(r1.w);
    r0.xyz = normalize(r5.xyz);
    r7.xyz = (r8.xyz) * (r8.www);
    r9.xyz = lerp(r4.xyz, c[30].xyw, r6.www);
    ...
    r4.xyz = (r11.xyz) * (r12.xyz) + (r13.xyz);
