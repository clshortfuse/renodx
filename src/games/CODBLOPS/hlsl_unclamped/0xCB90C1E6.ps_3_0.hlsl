// Mechanically reconstructed from 0xCB90C1E6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xy = (r3.xy) * (r4.xy);
    r11.xyz = (r0.www) * (r2.xyz) + (c[39].xyw);
    r1.w = (r1.w) * (r3.x);
    ...
    r2.xyz = (v0.zzz) * (r2.xyz) + (c1.www);
    r3.xyz = (r9.www) * (r3.xyz) + (r6.xyz);
    ...
    r8.z = (r4.z) + (r4.z);
    r4.xyz = (r5.xyz) * (r3.xyz) + (r0.xyz);
    r0.xyz = (r10.xyz) * (-(r8.zzz)) + (r6.xyz);
    ...
    r8.x = dot(r0, c[25]);
    r8.y = dot(r0, c[26]);
    r7.xyz = (r3.xyz) * (c3.zzz) + (r4.xyz);
    r4.xy = (r3.ww) * (r8.xy);
    r3.x = dot(r0, c[27]);
    r0.xy = (r4.xy) * (c4.yy) + (c4.yy);
    r0 = tex2D(s2, r0.xy);
    r3.y = (r3.x) * (r3.x);
    r0.xyz = (r0.xyz) * (r0.xyz);
    ...
    r4.xyz = (r4.xyz) * (r6.www) + (-(r6.xyz));
    r0.w = saturate((r0.w) * (c[30].x) + (c[30].y));
    r6.w = dot(c[36].xyz, r6.xyz);
    r6.z = (r0.w) * (r0.w);
