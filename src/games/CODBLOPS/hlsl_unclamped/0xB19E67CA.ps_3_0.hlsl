// Mechanically reconstructed from 0xB19E67CA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = (r9.wwww) * (r2) + (r6);
    r6.w = lerp(r5.y, r4.y, r8.w);
    r3.w = (r2.w) * (c3.z);
    r3 = texCUBElod(s15, r3);
    r3.xyz = (r3.xyz) * (r3.xyz);
    r1.w = (-(r1.w)) + (-(c2.y));
    r8.xy = lerp(r6.ww, c[8].xy, r9.ww);
    r3.w = (r1.w) * (r1.w);
    ...
    r2 = tex2D(s0, v1.xy);
    r3.xyz = lerp(r2.xyz, r1.xyz, r8.www);
    r1.xyz = (r7.xyz) * (r3.www);
    r2.xyz = lerp(r3.xyz, r0.xyz, r9.www);
