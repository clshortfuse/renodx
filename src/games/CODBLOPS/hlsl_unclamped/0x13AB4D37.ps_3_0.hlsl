// Mechanically reconstructed from 0x13AB4D37.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = (r0.z) * (r0.y);
    r10.w = (r2.w) * (r2.w);
    r2.w = (r9.w) * (r0.z) + (r10.w);
    r0.w = saturate((r0.w) * (c[30].x) + (c[30].y));
    r4.w = (r0.w) * (c16.z) + (c16.w);
    r3.w = (r0.w) * (r0.w);
    r0 = tex2D(s6, v7.zw);
    r0.yz = (r0.wy) + (c1.yy);
    r11.xy = (r6.ww) * (r0.yz) + (c1.xx);
    r0.xyz = v1.xyz;
    r0.xyz = (r8.xxx) * (v4.xyz) + (r0.xyz);
    r8.w = (r11.x) * (-(c12.z)) + (c12.w);
    r0.xyz = (r8.yyy) * (v3.xyz) + (r0.xyz);
    r9.xyz = normalize(r0.xyz);
    r0.x = (r11.x) * (c3.w);
    r6.w = saturate(dot(r4.xyz, r9.xyz));
    r11.z = saturate(dot(r9.xyz, -(r7.xyz)));
    r0.w = (r6.w) * (r8.w) + (r0.x);
    r4.z = (r11.z) * (r8.w) + (r0.x);
    r7.w = (r4.w) * (r3.w);
    r0.w = (r0.w) * (r4.z) + (c15.x);
    r0.z = (r9.w) * (r1.w) + (r10.w);
    r0.w = 1.0f / (r0.w);
    r3.w = (r6.w) * (r0.w);
    r12.xy = (r11.xx) * (c37.xy) + (c37.zw);
    r4.w = exp2(r12.y);
    r1.w = saturate(dot(r9.xyz, r3.xyz));
    r11.w = dot(r7.xyz, r9.xyz);
    r0.y = pow(abs(r1.w), r4.w);
    r0.w = (r4.w) * (c15.y) + (c15.z);
    r1.w = saturate(dot(r9.xyz, c[17].xyz));
    r0.y = (r0.y) * (r0.w);
    r0.x = (r1.w) * (r8.w) + (r0.x);
    r3.z = saturate(dot(r9.xyz, r2.xyz));
    r0.x = (r0.x) * (r4.z) + (c15.x);
