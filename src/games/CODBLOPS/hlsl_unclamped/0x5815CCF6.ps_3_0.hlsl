// Mechanically reconstructed from 0x5815CCF6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.y = dot(r1.xy, r0.zw) + (c16.w);
    r6.x = dot(r1.xy, r0.xy) + (c16.w);
    r1 = tex2D(s1, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r0.xyz = (r0.xyz) + (c16.yyy);
    r4.xyz = (v0.yyy) * (r0.xyz) + (c16.zzz);
    r0 = tex2D(s0, v1.xy);
    r2 = tex2D(s4, v7.zw);
    r3.w = (r2.w) * (v0.z);
    ...
    r2.xyz = (r0.xyz) * (r4.xyz) + (r1.xyz);
    r0.xy = (v1.zw) * (c4.xy) + (c4.zy);
    r0 = tex2D(s13, r0.xy);
    r1.xy = (v1.zw) * (c4.xy);
    r1 = tex2D(s13, r1.xy);
    r0.w = r1.y;
    r5.xy = lerp(r7.xy, r6.xy, r3.ww);
    r6.xy = (r0.wy) * (c10.xx) + (c10.yy);
