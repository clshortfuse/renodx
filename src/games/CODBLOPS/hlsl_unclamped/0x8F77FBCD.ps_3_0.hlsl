// Mechanically reconstructed from 0x8F77FBCD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r3.w = (r0.w) * (v0.w) + (c1.x);
    r4.xyz = float3(((r3.w) >= 0.0f ? (r1.x) : (c1.z)), ((r3.w) >= 0.0f ? (r1.y) : (c1.z)), ((r3.w) >= 0.0f ? (r1.z) : (c1.z)));
    r1 = v2;
    ...
    r3.w = dot(r1.xyz, c[8].xyz);
    r4.x = 1.0f / (r4.x);
    r5.w = saturate((r3.w) * (c[9].x) + (c[9].y));
    r3.w = saturate(dot(r1.xyz, r3.xyz));
    r1.z = (r5.w) * (c[9].w);
    r3.z = lerp(r2.w, r4.w, r1.z);
    r3.xy = saturate((r4.xx) * (c[11].xy) + (c[11].zw));
    r1.xy = (r3.xy) * (r3.xy);
    r3.xy = (r3.xy) * (c2.xx) + (c2.yy);
    r2.w = dot(c[10].yz, r4.xy) + (c[10].x);
    r3.xy = (r1.xy) * (r3.xy);
