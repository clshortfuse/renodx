// Mechanically reconstructed from 0x6C8DF318.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = saturate((r6.xx) * (c[33].xy) + (c[33].zw));
    ...
    r4.xyz = (r0.xyz) * (-(r0.xyz)) + (c0.www);
    r1.w = (r11.w) * (r1.w);
    r0.xyz = (r4.xyz) * (r2.www) + (r7.xyz);
    r2.w = 1.0f / (r6.x);
    r0.xyz = (r1.www) * (r0.xyz);
    r1.w = (r0.w) * (c0.y);
    r6.xyz = (r0.xyz) * (c[35].www);
    r0 = tex2D(s5, v1.xy);
