// Mechanically reconstructed from 0x1AC16C4F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c28 = float4(4.0f, -2.0f, 0.797884583f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0.xyw = c[24].xyw;
    r1.xyz = (-(r0.xyw)) + (c[25].xyw);
    r0 = tex2D(s5, v8.zw);
    r4.w = (r0.w) * (v0.z);
    r4.xyz = (r3.www) * (r1.xyz) + (c[24].xyw);
    r3.xyz = lerp(r5.xyz, r0.xyz, r4.www);
    r0 = tex2D(s9, v8.zw);
    r1 = lerp(r2, r0, r4.wwww);
    r11.xyz = lerp(r4.xyz, c[26].xyw, r4.www);
