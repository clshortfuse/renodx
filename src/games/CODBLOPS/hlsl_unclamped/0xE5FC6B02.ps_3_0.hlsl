// Mechanically reconstructed from 0xE5FC6B02.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c35 = float4(2.0f, -1.0f, 1.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r4.y = dot(r2.xy, r0.zw) + (c35.w);
    r1 = tex2D(s5, v7.xy);
    r1.xyz = (r1.xyz) + (c35.yyy);
    r4.x = dot(r2.xy, r0.xy) + (c35.w);
    r1.xyz = (v0.yyy) * (r1.xyz) + (c35.zzz);
    r2 = tex2D(s8, v1.xy);
    ...
    r15.xyz = (r0.xyz) * (-(r0.xyz)) + (c35.zzz);
    r1.w = dot(r5.xy, r5.xy) + (c35.w);
    ...
    r3.w = r1.y;
    r10.xy = (r3.xz) * (r6.xx);
    r3.xy = (r3.yw) * (c4.yy) + (c4.zz);
    r1.y = (r2.x) * (c4.x) + (-(r10.x));
    r1.w = dot(r3.xy, r5.xy) + (c35.w);
    r2.w = (r3.z) * (-(r6.x)) + (r1.y);
    r4.xy = (r1.xz) * (r6.yy);
    r1.x = dot(r3.xy, r3.xy) + (c35.w);
    r1.y = (r2.y) * (c4.x) + (-(r4.x));
    r1.x = exp2(-(r1.x));
    r1.y = (r1.z) * (-(r6.y)) + (r1.y);
    r1.z = (r1.x) * (c3.y) + (c3.z);
    ...
    r3.z = (r2.y) * (r2.w);
    r2.xyw = c[33].xyw;
    r14.xyz = float3(((r4.w) >= 0.0f ? (r2.x) : (c[32].x)), ((r4.w) >= 0.0f ? (r2.y) : (c[32].y)), ((r4.w) >= 0.0f ? (r2.w) : (c[32].w)));
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c35.z) : (c35.w));
