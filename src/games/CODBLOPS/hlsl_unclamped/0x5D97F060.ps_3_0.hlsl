// Mechanically reconstructed from 0x5D97F060.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xyz = (v0.yyy) * (r0.xyz) + (c16.zzz);
    r0.w = dot(r5.xyz, r10.xyz);
    r3.xyz = (r11.xyz) * (c16.www);
    r7.w = (r0.w) + (r0.w);
    r0 = lerp(r3, r1, r5.wwww);
    r1.xyz = (r10.xyz) * (-(r7.www)) + (r5.xyz);
    r1.w = (r0.w) * (c3.w);
    ...
    r1.xyz = (r6.xyz) * (r4.www) + (r13.xyz);
    r0.xyz = (r0.xyz) * (r3.xyz);
    r3.xyz = (r2.www) * (r1.xyz);
    r0.xyz = (r6.xyz) * (r0.xyz);
    r4.w = exp2(r14.y);
    r6.xyz = (r0.xyz) * (c3.www);
    r1 = tex2D(s0, v1.xy);
    r0.xyz = (r1.xyz) * (-(r11.xyz)) + (r2.xyz);
