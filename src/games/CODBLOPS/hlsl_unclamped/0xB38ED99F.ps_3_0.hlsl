// Mechanically reconstructed from 0xB38ED99F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s3, v7.zw);
    r4.w = (r0.w) * (v7.y) + (c1.w);
    r9.xy = float2(((r4.w) >= 0.0f ? (r1.x) : (r3.x)), ((r4.w) >= 0.0f ? (r1.y) : (r3.y)));
    r3 = tex2D(s5, v0.xy);
    r1 = tex2D(s6, v7.zw);
    r1 = float4(((r4.w) >= 0.0f ? (r1.x) : (r3.x)), ((r4.w) >= 0.0f ? (r1.y) : (r3.y)), ((r4.w) >= 0.0f ? (r1.z) : (r3.z)), ((r4.w) >= 0.0f ? (r1.w) : (r3.w)));
    r3.xyz = float3(((r4.w) >= 0.0f ? (r0.x) : (r2.x)), ((r4.w) >= 0.0f ? (r0.y) : (r2.y)), ((r4.w) >= 0.0f ? (r0.z) : (r2.z)));
    ...
    r2.xz = (r0.xy) * (c4.yy);
    r0 = v1;
    r1.xyz = (r9.xxx) * (v4.xyz) + (r0.xyz);
    r0.xyz = (r2.www) * (r2.xyz);
    r1.xyz = (r9.yyy) * (v3.xyz) + (r1.xyz);
    r9.xyz = normalize(r1.xyz);
    r1.xyz = (r6.www) * (v6.xyz);
    r2.w = (r1.w) * (-(c13.x)) + (c13.y);
    r7.w = saturate(dot(r9.xyz, -(r1.xyz)));
    r2.y = (r1.w) * (c3.w);
    r3.z = saturate(dot(r9.xyz, c[17].xyz));
    r2.z = (r7.w) * (r2.w) + (r2.y);
    r2.w = (r3.z) * (r2.w) + (r2.y);
    r8.xz = (r6.xy) * (c4.yy);
    r2.w = (r2.w) * (r2.z) + (c4.w);
    r2.y = 1.0f / (r2.w);
    r16.xy = (r1.ww) * (c12.xy) + (c12.zw);
    r3.y = saturate(dot(r9.xyz, r5.xyz));
    r3.w = exp2(r16.y);
    r2.z = pow(abs(r3.y), r3.w);
    ...
    r3.xyw = c[21].xyw;
    r12.xyz = float3(((r4.w) >= 0.0f ? (r3.x) : (c[20].x)), ((r4.w) >= 0.0f ? (r3.y) : (c[20].y)), ((r4.w) >= 0.0f ? (r3.w) : (c[20].w)));
    r14.xyz = (r2.xyz) * (r12.yyy);
    r15.xyz = (r0.xyz) * (r12.zzz);
    r2 = tex2D(s12, v0.zw);
    r0.z = ((-abs(r2.y)) >= 0.0f ? (-(c1.y)) : (-(c1.z)));
    r13.xyz = (r3.zzz) * (c[18].xyz);
    if ((r0.z) != (-(r0.z)))
    {
        r0.z = r2.y;
        r2.w = r0.z;
