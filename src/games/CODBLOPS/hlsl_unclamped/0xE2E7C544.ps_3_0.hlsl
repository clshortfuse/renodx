// Mechanically reconstructed from 0xE2E7C544.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.w = (r2.w) * (-(c3.x)) + (c3.y);
    r5.y = saturate(dot(r10.xyz, -(r9.xyz)));
    r5.z = (r5.w) * (r7.w) + (r8.w);
    r6.w = (r5.y) * (r7.w) + (r8.w);
    ...
    r5.z = 1.0f / (r5.z);
    r11.z = (r5.w) * (r5.z);
    r5.xyz = (r3.xyz) * (r4.www) + (-(r9.xyz));
    r7.xyz = (r5.www) * (c[37].xyz);
    ...
    r3.xy = saturate((r14.xx) * (c[40].xy) + (c[40].zw));
    r3.z = dot(c[39].yz, r14.xy) + (c[39].x);
    r2.xy = (r3.xy) * (r3.xy);
    r3.xy = (r3.xy) * (c2.zz) + (c2.ww);
