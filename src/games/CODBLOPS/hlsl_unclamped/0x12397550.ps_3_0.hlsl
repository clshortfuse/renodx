// Mechanically reconstructed from 0x12397550.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = r0.y;
    r0.w = exp2(-(r2.w));
    r6.xy = (r1.yw) * (c38.xx) + (c38.yy);
    r3.z = (r0.w) * (c3.x) + (c3.y);
    r1.w = dot(r6.xy, r4.xy) + (c1.z);
    r2 = tex2D(s14, v0.zw);
    r7.xy = (r2.xy) * (c3.ww);
    r3.xy = (r1.xz) * (r7.xx);
    r5.xy = (r0.xz) * (r7.yy);
    ...
    r0 = tex2D(s5, v7.zw);
    r1.z = (r0.w) * (v7.y) + (c1.x);
    r2.xyz = float3(((r1.z) >= 0.0f ? (r0.x) : (r2.x)), ((r1.z) >= 0.0f ? (r0.y) : (r2.y)), ((r1.z) >= 0.0f ? (r0.z) : (r2.z)));
    r0 = v1;
    ...
    r7.w = c1.y;
    r7.xyz = float3(((r1.z) >= 0.0f ? (r7.w) : (c[36].x)), ((r1.z) >= 0.0f ? (r7.w) : (c[36].y)), ((r1.z) >= 0.0f ? (r7.w) : (c[36].w)));
