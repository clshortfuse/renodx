// Mechanically reconstructed from 0xC14E950D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(8.0f, 1.0f, 3.5f, 0.5f);
    const float4 c2 = float4(0.200000003f, 0.0f, 0.600000024f, 0.400000006f);
    ...
    r2.z = 1.0f / (r0.z);
    r1 = tex2D(s0, v1.xy);
    r0.xyz = lerp(r1.xyz, c2.xxx, r2.xxx);
    r1.w = (r2.w) * (r2.z);
    r6.xyz = (r0.xyz) * (-(r0.xyz)) + (c1.yyy);
    r3.xyz = (r3.xyz) * (r3.xyz);
    r6.xyz = (r1.www) * (r6.xyz);
    r3.xyz = (r2.yyy) * (r3.xyz);
    r6.xyz = (r0.xyz) * (r0.xyz) + (r6.xyz);
    r0.xyz = (r2.xxx) * (r1.xyz);
    r1.xyz = (r3.xyz) * (r6.xyz);
