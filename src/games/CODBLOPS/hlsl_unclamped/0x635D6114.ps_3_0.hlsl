// Mechanically reconstructed from 0x635D6114.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = dot(c[30].yz, r1.xy) + (c[30].x);
    r4.xy = (c[33].zz) * (r3.xy) + (r0.xy);
    r3.xy = saturate((r1.xx) * (c[31].xy) + (c[31].zw));
    r0 = v2;
    ...
    r1 = (v6.zzzz) * (c[26]) + (r1);
    r6.xyz = (r0.zzz) * (c[29].xyz);
    r1 = (r1) + (c[27]);
    r4.xy = (r1.ww) * (c[32].xy) + (r1.xy);
    r4.zw = r1.zw;
    r2 = tex2Dproj(s2, r4);
    r3.zw = r4.zw;
    r1.zw = r3.zw;
    r5.xy = (r4.ww) * (-(c[32].zw)) + (r1.xy);
    r5.zw = r1.zw;
    r5 = tex2Dproj(s2, r5);
    r2.w = r5.x;
    r3.xy = (r4.ww) * (-(c[32].xy)) + (r1.xy);
    r1.xy = (r4.ww) * (c[32].zw) + (r1.xy);
    r3 = tex2Dproj(s2, r3);
    r2.y = r3.x;
    r3 = tex2Dproj(s2, r1);
