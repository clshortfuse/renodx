// Mechanically reconstructed from 0x46382515.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = (r1.xyz) * (-(r1.xyz)) + (c3.xxx);
    r4.w = (r4.w) * (r0.y);
    r0.xyz = (r6.xyz) * (r0.zzz) + (r10.xyz);
    r1.xyz = (r3.www) * (r3.xyz) + (r4.xyz);
    ...
    r2.x = c[28].w;
    r1.xy = (c[30].xy) * (-(r2.xx)) + (v1.xy);
    r1 = tex2D(s5, r1.xy);
    r2.xy = (c[31].xy) * (-(r2.xx)) + (v1.xy);
    r2 = tex2D(s4, r2.xy);
