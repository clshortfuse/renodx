// Mechanically reconstructed from 0x909D8D7D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xyz = (r10.www) * (r3.xyz) + (c[32].xyw);
    r7.xyz = normalize(r0.xyz);
    r2.xyz = (r2.xyz) * (r5.yyy);
    r5.w = saturate(dot(r7.xyz, r12.xyz));
    r0.xyz = (r5.www) * (c[25].xyz);
    r9.xyz = normalize(v7.xyz);
    r0.xyz = (r11.www) * (r0.xyz) + (r2.xyz);
    ...
    r4.z = saturate(dot(r6.xyz, r12.xyz));
    r9.w = exp2(r3.y);
    ...
    r1.xyz = (r11.www) * (r11.xyz);
    r3.xyz = (r10.www) * (r3.xyz);
    r2.xyz = (r2.xyz) * (r10.xyz) + (r3.xyz);
