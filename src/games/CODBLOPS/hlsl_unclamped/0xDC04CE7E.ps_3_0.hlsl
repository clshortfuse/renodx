// Mechanically reconstructed from 0xDC04CE7E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s2, v7.xy);
    r4.w = (r0.w) * (v0.y) + (c1.x);
    r2.xyz = float3(((r4.w) >= 0.0f ? (r0.x) : (r1.x)), ((r4.w) >= 0.0f ? (r0.y) : (r1.y)), ((r4.w) >= 0.0f ? (r0.z) : (r1.z)));
    r0 = tex2D(s3, v7.zw);
    ...
    r12.xy = float2(((r4.w) >= 0.0f ? (r0.w) : (r1.w)), ((r4.w) >= 0.0f ? (r0.y) : (r1.y)));
    r0 = v2;
    r0.xyz = (r8.xxx) * (v5.xyz) + (r0.xyz);
    r1.x = (r12.x) * (c12.x);
    r0.xyz = (r8.yyy) * (v4.xyz) + (r0.xyz);
    r1.z = (r12.x) * (-(c12.x)) + (c12.y);
