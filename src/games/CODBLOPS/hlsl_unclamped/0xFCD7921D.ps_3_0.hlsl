// Mechanically reconstructed from 0xFCD7921D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.x = dot(r3.xy, r1.xy) + (c1.z);
    r6.y = dot(r3.xy, r1.zw) + (c1.z);
    r1 = tex2D(s3, v6.zw);
    r5.w = (r1.w) * (v6.y);
