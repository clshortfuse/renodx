// Mechanically reconstructed from 0xAC1BF23E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r3.w = (r0.w) * (v0.w) + (c0.x);
    r4.xy = float2(((r3.w) >= 0.0f ? (r1.x) : (c0.z)), ((r3.w) >= 0.0f ? (r1.y) : (c0.z)));
    r1 = v2;
    ...
    r1.z = lerp(r2.w, r3.z, c[25].w);
    r7.w = rsqrt(r1.y);
    r5.xyz = (r2.xyz) * (r2.xyz);
    r6.xyz = (r4.xyz) * (r7.www);
    ...
    r12.yz = c0.yz;
    r7.xyz = float3(((r3.w) >= 0.0f ? (c[38].x) : (r12.z)), ((r3.w) >= 0.0f ? (c[38].y) : (r12.z)), ((r3.w) >= 0.0f ? (c[38].w) : (r12.z)));
