// Mechanically reconstructed from 0x14F3F787.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xy = (r2.ww) * (-(r4.xy)) + (r4.xy);
    r0.y = dot(r1.xy, r1.xy) + (c4.y);
    ...
    r3.xy = (r3.xy) * (r9.xy);
    r4.w = lerp(r1.y, c4.x, r2.w);
    r0.w = (r0.w) * (r3.x);
    r9.xyz = (r0.xyz) * (r4.www);
    r1.z = (r3.y) * (r0.w);
    r3 = tex2D(s12, v1.zw);
    r0 = v2;
    ...
    r9.w = saturate(dot(r7.xyz, r11.xyz));
    r11.w = (r1.z) * (r3.y);
    r1.xyz = (r9.www) * (c[29].xyz);
    r0.xyz = (r6.www) * (r10.xyz);
    r1.xyz = (r11.www) * (r1.xyz) + (r9.xyz);
    r3 = tex2D(s0, v1.xy);
    r10.xyz = lerp(r3.xyz, r2.xyz, r2.www);
    r2 = tex2D(s5, v7.zw);
    r9.xyz = normalize(v6.xyz);
    r3.xyz = (r5.xyz) * (r5.www) + (-(r9.xyz));
    r5.xyz = normalize(r3.xyz);
    r2.xyz = (r2.xyz) * (v0.zzz);
    r3.w = saturate(dot(r5.xyz, r11.xyz));
    r2.xyz = (r2.xyz) * (r2.www) + (r10.xyz);
    r2.w = (-(r3.w)) + (c4.x);
