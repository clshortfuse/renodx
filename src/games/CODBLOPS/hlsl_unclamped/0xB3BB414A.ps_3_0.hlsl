// Mechanically reconstructed from 0xB3BB414A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.x = 1.0f / (r0.w);
    r1.w = c2.w;
    r4.xyz = float3(((r6.w) >= 0.0f ? (r1.w) : (c[21].x)), ((r6.w) >= 0.0f ? (r1.w) : (c[21].y)), ((r6.w) >= 0.0f ? (r1.w) : (c[21].w)));
    r8.xy = saturate((r9.xx) * (c[9].xy) + (c[9].zw));
    r7.xy = (r8.xy) * (r8.xy);
    r8.xy = (r8.xy) * (c13.zz) + (c13.ww);
    r1.w = dot(c[8].yz, r9.xy) + (c[8].x);
    r7.xy = (r7.xy) * (r8.xy);
    r9.xyz = lerp(r4.xyz, c[22].xyw, r5.www);
    r1.w = (r1.w) * (r7.x);
