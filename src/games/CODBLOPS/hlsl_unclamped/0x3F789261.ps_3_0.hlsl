// Mechanically reconstructed from 0x3F789261.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xyz = (r12.xyz) * (r3.www) + (r3.xyz);
    r11.xyz = (r2.www) * (r0.xyz) + (c[31].xyw);
    r0 = tex2D(s3, v7.xy);
    r0.xyz = (r0.xyz) + (c2.xxx);
    r7.xyz = (r1.xyz) * (r11.yyy);
    r13.xyz = (v0.yyy) * (r0.xyz) + (c2.yyy);
    r4 = tex2D(s6, v1.xy);
    r0 = tex2D(s4, v7.zw);
    r1.xyz = (r0.xyz) + (c2.xxx);
    r0.xyz = (r13.xyz) * (r4.xyz);
    r8.xyz = (v0.zzz) * (r1.xyz) + (c2.yyy);
    r4.xyz = (r0.xyz) * (r8.xyz);
    r3 = tex2D(s7, v8.xy);
    r0 = v2;
    ...
    r6.w = saturate(dot(r10.xyz, -(r14.xyz)));
    r0.z = (-(r6.w)) + (c2.y);
    r0.y = (r0.z) * (r0.z);
