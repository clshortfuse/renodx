// Mechanically reconstructed from 0xE238C751.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = dot(r3.xyz, c[9].xyz);
    r3.w = saturate((r3.w) * (c[10].x) + (c[10].y));
    r6.x = 1.0f / (r6.z);
    r4.z = (r3.w) * (c[10].w);
    r5.xy = saturate((r6.xx) * (c[20].xy) + (c[20].zw));
    r4.xy = (r5.xy) * (r5.xy);
    r5.xy = (r5.xy) * (c2.zz) + (c2.ww);
    r4.w = dot(c[11].yz, r6.xy) + (c[11].x);
    r4.xy = (r4.xy) * (r5.xy);
    r3.w = lerp(r2.w, r5.w, r4.z);
    r2.w = (r4.w) * (r4.x);
