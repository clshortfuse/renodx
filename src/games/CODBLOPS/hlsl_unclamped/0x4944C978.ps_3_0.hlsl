// Mechanically reconstructed from 0x4944C978.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6 = tex2D(s13, r5.xy);
    r4.w = r6.y;
    r9.xyz = lerp(r2.yyy, c[29].xyw, r3.www);
    r5.xy = (r4.yw) * (c12.xx) + (c12.yy);
    r2.y = dot(r14.xy, r14.xy) + (c1.w);
    r4.w = dot(r5.xy, r5.xy) + (c1.w);
    r2.y = exp2(-(r2.y));
    r4.w = exp2(-(r4.w));
    r2.y = (r2.y) * (c2.x) + (c2.y);
    r4.y = (r4.w) * (c2.x) + (c2.y);
    r4.w = dot(r5.xy, r14.xy) + (c1.w);
    r4.y = (r2.y) * (r4.y);
    r5 = tex2D(s14, v0.zw);
    r15.xy = (r5.xy) * (c3.ww);
