// Mechanically reconstructed from 0xE6E9FB27.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xyz = (r5.xyz) * (r2.www) + (r7.xyz);
    r2.xyw = c[5].xyw;
    r2.xyz = (-(r2.xyw)) + (c[6].xyw);
    r1.xyz = (r0.www) * (r1.xyz);
    r8.xyz = (r7.www) * (r2.xyz) + (c[5].xyw);
    r5.w = 1.0f / (r3.x);
    r1.xyz = (r1.xyz) * (r8.zzz);
    r0.w = (r1.w) * (c0.x);
    r11.xyz = (r1.xyz) * (c[19].xyz);
    r1 = tex2D(s12, v0.zw);
    r2.xy = (v0.zw) * (c0.yw);
    r2 = tex2D(s13, r2.xy);
