// Mechanically reconstructed from 0xA6F1B325.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xyz = (v6.xyz) * (-(r1.www)) + (c[17].xyz);
    r2.y = saturate(dot(r0.xyz, -(r3.xyz)));
    r1 = tex2D(s2, v1.xy);
    r2.x = (r1.w) * (c2.x);
    r2.w = (r1.w) * (-(c2.x)) + (c2.y);
    r6.w = saturate(dot(r0.xyz, c[17].xyz));
    r2.z = (r2.y) * (r2.w) + (r2.x);
    r2.w = (r6.w) * (r2.w) + (r2.x);
    r5.w = (-(r2.y)) + (c0.w);
    r2.w = (r2.w) * (r2.z) + (c2.z);
    ...
    r7.w = max(abs(r0.y), abs(r0.z));
    r9.xy = c[6].xy;
    r6.xyz = (r9.yyy) * (c[19].xyz);
    r2.w = max(abs(r0.x), r7.w);
    r2.w = 1.0f / (r2.w);
    ...
    r1.w = (r1.w) + (r1.w);
    r2.xyz = (r9.xxx) * (c[18].xyz);
    r3.xyz = (r0.xyz) * (-(r1.www)) + (r3.xyz);
