// Mechanically reconstructed from 0xEB7C0919.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = (r0.w) + (r0.w);
    r0.xyw = c[29].xyw;
    r1.xyz = (-(r0.xyw)) + (c[30].xyw);
    r0.xyz = (r8.xyz) * (r2.www) + (r3.xyz);
    r7.xyz = (r10.www) * (r1.xyz) + (c[29].xyw);
