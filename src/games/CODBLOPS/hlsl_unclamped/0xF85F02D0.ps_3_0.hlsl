// Mechanically reconstructed from 0xF85F02D0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xy = float2(((r1.x) >= 0.0f ? (r3.x) : (c0.z)), ((r1.x) >= 0.0f ? (r3.y) : (c0.y)));
    r0 = (r0.xyzx) * (c0.yyyz) + (c0.zzzy);
    r3.xy = (r2.yy) * (c12.xy) + (c12.zw);
    r2.w = exp2(r3.y);
    r8.w = 1.0f / (r3.x);
    ...
    r3.y = (r2.y) * (c1.y);
    r2.w = (r2.y) * (-(c1.y)) + (c1.z);
    r2.z = saturate(dot(r6.xyz, -(r7.xyz)));
    r1.w = (r3.w) * (r2.w) + (r3.y);
    r2.w = (r2.z) * (r2.w) + (r3.y);
    r9.w = (-(r2.z)) + (c0.y);
    r1.w = (r1.w) * (r2.w) + (c4.x);
