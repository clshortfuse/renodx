// Mechanically reconstructed from 0xFA1E4A30.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c4 = float4(2.0f, -1.0f, -0.5f, 1.0f);
    ...
    r1 = tex2D(s6, v7.zw);
    r4.z = (r1.w) * (v0.z) + (c4.z);
    r4.xy = float2(((r4.z) >= 0.0f ? (r2.x) : (r0.x)), ((r4.z) >= 0.0f ? (r2.y) : (r0.y)));
    r2 = tex2D(s0, v1.xy);
    r0 = tex2D(s5, v7.xy);
    r4.w = (r0.w) * (v0.y) + (c4.z);
    ...
    r0 = tex2D(s13, r0.xy);
    r2.w = r0.y;
    r3.xyz = float3(((r4.z) >= 0.0f ? (r1.x) : (r3.x)), ((r4.z) >= 0.0f ? (r1.y) : (r3.y)), ((r4.z) >= 0.0f ? (r1.z) : (r3.z)));
    r1.xy = (r2.yw) * (c43.xx) + (c43.yy);
    r0.w = dot(r4.xy, r4.xy) + (c3.x);
    r0.y = dot(r1.xy, r1.xy) + (c3.x);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c12.x) + (c12.y);
    r1.w = (r0.y) * (c12.x) + (c12.y);
    r0.y = dot(r1.xy, r4.xy) + (c3.x);
    r2.w = (r0.w) * (r1.w);
    r1 = tex2D(s14, v1.zw);
    r6.xy = (r1.xy) * (c12.ww);
    ...
    r1.w = ((r4.w) >= 0.0f ? (c4.w) : (r0.y));
    r0.xyz = (r3.xyz) * (r3.www) + (-(r6.xyz));
    r2.xyz = normalize(r0.xyz);
    r3.xyz = (r3.xyz) * (r3.www);
    r13.xyz = float3(((r4.z) >= 0.0f ? (c[39].x) : (r1.w)), ((r4.z) >= 0.0f ? (c[39].y) : (r1.w)), ((r4.z) >= 0.0f ? (c[39].w) : (r1.w)));
    ...
    r1.y = (r3.w) * (r4.w);
    r14.xyz = (r0.xyz) * (-(r0.xyz)) + (c4.www);
    r15.xyz = (r0.xyz) * (r0.xyz);
    r0.xyz = v2.xyz;
    r0.xyz = (r4.xxx) * (v4.xyz) + (r0.xyz);
    r11.w = (r0.w) * (-(c43.z)) + (c43.w);
