// Mechanically reconstructed from 0x2C675D02.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xy = float2(((r0.w) >= 0.0f ? (r1.w) : (r2.w)), ((r0.w) >= 0.0f ? (r1.y) : (r2.y)));
    r2.xyz = (r4.www) * (r5.xyz);
    r5.xyz = (r3.xyz) * (r11.yyy);
    r1 = tex2D(s0, v1.xy);
    r7.xyz = float3(((r0.w) >= 0.0f ? (r0.x) : (r1.x)), ((r0.w) >= 0.0f ? (r0.y) : (r1.y)), ((r0.w) >= 0.0f ? (r0.z) : (r1.z)));
    r0 = tex2D(s5, v7.zw);
    r0.xyz = (r0.xyz) + (c1.yyy);
    r1.xyz = (v0.zzz) * (r0.xyz) + (c1.zzz);
    r0 = v2;
    r3.xyz = (r8.xxx) * (v5.xyz) + (r0.xyz);
    r0.xyz = (r7.xyz) * (r1.xyz);
    r3.xyz = (r8.yyy) * (v4.xyz) + (r3.xyz);
