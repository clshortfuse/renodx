// Mechanically reconstructed from 0x066AA124.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xy = float2(((r0.w) >= 0.0f ? (c1.y) : (r1.y)), ((r0.w) >= 0.0f ? (c1.z) : (r1.y)));
    r0 = tex2D(s4, v8.zw);
    r0.w = (r0.w) * (v0.z);
    r1.xyz = lerp(r2.xyz, r0.xyz, r0.www);
    r4.xy = (r0.ww) * (-(r4.xy)) + (r4.xy);
    r12.xy = lerp(r3.xy, c1.zz, r0.ww);
