// Mechanically reconstructed from 0x43C60D7F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.y = saturate(dot(r1.xyz, r2.xyz));
    r1.w = saturate(dot(r2.xyz, c[17].xyz));
    r2.xy = (r0.ww) * (c2.xy) + (c2.zw);
    r4.z = exp2(r2.y);
    r2.w = 1.0f / (r2.x);
    ...
    r1.w = (r0.w) * (c0.x);
    r0.xyz = (r2.xyz) * (r4.zzz) + (r5.xyz);
    r0.xyz = (r4.www) * (r0.xyz);
    r4.w = max(abs(r1.y), abs(r1.z));
    r4.xyz = (r0.xyz) * (c[6].www);
