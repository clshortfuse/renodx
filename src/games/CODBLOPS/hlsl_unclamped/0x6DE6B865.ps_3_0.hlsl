// Mechanically reconstructed from 0x6DE6B865.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(3.5f, 1.0f, 31.875f, 4.0f);
    ...
    r3.x = dot(r4.xy, r1.xy) + (c3.z);
    r3.y = dot(r4.xy, r1.zw) + (c3.z);
    r4 = tex2D(s2, v6.xy);
    r4.w = (r4.w) * (v0.y) + (c3.w);
    r1.xy = (r0.yw) * (c12.xx) + (c12.yy);
    r5.xy = float2(((r4.w) >= 0.0f ? (r3.x) : (r5.x)), ((r4.w) >= 0.0f ? (r3.y) : (r5.y)));
    ...
    r1.w = (r0.w) * (r0.w);
    r9.xyz = (v0.zzz) * (r1.xyz) + (-(c3.yyy));
    r0.w = (r0.w) * (r1.w);
    r1.xyz = (r9.xyz) * (c4.xxx);
    r0.w = (r3.w) * (r0.w);
    r5.xyz = (r1.xyz) * (-(r1.xyz)) + (-(c3.yyy));
