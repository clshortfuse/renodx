// Mechanically reconstructed from 0xF8C0D2C0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xz = (r2.xy) * (c6.xx);
    r0.w = (r1.w) * (r1.w);
    r3.xyz = (r7.xyz) * (r2.www) + (r0.xyz);
    r1.z = (r0.w) * (r0.w);
    r0 = tex2D(s3, v7.zw);
    r0.xyz = (r0.xyz) + (c1.yyy);
    r5.w = (r1.w) * (r1.z);
    r13.xyz = (v7.yyy) * (r0.xyz) + (c1.zzz);
    r1 = tex2D(s4, v0.xy);
    r2 = tex2D(s0, v0.xy);
    r0.xyz = lerp(r2.xyz, c1.xxx, r1.xxx);
    r6.w = (r1.w) * (-(c6.z)) + (c6.w);
    r5.xyz = (r13.xyz) * (r0.xyz);
    ...
    r2.w = (r2.w) * (r4.w);
    r12.xyz = (r1.xxx) * (r2.xyz);
    r0.xyz = (r0.xyz) * (r2.www);
    r16.xyz = (r1.yyy) * (r0.xyz);
    r15.xyz = (r3.xyz) * (r1.yyy);
    r2 = tex2D(s12, v0.zw);
