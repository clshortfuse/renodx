// Mechanically reconstructed from 0xBEAA2147.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = (v6.yyy) * (r4.xyz) + (c1.zzz);
    r1.w = 1.0f / (r2.w);
    r0.xyz = (r0.xyz) * (r4.xyz);
    r1.w = (r2.z) * (r1.w);
    r7.xyz = (r0.xyz) * (-(r0.xyz)) + (c1.zzz);
    r3.xyz = (r3.xyz) * (r3.xyz);
    r7.xyz = (r1.www) * (r7.xyz);
    r3.xyz = (r2.yyy) * (r3.xyz);
    r7.xyz = (r0.xyz) * (r0.xyz) + (r7.xyz);
    r0.xyz = (r2.xxx) * (r1.xyz);
    r1.xyz = (r3.xyz) * (r7.xyz);
