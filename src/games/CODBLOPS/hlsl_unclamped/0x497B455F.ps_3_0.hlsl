// Mechanically reconstructed from 0x497B455F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = (r4.www) * (r0.xyz);
    r2.xyz = (r1.xyz) * (r4.xyz);
    r0 = tex2D(s7, v9.xy);
    r1 = lerp(r2, r0, r4.wwww);
    r10.xyz = (r1.xyz) * (-(r1.xyz)) + (c1.yyy);
    r11.xyz = (r1.xyz) * (r1.xyz);
    r1.xyz = (r3.xyz) * (r4.xyz) + (r6.xyz);
    r4.xyz = (r10.xyz) * (r3.www) + (r11.xyz);
    r6.xy = (r4.ww) * (-(r7.xy)) + (r7.xy);
    r0.xy = (v1.zw) * (c3.xy);
    r3 = tex2D(s13, r0.xy);
    ...
    r2.w = (r0.y) * (r0.z);
    r3.xyw = c[20].xyw;
    r0.xyz = (-(r3.xyw)) + (c[21].xyw);
    r2.w = (r5.w) * (r2.w);
    r12.xyz = (r4.www) * (r0.xyz) + (c[20].xyw);
