// Mechanically reconstructed from 0x44792646.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r3.w = (r0.w) * (v0.w) + (c0.x);
    r4.xyz = float3(((r3.w) >= 0.0f ? (r1.x) : (c0.z)), ((r3.w) >= 0.0f ? (r1.y) : (c0.z)), ((r3.w) >= 0.0f ? (r1.z) : (c0.z)));
    r1 = v2;
