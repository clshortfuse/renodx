// Mechanically reconstructed from 0xEAFF9867.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4 = tex2D(s6, v1.xy);
    r3 = tex2D(s7, v6.xy);
    r5 = lerp(r4, r3, r6.wwww);
    r4 = tex2D(s8, v6.zw);
    r3 = lerp(r5, r4, r1.wwww);
