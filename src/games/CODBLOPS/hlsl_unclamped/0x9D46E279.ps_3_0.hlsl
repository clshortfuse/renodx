// Mechanically reconstructed from 0x9D46E279.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r1.w) * (r2.w);
    r5.z = exp2(r5.y);
    r1.w = dot(r10.xyz, c[17].xyz);
    r5.y = saturate(dot(r10.xyz, r4.xyz));
    r3.w = saturate(r1.w);
    r4.y = pow(abs(r5.y), r5.z);
    r4.z = (r3.w) * (r4.w) + (r6.z);
    r4.w = (r5.z) * (c3.y) + (c3.z);
    r4.z = (r4.z) * (r5.w) + (c3.x);
    r4.w = (r4.y) * (r4.w);
