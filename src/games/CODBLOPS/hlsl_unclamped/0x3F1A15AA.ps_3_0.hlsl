// Mechanically reconstructed from 0x3F1A15AA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.z = (r12.x) * (-(c12.x)) + (c12.y);
    r1.w = saturate(dot(r9.xyz, -(r3.xyz)));
    r1.z = (r2.w) * (r2.z) + (r2.y);
    r2.z = (r1.w) * (r2.z) + (r2.y);
    r1.z = (r1.z) * (r2.z) + (c3.w);
    r1.z = 1.0f / (r1.z);
    r4.xyz = (v5.xyz) * (-(r1.xxx)) + (c[17].xyz);
    r3.w = (r2.w) * (r1.z);
    ...
    r1.z = (r3.w) * (r1.z);
    r2.xyz = (r4.xyz) * (r1.xxx) + (r10.xyz);
    r5.xyz = (r1.zzz) * (r2.xyz);
    r2.xyz = (r1.yyy) * (r6.xyz) + (r11.xyz);
    r5.xyz = (r12.yyy) * (r5.xyz);
    r2.w = (-(r1.w)) + (c14.w);
    r5.xyz = (r5.xyz) * (c[19].xyz);
    r6.w = 1.0f / (r13.x);
    r6.xyz = (r1.yyy) * (r5.xyz);
    r1 = tex2D(s0, v1.xy);
