// Mechanically reconstructed from 0xF9B77CAF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = dot(r1.xy, r0.zw) + (c33.z);
    r2.x = dot(r1.xy, r0.xy) + (c33.z);
    r0 = tex2D(s1, v1.xy);
    r3.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s5, v7.xy);
    r4.w = (r0.w) * (v0.y);
    r5.xy = lerp(r3.xy, r2.xy, r4.ww);
    ...
    r2.w = r0.y;
    r4.xy = (r2.xz) * (r6.xx);
    r7.xy = (r2.yw) * (c12.yy) + (c12.zz);
    r0.y = (r1.x) * (c12.x) + (-(r4.x));
    r0.w = dot(r7.xy, r5.xy) + (c33.z);
    r1.w = (r2.z) * (-(r6.x)) + (r0.y);
    r2.xy = (r0.xz) * (r6.yy);
    r0.x = dot(r7.xy, r7.xy) + (c33.z);
    ...
    r18.xy = (r4.ww) * (r1.xy) + (r0.yy);
    r13.xyz = (r2.xyz) * (r18.yyy);
    r9.w = (r0.w) * (-(c4.x)) + (c4.y);
    r1 = tex2D(s6, v7.zw);
    ...
    r10.w = (r0.w) * (c4.x);
    r2.z = saturate(dot(r8.xyz, r16.xyz));
    r1.w = saturate(dot(r16.xyz, -(r7.xyz)));
    ...
    r0.y = (r0.z) * (r0.z);
    r0.y = (r0.z) * (r0.y);
    r0.z = dot(r7.xyz, r16.xyz);
    r1.w = (r0.x) * (r0.y);
    r0.z = (r0.z) + (r0.z);
    r0.w = (r0.w) * (c3.w);
    r0.xyz = (r16.xyz) * (-(r0.zzz)) + (r7.xyz);
    r0 = texCUBElod(s15, r0);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r10.xyz = (r18.xxx) * (r0.xyz);
    r0.xyz = (v6.xyz) * (-(r2.www)) + (c[17].xyz);
    r11.xyz = (r14.xyz) * (r1.www) + (r15.xyz);
