// Mechanically reconstructed from 0x69120D27.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = dot(r4.xy, r4.xy) + (c8.y);
    r0.y = dot(r3.xy, r3.xy) + (c8.y);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c8.z) + (c8.w);
    r1.w = (r0.y) * (c8.z) + (c8.w);
    r0.y = dot(r3.xy, r4.xy) + (c8.y);
    r1.w = (r0.w) * (r1.w);
