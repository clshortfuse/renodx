// Mechanically reconstructed from 0x6DFA0C6B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r14.xy = float2(((r7.w) >= 0.0f ? (r2.x) : (r4.x)), ((r7.w) >= 0.0f ? (r2.y) : (r4.y)));
    ...
    r2.xyz = (r8.www) * (r2.xyz) + (c[38].xyw);
    r7.xyz = float3(((r7.w) >= 0.0f ? (c[40].x) : (r2.x)), ((r7.w) >= 0.0f ? (c[40].y) : (r2.y)), ((r7.w) >= 0.0f ? (c[40].w) : (r2.z)));
    r2.xy = (v1.zw) * (-(c2.yw));
    r2 = tex2D(s13, r2.xy);
