// Mechanically reconstructed from 0x9BA43F48.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s13, r2.xy);
    r0.w = r2.y;
    r8.xy = (r3.ww) * (-(r1.xy)) + (r1.xy);
    r1.xy = (r0.wy) * (c4.xx) + (c4.yy);
    r0.w = dot(r8.xy, r8.xy) + (c6.w);
    r0.y = dot(r1.xy, r1.xy) + (c6.w);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c1.x) + (c1.y);
    r1.z = (r0.y) * (c1.x) + (c1.y);
    r0.y = dot(r1.xy, r8.xy) + (c6.w);
    r1.z = (r0.w) * (r1.z);
    ...
    r1.y = (r1.z) * (r1.z);
    r0 = tex2D(s4, v8.zw);
    r0.xyz = (r0.xyz) + (c6.yyy);
    r0.w = (r1.y) * (r1.y);
    r3.xyz = (v0.zzz) * (r0.xyz) + (c6.xxx);
    r4.z = (r1.z) * (r0.w);
    r1.xyz = (r3.xyz) * (c6.zzz);
    r9.xyz = (r1.xyz) * (-(r1.xyz)) + (c6.xxx);
    r0 = v2;
