// Mechanically reconstructed from 0xB114FE65.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = (r4.xyz) * (c[23].xyz);
    r1.w = dot(c[24].yz, r6.xy) + (c[24].x);
    r6.xy = saturate((r6.xx) * (c[25].xy) + (c[25].zw));
    r1.xy = (r6.xy) * (r6.xy);
