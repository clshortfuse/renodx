// Mechanically reconstructed from 0xAB4B6A08.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.z = exp2(r16.y);
    r1.z = pow(abs(r2.y), r2.z);
    r1.w = (r2.z) * (c14.x) + (c14.y);
    r2.y = (r2.w) * (r1.y);
    r2.z = (r1.z) * (r1.w);
    r1.xyw = c[20].xyw;
    r1.xyz = (-(r1.xyw)) + (c[21].xyw);
    r1.w = (r2.y) * (r2.z);
