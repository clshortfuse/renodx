// Mechanically reconstructed from 0x6B7F3A5A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = (r0.xyz) * (c[5].yyy);
    r2 = tex2D(s0, v1.xy);
    r1 = tex2D(s2, v7.xy);
    r7.xyz = (r1.xyz) * (v0.yyy);
    r3 = tex2D(s3, v7.zw);
    r0 = v2;
    ...
    r3.xyz = (r0.xyz) * (-(r2.www)) + (r9.xyz);
    r3 = texCUBElod(s15, r3);
    r0.xyz = (r3.xyz) * (r3.xyz);
    r3.xyz = (r1.xyz) * (r1.xyz) + (r8.xyz);
    r1.xyz = (r0.xyz) * (c[5].xxx);
    r0.xyz = (r7.xyz) * (r1.www) + (r2.xyz);
