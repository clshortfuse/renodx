// Mechanically reconstructed from 0x2DE1F967.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.x = 1.0f / (r3.w);
    r4.w = dot(r1.xyz, c[9].xyz);
    r3.w = saturate(dot(r1.xyz, r3.xyz));
    r1.z = saturate((r4.w) * (c[10].x) + (c[10].y));
    r4.w = (r1.z) * (c[10].w);
    r3.xy = saturate((r4.xx) * (c[20].xy) + (c[20].zw));
    r1.xy = (r3.xy) * (r3.xy);
    r3.xy = (r3.xy) * (c2.xx) + (c2.yy);
    r1.z = dot(c[11].yz, r4.xy) + (c[11].x);
    r3.xy = (r1.xy) * (r3.xy);
    r3.z = lerp(r2.w, r5.w, r4.w);
    r2.w = (r1.z) * (r3.x);
