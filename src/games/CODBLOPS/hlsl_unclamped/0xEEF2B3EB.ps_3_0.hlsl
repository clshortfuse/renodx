// Mechanically reconstructed from 0xEEF2B3EB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = dot(r5.xy, r0.zw) + (c27.w);
    r1 = tex2D(s3, v7.xy);
    r1.xyz = (r1.xyz) + (c27.yyy);
    r2.x = dot(r5.xy, r0.xy) + (c27.w);
    r5.xyz = (v0.yyy) * (r1.xyz) + (c27.zzz);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s4, v7.zw);
    r3.w = (r0.w) * (v0.z) + (c3.x);
    r1.xyz = (r5.xyz) * (r1.xyz);
    r7.xy = float2(((r3.w) >= 0.0f ? (r2.x) : (r4.x)), ((r3.w) >= 0.0f ? (r2.y) : (r4.y)));
    ...
    r0.y = (r1.x) * (c12.w) + (-(r8.x));
    r0.w = dot(r9.xy, r7.xy) + (c27.w);
    r1.w = (r2.z) * (-(r4.x)) + (r0.y);
    r2.xy = (r0.xz) * (r4.yy);
    r0.x = dot(r9.xy, r9.xy) + (c27.w);
    r0.y = (r1.y) * (c12.w) + (-(r2.x));
    r0.x = exp2(-(r0.x));
    r0.y = (r0.z) * (-(r4.y)) + (r0.y);
    r0.z = (r0.x) * (c4.x) + (c4.y);
    r0.y = (r0.y) + (r0.y);
    ...
    r1.w = (r1.w) * (r1.z);
    r13.xyz = float3(((r3.w) >= 0.0f ? (r1.y) : (c[23].x)), ((r3.w) >= 0.0f ? (r1.y) : (c[23].y)), ((r3.w) >= 0.0f ? (r1.y) : (c[23].w)));
