// Mechanically reconstructed from 0xAB1DE1C4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4 = float4(((r3.w) >= 0.0f ? (r1.x) : (c1.z)), ((r3.w) >= 0.0f ? (r1.y) : (c1.z)), ((r3.w) >= 0.0f ? (r1.z) : (c1.z)), ((r3.w) >= 0.0f ? (r1.w) : (c1.y)));
    r2.w = rsqrt(r0.z);
    r1 = v2;
    ...
    r1.y = (r2.w) * (r1.z) + (r1.x);
    r1.z = (r2.z) * (r1.z) + (r1.x);
    r8.w = ((r3.w) >= 0.0f ? (r2.y) : (c1.z));
    r1.z = (r1.z) * (r1.y) + (c4.x);
    r2.y = 1.0f / (r1.z);
    r1.xyz = normalize(r3.xyz);
    r3.w = (r2.z) * (r2.y);
    r3.z = saturate(dot(r0.xyz, r1.xyz));
    r1.y = saturate(dot(r1.xyz, c[17].xyz));
    r2.xy = (r4.ww) * (c8.xy) + (c8.zw);
    r1.z = exp2(r2.y);
    r1.y = (-(r1.y)) + (c1.y);
    ...
    r3.w = r5.y;
    r2.w = exp2(-(r2.w));
    r9.xy = (r3.yw) * (c7.xx) + (c7.yy);
    r2.z = (r2.w) * (c2.x) + (c2.y);
    r2.x = dot(r9.xy, r9.xy) + (c1.z);
    r2.w = dot(r9.xy, r4.xy) + (c1.z);
    r2.x = exp2(-(r2.x));
    r3.w = (r4.w) * (c2.z);
    r2.x = (r2.x) * (c2.x) + (c2.y);
    r4 = tex2D(s14, v1.zw);
    ...
    r3.xyz = (r4.xyz) * (r2.zzz) + (r5.xyz);
    r2.w = (r2.w) + (r2.w);
    r5.xyz = (r8.www) * (r3.xyz);
    r3.xyz = (r0.xyz) * (-(r2.www)) + (r8.xyz);
