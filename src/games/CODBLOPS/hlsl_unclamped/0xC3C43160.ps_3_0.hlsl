// Mechanically reconstructed from 0xC3C43160.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = ((r1.z) >= 0.0f ? (r0.y) : (r1.y));
    r0 = tex2D(s4, v7.zw);
    r1.w = (r0.w) * (v0.z) + (c3.w);
    r3.xyz = float3(((r1.w) >= 0.0f ? (r0.x) : (r4.x)), ((r1.w) >= 0.0f ? (r0.y) : (r4.y)), ((r1.w) >= 0.0f ? (r0.z) : (r4.z)));
    r0.w = dot(v6.xyz, v6.xyz);
    r5.w = ((r1.w) >= 0.0f ? (-(c3.y)) : (r1.z));
    r5.z = rsqrt(r0.w);
    r4.w = (r11.z) * (-(c12.x)) + (c12.y);
    r0.xyz = (v6.xyz) * (-(r5.zzz)) + (c[17].xyz);
    r4.xyz = normalize(r0.xyz);
    r0.w = dot(r11.xy, r11.xy) + (c3.z);
    r6.w = saturate(dot(r4.xyz, c[17].xyz));
    r0.w = exp2(-(r0.w));
    r3.w = (r0.w) * (c4.y) + (c4.z);
