// Mechanically reconstructed from 0x3224ACB6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = (r0.w) * (v6.y) + (c1.z);
    r4.xy = float2(((r5.w) >= 0.0f ? (r2.x) : (c1.w)), ((r5.w) >= 0.0f ? (r2.y) : (c1.w)));
    r2 = tex2D(s3, v6.zw);
    r5.xy = (r2.wy) * (c0.xy) + (c0.zw);
    r2 = (c1.xxxx) * (v7) + (c1.yyyy);
    r3.x = dot(r5.xy, r2.xy) + (c1.w);
    r3.y = dot(r5.xy, r2.zw) + (c1.w);
    r2 = float4(((r5.w) >= 0.0f ? (r1.x) : (c1.w)), ((r5.w) >= 0.0f ? (r1.y) : (c1.w)), ((r5.w) >= 0.0f ? (r1.z) : (c1.w)), ((r5.w) >= 0.0f ? (r1.w) : (c1.w)));
    r7.xy = float2(((r3.w) >= 0.0f ? (r3.x) : (r4.x)), ((r3.w) >= 0.0f ? (r3.y) : (r4.y)));
    ...
    r2 = tex2D(s4, v0.xy);
    r0.xyz = (r2.wwy) * (c2.xyy) + (c2.zxx);
    r4.w = (r4.w) + (r4.w);
    r5.xyz = float3(((r5.w) >= 0.0f ? (r0.x) : (-(c1.w))), ((r5.w) >= 0.0f ? (r0.y) : (-(c1.y))), ((r5.w) >= 0.0f ? (r0.z) : (-(c1.w))));
    r2 = tex2D(s5, v6.zw);
    r0.xyz = (r2.wwy) * (c2.xyy) + (c2.zxx);
    r2.xyz = (r3.xyz) * (-(r4.www)) + (r4.xyz);
    r5.xyz = float3(((r3.w) >= 0.0f ? (r0.x) : (r5.x)), ((r3.w) >= 0.0f ? (r0.y) : (r5.y)), ((r3.w) >= 0.0f ? (r0.z) : (r5.z)));
    ...
    r2.w = dot(r0.xy, r0.xy) + (c1.w);
    r0.z = dot(r7.xy, r7.xy) + (c1.w);
    r2.w = exp2(-(r2.w));
    r0.z = exp2(-(r0.z));
    r2.y = (r2.w) * (c3.x) + (c3.y);
    r2.w = (r0.z) * (c3.x) + (c3.y);
    r0.z = dot(r0.xy, r7.xy) + (c1.w);
    r0.y = (r2.y) * (r2.w);
    r4.y = (r2.z) + (r2.z);
