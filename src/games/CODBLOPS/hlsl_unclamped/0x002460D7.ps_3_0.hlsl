// Mechanically reconstructed from 0x002460D7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = exp2(-(r0.w));
    r9.xyz = (r1.xyz) * (r0.xxx) + (r2.xyz);
    r0.w = (r0.w) * (c4.x) + (c4.y);
    r14.xyz = lerp(r0.yyy, c[32].xyw, r6.www);
    r2.xy = (v1.zw) * (c12.xy);
    r5 = tex2D(s13, r2.xy);
    ...
    r1 = tex2D(s9, v7.xy);
    r0 = tex2D(s6, v7.zw);
    r3.xyz = (r0.xyz) + (c3.yyy);
    r0 = lerp(r2, r1, r6.wwww);
    r1.xyz = (v0.zzz) * (r3.xyz) + (-(c3.yyy));
    ...
    r3.w = saturate(dot(r17.xyz, r0.xyz));
    r10.w = (r0.w) * (c4.w);
