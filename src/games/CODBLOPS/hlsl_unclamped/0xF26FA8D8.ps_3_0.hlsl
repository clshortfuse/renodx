// Mechanically reconstructed from 0xF26FA8D8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c3 = float4(1.0f, 3.5f, 0.5f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r1 = tex2D(s2, v6.zw);
    r1.w = (r1.w) * (v6.y);
    r4.xy = (r2.yw) * (c2.yy) + (c2.zz);
    r5.xy = (r1.ww) * (-(r0.xy)) + (r0.xy);
