// Mechanically reconstructed from 0xDF6B64A7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c35 = float4(0.00048828125f, -0.000122070312f, 0.0f, 0.0f);
    ...
    r3.xyz = lerp(r4.xyz, r1.xyz, r6.www);
    r0.w = dot(r5.xy, r5.xy) + (c3.z);
    r9.xyz = (r3.xyz) * (r3.xyz);
    r0.w = exp2(-(r0.w));
    r4.w = (r0.w) * (c12.x) + (c12.y);
    r3.xyz = float3(((r5.w) >= 0.0f ? (r0.y) : (c[32].x)), ((r5.w) >= 0.0f ? (r0.y) : (c[32].y)), ((r5.w) >= 0.0f ? (r0.y) : (c[32].w)));
    r1 = tex2D(s11, v7.zw);
    r0 = lerp(r2, r1, r6.wwww);
    r14.xyz = lerp(r3.xyz, c[33].xyw, r6.www);
    r1.xy = (v1.zw) * (-(c3.yw));
    r3 = tex2D(s13, r1.xy);
