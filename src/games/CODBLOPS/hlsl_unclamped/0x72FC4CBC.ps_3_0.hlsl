// Mechanically reconstructed from 0x72FC4CBC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xyz = float3(((r3.w) >= 0.0f ? (r0.x) : (r1.x)), ((r3.w) >= 0.0f ? (r0.y) : (r1.y)), ((r3.w) >= 0.0f ? (r0.z) : (r1.z)));
    r0 = tex2D(s5, v7.zw);
    r0.xyz = (r0.xyz) + (c3.yyy);
    r8.xy = float2(((r3.w) >= 0.0f ? (r4.x) : (r2.x)), ((r3.w) >= 0.0f ? (r4.y) : (r2.y)));
    ...
    r7.xyz = (r3.xyz) * (r0.www) + (-(r6.xyz));
    r2.xyz = normalize(r7.xyz);
    r3.xyz = (r3.xyz) * (r0.www);
    r0.w = saturate(dot(r2.xyz, r3.xyz));
    r0.w = (-(r0.w)) + (-(c3.y));
    r16.xy = float2(((r3.w) >= 0.0f ? (-(c3.z)) : (r1.y)), ((r3.w) >= 0.0f ? (-(c3.y)) : (r1.y)));
    r1.z = (r0.w) * (r0.w);
    r12.xyz = (r0.xyz) * (r16.yyy);
    r0.z = (r1.z) * (r1.z);
    r0.w = (r0.w) * (r0.z);
    ...
    r3.w = (r3.w) * (r10.w) + (c16.z);
    r3.w = 1.0f / (r3.w);
    r3.xy = (r1.ww) * (c35.xy) + (c35.zw);
    r9.w = exp2(r3.y);
