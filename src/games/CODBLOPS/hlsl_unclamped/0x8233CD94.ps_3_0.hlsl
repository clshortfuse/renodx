// Mechanically reconstructed from 0x8233CD94.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = float3(((r4.w) >= 0.0f ? (c[20].x) : (r1.w)), ((r4.w) >= 0.0f ? (c[20].y) : (r1.w)), ((r4.w) >= 0.0f ? (c[20].w) : (r1.w)));
    r0 = float4(((r4.w) >= 0.0f ? (r0.x) : (r1.x)), ((r4.w) >= 0.0f ? (r0.y) : (r1.y)), ((r4.w) >= 0.0f ? (r0.z) : (r1.z)), ((r4.w) >= 0.0f ? (r0.w) : (r1.w)));
    r5.xyz = (r2.xyz) * (r4.yyy);
    r2 = tex2D(s12, v0.zw);
    r1 = v1;
