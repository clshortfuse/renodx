// Mechanically reconstructed from 0x1C4A9AE7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s1, v1.xy);
    r0 = tex2D(s5, v7.xy);
    r0.xyz = (r0.xyz) + (c43.yyy);
    r4.xyz = (v0.yyy) * (r0.xyz) + (c43.zzz);
    r0 = tex2D(s0, v1.xy);
    r2 = tex2D(s6, v7.zw);
    r6.w = (r2.w) * (v0.z);
    ...
    r8.xy = lerp(r6.xy, r5.xy, r6.ww);
    r2 = tex2D(s8, v1.xy);
    r2.xyz = (r4.xyz) * (r2.xyz);
    r1 = tex2D(s9, v7.zw);
    r0 = lerp(r2, r1, r6.wwww);
    r1.w = dot(r8.xy, r8.xy) + (c43.w);
    ...
    r7.xy = (r3.xz) * (r4.xx);
    r1.w = dot(r6.xy, r8.xy) + (c43.w);
    r1.y = (r2.x) * (c4.w) + (-(r7.x));
    r2.w = (r3.z) * (-(r4.x)) + (r1.y);
    r3.xy = (r1.xz) * (r4.yy);
    r1.y = (r2.y) * (c4.w) + (-(r3.x));
    r1.x = dot(r6.xy, r6.xy) + (c43.w);
    r1.y = (r1.z) * (-(r4.y)) + (r1.y);
    r1.z = exp2(-(r1.x));
    r9.y = (r2.w) + (r2.w);
    r1.z = (r1.z) * (c3.x) + (c3.y);
    ...
    r4.xyw = c[39].xyw;
    r7.xyz = (-(r4.xyw)) + (c[40].xyw);
    r4.xyz = v2.xyz;
    r4.xyz = (r8.xxx) * (v4.xyz) + (r4.xyz);
    r13.xyz = (r6.www) * (r7.xyz) + (c[39].xyw);
