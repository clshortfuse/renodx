// Mechanically reconstructed from 0xC680A29A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = (r1.xxx) * (v6.xyz);
    r10.xyz = (v6.xyz) * (-(r1.xxx)) + (c[17].xyz);
