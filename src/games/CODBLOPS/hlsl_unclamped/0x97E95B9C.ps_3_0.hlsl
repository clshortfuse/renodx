// Mechanically reconstructed from 0x97E95B9C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xyz = (r0.xyz) * (c4.xxx);
    r13.xyz = (r5.xyz) * (-(r5.xyz)) + (-(c3.yyy));
    r0.xyz = v2.xyz;
    ...
    r1.w = (r1.w) * (r9.w) + (c13.z);
    r2.w = 1.0f / (r1.w);
    r3.xy = (r4.zz) * (c40.xy) + (c40.zw);
    r8.w = exp2(r3.y);
    r2.z = saturate(dot(r10.xyz, r2.xyz));
    r1.w = pow(abs(r2.z), r8.w);
    r4.w = (r8.w) * (c14.x) + (c14.y);
    r2.w = (r6.w) * (r2.w);
    r1.w = (r1.w) * (r4.w);
