// Mechanically reconstructed from 0x5F13A6AC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c29 = float4(2.0f, -1.0f, 0.0f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = (c29.xxxx) * (v9) + (c29.yyyy);
    r2.y = dot(r1.xy, r0.zw) + (c29.z);
    r2.x = dot(r1.xy, r0.xy) + (c29.z);
    r0 = tex2D(s1, v1.xy);
    r5.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s4, v7.xy);
    r6.w = (r0.w) * (v0.y);
    r3.xyz = lerp(r1.xyz, r0.xyz, r6.www);
    r4.xy = lerp(r5.xy, r2.xy, r6.ww);
    r1 = tex2D(s8, v1.xy);
    r0 = tex2D(s9, v7.xy);
    r2 = tex2D(s5, v7.zw);
    r2.xyz = (r2.xyz) + (c29.yyy);
    r3.w = lerp(r1.y, r0.y, r6.w);
    r5.xyz = (v0.zzz) * (r2.xyz) + (c29.www);
    r2 = tex2D(s6, v8.xy);
    r5.w = (r2.w) * (v0.w);
    r0.xyz = (r3.xyz) * (-(r5.xyz)) + (r2.xyz);
    r2.w = lerp(r1.w, r0.w, r6.w);
    r0.xyz = (r5.www) * (r0.xyz);
    r0.xyz = (r3.xyz) * (r5.xyz) + (r0.xyz);
    r11.xy = (r5.ww) * (-(r4.xy)) + (r4.xy);
    r10.xyz = (r0.xyz) * (r0.xyz);
    r0.w = dot(r11.xy, r11.xy) + (c29.z);
    r2.z = exp2(-(r0.w));
    r0.xy = (v1.zw) * (c12.yz);
    r1 = tex2D(s13, r0.xy);
    ...
    r1.w = dot(r2.xy, r11.xy) + (c29.z);
    r3 = tex2D(s14, v1.zw);
    r4.xy = (r3.xy) * (c4.xx);
    r7.xy = (r1.xz) * (r4.xx);
    r12.xy = (r0.xz) * (r4.yy);
    r0.w = (r3.x) * (c4.x) + (-(r7.x));
    r0.y = (r3.y) * (c4.x) + (-(r12.x));
    r0.w = (r1.z) * (-(r4.x)) + (r0.w);
    r0.z = (r0.z) * (-(r4.y)) + (r0.y);
    r8.y = (r0.w) + (r0.w);
    r0.w = dot(r2.xy, r2.xy) + (c29.z);
    r0.y = (r0.z) + (r0.z);
    r0.w = exp2(-(r0.w));
    ...
    r0.w = (r0.w) * (c3.y) + (c3.z);
    r2.xyz = (r1.xyz) * (r0.zzz) + (-(r6.xyz));
    r4.xyz = normalize(r2.xyz);
    r9.xyz = (r1.xyz) * (r0.zzz);
    r0.z = (r4.w) * (r0.w);
    r0.w = saturate(dot(r4.xyz, r9.xyz));
    r1.z = saturate((r1.w) * (r0.z) + (r0.z));
    r0.w = (-(r0.w)) + (c29.w);
    r0.xz = (r12.xy) * (c4.yy);
    r1.w = (r0.w) * (r0.w);
    r3.xyz = (r0.xyz) * (r1.zzz);
    r0.z = (r1.w) * (r1.w);
    r6.w = (r0.w) * (r0.z);
    r2.xyz = (r5.xyz) * (c3.xxx);
    r1 = tex2D(s10, v8.xy);
    r0 = lerp(r2, r1, r5.wwww);
    r14.xyz = (r0.xyz) * (-(r0.xyz)) + (c29.www);
    r1.xyz = v2.xyz;
    r1.xyz = (r11.xxx) * (v4.xyz) + (r1.xyz);
    r15.xyz = (r0.xyz) * (r0.xyz);
    r0.xyz = (r11.yyy) * (v3.xyz) + (r1.xyz);
    r9.w = (r0.w) * (-(c12.x)) + (c12.y);
    r16.xyz = normalize(r0.xyz);
    r1.z = saturate(dot(r16.xyz, r4.xyz));
    r10.w = (r0.w) * (c12.x);
    r2.w = saturate(dot(r9.xyz, r16.xyz));
    ...
    r1.y = (r2.w) * (r0.y);
    r1.z = (r0.z) * (r5.w);
    r0.xyz = (r14.xyz) * (r6.www) + (r15.xyz);
    r1.z = (r1.y) * (r1.z);
    r8.xz = (r7.xy) * (c4.yy);
    r0.xyz = (r0.xyz) * (r1.zzz);
    r1.xyz = (r8.xyz) * (r4.www) + (r3.xyz);
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c29.w) : (c29.z));
    ...
    r2.xyz = (r0.xyz) * (c3.www) + (r1.xyz);
    r1.z = (r0.w) * (c15.z) + (c15.w);
    r1.w = (r0.w) * (r0.w);
    r0 = (v6.xyzx) * (c29.wwwz) + (c29.zzzw);
    r1.w = (r1.z) * (r1.w);
    r1.z = dot(r0, c[21]);
    r1.z = 1.0f / (r1.z);
    r3.x = dot(r0, c[20]);
    ...
    r0.xy = (r0.xy) * (r0.xy);
    r0.w = ((-abs(r0.w)) >= 0.0f ? (c29.z) : (r0.z));
    r0.z = (r3.x) * (r0.x);
    r0.w = (r0.w) * (r0.z);
    r0.z = (r0.y) * (-(r3.y)) + (c29.w);
    r0.xy = (r1.zz) * (r1.xy);
    r0.w = (r0.w) * (r0.z);
    r1.w = (r1.w) * (r0.w);
