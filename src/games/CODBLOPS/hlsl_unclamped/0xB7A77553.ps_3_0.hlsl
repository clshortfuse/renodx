// Mechanically reconstructed from 0xB7A77553.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyz = (r1.xyz) * (r1.www) + (-(r7.xyz));
    r2.xyz = normalize(r0.xyz);
    r1.xyz = (r1.xyz) * (r1.www);
    r0.w = saturate(dot(r2.xyz, r1.xyz));
    r7.w = dot(r1.xyz, c[30].xyz);
    r1.w = (-(r0.w)) + (c1.w);
    r0 = v2;
    ...
    r0.x = max(abs(r9.x), r1.w);
    r8.w = saturate(dot(r1.xyz, r9.xyz));
    r1 = tex2D(s5, v1.xy);
    r13.y = (r1.w) * (-(c13.x)) + (c13.y);
    r13.x = (r1.w) * (c13.x);
    r0.z = saturate(dot(r9.xyz, -(r7.xyz)));
    r0.y = (r8.w) * (r13.y) + (r13.x);
    r13.z = (r0.z) * (r13.y) + (r13.x);
    r2.w = 1.0f / (r0.x);
    r0.y = (r0.y) * (r13.z) + (c13.z);
    ...
    r0.xy = (r1.ww) * (c14.xy) + (c14.zw);
    r0.x = 1.0f / (r0.x);
    r12.y = exp2(r0.y);
    r9.w = (r1.z) * (r0.x);
    r1.z = pow(abs(r0.z), r12.y);
    r12.z = (r12.y) * (c12.x) + (c12.y);
    ...
    r0.z = (r13.w) * (r13.y) + (r13.x);
    r0.z = (r0.z) * (r13.z) + (c13.z);
    r4.xyz = (r1.zzz) * (r10.xyz) + (r11.xyz);
    r0.z = 1.0f / (r0.z);
    r3.w = (r13.w) * (r0.z);
    r3.z = saturate(dot(r9.xyz, r8.xyz));
    r2.w = (r1.w) * (c1.y);
    r2.xyz = (r9.xyz) * (-(r12.xxx)) + (r7.xyz);
    r2 = texCUBElod(s15, r2);
    r0.xyz = (r2.xyz) * (r2.xyz);
    r1.w = pow(abs(r3.z), r12.y);
