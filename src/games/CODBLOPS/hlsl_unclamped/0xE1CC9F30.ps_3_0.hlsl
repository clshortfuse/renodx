// Mechanically reconstructed from 0xE1CC9F30.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = (r3.xy) * (c13.xx) + (c13.yy);
    r3.w = rsqrt(r2.w);
    r2.z = (r2.x) * (r4.x);
    r3.xyz = (r9.xyz) * (r3.www);
    r2.y = (r2.y) * (-(r4.y)) + (c14.y);
    ...
    r0.w = dot(r13.xy, r13.xy) + (c14.w);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r0.y = (r0.y) * (c1.x) + (c1.y);
    r0.w = (r0.w) * (c1.x) + (c1.y);
    r2.w = (r0.y) * (r0.w);
    r0.y = dot(r4.xy, r13.xy) + (c14.w);
    r1 = tex2D(s14, v1.zw);
    r7.xy = (r1.xy) * (c2.ww);
    ...
    r5.y = 1.0f / (r4.w);
    r4.w = exp2(r13.y);
    r5.z = pow(abs(r2.w), r4.w);
    r2.w = (r4.w) * (c3.y) + (c3.z);
    r9.w = (r8.w) * (r5.y);
    r8.w = (r5.z) * (r2.w);
    r5.xyz = (r0.xyz) * (r10.www) + (r2.xyz);
    r8.w = (r9.w) * (r8.w);
    r1.xyz = (r1.www) * (r1.xyz) + (r11.xyz);
    r5.xyz = (r5.xyz) * (r8.www);
    r8.w = (-(r7.w)) + (c14.y);
    r5.xyz = (r6.yyy) * (r5.xyz);
    r7.w = 1.0f / (r13.x);
    r5.xyz = (r5.xyz) * (c[37].xyz);
