// Mechanically reconstructed from 0xD5D9A61C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s6, v7.zw);
    r4.w = (r0.w) * (v0.z) + (c3.y);
    r9.xy = float2(((r4.w) >= 0.0f ? (r2.x) : (r3.x)), ((r4.w) >= 0.0f ? (r2.y) : (r3.y)));
    r2 = tex2D(s8, v1.xy);
    r3 = tex2D(s5, v7.xy);
    r3.xyz = (r3.xyz) + (c35.yyy);
    r3.xyz = (v0.yyy) * (r3.xyz) + (c35.zzz);
    r3.w = r2.w;
    r1.xyz = (r1.xyz) * (r3.xyz);
    r5.xyz = float3(((r4.w) >= 0.0f ? (r0.x) : (r1.x)), ((r4.w) >= 0.0f ? (r0.y) : (r1.y)), ((r4.w) >= 0.0f ? (r0.z) : (r1.z)));
    r3.xyz = (r3.xyz) * (c35.www);
    r1 = tex2D(s9, v7.zw);
