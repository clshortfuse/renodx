// Mechanically reconstructed from 0x600EEE6D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (-(r0.w)) + (c1.x);
    r2.w = (r1.w) * (c12.x);
    r1.w = ((r1.w) >= 0.0f ? (c1.x) : (c1.y));
    r3.z = min(r2.w, c1.x);
    r2.w = (r3.z) * (r3.z) + (-(c1.x));
    r3.z = ddx(r2.w);
    r3.w = ddy(r2.w);
    r2.w = (r2.w) * (c12.y);
    r4.x = dot(r3.zw, r3.zw) + (c1.y);
    r4.x = rsqrt(r4.x);
    r3.zw = (r3.zw) * (r4.xx);
    ...
    r4 = max(r5, c1.yyyy);
    oC0.w = (r1.w) * (r4.w);
    r3.xy = (r3.xy) * (c[42].xx) + (v7.xy);
    r3 = tex2D(s9, r3.xy);
    r5 = tex2D(s6, v4.xy);
    r3.xzw = (r5.xyz) * (-(r5.xyz)) + (c0.zzz);
