// Mechanically reconstructed from 0x8F83CD29.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c24 = float4(4.0f, -3.0f, 0.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = tex2D(s8, v7.xy);
    r2.z = r0.w;
    r4.xyz = float3(((r1.w) >= 0.0f ? (r4.x) : (r5.x)), ((r1.w) >= 0.0f ? (r4.y) : (r5.y)), ((r1.w) >= 0.0f ? (r4.z) : (r5.z)));
    r12.xyz = float3(((r1.w) >= 0.0f ? (r2.x) : (r3.x)), ((r1.w) >= 0.0f ? (r2.y) : (r3.y)), ((r1.w) >= 0.0f ? (r2.z) : (r3.z)));
    r2 = tex2D(s4, v7.zw);
    r2.xyz = (r2.xyz) + (c3.yyy);
    r5.w = ((r1.w) >= 0.0f ? (r0.y) : (r1.y));
    r0.xyz = (v0.zzz) * (r2.xyz) + (-(c3.yyy));
    r1.xyz = (r4.xyz) * (r0.xyz);
    r3.xyz = (r0.xyz) * (c4.xxx);
    r0 = tex2D(s5, v8.xy);
    ...
    r3.xyz = (r7.xyz) * (r1.www) + (r11.xyz);
    r0.w = exp2(-(r0.w));
    r4.w = (r12.z) * (-(c13.x)) + (c13.y);
    r3.w = (r0.w) * (c4.y) + (c4.z);
    r7.w = (r12.z) * (c12.x);
    ...
    r1 = tex2D(s14, v1.zw);
    r8.xy = (r1.xy) * (c12.yy);
    r9.xy = (r0.wy) * (c12.zz) + (c12.ww);
    r2.xy = (r2.xz) * (r8.xx);
    r0.w = dot(r9.xy, r12.xy) + (c3.z);
    r0.y = (r1.x) * (c12.y) + (-(r2.x));
    r1.w = (r2.z) * (-(r8.x)) + (r0.y);
    r6.xy = (r0.xz) * (r8.yy);
    r0.y = (r1.y) * (c12.y) + (-(r6.x));
    ...
    r1.x = (r6.w) * (r4.w) + (r7.w);
    r1.z = (r1.w) * (r4.w) + (r7.w);
    r1.y = pow(abs(r2.w), r0.w);
    r1.z = (r1.z) * (r1.x) + (c13.z);
    ...
    r1.xyz = (r14.xyz) * (c[19].xyz);
    r0.xyz = (r0.www) * (r8.xyz) + (r13.xyz);
