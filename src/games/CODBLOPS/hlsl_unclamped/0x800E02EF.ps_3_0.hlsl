// Mechanically reconstructed from 0x800E02EF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c39 = float4(1.16412354f, -0.813476562f, -0.391448975f, 0.529705048f);
    const float4 c40 = float4(81.2394867f, 17.3480244f, 37.3498383f, 59.3948402f);
    const float4 c41 = float4(9.99999994e-09f, 0.0f, 0.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r3.x = c14.w;
    r4 = tex2D(s6, r3.xz);
    r2.w = (r4.x) * (-(c16.x)) + (v3.x);
    r2.w = (r2.w) * (c16.y) + (-(v3.x));
    r3.x = (c[32].x) * (r2.w) + (v3.x);
    r2.w = frac(abs(v3.y));
    ...
    r2.w = (r2.w) + (r3.w);
    r3.x = saturate(r3.x);
    r4.xy = lerp(c[23].xy, c[23].zw, r3.xz);
    r5 = tex2D(s2, r4.xy);
    r6 = tex2D(s3, r4.xy);
    r4 = tex2D(s4, r4.xy);
    ...
    r5.z = r4.x;
    r3.z = dot(c39, r5);
    r3.w = dot(c15.xyz, r5.xzw);
    r3.xzw = (r3.xzw) * (c[38].xxx);
    ...
    r4.x = c15.w;
    r4 = tex2D(s6, r4.xy);
    r1.w = saturate((r4.x) * (c[30].x));
    r4.x = 1.0f / (c[31].x);
    r4.y = 1.0f / (c[31].y);
    r2.w = dot(r0.wwww, c40);
    r5.x = frac(r2.w);
    r5.w = c[22].w;
    r2.w = dot(r5.xwww, c40);
    r5.y = frac(r2.w);
    r2.w = dot(r5.xyww, c40);
    r5.z = frac(r2.w);
    r2.w = dot(r5, c40);
    r5.w = frac(r2.w);
    r2.w = dot(r5, c40);
    ...
    r1.w = pow(abs(r0.w), c[36].x);
    r3.x = c3.x;
    r0.w = (r1.w) * (-(c[35].x)) + (r3.x);
    r4.xyz = lerp(c[34].xyz, r5.xyz, r0.www);
