// Mechanically reconstructed from 0x2D124C39.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = rsqrt(r0.z);
    r0.y = dot(c[10], r3);
    r5.xyz = (r1.zzz) * (-(v2.xyz));
    r0.z = dot(c[11], r3);
    r1.w = dot(-(r5.xyz), r9.xyz);
    r4.xyz = normalize(c[17].xyz);
    r1.w = (r1.w) + (r1.w);
    r6.xyz = (-(v2.xyz)) * (r1.zzz) + (r4.xyz);
    r3.xyz = (r9.xyz) * (-(r1.www)) + (-(r5.xyz));
    r3 = texCUBE(s1, r3.xyz);
