// Mechanically reconstructed from 0xFDCE999A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c32 = float4(4.0f, -2.0f, 0.797884583f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0.w = r3.y;
    r11.xy = (r3.xz) * (r1.xx);
    r4.xy = (r0.wy) * (c32.xx) + (c32.yy);
    r0.y = (r2.x) * (c1.w) + (-(r11.x));
    r0.w = dot(r4.xy, r8.xy) + (c3.z);
    r1.z = (r3.z) * (-(r1.x)) + (r0.y);
    r3.xy = (r0.xz) * (r1.yy);
    ...
    r0.z = (r0.w) * (r0.w);
    r11.xyz = (r7.xyz) * (-(r7.xyz)) + (c3.yyy);
    r0.z = (r0.z) * (r0.z);
    r0.w = (r0.w) * (r0.z);
    r12.xyz = (r7.xyz) * (r7.xyz);
    r3.xyz = (r11.xyz) * (r0.www) + (r12.xyz);
    r0 = v2;
