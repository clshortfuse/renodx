// Mechanically reconstructed from 0x0E544E6D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s4, v5.zw);
    r1.zw = (r0.ww) * (c1.yz) + (c1.wy);
    r0 = tex2D(s2, v5.zw);
    r3.w = (r0.w) * (v5.y) + (c1.x);
    r1 = float4(((r3.w) >= 0.0f ? (r1.x) : (c1.y)), ((r3.w) >= 0.0f ? (r1.y) : (c1.y)), ((r3.w) >= 0.0f ? (r1.z) : (c1.y)), ((r3.w) >= 0.0f ? (r1.w) : (c1.z)));
    r3.xyz = (r2.xyz) * (r2.xyz);
    r2.xyz = v3.xyz;
    r2.xyz = (r1.xxx) * (r2.xyz) + (v1.xyz);
