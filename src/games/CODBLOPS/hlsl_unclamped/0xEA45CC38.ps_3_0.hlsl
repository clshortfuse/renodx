// Mechanically reconstructed from 0xEA45CC38.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r7.w) * (r1.y);
    r1.xyz = (r10.yyy) * (r3.xyz);
    r4.xyz = (r8.xyz) * (r1.www);
    r3.xyz = (r1.www) * (r7.xyz) + (r1.xyz);
    r1 = tex2D(s0, v0.xy);
    r7.xyz = lerp(r1.xyz, r0.xyz, r8.www);
    r1.w = (r1.w) * (-(v6.x)) + (c14.w);
    r2.w = (r0.w) * (-(v6.y)) + (c14.w);
