// Mechanically reconstructed from 0x485BF9F5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s3, v7.xy);
    r3.w = (r0.w) * (v0.y) + (c3.w);
    r5.z = saturate(dot(r4.xyz, c[17].xyz));
    r7.xy = float2(((r3.w) >= 0.0f ? (r1.x) : (r2.x)), ((r3.w) >= 0.0f ? (r1.y) : (r2.y)));
    r1 = tex2D(s6, v7.zw);
    ...
    r1 = tex2D(s7, v1.xy);
    r0 = tex2D(s8, v7.xy);
    r2 = float4(((r3.w) >= 0.0f ? (r0.x) : (r1.x)), ((r3.w) >= 0.0f ? (r0.y) : (r1.y)), ((r3.w) >= 0.0f ? (r0.z) : (r1.z)), ((r3.w) >= 0.0f ? (r0.w) : (r1.w)));
    r1 = tex2D(s9, v7.zw);
    r5.z = (-(r5.z)) + (-(c3.y));
    ...
    r2.y = saturate(dot(r12.xyz, r4.xyz));
    r1.y = (r0.w) * (c4.w);
    ...
    r1.w = (r1.w) * (r1.z) + (c12.w);
    r1.z = (r2.z) * (c14.z) + (c14.w);
    r1.w = 1.0f / (r1.w);
    r2.z = (r1.y) * (r1.z);
    r2.y = (r2.w) * (r1.w);
    r1.xyw = c[9].xyw;
    r1.xyz = float3(((r3.w) >= 0.0f ? (r1.x) : (c[8].x)), ((r3.w) >= 0.0f ? (r1.y) : (c[8].y)), ((r3.w) >= 0.0f ? (r1.w) : (c[8].w)));
    r1.w = (r2.z) * (r2.y);
    r11.xyz = lerp(r1.xyz, c[10].xyw, r4.www);
