// Mechanically reconstructed from 0xBE74194C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4 = tex2D(s13, r4.xy);
    r2.w = r4.y;
    r6.xy = (r2.yw) * (c2.xx) + (c2.yy);
    r0.w = dot(r6.xy, r6.xy) + (c1.z);
    r6.xyz = (r3.xyz) * (r0.yyy);
    r0.w = exp2(-(r0.w));
    r3 = tex2D(s14, v0.zw);
    r12.xy = (r3.xy) * (c1.ww);
    r0.z = saturate((r0.w) * (c2.z) + (c2.w));
    r4.xy = (r4.xz) * (r12.yy);
    r0.w = (r3.y) * (c1.w) + (-(r4.x));
    r8.xz = (r4.xy) * (c2.xx);
