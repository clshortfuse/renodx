// Mechanically reconstructed from 0x15A20C31.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.w = (r2.w) * (v0.y) + (c1.x);
    r13.yz = c1.yz;
    r6.xyz = float3(((r4.w) >= 0.0f ? (r13.y) : (c[36].x)), ((r4.w) >= 0.0f ? (r13.z) : (c[36].y)), ((r4.w) >= 0.0f ? (r13.y) : (c[36].w)));
    ...
    r4.xyz = lerp(r6.xyz, c1.zzz, r5.www);
    ...
    r3 = tex2D(s0, v1.xy);
    r2.xyz = float3(((r4.w) >= 0.0f ? (r2.x) : (r3.x)), ((r4.w) >= 0.0f ? (r2.y) : (r3.y)), ((r4.w) >= 0.0f ? (r2.z) : (r3.z)));
