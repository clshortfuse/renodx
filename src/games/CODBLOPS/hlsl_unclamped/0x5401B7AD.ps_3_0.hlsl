// Mechanically reconstructed from 0x5401B7AD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = rsqrt(r0.w);
    r6.xyz = (v0.www) * (r1.xyz) + (c15.www);
    r3.xyz = (v5.xyz) * (-(r0.zzz)) + (c[17].xyz);
