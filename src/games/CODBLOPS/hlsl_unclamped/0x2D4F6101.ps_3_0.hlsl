// Mechanically reconstructed from 0x2D4F6101.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = dot(r5.xy, r1.xy) + (c1.z);
    r0.y = dot(r5.xy, r1.zw) + (c1.z);
    r1 = tex2D(s4, v7.xy);
    r5.w = (r1.w) * (v0.y) + (c1.w);
    r1.w = dot(r3, c2.xxxx);
    r6.xyz = float3(((r5.w) >= 0.0f ? (r0.x) : (r2.x)), ((r5.w) >= 0.0f ? (r0.y) : (r2.y)), ((r5.w) >= 0.0f ? (r0.z) : (r2.z)));
    r0 = tex2D(s7, v7.zw);
