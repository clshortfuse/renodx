// Mechanically reconstructed from 0xDA846FC3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xy = float2(((r4.w) >= 0.0f ? (r2.x) : (c1.z)), ((r4.w) >= 0.0f ? (r2.y) : (c1.z)));
    ...
    r6.xyz = float3(((r4.w) >= 0.0f ? (c[29].x) : (r1.w)), ((r4.w) >= 0.0f ? (c[29].y) : (r1.w)), ((r4.w) >= 0.0f ? (c[29].w) : (r1.w)));
    ...
    r2.z = (r8.w) * (r2.z);
    r5.xyz = (r8.xyz) * (r2.xxx) + (r9.xyz);
    r3.xyz = (r2.yyy) * (r13.xyz) + (r14.xyz);
