// Mechanically reconstructed from 0xB960C060.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.x = dot(r5.xy, r1.xy) + (c14.z);
    r6.y = dot(r5.xy, r1.zw) + (c14.z);
    r1 = tex2D(s4, v6.zw);
    r6.w = (r1.w) * (v6.y);
    r5.xy = (r0.yw) * (c3.xx) + (c3.yy);
    r9.xy = lerp(r8.xy, r6.xy, r6.ww);
