// Mechanically reconstructed from 0x2FBA3E44.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5 = tex2D(s13, r4.xy);
    r3.w = r5.y;
    r5.w = lerp(r4.w, c4.x, r7.w);
    r4.xy = (r3.yw) * (c3.xx) + (c3.yy);
    r3.y = dot(r8.xy, r8.xy) + (c4.y);
    r3.w = dot(r4.xy, r4.xy) + (c4.y);
    r3.y = exp2(-(r3.y));
    r3.w = exp2(-(r3.w));
    r9.w = (r3.y) * (c4.z) + (c4.w);
    r3.y = (r3.w) * (c4.z) + (c4.w);
    r3.w = dot(r4.xy, r8.xy) + (c4.y);
    r3.y = (r9.w) * (r3.y);
    r4 = tex2D(s14, v1.zw);
    r10.xy = (r4.xy) * (c2.ww);
    ...
    r8.y = (r3.w) + (r3.w);
    r3.w = (r10.w) * (r5.w);
    r3.xyz = (r8.xyz) * (r9.www) + (r4.xyz);
    r4.xyz = (r3.www) * (c[22].xyz);
    r3.xyz = (r5.www) * (r3.xyz);
    r5.xyz = (r6.xyz) * (r4.xyz);
    r4.xyz = (r6.xyz) * (r0.xyz) + (r3.xyz);
    r3 = tex2D(s0, v1.xy);
    r6.xyz = lerp(r3.xyz, r2.xyz, r8.www);
    r0.xyz = lerp(r6.xyz, r1.xyz, r7.www);
