// Mechanically reconstructed from 0xC00B76CD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = (r0.w) + (r0.w);
    r0.xyw = c[36].xyw;
    r2.xyz = (-(r0.xyw)) + (c[37].xyw);
    r0.xyz = (r8.xyz) * (r3.www) + (r3.xyz);
    r10.xyz = (r6.www) * (r2.xyz) + (c[36].xyw);
