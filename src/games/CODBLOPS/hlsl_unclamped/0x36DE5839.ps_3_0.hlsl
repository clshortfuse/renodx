// Mechanically reconstructed from 0x36DE5839.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xy = (r1.ww) * (c3.xy) + (c3.zw);
    r7.w = exp2(r8.y);
    r6.xyz = (r2.xyz) * (r7.zzz) + (-(r4.xyz));
    r6.w = 1.0f / (r8.x);
    r2.xyz = normalize(r6.xyz);
    r4.w = (r7.w) * (c4.x) + (c4.y);
    r3.z = saturate(dot(r2.xyz, r3.xyz));
    r7.x = 1.0f / (r7.z);
    r3.z = (-(r3.z)) + (c0.y);
    r3.y = saturate(dot(r10.xyz, r2.xyz));
    r2.y = (r3.z) * (r3.z);
    r2.z = pow(abs(r3.y), r7.w);
    r2.y = (r2.y) * (r2.y);
    r2.z = (r4.w) * (r2.z);
    r2.y = (r3.z) * (r2.y);
    ...
    r2.z = (r3.w) * (r2.z);
    r1.xyz = (r9.xyz) * (r2.yyy) + (r11.xyz);
    r1.xyz = (r2.zzz) * (r1.xyz);
    r12.yz = c0.yz;
    r6.xyz = float3(((r2.w) >= 0.0f ? (c[26].x) : (r12.z)), ((r2.w) >= 0.0f ? (c[26].y) : (r12.z)), ((r2.w) >= 0.0f ? (c[26].w) : (r12.z)));
    r1.w = (r1.w) * (c0.w);
    ...
    r1.z = dot(c[24].yz, r7.xy) + (c[24].x);
    r2.xy = saturate((r7.xx) * (c[25].xy) + (c[25].zw));
    r1.xy = (r2.xy) * (r2.xy);
