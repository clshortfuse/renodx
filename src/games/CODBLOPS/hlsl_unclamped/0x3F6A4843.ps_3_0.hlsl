// Mechanically reconstructed from 0x3F6A4843.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = dot(r1.xy, r0.zw) + (c3.z);
    r8.x = dot(r1.xy, r0.xy) + (c3.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r3.w = (r0.w) * (v0.y);
    r2 = tex2D(s1, v1.xy);
    r2.xy = (r2.wy) * (c1.xy) + (c1.zw);
    r7.xyz = lerp(r1.xyz, r0.xyz, r3.www);
    r9.xy = lerp(r2.xy, r3.xy, r3.ww);
    r2 = tex2D(s7, v1.xy);
    r1.w = -(r2.w);
    r1.xyz = c3.www;
    r0 = tex2D(s8, v7.xy);
    r0 = (r1) + (r0);
    r1 = (r2.wwww) * (-(c3.zzzy)) + (-(c3.wwwz));
    r6.xyz = lerp(r2.yyy, c[8].xyw, r3.www);
    r3 = (r3.wwww) * (r0) + (r1);
    r0 = tex2D(s4, v7.zw);
    r6.w = (r0.w) * (v0.z);
    r5.xyz = lerp(r7.xyz, r0.xyz, r6.www);
    r12.xy = lerp(r9.xy, r8.xy, r6.ww);
    r1 = tex2D(s9, v7.zw);
    r2 = (r1.wwww) * (-(c3.zzzy)) + (-(c3.wwwz));
    ...
    r1.y = dot(r12.xy, r12.xy) + (c3.z);
    r1.w = dot(r2.xy, r2.xy) + (c3.z);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r3.w = (r1.y) * (c4.x) + (c4.y);
    r1.y = (r1.w) * (c4.x) + (c4.y);
    r1.w = dot(r2.xy, r12.xy) + (c3.z);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r6.xy = (r2.xy) * (c10.ww);
