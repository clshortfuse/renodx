// Mechanically reconstructed from 0xEC28C9F2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xz = (r3.xy) * (c12.xx);
    r8.y = (r2.w) + (r2.w);
    r3.xyz = (r8.xyz) * (r1.xxx) + (r4.xyz);
    r4.xyz = (r1.yyy) * (r3.xyz);
    r3.xyz = (r12.xyz) * (r2.yyy);
    r2.xyz = (r2.yyy) * (r6.xyz) + (r4.xyz);
