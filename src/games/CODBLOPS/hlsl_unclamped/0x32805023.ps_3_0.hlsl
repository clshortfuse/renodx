// Mechanically reconstructed from 0x32805023.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c34 = float4(2.0f, -1.0f, 0.0f, -0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = (c34.xxxx) * (v8) + (c34.yyyy);
    r3.y = dot(r1.xy, r0.zw) + (c34.z);
    r3.x = dot(r1.xy, r0.xy) + (c34.z);
    r0 = tex2D(s8, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c34.xxxx) * (v9) + (c34.yyyy);
    r5.y = dot(r1.xy, r0.zw) + (c34.z);
    r5.x = dot(r1.xy, r0.xy) + (c34.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s5, v7.xy);
    r5.w = (r0.w) * (v0.y);
    r2 = tex2D(s1, v1.xy);
    ...
    r6.xy = lerp(r2.xy, r3.xy, r5.ww);
    r0 = tex2D(s10, v7.xy);
    r1 = (r0.wwww) * (-(c34.zzzy)) + (-(c34.wwwz));
    r3 = tex2D(s9, v1.xy);
    r2 = lerp(r3, r1, r5.wwww);
    r1 = tex2D(s6, v7.zw);
    r3.w = (r1.w) * (v0.z) + (c3.x);
    r1.xyz = float3(((r3.w) >= 0.0f ? (r1.x) : (r4.x)), ((r3.w) >= 0.0f ? (r1.y) : (r4.y)), ((r3.w) >= 0.0f ? (r1.z) : (r4.z)));
    r5.xy = float2(((r3.w) >= 0.0f ? (r5.x) : (r6.x)), ((r3.w) >= 0.0f ? (r5.y) : (r6.y)));
    r9.xyz = (r1.xyz) * (r1.xyz);
    r3.xyz = lerp(c[32].xyw, r0.yyy, r5.www);
    r1 = tex2D(s11, v7.zw);
    r0 = (r1.wwww) * (-(c34.zzzy)) + (-(c34.wwwz));
    r0 = float4(((r3.w) >= 0.0f ? (r0.x) : (r2.x)), ((r3.w) >= 0.0f ? (r0.y) : (r2.y)), ((r3.w) >= 0.0f ? (r0.z) : (r2.z)), ((r3.w) >= 0.0f ? (r0.w) : (r2.w)));
    r1.w = dot(r5.xy, r5.xy) + (c34.z);
    r14.xyz = float3(((r3.w) >= 0.0f ? (r1.y) : (r3.x)), ((r3.w) >= 0.0f ? (r1.y) : (r3.y)), ((r3.w) >= 0.0f ? (r1.y) : (r3.z)));
    r1.w = exp2(-(r1.w));
    r4.w = (r1.w) * (c3.y) + (c3.z);
    r1.xy = (v1.zw) * (c4.yz);
    r3 = tex2D(s13, r1.xy);
    ...
    r2 = tex2D(s14, v1.zw);
    r4.xy = (r2.xy) * (c12.xx);
    r6.xy = (r3.yw) * (c12.yy) + (c12.zz);
    r10.xy = (r3.xz) * (r4.xx);
    r1.w = dot(r6.xy, r5.xy) + (c34.z);
    r1.y = (r2.x) * (c12.x) + (-(r10.x));
    r2.w = (r3.z) * (-(r4.x)) + (r1.y);
    r3.xy = (r1.xz) * (r4.yy);
    r1.y = (r2.y) * (c12.x) + (-(r3.x));
    r1.x = dot(r6.xy, r6.xy) + (c34.z);
    r1.y = (r1.z) * (-(r4.y)) + (r1.y);
    r1.z = exp2(-(r1.x));
    r6.y = (r2.w) + (r2.w);
    r1.z = (r1.z) * (c3.y) + (c3.z);
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (-(c34.y)) : (-(c34.z)));
    ...
    r1.xy = (r1.xy) * (r1.xy);
    r1.w = ((-abs(r1.w)) >= 0.0f ? (c34.z) : (r1.z));
    r1.z = (r3.x) * (r1.x);
    r1.w = (r1.w) * (r1.z);
    r1.z = (r1.y) * (-(r3.y)) + (-(c34.y));
    r1.xy = (r2.ww) * (r2.xy);
    r1.w = (r1.w) * (r1.z);
    r2.w = (r3.z) * (r1.w);
