// Mechanically reconstructed from 0x1AF13838.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.xy = (r0.wy) * (c12.yy) + (c12.zz);
    r5.w = rsqrt(r1.w);
    r0.w = dot(r3.xy, r5.xy) + (c24.z);
    r2 = tex2D(s14, v1.zw);
    r8.xy = (r2.xy) * (c12.xx);
    r6.xy = (r1.xz) * (r8.xx);
    r7.xy = (r0.xz) * (r8.yy);
    r0.x = (r2.x) * (c12.x) + (-(r6.x));
    r0.y = (r2.y) * (c12.x) + (-(r7.x));
    r0.x = (r1.z) * (-(r8.x)) + (r0.x);
    r0.y = (r0.z) * (-(r8.y)) + (r0.y);
    r10.y = (r0.x) + (r0.x);
    r0.z = dot(r3.xy, r3.xy) + (c24.z);
    r0.y = (r0.y) + (r0.y);
    r0.z = exp2(-(r0.z));
    r0.z = (r0.z) * (c3.y) + (c3.z);
    ...
    r1 = tex2D(s6, v1.xy);
    r0 = tex2D(s7, v7.xy);
    r14.xy = lerp(r1.wy, r0.wy, r6.ww);
    r0 = tex2D(s4, v7.zw);
    r0.xyz = (r0.xyz) + (c24.yyy);
    r0.w = (r14.x) * (-(c4.x)) + (c4.y);
    r1.xyz = (v0.zzz) * (r0.xyz) + (c24.www);
    r4.w = (r14.x) * (c4.x);
    ...
    r0.z = (r0.w) * (r0.z) + (c12.w);
    r0.w = (r2.w) * (c14.x) + (c14.y);
    r0.z = 1.0f / (r0.z);
    r0.w = (r0.y) * (r0.w);
    r2.w = (r1.w) * (r0.z);
    r0.xyz = (r7.xyz) * (r3.www) + (r11.xyz);
    r0.w = (r0.w) * (r2.w);
    r5.xyz = (r1.xyz) * (r1.xyz);
    r0.xyz = (r0.xyz) * (r0.www);
    r13.xyz = (r14.yyy) * (r0.xyz);
    r12.xyz = (r2.xyz) * (r14.yyy);
    r0 = tex2D(s12, v1.zw);
