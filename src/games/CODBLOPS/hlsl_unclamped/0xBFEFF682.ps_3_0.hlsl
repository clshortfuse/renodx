// Mechanically reconstructed from 0xBFEFF682.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = (r0.z) * (r3.w) + (r3.z);
    r3.w = (r0.x) * (r3.w) + (r3.z);
    r7.xyz = float3(((r8.w) >= 0.0f ? (r3.y) : (c[25].x)), ((r8.w) >= 0.0f ? (r3.y) : (c[25].y)), ((r8.w) >= 0.0f ? (r3.y) : (c[25].w)));
    r0.y = (r0.y) * (r3.w) + (c4.x);
    r7.w = (-(r0.x)) + (-(c1.y));
    r0.y = 1.0f / (r0.y);
    r4.w = (r0.z) * (r0.y);
