// Mechanically reconstructed from 0xF76814BA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s5, v7.zw);
    r0.w = (r0.w) * (v7.y);
    r5.xy = lerp(r3.xy, r2.xy, r0.ww);
    r1.w = dot(r5.xy, r5.xy) + (c38.z);
    r2.xyz = lerp(r1.xyz, r0.xyz, r0.www);
    r0.z = exp2(-(r1.w));
    r7.xyz = (r2.xyz) * (r2.xyz);
    r4.z = (r0.z) * (c1.x) + (c1.y);
    r1 = tex2D(s7, v0.xy);
    r9.w = lerp(r1.y, c38.w, r0.w);
    r5.z = (r1.w) * (-(c4.z)) + (c4.w);
    ...
    r3.xy = (r3.xz) * (r4.xx);
    r0.w = dot(r6.xy, r5.xy) + (c38.z);
    r0.y = (r2.x) * (c3.w) + (-(r3.x));
    r1.z = (r3.z) * (-(r4.x)) + (r0.y);
    r1.xy = (r0.xz) * (r4.yy);
    r0.y = (r2.y) * (c3.w) + (-(r1.x));
    r0.x = dot(r6.xy, r6.xy) + (c38.z);
    r0.y = (r0.z) * (-(r4.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r8.y = (r1.z) + (r1.z);
    r0.z = (r0.z) * (c1.x) + (c1.y);
    ...
    r10.w = saturate(dot(r3.xyz, r4.xyz));
    r3.w = (r0.w) * (c15.z) + (c15.w);
    r2.w = (r0.w) * (r0.w);
    r0 = v1;
    ...
    r3.y = (r3.y) * (r3.x);
    r4.z = (r3.w) * (r5.z) + (r5.y);
    r3.x = saturate(dot(r9.xyz, r0.xyz));
    r0.y = (r4.z) * (r5.w) + (c13.x);
    r0.z = pow(abs(r3.x), r4.w);
    r0.y = 1.0f / (r0.y);
    r0.z = (r2.w) * (r0.z);
    r0.x = (r3.w) * (r0.y);
    r0.y = (r3.y) * (c16.x) + (c16.y);
    r0.z = (r0.z) * (r0.x);
    r12.z = (r3.z) * (r2.w);
    r0.z = (r0.y) * (r0.z);
    r11.xyz = (r9.www) * (r2.xyz);
    r12.x = (r9.w) * (r0.z);
    r2 = tex2D(s12, v0.zw);
    r0.z = ((-abs(r2.y)) >= 0.0f ? (c38.w) : (c38.z));
