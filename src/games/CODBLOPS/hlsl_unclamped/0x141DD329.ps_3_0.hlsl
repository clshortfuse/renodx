// Mechanically reconstructed from 0x141DD329.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c37 = float4(2.0f, -1.0f, 0.0f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = (c37.xxxx) * (v9) + (c37.yyyy);
    r4.y = dot(r1.xy, r0.zw) + (c37.z);
    r4.x = dot(r1.xy, r0.xy) + (c37.z);
    r0 = tex2D(s1, v1.xy);
    ...
    r0 = tex2D(s13, r0.xy);
    r2.w = r0.y;
    r7.xy = lerp(r5.xy, r4.xy, r4.ww);
    r5.xy = (r2.yw) * (c12.xx) + (c12.yy);
    r1 = tex2D(s14, v1.zw);
    r6.xy = (r1.xy) * (c4.ww);
    r1.w = dot(r5.xy, r7.xy) + (c37.z);
    r2.xy = (r2.xz) * (r6.xx);
    r0.w = (r1.x) * (c4.w) + (-(r2.x));
    r4.xy = (r0.xz) * (r6.yy);
    r0.w = (r2.z) * (-(r6.x)) + (r0.w);
    ...
    r0.y = (r0.z) * (-(r6.y)) + (r0.y);
    r11.y = (r0.w) + (r0.w);
    r0.w = dot(r7.xy, r7.xy) + (c37.z);
    r0.z = dot(r5.xy, r5.xy) + (c37.z);
    r0.w = exp2(-(r0.w));
    r0.z = exp2(-(r0.z));
    r0.w = (r0.w) * (c3.x) + (c3.y);
    r0.z = (r0.z) * (c3.x) + (c3.y);
    ...
    r11.xz = (r2.xy) * (c12.xx);
    r1.xyz = (r11.xyz) * (r0.www) + (r0.xyz);
    r5.zw = c37.zw;
    r2.xyz = (r5.zwz) + (-(c[34].xyw));
    r0 = tex2D(s5, v7.zw);
    r0.xyz = (r0.xyz) + (c37.yyy);
    r8.xyz = (r4.www) * (r2.xyz) + (c[34].xyw);
    r4.xyz = (v0.zzz) * (r0.xyz) + (c37.www);
    r13.xyz = (r1.xyz) * (r8.yyy);
    r3.xyz = (r3.xyz) * (r4.xyz);
    r1 = tex2D(s8, v1.xy);
    r0 = tex2D(s6, v8.xy);
    r2.xyz = (r0.xyz) + (c37.yyy);
    r0.xyz = (r4.xyz) * (r1.xyz);
    r4.xyz = (v0.www) * (r2.xyz) + (c37.www);
    ...
    r0 = tex2D(s12, v1.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c37.w) : (c37.z));
    ...
    r0.xy = (r0.xy) * (r0.xy);
    r0.w = ((-abs(r0.w)) >= 0.0f ? (c37.z) : (r0.z));
    r0.z = (r2.x) * (r0.x);
    r0.w = (r0.w) * (r0.z);
    r0.z = (r0.y) * (-(r2.y)) + (c37.w);
    r0.xy = (r1.zz) * (r1.xy);
    r0.w = (r0.w) * (r0.z);
    r6.w = (r1.w) * (r0.w);
