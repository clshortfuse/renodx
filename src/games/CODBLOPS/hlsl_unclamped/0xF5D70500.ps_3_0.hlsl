// Mechanically reconstructed from 0xF5D70500.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.x = 1.0f / (r1.w);
    r8.y = (r0.w) + (r0.w);
    r1.xy = saturate((r5.xx) * (c[24].xy) + (c[24].zw));
    r0.xy = (r1.xy) * (r1.xy);
    ...
    r3.w = (r3.w) + (r3.w);
    r7.xyz = (r6.xyz) * (r2.xyz) + (r1.xyz);
    r1.xyz = (r9.xyz) * (-(r3.www)) + (r0.xyz);
