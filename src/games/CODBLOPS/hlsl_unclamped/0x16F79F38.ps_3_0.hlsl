// Mechanically reconstructed from 0x16F79F38.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = dot(r1, c[20]);
    r3.w = (r3.z) * (r3.z);
    r1.y = dot(c[7].yz, r3.zw) + (c[7].x);
    r1.z = saturate(1.0f / (r1.y));
    r1.y = ((-abs(r1.y)) >= 0.0f ? (c1.x) : (r1.z));
    r1.zw = saturate((r3.zz) * (c[8].xy) + (c[8].zw));
    r3.zw = (r1.zw) * (r1.zw);
    ...
    r0.x = (r3.z) * (-(r0.w)) + (r0.x);
    r3.y = (r0.y) * (r0.x);
    r0.xyz = (r3.xyw) * (c[34].xxx);
    r0.xyz = (r0.xyz) * (c15.xyx);
    r0.xyz = (r1.xyz) * (c14.xyz) + (r0.xyz);
    r0.w = c[29].w;
    r1.x = (r0.w) * (c15.z);
    r1.x = frac(r1.x);
    r1.x = (r0.w) * (c15.z) + (-(r1.x));
    r1.y = (r1.x) * (c15.w) + (v3.y);
    r1.x = c14.w;
    r1 = tex2D(s5, r1.xy);
    r1.x = (r1.x) * (-(c16.x)) + (v3.x);
    r1.x = (r1.x) * (c16.y) + (-(v3.x));
    r1.x = (c[37].x) * (r1.x) + (v3.x);
    r1.z = frac(abs(v3.y));
    r1.y = ((v3.y) >= 0.0f ? (r1.z) : (-(r1.z)));
    r1.z = ((r1.x) >= 0.0f ? (c1.x) : (c1.z));
    r1.w = (-(r1.x)) + (c1.z);
    r1.w = ((r1.w) >= 0.0f ? (c1.x) : (c1.z));
    r1.z = (r1.z) + (r1.w);
    r1.x = saturate(r1.x);
    ...
    r2.x = 1.0f / (c[36].x);
    r2.y = 1.0f / (c[36].y);
    r2.z = dot(r0.wwww, c18);
    r3.x = frac(r2.z);
    r3.w = c[29].w;
    r2.z = dot(r3.xwww, c18);
    r3.y = frac(r2.z);
    r2.z = dot(r3.xyww, c18);
    r3.z = frac(r2.z);
    r2.z = dot(r3, c18);
    r3.w = frac(r2.z);
    r2.z = dot(r3, c18);
