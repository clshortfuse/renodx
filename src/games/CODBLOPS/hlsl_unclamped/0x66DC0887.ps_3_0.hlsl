// Mechanically reconstructed from 0x66DC0887.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(0.25f, 0.0f, 0.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r1.w = dot(r0, c1.xxxx);
    r0.xyz = (r1.xyz) * (r2.www) + (v6.xyz);
    r0 = tex3D(s11, r0.xyz);
    r2.w = lerp(r0.w, r1.w, c[23].w);
