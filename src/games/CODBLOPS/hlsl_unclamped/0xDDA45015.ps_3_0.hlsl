// Mechanically reconstructed from 0xDDA45015.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = (r0.z) * (r1.w) + (r2.z);
    r1.w = (r0.x) * (r1.w) + (r2.z);
    r0.y = (r0.y) * (r1.w) + (c11.x);
    r0.y = 1.0f / (r0.y);
    r7.w = (-(r0.x)) + (c2.w);
    r1.w = (r0.z) * (r0.y);
    r6.xyz = (r0.zzz) * (c[6].xyz);
    r4.xyz = (r4.xyz) * (r3.www) + (-(r8.xyz));
    r5.x = 1.0f / (r3.w);
