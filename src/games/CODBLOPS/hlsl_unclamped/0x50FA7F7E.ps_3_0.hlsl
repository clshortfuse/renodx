// Mechanically reconstructed from 0x50FA7F7E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xy = (r4.xy) * (r5.xy);
    r3.w = c1.z;
    r8.xyz = float3(((r4.w) >= 0.0f ? (c[10].x) : (r3.w)), ((r4.w) >= 0.0f ? (c[10].y) : (r3.w)), ((r4.w) >= 0.0f ? (c[10].w) : (r3.w)));
    r1.w = (r1.w) * (r5.x);
