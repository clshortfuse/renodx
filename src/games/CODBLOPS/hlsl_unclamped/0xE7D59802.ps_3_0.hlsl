// Mechanically reconstructed from 0xE7D59802.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xy = float2(((r4.w) >= 0.0f ? (r6.x) : (c1.z)), ((r4.w) >= 0.0f ? (r6.y) : (c1.z)));
    ...
    r6.xyz = float3(((r4.w) >= 0.0f ? (c[29].x) : (r2.w)), ((r4.w) >= 0.0f ? (c[29].y) : (r2.w)), ((r4.w) >= 0.0f ? (c[29].w) : (r2.w)));
