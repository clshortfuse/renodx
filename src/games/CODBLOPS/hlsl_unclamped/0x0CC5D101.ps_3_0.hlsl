// Mechanically reconstructed from 0x0CC5D101.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = (r8.y) * (r7.w) + (c12.x);
    r0.xyz = (r5.xyz) * (r8.xxx) + (r6.xyz);
    r8.y = 1.0f / (r8.y);
    r9.z = (r3.w) * (r8.y);
    r8.y = (-(r1.w)) + (c1.z);
    r8.x = (r8.y) * (r8.y);
    ...
    r8.y = (r1.w) + (r1.w);
    r1.w = (r0.w) * (c1.x);
    r1.xyz = (r10.xyz) * (-(r8.yyy)) + (r1.xyz);
    r1 = texCUBElod(s15, r1);
    r1.xyz = (r1.xyz) * (r1.xyz);
    r8.xy = (r0.ww) * (c14.xy) + (c14.zw);
    r1.w = saturate(dot(r10.xyz, r4.xyz));
    r4.y = exp2(r8.y);
    r0.w = pow(abs(r1.w), r4.y);
    ...
    r0.y = 1.0f / (r0.z);
    r0.z = pow(abs(r4.z), r4.y);
    r0.y = (r6.w) * (r0.y);
    r0.z = (r1.w) * (r0.z);
    r1.w = (r0.y) * (r0.z);
    r0.xyz = (r5.xyz) * (r5.www) + (r6.xyz);
    r2.xyz = (r2.xyz) * (c1.yyy);
    r0.xyz = (r1.www) * (r0.xyz);
    r0.xyz = (r0.xyz) * (c[38].www);
    r4.xyz = (r9.yyy) * (c[19].xyz);
