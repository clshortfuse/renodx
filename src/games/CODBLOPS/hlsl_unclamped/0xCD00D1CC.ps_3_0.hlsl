// Mechanically reconstructed from 0xCD00D1CC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (r1.x) * (c1.w) + (-(r0.x));
    r1.xyz = v2.xyz;
    r3.xyz = (r5.xxx) * (v5.xyz) + (r1.xyz);
    r1.xz = (r2.ww) * (r0.xy);
    r3.xyz = (r5.yyy) * (v4.xyz) + (r3.xyz);
    r0.w = (r0.z) * (-(r4.x)) + (r0.w);
    r8.xyz = normalize(r3.xyz);
    r1.y = (r2.w) * (r0.w);
    r0.w = saturate(dot(c[17].xyz, r8.xyz));
    r7.xyz = (r1.xyz) * (c2.xzx) + (r2.xyz);
    ...
    r0 = (v6.zzzz) * (c[25]) + (r0);
    r0 = (r0) + (c[26]);
    r4.xy = (r0.ww) * (c[27].xy) + (r0.xy);
    r4.zw = r0.zw;
    r2 = tex2Dproj(s2, r4);
    r3.zw = r4.zw;
    r0.zw = r3.zw;
    r5.xy = (r4.ww) * (-(c[27].zw)) + (r0.xy);
    r5.zw = r0.zw;
    r5 = tex2Dproj(s2, r5);
    r2.w = r5.x;
    r3.xy = (r4.ww) * (-(c[27].xy)) + (r0.xy);
    r0.xy = (r4.ww) * (c[27].zw) + (r0.xy);
    r3 = tex2Dproj(s2, r3);
    r2.y = r3.x;
    r3 = tex2Dproj(s2, r0);
    r0 = (v6.xyzx) * (c3.xxxz) + (c3.zzzx);
    r1.w = dot(r0, c[20]);
    r2.z = r3.x;
    r1.z = 1.0f / (r1.w);
    r3.x = dot(r0, c[9]);
    ...
    r0.w = (r0.w) * (r1.x);
    r1.x = saturate((r1.z) * (c[22].x) + (c[22].y));
    r1.z = (r1.x) * (r1.x);
    r1.x = (r1.x) * (c4.x) + (c4.y);
    r0.w = (r2.w) * (r0.w);
    r1.z = (r1.z) * (r1.x);
