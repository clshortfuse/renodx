// Mechanically reconstructed from 0x2E70F899.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = lerp(r2.xyz, r0.xyz, r2.www);
    r7.xy = (r2.ww) * (-(r7.xy)) + (r7.xy);
    r7.w = c1.x;
    r1.xyz = (r7.www) + (-(c[20].xyw));
    r0 = tex2D(s4, v8.zw);
    r0.w = (r0.w) * (v0.z);
    r2.xyz = (r2.www) * (r1.xyz) + (c[20].xyw);
    r1.xyz = lerp(r6.xyz, r0.xyz, r0.www);
    r12.xyz = lerp(r2.xyz, c1.xxx, r0.www);
