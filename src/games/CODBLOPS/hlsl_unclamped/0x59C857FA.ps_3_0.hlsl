// Mechanically reconstructed from 0x59C857FA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.x = 1.0f / (r2.x);
    r5.w = dot(r5.xyz, c[33].xyz);
    r5.w = saturate((r5.w) * (c[34].x) + (c[34].y));
    r5.w = (r5.w) * (c[34].w);
    r6.x = lerp(r4.w, r1.w, r5.w);
    r4.xyz = (r4.xyz) * (r4.xyz);
    r2.z = (r2.x) * (r2.x);
    r1.w = dot(c[35].yz, r2.xz) + (c[35].x);
    r2.xz = saturate((r2.xx) * (c[36].xy) + (c[36].zw));
    r6.yz = (r2.xz) * (r2.xz);
    ...
    r2.xy = lerp(c[40].xy, c[40].zw, v3.xy);
    r3 = tex2D(s4, r2.xy);
    r3.y = r3.x;
    r4 = tex2D(s5, r2.xy);
    r2 = tex2D(s3, r2.xy);
