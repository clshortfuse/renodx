// Mechanically reconstructed from 0x045405E4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r3.z = (r0.w) * (v0.w) + (c1.x);
    r5.xyz = float3(((r3.z) >= 0.0f ? (r1.x) : (c1.z)), ((r3.z) >= 0.0f ? (r1.y) : (c1.z)), ((r3.z) >= 0.0f ? (r1.z) : (c1.z)));
    r1 = v2;
