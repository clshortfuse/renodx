// Mechanically reconstructed from 0x39EEB4C9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s7, v1.xy);
    r2 = tex2D(s0, v1.xy);
    r3.xyz = float3(((r3.w) >= 0.0f ? (r1.x) : (r2.x)), ((r3.w) >= 0.0f ? (r1.y) : (r2.y)), ((r3.w) >= 0.0f ? (r1.z) : (r2.z)));
    ...
    r13.xyz = float3(((r3.w) >= 0.0f ? (c[29].x) : (r0.y)), ((r3.w) >= 0.0f ? (c[29].y) : (r0.y)), ((r3.w) >= 0.0f ? (c[29].w) : (r0.y)));
    r0 = tex2D(s6, v8.zw);
