// Mechanically reconstructed from 0xC1EC52C3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = (r0.w) * (r3.w);
    r0.w = saturate(dot(r7.xyz, r11.xyz));
    r0.xyz = (r0.xyz) * (r1.zzz);
    r0.w = (-(r0.w)) + (c0.y);
    r6.xyz = (r2.www) * (r0.xyz);
    r0.z = (r0.w) * (r0.w);
    r13.xy = c[39].xy;
    r2.xyz = (r13.yyy) * (c[38].xyz);
    r0.z = (r0.z) * (r0.z);
    r14.x = 1.0f / (r1.w);
    r3.w = (r0.w) * (r0.z);
    r1 = tex2D(s3, v1.xy);
    ...
    r4.w = exp2(r12.y);
    r11.z = saturate(dot(r10.xyz, r7.xyz));
    r3.w = (r4.w) * (c4.x) + (c4.y);
    r7.z = pow(abs(r11.z), r4.w);
    r7.y = (r11.w) * (r8.w);
    r7.z = (r3.w) * (r7.z);
    r1.w = (r1.w) * (c0.w);
    r7.z = (r7.y) * (r7.z);
    ...
    r13.yz = c0.yz;
    r11.xyz = float3(((r2.w) >= 0.0f ? (c[43].x) : (r13.z)), ((r2.w) >= 0.0f ? (c[43].y) : (r13.z)), ((r2.w) >= 0.0f ? (c[43].w) : (r13.z)));
    r8.w = 1.0f / (r12.x);
    r1.xyz = (r1.xyz) * (r11.zzz);
    r0 = float4(((r2.w) >= 0.0f ? (r0.x) : (c0.z)), ((r2.w) >= 0.0f ? (r0.y) : (c0.z)), ((r2.w) >= 0.0f ? (r0.z) : (c0.z)), ((r2.w) >= 0.0f ? (r0.w) : (c0.z)));
    r12.xyz = (r2.xyz) * (r1.xyz);
    r1.z = dot(c[40].yz, r14.xy) + (c[40].x);
    r2.xy = saturate((r14.xx) * (c[41].xy) + (c[41].zw));
    r1.xy = (r2.xy) * (r2.xy);
    r2.xy = (r2.xy) * (c1.zz) + (c1.ww);
    r2.xy = (r1.xy) * (r2.xy);
