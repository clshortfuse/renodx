// Mechanically reconstructed from 0x80D2B7EB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.y = dot(r5.xy, r0.zw) + (c3.z);
    r1 = tex2D(s8, v7.zw);
    r4.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r2 = (c3.xxxx) * (v9) + (c3.yyyy);
    r3.x = dot(r5.xy, r0.xy) + (c3.z);
    r6.y = dot(r4.xy, r2.zw) + (c3.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s5, v7.xy);
    r4.w = (r0.w) * (v0.y);
    r6.x = dot(r4.xy, r2.xy) + (c3.z);
    ...
    r1 = tex2D(s10, v7.xy);
    r1 = (r2) + (r1);
    r2 = (r0.wwww) * (-(c3.zzzy)) + (-(c3.wwwz));
    r7.xy = lerp(r4.xy, r3.xy, r4.ww);
    r3 = (r4.wwww) * (r1) + (r2);
    r1 = tex2D(s6, v7.zw);
    r5.w = (r1.w) * (v0.z);
    ...
    r5.xyz = lerp(r0.yyy, c[32].xyw, r4.www);
    r0 = lerp(r3, r2, r5.wwww);
    r14.xyz = lerp(r5.xyz, r1.yyy, r5.www);
