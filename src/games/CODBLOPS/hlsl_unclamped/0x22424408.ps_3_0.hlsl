// Mechanically reconstructed from 0x22424408.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c15 = float4(-1.0f, 1.0f, 0.200000003f, 0.0f);
    ...
    r0.w = dot(r5.xy, r5.xy) + (c15.w);
    r0.xyz = (r0.xyz) * (r4.xyz) + (r1.xyz);
    r0.w = exp2(-(r0.w));
    r7.xyz = (r0.xyz) * (r0.xyz);
    r3.z = (r0.w) * (c1.x) + (c1.y);
    r10.xyz = lerp(r3.yyy, c[36].xyw, r5.www);
    r0.xy = (v1.zw) * (c3.xy);
    r2 = tex2D(s13, r0.xy);
    ...
    r2.xy = (r2.xz) * (r6.xx);
    r0.w = dot(r3.xy, r5.xy) + (c15.w);
    r0.y = (r1.x) * (c3.w) + (-(r2.x));
    r1.w = (r2.z) * (-(r6.x)) + (r0.y);
    r0.y = dot(r3.xy, r3.xy) + (c15.w);
    r3.xy = (r0.xz) * (r6.yy);
    r0.y = exp2(-(r0.y));
    r0.x = (r1.y) * (c3.w) + (-(r3.x));
    r0.y = (r0.y) * (c1.x) + (c1.y);
    ...
    r1.w = rsqrt(r1.w);
    r16.xyz = (r0.www) * (v7.xyz);
    r2.xyz = (r8.xyz) * (r3.zzz) + (r1.xyz);
    r1.xyz = (r0.xyz) * (r1.www) + (-(r16.xyz));
    r18.xyz = (r10.yyy) * (r2.xyz);
    ...
    r8.w = (r0.w) * (r0.z);
    r1 = tex2D(s12, v1.zw);
    r1.w = ((-abs(r1.y)) >= 0.0f ? (c15.y) : (c15.w));
    r3.xyz = (r4.xyz) * (c15.zzz);
    r0 = tex2D(s8, v8.zw);
    r2 = lerp(r3, r0, r5.wwww);
    r0 = v2;
    r0.xyz = (r5.xxx) * (v5.xyz) + (r0.xyz);
    r12.xyz = (r2.xyz) * (-(r2.xyz)) + (c15.yyy);
    ...
    r1.w = (r4.y) * (c14.y) + (c14.z);
    r0.z = (r9.w) * (r10.w) + (r4.x);
    r0.z = (r0.z) * (r3.z) + (c14.x);
    ...
    r1.xy = (r1.xy) * (r1.xy);
    r0.z = ((-abs(r0.z)) >= 0.0f ? (c15.w) : (r1.w));
    r1.w = (r2.x) * (r1.x);
    r0.z = (r0.z) * (r1.w);
    r1.w = (r1.y) * (-(r2.y)) + (c15.y);
    r0.xy = (r2.ww) * (r0.xy);
    r0.z = (r0.z) * (r1.w);
    r7.w = (r4.z) * (r0.z);
