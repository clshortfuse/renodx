// Mechanically reconstructed from 0x2523CD90.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.w = -(r2.w);
    r4 = (r4) + (r5);
    r5 = (r2.wwww) * (-(c1.wwwy)) + (-(c1.zzzw));
    r0.w = dot(c[5].xyz, r6.xyz);
    r6 = (r7.wwww) * (r4) + (r5);
    r4 = tex2D(s7, v6.zw);
    r5 = (r4.wwww) * (-(c1.wwwy)) + (-(c1.zzzw));
    r9.xy = lerp(r2.yy, c[8].xy, r7.ww);
