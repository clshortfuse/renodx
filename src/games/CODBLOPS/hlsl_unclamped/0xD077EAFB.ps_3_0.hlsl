// Mechanically reconstructed from 0xD077EAFB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = float4(((r5.w) >= 0.0f ? (r0.x) : (c3.w)), ((r5.w) >= 0.0f ? (r0.y) : (c3.w)), ((r5.w) >= 0.0f ? (r0.z) : (c3.w)), ((r5.w) >= 0.0f ? (r0.w) : (c3.w)));
    r3 = tex2D(s5, v0.xy);
    r4.zw = (r3.ww) * (c1.xy) + (c1.zx);
    r0 = tex2D(s3, v7.zw);
    r3.w = (r0.w) * (v7.y) + (c3.z);
    r0 = (r0.xyzx) * (-(c3.yyyw)) + (-(c3.wwwy));
    r4 = float4(((r5.w) >= 0.0f ? (r4.x) : (-(c3.w))), ((r5.w) >= 0.0f ? (r4.y) : (-(c3.w))), ((r5.w) >= 0.0f ? (r4.z) : (-(c3.w))), ((r5.w) >= 0.0f ? (r4.w) : (-(c3.y))));
    r0 = float4(((r3.w) >= 0.0f ? (r0.x) : (r1.x)), ((r3.w) >= 0.0f ? (r0.y) : (r1.y)), ((r3.w) >= 0.0f ? (r0.z) : (r1.z)), ((r3.w) >= 0.0f ? (r0.w) : (r1.w)));
    r1 = tex2D(s6, v7.zw);
    r2.zw = (r1.ww) * (c1.xy) + (c1.zx);
    r2 = float4(((r3.w) >= 0.0f ? (r2.x) : (r4.x)), ((r3.w) >= 0.0f ? (r2.y) : (r4.y)), ((r3.w) >= 0.0f ? (r2.z) : (r4.z)), ((r3.w) >= 0.0f ? (r2.w) : (r4.w)));
    r1.w = ((r5.w) >= 0.0f ? (r3.y) : (c3.w));
    r8.w = ((r3.w) >= 0.0f ? (r1.y) : (r1.w));
    ...
    r0.x = exp2(-(r0.x));
    r0.x = (r0.x) * (c4.x) + (c4.y);
    r1.xyz = (v6.xyz) * (-(r5.zzz)) + (c[17].xyz);
    r0.x = (r5.w) * (r0.x);
    r3.xyz = normalize(r1.xyz);
    r1.z = saturate((r0.z) * (r0.x) + (r0.x));
    ...
    r2.xyz = (r5.zzz) * (v6.xyz);
    r11.w = saturate(dot(r10.xyz, -(r2.xyz)));
    r1.x = (r2.w) * (c4.z);
    r4.z = (r11.w) * (r3.w) + (r1.x);
    r12.xy = (r2.ww) * (c14.xy) + (c14.zw);
    r1.y = exp2(r12.y);
    r1.z = saturate(dot(r10.xyz, c[17].xyz));
    r4.y = saturate(dot(r10.xyz, r3.xyz));
    r1.x = (r1.z) * (r3.w) + (r1.x);
    r3.w = pow(abs(r4.y), r1.y);
    r1.x = (r1.x) * (r4.z) + (c13.x);
    r1.y = (r1.y) * (c13.y) + (c13.z);
    r1.x = 1.0f / (r1.x);
    r1.y = (r3.w) * (r1.y);
    r3.w = (r1.z) * (r1.x);
    r1.x = (r9.w) * (r4.w) + (r10.w);
    r1.y = (r1.y) * (r3.w);
    r0.xyz = (r9.xyz) * (r5.www) + (r0.xyz);
    r1.y = (r1.x) * (r1.y);
    r11.xyz = (r8.www) * (r0.xyz);
    r12.w = (r8.w) * (r1.y);
    r3 = tex2D(s12, v0.zw);
    ...
    r0.xyz = (r3.www) * (r1.xyz) + (r11.xyz);
    r1.xyz = (r12.www) * (c[19].xyz);
    ...
    r7.w = (r9.w) * (r0.y) + (r10.w);
    r0.z = (r0.z) + (r0.z);
    r2.w = (r2.w) * (c1.w);
    r2.xyz = (r10.xyz) * (-(r0.zzz)) + (r2.xyz);
    r6 = texCUBElod(s15, r2);
    r5 = (-(v6.yyyy)) + (c[6]);
    r4 = (-(v6.xxxx)) + (c[5]);
    r2 = (r5) * (r5);
    r2 = (r4) * (r4) + (r2);
