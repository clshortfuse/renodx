// Mechanically reconstructed from 0x2E9AD485.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4 = tex2D(s14, v1.zw);
    r2.xy = (r4.xy) * (c12.ww);
    r9.xy = (r5.yw) * (c14.xx) + (c14.yy);
    r5.xy = (r5.xz) * (r2.xx);
    r0.z = dot(r9.xy, r8.xy) + (c3.w);
    r1.w = (r4.x) * (c12.w) + (-(r5.x));
    r2.x = (r5.z) * (-(r2.x)) + (r1.w);
    r3.xy = (r3.xz) * (r2.yy);
    r2.z = (r4.y) * (c12.w) + (-(r3.x));
    r1.w = dot(r9.xy, r9.xy) + (c3.w);
    r2.z = (r3.z) * (-(r2.y)) + (r2.z);
    r1.w = exp2(-(r1.w));
    r10.y = (r2.x) + (r2.x);
    r1.w = (r1.w) * (c4.x) + (c4.y);
    ...
    r10.xz = (r5.xy) * (c14.xx);
    r13.xyz = lerp(r0.yyy, c[23].xyw, r9.www);
    r2.xyz = (r10.xyz) * (r0.www) + (r2.xyz);
    r14.xyz = (r13.yyy) * (r2.xyz);
