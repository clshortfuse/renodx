// Mechanically reconstructed from 0x9AC7B9C9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s5, v7.xy);
    r5.w = (r0.w) * (v0.y) + (c3.w);
    r6.xy = float2(((r5.w) >= 0.0f ? (r1.x) : (r3.x)), ((r5.w) >= 0.0f ? (r1.y) : (r3.y)));
    ...
    r10.xy = lerp(r6.xy, r5.xy, r6.ww);
    r3.xyz = lerp(r4.xyz, r2.xyz, r6.www);
    ...
    r4.xy = (r4.xz) * (r6.xx);
    r1.z = dot(r7.xy, r10.xy) + (c3.z);
    r1.x = (r3.x) * (c12.w) + (-(r4.x));
    r2.y = (r4.z) * (-(r6.x)) + (r1.x);
    r5.xy = (r2.xz) * (r6.yy);
    r2.w = (r3.y) * (c12.w) + (-(r5.x));
    r1.x = dot(r7.xy, r7.xy) + (c3.z);
    r2.w = (r2.z) * (-(r6.y)) + (r2.w);
    r1.x = exp2(-(r1.x));
    r6.y = (r2.y) + (r2.y);
    ...
    r5.xyz = (r2.xyz) * (r1.www) + (-(r7.xyz));
    r4.xyz = normalize(r5.xyz);
    r8.xyz = (r2.xyz) * (r1.www);
    r2.xyz = float3(((r5.w) >= 0.0f ? (r1.y) : (c[32].x)), ((r5.w) >= 0.0f ? (r1.y) : (c[32].y)), ((r5.w) >= 0.0f ? (r1.y) : (c[32].w)));
    ...
    r1.y = saturate(dot(r17.xyz, r4.xyz));
    r10.w = (r0.w) * (c12.z);
    ...
    r4.z = (r3.w) * (r0.y);
    r1.y = (r0.z) * (r5.w);
    r0.xyz = (r15.xyz) * (r10.zzz) + (r16.xyz);
    r1.y = (r4.z) * (r1.y);
