// Mechanically reconstructed from 0xD1DB7395.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = 1.0f / (r6.w);
    r6.w = (r5.w) * (r6.w);
    r6.xyz = (r3.xyz) * (r3.www) + (-(r9.xyz));
    r11.x = 1.0f / (r3.w);
    r3.xyz = normalize(r6.xyz);
    r6.z = saturate(dot(r4.xyz, r3.xyz));
    r6.xy = (r1.ww) * (c3.xy) + (c3.zw);
    r3.y = saturate(dot(r3.xyz, r5.xyz));
    r3.z = exp2(r6.y);
    r3.w = 1.0f / (r6.x);
    r3.y = (-(r3.y)) + (c0.y);
    r5.z = pow(abs(r6.z), r3.z);
    r3.x = (r3.y) * (r3.y);
    r3.z = (r3.z) * (c4.x) + (c4.y);
    r3.x = (r3.x) * (r3.x);
    r3.z = (r5.z) * (r3.z);
    ...
    r3.z = (r6.w) * (r3.z);
    r1.xyz = (r7.xyz) * (r3.yyy) + (r8.xyz);
    r1.xyz = (r3.zzz) * (r1.xyz);
    r3.y = c0.z;
    r3.xyz = float3(((r2.w) >= 0.0f ? (c[20].x) : (r3.y)), ((r2.w) >= 0.0f ? (c[20].y) : (r3.y)), ((r2.w) >= 0.0f ? (c[20].w) : (r3.y)));
    r1.w = (r1.w) * (c0.w);
    ...
    r1.z = dot(c[10].yz, r11.xy) + (c[10].x);
    r2.xy = saturate((r11.xx) * (c[11].xy) + (c[11].zw));
    r1.xy = (r2.xy) * (r2.xy);
