// Mechanically reconstructed from 0x3C8133CC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r1.w) * (-(c1.y)) + (c1.z);
    r1.y = c0.z;
    r7.xyz = float3(((r3.z) >= 0.0f ? (c[6].x) : (r1.y)), ((r3.z) >= 0.0f ? (c[6].y) : (r1.y)), ((r3.z) >= 0.0f ? (c[6].w) : (r1.y)));
