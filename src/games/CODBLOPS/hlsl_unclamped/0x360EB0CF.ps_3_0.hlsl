// Mechanically reconstructed from 0x360EB0CF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r13.y = (r0.w) + (r0.w);
    r0.w = (r3.w) * (r6.w);
    r0.xyz = (r13.xyz) * (r2.www) + (r1.xyz);
    r2 = tex2D(s6, v0.xy);
    r11.xyz = lerp(r2.yyy, c[36].xyw, r12.www);
    ...
    r0.x = rsqrt(r0.z);
    r7.w = (r5.w) * (c2.w);
    r6.xyz = (r0.xxx) * (v5.xyz);
    r2.w = (r5.w) * (-(c4.z)) + (c4.w);
    r0.y = saturate(dot(r10.xyz, -(r6.xyz)));
    r0.z = (r2.z) * (r2.w) + (r7.w);
    r6.w = (r0.y) * (r2.w) + (r7.w);
    r7.xyz = (v5.xyz) * (-(r0.xxx)) + (c[17].xyz);
