// Mechanically reconstructed from 0xE08BF43F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c16 = float4(0.959999979f, 0.0399999991f, 1.0f, 0.5f);
    const float4 c30 = float4(3.5f, -13.0f, 1.0f, 13.0f);
    const float4 c31 = float4(2.0f, -1.0f, 0.0f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = (c31.xxxx) * (v8) + (c31.yyyy);
    r1.y = dot(r2.xy, r0.zw) + (c31.z);
    r1.x = dot(r2.xy, r0.xy) + (c31.z);
    r0 = tex2D(s1, v0.xy);
    r2.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r0 = tex2D(s5, v7.zw);
    r3.w = (r0.w) * (v7.y);
    r4.xy = lerp(r2.xy, r1.xy, r3.ww);
    r2.w = (r0.w) * (-(v7.y)) + (c31.w);
    r1 = tex2D(s0, v0.xy);
    r0.w = (r1.w) * (-(v7.x)) + (c31.w);
    r2.xyz = lerp(r1.xyz, r0.xyz, r3.www);
    r5.w = (r0.w) * (-(r2.w)) + (c31.w);
    r1 = tex2D(s7, v0.xy);
    r0 = tex2D(s8, v7.zw);
    r12.xy = lerp(r1.wy, r0.wy, r3.ww);
    r7.xyz = (r2.xyz) * (r2.xyz);
    r8.w = (r12.x) * (-(c4.z)) + (c4.w);
    r1.w = dot(r4.xy, r4.xy) + (c31.z);
    r1.xyz = (-(v6.xyz)) + (c[5].xyz);
    r0.z = dot(v6.xyz, v6.xyz);
    r0.w = dot(r1.xyz, r1.xyz);
    r6.z = rsqrt(r0.z);
    r0.w = rsqrt(r0.w);
    r9.xyz = (r6.zzz) * (v6.xyz);
    r0.xyz = v1.xyz;
    r0.xyz = (r4.xxx) * (v4.xyz) + (r0.xyz);
    r3.xyz = (r1.xyz) * (r0.www) + (-(r9.xyz));
    ...
    r2.z = (r2.z) * (r4.z) + (c13.x);
    r0.z = saturate(dot(r0.xyz, r1.xyz));
    r0.y = 1.0f / (r2.z);
    r0.x = (r0.w) * (r0.y);
    r13.xy = (r12.xx) * (c30.xy) + (c30.zw);
    r4.w = exp2(r13.y);
    r0.y = (-(r0.z)) + (c31.w);
    r0.z = pow(abs(r2.w), r4.w);
    r2.w = (r0.y) * (r0.y);
    r3.z = (r4.w) * (c13.y) + (c13.z);
    r2.w = (r2.w) * (r2.w);
    r0.z = (r0.z) * (r3.z);
    r0.y = (r0.y) * (r2.w);
    r0.z = (r0.x) * (r0.z);
    r0.x = (r0.y) * (c16.x) + (c16.y);
    r0.y = exp2(-(r1.w));
    r0.z = (r0.z) * (r0.x);
    r3.w = (r0.y) * (c1.x) + (c1.y);
    r0.xyz = (r0.zzz) * (c[7].xyz);
    r2.xyz = (r12.yyy) * (r0.xyz);
    r0.xyz = (r0.www) * (c[6].xyz);
    r5.xyz = (r7.xyz) * (r0.xyz) + (r2.xyz);
    r0.xy = (v0.zw) * (c16.zw);
    r2 = tex2D(s13, r0.xy);
    r0.xy = (v0.zw) * (c3.xy) + (c3.zy);
    r0 = tex2D(s13, r0.xy);
    r2.w = r0.y;
    r6.w = dot(r1.xyz, c[22].xyz);
    r6.xy = (r2.yw) * (c4.xx) + (c4.yy);
    r1 = tex2D(s14, v0.zw);
    r10.xy = (r1.xy) * (c3.ww);
    r0.w = dot(r6.xy, r4.xy) + (c31.z);
    r3.xy = (r2.xz) * (r10.xx);
    r0.y = (r1.x) * (c3.w) + (-(r3.x));
    r4.xy = (r0.xz) * (r10.yy);
    ...
    r1.z = (r0.w) * (r4.z) + (c13.x);
    r0.w = pow(abs(r1.y), r4.w);
    r1.z = 1.0f / (r1.z);
    r0.w = (r3.z) * (r0.w);
    r1.y = (r1.w) * (r1.z);
    r1.z = (r2.w) * (c16.x) + (c16.y);
    r0.w = (r0.w) * (r1.y);
    r0.xyz = (r6.xyz) * (r3.www) + (r0.xyz);
    r0.w = (r1.z) * (r0.w);
    r11.xyz = (r12.yyy) * (r0.xyz);
    r8.w = (r12.y) * (r0.w);
    r0 = tex2D(s12, v0.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c31.w) : (c31.z));
    ...
    r0 = (v6.zzzz) * (c[26]) + (r0);
    r1.w = saturate((r6.w) * (c[23].x) + (c[23].y));
    r3 = (r0) + (c[27]);
    ...
    r1.xy = (r1.xy) * (r1.xy);
    r1.w = ((-abs(r1.w)) >= 0.0f ? (c31.z) : (r1.z));
    r1.z = (r3.x) * (r1.x);
    r1.w = (r1.w) * (r1.z);
    r1.z = (r1.y) * (-(r3.y)) + (c31.w);
    r1.xy = (r2.ww) * (r2.xy);
    r1.w = (r1.w) * (r1.z);
    r2.w = (r3.z) * (r1.w);
    r1.xy = (r1.xy) * (c16.ww) + (c16.ww);
    r1 = tex2D(s4, r1.xy);
    r1.xyz = (r1.xyz) * (r1.xyz);
    r0.w = dot(r0, c13.zzzz);
    r0.xyz = (r2.www) * (r1.xyz);
    r1.xyz = (r6.xyz) * (c1.zzz) + (r7.xyz);
