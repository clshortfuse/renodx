// Mechanically reconstructed from 0x3CDEB9EE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c16 = float4(0.797884583f, 1.0f, 0.5f, 0.0f);
    ...
    r4.xy = lerp(r5.xy, r2.xy, r5.ww);
    r1 = tex2D(s8, v1.xy);
    r0 = tex2D(s9, v7.xy);
    r3.w = lerp(r1.y, r0.y, r5.w);
    r2 = tex2D(s5, v7.zw);
    r0.xyz = (r2.xyz) + (c14.yyy);
    r2.w = lerp(r1.w, r0.w, r5.w);
    r2.xyz = (v0.zzz) * (r0.xyz) + (c14.www);
    r0 = tex2D(s6, v8.xy);
    r6.w = (r0.w) * (v0.w);
    r0.xyz = (r3.xyz) * (-(r2.xyz)) + (r0.xyz);
    r7.xy = (r6.ww) * (-(r4.xy)) + (r4.xy);
    ...
    r4.w = (r0.w) * (c3.y) + (c3.z);
    r8.xyz = lerp(r3.www, c[34].xyw, r6.www);
    r0.xy = (v1.zw) * (c16.yz);
    r3 = tex2D(s13, r0.xy);
    r0.xy = (v1.zw) * (c16.yz) + (c16.wz);
    r0 = tex2D(s13, r0.xy);
    r3.w = r0.y;
    r1 = tex2D(s14, v1.zw);
    r4.xy = (r1.xy) * (c4.xx);
    ...
    r9.xy = (r3.xz) * (r4.xx);
    r0.w = dot(r6.xy, r7.xy) + (c14.z);
    r0.y = (r1.x) * (c4.x) + (-(r9.x));
    r1.w = (r3.z) * (-(r4.x)) + (r0.y);
    r3.xy = (r0.xz) * (r4.yy);
    r0.y = (r1.y) * (c4.x) + (-(r3.x));
    r0.x = dot(r6.xy, r6.xy) + (c14.z);
    r0.y = (r0.z) * (-(r4.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r11.y = (r1.w) + (r1.w);
    r0.z = (r0.z) * (c3.y) + (c3.z);
    ...
    r0.z = (r2.x) * (r0.x);
    r0.w = (r0.w) * (r0.z);
    r0.z = (r0.y) * (-(r2.y)) + (c14.w);
    r0.xy = (r1.zz) * (r1.xy);
    r0.w = (r0.w) * (r0.z);
    r5.w = (r1.w) * (r0.w);
    r0.xy = (r0.xy) * (c16.zz) + (c16.zz);
    r4 = tex2D(s3, r0.xy);
    r3 = (-(v6.yyyy)) + (c[6]);
    r2 = (-(v6.xxxx)) + (c[5]);
    r0 = (r3) * (r3);
