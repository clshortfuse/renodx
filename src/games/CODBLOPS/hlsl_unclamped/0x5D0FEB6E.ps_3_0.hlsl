// Mechanically reconstructed from 0x5D0FEB6E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = 1.0f / (r3.w);
    r11.z = (r11.w) * (r3.w);
    r11.xy = (r1.ww) * (c2.xy) + (c2.zw);
    r4.w = exp2(r11.y);
    r8.w = saturate(dot(r10.xyz, r2.xyz));
    r3.w = (r4.w) * (c3.x) + (c3.y);
    r2.z = pow(abs(r8.w), r4.w);
    r1.w = (r1.w) * (c0.w);
    r2.z = (r3.w) * (r2.z);
    r8.w = 1.0f / (r11.x);
    r2.z = (r11.z) * (r2.z);
    ...
    r12.yz = c0.yz;
    r11.xyz = float3(((r2.w) >= 0.0f ? (c[38].x) : (r12.z)), ((r2.w) >= 0.0f ? (c[38].y) : (r12.z)), ((r2.w) >= 0.0f ? (c[38].w) : (r12.z)));
