// Mechanically reconstructed from 0xEB048236.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c10 = float4(8.0f, 0.797884583f, 31.875f, 4.0f);
    ...
    r0.w = (r0.w) * (c4.z) + (c4.w);
    r0.y = exp2(-(r0.y));
    r8.xyz = lerp(r1.www, c[8].xyw, r9.www);
    r1.w = (r0.y) * (c4.z) + (c4.w);
    r0.y = dot(r1.xy, r4.xy) + (c3.z);
    r1.w = (r0.w) * (r1.w);
    r2 = tex2D(s14, v1.zw);
    r5.xy = (r2.xy) * (c10.zz);
    r1.w = saturate((r0.y) * (r1.w) + (r1.w));
    r1.xy = (r3.xz) * (r5.xx);
    r0.y = (r2.x) * (c10.z) + (-(r1.x));
    r3.xy = (r0.xz) * (r5.yy);
    r0.y = (r3.z) * (-(r5.x)) + (r0.y);
    r0.x = (r2.y) * (c10.z) + (-(r3.x));
    r0.z = (r0.z) * (-(r5.y)) + (r0.x);
    r6.y = (r0.y) + (r0.y);
    r0.y = (r0.z) + (r0.z);
    r0.xz = (r3.xy) * (c10.ww);
    ...
    r11.xyz = (r8.yyy) * (r0.xyz);
    r8.w = rsqrt(r0.w);
    r3.xyz = (v6.xyz) * (-(r8.www)) + (c[17].xyz);
    r0.xyz = v2.xyz;
    ...
    r1.w = c4.y;
    r2.y = (r1.y) * (r1.x);
    r0 = (r9.wwww) * (r0) + (r1.wwwz);
    r1.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c3.yyy));
    r5.xyz = (r0.xyz) * (r0.xyz);
    r0.y = (r0.w) * (-(c11.z)) + (c11.w);
    r12.xy = (r0.ww) * (c13.xy) + (c13.zw);
    r2.w = exp2(r12.y);
    r3.xyz = (r8.www) * (v6.xyz);
    r0.x = (r0.w) * (c10.y);
    r1.w = saturate(dot(r9.xyz, -(r3.xyz)));
    r0.z = (r6.w) * (r0.y) + (r0.x);
    r0.y = (r1.w) * (r0.y) + (r0.x);
    r0.x = pow(abs(r7.w), r2.w);
    r0.z = (r0.z) * (r0.y) + (c12.x);
    r0.y = (r2.w) * (c12.y) + (c12.z);
    r0.z = 1.0f / (r0.z);
    r2.w = (r0.x) * (r0.y);
    r2.z = (r6.w) * (r0.z);
    r0.xyz = (r1.xyz) * (r2.yyy) + (r5.xyz);
    r2.w = (r2.w) * (r2.z);
