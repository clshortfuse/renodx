// Mechanically reconstructed from 0x83B2EAFC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2Dproj(s2, r1);
    r0.w = r1.x;
    r8.xyz = (r2.xyz) * (c[32].yyy);
    r2.w = dot(r0, c3.zzzz);
    r0 = tex2D(s12, v1.zw);
    r9.xyz = (-(v7.xyz)) + (c[24].xyz);
    ...
    r1.x = 1.0f / (r3.w);
    r1.z = dot(c[29].yz, r1.xy) + (c[29].x);
    r1.xy = saturate((r1.xx) * (c[30].xy) + (c[30].zw));
    r0.xy = (r1.xy) * (r1.xy);
    ...
    r4.xyz = (v0.yyy) * (r2.xyz) + (c1.yyy);
    r0.xyz = (r5.www) * (r0.xyz) + (r8.xyz);
    ...
    r1.w = (r2.w) * (r2.w);
    r9.w = saturate(dot(r6.xyz, r1.xyz));
    r3.w = (r1.w) * (r1.w);
    r1 = tex2D(s7, v1.xy);
