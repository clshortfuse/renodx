// Mechanically reconstructed from 0x9B8457E6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.y = dot(r4.xy, r0.zw) + (c3.z);
    r1.x = dot(r4.xy, r0.xy) + (c3.z);
    r0 = tex2D(s3, v7.zw);
    r4.w = (r0.w) * (v7.y) + (c3.w);
    r5.w = (r1.w) * (r1.z);
    r4.xy = float2(((r4.w) >= 0.0f ? (r1.x) : (r2.x)), ((r4.w) >= 0.0f ? (r1.y) : (r2.y)));
    r1 = tex2D(s0, v0.xy);
    r1.xyz = float3(((r4.w) >= 0.0f ? (r0.x) : (r1.x)), ((r4.w) >= 0.0f ? (r0.y) : (r1.y)), ((r4.w) >= 0.0f ? (r0.z) : (r1.z)));
    r0.xy = (v0.zw) * (-(c3.yw)) + (-(c3.zw));
    r0 = tex2D(s13, r0.xy);
    r2.xy = (v0.zw) * (-(c3.yw));
    r2 = tex2D(s13, r2.xy);
    r0.w = r2.y;
    ...
    r0.y = dot(r4.xy, r4.xy) + (c3.z);
    r0.w = dot(r1.xy, r1.xy) + (c3.z);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r2.w = (r0.y) * (c4.x) + (c4.y);
    r0.y = (r0.w) * (c4.x) + (c4.y);
    r0.w = dot(r1.xy, r4.xy) + (c3.z);
    r0.y = (r2.w) * (r0.y);
    r1 = tex2D(s14, v0.zw);
    r6.xy = (r1.xy) * (c4.ww);
    ...
    r4.xyz = (r7.xyz) * (r2.www) + (r1.xyz);
    r12.xyz = normalize(r0.xyz);
    r5.z = saturate(dot(r12.xyz, r3.xyz));
    r13.xyz = (r3.www) * (v6.xyz);
    r2 = tex2D(s5, v0.xy);
    r3 = (r2.wwww) * (c0.xxxy) + (c0.zzzx);
    r1 = tex2D(s6, v7.zw);
    ...
    r1.z = (r1.z) * (r1.y);
    r11.xyz = float3(((r4.w) >= 0.0f ? (c[5].x) : (r2.y)), ((r4.w) >= 0.0f ? (c[5].y) : (r2.y)), ((r4.w) >= 0.0f ? (c[5].w) : (r2.y)));
