// Mechanically reconstructed from 0x9DDC0489.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = lerp(r6.xy, r2.xy, r0.ww);
    r1.w = dot(r5.xy, r5.xy) + (c2.z);
    r1.y = dot(r4.xy, r4.xy) + (c2.z);
    r1.w = exp2(-(r1.w));
    r1.y = exp2(-(r1.y));
    r1.w = (r1.w) * (c3.x) + (c3.y);
    r4.w = (r1.y) * (c3.x) + (c3.y);
    ...
    r9.xy = (r0.ww) * (r1.xy) + (c[23].xy);
    r5.w = (r1.w) + (r1.w);
    r3 = tex2D(s5, v1.xy);
    r2 = tex2D(s6, v6.xy);
    r1 = lerp(r3, r2, r0.wwww);
    r2.xyz = (r8.xyz) * (-(r5.www)) + (r4.xyz);
    r2.w = (r1.w) * (c2.w);
    ...
    r6.xyz = (r9.yyy) * (r2.xyz);
    r1.xyz = (r5.xyz) * (r1.xyz);
    r6.w = dot(c[20].xyz, r4.xyz);
    r7.xyz = (r1.xyz) * (c2.www);
    r1 = tex2D(s0, v1.xy);
    r9.xyz = lerp(r1.xyz, r0.xyz, r0.www);
    r5 = tex2D(s3, v6.zw);
    r3 = (-(v5.yyyy)) + (c[6]);
    r0 = (r3) * (r3);
    r2 = (-(v5.xxxx)) + (c[5]);
