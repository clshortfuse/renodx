// Mechanically reconstructed from 0xBF7C341A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c27 = float4(0.00048828125f, -0.000122070312f, 0.0f, 0.0f);
    const float4 c28 = float4(4.0f, -3.0f, 0.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r1.xyw = c[23].xyw;
    r1.xyz = (-(r1.xyw)) + (c[24].xyw);
    r1.xyz = (r6.www) * (r1.xyz) + (c[23].xyw);
    r1.w = dot(r5.xy, r5.xy) + (c4.z);
    r13.xyz = lerp(r1.xyz, c[25].xyw, r4.www);
    r1.w = exp2(-(r1.w));
    r4.w = (r1.w) * (c3.x) + (c3.y);
    r1.xy = (v1.zw) * (c12.xy);
    r3 = tex2D(s13, r1.xy);
