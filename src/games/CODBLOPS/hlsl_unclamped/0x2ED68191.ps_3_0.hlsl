// Mechanically reconstructed from 0x2ED68191.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = (-(v5.zzzz)) + (c[7]);
    r0 = (r1) * (r1) + (r0);
    r5.xyz = float3(((r4.w) >= 0.0f ? (r4.x) : (r5.x)), ((r4.w) >= 0.0f ? (r4.y) : (r5.y)), ((r4.w) >= 0.0f ? (r4.z) : (r5.z)));
    r4.x = rsqrt(r0.x);
    r4.y = rsqrt(r0.y);
    r4.z = rsqrt(r0.z);
    r4.w = rsqrt(r0.w);
