// Mechanically reconstructed from 0x4F5770D6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xy = (r1.ww) * (r2.xy) + (c[8].xy);
    r4.xy = -(r7.xy);
    r2.xyz = v2.xyz;
    r2.xyz = (r8.xxx) * (v4.xyz) + (r2.xyz);
    r4.z = (r4.y) + (c1.w);
    r5.xyz = (r8.yyy) * (v3.xyz) + (r2.xyz);
    r2.xyz = normalize(r5.xyz);
    r5.xyz = normalize(v5.xyz);
    r8.xy = (r5.ww) * (r4.xz) + (r7.xy);
