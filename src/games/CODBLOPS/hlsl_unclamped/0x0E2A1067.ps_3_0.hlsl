// Mechanically reconstructed from 0x0E2A1067.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.z = rsqrt(r0.w);
    r1.z = c0.y;
    r3.xy = (r1.xy) * (c[44].xx) + (r1.zz);
    r0 = tex2D(s0, v1.xy);
    r2.xyz = (r0.xyz) * (v0.xyz);
    r0 = tex2D(s7, r3.xy);
    r0.xyz = (r2.xyz) * (-(r2.xyz)) + (r0.xyz);
    r0.w = (r0.w) + (c3.z);
    r1.xy = (r1.xy) * (c[43].xx) + (r1.zz);
    r1 = tex2D(s6, r1.xy);
    ...
    r3.w = (r8.y) * (c13.x) + (c13.y);
    r2.w = (r12.w) * (r2.w);
    r3.z = (r3.z) * (r3.w);
    r8.z = (r11.x) * (r3.z);
    r3.z = (r10.w) * (r11.z) + (r11.y);
    r3.z = (r3.z) * (r11.w) + (c4.w);
