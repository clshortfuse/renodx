// Mechanically reconstructed from 0xB2122E16.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s1, v1.xy);
    r1.xyz = (r0.wwy) * (c0.zyy) + (c0.wzz);
    r0 = tex2D(s0, v1.xy);
    r1.w = (r0.w) * (v0.w) + (c0.x);
    r0 = (r0.xyzx) * (c0.yyyz) + (c0.zzzy);
    r2.xyz = float3(((r1.w) >= 0.0f ? (r1.x) : (c0.z)), ((r1.w) >= 0.0f ? (r1.y) : (c0.y)), ((r1.w) >= 0.0f ? (r1.z) : (c0.z)));
