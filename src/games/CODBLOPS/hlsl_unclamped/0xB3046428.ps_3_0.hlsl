// Mechanically reconstructed from 0xB3046428.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = (r0.w) * (v0.w) + (c0.x);
    r0.w = rsqrt(r1.w);
    r2.xy = float2(((r3.w) >= 0.0f ? (r1.x) : (c0.z)), ((r3.w) >= 0.0f ? (r1.y) : (c0.z)));
    r5.xyz = (r0.www) * (v6.xyz);
    r1 = v2;
    r1.xyz = (r2.xxx) * (v5.xyz) + (r1.xyz);
    r4.xyz = (v6.xyz) * (-(r0.www)) + (c[17].xyz);
    ...
    r3.z = saturate(dot(r10.xyz, -(r5.xyz)));
    r1.x = (r2.w) * (c2.y);
    r1.y = (r2.w) * (-(c2.y)) + (c2.z);
    r1.z = dot(r10.xyz, c[17].xyz);
    r3.y = (r3.z) * (r1.y) + (r1.x);
    r4.w = saturate(r1.z);
    r6.w = (-(r3.z)) + (c0.y);
    r3.z = (r4.w) * (r1.y) + (r1.x);
    r1.xyz = (abs(r1.zzz)) * (c[18].xyz);
    r3.z = (r3.z) * (r3.y) + (c2.w);
    r5.w = 1.0f / (r3.z);
    r3.xyz = normalize(r4.xyz);
    r4.w = (r4.w) * (r5.w);
    r5.w = saturate(dot(r10.xyz, r3.xyz));
    r4.y = saturate(dot(r3.xyz, c[17].xyz));
    ...
    r2.w = (r2.w) * (c0.w);
    r2.xyz = (r9.xyz) * (r3.yyy) + (r11.xyz);
    r2.xyz = (r3.zzz) * (r2.xyz);
    r12.yz = c0.yz;
    r7.xyz = float3(((r3.w) >= 0.0f ? (c[21].x) : (r12.z)), ((r3.w) >= 0.0f ? (c[21].y) : (r12.z)), ((r3.w) >= 0.0f ? (c[21].w) : (r12.z)));
    ...
    r3.z = dot(r5.xyz, r10.xyz);
    r2.xyz = (r2.xyz) * (c2.xxx);
    r4.w = (r3.z) + (r3.z);
    r3.xyz = (r3.www) * (r1.xyz) + (r2.xyz);
    r2.xyz = (r10.xyz) * (-(r4.www)) + (r5.xyz);
