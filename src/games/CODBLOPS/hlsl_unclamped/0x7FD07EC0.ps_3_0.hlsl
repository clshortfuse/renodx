// Mechanically reconstructed from 0x7FD07EC0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = dot(r5.xy, r3.xy) + (c3.z);
    r0.y = dot(r5.xy, r3.zw) + (c3.z);
    r5 = tex2D(s3, v6.zw);
    r7.w = (r5.w) * (v0.z);
    r0.z = dot(r7.xy, r7.xy) + (c3.z);
    r8.xy = lerp(r2.xy, r0.xy, r7.ww);
    r0.y = exp2(-(r0.z));
    ...
    r5.w = (r1.y) * (c4.x) + (c4.y);
    r1.y = (r1.w) * (r5.w);
    r1.w = dot(r7.xy, r8.xy) + (c3.z);
    r3 = tex2D(s14, v1.zw);
    r2.xy = (r3.xy) * (c12.xx);
    r3.w = saturate((r1.w) * (r1.y) + (r1.y));
    r6.xy = (r6.xz) * (r2.yy);
    r1.w = (r3.y) * (c12.x) + (-(r6.x));
    r7.xz = (r6.xy) * (c12.yy);
    r1.w = (r6.z) * (-(r2.y)) + (r1.w);
    r1.xy = (r1.xz) * (r2.xx);
    r7.y = (r1.w) + (r1.w);
