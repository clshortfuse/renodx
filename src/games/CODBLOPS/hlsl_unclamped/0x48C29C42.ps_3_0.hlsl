// Mechanically reconstructed from 0x48C29C42.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(-0.5f, 0.797884583f, 1.0f, 0.0009765625f);
    ...
    r1 = (c1.xxxx) * (v6) + (c1.yyyy);
    r2.x = dot(r4.xy, r1.xy) + (c1.w);
    r2.y = dot(r4.xy, r1.zw) + (c1.w);
    r1 = tex2D(s3, v5.zw);
    r5.w = (r1.w) * (v5.y) + (c2.x);
    r3.xy = float2(((r5.w) >= 0.0f ? (r2.x) : (r3.x)), ((r5.w) >= 0.0f ? (r2.y) : (r3.y)));
    r2.xyz = (r0.xyz) * (r0.xyz);
    r0.xyz = v3.xyz;
    r0.xyz = (r3.xxx) * (r0.xyz) + (v1.xyz);
    r5.xyz = (r2.www) * (r2.xyz);
    r0.xyz = (r3.yyy) * (v2.xyz) + (r0.xyz);
    ...
    r4 = tex2D(s0, v0.xy);
    r3 = tex2D(s5, v0.xy);
    r2.xyz = lerp(r4.xyz, c1.zzz, r3.xxx);
    ...
    r2.z = rsqrt(r1.w);
    r2.x = (r0.w) * (c2.y);
    r4.xyz = (r8.xyz) * (r2.zzz);
    r1.w = (r0.w) * (-(c2.y)) + (c2.z);
    r2.w = saturate(dot(r4.xyz, r7.xyz));
    r2.y = (r6.w) * (r1.w) + (r2.x);
    r1.w = (r2.w) * (r1.w) + (r2.x);
    r3.xyz = float3(((r5.w) >= 0.0f ? (r1.x) : (r3.x)), ((r5.w) >= 0.0f ? (r1.y) : (r3.y)), ((r5.w) >= 0.0f ? (r1.z) : (r3.z)));
    r1.w = (r1.w) * (r2.y) + (c2.w);
    ...
    r0.w = exp2(r0.w);
    r2.w = (-(r2.w)) + (-(c1.y));
    r3.w = pow(abs(r4.w), r0.w);
    r2.z = (r2.w) * (r2.w);
    r0.w = (r0.w) * (c3.z) + (c3.w);
    r2.z = (r2.z) * (r2.z);
    r2.w = (r2.w) * (r2.z);
    r2.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c1.yyy));
    r0.w = (r3.w) * (r0.w);
