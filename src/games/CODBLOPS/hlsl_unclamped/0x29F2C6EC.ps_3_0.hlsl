// Mechanically reconstructed from 0x29F2C6EC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = 1.0f / (r1.w);
    r7.xyz = (r0.xyz) * (r3.www) + (-(r3.xyz));
    r3.w = (r0.w) * (r1.w);
    r3.xyz = (r0.www) * (c[6].xyz);
    r0.xyz = normalize(r7.xyz);
    r4.w = saturate(dot(r6.xyz, r0.xyz));
    r1.w = (r2.w) * (c2.y) + (c2.z);
    r0.w = saturate(dot(r0.xyz, r1.xyz));
    r1.w = exp2(r1.w);
    r0.x = pow(abs(r4.w), r1.w);
    r0.w = (-(r0.w)) + (c1.z);
    r0.y = (r1.w) * (c3.x) + (c3.y);
    r0.z = (r0.w) * (r0.w);
    r1.w = (r0.x) * (r0.y);
