// Mechanically reconstructed from 0xD99FF2D5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r1.w) * (r2.w);
    r1.w = (r6.w) * (r1.w);
    r6.w = max(abs(r10.y), abs(r10.z));
    r8.xyz = (r1.xyz) * (r1.www);
    r1.w = max(abs(r10.x), r6.w);
    r1.w = 1.0f / (r1.w);
