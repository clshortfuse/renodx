// Mechanically reconstructed from 0x298D968A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s4, v6.zw);
    r2.w = (r2.w) * (v6.y) + (c1.x);
    r3.xyz = (r4.xyz) * (r5.www) + (r3.xyz);
    r11.xy = float2(((r2.w) >= 0.0f ? (r0.w) : (r1.w)), ((r2.w) >= 0.0f ? (r0.y) : (r1.y)));
    ...
    r1.xyz = (r6.xyz) * (-(r1.www)) + (r2.xyz);
    r8.xyz = (r8.xyz) * (r9.www) + (-(r2.xyz));
    r1.w = (r11.x) * (c2.x);
