// Mechanically reconstructed from 0x7C56FC85.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = (r1.w) * (c2.x);
    r5.w = (r1.w) * (-(c2.x)) + (c2.y);
    r12.w = saturate(dot(r0.xyz, c[17].xyz));
    r4.w = (r2.z) * (r5.w) + (r6.w);
    r2.y = (r12.w) * (r5.w) + (r6.w);
