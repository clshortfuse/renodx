// Mechanically reconstructed from 0x6319A93F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = saturate((r1.z) * (c3.x) + (c3.x));
    r3.x = c1.x;
    r2.w = lerp(c[33].x, -(r3.x), r1.z);
    r1.z = (r1.z) + (c3.w);
    r3.x = pow(abs(r0.w), r2.w);
    r1.xyw = (r1.xyw) * (r3.xxx);
