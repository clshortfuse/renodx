// Mechanically reconstructed from 0xC6173543.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = (r7.w) * (r12.w) + (r12.z);
    r11.x = (r0.w) * (r12.w) + (r12.z);
    r0.y = (r0.y) * (r0.y);
    r0.z = (r0.z) * (r11.x) + (c13.z);
    r9.w = (r2.w) * (r0.y);
    r0.z = 1.0f / (r0.z);
    r3.w = (r7.w) * (r0.z);
    r0.z = (-(r0.w)) + (c1.w);
