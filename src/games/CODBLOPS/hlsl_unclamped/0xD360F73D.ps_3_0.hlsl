// Mechanically reconstructed from 0xD360F73D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.y = (r1.z) + (r1.z);
    r5.zw = c15.zw;
    r1.xyz = (r5.zwz) + (-(c[34].xyw));
    r5.xyz = (r9.xyz) * (r1.www) + (r3.xyz);
    r11.xyz = (r0.www) * (r1.xyz) + (c[34].xyw);
    r1 = tex2D(s0, v1.xy);
    r2 = tex2D(s4, v6.zw);
    r3.xyz = (r2.xyz) + (c15.yyy);
    r2.xyz = lerp(r1.xyz, r0.xyz, r0.www);
    r3.xyz = (v0.zzz) * (r3.xyz) + (c15.www);
    r0 = tex2D(s5, v7.xy);
    r1.xyz = (r0.xyz) + (c15.yyy);
    r0.xyz = (r2.xyz) * (r3.xyz);
    r1.xyz = (v0.www) * (r1.xyz) + (c15.www);
    ...
    r1.y = dot(c[10], r0);
    r1.z = dot(c[11], r0);
    r0.w = saturate((c[33].y) * (r6.w) + (c[33].x));
    r0.xyz = c[0].xyz;
