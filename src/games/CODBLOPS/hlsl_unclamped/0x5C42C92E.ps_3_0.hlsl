// Mechanically reconstructed from 0x5C42C92E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xyz = float3(((r3.z) >= 0.0f ? (r0.x) : (r1.x)), ((r3.z) >= 0.0f ? (r0.y) : (r1.y)), ((r3.z) >= 0.0f ? (r0.z) : (r1.z)));
    r0 = tex2D(s4, v8.zw);
    r4.w = (r0.w) * (v0.z);
    r8.xyz = lerp(r1.xyz, r0.xyz, r4.www);
    r0.xy = (v1.zw) * (c4.xy);
    r2 = tex2D(s13, r0.xy);
    ...
    r1.yz = c1.yz;
    r3.xyz = float3(((r3.z) >= 0.0f ? (r1.y) : (c[5].x)), ((r3.z) >= 0.0f ? (r1.z) : (c[5].y)), ((r3.z) >= 0.0f ? (r1.y) : (c[5].w)));
    ...
    r1.z = (r1.z) * (r1.y);
    r11.xyz = lerp(r3.xyz, c1.zzz, r4.www);
