// Mechanically reconstructed from 0x2FE45A2B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s5, v7.xy);
    r6.w = (r0.w) * (v0.y) + (c3.w);
    r4.xy = float2(((r6.w) >= 0.0f ? (r1.x) : (r2.x)), ((r6.w) >= 0.0f ? (r1.y) : (r2.y)));
    r1 = tex2D(s8, v7.zw);
    r2.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r1 = (c3.xxxx) * (v9) + (c3.yyyy);
    r3.y = dot(r2.xy, r1.zw) + (c3.z);
    r3.x = dot(r2.xy, r1.xy) + (c3.z);
    r1 = tex2D(s0, v1.xy);
    r1.xyz = float3(((r6.w) >= 0.0f ? (r0.x) : (r1.x)), ((r6.w) >= 0.0f ? (r0.y) : (r1.y)), ((r6.w) >= 0.0f ? (r0.z) : (r1.z)));
    r0 = tex2D(s6, v7.zw);
    r4.w = (r0.w) * (v0.z);
    ...
    r1 = tex2D(s9, v1.xy);
    r0 = tex2D(s10, v7.xy);
    r3 = float4(((r6.w) >= 0.0f ? (r0.x) : (r1.x)), ((r6.w) >= 0.0f ? (r0.y) : (r1.y)), ((r6.w) >= 0.0f ? (r0.z) : (r1.z)), ((r6.w) >= 0.0f ? (r0.w) : (r1.w)));
    r0.w = dot(r10.xy, r10.xy) + (c3.z);
    r5.xyz = (r2.xyz) * (r2.xyz);
    r0.w = exp2(-(r0.w));
    r4.z = (r0.w) * (c12.x) + (c12.y);
    ...
    r2 = (r1.wwww) * (c4.xxxy) + (c4.zzzx);
    r8.xyz = (r0.xyz) * (r0.www) + (-(r6.xyz));
    ...
    r1.z = (r1.w) * (r1.w);
    r5.w = dot(r8.xyz, c[29].xyz);
    r1.z = (r1.z) * (r1.z);
    r3.w = (r1.w) * (r1.z);
    r2.xyz = v2.xyz;
    r3.xyz = (r10.xxx) * (v4.xyz) + (r2.xyz);
    r2.xyw = c[40].xyw;
    r2.xyz = float3(((r6.w) >= 0.0f ? (r2.x) : (c[39].x)), ((r6.w) >= 0.0f ? (r2.y) : (c[39].y)), ((r6.w) >= 0.0f ? (r2.w) : (c[39].w)));
    r3.xyz = (r10.yyy) * (v3.xyz) + (r3.xyz);
    r12.w = (r0.w) * (c12.z);
    r10.xyz = normalize(r3.xyz);
    r6.w = saturate(dot(r8.xyz, r10.xyz));
    r1.w = saturate(dot(r10.xyz, -(r6.xyz)));
    r1.z = (r6.w) * (r11.w) + (r12.w);
    r10.w = (r1.w) * (r11.w) + (r12.w);
    r15.xyz = (r0.xyz) * (r0.xyz);
    r0.z = (r1.z) * (r10.w) + (c15.x);
    r0.y = 1.0f / (r0.z);
    r3.xy = (r0.ww) * (c43.xy) + (c43.zw);
    r9.w = exp2(r3.y);
    r1.z = saturate(dot(r10.xyz, r7.xyz));
    r0.z = pow(abs(r1.z), r9.w);
    r7.w = (r9.w) * (c15.y) + (c15.z);
    r1.x = (r6.w) * (r0.y);
    r1.z = (r0.z) * (r7.w);
    r0.xyz = (r14.xyz) * (r3.www) + (r15.xyz);
    r1.z = (r1.x) * (r1.z);
    r13.xyz = lerp(r2.xyz, r1.yyy, r4.www);
