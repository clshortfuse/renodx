// Mechanically reconstructed from 0xAC892323.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c4 = float4(1.0f, 0.5f, 0.0f, 0.25f);
    ...
    r11.xy = float2(((r5.w) >= 0.0f ? (r2.w) : (r3.w)), ((r5.w) >= 0.0f ? (r2.y) : (r3.y)));
    r0.z = (r0.z) + (r0.z);
