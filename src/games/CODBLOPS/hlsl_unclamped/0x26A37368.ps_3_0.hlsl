// Mechanically reconstructed from 0x26A37368.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.x = dot(r6.xy, r0.xy) + (c14.z);
    r3.y = dot(r6.xy, r0.zw) + (c14.z);
    r0 = tex2D(s3, v6.xy);
    r4.w = (r0.w) * (v0.y);
    r6.xy = (r2.yw) * (c4.xx) + (c4.yy);
    r7.xy = lerp(r8.xy, r3.xy, r4.ww);
    ...
    r3.y = (r1.w) + (r1.w);
    r1.zw = c14.zw;
    r4.xyz = (r1.zwz) + (-(c[31].xyw));
    r2.xyz = (r3.xyz) * (r0.www) + (r6.xyz);
    r9.xyz = (r4.www) * (r4.xyz) + (c[31].xyw);
