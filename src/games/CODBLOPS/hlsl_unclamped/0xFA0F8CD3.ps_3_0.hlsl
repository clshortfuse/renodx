// Mechanically reconstructed from 0xFA0F8CD3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(0.25f, 0.959999979f, 0.0399999991f, 0.797884583f);
    ...
    r3 = tex2D(s8, v1.xy);
    r0 = tex2D(s9, v7.xy);
    r5.z = lerp(r3.w, r0.w, r7.w);
    r0 = tex2D(s5, v7.zw);
    r3.w = (r0.w) * (v0.z) + (c1.w);
    r0.w = (r4.w) * (r2.w) + (-(c1.y));
    r8.xyz = float3(((r3.w) >= 0.0f ? (r2.x) : (r5.x)), ((r3.w) >= 0.0f ? (r2.y) : (r5.y)), ((r3.w) >= 0.0f ? (r2.z) : (r5.z)));
    r4.xyz = (r4.xyz) * (r0.www);
    r2.xyz = v4.xyz;
    r2.xyz = (r8.xxx) * (r2.xyz) + (v2.xyz);
    ...
    r1.w = (r1.w) * (c2.y) + (c2.z);
    r0.xyz = float3(((r3.w) >= 0.0f ? (r0.x) : (r6.x)), ((r3.w) >= 0.0f ? (r0.y) : (r6.y)), ((r3.w) >= 0.0f ? (r0.z) : (r6.z)));
    r0.w = (r0.w) * (r1.w);
