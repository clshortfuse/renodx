// Mechanically reconstructed from 0xCCF26C1F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r9.w) * (r11.z) + (r11.y);
    r1.w = (r1.w) * (r11.w) + (c4.w);
    r4.y = saturate(dot(r9.xyz, r4.xyz));
    r4.z = 1.0f / (r1.w);
    r1.w = pow(abs(r4.y), r10.w);
    r4.z = (r9.w) * (r4.z);
    r1.w = (r8.w) * (r1.w);
    r1.w = (r4.z) * (r1.w);
    r4.xyz = (r5.xyz) * (r6.www) + (r7.xyz);
    ...
    r1 = (v7.yyyy) * (c[32]);
    r7.xyz = (r3.xyz) * (c1.www) + (r4.xyz);
    r1 = (v7.xxxx) * (c[31]) + (r1);
    r2.xyz = (r2.xyz) * (r3.www);
    r1 = (v7.zzzz) * (c[33]) + (r1);
    r2.xyz = (r2.xyz) * (c[22].xyz);
    r4 = (r1) + (c[34]);
    r2.xyz = (r2.xyz) * (c[36].www);
    r3.zw = r4.zw;
