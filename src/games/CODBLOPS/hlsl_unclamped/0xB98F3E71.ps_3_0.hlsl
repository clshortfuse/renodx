// Mechanically reconstructed from 0xB98F3E71.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.y = dot(r2.xy, r0.zw) + (c16.w);
    r1 = tex2D(s3, v7.xy);
    r1.xyz = (r1.xyz) + (c16.yyy);
    r5.x = dot(r2.xy, r0.xy) + (c16.w);
    r1.xyz = (v0.yyy) * (r1.xyz) + (c16.zzz);
    r2 = tex2D(s6, v1.xy);
    ...
    r1.w = r3.y;
    r5.w = (r0.w) * (-(c4.x)) + (c4.y);
    r2.xy = (r1.wy) * (c11.yy) + (c11.zz);
    r1.y = dot(r5.xy, r5.xy) + (c16.w);
    r1.w = dot(r2.xy, r2.xy) + (c16.w);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r3.w = (r1.y) * (c3.y) + (c3.z);
    r1.y = (r1.w) * (c3.y) + (c3.z);
    r1.w = dot(r2.xy, r5.xy) + (c16.w);
    r1.y = (r3.w) * (r1.y);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c11.xx);
    r1.w = saturate((r1.w) * (r1.y) + (r1.y));
    r3.xy = (r3.xz) * (r7.xx);
    r1.y = (r2.x) * (c11.x) + (-(r3.x));
    r6.xy = (r1.xz) * (r7.yy);
    r1.y = (r3.z) * (-(r7.x)) + (r1.y);
    r1.x = (r2.y) * (c11.x) + (-(r6.x));
    r1.z = (r1.z) * (-(r7.y)) + (r1.x);
    r7.y = (r1.y) + (r1.y);
    r1.y = (r1.z) + (r1.z);
    r2.xyz = v2.xyz;
    ...
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c16.z) : (c16.w));
