// Mechanically reconstructed from 0x10EE0AED.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.yz = c1.yz;
    r3.xyz = float3(((r5.w) >= 0.0f ? (r12.y) : (c[25].x)), ((r5.w) >= 0.0f ? (r12.z) : (c[25].y)), ((r5.w) >= 0.0f ? (r12.y) : (c[25].w)));
    r1 = tex2D(s3, v7.zw);
    ...
    r6.xy = (r4.xy) * (r6.xy);
    r4.xyz = float3(((r4.w) >= 0.0f ? (c1.y) : (r3.x)), ((r4.w) >= 0.0f ? (c1.z) : (r3.y)), ((r4.w) >= 0.0f ? (c1.y) : (r3.z)));
    r0.w = (r0.w) * (r6.x);
