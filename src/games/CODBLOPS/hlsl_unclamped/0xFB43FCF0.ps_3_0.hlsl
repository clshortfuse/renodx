// Mechanically reconstructed from 0xFB43FCF0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = (r6.xyz) * (r6.xyz) + (r9.xyz);
    r2.xyz = (r0.xyz) * (c[5].xxx);
    r0.xyz = (r1.xyz) * (r7.xyz) + (r8.xyz);
