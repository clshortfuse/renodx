// Mechanically reconstructed from 0x9AF9F258.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.x = rsqrt(r2.y);
    r10.xyz = (r5.xyz) * (r2.xxx);
    r8.xyz = normalize(v6.xyz);
    r3.z = saturate(dot(r6.xyz, r10.xyz));
    r4.w = saturate(dot(r6.xyz, -(r8.xyz)));
    r0.w = (r3.z) * (r9.w) + (r10.w);
    ...
    r12.z = (-(r4.w)) + (c1.y);
    r4.w = (r3.z) * (r3.x);
    r9.xyz = (r3.zzz) * (c[30].xyz);
    r12.xy = (r2.ww) * (c4.xy) + (c4.zw);
    r12.w = exp2(r12.y);
    r11.xyz = (r5.xyz) * (r2.xxx) + (-(r8.xyz));
    r6.w = 1.0f / (r12.x);
    r5.xyz = normalize(r11.xyz);
    r11.w = (r12.w) * (c12.x) + (c12.y);
    r3.z = saturate(dot(r5.xyz, r10.xyz));
    r2.x = 1.0f / (r2.x);
    r3.z = (-(r3.z)) + (c1.y);
    r5.z = saturate(dot(r6.xyz, r5.xyz));
    r5.w = (r3.z) * (r3.z);
    r3.x = pow(abs(r5.z), r12.w);
    r5.w = (r5.w) * (r5.w);
    r3.x = (r11.w) * (r3.x);
    r3.z = (r3.z) * (r5.w);
    r7.w = (r2.z) * (r2.z);
    ...
    r3.xy = saturate((r2.xx) * (c[33].xy) + (c[33].zw));
    r2.xy = (r3.xy) * (r3.xy);
    ...
    r6.w = (r6.w) * (r2.w);
    r7.z = saturate(dot(r6.xyz, r3.xyz));
    r2.w = saturate(dot(r4.xyz, r6.xyz));
    r3.w = pow(abs(r7.z), r12.w);
