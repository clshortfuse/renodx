// Mechanically reconstructed from 0x60E6630E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = (r3.w) * (r3.z) + (c4.w);
    r3.w = 1.0f / (r3.w);
    r6.xyz = (r6.xyz) * (r4.www) + (-(r12.xyz));
    r4.w = (r0.w) * (r3.w);
    r3.xyz = normalize(r6.xyz);
    r6.xyz = (r0.www) * (c[21].xyz);
    r7.z = saturate(dot(r9.xyz, r3.xyz));
    ...
    r7.xyz = float3(((r5.w) >= 0.0f ? (c[41].x) : (r2.x)), ((r5.w) >= 0.0f ? (c[41].y) : (r2.y)), ((r5.w) >= 0.0f ? (c[41].w) : (r2.z)));
    r2.xy = (v1.zw) * (-(c2.yw));
    r2 = tex2D(s13, r2.xy);
