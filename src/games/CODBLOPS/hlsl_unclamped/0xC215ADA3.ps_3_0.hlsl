// Mechanically reconstructed from 0xC215ADA3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xyz = v2.xyz;
    r5.xyz = (r9.xxx) * (v4.xyz) + (r2.xyz);
    r2.xyz = -(r3.xyz);
    r5.xyz = (r9.yyy) * (v3.xyz) + (r5.xyz);
    r2.w = (r2.y) + (c15.w);
    r10.xyz = normalize(r5.xyz);
    r11.xyz = (r12.www) * (r2.xwz) + (r3.xyz);
