// Mechanically reconstructed from 0x027DAA2C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r3.w) * (r1.w);
    r3.w = (r2.z) * (c1.x) + (c1.y);
    r2.z = saturate((r4.z) * (c[31].x) + (c[31].y));
    r2.x = dot(r0.xyz, r10.xyz);
    r2.y = (r2.z) * (c13.z) + (c13.w);
    r2.x = (r2.x) + (r2.x);
    r2.z = (r2.z) * (r2.z);
    r0.xyz = (r10.xyz) * (-(r2.xxx)) + (r0.xyz);
    r0 = texCUBElod(s15, r0);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r6.w = (r2.y) * (r2.z);
    r3.xyz = (r0.xyz) * (c0.xxx);
    r0 = tex3D(s11, v6.xyz);
    r4.xyz = (v5.xyz) * (-(r2.www)) + (c[17].xyz);
    r2.xyz = normalize(r4.xyz);
