// Mechanically reconstructed from 0x6209898E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xyz = (v0.yyy) * (r1.xyz) + (c13.yyy);
    r3.xyz = (r2.www) * (r2.xyz);
    r2.xyz = (r0.xyz) * (r1.xyz);
    r0 = tex2D(s5, v7.zw);
    r0.xyz = (r0.xyz) + (c13.xxx);
    r1.xyz = (r1.xyz) * (c13.zzz);
    r5.xyz = (v0.zzz) * (r0.xyz) + (c13.yyy);
