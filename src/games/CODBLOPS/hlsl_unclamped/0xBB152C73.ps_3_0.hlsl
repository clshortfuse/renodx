// Mechanically reconstructed from 0xBB152C73.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s5, v7.zw);
    r5.w = (r1.w) * (v0.z) + (c1.w);
    r7.xyz = (r8.xyz) * (r2.www) + (r2.xyz);
    r6.w = ((r5.w) >= 0.0f ? (r0.y) : (r3.y));
    r2 = (r0.wwww) * (c2.xxxy) + (c2.zzzx);
    r0 = tex2D(s4, v7.xy);
    r4.xyz = (r0.xyz) + (c1.xxx);
    r0 = v2;
    r3.xyz = (r10.xxx) * (v5.xyz) + (r0.xyz);
    r0.xyz = (v0.yyy) * (r4.xyz) + (c1.yyy);
