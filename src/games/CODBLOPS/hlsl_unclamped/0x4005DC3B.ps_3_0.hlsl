// Mechanically reconstructed from 0x4005DC3B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.z = rsqrt(r4.y);
    r5.xyz = (r2.xyz) * (r3.zzz);
    r0.z = dot(r5.xyz, c[24].xyz);
    r0.z = saturate((r0.z) * (c[25].x) + (c[25].y));
    r0.z = (r0.z) * (c[25].w);
    r4.x = 1.0f / (r3.z);
    r3.w = lerp(r1.w, r2.w, r0.z);
    ...
    r3.xyz = (r1.xyz) * (c[29].www);
    r1.xyz = (r4.xyz) * (c[29].yyy);
    r3.xyz = (r3.xyz) * (c[23].xyz);
    r1.xyz = (r1.xyz) * (c1.yyy);
    r4.xyz = (r3.www) * (r3.xyz);
    r3.xyz = (r3.www) * (r2.xyz) + (r1.xyz);
    r1 = tex2D(s0, v1.xy);
