// Mechanically reconstructed from 0x7FBF944E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = (r9.xyz) * (r3.zzz) + (r1.xyz);
    r0.w = rsqrt(r0.w);
    r15.xyz = (r3.www) * (v6.xyz);
    r2.xyz = (r0.xyz) * (r0.www);
    r0.xyz = (r0.xyz) * (r0.www) + (-(r15.xyz));
    ...
    r0 = tex2D(s7, v7.zw);
    r10.xyz = float3(((r4.w) >= 0.0f ? (r0.y) : (c[29].x)), ((r4.w) >= 0.0f ? (r0.y) : (c[29].y)), ((r4.w) >= 0.0f ? (r0.y) : (c[29].w)));
    r0 = (r0.wwww) * (c1.yyyz) + (c1.wwwy);
    r1 = tex2D(s6, v0.xy);
    r1 = float4(((r4.w) >= 0.0f ? (r0.x) : (r1.x)), ((r4.w) >= 0.0f ? (r0.y) : (r1.y)), ((r4.w) >= 0.0f ? (r0.z) : (r1.z)), ((r4.w) >= 0.0f ? (r0.w) : (r1.w)));
    r16.xyz = (r4.xyz) * (r10.yyy);
    ...
    r1.z = (r2.z) * (r12.w) + (r13.w);
    r11.w = (r14.w) * (r12.w) + (r13.w);
    r1.z = (r1.z) * (r11.w) + (c13.x);
    r17.xy = (r1.ww) * (c31.xy) + (c31.zw);
    r1.y = 1.0f / (r1.z);
    r10.y = exp2(r17.y);
    r1.z = pow(abs(r2.w), r10.y);
    r9.w = (r10.y) * (c13.y) + (c13.z);
    r1.y = (r2.z) * (r1.y);
    r1.z = (r1.z) * (r9.w);
    r2.w = (r1.y) * (r1.z);
    ...
    r2.w = saturate(dot(r14.xyz, c[17].xyz));
    ...
    r0.z = (r0.z) + (r0.z);
    r1.w = (r1.w) * (c3.z);
    r1.xyz = (r13.xyz) * (-(r0.zzz)) + (r15.xyz);
    r1 = texCUBElod(s15, r1);
    r0.xyz = (r1.xyz) * (r1.xyz);
    r1.w = (r3.z) * (r3.w);
    r0.xyz = (r10.xxx) * (r0.xyz);
    r1.xyz = (r11.xyz) * (r1.www) + (r12.xyz);
    r1.w = (r10.w) * (r12.w) + (r13.w);
    r1.w = (r1.w) * (r11.w) + (c13.x);
    r3.z = saturate(dot(r13.xyz, r14.xyz));
    r3.w = 1.0f / (r1.w);
    r1.w = pow(abs(r3.z), r10.y);
    r3.w = (r10.w) * (r3.w);
    r1.w = (r9.w) * (r1.w);
    r0.xyz = (r0.xyz) * (r1.xyz);
    r3.w = (r3.w) * (r1.w);
    r3.xyz = (r11.xyz) * (r8.www) + (r12.xyz);
    r1 = (v6.yyyy) * (c[25]);
