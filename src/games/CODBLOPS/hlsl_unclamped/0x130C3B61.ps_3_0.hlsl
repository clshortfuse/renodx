// Mechanically reconstructed from 0x130C3B61.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xy = (r4.xy) * (r4.xy);
    r4.xy = (r4.xy) * (c0.yy) + (c0.ww);
    r1.w = dot(c[7].yz, r7.xy) + (c[7].x);
    r4.xy = (r0.xy) * (r4.xy);
    r0.xyz = normalize(r6.xyz);
    r1.w = (r1.w) * (r4.x);
    r0.y = saturate(dot(r3.xyz, r0.xyz));
    r0.z = (r4.y) * (r1.w);
    r2.w = pow(abs(r0.y), c3.x);
