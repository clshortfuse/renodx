// Mechanically reconstructed from 0x36048224.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = (v0.zzz) * (r2.xyz) + (c1.xxx);
    r3.xyz = (v0.www) * (r1.xyz) + (c1.xxx);
    r1 = tex2D(s7, v1.xy);
    ...
    r2 = tex2D(s14, v1.zw);
    r4.xy = (r2.xy) * (c3.ww);
    r8.xy = (r3.yw) * (c26.xx) + (c26.yy);
    r7.xy = (r3.xz) * (r4.xx);
    r0.w = dot(r8.xy, r6.xy) + (c1.z);
    r0.y = (r2.x) * (c3.w) + (-(r7.x));
    r1.z = (r3.z) * (-(r4.x)) + (r0.y);
    r1.xy = (r0.xz) * (r4.yy);
    r0.y = (r2.y) * (c3.w) + (-(r1.x));
