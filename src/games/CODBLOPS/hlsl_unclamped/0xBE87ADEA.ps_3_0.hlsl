// Mechanically reconstructed from 0xBE87ADEA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xyz = (v0.yyy) * (r2.xyz) + (c2.yyy);
    r5.xyz = (r10.www) * (r0.xyz) + (r5.xyz);
    r0.xyz = (r1.xyz) * (r7.xyz);
    r1 = tex2D(s5, v7.zw);
    r10.xyz = normalize(v6.xyz);
    r1.xyz = (r1.xyz) + (c2.xxx);
    r12.xyz = (r12.xyz) * (r4.www) + (-(r10.xyz));
    r2.xyz = (v0.zzz) * (r1.xyz) + (c2.yyy);
