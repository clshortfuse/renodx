// Mechanically reconstructed from 0x8DE8428A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.xyz = float3(((r5.w) >= 0.0f ? (c[8].x) : (r1.y)), ((r5.w) >= 0.0f ? (c[8].y) : (r1.y)), ((r5.w) >= 0.0f ? (c[8].w) : (r1.y)));
