// Mechanically reconstructed from 0x5AAD5DCA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xyz = (r6.xyz) * (r4.www) + (r7.xyz);
    r0.xyz = (r6.xyz) * (r0.xyz);
    r6.xyz = (r10.yyy) * (r1.xyz);
