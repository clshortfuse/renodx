// Mechanically reconstructed from 0xF47E8D95.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    float4 v2 = input.v2;
    float4 v3 = input.v3;
    const float4 c0 = float4(0.200000003f, 1.0f, 0.797884583f, 0.0009765625f);
    const float4 c1 = float4(-13.0f, 13.0f, 0.125f, 0.25f);
