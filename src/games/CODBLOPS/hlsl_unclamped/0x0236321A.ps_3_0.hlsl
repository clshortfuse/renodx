// Mechanically reconstructed from 0x0236321A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.y = c0.z;
    r8.xyz = float3(((r4.w) >= 0.0f ? (c[30].x) : (r1.y)), ((r4.w) >= 0.0f ? (c[30].y) : (r1.y)), ((r4.w) >= 0.0f ? (c[30].w) : (r1.y)));
    ...
    r8.y = saturate(dot(r12.xyz, c[17].xyz));
    r15.xyz = (r0.xyz) * (c1.xxx);
    r14.xyz = (r8.yyy) * (c[18].xyz);
    if ((c0.y) >= (v4.w))
    {
        r2 = (v4.xyzx) * (c0.yyyz);
        r1 = (r2) + (-(c4.xyzz));
    ...
    r1.w = (r8.y) * (r11.w) + (r12.w);
    r1.w = (r1.w) * (r10.w) + (c1.w);
