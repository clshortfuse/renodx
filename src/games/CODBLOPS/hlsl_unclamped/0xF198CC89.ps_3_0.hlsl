// Mechanically reconstructed from 0xF198CC89.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.xy = float2(((r1.x) >= 0.0f ? (r4.x) : (c0.z)), ((r1.x) >= 0.0f ? (r4.y) : (c0.y)));
    r4.z = (r9.y) * (c1.y);
