// Mechanically reconstructed from 0xED16DF5F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = c0.y;
    r8.xyz = float3(((r1.w) >= 0.0f ? (r0.z) : (c[21].x)), ((r1.w) >= 0.0f ? (r0.z) : (c[21].y)), ((r1.w) >= 0.0f ? (r0.z) : (c[21].w)));
