// Mechanically reconstructed from 0xF7176AB0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = c2.y;
    r7.xyz = float3(((r4.w) >= 0.0f ? (-(r6.w)) : (c[23].x)), ((r4.w) >= 0.0f ? (-(r6.w)) : (c[23].y)), ((r4.w) >= 0.0f ? (-(r6.w)) : (c[23].w)));
