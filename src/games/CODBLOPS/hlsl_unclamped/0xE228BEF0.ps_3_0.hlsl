// Mechanically reconstructed from 0xE228BEF0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s3, v7.xy);
    r5.z = (r0.w) * (v0.y);
    r6.xyz = lerp(r1.xyz, r0.xyz, r5.zzz);
    r7.xy = lerp(r3.xy, r2.xy, r5.zz);
    r1 = tex2D(s7, v7.xy);
    r0 = (r1.wwww) * (-(c20.zzzy)) + (-(c20.wwwz));
    r3 = tex2D(s6, v1.xy);
    r2 = lerp(r3, r0, r5.zzzz);
    r0 = tex2D(s4, v7.zw);
    r3.w = (r0.w) * (v0.z);
    r3.xyz = lerp(c[8].xyw, r1.yyy, r5.zzz);
    r5.xyz = lerp(r6.xyz, r0.xyz, r3.www);
    r1 = tex2D(s8, v7.zw);
    r0 = lerp(r2, r1, r3.wwww);
    r9.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c20.yyy));
    r10.xyz = (r0.xyz) * (r0.xyz);
    r11.xyz = lerp(r3.xyz, c[9].xyw, r3.www);
    r0.xyz = (r9.xyz) * (r5.www) + (r10.xyz);
    r6.xy = (r3.ww) * (-(r7.xy)) + (r7.xy);
