// Mechanically reconstructed from 0xA1B0815A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (r0.w) * (c4.x) + (c4.y);
    r1.w = (r0.y) * (r0.w);
    r0.y = dot(r2.xy, r5.xy) + (c2.w);
    r2 = tex2D(s14, v1.zw);
    r6.xy = (r2.xy) * (c10.ww);
    r2.w = saturate((r0.y) * (r1.w) + (r1.w));
    r3.xy = (r3.xz) * (r6.yy);
    r0.y = (r2.y) * (c10.w) + (-(r3.x));
    r4.xz = (r3.xy) * (c11.xx);
    r1.w = (r3.z) * (-(r6.y)) + (r0.y);
    r0.xy = (r0.xz) * (r6.xx);
    r4.y = (r1.w) + (r1.w);
    r1.w = (r2.x) * (c10.w) + (-(r0.x));
    ...
    r10.xy = lerp(c[8].xy, r0.yy, r6.ww);
    r0.xyz = (r5.yyy) * (v3.xyz) + (r3.xyz);
    r9.xyz = normalize(r0.xyz);
    r8.xyz = normalize(v5.xyz);
    r3 = (r0.wwww) * (c3.xxxy) + (c3.zzzx);
    r0.w = dot(r8.xyz, r9.xyz);
    r5.xyz = (r2.xyz) * (r10.yyy);
    r1.w = (r0.w) + (r0.w);
    r0 = tex2D(s2, v6.xy);
    r0.xyz = (r0.xyz) + (c2.yyy);
    r2.xyz = (r9.xyz) * (-(r1.www)) + (r8.xyz);
    r6.xyz = (v0.yyy) * (r0.xyz) + (c2.zzz);
    r4 = tex2D(s5, v1.xy);
