// Mechanically reconstructed from 0xF45DD7F1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(2.0f, -1.0f, 1.0f, 0.200000003f);
    ...
    r1.x = dot(r2.xy, r1.xy) + (c2.x);
    r1.y = dot(r2.xy, r1.zw) + (c2.x);
    r2 = tex2D(s4, v6.zw);
    r2.w = (r2.w) * (v0.z);
