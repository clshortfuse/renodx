// Mechanically reconstructed from 0x2CC81760.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.xyz = lerp(r2.xyz, r0.xyz, r10.www);
    r5.xy = lerp(r3.xy, r1.xy, r10.ww);
    r0.xy = (v0.zw) * (-(c1.yz));
    r1 = tex2D(s13, r0.xy);
    ...
    r1.xyz = (r2.xyz) * (r4.www) + (r4.xyz);
    r4.xyz = (r5.yyy) * (v3.xyz) + (r0.xyz);
    r0.x = c1.w;
    r3.xyz = float3(((r5.w) >= 0.0f ? (c[5].x) : (r0.x)), ((r5.w) >= 0.0f ? (c[5].y) : (r0.x)), ((r5.w) >= 0.0f ? (c[5].w) : (r0.x)));
    r0.xyz = normalize(r4.xyz);
    r9.xyz = lerp(r3.xyz, c[6].xyw, r10.www);
    r7.w = saturate(dot(r0.xyz, c[17].xyz));
    r4.xyz = (r1.xyz) * (r9.yyy);
    r1.xyz = (r7.www) * (c[18].xyz);
    r3 = tex2D(s12, v0.zw);
    r7.xyz = (r3.yyy) * (r1.xyz) + (r4.xyz);
    r4 = tex2D(s4, v0.xy);
    ...
    r1.x = (r4.w) * (-(c4.x)) + (c4.y);
    r1.y = saturate(dot(r0.xyz, -(r6.xyz)));
    r1.z = (r7.w) * (r1.x) + (r3.z);
    r1.x = (r1.y) * (r1.x) + (r3.z);
    ...
    r5.xy = (r4.ww) * (c9.xy) + (c9.zw);
    r1.z = saturate(dot(r1.xyz, c[17].xyz));
    r1.x = exp2(r5.y);
    r5.w = 1.0f / (r5.x);
    r1.z = (-(r1.z)) + (-(c1.y));
    r3.w = pow(abs(r5.z), r1.x);
    r1.y = (r1.z) * (r1.z);
    r1.x = (r1.x) * (c4.z) + (c4.w);
    r1.y = (r1.y) * (r1.y);
    r3.z = (r3.w) * (r1.x);
