// Mechanically reconstructed from 0xA0BD4B6E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = c1.z;
    r6.xyz = float3(((r4.w) >= 0.0f ? (c[37].x) : (r2.w)), ((r4.w) >= 0.0f ? (c[37].y) : (r2.w)), ((r4.w) >= 0.0f ? (c[37].w) : (r2.w)));
