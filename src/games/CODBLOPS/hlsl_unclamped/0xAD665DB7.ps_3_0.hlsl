// Mechanically reconstructed from 0xAD665DB7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = (r0.z) * (c14.y) + (c14.z);
    r0.y = 1.0f / (r0.y);
    r0.z = (r1.z) * (r0.z);
    r0.y = (r4.w) * (r0.y);
    r1.x = (r0.x) * (c13.x) + (c13.y);
    r1.z = (r0.z) * (r0.y);
    ...
    r1.xyz = float3(((r1.z) >= 0.0f ? (r2.x) : (r3.x)), ((r1.z) >= 0.0f ? (r2.y) : (r3.y)), ((r1.z) >= 0.0f ? (r2.z) : (r3.z)));
    r9.w = (r4.z) * (r7.w);
    r7.xyz = (r1.xyz) * (r1.xyz);
    r11.xyz = (r0.xyz) * (r7.www);
    r2 = tex2D(s12, v0.zw);
