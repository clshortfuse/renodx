// Mechanically reconstructed from 0xE99A0D67.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = ((r12.w) >= 0.0f ? (c2.w) : (r4.y));
    r7.xyz = normalize(r3.xyz);
    r6.xyz = lerp(r0.www, c[27].xyw, r11.www);
    r2.w = saturate(dot(r7.xyz, c[17].xyz));
    r4.xyz = (r1.xyz) * (r6.yyy);
    r3.xyz = (r2.www) * (c[18].xyz);
    r1 = tex2D(s12, v1.zw);
    r0.w = dot(v5.xyz, v5.xyz);
    r10.xyz = (r1.yyy) * (r3.xyz) + (r4.xyz);
    r0.w = rsqrt(r0.w);
    r11.xyz = (v5.xyz) * (-(r0.www)) + (c[17].xyz);
    r5.w = -(r4.w);
    r3 = tex2D(s8, v6.zw);
    r5.xyz = c3.yyy;
    ...
    r2.xyz = lerp(r3.xyz, r0.xyz, r11.www);
