// Mechanically reconstructed from 0x4159253C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s2, v7.xy);
    r8.w = (r1.w) * (v0.y) + (c1.x);
    r3 = float4(((r8.w) >= 0.0f ? (r0.x) : (r3.x)), ((r8.w) >= 0.0f ? (r0.y) : (r3.y)), ((r8.w) >= 0.0f ? (r0.z) : (r3.z)), ((r8.w) >= 0.0f ? (r0.w) : (r3.w)));
    r5.w = (r3.w) * (c2.w);
    ...
    r9.xyz = float3(((r8.w) >= 0.0f ? (c[10].x) : (r2.y)), ((r8.w) >= 0.0f ? (c[10].y) : (r2.y)), ((r8.w) >= 0.0f ? (c[10].w) : (r2.y)));
