// Mechanically reconstructed from 0x5C2AD329.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c12 = float4(4.0f, -2.0f, 0.125f, 0.25f);
    const float4 c13 = float4(1.0f, 0.5f, 0.0f, 0.0009765625f);
    ...
    r3.w = (r0.y) * (c1.z) + (c1.w);
    r0.y = (r0.w) * (c1.z) + (c1.w);
    r0.w = dot(r2.xy, r3.xy) + (c1.y);
    r0.y = (r3.w) * (r0.y);
    r3.z = (r12.x) * (-(c3.z)) + (c3.y);
