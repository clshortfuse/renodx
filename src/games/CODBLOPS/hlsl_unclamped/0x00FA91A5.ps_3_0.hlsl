// Mechanically reconstructed from 0x00FA91A5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(4.0f, -0.5f, -2.07999992f, 200.0f);
    ...
    r0 = tex2D(s0, r1.xy);
    r3.xy = c0.xy;
    r1.xy = (v3.xy) * (c[28].xx) + (r3.xx);
    r1.xy = (r1.xy) * (c[29].xx) + (r3.yy);
    r1 = tex2D(s1, r1.xy);
    r5.xy = (v3.xy) * (c[28].xx);
    r0.w = (r1.y) * (c0.z) + (c0.w);
    r2.xy = (r5.xy) * (c1.xx) + (c1.yy);
    r1.y = (r0.w) * (c0.z) + (c0.w);
    r2.xy = (r2.xy) * (c[30].xx) + (r3.yy);
    r2 = tex2D(s2, r2.xy);
    r0.w = (r2.y) * (c0.z) + (c0.w);
    r1.w = (r0.w) * (c0.z) + (c0.w);
    r1.xz = c1.zz;
    ...
    r4.xy = (c[31].xx) * (r1.xy) + (r4.xy);
    r1.xyz = (r2.yzx) * (v0.zxy) + (-(r3.xyz));
    r0.xyz = (r0.xyz) * (r0.xyz);
    r1.xyz = (r4.yyy) * (-(r1.xyz));
    r0.xyz = (r3.www) * (r0.xyz);
    r1.xyz = (r4.xxx) * (v0.xyz) + (r1.xyz);
    r0.w = dot(-(v1.xyz), -(v1.xyz));
    r3.xyz = (-(v1.xyz)) + (c[5].xyz);
    r0.w = rsqrt(r0.w);
    r2.xyz = normalize(r3.xyz);
    r3.xyz = (r1.xyz) + (v2.xyz);
    r4.xyz = (-(v1.xyz)) * (r0.www) + (r2.xyz);
