// Mechanically reconstructed from 0x58B6AECF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = (r1.z) * (r1.z);
    r0 = float4(((r3.z) >= 0.0f ? (r0.x) : (c0.z)), ((r3.z) >= 0.0f ? (r0.y) : (c0.z)), ((r3.z) >= 0.0f ? (r0.z) : (c0.z)), ((r3.z) >= 0.0f ? (r0.w) : (c0.z)));
    r2.w = (r1.w) * (r1.z);
    r0.xyz = (r0.xyz) * (v0.xyz);
    r1 = tex2D(s2, v1.xy);
    r1 = float4(((r3.z) >= 0.0f ? (r1.x) : (c0.z)), ((r3.z) >= 0.0f ? (r1.y) : (c0.z)), ((r3.z) >= 0.0f ? (r1.z) : (c0.z)), ((r3.z) >= 0.0f ? (r1.w) : (c0.y)));
    ...
    r2.w = (r1.w) * (-(c1.y)) + (c1.z);
    r15.yz = c0.yz;
    r8.xyz = float3(((r3.z) >= 0.0f ? (c[22].x) : (r15.z)), ((r3.z) >= 0.0f ? (c[22].y) : (r15.z)), ((r3.z) >= 0.0f ? (c[22].w) : (r15.z)));
    r1.xyz = (r3.www) * (v5.xyz);
    r10.xyz = normalize(v2.xyz);
    r7.w = saturate(dot(r10.xyz, -(r1.xyz)));
    r4.z = (r1.w) * (c1.y);
    r3.y = (r7.w) * (r2.w) + (r4.z);
    r16.xy = (r1.ww) * (c3.xy) + (c3.zw);
    r3.z = exp2(r16.y);
    r3.w = saturate(dot(r10.xyz, c[17].xyz));
    r3.x = saturate(dot(r10.xyz, r2.xyz));
    r2.w = (r3.w) * (r2.w) + (r4.z);
    r2.y = pow(abs(r3.x), r3.z);
    r2.z = (r2.w) * (r3.y) + (c1.w);
    r2.w = (r3.z) * (c4.x) + (c4.y);
    r2.z = 1.0f / (r2.z);
    r2.w = (r2.y) * (r2.w);
