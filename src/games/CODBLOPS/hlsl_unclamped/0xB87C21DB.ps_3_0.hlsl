// Mechanically reconstructed from 0xB87C21DB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = (r3.w) * (c4.z) + (c4.w);
    r7.xyz = (v0.zzz) * (r0.xyz) + (c1.xxx);
    r4 = tex2D(s4, v8.xy);
    r4.xyz = (r4.xyz) + (c1.yyy);
    r0.xyz = (r3.xyz) * (r7.xyz);
    r3.xyz = (v0.www) * (r4.xyz) + (c1.xxx);
    r3.w = 1.0f / (r3.w);
    ...
    r8.xyz = (r0.xyz) * (r0.xyz) + (r2.xyz);
    r2 = tex2D(s0, v1.xy);
    r0.xyz = lerp(r2.xyz, r1.xyz, r1.www);
    r1.xyz = (r4.xyz) * (r8.xyz);
