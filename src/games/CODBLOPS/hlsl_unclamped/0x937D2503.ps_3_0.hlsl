// Mechanically reconstructed from 0x937D2503.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xy = float2(((r6.w) >= 0.0f ? (r2.x) : (r4.x)), ((r6.w) >= 0.0f ? (r2.y) : (r4.y)));
    r1 = tex2D(s9, v7.xy);
    ...
    r2.xyz = (v0.zzz) * (r2.xyz) + (-(c3.yyy));
    r5.xyz = (r0.xyz) * (r2.xyz);
    r0.xyz = (r3.xyz) * (r2.xyz);
    r9.xyz = (r0.xyz) * (r0.xyz);
    r0.z = dot(r10.xy, r10.xy) + (c3.z);
    r15.xyz = (r5.xyz) * (-(r5.xyz)) + (-(c3.yyy));
    r0.z = exp2(-(r0.z));
    r1.z = (r0.z) * (c12.x) + (c12.y);
    ...
    r2.w = r4.y;
    r11.xy = (r4.xz) * (r6.xx);
    r4.xy = (r2.wy) * (c13.xx) + (c13.yy);
    r0.y = (r3.x) * (c12.w) + (-(r11.x));
    r0.z = dot(r4.xy, r10.xy) + (c3.z);
    r2.w = (r4.z) * (-(r6.x)) + (r0.y);
    r0.xy = (r2.xz) * (r6.yy);
    r1.w = dot(r4.xy, r4.xy) + (c3.z);
    r1.x = (r3.y) * (c12.w) + (-(r0.x));
    r1.w = exp2(-(r1.w));
    r1.x = (r2.z) * (-(r6.y)) + (r1.x);
    ...
    r2.xz = (r0.xy) * (c13.xx);
    r4.xyz = (r3.xyz) * (r1.xxx) + (-(r7.xyz));
    r0.xyz = normalize(r4.xyz);
    r8.xyz = (r3.xyz) * (r1.xxx);
    ...
    r1.z = saturate(dot(r17.xyz, r0.xyz));
    r10.w = (r0.w) * (c12.z);
    ...
    r1.z = (r1.x) * (r1.z);
    r14.xyz = float3(((r6.w) >= 0.0f ? (r1.y) : (c[32].x)), ((r6.w) >= 0.0f ? (r1.y) : (c[32].y)), ((r6.w) >= 0.0f ? (r1.y) : (c[32].w)));
