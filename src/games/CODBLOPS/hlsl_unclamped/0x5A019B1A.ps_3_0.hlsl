// Mechanically reconstructed from 0x5A019B1A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = dot(r8.xy, r8.xy) + (c4.y);
    r1.y = exp2(-(r1.y));
    r1.w = exp2(-(r1.w));
    r1.y = (r1.y) * (c4.z) + (c4.w);
    r1.w = (r1.w) * (c4.z) + (c4.w);
    r3.w = (r1.y) * (r1.w);
    r1.y = dot(r2.xy, r8.xy) + (c4.y);
    r2 = tex2D(s14, v1.zw);
    r9.xy = (r2.xy) * (c2.ww);
    ...
    r2 = tex2D(s0, v1.xy);
    r9.xyz = lerp(r2.xyz, r0.xyz, r0.www);
    r2 = tex2D(s5, v7.zw);
    r0 = v2;
    r4.xyz = (r8.xxx) * (v5.xyz) + (r0.xyz);
    r0.xyz = (r2.xyz) * (v0.zzz);
    r2.xyz = (r8.yyy) * (v4.xyz) + (r4.xyz);
