// Mechanically reconstructed from 0xDBA4D30A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xyw = c[39].xyw;
    r4.xyz = (-(r0.xyw)) + (c[40].xyw);
    r0 = v2;
    r0.xyz = (r8.xxx) * (v5.xyz) + (r0.xyz);
    r4.xyz = (r13.www) * (r4.xyz) + (c[39].xyw);
    r0.xyz = (r8.yyy) * (v4.xyz) + (r0.xyz);
    r11.xyz = lerp(r4.xyz, c1.xxx, r10.www);
