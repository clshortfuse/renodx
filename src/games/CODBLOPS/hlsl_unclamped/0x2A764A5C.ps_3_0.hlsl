// Mechanically reconstructed from 0x2A764A5C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.y = (r5.w) * (c1.w);
    r0.y = (r5.z) * (r0.z) + (r3.y);
    r16.xy = (r5.ww) * (c13.xy) + (c13.zw);
    r0.x = exp2(r16.y);
    r2.w = saturate(dot(r9.xyz, r1.xyz));
    r1.w = pow(abs(r2.w), r0.x);
    r2.w = saturate(dot(r9.xyz, c[17].xyz));
    r0.x = (r0.x) * (c12.y) + (c12.z);
    r0.z = (r2.w) * (r0.z) + (r3.y);
    r3.y = (r1.w) * (r0.x);
    r3.x = (r0.z) * (r0.y) + (c12.x);
    r1 = tex2D(s3, v7.zw);
    r0.xyz = (r1.xyz) + (c21.xxx);
    r1.w = 1.0f / (r3.x);
    r12.xyz = (v7.yyy) * (r0.xyz) + (c21.yyy);
    r1.w = (r2.w) * (r1.w);
    r0.xyz = (r12.xyz) * (c21.zzz);
    r10.xyz = (r0.xyz) * (-(r0.xyz)) + (c21.yyy);
    ...
    r1 = tex2D(s12, v0.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c21.y) : (c21.w));
    ...
    r3.xyz = (r13.xyz) * (c[19].xyz);
    r1 = tex2D(s0, v0.xy);
    r0.xyz = (r12.xyz) * (r1.xyz);
    r1.xyz = (r2.www) * (r3.xyz);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r6.xyz = (r0.xyz) * (r2.xyz) + (r1.xyz);
    r1.w = (-(r5.z)) + (c21.y);
    r1.y = 1.0f / (r16.x);
    r1.z = (r1.w) * (r1.w);
    r1.z = (r1.w) * (r1.z);
