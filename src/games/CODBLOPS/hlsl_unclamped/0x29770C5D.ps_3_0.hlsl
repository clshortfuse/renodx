// Mechanically reconstructed from 0x29770C5D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s4, v8.xy);
    r0.w = (r0.w) * (v0.y);
    r4.xyz = lerp(r1.xyz, r0.xyz, r0.www);
    r8.w = c3.x;
    r0.xyz = (r8.www) + (-(c[31].xyw));
    r2.xy = (r0.ww) * (-(r2.xy)) + (r2.xy);
    r5.xyz = (r0.www) * (r0.xyz) + (c[31].xyw);
    r0 = tex2D(s5, v8.zw);
    r0.w = (r0.w) * (v0.z);
    r1.xy = (v1.zw) * (c4.xy);
    r3 = tex2D(s13, r1.xy);
    ...
    r1 = tex2D(s13, r1.xy);
    r3.w = r1.y;
    r8.xy = (r0.ww) * (-(r2.xy)) + (r2.xy);
    r2.xy = (r3.yw) * (c33.xx) + (c33.yy);
    r1.w = dot(r8.xy, r8.xy) + (c3.z);
    r1.y = dot(r2.xy, r2.xy) + (c3.z);
    r1.w = exp2(-(r1.w));
    r1.y = exp2(-(r1.y));
    r1.w = (r1.w) * (c1.x) + (c1.y);
    r2.w = (r1.y) * (c1.x) + (c1.y);
    r1.y = dot(r2.xy, r8.xy) + (c3.z);
    r3.w = (r1.w) * (r2.w);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c1.ww);
    ...
    r7.xz = (r3.xy) * (c4.ww);
    r6.xyz = lerp(r5.xyz, c3.xxx, r0.www);
    r1.xyz = (r7.xyz) * (r1.www) + (r1.xyz);
    r14.xyz = lerp(r4.xyz, r0.xyz, r0.www);
    r10.xyz = (r6.yyy) * (r1.xyz);
    r1 = tex2D(s12, v1.zw);
    r0 = v2;
    ...
    r1.w = rsqrt(r1.w);
    r12.xyz = (r2.www) * (v7.xyz);
    r3.xyz = (r5.www) * (r8.xyz) + (r10.xyz);
    r1.xyz = (r0.xyz) * (r1.www) + (-(r12.xyz));
    ...
    r2.z = (r0.z) * (r0.z);
    r1 = tex2D(s6, v9.xy);
    r0.xyz = (r1.xyz) + (c3.yyy);
    r7.w = (r2.w) * (r2.z);
    r0.xyz = (v0.www) * (r0.xyz) + (c3.xxx);
    r2 = tex2D(s7, v1.xy);
    r1.xyz = (r0.xyz) * (r2.xyz);
    r8.xyz = (r1.xyz) * (-(r1.xyz)) + (c3.xxx);
    r10.xyz = (r1.xyz) * (r1.xyz);
    r0.xyz = (r14.xyz) * (r0.xyz);
    r5.xyz = (r8.xyz) * (r4.www) + (r10.xyz);
    r11.w = (r2.w) * (-(c33.z)) + (c33.w);
    r12.w = (r2.w) * (c1.z);
    r4.w = saturate(dot(r13.xyz, r9.xyz));
    r2.z = saturate(dot(r9.xyz, -(r12.xyz)));
    r1.w = (r4.w) * (r11.w) + (r12.w);
    r10.w = (r2.z) * (r11.w) + (r12.w);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r1.w = (r1.w) * (r10.w) + (c13.x);
    r1.z = 1.0f / (r1.w);
    ...
    r2.xyz = (r8.xyz) * (r1.www) + (r10.xyz);
    r2.xyz = (r1.xyz) * (r2.xyz);
    r6.y = exp2(r12.y);
    r1.w = (r6.y) * (c13.y) + (c13.z);
    r1.z = (r9.w) * (r11.w) + (r12.w);
    r1.z = (r1.z) * (r10.w) + (c13.x);
    r2.w = saturate(dot(r9.xyz, r11.xyz));
    r1.y = 1.0f / (r1.z);
    r1.z = pow(abs(r2.w), r6.y);
    r1.y = (r9.w) * (r1.y);
    r1.z = (r1.w) * (r1.z);
    r2.w = (r1.y) * (r1.z);
    r1.xyz = (r8.xyz) * (r7.www) + (r10.xyz);
    r4.z = saturate(dot(r9.xyz, r4.xyz));
    r1.xyz = (r2.www) * (r1.xyz);
    r2.w = pow(abs(r4.z), r6.y);
