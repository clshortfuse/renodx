// Mechanically reconstructed from 0xA921FEFC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = (r2.w) * (-(c3.x)) + (c3.y);
    r6.y = saturate(dot(r10.xyz, -(r12.xyz)));
    r6.z = (r7.z) * (r6.w) + (r7.w);
    r5.w = (r6.y) * (r6.w) + (r7.w);
    r10.w = (-(r6.y)) + (c1.y);
    r6.z = (r6.z) * (r5.w) + (c3.z);
    ...
    r3.y = c1.z;
    r5.xyz = float3(((r3.w) >= 0.0f ? (c[35].x) : (r3.y)), ((r3.w) >= 0.0f ? (c[35].y) : (r3.y)), ((r3.w) >= 0.0f ? (c[35].w) : (r3.y)));
    ...
    r6.xy = saturate((r13.xx) * (c[33].xy) + (c[33].zw));
    r6.z = dot(c[32].yz, r13.xy) + (c[32].x);
    r3.xy = (r6.xy) * (r6.xy);
