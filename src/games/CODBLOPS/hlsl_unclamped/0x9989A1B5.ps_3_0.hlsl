// Mechanically reconstructed from 0x9989A1B5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.x = dot(r2.xy, r0.xy) + (c16.w);
    r4.y = dot(r2.xy, r0.zw) + (c16.w);
    r0 = tex2D(s3, v6.zw);
    r5.w = (r0.w) * (v0.z);
    ...
    r0.w = rsqrt(r5.y);
    r5.x = 1.0f / (r0.w);
    r7.xyz = lerp(c[28].xyw, r1.yyy, r5.www);
    r2.xy = saturate((r5.xx) * (c[24].xy) + (c[24].zw));
    r1.xy = (r2.xy) * (r2.xy);
    r2.xy = (r2.xy) * (c14.xx) + (c14.yy);
    r1.z = dot(c[23].yz, r5.xy) + (c[23].x);
    r1.xy = (r1.xy) * (r2.xy);
    ...
    r6.xyz = (r4.www) * (r1.xyz) + (r3.xyz);
    r11.xyz = normalize(v5.xyz);
    r1 = tex2D(s2, v6.xy);
    r3.xyz = (r1.xyz) + (c16.yyy);
    r1.xyz = (r4.xyz) * (r0.www) + (-(r11.xyz));
    ...
    r1 = tex2D(s0, v1.xy);
    r2.xyz = (r1.xyz) * (-(r5.xyz)) + (r0.xyz);
    r0.xyz = (r3.xyz) * (c[22].xyz);
