// Mechanically reconstructed from 0xB76B1CC1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s8, v1.xy);
    r9.xyz = lerp(r1.yyy, c[32].xyw, r2.www);
    ...
    r12.xyz = (r0.xyz) * (r0.www);
    r4.xyz = (r3.xyz) * (r9.yyy);
    r6.w = saturate(dot(r10.xyz, r12.xyz));
    r3.xyz = (r6.www) * (c[6].xyz);
    r7.xyz = normalize(v6.xyz);
    r8.xyz = (r13.xyz) * (r3.xyz) + (r4.xyz);
    ...
    r4.w = exp2(r4.y);
    r1.y = pow(abs(r4.z), r4.w);
    r1.z = (r4.w) * (c13.y) + (c13.z);
    r1.w = 1.0f / (r4.x);
    r1.y = (r1.y) * (r1.z);
    r4.y = (r3.w) * (c3.w);
    r4.z = (r3.w) * (-(c12.z)) + (c12.w);
    r4.w = (r6.w) * (r4.z) + (r4.y);
