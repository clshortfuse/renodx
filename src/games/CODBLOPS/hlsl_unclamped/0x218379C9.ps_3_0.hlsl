// Mechanically reconstructed from 0x218379C9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xyz = (r13.xyz) * (r0.www) + (r2.xyz);
    r2 = tex2D(s6, v1.xy);
    r5.xyz = lerp(r2.yyy, c[36].xyw, r7.www);
    r4.w = -(r2.w);
    r0 = tex2D(s7, v7.xy);
    r4.xyz = c1.xxx;
    r2 = (r2.wwww) * (c1.yyyz) + (c1.wwwy);
    r0 = (r4) + (r0);
    r11.xyz = lerp(r5.xyz, c[37].xyw, r6.www);
    r5 = (r7.wwww) * (r0) + (r2);
    r4 = tex2D(s8, v7.zw);
    r0 = v2;
    ...
    r12.xyz = (r8.xyz) * (r8.www) + (-(r12.xyz));
    r8.xyz = (r0.xyz) * (c2.zzz);
    r4 = tex2D(s0, v1.xy);
    r13.xyz = lerp(r4.xyz, r3.xyz, r7.www);
    r0.y = (r2.w) * (c2.w);
    r0.z = (r2.w) * (-(c13.x)) + (c13.y);
    r1.w = saturate(dot(r9.xyz, r10.xyz));
    r3.w = (r3.w) * (r0.z) + (r0.y);
    r2.w = (r1.w) * (r0.z) + (r0.y);
    r0.xyz = lerp(r13.xyz, r1.xyz, r6.www);
    r1.z = (r2.w) * (r3.w) + (c4.w);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r1.z = 1.0f / (r1.z);
