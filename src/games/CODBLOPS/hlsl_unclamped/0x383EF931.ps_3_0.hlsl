// Mechanically reconstructed from 0x383EF931.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r4.w = (r0.w) * (v0.w) + (c0.x);
    r3.xy = float2(((r4.w) >= 0.0f ? (r3.x) : (c0.w)), ((r4.w) >= 0.0f ? (r3.y) : (c0.w)));
    r2.w = r1.x;
    r1 = v2;
