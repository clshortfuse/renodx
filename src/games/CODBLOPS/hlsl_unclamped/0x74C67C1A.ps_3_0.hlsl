// Mechanically reconstructed from 0x74C67C1A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.x = pow(abs(r2.w), r3.y);
    r2.w = saturate(dot(r10.xyz, c[17].xyz));
    r1.y = (r3.y) * (c12.x) + (c12.y);
    r1.z = (r2.w) * (r3.w) + (r3.z);
    r1.y = (r1.x) * (r1.y);
    r1.z = (r1.z) * (r2.z) + (c3.z);
    r1.x = 1.0f / (r1.z);
    ...
    r3 = tex2D(s0, v1.xy);
    r4.xyz = saturate((r1.xyz) * (r3.www) + (r3.xyz));
    r1.xyz = (r5.xyz) * (r0.xyz);
    r0.xyz = (r2.xxx) * (r4.xyz);
    r1.xyz = (r1.xyz) * (c0.www);
    r0.xyz = (r0.xyz) * (v0.xyz);
    r3.xyz = (r0.xyz) * (r0.xyz);
    r0.xyz = lerp(r4.xyz, c0.yyy, r2.xxx);
    ...
    r2.x = c[22].w;
    r1.xy = (c[24].xy) * (-(r2.xx)) + (v1.xy);
    r1 = tex2D(s5, r1.xy);
    r2.xy = (c[25].xy) * (-(r2.xx)) + (v1.xy);
    r2 = tex2D(s4, r2.xy);
