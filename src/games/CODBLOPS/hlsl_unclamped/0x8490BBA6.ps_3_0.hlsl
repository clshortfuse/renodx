// Mechanically reconstructed from 0x8490BBA6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s2, v6.zw);
    r4.w = (r1.w) * (v6.y) + (c1.x);
    r9.xy = float2(((r4.w) >= 0.0f ? (c1.y) : (r2.y)), ((r4.w) >= 0.0f ? (c1.z) : (r2.y)));
    ...
    r4 = tex2D(s13, r1.xy);
    r2.w = r4.y;
    r1.z = dot(r10.xy, r10.xy) + (c1.y);
    r1.xy = (r2.yw) * (c15.xx) + (c15.yy);
    r2.w = exp2(-(r1.z));
    r1.z = dot(r1.xy, r1.xy) + (c1.y);
    r4.w = (r2.w) * (c2.x) + (c2.y);
    r2.w = exp2(-(r1.z));
    r1.z = dot(r1.xy, r10.xy) + (c1.y);
    r1.y = (r2.w) * (c2.x) + (c2.y);
    r3 = tex2D(s14, v0.zw);
    r10.xy = (r3.xy) * (c2.ww);
    r2.w = (r4.w) * (r1.y);
