// Mechanically reconstructed from 0xAFA21E19.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = c8.x;
    r1.xyz = (r0.www) + (-(c[5].xyw));
    r0 = tex2D(s4, v8.zw);
    r1.w = (r0.w) * (v0.z);
    r1.xyz = (r4.www) * (r1.xyz) + (c[5].xyw);
    r8.xyz = lerp(r2.xyz, r0.xyz, r1.www);
    r11.xyz = lerp(r1.xyz, c8.xxx, r1.www);
    ...
    r0.y = dot(r4.xy, r4.xy) + (c8.y);
    r0.w = dot(r1.xy, r1.xy) + (c8.y);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r4.w = (r0.y) * (c8.z) + (c8.w);
    r0.y = (r0.w) * (c8.z) + (c8.w);
    r0.w = dot(r1.xy, r4.xy) + (c8.y);
    r0.y = (r4.w) * (r0.y);
    r1 = tex2D(s14, v1.zw);
    r6.xy = (r1.xy) * (c3.ww);
    ...
    r0.z = (r0.z) * (r0.y) + (c4.z);
    r0.y = (r1.z) * (c10.x) + (c10.y);
    r0.z = 1.0f / (r0.z);
    r1.z = (r0.x) * (r0.y);
    r1.y = (r3.w) * (r0.z);
    r0.xyz = (r9.xyz) * (r4.zzz) + (r10.xyz);
    r2.w = (r1.z) * (r1.y);
    r1.xyz = (r7.xyz) * (r4.www) + (r2.xyz);
    r0.xyz = (r0.xyz) * (r2.www);
    r15.xyz = (r11.yyy) * (r1.xyz);
    r1.xyz = (r11.zzz) * (r0.xyz);
    r2 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r2.y)) >= 0.0f ? (c8.x) : (c8.y));
