// Mechanically reconstructed from 0x6E24977A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.y = dot(r1.xy, r0.zw) + (c1.w);
    r6.x = dot(r1.xy, r0.xy) + (c1.w);
    r0 = tex2D(s0, v0.xy);
    r3 = tex2D(s5, v7.zw);
    r2.w = (r3.w) * (v7.y) + (c3.x);
    r1.xyz = (r2.xxx) * (r0.xyz);
    r7.xy = float2(((r2.w) >= 0.0f ? (r6.x) : (r7.x)), ((r2.w) >= 0.0f ? (r6.y) : (r7.y)));
    r3.xyz = float3(((r2.w) >= 0.0f ? (r3.x) : (r1.x)), ((r2.w) >= 0.0f ? (r3.y) : (r1.y)), ((r2.w) >= 0.0f ? (r3.z) : (r1.z)));
    ...
    r10.xyz = float3(((r2.w) >= 0.0f ? (c[29].x) : (r2.y)), ((r2.w) >= 0.0f ? (c[29].y) : (r2.y)), ((r2.w) >= 0.0f ? (c[29].w) : (r2.y)));
    r0.xyz = (r0.xyz) * (c[7].xyz);
    r5.xyz = (r10.zzz) * (r0.xyz);
