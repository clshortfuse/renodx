// Mechanically reconstructed from 0xFCC4A1EF.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = saturate(dot(r13.xyz, r2.xyz));
    r11.w = (r1.w) * (c1.w);
    r1.z = saturate(dot(r9.xyz, r13.xyz));
    r12.w = saturate(dot(r13.xyz, -(r14.xyz)));
    r0.y = (r1.z) * (r10.w) + (r11.w);
    r9.w = (r12.w) * (r10.w) + (r11.w);
    r0.y = (r0.y) * (r9.w) + (c12.x);
    r17.xy = (r1.ww) * (c30.xy) + (c30.zw);
    r0.y = 1.0f / (r0.y);
    r8.w = exp2(r17.y);
    r3.z = (r1.z) * (r0.y);
    r3.y = pow(abs(r0.z), r8.w);
    r2 = tex2D(s5, v7.zw);
    r0.xyz = (r2.xyz) + (c13.xxx);
    r1.x = (r8.w) * (c12.y) + (c12.z);
    r0.xyz = (v7.yyy) * (r0.xyz) + (c13.yyy);
    r2.w = (r3.y) * (r1.x);
    r2.xyz = (r0.xyz) * (c13.zzz);
    r11.xyz = (r2.xyz) * (-(r2.xyz)) + (c13.yyy);
    r12.xyz = (r2.xyz) * (r2.xyz);
    r2.w = (r3.z) * (r2.w);
    r2.xyz = (r11.xyz) * (r3.www) + (r12.xyz);
    ...
    r4.xy = (r4.xz) * (r0.xx);
    r0.z = dot(r7.xy, r10.xy) + (c13.w);
    r2.w = (r3.x) * (c3.w) + (-(r4.x));
    r2.w = (r4.z) * (-(r0.x)) + (r2.w);
    r2.xy = (r2.xz) * (r0.yy);
    r3.w = (r3.y) * (c3.w) + (-(r2.x));
    r0.x = dot(r7.xy, r7.xy) + (c13.w);
    r0.y = (r2.z) * (-(r0.y)) + (r3.w);
    r0.x = exp2(-(r0.x));
    r10.y = (r2.w) + (r2.w);
    r0.x = (r0.x) * (c1.x) + (c1.y);
    ...
    r0.xyz = (r10.xyz) * (r1.zzz) + (r0.xyz);
    r16.xyz = (r1.yyy) * (r0.xyz);
    r7.w = saturate(dot(r13.xyz, c[17].xyz));
    r2 = tex2D(s12, v0.zw);
    r0.z = ((-abs(r2.y)) >= 0.0f ? (c13.y) : (c13.w));
    ...
    r2.xyz = (v6.xyz) * (-(r13.www)) + (c[17].xyz);
