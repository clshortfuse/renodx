// Mechanically reconstructed from 0xC2C0D9BC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = rsqrt(r0.z);
    r0.xyz = (r8.www) * (v6.xyz);
    r2.xyz = (r4.xyz) * (r1.www) + (-(r0.xyz));
    r3.xyz = (r4.www) * (r6.xyz) + (r9.xyz);
    ...
    r11.y = (r2.w) * (r2.z);
    r6.xyz = (v7.yyy) * (r1.xyz) + (c1.yyy);
    r2 = tex2D(s0, v0.xy);
    r1 = tex2D(s6, v0.xy);
    r1.xyz = (r6.xyz) * (r1.xyz);
    r4.xyz = (r1.xyz) * (-(r1.xyz)) + (c1.yyy);
    r5.xyz = (r1.xyz) * (r1.xyz);
    r10.w = (r1.w) * (-(c31.z)) + (c31.w);
    r11.z = (r1.w) * (c4.z);
    r10.z = saturate(dot(r10.xyz, r8.xyz));
    r2.w = saturate(dot(r8.xyz, -(r0.xyz)));
    r1.z = (r10.z) * (r10.w) + (r11.z);
    r8.w = (r2.w) * (r10.w) + (r11.z);
    r1.z = (r1.z) * (r8.w) + (c13.x);
    r10.xy = (r1.ww) * (c16.xy) + (c16.zw);
    r1.y = 1.0f / (r1.z);
    r9.w = exp2(r10.y);
    ...
    r11.w = (r10.z) * (r1.y);
    r10.y = (r1.z) * (r6.w);
    r1.xyz = (r4.xyz) * (r11.yyy) + (r5.xyz);
    r10.y = (r11.w) * (r10.y);
    r2.xyz = (r6.xyz) * (r2.xyz);
    r1.xyz = (r1.xyz) * (r10.yyy);
    r2.xyz = (r2.xyz) * (r2.xyz);
    r1.xyz = (r1.xyz) * (c[7].xyz);
    r6.xyz = (r1.xyz) * (c[29].www);
    r1.xyz = (r10.zzz) * (c[6].xyz);
    r6.xyz = (r2.xyz) * (r1.xyz) + (r6.xyz);
    r1.z = (-(r2.w)) + (c1.y);
    r1.x = 1.0f / (r10.x);
    r1.y = (r1.z) * (r1.z);
    r1.y = (r1.z) * (r1.y);
    r1.z = dot(r0.xyz, r8.xyz);
    r2.w = (r1.x) * (r1.y);
    r1.z = (r1.z) + (r1.z);
    r1.w = (r1.w) * (c1.w);
    r1.xyz = (r8.xyz) * (-(r1.zzz)) + (r0.xyz);
    r1 = texCUBElod(s15, r1);
    r0.xyz = (r1.xyz) * (r1.xyz);
    r1.w = (r7.w) * (r10.w) + (r11.z);
    r1.w = (r1.w) * (r8.w) + (c13.x);
    ...
    r4.xyz = (r4.www) * (r1.xyz);
    r1 = (v6.yyyy) * (c[25]);
    r8.xyz = (r2.xyz) * (r3.xyz) + (r4.xyz);
    r1 = (v6.xxxx) * (c[24]) + (r1);
    r7.xyz = (r7.xyz) * (r0.xyz);
    r1 = (v6.zzzz) * (c[26]) + (r1);
    r0.z = saturate((r3.w) * (c[23].x) + (c[23].y));
    r4 = (r1) + (c[27]);
