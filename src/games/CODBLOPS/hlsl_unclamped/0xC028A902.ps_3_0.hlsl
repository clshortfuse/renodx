// Mechanically reconstructed from 0xC028A902.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s13, r0.xy);
    r1.w = r0.y;
    r4.xy = (r3.ww) * (-(r4.xy)) + (r4.xy);
    r5.xy = (r1.yw) * (c38.xx) + (c38.yy);
    ...
    r0.w = (r0.w) * (c1.x) + (c1.y);
    r1.w = (r0.y) * (c1.x) + (c1.y);
    r0.y = dot(r5.xy, r4.xy) + (c3.z);
    r1.w = (r0.w) * (r1.w);
    r8.xyz = lerp(r3.xyz, r2.xyz, r3.www);
    ...
    r1.w = rsqrt(r1.w);
    r12.xyz = (r4.www) * (v7.xyz);
    r7.xz = (r3.xy) * (c4.ww);
    r2.xyz = (r1.xyz) * (r1.www) + (-(r12.xyz));
    ...
    r0.z = (r1.w) * (r1.w);
    r0.y = saturate(dot(r10.xyz, c[17].xyz));
    r0.z = (r0.z) * (r0.z);
    r0.y = (-(r0.y)) + (c3.x);
    r10.w = (r1.w) * (r0.z);
    r0.z = (r0.y) * (r0.y);
    ...
    r1.w = ((-abs(r1.y)) >= 0.0f ? (c3.x) : (c3.z));
    r3.xyz = (r4.yyy) * (v4.xyz) + (r0.xyz);
    r7.w = c3.x;
    r0.xyz = (r7.www) + (-(c[36].xyw));
    r9.xyz = normalize(r3.xyz);
    r6.xyz = (r3.www) * (r0.xyz) + (c[36].xyw);
    r6.w = saturate(dot(r9.xyz, c[17].xyz));
    r15.xyz = (r2.xyz) * (r6.yyy);
    ...
    r1.xyz = (v0.zzz) * (r0.xyz) + (c3.xxx);
    r4.xyz = (r3.www) * (r14.xyz) + (r15.xyz);
    r0.xyz = (r8.xyz) * (r1.xyz);
    r2 = tex2D(s7, v1.xy);
    r1.xyz = (r1.xyz) * (r2.xyz);
    r5.xyz = (r1.xyz) * (-(r1.xyz)) + (c3.xxx);
    r8.xyz = (r1.xyz) * (r1.xyz);
    r2.xyz = (r5.xyz) * (r10.www) + (r8.xyz);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r10.w = (r2.w) * (-(c38.z)) + (c38.w);
    r11.w = (r2.w) * (c1.z);
    r5.w = saturate(dot(r13.xyz, r9.xyz));
    r3.z = saturate(dot(r9.xyz, -(r12.xyz)));
    r1.w = (r5.w) * (r10.w) + (r11.w);
    r4.w = (r3.z) * (r10.w) + (r11.w);
    r1.z = (r1.w) * (r4.w) + (c14.x);
    ...
    r1.w = (r6.x) * (c14.y) + (c14.z);
    r1.z = (r6.w) * (r10.w) + (r11.w);
    r1.z = (r1.z) * (r4.w) + (c14.x);
    r4.w = saturate(dot(r9.xyz, r10.xyz));
    r1.y = 1.0f / (r1.z);
    r1.z = pow(abs(r4.w), r6.x);
    r1.y = (r6.w) * (r1.y);
    r1.z = (r1.w) * (r1.z);
    r6.w = (r1.y) * (r1.z);
    r1.xyz = (r5.xyz) * (r9.www) + (r8.xyz);
    ...
    r1 = (v7.xxxx) * (c[31]) + (r1);
    r7.xyz = (r3.xyz) * (c3.www) + (r4.xyz);
    r1 = (v7.zzzz) * (c[33]) + (r1);
    r2.xyz = (r2.xyz) * (c[22].xyz);
    r4 = (r1) + (c[34]);
    r2.xyz = (r6.zzz) * (r2.xyz);
    r3.zw = r4.zw;
    r1.xyz = (r5.www) * (c[21].xyz);
    r5.zw = r3.zw;
