// Mechanically reconstructed from 0xB1965A4B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r3.x) * (r1.w);
    r1.w = (r3.z) * (r1.w);
    r4.w = lerp(r3.y, c6.x, r10.w);
    r1.w = (r2.w) * (r1.w);
    r2.w = lerp(r4.w, c6.x, r9.w);
    r7.w = 1.0f / (r5.x);
    r3.z = (r1.w) * (r2.w);
    r1.w = (r3.w) * (c1.x);
    ...
    r3.w = dot(r10.xy, r10.xy) + (c6.y);
    r3.z = dot(r5.xy, r5.xy) + (c6.y);
    r3.w = exp2(-(r3.w));
    r3.z = exp2(-(r3.z));
    r3.w = (r3.w) * (c6.z) + (c6.w);
    r3.x = (r3.z) * (c6.z) + (c6.w);
    r3.z = dot(r5.xy, r10.xy) + (c6.y);
    r3.x = (r3.w) * (r3.x);
    r5 = tex2D(s14, v1.zw);
    r11.xy = (r5.xy) * (c2.ww);
