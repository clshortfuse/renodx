// Mechanically reconstructed from 0x64E164E2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.w = (r1.w) * (v7.y) + (c1.w);
    r0.w = (r4.w) * (r4.w);
    r7.xyz = float3(((r8.w) >= 0.0f ? (r0.x) : (r4.x)), ((r8.w) >= 0.0f ? (r0.y) : (r4.y)), ((r8.w) >= 0.0f ? (r0.z) : (r4.z)));
    r1.w = (r0.w) * (r0.w);
    r0 = v1;
