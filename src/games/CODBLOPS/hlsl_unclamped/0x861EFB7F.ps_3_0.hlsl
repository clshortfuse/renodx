// Mechanically reconstructed from 0x861EFB7F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(0.0f, 1.0f, 0.200000003f, 0.797884583f);
    ...
    r2.x = dot(r4.xy, r0.xy) + (c2.w);
    r2.y = dot(r4.xy, r0.zw) + (c2.w);
    r0 = tex2D(s4, v6.zw);
    r4.w = (r0.w) * (v0.z) + (c2.z);
    r3.xy = float2(((r4.w) >= 0.0f ? (r2.x) : (r3.x)), ((r4.w) >= 0.0f ? (r2.y) : (r3.y)));
    r2.xyz = v4.xyz;
    ...
    r2.xyz = float3(((r1.w) >= 0.0f ? (r2.x) : (r3.x)), ((r1.w) >= 0.0f ? (r2.y) : (r3.y)), ((r1.w) >= 0.0f ? (r2.z) : (r3.z)));
    r1.xyz = (r1.xyz) * (r1.xyz) + (r7.xyz);
    r0.xyz = float3(((r4.w) >= 0.0f ? (r0.x) : (r2.x)), ((r4.w) >= 0.0f ? (r0.y) : (r2.y)), ((r4.w) >= 0.0f ? (r0.z) : (r2.z)));
