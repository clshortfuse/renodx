// Mechanically reconstructed from 0x2FD91A8E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(8.0f, 31.875f, 3.5f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r2.z = r0.y;
    r4 = tex2D(s1, v1.xy);
    r2.xy = (r4.wy) * (c1.xy) + (c1.zw);
    r3.xyz = (r3.xyz) + (c0.xxx);
    r4.xyz = float3(((r6.w) >= 0.0f ? (r2.x) : (c0.w)), ((r6.w) >= 0.0f ? (r2.y) : (c0.w)), ((r6.w) >= 0.0f ? (r2.z) : (c0.w)));
    r7.xyz = saturate((r3.xyz) * (r1.www) + (r1.xyz));
    r1 = v2;
    r1.xyz = (r4.xxx) * (v5.xyz) + (r1.xyz);
    r2.xyz = lerp(r7.xyz, c0.yyy, r0.xxx);
    r1.xyz = (r4.yyy) * (v4.xyz) + (r1.xyz);
    r8.xyz = normalize(r1.xyz);
    r6.xyz = normalize(v6.xyz);
    r2.w = r0.w;
    r0.w = dot(r6.xyz, r8.xyz);
    r2 = float4(((r6.w) >= 0.0f ? (r2.x) : (c0.w)), ((r6.w) >= 0.0f ? (r2.y) : (c0.w)), ((r6.w) >= 0.0f ? (r2.z) : (c0.w)), ((r6.w) >= 0.0f ? (r2.w) : (c0.z)));
    r0.w = (r0.w) + (r0.w);
    r3.w = (r2.w) * (c2.x);
    ...
    r3.xyz = (r1.xyz) * (c2.yyy);
    r0.w = (-(r0.w)) + (c0.z);
    r1.y = (r2.w) * (c2.z) + (c2.w);
    r1.z = (r0.w) * (r0.w);
    r2.w = 1.0f / (r1.y);
    r0.w = (r0.w) * (r1.z);
    r1.xyz = (r2.xyz) * (-(r2.xyz)) + (c0.zzz);
    r0.w = (r2.w) * (r0.w);
