// Mechanically reconstructed from 0x5F4879CA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = saturate((r3.xx) * (c[26].xy) + (c[26].zw));
    ...
    r1.w = (r1.w) * (r2.w);
    r13.xyz = (v0.yyy) * (r0.xyz) + (c14.yyy);
    r0 = tex2D(s4, v8.zw);
    r0.xyz = (r0.xyz) + (c14.xxx);
    r3.xyz = (r13.xyz) * (c14.zzz);
    r12.xyz = (v0.zzz) * (r0.xyz) + (c14.yyy);
    r0 = tex2D(s5, v9.xy);
    r0.xyz = (r0.xyz) + (c14.xxx);
    r3.xyz = (r3.xyz) * (r12.xyz);
    r6.xyz = (v0.www) * (r0.xyz) + (c14.yyy);
    r0 = tex2D(s1, v1.xy);
    ...
    r1.x = dot(r8.xy, r8.xy) + (c14.w);
    r0.z = dot(r0.xy, r0.xy) + (c14.w);
    r1.x = exp2(-(r1.x));
    r0.z = exp2(-(r0.z));
    r1.x = (r1.x) * (c1.x) + (c1.y);
    r2.w = (r0.z) * (c1.x) + (c1.y);
    r0.z = dot(r0.xy, r8.xy) + (c14.w);
    r0.y = (r1.x) * (r2.w);
    r3 = tex2D(s14, v1.zw);
    r8.xy = (r3.xy) * (c2.ww);
    ...
    r8.xz = (r2.xy) * (c4.xx);
    r8.y = (r2.w) + (r2.w);
    r3.xyz = (r5.www) * (r14.xyz);
    r4.xyz = (r8.xyz) * (r1.xxx) + (r0.xyz);
    r2 = tex2D(s0, v1.xy);
    r0.xyz = (r13.xyz) * (r2.xyz);
    r2.xyz = (r1.yyy) * (r4.xyz);
    r0.xyz = (r12.xyz) * (r0.xyz);
    r2.xyz = (r5.www) * (r11.xyz) + (r2.xyz);
