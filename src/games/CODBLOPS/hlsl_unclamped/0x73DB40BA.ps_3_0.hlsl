// Mechanically reconstructed from 0x73DB40BA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = (r1.w) * (r0.z);
    r0.x = -(r3.y);
    r13.xyz = (r2.xyz) * (r0.zzz);
    r0.y = (r0.x) + (c13.x);
    r14.xy = (r7.ww) * (r0.xy) + (r3.yy);
    r0.xy = (v1.zw) * (c2.xy);
    r2 = tex2D(s13, r0.xy);
