// Mechanically reconstructed from 0xB2A9EB1D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r4.w = (r0.w) * (v0.w) + (c1.x);
    r2.xy = float2(((r4.w) >= 0.0f ? (r1.x) : (c1.z)), ((r4.w) >= 0.0f ? (r1.y) : (c1.z)));
    ...
    r5.w = (r3.w) * (r5.w);
    r6.z = exp2(r6.y);
    r6.y = saturate(dot(r10.xyz, r3.xyz));
    r3.w = saturate(dot(r10.xyz, c[17].xyz));
    r3.x = pow(abs(r6.y), r6.z);
    r3.y = (r3.w) * (r7.w) + (r7.z);
    r3.z = (r6.z) * (c12.x) + (c12.y);
    r3.y = (r3.y) * (r6.w) + (c3.w);
    r3.z = (r3.x) * (r3.z);
    r3.y = 1.0f / (r3.y);
    r3.x = (r3.w) * (r3.y);
