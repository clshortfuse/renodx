// Mechanically reconstructed from 0x0A3EFF03.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.x = dot(r5.xy, r0.xy) + (c14.z);
    r2.y = dot(r5.xy, r0.zw) + (c14.z);
    r0 = tex2D(s4, v6.zw);
    r8.w = (r0.w) * (v0.z);
    ...
    r4.xyw = c[38].xyw;
    r4.xyz = (-(r4.xyw)) + (c[39].xyw);
    r3.xyz = (r2.www) * (r3.xyz);
    r4.xyz = (r7.www) * (r4.xyz) + (c[38].xyw);
