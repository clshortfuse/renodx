// Mechanically reconstructed from 0x537B4764.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xy = float2(((r5.w) >= 0.0f ? (r5.x) : (c1.z)), ((r5.w) >= 0.0f ? (r5.y) : (c1.z)));
    ...
    r4.z = saturate(dot(r15.xyz, r2.xyz));
    r2.w = (-(r0.w)) + (c1.y);
