// Mechanically reconstructed from 0x09EF0796.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2D(s0, v1.xy);
    r5.xyz = float3(((r3.w) >= 0.0f ? (r0.x) : (r1.x)), ((r3.w) >= 0.0f ? (r0.y) : (r1.y)), ((r3.w) >= 0.0f ? (r0.z) : (r1.z)));
    r1 = tex2D(s8, v7.xy);
    ...
    r2 = tex2D(s4, v7.zw);
    r2.w = (r2.w) * (v0.z);
    r3.xyz = lerp(r5.xyz, r2.xyz, r2.www);
    r2.xyz = float3(((r3.w) >= 0.0f ? (r1.y) : (c[8].x)), ((r3.w) >= 0.0f ? (r1.y) : (c[8].y)), ((r3.w) >= 0.0f ? (r1.y) : (c[8].w)));
    r5.xy = lerp(r7.xy, r6.xy, r2.ww);
    r1.xyz = -(r2.xyz);
    r8.xyz = (r3.xyz) * (r3.xyz);
    r1.w = (r1.y) + (-(c3.y));
    r9.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c3.yyy));
    r11.xyz = (r2.www) * (r1.xwz) + (r2.xyz);
