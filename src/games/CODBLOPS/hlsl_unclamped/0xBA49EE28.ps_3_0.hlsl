// Mechanically reconstructed from 0xBA49EE28.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (r1.w) * (v4.y);
    r0.y = dot(r5.xy, r5.xy) + (c0.x);
    r5.xyz = lerp(r3.xyz, r1.xyz, r0.www);
    r0.y = exp2(-(r0.y));
    r1 = tex2D(s14, v0.zw);
    r8.xy = (r1.xy) * (c1.ww);
    ...
    r3.y = (r0.z) + (r0.z);
    r0.xy = c0.xy;
    r1.xyz = (r0.xyx) + (-(c[29].xyw));
    r0.xyz = (r6.xyz) * (r1.www) + (r3.xyz);
    r6.xyz = (r0.www) * (r1.xyz) + (c[29].xyw);
