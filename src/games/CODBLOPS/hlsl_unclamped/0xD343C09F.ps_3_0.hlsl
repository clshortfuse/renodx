// Mechanically reconstructed from 0xD343C09F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xy = float2(((r8.w) >= 0.0f ? (r0.x) : (c1.w)), ((r8.w) >= 0.0f ? (r0.y) : (c1.w)));
    r0 = tex2D(s2, v6.zw);
    r7.w = (r0.w) * (v6.y) + (c1.z);
    r0.w = dot(r5.xy, r5.xy) + (c1.w);
    r7.xy = float2(((r7.w) >= 0.0f ? (r3.x) : (r6.x)), ((r7.w) >= 0.0f ? (r3.y) : (r6.y)));
    r1.w = exp2(-(r0.w));
    ...
    r1.xyz = (r6.xyz) * (r4.www) + (r4.xyz);
    r4.xyz = (r7.yyy) * (v3.xyz) + (r2.xyz);
    r2.x = c1.w;
    r2.xyz = float3(((r8.w) >= 0.0f ? (c[5].x) : (r2.x)), ((r8.w) >= 0.0f ? (c[5].y) : (r2.x)), ((r8.w) >= 0.0f ? (c[5].w) : (r2.x)));
    r9.xyz = normalize(r4.xyz);
    r8.xyz = float3(((r7.w) >= 0.0f ? (c[6].x) : (r2.x)), ((r7.w) >= 0.0f ? (c[6].y) : (r2.y)), ((r7.w) >= 0.0f ? (c[6].w) : (r2.z)));
    r6.w = saturate(dot(r9.xyz, c[17].xyz));
    r4.xyz = (r1.xyz) * (r8.yyy);
    r1.xyz = (r6.www) * (c[18].xyz);
    r2 = tex2D(s12, v0.zw);
    r7.xyz = (r2.yyy) * (r1.xyz) + (r4.xyz);
    r4 = tex2D(s4, v0.xy);
    r5 = float4(((r8.w) >= 0.0f ? (r4.x) : (-(c1.w))), ((r8.w) >= 0.0f ? (r4.y) : (-(c1.w))), ((r8.w) >= 0.0f ? (r4.z) : (-(c1.w))), ((r8.w) >= 0.0f ? (r4.w) : (-(c1.y))));
    r4 = float4(((r8.w) >= 0.0f ? (r3.x) : (c1.w)), ((r8.w) >= 0.0f ? (r3.y) : (c1.w)), ((r8.w) >= 0.0f ? (r3.z) : (c1.w)), ((r8.w) >= 0.0f ? (r3.w) : (c1.w)));
    r3 = tex2D(s5, v6.zw);
