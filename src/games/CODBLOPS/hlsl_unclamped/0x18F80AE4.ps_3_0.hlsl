// Mechanically reconstructed from 0x18F80AE4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = float4(((r11.z) >= 0.0f ? (r0.x) : (c1.z)), ((r11.z) >= 0.0f ? (r0.y) : (c1.z)), ((r11.z) >= 0.0f ? (r0.z) : (c1.z)), ((r11.z) >= 0.0f ? (r0.w) : (c1.y)));
    r1.w = rsqrt(r1.w);
    r0 = v1;
