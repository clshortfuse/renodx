// Mechanically reconstructed from 0x37858BE8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.xy = (r4.ww) * (-(r6.xy)) + (r6.xy);
    r0.z = dot(r3.xy, r3.xy) + (c12.x);
    r0.w = dot(r9.xy, r9.xy) + (c12.x);
    r0.z = exp2(-(r0.z));
    r0.w = exp2(-(r0.w));
    r0.z = (r0.z) * (c12.z) + (c12.w);
    r0.w = (r0.w) * (c12.z) + (c12.w);
    r0.x = (r0.z) * (r0.w);
    r0.z = dot(r3.xy, r9.xy) + (c12.x);
    r3 = tex2D(s14, v0.zw);
    r7.xy = (r3.xy) * (c2.ww);
