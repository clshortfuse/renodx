// Mechanically reconstructed from 0x01BFD392.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = (r0.z) + (r0.z);
    r10.w = (r4.w) * (r2.w);
    r1.xyz = (r9.xyz) * (r0.www) + (r8.xyz);
    r0 = tex2D(s0, v1.xy);
    r2.w = (r0.w) * (v0.w) + (c0.x);
    r0 = (r0.xyzx) * (c0.yyyz) + (c0.zzzy);
    r9.xyz = normalize(v5.xyz);
    r12.yz = c0.yz;
    r11.xyz = float3(((r2.w) >= 0.0f ? (c[44].x) : (r12.z)), ((r2.w) >= 0.0f ? (c[44].y) : (r12.z)), ((r2.w) >= 0.0f ? (c[44].w) : (r12.z)));
    r2.xyz = (r3.xyz) * (r3.www) + (-(r9.xyz));
