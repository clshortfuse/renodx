// Mechanically reconstructed from 0x7ECE322A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r2.w) * (r2.z);
    r2.w = (r6.z) * (r2.w);
    r6.y = max(abs(r5.y), abs(r5.z));
    r6.z = (r1.y) * (r2.w);
    r2.w = max(abs(r5.x), r6.y);
    r2.w = 1.0f / (r2.w);
    ...
    r9.xyz = (r6.xyz) * (r2.www);
    r2.xyz = (r1.yyy) * (r2.xyz);
    r2.xyz = (r2.xyz) * (c1.yyy);
    r9.w = dot(r10.xyz, r5.xyz);
    r6.xyz = (r2.www) * (r0.xyz) + (r2.xyz);
    r0.z = (r9.w) + (r9.w);
    r2.xyz = (r5.xyz) * (-(r0.zzz)) + (r10.xyz);
    r2.w = (r1.w) * (c1.x);
    r2 = texCUBElod(s15, r2);
    r0.xyz = (r2.xyz) * (r2.xyz);
    r6.xyz = (r4.xyz) * (r6.xyz) + (r9.xyz);
    ...
    r1.x = (r1.x) * (c2.x) + (c2.y);
    r1.z = (r1.z) * (r2.w);
    r5.xyz = (r0.xyz) * (r1.xxx);
    r2.xyz = (r1.zzz) * (c[8].xyz);
