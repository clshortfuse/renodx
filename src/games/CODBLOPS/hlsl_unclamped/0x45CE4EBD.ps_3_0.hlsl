// Mechanically reconstructed from 0x45CE4EBD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = (r8.www) * (r6.xyz) + (r4.xyz);
    r9.xyz = (v6.xyz) * (r7.www) + (r2.xyz);
    r2 = tex2D(s14, v7.zw);
    r5.xy = (r2.xy) * (c12.ww);
