// Mechanically reconstructed from 0x08C47BAC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c14 = float4(0.797884583f, 1.0f, 0.0009765625f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r1 = tex2D(s5, v1.xy);
    r12.xyz = (r1.xyz) * (-(r1.xyz)) + (c0.www);
    r13.xyz = (r1.xyz) * (r1.xyz);
    r16.w = (r1.w) * (-(c14.x)) + (c14.y);
    r17.z = (r1.w) * (c14.x);
    r8.w = saturate(dot(r10.xyz, r9.xyz));
    r0.z = saturate(dot(r9.xyz, -(r2.xyz)));
    r0.y = (r8.w) * (r16.w) + (r17.z);
    r15.w = (r0.z) * (r16.w) + (r17.z);
    r11.xyz = (r12.xyz) * (r2.www) + (r13.xyz);
    r0.y = (r0.y) * (r15.w) + (c14.z);
    r0.y = 1.0f / (r0.y);
    r1.y = max(abs(r9.y), abs(r9.z));
    r1.z = (r8.w) * (r0.y);
    r0.y = max(abs(r9.x), r1.y);
    r1.y = 1.0f / (r0.y);
    r0.xy = (r1.ww) * (c3.xy) + (c3.zw);
    r14.w = exp2(r0.y);
    r1.x = saturate(dot(r9.xyz, r3.xyz));
    r0.y = pow(abs(r1.x), r14.w);
    r12.w = (r14.w) * (c4.x) + (c4.y);
    r2.w = (r1.w) * (c0.y);
    r0.y = (r0.y) * (r12.w);
    r13.w = saturate(dot(r9.xyz, c[17].xyz));
    r9.w = (r1.z) * (r0.y);
    r1.z = 1.0f / (r0.x);
    r1.w = (-(r0.z)) + (c0.w);
    r1.x = (r1.w) * (r1.w);
    ...
    r0.z = (r13.w) * (r16.w) + (r17.z);
    r0.z = (r0.z) * (r15.w) + (c14.z);
    r3.z = saturate(dot(r9.xyz, r16.xyz));
    r0.y = 1.0f / (r0.z);
    r0.z = pow(abs(r3.z), r14.w);
    r0.y = (r13.w) * (r0.y);
    r0.z = (r12.w) * (r0.z);
    r3.xyz = (r3.www) * (r14.xyz) + (r15.xyz);
    r4.z = (r0.y) * (r0.z);
    r0.xyz = (r12.xyz) * (r11.www) + (r13.xyz);
    r4.w = dot(r2.xyz, r9.xyz);
    r0.xyz = (r4.zzz) * (r0.xyz);
    r4.w = (r4.w) + (r4.w);
    r4.xyz = (r0.xyz) * (c[37].www);
    r2.xyz = (r9.xyz) * (-(r4.www)) + (r2.xyz);
    ...
    r4.xyz = (r12.xyz) * (r10.www) + (r13.xyz);
    r2.xyz = (r3.www) * (r2.xyz);
    r0.xyz = (r0.xyz) * (r4.xyz);
    r3.xyz = (r8.xyz) * (r3.xyz) + (r2.xyz);
    r2.xyz = (r0.xyz) * (c[37].xxx);
    ...
    r2.xy = (r1.xy) * (-(c13.ww)) + (-(c13.yy));
    r1.xy = (r1.xy) * (r1.xy);
    r0.z = ((-abs(r0.z)) >= 0.0f ? (c14.w) : (r1.w));
    r1.w = (r2.x) * (r1.x);
    r0.z = (r0.z) * (r1.w);
    r1.w = (r1.y) * (-(r2.y)) + (c0.w);
    r0.xy = (r2.ww) * (r0.xy);
