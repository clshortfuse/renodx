// Mechanically reconstructed from 0xC2EF6918.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r16.xy = (r4.ww) * (r2.xy) + (r1.yy);
    r1.xyz = (r0.xyz) * (c[7].xyz);
    r0.xyz = (r3.xyz) * (r4.xyz);
    r6.xyz = (r16.xxx) * (r1.xyz);
    r1.xyz = (r0.xyz) * (r0.xyz);
    r0.z = dot(r8.xy, r8.xy) + (c12.w);
    ...
    r4.xy = (r4.xz) * (r0.xx);
    r0.z = dot(r7.xy, r8.xy) + (c12.w);
    r2.w = (r3.x) * (c3.w) + (-(r4.x));
    r2.w = (r4.z) * (-(r0.x)) + (r2.w);
    r2.xy = (r2.xz) * (r0.yy);
    r3.w = (r3.y) * (c3.w) + (-(r2.x));
    r0.x = dot(r7.xy, r7.xy) + (c12.w);
    r0.y = (r2.z) * (-(r0.y)) + (r3.w);
    r0.x = exp2(-(r0.x));
    r10.y = (r2.w) + (r2.w);
    r0.x = (r0.x) * (c1.x) + (c1.y);
    ...
    r2.xyz = (v7.xyz) * (-(r14.www)) + (c[17].xyz);
    ...
    r2.y = (r2.y) * (r2.y);
    r2.y = (r2.z) * (r2.y);
    r2.z = (r9.w) * (r12.w) + (r13.w);
    r2.x = (r2.z) * (r11.w) + (c15.x);
    r2.z = saturate(dot(r13.xyz, r0.xyz));
    r0.y = 1.0f / (r2.x);
    r0.z = pow(abs(r2.z), r10.w);
    r0.y = (r9.w) * (r0.y);
    r0.z = (r8.w) * (r0.z);
    r2.z = (r0.y) * (r0.z);
    r0.xyz = (r11.xyz) * (r2.yyy) + (r12.xyz);
    r0.xyz = (r2.zzz) * (r0.xyz);
    r0.xyz = (r16.xxx) * (r0.xyz);
    r2.xyz = (r0.xyz) * (c[19].xyz);
    r0.xyz = (r2.www) * (r8.xyz) + (r15.xyz);
    r2.xyz = (r2.www) * (r2.xyz);
    r8.xyz = (r1.xyz) * (r0.xyz) + (r2.xyz);
    r0.z = (-(r7.w)) + (c12.x);
    r0.x = 1.0f / (r17.x);
    r0.y = (r0.z) * (r0.z);
    r0.y = (r0.z) * (r0.y);
