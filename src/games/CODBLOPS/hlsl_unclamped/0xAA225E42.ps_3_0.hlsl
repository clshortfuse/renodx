// Mechanically reconstructed from 0xAA225E42.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c3 = float4(1.0f, -0.0f, 1000.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = tex2D(s4, r5.xy);
    r1.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r3.xy = (c[36].xx) * (r1.xy) + (r2.xy);
    r1.xyz = v2.xyz;
    r2.xyz = (r1.zxy) * (v0.yzx);
    r1.xyz = (r1.yzx) * (v0.zxy) + (-(r2.xyz));
    r2.xyz = (vPos.yyy) * (c[29].xyz);
    r1.xyz = (r3.yyy) * (-(r1.xyz));
    r2.xyz = (vPos.xxx) * (c[28].xyz) + (r2.xyz);
    ...
    r0.w = saturate((r0.w) * (r1.w) + (c[38].x));
