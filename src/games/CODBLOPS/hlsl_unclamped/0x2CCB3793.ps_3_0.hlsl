// Mechanically reconstructed from 0x2CCB3793.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xyz = float3(((r5.w) >= 0.0f ? (r0.y) : (c[32].x)), ((r5.w) >= 0.0f ? (r0.y) : (c[32].y)), ((r5.w) >= 0.0f ? (r0.y) : (c[32].w)));
    r1 = tex2D(s11, v7.zw);
