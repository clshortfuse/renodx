// Mechanically reconstructed from 0x466242B4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.y = dot(r1.xy, r0.zw) + (c43.w);
    r4.x = dot(r1.xy, r0.xy) + (c43.w);
    r2 = tex2D(s0, v1.xy);
    r1 = tex2D(s5, v7.xy);
    r4.z = (r1.w) * (v0.y);
    r0 = tex2D(s1, v1.xy);
    r0.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r5.xy = (r4.zz) * (-(r0.xy)) + (r0.xy);
    r0 = tex2D(s6, v7.zw);
    r4.w = (r0.w) * (v0.z);
    r3.xyz = lerp(r2.xyz, r1.xyz, r4.zzz);
    r10.xy = lerp(r5.xy, r4.xy, r4.ww);
    ...
    r9.xz = (r3.xy) * (c12.xx);
    r5.w = c43.z;
    r0.xyz = (r5.www) + (-(c[39].xyw));
    r7.xyz = (r9.xyz) * (r3.www) + (r1.xyz);
    r8.xyz = (r4.zzz) * (r0.xyz) + (c[39].xyw);
    r2 = tex2D(s8, v1.xy);
    r1 = tex2D(s9, v7.zw);
    ...
    r13.xyz = lerp(r8.xyz, c[40].xyw, r4.www);
    r1.w = (-(r1.w)) + (c43.z);
    r12.xyz = (r7.xyz) * (r13.yyy);
    r1.z = (r1.w) * (r1.w);
