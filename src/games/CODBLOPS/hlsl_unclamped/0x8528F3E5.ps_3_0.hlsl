// Mechanically reconstructed from 0x8528F3E5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (r1.z) * (r1.z);
    r10.xyz = (v0.yyy) * (r0.xyz) + (c12.yyy);
    r3.w = (r1.w) * (r0.w);
    r3.xyz = (r10.xyz) * (c12.zzz);
    r0 = tex2D(s4, v8.zw);
    r1 = tex2D(s1, v1.xy);
    r5.xy = (r1.wy) * (c0.xy) + (c0.zw);
    r1.xyz = (r0.xyz) + (c12.xxx);
    r0 = v2;
    r0.xyz = (r5.xxx) * (v5.xyz) + (r0.xyz);
    r6.xyz = (v0.zzz) * (r1.xyz) + (c12.yyy);
    ...
    r2.w = dot(r5.xy, r5.xy) + (c12.w);
    r2.y = dot(r3.xy, r3.xy) + (c12.w);
    r2.w = exp2(-(r2.w));
    r2.y = exp2(-(r2.y));
    r2.w = (r2.w) * (c1.x) + (c1.y);
    r3.w = (r2.y) * (c1.x) + (c1.y);
    r2.y = dot(r3.xy, r5.xy) + (c12.w);
    r4.w = (r2.w) * (r3.w);
    r3 = tex2D(s14, v1.zw);
    r13.xy = (r3.xy) * (c2.ww);
