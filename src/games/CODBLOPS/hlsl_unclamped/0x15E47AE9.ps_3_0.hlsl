// Mechanically reconstructed from 0x15E47AE9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s13, r1.xy);
    r0.w = r2.y;
    r12.xy = lerp(r6.xy, r3.xy, r6.ww);
    r1.xy = (r0.wy) * (c12.xx) + (c12.yy);
    r0.y = dot(r12.xy, r12.xy) + (c3.z);
    r0.w = dot(r1.xy, r1.xy) + (c3.z);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r7.w = (r0.y) * (c4.x) + (c4.y);
    r0.y = (r0.w) * (c4.x) + (c4.y);
    r0.w = dot(r1.xy, r12.xy) + (c3.z);
    r0.y = (r7.w) * (r0.y);
    r1 = tex2D(s14, v1.zw);
    r6.xy = (r1.xy) * (c11.ww);
    ...
    r8.xyz = v2.xyz;
    r8.xyz = (r12.xxx) * (v4.xyz) + (r8.xyz);
    r11.xyz = lerp(r1.yyy, c[8].xyw, r6.www);
    r1.xyz = (r12.yyy) * (v3.xyz) + (r8.xyz);
    r15.xyz = (r6.xyz) * (r11.yyy);
