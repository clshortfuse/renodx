// Mechanically reconstructed from 0xA9098C08.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r0.w) * (r1.w);
    r5.xy = (r5.xz) * (r10.yy);
    r0.w = dot(r11.xy, r6.xy) + (c1.z);
    r0.y = (r4.y) * (c3.z) + (-(r5.x));
    r0.w = saturate((r0.w) * (r2.w) + (r2.w));
    r0.y = (r5.z) * (-(r10.y)) + (r0.y);
    r5.xz = (r5.xy) * (c3.ww);
    r5.y = (r0.y) + (r0.y);
    ...
    r3.xyz = (r8.xyz) * (r7.www) + (-(r5.xyz));
    r5.xyz = (r0.xyz) * (c2.zzz);
    r2 = tex2D(s0, v0.xy);
    r0.y = (r6.z) * (c2.w);
    r0.z = (r6.z) * (-(c13.x)) + (c13.y);
