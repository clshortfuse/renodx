// Mechanically reconstructed from 0x1F3892BD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = (r8.www) * (v6.xyz);
    r6.xyz = (r5.www) * (r6.xyz) + (r10.xyz);
    ...
    r1.y = saturate(dot(r9.xyz, r7.xyz));
    r1.z = exp2(r11.y);
