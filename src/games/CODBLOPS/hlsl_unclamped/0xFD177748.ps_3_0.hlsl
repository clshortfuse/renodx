// Mechanically reconstructed from 0xFD177748.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.xy = saturate((r3.xx) * (c[20].xy) + (c[20].zw));
    r3.xyz = normalize(v7.xyz);
    r6.xy = (r0.xy) * (r0.xy);
    r5.xyz = (r5.xyz) * (r1.www) + (-(r3.xyz));
    r7.xy = (r0.xy) * (c2.zz) + (c2.ww);
    ...
    r0.w = (r3.w) * (r0.w);
    r2.w = (r2.w) * (r2.w);
    r4.w = saturate(dot(r2.xyz, r0.xyz));
    r0.y = (r1.w) * (r2.w);
