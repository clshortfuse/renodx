// Mechanically reconstructed from 0x3E322F5C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r8.y = (r0.z) + (r0.z);
    r6.w = c1.x;
    r1.xyz = (r6.www) + (-(c[31].xyw));
    r0.xyz = (r8.xyz) * (r3.www) + (r3.xyz);
    r11.xyz = (r2.www) * (r1.xyz) + (c[31].xyw);
