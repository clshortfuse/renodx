// Mechanically reconstructed from 0x6A1FE53D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.z = (r0.w) * (v0.w) + (c1.x);
    r0.w = (r1.z) * (r1.z);
    r3.xy = float2(((r4.z) >= 0.0f ? (r1.x) : (c1.z)), ((r4.z) >= 0.0f ? (r1.y) : (c1.z)));
    r3.z = (r1.w) * (r0.w);
    r1 = v2;
    ...
    r8.w = saturate(dot(r11.xyz, -(r12.xyz)));
    ...
    r2.y = exp2(r15.y);
    r4.w = saturate(dot(r11.xyz, c[17].xyz));
    r0.x = pow(abs(r3.w), r2.y);
    r0.y = (r4.w) * (r0.z) + (r0.y);
    r0.z = (r2.y) * (c12.x) + (c12.y);
    r0.y = (r0.y) * (r2.z) + (c3.w);
    r0.z = (r0.x) * (r0.z);
    r0.y = 1.0f / (r0.y);
    r0.y = (r4.w) * (r0.y);
    r2.y = max(abs(r11.y), abs(r11.z));
    r2.z = (r0.z) * (r0.y);
    r0.z = max(abs(r11.x), r2.y);
    r3.w = 1.0f / (r0.z);
    ...
    r3 = tex3D(s11, r0.xyz);
    r0.y = c1.z;
    r1.xyz = float3(((r4.z) >= 0.0f ? (c[7].x) : (r0.y)), ((r4.z) >= 0.0f ? (c[7].y) : (r0.y)), ((r4.z) >= 0.0f ? (c[7].w) : (r0.y)));
    r0.xyz = (r3.xyz) * (r3.xyz);
    r2.xyz = (r2.xyz) * (r1.zzz);
    r3.xyz = (r1.yyy) * (r0.xyz);
    r16.xy = c[6].xy;
    r0.xyz = (r16.xxx) * (c[18].xyz);
    r14.xyz = (r3.xyz) * (c3.xxx);
    r13.xyz = (r4.www) * (r0.xyz);
    if ((c1.y) >= (v6.w))
    {
        r4 = (v6.xyzx) * (c1.yyyz);
        r3 = (r4) + (-(c13.xyzz));
    ...
    r0.xyz = (r16.yyy) * (c[19].xyz);
    r4.xyz = (r1.zzz) * (r13.xyz) + (r14.xyz);
