// Mechanically reconstructed from 0x1D5A2154.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.y = (r0.z) + (r0.z);
    r0.yz = c1.yz;
    r4.xyz = float3(((r4.w) >= 0.0f ? (r0.y) : (c[29].x)), ((r4.w) >= 0.0f ? (r0.z) : (c[29].y)), ((r4.w) >= 0.0f ? (r0.y) : (c[29].w)));
    r1 = tex2D(s5, v7.zw);
    r2.w = (r1.w) * (v0.z) + (c1.x);
    r0.xyz = (r7.xyz) * (r0.www) + (r5.xyz);
    r6.xyz = float3(((r2.w) >= 0.0f ? (c1.y) : (r4.x)), ((r2.w) >= 0.0f ? (c1.z) : (r4.y)), ((r2.w) >= 0.0f ? (c1.y) : (r4.z)));
