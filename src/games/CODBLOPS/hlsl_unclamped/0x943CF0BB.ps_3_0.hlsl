// Mechanically reconstructed from 0x943CF0BB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.x = saturate((c[21].x) * (v7.z));
    r1.xy = v4.xy;
    r1.zw = (r1.xy) * (c[26].xx) + (v7.xy);
    r4 = tex2D(s8, r1.zw);
    r0.yzw = (r0.yzw) * (c[6].xxx);
    r1.z = saturate(dot(r3.xyz, r2.xyz));
    r0.yzw = (r0.yzw) * (r1.zzz);
    r1.z = max(abs(r3.y), abs(r3.z));
    r2.x = max(abs(r3.x), r1.z);
    ...
    r1 = tex2D(s8, r1.xy);
    r5 = tex2D(s5, v4.xy);
    r1.xzw = (r5.xyz) * (r5.xyz);
    r4.yzw = (r5.xyz) * (-(r5.xyz)) + (c0.zzz);
    r4.yzw = (r1.yyy) * (r4.yzw) + (r1.xzw);
    r0.yzw = (r2.xyz) * (c0.www) + (r0.yzw);
    r2.xyz = (r4.yzw) * (r0.yzw);
    ...
    r6.xyz = (r0.yzw) * (r6.xyz) + (r1.yzw);
    r2 = max(r6, c1.yyyy);
    r0.y = saturate((r0.x) * (c15.z));
    r0.y = rsqrt(r0.y);
    r0.y = 1.0f / (r0.y);
    r1.yzw = lerp(r2.xyz, r4.yzw, r0.yyy);
    r0.xy = (r0.xx) + (c13.xy);
    r0.xy = saturate((r0.xy) * (c15.ww));
    r0.x = rsqrt(r0.x);
    r0.x = 1.0f / (r0.x);
    r2.xyz = (r7.xyz) * (r3.xyz) + (-(r1.yzw));
    r0.xzw = (r0.xxx) * (r2.xyz) + (r1.yzw);
    r0.y = rsqrt(r0.y);
    r0.y = 1.0f / (r0.y);
    r1.yzw = (r5.xyz) * (c13.zzz) + (-(r0.xzw));
    r0.xyz = (r0.yyy) * (r1.yzw) + (r0.xzw);
    r1.x = ((r1.x) >= 0.0f ? (c1.x) : (c1.y));
    oC0.w = (r2.w) * (r1.x);
    r0.w = c1.x;
    r1.x = dot(r0, c[9]);
    r1.y = dot(r0, c[10]);
