// Mechanically reconstructed from 0xDD1F331F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c29 = float4(-0.109375f, 30.0f, -0.0700000003f, 1.88679242f);
    const float4 c30 = float4(-2.0f, 3.0f, 1.29999995f, 0.0f);
    const float4 c31 = float4(249.63504f, -31.7392902f, 0.769999981f, 0.370000005f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0.z = saturate(dot(r0.zwy, r8.xyz));
    r0.z = (r3.z) + (r0.z);
    r0.z = (r0.z) * (c14.w);
    r3.y = max(c4.w, r0.z);
    r0.z = 1.0f / (r3.y);
    ...
    r0.w = (r0.z) + (r0.z);
    r9.xyz = (r7.xyz) * (-(r0.www)) + (r9.xyz);
    r9.w = (r3.x) * (c15.w);
    r9 = texCUBElod(s15, r9);
    r3.xyw = (r9.xyz) * (r9.xyz);
    r3.xyw = (r3.xyw) * (c15.www);
    r9 = tex3D(s11, v6.xyz);
    r9.xyz = (r9.xyz) * (r9.xyz);
    r3.xyw = (r3.xyw) * (r9.xyz);
    r3.xyw = (r3.xyw) * (c[22].xxx);
    r3.xyw = (r3.xyw) * (c16.xxx);
    r9 = tex2D(s6, v5.xy);
    r10 = tex2D(s5, v5.xy);
    r9 = (r2.wwww) * (r10) + (r9);
    r0.z = saturate(r0.z);
    ...
    r2.xyz = (c[7].xxx) * (r3.xyw) + (r2.xyz);
    r0.z = max(abs(r7.y), abs(r7.z));
    r3.x = max(abs(r7.x), r0.z);
    r10.xyz = (r7.xyz) * (c[5].xyz);
    r0.z = 1.0f / (r3.x);
    r3.xyw = (r10.xyz) * (r0.zzz) + (v6.xyz);
    r10 = tex3D(s11, r3.xyw);
    r3.xyw = (r10.xyz) * (r10.xyz);
    r5.x = c[6].x;
    ...
    r0.w = (r0.w) * (r0.w);
    r0.z = (r0.z) * (r0.w);
    r0.w = (r0.w) * (c29.x) + (c29.y);
    r0.z = (r0.z) * (c16.w);
    r4.x = saturate(dot(r7.xyz, r8.xyz));
    ...
    r0.yzw = (r3.xyw) * (c16.xxx) + (r0.yzw);
    r3.x = (r3.z) + (c29.z);
    r3.x = saturate((r3.x) * (c29.w));
    r3.y = (r3.x) * (c30.x) + (c30.y);
    r3.x = (r3.x) * (r3.x);
    r3.x = saturate((r3.y) * (r3.x));
    r3.yzw = (r5.yzw) * (v4.xyz);
    r4.xyz = (r3.yzw) * (c[23].xxx);
    r5.xyz = (r3.yzw) * (c[24].xxx);
    r7.x = log2(abs(abs(r5.x)));
    r7.y = log2(abs(abs(r5.y)));
    r7.z = log2(abs(abs(r5.z)));
    r5.xyz = (r7.xyz) * (c30.zzz);
    r7.x = exp2(r5.x);
    r7.y = exp2(r5.y);
    r7.z = exp2(r5.z);
    r3.yzw = (r3.yzw) * (-(c[23].xxx)) + (r7.xyz);
    ...
    r1.yzw = (r9.xyz) * (r2.xyz);
    r0.xyz = (r0.xyz) * (r5.xyz) + (r1.yzw);
    r1.yzw = max(r0.xyz, c3.yyy);
    r0.xyz = (r1.xxx) * (c[27].xyz) + (r1.yzw);
    r1 = c[8];
    r0.w = (r1.w) * (c[21].x);
    r2.xyz = lerp(c3.xxx, r1.xyz, r0.www);
