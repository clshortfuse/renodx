// Mechanically reconstructed from 0x0153B8AE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = dot(r5.xy, r5.xy) + (c7.x);
    r0.w = dot(r1.xy, r1.xy) + (c7.x);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r2.w = (r0.y) * (c7.z) + (c7.w);
    r0.y = (r0.w) * (c7.z) + (c7.w);
    r0.w = dot(r1.xy, r5.xy) + (c7.x);
    r0.y = (r2.w) * (r0.y);
    r1 = tex2D(s14, v0.zw);
    r6.xy = (r1.xy) * (c3.ww);
