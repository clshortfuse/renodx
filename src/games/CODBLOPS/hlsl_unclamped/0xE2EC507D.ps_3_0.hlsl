// Mechanically reconstructed from 0xE2EC507D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r1.xyz = lerp(r0.xyz, c1.xxx, r3.xxx);
    r6.xyz = (r1.xyz) * (-(r1.xyz)) + (c1.www);
