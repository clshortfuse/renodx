// Mechanically reconstructed from 0x512EA54E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = rsqrt(r0.w);
    r12.xyz = (r6.www) * (v6.xyz);
    r1.w = saturate((r1.w) * (r0.z) + (r0.z));
    r4.xyz = (r2.xyz) * (r0.www) + (-(r12.xyz));
    ...
    r2.w = saturate((r1.w) * (c[30].x) + (c[30].y));
    r0.xyz = (r3.yyy) * (v3.xyz) + (r0.xyz);
    r9.xyz = normalize(r0.xyz);
    r5.z = (r3.w) * (c3.w);
    r1.w = saturate(dot(r4.xyz, r9.xyz));
    r11.w = saturate(dot(r9.xyz, -(r12.xyz)));
    r0.z = (r1.w) * (r4.w) + (r5.z);
    r3.x = (r11.w) * (r4.w) + (r5.z);
    r0.x = (r2.w) * (c16.z) + (c16.w);
    r0.z = (r0.z) * (r3.x) + (c15.x);
    r0.y = (r2.w) * (r2.w);
    r0.z = 1.0f / (r0.z);
    r7.w = (r0.x) * (r0.y);
    r2.w = (r1.w) * (r0.z);
    r12.w = dot(r12.xyz, r9.xyz);
    r14.xy = (r3.ww) * (c37.xy) + (c37.zw);
    r3.y = exp2(r14.y);
    r1.z = saturate(dot(r9.xyz, r1.xyz));
    r0.z = pow(abs(r1.z), r3.y);
    ...
    r1.z = (r3.z) * (r1.z);
    r1.x = (r2.w) * (r1.y);
    r1.y = (r9.w) * (r2.z) + (r10.w);
    r1.z = (r1.z) * (r1.x);
    r8.xyz = (r8.www) * (r0.xyz);
    r0.z = (r1.y) * (r1.z);
    ...
    r0.xyz = (r1.www) * (r10.xyz) + (r13.xyz);
    r1.xyz = (r1.www) * (r1.xyz);
    r8.xyz = (r7.xyz) * (r3.xyz) + (r8.xyz);
    r10.xyz = (r7.xyz) * (r0.xyz) + (r1.xyz);
    r0.z = (r12.w) + (r12.w);
    r1 = (v6.yyyy) * (c[32]);
    r0.x = 1.0f / (r14.x);
    r1 = (v6.xxxx) * (c[31]) + (r1);
    ...
    r0.y = (r0.x) * (r0.y);
    r6.zw = r4.zw;
    r5.z = (r9.w) * (r0.y) + (r10.w);
    r2.zw = r6.zw;
    r1.xy = (r5.ww) * (-(c[35].zw)) + (r5.xy);
    r1.zw = r2.zw;
    r1 = tex2Dproj(s2, r1);
    r1.w = r1.x;
