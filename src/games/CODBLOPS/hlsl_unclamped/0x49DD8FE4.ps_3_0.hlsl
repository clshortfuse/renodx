// Mechanically reconstructed from 0x49DD8FE4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.z = saturate(dot(r10.xyz, r7.xyz));
    ...
    r7.w = 1.0f / (r7.x);
    r1.xyz = (r1.xyz) * (c[42].www);
    r5.xyz = (r1.xyz) * (c[38].xyz);
    r7.xy = saturate((r11.xx) * (c[40].xy) + (c[40].zw));
    r7.z = dot(c[39].yz, r11.xy) + (c[39].x);
    r1.xy = (r7.xy) * (r7.xy);
