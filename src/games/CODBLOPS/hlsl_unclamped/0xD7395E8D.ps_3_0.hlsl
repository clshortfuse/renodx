// Mechanically reconstructed from 0xD7395E8D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = (r12.xyz) * (r3.xyz) + (r5.xyz);
    r5.xyz = (r1.xyz) * (r0.www) + (-(r11.xyz));
    r3 = tex2D(s7, v1.xy);
