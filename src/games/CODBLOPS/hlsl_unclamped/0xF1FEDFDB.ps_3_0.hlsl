// Mechanically reconstructed from 0xF1FEDFDB.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r9.xyz = (r4.xyz) * (r3.www) + (-(r2.xyz));
    r10.xyz = normalize(v2.xyz);
    r4.xyz = normalize(r9.xyz);
    r9.z = saturate(dot(r10.xyz, r1.xyz));
    r1.w = saturate(dot(r4.xyz, r1.xyz));
    r1.xyz = (r9.zzz) * (c[36].xyz);
    r1.w = (-(r1.w)) + (c0.y);
    r1.xyz = (r10.www) * (r1.xyz) + (r8.xyz);
    r3.w = (r1.w) * (r1.w);
    r9.x = saturate(dot(r10.xyz, r4.xyz));
    r3.w = (r3.w) * (r3.w);
    r4.z = (r1.w) * (r3.w);
    ...
    r4.xy = (r8.yy) * (c13.xy) + (c13.zw);
    r9.y = 1.0f / (r1.w);
    r7.w = exp2(r4.y);
    r5.w = (r7.w) * (c12.y) + (c12.z);
    r1.w = pow(abs(r9.x), r7.w);
    r4.y = (r9.z) * (r9.y);
    r1.w = (r5.w) * (r1.w);
    r4.z = (r2.w) * (r4.z) + (r3.w);
    r1.w = (r4.y) * (r1.w);
