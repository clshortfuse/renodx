// Mechanically reconstructed from 0x85BC7174.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = 1.0f / (r1.z);
    r3.w = (r3.z) * (r1.z);
    r3.xy = (r1.ww) * (c13.xy) + (c13.zw);
    r2.y = saturate(dot(r0.xyz, r2.xyz));
    r2.z = exp2(r3.y);
    r1.x = pow(abs(r2.y), r2.z);
    r1.z = (r2.z) * (c3.x) + (c3.y);
    r7.xyz = (r3.zzz) * (c[6].xyz);
    r1.z = (r1.x) * (r1.z);
    r1.x = 1.0f / (r3.x);
    r1.z = (r3.w) * (r1.z);
    r2.w = (r2.w) * (r1.z);
