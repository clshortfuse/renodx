// Mechanically reconstructed from 0x113F4C7D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (r0.w) * (-(v7.x)) + (c13.w);
    r5.w = (r0.w) * (-(r1.w)) + (c13.w);
    ...
    r0 = tex2D(s12, v0.zw);
    r0.w = ((-abs(r0.y)) >= 0.0f ? (c13.w) : (c13.z));
