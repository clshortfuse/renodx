// Mechanically reconstructed from 0x9B35EE05.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xyz = lerp(r0.yyy, c[28].xyw, r6.www);
    r0.xy = (r3.ww) * (c13.xy) + (c13.zw);
    r1.y = exp2(r0.y);
    r8.w = 1.0f / (r0.x);
    r0.x = pow(abs(r1.x), r1.y);
    r0.y = (r1.y) * (c12.y) + (c12.z);
    r1.x = (r0.x) * (r0.y);
    r2.z = (r3.w) * (c3.z);
    r0.x = (r3.w) * (-(c4.z)) + (c4.w);
