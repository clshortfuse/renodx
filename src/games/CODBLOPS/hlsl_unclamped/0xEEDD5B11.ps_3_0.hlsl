// Mechanically reconstructed from 0xEEDD5B11.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = (r4.y) * (c12.x) + (-(r6.x));
    r7.xz = (r6.xy) * (c12.yy);
    r2.y = (r6.z) * (-(r8.y)) + (r2.y);
    r7.y = (r2.y) + (r2.y);
    r2.xy = (r2.xz) * (r8.xx);
    r6.xyz = (r0.www) * (r7.xyz);
    r0.w = (r4.x) * (c12.x) + (-(r2.x));
    r7.xz = (r2.xy) * (c12.yy);
    r4.xyz = v2.xyz;
    ...
    r2 = tex2D(s7, v6.xy);
    r5 = float4(((r7.w) >= 0.0f ? (r2.x) : (r5.x)), ((r7.w) >= 0.0f ? (r2.y) : (r5.y)), ((r7.w) >= 0.0f ? (r2.z) : (r5.z)), ((r7.w) >= 0.0f ? (r2.w) : (r5.w)));
    r2 = tex2D(s8, v6.zw);
