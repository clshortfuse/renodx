// Mechanically reconstructed from 0x9BBC6158.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = float4(((r5.z) >= 0.0f ? (r0.x) : (c1.w)), ((r5.z) >= 0.0f ? (r0.y) : (c1.w)), ((r5.z) >= 0.0f ? (r0.z) : (c1.w)), ((r5.z) >= 0.0f ? (r0.w) : (c1.w)));
    r0 = tex2D(s5, v7.zw);
    r5.w = (r0.w) * (v7.y) + (c1.z);
    r0 = (r0.xyzx) * (-(c1.yyyw)) + (-(c1.wwwy));
    r2.xy = (r2.wy) * (c0.xy) + (c0.zw);
    r0 = float4(((r5.w) >= 0.0f ? (r0.x) : (r1.x)), ((r5.w) >= 0.0f ? (r0.y) : (r1.y)), ((r5.w) >= 0.0f ? (r0.z) : (r1.z)), ((r5.w) >= 0.0f ? (r0.w) : (r1.w)));
    r5.xy = float2(((r5.z) >= 0.0f ? (r2.x) : (c1.w)), ((r5.z) >= 0.0f ? (r2.y) : (c1.w)));
    r8.xyz = (r0.xyz) * (r0.xyz);
    r1 = tex2D(s7, v0.xy);
    r2 = float4(((r5.z) >= 0.0f ? (r1.x) : (-(c1.w))), ((r5.z) >= 0.0f ? (r1.y) : (-(c1.w))), ((r5.z) >= 0.0f ? (r1.z) : (-(c1.w))), ((r5.z) >= 0.0f ? (r1.w) : (-(c1.y))));
    r1 = tex2D(s8, v7.zw);
    r3 = float4(((r5.w) >= 0.0f ? (r1.x) : (r2.x)), ((r5.w) >= 0.0f ? (r1.y) : (r2.y)), ((r5.w) >= 0.0f ? (r1.z) : (r2.z)), ((r5.w) >= 0.0f ? (r1.w) : (r2.w)));
    r5.xy = float2(((r5.w) >= 0.0f ? (r4.x) : (r5.x)), ((r5.w) >= 0.0f ? (r4.y) : (r5.y)));
    r10.w = (r3.w) * (-(c4.x)) + (c4.y);
    ...
    r11.xz = (r6.xy) * (c12.yy);
    r2.xyz = (r1.xyz) * (r1.www) + (-(r16.xyz));
    r15.xyz = normalize(r2.xyz);
    r17.xyz = (r1.xyz) * (r1.www);
    r0.xyz = (r11.xyz) * (r6.www) + (r0.xyz);
    r1.w = saturate(dot(r15.xyz, r17.xyz));
    r19.yw = c1.yw;
    r1.xyz = float3(((r5.z) >= 0.0f ? (c[36].x) : (r19.w)), ((r5.z) >= 0.0f ? (c[36].y) : (r19.w)), ((r5.z) >= 0.0f ? (c[36].w) : (r19.w)));
    r1.w = (-(r1.w)) + (-(c1.y));
    r10.xyz = float3(((r5.w) >= 0.0f ? (c[37].x) : (r1.x)), ((r5.w) >= 0.0f ? (c[37].y) : (r1.y)), ((r5.w) >= 0.0f ? (c[37].w) : (r1.z)));
    r1.z = (r1.w) * (r1.w);
