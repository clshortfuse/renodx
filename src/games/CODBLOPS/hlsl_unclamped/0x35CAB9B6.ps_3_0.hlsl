// Mechanically reconstructed from 0x35CAB9B6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.y = dot(r1.xy, r0.zw) + (c16.z);
    r4.x = dot(r1.xy, r0.xy) + (c16.z);
    r0 = tex2D(s1, v1.xy);
    ...
    r1 = tex2D(s13, r1.xy);
    r0.w = r1.y;
    r8.xy = lerp(r5.xy, r4.xy, r5.ww);
    r4.xy = (r0.wy) * (c10.xx) + (c10.yy);
    r0.y = dot(r8.xy, r8.xy) + (c16.z);
    r0.w = dot(r4.xy, r4.xy) + (c16.z);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r3.w = (r0.y) * (c3.x) + (c3.y);
    r0.y = (r0.w) * (c3.x) + (c3.y);
    r0.w = dot(r4.xy, r8.xy) + (c16.z);
    r0.y = (r3.w) * (r0.y);
    r4.xyz = lerp(r3.xyz, r2.xyz, r5.www);
    ...
    r2.w = (r0.w) * (-(c10.z)) + (c10.w);
    r3.z = saturate(dot(r12.xyz, r2.xyz));
    r2.z = (r0.w) * (c3.w);
