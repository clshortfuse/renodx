// Mechanically reconstructed from 0x3324D705.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s13, r0.xy);
    r2.w = r0.y;
    r3.xyz = (r1.xyz) * (r1.xyz) + (-(r4.xyz));
    r5.xy = (r2.yw) * (c3.yy) + (c3.zz);
    r1 = tex2D(s1, v1.xy);
    r7.xy = (r1.wy) * (c0.xy) + (c0.zw);
    r0.w = dot(r5.xy, r5.xy) + (c2.x);
    r0.y = dot(r7.xy, r7.xy) + (c2.x);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c2.y) + (c2.z);
    r3.w = (r0.y) * (c2.y) + (c2.z);
    r3.xyz = (v4.www) * (r3.xyz) + (r4.xyz);
    r2.w = (r0.w) * (r3.w);
    r1 = tex2D(s14, v1.zw);
    r6.xy = (r1.xy) * (c3.xx);
    r0.w = dot(r5.xy, r7.xy) + (c2.x);
    r0.xy = (r0.xz) * (r6.yy);
    r1.w = saturate((r0.w) * (r2.w) + (r2.w));
    r0.w = (r1.y) * (c3.x) + (-(r0.x));
    r5.xz = (r0.xy) * (c3.yy);
    r0.w = (r0.z) * (-(r6.y)) + (r0.w);
    r5.y = (r0.w) + (r0.w);
    r0 = v2;
    r4.xyz = (r7.xxx) * (v5.xyz) + (r0.xyz);
    r0.xyz = (r1.www) * (r5.xyz);
    r4.xyz = (r7.yyy) * (v4.xyz) + (r4.xyz);
    ...
    r2.z = (r2.w) + (r2.w);
    r2.w = (r1.w) * (c2.w);
    r2.xyz = (r5.xyz) * (-(r2.zzz)) + (r7.xyz);
    r2 = texCUBElod(s15, r2);
    r5.xyz = (r2.xyz) * (r2.xyz);
    r2.xyz = (r1.xyz) * (r1.xyz) + (r6.xyz);
    r1.xyz = (r5.xyz) * (c[5].xxx);
    r4.y = (r4.w) + (r4.w);
    r1.xyz = (r2.xyz) * (r1.xyz);
    r0.xyz = (r4.xyz) * (r3.www) + (r0.xyz);
    r1.xyz = (r4.xyz) * (r1.xyz);
    r0.xyz = (r0.xyz) * (c[5].yyy);
