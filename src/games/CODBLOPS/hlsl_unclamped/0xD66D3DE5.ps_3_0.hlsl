// Mechanically reconstructed from 0xD66D3DE5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c23 = float4(4.0f, -3.0f, 0.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r2.xyz = (v0.www) * (r0.xyz) + (c1.xxx);
    r0.w = (-(r0.w)) + (c1.x);
    r3.xyz = (r1.xyz) * (r2.xyz);
    r0.z = (r0.w) * (r0.w);
    r10.xyz = (r3.xyz) * (-(r3.xyz)) + (c1.xxx);
    r0.z = (r0.z) * (r0.z);
    r2.w = (r0.w) * (r0.z);
    r0.xyw = c[20].xyw;
    ...
    r0 = tex2D(s4, v8.zw);
    r0.w = (r0.w) * (v0.z);
    r4.xyz = (r3.www) * (r1.xyz) + (c[20].xyw);
    r1.xyz = lerp(r6.xyz, r0.xyz, r0.www);
    r12.xyz = lerp(r4.xyz, c1.xxx, r0.www);
    r11.xyz = (r3.xyz) * (r3.xyz);
    r4.xyz = (r10.xyz) * (r2.www) + (r11.xyz);
    r6.xy = (r0.ww) * (-(r7.xy)) + (r7.xy);
    ...
    r4.w = (r0.y) * (c4.x) + (c4.y);
    r0.y = (r0.w) * (c4.x) + (c4.y);
    r0.w = dot(r1.xy, r6.xy) + (c1.z);
    r0.y = (r4.w) * (r0.y);
    r2 = tex2D(s14, v1.zw);
    r8.xy = (r2.xy) * (c4.ww);
    r5.w = saturate((r0.w) * (r0.y) + (r0.y));
    r3.xy = (r3.xz) * (r8.xx);
    r0.w = (r2.x) * (c4.w) + (-(r3.x));
    r1.xy = (r0.xz) * (r8.yy);
    r0.y = (r3.z) * (-(r8.x)) + (r0.w);
