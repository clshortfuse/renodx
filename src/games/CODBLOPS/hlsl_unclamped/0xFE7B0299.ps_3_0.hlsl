// Mechanically reconstructed from 0xFE7B0299.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.y = dot(r1.xy, r0.zw) + (c1.w);
    r7.x = dot(r1.xy, r0.xy) + (c1.w);
    r0 = tex2D(s1, v0.xy);
    r1.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r0 = tex2D(s0, v0.xy);
    r5.w = (r0.w) * (v7.x) + (c1.z);
    r0 = (r0.xyzx) * (-(c1.yyyw)) + (-(c1.wwwy));
    r8.xy = float2(((r5.w) >= 0.0f ? (r1.x) : (c1.w)), ((r5.w) >= 0.0f ? (r1.y) : (c1.w)));
    ...
    r3 = tex2D(s13, r0.xy);
    r1.w = r3.y;
    r6.xy = lerp(r8.xy, r7.xy, r7.ww);
    r0.xy = (r1.wy) * (c4.yy) + (c4.zz);
    ...
    r1.xyz = (r2.xyz) * (r3.www) + (r0.xyz);
    r7.z = saturate(dot(r13.xyz, r5.xyz));
    r0.x = c1.w;
    r6.xyz = float3(((r5.w) >= 0.0f ? (c[5].x) : (r0.x)), ((r5.w) >= 0.0f ? (c[5].y) : (r0.x)), ((r5.w) >= 0.0f ? (c[5].w) : (r0.x)));
    r14.xyz = (r8.www) * (v6.xyz);
    r3 = tex2D(s5, v0.xy);
    r5 = float4(((r5.w) >= 0.0f ? (r3.x) : (-(c1.w))), ((r5.w) >= 0.0f ? (r3.y) : (-(c1.w))), ((r5.w) >= 0.0f ? (r3.z) : (-(c1.w))), ((r5.w) >= 0.0f ? (r3.w) : (-(c1.y))));
    r4 = tex2D(s6, v7.zw);
    r3 = lerp(r5, r4, r7.wwww);
    r9.w = saturate(dot(r13.xyz, -(r14.xyz)));
    ...
    r5.w = saturate(dot(r13.xyz, c[17].xyz));
    r3.z = exp2(r16.y);
    r0.z = (r5.w) * (r0.z) + (r0.x);
    r0.x = pow(abs(r7.z), r3.z);
    r0.z = (r0.z) * (r0.y) + (c4.w);
    r0.y = (r3.z) * (c9.z) + (c9.w);
    r0.z = 1.0f / (r0.z);
    r3.z = (r0.x) * (r0.y);
    ...
    r3.z = (r3.z) * (r3.y);
    r12.xyz = lerp(r6.xyz, c[6].xyw, r7.www);
    r0.xyz = (r0.xyz) * (r3.zzz);
    r15.xyz = (r1.xyz) * (r12.yyy);
    r3.xyz = (r12.zzz) * (r0.xyz);
    r4 = tex2D(s12, v0.zw);
