// Mechanically reconstructed from 0xF2690D7F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = r4.y;
    r5.x = dot(r3.xy, r0.xy) + (c13.w);
    r1 = tex2D(s1, v1.xy);
    r0.xy = (r1.wy) * (c1.xy) + (c1.zw);
    r1 = tex2D(s3, v7.xy);
    r6.w = (r1.w) * (v0.y);
    r5.y = dot(r3.xy, r0.zw) + (c13.w);
    r9.xy = (r6.ww) * (-(r0.xy)) + (r0.xy);
    r0 = tex2D(s4, v7.zw);
    r5.w = (r0.w) * (v0.z);
    r3.xy = (r2.yw) * (c12.xx) + (c12.yy);
    r6.xy = lerp(r9.xy, r5.xy, r5.ww);
    r1.w = dot(r3.xy, r3.xy) + (c13.w);
    ...
    r0.w = c13.z;
    r2.xyz = (r0.www) + (-(c[24].xyw));
    r4.xyz = (r6.www) * (r2.xyz) + (c[24].xyw);
    r2.xyz = v2.xyz;
    r2.xyz = (r6.xxx) * (v4.xyz) + (r2.xyz);
    r9.xyz = lerp(r4.xyz, c[25].xyw, r5.www);
