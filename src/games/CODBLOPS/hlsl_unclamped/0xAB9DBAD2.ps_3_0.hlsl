// Mechanically reconstructed from 0xAB9DBAD2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(1.0f, -0.0f, -1.0f, 0.797884583f);
    ...
    r8.xy = (v1.xy) + (c0.xx);
    r5.w = c0.y;
    r0.xy = (r8.xy) * (c[29].xx) + (r5.ww);
    r0 = tex2D(s4, r0.xy);
    r3.w = (v5.w) * (c0.z) + (-(r0.x));
    r2.xy = (r2.wy) * (c1.xy) + (c1.zw);
    r4.w = saturate((r3.w) * (c0.w));
    ...
    r0.x = (r0.w) * (r0.z);
    r6.w = saturate(dot(r6.xyz, r3.xyz));
    r2.w = saturate(dot(r3.xyz, r4.xyz));
    r0.z = (r1.w) * (c3.y) + (c3.z);
    r0.z = exp2(r0.z);
    r1.w = (-(r2.w)) + (c2.x);
    r2.w = pow(abs(r6.w), r0.z);
    r3.z = (r1.w) * (r1.w);
    r0.z = (r0.z) * (c4.x) + (c4.y);
    r3.z = (r3.z) * (r3.z);
    r1.w = (r1.w) * (r3.z);
    r3.xyz = (r1.xyz) * (-(r1.xyz)) + (c2.xxx);
    r0.z = (r2.w) * (r0.z);
    r3.xyz = (r1.www) * (r3.xyz);
    r0.z = (r0.x) * (r0.z);
    r1.xyz = (r1.xyz) * (r1.xyz) + (r3.xyz);
    r6.xy = (r8.xy) * (c[30].xx) + (r5.ww);
