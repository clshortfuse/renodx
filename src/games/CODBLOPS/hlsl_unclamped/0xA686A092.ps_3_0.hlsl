// Mechanically reconstructed from 0xA686A092.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xyz = (r0.xyz) * (-(r0.xyz)) + (c2.www);
    r3.w = (r3.w) * (r2.y);
    r2.xyz = (r6.xyz) * (r2.zzz) + (r10.xyz);
    r0.xyz = (r4.yyy) * (r5.xyz) + (r7.xyz);
