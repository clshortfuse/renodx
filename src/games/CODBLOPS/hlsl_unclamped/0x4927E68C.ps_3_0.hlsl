// Mechanically reconstructed from 0x4927E68C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xyz = float3(((r4.w) >= 0.0f ? (c[23].x) : (r0.y)), ((r4.w) >= 0.0f ? (c[23].y) : (r0.y)), ((r4.w) >= 0.0f ? (c[23].w) : (r0.y)));
    r9.xyz = normalize(r3.xyz);
    r3 = (r0.wwww) * (c2.xxxy) + (c2.zzzx);
    r1.w = saturate(dot(r9.xyz, c[17].xyz));
    r5.xyz = (r2.xyz) * (r7.yyy);
