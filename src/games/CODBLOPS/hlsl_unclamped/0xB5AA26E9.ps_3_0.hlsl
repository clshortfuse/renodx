// Mechanically reconstructed from 0xB5AA26E9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xy = (r10.ww) * (r2.yz) + (c1.zz);
    r3.w = saturate(dot(r0.xyz, -(r7.xyz)));
    r2.y = (r10.x) * (c2.w);
    r1.w = (r10.x) * (-(c7.z)) + (c7.w);
    ...
    r2.w = dot(r4.xy, r4.xy) + (c1.w);
    r1.w = exp2(-(r1.w));
    r2.w = exp2(-(r2.w));
    r1.w = (r1.w) * (c2.x) + (c2.y);
    r2.z = (r2.w) * (c2.x) + (c2.y);
    r2.w = dot(r4.xy, r9.xy) + (c1.w);
    r2.z = (r1.w) * (r2.z);
    r4 = tex2D(s14, v0.zw);
    r11.xy = (r4.xy) * (c3.ww);
