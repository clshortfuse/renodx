// Mechanically reconstructed from 0x1187ACF7.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = dot(r5.xy, r5.xy) + (c21.z);
    r1.y = dot(r2.xy, r2.xy) + (c21.z);
    r1.w = exp2(-(r1.w));
    r1.y = exp2(-(r1.y));
    r1.w = (r1.w) * (c3.x) + (c3.y);
    r2.w = (r1.y) * (c3.x) + (c3.y);
    r1.y = dot(r2.xy, r5.xy) + (c21.z);
    r3.w = (r1.w) * (r2.w);
    r2 = tex2D(s14, v1.zw);
    r7.xy = (r2.xy) * (c4.ww);
