// Mechanically reconstructed from 0x96D6CAC0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3 = tex2D(s4, v7.xy);
    r6.w = (r3.w) * (v0.y);
    r9.xy = lerp(r4.xy, r2.xy, r6.ww);
    r2.xyz = (r1.xyz) * (-(r0.xxx)) + (r3.xyz);
    r0.w = dot(r9.xy, r9.xy) + (c3.w);
    r2.xyz = (r6.www) * (r2.xyz);
    r0.w = exp2(-(r0.w));
    r7.xyz = (r1.xyz) * (r0.xxx) + (r2.xyz);
    r0.w = (r0.w) * (c4.x) + (c4.y);
    r8.xyz = lerp(r0.yyy, c[34].xyw, r6.www);
    r2.xy = (v1.zw) * (c12.xy);
    r5 = tex2D(s13, r2.xy);
    ...
    r5.xy = (r5.xz) * (r2.xx);
    r0.z = dot(r6.xy, r9.xy) + (c3.w);
    r0.y = (r4.x) * (c12.w) + (-(r5.x));
    r2.z = (r5.z) * (-(r2.x)) + (r0.y);
    r3.xy = (r3.xz) * (r2.yy);
    r1.w = (r4.y) * (c12.w) + (-(r3.x));
    r0.y = dot(r6.xy, r6.xy) + (c3.w);
    r1.w = (r3.z) * (-(r2.y)) + (r1.w);
    r0.y = exp2(-(r0.y));
    r11.y = (r2.z) + (r2.z);
    r0.y = (r0.y) * (c4.x) + (c4.y);
    ...
    r11.xz = (r5.xy) * (c13.xx);
    r5.xyz = (r11.xyz) * (r0.www) + (r2.xyz);
    r2.xyz = lerp(r1.xyz, c3.zzz, r0.xxx);
    r0 = tex2D(s9, v7.xy);
    r1 = tex2D(s5, v7.zw);
    r3.xyz = (r1.xyz) + (c3.yyy);
    r1 = lerp(r2, r0, r6.wwww);
    r3.xyz = (v0.zzz) * (r3.xyz) + (-(c3.yyy));
    r0 = tex2D(s6, v8.xy);
    r2.xyz = (r0.xyz) + (c3.yyy);
    r0.xyz = (r1.xyz) * (r3.xyz);
    r4.xyz = (v0.www) * (r2.xyz) + (-(c3.yyy));
    r0.xyz = (r0.xyz) * (r4.xyz);
    r13.xyz = (r8.yyy) * (r5.xyz);
