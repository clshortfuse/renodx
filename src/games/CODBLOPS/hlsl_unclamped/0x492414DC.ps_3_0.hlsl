// Mechanically reconstructed from 0x492414DC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.y = dot(r1.xy, r0.zw) + (c22.z);
    r5.x = dot(r1.xy, r0.xy) + (c22.z);
    r2 = tex2D(s1, v0.xy);
    r1 = tex2D(s0, v0.xy);
    r0 = tex2D(s3, v7.zw);
    r5.w = (r0.w) * (v7.y);
    ...
    r0.y = dot(r4.xy, r4.xy) + (c22.z);
    r0.w = dot(r1.xy, r1.xy) + (c22.z);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r2.w = (r0.y) * (c1.x) + (c1.y);
    r0.y = (r0.w) * (c1.x) + (c1.y);
    r0.w = dot(r1.xy, r4.xy) + (c22.z);
    r0.y = (r2.w) * (r0.y);
    r1 = tex2D(s14, v0.zw);
    r3.xy = (r1.xy) * (c3.ww);
    ...
    r8.xz = (r2.xy) * (c4.xx);
    r1.w = (r1.w) * (r1.w);
    r2.xyz = (r8.xyz) * (r2.www) + (r0.xyz);
    r4.z = (r0.w) * (r1.w);
    r1 = tex2D(s5, v0.xy);
    r10.xyz = (r1.xyz) * (-(r1.xyz)) + (c22.www);
    r0 = v1;
