// Mechanically reconstructed from 0x6B6C9E3E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r1.w) * (c3.x) + (c3.y);
    r1.y = (r0.z) * (c3.x) + (c3.y);
    r0.z = dot(r0.xy, r6.xy) + (c1.z);
    r1.y = (r1.w) * (r1.y);
    r2 = tex2D(s14, v0.zw);
    r0.xy = (r2.xy) * (c3.ww);
    r2.w = saturate((r0.z) * (r1.y) + (r1.y));
    r3.xy = (r4.xz) * (r0.xx);
    r0.z = (r2.x) * (c3.w) + (-(r3.x));
    r1.xy = (r1.xz) * (r0.yy);
    r0.x = (r4.z) * (-(r0.x)) + (r0.z);
    ...
    r1.x = saturate(dot(r13.xyz, r5.xyz));
    r10.xyz = (r2.xyz) * (-(r2.xyz)) + (c1.yyy);
    r0.z = (r2.w) * (-(c8.z)) + (c8.w);
    r14.xyz = (r6.www) * (v6.xyz);
    r8.w = saturate(dot(r13.xyz, -(r14.xyz)));
    r0.x = (r2.w) * (c3.z);
    r11.xyz = (r2.xyz) * (r2.xyz);
    r0.y = (r8.w) * (r0.z) + (r0.x);
    r16.xy = (r2.ww) * (c10.xy) + (c10.zw);
    r1.z = saturate(dot(r13.xyz, c[17].xyz));
    r1.y = exp2(r16.y);
    r0.z = (r1.z) * (r0.z) + (r0.x);
    ...
    r1.y = (r1.y) * (r1.x);
    r12.xyz = float3(((r5.w) >= 0.0f ? (c[5].x) : (r3.w)), ((r5.w) >= 0.0f ? (c[5].y) : (r3.w)), ((r5.w) >= 0.0f ? (c[5].w) : (r3.w)));
