// Mechanically reconstructed from 0xBBA9F3D6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s0, v1.xy);
    r7.w = (r0.w) * (v0.w) + (c0.x);
    r5.xy = float2(((r7.w) >= 0.0f ? (r1.x) : (c0.z)), ((r7.w) >= 0.0f ? (r1.y) : (c0.z)));
    r1 = v2;
    ...
    r2.w = r3.x;
    r3.w = max(abs(r1.x), r4.w);
    r3.w = 1.0f / (r3.w);
    r3.xyz = (r1.xyz) * (c[5].xyz);
    r4.w = dot(r2, c4.yyyy);
    r2.xyz = (r3.xyz) * (r3.www) + (v8.xyz);
    r2 = tex3D(s11, r2.xyz);
    r7.xyz = (-(v7.xyz)) + (c[6].xyz);
    r3.w = lerp(r2.w, r4.w, c[10].w);
    ...
    r2 = tex2D(s4, v1.xy);
    r3 = float4(((r7.w) >= 0.0f ? (r2.x) : (c0.z)), ((r7.w) >= 0.0f ? (r2.y) : (c0.z)), ((r7.w) >= 0.0f ? (r2.z) : (c0.z)), ((r7.w) >= 0.0f ? (r2.w) : (c0.y)));
    r4.w = saturate(dot(r1.xyz, r5.xyz));
    r2.x = (r3.w) * (c2.y);
    r2.z = (r3.w) * (-(c2.y)) + (c2.z);
    r10.xyz = normalize(v7.xyz);
    r2.w = (r4.w) * (r2.z) + (r2.x);
    r2.y = saturate(dot(r1.xyz, -(r10.xyz)));
    r2.z = (r2.y) * (r2.z) + (r2.x);
    r6.w = (-(r2.y)) + (c0.y);
    r2.w = (r2.w) * (r2.z) + (c2.w);
