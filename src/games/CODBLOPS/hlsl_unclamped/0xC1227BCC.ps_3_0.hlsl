// Mechanically reconstructed from 0xC1227BCC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xy = lerp(r4.xy, r3.xy, r6.ww);
    r1 = tex2D(s9, v1.xy);
    r0 = tex2D(s10, v7.xy);
    r2.w = dot(r10.xy, r10.xy) + (c3.z);
    r3 = float4(((r5.w) >= 0.0f ? (r0.x) : (r1.x)), ((r5.w) >= 0.0f ? (r0.y) : (r1.y)), ((r5.w) >= 0.0f ? (r0.z) : (r1.z)), ((r5.w) >= 0.0f ? (r0.w) : (r1.w)));
    r0.w = exp2(-(r2.w));
    ...
    r1.z = (r1.x) * (r1.z);
    r14.xyz = lerp(r2.xyz, r1.yyy, r6.www);
