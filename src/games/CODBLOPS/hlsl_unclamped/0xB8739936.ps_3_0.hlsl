// Mechanically reconstructed from 0xB8739936.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xy = (r2.yw) * (c38.xx) + (c38.yy);
    r0.y = dot(r6.xy, r6.xy) + (c1.y);
    r0.w = dot(r1.xy, r1.xy) + (c1.y);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r2.w = (r0.y) * (c3.x) + (c3.y);
    r0.y = (r0.w) * (c3.x) + (c3.y);
    r0.w = dot(r1.xy, r6.xy) + (c1.y);
    r0.y = (r2.w) * (r0.y);
    r1 = tex2D(s14, v0.zw);
    r4.xy = (r1.xy) * (c3.ww);
    ...
    r0.w = (r0.w) * (r0.w);
    r10.w = saturate(dot(r3.xyz, r5.xyz));
    r7.w = (r0.z) * (r0.w);
    r1 = tex2D(s6, v0.xy);
    r0 = v1;
    r0.xyz = (r6.xxx) * (v4.xyz) + (r0.xyz);
    r6.w = (r1.w) * (-(c38.z)) + (c38.w);
    ...
    r0.y = (r0.z) * (r0.x);
    r0.x = pow(abs(r1.z), r4.w);
    r0.z = (r4.w) * (c14.y) + (c14.z);
    r1.z = saturate(dot(r9.xyz, c[17].xyz));
    r1.x = (r0.x) * (r0.z);
    r0.x = (r1.z) * (r6.w) + (r6.z);
    r3.z = saturate(dot(r9.xyz, r2.xyz));
    r0.x = (r0.x) * (r5.w) + (c14.x);
    r2.z = pow(abs(r3.z), r4.w);
    r0.x = 1.0f / (r0.x);
    r0.z = (r0.z) * (r2.z);
    r0.x = (r1.z) * (r0.x);
    r9.w = (r3.w) * (r1.x);
    r0.z = (r0.z) * (r0.x);
    r11.w = (r0.y) * (c4.x) + (c4.y);
    r1.x = (r2.w) * (r0.z);
    r3 = tex2D(s0, v0.xy);
    r2 = tex2D(s5, v7.zw);
    r0.z = (r2.w) * (v7.y) + (c1.x);
    r12.xy = float2(((r0.z) >= 0.0f ? (c1.y) : (r1.y)), ((r0.z) >= 0.0f ? (c1.z) : (r1.y)));
    r0.xyz = float3(((r0.z) >= 0.0f ? (r2.x) : (r3.x)), ((r0.z) >= 0.0f ? (r2.y) : (r3.y)), ((r0.z) >= 0.0f ? (r2.z) : (r3.z)));
    r11.xyz = (r4.xyz) * (r12.yyy);
    ...
    r0.xyz = (r12.zzz) * (c[19].xyz);
    r2.xyz = (r2.www) * (r1.xyz) + (r11.xyz);
    r3.xyz = (r2.www) * (r0.xyz);
    r1.w = (r1.w) * (c1.w);
    r1.xyz = (r9.xyz) * (-(r12.www)) + (r10.xyz);
