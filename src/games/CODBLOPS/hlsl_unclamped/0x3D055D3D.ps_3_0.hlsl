// Mechanically reconstructed from 0x3D055D3D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = dot(r4.xy, r4.xy) + (c11.y);
    r0.z = dot(r0.xy, r0.xy) + (c11.y);
    r2.w = exp2(-(r2.w));
    r0.z = exp2(-(r0.z));
    r2.w = (r2.w) * (c11.z) + (c11.w);
    r2.z = (r0.z) * (c11.z) + (c11.w);
    r0.z = dot(r0.xy, r4.xy) + (c11.y);
    r0.y = (r2.w) * (r2.z);
    r4 = tex2D(s14, v0.zw);
    r11.xy = (r4.xy) * (c2.ww);
