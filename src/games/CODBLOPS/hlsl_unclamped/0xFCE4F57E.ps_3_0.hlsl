// Mechanically reconstructed from 0xFCE4F57E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = c2.w;
    r3.xyz = float3(((r6.w) >= 0.0f ? (r0.w) : (c[21].x)), ((r6.w) >= 0.0f ? (r0.w) : (c[21].y)), ((r6.w) >= 0.0f ? (r0.w) : (c[21].w)));
    r2 = tex2D(s6, v6.zw);
