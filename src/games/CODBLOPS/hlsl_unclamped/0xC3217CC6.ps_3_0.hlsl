// Mechanically reconstructed from 0xC3217CC6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.y = dot(r1.xy, r0.zw) + (c26.z);
    r6.x = dot(r1.xy, r0.xy) + (c26.z);
    r0 = tex2D(s6, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c26.xxxx) * (v9) + (c26.yyyy);
    r5.y = dot(r1.xy, r0.zw) + (c26.z);
    r5.x = dot(r1.xy, r0.xy) + (c26.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r3.w = (r0.w) * (v0.y);
    r2 = tex2D(s1, v1.xy);
    ...
    r1.xy = lerp(r2.xy, r6.xy, r3.ww);
    r0 = tex2D(s4, v7.zw);
    r1.w = (r0.w) * (v0.z);
    r2.xyz = lerp(r4.xyz, r0.xyz, r1.www);
    r6.zw = c26.zw;
    r0.xyz = (r6.zwz) + (-(c[23].xyw));
    r4.xy = lerp(r1.xy, r5.xy, r1.ww);
    r1.xyz = (r3.www) * (r0.xyz) + (c[23].xyw);
    r6.xyz = (r2.xyz) * (r2.xyz);
    r0.xyz = -(r1.xyz);
    r0.w = (r0.y) + (c26.w);
    r0.y = dot(r4.xy, r4.xy) + (c26.z);
    r13.xyz = (r1.www) * (r0.xwz) + (r1.xyz);
    r0.w = exp2(-(r0.y));
    r3.w = (r0.w) * (c3.x) + (c3.y);
    r0.xy = (v1.zw) * (c4.xy);
    r2 = tex2D(s13, r0.xy);
    ...
    r2.xy = (r2.xz) * (r7.xx);
    r0.w = dot(r8.xy, r4.xy) + (c26.z);
    r0.y = (r1.x) * (c4.w) + (-(r2.x));
    r1.w = (r2.z) * (-(r7.x)) + (r0.y);
    r5.xy = (r0.xz) * (r7.yy);
    r0.y = (r1.y) * (c4.w) + (-(r5.x));
    r0.x = dot(r8.xy, r8.xy) + (c26.z);
    r0.y = (r0.z) * (-(r7.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r10.y = (r1.w) + (r1.w);
    r0.z = (r0.z) * (c3.x) + (c3.y);
