// Mechanically reconstructed from 0x22F23B91.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c55 = float4(1.29999995f, 0.0f, 0.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r1.w = (r0.x) * (r0.x);
    r0.x = (r0.x) * (r1.w);
    r1.w = (r10.w) * (c16.y) + (c16.z);
    r1.w = 1.0f / (r1.w);
    r0.x = (r0.x) * (r1.w);
    r4.xyz = lerp(r10.xyz, c0.zzz, r0.xxx);
    r3.xyz = (r3.xyz) * (r4.xyz);
    ...
    r6.xyz = (r4.xyz) * (c[47].xxx);
    r7.x = log2(abs(abs(r6.x)));
    r7.y = log2(abs(abs(r6.y)));
    r7.z = log2(abs(abs(r6.z)));
    r6.xyz = (r7.xyz) * (c55.xxx);
    r7.x = exp2(r6.x);
    r7.y = exp2(r6.y);
    r7.z = exp2(r6.z);
    r4.xyz = (r4.xyz) * (-(c[46].xxx)) + (r7.xyz);
    r4.xyz = (r0.xxx) * (r4.xyz) + (r5.xyz);
    r0.x = (r9.x) * (r9.w);
    r5.z = c0.z;
    r0.x = (r0.x) * (-(c[51].x)) + (r5.z);
    r5.xyw = (r4.xyz) * (c[50].xyz) + (-(r4.xyz));
