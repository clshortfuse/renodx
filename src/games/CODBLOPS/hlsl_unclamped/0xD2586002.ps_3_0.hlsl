// Mechanically reconstructed from 0xD2586002.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = dot(r1.xy, r0.zw) + (c4.z);
    r2.x = dot(r1.xy, r0.xy) + (c4.z);
    r0 = tex2D(s1, v1.xy);
    ...
    r9.xy = lerp(r3.xy, r2.xy, r6.ww);
    r2 = tex2D(s8, v1.xy);
    r1 = tex2D(s9, v7.xy);
    r0.w = dot(r9.xy, r9.xy) + (c4.z);
    r0.w = exp2(-(r0.w));
    r5.w = (r0.w) * (c3.x) + (c3.y);
    r0.xy = (v1.zw) * (c12.xy);
    r4 = tex2D(s13, r0.xy);
    ...
    r4.xy = (r4.xz) * (r6.xx);
    r0.w = dot(r8.xy, r9.xy) + (c4.z);
    r0.y = (r3.x) * (c3.w) + (-(r4.x));
    r3.w = (r4.z) * (-(r6.x)) + (r0.y);
    r7.xy = (r0.xz) * (r6.yy);
    r0.y = (r3.y) * (c3.w) + (-(r7.x));
    r0.x = dot(r8.xy, r8.xy) + (c4.z);
    r0.y = (r0.z) * (-(r6.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r6.y = (r3.w) + (r3.w);
    r0.z = (r0.z) * (c3.x) + (c3.y);
    ...
    r2.xyz = (r6.xyz) * (r5.www) + (r3.xyz);
    r15.xyz = (r0.xyz) * (-(r0.xyz)) + (-(c4.yyy));
    r1.xyw = c[32].xyw;
    r1.xyz = (-(r1.xyw)) + (c[33].xyw);
    r9.w = (r0.w) * (-(c13.z)) + (c13.w);
    r14.xyz = (r6.www) * (r1.xyz) + (c[32].xyw);
    r1 = tex2D(s6, v7.zw);
