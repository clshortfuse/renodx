// Mechanically reconstructed from 0xD347F271.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(-0.5f, -1.0f, 1.0f, 0.797884583f);
    ...
    r1.w = (r0.w) * (r0.w);
    r5.xyz = (v0.zzz) * (r1.xyz) + (c1.zzz);
    r1.w = (r1.w) * (r1.w);
    r6.xyz = (r0.xyz) * (r5.xyz);
    r3.w = (r0.w) * (r1.w);
    r7.xyz = (r6.xyz) * (-(r6.xyz)) + (c1.zzz);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v6.xy);
    r0.w = (r0.w) * (v0.y) + (c1.x);
