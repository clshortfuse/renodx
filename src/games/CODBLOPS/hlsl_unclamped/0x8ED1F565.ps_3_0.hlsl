// Mechanically reconstructed from 0x8ED1F565.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.y = saturate(dot(r8.xyz, -(r5.xyz)));
    r4.w = (r2.w) * (c0.w);
    r4 = texCUBElod(s15, r4);
    r4.xyz = (r4.xyz) * (r4.xyz);
    r5.xyz = (r4.xyz) * (c0.www);
    r3.x = (-(r3.y)) + (c0.y);
    r3.y = (r2.w) * (c2.y) + (c2.z);
    r2.w = (r3.x) * (r3.x);
    r3.y = 1.0f / (r3.y);
    ...
    r1.z = max(abs(r8.x), r4.w);
    r4.w = 1.0f / (r1.z);
    r1.xyz = (r8.xyz) * (c[5].xyz);
    r7.xyz = (r3.xyz) * (r2.xyz);
    r1.xyz = (r1.xyz) * (r4.www) + (v7.xyz);
    r4 = tex3D(s11, r1.xyz);
