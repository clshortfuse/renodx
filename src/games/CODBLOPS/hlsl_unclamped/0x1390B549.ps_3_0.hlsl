// Mechanically reconstructed from 0x1390B549.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.y = dot(r1.xy, r0.zw) + (c27.w);
    r0.w = dot(v6.xyz, v6.xyz);
    r3.x = dot(r1.xy, r0.xy) + (c27.w);
    r4.w = rsqrt(r0.w);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r1.w = (r0.w) * (v0.y);
    ...
    r5.xy = lerp(r4.xy, r3.xy, r7.ww);
    r6.xyz = (r1.xyz) * (r1.xyz);
    r6.w = c27.z;
    r0.xyz = (r6.www) + (-(c[23].xyw));
    r0.xyz = (r1.www) * (r0.xyz) + (c[23].xyw);
    r0.w = dot(r5.xy, r5.xy) + (c27.w);
    r13.xyz = lerp(r0.xyz, c[24].xyw, r7.www);
    r0.w = exp2(-(r0.w));
    r3.w = (r0.w) * (c3.x) + (c3.y);
    r0.xy = (v1.zw) * (c4.xy);
    r2 = tex2D(s13, r0.xy);
    ...
    r2.xy = (r2.xz) * (r4.xx);
    r0.w = dot(r7.xy, r5.xy) + (c27.w);
    r0.y = (r1.x) * (c4.w) + (-(r2.x));
    r1.w = (r2.z) * (-(r4.x)) + (r0.y);
    r3.xy = (r0.xz) * (r4.yy);
    r0.y = (r1.y) * (c4.w) + (-(r3.x));
    r0.x = dot(r7.xy, r7.xy) + (c27.w);
    r0.y = (r0.z) * (-(r4.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r10.y = (r1.w) + (r1.w);
    r0.z = (r0.z) * (c3.x) + (c3.y);
