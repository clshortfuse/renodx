// Mechanically reconstructed from 0xAB54DA76.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c11 = float4(0.600000024f, 0.400000006f, 0.797884583f, 31.875f);
    ...
    r5.y = dot(r1.xy, r0.zw) + (c3.w);
    r5.x = dot(r1.xy, r0.xy) + (c3.w);
    r0 = tex2D(s1, v1.xy);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = tex2D(s0, v1.xy);
    r9.w = (r0.w) * (v0.x) + (c3.z);
    r0 = (r0.xyzx) * (-(c3.yyyw)) + (-(c3.wwwy));
    r3.xy = float2(((r9.w) >= 0.0f ? (r1.x) : (c3.w)), ((r9.w) >= 0.0f ? (r1.y) : (c3.w)));
    r1 = float4(((r9.w) >= 0.0f ? (r0.x) : (c3.w)), ((r9.w) >= 0.0f ? (r0.y) : (c3.w)), ((r9.w) >= 0.0f ? (r0.z) : (c3.w)), ((r9.w) >= 0.0f ? (r0.w) : (c3.w)));
    r0 = tex2D(s3, v7.xy);
    r8.w = (r0.w) * (v0.y) + (c3.z);
    r0 = (r0.xyzx) * (-(c3.yyyw)) + (-(c3.wwwy));
    r4 = float4(((r8.w) >= 0.0f ? (r0.x) : (r1.x)), ((r8.w) >= 0.0f ? (r0.y) : (r1.y)), ((r8.w) >= 0.0f ? (r0.z) : (r1.z)), ((r8.w) >= 0.0f ? (r0.w) : (r1.w)));
    r6.xy = float2(((r8.w) >= 0.0f ? (r2.x) : (r3.x)), ((r8.w) >= 0.0f ? (r2.y) : (r3.y)));
    r0 = tex2D(s4, v7.zw);
    r6.w = (r0.w) * (v0.z) + (c3.z);
    r0 = (r0.xyzx) * (-(c3.yyyw)) + (-(c3.wwwy));
    r1 = tex2D(s7, v1.xy);
    r2 = float4(((r9.w) >= 0.0f ? (r1.x) : (-(c3.w))), ((r9.w) >= 0.0f ? (r1.y) : (-(c3.w))), ((r9.w) >= 0.0f ? (r1.z) : (-(c3.w))), ((r9.w) >= 0.0f ? (r1.w) : (-(c3.y))));
    r1 = tex2D(s8, v7.xy);
    ...
    r1 = float4(((r6.w) >= 0.0f ? (r1.x) : (r3.x)), ((r6.w) >= 0.0f ? (r1.y) : (r3.y)), ((r6.w) >= 0.0f ? (r1.z) : (r3.z)), ((r6.w) >= 0.0f ? (r1.w) : (r3.w)));
    r12.xy = float2(((r6.w) >= 0.0f ? (r5.x) : (r6.x)), ((r6.w) >= 0.0f ? (r5.y) : (r6.y)));
    ...
    r4 = tex2D(s13, r1.xy);
    r3.w = r4.y;
    r6.xyz = (r10.xyz) * (r5.www) + (r11.xyz);
    r1.xy = (r3.wy) * (c12.xx) + (c12.yy);
    r2.w = dot(r12.xy, r12.xy) + (c3.w);
    r1.z = dot(r1.xy, r1.xy) + (c3.w);
    r2.w = exp2(-(r2.w));
    r1.z = exp2(-(r1.z));
    r2.w = (r2.w) * (c11.x) + (c11.y);
    r2.z = (r1.z) * (c11.x) + (c11.y);
    r1.z = dot(r1.xy, r12.xy) + (c3.w);
    r1.y = (r2.w) * (r2.z);
    ...
    r4.xy = (r4.xz) * (r0.xx);
    r1.xy = (r3.xz) * (r0.yy);
    r2.z = (r5.x) * (c11.w) + (-(r4.x));
    r0.z = (r5.y) * (c11.w) + (-(r1.x));
    r2.z = (r4.z) * (-(r0.x)) + (r2.z);
    r0.z = (r3.z) * (-(r0.y)) + (r0.z);
    r0.y = (r0.z) + (r0.z);
    r0.xz = (r1.xy) * (c12.xx);
    ...
    r3.xyz = (r8.xyz) * (r2.www) + (r1.xyz);
    r0.xyz = (r12.yyy) * (v3.xyz) + (r0.xyz);
    r2.w = (r1.w) * (-(c12.z)) + (c12.w);
    r1.xyz = normalize(r0.xyz);
    r0.x = c3.w;
    r0.xyz = float3(((r9.w) >= 0.0f ? (c[8].x) : (r0.x)), ((r9.w) >= 0.0f ? (c[8].y) : (r0.x)), ((r9.w) >= 0.0f ? (c[8].w) : (r0.x)));
    r4.z = saturate(dot(r1.xyz, r7.xyz));
    r2.x = (r1.w) * (c11.z);
    ...
    r2.z = (r7.w) * (r2.w) + (r2.x);
    r2.w = (r3.w) * (r2.w) + (r2.x);
    r2.x = pow(abs(r4.z), r4.w);
    r2.z = (r2.w) * (r2.z) + (c13.x);
    r2.w = (r4.w) * (c13.y) + (c13.z);
    r2.z = 1.0f / (r2.z);
    r2.w = (r2.x) * (r2.w);
    r2.z = (r3.w) * (r2.z);
    r0.xyz = float3(((r8.w) >= 0.0f ? (c[9].x) : (r0.x)), ((r8.w) >= 0.0f ? (c[9].y) : (r0.y)), ((r8.w) >= 0.0f ? (c[9].w) : (r0.z)));
    r2.w = (r2.w) * (r2.z);
    r12.xyz = float3(((r6.w) >= 0.0f ? (r2.y) : (r0.x)), ((r6.w) >= 0.0f ? (r2.y) : (r0.y)), ((r6.w) >= 0.0f ? (r2.y) : (r0.z)));
