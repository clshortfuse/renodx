// Mechanically reconstructed from 0xCF884E3B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = dot(r12.xy, r12.xy) + (c9.z);
    r2.z = dot(r4.xy, r4.xy) + (c9.z);
    r2.w = exp2(-(r2.w));
    r2.z = exp2(-(r2.z));
    r2.w = (r2.w) * (c2.x) + (c2.y);
    r2.x = (r2.z) * (c2.x) + (c2.y);
    r2.z = dot(r4.xy, r12.xy) + (c9.z);
    r2.x = (r2.w) * (r2.x);
    r4 = tex2D(s14, v0.zw);
    r13.xy = (r4.xy) * (c3.ww);
