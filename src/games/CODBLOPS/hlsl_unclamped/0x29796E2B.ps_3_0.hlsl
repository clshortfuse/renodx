// Mechanically reconstructed from 0x29796E2B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = float3(((r5.w) >= 0.0f ? (r0.x) : (r2.x)), ((r5.w) >= 0.0f ? (r0.y) : (r2.y)), ((r5.w) >= 0.0f ? (r0.z) : (r2.z)));
    ...
    r0.y = (r2.x) * (c12.x) + (-(r8.x));
    r1.z = (r3.z) * (-(r6.x)) + (r0.y);
    r1.xy = (r0.xz) * (r6.yy);
    r0.y = (r2.y) * (c12.x) + (-(r1.x));
    ...
    r0.w = (-(r0.w)) + (-(c3.y));
    r3.xyw = c[35].xyw;
    r8.xyz = float3(((r5.w) >= 0.0f ? (r3.x) : (c[34].x)), ((r5.w) >= 0.0f ? (r3.y) : (c[34].y)), ((r5.w) >= 0.0f ? (r3.w) : (c[34].w)));
    r2.w = (r0.w) * (r0.w);
