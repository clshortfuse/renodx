// Mechanically reconstructed from 0x690F83E6.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = dot(r2.xy, r2.xy) + (c8.w);
    r0.w = dot(r7.xy, r7.xy) + (c8.w);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r0.y = (r0.y) * (c1.x) + (c1.y);
    r0.w = (r0.w) * (c1.x) + (c1.y);
    r1.w = (r0.y) * (r0.w);
    r0.y = dot(r2.xy, r7.xy) + (c8.w);
    r2 = tex2D(s14, v1.zw);
    r5.xy = (r2.xy) * (c2.ww);
    ...
    r5 = tex2D(s4, v1.xy);
    r9.xyz = lerp(r5.yyy, c[5].xyw, r6.www);
    ...
    r4 = tex2D(s5, v7.zw);
    r3 = tex2D(s2, v7.xy);
    r3.xyz = (r3.xyz) + (c8.xxx);
    r11.xyz = (v0.yyy) * (r3.xyz) + (c8.yyy);
    r5.xyz = (r11.xyz) * (c8.zzz);
