// Mechanically reconstructed from 0x75878D03.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = dot(c[32].yz, r4.xy) + (c[32].x);
    r1.xy = (r1.xy) * (r3.xy);
    r1.x = (r1.w) * (r1.x);
    r1.w = dot(r5.xyz, c[30].xyz);
    r1.y = (r1.y) * (r1.x);
    r1.x = saturate((r1.w) * (c[31].x) + (c[31].y));
    r4.x = v5.w;
    ...
    r3 = tex3D(s11, r3.xyz);
    r4 = tex2Dproj(s1, v7);
    r1.w = lerp(r3.w, r4.x, r5.w);
    r4.xyz = (r3.xyz) * (r3.xyz);
    r1.w = (r1.y) * (r1.w);
    r3 = (v6.yyyy) * (c[25]);
    r9.xyz = (r4.xyz) * (c0.xxx);
    r3 = (v6.xxxx) * (c[24]) + (r3);
    r1.y = saturate(dot(r5.xyz, r10.xyz));
    r3 = (v6.zzzz) * (c[26]) + (r3);
    r8.xyz = (r1.yyy) * (c[29].xyz);
    r3 = (r3) + (c[27]);
    r6.xy = (r3.ww) * (c[34].xy) + (r3.xy);
    r6.zw = r3.zw;
    r4 = tex2Dproj(s1, r6);
    r5.zw = r6.zw;
    r3.zw = r5.zw;
    r7.xy = (r6.ww) * (-(c[34].zw)) + (r3.xy);
    r7.zw = r3.zw;
    r7 = tex2Dproj(s1, r7);
    r4.w = r7.x;
    r5.xy = (r6.ww) * (-(c[34].xy)) + (r3.xy);
    r3.xy = (r6.ww) * (c[34].zw) + (r3.xy);
    r5 = tex2Dproj(s1, r5);
    r4.y = r5.x;
    r5 = tex2Dproj(s1, r3);
