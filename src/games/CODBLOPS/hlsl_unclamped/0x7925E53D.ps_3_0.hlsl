// Mechanically reconstructed from 0x7925E53D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s2, v1.xy);
    r1.zw = (r2.ww) * (c0.zy) + (c0.wz);
    r0 = tex2D(s0, v1.xy);
    r2.z = (r0.w) * (v0.w) + (c0.x);
    r0 = (r0.xyzx) * (c0.yyyz) + (c0.zzzy);
    r3 = float4(((r2.z) >= 0.0f ? (r1.x) : (c0.z)), ((r2.z) >= 0.0f ? (r1.y) : (c0.z)), ((r2.z) >= 0.0f ? (r1.z) : (c0.z)), ((r2.z) >= 0.0f ? (r1.w) : (c0.y)));
    r5.z = (r3.w) * (c2.z);
    r2.x = (r3.w) * (-(c2.z)) + (c2.w);
    ...
    r2.x = (r8.w) * (r2.x) + (r9.z);
    r2.w = (r2.w) * (r2.x);
    r7.w = ((r2.z) >= 0.0f ? (r2.y) : (c0.z));
    r0 = float4(((r2.z) >= 0.0f ? (r0.x) : (c0.z)), ((r2.z) >= 0.0f ? (r0.y) : (c0.z)), ((r2.z) >= 0.0f ? (r0.z) : (c0.z)), ((r2.z) >= 0.0f ? (r0.w) : (c0.z)));
