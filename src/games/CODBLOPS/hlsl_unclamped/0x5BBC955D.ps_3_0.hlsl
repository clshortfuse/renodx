// Mechanically reconstructed from 0x5BBC955D.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = dot(r0, c4.zzzz);
    r0 = tex2D(s12, v1.zw);
    r8.xyz = (-(v7.xyz)) + (c[31].xyz);
    r3.y = dot(r8.xyz, r8.xyz);
    r4.w = rsqrt(r3.y);
    r4.xyz = (r8.xyz) * (r4.www);
    r0.w = dot(r4.xyz, c[34].xyz);
    ...
    r0.xyz = (r9.zzz) * (c[32].xyz);
    r3.xyz = (r8.xyz) * (r4.www) + (-(r6.xyz));
    r5.xyz = (r11.zzz) * (r0.xyz) + (r5.xyz);
