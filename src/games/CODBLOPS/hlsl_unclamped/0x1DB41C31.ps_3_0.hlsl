// Mechanically reconstructed from 0x1DB41C31.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xz = (r0.xy) * (c2.xx);
    r4.y = (r0.z) + (r0.z);
    r13.xyz = (r5.xyz) * (r0.www) + (r4.xyz);
    r0.w = c0.x;
    r1.xyz = (r0.www) + (-(c[29].xyw));
    r0 = tex2D(s3, v4.zw);
    ...
    r7.xyz = (r1.xyz) * (-(r1.xyz)) + (c0.xxx);
    r2.xyz = (r5.xxx) * (r2.xyz);
    r12.xyz = (r7.xyz) * (r2.www) + (r8.xyz);
    r1.xyz = (r13.xyz) * (r5.yyy);
    r2.xyz = (r2.xyz) * (r12.xyz);
    r11.xyz = (r6.xyz) * (r3.www) + (-(r11.xyz));
    r2.xyz = (r4.xyz) * (r2.xyz);
    r3.w = exp2(r14.y);
    r4.xyz = (r2.xyz) * (c0.yyy);
    r2 = tex2D(s0, v0.xy);
