// Mechanically reconstructed from 0x51EFC923.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c6 = float4(2.0f, -1.0f, 0.0f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = (c6.xxxx) * (v7) + (c6.yyyy);
    r2.x = dot(r4.xy, r0.xy) + (c6.z);
    r2.y = dot(r4.xy, r0.zw) + (c6.z);
    r0 = tex2D(s2, v6.zw);
    r3.w = (r0.w) * (v6.y);
    r4.xy = (r1.yw) * (c4.xx) + (c4.yy);
    r6.xy = lerp(r5.xy, r2.xy, r3.ww);
    r1.w = dot(r4.xy, r4.xy) + (c6.z);
    r1.y = dot(r6.xy, r6.xy) + (c6.z);
    r1.w = exp2(-(r1.w));
    r1.y = exp2(-(r1.y));
    r1.w = (r1.w) * (c1.x) + (c1.y);
    r4.w = (r1.y) * (c1.x) + (c1.y);
