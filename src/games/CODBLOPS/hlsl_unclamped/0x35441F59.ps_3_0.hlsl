// Mechanically reconstructed from 0x35441F59.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = dot(r4.xy, r4.xy) + (c6.w);
    r0.w = dot(r1.xy, r1.xy) + (c6.w);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r2.w = (r0.y) * (c1.x) + (c1.y);
    r0.y = (r0.w) * (c1.x) + (c1.y);
    r0.w = dot(r1.xy, r4.xy) + (c6.w);
    r0.y = (r2.w) * (r0.y);
    r1 = tex2D(s14, v1.zw);
    r3.xy = (r1.xy) * (c3.ww);
    ...
    r0.xyz = (v0.yyy) * (r0.xyz) + (c6.yyy);
    r2 = tex2D(s4, v8.zw);
    r3.xyz = (r2.xyz) + (c6.xxx);
    r2.xyz = (r0.xyz) * (c6.zzz);
    r5.xyz = (v0.zzz) * (r3.xyz) + (c6.yyy);
    r2.xyz = (r2.xyz) * (r5.xyz);
    r6.xyz = (r2.xyz) * (-(r2.xyz)) + (c6.yyy);
