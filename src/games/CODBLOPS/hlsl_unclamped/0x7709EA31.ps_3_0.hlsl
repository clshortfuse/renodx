// Mechanically reconstructed from 0x7709EA31.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4 = tex3D(s11, r2.yzw);
    r2.yzw = (r4.www) * (c[19].xyz);
    r4.xyz = (r4.www) * (c[18].xyz);
    r4.xyz = (r4.xyz) * (c[29].xxx);
    r2.yzw = (r2.yzw) * (c[29].yyy);
    r0.w = dot(-(r5.xyz), r6.xyz);
    r0.w = (r0.w) + (r0.w);
    r8.xyz = (r6.xyz) * (-(r0.www)) + (-(r5.xyz));
