// Mechanically reconstructed from 0x153A9735.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1 = tex2Dproj(s0, r1);
    r4.xy = c2.xy;
    r2.xy = (v8.xy) * (c[35].xx) + (r4.xx);
    r2.xy = (r2.xy) * (c[36].xx) + (r4.yy);
    r2 = tex2D(s3, r2.xy);
    r9.xy = (v8.xy) * (c[35].xx);
    r0.w = (r2.y) * (c2.z) + (c2.w);
    r3.xy = (r9.xy) * (c1.xx) + (c1.yy);
    r2.y = (r0.w) * (c2.z) + (c2.w);
    r3.xy = (r3.xy) * (c[37].xx) + (r4.yy);
    r3 = tex2D(s4, r3.xy);
    r0.w = (r3.y) * (c2.z) + (c2.w);
    r2.w = (r0.w) * (c2.z) + (c2.w);
    r2.xz = c1.zz;
    ...
    r5.xyz = (r1.xyz) * (c4.xxx);
    r1.xyz = normalize(r0.xyz);
    r0.xyz = (r6.xyz) * (c[34].xxx) + (-(r5.xyz));
    r8.xyz = (-(v6.xyz)) * (r3.www) + (r1.xyz);
    r0.w = saturate((r2.w) * (-(r2.w)) + (c3.x));
    r6.xyz = normalize(r8.xyz);
    r0.w = ((-(r7.z)) >= 0.0f ? (c3.y) : (r0.w));
    r1.w = saturate(dot(r3.xyz, r6.xyz));
    r0.xyz = (r0.www) * (r0.xyz) + (r5.xyz);
