// Mechanically reconstructed from 0x260AD001.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.w = (r0.w) * (v0.w) + (c1.x);
    r1.w = r2.x;
    r2.xy = float2(((r6.w) >= 0.0f ? (r3.x) : (c1.z)), ((r6.w) >= 0.0f ? (r3.y) : (c1.z)));
    r6.y = dot(r1, c3.wwww);
    r1 = v2;
    ...
    r4.w = (r2.w) * (-(c3.x)) + (c3.y);
    r1.x = saturate(dot(r8.xyz, -(r9.xyz)));
    r1.y = (r1.z) * (r4.w) + (r6.y);
    r4.w = (r1.x) * (r4.w) + (r6.y);
    r5.w = (r6.z) * (r5.w);
    r1.y = (r1.y) * (r4.w) + (c3.z);
