// Mechanically reconstructed from 0x9B7CCF72.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s13, r0.xy);
    r2.w = r0.y;
    r7.xy = float2(((r3.w) >= 0.0f ? (r3.x) : (r5.x)), ((r3.w) >= 0.0f ? (r3.y) : (r5.y)));
    r1.xy = (r2.yw) * (c12.yy) + (c12.zz);
    r0.y = dot(r7.xy, r7.xy) + (c3.z);
    r0.w = dot(r1.xy, r1.xy) + (c3.z);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r4.w = (r0.y) * (c4.x) + (c4.y);
    r0.y = (r0.w) * (c4.x) + (c4.y);
    r0.w = dot(r1.xy, r7.xy) + (c3.z);
    r0.y = (r4.w) * (r0.y);
    r1 = tex2D(s14, v1.zw);
    r3.xy = (r1.xy) * (c12.xx);
    r1.w = saturate((r0.w) * (r0.y) + (r0.y));
    r5.xy = (r2.xz) * (r3.xx);
    r0.w = (r1.x) * (c12.x) + (-(r5.x));
    r2.xy = (r0.xz) * (r3.yy);
    r0.y = (r2.z) * (-(r3.x)) + (r0.w);
    r0.w = (r1.y) * (c12.x) + (-(r2.x));
    r0.w = (r0.z) * (-(r3.y)) + (r0.w);
    r9.y = (r0.y) + (r0.y);
    r0.y = (r0.w) + (r0.w);
    r0.xz = (r2.xy) * (c12.yy);
