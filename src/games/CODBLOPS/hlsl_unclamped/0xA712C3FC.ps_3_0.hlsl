// Mechanically reconstructed from 0xA712C3FC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.y = (r2.w) * (-(c14.z)) + (c14.w);
    r1.w = saturate(dot(r9.xyz, -(r3.xyz)));
    r0.z = (r6.w) * (r0.y) + (r0.x);
    r0.y = (r1.w) * (r0.y) + (r0.x);
    r0.z = (r0.z) * (r0.y) + (c4.x);
    r4.xyz = (r10.xyz) * (r8.www) + (-(r3.xyz));
    r3.w = 1.0f / (r0.z);
