// Mechanically reconstructed from 0xC179ED9C.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = (r0.w) * (c4.x) + (c4.y);
    r13.xyz = lerp(r0.yyy, c[39].xyw, r6.www);
    r2.xy = (v1.zw) * (c12.xy);
    r5 = tex2D(s13, r2.xy);
