// Mechanically reconstructed from 0x8E5BCD73.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.z = saturate(dot(r14.xyz, r1.xyz));
    r0.y = saturate((r1.w) * (c[24].x) + (c[24].y));
    r1.w = (r0.y) * (-(c14.w)) + (-(c14.y));
    r0.z = (-(r3.w)) + (c0.w);
    r0.x = (r0.y) * (r0.y);
    r0.y = (r0.z) * (r0.z);
    r7.w = (r1.w) * (r0.x);
    ...
    r1 = tex2D(s0, v1.xy);
    r3.xyz = saturate((r0.xyz) * (r1.www) + (r1.xyz));
    r1 = tex2D(s5, v1.xy);
    r10.xyz = (r1.xyz) * (-(r1.xyz)) + (c0.www);
    r11.xyz = (r1.xyz) * (r1.xyz);
    r13.w = (r1.w) * (-(c3.x)) + (c3.y);
    r14.w = (r1.w) * (c3.x);
    r4.w = saturate(dot(r4.xyz, r14.xyz));
    r3.w = saturate(dot(r14.xyz, -(r2.xyz)));
    r0.z = (r4.w) * (r13.w) + (r14.w);
    r12.w = (r3.w) * (r13.w) + (r14.w);
    r0.z = (r0.z) * (r12.w) + (c3.z);
    r4.xy = (r1.ww) * (c4.xy) + (c4.zw);
    r0.y = 1.0f / (r0.z);
    r11.w = exp2(r4.y);
    r0.z = pow(abs(r5.z), r11.w);
    ...
    r3.z = 1.0f / (r4.x);
    r3.w = (-(r3.w)) + (c0.w);
    r0.z = dot(r2.xyz, r14.xyz);
    r3.y = (r3.w) * (r3.w);
    r0.z = (r0.z) + (r0.z);
    r1.w = (r1.w) * (c0.y);
    r1.xyz = (r14.xyz) * (-(r0.zzz)) + (r2.xyz);
    ...
    r8.xyz = (r0.xyz) * (c[30].xxx);
    r1.z = (-(r1.w)) + (c0.w);
    r0.z = (r1.z) * (r1.z);
    r1.w = max(abs(r14.y), abs(r14.z));
    r1.y = (r0.z) * (r0.z);
    r0.z = max(abs(r14.x), r1.w);
    r1.w = 1.0f / (r0.z);
    r0.xyz = (r14.xyz) * (c[5].xyz);
    r8.w = (r1.z) * (r1.y);
    r0.xyz = (r0.xyz) * (r1.www) + (v8.xyz);
    r2 = tex3D(s11, r0.xyz);
    r0.xyz = (r2.xyz) * (r2.xyz);
    r0.xyz = (r0.xyz) * (c[30].yyy);
    r10.w = saturate(dot(r14.xyz, c[17].xyz));
    r1 = tex2D(s8, v1.xy);
    r0.xyz = (r0.xyz) * (r1.www);
    r13.xyz = (r0.xyz) * (c0.zzz);
    r12.xyz = (r10.www) * (c[18].xyz);
    if ((c0.w) >= (v6.w))
    {
        r3 = (v6.xyzx) * (c3.yyyw);
        r2 = (r3) + (-(c13.xyzz));
    ...
    r0.z = (r10.w) * (r13.w) + (r14.w);
    r0.z = (r0.z) * (r12.w) + (c3.z);
    r2.w = saturate(dot(r14.xyz, r15.xyz));
    r0.y = 1.0f / (r0.z);
    r0.z = pow(abs(r2.w), r11.w);
    r2.z = (r10.w) * (r0.y);
    r2.w = (r9.w) * (r0.z);
    r0.xyz = (r3.www) * (r12.xyz) + (r13.xyz);
    r4.w = (r2.z) * (r2.w);
    r3.xyz = (r10.xyz) * (r8.www) + (r11.xyz);
    r2 = (v7.yyyy) * (c[26]);
