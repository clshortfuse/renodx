// Mechanically reconstructed from 0xBD7BB9CA.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.y = dot(r1.xy, r0.zw) + (c20.w);
    r0.w = dot(v6.xyz, v6.xyz);
    r3.x = dot(r1.xy, r0.xy) + (c20.w);
    r4.w = rsqrt(r0.w);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r1.w = (r0.w) * (v0.y);
    ...
    r0.y = dot(r5.xy, r5.xy) + (c20.w);
    r0.w = dot(r1.xy, r1.xy) + (c20.w);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r3.w = (r0.y) * (c3.x) + (c3.y);
    r0.y = (r0.w) * (c3.x) + (c3.y);
    r0.w = dot(r1.xy, r5.xy) + (c20.w);
    r0.y = (r3.w) * (r0.y);
    r1 = tex2D(s14, v1.zw);
    r4.xy = (r1.xy) * (c4.ww);
