// Mechanically reconstructed from 0x9F74C4B0.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c27 = float4(2.0f, -1.0f, 0.0f, 1.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r6.y = dot(r1.xy, r0.zw) + (c27.z);
    r6.x = dot(r1.xy, r0.xy) + (c27.z);
    r0 = tex2D(s6, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c27.xxxx) * (v9) + (c27.yyyy);
    r3.y = dot(r1.xy, r0.zw) + (c27.z);
    r3.x = dot(r1.xy, r0.xy) + (c27.z);
    r2 = tex2D(s1, v1.xy);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r7.w = (r0.w) * (v0.y);
    ...
    r0 = tex2D(s4, v7.zw);
    r4.w = (r0.w) * (v0.z);
    r5.xy = lerp(r7.xy, r6.xy, r7.ww);
    r1.xyz = lerp(r2.xyz, r0.xyz, r4.www);
    r7.xy = lerp(r5.xy, r3.xy, r4.ww);
    r0.xy = (v1.zw) * (c12.xy);
    r2 = tex2D(s13, r0.xy);
    ...
    r0.y = dot(r7.xy, r7.xy) + (c27.z);
    r0.w = dot(r1.xy, r1.xy) + (c27.z);
    r0.y = exp2(-(r0.y));
    r0.w = exp2(-(r0.w));
    r7.z = (r0.y) * (c4.x) + (c4.y);
    r0.y = (r0.w) * (c4.x) + (c4.y);
    r0.w = dot(r1.xy, r7.xy) + (c27.z);
    r0.y = (r7.z) * (r0.y);
    r1 = tex2D(s14, v1.zw);
    r5.xy = (r1.xy) * (c12.ww);
    ...
    r1 = tex2D(s7, v1.xy);
    r3.w = -(r1.w);
    r2 = (r1.wwww) * (c3.yyyz) + (c3.wwwy);
    r3.xyz = c3.xxx;
    r0 = tex2D(s8, v7.zw);
    r0 = (r3) + (r0);
    r3.xyz = (r10.xyz) * (r7.zzz) + (r5.xyz);
    r0 = (r4.wwww) * (r0) + (r2);
    r2.z = lerp(r1.y, c27.w, r7.w);
    r11.xyz = (r0.xyz) * (-(r0.xyz)) + (c27.www);
    ...
    r1.w = (r1.w) * (r1.z);
    r13.xyz = lerp(r2.zzz, c[23].xyw, r4.www);
    r0.xyz = (r0.xyz) * (r1.www);
    r14.xyz = (r3.xyz) * (r13.yyy);
    r15.xyz = (r13.zzz) * (r0.xyz);
    r1 = tex2D(s12, v1.zw);
    r0.z = ((-abs(r1.y)) >= 0.0f ? (c27.w) : (c27.z));
