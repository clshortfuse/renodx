// Mechanically reconstructed from 0xE43FD5BE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = (c10.xxxx) * (v7) + (c10.yyyy);
    r0.x = dot(r1.xy, r0.xy) + (c10.z);
    r0.y = dot(r1.xy, r0.zw) + (c10.z);
    r1 = tex2D(s2, v6.xy);
    r7.w = (r1.w) * (v0.y);
    ...
    r2.x = dot(r4.xy, r0.xy) + (c10.z);
    r2.y = dot(r4.xy, r0.zw) + (c10.z);
    r0 = tex2D(s3, v6.zw);
    r9.w = (r0.w) * (v0.z);
    r8.xy = lerp(r3.xy, r2.xy, r9.ww);
    r2.xyz = v2.xyz;
    ...
    r5 = tex2D(s6, v1.xy);
    r2 = tex2D(s7, v6.xy);
    r4 = (r2.wwww) * (-(c10.zzzy)) + (-(c10.wwwz));
    r0.w = dot(c[5].xyz, r6.xyz);
    r6 = lerp(r5, r4, r7.wwww);
    r4 = tex2D(s8, v6.zw);
    r5 = (r4.wwww) * (-(c10.zzzy)) + (-(c10.wwwz));
    r9.xy = lerp(c[8].xy, r2.yy, r7.ww);
    r2 = lerp(r6, r5, r9.wwww);
    r7.xy = lerp(r9.xy, r4.yy, r9.ww);
    r3.w = (r2.w) * (c2.z);
    ...
    r2.w = dot(r2.xy, r2.xy) + (c10.z);
    r1.w = dot(r8.xy, r8.xy) + (c10.z);
    r2.w = exp2(-(r2.w));
    r1.w = exp2(-(r1.w));
    r2.z = (r2.w) * (c2.x) + (c2.y);
    r1.w = (r1.w) * (c2.x) + (c2.y);
    r2.w = dot(r2.xy, r8.xy) + (c10.z);
    r2.z = (r2.z) * (r1.w);
    r4.y = (r3.w) + (r3.w);
    r2.w = saturate((r2.w) * (r2.z) + (r2.z));
    r3.xyz = (r6.xyz) * (c2.zzz);
    r6.xyz = (r4.xyz) * (r2.www);
    r2 = tex2D(s0, v1.xy);
    r4.xyz = lerp(r2.xyz, r1.xyz, r7.www);
    r2.xyz = (r5.xyz) * (r1.www) + (r6.xyz);
    r1.xyz = lerp(r4.xyz, r0.xyz, r9.www);
