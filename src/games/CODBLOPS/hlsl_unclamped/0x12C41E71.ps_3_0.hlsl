// Mechanically reconstructed from 0x12C41E71.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = (r1.w) * (r1.x) + (r5.w);
    r1.x = (r1.z) * (r1.x) + (r5.w);
    r11.xyz = (v6.xyz) * (-(r4.www)) + (c[17].xyz);
    r1.x = (r1.x) * (r3.w) + (c3.x);
    r1.w = (-(r1.w)) + (c1.y);
    r1.x = 1.0f / (r1.x);
    r4.w = (r1.z) * (r1.x);
    ...
    r11.xy = (r2.ww) * (c9.xy) + (c9.zw);
    r3.w = saturate(dot(r10.xyz, c[17].xyz));
    r1.z = exp2(r11.y);
    r5.w = pow(abs(r1.x), r1.z);
    r1.x = (r1.z) * (c3.y) + (c3.z);
    r1.z = 1.0f / (r11.x);
    r1.x = (r5.w) * (r1.x);
    r1.x = (r4.w) * (r1.x);
