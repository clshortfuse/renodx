// Mechanically reconstructed from 0x036C23F3.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.y = dot(r1.xy, r0.zw) + (c26.z);
    r3.x = dot(r1.xy, r0.xy) + (c26.z);
    r0 = tex2D(s6, v7.zw);
    r1.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r0 = (c26.xxxx) * (v9) + (c26.yyyy);
    r8.y = dot(r1.xy, r0.zw) + (c26.z);
    r8.x = dot(r1.xy, r0.xy) + (c26.z);
    r1 = tex2D(s0, v1.xy);
    r0 = tex2D(s3, v7.xy);
    r5.w = (r0.w) * (v0.y);
    r2 = tex2D(s1, v1.xy);
    ...
    r9.xy = lerp(r2.xy, r3.xy, r5.ww);
    r0 = tex2D(s8, v7.xy);
    r2 = (r0.wwww) * (-(c26.zzzy)) + (-(c26.wwwz));
    r4 = tex2D(s7, v1.xy);
    r1 = tex2D(s4, v7.zw);
    r6.w = (r1.w) * (v0.z);
    ...
    r6.xyz = lerp(c[23].xyw, r0.yyy, r5.www);
    r1 = tex2D(s9, v7.zw);
    r0.w = dot(v6.xyz, v6.xyz);
    r5.w = rsqrt(r0.w);
    r0.xyz = (v6.xyz) * (-(r5.www)) + (c[17].xyz);
    r4.xyz = normalize(r0.xyz);
    r2 = (r1.wwww) * (-(c26.zzzy)) + (-(c26.wwwz));
