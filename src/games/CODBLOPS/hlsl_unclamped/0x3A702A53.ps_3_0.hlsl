// Mechanically reconstructed from 0x3A702A53.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = 1.0f / (r1.x);
    r1.x = saturate(dot(r3.xyz, r8.xyz));
    r3.w = (r1.w) * (r3.w);
    r1.x = (-(r1.x)) + (c2.x);
    r4.w = saturate(dot(r7.xyz, r3.xyz));
    r3.z = (r1.x) * (r1.x);
    r3.y = pow(abs(r4.w), r5.w);
    r3.z = (r3.z) * (r3.z);
    r1.z = (r1.z) * (r3.y);
    r1.x = (r1.x) * (r3.z);
    r1.z = (r3.w) * (r1.z);
