// Mechanically reconstructed from 0x6F30C073.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r5.xy = float2(((r8.w) >= 0.0f ? (r2.x) : (c1.w)), ((r8.w) >= 0.0f ? (r2.y) : (c1.w)));
    r2 = tex2D(s5, v6.zw);
    ...
    r0.xyz = (r12.xyz) * (r2.www) + (r3.xyz);
    r2 = tex2D(s6, v0.xy);
    r1.z = ((r8.w) >= 0.0f ? (r2.y) : (c1.w));
    r2 = (r2.wwww) * (c2.xxxy) + (c2.zzzx);
    r11.xyz = lerp(r1.zzz, c[36].xyw, r7.www);
