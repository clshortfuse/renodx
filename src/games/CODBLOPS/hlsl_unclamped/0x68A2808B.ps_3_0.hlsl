// Mechanically reconstructed from 0x68A2808B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.y = saturate(dot(r9.xyz, -(r2.xyz)));
    r2.w = (r4.w) * (r10.w) + (r10.z);
    r9.w = (r10.y) * (r10.w) + (r10.z);
    r6.xyz = (r1.xyz) * (r1.xyz);
    r2.w = (r2.w) * (r9.w) + (c3.x);
    r1.xyz = (r5.xyz) * (r6.www) + (r6.xyz);
    r2.w = 1.0f / (r2.w);
    r6.w = (r4.w) * (r2.w);
