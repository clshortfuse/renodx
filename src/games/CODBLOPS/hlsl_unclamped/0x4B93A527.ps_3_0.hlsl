// Mechanically reconstructed from 0x4B93A527.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c1 = float4(1.0f, 0.797884583f, 0.25f, 0.0009765625f);
    ...
    r4.xyz = lerp(r0.xyz, c0.yyy, r1.xxx);
    r0.xyz = (r1.xxx) * (r0.xyz);
    r7.xyz = (r4.xyz) * (r4.xyz);
    r5.xyz = (r4.xyz) * (-(r4.xyz)) + (c1.xxx);
    r4.xyz = (r5.xyz) * (r1.zzz) + (r7.xyz);
