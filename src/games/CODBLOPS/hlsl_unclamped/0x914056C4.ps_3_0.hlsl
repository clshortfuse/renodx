// Mechanically reconstructed from 0x914056C4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = (c0.xxxx) * (v8) + (c0.yyyy);
    r2.y = dot(r1.xy, r0.zw) + (c0.w);
    r2.x = dot(r1.xy, r0.xy) + (c0.w);
    r1 = tex2D(s1, v0.xy);
    r0 = tex2D(s0, v0.xy);
    r5.z = (r0.w) * (v7.x) + (c0.z);
    r0 = (r0.xyzx) * (-(c0.yyyw)) + (-(c0.wwwy));
    r3.xy = (r1.wy) * (c3.xy) + (c3.zw);
    r1 = float4(((r5.z) >= 0.0f ? (r0.x) : (c0.w)), ((r5.z) >= 0.0f ? (r0.y) : (c0.w)), ((r5.z) >= 0.0f ? (r0.z) : (c0.w)), ((r5.z) >= 0.0f ? (r0.w) : (c0.w)));
    r4 = tex2D(s7, v0.xy);
    r3.zw = (r4.ww) * (c1.xy) + (c1.zx);
    r0 = tex2D(s5, v7.zw);
    r5.w = (r0.w) * (v7.y) + (c0.z);
    r0 = (r0.xyzx) * (-(c0.yyyw)) + (-(c0.wwwy));
    r3 = float4(((r5.z) >= 0.0f ? (r3.x) : (-(c0.w))), ((r5.z) >= 0.0f ? (r3.y) : (-(c0.w))), ((r5.z) >= 0.0f ? (r3.z) : (-(c0.w))), ((r5.z) >= 0.0f ? (r3.w) : (-(c0.y))));
    r0 = float4(((r5.w) >= 0.0f ? (r0.x) : (r1.x)), ((r5.w) >= 0.0f ? (r0.y) : (r1.y)), ((r5.w) >= 0.0f ? (r0.z) : (r1.z)), ((r5.w) >= 0.0f ? (r0.w) : (r1.w)));
    r1 = tex2D(s8, v7.zw);
    r2.zw = (r1.ww) * (c1.xy) + (c1.zx);
    r1.w = ((r5.z) >= 0.0f ? (r4.y) : (c0.w));
    r4 = float4(((r5.w) >= 0.0f ? (r2.x) : (r3.x)), ((r5.w) >= 0.0f ? (r2.y) : (r3.y)), ((r5.w) >= 0.0f ? (r2.z) : (r3.z)), ((r5.w) >= 0.0f ? (r2.w) : (r3.w)));
    r9.w = ((r5.w) >= 0.0f ? (r1.y) : (r1.w));
    r8.xyz = (r0.xyz) * (r0.xyz);
    r0.z = dot(r4.xy, r4.xy) + (c0.w);
    r10.w = (r4.z) * (-(r4.z)) + (-(c0.y));
    r0.z = exp2(-(r0.z));
    ...
    r2 = (v6.xyzx) * (-(c0.yyyw)) + (-(c0.wwwy));
    r7.xyz = (r0.xyz) * (c1.www) + (r10.xyz);
    r0.z = dot(r2, c[28]);
    r3.w = 1.0f / (r0.z);
    r3.x = dot(r2, c[27]);
    r0.x = dot(r2, c[25]);
