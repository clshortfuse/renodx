// Mechanically reconstructed from 0x81C73F44.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r14.xyz = (r3.www) * (r0.xyz) + (c[32].xyw);
    r0 = tex2D(s6, v7.zw);
    r0.xyz = (r0.xyz) + (c16.yyy);
    r13.xyz = (r1.xyz) * (r14.yyy);
    r1.xyz = (v0.zzz) * (r0.xyz) + (c16.www);
    r0 = tex2D(s8, v1.xy);
    ...
    r1.xy = (r1.xy) * (r1.xy);
    r1.w = ((-abs(r1.w)) >= 0.0f ? (c16.z) : (r1.z));
    r1.z = (r3.x) * (r1.x);
    r1.w = (r1.w) * (r1.z);
    r1.z = (r1.y) * (-(r3.y)) + (c16.w);
    r1.xy = (r2.ww) * (r2.xy);
    r1.w = (r1.w) * (r1.z);
    r2.w = (r3.z) * (r1.w);
