// Mechanically reconstructed from 0x0968F4DE.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xyz = (r2.xyz) * (r3.www) + (r4.xyz);
    r0.z = (r0.w) * (-(c1.x)) + (c1.y);
    r4.w = (r0.w) * (c1.x);
    r0.xy = (r0.ww) * (c3.xy) + (c3.zw);
    r3.w = (r2.w) * (r0.z) + (r4.w);
    r0.x = 1.0f / (r0.x);
    r0.w = (r0.w) * (c0.y);
    r1.w = (r1.w) * (r0.x);
    ...
    r7.xyz = (r2.xyz) * (c[21].xxx);
    r0.xyz = (r0.xyz) * (r0.www) + (v6.xyz);
    r0 = tex3D(s11, r0.xyz);
    r0.xyz = (r0.xyz) * (r0.xyz);
    r2.xyz = (r1.xyz) * (c[21].www);
