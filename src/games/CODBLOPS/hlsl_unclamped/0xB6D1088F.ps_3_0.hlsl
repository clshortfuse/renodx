// Mechanically reconstructed from 0xB6D1088F.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.w = (r2.w) + (r2.w);
    r11.xyz = lerp(r0.xyz, c1.zzz, r5.www);
    r4.xyz = (r10.xyz) * (-(r2.www)) + (r13.xyz);
    r2 = tex2D(s6, v1.xy);
    r4.w = (r2.w) * (c1.w);
