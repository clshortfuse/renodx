// Mechanically reconstructed from 0xD730D700.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c4 = float4(2.0f, -1.0f, 1.0f, 0.200000003f);
    const float4 c9 = float4(0.600000024f, 0.400000006f, 8.0f, 0.797884583f);
    ...
    r2 = tex2D(s6, v1.xy);
    r3 = tex2D(s3, v7.xy);
    r3.xyz = (r3.xyz) + (c4.yyy);
    r3.xyz = (v0.yyy) * (r3.xyz) + (c4.zzz);
    r3.w = r2.w;
    ...
    r6.w = ((r6.w) >= 0.0f ? (r1.y) : (r2.y));
    r9.xyz = (r0.xyz) * (-(r0.xyz)) + (c4.zzz);
    r10.xyz = (r0.xyz) * (r0.xyz);
    r0.xyz = (r9.xyz) * (r4.www) + (r10.xyz);
    r8.xyz = (r5.xyz) * (r5.xyz);
    r4.w = (r0.w) * (-(c11.z)) + (c11.w);
    r1.w = dot(r6.xy, r6.xy) + (c3.x);
    r2.w = exp2(-(r1.w));
    r1.xy = (v1.zw) * (c10.xy) + (c10.zy);
    r1 = tex2D(s13, r1.xy);
    r2.xy = (v1.zw) * (c10.xy);
    r3 = tex2D(s13, r2.xy);
    r1.w = r3.y;
    r3.w = (r2.w) * (c9.x) + (c9.y);
    r7.xy = (r1.wy) * (c11.xx) + (c11.yy);
    r2 = tex2D(s14, v1.zw);
    r11.xy = (r2.xy) * (c10.ww);
    r1.w = dot(r7.xy, r6.xy) + (c3.x);
    r3.xy = (r3.xz) * (r11.xx);
    r1.y = (r2.x) * (c10.w) + (-(r3.x));
    r5.xy = (r1.xz) * (r11.yy);
    r1.x = (r3.z) * (-(r11.x)) + (r1.y);
    r1.y = (r2.y) * (c10.w) + (-(r5.x));
    r1.y = (r1.z) * (-(r11.y)) + (r1.y);
    r1.z = dot(r7.xy, r7.xy) + (c3.x);
    r7.y = (r1.x) + (r1.x);
    r1.z = exp2(-(r1.z));
    r1.y = (r1.y) + (r1.y);
    r1.z = (r1.z) * (c9.x) + (c9.y);
    ...
    r7.w = saturate(dot(r11.xyz, -(r6.xyz)));
