// Mechanically reconstructed from 0xCDBDCFE8.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.z = (r0.w) * (v4.y) + (c0.x);
    r0.w = c0.y;
    r9.xyz = float3(((r4.z) >= 0.0f ? (r0.w) : (c[10].x)), ((r4.z) >= 0.0f ? (r0.w) : (c[10].y)), ((r4.z) >= 0.0f ? (r0.w) : (c[10].w)));
    ...
    r0.xyz = float3(((r4.z) >= 0.0f ? (r0.x) : (r2.x)), ((r4.z) >= 0.0f ? (r0.y) : (r2.y)), ((r4.z) >= 0.0f ? (r0.z) : (r2.z)));
