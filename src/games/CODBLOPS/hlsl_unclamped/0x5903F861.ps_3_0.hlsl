// Mechanically reconstructed from 0x5903F861.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.zw = v6.zw;
    r1 = tex2Dproj(s2, r1);
    r2.xy = (v6.ww) * (-(c[27].xy)) + (v6.xy);
    r2.zw = v6.zw;
    r2 = tex2Dproj(s2, r2);
    r1.y = r2.x;
    r2.xy = (v6.ww) * (c[27].zw) + (v6.xy);
    r2.zw = v6.zw;
    r2 = tex2Dproj(s2, r2);
    r1.z = r2.x;
    r2.xy = (v6.ww) * (-(c[27].zw)) + (v6.xy);
    ...
    r5.xyz = float3(((r5.w) >= 0.0f ? (r2.x) : (c1.z)), ((r5.w) >= 0.0f ? (r2.y) : (c1.z)), ((r5.w) >= 0.0f ? (r2.z) : (c1.z)));
