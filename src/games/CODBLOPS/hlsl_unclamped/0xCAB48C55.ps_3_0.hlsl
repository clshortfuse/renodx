// Mechanically reconstructed from 0xCAB48C55.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s5, v0.xy);
    r0.zw = (r2.ww) * (c1.xy) + (c1.zx);
    r2 = tex2D(s0, v0.xy);
    r4.w = (r2.w) * (v5.x) + (c2.z);
    r1.zw = (r1.ww) * (c1.xy) + (c1.zx);
    r3 = float4(((r4.w) >= 0.0f ? (r0.x) : (-(c2.w))), ((r4.w) >= 0.0f ? (r0.y) : (-(c2.w))), ((r4.w) >= 0.0f ? (r0.z) : (-(c2.w))), ((r4.w) >= 0.0f ? (r0.w) : (-(c2.y))));
    r0 = tex2D(s4, v5.zw);
    r6.xy = (r0.wy) * (c0.xy) + (c0.zw);
    r0 = (c2.xxxx) * (v6) + (c2.yyyy);
    r1.x = dot(r6.xy, r0.xy) + (c2.w);
    r1.y = dot(r6.xy, r0.zw) + (c2.w);
    r0 = tex2D(s3, v5.zw);
    r5.w = (r0.w) * (v5.y) + (c2.z);
    r2 = (r2.xyzx) * (-(c2.yyyw)) + (-(c2.wwwy));
    r1 = float4(((r5.w) >= 0.0f ? (r1.x) : (r3.x)), ((r5.w) >= 0.0f ? (r1.y) : (r3.y)), ((r5.w) >= 0.0f ? (r1.z) : (r3.z)), ((r5.w) >= 0.0f ? (r1.w) : (r3.w)));
    r2 = float4(((r4.w) >= 0.0f ? (r2.x) : (c2.w)), ((r4.w) >= 0.0f ? (r2.y) : (c2.w)), ((r4.w) >= 0.0f ? (r2.z) : (c2.w)), ((r4.w) >= 0.0f ? (r2.w) : (c2.w)));
    r3.xyz = v3.xyz;
    r3.xyz = (r1.xxx) * (r3.xyz) + (v1.xyz);
