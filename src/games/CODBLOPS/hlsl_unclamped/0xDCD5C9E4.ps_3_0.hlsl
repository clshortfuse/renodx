// Mechanically reconstructed from 0xDCD5C9E4.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2 = tex2D(s5, v1.xy);
    r5.w = max(abs(r9.y), abs(r9.z));
    r5.xyz = (r1.xyz) * (r2.www);
    r1.w = max(abs(r9.x), r5.w);
    r1.w = 1.0f / (r1.w);
