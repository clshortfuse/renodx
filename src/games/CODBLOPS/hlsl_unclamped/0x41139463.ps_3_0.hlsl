// Mechanically reconstructed from 0x41139463.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.z = (r3.z) * (c3.x) + (c3.y);
    r4.z = (r3.x) * (r3.z);
    r3.x = dot(r10.xy, r2.xy) + (c1.w);
    r6 = tex2D(s14, v0.zw);
    r12.xy = (r6.xy) * (c3.ww);
    r4.z = saturate((r3.x) * (r4.z) + (r4.z));
    r7.xy = (r7.xz) * (r12.yy);
    r3.x = (r6.y) * (c3.w) + (-(r7.x));
    r10.xz = (r7.xy) * (c4.xx);
    ...
    r5.xz = (r5.xy) * (c4.xx);
    r5.y = (r3.x) + (r3.x);
    r7.xyz = (r5.xyz) * (r3.zzz) + (r6.xyz);
    r4.z = ((r3.w) >= 0.0f ? (r3.y) : (c1.w));
    ...
    r2.y = dot(r6.xyz, r10.xyz);
    r1.xyz = (r7.xyz) * (r7.www);
    r2.y = (r2.y) + (r2.y);
    r3.w = (r2.w) * (c2.w);
    r3.xyz = (r10.xyz) * (-(r2.yyy)) + (r6.xyz);
