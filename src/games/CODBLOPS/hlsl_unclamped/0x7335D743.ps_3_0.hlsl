// Mechanically reconstructed from 0x7335D743.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0 = tex2D(s9, v7.xy);
    r2.z = r0.w;
    r12.xyz = float3(((r1.z) >= 0.0f ? (r2.x) : (r3.x)), ((r1.z) >= 0.0f ? (r2.y) : (r3.y)), ((r1.z) >= 0.0f ? (r2.z) : (r3.z)));
    r3.w = ((r1.z) >= 0.0f ? (r0.y) : (r1.y));
    r0 = tex2D(s5, v7.zw);
    r0.w = (r0.w) * (v0.z) + (c3.w);
    ...
    r1.w = rsqrt(r1.w);
    r6.xyz = (r13.www) * (v6.xyz);
    r11.w = (r12.z) * (-(c16.x)) + (c16.y);
    r3.xyz = (r2.xyz) * (r1.www) + (-(r6.xyz));
    ...
    r3.z = (r2.w) * (r1.z);
    r12.w = (r12.z) * (c12.x);
    r2.w = saturate(dot(r8.xyz, r11.xyz));
    r6.w = saturate(dot(r11.xyz, -(r6.xyz)));
    r1.z = (r2.w) * (r11.w) + (r12.w);
    r10.w = (r6.w) * (r11.w) + (r12.w);
    r1.z = (r1.z) * (r10.w) + (c16.z);
    r16.xy = (r12.zz) * (c28.xy) + (c28.zw);
    r1.z = 1.0f / (r1.z);
    r9.w = exp2(r16.y);
    r3.y = (r2.w) * (r1.z);
    r2.z = pow(abs(r1.w), r9.w);
    r1 = tex2D(s6, v8.xy);
    r1.xyz = (r1.xyz) + (c3.yyy);
    r7.w = (r9.w) * (c13.x) + (c13.y);
    r1.xyz = (v0.www) * (r1.xyz) + (-(c3.yyy));
    r1.w = (r2.z) * (r7.w);
    r2.xyz = (r1.xyz) * (c4.xxx);
    r9.xyz = (r2.xyz) * (-(r2.xyz)) + (-(c3.yyy));
    r10.xyz = (r2.xyz) * (r2.xyz);
    r1.w = (r3.y) * (r1.w);
    r2.xyz = (r9.xyz) * (r3.zzz) + (r10.xyz);
    r0.xyz = float3(((r0.w) >= 0.0f ? (r0.x) : (r4.x)), ((r0.w) >= 0.0f ? (r0.y) : (r4.y)), ((r0.w) >= 0.0f ? (r0.z) : (r4.z)));
    r2.xyz = (r1.www) * (r2.xyz);
    r5.w = ((r0.w) >= 0.0f ? (-(c3.y)) : (r3.w));
    r2.xyz = (r2.xyz) * (c[7].xyz);
    r4.xyz = (r5.www) * (r2.xyz);
    r0.xyz = (r1.xyz) * (r0.xyz);
    r13.xyz = (r0.xyz) * (r0.xyz);
    r0.w = dot(r12.xy, r12.xy) + (c3.z);
    ...
    r7.xz = (r2.xy) * (c12.zz);
    r5.xyz = (r13.xyz) * (r3.xyz) + (r4.xyz);
    r0.xyz = (r7.xyz) * (r3.www) + (r0.xyz);
    r15.xyz = (r5.www) * (r0.xyz);
    r8.w = saturate(dot(r11.xyz, c[17].xyz));
    r0 = tex2D(s12, v1.zw);
    ...
    r0.z = (r7.w) * (r0.z);
    r1.w = (r0.y) * (r0.z);
    r0.xyz = (r9.xyz) * (r1.zzz) + (r10.xyz);
    r0.xyz = (r1.www) * (r0.xyz);
    r0.xyz = (r5.www) * (r0.xyz);
    r1.xyz = (r0.xyz) * (c[19].xyz);
    r0.xyz = (r0.www) * (r14.xyz) + (r15.xyz);
    r1.xyz = (r0.www) * (r1.xyz);
    r1.xyz = (r13.xyz) * (r0.xyz) + (r1.xyz);
    r0.w = (-(r6.w)) + (-(c3.y));
    r0.y = 1.0f / (r16.x);
    r0.z = (r0.w) * (r0.w);
    r0.z = (r0.w) * (r0.z);
    r0.w = dot(r6.xyz, r11.xyz);
    r1.w = (r0.y) * (r0.z);
    r0.z = (r0.w) + (r0.w);
    r0.w = (r12.z) * (c4.w);
