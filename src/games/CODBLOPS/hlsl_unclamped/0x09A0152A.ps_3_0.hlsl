// Mechanically reconstructed from 0x09A0152A.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c13 = float4(4.0f, -2.0f, 0.0f, 0.0f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r1.x = dot(r3.xy, r1.xy) + (c3.x);
    r1.y = dot(r3.xy, r1.zw) + (c3.x);
    r5 = tex2D(s3, v6.zw);
    r7.w = (r5.w) * (v0.z);
    r3.xy = (r0.yw) * (c13.xx) + (c13.yy);
    r6.xy = lerp(r4.xy, r1.xy, r7.ww);
    r0.w = dot(r3.xy, r3.xy) + (c3.x);
    r0.y = dot(r6.xy, r6.xy) + (c3.x);
    r0.w = exp2(-(r0.w));
    r0.y = exp2(-(r0.y));
    r0.w = (r0.w) * (c3.y) + (c3.z);
    r3.w = (r0.y) * (c3.y) + (c3.z);
    ...
    r2.w = lerp(r5.w, r0.y, r7.w);
    r0.z = (r0.z) + (r0.z);
    r5.w = lerp(r1.w, r0.w, r7.w);
    r0.xyz = (r9.xyz) * (-(r0.zzz)) + (r1.xyz);
    r0.w = (r5.w) * (c3.w);
    r1.w = (r5.w) * (c4.x) + (c4.y);
