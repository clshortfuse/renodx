// Mechanically reconstructed from 0x607ADAE2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.z = rsqrt(r0.w);
    r0.xyz = (v7.xyz) * (-(r1.zzz)) + (c[17].xyz);
    r16.xyz = normalize(r0.xyz);
    r0.xyz = (-(v7.xyz)) + (c[6].xyz);
    r1.w = saturate(dot(r16.xyz, c[17].xyz));
    r0.w = dot(r0.xyz, r0.xyz);
    r0.w = rsqrt(r0.w);
    r3.xyz = (r1.zzz) * (v7.xyz);
    r1.w = (-(r1.w)) + (c0.y);
    ...
    r2 = tex2D(s0, v1.xy);
    r3.w = (r2.w) * (v0.w) + (c0.x);
    r6.xy = float2(((r3.w) >= 0.0f ? (r0.x) : (c0.z)), ((r3.w) >= 0.0f ? (r0.y) : (c0.z)));
    ...
    r8.xyz = (r0.xyz) * (c[8].xyz);
    r4.z = 1.0f / (r2.x);
    r4.w = (-(r2.z)) + (c0.y);
    r0.z = dot(r3.xyz, r15.xyz);
    r4.y = (r4.w) * (r4.w);
    r0.z = (r0.z) + (r0.z);
    r2.w = (r2.w) * (c0.w);
    r2.xyz = (r15.xyz) * (-(r0.zzz)) + (r3.xyz);
    r2 = texCUBElod(s15, r2);
    r0.xyz = (r2.xyz) * (r2.xyz);
    r4.w = (r4.w) * (r4.y);
    r3.xyz = (r0.xyz) * (c0.www);
    r2 = tex3D(s11, v8.xyz);
    r0.xyz = (r2.xyz) * (r2.xyz);
    r2.w = (r4.z) * (r4.w);
    r0.xyz = (r3.xyz) * (r0.xyz);
    r0.xyz = (r0.xyz) * (c3.xxx);
    r3.z = max(abs(r15.y), abs(r15.z));
    r2.xyz = (r13.xyz) * (r2.www) + (r14.xyz);
    r2.w = max(abs(r15.x), r3.z);
    r10.xyz = (r0.xyz) * (r2.xyz);
    r2.w = 1.0f / (r2.w);
    r0.y = c0.z;
    r9.xyz = float3(((r3.w) >= 0.0f ? (c[31].x) : (r0.y)), ((r3.w) >= 0.0f ? (c[31].y) : (r0.y)), ((r3.w) >= 0.0f ? (c[31].w) : (r0.y)));
    r0.xyz = (r15.xyz) * (c[5].xyz);
    r12.w = saturate(dot(r15.xyz, c[17].xyz));
    ...
    r11.xyz = (r12.www) * (r3.xyz);
    r12.xyz = (r0.xyz) * (c3.xxx);
    if ((c0.y) >= (v6.w))
    {
        r4 = (v6.xyzx) * (c0.yyyz);
        r3 = (r4) + (-(c4.xyzz));
    ...
    r0.z = (r0.z) * (r14.w) + (c3.w);
    r3.z = saturate(dot(r15.xyz, r16.xyz));
    r0.y = 1.0f / (r0.z);
    r0.z = pow(abs(r3.z), r13.w);
    r0.y = (r12.w) * (r0.y);
    r0.z = (r11.w) * (r0.z);
    r3.z = (r0.y) * (r0.z);
    ...
    r3.xyz = (r3.www) * (r11.xyz) + (r12.xyz);
    r4.xyz = (r3.www) * (r0.xyz);
    r0.xyz = (r10.xyz) * (r9.xxx);
    r3.xyz = (r1.xyz) * (r3.xyz) + (r4.xyz);
    r7.xyz = (r0.xyz) * (r2.xyz) + (r3.xyz);
    r2 = (v7.yyyy) * (c[26]);
    r9.xyz = (r8.xyz) * (r9.zzz);
    r2 = (v7.xxxx) * (c[25]) + (r2);
    r8.xyz = (r9.www) * (c[7].xyz);
    r2 = (v7.zzzz) * (c[27]) + (r2);
    r0.z = saturate((r8.w) * (c[24].x) + (c[24].y));
    r5 = (r2) + (c[28]);
    ...
    r4.xy = (r3.xy) * (-(c13.ww)) + (-(c13.yy));
    r3.xy = (r3.xy) * (r3.xy);
    r0.z = ((-abs(r0.z)) >= 0.0f ? (c0.z) : (r3.w));
    r3.w = (r4.x) * (r3.x);
    r0.z = (r0.z) * (r3.w);
    r3.w = (r3.y) * (-(r4.y)) + (c0.y);
    r0.xy = (r4.ww) * (r0.xy);
