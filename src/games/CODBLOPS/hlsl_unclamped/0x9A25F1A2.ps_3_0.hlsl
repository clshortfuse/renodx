// Mechanically reconstructed from 0x9A25F1A2.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r11.xy = (r6.zz) * (c12.xy) + (c12.zw);
    r8.xyz = (r4.xyz) * (r2.zzz) + (-(r7.xyz));
    r5.w = exp2(r11.y);
    ...
    r1.w = dot(c[23].yz, r10.xy) + (c[23].x);
    r2.xy = (r2.xy) * (r3.xy);
    r2.w = (r2.w) * (r8.w);
    r1.w = (r1.w) * (r2.x);
