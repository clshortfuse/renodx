// Mechanically reconstructed from 0x95EB8738.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c2 = float4(0.0f, -0.5f, 0.600000024f, 0.400000006f);
    const float4 c3 = float4(8.0f, 3.5f, 1.0f, 0.5f);
    const float4 c4 = float4(1.0f, 0.5f, 0.0f, 31.875f);
    const float4 c11 = float4(4.0f, -2.0f, 0.0f, 0.0f);
    const float4 c12 = float4(2.0f, -1.0f, 1.0f, 0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r2.x = dot(r3.xy, r0.xy) + (c2.x);
    r2.y = dot(r3.xy, r0.zw) + (c2.x);
    r3 = tex2D(s5, v1.xy);
    r5.zw = r3.yy;
    r0 = tex2D(s3, v6.zw);
    r6.w = (r0.w) * (v0.z) + (c2.y);
    r6.xy = (r1.yw) * (c11.xx) + (c11.yy);
    r2 = float4(((r6.w) >= 0.0f ? (r2.x) : (r5.x)), ((r6.w) >= 0.0f ? (r2.y) : (r5.y)), ((r6.w) >= 0.0f ? (r2.z) : (r5.z)), ((r6.w) >= 0.0f ? (r2.w) : (r5.w)));
    r1.w = dot(r6.xy, r6.xy) + (c2.x);
    r0.w = dot(r2.xy, r2.xy) + (c2.x);
    r1.w = exp2(-(r1.w));
    r0.w = exp2(-(r0.w));
    r1.w = (r1.w) * (c2.z) + (c2.w);
    r0.w = (r0.w) * (c2.z) + (c2.w);
    ...
    r6.y = (r1.w) + (r1.w);
    r1.xyz = v2.xyz;
    r3.xyz = (r2.xxx) * (v4.xyz) + (r1.xyz);
    r1.xyz = (r6.xyz) * (r0.www) + (r4.xyz);
    ...
    r0.w = (r0.w) + (r0.w);
    r7.xyz = (v0.yyy) * (r1.xyz) + (c12.zzz);
    r3.xyz = (r9.xyz) * (-(r0.www)) + (r8.xyz);
    r4.xyz = (r7.xyz) * (c12.www);
    r1 = tex2D(s6, v6.zw);
    ...
    r0.xyz = float3(((r6.w) >= 0.0f ? (r0.x) : (r2.x)), ((r6.w) >= 0.0f ? (r0.y) : (r2.y)), ((r6.w) >= 0.0f ? (r0.z) : (r2.z)));
