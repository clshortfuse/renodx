// Mechanically reconstructed from 0x36A06B94.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r3.w = 1.0f / (r2.x);
    r1.xyz = (r1.xyz) * (c[11].www);
    r1.w = (r1.w) * (c1.x);
    r3.xyz = (r1.xyz) * (c[8].xyz);
    r1.z = dot(c[9].yz, r5.xy) + (c[9].x);
    r2.xy = saturate((r5.xx) * (c[10].xy) + (c[10].zw));
    r1.xy = (r2.xy) * (r2.xy);
