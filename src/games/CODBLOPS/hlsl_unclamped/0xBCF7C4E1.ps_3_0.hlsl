// Mechanically reconstructed from 0xBCF7C4E1.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xy = (r1.ww) * (c[28].xy);
    r4.xy = (r4.xy) * (c[27].xx);
    r4.xy = (v4.xy) * (c[27].xx) + (r4.xy);
    r4 = tex2D(s7, r4.xy);
    r4.xyz = (r4.xyz) * (r4.xyz);
    r4.xyz = (r4.xyz) * (v7.xxx);
    r4.xyz = (r4.xyz) * (c3.www);
    r5.xy = (r1.ww) * (c[29].xy);
    r5.xy = (r5.xy) * (c[30].xx);
    r5.xy = (v4.xy) * (c[30].xx) + (r5.xy);
    r5 = tex2D(s6, r5.xy);
    ...
    r0.x = saturate(dot(r7.xyz, r3.xyz));
