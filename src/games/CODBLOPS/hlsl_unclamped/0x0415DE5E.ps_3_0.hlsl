// Mechanically reconstructed from 0x0415DE5E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xyz = lerp(r1.yyy, c[31].xyw, r8.www);
    ...
    r6.xyz = (r2.www) * (r6.xyz) + (r11.xyz);
    r4.z = (r3.w) * (c3.w);
    r1.y = (r3.w) * (-(c12.z)) + (c12.w);
    r11.xyz = normalize(v6.xyz);
    r0.w = (r1.z) * (r1.y) + (r4.z);
    r1.w = saturate(dot(r9.xyz, -(r11.xyz)));
    r1.y = (r1.w) * (r1.y) + (r4.z);
    r1.w = (-(r1.w)) + (-(c1.y));
    r0.w = (r0.w) * (r1.y) + (c13.x);
    r5.xyz = (r12.xyz) * (r6.www) + (-(r11.xyz));
    r0.w = 1.0f / (r0.w);
    ...
    r13.xyz = (r4.xyz) * (r1.yyy) + (r10.xyz);
    r3.xyz = (r0.xyz) * (-(r1.xxx)) + (r2.xyz);
    r2.xyz = (r1.zzz) * (r13.xyz);
