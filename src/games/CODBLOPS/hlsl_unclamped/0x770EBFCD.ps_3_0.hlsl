// Mechanically reconstructed from 0x770EBFCD.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    const float4 c9 = float4(0.600000024f, 0.400000006f, 3.5f, 1.0f);
    const float4 c10 = float4(2.0f, -1.0f, 1.0f, 0.200000003f);
    float4 r0 = 0.0f;
    float4 r1 = 0.0f;
    float4 r2 = 0.0f;
    float4 r3 = 0.0f;
    ...
    r0 = tex2D(s2, v6.xy);
    r0.xyz = (r0.xyz) + (c10.yyy);
    r0.w = (r1.w) + (r1.w);
    r6.xyz = (v0.yyy) * (r0.xyz) + (c10.zzz);
    r2.xyz = (r9.xyz) * (-(r0.www)) + (r8.xyz);
    r4.xyz = (r6.xyz) * (c10.www);
