// Mechanically reconstructed from 0x0826D643.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (r0.z) * (-(r6.x)) + (r1.w);
    r6.w = c12.x;
    r0.xyz = (r6.www) + (-(c[20].xyw));
    r8.y = (r1.w) + (r1.w);
    r3.xyz = (r8.www) * (r0.xyz) + (c[20].xyw);
    r0.xyz = (r8.xyz) * (r0.www) + (r4.xyz);
    r7.xyz = lerp(r3.xyz, c12.xxx, r5.www);
