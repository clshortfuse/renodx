// Mechanically reconstructed from 0xDBEB5452.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.y = dot(r1.xy, r0.zw) + (c43.w);
    r2.x = dot(r1.xy, r0.xy) + (c43.w);
    r0 = tex2D(s1, v1.xy);
    r1 = tex2D(s5, v7.xy);
    r1.xyz = (r1.xyz) + (c43.yyy);
    r3.xy = (r0.wy) * (c1.xy) + (c1.zw);
    r4.xyz = (v0.yyy) * (r1.xyz) + (c43.zzz);
    r0 = tex2D(s0, v1.xy);
    r1 = tex2D(s6, v7.zw);
    r5.w = (r1.w) * (v0.z);
    r1.xyz = (r0.xyz) * (-(r4.xyz)) + (r1.xyz);
    r10.xy = lerp(r3.xy, r2.xy, r5.ww);
    r1.xyz = (r5.www) * (r1.xyz);
    r0.w = dot(r10.xy, r10.xy) + (c43.w);
    r3.xyz = (r0.xyz) * (r4.xyz) + (r1.xyz);
    r0.w = exp2(-(r0.w));
    r3.w = (r0.w) * (c4.x) + (c4.y);
    r0.xy = (v1.zw) * (c12.xy);
    r2 = tex2D(s13, r0.xy);
    ...
    r1 = tex2D(s14, v1.zw);
    r6.xy = (r1.xy) * (c4.ww);
    r7.xy = (r2.yw) * (c42.xx) + (c42.yy);
    r2.xy = (r2.xz) * (r6.xx);
    r0.w = dot(r7.xy, r10.xy) + (c43.w);
    r0.y = (r1.x) * (c4.w) + (-(r2.x));
    r1.w = (r2.z) * (-(r6.x)) + (r0.y);
    r5.xy = (r0.xz) * (r6.yy);
    r0.y = (r1.y) * (c4.w) + (-(r5.x));
    r0.x = dot(r7.xy, r7.xy) + (c43.w);
    r0.y = (r0.z) * (-(r6.y)) + (r0.y);
    r0.z = exp2(-(r0.x));
    r9.y = (r1.w) + (r1.w);
    r0.z = (r0.z) * (c4.x) + (c4.y);
    ...
    r13.xyz = lerp(c[39].xyw, r1.yyy, r5.www);
    r1.w = (-(r1.w)) + (c43.z);
