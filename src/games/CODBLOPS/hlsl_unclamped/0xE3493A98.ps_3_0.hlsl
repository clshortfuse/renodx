// Mechanically reconstructed from 0xE3493A98.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r10.xz = (r3.xy) * (c4.ww);
    r0.xyz = (r5.xyz) * (r2.www) + (-(r15.xyz));
    r3.xyz = (r10.xyz) * (r3.www) + (r1.xyz);
    ...
    r0.yz = c1.yz;
    r1.xyz = float3(((r0.w) >= 0.0f ? (r0.y) : (c[29].x)), ((r0.w) >= 0.0f ? (r0.z) : (c[29].y)), ((r0.w) >= 0.0f ? (r0.y) : (c[29].w)));
    r0 = tex2D(s6, v8.zw);
    r0.w = (r0.w) * (v0.z) + (c1.x);
    r2.xyz = float3(((r0.w) >= 0.0f ? (r0.x) : (r2.x)), ((r0.w) >= 0.0f ? (r0.y) : (r2.y)), ((r0.w) >= 0.0f ? (r0.z) : (r2.z)));
    r9.xyz = (r5.xyz) * (r2.www);
    r13.xyz = float3(((r0.w) >= 0.0f ? (c1.y) : (r1.x)), ((r0.w) >= 0.0f ? (c1.z) : (r1.y)), ((r0.w) >= 0.0f ? (c1.y) : (r1.z)));
