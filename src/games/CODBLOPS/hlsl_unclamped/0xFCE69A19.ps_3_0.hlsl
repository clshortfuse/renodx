// Mechanically reconstructed from 0xFCE69A19.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = (r5.www) * (r3.xyz) + (c[28].xyw);
    r9.xyz = normalize(r0.xyz);
    r3.xyz = (r2.xyz) * (r4.yyy);
    r1.w = saturate(dot(r9.xyz, r5.xyz));
    r2 = tex2D(s6, v1.xy);
    r0.y = (r2.w) * (c3.z);
    r7.xyz = normalize(v7.xyz);
    r0.z = (r2.w) * (-(c14.z)) + (c14.w);
    r4.y = saturate(dot(r9.xyz, -(r7.xyz)));
    r3.w = (r1.w) * (r0.z) + (r0.y);
    r6.z = (r4.y) * (r0.z) + (r0.y);
    r0.xyz = (r1.www) * (c[21].xyz);
    r3.w = (r3.w) * (r6.z) + (c4.x);
    r6.xyz = (r4.www) * (r0.xyz) + (r3.xyz);
    r0.z = 1.0f / (r3.w);
    r7.w = (r1.w) * (r0.z);
    r3.xyz = (r10.xyz) * (r8.www) + (-(r7.xyz));
