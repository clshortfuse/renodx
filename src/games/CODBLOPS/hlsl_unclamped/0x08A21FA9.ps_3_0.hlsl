// Mechanically reconstructed from 0x08A21FA9.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r2.xyz = (v0.yyy) * (r1.xyz) + (c1.zzz);
    r5 = tex2D(s5, v1.xy);
    r0 = tex2D(s0, v1.xy);
    r3.xyz = lerp(r0.xyz, c1.xxx, r5.xxx);
    r1 = tex2D(s4, v8.zw);
    r1.xyz = (r1.xyz) + (c1.yyy);
    r3.xyz = (r2.xyz) * (r3.xyz);
    r1.xyz = (v0.zzz) * (r1.xyz) + (c1.zzz);
    r6.w = (r5.w) * (-(c12.z)) + (c12.w);
    r3.xyz = (r3.xyz) * (r1.xyz);
    r0.xyz = (r5.xxx) * (r0.xyz);
    r10.xyz = (r3.xyz) * (-(r3.xyz)) + (c1.zzz);
    ...
    r15.xyz = (r5.yyy) * (r1.xyz);
    r14.xyz = (r5.yyy) * (r0.xyz);
    r1 = tex2D(s12, v1.zw);
