// Mechanically reconstructed from 0xC787ED61.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r7.xy = saturate((r8.xx) * (c[31].xy) + (c[31].zw));
    r1.xy = (r7.xy) * (r7.xy);
    r7.xy = (r7.xy) * (c1.xx) + (c1.yy);
    r2.w = dot(c[30].yz, r8.xy) + (c[30].x);
    r7.xy = (r1.xy) * (r7.xy);
    r1.xyz = (r6.xyz) * (r3.www);
    r2.w = (r2.w) * (r7.x);
    r2.w = (r7.y) * (r2.w);
