// Mechanically reconstructed from 0x9C94A2E5.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r4.xyz = (r7.www) * (r11.xyz) + (r12.xyz);
    r8.w = (r2.w) * (c2.z);
    r7.y = (r2.w) * (-(c14.z)) + (c14.w);
