// Mechanically reconstructed from 0x0629C230.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.yz = c0.yz;
    r7.xyz = float3(((r3.w) >= 0.0f ? (c[26].x) : (r12.z)), ((r3.w) >= 0.0f ? (c[26].y) : (r12.z)), ((r3.w) >= 0.0f ? (c[26].w) : (r12.z)));
    r2.w = (r2.w) * (c0.w);
    r2.xyz = (r2.xyz) * (r7.zzz);
    r0 = float4(((r3.w) >= 0.0f ? (r0.x) : (c0.z)), ((r3.w) >= 0.0f ? (r0.y) : (c0.z)), ((r3.w) >= 0.0f ? (r0.z) : (c0.z)), ((r3.w) >= 0.0f ? (r0.w) : (c0.z)));
    r4.xyz = (r2.xyz) * (c[23].xyz);
    r2.z = dot(c[24].yz, r8.xy) + (c[24].x);
    r3.xy = saturate((r8.xx) * (c[25].xy) + (c[25].zw));
    r2.xy = (r3.xy) * (r3.xy);
