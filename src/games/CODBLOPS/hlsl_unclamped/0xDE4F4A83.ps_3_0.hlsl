// Mechanically reconstructed from 0xDE4F4A83.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r6.xy = float2(((r2.w) >= 0.0f ? (r4.x) : (r5.x)), ((r2.w) >= 0.0f ? (r4.y) : (r5.y)));
    ...
    r9.xy = float2(((r2.w) >= 0.0f ? (-(c2.z)) : (r1.y)), ((r2.w) >= 0.0f ? (-(c2.y)) : (r1.y)));
    r5.w = saturate(dot(r8.xyz, c[17].xyz));
    ...
    r0.x = (r1.w) * (-(c11.x)) + (c11.y);
    r0.z = saturate(dot(r8.xyz, -(r1.xyz)));
    r0.w = (r5.w) * (r0.x) + (r3.w);
    r0.x = (r0.z) * (r0.x) + (r3.w);
    r7.xyz = (v5.xyz) * (-(r2.www)) + (c[17].xyz);
    r0.w = (r0.w) * (r0.x) + (c11.z);
    r2.w = (-(r0.z)) + (-(c2.y));
    r0.w = 1.0f / (r0.w);
    r3.w = (r5.w) * (r0.w);
