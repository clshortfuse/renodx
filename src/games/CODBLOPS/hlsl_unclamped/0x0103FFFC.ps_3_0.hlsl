// Mechanically reconstructed from 0x0103FFFC.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r12.yz = c0.yz;
    r6.xyz = float3(((r2.w) >= 0.0f ? (c[37].x) : (r12.z)), ((r2.w) >= 0.0f ? (c[37].y) : (r12.z)), ((r2.w) >= 0.0f ? (c[37].w) : (r12.z)));
    r6.w = 1.0f / (r3.x);
    ...
    r1.xyz = (r7.xyz) * (r6.yyy);
    r2.w = dot(r4.xyz, r10.xyz);
    r1.xyz = (r1.xyz) * (c1.xxx);
    r2.w = (r2.w) + (r2.w);
    r2.xyz = (r2.xyz) * (r5.xyz) + (r1.xyz);
