// Mechanically reconstructed from 0xB79C728E.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.xy = float2(((r5.w) >= 0.0f ? (r0.w) : (r1.w)), ((r5.w) >= 0.0f ? (r0.y) : (r1.y)));
    r0.xyz = (r4.xyz) * (r1.zzz) + (-(r6.xyz));
    r3.xyz = normalize(r0.xyz);
    r4.xyz = (r4.xyz) * (r1.zzz);
    r13.xyz = lerp(r1.yyy, c[39].xyw, r4.www);
