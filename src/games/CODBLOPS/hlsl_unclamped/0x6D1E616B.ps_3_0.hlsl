// Mechanically reconstructed from 0x6D1E616B.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r1.w = (-(r1.w)) + (c2.w);
    r1.z = (r0.w) * (c13.z) + (c13.w);
    r1.x = (r1.w) * (r1.w);
    r1.z = 1.0f / (r1.z);
    r1.w = (r1.w) * (r1.x);
    r3.xy = lerp(r10.xy, r1.yy, r8.ww);
    r2.w = (r1.z) * (r1.w);
    ...
    r4.z = rsqrt(r0.z);
    r4.w = rsqrt(r0.w);
    r6.xyz = lerp(r10.xyz, r5.xyz, r8.www);
    r3 = (r3) * (r4);
    r3 = (r9.yyyy) * (r3);
    r2 = (r2) * (r4);
    r1 = (r1) * (r4);
