// Mechanically reconstructed from 0x0BFB0565.ps_3_0.cso.
...
float4 main(PS_INPUT input) : COLOR0
{
    ...
    r0.w = rsqrt(r5.y);
    r5.x = 1.0f / (r0.w);
    r11.xyz = lerp(c[39].xyw, r1.yyy, r10.www);
    r2.xy = saturate((r5.xx) * (c[35].xy) + (c[35].zw));
    r1.xy = (r2.xy) * (r2.xy);
    r2.xy = (r2.xy) * (c14.xx) + (c14.yy);
    r1.z = dot(c[34].yz, r5.xy) + (c[34].x);
    r1.xy = (r1.xy) * (r2.xy);
