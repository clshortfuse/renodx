...
// Transition from scanner scenes
// ---- Created with 3Dmigoto v1.4.1 on Thu Apr 17 23:31:25 2025
...
void main(
  ...
  if (RENODX_TONE_MAP_TYPE == 0.f) {
    o0.rgb = Vanilla(r2.rgb, t4, s4_s, cb0[36].xyz, v1.xy, t0, s0_s, cb0[30]);
  } else {
    o0.rgb = ApplyUserTonemap(r2.rgb, t4, s4_s, cb0[36].xyz);
  }
