...
//   float _801;
//   float _809;
//   _21 = (DeviceCorrectorContext.z != 0.0f);
//   _37 = SV_Position.x - float((uint)(uint)(ViewportDestination_ViewportMin.x));
//   _38 = SV_Position.y - float((uint)(uint)(ViewportDestination_ViewportMin.y));
//   _44 = saturate(_37 * ViewportDestination_ViewportSizeInverse.x);
//   _45 = saturate(_38 * ViewportDestination_ViewportSizeInverse.y);
//   _58 = select(_21, saturate(ViewportDestination_ViewportSizeInverse.x * ((floor(_37 * 0.5f) * 2.0f) + 1.0f)), _44);
//   _59 = select(_21, saturate(((floor(_38 * 0.5f) * 2.0f) + 1.0f) * ViewportDestination_ViewportSizeInverse.y), _45);
//   _128 = ColorTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(min(max((((ViewportColor_ViewportSize.x * _58) + float((uint)(uint)(ViewportColor_ViewportMin.x))) * ViewportColor_ExtentInverse.x), ViewportColor_UVViewportBilinearMin.x), ViewportColor_UVViewportBilinearMax.x), min(max((((ViewportColor_ViewportSize.y * _59) + float((uint)(uint)(ViewportColor_ViewportMin.y))) * ViewportColor_ExtentInverse.y), ViewportColor_UVViewportBilinearMin.y), ViewportColor_UVViewportBilinearMax.y)), 0.0f);
//   _140 = (1.0f / max(0.0010000000474974513f, VignetteContext.y)) * TEXCOORD_1.z;
//   _145 = (_140 * _140) * (1.0f / max(9.999999747378752e-06f, dot(float3(TEXCOORD_1.x, TEXCOORD_1.y, _140), float3(TEXCOORD_1.x, TEXCOORD_1.y, _140))));
//   _149 = (((_145 * _145) + -1.0f) * VignetteContext.x) + 1.0f;
//   _150 = _149 * min(_128.x, 64512.0f);
//   _151 = _149 * min(_128.y, 64512.0f);
//   _152 = _149 * min(_128.z, 64512.0f);
//   _154 = GlareTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(min(max((((ViewportGlare_ViewportSize.x * _58) + float((uint)(uint)(ViewportGlare_ViewportMin.x))) * ViewportGlare_ExtentInverse.x), ViewportGlare_UVViewportBilinearMin.x), ViewportGlare_UVViewportBilinearMax.x), min(max((((ViewportGlare_ViewportSize.y * _59) + float((uint)(uint)(ViewportGlare_ViewportMin.y))) * ViewportGlare_ExtentInverse.y), ViewportGlare_UVViewportBilinearMin.y), ViewportGlare_UVViewportBilinearMax.y)), 0.0f);
//   _180 = saturate(DeviceCorrectorContext.x);
//   _182 = saturate(DeviceCorrectorContext.y);
//   _187 = exp2(log2(saturate(((((min(_154.x, 64512.0f) - _150) + (GlareContext.y * _150)) * GlareContext.x) + _150) * 0.009999999776482582f)) * 0.1593017578125f);
//   _203 = exp2(log2(saturate(((((min(_154.y, 64512.0f) - _151) + (GlareContext.y * _151)) * GlareContext.x) + _151) * 0.009999999776482582f)) * 0.1593017578125f);
//   _219 = exp2(log2(saturate(((((min(_154.z, 64512.0f) - _152) + (GlareContext.y * _152)) * GlareContext.x) + _152) * 0.009999999776482582f)) * 0.1593017578125f);
//   _238 = BT709PQToBT2020PQLUT.SampleLevel(View_SharedBilinearClampedSampler, float3(((saturate(exp2(log2(max(0.0f, (((_187 * 18.8515625f) + 0.8359375f) * (1.0f / ((_187 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f), ((saturate(exp2(log2(max(0.0f, (((_203 * 18.8515625f) + 0.8359375f) * (1.0f / ((_203 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f), ((saturate(exp2(log2(max(0.0f, (((_219 * 18.8515625f) + 0.8359375f) * (1.0f / ((_219 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f)), 0.0f);
//   _245 = exp2(log2(saturate(_238.x)) * 0.012683313339948654f);
//   _254 = exp2(log2(max(0.0f, ((_245 + -0.8359375f) * (1.0f / (18.8515625f - (_245 * 18.6875f)))))) * 6.277394771575928f);
//   _259 = exp2(log2(saturate(_238.y)) * 0.012683313339948654f);
//   _268 = exp2(log2(max(0.0f, ((_259 + -0.8359375f) * (1.0f / (18.8515625f - (_259 * 18.6875f)))))) * 6.277394771575928f);
//   _273 = exp2(log2(saturate(_238.z)) * 0.012683313339948654f);
//   _282 = exp2(log2(max(0.0f, ((_273 + -0.8359375f) * (1.0f / (18.8515625f - (_273 * 18.6875f)))))) * 6.277394771575928f);
//   if (_180 > 0.0f) {
//     _287 = 1.0f - (_180 * 0.2928932309150696f);
//     _300 = exp2(log2(saturate(_254 * 10.0f)) * _287);
//     _301 = exp2(log2(saturate(_268 * 10.0f)) * _287);
//     _302 = exp2(log2(saturate(_282 * 10.0f)) * _287);
//     _310 = exp2(log2(saturate(_300 * 0.09999999403953552f)) * 0.1593017578125f);
//     _326 = exp2(log2(saturate(_301 * 0.09999999403953552f)) * 0.1593017578125f);
//     _342 = exp2(log2(saturate(_302 * 0.09999999403953552f)) * 0.1593017578125f);
//     _355 = (_300 * 1000.0f);
//     _356 = (_301 * 1000.0f);
//     _357 = (_302 * 1000.0f);
...
//   }
//   if (_182 < 1.0f) {
//     _370 = BT2020PQ1000ToBT2020PQ250LUT.SampleLevel(View_SharedBilinearClampedSampler, float3(((_358 * 0.96875f) + 0.015625f), ((_359 * 0.96875f) + 0.015625f), ((_360 * 0.96875f) + 0.015625f)), 0.0f);
//     _377 = exp2(log2(saturate(_370.x)) * 0.012683313339948654f);
//     _387 = exp2(log2(max(0.0f, ((_377 + -0.8359375f) * (1.0f / (18.8515625f - (_377 * 18.6875f)))))) * 6.277394771575928f) * 10000.0f;
//     _391 = exp2(log2(saturate(_370.y)) * 0.012683313339948654f);
//     _401 = exp2(log2(max(0.0f, ((_391 + -0.8359375f) * (1.0f / (18.8515625f - (_391 * 18.6875f)))))) * 6.277394771575928f) * 10000.0f;
//     _405 = exp2(log2(saturate(_370.z)) * 0.012683313339948654f);
//     _415 = exp2(log2(max(0.0f, ((_405 + -0.8359375f) * (1.0f / (18.8515625f - (_405 * 18.6875f)))))) * 6.277394771575928f) * 10000.0f;
...
//     _428 = _357;
//   }
//   _433 = exp2(log2(saturate(_426 * 9.999999747378752e-05f)) * 0.1593017578125f);
//   _444 = saturate(exp2(log2(max(0.0f, (((_433 * 18.8515625f) + 0.8359375f) * (1.0f / ((_433 * 18.6875f) + 1.0f))))) * 78.84375f));
//   _449 = exp2(log2(saturate(_427 * 9.999999747378752e-05f)) * 0.1593017578125f);
//   _460 = saturate(exp2(log2(max(0.0f, (((_449 * 18.8515625f) + 0.8359375f) * (1.0f / ((_449 * 18.6875f) + 1.0f))))) * 78.84375f));
//   _465 = exp2(log2(saturate(_428 * 9.999999747378752e-05f)) * 0.1593017578125f);
//   _476 = saturate(exp2(log2(max(0.0f, (((_465 * 18.8515625f) + 0.8359375f) * (1.0f / ((_465 * 18.6875f) + 1.0f))))) * 78.84375f));
//   _486 = max(9.999999747378752e-05f, HDRCompositionContextColor.x);
//   _487 = max(9.999999747378752e-05f, HDRCompositionContextColor.y);
//   _488 = max(9.999999747378752e-05f, HDRCompositionContextColor.z);
//   _490 = 1.0f / dot(float3(_486, _487, _488), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
//   _491 = dot(float3(_426, _427, _428), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f)) * 9.999999747378752e-05f;
//   _497 = exp2(log2(saturate((_491 * _486) * _490)) * 0.1593017578125f);
//   _514 = exp2(log2(saturate((_491 * _487) * _490)) * 0.1593017578125f);
//   _531 = exp2(log2(saturate((_491 * _488) * _490)) * 0.1593017578125f);
//   _550 = BT2020PQTosRGBLUT.SampleLevel(View_SharedBilinearClampedSampler, float3(((saturate(exp2(log2(max(0.0f, (((_497 * 18.8515625f) + 0.8359375f) * (1.0f / ((_497 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f), ((saturate(exp2(log2(max(0.0f, (((_514 * 18.8515625f) + 0.8359375f) * (1.0f / ((_514 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f), ((saturate(exp2(log2(max(0.0f, (((_531 * 18.8515625f) + 0.8359375f) * (1.0f / ((_531 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f)), 0.0f);
//   if (_550.x < 0.040449999272823334f) {
//     _564 = (_550.x * 0.07739938050508499f);
//   } else {
//     _564 = exp2(log2((_550.x + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f);
//   }
//   if (_550.y < 0.040449999272823334f) {
//     _575 = (_550.y * 0.07739938050508499f);
//   } else {
//     _575 = exp2(log2((_550.y + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f);
//   }
//   if (_550.z < 0.040449999272823334f) {
//     _586 = (_550.z * 0.07739938050508499f);
//   } else {
//     _586 = exp2(log2((_550.z + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f);
//   }
//   _589 = (1.0f / max(0.0010000000474974513f, HDRCompositionContext.z)) * TEXCOORD_1.w;
//   _594 = (_589 * _589) * (1.0f / max(9.999999747378752e-06f, dot(float3(TEXCOORD_1.x, TEXCOORD_1.y, _589), float3(TEXCOORD_1.x, TEXCOORD_1.y, _589))));
//   _598 = (saturate(_594 * _594) + -1.0f) * HDRCompositionContext.y;
//   _599 = -0.0f - _598;
//   _603 = CompositeSDRTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(((min(((ViewportDestination_ViewportSize.x * 0.5625f) * ViewportDestination_ViewportSizeInverse.y), 1.0f) * (_44 + -0.5f)) + 0.5f), ((min(((ViewportDestination_ViewportSize.y * 1.7777777910232544f) * ViewportDestination_ViewportSizeInverse.x), 1.0f) * (_45 + -0.5f)) + 0.5f)), 0.0f);
//   _617 = (((_564 * HDRCompositionContext.x) * _599) * _603.w) + _603.x;
//   _618 = (((_575 * HDRCompositionContext.x) * _599) * _603.w) + _603.y;
//   _619 = (((_586 * HDRCompositionContext.x) * _599) * _603.w) + _603.z;
//   _620 = _603.w * ((_598 * HDRCompositionContext.x) + 1.0f);
//   if (_617 < 0.0031308000907301903f) {
//     _631 = (_617 * 12.920000076293945f);
//   } else {
//     _631 = (((pow(_617, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_618 < 0.0031308000907301903f) {
//     _642 = (_618 * 12.920000076293945f);
//   } else {
//     _642 = (((pow(_618, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_619 < 0.0031308000907301903f) {
//     _653 = (_619 * 12.920000076293945f);
//   } else {
//     _653 = (((pow(_619, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   _654 = _620 * _620;
//   _661 = 1.0f / ((_426 * 0.004000000189989805f) + 1.0f);
//   _662 = 1.0f / ((_427 * 0.004000000189989805f) + 1.0f);
//   _663 = 1.0f / ((_428 * 0.004000000189989805f) + 1.0f);
//   _688 = saturate(pow(_631, 2.200000047683716f));
//   _689 = saturate(pow(_642, 2.200000047683716f));
//   _690 = saturate(pow(_653, 2.200000047683716f));
//   _704 = exp2(log2(saturate(((dot(float3(0.6274039149284363f, 0.3292829990386963f, 0.043313100934028625f), float3(_688, _689, _690)) * 250.0f) + ((_620 * _426) * (lerp(_661, 1.0f, _654)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   _715 = saturate(exp2(log2(max(0.0f, (((_704 * 18.8515625f) + 0.8359375f) * (1.0f / ((_704 * 18.6875f) + 1.0f))))) * 78.84375f));
//   _720 = exp2(log2(saturate(((dot(float3(0.06909730285406113f, 0.9195405840873718f, 0.011362300254404545f), float3(_688, _689, _690)) * 250.0f) + ((_620 * _427) * (lerp(_662, 1.0f, _654)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   _731 = saturate(exp2(log2(max(0.0f, (((_720 * 18.8515625f) + 0.8359375f) * (1.0f / ((_720 * 18.6875f) + 1.0f))))) * 78.84375f));
//   _736 = exp2(log2(saturate(((dot(float3(0.01639140024781227f, 0.08801329880952835f, 0.8955953121185303f), float3(_688, _689, _690)) * 250.0f) + ((_620 * _428) * (lerp(_663, 1.0f, _654)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   _747 = saturate(exp2(log2(max(0.0f, (((_736 * 18.8515625f) + 0.8359375f) * (1.0f / ((_736 * 18.6875f) + 1.0f))))) * 78.84375f));
//   _749 = ((((float4)(View_SpatiotemporalBlueNoiseVolumeTexture.Load(int4((int(SV_Position.x) & 127), (int(SV_Position.y) & 127), (View_StateFrameIndex & 63), 0)))).x) * 2.0f) + -1.0f;
//   _766 = ((1.0f - sqrt(1.0f - abs(_749))) * float((int)(((int)(uint)((int)(_749 > 0.0f))) - ((int)(uint)((int)(_749 < 0.0f)))))) * 0.0009775171056389809f;
//   _769 = saturate(select(((abs((_715 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_766 + _715), _715));
//   _777 = saturate(select(((abs((_731 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_766 + _731), _731));
//   _785 = saturate(select(((abs((_747 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_766 + _747), _747));
//   _793 = saturate(select(((abs((_444 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_766 + _444), _444));
//   _801 = saturate(select(((abs((_460 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_766 + _460), _460));
//   _809 = saturate(select(((abs((_476 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_766 + _476), _476));
//   SV_Target.x = _769;
//   SV_Target.y = _777;
//   SV_Target.z = _785;
//   SV_Target.w = 0.0f;
...
//   SV_Target_1.z = _809;
//   SV_Target_1.w = 0.0f;
//   SV_Target_2.x = max(0.0f, (_769 - (_793 * _620)));
//   SV_Target_2.y = max(0.0f, (_777 - (_801 * _620)));
//   SV_Target_2.z = max(0.0f, (_785 - (_809 * _620)));
//   SV_Target_2.w = max(0.0f, (1.0f - _620));
