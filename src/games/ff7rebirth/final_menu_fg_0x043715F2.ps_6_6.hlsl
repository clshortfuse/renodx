...
//   float _123 = (min(((ViewportDestination_ViewportSize.x * 0.5625f) * ViewportDestination_ViewportSizeInverse.y), 1.0f) * (_43 + -0.5f)) + 0.5f;
//   float _124 = (min(((ViewportDestination_ViewportSize.y * 1.7777777910232544f) * ViewportDestination_ViewportSizeInverse.x), 1.0f) * (_44 + -0.5f)) + 0.5f;
...
//   float _253 = exp2(log2(saturate(_233.y)) * 0.012683313339948654f);
//   float _262 = exp2(log2(max(0.0f, ((_253 + -0.8359375f) * (1.0f / (18.8515625f - (_253 * 18.6875f)))))) * 6.277394771575928f);
//   float _266 = exp2(log2(saturate(_233.z)) * 0.012683313339948654f);
//   float _275 = exp2(log2(max(0.0f, ((_266 + -0.8359375f) * (1.0f / (18.8515625f - (_266 * 18.6875f)))))) * 6.277394771575928f);
//   float _279 = exp2(log2(saturate(_249)) * 0.1593017578125f);
//   float _290 = saturate(exp2(log2(max(0.0f, (((_279 * 18.8515625f) + 0.8359375f) * (1.0f / ((_279 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _294 = exp2(log2(saturate(_262)) * 0.1593017578125f);
//   float _305 = saturate(exp2(log2(max(0.0f, (((_294 * 18.8515625f) + 0.8359375f) * (1.0f / ((_294 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _309 = exp2(log2(saturate(_275)) * 0.1593017578125f);
//   float _320 = saturate(exp2(log2(max(0.0f, (((_309 * 18.8515625f) + 0.8359375f) * (1.0f / ((_309 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float4 _322 = CompositeSDRBackgroundTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(_123, _124), 0.0f);
//   float4 _328 = CompositeSDRTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(_123, _124), 0.0f);
//   float4 _341 = CompositeSDRForegroundTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(_123, _124), 0.0f);
//   float _349 = (_341.w * ((_328.w * _322.x) + _328.x)) + _341.x;
//   float _350 = (_341.w * ((_328.w * _322.y) + _328.y)) + _341.y;
//   float _351 = (_341.w * ((_328.w * _322.z) + _328.z)) + _341.z;
//   float _352 = (_328.w * _322.w) * _341.w;
//   float _363;
//   float _374;
//   float _385;
//   if (_349 < 0.0031308000907301903f) {
//     _363 = (_349 * 12.920000076293945f);
//   } else {
//     _363 = (((pow(_349, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_350 < 0.0031308000907301903f) {
//     _374 = (_350 * 12.920000076293945f);
//   } else {
//     _374 = (((pow(_350, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_351 < 0.0031308000907301903f) {
//     _385 = (_351 * 12.920000076293945f);
//   } else {
//     _385 = (((pow(_351, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   float _386 = _352 * _352;
//   float _393 = 1.0f / ((_249 * 40.0f) + 1.0f);
//   float _394 = 1.0f / ((_262 * 40.0f) + 1.0f);
//   float _395 = 1.0f / ((_275 * 40.0f) + 1.0f);
//   float _405 = _352 * 10000.0f;
//   float _418 = (pow(_363, 2.200000047683716f));
//   float _419 = (pow(_374, 2.200000047683716f));
//   float _420 = (pow(_385, 2.200000047683716f));
//   float _434 = exp2(log2(saturate(((dot(float3(0.6274039149284363f, 0.3292829990386963f, 0.043313100934028625f), float3(_418, _419, _420)) * 250.0f) + ((_405 * _249) * (lerp(_393, 1.0f, _386)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _445 = saturate(exp2(log2(max(0.0f, (((_434 * 18.8515625f) + 0.8359375f) * (1.0f / ((_434 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _450 = exp2(log2(saturate(((dot(float3(0.06909730285406113f, 0.9195405840873718f, 0.011362300254404545f), float3(_418, _419, _420)) * 250.0f) + ((_405 * _262) * (lerp(_394, 1.0f, _386)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _461 = saturate(exp2(log2(max(0.0f, (((_450 * 18.8515625f) + 0.8359375f) * (1.0f / ((_450 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _466 = exp2(log2(saturate(((dot(float3(0.01639140024781227f, 0.08801329880952835f, 0.8955953121185303f), float3(_418, _419, _420)) * 250.0f) + ((_405 * _275) * (lerp(_395, 1.0f, _386)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _477 = saturate(exp2(log2(max(0.0f, (((_466 * 18.8515625f) + 0.8359375f) * (1.0f / ((_466 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _479 = (_29.x * 2.0f) + -1.0f;
//   float _496 = (float((int)(((int)(uint)((bool)(_479 > 0.0f))) - ((int)(uint)((bool)(_479 < 0.0f))))) * 0.0009775171056389809f) * (1.0f - sqrt(1.0f - abs(_479)));
//   float _499 = saturate(select(((abs((_445 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_496 + _445), _445));
//   float _507 = saturate(select(((abs((_461 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_496 + _461), _461));
//   float _515 = saturate(select(((abs((_477 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_496 + _477), _477));
//   float _523 = saturate(select(((abs((_290 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_496 + _290), _290));
//   float _531 = saturate(select(((abs((_305 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_496 + _305), _305));
//   float _539 = saturate(select(((abs((_320 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_496 + _320), _320));
//   SV_Target.x = _499;
//   SV_Target.y = _507;
//   SV_Target.z = _515;
//   SV_Target.w = 0.0f;
...
//   SV_Target_1.z = _539;
//   SV_Target_1.w = 0.0f;
//   SV_Target_2.x = max(0.0f, (_499 - (_523 * _352)));
//   SV_Target_2.y = max(0.0f, (_507 - (_531 * _352)));
//   SV_Target_2.z = max(0.0f, (_515 - (_539 * _352)));
//   SV_Target_2.w = max(0.0f, (1.0f - _352));
