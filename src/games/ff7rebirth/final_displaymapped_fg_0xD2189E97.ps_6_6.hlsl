...
//     _426 = _355;
//   }
//   float _431 = exp2(log2(saturate(_424 * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _442 = saturate(exp2(log2(max(0.0f, (((_431 * 18.8515625f) + 0.8359375f) * (1.0f / ((_431 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _447 = exp2(log2(saturate(_425 * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _458 = saturate(exp2(log2(max(0.0f, (((_447 * 18.8515625f) + 0.8359375f) * (1.0f / ((_447 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _463 = exp2(log2(saturate(_426 * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _474 = saturate(exp2(log2(max(0.0f, (((_463 * 18.8515625f) + 0.8359375f) * (1.0f / ((_463 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float4 _476 = CompositeSDRTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(((min(((ViewportDestination_ViewportSize.x * 0.5625f) * ViewportDestination_ViewportSizeInverse.y), 1.0f) * (_42 + -0.5f)) + 0.5f), ((min(((ViewportDestination_ViewportSize.y * 1.7777777910232544f) * ViewportDestination_ViewportSizeInverse.x), 1.0f) * (_43 + -0.5f)) + 0.5f)), 0.0f);
//   if (_476.x < 0.0031308000907301903f) {
//     _491 = (_476.x * 12.920000076293945f);
//   } else {
//     _491 = (((pow(_476.x, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_476.y < 0.0031308000907301903f) {
//     _502 = (_476.y * 12.920000076293945f);
//   } else {
//     _502 = (((pow(_476.y, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_476.z < 0.0031308000907301903f) {
//     _513 = (_476.z * 12.920000076293945f);
//   } else {
//     _513 = (((pow(_476.z, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   float _514 = _476.w * _476.w;
//   float _521 = 1.0f / ((_424 * 0.004000000189989805f) + 1.0f);
//   float _522 = 1.0f / ((_425 * 0.004000000189989805f) + 1.0f);
//   float _523 = 1.0f / ((_426 * 0.004000000189989805f) + 1.0f);
//   float _545 = (pow(_491, 2.200000047683716f));
//   float _546 = (pow(_502, 2.200000047683716f));
//   float _547 = (pow(_513, 2.200000047683716f));
//   float _561 = exp2(log2(saturate(((dot(float3(0.6274039149284363f, 0.3292829990386963f, 0.043313100934028625f), float3(_545, _546, _547)) * 250.0f) + ((_476.w * _424) * (lerp(_521, 1.0f, _514)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _572 = saturate(exp2(log2(max(0.0f, (((_561 * 18.8515625f) + 0.8359375f) * (1.0f / ((_561 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _577 = exp2(log2(saturate(((dot(float3(0.06909730285406113f, 0.9195405840873718f, 0.011362300254404545f), float3(_545, _546, _547)) * 250.0f) + ((_476.w * _425) * (lerp(_522, 1.0f, _514)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _588 = saturate(exp2(log2(max(0.0f, (((_577 * 18.8515625f) + 0.8359375f) * (1.0f / ((_577 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _593 = exp2(log2(saturate(((dot(float3(0.01639140024781227f, 0.08801329880952835f, 0.8955953121185303f), float3(_545, _546, _547)) * 250.0f) + ((_476.w * _426) * (lerp(_523, 1.0f, _514)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _604 = saturate(exp2(log2(max(0.0f, (((_593 * 18.8515625f) + 0.8359375f) * (1.0f / ((_593 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _606 = (_28.x * 2.0f) + -1.0f;
//   float _623 = (float((int)(((int)(uint)((bool)(_606 > 0.0f))) - ((int)(uint)((bool)(_606 < 0.0f))))) * 0.0009775171056389809f) * (1.0f - sqrt(1.0f - abs(_606)));
//   float _626 = saturate(select(((abs((_572 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_623 + _572), _572));
//   float _634 = saturate(select(((abs((_588 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_623 + _588), _588));
//   float _642 = saturate(select(((abs((_604 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_623 + _604), _604));
//   float _650 = saturate(select(((abs((_442 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_623 + _442), _442));
//   float _658 = saturate(select(((abs((_458 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_623 + _458), _458));
//   float _666 = saturate(select(((abs((_474 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_623 + _474), _474));
//   SV_Target.x = _626;
//   SV_Target.y = _634;
//   SV_Target.z = _642;
//   SV_Target.w = 0.0f;
...
//   SV_Target_1.z = _666;
//   SV_Target_1.w = 0.0f;
//   SV_Target_2.x = max(0.0f, (_626 - (_650 * _476.w)));
//   SV_Target_2.y = max(0.0f, (_634 - (_658 * _476.w)));
//   SV_Target_2.z = max(0.0f, (_642 - (_666 * _476.w)));
//   SV_Target_2.w = max(0.0f, (1.0f - _476.w));
