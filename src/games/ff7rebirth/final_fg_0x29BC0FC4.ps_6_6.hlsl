...
//   float4 _27 = View_SpatiotemporalBlueNoiseVolumeTexture.Load(int4((int(SV_Position.x) & 127), (int(SV_Position.y) & 127), (View_StateFrameIndex & 63), 0));
...
//   float _180 = exp2(log2(saturate(((((min(_151.x, 65504.0f) - _147) + (GlareContext.y * _147)) * GlareContext.x) + _147) * 0.009999999776482582f)) * 0.1593017578125f);
//   float _196 = exp2(log2(saturate(((((min(_151.y, 65504.0f) - _148) + (GlareContext.y * _148)) * GlareContext.x) + _148) * 0.009999999776482582f)) * 0.1593017578125f);
//   float _212 = exp2(log2(saturate(((((min(_151.z, 65504.0f) - _149) + (GlareContext.y * _149)) * GlareContext.x) + _149) * 0.009999999776482582f)) * 0.1593017578125f);
...
//   float _251 = exp2(log2(saturate(_231.y)) * 0.012683313339948654f);
//   float _260 = exp2(log2(max(0.0f, ((_251 + -0.8359375f) * (1.0f / (18.8515625f - (_251 * 18.6875f)))))) * 6.277394771575928f);
//   float _264 = exp2(log2(saturate(_231.z)) * 0.012683313339948654f);
//   float _273 = exp2(log2(max(0.0f, ((_264 + -0.8359375f) * (1.0f / (18.8515625f - (_264 * 18.6875f)))))) * 6.277394771575928f);
//   float _277 = exp2(log2(saturate(_247)) * 0.1593017578125f);
//   float _288 = saturate(exp2(log2(max(0.0f, (((_277 * 18.8515625f) + 0.8359375f) * (1.0f / ((_277 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _292 = exp2(log2(saturate(_260)) * 0.1593017578125f);
//   float _303 = saturate(exp2(log2(max(0.0f, (((_292 * 18.8515625f) + 0.8359375f) * (1.0f / ((_292 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _307 = exp2(log2(saturate(_273)) * 0.1593017578125f);
//   float _318 = saturate(exp2(log2(max(0.0f, (((_307 * 18.8515625f) + 0.8359375f) * (1.0f / ((_307 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float4 _320 = CompositeSDRTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(((min(((ViewportDestination_ViewportSize.x * 0.5625f) * ViewportDestination_ViewportSizeInverse.y), 1.0f) * (_41 + -0.5f)) + 0.5f), ((min(((ViewportDestination_ViewportSize.y * 1.7777777910232544f) * ViewportDestination_ViewportSizeInverse.x), 1.0f) * (_42 + -0.5f)) + 0.5f)), 0.0f);
//   float _335;
//   float _346;
//   float _357;
//   if (_320.x < 0.0031308000907301903f) {
//     _335 = (_320.x * 12.920000076293945f);
//   } else {
//     _335 = (((pow(_320.x, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_320.y < 0.0031308000907301903f) {
//     _346 = (_320.y * 12.920000076293945f);
//   } else {
//     _346 = (((pow(_320.y, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_320.z < 0.0031308000907301903f) {
//     _357 = (_320.z * 12.920000076293945f);
//   } else {
//     _357 = (((pow(_320.z, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   float _358 = _320.w * _320.w;
//   float _365 = 1.0f / ((_247 * 40.0f) + 1.0f); // bt2020
//   float _366 = 1.0f / ((_260 * 40.0f) + 1.0f);
//   float _367 = 1.0f / ((_273 * 40.0f) + 1.0f);
//   float _377 = _320.w * 10000.0f;
//   float _390 = (pow(_335, 2.200000047683716f));
//   float _391 = (pow(_346, 2.200000047683716f));
//   float _392 = (pow(_357, 2.200000047683716f));
//   float _406 = exp2(log2(saturate(((dot(float3(0.6274039149284363f, 0.3292829990386963f, 0.043313100934028625f), float3(_390, _391, _392)) * 250.0f) + ((_377 * _247) * (lerp(_365, 1.0f, _358)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _417 = saturate(exp2(log2(max(0.0f, (((_406 * 18.8515625f) + 0.8359375f) * (1.0f / ((_406 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _422 = exp2(log2(saturate(((dot(float3(0.06909730285406113f, 0.9195405840873718f, 0.011362300254404545f), float3(_390, _391, _392)) * 250.0f) + ((_377 * _260) * (lerp(_366, 1.0f, _358)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _433 = saturate(exp2(log2(max(0.0f, (((_422 * 18.8515625f) + 0.8359375f) * (1.0f / ((_422 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _438 = exp2(log2(saturate(((dot(float3(0.01639140024781227f, 0.08801329880952835f, 0.8955953121185303f), float3(_390, _391, _392)) * 250.0f) + ((_377 * _273) * (lerp(_367, 1.0f, _358)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _449 = saturate(exp2(log2(max(0.0f, (((_438 * 18.8515625f) + 0.8359375f) * (1.0f / ((_438 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _451 = (_27.x * 2.0f) + -1.0f;
//   float _468 = (float((int)(((int)(uint)((bool)(_451 > 0.0f))) - ((int)(uint)((bool)(_451 < 0.0f))))) * 0.0009775171056389809f) * (1.0f - sqrt(1.0f - abs(_451)));
//   float _471 = saturate(select(((abs((_417 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_468 + _417), _417));
//   float _479 = saturate(select(((abs((_433 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_468 + _433), _433));
//   float _487 = saturate(select(((abs((_449 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_468 + _449), _449));
//   float _495 = saturate(select(((abs((_288 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_468 + _288), _288));
//   float _503 = saturate(select(((abs((_303 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_468 + _303), _303));
//   float _511 = saturate(select(((abs((_318 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_468 + _318), _318));
//   SV_Target.x = _471;
//   SV_Target.y = _479;
//   SV_Target.z = _487;
//   SV_Target.w = 0.0f;
...
//   SV_Target_1.z = _511;
//   SV_Target_1.w = 0.0f;
//   SV_Target_2.x = max(0.0f, (_471 - (_495 * _320.w)));
//   SV_Target_2.y = max(0.0f, (_479 - (_503 * _320.w)));
//   SV_Target_2.z = max(0.0f, (_487 - (_511 * _320.w)));
//   SV_Target_2.w = max(0.0f, (1.0f - _320.w));
