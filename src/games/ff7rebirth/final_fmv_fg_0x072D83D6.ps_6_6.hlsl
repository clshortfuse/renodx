...
//         } else {
//           _307 = (((pow(_292.x, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//         }
//         do {
//           if (_292.y < 0.0031308000907301903f) {
//             _318 = (_292.y * 12.920000076293945f);
//           } else {
//             _318 = (((pow(_292.y, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//           }
//           do {
//             if (_292.z < 0.0031308000907301903f) {
//               _329 = (_292.z * 12.920000076293945f);
//             } else {
//               _329 = (((pow(_292.z, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//             }
//             float _336 = (pow(_307, 2.200000047683716f));
//             float _337 = (pow(_318, 2.200000047683716f));
//             float _338 = (pow(_329, 2.200000047683716f));
...
//     }
//   } else {
//     _346 = (exp2(log2(max(0.0f, ((_239 + -0.8359375f) * (1.0f / (18.8515625f - (_239 * 18.6875f)))))) * 6.277394771575928f) * 10000.0f);
//     _347 = (exp2(log2(max(0.0f, ((_253 + -0.8359375f) * (1.0f / (18.8515625f - (_253 * 18.6875f)))))) * 6.277394771575928f) * 10000.0f);
//     _348 = (exp2(log2(max(0.0f, ((_267 + -0.8359375f) * (1.0f / (18.8515625f - (_267 * 18.6875f)))))) * 6.277394771575928f) * 10000.0f);
//   }
//   float _353 = exp2(log2(saturate(_346 * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _364 = saturate(exp2(log2(max(0.0f, (((_353 * 18.8515625f) + 0.8359375f) * (1.0f / ((_353 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _369 = exp2(log2(saturate(_347 * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _380 = saturate(exp2(log2(max(0.0f, (((_369 * 18.8515625f) + 0.8359375f) * (1.0f / ((_369 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _385 = exp2(log2(saturate(_348 * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _396 = saturate(exp2(log2(max(0.0f, (((_385 * 18.8515625f) + 0.8359375f) * (1.0f / ((_385 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float4 _399 = CompositeSDRTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(((_118 * (_42 + -0.5f)) + 0.5f), ((_119 * (_43 + -0.5f)) + 0.5f)), 0.0f);
//   if (_399.x < 0.0031308000907301903f) {
//     _414 = (_399.x * 12.920000076293945f);
//   } else {
//     _414 = (((pow(_399.x, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_399.y < 0.0031308000907301903f) {
//     _425 = (_399.y * 12.920000076293945f);
//   } else {
//     _425 = (((pow(_399.y, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_399.z < 0.0031308000907301903f) {
//     _436 = (_399.z * 12.920000076293945f);
//   } else {
//     _436 = (((pow(_399.z, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   float _437 = _399.w * _399.w;
//   float _444 = 1.0f / ((_346 * 0.004000000189989805f) + 1.0f); // In bt2020
//   float _445 = 1.0f / ((_347 * 0.004000000189989805f) + 1.0f);
//   float _446 = 1.0f / ((_348 * 0.004000000189989805f) + 1.0f);
//   float _468 = (pow(_414, 2.200000047683716f));
//   float _469 = (pow(_425, 2.200000047683716f));
//   float _470 = (pow(_436, 2.200000047683716f));
//   float _484 = exp2(log2(saturate(((dot(float3(0.6274039149284363f, 0.3292829990386963f, 0.043313100934028625f), float3(_468, _469, _470)) * 250.0f) + ((_399.w * _346) * (lerp(_444, 1.0f, _437)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _495 = saturate(exp2(log2(max(0.0f, (((_484 * 18.8515625f) + 0.8359375f) * (1.0f / ((_484 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _500 = exp2(log2(saturate(((dot(float3(0.06909730285406113f, 0.9195405840873718f, 0.011362300254404545f), float3(_468, _469, _470)) * 250.0f) + ((_399.w * _347) * (lerp(_445, 1.0f, _437)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _511 = saturate(exp2(log2(max(0.0f, (((_500 * 18.8515625f) + 0.8359375f) * (1.0f / ((_500 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _516 = exp2(log2(saturate(((dot(float3(0.01639140024781227f, 0.08801329880952835f, 0.8955953121185303f), float3(_468, _469, _470)) * 250.0f) + ((_399.w * _348) * (lerp(_446, 1.0f, _437)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _527 = saturate(exp2(log2(max(0.0f, (((_516 * 18.8515625f) + 0.8359375f) * (1.0f / ((_516 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _529 = (_28.x * 2.0f) + -1.0f;
//   float _546 = (float((int)(((int)(uint)((bool)(_529 > 0.0f))) - ((int)(uint)((bool)(_529 < 0.0f))))) * 0.0009775171056389809f) * (1.0f - sqrt(1.0f - abs(_529)));
//   float _549 = saturate(select(((abs((_495 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_546 + _495), _495));
//   float _557 = saturate(select(((abs((_511 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_546 + _511), _511));
//   float _565 = saturate(select(((abs((_527 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_546 + _527), _527));
//   float _573 = saturate(select(((abs((_364 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_546 + _364), _364));
//   float _581 = saturate(select(((abs((_380 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_546 + _380), _380));
//   float _589 = saturate(select(((abs((_396 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_546 + _396), _396));
//   SV_Target.x = _549;
//   SV_Target.y = _557;
//   SV_Target.z = _565;
//   SV_Target.w = 0.0f;
...
//   SV_Target_1.z = _589;
//   SV_Target_1.w = 0.0f;
//   SV_Target_2.x = max(0.0f, (_549 - (_573 * _399.w)));
//   SV_Target_2.y = max(0.0f, (_557 - (_581 * _399.w)));
//   SV_Target_2.z = max(0.0f, (_565 - (_589 * _399.w)));
//   SV_Target_2.w = max(0.0f, (1.0f - _399.w));
