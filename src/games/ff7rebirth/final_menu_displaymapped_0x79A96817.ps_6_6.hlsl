...
//   } else {
//     _471 = (((pow(_457, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_458 < 0.0031308000907301903f) {
//     _482 = (_458 * 12.920000076293945f);
//   } else {
//     _482 = (((pow(_458, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_459 < 0.0031308000907301903f) {
//     _493 = (_459 * 12.920000076293945f);
//   } else {
//     _493 = (((pow(_459, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
...
//   float _525 = (pow(_471, 2.200000047683716f));
//   float _526 = (pow(_482, 2.200000047683716f));
//   float _527 = (pow(_493, 2.200000047683716f));
//   float _541 = exp2(log2(saturate(((dot(float3(0.6274039149284363f, 0.3292829990386963f, 0.043313100934028625f), float3(_525, _526, _527)) * 250.0f) + ((_460 * _426) * (lerp(_501, 1.0f, _494)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _552 = saturate(exp2(log2(max(0.0f, (((_541 * 18.8515625f) + 0.8359375f) * (1.0f / ((_541 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _557 = exp2(log2(saturate(((dot(float3(0.06909730285406113f, 0.9195405840873718f, 0.011362300254404545f), float3(_525, _526, _527)) * 250.0f) + ((_460 * _427) * (lerp(_502, 1.0f, _494)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _568 = saturate(exp2(log2(max(0.0f, (((_557 * 18.8515625f) + 0.8359375f) * (1.0f / ((_557 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _573 = exp2(log2(saturate(((dot(float3(0.01639140024781227f, 0.08801329880952835f, 0.8955953121185303f), float3(_525, _526, _527)) * 250.0f) + ((_460 * _428) * (lerp(_503, 1.0f, _494)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _584 = saturate(exp2(log2(max(0.0f, (((_573 * 18.8515625f) + 0.8359375f) * (1.0f / ((_573 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _586 = (_30.x * 2.0f) + -1.0f;
//   float _603 = (float((int)(((int)(uint)((bool)(_586 > 0.0f))) - ((int)(uint)((bool)(_586 < 0.0f))))) * 0.0009775171056389809f) * (1.0f - sqrt(1.0f - abs(_586)));
//   SV_Target.x = saturate(select(((abs((_552 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_603 + _552), _552));
//   SV_Target.y = saturate(select(((abs((_568 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_603 + _568), _568));
//   SV_Target.z = saturate(select(((abs((_584 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_603 + _584), _584));
//   SV_Target.w = 0.0f;
//   return SV_Target;
// }
