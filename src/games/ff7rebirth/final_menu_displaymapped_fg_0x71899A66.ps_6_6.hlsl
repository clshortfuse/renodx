...
//   float _124 = (min(((ViewportDestination_ViewportSize.x * 0.5625f) * ViewportDestination_ViewportSizeInverse.y), 1.0f) * (_44 + -0.5f)) + 0.5f;
//   float _125 = (min(((ViewportDestination_ViewportSize.y * 1.7777777910232544f) * ViewportDestination_ViewportSizeInverse.x), 1.0f) * (_45 + -0.5f)) + 0.5f;
...
//   float4 _478 = CompositeSDRBackgroundTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(_124, _125), 0.0f);
//   float4 _484 = CompositeSDRTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(_124, _125), 0.0f);
//   float4 _497 = CompositeSDRForegroundTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(_124, _125), 0.0f);
//   float _505 = (_497.w * ((_484.w * _478.x) + _484.x)) + _497.x;
//   float _506 = (_497.w * ((_484.w * _478.y) + _484.y)) + _497.y;
//   float _507 = (_497.w * ((_484.w * _478.z) + _484.z)) + _497.z;
//   float _508 = (_484.w * _478.w) * _497.w;
//   if (_505 < 0.0031308000907301903f) {
//     _519 = (_505 * 12.920000076293945f);
//   } else {
//     _519 = (((pow(_505, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_506 < 0.0031308000907301903f) {
//     _530 = (_506 * 12.920000076293945f);
//   } else {
//     _530 = (((pow(_506, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_507 < 0.0031308000907301903f) {
//     _541 = (_507 * 12.920000076293945f);
//   } else {
//     _541 = (((pow(_507, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   float _542 = _508 * _508;
//   float _549 = 1.0f / ((_426 * 0.004000000189989805f) + 1.0f);
//   float _550 = 1.0f / ((_427 * 0.004000000189989805f) + 1.0f);
//   float _551 = 1.0f / ((_428 * 0.004000000189989805f) + 1.0f);
//   float _573 = (pow(_519, 2.200000047683716f));
//   float _574 = (pow(_530, 2.200000047683716f));
//   float _575 = (pow(_541, 2.200000047683716f));
//   float _589 = exp2(log2(saturate(((dot(float3(0.6274039149284363f, 0.3292829990386963f, 0.043313100934028625f), float3(_573, _574, _575)) * 250.0f) + ((_508 * _426) * (lerp(_549, 1.0f, _542)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _600 = saturate(exp2(log2(max(0.0f, (((_589 * 18.8515625f) + 0.8359375f) * (1.0f / ((_589 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _605 = exp2(log2(saturate(((dot(float3(0.06909730285406113f, 0.9195405840873718f, 0.011362300254404545f), float3(_573, _574, _575)) * 250.0f) + ((_508 * _427) * (lerp(_550, 1.0f, _542)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _616 = saturate(exp2(log2(max(0.0f, (((_605 * 18.8515625f) + 0.8359375f) * (1.0f / ((_605 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _621 = exp2(log2(saturate(((dot(float3(0.01639140024781227f, 0.08801329880952835f, 0.8955953121185303f), float3(_573, _574, _575)) * 250.0f) + ((_508 * _428) * (lerp(_551, 1.0f, _542)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _632 = saturate(exp2(log2(max(0.0f, (((_621 * 18.8515625f) + 0.8359375f) * (1.0f / ((_621 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _634 = (_30.x * 2.0f) + -1.0f;
//   float _651 = (float((int)(((int)(uint)((bool)(_634 > 0.0f))) - ((int)(uint)((bool)(_634 < 0.0f))))) * 0.0009775171056389809f) * (1.0f - sqrt(1.0f - abs(_634)));
//   float _654 = saturate(select(((abs((_600 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_651 + _600), _600));
//   float _662 = saturate(select(((abs((_616 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_651 + _616), _616));
//   float _670 = saturate(select(((abs((_632 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_651 + _632), _632));
//   float _678 = saturate(select(((abs((_444 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_651 + _444), _444));
//   float _686 = saturate(select(((abs((_460 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_651 + _460), _460));
//   float _694 = saturate(select(((abs((_476 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_651 + _476), _476));
//   SV_Target.x = _654;
//   SV_Target.y = _662;
//   SV_Target.z = _670;
//   SV_Target.w = 0.0f;
...
//   SV_Target_1.z = _694;
//   SV_Target_1.w = 0.0f;
//   SV_Target_2.x = max(0.0f, (_654 - (_678 * _508)));
//   SV_Target_2.y = max(0.0f, (_662 - (_686 * _508)));
//   SV_Target_2.z = max(0.0f, (_670 - (_694 * _508)));
//   SV_Target_2.w = max(0.0f, (1.0f - _508));
