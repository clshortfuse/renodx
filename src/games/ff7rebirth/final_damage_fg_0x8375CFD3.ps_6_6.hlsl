...
//   float _282 = exp2(log2(saturate(_249)) * 0.1593017578125f);
//   float _293 = saturate(exp2(log2(max(0.0f, (((_282 * 18.8515625f) + 0.8359375f) * (1.0f / ((_282 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _297 = exp2(log2(saturate(_263)) * 0.1593017578125f);
//   float _308 = saturate(exp2(log2(max(0.0f, (((_297 * 18.8515625f) + 0.8359375f) * (1.0f / ((_297 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _312 = exp2(log2(saturate(_277)) * 0.1593017578125f);
//   float _323 = saturate(exp2(log2(max(0.0f, (((_312 * 18.8515625f) + 0.8359375f) * (1.0f / ((_312 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _333 = max(9.999999747378752e-05f, HDRCompositionContextColor.x);
//   float _334 = max(9.999999747378752e-05f, HDRCompositionContextColor.y);
//   float _335 = max(9.999999747378752e-05f, HDRCompositionContextColor.z);
//   float _339 = (1.0f / dot(float3(_333, _334, _335), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f))) * (dot(float3(_250, _264, _278), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f)) * 9.999999747378752e-05f);
//   float _344 = exp2(log2(saturate(_339 * _333)) * 0.1593017578125f);
//   float _360 = exp2(log2(saturate(_339 * _334)) * 0.1593017578125f);
//   float _376 = exp2(log2(saturate(_339 * _335)) * 0.1593017578125f);
//   float4 _395 = BT2020PQTosRGBLUT.SampleLevel(View_SharedBilinearClampedSampler, float3(((saturate(exp2(log2(max(0.0f, (((_344 * 18.8515625f) + 0.8359375f) * (1.0f / ((_344 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f), ((saturate(exp2(log2(max(0.0f, (((_360 * 18.8515625f) + 0.8359375f) * (1.0f / ((_360 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f), ((saturate(exp2(log2(max(0.0f, (((_376 * 18.8515625f) + 0.8359375f) * (1.0f / ((_376 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f)), 0.0f);
//   float _409;
//   float _420;
//   float _431;
//   float _472;
//   float _483;
//   float _494;
//   if (_395.x < 0.040449999272823334f) {
//     _409 = (_395.x * 0.07739938050508499f);
//   } else {
//     _409 = exp2(log2((_395.x + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f);
//   }
//   if (_395.y < 0.040449999272823334f) {
//     _420 = (_395.y * 0.07739938050508499f);
//   } else {
//     _420 = exp2(log2((_395.y + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f);
//   }
//   if (_395.z < 0.040449999272823334f) {
//     _431 = (_395.z * 0.07739938050508499f);
//   } else {
//     _431 = exp2(log2((_395.z + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f);
//   }
//   float _434 = (1.0f / max(0.0010000000474974513f, HDRCompositionContext.z)) * TEXCOORD_1.w;
//   float _439 = (_434 * _434) * (1.0f / max(9.999999747378752e-06f, dot(float3(TEXCOORD_1.x, TEXCOORD_1.y, _434), float3(TEXCOORD_1.x, TEXCOORD_1.y, _434))));
//   float _443 = (saturate(_439 * _439) + -1.0f) * HDRCompositionContext.y;
//   float4 _447 = CompositeSDRTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(((min(((ViewportDestination_ViewportSize.x * 0.5625f) * ViewportDestination_ViewportSizeInverse.y), 1.0f) * (_43 + -0.5f)) + 0.5f), ((min(((ViewportDestination_ViewportSize.y * 1.7777777910232544f) * ViewportDestination_ViewportSizeInverse.x), 1.0f) * (_44 + -0.5f)) + 0.5f)), 0.0f);
//   float _454 = -0.0f - ((HDRCompositionContext.x * _443) * _447.w);
//   float _458 = (_409 * _454) + _447.x;
//   float _459 = (_420 * _454) + _447.y;
//   float _460 = (_431 * _454) + _447.z;
//   float _461 = _447.w * ((_443 * HDRCompositionContext.x) + 1.0f);
//   if (_458 < 0.0031308000907301903f) {
//     _472 = (_458 * 12.920000076293945f);
//   } else {
//     _472 = (((pow(_458, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_459 < 0.0031308000907301903f) {
//     _483 = (_459 * 12.920000076293945f);
//   } else {
//     _483 = (((pow(_459, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_460 < 0.0031308000907301903f) {
//     _494 = (_460 * 12.920000076293945f);
//   } else {
//     _494 = (((pow(_460, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   float _495 = _461 * _461;
//   float _502 = 1.0f / ((_249 * 40.0f) + 1.0f);
//   float _503 = 1.0f / ((_263 * 40.0f) + 1.0f);
//   float _504 = 1.0f / ((_277 * 40.0f) + 1.0f);
//   float _526 = (pow(_472, 2.200000047683716f));
//   float _527 = (pow(_483, 2.200000047683716f));
//   float _528 = (pow(_494, 2.200000047683716f));
//   float _542 = exp2(log2(saturate(((dot(float3(0.6274039149284363f, 0.3292829990386963f, 0.043313100934028625f), float3(_526, _527, _528)) * 250.0f) + ((_461 * _250) * (lerp(_502, 1.0f, _495)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _553 = saturate(exp2(log2(max(0.0f, (((_542 * 18.8515625f) + 0.8359375f) * (1.0f / ((_542 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _558 = exp2(log2(saturate(((dot(float3(0.06909730285406113f, 0.9195405840873718f, 0.011362300254404545f), float3(_526, _527, _528)) * 250.0f) + ((_461 * _264) * (lerp(_503, 1.0f, _495)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _569 = saturate(exp2(log2(max(0.0f, (((_558 * 18.8515625f) + 0.8359375f) * (1.0f / ((_558 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _574 = exp2(log2(saturate(((dot(float3(0.01639140024781227f, 0.08801329880952835f, 0.8955953121185303f), float3(_526, _527, _528)) * 250.0f) + ((_461 * _278) * (lerp(_504, 1.0f, _495)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _585 = saturate(exp2(log2(max(0.0f, (((_574 * 18.8515625f) + 0.8359375f) * (1.0f / ((_574 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _587 = (_29.x * 2.0f) + -1.0f;
//   float _604 = (float((int)(((int)(uint)((bool)(_587 > 0.0f))) - ((int)(uint)((bool)(_587 < 0.0f))))) * 0.0009775171056389809f) * (1.0f - sqrt(1.0f - abs(_587)));
//   float _607 = saturate(select(((abs((_553 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_604 + _553), _553));
//   float _615 = saturate(select(((abs((_569 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_604 + _569), _569));
//   float _623 = saturate(select(((abs((_585 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_604 + _585), _585));
//   float _631 = saturate(select(((abs((_293 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_604 + _293), _293));
//   float _639 = saturate(select(((abs((_308 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_604 + _308), _308));
//   float _647 = saturate(select(((abs((_323 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_604 + _323), _323));
//   SV_Target.x = _607;
//   SV_Target.y = _615;
//   SV_Target.z = _623;
//   SV_Target.w = 0.0f;
...
//   SV_Target_1.z = _647;
//   SV_Target_1.w = 0.0f;
//   SV_Target_2.x = max(0.0f, (_607 - (_631 * _461)));
//   SV_Target_2.y = max(0.0f, (_615 - (_639 * _461)));
//   SV_Target_2.z = max(0.0f, (_623 - (_647 * _461)));
//   SV_Target_2.w = max(0.0f, (1.0f - _461));
