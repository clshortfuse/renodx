...
//   float4 _277 = CompositeSDRBackgroundTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(_123, _124), 0.0f);
//   float4 _283 = CompositeSDRTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(_123, _124), 0.0f);
//   float4 _296 = CompositeSDRForegroundTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(_123, _124), 0.0f);
//   float _304 = (_296.w * ((_283.w * _277.x) + _283.x)) + _296.x;
//   float _305 = (_296.w * ((_283.w * _277.y) + _283.y)) + _296.y;
//   float _306 = (_296.w * ((_283.w * _277.z) + _283.z)) + _296.z;
//   float _307 = (_283.w * _277.w) * _296.w;
//   float _318;
//   float _329;
//   float _340;
//   if (_304 < 0.0031308000907301903f) {
//     _318 = (_304 * 12.920000076293945f);
//   } else {
//     _318 = (((pow(_304, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_305 < 0.0031308000907301903f) {
//     _329 = (_305 * 12.920000076293945f);
//   } else {
//     _329 = (((pow(_305, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_306 < 0.0031308000907301903f) {
//     _340 = (_306 * 12.920000076293945f);
//   } else {
//     _340 = (((pow(_306, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   float _341 = _307 * _307;
//   float _348 = 1.0f / ((_249 * 40.0f) + 1.0f);
//   float _349 = 1.0f / ((_262 * 40.0f) + 1.0f);
//   float _350 = 1.0f / ((_275 * 40.0f) + 1.0f);
//   float _360 = _307 * 10000.0f;
//   float _373 = (pow(_318, 2.200000047683716f));
//   float _374 = (pow(_329, 2.200000047683716f));
//   float _375 = (pow(_340, 2.200000047683716f));
//   float _389 = exp2(log2(saturate(((dot(float3(0.6274039149284363f, 0.3292829990386963f, 0.043313100934028625f), float3(_373, _374, _375)) * 250.0f) + ((_360 * _249) * (lerp(_348, 1.0f, _341)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _400 = saturate(exp2(log2(max(0.0f, (((_389 * 18.8515625f) + 0.8359375f) * (1.0f / ((_389 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _405 = exp2(log2(saturate(((dot(float3(0.06909730285406113f, 0.9195405840873718f, 0.011362300254404545f), float3(_373, _374, _375)) * 250.0f) + ((_360 * _262) * (lerp(_349, 1.0f, _341)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _416 = saturate(exp2(log2(max(0.0f, (((_405 * 18.8515625f) + 0.8359375f) * (1.0f / ((_405 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _421 = exp2(log2(saturate(((dot(float3(0.01639140024781227f, 0.08801329880952835f, 0.8955953121185303f), float3(_373, _374, _375)) * 250.0f) + ((_360 * _275) * (lerp(_350, 1.0f, _341)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _432 = saturate(exp2(log2(max(0.0f, (((_421 * 18.8515625f) + 0.8359375f) * (1.0f / ((_421 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _434 = (_29.x * 2.0f) + -1.0f;
//   float _451 = (float((int)(((int)(uint)((bool)(_434 > 0.0f))) - ((int)(uint)((bool)(_434 < 0.0f))))) * 0.0009775171056389809f) * (1.0f - sqrt(1.0f - abs(_434)));
//   SV_Target.x = saturate(select(((abs((_400 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_451 + _400), _400));
//   SV_Target.y = saturate(select(((abs((_416 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_451 + _416), _416));
//   SV_Target.z = saturate(select(((abs((_432 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_451 + _432), _432));
//   SV_Target.w = 0.0f;
//   return SV_Target;
// }
