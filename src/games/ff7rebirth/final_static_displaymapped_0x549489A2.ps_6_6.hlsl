...
//     _557 = _486;
//   }
//   float4 _559 = CompositeSDRTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(((min(((ViewportDestination_ViewportSize.x * 0.5625f) * ViewportDestination_ViewportSizeInverse.y), 1.0f) * (_42 + -0.5f)) + 0.5f), ((min(((ViewportDestination_ViewportSize.y * 1.7777777910232544f) * ViewportDestination_ViewportSizeInverse.x), 1.0f) * (_43 + -0.5f)) + 0.5f)), 0.0f);
//   if (_559.x < 0.0031308000907301903f) {
//     _574 = (_559.x * 12.920000076293945f);
//   } else {
//     _574 = (((pow(_559.x, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_559.y < 0.0031308000907301903f) {
//     _585 = (_559.y * 12.920000076293945f);
//   } else {
//     _585 = (((pow(_559.y, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_559.z < 0.0031308000907301903f) {
//     _596 = (_559.z * 12.920000076293945f);
//   } else {
//     _596 = (((pow(_559.z, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   float _597 = _559.w * _559.w;
//   float _604 = 1.0f / ((_555 * 0.004000000189989805f) + 1.0f);
//   float _605 = 1.0f / ((_556 * 0.004000000189989805f) + 1.0f);
//   float _606 = 1.0f / ((_557 * 0.004000000189989805f) + 1.0f);
//   float _628 = (pow(_574, 2.200000047683716f));
//   float _629 = (pow(_585, 2.200000047683716f));
//   float _630 = (pow(_596, 2.200000047683716f));
//   float _644 = exp2(log2(saturate(((dot(float3(0.6274039149284363f, 0.3292829990386963f, 0.043313100934028625f), float3(_628, _629, _630)) * 250.0f) + ((_559.w * _555) * (lerp(_604, 1.0f, _597)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _655 = saturate(exp2(log2(max(0.0f, (((_644 * 18.8515625f) + 0.8359375f) * (1.0f / ((_644 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _660 = exp2(log2(saturate(((dot(float3(0.06909730285406113f, 0.9195405840873718f, 0.011362300254404545f), float3(_628, _629, _630)) * 250.0f) + ((_559.w * _556) * (lerp(_605, 1.0f, _597)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _671 = saturate(exp2(log2(max(0.0f, (((_660 * 18.8515625f) + 0.8359375f) * (1.0f / ((_660 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _676 = exp2(log2(saturate(((dot(float3(0.01639140024781227f, 0.08801329880952835f, 0.8955953121185303f), float3(_628, _629, _630)) * 250.0f) + ((_559.w * _557) * (lerp(_606, 1.0f, _597)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _687 = saturate(exp2(log2(max(0.0f, (((_676 * 18.8515625f) + 0.8359375f) * (1.0f / ((_676 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _689 = (_28.x * 2.0f) + -1.0f;
//   float _706 = (float((int)(((int)(uint)((bool)(_689 > 0.0f))) - ((int)(uint)((bool)(_689 < 0.0f))))) * 0.0009775171056389809f) * (1.0f - sqrt(1.0f - abs(_689)));
//   SV_Target.x = saturate(select(((abs((_655 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_706 + _655), _655));
//   SV_Target.y = saturate(select(((abs((_671 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_706 + _671), _671));
//   SV_Target.z = saturate(select(((abs((_687 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_706 + _687), _687));
//   SV_Target.w = 0.0f;
//   return SV_Target;
// }
