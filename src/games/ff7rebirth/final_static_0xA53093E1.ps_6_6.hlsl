...
float4 main(
  ...
  float _500 = exp2(((log2((saturate(((((dot(float3(0.6274039149284363f, 0.3292829990386963f, 0.043313100934028625f), float3(_484, _485, _486)))*RENODX_GRAPHICS_WHITE_NITS) + (((_384 * 10000.0f) * (_415.w)) * (((1.0f - _460) * _453) + _460))) * 9.999999747378752e-05f))))) * 0.1593017578125f));
  float _511 = saturate((exp2(((log2((max(0.0f, (((_500 * 18.8515625f) + 0.8359375f) * (1.0f / ((_500 * 18.6875f) + 1.0f))))))) * 78.84375f))));
  float _516 = exp2(((log2((saturate(((((dot(float3(0.06909730285406113f, 0.9195405840873718f, 0.011362300254404545f), float3(_484, _485, _486)))*RENODX_GRAPHICS_WHITE_NITS) + (((_398 * 10000.0f) * (_415.w)) * (((1.0f - _461) * _453) + _461))) * 9.999999747378752e-05f))))) * 0.1593017578125f));
  float _527 = saturate((exp2(((log2((max(0.0f, (((_516 * 18.8515625f) + 0.8359375f) * (1.0f / ((_516 * 18.6875f) + 1.0f))))))) * 78.84375f))));
  float _532 = exp2(((log2((saturate(((((dot(float3(0.01639140024781227f, 0.08801329880952835f, 0.8955953121185303f), float3(_484, _485, _486)))*RENODX_GRAPHICS_WHITE_NITS) + (((_412 * 10000.0f) * (_415.w)) * (((1.0f - _462) * _453) + _462))) * 9.999999747378752e-05f))))) * 0.1593017578125f));
