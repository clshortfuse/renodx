...
//   } else {
//     _702 = (((pow(_687.x, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_687.y < 0.0031308000907301903f) {
//     _713 = (_687.y * 12.920000076293945f);
//   } else {
//     _713 = (((pow(_687.y, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_687.z < 0.0031308000907301903f) {
//     _724 = (_687.z * 12.920000076293945f);
//   } else {
//     _724 = (((pow(_687.z, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
...
//   float _756 = (pow(_702, 2.200000047683716f));
//   float _757 = (pow(_713, 2.200000047683716f));
//   float _758 = (pow(_724, 2.200000047683716f));
//   float _772 = exp2(log2(saturate(((dot(float3(0.6274039149284363f, 0.3292829990386963f, 0.043313100934028625f), float3(_756, _757, _758)) * 250.0f) + ((_687.w * _683) * (lerp(_732, 1.0f, _725)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _783 = saturate(exp2(log2(max(0.0f, (((_772 * 18.8515625f) + 0.8359375f) * (1.0f / ((_772 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _788 = exp2(log2(saturate(((dot(float3(0.06909730285406113f, 0.9195405840873718f, 0.011362300254404545f), float3(_756, _757, _758)) * 250.0f) + ((_687.w * _684) * (lerp(_733, 1.0f, _725)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _799 = saturate(exp2(log2(max(0.0f, (((_788 * 18.8515625f) + 0.8359375f) * (1.0f / ((_788 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _804 = exp2(log2(saturate(((dot(float3(0.01639140024781227f, 0.08801329880952835f, 0.8955953121185303f), float3(_756, _757, _758)) * 250.0f) + ((_687.w * _685) * (lerp(_734, 1.0f, _725)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _815 = saturate(exp2(log2(max(0.0f, (((_804 * 18.8515625f) + 0.8359375f) * (1.0f / ((_804 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _817 = (_29.x * 2.0f) + -1.0f;
//   float _834 = (float((int)(((int)(uint)((bool)(_817 > 0.0f))) - ((int)(uint)((bool)(_817 < 0.0f))))) * 0.0009775171056389809f) * (1.0f - sqrt(1.0f - abs(_817)));
//   SV_Target.x = saturate(select(((abs((_783 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_834 + _783), _783));
//   SV_Target.y = saturate(select(((abs((_799 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_834 + _799), _799));
//   SV_Target.z = saturate(select(((abs((_815 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_834 + _815), _815));
//   SV_Target.w = 0.0f;
//   return SV_Target;
// }
