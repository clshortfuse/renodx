...
//   float _311 = exp2(log2(saturate(max(0.0f, ((((((min(_151.x, 65504.0f) - _147) + (GlareContext.y * _147)) * GlareContext.x) + _147) + _283) + ((_288 - _283) * NoiseContext.y))) * 0.009999999776482582f)) * 0.1593017578125f);
...
//   float _408 = exp2(log2(saturate(_378)) * 0.1593017578125f);
//   float _419 = saturate(exp2(log2(max(0.0f, (((_408 * 18.8515625f) + 0.8359375f) * (1.0f / ((_408 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _423 = exp2(log2(saturate(_391)) * 0.1593017578125f);
//   float _434 = saturate(exp2(log2(max(0.0f, (((_423 * 18.8515625f) + 0.8359375f) * (1.0f / ((_423 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _438 = exp2(log2(saturate(_404)) * 0.1593017578125f);
//   float _449 = saturate(exp2(log2(max(0.0f, (((_438 * 18.8515625f) + 0.8359375f) * (1.0f / ((_438 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float4 _451 = CompositeSDRTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(((min(((ViewportDestination_ViewportSize.x * 0.5625f) * ViewportDestination_ViewportSizeInverse.y), 1.0f) * (_41 + -0.5f)) + 0.5f), ((min(((ViewportDestination_ViewportSize.y * 1.7777777910232544f) * ViewportDestination_ViewportSizeInverse.x), 1.0f) * (_42 + -0.5f)) + 0.5f)), 0.0f);
//   float _466;
//   float _477;
//   float _488;
//   if (_451.x < 0.0031308000907301903f) {
//     _466 = (_451.x * 12.920000076293945f);
//   } else {
//     _466 = (((pow(_451.x, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_451.y < 0.0031308000907301903f) {
//     _477 = (_451.y * 12.920000076293945f);
//   } else {
//     _477 = (((pow(_451.y, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_451.z < 0.0031308000907301903f) {
//     _488 = (_451.z * 12.920000076293945f);
//   } else {
//     _488 = (((pow(_451.z, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   float _489 = _451.w * _451.w;
//   float _496 = 1.0f / ((_378 * 40.0f) + 1.0f);
//   float _497 = 1.0f / ((_391 * 40.0f) + 1.0f);
//   float _498 = 1.0f / ((_404 * 40.0f) + 1.0f);
//   float _508 = _451.w * 10000.0f;
//   float _521 = (pow(_466, 2.200000047683716f));
//   float _522 = (pow(_477, 2.200000047683716f));
//   float _523 = (pow(_488, 2.200000047683716f));
//   float _537 = exp2(log2(saturate(((dot(float3(0.6274039149284363f, 0.3292829990386963f, 0.043313100934028625f), float3(_521, _522, _523)) * 250.0f) + ((_508 * _378) * (lerp(_496, 1.0f, _489)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _548 = saturate(exp2(log2(max(0.0f, (((_537 * 18.8515625f) + 0.8359375f) * (1.0f / ((_537 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _553 = exp2(log2(saturate(((dot(float3(0.06909730285406113f, 0.9195405840873718f, 0.011362300254404545f), float3(_521, _522, _523)) * 250.0f) + ((_508 * _391) * (lerp(_497, 1.0f, _489)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _564 = saturate(exp2(log2(max(0.0f, (((_553 * 18.8515625f) + 0.8359375f) * (1.0f / ((_553 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _569 = exp2(log2(saturate(((dot(float3(0.01639140024781227f, 0.08801329880952835f, 0.8955953121185303f), float3(_521, _522, _523)) * 250.0f) + ((_508 * _404) * (lerp(_498, 1.0f, _489)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _580 = saturate(exp2(log2(max(0.0f, (((_569 * 18.8515625f) + 0.8359375f) * (1.0f / ((_569 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _582 = (_27.x * 2.0f) + -1.0f;
//   float _599 = (float((int)(((int)(uint)((bool)(_582 > 0.0f))) - ((int)(uint)((bool)(_582 < 0.0f))))) * 0.0009775171056389809f) * (1.0f - sqrt(1.0f - abs(_582)));
//   float _602 = saturate(select(((abs((_548 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_599 + _548), _548));
//   float _610 = saturate(select(((abs((_564 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_599 + _564), _564));
//   float _618 = saturate(select(((abs((_580 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_599 + _580), _580));
//   float _626 = saturate(select(((abs((_419 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_599 + _419), _419));
//   float _634 = saturate(select(((abs((_434 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_599 + _434), _434));
//   float _642 = saturate(select(((abs((_449 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_599 + _449), _449));
//   SV_Target.x = _602;
//   SV_Target.y = _610;
//   SV_Target.z = _618;
//   SV_Target.w = 0.0f;
...
//   SV_Target_1.z = _642;
//   SV_Target_1.w = 0.0f;
//   SV_Target_2.x = max(0.0f, (_602 - (_626 * _451.w)));
//   SV_Target_2.y = max(0.0f, (_610 - (_634 * _451.w)));
//   SV_Target_2.z = max(0.0f, (_618 - (_642 * _451.w)));
//   SV_Target_2.w = max(0.0f, (1.0f - _451.w));
