...
//   float _119 = min(((ViewportDestination_ViewportSize.x * 0.5625f) * ViewportDestination_ViewportSizeInverse.y), 1.0f);
//   float _120 = min(((ViewportDestination_ViewportSize.y * 1.7777777910232544f) * ViewportDestination_ViewportSizeInverse.x), 1.0f);
//   float4 _133 = ColorTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(min(max((((ViewportColor_ViewportSize.x * _57) + float((uint)(int)(ViewportColor_ViewportMin.x))) * ViewportColor_ExtentInverse.x), ViewportColor_UVViewportBilinearMin.x), ViewportColor_UVViewportBilinearMax.x), min(max((((ViewportColor_ViewportSize.y * _58) + float((uint)(int)(ViewportColor_ViewportMin.y))) * ViewportColor_ExtentInverse.y), ViewportColor_UVViewportBilinearMin.y), ViewportColor_UVViewportBilinearMax.y)), 0.0f);
//   float _145 = (1.0f / max(0.0010000000474974513f, VignetteContext.y)) * TEXCOORD_1.z;
...
//   float _154 = (((_150 * _150) + -1.0f) * VignetteContext.x) + 1.0f;
//   float _155 = _154 * min(_133.x, 64512.0f);
//   float _156 = _154 * min(_133.y, 64512.0f);
//   float _157 = _154 * min(_133.z, 64512.0f);
//   float4 _159 = GlareTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(min(max((((ViewportGlare_ViewportSize.x * _57) + float((uint)(int)(ViewportGlare_ViewportMin.x))) * ViewportGlare_ExtentInverse.x), ViewportGlare_UVViewportBilinearMin.x), ViewportGlare_UVViewportBilinearMax.x), min(max((((ViewportGlare_ViewportSize.y * _58) + float((uint)(int)(ViewportGlare_ViewportMin.y))) * ViewportGlare_ExtentInverse.y), ViewportGlare_UVViewportBilinearMin.y), ViewportGlare_UVViewportBilinearMax.y)), 0.0f);
//   float _185 = saturate(DeviceCorrectorContext.x);
//   float _187 = saturate(DeviceCorrectorContext.y);
//   float _192 = exp2(log2(saturate(((((min(_159.x, 65504.0f) - _155) + (GlareContext.y * _155)) * GlareContext.x) + _155) * 0.009999999776482582f)) * 0.1593017578125f);
//   float _208 = exp2(log2(saturate(((((min(_159.y, 65504.0f) - _156) + (GlareContext.y * _156)) * GlareContext.x) + _156) * 0.009999999776482582f)) * 0.1593017578125f);
//   float _224 = exp2(log2(saturate(((((min(_159.z, 65504.0f) - _157) + (GlareContext.y * _157)) * GlareContext.x) + _157) * 0.009999999776482582f)) * 0.1593017578125f);
...
//     _431 = (lerp(_392, _360, _187));
//     _432 = (lerp(_406, _361, _187));
//     _433 = (lerp(_420, _362, _187));
//   } else {
//     _431 = _360;
//     _432 = _361;
//     _433 = _362;
...
//           _683 = (lerp(_595, _564, _187));
//           _684 = (lerp(_609, _565, _187));
//           _685 = (lerp(_623, _566, _187));
//         } else {
//           _683 = _564;
//           _684 = _565;
//           _685 = _566;
...
//         } else {
//           _644 = (((pow(_441.x, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//         }
//         do {
//           if (_441.y < 0.0031308000907301903f) {
//             _655 = (_441.y * 12.920000076293945f);
//           } else {
//             _655 = (((pow(_441.y, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//           }
//           do {
//             if (_441.z < 0.0031308000907301903f) {
//               _666 = (_441.z * 12.920000076293945f);
//             } else {
//               _666 = (((pow(_441.z, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//             }
//             float _673 = (pow(_644, 2.200000047683716f));
//             float _674 = (pow(_655, 2.200000047683716f));
//             float _675 = (pow(_666, 2.200000047683716f));
...
//     _685 = _433;
//   }
//   float _690 = exp2(log2(saturate(_683 * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _701 = saturate(exp2(log2(max(0.0f, (((_690 * 18.8515625f) + 0.8359375f) * (1.0f / ((_690 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _706 = exp2(log2(saturate(_684 * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _717 = saturate(exp2(log2(max(0.0f, (((_706 * 18.8515625f) + 0.8359375f) * (1.0f / ((_706 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _722 = exp2(log2(saturate(_685 * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _733 = saturate(exp2(log2(max(0.0f, (((_722 * 18.8515625f) + 0.8359375f) * (1.0f / ((_722 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float4 _735 = CompositeSDRTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(((_119 * (_43 + -0.5f)) + 0.5f), ((_120 * (_44 + -0.5f)) + 0.5f)), 0.0f);
//   if (_735.x < 0.0031308000907301903f) {
//     _750 = (_735.x * 12.920000076293945f);
//   } else {
//     _750 = (((pow(_735.x, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_735.y < 0.0031308000907301903f) {
//     _761 = (_735.y * 12.920000076293945f);
//   } else {
//     _761 = (((pow(_735.y, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_735.z < 0.0031308000907301903f) {
//     _772 = (_735.z * 12.920000076293945f);
//   } else {
//     _772 = (((pow(_735.z, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   float _773 = _735.w * _735.w;
//   float _780 = 1.0f / ((_683 * 0.004000000189989805f) + 1.0f);
//   float _781 = 1.0f / ((_684 * 0.004000000189989805f) + 1.0f);
//   float _782 = 1.0f / ((_685 * 0.004000000189989805f) + 1.0f);
//   float _804 = (pow(_750, 2.200000047683716f));
//   float _805 = (pow(_761, 2.200000047683716f));
//   float _806 = (pow(_772, 2.200000047683716f));
//   float _820 = exp2(log2(saturate(((dot(float3(0.6274039149284363f, 0.3292829990386963f, 0.043313100934028625f), float3(_804, _805, _806)) * 250.0f) + ((_735.w * _683) * (lerp(_780, 1.0f, _773)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _831 = saturate(exp2(log2(max(0.0f, (((_820 * 18.8515625f) + 0.8359375f) * (1.0f / ((_820 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _836 = exp2(log2(saturate(((dot(float3(0.06909730285406113f, 0.9195405840873718f, 0.011362300254404545f), float3(_804, _805, _806)) * 250.0f) + ((_735.w * _684) * (lerp(_781, 1.0f, _773)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _847 = saturate(exp2(log2(max(0.0f, (((_836 * 18.8515625f) + 0.8359375f) * (1.0f / ((_836 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _852 = exp2(log2(saturate(((dot(float3(0.01639140024781227f, 0.08801329880952835f, 0.8955953121185303f), float3(_804, _805, _806)) * 250.0f) + ((_735.w * _685) * (lerp(_782, 1.0f, _773)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _863 = saturate(exp2(log2(max(0.0f, (((_852 * 18.8515625f) + 0.8359375f) * (1.0f / ((_852 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _865 = (_29.x * 2.0f) + -1.0f;
//   float _882 = (float((int)(((int)(uint)((bool)(_865 > 0.0f))) - ((int)(uint)((bool)(_865 < 0.0f))))) * 0.0009775171056389809f) * (1.0f - sqrt(1.0f - abs(_865)));
//   float _885 = saturate(select(((abs((_831 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_882 + _831), _831));
//   float _893 = saturate(select(((abs((_847 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_882 + _847), _847));
//   float _901 = saturate(select(((abs((_863 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_882 + _863), _863));
//   float _909 = saturate(select(((abs((_701 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_882 + _701), _701));
//   float _917 = saturate(select(((abs((_717 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_882 + _717), _717));
//   float _925 = saturate(select(((abs((_733 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_882 + _733), _733));
//   SV_Target.x = _885;
//   SV_Target.y = _893;
//   SV_Target.z = _901;
//   SV_Target.w = 0.0f;
...
//   SV_Target_1.z = _925;
//   SV_Target_1.w = 0.0f;
//   SV_Target_2.x = max(0.0f, (_885 - (_909 * _735.w)));
//   SV_Target_2.y = max(0.0f, (_893 - (_917 * _735.w)));
//   SV_Target_2.z = max(0.0f, (_901 - (_925 * _735.w)));
//   SV_Target_2.w = max(0.0f, (1.0f - _735.w));
