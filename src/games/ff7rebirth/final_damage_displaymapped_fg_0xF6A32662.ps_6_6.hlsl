...
//     _428 = _357;
//   }
//   float _433 = exp2(log2(saturate(_426 * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _444 = saturate(exp2(log2(max(0.0f, (((_433 * 18.8515625f) + 0.8359375f) * (1.0f / ((_433 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _449 = exp2(log2(saturate(_427 * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _460 = saturate(exp2(log2(max(0.0f, (((_449 * 18.8515625f) + 0.8359375f) * (1.0f / ((_449 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _465 = exp2(log2(saturate(_428 * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _476 = saturate(exp2(log2(max(0.0f, (((_465 * 18.8515625f) + 0.8359375f) * (1.0f / ((_465 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _486 = max(9.999999747378752e-05f, HDRCompositionContextColor.x);
//   float _487 = max(9.999999747378752e-05f, HDRCompositionContextColor.y);
//   float _488 = max(9.999999747378752e-05f, HDRCompositionContextColor.z);
//   float _492 = (1.0f / dot(float3(_486, _487, _488), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f))) * (dot(float3(_426, _427, _428), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f)) * 9.999999747378752e-05f);
//   float _497 = exp2(log2(saturate(_492 * _486)) * 0.1593017578125f);
//   float _513 = exp2(log2(saturate(_492 * _487)) * 0.1593017578125f);
//   float _529 = exp2(log2(saturate(_492 * _488)) * 0.1593017578125f);
//   float4 _548 = BT2020PQTosRGBLUT.SampleLevel(View_SharedBilinearClampedSampler, float3(((saturate(exp2(log2(max(0.0f, (((_497 * 18.8515625f) + 0.8359375f) * (1.0f / ((_497 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f), ((saturate(exp2(log2(max(0.0f, (((_513 * 18.8515625f) + 0.8359375f) * (1.0f / ((_513 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f), ((saturate(exp2(log2(max(0.0f, (((_529 * 18.8515625f) + 0.8359375f) * (1.0f / ((_529 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f)), 0.0f);
//   if (_548.x < 0.040449999272823334f) {
//     _562 = (_548.x * 0.07739938050508499f);
//   } else {
//     _562 = exp2(log2((_548.x + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f);
//   }
//   if (_548.y < 0.040449999272823334f) {
//     _573 = (_548.y * 0.07739938050508499f);
//   } else {
//     _573 = exp2(log2((_548.y + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f);
//   }
//   if (_548.z < 0.040449999272823334f) {
//     _584 = (_548.z * 0.07739938050508499f);
//   } else {
//     _584 = exp2(log2((_548.z + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f);
//   }
//   float _587 = (1.0f / max(0.0010000000474974513f, HDRCompositionContext.z)) * TEXCOORD_1.w;
//   float _592 = (_587 * _587) * (1.0f / max(9.999999747378752e-06f, dot(float3(TEXCOORD_1.x, TEXCOORD_1.y, _587), float3(TEXCOORD_1.x, TEXCOORD_1.y, _587))));
//   float _596 = (saturate(_592 * _592) + -1.0f) * HDRCompositionContext.y;
//   float4 _600 = CompositeSDRTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(((min(((ViewportDestination_ViewportSize.x * 0.5625f) * ViewportDestination_ViewportSizeInverse.y), 1.0f) * (_44 + -0.5f)) + 0.5f), ((min(((ViewportDestination_ViewportSize.y * 1.7777777910232544f) * ViewportDestination_ViewportSizeInverse.x), 1.0f) * (_45 + -0.5f)) + 0.5f)), 0.0f);
//   float _607 = -0.0f - ((HDRCompositionContext.x * _596) * _600.w);
//   float _611 = (_562 * _607) + _600.x;
//   float _612 = (_573 * _607) + _600.y;
//   float _613 = (_584 * _607) + _600.z;
//   float _614 = _600.w * ((_596 * HDRCompositionContext.x) + 1.0f);
//   if (_611 < 0.0031308000907301903f) {
//     _625 = (_611 * 12.920000076293945f);
//   } else {
//     _625 = (((pow(_611, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_612 < 0.0031308000907301903f) {
//     _636 = (_612 * 12.920000076293945f);
//   } else {
//     _636 = (((pow(_612, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_613 < 0.0031308000907301903f) {
//     _647 = (_613 * 12.920000076293945f);
//   } else {
//     _647 = (((pow(_613, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   float _648 = _614 * _614;
//   float _655 = 1.0f / ((_426 * 0.004000000189989805f) + 1.0f);
//   float _656 = 1.0f / ((_427 * 0.004000000189989805f) + 1.0f);
//   float _657 = 1.0f / ((_428 * 0.004000000189989805f) + 1.0f);
//   float _679 = (pow(_625, 2.200000047683716f));
//   float _680 = (pow(_636, 2.200000047683716f));
//   float _681 = (pow(_647, 2.200000047683716f));
//   float _695 = exp2(log2(saturate(((dot(float3(0.6274039149284363f, 0.3292829990386963f, 0.043313100934028625f), float3(_679, _680, _681)) * 250.0f) + ((_614 * _426) * (lerp(_655, 1.0f, _648)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _706 = saturate(exp2(log2(max(0.0f, (((_695 * 18.8515625f) + 0.8359375f) * (1.0f / ((_695 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _711 = exp2(log2(saturate(((dot(float3(0.06909730285406113f, 0.9195405840873718f, 0.011362300254404545f), float3(_679, _680, _681)) * 250.0f) + ((_614 * _427) * (lerp(_656, 1.0f, _648)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _722 = saturate(exp2(log2(max(0.0f, (((_711 * 18.8515625f) + 0.8359375f) * (1.0f / ((_711 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _727 = exp2(log2(saturate(((dot(float3(0.01639140024781227f, 0.08801329880952835f, 0.8955953121185303f), float3(_679, _680, _681)) * 250.0f) + ((_614 * _428) * (lerp(_657, 1.0f, _648)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _738 = saturate(exp2(log2(max(0.0f, (((_727 * 18.8515625f) + 0.8359375f) * (1.0f / ((_727 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _740 = (_30.x * 2.0f) + -1.0f;
//   float _757 = (float((int)(((int)(uint)((bool)(_740 > 0.0f))) - ((int)(uint)((bool)(_740 < 0.0f))))) * 0.0009775171056389809f) * (1.0f - sqrt(1.0f - abs(_740)));
//   float _760 = saturate(select(((abs((_706 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_757 + _706), _706));
//   float _768 = saturate(select(((abs((_722 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_757 + _722), _722));
//   float _776 = saturate(select(((abs((_738 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_757 + _738), _738));
//   float _784 = saturate(select(((abs((_444 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_757 + _444), _444));
//   float _792 = saturate(select(((abs((_460 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_757 + _460), _460));
//   float _800 = saturate(select(((abs((_476 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_757 + _476), _476));
//   SV_Target.x = _760;
//   SV_Target.y = _768;
//   SV_Target.z = _776;
//   SV_Target.w = 0.0f;
...
//   SV_Target_1.z = _800;
//   SV_Target_1.w = 0.0f;
//   SV_Target_2.x = max(0.0f, (_760 - (_784 * _614)));
//   SV_Target_2.y = max(0.0f, (_768 - (_792 * _614)));
//   SV_Target_2.z = max(0.0f, (_776 - (_800 * _614)));
//   SV_Target_2.w = max(0.0f, (1.0f - _614));
