...
//   } else {
//     _366 = (((pow(_351.x, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_351.y < 0.0031308000907301903f) {
//     _377 = (_351.y * 12.920000076293945f);
//   } else {
//     _377 = (((pow(_351.y, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_351.z < 0.0031308000907301903f) {
//     _388 = (_351.z * 12.920000076293945f);
//   } else {
//     _388 = (((pow(_351.z, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
...
//   float _420 = (pow(_366, 2.200000047683716f));
//   float _421 = (pow(_377, 2.200000047683716f));
//   float _422 = (pow(_388, 2.200000047683716f));
//   float _436 = exp2(log2(saturate(((dot(float3(0.6274039149284363f, 0.3292829990386963f, 0.043313100934028625f), float3(_420, _421, _422)) * 250.0f) + ((_351.w * _346) * (lerp(_396, 1.0f, _389)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _447 = saturate(exp2(log2(max(0.0f, (((_436 * 18.8515625f) + 0.8359375f) * (1.0f / ((_436 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _452 = exp2(log2(saturate(((dot(float3(0.06909730285406113f, 0.9195405840873718f, 0.011362300254404545f), float3(_420, _421, _422)) * 250.0f) + ((_351.w * _347) * (lerp(_397, 1.0f, _389)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _463 = saturate(exp2(log2(max(0.0f, (((_452 * 18.8515625f) + 0.8359375f) * (1.0f / ((_452 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _468 = exp2(log2(saturate(((dot(float3(0.01639140024781227f, 0.08801329880952835f, 0.8955953121185303f), float3(_420, _421, _422)) * 250.0f) + ((_351.w * _348) * (lerp(_398, 1.0f, _389)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _479 = saturate(exp2(log2(max(0.0f, (((_468 * 18.8515625f) + 0.8359375f) * (1.0f / ((_468 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _481 = (_28.x * 2.0f) + -1.0f;
//   float _498 = (float((int)(((int)(uint)((bool)(_481 > 0.0f))) - ((int)(uint)((bool)(_481 < 0.0f))))) * 0.0009775171056389809f) * (1.0f - sqrt(1.0f - abs(_481)));
//   SV_Target.x = saturate(select(((abs((_447 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_498 + _447), _447));
//   SV_Target.y = saturate(select(((abs((_463 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_498 + _463), _463));
//   SV_Target.z = saturate(select(((abs((_479 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_498 + _479), _479));
//   SV_Target.w = 0.0f;
//   return SV_Target;
// }
