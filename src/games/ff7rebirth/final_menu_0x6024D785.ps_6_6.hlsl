...
// ) : SV_Target {
//   float4 SV_Target;
//   bool _22 = !(DeviceCorrectorContext.z == 0.0f);
//   float4 _31 = View_SpatiotemporalBlueNoiseVolumeTexture.Load(int4((int(SV_Position.x) & 127), (int(SV_Position.y) & 127), (View_StateFrameIndex & 63), 0));
//   float _38 = SV_Position.x - float((uint)(int)(ViewportDestination_ViewportMin.x));
//   float _39 = SV_Position.y - float((uint)(int)(ViewportDestination_ViewportMin.y));
//   float _45 = saturate(_38 * ViewportDestination_ViewportSizeInverse.x);
//   float _46 = saturate(_39 * ViewportDestination_ViewportSizeInverse.y);
//   float _59 = select(_22, saturate(((floor(_38 * 0.5f) * 2.0f) + 1.0f) * ViewportDestination_ViewportSizeInverse.x), _45);
//   float _60 = select(_22, saturate(((floor(_39 * 0.5f) * 2.0f) + 1.0f) * ViewportDestination_ViewportSizeInverse.y), _46);
//   float _125 = (min(((ViewportDestination_ViewportSize.x * 0.5625f) * ViewportDestination_ViewportSizeInverse.y), 1.0f) * (_45 + -0.5f)) + 0.5f;
//   float _126 = (min(((ViewportDestination_ViewportSize.y * 1.7777777910232544f) * ViewportDestination_ViewportSizeInverse.x), 1.0f) * (_46 + -0.5f)) + 0.5f;
//   float4 _129 = ColorTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(min(max((((ViewportColor_ViewportSize.x * _59) + float((uint)(int)(ViewportColor_ViewportMin.x))) * ViewportColor_ExtentInverse.x), ViewportColor_UVViewportBilinearMin.x), ViewportColor_UVViewportBilinearMax.x), min(max((((ViewportColor_ViewportSize.y * _60) + float((uint)(int)(ViewportColor_ViewportMin.y))) * ViewportColor_ExtentInverse.y), ViewportColor_UVViewportBilinearMin.y), ViewportColor_UVViewportBilinearMax.y)), 0.0f);
//   float _141 = (1.0f / max(0.0010000000474974513f, VignetteContext.y)) * TEXCOORD_1.z;
//   float _146 = (_141 * _141) * (1.0f / max(9.999999747378752e-06f, dot(float3(TEXCOORD_1.x, TEXCOORD_1.y, _141), float3(TEXCOORD_1.x, TEXCOORD_1.y, _141))));
//   float _150 = (((_146 * _146) + -1.0f) * VignetteContext.x) + 1.0f;
//   float _151 = _150 * min(_129.x, 64512.0f);
//   float _152 = _150 * min(_129.y, 64512.0f);
//   float _153 = _150 * min(_129.z, 64512.0f);
//   float4 _155 = GlareTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(min(max((((ViewportGlare_ViewportSize.x * _59) + float((uint)(int)(ViewportGlare_ViewportMin.x))) * ViewportGlare_ExtentInverse.x), ViewportGlare_UVViewportBilinearMin.x), ViewportGlare_UVViewportBilinearMax.x), min(max((((ViewportGlare_ViewportSize.y * _60) + float((uint)(int)(ViewportGlare_ViewportMin.y))) * ViewportGlare_ExtentInverse.y), ViewportGlare_UVViewportBilinearMin.y), ViewportGlare_UVViewportBilinearMax.y)), 0.0f);
//   float _184 = exp2(log2(saturate(((((min(_155.x, 65504.0f) - _151) + (GlareContext.y * _151)) * GlareContext.x) + _151) * 0.009999999776482582f)) * 0.1593017578125f);
//   float _200 = exp2(log2(saturate(((((min(_155.y, 65504.0f) - _152) + (GlareContext.y * _152)) * GlareContext.x) + _152) * 0.009999999776482582f)) * 0.1593017578125f);
//   float _216 = exp2(log2(saturate(((((min(_155.z, 65504.0f) - _153) + (GlareContext.y * _153)) * GlareContext.x) + _153) * 0.009999999776482582f)) * 0.1593017578125f);
//   float4 _235 = BT709PQToBT2020PQLUT.SampleLevel(View_SharedBilinearClampedSampler, float3(((saturate(exp2(log2(max(0.0f, (((_184 * 18.8515625f) + 0.8359375f) * (1.0f / ((_184 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f), ((saturate(exp2(log2(max(0.0f, (((_200 * 18.8515625f) + 0.8359375f) * (1.0f / ((_200 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f), ((saturate(exp2(log2(max(0.0f, (((_216 * 18.8515625f) + 0.8359375f) * (1.0f / ((_216 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f)), 0.0f);
//   float _242 = exp2(log2(saturate(_235.x)) * 0.012683313339948654f);
//   float _251 = exp2(log2(max(0.0f, ((_242 + -0.8359375f) * (1.0f / (18.8515625f - (_242 * 18.6875f)))))) * 6.277394771575928f);
//   float _252 = _251 * 10000.0f;
//   float _256 = exp2(log2(saturate(_235.y)) * 0.012683313339948654f);
//   float _265 = exp2(log2(max(0.0f, ((_256 + -0.8359375f) * (1.0f / (18.8515625f - (_256 * 18.6875f)))))) * 6.277394771575928f);
//   float _266 = _265 * 10000.0f;
//   float _270 = exp2(log2(saturate(_235.z)) * 0.012683313339948654f);
//   float _279 = exp2(log2(max(0.0f, ((_270 + -0.8359375f) * (1.0f / (18.8515625f - (_270 * 18.6875f)))))) * 6.277394771575928f);
//   float _280 = _279 * 10000.0f;
//   float _290 = max(9.999999747378752e-05f, HDRCompositionContextColor.x);
//   float _291 = max(9.999999747378752e-05f, HDRCompositionContextColor.y);
//   float _292 = max(9.999999747378752e-05f, HDRCompositionContextColor.z);
//   float _296 = (1.0f / dot(float3(_290, _291, _292), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f))) * (dot(float3(_252, _266, _280), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f)) * 9.999999747378752e-05f);
//   float _301 = exp2(log2(saturate(_296 * _290)) * 0.1593017578125f);
//   float _317 = exp2(log2(saturate(_296 * _291)) * 0.1593017578125f);
//   float _333 = exp2(log2(saturate(_296 * _292)) * 0.1593017578125f);
//   float4 _352 = BT2020PQTosRGBLUT.SampleLevel(View_SharedBilinearClampedSampler, float3(((saturate(exp2(log2(max(0.0f, (((_301 * 18.8515625f) + 0.8359375f) * (1.0f / ((_301 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f), ((saturate(exp2(log2(max(0.0f, (((_317 * 18.8515625f) + 0.8359375f) * (1.0f / ((_317 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f), ((saturate(exp2(log2(max(0.0f, (((_333 * 18.8515625f) + 0.8359375f) * (1.0f / ((_333 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f)), 0.0f);
//   float _366;
//   float _377;
//   float _388;
//   float _455;
//   float _466;
//   float _477;
//   if (_352.x < 0.040449999272823334f) {
//     _366 = (_352.x * 0.07739938050508499f);
//   } else {
//     _366 = exp2(log2((_352.x + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f);
//   }
//   if (_352.y < 0.040449999272823334f) {
//     _377 = (_352.y * 0.07739938050508499f);
//   } else {
//     _377 = exp2(log2((_352.y + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f);
//   }
//   if (_352.z < 0.040449999272823334f) {
//     _388 = (_352.z * 0.07739938050508499f);
//   } else {
//     _388 = exp2(log2((_352.z + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f);
//   }
//   float _391 = (1.0f / max(0.0010000000474974513f, HDRCompositionContext.z)) * TEXCOORD_1.w;
//   float _396 = (_391 * _391) * 
  
//   (1.0f / max(9.999999747378752e-06f, dot(float3(TEXCOORD_1.x, TEXCOORD_1.y, _391), float3(TEXCOORD_1.x, TEXCOORD_1.y, _391))));
//   float _400 = (saturate(_396 * _396) + -1.0f) * HDRCompositionContext.y;
//   float4 _404 = CompositeSDRBackgroundTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(_125, _126), 0.0f);
//   float _411 = -0.0f - ((HDRCompositionContext.x * _400) * _404.w);
//   float4 _420 = CompositeSDRTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(_125, _126), 0.0f);
//   float4 _433 = CompositeSDRForegroundTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(_125, _126), 0.0f);
//   float _441 = (_433.w * ((_420.w * ((_366 * _411) + _404.x)) + _420.x)) + _433.x;
//   float _442 = (_433.w * ((_420.w * ((_377 * _411) + _404.y)) + _420.y)) + _433.y;
//   float _443 = (_433.w * ((_420.w * ((_388 * _411) + _404.z)) + _420.z)) + _433.z;
//   float _444 = ((_404.w * ((_400 * HDRCompositionContext.x) + 1.0f)) * _420.w) * _433.w;
//   if (_441 < 0.0031308000907301903f) {
//     _455 = (_441 * 12.920000076293945f);
//   } else {
//     _455 = (((pow(_441, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_442 < 0.0031308000907301903f) {
//     _466 = (_442 * 12.920000076293945f);
//   } else {
//     _466 = (((pow(_442, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_443 < 0.0031308000907301903f) {
//     _477 = (_443 * 12.920000076293945f);
//   } else {
//     _477 = (((pow(_443, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   float _478 = _444 * _444;
//   float _485 = 1.0f / ((_251 * 40.0f) + 1.0f);
//   float _486 = 1.0f / ((_265 * 40.0f) + 1.0f);
//   float _487 = 1.0f / ((_279 * 40.0f) + 1.0f);
//   float _509 = (pow(_455, 2.200000047683716f));
//   float _510 = (pow(_466, 2.200000047683716f));
//   float _511 = (pow(_477, 2.200000047683716f));
//   float _525 = exp2(log2(saturate(((dot(float3(0.6274039149284363f, 0.3292829990386963f, 0.043313100934028625f), float3(_509, _510, _511)) * 250.0f) + ((_444 * _252) * (lerp(_485, 1.0f, _478)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _536 = saturate(exp2(log2(max(0.0f, (((_525 * 18.8515625f) + 0.8359375f) * (1.0f / ((_525 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _541 = exp2(log2(saturate(((dot(float3(0.06909730285406113f, 0.9195405840873718f, 0.011362300254404545f), float3(_509, _510, _511)) * 250.0f) + ((_444 * _266) * (lerp(_486, 1.0f, _478)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _552 = saturate(exp2(log2(max(0.0f, (((_541 * 18.8515625f) + 0.8359375f) * (1.0f / ((_541 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _557 = exp2(log2(saturate(((dot(float3(0.01639140024781227f, 0.08801329880952835f, 0.8955953121185303f), float3(_509, _510, _511)) * 250.0f) + ((_444 * _280) * (lerp(_487, 1.0f, _478)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _568 = saturate(exp2(log2(max(0.0f, (((_557 * 18.8515625f) + 0.8359375f) * (1.0f / ((_557 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _570 = (_31.x * 2.0f) + -1.0f;
//   float _587 = (float((int)(((int)(uint)((bool)(_570 > 0.0f))) - ((int)(uint)((bool)(_570 < 0.0f))))) * 0.0009775171056389809f) * (1.0f - sqrt(1.0f - abs(_570)));
//   SV_Target.x = saturate(select(((abs((_536 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_587 + _536), _536));
//   SV_Target.y = saturate(select(((abs((_552 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_587 + _552), _552));
//   SV_Target.z = saturate(select(((abs((_568 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_587 + _568), _568));
//   SV_Target.w = 0.0f;
//   return SV_Target;
// }
