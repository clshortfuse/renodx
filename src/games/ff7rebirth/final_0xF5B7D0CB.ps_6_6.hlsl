...
//   float4 _275 = CompositeSDRTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(((min(((ViewportDestination_ViewportSize.x * 0.5625f) * ViewportDestination_ViewportSizeInverse.y), 1.0f) * (_41 + -0.5f)) + 0.5f), ((min(((ViewportDestination_ViewportSize.y * 1.7777777910232544f) * ViewportDestination_ViewportSizeInverse.x), 1.0f) * (_42 + -0.5f)) + 0.5f)), 0.0f);
//   float _290;
//   float _301;
//   float _312;
//   if (_275.x < 0.0031308000907301903f) {
//     _290 = (_275.x * 12.920000076293945f);
//   } else {
//     _290 = (((pow(_275.x, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_275.y < 0.0031308000907301903f) {
//     _301 = (_275.y * 12.920000076293945f);
//   } else {
//     _301 = (((pow(_275.y, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_275.z < 0.0031308000907301903f) {
//     _312 = (_275.z * 12.920000076293945f);
//   } else {
//     _312 = (((pow(_275.z, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   float _313 = _275.w * _275.w;
//   float _320 = 1.0f / ((_247 * 40.0f) + 1.0f);
//   float _321 = 1.0f / ((_260 * 40.0f) + 1.0f);
//   float _322 = 1.0f / ((_273 * 40.0f) + 1.0f);
//   float _332 = _275.w * 10000.0f;
//   float _345 = (pow(_290, 2.200000047683716f));
//   float _346 = (pow(_301, 2.200000047683716f));
//   float _347 = (pow(_312, 2.200000047683716f));
//   float _361 = exp2(log2(saturate(((dot(float3(0.6274039149284363f, 0.3292829990386963f, 0.043313100934028625f), float3(_345, _346, _347)) * 250.0f) + ((_332 * _247) * (lerp(_320, 1.0f, _313)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _372 = saturate(exp2(log2(max(0.0f, (((_361 * 18.8515625f) + 0.8359375f) * (1.0f / ((_361 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _377 = exp2(log2(saturate(((dot(float3(0.06909730285406113f, 0.9195405840873718f, 0.011362300254404545f), float3(_345, _346, _347)) * 250.0f) + ((_332 * _260) * (lerp(_321, 1.0f, _313)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _388 = saturate(exp2(log2(max(0.0f, (((_377 * 18.8515625f) + 0.8359375f) * (1.0f / ((_377 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _393 = exp2(log2(saturate(((dot(float3(0.01639140024781227f, 0.08801329880952835f, 0.8955953121185303f), float3(_345, _346, _347)) * 250.0f) + ((_332 * _273) * (lerp(_322, 1.0f, _313)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   float _404 = saturate(exp2(log2(max(0.0f, (((_393 * 18.8515625f) + 0.8359375f) * (1.0f / ((_393 * 18.6875f) + 1.0f))))) * 78.84375f));
//   float _406 = (_27.x * 2.0f) + -1.0f;
//   float _423 = (float((int)(((int)(uint)((bool)(_406 > 0.0f))) - ((int)(uint)((bool)(_406 < 0.0f))))) * 0.0009775171056389809f) * (1.0f - sqrt(1.0f - abs(_406)));
//   SV_Target.x = saturate(select(((abs((_372 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_423 + _372), _372));
//   SV_Target.y = saturate(select(((abs((_388 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_423 + _388), _388));
//   SV_Target.z = saturate(select(((abs((_404 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_423 + _404), _404));
//   SV_Target.w = 0.0f;
//   return SV_Target;
// }
