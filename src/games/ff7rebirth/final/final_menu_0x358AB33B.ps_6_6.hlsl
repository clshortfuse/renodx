...
float4 main(noperspective float2 TEXCOORD : TEXCOORD,
...
//   row_major float4x4 View_TranslatedWorldToOrthographicClip :
//   packoffset(c008.x); row_major float4x4 View_WorldToClip :
//   packoffset(c012.x); row_major float4x4 View_ClipToWorld :
//   packoffset(c016.x); row_major float4x4 View_TranslatedWorldToView :
//   packoffset(c020.x); row_major float4x4 View_ViewToTranslatedWorld :
//   packoffset(c024.x); row_major float4x4 View_TranslatedWorldToCameraView :
//   packoffset(c028.x); row_major float4x4 View_CameraViewToTranslatedWorld :
//   packoffset(c032.x); row_major float4x4 View_ViewToClip :
//   packoffset(c036.x); row_major float4x4 View_ViewToClipNoAA :
//   packoffset(c040.x); row_major float4x4 View_ClipToView :
//   packoffset(c044.x); row_major float4x4 View_ClipToTranslatedWorld :
//   packoffset(c048.x); row_major float4x4 View_SVPositionToTranslatedWorld :
//   packoffset(c052.x); row_major float4x4 View_ScreenToWorld :
//   packoffset(c056.x); row_major float4x4 View_ScreenToTranslatedWorld :
//   packoffset(c060.x); row_major float4x4 View_MobileMultiviewShadowTransform
//   : packoffset(c064.x); float3 View_ViewForward : packoffset(c068.x); float
//   PrePadding_View_1100 : packoffset(c068.w); float3 View_ViewUp :
//   packoffset(c069.x); float PrePadding_View_1116 : packoffset(c069.w); float3
//   View_ViewRight : packoffset(c070.x); float PrePadding_View_1132 :
//   packoffset(c070.w); float3 View_HMDViewNoRollUp : packoffset(c071.x); float
//   PrePadding_View_1148 : packoffset(c071.w); float3 View_HMDViewNoRollRight :
//   packoffset(c072.x); float PrePadding_View_1164 : packoffset(c072.w); float4
//   View_InvDeviceZToWorldZTransform : packoffset(c073.x); float4
//   View_ScreenPositionScaleBias : packoffset(c074.x); float3
//   View_WorldCameraOrigin : packoffset(c075.x); float PrePadding_View_1212 :
//   packoffset(c075.w); float3 View_TranslatedWorldCameraOrigin :
//   packoffset(c076.x); float PrePadding_View_1228 : packoffset(c076.w); float3
//   View_WorldViewOrigin : packoffset(c077.x); float PrePadding_View_1244 :
//   packoffset(c077.w); float3 View_PreViewTranslation : packoffset(c078.x);
...
//   row_major float4x4 View_PrevTranslatedWorldToOrthographicClip :
//   packoffset(c107.x); row_major float4x4 View_PrevTranslatedWorldToView :
//   packoffset(c111.x); row_major float4x4 View_PrevViewToTranslatedWorld :
//   packoffset(c115.x); row_major float4x4 View_PrevTranslatedWorldToCameraView
//   : packoffset(c119.x); row_major float4x4
//   View_PrevCameraViewToTranslatedWorld : packoffset(c123.x); float3
//   View_PrevWorldCameraOrigin : packoffset(c127.x); float PrePadding_View_2044
//   : packoffset(c127.w); float3 View_PrevWorldViewOrigin : packoffset(c128.x);
...
//   row_major float4x4 View_ClipToPrevClipWithoutTranslation :
//   packoffset(c142.x); row_major float4x4 View_ProjectionToWorld :
//   packoffset(c146.x); row_major float4x4 View_WorldToProjection :
//   packoffset(c150.x); float4 View_TemporalAAJitter : packoffset(c154.x);
...
//   packoffset(c199.x); float4 View_AtmosphereLightDiscLuminance[2] :
//   packoffset(c201.x); float4 View_AtmosphereLightDiscCosHalfApexAngle[2] :
//   packoffset(c203.x); float4 View_SkyViewLutSizeAndInvSize :
//   packoffset(c205.x); float3 View_SkyWorldCameraOrigin : packoffset(c206.x);
...
//   packoffset(c214.x); float View_SkyAtmosphereAerialPerspectiveStartDepthKm :
//   packoffset(c215.x); float
//   View_SkyAtmosphereCameraAerialPerspectiveVolumeDepthResolution :
//   packoffset(c215.y); float
//   View_SkyAtmosphereCameraAerialPerspectiveVolumeDepthResolutionInv :
//   packoffset(c215.z); float
//   View_SkyAtmosphereCameraAerialPerspectiveVolumeDepthSliceLengthKm :
//   packoffset(c215.w); float
//   View_SkyAtmosphereCameraAerialPerspectiveVolumeDepthSliceLengthKmInv :
//   packoffset(c216.x); float
//   View_SkyAtmosphereApplyCameraAerialPerspectiveVolume : packoffset(c216.y);
...
//   packoffset(c248.z); float View_SkyLightAffectReflectionFlag :
//   packoffset(c248.w); float View_SkyLightAffectGlobalIlluminationFlag :
//   packoffset(c249.x); float PrePadding_View_3988 : packoffset(c249.y); float
//   PrePadding_View_3992 : packoffset(c249.z); float PrePadding_View_3996 :
//   packoffset(c249.w); float4 View_SkyLightColor : packoffset(c250.x); float4
//   View_MobileSkyIrradianceEnvironmentMap[7] : packoffset(c251.x); float
//   View_MobilePreviewMode : packoffset(c258.x); float View_HMDEyePaddingOffset
//   : packoffset(c258.y); float View_ReflectionCubemapMaxMip :
//   packoffset(c258.z); float View_ShowDecalsMask : packoffset(c258.w); uint
//   View_DistanceFieldAOSpecularOcclusionMode : packoffset(c259.x); float
//   View_IndirectCapsuleSelfShadowingIntensity : packoffset(c259.y); float
//   PrePadding_View_4152 : packoffset(c259.z); float PrePadding_View_4156 :
//   packoffset(c259.w); float3
//   View_ReflectionEnvironmentRoughnessMixingScaleBiasAndLargestWeight :
//   packoffset(c260.x); int View_StereoPassIndex : packoffset(c260.w); float4
//   View_GlobalVolumeCenterAndExtent[4] : packoffset(c261.x); float4
//   View_GlobalVolumeWorldToUVAddAndMul[4] : packoffset(c265.x); float
//   View_GlobalVolumeDimension : packoffset(c269.x); float
//   View_GlobalVolumeTexelSize : packoffset(c269.y); float
//   View_MaxGlobalDistance : packoffset(c269.z); float PrePadding_View_4316 :
//   packoffset(c269.w); int2 View_CursorPosition : packoffset(c270.x); float
//   View_bCheckerboardSubsurfaceProfileRendering : packoffset(c270.z); float
//   PrePadding_View_4332 : packoffset(c270.w); float3
//   View_PrecomputedLightVolumeGridZParams : packoffset(c271.x); float
//   PrePadding_View_4348 : packoffset(c271.w); float3
//   View_PrecomputedLightVolumeGridSize : packoffset(c272.x); float
//   PrePadding_View_4364 : packoffset(c272.w); int3
//   View_PrecomputedLightVolumeGridSizeInt : packoffset(c273.x); int
//   PrePadding_View_4380 : packoffset(c273.w); float3
//   View_VolumetricFogGridSize : packoffset(c274.x); float PrePadding_View_4396
//   : packoffset(c274.w); float3 View_VolumetricFogGridSizeReciprocal :
//   packoffset(c275.x); float PrePadding_View_4412 : packoffset(c275.w); float3
//   View_VolumetricFogGridZParameter : packoffset(c276.x); float
//   PrePadding_View_4428 : packoffset(c276.w); float3
//   View_VolumetricFogGridZParameterReciprocal : packoffset(c277.x); float
//   PrePadding_View_4444 : packoffset(c277.w); float3
//   View_VolumetricFogGridCoordinateSolver : packoffset(c278.x); float
//   PrePadding_View_4460 : packoffset(c278.w); float3
//   View_VolumetricFogGridCoordinateMinimum : packoffset(c279.x); float
//   PrePadding_View_4476 : packoffset(c279.w); float3
//   View_VolumetricFogGridCoordinateMaximum : packoffset(c280.x); float
//   View_VolumetricFogMaxDistance : packoffset(c280.w); float3
//   View_VolumetricLightmapWorldToUVScale : packoffset(c281.x); float
//   PrePadding_View_4508 : packoffset(c281.w); float3
//   View_VolumetricLightmapWorldToUVAdd : packoffset(c282.x); float
//   PrePadding_View_4524 : packoffset(c282.w); float3
//   View_VolumetricLightmapIndirectionTextureSize : packoffset(c283.x); float
//   View_VolumetricLightmapBrickSize : packoffset(c283.w); float3
//   View_VolumetricLightmapBrickTexelSize : packoffset(c284.x); float
//   View_StereoIPD : packoffset(c284.w); float
//   View_IndirectLightingCacheShowFlag : packoffset(c285.x); float
//   View_EyeToPixelSpreadAngle : packoffset(c285.y); float PrePadding_View_4568
//   : packoffset(c285.z); float PrePadding_View_4572 : packoffset(c285.w);
...
// // DXIL FirstbitHi: returns bit position counting from MSB (leading zeros
// count) uint firstbithigh_msb(int value) { return (value == 0) ? 0xFFFFFFFF :
// (31u - firstbithigh(value)); } uint firstbithigh_msb(uint value) { return
// (value == 0) ? 0xFFFFFFFF : (31u - firstbithigh(value)); }
...
//   float _439;
//   float _456;
//   _20 = (DeviceCorrectorContext.z != 0.0f);
//   _36 = SV_Position.x -
//   float((uint)(uint)(ViewportDestination_ViewportMin.x)); _37 = SV_Position.y
//   - float((uint)(uint)(ViewportDestination_ViewportMin.y)); _43 =
//   saturate(_36 * ViewportDestination_ViewportSizeInverse.x); _44 =
//   saturate(_37 * ViewportDestination_ViewportSizeInverse.y); _57 =
//   select(_20, saturate(ViewportDestination_ViewportSizeInverse.x *
//   ((floor(_36 * 0.5f) * 2.0f) + 1.0f)), _43); _58 = select(_20,
//   saturate(((floor(_37 * 0.5f) * 2.0f) + 1.0f) *
//   ViewportDestination_ViewportSizeInverse.y), _44); _123 =
//   (min(((ViewportDestination_ViewportSize.x * 0.5625f) *
//   ViewportDestination_ViewportSizeInverse.y), 1.0f) * (_43 + -0.5f)) + 0.5f;
//   _124 = (min(((ViewportDestination_ViewportSize.y * 1.7777777910232544f) *
//   ViewportDestination_ViewportSizeInverse.x), 1.0f) * (_44 + -0.5f)) + 0.5f;
//   _127 = ColorTexture.SampleLevel(View_SharedBilinearClampedSampler,
//   float2(min(max((((ViewportColor_ViewportSize.x * _57) +
//   float((uint)(uint)(ViewportColor_ViewportMin.x))) *
//   ViewportColor_ExtentInverse.x), ViewportColor_UVViewportBilinearMin.x),
//   ViewportColor_UVViewportBilinearMax.x),
//   min(max((((ViewportColor_ViewportSize.y * _58) +
//   float((uint)(uint)(ViewportColor_ViewportMin.y))) *
//   ViewportColor_ExtentInverse.y), ViewportColor_UVViewportBilinearMin.y),
//   ViewportColor_UVViewportBilinearMax.y)), 0.0f); _139 = (1.0f /
//   max(0.0010000000474974513f, VignetteContext.y)) * TEXCOORD_1.z; _144 =
//   (_139 * _139) * (1.0f / max(9.999999747378752e-06f,
//   dot(float3(TEXCOORD_1.x, TEXCOORD_1.y, _139), float3(TEXCOORD_1.x,
//   TEXCOORD_1.y, _139)))); _148 = (((_144 * _144) + -1.0f) *
//   VignetteContext.x) + 1.0f; _149 = _148 * min(_127.x, 64512.0f); _150 = _148
//   * min(_127.y, 64512.0f); _151 = _148 * min(_127.z, 64512.0f); _153 =
//   GlareTexture.SampleLevel(View_SharedBilinearClampedSampler,
//   float2(min(max((((ViewportGlare_ViewportSize.x * _57) +
//   float((uint)(uint)(ViewportGlare_ViewportMin.x))) *
//   ViewportGlare_ExtentInverse.x), ViewportGlare_UVViewportBilinearMin.x),
//   ViewportGlare_UVViewportBilinearMax.x),
//   min(max((((ViewportGlare_ViewportSize.y * _58) +
//   float((uint)(uint)(ViewportGlare_ViewportMin.y))) *
//   ViewportGlare_ExtentInverse.y), ViewportGlare_UVViewportBilinearMin.y),
//   ViewportGlare_UVViewportBilinearMax.y)), 0.0f); _182 =
//   exp2(log2(saturate(((((min(_153.x, 64512.0f) - _149) + (GlareContext.y *
//   _149)) * GlareContext.x) + _149) * 0.009999999776482582f)) *
//   0.1593017578125f); _198 = exp2(log2(saturate(((((min(_153.y, 64512.0f) -
//   _150) + (GlareContext.y * _150)) * GlareContext.x) + _150) *
//   0.009999999776482582f)) * 0.1593017578125f); _214 =
//   exp2(log2(saturate(((((min(_153.z, 64512.0f) - _151) + (GlareContext.y *
//   _151)) * GlareContext.x) + _151) * 0.009999999776482582f)) *
//   0.1593017578125f); _233 =
//   BT709PQToBT2020PQLUT.SampleLevel(View_SharedBilinearClampedSampler,
//   float3(((saturate(exp2(log2(max(0.0f, (((_182 * 18.8515625f) + 0.8359375f)
//   * (1.0f / ((_182 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) +
//   0.015625f), ((saturate(exp2(log2(max(0.0f, (((_198 * 18.8515625f) +
//   0.8359375f) * (1.0f / ((_198 * 18.6875f) + 1.0f))))) * 78.84375f)) *
//   0.96875f) + 0.015625f), ((saturate(exp2(log2(max(0.0f, (((_214
//   * 18.8515625f) + 0.8359375f) * (1.0f / ((_214 * 18.6875f) + 1.0f)))))
//   * 78.84375f)) * 0.96875f) + 0.015625f)), 0.0f); _240 =
//   exp2(log2(saturate(_233.x)) * 0.012683313339948654f); _249 =
//   exp2(log2(max(0.0f, ((_240 + -0.8359375f) * (1.0f / (18.8515625f - (_240
//   * 18.6875f)))))) * 6.277394771575928f); _254 = exp2(log2(saturate(_233.y))
//   * 0.012683313339948654f); _263 = exp2(log2(max(0.0f, ((_254 + -0.8359375f)
//   * (1.0f / (18.8515625f - (_254 * 18.6875f)))))) * 6.277394771575928f); _268
//   = exp2(log2(saturate(_233.z)) * 0.012683313339948654f); _277 =
//   exp2(log2(max(0.0f, ((_268 + -0.8359375f) * (1.0f / (18.8515625f - (_268
//   * 18.6875f)))))) * 6.277394771575928f); _280 =
//   CompositeSDRBackgroundTexture.SampleLevel(View_SharedBilinearClampedSampler,
//   float2(_123, _124), 0.0f); _286 =
//   CompositeSDRTexture.SampleLevel(View_SharedBilinearClampedSampler,
//   float2(_123, _124), 0.0f); _299 =
//   CompositeSDRForegroundTexture.SampleLevel(View_SharedBilinearClampedSampler,
//   float2(_123, _124), 0.0f); _307 = (_299.w * ((_286.w * _280.x) + _286.x)) +
//   _299.x; _308 = (_299.w * ((_286.w * _280.y) + _286.y)) + _299.y; _309 =
//   (_299.w * ((_286.w * _280.z) + _286.z)) + _299.z; _310 = (_286.w * _280.w)
//   * _299.w; if (_307 < 0.0031308000907301903f) {
//     _321 = (_307 * 12.920000076293945f);
//   } else {
//     _321 = (((pow(_307, 0.4166666567325592f)) * 1.0549999475479126f) +
//     -0.054999999701976776f);
//   }
//   if (_308 < 0.0031308000907301903f) {
//     _332 = (_308 * 12.920000076293945f);
//   } else {
//     _332 = (((pow(_308, 0.4166666567325592f)) * 1.0549999475479126f) +
//     -0.054999999701976776f);
//   }
//   if (_309 < 0.0031308000907301903f) {
//     _343 = (_309 * 12.920000076293945f);
//   } else {
//     _343 = (((pow(_309, 0.4166666567325592f)) * 1.0549999475479126f) +
//     -0.054999999701976776f);
//   }
//   _344 = _310 * _310;
//   _351 = 1.0f / ((_249 * 40.0f) + 1.0f);
//   _352 = 1.0f / ((_263 * 40.0f) + 1.0f);
//   _353 = 1.0f / ((_277 * 40.0f) + 1.0f);
//   _378 = saturate(pow(_321, 2.200000047683716f));
//   _379 = saturate(pow(_332, 2.200000047683716f));
//   _380 = saturate(pow(_343, 2.200000047683716f));
//   _394 = exp2(log2(saturate(((dot(float3(0.6274039149284363f,
//   0.3292829990386963f, 0.043313100934028625f), float3(_378, _379, _380)) *
//   250.0f) + (((_249 * 10000.0f) * _310) * (lerp(_351, 1.0f, _344))))
//   * 9.999999747378752e-05f)) * 0.1593017578125f); _405 =
//   saturate(exp2(log2(max(0.0f, (((_394 * 18.8515625f) + 0.8359375f) * (1.0f /
//   ((_394 * 18.6875f) + 1.0f))))) * 78.84375f)); _410 =
//   exp2(log2(saturate(((dot(float3(0.06909730285406113f, 0.9195405840873718f,
//   0.011362300254404545f), float3(_378, _379, _380)) * 250.0f) + (((_263 *
//   10000.0f) * _310) * (lerp(_352, 1.0f, _344)))) * 9.999999747378752e-05f)) *
//   0.1593017578125f); _421 = saturate(exp2(log2(max(0.0f, (((_410
//   * 18.8515625f) + 0.8359375f) * (1.0f / ((_410 * 18.6875f) + 1.0f)))))
//   * 78.84375f)); _426 = exp2(log2(saturate(((dot(float3(0.01639140024781227f,
//   0.08801329880952835f, 0.8955953121185303f), float3(_378, _379, _380)) *
//   250.0f) + (((_277 * 10000.0f) * _310) * (lerp(_353, 1.0f, _344))))
//   * 9.999999747378752e-05f)) * 0.1593017578125f); _437 =
//   saturate(exp2(log2(max(0.0f, (((_426 * 18.8515625f) + 0.8359375f) * (1.0f /
//   ((_426 * 18.6875f) + 1.0f))))) * 78.84375f)); _439 =
//   ((((float4)(View_SpatiotemporalBlueNoiseVolumeTexture.Load(int4((int(SV_Position.x)
//   & 127), (int(SV_Position.y) & 127), (View_StateFrameIndex & 63), 0)))).x)
//   * 2.0f) + -1.0f; _456 = ((1.0f - sqrt(1.0f - abs(_439))) *
//   float((int)(((int)(uint)((int)(_439 > 0.0f))) - ((int)(uint)((int)(_439 <
//   0.0f)))))) * 0.0009775171056389809f; SV_Target.x =
//   saturate(select(((abs((_405 * 2.0f) + -1.0f) + -0.9980449676513672f) <
//   0.0f), (_456 + _405), _405)); SV_Target.y = saturate(select(((abs((_421
//   * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_456 + _421), _421));
//   SV_Target.z = saturate(select(((abs((_437 * 2.0f) + -1.0f) +
//   -0.9980449676513672f) < 0.0f), (_456 + _437), _437)); SV_Target.w = 0.0f;
//   return SV_Target;
// }