...
//   _180 = exp2(log2(saturate(((((min(_151.x, 64512.0f) - _147) + (GlareContext.y * _147)) * GlareContext.x) + _147) * 0.009999999776482582f)) * 0.1593017578125f);
//   _196 = exp2(log2(saturate(((((min(_151.y, 64512.0f) - _148) + (GlareContext.y * _148)) * GlareContext.x) + _148) * 0.009999999776482582f)) * 0.1593017578125f);
//   _212 = exp2(log2(saturate(((((min(_151.z, 64512.0f) - _149) + (GlareContext.y * _149)) * GlareContext.x) + _149) * 0.009999999776482582f)) * 0.1593017578125f);
//   _231 = BT709PQToBT2020PQLUT.SampleLevel(View_SharedBilinearClampedSampler, float3(((saturate(exp2(log2(max(0.0f, (((_180 * 18.8515625f) + 0.8359375f) * (1.0f / ((_180 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f), ((saturate(exp2(log2(max(0.0f, (((_196 * 18.8515625f) + 0.8359375f) * (1.0f / ((_196 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f), ((saturate(exp2(log2(max(0.0f, (((_212 * 18.8515625f) + 0.8359375f) * (1.0f / ((_212 * 18.6875f) + 1.0f))))) * 78.84375f)) * 0.96875f) + 0.015625f)), 0.0f);
//   _238 = exp2(log2(saturate(_231.x)) * 0.012683313339948654f);
//   _247 = exp2(log2(max(0.0f, ((_238 + -0.8359375f) * (1.0f / (18.8515625f - (_238 * 18.6875f)))))) * 6.277394771575928f);
//   _252 = exp2(log2(saturate(_231.y)) * 0.012683313339948654f);
//   _261 = exp2(log2(max(0.0f, ((_252 + -0.8359375f) * (1.0f / (18.8515625f - (_252 * 18.6875f)))))) * 6.277394771575928f);
//   _266 = exp2(log2(saturate(_231.z)) * 0.012683313339948654f);
//   _275 = exp2(log2(max(0.0f, ((_266 + -0.8359375f) * (1.0f / (18.8515625f - (_266 * 18.6875f)))))) * 6.277394771575928f);
//   _278 = CompositeSDRTexture.SampleLevel(View_SharedBilinearClampedSampler, float2(((min(((ViewportDestination_ViewportSize.x * 0.5625f) * ViewportDestination_ViewportSizeInverse.y), 1.0f) * (_41 + -0.5f)) + 0.5f), ((min(((ViewportDestination_ViewportSize.y * 1.7777777910232544f) * ViewportDestination_ViewportSizeInverse.x), 1.0f) * (_42 + -0.5f)) + 0.5f)), 0.0f);
//   if (_278.x < 0.0031308000907301903f) {
//     _293 = (_278.x * 12.920000076293945f);
//   } else {
//     _293 = (((pow(_278.x, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_278.y < 0.0031308000907301903f) {
//     _304 = (_278.y * 12.920000076293945f);
//   } else {
//     _304 = (((pow(_278.y, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   if (_278.z < 0.0031308000907301903f) {
//     _315 = (_278.z * 12.920000076293945f);
//   } else {
//     _315 = (((pow(_278.z, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
//   }
//   _316 = _278.w * _278.w;
//   _323 = 1.0f / ((_247 * 40.0f) + 1.0f);
//   _324 = 1.0f / ((_261 * 40.0f) + 1.0f);
//   _325 = 1.0f / ((_275 * 40.0f) + 1.0f);
//   _350 = saturate(pow(_293, 2.200000047683716f));
//   _351 = saturate(pow(_304, 2.200000047683716f));
//   _352 = saturate(pow(_315, 2.200000047683716f));
//   _366 = exp2(log2(saturate(((dot(float3(0.6274039149284363f, 0.3292829990386963f, 0.043313100934028625f), float3(_350, _351, _352)) * 250.0f) + (((_247 * 10000.0f) * _278.w) * (lerp(_323, 1.0f, _316)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   _377 = saturate(exp2(log2(max(0.0f, (((_366 * 18.8515625f) + 0.8359375f) * (1.0f / ((_366 * 18.6875f) + 1.0f))))) * 78.84375f));
//   _382 = exp2(log2(saturate(((dot(float3(0.06909730285406113f, 0.9195405840873718f, 0.011362300254404545f), float3(_350, _351, _352)) * 250.0f) + (((_261 * 10000.0f) * _278.w) * (lerp(_324, 1.0f, _316)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   _393 = saturate(exp2(log2(max(0.0f, (((_382 * 18.8515625f) + 0.8359375f) * (1.0f / ((_382 * 18.6875f) + 1.0f))))) * 78.84375f));
//   _398 = exp2(log2(saturate(((dot(float3(0.01639140024781227f, 0.08801329880952835f, 0.8955953121185303f), float3(_350, _351, _352)) * 250.0f) + (((_275 * 10000.0f) * _278.w) * (lerp(_325, 1.0f, _316)))) * 9.999999747378752e-05f)) * 0.1593017578125f);
//   _409 = saturate(exp2(log2(max(0.0f, (((_398 * 18.8515625f) + 0.8359375f) * (1.0f / ((_398 * 18.6875f) + 1.0f))))) * 78.84375f));
//   _411 = ((((float4)(View_SpatiotemporalBlueNoiseVolumeTexture.Load(int4((int(SV_Position.x) & 127), (int(SV_Position.y) & 127), (View_StateFrameIndex & 63), 0)))).x) * 2.0f) + -1.0f;
//   _428 = ((1.0f - sqrt(1.0f - abs(_411))) * float((int)(((int)(uint)((int)(_411 > 0.0f))) - ((int)(uint)((int)(_411 < 0.0f)))))) * 0.0009775171056389809f;
//   SV_Target.x = saturate(select(((abs((_377 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_428 + _377), _377));
//   SV_Target.y = saturate(select(((abs((_393 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_428 + _393), _393));
//   SV_Target.z = saturate(select(((abs((_409 * 2.0f) + -1.0f) + -0.9980449676513672f) < 0.0f), (_428 + _409), _409));
//   SV_Target.w = 0.0f;
//   return SV_Target;
// }