...
float3 Sample3Packed1DLuts(
  ...
  float _1305 = ((((((lerp(_1229.x, _1234.x, _1224)) * LUTWeights[0].y) + (LUTWeights[0].x * _1189)) + ((lerp(_1256.x, _1260.x, _1224)) * LUTWeights[0].z)) + ((lerp(_1282.x, _1286.x, _1224)) * LUTWeights[0].w)));
  float _1306 = ((((((lerp(_1229.y, _1234.y, _1224)) * LUTWeights[0].y) + (LUTWeights[0].x * _1200)) + ((lerp(_1256.y, _1260.y, _1224)) * LUTWeights[0].z)) + ((lerp(_1282.y, _1286.y, _1224)) * LUTWeights[0].w)));
  float _1307 = ((((((lerp(_1229.z, _1234.z, _1224)) * LUTWeights[0].y) + (LUTWeights[0].x * _1211)) + ((lerp(_1256.z, _1260.z, _1224)) * LUTWeights[0].z)) + ((lerp(_1282.z, _1286.z, _1224)) * LUTWeights[0].w)));
