/*
 * Copyright (C) 2025 Carlos Lopez, Amelia Wheeler
...
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntry(0x3E2F4F50), // Main Menu Video. May be used for others...
    CustomShaderEntry(0xED64F186), // ToneMap
    CustomShaderEntry(0x13D78644), // Output? 
    CustomShaderEntry(0xC0858664), // In Game Brightness
    // Others
};
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX (Digimon Story: Time Stranger)";
