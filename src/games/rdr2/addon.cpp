...
renodx::utils::settings::Settings settings = {
    new renodx::utils::settings::Setting{
        ...
        .labels = {"Vanilla", "None", "Vanilla+", "SDR"},
    },
    new renodx::utils::settings::Setting{
        .key = "ToneMapPeakNits",
    ...
    new renodx::utils::settings::Setting{
        .key = "UseSRGBLUTEncoding",
        .binding = &shader_injection.use_srgb_lut_encoding,
        .value_type = renodx::utils::settings::SettingValueType::BOOLEAN,
        .default_value = 1.f,
        .label = "Use sRGB LUT Encoding",
        .section = "Advanced",
        .tooltip = "Replaces the game's custom sRGB-like LUT encoding with standard sRGB",
    },
    new renodx::utils::settings::Setting{
