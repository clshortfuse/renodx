  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  // Reduce saturation by 20%... Why? Pure slop, couldnt figure out a better way.
  // Scene and world map use the same grading but world map is already more saturated
  // Good grading settings for the scene resulted in giga saturated colours in the world map
  // This does mean other UI also get 20% saturation reduction, I eyeballed roughly.
