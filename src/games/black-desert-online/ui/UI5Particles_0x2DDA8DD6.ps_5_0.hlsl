...
// This shader handles the bright UI Particles so upgrades, sparkles ect
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  float ui_peak = RENODX_PEAK_WHITE_NITS / RENODX_GRAPHICS_WHITE_NITS;
  o0.rgb = o0.rgb * (1.f + o0.rgb / (ui_peak * ui_peak)) / (1.f + o0.rgb);
