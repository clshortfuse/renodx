  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  // Sample the auxiliary texture with lens-distorted UVs and scale it.
  r0.xyzw = atex2D_Texture.Sample(asamp2D_Texture_s, v1.xy, int2(0, 0)).xyzw;
  r0.xyzw = afRGBA_Modulate[1].xyzw * r0.xyzw;
  // Fetch the primary buffer and apply its modulation before adding.
  r1.xyzw = atex2D_Texture.Sample(asamp2D_Texture_s, v0.xy, int2(0, 0)).xyzw;
  o0.xyzw = r1.xyzw * afRGBA_Modulate[0].xyzw + r0.xyzw;
  return;
}