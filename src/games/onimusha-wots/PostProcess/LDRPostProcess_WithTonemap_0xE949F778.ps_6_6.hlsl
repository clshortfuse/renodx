...
float4 main(
  ...
  _2482 = isfinite(max(max(_2477, _2478), _2479));
  _2483 = select(_2482, _2477, 1.0f);
  _2484 = select(_2482, _2478, 1.0f);
  _2485 = select(_2482, _2479, 1.0f);
  if (!((cPassEnabled & 8) == 0)) {
    _2520 = saturate(((cvdR.x * _2483) + (cvdR.y * _2484)) + (cvdR.z * _2485));
    _2521 = saturate(((cvdG.x * _2483) + (cvdG.y * _2484)) + (cvdG.z * _2485));
    _2522 = saturate(((cvdB.x * _2483) + (cvdB.y * _2484)) + (cvdB.z * _2485));
  } else {
    _2520 = _2483;
    _2521 = _2484;
    _2522 = _2485;
  ...
  if (!((cPassEnabled & 16) == 0)) {
    _2534 = screenInverseSize.x * SV_Position.x;
    _2535 = screenInverseSize.y * SV_Position.y;
    _2538 = ImagePlameBase.SampleLevel(BilinearClamp, float2(_2534, _2535), 0.0f);
    _2543 = _2538.x * ColorParam.x;
    _2544 = _2538.y * ColorParam.y;
    _2545 = _2538.z * ColorParam.z;
    _2553 = (_2538.w * ColorParam.w) * saturate((((ImagePlameAlpha.SampleLevel(BilinearClamp, float2(_2534, _2535), 0.0f)).x) * Levels_Rate) + Levels_Range);
    do {
      if (_2543 < 0.5f) {
        _2565 = ((_2520 * 2.0f) * _2543);
      } else {
        _2565 = (1.0f - (((1.0f - _2520) * 2.0f) * (1.0f - _2543)));
      }
      do {
        if (_2544 < 0.5f) {
          _2577 = ((_2521 * 2.0f) * _2544);
        } else {
          _2577 = (1.0f - (((1.0f - _2521) * 2.0f) * (1.0f - _2544)));
        }
        do {
          if (_2545 < 0.5f) {
            _2589 = ((_2522 * 2.0f) * _2545);
          } else {
            _2589 = (1.0f - (((1.0f - _2522) * 2.0f) * (1.0f - _2545)));
          }
          _2600 = (lerp(_2520, _2565, _2553));
          _2601 = (lerp(_2521, _2577, _2553));
          _2602 = (lerp(_2522, _2589, _2553));
        } while (false);
      } while (false);
    } while (false);
  } else {
  ...
  if (tonemapParam_isHDRMode == 0.0f) {
    ...
    do {
      _2618 = 1.0f;
      if (!(_2600 >= linearBegin)) {
        _2618 = ((_2610 * _2610) * (3.0f - (_2610 * 2.0f)));
      }
      _2619 = invLinearBegin * _2601;
      do {
        _2627 = 1.0f;
        if (!(_2601 >= linearBegin)) {
          _2627 = ((_2619 * _2619) * (3.0f - (_2619 * 2.0f)));
        }
        _2628 = invLinearBegin * _2602;
        do {
          _2636 = 1.0f;
          if (!(_2602 >= linearBegin)) {
            _2636 = ((_2628 * _2628) * (3.0f - (_2628 * 2.0f)));
          }
          _2645 = select((_2600 < linearStart), 0.0f, 1.0f);
          _2646 = select((_2601 < linearStart), 0.0f, 1.0f);
          _2647 = select((_2602 < linearStart), 0.0f, 1.0f);
          _2707 = (((((1.0f - _2618) * linearBegin) * (pow(_2610, toe))) + ((_2618 - _2645) * ((contrast * _2600) + madLinearStartContrastFactor))) + ((maxNit - (exp2((contrastFactor * _2600) + mulLinearStartContrastFactor) * displayMaxNitSubContrastFactor)) * _2645));
          _2708 = (((((1.0f - _2627) * linearBegin) * (pow(_2619, toe))) + ((_2627 - _2646) * ((contrast * _2601) + madLinearStartContrastFactor))) + ((maxNit - (exp2((contrastFactor * _2601) + mulLinearStartContrastFactor) * displayMaxNitSubContrastFactor)) * _2646));
          _2709 = (((((1.0f - _2636) * linearBegin) * (pow(_2628, toe))) + ((_2636 - _2647) * ((contrast * _2602) + madLinearStartContrastFactor))) + ((maxNit - (exp2((contrastFactor * _2602) + mulLinearStartContrastFactor) * displayMaxNitSubContrastFactor)) * _2647));
        } while (false);
      } while (false);
    } while (false);
  } else {
