// ---- Created with 3Dmigoto v1.3.16 on Fri Mar 21 12:33:51 2025
// tonemap shader with another dramatic lut setup
// idk if or when its used
...
void main(
  ...
  r3.xy = float2(0.5, 0.5) * g_vMaxUV.zw;
  r3.zw = r2.xz / g_vMaxUV.zw;
  r4.yz = float2(-0.5, -0.5) + r3.zw;
  r5.yz = -g_vMaxUV.zw * float2(0.5, 0.5) + r2.xz;
  r4.x = g_vCompositeInfo.x * r4.y;
  r5.x = g_vCompositeInfo.x * r5.y;
  r2.w = dot(r4.xz, r4.xz);
  r3.z = r2.w * r2.w;
  r2.w = g_vDistortionParams.x * r2.w + 1;
  r2.w = g_vDistortionParams.y * r3.z + r2.w;
  r4.yz = r2.ww * r5.xz;
  r4.x = r4.y / g_vCompositeInfo.x;
  r3.xy = r4.xz * g_vDistortionParams.zz + r3.xy;
  ...
  if (r1.w != 0) {
    ...
    r4.xy = g_vCompositeLastViewport.xy + g_vCompositeLastViewport.xy;
    r4.xy = g_vMaxUV.xy * float2(0.5, 0.5) + r4.xy;
    r4.zw = float2(1, 1) / g_vMaxUV.xy;
    r5.xy = r2.xz + r2.xz;
    r4.xy = r4.xy * float2(-2, -2) + r5.xy;
    r2.w = dot(r4.xy, r4.xy);
    r4.xy = r4.xy * r2.ww;
    r5.xy = r4.zw * r4.zw;
    r4.xy = r5.xy * r4.xy;
    r4.xy = g_vEtcEffect.xx * r4.xy;
    r4.zw = g_vSceneTexSize.xy * r4.zw;
    r4.zw = r4.zw * -r4.xy;
  ...
  if (r0.x != 0) {
    ...
    r5.xyz = g_tLensFlareMap.SampleLevel(sampleLinear_s, r0.xz, 0).xyz;
  ...
  if (r0.y != 0) {
    r4.xy = g_vCompositeLastViewport.xy;
    r4.zw = g_vMaxUV.xy;
    r4.xyzw = r4.xyzw / g_vCompositeLastViewport.zwzw;
    r0.x = g_vCompositeLastViewport.z * g_vCompositeInfo.x;
    r0.x = r0.x / g_vCompositeLastViewport.w;
    r0.yz = r4.zw * float2(0.5, 0.5) + r4.xy;
    r4.yz = v1.xy + -r0.yz;
    r4.x = r4.y * r0.x;
    r0.x = dot(r4.xz, r4.xz);
    r0.x = sqrt(r0.x);
    r0.x = r0.x / r4.w;
    r0.y = -g_vLimbDarkenningInfo.y + r0.x;
    r0.z = cmp(0 < r0.y);
    r0.y = saturate(-r0.y * g_vLimbDarkenningInfo.z + 1);
    r0.y = r0.z ? r0.y : 1;
    r0.z = cmp(0 < r0.y);
    r0.x = r0.x * r0.x + g_vLimbDarkenningInfo.x;
