  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = 1 + -r0.w;
  r1.xyzw = blurTexture.Sample(blurTexture_s, v1.xy).wxyz;
  r1.x = saturate(r1.x);
  r0.w = r1.x * r0.w;
  r2.xyz = r1.yzw + -r0.xyz;
  r0.xyz = r0.www * r2.xyz + r0.xyz;
  r2.xyzw = mainTexture2.Sample(mainTexture2_s, v1.xy).xyzw;
  r0.w = 1 + -r2.w;
  r0.xyz = r0.xyz * r0.www + r2.xyz;
  r1.xyz = r1.yzw + -r0.xyz;
  r0.w = depthTexture.Sample(depthTexture_s, v1.xy).x;
  r0.w = HexDOF_Params.x * r0.w + HexDOF_Params.y;
  r0.w = max(HexDOF_Params.w, r0.w);
  r0.w = saturate(abs(r0.w) * HexDOF_Params.z + -HexDOF_Params2.x);
