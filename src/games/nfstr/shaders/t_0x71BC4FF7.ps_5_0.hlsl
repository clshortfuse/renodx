// ---- Created with 3Dmigoto v1.3.16 on Tue Sep 09 12:08:07 2025
#include "./!common.hlsl"
...
SamplerState colorGradingTexture_s : register(s4);
...
Texture3D<float4> colorGradingTexture : register(t4);
