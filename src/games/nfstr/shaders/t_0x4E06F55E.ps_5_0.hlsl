// ---- Created with 3Dmigoto v1.3.16 on Tue Sep 09 12:08:05 2025
#include "./!common.hlsl"
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.yzw = blurTexture.Sample(blurTexture_s, v1.xy).xyz;
  r1.xyz = mainTexture.Sample(mainTexture_s, v1.xy).xyz;
