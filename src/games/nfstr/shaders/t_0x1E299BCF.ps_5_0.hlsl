// ---- Created with 3Dmigoto v1.3.16 on Tue Sep 09 14:18:32 2025
#include "./!common.hlsl"
...
SamplerState blurTexture_s : register(s4);
SamplerState colorGradingTexture_s : register(s5);
...
Texture3D<float4> colorGradingTexture : register(t5);
