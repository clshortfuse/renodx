...
struct ShaderInjectData {
  ...
  float custom_extra_bloom;
  float custom_extra_ui;
...
#define CUSTOM_EXTRA_BLOOM          shader_injection.custom_extra_bloom
#define CUSTOM_EXTRA_UI             shader_injection.custom_extra_ui
