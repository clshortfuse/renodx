...
#define CUSTOM_SCANLINES                     shader_injection.custom_scanlines
#define CUSTOM_BLOOM_FIX                   shader_injection.custom_bloom_fix
#define RESOURCE_TAG                         shader_injection.resource_tag
#define COMPOSITE_RESOURCE_TAG               67
#define MAIN_RESOURCE_TAG                    73
...
struct ShaderInjectData {
  ...
  float custom_scanlines;
  float custom_bloom_fix;
  float resource_tag;
};
