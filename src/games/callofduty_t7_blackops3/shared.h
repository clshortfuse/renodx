...
struct ShaderInjectData {
  ...
  float custom_sdrneutral_preexposure;
  float custom_sdrneutral_midwhite_out;
  float custom_motionblur_scale;
...
#define CUSTOM_TONEMAP_ISUSESDR       shader_injection.custom_tonemap_isusesdr
...
#define CUSTOM_MOTIONBLUR_SCALE       shader_injection.custom_motionblur_scale
