// ---- Created with 3Dmigoto v1.3.16 on Fri Aug 01 16:58:20 2025

//Final blur combine. Seen in pause screen (and unconfirmed when player dazzed).
...
{
  if (!CUSTOM_SHOW_FSFXBLUR) discard;
