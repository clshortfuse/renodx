  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  if (RENODX_TONE_MAP_TYPE != 0) {
    ...
    // r0.xyz = float3(3.05175781e-005,3.05175781e-005,3.05175781e-005) * r0.xyz; //this is skip noise and dither. same as r0.xyz /= SDR_NORMALIZATION_MAX;
    {
      //dither
      ...
      //get color and apply prev
      r1.xyz = t0.Sample(s0_s, v1.xy).xyz; //color
      r1.xyz = r1.xyz * float3(3.05175781e-005,3.05175781e-005,3.05175781e-005) + r0.xyz; //scaled down to 0-1 here
      r1.xz = r0.zx * r1.yy + r1.xz;

      // //srgb with user gamma correct
      // r0.xyz = log2(r1.xyz);
      // r0.xyz = cb8[2].yyy * r0.xyz;
      // r0.xyz = exp2(r0.xyz);
      // r0.xyz = r0.xyz * cb8[2].zzz + cb8[2].www; //user
      // r2.xyz = cmp(cb8[1].www >= r1.xyz);
      // r1.xyz = cb8[2].xxx * r1.xyz;
      // r0.xyz = r2.xyz ? r1.xyz : r0.xyz; //select
      // r0.xyz = cb8[1].yyy + r0.xyz; //user
