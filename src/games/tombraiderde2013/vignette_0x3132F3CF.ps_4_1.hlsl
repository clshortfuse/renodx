...
void main(
  ...
  r1.xyzw = InstanceParameters[r0.z].InstanceParams[1].xyzw + -InstanceParameters[r0.z].InstanceParams[0].xyzw;
  r0.xyzw = r0.xxxx * r1.xyzw + InstanceParameters[r0.z].InstanceParams[0].xyzw;
  r1.x = v0.x;
  o0.w = __InstancedMaterialOpacity[r1.x].x * r0.w;
  o0.xyz = r0.xyz * CUSTOM_VIGNETTE;
  return;
}
