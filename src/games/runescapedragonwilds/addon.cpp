...
extern "C" __declspec(dllexport) constexpr const char* NAME = "RenoDX for RuneScape: Dragonwilds";
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for RuneScape: Dragonwilds";
