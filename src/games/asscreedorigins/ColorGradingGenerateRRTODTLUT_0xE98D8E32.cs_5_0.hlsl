...
// ---- Created with 3Dmigoto v1.4.1 on Sun Mar 23 12:30:19 2025

// clang-format off
cbuffer ColorGradingGenerateRRTODTLUT_cbuffer : register(b6) {
  struct
  {
    uint UseRec2020;
    float WhiteScale;
    float MaxNitsHDRTV;
  } ColorGradingGenerateRRTODTLUT_constants: packoffset(c0);
}
// clang-format on
...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  ...
  if (ColorGradingGenerateRRTODTLUT_constants.UseRec2020 != 0 && RENODX_TONE_MAP_TYPE == 0) {
    r0.w = dot(r0.xyz, float3(1.45143938, -0.236510724, -0.214928553));
    r1.x = dot(r0.xyz, float3(-0.0765537992, 1.17622995, -0.0996759459));
    r1.y = dot(r0.xyz, float3(0.00831612758, -0.00603244733, 0.997716188));
    r1.z = cmp(ColorGradingGenerateRRTODTLUT_constants.MaxNitsHDRTV >= 4000);
    if (r1.z != 0) {
      ...
      r1.z = cmp(ColorGradingGenerateRRTODTLUT_constants.MaxNitsHDRTV >= 2000);
      if (r1.z != 0) {
        r1.z = -2000 + ColorGradingGenerateRRTODTLUT_constants.MaxNitsHDRTV;
        ...
        r1.z = cmp(ColorGradingGenerateRRTODTLUT_constants.MaxNitsHDRTV >= 1000);
        if (r1.z != 0) {
          r1.z = -1000 + ColorGradingGenerateRRTODTLUT_constants.MaxNitsHDRTV;
          ...
          r1.z = cmp(ColorGradingGenerateRRTODTLUT_constants.MaxNitsHDRTV >= 48);
          if (r1.z != 0) {
            r1.z = -48 + ColorGradingGenerateRRTODTLUT_constants.MaxNitsHDRTV;
    ...
    if (r0.z != 0) {
      ...
      r0.w = cmp(r0.y < 2.26303411);
      if (r0.w != 0) {
        r0.w = r0.y * 0.30103001 + 2.54062366;
        r1.y = 2.17265487 * r0.w;
        r1.z = (int)r1.y;
        r1.y = trunc(r1.y);
        r3.y = r0.w * 2.17265487 + -r1.y;
    ...
    if (r0.w != 0) {
      ...
      r1.x = cmp(r0.z < 2.26303411);
      if (r1.x != 0) {
        r1.x = r0.z * 0.30103001 + 2.54062366;
        r1.y = 2.17265487 * r1.x;
        r1.z = (int)r1.y;
        r1.y = trunc(r1.y);
        r3.y = r1.x * 2.17265487 + -r1.y;
        r1.xy = (int2)r1.zz + int2(1, 2);
        r3.x = r3.y * r3.y;
        r4.x = icb[r1.z + 0].z;
        r4.y = icb[r1.x + 0].z;
    ...
    if (r0.w != 0) {
      ...
      r1.x = cmp(r0.x < 2.26303411);
      if (r1.x != 0) {
        r1.x = r0.x * 0.30103001 + 2.54062366;
        r1.y = 2.17265487 * r1.x;
        r1.z = (int)r1.y;
        r1.y = trunc(r1.y);
        r3.y = r1.x * 2.17265487 + -r1.y;
  ...
  ColorGradingGenerateRRTODTLUT_Output[vThreadID] = r2;  // store_uav_typed u1.xyzw, vThreadID.xyzz, r2.xyzw
  return;
}
