...
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntry(0x60F0256B),  // Tonemap
    CustomShaderEntry(0x478E345C),  // TAA
    CustomShaderEntry(0x50BE35B0),  // Cutscene
};
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Granblue Fantasy Relink";
