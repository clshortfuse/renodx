// ---- Created with 3Dmigoto v1.3.16 on Tue Jul 23 02:31:51 2024
#include "./shared.h"
  ...
  out float4 o0 : SV_Target0)
{
  ...
  //We dont need the below code, so we skip it and make our own output
  o0.xyz = r0.xyz;
  o0.w = 1;
  return;
    
  //all below vanilla code is skipped
    /*
  r0.xyz = log2(abs(r0.xyz));
  r0.xyz = fGamma * r0.xyz; //2.2 gamma
  r0.xyz = exp2(r0.xyz);
  //hable
