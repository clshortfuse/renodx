  ...
  if (RENODX_TONE_MAP_TYPE == 0.f) {
    ...
    if (RENODX_TONE_MAP_TYPE == 2.f) {  // Psycho
      ...
      untonemapped_bt2020 = renodx_custom::tonemap::psycho::psycho11_GradeBT2020(
          ...
          0.10f * pow(RENODX_TONE_MAP_FLARE, 10.f), RENODX_TONE_MAP_CONTRAST_HIGHLIGHTS, RENODX_TONE_MAP_CONTRAST_SHADOWS, 0.1f, RENODX_TONE_MAP_SATURATION, RENODX_TONE_MAP_ADAPTATION_CONTRAST, 1.f, 0.f);
