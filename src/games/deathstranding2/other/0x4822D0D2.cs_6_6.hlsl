...
void main(
  ...
  if (_23 == 1) {
    do {
      ...
      do {
        ...
        do {
          ...
          float _62 = 1.0f / ShaderInstance_PerInstance_000.ShaderInstance_PerInstance_Constants_000.InUniform_Constant_032.x;
    ...
    if (_23 == 2) {
      ...
      float _102 = 1.0f / ShaderInstance_PerInstance_000.ShaderInstance_PerInstance_Constants_000.InUniform_Constant_032.x;
      float _115 = 1.0f / ShaderInstance_PerInstance_000.ShaderInstance_PerInstance_Constants_000.InUniform_Constant_032.y;
