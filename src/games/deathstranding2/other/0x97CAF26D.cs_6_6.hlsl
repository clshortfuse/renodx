...
void main(
  ...
  float3 _12 = t0_space8.Load(int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), 0));
  int _16 = int(ShaderInstance_PerInstance_000.ShaderInstance_PerInstance_Constants_000.InUniform_Constant_016.w);
  float _42;
  float _54;
  float _120;
  float _121;
  ...
  [branch]
  if (_16 == 1) {
    float _28 = exp2(log2(abs(_12.x)) * ShaderInstance_PerInstance_000.ShaderInstance_PerInstance_Constants_000.InUniform_Constant_016.x);
    float _29 = exp2(log2(abs(_12.y)) * ShaderInstance_PerInstance_000.ShaderInstance_PerInstance_Constants_000.InUniform_Constant_016.x);
    float _30 = exp2(log2(abs(_12.z)) * ShaderInstance_PerInstance_000.ShaderInstance_PerInstance_Constants_000.InUniform_Constant_016.x);
    do {
      if (_28 < 0.003100000089034438f) {
        _42 = (_28 * 12.920000076293945f);
      } else {
        _42 = ((exp2(log2(abs(_28)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f);
      }
      do {
        if (_29 < 0.003100000089034438f) {
          _54 = (_29 * 12.920000076293945f);
        } else {
          _54 = ((exp2(log2(abs(_29)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f);
        }
        if (_30 < 0.003100000089034438f) {
          _120 = _42;
          _121 = _54;
          _122 = (_30 * 12.920000076293945f);
        } else {
          _120 = _42;
          _121 = _54;
          _122 = ((exp2(log2(abs(_30)) * 0.4166666567325592f) * 1.0549999475479126f) + -0.054999999701976776f);
        }
      } while (false);
    } while (false);
  } else {
  ...
  u0_space8[int2((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y))] = float3(_120, _121, _122);
}
