...
void main(
  ...
  if ((abs(cb0_037y + -6500.0f) > 9.99999993922529e-09f) | (abs(cb0_037z) > 9.99999993922529e-09f)) {
    ...
    _292 = mad(_271, (WorkingColorSpace_000[2].x), mad(_268, (WorkingColorSpace_000[1].x), (_265 * (WorkingColorSpace_000[0].x))));
    _295 = mad(_271, (WorkingColorSpace_000[2].y), mad(_268, (WorkingColorSpace_000[1].y), (_265 * (WorkingColorSpace_000[0].y))));
    _298 = mad(_271, (WorkingColorSpace_000[2].z), mad(_268, (WorkingColorSpace_000[1].z), (_265 * (WorkingColorSpace_000[0].z))));
    _336 = mad(mad((WorkingColorSpace_064[0].z), _298, mad((WorkingColorSpace_064[0].y), _289, (_280 * (WorkingColorSpace_064[0].x)))), _74, mad(mad((WorkingColorSpace_064[0].z), _295, mad((WorkingColorSpace_064[0].y), _286, (_277 * (WorkingColorSpace_064[0].x)))), _73, (mad((WorkingColorSpace_064[0].z), _292, mad((WorkingColorSpace_064[0].y), _283, (_274 * (WorkingColorSpace_064[0].x)))) * _72)));
    _337 = mad(mad((WorkingColorSpace_064[1].z), _298, mad((WorkingColorSpace_064[1].y), _289, (_280 * (WorkingColorSpace_064[1].x)))), _74, mad(mad((WorkingColorSpace_064[1].z), _295, mad((WorkingColorSpace_064[1].y), _286, (_277 * (WorkingColorSpace_064[1].x)))), _73, (mad((WorkingColorSpace_064[1].z), _292, mad((WorkingColorSpace_064[1].y), _283, (_274 * (WorkingColorSpace_064[1].x)))) * _72)));
    _338 = mad(mad((WorkingColorSpace_064[2].z), _298, mad((WorkingColorSpace_064[2].y), _289, (_280 * (WorkingColorSpace_064[2].x)))), _74, mad(mad((WorkingColorSpace_064[2].z), _295, mad((WorkingColorSpace_064[2].y), _286, (_277 * (WorkingColorSpace_064[2].x)))), _73, (mad((WorkingColorSpace_064[2].z), _292, mad((WorkingColorSpace_064[2].y), _283, (_274 * (WorkingColorSpace_064[2].x)))) * _72)));
  } else {
    _336 = _72;
    _337 = _73;
    _338 = _74;
  }
  _353 = mad((WorkingColorSpace_128[0].z), _338, mad((WorkingColorSpace_128[0].y), _337, ((WorkingColorSpace_128[0].x) * _336)));
  _356 = mad((WorkingColorSpace_128[1].z), _338, mad((WorkingColorSpace_128[1].y), _337, ((WorkingColorSpace_128[1].x) * _336)));
  _359 = mad((WorkingColorSpace_128[2].z), _338, mad((WorkingColorSpace_128[2].y), _337, ((WorkingColorSpace_128[2].x) * _336)));
  _360 = dot(float3(_353, _356, _359), float3(0.2722287178039551f, 0.6740817427635193f, 0.053689517080783844f));
  _364 = (_353 / _360) + -1.0f;
  _365 = (_356 / _360) + -1.0f;
  _366 = (_359 / _360) + -1.0f;
  _378 = (1.0f - exp2(((_360 * _360) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_364, _365, _366), float3(_364, _365, _366)) * -4.0f));
  _394 = ((mad(-0.06368321925401688f, _359, mad(-0.3292922377586365f, _356, (_353 * 1.3704125881195068f))) - _353) * _378) + _353;
  _395 = ((mad(-0.010861365124583244f, _359, mad(1.0970927476882935f, _356, (_353 * -0.08343357592821121f))) - _356) * _378) + _356;
  _396 = ((mad(1.2036951780319214f, _359, mad(-0.09862580895423889f, _356, (_353 * -0.02579331398010254f))) - _359) * _378) + _359;
  ...
  float4 output = ProcessLutbuilder(float3(_761, _763, _765), s0, t0, cb_config, u0[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))], 0u);
  ...
  _1129 = saturate(max(0.0f, mad((WorkingColorSpace_192[0].z), _1104, mad((WorkingColorSpace_192[0].y), _1103, ((WorkingColorSpace_192[0].x) * _1102)))));
  _1130 = saturate(max(0.0f, mad((WorkingColorSpace_192[1].z), _1104, mad((WorkingColorSpace_192[1].y), _1103, ((WorkingColorSpace_192[1].x) * _1102)))));
  _1131 = saturate(max(0.0f, mad((WorkingColorSpace_192[2].z), _1104, mad((WorkingColorSpace_192[2].y), _1103, ((WorkingColorSpace_192[2].x) * _1102)))));
  ...
  _1168 = (_1153 * 0.9375f) + 0.03125f;
  _1175 = _1164 * 15.0f;
  _1176 = floor(_1175);
  _1177 = _1175 - _1176;
  _1179 = (((_1142 * 0.9375f) + 0.03125f) + _1176) * 0.0625f;
  _1182 = t0.SampleLevel(s0, float2(_1179, _1168), 0.0f);
  _1187 = t0.SampleLevel(s0, float2((_1179 + 0.0625f), _1168), 0.0f);
  _1203 = ((lerp(_1182.x, _1187.x, _1177)) * cb0_005y) + (cb0_005x * _1142);
  _1204 = ((lerp(_1182.y, _1187.y, _1177)) * cb0_005y) + (cb0_005x * _1153);
  _1205 = ((lerp(_1182.z, _1187.z, _1177)) * cb0_005y) + (cb0_005x * _1164);
  _1230 = select((_1203 > 0.040449999272823334f), exp2(log2((abs(_1203) * 0.9478672742843628f) + 0.05213269963860512f) * 2.4000000953674316f), (_1203 * 0.07739938050508499f));
  _1231 = select((_1204 > 0.040449999272823334f), exp2(log2((abs(_1204) * 0.9478672742843628f) + 0.05213269963860512f) * 2.4000000953674316f), (_1204 * 0.07739938050508499f));
  _1232 = select((_1205 > 0.040449999272823334f), exp2(log2((abs(_1205) * 0.9478672742843628f) + 0.05213269963860512f) * 2.4000000953674316f), (_1205 * 0.07739938050508499f));
  _1258 = cb0_016x * (((cb0_041y + (cb0_041x * _1230)) * _1230) + cb0_041z);
  _1259 = cb0_016y * (((cb0_041y + (cb0_041x * _1231)) * _1231) + cb0_041z);
  _1260 = cb0_016z * (((cb0_041y + (cb0_041x * _1232)) * _1232) + cb0_041z);
  _1281 = exp2(log2(max(0.0f, (lerp(_1258, cb0_015x, cb0_015w)))) * cb0_042y);
  _1282 = exp2(log2(max(0.0f, (lerp(_1259, cb0_015y, cb0_015w)))) * cb0_042y);
  _1283 = exp2(log2(max(0.0f, (lerp(_1260, cb0_015z, cb0_015w)))) * cb0_042y);
  if (WorkingColorSpace_384 == 0) {
    _1290 = mad((WorkingColorSpace_128[0].z), _1283, mad((WorkingColorSpace_128[0].y), _1282, ((WorkingColorSpace_128[0].x) * _1281)));
    _1293 = mad((WorkingColorSpace_128[1].z), _1283, mad((WorkingColorSpace_128[1].y), _1282, ((WorkingColorSpace_128[1].x) * _1281)));
    _1296 = mad((WorkingColorSpace_128[2].z), _1283, mad((WorkingColorSpace_128[2].y), _1282, ((WorkingColorSpace_128[2].x) * _1281)));
  ...
  u0[int3((int)(SV_DispatchThreadID.x), (int)(SV_DispatchThreadID.y), (int)(SV_DispatchThreadID.z))] = float4((_1320 * 0.9523810148239136f), (_1331 * 0.9523810148239136f), (_1342 * 0.9523810148239136f), 0.0f);
}