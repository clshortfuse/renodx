...
void main(
  ...
  _392 = ((mad(-0.06368321925401688f, _357, mad(-0.3292922377586365f, _354, (_351 * 1.3704125881195068f))) - _351) * _376) + _351;
  _393 = ((mad(-0.010861365124583244f, _357, mad(1.0970927476882935f, _354, (_351 * -0.08343357592821121f))) - _354) * _376) + _354;
  _394 = ((mad(1.2036951780319214f, _357, mad(-0.09862580895423889f, _354, (_351 * -0.02579331398010254f))) - _357) * _376) + _357;
  _395 = dot(float3(_392, _393, _394), float3(0.2722287178039551f, 0.6740817427635193f, 0.053689517080783844f));
  _409 = cb0_021w + cb0_026w;
  _423 = cb0_020w * cb0_025w;
  ...
  float4 output = ProcessLutbuilder(float3(_759, _761, _763), cb_config, u0[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))], 0u);
  u0[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))] = output;
  return;

  _778 = ((mad(0.061360642313957214f, _763, mad(-4.540197551250458e-09f, _761, (_759 * 0.9386394023895264f))) - _759) * cb0_038z) + _759;
  _779 = ((mad(0.169205904006958f, _763, mad(0.8307942152023315f, _761, (_759 * 6.775371730327606e-08f))) - _761) * cb0_038z) + _761;
  _780 = (mad(-2.3283064365386963e-10f, _761, (_759 * -9.313225746154785e-10f)) * cb0_038z) + _763;
  _783 = mad(0.16386905312538147f, _780, mad(0.14067868888378143f, _779, (_778 * 0.6954522132873535f)));
  _786 = mad(0.0955343246459961f, _780, mad(0.8596711158752441f, _779, (_778 * 0.044794581830501556f)));
  _789 = mad(1.0015007257461548f, _780, mad(0.004025210160762072f, _779, (_778 * -0.005525882821530104f)));
  _793 = max(max(_783, _786), _789);
  _798 = (max(_793, 1.000000013351432e-10f) - max(min(min(_783, _786), _789), 1.000000013351432e-10f)) / max(_793, 0.009999999776482582f);
  _811 = ((_786 + _783) + _789) + (sqrt((((_789 - _786) * _789) + ((_786 - _783) * _786)) + ((_783 - _789) * _783)) * 1.75f);
  _812 = _811 * 0.3333333432674408f;
  _813 = _798 + -0.4000000059604645f;
  _814 = _813 * 5.0f;
  _818 = max((1.0f - abs(_813 * 2.5f)), 0.0f);
  _829 = ((float((int)(((int)(uint)((int)(_814 > 0.0f))) - ((int)(uint)((int)(_814 < 0.0f))))) * (1.0f - (_818 * _818))) + 1.0f) * 0.02500000037252903f;
  ...
  _841 = _839 * _786;
  _842 = _839 * _789;
  if (!((_840 == _841) && (_841 == _842))) {
    _849 = ((_840 * 2.0f) - _841) - _842;
    _852 = ((_786 - _789) * 1.7320507764816284f) * _839;
    _854 = atan(_852 / _849);
    _857 = (_849 < 0.0f);
    _858 = (_849 == 0.0f);
    _859 = (_852 >= 0.0f);
  ...
  _876 = min(max(select((_871 < 0.0f), (_871 + 360.0f), _871), 0.0f), 360.0f);
  if (_876 < -180.0f) {
    _885 = (_876 + 360.0f);
  } else {
    if (_876 > 180.0f) {
  ...
  _889 = saturate(1.0f - abs(_885 * 0.014814814552664757f));
  _893 = (_889 * _889) * (3.0f - (_889 * 2.0f));
  _899 = ((_893 * _893) * ((_798 * 0.18000000715255737f) * (0.029999999329447746f - _840))) + _840;
  _909 = max(0.0f, mad(-0.21492856740951538f, _842, mad(-0.2365107536315918f, _841, (_899 * 1.4514392614364624f))));
  _910 = max(0.0f, mad(-0.09967592358589172f, _842, mad(1.17622971534729f, _841, (_899 * -0.07655377686023712f))));
  _911 = max(0.0f, mad(0.9977163076400757f, _842, mad(-0.006032449658960104f, _841, (_899 * 0.008316148072481155f))));
  _912 = dot(float3(_909, _910, _911), float3(0.2722287178039551f, 0.6740817427635193f, 0.053689517080783844f));
  _927 = (cb0_040x + 1.0f) - cb0_039z;
  _929 = cb0_040y + 1.0f;
  _931 = _929 - cb0_039w;
  if (cb0_039z > 0.800000011920929f) {
    _949 = (((0.8199999928474426f - cb0_039z) / cb0_039y) + -0.7447274923324585f);
  } else {
    _940 = (cb0_040x + 0.18000000715255737f) / _927;
    _949 = (-0.7447274923324585f - ((log2(_940 / (2.0f - _940)) * 0.3465735912322998f) * (_927 / cb0_039y)));
  }
  _952 = ((1.0f - cb0_039z) / cb0_039y) - _949;
  _954 = (cb0_039w / cb0_039y) - _952;
  _958 = log2(lerp(_912, _909, 0.9599999785423279f)) * 0.3010300099849701f;
  _959 = log2(lerp(_912, _910, 0.9599999785423279f)) * 0.3010300099849701f;
  _960 = log2(lerp(_912, _911, 0.9599999785423279f)) * 0.3010300099849701f;
  _964 = cb0_039y * (_958 + _952);
  _965 = cb0_039y * (_959 + _952);
  _966 = cb0_039y * (_960 + _952);
  _967 = _927 * 2.0f;
  _969 = (cb0_039y * -2.0f) / _927;
  _970 = _958 - _949;
  _971 = _959 - _949;
  _972 = _960 - _949;
  _991 = _931 * 2.0f;
  _993 = (cb0_039y * 2.0f) / _931;
  _1018 = select((_958 < _949), ((_967 / (exp2((_970 * 1.4426950216293335f) * _969) + 1.0f)) - cb0_040x), _964);
  _1019 = select((_959 < _949), ((_967 / (exp2((_971 * 1.4426950216293335f) * _969) + 1.0f)) - cb0_040x), _965);
  _1020 = select((_960 < _949), ((_967 / (exp2((_972 * 1.4426950216293335f) * _969) + 1.0f)) - cb0_040x), _966);
  _1027 = _954 - _949;
  _1031 = saturate(_970 / _1027);
  _1032 = saturate(_971 / _1027);
  _1033 = saturate(_972 / _1027);
  _1034 = (_954 < _949);
  _1038 = select(_1034, (1.0f - _1031), _1031);
  _1039 = select(_1034, (1.0f - _1032), _1032);
  _1040 = select(_1034, (1.0f - _1033), _1033);
  _1059 = (((_1038 * _1038) * (select((_958 > _954), (_929 - (_991 / (exp2(((_958 - _954) * 1.4426950216293335f) * _993) + 1.0f))), _964) - _1018)) * (3.0f - (_1038 * 2.0f))) + _1018;
  _1060 = (((_1039 * _1039) * (select((_959 > _954), (_929 - (_991 / (exp2(((_959 - _954) * 1.4426950216293335f) * _993) + 1.0f))), _965) - _1019)) * (3.0f - (_1039 * 2.0f))) + _1019;
  _1061 = (((_1040 * _1040) * (select((_960 > _954), (_929 - (_991 / (exp2(((_960 - _954) * 1.4426950216293335f) * _993) + 1.0f))), _966) - _1020)) * (3.0f - (_1040 * 2.0f))) + _1020;
  _1062 = dot(float3(_1059, _1060, _1061), float3(0.2722287178039551f, 0.6740817427635193f, 0.053689517080783844f));
  _1082 = (cb0_039x * (max(0.0f, (lerp(_1062, _1059, 0.9300000071525574f))) - _778)) + _778;
  _1083 = (cb0_039x * (max(0.0f, (lerp(_1062, _1060, 0.9300000071525574f))) - _779)) + _779;
  _1084 = (cb0_039x * (max(0.0f, (lerp(_1062, _1061, 0.9300000071525574f))) - _780)) + _780;
  _1100 = ((mad(-0.06537103652954102f, _1084, mad(1.451815478503704e-06f, _1083, (_1082 * 1.065374732017517f))) - _1082) * cb0_038z) + _1082;
  _1101 = ((mad(-0.20366770029067993f, _1084, mad(1.2036634683609009f, _1083, (_1082 * -2.57161445915699e-07f))) - _1083) * cb0_038z) + _1083;
  _1102 = ((mad(0.9999996423721313f, _1084, mad(2.0954757928848267e-08f, _1083, (_1082 * 1.862645149230957e-08f))) - _1084) * cb0_038z) + _1084;
  _1124 = max(0.0f, mad((WorkingColorSpace_192[0].z), _1102, mad((WorkingColorSpace_192[0].y), _1101, ((WorkingColorSpace_192[0].x) * _1100))));
  _1125 = max(0.0f, mad((WorkingColorSpace_192[1].z), _1102, mad((WorkingColorSpace_192[1].y), _1101, ((WorkingColorSpace_192[1].x) * _1100))));
  _1126 = max(0.0f, mad((WorkingColorSpace_192[2].z), _1102, mad((WorkingColorSpace_192[2].y), _1101, ((WorkingColorSpace_192[2].x) * _1100))));
  _1152 = cb0_016x * (((cb0_041y + (cb0_041x * _1124)) * _1124) + cb0_041z);
  _1153 = cb0_016y * (((cb0_041y + (cb0_041x * _1125)) * _1125) + cb0_041z);
  _1154 = cb0_016z * (((cb0_041y + (cb0_041x * _1126)) * _1126) + cb0_041z);
  _1175 = exp2(log2(max(0.0f, (lerp(_1152, cb0_015x, cb0_015w)))) * cb0_042y);
  _1176 = exp2(log2(max(0.0f, (lerp(_1153, cb0_015y, cb0_015w)))) * cb0_042y);
  _1177 = exp2(log2(max(0.0f, (lerp(_1154, cb0_015z, cb0_015w)))) * cb0_042y);
  if (WorkingColorSpace_384 == 0) {
    _1184 = mad((WorkingColorSpace_128[0].z), _1177, mad((WorkingColorSpace_128[0].y), _1176, ((WorkingColorSpace_128[0].x) * _1175)));
    _1187 = mad((WorkingColorSpace_128[1].z), _1177, mad((WorkingColorSpace_128[1].y), _1176, ((WorkingColorSpace_128[1].x) * _1175)));
    _1190 = mad((WorkingColorSpace_128[2].z), _1177, mad((WorkingColorSpace_128[2].y), _1176, ((WorkingColorSpace_128[2].x) * _1175)));
  ...
  u0[int3((int)(SV_DispatchThreadID.x), (int)(SV_DispatchThreadID.y), (int)(SV_DispatchThreadID.z))] = float4((_1214 * 0.9523810148239136f), (_1225 * 0.9523810148239136f), (_1236 * 0.9523810148239136f), 0.0f);
}