...
// scRGB composite shader?
// Used in Chernobylite Native HDR (DX11)
...
void main(
  ...
  r1.xyz = LinearSceneToPq(r1.xyz);  // Convert scene to PQ

  if (HandleUICompositing(r0, r1, o0, v0.xy, t1, s1_s, 1u)) {
    return;
  }
