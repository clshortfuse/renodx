// Found in Marvel's Midnight Suns
// UE 4.26.2.0 HDR10 Native HDR

#include "./composite.hlsli"

// ---- Created with 3Dmigoto v1.4.1 on Fri Feb 20 19:48:55 2026
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.x = dot(cb0[16].xyz, r0.xyz);
  r1.y = dot(cb0[17].xyz, r0.xyz);
  r1.z = dot(cb0[18].xyz, r0.xyz);
