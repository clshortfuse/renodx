...
float4 main(
  ...
  if ((bool)(_10.w > 0.0f) && (bool)(_10.w < 1.0f)) {
    ...
    float _112 = ((((1.0f / ((dot(float3(_102, _103, _104), float3(0.26269999146461487f, 0.6779999732971191f, 0.059300001710653305f)) / cb0_007z) + 1.0f)) * cb0_007z) + -1.0f) * _10.w) + 1.0f;
    _117 = (_112 * _102);
    _118 = (_112 * _103);
    _119 = (_112 * _104);
  } else {
  ...
  SV_Target.x = (((_117 * _120) + ((cb0_007w * mad(0.04330150783061981f, _41, mad(0.32926714420318604f, _40, (_39 * 0.6274880170822144f)))) * cb0_007z)) * 0.012500000186264515f);
  SV_Target.y = (((_118 * _120) + ((cb0_007w * mad(0.011359544470906258f, _41, mad(0.9195171594619751f, _40, (_39 * 0.06910824030637741f)))) * cb0_007z)) * 0.012500000186264515f);
  SV_Target.z = (((_119 * _120) + ((cb0_007w * mad(0.8954997062683105f, _41, mad(0.08802297711372375f, _40, (_39 * 0.016396233811974525f)))) * cb0_007z)) * 0.012500000186264515f);
  SV_Target.w = 1.0f;
  return SV_Target;
}
