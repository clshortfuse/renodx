...
struct FWorkingColorSpaceConstants {
  ...
  int FWorkingColorSpaceConstants_320;
};
...
float4 main(
  ...
  float _255 = mad(_234, (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[2].x), mad(_231, (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[1].x), (_228 * (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[0].x))));
  float _258 = mad(_234, (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[2].y), mad(_231, (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[1].y), (_228 * (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[0].y))));
  float _261 = mad(_234, (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[2].z), mad(_231, (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[1].z), (_228 * (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[0].z))));
  float _264 = mad(_243, (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[2].x), mad(_240, (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[1].x), (_237 * (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[0].x))));
  float _267 = mad(_243, (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[2].y), mad(_240, (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[1].y), (_237 * (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[0].y))));
  float _270 = mad(_243, (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[2].z), mad(_240, (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[1].z), (_237 * (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[0].z))));
  float _273 = mad(_252, (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[2].x), mad(_249, (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[1].x), (_246 * (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[0].x))));
  float _276 = mad(_252, (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[2].y), mad(_249, (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[1].y), (_246 * (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[0].y))));
  float _279 = mad(_252, (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[2].z), mad(_249, (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[1].z), (_246 * (WorkingColorSpace_000.FWorkingColorSpaceConstants_000[0].z))));
  float _309 = mad(mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_064[0].z), _279, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_064[0].y), _270, (_261 * (WorkingColorSpace_000.FWorkingColorSpaceConstants_064[0].x)))), _62, mad(mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_064[0].z), _276, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_064[0].y), _267, (_258 * (WorkingColorSpace_000.FWorkingColorSpaceConstants_064[0].x)))), _61, (mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_064[0].z), _273, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_064[0].y), _264, (_255 * (WorkingColorSpace_000.FWorkingColorSpaceConstants_064[0].x)))) * _60)));
  float _312 = mad(mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_064[1].z), _279, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_064[1].y), _270, (_261 * (WorkingColorSpace_000.FWorkingColorSpaceConstants_064[1].x)))), _62, mad(mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_064[1].z), _276, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_064[1].y), _267, (_258 * (WorkingColorSpace_000.FWorkingColorSpaceConstants_064[1].x)))), _61, (mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_064[1].z), _273, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_064[1].y), _264, (_255 * (WorkingColorSpace_000.FWorkingColorSpaceConstants_064[1].x)))) * _60)));
  float _315 = mad(mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_064[2].z), _279, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_064[2].y), _270, (_261 * (WorkingColorSpace_000.FWorkingColorSpaceConstants_064[2].x)))), _62, mad(mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_064[2].z), _276, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_064[2].y), _267, (_258 * (WorkingColorSpace_000.FWorkingColorSpaceConstants_064[2].x)))), _61, (mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_064[2].z), _273, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_064[2].y), _264, (_255 * (WorkingColorSpace_000.FWorkingColorSpaceConstants_064[2].x)))) * _60)));
  float _330 = mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_128[0].z), _315, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_128[0].y), _312, ((WorkingColorSpace_000.FWorkingColorSpaceConstants_128[0].x) * _309)));
  float _333 = mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_128[1].z), _315, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_128[1].y), _312, ((WorkingColorSpace_000.FWorkingColorSpaceConstants_128[1].x) * _309)));
  float _336 = mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_128[2].z), _315, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_128[2].y), _312, ((WorkingColorSpace_000.FWorkingColorSpaceConstants_128[2].x) * _309)));
  ...
  SV_Target = ProcessLutbuilder(float3(_738, _740, _742), cb_config, SV_Target, 0u);
  return SV_Target;
  ...
  float _808 = ((float((int)(((int)(uint)((bool)(_793 > 0.0f))) - ((int)(uint)((bool)(_793 < 0.0f))))) * (1.0f - (_797 * _797))) + 1.0f) * 0.02500000037252903f;
  ...
  float _1103 = max(0.0f, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_192[0].z), _1081, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_192[0].y), _1080, ((WorkingColorSpace_000.FWorkingColorSpaceConstants_192[0].x) * _1079))));
  float _1104 = max(0.0f, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_192[1].z), _1081, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_192[1].y), _1080, ((WorkingColorSpace_000.FWorkingColorSpaceConstants_192[1].x) * _1079))));
  float _1105 = max(0.0f, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_192[2].z), _1081, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_192[2].y), _1080, ((WorkingColorSpace_000.FWorkingColorSpaceConstants_192[2].x) * _1079))));
  ...
  if (WorkingColorSpace_000.FWorkingColorSpaceConstants_320 == 0) {
    float _1163 = mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_128[0].z), _1156, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_128[0].y), _1155, ((WorkingColorSpace_000.FWorkingColorSpaceConstants_128[0].x) * _1154)));
    float _1166 = mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_128[1].z), _1156, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_128[1].y), _1155, ((WorkingColorSpace_000.FWorkingColorSpaceConstants_128[1].x) * _1154)));
    float _1169 = mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_128[2].z), _1156, mad((WorkingColorSpace_000.FWorkingColorSpaceConstants_128[2].y), _1155, ((WorkingColorSpace_000.FWorkingColorSpaceConstants_128[2].x) * _1154)));
