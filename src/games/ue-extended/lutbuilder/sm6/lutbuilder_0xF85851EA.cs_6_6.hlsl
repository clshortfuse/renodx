...
void main(
  ...
  float4 output = ProcessLutbuilder(float3(_750, _752, _754), Samplers_1, Textures_1, cb_config, RWOutputTexture[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))], 0u);
