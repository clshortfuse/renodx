...
float4 main(
  ...
  float _1129 = (cb0_036w * (max(0.0f, (lerp(_1109, _1106, 0.9300000071525574f))) - _825)) + _825;
  float _1130 = (cb0_036w * (max(0.0f, (lerp(_1109, _1107, 0.9300000071525574f))) - _826)) + _826;
  float _1131 = (cb0_036w * (max(0.0f, (lerp(_1109, _1108, 0.9300000071525574f))) - _827)) + _827;
