// Found in Neverness To Everness, UE 5.6.1
...
float4 main(
  ...
  if (!(abs(cb0_037y + -6500.0f) > 9.99999993922529e-09f)) {
    ...
    if (!(abs(cb0_037z) > 9.99999993922529e-09f)) {
      ...
      SV_Target = ProcessLutbuilder(float3(_808, _810, _812), s0, t0, cb_config, SV_Target, asuint(cb0_044w));
      return SV_Target;
              ...
              do {
                ...
                do {
                  ...
                  do {
                    ...
                    float _1316 = cb0_016x * (((cb0_043y + (cb0_043x * _1288)) * _1288) + cb0_043z);
                    float _1317 = cb0_016y * (((cb0_043y + (cb0_043x * _1289)) * _1289) + cb0_043z);
                    float _1318 = cb0_016z * (((cb0_043y + (cb0_043x * _1290)) * _1290) + cb0_043z);
                    ...
                    float _1351 = exp2(log2(max(0.0f, _1325)) * cb0_044y);
                    float _1352 = exp2(log2(max(0.0f, _1326)) * cb0_044y);
                    float _1353 = exp2(log2(max(0.0f, _1327)) * cb0_044y);
                    do {
                      [branch]
                      if (cb0_044w == 0) {
                        do {
                              ...
                              if (cb0_044w == 7) {
                                ...
                                if (!(cb0_044w == 8)) {
                                  if (cb0_044w == 9) {
                                    ...
                                    _2968 = exp2(log2(mad(_55, _2947, mad(_54, _2944, (_2941 * _53)))) * cb0_044z);
                                    _2969 = exp2(log2(mad(_58, _2947, mad(_57, _2944, (_2941 * _56)))) * cb0_044z);
                                    _2970 = exp2(log2(mad(_61, _2947, mad(_60, _2944, (_2941 * _59)))) * cb0_044z);
                                  }
                                } else {
                                  _2968 = _1337;
                                  _2969 = _1338;
