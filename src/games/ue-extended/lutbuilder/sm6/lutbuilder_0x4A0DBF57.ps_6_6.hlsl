...
float4 main(
  ...
  float _913 = saturate(max(0.0f, mad((WorkingColorSpace.FromAP1[0].z), _900, mad((WorkingColorSpace.FromAP1[0].y), _899, ((WorkingColorSpace.FromAP1[0].x) * _898)))));
  float _914 = saturate(max(0.0f, mad((WorkingColorSpace.FromAP1[1].z), _900, mad((WorkingColorSpace.FromAP1[1].y), _899, ((WorkingColorSpace.FromAP1[1].x) * _898)))));
  float _915 = saturate(max(0.0f, mad((WorkingColorSpace.FromAP1[2].z), _900, mad((WorkingColorSpace.FromAP1[2].y), _899, ((WorkingColorSpace.FromAP1[2].x) * _898)))));
                  ...
                  do {
                    if (!(!(_1550 <= _1552))) {
                      ...
                      if ((bool)(_1550 > _1552) && (bool)(_1550 < _1560)) {
                        ...
                        int _1569 = int(_1568);
                        float _1571 = _1568 - float((int)(_1569));
                        ...
                        do {
                          if (!(!(_1550 >= _1560))) {
                            ...
                            if (_1550 < (_1590 * 0.3010300099849701f)) {
                              ...
                              int _1599 = int(_1598);
                              float _1601 = _1598 - float((int)(_1599));
                          ...
                          do {
                            if (!(!(_1626 >= _1634))) {
                              ...
                              if (_1626 < (_1664 * 0.3010300099849701f)) {
                                ...
                                int _1673 = int(_1672);
                                float _1675 = _1672 - float((int)(_1673));
                      ...
                      do {
                        if (!(!(_1700 <= _1552))) {
                          ...
                          if ((bool)(_1700 > _1552) && (bool)(_1700 < _1708)) {
                            ...
                            int _1717 = int(_1716);
                            float _1719 = _1716 - float((int)(_1717));
                          ...
                          do {
                            if (!(!(_2224 >= _2234))) {
                              ...
                              if (_2224 < (_2264 * 0.3010300099849701f)) {
                                ...
                                int _2273 = int(_2272);
                                float _2275 = _2272 - float((int)(_2273));
                            ...
                            do {
                              if (!(!(_2300 >= _2308))) {
                                ...
                                if (_2300 < (_2338 * 0.3010300099849701f)) {
                                  ...
                                  int _2347 = int(_2346);
                                  float _2349 = _2346 - float((int)(_2347));
