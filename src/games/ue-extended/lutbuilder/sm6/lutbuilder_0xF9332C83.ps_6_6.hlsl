// Found in Clair 33, Tempest Rising, generic UE shader
...
float4 main(
  ...
  SV_Target = ProcessLutbuilder(float3(_487, _489, _491), Samplers_1, Textures_1, cb_config, SV_Target, 0u);
  return SV_Target;
  ...
  float _557 = ((float((int)(((int)(uint)((bool)(_542 > 0.0f))) - ((int)(uint)((bool)(_542 < 0.0f))))) * (1.0f - (_546 * _546))) + 1.0f) * 0.02500000037252903f;
  ...
  float _857 = saturate(max(0.0f, mad((WorkingColorSpace.FromAP1[2].z), _830, mad((WorkingColorSpace.FromAP1[2].y), _829, ((WorkingColorSpace.FromAP1[2].x) * _828)))));
