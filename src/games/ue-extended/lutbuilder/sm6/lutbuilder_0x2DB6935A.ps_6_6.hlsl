...
float4 main(
  ...
  float _32 = float((uint)(int)(SV_RenderTargetArrayIndex)) / _28;
  float _52;
  float _53;
  float _54;
  float _55;
  ...
  bool _147 = (bIsTemperatureWhiteBalance != 0);
  ...
  float _413 = (1.0f - exp2(((_395 * _395) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_399, _400, _401), float3(_399, _400, _401)) * -4.0f));
  ...
  SV_Target = ProcessLutbuilder(float3(_796, _798, _800), Samplers_1, Textures_1, cb_config, SV_Target, OutputDevice);
  return SV_Target;
  ...
  float _887 = ((float((int)(((int)(uint)((bool)(_872 > 0.0f))) - ((int)(uint)((bool)(_872 < 0.0f))))) * (1.0f - (_876 * _876))) + 1.0f) * 0.02500000037252903f;
    ...
    if (OutputDevice == 1) {
      ...
      if ((bool)(OutputDevice == 3) || (bool)(OutputDevice == 5)) {
        ...
        do {
          ...
          float _1676 = ((float((int)(((int)(uint)((bool)(_1661 > 0.0f))) - ((int)(uint)((bool)(_1661 < 0.0f))))) * (1.0f - (_1665 * _1665))) + 1.0f) * 0.02500000037252903f;
          do {
                  ...
                  do {
                    if (!(!(_1816 <= _1818))) {
                      ...
                      if ((bool)(_1816 > _1818) && (bool)(_1816 < _1826)) {
                        ...
                        int _1835 = int(_1834);
                        float _1837 = _1834 - float((int)(_1835));
                        ...
                        do {
                          if (!(!(_1816 >= _1826))) {
                            ...
                            if (_1816 < (_1856 * 0.3010300099849701f)) {
                              ...
                              int _1865 = int(_1864);
                              float _1867 = _1864 - float((int)(_1865));
                    ...
                    do {
                      if (!(!(_1904 <= _1818))) {
                        ...
                        if ((bool)(_1904 > _1818) && (bool)(_1904 < _1912)) {
                          ...
                          int _1921 = int(_1920);
                          float _1923 = _1920 - float((int)(_1921));
                          ...
                          do {
                            if (!(!(_1904 >= _1912))) {
                              ...
                              if (_1904 < (_1942 * 0.3010300099849701f)) {
                                ...
                                int _1951 = int(_1950);
                                float _1953 = _1950 - float((int)(_1951));
                      ...
                      do {
                        if (!(!(_1978 <= _1818))) {
                          ...
                          if ((bool)(_1978 > _1818) && (bool)(_1978 < _1986)) {
                            ...
                            int _1995 = int(_1994);
                            float _1997 = _1994 - float((int)(_1995));
                            ...
                            do {
                              if (!(!(_1978 >= _1986))) {
                                ...
                                if (_1978 < (_2016 * 0.3010300099849701f)) {
                                  ...
                                  int _2025 = int(_2024);
                                  float _2027 = _2024 - float((int)(_2025));
        ...
        if ((OutputDevice & -3) == 4) {
          ...
          do {
            ...
            float _2356 = ((float((int)(((int)(uint)((bool)(_2341 > 0.0f))) - ((int)(uint)((bool)(_2341 < 0.0f))))) * (1.0f - (_2345 * _2345))) + 1.0f) * 0.02500000037252903f;
            do {
                          ...
                          do {
                            if (!(!(_2502 >= _2512))) {
                              ...
                              if (_2502 < (_2542 * 0.3010300099849701f)) {
                                ...
                                int _2551 = int(_2550);
                                float _2553 = _2550 - float((int)(_2551));
                            ...
                            do {
                              if (!(!(_2590 >= _2598))) {
                                ...
                                if (_2590 < (_2628 * 0.3010300099849701f)) {
                                  ...
                                  int _2637 = int(_2636);
                                  float _2639 = _2636 - float((int)(_2637));
                        ...
                        do {
                          if (!(!(_2676 <= _2504))) {
                            ...
                            if ((bool)(_2676 > _2504) && (bool)(_2676 < _2684)) {
                              ...
                              int _2693 = int(_2692);
                              float _2695 = _2692 - float((int)(_2693));
                              ...
                              do {
                                if (!(!(_2676 >= _2684))) {
                                  ...
                                  if (_2676 < (_2714 * 0.3010300099849701f)) {
                                    ...
                                    int _2723 = int(_2722);
                                    float _2725 = _2722 - float((int)(_2723));
