// Subnautica 2 (native HDR lutbuilder with OutputDevice)
...
float4 main(
  ...
  _1208 = cb0_016x * (((cb0_041y + (cb0_041x * _1180)) * _1180) + cb0_041z);
  _1209 = cb0_016y * (((cb0_041y + (cb0_041x * _1181)) * _1181) + cb0_041z);
  _1210 = cb0_016z * (((cb0_041y + (cb0_041x * _1182)) * _1182) + cb0_041z);
  ...
  _1243 = exp2(log2(max(0.0f, _1217)) * cb0_042y);
  ...
  if (cb0_042w == 0) {
    ...
    if (cb0_042w == 1) {
      ...
      if ((uint)((int)((uint)(cb0_042w) + (uint)(-3))) < (uint)2) {
        ...
        _2038 = exp2(log2(mad(_53, _2019, mad(_52, _2018, (_2017 * _51))) * 9.999999747378752e-05f) * 0.1593017578125f);
        _2039 = exp2(log2(mad(_56, _2019, mad(_55, _2018, (_2017 * _54))) * 9.999999747378752e-05f) * 0.1593017578125f);
        _2040 = exp2(log2(mad(_59, _2019, mad(_58, _2018, (_2017 * _57))) * 9.999999747378752e-05f) * 0.1593017578125f);
        ...
        if ((uint)((int)((uint)(cb0_042w) + (uint)(-5))) < (uint)2) {
          _2106 = cb0_012z * _1229;
          _2107 = cb0_012z * _1230;
          _2108 = cb0_012z * _1231;
          _2111 = mad((WorkingColorSpace_256[0].z), _2108, mad((WorkingColorSpace_256[0].y), _2107, ((WorkingColorSpace_256[0].x) * _2106)));
          _2114 = mad((WorkingColorSpace_256[1].z), _2108, mad((WorkingColorSpace_256[1].y), _2107, ((WorkingColorSpace_256[1].x) * _2106)));
          _2117 = mad((WorkingColorSpace_256[2].z), _2108, mad((WorkingColorSpace_256[2].y), _2107, ((WorkingColorSpace_256[2].x) * _2106)));
          _2120 = mad(-0.21492856740951538f, _2117, mad(-0.2365107536315918f, _2114, (_2111 * 1.4514392614364624f)));
          _2123 = mad(-0.09967592358589172f, _2117, mad(1.17622971534729f, _2114, (_2111 * -0.07655377686023712f)));
          _2126 = mad(0.9977163076400757f, _2117, mad(-0.006032449658960104f, _2114, (_2111 * 0.008316148072481155f)));
          _2128 = max(_2120, max(_2123, _2126));
          if (!(_2128 < 1.000000013351432e-10f)) {
            if (!(((_2111 < 0.0f) || (_2114 < 0.0f)) || (_2117 < 0.0f))) {
              _2138 = abs(_2128);
              _2139 = (_2128 - _2120) / _2138;
              _2141 = (_2128 - _2123) / _2138;
              _2143 = (_2128 - _2126) / _2138;
              if (!(_2139 < 0.8149999976158142f)) {
                _2146 = _2139 + -0.8149999976158142f;
              ...
              if (!(_2141 < 0.8029999732971191f)) {
                _2161 = _2141 + -0.8029999732971191f;
              ...
              if (!(_2143 < 0.8799999952316284f)) {
                _2176 = _2143 + -0.8799999952316284f;
          ...
          _2214 = ((mad(0.16386906802654266f, _2198, mad(0.14067870378494263f, _2197, (_2196 * 0.6954522132873535f))) - _2111) * cb0_012w) + _2111;
          _2215 = ((mad(0.0955343171954155f, _2198, mad(0.8596711158752441f, _2197, (_2196 * 0.044794563204050064f))) - _2114) * cb0_012w) + _2114;
          _2216 = ((mad(1.0015007257461548f, _2198, mad(0.004025210160762072f, _2197, (_2196 * -0.005525882821530104f))) - _2117) * cb0_012w) + _2117;
          _2220 = max(max(_2214, _2215), _2216);
          _2225 = (max(_2220, 1.000000013351432e-10f) - max(min(min(_2214, _2215), _2216), 1.000000013351432e-10f)) / max(_2220, 0.009999999776482582f);
          _2238 = ((_2215 + _2214) + _2216) + (sqrt((((_2216 - _2215) * _2216) + ((_2215 - _2214) * _2215)) + ((_2214 - _2216) * _2214)) * 1.75f);
          _2239 = _2238 * 0.3333333432674408f;
          _2240 = _2225 + -0.4000000059604645f;
          _2241 = _2240 * 5.0f;
          _2245 = max((1.0f - abs(_2240 * 2.5f)), 0.0f);
          _2256 = ((float((int)(((int)(uint)((int)(_2241 > 0.0f))) - ((int)(uint)((int)(_2241 < 0.0f))))) * (1.0f - (_2245 * _2245))) + 1.0f) * 0.02500000037252903f;
          ...
          _2268 = _2266 * _2215;
          _2269 = _2266 * _2216;
          if (!((_2267 == _2268) && (_2268 == _2269))) {
            _2276 = ((_2267 * 2.0f) - _2268) - _2269;
            _2279 = ((_2215 - _2216) * 1.7320507764816284f) * _2266;
            _2281 = atan(_2279 / _2276);
            _2284 = (_2276 < 0.0f);
            _2285 = (_2276 == 0.0f);
            _2286 = (_2279 >= 0.0f);
            _2287 = (_2279 < 0.0f);
          ...
          _2303 = min(max(select((_2298 < 0.0f), (_2298 + 360.0f), _2298), 0.0f), 360.0f);
          if (_2303 < -180.0f) {
            _2312 = (_2303 + 360.0f);
          } else {
            if (_2303 > 180.0f) {
          ...
          if ((_2312 > -67.5f) && (_2312 < 67.5f)) {
            _2318 = (_2312 + 67.5f) * 0.029629629105329514f;
            _2319 = int(_2318);
            _2321 = _2318 - float((int)(_2319));
            _2322 = _2321 * _2321;
            _2323 = _2322 * _2321;
            if (_2319 == 3) {
          ...
          _2360 = min(max(((((_2225 * 0.27000001072883606f) * (0.029999999329447746f - _2267)) * _2351) + _2267), 0.0f), 65535.0f);
          _2361 = min(max(_2268, 0.0f), 65535.0f);
          _2362 = min(max(_2269, 0.0f), 65535.0f);
          _2375 = min(max(mad(-0.21492856740951538f, _2362, mad(-0.2365107536315918f, _2361, (_2360 * 1.4514392614364624f))), 0.0f), 65504.0f);
          _2376 = min(max(mad(-0.09967592358589172f, _2362, mad(1.17622971534729f, _2361, (_2360 * -0.07655377686023712f))), 0.0f), 65504.0f);
          _2377 = min(max(mad(0.9977163076400757f, _2362, mad(-0.006032449658960104f, _2361, (_2360 * 0.008316148072481155f))), 0.0f), 65504.0f);
          _2378 = dot(float3(_2375, _2376, _2377), float3(0.2722287178039551f, 0.6740817427635193f, 0.053689517080783844f));
          _14[0] = cb0_010x;
          _14[1] = cb0_010y;
          _14[2] = cb0_010z;
          _14[3] = cb0_010w;
          ...
          _15[4] = cb0_012y;
          _15[5] = cb0_012y;
          _2401 = log2(max((lerp(_2378, _2375, 0.9599999785423279f)), 1.000000013351432e-10f));
          _2402 = _2401 * 0.3010300099849701f;
          _2403 = log2(cb0_008x);
          _2404 = _2403 * 0.3010300099849701f;
          if (_2402 > _2404) {
            _2411 = log2(cb0_009x);
            _2412 = _2411 * 0.3010300099849701f;
            if ((_2402 > _2404) && (_2402 < _2412)) {
              _2420 = ((_2401 - _2403) * 0.9030900001525879f) / ((_2411 - _2403) * 0.3010300099849701f);
              _2421 = int(_2420);
              _2423 = _2420 - float((int)(_2421));
              _2425 = _14[min((uint)(_2421), 5u)];
              _2428 = _14[min((uint)((_2421 + 1)), 5u)];
              _2433 = _2425 * 0.5f;
              _2473 = dot(float3((_2423 * _2423), _2423, 1.0f), float3(mad((_14[min((uint)((_2421 + 2)), 5u)]), 0.5f, mad(_2428, -1.0f, _2433)), (_2428 - _2425), mad(_2428, 0.5f, _2433)));
            } else {
              if (_2402 < _2412) {
                ...
                if (!(_2402 < (_2442 * 0.3010300099849701f))) {
                  ...
                  _2450 = ((_2401 - _2411) * 0.9030900001525879f) / ((_2442 - _2411) * 0.3010300099849701f);
                  _2451 = int(_2450);
                  _2453 = _2450 - float((int)(_2451));
                  _2455 = _15[min((uint)(_2451), 5u)];
                  _2458 = _15[min((uint)((_2451 + 1)), 5u)];
                  _2463 = _2455 * 0.5f;
                  _2473 = dot(float3((_2453 * _2453), _2453, 1.0f), float3(mad((_15[min((uint)((_2451 + 2)), 5u)]), 0.5f, mad(_2458, -1.0f, _2463)), (_2458 - _2455), mad(_2458, 0.5f, _2463)));
                }
              }
            }
          } else {
          ...
          _11[4] = cb0_012y;
          _11[5] = cb0_012y;
          _2489 = log2(max((lerp(_2378, _2376, 0.9599999785423279f)), 1.000000013351432e-10f));
          _2490 = _2489 * 0.3010300099849701f;
          if (_2490 > _2404) {
            _2497 = log2(cb0_009x);
            _2498 = _2497 * 0.3010300099849701f;
            if ((_2490 > _2404) && (_2490 < _2498)) {
              _2506 = ((_2489 - _2403) * 0.9030900001525879f) / ((_2497 - _2403) * 0.3010300099849701f);
              _2507 = int(_2506);
              _2509 = _2506 - float((int)(_2507));
              _2511 = _10[min((uint)(_2507), 5u)];
              _2514 = _10[min((uint)((_2507 + 1)), 5u)];
              _2519 = _2511 * 0.5f;
              _2559 = dot(float3((_2509 * _2509), _2509, 1.0f), float3(mad((_10[min((uint)((_2507 + 2)), 5u)]), 0.5f, mad(_2514, -1.0f, _2519)), (_2514 - _2511), mad(_2514, 0.5f, _2519)));
            } else {
              if (_2490 < _2498) {
                ...
                if (!(_2490 < (_2528 * 0.3010300099849701f))) {
                  ...
                  _2536 = ((_2489 - _2497) * 0.9030900001525879f) / ((_2528 - _2497) * 0.3010300099849701f);
                  _2537 = int(_2536);
                  _2539 = _2536 - float((int)(_2537));
                  _2541 = _11[min((uint)(_2537), 5u)];
                  _2544 = _11[min((uint)((_2537 + 1)), 5u)];
                  _2549 = _2541 * 0.5f;
                  _2559 = dot(float3((_2539 * _2539), _2539, 1.0f), float3(mad((_11[min((uint)((_2537 + 2)), 5u)]), 0.5f, mad(_2544, -1.0f, _2549)), (_2544 - _2541), mad(_2544, 0.5f, _2549)));
                }
              }
            }
          } else {
          ...
          _13[4] = cb0_012y;
          _13[5] = cb0_012y;
          _2575 = log2(max((lerp(_2378, _2377, 0.9599999785423279f)), 1.000000013351432e-10f));
          _2576 = _2575 * 0.3010300099849701f;
          if (_2576 > _2404) {
            _2583 = log2(cb0_009x);
            _2584 = _2583 * 0.3010300099849701f;
            if ((_2576 > _2404) && (_2576 < _2584)) {
              _2592 = ((_2575 - _2403) * 0.9030900001525879f) / ((_2583 - _2403) * 0.3010300099849701f);
              _2593 = int(_2592);
              _2595 = _2592 - float((int)(_2593));
              _2597 = _12[min((uint)(_2593), 5u)];
              _2600 = _12[min((uint)((_2593 + 1)), 5u)];
              _2605 = _2597 * 0.5f;
              _2645 = dot(float3((_2595 * _2595), _2595, 1.0f), float3(mad((_12[min((uint)((_2593 + 2)), 5u)]), 0.5f, mad(_2600, -1.0f, _2605)), (_2600 - _2597), mad(_2600, 0.5f, _2605)));
            } else {
              if (_2576 < _2584) {
                ...
                if (!(_2576 < (_2614 * 0.3010300099849701f))) {
                  ...
                  _2622 = ((_2575 - _2583) * 0.9030900001525879f) / ((_2614 - _2583) * 0.3010300099849701f);
                  _2623 = int(_2622);
                  _2625 = _2622 - float((int)(_2623));
                  _2627 = _13[min((uint)(_2623), 5u)];
                  _2630 = _13[min((uint)((_2623 + 1)), 5u)];
                  _2635 = _2627 * 0.5f;
                  _2645 = dot(float3((_2625 * _2625), _2625, 1.0f), float3(mad((_13[min((uint)((_2623 + 2)), 5u)]), 0.5f, mad(_2630, -1.0f, _2635)), (_2630 - _2627), mad(_2630, 0.5f, _2635)));
                }
              }
            }
          } else {
          ...
          _2649 = cb0_008w - cb0_008y;
          _2650 = (exp2(_2473 * 3.321928024291992f) - cb0_008y) / _2649;
          _2652 = (exp2(_2559 * 3.321928024291992f) - cb0_008y) / _2649;
          _2654 = (exp2(_2645 * 3.321928024291992f) - cb0_008y) / _2649;
          _2657 = mad(0.15618768334388733f, _2654, mad(0.13400420546531677f, _2652, (_2650 * 0.6624541878700256f)));
          _2660 = mad(0.053689517080783844f, _2654, mad(0.6740817427635193f, _2652, (_2650 * 0.2722287178039551f)));
          _2663 = mad(1.0103391408920288f, _2654, mad(0.00406073359772563f, _2652, (_2650 * -0.005574649665504694f)));
          _2676 = min(max(mad(-0.23642469942569733f, _2663, mad(-0.32480329275131226f, _2660, (_2657 * 1.6410233974456787f))), 0.0f), 1.0f);
          _2677 = min(max(mad(0.016756348311901093f, _2663, mad(1.6153316497802734f, _2660, (_2657 * -0.663662850856781f))), 0.0f), 1.0f);
          _2678 = min(max(mad(0.9883948564529419f, _2663, mad(-0.008284442126750946f, _2660, (_2657 * 0.011721894145011902f))), 0.0f), 1.0f);
          _2681 = mad(0.15618768334388733f, _2678, mad(0.13400420546531677f, _2677, (_2676 * 0.6624541878700256f)));
          _2684 = mad(0.053689517080783844f, _2678, mad(0.6740817427635193f, _2677, (_2676 * 0.2722287178039551f)));
          _2687 = mad(1.0103391408920288f, _2678, mad(0.00406073359772563f, _2677, (_2676 * -0.005574649665504694f)));
          _2709 = min(max((min(max(mad(-0.23642469942569733f, _2687, mad(-0.32480329275131226f, _2684, (_2681 * 1.6410233974456787f))), 0.0f), 65535.0f) * cb0_008w), 0.0f), 65535.0f);
          _2712 = min(max((min(max(mad(0.016756348311901093f, _2687, mad(1.6153316497802734f, _2684, (_2681 * -0.663662850856781f))), 0.0f), 65535.0f) * cb0_008w), 0.0f), 65535.0f) * 0.012500000186264515f;
          _2713 = min(max((min(max(mad(0.9883948564529419f, _2687, mad(-0.008284442126750946f, _2684, (_2681 * 0.011721894145011902f))), 0.0f), 65535.0f) * cb0_008w), 0.0f), 65535.0f) * 0.012500000186264515f;
          ...
          if (cb0_042w == 7) {
            _2740 = mad((WorkingColorSpace_128[0].z), _1231, mad((WorkingColorSpace_128[0].y), _1230, ((WorkingColorSpace_128[0].x) * _1229)));
            _2743 = mad((WorkingColorSpace_128[1].z), _1231, mad((WorkingColorSpace_128[1].y), _1230, ((WorkingColorSpace_128[1].x) * _1229)));
            _2746 = mad((WorkingColorSpace_128[2].z), _1231, mad((WorkingColorSpace_128[2].y), _1230, ((WorkingColorSpace_128[2].x) * _1229)));
            _2765 = exp2(log2(mad(_53, _2746, mad(_52, _2743, (_2740 * _51))) * 9.999999747378752e-05f) * 0.1593017578125f);
            _2766 = exp2(log2(mad(_56, _2746, mad(_55, _2743, (_2740 * _54))) * 9.999999747378752e-05f) * 0.1593017578125f);
            _2767 = exp2(log2(mad(_59, _2746, mad(_58, _2743, (_2740 * _57))) * 9.999999747378752e-05f) * 0.1593017578125f);
            ...
            if (!(cb0_042w == 8)) {
              if (cb0_042w == 9) {
                _2814 = mad((WorkingColorSpace_128[0].z), _1219, mad((WorkingColorSpace_128[0].y), _1218, ((WorkingColorSpace_128[0].x) * _1217)));
                _2817 = mad((WorkingColorSpace_128[1].z), _1219, mad((WorkingColorSpace_128[1].y), _1218, ((WorkingColorSpace_128[1].x) * _1217)));
                _2820 = mad((WorkingColorSpace_128[2].z), _1219, mad((WorkingColorSpace_128[2].y), _1218, ((WorkingColorSpace_128[2].x) * _1217)));
                ...
                _2833 = mad((WorkingColorSpace_128[0].z), _1245, mad((WorkingColorSpace_128[0].y), _1244, ((WorkingColorSpace_128[0].x) * _1243)));
                _2836 = mad((WorkingColorSpace_128[1].z), _1245, mad((WorkingColorSpace_128[1].y), _1244, ((WorkingColorSpace_128[1].x) * _1243)));
                _2839 = mad((WorkingColorSpace_128[2].z), _1245, mad((WorkingColorSpace_128[2].y), _1244, ((WorkingColorSpace_128[2].x) * _1243)));
