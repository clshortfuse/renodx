...
float4 main(
  ...
  float _406 = (1.0f - exp2(((_388 * _388) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_392, _393, _394), float3(_392, _393, _394)) * -4.0f));
  ...
  SV_Target = ProcessLutbuilder(float3(_789, _791, _793), Samplers_1, Textures_1, cb_config, SV_Target, OutputDevice);
  return SV_Target;
  ...
  float _1166 = saturate(max(0.0f, mad((WorkingColorSpace.FromAP1[0].z), _1153, mad((WorkingColorSpace.FromAP1[0].y), _1152, ((WorkingColorSpace.FromAP1[0].x) * _1151)))));
  float _1167 = saturate(max(0.0f, mad((WorkingColorSpace.FromAP1[1].z), _1153, mad((WorkingColorSpace.FromAP1[1].y), _1152, ((WorkingColorSpace.FromAP1[1].x) * _1151)))));
  float _1168 = saturate(max(0.0f, mad((WorkingColorSpace.FromAP1[2].z), _1153, mad((WorkingColorSpace.FromAP1[2].y), _1152, ((WorkingColorSpace.FromAP1[2].x) * _1151)))));
