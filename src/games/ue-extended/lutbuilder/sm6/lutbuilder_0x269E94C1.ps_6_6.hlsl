...
float4 main(
  ...
  float _153 = (1.0f - exp2(((_135 * _135) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_139, _140, _141), float3(_139, _140, _141)) * -4.0f));
  ...
  SV_Target = ProcessLutbuilder(float3(_536, _538, _540), Samplers_1, Textures_1, cb_config, SV_Target, OutputDevice);
  return SV_Target;
  ...
  float _913 = saturate(max(0.0f, mad((WorkingColorSpace_FromAP1[0].z), _900, mad((WorkingColorSpace_FromAP1[0].y), _899, ((WorkingColorSpace_FromAP1[0].x) * _898)))));
  float _914 = saturate(max(0.0f, mad((WorkingColorSpace_FromAP1[1].z), _900, mad((WorkingColorSpace_FromAP1[1].y), _899, ((WorkingColorSpace_FromAP1[1].x) * _898)))));
  float _915 = saturate(max(0.0f, mad((WorkingColorSpace_FromAP1[2].z), _900, mad((WorkingColorSpace_FromAP1[2].y), _899, ((WorkingColorSpace_FromAP1[2].x) * _898)))));
    ...
    if ((uint)(OutputDevice) == 1) {
      ...
      if ((bool)((uint)(OutputDevice) == 3) || (bool)((uint)(OutputDevice) == 5)) {
        ...
        if (((uint)(OutputDevice) & -3) == 4) {
          ...
          float _1890 = ((float(((int)(uint)((bool)(_1875 > 0.0f))) - ((int)(uint)((bool)(_1875 < 0.0f)))) * (1.0f - (_1879 * _1879))) + 1.0f) * 0.02500000037252903f;
          do {
