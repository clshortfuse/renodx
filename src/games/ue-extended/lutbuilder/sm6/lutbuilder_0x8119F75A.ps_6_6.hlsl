// Found in Maifa Old Country UE 5.4
...
float4 main(
  ...
  float _255 = mad(_234, (WorkingColorSpace.ToXYZ[2].x), mad(_231, (WorkingColorSpace.ToXYZ[1].x), (_228 * (WorkingColorSpace.ToXYZ[0].x))));
  float _258 = mad(_234, (WorkingColorSpace.ToXYZ[2].y), mad(_231, (WorkingColorSpace.ToXYZ[1].y), (_228 * (WorkingColorSpace.ToXYZ[0].y))));
  float _261 = mad(_234, (WorkingColorSpace.ToXYZ[2].z), mad(_231, (WorkingColorSpace.ToXYZ[1].z), (_228 * (WorkingColorSpace.ToXYZ[0].z))));
  float _264 = mad(_243, (WorkingColorSpace.ToXYZ[2].x), mad(_240, (WorkingColorSpace.ToXYZ[1].x), (_237 * (WorkingColorSpace.ToXYZ[0].x))));
  float _267 = mad(_243, (WorkingColorSpace.ToXYZ[2].y), mad(_240, (WorkingColorSpace.ToXYZ[1].y), (_237 * (WorkingColorSpace.ToXYZ[0].y))));
  float _270 = mad(_243, (WorkingColorSpace.ToXYZ[2].z), mad(_240, (WorkingColorSpace.ToXYZ[1].z), (_237 * (WorkingColorSpace.ToXYZ[0].z))));
  float _273 = mad(_252, (WorkingColorSpace.ToXYZ[2].x), mad(_249, (WorkingColorSpace.ToXYZ[1].x), (_246 * (WorkingColorSpace.ToXYZ[0].x))));
  float _276 = mad(_252, (WorkingColorSpace.ToXYZ[2].y), mad(_249, (WorkingColorSpace.ToXYZ[1].y), (_246 * (WorkingColorSpace.ToXYZ[0].y))));
  float _279 = mad(_252, (WorkingColorSpace.ToXYZ[2].z), mad(_249, (WorkingColorSpace.ToXYZ[1].z), (_246 * (WorkingColorSpace.ToXYZ[0].z))));
  float _309 = mad(mad((WorkingColorSpace.FromXYZ[0].z), _279, mad((WorkingColorSpace.FromXYZ[0].y), _270, (_261 * (WorkingColorSpace.FromXYZ[0].x)))), _62, mad(mad((WorkingColorSpace.FromXYZ[0].z), _276, mad((WorkingColorSpace.FromXYZ[0].y), _267, (_258 * (WorkingColorSpace.FromXYZ[0].x)))), _61, (mad((WorkingColorSpace.FromXYZ[0].z), _273, mad((WorkingColorSpace.FromXYZ[0].y), _264, (_255 * (WorkingColorSpace.FromXYZ[0].x)))) * _60)));
  float _312 = mad(mad((WorkingColorSpace.FromXYZ[1].z), _279, mad((WorkingColorSpace.FromXYZ[1].y), _270, (_261 * (WorkingColorSpace.FromXYZ[1].x)))), _62, mad(mad((WorkingColorSpace.FromXYZ[1].z), _276, mad((WorkingColorSpace.FromXYZ[1].y), _267, (_258 * (WorkingColorSpace.FromXYZ[1].x)))), _61, (mad((WorkingColorSpace.FromXYZ[1].z), _273, mad((WorkingColorSpace.FromXYZ[1].y), _264, (_255 * (WorkingColorSpace.FromXYZ[1].x)))) * _60)));
  float _315 = mad(mad((WorkingColorSpace.FromXYZ[2].z), _279, mad((WorkingColorSpace.FromXYZ[2].y), _270, (_261 * (WorkingColorSpace.FromXYZ[2].x)))), _62, mad(mad((WorkingColorSpace.FromXYZ[2].z), _276, mad((WorkingColorSpace.FromXYZ[2].y), _267, (_258 * (WorkingColorSpace.FromXYZ[2].x)))), _61, (mad((WorkingColorSpace.FromXYZ[2].z), _273, mad((WorkingColorSpace.FromXYZ[2].y), _264, (_255 * (WorkingColorSpace.FromXYZ[2].x)))) * _60)));
  float _330 = mad((WorkingColorSpace.ToAP1[0].z), _315, mad((WorkingColorSpace.ToAP1[0].y), _312, ((WorkingColorSpace.ToAP1[0].x) * _309)));
  float _333 = mad((WorkingColorSpace.ToAP1[1].z), _315, mad((WorkingColorSpace.ToAP1[1].y), _312, ((WorkingColorSpace.ToAP1[1].x) * _309)));
  float _336 = mad((WorkingColorSpace.ToAP1[2].z), _315, mad((WorkingColorSpace.ToAP1[2].y), _312, ((WorkingColorSpace.ToAP1[2].x) * _309)));
  ...
  SV_Target = ProcessLutbuilder(float3(_738, _740, _742), cb_config, SV_Target, 3u);
  return SV_Target;
  ...
  float _1103 = max(0.0f, mad((WorkingColorSpace.FromAP1[0].z), _1081, mad((WorkingColorSpace.FromAP1[0].y), _1080, ((WorkingColorSpace.FromAP1[0].x) * _1079))));
  float _1104 = max(0.0f, mad((WorkingColorSpace.FromAP1[1].z), _1081, mad((WorkingColorSpace.FromAP1[1].y), _1080, ((WorkingColorSpace.FromAP1[1].x) * _1079))));
  float _1105 = max(0.0f, mad((WorkingColorSpace.FromAP1[2].z), _1081, mad((WorkingColorSpace.FromAP1[2].y), _1080, ((WorkingColorSpace.FromAP1[2].x) * _1079))));
  ...
  if (WorkingColorSpace.bIsSRGB == 0) {
    float _1163 = mad((WorkingColorSpace.ToAP1[0].z), _1156, mad((WorkingColorSpace.ToAP1[0].y), _1155, ((WorkingColorSpace.ToAP1[0].x) * _1154)));
    float _1166 = mad((WorkingColorSpace.ToAP1[1].z), _1156, mad((WorkingColorSpace.ToAP1[1].y), _1155, ((WorkingColorSpace.ToAP1[1].x) * _1154)));
    float _1169 = mad((WorkingColorSpace.ToAP1[2].z), _1156, mad((WorkingColorSpace.ToAP1[2].y), _1155, ((WorkingColorSpace.ToAP1[2].x) * _1154)));
