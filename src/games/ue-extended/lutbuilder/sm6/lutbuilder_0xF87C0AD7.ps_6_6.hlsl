...
float4 main(
  ...
  // float _408 = (1.0f - exp2(((_390 * _390) * -4.0f) * ExpandGamut)) * (1.0f - exp2(dot(float3(_394, _395, _396), float3(_394, _395, _396)) * -4.0f));
  float _408 = (1.0f - exp2(((_390 * _390) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_394, _395, _396), float3(_394, _395, _396)) * -4.0f));
  ...
  SV_Target = ProcessLutbuilder(float3(_791, _793, _795), Samplers_1, Samplers_2, Textures_1, Textures_2, cb_config, SV_Target, OutputDevice);
  return SV_Target;
  ...
  float _1011 = log2(lerp(_965, _962, 0.9599999785423279f)) * 0.3010300099849701f;
  float _1012 = log2(lerp(_965, _963, 0.9599999785423279f)) * 0.3010300099849701f;
  float _1013 = log2(lerp(_965, _964, 0.9599999785423279f)) * 0.3010300099849701f;
  ...
  float _1168 = saturate(max(0.0f, mad((WorkingColorSpace.FromAP1[0].z), _1155, mad((WorkingColorSpace.FromAP1[0].y), _1154, ((WorkingColorSpace.FromAP1[0].x) * _1153)))));
  float _1169 = saturate(max(0.0f, mad((WorkingColorSpace.FromAP1[1].z), _1155, mad((WorkingColorSpace.FromAP1[1].y), _1154, ((WorkingColorSpace.FromAP1[1].x) * _1153)))));
  float _1170 = saturate(max(0.0f, mad((WorkingColorSpace.FromAP1[2].z), _1155, mad((WorkingColorSpace.FromAP1[2].y), _1154, ((WorkingColorSpace.FromAP1[2].x) * _1153)))));
