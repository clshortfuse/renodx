...
// Found in WUCHANG Fallen Feathers UE 5.1.1
...
float4 main(
  ...
  float _149 = (1.0f - exp2(((_131 * _131) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_135, _136, _137), float3(_135, _136, _137)) * -4.0f));
  ...
  SV_Target = ProcessLutbuilder(float3(_533, _535, _537), s0, s1, t0, t1, cb_config, SV_Target, cb0_040w);
  return SV_Target;
  ...
  float _624 = ((float((int)(((int)(uint)((bool)(_609 > 0.0f))) - ((int)(uint)((bool)(_609 < 0.0f))))) * (1.0f - (_613 * _613))) + 1.0f) * 0.02500000037252903f;
  ...
  float _753 = log2(lerp(_707, _704, 0.9599999785423279f)) * 0.3010300099849701f;
  float _754 = log2(lerp(_707, _705, 0.9599999785423279f)) * 0.3010300099849701f;
  float _755 = log2(lerp(_707, _706, 0.9599999785423279f)) * 0.3010300099849701f;
  ...
  float _877 = (cb0_036w * (max(0.0f, (lerp(_857, _854, 0.9300000071525574f))) - _573)) + _573;
  float _878 = (cb0_036w * (max(0.0f, (lerp(_857, _855, 0.9300000071525574f))) - _574)) + _574;
  float _879 = (cb0_036w * (max(0.0f, (lerp(_857, _856, 0.9300000071525574f))) - _575)) + _575;
  ...
  if (cb0_040w == 0) {
    ...
    if (cb0_040w == 1) {
      ...
      if ((bool)(cb0_040w == 3) || (bool)(cb0_040w == 5)) {
        ...
        float _1344 = ((float((int)(((int)(uint)((bool)(_1329 > 0.0f))) - ((int)(uint)((bool)(_1329 < 0.0f))))) * (1.0f - (_1333 * _1333))) + 1.0f) * 0.02500000037252903f;
        do {
            ...
            do {
              ...
              do {
                if ((bool)(_1400 > -67.5f) && (bool)(_1400 < 67.5f)) {
                  ...
                  int _1407 = int(_1406);
                  float _1409 = _1406 - float((int)(_1407));
                ...
                do {
                  if (!(!(_1478 <= _1480))) {
                    ...
                    if ((bool)(_1478 > _1480) && (bool)(_1478 < _1488)) {
                      ...
                      int _1497 = int(_1496);
                      float _1499 = _1496 - float((int)(_1497));
                      ...
                      do {
                        if (!(!(_1478 >= _1488))) {
                          ...
                          if (_1478 < (_1518 * 0.3010300099849701f)) {
                            ...
                            int _1527 = int(_1526);
                            float _1529 = _1526 - float((int)(_1527));
                  ...
                  do {
                    if (!(!(_1554 <= _1480))) {
                      ...
                      if ((bool)(_1554 > _1480) && (bool)(_1554 < _1562)) {
                        ...
                        int _1571 = int(_1570);
                        float _1573 = _1570 - float((int)(_1571));
                        ...
                        do {
                          if (!(!(_1554 >= _1562))) {
                            ...
                            if (_1554 < (_1592 * 0.3010300099849701f)) {
                              ...
                              int _1601 = int(_1600);
                              float _1603 = _1600 - float((int)(_1601));
                    ...
                    do {
                      if (!(!(_1628 <= _1480))) {
                        ...
                        if ((bool)(_1628 > _1480) && (bool)(_1628 < _1636)) {
                          ...
                          int _1645 = int(_1644);
                          float _1647 = _1644 - float((int)(_1645));
        ...
        if ((cb0_040w & -3) == 4) {
          ...
          float _1920 = ((float((int)(((int)(uint)((bool)(_1905 > 0.0f))) - ((int)(uint)((bool)(_1905 < 0.0f))))) * (1.0f - (_1909 * _1909))) + 1.0f) * 0.02500000037252903f;
          do {
                        ...
                        do {
                          if (!(!(_2054 >= _2064))) {
                            ...
                            if (_2054 < (_2094 * 0.3010300099849701f)) {
                              ...
                              int _2103 = int(_2102);
                              float _2105 = _2102 - float((int)(_2103));
                            ...
                            do {
                              if (!(!(_2204 >= _2212))) {
                                ...
                                if (_2204 < (_2242 * 0.3010300099849701f)) {
                                  ...
                                  int _2251 = int(_2250);
                                  float _2253 = _2250 - float((int)(_2251));
