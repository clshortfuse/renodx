...
float4 main(
  ...
  float _403 = (1.0f - exp2(((_385 * _385) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_389, _390, _391), float3(_389, _390, _391)) * -4.0f));
  ...
  SV_Target = ProcessLutbuilder(float3(_787, _789, _791), s0, s1, t0, t1, cb_config, SV_Target, cb0_040w);
  return SV_Target;
  ...
  float _1131 = (cb0_036w * (max(0.0f, (lerp(_1111, _1108, 0.9300000071525574f))) - _827)) + _827;
  float _1132 = (cb0_036w * (max(0.0f, (lerp(_1111, _1109, 0.9300000071525574f))) - _828)) + _828;
  float _1133 = (cb0_036w * (max(0.0f, (lerp(_1111, _1110, 0.9300000071525574f))) - _829)) + _829;
  ...
  float _1164 = saturate(max(0.0f, mad((UniformBufferConstants_WorkingColorSpace_192[0].z), _1151, mad((UniformBufferConstants_WorkingColorSpace_192[0].y), _1150, ((UniformBufferConstants_WorkingColorSpace_192[0].x) * _1149)))));
  float _1165 = saturate(max(0.0f, mad((UniformBufferConstants_WorkingColorSpace_192[1].z), _1151, mad((UniformBufferConstants_WorkingColorSpace_192[1].y), _1150, ((UniformBufferConstants_WorkingColorSpace_192[1].x) * _1149)))));
  float _1166 = saturate(max(0.0f, mad((UniformBufferConstants_WorkingColorSpace_192[2].z), _1151, mad((UniformBufferConstants_WorkingColorSpace_192[2].y), _1150, ((UniformBufferConstants_WorkingColorSpace_192[2].x) * _1149)))));
