...
[numthreads(8, 8, 8)] void main(
  ...
  float _265 = mad(_244, (WorkingColorSpace_ToXYZ[2].x), mad(_241, (WorkingColorSpace_ToXYZ[1].x), (_238 * (WorkingColorSpace_ToXYZ[0].x))));
  float _268 = mad(_244, (WorkingColorSpace_ToXYZ[2].y), mad(_241, (WorkingColorSpace_ToXYZ[1].y), (_238 * (WorkingColorSpace_ToXYZ[0].y))));
  float _271 = mad(_244, (WorkingColorSpace_ToXYZ[2].z), mad(_241, (WorkingColorSpace_ToXYZ[1].z), (_238 * (WorkingColorSpace_ToXYZ[0].z))));
  float _274 = mad(_253, (WorkingColorSpace_ToXYZ[2].x), mad(_250, (WorkingColorSpace_ToXYZ[1].x), (_247 * (WorkingColorSpace_ToXYZ[0].x))));
  float _277 = mad(_253, (WorkingColorSpace_ToXYZ[2].y), mad(_250, (WorkingColorSpace_ToXYZ[1].y), (_247 * (WorkingColorSpace_ToXYZ[0].y))));
  float _280 = mad(_253, (WorkingColorSpace_ToXYZ[2].z), mad(_250, (WorkingColorSpace_ToXYZ[1].z), (_247 * (WorkingColorSpace_ToXYZ[0].z))));
  float _283 = mad(_262, (WorkingColorSpace_ToXYZ[2].x), mad(_259, (WorkingColorSpace_ToXYZ[1].x), (_256 * (WorkingColorSpace_ToXYZ[0].x))));
  float _286 = mad(_262, (WorkingColorSpace_ToXYZ[2].y), mad(_259, (WorkingColorSpace_ToXYZ[1].y), (_256 * (WorkingColorSpace_ToXYZ[0].y))));
  float _289 = mad(_262, (WorkingColorSpace_ToXYZ[2].z), mad(_259, (WorkingColorSpace_ToXYZ[1].z), (_256 * (WorkingColorSpace_ToXYZ[0].z))));
  float _319 = mad(mad((WorkingColorSpace_FromXYZ[0].z), _289, mad((WorkingColorSpace_FromXYZ[0].y), _280, (_271 * (WorkingColorSpace_FromXYZ[0].x)))), _72, mad(mad((WorkingColorSpace_FromXYZ[0].z), _286, mad((WorkingColorSpace_FromXYZ[0].y), _277, (_268 * (WorkingColorSpace_FromXYZ[0].x)))), _71, (mad((WorkingColorSpace_FromXYZ[0].z), _283, mad((WorkingColorSpace_FromXYZ[0].y), _274, (_265 * (WorkingColorSpace_FromXYZ[0].x)))) * _70)));
  float _322 = mad(mad((WorkingColorSpace_FromXYZ[1].z), _289, mad((WorkingColorSpace_FromXYZ[1].y), _280, (_271 * (WorkingColorSpace_FromXYZ[1].x)))), _72, mad(mad((WorkingColorSpace_FromXYZ[1].z), _286, mad((WorkingColorSpace_FromXYZ[1].y), _277, (_268 * (WorkingColorSpace_FromXYZ[1].x)))), _71, (mad((WorkingColorSpace_FromXYZ[1].z), _283, mad((WorkingColorSpace_FromXYZ[1].y), _274, (_265 * (WorkingColorSpace_FromXYZ[1].x)))) * _70)));
  float _325 = mad(mad((WorkingColorSpace_FromXYZ[2].z), _289, mad((WorkingColorSpace_FromXYZ[2].y), _280, (_271 * (WorkingColorSpace_FromXYZ[2].x)))), _72, mad(mad((WorkingColorSpace_FromXYZ[2].z), _286, mad((WorkingColorSpace_FromXYZ[2].y), _277, (_268 * (WorkingColorSpace_FromXYZ[2].x)))), _71, (mad((WorkingColorSpace_FromXYZ[2].z), _283, mad((WorkingColorSpace_FromXYZ[2].y), _274, (_265 * (WorkingColorSpace_FromXYZ[2].x)))) * _70)));
  float _340 = mad((WorkingColorSpace_ToAP1[0].z), _325, mad((WorkingColorSpace_ToAP1[0].y), _322, ((WorkingColorSpace_ToAP1[0].x) * _319)));
  ...
  float _365 = (1.0f - exp2(((_347 * _347) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_351, _352, _353), float3(_351, _352, _353)) * -4.0f));
  ...
  float4 output = ProcessLutbuilder(float3(_748, _750, _752), cb_config, RWOutputTexture[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))], OutputDevice);
  ...
  float _818 = ((float(((int)(uint)((bool)(_803 > 0.0f))) - ((int)(uint)((bool)(_803 < 0.0f)))) * (1.0f - (_807 * _807))) + 1.0f) * 0.02500000037252903f;
  ...
  float _1113 = max(0.0f, mad((WorkingColorSpace_FromAP1[0].z), _1091, mad((WorkingColorSpace_FromAP1[0].y), _1090, ((WorkingColorSpace_FromAP1[0].x) * _1089))));
  float _1114 = max(0.0f, mad((WorkingColorSpace_FromAP1[1].z), _1091, mad((WorkingColorSpace_FromAP1[1].y), _1090, ((WorkingColorSpace_FromAP1[1].x) * _1089))));
  float _1115 = max(0.0f, mad((WorkingColorSpace_FromAP1[2].z), _1091, mad((WorkingColorSpace_FromAP1[2].y), _1090, ((WorkingColorSpace_FromAP1[2].x) * _1089))));
  ...
  if (WorkingColorSpace_bIsSRGB == 0) {
    float _1173 = mad((WorkingColorSpace_ToAP1[0].z), _1166, mad((WorkingColorSpace_ToAP1[0].y), _1165, ((WorkingColorSpace_ToAP1[0].x) * _1164)));
    float _1176 = mad((WorkingColorSpace_ToAP1[1].z), _1166, mad((WorkingColorSpace_ToAP1[1].y), _1165, ((WorkingColorSpace_ToAP1[1].x) * _1164)));
    float _1179 = mad((WorkingColorSpace_ToAP1[2].z), _1166, mad((WorkingColorSpace_ToAP1[2].y), _1165, ((WorkingColorSpace_ToAP1[2].x) * _1164)));
