...
float4 main(
  ...
  float _407 = (1.0f - exp2(((_389 * _389) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_393, _394, _395), float3(_393, _394, _395)) * -4.0f));
  ...
  SV_Target = ProcessLutbuilder(float3(_1235, _1237, _1239), cb_config, SV_Target, OutputDevice);
  return SV_Target;
