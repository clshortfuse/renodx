...
[numthreads(8, 8, 8)] void main(
  ...
  float _87 = mad((WorkingColorSpace_ToAP1[0].z), _72, mad((WorkingColorSpace_ToAP1[0].y), _71, ((WorkingColorSpace_ToAP1[0].x) * _70)));
  float _90 = mad((WorkingColorSpace_ToAP1[1].z), _72, mad((WorkingColorSpace_ToAP1[1].y), _71, ((WorkingColorSpace_ToAP1[1].x) * _70)));
  float _93 = mad((WorkingColorSpace_ToAP1[2].z), _72, mad((WorkingColorSpace_ToAP1[2].y), _71, ((WorkingColorSpace_ToAP1[2].x) * _70)));
  ...
  float _112 = (1.0f - exp2(((_94 * _94) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_98, _99, _100), float3(_98, _99, _100)) * -4.0f));
  ...
  float4 output = ProcessLutbuilder(float3(_495, _497, _499), cb_config, RWOutputTexture[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))], OutputDevice);
  ...
  float _565 = ((float(((int)(uint)((bool)(_550 > 0.0f))) - ((int)(uint)((bool)(_550 < 0.0f)))) * (1.0f - (_554 * _554))) + 1.0f) * 0.02500000037252903f;
  ...
  float _862 = max(0.0f, mad((WorkingColorSpace_FromAP1[2].z), _838, mad((WorkingColorSpace_FromAP1[2].y), _837, ((WorkingColorSpace_FromAP1[2].x) * _836))));
  ...
  if (WorkingColorSpace_bIsSRGB == 0) {
    float _920 = mad((WorkingColorSpace_ToAP1[0].z), _913, mad((WorkingColorSpace_ToAP1[0].y), _912, ((WorkingColorSpace_ToAP1[0].x) * _911)));
    float _923 = mad((WorkingColorSpace_ToAP1[1].z), _913, mad((WorkingColorSpace_ToAP1[1].y), _912, ((WorkingColorSpace_ToAP1[1].x) * _911)));
    float _926 = mad((WorkingColorSpace_ToAP1[2].z), _913, mad((WorkingColorSpace_ToAP1[2].y), _912, ((WorkingColorSpace_ToAP1[2].x) * _911)));
  ...
  RWOutputTexture[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))] = saturate(float4((_950 * 0.9523810148239136f), (_961 * 0.9523810148239136f), (_972 * 0.9523810148239136f), 0.0f));
}
