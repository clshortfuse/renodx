...
float4 main(
  ...
  cb_config.ue_mappingpolynomial = float3(cb0_040x, cb0_040y, cb0_040z);
  ...
  SV_Target = ProcessLutbuilder(float3(_485, _487, _489), cb_config, SV_Target, asuint(0u));
  return SV_Target;
  ...
  float _878 = cb0_014x * (((cb0_040y + (cb0_040x * _850)) * _850) + cb0_040z);
  float _879 = cb0_014y * (((cb0_040y + (cb0_040x * _851)) * _851) + cb0_040z);
  float _880 = cb0_014z * (((cb0_040y + (cb0_040x * _852)) * _852) + cb0_040z);
  float _901 = exp2(log2(max(0.0f, (lerp(_878, cb0_013x, cb0_013w)))) * cb0_041y);
  float _902 = exp2(log2(max(0.0f, (lerp(_879, cb0_013y, cb0_013w)))) * cb0_041y);
  float _903 = exp2(log2(max(0.0f, (lerp(_880, cb0_013z, cb0_013w)))) * cb0_041y);
