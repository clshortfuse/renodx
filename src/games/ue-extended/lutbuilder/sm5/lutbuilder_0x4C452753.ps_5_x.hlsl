...
// Found in We Happy Few

// ---- Created with 3Dmigoto v1.3.16 on Tue May 27 18:18:37 2025
...
void main(
  ...
  cb_config.ue_tonecurveammount = 1.f; // shader has no ToneCurveAmount cbuffer member (cb0[57] out of bounds)
  ...
  if (asuint(cb0[56].z) == 0) {
    ...
    if (r0.w != 0) {
      ...
      if (r0.w != 0) {
        r6.xyz = cb0[34].xyz + -r1.xyz;
        r6.xyz = cb0[34].www * r6.xyz + r1.xyz;
        r6.xyz = float3(1.5, 1.5, 1.5) * r6.xyz;
        ...
        if (r0.w != 0) {
          r6.xyz = cb0[34].xyz + -r1.xyz;
          r1.xyz = cb0[34].www * r6.xyz + r1.xyz;
