// Generic UE 4.27 Lutbuilder
// Found in BLACKTAIL (2 SDR LUTs)

#include "../lutbuilderoutput.hlsli"

// ---- Created with 3Dmigoto v1.4.9 on Wed Jul  8 15:43:25 2026
  ...
  out float4 o0 : SV_Target0)
{
  ...
  // Two 16-cube SDR LUTs: result = cb0[38].x*prelut + cb0[39].x*LUT0(t0) + cb0[40].x*LUT1(t1)
