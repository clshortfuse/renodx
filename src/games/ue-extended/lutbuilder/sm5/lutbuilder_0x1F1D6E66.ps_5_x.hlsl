...
// ---- Created with 3Dmigoto v1.3.16 on Fri May  2 11:17:42 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = 1.00055635 * cb0[48].x;
  r1.x = cmp(6996.10791 >= cb0[48].x);
  ...
  r2.xyz = cb0[48].xxx * float3(0.000154118257,0.00084242021,4.22806261e-05) + float3(0.860117733,1,0.317398727);
  r0.w = cb0[48].x * cb0[48].x;
  r2.xyz = r0.www * float3(1.28641219e-07,7.08145137e-07,4.20481676e-08) + r2.xyz;
  r2.x = r2.x / r2.y;
  r1.z = -cb0[48].x * 2.8974182e-05 + 1;
  ...
  r1.xyzw = cb0[54].xyzw * cb0[49].xyzw;
  r2.xyzw = cb0[55].xyzw * cb0[50].xyzw;
  r3.xyzw = cb0[56].xyzw * cb0[51].xyzw;
  r4.xyzw = cb0[57].xyzw * cb0[52].xyzw;
  r5.xyzw = cb0[58].xyzw + cb0[53].xyzw;
  ...
  r1.w = r1.w * r1.w;
  r1.w = -r2.x * r1.w + 1;
  r2.xyzw = cb0[64].xyzw * cb0[49].xyzw;
  r3.xyzw = cb0[65].xyzw * cb0[50].xyzw;
  r4.xyzw = cb0[66].xyzw * cb0[51].xyzw;
  r5.xyzw = cb0[67].xyzw * cb0[52].xyzw;
  r6.xyzw = cb0[68].xyzw + cb0[53].xyzw;
  r2.xyz = r2.xyz * r2.www;
  ...
  r2.w = r2.w * r2.w;
  r3.y = r3.x * r2.w;
  r4.xyzw = cb0[59].xyzw * cb0[49].xyzw;
  r5.xyzw = cb0[60].xyzw * cb0[50].xyzw;
  r6.xyzw = cb0[61].xyzw * cb0[51].xyzw;
  r7.xyzw = cb0[62].xyzw * cb0[52].xyzw;
  r8.xyzw = cb0[63].xyzw + cb0[53].xyzw;
  ...
  cb_config.ue_filmblackclip = asfloat(cb0[40].w);
  cb_config.ue_filmtoe = asfloat(cb0[40].y);
  cb_config.ue_filmshoulder = asfloat(cb0[40].z);
  cb_config.ue_filmslope = asfloat(cb0[40].x);
  cb_config.ue_filmwhiteclip = asfloat(cb0[41].x);
  cb_config.ue_tonecurveammount = asfloat(cb0[70].z);
  cb_config.ue_mappingpolynomial = asfloat(cb0[30].xyz);
  cb_config.ue_overlaycolor = asfloat(cb0[47].xyzw);
  cb_config.ue_bluecorrection = asfloat(cb0[70].x);
  cb_config.ue_colorscale = asfloat(cb0[46].yzw);
  o0 = ProcessLutbuilder(float3(r0.xyz), cb_config, o0, asuint(cb0[69].z));
  return;
  ...
  r0.w = cmp(cb0[39].w == 0.000000);
  if (r0.w != 0) {
    r2.x = dot(r1.xyz, cb0[32].xyz);
    r2.y = dot(r1.xyz, cb0[33].xyz);
    r2.z = dot(r1.xyz, cb0[34].xyz);
    r0.w = dot(r1.xyz, cb0[37].xyz);
    r0.w = 1 + r0.w;
    r0.w = rcp(r0.w);
    r3.xyz = cb0[39].xyz * r0.www + cb0[38].xyz;
    r2.xyz = r3.xyz * r2.xyz;
    r2.xyz = max(float3(0,0,0), r2.xyz);
    r3.xyz = cb0[35].xxx + -r2.xyz;
    r3.xyz = max(float3(0,0,0), r3.xyz);
    r4.xyz = max(cb0[35].zzz, r2.xyz);
    r2.xyz = max(cb0[35].xxx, r2.xyz);
    r2.xyz = min(cb0[35].zzz, r2.xyz);
    r5.xyz = r4.xyz * cb0[36].xxx + cb0[36].yyy;
    r4.xyz = cb0[35].www + r4.xyz;
    r4.xyz = rcp(r4.xyz);
    r6.xyz = cb0[32].www * r3.xyz;
    r3.xyz = cb0[35].yyy + r3.xyz;
    r3.xyz = rcp(r3.xyz);
    r3.xyz = r6.xyz * r3.xyz + cb0[33].www;
    r2.xyz = r2.xyz * cb0[34].www + r3.xyz;
    ...
    r0.xyz = cb0[70].xxx * r3.xyz + r0.xyz;
    ...
    r3.xy = float2(1,0.180000007) + cb0[40].ww;
    r0.w = -cb0[40].y + r3.x;
    r1.w = 1 + cb0[41].x;
    r2.w = -cb0[40].z + r1.w;
    r3.x = cmp(0.800000012 < cb0[40].y);
    r3.zw = float2(0.819999993,1) + -cb0[40].yy;
    r3.zw = r3.zw / cb0[40].xx;
    ...
    r7.xyz = -cb0[40].www + r7.xyz;
    r0.w = r2.w + r2.w;
    r3.y = cb0[40].x + cb0[40].x;
    r2.w = r3.y / r2.w;
  ...
  r2.xyz = cb0[30].yyy * r2.xyz;
  r0.xyz = cb0[30].xxx * r0.xyz + r2.xyz;
  r0.xyz = cb0[30].zzz + r0.xyz;
  r2.xyz = cb0[46].yzw * r0.xyz;
  r0.xyz = -r0.xyz * cb0[46].yzw + cb0[47].xyz;
  r0.xyz = cb0[47].www * r0.xyz + r2.xyz;
  r0.xyz = max(float3(0,0,0), r0.xyz);
  r0.xyz = log2(r0.xyz);
  r0.xyz = cb0[31].yyy * r0.xyz;
  r2.xyz = exp2(r0.xyz);

  [branch]
  if (asuint(cb0[69].z) == 0) {
    ...
    r3.xyzw = cmp(asint(cb0[69].wwww) == int4(1,2,3,4));
    ...
    if (r0.w != 0) {
      ...
      r6.xy = cmp(asint(cb0[69].zz) == int2(3,5));
      ...
      if (r0.w != 0) {
        ...
        r6.xy = cmp(asint(cb0[69].zz) == int2(4,6));
        r0.w = (int)r6.y | (int)r6.x;
        if (r0.w != 0) {
          r6.xyz = float3(1.5,1.5,1.5) * r1.xyz;
          r7.y = dot(float3(0.439700812,0.382978052,0.1773348), r6.xyz);
