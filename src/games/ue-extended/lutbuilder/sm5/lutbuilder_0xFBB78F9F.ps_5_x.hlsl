...
// ---- Created with 3Dmigoto v1.3.16 on Mon Feb 23 06:41:53 2026
...
void main(
  ...
  cb_config.ue_tonecurveammount = asfloat(1.f);  // Older unreal games with no ToneCurveAmmount can run this at 1.f
