...
// ---- Created with 3Dmigoto v1.3.2 on Mon Dec 30 00:29:24 2024
...
void main(
  ...
  cb_config.ue_tonecurveammount = asfloat(cb0[68].z);
  ...
  o0 = ProcessLutbuilder(float3(untonemapped_ap1), cb_config, o0, asuint(cb0[67].z));
  return;
