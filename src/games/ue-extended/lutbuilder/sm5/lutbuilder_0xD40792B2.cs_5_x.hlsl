// Found in VOIN (UE sm5, compute LUT builder)

#include "../lutbuilderoutput.hlsli"

// ---- Created with 3Dmigoto v1.4.9 on Tue Jun 16 23:12:15 2026
...
void main(uint3 vThreadID : SV_DispatchThreadID)
{
  ...
  r0.w = 0.5 / cb0[37].x;
  r0.xy = r0.xy * cb0[44].xy + -r0.ww;
  r0.xy = cb0[37].xx * r0.xy;
  r1.xy = cb0[37].xy + float2(-1,-6500);
  r2.xyz = r0.xyz / r1.xxx;
  r0.xyzw = cmp(int4(1,2,3,4) == asint(cb0[43].xxxx));
  r1.xzw = r0.www ? float3(1,0,0) : float3(1.70505095,-0.621792138,-0.0832588747);
  ...
  r1.xzw = r0.zzz ? float3(0.695452213,0.140678704,0.163869068) : r1.xzw;
  ...
  r1.xzw = r0.yyy ? float3(1.02582479,-0.0200531911,-0.00577155687) : r1.xzw;
  ...
  r1.xzw = r0.xxx ? float3(1.37921417,-0.308864146,-0.0703499839) : r1.xzw;
  ...
  if (r0.w != 0) {
    ...
    r2.xyz = float3(-0.434017599,-0.434017599,-0.434017599) + r2.xyz;
    r2.xyz = float3(14,14,14) * r2.xyz;
    r2.xyz = exp2(r2.xyz);
    r4.xyz = r2.xyz * float3(0.180000007,0.180000007,0.180000007) + float3(-0.00266771927,-0.00266771927,-0.00266771927);
  }
  r0.w = cmp(9.99999994e-09 < abs(r1.y));
  r1.y = cmp(9.99999994e-09 < abs(cb0[37].z));
  r0.w = (int)r0.w | (int)r1.y;
  if (r0.w != 0) {
    r0.w = cb0[37].y * 1.00055635;
    r0.w = 1 / r0.w;
    r1.y = cmp(6996.10791 >= cb0[37].y);
    r2.xy = -r0.ww * float2(4.60700006e+09,2.0064e+09) + float2(2967800,1901800);
    r2.xy = r2.xy * r0.ww + float2(99.1100006,247.479996);
    r2.xy = r2.xy * r0.ww + float2(0.244063005,0.237039998);
    r2.x = r1.y ? r2.x : r2.y;
    r0.w = r2.x * r2.x;
    r1.y = 2.86999989 * r2.x;
    r0.w = r0.w * -3 + r1.y;
    ...
    r2.w = r2.z + r2.z;
    r6.y = r2.w / r3.w;
    r2.w = cmp(cb0[37].y < 4000);
    r2.xy = r2.ww ? r6.xy : r2.xy;
    r5.xy = -r0.ww * float2(1.53176999,308.606995) + r5.yw;
    r2.w = cb0[37].y * 1189.62 + r0.w;
    ...
    r5.xy = r7.xy * r0.ww;
    r0.w = cb0[37].z * r5.y;
    r0.w = r0.w * 0.0500000007 + r1.y;
    r1.y = cb0[37].z * -r5.x;
    r1.y = r1.y * 0.0500000007 + r2.z;
    r2.z = 3 * r0.w;
    r0.w = r0.w + r0.w;
    r0.w = -r1.y * 8 + r0.w;
    r0.w = 4 + r0.w;
    ...
    r1.y = dot(float3(-0.750199974,1.71350002,0.0366999991), r6.xzw);
    r2.x = dot(float3(0.0388999991,-0.0684999973,1.02960002), r6.xzw);
    r2.zw = r6.yz;
    r3.w = dot(float3(-0.161400005,0.895099998,0.266400009), r2.yzw);
    r4.w = dot(float3(0.0366999991,-0.750199974,1.71350002), r2.yzw);
    r2.y = dot(float3(1.02960002,0.0388999991,-0.0684999973), r2.yzw);
    r0.w = r3.w / r0.w;
    r1.y = r4.w / r1.y;
    r2.x = r2.y / r2.x;
    r2.yzw = float3(0.895099998,0.266400009,-0.161400005) * r0.www;
    r5.xyz = float3(-0.750199974,1.71350002,0.0366999991) * r1.yyy;
    r6.xyz = float3(0.0388999991,-0.0684999973,1.02960002) * r2.xxx;
    r7.x = r2.y;
    r7.y = r5.x;
    r7.z = r6.x;
    ...
    r2.y = r5.y;
    r2.z = r6.y;
    r1.y = dot(float3(0.986992896,-0.1470543,0.159962699), r2.xyz);
    r6.x = r2.w;
    r6.y = r5.z;
    r2.w = dot(float3(0.986992896,-0.1470543,0.159962699), r6.xyz);
    r3.w = dot(float3(0.432305306,0.518360317,0.0492912009), r7.xyz);
    r4.w = dot(float3(0.432305306,0.518360317,0.0492912009), r2.xyz);
    r5.x = dot(float3(0.432305306,0.518360317,0.0492912009), r6.xyz);
    r5.y = dot(float3(-0.0085287001,0.040042799,0.968486726), r7.xyz);
    r2.x = dot(float3(-0.0085287001,0.040042799,0.968486726), r2.xyz);
    r2.y = dot(float3(-0.0085287001,0.040042799,0.968486726), r6.xyz);
    r6.xyz = cb1[1].xyz * r1.yyy;
    r6.xyz = r0.www * cb1[0].xyz + r6.xyz;
    r6.xyz = r2.www * cb1[2].xyz + r6.xyz;
    r7.xyz = cb1[1].xyz * r4.www;
    r7.xyz = r3.www * cb1[0].xyz + r7.xyz;
    r5.xzw = r5.xxx * cb1[2].xyz + r7.xyz;
    r2.xzw = cb1[1].xyz * r2.xxx;
    r2.xzw = r5.yyy * cb1[0].xyz + r2.xzw;
    r2.xyz = r2.yyy * cb1[2].xyz + r2.xzw;
    r7.xyz = cb1[4].yyy * r5.xzw;
    r7.xyz = cb1[4].xxx * r6.xyz + r7.xyz;
    r7.xyz = cb1[4].zzz * r2.xyz + r7.xyz;
    r8.xyz = cb1[5].yyy * r5.xzw;
    r8.xyz = cb1[5].xxx * r6.xyz + r8.xyz;
    r8.xyz = cb1[5].zzz * r2.xyz + r8.xyz;
    r5.xyz = cb1[6].yyy * r5.xzw;
    r5.xyz = cb1[6].xxx * r6.xyz + r5.xyz;
    r2.xyz = cb1[6].zzz * r2.xyz + r5.xyz;
    r5.x = dot(r7.xyz, r4.xyz);
    r5.y = dot(r8.xyz, r4.xyz);
    r5.z = dot(r2.xyz, r4.xyz);
    r4.xyz = r5.xyz;
  }
  r2.x = dot(cb1[8].xyz, r4.xyz);
  r2.y = dot(cb1[9].xyz, r4.xyz);
  r2.z = dot(cb1[10].xyz, r4.xyz);
  ...
  r0.w = 1 + -r0.w;
  r0.w = r1.y * r0.w;
  r4.x = dot(float3(1.37041235,-0.329292178,-0.0636831224), r2.xyz);
  r4.y = dot(float3(-0.083433494,1.09709275,-0.0108613791), r2.xyz);
  r4.z = dot(float3(-0.0257933214,-0.0986258015,1.20369494), r2.xyz);
  ...
  r2.xyz = r5.xyz * r4.www + r2.xyz;

  float3 untonemapped_ap1 = r2.xyz;

  UECbufferConfig cb_config = CreateCbufferConfig();
  cb_config.ue_filmblackclip = asfloat(cb0[40].x);
  cb_config.ue_filmtoe = asfloat(cb0[39].z);
  cb_config.ue_filmshoulder = asfloat(cb0[39].w);
  cb_config.ue_filmslope = asfloat(cb0[39].y);
  cb_config.ue_filmwhiteclip = asfloat(cb0[40].y);
  cb_config.ue_tonecurveammount = asfloat(cb0[39].x);
  cb_config.ue_lutweights[0] = float4(asfloat(cb0[5].x), asfloat(cb0[5].y), 0.f, 0.f);
  cb_config.ue_mappingpolynomial = asfloat(cb0[41].xyz);
  cb_config.ue_overlaycolor = asfloat(cb0[15].xyzw);
  cb_config.ue_colorscale = asfloat(cb0[16].xyz);
  cb_config.ue_bluecorrection = asfloat(cb0[38].z);
  cb_config.ue_haslut = true;

  u0[vThreadID.xyz] = ProcessLutbuilder(untonemapped_ap1, s0_s, t0, cb_config, u0[vThreadID.xyz], asuint(cb0[42].w));
  return;

  r4.x = dot(float3(0.938639402,1.02359565e-10,0.0613606237), r2.xyz);
  r4.y = dot(float3(8.36008554e-11,0.830794156,0.169205874), r2.xyz);
  r4.z = dot(float3(2.13187367e-12,-5.63307213e-12,1), r2.xyz);
  r4.xyz = r4.xyz + -r2.xyz;
  r4.xyz = cb0[38].zzz * r4.xyz + r2.xyz;
  ...
  r1.y = max(r5.y, r5.z);
  r1.y = max(r1.y, r5.w);
  r6.xy = max(float2(1.00000001e-10,0.00999999978), r1.yy);
  ...
  r6.xyz = cb0[40].xyx + float3(1,1,0.180000007);
  r6.xw = -cb0[39].zw + r6.xy;
  r0.w = cmp(0.800000012 < cb0[39].z);
  r7.xy = -cb0[39].zz + float2(0.819999993,1);
  r7.xy = r7.xy / cb0[39].yy;
  r1.y = -0.744727492 + r7.x;
  r2.w = r6.z / r6.x;
  r3.w = -1 + r2.w;
  r3.w = 1 + -r3.w;
  r2.w = r2.w / r3.w;
  ...
  r8.xyz = r5.xyz * float3(0.30103001,0.30103001,0.30103001) + r1.yyy;
  r8.xyz = cb0[39].yyy * r8.xyz;
  r9.xy = r6.xw + r6.xw;
  r1.y = cb0[39].y * -2;
  r1.y = r1.y / r6.x;
  r10.xyz = r5.xyz * float3(0.30103001,0.30103001,0.30103001) + -r0.www;
  r11.xyz = r10.xyz * r1.yyy;
  ...
  r9.xzw = -cb0[40].xxx + r9.xzw;
  r1.y = cb0[39].y + cb0[39].y;
  r1.y = r1.y / r6.w;
  ...
  r1.y = r2.w + -r0.w;
  r7.xyz = saturate(r10.xyz / r1.yyy);
  r0.w = cmp(r2.w < r0.w);
  ...
  r5.xyz = r5.xyz + -r4.xyz;
  r4.xyz = cb0[38].zzz * r5.xyz + r4.xyz;
  ...
  r1.y = r5.y + r1.y;
  r5.x = 0.0625 * r1.y;
  r6.xyz = t0.SampleLevel(s0_s, r5.xz, 0).xyz;
  ...
  r6.xyz = abs(r4.xyz) * float3(0.947867274,0.947867274,0.947867274) + float3(0.0521326996,0.0521326996,0.0521326996);
  r6.xyz = log2(r6.xyz);
  ...
  r4.xyz = cb0[41].yyy * r4.xyz;
  r4.xyz = cb0[41].xxx * r5.xyz + r4.xyz;
  r4.xyz = cb0[41].zzz + r4.xyz;
  r5.xyz = cb0[16].xyz * r4.xyz;
  r4.xyz = -r4.xyz * cb0[16].xyz + cb0[15].xyz;
  r4.xyz = cb0[15].www * r4.xyz + r5.xyz;
  ...
  if (asuint(cb0[42].w) == 0) {
    ...
    if (r0.w != 0) {
      ...
      r7.x = dot(cb1[12].xyz, r2.xyz);
      r7.y = dot(cb1[13].xyz, r2.xyz);
      r7.z = dot(cb1[14].xyz, r2.xyz);
      r2.xyz = cb0[16].xyz * r7.xyz;
      r7.xyz = -r7.xyz * cb0[16].xyz + cb0[15].xyz;
      r2.xyz = cb0[15].www * r7.xyz + r2.xyz;
      r7.xy = cmp(int2(3,4) == asint(cb0[42].ww));
      r0.w = (int)r7.y | (int)r7.x;
      if (r0.w != 0) {
        r7.xyz = cb0[12].zzz * r2.xyz;
        ...
        if (r1.y == 0) {
          ...
          r1.y = log2(r10.x);
          r1.y = 1.20000005 * r1.y;
          r1.y = exp2(r1.y);
          r1.y = 1 + r1.y;
          r1.y = log2(r1.y);
          r1.y = 0.833333313 * r1.y;
          r1.y = exp2(r1.y);
          r1.y = r10.y / r1.y;
          r1.y = 0.879999995 + r1.y;
          r1.y = r10.z ? r9.z : r1.y;
          r7.xy = -r9.xy * abs(r0.ww) + r0.ww;
          r7.z = -r1.y * abs(r0.w) + r0.w;
        }
        ...
        r1.y = max(r7.x, r7.y);
        r1.y = max(r1.y, r7.z);
        r8.xy = max(float2(1.00000001e-10,0.00999999978), r1.yy);
        r0.w = max(1.00000001e-10, r0.w);
        r0.w = r8.x + -r0.w;
        r0.w = r0.w / r8.y;
        ...
        if (r9.x != 0) {
          ...
          if (r2.w != 0) {
            ...
            if (r2.w != 0) {
              ...
              r2.w = log2(cb0[8].w);
              r1.y = 0.30103001 * r2.w;
            }
          }
        }
        r1.y = 3.32192802 * r1.y;
        r1.y = exp2(r1.y);
        if (r9.y != 0) {
          r2.w = log2(cb0[8].y);
        ...
        r7.xy = cmp(int2(5,6) == asint(cb0[42].ww));
        r0.w = (int)r7.y | (int)r7.x;
        if (r0.w != 0) {
          r7.xyz = cb0[12].zzz * r2.xyz;
          r8.y = dot(cb1[16].xyz, r7.xyz);
          ...
          r7.xyz = max(float3(0,0,0), r7.xyz);
          r7.xyz = min(float3(65535,65535,65535), r7.xyz);
          r7.xyz = float3(0.0125000002,0.0125000002,0.0125000002) * r7.xyz;
          r6.x = dot(float3(1.70505095,-0.621792138,-0.0832588747), r7.xyz);
          r6.y = dot(float3(-0.130256414,1.14080477,-0.0105483187), r7.xyz);
          r6.z = dot(float3(-0.0240033567,-0.128968969,1.15297234), r7.xyz);
        } else {
          r0.w = cmp(7 == asint(cb0[42].w));
          if (r0.w != 0) {
            r7.x = dot(cb1[8].xyz, r2.xyz);
            r7.y = dot(cb1[9].xyz, r2.xyz);
            r7.z = dot(cb1[10].xyz, r2.xyz);
            r8.x = dot(r1.xzw, r7.xyz);
            r8.y = dot(r3.xyz, r7.xyz);
            r8.z = dot(r0.xyz, r7.xyz);
            r7.xyz = float3(9.99999975e-05,9.99999975e-05,9.99999975e-05) * r8.xyz;
