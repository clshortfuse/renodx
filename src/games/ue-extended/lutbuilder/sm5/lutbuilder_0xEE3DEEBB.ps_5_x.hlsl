...
// ---- Created with 3Dmigoto v1.3.16 on Sat May 10 11:21:05 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  float4 lutweights[2] = {float4(asfloat(cb0[33].x), asfloat(cb0[34].x), asfloat(cb0[35].x), 0.f), float4(0.f, 0.f, 0.f, 0.f)};
  cb_config.ue_lutweights = lutweights;
  o0 = ProcessLutbuilder(float3(r0.xyz), s0_s, s1_s, t0, t1, cb_config, o0, asuint(cb0[60].z));
  return;
  ...
  r3.xyz = cb0[34].xxx * r3.xyz;
  r0.xyz = cb0[33].xxx * r0.xyz + r3.xyz;
  r3.xyz = t1.Sample(s1_s, r2.xz).xyz;
  r2.xyz = t1.Sample(s1_s, r2.yw).xyz;
  r2.xyz = r2.xyz + -r3.xyz;
  r2.xyz = r0.www * r2.xyz + r3.xyz;
  r0.xyz = cb0[35].xxx * r2.xyz + r0.xyz;
