...
// Found in Densha attack ini hdr

// ---- Created with 3Dmigoto v1.3.16 on Thu Jul 16 17:41:34 2026
...
void main(
  ...
  if (r1.w != 0) {
    ...
    r1.xyz = exp2(r1.xyz);
    r4.xyz = r1.xyz * float3(0.180000007, 0.180000007, 0.180000007) + float3(-0.00266771927, -0.00266771927, -0.00266771927);
  }
  r0.w = cmp(9.99999994e-09 < abs(r0.w));
  r1.x = cmp(9.99999994e-09 < abs(cb0[37].z));
  r0.w = (int)r0.w | (int)r1.x;
  if (r0.w != 0) {
    r0.w = cb0[37].y * 1.00055635;
    r0.w = 1 / r0.w;
    r1.x = cmp(6996.10791 >= cb0[37].y);
    ...
    r1.xyzw = (asuint(cb0[40].w) != 0u) ? r1.xyzw : r1.zwxy;
    ...
    r5.z = dot(r1.xyz, r4.xyz);
    r4.xyz = r5.xyz;
  }
  r1.x = dot(cb1[8].xyz, r4.xyz);
  r1.y = dot(cb1[9].xyz, r4.xyz);
  r1.z = dot(cb1[10].xyz, r4.xyz);
  ...
  r4.xyz = r4.xyz + -r1.xyz;
  r4.xyz = cb0[38].zzz * r4.xyz + r1.xyz;
  ...
  if (asuint(cb0[42].w) == 0) {
    ...
    if (r0.w != 0) {
      ...
      r1.xyz = cb0[16].xyz * r7.xyz;
      r7.xyz = -r7.xyz * cb0[16].xyz + cb0[15].xyz;
      r1.xyz = cb0[15].www * r7.xyz + r1.xyz;
