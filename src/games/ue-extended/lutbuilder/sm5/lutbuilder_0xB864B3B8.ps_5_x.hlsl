// Found in GTA trilogy remaster

#include "../lutbuilderoutput.hlsli"

// ---- Created with 3Dmigoto v1.3.16 on Sun Apr 12 15:47:30 2026
...
void main(
  ...
  const float4 icb[] = { { -4.000000, 0, 0, 0 },
                         { -4.000000, 0, 0, 0 },
                         { -3.157377, 0, 0, 0 },
                         { -0.485250, 0, 0, 0 },
                         { 1.847732, 0, 0, 0 },
  ...
  r1.z = r2.x / r2.y;
  r2.xyw = -cb0[44].yyy * float3(2.8974182e-05, 1916156.25, 705674) + float3(1, -1.13758118e+09, 1.97471539e+09);
  r1.w = r0.w * 1.61456057e-07 + r2.x;
  r1.w = r2.z / r1.w;
  r2.x = 3 * r1.z;
  r2.z = r1.z + r1.z;
  r2.z = -r1.w * 8 + r2.z;
  ...
  r2.x = r1.w + r1.w;
  r3.y = r2.x / r2.z;
  r2.x = cmp(cb0[44].y < 4000);
  r1.xy = r2.xx ? r3.xy : r1.xy;
  r2.xy = -r0.ww * float2(1.53176999, 308.606995) + r2.yw;
  r2.z = cb0[44].y * 1189.62 + r0.w;
  r2.z = 1412139.88 + r2.z;
  r2.z = r2.z * r2.z;
  r4.x = r2.x / r2.z;
  r0.w = -cb0[44].y * 179.455994 + r0.w;
  r0.w = 6193636 + r0.w;
  r0.w = r0.w * r0.w;
  r4.y = r2.y / r0.w;
  ...
  cb_config.ue_tonecurveammount = asfloat(cb0[67].x);
  ...
  if (asuint(cb0[65].z) == 0) {
    ...
    if (r0.w != 0) {
      ...
      if (r0.w != 0) {
        ...
        r0.w = log2(cb0[66].x);
        r7.w = 0.30103001 * r0.w;
        r9.xy = r0.ww * float2(0.30103001, 0.30103001) + float2(-1.68124127, -0.681241274);
        r1.w = saturate(0.431265235 * r9.x);
        r9.xz = r1.ww * float2(11.5, 0.00999999046) + float2(6.5, 0.889999986);
        r1.w = exp2(r9.x);
        r1.w = 0.180000007 * r1.w;
        r1.w = log2(r1.w);
        r2.w = 0.30103001 * r1.w;
        r3.w = r1.w * 0.30103001 + 0.744727433;
        r9.xw = float2(0.333333343, 0.166666672) * r3.ww;
        r4.w = -r3.w * 0.166666672 + -0.744727433;
        r4.w = r4.w * 1.54999995 + 1.83556879;
        r3.w = r3.w * 0.166666672 + -0.744727433;
        r7.y = r3.w * 1.54999995 + 1.83556879;
        r7.z = r9.z * r9.y + 0.681241274;
        r9.yz = r7.yz + r7.zw;
        r0.w = cmp(3.90689087 < r0.w);
        r3.w = cmp(r9.y < 2.35218263);
        r9.yz = cmp(r9.yz >= float2(2.35218263, 2.35218263));
        r3.w = r3.w ? r9.z : 0;
        r7.x = 1;
        r10.y = 2;
        r10.xzw = r7.wzw;
        r11.xyzw = r3.wwww ? r7.xyzw : r10.yzwx;
        r12.x = 0;
        r12.yz = r9.ww * float2(-1.54999995, 1.54999995) + float2(0.681241274, 0.681241274);
        r12.w = r10.z;
        r11.xyzw = r9.yyyy ? r12.xyzw : r11.xyzw;
        r3.w = dot(r11.ywz, float3(0.5, 0.5, -1));
        r5.w = dot(r11.yz, float2(-1, 1));
        r6.w = dot(r11.yz, float2(0.5, 0.5));
        r6.w = -1.17609131 + r6.w;
        r3.w = r6.w * r3.w;
        r3.w = 4 * r3.w;
        r3.w = r5.w * r5.w + -r3.w;
        r3.w = sqrt(r3.w);
        ...
        r5.w = (int)r11.x;
        r3.w = r5.w + r3.w;
        r3.w = r3.w * r9.x + -0.744727433;
        r0.w = r0.w ? r3.w : r2.w;
        r0.w = r0.w * 3.32192802 + 2.47393107;
        r7.xw = float2(-17.4739304, -2.47393107) + -r0.ww;
        r0.w = r1.w + -r0.w;
        r1.w = min(r8.y, r8.z);
        r1.w = min(r1.w, r8.w);
        r2.w = max(r8.y, r8.z);
        r2.w = max(r2.w, r8.w);
        r9.xy = max(float2(1.00000001e-10, 0.00999999978), r2.ww);
        r1.w = max(1.00000001e-10, r1.w);
        r1.w = r9.x + -r1.w;
        r1.w = r1.w / r9.y;
        r9.xyz = r8.wzy + -r8.zyw;
        r9.xy = r9.xy * r8.wz;
        r2.w = r9.x + r9.y;
        r2.w = r8.y * r9.z + r2.w;
        r2.w = sqrt(r2.w);
        ...
        r5.w = -0.400000006 + r1.w;
        r6.w = 2.5 * r5.w;
        r6.w = 1 + -abs(r6.w);
        r6.w = max(0, r6.w);
        r8.x = cmp(0 < r5.w);
        r5.w = cmp(r5.w < 0);
        r5.w = (int)-r8.x + (int)r5.w;
        r5.w = (int)r5.w;
        r6.w = -r6.w * r6.w + 1;
        r5.w = r5.w * r6.w + 1;
        ...
        r2.w = r6.w ? r5.w : r2.w;
        r2.w = 1 + r2.w;
        r9.yzw = r8.yzw * r2.www;
        r10.yz = cmp(r9.zw == r9.yz);
        r3.w = r10.z ? r10.y : 0;
        r5.w = r8.z * r2.w + -r9.w;
        r5.w = 1.73205078 * r5.w;
        r6.w = r9.y * 2 + -r9.z;
        r6.w = -r8.w * r2.w + r6.w;
        r8.x = min(abs(r6.w), abs(r5.w));
        r8.z = max(abs(r6.w), abs(r5.w));
        r8.z = 1 / r8.z;
        r8.x = r8.x * r8.z;
        r8.z = r8.x * r8.x;
        ...
        r8.w = r8.x * r8.z;
        r10.y = cmp(abs(r6.w) < abs(r5.w));
        r8.w = r8.w * -2 + 1.57079637;
        r8.w = r10.y ? r8.w : 0;
        r8.x = r8.x * r8.z + r8.w;
        r8.z = cmp(r6.w < -r6.w);
        r8.z = r8.z ? -3.141593 : 0;
        r8.x = r8.x + r8.z;
        r8.z = min(r6.w, r5.w);
        r5.w = max(r6.w, r5.w);
        r6.w = cmp(r8.z < -r8.z);
        ...
        if (r5.w != 0) {
          r3.w = 67.5 + r3.w;
          r5.w = 0.0296296291 * r3.w;
          r6.w = (int)r5.w;
          r5.w = trunc(r5.w);
          r3.w = r3.w * 0.0296296291 + -r5.w;
          r5.w = r3.w * r3.w;
          r8.x = r5.w * r3.w;
          r10.yzw = float3(-0.166666672, -0.5, 0.166666672) * r8.xxx;
          r8.zw = r5.ww * float2(0.5, 0.5) + r10.yz;
          r8.zw = r3.ww * float2(-0.5, 0.5) + r8.zw;
          r3.w = r8.x * 0.5 + -r5.w;
          r3.w = 0.666666687 + r3.w;
          r11.xyz = cmp((int3)r6.www == int3(3, 2, 1));
          r8.xz = float2(0.166666672, 0.166666672) + r8.zw;
          r5.w = r6.w ? 0 : r10.w;
          r5.w = r11.z ? r8.z : r5.w;
          r3.w = r11.y ? r3.w : r5.w;
          r3.w = r11.x ? r8.x : r3.w;
        } else {
          r3.w = 0;
        }
        r1.w = r3.w * r1.w;
        ...
        r1.w = r2.w * r1.w;
        r9.x = r1.w * 0.180000007 + r9.y;
        r8.xyz = max(float3(0, 0, 0), r9.xzw);
        ...
        r1.w = dot(r8.xyz, float3(0.272228718, 0.674081743, 0.0536895171));
        r8.xyz = r8.xyz + -r1.www;
        r8.xyz = r8.xyz * float3(0.959999979, 0.959999979, 0.959999979) + r1.www;
        r8.xyz = max(float3(1.00000001e-10, 1.00000001e-10, 1.00000001e-10), r8.xyz);
        r8.xyz = log2(r8.xyz);
        r9.xyz = float3(0.30103001, 0.30103001, 0.30103001) * r8.xyz;
        r1.w = 0.30103001 * r7.x;
        r10.yzw = cmp(r1.www >= r9.xyz);
        if (r10.y != 0) {
          r2.w = -4;
        } else {
          r3.w = cmp(r1.w < r9.x);
          r5.w = 0.30103001 * r7.w;
          r6.w = cmp(r9.x < r5.w);
          r3.w = r3.w ? r6.w : 0;
          if (r3.w != 0) {
            r3.w = r8.x * 0.30103001 + -r1.w;
            r3.w = 3 * r3.w;
            r6.w = r7.w * 0.30103001 + -r1.w;
            r3.w = r3.w / r6.w;
            r6.w = (int)r3.w;
            r7.x = trunc(r3.w);
            r11.y = -r7.x + r3.w;
            r12.xy = (int2)r6.ww + int2(1, 2);
            r11.x = r11.y * r11.y;
            r13.x = icb[r6.w + 0].x;
            r13.y = icb[r12.x + 0].x;
            r13.z = icb[r12.y + 0].x;
            r12.x = dot(r13.xzy, float3(0.5, 0.5, -1));
            r12.y = dot(r13.xy, float2(-1, 1));
            r12.z = dot(r13.xy, float2(0.5, 0.5));
            r11.z = 1;
            r2.w = dot(r11.xyz, r12.xyz);
          } else {
            r3.w = cmp(r9.x >= r5.w);
            r6.w = 0.30103001 * r0.w;
            r6.w = cmp(r9.x < r6.w);
            r3.w = r3.w ? r6.w : 0;
            if (r3.w != 0) {
              r3.w = r8.x * 0.30103001 + -r5.w;
              r3.w = 3 * r3.w;
              r5.w = r0.w * 0.30103001 + -r5.w;
              r3.w = r3.w / r5.w;
              r5.w = (int)r3.w;
              r6.w = trunc(r3.w);
              r11.y = -r6.w + r3.w;
              r12.xyzw = cmp((int4)r5.wwww == int4(0, 1, 2, 3));
              r8.xw = cmp((int2)r5.ww == int2(4, 5));
              r12.xyzw = r12.xyzw ? float4(1, 1, 1, 1) : 0;
              r8.xw = r8.xw ? float2(1, 1) : 0;
              r3.w = r12.y * r7.y;
              r3.w = r12.x * r4.w + r3.w;
              r3.w = r12.z * r7.z + r3.w;
              r3.w = r12.w * r10.x + r3.w;
              r3.w = r8.x * r10.x + r3.w;
              r12.x = r8.w * r10.x + r3.w;
              r13.xyzw = (int4)r5.wwww + int4(1, 1, 2, 2);
              r14.xyzw = cmp((int4)r13.yyyy == int4(0, 1, 2, 3));
              r15.xyzw = cmp((int4)r13.xyzw == int4(4, 5, 4, 5));
              r14.xyzw = r14.xyzw ? float4(1, 1, 1, 1) : 0;
              r15.xyzw = r15.xyzw ? float4(1, 1, 1, 1) : 0;
              r3.w = r14.y * r7.y;
              r3.w = r14.x * r4.w + r3.w;
              r3.w = r14.z * r7.z + r3.w;
              r3.w = r14.w * r10.x + r3.w;
              r3.w = r15.x * r10.x + r3.w;
              r12.y = r15.y * r10.x + r3.w;
              r13.xyzw = cmp((int4)r13.wwww == int4(0, 1, 2, 3));
              r13.xyzw = r13.xyzw ? float4(1, 1, 1, 1) : 0;
              r3.w = r13.y * r7.y;
              r3.w = r13.x * r4.w + r3.w;
              r3.w = r13.z * r7.z + r3.w;
              r3.w = r13.w * r10.x + r3.w;
              r3.w = r15.z * r10.x + r3.w;
              r12.z = r15.w * r10.x + r3.w;
              r11.x = r11.y * r11.y;
              r13.x = dot(r12.xzy, float3(0.5, 0.5, -1));
              r13.y = dot(r12.xy, float2(-1, 1));
              r13.z = dot(r12.xy, float2(0.5, 0.5));
              r11.z = 1;
              r2.w = dot(r11.xyz, r13.xyz);
            } else {
              r2.w = r10.x;
            }
          }
        ...
        if (r10.z != 0) {
          ...
          r5.w = cmp(r1.w < r9.y);
          r6.w = 0.30103001 * r7.w;
          r7.x = cmp(r9.y < r6.w);
          r5.w = r5.w ? r7.x : 0;
          if (r5.w != 0) {
            r5.w = r8.y * 0.30103001 + -r1.w;
            r5.w = 3 * r5.w;
            r7.x = r7.w * 0.30103001 + -r1.w;
            r5.w = r5.w / r7.x;
            r7.x = (int)r5.w;
            r8.x = trunc(r5.w);
            r11.y = -r8.x + r5.w;
            r8.xw = (int2)r7.xx + int2(1, 2);
            r11.x = r11.y * r11.y;
            r12.x = icb[r7.x + 0].x;
            r12.y = icb[r8.x + 0].x;
            r12.z = icb[r8.w + 0].x;
            ...
            r5.w = cmp(r9.y >= r6.w);
            r7.x = 0.30103001 * r0.w;
            r7.x = cmp(r9.y < r7.x);
            r5.w = r5.w ? r7.x : 0;
            if (r5.w != 0) {
              r5.w = r8.y * 0.30103001 + -r6.w;
              r5.w = 3 * r5.w;
              r6.w = r0.w * 0.30103001 + -r6.w;
              r5.w = r5.w / r6.w;
              r6.w = (int)r5.w;
              r7.x = trunc(r5.w);
              r11.y = -r7.x + r5.w;
              r12.xyzw = cmp((int4)r6.wwww == int4(0, 1, 2, 3));
              r8.xy = cmp((int2)r6.ww == int2(4, 5));
              r12.xyzw = r12.xyzw ? float4(1, 1, 1, 1) : 0;
              r8.xy = r8.xy ? float2(1, 1) : 0;
              r5.w = r12.y * r7.y;
              r5.w = r12.x * r4.w + r5.w;
              r5.w = r12.z * r7.z + r5.w;
              r5.w = r12.w * r10.x + r5.w;
              r5.w = r8.x * r10.x + r5.w;
              r12.x = r8.y * r10.x + r5.w;
              r13.xyzw = (int4)r6.wwww + int4(1, 1, 2, 2);
              r14.xyzw = cmp((int4)r13.yyyy == int4(0, 1, 2, 3));
              r15.xyzw = cmp((int4)r13.xyzw == int4(4, 5, 4, 5));
              r14.xyzw = r14.xyzw ? float4(1, 1, 1, 1) : 0;
              r15.xyzw = r15.xyzw ? float4(1, 1, 1, 1) : 0;
              r5.w = r14.y * r7.y;
              r5.w = r14.x * r4.w + r5.w;
              r5.w = r14.z * r7.z + r5.w;
              r5.w = r14.w * r10.x + r5.w;
              r5.w = r15.x * r10.x + r5.w;
              r12.y = r15.y * r10.x + r5.w;
              r13.xyzw = cmp((int4)r13.wwww == int4(0, 1, 2, 3));
              r13.xyzw = r13.xyzw ? float4(1, 1, 1, 1) : 0;
              r5.w = r13.y * r7.y;
              r5.w = r13.x * r4.w + r5.w;
              r5.w = r13.z * r7.z + r5.w;
              r5.w = r13.w * r10.x + r5.w;
              r5.w = r15.z * r10.x + r5.w;
              r12.z = r15.w * r10.x + r5.w;
              r11.x = r11.y * r11.y;
              r13.x = dot(r12.xzy, float3(0.5, 0.5, -1));
              r13.y = dot(r12.xy, float2(-1, 1));
              r13.z = dot(r12.xy, float2(0.5, 0.5));
        ...
        if (r10.w != 0) {
          ...
          r5.w = r5.w ? r7.x : 0;
          if (r5.w != 0) {
            r5.w = r8.z * 0.30103001 + -r1.w;
            r5.w = 3 * r5.w;
            r1.w = r7.w * 0.30103001 + -r1.w;
            r1.w = r5.w / r1.w;
            r5.w = (int)r1.w;
            r7.x = trunc(r1.w);
            r11.y = -r7.x + r1.w;
            r7.xw = (int2)r5.ww + int2(1, 2);
            r11.x = r11.y * r11.y;
            r12.x = icb[r5.w + 0].x;
            r12.y = icb[r7.x + 0].x;
            r12.z = icb[r7.w + 0].x;
            ...
            r13.z = dot(r12.xy, float2(0.5, 0.5));
            r11.z = 1;
            r10.x = dot(r11.xyz, r13.xyz);
          } else {
            r1.w = cmp(r9.z >= r6.w);
            r5.w = 0.30103001 * r0.w;
            r5.w = cmp(r9.z < r5.w);
            r1.w = r1.w ? r5.w : 0;
            if (r1.w != 0) {
              r1.w = r8.z * 0.30103001 + -r6.w;
              r1.w = 3 * r1.w;
              r0.w = r0.w * 0.30103001 + -r6.w;
              r0.w = r1.w / r0.w;
              r1.w = (int)r0.w;
              r5.w = trunc(r0.w);
              r8.y = -r5.w + r0.w;
              r9.xyzw = cmp((int4)r1.wwww == int4(0, 1, 2, 3));
              r7.xw = cmp((int2)r1.ww == int2(4, 5));
              ...
              r0.w = r7.x * r10.x + r0.w;
              r9.x = r7.w * r10.x + r0.w;
              ...
              r13.xyzw = r13.xyzw ? float4(1, 1, 1, 1) : 0;
              r0.w = r12.y * r7.y;
              r0.w = r12.x * r4.w + r0.w;
              r0.w = r12.z * r7.z + r0.w;
              r0.w = r12.w * r10.x + r0.w;
              r0.w = r13.x * r10.x + r0.w;
              r9.y = r13.y * r10.x + r0.w;
              r11.xyzw = cmp((int4)r11.wwww == int4(0, 1, 2, 3));
              r11.xyzw = r11.xyzw ? float4(1, 1, 1, 1) : 0;
              r0.w = r11.y * r7.y;
              r0.w = r11.x * r4.w + r0.w;
              r0.w = r11.z * r7.z + r0.w;
              r0.w = r11.w * r10.x + r0.w;
              r0.w = r13.z * r10.x + r0.w;
              r9.z = r13.w * r10.x + r0.w;
              r8.x = r8.y * r8.y;
              r7.x = dot(r9.xzy, float3(0.5, 0.5, -1));
              r7.y = dot(r9.xy, float2(-1, 1));
              r7.z = dot(r9.xy, float2(0.5, 0.5));
              r8.z = 1;
              r10.x = dot(r8.xyz, r7.xyz);
            }
          }
        }
        r0.w = 3.32192802 * r10.x;
        r0.w = exp2(r0.w);
        r1.w = -9.99999975e-05 + r2.w;
        r7.xy = float2(-9.99999975e-05, -0.5) + cb0[66].xy;
        r8.x = r1.w / r7.x;
        r1.w = -9.99999975e-05 + r3.w;
        r8.y = r1.w / r7.x;
        r0.w = -9.99999975e-05 + r0.w;
        r8.z = r0.w / r7.x;
        r9.x = dot(float3(0.662454188, 0.134004205, 0.156187683), r8.xyz);
        r9.y = dot(float3(0.272228718, 0.674081743, 0.0536895171), r8.xyz);
        r9.z = dot(float3(-0.00557464967, 0.0040607336, 1.01033914), r8.xyz);
        r8.x = saturate(dot(float3(1.6410234, -0.324803293, -0.236424699), r9.xyz));
        r8.y = saturate(dot(float3(-0.663662851, 1.61533165, 0.0167563483), r9.xyz));
        r8.z = saturate(dot(float3(0.0117218941, -0.00828444213, 0.988394856), r9.xyz));
        r9.x = dot(float3(0.662454188, 0.134004205, 0.156187683), r8.xyz);
        r9.y = dot(float3(0.272228718, 0.674081743, 0.0536895171), r8.xyz);
        r9.z = dot(float3(-0.00557464967, 0.0040607336, 1.01033914), r8.xyz);
        r0.w = dot(float3(1.6410234, -0.324803293, -0.236424699), r9.xyz);
        r1.w = dot(float3(-0.663662851, 1.61533165, 0.0167563483), r9.xyz);
        r2.w = dot(float3(0.0117218941, -0.00828444213, 0.988394856), r9.xyz);
        r3.w = 1 + -cb0[66].y;
        r4.w = r7.y * 2 + -0.5;
        r5.w = 1 + -r0.w;
        r6.w = r5.w + r5.w;
        r7.x = cmp(r5.w < 0);
        r7.y = r6.w * r4.w + -cb0[66].y;
        r5.w = cmp(0.5 < r5.w);
        r7.z = r6.w * r3.w + r4.w;
        r6.w = r7.z * r6.w + -cb0[66].y;
        r0.w = r5.w ? r0.w : -r6.w;
        r7.x = r7.x ? -r7.y : r0.w;
        r0.w = 1 + -r1.w;
        r5.w = r0.w + r0.w;
        r6.w = cmp(r0.w < 0);
        r7.w = r5.w * r4.w + -cb0[66].y;
        r0.w = cmp(0.5 < r0.w);
        r8.x = r5.w * r3.w + r4.w;
        r5.w = r8.x * r5.w + -cb0[66].y;
        r0.w = r0.w ? r1.w : -r5.w;
        r7.y = r6.w ? -r7.w : r0.w;
        r0.w = 1 + -r2.w;
        r1.w = r0.w + r0.w;
        r5.w = cmp(r0.w < 0);
        r6.w = r1.w * r4.w + -cb0[66].y;
        r0.w = cmp(0.5 < r0.w);
        r3.w = r1.w * r3.w + r4.w;
        r1.w = r3.w * r1.w + -cb0[66].y;
        r0.w = r0.w ? r2.w : -r1.w;
        r7.z = r5.w ? -r6.w : r0.w;
        r7.xyz = cb0[66].yyy * r7.xyz;
        r7.xyz = max(float3(0, 0, 0), r7.xyz);
        r7.xyz = min(float3(65535, 65535, 65535), r7.xyz);
        r7.xyz = cb0[66].xxx * r7.xyz;
        r7.xyz = max(float3(0, 0, 0), r7.xyz);
        r7.xyz = min(float3(65535, 65535, 65535), r7.xyz);
        r8.x = dot(r5.xyz, r7.xyz);
        r8.y = dot(r6.xyz, r7.xyz);
