...
// ---- Created with 3Dmigoto v1.3.2 on Mon Dec 30 00:29:03 2024
...
void main(
  ...
  r2.xyz = cb0[46].xxx * float3(0.000154118257, 0.00084242021, 4.22806261e-005) + float3(0.860117733, 1, 0.317398727);
  r0.w = cb0[46].x * cb0[46].x;
  r2.xyz = r0.www * float3(1.28641219e-007, 7.08145137e-007, 4.20481676e-008) + r2.xyz;
  r2.x = r2.x / r2.y;
  r1.z = -cb0[46].x * 2.8974182e-005 + 1;
  ...
  cb_config.ue_bluecorrection = asfloat(cb0[68].x);
  cb_config.ue_colorscale = asfloat(cb0[43].yzw);
  float4 lutweights[2] = {float4(asfloat(cb0[39].x), asfloat(cb0[40].x), asfloat(cb0[41].x), 0.f), float4(0.f, 0.f, 0.f, 0.f)};
  cb_config.ue_lutweights = lutweights;
  o0 = ProcessLutbuilder(float3(untonemapped_ap1), s0_s, s1_s, t0, t1, cb_config, o0, asuint(cb0[67].z));
  return;
  ...
  r2.x = dot(float3(0.938639402, 1.02359565e-010, 0.0613606237), r0.xyz);
  r2.y = dot(float3(8.36008554e-011, 0.830794156, 0.169205874), r0.xyz);
  r2.z = dot(float3(2.13187367e-012, -5.63307213e-012, 1), r0.xyz);
  r2.xyz = r2.xyz + -r0.xyz;
  r0.xyz = cb0[68].xxx * r2.xyz + r0.xyz;
  ...
  if (r0.w != 0) {
    ...
    r2.xyz = max(float3(0, 0, 0), r2.xyz);
    r2.xyz = r2.xyz + -r0.xyz;
    r0.xyz = cb0[68].zzz * r2.xyz + r0.xyz;
  }
  [branch]
  ...
  r3.xyz = cb0[40].xxx * r3.xyz;
  r0.xyz = cb0[39].xxx * r0.xyz + r3.xyz;
  ...
  if (asuint(cb0[67].z) == 0) {
    ...
    r4.xyzw = cmp(asint(cb0[67].wwww) == int4(1, 2, 3, 4));
