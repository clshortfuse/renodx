// Sprawl Zero (UE 5.7.4.0)

#include "../lutbuilderoutput.hlsli"

// ---- Created with 3Dmigoto v1.4.1 on Mon Jun 22 14:22:29 2026
...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  ...
  if (r0.w != 0) {
    ...
    r4.xyzw = (asuint(cb0[40].w) != 0u) ? r4.xyzw : r4.zwxy;
    ...
    r8.y = r5.y;
    r8.z = r6.y;
    r1.y = dot(float3(0.986992896, -0.1470543, 0.159962699), r8.xyz);
    r6.x = r4.z;
    r6.y = r5.z;
  ...
  r4.x = dot(cb1[8].xyz, r2.xyz);
  r4.y = dot(cb1[9].xyz, r2.xyz);
  r4.z = dot(cb1[10].xyz, r2.xyz);
  ...
  r0.w = 1 + -r0.w;
  r0.w = r1.y * r0.w;
  r2.x = dot(float3(1.37041235, -0.329292178, -0.0636831224), r4.xyz);
  r2.y = dot(float3(-0.083433494, 1.09709275, -0.0108613791), r4.xyz);
  r2.z = dot(float3(-0.0257933214, -0.0986258015, 1.20369494), r4.xyz);
  ...
  r2.xyz = cb0[38].zzz * r4.xyz + r2.xyz;
  r4.y = dot(float3(0.695452213, 0.140678704, 0.163869068), r2.xyz);
  r4.z = dot(float3(0.0447945632, 0.859671116, 0.0955343172), r2.xyz);
  r4.w = dot(float3(-0.00552588236, 0.00402521016, 1.00150073), r2.xyz);
  r0.w = min(r4.y, r4.z);
  r0.w = min(r0.w, r4.w);
  r1.y = max(r4.y, r4.z);
  r1.y = max(r1.y, r4.w);
  r5.xy = max(float2(1.00000001e-10, 0.00999999978), r1.yy);
  ...
  r4.xyz = max(float3(0, 0, 0), r4.xyz);
  r4.xyz = r4.xyz + -r2.xyz;
  r2.xyz = cb0[39].xxx * r4.xyz + r2.xyz;
  r4.x = dot(float3(1.06537485, 1.44678506e-06, -0.0653710067), r2.xyz);
  r4.y = dot(float3(-3.45525592e-07, 1.20366347, -0.203667715), r2.xyz);
  r4.z = dot(float3(1.9865448e-08, 2.12079581e-08, 0.999999583), r2.xyz);
  r4.xyz = r4.xyz + -r2.xyz;
  r2.xyz = cb0[38].zzz * r4.xyz + r2.xyz;
  r4.x = dot(cb1[12].xyz, r2.xyz);
  r4.y = dot(cb1[13].xyz, r2.xyz);
  r4.z = dot(cb1[14].xyz, r2.xyz);
  r2.xyz = max(float3(0, 0, 0), r4.xyz);
  r4.xyz = r2.xyz * r2.xyz;
  r2.xyz = cb0[41].yyy * r2.xyz;
  r2.xyz = cb0[41].xxx * r4.xyz + r2.xyz;
  r2.xyz = cb0[41].zzz + r2.xyz;
  r4.xyz = cb0[16].xyz * r2.xyz;
  r2.xyz = -r2.xyz * cb0[16].xyz + cb0[15].xyz;
  r2.xyz = cb0[15].www * r2.xyz + r4.xyz;
  r2.xyz = max(float3(0, 0, 0), r2.xyz);
  r2.xyz = log2(r2.xyz);
  r2.xyz = cb0[42].yyy * r2.xyz;
  r2.xyz = exp2(r2.xyz);
  r4.x = dot(cb1[8].xyz, r2.xyz);
  r4.y = dot(cb1[9].xyz, r2.xyz);
  r4.z = dot(cb1[10].xyz, r2.xyz);
  r1.x = dot(r1.xzw, r4.xyz);
  r1.y = dot(r3.xyz, r4.xyz);
  r1.z = dot(r0.xyz, r4.xyz);
  r0.xyz = (asuint(cb1[24].x) != 0u) ? r2.xyz : r1.xyz;
