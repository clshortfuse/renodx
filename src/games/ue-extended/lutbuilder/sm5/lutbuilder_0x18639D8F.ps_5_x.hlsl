...
// ---- Created with 3Dmigoto v1.4.1 on Sun Mar 30 14:35:36 2025
...
void main(
  ...
  r0.w = 1.00055635 * cb0[38].x;
  r1.x = cmp(6996.10791 >= cb0[38].x);
  ...
  r2.xyz = cb0[38].xxx * float3(0.000154118257, 0.00084242021, 4.22806261e-05) + float3(0.860117733, 1, 0.317398727);
  r0.w = cb0[38].x * cb0[38].x;
  r2.xyz = r0.www * float3(1.28641219e-07, 7.08145137e-07, 4.20481676e-08) + r2.xyz;
  r2.x = r2.x / r2.y;
  r1.z = -cb0[38].x * 2.8974182e-05 + 1;
  ...
  r1.xyzw = cb0[44].xyzw * cb0[39].xyzw;
  r2.xyzw = cb0[45].xyzw * cb0[40].xyzw;
  ...
  r1.w = r1.w * r1.w;
  r1.w = -r2.x * r1.w + 1;
  r2.xyzw = cb0[54].xyzw * cb0[39].xyzw;
  r3.xyzw = cb0[55].xyzw * cb0[40].xyzw;
  ...
  r2.w = r2.w * r2.w;
  r3.y = r3.x * r2.w;
  r4.xyzw = cb0[49].xyzw * cb0[39].xyzw;
  r5.xyzw = cb0[50].xyzw * cb0[40].xyzw;
  r6.xyzw = cb0[51].xyzw * cb0[41].xyzw;
  r7.xyzw = cb0[52].xyzw * cb0[42].xyzw;
  r8.xyzw = cb0[53].xyzw + cb0[43].xyzw;
  ...
  cb_config.ue_filmblackclip = asfloat(cb0[30].w);
  cb_config.ue_filmtoe = asfloat(cb0[30].y);
  cb_config.ue_filmshoulder = asfloat(cb0[30].z);
  cb_config.ue_filmslope = asfloat(cb0[30].x);
  cb_config.ue_filmwhiteclip = asfloat(cb0[31].x);
  cb_config.ue_tonecurveammount = 1.f;
  cb_config.ue_mappingpolynomial = asfloat(cb0[20].xyz);
  cb_config.ue_overlaycolor = asfloat(cb0[37].xyzw);
  cb_config.ue_bluecorrection = 0.f;
  cb_config.ue_colorscale = asfloat(cb0[36].yzw);
  o0 = ProcessLutbuilder(float3(untonemapped_ap1), cb_config, o0, asuint(cb0[59].z));
  return;
  ...
  r0.x = cmp(cb0[29].w == 0.000000);
  if (r0.x != 0) {
    r0.x = dot(r1.xyz, cb0[22].xyz);
    r0.y = dot(r1.xyz, cb0[23].xyz);
    r0.z = dot(r1.xyz, cb0[24].xyz);
    r0.w = dot(r1.xyz, cb0[27].xyz);
    r0.w = 1 + r0.w;
    r0.w = rcp(r0.w);
    r2.xyz = cb0[29].xyz * r0.www + cb0[28].xyz;
    r0.xyz = r2.xyz * r0.xyz;
    r0.xyz = max(float3(0, 0, 0), r0.xyz);
    r2.xyz = cb0[25].xxx + -r0.xyz;
    r2.xyz = max(float3(0, 0, 0), r2.xyz);
    r3.xyz = max(cb0[25].zzz, r0.xyz);
    r0.xyz = max(cb0[25].xxx, r0.xyz);
    r0.xyz = min(cb0[25].zzz, r0.xyz);
    r4.xyz = r3.xyz * cb0[26].xxx + cb0[26].yyy;
    r3.xyz = cb0[25].www + r3.xyz;
    r3.xyz = rcp(r3.xyz);
    r5.xyz = cb0[22].www * r2.xyz;
    r2.xyz = cb0[25].yyy + r2.xyz;
    r2.xyz = rcp(r2.xyz);
    r2.xyz = r5.xyz * r2.xyz + cb0[23].www;
    r0.xyz = r0.xyz * cb0[24].www + r2.xyz;
    ...
    r3.xy = float2(1, 0.180000007) + cb0[30].ww;
    r0.w = -cb0[30].y + r3.x;
    r1.w = 1 + cb0[31].x;
    r2.w = -cb0[30].z + r1.w;
    r3.x = cmp(0.800000012 < cb0[30].y);
    r3.zw = float2(0.819999993, 1) + -cb0[30].yy;
    r3.zw = r3.zw / cb0[30].xx;
  ...
  r0.xyz = cb0[20].xxx * r2.xyz + r0.xyz;
  r0.xyz = cb0[20].zzz + r0.xyz;
  r2.xyz = cb0[36].yzw * r0.xyz;
  r0.xyz = -r0.xyz * cb0[36].yzw + cb0[37].xyz;
  r0.xyz = cb0[37].www * r0.xyz + r2.xyz;
  r0.xyz = max(float3(0, 0, 0), r0.xyz);
  r0.xyz = log2(r0.xyz);
  r0.xyz = cb0[21].yyy * r0.xyz;
  r2.xyz = exp2(r0.xyz);

  [branch] if (asuint(cb0[59].z) == 0) {
    ...
    r3.xyzw = cmp(asint(cb0[59].wwww) == int4(1, 2, 3, 4));
    ...
    if (r0.w != 0) {
      ...
      r6.xy = cmp(asint(cb0[59].zz) == int2(3, 5));
      ...
      if (r0.w != 0) {
        ...
        r6.xy = cmp(asint(cb0[59].zz) == int2(4, 6));
        r0.w = (int)r6.y | (int)r6.x;
        if (r0.w != 0) {
