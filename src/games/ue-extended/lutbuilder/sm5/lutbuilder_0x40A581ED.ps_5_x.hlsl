// ---- Created with 3Dmigoto v1.3.16 on Mon Mar 31 03:29:58 2025
// Found in Spyro
...
void main(
  ...
  r2.xyz = cb0[36].xxx * float3(0.000154118257, 0.00084242021, 4.22806261e-05) + float3(0.860117733, 1, 0.317398727);
  r0.w = cb0[36].x * cb0[36].x;
  r2.xyz = r0.www * float3(1.28641219e-07, 7.08145137e-07, 4.20481676e-08) + r2.xyz;
  r2.x = r2.x / r2.y;
  r1.z = -cb0[36].x * 2.8974182e-05 + 1;
  ...
  r1.xyzw = cb0[42].xyzw * cb0[37].xyzw;
  r2.xyzw = cb0[43].xyzw * cb0[38].xyzw;
  r3.xyzw = cb0[44].xyzw * cb0[39].xyzw;
  r4.xyzw = cb0[45].xyzw * cb0[40].xyzw;
  r5.xyzw = cb0[46].xyzw + cb0[41].xyzw;
  ...
  r1.w = r1.w * r1.w;
  r1.w = -r2.x * r1.w + 1;
  r2.xyzw = cb0[52].xyzw * cb0[37].xyzw;
  r3.xyzw = cb0[53].xyzw * cb0[38].xyzw;
  r4.xyzw = cb0[54].xyzw * cb0[39].xyzw;
  r5.xyzw = cb0[55].xyzw * cb0[40].xyzw;
  r6.xyzw = cb0[56].xyzw + cb0[41].xyzw;
  r2.xyz = r2.xyz * r2.www;
  ...
  r2.w = r2.w * r2.w;
  r3.y = r3.x * r2.w;
  r4.xyzw = cb0[47].xyzw * cb0[37].xyzw;
  r5.xyzw = cb0[48].xyzw * cb0[38].xyzw;
  r6.xyzw = cb0[49].xyzw * cb0[39].xyzw;
  r7.xyzw = cb0[50].xyzw * cb0[40].xyzw;
  r8.xyzw = cb0[51].xyzw + cb0[41].xyzw;
  ...
  cb_config.ue_filmblackclip = asfloat(cb0[28].w);
  cb_config.ue_filmtoe = asfloat(cb0[28].y);
  cb_config.ue_filmshoulder = asfloat(cb0[28].z);
  cb_config.ue_filmslope = asfloat(cb0[28].x);
  cb_config.ue_filmwhiteclip = asfloat(cb0[29].x);
  cb_config.ue_tonecurveammount = 1.f;
  cb_config.ue_mappingpolynomial = asfloat(cb0[18].xyz);
  cb_config.ue_overlaycolor = asfloat(cb0[35].xyzw);
  cb_config.ue_bluecorrection = asfloat(cb0[58].x);
  cb_config.ue_colorscale = asfloat(cb0[34].yzw);
  o0 = ProcessLutbuilder(float3(untonemapped_ap1), cb_config, o0, asuint(cb0[57].z));
  return;
  ...
  r0.w = cmp(cb0[27].w == 0.000000);
  if (r0.w != 0) {
    r2.x = dot(r1.xyz, cb0[20].xyz);
    r2.y = dot(r1.xyz, cb0[21].xyz);
    r2.z = dot(r1.xyz, cb0[22].xyz);
    r0.w = dot(r1.xyz, cb0[25].xyz);
    r0.w = 1 + r0.w;
    r0.w = rcp(r0.w);
    r3.xyz = cb0[27].xyz * r0.www + cb0[26].xyz;
    r2.xyz = r3.xyz * r2.xyz;
    r2.xyz = max(float3(0, 0, 0), r2.xyz);
    r3.xyz = cb0[23].xxx + -r2.xyz;
    r3.xyz = max(float3(0, 0, 0), r3.xyz);
    r4.xyz = max(cb0[23].zzz, r2.xyz);
    r2.xyz = max(cb0[23].xxx, r2.xyz);
    r2.xyz = min(cb0[23].zzz, r2.xyz);
    r5.xyz = r4.xyz * cb0[24].xxx + cb0[24].yyy;
    r4.xyz = cb0[23].www + r4.xyz;
    r4.xyz = rcp(r4.xyz);
    r6.xyz = cb0[20].www * r3.xyz;
    r3.xyz = cb0[23].yyy + r3.xyz;
    r3.xyz = rcp(r3.xyz);
    r3.xyz = r6.xyz * r3.xyz + cb0[21].www;
    r2.xyz = r2.xyz * cb0[22].www + r3.xyz;
    ...
    r0.xyz = cb0[58].xxx * r3.xyz + r0.xyz;
    ...
    r3.xy = float2(1, 0.180000007) + cb0[28].ww;
    r0.w = -cb0[28].y + r3.x;
    r1.w = 1 + cb0[29].x;
    r2.w = -cb0[28].z + r1.w;
    r3.x = cmp(0.800000012 < cb0[28].y);
    r3.zw = float2(0.819999993, 1) + -cb0[28].yy;
    r3.zw = r3.zw / cb0[28].xx;
  ...
  r0.xyz = cb0[18].xxx * r0.xyz + r2.xyz;
  r0.xyz = cb0[18].zzz + r0.xyz;
  r2.xyz = cb0[34].yzw * r0.xyz;
  ...
  if (asuint(cb0[57].z) == 0) {
    ...
    r3.xyzw = cmp(asint(cb0[57].wwww) == int4(1, 2, 3, 4));
    ...
    if (r0.w != 0) {
      ...
      r6.xy = cmp(asint(cb0[57].zz) == int2(3, 5));
      ...
      if (r0.w != 0) {
        ...
        r6.xy = cmp(asint(cb0[57].zz) == int2(4, 6));
        r0.w = (int)r6.y | (int)r6.x;
        if (r0.w != 0) {
          r6.xyz = float3(1.5, 1.5, 1.5) * r1.xyz;
          r7.y = dot(float3(0.439700812, 0.382978052, 0.1773348), r6.xyz);
