...
// Found in Wanted: Dead

// ---- Created with 3Dmigoto v1.3.16 on Sun Jun 22 15:38:51 2025
...
void main(
  ...
  r0.w = 1.00055635 * cb0[45].z;
  r0.w = 1 / r0.w;
  r1.x = cmp(6996.10791 >= cb0[45].z);
  ...
  r2.xyz = cb0[45].zzz * float3(0.000154118257, 0.00084242021, 4.22806261e-05) + float3(0.860117733, 1, 0.317398727);
  r0.w = cb0[45].z * cb0[45].z;
  r2.xyz = r0.www * float3(1.28641219e-07, 7.08145137e-07, 4.20481676e-08) + r2.xyz;
  r2.x = r2.x / r2.y;
  r1.z = -cb0[45].z * 2.8974182e-05 + 1;
  ...
  r1.xyzw = (asuint(cb0[45].x) != 0u) ? r1.xyzw : r1.zwxy;
  ...
  r0.xyz = (asuint(cb0[45].y) != 0u) ? r0.xyz : r1.xyz;
  r0.w = dot(r0.xyz, float3(0.272228718, 0.674081743, 0.0536895171));
  r1.xyzw = cb0[51].xyzw * cb0[46].xyzw;
  r2.xyzw = cb0[52].xyzw * cb0[47].xyzw;
  r3.xyzw = cb0[53].xyzw * cb0[48].xyzw;
  r4.xyzw = cb0[54].xyzw * cb0[49].xyzw;
  r5.xyzw = cb0[55].xyzw + cb0[50].xyzw;
  ...
  r1.w = r1.w * r1.w;
  r1.w = -r2.x * r1.w + 1;
  r2.xyzw = cb0[61].xyzw * cb0[46].xyzw;
  r3.xyzw = cb0[62].xyzw * cb0[47].xyzw;
  r4.xyzw = cb0[63].xyzw * cb0[48].xyzw;
  r5.xyzw = cb0[64].xyzw * cb0[49].xyzw;
  r6.xyzw = cb0[65].xyzw + cb0[50].xyzw;
  r2.xyz = r2.xyz * r2.www;
  ...
  if (asuint(cb0[45].y) != 0) {
    ...
    r0.w = dot(r1.xyz, cb0[34].xyz);
    r0.w = 1 + r0.w;
    r0.w = rcp(r0.w);
    r3.xyz = cb0[36].xyz * r0.www + cb0[35].xyz;
    r2.xyz = r3.xyz * r2.xyz;
    r2.xyz = max(float3(0, 0, 0), r2.xyz);
    ...
    r0.xyz = cb0[67].xxx * r3.xyz + r0.xyz;
    ...
    r4.xz = float2(0.819999993, 1) + -cb0[37].yy;
    r4.xz = r4.xz / cb0[37].xx;
    r4.y = r4.y / r0.w;
  ...
  if (asuint(cb0[66].z) == 0) {
    ...
    if (r0.w != 0) {
      ...
      if (r0.w != 0) {
        r0.w = cmp(0 >= cb0[28].w);
        r1.w = dot(r1.xyz, float3(0.216000006, 0.715200007, 0.0722000003));
        ...
        r7.xyz = r2.www ? r7.xyz : r1.xyz;
        r7.xyz = cb0[28].zzz * r7.xyz;
        r1.w = 1000 / cb0[28].w;
        r1.w = cb0[28].w + -r1.w;
        r1.w = 1000 / r1.w;
        ...
        r8.xyz = cb0[28].zzz * r8.xyz;
        r7.xyz = r0.www ? r7.xyz : r8.xyz;
        r7.xyz = float3(1.5, 1.5, 1.5) * r7.xyz;
        ...
        r7.xy = cmp(asint(cb0[66].zz) == int2(4, 6));
        r0.w = (int)r7.y | (int)r7.x;
        if (r0.w != 0) {
          ...
          if (r0.w != 0) {
            ...
            r4.y = log2(r1.w);
            r4.z = log2(r2.x);
            r2.xyz = cb0[27].zzz * r4.xyz;
            r2.xyz = exp2(r2.xyz);
            r0.xyz = r7.yyy ? r0.xyz : r2.xyz;
            r3.xyz = r7.xxx ? r1.xyz : r0.xyz;
          }
        }
      }
    }
  }
  o0.xyz = float3(0.952381015, 0.952381015, 0.952381015) * r3.xyz;
  o0.w = 0;
