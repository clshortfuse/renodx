...
// ---- Created with 3Dmigoto v1.4.1 on Thu Mar 13 23:33:10 2025
...
void main(
  ...
  r2.xyz = cb0[29].xxx * float3(0.000154118257, 0.00084242021, 4.22806261e-05) + float3(0.860117733, 1, 0.317398727);
  ...
  o0 = ProcessLutbuilder(float3(untonemapped_ap1), cb_config, o0, asuint(cb0[34].w));
  return;
