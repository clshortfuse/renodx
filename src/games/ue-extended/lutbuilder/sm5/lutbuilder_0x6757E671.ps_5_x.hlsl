// ---- Created with 3Dmigoto v1.3.16 on Thu Apr  3 22:32:09 2025
// Found in Biomutant
...
void main(
  ...
  cb_config.ue_tonecurveammount = 1.f; // shader has no ToneCurveAmount cbuffer member (cb0[58] out of bounds)
  cb_config.ue_mappingpolynomial = asfloat(cb0[18].xyz);
  cb_config.ue_overlaycolor = asfloat(cb0[35].xyzw);
  cb_config.ue_bluecorrection = asfloat(cb0[18].x);
  ...
  r0.xyz = cb0[18].xxx * r2.xyz + r0.xyz;
