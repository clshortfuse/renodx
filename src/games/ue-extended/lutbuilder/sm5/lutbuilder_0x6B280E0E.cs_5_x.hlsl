...
// unknown dcl_: dcl_thread_group 8, 8, 8
  ...
  float3 untonemapped_ap1 = r0.yzw;
  ...
  cb_config.ue_overlaycolor = float4(0.f, 0.f, 0.f, 1.f); // no overlay color fingerprint found in dead code
  cb_config.ue_bluecorrection = asfloat(cb0[67].x); // blue correction fingerprint: cb0[67].xxx * delta + original after 0.938639 dots (line ~318)
  cb_config.ue_colorscale = float3(1.f, 1.f, 1.f); // no color scale fingerprint found in dead code
