// Marvel's Midnight Suns (UE 4.26.2.0)
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = 1.00055635 * cb0[53].y;
  r1.x = cmp(6996.10791 >= cb0[53].y);
  ...
  r2.xyz = cb0[53].yyy * float3(0.000154118257,0.00084242021,4.22806261e-05) + float3(0.860117733,1,0.317398727);
  r0.w = cb0[53].y * cb0[53].y;
  r2.xyz = r0.www * float3(1.28641219e-07,7.08145137e-07,4.20481676e-08) + r2.xyz;
  r2.x = r2.x / r2.y;
  r1.z = -cb0[53].y * 2.8974182e-05 + 1;
  ...
  r0.xyz = (asuint(cb0[53].x) != 0u) ? r0.xyz : r1.xyz;
  r0.w = dot(r0.xyz, float3(0.272228718,0.674081743,0.0536895171));
  r1.xyzw = cb0[59].xyzw * cb0[54].xyzw;
  r2.xyzw = cb0[60].xyzw * cb0[55].xyzw;
  r3.xyzw = cb0[61].xyzw * cb0[56].xyzw;
  r4.xyzw = cb0[62].xyzw * cb0[57].xyzw;
  r5.xyzw = cb0[63].xyzw + cb0[58].xyzw;
  ...
  r1.w = r1.w * r1.w;
  r1.w = -r2.x * r1.w + 1;
  r2.xyzw = cb0[69].xyzw * cb0[54].xyzw;
  r3.xyzw = cb0[70].xyzw * cb0[55].xyzw;
  r4.xyzw = cb0[71].xyzw * cb0[56].xyzw;
  r5.xyzw = cb0[72].xyzw * cb0[57].xyzw;
  r6.xyzw = cb0[73].xyzw + cb0[58].xyzw;
  r2.xyz = r2.xyz * r2.www;
  ...
  r2.w = r2.w * r2.w;
  r3.y = r3.x * r2.w;
  r4.xyzw = cb0[64].xyzw * cb0[54].xyzw;
  r5.xyzw = cb0[65].xyzw * cb0[55].xyzw;
  r6.xyzw = cb0[66].xyzw * cb0[56].xyzw;
  r7.xyzw = cb0[67].xyzw * cb0[57].xyzw;
  r8.xyzw = cb0[68].xyzw + cb0[58].xyzw;
  ...
  cb_config.ue_tonecurveammount = asfloat(cb0[75].z);
  cb_config.ue_mappingpolynomial = asfloat(cb0[26].xyz);
  cb_config.ue_overlaycolor = asfloat(cb0[52].xyzw);
  cb_config.ue_bluecorrection = asfloat(cb0[75].x);
  cb_config.ue_colorscale = asfloat(cb0[51].yzw);

  o0 = ProcessLutbuilder(float3(untonemapped_ap1), cb_config, o0, asuint(cb0[74].z));
  return;
  ...
  if (asuint(cb0[53].x) != 0) {
    ...
    r3.xyz = max(float3(0,0,0), r3.xyz);
    r3.xyz = r3.xyz + -r0.xyz;
    r0.xyz = cb0[75].zzz * r3.xyz + r0.xyz;
  ...
  r2.xyz = cb0[51].yzw * r0.xyz;
  r0.xyz = -r0.xyz * cb0[51].yzw + cb0[52].xyz;
  r0.xyz = cb0[52].www * r0.xyz + r2.xyz;
  r2.x = dot(cb0[43].xyz, r0.xyz);
  r2.y = dot(cb0[44].xyz, r0.xyz);
  r2.z = dot(cb0[45].xyz, r0.xyz);
  r0.xyz = max(float3(0,0,0), r2.xyz);
  r2.xyz = log2(r0.xyz);
  r2.xyz = cb0[27].yyy * r2.xyz;
  r3.xyz = exp2(r2.xyz);
  [branch]
  if (asuint(cb0[74].z) == 0) {
    ...
    if (r0.w != 0) {
      ...
      r7.xyz = cb0[51].yzw * r1.xyz;
      r1.xyz = -r1.xyz * cb0[51].yzw + cb0[52].xyz;
      r1.xyz = cb0[52].www * r1.xyz + r7.xyz;
      r7.x = dot(cb0[43].xyz, r1.xyz);
      r7.y = dot(cb0[44].xyz, r1.xyz);
      r7.z = dot(cb0[45].xyz, r1.xyz);
      r1.xyz = max(float3(0,0,0), r7.xyz);
      r7.xyzw = cmp(asint(cb0[74].zzzz) == int4(3,5,4,6));
      r0.w = (int)r7.y | (int)r7.x;
      r0.w = (int)r7.z | (int)r0.w;
      r0.w = (int)r7.w | (int)r0.w;
      if (r0.w != 0) {
        r7.xyz = float3(1.5,1.5,1.5) * r1.xyz;
        r0.w = dot(float3(0.613191485,0.33951208,0.0473663323), r7.xyz);
        r1.w = dot(float3(0.0702069029,0.916335821,0.0134500116), r7.xyz);
        r2.w = dot(float3(0.0206188709,0.109567292,0.869606733), r7.xyz);
        r0.w = max(9.99999975e-05, r0.w);
        r0.w = log2(r0.w);
        r3.w = 0.30103001 * r0.w;
        r4.w = log2(cb0[37].y);
        r4.w = 0.30103001 * r4.w;
        r5.w = cmp(r4.w >= r3.w);
        if (r5.w != 0) {
          r5.w = log2(cb0[37].z);
          r6.w = cb0[37].w * r4.w;
          r5.w = r5.w * 0.30103001 + -r6.w;
          r5.w = r3.w * cb0[37].w + r5.w;
        } else {
          r6.w = cmp(r4.w < r3.w);
          r7.x = log2(cb0[38].x);
          ...
          r6.w = r6.w ? r7.z : 0;
          if (r6.w != 0) {
            r6.w = r0.w * 0.30103001 + -r4.w;
            r6.w = 3 * r6.w;
            r7.x = r7.x * 0.30103001 + -r4.w;
            r6.w = r6.w / r7.x;
            r7.x = (int)r6.w;
            r7.z = trunc(r6.w);
            r8.y = -r7.z + r6.w;
            r9.xyzw = cmp((int4)r7.xxxx == int4(3,2,1,0));
            r7.zw = cmp((int2)r7.xx == int2(4,5));
            r9.xyzw = r9.xyzw ? float4(1,1,1,1) : 0;
            r7.zw = r7.zw ? float2(1,1) : 0;
            r6.w = dot(r9.wzyx, cb0[40].xyzw);
            r6.w = r7.z * cb0[41].x + r6.w;
            r9.x = r7.w * cb0[41].y + r6.w;
            r10.xyzw = (int4)r7.xxxx + int4(1,1,2,2);
            ...
            r6.w = dot(r11.wzyx, cb0[40].xyzw);
            r6.w = r12.x * cb0[41].x + r6.w;
            r9.y = r12.y * cb0[41].y + r6.w;
            r10.xyzw = cmp((int4)r10.wwww == int4(3,2,1,0));
            r10.xyzw = r10.xyzw ? float4(1,1,1,1) : 0;
            r6.w = dot(r10.wzyx, cb0[40].xyzw);
            r6.w = r12.z * cb0[41].x + r6.w;
            r9.z = r12.w * cb0[41].y + r6.w;
            r8.x = r8.y * r8.y;
            ...
            r6.w = cmp(r3.w >= r7.y);
            r7.x = log2(cb0[39].x);
            r7.z = 0.30103001 * r7.x;
            r7.w = cmp(r3.w < r7.z);
            r6.w = r6.w ? r7.w : 0;
            if (r6.w != 0) {
              r0.w = r0.w * 0.30103001 + -r7.y;
              r0.w = 3 * r0.w;
              r6.w = r7.x * 0.30103001 + -r7.y;
              r0.w = r0.w / r6.w;
              r6.w = (int)r0.w;
              r7.x = trunc(r0.w);
              r8.y = -r7.x + r0.w;
              r9.xyzw = cmp((int4)r6.wwww == int4(0,1,2,3));
              r7.xy = cmp((int2)r6.ww == int2(4,5));
              r9.xyzw = r9.xyzw ? float4(1,1,1,1) : 0;
              r7.xy = r7.xy ? float2(1,1) : 0;
              r0.w = dot(r9.xy, cb0[41].zw);
              r0.w = r9.z * cb0[42].x + r0.w;
              r0.w = r9.w * cb0[42].y + r0.w;
              r0.w = r7.x * cb0[42].z + r0.w;
              r9.x = r7.y * cb0[42].w + r0.w;
              r10.xyzw = (int4)r6.wwww + int4(1,1,2,2);
              r11.xyzw = cmp((int4)r10.yyyy == int4(0,1,2,3));
              r12.xyzw = cmp((int4)r10.xyzw == int4(4,5,4,5));
              r11.xyzw = r11.xyzw ? float4(1,1,1,1) : 0;
              r12.xyzw = r12.xyzw ? float4(1,1,1,1) : 0;
              r0.w = dot(r11.xy, cb0[41].zw);
              r0.w = r11.z * cb0[42].x + r0.w;
              r0.w = r11.w * cb0[42].y + r0.w;
              r0.w = r12.x * cb0[42].z + r0.w;
              r9.y = r12.y * cb0[42].w + r0.w;
              r10.xyzw = cmp((int4)r10.wwww == int4(0,1,2,3));
              r10.xyzw = r10.xyzw ? float4(1,1,1,1) : 0;
              r0.w = dot(r10.xy, cb0[41].zw);
              r0.w = r10.z * cb0[42].x + r0.w;
              r0.w = r10.w * cb0[42].y + r0.w;
              r0.w = r12.z * cb0[42].z + r0.w;
              r9.z = r12.w * cb0[42].w + r0.w;
              r8.x = r8.y * r8.y;
              r10.x = dot(r9.xzy, float3(0.5,0.5,-1));
              r10.y = dot(r9.xy, float2(-1,1));
              r10.z = dot(r9.xy, float2(0.5,0.5));
        ...
        if (r3.w != 0) {
          r3.w = log2(cb0[37].z);
          r5.w = cb0[37].w * r4.w;
          r3.w = r3.w * 0.30103001 + -r5.w;
          r3.w = r1.w * cb0[37].w + r3.w;
        } else {
          r5.w = cmp(r4.w < r1.w);
          r6.w = log2(cb0[38].x);
          ...
          r5.w = r5.w ? r8.x : 0;
          if (r5.w != 0) {
            r5.w = r0.w * 0.30103001 + -r4.w;
            r5.w = 3 * r5.w;
            r6.w = r6.w * 0.30103001 + -r4.w;
            r5.w = r5.w / r6.w;
            r6.w = (int)r5.w;
            r8.x = trunc(r5.w);
            r8.y = -r8.x + r5.w;
            r9.xyzw = cmp((int4)r6.wwww == int4(3,2,1,0));
            r10.xy = cmp((int2)r6.ww == int2(4,5));
            r9.xyzw = r9.xyzw ? float4(1,1,1,1) : 0;
            r10.xy = r10.xy ? float2(1,1) : 0;
            r5.w = dot(r9.wzyx, cb0[40].xyzw);
            r5.w = r10.x * cb0[41].x + r5.w;
            r9.x = r10.y * cb0[41].y + r5.w;
            r10.xyzw = (int4)r6.wwww + int4(1,1,2,2);
            r11.xyzw = cmp((int4)r10.yyyy == int4(3,2,1,0));
            r12.xyzw = cmp((int4)r10.xyzw == int4(4,5,4,5));
            r11.xyzw = r11.xyzw ? float4(1,1,1,1) : 0;
            r12.xyzw = r12.xyzw ? float4(1,1,1,1) : 0;
            r5.w = dot(r11.wzyx, cb0[40].xyzw);
            r5.w = r12.x * cb0[41].x + r5.w;
            r9.y = r12.y * cb0[41].y + r5.w;
            r10.xyzw = cmp((int4)r10.wwww == int4(3,2,1,0));
            r10.xyzw = r10.xyzw ? float4(1,1,1,1) : 0;
            r5.w = dot(r10.wzyx, cb0[40].xyzw);
            r5.w = r12.z * cb0[41].x + r5.w;
            r9.z = r12.w * cb0[41].y + r5.w;
            r8.x = r8.y * r8.y;
            r10.x = dot(r9.xzy, float3(0.5,0.5,-1));
            r10.y = dot(r9.xy, float2(-1,1));
            r10.z = dot(r9.xy, float2(0.5,0.5));
            ...
            r5.w = cmp(r1.w >= r7.w);
            r6.w = log2(cb0[39].x);
            r8.x = 0.30103001 * r6.w;
            r8.y = cmp(r1.w < r8.x);
            r5.w = r5.w ? r8.y : 0;
            if (r5.w != 0) {
              r0.w = r0.w * 0.30103001 + -r7.w;
              r0.w = 3 * r0.w;
              r5.w = r6.w * 0.30103001 + -r7.w;
              r0.w = r0.w / r5.w;
              r5.w = (int)r0.w;
              r6.w = trunc(r0.w);
              r9.y = -r6.w + r0.w;
              r10.xyzw = cmp((int4)r5.wwww == int4(0,1,2,3));
              r8.yz = cmp((int2)r5.ww == int2(4,5));
              r10.xyzw = r10.xyzw ? float4(1,1,1,1) : 0;
              r8.yz = r8.yz ? float2(1,1) : 0;
              r0.w = dot(r10.xy, cb0[41].zw);
              r0.w = r10.z * cb0[42].x + r0.w;
              r0.w = r10.w * cb0[42].y + r0.w;
              r0.w = r8.y * cb0[42].z + r0.w;
              r10.x = r8.z * cb0[42].w + r0.w;
              r11.xyzw = (int4)r5.wwww + int4(1,1,2,2);
              r12.xyzw = cmp((int4)r11.yyyy == int4(0,1,2,3));
              r13.xyzw = cmp((int4)r11.xyzw == int4(4,5,4,5));
              r12.xyzw = r12.xyzw ? float4(1,1,1,1) : 0;
              r13.xyzw = r13.xyzw ? float4(1,1,1,1) : 0;
              r0.w = dot(r12.xy, cb0[41].zw);
              r0.w = r12.z * cb0[42].x + r0.w;
              r0.w = r12.w * cb0[42].y + r0.w;
              r0.w = r13.x * cb0[42].z + r0.w;
              r10.y = r13.y * cb0[42].w + r0.w;
              r11.xyzw = cmp((int4)r11.wwww == int4(0,1,2,3));
              r11.xyzw = r11.xyzw ? float4(1,1,1,1) : 0;
              r0.w = dot(r11.xy, cb0[41].zw);
              r0.w = r11.z * cb0[42].x + r0.w;
              r0.w = r11.w * cb0[42].y + r0.w;
              r0.w = r13.z * cb0[42].z + r0.w;
              r10.z = r13.w * cb0[42].w + r0.w;
              r9.x = r9.y * r9.y;
              ...
              r0.w = log2(cb0[39].y);
              r5.w = cb0[39].z * r8.x;
              r0.w = r0.w * 0.30103001 + -r5.w;
              r3.w = r1.w * cb0[39].z + r0.w;
            }
          }
        }
        ...
        if (r2.w != 0) {
          ...
          r3.w = r3.w ? r7.w : 0;
          if (r3.w != 0) {
            r3.w = r0.w * 0.30103001 + -r4.w;
            r3.w = 3 * r3.w;
            r4.w = r5.w * 0.30103001 + -r4.w;
            r3.w = r3.w / r4.w;
            r4.w = (int)r3.w;
            r5.w = trunc(r3.w);
            r8.y = -r5.w + r3.w;
            r9.xyzw = cmp((int4)r4.wwww == int4(3,2,1,0));
            r10.xy = cmp((int2)r4.ww == int2(4,5));
            r9.xyzw = r9.xyzw ? float4(1,1,1,1) : 0;
            r10.xy = r10.xy ? float2(1,1) : 0;
            r3.w = dot(r9.wzyx, cb0[40].xyzw);
            r3.w = r10.x * cb0[41].x + r3.w;
            r9.x = r10.y * cb0[41].y + r3.w;
            r10.xyzw = (int4)r4.wwww + int4(1,1,2,2);
            r11.xyzw = cmp((int4)r10.yyyy == int4(3,2,1,0));
            r12.xyzw = cmp((int4)r10.xyzw == int4(4,5,4,5));
            r11.xyzw = r11.xyzw ? float4(1,1,1,1) : 0;
            r12.xyzw = r12.xyzw ? float4(1,1,1,1) : 0;
            r3.w = dot(r11.wzyx, cb0[40].xyzw);
            r3.w = r12.x * cb0[41].x + r3.w;
            r9.y = r12.y * cb0[41].y + r3.w;
            r10.xyzw = cmp((int4)r10.wwww == int4(3,2,1,0));
            r10.xyzw = r10.xyzw ? float4(1,1,1,1) : 0;
            r3.w = dot(r10.wzyx, cb0[40].xyzw);
            r3.w = r12.z * cb0[41].x + r3.w;
            r9.z = r12.w * cb0[41].y + r3.w;
            r8.x = r8.y * r8.y;
            r10.x = dot(r9.xzy, float3(0.5,0.5,-1));
            r10.y = dot(r9.xy, float2(-1,1));
            r10.z = dot(r9.xy, float2(0.5,0.5));
            ...
            if (r3.w != 0) {
              r0.w = r0.w * 0.30103001 + -r6.w;
              r0.w = 3 * r0.w;
              r3.w = r4.w * 0.30103001 + -r6.w;
              r0.w = r0.w / r3.w;
              r3.w = (int)r0.w;
              r4.w = trunc(r0.w);
              r8.y = -r4.w + r0.w;
              r9.xyzw = cmp((int4)r3.wwww == int4(0,1,2,3));
              r10.xy = cmp((int2)r3.ww == int2(4,5));
              r9.xyzw = r9.xyzw ? float4(1,1,1,1) : 0;
              r10.xy = r10.xy ? float2(1,1) : 0;
              r0.w = dot(r9.xy, cb0[41].zw);
              r0.w = r9.z * cb0[42].x + r0.w;
              r0.w = r9.w * cb0[42].y + r0.w;
              r0.w = r10.x * cb0[42].z + r0.w;
              r9.x = r10.y * cb0[42].w + r0.w;
              ...
              r0.w = log2(cb0[39].y);
              r3.w = cb0[39].z * r5.w;
              r0.w = r0.w * 0.30103001 + -r3.w;
              r2.w = r1.w * cb0[39].z + r0.w;
            }
          }
        }
        r0.w = 3.32192802 * r2.w;
        r7.z = exp2(r0.w);
        r8.x = dot(r5.xyz, r7.xyz);
        r8.y = dot(r6.xyz, r7.xyz);
        r8.z = dot(r4.xyz, r7.xyz);
