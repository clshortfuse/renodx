// Generic UE 4.27 Lutbuilder (3 SDR LUTs)
// Found in BLACKTAIL

#include "../lutbuilderoutput.hlsli"

// ---- Created with 3Dmigoto v1.4.9 on Sat Jul 11 13:06:42 2026
  ...
  out float4 o0 : SV_Target0)
{
  ...
  // Three 16-cube SDR LUTs: result = cb0[38].x*prelut + cb0[39].x*LUT0(t0) + cb0[40].x*LUT1(t1) + cb0[41].x*LUT2(t2)
  float4 lutweights[2] = { float4(asfloat(cb0[38].x), asfloat(cb0[39].x), asfloat(cb0[40].x), asfloat(cb0[41].x)), float4(0.f, 0.f, 0.f, 0.f) };
  cb_config.ue_lutweights = lutweights;

  o0 = ProcessLutbuilder(float3(untonemapped_ap1), s0_s, s1_s, s2_s, t0, t1, t2, cb_config, o0, asuint(cb0[65].z));
  return;
