// ---- Created with 3Dmigoto v1.3.16 on Sun Oct  5 18:34:54 2025
// Found in  Little Nightmares Enhanced Edition
...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  ...
  float4 output = ProcessLutbuilder(float3(untonemapped_ap1), s0_s, t0, cb_config, u0[vThreadID.xyz], asuint(cb0[65].z));
  ...
  // store_uav_typed u0.xyzw, vThreadID.xyzz, r0.xyzw return;
  u0[vThreadID.xyz] = r0;
