// Sprawl Zero ini HDR (UE 5.7.4.0)

#include "../lutbuilderoutput.hlsli"

// ---- Created with 3Dmigoto v1.4.1 on Mon Jun 22 16:30:42 2026
...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  ...
  cb_config.ue_filmwhiteclip = asfloat(1.f);  // no white clip
  ...
  u0[vThreadID.xyz] = ProcessLutbuilder(float3(untonemapped_ap1), cb_config, u0[vThreadID.xyz], asuint(cb0[42].w));
  return;
