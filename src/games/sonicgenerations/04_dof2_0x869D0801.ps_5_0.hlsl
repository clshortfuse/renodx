...
Texture2D<float4> g_SourceLow : register(t1);
Texture2D<float4> s2 : register(t2);
Texture2D<float4> s3 : register(t3);
  ...
  out float4 o3 : SV_Target3)
{
  ...
  r1.xyz = g_Source.Sample(g_Source_s_s, r0.yz).xyz;
  r2.xyzw = g_SourceLow.Sample(g_SourceLow_s_s, r0.yz).xyzw;
  r0.yzw = r2.xyz + -r1.xyz;
  r1.w = g_Param3.z * r2.w;
  r0.yzw = r1.www * r0.yzw * injectedData.fxDoF + r1.xyz;
