  ...
  out float4 o3 : SV_Target3)
{
  ...
  r1.y = g_DepthOfFieldFocusNearFarRange.w + g_DepthOfFieldFocusNearFarRange.x;
  r1.x = min(r1.y, -r1.x);
  r1.y = r0.y * -r0.z + -r1.x;
  r0.y = r0.y * -r0.z + -g_DepthOfFieldFocusNearFarRange.x;
  r0.yw = cmp(r0.yw >= float2(0,0));
  r0.z = g_DepthOfFieldFocusNearFarRange.z + -r1.x;
  r0.z = 1 / r0.z;
  r0.z = min(3.40282347e+38, r0.z);
