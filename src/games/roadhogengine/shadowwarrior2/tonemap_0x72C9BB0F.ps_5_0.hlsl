  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.w = t4.Load(r3.xyz).y;
  r2.w = (int)r2.w & 34;
  r3.x = -r1.z + r0.w;
  r3.x = 0.0500000007 * abs(r3.x);
  r3.x = min(1, r3.x);
  r3.y = r1.z + -r0.w;
  r3.y = r3.x * r3.y + r0.w;
  r0.w = r1.x + -r1.w;
  ...
  r2.xyz = r0.xyz;
  r0.a = renodx::color::y::from::NTSC1953(r2.rgb);
  r2.xyz = cb1[3].xyz * r0.www;
  r0.xyz = r0.xyz * cb1[0].zzz + -r2.xyz;
  r0.xyz = cb1[3].www * r0.xyz + r2.xyz;
  ...
  r2.xyz = r1.xxx * r2.xyz + cb1[7].xyz;
  r1.r = renodx::color::y::from::NTSC1953(cb1[6].xyz);
  r2.xyz = r2.xyz + -r1.xxx;
  r2.xyz = r0.www * r2.xyz + r1.xxx;
