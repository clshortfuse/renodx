  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xy = cb0[18].xy * v0.xy;
  r2.xyz = t3.SampleLevel(s6_s, r2.xy, 0).xyz;
  r2.xyz = float3(-1,-1,-1) + r2.xyz;
  r3.xyz = cb1[0].xxx * r2.xyz + float3(1,1,1);
  r2.xyz = cb1[0].yyy * r2.xyz + float3(1,1,1);
  r1.xyz = r3.xyz * r1.xyz;
  r0.xyz = r0.xyz * cb3[0].yyy + r1.xyz * injectedData.fxBloom;
  r1.xy = cb0[17].xy * v0.xy;
  r3.xyz = t2.SampleLevel(s6_s, r1.xy, 0).xyz;
  r0.xyz = r3.xyz * r2.xyz * injectedData.fxLens + r0.xyz;
  ...
  r0.xyz = r0.xyz * r0.www;
    ...
    r0.rgb = applyFilmGrain(r0.rgb, r1.xy);
  }
  r1.xyz = r0.xyz;
