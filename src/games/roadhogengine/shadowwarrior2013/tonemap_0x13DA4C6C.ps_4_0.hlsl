  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.zw = cb1[8].zw + r0.xy;
  r2.xyzw = t15.SampleLevel(s8_s, r0.xy, 0).xyzw;
  r0.x = r2.x * cb0[18].x + cb0[18].z;
  r0.x = 1 / r0.x;
  r0.xy = r0.xx * cb1[11].xz + cb1[11].yw;
  o0.w = max(r0.x, r0.y);
  o0.a = saturate(o0.a);
  r0.xyzw = t12.SampleLevel(s4_s, r0.zw, 0).xyzw;
  ...
  r0.xyz = cb1[10].www * r1.xyz * injectedData.fxBlur + r0.xyz;
