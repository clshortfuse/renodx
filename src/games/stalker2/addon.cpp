...
extern "C" __declspec(dllexport) constexpr const char* NAME = "RenoDX Stalker 2";
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX Stalker 2";
