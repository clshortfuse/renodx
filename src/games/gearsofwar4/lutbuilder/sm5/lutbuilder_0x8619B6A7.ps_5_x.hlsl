  ...
  out float4 o0 : SV_Target0)
{
  ...
  o0 = ProcessLutbuilder(float3(untonemapped_ap1), s0_s, t0, cb_config, o0, asuint(cb0[65].z));
  return;
  ...
  if (asuint(cb0[65].z) == 0) {
    ...
    if (r0.w != 0) {
      ...
      r8.xy = float2(0.0625,0) + r8.xz;
      r8.xyz = t0.Sample(s0_s, r8.xy).xyz;
      r8.xyz = r8.xyz + -r9.xyz;
      r8.xyz = r0.www * r8.xyz + r9.xyz;
      r8.xyz = cb0[39].xxx * r8.xyz;
      r1.xyz = cb0[38].xxx * r1.xyz + r8.xyz;
