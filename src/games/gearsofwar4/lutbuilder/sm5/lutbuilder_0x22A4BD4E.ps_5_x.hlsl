...
// ---- Created with 3Dmigoto v1.3.16 on Fri May 30 17:53:25 2025
...
void main(
  ...
  float4 lutweights[2] = {float4(asfloat(cb0[30].x), asfloat(cb0[31].x), 0.f, 0.f), float4(0.f, 0.f, 0.f, 0.f)};
  cb_config.ue_lutweights = lutweights;
  o0 = ProcessLutbuilder(float3(untonemapped_ap1), s0_s, t0, cb_config, o0, asuint(cb0[41].w));
  return;
  ...
  r2.xyz = cb0[18].xxx * r3.xyz + r2.xyz;
  r2.xyz = cb0[18].zzz + r2.xyz;
  r3.xyz = cb0[34].yzw * r2.xyz;
  r2.xyz = -r2.xyz * cb0[34].yzw + cb0[35].xyz;
  r2.xyz = cb0[35].www * r2.xyz + r3.xyz;
  r2.xyz = max(float3(0, 0, 0), r2.xyz);
  r2.xyz = log2(r2.xyz);
  r2.xyz = cb0[19].yyy * r2.xyz;
  r3.xyz = exp2(r2.xyz);

  [branch]
  if (asuint(cb0[41].w) == 0) {
    ...
    r4.xyzw = cmp(asint(cb0[42].xxxx) == int4(1, 2, 3, 4));
