...
// ---- Created with 3Dmigoto v1.3.16 on Sun Jun  8 18:18:40 2025
...
// unknown dcl_: dcl_thread_group 8, 8, 8
  ...
  r0.xy = r0.xy * cb0[90].xy + float2(-0.015625,-0.015625);
  r1.xyz = float3(1.03225803,1.03225803,0.0322580636) * r0.xyz;
  r0.x = cmp(asuint(cb0[88].z) >= 3);
  r0.yzw = log2(r1.xyz);
  ...
  r0.w = 1.00055635 * cb0[67].z;
  r1.x = cmp(6996.10791 >= cb0[67].z);
  ...
  r2.xyz = cb0[67].zzz * float3(0.000154118257,0.00084242021,4.22806261e-05) + float3(0.860117733,1,0.317398727);
  r0.w = cb0[67].z * cb0[67].z;
  r2.xyz = r0.www * float3(1.28641219e-07,7.08145137e-07,4.20481676e-08) + r2.xyz;
  r2.x = r2.x / r2.y;
  r1.z = -cb0[67].z * 2.8974182e-05 + 1;
  ...
  r0.xyz = (asuint(cb0[67].x) != 0u) ? r0.xyz : r1.xyz;
  r0.w = dot(r0.xyz, float3(0.272228718,0.674081743,0.0536895171));
  r1.xyzw = cb0[73].xyzw * cb0[68].xyzw;
  r2.xyzw = cb0[74].xyzw * cb0[69].xyzw;
  r3.xyzw = cb0[75].xyzw * cb0[70].xyzw;
  r4.xyzw = cb0[76].xyzw * cb0[71].xyzw;
  r5.xyzw = cb0[77].xyzw + cb0[72].xyzw;
  ...
  r1.w = r1.w * r1.w;
  r1.w = -r2.x * r1.w + 1;
  r2.xyzw = cb0[83].xyzw * cb0[68].xyzw;
  r3.xyzw = cb0[84].xyzw * cb0[69].xyzw;
  r4.xyzw = cb0[85].xyzw * cb0[70].xyzw;
  r5.xyzw = cb0[86].xyzw * cb0[71].xyzw;
  r6.xyzw = cb0[87].xyzw + cb0[72].xyzw;
  r2.xyz = r2.xyz * r2.www;
  ...
  r2.w = r2.w * r2.w;
  r3.y = r3.x * r2.w;
  r4.xyzw = cb0[78].xyzw * cb0[68].xyzw;
  r5.xyzw = cb0[79].xyzw * cb0[69].xyzw;
  r6.xyzw = cb0[80].xyzw * cb0[70].xyzw;
  r7.xyzw = cb0[81].xyzw * cb0[71].xyzw;
  r8.xyzw = cb0[82].xyzw + cb0[72].xyzw;
  ...
  cb_config.ue_tonecurveammount = asfloat(cb0[89].z);
  cb_config.ue_mappingpolynomial = asfloat(cb0[26].xyz);
  cb_config.ue_overlaycolor = asfloat(cb0[66].xyzw);
  cb_config.ue_bluecorrection = asfloat(cb0[89].x);
  cb_config.ue_colorscale = asfloat(cb0[65].yzw);
  float4 output = ProcessLutbuilder(float3(untonemapped_ap1), cb_config, u0[vThreadID.xyz], asuint(cb0[88].z));
  ...
  if (asuint(cb0[67].x) != 0) {
    ...
    r0.xyz = cb0[89].xxx * r3.xyz + r0.xyz;
    ...
    r3.xyz = max(float3(0,0,0), r3.xyz);
    r3.xyz = r3.xyz + -r0.xyz;
    r0.xyz = cb0[89].zzz * r3.xyz + r0.xyz;
  ...
  r2.xyz = cb0[65].yzw * r0.xyz;
  r0.xyz = -r0.xyz * cb0[65].yzw + cb0[66].xyz;
  r0.xyz = cb0[66].www * r0.xyz + r2.xyz;
  ...
  if (asuint(cb0[88].z) == 0) {
    ...
    r4.xyzw = cmp(asint(cb0[88].wwww) == int4(1,2,3,4));
    ...
    if (r0.w != 0) {
      ...
      r7.xyz = cb0[65].yzw * r1.xyz;
      r1.xyz = -r1.xyz * cb0[65].yzw + cb0[66].xyz;
      r1.xyz = cb0[66].www * r1.xyz + r7.xyz;
      r7.xy = cmp(asint(cb0[88].zz) == int2(3,5));
      ...
      if (r0.w != 0) {
        ...
        r8.xyz = cb0[66].xyz + -r7.xyz;
        r7.xyz = cb0[66].www * r8.xyz + r7.xyz;
        r8.x = dot(r5.xyz, r7.xyz);
        r8.y = dot(r6.xyz, r7.xyz);
        r8.z = dot(r4.xyz, r7.xyz);
        ...
        r7.xy = cmp(asint(cb0[88].zz) == int2(4,6));
        r0.w = (int)r7.y | (int)r7.x;
        if (r0.w != 0) {
          r7.xyz = float3(1.5,1.5,1.5) * r1.xyz;
          r8.y = dot(float3(0.439700812,0.382978052,0.1773348), r7.xyz);
          ...
          r7.xy = cmp(asint(cb0[88].zz) == int2(10,11));
          r0.w = (int)r7.y | (int)r7.x;
          if (r0.w != 0) {
            r7.xyz = cb0[60].xxx * r1.xyz;
            r8.y = dot(float3(0.439700812,0.382978052,0.1773348), r7.xyz);
            r8.z = dot(float3(0.0897923037,0.813423157,0.096761629), r7.xyz);
            r8.w = dot(float3(0.0175439864,0.111544058,0.870704114), r7.xyz);
            r0.w = min(r8.y, r8.z);
            ...
            if (r5.w != 0) {
              r5.w = log2(cb0[57].z);
              r6.w = cb0[59].x * r4.w;
              r5.w = r5.w * 0.30103001 + -r6.w;
              r5.w = r0.w * cb0[59].x + r5.w;
            } else {
              r6.w = cmp(r4.w < r0.w);
              r7.x = log2(cb0[58].x);
              r7.y = 0.30103001 * r7.x;
              r7.z = cmp(r0.w < r7.y);
              r6.w = r6.w ? r7.z : 0;
              if (r6.w != 0) {
                r6.w = -r3.w * 0.30103001 + r0.w;
                r6.w = 7 * r6.w;
                r7.z = r7.x * 0.30103001 + -r4.w;
                r6.w = r6.w / r7.z;
                r7.z = (int)r6.w;
                r7.w = trunc(r6.w);
                r8.y = -r7.w + r6.w;
                r9.xy = (int2)r7.zz + int2(1,2);
                r8.x = r8.y * r8.y;
                r10.x = cb0[r7.z+38].x;
                r10.y = cb0[r9.x+38].x;
                r10.z = cb0[r9.y+38].x;
                ...
                r6.w = cmp(r0.w >= r7.y);
                r7.z = log2(cb0[58].z);
                r7.w = 0.30103001 * r7.z;
                r8.x = cmp(r0.w < r7.w);
                r6.w = r6.w ? r8.x : 0;
                if (r6.w != 0) {
                  r6.w = -r7.x * 0.30103001 + r0.w;
                  r6.w = 7 * r6.w;
                  r7.x = r7.z * 0.30103001 + -r7.y;
                  r6.w = r6.w / r7.x;
                  r7.x = (int)r6.w;
                  r7.y = trunc(r6.w);
                  r8.y = -r7.y + r6.w;
                  ...
                  r8.z = 1;
                  r5.w = dot(r8.xyz, r7.xyz);
                } else {
                  r6.w = log2(cb0[58].w);
                  r7.x = cb0[59].y * r7.w;
                  r6.w = r6.w * 0.30103001 + -r7.x;
                  r5.w = r0.w * cb0[59].y + r6.w;
                }
              }
            }
            r0.w = 3.32192802 * r5.w;
            r7.x = exp2(r0.w);
            r0.w = cmp(0 >= r1.w);
            r1.w = log2(r1.w);
            ...
            if (r1.w != 0) {
              r1.w = log2(cb0[57].z);
              r5.w = cb0[59].x * r4.w;
              r1.w = r1.w * 0.30103001 + -r5.w;
              r1.w = r0.w * cb0[59].x + r1.w;
            } else {
              r5.w = cmp(r4.w < r0.w);
              r6.w = log2(cb0[58].x);
              r7.w = 0.30103001 * r6.w;
              r8.x = cmp(r0.w < r7.w);
              r5.w = r5.w ? r8.x : 0;
              if (r5.w != 0) {
                r5.w = -r3.w * 0.30103001 + r0.w;
                r5.w = 7 * r5.w;
                r8.x = r6.w * 0.30103001 + -r4.w;
                r5.w = r5.w / r8.x;
                r8.x = (int)r5.w;
                r8.y = trunc(r5.w);
                r9.y = -r8.y + r5.w;
                r8.yz = (int2)r8.xx + int2(1,2);
                r9.x = r9.y * r9.y;
                r10.x = cb0[r8.x+38].x;
                r10.y = cb0[r8.y+38].x;
                r10.z = cb0[r8.z+38].x;
                ...
                r5.w = r5.w ? r8.z : 0;
                if (r5.w != 0) {
                  r5.w = -r6.w * 0.30103001 + r0.w;
                  r5.w = 7 * r5.w;
                  r6.w = r8.x * 0.30103001 + -r7.w;
                  r5.w = r5.w / r6.w;
                  r6.w = (int)r5.w;
                  r7.w = trunc(r5.w);
                  r9.y = -r7.w + r5.w;
                  r8.xz = (int2)r6.ww + int2(1,2);
                  r9.x = r9.y * r9.y;
                  r10.x = cb0[r6.w+48].x;
                  r10.y = cb0[r8.x+48].x;
                  r10.z = cb0[r8.z+48].x;
            ...
            if (r1.w != 0) {
              ...
              r2.w = r2.w ? r7.w : 0;
              if (r2.w != 0) {
                r2.w = -r3.w * 0.30103001 + r0.w;
                r2.w = 7 * r2.w;
                r3.w = r5.w * 0.30103001 + -r4.w;
                r2.w = r2.w / r3.w;
                r3.w = (int)r2.w;
                r4.w = trunc(r2.w);
                r8.y = -r4.w + r2.w;
                ...
                r2.w = r2.w ? r7.w : 0;
                if (r2.w != 0) {
                  r2.w = -r5.w * 0.30103001 + r0.w;
                  r2.w = 7 * r2.w;
                  r3.w = r3.w * 0.30103001 + -r6.w;
                  r2.w = r2.w / r3.w;
                  r3.w = (int)r2.w;
                  r5.w = trunc(r2.w);
                  r8.y = -r5.w + r2.w;
                  ...
                  r2.w = log2(cb0[58].w);
                  r3.w = cb0[59].y * r4.w;
                  r2.w = r2.w * 0.30103001 + -r3.w;
                  r1.w = r0.w * cb0[59].y + r2.w;
                }
              }
            }
            r0.w = 3.32192802 * r1.w;
            r7.z = exp2(r0.w);
            r7.xyz = -cb0[60].zzz + r7.xyz;
            r0.w = dot(float3(0.662454188,0.134004205,0.156187683), r7.xyz);
            r1.w = dot(float3(0.272228718,0.674081743,0.0536895171), r7.xyz);
            r2.w = dot(float3(-0.00557464967,0.0040607336,1.01033914), r7.xyz);
            r3.w = r1.w + r0.w;
            r2.w = r3.w + r2.w;
            r3.w = cmp(r2.w == 0.000000);
            r2.w = r3.w ? 1.00000001e-10 : r2.w;
            r0.w = r0.w / r2.w;
            r2.w = r1.w / r2.w;
            r1.w = max(0, r1.w);
            r1.w = min(65535, r1.w);
            ...
            r7.y = exp2(r1.w);
            r1.w = r7.y * r0.w;
            r3.w = max(1.00000001e-10, r2.w);
            r7.x = r1.w / r3.w;
            r0.w = 1 + -r0.w;
            r0.w = r0.w + -r2.w;
            r0.w = r0.w * r7.y;
            r7.z = r0.w / r3.w;
            r8.x = dot(float3(1.6410234,-0.324803293,-0.236424699), r7.xyz);
            r8.y = dot(float3(-0.663662851,1.61533165,0.0167563483), r7.xyz);
            r8.z = dot(float3(0.0117218941,-0.00828444213,0.988394856), r7.xyz);
            r7.xyz = cb0[66].xyz + -r8.xyz;
            r7.xyz = cb0[66].www * r7.xyz + r8.xyz;
            r8.x = dot(r5.xyz, r7.xyz);
            r8.y = dot(r6.xyz, r7.xyz);
            r8.z = dot(r4.xyz, r7.xyz);
            r7.xyz = float3(9.99999975e-05,9.99999975e-05,9.99999975e-05) * r8.xyz;
            ...
            if (r0.w != 0) {
              ...
              r7.xy = cmp(asint(cb0[88].zz) == int2(8,9));
