// Mortal Kombat 1 (UE 4.27.2.0 native HDR)
...
void main(
  ...
  const float4 icb[] = { { -4.000000, -0.718548, -4.970622, 0.808913 },
                         ...
                         { -1.057800, 2.378300, 0.797319, 0 },
                         { -0.466800, 2.768400, 1.202681, 0 },
                         { 0.119380, 3.051500, 1.609300, 0 },
                         { 0.708813, 3.274629, 2.010800, 0 },
                         { 1.291187, 3.327431, 2.414800, 0 },
                         { 1.291187, 3.327431, 2.817900, 0 },
                         { 0, 0, 3.172500, 0 },
                         { 0, 0, 3.534500, 0 },
                         { 0, 0, 3.669621, 0 },
                         { 0, 0, 3.669621, 0 } };
  ...
  r0.xyw = r0.zzz ? r0.xyw : r1.xyz;
  r1.x = dot(float3(0.613191485, 0.33951208, 0.0473663323), r0.xyw);
  r1.y = dot(float3(0.0702069029, 0.916335821, 0.0134500116), r0.xyw);
  r1.z = dot(float3(0.0206188709, 0.109567292, 0.869606733), r0.xyw);
  ...
  r6.xyzw = cb0[55].xyzw + cb0[50].xyzw;
  ...
  r7.xyzw = cb0[65].xyzw + cb0[50].xyzw;
  r3.xyz = r3.xyz * r3.www;
  r3.xyz = r3.xyz * r1.xyz + r0.xxx;
  ...
  r0.w = r0.w * r0.w;
  r2.w = r1.w * r0.w;
  r4.xyzw = cb0[56].xyzw * cb0[46].xyzw;
  r5.xyzw = cb0[57].xyzw * cb0[47].xyzw;
  r6.xyzw = cb0[58].xyzw * cb0[48].xyzw;
  r7.xyzw = cb0[59].xyzw * cb0[49].xyzw;
  r8.xyzw = cb0[60].xyzw + cb0[50].xyzw;
  r4.xyz = r4.xyz * r4.www;
  ...
  r0.x = -r1.w * r0.w + r0.x;
  r1.xyz = r1.xyz * r0.xxx;
  r0.xyw = r2.xyz * r0.yyy + r1.xyz;
  r0.xyw = r3.xyz * r2.www + r0.xyw;

  float3 untonemapped_ap1 = r0.xyw;
  ...
  cb_config.ue_tonecurveammount = asfloat(cb0[67].z);
  cb_config.ue_mappingpolynomial = asfloat(cb0[26].xyz);
  cb_config.ue_overlaycolor = asfloat(cb0[44].xyzw);
  cb_config.ue_bluecorrection = asfloat(cb0[67].x);
  cb_config.ue_colorscale = asfloat(cb0[43].yzw);

  o0 = ProcessLutbuilder(float3(untonemapped_ap1), cb_config, o0, asuint(cb0[66].z));
  return;

  r1.x = dot(float3(1.70505154, -0.621790707, -0.0832583979), r0.xyw);
  r1.y = dot(float3(-0.130257145, 1.14080286, -0.0105485283), r0.xyw);
  r1.z = dot(float3(-0.0240032747, -0.128968775, 1.15297174), r0.xyw);
  [branch]
  if (asuint(cb0[45].y) != 0) {
    r2.x = dot(r1.xyz, cb0[29].xyz);
    r2.y = dot(r1.xyz, cb0[30].xyz);
    r2.z = dot(r1.xyz, cb0[31].xyz);
    r1.w = dot(r1.xyz, cb0[34].xyz);
    r1.w = 1 + r1.w;
    r1.w = rcp(r1.w);
    r3.xyz = cb0[36].xyz * r1.www + cb0[35].xyz;
    r2.xyz = r3.xyz * r2.xyz;
    r2.xyz = max(float3(0, 0, 0), r2.xyz);
    r3.xyz = cb0[32].xxx + -r2.xyz;
    r3.xyz = max(float3(0, 0, 0), r3.xyz);
    r4.xyz = max(cb0[32].zzz, r2.xyz);
    r2.xyz = max(cb0[32].xxx, r2.xyz);
    r2.xyz = min(cb0[32].zzz, r2.xyz);
    r5.xyz = r4.xyz * cb0[33].xxx + cb0[33].yyy;
    r4.xyz = cb0[32].www + r4.xyz;
    r4.xyz = rcp(r4.xyz);
    r6.xyz = cb0[29].www * r3.xyz;
    r3.xyz = cb0[32].yyy + r3.xyz;
    r3.xyz = rcp(r3.xyz);
    r3.xyz = r6.xyz * r3.xyz + cb0[30].www;
    r2.xyz = r2.xyz * cb0[31].www + r3.xyz;
    r2.xyz = r5.xyz * r4.xyz + r2.xyz;
    r2.xyz = float3(-0.00200000009, -0.00200000009, -0.00200000009) + r2.xyz;
  } else {
    r3.x = dot(float3(0.938639402, 1.02359565e-10, 0.0613606237), r0.xyw);
    r3.y = dot(float3(8.36008554e-11, 0.830794156, 0.169205874), r0.xyw);
    r3.z = dot(float3(2.13187367e-12, -5.63307213e-12, 1), r0.xyw);
    r3.xyz = r3.xyz + -r0.xyw;
    r0.xyw = cb0[67].xxx * r3.xyz + r0.xyw;
    r3.y = dot(float3(0.695452213, 0.140678704, 0.163869068), r0.xyw);
    r3.z = dot(float3(0.0447945632, 0.859671116, 0.0955343172), r0.xyw);
    r3.w = dot(float3(-0.00552588236, 0.00402521016, 1.00150073), r0.xyw);
    r1.w = min(r3.y, r3.z);
    r1.w = min(r1.w, r3.w);
    r2.w = max(r3.y, r3.z);
    r2.w = max(r2.w, r3.w);
    r4.xy = max(float2(1.00000001e-10, 0.00999999978), r2.ww);
    ...
    r3.x = r3.x + r3.y;
    r2.w = r2.w * 1.75 + r3.x;
    r3.x = 0.333333343 * r2.w;
    r4.x = -0.400000006 + r1.w;
    r4.y = 2.5 * r4.x;
    r4.y = 1 + -abs(r4.y);
    r4.y = max(0, r4.y);
    r4.z = cmp(0 < r4.x);
    r4.x = cmp(r4.x < 0);
    r4.x = (int)-r4.z + (int)r4.x;
    r4.x = (int)r4.x;
    r4.y = -r4.y * r4.y + 1;
    r4.x = r4.x * r4.y + 1;
    r4.x = 0.0250000004 * r4.x;
    r4.y = cmp(0.159999996 >= r2.w);
    r2.w = cmp(r2.w >= 0.479999989);
    r3.x = 0.0799999982 / r3.x;
    r3.x = -0.5 + r3.x;
    r3.x = r4.x * r3.x;
    r2.w = r2.w ? 0 : r3.x;
    r2.w = r4.y ? r4.x : r2.w;
    r2.w = 1 + r2.w;
    r4.yzw = r3.yzw * r2.www;
    r5.xy = cmp(r4.zw == r4.yz);
    r3.x = r5.y ? r5.x : 0;
    r3.z = r3.z * r2.w + -r4.w;
    r3.z = 1.73205078 * r3.z;
    r5.x = r4.y * 2 + -r4.z;
    r3.w = -r3.w * r2.w + r5.x;
    r5.x = min(abs(r3.z), abs(r3.w));
    r5.y = max(abs(r3.z), abs(r3.w));
    r5.y = 1 / r5.y;
    r5.x = r5.x * r5.y;
    r5.y = r5.x * r5.x;
    ...
    r3.x = r3.x * r3.x;
    r1.w = r3.x * r1.w;
    r2.w = -r3.y * r2.w + 0.0299999993;
    r1.w = r2.w * r1.w;
    r4.x = r1.w * 0.180000007 + r4.y;
    ...
    r4.xy = float2(1, 0.180000007) + cb0[37].ww;
    r1.w = -cb0[37].y + r4.x;
    r2.w = 1 + cb0[38].x;
    r3.w = -cb0[37].z + r2.w;
    r4.x = cmp(0.800000012 < cb0[37].y);
    r4.zw = float2(0.819999993, 1) + -cb0[37].yy;
    r4.zw = r4.zw / cb0[37].xx;
    ...
    r3.xyz = max(float3(0, 0, 0), r3.xyz);
    r3.xyz = r3.xyz + -r0.xyw;
    r0.xyw = cb0[67].zzz * r3.xyz + r0.xyw;
    r3.x = dot(float3(1.06537485, 1.44678506e-06, -0.0653710067), r0.xyw);
    r3.y = dot(float3(-3.45525592e-07, 1.20366347, -0.203667715), r0.xyw);
    r3.z = dot(float3(1.9865448e-08, 2.12079581e-08, 0.999999583), r0.xyw);
    r3.xyz = r3.xyz + -r0.xyw;
    r0.xyw = cb0[67].xxx * r3.xyz + r0.xyw;
    r3.x = dot(float3(1.70505154, -0.621790707, -0.0832583979), r0.xyw);
    r3.y = dot(float3(-0.130257145, 1.14080286, -0.0105485283), r0.xyw);
    r3.z = dot(float3(-0.0240032747, -0.128968775, 1.15297174), r0.xyw);
    r2.xyz = max(float3(0, 0, 0), r3.xyz);
  }
  r0.xyw = r2.xyz * r2.xyz;
  r2.xyz = cb0[26].yyy * r2.xyz;
  r0.xyw = cb0[26].xxx * r0.xyw + r2.xyz;
  r0.xyw = cb0[26].zzz + r0.xyw;
  r2.xyz = cb0[43].yzw * r0.xyw;
  r0.xyw = -r0.xyw * cb0[43].yzw + cb0[44].xyz;
  r0.xyw = cb0[44].www * r0.xyw + r2.xyz;
  r2.xyz = max(float3(0, 0, 0), r0.xyw);
  r2.xyz = log2(r2.xyz);
  r2.xyz = cb0[27].yyy * r2.xyz;
  r3.xyz = exp2(r2.xyz);
  [branch]
  if (asuint(cb0[66].z) == 0) {
    ...
    r4.xyzw = cmp(asint(cb0[66].wwww) == int4(1, 2, 3, 4));
    ...
    if (r1.w != 0) {
      ...
      r1.w = cmp(6 >= asuint(cb0[66].z));
      r0.z = r0.z ? r1.w : 0;
      r7.xyzw = cmp(asint(cb0[66].zzzz) == int4(10, 11, 3, 5));
      r0.z = (int)r0.z | (int)r7.x;
      r0.z = (int)r7.y | (int)r0.z;
      r8.xyz = max(float3(0, 0, 0), r1.xyz);
      r8.xyz = log2(r8.xyz);
      r8.xyz = cb0[28].xxx * r8.xyz;
      r8.xyz = exp2(r8.xyz);
      r1.xyz = r0.zzz ? r8.xyz : r1.xyz;
      r0.z = (int)r7.w | (int)r7.z;
      if (r0.z != 0) {
        r8.xyz = float3(1.5, 1.5, 1.5) * r1.xyz;
        ...
        r1.w = max(r9.y, r9.z);
        r1.w = max(r1.w, r9.w);
        r7.zw = max(float2(1.00000001e-10, 0.00999999978), r1.ww);
        r0.z = max(1.00000001e-10, r0.z);
        r0.z = r7.z + -r0.z;
        r0.z = r0.z / r7.w;
        ...
        r5.w = r6.w * r5.w;
        r6.w = r5.w * r5.w;
        r7.z = r6.w * 0.0208350997 + -0.0851330012;
        r7.z = r6.w * r7.z + 0.180141002;
        r7.z = r6.w * r7.z + -0.330299497;
        r6.w = r6.w * r7.z + 0.999866009;
        r7.z = r6.w * r5.w;
        ...
        if (r3.w != 0) {
          ...
          r7.zw = r3.ww * float2(0.5, 0.5) + r9.xz;
          r7.zw = r2.ww * float2(-0.5, 0.5) + r7.zw;
          r2.w = r5.w * 0.5 + -r3.w;
          r2.w = 0.666666687 + r2.w;
          r10.xyz = cmp((int3)r4.www == int3(3, 2, 1));
          r7.zw = float2(0.166666672, 0.166666672) + r7.zw;
          r3.w = r4.w ? 0 : r9.w;
          r3.w = r10.z ? r7.w : r3.w;
          r2.w = r10.y ? r2.w : r3.w;
          r2.w = r10.x ? r7.z : r2.w;
        } else {
          r2.w = 0;
        }
        r0.z = r2.w * r0.z;
        ...
        r8.xyz = min(float3(65535, 65535, 65535), r8.xyz);
        r0.z = dot(r8.xyz, float3(0.272228718, 0.674081743, 0.0536895171));
        r8.xyz = r8.xyz + -r0.zzz;
        r8.xyz = r8.xyz * float3(0.959999979, 0.959999979, 0.959999979) + r0.zzz;
        ...
        if (r9.z != 0) {
          ...
          if (r1.w != 0) {
            ...
            if (r1.w != 0) {
              ...
              r9.y = icb[r7.z + 0].y;
              r9.z = icb[r7.w + 0].y;
              r11.x = dot(r9.xzy, float3(0.5, 0.5, -1));
              r11.y = dot(r9.xy, float2(-1, 1));
              r11.z = dot(r9.xy, float2(0.5, 0.5));
              r8.z = 1;
              r0.z = dot(r8.xyz, r11.xyz);
            } else {
              r0.z = 4;
            }
          }
        ...
        r0.z = dot(float3(1.45143926, -0.236510754, -0.214928567), r8.xyz);
        ...
        r3.w = cmp(0 >= r0.z);
        r0.z = log2(r0.z);
        r0.z = r3.w ? -13.2877121 : r0.z;
        r3.w = cmp(-12.7838678 >= r0.z);
        if (r3.w != 0) {
          r3.w = r0.z * 0.90309 + 7.54498291;
        } else {
          r4.w = cmp(-12.7838678 < r0.z);
          r5.w = cmp(r0.z < 2.26303458);
          r4.w = r4.w ? r5.w : 0;
          if (r4.w != 0) {
            r4.w = r0.z * 0.30103001 + 3.84832764;
            r5.w = 1.54540098 * r4.w;
            r6.w = (int)r5.w;
            r5.w = trunc(r5.w);
            r8.y = r4.w * 1.54540098 + -r5.w;
            r7.zw = (int2)r6.ww + int2(1, 2);
            r8.x = r8.y * r8.y;
            r9.x = icb[r6.w + 0].z;
            r9.y = icb[r7.z + 0].z;
            r9.z = icb[r7.w + 0].z;
            ...
            r4.w = cmp(r0.z >= 2.26303458);
            r5.w = cmp(r0.z < 12.1373367);
            r4.w = r4.w ? r5.w : 0;
            if (r4.w != 0) {
              r4.w = r0.z * 0.30103001 + -0.681241274;
              r5.w = 2.3549509 * r4.w;
              r6.w = (int)r5.w;
              r5.w = trunc(r5.w);
              ...
              r3.w = r0.z * 0.0180617999 + 2.78077793;
            }
          }
        }
        r0.z = 3.32192802 * r3.w;
        r8.x = exp2(r0.z);
        r0.z = cmp(0 >= r1.w);
        r1.w = log2(r1.w);
        r0.z = r0.z ? -13.2877121 : r1.w;
        r1.w = cmp(-12.7838678 >= r0.z);
        if (r1.w != 0) {
          r1.w = r0.z * 0.90309 + 7.54498291;
        } else {
          r3.w = cmp(-12.7838678 < r0.z);
          r4.w = cmp(r0.z < 2.26303458);
          r3.w = r3.w ? r4.w : 0;
          if (r3.w != 0) {
            r3.w = r0.z * 0.30103001 + 3.84832764;
            r4.w = 1.54540098 * r3.w;
            r5.w = (int)r4.w;
            r4.w = trunc(r4.w);
            r9.y = r3.w * 1.54540098 + -r4.w;
            r7.zw = (int2)r5.ww + int2(1, 2);
            r9.x = r9.y * r9.y;
            r10.x = icb[r5.w + 0].z;
            r10.y = icb[r7.z + 0].z;
            r10.z = icb[r7.w + 0].z;
            ...
            r3.w = cmp(r0.z >= 2.26303458);
            r4.w = cmp(r0.z < 12.1373367);
            r3.w = r3.w ? r4.w : 0;
            if (r3.w != 0) {
              r3.w = r0.z * 0.30103001 + -0.681241274;
              r4.w = 2.3549509 * r3.w;
              r5.w = (int)r4.w;
              r4.w = trunc(r4.w);
              ...
              r1.w = r0.z * 0.0180617999 + 2.78077793;
            }
          }
        }
        ...
        if (r1.w != 0) {
          ...
          r2.w = cmp(-12.7838678 < r0.z);
          r3.w = cmp(r0.z < 2.26303458);
          r2.w = r2.w ? r3.w : 0;
          if (r2.w != 0) {
            r2.w = r0.z * 0.30103001 + 3.84832764;
            r3.w = 1.54540098 * r2.w;
            r4.w = (int)r3.w;
            r3.w = trunc(r3.w);
            r9.y = r2.w * 1.54540098 + -r3.w;
            r7.zw = (int2)r4.ww + int2(1, 2);
            r9.x = r9.y * r9.y;
            r10.x = icb[r4.w + 0].z;
            r10.y = icb[r7.z + 0].z;
            r10.z = icb[r7.w + 0].z;
            ...
            r2.w = cmp(r0.z >= 2.26303458);
            r3.w = cmp(r0.z < 12.1373367);
            r2.w = r2.w ? r3.w : 0;
            if (r2.w != 0) {
              r2.w = r0.z * 0.30103001 + -0.681241274;
              r3.w = 2.3549509 * r2.w;
              r4.w = (int)r3.w;
              r3.w = trunc(r3.w);
        ...
        r7.zw = cmp(asint(cb0[66].zz) == int2(4, 6));
        r0.z = (int)r7.w | (int)r7.z;
        if (r0.z != 0) {
          r8.xyz = float3(1.5, 1.5, 1.5) * r1.xyz;
          r9.y = dot(float3(0.439700812, 0.382978052, 0.1773348), r8.xyz);
          ...
          if (r3.w != 0) {
            ...
            if (r4.w != 0) {
              ...
              if (r4.w != 0) {
                ...
                r3.w = r0.z * 0.0361235999 + 2.84967208;
              }
            }
          }
          r0.z = 3.32192802 * r3.w;
          ...
          if (r1.w != 0) {
            ...
            if (r3.w != 0) {
              ...
              if (r3.w != 0) {
                ...
                r1.w = r0.z * 0.0361235999 + 2.84967208;
              }
            }
          }
          r0.z = 3.32192802 * r1.w;
          ...
          if (r0.z != 0) {
            ...
            r7.xyz = min(float3(65535, 65535, 65535), r7.xyz);
            r0.z = dot(r7.xyz, float3(0.272228718, 0.674081743, 0.0536895171));
            r7.xyz = r7.xyz + -r0.zzz;
            r7.xyz = r7.xyz * float3(0.959999979, 0.959999979, 0.959999979) + r0.zzz;
            ...
            r0.z = dot(float3(1.45143926, -0.236510754, -0.214928567), r7.xyz);
            ...
            if (r3.w != 0) {
              ...
              if (r4.w != 0) {
                ...
                r4.w = cmp(r0.z >= 2.26303458);
                r5.w = cmp(r0.z < 12.7364788);
                r4.w = r4.w ? r5.w : 0;
                if (r4.w != 0) {
                  r4.w = r0.z * 0.30103001 + -0.681241274;
                  r5.w = 2.22023392 * r4.w;
                  r6.w = (int)r5.w;
                  r5.w = trunc(r5.w);
                  r7.y = r4.w * 2.22023392 + -r5.w;
                  r8.xy = (int2)r6.ww + int2(1, 2);
                  r7.x = r7.y * r7.y;
                  r9.x = icb[r6.w + 10].z;
                  r9.y = icb[r8.x + 10].z;
                  ...
                  r3.w = r0.z * 0.0903090015 + 2.45184112;
                }
              }
            }
            r0.z = 3.32192802 * r3.w;
            ...
            if (r1.w != 0) {
              ...
              if (r3.w != 0) {
                ...
                r3.w = cmp(r0.z >= 2.26303458);
                r4.w = cmp(r0.z < 12.7364788);
                r3.w = r3.w ? r4.w : 0;
                if (r3.w != 0) {
                  r3.w = r0.z * 0.30103001 + -0.681241274;
                  r4.w = 2.22023392 * r3.w;
                  r5.w = (int)r4.w;
                  r4.w = trunc(r4.w);
                  r8.y = r3.w * 2.22023392 + -r4.w;
                  r9.xy = (int2)r5.ww + int2(1, 2);
                  r8.x = r8.y * r8.y;
                  r10.x = icb[r5.w + 10].z;
                  r10.y = icb[r9.x + 10].z;
                  ...
                  r1.w = r0.z * 0.0903090015 + 2.45184112;
                }
              }
            }
            r0.z = 3.32192802 * r1.w;
            ...
            if (r1.w != 0) {
              ...
              if (r2.w != 0) {
                ...
                r2.w = cmp(r0.z >= 2.26303458);
                r3.w = cmp(r0.z < 12.7364788);
                r2.w = r2.w ? r3.w : 0;
                if (r2.w != 0) {
                  r2.w = r0.z * 0.30103001 + -0.681241274;
                  r3.w = 2.22023392 * r2.w;
                  r4.w = (int)r3.w;
                  r3.w = trunc(r3.w);
                  r8.y = r2.w * 2.22023392 + -r3.w;
                  r9.xy = (int2)r4.ww + int2(1, 2);
                  r8.x = r8.y * r8.y;
                  r10.x = icb[r4.w + 10].z;
                  r10.y = icb[r9.x + 10].z;
            ...
            r0.z = 3.32192802 * r1.w;
            r7.z = exp2(r0.z);
            r0.z = cmp(asint(cb0[66].z) != 11);
            r8.x = dot(r5.xyz, r7.xyz);
            r8.y = dot(r6.xyz, r7.xyz);
            r8.z = dot(r4.xyz, r7.xyz);
            r7.xyz = r0.zzz ? r8.xyz : r7.xyz;
            ...
            if (r0.z != 0) {
              ...
              r7.xy = cmp(asint(cb0[66].zz) == int2(8, 9));
              r8.x = dot(float3(0.613191485, 0.33951208, 0.0473663323), r0.xyw);
              r8.y = dot(float3(0.0702069029, 0.916335821, 0.0134500116), r0.xyw);
              r8.z = dot(float3(0.0206188709, 0.109567292, 0.869606733), r0.xyw);
