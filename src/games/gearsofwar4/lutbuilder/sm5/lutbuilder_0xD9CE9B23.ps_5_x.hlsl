...
// ---- Created with 3Dmigoto v1.3.16 on Wed Aug  6 17:22:04 2025
Texture2D<float4> t0 : register(t0);

SamplerState s0_s : register(s0);

cbuffer cb0 : register(b0) { float4 cb0[36]; }

// 3Dmigoto declarations
#define cmp -

void main(linear noperspective float2 v0 : TEXCOORD0, float4 v1 : SV_POSITION0,
          uint v2 : SV_RenderTargetArrayIndex0, out float4 o0 : SV_Target0) {
  ...
  r0.xyw = -r0.xyw * float3(18.6875, 18.6875, 18.6875) +
           float3(18.8515625, 18.8515625, 18.8515625);
  r0.xyw = r2.xyz / r0.xyw;
  r0.xyw = log2(r0.xyw);
  r0.xyw = float3(6.27739477, 6.27739477, 6.27739477) * r0.xyw;
  r0.xyw = exp2(r0.xyw);
  r0.xyw = float3(100, 100, 100) * r0.xyw;
  r1.xy = v0.xy * float2(1.03225803, 1.03225803) +
          float2(-0.0161290318, -0.0161290318);
  r1.xyz = float3(-0.434017599, -0.434017599, -0.434017599) + r1.xyz;
  r1.xyz = float3(14, 14, 14) * r1.xyz;
  r1.xyz = exp2(r1.xyz);
  r1.xyz = r1.xyz * float3(0.180000007, 0.180000007, 0.180000007) +
           float3(-0.00266771927, -0.00266771927, -0.00266771927);
  r0.xyz = r0.zzz ? r0.xyw : r1.xyz;
  r0.w = cb0[29].x * 1.00055635;
  r0.w = 1 / r0.w;
  r1.x = cmp(6996.10791 >= cb0[29].x);
  r1.yz =
      -r0.ww * float2(4.60700006e+09, 2.0064e+09) + float2(2967800, 1901800);
  ...
  r2.xyz = cb0[29].xxx * float3(0.000154118257, 0.00084242021, 4.22806261e-05) +
           float3(0.860117733, 1, 0.317398727);
  r0.w = cb0[29].x * cb0[29].x;
  r2.xyz =
      r0.www * float3(1.28641219e-07, 7.08145137e-07, 4.20481676e-08) + r2.xyz;
  r2.x = r2.x / r2.y;
  r1.z = -cb0[29].x * 2.8974182e-05 + 1;
  ...
  r0.w = dot(r0.xyz, float3(0.272228718, 0.674081743, 0.0536895171));
  r1.xyzw = cb0[14].xyzw * cb0[9].xyzw;
  r2.xyzw = cb0[15].xyzw * cb0[10].xyzw;
  r3.xyzw = cb0[16].xyzw * cb0[11].xyzw;
  r4.xyzw = cb0[17].xyzw * cb0[12].xyzw;
  r5.xyzw = cb0[18].xyzw + cb0[13].xyzw;
  ...
  r1.w = r1.w * r1.w;
  r1.w = -r2.x * r1.w + 1;
  r2.xyzw = cb0[24].xyzw * cb0[9].xyzw;
  r3.xyzw = cb0[25].xyzw * cb0[10].xyzw;
  r4.xyzw = cb0[26].xyzw * cb0[11].xyzw;
  r5.xyzw = cb0[27].xyzw * cb0[12].xyzw;
  r6.xyzw = cb0[28].xyzw + cb0[13].xyzw;
  r2.xyz = r2.xyz * r2.www;
  ...
  r2.w = r2.w * r2.w;
  r3.y = r3.x * r2.w;
  r4.xyzw = cb0[19].xyzw * cb0[9].xyzw;
  r5.xyzw = cb0[20].xyzw * cb0[10].xyzw;
  r6.xyzw = cb0[21].xyzw * cb0[11].xyzw;
  r7.xyzw = cb0[22].xyzw * cb0[12].xyzw;
  r8.xyzw = cb0[23].xyzw + cb0[13].xyzw;
  ...
  cb_config.ue_filmblackclip = asfloat(cb0[31].w);
  cb_config.ue_filmtoe = asfloat(cb0[31].y);
  cb_config.ue_filmshoulder = asfloat(cb0[31].z);
  cb_config.ue_filmslope = asfloat(cb0[31].x);
  cb_config.ue_filmwhiteclip = asfloat(cb0[32].x);
  cb_config.ue_tonecurveammount = asfloat(cb0[30].w);
  cb_config.ue_mappingpolynomial = asfloat(cb0[33].xyz);
  cb_config.ue_overlaycolor = asfloat(cb0[7].xyzw);
  cb_config.ue_bluecorrection = asfloat(cb0[30].y);
  cb_config.ue_colorscale = asfloat(cb0[8].xyz);
  ...
  o0 = ProcessLutbuilder(float3(untonemapped_ap1), s0_s, t0, cb_config, o0,
                         asuint(cb0[34].w));
  return;
  ...
  r1.xyz = r1.xyz + -r0.xyz;
  r1.xyz = cb0[30].yyy * r1.xyz + r0.xyz;
  r2.y = dot(float3(0.695452213, 0.140678704, 0.163869068), r1.xyz);
  r2.z = dot(float3(0.0447945632, 0.859671116, 0.0955343172), r1.xyz);
  r2.w = dot(float3(-0.00552588236, 0.00402521016, 1.00150073), r1.xyz);
  r0.w = min(r2.y, r2.z);
  r0.w = min(r0.w, r2.w);
  r1.w = max(r2.y, r2.z);
  r1.w = max(r1.w, r2.w);
  ...
  r3.xy = cb0[31].ww + float2(1, 0.180000007);
  r0.w = -cb0[31].y + r3.x;
  r1.w = cb0[32].x + 1;
  r2.w = -cb0[31].z + r1.w;
  r3.x = cmp(0.800000012 < cb0[31].y);
  r3.zw = -cb0[31].yy + float2(0.819999993, 1);
  r3.zw = r3.zw / cb0[31].xx;
  ...
  r1.xyz = cb0[30].www * r2.xyz + r1.xyz;
  r2.x = dot(float3(1.06537485, 1.44678506e-06, -0.0653710067), r1.xyz);
  r2.y = dot(float3(-3.45525592e-07, 1.20366347, -0.203667715), r1.xyz);
  ...
  r2.xyz = exp2(r2.xyz);
  r2.xyz = r2.xyz * float3(1.05499995, 1.05499995, 1.05499995) +
           float3(-0.0549999997, -0.0549999997, -0.0549999997);
  r1.xyz = r3.xyz ? r2.xyz : r1.xyz;
  r2.yzw = r1.xyz * float3(0.9375, 0.9375, 0.9375) +
           float3(0.03125, 0.03125, 0.03125);
  r0.w = r2.w * 16 + -0.5;
  r1.w = floor(r0.w);
  r0.w = -r1.w + r0.w;
  r1.w = r2.y + r1.w;
  ...
  r1.xyz = cb0[5].xxx * r1.xyz + r2.xyz;
  ...
  r3.xyz = r1.xyz * float3(0.947867274, 0.947867274, 0.947867274) +
  ...
  r1.xyz = cb0[33].zzz + r1.xyz;
  r2.xyz = cb0[8].xyz * r1.xyz;
  r1.xyz = -r1.xyz * cb0[8].xyz + cb0[7].xyz;
  r1.xyz = cb0[7].www * r1.xyz + r2.xyz;
  r2.xyz = max(float3(0, 0, 0), r1.xyz);
  r2.xyz = log2(r2.xyz);
  r2.xyz = cb0[34].yyy * r2.xyz;
  r3.xyz = exp2(r2.xyz);

  [branch] if (asuint(cb0[34].w) == 0) {
    ...
    r4.xyzw = cmp(int4(1, 2, 3, 4) == asint(cb0[35].xxxx));
    r5.xyz = r4.www ? float3(1, 0, 0)
                    : float3(1.70505154, -0.621790707, -0.0832583979);
    r6.xyz = r4.www ? float3(0, 1, 0)
                    : float3(-0.130257145, 1.14080286, -0.0105485283);
    r7.xyz = r4.www ? float3(0, 0, 1)
                    : float3(-0.0240032747, -0.128968775, 1.15297174);
    ...
    r7.xyz =
        r4.zzz ? float3(-0.00552588282, 0.00402521016, 1.00150073) : r7.xyz;
    r5.xyz =
        r4.yyy ? float3(1.02579927, -0.0200525094, -0.00577136781) : r5.xyz;
    r6.xyz =
        r4.yyy ? float3(-0.00223502493, 1.00458264, -0.00235231337) : r6.xyz;
    r4.yzw =
        r4.yyy ? float3(-0.00501400325, -0.0252933875, 1.03044021) : r7.xyz;
    ...
    r4.xyz =
        r4.xxx ? float3(-0.00215925858, -0.0454653986, 1.04775953) : r4.yzw;
    r0.w = cmp(1 == asint(cb0[34].w));
    if (r0.w != 0) {
      ...
      r7.xyz =
          max(float3(6.10351999e-05, 6.10351999e-05, 6.10351999e-05), r8.xyz);
      ...
      r7.xyz = exp2(r7.xyz);
      r7.xyz = r7.xyz * float3(1.09899998, 1.09899998, 1.09899998) +
               float3(-0.0989999995, -0.0989999995, -0.0989999995);
      r2.xyz = min(r8.xyz, r7.xyz);
    } else {
      r7.x = dot(float3(1.70505154, -0.621790707, -0.0832583979), r0.xyz);
      r7.y = dot(float3(-0.130257145, 1.14080286, -0.0105485283), r0.xyz);
      r7.z = dot(float3(-0.0240032747, -0.128968775, 1.15297174), r0.xyz);
      r0.xyz = cb0[8].xyz * r7.xyz;
      r7.xyz = -r7.xyz * cb0[8].xyz + cb0[7].xyz;
      r0.xyz = cb0[7].www * r7.xyz + r0.xyz;
      r7.xy = cmp(int2(3, 5) == asint(cb0[34].ww));
      ...
      if (r0.w != 0) {
        ...
        r7.xyz =
            r7.xyz * float3(0.959999979, 0.959999979, 0.959999979) + r0.www;
        ...
        r7.z = exp2(r0.w);
        r7.xyz =
            float3(-3.50738446e-05, -3.50738446e-05, -3.50738446e-05) + r7.xyz;
        r8.x = dot(r5.xyz, r7.xyz);
        r8.y = dot(r6.xyz, r7.xyz);
        r8.z = dot(r4.xyz, r7.xyz);
        r7.xyz =
            float3(9.99999975e-05, 9.99999975e-05, 9.99999975e-05) * r8.xyz;
        r7.xyz = log2(r7.xyz);
        r7.xyz = float3(0.159301758, 0.159301758, 0.159301758) * r7.xyz;
        r7.xyz = exp2(r7.xyz);
        r8.xyz = r7.xyz * float3(18.8515625, 18.8515625, 18.8515625) +
                 float3(0.8359375, 0.8359375, 0.8359375);
        ...
        r7.xy = cmp(int2(4, 6) == asint(cb0[34].ww));
        r0.w = (int)r7.y | (int)r7.x;
        if (r0.w != 0) {
          r7.xyz = float3(1.5, 1.5, 1.5) * r0.xyz;
          r8.y = dot(float3(0.439700812, 0.382978052, 0.1773348), r7.xyz);
          ...
          r8.y = dot(float3(-0.0765537769, 1.17622972, -0.0996759236), r7.xyz);
          r8.z =
              dot(float3(0.00831614807, -0.00603244966, 0.997716308), r7.xyz);
          r7.xyz = max(float3(0, 0, 0), r8.xyz);
          r7.xyz = min(float3(65535, 65535, 65535), r7.xyz);
          r0.w = dot(r7.xyz, float3(0.272228718, 0.674081743, 0.0536895171));
          r7.xyz = r7.xyz + -r0.www;
          ...
          if (r0.w != 0) {
            ...
            r8.xyz = r7.xyz * float3(18.8515625, 18.8515625, 18.8515625) +
                     float3(0.8359375, 0.8359375, 0.8359375);
            r7.xyz =
                r7.xyz * float3(18.6875, 18.6875, 18.6875) + float3(1, 1, 1);
            r7.xyz = rcp(r7.xyz);
            r7.xyz = r8.xyz * r7.xyz;
            r7.xyz = log2(r7.xyz);
            r7.xyz = float3(78.84375, 78.84375, 78.84375) * r7.xyz;
            ...
            r7.xy = cmp(int2(8, 9) == asint(cb0[34].ww));
            r8.x = dot(float3(0.613191485, 0.33951208, 0.0473663323), r1.xyz);
            r8.y = dot(float3(0.0702069029, 0.916335821, 0.0134500116), r1.xyz);
            r8.z = dot(float3(0.0206188709, 0.109567292, 0.869606733), r1.xyz);
            r1.x = dot(r5.xyz, r8.xyz);
            r1.y = dot(r6.xyz, r8.xyz);
            ...
            r3.xyz = exp2(r3.xyz);
            r1.xyz = r7.yyy ? r1.xyz : r3.xyz;
            r2.xyz = r7.xxx ? r0.xyz : r1.xyz;
          }
        }
      }
    }
