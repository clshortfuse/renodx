...
// Found in The Awesome Adventures of Captain Spirit

// ---- Created with 3Dmigoto v1.3.16 on Fri May 30 18:14:00 2025
...
void main(
  ...
  r0.w = 1.00055635 * cb0[39].x;
  r1.x = cmp(6996.10791 >= cb0[39].x);
  ...
  r2.xyz = cb0[39].xxx * float3(0.000154118257, 0.00084242021, 4.22806261e-05) + float3(0.860117733, 1, 0.317398727);
  r0.w = cb0[39].x * cb0[39].x;
  r2.xyz = r0.www * float3(1.28641219e-07, 7.08145137e-07, 4.20481676e-08) + r2.xyz;
  r2.x = r2.x / r2.y;
  r1.z = -cb0[39].x * 2.8974182e-05 + 1;
  ...
  r1.xyzw = cb0[45].xyzw * cb0[40].xyzw;
  ...
  r1.w = r1.w * r1.w;
  r1.w = -r2.x * r1.w + 1;
  r2.xyzw = cb0[55].xyzw * cb0[40].xyzw;
  ...
  r2.w = r2.w * r2.w;
  r3.y = r3.x * r2.w;
  r4.xyzw = cb0[50].xyzw * cb0[40].xyzw;
  ...
  cb_config.ue_tonecurveammount = 1.f; // shader has no ToneCurveAmount cbuffer member (cb0[61] out of bounds)
  cb_config.ue_mappingpolynomial = asfloat(cb0[21].xyz);
  cb_config.ue_overlaycolor = asfloat(cb0[38].xyzw);
  cb_config.ue_bluecorrection = 0.f;
  cb_config.ue_colorscale = asfloat(cb0[37].yzw);
  float4 lutweights[2] = {float4(asfloat(cb0[33].x), asfloat(cb0[34].x), 0.f, 0.f), float4(0.f, 0.f, 0.f, 0.f)};
  cb_config.ue_lutweights = lutweights;
  o0 = ProcessLutbuilder(float3(untonemapped_ap1), s0_s, t0, cb_config, o0, asuint(cb0[60].z));
  return;
  ...
  r0.x = cmp(cb0[30].w == 0.000000);
  [branch]
  if (r0.x != 0) {
    r0.x = dot(r1.xyz, cb0[23].xyz);
    r0.y = dot(r1.xyz, cb0[24].xyz);
    r0.z = dot(r1.xyz, cb0[25].xyz);
    r0.w = dot(r1.xyz, cb0[28].xyz);
    r0.w = 1 + r0.w;
    r0.w = rcp(r0.w);
    r2.xyz = cb0[30].xyz * r0.www + cb0[29].xyz;
    r0.xyz = r2.xyz * r0.xyz;
    r0.xyz = max(float3(0, 0, 0), r0.xyz);
    r2.xyz = cb0[26].xxx + -r0.xyz;
    r2.xyz = max(float3(0, 0, 0), r2.xyz);
    r3.xyz = max(cb0[26].zzz, r0.xyz);
    r0.xyz = max(cb0[26].xxx, r0.xyz);
    r0.xyz = min(cb0[26].zzz, r0.xyz);
    r4.xyz = r3.xyz * cb0[27].xxx + cb0[27].yyy;
    r3.xyz = cb0[26].www + r3.xyz;
    r3.xyz = rcp(r3.xyz);
    r5.xyz = cb0[23].www * r2.xyz;
    r2.xyz = cb0[26].yyy + r2.xyz;
    r2.xyz = rcp(r2.xyz);
    r2.xyz = r5.xyz * r2.xyz + cb0[24].www;
    r0.xyz = r0.xyz * cb0[25].www + r2.xyz;
    ...
    r3.xy = float2(1, 0.180000007) + cb0[31].ww;
    r0.w = -cb0[31].y + r3.x;
    r1.w = 1 + cb0[32].x;
    r2.w = -cb0[31].z + r1.w;
    r3.x = cmp(0.800000012 < cb0[31].y);
    r3.zw = float2(0.819999993, 1) + -cb0[31].yy;
  ...
  r2.xyz = cb0[34].xxx * r2.xyz;
  r0.xyz = cb0[33].xxx * r0.xyz + r2.xyz;
  ...
  r0.xyz = cb0[21].yyy * r0.xyz;
  r0.xyz = cb0[21].xxx * r2.xyz + r0.xyz;
  r0.xyz = cb0[21].zzz + r0.xyz;
  r2.xyz = cb0[37].yzw * r0.xyz;
  r0.xyz = -r0.xyz * cb0[37].yzw + cb0[38].xyz;
  r0.xyz = cb0[38].www * r0.xyz + r2.xyz;
  r0.xyz = max(float3(0, 0, 0), r0.xyz);
  r0.xyz = log2(r0.xyz);
  ...
  if (asuint(cb0[60].z) == 0) {
    ...
    r3.xyzw = cmp(asint(cb0[60].wwww) == int4(1, 2, 3, 4));
    ...
    if (r0.w != 0) {
      ...
      r6.xy = cmp(asint(cb0[60].zz) == int2(3, 5));
      ...
      if (r0.w != 0) {
        ...
        r6.xy = cmp(asint(cb0[60].zz) == int2(4, 6));
        r0.w = (int)r6.y | (int)r6.x;
        if (r0.w != 0) {
