...
// ---- Created with 3Dmigoto v1.3.2 on Mon Dec 30 00:29:05 2024
...
void main(
  ...
  float4 lutweights[2] = {float4(asfloat(cb0[39].x), asfloat(cb0[40].x), 0.f, 0.f), float4(0.f, 0.f, 0.f, 0.f)};
  cb_config.ue_lutweights = lutweights;
  o0 = ProcessLutbuilder(float3(untonemapped_ap1), s0_s, t0, cb_config, o0, asuint(cb0[67].z));
  return;
