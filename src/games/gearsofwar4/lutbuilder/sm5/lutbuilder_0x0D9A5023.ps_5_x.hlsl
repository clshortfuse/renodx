...
// Found in Outriders
// ---- Created with 3Dmigoto v1.4.1 on Mon Sep  1 15:46:55 2025
...
void main(
  ...
  cb_config.ue_bluecorrection = asfloat(cb0[66].w);
  ...
  [branch] if (asuint(cb0[44].x) != 0) {
    ...
    r0.xyz = cb0[66].www * r3.xyz + r0.xyz;
  ...
  [branch] if (asuint(cb0[65].z) == 0) {
    ...
    if (r0.w != 0) {
      ...
      if (r0.w != 0) {
        r7.xyz = log2(cb0[66].xzz);
        r9.xyz = r7.xyz * float3(0.30103001, 0.30103001, 0.30103001) + float3(4, -1.68124127, -0.681241274);
        r7.yw = float2(-2.82482171, 7.76277447) * r9.xy;
        r10.xyzw = -r9.xxyy * float4(0.434587955, 0.434587955, 0.431265235, 0.431265235) + float4(1, 1, 1, 1);
        r10.xyzw = r10.xyzw * float4(-15, -15, 6.5, 6.5) + r7.yyww;
        r7.yw = exp2(r10.yw);
        r7.yw = float2(0.180000007, 0.180000007) * r7.yw;
        r7.yw = log2(r7.yw);
        r8.xyzw = float4(0.30103001, 0.30103001, 0.30103001, 0.30103001) * r7.zxyw;
        r0.w = -r7.y * 0.30103001 + -0.744727433;
        r1.w = -r0.w * 0.166666672 + -0.744727433;
        r11.z = r1.w * 1.54999995 + 1.83556879;
        r1.w = r0.w * 0.166666672 + -0.744727433;
        r12.w = r1.w * 1.54999995 + 1.83556879;
        r10.xyzw = float4(15, 15, -6.5, -6.5) + r10.xyzw;
        r9.xy = float2(0.0411764719, 0.0782608688) * r10.yw;
        r10.xy = -r10.xz * float2(0.117647059, 0.0869565234) + float2(1, 1);
        r9.xy = r10.xy * float2(0.180000007, 0.889999986) + r9.xy;
        r1.w = -r7.x * 0.30103001 + 0.681241274;
        r11.w = r9.x * r1.w + r8.y;
        r1.w = r7.w * 0.30103001 + 0.744727433;
        r2.w = 0.166666672 * r1.w;
        r3.w = -r1.w * 0.166666672 + -0.744727433;
        r3.w = r3.w * 1.54999995 + 1.83556879;
        r4.w = r1.w * 0.166666672 + -0.744727433;
        r10.y = r4.w * 1.54999995 + 1.83556879;
        r10.z = r9.y * r9.z + 0.681241274;
        r4.w = max(1.00000001e-10, cb0[66].y);
        r4.w = log2(r4.w);
        r5.w = 0.30103001 * r4.w;
        r6.w = cmp(r8.y >= r5.w);
        if (r6.w == 0) {
          r6.w = cmp(r8.y < r5.w);
          r9.x = cmp(2.26303458 >= r4.w);
          r6.w = r6.w ? r9.x : 0;
          if (r6.w != 0) {
            r0.w = 0.333333343 * r0.w;
            r6.w = r7.x * 0.30103001 + r11.w;
            r6.w = 0.5 * r6.w;
            r7.x = r11.w + r11.z;
            r7.x = 0.5 * r7.x;
            r9.x = cmp(r6.w >= r5.w);
            ...
            r12.x = 2;
            r12.yz = r11.wz;
            r13.xyzw = r6.wwww ? r11.xywz : r12.xyzw;
            r11.x = 0;
            r9.xyzw = r9.xxxx ? r11.xyyw : r13.xyzw;
            r6.w = dot(r9.ywz, float3(0.5, 0.5, -1));
            r7.x = dot(r9.yz, float2(-1, 1));
            r9.y = dot(r9.yz, float2(0.5, 0.5));
            r9.y = -r4.w * 0.30103001 + r9.y;
            r6.w = r9.y * r6.w;
            r6.w = 4 * r6.w;
            r6.w = r7.x * r7.x + -r6.w;
            r6.w = sqrt(r6.w);
            ...
            r0.w = 0.333333343 * r1.w;
            r1.w = r10.y + r3.w;
            r1.w = 0.5 * r1.w;
            r6.w = r10.y + r10.z;
            r6.w = 0.5 * r6.w;
            r7.x = r7.z * 0.30103001 + r10.z;
            r7.x = 0.5 * r7.x;
            r7.z = cmp(2.26303458 < r4.w);
            r9.x = cmp(r5.w < r8.x);
            r7.z = r7.z ? r9.x : 0;
            r1.w = cmp(r5.w >= r1.w);
            r9.x = cmp(r6.w >= r5.w);
            ...
            r9.x = 2;
            r9.yzw = r10.wwz;
            r13.xyzw = r5.wwww ? r10.xyzw : r9.xwyz;
            r9.x = 0;
            r9.yz = r2.ww * float2(-1.54999995, 1.54999995) + float2(0.681241274, 0.681241274);
            r9.xyzw = r1.wwww ? r9.xyzw : r13.xyzw;
            r1.w = dot(r9.ywz, float3(0.5, 0.5, -1));
            r2.w = dot(r9.yz, float2(-1, 1));
            r5.w = dot(r9.yz, float2(0.5, 0.5));
            ...
            r2.w = (uint)r9.x;
            r1.w = r2.w + r1.w;
            r0.w = r1.w * r0.w + -0.744727433;
            r8.z = r7.z ? r0.w : r8.w;
          }
        }
        r0.w = r8.z * 3.32192802 + 2.47393107;
        r1.w = -2.47393107 + -r0.w;
        r7.xy = r7.yw + -r0.ww;
        r9.xyz = float3(1.5, 1.5, 1.5) * r1.xyz;
        r13.y = dot(float3(0.439700812, 0.382978052, 0.1773348), r9.xyz);
        r13.z = dot(float3(0.0897923037, 0.813423157, 0.096761629), r9.xyz);
        r13.w = dot(float3(0.0175439864, 0.111544058, 0.870704114), r9.xyz);
        r0.w = min(r13.y, r13.z);
        r0.w = min(r0.w, r13.w);
        r2.w = max(r13.y, r13.z);
        r2.w = max(r2.w, r13.w);
        r7.zw = max(float2(1.00000001e-10, 0.00999999978), r2.ww);
        r0.w = max(1.00000001e-10, r0.w);
        r0.w = r7.z + -r0.w;
        r0.w = r0.w / r7.w;
        r9.xyz = r13.wzy + -r13.zyw;
        r7.zw = r13.wz * r9.xy;
        r2.w = r7.z + r7.w;
        r2.w = r13.y * r9.z + r2.w;
        r2.w = sqrt(r2.w);
        r4.w = r13.w + r13.z;
        r4.w = r4.w + r13.y;
        r2.w = r2.w * 1.75 + r4.w;
        r4.w = 0.333333343 * r2.w;
        r5.w = -0.400000006 + r0.w;
        r6.w = 2.5 * r5.w;
        r6.w = 1 + -abs(r6.w);
        r6.w = max(0, r6.w);
        r7.z = cmp(0 < r5.w);
        ...
        r6.w = -r6.w * r6.w + 1;
        r5.w = r5.w * r6.w + 1;
        r5.w = 0.0250000004 * r5.w;
        r6.w = cmp(0.159999996 >= r2.w);
        r2.w = cmp(r2.w >= 0.479999989);
        r4.w = 0.0799999982 / r4.w;
        r4.w = -0.5 + r4.w;
        r4.w = r5.w * r4.w;
        r2.w = r2.w ? 0 : r4.w;
        r2.w = r6.w ? r5.w : r2.w;
        r2.w = 1 + r2.w;
        r9.yzw = r13.yzw * r2.www;
        r7.zw = cmp(r9.zw == r9.yz);
        r4.w = r7.w ? r7.z : 0;
        r5.w = r13.z * r2.w + -r9.w;
        r5.w = 1.73205078 * r5.w;
        r6.w = r9.y * 2 + -r9.z;
        r6.w = -r13.w * r2.w + r6.w;
        r7.z = min(abs(r6.w), abs(r5.w));
        r7.w = max(abs(r6.w), abs(r5.w));
        r7.w = 1 / r7.w;
        r7.z = r7.z * r7.w;
        r7.w = r7.z * r7.z;
        r8.z = r7.w * 0.0208350997 + -0.0851330012;
        r8.z = r7.w * r8.z + 0.180141002;
        r8.z = r7.w * r8.z + -0.330299497;
        r7.w = r7.w * r8.z + 0.999866009;
        r8.z = r7.z * r7.w;
        r8.w = cmp(abs(r6.w) < abs(r5.w));
        ...
        if (r5.w != 0) {
          r4.w = 67.5 + r4.w;
          r5.w = 0.0296296291 * r4.w;
          r6.w = (int)r5.w;
          r5.w = trunc(r5.w);
          r4.w = r4.w * 0.0296296291 + -r5.w;
          r5.w = r4.w * r4.w;
          r7.z = r5.w * r4.w;
          r12.xyz = float3(-0.166666672, -0.5, 0.166666672) * r7.zzz;
          r8.zw = r5.ww * float2(0.5, 0.5) + r12.xy;
          r8.zw = r4.ww * float2(-0.5, 0.5) + r8.zw;
          r4.w = r7.z * 0.5 + -r5.w;
          r4.w = 0.666666687 + r4.w;
          r13.xzw = cmp((int3)r6.www == int3(3, 2, 1));
          r7.zw = float2(0.166666672, 0.166666672) + r8.zw;
          r5.w = r6.w ? 0 : r12.z;
          r5.w = r13.w ? r7.w : r5.w;
          r4.w = r13.z ? r4.w : r5.w;
          r4.w = r13.x ? r7.z : r4.w;
        } else {
          r4.w = 0;
        }
        r0.w = r4.w * r0.w;
        r0.w = 1.5 * r0.w;
        r2.w = -r13.y * r2.w + 0.0299999993;
        r0.w = r2.w * r0.w;
        r9.x = r0.w * 0.180000007 + r9.y;
        r9.xyz = max(float3(0, 0, 0), r9.xzw);
        r9.xyz = min(float3(65535, 65535, 65535), r9.xyz);
        r12.x = dot(float3(1.45143926, -0.236510754, -0.214928567), r9.xyz);
        r12.y = dot(float3(-0.0765537769, 1.17622972, -0.0996759236), r9.xyz);
        r12.z = dot(float3(0.00831614807, -0.00603244966, 0.997716308), r9.xyz);
        r9.xyz = max(float3(0, 0, 0), r12.xyz);
        r9.xyz = min(float3(65535, 65535, 65535), r9.xyz);
        r0.w = dot(r9.xyz, float3(0.272228718, 0.674081743, 0.0536895171));
        r9.xyz = r9.xyz + -r0.www;
        r9.xyz = r9.xyz * float3(0.959999979, 0.959999979, 0.959999979) + r0.www;
        r12.xyz = cmp(float3(0, 0, 0) >= r9.xyz);
        r9.xyz = log2(r9.xyz);
        r9.xyz = float3(0.30103001, 0.30103001, 0.30103001) * r9.xyz;
        r9.xyz = r12.xyz ? float3(-4.21441984, -4.21441984, -4.21441984) : r9.xyz;
        r0.w = 0.30103001 * r7.x;
        r12.xyz = cmp(r0.www >= r9.xyz);
        if (r12.x != 0) {
          r2.w = r8.y;
        } else {
          r4.w = cmp(r0.w < r9.x);
          r5.w = 0.30103001 * r1.w;
          r6.w = cmp(r9.x < r5.w);
          r4.w = r4.w ? r6.w : 0;
          if (r4.w != 0) {
            r4.w = -r7.x * 0.30103001 + r9.x;
            r4.w = 3 * r4.w;
            r6.w = r1.w * 0.30103001 + -r0.w;
            r4.w = r4.w / r6.w;
            r6.w = (int)r4.w;
            r7.z = trunc(r4.w);
            r13.y = -r7.z + r4.w;
            r14.xyzw = cmp((int4)r6.wwww == int4(0, 1, 2, 3));
            r7.zw = cmp((int2)r6.ww == int2(4, 5));
            r14.xyzw = r14.xyzw ? float4(1, 1, 1, 1) : 0;
            r7.zw = r7.zw ? float2(1, 1) : 0;
            r4.w = dot(r14.yx, r8.yy);
            r4.w = r14.z * r11.w + r4.w;
            r4.w = r14.w * r11.z + r4.w;
            r4.w = r7.z * r12.w + r4.w;
            r14.x = r7.w * r12.w + r4.w;
            r15.xyzw = (int4)r6.wwww + int4(1, 1, 2, 2);
            r16.xyzw = cmp((int4)r15.yyyy == int4(0, 1, 2, 3));
            r17.xyzw = cmp((int4)r15.xyzw == int4(4, 5, 4, 5));
            r16.xyzw = r16.xyzw ? float4(1, 1, 1, 1) : 0;
            r17.xyzw = r17.xyzw ? float4(1, 1, 1, 1) : 0;
            r4.w = dot(r16.yx, r8.yy);
            r4.w = r16.z * r11.w + r4.w;
            r4.w = r16.w * r11.z + r4.w;
            r4.w = r17.x * r12.w + r4.w;
            r14.y = r17.y * r12.w + r4.w;
            r15.xyzw = cmp((int4)r15.wwww == int4(0, 1, 2, 3));
            r15.xyzw = r15.xyzw ? float4(1, 1, 1, 1) : 0;
            r4.w = dot(r15.yx, r8.yy);
            r4.w = r15.z * r11.w + r4.w;
            r4.w = r15.w * r11.z + r4.w;
            r4.w = r17.z * r12.w + r4.w;
            r14.z = r17.w * r12.w + r4.w;
            r13.x = r13.y * r13.y;
            r15.x = dot(r14.xzy, float3(0.5, 0.5, -1));
            r15.y = dot(r14.xy, float2(-1, 1));
            r15.z = dot(r14.xy, float2(0.5, 0.5));
            r13.z = 1;
            r2.w = dot(r13.xyz, r15.xyz);
          } else {
            r4.w = cmp(r9.x >= r5.w);
            r6.w = 0.30103001 * r7.y;
            r6.w = cmp(r9.x < r6.w);
            r4.w = r4.w ? r6.w : 0;
            if (r4.w != 0) {
              r4.w = -r1.w * 0.30103001 + r9.x;
              r4.w = 3 * r4.w;
              r5.w = r7.y * 0.30103001 + -r5.w;
              r4.w = r4.w / r5.w;
              r5.w = (int)r4.w;
              r6.w = trunc(r4.w);
              r13.y = -r6.w + r4.w;
              r14.xyzw = cmp((int4)r5.wwww == int4(0, 1, 2, 3));
              r7.zw = cmp((int2)r5.ww == int2(4, 5));
              r14.xyzw = r14.xyzw ? float4(1, 1, 1, 1) : 0;
              r7.zw = r7.zw ? float2(1, 1) : 0;
              r4.w = r14.y * r10.y;
              r4.w = r14.x * r3.w + r4.w;
              r4.w = r14.z * r10.z + r4.w;
              r4.w = r14.w * r8.x + r4.w;
              r4.w = r7.z * r8.x + r4.w;
              r14.x = r7.w * r8.x + r4.w;
              r15.xyzw = (int4)r5.wwww + int4(1, 1, 2, 2);
              r16.xyzw = cmp((int4)r15.yyyy == int4(0, 1, 2, 3));
              r17.xyzw = cmp((int4)r15.xyzw == int4(4, 5, 4, 5));
              r16.xyzw = r16.xyzw ? float4(1, 1, 1, 1) : 0;
              r17.xyzw = r17.xyzw ? float4(1, 1, 1, 1) : 0;
              r4.w = r16.y * r10.y;
              r4.w = r16.x * r3.w + r4.w;
              r4.w = r16.z * r10.z + r4.w;
              r4.w = r16.w * r8.x + r4.w;
              r4.w = r17.x * r8.x + r4.w;
              r14.y = r17.y * r8.x + r4.w;
              r15.xyzw = cmp((int4)r15.wwww == int4(0, 1, 2, 3));
              r15.xyzw = r15.xyzw ? float4(1, 1, 1, 1) : 0;
              r4.w = r15.y * r10.y;
              r4.w = r15.x * r3.w + r4.w;
              r4.w = r15.z * r10.z + r4.w;
              r4.w = r15.w * r8.x + r4.w;
              r4.w = r17.z * r8.x + r4.w;
              r14.z = r17.w * r8.x + r4.w;
              r13.x = r13.y * r13.y;
              r15.x = dot(r14.xzy, float3(0.5, 0.5, -1));
              r15.y = dot(r14.xy, float2(-1, 1));
              r15.z = dot(r14.xy, float2(0.5, 0.5));
        ...
        if (r12.y != 0) {
          ...
          if (r4.w != 0) {
            ...
            r7.z = trunc(r4.w);
            r14.y = -r7.z + r4.w;
            r15.xyzw = cmp((int4)r6.wwww == int4(0, 1, 2, 3));
            r7.zw = cmp((int2)r6.ww == int2(4, 5));
            r15.xyzw = r15.xyzw ? float4(1, 1, 1, 1) : 0;
            r7.zw = r7.zw ? float2(1, 1) : 0;
            r4.w = dot(r15.yx, r8.yy);
            ...
            r4.w = r15.w * r11.z + r4.w;
            r4.w = r7.z * r12.w + r4.w;
            r15.x = r7.w * r12.w + r4.w;
            r16.xyzw = (int4)r6.wwww + int4(1, 1, 2, 2);
            r17.xyzw = cmp((int4)r16.yyyy == int4(0, 1, 2, 3));
            r18.xyzw = cmp((int4)r16.xyzw == int4(4, 5, 4, 5));
            r17.xyzw = r17.xyzw ? float4(1, 1, 1, 1) : 0;
            r18.xyzw = r18.xyzw ? float4(1, 1, 1, 1) : 0;
            r4.w = dot(r17.yx, r8.yy);
            r4.w = r17.z * r11.w + r4.w;
            r4.w = r17.w * r11.z + r4.w;
            r4.w = r18.x * r12.w + r4.w;
            r15.y = r18.y * r12.w + r4.w;
            r16.xyzw = cmp((int4)r16.wwww == int4(0, 1, 2, 3));
            r16.xyzw = r16.xyzw ? float4(1, 1, 1, 1) : 0;
            r4.w = dot(r16.yx, r8.yy);
            r4.w = r16.z * r11.w + r4.w;
            r4.w = r16.w * r11.z + r4.w;
            r4.w = r18.z * r12.w + r4.w;
            r15.z = r18.w * r12.w + r4.w;
            r14.x = r14.y * r14.y;
            r16.x = dot(r15.xzy, float3(0.5, 0.5, -1));
            r16.y = dot(r15.xy, float2(-1, 1));
            r16.z = dot(r15.xy, float2(0.5, 0.5));
            r14.z = 1;
            r2.w = dot(r14.xyz, r16.xyz);
          } else {
            r4.w = cmp(r9.y >= r5.w);
            r6.w = 0.30103001 * r7.y;
            r6.w = cmp(r9.y < r6.w);
            ...
            if (r4.w != 0) {
              ...
              r6.w = trunc(r4.w);
              r14.y = -r6.w + r4.w;
              r15.xyzw = cmp((int4)r5.wwww == int4(0, 1, 2, 3));
              r7.zw = cmp((int2)r5.ww == int2(4, 5));
              r15.xyzw = r15.xyzw ? float4(1, 1, 1, 1) : 0;
              r7.zw = r7.zw ? float2(1, 1) : 0;
              r4.w = r15.y * r10.y;
              ...
              r4.w = r15.w * r8.x + r4.w;
              r4.w = r7.z * r8.x + r4.w;
              r15.x = r7.w * r8.x + r4.w;
              r16.xyzw = (int4)r5.wwww + int4(1, 1, 2, 2);
              r17.xyzw = cmp((int4)r16.yyyy == int4(0, 1, 2, 3));
              r18.xyzw = cmp((int4)r16.xyzw == int4(4, 5, 4, 5));
              r17.xyzw = r17.xyzw ? float4(1, 1, 1, 1) : 0;
              r18.xyzw = r18.xyzw ? float4(1, 1, 1, 1) : 0;
              r4.w = r17.y * r10.y;
              r4.w = r17.x * r3.w + r4.w;
              r4.w = r17.z * r10.z + r4.w;
              r4.w = r17.w * r8.x + r4.w;
              r4.w = r18.x * r8.x + r4.w;
              r15.y = r18.y * r8.x + r4.w;
              r16.xyzw = cmp((int4)r16.wwww == int4(0, 1, 2, 3));
              r16.xyzw = r16.xyzw ? float4(1, 1, 1, 1) : 0;
              r4.w = r16.y * r10.y;
              r4.w = r16.x * r3.w + r4.w;
              r4.w = r16.z * r10.z + r4.w;
              r4.w = r16.w * r8.x + r4.w;
              r4.w = r18.z * r8.x + r4.w;
              r15.z = r18.w * r8.x + r4.w;
              r14.x = r14.y * r14.y;
              r16.x = dot(r15.xzy, float3(0.5, 0.5, -1));
              r16.y = dot(r15.xy, float2(-1, 1));
              r16.z = dot(r15.xy, float2(0.5, 0.5));
        ...
        if (r12.z != 0) {
          ...
          r2.w = cmp(r0.w < r9.z);
          r4.w = 0.30103001 * r1.w;
          r5.w = cmp(r9.z < r4.w);
          r2.w = r2.w ? r5.w : 0;
          if (r2.w != 0) {
            r2.w = -r7.x * 0.30103001 + r9.z;
            r2.w = 3 * r2.w;
            ...
            r5.w = trunc(r0.w);
            r12.y = -r5.w + r0.w;
            r14.xyzw = cmp((int4)r2.wwww == int4(0, 1, 2, 3));
            r7.xz = cmp((int2)r2.ww == int2(4, 5));
            r14.xyzw = r14.xyzw ? float4(1, 1, 1, 1) : 0;
            r7.xz = r7.xz ? float2(1, 1) : 0;
            r0.w = dot(r14.yx, r8.yy);
            r0.w = r14.z * r11.w + r0.w;
            r0.w = r14.w * r11.z + r0.w;
            r0.w = r7.x * r12.w + r0.w;
            r14.x = r7.z * r12.w + r0.w;
            r15.xyzw = (int4)r2.wwww + int4(1, 1, 2, 2);
            r16.xyzw = cmp((int4)r15.yyyy == int4(0, 1, 2, 3));
            r17.xyzw = cmp((int4)r15.xyzw == int4(4, 5, 4, 5));
            r16.xyzw = r16.xyzw ? float4(1, 1, 1, 1) : 0;
            r17.xyzw = r17.xyzw ? float4(1, 1, 1, 1) : 0;
            r0.w = dot(r16.yx, r8.yy);
            r0.w = r16.z * r11.w + r0.w;
            r0.w = r16.w * r11.z + r0.w;
            r0.w = r17.x * r12.w + r0.w;
            r14.y = r17.y * r12.w + r0.w;
            r15.xyzw = cmp((int4)r15.wwww == int4(0, 1, 2, 3));
            r15.xyzw = r15.xyzw ? float4(1, 1, 1, 1) : 0;
            r0.w = dot(r15.yx, r8.yy);
            r0.w = r15.z * r11.w + r0.w;
            r0.w = r15.w * r11.z + r0.w;
            r0.w = r17.z * r12.w + r0.w;
            r14.z = r17.w * r12.w + r0.w;
            r12.x = r12.y * r12.y;
            r11.x = dot(r14.xzy, float3(0.5, 0.5, -1));
            r11.y = dot(r14.xy, float2(-1, 1));
            r11.z = dot(r14.xy, float2(0.5, 0.5));
            r12.z = 1;
            r8.x = dot(r12.xyz, r11.xyz);
          } else {
            r0.w = cmp(r9.z >= r4.w);
            r2.w = 0.30103001 * r7.y;
            r2.w = cmp(r9.z < r2.w);
            r0.w = r0.w ? r2.w : 0;
            if (r0.w != 0) {
              r0.w = -r1.w * 0.30103001 + r9.z;
              r0.w = 3 * r0.w;
              r1.w = r7.y * 0.30103001 + -r4.w;
              r0.w = r0.w / r1.w;
              r1.w = (int)r0.w;
              r2.w = trunc(r0.w);
              r7.y = -r2.w + r0.w;
              r9.xyzw = cmp((int4)r1.wwww == int4(0, 1, 2, 3));
              r8.yz = cmp((int2)r1.ww == int2(4, 5));
              r9.xyzw = r9.xyzw ? float4(1, 1, 1, 1) : 0;
              r8.yz = r8.yz ? float2(1, 1) : 0;
              r0.w = r9.y * r10.y;
              r0.w = r9.x * r3.w + r0.w;
              r0.w = r9.z * r10.z + r0.w;
              r0.w = r9.w * r8.x + r0.w;
              r0.w = r8.y * r8.x + r0.w;
              r9.x = r8.z * r8.x + r0.w;
              r11.xyzw = (int4)r1.wwww + int4(1, 1, 2, 2);
              r12.xyzw = cmp((int4)r11.yyyy == int4(0, 1, 2, 3));
              r14.xyzw = cmp((int4)r11.xyzw == int4(4, 5, 4, 5));
              r12.xyzw = r12.xyzw ? float4(1, 1, 1, 1) : 0;
              r14.xyzw = r14.xyzw ? float4(1, 1, 1, 1) : 0;
              r0.w = r12.y * r10.y;
              r0.w = r12.x * r3.w + r0.w;
              r0.w = r12.z * r10.z + r0.w;
              r0.w = r12.w * r8.x + r0.w;
              r0.w = r14.x * r8.x + r0.w;
              r9.y = r14.y * r8.x + r0.w;
              r11.xyzw = cmp((int4)r11.wwww == int4(0, 1, 2, 3));
              r11.xyzw = r11.xyzw ? float4(1, 1, 1, 1) : 0;
              r0.w = r11.y * r10.y;
              r0.w = r11.x * r3.w + r0.w;
              r0.w = r11.z * r10.z + r0.w;
              r0.w = r11.w * r8.x + r0.w;
              r0.w = r14.z * r8.x + r0.w;
              r9.z = r14.w * r8.x + r0.w;
              r7.x = r7.y * r7.y;
        ...
        r0.w = 3.32192802 * r8.x;
        r13.z = exp2(r0.w);
        r7.x = dot(r5.xyz, r13.xyz);
        r7.y = dot(r6.xyz, r13.xyz);
        r7.z = dot(r4.xyz, r13.xyz);
