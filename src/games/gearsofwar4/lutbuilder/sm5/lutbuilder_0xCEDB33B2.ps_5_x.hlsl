...
// ---- Created with 3Dmigoto v1.3.16 on Sun Jun 22 15:49:35 2025
  ...
  if (asuint(cb0[66].z) == 0) {
    ...
    if (r0.w != 0) {
      ...
      if (r0.w != 0) {
        ...
        r7.xyz = log2(r7.xyz);
        r7.xyz = cb0[65].zzz * r7.xyz;
        r7.xyz = exp2(r7.xyz);
        r9.xyz = cb0[65].www * r7.xyz;
        r0.w = dot(r8.xyz, float3(0.272228718, 0.674081743, 0.0536895171));
        r1.w = cb0[66].x + -cb0[65].w;
        r0.w = -cb0[65].w + r0.w;
        r1.w = 1 / r1.w;
        ...
        r0.w = r0.w * r0.w;
        r0.w = r1.w * r0.w;
        r7.xyz = -r7.xyz * cb0[65].www + r8.xyz;
        r7.xyz = r0.www * r7.xyz + r9.xyz;
        ...
        r0.w = exp2(r0.w);
        r8.xy = r0.ww * float2(18.8515625, 18.6875) + float2(0.8359375, 1);
        r0.w = rcp(r8.y);
        r0.w = r8.x * r0.w;
        r0.w = log2(r0.w);
        r0.w = 78.84375 * r0.w;
        r0.w = exp2(r0.w);
        r0.w = 1.33009529 * r0.w;
