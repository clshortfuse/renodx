...
// ---- Created with 3Dmigoto v1.3.2 on Fri Jul 04 03:14:08 2025
...
void main(
  ...
  r1.yz = -r0.ww * float2(4.60700006e+009, 2.0064e+009) + float2(2967800, 1901800);
  ...
  r2.xyz = cb0[44].zzz * float3(0.000154118257, 0.00084242021, 4.22806261e-005) + float3(0.860117733, 1, 0.317398727);
  r0.w = cb0[44].z * cb0[44].z;
  r2.xyz = r0.www * float3(1.28641219e-007, 7.08145137e-007, 4.20481676e-008) + r2.xyz;
  r2.x = r2.x / r2.y;
  r1.z = -cb0[44].z * 2.8974182e-005 + 1;
  ...
  r2.xy = max(float2(1.00000001e-010, 1.00000001e-010), r1.yw);
  ...
  o0 = ProcessLutbuilder(float3(untonemapped_ap1), s0_s, s1_s, t0, t1, cb_config, o0, asuint(cb0[65].z));
  return;
  ...
  [branch] if (asuint(cb0[65].z) == 0) {
    ...
    if (r0.w != 0) {
      ...
      r7.xyz = max(float3(1, 1, 1), r1.xyz);
      r1.xyz = saturate(r1.xyz);
      r8.xyz = float3(12.9200001, 12.9200001, 12.9200001) * r1.xyz;
      r9.xyz = cmp(r1.xyz >= float3(0.00313066994, 0.00313066994, 0.00313066994));
      r1.xyz = log2(r1.xyz);
      r1.xyz = float3(0.416666657, 0.416666657, 0.416666657) * r1.xyz;
      r1.xyz = exp2(r1.xyz);
      r1.xyz = r1.xyz * float3(1.05499995, 1.05499995, 1.05499995) + float3(-0.0549999997, -0.0549999997, -0.0549999997);
      r1.xyz = r9.xyz ? r1.xyz : r8.xyz;
      r8.yzw = r1.xyz * float3(0.9375, 0.9375, 0.9375) + float3(0.03125, 0.03125, 0.03125);
      r0.w = r8.w * 16 + -0.5;
      r1.w = floor(r0.w);
      r0.w = -r1.w + r0.w;
      r1.w = r8.y + r1.w;
      r8.x = 0.0625 * r1.w;
      r9.xyz = t0.Sample(s0_s, r8.xz).xyz;
      r8.yw = float2(0.0625, 0) + r8.xz;
      r10.xyz = t0.Sample(s0_s, r8.yw).xyz;
      r10.xyz = r10.xyz + -r9.xyz;
      r9.xyz = r0.www * r10.xyz + r9.xyz;
      r9.xyz = cb0[39].xxx * r9.xyz;
      r1.xyz = cb0[38].xxx * r1.xyz + r9.xyz;
      r9.xyz = t1.Sample(s1_s, r8.xz).xyz;
      r8.xyz = t1.Sample(s1_s, r8.yw).xyz;
      r8.xyz = r8.xyz + -r9.xyz;
      r8.xyz = r0.www * r8.xyz + r9.xyz;
      r1.xyz = cb0[40].xxx * r8.xyz + r1.xyz;
      r1.xyz = max(float3(6.10351999e-005, 6.10351999e-005, 6.10351999e-005), r1.xyz);
      r8.xyz = cmp(float3(0.0404499993, 0.0404499993, 0.0404499993) < r1.xyz);
      r9.xyz = r1.xyz * float3(0.947867274, 0.947867274, 0.947867274) + float3(0.0521326996, 0.0521326996, 0.0521326996);
      r9.xyz = log2(r9.xyz);
      r9.xyz = float3(2.4000001, 2.4000001, 2.4000001) * r9.xyz;
      r9.xyz = exp2(r9.xyz);
      r1.xyz = float3(0.0773993805, 0.0773993805, 0.0773993805) * r1.xyz;
      r1.xyz = r8.xyz ? r9.xyz : r1.xyz;
      ...
      if (r0.w != 0) {
        ...
        r7.xyz = float3(9.99999975e-005, 9.99999975e-005, 9.99999975e-005) * r7.xyz;
        r7.xyz = log2(r7.xyz);
