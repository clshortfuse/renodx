...
#include "./ue_extended_compat.hlsli"
...
float3 RestorePsychoHueAndCompressLMS(
  ...
  float3 source_relative_weighted = gears4_ue_extended::psycho22_ToAdaptiveRelativeWeightedLMS(source_lms, adaptive_state_lms);
  float3 target_relative_weighted = gears4_ue_extended::psycho22_ToAdaptiveRelativeWeightedLMS(target_lms, adaptive_state_lms);
  float3 neutral_weighted = gears4_ue_extended::psycho22_AdaptiveRelativeWeightedNeutral();
  ...
  float3 reference_white_relative_weighted =
      gears4_ue_extended::psycho22_ToAdaptiveRelativeWeightedLMS(
  ...
  target_relative_weighted = gears4_ue_extended::psycho22_GamutCompressAdaptiveRelativeWeightedLMSBound(
  ...
  return renodx::color::macleod_boynton::UnweighLMS(
             gears4_ue_extended::psycho22_FromAdaptiveRelativeWeightedLMS(target_relative_weighted, adaptive_state_lms))
         / RENODX_BT709_LMS_WHITE;
}
