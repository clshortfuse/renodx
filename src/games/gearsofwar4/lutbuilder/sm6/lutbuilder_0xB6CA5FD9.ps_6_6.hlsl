...
float4 main(
  ...
  bool _134 = (bIsTemperatureWhiteBalance != 0);
  float _139 = 0.9994439482688904f / WhiteTemp;
  ...
  float _170 = ((((WhiteTemp * 1.2864121856637212e-07f) + 0.00015411825734190643f) * WhiteTemp) + 0.8601177334785461f) / ((((WhiteTemp * 7.081451371959702e-07f) + 0.0008424202096648514f) * WhiteTemp) + 1.0f);
  float _177 = WhiteTemp * WhiteTemp;
  float _180 = ((((WhiteTemp * 4.204816761443908e-08f) + 4.228062607580796e-05f) * WhiteTemp) + 0.31739872694015503f) / ((1.0f - (WhiteTemp * 2.8974181986995973e-05f)) + (_177 * 1.6145605741257896e-07f));
  float _185 = ((_170 * 2.0f) + 4.0f) - (_180 * 8.0f);
  float _186 = (_170 * 3.0f) / _185;
  float _188 = (_180 * 2.0f) / _185;
  bool _189 = (WhiteTemp < 4000.0f);
  float _198 = ((WhiteTemp + 1189.6199951171875f) * WhiteTemp) + 1412139.875f;
  float _200 = ((-1137581184.0f - (WhiteTemp * 1916156.25f)) - (_177 * 1.5317699909210205f)) / (_198 * _198);
  float _207 = (6193636.0f - (WhiteTemp * 179.45599365234375f)) + _177;
  float _209 = ((1974715392.0f - (WhiteTemp * 705674.0f)) - (_177 * 308.60699462890625f)) / (_207 * _207);
  float _211 = rsqrt(dot(float2(_200, _209), float2(_200, _209)));
  float _212 = WhiteTint * 0.05000000074505806f;
  ...
  float _301 = mad(_280, (WorkingColorSpace_ToXYZ[2].x), mad(_277, (WorkingColorSpace_ToXYZ[1].x), (_274 * (WorkingColorSpace_ToXYZ[0].x))));
  float _304 = mad(_280, (WorkingColorSpace_ToXYZ[2].y), mad(_277, (WorkingColorSpace_ToXYZ[1].y), (_274 * (WorkingColorSpace_ToXYZ[0].y))));
  float _307 = mad(_280, (WorkingColorSpace_ToXYZ[2].z), mad(_277, (WorkingColorSpace_ToXYZ[1].z), (_274 * (WorkingColorSpace_ToXYZ[0].z))));
  float _310 = mad(_289, (WorkingColorSpace_ToXYZ[2].x), mad(_286, (WorkingColorSpace_ToXYZ[1].x), (_283 * (WorkingColorSpace_ToXYZ[0].x))));
  float _313 = mad(_289, (WorkingColorSpace_ToXYZ[2].y), mad(_286, (WorkingColorSpace_ToXYZ[1].y), (_283 * (WorkingColorSpace_ToXYZ[0].y))));
  float _316 = mad(_289, (WorkingColorSpace_ToXYZ[2].z), mad(_286, (WorkingColorSpace_ToXYZ[1].z), (_283 * (WorkingColorSpace_ToXYZ[0].z))));
  float _319 = mad(_298, (WorkingColorSpace_ToXYZ[2].x), mad(_295, (WorkingColorSpace_ToXYZ[1].x), (_292 * (WorkingColorSpace_ToXYZ[0].x))));
  float _322 = mad(_298, (WorkingColorSpace_ToXYZ[2].y), mad(_295, (WorkingColorSpace_ToXYZ[1].y), (_292 * (WorkingColorSpace_ToXYZ[0].y))));
  float _325 = mad(_298, (WorkingColorSpace_ToXYZ[2].z), mad(_295, (WorkingColorSpace_ToXYZ[1].z), (_292 * (WorkingColorSpace_ToXYZ[0].z))));
  float _355 = mad(mad((WorkingColorSpace_FromXYZ[0].z), _325, mad((WorkingColorSpace_FromXYZ[0].y), _316, (_307 * (WorkingColorSpace_FromXYZ[0].x)))), _107, mad(mad((WorkingColorSpace_FromXYZ[0].z), _322, mad((WorkingColorSpace_FromXYZ[0].y), _313, (_304 * (WorkingColorSpace_FromXYZ[0].x)))), _106, (mad((WorkingColorSpace_FromXYZ[0].z), _319, mad((WorkingColorSpace_FromXYZ[0].y), _310, (_301 * (WorkingColorSpace_FromXYZ[0].x)))) * _105)));
  float _358 = mad(mad((WorkingColorSpace_FromXYZ[1].z), _325, mad((WorkingColorSpace_FromXYZ[1].y), _316, (_307 * (WorkingColorSpace_FromXYZ[1].x)))), _107, mad(mad((WorkingColorSpace_FromXYZ[1].z), _322, mad((WorkingColorSpace_FromXYZ[1].y), _313, (_304 * (WorkingColorSpace_FromXYZ[1].x)))), _106, (mad((WorkingColorSpace_FromXYZ[1].z), _319, mad((WorkingColorSpace_FromXYZ[1].y), _310, (_301 * (WorkingColorSpace_FromXYZ[1].x)))) * _105)));
  float _361 = mad(mad((WorkingColorSpace_FromXYZ[2].z), _325, mad((WorkingColorSpace_FromXYZ[2].y), _316, (_307 * (WorkingColorSpace_FromXYZ[2].x)))), _107, mad(mad((WorkingColorSpace_FromXYZ[2].z), _322, mad((WorkingColorSpace_FromXYZ[2].y), _313, (_304 * (WorkingColorSpace_FromXYZ[2].x)))), _106, (mad((WorkingColorSpace_FromXYZ[2].z), _319, mad((WorkingColorSpace_FromXYZ[2].y), _310, (_301 * (WorkingColorSpace_FromXYZ[2].x)))) * _105)));
  float _376 = mad((WorkingColorSpace_ToAP1[0].z), _361, mad((WorkingColorSpace_ToAP1[0].y), _358, ((WorkingColorSpace_ToAP1[0].x) * _355)));
  float _379 = mad((WorkingColorSpace_ToAP1[1].z), _361, mad((WorkingColorSpace_ToAP1[1].y), _358, ((WorkingColorSpace_ToAP1[1].x) * _355)));
  float _382 = mad((WorkingColorSpace_ToAP1[2].z), _361, mad((WorkingColorSpace_ToAP1[2].y), _358, ((WorkingColorSpace_ToAP1[2].x) * _355)));
  ...
  // float _401 = (1.0f - exp2(((_383 * _383) * -4.0f) * ExpandGamut)) * (1.0f - exp2(dot(float3(_387, _388, _389), float3(_387, _388, _389)) * -4.0f));
  float _401 = (1.0f - exp2(((_383 * _383) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_387, _388, _389), float3(_387, _388, _389)) * -4.0f));
  ...
  float _434 = ColorOffset.w + ColorOffsetShadows.w;
  float _448 = ColorGain.w * ColorGainShadows.w;
  float _462 = ColorGamma.w * ColorGammaShadows.w;
  float _476 = ColorContrast.w * ColorContrastShadows.w;
  float _490 = ColorSaturation.w * ColorSaturationShadows.w;
  float _494 = _417 - _420;
  float _495 = _418 - _420;
  float _496 = _419 - _420;
  float _553 = saturate(_420 / ColorCorrectionShadowsMax);
  float _557 = (_553 * _553) * (3.0f - (_553 * 2.0f));
  float _558 = 1.0f - _557;
  float _567 = ColorOffset.w + ColorOffsetHighlights.w;
  float _576 = ColorGain.w * ColorGainHighlights.w;
  float _585 = ColorGamma.w * ColorGammaHighlights.w;
  float _594 = ColorContrast.w * ColorContrastHighlights.w;
  float _603 = ColorSaturation.w * ColorSaturationHighlights.w;
  float _667 = saturate((_420 - ColorCorrectionHighlightsMin) / (ColorCorrectionHighlightsMax - ColorCorrectionHighlightsMin));
  ...
  float _785 = ((_671 * (((ColorOffset.x + ColorOffsetHighlights.x) + _567) + (((ColorGain.x * ColorGainHighlights.x) * _576) * exp2(log2(exp2(((ColorContrast.x * ColorContrastHighlights.x) * _594) * log2(max(0.0f, ((((ColorSaturation.x * ColorSaturationHighlights.x) * _603) * _494) + _420)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((ColorGamma.x * ColorGammaHighlights.x) * _585)))))) + (_558 * (((ColorOffset.x + ColorOffsetShadows.x) + _434) + (((ColorGain.x * ColorGainShadows.x) * _448) * exp2(log2(exp2(((ColorContrast.x * ColorContrastShadows.x) * _476) * log2(max(0.0f, ((((ColorSaturation.x * ColorSaturationShadows.x) * _490) * _494) + _420)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((ColorGamma.x * ColorGammaShadows.x) * _462))))))) + ((((ColorOffset.x + ColorOffsetMidtones.x) + _680) + (((ColorGain.x * ColorGainMidtones.x) * _689) * exp2(log2(exp2(((ColorContrast.x * ColorContrastMidtones.x) * _707) * log2(max(0.0f, ((((ColorSaturation.x * ColorSaturationMidtones.x) * _716) * _494) + _420)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((ColorGamma.x * ColorGammaMidtones.x) * _698))))) * _774);
  float _787 = ((_671 * (((ColorOffset.y + ColorOffsetHighlights.y) + _567) + (((ColorGain.y * ColorGainHighlights.y) * _576) * exp2(log2(exp2(((ColorContrast.y * ColorContrastHighlights.y) * _594) * log2(max(0.0f, ((((ColorSaturation.y * ColorSaturationHighlights.y) * _603) * _495) + _420)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((ColorGamma.y * ColorGammaHighlights.y) * _585)))))) + (_558 * (((ColorOffset.y + ColorOffsetShadows.y) + _434) + (((ColorGain.y * ColorGainShadows.y) * _448) * exp2(log2(exp2(((ColorContrast.y * ColorContrastShadows.y) * _476) * log2(max(0.0f, ((((ColorSaturation.y * ColorSaturationShadows.y) * _490) * _495) + _420)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((ColorGamma.y * ColorGammaShadows.y) * _462))))))) + ((((ColorOffset.y + ColorOffsetMidtones.y) + _680) + (((ColorGain.y * ColorGainMidtones.y) * _689) * exp2(log2(exp2(((ColorContrast.y * ColorContrastMidtones.y) * _707) * log2(max(0.0f, ((((ColorSaturation.y * ColorSaturationMidtones.y) * _716) * _495) + _420)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((ColorGamma.y * ColorGammaMidtones.y) * _698))))) * _774);
  float _789 = ((_671 * (((ColorOffset.z + ColorOffsetHighlights.z) + _567) + (((ColorGain.z * ColorGainHighlights.z) * _576) * exp2(log2(exp2(((ColorContrast.z * ColorContrastHighlights.z) * _594) * log2(max(0.0f, ((((ColorSaturation.z * ColorSaturationHighlights.z) * _603) * _496) + _420)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((ColorGamma.z * ColorGammaHighlights.z) * _585)))))) + (_558 * (((ColorOffset.z + ColorOffsetShadows.z) + _434) + (((ColorGain.z * ColorGainShadows.z) * _448) * exp2(log2(exp2(((ColorContrast.z * ColorContrastShadows.z) * _476) * log2(max(0.0f, ((((ColorSaturation.z * ColorSaturationShadows.z) * _490) * _496) + _420)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((ColorGamma.z * ColorGammaShadows.z) * _462))))))) + ((((ColorOffset.z + ColorOffsetMidtones.z) + _680) + (((ColorGain.z * ColorGainMidtones.z) * _689) * exp2(log2(exp2(((ColorContrast.z * ColorContrastMidtones.z) * _707) * log2(max(0.0f, ((((ColorSaturation.z * ColorSaturationMidtones.z) * _716) * _496) + _420)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((ColorGamma.z * ColorGammaMidtones.z) * _698))))) * _774);
  ...
  SV_Target = ProcessLutbuilder(float3(_785, _787, _789), Samplers_1, Textures_1, cb_config, SV_Target, OutputDevice);
  return SV_Target;

  float _825 = ((mad(0.061360642313957214f, _789, mad(-4.540197551250458e-09f, _787, (_785 * 0.9386394023895264f))) - _785) * BlueCorrection) + _785;
  float _826 = ((mad(0.169205904006958f, _789, mad(0.8307942152023315f, _787, (_785 * 6.775371730327606e-08f))) - _787) * BlueCorrection) + _787;
  float _827 = (mad(-2.3283064365386963e-10f, _787, (_785 * -9.313225746154785e-10f)) * BlueCorrection) + _789;
  ...
  float _973 = (FilmBlackClip + 1.0f) - FilmToe;
  float _976 = FilmWhiteClip + 1.0f;
  float _978 = _976 - FilmShoulder;
  if (FilmToe > 0.800000011920929f) {
    _996 = (((0.8199999928474426f - FilmToe) / FilmSlope) + -0.7447274923324585f);
  } else {
    float _987 = (FilmBlackClip + 0.18000000715255737f) / _973;
    _996 = (-0.7447274923324585f - ((log2(_987 / (2.0f - _987)) * 0.3465735912322998f) * (_973 / FilmSlope)));
  }
  float _999 = ((1.0f - FilmToe) / FilmSlope) - _996;
  float _1001 = (FilmShoulder / FilmSlope) - _999;
  ...
  float _1011 = FilmSlope * (_1005 + _999);
  float _1012 = FilmSlope * (_1006 + _999);
  float _1013 = FilmSlope * (_1007 + _999);
  float _1014 = _973 * 2.0f;
  float _1016 = (FilmSlope * -2.0f) / _973;
  float _1017 = _1005 - _996;
  float _1018 = _1006 - _996;
  float _1019 = _1007 - _996;
  float _1038 = _978 * 2.0f;
  float _1040 = (FilmSlope * 2.0f) / _978;
  float _1065 = select((_1005 < _996), ((_1014 / (exp2((_1017 * 1.4426950216293335f) * _1016) + 1.0f)) - FilmBlackClip), _1011);
  float _1066 = select((_1006 < _996), ((_1014 / (exp2((_1018 * 1.4426950216293335f) * _1016) + 1.0f)) - FilmBlackClip), _1012);
  float _1067 = select((_1007 < _996), ((_1014 / (exp2((_1019 * 1.4426950216293335f) * _1016) + 1.0f)) - FilmBlackClip), _1013);
  ...
  float _1129 = (ToneCurveAmount * (max(0.0f, (lerp(_1109, _1106, 0.9300000071525574f))) - _825)) + _825;
  float _1130 = (ToneCurveAmount * (max(0.0f, (lerp(_1109, _1107, 0.9300000071525574f))) - _826)) + _826;
  float _1131 = (ToneCurveAmount * (max(0.0f, (lerp(_1109, _1108, 0.9300000071525574f))) - _827)) + _827;
  float _1147 = ((mad(-0.06537103652954102f, _1131, mad(1.451815478503704e-06f, _1130, (_1129 * 1.065374732017517f))) - _1129) * BlueCorrection) + _1129;
  float _1148 = ((mad(-0.20366770029067993f, _1131, mad(1.2036634683609009f, _1130, (_1129 * -2.57161445915699e-07f))) - _1130) * BlueCorrection) + _1130;
  float _1149 = ((mad(0.9999996423721313f, _1131, mad(2.0954757928848267e-08f, _1130, (_1129 * 1.862645149230957e-08f))) - _1131) * BlueCorrection) + _1131;
  float _1162 = saturate(max(0.0f, mad((WorkingColorSpace_FromAP1[0].z), _1149, mad((WorkingColorSpace_FromAP1[0].y), _1148, ((WorkingColorSpace_FromAP1[0].x) * _1147)))));
  float _1163 = saturate(max(0.0f, mad((WorkingColorSpace_FromAP1[1].z), _1149, mad((WorkingColorSpace_FromAP1[1].y), _1148, ((WorkingColorSpace_FromAP1[1].x) * _1147)))));
  float _1164 = saturate(max(0.0f, mad((WorkingColorSpace_FromAP1[2].z), _1149, mad((WorkingColorSpace_FromAP1[2].y), _1148, ((WorkingColorSpace_FromAP1[2].x) * _1147)))));
  ...
  float4 _1222 = Textures_1.Sample(Samplers_1, float2((_1212 + 0.0625f), _1201));
  float _1241 = max(6.103519990574569e-05f, (((lerp(_1215.x, _1222.x, _1210)) * (LUTWeights[0].y)) + ((LUTWeights[0].x) * _1175)));
  float _1242 = max(6.103519990574569e-05f, (((lerp(_1215.y, _1222.y, _1210)) * (LUTWeights[0].y)) + ((LUTWeights[0].x) * _1186)));
  float _1243 = max(6.103519990574569e-05f, (((lerp(_1215.z, _1222.z, _1210)) * (LUTWeights[0].y)) + ((LUTWeights[0].x) * _1197)));
  ...
  float _1293 = ColorScale.x * (((MappingPolynomial.y + (MappingPolynomial.x * _1265)) * _1265) + MappingPolynomial.z);
  float _1294 = ColorScale.y * (((MappingPolynomial.y + (MappingPolynomial.x * _1266)) * _1266) + MappingPolynomial.z);
  float _1295 = ColorScale.z * (((MappingPolynomial.y + (MappingPolynomial.x * _1267)) * _1267) + MappingPolynomial.z);
  float _1302 = ((OverlayColor.x - _1293) * OverlayColor.w) + _1293;
  float _1303 = ((OverlayColor.y - _1294) * OverlayColor.w) + _1294;
  float _1304 = ((OverlayColor.z - _1295) * OverlayColor.w) + _1295;
  float _1305 = ColorScale.x * mad((WorkingColorSpace_FromAP1[0].z), _789, mad((WorkingColorSpace_FromAP1[0].y), _787, (_785 * (WorkingColorSpace_FromAP1[0].x))));
  float _1306 = ColorScale.y * mad((WorkingColorSpace_FromAP1[1].z), _789, mad((WorkingColorSpace_FromAP1[1].y), _787, ((WorkingColorSpace_FromAP1[1].x) * _785)));
  float _1307 = ColorScale.z * mad((WorkingColorSpace_FromAP1[2].z), _789, mad((WorkingColorSpace_FromAP1[2].y), _787, ((WorkingColorSpace_FromAP1[2].x) * _785)));
  ...
  float _1328 = exp2(log2(max(0.0f, _1302)) * InverseGamma.y);
  float _1329 = exp2(log2(max(0.0f, _1303)) * InverseGamma.y);
  float _1330 = exp2(log2(max(0.0f, _1304)) * InverseGamma.y);
  [branch]
  if (OutputDevice == 0) {
    do {
      if (WorkingColorSpace_bIsSRGB == 0) {
        float _1353 = mad((WorkingColorSpace_ToAP1[0].z), _1330, mad((WorkingColorSpace_ToAP1[0].y), _1329, ((WorkingColorSpace_ToAP1[0].x) * _1328)));
        float _1356 = mad((WorkingColorSpace_ToAP1[1].z), _1330, mad((WorkingColorSpace_ToAP1[1].y), _1329, ((WorkingColorSpace_ToAP1[1].x) * _1328)));
        float _1359 = mad((WorkingColorSpace_ToAP1[2].z), _1330, mad((WorkingColorSpace_ToAP1[2].y), _1329, ((WorkingColorSpace_ToAP1[2].x) * _1328)));
    ...
    if (OutputDevice == 1) {
      float _1421 = mad((WorkingColorSpace_ToAP1[0].z), _1330, mad((WorkingColorSpace_ToAP1[0].y), _1329, ((WorkingColorSpace_ToAP1[0].x) * _1328)));
      float _1424 = mad((WorkingColorSpace_ToAP1[1].z), _1330, mad((WorkingColorSpace_ToAP1[1].y), _1329, ((WorkingColorSpace_ToAP1[1].x) * _1328)));
      float _1427 = mad((WorkingColorSpace_ToAP1[2].z), _1330, mad((WorkingColorSpace_ToAP1[2].y), _1329, ((WorkingColorSpace_ToAP1[2].x) * _1328)));
      ...
      if ((bool)(OutputDevice == 3) || (bool)(OutputDevice == 5)) {
        ...
        float _1516 = ACESSceneColorMultiplier * _1314;
        float _1517 = ACESSceneColorMultiplier * _1315;
        float _1518 = ACESSceneColorMultiplier * _1316;
        float _1521 = mad((WorkingColorSpace_ToAP0[0].z), _1518, mad((WorkingColorSpace_ToAP0[0].y), _1517, ((WorkingColorSpace_ToAP0[0].x) * _1516)));
        float _1524 = mad((WorkingColorSpace_ToAP0[1].z), _1518, mad((WorkingColorSpace_ToAP0[1].y), _1517, ((WorkingColorSpace_ToAP0[1].x) * _1516)));
        float _1527 = mad((WorkingColorSpace_ToAP0[2].z), _1518, mad((WorkingColorSpace_ToAP0[2].y), _1517, ((WorkingColorSpace_ToAP0[2].x) * _1516)));
          ...
          do {
            ...
            do {
              ...
              do {
                ...
                float _1702 = log2(ACESMinMaxData.x);
                float _1703 = _1702 * 0.3010300099849701f;
                do {
                  if (!(!(_1701 <= _1703))) {
                    _1772 = (log2(ACESMinMaxData.y) * 0.3010300099849701f);
                  } else {
                    float _1710 = log2(ACESMidData.x);
                    ...
                    if ((bool)(_1701 > _1703) && (bool)(_1701 < _1711)) {
                      ...
                      do {
                        if (!(!(_1701 >= _1711))) {
                          float _1741 = log2(ACESMinMaxData.z);
                        ...
                        _1772 = (log2(ACESMinMaxData.w) * 0.3010300099849701f);
                      } while (false);
                    }
                  }
                  ...
                  do {
                    if (!(!(_1777 <= _1703))) {
                      _1846 = (log2(ACESMinMaxData.y) * 0.3010300099849701f);
                    } else {
                      float _1784 = log2(ACESMidData.x);
                      ...
                      if ((bool)(_1777 > _1703) && (bool)(_1777 < _1785)) {
                        ...
                        do {
                          if (!(!(_1777 >= _1785))) {
                            float _1815 = log2(ACESMinMaxData.z);
                          ...
                          _1846 = (log2(ACESMinMaxData.w) * 0.3010300099849701f);
                        } while (false);
                      }
                    }
                    ...
                    do {
                      if (!(!(_1851 <= _1703))) {
                        _1920 = (log2(ACESMinMaxData.y) * 0.3010300099849701f);
                      } else {
                        float _1858 = log2(ACESMidData.x);
                        ...
                        if ((bool)(_1851 > _1703) && (bool)(_1851 < _1859)) {
                          ...
                          do {
                            if (!(!(_1851 >= _1859))) {
                              float _1889 = log2(ACESMinMaxData.z);
                            ...
                            _1920 = (log2(ACESMinMaxData.w) * 0.3010300099849701f);
                          } while (false);
                        }
                      }
                      float _1924 = ACESMinMaxData.w - ACESMinMaxData.y;
                      float _1925 = (exp2(_1772 * 3.321928024291992f) - ACESMinMaxData.y) / _1924;
                      float _1927 = (exp2(_1846 * 3.321928024291992f) - ACESMinMaxData.y) / _1924;
                      float _1929 = (exp2(_1920 * 3.321928024291992f) - ACESMinMaxData.y) / _1924;
                      ...
                      float _1984 = min(max((min(max(mad(-0.23642469942569733f, _1962, mad(-0.32480329275131226f, _1959, (_1956 * 1.6410233974456787f))), 0.0f), 65535.0f) * ACESMinMaxData.w), 0.0f), 65535.0f);
                      float _1985 = min(max((min(max(mad(0.016756348311901093f, _1962, mad(1.6153316497802734f, _1959, (_1956 * -0.663662850856781f))), 0.0f), 65535.0f) * ACESMinMaxData.w), 0.0f), 65535.0f);
                      float _1986 = min(max((min(max(mad(0.9883948564529419f, _1962, mad(-0.008284442126750946f, _1959, (_1956 * 0.011721894145011902f))), 0.0f), 65535.0f) * ACESMinMaxData.w), 0.0f), 65535.0f);
                      do {
                        if (!(OutputDevice == 5)) {
        ...
        if ((OutputDevice & -3) == 4) {
          ...
          float _2092 = ACESSceneColorMultiplier * _1314;
          float _2093 = ACESSceneColorMultiplier * _1315;
          float _2094 = ACESSceneColorMultiplier * _1316;
          ...
          if (OutputDevice == 7) {
            float _2634 = mad((WorkingColorSpace_ToAP1[0].z), _1316, mad((WorkingColorSpace_ToAP1[0].y), _1315, ((WorkingColorSpace_ToAP1[0].x) * _1314)));
            float _2637 = mad((WorkingColorSpace_ToAP1[1].z), _1316, mad((WorkingColorSpace_ToAP1[1].y), _1315, ((WorkingColorSpace_ToAP1[1].x) * _1314)));
            float _2640 = mad((WorkingColorSpace_ToAP1[2].z), _1316, mad((WorkingColorSpace_ToAP1[2].y), _1315, ((WorkingColorSpace_ToAP1[2].x) * _1314)));
            ...
            if (!(OutputDevice == 8)) {
              if (OutputDevice == 9) {
                float _2708 = mad((WorkingColorSpace_ToAP1[0].z), _1304, mad((WorkingColorSpace_ToAP1[0].y), _1303, ((WorkingColorSpace_ToAP1[0].x) * _1302)));
                float _2711 = mad((WorkingColorSpace_ToAP1[1].z), _1304, mad((WorkingColorSpace_ToAP1[1].y), _1303, ((WorkingColorSpace_ToAP1[1].x) * _1302)));
                float _2714 = mad((WorkingColorSpace_ToAP1[2].z), _1304, mad((WorkingColorSpace_ToAP1[2].y), _1303, ((WorkingColorSpace_ToAP1[2].x) * _1302)));
                ...
                float _2727 = mad((WorkingColorSpace_ToAP1[0].z), _1330, mad((WorkingColorSpace_ToAP1[0].y), _1329, ((WorkingColorSpace_ToAP1[0].x) * _1328)));
                float _2730 = mad((WorkingColorSpace_ToAP1[1].z), _1330, mad((WorkingColorSpace_ToAP1[1].y), _1329, ((WorkingColorSpace_ToAP1[1].x) * _1328)));
                float _2733 = mad((WorkingColorSpace_ToAP1[2].z), _1330, mad((WorkingColorSpace_ToAP1[2].y), _1329, ((WorkingColorSpace_ToAP1[2].x) * _1328)));
                _2754 = exp2(log2(mad(_41, _2733, mad(_40, _2730, (_2727 * _39)))) * InverseGamma.z);
                _2755 = exp2(log2(mad(_44, _2733, mad(_43, _2730, (_2727 * _42)))) * InverseGamma.z);
                _2756 = exp2(log2(mad(_47, _2733, mad(_46, _2730, (_2727 * _45)))) * InverseGamma.z);
              }
            } else {
              _2754 = _1314;
              _2755 = _1315;
