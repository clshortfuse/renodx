...
void main(
  ...
  if (!(abs(cb0_037y + -6500.0f) > 9.99999993922529e-09f)) {
    ...
    if (!(abs(cb0_037z) > 9.99999993922529e-09f)) {
      ...
      float _376 = (1.0f - exp2(((_358 * _358) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_362, _363, _364), float3(_362, _363, _364)) * -4.0f));
      ...
      float4 output = ProcessLutbuilder(float3(_759, _761, _763), cb_config, u0[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))], cb0_040w);
      ...
      float _829 = ((float(((int)(uint)((bool)(_814 > 0.0f))) - ((int)(uint)((bool)(_814 < 0.0f)))) * (1.0f - (_818 * _818))) + 1.0f) * 0.02500000037252903f;
      do {
                ...
                do {
                  ...
                  do {
                    ...
                    do {
                      ...
                      u0[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))] = float4((_1214 * 0.9523810148239136f), (_1225 * 0.9523810148239136f), (_1236 * 0.9523810148239136f), 0.0f);
                    } while (false);
                  } while (false);
                } while (false);
              } while (false);
