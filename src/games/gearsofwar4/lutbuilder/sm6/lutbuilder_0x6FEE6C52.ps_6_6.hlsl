...
float4 main(
  ...
  cb_config.ue_filmblackclip = cb0_041x;
  cb_config.ue_filmtoe = cb0_040z;
  cb_config.ue_filmshoulder = cb0_040w;
  cb_config.ue_filmslope = cb0_040y;
  cb_config.ue_filmwhiteclip = cb0_041y;
  ...
  SV_Target = ProcessLutbuilder(float3(_738, _740, _742), cb_config, SV_Target, cb0_044x);
  return SV_Target;
