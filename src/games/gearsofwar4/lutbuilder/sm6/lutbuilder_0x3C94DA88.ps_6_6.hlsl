...
float4 main(
  ...
  float _81 = mad((WorkingColorSpace.ToAP1[0].z), _66, mad((WorkingColorSpace.ToAP1[0].y), _65, ((WorkingColorSpace.ToAP1[0].x) * _64)));
  float _84 = mad((WorkingColorSpace.ToAP1[1].z), _66, mad((WorkingColorSpace.ToAP1[1].y), _65, ((WorkingColorSpace.ToAP1[1].x) * _64)));
  float _87 = mad((WorkingColorSpace.ToAP1[2].z), _66, mad((WorkingColorSpace.ToAP1[2].y), _65, ((WorkingColorSpace.ToAP1[2].x) * _64)));
  ...
  float _559 = ((float((int)(((int)(uint)((bool)(_544 > 0.0f))) - ((int)(uint)((bool)(_544 < 0.0f))))) * (1.0f - (_548 * _548))) + 1.0f) * 0.02500000037252903f;
  ...
  float _857 = saturate(max(0.0f, mad((WorkingColorSpace.FromAP1[0].z), _832, mad((WorkingColorSpace.FromAP1[0].y), _831, ((WorkingColorSpace.FromAP1[0].x) * _830)))));
  float _858 = saturate(max(0.0f, mad((WorkingColorSpace.FromAP1[1].z), _832, mad((WorkingColorSpace.FromAP1[1].y), _831, ((WorkingColorSpace.FromAP1[1].x) * _830)))));
  float _859 = saturate(max(0.0f, mad((WorkingColorSpace.FromAP1[2].z), _832, mad((WorkingColorSpace.FromAP1[2].y), _831, ((WorkingColorSpace.FromAP1[2].x) * _830)))));
  ...
  if (WorkingColorSpace.bIsSRGB == 0) {
    float _1061 = mad((WorkingColorSpace.ToAP1[0].z), _1042, mad((WorkingColorSpace.ToAP1[0].y), _1041, ((WorkingColorSpace.ToAP1[0].x) * _1040)));
    float _1064 = mad((WorkingColorSpace.ToAP1[1].z), _1042, mad((WorkingColorSpace.ToAP1[1].y), _1041, ((WorkingColorSpace.ToAP1[1].x) * _1040)));
    float _1067 = mad((WorkingColorSpace.ToAP1[2].z), _1042, mad((WorkingColorSpace.ToAP1[2].y), _1041, ((WorkingColorSpace.ToAP1[2].x) * _1040)));
