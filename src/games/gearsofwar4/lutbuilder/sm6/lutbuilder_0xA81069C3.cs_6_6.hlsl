...
void main(
  ...
  bool _101 = (cb0_038w != 0);
  float _105 = 0.9994439482688904f / cb0_035y;
  ...
  float _136 = ((((cb0_035y * 1.2864121856637212e-07f) + 0.00015411825734190643f) * cb0_035y) + 0.8601177334785461f) / ((((cb0_035y * 7.081451371959702e-07f) + 0.0008424202096648514f) * cb0_035y) + 1.0f);
  float _143 = cb0_035y * cb0_035y;
  float _146 = ((((cb0_035y * 4.204816761443908e-08f) + 4.228062607580796e-05f) * cb0_035y) + 0.31739872694015503f) / ((1.0f - (cb0_035y * 2.8974181986995973e-05f)) + (_143 * 1.6145605741257896e-07f));
  float _151 = ((_136 * 2.0f) + 4.0f) - (_146 * 8.0f);
  float _152 = (_136 * 3.0f) / _151;
  float _154 = (_146 * 2.0f) / _151;
  bool _155 = (cb0_035y < 4000.0f);
  float _164 = ((cb0_035y + 1189.6199951171875f) * cb0_035y) + 1412139.875f;
  float _166 = ((-1137581184.0f - (cb0_035y * 1916156.25f)) - (_143 * 1.5317699909210205f)) / (_164 * _164);
  float _173 = (6193636.0f - (cb0_035y * 179.45599365234375f)) + _143;
  float _175 = ((1974715392.0f - (cb0_035y * 705674.0f)) - (_143 * 308.60699462890625f)) / (_173 * _173);
  float _177 = rsqrt(dot(float2(_166, _175), float2(_166, _175)));
  float _178 = cb0_035z * 0.05000000074505806f;
  ...
  float _267 = mad(_246, (WorkingColorSpace_000[2].x), mad(_243, (WorkingColorSpace_000[1].x), (_240 * (WorkingColorSpace_000[0].x))));
  float _270 = mad(_246, (WorkingColorSpace_000[2].y), mad(_243, (WorkingColorSpace_000[1].y), (_240 * (WorkingColorSpace_000[0].y))));
  float _273 = mad(_246, (WorkingColorSpace_000[2].z), mad(_243, (WorkingColorSpace_000[1].z), (_240 * (WorkingColorSpace_000[0].z))));
  float _276 = mad(_255, (WorkingColorSpace_000[2].x), mad(_252, (WorkingColorSpace_000[1].x), (_249 * (WorkingColorSpace_000[0].x))));
  float _279 = mad(_255, (WorkingColorSpace_000[2].y), mad(_252, (WorkingColorSpace_000[1].y), (_249 * (WorkingColorSpace_000[0].y))));
  float _282 = mad(_255, (WorkingColorSpace_000[2].z), mad(_252, (WorkingColorSpace_000[1].z), (_249 * (WorkingColorSpace_000[0].z))));
  float _285 = mad(_264, (WorkingColorSpace_000[2].x), mad(_261, (WorkingColorSpace_000[1].x), (_258 * (WorkingColorSpace_000[0].x))));
  float _288 = mad(_264, (WorkingColorSpace_000[2].y), mad(_261, (WorkingColorSpace_000[1].y), (_258 * (WorkingColorSpace_000[0].y))));
  float _291 = mad(_264, (WorkingColorSpace_000[2].z), mad(_261, (WorkingColorSpace_000[1].z), (_258 * (WorkingColorSpace_000[0].z))));
  float _321 = mad(mad((WorkingColorSpace_064[0].z), _291, mad((WorkingColorSpace_064[0].y), _282, (_273 * (WorkingColorSpace_064[0].x)))), _74, mad(mad((WorkingColorSpace_064[0].z), _288, mad((WorkingColorSpace_064[0].y), _279, (_270 * (WorkingColorSpace_064[0].x)))), _73, (mad((WorkingColorSpace_064[0].z), _285, mad((WorkingColorSpace_064[0].y), _276, (_267 * (WorkingColorSpace_064[0].x)))) * _72)));
  float _324 = mad(mad((WorkingColorSpace_064[1].z), _291, mad((WorkingColorSpace_064[1].y), _282, (_273 * (WorkingColorSpace_064[1].x)))), _74, mad(mad((WorkingColorSpace_064[1].z), _288, mad((WorkingColorSpace_064[1].y), _279, (_270 * (WorkingColorSpace_064[1].x)))), _73, (mad((WorkingColorSpace_064[1].z), _285, mad((WorkingColorSpace_064[1].y), _276, (_267 * (WorkingColorSpace_064[1].x)))) * _72)));
  float _327 = mad(mad((WorkingColorSpace_064[2].z), _291, mad((WorkingColorSpace_064[2].y), _282, (_273 * (WorkingColorSpace_064[2].x)))), _74, mad(mad((WorkingColorSpace_064[2].z), _288, mad((WorkingColorSpace_064[2].y), _279, (_270 * (WorkingColorSpace_064[2].x)))), _73, (mad((WorkingColorSpace_064[2].z), _285, mad((WorkingColorSpace_064[2].y), _276, (_267 * (WorkingColorSpace_064[2].x)))) * _72)));
  float _342 = mad((WorkingColorSpace_128[0].z), _327, mad((WorkingColorSpace_128[0].y), _324, ((WorkingColorSpace_128[0].x) * _321)));
  float _345 = mad((WorkingColorSpace_128[1].z), _327, mad((WorkingColorSpace_128[1].y), _324, ((WorkingColorSpace_128[1].x) * _321)));
  float _348 = mad((WorkingColorSpace_128[2].z), _327, mad((WorkingColorSpace_128[2].y), _324, ((WorkingColorSpace_128[2].x) * _321)));
  ...
  float _367 = (1.0f - exp2(((_349 * _349) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_353, _354, _355), float3(_353, _354, _355)) * -4.0f));
  ...
  float _400 = cb0_019w + cb0_024w;
  float _414 = cb0_018w * cb0_023w;
  float _428 = cb0_017w * cb0_022w;
  float _442 = cb0_016w * cb0_021w;
  float _456 = cb0_015w * cb0_020w;
  float _460 = _383 - _386;
  float _461 = _384 - _386;
  float _462 = _385 - _386;
  float _519 = saturate(_386 / cb0_035w);
  float _523 = (_519 * _519) * (3.0f - (_519 * 2.0f));
  float _524 = 1.0f - _523;
  float _533 = cb0_019w + cb0_034w;
  float _542 = cb0_018w * cb0_033w;
  float _551 = cb0_017w * cb0_032w;
  float _560 = cb0_016w * cb0_031w;
  float _569 = cb0_015w * cb0_030w;
  float _632 = saturate((_386 - cb0_036x) / (cb0_036y - cb0_036x));
  float _636 = (_632 * _632) * (3.0f - (_632 * 2.0f));
  float _645 = cb0_019w + cb0_029w;
  float _654 = cb0_018w * cb0_028w;
  float _663 = cb0_017w * cb0_027w;
  float _672 = cb0_016w * cb0_026w;
  float _681 = cb0_015w * cb0_025w;
  float _739 = _523 - _636;
  float _750 = ((_636 * (((cb0_019x + cb0_034x) + _533) + (((cb0_018x * cb0_033x) * _542) * exp2(log2(exp2(((cb0_016x * cb0_031x) * _560) * log2(max(0.0f, ((((cb0_015x * cb0_030x) * _569) * _460) + _386)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017x * cb0_032x) * _551)))))) + (_524 * (((cb0_019x + cb0_024x) + _400) + (((cb0_018x * cb0_023x) * _414) * exp2(log2(exp2(((cb0_016x * cb0_021x) * _442) * log2(max(0.0f, ((((cb0_015x * cb0_020x) * _456) * _460) + _386)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017x * cb0_022x) * _428))))))) + ((((cb0_019x + cb0_029x) + _645) + (((cb0_018x * cb0_028x) * _654) * exp2(log2(exp2(((cb0_016x * cb0_026x) * _672) * log2(max(0.0f, ((((cb0_015x * cb0_025x) * _681) * _460) + _386)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017x * cb0_027x) * _663))))) * _739);
  float _752 = ((_636 * (((cb0_019y + cb0_034y) + _533) + (((cb0_018y * cb0_033y) * _542) * exp2(log2(exp2(((cb0_016y * cb0_031y) * _560) * log2(max(0.0f, ((((cb0_015y * cb0_030y) * _569) * _461) + _386)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017y * cb0_032y) * _551)))))) + (_524 * (((cb0_019y + cb0_024y) + _400) + (((cb0_018y * cb0_023y) * _414) * exp2(log2(exp2(((cb0_016y * cb0_021y) * _442) * log2(max(0.0f, ((((cb0_015y * cb0_020y) * _456) * _461) + _386)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017y * cb0_022y) * _428))))))) + ((((cb0_019y + cb0_029y) + _645) + (((cb0_018y * cb0_028y) * _654) * exp2(log2(exp2(((cb0_016y * cb0_026y) * _672) * log2(max(0.0f, ((((cb0_015y * cb0_025y) * _681) * _461) + _386)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017y * cb0_027y) * _663))))) * _739);
  float _754 = ((_636 * (((cb0_019z + cb0_034z) + _533) + (((cb0_018z * cb0_033z) * _542) * exp2(log2(exp2(((cb0_016z * cb0_031z) * _560) * log2(max(0.0f, ((((cb0_015z * cb0_030z) * _569) * _462) + _386)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017z * cb0_032z) * _551)))))) + (_524 * (((cb0_019z + cb0_024z) + _400) + (((cb0_018z * cb0_023z) * _414) * exp2(log2(exp2(((cb0_016z * cb0_021z) * _442) * log2(max(0.0f, ((((cb0_015z * cb0_020z) * _456) * _462) + _386)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017z * cb0_022z) * _428))))))) + ((((cb0_019z + cb0_029z) + _645) + (((cb0_018z * cb0_028z) * _654) * exp2(log2(exp2(((cb0_016z * cb0_026z) * _672) * log2(max(0.0f, ((((cb0_015z * cb0_025z) * _681) * _462) + _386)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017z * cb0_027z) * _663))))) * _739);
  ...
  cb_config.ue_lutweights = lutweights;  // Only Lutweights[0].xyzis used

  float4 output = ProcessLutbuilder(float3(_750, _752, _754), s0, t0, cb_config, u0[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))], 0u);
  u0[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))] = output;
  return;
  
  float _769 = ((mad(0.061360642313957214f, _754, mad(-4.540197551250458e-09f, _752, (_750 * 0.9386394023895264f))) - _750) * cb0_036z) + _750;
  float _770 = ((mad(0.169205904006958f, _754, mad(0.8307942152023315f, _752, (_750 * 6.775371730327606e-08f))) - _752) * cb0_036z) + _752;
  float _771 = (mad(-2.3283064365386963e-10f, _752, (_750 * -9.313225746154785e-10f)) * cb0_036z) + _754;
  ...
  float _918 = (cb0_038x + 1.0f) - cb0_037z;
  float _920 = cb0_038y + 1.0f;
  float _922 = _920 - cb0_037w;
  if (cb0_037z > 0.800000011920929f) {
    _940 = (((0.8199999928474426f - cb0_037z) / cb0_037y) + -0.7447274923324585f);
  } else {
    float _931 = (cb0_038x + 0.18000000715255737f) / _918;
    _940 = (-0.7447274923324585f - ((log2(_931 / (2.0f - _931)) * 0.3465735912322998f) * (_918 / cb0_037y)));
  }
  float _943 = ((1.0f - cb0_037z) / cb0_037y) - _940;
  float _945 = (cb0_037w / cb0_037y) - _943;
  ...
  float _955 = cb0_037y * (_949 + _943);
  float _956 = cb0_037y * (_950 + _943);
  float _957 = cb0_037y * (_951 + _943);
  float _958 = _918 * 2.0f;
  float _960 = (cb0_037y * -2.0f) / _918;
  float _961 = _949 - _940;
  float _962 = _950 - _940;
  float _963 = _951 - _940;
  float _982 = _922 * 2.0f;
  float _984 = (cb0_037y * 2.0f) / _922;
  float _1009 = select((_949 < _940), ((_958 / (exp2((_961 * 1.4426950216293335f) * _960) + 1.0f)) - cb0_038x), _955);
  float _1010 = select((_950 < _940), ((_958 / (exp2((_962 * 1.4426950216293335f) * _960) + 1.0f)) - cb0_038x), _956);
  float _1011 = select((_951 < _940), ((_958 / (exp2((_963 * 1.4426950216293335f) * _960) + 1.0f)) - cb0_038x), _957);
  ...
  float _1073 = (cb0_037x * (max(0.0f, (lerp(_1053, _1050, 0.9300000071525574f))) - _769)) + _769;
  float _1074 = (cb0_037x * (max(0.0f, (lerp(_1053, _1051, 0.9300000071525574f))) - _770)) + _770;
  float _1075 = (cb0_037x * (max(0.0f, (lerp(_1053, _1052, 0.9300000071525574f))) - _771)) + _771;
  float _1091 = ((mad(-0.06537103652954102f, _1075, mad(1.451815478503704e-06f, _1074, (_1073 * 1.065374732017517f))) - _1073) * cb0_036z) + _1073;
  float _1092 = ((mad(-0.20366770029067993f, _1075, mad(1.2036634683609009f, _1074, (_1073 * -2.57161445915699e-07f))) - _1074) * cb0_036z) + _1074;
  float _1093 = ((mad(0.9999996423721313f, _1075, mad(2.0954757928848267e-08f, _1074, (_1073 * 1.862645149230957e-08f))) - _1075) * cb0_036z) + _1075;
  float _1118 = saturate(max(0.0f, mad((WorkingColorSpace_192[0].z), _1093, mad((WorkingColorSpace_192[0].y), _1092, ((WorkingColorSpace_192[0].x) * _1091)))));
  float _1119 = saturate(max(0.0f, mad((WorkingColorSpace_192[1].z), _1093, mad((WorkingColorSpace_192[1].y), _1092, ((WorkingColorSpace_192[1].x) * _1091)))));
  float _1120 = saturate(max(0.0f, mad((WorkingColorSpace_192[2].z), _1093, mad((WorkingColorSpace_192[2].y), _1092, ((WorkingColorSpace_192[2].x) * _1091)))));
  ...
  float4 _1171 = t0.SampleLevel(s0, float2(_1168, _1157), 0.0f);
  float4 _1176 = t0.SampleLevel(s0, float2((_1168 + 0.0625f), _1157), 0.0f);
  float _1195 = max(6.103519990574569e-05f, (((lerp(_1171.x, _1176.x, _1166)) * cb0_005y) + (cb0_005x * _1131)));
  float _1196 = max(6.103519990574569e-05f, (((lerp(_1171.y, _1176.y, _1166)) * cb0_005y) + (cb0_005x * _1142)));
  float _1197 = max(6.103519990574569e-05f, (((lerp(_1171.z, _1176.z, _1166)) * cb0_005y) + (cb0_005x * _1153)));
  ...
  float _1247 = cb0_014x * (((cb0_039y + (cb0_039x * _1219)) * _1219) + cb0_039z);
  float _1248 = cb0_014y * (((cb0_039y + (cb0_039x * _1220)) * _1220) + cb0_039z);
  float _1249 = cb0_014z * (((cb0_039y + (cb0_039x * _1221)) * _1221) + cb0_039z);
  float _1270 = exp2(log2(max(0.0f, (lerp(_1247, cb0_013x, cb0_013w)))) * cb0_040y);
  float _1271 = exp2(log2(max(0.0f, (lerp(_1248, cb0_013y, cb0_013w)))) * cb0_040y);
  float _1272 = exp2(log2(max(0.0f, (lerp(_1249, cb0_013z, cb0_013w)))) * cb0_040y);
  if (WorkingColorSpace_320 == 0) {
    float _1279 = mad((WorkingColorSpace_128[0].z), _1272, mad((WorkingColorSpace_128[0].y), _1271, ((WorkingColorSpace_128[0].x) * _1270)));
    float _1282 = mad((WorkingColorSpace_128[1].z), _1272, mad((WorkingColorSpace_128[1].y), _1271, ((WorkingColorSpace_128[1].x) * _1270)));
    float _1285 = mad((WorkingColorSpace_128[2].z), _1272, mad((WorkingColorSpace_128[2].y), _1271, ((WorkingColorSpace_128[2].x) * _1270)));
  ...
  u0[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))] = float4((_1309 * 0.9523810148239136f), (_1320 * 0.9523810148239136f), (_1331 * 0.9523810148239136f), 0.0f);
}
