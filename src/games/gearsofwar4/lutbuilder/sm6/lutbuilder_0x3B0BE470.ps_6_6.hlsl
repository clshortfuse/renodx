...
float4 main(
  ...
  float _154 = (1.0f - exp2(((_136 * _136) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_140, _141, _142), float3(_140, _141, _142)) * -4.0f));
  ...
  SV_Target = ProcessLutbuilder(float3(_727, _729, _731), cb_config, SV_Target, OutputDevice);
  return SV_Target;
