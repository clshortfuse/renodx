...
[numthreads(8, 8, 8)] void main(
  ...
  float4 output = ProcessLutbuilder(float3(_539, _541, _543), cb_config, u0[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))], cb0_040w);
