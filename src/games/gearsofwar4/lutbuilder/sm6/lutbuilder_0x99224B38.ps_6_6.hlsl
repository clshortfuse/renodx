...
float4 main(
  ...
  _382 = ((mad(-0.06368321925401688f, _347, mad(-0.3292922377586365f, _344, (_341 * 1.3704125881195068f))) - _341) * _366) + _341;
  _383 = ((mad(-0.010861365124583244f, _347, mad(1.0970927476882935f, _344, (_341 * -0.08343357592821121f))) - _344) * _366) + _344;
  _384 = ((mad(1.2036951780319214f, _347, mad(-0.09862580895423889f, _344, (_341 * -0.02579331398010254f))) - _347) * _366) + _347;
  _385 = dot(float3(_382, _383, _384), float3(0.2722287178039551f, 0.6740817427635193f, 0.053689517080783844f));
  _399 = cb0_021w + cb0_026w;
  _413 = cb0_020w * cb0_025w;
  _427 = cb0_019w * cb0_024w;
  _441 = cb0_018w * cb0_023w;
  _455 = cb0_017w * cb0_022w;
  _459 = _382 - _385;
  _460 = _383 - _385;
  _461 = _384 - _385;
  _518 = saturate(_385 / cb0_037w);
  _522 = (_518 * _518) * (3.0f - (_518 * 2.0f));
  _523 = 1.0f - _522;
  _532 = cb0_021w + cb0_036w;
  _541 = cb0_020w * cb0_035w;
  _550 = cb0_019w * cb0_034w;
  _559 = cb0_018w * cb0_033w;
  _568 = cb0_017w * cb0_032w;
  _631 = saturate((_385 - cb0_038x) / (cb0_038y - cb0_038x));
  _635 = (_631 * _631) * (3.0f - (_631 * 2.0f));
  _644 = cb0_021w + cb0_031w;
  _653 = cb0_020w * cb0_030w;
  _662 = cb0_019w * cb0_029w;
  _671 = cb0_018w * cb0_028w;
  _680 = cb0_017w * cb0_027w;
  _738 = _522 - _635;
  _749 = ((_635 * (((cb0_021x + cb0_036x) + _532) + (((cb0_020x * cb0_035x) * _541) * exp2(log2(exp2(((cb0_018x * cb0_033x) * _559) * log2(max(0.0f, ((((cb0_017x * cb0_032x) * _568) * _459) + _385)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_019x * cb0_034x) * _550)))))) + (_523 * (((cb0_021x + cb0_026x) + _399) + (((cb0_020x * cb0_025x) * _413) * exp2(log2(exp2(((cb0_018x * cb0_023x) * _441) * log2(max(0.0f, ((((cb0_017x * cb0_022x) * _455) * _459) + _385)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_019x * cb0_024x) * _427))))))) + ((((cb0_021x + cb0_031x) + _644) + (((cb0_020x * cb0_030x) * _653) * exp2(log2(exp2(((cb0_018x * cb0_028x) * _671) * log2(max(0.0f, ((((cb0_017x * cb0_027x) * _680) * _459) + _385)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_019x * cb0_029x) * _662))))) * _738);
  _751 = ((_635 * (((cb0_021y + cb0_036y) + _532) + (((cb0_020y * cb0_035y) * _541) * exp2(log2(exp2(((cb0_018y * cb0_033y) * _559) * log2(max(0.0f, ((((cb0_017y * cb0_032y) * _568) * _460) + _385)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_019y * cb0_034y) * _550)))))) + (_523 * (((cb0_021y + cb0_026y) + _399) + (((cb0_020y * cb0_025y) * _413) * exp2(log2(exp2(((cb0_018y * cb0_023y) * _441) * log2(max(0.0f, ((((cb0_017y * cb0_022y) * _455) * _460) + _385)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_019y * cb0_024y) * _427))))))) + ((((cb0_021y + cb0_031y) + _644) + (((cb0_020y * cb0_030y) * _653) * exp2(log2(exp2(((cb0_018y * cb0_028y) * _671) * log2(max(0.0f, ((((cb0_017y * cb0_027y) * _680) * _460) + _385)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_019y * cb0_029y) * _662))))) * _738);
  _753 = ((_635 * (((cb0_021z + cb0_036z) + _532) + (((cb0_020z * cb0_035z) * _541) * exp2(log2(exp2(((cb0_018z * cb0_033z) * _559) * log2(max(0.0f, ((((cb0_017z * cb0_032z) * _568) * _461) + _385)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_019z * cb0_034z) * _550)))))) + (_523 * (((cb0_021z + cb0_026z) + _399) + (((cb0_020z * cb0_025z) * _413) * exp2(log2(exp2(((cb0_018z * cb0_023z) * _441) * log2(max(0.0f, ((((cb0_017z * cb0_022z) * _455) * _461) + _385)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_019z * cb0_024z) * _427))))))) + ((((cb0_021z + cb0_031z) + _644) + (((cb0_020z * cb0_030z) * _653) * exp2(log2(exp2(((cb0_018z * cb0_028z) * _671) * log2(max(0.0f, ((((cb0_017z * cb0_027z) * _680) * _461) + _385)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_019z * cb0_029z) * _662))))) * _738);
  ...
  SV_Target = ProcessLutbuilder(float3(_749, _751, _753), cb_config, SV_Target, asuint(cb0_044x));
  return SV_Target;

  _768 = ((mad(0.061360642313957214f, _753, mad(-4.540197551250458e-09f, _751, (_749 * 0.9386394023895264f))) - _749) * cb0_038z) + _749;
  _769 = ((mad(0.169205904006958f, _753, mad(0.8307942152023315f, _751, (_749 * 6.775371730327606e-08f))) - _751) * cb0_038z) + _751;
  _770 = (mad(-2.3283064365386963e-10f, _751, (_749 * -9.313225746154785e-10f)) * cb0_038z) + _753;
  _773 = mad(0.16386905312538147f, _770, mad(0.14067868888378143f, _769, (_768 * 0.6954522132873535f)));
  _776 = mad(0.0955343246459961f, _770, mad(0.8596711158752441f, _769, (_768 * 0.044794581830501556f)));
  _779 = mad(1.0015007257461548f, _770, mad(0.004025210160762072f, _769, (_768 * -0.005525882821530104f)));
  _783 = max(max(_773, _776), _779);
  _788 = (max(_783, 1.000000013351432e-10f) - max(min(min(_773, _776), _779), 1.000000013351432e-10f)) / max(_783, 0.009999999776482582f);
  _801 = ((_776 + _773) + _779) + (sqrt((((_779 - _776) * _779) + ((_776 - _773) * _776)) + ((_773 - _779) * _773)) * 1.75f);
  _802 = _801 * 0.3333333432674408f;
  _803 = _788 + -0.4000000059604645f;
  _804 = _803 * 5.0f;
  _808 = max((1.0f - abs(_803 * 2.5f)), 0.0f);
  _819 = ((float((int)(((int)(uint)((int)(_804 > 0.0f))) - ((int)(uint)((int)(_804 < 0.0f))))) * (1.0f - (_808 * _808))) + 1.0f) * 0.02500000037252903f;
  ...
  _831 = _829 * _776;
  _832 = _829 * _779;
  if (!((_830 == _831) && (_831 == _832))) {
    _839 = ((_830 * 2.0f) - _831) - _832;
    _842 = ((_776 - _779) * 1.7320507764816284f) * _829;
    _844 = atan(_842 / _839);
    _847 = (_839 < 0.0f);
    _848 = (_839 == 0.0f);
    _849 = (_842 >= 0.0f);
  ...
  _866 = min(max(select((_861 < 0.0f), (_861 + 360.0f), _861), 0.0f), 360.0f);
  if (_866 < -180.0f) {
    _875 = (_866 + 360.0f);
  } else {
    if (_866 > 180.0f) {
  ...
  _879 = saturate(1.0f - abs(_875 * 0.014814814552664757f));
  _883 = (_879 * _879) * (3.0f - (_879 * 2.0f));
  _889 = ((_883 * _883) * ((_788 * 0.18000000715255737f) * (0.029999999329447746f - _830))) + _830;
  _899 = max(0.0f, mad(-0.21492856740951538f, _832, mad(-0.2365107536315918f, _831, (_889 * 1.4514392614364624f))));
  _900 = max(0.0f, mad(-0.09967592358589172f, _832, mad(1.17622971534729f, _831, (_889 * -0.07655377686023712f))));
  _901 = max(0.0f, mad(0.9977163076400757f, _832, mad(-0.006032449658960104f, _831, (_889 * 0.008316148072481155f))));
  _902 = dot(float3(_899, _900, _901), float3(0.2722287178039551f, 0.6740817427635193f, 0.053689517080783844f));
  _917 = (cb0_040x + 1.0f) - cb0_039z;
  _919 = cb0_040y + 1.0f;
  _921 = _919 - cb0_039w;
  if (cb0_039z > 0.800000011920929f) {
    _939 = (((0.8199999928474426f - cb0_039z) / cb0_039y) + -0.7447274923324585f);
  } else {
    _930 = (cb0_040x + 0.18000000715255737f) / _917;
    _939 = (-0.7447274923324585f - ((log2(_930 / (2.0f - _930)) * 0.3465735912322998f) * (_917 / cb0_039y)));
  }
  _942 = ((1.0f - cb0_039z) / cb0_039y) - _939;
  _944 = (cb0_039w / cb0_039y) - _942;
  _948 = log2(lerp(_902, _899, 0.9599999785423279f)) * 0.3010300099849701f;
  _949 = log2(lerp(_902, _900, 0.9599999785423279f)) * 0.3010300099849701f;
  _950 = log2(lerp(_902, _901, 0.9599999785423279f)) * 0.3010300099849701f;
  _954 = cb0_039y * (_948 + _942);
  _955 = cb0_039y * (_949 + _942);
  _956 = cb0_039y * (_950 + _942);
  _957 = _917 * 2.0f;
  _959 = (cb0_039y * -2.0f) / _917;
  _960 = _948 - _939;
  _961 = _949 - _939;
  _962 = _950 - _939;
  _981 = _921 * 2.0f;
  _983 = (cb0_039y * 2.0f) / _921;
  _1008 = select((_948 < _939), ((_957 / (exp2((_960 * 1.4426950216293335f) * _959) + 1.0f)) - cb0_040x), _954);
  _1009 = select((_949 < _939), ((_957 / (exp2((_961 * 1.4426950216293335f) * _959) + 1.0f)) - cb0_040x), _955);
  _1010 = select((_950 < _939), ((_957 / (exp2((_962 * 1.4426950216293335f) * _959) + 1.0f)) - cb0_040x), _956);
  _1017 = _944 - _939;
  _1021 = saturate(_960 / _1017);
  _1022 = saturate(_961 / _1017);
  _1023 = saturate(_962 / _1017);
  _1024 = (_944 < _939);
  _1028 = select(_1024, (1.0f - _1021), _1021);
  _1029 = select(_1024, (1.0f - _1022), _1022);
  _1030 = select(_1024, (1.0f - _1023), _1023);
  _1049 = (((_1028 * _1028) * (select((_948 > _944), (_919 - (_981 / (exp2(((_948 - _944) * 1.4426950216293335f) * _983) + 1.0f))), _954) - _1008)) * (3.0f - (_1028 * 2.0f))) + _1008;
  _1050 = (((_1029 * _1029) * (select((_949 > _944), (_919 - (_981 / (exp2(((_949 - _944) * 1.4426950216293335f) * _983) + 1.0f))), _955) - _1009)) * (3.0f - (_1029 * 2.0f))) + _1009;
  _1051 = (((_1030 * _1030) * (select((_950 > _944), (_919 - (_981 / (exp2(((_950 - _944) * 1.4426950216293335f) * _983) + 1.0f))), _956) - _1010)) * (3.0f - (_1030 * 2.0f))) + _1010;
  _1052 = dot(float3(_1049, _1050, _1051), float3(0.2722287178039551f, 0.6740817427635193f, 0.053689517080783844f));
  _1072 = (cb0_039x * (max(0.0f, (lerp(_1052, _1049, 0.9300000071525574f))) - _768)) + _768;
  _1073 = (cb0_039x * (max(0.0f, (lerp(_1052, _1050, 0.9300000071525574f))) - _769)) + _769;
  _1074 = (cb0_039x * (max(0.0f, (lerp(_1052, _1051, 0.9300000071525574f))) - _770)) + _770;
  _1090 = ((mad(-0.06537103652954102f, _1074, mad(1.451815478503704e-06f, _1073, (_1072 * 1.065374732017517f))) - _1072) * cb0_038z) + _1072;
  _1091 = ((mad(-0.20366770029067993f, _1074, mad(1.2036634683609009f, _1073, (_1072 * -2.57161445915699e-07f))) - _1073) * cb0_038z) + _1073;
  _1092 = ((mad(0.9999996423721313f, _1074, mad(2.0954757928848267e-08f, _1073, (_1072 * 1.862645149230957e-08f))) - _1074) * cb0_038z) + _1074;
  _1114 = max(0.0f, mad((WorkingColorSpace_192[0].z), _1092, mad((WorkingColorSpace_192[0].y), _1091, ((WorkingColorSpace_192[0].x) * _1090))));
  _1115 = max(0.0f, mad((WorkingColorSpace_192[1].z), _1092, mad((WorkingColorSpace_192[1].y), _1091, ((WorkingColorSpace_192[1].x) * _1090))));
  _1116 = max(0.0f, mad((WorkingColorSpace_192[2].z), _1092, mad((WorkingColorSpace_192[2].y), _1091, ((WorkingColorSpace_192[2].x) * _1090))));
  _1142 = cb0_016x * (((cb0_042y + (cb0_042x * _1114)) * _1114) + cb0_042z);
  _1143 = cb0_016y * (((cb0_042y + (cb0_042x * _1115)) * _1115) + cb0_042z);
  _1144 = cb0_016z * (((cb0_042y + (cb0_042x * _1116)) * _1116) + cb0_042z);
  _1165 = exp2(log2(max(0.0f, (lerp(_1142, cb0_015x, cb0_015w)))) * cb0_043y);
  _1166 = exp2(log2(max(0.0f, (lerp(_1143, cb0_015y, cb0_015w)))) * cb0_043y);
  _1167 = exp2(log2(max(0.0f, (lerp(_1144, cb0_015z, cb0_015w)))) * cb0_043y);
  if (WorkingColorSpace_384 == 0) {
    _1174 = mad((WorkingColorSpace_128[0].z), _1167, mad((WorkingColorSpace_128[0].y), _1166, ((WorkingColorSpace_128[0].x) * _1165)));
    _1177 = mad((WorkingColorSpace_128[1].z), _1167, mad((WorkingColorSpace_128[1].y), _1166, ((WorkingColorSpace_128[1].x) * _1165)));
    _1180 = mad((WorkingColorSpace_128[2].z), _1167, mad((WorkingColorSpace_128[2].y), _1166, ((WorkingColorSpace_128[2].x) * _1165)));
