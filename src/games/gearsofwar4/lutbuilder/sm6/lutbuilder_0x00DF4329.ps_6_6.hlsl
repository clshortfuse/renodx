...
float4 main(
  ...
  float _134 = mad((WorkingColorSpace.ToAP1[0].z), _119, mad((WorkingColorSpace.ToAP1[0].y), _118, ((WorkingColorSpace.ToAP1[0].x) * _117)));
  float _137 = mad((WorkingColorSpace.ToAP1[1].z), _119, mad((WorkingColorSpace.ToAP1[1].y), _118, ((WorkingColorSpace.ToAP1[1].x) * _117)));
  float _140 = mad((WorkingColorSpace.ToAP1[2].z), _119, mad((WorkingColorSpace.ToAP1[2].y), _118, ((WorkingColorSpace.ToAP1[2].x) * _117)));
  ...
  float _159 = (1.0f - exp2(((_141 * _141) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_145, _146, _147), float3(_145, _146, _147)) * -4.0f));
  ...
  float _192 = ColorOffset.w + ColorOffsetShadows.w;
  float _206 = ColorGain.w * ColorGainShadows.w;
  float _220 = ColorGamma.w * ColorGammaShadows.w;
  float _234 = ColorContrast.w * ColorContrastShadows.w;
  float _248 = ColorSaturation.w * ColorSaturationShadows.w;
  float _252 = _175 - _178;
  float _253 = _176 - _178;
  float _254 = _177 - _178;
  float _311 = saturate(_178 / ColorCorrectionShadowsMax);
  float _315 = (_311 * _311) * (3.0f - (_311 * 2.0f));
  float _316 = 1.0f - _315;
  float _325 = ColorOffset.w + ColorOffsetHighlights.w;
  float _334 = ColorGain.w * ColorGainHighlights.w;
  float _343 = ColorGamma.w * ColorGammaHighlights.w;
  float _352 = ColorContrast.w * ColorContrastHighlights.w;
  float _361 = ColorSaturation.w * ColorSaturationHighlights.w;
  float _424 = saturate((_178 - ColorCorrectionHighlightsMin) / (ColorCorrectionHighlightsMax - ColorCorrectionHighlightsMin));
  ...
  float _542 = ((_428 * (((ColorOffset.x + ColorOffsetHighlights.x) + _325) + (((ColorGain.x * ColorGainHighlights.x) * _334) * exp2(log2(exp2(((ColorContrast.x * ColorContrastHighlights.x) * _352) * log2(max(0.0f, ((((ColorSaturation.x * ColorSaturationHighlights.x) * _361) * _252) + _178)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((ColorGamma.x * ColorGammaHighlights.x) * _343)))))) + (_316 * (((ColorOffset.x + ColorOffsetShadows.x) + _192) + (((ColorGain.x * ColorGainShadows.x) * _206) * exp2(log2(exp2(((ColorContrast.x * ColorContrastShadows.x) * _234) * log2(max(0.0f, ((((ColorSaturation.x * ColorSaturationShadows.x) * _248) * _252) + _178)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((ColorGamma.x * ColorGammaShadows.x) * _220))))))) + ((((ColorOffset.x + ColorOffsetMidtones.x) + _437) + (((ColorGain.x * ColorGainMidtones.x) * _446) * exp2(log2(exp2(((ColorContrast.x * ColorContrastMidtones.x) * _464) * log2(max(0.0f, ((((ColorSaturation.x * ColorSaturationMidtones.x) * _473) * _252) + _178)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((ColorGamma.x * ColorGammaMidtones.x) * _455))))) * _531);
  float _544 = ((_428 * (((ColorOffset.y + ColorOffsetHighlights.y) + _325) + (((ColorGain.y * ColorGainHighlights.y) * _334) * exp2(log2(exp2(((ColorContrast.y * ColorContrastHighlights.y) * _352) * log2(max(0.0f, ((((ColorSaturation.y * ColorSaturationHighlights.y) * _361) * _253) + _178)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((ColorGamma.y * ColorGammaHighlights.y) * _343)))))) + (_316 * (((ColorOffset.y + ColorOffsetShadows.y) + _192) + (((ColorGain.y * ColorGainShadows.y) * _206) * exp2(log2(exp2(((ColorContrast.y * ColorContrastShadows.y) * _234) * log2(max(0.0f, ((((ColorSaturation.y * ColorSaturationShadows.y) * _248) * _253) + _178)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((ColorGamma.y * ColorGammaShadows.y) * _220))))))) + ((((ColorOffset.y + ColorOffsetMidtones.y) + _437) + (((ColorGain.y * ColorGainMidtones.y) * _446) * exp2(log2(exp2(((ColorContrast.y * ColorContrastMidtones.y) * _464) * log2(max(0.0f, ((((ColorSaturation.y * ColorSaturationMidtones.y) * _473) * _253) + _178)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((ColorGamma.y * ColorGammaMidtones.y) * _455))))) * _531);
  float _546 = ((_428 * (((ColorOffset.z + ColorOffsetHighlights.z) + _325) + (((ColorGain.z * ColorGainHighlights.z) * _334) * exp2(log2(exp2(((ColorContrast.z * ColorContrastHighlights.z) * _352) * log2(max(0.0f, ((((ColorSaturation.z * ColorSaturationHighlights.z) * _361) * _254) + _178)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((ColorGamma.z * ColorGammaHighlights.z) * _343)))))) + (_316 * (((ColorOffset.z + ColorOffsetShadows.z) + _192) + (((ColorGain.z * ColorGainShadows.z) * _206) * exp2(log2(exp2(((ColorContrast.z * ColorContrastShadows.z) * _234) * log2(max(0.0f, ((((ColorSaturation.z * ColorSaturationShadows.z) * _248) * _254) + _178)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((ColorGamma.z * ColorGammaShadows.z) * _220))))))) + ((((ColorOffset.z + ColorOffsetMidtones.z) + _437) + (((ColorGain.z * ColorGainMidtones.z) * _446) * exp2(log2(exp2(((ColorContrast.z * ColorContrastMidtones.z) * _464) * log2(max(0.0f, ((((ColorSaturation.z * ColorSaturationMidtones.z) * _473) * _254) + _178)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((ColorGamma.z * ColorGammaMidtones.z) * _455))))) * _531);
  ...
  SV_Target = ProcessLutbuilder(float3(_542, _544, _546), cb_config, SV_Target, OutputDevice);
  return SV_Target;

  float _582 = ((mad(0.061360642313957214f, _546, mad(-4.540197551250458e-09f, _544, (_542 * 0.9386394023895264f))) - _542) * BlueCorrection) + _542;
  float _583 = ((mad(0.169205904006958f, _546, mad(0.8307942152023315f, _544, (_542 * 6.775371730327606e-08f))) - _544) * BlueCorrection) + _544;
  float _584 = (mad(-2.3283064365386963e-10f, _544, (_542 * -9.313225746154785e-10f)) * BlueCorrection) + _546;
  ...
  float _904 = ((mad(-0.06537103652954102f, _888, mad(1.451815478503704e-06f, _887, (_886 * 1.065374732017517f))) - _886) * BlueCorrection) + _886;
  float _905 = ((mad(-0.20366770029067993f, _888, mad(1.2036634683609009f, _887, (_886 * -2.57161445915699e-07f))) - _887) * BlueCorrection) + _887;
  float _906 = ((mad(0.9999996423721313f, _888, mad(2.0954757928848267e-08f, _887, (_886 * 1.862645149230957e-08f))) - _888) * BlueCorrection) + _888;
  float _916 = max(0.0f, mad((WorkingColorSpace.FromAP1[0].z), _906, mad((WorkingColorSpace.FromAP1[0].y), _905, ((WorkingColorSpace.FromAP1[0].x) * _904))));
  float _917 = max(0.0f, mad((WorkingColorSpace.FromAP1[1].z), _906, mad((WorkingColorSpace.FromAP1[1].y), _905, ((WorkingColorSpace.FromAP1[1].x) * _904))));
  float _918 = max(0.0f, mad((WorkingColorSpace.FromAP1[2].z), _906, mad((WorkingColorSpace.FromAP1[2].y), _905, ((WorkingColorSpace.FromAP1[2].x) * _904))));
  ...
  float _956 = ColorScale.x * mad((WorkingColorSpace.FromAP1[0].z), _546, mad((WorkingColorSpace.FromAP1[0].y), _544, (_542 * (WorkingColorSpace.FromAP1[0].x))));
  float _957 = ColorScale.y * mad((WorkingColorSpace.FromAP1[1].z), _546, mad((WorkingColorSpace.FromAP1[1].y), _544, ((WorkingColorSpace.FromAP1[1].x) * _542)));
  float _958 = ColorScale.z * mad((WorkingColorSpace.FromAP1[2].z), _546, mad((WorkingColorSpace.FromAP1[2].y), _544, ((WorkingColorSpace.FromAP1[2].x) * _542)));
  ...
  if (OutputDevice == 0) {
    do {
      if (WorkingColorSpace.bIsSRGB == 0) {
        float _1004 = mad((WorkingColorSpace.ToAP1[0].z), _981, mad((WorkingColorSpace.ToAP1[0].y), _980, ((WorkingColorSpace.ToAP1[0].x) * _979)));
        float _1007 = mad((WorkingColorSpace.ToAP1[1].z), _981, mad((WorkingColorSpace.ToAP1[1].y), _980, ((WorkingColorSpace.ToAP1[1].x) * _979)));
        float _1010 = mad((WorkingColorSpace.ToAP1[2].z), _981, mad((WorkingColorSpace.ToAP1[2].y), _980, ((WorkingColorSpace.ToAP1[2].x) * _979)));
    ...
    if (OutputDevice == 1) {
      float _1072 = mad((WorkingColorSpace.ToAP1[0].z), _981, mad((WorkingColorSpace.ToAP1[0].y), _980, ((WorkingColorSpace.ToAP1[0].x) * _979)));
      float _1075 = mad((WorkingColorSpace.ToAP1[1].z), _981, mad((WorkingColorSpace.ToAP1[1].y), _980, ((WorkingColorSpace.ToAP1[1].x) * _979)));
      float _1078 = mad((WorkingColorSpace.ToAP1[2].z), _981, mad((WorkingColorSpace.ToAP1[2].y), _980, ((WorkingColorSpace.ToAP1[2].x) * _979)));
      ...
      if ((bool)(OutputDevice == 3) || (bool)(OutputDevice == 5)) {
        ...
        float _1171 = mad((WorkingColorSpace.ToAP0[0].z), _1168, mad((WorkingColorSpace.ToAP0[0].y), _1167, ((WorkingColorSpace.ToAP0[0].x) * _1166)));
        float _1174 = mad((WorkingColorSpace.ToAP0[1].z), _1168, mad((WorkingColorSpace.ToAP0[1].y), _1167, ((WorkingColorSpace.ToAP0[1].x) * _1166)));
        float _1177 = mad((WorkingColorSpace.ToAP0[2].z), _1168, mad((WorkingColorSpace.ToAP0[2].y), _1167, ((WorkingColorSpace.ToAP0[2].x) * _1166)));
        ...
        if ((OutputDevice & -3) == 4) {
          ...
          float _1857 = mad((WorkingColorSpace.ToAP0[0].z), _1854, mad((WorkingColorSpace.ToAP0[0].y), _1853, ((WorkingColorSpace.ToAP0[0].x) * _1852)));
          float _1860 = mad((WorkingColorSpace.ToAP0[1].z), _1854, mad((WorkingColorSpace.ToAP0[1].y), _1853, ((WorkingColorSpace.ToAP0[1].x) * _1852)));
          float _1863 = mad((WorkingColorSpace.ToAP0[2].z), _1854, mad((WorkingColorSpace.ToAP0[2].y), _1853, ((WorkingColorSpace.ToAP0[2].x) * _1852)));
          ...
          if (OutputDevice == 7) {
            float _2529 = mad((WorkingColorSpace.ToAP1[0].z), _967, mad((WorkingColorSpace.ToAP1[0].y), _966, ((WorkingColorSpace.ToAP1[0].x) * _965)));
            float _2532 = mad((WorkingColorSpace.ToAP1[1].z), _967, mad((WorkingColorSpace.ToAP1[1].y), _966, ((WorkingColorSpace.ToAP1[1].x) * _965)));
            float _2535 = mad((WorkingColorSpace.ToAP1[2].z), _967, mad((WorkingColorSpace.ToAP1[2].y), _966, ((WorkingColorSpace.ToAP1[2].x) * _965)));
            ...
            if (!(OutputDevice == 8)) {
              if (OutputDevice == 9) {
                float _2603 = mad((WorkingColorSpace.ToAP1[0].z), _955, mad((WorkingColorSpace.ToAP1[0].y), _954, ((WorkingColorSpace.ToAP1[0].x) * _953)));
                float _2606 = mad((WorkingColorSpace.ToAP1[1].z), _955, mad((WorkingColorSpace.ToAP1[1].y), _954, ((WorkingColorSpace.ToAP1[1].x) * _953)));
                float _2609 = mad((WorkingColorSpace.ToAP1[2].z), _955, mad((WorkingColorSpace.ToAP1[2].y), _954, ((WorkingColorSpace.ToAP1[2].x) * _953)));
                ...
                float _2622 = mad((WorkingColorSpace.ToAP1[0].z), _981, mad((WorkingColorSpace.ToAP1[0].y), _980, ((WorkingColorSpace.ToAP1[0].x) * _979)));
                float _2625 = mad((WorkingColorSpace.ToAP1[1].z), _981, mad((WorkingColorSpace.ToAP1[1].y), _980, ((WorkingColorSpace.ToAP1[1].x) * _979)));
                float _2628 = mad((WorkingColorSpace.ToAP1[2].z), _981, mad((WorkingColorSpace.ToAP1[2].y), _980, ((WorkingColorSpace.ToAP1[2].x) * _979)));
