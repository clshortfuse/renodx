...
float4 main(
  ...
  float _123 = select(((cb0_034x * 1.0005563497543335f) <= 7000.0f), (((((2967800.0f - (_109 * 4607000064.0f)) * _109) + 99.11000061035156f) * _109) + 0.24406300485134125f), (((((1901800.0f - (_109 * 2006400000.0f)) * _109) + 247.47999572753906f) * _109) + 0.23703999817371368f));
  ...
  float _197 = (((_183 * 3.0f) / _191) - _153) + select(_156, _153, _123);
  float _198 = (((_186 * 2.0f) / _191) - _155) + select(_156, _155, (((_123 * 2.869999885559082f) + -0.2750000059604645f) - ((_123 * _123) * 3.0f)));
  bool _201 = (cb0_037z != 0);
  float _202 = select(_201, _197, 0.3127000033855438f);
  float _203 = select(_201, _198, 0.32899999618530273f);
  float _204 = select(_201, 0.3127000033855438f, _197);
  float _205 = select(_201, 0.32899999618530273f, _198);
  ...
  float _360 = (1.0f - exp2(((_342 * _342) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_346, _347, _348), float3(_346, _347, _348)) * -4.0f));
  ...
  SV_Target = ProcessLutbuilder(float3(_744, _746, _748), s0, t0, cb_config, SV_Target, cb0_039w);
  return SV_Target;
  ...
  float _814 = ((float((int)(((int)(uint)((bool)(_799 > 0.0f))) - ((int)(uint)((bool)(_799 < 0.0f))))) * (1.0f - (_803 * _803))) + 1.0f) * 0.02500000037252903f;
  ...
  if (!((bool)(_825 == _826) && (bool)(_826 == _827))) {
    ...
    bool _844 = (_837 >= 0.0f);
    bool _845 = (_837 < 0.0f);
    float _854 = select((_844 && _843), 90.0f, select((_845 && _843), -90.0f, (select((_845 && _842), (_839 + -3.1415927410125732f), select((_844 && _842), (_839 + 3.1415927410125732f), _839)) * 57.2957763671875f)));
    if (_854 < 0.0f) {
      _859 = (_854 + 360.0f);
    } else {
      _859 = _854;
  ...
  float _1003 = select((_943 < _934), ((_952 / (exp2((_955 * 1.4426950216293335f) * _954) + 1.0f)) - cb0_036w), _949);
  float _1004 = select((_944 < _934), ((_952 / (exp2((_956 * 1.4426950216293335f) * _954) + 1.0f)) - cb0_036w), _950);
  float _1005 = select((_945 < _934), ((_952 / (exp2((_957 * 1.4426950216293335f) * _954) + 1.0f)) - cb0_036w), _951);
  ...
  float _1067 = (cb0_035w * (max(0.0f, (lerp(_1047, _1044, 0.9300000071525574f))) - _763)) + _763;
  float _1068 = (cb0_035w * (max(0.0f, (lerp(_1047, _1045, 0.9300000071525574f))) - _764)) + _764;
  float _1069 = (cb0_035w * (max(0.0f, (lerp(_1047, _1046, 0.9300000071525574f))) - _765)) + _765;
  ...
  if (_1100 < 0.0031306699384003878f) {
    ...
    _1113 = (((pow(_1100, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
  }
  if (_1101 < 0.0031306699384003878f) {
    _1124 = (_1101 * 12.920000076293945f);
  } else {
    _1124 = (((pow(_1101, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
  }
  if (_1102 < 0.0031306699384003878f) {
    _1135 = (_1102 * 12.920000076293945f);
  } else {
    _1135 = (((pow(_1102, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
  }
  ...
  float _1179 = max(6.103519990574569e-05f, (((lerp(_1153.x, _1160.x, _1148)) * cb0_005y) + (cb0_005x * _1113)));
  float _1180 = max(6.103519990574569e-05f, (((lerp(_1153.y, _1160.y, _1148)) * cb0_005y) + (cb0_005x * _1124)));
  float _1181 = max(6.103519990574569e-05f, (((lerp(_1153.z, _1160.z, _1148)) * cb0_005y) + (cb0_005x * _1135)));
  float _1203 = select((_1179 > 0.040449999272823334f), exp2(log2((_1179 * 0.9478672742843628f) + 0.05213269963860512f) * 2.4000000953674316f), (_1179 * 0.07739938050508499f));
  float _1204 = select((_1180 > 0.040449999272823334f), exp2(log2((_1180 * 0.9478672742843628f) + 0.05213269963860512f) * 2.4000000953674316f), (_1180 * 0.07739938050508499f));
  float _1205 = select((_1181 > 0.040449999272823334f), exp2(log2((_1181 * 0.9478672742843628f) + 0.05213269963860512f) * 2.4000000953674316f), (_1181 * 0.07739938050508499f));
  ...
  if (cb0_039w == 0) {
    do {
      if (_1254 < 0.0031306699384003878f) {
        ...
        _1271 = (((pow(_1254, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
      }
      do {
        if (_1255 < 0.0031306699384003878f) {
          _1282 = (_1255 * 12.920000076293945f);
        } else {
          _1282 = (((pow(_1255, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
        }
        if (_1256 < 0.0031306699384003878f) {
          ...
          _2769 = _1271;
          _2770 = _1282;
          _2771 = (((pow(_1256, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
        }
      } while (false);
    } while (false);
  } else {
    if (cb0_039w == 1) {
      ...
      bool _1342 = (cb0_039w == 5);
      if ((bool)(cb0_039w == 3) || _1342) {
        _10[0] = cb0_009x;
        _10[1] = cb0_009y;
        _10[2] = cb0_009z;
        _10[3] = cb0_009w;
        ...
        do {
          ...
          float _1525 = ((float((int)(((int)(uint)((bool)(_1510 > 0.0f))) - ((int)(uint)((bool)(_1510 < 0.0f))))) * (1.0f - (_1514 * _1514))) + 1.0f) * 0.02500000037252903f;
          do {
            ...
            do {
              if (!((bool)(_1536 == _1537) && (bool)(_1537 == _1538))) {
                ...
                float _1565 = select((_1555 && _1554), 90.0f, select((_1556 && _1554), -90.0f, (select((_1556 && _1553), (_1550 + -3.1415927410125732f), select((_1555 && _1553), (_1550 + 3.1415927410125732f), _1550)) * 57.2957763671875f)));
                if (_1565 < 0.0f) {
                  _1570 = (_1565 + 360.0f);
                } else {
                  _1570 = _1565;
              ...
              do {
                ...
                do {
                    ...
                    if (_1588 == 3) {
                      ...
                      if (_1588 == 2) {
                        ...
                        if (_1588 == 1) {
                          ...
                          _1620 = select((_1588 == 0), (_1592 * 0.1666666716337204f), 0.0f);
                        }
                      }
                    }
                  } else {
                  ...
                  float _1658 = log2(max((lerp(_1647, _1644, 0.9599999785423279f)), 1.000000013351432e-10f));
                  ...
                  do {
                    ...
                    float _1734 = log2(max((lerp(_1647, _1645, 0.9599999785423279f)), 1.000000013351432e-10f));
                    ...
                    do {
                      if (!(!(_1735 <= _1661))) {
                        ...
                        if ((bool)(_1735 > _1661) && (bool)(_1735 < _1743)) {
                          ...
                          if ((bool)(_1735 >= _1743) && (bool)(_1735 < (_1772 * 0.3010300099849701f))) {
                            ...
                            int _1782 = int(_1781);
                            float _1784 = _1781 - float((int)(_1782));
                      ...
                      float _1808 = log2(max((lerp(_1647, _1646, 0.9599999785423279f)), 1.000000013351432e-10f));
                        ...
                        if (!(!(_1809 <= _1661))) {
                          ...
                          if ((bool)(_1809 > _1661) && (bool)(_1809 < _1817)) {
                            ...
                            if ((bool)(_1809 >= _1817) && (bool)(_1809 < (_1846 * 0.3010300099849701f))) {
                              ...
                              int _1856 = int(_1855);
                              float _1858 = _1855 - float((int)(_1856));
        ...
        if ((cb0_039w & -3) == 4) {
          ...
          do {
            ...
            float _2183 = ((float((int)(((int)(uint)((bool)(_2168 > 0.0f))) - ((int)(uint)((bool)(_2168 < 0.0f))))) * (1.0f - (_2172 * _2172))) + 1.0f) * 0.02500000037252903f;
            do {
              ...
              do {
                if (!((bool)(_2194 == _2195) && (bool)(_2195 == _2196))) {
                  ...
                  float _2223 = select((_2213 && _2212), 90.0f, select((_2214 && _2212), -90.0f, (select((_2214 && _2211), (_2208 + -3.1415927410125732f), select((_2213 && _2211), (_2208 + 3.1415927410125732f), _2208)) * 57.2957763671875f)));
                  if (_2223 < 0.0f) {
                    _2228 = (_2223 + 360.0f);
                  } else {
                    _2228 = _2223;
                ...
                do {
                  ...
                  do {
                      ...
                      if (_2246 == 3) {
                        ...
                        if (_2246 == 2) {
                          ...
                          if (_2246 == 1) {
                            ...
                            _2278 = select((_2246 == 0), (_2250 * 0.1666666716337204f), 0.0f);
                          }
                        }
                      }
                    } else {
                    ...
                    float _2316 = log2(max((lerp(_2305, _2302, 0.9599999785423279f)), 1.000000013351432e-10f));
                    ...
                    do {
                      ...
                      float _2392 = log2(max((lerp(_2305, _2303, 0.9599999785423279f)), 1.000000013351432e-10f));
                      ...
                      do {
                        if (!(!(_2393 <= _2319))) {
                          ...
                          if ((bool)(_2393 > _2319) && (bool)(_2393 < _2401)) {
                            ...
                            if ((bool)(_2393 >= _2401) && (bool)(_2393 < (_2430 * 0.3010300099849701f))) {
                              ...
                              int _2440 = int(_2439);
                              float _2442 = _2439 - float((int)(_2440));
                        ...
                        float _2466 = log2(max((lerp(_2305, _2304, 0.9599999785423279f)), 1.000000013351432e-10f));
