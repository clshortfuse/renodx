...
void main(
  ...
  float _89 = mad((WorkingColorSpace.ToAP1[0].z), _74, mad((WorkingColorSpace.ToAP1[0].y), _73, ((WorkingColorSpace.ToAP1[0].x) * _72)));
  float _92 = mad((WorkingColorSpace.ToAP1[1].z), _74, mad((WorkingColorSpace.ToAP1[1].y), _73, ((WorkingColorSpace.ToAP1[1].x) * _72)));
  float _95 = mad((WorkingColorSpace.ToAP1[2].z), _74, mad((WorkingColorSpace.ToAP1[2].y), _73, ((WorkingColorSpace.ToAP1[2].x) * _72)));
  ...
  float4 output = ProcessLutbuilder(float3(_497, _499, _501), Samplers_1, Textures_1, cb_config, RWOutputTexture[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))], 0u);
  ...
  float _865 = saturate(max(0.0f, mad((WorkingColorSpace.FromAP1[0].z), _840, mad((WorkingColorSpace.FromAP1[0].y), _839, ((WorkingColorSpace.FromAP1[0].x) * _838)))));
  float _866 = saturate(max(0.0f, mad((WorkingColorSpace.FromAP1[1].z), _840, mad((WorkingColorSpace.FromAP1[1].y), _839, ((WorkingColorSpace.FromAP1[1].x) * _838)))));
  float _867 = saturate(max(0.0f, mad((WorkingColorSpace.FromAP1[2].z), _840, mad((WorkingColorSpace.FromAP1[2].y), _839, ((WorkingColorSpace.FromAP1[2].x) * _838)))));
  ...
  if (WorkingColorSpace.bIsSRGB == 0) {
    float _1026 = mad((WorkingColorSpace.ToAP1[0].z), _1019, mad((WorkingColorSpace.ToAP1[0].y), _1018, ((WorkingColorSpace.ToAP1[0].x) * _1017)));
    float _1029 = mad((WorkingColorSpace.ToAP1[1].z), _1019, mad((WorkingColorSpace.ToAP1[1].y), _1018, ((WorkingColorSpace.ToAP1[1].x) * _1017)));
    float _1032 = mad((WorkingColorSpace.ToAP1[2].z), _1019, mad((WorkingColorSpace.ToAP1[2].y), _1018, ((WorkingColorSpace.ToAP1[2].x) * _1017)));
