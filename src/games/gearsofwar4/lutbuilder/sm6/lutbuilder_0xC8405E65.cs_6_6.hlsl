...
void main(
  ...
  float4 output = ProcessLutbuilder(float3(_497, _499, _501), s0, t0, cb_config, u0[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))], 0u);
