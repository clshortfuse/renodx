...
void main(
  ...
  float _93 = mad((WorkingColorSpace_128[0].z), _78, mad((WorkingColorSpace_128[0].y), _77, ((WorkingColorSpace_128[0].x) * _76)));
  float _96 = mad((WorkingColorSpace_128[1].z), _78, mad((WorkingColorSpace_128[1].y), _77, ((WorkingColorSpace_128[1].x) * _76)));
  float _99 = mad((WorkingColorSpace_128[2].z), _78, mad((WorkingColorSpace_128[2].y), _77, ((WorkingColorSpace_128[2].x) * _76)));
  ...
  float _118 = (1.0f - exp2(((_100 * _100) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_104, _105, _106), float3(_104, _105, _106)) * -4.0f));
  ...
  float _151 = cb0_019w + cb0_024w;
  float _165 = cb0_018w * cb0_023w;
  float _179 = cb0_017w * cb0_022w;
  float _193 = cb0_016w * cb0_021w;
  float _207 = cb0_015w * cb0_020w;
  float _211 = _134 - _137;
  float _212 = _135 - _137;
  float _213 = _136 - _137;
  float _270 = saturate(_137 / cb0_035w);
  float _274 = (_270 * _270) * (3.0f - (_270 * 2.0f));
  float _275 = 1.0f - _274;
  float _284 = cb0_019w + cb0_034w;
  float _293 = cb0_018w * cb0_033w;
  float _302 = cb0_017w * cb0_032w;
  float _311 = cb0_016w * cb0_031w;
  float _320 = cb0_015w * cb0_030w;
  float _383 = saturate((_137 - cb0_036x) / (cb0_036y - cb0_036x));
  float _387 = (_383 * _383) * (3.0f - (_383 * 2.0f));
  float _396 = cb0_019w + cb0_029w;
  float _405 = cb0_018w * cb0_028w;
  float _414 = cb0_017w * cb0_027w;
  float _423 = cb0_016w * cb0_026w;
  float _432 = cb0_015w * cb0_025w;
  float _490 = _274 - _387;
  float _501 = ((_387 * (((cb0_019x + cb0_034x) + _284) + (((cb0_018x * cb0_033x) * _293) * exp2(log2(exp2(((cb0_016x * cb0_031x) * _311) * log2(max(0.0f, ((((cb0_015x * cb0_030x) * _320) * _211) + _137)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017x * cb0_032x) * _302)))))) + (_275 * (((cb0_019x + cb0_024x) + _151) + (((cb0_018x * cb0_023x) * _165) * exp2(log2(exp2(((cb0_016x * cb0_021x) * _193) * log2(max(0.0f, ((((cb0_015x * cb0_020x) * _207) * _211) + _137)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017x * cb0_022x) * _179))))))) + ((((cb0_019x + cb0_029x) + _396) + (((cb0_018x * cb0_028x) * _405) * exp2(log2(exp2(((cb0_016x * cb0_026x) * _423) * log2(max(0.0f, ((((cb0_015x * cb0_025x) * _432) * _211) + _137)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017x * cb0_027x) * _414))))) * _490);
  float _503 = ((_387 * (((cb0_019y + cb0_034y) + _284) + (((cb0_018y * cb0_033y) * _293) * exp2(log2(exp2(((cb0_016y * cb0_031y) * _311) * log2(max(0.0f, ((((cb0_015y * cb0_030y) * _320) * _212) + _137)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017y * cb0_032y) * _302)))))) + (_275 * (((cb0_019y + cb0_024y) + _151) + (((cb0_018y * cb0_023y) * _165) * exp2(log2(exp2(((cb0_016y * cb0_021y) * _193) * log2(max(0.0f, ((((cb0_015y * cb0_020y) * _207) * _212) + _137)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017y * cb0_022y) * _179))))))) + ((((cb0_019y + cb0_029y) + _396) + (((cb0_018y * cb0_028y) * _405) * exp2(log2(exp2(((cb0_016y * cb0_026y) * _423) * log2(max(0.0f, ((((cb0_015y * cb0_025y) * _432) * _212) + _137)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017y * cb0_027y) * _414))))) * _490);
  float _505 = ((_387 * (((cb0_019z + cb0_034z) + _284) + (((cb0_018z * cb0_033z) * _293) * exp2(log2(exp2(((cb0_016z * cb0_031z) * _311) * log2(max(0.0f, ((((cb0_015z * cb0_030z) * _320) * _213) + _137)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017z * cb0_032z) * _302)))))) + (_275 * (((cb0_019z + cb0_024z) + _151) + (((cb0_018z * cb0_023z) * _165) * exp2(log2(exp2(((cb0_016z * cb0_021z) * _193) * log2(max(0.0f, ((((cb0_015z * cb0_020z) * _207) * _213) + _137)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017z * cb0_022z) * _179))))))) + ((((cb0_019z + cb0_029z) + _396) + (((cb0_018z * cb0_028z) * _405) * exp2(log2(exp2(((cb0_016z * cb0_026z) * _423) * log2(max(0.0f, ((((cb0_015z * cb0_025z) * _432) * _213) + _137)) * 5.55555534362793f)) * 0.18000000715255737f) * (1.0f / ((cb0_017z * cb0_027z) * _414))))) * _490);
  ...
  cb_config.ue_lutweights = lutweights;  // Only Lutweights[0].xyzw

  float4 output = ProcessLutbuilder(float3(_501, _503, _505), s0, s1, s2, t0, t1, t2, cb_config, u0[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))], 0u);
  u0[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))] = output;
  return;

  float _520 = ((mad(0.061360642313957214f, _505, mad(-4.540197551250458e-09f, _503, (_501 * 0.9386394023895264f))) - _501) * cb0_036z) + _501;
  float _521 = ((mad(0.169205904006958f, _505, mad(0.8307942152023315f, _503, (_501 * 6.775371730327606e-08f))) - _503) * cb0_036z) + _503;
  float _522 = (mad(-2.3283064365386963e-10f, _503, (_501 * -9.313225746154785e-10f)) * cb0_036z) + _505;
  ...
  float _571 = ((float((int)(((int)(uint)((bool)(_556 > 0.0f))) - ((int)(uint)((bool)(_556 < 0.0f))))) * (1.0f - (_560 * _560))) + 1.0f) * 0.02500000037252903f;
  ...
  float _669 = (cb0_038x + 1.0f) - cb0_037z;
  float _671 = cb0_038y + 1.0f;
  float _673 = _671 - cb0_037w;
  if (cb0_037z > 0.800000011920929f) {
    _691 = (((0.8199999928474426f - cb0_037z) / cb0_037y) + -0.7447274923324585f);
  } else {
    float _682 = (cb0_038x + 0.18000000715255737f) / _669;
    _691 = (-0.7447274923324585f - ((log2(_682 / (2.0f - _682)) * 0.3465735912322998f) * (_669 / cb0_037y)));
  }
  float _694 = ((1.0f - cb0_037z) / cb0_037y) - _691;
  float _696 = (cb0_037w / cb0_037y) - _694;
  ...
  float _706 = cb0_037y * (_700 + _694);
  float _707 = cb0_037y * (_701 + _694);
  float _708 = cb0_037y * (_702 + _694);
  float _709 = _669 * 2.0f;
  float _711 = (cb0_037y * -2.0f) / _669;
  float _712 = _700 - _691;
  float _713 = _701 - _691;
  float _714 = _702 - _691;
  float _733 = _673 * 2.0f;
  float _735 = (cb0_037y * 2.0f) / _673;
  float _760 = select((_700 < _691), ((_709 / (exp2((_712 * 1.4426950216293335f) * _711) + 1.0f)) - cb0_038x), _706);
  float _761 = select((_701 < _691), ((_709 / (exp2((_713 * 1.4426950216293335f) * _711) + 1.0f)) - cb0_038x), _707);
  float _762 = select((_702 < _691), ((_709 / (exp2((_714 * 1.4426950216293335f) * _711) + 1.0f)) - cb0_038x), _708);
  ...
  float _824 = (cb0_037x * (max(0.0f, (lerp(_804, _801, 0.9300000071525574f))) - _520)) + _520;
  float _825 = (cb0_037x * (max(0.0f, (lerp(_804, _802, 0.9300000071525574f))) - _521)) + _521;
  float _826 = (cb0_037x * (max(0.0f, (lerp(_804, _803, 0.9300000071525574f))) - _522)) + _522;
  float _842 = ((mad(-0.06537103652954102f, _826, mad(1.451815478503704e-06f, _825, (_824 * 1.065374732017517f))) - _824) * cb0_036z) + _824;
  float _843 = ((mad(-0.20366770029067993f, _826, mad(1.2036634683609009f, _825, (_824 * -2.57161445915699e-07f))) - _825) * cb0_036z) + _825;
  float _844 = ((mad(0.9999996423721313f, _826, mad(2.0954757928848267e-08f, _825, (_824 * 1.862645149230957e-08f))) - _826) * cb0_036z) + _826;
  float _869 = saturate(max(0.0f, mad((WorkingColorSpace_192[0].z), _844, mad((WorkingColorSpace_192[0].y), _843, ((WorkingColorSpace_192[0].x) * _842)))));
  float _870 = saturate(max(0.0f, mad((WorkingColorSpace_192[1].z), _844, mad((WorkingColorSpace_192[1].y), _843, ((WorkingColorSpace_192[1].x) * _842)))));
  float _871 = saturate(max(0.0f, mad((WorkingColorSpace_192[2].z), _844, mad((WorkingColorSpace_192[2].y), _843, ((WorkingColorSpace_192[2].x) * _842)))));
  ...
  float4 _922 = t0.SampleLevel(s0, float2(_919, _908), 0.0f);
  float _926 = _919 + 0.0625f;
  float4 _927 = t0.SampleLevel(s0, float2(_926, _908), 0.0f);
  float4 _949 = t1.SampleLevel(s1, float2(_919, _908), 0.0f);
  float4 _953 = t1.SampleLevel(s1, float2(_926, _908), 0.0f);
  float4 _975 = t2.SampleLevel(s2, float2(_919, _908), 0.0f);
  float4 _979 = t2.SampleLevel(s2, float2(_926, _908), 0.0f);
  float _998 = max(6.103519990574569e-05f, (((((lerp(_922.x, _927.x, _917)) * cb0_005y) + (cb0_005x * _882)) + ((lerp(_949.x, _953.x, _917)) * cb0_005z)) + ((lerp(_975.x, _979.x, _917)) * cb0_005w)));
  float _999 = max(6.103519990574569e-05f, (((((lerp(_922.y, _927.y, _917)) * cb0_005y) + (cb0_005x * _893)) + ((lerp(_949.y, _953.y, _917)) * cb0_005z)) + ((lerp(_975.y, _979.y, _917)) * cb0_005w)));
  float _1000 = max(6.103519990574569e-05f, (((((lerp(_922.z, _927.z, _917)) * cb0_005y) + (cb0_005x * _904)) + ((lerp(_949.z, _953.z, _917)) * cb0_005z)) + ((lerp(_975.z, _979.z, _917)) * cb0_005w)));
  ...
  float _1050 = cb0_014x * (((cb0_039y + (cb0_039x * _1022)) * _1022) + cb0_039z);
  float _1051 = cb0_014y * (((cb0_039y + (cb0_039x * _1023)) * _1023) + cb0_039z);
  float _1052 = cb0_014z * (((cb0_039y + (cb0_039x * _1024)) * _1024) + cb0_039z);
  float _1073 = exp2(log2(max(0.0f, (lerp(_1050, cb0_013x, cb0_013w)))) * cb0_040y);
  float _1074 = exp2(log2(max(0.0f, (lerp(_1051, cb0_013y, cb0_013w)))) * cb0_040y);
  float _1075 = exp2(log2(max(0.0f, (lerp(_1052, cb0_013z, cb0_013w)))) * cb0_040y);
  if (WorkingColorSpace_320 == 0) {
    float _1082 = mad((WorkingColorSpace_128[0].z), _1075, mad((WorkingColorSpace_128[0].y), _1074, ((WorkingColorSpace_128[0].x) * _1073)));
    float _1085 = mad((WorkingColorSpace_128[1].z), _1075, mad((WorkingColorSpace_128[1].y), _1074, ((WorkingColorSpace_128[1].x) * _1073)));
    float _1088 = mad((WorkingColorSpace_128[2].z), _1075, mad((WorkingColorSpace_128[2].y), _1074, ((WorkingColorSpace_128[2].x) * _1073)));
  ...
  u0[int3((uint)(SV_DispatchThreadID.x), (uint)(SV_DispatchThreadID.y), (uint)(SV_DispatchThreadID.z))] = float4((_1112 * 0.9523810148239136f), (_1123 * 0.9523810148239136f), (_1134 * 0.9523810148239136f), 0.0f);
}
