...
float4 main(
  ...
  float4 output = ProcessLutbuilder(float3(_749, _751, _753), cb_config, SV_Target, 0u);
  SV_Target = output;
  return SV_Target;
  ...
  _1142 = cb0_016x * (((cb0_041y + (cb0_041x * _1114)) * _1114) + cb0_041z);
  _1143 = cb0_016y * (((cb0_041y + (cb0_041x * _1115)) * _1115) + cb0_041z);
  _1144 = cb0_016z * (((cb0_041y + (cb0_041x * _1116)) * _1116) + cb0_041z);
  _1165 = exp2(log2(max(0.0f, (lerp(_1142, cb0_015x, cb0_015w)))) * cb0_042y);
  _1166 = exp2(log2(max(0.0f, (lerp(_1143, cb0_015y, cb0_015w)))) * cb0_042y);
  _1167 = exp2(log2(max(0.0f, (lerp(_1144, cb0_015z, cb0_015w)))) * cb0_042y);
