...
float4 main(
  ...
  // float _155 = (1.0f - exp2(((_137 * _137) * -4.0f) * ExpandGamut)) * (1.0f - exp2(dot(float3(_141, _142, _143), float3(_141, _142, _143)) * -4.0f));
  float _155 = (1.0f - exp2(((_137 * _137) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_141, _142, _143), float3(_141, _142, _143)) * -4.0f));
  ...
  SV_Target = ProcessLutbuilder(float3(_538, _540, _542), Samplers_1, Samplers_2, Textures_1, Textures_2, cb_config, SV_Target, OutputDevice);
  return SV_Target;
  ...
  float _758 = log2(lerp(_712, _709, 0.9599999785423279f)) * 0.3010300099849701f;
  float _759 = log2(lerp(_712, _710, 0.9599999785423279f)) * 0.3010300099849701f;
  float _760 = log2(lerp(_712, _711, 0.9599999785423279f)) * 0.3010300099849701f;
  ...
  float _915 = saturate(max(0.0f, mad((WorkingColorSpace.FromAP1[0].z), _902, mad((WorkingColorSpace.FromAP1[0].y), _901, ((WorkingColorSpace.FromAP1[0].x) * _900)))));
  float _916 = saturate(max(0.0f, mad((WorkingColorSpace.FromAP1[1].z), _902, mad((WorkingColorSpace.FromAP1[1].y), _901, ((WorkingColorSpace.FromAP1[1].x) * _900)))));
  float _917 = saturate(max(0.0f, mad((WorkingColorSpace.FromAP1[2].z), _902, mad((WorkingColorSpace.FromAP1[2].y), _901, ((WorkingColorSpace.FromAP1[2].x) * _900)))));
  ...
  float _1023 = max(6.103519990574569e-05f, ((((lerp(_968.x, _975.x, _963)) * (LUTWeights[0].y)) + ((LUTWeights[0].x) * _928)) + ((lerp(_998.x, _1004.x, _963)) * (LUTWeights[0].z))));
  float _1024 = max(6.103519990574569e-05f, ((((lerp(_968.y, _975.y, _963)) * (LUTWeights[0].y)) + ((LUTWeights[0].x) * _939)) + ((lerp(_998.y, _1004.y, _963)) * (LUTWeights[0].z))));
  float _1025 = max(6.103519990574569e-05f, ((((lerp(_968.z, _975.z, _963)) * (LUTWeights[0].y)) + ((LUTWeights[0].x) * _950)) + ((lerp(_998.z, _1004.z, _963)) * (LUTWeights[0].z))));
