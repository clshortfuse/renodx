...
float4 main(
  ...
  float _125 = select(((cb0_034x * 1.0005563497543335f) <= 7000.0f), (((((2967800.0f - (_111 * 4607000064.0f)) * _111) + 99.11000061035156f) * _111) + 0.24406300485134125f), (((((1901800.0f - (_111 * 2006400000.0f)) * _111) + 247.47999572753906f) * _111) + 0.23703999817371368f));
  ...
  float _199 = (((_185 * 3.0f) / _193) - _155) + select(_158, _155, _125);
  float _200 = (((_188 * 2.0f) / _193) - _157) + select(_158, _157, (((_125 * 2.869999885559082f) + -0.2750000059604645f) - ((_125 * _125) * 3.0f)));
  bool _203 = (cb0_037z != 0);
  float _204 = select(_203, _199, 0.3127000033855438f);
  float _205 = select(_203, _200, 0.32899999618530273f);
  float _206 = select(_203, 0.3127000033855438f, _199);
  float _207 = select(_203, 0.32899999618530273f, _200);
  ...
  float _362 = (1.0f - exp2(((_344 * _344) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_348, _349, _350), float3(_348, _349, _350)) * -4.0f));
  ...
  SV_Target = ProcessLutbuilder(float3(_746, _748, _750), s0, s1, t0, t1, cb_config, SV_Target, cb0_039w);
  return SV_Target;
  ...
  float _816 = ((float((int)(((int)(uint)((bool)(_801 > 0.0f))) - ((int)(uint)((bool)(_801 < 0.0f))))) * (1.0f - (_805 * _805))) + 1.0f) * 0.02500000037252903f;
  ...
  if (!((bool)(_827 == _828) && (bool)(_828 == _829))) {
    ...
    bool _846 = (_839 >= 0.0f);
    bool _847 = (_839 < 0.0f);
    float _856 = select((_846 && _845), 90.0f, select((_847 && _845), -90.0f, (select((_847 && _844), (_841 + -3.1415927410125732f), select((_846 && _844), (_841 + 3.1415927410125732f), _841)) * 57.2957763671875f)));
    if (_856 < 0.0f) {
      _861 = (_856 + 360.0f);
    } else {
      _861 = _856;
  ...
  float _945 = log2(lerp(_899, _896, 0.9599999785423279f)) * 0.3010300099849701f;
  float _946 = log2(lerp(_899, _897, 0.9599999785423279f)) * 0.3010300099849701f;
  float _947 = log2(lerp(_899, _898, 0.9599999785423279f)) * 0.3010300099849701f;
  ...
  float _1005 = select((_945 < _936), ((_954 / (exp2((_957 * 1.4426950216293335f) * _956) + 1.0f)) - cb0_036w), _951);
  float _1006 = select((_946 < _936), ((_954 / (exp2((_958 * 1.4426950216293335f) * _956) + 1.0f)) - cb0_036w), _952);
  float _1007 = select((_947 < _936), ((_954 / (exp2((_959 * 1.4426950216293335f) * _956) + 1.0f)) - cb0_036w), _953);
  ...
  float _1025 = select(_1021, (1.0f - _1018), _1018);
  float _1026 = select(_1021, (1.0f - _1019), _1019);
  float _1027 = select(_1021, (1.0f - _1020), _1020);
  float _1046 = (((_1025 * _1025) * (select((_945 > _941), (_916 - (_978 / (exp2(((_945 - _941) * 1.4426950216293335f) * _980) + 1.0f))), _951) - _1005)) * (3.0f - (_1025 * 2.0f))) + _1005;
  float _1047 = (((_1026 * _1026) * (select((_946 > _941), (_916 - (_978 / (exp2(((_946 - _941) * 1.4426950216293335f) * _980) + 1.0f))), _952) - _1006)) * (3.0f - (_1026 * 2.0f))) + _1006;
  float _1048 = (((_1027 * _1027) * (select((_947 > _941), (_916 - (_978 / (exp2(((_947 - _941) * 1.4426950216293335f) * _980) + 1.0f))), _953) - _1007)) * (3.0f - (_1027 * 2.0f))) + _1007;
  float _1049 = dot(float3(_1046, _1047, _1048), float3(0.2722287178039551f, 0.6740817427635193f, 0.053689517080783844f));
  float _1069 = (cb0_035w * (max(0.0f, (lerp(_1049, _1046, 0.9300000071525574f))) - _765)) + _765;
  float _1070 = (cb0_035w * (max(0.0f, (lerp(_1049, _1047, 0.9300000071525574f))) - _766)) + _766;
  float _1071 = (cb0_035w * (max(0.0f, (lerp(_1049, _1048, 0.9300000071525574f))) - _767)) + _767;
  ...
  if (_1104 < 0.0031306699384003878f) {
    ...
    _1137 = (((pow(_1104, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
  }
  ...
  float _1210 = max(6.103519990574569e-05f, ((((lerp(_1155.x, _1162.x, _1150)) * cb0_005y) + (cb0_005x * _1115)) + ((lerp(_1185.x, _1191.x, _1150)) * cb0_005z)));
  float _1211 = max(6.103519990574569e-05f, ((((lerp(_1155.y, _1162.y, _1150)) * cb0_005y) + (cb0_005x * _1126)) + ((lerp(_1185.y, _1191.y, _1150)) * cb0_005z)));
  float _1212 = max(6.103519990574569e-05f, ((((lerp(_1155.z, _1162.z, _1150)) * cb0_005y) + (cb0_005x * _1137)) + ((lerp(_1185.z, _1191.z, _1150)) * cb0_005z)));
  float _1234 = select((_1210 > 0.040449999272823334f), exp2(log2((_1210 * 0.9478672742843628f) + 0.05213269963860512f) * 2.4000000953674316f), (_1210 * 0.07739938050508499f));
  float _1235 = select((_1211 > 0.040449999272823334f), exp2(log2((_1211 * 0.9478672742843628f) + 0.05213269963860512f) * 2.4000000953674316f), (_1211 * 0.07739938050508499f));
  float _1236 = select((_1212 > 0.040449999272823334f), exp2(log2((_1212 * 0.9478672742843628f) + 0.05213269963860512f) * 2.4000000953674316f), (_1212 * 0.07739938050508499f));
  ...
  if (cb0_039w == 0) {
    do {
      if (_1285 < 0.0031306699384003878f) {
        ...
        _1302 = (((pow(_1285, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
      }
      do {
        if (_1286 < 0.0031306699384003878f) {
          _1313 = (_1286 * 12.920000076293945f);
        } else {
          _1313 = (((pow(_1286, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
        }
        if (_1287 < 0.0031306699384003878f) {
          ...
          _2800 = _1302;
          _2801 = _1313;
          _2802 = (((pow(_1287, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f);
        }
      } while (false);
    } while (false);
  } else {
    if (cb0_039w == 1) {
      ...
      bool _1373 = (cb0_039w == 5);
      if ((bool)(cb0_039w == 3) || _1373) {
        _12[0] = cb0_009x;
        _12[1] = cb0_009y;
        _12[2] = cb0_009z;
        _12[3] = cb0_009w;
        ...
        do {
          ...
          float _1556 = ((float((int)(((int)(uint)((bool)(_1541 > 0.0f))) - ((int)(uint)((bool)(_1541 < 0.0f))))) * (1.0f - (_1545 * _1545))) + 1.0f) * 0.02500000037252903f;
          do {
            ...
            do {
              if (!((bool)(_1567 == _1568) && (bool)(_1568 == _1569))) {
                ...
                float _1596 = select((_1586 && _1585), 90.0f, select((_1587 && _1585), -90.0f, (select((_1587 && _1584), (_1581 + -3.1415927410125732f), select((_1586 && _1584), (_1581 + 3.1415927410125732f), _1581)) * 57.2957763671875f)));
                if (_1596 < 0.0f) {
                  _1601 = (_1596 + 360.0f);
                } else {
                  _1601 = _1596;
              ...
              do {
                ...
                do {
                    ...
                    if (_1619 == 3) {
                      ...
                      if (_1619 == 2) {
                        ...
                        if (_1619 == 1) {
                          ...
                          _1651 = select((_1619 == 0), (_1623 * 0.1666666716337204f), 0.0f);
                        }
                      }
                    }
                  } else {
                  ...
                  float _1689 = log2(max((lerp(_1678, _1675, 0.9599999785423279f)), 1.000000013351432e-10f));
                  ...
                  do {
                    if (!(!(_1690 <= _1692))) {
                      ...
                      if ((bool)(_1690 > _1692) && (bool)(_1690 < _1700)) {
                        ...
                        int _1709 = int(_1708);
                        float _1711 = _1708 - float((int)(_1709));
                    ...
                    float _1765 = log2(max((lerp(_1678, _1676, 0.9599999785423279f)), 1.000000013351432e-10f));
                    ...
                    do {
                      if (!(!(_1766 <= _1692))) {
                        ...
                        if ((bool)(_1766 > _1692) && (bool)(_1766 < _1774)) {
                          ...
                          int _1783 = int(_1782);
                          float _1785 = _1782 - float((int)(_1783));
                      ...
                      float _1839 = log2(max((lerp(_1678, _1677, 0.9599999785423279f)), 1.000000013351432e-10f));
        ...
        if ((cb0_039w & -3) == 4) {
          ...
          do {
            ...
            float _2214 = ((float((int)(((int)(uint)((bool)(_2199 > 0.0f))) - ((int)(uint)((bool)(_2199 < 0.0f))))) * (1.0f - (_2203 * _2203))) + 1.0f) * 0.02500000037252903f;
            do {
              ...
              do {
                if (!((bool)(_2225 == _2226) && (bool)(_2226 == _2227))) {
                  ...
                  float _2254 = select((_2244 && _2243), 90.0f, select((_2245 && _2243), -90.0f, (select((_2245 && _2242), (_2239 + -3.1415927410125732f), select((_2244 && _2242), (_2239 + 3.1415927410125732f), _2239)) * 57.2957763671875f)));
                  if (_2254 < 0.0f) {
                    _2259 = (_2254 + 360.0f);
                  } else {
                    _2259 = _2254;
                ...
                do {
                  ...
                  do {
                    if ((bool)(_2270 > -67.5f) && (bool)(_2270 < 67.5f)) {
                      ...
                      int _2277 = int(_2276);
                      float _2279 = _2276 - float((int)(_2277));
                      ...
                      if (_2277 == 3) {
                        ...
                        if (_2277 == 2) {
                          ...
                          if (_2277 == 1) {
                            ...
                            _2309 = select((_2277 == 0), (_2281 * 0.1666666716337204f), 0.0f);
                          }
                        }
                      }
                    } else {
                    ...
                    float _2347 = log2(max((lerp(_2336, _2333, 0.9599999785423279f)), 1.000000013351432e-10f));
                    ...
                    do {
                      if (!(!(_2348 <= _2350))) {
                        ...
                        if ((bool)(_2348 > _2350) && (bool)(_2348 < _2358)) {
                          ...
                          int _2367 = int(_2366);
                          float _2369 = _2366 - float((int)(_2367));
                          ...
                          if ((bool)(_2348 >= _2358) && (bool)(_2348 < (_2387 * 0.3010300099849701f))) {
                            ...
                            int _2397 = int(_2396);
                            float _2399 = _2396 - float((int)(_2397));
                      ...
                      float _2423 = log2(max((lerp(_2336, _2334, 0.9599999785423279f)), 1.000000013351432e-10f));
                      ...
                      do {
                        if (!(!(_2424 <= _2350))) {
                          ...
                          if ((bool)(_2424 > _2350) && (bool)(_2424 < _2432)) {
                            ...
                            int _2441 = int(_2440);
                            float _2443 = _2440 - float((int)(_2441));
                            ...
                            if ((bool)(_2424 >= _2432) && (bool)(_2424 < (_2461 * 0.3010300099849701f))) {
                              ...
                              int _2471 = int(_2470);
                              float _2473 = _2470 - float((int)(_2471));
                        ...
                        float _2497 = log2(max((lerp(_2336, _2335, 0.9599999785423279f)), 1.000000013351432e-10f));
                        ...
                        do {
                          if (!(!(_2498 <= _2350))) {
                            ...
                            if ((bool)(_2498 > _2350) && (bool)(_2498 < _2506)) {
                              ...
                              int _2515 = int(_2514);
                              float _2517 = _2514 - float((int)(_2515));
