// ---- Created with 3Dmigoto v1.3.16 on Thu Jul 16 17:54:27 2026

// Found in Densha Attack
// UE 5.6 HDR10 ini hdr
...
void main(
  ...
  r1.xyzw = cmp(float4(0.0404499993, 0.0404499993, 0.0404499993, 0) < r0.xyzw);
  r2.xyz = abs(r0.xyz) * float3(0.947867274, 0.947867274, 0.947867274) + float3(0.0521326996, 0.0521326996, 0.0521326996);
  r2.xyz = log2(r2.xyz);
