...
renodx::utils::settings::Settings settings = {
    ...
    tone_map_ui_nits_setting = new renodx::utils::settings::Setting{
        ...
        .label = "Brightness",
        .section = "Tone Mapping",
        .tooltip = "Sets the brightness of both game and UI.",
        .min = 48.f,
        .max = 500.f,
        .is_enabled = &IsHDREnabled,
    },
...
//     },
    ...
    new renodx::utils::settings::Setting{
        ...
        .section = "Effects",
        .tooltip = "Controls depth of field effect.",
        .max = 100.f,
        //.is_enabled = []() { return RENODX_TONE_MAP_TYPE > 0; },
        .parse = [](float value) { return value * 0.01f; },
    },
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Penny's Big Breakaway";
