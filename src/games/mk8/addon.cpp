...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Mario Kart 8 Deluxe";
  ...
  switch (fdw_reason) {
    case DLL_PROCESS_ATTACH: {
      ...
      */
      ...
      static std::vector<uint32_t> hashes = {0xEF015FAB, 0x7D419515, 0xC7B41AEE, 0x7D419515};  // final buffer
