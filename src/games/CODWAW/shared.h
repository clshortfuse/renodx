#ifndef SRC_CODWAW_SHARED_H_
#define SRC_CODWAW_SHARED_H_



#define RENODX_PSYCHO_SLIDER_LAYOUT_VERSION 1
#define RENODX_PRAGMAP_SLIDER_LAYOUT_VERSION 1
// Tone mapper IDs used by Addon.cpp and HLSL.
#define RENODX_TONE_MAP_TYPE_VANILLA   0.f
#define RENODX_TONE_MAP_TYPE_RENODRT   3.f
#define RENODX_TONE_MAP_TYPE_PSYCHO  24.f
#define RENODX_TONE_MAP_TYPE_PRAGMAP 31.f


// Must be 32-bit aligned.
// Keep the original first 32 float layout stable for the DX9/ps_3_0 c50-c57 path.
// New Psycho controls are appended at c58, not inserted in the middle.
struct ShaderInjectData {
  ...
  float psycho_compression;
  float psycho_gamut_compression;
  float psycho_gamut_mode;


  // c59
  float psycho_cone_response;  // x
  float bloom_brightness;         // y
  float bloom_flare_size;         // z
  float hdr_boost;                // w

  // c60
  // Reuses the existing extension register while keeping c50-c59 stable.
  float psycho_purity;                // x
  float pragmap_hue_strength;         // y
  float pragmap_blowout_strength;     // z
  float psycho_padding0;              // w
};
...
// c58 adds custom_flip_uv_y plus the first Psycho controls.
// c59 adds Psycho cone response, bloom controls, and HDR Boost.
// c60 adds Psycho purity and Pragmap controls.
...
#define RENODX_PSYCHO_COMPRESSION           shader_injection[8][1]
#define RENODX_PSYCHO_GAMUT_COMPRESSION     shader_injection[8][2]
#define RENODX_PSYCHO_GAMUT_MODE            shader_injection[8][3]
#define RENODX_PSYCHO_CONE_RESPONSE         shader_injection[9][0]
...
#define RENODX_PSYCHO_PURITY                   shader_injection[10][0]
#define RENODX_PRAGMAP_HUE_STRENGTH            shader_injection[10][1]
#define RENODX_PRAGMAP_BLOWOUT_STRENGTH        shader_injection[10][2]
...
#define RENODX_PSYCHO_COMPRESSION           shader_injection.psycho_compression
#define RENODX_PSYCHO_GAMUT_COMPRESSION     shader_injection.psycho_gamut_compression
#define RENODX_PSYCHO_GAMUT_MODE            shader_injection.psycho_gamut_mode
#define RENODX_PSYCHO_CONE_RESPONSE         shader_injection.psycho_cone_response
#define RENODX_PSYCHO_PURITY                   shader_injection.psycho_purity
