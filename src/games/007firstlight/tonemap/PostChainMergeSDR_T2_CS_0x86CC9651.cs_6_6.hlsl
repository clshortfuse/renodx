...
void main(
  ...
  _290 = (frac(sin(dot(float2(_20, _21), float2(12.989800453186035f, 78.23300170898438f))) * 43758.546875f) * 0.003921568859368563f) + -0.0019607844296842813f;
  float3 output = float3(((_290 + _282) * cbPostChainMerge.fFadeValue),
                         ((_290 + _283) * cbPostChainMerge.fFadeValue),
                         ((_290 + _284) * cbPostChainMerge.fFadeValue));
