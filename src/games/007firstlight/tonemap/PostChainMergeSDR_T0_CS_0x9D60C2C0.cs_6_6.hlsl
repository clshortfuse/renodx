...
void main(
  ...
  _213 = srvColorCorrectionVolume.SampleLevel(samplerLinearClampNode,
                                              float3(((saturate((((-0.054999999701976776f - _187) + (exp2(log2(abs(_159)) * 0.4166666567325592f) * 1.0549999475479126f)) * float((bool)(uint)(_159 > 0.0031308000907301903f))) + _187) * 0.9375f) + 0.03125f),
                                                     ((saturate((((-0.054999999701976776f - _188) + (exp2(log2(abs(_160)) * 0.4166666567325592f) * 1.0549999475479126f)) * float((bool)(uint)(_160 > 0.0031308000907301903f))) + _188) * 0.9375f) + 0.03125f),
                                                     ((saturate((((-0.054999999701976776f - _189) + (exp2(log2(abs(_161)) * 0.4166666567325592f) * 1.0549999475479126f)) * float((bool)(uint)(_161 > 0.0031308000907301903f))) + _189) * 0.9375f) + 0.03125f)),
                                              0.0f);
  ...
  _263 = (frac(sin(dot(float2(_20, _21), float2(12.989800453186035f, 78.23300170898438f))) * 43758.546875f) * 0.003921568859368563f) + -0.0019607844296842813f;
  float3 output = float3(((_263 + _255) * cbPostChainMerge.fFadeValue),
                         ((_263 + _256) * cbPostChainMerge.fFadeValue),
                         ((_263 + _257) * cbPostChainMerge.fFadeValue));
