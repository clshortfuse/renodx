...
void main(float4 v0 : SV_Position0, float4 v1 : TEXCOORD0, float4 v2 : TEXCOORD4, float4 v3 : COLOR0, float4 v4 : COLOR1, float3 v5 : TEXCOORD1, uint v6 : SV_IsFrontFace0, out float4 o0 : SV_Target0) {
  float4 r0, r1, r2;
