...
// ---- Created with 3Dmigoto v1.3.16 on Thu Jun 13 16:15:35 2024
...
void main(float4 v0 : SV_Position0, float4 v1 : TEXCOORD0, float4 v2 : TEXCOORD4, float4 v3 : COLOR1, float3 v4 : TEXCOORD1, uint v5 : SV_IsFrontFace0, out float4 o0 : SV_Target0) {
  float4 r0, r1, r2;
