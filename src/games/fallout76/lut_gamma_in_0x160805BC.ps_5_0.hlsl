...
void main(float4 v0: SV_POSITION0, float2 v1: TEXCOORD0, out float4 o0: SV_Target0) {
  ...
  r0.xyz = sign(r0.xyz) * pow(abs(r0.xyz), 2.2f);  // Gamma to Linear
  ...
  if (injectedData.colorGradeLUTStrength == 0.f || injectedData.toneMapType == 1.f) {
    ...
    r1.xyz = r0.xyz;  // * 0.9375 + 0.03125;

    r2.xyz = renodx::lut::Sample(t3, lut_config, r0.xyz);  // r2.xyz = t3.Sample(s3_s, r1.xyz).xyz;
    ...
    float3 postProcessColor = r1.xyz * cb2[0].www + r0.xyz;  // o0.xyz = r1.xyz * cb2[0].www + r0.xyz;
