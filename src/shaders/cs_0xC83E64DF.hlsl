...
{
    float4 _34_m0[30] : packoffset(c0);
};

cbuffer _41_43 : register(b6, space0)
{
    float4 _43_m0[30] : packoffset(c0);
};
...
void comp_main()
{
    ...
    float _87 = float(_85);
    float _88 = float(_86);
    uint4 _96 = asuint(_43_m0[12u]);
    float _99 = float(_96.z);
    float _100 = float(_96.w);
    float _101 = (_87 + 0.5f) / _99;
    float _102 = (_88 + 0.5f) / _100;
    bool _118 = ((_101 < _43_m0[9u].y) || (_102 < _43_m0[9u].z)) || (((1.0f - _43_m0[9u].y) < _101) || ((1.0f - _43_m0[9u].z) < _102));
    float _119;
    float _123;
    float _126;


    float uiOverlayShake = _43_m0[0u].x;
    float uiDeathOverlay = _43_m0[0u].y;
    // _43_m0[0u].z;
    // _43_m0[0u].w;

    float hudVisualEffects = _43_m0[1u].x; // Hud Ghosting
    float uiStaticStrength = _43_m0[1u].y; // If Lens Distortion is off
    float hudMaskStrength = _43_m0[1u].z; // Hud Mask?
    float texture6Strength = _43_m0[1u].w; // Blur texture?
    float texture5Strength = _43_m0[2u].x ;
    // _43_m0[2u].yz
    float hudSkewX = _43_m0[3u].x;
    float hudSkewY = _43_m0[3u].y;
    float dropShadowX = _43_m0[3u].z;
    float dropShadowY = _43_m0[3u].w;
    float dropShadowOpacity = _43_m0[4u].x;
    float dropShadowSpread = _43_m0[4u].y;

    float hudVisual00 = _43_m0[6u].w;
    
    float uiOutline = _43_m0[12u].x;
    float uiOutlineBlend = _43_m0[12u].y;
    ...
    else
    {
        ...
        float _181 = (((cos(_34_m0[0u].x) * 2.0f) + 200.0f) * _169) + 1.0f;
        ...
        float _232 = abs(sin((_165 * 0.1680000126361846923828125f) * _34_m0[0u].x));
        float _237 = (_165 * 0.14000000059604644775390625f) + 1.0f;
        float _243 = dot(float3(_194, _193, _194), float3(_197, _195, _195));
        float _256 = (floor(frac(frac((_204 + (_243 * 2.0f)) * (_243 + _194)) + _232) * _237) * (1.0f / (((cos(frac(_207 + abs(sin(_34_m0[0u].x * 5000.0f))) * _34_m0[0u].x) * 0.0199999995529651641845703125f) + 1.0f) * _181))) + _102;
        float _258 = _100 * _256;
        float _267 = frac(round((_165 * 0.125f) * _258) * 0.103100001811981201171875f);
        float _268 = frac((_165 * 2.0620000362396240234375f) * _34_m0[0u].x);
        ...
        float _304 = _138 ? ((((_99 * ((floor(frac(_207 + _232) * _237) * (1.0f / (((sin(frac(_207 + abs(sin(_34_m0[0u].x * 100.0f))) * _34_m0[0u].x) * 0.0199999995529651641845703125f) + 1.0f) * _172))) + _101)) + 2.0f) + ((((_165 * _165) * 960.0f) * frac(((_268 + _267) + (_271 * 2.0f)) * (_271 + _267))) * frac(((_268 + _285) + (_287 * 2.0f)) * (_287 + _285)))) / _99) : _101;
        ...
        if (_306)
        {
            ...
            float _350 = floor((_34_m0[0u].x * 2.0f) + (uiDeathOverlay * 20.0f));
            ...
            if (hasUiOutline)
            {
                ...
                float4 _815 = textureNoise.Load(int3(uint2(_581 & 255u, _582 & 255u), 0u));
                float _818 = _815.y;
                float _822 = ((_815.x + _818) + _815.z) * 0.3333333432674407958984375f;
                float _823 = uiOutline * _585;
                float _830 = _818 - _822;
                float _832 = _822 + (-0.5f);
                uint4 _838 = asuint(_43_m0[17u]);
                float _887 = (((((((_832 + (_43_m0[18u].w * _830)) * _43_m0[18u].y) * float(min((_838.x & _812), 1u))) + 1.0f) * (_823 / max(1.0f - _823, 9.9999999747524270787835121154785e-07f))) * ((((_832 + (_43_m0[19u].w * _830)) * _43_m0[19u].y) * float(min((_838.y & _812), 1u))) + 1.0f)) * ((((_832 + (_43_m0[20u].w * _830)) * _43_m0[20u].y) * float(min((_838.z & _812), 1u))) + 1.0f)) * ((((_832 + (_43_m0[21u].w * _830)) * _43_m0[21u].y) * float(min((_838.w & _812), 1u))) + 1.0f);
            ...
            if (hasUiOutline)
            {
                ...
                float _1390 = (((((((_1283 + (_43_m0[18u].w * _1277)) * _43_m0[18u].x) * _1299) + 1.0f) * (_1262 / max(1.0f - _1262, 9.9999999747524270787835121154785e-07f))) * ((((_1283 + (_43_m0[19u].w * _1277)) * _43_m0[19u].x) * _1327) + 1.0f)) * ((((_1283 + (_43_m0[20u].w * _1277)) * _43_m0[20u].x) * _1355) + 1.0f)) * ((((_1283 + (_43_m0[21u].w * _1277)) * _43_m0[21u].x) * _1383) + 1.0f);
                float _1391 = (((((((_1283 + (_43_m0[18u].w * _1278)) * _43_m0[18u].y) * _1299) + 1.0f) * (_1263 / max(1.0f - _1263, 9.9999999747524270787835121154785e-07f))) * ((((_1283 + (_43_m0[19u].w * _1278)) * _43_m0[19u].y) * _1327) + 1.0f)) * ((((_1283 + (_43_m0[20u].w * _1278)) * _43_m0[20u].y) * _1355) + 1.0f)) * ((((_1283 + (_43_m0[21u].w * _1278)) * _43_m0[21u].y) * _1383) + 1.0f);
                float _1392 = (((((((_1283 + (_43_m0[18u].w * _1279)) * _43_m0[18u].z) * _1299) + 1.0f) * (_1264 / max(1.0f - _1264, 9.9999999747524270787835121154785e-07f))) * ((((_1283 + (_43_m0[19u].w * _1279)) * _43_m0[19u].z) * _1327) + 1.0f)) * ((((_1283 + (_43_m0[20u].w * _1279)) * _43_m0[20u].z) * _1355) + 1.0f)) * ((((_1283 + (_43_m0[21u].w * _1279)) * _43_m0[21u].z) * _1383) + 1.0f);
        ...
        else
        {
            ...
            if (hasUiOutline)
            {
                ...
                float _1095 = (((((((_988 + (_43_m0[18u].w * _982)) * _43_m0[18u].x) * _1004) + 1.0f) * (_967 / max(1.0f - _967, 9.9999999747524270787835121154785e-07f))) * ((((_988 + (_43_m0[19u].w * _982)) * _43_m0[19u].x) * _1032) + 1.0f)) * ((((_988 + (_43_m0[20u].w * _982)) * _43_m0[20u].x) * _1060) + 1.0f)) * ((((_988 + (_43_m0[21u].w * _982)) * _43_m0[21u].x) * _1088) + 1.0f);
                float _1096 = (((((((_988 + (_43_m0[18u].w * _983)) * _43_m0[18u].y) * _1004) + 1.0f) * (_968 / max(1.0f - _968, 9.9999999747524270787835121154785e-07f))) * ((((_988 + (_43_m0[19u].w * _983)) * _43_m0[19u].y) * _1032) + 1.0f)) * ((((_988 + (_43_m0[20u].w * _983)) * _43_m0[20u].y) * _1060) + 1.0f)) * ((((_988 + (_43_m0[21u].w * _983)) * _43_m0[21u].y) * _1088) + 1.0f);
                float _1097 = (((((((_988 + (_43_m0[18u].w * _984)) * _43_m0[18u].z) * _1004) + 1.0f) * (_969 / max(1.0f - _969, 9.9999999747524270787835121154785e-07f))) * ((((_988 + (_43_m0[19u].w * _984)) * _43_m0[19u].z) * _1032) + 1.0f)) * ((((_988 + (_43_m0[20u].w * _984)) * _43_m0[20u].z) * _1060) + 1.0f)) * ((((_988 + (_43_m0[21u].w * _984)) * _43_m0[21u].z) * _1088) + 1.0f);
        ...
        float _1411;
        if ((asuint(_43_m0[13u]).z != 0u) && _1127)
        {
        ...
        float _1433 = _34_m0[0u].x * 0.004999999888241291046142578125f;
        ...
        if (texture6Strength > 0.0f)
        {
            ...
            if (_43_m0[6u].x > 0.0f)
            {
                float _1773 = clamp((sqrt((_142 * _142) + (_140 * _140)) - _43_m0[5u].z) / (_43_m0[5u].w - _43_m0[5u].z), 0.0f, 1.0f);
                float _1779 = 1.0f - (((_1773 * _1773) * (3.0f - (_1773 * 2.0f))) * _43_m0[6u].x);
                _1783 = _1779 * _1615;
                _1784 = _1779 * _1616;
                _1785 = _1779 * _1617;
            }
            ...
            _1622 = (((_1783 - _1787) * _43_m0[6u].y) + _1787) * texture6Strength;
            _1624 = (((_1784 - _1787) * _43_m0[6u].y) + _1787) * texture6Strength;
            _1626 = (((_1785 - _1787) * _43_m0[6u].y) + _1787) * texture6Strength;
        }
        else
        {
            _1622 = 0.0f;
        ...
        if (hudVisualEffects > 0.0f)
        {
            ...
            float4 _2105 = textureUI.SampleLevel(_46, float2((_43_m0[7u].x * _1430) + _1426, (_43_m0[7u].y * _1431) + _1427), 1.0f);
            float4 _2116 = textureUI.SampleLevel(_46, float2((_43_m0[7u].z * _1430) + _1426, (_43_m0[7u].w * _1431) + _1427), 2.0f);
            float4 _2131 = textureUI.SampleLevel(_46, float2((_43_m0[8u].x * _1430) + _1426, (_43_m0[8u].y * _1431) + _1427), 4.0f);
            float _2163 = 1.0f - (((_2083.w + _2079.w) + _2090.w) * 0.3333333432674407958984375f);
            float _2164 = clamp(_1470 * (((_43_m0[8u].w * _2116.x) + (_43_m0[8u].z * _2105.x)) + (_43_m0[9u].x * _2131.x)), 0.0f, 1.0f) * _2163;
            float _2165 = clamp(_1470 * (((_43_m0[8u].w * _2116.y) + (_43_m0[8u].z * _2105.y)) + (_43_m0[9u].x * _2131.y)), 0.0f, 1.0f) * _2163;
            float _2166 = clamp(_1470 * (((_43_m0[8u].w * _2116.z) + (_43_m0[8u].z * _2105.z)) + (_43_m0[9u].x * _2131.z)), 0.0f, 1.0f) * _2163;
            float _2258;
            float _2259;
            float _2260;
            if (_1127)
            ...
            float _2370 = _43_m0[5u].x * _1411;
            float4 _2372 = _22.SampleLevel(_46, float2(_1426, _1427), _43_m0[5u].y);
            _2167 = (((((_2340 - _2343) * _43_m0[6u].z) + _2343) * _1411) + ((((_2274 * (((_2258 - _2262) * _43_m0[6u].z) + _2262)) + _1995) * _2163) * _2309)) + (_2372.x * _2370);
            _2169 = (((((_2341 - _2343) * _43_m0[6u].z) + _2343) * _1411) + ((((_2274 * (((_2259 - _2262) * _43_m0[6u].z) + _2262)) + _1996) * _2163) * _2309)) + (_2372.y * _2370);
            _2171 = (((((_2342 - _2343) * _43_m0[6u].z) + _2343) * _1411) + ((((_2274 * (((_2260 - _2262) * _43_m0[6u].z) + _2262)) + _1997) * _2163) * _2309)) + (_2372.z * _2370);
        }
        else
        {
            _2167 = _1995;
        ...
        if (_306)
        {
            ...
            for (;;)
            {
                ...
                else
                {
                    ...
                    _2472 = _2473;
                    _2474 = _2475;
                    _2476 = (((_2521 * 0.20000000298023223876953125f) * (frac(_2485) - _2480)) * frac(floor(((_34_m0[0u].x * 0.1500000059604644775390625f) + 300.0f) / _2519) * _2519)) + _2476;
                    _2478 = ((_2521 * _2520) * (frac(_2486) - _2480)) + _2478;
                    _2480 *= (-2.0f);
                    _2482 = _2483;
                }
            }
            float _2558 = floor((_34_m0[0u].x * 2.0f) + uiDeathOverlay);
    ...
    bool _134 = asuint(_43_m0[15u]).x == 0u;
    float _311;
    float _314;
    float _316;
    if (_134)
    ...
    else
    {
        ...
        if (uiOutline > 0.0f)
        {
            ...
            float _779 = (((((((_668 + (_43_m0[18u].w * _662)) * _43_m0[18u].x) * _685) + 1.0f) * (_645 / max(1.0f - _645, 9.9999999747524270787835121154785e-07f))) * ((((_668 + (_43_m0[19u].w * _662)) * _43_m0[19u].x) * _714) + 1.0f)) * ((((_668 + (_43_m0[20u].w * _662)) * _43_m0[20u].x) * _743) + 1.0f)) * ((((_668 + (_43_m0[21u].w * _662)) * _43_m0[21u].x) * _772) + 1.0f);
            float _780 = (((((((_668 + (_43_m0[18u].w * _663)) * _43_m0[18u].y) * _685) + 1.0f) * (_646 / max(1.0f - _646, 9.9999999747524270787835121154785e-07f))) * ((((_668 + (_43_m0[19u].w * _663)) * _43_m0[19u].y) * _714) + 1.0f)) * ((((_668 + (_43_m0[20u].w * _663)) * _43_m0[20u].y) * _743) + 1.0f)) * ((((_668 + (_43_m0[21u].w * _663)) * _43_m0[21u].y) * _772) + 1.0f);
            float _781 = (((((((_668 + (_43_m0[18u].w * _664)) * _43_m0[18u].z) * _685) + 1.0f) * (_647 / max(1.0f - _647, 9.9999999747524270787835121154785e-07f))) * ((((_668 + (_43_m0[19u].w * _664)) * _43_m0[19u].z) * _714) + 1.0f)) * ((((_668 + (_43_m0[20u].w * _664)) * _43_m0[20u].z) * _743) + 1.0f)) * ((((_668 + (_43_m0[21u].w * _664)) * _43_m0[21u].z) * _772) + 1.0f);
    ...
    float _608;
    float _610;
    if (_43_m0[14u].w > 0.0f)
    {
        uint4 _594 = asuint(_43_m0[10u]);
        uint _595 = _594.x;
        uint _597 = _594.z;
        uint _600 = _594.y;
        uint _603 = _594.w;
        ...
        {
            float4 _1152 = _24.SampleLevel(_46, float2((_43_m0[11u].z * ((_87 - float(int(_595))) / float(int(_597 - _595)))) + _43_m0[11u].x, (_43_m0[11u].w * ((_88 - float(int(_600))) / float(int(_603 - _600)))) + _43_m0[11u].y), 0.0f);
            frontier_phi_8_7_ladder = _1152.y * _43_m0[14u].w;
            frontier_phi_8_7_ladder_1 = _1152.x * _43_m0[14u].w;
            frontier_phi_8_7_ladder_2 = _1152.z * _43_m0[14u].w;
        }
        else
        {
    ...
    else
    {
        ...
        float _1539;
        float _1540;
        if (_43_m0[14u].z != 1.0f)
        {
            _1538 = exp2(log2(abs(_606)) * _43_m0[14u].z);
            _1539 = exp2(log2(abs(_608)) * _43_m0[14u].z);
            _1540 = exp2(log2(abs(_610)) * _43_m0[14u].z);
        }
        else
        {
            _1538 = _606;
        ...
        float _1552 = frac(_34_m0[0u].x * 6.227200031280517578125f);
        ...
        else
        {
            ...
            if (_1200 == 1u)
            {
                ...
                float _1925 = exp2(log2(abs((((clamp(mad(_1889, _43_m0[22u].z, mad(_1883, _43_m0[22u].y, _1877 * _43_m0[22u].x)), 0.0f, 1.0f) - _1877) * _43_m0[16u].x) + _1877) * _43_m0[14u].x)) * 0.1593017578125f);
                float _1926 = exp2(log2(abs((((clamp(mad(_1889, _43_m0[23u].z, mad(_1883, _43_m0[23u].y, _1877 * _43_m0[23u].x)), 0.0f, 1.0f) - _1883) * _43_m0[16u].x) + _1883) * _43_m0[14u].x)) * 0.1593017578125f);
                float _1927 = exp2(log2(abs((((clamp(mad(_1889, _43_m0[24u].z, mad(_1883, _43_m0[24u].y, _1877 * _43_m0[24u].x)), 0.0f, 1.0f) - _1889) * _43_m0[16u].x) + _1889) * _43_m0[14u].x)) * 0.1593017578125f);
            ...
            else
            {
                ...
                if (_1200 == 2u)
                {
                    frontier_phi_16_25_ladder_33_ladder_41_ladder = _1540 * _43_m0[14u].x;
                    frontier_phi_16_25_ladder_33_ladder_41_ladder_1 = _1538 * _43_m0[14u].x;
                    frontier_phi_16_25_ladder_33_ladder_41_ladder_2 = _1539 * _43_m0[14u].x;
                }
                else
                {
                    ...
                    if (_1200 == 3u)
                    {
                        float _2185 = mad(_1540, _43_m0[22u].z, mad(_1539, _43_m0[22u].y, _1538 * _43_m0[22u].x)) * _43_m0[14u].x;
                        float _2186 = mad(_1540, _43_m0[23u].z, mad(_1539, _43_m0[23u].y, _1538 * _43_m0[23u].x)) * _43_m0[14u].x;
                        float _2187 = mad(_1540, _43_m0[24u].z, mad(_1539, _43_m0[24u].y, _1538 * _43_m0[24u].x)) * _43_m0[14u].x;
                    ...
                    {
                        frontier_phi_16_25_ladder_33_ladder_41_ladder_47_ladder = (_1540 * _43_m0[14u].x) + _43_m0[14u].y;
                        frontier_phi_16_25_ladder_33_ladder_41_ladder_47_ladder_1 = (_1538 * _43_m0[14u].x) + _43_m0[14u].y;
                        frontier_phi_16_25_ladder_33_ladder_41_ladder_47_ladder_2 = (_1539 * _43_m0[14u].x) + _43_m0[14u].y;
                    }
    ...
    else
    {
        ...
        float _1648;
        float _1649;
        if (_43_m0[15u].w != 1.0f)
        {
            _1647 = exp2(log2(abs(_311)) * _43_m0[15u].w);
            _1648 = exp2(log2(abs(_314)) * _43_m0[15u].w);
            _1649 = exp2(log2(abs(_316)) * _43_m0[15u].w);
        }
        else
        {
            _1647 = _311;
        ...
        float _1658 = frac(_34_m0[0u].x * 6.227200031280517578125f);
        ...
        else
        {
            ...
            if (_1524 == 1u)
            {
                ...
                float _2042 = exp2(log2(abs((((clamp(mad(_2008, _43_m0[26u].z, mad(_2005, _43_m0[26u].y, _2002 * _43_m0[26u].x)), 0.0f, 1.0f) - _2002) * _43_m0[16u].x) + _2002) * _43_m0[15u].y)) * 0.1593017578125f);
                float _2043 = exp2(log2(abs((((clamp(mad(_2008, _43_m0[27u].z, mad(_2005, _43_m0[27u].y, _2002 * _43_m0[27u].x)), 0.0f, 1.0f) - _2005) * _43_m0[16u].x) + _2005) * _43_m0[15u].y)) * 0.1593017578125f);
                float _2044 = exp2(log2(abs((((clamp(mad(_2008, _43_m0[28u].z, mad(_2005, _43_m0[28u].y, _2002 * _43_m0[28u].x)), 0.0f, 1.0f) - _2008) * _43_m0[16u].x) + _2008) * _43_m0[15u].y)) * 0.1593017578125f);
            ...
            else
            {
                ...
                if (_1524 == 2u)
                {
                    frontier_phi_22_31_ladder_39_ladder_45_ladder = _1647 * _43_m0[15u].y;
                    frontier_phi_22_31_ladder_39_ladder_45_ladder_1 = _1649 * _43_m0[15u].y;
                    frontier_phi_22_31_ladder_39_ladder_45_ladder_2 = _1648 * _43_m0[15u].y;
                }
                else
                {
                    ...
                    if (_1524 == 3u)
                    {
                        float _2402 = mad(_1649, _43_m0[26u].z, mad(_1648, _43_m0[26u].y, _1647 * _43_m0[26u].x)) * _43_m0[15u].y;
                        float _2403 = mad(_1649, _43_m0[27u].z, mad(_1648, _43_m0[27u].y, _1647 * _43_m0[27u].x)) * _43_m0[15u].y;
                        float _2404 = mad(_1649, _43_m0[28u].z, mad(_1648, _43_m0[28u].y, _1647 * _43_m0[28u].x)) * _43_m0[15u].y;
                    ...
                    {
                        frontier_phi_22_31_ladder_39_ladder_45_ladder_51_ladder = (_1647 * _43_m0[15u].y) + _43_m0[15u].z;
                        frontier_phi_22_31_ladder_39_ladder_45_ladder_51_ladder_1 = (_1649 * _43_m0[15u].y) + _43_m0[15u].z;
                        frontier_phi_22_31_ladder_39_ladder_45_ladder_51_ladder_2 = (_1648 * _43_m0[15u].y) + _43_m0[15u].z;
                    }
