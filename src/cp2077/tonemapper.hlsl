...
{
  float4 const00[10]; // _20_m0[8u].xyzw  _20_m0[9u].xyzw _20_m0[10u].xyzw _20_m0[11u].xyzw _20_m0[12u].xyzw _20_m0[13u].xyzw _20_m0[14u].xyzw _20_m0[15u].xyzw _20_m0[16u].xyzw _20_m0[17u].xyzw
  ...
  float3 const07[3];  // _20_m0[21u].xyz (_20_m0[21u].w _20_m0[22u].xy) (_20_m0[22u].zw _20_m0[23u].x)
  float3 const08[3];  // _20_m0[23u].yzw (_20_m0[24u].x _20_m0[24u].yz) (_20_m0[24u].w  _20_m0[25u].xy)
...
struct UnknownType
{
  ...
  float const33y; // _20_m0[33u].y 0.01245117 (100) 0.00622558 (200) 0.00498046 (250) 0.004150039 (300) 0.00311279 (400)  0.00249023 (500)
  float4 const34;
  float4 const35;
  float4 const36;
  float4 const37;
...
float3 sampleAllLUTs(const float3 color)
{
  ...
  if (injectedData.colorGradingStrength) { // 0 speed-hack
    compositedColor = lerp(color, sampleLUT(_20_m0[33u], color, 0u), injectedData.colorGradingStrength);
  } else {
...
float4 tonemap()
{
  ...
  float _88 = exp2(((float(gl_GlobalInvocationID.x) / _73) - _20_m0[41u].w) / _20_m0[41u].z);
  float _89 = exp2(((float(gl_GlobalInvocationID.y) / _73) - _20_m0[41u].w) / _20_m0[41u].z);
  float _90 = exp2(((float(gl_GlobalInvocationID.z) / _73) - _20_m0[41u].w) / _20_m0[41u].z);
  ...
  float _194 = ((
                    ...
                    float(
                        (_88 >= exposureMin) && (_88 <= exposureMax))) +
                ((float(_88 < exposureMin) * exposureMin) * (((1.0f - _20_m0[4u].x) * (_88 / exposureMin)) + _20_m0[4u].x))) +
               ((
                    (_136 * (_20_m0[6u].x + 1.0f)) + exposureMax) *
                float(_88 > exposureMax));
  float _195 = ((((_119 * (_20_m0[5u].y + 1.0f)) + exposureMin) * float((_89 >= exposureMin) && (_89 <= exposureMax))) + ((float(_89 < exposureMin) * exposureMin) * (((1.0f - _20_m0[4u].y) * (_89 / exposureMin)) + _20_m0[4u].y))) + (((_137 * (_20_m0[6u].y + 1.0f)) + exposureMax) * float(_89 > exposureMax));
  float _196 = ((((_120 * (_20_m0[5u].z + 1.0f)) + exposureMin) * float((_90 >= exposureMin) && (_90 <= exposureMax))) + ((float(_90 < exposureMin) * exposureMin) * (((1.0f - _20_m0[4u].z) * (_90 / exposureMin)) + _20_m0[4u].z))) + (((_138 * (_20_m0[6u].z + 1.0f)) + exposureMax) * float(_90 > exposureMax));
  ...
  float _355 = _20_m0[3u].w + mad(_258, mad(_309, _318, mad(_307, _315, _314 * _303)), mad(_257, mad(_300, _318, mad(_298, _315, _314 * _293)), mad(_289, _318, mad(_286, _315, _314 * _279)) * _256));
  float _356 = _20_m0[3u].w + mad(_258, mad(_309, _318, mad(_307, _317, _340)), mad(_257, mad(_300, _318, mad(_298, _317, _332)), mad(_289, _318, mad(_286, _317, _324)) * _256));
  float _357 = _20_m0[3u].w + mad(_258, mad(_309, _320, mad(_307, _315, _340)), mad(_257, mad(_300, _320, mad(_298, _315, _332)), mad(_289, _320, mad(_286, _315, _324)) * _256));

  float3 outputRGB = float3(_355, _356, _357);

  if ((injectedData.colorGradingWorkflow == -1.f || asuint(_20_m0[42u]).y == 1u) && (_69.x != 0u))
  {
  ...
  else if (toneMapperType == TONE_MAPPER_TYPE__VANILLA)
  {
    ...
    const SegmentedSplineParams_c9 ODT_CONFIG = {
        // coefsLow[10]
        {_20_m0[8u].x, _20_m0[9u].x, _20_m0[10u].x, _20_m0[11u].x, _20_m0[12u].x, _20_m0[13u].x, _20_m0[14u].x, _20_m0[15u].x, _20_m0[16u].x, _20_m0[17u].x},
        // coefsHigh[10]
        {_20_m0[8u].y, _20_m0[9u].y, _20_m0[10u].y, _20_m0[11u].y, _20_m0[12u].y, _20_m0[13u].y, _20_m0[14u].y, _20_m0[15u].y, _20_m0[16u].y, _20_m0[17u].y},
    ...
    if (_20_m0[28u].w != 0.0f)
    {
      ...
      toneMappedColor = (_20_m0[29u].x * (scaledAndToneMapped - toneMappedColor)) + toneMappedColor;
    }

    toneMappedColor = max(toneMappedColor, yMin);

    float3 linearCV = Y_2_linCV(
        toneMappedColor,
        yMax,
        yMin);
    ...
    float3x3 customMatrix0 = float3x3(
        _20_m0[21u].x, _20_m0[21u].y, _20_m0[21u].z,
        _20_m0[22u].x, _20_m0[22u].y, _20_m0[22u].z,
        _20_m0[23u].x, _20_m0[23u].y, _20_m0[23u].z);
    ...
    else
    {
      ...
      float maxScaledChannel = max(
          ...
          max(
              (yRange * odtUnknown.g) + yMin,
              (yRange * odtUnknown.b) + yMin));
  ...
  else if (toneMapperType == TONE_MAPPER_TYPE__OPENDRT)
  {
    ...
    odtFinal = open_drt_transform_custom(
      ...
      injectedData.toneMapperShadows) * yMax / REFERENCE_WHITE;
