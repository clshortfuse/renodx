...
float4 tonemap() {
  ...
  float _194 = ((((_118 * (_20_m0[5u].x + 1.0f)) + exposureMin) * float((_88 >= exposureMin) && (_88 <= exposureMax))) + ((float(_88 < exposureMin) * exposureMin) * (((1.0f - _20_m0[4u].x) * (_88 / exposureMin)) + _20_m0[4u].x))) + (((_136 * (_20_m0[6u].x + 1.0f)) + exposureMax) * float(_88 > exposureMax));
