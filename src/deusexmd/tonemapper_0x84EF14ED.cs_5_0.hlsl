...
[numthreads(8, 8, 1)] void main(uint3 vThreadGroupID : SV_GroupID, uint3 vThreadIDInGroup : SV_GroupThreadID) {
  ...
  float3 untonemappedColor = r2.xyz;
  ...
  if (injectedData.toneMapType == 0) {
    ...
    if (injectedData.toneMapType == 2) {
      ...
      outputColor *= (injectedData.toneMapPeakNits / injectedData.toneMapGameNits);
    }
    outputColor *= injectedData.toneMapGameNits / injectedData.toneMapUINits;
  }
  r1.rgb = outputColor.rgb;

  u0[uint2(r0.x, r0.y)] = r1.xyzw;
